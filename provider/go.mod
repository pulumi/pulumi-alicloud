...
replace (
	...
	github.com/denverdino/aliyungo => github.com/denverdino/aliyungo v0.0.0-20201215054313-f635de23c5e0
...
require (
	github.com/aliyun/terraform-provider-alicloud v1.110.0
