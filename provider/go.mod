...
replace (
	...
	github.com/denverdino/aliyungo => github.com/denverdino/aliyungo v0.0.0-20201218084154-7630293abb83
...
require (
	github.com/aliyun/terraform-provider-alicloud v1.114.1
