...
replace (
	...
	github.com/denverdino/aliyungo => github.com/denverdino/aliyungo v0.0.0-20200902071702-b5d3e9ff6492
)
...
require (
	...
	github.com/aliyun/terraform-provider-alicloud v1.100.0
)
