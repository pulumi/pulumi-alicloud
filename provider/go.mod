...
replace (
	...
	github.com/denverdino/aliyungo => github.com/denverdino/aliyungo v0.0.0-20201127010231-19d40697f3a3
...
require (
	github.com/aliyun/terraform-provider-alicloud v1.108.0
