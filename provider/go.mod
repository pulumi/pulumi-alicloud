...
replace (
	...
	github.com/denverdino/aliyungo => github.com/denverdino/aliyungo v0.0.0-20201022023337-dbe44e48e083
...
require (
	github.com/aliyun/terraform-provider-alicloud v1.103.0
