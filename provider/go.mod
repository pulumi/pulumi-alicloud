...
replace (
	...
	github.com/denverdino/aliyungo => github.com/denverdino/aliyungo v0.0.0-20201111050017-ecb1ab1b9105
...
require (
	github.com/aliyun/terraform-provider-alicloud v1.103.2
