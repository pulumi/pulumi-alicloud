...
require (
	github.com/aliyun/terraform-provider-alicloud v1.244.0
...
require (
	...
	github.com/alibabacloud-go/alibabacloud-gateway-oss v0.0.11 // indirect
	...
	github.com/alibabacloud-go/cs-20151215/v5 v5.8.1 // indirect
