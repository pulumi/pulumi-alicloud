...
replace (
	...
	github.com/denverdino/aliyungo => github.com/denverdino/aliyungo v0.0.0-20210222084345-ddfe3452f5e8
...
require (
	github.com/aliyun/terraform-provider-alicloud v1.117.0
