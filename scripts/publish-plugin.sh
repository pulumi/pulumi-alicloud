...
PLUGIN_PACKAGE_NAME="pulumi-resource-alicloud-${VERSION}-$(go env GOOS)-$(go env GOARCH).tar.gz"
...
go build \
   -ldflags "-X github.com/pulumi/pulumi-alicloud/pkg/version.Version=${VERSION}" \
...
CREDS_JSON=$(aws sts assume-role \
                 ...
                 --role-session-name "upload-plugin-pulumi-resource-alicloud" \
