...
namespace Pulumi.AliCloud.MongoDB
{
    ...
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.InstanceSecurityIpGroup>> SecurityIpGroups { get; private set; } = null!;
    ...
    public sealed class InstanceArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.InstanceSecurityIpGroupArgs>? _securityIpGroups;

        /// <summary>
        /// The list of named security IP groups. Each element represents a separate IP whitelist group managed independently from `SecurityIpList` (which manages the `Default` group). See `SecurityIpGroups` below.
        /// </summary>
        public InputList<Inputs.InstanceSecurityIpGroupArgs> SecurityIpGroups
        {
            get => _securityIpGroups ?? (_securityIpGroups = new InputList<Inputs.InstanceSecurityIpGroupArgs>());
    ...
    public sealed class InstanceState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("securityIpGroups")]
        private InputList<Inputs.InstanceSecurityIpGroupGetArgs>? _securityIpGroups;

        /// <summary>
        /// The list of named security IP groups. Each element represents a separate IP whitelist group managed independently from `SecurityIpList` (which manages the `Default` group). See `SecurityIpGroups` below.
        /// </summary>
        public InputList<Inputs.InstanceSecurityIpGroupGetArgs> SecurityIpGroups
        {
            get => _securityIpGroups ?? (_securityIpGroups = new InputList<Inputs.InstanceSecurityIpGroupGetArgs>());
            set => _securityIpGroups = value;
        }
