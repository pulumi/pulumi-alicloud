...
namespace Pulumi.AliCloud.MongoDB.Inputs
{
    ...
    public sealed class InstanceSecurityIpGroupArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public InstanceSecurityIpGroupArgs()
        {
        }
        public static new InstanceSecurityIpGroupArgs Empty => new InstanceSecurityIpGroupArgs();
    }
}
