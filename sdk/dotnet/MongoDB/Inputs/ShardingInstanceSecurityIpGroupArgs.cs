...
namespace Pulumi.AliCloud.MongoDB.Inputs
{
    ...
    public sealed class ShardingInstanceSecurityIpGroupArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public ShardingInstanceSecurityIpGroupArgs()
        {
        }
        public static new ShardingInstanceSecurityIpGroupArgs Empty => new ShardingInstanceSecurityIpGroupArgs();
    }
}
