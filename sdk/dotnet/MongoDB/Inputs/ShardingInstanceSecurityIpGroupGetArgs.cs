...
namespace Pulumi.AliCloud.MongoDB.Inputs
{
    ...
    public sealed class ShardingInstanceSecurityIpGroupGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public ShardingInstanceSecurityIpGroupGetArgs()
        {
        }
        public static new ShardingInstanceSecurityIpGroupGetArgs Empty => new ShardingInstanceSecurityIpGroupGetArgs();
    }
}
