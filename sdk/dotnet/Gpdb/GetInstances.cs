...
namespace Pulumi.AliCloud.Gpdb
{
    public static class GetInstances
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var ids = Output.Create(AliCloud.Gpdb.GetInstances.InvokeAsync());
        ///         this.GpdbDbInstanceId1 = ids.Apply(ids =&gt; ids.Instances?[0]?.Id);
        ///     }
        /// 
        ///     [Output("gpdbDbInstanceId1")]
        ///     public Output&lt;string&gt; GpdbDbInstanceId1 { get; set; }
        /// }
        /// ```
        /// {{% /example %}}
        /// {{% /examples %}}
