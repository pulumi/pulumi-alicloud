...
namespace Pulumi.AliCloud.Hbr.Inputs
{
    ...
    public sealed class PolicyRuleGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.PolicyRuleDataSourceFilterGetArgs>? _dataSourceFilters;

        /// <summary>
        /// This parameter is required only when the value of RuleType is TAG. See `DataSourceFilters` below.
        /// </summary>
        public InputList<Inputs.PolicyRuleDataSourceFilterGetArgs> DataSourceFilters
        {
            get => _dataSourceFilters ?? (_dataSourceFilters = new InputList<Inputs.PolicyRuleDataSourceFilterGetArgs>());
        ...
        [Input("tagFilters")]
        private InputList<Inputs.PolicyRuleTagFilterGetArgs>? _tagFilters;

        /// <summary>
        /// This parameter is required only when the value of RuleType is TAG. Resource label filtering rules. See `TagFilters` below.
        /// </summary>
        public InputList<Inputs.PolicyRuleTagFilterGetArgs> TagFilters
        {
            get => _tagFilters ?? (_tagFilters = new InputList<Inputs.PolicyRuleTagFilterGetArgs>());
