...
namespace Pulumi.AliCloud.Slb
{
    ...
    public partial class AclEntryAttachment : Pulumi.CustomResource
    {
        ...
        public AclEntryAttachment(string name, AclEntryAttachmentArgs args, CustomResourceOptions? options = null)
            : base("alicloud:slb/aclEntryAttachment:AclEntryAttachment", name, args ?? new AclEntryAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AclEntryAttachment(string name, Input<string> id, AclEntryAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("alicloud:slb/aclEntryAttachment:AclEntryAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
