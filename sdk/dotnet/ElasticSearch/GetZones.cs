...
namespace Pulumi.AliCloud.ElasticSearch
{
    public static class GetZones
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var zonesIds = Output.Create(AliCloud.ElasticSearch.GetZones.InvokeAsync());
        ///     }
        /// 
        /// }
        /// ```
        ...
        public static Output<GetZonesResult> Invoke(GetZonesInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetZonesResult>("alicloud:elasticsearch/getZones:getZones", args ?? new GetZonesInvokeArgs(), options.WithVersion());
    }
