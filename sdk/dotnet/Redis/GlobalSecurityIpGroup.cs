...
namespace Pulumi.AliCloud.Redis
{
    ...
    /// ```
    /// </summary>
    [AliCloudResourceType("alicloud:redis/globalSecurityIpGroup:GlobalSecurityIpGroup")]
    public partial class GlobalSecurityIpGroup : global::Pulumi.CustomResource
    {
        ...
        public GlobalSecurityIpGroup(string name, GlobalSecurityIpGroupArgs args, CustomResourceOptions? options = null)
            : base("alicloud:redis/globalSecurityIpGroup:GlobalSecurityIpGroup", name, args ?? new GlobalSecurityIpGroupArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private GlobalSecurityIpGroup(string name, Input<string> id, GlobalSecurityIpGroupState? state = null, CustomResourceOptions? options = null)
            : base("alicloud:redis/globalSecurityIpGroup:GlobalSecurityIpGroup", name, state, MakeResourceOptions(options, id))
        {
        }
