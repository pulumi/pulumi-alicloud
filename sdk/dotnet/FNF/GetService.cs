...
namespace Pulumi.AliCloud.FNF
{
    public static class GetService
    {
        ...
        public static Task<GetServiceResult> InvokeAsync(GetServiceArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceResult>("alicloud:fnf/getService:getService", args ?? new GetServiceArgs(), options.WithVersion());
        ...
        public static Output<GetServiceResult> Invoke(GetServiceInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceResult>("alicloud:fnf/getService:getService", args ?? new GetServiceInvokeArgs(), options.WithVersion());
    }
