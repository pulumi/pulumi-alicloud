...
namespace Pulumi.AliCloud.PolarDB
{
    public static class GetZones
    {
        ...
        public static Task<GetZonesResult> InvokeAsync(GetZonesArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetZonesResult>("alicloud:polardb/getZones:getZones", args ?? new GetZonesArgs(), options.WithVersion());
        ...
        public static Output<GetZonesResult> Invoke(GetZonesInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetZonesResult>("alicloud:polardb/getZones:getZones", args ?? new GetZonesInvokeArgs(), options.WithVersion());
    }
