...
namespace Pulumi.AliCloud.Edas.Inputs
{
    ...
    public sealed class K8sSlbAttachmentSlbConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.K8sSlbAttachmentSlbConfigPortMappingArgs>? _portMappings;

        /// <summary>
        /// The port configuration for SLB instance, which is supported for multiple configurations. See `port_mappings` below.
        /// </summary>
        public InputList<Inputs.K8sSlbAttachmentSlbConfigPortMappingArgs> PortMappings
        {
            get => _portMappings ?? (_portMappings = new InputList<Inputs.K8sSlbAttachmentSlbConfigPortMappingArgs>());
        ...
        public K8sSlbAttachmentSlbConfigArgs()
        {
        }
        public static new K8sSlbAttachmentSlbConfigArgs Empty => new K8sSlbAttachmentSlbConfigArgs();
    }
}
