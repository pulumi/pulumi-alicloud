...
namespace Pulumi.AliCloud.Edas
{
    ...
    ///     });
    /// 
    ///     var defaultDeployGroups = AliCloud.Edas.GetDeployGroups.Invoke(new()
    ///     {
    ///         AppId = defaultDeployGroup.AppId,
    ///     });
    /// 
    ///     var defaultApplicationScale = new AliCloud.Edas.ApplicationScale("defaultApplicationScale", new()
    ///     {
    ///         AppId = defaultApplication.Id,
    ///         DeployGroup = defaultDeployGroups.Apply(getDeployGroupsResult =&gt; getDeployGroupsResult.Groups[0]?.GroupId),
    ///         EcuInfos = new[]
    ///         {
