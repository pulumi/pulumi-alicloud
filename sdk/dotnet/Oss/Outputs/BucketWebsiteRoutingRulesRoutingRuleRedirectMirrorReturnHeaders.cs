...
namespace Pulumi.AliCloud.Oss.Outputs
{
    ...
    public sealed class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorReturnHeaders
    {
        ...
        [OutputConstructor]
        private BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorReturnHeaders(ImmutableArray<Outputs.BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorReturnHeadersReturnHeader> returnHeaders)
        {
