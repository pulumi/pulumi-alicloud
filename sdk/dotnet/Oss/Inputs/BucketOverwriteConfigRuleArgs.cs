...
namespace Pulumi.AliCloud.Oss.Inputs
{
    ...
    public sealed class BucketOverwriteConfigRuleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("principals")]
        public Input<Inputs.BucketOverwriteConfigRulePrincipalsArgs>? Principals { get; set; }
        ...
        public BucketOverwriteConfigRuleArgs()
        {
        }
        public static new BucketOverwriteConfigRuleArgs Empty => new BucketOverwriteConfigRuleArgs();
    }
}
