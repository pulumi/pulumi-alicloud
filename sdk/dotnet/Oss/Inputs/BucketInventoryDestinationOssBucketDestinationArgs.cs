...
namespace Pulumi.AliCloud.Oss.Inputs
{
    ...
    public sealed class BucketInventoryDestinationOssBucketDestinationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("encryption")]
        public Input<Inputs.BucketInventoryDestinationOssBucketDestinationEncryptionArgs>? Encryption { get; set; }
        ...
        public BucketInventoryDestinationOssBucketDestinationArgs()
        {
        }
        public static new BucketInventoryDestinationOssBucketDestinationArgs Empty => new BucketInventoryDestinationOssBucketDestinationArgs();
    }
}
