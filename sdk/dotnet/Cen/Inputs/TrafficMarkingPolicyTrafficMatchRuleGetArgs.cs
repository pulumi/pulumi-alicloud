...
namespace Pulumi.AliCloud.Cen.Inputs
{
    ...
    public sealed class TrafficMarkingPolicyTrafficMatchRuleGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// IP Address Family
        /// </summary>
        ...
        [Input("dstPortRanges")]
        private InputList<int>? _dstPortRanges;
        ...
        /// </summary>
        public InputList<int> DstPortRanges
        {
            get => _dstPortRanges ?? (_dstPortRanges = new InputList<int>());
            set => _dstPortRanges = value;
        }
        ...
        [Input("srcPortRanges")]
        private InputList<int>? _srcPortRanges;
        ...
        /// </summary>
        public InputList<int> SrcPortRanges
        {
            get => _srcPortRanges ?? (_srcPortRanges = new InputList<int>());
        ...
        /// </summary>
        [Input("trafficMatchRuleDescription")]
        public Input<string>? TrafficMatchRuleDescription { get; set; }
        ...
        /// </summary>
        [Input("trafficMatchRuleName")]
        public Input<string>? TrafficMatchRuleName { get; set; }

        public TrafficMarkingPolicyTrafficMatchRuleGetArgs()
        {
        }
        public static new TrafficMarkingPolicyTrafficMatchRuleGetArgs Empty => new TrafficMarkingPolicyTrafficMatchRuleGetArgs();
    }
}
