...
namespace Pulumi.AliCloud.CS
{
    ...
    /// {
    ///     var config = new Config();
    ///     var name = config.Get("name") ?? "tf-example-resource-pool-options";
    ///     var @default = AliCloud.GetZones.Invoke(new()
    ///     {
    ///         AvailableResourceCreation = "VSwitch",
    ///     });
    /// 
    ///     var cloudEssd = AliCloud.Ecs.GetInstanceTypes.Invoke(new()
    ///     {
    ...
    ///     });
    /// 
    ///     var vsw1 = AliCloud.Vpc.GetSwitches.Invoke(new()
    ///     {
    ...
    ///     });
    /// 
    ///     var defaultGetManagedKubernetesClusters = AliCloud.CS.GetManagedKubernetesClusters.Invoke(new()
    ///     {
    ///         NameRegex = "^cluster-",
    ///     });
    /// 
    ...
    ///         InstanceAmount = 1,
    ///         InstanceType = cloudEssd.Apply(getInstanceTypesResult =&gt; getInstanceTypesResult.InstanceTypes[0]?.Id),
    ...
    ///     var privatePoolFirst = new AliCloud.CS.NodePool("private_pool_first", new()
    ///     {
    ///         NodePoolName = $"{name}-first",
    ///         ClusterId = defaultGetManagedKubernetesClusters.Apply(getManagedKubernetesClustersResult =&gt; getManagedKubernetesClustersResult.Ids[0]),
    ///         VswitchIds = new[]
    ///         {
    ///             vsw1.Apply(getSwitchesResult =&gt; getSwitchesResult.Ids[0]),
    ///         },
    ///         InstanceChargeType = "PostPaid",
    ///         SystemDiskCategory = "cloud_essd",
    ///         SystemDiskSize = 120,
    ...
    ///         InstanceTypes = new[]
    ///         {
    ///             cloudEssd.Apply(getInstanceTypesResult =&gt; getInstanceTypesResult.InstanceTypes[0]?.Id),
    ///         },
    ///         ResourcePoolOptions = new AliCloud.CS.Inputs.NodePoolResourcePoolOptionsArgs
    ///         {
    ...
    ///     var privatePoolOnly = new AliCloud.CS.NodePool("private_pool_only", new()
    ///     {
    ...
    public partial class NodePool : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("resourcePoolOptions")]
        public Output<Outputs.NodePoolResourcePoolOptions?> ResourcePoolOptions { get; private set; } = null!;
    ...
    public sealed class NodePoolArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// &gt; **NOTE:** `ResourcePoolOptions` only takes effect when creating PostPaid (pay-as-you-go) instances, and it cannot be set together with `private_pool_options.private_pool_options_match_criteria` and `private_pool_options.private_pool_options_id`.
        /// </summary>
        [Input("resourcePoolOptions")]
        public Input<Inputs.NodePoolResourcePoolOptionsArgs>? ResourcePoolOptions { get; set; }
    ...
    public sealed class NodePoolState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("resourcePoolOptions")]
        public Input<Inputs.NodePoolResourcePoolOptionsGetArgs>? ResourcePoolOptions { get; set; }
