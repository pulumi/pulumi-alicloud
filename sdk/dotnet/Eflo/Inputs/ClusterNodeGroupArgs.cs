...
namespace Pulumi.AliCloud.Eflo.Inputs
{
    ...
    public sealed class ClusterNodeGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("nodes")]
        private InputList<Inputs.ClusterNodeGroupNodeArgs>? _nodes;

        /// <summary>
        /// Node List See `nodes` below.
        /// </summary>
        public InputList<Inputs.ClusterNodeGroupNodeArgs> Nodes
        {
            get => _nodes ?? (_nodes = new InputList<Inputs.ClusterNodeGroupNodeArgs>());
            set => _nodes = value;
        }
