...
namespace Pulumi.AliCloud.Eflo.Inputs
{
    ...
    public sealed class ExperimentPlanTemplateTemplatePipelineArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Contains a series of parameters related to the environment. See `env_params` below.
        /// </summary>
        [Input("envParams", required: true)]
        public Input<Inputs.ExperimentPlanTemplateTemplatePipelineEnvParamsArgs> EnvParams { get; set; } = null!;
        ...
        public ExperimentPlanTemplateTemplatePipelineArgs()
        {
        }
        public static new ExperimentPlanTemplateTemplatePipelineArgs Empty => new ExperimentPlanTemplateTemplatePipelineArgs();
    }
}
