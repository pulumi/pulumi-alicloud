...
namespace Pulumi.AliCloud.PrivateLink
{
    public static class GetService
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var open = Output.Create(AliCloud.PrivateLink.GetService.InvokeAsync(new AliCloud.PrivateLink.GetServiceArgs
        ///         {
        ///             Enable = "On",
        ///         }));
        ///     }
        ...
        public static Task<GetServiceResult> InvokeAsync(GetServiceArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceResult>("alicloud:privatelink/getService:getService", args ?? new GetServiceArgs(), options.WithDefaults());
        ...
        public static Output<GetServiceResult> Invoke(GetServiceInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceResult>("alicloud:privatelink/getService:getService", args ?? new GetServiceInvokeArgs(), options.WithDefaults());
    }
