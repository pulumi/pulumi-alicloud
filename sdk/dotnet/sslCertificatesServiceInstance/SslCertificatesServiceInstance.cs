...
namespace Pulumi.AliCloud.sslCertificatesServiceInstance
{
    ...
    /// ```
    /// </summary>
    [AliCloudResourceType("alicloud:sslcertificatesserviceinstance/sslCertificatesServiceInstance:SslCertificatesServiceInstance")]
    public partial class SslCertificatesServiceInstance : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("parameters")]
        public Output<ImmutableArray<Outputs.SslCertificatesServiceInstanceParameter>> Parameters { get; private set; } = null!;
        ...
        public SslCertificatesServiceInstance(string name, SslCertificatesServiceInstanceArgs? args = null, CustomResourceOptions? options = null)
            : base("alicloud:sslcertificatesserviceinstance/sslCertificatesServiceInstance:SslCertificatesServiceInstance", name, args ?? new SslCertificatesServiceInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SslCertificatesServiceInstance(string name, Input<string> id, SslCertificatesServiceInstanceState? state = null, CustomResourceOptions? options = null)
            : base("alicloud:sslcertificatesserviceinstance/sslCertificatesServiceInstance:SslCertificatesServiceInstance", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SslCertificatesServiceInstance Get(string name, Input<string> id, SslCertificatesServiceInstanceState? state = null, CustomResourceOptions? options = null)
        {
            return new SslCertificatesServiceInstance(name, id, state, options);
        }
    }

    public sealed class SslCertificatesServiceInstanceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Specifies whether to enable managed renewal.
        /// enable: Enabled
        ...
        [Input("parameters")]
        private InputList<Inputs.SslCertificatesServiceInstanceParameterArgs>? _parameters;
        ...
        /// &gt; **NOTE:** This parameter is immutable. Changing it after creation has no effect.
        /// </summary>
        public InputList<Inputs.SslCertificatesServiceInstanceParameterArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.SslCertificatesServiceInstanceParameterArgs>());
        ...
        public SslCertificatesServiceInstanceArgs()
        {
        }
        public static new SslCertificatesServiceInstanceArgs Empty => new SslCertificatesServiceInstanceArgs();
    }

    public sealed class SslCertificatesServiceInstanceState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Specifies whether to enable managed renewal.
        /// enable: Enabled
        ...
        [Input("parameters")]
        private InputList<Inputs.SslCertificatesServiceInstanceParameterGetArgs>? _parameters;
        ...
        /// &gt; **NOTE:** This parameter is immutable. Changing it after creation has no effect.
        /// </summary>
        public InputList<Inputs.SslCertificatesServiceInstanceParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.SslCertificatesServiceInstanceParameterGetArgs>());
            set => _parameters = value;
        }
        ...
        public SslCertificatesServiceInstanceState()
        {
        }
        public static new SslCertificatesServiceInstanceState Empty => new SslCertificatesServiceInstanceState();
    }
}
