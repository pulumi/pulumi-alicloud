...
namespace Pulumi.AliCloud.Vpc.Inputs
{
    ...
    public sealed class VPCRouteEntryNextHopGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.VPCRouteEntryNextHopNextHopRelatedInfoGetArgs>? NextHopRelatedInfo { get; set; }
        ...
        public VPCRouteEntryNextHopGetArgs()
        {
        }
        public static new VPCRouteEntryNextHopGetArgs Empty => new VPCRouteEntryNextHopGetArgs();
    }
}
