...
namespace Pulumi.AliCloud.Sag
{
    ...
    /// ```
    /// </summary>
    [AliCloudResourceType("alicloud:sag/qosCar:QosCar")]
    public partial class QosCar : global::Pulumi.CustomResource
    {
        ...
        public QosCar(string name, QosCarArgs args, CustomResourceOptions? options = null)
            : base("alicloud:sag/qosCar:QosCar", name, args ?? new QosCarArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QosCar(string name, Input<string> id, QosCarState? state = null, CustomResourceOptions? options = null)
            : base("alicloud:sag/qosCar:QosCar", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "alicloud:rocketmq/qosCar:QosCar" },
                },
            };
