...
namespace Pulumi.AliCloud.Sag
{
    ...
    /// ```
    /// </summary>
    [AliCloudResourceType("alicloud:sag/qos:Qos")]
    public partial class Qos : global::Pulumi.CustomResource
    {
        ...
        public Qos(string name, QosArgs? args = null, CustomResourceOptions? options = null)
            : base("alicloud:sag/qos:Qos", name, args ?? new QosArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Qos(string name, Input<string> id, QosState? state = null, CustomResourceOptions? options = null)
            : base("alicloud:sag/qos:Qos", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Qos Get(string name, Input<string> id, QosState? state = null, CustomResourceOptions? options = null)
        {
