...
namespace Pulumi.AliCloud.Sag
{
    ...
    /// ```
    /// </summary>
    [AliCloudResourceType("alicloud:sag/dnatEntry:DnatEntry")]
    public partial class DnatEntry : global::Pulumi.CustomResource
    {
        ...
        public DnatEntry(string name, DnatEntryArgs args, CustomResourceOptions? options = null)
            : base("alicloud:sag/dnatEntry:DnatEntry", name, args ?? new DnatEntryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnatEntry(string name, Input<string> id, DnatEntryState? state = null, CustomResourceOptions? options = null)
            : base("alicloud:sag/dnatEntry:DnatEntry", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "alicloud:rocketmq/dnatEntry:DnatEntry" },
                },
            };
