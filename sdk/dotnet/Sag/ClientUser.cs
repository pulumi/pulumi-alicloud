...
namespace Pulumi.AliCloud.Sag
{
    ...
    /// ```
    /// </summary>
    [AliCloudResourceType("alicloud:sag/clientUser:ClientUser")]
    public partial class ClientUser : global::Pulumi.CustomResource
    {
        ...
        public ClientUser(string name, ClientUserArgs args, CustomResourceOptions? options = null)
            : base("alicloud:sag/clientUser:ClientUser", name, args ?? new ClientUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClientUser(string name, Input<string> id, ClientUserState? state = null, CustomResourceOptions? options = null)
            : base("alicloud:sag/clientUser:ClientUser", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "alicloud:rocketmq/clientUser:ClientUser" },
                },
            };
