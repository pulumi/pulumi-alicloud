...
namespace Pulumi.AliCloud.Sag
{
    ...
    /// ```
    /// </summary>
    [AliCloudResourceType("alicloud:sag/qosPolicy:QosPolicy")]
    public partial class QosPolicy : global::Pulumi.CustomResource
    {
        ...
        public QosPolicy(string name, QosPolicyArgs args, CustomResourceOptions? options = null)
            : base("alicloud:sag/qosPolicy:QosPolicy", name, args ?? new QosPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private QosPolicy(string name, Input<string> id, QosPolicyState? state = null, CustomResourceOptions? options = null)
            : base("alicloud:sag/qosPolicy:QosPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "alicloud:rocketmq/qosPolicy:QosPolicy" },
                },
            };
