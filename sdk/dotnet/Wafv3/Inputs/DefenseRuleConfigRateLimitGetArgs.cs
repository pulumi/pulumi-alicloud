...
namespace Pulumi.AliCloud.Wafv3.Inputs
{
    ...
    public sealed class DefenseRuleConfigRateLimitGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("status")]
        public Input<Inputs.DefenseRuleConfigRateLimitStatusGetArgs>? Status { get; set; }
        ...
        public DefenseRuleConfigRateLimitGetArgs()
        {
        }
        public static new DefenseRuleConfigRateLimitGetArgs Empty => new DefenseRuleConfigRateLimitGetArgs();
    }
}
