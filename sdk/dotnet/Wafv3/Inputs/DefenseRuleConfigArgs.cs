...
namespace Pulumi.AliCloud.Wafv3.Inputs
{
    ...
    public sealed class DefenseRuleConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.DefenseRuleConfigAccountIdentifierArgs>? _accountIdentifiers;
        ...
        /// </summary>
        public InputList<Inputs.DefenseRuleConfigAccountIdentifierArgs> AccountIdentifiers
        {
            get => _accountIdentifiers ?? (_accountIdentifiers = new InputList<Inputs.DefenseRuleConfigAccountIdentifierArgs>());
        ...
        [Input("conditions")]
        private InputList<Inputs.DefenseRuleConfigConditionArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Inputs.DefenseRuleConfigConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.DefenseRuleConfigConditionArgs>());
        ...
        /// </summary>
        [Input("grayConfig")]
        public Input<Inputs.DefenseRuleConfigGrayConfigArgs>? GrayConfig { get; set; }
        ...
        /// </summary>
        [Input("rateLimit")]
        public Input<Inputs.DefenseRuleConfigRateLimitArgs>? RateLimit { get; set; }
        ...
        /// </summary>
        [Input("timeConfig")]
        public Input<Inputs.DefenseRuleConfigTimeConfigArgs>? TimeConfig { get; set; }
        ...
        private InputList<Inputs.DefenseRuleConfigWafBaseConfigArgs>? _wafBaseConfigs;

        /// <summary>
        /// The configuration of the Web core protection rules to be modified. See `WafBaseConfig` below.
        /// </summary>
        public InputList<Inputs.DefenseRuleConfigWafBaseConfigArgs> WafBaseConfigs
        {
            get => _wafBaseConfigs ?? (_wafBaseConfigs = new InputList<Inputs.DefenseRuleConfigWafBaseConfigArgs>());
            set => _wafBaseConfigs = value;
        }

        public DefenseRuleConfigArgs()
        {
        }
        public static new DefenseRuleConfigArgs Empty => new DefenseRuleConfigArgs();
    }
}
