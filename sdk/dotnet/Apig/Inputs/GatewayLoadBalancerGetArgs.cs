...
namespace Pulumi.AliCloud.Apig.Inputs
{
    ...
    public sealed class GatewayLoadBalancerGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("ports")]
        private InputList<Inputs.GatewayLoadBalancerPortGetArgs>? _ports;

        /// <summary>
        /// The list of listening ports.
        /// </summary>
        public InputList<Inputs.GatewayLoadBalancerPortGetArgs> Ports
        {
            get => _ports ?? (_ports = new InputList<Inputs.GatewayLoadBalancerPortGetArgs>());
            set => _ports = value;
        }
        ...
        public GatewayLoadBalancerGetArgs()
        {
        }
        public static new GatewayLoadBalancerGetArgs Empty => new GatewayLoadBalancerGetArgs();
    }
}
