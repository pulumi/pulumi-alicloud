...
namespace Pulumi.AliCloud.FC.Inputs
{
    ...
    public sealed class V3FunctionNasConfigGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _mountPoints ?? (_mountPoints = new InputList<Inputs.V3FunctionNasConfigMountPointGetArgs>());
        ...
        public V3FunctionNasConfigGetArgs()
        {
        }
        public static new V3FunctionNasConfigGetArgs Empty => new V3FunctionNasConfigGetArgs();
    }
}
