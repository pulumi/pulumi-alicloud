...
namespace Pulumi.AliCloud.FC.Inputs
{
    ...
    public sealed class V3FunctionLogConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public V3FunctionLogConfigGetArgs()
        {
        }
        public static new V3FunctionLogConfigGetArgs Empty => new V3FunctionLogConfigGetArgs();
    }
}
