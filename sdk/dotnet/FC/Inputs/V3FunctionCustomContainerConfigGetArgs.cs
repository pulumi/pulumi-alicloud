...
namespace Pulumi.AliCloud.FC.Inputs
{
    ...
    public sealed class V3FunctionCustomContainerConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Deprecated since v1.242.0) Image Acceleration Information (Obsolete)
        /// </summary>
        [Input("accelerationInfo")]
        public Input<Inputs.V3FunctionCustomContainerConfigAccelerationInfoGetArgs>? AccelerationInfo { get; set; }
        ...
        public Input<Inputs.V3FunctionCustomContainerConfigHealthCheckConfigGetArgs>? HealthCheckConfig { get; set; }
        ...
        public Input<Inputs.V3FunctionCustomContainerConfigRegistryConfigGetArgs>? RegistryConfig { get; set; }
        ...
        public V3FunctionCustomContainerConfigGetArgs()
        {
        }
        public static new V3FunctionCustomContainerConfigGetArgs Empty => new V3FunctionCustomContainerConfigGetArgs();
    }
}
