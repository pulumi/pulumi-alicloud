...
namespace Pulumi.AliCloud.FC.Inputs
{
    ...
    public sealed class V3FunctionCustomDnsArgs : global::Pulumi.ResourceArgs
    {
        [Input("dnsOptions")]
        ...
        {
            get => _dnsOptions ?? (_dnsOptions = new InputList<Inputs.V3FunctionCustomDnsDnsOptionArgs>());
        ...
        public V3FunctionCustomDnsArgs()
        {
        }
        public static new V3FunctionCustomDnsArgs Empty => new V3FunctionCustomDnsArgs();
    }
}
