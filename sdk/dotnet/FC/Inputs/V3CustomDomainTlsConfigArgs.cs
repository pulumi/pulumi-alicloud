...
namespace Pulumi.AliCloud.FC.Inputs
{
    ...
    public sealed class V3CustomDomainTlsConfigArgs : global::Pulumi.ResourceArgs
    {
        [Input("cipherSuites")]
        ...
        public V3CustomDomainTlsConfigArgs()
        {
        }
        public static new V3CustomDomainTlsConfigArgs Empty => new V3CustomDomainTlsConfigArgs();
    }
}
