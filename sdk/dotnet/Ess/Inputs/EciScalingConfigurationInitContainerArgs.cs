...
namespace Pulumi.AliCloud.Ess.Inputs
{
    ...
    public sealed class EciScalingConfigurationInitContainerArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.EciScalingConfigurationInitContainerEnvironmentVarArgs>? _environmentVars;
        ...
        {
            get => _environmentVars ?? (_environmentVars = new InputList<Inputs.EciScalingConfigurationInitContainerEnvironmentVarArgs>());
        ...
        {
            get => _ports ?? (_ports = new InputList<Inputs.EciScalingConfigurationInitContainerPortArgs>());
            set => _ports = value;
        }
        ...
        [Input("volumeMounts")]
        private InputList<Inputs.EciScalingConfigurationInitContainerVolumeMountArgs>? _volumeMounts;
        ...
        {
            get => _volumeMounts ?? (_volumeMounts = new InputList<Inputs.EciScalingConfigurationInitContainerVolumeMountArgs>());
