...
namespace Pulumi.AliCloud.Ess.Inputs
{
    ...
    public sealed class ScalingRuleHybridMetricArgs : global::Pulumi.ResourceArgs
    {
        [Input("dimensions")]
        private InputList<Inputs.ScalingRuleHybridMetricDimensionArgs>? _dimensions;
        ...
        {
            get => _dimensions ?? (_dimensions = new InputList<Inputs.ScalingRuleHybridMetricDimensionArgs>());
        ...
        public ScalingRuleHybridMetricArgs()
        {
        }
        public static new ScalingRuleHybridMetricArgs Empty => new ScalingRuleHybridMetricArgs();
    }
}
