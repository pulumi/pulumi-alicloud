...
namespace Pulumi.AliCloud.Emrv2.Inputs
{
    ...
    public sealed class ClusterNodeGroupAckConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        {
            get => _customAnnotations ?? (_customAnnotations = new InputList<Inputs.ClusterNodeGroupAckConfigCustomAnnotationArgs>());
        ...
        {
            get => _customLabels ?? (_customLabels = new InputList<Inputs.ClusterNodeGroupAckConfigCustomLabelArgs>());
        ...
        {
            get => _nodeSelectors ?? (_nodeSelectors = new InputList<Inputs.ClusterNodeGroupAckConfigNodeSelectorArgs>());
        ...
        {
            get => _pvcs ?? (_pvcs = new InputList<Inputs.ClusterNodeGroupAckConfigPvcArgs>());
            set => _pvcs = value;
        }
        ...
        {
            get => _tolerations ?? (_tolerations = new InputList<Inputs.ClusterNodeGroupAckConfigTolerationArgs>());
        ...
        {
            get => _volumeMounts ?? (_volumeMounts = new InputList<Inputs.ClusterNodeGroupAckConfigVolumeMountArgs>());
        ...
        {
            get => _volumes ?? (_volumes = new InputList<Inputs.ClusterNodeGroupAckConfigVolumeArgs>());
            set => _volumes = value;
        }

        public ClusterNodeGroupAckConfigArgs()
        {
        }
        public static new ClusterNodeGroupAckConfigArgs Empty => new ClusterNodeGroupAckConfigArgs();
    }
}
