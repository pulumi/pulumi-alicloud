...
namespace Pulumi.AliCloud.Emrv2.Inputs
{
    ...
    public sealed class ClusterNodeGroupGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.ClusterNodeGroupDataDiskGetArgs>? _dataDisks;

        /// <summary>
        /// Host Ecs data disks information in this node group. See `DataDisks` below.
        /// </summary>
        public InputList<Inputs.ClusterNodeGroupDataDiskGetArgs> DataDisks
        {
            get => _dataDisks ?? (_dataDisks = new InputList<Inputs.ClusterNodeGroupDataDiskGetArgs>());
        ...
        public Input<Inputs.ClusterNodeGroupPrivatePoolOptionsGetArgs>? PrivatePoolOptions { get; set; }

        [Input("spotBidPrices")]
        private InputList<Inputs.ClusterNodeGroupSpotBidPriceGetArgs>? _spotBidPrices;

        /// <summary>
        /// The spot bid prices of a PayAsYouGo instance. See `SpotBidPrices` below.
        /// </summary>
        public InputList<Inputs.ClusterNodeGroupSpotBidPriceGetArgs> SpotBidPrices
        {
            get => _spotBidPrices ?? (_spotBidPrices = new InputList<Inputs.ClusterNodeGroupSpotBidPriceGetArgs>());
        ...
        public Input<Inputs.ClusterNodeGroupSubscriptionConfigGetArgs>? SubscriptionConfig { get; set; }

        /// <summary>
        /// Host Ecs system disk information in this node group. See `SystemDisk` below.
        /// </summary>
        [Input("systemDisk", required: true)]
        public Input<Inputs.ClusterNodeGroupSystemDiskGetArgs> SystemDisk { get; set; } = null!;
