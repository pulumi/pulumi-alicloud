...
namespace Pulumi.AliCloud.Ehpc.Inputs
{
    ...
    public sealed class ClusterV2ManagerManagerNodeArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("systemDisk")]
        public Input<Inputs.ClusterV2ManagerManagerNodeSystemDiskArgs>? SystemDisk { get; set; }

        public ClusterV2ManagerManagerNodeArgs()
        {
        }
        public static new ClusterV2ManagerManagerNodeArgs Empty => new ClusterV2ManagerManagerNodeArgs();
    }
}
