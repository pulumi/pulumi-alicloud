...
namespace Pulumi.AliCloud.Cddc
{
    public static class GetZones
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var example = Output.Create(AliCloud.Cddc.GetZones.InvokeAsync());
        ///         this.CddcZonesId1 = example.Apply(example =&gt; example.Zones?[0]?.Id);
        ///     }
        /// 
        ///     [Output("cddcZonesId1")]
        ///     public Output&lt;string&gt; CddcZonesId1 { get; set; }
        /// }
        /// ```
        /// {{% /example %}}
        /// {{% /examples %}}
        ...
        public static Task<GetZonesResult> InvokeAsync(GetZonesArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetZonesResult>("alicloud:cddc/getZones:getZones", args ?? new GetZonesArgs(), options.WithVersion());
        ...
        public static Output<GetZonesResult> Invoke(GetZonesInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetZonesResult>("alicloud:cddc/getZones:getZones", args ?? new GetZonesInvokeArgs(), options.WithVersion());
    }
