...
namespace Pulumi.AliCloud.Log
{
    public static class GetService
    {
        ...
        public static Task<GetServiceResult> InvokeAsync(GetServiceArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceResult>("alicloud:log/getService:getService", args ?? new GetServiceArgs(), options.WithDefaults());
        ...
        public static Output<GetServiceResult> Invoke(GetServiceInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceResult>("alicloud:log/getService:getService", args ?? new GetServiceInvokeArgs(), options.WithDefaults());
    }
