...
namespace Pulumi.AliCloud.Esa.Inputs
{
    ...
    public sealed class OriginPoolOriginArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Origin Address.
        /// </summary>
        ...
        /// </summary>
        [Input("authConf")]
        public Input<Inputs.OriginPoolOriginAuthConfArgs>? AuthConf { get; set; }
        ...
        public OriginPoolOriginArgs()
        {
        }
        public static new OriginPoolOriginArgs Empty => new OriginPoolOriginArgs();
    }
}
