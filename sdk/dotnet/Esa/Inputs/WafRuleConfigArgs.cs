...
namespace Pulumi.AliCloud.Esa.Inputs
{
    ...
    public sealed class WafRuleConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("actions")]
        public Input<Inputs.WafRuleConfigActionsArgs>? Actions { get; set; }

        /// <summary>
        /// Security mechanism to prevent apps from being repackaged. See `AppPackage` below.
        /// </summary>
        [Input("appPackage")]
        public Input<Inputs.WafRuleConfigAppPackageArgs>? AppPackage { get; set; }

        /// <summary>
        /// Mobile app SDK-related configurations. See `AppSdk` below.
        /// </summary>
        [Input("appSdk")]
        public Input<Inputs.WafRuleConfigAppSdkArgs>? AppSdk { get; set; }
        ...
        private InputList<Inputs.WafRuleConfigManagedRulesetArgs>? _managedRulesets;

        /// <summary>
        /// The managed rulesets referenced by this rule and their configurations. See `ManagedRulesets` below.
        /// </summary>
        public InputList<Inputs.WafRuleConfigManagedRulesetArgs> ManagedRulesets
        {
            get => _managedRulesets ?? (_managedRulesets = new InputList<Inputs.WafRuleConfigManagedRulesetArgs>());
        ...
        /// </summary>
        [Input("timer")]
        public Input<Inputs.WafRuleConfigTimerArgs>? Timer { get; set; }
        ...
        public WafRuleConfigArgs()
        {
        }
        public static new WafRuleConfigArgs Empty => new WafRuleConfigArgs();
    }
}
