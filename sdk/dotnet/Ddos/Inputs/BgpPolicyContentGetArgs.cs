...
namespace Pulumi.AliCloud.Ddos.Inputs
{
    ...
    public sealed class BgpPolicyContentGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.BgpPolicyContentFingerPrintRuleListGetArgs>? _fingerPrintRuleLists;

        /// <summary>
        /// Fingerprint Rules. See `finger_print_rule_list` below.
        /// </summary>
        public InputList<Inputs.BgpPolicyContentFingerPrintRuleListGetArgs> FingerPrintRuleLists
        {
            get => _fingerPrintRuleLists ?? (_fingerPrintRuleLists = new InputList<Inputs.BgpPolicyContentFingerPrintRuleListGetArgs>());
        ...
        private InputList<Inputs.BgpPolicyContentLayer4RuleListGetArgs>? _layer4RuleLists;

        /// <summary>
        /// L4 protection rules. See `layer4_rule_list` below.
        /// </summary>
        public InputList<Inputs.BgpPolicyContentLayer4RuleListGetArgs> Layer4RuleLists
        {
            get => _layer4RuleLists ?? (_layer4RuleLists = new InputList<Inputs.BgpPolicyContentLayer4RuleListGetArgs>());
            set => _layer4RuleLists = value;
        }

        [Input("portRuleLists")]
        private InputList<Inputs.BgpPolicyContentPortRuleListGetArgs>? _portRuleLists;

        /// <summary>
        /// Port Rule List. See `port_rule_list` below.
        /// </summary>
        public InputList<Inputs.BgpPolicyContentPortRuleListGetArgs> PortRuleLists
        {
            get => _portRuleLists ?? (_portRuleLists = new InputList<Inputs.BgpPolicyContentPortRuleListGetArgs>());
        ...
        private InputList<Inputs.BgpPolicyContentSourceBlockListGetArgs>? _sourceBlockLists;

        /// <summary>
        /// Source pull Black. See `source_block_list` below.
        /// </summary>
        public InputList<Inputs.BgpPolicyContentSourceBlockListGetArgs> SourceBlockLists
        {
            get => _sourceBlockLists ?? (_sourceBlockLists = new InputList<Inputs.BgpPolicyContentSourceBlockListGetArgs>());
        ...
        /// </summary>
        [Input("sourceLimit")]
        public Input<Inputs.BgpPolicyContentSourceLimitGetArgs>? SourceLimit { get; set; }
        ...
        public BgpPolicyContentGetArgs()
        {
        }
        public static new BgpPolicyContentGetArgs Empty => new BgpPolicyContentGetArgs();
    }
}
