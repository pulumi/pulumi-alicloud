...
namespace Pulumi.AliCloud.ResourceManager.Outputs
{
    ...
    [OutputType]
    public sealed class MultiAccountDeliveryChannelDeliveryChannelFilter
    {
        /// <summary>
        /// The account scopes of the delivery channel.
        /// </summary>
        public readonly ImmutableArray<string> AccountScopes;
        /// <summary>
        ...
        private MultiAccountDeliveryChannelDeliveryChannelFilter(
            ImmutableArray<string> accountScopes,
