...
namespace Pulumi.AliCloud.Ecs.Inputs
{
    ...
    public sealed class InstanceMaintenanceTimeArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public InstanceMaintenanceTimeArgs()
        {
        }
        public static new InstanceMaintenanceTimeArgs Empty => new InstanceMaintenanceTimeArgs();
    }
}
