...
namespace Pulumi.AliCloud.Sae.Inputs
{
    ...
    public sealed class LoadBalancerInternetInternetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public LoadBalancerInternetInternetArgs()
        {
        }
        public static new LoadBalancerInternetInternetArgs Empty => new LoadBalancerInternetInternetArgs();
    }
}
