...
namespace Pulumi.AliCloud.Cms.Inputs
{
    ...
    public sealed class SiteMonitorOptionJsonArgs : global::Pulumi.ResourceArgs
    {
        [Input("assertions")]
        private InputList<Inputs.SiteMonitorOptionJsonAssertionArgs>? _assertions;

        /// <summary>
        /// Assertion configuration group. See `Assertions` below.
        /// </summary>
        public InputList<Inputs.SiteMonitorOptionJsonAssertionArgs> Assertions
        {
            get => _assertions ?? (_assertions = new InputList<Inputs.SiteMonitorOptionJsonAssertionArgs>());
        ...
        public SiteMonitorOptionJsonArgs()
        {
        }
        public static new SiteMonitorOptionJsonArgs Empty => new SiteMonitorOptionJsonArgs();
    }
}
