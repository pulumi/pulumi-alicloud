...
namespace Pulumi.AliCloud.Cms
{
    public static class GetService
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var open = Output.Create(AliCloud.Cms.GetService.InvokeAsync(new AliCloud.Cms.GetServiceArgs
        ///         {
        ///             Enable = "On",
        ///         }));
        ///     }
        ...
        public static Task<GetServiceResult> InvokeAsync(GetServiceArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetServiceResult>("alicloud:cms/getService:getService", args ?? new GetServiceArgs(), options.WithDefaults());
        ...
        public static Output<GetServiceResult> Invoke(GetServiceInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetServiceResult>("alicloud:cms/getService:getService", args ?? new GetServiceInvokeArgs(), options.WithDefaults());
    }
