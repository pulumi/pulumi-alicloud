...
namespace Pulumi.AliCloud.CloudMonitor.Inputs
{
    ...
    public sealed class ServiceMetricAlarmRuleCompositeExpressionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ServiceMetricAlarmRuleCompositeExpressionExpressionListGetArgs>? _expressionLists;

        /// <summary>
        /// A list of alert conditions created using standard expressions. See `ExpressionList` below.
        /// </summary>
        public InputList<Inputs.ServiceMetricAlarmRuleCompositeExpressionExpressionListGetArgs> ExpressionLists
        {
            get => _expressionLists ?? (_expressionLists = new InputList<Inputs.ServiceMetricAlarmRuleCompositeExpressionExpressionListGetArgs>());
        ...
        public ServiceMetricAlarmRuleCompositeExpressionGetArgs()
        {
        }
        public static new ServiceMetricAlarmRuleCompositeExpressionGetArgs Empty => new ServiceMetricAlarmRuleCompositeExpressionGetArgs();
    }
}
