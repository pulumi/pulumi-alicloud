...
namespace Pulumi.AliCloud.CloudMonitor.Inputs
{
    ...
    public sealed class ServiceMetricAlarmRulePrometheusArgs : global::Pulumi.ResourceArgs
    {
        [Input("annotations")]
        private InputList<Inputs.ServiceMetricAlarmRulePrometheusAnnotationArgs>? _annotations;
        ...
        /// </summary>
        public InputList<Inputs.ServiceMetricAlarmRulePrometheusAnnotationArgs> Annotations
        {
            get => _annotations ?? (_annotations = new InputList<Inputs.ServiceMetricAlarmRulePrometheusAnnotationArgs>());
        ...
        public ServiceMetricAlarmRulePrometheusArgs()
        {
        }
        public static new ServiceMetricAlarmRulePrometheusArgs Empty => new ServiceMetricAlarmRulePrometheusArgs();
    }
}
