...
namespace Pulumi.AliCloud.Dcdn.Inputs
{
    ...
    public sealed class ErEnvConfPresetCanaryOverseasGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("allowedHosts")]
        ...
        public ErEnvConfPresetCanaryOverseasGetArgs()
        {
        }
        public static new ErEnvConfPresetCanaryOverseasGetArgs Empty => new ErEnvConfPresetCanaryOverseasGetArgs();
    }
}
