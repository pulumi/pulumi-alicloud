...
namespace Pulumi.AliCloud.Dcdn.Inputs
{
    ...
    public sealed class ErEnvConfPresetCanaryShanxiArgs : global::Pulumi.ResourceArgs
    {
        [Input("allowedHosts")]
        ...
        public ErEnvConfPresetCanaryShanxiArgs()
        {
        }
        public static new ErEnvConfPresetCanaryShanxiArgs Empty => new ErEnvConfPresetCanaryShanxiArgs();
    }
}
