...
def get_msc_sub_subscriptions(output_file: Optional[builtins.str] = None,
...
def get_msc_sub_subscriptions_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
