...
def get_msc_sub_contact_verification_message(contact_id: Optional[builtins.str] = None,
    ...
    :param builtins.str contact_id: The ID of the Contact.
    :param builtins.int type: How a user receives verification messages. Valid values : `1`, `2`.
    """
    __args__ = dict()
...
def get_msc_sub_contact_verification_message_output(contact_id: Optional[pulumi.Input[builtins.str]] = None,
