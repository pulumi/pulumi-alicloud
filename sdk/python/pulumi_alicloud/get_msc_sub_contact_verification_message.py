...
def get_msc_sub_contact_verification_message(contact_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str contact_id: The ID of the Contact.
    :param _builtins.int type: How a user receives verification messages. Valid values : `1`, `2`.
    """
    __args__ = dict()
