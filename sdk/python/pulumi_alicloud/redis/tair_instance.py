...
class TairInstanceArgs:
    def __init__(__self__, *,
                 ...
                 cluster_backup_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 intranet_bandwidth: Optional[pulumi.Input[builtins.int]] = None,
                 modify_mode: Optional[pulumi.Input[builtins.str]] = None,
                 node_type: Optional[pulumi.Input[builtins.str]] = None,
                 param_no_loose_sentinel_enabled: Optional[pulumi.Input[builtins.str]] = None,
                 param_no_loose_sentinel_password_free_access: Optional[pulumi.Input[builtins.str]] = None,
                 param_no_loose_sentinel_password_free_commands: Optional[pulumi.Input[builtins.str]] = None,
                 param_repl_mode: Optional[pulumi.Input[builtins.str]] = None,
                 param_semisync_repl_timeout: Optional[pulumi.Input[builtins.str]] = None,
                 param_sentinel_compat_enable: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 recover_config_mode: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 src_db_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_enabled: Optional[pulumi.Input[builtins.str]] = None,
                 storage_performance_level: Optional[pulumi.Input[builtins.str]] = None,
                 storage_size_gb: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 tair_instance_name: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_auth_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a TairInstance resource.
        :param pulumi.Input[builtins.str] instance_class: The instance type of the instance. For more information, see [Instance types](https://www.alibabacloud.com/help/en/apsaradb-for-redis/latest/instance-types).
        :param pulumi.Input[builtins.str] instance_type: The storage medium of the instance. Valid values: tair_rdb, tair_scm, tair_essd.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the virtual private cloud (VPC).
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the vSwitch to which the instance is connected.
        :param pulumi.Input[builtins.str] zone_id: Zone ID
        :param pulumi.Input[builtins.str] auto_renew: Specifies whether to enable auto-renewal for the instance. Default value: false. Valid values: true(enables auto-renewal), false(disables auto-renewal).
        :param pulumi.Input[builtins.str] auto_renew_period: The subscription duration that is supported by auto-renewal. Unit: months. Valid values: 1, 2, 3, 6, and 12. This parameter is required only if the AutoRenew parameter is set to true.
        :param pulumi.Input[builtins.str] backup_id: You can set the BackupId parameter to the backup set ID of the source instance. The system uses the data stored in the backup set to create an instance. You can call the DescribeBackups operation to query backup set IDs. If the source instance is a cluster instance, set the BackupId parameter to the backup set IDs of all shards of the source instance, separated by commas (,).
        ...
        :param pulumi.Input[builtins.str] cluster_backup_id: This parameter is supported for specific new cluster instances. You can query the backup set ID by calling the DescribeClusterBackupList operation. If this parameter is supported, you can specify the backup set ID. In this case, you do not need to specify the BackupId parameter. If this parameter is not supported, set the BackupId parameter to the IDs of backup sets in all shards of the source instance, separated by commas (,).
        :param pulumi.Input[builtins.str] connection_string_prefix: The prefix of the endpoint the instance, which must consist of lowercase letters and numbers and start with a lowercase letter.
        :param pulumi.Input[builtins.str] effective_time: The time when to change the configurations. Default value: Immediately. Valid values: Immediately (The configurations are immediately changed), MaintainTime (The configurations are changed within the maintenance window).
        :param pulumi.Input[builtins.str] engine_version: Database version. Default value: 1.0.
        ...
        :param pulumi.Input[builtins.bool] force_upgrade: Specifies whether to forcefully change the configurations of the instance. Default value: true. Valid values: false (The system does not forcefully change the configurations), true (The system forcefully changes the configurations).
        :param pulumi.Input[builtins.str] global_instance_id: The ID of a distributed (Global Distributed Cache) instance, which indicates whether to use the newly created instance as a sub-instance of a distributed instance. You can use this method to create a distributed instance.
        ...
        :param pulumi.Input[builtins.int] intranet_bandwidth: Instance intranet bandwidth
        :param pulumi.Input[builtins.str] modify_mode: The modification method when modifying the IP whitelist. The value includes Cover (default): overwrite the original whitelist; Append: Append the whitelist; Delete: Delete the whitelist.
        :param pulumi.Input[builtins.str] node_type: The node type. For cloud-native instances, input MASTER_SLAVE (master-replica) or STAND_ALONE (standalone). For classic instances, input double (master-replica) or single (standalone).
        :param pulumi.Input[builtins.str] param_no_loose_sentinel_enabled: sentinel compatibility mode, applicable to non-cluster instances. For more information about parameters, see yes or no in the https://www.alibabacloud.com/help/en/redis/user-guide/use-the-sentinel-compatible-mode-to-connect-to-an-apsaradb-for-redis-instance, valid values: yes, no. The default value is no.
        :param pulumi.Input[builtins.str] param_no_loose_sentinel_password_free_access: Whether to allow Sentinel commands to be executed without secrets when Sentinel mode is enabled. Value: yes: enabled. After the command is enabled, you can directly run the Sentinel command in the VPC without enabling the password-free feature. no: the default value, disabled. For parameters, see https://help.aliyun.com/zh/redis/user-guide/use-the-sentinel-compatible-mode-to-connect-to-an-apsaradb-for-redis-instance
        :param pulumi.Input[builtins.str] param_no_loose_sentinel_password_free_commands: After sentinel mode and the# no_loose_sentinel-password-free-access parameter are enabled, you can use this parameter to add additional secret-free command lists (empty by default). After setting, you can execute the corresponding command on any connection without secret, please operate carefully. Commands are written in lowercase letters, and multiple commands are separated by commas (,). See https://help.aliyun.com/zh/redis/user-guide/parameter-support for details
        :param pulumi.Input[builtins.str] param_repl_mode: The value is semisync or async. The default value is async.
        ...
        :param pulumi.Input[builtins.str] param_semisync_repl_timeout: The degradation threshold time of the semi-synchronous replication mode. This parameter value is required only when semi-synchronous replication is enabled. The unit is milliseconds, and the range is 10ms to 60000ms. The default value is 500ms. Please refer to: https://www.alibabacloud.com/help/en/redis/user-guide/modify-the-synchronization-mode-of-a-persistent-memory-optimized-instance.
        :param pulumi.Input[builtins.str] param_sentinel_compat_enable: sentinel compatibility mode, applicable to instances in the cluster architecture proxy connection mode or read/write splitting architecture. For more information about the parameters, see https://www.alibabacloud.com/help/en/redis/user-guide/use-the-sentinel-compatible-mode-to-connect-to-an-apsaradb-for-redis-instance. The value is 0 or 1. The default value is 0.
        :param pulumi.Input[builtins.str] password: The password that is used to connect to the instance. The password must be 8 to 32 characters in length and contain at least three of the following character types: uppercase letters, lowercase letters, digits, and special characters. Special characters include ! @ # $ % ^ & * ( ) _ + - =
        :param pulumi.Input[builtins.str] payment_type: Payment type: Subscription (prepaid), PayAsYouGo (postpaid). Default Subscription.
        :param pulumi.Input[builtins.int] period: The subscription duration. Unit: months. Valid values: 1, 2, 3, 4, 5, 6, 7, 8, 9, 12, 24,36, and 60. This parameter is required only if you set the PaymentType parameter to Subscription.
        :param pulumi.Input[builtins.int] port: The Tair service port. The service port of the instance. Valid values: 1024 to 65535. Default value: 6379.
        :param pulumi.Input[builtins.int] read_only_count: Number of read-only nodes in the primary zone. Valid values: 0 to 5. This parameter is only applicable to the following conditions:
        ...
        :param pulumi.Input[builtins.str] src_db_instance_id: If you want to create an instance based on the backup set of an existing instance, set this parameter to the ID of the source instance. preceding three parameters. After you specify the SrcDBInstanceId parameter, use the BackupId, ClusterBackupId (recommended for cloud-native cluster instances), or RestoreTime parameter to specify the backup set or the specific point in time that you want to use to create an instance. The SrcDBInstanceId parameter must be used in combination with one of the preceding three parameters.
        :param pulumi.Input[builtins.str] ssl_enabled: Modifies SSL encryption configurations. Valid values: 1. Disable (The SSL encryption is disabled) 2. Enable (The SSL encryption is enabled)  3. Update (The SSL certificate is updated)
        :param pulumi.Input[builtins.str] storage_performance_level: The storage type. Valid values: PL1, PL2, and PL3. This parameter is available only when the value of InstanceType is tair_essd, that is, when an ESSD disk instance is selected.
        ...
        :param pulumi.Input[builtins.int] storage_size_gb: Different specifications have different value ranges. When the instance_type value is tair_essd and the disk type is ESSD, this attribute takes effect and is required. When a Tair disk is an SSD, see-https://help.aliyun.com/zh/redis/product-overview/capacity-storage-type. The capacity field is defined as different fixed values according to different specifications, and does not need to be specified.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the resource
        :param pulumi.Input[builtins.str] tair_instance_name: The name of the resource.
        :param pulumi.Input[builtins.str] vpc_auth_mode: The VPC authentication mode. Valid values: Open (enables password authentication), Close (disables password authentication and enables [password-free access](https://www.alibabacloud.com/help/en/apsaradb-for-redis/latest/enable-password-free-access)).
        """
    ...
    def cluster_backup_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cluster_backup_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def intranet_bandwidth(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def intranet_bandwidth(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def param_no_loose_sentinel_enabled(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def param_no_loose_sentinel_enabled(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "param_no_loose_sentinel_enabled", value)

    @property
    @pulumi.getter(name="paramNoLooseSentinelPasswordFreeAccess")
    def param_no_loose_sentinel_password_free_access(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def param_no_loose_sentinel_password_free_access(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def param_no_loose_sentinel_password_free_commands(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def param_no_loose_sentinel_password_free_commands(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "param_no_loose_sentinel_password_free_commands", value)

    @property
    @pulumi.getter(name="paramReplMode")
    def param_repl_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def param_repl_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "param_repl_mode", value)

    @property
    @pulumi.getter(name="paramSemisyncReplTimeout")
    def param_semisync_repl_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def param_semisync_repl_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "param_semisync_repl_timeout", value)

    @property
    @pulumi.getter(name="paramSentinelCompatEnable")
    def param_sentinel_compat_enable(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def param_sentinel_compat_enable(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def recover_config_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def recover_config_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def src_db_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        If you want to create an instance based on the backup set of an existing instance, set this parameter to the ID of the source instance. preceding three parameters. After you specify the SrcDBInstanceId parameter, use the BackupId, ClusterBackupId (recommended for cloud-native cluster instances), or RestoreTime parameter to specify the backup set or the specific point in time that you want to use to create an instance. The SrcDBInstanceId parameter must be used in combination with one of the preceding three parameters.
        """
    ...
    def src_db_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "src_db_instance_id", value)

    @property
    @pulumi.getter(name="sslEnabled")
    def ssl_enabled(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ssl_enabled.setter
    def ssl_enabled(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ssl_enabled", value)

    @property
    @pulumi.getter(name="storagePerformanceLevel")
    def storage_performance_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_performance_level(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def tair_instance_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tair_instance_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TairInstanceState:
    def __init__(__self__, *,
                 architecture_type: Optional[pulumi.Input[builtins.str]] = None,
                 auto_renew: Optional[pulumi.Input[builtins.str]] = None,
                 auto_renew_period: Optional[pulumi.Input[builtins.str]] = None,
                 backup_id: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_backup_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 storage_size_gb: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 tair_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 tair_instance_name: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_auth_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] architecture_type: The architecture of the instance.  cluster, standard, rwsplit.
        :param pulumi.Input[builtins.str] auto_renew: Specifies whether to enable auto-renewal for the instance. Default value: false. Valid values: true(enables auto-renewal), false(disables auto-renewal).
        :param pulumi.Input[builtins.str] auto_renew_period: The subscription duration that is supported by auto-renewal. Unit: months. Valid values: 1, 2, 3, 6, and 12. This parameter is required only if the AutoRenew parameter is set to true.
        :param pulumi.Input[builtins.str] backup_id: You can set the BackupId parameter to the backup set ID of the source instance. The system uses the data stored in the backup set to create an instance. You can call the DescribeBackups operation to query backup set IDs. If the source instance is a cluster instance, set the BackupId parameter to the backup set IDs of all shards of the source instance, separated by commas (,).
               ...
               If your instance is a cloud-native cluster instance, we recommend that you use DescribeClusterBackupList to query the backup set ID of the cluster instance. Then, set the ClusterBackupId request parameter to the backup set ID to clone the cluster instance. This eliminates the need to specify the backup set ID of each shard.
        :param pulumi.Input[builtins.str] cluster_backup_id: This parameter is supported for specific new cluster instances. You can query the backup set ID by calling the DescribeClusterBackupList operation. If this parameter is supported, you can specify the backup set ID. In this case, you do not need to specify the BackupId parameter. If this parameter is not supported, set the BackupId parameter to the IDs of backup sets in all shards of the source instance, separated by commas (,).
        :param pulumi.Input[builtins.str] connection_domain: The internal endpoint of the instance.
        :param pulumi.Input[builtins.str] connection_string_prefix: The prefix of the endpoint the instance, which must consist of lowercase letters and numbers and start with a lowercase letter.
        :param pulumi.Input[builtins.str] create_time: The time when the instance was created. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        :param pulumi.Input[builtins.str] effective_time: The time when to change the configurations. Default value: Immediately. Valid values: Immediately (The configurations are immediately changed), MaintainTime (The configurations are changed within the maintenance window).
        :param pulumi.Input[builtins.str] engine_version: Database version. Default value: 1.0.
        ...
        :param pulumi.Input[builtins.str] instance_type: The storage medium of the instance. Valid values: tair_rdb, tair_scm, tair_essd.
        :param pulumi.Input[builtins.int] intranet_bandwidth: Instance intranet bandwidth
        :param pulumi.Input[builtins.int] max_connections: The maximum number of connections supported by the instance.
        :param pulumi.Input[builtins.str] modify_mode: The modification method when modifying the IP whitelist. The value includes Cover (default): overwrite the original whitelist; Append: Append the whitelist; Delete: Delete the whitelist.
        :param pulumi.Input[builtins.str] network_type: The network type of the instance.  CLASSIC(classic network), VPC.
        :param pulumi.Input[builtins.str] node_type: The node type. For cloud-native instances, input MASTER_SLAVE (master-replica) or STAND_ALONE (standalone). For classic instances, input double (master-replica) or single (standalone).
        :param pulumi.Input[builtins.str] param_no_loose_sentinel_enabled: sentinel compatibility mode, applicable to non-cluster instances. For more information about parameters, see yes or no in the https://www.alibabacloud.com/help/en/redis/user-guide/use-the-sentinel-compatible-mode-to-connect-to-an-apsaradb-for-redis-instance, valid values: yes, no. The default value is no.
        :param pulumi.Input[builtins.str] param_no_loose_sentinel_password_free_access: Whether to allow Sentinel commands to be executed without secrets when Sentinel mode is enabled. Value: yes: enabled. After the command is enabled, you can directly run the Sentinel command in the VPC without enabling the password-free feature. no: the default value, disabled. For parameters, see https://help.aliyun.com/zh/redis/user-guide/use-the-sentinel-compatible-mode-to-connect-to-an-apsaradb-for-redis-instance
        :param pulumi.Input[builtins.str] param_no_loose_sentinel_password_free_commands: After sentinel mode and the# no_loose_sentinel-password-free-access parameter are enabled, you can use this parameter to add additional secret-free command lists (empty by default). After setting, you can execute the corresponding command on any connection without secret, please operate carefully. Commands are written in lowercase letters, and multiple commands are separated by commas (,). See https://help.aliyun.com/zh/redis/user-guide/parameter-support for details
        ...
        :param pulumi.Input[builtins.int] storage_size_gb: Different specifications have different value ranges. When the instance_type value is tair_essd and the disk type is ESSD, this attribute takes effect and is required. When a Tair disk is an SSD, see-https://help.aliyun.com/zh/redis/product-overview/capacity-storage-type. The capacity field is defined as different fixed values according to different specifications, and does not need to be specified.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the resource
        :param pulumi.Input[builtins.str] tair_instance_id: The ID of the resource.
        :param pulumi.Input[builtins.str] tair_instance_name: The name of the resource.
        :param pulumi.Input[builtins.str] vpc_auth_mode: The VPC authentication mode. Valid values: Open (enables password authentication), Close (disables password authentication and enables [password-free access](https://www.alibabacloud.com/help/en/apsaradb-for-redis/latest/enable-password-free-access)).
        :param pulumi.Input[builtins.str] vpc_id: The ID of the virtual private cloud (VPC).
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the vSwitch to which the instance is connected.
    ...
    def architecture_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def architecture_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def tair_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tair_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TairInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TairInstance':
        """
    ...
    @property
    @pulumi.getter(name="architectureType")
    def architecture_type(self) -> pulumi.Output[builtins.str]:
        """
        The architecture of the instance.  cluster, standard, rwsplit.
        """
        return pulumi.get(self, "architecture_type")
    ...
    @property
    @pulumi.getter(name="clusterBackupId")
    def cluster_backup_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This parameter is supported for specific new cluster instances. You can query the backup set ID by calling the DescribeClusterBackupList operation. If this parameter is supported, you can specify the backup set ID. In this case, you do not need to specify the BackupId parameter. If this parameter is not supported, set the BackupId parameter to the IDs of backup sets in all shards of the source instance, separated by commas (,).
        """
        return pulumi.get(self, "cluster_backup_id")
    ...
    @property
    @pulumi.getter(name="intranetBandwidth")
    def intranet_bandwidth(self) -> pulumi.Output[builtins.int]:
        """
        Instance intranet bandwidth
        """
        return pulumi.get(self, "intranet_bandwidth")
    ...
    @property
    @pulumi.getter(name="paramNoLooseSentinelEnabled")
    def param_no_loose_sentinel_enabled(self) -> pulumi.Output[builtins.str]:
        """
        sentinel compatibility mode, applicable to non-cluster instances. For more information about parameters, see yes or no in the https://www.alibabacloud.com/help/en/redis/user-guide/use-the-sentinel-compatible-mode-to-connect-to-an-apsaradb-for-redis-instance, valid values: yes, no. The default value is no.
        """
        return pulumi.get(self, "param_no_loose_sentinel_enabled")
    ...
    @property
    @pulumi.getter(name="paramNoLooseSentinelPasswordFreeAccess")
    def param_no_loose_sentinel_password_free_access(self) -> pulumi.Output[builtins.str]:
        """
        Whether to allow Sentinel commands to be executed without secrets when Sentinel mode is enabled. Value: yes: enabled. After the command is enabled, you can directly run the Sentinel command in the VPC without enabling the password-free feature. no: the default value, disabled. For parameters, see https://help.aliyun.com/zh/redis/user-guide/use-the-sentinel-compatible-mode-to-connect-to-an-apsaradb-for-redis-instance
        """
        return pulumi.get(self, "param_no_loose_sentinel_password_free_access")
    ...
    @property
    @pulumi.getter(name="paramNoLooseSentinelPasswordFreeCommands")
    def param_no_loose_sentinel_password_free_commands(self) -> pulumi.Output[builtins.str]:
        """
        After sentinel mode and the# no_loose_sentinel-password-free-access parameter are enabled, you can use this parameter to add additional secret-free command lists (empty by default). After setting, you can execute the corresponding command on any connection without secret, please operate carefully. Commands are written in lowercase letters, and multiple commands are separated by commas (,). See https://help.aliyun.com/zh/redis/user-guide/parameter-support for details
        """
        return pulumi.get(self, "param_no_loose_sentinel_password_free_commands")
    ...
    @property
    @pulumi.getter(name="paramReplMode")
    def param_repl_mode(self) -> pulumi.Output[builtins.str]:
        """
        The value is semisync or async. The default value is async.
    ...
    @property
    @pulumi.getter(name="paramSemisyncReplTimeout")
    def param_semisync_repl_timeout(self) -> pulumi.Output[builtins.str]:
        """
        The degradation threshold time of the semi-synchronous replication mode. This parameter value is required only when semi-synchronous replication is enabled. The unit is milliseconds, and the range is 10ms to 60000ms. The default value is 500ms. Please refer to: https://www.alibabacloud.com/help/en/redis/user-guide/modify-the-synchronization-mode-of-a-persistent-memory-optimized-instance.
        """
        return pulumi.get(self, "param_semisync_repl_timeout")
    ...
    @property
    @pulumi.getter(name="paramSentinelCompatEnable")
    def param_sentinel_compat_enable(self) -> pulumi.Output[builtins.str]:
        """
        sentinel compatibility mode, applicable to instances in the cluster architecture proxy connection mode or read/write splitting architecture. For more information about the parameters, see https://www.alibabacloud.com/help/en/redis/user-guide/use-the-sentinel-compatible-mode-to-connect-to-an-apsaradb-for-redis-instance. The value is 0 or 1. The default value is 0.
        """
        return pulumi.get(self, "param_sentinel_compat_enable")
    ...
    @property
    @pulumi.getter(name="recoverConfigMode")
    def recover_config_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether to restore the account, kernel parameters, and whitelist (config) information from the original backup set when creating an instance using a specified backup set. The default value is empty, indicating that the account, kernel parameters, and whitelist information are not restored from the original backup set. This parameter is only applicable to Cloud Native instances, and the account, kernel parameters, and whitelist information must have been saved in the original backup set.
        """
        return pulumi.get(self, "recover_config_mode")
    ...
    @property
    @pulumi.getter(name="srcDbInstanceId")
    def src_db_instance_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If you want to create an instance based on the backup set of an existing instance, set this parameter to the ID of the source instance. preceding three parameters. After you specify the SrcDBInstanceId parameter, use the BackupId, ClusterBackupId (recommended for cloud-native cluster instances), or RestoreTime parameter to specify the backup set or the specific point in time that you want to use to create an instance. The SrcDBInstanceId parameter must be used in combination with one of the preceding three parameters.
        """
        return pulumi.get(self, "src_db_instance_id")
    ...
    @property
    @pulumi.getter(name="sslEnabled")
    def ssl_enabled(self) -> pulumi.Output[builtins.str]:
        """
        Modifies SSL encryption configurations. Valid values: 1. Disable (The SSL encryption is disabled) 2. Enable (The SSL encryption is enabled)  3. Update (The SSL certificate is updated)
        """
        return pulumi.get(self, "ssl_enabled")
    ...
    @property
    @pulumi.getter(name="storagePerformanceLevel")
    def storage_performance_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The storage type. Valid values: PL1, PL2, and PL3. This parameter is available only when the value of InstanceType is tair_essd, that is, when an ESSD disk instance is selected.
    ...
    @property
    @pulumi.getter(name="storageSizeGb")
    def storage_size_gb(self) -> pulumi.Output[builtins.int]:
        """
        Different specifications have different value ranges. When the instance_type value is tair_essd and the disk type is ESSD, this attribute takes effect and is required. When a Tair disk is an SSD, see-https://help.aliyun.com/zh/redis/product-overview/capacity-storage-type. The capacity field is defined as different fixed values according to different specifications, and does not need to be specified.
        """
        return pulumi.get(self, "storage_size_gb")
    ...
    @property
    @pulumi.getter(name="tairInstanceId")
    def tair_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the resource.
        """
        return pulumi.get(self, "tair_instance_id")
    ...
    @property
    @pulumi.getter(name="tairInstanceName")
    def tair_instance_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "tair_instance_name")
