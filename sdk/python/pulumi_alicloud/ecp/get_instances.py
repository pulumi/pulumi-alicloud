...
def get_instances(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ecp Instances IDs.
    :param builtins.str image_id: The ID Of The Image.
    :param builtins.str instance_name: The name of the instance. It must be 2 to 128 characters in length and must start with an
    ...
    :param builtins.str key_pair_name: The name of the key pair of the mobile phone instance.
    :param builtins.str name_regex: A regex string to filter results by mobile phone name.
    ...
    :param builtins.str resolution: The selected resolution for the cloud mobile phone instance.
    :param builtins.str status: Instance status. Valid values: `Pending`, `Running`, `Starting`, `Stopped`, `Stopping`
           .
    """
    __args__ = dict()
...
def get_instances_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                         ...
                         key_pair_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         ...
                         resolution: Optional[pulumi.Input[Optional[builtins.str]]] = None,
