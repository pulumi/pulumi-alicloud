...
def get_instances(enable_details: Optional[_builtins.bool] = None,
    ...
    zone_id = count_size.apply(lambda count_size: default.zones[count_size - 1]).zone_id
    instance_type_count_size = len(default_get_instance_types.instance_types)
    instance_type = instance_type_count_size.apply(lambda instance_type_count_size: default_get_instance_types.instance_types[instance_type_count_size - 1]).instance_type
