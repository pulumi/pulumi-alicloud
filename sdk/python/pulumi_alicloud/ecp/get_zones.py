...
def get_zones(output_file: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:ecp/getZones:getZones', __args__, opts=opts, typ=GetZonesResult).value
...
def get_zones_output(output_file: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['outputFile'] = output_file
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('alicloud:ecp/getZones:getZones', __args__, opts=opts, typ=GetZonesResult)
