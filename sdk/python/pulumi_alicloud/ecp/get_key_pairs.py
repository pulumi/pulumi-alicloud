...
class GetKeyPairsResult:
    ...
    def key_pair_finger_print(self) -> Optional[builtins.str]:
...
def get_key_pairs(ids: Optional[Sequence[builtins.str]] = None,
                  key_pair_finger_print: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Key Pair IDs. Its element value is same as Key Pair Name.
...
def get_key_pairs_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                         key_pair_finger_print: Optional[pulumi.Input[Optional[builtins.str]]] = None,
