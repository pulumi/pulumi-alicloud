...
def get_key_pairs_output(ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                         key_pair_finger_print: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
