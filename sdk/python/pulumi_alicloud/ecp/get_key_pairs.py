...
class GetKeyPairsResult:
    ...
    def key_pair_finger_print(self) -> Optional[_builtins.str]:
...
def get_key_pairs(ids: Optional[Sequence[_builtins.str]] = None,
                  key_pair_finger_print: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Key Pair IDs. Its element value is same as Key Pair Name.
...
def get_key_pairs_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                         key_pair_finger_print: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:ecp/getKeyPairs:getKeyPairs', __args__, opts=opts, typ=GetKeyPairsResult)
    return __ret__.apply(lambda __response__: GetKeyPairsResult(
        id=pulumi.get(__response__, 'id'),
        ids=pulumi.get(__response__, 'ids'),
        key_pair_finger_print=pulumi.get(__response__, 'key_pair_finger_print'),
