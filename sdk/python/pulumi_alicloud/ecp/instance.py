...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 eip_bandwidth: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 vnc_password: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Instance resource.
        :param pulumi.Input[builtins.str] image_id: The ID of the image.
        :param pulumi.Input[builtins.str] instance_type: The specifications of the ECP instance.
        ...
        :param pulumi.Input[builtins.bool] auto_pay: Specifies whether to enable the auto-payment feature. Valid values:
        :param pulumi.Input[builtins.bool] auto_renew: Specifies whether to enable the auto-renewal feature. Valid values:
        :param pulumi.Input[builtins.str] description: The description of the ECP instance. The description must be `2` to `256` characters in length and cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.int] eip_bandwidth: The bandwidth of the elastic IP address (EIP). **NOTE:** From version 1.232.0, `eip_bandwidth` cannot be modified.
        :param pulumi.Input[builtins.bool] force: Specifies whether to forcefully stop and release the instance. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.str] instance_name: The name of the ECP instance. The name must be `2` to `128` characters in length. It must start with a letter but cannot start with `http://` or `https://`. It can contain letters, digits, colons (:), underscores (_), periods (.), and hyphens (-).
        :param pulumi.Input[builtins.str] key_pair_name: The name of the key pair that you want to use to connect to the instance.
        :param pulumi.Input[builtins.str] payment_type: The billing method of the ECP instance. Default value: `PayAsYouGo`. Valid values: `PayAsYouGo`,`Subscription`. **NOTE:** From version 1.232.0, `payment_type` cannot be modified.
        :param pulumi.Input[builtins.str] period: The subscription duration. Default value: `1`. Valid values:
               - If `period_unit` is set to `Month`. Valid values: `1`, `2`, `3`, and `6`.
               - If `period_unit` is set to `Year`. Valid values: `1` to `5`.
        :param pulumi.Input[builtins.str] period_unit: The unit of the subscription duration. Default value: `Month`. Valid values: `Month`, `Year`.
        :param pulumi.Input[builtins.str] resolution: The resolution that you want to select for the ECP instance. **NOTE:** From version 1.232.0, `resolution` can be modified.
        :param pulumi.Input[builtins.str] status: The status of the Instance. Valid values: `Running`, `Stopped`.
        :param pulumi.Input[builtins.str] vnc_password: The VNC password of the instance. The password must be `6` characters in length and can contain only uppercase letters, lowercase letters, and digits.
        """
    ...
    def eip_bandwidth(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def eip_bandwidth(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def vnc_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @vnc_password.setter
    def vnc_password(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Instance(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:ecp/instance:Instance"
    ...
    @property
    @pulumi.getter(name="eipBandwidth")
    def eip_bandwidth(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The bandwidth of the elastic IP address (EIP). **NOTE:** From version 1.232.0, `eip_bandwidth` cannot be modified.
        """
        return pulumi.get(self, "eip_bandwidth")
    ...
    @property
    @pulumi.getter(name="vncPassword")
    def vnc_password(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The VNC password of the instance. The password must be `6` characters in length and can contain only uppercase letters, lowercase letters, and digits.
        """
        return pulumi.get(self, "vnc_password")
