...
def get_dedicated_host_groups(engine: Optional[_builtins.str] = None,
    ...
    :param _builtins.str engine: Database Engine Type. Valid values:`Redis`, `SQLServer`, `MySQL`, `PostgreSQL`, `MongoDB`
    :param Sequence[_builtins.str] ids: A list of Dedicated Host Group IDs.
    :param _builtins.str name_regex: A regex string to filter results by Dedicated Host Group name.
...
def get_dedicated_host_groups_output(engine: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
