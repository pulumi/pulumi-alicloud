...
class DedicatedHostArgs:
    def __init__(__self__, *,
                 ...
                 host_class: pulumi.Input[builtins.str],
                 ...
                 image_category: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] dedicated_host_group_id: The ID of the dedicated cluster.
        :param pulumi.Input[builtins.str] host_class: The instance type of the host. For more information about the supported instance types of hosts, see [Host specification details](https://www.alibabacloud.com/help/doc-detail/206343.htm).
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource. Valid values: `Subscription`.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the vSwitch to which the host is connected.
        :param pulumi.Input[builtins.str] zone_id: The ID of the zone.
        :param pulumi.Input[builtins.str] allocation_status: Specifies whether instances can be created on the host. Valid values: `Allocatable` or `Suspended`. `Allocatable`: Instances can be created on the host. `Suspended`: Instances cannot be created on the host.
        :param pulumi.Input[builtins.bool] auto_renew: Specifies whether to enable the auto-renewal feature.
        :param pulumi.Input[builtins.str] host_name: The name of the host. The name must be `1` to `64` characters in length and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter.
        :param pulumi.Input[builtins.str] image_category: Host Image Category. Valid values: `WindowsWithMssqlEntAlwaysonLicense`, `WindowsWithMssqlStdLicense`, `WindowsWithMssqlEntLicense`, `WindowsWithMssqlWebLicense`, `AliLinux`.
        :param pulumi.Input[builtins.str] os_password: Host password. **NOTE:** The creation of a host password is supported only when the database type is `Tair-PMem`.
        :param pulumi.Input[builtins.str] period: The unit of the subscription duration. Valid values: `Year`, `Month`, `Week`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.int] used_time: The subscription duration of the host. Valid values: 
    ...
    def host_class(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @host_class.setter
    def host_class(self, value: pulumi.Input[builtins.str]):
    ...
    def image_category(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def image_category(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DedicatedHostState:
    def __init__(__self__, *,
                 ...
                 host_class: Optional[pulumi.Input[builtins.str]] = None,
                 host_name: Optional[pulumi.Input[builtins.str]] = None,
                 image_category: Optional[pulumi.Input[builtins.str]] = None,
                 os_password: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] auto_renew: Specifies whether to enable the auto-renewal feature.
        :param pulumi.Input[builtins.str] dedicated_host_group_id: The ID of the dedicated cluster.
        :param pulumi.Input[builtins.str] dedicated_host_id: The ID of the host.
        :param pulumi.Input[builtins.str] host_class: The instance type of the host. For more information about the supported instance types of hosts, see [Host specification details](https://www.alibabacloud.com/help/doc-detail/206343.htm).
        :param pulumi.Input[builtins.str] host_name: The name of the host. The name must be `1` to `64` characters in length and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter.
        :param pulumi.Input[builtins.str] image_category: Host Image Category. Valid values: `WindowsWithMssqlEntAlwaysonLicense`, `WindowsWithMssqlStdLicense`, `WindowsWithMssqlEntLicense`, `WindowsWithMssqlWebLicense`, `AliLinux`.
        :param pulumi.Input[builtins.str] os_password: Host password. **NOTE:** The creation of a host password is supported only when the database type is `Tair-PMem`.
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource. Valid values: `Subscription`.
        :param pulumi.Input[builtins.str] period: The unit of the subscription duration. Valid values: `Year`, `Month`, `Week`.
        :param pulumi.Input[builtins.str] status: The state of the host. Valid values: `0:` The host is being created. `1`: The host is running. `2`: The host is faulty. `3`: The host is ready for deactivation. `4`: The host is being maintained. `5`: The host is deactivated. `6`: The host is restarting. `7`: The host is locked.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.int] used_time: The subscription duration of the host. Valid values: 
               * If the Period parameter is set to `Year`, the value of the UsedTime parameter ranges from `1` to `5`.
               * If the Period parameter is set to `Month`, the value of the UsedTime parameter ranges from `1` to `9`.
    ...
    @property
    @pulumi.getter(name="hostClass")
    def host_class(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The instance type of the host. For more information about the supported instance types of hosts, see [Host specification details](https://www.alibabacloud.com/help/doc-detail/206343.htm).
        """
        return pulumi.get(self, "host_class")
    ...
    @host_class.setter
    def host_class(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "host_class", value)
...
class DedicatedHost(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="hostClass")
    def host_class(self) -> pulumi.Output[builtins.str]:
        """
        The instance type of the host. For more information about the supported instance types of hosts, see [Host specification details](https://www.alibabacloud.com/help/doc-detail/206343.htm).
        """
        return pulumi.get(self, "host_class")
    ...
    @property
    @pulumi.getter(name="imageCategory")
    def image_category(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Host Image Category. Valid values: `WindowsWithMssqlEntAlwaysonLicense`, `WindowsWithMssqlStdLicense`, `WindowsWithMssqlEntLicense`, `WindowsWithMssqlWebLicense`, `AliLinux`.
        """
        return pulumi.get(self, "image_category")
