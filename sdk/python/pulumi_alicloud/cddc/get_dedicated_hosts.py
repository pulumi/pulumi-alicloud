...
class GetDedicatedHostsResult:
    ...
    def allocation_status(self) -> Optional[builtins.str]:
    ...
    def order_id(self) -> Optional[builtins.str]:
...
def get_dedicated_hosts(allocation_status: Optional[builtins.str] = None,
                        dedicated_host_group_id: Optional[builtins.str] = None,
                        enable_details: Optional[builtins.bool] = None,
                        host_type: Optional[builtins.str] = None,
                        ids: Optional[Sequence[builtins.str]] = None,
                        order_id: Optional[builtins.str] = None,
    ...
    :param builtins.str allocation_status: Specifies whether instances can be created on the host. Valid values: `Allocatable` or `Suspended`. `Allocatable`: Instances can be created on the host. `Suspended`: Instances cannot be created on the host.
    :param builtins.str dedicated_host_group_id: The ID of the dedicated cluster.
    :param builtins.bool enable_details: Default to `false`. Set it to `true` can output more details about resource attributes.
    :param builtins.str host_type: The storage type of the host. Valid values: `dhg_local_ssd` or `dhg_cloud_ssd`. `dhg_local_ssd`: specifies that the host uses local SSDs. `dhg_cloud_ssd`: specifies that the host uses enhanced SSDs (ESSDs).
    :param Sequence[builtins.str] ids: A list of Dedicated Host IDs.
    :param builtins.str order_id: The ID of the order.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The state of the host. Valid values: 
...
def get_dedicated_hosts_output(allocation_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               ...
                               host_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                               order_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
