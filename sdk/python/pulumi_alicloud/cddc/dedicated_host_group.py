...
class DedicatedHostGroupArgs:
    def __init__(__self__, *,
                 ...
                 allocation_policy: Optional[pulumi.Input[builtins.str]] = None,
                 cpu_allocation_ratio: Optional[pulumi.Input[builtins.int]] = None,
                 dedicated_host_group_desc: Optional[pulumi.Input[builtins.str]] = None,
                 disk_allocation_ratio: Optional[pulumi.Input[builtins.int]] = None,
                 host_replace_policy: Optional[pulumi.Input[builtins.str]] = None,
                 mem_allocation_ratio: Optional[pulumi.Input[builtins.int]] = None,
                 open_permission: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a DedicatedHostGroup resource.
        :param pulumi.Input[builtins.str] engine: Database Engine Type.The database engine of the dedicated cluster. Valid values:`Redis`, `SQLServer`, `MySQL`, `PostgreSQL`, `MongoDB`, `alisql`, `tair`, `mssql`. **NOTE:** Since v1.210.0., the `engine = SQLServer` was deprecated.
        :param pulumi.Input[builtins.str] vpc_id: The virtual private cloud (VPC) ID of the dedicated cluster.
        :param pulumi.Input[builtins.str] allocation_policy: AThe policy that is used to allocate resources in the dedicated cluster. Valid values:`Evenly`,`Intensively`
        :param pulumi.Input[builtins.int] cpu_allocation_ratio: The CPU overcommitment ratio of the dedicated cluster.Valid values: 100 to 300. Default value: 200.
        :param pulumi.Input[builtins.str] dedicated_host_group_desc: The name of the dedicated cluster. The name must be 1 to 64 characters in length and can contain letters, digits, underscores (_), and hyphens (-). It must start with a letter.
        :param pulumi.Input[builtins.int] disk_allocation_ratio: The Disk Allocation Ratio of the Dedicated Host Group. **NOTE:** When `engine = SQLServer`, this attribute does not support to set.
        :param pulumi.Input[builtins.str] host_replace_policy: The policy based on which the system handles host failures. Valid values:`Auto`,`Manual`
        :param pulumi.Input[builtins.int] mem_allocation_ratio: The Memory Allocation Ratio of the Dedicated Host Group.
        :param pulumi.Input[builtins.bool] open_permission: Whether to enable the feature that allows you to have OS permissions on the hosts in the dedicated cluster. Valid values: `true` and `false`.
    ...
    def allocation_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def allocation_policy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "allocation_policy", value)

    @property
    @pulumi.getter(name="cpuAllocationRatio")
    def cpu_allocation_ratio(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cpu_allocation_ratio(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cpu_allocation_ratio", value)

    @property
    @pulumi.getter(name="dedicatedHostGroupDesc")
    def dedicated_host_group_desc(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dedicated_host_group_desc(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dedicated_host_group_desc", value)

    @property
    @pulumi.getter(name="diskAllocationRatio")
    def disk_allocation_ratio(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def disk_allocation_ratio(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "disk_allocation_ratio", value)

    @property
    @pulumi.getter(name="hostReplacePolicy")
    def host_replace_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def host_replace_policy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "host_replace_policy", value)

    @property
    @pulumi.getter(name="memAllocationRatio")
    def mem_allocation_ratio(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def mem_allocation_ratio(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "mem_allocation_ratio", value)

    @property
    @pulumi.getter(name="openPermission")
    def open_permission(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def open_permission(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DedicatedHostGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            mem_allocation_ratio: Optional[pulumi.Input[builtins.int]] = None,
            open_permission: Optional[pulumi.Input[builtins.bool]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DedicatedHostGroup':
        """
    ...
    @property
    @pulumi.getter(name="allocationPolicy")
    def allocation_policy(self) -> pulumi.Output[builtins.str]:
        """
        AThe policy that is used to allocate resources in the dedicated cluster. Valid values:`Evenly`,`Intensively`
        """
        return pulumi.get(self, "allocation_policy")
    ...
    @property
    @pulumi.getter(name="cpuAllocationRatio")
    def cpu_allocation_ratio(self) -> pulumi.Output[builtins.int]:
        """
        The CPU overcommitment ratio of the dedicated cluster.Valid values: 100 to 300. Default value: 200.
        """
        return pulumi.get(self, "cpu_allocation_ratio")
    ...
    @property
    @pulumi.getter(name="dedicatedHostGroupDesc")
    def dedicated_host_group_desc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the dedicated cluster. The name must be 1 to 64 characters in length and can contain letters, digits, underscores (_), and hyphens (-). It must start with a letter.
        """
        return pulumi.get(self, "dedicated_host_group_desc")
    ...
    @property
    @pulumi.getter(name="diskAllocationRatio")
    def disk_allocation_ratio(self) -> pulumi.Output[builtins.int]:
        """
        The Disk Allocation Ratio of the Dedicated Host Group. **NOTE:** When `engine = SQLServer`, this attribute does not support to set.
        """
        return pulumi.get(self, "disk_allocation_ratio")
    ...
    @property
    @pulumi.getter(name="hostReplacePolicy")
    def host_replace_policy(self) -> pulumi.Output[builtins.str]:
        """
        The policy based on which the system handles host failures. Valid values:`Auto`,`Manual`
        """
        return pulumi.get(self, "host_replace_policy")
    ...
    @property
    @pulumi.getter(name="memAllocationRatio")
    def mem_allocation_ratio(self) -> pulumi.Output[builtins.int]:
        """
        The Memory Allocation Ratio of the Dedicated Host Group.
        """
        return pulumi.get(self, "mem_allocation_ratio")
    ...
    @property
    @pulumi.getter(name="openPermission")
    def open_permission(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to enable the feature that allows you to have OS permissions on the hosts in the dedicated cluster. Valid values: `true` and `false`.
        **NOTE:** The `open_permission` should be `true` when `engine = "SQLServer"`
        """
