...
class DedicatedPropreHostArgs:
    def __init__(__self__, *,
                 ...
                 ecs_zone_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] auto_renew: Whether to enable automatic renewal. Valid values:
               - **true**: On
               - **false** (default): Off
        :param pulumi.Input[_builtins.str] dedicated_host_group_id: You have a dedicated cluster ID.
        :param pulumi.Input[_builtins.str] ecs_deployment_set_id: The ID of the cloud server deployment set.
        :param pulumi.Input[_builtins.str] ecs_host_name: Windows system: length of 2 to 15 characters, allowing the use of upper and lower case letters, numbers. You cannot use only numbers. Other operating systems (such as Linux): the length of 2 to 64 characters, allowing the use of dot (.) to separate characters into multiple segments, each segment allows the use of upper and lower case letters, numbers, but can not use continuous dot (.). Cannot start or end with a dot (.).
        :param pulumi.Input[_builtins.str] ecs_instance_name: The instance name. It must be 2 to 128 characters in length and must start with an uppercase or lowercase letter or a Chinese character. It cannot start with http:// or https. Can contain Chinese, English, numbers, half-width colons (:), underscores (_), half-width periods (.), or dashes (-). The default value is the InstanceId of the instance.
        ...
        :param pulumi.Input[_builtins.int] internet_max_bandwidth_out: The maximum outbound bandwidth of the public network, in Mbit/s. Value range: 0~100.  Default value: 0. When set to greater than 0, a public IP is automatically created.
        :param pulumi.Input[_builtins.str] key_pair_name: The key pair name.
        :param pulumi.Input[_builtins.str] os_password: Host login password, which can be set later. The password must meet the following requirements:
        ...
        :param pulumi.Input[_builtins.str] password_inherit: Whether to use the default password of the image.
               - **false**: (default)Do not use
               - **true**: Use
               > **NOTE:**  If the default password of the image is used, the **OSPassword** parameter is not required.
        :param pulumi.Input[_builtins.str] period: Duration of purchase.
        :param pulumi.Input[_builtins.str] period_type: The subscription type. Currently, only **Monthly** (subscription) is supported.
        :param pulumi.Input[_builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Host tag information.
        :param pulumi.Input[_builtins.str] user_data: User-defined script data. The maximum size of the original data is 16kB.
        :param pulumi.Input[_builtins.bool] user_data_encoded: Whether custom data is encoded in Base64 format.
        """
    ...
    def ecs_zone_id(self) -> pulumi.Input[_builtins.str]:
        """
        The ID of the zone.
        """
    ...
    @ecs_zone_id.setter
    def ecs_zone_id(self, value: pulumi.Input[_builtins.str]):
...
class _DedicatedPropreHostState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ecs_deployment_set_id: The ID of the cloud server deployment set.
        :param pulumi.Input[_builtins.str] ecs_host_name: Windows system: length of 2 to 15 characters, allowing the use of upper and lower case letters, numbers. You cannot use only numbers. Other operating systems (such as Linux): the length of 2 to 64 characters, allowing the use of dot (.) to separate characters into multiple segments, each segment allows the use of upper and lower case letters, numbers, but can not use continuous dot (.). Cannot start or end with a dot (.).
        :param pulumi.Input[_builtins.str] ecs_instance_id: ECS instance ID.
        :param pulumi.Input[_builtins.str] ecs_instance_name: The instance name. It must be 2 to 128 characters in length and must start with an uppercase or lowercase letter or a Chinese character. It cannot start with http:// or https. Can contain Chinese, English, numbers, half-width colons (:), underscores (_), half-width periods (.), or dashes (-). The default value is the InstanceId of the instance.
        :param pulumi.Input[_builtins.str] ecs_unique_suffix: Whether to automatically add an ordered suffix for HostName and InstanceName when creating multiple instances. The ordered suffix starts from 001 and cannot exceed 999. Value Description:
               - **true**: added.
               - **false** (default): Do not add.
...
class DedicatedPropreHost(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auto_renew: pulumi.Input[Optional[_builtins.str]] = None,
                 dedicated_host_group_id: pulumi.Input[Optional[_builtins.str]] = None,
                 ecs_class_lists: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DedicatedPropreHostEcsClassListArgs', 'DedicatedPropreHostEcsClassListArgsDict', 'outputs.DedicatedPropreHostEcsClassList']]]]] = None,
                 ecs_deployment_set_id: pulumi.Input[Optional[_builtins.str]] = None,
                 ecs_host_name: pulumi.Input[Optional[_builtins.str]] = None,
                 ecs_instance_name: pulumi.Input[Optional[_builtins.str]] = None,
                 ecs_unique_suffix: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] auto_renew: Whether to enable automatic renewal. Valid values:
               ...
               - **false** (default): Off
        :param pulumi.Input[_builtins.str] dedicated_host_group_id: You have a dedicated cluster ID.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DedicatedPropreHostEcsClassListArgs', 'DedicatedPropreHostEcsClassListArgsDict', 'outputs.DedicatedPropreHostEcsClassList']]]] ecs_class_lists: ECS specifications. See `ecs_class_list` below.
        :param pulumi.Input[_builtins.str] ecs_deployment_set_id: The ID of the cloud server deployment set.
        :param pulumi.Input[_builtins.str] ecs_host_name: Windows system: length of 2 to 15 characters, allowing the use of upper and lower case letters, numbers. You cannot use only numbers. Other operating systems (such as Linux): the length of 2 to 64 characters, allowing the use of dot (.) to separate characters into multiple segments, each segment allows the use of upper and lower case letters, numbers, but can not use continuous dot (.). Cannot start or end with a dot (.).
        :param pulumi.Input[_builtins.str] ecs_instance_name: The instance name. It must be 2 to 128 characters in length and must start with an uppercase or lowercase letter or a Chinese character. It cannot start with http:// or https. Can contain Chinese, English, numbers, half-width colons (:), underscores (_), half-width periods (.), or dashes (-). The default value is the InstanceId of the instance.
        :param pulumi.Input[_builtins.str] ecs_unique_suffix: Whether to automatically add an ordered suffix for HostName and InstanceName when creating multiple instances. The ordered suffix starts from 001 and cannot exceed 999. Value Description:
    ...
    @_builtins.property
    @pulumi.getter(name="ecsDeploymentSetId")
    def ecs_deployment_set_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of the cloud server deployment set.
        """
        return pulumi.get(self, "ecs_deployment_set_id")
    ...
    @_builtins.property
    @pulumi.getter(name="ecsHostName")
    def ecs_host_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Windows system: length of 2 to 15 characters, allowing the use of upper and lower case letters, numbers. You cannot use only numbers. Other operating systems (such as Linux): the length of 2 to 64 characters, allowing the use of dot (.) to separate characters into multiple segments, each segment allows the use of upper and lower case letters, numbers, but can not use continuous dot (.). Cannot start or end with a dot (.).
        """
        return pulumi.get(self, "ecs_host_name")
    ...
    @_builtins.property
    @pulumi.getter(name="ecsInstanceName")
    def ecs_instance_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The instance name. It must be 2 to 128 characters in length and must start with an uppercase or lowercase letter or a Chinese character. It cannot start with http:// or https. Can contain Chinese, English, numbers, half-width colons (:), underscores (_), half-width periods (.), or dashes (-). The default value is the InstanceId of the instance.
        """
        return pulumi.get(self, "ecs_instance_name")
    ...
    @_builtins.property
    @pulumi.getter(name="ecsUniqueSuffix")
    def ecs_unique_suffix(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Whether to automatically add an ordered suffix for HostName and InstanceName when creating multiple instances. The ordered suffix starts from 001 and cannot exceed 999. Value Description:
        - **true**: added.
        - **false** (default): Do not add.
    ...
    @_builtins.property
    @pulumi.getter(name="ecsZoneId")
    def ecs_zone_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the zone.
        """
        return pulumi.get(self, "ecs_zone_id")
    ...
    @_builtins.property
    @pulumi.getter(name="passwordInherit")
    def password_inherit(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Whether to use the default password of the image.
        - **false**: (default)Do not use
        - **true**: Use
    ...
    @_builtins.property
    @pulumi.getter(name="userDataEncoded")
    def user_data_encoded(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether custom data is encoded in Base64 format.
        """
        return pulumi.get(self, "user_data_encoded")
