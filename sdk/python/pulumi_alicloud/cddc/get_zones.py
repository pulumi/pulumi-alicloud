...
def get_zones(output_file: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:cddc/getZones:getZones', __args__, opts=opts, typ=GetZonesResult).value
...
def get_zones_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:cddc/getZones:getZones', __args__, opts=opts, typ=GetZonesResult)
