...
class DedicatedHostAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_name: The name of the Dedicated host account. The account name must be 2 to 16 characters in length, contain lower case letters, digits, and underscore(_). At the same time, the name must start with a letter and end with a letter or number.
        :param pulumi.Input[builtins.str] account_password: The password of the Dedicated host account. The account password must be 6 to 32 characters in length, and can contain letters, digits, and special characters `!@#$%^&*()_+-=`.
        :param pulumi.Input[builtins.str] dedicated_host_id: The ID of Dedicated the host.
        :param pulumi.Input[builtins.str] account_type: The type of the Dedicated host account. Valid values: `Admin`, `Normal`.
        """
...
@pulumi.type_token("alicloud:cddc/dedicatedHostAccount:DedicatedHostAccount")
class DedicatedHostAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            account_password: Optional[pulumi.Input[builtins.str]] = None,
            account_type: Optional[pulumi.Input[builtins.str]] = None,
            dedicated_host_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DedicatedHostAccount':
        """
