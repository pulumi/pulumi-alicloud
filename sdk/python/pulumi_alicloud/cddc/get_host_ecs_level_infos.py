...
class GetHostEcsLevelInfosResult:
    ...
    def image_category(self) -> Optional[builtins.str]:
...
def get_host_ecs_level_infos(db_type: Optional[builtins.str] = None,
                             image_category: Optional[builtins.str] = None,
    ...
    :param builtins.str db_type: The database engine of the host. Valid values: `mysql`, `mssql`, `pgsql`, `redis`.
    :param builtins.str image_category: Host image. Valid values: `WindowsWithMssqlEntAlwaysonLicense`, `WindowsWithMssqlStdLicense`, `WindowsWithMssqlEntLicense`, `WindowsWithMssqlWebLicense`, `AliLinux`.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str storage_type: The storage type of the host ecs level info. Valid values: `local_ssd`, `cloud_essd`, `cloud_essd2`, `cloud_essd3`.
    :param builtins.str zone_id: The ID of the zone in the region.
    """
    __args__ = dict()
...
def get_host_ecs_level_infos_output(db_type: Optional[pulumi.Input[builtins.str]] = None,
                                    image_category: Optional[pulumi.Input[Optional[builtins.str]]] = None,
