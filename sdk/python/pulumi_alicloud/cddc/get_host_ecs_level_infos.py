...
class GetHostEcsLevelInfosResult:
    ...
    def image_category(self) -> Optional[_builtins.str]:
...
def get_host_ecs_level_infos(db_type: Optional[_builtins.str] = None,
                             image_category: Optional[_builtins.str] = None,
    ...
    :param _builtins.str db_type: The database engine of the host. Valid values: `mysql`, `mssql`, `pgsql`, `redis`.
    :param _builtins.str image_category: Host image. Valid values: `WindowsWithMssqlEntAlwaysonLicense`, `WindowsWithMssqlStdLicense`, `WindowsWithMssqlEntLicense`, `WindowsWithMssqlWebLicense`, `AliLinux`.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str storage_type: The storage type of the host ecs level info. Valid values: `local_ssd`, `cloud_essd`, `cloud_essd2`, `cloud_essd3`.
    :param _builtins.str zone_id: The ID of the zone in the region.
    """
    __args__ = dict()
