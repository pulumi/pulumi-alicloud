...
def get_dedicated_host_accounts(dedicated_host_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Dedicated Host Account IDs.
...
def get_dedicated_host_accounts_output(dedicated_host_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
