...
if not MYPY:
    class DedicatedPropreHostEcsClassListArgsDict(TypedDict):
        ...
        ECS specifications.
        """
        sys_disk_capacity: pulumi.Input[builtins.int]
        """
        System disk capacity.
        """
        sys_disk_type: pulumi.Input[builtins.str]
        """
        ...
        """
        data_disk_performance_level: NotRequired[pulumi.Input[builtins.str]]
        """
        Data disk PL level.
        """
        ...
        - **cloud_auto**: ESSD AutoPL cloud disk.
        """
        system_disk_performance_level: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DedicatedPropreHostEcsClassListArgs:
    def __init__(__self__, *,
                 ...
                 sys_disk_capacity: pulumi.Input[builtins.int],
                 sys_disk_type: pulumi.Input[builtins.str],
                 data_disk_performance_level: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] instance_type: ECS specifications.
        :param pulumi.Input[builtins.int] sys_disk_capacity: System disk capacity.
        :param pulumi.Input[builtins.str] sys_disk_type: System disk type, value:
               - **cloud_essd**: the ESSD cloud disk.
               - **cloud_ssd**: SSD cloud disk.
               - **cloud_efficiency**: The ultra cloud disk.
               - **cloud_auto**: ESSD AutoPL cloud disk.
        :param pulumi.Input[builtins.str] data_disk_performance_level: Data disk PL level.
        :param pulumi.Input[builtins.int] disk_capacity: The capacity of the data disk.
        :param pulumi.Input[builtins.int] disk_count: Number of mounted data disks.
        :param pulumi.Input[builtins.str] disk_type: Data disk type, value range:
               - **cloud_essd**: the ESSD cloud disk.
               - **cloud_ssd**: SSD cloud disk.
               - **cloud_efficiency**: The ultra cloud disk.
               - **cloud_auto**: ESSD AutoPL cloud disk.
        :param pulumi.Input[builtins.str] system_disk_performance_level: System disk PL level.
        """
    ...
    def sys_disk_capacity(self) -> pulumi.Input[builtins.int]:
        """
        System disk capacity.
        """
    ...
    def sys_disk_capacity(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "sys_disk_capacity", value)

    @property
    @pulumi.getter(name="sysDiskType")
    def sys_disk_type(self) -> pulumi.Input[builtins.str]:
        """
        System disk type, value:
        - **cloud_essd**: the ESSD cloud disk.
        - **cloud_ssd**: SSD cloud disk.
    ...
    def sys_disk_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sys_disk_type", value)

    @property
    @pulumi.getter(name="dataDiskPerformanceLevel")
    def data_disk_performance_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Data disk PL level.
        """
    ...
    def data_disk_performance_level(self, value: Optional[pulumi.Input[builtins.str]]):
