...
class AccessConfigurationArgs:
    def __init__(__self__, *,
                 access_configuration_name: pulumi.Input[builtins.str],
                 directory_id: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 force_remove_permission_policies: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] access_configuration_name: The name of the access configuration. The name can be up to `32` characters long and can contain letters, digits, and hyphens (-).
        :param pulumi.Input[builtins.str] directory_id: The ID of the Directory.
        :param pulumi.Input[builtins.str] description: The description of the access configuration. The description can be up to `1024` characters in length.
        :param pulumi.Input[builtins.bool] force_remove_permission_policies: This parameter is used to force deletion `permission_policies`. Valid Value: `true`, `false`.
        ...
        :param pulumi.Input[builtins.str] relay_state: The RelayState of the Access Configuration, Cloud SSO users use this access configuration to access the RD account, the initial access page address. Must be the Alibaba Cloud console page, the default is the console home page.
        :param pulumi.Input[builtins.int] session_duration: The SessionDuration of the Access Configuration. Unit: Seconds. Valid values: `900` to `43200`.
        """
    ...
    def access_configuration_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def access_configuration_name(self, value: pulumi.Input[builtins.str]):
    ...
    def force_remove_permission_policies(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def force_remove_permission_policies(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _AccessConfigurationState:
    def __init__(__self__, *,
                 ...
                 access_configuration_name: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="accessConfigurationName")
    def access_configuration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the access configuration. The name can be up to `32` characters long and can contain letters, digits, and hyphens (-).
        """
        return pulumi.get(self, "access_configuration_name")
    ...
    @access_configuration_name.setter
    def access_configuration_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "access_configuration_name", value)
...
class AccessConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            permission_policies: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AccessConfigurationPermissionPolicyArgs', 'AccessConfigurationPermissionPolicyArgsDict']]]]] = None,
            relay_state: Optional[pulumi.Input[builtins.str]] = None,
            session_duration: Optional[pulumi.Input[builtins.int]] = None) -> 'AccessConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="accessConfigurationName")
    def access_configuration_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the access configuration. The name can be up to `32` characters long and can contain letters, digits, and hyphens (-).
        """
        return pulumi.get(self, "access_configuration_name")
    ...
    @property
    @pulumi.getter(name="forceRemovePermissionPolicies")
    def force_remove_permission_policies(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        This parameter is used to force deletion `permission_policies`. Valid Value: `true`, `false`.
    ...
    @property
    @pulumi.getter(name="relayState")
    def relay_state(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The RelayState of the Access Configuration, Cloud SSO users use this access configuration to access the RD account, the initial access page address. Must be the Alibaba Cloud console page, the default is the console home page.
        """
        return pulumi.get(self, "relay_state")
