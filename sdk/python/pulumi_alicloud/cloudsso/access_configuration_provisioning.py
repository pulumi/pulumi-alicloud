...
class AccessConfigurationProvisioningArgs:
    def __init__(__self__, *,
                 access_configuration_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid values: `Provisioned`, `ReprovisionRequired` and `DeprovisionFailed`.
        """
    ...
    def access_configuration_id(self, value: pulumi.Input[builtins.str]):
...
class AccessConfigurationProvisioning(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            target_id: Optional[pulumi.Input[builtins.str]] = None,
            target_type: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessConfigurationProvisioning':
        """
