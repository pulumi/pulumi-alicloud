...
def get_scim_server_credentials(directory_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of SCIM Server Credential IDs.
...
def get_scim_server_credentials_output(directory_id: Optional[pulumi.Input[builtins.str]] = None,
