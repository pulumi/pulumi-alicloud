...
def get_access_configurations(directory_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Access Configuration IDs.
    :param _builtins.str name_regex: A regex string to filter results by Access Configuration name.
