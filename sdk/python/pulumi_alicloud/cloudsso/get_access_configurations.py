...
def get_access_configurations(directory_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Access Configuration IDs.
    :param builtins.str name_regex: A regex string to filter results by Access Configuration name.
...
def get_access_configurations_output(directory_id: Optional[pulumi.Input[builtins.str]] = None,
