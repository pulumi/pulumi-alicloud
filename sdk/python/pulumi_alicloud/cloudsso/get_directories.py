...
def get_directories(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Directory IDs.
    :param builtins.str name_regex: A regex string to filter results by Directory name.
...
def get_directories_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
