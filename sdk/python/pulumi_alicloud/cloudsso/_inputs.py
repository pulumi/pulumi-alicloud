...
class DirectoryLoginPreferenceArgsDict(TypedDict):
    allow_user_to_get_credentials: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether the user can obtain the program access credential in the portal after logging in.
    """
    login_network_masks: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class DirectoryLoginPreferenceArgs:
    def __init__(__self__, *,
                 allow_user_to_get_credentials: pulumi.Input[Optional[_builtins.bool]] = None,
    ...
    def allow_user_to_get_credentials(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether the user can obtain the program access credential in the portal after logging in.
        """
    ...
    def allow_user_to_get_credentials(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class DirectoryMfaAuthenticationSettingInfoArgsDict(TypedDict):
    mfa_authentication_advance_settings: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Global MFA validation policy
    """
    operation_for_risk_login: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class DirectoryMfaAuthenticationSettingInfoArgs:
    def __init__(__self__, *,
                 mfa_authentication_advance_settings: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def mfa_authentication_advance_settings(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Global MFA validation policy
        """
    ...
    def mfa_authentication_advance_settings(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class DirectoryPasswordPolicyArgsDict(TypedDict):
    hard_expire: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether to restrict login after Password Expiration
    """
    max_login_attempts: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Number of password retries.
    """
    max_password_age: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Password validity period.
    """
    max_password_length: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Maximum password length.
    """
    min_password_different_chars: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    The minimum number of different characters in a password.
    """
    min_password_length: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Minimum password length.
    """
    password_not_contain_username: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether the user name is not allowed in the password.
    """
    password_reuse_prevention: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Historical password check policy.
    """
    require_lower_case_chars: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    require_upper_case_chars: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class DirectoryPasswordPolicyArgs:
    def __init__(__self__, *,
                 hard_expire: pulumi.Input[Optional[_builtins.bool]] = None,
                 max_login_attempts: pulumi.Input[Optional[_builtins.int]] = None,
                 max_password_age: pulumi.Input[Optional[_builtins.int]] = None,
                 max_password_length: pulumi.Input[Optional[_builtins.int]] = None,
                 min_password_different_chars: pulumi.Input[Optional[_builtins.int]] = None,
                 min_password_length: pulumi.Input[Optional[_builtins.int]] = None,
                 password_not_contain_username: pulumi.Input[Optional[_builtins.bool]] = None,
                 password_reuse_prevention: pulumi.Input[Optional[_builtins.int]] = None,
                 require_lower_case_chars: pulumi.Input[Optional[_builtins.bool]] = None,
                 require_numbers: pulumi.Input[Optional[_builtins.bool]] = None,
                 require_symbols: pulumi.Input[Optional[_builtins.bool]] = None,
                 require_upper_case_chars: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    def hard_expire(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to restrict login after Password Expiration
        """
    ...
    @hard_expire.setter
    def hard_expire(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def max_password_length(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Maximum password length.
        """
    ...
    def max_password_length(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "max_password_length", value)

    @_builtins.property
    @pulumi.getter(name="minPasswordDifferentChars")
    def min_password_different_chars(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The minimum number of different characters in a password.
        """
    ...
    def min_password_different_chars(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "min_password_different_chars", value)

    @_builtins.property
    @pulumi.getter(name="minPasswordLength")
    def min_password_length(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Minimum password length.
        """
    ...
    def min_password_length(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "min_password_length", value)

    @_builtins.property
    @pulumi.getter(name="passwordNotContainUsername")
    def password_not_contain_username(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether the user name is not allowed in the password.
        """
    ...
    def password_not_contain_username(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def require_lower_case_chars(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether lowercase letters are required in the password.
        """
    ...
    def require_lower_case_chars(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def require_upper_case_chars(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether uppercase letters are required in the password.
        """
    ...
    def require_upper_case_chars(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "require_upper_case_chars", value)


class DirectorySamlIdentityProviderConfigurationArgsDict(TypedDict):
    binding_type: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    CreateTime
    """
    encoded_metadata_document: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    EntityId
    """
    login_url: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    LoginUrl
    """
    sso_status: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    SSOStatus
    """
    ...
    UpdateTime
    """
    want_request_signed: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class DirectorySamlIdentityProviderConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 want_request_signed: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    def want_request_signed(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        SP Request whether the signature is required
        """
    ...
    def want_request_signed(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "want_request_signed", value)


class DirectorySamlServiceProviderArgsDict(TypedDict):
    acs_url: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ACS URL of SP.
    """
    authn_sign_algo: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    SP identity.
    """
    support_encrypted_assertion: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class DirectorySamlServiceProviderArgs:
    def __init__(__self__, *,
                 ...
                 authn_sign_algo: pulumi.Input[Optional[_builtins.str]] = None,
                 certificate_type: pulumi.Input[Optional[_builtins.str]] = None,
                 encoded_metadata_document: pulumi.Input[Optional[_builtins.str]] = None,
                 entity_id: pulumi.Input[Optional[_builtins.str]] = None,
                 support_encrypted_assertion: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    def authn_sign_algo(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Signature algorithms supported by AuthNRequest
        """
    ...
    def authn_sign_algo(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def support_encrypted_assertion(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether IdP-side encryption of Assertion is supported.
        """
    ...
    def support_encrypted_assertion(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "support_encrypted_assertion", value)


class DirectoryUserProvisioningConfigurationArgsDict(TypedDict):
    default_landing_page: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class DirectoryUserProvisioningConfigurationArgs:
    def __init__(__self__, *,
                 default_landing_page: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def default_landing_page(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The duration of the Session after the user logs in.
        """
    ...
    def default_landing_page(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class UserProvisioningUserProvisioningStatisticArgsDict(TypedDict):
    failed_event_count: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Number of failed events
    """
    gmt_latest_sync: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class UserProvisioningUserProvisioningStatisticArgs:
    def __init__(__self__, *,
                 failed_event_count: pulumi.Input[Optional[_builtins.int]] = None,
                 gmt_latest_sync: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def failed_event_count(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Number of failed events
        """
    ...
    def failed_event_count(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "failed_event_count", value)

    @_builtins.property
    @pulumi.getter(name="gmtLatestSync")
    def gmt_latest_sync(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Last Provisioning time
        """
    ...
    def gmt_latest_sync(self, value: pulumi.Input[Optional[_builtins.str]]):
