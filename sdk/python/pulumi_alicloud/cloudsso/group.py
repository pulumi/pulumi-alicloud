...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_name: The Name of the group. The name must be `1` to `128` characters in length and can contain letters, digits, periods (.), underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] description: The Description of the group. The description can be up to `1024` characters long.
        """
...
class _GroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The Description of the group. The description can be up to `1024` characters long.
        :param pulumi.Input[builtins.str] directory_id: The ID of the Directory.
        :param pulumi.Input[builtins.str] group_id: The GroupId of the group.
        :param pulumi.Input[builtins.str] group_name: The Name of the group. The name must be `1` to `128` characters in length and can contain letters, digits, periods (.), underscores (_), and hyphens (-).
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
...
class Group(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            directory_id: Optional[pulumi.Input[builtins.str]] = None,
            group_id: Optional[pulumi.Input[builtins.str]] = None,
            group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Group':
        """
