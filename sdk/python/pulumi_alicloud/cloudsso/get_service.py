...
def get_service(enable: Optional[builtins.str] = None,
    ...
    :param builtins.str enable: Setting the value to `On` to enable the service. Valid values: `On` or `Off`. 
...
def get_service_output(enable: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:cloudsso/getService:getService', __args__, opts=opts, typ=GetServiceResult)
