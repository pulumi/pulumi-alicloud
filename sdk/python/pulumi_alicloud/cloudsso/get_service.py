...
def get_service(enable: Optional[_builtins.str] = None,
    ...
    :param _builtins.str enable: Setting the value to `On` to enable the service. Valid values: `On` or `Off`. 
...
def get_service_output(enable: Optional[pulumi.Input[_builtins.str]] = None,
