...
def get_groups(directory_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str provision_type: The ProvisionType of the Group. Valid values: `Manual`, `Synchronized`.
    """
    __args__ = dict()
