...
def get_groups(directory_id: Optional[builtins.str] = None,
    ...
    :param builtins.str provision_type: The ProvisionType of the Group. Valid values: `Manual`, `Synchronized`.
    """
    __args__ = dict()
...
def get_groups_output(directory_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:cloudsso/getGroups:getGroups', __args__, opts=opts, typ=GetGroupsResult)
