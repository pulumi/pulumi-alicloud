...
class ScimServerCredentialArgs:
    def __init__(__self__, *,
                 ...
                 credential_secret_file: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] credential_secret_file: The name of file that can save Credential ID and Credential Secret. Strongly suggest you to specified it when you creating credential, otherwise, you wouldn't get its secret ever.
        :param pulumi.Input[builtins.str] status: The status of the SCIM Server Credential. Valid values: `Enabled`, `Disabled`.
        """
    ...
    def credential_secret_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def credential_secret_file(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ScimServerCredentialState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: (Available since v1.245.0) The time when the SCIM credential was created.
        :param pulumi.Input[builtins.str] credential_id: The ID of the SCIM credential.
        :param pulumi.Input[builtins.str] credential_secret_file: The name of file that can save Credential ID and Credential Secret. Strongly suggest you to specified it when you creating credential, otherwise, you wouldn't get its secret ever.
        :param pulumi.Input[builtins.str] credential_type: (Available since v1.245.0) The type of the SCIM credential.
        :param pulumi.Input[builtins.str] directory_id: The ID of the Directory.
        :param pulumi.Input[builtins.str] expire_time: (Available since v1.245.0) The time when the SCIM credential expires.
        :param pulumi.Input[builtins.str] status: The status of the SCIM Server Credential. Valid values: `Enabled`, `Disabled`.
        """
...
class ScimServerCredential(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            directory_id: Optional[pulumi.Input[builtins.str]] = None,
            expire_time: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ScimServerCredential':
        """
    ...
    @property
    @pulumi.getter(name="credentialSecretFile")
    def credential_secret_file(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of file that can save Credential ID and Credential Secret. Strongly suggest you to specified it when you creating credential, otherwise, you wouldn't get its secret ever.
        """
        return pulumi.get(self, "credential_secret_file")
