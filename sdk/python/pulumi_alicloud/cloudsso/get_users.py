...
class GetUsersResult:
    ...
    def provision_type(self) -> Optional[builtins.str]:
...
def get_users(directory_id: Optional[builtins.str] = None,
              ...
              provision_type: Optional[builtins.str] = None,
    ...
    :param builtins.str name_regex: A regex string to filter results by User name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str provision_type: ProvisionType. Valid values: `Manual`, `Synchronized`.
    :param builtins.str status: The status of user. Valid values: `Disabled`, `Enabled`.
    """
    __args__ = dict()
...
def get_users_output(directory_id: Optional[pulumi.Input[builtins.str]] = None,
                     ...
                     provision_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
