...
class GetAccessAssignmentsResult:
    ...
    def access_configuration_id(self) -> Optional[builtins.str]:
...
def get_access_assignments(access_configuration_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Access Assignment IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str principal_type: Create the identity type of the access assignment, which can be a user or a user group. Valid values: `Group`, `User`.
    :param builtins.str target_id: The ID of the target to create the resource range.
    :param builtins.str target_type: The type of the resource range target to be accessed. Only a single RD primary account or member account can be specified in the first phase. Valid values: `RD-Account`.
    """
    __args__ = dict()
...
def get_access_assignments_output(access_configuration_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
