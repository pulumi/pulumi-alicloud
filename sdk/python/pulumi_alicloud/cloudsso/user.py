...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] user_name: The name of user. The name must be `1` to `64` characters in length and can contain letters, digits, at signs (@), periods (.), underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] description: The description of user. The description can be up to `1024` characters long.
        :param pulumi.Input[builtins.str] display_name: The display name of user. The display name can be up to `256` characters long.
        :param pulumi.Input[builtins.str] email: The User's Contact Email Address. The email can be up to `128` characters long.
        :param pulumi.Input[builtins.str] first_name: The first name of user. The first_name can be up to `64` characters long.
        :param pulumi.Input[builtins.str] last_name: The last name of user. The last_name can be up to `64` characters long.
        :param pulumi.Input[builtins.str] status: The status of user. Valid values: `Disabled`, `Enabled`.
        """
...
class _UserState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] last_name: The last name of user. The last_name can be up to `64` characters long.
        :param pulumi.Input[builtins.str] status: The status of user. Valid values: `Disabled`, `Enabled`.
        :param pulumi.Input[builtins.str] user_id: The User ID of the group.
        :param pulumi.Input[builtins.str] user_name: The name of user. The name must be `1` to `64` characters in length and can contain letters, digits, at signs (@), periods (.), underscores (_), and hyphens (-).
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
