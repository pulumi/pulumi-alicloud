...
def get_domains(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.str key_word: The domain name. It must be 1 to 50 characters in length and can contain digits, letters, periods (.), and hyphens (-).
    :param builtins.str name_regex: A regex string to filter results by Domain name.
...
def get_domains_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
