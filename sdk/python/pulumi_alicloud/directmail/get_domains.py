...
def get_domains(enable_details: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str key_word: The domain name. It must be 1 to 50 characters in length and can contain digits, letters, periods (.), and hyphens (-).
...
def get_domains_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
