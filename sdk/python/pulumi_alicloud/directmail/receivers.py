...
class ReceiversArgs:
    def __init__(__self__, *,
                 receivers_alias: pulumi.Input[builtins.str],
                 receivers_name: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Receivers resource.
        :param pulumi.Input[builtins.str] receivers_alias: The alias of receivers. Must email address and less than 30 characters in length.
        :param pulumi.Input[builtins.str] receivers_name: The name of the resource. The length that cannot be repeated is 1-30 characters.
        :param pulumi.Input[builtins.str] description: The description of receivers and 1-50 characters in length.
        """
    ...
    def receivers_alias(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def receivers_alias(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "receivers_alias", value)

    @property
    @pulumi.getter(name="receiversName")
    def receivers_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def receivers_name(self, value: pulumi.Input[builtins.str]):
...
class _ReceiversState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 receivers_alias: Optional[pulumi.Input[builtins.str]] = None,
                 receivers_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] receivers_alias: The alias of receivers. Must email address and less than 30 characters in length.
        :param pulumi.Input[builtins.str] receivers_name: The name of the resource. The length that cannot be repeated is 1-30 characters.
        :param pulumi.Input[builtins.int] status: The status of the resource. `0` means uploading, `1` means upload completed.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    @property
    @pulumi.getter(name="receiversAlias")
    def receivers_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The alias of receivers. Must email address and less than 30 characters in length.
        """
        return pulumi.get(self, "receivers_alias")
    ...
    @receivers_alias.setter
    def receivers_alias(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "receivers_alias", value)

    @property
    @pulumi.getter(name="receiversName")
    def receivers_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the resource. The length that cannot be repeated is 1-30 characters.
        """
        return pulumi.get(self, "receivers_name")
    ...
    @receivers_name.setter
    def receivers_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "receivers_name", value)
...
class Receivers(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:directmail/receivers:Receivers"
    ...
    def get(resource_name: str,
            ...
            receivers_alias: Optional[pulumi.Input[builtins.str]] = None,
            receivers_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.int]] = None) -> 'Receivers':
        """
    ...
    @property
    @pulumi.getter(name="receiversAlias")
    def receivers_alias(self) -> pulumi.Output[builtins.str]:
        """
        The alias of receivers. Must email address and less than 30 characters in length.
        """
        return pulumi.get(self, "receivers_alias")
    ...
    @property
    @pulumi.getter(name="receiversName")
    def receivers_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the resource. The length that cannot be repeated is 1-30 characters.
        """
        return pulumi.get(self, "receivers_name")
