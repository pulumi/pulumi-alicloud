...
def get_receivers(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Receivers IDs.
    :param _builtins.str key_word: The key word.
    :param _builtins.str name_regex: A regex string to filter results by Receivers name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.int status: The status of the resource. Valid Values: `0` means uploading, `1` means upload completed.
    """
    __args__ = dict()
    __args__['ids'] = ids
