...
def get_receivers(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Receivers IDs.
    :param builtins.str key_word: The key word.
    :param builtins.str name_regex: A regex string to filter results by Receivers name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.int status: The status of the resource. Valid Values: `0` means uploading, `1` means upload completed.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_receivers_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:directmail/getReceivers:getReceivers', __args__, opts=opts, typ=GetReceiversResult)
    return __ret__.apply(lambda __response__: GetReceiversResult(
        ...
        receiverses=pulumi.get(__response__, 'receiverses'),
