...
class MailAddressArgs:
    def __init__(__self__, *,
                 ...
                 sendtype: pulumi.Input[builtins.str],
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 reply_address: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a MailAddress resource.
        :param pulumi.Input[builtins.str] account_name: The sender address. The email address must be filled in the format of account@domain, and only lowercase letters or numbers can be used.
        :param pulumi.Input[builtins.str] sendtype: Account type. Valid values: `batch`, `trigger`.
        :param pulumi.Input[builtins.str] password: Account password. The password must be length 10-20 string, contains numbers, uppercase letters, lowercase letters at the same time.
        :param pulumi.Input[builtins.str] reply_address: Return address.
        """
    ...
    @property
    @pulumi.getter
    def sendtype(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sendtype.setter
    def sendtype(self, value: pulumi.Input[builtins.str]):
    ...
    def reply_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Return address.
        """
    ...
    def reply_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MailAddressState:
    def __init__(__self__, *,
                 ...
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 reply_address: Optional[pulumi.Input[builtins.str]] = None,
                 sendtype: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] reply_address: Return address.
        :param pulumi.Input[builtins.str] sendtype: Account type. Valid values: `batch`, `trigger`.
        :param pulumi.Input[builtins.str] status: Account Status freeze: 1, normal: 0.
        """
    ...
    @property
    @pulumi.getter
    def sendtype(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Account type. Valid values: `batch`, `trigger`.
        """
        return pulumi.get(self, "sendtype")
    ...
    @sendtype.setter
    def sendtype(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sendtype", value)
...
class MailAddress(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reply_address: Optional[pulumi.Input[builtins.str]] = None,
            sendtype: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'MailAddress':
        """
    ...
    @property
    @pulumi.getter(name="replyAddress")
    def reply_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Return address.
        """
        return pulumi.get(self, "reply_address")
    ...
    @property
    @pulumi.getter
    def sendtype(self) -> pulumi.Output[builtins.str]:
        """
        Account type. Valid values: `batch`, `trigger`.
        """
        return pulumi.get(self, "sendtype")
