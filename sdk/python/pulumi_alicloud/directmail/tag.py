...
class TagArgs:
    def __init__(__self__, *,
                 tag_name: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a Tag resource.
        :param pulumi.Input[builtins.str] tag_name: The name of the tag. The name must be `1` to `50` characters in length, and can contain letters and digits.
        """
        pulumi.set(__self__, "tag_name", tag_name)

    @property
    @pulumi.getter(name="tagName")
    def tag_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @tag_name.setter
    def tag_name(self, value: pulumi.Input[builtins.str]):
...
class Tag(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            tag_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Tag':
        """
    ...
    @property
    @pulumi.getter(name="tagName")
    def tag_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the tag. The name must be `1` to `50` characters in length, and can contain letters and digits.
        """
        return pulumi.get(self, "tag_name")
