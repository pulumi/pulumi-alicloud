...
def get_tags(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Tag IDs.
    :param _builtins.str name_regex: A regex string to filter results by Tag name.
...
def get_tags_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:directmail/getTags:getTags', __args__, opts=opts, typ=GetTagsResult)
