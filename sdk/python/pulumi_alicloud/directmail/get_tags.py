...
def get_tags(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Tag IDs.
    :param builtins.str name_regex: A regex string to filter results by Tag name.
...
def get_tags_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
