...
class DomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_name: Domain, length `1` to `50`, including numbers or capitals or lowercase letters or `.` or `-`
        """
...
class _DomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_name: Domain, length `1` to `50`, including numbers or capitals or lowercase letters or `.` or `-`
        :param pulumi.Input[builtins.str] status: The status of the domain name. Valid values:`0` to `4`. `0`:Available, Passed. `1`: Unavailable, No passed. `2`: Available, cname no passed, icp no passed. `3`: Available, icp no passed. `4`: Available, cname no passed.
        """
