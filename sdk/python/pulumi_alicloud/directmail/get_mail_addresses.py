...
class GetMailAddressesResult:
    ...
    @property
    @pulumi.getter
    def sendtype(self) -> Optional[builtins.str]:
...
def get_mail_addresses(ids: Optional[Sequence[builtins.str]] = None,
                       key_word: Optional[builtins.str] = None,
                       output_file: Optional[builtins.str] = None,
                       sendtype: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Mail Address IDs.
    :param builtins.str key_word: The key word about account email address.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str sendtype: Account type. Valid values: `batch`, `trigger`.
...
def get_mail_addresses_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                              key_word: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              sendtype: Optional[pulumi.Input[Optional[builtins.str]]] = None,
