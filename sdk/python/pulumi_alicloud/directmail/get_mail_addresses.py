...
class GetMailAddressesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def sendtype(self) -> Optional[_builtins.str]:
...
def get_mail_addresses(ids: Optional[Sequence[_builtins.str]] = None,
                       key_word: Optional[_builtins.str] = None,
                       output_file: Optional[_builtins.str] = None,
                       sendtype: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Mail Address IDs.
    :param _builtins.str key_word: The key word about account email address.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str sendtype: Account type. Valid values: `batch`, `trigger`.
