...
def get_launch_options(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Launch Option IDs.
    :param builtins.str name_regex: A regex string to filter results by portfolio name.
...
def get_launch_options_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
