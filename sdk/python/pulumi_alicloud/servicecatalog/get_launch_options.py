...
class GetLaunchOptionsResult:
    ...
    """
    def __init__(__self__, id=None, ids=None, name_regex=None, options=None, output_file=None, product_id=None):
...
def get_launch_options(ids: Optional[Sequence[str]] = None,
    ...
    default = alicloud.servicecatalog.get_launch_options(product_id="prod-bp125x4k29wb7q")
    pulumi.export("alicloudServiceCatalogLaunchOptionExampleId", default.options[0].id)
    ```
