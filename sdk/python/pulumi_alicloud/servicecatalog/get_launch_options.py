...
def get_launch_options(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Launch Option IDs.
    :param _builtins.str name_regex: A regex string to filter results by portfolio name.
...
def get_launch_options_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
