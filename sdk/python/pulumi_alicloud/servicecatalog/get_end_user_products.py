...
def get_end_user_products(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of End User Product IDs.
    ...
    :param builtins.str sort_by: The field that is used to sort the queried data. The value is fixed as CreateTime, which specifies the creation time of products.
...
def get_end_user_products_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
