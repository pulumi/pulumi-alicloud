...
def get_portfolios(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Portfolio IDs.
    ...
    :param _builtins.str scope: The query scope. Valid values: `Local`(default), `Import`, `All`.
    :param _builtins.str sort_by: The field that is used to sort the queried data. The value is fixed as CreateTime, which specifies the creation time of product portfolios.
...
def get_portfolios_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                          ...
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPortfoliosResult]:
    """
    This data source provides Service Catalog Portfolio available to the user.[What is Portfolio](https://www.alibabacloud.com/help/en/service-catalog/developer-reference/api-servicecatalog-2021-09-01-createportfolio)
