...
def get_portfolios(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Portfolio IDs.
    ...
    :param builtins.str scope: The query scope. Valid values: `Local`(default), `Import`, `All`.
    :param builtins.str sort_by: The field that is used to sort the queried data. The value is fixed as CreateTime, which specifies the creation time of product portfolios.
    :param builtins.str sort_order: The order in which you want to sort the queried data. Valid values: `Asc`, `Desc`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_portfolios_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
