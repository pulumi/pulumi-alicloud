...
def get_product_as_end_users(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Product As End User IDs.
    :param builtins.str name_regex: A regex string to filter results by product name.
...
def get_product_as_end_users_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
