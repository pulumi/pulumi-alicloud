...
class PortfolioArgs:
    def __init__(__self__, *,
                 portfolio_name: pulumi.Input[builtins.str],
                 provider_name: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Portfolio resource.
        :param pulumi.Input[builtins.str] portfolio_name: The name of the portfolio
        :param pulumi.Input[builtins.str] provider_name: The provider name of the portfolio
        :param pulumi.Input[builtins.str] description: The description of the portfolio
        """
    ...
    def portfolio_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def portfolio_name(self, value: pulumi.Input[builtins.str]):
...
class _PortfolioState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 portfolio_arn: Optional[pulumi.Input[builtins.str]] = None,
                 portfolio_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] create_time: The creation time of the portfolio
        :param pulumi.Input[builtins.str] description: The description of the portfolio
        :param pulumi.Input[builtins.str] portfolio_arn: The ARN of the portfolio
        :param pulumi.Input[builtins.str] portfolio_name: The name of the portfolio
        :param pulumi.Input[builtins.str] provider_name: The provider name of the portfolio
        """
    ...
    def portfolio_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def portfolio_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "portfolio_arn", value)

    @property
    @pulumi.getter(name="portfolioName")
    def portfolio_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the portfolio
        """
        return pulumi.get(self, "portfolio_name")
    ...
    @portfolio_name.setter
    def portfolio_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "portfolio_name", value)
...
class Portfolio(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            portfolio_arn: Optional[pulumi.Input[builtins.str]] = None,
            portfolio_name: Optional[pulumi.Input[builtins.str]] = None,
            provider_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Portfolio':
        """
    ...
    @property
    @pulumi.getter(name="portfolioArn")
    def portfolio_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the portfolio
        """
        return pulumi.get(self, "portfolio_arn")
    ...
    @property
    @pulumi.getter(name="portfolioName")
    def portfolio_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the portfolio
        """
        return pulumi.get(self, "portfolio_name")
