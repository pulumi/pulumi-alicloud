...
class ProvisionedProductArgs:
    def __init__(__self__, *,
                 ...
                 product_version_id: pulumi.Input[builtins.str],
                 provisioned_product_name: pulumi.Input[builtins.str],
                 stack_region_id: pulumi.Input[builtins.str],
                 ...
                 provisioned_product_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ProvisionedProduct resource.
        :param pulumi.Input[builtins.str] product_id: Product ID.
        :param pulumi.Input[builtins.str] product_version_id: Product version ID.
        :param pulumi.Input[builtins.str] provisioned_product_name: The name of the instance.The length is 1~128 characters.
        :param pulumi.Input[builtins.str] stack_region_id: The ID of the region to which the resource stack of the Alibaba Cloud resource orchestration service (ROS) belongs.
        ...
        :param pulumi.Input[builtins.str] portfolio_id: Product mix ID.> When there is a default Startup option, there is no need to fill in the portfolio. When there is no default Startup option, you must fill in the portfolio.
        :param pulumi.Input[builtins.str] provisioned_product_id: The ID of the instance.
    ...
    def product_version_id(self) -> pulumi.Input[builtins.str]:
        """
        Product version ID.
        """
    ...
    def product_version_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "product_version_id", value)

    @property
    @pulumi.getter(name="provisionedProductName")
    def provisioned_product_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def provisioned_product_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "provisioned_product_name", value)

    @property
    @pulumi.getter(name="stackRegionId")
    def stack_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def stack_region_id(self, value: pulumi.Input[builtins.str]):
    ...
    def provisioned_product_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provisioned_product_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ProvisionedProductState:
    def __init__(__self__, *,
                 ...
                 last_provisioning_task_id: Optional[pulumi.Input[builtins.str]] = None,
                 last_successful_provisioning_task_id: Optional[pulumi.Input[builtins.str]] = None,
                 last_task_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 owner_principal_type: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input['ProvisionedProductParameterArgs']]]] = None,
                 portfolio_id: Optional[pulumi.Input[builtins.str]] = None,
                 product_id: Optional[pulumi.Input[builtins.str]] = None,
                 product_name: Optional[pulumi.Input[builtins.str]] = None,
                 product_version_id: Optional[pulumi.Input[builtins.str]] = None,
                 product_version_name: Optional[pulumi.Input[builtins.str]] = None,
                 provisioned_product_arn: Optional[pulumi.Input[builtins.str]] = None,
                 provisioned_product_id: Optional[pulumi.Input[builtins.str]] = None,
                 provisioned_product_name: Optional[pulumi.Input[builtins.str]] = None,
                 provisioned_product_type: Optional[pulumi.Input[builtins.str]] = None,
                 stack_id: Optional[pulumi.Input[builtins.str]] = None,
                 stack_region_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] create_time: The creation time of the product instance
        :param pulumi.Input[builtins.str] last_provisioning_task_id: The ID of the last instance operation task
        :param pulumi.Input[builtins.str] last_successful_provisioning_task_id: The ID of the last successful instance operation task
        :param pulumi.Input[builtins.str] last_task_id: The ID of the last task
        :param pulumi.Input[Sequence[pulumi.Input['ProvisionedProductOutputArgs']]] outputs: The output value of the template.
        :param pulumi.Input[builtins.str] owner_principal_id: The RAM entity ID of the owner
        :param pulumi.Input[builtins.str] owner_principal_type: The RAM entity type of the owner
        :param pulumi.Input[Sequence[pulumi.Input['ProvisionedProductParameterArgs']]] parameters: Template parameters entered by the user.The maximum value of N is 200.See the following `Block Parameters`.
        :param pulumi.Input[builtins.str] portfolio_id: Product mix ID.> When there is a default Startup option, there is no need to fill in the portfolio. When there is no default Startup option, you must fill in the portfolio.
        :param pulumi.Input[builtins.str] product_id: Product ID.
        :param pulumi.Input[builtins.str] product_name: The name of the product
        :param pulumi.Input[builtins.str] product_version_id: Product version ID.
        :param pulumi.Input[builtins.str] product_version_name: The name of the product version
        :param pulumi.Input[builtins.str] provisioned_product_arn: The ARN of the product instance
        :param pulumi.Input[builtins.str] provisioned_product_id: The ID of the instance.
        :param pulumi.Input[builtins.str] provisioned_product_name: The name of the instance.The length is 1~128 characters.
        :param pulumi.Input[builtins.str] provisioned_product_type: Instance type.The value is RosStack, which indicates the stack of Alibaba Cloud resource orchestration service (ROS).
        :param pulumi.Input[builtins.str] stack_id: The ID of the ROS stack
        :param pulumi.Input[builtins.str] stack_region_id: The ID of the region to which the resource stack of the Alibaba Cloud resource orchestration service (ROS) belongs.
        :param pulumi.Input[builtins.str] status: Instance status
        :param pulumi.Input[builtins.str] status_message: The status message of the product instance
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        """
    ...
    def last_provisioning_task_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_provisioning_task_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_provisioning_task_id", value)

    @property
    @pulumi.getter(name="lastSuccessfulProvisioningTaskId")
    def last_successful_provisioning_task_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_successful_provisioning_task_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_successful_provisioning_task_id", value)

    @property
    @pulumi.getter(name="lastTaskId")
    def last_task_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @last_task_id.setter
    def last_task_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def owner_principal_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def owner_principal_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="productVersionId")
    def product_version_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Product version ID.
        """
        return pulumi.get(self, "product_version_id")
    ...
    @product_version_id.setter
    def product_version_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "product_version_id", value)

    @property
    @pulumi.getter(name="productVersionName")
    def product_version_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def product_version_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "product_version_name", value)

    @property
    @pulumi.getter(name="provisionedProductArn")
    def provisioned_product_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provisioned_product_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="provisionedProductName")
    def provisioned_product_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the instance.The length is 1~128 characters.
        """
        return pulumi.get(self, "provisioned_product_name")
    ...
    @provisioned_product_name.setter
    def provisioned_product_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provisioned_product_name", value)

    @property
    @pulumi.getter(name="provisionedProductType")
    def provisioned_product_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provisioned_product_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="stackRegionId")
    def stack_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the region to which the resource stack of the Alibaba Cloud resource orchestration service (ROS) belongs.
        """
        return pulumi.get(self, "stack_region_id")
    ...
    @stack_region_id.setter
    def stack_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stack_region_id", value)
...
class ProvisionedProduct(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            status_message: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ProvisionedProduct':
        """
    ...
    @property
    @pulumi.getter(name="lastProvisioningTaskId")
    def last_provisioning_task_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the last instance operation task
        """
        return pulumi.get(self, "last_provisioning_task_id")
    ...
    @property
    @pulumi.getter(name="lastSuccessfulProvisioningTaskId")
    def last_successful_provisioning_task_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the last successful instance operation task
        """
        return pulumi.get(self, "last_successful_provisioning_task_id")
    ...
    @property
    @pulumi.getter(name="lastTaskId")
    def last_task_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the last task
        """
        return pulumi.get(self, "last_task_id")
    ...
    @property
    @pulumi.getter(name="ownerPrincipalType")
    def owner_principal_type(self) -> pulumi.Output[builtins.str]:
        """
        The RAM entity type of the owner
        """
        return pulumi.get(self, "owner_principal_type")
    ...
    @property
    @pulumi.getter(name="portfolioId")
    def portfolio_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Product mix ID.> When there is a default Startup option, there is no need to fill in the portfolio. When there is no default Startup option, you must fill in the portfolio.
        """
        return pulumi.get(self, "portfolio_id")
    ...
    @property
    @pulumi.getter(name="productVersionId")
    def product_version_id(self) -> pulumi.Output[builtins.str]:
        """
        Product version ID.
        """
        return pulumi.get(self, "product_version_id")
    ...
    @property
    @pulumi.getter(name="productVersionName")
    def product_version_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the product version
        """
        return pulumi.get(self, "product_version_name")
    ...
    @property
    @pulumi.getter(name="provisionedProductArn")
    def provisioned_product_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the product instance
        """
        return pulumi.get(self, "provisioned_product_arn")
    ...
    @property
    @pulumi.getter(name="provisionedProductId")
    def provisioned_product_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the instance.
        """
        return pulumi.get(self, "provisioned_product_id")
    ...
    @property
    @pulumi.getter(name="provisionedProductName")
    def provisioned_product_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the instance.The length is 1~128 characters.
        """
        return pulumi.get(self, "provisioned_product_name")
    ...
    @property
    @pulumi.getter(name="provisionedProductType")
    def provisioned_product_type(self) -> pulumi.Output[builtins.str]:
        """
        Instance type.The value is RosStack, which indicates the stack of Alibaba Cloud resource orchestration service (ROS).
        """
        return pulumi.get(self, "provisioned_product_type")
    ...
    @property
    @pulumi.getter(name="stackRegionId")
    def stack_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the region to which the resource stack of the Alibaba Cloud resource orchestration service (ROS) belongs.
        """
        return pulumi.get(self, "stack_region_id")
