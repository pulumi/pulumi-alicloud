...
class GetProvisionedProductsResult:
    ...
    def access_level_filter(self) -> Optional[_builtins.str]:
...
def get_provisioned_products(access_level_filter: Optional[_builtins.str] = None,
    ...
    :param _builtins.str access_level_filter: The access filter.
    :param _builtins.bool enable_details: Default to `false`. Set it to `true` can output more details about resource attributes.
    :param Sequence[_builtins.str] ids: A list of Provisioned Product IDs.
    :param _builtins.str name_regex: A regex string to filter results by Product name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str sort_by: The field that is used to sort the queried data.
    :param _builtins.str sort_order: The sorting method.
    """
    __args__ = dict()
