...
class GetProvisionedProductsResult:
    ...
    def access_level_filter(self) -> Optional[builtins.str]:
...
def get_provisioned_products(access_level_filter: Optional[builtins.str] = None,
    ...
    :param builtins.str access_level_filter: The access filter.
    :param builtins.bool enable_details: Default to `false`. Set it to `true` can output more details about resource attributes.
    :param Sequence[builtins.str] ids: A list of Provisioned Product IDs.
    ...
    :param builtins.str sort_by: The field that is used to sort the queried data.
    :param builtins.str sort_order: The sorting method.
    """
    __args__ = dict()
...
def get_provisioned_products_output(access_level_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
