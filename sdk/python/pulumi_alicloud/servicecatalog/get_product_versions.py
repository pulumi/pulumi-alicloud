...
def get_product_versions(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Product Version IDs.
...
def get_product_versions_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
