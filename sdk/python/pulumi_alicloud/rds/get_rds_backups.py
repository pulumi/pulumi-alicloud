...
def get_rds_backups(backup_mode: Optional[_builtins.str] = None,
    ...
    :param _builtins.str backup_mode: BackupMode. Valid values: `Automated` and `Manual`.
    :param _builtins.str backup_status: Backup task status. Valid values: `Automated` and `Manual`.
    :param _builtins.str db_instance_id: The db instance id.
    :param _builtins.str end_time: The end time.
    :param Sequence[_builtins.str] ids: A list of Backup IDs.
...
def get_rds_backups_output(backup_mode: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           backup_status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
