...
class GetRdsBackupsResult:
    ...
    def backup_status(self) -> Optional[builtins.str]:
...
def get_rds_backups(backup_mode: Optional[builtins.str] = None,
                    backup_status: Optional[builtins.str] = None,
    ...
    :param builtins.str backup_mode: BackupMode. Valid values: `Automated` and `Manual`.
    :param builtins.str backup_status: Backup task status. Valid values: `Automated` and `Manual`.
    :param builtins.str db_instance_id: The db instance id.
    :param builtins.str end_time: The end time.
    :param Sequence[builtins.str] ids: A list of Backup IDs.
...
def get_rds_backups_output(backup_mode: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           backup_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
