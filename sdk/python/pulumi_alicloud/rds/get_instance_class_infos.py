...
def get_instance_class_infos(commodity_code: Optional[builtins.str] = None,
    ...
    :param builtins.str db_instance_id: The ID of the primary instance.
    ...
    :param builtins.str order_type: FThe type of order that you want to query. Valid values:
...
def get_instance_class_infos_output(commodity_code: Optional[pulumi.Input[builtins.str]] = None,
