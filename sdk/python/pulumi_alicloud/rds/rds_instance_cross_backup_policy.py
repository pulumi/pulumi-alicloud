...
class RdsInstanceCrossBackupPolicyArgs:
    def __init__(__self__, *,
                 cross_backup_region: pulumi.Input[builtins.str],
                 instance_id: pulumi.Input[builtins.str],
                 log_backup_enabled: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cross_backup_region: The ID of the destination region where the cross-region backup files of the instance are stored.
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] log_backup_enabled: The status of the cross-region log backup feature on the instance. Valid values:
               - Enable: Enables the feature.
               - Disabled: Disables the feature.
        :param pulumi.Input[builtins.int] retention: The number of days for which the cross-region backup files of the instance are retained. Valid values: 7 to 1825. Default value: 7.
        """
    ...
    def cross_backup_region(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cross_backup_region(self, value: pulumi.Input[builtins.str]):
    ...
    def log_backup_enabled(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def log_backup_enabled(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RdsInstanceCrossBackupPolicyState:
    def __init__(__self__, *,
                 backup_enabled: Optional[pulumi.Input[builtins.str]] = None,
                 backup_enabled_time: Optional[pulumi.Input[builtins.str]] = None,
                 cross_backup_region: Optional[pulumi.Input[builtins.str]] = None,
                 cross_backup_type: Optional[pulumi.Input[builtins.str]] = None,
                 db_instance_status: Optional[pulumi.Input[builtins.str]] = None,
                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 lock_mode: Optional[pulumi.Input[builtins.str]] = None,
                 log_backup_enabled: Optional[pulumi.Input[builtins.str]] = None,
                 log_backup_enabled_time: Optional[pulumi.Input[builtins.str]] = None,
                 retent_type: Optional[pulumi.Input[builtins.str]] = None,
                 retention: Optional[pulumi.Input[builtins.int]] = None):
        """
        Input properties used for looking up and filtering RdsInstanceCrossBackupPolicy resources.
        :param pulumi.Input[builtins.str] backup_enabled: The status of the overall cross-region backup switch on the instance. Valid values:
               - Disabled
               - Enable
        :param pulumi.Input[builtins.str] backup_enabled_time: The time when cross-region backup was enabled on the instance. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        :param pulumi.Input[builtins.str] cross_backup_region: The ID of the destination region where the cross-region backup files of the instance are stored.
        :param pulumi.Input[builtins.str] cross_backup_type: The policy that is used to save cross-region backups of the instance. Default value: 1. The default value 1 indicates that all cross-region backups are saved.
        :param pulumi.Input[builtins.str] db_instance_status: The state of the instance. For more information, see Instance status.
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] lock_mode: The lock status of the instance. Valid values:
        ...
        :param pulumi.Input[builtins.str] log_backup_enabled: The status of the cross-region log backup feature on the instance. Valid values:
               - Enable: Enables the feature.
               - Disabled: Disables the feature.
        :param pulumi.Input[builtins.str] log_backup_enabled_time: The time when cross-region log backup was enabled on the instance. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        :param pulumi.Input[builtins.str] retent_type: The policy that is used to retain cross-region backups of the instance. Default value: 1. The default value 1 indicate that cross-region backups are retained based on the specified retention period.
        :param pulumi.Input[builtins.int] retention: The number of days for which the cross-region backup files of the instance are retained. Valid values: 7 to 1825. Default value: 7.
        """
    ...
    def backup_enabled(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def backup_enabled(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "backup_enabled", value)

    @property
    @pulumi.getter(name="backupEnabledTime")
    def backup_enabled_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def backup_enabled_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def cross_backup_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cross_backup_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cross_backup_type", value)

    @property
    @pulumi.getter(name="dbInstanceStatus")
    def db_instance_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_instance_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def log_backup_enabled_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def log_backup_enabled_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_backup_enabled_time", value)

    @property
    @pulumi.getter(name="retentType")
    def retent_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @retent_type.setter
    def retent_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RdsInstanceCrossBackupPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            log_backup_enabled_time: Optional[pulumi.Input[builtins.str]] = None,
            retent_type: Optional[pulumi.Input[builtins.str]] = None,
            retention: Optional[pulumi.Input[builtins.int]] = None) -> 'RdsInstanceCrossBackupPolicy':
        """
    ...
    @property
    @pulumi.getter(name="backupEnabled")
    def backup_enabled(self) -> pulumi.Output[builtins.str]:
        """
        The status of the overall cross-region backup switch on the instance. Valid values:
        - Disabled
        - Enable
    ...
    @property
    @pulumi.getter(name="backupEnabledTime")
    def backup_enabled_time(self) -> pulumi.Output[builtins.str]:
        """
        The time when cross-region backup was enabled on the instance. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        """
        return pulumi.get(self, "backup_enabled_time")
    ...
    @property
    @pulumi.getter(name="crossBackupRegion")
    def cross_backup_region(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the destination region where the cross-region backup files of the instance are stored.
        """
        return pulumi.get(self, "cross_backup_region")
    ...
    @property
    @pulumi.getter(name="crossBackupType")
    def cross_backup_type(self) -> pulumi.Output[builtins.str]:
        """
        The policy that is used to save cross-region backups of the instance. Default value: 1. The default value 1 indicates that all cross-region backups are saved.
        """
        return pulumi.get(self, "cross_backup_type")
    ...
    @property
    @pulumi.getter(name="logBackupEnabled")
    def log_backup_enabled(self) -> pulumi.Output[builtins.str]:
        """
        The status of the cross-region log backup feature on the instance. Valid values:
        - Enable: Enables the feature.
        - Disabled: Disables the feature.
    ...
    @property
    @pulumi.getter(name="logBackupEnabledTime")
    def log_backup_enabled_time(self) -> pulumi.Output[builtins.str]:
        """
        The time when cross-region log backup was enabled on the instance. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        """
        return pulumi.get(self, "log_backup_enabled_time")
    ...
    @property
    @pulumi.getter(name="retentType")
    def retent_type(self) -> pulumi.Output[builtins.str]:
        """
        The policy that is used to retain cross-region backups of the instance. Default value: 1. The default value 1 indicate that cross-region backups are retained based on the specified retention period.
        """
        return pulumi.get(self, "retent_type")
    ...
    @property
    @pulumi.getter
    def retention(self) -> pulumi.Output[builtins.int]:
        """
        The number of days for which the cross-region backup files of the instance are retained. Valid values: 7 to 1825. Default value: 7.
        """
        return pulumi.get(self, "retention")
