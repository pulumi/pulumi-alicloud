...
class RdsAccountArgs:
    def __init__(__self__, *,
                 ...
                 reset_permission_flag: Optional[pulumi.Input[builtins.bool]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RdsAccount resource.
        :param pulumi.Input[builtins.str] account_description: The description of the account. The value must be 2 to 256 characters in length. The value can contain letters, digits, underscores (_), and hyphens (-), and must start with a letter.
               
               > **NOTE:** The name cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] account_name: The name of the database account.
        ...
        :param pulumi.Input[builtins.str] account_password: The password of the account.
               * The value must be 8 to 32 characters in length.
               * The password must contain at least three of the following character types: uppercase letters, lowercase letters, digits, and special characters.
               * Special characters include ! @ # $ % ^ & * ( ) _ + - =
        :param pulumi.Input[builtins.str] account_type: The account type. Valid values:
        ...
        :param pulumi.Input[builtins.str] db_instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] description: The attribute has been deprecated from 1.120.0 and using `account_description` instead.
        :param pulumi.Input[builtins.str] instance_id: The attribute has been deprecated from 1.120.0 and using `db_instance_id` instead.
        :param pulumi.Input[builtins.str] kms_encrypted_password: An KMS encrypts password used to a db account. If the `account_password` is filled in, this field will be ignored.
        ...
        :param pulumi.Input[builtins.str] name: The attribute has been deprecated from 1.120.0 and using `account_name` instead.
        :param pulumi.Input[builtins.str] password: The attribute has been deprecated from 1.120.0 and using `account_password` instead.
        :param pulumi.Input[builtins.bool] reset_permission_flag: Resets permissions flag of the privileged account. Default to `false`. Set it to `true` can resets permissions of the privileged account.
        :param pulumi.Input[builtins.str] type: The attribute has been deprecated from 1.120.0 and using `account_type` instead.
    ...
    def reset_permission_flag(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reset_permission_flag(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _RdsAccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The attribute has been deprecated from 1.120.0 and using `account_password` instead.
        :param pulumi.Input[builtins.bool] reset_permission_flag: Resets permissions flag of the privileged account. Default to `false`. Set it to `true` can resets permissions of the privileged account.
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid values: `Available`, `Unavailable`.
        :param pulumi.Input[builtins.str] type: The attribute has been deprecated from 1.120.0 and using `account_type` instead.
...
class RdsAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reset_permission_flag: Optional[pulumi.Input[builtins.bool]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'RdsAccount':
        """
    ...
    @property
    @pulumi.getter(name="accountDescription")
    def account_description(self) -> pulumi.Output[builtins.str]:
        """
        The description of the account. The value must be 2 to 256 characters in length. The value can contain letters, digits, underscores (_), and hyphens (-), and must start with a letter.
    ...
    @property
    @pulumi.getter(name="resetPermissionFlag")
    def reset_permission_flag(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Resets permissions flag of the privileged account. Default to `false`. Set it to `true` can resets permissions of the privileged account.
        """
        return pulumi.get(self, "reset_permission_flag")
