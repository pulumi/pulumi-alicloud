...
class GetZonesResult:
    ...
    def multi(self) -> Optional[builtins.bool]:
...
def get_zones(category: Optional[builtins.str] = None,
              ...
              multi: Optional[builtins.bool] = None,
    ...
    :param builtins.str instance_charge_type: Filter the results by a specific instance charge type. Valid values: `PrePaid` and `PostPaid` and `Serverless`. Default to `PostPaid`.
    :param builtins.bool multi: It has been deprecated from version 1.137.0 and using `multi_zone` instead.
    :param builtins.bool multi_zone: Indicate whether the zones can be used in a multi AZ configuration. Default to `false`. Multi AZ is usually used to launch RDS instances.
...
def get_zones_output(category: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     ...
                     multi: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
