...
class GetZonesResult:
    ...
    def multi(self) -> Optional[_builtins.bool]:
...
def get_zones(category: Optional[_builtins.str] = None,
              ...
              multi: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str instance_charge_type: Filter the results by a specific instance charge type. Valid values: `PrePaid` and `PostPaid` and `Serverless`. Default to `PostPaid`.
    :param _builtins.bool multi: It has been deprecated from version 1.137.0 and using `multi_zone` instead.
    :param _builtins.bool multi_zone: Indicate whether the zones can be used in a multi AZ configuration. Default to `false`. Multi AZ is usually used to launch RDS instances.
