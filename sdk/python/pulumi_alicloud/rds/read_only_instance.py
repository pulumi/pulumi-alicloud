...
class ReadOnlyInstanceArgs:
    def __init__(__self__, *,
                 ...
                 master_db_instance_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.int] instance_storage: User-defined DB instance storage space. Value range: [5, 2000] for MySQL/SQL Server HA dual node edition. Increase progressively at a rate of 5 GB. For details, see [Instance type table](https://www.alibabacloud.com/help/doc-detail/26312.htm).
        ...
        :param pulumi.Input[builtins.str] master_db_instance_id: ID of the master instance.
        ...
        :param pulumi.Input[builtins.str] ca_type: The type of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the SSLEnabled parameter to 1, the default value of this parameter is aliyun. It is valid only when `ssl_enabled  = 1`. Value range:
               - aliyun: a cloud certificate
               - custom: a custom certificate
        :param pulumi.Input[builtins.str] client_ca_cert: The public key of the CA that issues client certificates. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the ClientCAEbabled parameter to 1, you must also specify this parameter. It is valid only when `ssl_enabled  = 1`.
        :param pulumi.Input[builtins.int] client_ca_enabled: Specifies whether to enable the public key of the CA that issues client certificates. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. It is valid only when `ssl_enabled  = 1`. Valid values:
               - 1: enables the public key
               - 0: disables the public key
        :param pulumi.Input[builtins.str] client_cert_revocation_list: The CRL that contains revoked client certificates. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the ClientCrlEnabled parameter to 1, you must also specify this parameter. It is valid only when `ssl_enabled  = 1`.
        ...
        :param pulumi.Input[builtins.str] direction: The instance configuration type. Valid values:
               - Up
               - Down
               - TempUpgrade
               - Serverless
        :param pulumi.Input[builtins.str] effective_time: The method to change.  Default value: Immediate. Valid values:
        ...
        :param pulumi.Input[builtins.str] instance_charge_type: Valid values are `Prepaid`, `Postpaid`, Default to `Postpaid`. The interval between the two conversion operations must be greater than 15 minutes. Only when this parameter is `Postpaid`, the instance can be released.
        ...
        :param pulumi.Input[builtins.str] resource_group_id: The ID of resource group which the DB read-only instance belongs.
        ...
        :param pulumi.Input[builtins.str] server_cert: The content of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the CAType parameter to custom, you must also specify this parameter. It is valid only when `ssl_enabled  = 1`.
        :param pulumi.Input[builtins.str] server_key: The private key of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the CAType parameter to custom, you must also specify this parameter. It is valid only when `ssl_enabled  = 1`.
        :param pulumi.Input[builtins.int] ssl_enabled: Specifies whether to enable or disable SSL encryption. Valid values:
        ...
        :param pulumi.Input[builtins.str] zone_id: The Zone to launch the DB instance.
        """
    ...
    def master_db_instance_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def master_db_instance_id(self, value: pulumi.Input[builtins.str]):
...
class _ReadOnlyInstanceState:
    def __init__(__self__, *,
                 ...
                 master_db_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 modify_mode: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input['ReadOnlyInstanceParameterArgs']]]] = None,
                 period: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] effective_time: The method to change.  Default value: Immediate. Valid values:
               - Immediate: The change immediately takes effect.
               - MaintainTime: The change takes effect during the specified maintenance window. For more information, see ModifyDBInstanceMaintainTime.
        :param pulumi.Input[builtins.str] engine: Database type.
        :param pulumi.Input[builtins.str] engine_version: Database version. Value options can refer to the latest docs [CreateDBInstance](https://www.alibabacloud.com/help/doc-detail/26228.htm) `EngineVersion`.
        :param pulumi.Input[builtins.bool] force_restart: Set it to true to make some parameter efficient when modifying them. Default to false.
        :param pulumi.Input[builtins.str] instance_charge_type: Valid values are `Prepaid`, `Postpaid`, Default to `Postpaid`. The interval between the two conversion operations must be greater than 15 minutes. Only when this parameter is `Postpaid`, the instance can be released.
        :param pulumi.Input[builtins.str] instance_name: The name of DB instance. It a string of 2 to 256 characters.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ReadOnlyInstanceParameterArgs']]] parameters: Set of parameters needs to be set after DB instance was launched. Available parameters can refer to the latest docs [View database parameter templates](https://www.alibabacloud.com/help/doc-detail/26284.htm). See `parameters` below.
        :param pulumi.Input[builtins.int] period: The duration that you will buy DB instance (in month). It is valid when instance_charge_type is `PrePaid`. Valid values: [1~9], 12, 24, 36.
        :param pulumi.Input[builtins.str] port: RDS database connection port.
        :param pulumi.Input[builtins.str] replication_acl: The method that is used to verify the replication permission. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. In addition, this parameter is available only when the public key of the CA that issues client certificates is enabled. It is valid only when `ssl_enabled  = 1`. Valid values:
               - cert
               - perfer
               - verify-ca
    ...
    @property
    @pulumi.getter(name="masterDbInstanceId")
    def master_db_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the master instance.
        """
        return pulumi.get(self, "master_db_instance_id")
    ...
    @master_db_instance_id.setter
    def master_db_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "master_db_instance_id", value)
...
class ReadOnlyInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            whitelist_network_type: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ReadOnlyInstance':
        """
    ...
    @property
    @pulumi.getter(name="masterDbInstanceId")
    def master_db_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the master instance.
        """
        return pulumi.get(self, "master_db_instance_id")
