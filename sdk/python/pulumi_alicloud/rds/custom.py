...
class CustomArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Instance description. It must be 2 to 256 characters in length and cannot start with http:// or https.
        :param pulumi.Input[builtins.str] direction: Instance configuration type, value range:
        ...
        :param pulumi.Input[builtins.bool] dry_run: Whether to pre-check the operation of creating an instance. Valid values:
        :param pulumi.Input[builtins.bool] force: Whether to forcibly release the running instance. Value: true/false
        :param pulumi.Input[builtins.bool] force_stop: Whether to force shutdown. Value range:
        :param pulumi.Input[builtins.str] host_name: The instance host name.
        :param pulumi.Input[builtins.str] image_id: The ID of the image used by the instance.
        :param pulumi.Input[builtins.str] instance_charge_type: The Payment type. Currently, only `Prepaid` (package year and month) types are supported.
        :param pulumi.Input[builtins.str] internet_charge_type: Reserved parameters are not supported.
        :param pulumi.Input[builtins.int] internet_max_bandwidth_out: Reserved parameters are not supported.
        :param pulumi.Input[builtins.str] io_optimized: Reserved parameters are not supported.
        :param pulumi.Input[builtins.str] key_pair_name: The key pair name. Only flyer names are supported.
        :param pulumi.Input[builtins.str] password: The account and password of the instance.
        :param pulumi.Input[builtins.int] period: Prepaid renewal duration, unit: Month/Year.
        :param pulumi.Input[builtins.str] period_unit: The unit of duration of the year-to-month billing method. Value range:
               - `Year`: Year
               - `Month` (default): Month
...
class _CustomState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] period_unit: The unit of duration of the year-to-month billing method. Value range:
               - `Year`: Year
               - `Month` (default): Month
        :param pulumi.Input[builtins.str] region_id: The region ID. Callable DescribeRegions to get.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group
        :param pulumi.Input[builtins.str] security_enhancement_strategy: Reserved parameters are not supported.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: Security group list
        :param pulumi.Input[builtins.str] status: The status of the resource
...
class Custom(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Custom':
        """
