...
__all__ = [
    ...
    'DdrInstanceParameterArgsDict',
    'DdrInstancePgHbaConfArgs',
    'DdrInstancePgHbaConfArgsDict',
    'InstanceBabelfishConfigArgs',
    'InstanceBabelfishConfigArgsDict',
    'InstanceParameterArgs',
    'InstanceParameterArgsDict',
    'InstancePgHbaConfArgs',
    'InstancePgHbaConfArgsDict',
...
class CustomSystemDiskArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] category: The cloud disk type of the system disk. Currently, only `cloud_essd`(ESSD cloud disk) is supported.
        :param pulumi.Input[builtins.str] size: System disk size, unit: GiB. Only ESSD PL1 is supported. Valid values range from 20 to 2048.
        """
        if category is not None:
            pulumi.set(__self__, "category", category)
        if size is not None:
...
class DbInstanceEndpointNodeItemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] weight: The weight of the node. Read requests are distributed based on the weight.Valid values: 0 to 100.
        """
...
if not MYPY:
    class DdrInstancePgHbaConfArgsDict(TypedDict):
        ...
        """
        priority_id: pulumi.Input[builtins.int]
        """
...
class DdrInstancePgHbaConfArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] address: The IP addresses from which the specified users can access the specified databases. If you set this parameter to 0.0.0.0/0, the specified users are allowed to access the specified databases from all IP addresses.
        :param pulumi.Input[builtins.str] database: The name of the database that the specified users are allowed to access. If you set this parameter to all, the specified users are allowed to access all databases in the instance. If you specify multiple databases, separate the database names with commas (,).
        :param pulumi.Input[builtins.str] method: The authentication method of Lightweight Directory Access Protocol (LDAP). Valid values: `trust`, `reject`, `scram-sha-256`, `md5`, `password`, `gss`, `sspi`, `ldap`, `radius`, `cert`, `pam`.
        :param pulumi.Input[builtins.int] priority_id: The priority of an AD domain. If you set this parameter to 0, the AD domain has the highest priority. Valid values: 0 to 10000. This parameter is used to identify each AD domain. When you add an AD domain, the value of the PriorityId parameter of the new AD domain cannot be the same as the value of the PriorityId parameter for any existing AD domain. When you modify or delete an AD domain, you must also modify or delete the value of the PriorityId parameter for this AD domain.
        :param pulumi.Input[builtins.str] type: The type of connection to the instance. Valid values:
               * **host**: specifies to verify TCP/IP connections, including SSL connections and non-SSL connections.
               * **hostssl**: specifies to verify only TCP/IP connections that are established over SSL connections.
               * **hostnossl**: specifies to verify only TCP/IP connections that are established over non-SSL connections.
               
               > **NOTE:** You can set this parameter to hostssl only when SSL encryption is enabled for the instance. For more information, see [Configure SSL encryption for an ApsaraDB RDS for PostgreSQL instance](https://www.alibabacloud.com/help/en/doc-detail/229518.htm).
        :param pulumi.Input[builtins.str] user: The user that is allowed to access the instance. If you specify multiple users, separate the usernames with commas (,).
        :param pulumi.Input[builtins.str] mask: The mask of the instance. If the value of the `Address` parameter is an IP address, you can use this parameter to specify the mask of the IP address.
        :param pulumi.Input[builtins.str] option: Optional. The value of this parameter is based on the value of the HbaItem.N.Method parameter. In this topic, LDAP is used as an example. You must configure this parameter. For more information, see [Authentication Methods](https://www.postgresql.org/docs/11/auth-methods.html).
        """
    ...
    def priority_id(self) -> pulumi.Input[builtins.int]:
        """
        The priority of an AD domain. If you set this parameter to 0, the AD domain has the highest priority. Valid values: 0 to 10000. This parameter is used to identify each AD domain. When you add an AD domain, the value of the PriorityId parameter of the new AD domain cannot be the same as the value of the PriorityId parameter for any existing AD domain. When you modify or delete an AD domain, you must also modify or delete the value of the PriorityId parameter for this AD domain.
        """
    ...
    @priority_id.setter
    def priority_id(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class InstanceBabelfishConfigArgsDict(TypedDict):
        babelfish_enabled: pulumi.Input[builtins.str]
        """
        ...
        """
        master_user_password: pulumi.Input[builtins.str]
        """
        ...
        """
        migration_mode: pulumi.Input[builtins.str]
        """
...
class InstanceBabelfishConfigArgs:
    def __init__(__self__, *,
                 ...
                 migration_mode: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] babelfish_enabled: specifies whether to enable the Babelfish for the instance. If you set this parameter to **true**, you enable Babelfish for the instance. If you leave this parameter empty, you disable Babelfish for the instance.
        :param pulumi.Input[builtins.str] master_user_password: The password of the administrator account. The password must contain at least three of the following character types: uppercase letters, lowercase letters, digits, and special characters. It must be 8 to 32 characters in length. The password can contain any of the following characters:! @ # $ % ^ & * () _ + - =
        :param pulumi.Input[builtins.str] master_username: The name of the administrator account. The name can contain lowercase letters, digits, and underscores (_). It must start with a letter and end with a letter or digit. It can be up to 63 characters in length and cannot start with pg.
        :param pulumi.Input[builtins.str] migration_mode: The migration mode of the instance. Valid values: **single-db** and **multi-db**.
        """
    ...
    def babelfish_enabled(self) -> pulumi.Input[builtins.str]:
        """
        specifies whether to enable the Babelfish for the instance. If you set this parameter to **true**, you enable Babelfish for the instance. If you leave this parameter empty, you disable Babelfish for the instance.
        """
    ...
    def babelfish_enabled(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "babelfish_enabled", value)

    @property
    @pulumi.getter(name="masterUserPassword")
    def master_user_password(self) -> pulumi.Input[builtins.str]:
        """
        The password of the administrator account. The password must contain at least three of the following character types: uppercase letters, lowercase letters, digits, and special characters. It must be 8 to 32 characters in length. The password can contain any of the following characters:! @ # $ % ^ & * () _ + - =
        """
    ...
    def master_user_password(self, value: pulumi.Input[builtins.str]):
    ...
    def migration_mode(self) -> pulumi.Input[builtins.str]:
        """
        The migration mode of the instance. Valid values: **single-db** and **multi-db**.
        """
    ...
    def migration_mode(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class InstanceServerlessConfigArgsDict(TypedDict):
        ...
        switch_force: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class InstanceServerlessConfigArgs:
    def __init__(__self__, *,
                 ...
                 switch_force: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.float] max_capacity: The maximum number of RDS Capacity Units (RCUs). The value of this parameter must be greater than or equal to `min_capacity` and only supports passing integers. Valid values:
               - MySQL: 1~8
               - SQLServer: 2~8
               - PostgreSQL: 1~12
        :param pulumi.Input[builtins.float] min_capacity: The minimum number of RCUs. The value of this parameter must be less than or equal to `max_capacity`. Valid values:
               - MySQL: 0.5~8
               - SQLServer: 2~8 \\(Supports integers only\\).
               - PostgreSQL: 0.5~12
        :param pulumi.Input[builtins.bool] switch_force: Specifies whether to enable the forced scaling feature for the serverless instance. Valid values:
               - true: enables the feature.
               - false: disables the feature. This is the default value.
               > - Only MySQL Serverless instances need to set this parameter. After enabling this parameter, there will be a flash break within 1 minute when the instance is forced to expand or shrink. Please use it with caution according to the actual situation.
               > - The elastic scaling of an instance RCU usually takes effect immediately, but in some special circumstances (such as during large transaction execution), it is not possible to complete scaling immediately. In this case, this parameter can be enabled to force scaling.
    ...
    def switch_force(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to enable the forced scaling feature for the serverless instance. Valid values:
        - true: enables the feature.
        - false: disables the feature. This is the default value.
    ...
    @switch_force.setter
    def switch_force(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class RdsCloneDbInstanceParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The parameters name.
        :param pulumi.Input[builtins.str] value: The parameters value.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class RdsCloneDbInstanceServerlessConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] min_capacity: The minimum number of RCUs. The value of this parameter must be less than or equal to `max_capacity`. Valid values:
               ...
               - SQLServer: 2~8 \\(Supports integers only\\).
               - PostgreSQL: 0.5~12
        :param pulumi.Input[builtins.bool] auto_pause: Specifies whether to enable the smart startup and stop feature for the serverless instance. Valid values:
               - true: enables the feature.
               - false: disables the feature. This is the default value.
               > - Only MySQL Serverless instances need to set this parameter. If there is no connection within 10 minutes, it will enter a paused state and automatically wake up when the connection enters.
        :param pulumi.Input[builtins.bool] switch_force: Specifies whether to enable the forced scaling feature for the serverless instance. Valid values:
...
class RdsDbProxyReadOnlyInstanceWeightArgs:
    def __init__(__self__, *,
                 ...
                 weight: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] instance_id: The Id of the instance and its read-only instances that can run database.
        :param pulumi.Input[builtins.str] weight: Weight of instances that can run the database and their read-only instances. Read weights increase in increments of 100, and the maximum read weight is 10000.
        """
...
if not MYPY:
    class RdsParameterGroupParamDetailArgsDict(TypedDict):
        ...
        """
        param_value: pulumi.Input[builtins.str]
        """
...
class RdsParameterGroupParamDetailArgs:
    def __init__(__self__, *,
                 ...
                 param_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] param_name: The name of a parameter.
        :param pulumi.Input[builtins.str] param_value: The value of a parameter.
        """
    ...
    def param_value(self) -> pulumi.Input[builtins.str]:
        """
        The value of a parameter.
        """
    ...
    @param_value.setter
    def param_value(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class GetCollationTimeZonesCollationTimeZoneArgsDict(TypedDict):
        ...
        """
        standard_time_offset: NotRequired[builtins.str]
        """
        The offset of the UTC time. The offset is in the following format: (UTC+<i>HH:mm</i>).
        """
        time_zone: NotRequired[builtins.str]
        """
...
class GetCollationTimeZonesCollationTimeZoneArgs:
    def __init__(__self__, *,
                 ...
                 standard_time_offset: Optional[builtins.str] = None,
                 time_zone: Optional[builtins.str] = None):
        """
        :param builtins.str description: The code of the instance type.
        :param builtins.str standard_time_offset: The offset of the UTC time. The offset is in the following format: (UTC+<i>HH:mm</i>).
        :param builtins.str time_zone: The time zone that is available for use in ApsaraDB RDS.
        """
    ...
    def standard_time_offset(self) -> Optional[builtins.str]:
        """
        The offset of the UTC time. The offset is in the following format: (UTC+<i>HH:mm</i>).
        """
    ...
    def standard_time_offset(self, value: Optional[builtins.str]):
    ...
    @time_zone.setter
    def time_zone(self, value: Optional[builtins.str]):
        pulumi.set(self, "time_zone", value)


if not MYPY:
    class GetInstanceClassInfosInfoArgsDict(TypedDict):
        class_code: NotRequired[builtins.str]
        """
        The code of the instance type.
        """
        class_group: NotRequired[builtins.str]
        """
        The instance family of the instance.
        """
        cpu: NotRequired[builtins.str]
        """
        The number of cores that are supported by the instance type. Unit: cores.
        """
        instruction_set_arch: NotRequired[builtins.str]
        """
        The architecture of the instance type.
        """
        max_connections: NotRequired[builtins.str]
        """
        The maximum number of connections that are supported by the instance type. Unit: connections.
        """
        max_iombps: NotRequired[builtins.str]
        """
        The maximum I/O bandwidth that is supported by the instance type. Unit: Mbit/s.
        """
        max_iops: NotRequired[builtins.str]
        """
        The maximum input/output operations per second (IOPS) that is supported by the instance type. Unit: operations per second.
        """
        memory_class: NotRequired[builtins.str]
        """
        The memory capacity that is supported by the instance type. Unit: GB.
        """
        reference_price: NotRequired[builtins.str]
        """
...
class GetInstanceClassInfosInfoArgs:
    def __init__(__self__, *,
                 class_code: Optional[builtins.str] = None,
                 class_group: Optional[builtins.str] = None,
                 cpu: Optional[builtins.str] = None,
                 instruction_set_arch: Optional[builtins.str] = None,
                 max_connections: Optional[builtins.str] = None,
                 max_iombps: Optional[builtins.str] = None,
                 max_iops: Optional[builtins.str] = None,
                 memory_class: Optional[builtins.str] = None,
                 reference_price: Optional[builtins.str] = None):
        """
        :param builtins.str class_code: The code of the instance type.
        :param builtins.str class_group: The instance family of the instance.
        :param builtins.str cpu: The number of cores that are supported by the instance type. Unit: cores.
        :param builtins.str instruction_set_arch: The architecture of the instance type.
        :param builtins.str max_connections: The maximum number of connections that are supported by the instance type. Unit: connections.
        :param builtins.str max_iombps: The maximum I/O bandwidth that is supported by the instance type. Unit: Mbit/s.
        :param builtins.str max_iops: The maximum input/output operations per second (IOPS) that is supported by the instance type. Unit: operations per second.
        :param builtins.str memory_class: The memory capacity that is supported by the instance type. Unit: GB.
        :param builtins.str reference_price: The fee that you must pay for the instance type. Unit: cent (USD).
        """
    ...
    def class_code(self) -> Optional[builtins.str]:
        """
        The code of the instance type.
        """
    ...
    @class_code.setter
    def class_code(self, value: Optional[builtins.str]):
        pulumi.set(self, "class_code", value)

    @property
    @pulumi.getter(name="classGroup")
    def class_group(self) -> Optional[builtins.str]:
        """
        The instance family of the instance.
        """
    ...
    @class_group.setter
    def class_group(self, value: Optional[builtins.str]):
    ...
    @cpu.setter
    def cpu(self, value: Optional[builtins.str]):
        pulumi.set(self, "cpu", value)

    @property
    @pulumi.getter(name="instructionSetArch")
    def instruction_set_arch(self) -> Optional[builtins.str]:
        """
        The architecture of the instance type.
        """
    ...
    def instruction_set_arch(self, value: Optional[builtins.str]):
        pulumi.set(self, "instruction_set_arch", value)

    @property
    @pulumi.getter(name="maxConnections")
    def max_connections(self) -> Optional[builtins.str]:
        """
        The maximum number of connections that are supported by the instance type. Unit: connections.
        """
    ...
    def max_connections(self, value: Optional[builtins.str]):
        pulumi.set(self, "max_connections", value)

    @property
    @pulumi.getter(name="maxIombps")
    def max_iombps(self) -> Optional[builtins.str]:
        """
        The maximum I/O bandwidth that is supported by the instance type. Unit: Mbit/s.
        """
    ...
    @max_iombps.setter
    def max_iombps(self, value: Optional[builtins.str]):
        pulumi.set(self, "max_iombps", value)

    @property
    @pulumi.getter(name="maxIops")
    def max_iops(self) -> Optional[builtins.str]:
        """
        The maximum input/output operations per second (IOPS) that is supported by the instance type. Unit: operations per second.
        """
    ...
    @max_iops.setter
    def max_iops(self, value: Optional[builtins.str]):
        pulumi.set(self, "max_iops", value)

    @property
    @pulumi.getter(name="memoryClass")
    def memory_class(self) -> Optional[builtins.str]:
        """
        The memory capacity that is supported by the instance type. Unit: GB.
        """
    ...
    @memory_class.setter
    def memory_class(self, value: Optional[builtins.str]):
        pulumi.set(self, "memory_class", value)

    @property
    @pulumi.getter(name="referencePrice")
    def reference_price(self) -> Optional[builtins.str]:
        """
        The fee that you must pay for the instance type. Unit: cent (USD).
        """
    ...
    def reference_price(self, value: Optional[builtins.str]):
