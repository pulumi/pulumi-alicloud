...
class DbNodeArgs:
    def __init__(__self__, *,
                 class_code: pulumi.Input[builtins.str],
                 db_instance_id: pulumi.Input[builtins.str],
                 zone_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a DbNode resource.
        :param pulumi.Input[builtins.str] class_code: The specification information of the node.
        :param pulumi.Input[builtins.str] db_instance_id: The Id of instance that can run database.
        :param pulumi.Input[builtins.str] zone_id: The zone ID of the node.
        """
    ...
    def class_code(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @class_code.setter
    def class_code(self, value: pulumi.Input[builtins.str]):
...
class _DbNodeState:
    def __init__(__self__, *,
                 class_code: Optional[pulumi.Input[builtins.str]] = None,
                 db_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 node_id: Optional[pulumi.Input[builtins.str]] = None,
                 node_region_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] node_region_id: The region ID of the node.
        :param pulumi.Input[builtins.str] node_role: The role of node.
        :param pulumi.Input[builtins.str] zone_id: The zone ID of the node.
        """
    ...
    @property
    @pulumi.getter(name="classCode")
    def class_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The specification information of the node.
        """
        return pulumi.get(self, "class_code")
    ...
    @class_code.setter
    def class_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "class_code", value)
    ...
    def node_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def node_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DbNode(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            node_region_id: Optional[pulumi.Input[builtins.str]] = None,
            node_role: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DbNode':
        """
    ...
    @property
    @pulumi.getter(name="classCode")
    def class_code(self) -> pulumi.Output[builtins.str]:
        """
        The specification information of the node.
        """
        return pulumi.get(self, "class_code")
    ...
    @property
    @pulumi.getter(name="nodeRegionId")
    def node_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The region ID of the node.
        """
        return pulumi.get(self, "node_region_id")
