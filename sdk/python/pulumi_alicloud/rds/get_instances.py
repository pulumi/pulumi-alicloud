...
def get_instances(connection_mode: Optional[builtins.str] = None,
    ...
    :param builtins.bool enable_details: Default to `false`. Set it to `true` can output parameter template about resource attributes.
    ...
    :param Sequence[builtins.str] ids: A list of RDS instance IDs.
    ...
    :param Mapping[str, builtins.str] tags: A map of tags assigned to the DB instances. 
...
def get_instances_output(connection_mode: Optional[pulumi.Input[Optional[builtins.str]]] = None,
