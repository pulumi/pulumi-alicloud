...
def get_instances(connection_mode: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool enable_details: Default to `false`. Set it to `true` can output parameter template about resource attributes.
    ...
    :param Sequence[_builtins.str] ids: A list of RDS instance IDs.
...
def get_instances_output(connection_mode: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
