...
class GetInstanceClassesResult:
    ...
    def commodity_code(self) -> Optional[builtins.str]:
    ...
    def db_instance_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "db_instance_id")

    @property
    @pulumi.getter(name="dbInstanceStorageType")
    def db_instance_storage_type(self) -> Optional[builtins.str]:
    ...
    def multi_zone(self) -> Optional[builtins.bool]:
...
def get_instance_classes(category: Optional[builtins.str] = None,
                         commodity_code: Optional[builtins.str] = None,
                         db_instance_class: Optional[builtins.str] = None,
                         db_instance_id: Optional[builtins.str] = None,
                         db_instance_storage_type: Optional[builtins.str] = None,
                         ...
                         multi_zone: Optional[builtins.bool] = None,
    ...
    :param builtins.str category: DB Instance category. the value like [`Basic`, `HighAvailability`, `Finance`, `AlwaysOn`, `serverless_basic`, `serverless_standard`, `serverless_ha`, `cluster`], [detail info](https://www.alibabacloud.com/help/doc-detail/69795.htm).
    :param builtins.str commodity_code: The commodity code of the instance. Valid values:
    ...
    :param builtins.str db_instance_class: The DB instance class type by the user.
    :param builtins.str db_instance_id: The ID of the instance.
           
           > **NOTE**: The field `db_instance_id` will be ignored when `commodity_code` is not a read-only type.
    :param builtins.str db_instance_storage_type: The DB instance storage space required by the user. Valid values: "cloud_ssd", "local_ssd", "cloud_essd", "cloud_essd2", "cloud_essd3".
    :param builtins.str engine: Database type. Valid values:"MySQL", "SQLServer", "PostgreSQL", "MariaDB". If not set, it will match all of engines.
    :param builtins.str engine_version: Database version required by the user. Value options can refer to the latest docs [detail info](https://www.alibabacloud.com/help/doc-detail/26228.htm) `EngineVersion`.
    :param builtins.str instance_charge_type: Filter the results by charge type. Valid values: `PrePaid` and `PostPaid` and `Serverless`. Default to `PostPaid`.
    :param builtins.bool multi_zone: Whether to show multi available zone. Default false to not show multi availability zone.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi up`).
    :param builtins.str storage_type: It has been deprecated from version 1.134.0+ and using `db_instance_storage_type` instead.
    :param builtins.str zone_id: The Zone to launch the DB instance.
    """
    __args__ = dict()
...
def get_instance_classes_output(category: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                commodity_code: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                db_instance_class: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                db_instance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                db_instance_storage_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                multi_zone: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
