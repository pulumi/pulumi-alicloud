...
class DbInstanceEndpointArgs:
    def __init__(__self__, *,
                 ...
                 db_instance_endpoint_description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DbInstanceEndpoint resource.
        :param pulumi.Input[builtins.str] connection_string_prefix: The IP address of the internal endpoint.
        ...
        :param pulumi.Input[builtins.str] port: The port number of the internal endpoint. You can specify the port number for the internal endpoint.Valid values: 3000 to 5999.
        :param pulumi.Input[builtins.str] vpc_id: The virtual private cloud (VPC) ID of the internal endpoint.
        :param pulumi.Input[builtins.str] vswitch_id: The vSwitch ID of the internal endpoint.
        :param pulumi.Input[builtins.str] db_instance_endpoint_description: The user-defined description of the endpoint.
        """
    ...
    def db_instance_endpoint_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_instance_endpoint_description(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DbInstanceEndpointState:
    def __init__(__self__, *,
                 ...
                 db_instance_endpoint_description: Optional[pulumi.Input[builtins.str]] = None,
                 db_instance_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
                 db_instance_endpoint_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] connection_string: The internal endpoint.
        :param pulumi.Input[builtins.str] connection_string_prefix: The IP address of the internal endpoint.
        :param pulumi.Input[builtins.str] db_instance_endpoint_description: The user-defined description of the endpoint.
        :param pulumi.Input[builtins.str] db_instance_endpoint_id: The Endpoint ID of the instance.
        :param pulumi.Input[builtins.str] db_instance_endpoint_type: The type of the endpoint.
        :param pulumi.Input[builtins.str] db_instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] ip_type: The type of the IP address.
        :param pulumi.Input[Sequence[pulumi.Input['DbInstanceEndpointNodeItemArgs']]] node_items: The information about the node that is configured for the endpoint.  It contains two sub-fields(node_id and weight). See `node_items` below.
        :param pulumi.Input[builtins.str] port: The port number of the internal endpoint. You can specify the port number for the internal endpoint.Valid values: 3000 to 5999.
        :param pulumi.Input[builtins.str] private_ip_address: The IP address of the internal endpoint.
        :param pulumi.Input[builtins.str] vpc_id: The virtual private cloud (VPC) ID of the internal endpoint.
        :param pulumi.Input[builtins.str] vswitch_id: The vSwitch ID of the internal endpoint.
        """
    ...
    def db_instance_endpoint_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_instance_endpoint_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_instance_endpoint_id", value)

    @property
    @pulumi.getter(name="dbInstanceEndpointType")
    def db_instance_endpoint_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_instance_endpoint_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DbInstanceEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            private_ip_address: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DbInstanceEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="dbInstanceEndpointDescription")
    def db_instance_endpoint_description(self) -> pulumi.Output[builtins.str]:
        """
        The user-defined description of the endpoint.
        """
        return pulumi.get(self, "db_instance_endpoint_description")
    ...
    @property
    @pulumi.getter(name="dbInstanceEndpointId")
    def db_instance_endpoint_id(self) -> pulumi.Output[builtins.str]:
        """
        The Endpoint ID of the instance.
        """
        return pulumi.get(self, "db_instance_endpoint_id")
    ...
    @property
    @pulumi.getter(name="dbInstanceEndpointType")
    def db_instance_endpoint_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the endpoint.
        """
        return pulumi.get(self, "db_instance_endpoint_type")
