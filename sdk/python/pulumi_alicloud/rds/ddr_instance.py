...
class DdrInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] engine_version: Database version. Value options can refer to the latest docs [CreateDdrInstance](https://www.alibabacloud.com/help/en/apsaradb-for-rds/latest/restore-data-to-a-new-instance-across-regions) `EngineVersion`.
        :param pulumi.Input[_builtins.int] instance_storage: The storage capacity of the destination instance. Valid values: 5 to 2000. Unit: GB.
               
               This value must be a multiple of 5 GB. For more information, see Primary ApsaraDB RDS instance types.
        :param pulumi.Input[_builtins.str] instance_type: DB Instance type.
        ...
        :param pulumi.Input[_builtins.str] payment_type: Valid values are `Subscription`, `PayAsYouGo`, Default to `PayAsYouGo`.
        :param pulumi.Input[_builtins.str] restore_type: The method that is used to restore data. Valid values:
        ...
        :param pulumi.Input[_builtins.bool] auto_renew: Whether to renewal a DB instance automatically or not. It is valid when payment_type is `Subscription`. Default to `false`.
        :param pulumi.Input[_builtins.int] auto_renew_period: Auto-renewal period of an instance, in the unit of the month. It is valid when payment_type is `Subscription`. Valid value:[1~12], Default to 1.
        ...
        :param pulumi.Input[_builtins.str] backup_set_id: The ID of the backup set that is used for the restoration. You can call the DescribeCrossRegionBackups operation to query the ID of the backup set.
        :param pulumi.Input[_builtins.str] ca_type: The type of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the SSLEnabled parameter to 1, the default value of this parameter is aliyun. Value range:
        ...
        :param pulumi.Input[_builtins.int] monitoring_period: The monitoring frequency in seconds. Valid values are 5, 60, 300. Defaults to 300.
        ...
        :param pulumi.Input[_builtins.int] period: The duration that you will buy DB instance (in month). It is valid when payment_type is `Subscription`. Valid values: [1~9], 12, 24, 36.
        ...
        :param pulumi.Input[_builtins.str] restore_time: The point in time to which you want to restore data. The point in time that you specify must be earlier than the current time. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: ) The list IDs to join ECS Security Group. At most supports three security groups.
        ...
        :param pulumi.Input[_builtins.str] server_cert: The content of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the CAType parameter to custom, you must also specify this parameter.
        :param pulumi.Input[_builtins.str] server_key: The private key of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the CAType parameter to custom, you must also specify this parameter.
        :param pulumi.Input[_builtins.str] source_db_instance_name: The ID of the source instance if you want to restore data to a point in time.
        :param pulumi.Input[_builtins.str] source_region: The region ID of the source instance if you want to restore data to a point in time.
        ...
        :param pulumi.Input[_builtins.str] ssl_action: Actions performed on SSL functions, Valid values: `Open`: turn on SSL encryption; `Close`: turn off SSL encryption; `Update`: update SSL certificate. See more [engine and engineVersion limitation](https://www.alibabacloud.com/help/zh/doc-detail/26254.htm).
        ...
        :param pulumi.Input[_builtins.int] storage_threshold: The trigger threshold (percentage) for automatic storage space expansion. Valid values:
               - 10
               - 20
               - 30
               - 40
        ...
        :param pulumi.Input[_builtins.str] tde_status: The TDE(Transparent Data Encryption) status. See more [engine and engineVersion limitation](https://www.alibabacloud.com/help/zh/doc-detail/26256.htm).
...
class _DdrInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ca_type: The type of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the SSLEnabled parameter to 1, the default value of this parameter is aliyun. Value range:
               - aliyun: a cloud certificate
               - custom: a custom certificate
        :param pulumi.Input[_builtins.str] category: The RDS edition of the instance.
        :param pulumi.Input[_builtins.str] client_ca_cert: The public key of the CA that issues client certificates. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the ClientCAEbabled parameter to 1, you must also specify this parameter.
        :param pulumi.Input[_builtins.int] client_ca_enabled: Specifies whether to enable the public key of the CA that issues client certificates. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. Valid values:
               - 1: enables the public key
               - 0: disables the public key
        ...
        :param pulumi.Input[_builtins.str] zone_id: The Zone to launch the DB instance. It supports multiple zone.
               If it is a multi-zone and `vswitch_id` is specified, the vswitch must in the one of them.
               The multiple zone ID can be retrieved by setting `multi` to "true" in the data source `get_zones`.
        :param pulumi.Input[_builtins.str] zone_id_slave_a: The region ID of the secondary instance if you create a secondary instance.
        :param pulumi.Input[_builtins.str] zone_id_slave_b: The region ID of the log instance if you create a log instance.
        """
        if acl is not None:
            pulumi.set(__self__, "acl", acl)
        if auto_renew is not None:
...
class DdrInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 modify_mode: pulumi.Input[Optional[_builtins.str]] = None,
                 monitoring_period: pulumi.Input[Optional[_builtins.int]] = None,
                 parameters: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DdrInstanceParameterArgs', 'DdrInstanceParameterArgsDict', 'outputs.DdrInstanceParameter']]]]] = None,
                 payment_type: pulumi.Input[Optional[_builtins.str]] = None,
                 period: pulumi.Input[Optional[_builtins.int]] = None,
                 pg_hba_confs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DdrInstancePgHbaConfArgs', 'DdrInstancePgHbaConfArgsDict', 'outputs.DdrInstancePgHbaConf']]]]] = None,
                 port: pulumi.Input[Optional[_builtins.str]] = None,
                 private_ip_address: pulumi.Input[Optional[_builtins.str]] = None,
                 released_keep_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 replication_acl: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] modify_mode: The method that is used to modify the IP address whitelist. Default value: Cover. Valid values:
               ...
               - Delete: Delete IP addresses and CIDR blocks that are specified in the SecurityIps parameter from the IP address whitelist. You must retain at least one IP address or CIDR block.
        :param pulumi.Input[_builtins.int] monitoring_period: The monitoring frequency in seconds. Valid values are 5, 60, 300. Defaults to 300.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DdrInstanceParameterArgs', 'DdrInstanceParameterArgsDict', 'outputs.DdrInstanceParameter']]]] parameters: Set of parameters needs to be set after DB instance was launched. Available parameters can refer to the latest docs [View database parameter templates](https://www.alibabacloud.com/help/doc-detail/26284.htm) . See `parameters` below.
        :param pulumi.Input[_builtins.str] payment_type: Valid values are `Subscription`, `PayAsYouGo`, Default to `PayAsYouGo`.
        :param pulumi.Input[_builtins.int] period: The duration that you will buy DB instance (in month). It is valid when payment_type is `Subscription`. Valid values: [1~9], 12, 24, 36.
               > **NOTE:** The attribute `period` is only used to create Subscription instance or modify the PayAsYouGo instance to Subscription. Once effect, it will not be modified that means running `pulumi up` will not effect the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DdrInstancePgHbaConfArgs', 'DdrInstancePgHbaConfArgsDict', 'outputs.DdrInstancePgHbaConf']]]] pg_hba_confs: The configuration of [AD domain](https://www.alibabacloud.com/help/en/doc-detail/349288.htm) . See `pg_hba_conf` below.
        :param pulumi.Input[_builtins.str] port: The private port of the database service. If you want to update public port, please use resource rds.Connection port.
        :param pulumi.Input[_builtins.str] private_ip_address: The private IP address of the instance. The private IP address must be within the Classless Inter-Domain Routing (CIDR) block of the vSwitch that is specified by the VSwitchId parameter.
        :param pulumi.Input[_builtins.str] released_keep_policy: The policy based on which ApsaraDB RDS retains archived backup files after the instance is released. Valid values:
               - None: No archived backup files are retained.
    ...
    @_builtins.property
    @pulumi.getter(name="forceRestart")
    def force_restart(self) -> pulumi.Output[_builtins.bool]:
        """
        Set it to true to make some parameter efficient when modifying them. Default to false.
        """
        return pulumi.get(self, "force_restart")
    ...
    @_builtins.property
    @pulumi.getter(name="securityIpMode")
    def security_ip_mode(self) -> pulumi.Output[_builtins.str]:
        """
        Valid values are `normal`, `safety`, Default to `normal`. support `safety` switch to high security access mode.
        """
        return pulumi.get(self, "security_ip_mode")
    ...
    @_builtins.property
    @pulumi.getter(name="sourceDbInstanceName")
    def source_db_instance_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of the source instance if you want to restore data to a point in time.
        """
        return pulumi.get(self, "source_db_instance_name")
    ...
    @_builtins.property
    @pulumi.getter(name="sqlCollectorConfigValue")
    def sql_collector_config_value(self) -> pulumi.Output[_builtins.int]:
        """
        The sql collector keep time of the instance. Valid values are `30`, `180`, `365`, `1095`, `1825`, Default to `30`.
        """
        return pulumi.get(self, "sql_collector_config_value")
