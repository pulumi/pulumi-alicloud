...
class DdrInstanceArgs:
    def __init__(__self__, *,
                 ...
                 restore_type: pulumi.Input[builtins.str],
                 ...
                 backup_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 source_db_instance_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] engine: Database type. Value options: MySQL, SQLServer.
        ...
        :param pulumi.Input[builtins.str] engine_version: Database version. Value options can refer to the latest docs [CreateDdrInstance](https://www.alibabacloud.com/help/en/apsaradb-for-rds/latest/restore-data-to-a-new-instance-across-regions) `EngineVersion`.
        :param pulumi.Input[builtins.int] instance_storage: The storage capacity of the destination instance. Valid values: 5 to 2000. Unit: GB.
               
               This value must be a multiple of 5 GB. For more information, see Primary ApsaraDB RDS instance types.
        :param pulumi.Input[builtins.str] instance_type: DB Instance type.
        ...
        :param pulumi.Input[builtins.str] payment_type: Valid values are `Subscription`, `PayAsYouGo`, Default to `PayAsYouGo`.
        :param pulumi.Input[builtins.str] restore_type: The method that is used to restore data. Valid values:
        ...
        :param pulumi.Input[builtins.bool] auto_renew: Whether to renewal a DB instance automatically or not. It is valid when payment_type is `Subscription`. Default to `false`.
        :param pulumi.Input[builtins.int] auto_renew_period: Auto-renewal period of an instance, in the unit of the month. It is valid when payment_type is `Subscription`. Valid value:[1~12], Default to 1.
        ...
        :param pulumi.Input[builtins.str] backup_set_id: The ID of the backup set that is used for the restoration. You can call the DescribeCrossRegionBackups operation to query the ID of the backup set.
        :param pulumi.Input[builtins.str] ca_type: The type of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the SSLEnabled parameter to 1, the default value of this parameter is aliyun. Value range:
        ...
        :param pulumi.Input[builtins.str] db_instance_storage_type: The storage type of the instance. Valid values:
        ...
        :param pulumi.Input[builtins.int] monitoring_period: The monitoring frequency in seconds. Valid values are 5, 60, 300. Defaults to 300.
        ...
        :param pulumi.Input[builtins.int] period: The duration that you will buy DB instance (in month). It is valid when payment_type is `Subscription`. Valid values: [1~9], 12, 24, 36.
        ...
        :param pulumi.Input[builtins.str] restore_time: The point in time to which you want to restore data. The point in time that you specify must be earlier than the current time. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: ) The list IDs to join ECS Security Group. At most supports three security groups.
        ...
        :param pulumi.Input[builtins.str] server_cert: The content of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the CAType parameter to custom, you must also specify this parameter.
        :param pulumi.Input[builtins.str] server_key: The private key of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the CAType parameter to custom, you must also specify this parameter.
        :param pulumi.Input[builtins.str] source_db_instance_name: The ID of the source instance if you want to restore data to a point in time.
        :param pulumi.Input[builtins.str] source_region: The region ID of the source instance if you want to restore data to a point in time.
        ...
        :param pulumi.Input[builtins.str] ssl_action: Actions performed on SSL functions, Valid values: `Open`: turn on SSL encryption; `Close`: turn off SSL encryption; `Update`: update SSL certificate. See more [engine and engineVersion limitation](https://www.alibabacloud.com/help/zh/doc-detail/26254.htm).
        ...
        :param pulumi.Input[builtins.int] storage_threshold: The trigger threshold (percentage) for automatic storage space expansion. Valid values:
               - 10
               - 20
               - 30
               - 40
        ...
        :param pulumi.Input[builtins.str] switch_time: The specific point in time when you want to perform the update. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. It is valid only when `upgrade_db_instance_kernel_version = true`. The time must be in UTC.
               
               > **NOTE:** This parameter takes effect only when you set the UpgradeTime parameter to SpecifyTime.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
               - Key: It can be up to 64 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It cannot be a null string.
               - Value: It can be up to 128 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It can be a null string.
        :param pulumi.Input[builtins.str] target_minor_version: The minor engine version to which you want to update the instance. If you do not specify this parameter, the instance is updated to the latest minor engine version. It is valid only when `upgrade_db_instance_kernel_version = true`. You must specify the minor engine version in one of the following formats:
        ...
        :param pulumi.Input[builtins.str] tde_status: The TDE(Transparent Data Encryption) status. See more [engine and engineVersion limitation](https://www.alibabacloud.com/help/zh/doc-detail/26256.htm).
        ...
        :param pulumi.Input[builtins.str] upgrade_time: The method to update the minor engine version. Default value: Immediate. It is valid only when `upgrade_db_instance_kernel_version = true`. Valid values:
    ...
    def restore_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @restore_type.setter
    def restore_type(self, value: pulumi.Input[builtins.str]):
    ...
    def backup_set_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def backup_set_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_db_instance_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_db_instance_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DdrInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ca_type: The type of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the SSLEnabled parameter to 1, the default value of this parameter is aliyun. Value range:
               - aliyun: a cloud certificate
               - custom: a custom certificate
        :param pulumi.Input[builtins.str] category: The RDS edition of the instance.
        :param pulumi.Input[builtins.str] client_ca_cert: The public key of the CA that issues client certificates. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. If you set the ClientCAEbabled parameter to 1, you must also specify this parameter.
        :param pulumi.Input[builtins.int] client_ca_enabled: Specifies whether to enable the public key of the CA that issues client certificates. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. Valid values:
               - 1: enables the public key
               - 0: disables the public key
        ...
        :param pulumi.Input[builtins.str] zone_id: The Zone to launch the DB instance. It supports multiple zone.
               If it is a multi-zone and `vswitch_id` is specified, the vswitch must in the one of them.
               The multiple zone ID can be retrieved by setting `multi` to "true" in the data source `get_zones`.
        :param pulumi.Input[builtins.str] zone_id_slave_a: The region ID of the secondary instance if you create a secondary instance.
        :param pulumi.Input[builtins.str] zone_id_slave_b: The region ID of the log instance if you create a log instance.
        """
        if acl is not None:
            pulumi.set(__self__, "acl", acl)
        if auto_renew is not None:
...
class DdrInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            zone_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id_slave_a: Optional[pulumi.Input[builtins.str]] = None,
            zone_id_slave_b: Optional[pulumi.Input[builtins.str]] = None) -> 'DdrInstance':
        """
    ...
    @property
    @pulumi.getter(name="backupSetId")
    def backup_set_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the backup set that is used for the restoration. You can call the DescribeCrossRegionBackups operation to query the ID of the backup set.
        """
        return pulumi.get(self, "backup_set_id")
    ...
    @property
    @pulumi.getter(name="forceRestart")
    def force_restart(self) -> pulumi.Output[builtins.bool]:
        """
        Set it to true to make some parameter efficient when modifying them. Default to false.
        """
        return pulumi.get(self, "force_restart")
    ...
    @property
    @pulumi.getter(name="restoreType")
    def restore_type(self) -> pulumi.Output[builtins.str]:
        """
        The method that is used to restore data. Valid values:
        - BackupSet: Data is restored from a backup set. If you use this value, you must also specify the BackupSetID parameter.
        - BackupTime: restores data to a point in time. You must also specify the RestoreTime, SourceRegion, and SourceDBInstanceName parameters.
    ...
    @property
    @pulumi.getter(name="securityIpMode")
    def security_ip_mode(self) -> pulumi.Output[builtins.str]:
        """
        Valid values are `normal`, `safety`, Default to `normal`. support `safety` switch to high security access mode.
        """
        return pulumi.get(self, "security_ip_mode")
    ...
    @property
    @pulumi.getter(name="sourceDbInstanceName")
    def source_db_instance_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the source instance if you want to restore data to a point in time.
        """
        return pulumi.get(self, "source_db_instance_name")
    ...
    @property
    @pulumi.getter(name="sqlCollectorConfigValue")
    def sql_collector_config_value(self) -> pulumi.Output[builtins.int]:
        """
        The sql collector keep time of the instance. Valid values are `30`, `180`, `365`, `1095`, `1825`, Default to `30`.
        """
        return pulumi.get(self, "sql_collector_config_value")
    ...
    @property
    @pulumi.getter(name="tdeStatus")
    def tde_status(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The TDE(Transparent Data Encryption) status. See more [engine and engineVersion limitation](https://www.alibabacloud.com/help/zh/doc-detail/26256.htm).
        """
        return pulumi.get(self, "tde_status")
