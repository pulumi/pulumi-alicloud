...
class CustomSystemDisk(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str category: The cloud disk type of the system disk. Currently, only `cloud_essd`(ESSD cloud disk) is supported.
        :param builtins.str size: System disk size, unit: GiB. Only ESSD PL1 is supported. Valid values range from 20 to 2048.
        """
        if category is not None:
            pulumi.set(__self__, "category", category)
        if size is not None:
...
class DbInstanceEndpointNodeItem(dict):
    ...
    def __init__(__self__, *,
                 ...
                 weight: builtins.int):
        """
        :param builtins.str node_id: The ID of the node.
        :param builtins.int weight: The weight of the node. Read requests are distributed based on the weight.Valid values: 0 to 100.
        """
...
class DdrInstancePgHbaConf(dict):
    ...
    def __init__(__self__, *,
                 ...
                 method: builtins.str,
                 priority_id: builtins.int,
                 type: builtins.str,
                 user: builtins.str,
                 mask: Optional[builtins.str] = None,
                 option: Optional[builtins.str] = None):
        """
        :param builtins.str address: The IP addresses from which the specified users can access the specified databases. If you set this parameter to 0.0.0.0/0, the specified users are allowed to access the specified databases from all IP addresses.
        :param builtins.str database: The name of the database that the specified users are allowed to access. If you set this parameter to all, the specified users are allowed to access all databases in the instance. If you specify multiple databases, separate the database names with commas (,).
        :param builtins.str method: The authentication method of Lightweight Directory Access Protocol (LDAP). Valid values: `trust`, `reject`, `scram-sha-256`, `md5`, `password`, `gss`, `sspi`, `ldap`, `radius`, `cert`, `pam`.
        :param builtins.int priority_id: The priority of an AD domain. If you set this parameter to 0, the AD domain has the highest priority. Valid values: 0 to 10000. This parameter is used to identify each AD domain. When you add an AD domain, the value of the PriorityId parameter of the new AD domain cannot be the same as the value of the PriorityId parameter for any existing AD domain. When you modify or delete an AD domain, you must also modify or delete the value of the PriorityId parameter for this AD domain.
        :param builtins.str type: The type of connection to the instance. Valid values:
        ...
        :param builtins.str user: The user that is allowed to access the instance. If you specify multiple users, separate the usernames with commas (,).
        :param builtins.str mask: The mask of the instance. If the value of the `Address` parameter is an IP address, you can use this parameter to specify the mask of the IP address.
        :param builtins.str option: Optional. The value of this parameter is based on the value of the HbaItem.N.Method parameter. In this topic, LDAP is used as an example. You must configure this parameter. For more information, see [Authentication Methods](https://www.postgresql.org/docs/11/auth-methods.html).
        """
    ...
    def priority_id(self) -> builtins.int:
        """
...
class InstanceBabelfishConfig(dict):
    ...
    def __init__(__self__, *,
                 babelfish_enabled: builtins.str,
                 master_user_password: builtins.str,
                 master_username: builtins.str,
                 migration_mode: builtins.str):
        """
        :param builtins.str babelfish_enabled: specifies whether to enable the Babelfish for the instance. If you set this parameter to **true**, you enable Babelfish for the instance. If you leave this parameter empty, you disable Babelfish for the instance.
        :param builtins.str master_user_password: The password of the administrator account. The password must contain at least three of the following character types: uppercase letters, lowercase letters, digits, and special characters. It must be 8 to 32 characters in length. The password can contain any of the following characters:! @ # $ % ^ & * () _ + - =
        :param builtins.str master_username: The name of the administrator account. The name can contain lowercase letters, digits, and underscores (_). It must start with a letter and end with a letter or digit. It can be up to 63 characters in length and cannot start with pg.
        :param builtins.str migration_mode: The migration mode of the instance. Valid values: **single-db** and **multi-db**.
        """
    ...
    def babelfish_enabled(self) -> builtins.str:
        """
    ...
    def migration_mode(self) -> builtins.str:
        """
...
class InstanceServerlessConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch_force: Optional[builtins.bool] = None):
        """
        :param builtins.float max_capacity: The maximum number of RDS Capacity Units (RCUs). The value of this parameter must be greater than or equal to `min_capacity` and only supports passing integers. Valid values:
               - MySQL: 1~8
               - SQLServer: 2~8
               - PostgreSQL: 1~12
        :param builtins.float min_capacity: The minimum number of RCUs. The value of this parameter must be less than or equal to `max_capacity`. Valid values:
               - MySQL: 0.5~8
               - SQLServer: 2~8 \\(Supports integers only\\).
               - PostgreSQL: 0.5~12
        :param builtins.bool switch_force: Specifies whether to enable the forced scaling feature for the serverless instance. Valid values:
    ...
    def switch_force(self) -> Optional[builtins.bool]:
        """
...
class RdsCloneDbInstanceParameter(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The parameters name.
        :param builtins.str value: The parameters value.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class RdsCloneDbInstanceServerlessConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.float min_capacity: The minimum number of RCUs. The value of this parameter must be less than or equal to `max_capacity`. Valid values:
               ...
               - SQLServer: 2~8 \\(Supports integers only\\).
               - PostgreSQL: 0.5~12
        :param builtins.bool auto_pause: Specifies whether to enable the smart startup and stop feature for the serverless instance. Valid values:
               - true: enables the feature.
               - false: disables the feature. This is the default value.
...
class RdsDbProxyReadOnlyInstanceWeight(dict):
    ...
    def __init__(__self__, *,
                 ...
                 weight: builtins.str):
        """
        :param builtins.str instance_id: The Id of the instance and its read-only instances that can run database.
        :param builtins.str weight: Weight of instances that can run the database and their read-only instances. Read weights increase in increments of 100, and the maximum read weight is 10000.
        """
...
class RdsParameterGroupParamDetail(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str param_name: The name of a parameter.
        :param builtins.str param_value: The value of a parameter.
        """
...
class GetAccountsAccountResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 priv_exceeded: builtins.str,
                 status: builtins.str):
        """
        :param builtins.str account_description: Database description.
        :param builtins.str account_name: Name of database account.
        ...
        :param builtins.str priv_exceeded: Whether the maximum number of databases managed by the account is exceeded.
    ...
    def priv_exceeded(self) -> builtins.str:
        """
...
class GetAccountsAccountDatabasePrivilegeResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str account_privilege: The type of permission for the account.
        :param builtins.str account_privilege_detail: The specific permissions corresponding to the type of account permissions.
...
class GetCrossRegionBackupsBackupResult(dict):
    def __init__(__self__, *,
                 ...
                 backup_set_scale: builtins.str,
                 backup_set_status: builtins.int,
                 backup_start_time: builtins.str,
                 backup_type: builtins.str,
                 category: builtins.str,
                 consistent_time: builtins.str,
                 cross_backup_download_link: builtins.str,
                 cross_backup_id: builtins.str,
                 cross_backup_region: builtins.str,
                 cross_backup_set_file: builtins.str,
                 cross_backup_set_location: builtins.str,
                 cross_backup_set_size: builtins.int,
                 db_instance_storage_type: builtins.str,
                 engine: builtins.str,
                 engine_version: builtins.str,
                 id: builtins.str,
                 instance_id: builtins.int,
                 recovery_begin_time: builtins.str,
                 recovery_end_time: builtins.str,
                 restore_regions: Sequence[builtins.str]):
        """
        :param builtins.str backup_end_time: The time when the cross-region data backup file was generated.
        :param builtins.str backup_method: The method that is used to generate the cross-region data backup file. Valid values:
               `L` - logical backup.
               `P` - physical backup.
        :param builtins.str backup_set_scale: The level at which the cross-region data backup file is generated.
               `0` - instance-level backup.
               `1` - database-level backup.
        :param builtins.int backup_set_status: TThe status of the cross-region data backup. Valid values:
               `0` - The cross-region data backup is successful.
               `1` - The cross-region data backup failed.
        :param builtins.str backup_start_time: The time when the cross-region data backup started.
        :param builtins.str backup_type: The type of the cross-region data backup. Valid values:F: full data backup
               `F` - full data backup.
               `I` - incremental data backup.
        :param builtins.str category: The RDS edition of the instance. Valid values:
               `Basic` - Basic Edition.
               `HighAvailability` - High-availability Edition.
               `Finance` - Enterprise Edition. This edition is supported only by the China site (aliyun.com).
        :param builtins.str consistent_time: The point in time that is indicated by the data in the cross-region data backup file.
        :param builtins.str cross_backup_download_link: The external URL from which you can download the cross-region data backup file.
        :param builtins.str cross_backup_id: The ID of the cross-region data backup file.
        :param builtins.str cross_backup_region: The ID of the destination region where the cross-region data backup file of the instance is stored.
        :param builtins.str cross_backup_set_file: The name of the compressed package that contains the cross-region data backup file.
        :param builtins.str cross_backup_set_location: The location where the cross-region data backup file is stored.
        :param builtins.int cross_backup_set_size: The size of the cross-region data backup file. Unit: bytes.
        :param builtins.str db_instance_storage_type: The storage type.
        :param builtins.str engine: The engine of the database.
        :param builtins.str engine_version: The version of the database engine.
        :param builtins.str id: The ID of the cross-region data backup file.
        :param builtins.int instance_id: The ID of the instance. This parameter is used to determine whether the instance that generates the cross-region data backup file is a primary or secondary instance.
        :param builtins.str recovery_begin_time: The start time to which data can be restored. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        :param builtins.str recovery_end_time: The end time to which data can be restored. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        :param Sequence[builtins.str] restore_regions: An array that consists of the regions to which the cross-region data backup file can be restored.
        """
    ...
    def backup_set_scale(self) -> builtins.str:
        """
    ...
    def backup_set_status(self) -> builtins.int:
        """
    ...
    def cross_backup_download_link(self) -> builtins.str:
        """
    ...
    def cross_backup_id(self) -> builtins.str:
        """
    ...
    def cross_backup_set_file(self) -> builtins.str:
        """
    ...
    def cross_backup_set_location(self) -> builtins.str:
        """
    ...
    def cross_backup_set_size(self) -> builtins.int:
        """
    ...
    def db_instance_storage_type(self) -> builtins.str:
        """
        The storage type.
        """
    ...
    def recovery_begin_time(self) -> builtins.str:
        """
    ...
    def recovery_end_time(self) -> builtins.str:
        """
    ...
    def restore_regions(self) -> Sequence[builtins.str]:
        """
...
class GetInstanceClassesInstanceClassResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str instance_class: DB Instance available class.
...
class GetInstanceClassesInstanceClassStorageRangeResult(dict):
    def __init__(__self__, *,
                 ...
                 step: builtins.str):
        """
        :param builtins.str max: DB Instance available storage max value.
        :param builtins.str min: DB Instance available storage min value.
        :param builtins.str step: DB Instance available storage increase step.
        """
...
class GetInstanceClassesInstanceClassZoneIdResult(dict):
    def __init__(__self__, *,
                 id: builtins.str,
                 sub_zone_ids: Sequence[builtins.str]):
        """
        :param builtins.str id: The Zone to launch the DB instance
        :param Sequence[builtins.str] sub_zone_ids: A list of sub zone ids which in the id - e.g If `id` is `cn-beijing-MAZ5(a,b)`, `sub_zone_ids` will be `["cn-beijing-a", "cn-beijing-b"]`.
        """
        pulumi.set(__self__, "id", id)
    ...
    def sub_zone_ids(self) -> Sequence[builtins.str]:
        """
...
class GetInstancesInstanceResult(dict):
    def __init__(__self__, *,
                 ...
                 ca_type: builtins.str,
                 charge_type: builtins.str,
                 client_ca_cert: builtins.str,
                 client_ca_cert_expire_time: builtins.str,
                 client_cert_revocation_list: builtins.str,
                 ...
                 encryption_key_status: builtins.str,
                 engine: builtins.str,
                 engine_version: builtins.str,
                 expire_time: builtins.str,
                 guard_instance_id: builtins.str,
                 ha_mode: builtins.str,
                 host_instance_infos: Sequence['outputs.GetInstancesInstanceHostInstanceInfoResult'],
                 id: builtins.str,
                 instance_storage: builtins.int,
                 instance_type: builtins.str,
                 key_usage: builtins.str,
                 last_modify_status: builtins.str,
                 master_instance_id: builtins.str,
                 master_zone: builtins.str,
                 material_expire_time: builtins.str,
                 modify_status_reason: builtins.str,
                 name: builtins.str,
                 net_type: builtins.str,
                 origin: builtins.str,
                 parameters: Sequence['outputs.GetInstancesInstanceParameterResult'],
                 port: builtins.str,
                 readonly_instance_ids: Sequence[builtins.str],
                 region_id: builtins.str,
                 replication_acl: builtins.str,
                 require_update: builtins.str,
                 require_update_item: builtins.str,
                 require_update_reason: builtins.str,
                 server_ca_url: builtins.str,
                 server_cert: builtins.str,
                 server_key: builtins.str,
                 ssl_create_time: builtins.str,
                 ssl_enabled: builtins.str,
                 ssl_expire_time: builtins.str,
                 status: builtins.str,
                 sync_mode: builtins.str,
                 temp_instance_id: builtins.str,
                 vpc_id: builtins.str,
                 vswitch_id: builtins.str,
                 zone_id_slave_a: builtins.str,
                 zone_id_slave_b: builtins.str):
        """
        :param builtins.str acl: (Available in 1.124.1+) The method that is used to verify the identities of clients. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. Valid values:
               - cert
               - perfer
               - verify-ca
               - verify-full (supported only when the instance runs PostgreSQL 12 or later)
        :param builtins.str availability_zone: Availability zone.
        :param builtins.str ca_type: (Available in 1.124.1+) The type of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. Valid values:
        ...
        :param builtins.str client_ca_cert: (Available in 1.124.1+) The public key of the CA that issues client certificates. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs.
        :param builtins.str client_ca_cert_expire_time: (Available in 1.124.1+) The content of the server certificate. This parameter is supported only when the instance runs PostgreSQL with cloud disks. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC. This parameter is not supported now.
        :param builtins.str client_cert_revocation_list: (Available in 1.124.1+) The certificate revocation list (CRL) that contains revoked client certificates. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs.
        :param builtins.str connection_mode: `Standard` for standard access mode and `Safe` for high security access mode.
        :param builtins.str connection_string: (Available in 1.70.3+) RDS database connection string.
        :param builtins.str create_time: Creation time of the instance.
        :param builtins.str creator: (Available in 1.124.3+) The creator of the encryption key.
        :param builtins.str db_instance_storage_type: (Available in 1.70.3+) The storage type of the instance.
        :param builtins.str db_instance_type: (Available in 1.197.0+) The type of instance.
        :param builtins.str db_type: `Primary` for primary instance, `Readonly` for read-only instance, `Guard` for disaster recovery instance, and `Temp` for temporary instance.
        :param builtins.str delete_date: (Available in 1.124.3+) The estimated time when the encryption key will be deleted. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        :param builtins.bool deletion_protection: (Available in 1.167.0+) Indicates whether the release protection feature is enabled for the instance. Valid values:
               * **true**: The release protection feature is enabled.
               * **false**: The release protection feature is disabled.
        :param builtins.str description: (Available in 1.124.3+) The description of the encryption key.
        :param builtins.str encryption_key: (Available in 1.124.3+) The ID of the encryption key.
        :param builtins.str encryption_key_status: (Available in 1.124.3+) The status of the encryption key. Valid values:
               - Enabled
               - Disabled
        :param builtins.str engine: Database type. Options are `MySQL`, `SQLServer`, `PostgreSQL`, `MariaDB`. If no value is specified, all types are returned.
        :param builtins.str engine_version: Database version.
        :param builtins.str expire_time: Expiration time. Pay-As-You-Go instances never expire.
        :param builtins.str guard_instance_id: If a disaster recovery instance is attached to the current instance, the ID of the disaster recovery instance applies.
        :param builtins.str ha_mode: (Available since v1.209.1) The high availability mode of the instance.
        ...
        :param builtins.str id: The ID of the RDS instance.
        :param builtins.int instance_storage: (Available in 1.70.3+) User-defined DB instance storage space.
        :param builtins.str instance_type: Sizing of the RDS instance.
        :param builtins.str key_usage: (Available in 1.124.3+) The purpose of the encryption key.
        :param builtins.str last_modify_status: (Available in 1.124.1+) The status of the SSL link. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. Valid values:
               - success
               - setting
               - failed
        :param builtins.str master_instance_id: ID of the primary instance. If this parameter is not returned, the current instance is a primary instance.
        :param builtins.str master_zone: (Available in 1.101.0+) The master zone of the instance.
        :param builtins.str material_expire_time: (Available in 1.124.3+) The time when the encryption key expires. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        :param builtins.str modify_status_reason: (Available in 1.124.1+) The reason why the SSL link stays in the current state. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs.
        :param builtins.str name: The name of the RDS instance.
        :param builtins.str net_type: `Internet` for public network or `Intranet` for private network.
        :param builtins.str origin: (Available in 1.124.3+) The source of the encryption key.
        :param Sequence['GetInstancesInstanceParameterArgs'] parameters: (Available in 1.135.0+) Parameter list.
        :param builtins.str port: (Available in 1.70.3+) RDS database connection port.
        :param Sequence[builtins.str] readonly_instance_ids: A list of IDs of read-only instances attached to the primary instance.
        :param builtins.str region_id: The region ID of the instance.
        :param builtins.str replication_acl: (Available in 1.124.1+) The method that is used to verify the replication permission. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. Valid values:
               - cert
               - perfer
               - verify-ca
               - verify-full (supported only when the instance runs PostgreSQL 12 or later)
        :param builtins.str require_update: (Available in 1.124.1+) Indicates whether the server certificate needs to be updated.
               ...
               - 0: no
               - 1: yes
        :param builtins.str require_update_item: (Available in 1.124.1+) The server certificate that needs to be updated. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs.
        :param builtins.str require_update_reason: (Available in 1.124.1+) The reason why the server certificate needs to be updated. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs.
        :param builtins.str server_ca_url: (Available in 1.124.1+) The URL of the CA that issues the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs.
        :param builtins.str server_cert: (Available in 1.124.1+) The content of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs.
        :param builtins.str server_key: (Available in 1.124.1+) The private key of the server certificate. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs.
        :param builtins.str ssl_create_time: (Available in 1.124.1+) The time when the server certificate was created. This parameter is supported only when the instance runs PostgreSQL with standard or enhanced SSDs. In addition, this parameter is valid only when the CAType parameter is set to aliyun.
        :param builtins.str ssl_enabled: (Available in 1.124.1+) Indicates whether SSL encryption is enabled. Valid values:
               - on: enabled
               - off: disabled
        :param builtins.str ssl_expire_time: (Available in 1.124.1+) The time when the server certificate expires. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        :param builtins.str status: Status of the instance.
        :param builtins.str sync_mode: (Available since v1.209.1) The data replication mode of the instance.
        :param builtins.str temp_instance_id: If a temporary instance is attached to the current instance, the ID of the temporary instance applies.
        ...
        :param builtins.str zone_id_slave_a: (Available in 1.101.0+) The region ID of the secondary instance if you create a secondary instance. If you set this parameter to the same value as the ZoneId parameter, the instance is deployed in a single zone. Otherwise, the instance is deployed in multiple zones.
        :param builtins.str zone_id_slave_b: (Available in 1.101.0+) The region ID of the log instance if you create a log instance. If you set this parameter to the same value as the ZoneId parameter, the instance is deployed in a single zone. Otherwise, the instance is deployed in multiple zones.
        """
    ...
    def client_ca_cert(self) -> builtins.str:
        """
    ...
    def client_ca_cert_expire_time(self) -> builtins.str:
        """
    ...
    def client_cert_revocation_list(self) -> builtins.str:
        """
    ...
    def encryption_key_status(self) -> builtins.str:
        """
    ...
    def guard_instance_id(self) -> builtins.str:
        """
    ...
    def instance_storage(self) -> builtins.int:
        """
    ...
    def last_modify_status(self) -> builtins.str:
        """
    ...
    def master_zone(self) -> builtins.str:
        """
    ...
    def modify_status_reason(self) -> builtins.str:
        """
    ...
    def readonly_instance_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def replication_acl(self) -> builtins.str:
        """
    ...
    def require_update(self) -> builtins.str:
        """
    ...
    def require_update_item(self) -> builtins.str:
        """
    ...
    def require_update_reason(self) -> builtins.str:
        """
    ...
    def server_ca_url(self) -> builtins.str:
        """
    ...
    def server_cert(self) -> builtins.str:
        """
    ...
    def server_key(self) -> builtins.str:
        """
    ...
    def ssl_create_time(self) -> builtins.str:
        """
    ...
    def ssl_enabled(self) -> builtins.str:
        """
    ...
    def temp_instance_id(self) -> builtins.str:
        """
    ...
    def zone_id_slave_a(self) -> builtins.str:
        """
    ...
    def zone_id_slave_b(self) -> builtins.str:
        """
...
class GetInstancesInstanceHostInstanceInfoResult(dict):
    def __init__(__self__, *,
                 data_sync_time: builtins.str,
                 log_sync_time: builtins.str,
                 node_id: builtins.str,
                 node_type: builtins.str,
                 region_id: builtins.str,
                 sync_status: builtins.str,
                 zone_id: builtins.str):
        """
        :param builtins.str data_sync_time: The time when the secondary instance completed the synchronization of data from the primary instance. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        :param builtins.str log_sync_time: The time when the secondary instance received logs from the primary instance. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        :param builtins.str node_id: The ID of the instance.
        :param builtins.str node_type: The type of the node.
        :param builtins.str region_id: The region ID of the instance.
        :param builtins.str sync_status: The synchronization status.
    ...
    def data_sync_time(self) -> builtins.str:
        """
    ...
    def log_sync_time(self) -> builtins.str:
        """
...
class GetInstancesInstanceParameterResult(dict):
    def __init__(__self__, *,
                 ...
                 force_modify: builtins.str,
                 force_restart: builtins.str,
                 parameter_description: builtins.str,
                 parameter_name: builtins.str,
                 parameter_value: builtins.str):
        """
        :param builtins.str checking_code: The value range of the parameter.
        :param builtins.str force_modify: Indicates whether the parameter can be modified. Valid values: true | false
        :param builtins.str force_restart: Indicates whether the modified parameter takes effect only after a database restart. Valid values: true | false
        :param builtins.str parameter_description: The description of the parameter.
        :param builtins.str parameter_name: The name of the parameter.
        :param builtins.str parameter_value: The default value of the parameter.
        """
    ...
    def force_modify(self) -> builtins.str:
        """
    ...
    def force_restart(self) -> builtins.str:
        """
...
class GetModifyParameterLogsLogResult(dict):
    def __init__(__self__, *,
                 ...
                 new_parameter_value: builtins.str,
                 old_parameter_value: builtins.str,
                 parameter_name: builtins.str,
                 status: builtins.str):
        """
        :param builtins.str modify_time: The time when the parameter was reconfigured. This value is a UNIX timestamp. Unit: milliseconds.
        :param builtins.str new_parameter_value: The new value of the parameter.
        :param builtins.str old_parameter_value: The original value of the parameter.
        :param builtins.str parameter_name: The name of the parameter.
        :param builtins.str status: The status of the new value specified for the parameter. Valid values:
    ...
    def new_parameter_value(self) -> builtins.str:
        """
    ...
    def old_parameter_value(self) -> builtins.str:
        """
...
class GetRdsBackupsBackupResult(dict):
    def __init__(__self__, *,
                 ...
                 backup_initiator: builtins.str,
                 backup_intranet_download_url: builtins.str,
                 backup_method: builtins.str,
                 backup_mode: builtins.str,
                 backup_size: builtins.str,
                 backup_start_time: builtins.str,
                 backup_status: builtins.str,
                 backup_type: builtins.str,
                 consistent_time: builtins.str,
                 copy_only_backup: builtins.str,
                 db_instance_id: builtins.str,
                 encryption: builtins.str,
                 host_instance_id: builtins.str,
                 id: builtins.str,
                 is_avail: builtins.int,
                 meta_status: builtins.str,
                 storage_class: builtins.str,
                 store_status: builtins.str):
        """
        :param builtins.str backup_download_url: The backup download url.
        :param builtins.str backup_end_time: BackupEndTime.
        :param builtins.str backup_id: BackupId.
        :param builtins.str backup_initiator: The initiator of the backup task. Value:
               * **System**: automatically initiated by the System
               * **User**: manually initiated by the User.
        :param builtins.str backup_intranet_download_url: The backup intranet download url.
        :param builtins.str backup_method: BackupMethod.
        :param builtins.str backup_mode: BackupMode.
        :param builtins.str backup_size: BackupSize.
        :param builtins.str backup_start_time: BackupStartTime.
        :param builtins.str backup_status: Backup task status. **NOTE:** This parameter will only be returned when a task is executed. Value:
               * **NoStart**: Not started
        ...
        :param builtins.str backup_type: BackupType.
        :param builtins.str consistent_time: The consistency point of the backup set. The return value is a timestamp. **NOTE:** only MySQL 5.6 returns this parameter, and other versions return 0.
        :param builtins.str copy_only_backup: The backup mode is divided into the normal backup mode (full and incremental recovery is supported) and the replication-only mode (full recovery is supported only). **NOTE:** Only SQL Server returns this parameter. Valid values:
               * **0**: General Backup Mode
               * **1**: Copy only mode
        :param builtins.str db_instance_id: The db instance id.
        :param builtins.str encryption: The encrypted information of the backup set.
        :param builtins.str host_instance_id: HostInstanceID.
        :param builtins.str id: The ID of the Backup.
        :param builtins.int is_avail: Whether the backup set is available, the value is:
               * **0**: Not available
               * **1**: Available.
        :param builtins.str meta_status: The backup set status of the database table. **NOTE:** an empty string indicates that the backup set for database table recovery is not enabled. Valid values:
               * **OK**: normal.
        ...
        :param builtins.str storage_class: The storage medium for the backup set. Valid values:
               * **0**: Regular storage
               * **1**: Archive storage.
        :param builtins.str store_status: StoreStatus.
        """
    ...
    def backup_download_url(self) -> builtins.str:
        """
    ...
    def backup_initiator(self) -> builtins.str:
        """
    ...
    def backup_intranet_download_url(self) -> builtins.str:
        """
    ...
    def backup_size(self) -> builtins.str:
        """
        BackupSize.
        """
    ...
    def copy_only_backup(self) -> builtins.str:
        """
    ...
    def host_instance_id(self) -> builtins.str:
        """
        HostInstanceID.
        """
    ...
    def is_avail(self) -> builtins.int:
        """
    ...
    def meta_status(self) -> builtins.str:
        """
    ...
    def store_status(self) -> builtins.str:
        """
        StoreStatus.
        """
...
class GetRdsParameterGroupsGroupResult(dict):
    ...
    @property
    @pulumi.getter(name="forceRestart")
    def force_restart(self) -> builtins.int:
        return pulumi.get(self, "force_restart")
    ...
    def param_counts(self) -> builtins.int:
    ...
    def parameter_group_desc(self) -> builtins.str:
    ...
    def parameter_group_type(self) -> builtins.int:
...
class GetSlotsSlotResult(dict):
    def __init__(__self__, *,
                 ...
                 temporary: builtins.str,
                 wal_delay: builtins.str):
        """
        :param builtins.str database: The name of the database where Replication Slot is located.
        :param builtins.str plugin: The plugin used by Replication Slot.
        :param builtins.str slot_name: The Replication Slot name.
        :param builtins.str slot_status: The Replication Slot status.
        :param builtins.str slot_type: The Replication Slot type.
        :param builtins.str temporary: Is the Replication Slot temporary.
        :param builtins.str wal_delay: The amount of logs accumulated by Replication Slot.
        """
        pulumi.set(__self__, "database", database)
    ...
    @property
    @pulumi.getter
    def temporary(self) -> builtins.str:
        """
    ...
    def wal_delay(self) -> builtins.str:
        """
