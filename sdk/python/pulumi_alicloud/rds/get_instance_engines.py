...
def get_instance_engines(category: Optional[builtins.str] = None,
    ...
    :param builtins.str category: DB Instance category. the value like [`Basic`, `HighAvailability`, `Finance`, `AlwaysOn`], [detail info](https://www.alibabacloud.com/help/doc-detail/69795.htm).
...
def get_instance_engines_output(category: Optional[pulumi.Input[Optional[builtins.str]]] = None,
