...
def get_instance_engines(category: Optional[_builtins.str] = None,
...
def get_instance_engines_output(category: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
