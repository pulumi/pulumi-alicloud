...
def get_accounts(db_instance_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str status: The status of the resource. Valid values: `Available`, `Unavailable`.
    """
    __args__ = dict()
...
def get_accounts_output(db_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:rds/getAccounts:getAccounts', __args__, opts=opts, typ=GetAccountsResult)
