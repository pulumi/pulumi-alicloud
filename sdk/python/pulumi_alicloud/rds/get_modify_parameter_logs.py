...
def get_modify_parameter_logs(db_instance_id: Optional[builtins.str] = None,
...
def get_modify_parameter_logs_output(db_instance_id: Optional[pulumi.Input[builtins.str]] = None,
