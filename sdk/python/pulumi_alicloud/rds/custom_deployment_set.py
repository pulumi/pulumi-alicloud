...
class CustomDeploymentSetArgs:
    def __init__(__self__, *,
                 custom_deployment_set_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] custom_deployment_set_name: The name of the resource
        :param pulumi.Input[builtins.str] description: Deployment set description information. It must be 2 to 256 characters in length and cannot start with http:// or https.
        :param pulumi.Input[builtins.int] group_count: Set the number of groups for the deployment set group high availability policy. Value range: 1~7.
               
               Default value: 3
               
               > **NOTE:**  This parameter takes effect only when 'Strategy = AvailabilityGroup.
        :param pulumi.Input[builtins.str] on_unable_to_redeploy_failed_instance: After the instance in the deployment set is down and migrated, there is no emergency solution for the scattered instance inventory. Value range:
        ...
        :param pulumi.Input[builtins.str] strategy: Deployment strategy. Value range:
    ...
    def custom_deployment_set_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_deployment_set_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CustomDeploymentSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            on_unable_to_redeploy_failed_instance: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            strategy: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomDeploymentSet':
        """
    ...
    @property
    @pulumi.getter(name="customDeploymentSetName")
    def custom_deployment_set_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the resource
        """
        return pulumi.get(self, "custom_deployment_set_name")
    ...
    @property
    @pulumi.getter(name="groupCount")
    def group_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Set the number of groups for the deployment set group high availability policy. Value range: 1~7.
