...
class ConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] connection_prefix: Prefix of an Internet connection string. It must be checked for uniqueness. It may consist of lowercase letters, numbers, and underlines, and must start with a letter and have no more than 40 characters. Default to <instance_id> + 'tf'.
        :param pulumi.Input[_builtins.str] port: Internet connection port. Valid value: [1000-5999]. Default to 3306.
        """
