...
class GetClassDetailsResult:
    ...
    def class_code(self) -> builtins.str:
        return pulumi.get(self, "class_code")

    @property
    @pulumi.getter(name="classGroup")
    def class_group(self) -> builtins.str:
        """
    ...
    def instruction_set_arch(self) -> builtins.str:
        """
    ...
    def max_iombps(self) -> builtins.str:
        """
    ...
    def max_iops(self) -> builtins.str:
        """
    ...
    def memory_class(self) -> builtins.str:
        """
    ...
    def reference_price(self) -> builtins.str:
        """
...
def get_class_details(class_code: Optional[builtins.str] = None,
    ...
    :param builtins.str engine: Database type. Value options: MySQL, SQLServer, PostgreSQL, MariaDB.
    :param builtins.str engine_version: Database version. Value options:
...
def get_class_details_output(class_code: Optional[pulumi.Input[builtins.str]] = None,
