...
class RdsDbProxyArgs:
    def __init__(__self__, *,
                 db_proxy_instance_num: pulumi.Input[builtins.int],
                 ...
                 db_proxy_connect_string_port: Optional[pulumi.Input[builtins.int]] = None,
                 db_proxy_connection_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 db_proxy_endpoint_read_write_mode: Optional[pulumi.Input[builtins.str]] = None,
                 db_proxy_features: Optional[pulumi.Input[builtins.str]] = None,
                 db_proxy_instance_type: Optional[pulumi.Input[builtins.str]] = None,
                 db_proxy_ssl_enabled: Optional[pulumi.Input[builtins.str]] = None,
                 effective_specific_time: Optional[pulumi.Input[builtins.str]] = None,
                 effective_time: Optional[pulumi.Input[builtins.str]] = None,
                 read_only_instance_distribution_type: Optional[pulumi.Input[builtins.str]] = None,
                 read_only_instance_max_delay_time: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] db_proxy_instance_num: The number of proxy instances that are enabled. Valid values: 1 to 60.
        :param pulumi.Input[builtins.str] instance_id: The Id of instance that can run database.
        :param pulumi.Input[builtins.str] instance_network_type: The network type of the instance. Set the value to VPC.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the virtual private cloud (VPC) to which the instance belongs.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the vSwitch that is associated with the specified VPC.
        :param pulumi.Input[builtins.int] db_proxy_connect_string_port: The port number that is associated with the proxy endpoint.
        :param pulumi.Input[builtins.str] db_proxy_connection_prefix: The new prefix of the proxy endpoint. Enter a prefix.
        :param pulumi.Input[builtins.str] db_proxy_endpoint_read_write_mode: The read and write attributes of the proxy terminal. Valid values:
        ...
        :param pulumi.Input[builtins.str] db_proxy_features: The features that you want to enable for the proxy endpoint. If you specify more than one feature, separate the features with semicolons (;). Format: Feature 1:Status;Feature 2:Status;.... Do not add a semicolon (;) at the end of the last value. Valid feature values:
        ...
        :param pulumi.Input[builtins.str] db_proxy_instance_type: The database proxy type. Valid values:
               - common: universal proxy.
               - exclusive: Exclusive proxy (default).
        :param pulumi.Input[builtins.str] db_proxy_ssl_enabled: The SSL configuration setting that you want to apply on the instance. Valid values:
        ...
        :param pulumi.Input[builtins.str] effective_specific_time: The point in time at which you want to apply the new database proxy settings. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.
        :param pulumi.Input[builtins.str] effective_time: When modifying the number of proxy instances,The time when you want to apply the new database proxy settings.Valid values:
        ...
        :param pulumi.Input[builtins.str] read_only_instance_distribution_type: The policy that is used to allocate read weights. Valid values:
        ...
        :param pulumi.Input[builtins.str] switch_time: The point in time at which you want to upgrade the database proxy version of the instance. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.
        :param pulumi.Input[builtins.str] upgrade_time: The time when you want to upgrade the database proxy version of the instance. Valid values:
    ...
    def db_proxy_instance_num(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def db_proxy_instance_num(self, value: pulumi.Input[builtins.int]):
    ...
    def db_proxy_connect_string_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def db_proxy_connect_string_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "db_proxy_connect_string_port", value)

    @property
    @pulumi.getter(name="dbProxyConnectionPrefix")
    def db_proxy_connection_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_proxy_connection_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_proxy_connection_prefix", value)

    @property
    @pulumi.getter(name="dbProxyEndpointReadWriteMode")
    def db_proxy_endpoint_read_write_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_proxy_endpoint_read_write_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_proxy_endpoint_read_write_mode", value)

    @property
    @pulumi.getter(name="dbProxyFeatures")
    def db_proxy_features(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_proxy_features(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_proxy_features", value)

    @property
    @pulumi.getter(name="dbProxyInstanceType")
    def db_proxy_instance_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_proxy_instance_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_proxy_instance_type", value)

    @property
    @pulumi.getter(name="dbProxySslEnabled")
    def db_proxy_ssl_enabled(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_proxy_ssl_enabled(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_proxy_ssl_enabled", value)

    @property
    @pulumi.getter(name="effectiveSpecificTime")
    def effective_specific_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def effective_specific_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def read_only_instance_distribution_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def read_only_instance_distribution_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "read_only_instance_distribution_type", value)

    @property
    @pulumi.getter(name="readOnlyInstanceMaxDelayTime")
    def read_only_instance_max_delay_time(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum latency threshold that is allowed for read/write splitting. If the latency on a read-only instance exceeds the threshold that you specified, ApsaraDB RDS no longer forwards read requests to the read-only instance. If you do not specify this parameter, the default value of this parameter is retained. Unit: seconds. Valid values: 0 to 3600.
    ...
    def read_only_instance_max_delay_time(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _RdsDbProxyState:
    def __init__(__self__, *,
                 db_proxy_connect_string_port: Optional[pulumi.Input[builtins.int]] = None,
                 db_proxy_connection_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 db_proxy_connection_string: Optional[pulumi.Input[builtins.str]] = None,
                 db_proxy_endpoint_aliases: Optional[pulumi.Input[builtins.str]] = None,
                 db_proxy_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
                 db_proxy_endpoint_read_write_mode: Optional[pulumi.Input[builtins.str]] = None,
                 db_proxy_features: Optional[pulumi.Input[builtins.str]] = None,
                 db_proxy_instance_num: Optional[pulumi.Input[builtins.int]] = None,
                 db_proxy_instance_type: Optional[pulumi.Input[builtins.str]] = None,
                 db_proxy_ssl_enabled: Optional[pulumi.Input[builtins.str]] = None,
                 effective_specific_time: Optional[pulumi.Input[builtins.str]] = None,
                 effective_time: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] db_proxy_connect_string_port: The port number that is associated with the proxy endpoint.
        :param pulumi.Input[builtins.str] db_proxy_connection_prefix: The new prefix of the proxy endpoint. Enter a prefix.
        :param pulumi.Input[builtins.str] db_proxy_connection_string: Connection instance string.
        :param pulumi.Input[builtins.str] db_proxy_endpoint_aliases: Remarks of agent terminal.
        :param pulumi.Input[builtins.str] db_proxy_endpoint_id: Proxy connection address ID.
        :param pulumi.Input[builtins.str] db_proxy_endpoint_read_write_mode: The read and write attributes of the proxy terminal. Valid values:
               - ReadWrite: The proxy terminal connects to the primary instance and can receive both read and write requests.
               - ReadOnly: The proxy terminal does not connect to the primary instance and can receive only read requests. This is the default value.
        ...
        :param pulumi.Input[builtins.str] instance_id: The Id of instance that can run database.
        :param pulumi.Input[builtins.str] instance_network_type: The network type of the instance. Set the value to VPC.
        :param pulumi.Input[builtins.str] net_type: Network type of proxy connection address.
        :param pulumi.Input[builtins.str] read_only_instance_distribution_type: The policy that is used to allocate read weights. Valid values:
               - Standard: ApsaraDB RDS automatically allocates read weights to the instance and its read-only instances based on the specifications of the instances.
               - Custom: You must manually allocate read weights to the instance and its read-only instances.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RdsDbProxyReadOnlyInstanceWeightArgs']]] read_only_instance_weights: A list of the read weights of the instance and its read-only instances.  It contains two sub-fields(instance_id and weight). Read weights increase in increments of 100, and the maximum read weight is 10000. See `read_only_instance_weight` below.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] ssl_expired_time: The time when the certificate expires.
        :param pulumi.Input[builtins.str] switch_time: The point in time at which you want to upgrade the database proxy version of the instance. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.
        :param pulumi.Input[builtins.str] upgrade_time: The time when you want to upgrade the database proxy version of the instance. Valid values:
               - MaintainTime: ApsaraDB RDS performs the upgrade during the maintenance window that you specified. This is the default value. For more information, see Modify the maintenance window.
               - Immediate: ApsaraDB RDS immediately performs the upgrade.
    ...
    def db_proxy_connection_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_proxy_connection_string(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_proxy_connection_string", value)

    @property
    @pulumi.getter(name="dbProxyEndpointAliases")
    def db_proxy_endpoint_aliases(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_proxy_endpoint_aliases(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="dbProxyInstanceNum")
    def db_proxy_instance_num(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of proxy instances that are enabled. Valid values: 1 to 60.
        """
        return pulumi.get(self, "db_proxy_instance_num")
    ...
    @db_proxy_instance_num.setter
    def db_proxy_instance_num(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "db_proxy_instance_num", value)
...
class RdsDbProxy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            upgrade_time: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RdsDbProxy':
        """
    ...
    @property
    @pulumi.getter(name="dbProxyConnectStringPort")
    def db_proxy_connect_string_port(self) -> pulumi.Output[builtins.int]:
        """
        The port number that is associated with the proxy endpoint.
        """
        return pulumi.get(self, "db_proxy_connect_string_port")
    ...
    @property
    @pulumi.getter(name="dbProxyConnectionPrefix")
    def db_proxy_connection_prefix(self) -> pulumi.Output[builtins.str]:
        """
        The new prefix of the proxy endpoint. Enter a prefix.
        """
        return pulumi.get(self, "db_proxy_connection_prefix")
    ...
    @property
    @pulumi.getter(name="dbProxyConnectionString")
    def db_proxy_connection_string(self) -> pulumi.Output[builtins.str]:
        """
        Connection instance string.
        """
        return pulumi.get(self, "db_proxy_connection_string")
    ...
    @property
    @pulumi.getter(name="dbProxyEndpointAliases")
    def db_proxy_endpoint_aliases(self) -> pulumi.Output[builtins.str]:
        """
        Remarks of agent terminal.
        """
        return pulumi.get(self, "db_proxy_endpoint_aliases")
    ...
    @property
    @pulumi.getter(name="dbProxyEndpointReadWriteMode")
    def db_proxy_endpoint_read_write_mode(self) -> pulumi.Output[builtins.str]:
        """
        The read and write attributes of the proxy terminal. Valid values:
        - ReadWrite: The proxy terminal connects to the primary instance and can receive both read and write requests.
        - ReadOnly: The proxy terminal does not connect to the primary instance and can receive only read requests. This is the default value.
    ...
    @property
    @pulumi.getter(name="dbProxyFeatures")
    def db_proxy_features(self) -> pulumi.Output[builtins.str]:
        """
        The features that you want to enable for the proxy endpoint. If you specify more than one feature, separate the features with semicolons (;). Format: Feature 1:Status;Feature 2:Status;.... Do not add a semicolon (;) at the end of the last value. Valid feature values:
        - ReadWriteSpliting: read/write splitting.
        - ConnectionPersist: connection pooling.
    ...
    @property
    @pulumi.getter(name="dbProxyInstanceNum")
    def db_proxy_instance_num(self) -> pulumi.Output[builtins.int]:
        """
        The number of proxy instances that are enabled. Valid values: 1 to 60.
        """
        return pulumi.get(self, "db_proxy_instance_num")
    ...
    @property
    @pulumi.getter(name="dbProxyInstanceType")
    def db_proxy_instance_type(self) -> pulumi.Output[builtins.str]:
        """
        The database proxy type. Valid values:
        - common: universal proxy.
        - exclusive: Exclusive proxy (default).
    ...
    @property
    @pulumi.getter(name="dbProxySslEnabled")
    def db_proxy_ssl_enabled(self) -> pulumi.Output[builtins.str]:
        """
        The SSL configuration setting that you want to apply on the instance. Valid values:
        - Close: disables SSL encryption.
        - Open: enables SSL encryption or modifies the endpoint that requires SSL encryption.
    ...
    @property
    @pulumi.getter(name="effectiveSpecificTime")
    def effective_specific_time(self) -> pulumi.Output[builtins.str]:
        """
        The point in time at which you want to apply the new database proxy settings. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.
        """
        return pulumi.get(self, "effective_specific_time")
    ...
    @property
    @pulumi.getter(name="effectiveTime")
    def effective_time(self) -> pulumi.Output[builtins.str]:
        """
        When modifying the number of proxy instances,The time when you want to apply the new database proxy settings.Valid values:
        - Immediate: ApsaraDB RDS immediately applies the new settings.
        - MaintainTime: ApsaraDB RDS applies the new settings during the maintenance window that you specified. For more information, see Modify the maintenance window.
    ...
    @property
    @pulumi.getter(name="readOnlyInstanceDistributionType")
    def read_only_instance_distribution_type(self) -> pulumi.Output[builtins.str]:
        """
        The policy that is used to allocate read weights. Valid values:
        - Standard: ApsaraDB RDS automatically allocates read weights to the instance and its read-only instances based on the specifications of the instances.
        - Custom: You must manually allocate read weights to the instance and its read-only instances.
    ...
    @property
    @pulumi.getter(name="readOnlyInstanceMaxDelayTime")
    def read_only_instance_max_delay_time(self) -> pulumi.Output[builtins.int]:
        """
        The maximum latency threshold that is allowed for read/write splitting. If the latency on a read-only instance exceeds the threshold that you specified, ApsaraDB RDS no longer forwards read requests to the read-only instance. If you do not specify this parameter, the default value of this parameter is retained. Unit: seconds. Valid values: 0 to 3600.
