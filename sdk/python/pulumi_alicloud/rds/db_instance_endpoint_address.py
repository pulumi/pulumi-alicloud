...
class DbInstanceEndpointAddressArgs:
    def __init__(__self__, *,
                 ...
                 db_instance_endpoint_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] port: The port number of the public endpoint.
        """
    ...
    def db_instance_endpoint_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def db_instance_endpoint_id(self, value: pulumi.Input[_builtins.str]):
...
class _DbInstanceEndpointAddressState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] db_instance_endpoint_id: The Endpoint ID of the instance.
        :param pulumi.Input[_builtins.str] db_instance_id: The ID of the instance.
        :param pulumi.Input[_builtins.str] ip_address: The IP address of the endpoint.
