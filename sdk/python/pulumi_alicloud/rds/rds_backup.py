...
class RdsBackupArgs:
    def __init__(__self__, *,
                 ...
                 backup_strategy: Optional[pulumi.Input[builtins.str]] = None,
                 backup_type: Optional[pulumi.Input[builtins.str]] = None,
                 db_name: Optional[pulumi.Input[builtins.str]] = None,
                 remove_from_state: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a RdsBackup resource.
        :param pulumi.Input[builtins.str] db_instance_id: The db instance id.
        :param pulumi.Input[builtins.str] backup_method: The type of backup that you want to perform. Default value: `Physical`. Valid values: `Logical`, `Physical` and `Snapshot`.
        :param pulumi.Input[builtins.str] backup_strategy: The policy that you want to use for the backup task. Valid values:
               * **db**: specifies to perform a database-level backup.
               * **instance**: specifies to perform an instance-level backup.
        :param pulumi.Input[builtins.str] backup_type: The method that you want to use for the backup task. Default value: `Auto`. Valid values:
               * **Auto**: specifies to automatically perform a full or incremental backup.
               * **FullBackup**: specifies to perform a full backup.
        :param pulumi.Input[builtins.str] db_name: The names of the databases whose data you want to back up. Separate the names of the databases with commas (,).
        :param pulumi.Input[builtins.bool] remove_from_state: Remove form state when resource cannot be deleted. Valid values: `true` and `false`.
        """
    ...
    def backup_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def backup_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def remove_from_state(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def remove_from_state(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _RdsBackupState:
    def __init__(__self__, *,
                 ...
                 db_name: Optional[pulumi.Input[builtins.str]] = None,
                 remove_from_state: Optional[pulumi.Input[builtins.bool]] = None,
                 store_status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering RdsBackup resources.
        :param pulumi.Input[builtins.str] backup_id: The backup id.
        :param pulumi.Input[builtins.str] backup_method: The type of backup that you want to perform. Default value: `Physical`. Valid values: `Logical`, `Physical` and `Snapshot`.
        :param pulumi.Input[builtins.str] backup_strategy: The policy that you want to use for the backup task. Valid values:
               * **db**: specifies to perform a database-level backup.
               * **instance**: specifies to perform an instance-level backup.
        ...
        :param pulumi.Input[builtins.str] db_name: The names of the databases whose data you want to back up. Separate the names of the databases with commas (,).
        :param pulumi.Input[builtins.bool] remove_from_state: Remove form state when resource cannot be deleted. Valid values: `true` and `false`.
        :param pulumi.Input[builtins.str] store_status: Indicates whether the data backup file can be deleted. Valid values: `Enabled` and `Disabled`.
        """
    ...
    def store_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @store_status.setter
    def store_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RdsBackup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            db_name: Optional[pulumi.Input[builtins.str]] = None,
            remove_from_state: Optional[pulumi.Input[builtins.bool]] = None,
            store_status: Optional[pulumi.Input[builtins.str]] = None) -> 'RdsBackup':
        """
    ...
    @property
    @pulumi.getter(name="backupStrategy")
    def backup_strategy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The policy that you want to use for the backup task. Valid values:
        * **db**: specifies to perform a database-level backup.
        * **instance**: specifies to perform an instance-level backup.
    ...
    @property
    @pulumi.getter(name="removeFromState")
    def remove_from_state(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Remove form state when resource cannot be deleted. Valid values: `true` and `false`.
        """
        return pulumi.get(self, "remove_from_state")
    ...
    @property
    @pulumi.getter(name="storeStatus")
    def store_status(self) -> pulumi.Output[builtins.str]:
        """
        Indicates whether the data backup file can be deleted. Valid values: `Enabled` and `Disabled`.
        """
        return pulumi.get(self, "store_status")
