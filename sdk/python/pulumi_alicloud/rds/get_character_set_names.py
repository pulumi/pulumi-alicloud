...
def get_character_set_names(engine: Optional[builtins.str] = None,
    ...
    :param builtins.str engine: Database type. Options are `MySQL`, `SQLServer`, `PostgreSQL`, `MariaDB`.
    """
    __args__ = dict()
...
def get_character_set_names_output(engine: Optional[pulumi.Input[builtins.str]] = None,
