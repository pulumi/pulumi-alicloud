...
class GetCrossRegionBackupsResult:
    ...
    def cross_backup_id(self) -> Optional[_builtins.str]:
...
def get_cross_region_backups(backup_id: Optional[_builtins.str] = None,
                             cross_backup_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str backup_id: The ID of the cross-region data backup file.
    :param _builtins.str cross_backup_id: The ID of the cross-region data backup file.
    :param _builtins.str cross_backup_region: The ID of the destination region where the cross-region data backup file is stored.
    ...
    :param _builtins.str end_time: The end of the time range to query. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.
    :param Sequence[_builtins.str] ids: A list of Cross Region Backup IDs.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str resource_group_id: The ID of the resource group.
    :param _builtins.str start_time: The beginning of the time range to query. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.
    """
    __args__ = dict()
...
def get_cross_region_backups_output(backup_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                    cross_backup_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                    cross_backup_region: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
