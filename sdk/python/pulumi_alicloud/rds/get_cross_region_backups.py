...
class GetCrossRegionBackupsResult:
    ...
    def cross_backup_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "cross_backup_id")

    @property
    @pulumi.getter(name="crossBackupRegion")
    def cross_backup_region(self) -> Optional[builtins.str]:
...
def get_cross_region_backups(backup_id: Optional[builtins.str] = None,
                             cross_backup_id: Optional[builtins.str] = None,
                             cross_backup_region: Optional[builtins.str] = None,
    ...
    :param builtins.str backup_id: The ID of the cross-region data backup file.
    :param builtins.str cross_backup_id: The ID of the cross-region data backup file.
    :param builtins.str cross_backup_region: The ID of the destination region where the cross-region data backup file is stored.
    ...
    :param builtins.str end_time: The end of the time range to query. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.
    :param Sequence[builtins.str] ids: A list of Cross Region Backup IDs.
    ...
    :param builtins.str start_time: The beginning of the time range to query. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.
    """
    __args__ = dict()
...
def get_cross_region_backups_output(backup_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    cross_backup_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    cross_backup_region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
