...
class RdsParameterGroupArgs:
    def __init__(__self__, *,
                 ...
                 parameter_group_name: pulumi.Input[builtins.str],
                 parameter_group_desc: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RdsParameterGroup resource.
        :param pulumi.Input[builtins.str] engine: The database engine. Valid values: `mysql`, `mariadb`, `PostgreSQL`.
        :param pulumi.Input[builtins.str] engine_version: The version of the database engine. Valid values: mysql: `5.1`, `5.5`, `5.6`, `5.7`, `8.0`; mariadb: `10.3`; PostgreSQL: `10.0`, `11.0`, `12.0`, `13.0`, `14.0`, `15.0`.
        ...
        :param pulumi.Input[builtins.str] parameter_group_name: The name of the parameter template.
        :param pulumi.Input[builtins.str] parameter_group_desc: The description of the parameter template.
        """
    ...
    def parameter_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def parameter_group_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "parameter_group_name", value)

    @property
    @pulumi.getter(name="parameterGroupDesc")
    def parameter_group_desc(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def parameter_group_desc(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RdsParameterGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            param_details: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RdsParameterGroupParamDetailArgs', 'RdsParameterGroupParamDetailArgsDict']]]]] = None,
            parameter_group_desc: Optional[pulumi.Input[builtins.str]] = None,
            parameter_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'RdsParameterGroup':
        """
    ...
    @property
    @pulumi.getter(name="parameterGroupDesc")
    def parameter_group_desc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the parameter template.
        """
        return pulumi.get(self, "parameter_group_desc")
