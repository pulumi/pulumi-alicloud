...
class DatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] character_set: Character set. The value range is limited to the following:
...
class Database(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="characterSet")
    def character_set(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Character set. The value range is limited to the following:
        - MySQL: [ utf8, gbk, latin1, utf8mb4 ] \\(`utf8mb4` only supports versions 5.5 and 5.6\\).
        - SQLServer: [ Chinese_PRC_CI_AS, Chinese_PRC_CS_AS, SQL_Latin1_General_CP1_CI_AS, SQL_Latin1_General_CP1_CS_AS, Chinese_PRC_BIN ]
