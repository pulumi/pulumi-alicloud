...
class CustomDiskArgs:
    def __init__(__self__, *,
                 disk_category: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] disk_category: The type of the data disk. Value range:
        :param pulumi.Input[builtins.int] size: Capacity size. Unit: GiB. You must pass in a parameter value for this parameter. Value range:
        ...
        :param pulumi.Input[builtins.bool] auto_renew: Whether to automatically renew. This parameter is passed in only when you create a data disk. Valid values:
        :param pulumi.Input[builtins.str] description: The disk description. It must be 2 to 256 characters in length and cannot start with 'http:// 'or 'https.
               Default value: empty.
        :param pulumi.Input[builtins.str] disk_name: The disk name. It can be 2 to 128 characters in length. It supports letters in Unicode (including English, Chinese, and numbers). Can contain a colon (:), an underscore (_), a period (.), or a dash (-).
               Default value: empty.
        :param pulumi.Input[builtins.bool] dry_run: Whether to pre-check the instance creation operation. Valid values:
        :param pulumi.Input[builtins.str] instance_charge_type: The Payment type. Only `Postpaid`: Pay-As-You-Go is supported.
        :param pulumi.Input[builtins.str] performance_level: When creating an ESSD cloud disk, set the performance level of the disk. Value range:
        ...
        :param pulumi.Input[builtins.int] period: Reserved parameters, no need to fill in.
        :param pulumi.Input[builtins.str] period_unit: Reserved parameters, no need to fill in.
        :param pulumi.Input[builtins.str] snapshot_id: The snapshot used to create the cloud disk. Snapshots made on or before July 15, 2013 cannot be used to create cloud disks. The 'SnapshotId' parameter and the 'Size' parameter have the following limitations:
        ...
        :param pulumi.Input[builtins.str] type: The method of expanding the disk. Value range:
    ...
    def disk_category(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def disk_category(self, value: pulumi.Input[builtins.str]):
...
class _CustomDiskState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] period: Reserved parameters, no need to fill in.
        :param pulumi.Input[builtins.str] period_unit: Reserved parameters, no need to fill in.
        :param pulumi.Input[builtins.str] region_id: The region ID. You can view the region ID through the DescribeRegions interface.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the disk belongs.
        :param pulumi.Input[builtins.int] size: Capacity size. Unit: GiB. You must pass in a parameter value for this parameter. Value range:
        :param pulumi.Input[builtins.str] snapshot_id: The snapshot used to create the cloud disk. Snapshots made on or before July 15, 2013 cannot be used to create cloud disks. The 'SnapshotId' parameter and the 'Size' parameter have the following limitations:
               - If the snapshot capacity corresponding to the 'SnapshotId' parameter is greater than the set 'Size' parameter value, the actual size of the cloud disk created is the size of the specified snapshot.
               - If the snapshot capacity corresponding to the 'SnapshotId' parameter is less than the set 'Size' parameter value, the size of the cloud disk created is the specified 'Size' parameter value.
               - Snapshots are not supported for creating elastic temporary disks.
        :param pulumi.Input[builtins.str] status: Disk status. Value Description:_use: In use.
        :param pulumi.Input[builtins.str] type: The method of expanding the disk. Value range:
               offline (default): offline expansion. After the expansion, the instance must be restarted to take effect.
               online: online expansion, which can be completed without restarting the instance.
        :param pulumi.Input[builtins.str] zone_id: The zone ID.
...
class CustomDisk(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomDisk':
        """
    ...
    @property
    @pulumi.getter(name="diskCategory")
    def disk_category(self) -> pulumi.Output[builtins.str]:
        """
        The type of the data disk. Value range:
        """
        return pulumi.get(self, "disk_category")
    ...
    @property
    @pulumi.getter(name="performanceLevel")
    def performance_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When creating an ESSD cloud disk, set the performance level of the disk. Value range:
        - `PL0`: The maximum random read/write IOPS 10000 for a single disk.
        - `PL1` (default): The maximum number of random read/write IOPS 50000 for a single disk.
