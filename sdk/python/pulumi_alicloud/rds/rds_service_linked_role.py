...
class RdsServiceLinkedRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_name: The product name for SLR. RDS can automatically create the following service-linked roles: `AliyunServiceRoleForRdsPgsqlOnEcs`, `AliyunServiceRoleForRDSProxyOnEcs`.
        """
...
class _RdsServiceLinkedRoleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Alibaba Cloud Resource Name (ARN) of the role.
...
@pulumi.type_token("alicloud:rds/rdsServiceLinkedRole:RdsServiceLinkedRole")
class RdsServiceLinkedRole(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role_id: Optional[pulumi.Input[builtins.str]] = None,
            role_name: Optional[pulumi.Input[builtins.str]] = None,
            service_name: Optional[pulumi.Input[builtins.str]] = None) -> 'RdsServiceLinkedRole':
        """
