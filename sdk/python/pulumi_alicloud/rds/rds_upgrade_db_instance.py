...
class RdsUpgradeDbInstanceArgs:
    def __init__(__self__, *,
                 collect_stat_mode: pulumi.Input[builtins.str],
                 db_instance_class: pulumi.Input[builtins.str],
                 db_instance_storage: pulumi.Input[builtins.int],
                 db_instance_storage_type: pulumi.Input[builtins.str],
                 instance_network_type: pulumi.Input[builtins.str],
                 payment_type: pulumi.Input[builtins.str],
                 source_db_instance_id: pulumi.Input[builtins.str],
                 switch_over: pulumi.Input[builtins.str],
                 target_major_version: pulumi.Input[builtins.str],
                 ...
                 ha_mode: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 source_biz: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_enabled: Optional[pulumi.Input[builtins.int]] = None,
                 switch_time: Optional[pulumi.Input[builtins.str]] = None,
                 switch_time_mode: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 zone_id_slave1: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RdsUpgradeDbInstance resource.
        :param pulumi.Input[builtins.str] collect_stat_mode: The time at which ApsaraDB RDS collects the statistics of the new instance.
        ...
        :param pulumi.Input[builtins.str] db_instance_class: The instance type of the new instance. For information, see [Primary ApsaraDB RDS instance types](https://www.alibabacloud.com/help/en/rds/product-overview/primary-apsaradb-rds-instance-types).
        :param pulumi.Input[builtins.int] db_instance_storage: The storage capacity of the new instance. Unit: GB. The storage capacity increases in increments of 5 GB. For more information, see [Primary ApsaraDB RDS instance types](https://www.alibabacloud.com/help/en/rds/product-overview/primary-apsaradb-rds-instance-types).
               
               > **NOTE:** The default value of this parameter is the storage capacity of the original instance.
        :param pulumi.Input[builtins.str] db_instance_storage_type: The type of storage media that is used for the new instance. Valid values:
               * **local_ssd**: local SSDs.
               * **cloud_ssd**: standard SSDs.
               * **cloud_essd**: enhanced SSDs (ESSDs) of performance level 1 (PL1).
               * **cloud_essd2**: ESSDs of PL2.
               * **cloud_essd3**: ESSDs of PL3.
        :param pulumi.Input[builtins.str] instance_network_type: The network type of the instance. Valid values:
               * **Classic**: Classic Network.
               * **VPC**: VPC.
        :param pulumi.Input[builtins.str] payment_type: The billing method of the new instance. Valid values: `PayAsYouGo` and `Subscription`.
        :param pulumi.Input[builtins.str] source_db_instance_id: The source db instance id.
        :param pulumi.Input[builtins.str] switch_over: Specifies whether ApsaraDB RDS automatically switches your workloads over to the new instance after data is migrated to the new instance. Valid values:
        ...
        :param pulumi.Input[builtins.str] target_major_version: The major engine version of the new instance. The value of this parameter must be the major engine version on which an upgrade check is performed.
        ...
        :param pulumi.Input[builtins.str] acl: This parameter is only supported by the RDS PostgreSQL cloud disk version. This parameter indicates the authentication method. It is allowed only when the public key of the client certificate authority is enabled. Valid values: `cert` and `perfer` and `verify-ca` and `verify-full (supported by RDS PostgreSQL above 12)`.
        :param pulumi.Input[builtins.str] auto_upgrade_minor_version: How to upgrade the minor version of the instance. Valid values:
        ...
        :param pulumi.Input[builtins.str] ca_type: This parameter is only supported by the RDS PostgreSQL cloud disk version. It indicates the certificate type. When the value of ssl_action is Open, the default value of this parameter is aliyun. Value range:
        ...
        :param pulumi.Input[builtins.str] client_cert_revocation_list: This parameter is only supported by the RDS PostgreSQL cloud disk version, which indicates that the client revokes the certificate file. If the value of client_crl_enabled is 1, this parameter must be configured.
        :param pulumi.Input[builtins.int] client_crl_enabled: The client crl enabled.
        :param pulumi.Input[builtins.str] connection_string_prefix: The connection string prefix.
        :param pulumi.Input[builtins.str] db_instance_description: The db instance description.
        :param pulumi.Input[builtins.str] db_name: The name of the database for which you want to enable TDE. Up to 50 names can be entered in a single request. If you specify multiple names, separate these names with commas (,).
        ...
        :param pulumi.Input[builtins.str] dedicated_host_group_id: The ID of the dedicated cluster to which the new instance belongs. This parameter takes effect only when you create the new instance in a dedicated cluster.
        ...
        :param pulumi.Input[builtins.str] direction: The direction. Valid values: `Auto`, `Down`, `TempUpgrade`, `Up`.
        :param pulumi.Input[builtins.str] effective_time: The effective time.
        :param pulumi.Input[builtins.str] encryption_key: The ID of the private key.
               
               > **NOTE:** This parameter is available only when the instance runs MySQL.
        :param pulumi.Input[builtins.str] engine: Database type. Value options: MySQL, SQLServer, PostgreSQL.
        :param pulumi.Input[builtins.str] engine_version: Database version. Value:
        ...
        :param pulumi.Input[builtins.str] ha_mode: The high availability mode. Valid values:
        ...
        :param pulumi.Input[builtins.str] maintain_time: The maintainable time period of the instance. Format: <I> HH:mm</I> Z-<I> HH:mm</I> Z(UTC time).
        ...
        :param pulumi.Input[builtins.str] password: The password of the certificate. 
        ...
        :param pulumi.Input[builtins.str] port: The port.
        :param pulumi.Input[builtins.str] private_ip_address: The intranet IP address of the new instance must be within the specified vSwitch IP address range. By default, the system automatically allocates by using **VPCId** and **VSwitchId**.
        :param pulumi.Input[builtins.str] private_key: The file that contains the private key used for TDE.
        :param pulumi.Input[builtins.str] released_keep_policy: The released keep policy.
        :param pulumi.Input[builtins.str] replication_acl: This parameter is only supported by the RDS PostgreSQL cloud disk version, indicating the authentication method of the replication permission. It is only allowed when the public key of the client certificate authority is enabled. Valid values: `cert` and `perfer` and `verify-ca` and `verify-full (supported by RDS PostgreSQL above 12)`.
        :param pulumi.Input[builtins.str] resource_group_id: The resource group id.
        :param pulumi.Input[builtins.str] role_arn: The Alibaba Cloud Resource Name (ARN) of a RAM role. A RAM role is a virtual RAM identity that you can create within your Alibaba Cloud account. For more information, see [RAM role overview](https://www.alibabacloud.com/help/en/ram/user-guide/ram-role-overview).
               
               > **NOTE:** This parameter is available only when the instance runs MySQL.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_ips: The IP address whitelist of the instance. Separate multiple IP addresses with commas (,) and cannot be repeated. The following two formats are supported:
        ...
        :param pulumi.Input[builtins.str] server_cert: This parameter is only supported by the RDS PostgreSQL cloud disk version. It indicates the content of the server certificate. If the CAType value is custom, this parameter must be configured.
        :param pulumi.Input[builtins.str] server_key: This parameter is only supported by the RDS PostgreSQL cloud disk version. It indicates the private key of the server certificate. If the value of CAType is custom, this parameter must be configured.
        :param pulumi.Input[builtins.str] source_biz: The source biz.
        :param pulumi.Input[builtins.int] ssl_enabled: Enable or disable SSL. Valid values: `0` and `1`.
        :param pulumi.Input[builtins.str] switch_time: The time at which you want to apply the specification changes. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.
        :param pulumi.Input[builtins.str] switch_time_mode: The time at which ApsaraDB RDS switches your workloads over to the new instance. This parameter is used together with the SwitchOver parameter and takes effect only when you set the SwitchOver parameter to true. Valid values:
        ...
        :param pulumi.Input[builtins.str] sync_mode: [The data replication mode](https://www.alibabacloud.com/help/doc-detail/96055.htm). Valid values:
        ...
        :param pulumi.Input[builtins.str] tde_status: Specifies whether to enable TDE. Valid values: `Enabled` and `Disabled`.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC to which the new instance belongs.
               
               > **NOTE:** Make sure that the VPC resides in the specified region.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the vSwitch associated with the specified VPC.
               
               > **NOTE:** Make sure that the vSwitch belongs to the specified VPC and region.
        :param pulumi.Input[builtins.str] zone_id: The ID of the zone to which the new instance belongs. You can call the [DescribeRegions](https://www.alibabacloud.com/help/en/rds/developer-reference/api-rds-2014-08-15-describeregions) operation to query the most recent region list.
               
               > **NOTE:** The default value of this parameter is the ID of the zone to which the original instance belongs.
        :param pulumi.Input[builtins.str] zone_id_slave1: The ID of the zone to which the secondary instance of the new instance belongs. You can specify this parameter only when the original instance runs RDS High-availability Edition. You can select a zone that belongs to the region where the original instance resides. You can call the [DescribeRegions](https://www.alibabacloud.com/help/en/rds/developer-reference/api-rds-2014-08-15-describeregions) operation to query zone IDs.
        """
    ...
    def collect_stat_mode(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def collect_stat_mode(self, value: pulumi.Input[builtins.str]):
    ...
    def db_instance_storage(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def db_instance_storage(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "db_instance_storage", value)

    @property
    @pulumi.getter(name="dbInstanceStorageType")
    def db_instance_storage_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_instance_storage_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "db_instance_storage_type", value)

    @property
    @pulumi.getter(name="instanceNetworkType")
    def instance_network_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def instance_network_type(self, value: pulumi.Input[builtins.str]):
    ...
    def source_db_instance_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_db_instance_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_db_instance_id", value)

    @property
    @pulumi.getter(name="switchOver")
    def switch_over(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @switch_over.setter
    def switch_over(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "switch_over", value)

    @property
    @pulumi.getter(name="targetMajorVersion")
    def target_major_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_major_version(self, value: pulumi.Input[builtins.str]):
    ...
    def db_instance_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_instance_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ha_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ha_mode.setter
    def ha_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_biz(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The source biz.
        """
    ...
    @source_biz.setter
    def source_biz(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_biz", value)

    @property
    @pulumi.getter(name="sslEnabled")
    def ssl_enabled(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @ssl_enabled.setter
    def ssl_enabled(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def switch_time_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def switch_time_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def zone_id_slave1(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def zone_id_slave1(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RdsUpgradeDbInstanceState:
    def __init__(__self__, *,
                 ...
                 client_cert_revocation_list: Optional[pulumi.Input[builtins.str]] = None,
                 client_crl_enabled: Optional[pulumi.Input[builtins.int]] = None,
                 collect_stat_mode: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 force_restart: Optional[pulumi.Input[builtins.bool]] = None,
                 ha_mode: Optional[pulumi.Input[builtins.str]] = None,
                 instance_network_type: Optional[pulumi.Input[builtins.str]] = None,
                 maintain_time: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input['RdsUpgradeDbInstanceParameterArgs']]]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 ssl_enabled: Optional[pulumi.Input[builtins.int]] = None,
                 switch_over: Optional[pulumi.Input[builtins.str]] = None,
                 switch_time: Optional[pulumi.Input[builtins.str]] = None,
                 switch_time_mode: Optional[pulumi.Input[builtins.str]] = None,
                 sync_mode: Optional[pulumi.Input[builtins.str]] = None,
                 target_major_version: Optional[pulumi.Input[builtins.str]] = None,
                 tcp_connection_type: Optional[pulumi.Input[builtins.str]] = None,
                 tde_status: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_id: Optional[pulumi.Input[builtins.str]] = None,
                 vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] collect_stat_mode: The time at which ApsaraDB RDS collects the statistics of the new instance.
               ...
               * **After**: ApsaraDB RDS collects the statistics of the new instance after the switchover to accelerate the upgrade. If you access tables for which no statistics are generated, the query plans that you specify may be inaccurately executed. In addition, your database service may be unavailable during peak hours.
               ...
               > **NOTE** If you set the SwitchOver parameter to false, the value Before specifies that ApsaraDB RDS collects the statistics of the new instance before the new instance starts to process read and write requests, and the value After specifies that ApsaraDB RDS collects the statistics of the new instance after the new instance starts to process read and write requests.
        :param pulumi.Input[builtins.str] connection_string: The database connection address.
        :param pulumi.Input[builtins.str] connection_string_prefix: The connection string prefix.
        :param pulumi.Input[builtins.str] db_instance_class: The instance type of the new instance. For information, see [Primary ApsaraDB RDS instance types](https://www.alibabacloud.com/help/en/rds/product-overview/primary-apsaradb-rds-instance-types).
        :param pulumi.Input[builtins.str] db_instance_description: The db instance description.
        :param pulumi.Input[builtins.int] db_instance_storage: The storage capacity of the new instance. Unit: GB. The storage capacity increases in increments of 5 GB. For more information, see [Primary ApsaraDB RDS instance types](https://www.alibabacloud.com/help/en/rds/product-overview/primary-apsaradb-rds-instance-types).
    ...
    @property
    @pulumi.getter(name="collectStatMode")
    def collect_stat_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The time at which ApsaraDB RDS collects the statistics of the new instance.
        * **Before**: ApsaraDB RDS collects the statistics of the new instance before the switchover to ensure service stability. If the original instance contains a large amount of data, the upgrade may require a long period of time.
        * **After**: ApsaraDB RDS collects the statistics of the new instance after the switchover to accelerate the upgrade. If you access tables for which no statistics are generated, the query plans that you specify may be inaccurately executed. In addition, your database service may be unavailable during peak hours.
    ...
    @collect_stat_mode.setter
    def collect_stat_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "collect_stat_mode", value)
    ...
    @db_instance_storage.setter
    def db_instance_storage(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "db_instance_storage", value)
    ...
    @property
    @pulumi.getter(name="instanceNetworkType")
    def instance_network_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The network type of the instance. Valid values:
        * **Classic**: Classic Network.
        * **VPC**: VPC.
    ...
    @instance_network_type.setter
    def instance_network_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "instance_network_type", value)
    ...
    @property
    @pulumi.getter(name="switchOver")
    def switch_over(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies whether ApsaraDB RDS automatically switches your workloads over to the new instance after data is migrated to the new instance. Valid values:
        * **true**: ApsaraDB RDS automatically switches workloads over to the new instance. If you set this parameter to true, you must take note of the following information:
        * After the switchover is complete, you cannot roll your workloads back to the original instance. Proceed with caution.
    ...
    @switch_over.setter
    def switch_over(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "switch_over", value)
    ...
    @property
    @pulumi.getter(name="targetMajorVersion")
    def target_major_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The major engine version of the new instance. The value of this parameter must be the major engine version on which an upgrade check is performed.
    ...
    @target_major_version.setter
    def target_major_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_major_version", value)
...
class RdsUpgradeDbInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id_slave1: Optional[pulumi.Input[builtins.str]] = None) -> 'RdsUpgradeDbInstance':
        """
    ...
    @property
    @pulumi.getter(name="collectStatMode")
    def collect_stat_mode(self) -> pulumi.Output[builtins.str]:
        """
        The time at which ApsaraDB RDS collects the statistics of the new instance.
        * **Before**: ApsaraDB RDS collects the statistics of the new instance before the switchover to ensure service stability. If the original instance contains a large amount of data, the upgrade may require a long period of time.
        * **After**: ApsaraDB RDS collects the statistics of the new instance after the switchover to accelerate the upgrade. If you access tables for which no statistics are generated, the query plans that you specify may be inaccurately executed. In addition, your database service may be unavailable during peak hours.
    ...
    @property
    @pulumi.getter(name="dbInstanceDescription")
    def db_instance_description(self) -> pulumi.Output[builtins.str]:
        """
        The db instance description.
        """
        return pulumi.get(self, "db_instance_description")
    ...
    @property
    @pulumi.getter(name="haMode")
    def ha_mode(self) -> pulumi.Output[builtins.str]:
        """
        The high availability mode. Valid values:
        * **RPO**: Data persistence is preferred. The instance preferentially ensures data reliability to minimize data loss. Use this mode if you have higher requirements on data consistency.
        * **RTO**: Instance availability is preferred. The instance restores services as soon as possible to ensure availability. Use this mode if you have higher requirements on service availability.
    ...
    @property
    @pulumi.getter(name="instanceNetworkType")
    def instance_network_type(self) -> pulumi.Output[builtins.str]:
        """
        The network type of the instance. Valid values:
        * **Classic**: Classic Network.
        * **VPC**: VPC.
    ...
    @property
    @pulumi.getter(name="sourceBiz")
    def source_biz(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The source biz.
        """
        return pulumi.get(self, "source_biz")
    ...
    @property
    @pulumi.getter(name="sourceDbInstanceId")
    def source_db_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The source db instance id.
        """
        return pulumi.get(self, "source_db_instance_id")
    ...
    @property
    @pulumi.getter(name="sslEnabled")
    def ssl_enabled(self) -> pulumi.Output[builtins.int]:
        """
        Enable or disable SSL. Valid values: `0` and `1`.
        """
        return pulumi.get(self, "ssl_enabled")
    ...
    @property
    @pulumi.getter(name="switchOver")
    def switch_over(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether ApsaraDB RDS automatically switches your workloads over to the new instance after data is migrated to the new instance. Valid values:
        * **true**: ApsaraDB RDS automatically switches workloads over to the new instance. If you set this parameter to true, you must take note of the following information:
        * After the switchover is complete, you cannot roll your workloads back to the original instance. Proceed with caution.
    ...
    @property
    @pulumi.getter(name="switchTimeMode")
    def switch_time_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time at which ApsaraDB RDS switches your workloads over to the new instance. This parameter is used together with the SwitchOver parameter and takes effect only when you set the SwitchOver parameter to true. Valid values:
        * **Immediate**: After data is migrated to the new instance, ApsaraDB RDS immediately switches your workloads over to the new instance.
        * **MaintainTime**: After data is migrated to the new instance, ApsaraDB RDS switches your workloads over to the new instance during the maintenance window that you specify. You can call the [ModifyDBInstanceMaintainTime](https://www.alibabacloud.com/help/doc-detail/26249.htm) operation to change the maintenance window of an instance.
    ...
    @property
    @pulumi.getter(name="targetMajorVersion")
    def target_major_version(self) -> pulumi.Output[builtins.str]:
        """
        The major engine version of the new instance. The value of this parameter must be the major engine version on which an upgrade check is performed.
    ...
    @property
    @pulumi.getter(name="zoneIdSlave1")
    def zone_id_slave1(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the zone to which the secondary instance of the new instance belongs. You can specify this parameter only when the original instance runs RDS High-availability Edition. You can select a zone that belongs to the region where the original instance resides. You can call the [DescribeRegions](https://www.alibabacloud.com/help/en/rds/developer-reference/api-rds-2014-08-15-describeregions) operation to query zone IDs.
        """
        return pulumi.get(self, "zone_id_slave1")
