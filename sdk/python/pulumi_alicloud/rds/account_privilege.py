...
class AccountPrivilegeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The Id of instance in which account belongs.
        :param pulumi.Input[builtins.str] privilege: The privilege of one account access database. Valid values: 
...
class AccountPrivilege(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            db_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            privilege: Optional[pulumi.Input[builtins.str]] = None) -> 'AccountPrivilege':
        """
    ...
    @property
    @pulumi.getter
    def privilege(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The privilege of one account access database. Valid values: 
        - ReadOnly: This value is only for MySQL, MariaDB and SQL Server
        - ReadWrite: This value is only for MySQL, MariaDB and SQL Server
