...
def get_certificates(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of cert IDs.
    :param builtins.str name_regex: A regex string to filter results by the certificate name.
...
def get_certificates_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
