...
def get_service_certificates(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ssl Certificates IDs.
    :param builtins.str keyword: The domain name that is bound or the ID of the resource. Fuzzy match is supported.
    :param builtins.str lang: The language of the content within the request and response. **Note:** Field `lang` has been deprecated from provider version 1.232.0.
    :param builtins.str name_regex: A regex string to filter results by Ssl Certificates name.
...
def get_service_certificates_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
