...
class CertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the Certificate. This name must contain only alphanumeric characters or "-", and must not begin or end with "-", and "-" must not in the 3th and 4th character positions at the same time. Suffix `.sh` and `.tel` are not supported.
        """
...
class Certificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key: Optional[pulumi.Input[builtins.str]] = None,
            lang: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'Certificate':
        """
