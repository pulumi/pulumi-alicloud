...
class ServiceCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cert: Cert of the Certificate in which the Certificate will add.
        :param pulumi.Input[builtins.str] key: Key of the Certificate in which the Certificate will add.
        :param pulumi.Input[builtins.str] certificate_name: Name of the Certificate. `certificate_name` must contain only alphanumeric characters or "-", and must not begin or end with "-", and "-" must not in the 3th and 4th character positions at the same time. Suffix .sh and .tel are not supported.
               **NOTE:** One of `certificate_name` and `name` must be specified.
        :param pulumi.Input[builtins.str] lang: The lang.
        :param pulumi.Input[builtins.str] name: It has been deprecated from version 1.129.0 and using `certificate_name` instead.
        """
...
class ServiceCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key: Optional[pulumi.Input[builtins.str]] = None,
            lang: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceCertificate':
        """
