...
class GetGatewaysGatewayResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str create_time: The creation time of Gateway.
        :param builtins.str gateway_desc: The description of Gateway.
        :param builtins.str gateway_name: The name of the Gateway.
        :param builtins.str hosts: A host of information.
        :param builtins.str id: The ID of Gateway.
        :param builtins.str modified_time: The Modify time of Gateway.
        :param builtins.str parent_id: The parent node Id of Gateway.
        :param builtins.str status: The status of gateway. Valid values: `EXCEPTION`, `NEW`, `RUNNING`, `STOPPED`.
        :param builtins.str user_id: The user's id.
        """
    ...
    def gateway_desc(self) -> builtins.str:
        """
...
class GetGatewaysGatewayGatewayInstanceResult(dict):
    def __init__(__self__, *,
                 connect_endpoint_type: builtins.str,
                 current_daemon_version: builtins.str,
                 current_version: builtins.str,
                 end_point: builtins.str,
                 gateway_instance_id: builtins.str,
                 gateway_instance_status: builtins.str,
                 last_update_time: builtins.str,
                 local_ip: builtins.str,
                 message: builtins.str,
                 output_ip: builtins.str):
        """
        :param builtins.str connect_endpoint_type: The connection type of Gateway instance.
        :param builtins.str current_daemon_version: The process of version number of Gateway instance.
        :param builtins.str current_version: The version of Gateway instance.
        :param builtins.str end_point: The endpoint address of Gateway instance.
        :param builtins.str gateway_instance_id: The id of Gateway instance.
        :param builtins.str gateway_instance_status: The status of Gateway instance. Valid values: `EXCEPTION`, `NEW`, `RUNNING`, `STOPPED`.
        :param builtins.str last_update_time: The last Updated time stamp of Gateway instance.
        :param builtins.str local_ip: The Local IP ADDRESS of Gateway instance.
        :param builtins.str message: The prompt information of Gateway instance.
        :param builtins.str output_ip: The host of Gateway instance.
        """
    ...
    def connect_endpoint_type(self) -> builtins.str:
        """
    ...
    def current_daemon_version(self) -> builtins.str:
        """
    ...
    def gateway_instance_id(self) -> builtins.str:
        """
    ...
    def gateway_instance_status(self) -> builtins.str:
        """
    ...
    def output_ip(self) -> builtins.str:
        """
