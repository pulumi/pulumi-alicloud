...
def get_service_meshes(enable_details: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Service Mesh IDs.
    :param _builtins.str name_regex: A regex string to filter results by Service Mesh name.
...
def get_service_meshes_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
