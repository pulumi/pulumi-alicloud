...
def get_service_meshes(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Service Mesh IDs.
    :param builtins.str name_regex: A regex string to filter results by Service Mesh name.
...
def get_service_meshes_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetServiceMeshesResult(
        ...
        meshes=pulumi.get(__response__, 'meshes'),
