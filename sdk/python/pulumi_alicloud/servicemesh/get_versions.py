...
def get_versions(edition: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of ASM versions. Its element formats as `<edition>:<version>`.
...
def get_versions_output(edition: Optional[pulumi.Input[Optional[builtins.str]]] = None,
