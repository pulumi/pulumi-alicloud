...
class ExtensionProviderArgs:
    def __init__(__self__, *,
                 ...
                 extension_provider_name: pulumi.Input[builtins.str],
                 service_mesh_id: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ExtensionProvider resource.
        :param pulumi.Input[builtins.str] config: The config of the Service Mesh Extension Provider. The `config` format is json.
        :param pulumi.Input[builtins.str] extension_provider_name: The name of the Service Mesh Extension Provider. It must be prefixed with `$type-`, for example `httpextauth-xxx`, `grpcextauth-xxx`.
        :param pulumi.Input[builtins.str] service_mesh_id: The ID of the Service Mesh.
        :param pulumi.Input[builtins.str] type: The type of the Service Mesh Extension Provider. Valid values: `httpextauth`, `grpcextauth`.
        """
    ...
    def extension_provider_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def extension_provider_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "extension_provider_name", value)

    @property
    @pulumi.getter(name="serviceMeshId")
    def service_mesh_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def service_mesh_id(self, value: pulumi.Input[builtins.str]):
...
class _ExtensionProviderState:
    def __init__(__self__, *,
                 ...
                 extension_provider_name: Optional[pulumi.Input[builtins.str]] = None,
                 service_mesh_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="extensionProviderName")
    def extension_provider_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Service Mesh Extension Provider. It must be prefixed with `$type-`, for example `httpextauth-xxx`, `grpcextauth-xxx`.
        """
        return pulumi.get(self, "extension_provider_name")
    ...
    @extension_provider_name.setter
    def extension_provider_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "extension_provider_name", value)

    @property
    @pulumi.getter(name="serviceMeshId")
    def service_mesh_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Service Mesh.
        """
        return pulumi.get(self, "service_mesh_id")
    ...
    @service_mesh_id.setter
    def service_mesh_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_mesh_id", value)
...
class ExtensionProvider(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            extension_provider_name: Optional[pulumi.Input[builtins.str]] = None,
            service_mesh_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'ExtensionProvider':
        """
    ...
    @property
    @pulumi.getter(name="extensionProviderName")
    def extension_provider_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Service Mesh Extension Provider. It must be prefixed with `$type-`, for example `httpextauth-xxx`, `grpcextauth-xxx`.
        """
        return pulumi.get(self, "extension_provider_name")
    ...
    @property
    @pulumi.getter(name="serviceMeshId")
    def service_mesh_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Service Mesh.
        """
        return pulumi.get(self, "service_mesh_id")
