...
class GetServiceMeshesMeshMeshConfigSidecarInjectorResult(dict):
    ...
    def _configure(
        ...
        if 'enableNamespacesByDefault' in kwargs:
            enable_namespaces_by_default = kwargs['enableNamespacesByDefault']
        if 'initCniConfigurations' in kwargs:
