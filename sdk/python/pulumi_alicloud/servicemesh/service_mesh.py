...
class ServiceMeshArgs:
    def __init__(__self__, *,
                 ...
                 customized_prometheus: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 service_mesh_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cluster_ids: List of clusters.
        :param pulumi.Input[builtins.str] cluster_spec: Cluster specification
        :param pulumi.Input[builtins.bool] customized_prometheus: Whether to customize Prometheus. Value:
               -'true': custom Prometheus.
               -'false': Do not customize Prometheus.
               
               Default value: 'false '.
        :param pulumi.Input[builtins.str] edition: Grid instance version type (for example: the standard, the Pro version, etc.)
        ...
        :param pulumi.Input[builtins.bool] force: Whether to forcibly delete the ASM instance. Value:
        ...
        :param pulumi.Input[builtins.str] prometheus_url: The Prometheus service address (in non-custom cases, use the ARMS address format).
        :param pulumi.Input[builtins.str] service_mesh_name: ServiceMeshName
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the resource
        :param pulumi.Input[builtins.str] version: Service grid version number
        """
    ...
    def customized_prometheus(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def customized_prometheus(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def service_mesh_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ServiceMeshName
        """
    ...
    def service_mesh_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ServiceMeshState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cluster_ids: List of clusters.
        :param pulumi.Input[builtins.str] cluster_spec: Cluster specification
        :param pulumi.Input[builtins.str] create_time: Service grid creation time
        :param pulumi.Input[builtins.bool] customized_prometheus: Whether to customize Prometheus. Value:
               -'true': custom Prometheus.
               -'false': Do not customize Prometheus.
        ...
        :param pulumi.Input[builtins.bool] force: Whether to forcibly delete the ASM instance. Value:
               ...
               Default value: false
        :param pulumi.Input[builtins.str] kubeconfig: Kubeconfig configuration content
        :param pulumi.Input['ServiceMeshLoadBalancerArgs'] load_balancer: Load balancing information See `load_balancer` below.
        :param pulumi.Input['ServiceMeshMeshConfigArgs'] mesh_config: Service grid configuration information See `mesh_config` below.
        :param pulumi.Input['ServiceMeshNetworkArgs'] network: Service grid network configuration information See `network` below.
        :param pulumi.Input[builtins.str] prometheus_url: The Prometheus service address (in non-custom cases, use the ARMS address format).
...
class ServiceMesh(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceMesh':
        """
    ...
    @property
    @pulumi.getter(name="clusterIds")
    def cluster_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of clusters.
        """
        return pulumi.get(self, "cluster_ids")
    ...
    @property
    @pulumi.getter(name="customizedPrometheus")
    def customized_prometheus(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to customize Prometheus. Value:
        -'true': custom Prometheus.
        -'false': Do not customize Prometheus.
    ...
    @property
    @pulumi.getter(name="prometheusUrl")
    def prometheus_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Prometheus service address (in non-custom cases, use the ARMS address format).
        """
        return pulumi.get(self, "prometheus_url")
    ...
    @property
    @pulumi.getter(name="serviceMeshName")
    def service_mesh_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ServiceMeshName
        """
        return pulumi.get(self, "service_mesh_name")
