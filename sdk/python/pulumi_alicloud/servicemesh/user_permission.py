...
class UserPermissionArgs:
    def __init__(__self__, *,
                 sub_account_user_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] sub_account_user_id: The configuration of the Load Balancer. See the following `Block load_balancer`.
    ...
    def sub_account_user_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sub_account_user_id(self, value: pulumi.Input[builtins.str]):
...
class _UserPermissionState:
    def __init__(__self__, *,
                 permissions: Optional[pulumi.Input[Sequence[pulumi.Input['UserPermissionPermissionArgs']]]] = None,
                 sub_account_user_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="subAccountUserId")
    def sub_account_user_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The configuration of the Load Balancer. See the following `Block load_balancer`.
        """
        return pulumi.get(self, "sub_account_user_id")
    ...
    @sub_account_user_id.setter
    def sub_account_user_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sub_account_user_id", value)
...
class UserPermission(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            permissions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['UserPermissionPermissionArgs', 'UserPermissionPermissionArgsDict']]]]] = None,
            sub_account_user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UserPermission':
        """
    ...
    @property
    @pulumi.getter(name="subAccountUserId")
    def sub_account_user_id(self) -> pulumi.Output[builtins.str]:
        """
        The configuration of the Load Balancer. See the following `Block load_balancer`.
        """
        return pulumi.get(self, "sub_account_user_id")
