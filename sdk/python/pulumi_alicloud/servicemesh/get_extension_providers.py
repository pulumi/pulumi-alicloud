...
def get_extension_providers(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Service Mesh Extension Provider IDs.
    :param builtins.str name_regex: A regex string to filter results by Service Mesh Extension Provider name.
...
def get_extension_providers_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
