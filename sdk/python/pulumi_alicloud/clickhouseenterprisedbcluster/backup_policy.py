...
class BackupPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] backup_retention_period: Backup retention time.
        :param pulumi.Input[str] db_instance_id: The instance ID.
        :param pulumi.Input[str] preferred_backup_period: Backup period.
        :param pulumi.Input[str] preferred_backup_time: Backup time.
        """
