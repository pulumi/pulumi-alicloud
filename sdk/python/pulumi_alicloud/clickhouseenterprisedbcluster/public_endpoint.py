...
class PublicEndpointArgs:
    def __init__(__self__, *,
                 ...
                 net_type: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a PublicEndpoint resource.
        :param pulumi.Input[builtins.str] connection_string_prefix: The public network connection string prefix of the instance.
        :param pulumi.Input[builtins.str] db_instance_id: The cluster ID.
        :param pulumi.Input[builtins.str] net_type: Network type of the connection address. Valid values:
    ...
    def net_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @net_type.setter
    def net_type(self, value: pulumi.Input[builtins.str]):
...
class PublicEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            connection_string_prefix: Optional[pulumi.Input[builtins.str]] = None,
            db_instance_id: Optional[pulumi.Input[builtins.str]] = None,
            net_type: Optional[pulumi.Input[builtins.str]] = None) -> 'PublicEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="netType")
    def net_type(self) -> pulumi.Output[builtins.str]:
        """
        Network type of the connection address. Valid values:
        - Public: Public network.
        """
