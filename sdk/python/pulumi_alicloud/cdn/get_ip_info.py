...
class GetIpInfoResult:
    ...
    def isp_ename(self) -> _builtins.str:
    ...
    def region_ename(self) -> _builtins.str:
...
def get_ip_info(ip: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ip: Specify IP address.
    """
    __args__ = dict()
    __args__['ip'] = ip
