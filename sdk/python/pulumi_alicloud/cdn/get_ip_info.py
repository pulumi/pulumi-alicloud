...
class GetIpInfoResult:
    ...
    def isp_ename(self) -> builtins.str:
    ...
    def region_ename(self) -> builtins.str:
...
def get_ip_info(ip: Optional[builtins.str] = None,
    ...
    :param builtins.str ip: Specify IP address.
    """
    __args__ = dict()
    __args__['ip'] = ip
...
def get_ip_info_output(ip: Optional[pulumi.Input[builtins.str]] = None,
