...
def get_blocked_regions(language: Optional[builtins.str] = None,
    ...
    :param builtins.str language: The language. Valid values: `zh`, `en`, `jp`.
    """
    __args__ = dict()
...
def get_blocked_regions_output(language: Optional[pulumi.Input[builtins.str]] = None,
