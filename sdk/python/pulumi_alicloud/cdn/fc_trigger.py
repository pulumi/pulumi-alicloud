...
class FcTriggerArgs:
    def __init__(__self__, *,
                 event_meta_name: pulumi.Input[builtins.str],
                 event_meta_version: pulumi.Input[builtins.str],
                 notes: pulumi.Input[builtins.str],
                 role_arn: pulumi.Input[builtins.str],
                 source_arn: pulumi.Input[builtins.str],
                 trigger_arn: pulumi.Input[builtins.str],
                 function_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a FcTrigger resource.
        :param pulumi.Input[builtins.str] event_meta_name: The name of the Event.
        :param pulumi.Input[builtins.str] event_meta_version: The version of the Event.
        :param pulumi.Input[builtins.str] notes: The Note information.
        :param pulumi.Input[builtins.str] role_arn: The role authorized by RAM. The value formats as `acs:ram::{AccountID}:role/{RoleName}`.
        :param pulumi.Input[builtins.str] source_arn: Resources and filters for event listening. The value formats as `acs:cdn:{RegionID}:{AccountID}:{Filter}`.
        :param pulumi.Input[builtins.str] trigger_arn: The trigger corresponding to the function Compute Service. The value formats as `acs:fc:{RegionID}:{AccountID}:{Filter}`. See [Create a CDN Fc Trigger](https://www.alibabacloud.com/help/en/cdn/developer-reference/api-cdn-2018-05-10-addfctrigger) for more details.
        :param pulumi.Input[builtins.str] function_arn: The function arn. The value formats as `acs:fc:{RegionID}:{AccountID}:{Filter}`.
        """
    ...
    def event_meta_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def event_meta_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "event_meta_name", value)

    @property
    @pulumi.getter(name="eventMetaVersion")
    def event_meta_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def event_meta_version(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "event_meta_version", value)

    @property
    @pulumi.getter
    def notes(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @notes.setter
    def notes(self, value: pulumi.Input[builtins.str]):
    ...
    def trigger_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @trigger_arn.setter
    def trigger_arn(self, value: pulumi.Input[builtins.str]):
...
class _FcTriggerState:
    def __init__(__self__, *,
                 event_meta_name: Optional[pulumi.Input[builtins.str]] = None,
                 event_meta_version: Optional[pulumi.Input[builtins.str]] = None,
                 function_arn: Optional[pulumi.Input[builtins.str]] = None,
                 notes: Optional[pulumi.Input[builtins.str]] = None,
                 role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 source_arn: Optional[pulumi.Input[builtins.str]] = None,
                 trigger_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="eventMetaName")
    def event_meta_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Event.
        """
        return pulumi.get(self, "event_meta_name")
    ...
    @event_meta_name.setter
    def event_meta_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_meta_name", value)

    @property
    @pulumi.getter(name="eventMetaVersion")
    def event_meta_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The version of the Event.
        """
        return pulumi.get(self, "event_meta_version")
    ...
    @event_meta_version.setter
    def event_meta_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_meta_version", value)
    ...
    @property
    @pulumi.getter(name="triggerArn")
    def trigger_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The trigger corresponding to the function Compute Service. The value formats as `acs:fc:{RegionID}:{AccountID}:{Filter}`. See [Create a CDN Fc Trigger](https://www.alibabacloud.com/help/en/cdn/developer-reference/api-cdn-2018-05-10-addfctrigger) for more details.
        """
        return pulumi.get(self, "trigger_arn")
    ...
    @trigger_arn.setter
    def trigger_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trigger_arn", value)
...
class FcTrigger(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role_arn: Optional[pulumi.Input[builtins.str]] = None,
            source_arn: Optional[pulumi.Input[builtins.str]] = None,
            trigger_arn: Optional[pulumi.Input[builtins.str]] = None) -> 'FcTrigger':
        """
    ...
    @property
    @pulumi.getter(name="eventMetaName")
    def event_meta_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Event.
        """
        return pulumi.get(self, "event_meta_name")
    ...
    @property
    @pulumi.getter(name="eventMetaVersion")
    def event_meta_version(self) -> pulumi.Output[builtins.str]:
        """
        The version of the Event.
        """
        return pulumi.get(self, "event_meta_version")
    ...
    @property
    @pulumi.getter(name="functionArn")
    def function_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The function arn. The value formats as `acs:fc:{RegionID}:{AccountID}:{Filter}`.
        """
        return pulumi.get(self, "function_arn")
    ...
    @property
    @pulumi.getter(name="triggerArn")
    def trigger_arn(self) -> pulumi.Output[builtins.str]:
        """
        The trigger corresponding to the function Compute Service. The value formats as `acs:fc:{RegionID}:{AccountID}:{Filter}`. See [Create a CDN Fc Trigger](https://www.alibabacloud.com/help/en/cdn/developer-reference/api-cdn-2018-05-10-addfctrigger) for more details.
        """
        return pulumi.get(self, "trigger_arn")
