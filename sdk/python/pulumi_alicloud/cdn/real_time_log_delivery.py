...
class RealTimeLogDeliveryArgs:
    def __init__(__self__, *,
                 ...
                 sls_region: pulumi.Input[builtins.str],
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RealTimeLogDelivery resource.
        :param pulumi.Input[builtins.str] domain: The accelerated domain name for which you want to disable real-time log delivery. You can specify multiple domain names and separate them with commas (,).
        :param pulumi.Input[builtins.str] logstore: The ID of the region where the Log Service project is deployed. You can specify multiple region IDs and separate them with commas (,).
        ...
        :param pulumi.Input[builtins.str] project: The name of the Logstore that collects log data from Alibaba Cloud CDN in real time. You can specify multiple Logstore names and separate them with commas (,).
        :param pulumi.Input[builtins.str] sls_region: The ID of the region where the Log Service project is deployed. For more information, see [Regions that support real-time log delivery](https://www.alibabacloud.com/help/en/doc-detail/144883.html).
    ...
    def sls_region(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sls_region.setter
    def sls_region(self, value: pulumi.Input[builtins.str]):
...
class RealTimeLogDelivery(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            sls_region: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'RealTimeLogDelivery':
        """
    ...
    @property
    @pulumi.getter(name="slsRegion")
    def sls_region(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the region where the Log Service project is deployed. For more information, see [Regions that support real-time log delivery](https://www.alibabacloud.com/help/en/doc-detail/144883.html).
        """
        return pulumi.get(self, "sls_region")
