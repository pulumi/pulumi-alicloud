...
class DomainNewArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cdn_type: Cdn type of the accelerated domain. Valid values are `web`, `download`, `video`.
        ...
        :param pulumi.Input[builtins.str] check_url: Health test URL.
        :param pulumi.Input[builtins.str] env: Whether to issue a certificate in grayscale. Value: staging: issued certificate in grayscale. Not passing or passing any other value is a formal certificate.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] scope: Scope of the accelerated domain. Valid values are `domestic`, `overseas`, `global`. Default value is `domestic`. This parameter's setting is valid Only for the international users and domestic L3 and above users. Value:
        :param pulumi.Input[builtins.str] status: The status of the resource, valid values: `online`, `offline`.
...
class DomainNew(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sources: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DomainNewSourceArgs', 'DomainNewSourceArgsDict']]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'DomainNew':
        """
