...
if not MYPY:
    class DomainAuthConfigArgsDict(TypedDict):
        ...
        master_key: NotRequired[pulumi.Input[builtins.str]]
        slave_key: NotRequired[pulumi.Input[builtins.str]]
...
class DomainAuthConfigArgs:
    def __init__(__self__, *,
                 ...
                 master_key: Optional[pulumi.Input[builtins.str]] = None,
                 slave_key: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def master_key(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "master_key")

    @master_key.setter
    def master_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "master_key", value)

    @property
    @pulumi.getter(name="slaveKey")
    def slave_key(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "slave_key")

    @slave_key.setter
    def slave_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DomainCacheConfigArgsDict(TypedDict):
        cache_content: pulumi.Input[builtins.str]
        cache_type: pulumi.Input[builtins.str]
        ttl: pulumi.Input[builtins.int]
        cache_id: NotRequired[pulumi.Input[builtins.str]]
...
class DomainCacheConfigArgs:
    def __init__(__self__, *,
                 ...
                 cache_type: pulumi.Input[builtins.str],
                 ttl: pulumi.Input[builtins.int],
                 cache_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def cache_content(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "cache_content")

    @cache_content.setter
    def cache_content(self, value: pulumi.Input[builtins.str]):
    ...
    def cache_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "cache_id")

    @cache_id.setter
    def cache_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DomainCertificateConfigArgsDict(TypedDict):
        ...
        server_certificate: NotRequired[pulumi.Input[builtins.str]]
        server_certificate_status: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class DomainCertificateConfigArgs:
    def __init__(__self__, *,
                 ...
                 server_certificate_status: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def server_certificate_status(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "server_certificate_status")

    @server_certificate_status.setter
    def server_certificate_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DomainConfigFunctionArgArgsDict(TypedDict):
        ...
        The name of arg.
        """
        arg_value: pulumi.Input[builtins.str]
        """
        The value of arg.
        """
elif False:
...
class DomainConfigFunctionArgArgs:
    def __init__(__self__, *,
                 ...
                 arg_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] arg_name: The name of arg.
        :param pulumi.Input[builtins.str] arg_value: The value of arg.
        """
    ...
    def arg_value(self) -> pulumi.Input[builtins.str]:
        """
        The value of arg.
        """
    ...
    @arg_value.setter
    def arg_value(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "arg_value", value)


if not MYPY:
    class DomainHttpHeaderConfigArgsDict(TypedDict):
        header_key: pulumi.Input[builtins.str]
        header_value: pulumi.Input[builtins.str]
        header_id: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class DomainHttpHeaderConfigArgs:
    def __init__(__self__, *,
                 header_key: pulumi.Input[builtins.str],
                 header_value: pulumi.Input[builtins.str],
                 header_id: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def header_key(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "header_key")

    @header_key.setter
    def header_key(self, value: pulumi.Input[builtins.str]):
    ...
    def header_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "header_id")

    @header_id.setter
    def header_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DomainNewCertificateConfigArgsDict(TypedDict):
        ...
        """
        cert_region: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DomainNewCertificateConfigArgs:
    def __init__(__self__, *,
                 ...
                 cert_region: Optional[pulumi.Input[builtins.str]] = None,
                 cert_type: Optional[pulumi.Input[builtins.str]] = None,
                 private_key: Optional[pulumi.Input[builtins.str]] = None,
                 server_certificate: Optional[pulumi.Input[builtins.str]] = None,
                 server_certificate_status: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cert_id: The ID of the certificate. It takes effect only when CertType = cas.
        :param pulumi.Input[builtins.str] cert_name: Certificate name, only flyer names are supported.
        :param pulumi.Input[builtins.str] cert_region: The certificate region, which takes effect only when CertType = cas, supports cn-hangzhou (domestic) and ap-southeast-1 (International), and is cn-hangzhou by default.
        :param pulumi.Input[builtins.str] cert_type: Certificate type. Value:
               - **upload**: upload certificate.
               - **cas**: Cloud Shield certificate.
               - **free**: free certificate.
               > If the certificate type is **cas**, **PrivateKey** does not need to pass parameters.
        :param pulumi.Input[builtins.str] private_key: The content of the private key. If the certificate is not enabled, you do not need to enter the content of the private key. To configure the certificate, enter the content of the private key.
        :param pulumi.Input[builtins.str] server_certificate: The content of the security certificate. If the certificate is not enabled, you do not need to enter the content of the security certificate. Please enter the content of the certificate to configure the certificate.
        :param pulumi.Input[builtins.str] server_certificate_status: Whether the HTTPS certificate is enabled. Value:
               - **on**(default): enabled.
               - **off** : not enabled.
        """
    ...
    def cert_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The certificate region, which takes effect only when CertType = cas, supports cn-hangzhou (domestic) and ap-southeast-1 (International), and is cn-hangzhou by default.
        """
    ...
    @cert_region.setter
    def cert_region(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DomainNewSourceArgs:
    def __init__(__self__, *,
                 ...
                 weight: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] content: The address of source. Valid values can be ip or doaminName. Each item's `content` can not be repeated.
        :param pulumi.Input[builtins.int] port: The port of source. Valid values are `443` and `80`. Default value is `80`.
        :param pulumi.Input[builtins.int] priority: Priority of the source. Valid values are `0` and `100`. Default value is `20`.
        :param pulumi.Input[builtins.str] type: The type of the source. Valid values are `ipaddr`, `domain` and `oss`.
        :param pulumi.Input[builtins.int] weight: Weight of the source. Valid values are from `0` to `100`. Default value is `10`, but if type is `ipaddr`, the value can only be `10`.
        """
...
if not MYPY:
    class DomainPage404ConfigArgsDict(TypedDict):
        custom_page_url: NotRequired[pulumi.Input[builtins.str]]
        error_code: NotRequired[pulumi.Input[builtins.str]]
        page_type: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class DomainPage404ConfigArgs:
    def __init__(__self__, *,
                 custom_page_url: Optional[pulumi.Input[builtins.str]] = None,
                 error_code: Optional[pulumi.Input[builtins.str]] = None,
                 page_type: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def custom_page_url(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "custom_page_url")

    @custom_page_url.setter
    def custom_page_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def page_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "page_type")

    @page_type.setter
    def page_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "page_type", value)


if not MYPY:
    class DomainParameterFilterConfigArgsDict(TypedDict):
        enable: NotRequired[pulumi.Input[builtins.str]]
        hash_key_args: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
elif False:
...
class DomainParameterFilterConfigArgs:
    def __init__(__self__, *,
                 enable: Optional[pulumi.Input[builtins.str]] = None,
                 hash_key_args: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
    ...
    @property
    @pulumi.getter
    def enable(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "enable")

    @enable.setter
    def enable(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "enable", value)

    @property
    @pulumi.getter(name="hashKeyArgs")
    def hash_key_args(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "hash_key_args")

    @hash_key_args.setter
    def hash_key_args(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "hash_key_args", value)


if not MYPY:
    class DomainReferConfigArgsDict(TypedDict):
        refer_lists: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        allow_empty: NotRequired[pulumi.Input[builtins.str]]
        refer_type: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class DomainReferConfigArgs:
    def __init__(__self__, *,
                 refer_lists: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 allow_empty: Optional[pulumi.Input[builtins.str]] = None,
                 refer_type: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def refer_lists(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "refer_lists")

    @refer_lists.setter
    def refer_lists(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "refer_lists", value)

    @property
    @pulumi.getter(name="allowEmpty")
    def allow_empty(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "allow_empty")

    @allow_empty.setter
    def allow_empty(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "allow_empty", value)

    @property
    @pulumi.getter(name="referType")
    def refer_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "refer_type")

    @refer_type.setter
    def refer_type(self, value: Optional[pulumi.Input[builtins.str]]):
