...
def get_real_time_log_deliveries(domain: Optional[builtins.str] = None,
...
def get_real_time_log_deliveries_output(domain: Optional[pulumi.Input[builtins.str]] = None,
