...
def get_prometheus(enable_details: Optional[builtins.bool] = None,
...
def get_prometheus_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
