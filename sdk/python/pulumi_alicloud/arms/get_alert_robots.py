...
class GetAlertRobotsResult:
    ...
    def alert_robot_name(self) -> Optional[builtins.str]:
    ...
    def robot_type(self) -> Optional[builtins.str]:
        """
...
def get_alert_robots(alert_robot_name: Optional[builtins.str] = None,
    ...
    :param builtins.str alert_robot_name: The robot name.
    :param Sequence[builtins.str] ids: A list of Alert Robot IDs.
    :param builtins.str name_regex: A regex string to filter results by Alert Robot name.
...
def get_alert_robots_output(alert_robot_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            ...
                            robot_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
