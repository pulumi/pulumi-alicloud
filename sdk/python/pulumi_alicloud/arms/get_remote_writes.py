...
def get_remote_writes(cluster_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Remote Write IDs.
    :param builtins.str name_regex: A regex string to filter results by Remote Write name.
...
def get_remote_writes_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
