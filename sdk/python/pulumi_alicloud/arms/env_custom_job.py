...
class EnvCustomJobArgs:
    def __init__(__self__, *,
                 ...
                 env_custom_job_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] env_custom_job_name: Custom job name.
        :param pulumi.Input[builtins.str] environment_id: Environment id.
        :param pulumi.Input[builtins.str] aliyun_lang: The locale. The default is Chinese zh | en.
    ...
    def env_custom_job_name(self) -> pulumi.Input[builtins.str]:
        """
        Custom job name.
        """
    ...
    def env_custom_job_name(self, value: pulumi.Input[builtins.str]):
...
class _EnvCustomJobState:
    def __init__(__self__, *,
                 ...
                 env_custom_job_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="envCustomJobName")
    def env_custom_job_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Custom job name.
        """
        return pulumi.get(self, "env_custom_job_name")
    ...
    @env_custom_job_name.setter
    def env_custom_job_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "env_custom_job_name", value)
...
class EnvCustomJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            env_custom_job_name: Optional[pulumi.Input[builtins.str]] = None,
            environment_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'EnvCustomJob':
        """
    ...
    @property
    @pulumi.getter(name="envCustomJobName")
    def env_custom_job_name(self) -> pulumi.Output[builtins.str]:
        """
        Custom job name.
        """
        return pulumi.get(self, "env_custom_job_name")
