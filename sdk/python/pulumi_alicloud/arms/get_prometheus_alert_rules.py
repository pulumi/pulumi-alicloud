...
class GetPrometheusAlertRulesResult:
    ...
    def match_expressions(self) -> Optional[builtins.str]:
...
def get_prometheus_alert_rules(cluster_id: Optional[builtins.str] = None,
                               ids: Optional[Sequence[builtins.str]] = None,
                               match_expressions: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Prometheus Alert Rule IDs.
    :param builtins.str name_regex: A regex string to filter results by Prometheus Alert Rule name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.int status: The status of the resource. Valid values: `0`, `1`.
    :param builtins.str type: The type of the alert rule.
    """
    __args__ = dict()
...
def get_prometheus_alert_rules_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                                      ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                      match_expressions: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetPrometheusAlertRulesResult(
        ...
        match_expressions=pulumi.get(__response__, 'match_expressions'),
