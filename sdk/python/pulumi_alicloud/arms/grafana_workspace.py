...
class GrafanaWorkspaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] grafana_version: The version of the grafana.
        :param pulumi.Input[builtins.str] grafana_workspace_edition: The edition of the grafana.
...
class GrafanaWorkspace(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="grafanaWorkspaceName")
    def grafana_workspace_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "grafana_workspace_name")
