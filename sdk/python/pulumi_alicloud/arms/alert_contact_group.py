...
class AlertContactGroupArgs:
    def __init__(__self__, *,
                 alert_contact_group_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] alert_contact_group_name: The name of the resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contact_ids: The list id of alert contact.
        """
    ...
    def alert_contact_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def alert_contact_group_name(self, value: pulumi.Input[builtins.str]):
...
class _AlertContactGroupState:
    def __init__(__self__, *,
                 alert_contact_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 contact_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="alertContactGroupName")
    def alert_contact_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "alert_contact_group_name")
    ...
    @alert_contact_group_name.setter
    def alert_contact_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alert_contact_group_name", value)
...
class AlertContactGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            alert_contact_group_name: Optional[pulumi.Input[builtins.str]] = None,
            contact_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'AlertContactGroup':
        """
    ...
    @property
    @pulumi.getter(name="alertContactGroupName")
    def alert_contact_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "alert_contact_group_name")
    ...
    @property
    @pulumi.getter(name="contactIds")
    def contact_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list id of alert contact.
        """
        return pulumi.get(self, "contact_ids")
