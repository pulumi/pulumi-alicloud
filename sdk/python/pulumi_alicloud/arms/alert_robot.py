...
class AlertRobotArgs:
    def __init__(__self__, *,
                 alert_robot_name: pulumi.Input[builtins.str],
                 robot_addr: pulumi.Input[builtins.str],
                 robot_type: pulumi.Input[builtins.str],
                 daily_noc: Optional[pulumi.Input[builtins.bool]] = None,
                 daily_noc_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a AlertRobot resource.
        :param pulumi.Input[builtins.str] alert_robot_name: The name of the resource.
        :param pulumi.Input[builtins.str] robot_addr: The webhook url of the robot.
        :param pulumi.Input[builtins.str] robot_type: The type of the robot, Valid values: `wechat`, `dingding`, `feishu`.
        :param pulumi.Input[builtins.bool] daily_noc: Specifies whether the alert robot receives daily notifications. Valid values: `true`: receives daily notifications. `false`: does not receive daily notifications, default to `false`.
        :param pulumi.Input[builtins.str] daily_noc_time: The time of the daily notification.
        """
    ...
    def alert_robot_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def alert_robot_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "alert_robot_name", value)

    @property
    @pulumi.getter(name="robotAddr")
    def robot_addr(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @robot_addr.setter
    def robot_addr(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "robot_addr", value)

    @property
    @pulumi.getter(name="robotType")
    def robot_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @robot_type.setter
    def robot_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "robot_type", value)

    @property
    @pulumi.getter(name="dailyNoc")
    def daily_noc(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @daily_noc.setter
    def daily_noc(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "daily_noc", value)

    @property
    @pulumi.getter(name="dailyNocTime")
    def daily_noc_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def daily_noc_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AlertRobotState:
    def __init__(__self__, *,
                 alert_robot_name: Optional[pulumi.Input[builtins.str]] = None,
                 daily_noc: Optional[pulumi.Input[builtins.bool]] = None,
                 daily_noc_time: Optional[pulumi.Input[builtins.str]] = None,
                 robot_addr: Optional[pulumi.Input[builtins.str]] = None,
                 robot_type: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="alertRobotName")
    def alert_robot_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "alert_robot_name")
    ...
    @alert_robot_name.setter
    def alert_robot_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alert_robot_name", value)
    ...
    @property
    @pulumi.getter(name="robotAddr")
    def robot_addr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The webhook url of the robot.
        """
        return pulumi.get(self, "robot_addr")
    ...
    @robot_addr.setter
    def robot_addr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "robot_addr", value)

    @property
    @pulumi.getter(name="robotType")
    def robot_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the robot, Valid values: `wechat`, `dingding`, `feishu`.
        """
        return pulumi.get(self, "robot_type")
    ...
    @robot_type.setter
    def robot_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "robot_type", value)
...
class AlertRobot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            daily_noc_time: Optional[pulumi.Input[builtins.str]] = None,
            robot_addr: Optional[pulumi.Input[builtins.str]] = None,
            robot_type: Optional[pulumi.Input[builtins.str]] = None) -> 'AlertRobot':
        """
    ...
    @property
    @pulumi.getter(name="alertRobotName")
    def alert_robot_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "alert_robot_name")
    ...
    @property
    @pulumi.getter(name="dailyNoc")
    def daily_noc(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the alert robot receives daily notifications. Valid values: `true`: receives daily notifications. `false`: does not receive daily notifications, default to `false`.
        """
        return pulumi.get(self, "daily_noc")
    ...
    @property
    @pulumi.getter(name="dailyNocTime")
    def daily_noc_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time of the daily notification.
        """
        return pulumi.get(self, "daily_noc_time")
    ...
    @property
    @pulumi.getter(name="robotAddr")
    def robot_addr(self) -> pulumi.Output[builtins.str]:
        """
        The webhook url of the robot.
        """
        return pulumi.get(self, "robot_addr")
    ...
    @property
    @pulumi.getter(name="robotType")
    def robot_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the robot, Valid values: `wechat`, `dingding`, `feishu`.
        """
        return pulumi.get(self, "robot_type")
