...
class DispatchRuleGroupRule(dict):
    ...
    def __init__(__self__, *,
                 group_interval: builtins.int,
                 group_wait_time: builtins.int,
                 grouping_fields: Sequence[builtins.str],
                 group_id: Optional[builtins.int] = None,
                 repeat_interval: Optional[builtins.int] = None):
        """
        :param builtins.int group_interval: The duration for which the system waits after the first alert is sent. After the duration, all alerts are sent in a single notification to the handler.
        :param builtins.int group_wait_time: The duration for which the system waits after the first alert is sent. After the duration, all alerts are sent in a single notification to the handler.
        :param Sequence[builtins.str] grouping_fields: The fields that are used to group events. Events with the same field content are assigned to a group. Alerts with the same specified grouping field are sent to the handler in separate notifications.
        :param builtins.int group_id: The ID of the group rule.
        :param builtins.int repeat_interval: The silence period of repeated alerts. All alerts are repeatedly sent at specified intervals until the alerts are cleared. The minimum value is 61. Default to 600.
        """
    ...
    def group_interval(self) -> builtins.int:
        """
    ...
    def group_wait_time(self) -> builtins.int:
        """
        The duration for which the system waits after the first alert is sent. After the duration, all alerts are sent in a single notification to the handler.
        """
    ...
    def grouping_fields(self) -> Sequence[builtins.str]:
        """
    ...
    def repeat_interval(self) -> Optional[builtins.int]:
        """
...
class DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroupLabelMatchExpression(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: The key of the tag of the dispatch rule. Valid values:
        ...
        :param builtins.str operator: The operator used in the dispatch rule. Valid values: 
               * eq: equals to.
...
class DispatchRuleNotifyRule(dict):
    ...
    def __init__(__self__, *,
                 notify_channels: Sequence[builtins.str],
                 notify_end_time: builtins.str,
                 notify_objects: Sequence['outputs.DispatchRuleNotifyRuleNotifyObject'],
                 notify_start_time: builtins.str):
        """
        :param Sequence[builtins.str] notify_channels: The notification method. Valid values: dingTalk, sms, webhook, email, and wechat.
        :param builtins.str notify_end_time: End time of notification.
        ...
        :param builtins.str notify_start_time: Start time of notification.
        """
    ...
    def notify_channels(self) -> Sequence[builtins.str]:
        """
    ...
    def notify_end_time(self) -> builtins.str:
        """
    ...
    def notify_start_time(self) -> builtins.str:
        """
...
class DispatchRuleNotifyRuleNotifyObject(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 notify_object_id: builtins.str,
                 notify_type: builtins.str):
        """
        :param builtins.str name: The name of the contact or contact group.
        :param builtins.str notify_object_id: The ID of the contact or contact group.
        :param builtins.str notify_type: The type of the alert contact. Valid values: ARMS_ROBOT: robot. ARMS_CONTACT: contact. ARMS_CONTACT_GROUP: contact group.
        """
    ...
    def notify_object_id(self) -> builtins.str:
        """
    ...
    def notify_type(self) -> builtins.str:
        """
...
class DispatchRuleNotifyTemplate(dict):
    ...
    def __init__(__self__, *,
                 email_content: builtins.str,
                 email_recover_content: builtins.str,
                 email_recover_title: builtins.str,
                 email_title: builtins.str,
                 robot_content: builtins.str,
                 sms_content: builtins.str,
                 sms_recover_content: builtins.str,
                 tts_content: builtins.str,
                 tts_recover_content: builtins.str):
        """
        :param builtins.str email_content: The content of the email notification.
        :param builtins.str email_recover_content: The content of the email notification for restored alerts.
        :param builtins.str email_recover_title: The title of the email notification for restored alerts.
        :param builtins.str email_title: The title of the email notification.
        :param builtins.str robot_content: The content of the robot notification.
        :param builtins.str sms_content: The content of the SMS notification.
        :param builtins.str sms_recover_content: The content of the SMS notification for restored alerts.
        :param builtins.str tts_content: The content of the TTS notification.
        :param builtins.str tts_recover_content: The content of the TTS notification for restored alerts.
        """
    ...
    def email_content(self) -> builtins.str:
        """
    ...
    def email_recover_content(self) -> builtins.str:
        """
    ...
    def email_recover_title(self) -> builtins.str:
        """
    ...
    def email_title(self) -> builtins.str:
        """
    ...
    def robot_content(self) -> builtins.str:
        """
    ...
    def sms_content(self) -> builtins.str:
        """
    ...
    def sms_recover_content(self) -> builtins.str:
        """
    ...
    def tts_content(self) -> builtins.str:
        """
    ...
    def tts_recover_content(self) -> builtins.str:
        """
...
class PrometheusAlertRuleAnnotation(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the annotation.
        :param builtins.str value: The value of the annotation.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class PrometheusAlertRuleLabel(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the label.
...
class SyntheticTaskAvailableAssertion(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str expect: Expected value.
        :param builtins.str operator: Condition: gt: greater than; gte: greater than or equal to; lt: less than; te: less than or equal to; eq: equal to; neq: not equal to; ctn: contains; nctn: does not contain; exist: exists; n_exist: does not exist; belong: belongs to; reg_match: regular matching.
        :param builtins.str type: Assertion type, including: httpresead, httpresead, HttpResBody, HttpResBodyJson, httpressetime, IcmpPackLoss (packet loss rate), IcmpPackMaxLatency (maximum packet delay ms), icmppackwebscreen, fmppackavglatency (average delay rendering), TraceRouteHops (number of hops), dnsarecname, websiteOnload (full load time), see the supplement below for specific use.
        :param builtins.str target: Check the target. If the target is HttpResCode, HttpResBody, or httpressetime, you do not need to specify the target. If the target is HttpResHead, you need to specify the key in the header. If the target is HttpResHead, you need to use jsonPath.
        """
...
class SyntheticTaskCommonSetting(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ip_type: Optional[builtins.int] = None,
                 is_open_trace: Optional[builtins.bool] = None,
                 monitor_samples: Optional[builtins.int] = None,
                 trace_client_type: Optional[builtins.int] = None,
                 xtrace_region: Optional[builtins.str] = None):
        """
        :param 'SyntheticTaskCommonSettingCustomHostArgs' custom_host: Custom host. See `custom_host` below.
        :param builtins.int ip_type: IpType.
        :param builtins.bool is_open_trace: Whether to enable link tracking.
        :param builtins.int monitor_samples: Whether the monitoring samples are evenly distributed:
               - 0: No
               1: Yes.
        :param builtins.int trace_client_type: Link trace client type:
               - 0:ARMS Agent
               - 1:OpenTelemetry
               - 2:Jaeger.
        :param builtins.str xtrace_region: The link data is reported to the region.
        """
    ...
    def ip_type(self) -> Optional[builtins.int]:
        """
        IpType.
        """
    ...
    def is_open_trace(self) -> Optional[builtins.bool]:
        """
    ...
    def monitor_samples(self) -> Optional[builtins.int]:
        """
    ...
    def trace_client_type(self) -> Optional[builtins.int]:
        """
    ...
    def xtrace_region(self) -> Optional[builtins.str]:
        """
...
class SyntheticTaskCommonSettingCustomHost(dict):
    ...
    def select_type(self) -> builtins.int:
        """
        Selection method:
        - 0: Random
        - 1: Polling.
...
class SyntheticTaskCommonSettingCustomHostHost(dict):
    ...
    def __init__(__self__, *,
                 domain: builtins.str,
                 ip_type: builtins.int,
                 ips: Sequence[builtins.str]):
        """
        :param builtins.str domain: Domain Name.
        :param builtins.int ip_type: IpType.
        :param Sequence[builtins.str] ips: The IP list.
        """
...
class SyntheticTaskCustomPeriod(dict):
    ...
    def __init__(__self__, *,
                 end_hour: Optional[builtins.int] = None,
                 start_hour: Optional[builtins.int] = None):
        """
        :param builtins.int end_hour: End hours, 0-24.
        :param builtins.int start_hour: Starting hours, 0-24.
        """
    ...
    def end_hour(self) -> Optional[builtins.int]:
        """
        End hours, 0-24.
        """
...
class SyntheticTaskMonitor(dict):
    ...
    def __init__(__self__, *,
                 ...
                 operator_code: builtins.str):
        """
        :param builtins.str city_code: The city code of monitor.
        :param builtins.int client_type: The type of monitor.
        :param builtins.str operator_code: The operator code of monitor.
        """
    ...
    def client_type(self) -> builtins.int:
        """
        The type of monitor.
        """
    ...
    def operator_code(self) -> builtins.str:
        """
...
class SyntheticTaskMonitorConfApiHttp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str target_url: The target URL.
        :param builtins.int connect_timeout: Connection timeout, in ms. Default 5000. Optional range: 1000-300000ms.
        :param builtins.str method: HTTP method, GET or POST.
        :param 'SyntheticTaskMonitorConfApiHttpRequestBodyArgs' request_body: HTTP request body. See `request_body` below.
        :param Mapping[str, builtins.str] request_headers: HTTP request header.
        :param builtins.int timeout: TCP dial test timeout. The unit is milliseconds (ms), the minimum value is 1000, the maximum value is 300000, and the default value is 20000.
        """
...
class SyntheticTaskMonitorConfApiHttpRequestBody(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str content: The request body content, in JSON string format. When the type is text/plain,application/json,application/xml,text/html, the content can be converted to a JSON string.
        """
...
class SyntheticTaskMonitorConfFileDownload(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_header_content: Optional[Mapping[str, builtins.str]] = None,
                 download_kernel: Optional[builtins.int] = None,
                 ignore_certificate_auth_error: Optional[builtins.int] = None,
                 ignore_certificate_canceled_error: Optional[builtins.int] = None,
                 ignore_certificate_out_of_date_error: Optional[builtins.int] = None,
                 ignore_certificate_status_error: Optional[builtins.int] = None,
                 ignore_certificate_untrustworthy_error: Optional[builtins.int] = None,
                 ignore_certificate_using_error: Optional[builtins.int] = None,
                 ignore_invalid_host_error: Optional[builtins.int] = None,
                 monitor_timeout: Optional[builtins.int] = None,
                 quick_protocol: Optional[builtins.int] = None,
                 redirection: Optional[builtins.int] = None,
                 transmission_size: Optional[builtins.int] = None,
                 validate_keywords: Optional[builtins.str] = None,
                 verify_way: Optional[builtins.int] = None,
                 white_list: Optional[builtins.str] = None):
        """
        :param builtins.str target_url: The target URL.
        :param builtins.int connection_timeout: Connection timeout time, in ms. Default 5000. Optional range: 1000-120000ms.
        :param Mapping[str, builtins.str] custom_header_content: Custom header, in JSON Map format.
        :param builtins.int download_kernel: Download the kernel.
               - 1:curl
               - 0:WinInet
               Default 1.
        :param builtins.int ignore_certificate_auth_error: Ignore CA Certificate authorization error 0: Do not ignore, 1: ignore, default 1.
        :param builtins.int ignore_certificate_canceled_error: Ignore certificate revocation error 0: Do not ignore, 1: ignore, default 1.
        :param builtins.int ignore_certificate_out_of_date_error: Ignore certificate expiration error 0: not ignored, 1: Ignored, default 1.
        :param builtins.int ignore_certificate_status_error: The certificate status error is ignored. 0: Do not ignore, 1: IGNORE. The default value is 1.
        :param builtins.int ignore_certificate_untrustworthy_error: The certificate cannot be trusted and ignored. 0: Do not ignore, 1: IGNORE. The default value is 1.
        :param builtins.int ignore_certificate_using_error: Ignore certificate usage error 0: Do not ignore, 1: ignore, default 1.
        :param builtins.int ignore_invalid_host_error: Invalid host error ignored, 0: not ignored, 1: Ignored, default 1.
        :param builtins.int monitor_timeout: Monitoring timeout, in ms. Not required, 20000 by default.
        :param builtins.int quick_protocol: Quick agreement
               - 1:http1
               - 2:http2
               - 3:http3
               Default 1.
        :param builtins.int redirection: When redirection occurs, whether to continue browsing, 0-No, 1-Yes, the default is 1.
        :param builtins.int transmission_size: The transmission size, in KB. The default value is 2048KB. The transmission size of the downloaded file must be between 1 and 20480KB.
        :param builtins.str validate_keywords: Verify keywords.
        :param builtins.int verify_way: The verification method.
               - 0: Do not validate
               - 1: Validation string
               - 2:MD5 validation.
        :param builtins.str white_list: DNS hijack whitelist. Match rules support IP, IP wildcard, subnet mask, and CNAME. Multiple match rules can be filled in. Multiple match rules are separated by vertical bars (|). For example, www.aliyun.com:203.0.3.55 | 203.3.44.67 indicates that all other IP addresses under the www.aliyun.com domain except 203.0.3.55 and 203.3.44.67 are hijacked.
        """
        pulumi.set(__self__, "target_url", target_url)
    ...
    def custom_header_content(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def download_kernel(self) -> Optional[builtins.int]:
        """
        Download the kernel.
        - 1:curl
        - 0:WinInet
    ...
    def ignore_certificate_auth_error(self) -> Optional[builtins.int]:
        """
    ...
    def ignore_certificate_canceled_error(self) -> Optional[builtins.int]:
        """
    ...
    def ignore_certificate_out_of_date_error(self) -> Optional[builtins.int]:
        """
    ...
    def ignore_certificate_status_error(self) -> Optional[builtins.int]:
        """
    ...
    def ignore_certificate_untrustworthy_error(self) -> Optional[builtins.int]:
        """
    ...
    def ignore_certificate_using_error(self) -> Optional[builtins.int]:
        """
    ...
    def ignore_invalid_host_error(self) -> Optional[builtins.int]:
        """
    ...
    def monitor_timeout(self) -> Optional[builtins.int]:
        """
    ...
    def quick_protocol(self) -> Optional[builtins.int]:
        """
        Quick agreement
        - 1:http1
        - 2:http2
    ...
    @property
    @pulumi.getter
    def redirection(self) -> Optional[builtins.int]:
        """
    ...
    def transmission_size(self) -> Optional[builtins.int]:
        """
    ...
    def validate_keywords(self) -> Optional[builtins.str]:
        """
        Verify keywords.
        """
    ...
    def verify_way(self) -> Optional[builtins.int]:
        """
    ...
    def white_list(self) -> Optional[builtins.str]:
        """
...
class SyntheticTaskMonitorConfNetDns(dict):
    ...
    def __init__(__self__, *,
                 target_url: builtins.str,
                 dns_server_ip_type: Optional[builtins.int] = None,
                 ns_server: Optional[builtins.str] = None,
                 query_method: Optional[builtins.int] = None,
                 timeout: Optional[builtins.int] = None):
        """
        :param builtins.str target_url: The target URL.
        :param builtins.int dns_server_ip_type: The IP address type of the DNS server.
               - 0 (default):ipv4
               - 1:ipv6
               2: Automatic.
        :param builtins.str ns_server: The IP address of the NS server. The default value is 114.114.114.114.
        :param builtins.int query_method: DNS query method.
               - 0 (default): Recursive
               - 1: Iteration.
        :param builtins.int timeout: TCP dial test timeout. The unit is milliseconds (ms), the minimum value is 1000, the maximum value is 300000, and the default value is 20000.
        """
    ...
    def dns_server_ip_type(self) -> Optional[builtins.int]:
        """
    ...
    def ns_server(self) -> Optional[builtins.str]:
        """
    ...
    def query_method(self) -> Optional[builtins.int]:
        """
        DNS query method.
        - 0 (default): Recursive
        - 1: Iteration.
...
class SyntheticTaskMonitorConfNetIcmp(dict):
    ...
    def __init__(__self__, *,
                 ...
                 package_num: Optional[builtins.int] = None,
                 package_size: Optional[builtins.int] = None,
                 split_package: Optional[builtins.bool] = None,
                 timeout: Optional[builtins.int] = None,
                 tracert_enable: Optional[builtins.bool] = None,
                 tracert_num_max: Optional[builtins.int] = None,
                 tracert_timeout: Optional[builtins.int] = None):
        """
        :param builtins.str target_url: The target URL.
        :param builtins.int interval: The interval between TCP connections. The unit is milliseconds (ms), the minimum value is 200, the maximum value is 10000, and the default value is 200.
        :param builtins.int package_num: Number of ICMP(Ping) packets sent. The minimum value is 1, the maximum value is 50, and the default is 4.
        :param builtins.int package_size: The size of the sent ICMP(Ping) packet. The unit is byte. The ICMP(PING) packet size is limited to 32, 64, 128, 256, 512, 1024, 1080, and 1450.
        :param builtins.bool split_package: Whether to split ICMP(Ping) packets. The default is true.
        :param builtins.int timeout: TCP dial test timeout. The unit is milliseconds (ms), the minimum value is 1000, the maximum value is 300000, and the default value is 20000.
        :param builtins.bool tracert_enable: Whether to enable tracert. The default is true.
        :param builtins.int tracert_num_max: The maximum number of hops for tracert. The minimum value is 1, the maximum value is 128, and the default value is 20.
        :param builtins.int tracert_timeout: The time-out of tracert. The unit is milliseconds (ms), the minimum value is 1000, the maximum value is 300000, and the default value is 60000.
        """
        pulumi.set(__self__, "target_url", target_url)
    ...
    def package_num(self) -> Optional[builtins.int]:
        """
    ...
    def package_size(self) -> Optional[builtins.int]:
        """
    ...
    def split_package(self) -> Optional[builtins.bool]:
        """
    ...
    def tracert_enable(self) -> Optional[builtins.bool]:
        """
    ...
    def tracert_num_max(self) -> Optional[builtins.int]:
        """
    ...
    def tracert_timeout(self) -> Optional[builtins.int]:
        """
...
class SyntheticTaskMonitorConfNetTcp(dict):
    ...
    def __init__(__self__, *,
                 target_url: builtins.str,
                 connect_times: Optional[builtins.int] = None,
                 interval: Optional[builtins.int] = None,
                 timeout: Optional[builtins.int] = None,
                 tracert_enable: Optional[builtins.bool] = None,
                 tracert_num_max: Optional[builtins.int] = None,
        ...
        """
        :param builtins.str target_url: The target URL.
        :param builtins.int connect_times: The number of TCP connections established. The minimum value is 1, the maximum value is 16, and the default is 4.
        :param builtins.int interval: The interval between TCP connections. The unit is milliseconds (ms), the minimum value is 200, the maximum value is 10000, and the default value is 200.
        :param builtins.int timeout: TCP dial test timeout. The unit is milliseconds (ms), the minimum value is 1000, the maximum value is 300000, and the default value is 20000.
        :param builtins.bool tracert_enable: Whether to enable tracert. The default is true.
        :param builtins.int tracert_num_max: The maximum number of hops for tracert. The minimum value is 1, the maximum value is 128, and the default value is 20.
    ...
    def connect_times(self) -> Optional[builtins.int]:
        """
...
class SyntheticTaskMonitorConfStream(dict):
    ...
    def __init__(__self__, *,
                 custom_header_content: Optional[Mapping[str, builtins.str]] = None,
                 player_type: Optional[builtins.int] = None,
                 stream_address_type: Optional[builtins.int] = None,
                 stream_monitor_timeout: Optional[builtins.int] = None,
                 stream_type: Optional[builtins.int] = None,
                 target_url: Optional[builtins.str] = None,
                 white_list: Optional[builtins.str] = None):
        """
        :param Mapping[str, builtins.str] custom_header_content: Custom header, in JSON Map format.
        :param builtins.int player_type: Player, do not pass the default 12.
               - 12:VLC
               - 2:FlashPlayer.
        :param builtins.int stream_address_type: Resource address type:
               - 1: Resource address.
               - 0: page address, not 0 by default.
        :param builtins.int stream_monitor_timeout: Monitoring duration, in seconds, up to 60s, not 60 by default.
        :param builtins.int stream_type: Audio and video flags: 0-video, 1-audio.
        :param builtins.str target_url: The target URL.
        :param builtins.str white_list: DNS hijack whitelist. Match rules support IP, IP wildcard, subnet mask, and CNAME. Multiple match rules can be filled in. Multiple match rules are separated by vertical bars (|). For example, www.aliyun.com:203.0.3.55 | 203.3.44.67 indicates that all other IP addresses under the www.aliyun.com domain except 203.0.3.55 and 203.3.44.67 are hijacked.
        """
        if custom_header_content is not None:
    ...
    def player_type(self) -> Optional[builtins.int]:
        """
    ...
    def stream_address_type(self) -> Optional[builtins.int]:
        """
    ...
    def stream_monitor_timeout(self) -> Optional[builtins.int]:
        """
    ...
    def stream_type(self) -> Optional[builtins.int]:
        """
...
class SyntheticTaskMonitorConfWebsite(dict):
    ...
    def __init__(__self__, *,
                 target_url: builtins.str,
                 automatic_scrolling: Optional[builtins.int] = None,
                 custom_header: Optional[builtins.int] = None,
                 custom_header_content: Optional[Mapping[str, builtins.str]] = None,
                 disable_cache: Optional[builtins.int] = None,
                 disable_compression: Optional[builtins.int] = None,
                 dns_hijack_whitelist: Optional[builtins.str] = None,
                 element_blacklist: Optional[builtins.str] = None,
                 filter_invalid_ip: Optional[builtins.int] = None,
                 flow_hijack_jump_times: Optional[builtins.int] = None,
                 flow_hijack_logo: Optional[builtins.str] = None,
                 ignore_certificate_error: Optional[builtins.int] = None,
                 monitor_timeout: Optional[builtins.int] = None,
                 page_tamper: Optional[builtins.str] = None,
                 redirection: Optional[builtins.int] = None,
                 slow_element_threshold: Optional[builtins.int] = None,
                 verify_string_blacklist: Optional[builtins.str] = None,
                 verify_string_whitelist: Optional[builtins.str] = None,
                 wait_completion_time: Optional[builtins.int] = None):
        """
        :param builtins.str target_url: The target URL.
        :param builtins.int automatic_scrolling: Whether to support automatic scrolling screen, loading page.
               - 0 (default): No
               1: Yes.
        :param builtins.int custom_header: Custom header.
               - 0 (default): Off
               - 1: Modify the first package
               - 2: Modify all packages.
        :param Mapping[str, builtins.str] custom_header_content: Custom header, in JSON Map format.
        :param builtins.int disable_cache: Whether to disable caching.
               - 0: not disabled
               - 1 (default): Disabled.
        :param builtins.int disable_compression: The Accept-Encoding field is used to determine whether to Accept compressed files. 0-do not disable, 1-disable, the default is 0.
        :param builtins.str dns_hijack_whitelist: When a domain name (such as www.aliyun.com) is resolved, if the resolved IP address or CNAME is not in the DNS hijacking white list, the user will fail to access or return a target IP address that is not Aliyun. If the IP or CNAME in the resolution result is in the DNS white list, it will be determined that DNS hijacking has not occurred.  Fill in the format: Domain name: matching rules. Match rules support IP, IP wildcard, subnet mask, and CNAME. Multiple match rules can be filled in. Multiple match rules are separated by vertical bars (|). For example, www.aliyun.com:203.0.3.55 | 203.3.44.67 indicates that all other IP addresses under the www.aliyun.com domain except 203.0.3.55 and 203.3.44.67 are hijacked.
        :param builtins.str element_blacklist: If an element configured in the element blacklist appears during page loading, the element is not requested to be loaded.
        :param builtins.int filter_invalid_ip: Whether to filter invalid IP parameters. 0: filter, 1: do not filter. The default value is 0.
        :param builtins.int flow_hijack_jump_times: Identify elements: Set the total number of elements on the Browse page.
        :param builtins.str flow_hijack_logo: Hijacking ID: Set the matching key information. Enter the hijacking keyword or key element, with an asterisk (*) allowed.
        :param builtins.int ignore_certificate_error: Whether to ignore certificate errors during certificate verification in SSL Handshake and continue browsing. 0-do not ignore, 1-ignore. The default value is 1.
        :param builtins.int monitor_timeout: Monitoring timeout, in ms. Not required, 20000 by default.
        :param builtins.str page_tamper: Monitoring the page appears to be tampered with elements other than the domain settings that belong to the page. Common manifestations are pop-up advertisements, floating advertisements, jumps, etc.  Fill in the format: Domain name: Element. You can fill multiple elements separated by a vertical bar (|). For example, www.aliyun.com:|/cc/bb/a.gif |/vv/bb/cc.jpg indicates that all the other elements of the www.aliyun.com domain name except the basic document,/cc/bb/a.gif, and/vv/bb/cc.jpg are tampered.
        :param builtins.int redirection: When redirection occurs, whether to continue browsing, 0-No, 1-Yes, the default is 1.
        :param builtins.int slow_element_threshold: The slow element threshold, in ms, is 5000 by default and can be selected from 1 to 300000ms.
        :param builtins.str verify_string_blacklist: The verification string is an arbitrary string in the source code of the monitoring page. If the source code returned by the client contains any of the blacklisted strings, 650 error is returned. Multiple strings are separated by a vertical bar (|).
        :param builtins.str verify_string_whitelist: The verification string is an arbitrary string in the source code of the monitoring page. The source code returned by the client must contain all the strings in the whitelist. Otherwise, 650 error is returned. Multiple strings are separated by a vertical bar (|).
        :param builtins.int wait_completion_time: The maximum waiting time, in ms, is 5000 by default and can be selected from 5000 ms to 300000ms.
        """
        pulumi.set(__self__, "target_url", target_url)
    ...
    def automatic_scrolling(self) -> Optional[builtins.int]:
        """
    ...
    def custom_header(self) -> Optional[builtins.int]:
        """
        Custom header.
        - 0 (default): Off
        - 1: Modify the first package
    ...
    def disable_cache(self) -> Optional[builtins.int]:
        """
    ...
    def disable_compression(self) -> Optional[builtins.int]:
        """
    ...
    def dns_hijack_whitelist(self) -> Optional[builtins.str]:
        """
    ...
    def element_blacklist(self) -> Optional[builtins.str]:
        """
    ...
    def filter_invalid_ip(self) -> Optional[builtins.int]:
        """
    ...
    def flow_hijack_jump_times(self) -> Optional[builtins.int]:
        """
    ...
    def flow_hijack_logo(self) -> Optional[builtins.str]:
        """
    ...
    def ignore_certificate_error(self) -> Optional[builtins.int]:
        """
    ...
    def page_tamper(self) -> Optional[builtins.str]:
        """
    ...
    def slow_element_threshold(self) -> Optional[builtins.int]:
        """
    ...
    def verify_string_blacklist(self) -> Optional[builtins.str]:
        """
    ...
    def verify_string_whitelist(self) -> Optional[builtins.str]:
        """
    ...
    def wait_completion_time(self) -> Optional[builtins.int]:
        """
...
class GetAlertContactGroupsGroupResult(dict):
    def __init__(__self__, *,
                 alert_contact_group_id: builtins.str,
                 alert_contact_group_name: builtins.str,
                 contact_ids: Sequence[builtins.str],
                 create_time: builtins.str,
                 id: builtins.str):
        """
        :param builtins.str alert_contact_group_id: The first ID of the resource.
        :param builtins.str alert_contact_group_name: The name of the resource.
        :param Sequence[builtins.str] contact_ids: contact ids.
        :param builtins.str create_time: The creation time of the resource.
        :param builtins.str id: The ID of the Alert Contact Group.
        """
    ...
    def alert_contact_group_id(self) -> builtins.str:
        """
    ...
    def alert_contact_group_name(self) -> builtins.str:
        """
...
class GetAlertContactsContactResult(dict):
    def __init__(__self__, *,
                 alert_contact_id: builtins.str,
                 alert_contact_name: builtins.str,
                 create_time: builtins.str,
                 ding_robot_webhook_url: builtins.str,
                 email: builtins.str,
                 id: builtins.str,
                 phone_num: builtins.str,
                 system_noc: builtins.bool,
                 webhook: builtins.str):
        """
        :param builtins.str alert_contact_id: Contact ID.
        :param builtins.str alert_contact_name: The name of the alert contact.
        :param builtins.str create_time: The Creation Time Timestamp.
        :param builtins.str ding_robot_webhook_url: The webhook URL of the DingTalk chatbot.
        :param builtins.str email: The email address of the alert contact.
        :param builtins.str id: The ID of the Alert Contact.
        :param builtins.str phone_num: The mobile number of the alert contact.
        :param builtins.bool system_noc: Specifies whether the alert contact receives system notifications.
        :param builtins.str webhook: Webhook Information.
        """
    ...
    def alert_contact_id(self) -> builtins.str:
        """
        Contact ID.
        """
    ...
    def alert_contact_name(self) -> builtins.str:
        """
    ...
    def ding_robot_webhook_url(self) -> builtins.str:
        """
    ...
    def phone_num(self) -> builtins.str:
        """
    ...
    def system_noc(self) -> builtins.bool:
        """
...
class GetAlertRobotsRobotResult(dict):
    def __init__(__self__, *,
                 create_time: builtins.str,
                 daily_noc: builtins.str,
                 daily_noc_time: builtins.str,
                 id: builtins.str,
                 robot_addr: builtins.str,
                 robot_id: builtins.str,
                 robot_name: builtins.str,
                 robot_type: builtins.str):
        """
        :param builtins.str create_time: The creation time of the resource.
        :param builtins.str daily_noc: Specifies whether the alert robot receives daily notifications.
        :param builtins.str daily_noc_time: The time of the daily notification.
        :param builtins.str id: The ID of the Alert Robot.
        :param builtins.str robot_addr: The webhook url of the robot.
        :param builtins.str robot_id: The id of the robot.
        :param builtins.str robot_name: The name of the robot.
        :param builtins.str robot_type: The robot type.
        """
        pulumi.set(__self__, "create_time", create_time)
    ...
    def daily_noc(self) -> builtins.str:
        """
    ...
    def daily_noc_time(self) -> builtins.str:
        """
    ...
    def robot_addr(self) -> builtins.str:
        """
    ...
    def robot_id(self) -> builtins.str:
        """
        The id of the robot.
        """
    ...
    def robot_name(self) -> builtins.str:
        """
    ...
    def robot_type(self) -> builtins.str:
        """
        The robot type.
        """
...
class GetDispatchRulesRuleResult(dict):
    def __init__(__self__, *,
                 dispatch_rule_id: builtins.str,
                 dispatch_rule_name: builtins.str,
                 ...
                 status: builtins.str):
        """
        :param builtins.str dispatch_rule_id: Dispatch rule ID.
        ...
        :param builtins.str id: The ID of the Dispatch Rule.
        ...
        :param builtins.str status: The resource status of Alert Dispatch Rule.
        """
    ...
    def dispatch_rule_id(self) -> builtins.str:
        """
        Dispatch rule ID.
        """
    ...
    def dispatch_rule_name(self) -> builtins.str:
        """
...
class GetDispatchRulesRuleGroupRuleResult(dict):
    ...
    @property
    @pulumi.getter(name="repeatInterval")
    def repeat_interval(self) -> builtins.int:
        """
        The silence period of repeated alerts. All alerts are repeatedly sent at specified intervals until the alerts are cleared. The minimum value is 61. Default to 600.
        """
        return pulumi.get(self, "repeat_interval")
...
class GetDispatchRulesRuleLabelMatchExpressionGridLabelMatchExpressionGroupLabelMatchExpressionResult(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: The key of the tag of the dispatch rule.
        :param builtins.str operator: The operator used in the dispatch rule.
        :param builtins.str value: The value of the tag.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "operator", operator)
...
class GetDispatchRulesRuleNotifyRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 notify_start_time: builtins.str):
        """
        :param Sequence[builtins.str] notify_channels: A list of notification methods.
        :param builtins.str notify_end_time: (Available since v1.237.0) End time of notification.
        :param Sequence['GetDispatchRulesRuleNotifyRuleNotifyObjectArgs'] notify_objects: Sets the notification object.
        :param builtins.str notify_start_time: (Available since v1.237.0) Start time of notification.
        """
        pulumi.set(__self__, "notify_channels", notify_channels)
        pulumi.set(__self__, "notify_end_time", notify_end_time)
        pulumi.set(__self__, "notify_objects", notify_objects)
...
class GetDispatchRulesRuleNotifyRuleNotifyObjectResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the contact or contact group.
        :param builtins.str notify_object_id: The ID of the contact or contact group.
        :param builtins.str notify_type: The type of the alert contact.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "notify_object_id", notify_object_id)
        pulumi.set(__self__, "notify_type", notify_type)
...
class GetDispatchRulesRuleNotifyTemplateResult(dict):
    def __init__(__self__, *,
                 ...
                 tts_recover_content: builtins.str):
        """
        :param builtins.str email_content: The content of the email.
        :param builtins.str email_recover_content: The content of the email.
        :param builtins.str email_recover_title: The title of the email.
        :param builtins.str email_title: The title of the email.
        :param builtins.str robot_content: The content of the robot.
        :param builtins.str sms_content: The content of the SMS.
        :param builtins.str sms_recover_content: The content of the SMS.
        :param builtins.str tts_content: The content of the TTS.
        :param builtins.str tts_recover_content: The content of the TTS.
        """
        pulumi.set(__self__, "email_content", email_content)
        pulumi.set(__self__, "email_recover_content", email_recover_content)
        pulumi.set(__self__, "email_recover_title", email_recover_title)
...
class GetIntegrationExportersIntegrationExporterResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str exporter_type: Integration Exporter Type.
        :param builtins.str id: The ID of the Integration Exporter. It formats as `<cluster_id>:<integration_type>:<instance_id>`.
        :param builtins.int instance_id: The ID of the Integration Exporter instance.
        :param builtins.str instance_name: The name of the instance.
        :param builtins.str integration_type: The type of prometheus integration.
        :param builtins.str param: Exporter configuration parameter json string.
        :param builtins.str target: Monitor the target address.
        :param builtins.str version: The version information.
        """
    ...
    def exporter_type(self) -> builtins.str:
        """
...
class GetPrometheisPrometheiResult(dict):
    def __init__(__self__, *,
                 ...
                 grafana_instance_id: builtins.str,
                 http_api_inter_url: builtins.str,
                 http_api_intra_url: builtins.str,
                 id: builtins.str,
                 push_gate_way_inter_url: builtins.str,
                 push_gate_way_intra_url: builtins.str,
                 remote_read_inter_url: builtins.str,
                 remote_read_intra_url: builtins.str,
                 remote_write_inter_url: builtins.str,
                 remote_write_intra_url: builtins.str,
                 resource_group_id: builtins.str,
                 security_group_id: builtins.str,
                 sub_clusters_json: builtins.str,
                 tags: Mapping[str, builtins.str],
                 vpc_id: builtins.str,
                 vswitch_id: builtins.str):
        """
        :param builtins.str auth_token: The token used to access the data source.
        :param builtins.str cluster_id: The ID of the cluster.
        :param builtins.str cluster_name: The name of the cluster.
        :param builtins.str cluster_type: The type of the cluster.
        :param builtins.str grafana_instance_id: The ID of the Grafana workspace.
        :param builtins.str http_api_inter_url: Http api public network address.
        :param builtins.str http_api_intra_url: Http api intranet address.
        :param builtins.str id: The ID of the Prometheus.
        :param builtins.str push_gate_way_inter_url: PushGateway public network Url.
        :param builtins.str push_gate_way_intra_url: PushGateway intranet Url.
        :param builtins.str remote_read_inter_url: Public Url of remoteRead.
        :param builtins.str remote_read_intra_url: RemoteRead intranet Url.
        :param builtins.str remote_write_inter_url: RemoteWrite public Url.
        :param builtins.str remote_write_intra_url: RemoteWrite Intranet Url.
        ...
        :param builtins.str sub_clusters_json: The child instance json string of the globalView instance.
    ...
    def grafana_instance_id(self) -> builtins.str:
        """
    ...
    def http_api_inter_url(self) -> builtins.str:
        """
    ...
    def http_api_intra_url(self) -> builtins.str:
        """
    ...
    def push_gate_way_inter_url(self) -> builtins.str:
        """
    ...
    def push_gate_way_intra_url(self) -> builtins.str:
        """
    ...
    def remote_read_inter_url(self) -> builtins.str:
        """
    ...
    def remote_read_intra_url(self) -> builtins.str:
        """
    ...
    def remote_write_inter_url(self) -> builtins.str:
        """
    ...
    def remote_write_intra_url(self) -> builtins.str:
        """
    ...
    def sub_clusters_json(self) -> builtins.str:
        """
...
class GetPrometheusAlertRulesRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 notify_type: builtins.str,
                 prometheus_alert_rule_id: builtins.str,
                 prometheus_alert_rule_name: builtins.str,
                 status: builtins.int,
                 type: builtins.str):
        """
        :param Sequence['GetPrometheusAlertRulesRuleAnnotationArgs'] annotations: The annotations of the alert rule.
        :param builtins.str cluster_id: The ID of the cluster.
        :param builtins.str dispatch_rule_id: The ID of the notification policy. This parameter is required when the `notify_type` parameter is set to `DISPATCH_RULE`.
        :param builtins.str duration: The duration of the alert.
        :param builtins.str expression: The alert rule expression that follows the PromQL syntax..
        :param builtins.str id: The ID of the Prometheus Alert Rule.
        :param Sequence['GetPrometheusAlertRulesRuleLabelArgs'] labels: The labels of the resource.
        :param builtins.str message: The message of the alert notification.
        :param builtins.str notify_type: The method of sending the alert notification. Valid values: `ALERT_MANAGER`, `DISPATCH_RULE`.
        :param builtins.str prometheus_alert_rule_id: The first ID of the resource.
        :param builtins.str prometheus_alert_rule_name: The name of the resource.
    ...
    def prometheus_alert_rule_id(self) -> builtins.str:
        """
        The first ID of the resource.
        """
    ...
    def prometheus_alert_rule_name(self) -> builtins.str:
        """
        The name of the resource.
        """
...
class GetPrometheusAlertRulesRuleAnnotationResult(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The value of the annotation.
        :param builtins.str value: The name of the annotation name.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class GetPrometheusMonitoringsPrometheusMonitoringResult(dict):
    def __init__(__self__, *,
                 cluster_id: builtins.str,
                 config_yaml: builtins.str,
                 id: builtins.str,
                 monitoring_name: builtins.str,
                 status: builtins.str,
                 type: builtins.str):
        """
        :param builtins.str cluster_id: The ID of the Prometheus instance.
        :param builtins.str config_yaml: The monitoring configuration. The value is a YAML string.
        :param builtins.str id: The ID of the Prometheus Monitoring. It formats as `<cluster_id>:<monitoring_name>:<type>`.
        :param builtins.str monitoring_name: The name of the monitoring configuration.
    ...
    def config_yaml(self) -> builtins.str:
        """
    ...
    def monitoring_name(self) -> builtins.str:
        """
...
class GetPrometheusPrometheiResult(dict):
    def __init__(__self__, *,
                 ...
                 vswitch_id: builtins.str):
        """
        :param builtins.str auth_token: (Available since v1.214.0) The authorization token. **Note:** `auth_token` takes effect only if `enable_details` is set to `true`.
        :param builtins.str cluster_id: The ID of the cluster.
        :param builtins.str cluster_name: The name of the cluster.
        :param builtins.str cluster_type: The type of the cluster.
        :param builtins.str grafana_instance_id: The ID of the Grafana workspace.
        :param builtins.str http_api_inter_url: (Available since v1.214.0) The public URL for the HTTP API. **Note:** `http_api_inter_url` takes effect only if `enable_details` is set to `true`.
        :param builtins.str http_api_intra_url: (Available since v1.214.0) The internal URL for the HTTP API. **Note:** `http_api_intra_url` takes effect only if `enable_details` is set to `true`.
        :param builtins.str id: The ID of the Prometheus.
        :param builtins.str push_gate_way_inter_url: (Available since v1.214.0) The public URL for Pushgateway. **Note:** `push_gate_way_inter_url` takes effect only if `enable_details` is set to `true`.
        :param builtins.str push_gate_way_intra_url: (Available since v1.214.0) The internal URL for Pushgateway. **Note:** `push_gate_way_intra_url` takes effect only if `enable_details` is set to `true`.
        :param builtins.str remote_read_inter_url: (Available since v1.214.0) The public URL for remote read. **Note:** `remote_read_inter_url` takes effect only if `enable_details` is set to `true`.
        :param builtins.str remote_read_intra_url: (Available since v1.214.0) The internal URL for remote read. **Note:** `remote_read_intra_url` takes effect only if `enable_details` is set to `true`.
        :param builtins.str remote_write_inter_url: (Available since v1.214.0) The public URL for remote write. **Note:** `remote_write_inter_url` takes effect only if `enable_details` is set to `true`.
        :param builtins.str remote_write_intra_url: (Available since v1.214.0) The internal URL for remote write. **Note:** `remote_write_intra_url` takes effect only if `enable_details` is set to `true`.
        :param builtins.str resource_group_id: The ID of the resource group.
        :param builtins.str security_group_id: The ID of the security group.
        :param builtins.str sub_clusters_json: The child instance json string of the globalView instance.
        :param Mapping[str, builtins.str] tags: A mapping of tags to assign to the resource.
...
class GetRemoteWritesRemoteWriteResult(dict):
    def __init__(__self__, *,
                 cluster_id: builtins.str,
                 id: builtins.str,
                 remote_write_name: builtins.str,
                 remote_write_yaml: builtins.str):
        """
        :param builtins.str cluster_id: The ID of the Prometheus instance.
        :param builtins.str id: The ID of the Remote Write. It formats as `<cluster_id>:<remote_write_name>`.
        :param builtins.str remote_write_name: The name of the Remote Write configuration item.
        :param builtins.str remote_write_yaml: The details of the Remote Write configuration item. The value is in the YAML format.
        """
        pulumi.set(__self__, "cluster_id", cluster_id)
        pulumi.set(__self__, "id", id)
    ...
    def remote_write_name(self) -> builtins.str:
        """
    ...
    def remote_write_yaml(self) -> builtins.str:
        """
