...
class EnvServiceMonitorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] config_yaml: Yaml configuration string.
        :param pulumi.Input[builtins.str] environment_id: Environment id.
        :param pulumi.Input[builtins.str] aliyun_lang: Language environment, default is Chinese zh | en.
        """
...
class _EnvServiceMonitorState:
    def __init__(__self__, *,
                 ...
                 env_service_monitor_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] aliyun_lang: Language environment, default is Chinese zh | en.
        :param pulumi.Input[builtins.str] config_yaml: Yaml configuration string.
        :param pulumi.Input[builtins.str] env_service_monitor_name: The name of the resource.
        :param pulumi.Input[builtins.str] environment_id: Environment id.
        :param pulumi.Input[builtins.str] namespace: The namespace where the resource is located.
        :param pulumi.Input[builtins.str] status: Status: run, stop.
        """
        if aliyun_lang is not None:
            pulumi.set(__self__, "aliyun_lang", aliyun_lang)
    ...
    def env_service_monitor_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def env_service_monitor_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EnvServiceMonitor(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:arms/envServiceMonitor:EnvServiceMonitor"
    ...
    def get(resource_name: str,
            ...
            environment_id: Optional[pulumi.Input[builtins.str]] = None,
            namespace: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'EnvServiceMonitor':
        """
    ...
    @property
    @pulumi.getter(name="envServiceMonitorName")
    def env_service_monitor_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "env_service_monitor_name")
