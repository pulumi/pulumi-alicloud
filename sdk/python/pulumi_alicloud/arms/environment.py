...
class EnvironmentArgs:
    def __init__(__self__, *,
                 environment_sub_type: pulumi.Input[builtins.str],
                 environment_type: pulumi.Input[builtins.str],
                 aliyun_lang: Optional[pulumi.Input[builtins.str]] = None,
                 bind_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 drop_metrics: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] environment_sub_type: Subtype of environment:
        ...
        :param pulumi.Input[builtins.str] environment_type: Type of environment.
        :param pulumi.Input[builtins.str] aliyun_lang: The locale. The default is Chinese zh | en.
        :param pulumi.Input[builtins.str] bind_resource_id: The id or vpcId of the bound container instance.
        :param pulumi.Input[builtins.str] drop_metrics: List of abandoned indicators.
        :param pulumi.Input[builtins.str] environment_name: The name of the resource.
        :param pulumi.Input[builtins.str] managed_type: Hosting type:
    ...
    def environment_sub_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def environment_sub_type(self, value: pulumi.Input[builtins.str]):
    ...
    def bind_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bind_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bind_resource_id", value)

    @property
    @pulumi.getter(name="dropMetrics")
    def drop_metrics(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @drop_metrics.setter
    def drop_metrics(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EnvironmentState:
    def __init__(__self__, *,
                 ...
                 environment_name: Optional[pulumi.Input[builtins.str]] = None,
                 environment_sub_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="environmentSubType")
    def environment_sub_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Subtype of environment:
        - Type of CS: ACK is currently supported. ManagedKubernetes, Kubernetes, ExternalKubernetes, and One are also supported.
        - Type of ECS: currently supports ECS.
    ...
    @environment_sub_type.setter
    def environment_sub_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "environment_sub_type", value)
...
class Environment(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:arms/environment:Environment"
    ...
    def get(resource_name: str,
            ...
            managed_type: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Environment':
        """
    ...
    @property
    @pulumi.getter(name="bindResourceId")
    def bind_resource_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The id or vpcId of the bound container instance.
        """
        return pulumi.get(self, "bind_resource_id")
    ...
    @property
    @pulumi.getter(name="dropMetrics")
    def drop_metrics(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        List of abandoned indicators.
        """
        return pulumi.get(self, "drop_metrics")
    ...
    @property
    @pulumi.getter(name="environmentSubType")
    def environment_sub_type(self) -> pulumi.Output[builtins.str]:
        """
        Subtype of environment:
        - Type of CS: ACK is currently supported. ManagedKubernetes, Kubernetes, ExternalKubernetes, and One are also supported.
        - Type of ECS: currently supports ECS.
