...
class RemoteWriteArgs:
    def __init__(__self__, *,
                 ...
                 remote_write_yaml: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] remote_write_yaml: The details of the Remote Write configuration item. Specify the value in the YAML format.
        """
    ...
    def remote_write_yaml(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def remote_write_yaml(self, value: pulumi.Input[builtins.str]):
...
class _RemoteWriteState:
    def __init__(__self__, *,
                 ...
                 remote_write_name: Optional[pulumi.Input[builtins.str]] = None,
                 remote_write_yaml: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering RemoteWrite resources.
        :param pulumi.Input[builtins.str] cluster_id: The ID of the Prometheus instance.
        :param pulumi.Input[builtins.str] remote_write_name: The name of the Remote Write configuration item.
        :param pulumi.Input[builtins.str] remote_write_yaml: The details of the Remote Write configuration item. Specify the value in the YAML format.
        """
    ...
    def remote_write_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def remote_write_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "remote_write_name", value)

    @property
    @pulumi.getter(name="remoteWriteYaml")
    def remote_write_yaml(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The details of the Remote Write configuration item. Specify the value in the YAML format.
        """
        return pulumi.get(self, "remote_write_yaml")
    ...
    @remote_write_yaml.setter
    def remote_write_yaml(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "remote_write_yaml", value)
...
class RemoteWrite(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cluster_id: Optional[pulumi.Input[builtins.str]] = None,
            remote_write_name: Optional[pulumi.Input[builtins.str]] = None,
            remote_write_yaml: Optional[pulumi.Input[builtins.str]] = None) -> 'RemoteWrite':
        """
    ...
    @property
    @pulumi.getter(name="remoteWriteName")
    def remote_write_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Remote Write configuration item.
        """
        return pulumi.get(self, "remote_write_name")
    ...
    @property
    @pulumi.getter(name="remoteWriteYaml")
    def remote_write_yaml(self) -> pulumi.Output[builtins.str]:
        """
        The details of the Remote Write configuration item. Specify the value in the YAML format.
        """
        return pulumi.get(self, "remote_write_yaml")
