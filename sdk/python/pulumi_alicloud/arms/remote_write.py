...
class RemoteWriteArgs:
    ...
    def remote_write_yaml(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def remote_write_yaml(self, value: pulumi.Input[_builtins.str]):
...
class RemoteWrite(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        default_switch = alicloud.vpc.Switch("default",
            ...
            zone_id=len(default.zones).apply(lambda length: default.zones[length - 1]).id)
    ...
    @_builtins.property
    @pulumi.getter(name="remoteWriteName")
    def remote_write_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the Remote Write configuration item.
        """
        return pulumi.get(self, "remote_write_name")
    ...
    @_builtins.property
    @pulumi.getter(name="remoteWriteYaml")
    def remote_write_yaml(self) -> pulumi.Output[_builtins.str]:
        """
        The details of the Remote Write configuration item. Specify the value in the YAML format.
        """
        return pulumi.get(self, "remote_write_yaml")
