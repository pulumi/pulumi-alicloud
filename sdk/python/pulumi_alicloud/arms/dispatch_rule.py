...
class DispatchRuleArgs:
    def __init__(__self__, *,
                 dispatch_rule_name: pulumi.Input[builtins.str],
                 ...
                 dispatch_type: Optional[pulumi.Input[builtins.str]] = None,
                 is_recover: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] dispatch_rule_name: The name of the dispatch policy.
        ...
        :param pulumi.Input[builtins.str] dispatch_type: The alert handling method. Valid values: CREATE_ALERT: generates an alert. DISCARD_ALERT: discards the alert event and generates no alert.
        :param pulumi.Input[builtins.bool] is_recover: Specifies whether to send the restored alert. Valid values: true: sends the alert. false: does not send the alert.
    ...
    def dispatch_rule_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dispatch_rule_name(self, value: pulumi.Input[builtins.str]):
    ...
    def dispatch_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dispatch_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dispatch_type", value)

    @property
    @pulumi.getter(name="isRecover")
    def is_recover(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_recover.setter
    def is_recover(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DispatchRuleState:
    def __init__(__self__, *,
                 dispatch_rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 dispatch_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DispatchRuleNotifyRuleArgs']]] notify_rules: Sets the notification rule. See `notify_rules` below. It will be ignored  when `dispatch_type = "DISCARD_ALERT"`.
        :param pulumi.Input[Sequence[pulumi.Input['DispatchRuleNotifyTemplateArgs']]] notify_templates: Sets the notification template. See `notify_template` below.
        :param pulumi.Input[builtins.str] status: The resource status of Alert Dispatch Rule.
        """
    ...
    @property
    @pulumi.getter(name="dispatchRuleName")
    def dispatch_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the dispatch policy.
        """
        return pulumi.get(self, "dispatch_rule_name")
    ...
    @dispatch_rule_name.setter
    def dispatch_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dispatch_rule_name", value)
...
class DispatchRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            notify_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DispatchRuleNotifyRuleArgs', 'DispatchRuleNotifyRuleArgsDict']]]]] = None,
            notify_templates: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DispatchRuleNotifyTemplateArgs', 'DispatchRuleNotifyTemplateArgsDict']]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'DispatchRule':
        """
    ...
    @property
    @pulumi.getter(name="dispatchRuleName")
    def dispatch_rule_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the dispatch policy.
        """
        return pulumi.get(self, "dispatch_rule_name")
    ...
    @property
    @pulumi.getter(name="dispatchType")
    def dispatch_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The alert handling method. Valid values: CREATE_ALERT: generates an alert. DISCARD_ALERT: discards the alert event and generates no alert.
        """
        return pulumi.get(self, "dispatch_type")
    ...
    @property
    @pulumi.getter(name="isRecover")
    def is_recover(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to send the restored alert. Valid values: true: sends the alert. false: does not send the alert.
        """
        return pulumi.get(self, "is_recover")
