...
class GetDispatchRulesResult:
    ...
    def dispatch_rule_name(self) -> Optional[builtins.str]:
        """
...
def get_dispatch_rules(dispatch_rule_name: Optional[builtins.str] = None,
    ...
    :param builtins.str dispatch_rule_name: The name of the dispatch rule.
    :param builtins.bool enable_details: Default to `false`. Set it to `true` can output more details about resource attributes.
    :param Sequence[builtins.str] ids: A list of dispatch rule id.
    :param builtins.str name_regex: A regex string to filter results by Dispatch Rule name.
...
def get_dispatch_rules_output(dispatch_rule_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
