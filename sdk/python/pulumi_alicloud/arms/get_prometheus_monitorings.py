...
def get_prometheus_monitorings(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: The ID of the Prometheus instance.
    :param Sequence[builtins.str] ids: A list of Prometheus Monitoring IDs.
    :param builtins.str name_regex: A regex string to filter results by Prometheus Monitoring name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the monitoring configuration. Valid values: `run`, `stop`.
    :param builtins.str type: The type of the monitoring configuration. Valid values: `serviceMonitor`, `podMonitor`, `customJob`, `probe`.
    """
    __args__ = dict()
...
def get_prometheus_monitorings_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
