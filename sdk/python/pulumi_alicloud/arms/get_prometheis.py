...
def get_prometheis(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.bool enable_details: Whether to query details about the instance.
    :param Sequence[builtins.str] ids: A list of Prometheus IDs.
    :param builtins.str name_regex: A regex string to filter results by Prometheus name.
...
def get_prometheis_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
