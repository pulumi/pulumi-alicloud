...
class IntegrationExporterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] integration_type: The type of prometheus integration.
        :param pulumi.Input[builtins.str] param: Exporter configuration parameter json string.
        """
...
class _IntegrationExporterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The ID of the Prometheus instance.
        :param pulumi.Input[builtins.int] instance_id: The ID of the Integration Exporter instance.
        :param pulumi.Input[builtins.str] integration_type: The type of prometheus integration.
        :param pulumi.Input[builtins.str] param: Exporter configuration parameter json string.
        """
...
class IntegrationExporter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.int]] = None,
            integration_type: Optional[pulumi.Input[builtins.str]] = None,
            param: Optional[pulumi.Input[builtins.str]] = None) -> 'IntegrationExporter':
        """
    ...
    @property
    @pulumi.getter
    def param(self) -> pulumi.Output[builtins.str]:
        """
        Exporter configuration parameter json string.
        """
        return pulumi.get(self, "param")
