...
def get_integration_exporters(cluster_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Integration Exporter IDs.
...
def get_integration_exporters_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
