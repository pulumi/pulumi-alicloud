...
class AlertContactArgs:
    def __init__(__self__, *,
                 alert_contact_name: Optional[pulumi.Input[builtins.str]] = None,
                 ding_robot_webhook_url: Optional[pulumi.Input[builtins.str]] = None,
                 email: Optional[pulumi.Input[builtins.str]] = None,
                 phone_num: Optional[pulumi.Input[builtins.str]] = None,
                 system_noc: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a AlertContact resource.
        :param pulumi.Input[builtins.str] alert_contact_name: The name of the alert contact.
        :param pulumi.Input[builtins.str] ding_robot_webhook_url: The webhook URL of the DingTalk chatbot. For more information about how to obtain the URL, see Configure a DingTalk chatbot to send alert notifications: https://www.alibabacloud.com/help/en/doc-detail/106247.htm. You must specify at least one of the following parameters: PhoneNum, Email, and DingRobotWebhookUrl.
        :param pulumi.Input[builtins.str] email: The email address of the alert contact. You must specify at least one of the following parameters: PhoneNum, Email, and DingRobotWebhookUrl.
        :param pulumi.Input[builtins.str] phone_num: The mobile number of the alert contact. You must specify at least one of the following parameters: PhoneNum, Email, and DingRobotWebhookUrl.
        :param pulumi.Input[builtins.bool] system_noc: Specifies whether the alert contact receives system notifications. Valid values:  true: receives system notifications. false: does not receive system notifications.
        """
    ...
    def alert_contact_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alert_contact_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alert_contact_name", value)

    @property
    @pulumi.getter(name="dingRobotWebhookUrl")
    def ding_robot_webhook_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ding_robot_webhook_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def phone_num(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @phone_num.setter
    def phone_num(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "phone_num", value)

    @property
    @pulumi.getter(name="systemNoc")
    def system_noc(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @system_noc.setter
    def system_noc(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AlertContact(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            email: Optional[pulumi.Input[builtins.str]] = None,
            phone_num: Optional[pulumi.Input[builtins.str]] = None,
            system_noc: Optional[pulumi.Input[builtins.bool]] = None) -> 'AlertContact':
        """
    ...
    @property
    @pulumi.getter(name="alertContactName")
    def alert_contact_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the alert contact.
        """
        return pulumi.get(self, "alert_contact_name")
    ...
    @property
    @pulumi.getter(name="dingRobotWebhookUrl")
    def ding_robot_webhook_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The webhook URL of the DingTalk chatbot. For more information about how to obtain the URL, see Configure a DingTalk chatbot to send alert notifications: https://www.alibabacloud.com/help/en/doc-detail/106247.htm. You must specify at least one of the following parameters: PhoneNum, Email, and DingRobotWebhookUrl.
        """
        return pulumi.get(self, "ding_robot_webhook_url")
    ...
    @property
    @pulumi.getter(name="phoneNum")
    def phone_num(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The mobile number of the alert contact. You must specify at least one of the following parameters: PhoneNum, Email, and DingRobotWebhookUrl.
        """
        return pulumi.get(self, "phone_num")
    ...
    @property
    @pulumi.getter(name="systemNoc")
    def system_noc(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the alert contact receives system notifications. Valid values:  true: receives system notifications. false: does not receive system notifications.
        """
        return pulumi.get(self, "system_noc")
