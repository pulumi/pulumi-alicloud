...
class EnvFeatureArgs:
    def __init__(__self__, *,
                 env_feature_name: pulumi.Input[builtins.str],
                 environment_id: pulumi.Input[builtins.str],
                 feature_version: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a EnvFeature resource.
        :param pulumi.Input[builtins.str] env_feature_name: The name of the resource.
        :param pulumi.Input[builtins.str] environment_id: The first ID of the resource.
        :param pulumi.Input[builtins.str] feature_version: Version information of the Feature. You can query Feature information by using ListEnvironmentFeatures.
        """
    ...
    def env_feature_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def env_feature_name(self, value: pulumi.Input[builtins.str]):
    ...
    def feature_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def feature_version(self, value: pulumi.Input[builtins.str]):
...
class _EnvFeatureState:
    def __init__(__self__, *,
                 env_feature_name: Optional[pulumi.Input[builtins.str]] = None,
                 environment_id: Optional[pulumi.Input[builtins.str]] = None,
                 feature_version: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="envFeatureName")
    def env_feature_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "env_feature_name")
    ...
    @env_feature_name.setter
    def env_feature_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "env_feature_name", value)
    ...
    @property
    @pulumi.getter(name="featureVersion")
    def feature_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Version information of the Feature. You can query Feature information by using ListEnvironmentFeatures.
        """
        return pulumi.get(self, "feature_version")
    ...
    @feature_version.setter
    def feature_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "feature_version", value)
...
class EnvFeature(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            feature_version: Optional[pulumi.Input[builtins.str]] = None,
            namespace: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'EnvFeature':
        """
    ...
    @property
    @pulumi.getter(name="envFeatureName")
    def env_feature_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "env_feature_name")
    ...
    @property
    @pulumi.getter(name="featureVersion")
    def feature_version(self) -> pulumi.Output[builtins.str]:
        """
        Version information of the Feature. You can query Feature information by using ListEnvironmentFeatures.
        """
        return pulumi.get(self, "feature_version")
