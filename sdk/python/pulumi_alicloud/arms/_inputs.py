...
class DispatchRuleGroupRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] grouping_fields: The fields that are used to group events. Events with the same field content are assigned to a group. Alerts with the same specified grouping field are sent to the handler in separate notifications.
        :param pulumi.Input[_builtins.int] group_id: The ID of the group rule.
        :param pulumi.Input[_builtins.int] repeat_interval: The silence period of repeated alerts. All alerts are repeatedly sent at specified intervals until the alerts are cleared. The minimum value is 61. Default to 600.
        """
    ...
    def group_wait_time(self) -> pulumi.Input[_builtins.int]:
        """
        The duration for which the system waits after the first alert is sent. After the duration, all alerts are sent in a single notification to the handler.
        """
    ...
    def group_wait_time(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "group_wait_time", value)

    @_builtins.property
    @pulumi.getter(name="groupingFields")
    def grouping_fields(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        The fields that are used to group events. Events with the same field content are assigned to a group. Alerts with the same specified grouping field are sent to the handler in separate notifications.
        """
    ...
    def grouping_fields(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class DispatchRuleLabelMatchExpressionGridLabelMatchExpressionGroupLabelMatchExpressionArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] key: The key of the tag of the dispatch rule. Valid values:
               * _aliyun_arms_userid: user ID
               * _aliyun_arms_involvedObject_kind: type of the associated object
               * _aliyun_arms_involvedObject_id: ID of the associated object
               * _aliyun_arms_involvedObject_name: name of the associated object
...
if not MYPY:
    class DispatchRuleNotifyRuleArgsDict(TypedDict):
        notify_channels: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
        """
        The notification method. Valid values: dingTalk, sms, webhook, email, and wechat.
        """
        notify_end_time: pulumi.Input[_builtins.str]
        """
        ...
        """
        notify_start_time: pulumi.Input[_builtins.str]
        """
...
class DispatchRuleNotifyRuleArgs:
    def __init__(__self__, *,
                 ...
                 notify_start_time: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] notify_channels: The notification method. Valid values: dingTalk, sms, webhook, email, and wechat.
        :param pulumi.Input[_builtins.str] notify_end_time: End time of notification.
        ...
        :param pulumi.Input[_builtins.str] notify_start_time: Start time of notification.
        """
    ...
    def notify_channels(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        The notification method. Valid values: dingTalk, sms, webhook, email, and wechat.
        """
    ...
    def notify_channels(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        pulumi.set(self, "notify_channels", value)

    @_builtins.property
    @pulumi.getter(name="notifyEndTime")
    def notify_end_time(self) -> pulumi.Input[_builtins.str]:
        """
        End time of notification.
        """
    ...
    def notify_end_time(self, value: pulumi.Input[_builtins.str]):
    ...
    def notify_start_time(self) -> pulumi.Input[_builtins.str]:
        """
        Start time of notification.
        """
    ...
    def notify_start_time(self, value: pulumi.Input[_builtins.str]):
...
if not MYPY:
    class DispatchRuleNotifyRuleNotifyObjectArgsDict(TypedDict):
        ...
        """
        notify_object_id: pulumi.Input[_builtins.str]
        """
...
class DispatchRuleNotifyRuleNotifyObjectArgs:
    def __init__(__self__, *,
                 ...
                 notify_type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] name: The name of the contact or contact group.
        :param pulumi.Input[_builtins.str] notify_object_id: The ID of the contact or contact group.
        :param pulumi.Input[_builtins.str] notify_type: The type of the alert contact. Valid values: ARMS_ROBOT: robot. ARMS_CONTACT: contact. ARMS_CONTACT_GROUP: contact group.
        """
    ...
    def notify_object_id(self) -> pulumi.Input[_builtins.str]:
        """
        The ID of the contact or contact group.
        """
    ...
    def notify_object_id(self, value: pulumi.Input[_builtins.str]):
...
if not MYPY:
    class DispatchRuleNotifyTemplateArgsDict(TypedDict):
        email_content: pulumi.Input[_builtins.str]
        """
        The content of the email notification.
        """
        email_recover_content: pulumi.Input[_builtins.str]
        """
        The content of the email notification for restored alerts.
        """
        email_recover_title: pulumi.Input[_builtins.str]
        """
        The title of the email notification for restored alerts.
        """
        email_title: pulumi.Input[_builtins.str]
        """
        The title of the email notification.
        """
        robot_content: pulumi.Input[_builtins.str]
        """
        The content of the robot notification.
        """
        sms_content: pulumi.Input[_builtins.str]
        """
        The content of the SMS notification.
        """
        sms_recover_content: pulumi.Input[_builtins.str]
        """
        The content of the SMS notification for restored alerts.
        """
        tts_content: pulumi.Input[_builtins.str]
        """
        The content of the TTS notification.
        """
        tts_recover_content: pulumi.Input[_builtins.str]
        """
...
class DispatchRuleNotifyTemplateArgs:
    def __init__(__self__, *,
                 ...
                 tts_recover_content: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] email_content: The content of the email notification.
        :param pulumi.Input[_builtins.str] email_recover_content: The content of the email notification for restored alerts.
        :param pulumi.Input[_builtins.str] email_recover_title: The title of the email notification for restored alerts.
        :param pulumi.Input[_builtins.str] email_title: The title of the email notification.
        :param pulumi.Input[_builtins.str] robot_content: The content of the robot notification.
        :param pulumi.Input[_builtins.str] sms_content: The content of the SMS notification.
        :param pulumi.Input[_builtins.str] sms_recover_content: The content of the SMS notification for restored alerts.
        :param pulumi.Input[_builtins.str] tts_content: The content of the TTS notification.
        :param pulumi.Input[_builtins.str] tts_recover_content: The content of the TTS notification for restored alerts.
        """
    ...
    def email_content(self) -> pulumi.Input[_builtins.str]:
        """
        The content of the email notification.
        """
    ...
    def email_content(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "email_content", value)

    @_builtins.property
    @pulumi.getter(name="emailRecoverContent")
    def email_recover_content(self) -> pulumi.Input[_builtins.str]:
        """
        The content of the email notification for restored alerts.
        """
    ...
    def email_recover_content(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "email_recover_content", value)

    @_builtins.property
    @pulumi.getter(name="emailRecoverTitle")
    def email_recover_title(self) -> pulumi.Input[_builtins.str]:
        """
        The title of the email notification for restored alerts.
        """
    ...
    def email_recover_title(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "email_recover_title", value)

    @_builtins.property
    @pulumi.getter(name="emailTitle")
    def email_title(self) -> pulumi.Input[_builtins.str]:
        """
        The title of the email notification.
        """
    ...
    @email_title.setter
    def email_title(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "email_title", value)

    @_builtins.property
    @pulumi.getter(name="robotContent")
    def robot_content(self) -> pulumi.Input[_builtins.str]:
        """
        The content of the robot notification.
        """
    ...
    def robot_content(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "robot_content", value)

    @_builtins.property
    @pulumi.getter(name="smsContent")
    def sms_content(self) -> pulumi.Input[_builtins.str]:
        """
        The content of the SMS notification.
        """
    ...
    @sms_content.setter
    def sms_content(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "sms_content", value)

    @_builtins.property
    @pulumi.getter(name="smsRecoverContent")
    def sms_recover_content(self) -> pulumi.Input[_builtins.str]:
        """
        The content of the SMS notification for restored alerts.
        """
    ...
    def sms_recover_content(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "sms_recover_content", value)

    @_builtins.property
    @pulumi.getter(name="ttsContent")
    def tts_content(self) -> pulumi.Input[_builtins.str]:
        """
        The content of the TTS notification.
        """
    ...
    @tts_content.setter
    def tts_content(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "tts_content", value)

    @_builtins.property
    @pulumi.getter(name="ttsRecoverContent")
    def tts_recover_content(self) -> pulumi.Input[_builtins.str]:
        """
        The content of the TTS notification for restored alerts.
        """
    ...
    def tts_recover_content(self, value: pulumi.Input[_builtins.str]):
...
class SyntheticTaskAvailableAssertionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Assertion type, including: httpresead, httpresead, HttpResBody, HttpResBodyJson, httpressetime, IcmpPackLoss (packet loss rate), IcmpPackMaxLatency (maximum packet delay ms), icmppackwebscreen, fmppackavglatency (average delay rendering), TraceRouteHops (number of hops), dnsarecname, websiteOnload (full load time), see the supplement below for specific use.
        :param pulumi.Input[_builtins.str] target: Check the target. If the target is HttpResCode, HttpResBody, or httpressetime, you do not need to specify the target. If the target is HttpResHead, you need to specify the key in the header. If the target is HttpResHead, you need to use jsonPath.
        """
...
class SyntheticTaskCommonSettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] trace_client_type: Link trace client type:
               ...
               - 1:OpenTelemetry
               - 2:Jaeger.
        :param pulumi.Input[_builtins.str] xtrace_region: The link data is reported to the region.
        """
...
if not MYPY:
    class SyntheticTaskCommonSettingCustomHostArgsDict(TypedDict):
        ...
        """
        select_type: pulumi.Input[_builtins.int]
        """
        Selection method:
        - 0: Random
        - 1: Polling.
...
class SyntheticTaskCommonSettingCustomHostArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] select_type: Selection method:
               - 0: Random
               - 1: Polling.
        """
    ...
    def select_type(self) -> pulumi.Input[_builtins.int]:
        """
        Selection method:
        - 0: Random
        - 1: Polling.
    ...
    @select_type.setter
    def select_type(self, value: pulumi.Input[_builtins.int]):
...
if not MYPY:
    class SyntheticTaskCommonSettingCustomHostHostArgsDict(TypedDict):
        ...
        Domain Name.
        """
        ip_type: pulumi.Input[_builtins.int]
        """
        IpType.
        """
...
class SyntheticTaskCommonSettingCustomHostHostArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] ip_type: IpType.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ips: The IP list.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="ipType")
    def ip_type(self) -> pulumi.Input[_builtins.int]:
        """
        IpType.
        """
        return pulumi.get(self, "ip_type")
    ...
    @ip_type.setter
    def ip_type(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "ip_type", value)
...
if not MYPY:
    class SyntheticTaskMonitorArgsDict(TypedDict):
        ...
        """
        client_type: pulumi.Input[_builtins.int]
        """
        The type of monitor.
        """
        operator_code: pulumi.Input[_builtins.str]
        """
...
class SyntheticTaskMonitorArgs:
    def __init__(__self__, *,
                 ...
                 operator_code: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] city_code: The city code of monitor.
        :param pulumi.Input[_builtins.int] client_type: The type of monitor.
        :param pulumi.Input[_builtins.str] operator_code: The operator code of monitor.
        """
    ...
    def client_type(self) -> pulumi.Input[_builtins.int]:
        """
        The type of monitor.
        """
    ...
    @client_type.setter
    def client_type(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "client_type", value)

    @_builtins.property
    @pulumi.getter(name="operatorCode")
    def operator_code(self) -> pulumi.Input[_builtins.str]:
        """
        The operator code of monitor.
        """
    ...
    def operator_code(self, value: pulumi.Input[_builtins.str]):
...
class SyntheticTaskMonitorConfApiHttpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] method: HTTP method, GET or POST.
        :param pulumi.Input['SyntheticTaskMonitorConfApiHttpRequestBodyArgs'] request_body: HTTP request body. See `request_body` below.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] request_headers: HTTP request header.
        :param pulumi.Input[_builtins.int] timeout: TCP dial test timeout. The unit is milliseconds (ms), the minimum value is 1000, the maximum value is 300000, and the default value is 20000.
        """
...
class SyntheticTaskMonitorConfFileDownloadArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] ignore_certificate_status_error: The certificate status error is ignored. 0: Do not ignore, 1: IGNORE. The default value is 1.
        :param pulumi.Input[_builtins.int] ignore_certificate_untrustworthy_error: The certificate cannot be trusted and ignored. 0: Do not ignore, 1: IGNORE. The default value is 1.
        :param pulumi.Input[_builtins.int] ignore_certificate_using_error: Ignore certificate usage error 0: Do not ignore, 1: ignore, default 1.
        :param pulumi.Input[_builtins.int] ignore_invalid_host_error: Invalid host error ignored, 0: not ignored, 1: Ignored, default 1.
        :param pulumi.Input[_builtins.int] monitor_timeout: Monitoring timeout, in ms. Not required, 20000 by default.
        :param pulumi.Input[_builtins.int] quick_protocol: Quick agreement
               - 1:http1
               - 2:http2
               - 3:http3
               Default 1.
        ...
        :param pulumi.Input[_builtins.int] verify_way: The verification method.
               - 0: Do not validate
               - 1: Validation string
               - 2:MD5 validation.
        :param pulumi.Input[_builtins.str] white_list: DNS hijack whitelist. Match rules support IP, IP wildcard, subnet mask, and CNAME. Multiple match rules can be filled in. Multiple match rules are separated by vertical bars (|). For example, www.aliyun.com:203.0.3.55 | 203.3.44.67 indicates that all other IP addresses under the www.aliyun.com domain except 203.0.3.55 and 203.3.44.67 are hijacked.
        """
        pulumi.set(__self__, "target_url", target_url)
...
class SyntheticTaskMonitorConfNetIcmpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] package_num: Number of ICMP(Ping) packets sent. The minimum value is 1, the maximum value is 50, and the default is 4.
        :param pulumi.Input[_builtins.int] package_size: The size of the sent ICMP(Ping) packet. The unit is byte. The ICMP(PING) packet size is limited to 32, 64, 128, 256, 512, 1024, 1080, and 1450.
        :param pulumi.Input[_builtins.bool] split_package: Whether to split ICMP(Ping) packets. The default is true.
        :param pulumi.Input[_builtins.int] timeout: TCP dial test timeout. The unit is milliseconds (ms), the minimum value is 1000, the maximum value is 300000, and the default value is 20000.
        :param pulumi.Input[_builtins.bool] tracert_enable: Whether to enable tracert. The default is true.
        :param pulumi.Input[_builtins.int] tracert_num_max: The maximum number of hops for tracert. The minimum value is 1, the maximum value is 128, and the default value is 20.
        :param pulumi.Input[_builtins.int] tracert_timeout: The time-out of tracert. The unit is milliseconds (ms), the minimum value is 1000, the maximum value is 300000, and the default value is 60000.
        """
        pulumi.set(__self__, "target_url", target_url)
...
class SyntheticTaskMonitorConfStreamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] player_type: Player, do not pass the default 12.
               - 12:VLC
               - 2:FlashPlayer.
        :param pulumi.Input[_builtins.int] stream_address_type: Resource address type:
               - 1: Resource address.
               - 0: page address, not 0 by default.
        :param pulumi.Input[_builtins.int] stream_monitor_timeout: Monitoring duration, in seconds, up to 60s, not 60 by default.
        :param pulumi.Input[_builtins.int] stream_type: Audio and video flags: 0-video, 1-audio.
        :param pulumi.Input[_builtins.str] target_url: The target URL.
        :param pulumi.Input[_builtins.str] white_list: DNS hijack whitelist. Match rules support IP, IP wildcard, subnet mask, and CNAME. Multiple match rules can be filled in. Multiple match rules are separated by vertical bars (|). For example, www.aliyun.com:203.0.3.55 | 203.3.44.67 indicates that all other IP addresses under the www.aliyun.com domain except 203.0.3.55 and 203.3.44.67 are hijacked.
        """
        if custom_header_content is not None:
...
class SyntheticTaskMonitorConfWebsiteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] custom_header: Custom header.
               ...
               - 2: Modify all packages.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] custom_header_content: Custom header, in JSON Map format.
        :param pulumi.Input[_builtins.int] disable_cache: Whether to disable caching.
               - 0: not disabled
               - 1 (default): Disabled.
        :param pulumi.Input[_builtins.int] disable_compression: The Accept-Encoding field is used to determine whether to Accept compressed files. 0-do not disable, 1-disable, the default is 0.
        :param pulumi.Input[_builtins.str] dns_hijack_whitelist: When a domain name (such as www.aliyun.com) is resolved, if the resolved IP address or CNAME is not in the DNS hijacking white list, the user will fail to access or return a target IP address that is not Aliyun. If the IP or CNAME in the resolution result is in the DNS white list, it will be determined that DNS hijacking has not occurred.  Fill in the format: Domain name: matching rules. Match rules support IP, IP wildcard, subnet mask, and CNAME. Multiple match rules can be filled in. Multiple match rules are separated by vertical bars (|). For example, www.aliyun.com:203.0.3.55 | 203.3.44.67 indicates that all other IP addresses under the www.aliyun.com domain except 203.0.3.55 and 203.3.44.67 are hijacked.
        :param pulumi.Input[_builtins.str] element_blacklist: If an element configured in the element blacklist appears during page loading, the element is not requested to be loaded.
        :param pulumi.Input[_builtins.int] filter_invalid_ip: Whether to filter invalid IP parameters. 0: filter, 1: do not filter. The default value is 0.
        :param pulumi.Input[_builtins.int] flow_hijack_jump_times: Identify elements: Set the total number of elements on the Browse page.
        :param pulumi.Input[_builtins.str] flow_hijack_logo: Hijacking ID: Set the matching key information. Enter the hijacking keyword or key element, with an asterisk (*) allowed.
        :param pulumi.Input[_builtins.int] ignore_certificate_error: Whether to ignore certificate errors during certificate verification in SSL Handshake and continue browsing. 0-do not ignore, 1-ignore. The default value is 1.
        :param pulumi.Input[_builtins.int] monitor_timeout: Monitoring timeout, in ms. Not required, 20000 by default.
        :param pulumi.Input[_builtins.str] page_tamper: Monitoring the page appears to be tampered with elements other than the domain settings that belong to the page. Common manifestations are pop-up advertisements, floating advertisements, jumps, etc.  Fill in the format: Domain name: Element. You can fill multiple elements separated by a vertical bar (|). For example, www.aliyun.com:|/cc/bb/a.gif |/vv/bb/cc.jpg indicates that all the other elements of the www.aliyun.com domain name except the basic document,/cc/bb/a.gif, and/vv/bb/cc.jpg are tampered.
        :param pulumi.Input[_builtins.int] redirection: When redirection occurs, whether to continue browsing, 0-No, 1-Yes, the default is 1.
        :param pulumi.Input[_builtins.int] slow_element_threshold: The slow element threshold, in ms, is 5000 by default and can be selected from 1 to 300000ms.
        :param pulumi.Input[_builtins.str] verify_string_blacklist: The verification string is an arbitrary string in the source code of the monitoring page. If the source code returned by the client contains any of the blacklisted strings, 650 error is returned. Multiple strings are separated by a vertical bar (|).
        :param pulumi.Input[_builtins.str] verify_string_whitelist: The verification string is an arbitrary string in the source code of the monitoring page. The source code returned by the client must contain all the strings in the whitelist. Otherwise, 650 error is returned. Multiple strings are separated by a vertical bar (|).
        :param pulumi.Input[_builtins.int] wait_completion_time: The maximum waiting time, in ms, is 5000 by default and can be selected from 5000 ms to 300000ms.
        """
        pulumi.set(__self__, "target_url", target_url)
