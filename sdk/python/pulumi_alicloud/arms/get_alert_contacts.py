...
class GetAlertContactsResult:
    ...
    def alert_contact_name(self) -> Optional[builtins.str]:
    ...
    def phone_num(self) -> Optional[builtins.str]:
...
def get_alert_contacts(alert_contact_name: Optional[builtins.str] = None,
                       ...
                       phone_num: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Alert Contact IDs.
    :param builtins.str name_regex: A regex string to filter results by Alert Contact name.
...
def get_alert_contacts_output(alert_contact_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              ...
                              phone_num: Optional[pulumi.Input[Optional[builtins.str]]] = None,
