...
class GetAlertContactsResult:
    ...
    def alert_contact_name(self) -> Optional[_builtins.str]:
...
def get_alert_contacts(alert_contact_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Alert Contact IDs.
    :param _builtins.str name_regex: A regex string to filter results by Alert Contact name.
...
def get_alert_contacts_output(alert_contact_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
