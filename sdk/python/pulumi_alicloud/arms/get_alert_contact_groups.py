...
class GetAlertContactGroupsResult:
    ...
    def alert_contact_group_name(self) -> Optional[_builtins.str]:
...
def get_alert_contact_groups(alert_contact_group_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str contact_id: The contact id.
    :param _builtins.str contact_name: The contact name.
    :param Sequence[_builtins.str] ids: A list of Alert Contact Group IDs.
    :param _builtins.str name_regex: A regex string to filter results by Alert Contact Group name.
