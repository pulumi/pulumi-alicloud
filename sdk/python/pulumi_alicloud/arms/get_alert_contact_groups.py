...
class GetAlertContactGroupsResult:
    ...
    def alert_contact_group_name(self) -> Optional[builtins.str]:
...
def get_alert_contact_groups(alert_contact_group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str alert_contact_group_name: The name of the resource.
    :param builtins.str contact_id: The contact id.
    :param builtins.str contact_name: The contact name.
    :param Sequence[builtins.str] ids: A list of Alert Contact Group IDs.
    :param builtins.str name_regex: A regex string to filter results by Alert Contact Group name.
...
def get_alert_contact_groups_output(alert_contact_group_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    contact_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    contact_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
