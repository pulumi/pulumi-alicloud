...
def get_app_templates(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of App Template IDs.
    :param builtins.str name_regex: A regex string to filter results by App Template name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: Application template usage status. Valid values: ["attached", "unattached"].
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_app_templates_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
