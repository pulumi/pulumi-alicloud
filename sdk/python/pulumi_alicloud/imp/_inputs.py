...
class AppTemplateConfigListArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: Configuration item key. Valid values: ["config.appCallbackAuthKey","config.appCallbackUrl","config.callbackClass.live","config.callbackClass.user","config.livePullDomain","config.livePushDomain","config.multipleClientsLogin","config.regionId","config.streamChangeCallbackUrl"].
        :param pulumi.Input[builtins.str] value: Configuration item content.
