...
class DeployGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_name: The name of the instance group that you want to create.
        """
...
class _DeployGroupState:
    def __init__(__self__, *,
                 ...
                 group_type: Optional[pulumi.Input[builtins.int]] = None):
        """
        Input properties used for looking up and filtering DeployGroup resources.
        :param pulumi.Input[builtins.str] app_id: The ID of the application that you want to deploy.
        :param pulumi.Input[builtins.str] group_name: The name of the instance group that you want to create.
        :param pulumi.Input[builtins.int] group_type: The type of the instance group that you want to create. Valid values: 0: Default group. 1: Phased release is disabled for traffic management. 2: Phased release is enabled for traffic management.
        """
    ...
    def group_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @group_type.setter
    def group_type(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DeployGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            app_id: Optional[pulumi.Input[builtins.str]] = None,
            group_name: Optional[pulumi.Input[builtins.str]] = None,
            group_type: Optional[pulumi.Input[builtins.int]] = None) -> 'DeployGroup':
        """
    ...
    @property
    @pulumi.getter(name="groupType")
    def group_type(self) -> pulumi.Output[builtins.int]:
        """
        The type of the instance group that you want to create. Valid values: 0: Default group. 1: Phased release is disabled for traffic management. 2: Phased release is enabled for traffic management.
        """
        return pulumi.get(self, "group_type")
