...
class SlbAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 slb_ip: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 listener_port: Optional[pulumi.Input[builtins.int]] = None,
                 vserver_group_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SlbAttachment resource.
        :param pulumi.Input[builtins.str] app_id: The ID of the application to which you want to bind an SLB instance.
        :param pulumi.Input[builtins.str] slb_id: The ID of the SLB instance that is going to be bound.
        :param pulumi.Input[builtins.str] slb_ip: The IP address that is allocated to the bound SLB instance.
        :param pulumi.Input[builtins.str] type: The type of the bound SLB instance.
        :param pulumi.Input[builtins.int] listener_port: The listening port for the bound SLB instance.
        :param pulumi.Input[builtins.str] vserver_group_id: The ID of the virtual server (VServer) group associated with the intranet SLB instance.
        """
    ...
    def slb_ip(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @slb_ip.setter
    def slb_ip(self, value: pulumi.Input[builtins.str]):
    ...
    def vserver_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vserver_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SlbAttachmentState:
    def __init__(__self__, *,
                 ...
                 slb_status: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def slb_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @slb_status.setter
    def slb_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("alicloud:edas/slbAttachment:SlbAttachment")
class SlbAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            vserver_group_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SlbAttachment':
        """
    ...
    @property
    @pulumi.getter(name="listenerPort")
    def listener_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The listening port for the bound SLB instance.
        """
        return pulumi.get(self, "listener_port")
    ...
    @property
    @pulumi.getter(name="slbIp")
    def slb_ip(self) -> pulumi.Output[builtins.str]:
        """
        The IP address that is allocated to the bound SLB instance.
        """
        return pulumi.get(self, "slb_ip")
    ...
    @property
    @pulumi.getter(name="slbStatus")
    def slb_status(self) -> pulumi.Output[builtins.str]:
        """
        Running Status of SLB instance. Inactive：The instance is stopped, and listener will not monitor and forward traffic. Active：The instance is running. After the instance is created, the default state is active. Locked：The instance is locked, the instance has been owed or locked by Alibaba Cloud. Expired: The instance has expired.
        """
        return pulumi.get(self, "slb_status")
    ...
    @property
    @pulumi.getter(name="vserverGroupId")
    def vserver_group_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the virtual server (VServer) group associated with the intranet SLB instance.
        """
        return pulumi.get(self, "vserver_group_id")
