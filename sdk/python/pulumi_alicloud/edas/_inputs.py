...
if not MYPY:
    class K8sSlbAttachmentSlbConfigArgsDict(TypedDict):
        ...
        """
        scheduler: pulumi.Input[builtins.str]
        """
        ...
        """
        specification: NotRequired[pulumi.Input[builtins.str]]
        """
...
class K8sSlbAttachmentSlbConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scheduler: The scheduler policy of SLB configuration, values can be 'rr'(round-robin) or 'wrr'(weighted round-robin).
        :param pulumi.Input[builtins.str] type: The type of SLB instance, values can be 'internet' or 'intranet'.
        :param pulumi.Input[builtins.str] name: The name of this SLB configuration, empty for auto-generated by EDAS server.
        :param pulumi.Input[builtins.str] slb_id: The ID of your SLB instance, if value is empty which means EDAS will purchase an SLB instance with 'specification' field.
        :param pulumi.Input[builtins.str] specification: The instance specification of SLB, values can be found [here](https://www.alibabacloud.com/help/en/server-load-balancer/latest/createloadbalancer-2#t4182.html), empty for 'slb.s1.small'.
        """
    ...
    @property
    @pulumi.getter
    def scheduler(self) -> pulumi.Input[builtins.str]:
        """
        The scheduler policy of SLB configuration, values can be 'rr'(round-robin) or 'wrr'(weighted round-robin).
        """
    ...
    @scheduler.setter
    def scheduler(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class K8sSlbAttachmentSlbConfigPortMappingArgsDict(TypedDict):
        loadbalancer_protocol: pulumi.Input[builtins.str]
        """
...
class K8sSlbAttachmentSlbConfigPortMappingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] loadbalancer_protocol: The protocol of SLB instance configuration, values can be 'TCP', 'HTTP' or 'HTTPS'.
        ...
        :param pulumi.Input[builtins.str] cert_id: The ID of your tls certification, this is used for 'HTTPS' protocol only.
        """
    ...
    def loadbalancer_protocol(self) -> pulumi.Input[builtins.str]:
        """
        The protocol of SLB instance configuration, values can be 'TCP', 'HTTP' or 'HTTPS'.
        """
    ...
    def loadbalancer_protocol(self, value: pulumi.Input[builtins.str]):
...
class K8sSlbAttachmentSlbConfigPortMappingServicePortArgs:
    def __init__(__self__, *,
                 ...
                 target_port: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] port: The port of k8s service, values should be within range [1, 65535].
        :param pulumi.Input[builtins.str] protocol: The protocol of k8s service, values can be 'TCP' or 'UDP'.
        :param pulumi.Input[builtins.int] target_port: The port of k8s pod, values should be within range [1, 65535].
        """
