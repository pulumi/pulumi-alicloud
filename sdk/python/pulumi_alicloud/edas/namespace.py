...
class NamespaceArgs:
    def __init__(__self__, *,
                 namespace_logical_id: pulumi.Input[builtins.str],
                 namespace_name: pulumi.Input[builtins.str],
                 debug_enable: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Namespace resource.
        :param pulumi.Input[builtins.str] namespace_logical_id: The ID of the namespace.
        ...
        :param pulumi.Input[builtins.str] namespace_name: The name of the namespace, The name can be up to `63` characters in length.
        :param pulumi.Input[builtins.bool] debug_enable: Specifies whether to enable remote debugging.
        :param pulumi.Input[builtins.str] description: The description of the namespace, The description can be up to `128` characters in length.
        """
    ...
    def namespace_logical_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def namespace_logical_id(self, value: pulumi.Input[builtins.str]):
    ...
    def debug_enable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @debug_enable.setter
    def debug_enable(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _NamespaceState:
    def __init__(__self__, *,
                 debug_enable: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 namespace_logical_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="namespaceLogicalId")
    def namespace_logical_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the namespace.
        - The ID of a custom namespace is in the `region ID:namespace identifier` format. An example is `cn-beijing:tdy218`.
        - The ID of the default namespace is in the `region ID` format. An example is cn-beijing.
    ...
    @namespace_logical_id.setter
    def namespace_logical_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "namespace_logical_id", value)
...
class Namespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            namespace_logical_id: Optional[pulumi.Input[builtins.str]] = None,
            namespace_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Namespace':
        """
    ...
    @property
    @pulumi.getter(name="debugEnable")
    def debug_enable(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to enable remote debugging.
        """
        return pulumi.get(self, "debug_enable")
    ...
    @property
    @pulumi.getter(name="namespaceLogicalId")
    def namespace_logical_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the namespace.
        - The ID of a custom namespace is in the `region ID:namespace identifier` format. An example is `cn-beijing:tdy218`.
        - The ID of the default namespace is in the `region ID` format. An example is cn-beijing.
