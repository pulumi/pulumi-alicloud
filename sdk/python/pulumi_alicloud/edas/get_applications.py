...
def get_applications(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: An ids string to filter results by the application id.
    :param builtins.str name_regex: A regex string to filter results by the application name.
