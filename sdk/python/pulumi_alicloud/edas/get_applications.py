...
def get_applications(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: An ids string to filter results by the application id.
    :param _builtins.str name_regex: A regex string to filter results by the application name.
...
def get_applications_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:edas/getApplications:getApplications', __args__, opts=opts, typ=GetApplicationsResult)
