...
class K8sClusterArgs:
    def __init__(__self__, *,
                 cs_cluster_id: pulumi.Input[builtins.str],
                 namespace_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a K8sCluster resource.
        :param pulumi.Input[builtins.str] cs_cluster_id: The ID of the alicloud container service kubernetes cluster that you want to import.
        :param pulumi.Input[builtins.str] namespace_id: The ID of the namespace where you want to import. You can call the [ListUserDefineRegion](https://www.alibabacloud.com/help/en/doc-detail/149377.htm?spm=a2c63.p38356.879954.34.331054faK2yNvC#doc-api-Edas-ListUserDefineRegion) operation to query the namespace ID.
        """
    ...
    def cs_cluster_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cs_cluster_id(self, value: pulumi.Input[builtins.str]):
...
class _K8sClusterState:
    def __init__(__self__, *,
                 cluster_import_status: Optional[pulumi.Input[builtins.int]] = None,
                 cluster_name: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_type: Optional[pulumi.Input[builtins.int]] = None,
                 cs_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                 namespace_id: Optional[pulumi.Input[builtins.str]] = None,
                 network_mode: Optional[pulumi.Input[builtins.int]] = None,
                 vpc_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering K8sCluster resources.
        :param pulumi.Input[builtins.int] cluster_import_status: The import status of cluster: 
               `1`: success.
               `2`: failed.
               `3`: importing.
               `4`: deleted.
        :param pulumi.Input[builtins.str] cluster_name: The name of the cluster that you want to create.
        :param pulumi.Input[builtins.int] cluster_type: The type of the cluster that you want to create. Valid values only: 5: K8s cluster.
        :param pulumi.Input[builtins.str] cs_cluster_id: The ID of the alicloud container service kubernetes cluster that you want to import.
        :param pulumi.Input[builtins.str] namespace_id: The ID of the namespace where you want to import. You can call the [ListUserDefineRegion](https://www.alibabacloud.com/help/en/doc-detail/149377.htm?spm=a2c63.p38356.879954.34.331054faK2yNvC#doc-api-Edas-ListUserDefineRegion) operation to query the namespace ID.
        :param pulumi.Input[builtins.int] network_mode: The network type of the cluster that you want to create. Valid values: 1: classic network. 2: VPC.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the Virtual Private Cloud (VPC) for the cluster.
        """
    ...
    def cluster_import_status(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cluster_import_status(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def cluster_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @cluster_type.setter
    def cluster_type(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cluster_type", value)

    @property
    @pulumi.getter(name="csClusterId")
    def cs_cluster_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the alicloud container service kubernetes cluster that you want to import.
        """
        return pulumi.get(self, "cs_cluster_id")
    ...
    @cs_cluster_id.setter
    def cs_cluster_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cs_cluster_id", value)
    ...
    def network_mode(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @network_mode.setter
    def network_mode(self, value: Optional[pulumi.Input[builtins.int]]):
...
class K8sCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace_id: Optional[pulumi.Input[builtins.str]] = None,
            network_mode: Optional[pulumi.Input[builtins.int]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'K8sCluster':
        """
    ...
    @property
    @pulumi.getter(name="clusterImportStatus")
    def cluster_import_status(self) -> pulumi.Output[builtins.int]:
        """
        The import status of cluster: 
        `1`: success.
        `2`: failed.
    ...
    @property
    @pulumi.getter(name="clusterType")
    def cluster_type(self) -> pulumi.Output[builtins.int]:
        """
        The type of the cluster that you want to create. Valid values only: 5: K8s cluster.
        """
        return pulumi.get(self, "cluster_type")
    ...
    @property
    @pulumi.getter(name="csClusterId")
    def cs_cluster_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the alicloud container service kubernetes cluster that you want to import.
        """
        return pulumi.get(self, "cs_cluster_id")
    ...
    @property
    @pulumi.getter(name="networkMode")
    def network_mode(self) -> pulumi.Output[builtins.int]:
        """
        The network type of the cluster that you want to create. Valid values: 1: classic network. 2: VPC.
        """
        return pulumi.get(self, "network_mode")
