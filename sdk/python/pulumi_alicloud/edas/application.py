...
class ApplicationArgs:
    def __init__(__self__, *,
                 ...
                 build_pack_id: Optional[pulumi.Input[builtins.int]] = None,
                 descriotion: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 war_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Application resource.
        :param pulumi.Input[builtins.str] application_name: Name of your EDAS application. Only letters '-' '_' and numbers are allowed. The length cannot exceed 36 characters.
        :param pulumi.Input[builtins.str] cluster_id: The ID of the cluster that you want to create the application. The default cluster will be used if you do not specify this parameter.
        :param pulumi.Input[builtins.str] package_type: The type of the package for the deployment of the application that you want to create. The valid values are: WAR and JAR. We strongly recommend you to set this parameter when creating the application.
        :param pulumi.Input[builtins.int] build_pack_id: The package ID of Enterprise Distributed Application Service (EDAS) Container, which can be retrieved by calling container version list interface ListBuildPack or the "Pack ID" column in container version list. When creating High-speed Service Framework (HSF) application, this parameter is required.
        :param pulumi.Input[builtins.str] descriotion: The description of the application that you want to create.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ecu_infos: The ID of the Elastic Compute Unit (ECU) where you want to deploy the application. Type: List.
        :param pulumi.Input[builtins.str] group_id: The ID of the instance group where the application is going to be deployed. Set this parameter to all if you want to deploy the application to all groups.
        :param pulumi.Input[builtins.str] health_check_url: The URL for health checking of the application.
        :param pulumi.Input[builtins.str] logical_region_id: The ID of the namespace where you want to create the application. You can call the ListUserDefineRegion operation to query the namespace ID.
        :param pulumi.Input[builtins.str] package_version: The version of the application that you want to deploy. It must be unique for every application. The length cannot exceed 64 characters. We recommended you to use a timestamp.
        :param pulumi.Input[builtins.str] war_url: The address to store the uploaded web application (WAR) package for application deployment. This parameter is required when the deployType parameter is set as url.
        """
    ...
    def build_pack_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def build_pack_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "build_pack_id", value)

    @property
    @pulumi.getter
    def descriotion(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @descriotion.setter
    def descriotion(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def war_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @war_url.setter
    def war_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("alicloud:edas/application:Application")
class Application(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            package_type: Optional[pulumi.Input[builtins.str]] = None,
            package_version: Optional[pulumi.Input[builtins.str]] = None,
            war_url: Optional[pulumi.Input[builtins.str]] = None) -> 'Application':
        """
    ...
    @property
    @pulumi.getter(name="buildPackId")
    def build_pack_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The package ID of Enterprise Distributed Application Service (EDAS) Container, which can be retrieved by calling container version list interface ListBuildPack or the "Pack ID" column in container version list. When creating High-speed Service Framework (HSF) application, this parameter is required.
        """
        return pulumi.get(self, "build_pack_id")
    ...
    @property
    @pulumi.getter
    def descriotion(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the application that you want to create.
        """
        return pulumi.get(self, "descriotion")
    ...
    @property
    @pulumi.getter(name="ecuInfos")
    def ecu_infos(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The ID of the Elastic Compute Unit (ECU) where you want to deploy the application. Type: List.
        """
        return pulumi.get(self, "ecu_infos")
    ...
    @property
    @pulumi.getter(name="healthCheckUrl")
    def health_check_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL for health checking of the application.
        """
        return pulumi.get(self, "health_check_url")
    ...
    @property
    @pulumi.getter(name="packageVersion")
    def package_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version of the application that you want to deploy. It must be unique for every application. The length cannot exceed 64 characters. We recommended you to use a timestamp.
        """
        return pulumi.get(self, "package_version")
    ...
    @property
    @pulumi.getter(name="warUrl")
    def war_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The address to store the uploaded web application (WAR) package for application deployment. This parameter is required when the deployType parameter is set as url.
        """
        return pulumi.get(self, "war_url")
