...
def get_deploy_groups(app_id: Optional[builtins.str] = None,
    ...
    :param builtins.str name_regex: A regex string to filter results by the deploy group name.
...
def get_deploy_groups_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
