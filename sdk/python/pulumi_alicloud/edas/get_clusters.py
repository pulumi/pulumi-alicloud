...
class GetClustersResult:
    ...
    def logical_region_id(self) -> builtins.str:
...
def get_clusters(ids: Optional[Sequence[builtins.str]] = None,
                 logical_region_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: An ids string to filter results by the cluster id.
    :param builtins.str logical_region_id: ID of the namespace in EDAS.
    :param builtins.str name_regex: A regex string to filter results by the cluster name.
...
def get_clusters_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
