...
class ApplicationScaleArgs:
    def __init__(__self__, *,
                 ...
                 deploy_group: pulumi.Input[builtins.str],
                 ecu_infos: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 force_status: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a ApplicationScale resource.
        :param pulumi.Input[builtins.str] app_id: The ID of the application that you want to deploy.
        :param pulumi.Input[builtins.str] deploy_group: The ID of the instance group to which you want to add ECS instances to scale out the application.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ecu_infos: The IDs of the Elastic Compute Unit (ECU) where you want to deploy the application. Type: List.
        :param pulumi.Input[builtins.bool] force_status: This parameter specifies whether to forcibly remove an ECS instance where the application is deployed. It is set as true only after the ECS instance expires. In normal cases, this parameter do not need to be specified.
        """
    ...
    def deploy_group(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @deploy_group.setter
    def deploy_group(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "deploy_group", value)

    @property
    @pulumi.getter(name="ecuInfos")
    def ecu_infos(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @ecu_infos.setter
    def ecu_infos(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "ecu_infos", value)

    @property
    @pulumi.getter(name="forceStatus")
    def force_status(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @force_status.setter
    def force_status(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ApplicationScaleState:
    def __init__(__self__, *,
                 ...
                 deploy_group: Optional[pulumi.Input[builtins.str]] = None,
                 ecc_info: Optional[pulumi.Input[builtins.str]] = None,
                 ecu_infos: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 force_status: Optional[pulumi.Input[builtins.bool]] = None):
        """
        Input properties used for looking up and filtering ApplicationScale resources.
        :param pulumi.Input[builtins.str] app_id: The ID of the application that you want to deploy.
        :param pulumi.Input[builtins.str] deploy_group: The ID of the instance group to which you want to add ECS instances to scale out the application.
        :param pulumi.Input[builtins.str] ecc_info: The ecc information of the resource supplied above. The value is formulated as `<ecc1,ecc2>`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ecu_infos: The IDs of the Elastic Compute Unit (ECU) where you want to deploy the application. Type: List.
        :param pulumi.Input[builtins.bool] force_status: This parameter specifies whether to forcibly remove an ECS instance where the application is deployed. It is set as true only after the ECS instance expires. In normal cases, this parameter do not need to be specified.
        """
    ...
    @property
    @pulumi.getter(name="deployGroup")
    def deploy_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the instance group to which you want to add ECS instances to scale out the application.
        """
        return pulumi.get(self, "deploy_group")
    ...
    @deploy_group.setter
    def deploy_group(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "deploy_group", value)

    @property
    @pulumi.getter(name="eccInfo")
    def ecc_info(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ecc_info.setter
    def ecc_info(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ecc_info", value)

    @property
    @pulumi.getter(name="ecuInfos")
    def ecu_infos(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The IDs of the Elastic Compute Unit (ECU) where you want to deploy the application. Type: List.
        """
        return pulumi.get(self, "ecu_infos")
    ...
    @ecu_infos.setter
    def ecu_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "ecu_infos", value)
...
class ApplicationScale(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ecc_info: Optional[pulumi.Input[builtins.str]] = None,
            ecu_infos: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            force_status: Optional[pulumi.Input[builtins.bool]] = None) -> 'ApplicationScale':
        """
    ...
    @property
    @pulumi.getter(name="deployGroup")
    def deploy_group(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the instance group to which you want to add ECS instances to scale out the application.
        """
        return pulumi.get(self, "deploy_group")
    ...
    @property
    @pulumi.getter(name="eccInfo")
    def ecc_info(self) -> pulumi.Output[builtins.str]:
        """
        The ecc information of the resource supplied above. The value is formulated as `<ecc1,ecc2>`.
        """
        return pulumi.get(self, "ecc_info")
    ...
    @property
    @pulumi.getter(name="ecuInfos")
    def ecu_infos(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The IDs of the Elastic Compute Unit (ECU) where you want to deploy the application. Type: List.
        """
        return pulumi.get(self, "ecu_infos")
    ...
    @property
    @pulumi.getter(name="forceStatus")
    def force_status(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        This parameter specifies whether to forcibly remove an ECS instance where the application is deployed. It is set as true only after the ECS instance expires. In normal cases, this parameter do not need to be specified.
        """
        return pulumi.get(self, "force_status")
