...
class ApplicationDeploymentArgs:
    def __init__(__self__, *,
                 ...
                 war_url: pulumi.Input[builtins.str],
    ...
    def war_url(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @war_url.setter
    def war_url(self, value: pulumi.Input[builtins.str]):
...
class _ApplicationDeploymentState:
    def __init__(__self__, *,
                 ...
                 last_package_version: Optional[pulumi.Input[builtins.str]] = None,
                 package_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] app_id: The ID of the application that you want to deploy.
        :param pulumi.Input[builtins.str] group_id: The ID of the instance group where the application is going to be deployed. Set this parameter to all if you want to deploy the application to all groups.
        :param pulumi.Input[builtins.str] last_package_version: Last package version deployed.
        :param pulumi.Input[builtins.str] package_version: The version of the application that you want to deploy. It must be unique for every application. The length cannot exceed 64 characters. We recommended you to use a timestamp.
        :param pulumi.Input[builtins.str] war_url: The address to store the uploaded web application (WAR) package for application deployment. This parameter is required when the deployType parameter is set as url.
        """
    ...
    def last_package_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_package_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ApplicationDeployment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            last_package_version: Optional[pulumi.Input[builtins.str]] = None,
            package_version: Optional[pulumi.Input[builtins.str]] = None,
            war_url: Optional[pulumi.Input[builtins.str]] = None) -> 'ApplicationDeployment':
        """
    ...
    @property
    @pulumi.getter(name="lastPackageVersion")
    def last_package_version(self) -> pulumi.Output[builtins.str]:
        """
        Last package version deployed.
        """
        return pulumi.get(self, "last_package_version")
    ...
    @property
    @pulumi.getter(name="warUrl")
    def war_url(self) -> pulumi.Output[builtins.str]:
        """
        The address to store the uploaded web application (WAR) package for application deployment. This parameter is required when the deployType parameter is set as url.
        """
        return pulumi.get(self, "war_url")
