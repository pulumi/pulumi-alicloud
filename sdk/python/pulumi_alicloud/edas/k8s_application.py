...
class K8sApplicationArgs:
    def __init__(__self__, *,
                 ...
                 application_descriotion: Optional[pulumi.Input[builtins.str]] = None,
                 command: Optional[pulumi.Input[builtins.str]] = None,
                 command_args: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 edas_container_version: Optional[pulumi.Input[builtins.str]] = None,
                 envs: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 image_url: Optional[pulumi.Input[builtins.str]] = None,
                 internet_slb_id: Optional[pulumi.Input[builtins.str]] = None,
                 internet_slb_port: Optional[pulumi.Input[builtins.int]] = None,
                 internet_slb_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 internet_target_port: Optional[pulumi.Input[builtins.int]] = None,
                 jdk: Optional[pulumi.Input[builtins.str]] = None,
                 limit_m_cpu: Optional[pulumi.Input[builtins.int]] = None,
                 limit_mem: Optional[pulumi.Input[builtins.int]] = None,
                 liveness: Optional[pulumi.Input[builtins.str]] = None,
                 local_volume: Optional[pulumi.Input[builtins.str]] = None,
                 logical_region_id: Optional[pulumi.Input[builtins.str]] = None,
                 mount_descs: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 requests_m_cpu: Optional[pulumi.Input[builtins.int]] = None,
                 requests_mem: Optional[pulumi.Input[builtins.int]] = None,
                 web_container: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a K8sApplication resource.
        :param pulumi.Input[builtins.str] application_name: The name of the application you want to create. Must start with character,supports numbers, letters and dashes (-), supports up to 36 characters
        :param pulumi.Input[builtins.str] cluster_id: The ID of the alicloud container service kubernetes cluster that you want to import to. You can call the ListCluster operation to query.
        :param pulumi.Input[builtins.str] application_descriotion: The description of the application
        :param pulumi.Input[builtins.str] command: The set command, if set, will replace the startup command in the mirror when the mirror is started.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] command_args: Used in combination with the command, the parameter of the command is a JsonArray string in the format: `[{"argument":"-c"},{"argument":"test"}]`. Among them, -c and test are two parameters that need to be set.
        :param pulumi.Input[builtins.str] edas_container_version: EDAS-Container version that the deployed package depends on. Image does not support this parameter.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] envs: Deployment environment variables, the format must conform to the JSON object array, such as: `{"name":"x","value":"y"},{"name":"x2","value":"y2"}`, If you want to cancel the configuration, you need to set an empty JSON array "" to indicate no configuration.
        :param pulumi.Input[builtins.str] image_url: Mirror address. When the package_type is set to 'Image', this parameter item is required.
        :param pulumi.Input[builtins.str] internet_slb_id: Public network SLB ID. If not configured, EDAS will automatically purchase a new SLB for the user.
               It has been deprecated, and new resource 'alicloud_edas_k8s_slb_attachment' replaces it.
        :param pulumi.Input[builtins.int] internet_slb_port: The public network SLB front-end port, range 1~65535. It has been deprecated and new resource 'alicloud_edas_k8s_slb_attachment' replaces it.
        :param pulumi.Input[builtins.str] internet_slb_protocol: The public network SLB protocol supports TCP, HTTP and HTTPS protocols. It has been deprecated, and new resource 'alicloud_edas_k8s_slb_attachment' replaces it.
        :param pulumi.Input[builtins.int] internet_target_port: The private SLB back-end port, is also the service port of the application, ranging from 1 to 65535.
               It has been deprecated, and new resource 'alicloud_edas_k8s_slb_attachment' replaces it.
        :param pulumi.Input[builtins.str] jdk: The JDK version that the deployed package depends on. The optional parameter values are Open JDK 7 and Open JDK 8. Image does not support this parameter.
        :param pulumi.Input[builtins.int] limit_m_cpu: The CPU quota of the application instance during application operation. Unit: Number of millcores, set to 0 means unlimited, similar to request_cpu.
        :param pulumi.Input[builtins.int] limit_mem: The memory limit of the application instance during application operation, unit: M.
        :param pulumi.Input[builtins.str] liveness: Container survival status monitoring, format such as: `{"failureThreshold": 3,"initialDelaySeconds": 5,"successThreshold": 1,"timeoutSeconds": 1,"tcpSocket":{"host":"", "port":8080} }`.
        :param pulumi.Input[builtins.str] local_volume: The configuration of the host file mounted to the container. For example: `[{"type":"","nodePath":"/localfiles","mountPath":"/app/files"},{"type":"Directory","nodePath":"/mnt", "mountPath":"/app/storage"}]`. Among them, nodePath is the host path; mountPath is the path in the container; type is the mount type.
        :param pulumi.Input[builtins.str] logical_region_id: The ID corresponding to the EDAS namespace, the non-default namespace must be filled in.
        :param pulumi.Input[builtins.str] mount_descs: Mount configuration description, as a serialized JSON. For example: `[{"nasPath": "/k8s","mountPath": "/mnt"},{"nasPath": "/files","mountPath": "/app/files"}]`. Among them, nasPath refers to the file storage path; mountPath refers to the path mounted in the container.
        :param pulumi.Input[builtins.str] namespace: The namespace of the K8s cluster, it will determine which K8s namespace your application is deployed in. The default is 'default'.
        :param pulumi.Input[builtins.str] nas_id: The ID of the mounted NAS must be in the same region as the cluster. It must have an available mount point creation quota, or its mount point must be on a switch in the VPC. If it is not filled in and the mountDescs field exists, a NAS will be automatically purchased and mounted on the switch in the VPC by default.
        :param pulumi.Input[builtins.str] package_type: Application package type. Optional parameter values include: FatJar, WAR and Image.
        :param pulumi.Input[builtins.str] package_url: The url of the package to deploy.Applications deployed through FatJar or WAR packages need to configure it.
        :param pulumi.Input[builtins.str] package_version: The version number of the deployment package. WAR and FatJar types are required. Please customize its meaning.
        :param pulumi.Input[builtins.str] post_start: Execute script after startup
        :param pulumi.Input[builtins.str] pre_stop: Execute script before stopping
        :param pulumi.Input[builtins.str] readiness: Container service status check. If the check fails, the traffic passing through K8s Service will not be transferred to the container. The format is: `{"failureThreshold": 3,"initialDelaySeconds": 5,"successThreshold": 1,"timeoutSeconds": 1, "httpGet": {"path": "/consumer","port": 8080,"scheme": "HTTP","httpHeaders": [{"name": "test","value": "testvalue"} ]}}`.
        :param pulumi.Input[builtins.int] replicas: Number of application instances.
        :param pulumi.Input[builtins.int] requests_m_cpu: When the application is created, the CPU quota of the application instance, unit: number of millcores, similar to request_cpu
        :param pulumi.Input[builtins.int] requests_mem: When the application is created, the memory limit of the application instance, unit: M. When set to 0, it means unlimited.
        :param pulumi.Input[builtins.str] web_container: The Tomcat version that the deployment package depends on. Applicable to Spring Cloud and Dubbo applications deployed through WAR packages. Image does not support this parameter.
        """
    ...
    def application_descriotion(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def application_descriotion(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def command_args(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @command_args.setter
    def command_args(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @property
    @pulumi.getter
    def envs(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    @envs.setter
    def envs(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def internet_slb_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def internet_slb_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def internet_slb_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def internet_slb_port(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def internet_slb_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def internet_slb_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def internet_target_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def internet_target_port(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def limit_m_cpu(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @limit_m_cpu.setter
    def limit_m_cpu(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "limit_m_cpu", value)

    @property
    @pulumi.getter(name="limitMem")
    def limit_mem(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @limit_mem.setter
    def limit_mem(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def local_volume(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @local_volume.setter
    def local_volume(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "local_volume", value)

    @property
    @pulumi.getter(name="logicalRegionId")
    def logical_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def logical_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "logical_region_id", value)

    @property
    @pulumi.getter(name="mountDescs")
    def mount_descs(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @mount_descs.setter
    def mount_descs(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def requests_m_cpu(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def requests_m_cpu(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "requests_m_cpu", value)

    @property
    @pulumi.getter(name="requestsMem")
    def requests_mem(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @requests_mem.setter
    def requests_mem(self, value: Optional[pulumi.Input[builtins.int]]):
...
class K8sApplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            requests_m_cpu: Optional[pulumi.Input[builtins.int]] = None,
            requests_mem: Optional[pulumi.Input[builtins.int]] = None,
            web_container: Optional[pulumi.Input[builtins.str]] = None) -> 'K8sApplication':
        """
    ...
    @property
    @pulumi.getter(name="applicationDescriotion")
    def application_descriotion(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the application
        """
        return pulumi.get(self, "application_descriotion")
    ...
    @property
    @pulumi.getter(name="commandArgs")
    def command_args(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Used in combination with the command, the parameter of the command is a JsonArray string in the format: `[{"argument":"-c"},{"argument":"test"}]`. Among them, -c and test are two parameters that need to be set.
        """
        return pulumi.get(self, "command_args")
    ...
    @property
    @pulumi.getter
    def envs(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Deployment environment variables, the format must conform to the JSON object array, such as: `{"name":"x","value":"y"},{"name":"x2","value":"y2"}`, If you want to cancel the configuration, you need to set an empty JSON array "" to indicate no configuration.
        """
        return pulumi.get(self, "envs")
    ...
    @pulumi.getter(name="internetSlbId")
    @_utilities.deprecated("""Field 'internet_slb_id' has been deprecated, New Resource 'alicloud_edas_k8s_slb_attachment' replaces it""")
    def internet_slb_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Public network SLB ID. If not configured, EDAS will automatically purchase a new SLB for the user.
        It has been deprecated, and new resource 'alicloud_edas_k8s_slb_attachment' replaces it.
        """
    ...
    @pulumi.getter(name="internetSlbPort")
    @_utilities.deprecated("""Field 'internet_slb_port' has been deprecated, New Resource 'alicloud_edas_k8s_slb_attachment' replaces it""")
    def internet_slb_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The public network SLB front-end port, range 1~65535. It has been deprecated and new resource 'alicloud_edas_k8s_slb_attachment' replaces it.
        """
        return pulumi.get(self, "internet_slb_port")
    ...
    @pulumi.getter(name="internetSlbProtocol")
    @_utilities.deprecated("""Field 'internet_slb_protocol' has been deprecated, New Resource 'alicloud_edas_k8s_slb_attachment' replaces it""")
    def internet_slb_protocol(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The public network SLB protocol supports TCP, HTTP and HTTPS protocols. It has been deprecated, and new resource 'alicloud_edas_k8s_slb_attachment' replaces it.
        """
        return pulumi.get(self, "internet_slb_protocol")
    ...
    @pulumi.getter(name="internetTargetPort")
    @_utilities.deprecated("""Field 'internet_target_port' has been deprecated, New Resource 'alicloud_edas_k8s_slb_attachment' replaces it""")
    def internet_target_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The private SLB back-end port, is also the service port of the application, ranging from 1 to 65535.
        It has been deprecated, and new resource 'alicloud_edas_k8s_slb_attachment' replaces it.
        """
    ...
    @property
    @pulumi.getter(name="limitMCpu")
    def limit_m_cpu(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The CPU quota of the application instance during application operation. Unit: Number of millcores, set to 0 means unlimited, similar to request_cpu.
        """
        return pulumi.get(self, "limit_m_cpu")
    ...
    @property
    @pulumi.getter(name="limitMem")
    def limit_mem(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The memory limit of the application instance during application operation, unit: M.
        """
        return pulumi.get(self, "limit_mem")
    ...
    @property
    @pulumi.getter
    def liveness(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Container survival status monitoring, format such as: `{"failureThreshold": 3,"initialDelaySeconds": 5,"successThreshold": 1,"timeoutSeconds": 1,"tcpSocket":{"host":"", "port":8080} }`.
        """
        return pulumi.get(self, "liveness")
    ...
    @property
    @pulumi.getter(name="localVolume")
    def local_volume(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The configuration of the host file mounted to the container. For example: `[{"type":"","nodePath":"/localfiles","mountPath":"/app/files"},{"type":"Directory","nodePath":"/mnt", "mountPath":"/app/storage"}]`. Among them, nodePath is the host path; mountPath is the path in the container; type is the mount type.
        """
        return pulumi.get(self, "local_volume")
    ...
    @property
    @pulumi.getter(name="logicalRegionId")
    def logical_region_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID corresponding to the EDAS namespace, the non-default namespace must be filled in.
        """
        return pulumi.get(self, "logical_region_id")
    ...
    @property
    @pulumi.getter(name="mountDescs")
    def mount_descs(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Mount configuration description, as a serialized JSON. For example: `[{"nasPath": "/k8s","mountPath": "/mnt"},{"nasPath": "/files","mountPath": "/app/files"}]`. Among them, nasPath refers to the file storage path; mountPath refers to the path mounted in the container.
        """
        return pulumi.get(self, "mount_descs")
    ...
    @property
    @pulumi.getter(name="nasId")
    def nas_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the mounted NAS must be in the same region as the cluster. It must have an available mount point creation quota, or its mount point must be on a switch in the VPC. If it is not filled in and the mountDescs field exists, a NAS will be automatically purchased and mounted on the switch in the VPC by default.
        """
        return pulumi.get(self, "nas_id")
    ...
    @property
    @pulumi.getter(name="postStart")
    def post_start(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Execute script after startup
        """
        return pulumi.get(self, "post_start")
    ...
    @property
    @pulumi.getter(name="preStop")
    def pre_stop(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Execute script before stopping
        """
        return pulumi.get(self, "pre_stop")
    ...
    @property
    @pulumi.getter
    def readiness(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Container service status check. If the check fails, the traffic passing through K8s Service will not be transferred to the container. The format is: `{"failureThreshold": 3,"initialDelaySeconds": 5,"successThreshold": 1,"timeoutSeconds": 1, "httpGet": {"path": "/consumer","port": 8080,"scheme": "HTTP","httpHeaders": [{"name": "test","value": "testvalue"} ]}}`.
        """
        return pulumi.get(self, "readiness")
    ...
    @property
    @pulumi.getter
    def replicas(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of application instances.
        """
        return pulumi.get(self, "replicas")
    ...
    @property
    @pulumi.getter(name="requestsMCpu")
    def requests_m_cpu(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        When the application is created, the CPU quota of the application instance, unit: number of millcores, similar to request_cpu
        """
        return pulumi.get(self, "requests_m_cpu")
    ...
    @property
    @pulumi.getter(name="requestsMem")
    def requests_mem(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        When the application is created, the memory limit of the application instance, unit: M. When set to 0, it means unlimited.
        """
        return pulumi.get(self, "requests_mem")
