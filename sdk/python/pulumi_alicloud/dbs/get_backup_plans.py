...
class GetBackupPlansResult:
    ...
    def backup_plan_name(self) -> Optional[_builtins.str]:
...
def get_backup_plans(backup_plan_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool enable_details: Default to `true`. Set it to `false` can hide the `payment_type` to output.
    :param Sequence[_builtins.str] ids: A list of Backup Plan IDs.
    :param _builtins.str name_regex: A regex string to filter results by Backup Plan name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str status: The status of the resource. Valid values: `check_pass`, `init`, `locked`, `pause`, `running`, `stop`, `wait`.
    """
    __args__ = dict()
...
def get_backup_plans_output(backup_plan_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
