...
class DnatEntryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] external_port: The public port.Value range: 1 to 65535 or "any".
        :param pulumi.Input[builtins.str] internal_ip: The destination private IP address.
        :param pulumi.Input[builtins.str] internal_port: The destination private port.Value range: 1 to 65535 or "any".
        :param pulumi.Input[builtins.str] ip_protocol: The protocol type. Valid values: TCP: Forwards packets of the TCP protocol. UDP: Forwards packets of the UDP protocol. Any: Forwards packets of all protocols.
        :param pulumi.Input[builtins.str] sag_id: The ID of the SAG instance.
        :param pulumi.Input[builtins.str] type: The DNAT type. Valid values: Intranet: DNAT of private IP addresses. Internet: DNAT of public IP addresses
        :param pulumi.Input[builtins.str] external_ip: The external public IP address.when "type" is "Internet",automatically identify the external ip.
        """
...
class DnatEntry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip_protocol: Optional[pulumi.Input[builtins.str]] = None,
            sag_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'DnatEntry':
        """
    ...
    @property
    @pulumi.getter(name="externalIp")
    def external_ip(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The external public IP address.when "type" is "Internet",automatically identify the external ip.
        """
        return pulumi.get(self, "external_ip")
