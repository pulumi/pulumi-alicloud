...
def get_smartag_flow_logs(description: Optional[builtins.str] = None,
    ...
    :param builtins.str name_regex: A regex string to filter results by Flow Log name.
...
def get_smartag_flow_logs_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
