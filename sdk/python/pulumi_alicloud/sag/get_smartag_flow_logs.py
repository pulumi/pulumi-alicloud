...
__all__ = [
    ...
    'AwaitableGetSmartagFlowLogsResult',
    'get_smartag_flow_logs',
    'get_smartag_flow_logs_output',
]
...
class GetSmartagFlowLogsResult:
    ...
    """
    def __init__(__self__, description=None, id=None, ids=None, logs=None, name_regex=None, names=None, output_file=None, page_number=None, page_size=None, status=None):
    ...
    @_builtins.property
    @pulumi.getter
    def logs(self) -> Sequence['outputs.GetSmartagFlowLogsLogResult']:
...
class AwaitableGetSmartagFlowLogsResult(GetSmartagFlowLogsResult):
...
def get_smartag_flow_logs(description: Optional[_builtins.str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmartagFlowLogsResult:
    """
    ...
    :param _builtins.str name_regex: A regex string to filter results by Flow Log name.
...
def get_smartag_flow_logs_output(description: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
