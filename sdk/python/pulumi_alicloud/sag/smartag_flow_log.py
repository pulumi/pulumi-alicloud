...
class SmartagFlowLogArgs:
    def __init__(__self__, *,
                 ...
                 active_aging: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 flow_log_name: Optional[pulumi.Input[builtins.str]] = None,
                 inactive_aging: Optional[pulumi.Input[builtins.int]] = None,
                 logstore_name: Optional[pulumi.Input[builtins.str]] = None,
                 netflow_server_ip: Optional[pulumi.Input[builtins.str]] = None,
                 netflow_server_port: Optional[pulumi.Input[builtins.int]] = None,
                 netflow_version: Optional[pulumi.Input[builtins.str]] = None,
                 project_name: Optional[pulumi.Input[builtins.str]] = None,
                 sls_region_id: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SmartagFlowLog resource.
        :param pulumi.Input[builtins.str] output_type: The location where the flow log is stored. Valid values:
        :param pulumi.Input[builtins.int] active_aging: The time interval at which log data of active connections is collected. Valid values: `60` to `6000`. Default value: `300`. Unit: second.
        :param pulumi.Input[builtins.str] description: The description of the flow log.
        :param pulumi.Input[builtins.str] flow_log_name: The name of the flow log.
        :param pulumi.Input[builtins.int] inactive_aging: The time interval at which log data of inactive connections is connected. Valid values: `10` to `600`. Default value: `15`. Unit: second.
        :param pulumi.Input[builtins.str] logstore_name: The Logstore in Log Service. If `output_type` is set to `sls` or `all`, this parameter is required.
        :param pulumi.Input[builtins.str] netflow_server_ip: The IP address of the NetFlow collector where the flow log is stored. If `output_type` is set to `netflow` or `all`, this parameter is required.
        :param pulumi.Input[builtins.int] netflow_server_port: The port of the NetFlow collector. Default value: `9995`. If `output_type` is set to `netflow` or `all`, this parameter is required.
        :param pulumi.Input[builtins.str] netflow_version: The NetFlow version. Default value: `V9`. Valid values: `V10`, `V5`, `V9`. If `output_type` is set to `netflow` or `all`, this parameter is required.
        :param pulumi.Input[builtins.str] project_name: The project in Log Service. If `output_type` is set to `sls` or `all`, this parameter is required.
        :param pulumi.Input[builtins.str] sls_region_id: The ID of the region where Log Service is deployed. If `output_type` is set to `sls` or `all`, this parameter is required.
        :param pulumi.Input[builtins.str] status: The status of the flow log. Valid values:  `Active`: The flow log is enabled. `Inactive`: The flow log is disabled.
        """
    ...
    def active_aging(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @active_aging.setter
    def active_aging(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def inactive_aging(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def inactive_aging(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def netflow_server_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def netflow_server_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "netflow_server_ip", value)

    @property
    @pulumi.getter(name="netflowServerPort")
    def netflow_server_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def netflow_server_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "netflow_server_port", value)

    @property
    @pulumi.getter(name="netflowVersion")
    def netflow_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def netflow_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sls_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sls_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SmartagFlowLog(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_name: Optional[pulumi.Input[builtins.str]] = None,
            sls_region_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'SmartagFlowLog':
        """
    ...
    @property
    @pulumi.getter(name="activeAging")
    def active_aging(self) -> pulumi.Output[builtins.int]:
        """
        The time interval at which log data of active connections is collected. Valid values: `60` to `6000`. Default value: `300`. Unit: second.
        """
        return pulumi.get(self, "active_aging")
    ...
    @property
    @pulumi.getter(name="inactiveAging")
    def inactive_aging(self) -> pulumi.Output[builtins.int]:
        """
        The time interval at which log data of inactive connections is connected. Valid values: `10` to `600`. Default value: `15`. Unit: second.
        """
        return pulumi.get(self, "inactive_aging")
    ...
    @property
    @pulumi.getter(name="logstoreName")
    def logstore_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Logstore in Log Service. If `output_type` is set to `sls` or `all`, this parameter is required.
        """
        return pulumi.get(self, "logstore_name")
    ...
    @property
    @pulumi.getter(name="netflowServerIp")
    def netflow_server_ip(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IP address of the NetFlow collector where the flow log is stored. If `output_type` is set to `netflow` or `all`, this parameter is required.
        """
        return pulumi.get(self, "netflow_server_ip")
    ...
    @property
    @pulumi.getter(name="netflowServerPort")
    def netflow_server_port(self) -> pulumi.Output[builtins.int]:
        """
        The port of the NetFlow collector. Default value: `9995`. If `output_type` is set to `netflow` or `all`, this parameter is required.
        """
        return pulumi.get(self, "netflow_server_port")
    ...
    @property
    @pulumi.getter(name="netflowVersion")
    def netflow_version(self) -> pulumi.Output[builtins.str]:
        """
        The NetFlow version. Default value: `V9`. Valid values: `V10`, `V5`, `V9`. If `output_type` is set to `netflow` or `all`, this parameter is required.
        """
        return pulumi.get(self, "netflow_version")
    ...
    @property
    @pulumi.getter(name="slsRegionId")
    def sls_region_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the region where Log Service is deployed. If `output_type` is set to `sls` or `all`, this parameter is required.
        """
        return pulumi.get(self, "sls_region_id")
