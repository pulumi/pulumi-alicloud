...
def get_acls(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Sag Acl IDs.
    :param builtins.str name_regex: A regex string to filter Sag Acl instances by name.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_acls_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
