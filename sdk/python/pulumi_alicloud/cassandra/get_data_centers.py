...
def get_data_centers(cluster_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: The list of Cassandra data center ids.
    :param builtins.str name_regex: A regex string to apply to the cluster name.
    :param builtins.str output_file: The name of file that can save the collection of data centers after running `pulumi preview`.
    """
    __args__ = dict()
...
def get_data_centers_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
