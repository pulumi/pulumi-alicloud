...
class GetBackupPlansPlanResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool active: Specifies whether to activate the backup plan.
        :param builtins.str backup_period: The backup cycle. Valid values: Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, and Sunday.
        :param builtins.str backup_time: The start time of the backup task each day. The time is displayed in UTC and denoted by Z.
        :param builtins.str cluster_id: The ID of the cluster for the backup.
        :param builtins.str create_time: The time when the backup plan was created.
        :param builtins.str data_center_id: The ID of the data center for the backup in the cluster.
        :param builtins.str id: The ID of the Backup Plan.
        :param builtins.int retention_period: The duration for which you want to retain the backup. Valid values: 1 to 30. Unit: days.
        """
...
class GetClustersClusterResult(dict):
    def __init__(__self__, *,
                 ...
                 data_center_count: builtins.int,
        ...
        """
        :param builtins.str cluster_id: The ID of the Cassandra cluster.
        :param builtins.str cluster_name: The name of the Cassandra cluster.
        :param builtins.int data_center_count: The count of data centers
        :param builtins.str expire_time: The expire time of the cluster.
        :param builtins.str id: The ID of the Cassandra cluster.
        :param builtins.str lock_mode: The lock mode of the cluster.
        :param builtins.str major_version: The major version of the cluster.
        :param builtins.str minor_version: The minor version of the cluster.
        :param builtins.str pay_type: Billing method. Value options are `Subscription` for Pay-As-You-Go and `PayAsYouGo` for yearly or monthly subscription.
        :param builtins.str status: Status of the cluster.
    ...
    def data_center_count(self) -> builtins.int:
        """
...
class GetDataCentersCenterResult(dict):
    def __init__(__self__, *,
                 cluster_id: builtins.str,
                 commodity_instance: builtins.str,
                 created_time: builtins.str,
                 data_center_id: builtins.str,
                 data_center_name: builtins.str,
        ...
        """
        :param builtins.str cluster_id: The cluster id of dataCenters belongs to.
        :param builtins.str commodity_instance: The commodity ID of the Cassandra dataCenter.
        :param builtins.str data_center_id: The id of the Cassandra dataCenter.
        :param builtins.str data_center_name: The name of the Cassandra dataCenter.
        :param builtins.int disk_size: One node disk size, unit:GB.
        :param builtins.str disk_type: Cloud_ssd or cloud_efficiency.
        :param builtins.str expire_time: The expire time of the dataCenter.
        :param builtins.str instance_type: The instance type of the Cassandra dataCenter, eg: cassandra.c.large.
        :param builtins.str lock_mode: The lock mode of the dataCenter.
        :param builtins.int node_count: The node count of dataCenter.
        :param builtins.str pay_type: Billing method. Value options are `Subscription` for Pay-As-You-Go and `PayAsYouGo` for yearly or monthly subscription.
        :param builtins.str status: Status of the dataCenter.
        :param builtins.str vpc_id: VPC ID the dataCenter belongs to.
        :param builtins.str vswitch_id: VSwitch ID the dataCenter belongs to.
        :param builtins.str zone_id: Zone ID the dataCenter belongs to.
        """
        pulumi.set(__self__, "cluster_id", cluster_id)
    ...
    def commodity_instance(self) -> builtins.str:
        """
    ...
    def data_center_name(self) -> builtins.str:
        """
