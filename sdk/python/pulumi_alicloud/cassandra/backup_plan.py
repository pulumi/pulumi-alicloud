...
class BackupPlanArgs:
    def __init__(__self__, *,
                 backup_time: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] backup_time: The start time of the backup task each day. The time is displayed in UTC and denoted by Z.
        :param pulumi.Input[builtins.str] cluster_id: The ID of the cluster for the backup.
        :param pulumi.Input[builtins.str] data_center_id: The ID of the data center for the backup in the cluster.
        :param pulumi.Input[builtins.bool] active: Specifies whether to activate the backup plan. Valid values: `True`, `False`. Default value: `True`.
        :param pulumi.Input[builtins.str] backup_period: The backup cycle. Valid values: `Friday`, `Monday`, `Saturday`, `Sunday`, `Thursday`, `Tuesday`, `Wednesday`.
        :param pulumi.Input[builtins.int] retention_period: The duration for which you want to retain the backup. Valid values: 1 to 30. Unit: days. Default value: `30`.
        """
    ...
    def backup_time(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @backup_time.setter
    def backup_time(self, value: pulumi.Input[builtins.str]):
...
class BackupPlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cluster_id: Optional[pulumi.Input[builtins.str]] = None,
            data_center_id: Optional[pulumi.Input[builtins.str]] = None,
            retention_period: Optional[pulumi.Input[builtins.int]] = None) -> 'BackupPlan':
        """
