...
def get_clusters(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: The list of Cassandra cluster ids.
    :param builtins.str name_regex: A regex string to apply to the cluster name.
    :param builtins.str output_file: The name of file that can save the collection of clusters after running `pulumi preview`.
