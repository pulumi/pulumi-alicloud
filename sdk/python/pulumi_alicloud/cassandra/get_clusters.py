...
def get_clusters(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: The list of Cassandra cluster ids.
    :param _builtins.str name_regex: A regex string to apply to the cluster name.
    :param _builtins.str output_file: The name of file that can save the collection of clusters after running `pulumi preview`.
...
def get_clusters_output(ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
