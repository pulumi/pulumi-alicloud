...
class GetGlobalDatabaseNetworksResult:
    ...
    def db_cluster_id(self) -> Optional[builtins.str]:
        """
    ...
    def gdn_id(self) -> Optional[builtins.str]:
        """
...
def get_global_database_networks(db_cluster_id: Optional[builtins.str] = None,
                                 description: Optional[builtins.str] = None,
                                 gdn_id: Optional[builtins.str] = None,
    ...
    :param builtins.str db_cluster_id: The ID of the cluster.
    :param builtins.str description: The description of the Global Database Network.
    :param builtins.str gdn_id: The ID of the Global Database Network.
    :param Sequence[builtins.str] ids: A list of Global Database Network IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the Global Database Network. Valid values:
    """
    __args__ = dict()
...
def get_global_database_networks_output(db_cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        gdn_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
