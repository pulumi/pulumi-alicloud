...
def get_global_database_networks_output(db_cluster_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        description: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        gdn_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
