...
def get_clusters(db_type: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of PolarDB cluster IDs.
...
def get_clusters_output(db_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
