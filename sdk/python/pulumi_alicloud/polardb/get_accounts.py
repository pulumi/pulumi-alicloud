...
def get_accounts(db_cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str db_cluster_id: The polarDB cluster ID.
...
def get_accounts_output(db_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:polardb/getAccounts:getAccounts', __args__, opts=opts, typ=GetAccountsResult)
