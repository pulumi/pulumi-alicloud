...
def get_zones(multi: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool multi: Indicate whether the zones can be used in a multi AZ configuration. Default to `false`. Multi AZ is usually used to launch PolarDB instances.
