...
class EndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] endpoint_type: Type of the endpoint. Before v1.121.0, it only can be `Custom`. since v1.121.0, `Custom`, `Cluster`, `Primary` are valid, default to `Custom`. However when creating a new endpoint, it also only can be `Custom`.
...
class _EndpointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] db_cluster_id: The Id of cluster that can run database.
        :param pulumi.Input[_builtins.str] db_endpoint_description: The name of the endpoint.
        :param pulumi.Input[_builtins.str] db_endpoint_id: (Available since v1.161.0) The ID of the cluster endpoint.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] endpoint_config: The advanced settings of the endpoint of Apsara PolarDB clusters are in JSON format. Including the settings of consistency level, transaction splitting, connection pool, and offload reads from primary node. For more details, see the [description of EndpointConfig in the Request parameters table for details](https://www.alibabacloud.com/help/doc-detail/116593.htm).
        :param pulumi.Input[_builtins.str] endpoint_type: Type of the endpoint. Before v1.121.0, it only can be `Custom`. since v1.121.0, `Custom`, `Cluster`, `Primary` are valid, default to `Custom`. However when creating a new endpoint, it also only can be `Custom`.
        :param pulumi.Input[_builtins.str] net_type: The network type of the endpoint address.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] nodes: Node id list for endpoint configuration. At least 2 nodes if specified, or if the cluster has more than 3 nodes, read-only endpoint is allowed to mount only one node. Default is all nodes.
        ...
        :param pulumi.Input[_builtins.str] ssl_enabled: Specifies how to modify the SSL encryption status. Valid values: `Disable`, `Enable`, `Update`.
        :param pulumi.Input[_builtins.str] ssl_expire_time: (Available since v1.121.0) The time when the SSL certificate expires. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        """
        if auto_add_new_nodes is not None:
            pulumi.set(__self__, "auto_add_new_nodes", auto_add_new_nodes)
        if connection_prefix is not None:
...
class Endpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssl_connection_string: Optional[pulumi.Input[_builtins.str]] = None,
            ssl_enabled: Optional[pulumi.Input[_builtins.str]] = None,
            ssl_expire_time: Optional[pulumi.Input[_builtins.str]] = None) -> 'Endpoint':
        """
