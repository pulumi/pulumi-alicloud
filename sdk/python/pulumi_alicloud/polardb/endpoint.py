...
class EndpointArgs:
    def __init__(__self__, *,
                 db_cluster_id: pulumi.Input[builtins.str],
                 auto_add_new_nodes: Optional[pulumi.Input[builtins.str]] = None,
                 connection_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 db_endpoint_description: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_config: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 ssl_auto_rotate: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_enabled: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Endpoint resource.
        :param pulumi.Input[builtins.str] db_cluster_id: The Id of cluster that can run database.
        :param pulumi.Input[builtins.str] auto_add_new_nodes: Whether the new node automatically joins the default cluster address. Valid values are `Enable`, `Disable`. When creating a new custom endpoint, default to `Disable`.
        :param pulumi.Input[builtins.str] connection_prefix: Prefix of the specified endpoint. The prefix must be 6 to 30 characters in length, and can contain lowercase letters, digits, and hyphens (-), must start with a letter and end with a digit or letter.
        :param pulumi.Input[builtins.str] db_endpoint_description: The name of the endpoint.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] endpoint_config: The advanced settings of the endpoint of Apsara PolarDB clusters are in JSON format. Including the settings of consistency level, transaction splitting, connection pool, and offload reads from primary node. For more details, see the [description of EndpointConfig in the Request parameters table for details](https://www.alibabacloud.com/help/doc-detail/116593.htm).
        :param pulumi.Input[builtins.str] endpoint_type: Type of the endpoint. Before v1.121.0, it only can be `Custom`. since v1.121.0, `Custom`, `Cluster`, `Primary` are valid, default to `Custom`. However when creating a new endpoint, it also only can be `Custom`.
        :param pulumi.Input[builtins.str] net_type: The network type of the endpoint address.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nodes: Node id list for endpoint configuration. At least 2 nodes if specified, or if the cluster has more than 3 nodes, read-only endpoint is allowed to mount only one node. Default is all nodes.
        :param pulumi.Input[builtins.str] port: Port of the specified endpoint. Valid values: 3000 to 5999.
        :param pulumi.Input[builtins.str] read_write_mode: Read or write mode. Valid values are `ReadWrite`, `ReadOnly`. When creating a new custom endpoint, default to `ReadOnly`.
        :param pulumi.Input[builtins.str] ssl_auto_rotate: Specifies whether automatic rotation of SSL certificates is enabled. Valid values: `Enable`,`Disable`.
        :param pulumi.Input[builtins.str] ssl_enabled: Specifies how to modify the SSL encryption status. Valid values: `Disable`, `Enable`, `Update`.
        """
    ...
    def db_cluster_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_cluster_id(self, value: pulumi.Input[builtins.str]):
    ...
    def db_endpoint_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_endpoint_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_endpoint_description", value)

    @property
    @pulumi.getter(name="endpointConfig")
    def endpoint_config(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        The advanced settings of the endpoint of Apsara PolarDB clusters are in JSON format. Including the settings of consistency level, transaction splitting, connection pool, and offload reads from primary node. For more details, see the [description of EndpointConfig in the Request parameters table for details](https://www.alibabacloud.com/help/doc-detail/116593.htm).
        """
    ...
    def endpoint_config(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def ssl_auto_rotate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ssl_auto_rotate(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EndpointState:
    def __init__(__self__, *,
                 auto_add_new_nodes: Optional[pulumi.Input[builtins.str]] = None,
                 connection_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 db_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                 db_endpoint_description: Optional[pulumi.Input[builtins.str]] = None,
                 db_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_config: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 endpoint_type: Optional[pulumi.Input[builtins.str]] = None,
                 net_type: Optional[pulumi.Input[builtins.str]] = None,
                 nodes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 read_write_mode: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_auto_rotate: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_certificate_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] db_cluster_id: The Id of cluster that can run database.
        :param pulumi.Input[builtins.str] db_endpoint_description: The name of the endpoint.
        :param pulumi.Input[builtins.str] db_endpoint_id: (Available since v1.161.0) The ID of the cluster endpoint.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] endpoint_config: The advanced settings of the endpoint of Apsara PolarDB clusters are in JSON format. Including the settings of consistency level, transaction splitting, connection pool, and offload reads from primary node. For more details, see the [description of EndpointConfig in the Request parameters table for details](https://www.alibabacloud.com/help/doc-detail/116593.htm).
        :param pulumi.Input[builtins.str] endpoint_type: Type of the endpoint. Before v1.121.0, it only can be `Custom`. since v1.121.0, `Custom`, `Cluster`, `Primary` are valid, default to `Custom`. However when creating a new endpoint, it also only can be `Custom`.
        :param pulumi.Input[builtins.str] net_type: The network type of the endpoint address.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nodes: Node id list for endpoint configuration. At least 2 nodes if specified, or if the cluster has more than 3 nodes, read-only endpoint is allowed to mount only one node. Default is all nodes.
        ...
        :param pulumi.Input[builtins.str] read_write_mode: Read or write mode. Valid values are `ReadWrite`, `ReadOnly`. When creating a new custom endpoint, default to `ReadOnly`.
        :param pulumi.Input[builtins.str] ssl_auto_rotate: Specifies whether automatic rotation of SSL certificates is enabled. Valid values: `Enable`,`Disable`.
        :param pulumi.Input[builtins.str] ssl_certificate_url: Specifies SSL certificate download link.  
               **NOTE:** For a PolarDB for MySQL cluster, this parameter is required, and only one connection string in each endpoint can enable the ssl, for other notes, see [Configure SSL encryption](https://www.alibabacloud.com/help/doc-detail/153182.htm).
               For a PolarDB for PostgreSQL cluster or a PolarDB-O cluster, this parameter is not required, by default, SSL encryption is enabled for all endpoints.
        :param pulumi.Input[builtins.str] ssl_connection_string: (Available since v1.121.0) The SSL connection string.
        :param pulumi.Input[builtins.str] ssl_enabled: Specifies how to modify the SSL encryption status. Valid values: `Disable`, `Enable`, `Update`.
        :param pulumi.Input[builtins.str] ssl_expire_time: (Available since v1.121.0) The time when the SSL certificate expires. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        """
        if auto_add_new_nodes is not None:
            pulumi.set(__self__, "auto_add_new_nodes", auto_add_new_nodes)
        if connection_prefix is not None:
    ...
    @property
    @pulumi.getter(name="dbClusterId")
    def db_cluster_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Id of cluster that can run database.
        """
        return pulumi.get(self, "db_cluster_id")
    ...
    @db_cluster_id.setter
    def db_cluster_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_cluster_id", value)
    ...
    def db_endpoint_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_endpoint_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ssl_certificate_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ssl_certificate_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("alicloud:polardb/endpoint:Endpoint")
class Endpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssl_connection_string: Optional[pulumi.Input[builtins.str]] = None,
            ssl_enabled: Optional[pulumi.Input[builtins.str]] = None,
            ssl_expire_time: Optional[pulumi.Input[builtins.str]] = None) -> 'Endpoint':
        """
    ...
    @property
    @pulumi.getter(name="dbClusterId")
    def db_cluster_id(self) -> pulumi.Output[builtins.str]:
        """
        The Id of cluster that can run database.
        """
        return pulumi.get(self, "db_cluster_id")
    ...
    @property
    @pulumi.getter(name="dbEndpointDescription")
    def db_endpoint_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the endpoint.
        """
        return pulumi.get(self, "db_endpoint_description")
    ...
    @property
    @pulumi.getter(name="dbEndpointId")
    def db_endpoint_id(self) -> pulumi.Output[builtins.str]:
        """
        (Available since v1.161.0) The ID of the cluster endpoint.
        """
        return pulumi.get(self, "db_endpoint_id")
    ...
    @property
    @pulumi.getter(name="endpointConfig")
    def endpoint_config(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        The advanced settings of the endpoint of Apsara PolarDB clusters are in JSON format. Including the settings of consistency level, transaction splitting, connection pool, and offload reads from primary node. For more details, see the [description of EndpointConfig in the Request parameters table for details](https://www.alibabacloud.com/help/doc-detail/116593.htm).
        """
        return pulumi.get(self, "endpoint_config")
    ...
    @property
    @pulumi.getter
    def nodes(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Node id list for endpoint configuration. At least 2 nodes if specified, or if the cluster has more than 3 nodes, read-only endpoint is allowed to mount only one node. Default is all nodes.
        """
        return pulumi.get(self, "nodes")
    ...
    @property
    @pulumi.getter(name="sslAutoRotate")
    def ssl_auto_rotate(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether automatic rotation of SSL certificates is enabled. Valid values: `Enable`,`Disable`.
        """
        return pulumi.get(self, "ssl_auto_rotate")
    ...
    @property
    @pulumi.getter(name="sslCertificateUrl")
    def ssl_certificate_url(self) -> pulumi.Output[builtins.str]:
        """
        Specifies SSL certificate download link.  
        **NOTE:** For a PolarDB for MySQL cluster, this parameter is required, and only one connection string in each endpoint can enable the ssl, for other notes, see [Configure SSL encryption](https://www.alibabacloud.com/help/doc-detail/153182.htm).
        For a PolarDB for PostgreSQL cluster or a PolarDB-O cluster, this parameter is not required, by default, SSL encryption is enabled for all endpoints.
    ...
    @property
    @pulumi.getter(name="sslEnabled")
    def ssl_enabled(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies how to modify the SSL encryption status. Valid values: `Disable`, `Enable`, `Update`.
        """
        return pulumi.get(self, "ssl_enabled")
