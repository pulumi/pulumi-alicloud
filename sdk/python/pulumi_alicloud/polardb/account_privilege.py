...
class AccountPrivilegeArgs:
    def __init__(__self__, *,
                 ...
                 db_names: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[builtins.str] account_name: A specified account name.
        :param pulumi.Input[builtins.str] db_cluster_id: The Id of cluster in which account belongs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] db_names: List of specified database name.
        :param pulumi.Input[builtins.str] account_privilege: The privilege of one account access database. Valid values: ["ReadOnly", "ReadWrite"], ["DMLOnly", "DDLOnly"] added since version v1.101.0. Default to "ReadOnly".
        """
    ...
    def db_names(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @db_names.setter
    def db_names(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class AccountPrivilege(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:polardb/accountPrivilege:AccountPrivilege"
    ...
    def get(resource_name: str,
            ...
            account_privilege: Optional[pulumi.Input[builtins.str]] = None,
            db_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
            db_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'AccountPrivilege':
        """
    ...
    @property
    @pulumi.getter(name="dbNames")
    def db_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of specified database name.
        """
        return pulumi.get(self, "db_names")
