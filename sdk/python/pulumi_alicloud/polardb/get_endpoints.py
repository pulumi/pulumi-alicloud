...
class GetEndpointsResult:
    ...
    def db_endpoint_id(self) -> Optional[builtins.str]:
        """
        The endpoint ID.
        """
...
def get_endpoints(db_cluster_id: Optional[builtins.str] = None,
                  db_endpoint_id: Optional[builtins.str] = None,
    ...
    :param builtins.str db_cluster_id: PolarDB cluster ID.
...
def get_endpoints_output(db_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                         db_endpoint_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
