...
class ClusterDbClusterIpArray(dict):
    ...
    def __init__(__self__, *,
                 ...
                 modify_mode: Optional[builtins.str] = None,
                 security_ips: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str db_cluster_ip_array_name: The name of the IP whitelist group. The group name must be 2 to 120 characters in length and consists of lowercase letters and digits. It must start with a letter, and end with a letter or a digit.
        ...
        :param builtins.str modify_mode: The method for modifying the IP whitelist. Valid values are `Cover`, `Append`, `Delete`.
               **NOTE:** There does not recommend setting modify_mode to `Append` or `Delete` and it will bring a potential diff error.
        :param Sequence[builtins.str] security_ips: List of IP addresses allowed to access all databases of a cluster. The list contains up to 1,000 IP addresses, separated by commas. Supported formats include 0.0.0.0/0, 10.23.12.24 (IP), and 10.23.12.24/24 (Classless Inter-Domain Routing (CIDR) mode. /24 represents the length of the prefix in an IP address. The range of the prefix length is [1,32]).
        """
    ...
    def modify_mode(self) -> Optional[builtins.str]:
        """
    ...
    def security_ips(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ClusterDbRevisionVersionList(dict):
    ...
    def __init__(__self__, *,
                 release_note: Optional[builtins.str] = None,
                 release_type: Optional[builtins.str] = None,
                 revision_version_code: Optional[builtins.str] = None,
                 revision_version_name: Optional[builtins.str] = None):
        """
        :param builtins.str release_note: (Available since v1.216.0) The revised version Code of the database engine is used to specify the upgrade to the target version.
        :param builtins.str release_type: (Available since v1.216.0) Database version release status. Valid values are `Stable`, `Old`, `HighRisk`.
        :param builtins.str revision_version_code: (Available since v1.216.0) The revised version Code of the database engine is used to specify the upgrade to the target version.
        :param builtins.str revision_version_name: (Available since v1.216.0) The revision version number of the database engine.
        """
    ...
    def release_note(self) -> Optional[builtins.str]:
        """
    ...
    def revision_version_code(self) -> Optional[builtins.str]:
        """
        (Available since v1.216.0) The revised version Code of the database engine is used to specify the upgrade to the target version.
        """
    ...
    def revision_version_name(self) -> Optional[builtins.str]:
        """
...
class ClusterParameter(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: Kernel parameter name.
        :param builtins.str value: Kernel parameter value.
        """
...
class ParameterGroupParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str param_name: The name of a parameter in the parameter template.
        :param builtins.str param_value: The value of a parameter in the parameter template.
        """
...
class GetAccountsAccountResult(dict):
    def __init__(__self__, *,
                 ...
                 account_lock_state: builtins.str,
        ...
        """
        :param builtins.str account_description: Account description.
        :param builtins.str account_lock_state: Account lock state, Valid values are `Lock`, `UnLock`.
        :param builtins.str account_name: Account name.
        :param builtins.str account_status: Cluster address type.`Cluster`: the default address of the Cluster.`Primary`: Primary address.`Custom`: Custom cluster addresses.
        :param builtins.str account_type: Account type, Valid values are `Normal`, `Super`.
    ...
    def account_lock_state(self) -> builtins.str:
        """
...
class GetAccountsAccountDatabasePrivilegeResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str account_privilege: Account privilege of database
        :param builtins.str db_name: The account owned database name
        """
...
class GetClustersClusterResult(dict):
    def __init__(__self__, *,
                 ...
                 status: builtins.str,
                 storage_used: builtins.int,
                 vpc_id: builtins.str,
                 zone_id: builtins.str):
        """
        :param builtins.str charge_type: Billing method. Value options: `PostPaid` for Pay-As-You-Go and `PrePaid` for subscription.
        :param builtins.str connection_string: PolarDB cluster connection string.
        :param builtins.str create_time: The create_time of the db_nodes.
        :param builtins.str db_node_class: The db_node_class of the db_nodes.
        :param builtins.int db_node_number: The DBNodeNumber of the PolarDB cluster.
        :param Sequence['GetClustersClusterDbNodeArgs'] db_nodes: The DBNodes of the PolarDB cluster.
        :param builtins.str db_type: Database type. Options are `MySQL`, `Oracle` and `PostgreSQL`. If no value is specified, all types are returned.
        :param builtins.str db_version: The DBVersion of the PolarDB cluster.
        :param builtins.int delete_lock: The DeleteLock of the PolarDB cluster.
        :param builtins.str description: The description of the PolarDB cluster.
        :param builtins.str engine: The database engine of the cluster, example: POLARDB.
        :param builtins.str expire_time: Expiration time. Pay-As-You-Go clusters never expire.
        :param builtins.str expired: The expired of the PolarDB cluster.
        :param builtins.str id: The ID of the PolarDB cluster.
        :param builtins.str lock_mode: The LockMode of the PolarDB cluster.
        :param builtins.str network_type: The DBClusterNetworkType of the PolarDB cluster.
        :param builtins.str port: PolarDB cluster connection port.
        :param builtins.str region_id: The region_id of the db_nodes.
        :param builtins.str status: status of the cluster.
        :param builtins.int storage_used: The StorageUsed of the PolarDB cluster.
        :param builtins.str vpc_id: ID of the VPC the cluster belongs to.
        :param builtins.str zone_id: The zone_id of the db_nodes.
        """
    ...
    def db_node_number(self) -> builtins.int:
        """
    ...
    def delete_lock(self) -> builtins.int:
        """
    ...
    def storage_used(self) -> builtins.int:
        """
...
class GetClustersClusterDbNodeResult(dict):
    def __init__(__self__, *,
                 ...
                 db_node_role: builtins.str,
                 db_node_status: builtins.str,
        ...
        :param builtins.str create_time: The create_time of the db_nodes.
        :param builtins.str db_node_class: The db_node_class of the db_nodes.
        :param builtins.str db_node_id: The db_node_id of the db_nodes.
        :param builtins.str db_node_role: The db_node_role of the db_nodes.
        :param builtins.str db_node_status: The db_node_status of the db_nodes.
        :param builtins.int max_connections: The max_connections of the db_nodes.
        :param builtins.int max_iops: The max_iops of the db_nodes.
        :param builtins.str region_id: The region_id of the db_nodes.
        :param builtins.str zone_id: The zone_id of the db_nodes.
        """
        pulumi.set(__self__, "create_time", create_time)
    ...
    def db_node_role(self) -> builtins.str:
        """
    ...
    def db_node_status(self) -> builtins.str:
        """
...
class GetDatabasesDatabaseResult(dict):
    def __init__(__self__, *,
                 ...
                 db_description: builtins.str,
                 db_name: builtins.str,
                 db_status: builtins.str,
                 engine: builtins.str):
        """
        ...
        :param builtins.str character_set_name: The character set name of database.
        :param builtins.str db_description: Database description.
        :param builtins.str db_name: Database name.
        :param builtins.str db_status: The status of database.
        :param builtins.str engine: The engine of database.
        """
    ...
    def db_description(self) -> builtins.str:
        """
...
class GetDatabasesDatabaseAccountResult(dict):
    def __init__(__self__, *,
                 account_name: builtins.str,
                 account_status: builtins.str,
                 privilege_status: builtins.str):
        """
        :param builtins.str account_name: Account name.
        :param builtins.str account_status: Account status.
        :param builtins.str privilege_status: The privilege status of account.
        """
        pulumi.set(__self__, "account_name", account_name)
        pulumi.set(__self__, "account_status", account_status)
    ...
    def privilege_status(self) -> builtins.str:
        """
...
class GetEndpointsEndpointResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str auto_add_new_nodes: Whether the new node is automatically added to the default cluster address.Options are `Enable` and `Disable`.
        :param builtins.str db_endpoint_id: endpoint of the cluster.
        :param builtins.str endpoint_config: The Endpoint configuration. `ConsistLevel`: session consistency level, value:`0`: final consistency,`1`: session consistency;`LoadBalanceStrategy`: load balancing strategy. Based on the automatic scheduling of load, the value is: `load`.
        :param builtins.str endpoint_type: Cluster address type.`Cluster`: the default address of the Cluster.`Primary`: Primary address.`Custom`: Custom cluster addresses.
        :param builtins.str nodes: A list of nodes that connect to the address configuration.
        :param builtins.str read_write_mode: Read-write mode:`ReadWrite`: readable and writable (automatic read-write separation).`ReadOnly`: ReadOnly.
        """
    ...
    def endpoint_config(self) -> builtins.str:
        """
...
class GetEndpointsEndpointAddressItemResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str connection_string: Connection instance string.
        :param builtins.str ip_address: The ip address of connection string.
        :param builtins.str net_type: IP network type:`Public` or `Private`.
        :param builtins.str port: Intranet connection port.
        :param builtins.str vpc_id: ID of the VPC the instance belongs to.
        :param builtins.str vswitch_id: ID of the vSwitch the cluster belongs to.
        """
        pulumi.set(__self__, "connection_string", connection_string)
...
class GetGlobalDatabaseNetworksNetworkResult(dict):
    def __init__(__self__, *,
                 ...
                 status: builtins.str):
        """
        :param builtins.str create_time: The time when the Global Database Network was created. The time is in the YYYY-MM-DDThh:mm:ssZ format. The time is displayed in UTC.
        ...
        :param builtins.str db_type: The type of the database engine. Only MySQL is supported.
        :param builtins.str db_version: The version number of the database engine. Only the 8.0 version is supported.
        ...
        :param builtins.str id: The ID of the Global Database Network.
...
class GetGlobalDatabaseNetworksNetworkDbClusterResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str region_id: The region ID of the cluster.
        :param builtins.str role: The role of the cluster.
        """
...
class GetNodeClassesClassResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str zone_id: The Zone to launch the PolarDB cluster.
        """
...
class GetNodeClassesClassSupportedEngineResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str engine: In the zone, the database type supports classes in the following available_resources.
        """
...
class GetNodeClassesClassSupportedEngineAvailableResourceResult(dict):
    def __init__(__self__, *,
                 db_node_class: builtins.str):
        """
        :param builtins.str db_node_class: The PolarDB node class type by the user.
        """
        pulumi.set(__self__, "db_node_class", db_node_class)
...
class GetParameterGroupsGroupResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 parameter_counts: builtins.int,
                 parameter_group_desc: builtins.str,
                 parameter_group_id: builtins.str,
                 parameter_group_name: builtins.str,
                 parameter_group_type: builtins.str):
        """
        :param builtins.str create_time: The time when the parameter template was created. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        :param builtins.str db_type: The type of the database engine. Only `MySQL` is supported.
        :param builtins.str db_version: The version number of the database engine. Valid values: `5.6`, `5.7`, `8.0`.
        :param builtins.str force_restart: Indicates whether to restart the cluster when this parameter template is applied.
        :param builtins.str id: The ID of the Parameter Group.
        :param builtins.int parameter_counts: The number of parameters in the parameter template.
        :param builtins.str parameter_group_desc: The description of the parameter template.
        :param builtins.str parameter_group_id: The ID of the Parameter Group.
        :param builtins.str parameter_group_name: The name of the parameter template.
        :param builtins.str parameter_group_type: The type of the parameter template.
        """
        pulumi.set(__self__, "create_time", create_time)
        pulumi.set(__self__, "db_type", db_type)
        pulumi.set(__self__, "db_version", db_version)
    ...
    def parameter_counts(self) -> builtins.int:
        """
    ...
    def parameter_group_type(self) -> builtins.str:
        """
