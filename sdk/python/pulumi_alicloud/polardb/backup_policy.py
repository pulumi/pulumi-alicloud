...
class BackupPolicy(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] preferred_backup_periods: PolarDB Cluster backup period. Valid values: [Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday]. Default to ["Tuesday", "Thursday", "Saturday"].
