...
def get_databases(db_cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str name_regex: A regex string to filter results by database name.
    """
    __args__ = dict()
...
def get_databases_output(db_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
