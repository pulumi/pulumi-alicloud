...
class GetNodeClassesResult:
    ...
    def db_node_class(self) -> Optional[_builtins.str]:
        """
...
def get_node_classes(category: Optional[_builtins.str] = None,
                     db_node_class: Optional[_builtins.str] = None,
    ...
    :param _builtins.str category: The PolarDB node cluster series.
    :param _builtins.str db_node_class: The PolarDB node class type by the user.
    :param _builtins.str db_type: Database type. Options are `MySQL`, `PostgreSQL`, `Oracle`. If db_type is set, db_version also needs to be set.
    :param _builtins.str db_version: Database version required by the user. Value options can refer to the latest docs [detail info](https://www.alibabacloud.com/help/doc-detail/98169.htm) `DBVersion`. If db_version is set, db_type also needs to be set.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi up`).
    :param _builtins.str pay_type: Filter the results by charge type. Valid values: `PrePaid` and `PostPaid`.
    :param _builtins.str region_id: The Region to launch the PolarDB cluster.
