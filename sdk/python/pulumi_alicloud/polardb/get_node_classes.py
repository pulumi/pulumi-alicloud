...
class GetNodeClassesResult:
    ...
    def db_node_class(self) -> Optional[builtins.str]:
        """
    ...
    def db_type(self) -> Optional[builtins.str]:
...
def get_node_classes(category: Optional[builtins.str] = None,
                     db_node_class: Optional[builtins.str] = None,
                     db_type: Optional[builtins.str] = None,
                     db_version: Optional[builtins.str] = None,
                     output_file: Optional[builtins.str] = None,
                     pay_type: Optional[builtins.str] = None,
    ...
    :param builtins.str category: The PolarDB node cluster series.
    :param builtins.str db_node_class: The PolarDB node class type by the user.
    :param builtins.str db_type: Database type. Options are `MySQL`, `PostgreSQL`, `Oracle`. If db_type is set, db_version also needs to be set.
    :param builtins.str db_version: Database version required by the user. Value options can refer to the latest docs [detail info](https://www.alibabacloud.com/help/doc-detail/98169.htm) `DBVersion`. If db_version is set, db_type also needs to be set.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi up`).
    :param builtins.str pay_type: Filter the results by charge type. Valid values: `PrePaid` and `PostPaid`.
    :param builtins.str region_id: The Region to launch the PolarDB cluster.
...
def get_node_classes_output(category: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            db_node_class: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            db_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
