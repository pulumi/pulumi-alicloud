...
class EndpointAddressArgs:
    def __init__(__self__, *,
                 ...
                 db_endpoint_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] db_endpoint_id: The Id of endpoint that can run database.
        ...
        :param pulumi.Input[builtins.str] net_type: Internet connection net type. Valid value: `Public`. Default to `Public`. Currently supported only `Public`.
    ...
    def db_endpoint_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_endpoint_id(self, value: pulumi.Input[builtins.str]):
...
class _EndpointAddressState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_prefix: Prefix of the specified endpoint. The prefix must be 6 to 30 characters in length, and can contain lowercase letters, digits, and hyphens (-), must start with a letter and end with a digit or letter.
        :param pulumi.Input[builtins.str] connection_string: Connection cluster or endpoint string.
        :param pulumi.Input[builtins.str] db_cluster_id: The Id of cluster that can run database.
        :param pulumi.Input[builtins.str] db_endpoint_id: The Id of endpoint that can run database.
        :param pulumi.Input[builtins.str] ip_address: The ip address of connection string.
        :param pulumi.Input[builtins.str] net_type: Internet connection net type. Valid value: `Public`. Default to `Public`. Currently supported only `Public`.
        :param pulumi.Input[builtins.str] port: Port of the specified endpoint. Valid values: 3000 to 5999.
        """
        if connection_prefix is not None:
...
class EndpointAddress(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip_address: Optional[pulumi.Input[builtins.str]] = None,
            net_type: Optional[pulumi.Input[builtins.str]] = None,
            port: Optional[pulumi.Input[builtins.str]] = None) -> 'EndpointAddress':
        """
