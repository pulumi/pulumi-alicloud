...
class ParameterGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] db_type: The type of the database engine. Only `MySQL` is supported.
        :param pulumi.Input[builtins.str] db_version: The version number of the database engine. Valid values: `5.6`, `5.7`, `8.0`.
        ...
        :param pulumi.Input[builtins.str] description: The description of the parameter template. It must be 0 to 200 characters in length.
        :param pulumi.Input[builtins.str] name: The name of the parameter template. It must be 8 to 64 characters in length, and can contain letters, digits, and underscores (_). It must start with a letter and cannot contain Chinese characters.
        """
