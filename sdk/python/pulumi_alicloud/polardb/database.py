...
class DatabaseArgs:
    def __init__(__self__, *,
                 ...
                 db_description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Database resource.
        :param pulumi.Input[builtins.str] db_cluster_id: The Id of cluster that can run database.
        :param pulumi.Input[builtins.str] db_name: Name of the database requiring a uniqueness check. It may consist of lower case letters, numbers, and underlines, and must start with a letterand have no more than 64 characters.
        :param pulumi.Input[builtins.str] account_name: Account name authorized to access the database. Only supports PostgreSQL.
        :param pulumi.Input[builtins.str] character_set_name: Character set. The value range is limited to the following: [ utf8, gbk, latin1, utf8mb4, Chinese_PRC_CI_AS, Chinese_PRC_CS_AS, SQL_Latin1_General_CP1_CI_AS, SQL_Latin1_General_CP1_CS_AS, Chinese_PRC_BIN ], default is "utf8" \\(`utf8mb4` only supports versions 5.5 and 5.6\\).
        :param pulumi.Input[builtins.str] db_description: Database description. It must start with a Chinese character or English letter, cannot start with "http://" or "https://". It can include Chinese and English characters, underlines (_), hyphens (-), and numbers. The length must be 2-256 characters.
        """
    ...
    def db_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_description(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Database(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:polardb/database:Database"
    ...
    def get(resource_name: str,
            ...
            db_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
            db_description: Optional[pulumi.Input[builtins.str]] = None,
            db_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Database':
        """
    ...
    @property
    @pulumi.getter(name="dbDescription")
    def db_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Database description. It must start with a Chinese character or English letter, cannot start with "http://" or "https://". It can include Chinese and English characters, underlines (_), hyphens (-), and numbers. The length must be 2-256 characters.
        """
        return pulumi.get(self, "db_description")
