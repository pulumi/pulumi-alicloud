...
def get_parameter_groups(db_type: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Parameter Group IDs.
    :param builtins.str name_regex: A regex string to filter results by Parameter Group name.
...
def get_parameter_groups_output(db_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
