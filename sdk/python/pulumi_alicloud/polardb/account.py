...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_password: Operation password. It may consist of letters, digits, or underlines, with a length of 6 to 32 characters.
        ...
        :param pulumi.Input[builtins.str] account_type: Account type, Valid values are `Normal`, `Super`, Default to `Normal`.
