...
def get_vpc_endpoint_service_resources(output_file: Optional[builtins.str] = None,
    ...
    :param builtins.str service_id: The ID of Vpc Endpoint Service.
    """
    __args__ = dict()
...
def get_vpc_endpoint_service_resources_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
