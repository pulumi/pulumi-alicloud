...
def get_vpc_endpoint_connections_output(endpoint_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        endpoint_owner_id: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
