...
class GetVpcEndpointConnectionsResult:
    ...
    def endpoint_owner_id(self) -> Optional[builtins.int]:
...
def get_vpc_endpoint_connections(endpoint_id: Optional[builtins.str] = None,
                                 endpoint_owner_id: Optional[builtins.int] = None,
    ...
    :param builtins.int endpoint_owner_id: The endpoint owner id.
...
def get_vpc_endpoint_connections_output(endpoint_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        endpoint_owner_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
