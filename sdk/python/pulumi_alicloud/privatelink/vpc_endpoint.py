...
class VpcEndpointArgs:
    def __init__(__self__, *,
                 ...
                 endpoint_description: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_type: Optional[pulumi.Input[builtins.str]] = None,
                 policy_document: Optional[pulumi.Input[builtins.str]] = None,
                 protected_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 zone_private_ip_address_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a VpcEndpoint resource.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC to which the endpoint belongs.
        ...
        :param pulumi.Input[builtins.str] endpoint_description: The description of the endpoint.
        ...
        :param pulumi.Input[builtins.str] policy_document: RAM access policies. For more information about policy definitions, see Alibaba Cloud-access control (RAM) official guidance.
        :param pulumi.Input[builtins.bool] protected_enabled: Specifies whether to enable user authentication. This parameter is available in Security Token Service (STS) mode. Valid values:
        :param pulumi.Input[builtins.str] resource_group_id: The resource group ID.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The ID of the security group that is associated with the endpoint ENI. The security group can be used to control data transfer between the VPC and the endpoint ENI.
               
               The endpoint can be associated with up to 10 security groups.
        :param pulumi.Input[builtins.str] service_id: The ID of the endpoint service with which the endpoint is associated.
        :param pulumi.Input[builtins.str] service_name: The name of the endpoint service with which the endpoint is associated.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The list of tags.
        :param pulumi.Input[builtins.str] vpc_endpoint_name: The name of the endpoint.
        :param pulumi.Input[builtins.int] zone_private_ip_address_count: The number of private IP addresses that are assigned to an elastic network interface (ENI) in each zone. Only 1 is returned.
        """
    ...
    def endpoint_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def endpoint_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def protected_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def protected_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def zone_private_ip_address_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def zone_private_ip_address_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _VpcEndpointState:
    def __init__(__self__, *,
                 ...
                 dry_run: Optional[pulumi.Input[builtins.bool]] = None,
                 endpoint_business_status: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] address_ip_version: The IP address version.
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth of the endpoint connection.  1024 to 10240. Unit: Mbit/s.
        :param pulumi.Input[builtins.str] connection_status: The state of the endpoint connection.
        :param pulumi.Input[builtins.str] create_time: The time when the endpoint was created.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to perform only a dry run, without performing the actual request. Valid values:
        :param pulumi.Input[builtins.str] endpoint_business_status: The service state of the endpoint.
        :param pulumi.Input[builtins.str] endpoint_description: The description of the endpoint.
        :param pulumi.Input[builtins.str] endpoint_domain: The domain name of the endpoint.
        :param pulumi.Input[builtins.str] endpoint_type: The endpoint type.
               
               Only the value: Interface, indicating the Interface endpoint. You can add the service resource types of Application Load Balancer (ALB), Classic Load Balancer (CLB), and Network Load Balancer (NLB).
        :param pulumi.Input[builtins.str] policy_document: RAM access policies. For more information about policy definitions, see Alibaba Cloud-access control (RAM) official guidance.
        :param pulumi.Input[builtins.bool] protected_enabled: Specifies whether to enable user authentication. This parameter is available in Security Token Service (STS) mode. Valid values:
        :param pulumi.Input[builtins.str] region_id: (Available since v1.239.0) The region ID of the endpoint.
        :param pulumi.Input[builtins.str] resource_group_id: The resource group ID.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The ID of the security group that is associated with the endpoint ENI. The security group can be used to control data transfer between the VPC and the endpoint ENI.
        ...
        :param pulumi.Input[builtins.str] service_id: The ID of the endpoint service with which the endpoint is associated.
        :param pulumi.Input[builtins.str] service_name: The name of the endpoint service with which the endpoint is associated.
        :param pulumi.Input[builtins.str] status: The state of the endpoint.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The list of tags.
        :param pulumi.Input[builtins.str] vpc_endpoint_name: The name of the endpoint.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC to which the endpoint belongs.
        :param pulumi.Input[builtins.int] zone_private_ip_address_count: The number of private IP addresses that are assigned to an elastic network interface (ENI) in each zone. Only 1 is returned.
    ...
    def endpoint_business_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def endpoint_business_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VpcEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpc_endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_private_ip_address_count: Optional[pulumi.Input[builtins.int]] = None) -> 'VpcEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="endpointBusinessStatus")
    def endpoint_business_status(self) -> pulumi.Output[builtins.str]:
        """
        The service state of the endpoint.
        """
        return pulumi.get(self, "endpoint_business_status")
    ...
    @property
    @pulumi.getter(name="endpointDescription")
    def endpoint_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the endpoint.
        """
        return pulumi.get(self, "endpoint_description")
    ...
    @property
    @pulumi.getter(name="protectedEnabled")
    def protected_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable user authentication. This parameter is available in Security Token Service (STS) mode. Valid values:
        """
        return pulumi.get(self, "protected_enabled")
    ...
    @property
    @pulumi.getter(name="vpcEndpointName")
    def vpc_endpoint_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the endpoint.
        """
        return pulumi.get(self, "vpc_endpoint_name")
    ...
    @property
    @pulumi.getter(name="zonePrivateIpAddressCount")
    def zone_private_ip_address_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of private IP addresses that are assigned to an elastic network interface (ENI) in each zone. Only 1 is returned.
        """
        return pulumi.get(self, "zone_private_ip_address_count")
