...
class VpcEndpointServiceConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth of the endpoint connection. Valid values: 1024 to 10240. Unit: Mbit/s.
...
class _VpcEndpointServiceConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint_id: The endpoint ID.
        :param pulumi.Input[builtins.str] service_id: The endpoint service ID.
        :param pulumi.Input[builtins.str] status: The state of the endpoint connection.
        """
        if bandwidth is not None:
            pulumi.set(__self__, "bandwidth", bandwidth)
        if dry_run is not None:
...
@pulumi.type_token("alicloud:privatelink/vpcEndpointServiceConnection:VpcEndpointServiceConnection")
class VpcEndpointServiceConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
            service_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'VpcEndpointServiceConnection':
        """
