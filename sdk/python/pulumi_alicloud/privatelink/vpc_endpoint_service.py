...
class VpcEndpointServiceArgs:
    def __init__(__self__, *,
                 ...
                 auto_accept_connection: Optional[pulumi.Input[builtins.bool]] = None,
                 connect_bandwidth: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 service_description: Optional[pulumi.Input[builtins.str]] = None,
                 service_resource_type: Optional[pulumi.Input[builtins.str]] = None,
                 service_support_ipv6: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 zone_affinity_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a VpcEndpointService resource.
        :param pulumi.Input[builtins.str] address_ip_version: The IP address version.
        :param pulumi.Input[builtins.bool] auto_accept_connection: Indicates whether the endpoint service automatically accepts endpoint connection requests. Valid values:
        :param pulumi.Input[builtins.int] connect_bandwidth: The default bandwidth of the endpoint connection. Valid values: 100 to 10240. Unit: Mbit/s.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to perform only a dry run, without performing the actual request.
        :param pulumi.Input[builtins.str] payer: The payer of the endpoint service. Valid values:
               - `Endpoint`: the service consumer.
               - `EndpointService`: the service provider.
        :param pulumi.Input[builtins.str] resource_group_id: The resource group ID.
        :param pulumi.Input[builtins.str] service_description: The description of the endpoint service.
        :param pulumi.Input[builtins.str] service_resource_type: Service resource type, value:
        :param pulumi.Input[builtins.bool] service_support_ipv6: Specifies whether to enable IPv6 for the endpoint service. Valid values:
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The list of tags.
        :param pulumi.Input[builtins.bool] zone_affinity_enabled: Specifies whether to first resolve the domain name of the nearest endpoint that is associated with the endpoint service. Valid values:
        """
    ...
    def auto_accept_connection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_accept_connection(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_accept_connection", value)

    @property
    @pulumi.getter(name="connectBandwidth")
    def connect_bandwidth(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def connect_bandwidth(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def service_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def service_support_ipv6(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def service_support_ipv6(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def zone_affinity_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def zone_affinity_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _VpcEndpointServiceState:
    def __init__(__self__, *,
                 ...
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_business_status: Optional[pulumi.Input[builtins.str]] = None,
                 service_description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] auto_accept_connection: Indicates whether the endpoint service automatically accepts endpoint connection requests. Valid values:
        :param pulumi.Input[builtins.int] connect_bandwidth: The default bandwidth of the endpoint connection. Valid values: 100 to 10240. Unit: Mbit/s.
        :param pulumi.Input[builtins.str] create_time: The time when the endpoint service was created.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to perform only a dry run, without performing the actual request.
        :param pulumi.Input[builtins.str] payer: The payer of the endpoint service. Valid values:
               - `Endpoint`: the service consumer.
               - `EndpointService`: the service provider.
        :param pulumi.Input[builtins.str] region_id: (Available since v1.235.0) The ID of the region to which the endpoint service belongs.
        :param pulumi.Input[builtins.str] resource_group_id: The resource group ID.
        :param pulumi.Input[builtins.str] service_business_status: The service state of the endpoint service.
        :param pulumi.Input[builtins.str] service_description: The description of the endpoint service.
        :param pulumi.Input[builtins.str] service_domain: The domain name of the endpoint service.
        :param pulumi.Input[builtins.str] service_resource_type: Service resource type, value:
        :param pulumi.Input[builtins.bool] service_support_ipv6: Specifies whether to enable IPv6 for the endpoint service. Valid values:
        :param pulumi.Input[builtins.str] status: The state of the endpoint service.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The list of tags.
        :param pulumi.Input[builtins.str] vpc_endpoint_service_name: The name of the endpoint service.
        :param pulumi.Input[builtins.bool] zone_affinity_enabled: Specifies whether to first resolve the domain name of the nearest endpoint that is associated with the endpoint service. Valid values:
        """
        if address_ip_version is not None:
            pulumi.set(__self__, "address_ip_version", address_ip_version)
    ...
    def service_business_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_business_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VpcEndpointService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_endpoint_service_name: Optional[pulumi.Input[builtins.str]] = None,
            zone_affinity_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'VpcEndpointService':
        """
    ...
    @property
    @pulumi.getter(name="autoAcceptConnection")
    def auto_accept_connection(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the endpoint service automatically accepts endpoint connection requests. Valid values:
        """
        return pulumi.get(self, "auto_accept_connection")
    ...
    @property
    @pulumi.getter(name="connectBandwidth")
    def connect_bandwidth(self) -> pulumi.Output[builtins.int]:
        """
        The default bandwidth of the endpoint connection. Valid values: 100 to 10240. Unit: Mbit/s.
        """
        return pulumi.get(self, "connect_bandwidth")
    ...
    @property
    @pulumi.getter(name="serviceBusinessStatus")
    def service_business_status(self) -> pulumi.Output[builtins.str]:
        """
        The service state of the endpoint service.
        """
        return pulumi.get(self, "service_business_status")
    ...
    @property
    @pulumi.getter(name="serviceDescription")
    def service_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the endpoint service.
        """
        return pulumi.get(self, "service_description")
    ...
    @property
    @pulumi.getter(name="serviceSupportIpv6")
    def service_support_ipv6(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to enable IPv6 for the endpoint service. Valid values:
        """
        return pulumi.get(self, "service_support_ipv6")
    ...
    @property
    @pulumi.getter(name="zoneAffinityEnabled")
    def zone_affinity_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to first resolve the domain name of the nearest endpoint that is associated with the endpoint service. Valid values:
        """
        return pulumi.get(self, "zone_affinity_enabled")
