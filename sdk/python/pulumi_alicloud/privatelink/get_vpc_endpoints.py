...
class GetVpcEndpointsResult:
    ...
    def vpc_endpoint_name(self) -> Optional[builtins.str]:
        """
...
def get_vpc_endpoints(connection_status: Optional[builtins.str] = None,
                      ...
                      vpc_endpoint_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Vpc Endpoint IDs.
    :param builtins.str name_regex: A regex string to filter results by Vpc Endpoint name.
...
def get_vpc_endpoints_output(connection_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ...
                             vpc_endpoint_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
