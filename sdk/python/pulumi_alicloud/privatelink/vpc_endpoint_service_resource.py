...
class VpcEndpointServiceResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_id: The service resource ID.
        :param pulumi.Input[builtins.str] resource_type: Service resource type, value:
        ...
        :param pulumi.Input[builtins.str] zone_id: The ID of the zone to which the service resource belongs. (valid when the resource type is nlb/alb).
        """
...
class _VpcEndpointServiceResourceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to perform only a dry run, without performing the actual request. Valid values:
        :param pulumi.Input[builtins.str] region_id: (Available since v1.235.0) The ID of the region where the service resource is deployed.
        :param pulumi.Input[builtins.str] resource_id: The service resource ID.
        :param pulumi.Input[builtins.str] resource_type: Service resource type, value:
        :param pulumi.Input[builtins.str] service_id: The endpoint service ID.
        :param pulumi.Input[builtins.str] zone_id: The ID of the zone to which the service resource belongs. (valid when the resource type is nlb/alb).
...
@pulumi.type_token("alicloud:privatelink/vpcEndpointServiceResource:VpcEndpointServiceResource")
class VpcEndpointServiceResource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_type: Optional[pulumi.Input[builtins.str]] = None,
            service_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VpcEndpointServiceResource':
        """
