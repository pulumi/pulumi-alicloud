...
def get_vpc_endpoint_service_users(output_file: Optional[builtins.str] = None,
...
def get_vpc_endpoint_service_users_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
