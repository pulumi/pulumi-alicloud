...
class VpcEndpointServiceUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_id: The endpoint service ID.
        :param pulumi.Input[builtins.str] user_id: The ID of the Alibaba Cloud account in the whitelist of the endpoint service.
        ...
        :param pulumi.Input[builtins.str] user_arn: The whitelist in the format of ARN.
        """
...
@pulumi.type_token("alicloud:privatelink/vpcEndpointServiceUser:VpcEndpointServiceUser")
class VpcEndpointServiceUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_id: Optional[pulumi.Input[builtins.str]] = None,
            user_arn: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VpcEndpointServiceUser':
        """
    ...
    @property
    @pulumi.getter(name="userArn")
    def user_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The whitelist in the format of ARN.
        """
        return pulumi.get(self, "user_arn")
