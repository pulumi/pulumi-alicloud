...
def get_vpc_endpoint_zones(endpoint_id: Optional[builtins.str] = None,
...
def get_vpc_endpoint_zones_output(endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
