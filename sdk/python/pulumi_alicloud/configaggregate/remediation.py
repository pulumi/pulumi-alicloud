...
warnings.warn("""alicloud.configaggregate/remediation.Remediation has been deprecated in favor of alicloud.cfg/aggregateremediation.AggregateRemediation""", DeprecationWarning)


@pulumi.type_token("alicloud:configaggregate/remediation:Remediation")
