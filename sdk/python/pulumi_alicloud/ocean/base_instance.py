...
class BaseInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_class: Cluster specification information. Note Please enter the shape as xCxxG, not xCxxGB
               ...
               - 16C70G:16 core 70GB
               - 32C180G:32 core 180GB
        :param pulumi.Input[_builtins.str] payment_type: The payment method of the instance. Value range:
        ...
        :param pulumi.Input[_builtins.str] series: Series of OceanBase cluster instances-normal (default): Standard cluster version (cloud disk)-normal_SSD: Standard cluster version (local disk)-history: history Library cluster version.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] zones: Information about the zone where the cluster is deployed.
        ...
        :param pulumi.Input[_builtins.int] auto_renew_period: The duration of each auto-renewal. When the value of the AutoRenew parameter is True, this parameter is required.
               - PeriodUnit is Week, AutoRenewPeriod is {"1", "2", "3"}.
               - PeriodUnit is Month, AutoRenewPeriod is {"1", "2", "3", "6", "12"}.
        :param pulumi.Input[_builtins.str] backup_retain_mode: The backup retention policy after the cluster is deleted. The values are as follows:
        ...
        :param pulumi.Input[_builtins.str] cpu_arch: Cpu architecture, x86, arm. If no, the default value is x86
        :param pulumi.Input[_builtins.str] disk_type: The storage type of the cluster. Effective only in the standard cluster version (cloud disk).
               
               Two types are currently supported:
               - cloud_essd_pl1: cloud disk ESSD pl1.
               - cloud_essd_pl0: cloud disk ESSD pl0. The default value is cloud_essd_pl1.
        :param pulumi.Input[_builtins.str] instance_name: OceanBase cluster name.
        ...
        :param pulumi.Input[_builtins.str] node_num: The number of nodes in the cluster. If the deployment mode is n-n-n, the number of nodes is n * 3
        :param pulumi.Input[_builtins.str] ob_version: The OceanBase Server version number.
        :param pulumi.Input[_builtins.int] period: The duration of the resource purchase. The unit is specified by the PeriodUnit. The parameter InstanceChargeType takes effect only when the value is PrePaid and is required. Once the DedicatedHostId is specified, the value cannot exceed the subscription duration of the dedicated host. When PeriodUnit = Week, Period values: {"1", "2", "3", "4"}. When PeriodUnit = Month, Period values: {"1", "2", "3", "4", "5", "6", "7", "8", "9", "12", "24", "36", "48", "60"}.
        :param pulumi.Input[_builtins.str] period_unit: The duration of the purchase of resources.
        ...
        :param pulumi.Input[_builtins.str] primary_instance: The ID of the primary instance.
        :param pulumi.Input[_builtins.str] primary_region: The primary instance Region.
        :param pulumi.Input[_builtins.str] resource_group_id: The ID of the enterprise resource group to which the instance resides.
        :param pulumi.Input[_builtins.bool] upgrade_spec_native: Valid values:
    ...
    @_builtins.property
    @pulumi.getter
    def series(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @series.setter
    def series(self, value: pulumi.Input[_builtins.str]):
...
class _BaseInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] backup_retain_mode: The backup retention policy after the cluster is deleted. The values are as follows:
               ...
               > **NOTE:**   The default value is delete_all.
        :param pulumi.Input[_builtins.str] commodity_code: The product code of the OceanBase cluster._oceanbasepre_public_cn: Domestic station cloud database package Year-to-month package._oceanbasepost_public_cn: The domestic station cloud database is paid by the hour._obpre_public_intl: International Station Cloud Database Package Monthly Package.
        :param pulumi.Input[_builtins.int] cpu: The number of CPU cores of the cluster.
        :param pulumi.Input[_builtins.str] cpu_arch: Cpu architecture, x86, arm. If no, the default value is x86
...
class BaseInstance(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="backupRetainMode")
    def backup_retain_mode(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The backup retention policy after the cluster is deleted. The values are as follows:
        - receive_all: Keep all backup sets;
        - delete_all: delete all backup sets;
    ...
    @_builtins.property
    @pulumi.getter(name="nodeNum")
    def node_num(self) -> pulumi.Output[_builtins.str]:
        """
        The number of nodes in the cluster. If the deployment mode is n-n-n, the number of nodes is n * 3
        """
        return pulumi.get(self, "node_num")
    ...
    @_builtins.property
    @pulumi.getter(name="obVersion")
    def ob_version(self) -> pulumi.Output[_builtins.str]:
        """
        The OceanBase Server version number.
        """
        return pulumi.get(self, "ob_version")
    ...
    @_builtins.property
    @pulumi.getter(name="primaryInstance")
    def primary_instance(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of the primary instance.
        """
        return pulumi.get(self, "primary_instance")
    ...
    @_builtins.property
    @pulumi.getter
    def series(self) -> pulumi.Output[_builtins.str]:
        """
        Series of OceanBase cluster instances-normal (default): Standard cluster version (cloud disk)-normal_SSD: Standard cluster version (local disk)-history: history Library cluster version.
        """
        return pulumi.get(self, "series")
    ...
    @_builtins.property
    @pulumi.getter(name="upgradeSpecNative")
    def upgrade_spec_native(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Valid values:
        - false: migration and configuration change.
        - true: in-situ matching
