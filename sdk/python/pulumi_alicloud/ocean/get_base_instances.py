...
def get_base_instances(enable_details: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str instance_name: OceanBase cluster name. The length is 1 to 20 English or Chinese characters. If this parameter is not specified, the default value is the InstanceId of the cluster.
    ...
    :param _builtins.str search_key: The filter keyword for the query list.
    :param _builtins.str status: The status of the Instance. Value range: `PENDING_CREATE`, `ONLINE`, `TENANT_CREATING`, `TENANT_SPEC_MODIFYING`, `EXPANDING`, `REDUCING`, `SPEC_UPGRADING`, `DISK_UPGRADING`, `WHITE_LIST_MODIFYING`, `PARAMETER_MODIFYING`, `SSL_MODIFYING`, `PREPAID_EXPIRE_CLOSED`, `ARREARS_CLOSED`, `PENDING_DELETE`.
    """
    __args__ = dict()
...
def get_base_instances_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                              ...
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBaseInstancesResult]:
    """
    This data source provides the Ocean Base Instances of the current Alibaba Cloud user.
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:ocean/getBaseInstances:getBaseInstances', __args__, opts=opts, typ=GetBaseInstancesResult)
    return __ret__.apply(lambda __response__: GetBaseInstancesResult(
