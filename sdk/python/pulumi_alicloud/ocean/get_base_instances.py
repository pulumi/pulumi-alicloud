...
def get_base_instances(enable_details: Optional[bool] = None,
    ...
    :param str instance_id: (ForceNew,Optional) OceanBase cluster ID.
    ...
    :param str resource_group_id: (ForceNew,Optional) The ID of the enterprise resource group to which the instance resides.
    :param str search_key: (ForceNew,Optional) The filter keyword for the query list.
