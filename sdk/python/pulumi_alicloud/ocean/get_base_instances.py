...
def get_base_instances(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.str instance_name: OceanBase cluster name. The length is 1 to 20 English or Chinese characters. If this parameter is not specified, the default value is the InstanceId of the cluster.
    ...
    :param builtins.str search_key: The filter keyword for the query list.
    :param builtins.str status: The status of the Instance. Value range: `PENDING_CREATE`, `ONLINE`, `TENANT_CREATING`, `TENANT_SPEC_MODIFYING`, `EXPANDING`, `REDUCING`, `SPEC_UPGRADING`, `DISK_UPGRADING`, `WHITE_LIST_MODIFYING`, `PARAMETER_MODIFYING`, `SSL_MODIFYING`, `PREPAID_EXPIRE_CLOSED`, `ARREARS_CLOSED`, `PENDING_DELETE`.
    """
    __args__ = dict()
...
def get_base_instances_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
