...
def get_subscription_jobs(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Subscription Job IDs.
    :param builtins.str name_regex: A regex string to filter results by subscription job name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the task. Valid values: `Abnormal`, `Downgrade`, `Locked`, `Normal`, `NotStarted`, `NotStarted`, `PreCheckPass`, `PrecheckFailed`, `Prechecking`, `Retrying`, `Starting`, `Upgrade`.
    """
    __args__ = dict()
...
def get_subscription_jobs_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
