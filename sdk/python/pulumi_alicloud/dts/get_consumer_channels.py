...
def get_consumer_channels(dts_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str dts_instance_id: Subscription instance ID.
    :param Sequence[builtins.str] ids: A list of Consumer Channel IDs.
...
def get_consumer_channels_output(dts_instance_id: Optional[pulumi.Input[builtins.str]] = None,
