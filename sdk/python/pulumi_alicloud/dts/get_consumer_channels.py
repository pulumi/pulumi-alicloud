...
def get_consumer_channels(dts_instance_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dts_instance_id: Subscription instance ID.
    :param Sequence[_builtins.str] ids: A list of Consumer Channel IDs.
...
def get_consumer_channels_output(dts_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetConsumerChannelsResult(
        ...
        dts_instance_id=pulumi.get(__response__, 'dts_instance_id'),
