...
class ConsumerChannelArgs:
    def __init__(__self__, *,
                 ...
                 consumer_group_password: pulumi.Input[builtins.str],
                 consumer_group_user_name: pulumi.Input[builtins.str],
                 dts_instance_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ConsumerChannel resource.
        :param pulumi.Input[builtins.str] consumer_group_name: The name of the consumer group.
        :param pulumi.Input[builtins.str] consumer_group_password: The password of the consumer group account. The length of the `consumer_group_password` is limited to `8` to `32` characters. It can contain two or more of the following characters: uppercase letters, lowercase letters, digits, and special characters.
        :param pulumi.Input[builtins.str] consumer_group_user_name: The username of the consumer group. The length of the `consumer_group_user_name` is limited to `1` to `16` characters. It can contain one or more of the following characters: uppercase letters, lowercase letters, digits, and underscores (_).
    ...
    def consumer_group_password(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def consumer_group_password(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "consumer_group_password", value)

    @property
    @pulumi.getter(name="consumerGroupUserName")
    def consumer_group_user_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def consumer_group_user_name(self, value: pulumi.Input[builtins.str]):
...
class _ConsumerChannelState:
    def __init__(__self__, *,
                 ...
                 consumer_group_password: Optional[pulumi.Input[builtins.str]] = None,
                 consumer_group_user_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] consumer_group_id: The ID of the consumer group.
        :param pulumi.Input[builtins.str] consumer_group_name: The name of the consumer group.
        :param pulumi.Input[builtins.str] consumer_group_password: The password of the consumer group account. The length of the `consumer_group_password` is limited to `8` to `32` characters. It can contain two or more of the following characters: uppercase letters, lowercase letters, digits, and special characters.
        :param pulumi.Input[builtins.str] consumer_group_user_name: The username of the consumer group. The length of the `consumer_group_user_name` is limited to `1` to `16` characters. It can contain one or more of the following characters: uppercase letters, lowercase letters, digits, and underscores (_).
        :param pulumi.Input[builtins.str] dts_instance_id: The ID of the subscription instance.
    ...
    @property
    @pulumi.getter(name="consumerGroupPassword")
    def consumer_group_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The password of the consumer group account. The length of the `consumer_group_password` is limited to `8` to `32` characters. It can contain two or more of the following characters: uppercase letters, lowercase letters, digits, and special characters.
        """
        return pulumi.get(self, "consumer_group_password")
    ...
    @consumer_group_password.setter
    def consumer_group_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "consumer_group_password", value)

    @property
    @pulumi.getter(name="consumerGroupUserName")
    def consumer_group_user_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The username of the consumer group. The length of the `consumer_group_user_name` is limited to `1` to `16` characters. It can contain one or more of the following characters: uppercase letters, lowercase letters, digits, and underscores (_).
        """
        return pulumi.get(self, "consumer_group_user_name")
    ...
    @consumer_group_user_name.setter
    def consumer_group_user_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "consumer_group_user_name", value)
...
class ConsumerChannel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            consumer_group_password: Optional[pulumi.Input[builtins.str]] = None,
            consumer_group_user_name: Optional[pulumi.Input[builtins.str]] = None,
            dts_instance_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ConsumerChannel':
        """
    ...
    @property
    @pulumi.getter(name="consumerGroupId")
    def consumer_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the consumer group.
        """
        return pulumi.get(self, "consumer_group_id")
    ...
    @property
    @pulumi.getter(name="consumerGroupPassword")
    def consumer_group_password(self) -> pulumi.Output[builtins.str]:
        """
        The password of the consumer group account. The length of the `consumer_group_password` is limited to `8` to `32` characters. It can contain two or more of the following characters: uppercase letters, lowercase letters, digits, and special characters.
        """
        return pulumi.get(self, "consumer_group_password")
    ...
    @property
    @pulumi.getter(name="consumerGroupUserName")
    def consumer_group_user_name(self) -> pulumi.Output[builtins.str]:
        """
        The username of the consumer group. The length of the `consumer_group_user_name` is limited to `1` to `16` characters. It can contain one or more of the following characters: uppercase letters, lowercase letters, digits, and underscores (_).
        """
        return pulumi.get(self, "consumer_group_user_name")
