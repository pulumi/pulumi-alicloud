...
def get_synchronization_jobs(enable_details: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str name_regex: A regex string to filter results by synchronization job name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str status: The status of the resource. Valid values: `Synchronizing`, `Suspending`. `Downgrade`, `Failed`, `Finished`, `InitializeFailed`, `Locked`, `Modifying`, `NotConfigured`, `NotStarted`, `PreCheckPass`, `PrecheckFailed`, `Prechecking`, `Retrying`, `Upgrade`.
    """
    __args__ = dict()
...
def get_synchronization_jobs_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                    ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                    name_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSynchronizationJobsResult]:
    """
    This data source provides the Dts Synchronization Jobs of the current Alibaba Cloud user.
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:dts/getSynchronizationJobs:getSynchronizationJobs', __args__, opts=opts, typ=GetSynchronizationJobsResult)
    return __ret__.apply(lambda __response__: GetSynchronizationJobsResult(
