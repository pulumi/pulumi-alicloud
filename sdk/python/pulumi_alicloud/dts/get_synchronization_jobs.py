...
def get_synchronization_jobs(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.str name_regex: A regex string to filter results by synchronization job name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the resource. Valid values: `Synchronizing`, `Suspending`. `Downgrade`, `Failed`, `Finished`, `InitializeFailed`, `Locked`, `Modifying`, `NotConfigured`, `NotStarted`, `PreCheckPass`, `PrecheckFailed`, `Prechecking`, `Retrying`, `Upgrade`.
    """
    __args__ = dict()
...
def get_synchronization_jobs_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
