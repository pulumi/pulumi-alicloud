...
def get_migration_jobs(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Synchronization Job IDs.
    :param builtins.str name_regex: A regex string to filter results by Migration Job name.
...
def get_migration_jobs_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
