...
def get_migration_jobs(enable_details: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Synchronization Job IDs.
    :param _builtins.str name_regex: A regex string to filter results by Migration Job name.
...
def get_migration_jobs_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
