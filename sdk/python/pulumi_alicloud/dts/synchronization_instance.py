...
class SynchronizationInstanceArgs:
    def __init__(__self__, *,
                 ...
                 destination_endpoint_region: pulumi.Input[builtins.str],
                 payment_type: pulumi.Input[builtins.str],
                 source_endpoint_engine_name: pulumi.Input[builtins.str],
                 source_endpoint_region: pulumi.Input[builtins.str],
                 auto_pay: Optional[pulumi.Input[builtins.str]] = None,
                 auto_start: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 payment_duration: Optional[pulumi.Input[builtins.int]] = None,
                 payment_duration_unit: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] destination_endpoint_engine_name: The type of destination engine. Valid values: `ADS`, `DB2`, `DRDS`, `DataHub`, `Greenplum`, `MSSQL`, `MySQL`, `PolarDB`, `PostgreSQL`, `Redis`, `Tablestore`, `as400`, `clickhouse`, `kafka`, `mongodb`, `odps`, `oracle`, `polardb_o`, `polardb_pg`, `tidb`. For the correspondence between the supported source and target libraries, see [Supported Databases, Synchronization Initialization Types and Synchronization Topologies](https://help.aliyun.com/document_detail/130744.html), [Supported Databases and Migration Types](https://help.aliyun.com/document_detail/26618.html).
        :param pulumi.Input[builtins.str] destination_endpoint_region: The region of destination instance. List of [supported regions](https://help.aliyun.com/document_detail/141033.html).
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource. Valid values: `Subscription`, `PayAsYouGo`.
        :param pulumi.Input[builtins.str] source_endpoint_engine_name: The type of source endpoint engine. Valid values: `ADS`, `DB2`, `DRDS`, `DataHub`, `Greenplum`, `MSSQL`, `MySQL`, `PolarDB`, `PostgreSQL`, `Redis`, `Tablestore`, `as400`, `clickhouse`, `kafka`, `mongodb`, `odps`, `oracle`, `polardb_o`, `polardb_pg`, `tidb`. For the correspondence between the supported source and target libraries, see [Supported Databases, Synchronization Initialization Types and Synchronization Topologies](https://help.aliyun.com/document_detail/130744.html), [Supported Databases and Migration Types](https://help.aliyun.com/document_detail/26618.html).
        :param pulumi.Input[builtins.str] source_endpoint_region: The region of source instance.
        :param pulumi.Input[builtins.str] auto_pay: Whether to automatically renew when it expires. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] auto_start: Whether to automatically start the task after the purchase completed. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.int] compute_unit: [ETL specifications](https://help.aliyun.com/document_detail/212324.html). The unit is the computing unit ComputeUnit (CU), 1CU=1vCPU+4 GB memory. The value range is an integer greater than or equal to 2.
        :param pulumi.Input[builtins.int] database_count: The number of private customized RDS instances under PolarDB-X. The default value is 1. This parameter needs to be passed only when `source_endpoint_engine_name` equals `drds`.
        ...
        :param pulumi.Input[builtins.int] payment_duration: The duration of prepaid instance purchase. this parameter is required When `payment_type` equals `Subscription`.
        :param pulumi.Input[builtins.str] payment_duration_unit: The payment duration unit. Valid values: `Month`, `Year`. When `payment_type` is `Subscription`, this parameter is valid and must be passed in.
        :param pulumi.Input[builtins.int] quantity: The number of instances purchased.
        :param pulumi.Input[builtins.str] sync_architecture: The sync architecture. Valid values: `oneway`, `bidirectional`.
        """
    ...
    def destination_endpoint_region(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destination_endpoint_region(self, value: pulumi.Input[builtins.str]):
    ...
    def source_endpoint_region(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_endpoint_region(self, value: pulumi.Input[builtins.str]):
    ...
    def auto_start(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @auto_start.setter
    def auto_start(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def payment_duration(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def payment_duration(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "payment_duration", value)

    @property
    @pulumi.getter(name="paymentDurationUnit")
    def payment_duration_unit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def payment_duration_unit(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SynchronizationInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_endpoint_region: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            sync_architecture: Optional[pulumi.Input[builtins.str]] = None) -> 'SynchronizationInstance':
        """
    ...
    @property
    @pulumi.getter(name="autoStart")
    def auto_start(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether to automatically start the task after the purchase completed. Valid values: `true`, `false`.
        """
        return pulumi.get(self, "auto_start")
    ...
    @property
    @pulumi.getter(name="databaseCount")
    def database_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of private customized RDS instances under PolarDB-X. The default value is 1. This parameter needs to be passed only when `source_endpoint_engine_name` equals `drds`.
        """
        return pulumi.get(self, "database_count")
    ...
    @property
    @pulumi.getter(name="destinationEndpointRegion")
    def destination_endpoint_region(self) -> pulumi.Output[builtins.str]:
        """
        The region of destination instance. List of [supported regions](https://help.aliyun.com/document_detail/141033.html).
        """
        return pulumi.get(self, "destination_endpoint_region")
    ...
    @property
    @pulumi.getter(name="paymentDuration")
    def payment_duration(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The duration of prepaid instance purchase. this parameter is required When `payment_type` equals `Subscription`.
        """
        return pulumi.get(self, "payment_duration")
    ...
    @property
    @pulumi.getter(name="paymentDurationUnit")
    def payment_duration_unit(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The payment duration unit. Valid values: `Month`, `Year`. When `payment_type` is `Subscription`, this parameter is valid and must be passed in.
        """
        return pulumi.get(self, "payment_duration_unit")
    ...
    @property
    @pulumi.getter
    def quantity(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of instances purchased.
        """
        return pulumi.get(self, "quantity")
    ...
    @property
    @pulumi.getter(name="sourceEndpointRegion")
    def source_endpoint_region(self) -> pulumi.Output[builtins.str]:
        """
        The region of source instance.
        """
        return pulumi.get(self, "source_endpoint_region")
