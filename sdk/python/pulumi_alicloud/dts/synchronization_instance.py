...
class SynchronizationInstanceArgs:
    def __init__(__self__, *,
                 ...
                 destination_endpoint_region: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.int] payment_duration: The duration of prepaid instance purchase. this parameter is required When `payment_type` equals `Subscription`.
        ...
        :param pulumi.Input[_builtins.int] quantity: The number of instances purchased.
        :param pulumi.Input[_builtins.str] sync_architecture: The sync architecture. Valid values: `oneway`, `bidirectional`.
        """
    ...
    def destination_endpoint_region(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def destination_endpoint_region(self, value: pulumi.Input[_builtins.str]):
...
class SynchronizationInstance(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="autoStart")
    def auto_start(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Whether to automatically start the task after the purchase completed. Valid values: `true`, `false`.
        """
        return pulumi.get(self, "auto_start")
    ...
    @_builtins.property
    @pulumi.getter(name="destinationEndpointRegion")
    def destination_endpoint_region(self) -> pulumi.Output[_builtins.str]:
        """
        The region of destination instance. List of [supported regions](https://help.aliyun.com/document_detail/141033.html).
        """
        return pulumi.get(self, "destination_endpoint_region")
