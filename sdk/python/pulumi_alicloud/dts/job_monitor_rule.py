...
class JobMonitorRuleArgs:
    def __init__(__self__, *,
                 dts_job_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] dts_job_id: Migration, synchronization or subscription task ID can be by calling the [DescribeDtsJobs] get.
        :param pulumi.Input[builtins.str] type: Monitoring rules of type, valid values: `delay`, `error`. **delay**: delay alarm. **error**: abnormal alarm.
        :param pulumi.Input[builtins.str] delay_rule_time: Trigger delay alarm threshold, which is measured in seconds.
        :param pulumi.Input[builtins.str] phone: The alarm is triggered after notification of the contact phone number, A plurality of phone numbers between them with a comma (,) to separate.
        :param pulumi.Input[builtins.str] state: Whether to enable monitoring rules, valid values: `Y`, `N`.
        """
    ...
    def dts_job_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @dts_job_id.setter
    def dts_job_id(self, value: pulumi.Input[builtins.str]):
...
class _JobMonitorRuleState:
    def __init__(__self__, *,
                 delay_rule_time: Optional[pulumi.Input[builtins.str]] = None,
                 dts_job_id: Optional[pulumi.Input[builtins.str]] = None,
                 phone: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="dtsJobId")
    def dts_job_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Migration, synchronization or subscription task ID can be by calling the [DescribeDtsJobs] get.
        """
        return pulumi.get(self, "dts_job_id")
    ...
    @dts_job_id.setter
    def dts_job_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dts_job_id", value)
...
class JobMonitorRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            phone: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'JobMonitorRule':
        """
    ...
    @property
    @pulumi.getter(name="delayRuleTime")
    def delay_rule_time(self) -> pulumi.Output[builtins.str]:
        """
        Trigger delay alarm threshold, which is measured in seconds.
        """
        return pulumi.get(self, "delay_rule_time")
    ...
    @property
    @pulumi.getter(name="dtsJobId")
    def dts_job_id(self) -> pulumi.Output[builtins.str]:
        """
        Migration, synchronization or subscription task ID can be by calling the [DescribeDtsJobs] get.
        """
        return pulumi.get(self, "dts_job_id")
