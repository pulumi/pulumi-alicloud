...
class MigrationJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] data_initialization: Whether to execute DTS supports schema migration.
        :param pulumi.Input[builtins.bool] data_synchronization: Whether to perform incremental data migration.
        :param pulumi.Input[builtins.str] db_list: Migration object, in the format of JSON strings. For detailed definition instructions, please refer to [the description of migration, migration or subscription objects](https://help.aliyun.com/document_detail/209545.html).
        :param pulumi.Input[builtins.str] destination_endpoint_engine_name: The type of destination database. Valid values: `ADS`, `ADB30`, `AS400`, `DATAHUB`, `DB2`, `GREENPLUM`, `KAFKA`, `MONGODB`, `MSSQL`, `MySQL`, `ORACLE`, `PolarDB`, `POLARDBX20`, `POLARDB_O`, `PostgreSQL`.
        :param pulumi.Input[builtins.str] destination_endpoint_instance_type: The type of destination instance. Valid values: `ADS`, `CEN`, `DATAHUB`, `DG`, `ECS`, `EXPRESS`, `GREENPLUM`, `MONGODB`, `OTHER`, `PolarDB`, `POLARDBX20`, `RDS`.
        :param pulumi.Input[builtins.str] dts_instance_id: The Migration instance ID. The ID of `dts.MigrationInstance`.
        :param pulumi.Input[builtins.str] source_endpoint_engine_name: The type of source database. Valid values: `AS400`, `DB2`, `DMSPOLARDB`, `HBASE`, `MONGODB`, `MSSQL`, `MySQL`, `ORACLE`, `PolarDB`, `POLARDBX20`, `POLARDB_O`, `POSTGRESQL`, `TERADATA`.
        :param pulumi.Input[builtins.str] source_endpoint_instance_type: The type of source instance. Valid values: `CEN`, `DG`, `DISTRIBUTED_DMSLOGICDB`, `ECS`, `EXPRESS`, `MONGODB`, `OTHER`, `PolarDB`, `POLARDBX20`, `RDS`.
        :param pulumi.Input[builtins.bool] structure_initialization: Whether to perform a database table structure to migrate.
        :param pulumi.Input[builtins.str] checkpoint: Start time in Unix timestamp format.
        :param pulumi.Input[builtins.str] destination_endpoint_database_name: The name of migrate the database.
        :param pulumi.Input[builtins.str] destination_endpoint_instance_id: The ID of destination instance.
        :param pulumi.Input[builtins.str] destination_endpoint_ip: The ip of source endpoint.
        :param pulumi.Input[builtins.str] destination_endpoint_oracle_sid: The SID of Oracle database.
        :param pulumi.Input[builtins.str] destination_endpoint_password: The password of database account.
        :param pulumi.Input[builtins.str] destination_endpoint_port: The port of source endpoint.
        :param pulumi.Input[builtins.str] destination_endpoint_region: The region of destination instance.
        :param pulumi.Input[builtins.str] destination_endpoint_user_name: The username of database account.
        :param pulumi.Input[builtins.str] dts_job_name: The name of migration job.
        :param pulumi.Input[builtins.str] instance_class: The instance class. Valid values: `large`, `medium`, `micro`, `small`, `xlarge`, `xxlarge`.
        :param pulumi.Input[builtins.str] source_endpoint_database_name: The name of migrate the database.
        :param pulumi.Input[builtins.str] source_endpoint_instance_id: The ID of source instance.
        :param pulumi.Input[builtins.str] source_endpoint_ip: The ip of source endpoint.
        :param pulumi.Input[builtins.str] source_endpoint_oracle_sid: The SID of Oracle database.
        :param pulumi.Input[builtins.str] source_endpoint_owner_id: The Alibaba Cloud account ID to which the source instance belongs.
        :param pulumi.Input[builtins.str] source_endpoint_password: The password of database account.
        :param pulumi.Input[builtins.str] source_endpoint_port: The port of source endpoint.
        :param pulumi.Input[builtins.str] source_endpoint_region: The region of source instance.
        :param pulumi.Input[builtins.str] source_endpoint_role: The name of the role configured for the cloud account to which the source instance belongs.
        :param pulumi.Input[builtins.str] source_endpoint_user_name: The username of database account.
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid values: `Migrating`, `Suspending`. You can suspend the task by specifying `Suspending` and start the task by specifying `Migrating`.
        """
...
class MigrationJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_endpoint_user_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            structure_initialization: Optional[pulumi.Input[builtins.bool]] = None) -> 'MigrationJob':
        """
