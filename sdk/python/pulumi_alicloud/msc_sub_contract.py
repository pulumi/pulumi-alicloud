...
class MscSubContractArgs:
    def __init__(__self__, *,
                 contact_name: pulumi.Input[builtins.str],
                 email: pulumi.Input[builtins.str],
                 mobile: pulumi.Input[builtins.str],
                 position: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a MscSubContract resource.
        :param pulumi.Input[builtins.str] contact_name: The User's Contact Name. **Note:** The name must be 2 to 12 characters in length.
        :param pulumi.Input[builtins.str] email: The User's Contact Email Address.
        :param pulumi.Input[builtins.str] mobile: The User's Telephone.
        :param pulumi.Input[builtins.str] position: The User's Position. Valid values: `CEO`, `Technical Director`, `Maintenance Director`, `Project Director`,`Finance Director` and `Other`.
    ...
    def contact_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @contact_name.setter
    def contact_name(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def mobile(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @mobile.setter
    def mobile(self, value: pulumi.Input[builtins.str]):
...
class MscSubContract(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            email: Optional[pulumi.Input[builtins.str]] = None,
            mobile: Optional[pulumi.Input[builtins.str]] = None,
            position: Optional[pulumi.Input[builtins.str]] = None) -> 'MscSubContract':
        """
    ...
    @property
    @pulumi.getter(name="contactName")
    def contact_name(self) -> pulumi.Output[builtins.str]:
        """
        The User's Contact Name. **Note:** The name must be 2 to 12 characters in length.
        """
        return pulumi.get(self, "contact_name")
    ...
    @property
    @pulumi.getter
    def mobile(self) -> pulumi.Output[builtins.str]:
        """
        The User's Telephone.
        """
        return pulumi.get(self, "mobile")
