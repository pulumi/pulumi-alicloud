...
class RecordArgs:
    def __init__(__self__, *,
                 ...
                 biz_name: Optional[pulumi.Input[builtins.str]] = None,
                 comment: Optional[pulumi.Input[builtins.str]] = None,
                 host_policy: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] record_name: The record name. This parameter specifies a filter condition for the query.
        :param pulumi.Input[builtins.str] record_type: The DNS record type.
        :param pulumi.Input[builtins.int] site_id: The website ID, which can be obtained by calling the [ListSites](https://www.alibabacloud.com/help/en/doc-detail/2850189.html) operation.
        ...
        :param pulumi.Input[builtins.str] biz_name: The business scenario of the record for acceleration. Valid values:
        :param pulumi.Input[builtins.str] comment: The comments of the record.
        :param pulumi.Input[builtins.str] host_policy: The origin host policy. This policy takes effect when the record type is CNAME. You can set the policy in two modes:
        :param pulumi.Input[builtins.bool] proxied: Filters by whether the record is proxied. Valid values:
        :param pulumi.Input[builtins.str] source_type: The origin type of the record. Only CNAME records can be filtered by using this field. Valid values:
               ...
               - `OP`: origin pool.
               - `Domain`: domain name.
        :param pulumi.Input[builtins.int] ttl: The TTL of the record. Unit: seconds. The range is 30 to 86,400, or 1. If the value is 1, the TTL of the record is determined by the system.
        """
    ...
    def biz_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @biz_name.setter
    def biz_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def host_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @host_policy.setter
    def host_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RecordState:
    def __init__(__self__, *,
                 ...
                 host_policy: Optional[pulumi.Input[builtins.str]] = None,
                 proxied: Optional[pulumi.Input[builtins.bool]] = None,
                 record_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] biz_name: The business scenario of the record for acceleration. Valid values:
        :param pulumi.Input[builtins.str] comment: The comments of the record.
        :param pulumi.Input[builtins.str] create_time: The creation time of the record. The date format follows ISO8601 notation and uses UTC time. The format is yyyy-MM-ddTHH:mm:ssZ.
        :param pulumi.Input['RecordDataArgs'] data: The DNS record information. The format of this field varies based on the record type. For more information, see [Add DNS records](https://www.alibabacloud.com/help/doc-detail/2708761.html). See `data` below.
        :param pulumi.Input[builtins.str] host_policy: The origin host policy. This policy takes effect when the record type is CNAME. You can set the policy in two modes:
        :param pulumi.Input[builtins.bool] proxied: Filters by whether the record is proxied. Valid values:
        :param pulumi.Input[builtins.str] record_name: The record name. This parameter specifies a filter condition for the query.
    ...
    @property
    @pulumi.getter(name="recordName")
    def record_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The record name. This parameter specifies a filter condition for the query.
        """
        return pulumi.get(self, "record_name")
    ...
    @record_name.setter
    def record_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "record_name", value)
...
class Record(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            site_id: Optional[pulumi.Input[builtins.int]] = None,
            source_type: Optional[pulumi.Input[builtins.str]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None) -> 'Record':
        """
    ...
    @property
    @pulumi.getter(name="bizName")
    def biz_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The business scenario of the record for acceleration. Valid values:
        """
        return pulumi.get(self, "biz_name")
    ...
    @property
    @pulumi.getter(name="hostPolicy")
    def host_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The origin host policy. This policy takes effect when the record type is CNAME. You can set the policy in two modes:
        """
        return pulumi.get(self, "host_policy")
    ...
    @property
    @pulumi.getter(name="recordName")
    def record_name(self) -> pulumi.Output[builtins.str]:
        """
        The record name. This parameter specifies a filter condition for the query.
        """
        return pulumi.get(self, "record_name")
