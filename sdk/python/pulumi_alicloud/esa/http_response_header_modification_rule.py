...
class _HttpResponseHeaderModificationRuleState:
    def __init__(__self__, *,
                 ...
                 response_header_modifications: pulumi.Input[Optional[Sequence[pulumi.Input['HttpResponseHeaderModificationRuleResponseHeaderModificationArgs']]]] = None,
                 rule: pulumi.Input[Optional[_builtins.str]] = None,
                 rule_enable: pulumi.Input[Optional[_builtins.str]] = None,
                 rule_name: pulumi.Input[Optional[_builtins.str]] = None,
                 sequence: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="responseHeaderModifications")
    def response_header_modifications(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['HttpResponseHeaderModificationRuleResponseHeaderModificationArgs']]]]:
        """
        Modify response headers, supporting add, delete, and modify operations. See `response_header_modification` below.
        """
        return pulumi.get(self, "response_header_modifications")
    ...
    @response_header_modifications.setter
    def response_header_modifications(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['HttpResponseHeaderModificationRuleResponseHeaderModificationArgs']]]]):
        pulumi.set(self, "response_header_modifications", value)
...
class HttpResponseHeaderModificationRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sequence: pulumi.Input[Optional[_builtins.int]] = None,
            site_id: pulumi.Input[Optional[_builtins.str]] = None,
            site_version: pulumi.Input[Optional[_builtins.int]] = None) -> 'HttpResponseHeaderModificationRule':
        """
