...
class HttpResponseHeaderModificationRuleResponseHeaderModification(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str operation: Operation method. Possible values:
...
class RecordAuthConf(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str region: The region of the origin. If the origin type is S3, you must specify this value. You can get the region information from the official website of S3.
        ...
        :param builtins.str version: The version of the signature algorithm. This parameter is required when the origin type is S3 and AuthType is private. The following two types are supported:
        """
        if access_key is not None:
            pulumi.set(__self__, "access_key", access_key)
        if auth_type is not None:
...
class SiteDeliveryTaskHttpDelivery(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dest_url: Optional[builtins.str] = None,
                 header_param: Optional[Mapping[str, builtins.str]] = None,
                 log_body_prefix: Optional[builtins.str] = None,
                 log_body_suffix: Optional[builtins.str] = None,
                 max_batch_mb: Optional[builtins.int] = None,
                 max_batch_size: Optional[builtins.int] = None,
                 max_retry: Optional[builtins.int] = None,
                 query_param: Optional[Mapping[str, builtins.str]] = None,
                 standard_auth_on: Optional[builtins.bool] = None,
                 standard_auth_param: Optional['outputs.SiteDeliveryTaskHttpDeliveryStandardAuthParam'] = None,
                 transform_timeout: Optional[builtins.int] = None):
        """
    ...
    def query_param(self) -> Optional[Mapping[str, builtins.str]]:
        return pulumi.get(self, "query_param")

    @property
    @pulumi.getter(name="standardAuthOn")
    def standard_auth_on(self) -> Optional[builtins.bool]:
    ...
    def transform_timeout(self) -> Optional[builtins.int]:
...
class SiteDeliveryTaskHttpDeliveryStandardAuthParam(dict):
    ...
    def __init__(__self__, *,
                 expired_time: Optional[builtins.int] = None,
    ...
    def expired_time(self) -> Optional[builtins.int]:
...
class SiteDeliveryTaskKafkaDelivery(dict):
    ...
    def __init__(__self__, *,
                 balancer: Optional[builtins.str] = None,
                 brokers: Optional[Sequence[builtins.str]] = None,
                 compress: Optional[builtins.str] = None,
                 machanism_type: Optional[builtins.str] = None,
                 password: Optional[builtins.str] = None,
                 topic: Optional[builtins.str] = None,
                 user_auth: Optional[builtins.bool] = None,
                 user_name: Optional[builtins.str] = None):
        """
        :param builtins.str compress: The compression method. By default, data is not compressed.
        """
    ...
    @property
    @pulumi.getter
    def balancer(self) -> Optional[builtins.str]:
        return pulumi.get(self, "balancer")

    @property
    @pulumi.getter
    def brokers(self) -> Optional[Sequence[builtins.str]]:
    ...
    def machanism_type(self) -> Optional[builtins.str]:
    ...
    def user_auth(self) -> Optional[builtins.bool]:
...
class SiteDeliveryTaskOssDelivery(dict):
    ...
    def __init__(__self__, *,
                 aliuid: Optional[builtins.str] = None,
                 bucket_name: Optional[builtins.str] = None,
                 prefix_path: Optional[builtins.str] = None,
                 region: Optional[builtins.str] = None):
        """
        :param builtins.str region: The region ID of the service.
        """
    ...
    @property
    @pulumi.getter
    def aliuid(self) -> Optional[builtins.str]:
...
class SiteDeliveryTaskS3Delivery(dict):
    ...
    def __init__(__self__, *,
                 ...
                 prefix_path: Optional[builtins.str] = None,
                 region: Optional[builtins.str] = None,
                 s3_cmpt: Optional[builtins.bool] = None,
                 secret_key: Optional[builtins.str] = None,
                 server_side_encryption: Optional[builtins.bool] = None,
                 vertify_type: Optional[builtins.str] = None):
        """
        :param builtins.bool server_side_encryption: Server-side encryption
        :param builtins.str vertify_type: Authentication Type
        """
        if access_key is not None:
            pulumi.set(__self__, "access_key", access_key)
    ...
    def s3_cmpt(self) -> Optional[builtins.bool]:
    ...
    def vertify_type(self) -> Optional[builtins.str]:
        """
        Authentication Type
        """
...
class SiteDeliveryTaskSlsDelivery(dict):
    ...
    def __init__(__self__, *,
                 sls_log_store: Optional[builtins.str] = None,
                 sls_project: Optional[builtins.str] = None,
                 sls_region: Optional[builtins.str] = None):
    ...
    def sls_log_store(self) -> Optional[builtins.str]:
        return pulumi.get(self, "sls_log_store")

    @property
    @pulumi.getter(name="slsProject")
    def sls_project(self) -> Optional[builtins.str]:
        return pulumi.get(self, "sls_project")

    @property
    @pulumi.getter(name="slsRegion")
    def sls_region(self) -> Optional[builtins.str]:
