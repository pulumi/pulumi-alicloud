...
class RedirectRuleArgs:
    def __init__(__self__, *,
                 reserve_query_string: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] reserve_query_string: Indicates whether the feature of retaining the query string is enabled. Valid values:
        ...
        :param pulumi.Input[builtins.str] status_code: The response code that you want to use to indicate URL redirection. Valid values:
               ...
               - 307
               - 308
        :param pulumi.Input[builtins.str] target_url: The destination URL to which requests are redirected.
        :param pulumi.Input[builtins.str] type: The redirect type. Valid value:
        ...
        :param pulumi.Input[builtins.str] rule_name: 规则名，可以查出规则名为所传字段的那条规则，只有传了functionName才生效
    ...
    def reserve_query_string(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def reserve_query_string(self, value: pulumi.Input[builtins.str]):
...
class _RedirectRuleState:
    def __init__(__self__, *,
                 ...
                 reserve_query_string: Optional[pulumi.Input[builtins.str]] = None,
                 rule: Optional[pulumi.Input[builtins.str]] = None,
                 rule_enable: Optional[pulumi.Input[builtins.str]] = None,
                 rule_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="reserveQueryString")
    def reserve_query_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Indicates whether the feature of retaining the query string is enabled. Valid values:
    ...
    @reserve_query_string.setter
    def reserve_query_string(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "reserve_query_string", value)
...
class RedirectRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status_code: Optional[pulumi.Input[builtins.str]] = None,
            target_url: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'RedirectRule':
        """
    ...
    @property
    @pulumi.getter(name="reserveQueryString")
    def reserve_query_string(self) -> pulumi.Output[builtins.str]:
        """
        Indicates whether the feature of retaining the query string is enabled. Valid values:
    ...
    @property
    @pulumi.getter(name="targetUrl")
    def target_url(self) -> pulumi.Output[builtins.str]:
        """
        The destination URL to which requests are redirected.
        """
        return pulumi.get(self, "target_url")
