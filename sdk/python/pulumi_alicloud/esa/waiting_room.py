...
class WaitingRoomArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cookie_name: Custom Cookie name.
        ...
        :param pulumi.Input[builtins.str] new_users_per_minute: Number of new users per minute.
        :param pulumi.Input[builtins.str] queuing_method: Way of queuing. Value:
               -'random': random.
               -'fifo': first in, first out.
               -'Passthrough ': through.
               -'Reject-all': reject all.
        :param pulumi.Input[builtins.str] queuing_status_code: Waiting room status code. Value:
               -'200'
               -'202'
               -'429'
        :param pulumi.Input[builtins.str] session_duration: Session duration in minutes.
        :param pulumi.Input[builtins.int] site_id: The site ID, which can be obtained by calling the [ListSites](https://help.aliyun.com/document_detail/2850189.html) interface.
        :param pulumi.Input[builtins.str] status: Waiting room enabled status. Value:
               -'on': Enable waiting room
               -'off': disabled waiting room
        :param pulumi.Input[builtins.str] total_active_users: Total number of active users.
        :param pulumi.Input[builtins.str] waiting_room_name: The name of the waiting room.
        :param pulumi.Input[builtins.str] waiting_room_type: Waiting room type, support:
               -'default': Indicates the default type.
               -'custom': indicates a custom type.
        :param pulumi.Input[builtins.str] custom_page_html: User-defined waiting room page content, when the waiting room type is custom type, you need to enter. The incoming content needs to be base64 encoded.
        :param pulumi.Input[builtins.str] description: Waiting room description.
        :param pulumi.Input[builtins.str] disable_session_renewal_enable: Disable session renewal. Value:
               -'on': open.
               -'off': closed.
        :param pulumi.Input[builtins.str] json_response_enable: The JSON response. If the accept request header contains "application/json", JSON data is returned. Value:
               -'on': open.
               -'off': closed.
        :param pulumi.Input[builtins.str] language: The language of the waiting room page. When the waiting room type is the default type, it needs to be passed in. The following types are supported:
               -'enus': English.
               -'zhcn': Simplified Chinese.
               -'zhhk': Traditional Chinese.
        :param pulumi.Input[builtins.str] queue_all_enable: All in line. Value:
               -'on': open.
               -'off': closed.
        """
...
class _WaitingRoomState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] status: Waiting room enabled status. Value:
               ...
               -'off': disabled waiting room
        :param pulumi.Input[builtins.str] total_active_users: Total number of active users.
        :param pulumi.Input[builtins.str] waiting_room_id: The waiting room ID, which can be obtained by calling the [ListWaitingRooms](https://help.aliyun.com/document_detail/2850279.html) API.
        :param pulumi.Input[builtins.str] waiting_room_name: The name of the waiting room.
        :param pulumi.Input[builtins.str] waiting_room_type: Waiting room type, support:
               -'default': Indicates the default type.
               -'custom': indicates a custom type.
