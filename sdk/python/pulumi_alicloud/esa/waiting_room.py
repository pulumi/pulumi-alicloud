...
class WaitingRoomArgs:
    def __init__(__self__, *,
                 cookie_name: pulumi.Input[builtins.str],
                 host_name_and_paths: pulumi.Input[Sequence[pulumi.Input['WaitingRoomHostNameAndPathArgs']]],
                 new_users_per_minute: pulumi.Input[builtins.str],
                 queuing_method: pulumi.Input[builtins.str],
                 queuing_status_code: pulumi.Input[builtins.str],
                 session_duration: pulumi.Input[builtins.str],
                 site_id: pulumi.Input[builtins.int],
                 status: pulumi.Input[builtins.str],
                 total_active_users: pulumi.Input[builtins.str],
                 waiting_room_name: pulumi.Input[builtins.str],
                 waiting_room_type: pulumi.Input[builtins.str],
                 custom_page_html: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 disable_session_renewal_enable: Optional[pulumi.Input[builtins.str]] = None,
                 json_response_enable: Optional[pulumi.Input[builtins.str]] = None,
                 language: Optional[pulumi.Input[builtins.str]] = None,
                 queue_all_enable: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WaitingRoom resource.
        :param pulumi.Input[builtins.str] cookie_name: The name of the custom cookie.
        ...
        :param pulumi.Input[builtins.str] new_users_per_minute: The maximum number of new users per minute.
        :param pulumi.Input[builtins.str] queuing_method: The queuing method. Valid values:
               
               - random: Users gain access to the origin randomly, regardless of the arrival time.
               - fifo: Users gain access to the origin in order of arrival.
               - passthrough: Users pass through the waiting room and go straight to the origin.
               - reject-all: Users are blocked from reaching the origin.
        :param pulumi.Input[builtins.str] queuing_status_code: The queuing method. Valid values:
               
               - random: Users gain access to the origin randomly, regardless of the arrival time.
               - fifo: Users gain access to the origin in order of arrival.
               - passthrough: Users pass through the waiting room and go straight to the origin.
               - reject-all: Users are blocked from reaching the origin.
        :param pulumi.Input[builtins.str] session_duration: The maximum duration for which a session remains valid after a user leaves the origin. Unit: minutes.
        :param pulumi.Input[builtins.str] status: The ID of the waiting room, which can be obtained by calling the [ListWaitingRooms](https://www.alibabacloud.com/help/en/doc-detail/2850279.html) operation.
        :param pulumi.Input[builtins.str] total_active_users: The maximum number of active users.
        :param pulumi.Input[builtins.str] waiting_room_name: Specifies whether to enable the waiting room. Valid values:
               
               - on
               - off
        :param pulumi.Input[builtins.str] waiting_room_type: The type of the waiting room. Valid values:
               
               - default
               - custom
        :param pulumi.Input[builtins.str] custom_page_html: The HTML content or identifier of the custom queuing page. This parameter is valid only when `WaitingRoomType` is set to `custom`. The content must be URL-encoded.
        :param pulumi.Input[builtins.str] description: Specifies whether to enable JSON response. If you set this parameter to on, a JSON body is returned for requests to the waiting room with the header Accept: application/json. Valid values:
               
               - on
               - off
        :param pulumi.Input[builtins.str] disable_session_renewal_enable: The maximum duration for which a session remains valid after a user leaves the origin. Unit: minutes.
        :param pulumi.Input[builtins.str] json_response_enable: Indicates whether JSON response is enabled. If you set this parameter to on, a JSON body is returned for requests to the waiting room with the header Accept: application/json. Valid values:
               
               - on
               - off
        :param pulumi.Input[builtins.str] language: The language of the waiting room page. This parameter is returned when the waiting room type is set to default. Valid values:
               
               - enus: English.
               - zhcn: Simplified Chinese.
               - zhhk: Traditional Chinese.
        :param pulumi.Input[builtins.str] queue_all_enable: Indicates whether all requests must be queued. Valid values:
    ...
    def cookie_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @cookie_name.setter
    def cookie_name(self, value: pulumi.Input[builtins.str]):
    ...
    def new_users_per_minute(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def new_users_per_minute(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "new_users_per_minute", value)

    @property
    @pulumi.getter(name="queuingMethod")
    def queuing_method(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def queuing_method(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "queuing_method", value)

    @property
    @pulumi.getter(name="queuingStatusCode")
    def queuing_status_code(self) -> pulumi.Input[builtins.str]:
        """
        The queuing method. Valid values:
    ...
    def queuing_status_code(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "queuing_status_code", value)

    @property
    @pulumi.getter(name="sessionDuration")
    def session_duration(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def session_duration(self, value: pulumi.Input[builtins.str]):
    ...
    def total_active_users(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def total_active_users(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "total_active_users", value)

    @property
    @pulumi.getter(name="waitingRoomName")
    def waiting_room_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def waiting_room_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "waiting_room_name", value)

    @property
    @pulumi.getter(name="waitingRoomType")
    def waiting_room_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def waiting_room_type(self, value: pulumi.Input[builtins.str]):
    ...
    def disable_session_renewal_enable(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The maximum duration for which a session remains valid after a user leaves the origin. Unit: minutes.
        """
    ...
    def disable_session_renewal_enable(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "disable_session_renewal_enable", value)

    @property
    @pulumi.getter(name="jsonResponseEnable")
    def json_response_enable(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def json_response_enable(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def queue_all_enable(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def queue_all_enable(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _WaitingRoomState:
    def __init__(__self__, *,
                 ...
                 json_response_enable: Optional[pulumi.Input[builtins.str]] = None,
                 language: Optional[pulumi.Input[builtins.str]] = None,
                 new_users_per_minute: Optional[pulumi.Input[builtins.str]] = None,
                 queue_all_enable: Optional[pulumi.Input[builtins.str]] = None,
                 queuing_method: Optional[pulumi.Input[builtins.str]] = None,
                 queuing_status_code: Optional[pulumi.Input[builtins.str]] = None,
                 session_duration: Optional[pulumi.Input[builtins.str]] = None,
                 site_id: Optional[pulumi.Input[builtins.int]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 total_active_users: Optional[pulumi.Input[builtins.str]] = None,
                 waiting_room_id: Optional[pulumi.Input[builtins.str]] = None,
                 waiting_room_name: Optional[pulumi.Input[builtins.str]] = None,
                 waiting_room_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] status: The ID of the waiting room, which can be obtained by calling the [ListWaitingRooms](https://www.alibabacloud.com/help/en/doc-detail/2850279.html) operation.
        :param pulumi.Input[builtins.str] total_active_users: The maximum number of active users.
        :param pulumi.Input[builtins.str] waiting_room_id: The website ID, which can be obtained by calling the [ListSites](https://www.alibabacloud.com/help/en/doc-detail/2850189.html) operation.
        :param pulumi.Input[builtins.str] waiting_room_name: Specifies whether to enable the waiting room. Valid values:
    ...
    @property
    @pulumi.getter(name="newUsersPerMinute")
    def new_users_per_minute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The maximum number of new users per minute.
        """
        return pulumi.get(self, "new_users_per_minute")
    ...
    @new_users_per_minute.setter
    def new_users_per_minute(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "new_users_per_minute", value)
    ...
    @property
    @pulumi.getter(name="queuingMethod")
    def queuing_method(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The queuing method. Valid values:
    ...
    @queuing_method.setter
    def queuing_method(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "queuing_method", value)

    @property
    @pulumi.getter(name="queuingStatusCode")
    def queuing_status_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The queuing method. Valid values:
    ...
    @queuing_status_code.setter
    def queuing_status_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "queuing_status_code", value)
    ...
    @property
    @pulumi.getter(name="totalActiveUsers")
    def total_active_users(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The maximum number of active users.
        """
        return pulumi.get(self, "total_active_users")
    ...
    @total_active_users.setter
    def total_active_users(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "total_active_users", value)
    ...
    @property
    @pulumi.getter(name="waitingRoomName")
    def waiting_room_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies whether to enable the waiting room. Valid values:
    ...
    @waiting_room_name.setter
    def waiting_room_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "waiting_room_name", value)

    @property
    @pulumi.getter(name="waitingRoomType")
    def waiting_room_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the waiting room. Valid values:
    ...
    @waiting_room_type.setter
    def waiting_room_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "waiting_room_type", value)
...
class WaitingRoom(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            waiting_room_id: Optional[pulumi.Input[builtins.str]] = None,
            waiting_room_name: Optional[pulumi.Input[builtins.str]] = None,
            waiting_room_type: Optional[pulumi.Input[builtins.str]] = None) -> 'WaitingRoom':
        """
    ...
    @property
    @pulumi.getter(name="cookieName")
    def cookie_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the custom cookie.
        """
        return pulumi.get(self, "cookie_name")
    ...
    @property
    @pulumi.getter(name="disableSessionRenewalEnable")
    def disable_session_renewal_enable(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The maximum duration for which a session remains valid after a user leaves the origin. Unit: minutes.
        """
        return pulumi.get(self, "disable_session_renewal_enable")
    ...
    @property
    @pulumi.getter(name="jsonResponseEnable")
    def json_response_enable(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates whether JSON response is enabled. If you set this parameter to on, a JSON body is returned for requests to the waiting room with the header Accept: application/json. Valid values:
    ...
    @property
    @pulumi.getter(name="newUsersPerMinute")
    def new_users_per_minute(self) -> pulumi.Output[builtins.str]:
        """
        The maximum number of new users per minute.
        """
        return pulumi.get(self, "new_users_per_minute")
    ...
    @property
    @pulumi.getter(name="queueAllEnable")
    def queue_all_enable(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates whether all requests must be queued. Valid values:
    ...
    @property
    @pulumi.getter(name="queuingMethod")
    def queuing_method(self) -> pulumi.Output[builtins.str]:
        """
        The queuing method. Valid values:
    ...
    @property
    @pulumi.getter(name="queuingStatusCode")
    def queuing_status_code(self) -> pulumi.Output[builtins.str]:
        """
        The queuing method. Valid values:
    ...
    @property
    @pulumi.getter(name="totalActiveUsers")
    def total_active_users(self) -> pulumi.Output[builtins.str]:
        """
        The maximum number of active users.
        """
        return pulumi.get(self, "total_active_users")
    ...
    @property
    @pulumi.getter(name="waitingRoomName")
    def waiting_room_name(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether to enable the waiting room. Valid values:
    ...
    @property
    @pulumi.getter(name="waitingRoomType")
    def waiting_room_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the waiting room. Valid values:
