...
class PageArgs:
    def __init__(__self__, *,
                 ...
                 page_name: pulumi.Input[builtins.str],
                 content: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Page resource.
        :param pulumi.Input[builtins.str] content_type: The description of the custom error page.
        :param pulumi.Input[builtins.str] page_name: The ID of the custom error page, which can be obtained by calling the [ListPages](https://www.alibabacloud.com/help/en/doc-detail/2850223.html) operation.
        :param pulumi.Input[builtins.str] content: The Content-Type field in the HTTP header. Valid values:
               
               - text/html
               - application/json
        :param pulumi.Input[builtins.str] description: The name of the custom error page.
        """
    ...
    def page_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @page_name.setter
    def page_name(self, value: pulumi.Input[builtins.str]):
...
class _PageState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 page_name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="pageName")
    def page_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the custom error page, which can be obtained by calling the [ListPages](https://www.alibabacloud.com/help/en/doc-detail/2850223.html) operation.
        """
        return pulumi.get(self, "page_name")
    ...
    @page_name.setter
    def page_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "page_name", value)
...
class Page(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            content_type: Optional[pulumi.Input[builtins.str]] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            page_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Page':
        """
    ...
    @property
    @pulumi.getter(name="pageName")
    def page_name(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the custom error page, which can be obtained by calling the [ListPages](https://www.alibabacloud.com/help/en/doc-detail/2850223.html) operation.
        """
        return pulumi.get(self, "page_name")
