...
class PageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content_type: The Content-Type field in the HTTP header.
        :param pulumi.Input[builtins.str] page_name: The name of the custom response page.
        :param pulumi.Input[builtins.str] content: The Base64-encoded content of the error page. The content type is specified by the Content-Type field.
        :param pulumi.Input[builtins.str] description: The description of the custom error page.
        """
