...
class ListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the custom list.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] items: The items in the custom list, which are displayed as an array.
        :param pulumi.Input[builtins.str] kind: The type of the custom list.
        :param pulumi.Input[builtins.str] name: The name of the custom list.
        """
