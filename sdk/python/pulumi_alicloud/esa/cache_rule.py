...
class CacheRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] additional_cacheable_ports: Enable caching on specified ports. Value range: 8880, 2052, 2082, 2086, 2095, 2053, 2083, 2087, 2096
        :param pulumi.Input[builtins.str] browser_cache_mode: Browser cache mode. Possible values:
        :param pulumi.Input[builtins.str] browser_cache_ttl: Browser cache expiration time in seconds.
        :param pulumi.Input[builtins.str] bypass_cache: Set the bypass cache mode. Possible values:
        :param pulumi.Input[builtins.str] cache_deception_armor: Cache deception protection. Used to defend against web cache deception attacks, only the cache content that passes the validation will be cached. Value range:
        :param pulumi.Input[builtins.str] cache_reserve_eligibility: Cache retention eligibility. Used to control whether user requests bypass the cache retention node when returning to the origin. Possible values:
        :param pulumi.Input[builtins.str] check_presence_cookie: When generating the cache key, check if the cookie exists. If it does, add the cookie name (case-insensitive) to the cache key. Multiple cookie names are supported, separated by spaces.
        :param pulumi.Input[builtins.str] check_presence_header: When generating the cache key, check if the header exists. If it does, add the header name (case-insensitive) to the cache key. Multiple header names are supported, separated by spaces.
        :param pulumi.Input[builtins.str] edge_cache_mode: Edge cache mode. Possible values:
        :param pulumi.Input[builtins.str] edge_cache_ttl: Edge cache expiration time in seconds.
        :param pulumi.Input[builtins.str] edge_status_code_cache_ttl: Status code cache expiration time in seconds.
        :param pulumi.Input[builtins.str] include_cookie: When generating the cache key, add the specified cookie names and their values. Multiple values are supported, separated by spaces.
        :param pulumi.Input[builtins.str] include_header: When generating the cache key, add the specified header names and their values. Multiple values are supported, separated by spaces.
        :param pulumi.Input[builtins.str] query_string: Query strings to be reserved or excluded. Multiple values are supported, separated by spaces.
        :param pulumi.Input[builtins.str] query_string_mode: The processing mode for query strings when generating the cache key. Possible values:
        ...
        :param pulumi.Input[builtins.str] serve_stale: Serve stale cache. When enabled, the node can still respond to user requests with expired cached files when the origin server is unavailable. Value range:
        ...
        :param pulumi.Input[builtins.str] sort_query_string_for_cache: Query string sorting, disabled by default. Possible values:
        :param pulumi.Input[builtins.str] user_device_type: When generating the cache key, add the client device type. Possible values:
        :param pulumi.Input[builtins.str] user_geo: When generating the cache key, add the client's geographic location. Possible values:
        :param pulumi.Input[builtins.str] user_language: When generating cache keys, include the client's language type. Possible values:
        """
...
class _CacheRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cache_deception_armor: Cache deception protection. Used to defend against web cache deception attacks, only the cache content that passes the validation will be cached. Value range:
        :param pulumi.Input[builtins.str] cache_reserve_eligibility: Cache retention eligibility. Used to control whether user requests bypass the cache retention node when returning to the origin. Possible values:
        :param pulumi.Input[builtins.int] cache_rule_id: Cache Rule Id.
        :param pulumi.Input[builtins.str] check_presence_cookie: When generating the cache key, check if the cookie exists. If it does, add the cookie name (case-insensitive) to the cache key. Multiple cookie names are supported, separated by spaces.
        :param pulumi.Input[builtins.str] check_presence_header: When generating the cache key, check if the header exists. If it does, add the header name (case-insensitive) to the cache key. Multiple header names are supported, separated by spaces.
        :param pulumi.Input[builtins.str] edge_cache_mode: Edge cache mode. Possible values:
        :param pulumi.Input[builtins.str] edge_cache_ttl: Edge cache expiration time in seconds.
