...
class EdgeContainerAppRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_id: The application ID
        :param pulumi.Input[builtins.str] record_name: The associated domain name.
        :param pulumi.Input[builtins.int] site_id: The website ID.
        """
...
class _EdgeContainerAppRecordState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_id: The application ID
        :param pulumi.Input[builtins.str] create_time: The time when the domain name was added. The time follows the ISO 8601 standard in the YYYY-MM-DDThh:mm:ss format. The time is displayed in UTC.
        :param pulumi.Input[builtins.str] record_name: The associated domain name.
        :param pulumi.Input[builtins.int] site_id: The website ID.
        """
...
class EdgeContainerAppRecord(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            create_time: Optional[pulumi.Input[builtins.str]] = None,
            record_name: Optional[pulumi.Input[builtins.str]] = None,
            site_id: Optional[pulumi.Input[builtins.int]] = None) -> 'EdgeContainerAppRecord':
        """
