...
class GetSitesResult:
    ...
    @property
    @pulumi.getter
    def coverage(self) -> Optional[builtins.str]:
        """
        Acceleration area
        """
    ...
    def only_enterprise(self) -> Optional[builtins.bool]:
    ...
    def plan_subscribe_type(self) -> Optional[builtins.str]:
    ...
    def site_search_type(self) -> Optional[builtins.str]:
...
def get_sites(access_type: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Site IDs.
    :param builtins.str name_regex: A regex string to filter results by Group Metric Rule name.
    :param builtins.bool only_enterprise: Only the Enterprise version, pass **true** when the table only queries the enterprise version of the site.
    ...
    :param builtins.str plan_subscribe_type: Package subscription type. Value:-**basicplan**: Basic version.-**standardplan**: Standard version.-**advancedplan**: Advanced version.-**enterpriseplan**: Enterprise Edition.
    :param builtins.str resource_group_id: The ID of the resource group
    :param builtins.str site_name: Site Name
    :param builtins.str site_search_type: The search match pattern for the site name. The default value is exact match. Valid values:-**prefix**: matches the prefix.-**suffix**: The suffix matches.-**exact**: exact match.-**fuzzy**: fuzzy match.
...
def get_sites_output(access_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     coverage: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                     name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     only_enterprise: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                     ...
                     plan_subscribe_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     resource_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     site_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     site_search_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
