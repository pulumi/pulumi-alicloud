...
class WaitingRoomRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] rule: The content of the rule, the implemented policy or conditional expression.
        :param pulumi.Input[builtins.str] rule_name: Rule name, optional, used to query by waiting room bypass rule name.
        :param pulumi.Input[builtins.int] site_id: The site ID, which can be obtained by calling the ListSites API.
        :param pulumi.Input[builtins.str] status: Rule enabled status, supporting:
               -'on': means enabled.
               -'off': means disabled.
...
class _WaitingRoomRuleState:
    def __init__(__self__, *,
                 ...
                 waiting_room_rule_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] status: Rule enabled status, supporting:
               ...
               -'off': means disabled.
        :param pulumi.Input[builtins.str] waiting_room_id: Waiting room ID, used to identify a specific waiting room. It can be obtained by calling the [listwaitingroom](https://help.aliyun.com/document_detail/2850279.html) interface.
        :param pulumi.Input[builtins.int] waiting_room_rule_id: The rule ID, which can be used to query a specific rule.
        """
        if rule is not None:
            pulumi.set(__self__, "rule", rule)
    ...
    def waiting_room_rule_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def waiting_room_rule_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "waiting_room_rule_id", value)


class WaitingRoomRule(pulumi.CustomResource):

    pulumi_type = "alicloud:esa/waitingRoomRule:WaitingRoomRule"
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            waiting_room_id: Optional[pulumi.Input[builtins.str]] = None,
            waiting_room_rule_id: Optional[pulumi.Input[builtins.int]] = None) -> 'WaitingRoomRule':
        """
    ...
    @property
    @pulumi.getter(name="waitingRoomRuleId")
    def waiting_room_rule_id(self) -> pulumi.Output[builtins.int]:
        """
        The rule ID, which can be used to query a specific rule.
        """
        return pulumi.get(self, "waiting_room_rule_id")
