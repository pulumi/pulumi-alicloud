...
class WaitingRoomRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] rule: Specifies whether to enable the rule. Valid values:
               
               - on
               - off
        :param pulumi.Input[builtins.str] rule_name: Optional. The rule ID, which can be used to query a specific rule.
        :param pulumi.Input[builtins.int] site_id: The site ID, which can be obtained by calling the ListSites API.
        :param pulumi.Input[builtins.str] status: The rule name.
...
class _WaitingRoomRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] status: The rule name.
        :param pulumi.Input[builtins.str] waiting_room_id: The website ID, which can be obtained by calling the [ListSites](https://www.alibabacloud.com/help/en/doc-detail/2850189.html) operation.
        :param pulumi.Input[builtins.int] waiting_room_rule_id: WaitingRoomRuleId Id
        """
        if rule is not None:
            pulumi.set(__self__, "rule", rule)
