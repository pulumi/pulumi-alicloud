...
class CertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] site_id: The site ID, which can be obtained by calling the ListSites interface.
        ...
        :param pulumi.Input[builtins.str] type: Certificate type. Possible values: lets_encrypt: Let's Encrypt certificate;
        """
