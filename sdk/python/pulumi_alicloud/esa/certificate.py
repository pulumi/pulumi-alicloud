...
class CertificateArgs:
    def __init__(__self__, *,
                 created_type: pulumi.Input[builtins.str],
                 site_id: pulumi.Input[builtins.int],
                 cas_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] created_type: The certificate ID on Certificate Management Service. Valid values:
               - free: a free certificate.
               - cas: a certificate purchased by using Certificate Management Service.
               - upload: a custom certificate that you upload.
        :param pulumi.Input[builtins.int] site_id: Site ID, which can be obtained by calling the [ListSites](https://www.alibabacloud.com/help/en/doc-detail/2850189.html) interface.
        :param pulumi.Input[builtins.str] cas_id: The certificate ID on Certificate Management Service.
        :param pulumi.Input[builtins.str] cert_id: The certificate ID on ESA.
        ...
        :param pulumi.Input[builtins.str] domains: The Subject Alternative Name (SAN) of the certificate.
        :param pulumi.Input[builtins.str] private_key: The certificate content.
        :param pulumi.Input[builtins.str] region: The private key of the certificate.
        :param pulumi.Input[builtins.str] type: The certificate type. Valid values:
               - cas: a certificate purchased by using Certificate Management Service.
               - upload: a custom certificate that you upload.
        """
    ...
    def created_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @created_type.setter
    def created_type(self, value: pulumi.Input[builtins.str]):
    ...
    def cas_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cas_id.setter
    def cas_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CertificateState:
    def __init__(__self__, *,
                 ...
                 created_type: Optional[pulumi.Input[builtins.str]] = None,
                 domains: Optional[pulumi.Input[builtins.str]] = None,
                 private_key: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] region: The private key of the certificate.
        :param pulumi.Input[builtins.int] site_id: Site ID, which can be obtained by calling the [ListSites](https://www.alibabacloud.com/help/en/doc-detail/2850189.html) interface.
        :param pulumi.Input[builtins.str] status: Certificate status.(within 30 days).- issued.- applying.- application failed.- canceled.
        :param pulumi.Input[builtins.str] type: The certificate type. Valid values:
               - cas: a certificate purchased by using Certificate Management Service.
               - upload: a custom certificate that you upload.
        """
    ...
    @property
    @pulumi.getter(name="createdType")
    def created_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The certificate ID on Certificate Management Service. Valid values:
        - free: a free certificate.
        - cas: a certificate purchased by using Certificate Management Service.
    ...
    @created_type.setter
    def created_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "created_type", value)
...
class Certificate(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="casId")
    def cas_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The certificate ID on Certificate Management Service.
        """
        return pulumi.get(self, "cas_id")
    ...
    @property
    @pulumi.getter(name="createdType")
    def created_type(self) -> pulumi.Output[builtins.str]:
        """
        The certificate ID on Certificate Management Service. Valid values:
        - free: a free certificate.
        - cas: a certificate purchased by using Certificate Management Service.
    ...
    @property
    @pulumi.getter
    def domains(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Subject Alternative Name (SAN) of the certificate.
        """
        return pulumi.get(self, "domains")
