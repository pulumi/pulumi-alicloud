...
class HttpIncomingRequestHeaderModificationRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 request_header_modifications: pulumi.Input[Optional[Sequence[pulumi.Input[Union['HttpIncomingRequestHeaderModificationRuleRequestHeaderModificationArgs', 'HttpIncomingRequestHeaderModificationRuleRequestHeaderModificationArgsDict']]]]] = None,
                 rule: pulumi.Input[Optional[_builtins.str]] = None,
                 rule_enable: pulumi.Input[Optional[_builtins.str]] = None,
                 rule_name: pulumi.Input[Optional[_builtins.str]] = None,
                 sequence: pulumi.Input[Optional[_builtins.int]] = None,
