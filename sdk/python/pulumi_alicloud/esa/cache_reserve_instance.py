...
class CacheReserveInstanceArgs:
    def __init__(__self__, *,
                 ...
                 cr_region: Optional[pulumi.Input[builtins.str]] = None,
                 period: Optional[pulumi.Input[builtins.int]] = None,
                 quota_gb: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a CacheReserveInstance resource.
        :param pulumi.Input[builtins.str] payment_type: Specifies whether to enable auto payment.
        :param pulumi.Input[builtins.bool] auto_pay: Automatic payment.
        :param pulumi.Input[builtins.bool] auto_renew: Whether to auto-renew:
        :param pulumi.Input[builtins.str] cr_region: Cache holding area
               - `HK`: Hong Kong, China
               - `CN`: Mainland China
        :param pulumi.Input[builtins.int] period: Purchase period (unit: month).
        :param pulumi.Input[builtins.int] quota_gb: Cache retention specification (unit: GB).
        """
    ...
    def cr_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Cache holding area
        - `HK`: Hong Kong, China
        - `CN`: Mainland China
    ...
    @cr_region.setter
    def cr_region(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def quota_gb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @quota_gb.setter
    def quota_gb(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _CacheReserveInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cr_region: Cache holding area
               - `HK`: Hong Kong, China
               - `CN`: Mainland China
        :param pulumi.Input[builtins.str] create_time: Instance purchase time.
        :param pulumi.Input[builtins.str] payment_type: Specifies whether to enable auto payment.
        :param pulumi.Input[builtins.int] period: Purchase period (unit: month).
        :param pulumi.Input[builtins.int] quota_gb: Cache retention specification (unit: GB).
        :param pulumi.Input[builtins.str] status: The status of the cache reserve instance. , it is unavailable.
        """
        if auto_pay is not None:
            pulumi.set(__self__, "auto_pay", auto_pay)
        if auto_renew is not None:
...
class CacheReserveInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            period: Optional[pulumi.Input[builtins.int]] = None,
            quota_gb: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'CacheReserveInstance':
        """
    ...
    @property
    @pulumi.getter(name="crRegion")
    def cr_region(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cache holding area
        - `HK`: Hong Kong, China
        - `CN`: Mainland China
    ...
    @property
    @pulumi.getter(name="quotaGb")
    def quota_gb(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Cache retention specification (unit: GB).
        """
        return pulumi.get(self, "quota_gb")
