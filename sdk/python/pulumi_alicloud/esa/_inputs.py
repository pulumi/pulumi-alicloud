...
class HttpRequestHeaderModificationRuleRequestHeaderModificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Request Header Name.
        :param pulumi.Input[builtins.str] operation: Mode of operation. Value range:
...
class HttpResponseHeaderModificationRuleResponseHeaderModificationArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The response header name.
        :param pulumi.Input[builtins.str] operation: Operation method. Possible values:
        :param pulumi.Input[builtins.str] value: The response header value.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "operation", operation)
        if value is not None:
...
if not MYPY:
    class OriginPoolOriginArgsDict(TypedDict):
        ...
        Origin Name.
        """
        origin_id: NotRequired[pulumi.Input[builtins.int]]
        """
        Origin ID.
        """
...
class OriginPoolOriginArgs:
    def __init__(__self__, *,
                 ...
                 origin_id: Optional[pulumi.Input[builtins.int]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 weight: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] address: Origin Address.
        ...
        :param pulumi.Input[builtins.bool] enabled: Whether the source station is enabled:
        :param pulumi.Input[builtins.str] header: The request header that is sent when returning to the source. Only Host is supported.
        :param pulumi.Input[builtins.str] name: Origin Name.
        :param pulumi.Input[builtins.int] origin_id: Origin ID.
        :param pulumi.Input[builtins.str] type: Source station type:
               ip_domain: ip or domain name type origin station;
               - `OSS`:OSS address source station;
               - `S3`:AWS S3 Source station.
        :param pulumi.Input[builtins.int] weight: Weight, 0-100.
        """
    ...
    def origin_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Origin ID.
        """
    ...
    @origin_id.setter
    def origin_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class OriginPoolOriginAuthConfArgsDict(TypedDict):
        ...
        """
        secret_key: NotRequired[pulumi.Input[builtins.str]]
        """
...
class OriginPoolOriginAuthConfArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] access_key: The AccessKey to be passed when AuthType is set to private_cross_account or private.
        :param pulumi.Input[builtins.str] auth_type: Authentication type.
        :param pulumi.Input[builtins.str] region: The Region of the source station to be transmitted when the source station is AWS S3.
        :param pulumi.Input[builtins.str] secret_key: The SecretKey to be passed when AuthType is set to private_cross_account or private.
        :param pulumi.Input[builtins.str] version: The signature version to be transmitted when the source station is AWS S3.
        """
...
class RecordAuthConfArgs:
    def __init__(__self__, *,
                 ...
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] access_key: The access key of the account to which the origin server belongs. This parameter is required when the SourceType is OSS, and AuthType is private_same_account, or when the SourceType is S3 and AuthType is private.
        :param pulumi.Input[builtins.str] auth_type: The authentication type of the origin server. Different origins support different authentication types. The type of origin refers to the SourceType parameter in this operation. If the type of origin is OSS or S3, you must specify the authentication type of the origin. Valid values:
        :param pulumi.Input[builtins.str] region: The region of the origin. If the origin type is S3, you must specify this value. You can get the region information from the official website of S3.
        :param pulumi.Input[builtins.str] secret_key: The secret access key of the account to which the origin server belongs. This parameter is required when the SourceType is OSS, and AuthType is private_same_account, or when the SourceType is S3 and AuthType is private.
        :param pulumi.Input[builtins.str] version: The version of the signature algorithm. This parameter is required when the origin type is S3 and AuthType is private. The following two types are supported:
        """
        if access_key is not None:
            pulumi.set(__self__, "access_key", access_key)
        if auth_type is not None:
...
if not MYPY:
    class RecordDataArgsDict(TypedDict):
        ...
        """
        flag: NotRequired[pulumi.Input[builtins.int]]
        """
...
class RecordDataArgs:
    def __init__(__self__, *,
                 ...
                 flag: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 weight: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] algorithm: The encryption algorithm used for the record, specified within the range from 0 to 255. This parameter is required when you add CERT or SSHFP records.
        :param pulumi.Input[builtins.str] certificate: The public key of the certificate. This parameter is required when you add CERT, SMIMEA, or TLSA records.
        :param pulumi.Input[builtins.str] fingerprint: The public key fingerprint of the record. This parameter is required when you add a SSHFP record.
        :param pulumi.Input[builtins.int] flag: The flag bit of the record. The Flag for a CAA record indicates its priority and how it is processed, specified within the range of 0 to 255. This parameter is required when you add a CAA record.
        :param pulumi.Input[builtins.int] key_tag: The public key identification for the record, specified within the range of 0 to 65,535. This parameter is required when you add a CAA record.
        :param pulumi.Input[builtins.int] matching_type: The algorithm policy used to match or validate the certificate, specified within the range 0 to 255. This parameter is required when you add SMIMEA or TLSA records.
        :param pulumi.Input[builtins.int] port: The port of the record, specified within the range of 0 to 65,535. This parameter is required when you add an SRV record.
        :param pulumi.Input[builtins.int] priority: The priority of the record, specified within the range of 0 to 65,535. A smaller value indicates a higher priority. This parameter is required when you add MX, SRV, and URI records.
        :param pulumi.Input[builtins.int] selector: The type of certificate or public key, specified within the range of 0 to 255. This parameter is required when you add SMIMEA or TLSA records.
        :param pulumi.Input[builtins.str] tag: The label of the record. The Tag of a CAA record indicate its specific type and usage. This parameter is required when you add a CAA record.
        :param pulumi.Input[builtins.int] type: The certificate type of the record (in CERT records), or the public key type (in SSHFP records). This parameter is required when you add CERT or SSHFP records.
        :param pulumi.Input[builtins.int] usage: The usage identifier of the record, specified within the range of 0 to 255. This parameter is required when you add SMIMEA or TLSA records.
        :param pulumi.Input[builtins.str] value: The record value or part of the record content. This parameter is required when you add A/AAAA, CNAME, NS, MX, TXT, CAA, SRV, and URI records. It has different meanings based on different types of records:
               ...
               - `SRV`: a valid domain name of the target host.
               - `URI`: a valid URI string.
        :param pulumi.Input[builtins.int] weight: The weight of the record, specified within the range of 0 to 65,535. This parameter is required when you add SRV or URI records.
        """
    ...
    @property
    @pulumi.getter
    def flag(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The flag bit of the record. The Flag for a CAA record indicates its priority and how it is processed, specified within the range of 0 to 255. This parameter is required when you add a CAA record.
        """
    ...
    @flag.setter
    def flag(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class SiteDeliveryTaskHttpDeliveryArgsDict(TypedDict):
        ...
        dest_url: NotRequired[pulumi.Input[builtins.str]]
        header_param: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        log_body_prefix: NotRequired[pulumi.Input[builtins.str]]
        log_body_suffix: NotRequired[pulumi.Input[builtins.str]]
        max_batch_mb: NotRequired[pulumi.Input[builtins.int]]
        max_batch_size: NotRequired[pulumi.Input[builtins.int]]
        max_retry: NotRequired[pulumi.Input[builtins.int]]
        query_param: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        standard_auth_on: NotRequired[pulumi.Input[builtins.bool]]
        ...
        """
        transform_timeout: NotRequired[pulumi.Input[builtins.int]]
elif False:
...
class SiteDeliveryTaskHttpDeliveryArgs:
    def __init__(__self__, *,
                 ...
                 dest_url: Optional[pulumi.Input[builtins.str]] = None,
                 header_param: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 log_body_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 log_body_suffix: Optional[pulumi.Input[builtins.str]] = None,
                 max_batch_mb: Optional[pulumi.Input[builtins.int]] = None,
                 max_batch_size: Optional[pulumi.Input[builtins.int]] = None,
                 max_retry: Optional[pulumi.Input[builtins.int]] = None,
                 query_param: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 standard_auth_on: Optional[pulumi.Input[builtins.bool]] = None,
                 standard_auth_param: Optional[pulumi.Input['SiteDeliveryTaskHttpDeliveryStandardAuthParamArgs']] = None,
                 transform_timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    def dest_url(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "dest_url")

    @dest_url.setter
    def dest_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dest_url", value)

    @property
    @pulumi.getter(name="headerParam")
    def header_param(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "header_param")

    @header_param.setter
    def header_param(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "header_param", value)

    @property
    @pulumi.getter(name="logBodyPrefix")
    def log_body_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "log_body_prefix")

    @log_body_prefix.setter
    def log_body_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_body_prefix", value)

    @property
    @pulumi.getter(name="logBodySuffix")
    def log_body_suffix(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "log_body_suffix")

    @log_body_suffix.setter
    def log_body_suffix(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_body_suffix", value)

    @property
    @pulumi.getter(name="maxBatchMb")
    def max_batch_mb(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "max_batch_mb")

    @max_batch_mb.setter
    def max_batch_mb(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def query_param(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "query_param")

    @query_param.setter
    def query_param(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "query_param", value)

    @property
    @pulumi.getter(name="standardAuthOn")
    def standard_auth_on(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "standard_auth_on")

    @standard_auth_on.setter
    def standard_auth_on(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def transform_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "transform_timeout")

    @transform_timeout.setter
    def transform_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "transform_timeout", value)


if not MYPY:
    class SiteDeliveryTaskHttpDeliveryStandardAuthParamArgsDict(TypedDict):
        expired_time: NotRequired[pulumi.Input[builtins.int]]
...
if not MYPY:
    class SiteDeliveryTaskKafkaDeliveryArgsDict(TypedDict):
        balancer: NotRequired[pulumi.Input[builtins.str]]
        brokers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        compress: NotRequired[pulumi.Input[builtins.str]]
        """
        The compression method. By default, data is not compressed.
        """
        machanism_type: NotRequired[pulumi.Input[builtins.str]]
        password: NotRequired[pulumi.Input[builtins.str]]
        topic: NotRequired[pulumi.Input[builtins.str]]
        user_auth: NotRequired[pulumi.Input[builtins.bool]]
...
class SiteDeliveryTaskKafkaDeliveryArgs:
    def __init__(__self__, *,
                 balancer: Optional[pulumi.Input[builtins.str]] = None,
                 brokers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 compress: Optional[pulumi.Input[builtins.str]] = None,
                 machanism_type: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 topic: Optional[pulumi.Input[builtins.str]] = None,
                 user_auth: Optional[pulumi.Input[builtins.bool]] = None,
                 user_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] compress: The compression method. By default, data is not compressed.
        """
    ...
    @property
    @pulumi.getter
    def balancer(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "balancer")

    @balancer.setter
    def balancer(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "balancer", value)

    @property
    @pulumi.getter
    def brokers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "brokers")

    @brokers.setter
    def brokers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def machanism_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "machanism_type")

    @machanism_type.setter
    def machanism_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_auth(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "user_auth")

    @user_auth.setter
    def user_auth(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class SiteDeliveryTaskOssDeliveryArgsDict(TypedDict):
        aliuid: NotRequired[pulumi.Input[builtins.str]]
        bucket_name: NotRequired[pulumi.Input[builtins.str]]
        prefix_path: NotRequired[pulumi.Input[builtins.str]]
        region: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SiteDeliveryTaskOssDeliveryArgs:
    def __init__(__self__, *,
                 aliuid: Optional[pulumi.Input[builtins.str]] = None,
                 bucket_name: Optional[pulumi.Input[builtins.str]] = None,
                 prefix_path: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] region: The region ID of the service.
        """
    ...
    @property
    @pulumi.getter
    def aliuid(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "aliuid")

    @aliuid.setter
    def aliuid(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def prefix_path(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "prefix_path")

    @prefix_path.setter
    def prefix_path(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class SiteDeliveryTaskS3DeliveryArgsDict(TypedDict):
        ...
        prefix_path: NotRequired[pulumi.Input[builtins.str]]
        region: NotRequired[pulumi.Input[builtins.str]]
        s3_cmpt: NotRequired[pulumi.Input[builtins.bool]]
        secret_key: NotRequired[pulumi.Input[builtins.str]]
        server_side_encryption: NotRequired[pulumi.Input[builtins.bool]]
        """
        Server-side encryption
        """
        vertify_type: NotRequired[pulumi.Input[builtins.str]]
        """
        Authentication Type
        """
elif False:
...
class SiteDeliveryTaskS3DeliveryArgs:
    def __init__(__self__, *,
                 ...
                 prefix_path: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 s3_cmpt: Optional[pulumi.Input[builtins.bool]] = None,
                 secret_key: Optional[pulumi.Input[builtins.str]] = None,
                 server_side_encryption: Optional[pulumi.Input[builtins.bool]] = None,
                 vertify_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] server_side_encryption: Server-side encryption
        :param pulumi.Input[builtins.str] vertify_type: Authentication Type
        """
        if access_key is not None:
            pulumi.set(__self__, "access_key", access_key)
    ...
    def s3_cmpt(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "s3_cmpt")

    @s3_cmpt.setter
    def s3_cmpt(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def server_side_encryption(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Server-side encryption
        """
    ...
    def server_side_encryption(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "server_side_encryption", value)

    @property
    @pulumi.getter(name="vertifyType")
    def vertify_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Authentication Type
        """
    ...
    @vertify_type.setter
    def vertify_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vertify_type", value)


if not MYPY:
    class SiteDeliveryTaskSlsDeliveryArgsDict(TypedDict):
        sls_log_store: NotRequired[pulumi.Input[builtins.str]]
        sls_project: NotRequired[pulumi.Input[builtins.str]]
        sls_region: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class SiteDeliveryTaskSlsDeliveryArgs:
    def __init__(__self__, *,
                 sls_log_store: Optional[pulumi.Input[builtins.str]] = None,
                 sls_project: Optional[pulumi.Input[builtins.str]] = None,
                 sls_region: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def sls_log_store(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "sls_log_store")

    @sls_log_store.setter
    def sls_log_store(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sls_log_store", value)

    @property
    @pulumi.getter(name="slsProject")
    def sls_project(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "sls_project")

    @sls_project.setter
    def sls_project(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sls_project", value)

    @property
    @pulumi.getter(name="slsRegion")
    def sls_region(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "sls_region")

    @sls_region.setter
    def sls_region(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WaitingRoomHostNameAndPathArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] subdomain: The subdomain.
        """
