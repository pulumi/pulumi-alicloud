...
class HttpResponseHeaderModificationRuleResponseHeaderModificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] operation: Mode of operation.
...
class RecordAuthConfArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: The version of the signature algorithm. This parameter is required when the origin type is S3 and AuthType is private. The following two types are supported:
        ...
        :param pulumi.Input[builtins.str] version: The region of the origin. If the origin type is S3, you must specify this value. You can get the region information from the official website of S3.
        """
        if access_key is not None:
            pulumi.set(__self__, "access_key", access_key)
        if auth_type is not None:
