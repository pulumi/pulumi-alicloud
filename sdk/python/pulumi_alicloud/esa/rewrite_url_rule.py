...
class RewriteUrlRuleArgs:
    def __init__(__self__, *,
                 ...
                 rewrite_query_string_type: Optional[pulumi.Input[builtins.str]] = None,
                 rewrite_uri_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] query_string: The desired query string to which you want to rewrite the query string in the original request.
        :param pulumi.Input[builtins.str] rewrite_query_string_type: Query string rewrite type. Value range:
        :param pulumi.Input[builtins.str] rewrite_uri_type: URI rewrite type. Value range:
        ...
        :param pulumi.Input[builtins.str] rule_enable: Indicates whether the rule is enabled. Valid values:
               
               - on
               - off
        :param pulumi.Input[builtins.str] rule_name: The rule name. You do not need to set this parameter when adding a global configuration.
        :param pulumi.Input[builtins.int] site_version: Version number of the site configuration. For a site with configuration version management enabled, you can use this parameter to specify the site version in which the configuration takes effect. The default version is 0.
        :param pulumi.Input[builtins.str] uri: The desired URI to which you want to rewrite the path in the original request.
        """
    ...
    def rewrite_query_string_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rewrite_query_string_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rewrite_query_string_type", value)

    @property
    @pulumi.getter(name="rewriteUriType")
    def rewrite_uri_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rewrite_uri_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RewriteUrlRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] config_id: ConfigId
        :param pulumi.Input[builtins.str] query_string: The desired query string to which you want to rewrite the query string in the original request.
        :param pulumi.Input[builtins.str] rewrite_query_string_type: Query string rewrite type. Value range:
        :param pulumi.Input[builtins.str] rewrite_uri_type: URI rewrite type. Value range:
        :param pulumi.Input[builtins.str] rule: Rule content, using conditional expressions to match user requests. When adding global configuration, this parameter does not need to be set. There are two usage scenarios:
...
class RewriteUrlRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            site_id: Optional[pulumi.Input[builtins.int]] = None,
            site_version: Optional[pulumi.Input[builtins.int]] = None,
            uri: Optional[pulumi.Input[builtins.str]] = None) -> 'RewriteUrlRule':
        """
    ...
    @property
    @pulumi.getter(name="rewriteQueryStringType")
    def rewrite_query_string_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Query string rewrite type. Value range:
        """
        return pulumi.get(self, "rewrite_query_string_type")
    ...
    @property
    @pulumi.getter(name="rewriteUriType")
    def rewrite_uri_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URI rewrite type. Value range:
        """
        return pulumi.get(self, "rewrite_uri_type")
