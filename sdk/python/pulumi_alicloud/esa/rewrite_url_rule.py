...
class RewriteUrlRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] rewrite_query_string_type: The query string rewrite method. Valid value:
               
               - static
        :param pulumi.Input[builtins.str] rewrite_uri_type: The path rewrite method. Valid value:
        ...
        :param pulumi.Input[builtins.str] rule_enable: Indicates whether the rule is enabled. Valid values:
               ...
               - on
               - off
        :param pulumi.Input[builtins.str] rule_name: Rule name. You can find the rule whose field is passed by the rule name. The rule takes effect only if functionName is passed.
        :param pulumi.Input[builtins.int] site_version: The version number of the website configurations.
