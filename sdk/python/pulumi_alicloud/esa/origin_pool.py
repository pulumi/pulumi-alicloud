...
class OriginPoolArgs:
    def __init__(__self__, *,
                 origin_pool_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] origin_pool_name: The source address pool name.
        :param pulumi.Input[builtins.int] site_id: The site ID.
        :param pulumi.Input[builtins.bool] enabled: Whether the source address pool is enabled:
    ...
    def origin_pool_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def origin_pool_name(self, value: pulumi.Input[builtins.str]):
...
class _OriginPoolState:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 origin_pool_id: Optional[pulumi.Input[builtins.int]] = None,
                 origin_pool_name: Optional[pulumi.Input[builtins.str]] = None,
                 origins: Optional[pulumi.Input[Sequence[pulumi.Input['OriginPoolOriginArgs']]]] = None,
                 site_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        Input properties used for looking up and filtering OriginPool resources.
        :param pulumi.Input[builtins.bool] enabled: Whether the source address pool is enabled:
        :param pulumi.Input[builtins.int] origin_pool_id: OriginPool Id
        :param pulumi.Input[builtins.str] origin_pool_name: The source address pool name.
        :param pulumi.Input[Sequence[pulumi.Input['OriginPoolOriginArgs']]] origins: The Source station information added to the source address pool. Multiple Source stations use arrays to transfer values. See `origins` below.
        :param pulumi.Input[builtins.int] site_id: The site ID.
        """
    ...
    def origin_pool_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        OriginPool Id
        """
    ...
    def origin_pool_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "origin_pool_id", value)

    @property
    @pulumi.getter(name="originPoolName")
    def origin_pool_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The source address pool name.
        """
        return pulumi.get(self, "origin_pool_name")
    ...
    @origin_pool_name.setter
    def origin_pool_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "origin_pool_name", value)
...
class OriginPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            origin_pool_name: Optional[pulumi.Input[builtins.str]] = None,
            origins: Optional[pulumi.Input[Sequence[pulumi.Input[Union['OriginPoolOriginArgs', 'OriginPoolOriginArgsDict']]]]] = None,
            site_id: Optional[pulumi.Input[builtins.int]] = None) -> 'OriginPool':
        """
    ...
    @property
    @pulumi.getter(name="originPoolId")
    def origin_pool_id(self) -> pulumi.Output[builtins.int]:
        """
        OriginPool Id
        """
        return pulumi.get(self, "origin_pool_id")
    ...
    @property
    @pulumi.getter(name="originPoolName")
    def origin_pool_name(self) -> pulumi.Output[builtins.str]:
        """
        The source address pool name.
        """
        return pulumi.get(self, "origin_pool_name")
