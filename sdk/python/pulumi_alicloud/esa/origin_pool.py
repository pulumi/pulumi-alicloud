...
class OriginPoolArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def origins(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['OriginPoolOriginArgs']]]]:
        """
    ...
    @origins.setter
    def origins(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['OriginPoolOriginArgs']]]]):
...
class _OriginPoolState:
    ...
    @_builtins.property
    @pulumi.getter(name="originPoolName")
    def origin_pool_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The source address pool name.
        """
        return pulumi.get(self, "origin_pool_name")
    ...
    @origin_pool_name.setter
    def origin_pool_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "origin_pool_name", value)
