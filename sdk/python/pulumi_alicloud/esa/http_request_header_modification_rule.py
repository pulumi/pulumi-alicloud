...
class _HttpRequestHeaderModificationRuleState:
    def __init__(__self__, *,
                 ...
                 request_header_modifications: pulumi.Input[Optional[Sequence[pulumi.Input['HttpRequestHeaderModificationRuleRequestHeaderModificationArgs']]]] = None,
                 rule: pulumi.Input[Optional[_builtins.str]] = None,
                 rule_enable: pulumi.Input[Optional[_builtins.str]] = None,
                 rule_name: pulumi.Input[Optional[_builtins.str]] = None,
                 sequence: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="requestHeaderModifications")
    def request_header_modifications(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['HttpRequestHeaderModificationRuleRequestHeaderModificationArgs']]]]:
        """
        The configurations of modifying request headers. You can add, delete, or modify a request header. See `request_header_modification` below.
        """
        return pulumi.get(self, "request_header_modifications")
    ...
    @request_header_modifications.setter
    def request_header_modifications(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['HttpRequestHeaderModificationRuleRequestHeaderModificationArgs']]]]):
        pulumi.set(self, "request_header_modifications", value)
...
class HttpRequestHeaderModificationRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 request_header_modifications: pulumi.Input[Optional[Sequence[pulumi.Input[Union['HttpRequestHeaderModificationRuleRequestHeaderModificationArgs', 'HttpRequestHeaderModificationRuleRequestHeaderModificationArgsDict', 'outputs.HttpRequestHeaderModificationRuleRequestHeaderModification']]]]] = None,
                 rule: pulumi.Input[Optional[_builtins.str]] = None,
                 rule_enable: pulumi.Input[Optional[_builtins.str]] = None,
                 rule_name: pulumi.Input[Optional[_builtins.str]] = None,
                 sequence: pulumi.Input[Optional[_builtins.int]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['HttpRequestHeaderModificationRuleRequestHeaderModificationArgs', 'HttpRequestHeaderModificationRuleRequestHeaderModificationArgsDict', 'outputs.HttpRequestHeaderModificationRuleRequestHeaderModification']]]] request_header_modifications: The configurations of modifying request headers. You can add, delete, or modify a request header. See `request_header_modification` below.
        :param pulumi.Input[_builtins.str] rule: Rule content, using conditional expressions to match user requests. When adding global configuration, this parameter does not need to be set. There are two usage scenarios:
               - Match all incoming requests: value set to true
               - Match specified request: Set the value to a custom expression, for example: (http.host eq \\"video.example.com\\")
        :param pulumi.Input[_builtins.str] rule_enable: Rule switch. When adding global configuration, this parameter does not need to be set. Value range:
    ...
    def get(resource_name: str,
            ...
            sequence: pulumi.Input[Optional[_builtins.int]] = None,
            site_id: pulumi.Input[Optional[_builtins.str]] = None,
            site_version: pulumi.Input[Optional[_builtins.int]] = None) -> 'HttpRequestHeaderModificationRule':
        """
