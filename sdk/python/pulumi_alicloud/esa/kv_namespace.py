...
class KvNamespaceArgs:
    def __init__(__self__, *,
                 kv_namespace: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a KvNamespace resource.
        :param pulumi.Input[builtins.str] kv_namespace: The name of the namespace.
    ...
    def kv_namespace(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @kv_namespace.setter
    def kv_namespace(self, value: pulumi.Input[builtins.str]):
...
class _KvNamespaceState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 kv_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering KvNamespace resources.
        :param pulumi.Input[builtins.str] description: The description of the namespace.
        :param pulumi.Input[builtins.str] kv_namespace: The name of the namespace.
        :param pulumi.Input[builtins.str] status: The status of the namespace.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    @property
    @pulumi.getter(name="kvNamespace")
    def kv_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the namespace.
        """
        return pulumi.get(self, "kv_namespace")
    ...
    @kv_namespace.setter
    def kv_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "kv_namespace", value)
...
class KvNamespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            kv_namespace: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'KvNamespace':
        """
    ...
    @property
    @pulumi.getter(name="kvNamespace")
    def kv_namespace(self) -> pulumi.Output[builtins.str]:
        """
        The name of the namespace.
        """
        return pulumi.get(self, "kv_namespace")
