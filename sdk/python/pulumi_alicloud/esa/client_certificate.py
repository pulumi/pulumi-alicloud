...
class ClientCertificateArgs:
    def __init__(__self__, *,
                 ...
                 validity_days: pulumi.Input[builtins.str],
                 csr: Optional[pulumi.Input[builtins.str]] = None,
                 pkey_type: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ClientCertificate resource.
        :param pulumi.Input[builtins.int] site_id: Site Id
        :param pulumi.Input[builtins.str] validity_days: Certificate validity period.
        :param pulumi.Input[builtins.str] csr: Certificate signing request content.
        :param pulumi.Input[builtins.str] pkey_type: The private key algorithm type.
        :param pulumi.Input[builtins.str] status: The certificate status. Valid values: `revoked`, `active`.
        """
    ...
    def validity_days(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def validity_days(self, value: pulumi.Input[builtins.str]):
    ...
    def pkey_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @pkey_type.setter
    def pkey_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ClientCertificateState:
    def __init__(__self__, *,
                 client_cert_id: Optional[pulumi.Input[builtins.str]] = None,
                 create_time: Optional[pulumi.Input[builtins.str]] = None,
                 csr: Optional[pulumi.Input[builtins.str]] = None,
                 pkey_type: Optional[pulumi.Input[builtins.str]] = None,
                 site_id: Optional[pulumi.Input[builtins.int]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 validity_days: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering ClientCertificate resources.
        :param pulumi.Input[builtins.str] client_cert_id: ClientCertificate Id
        :param pulumi.Input[builtins.str] create_time: The time when the certificate was created.
        :param pulumi.Input[builtins.str] csr: Certificate signing request content.
        :param pulumi.Input[builtins.str] pkey_type: The private key algorithm type.
        :param pulumi.Input[builtins.int] site_id: Site Id
        :param pulumi.Input[builtins.str] status: The certificate status. Valid values: `revoked`, `active`.
    ...
    def client_cert_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_cert_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="validityDays")
    def validity_days(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Certificate validity period.
        """
        return pulumi.get(self, "validity_days")
    ...
    @validity_days.setter
    def validity_days(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "validity_days", value)
...
class ClientCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            site_id: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            validity_days: Optional[pulumi.Input[builtins.str]] = None) -> 'ClientCertificate':
        """
    ...
    @property
    @pulumi.getter(name="clientCertId")
    def client_cert_id(self) -> pulumi.Output[builtins.str]:
        """
        ClientCertificate Id
        """
        return pulumi.get(self, "client_cert_id")
    ...
    @property
    @pulumi.getter(name="pkeyType")
    def pkey_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The private key algorithm type.
        """
        return pulumi.get(self, "pkey_type")
    ...
    @property
    @pulumi.getter(name="validityDays")
    def validity_days(self) -> pulumi.Output[builtins.str]:
        """
        Certificate validity period.
        """
        return pulumi.get(self, "validity_days")
