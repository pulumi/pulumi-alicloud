...
class SiteDeliveryTaskArgs:
    def __init__(__self__, *,
                 business_type: pulumi.Input[builtins.str],
                 data_center: pulumi.Input[builtins.str],
                 delivery_type: pulumi.Input[builtins.str],
                 field_name: pulumi.Input[builtins.str],
                 site_id: pulumi.Input[builtins.int],
                 task_name: pulumi.Input[builtins.str],
                 discard_rate: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.str] business_type: Real-time log type. Valid values:
               - `dcdn_log_access_l1 (default)`: access log.
        :param pulumi.Input[builtins.str] data_center: Data Center. Values:
        :param pulumi.Input[builtins.str] delivery_type: Delivery Type:
        :param pulumi.Input[builtins.str] field_name: The list of delivery fields to be modified, separated by commas.
        ...
        :param pulumi.Input[builtins.float] discard_rate: If the discard rate is not filled, the default value is 0.
        ...
        :param pulumi.Input[builtins.str] status: Task status, value:
        """
    ...
    def business_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def business_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "business_type", value)

    @property
    @pulumi.getter(name="dataCenter")
    def data_center(self) -> pulumi.Input[builtins.str]:
        """
        Data Center. Values:
        """
    ...
    @data_center.setter
    def data_center(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "data_center", value)

    @property
    @pulumi.getter(name="deliveryType")
    def delivery_type(self) -> pulumi.Input[builtins.str]:
        """
        Delivery Type:
        """
    ...
    def delivery_type(self, value: pulumi.Input[builtins.str]):
    ...
    def discard_rate(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    @discard_rate.setter
    def discard_rate(self, value: Optional[pulumi.Input[builtins.float]]):
...
class _SiteDeliveryTaskState:
    def __init__(__self__, *,
                 business_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="businessType")
    def business_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Real-time log type. Valid values:
        - `dcdn_log_access_l1 (default)`: access log.
        """
    ...
    @business_type.setter
    def business_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "business_type", value)
...
class SiteDeliveryTask(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sls_delivery: Optional[pulumi.Input[Union['SiteDeliveryTaskSlsDeliveryArgs', 'SiteDeliveryTaskSlsDeliveryArgsDict']]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            task_name: Optional[pulumi.Input[builtins.str]] = None) -> 'SiteDeliveryTask':
        """
    ...
    @property
    @pulumi.getter(name="businessType")
    def business_type(self) -> pulumi.Output[builtins.str]:
        """
        Real-time log type. Valid values:
        - `dcdn_log_access_l1 (default)`: access log.
        """
    ...
    @property
    @pulumi.getter(name="dataCenter")
    def data_center(self) -> pulumi.Output[builtins.str]:
        """
        Data Center. Values:
        """
        return pulumi.get(self, "data_center")
    ...
    @property
    @pulumi.getter(name="deliveryType")
    def delivery_type(self) -> pulumi.Output[builtins.str]:
        """
        Delivery Type:
        """
        return pulumi.get(self, "delivery_type")
    ...
    @property
    @pulumi.getter(name="discardRate")
    def discard_rate(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        If the discard rate is not filled, the default value is 0.
        """
        return pulumi.get(self, "discard_rate")
