...
class EdgeContainerAppArgs:
    def __init__(__self__, *,
                 edge_container_app_name: pulumi.Input[builtins.str],
                 service_port: pulumi.Input[builtins.int],
                 target_port: pulumi.Input[builtins.int],
                 health_check_fail_times: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 health_check_succ_times: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] edge_container_app_name: The application name must start with a lowercase letter. Lowercase letters, numbers, and bars are supported. The length is limited to 6 to 128 characters.
        :param pulumi.Input[builtins.int] service_port: The name of the application. The name must start with a lowercase letter and can contain lowercase letters, digits, and hyphens (-). The name must be 6 to 128 characters in length.
        :param pulumi.Input[builtins.int] target_port: The server port. Valid values: 1 to 65535.
        :param pulumi.Input[builtins.int] health_check_fail_times: The number of consecutive successful health checks required for an application to be considered as healthy. Valid values: 1 to 10. Default value: 2.
        :param pulumi.Input[builtins.str] health_check_host: The health check type. By default, this parameter is left empty.
               
               Valid values:
        :param pulumi.Input[builtins.str] health_check_http_code: The domain name that is used for health checks. This parameter is empty by default.
        :param pulumi.Input[builtins.int] health_check_interval: The timeout period of a health check response. If a backend ECS instance does not respond within the specified timeout period, the ECS instance fails the health check. Unit: seconds.
               Valid values: `1` to `100`.
               Default value: `3`.
        :param pulumi.Input[builtins.str] health_check_method: The HTTP status code returned for a successful health check. Valid values:
               
               - **http\\_2xx** (default)
               - **http\\_3xx**
        :param pulumi.Input[builtins.int] health_check_port: The URI used for health checks. The URI must be `1` to `80` characters in length. Default value: "/".
        :param pulumi.Input[builtins.int] health_check_succ_times: The interval between two consecutive health checks. Unit: seconds. Valid values: `1` to `50`. Default value: `5`.
        :param pulumi.Input[builtins.int] health_check_timeout: The port used for health checks. Valid values: 1 to 65535. Default value: 80.
        :param pulumi.Input[builtins.str] health_check_type: The remarks. This parameter is empty by default.
        :param pulumi.Input[builtins.str] health_check_uri: The HTTP request method for health checks. Valid values:
               
               - `HEAD` (default): requests the headers of the resource.
               - `GET`: requests the specified resource and returns both the headers and entity body.
        :param pulumi.Input[builtins.str] remarks: The backend port, which is also the service port of the application. Valid values: 1 to 65535.
        """
    ...
    def edge_container_app_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def edge_container_app_name(self, value: pulumi.Input[builtins.str]):
    ...
    def health_check_fail_times(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def health_check_fail_times(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def health_check_succ_times(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def health_check_succ_times(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _EdgeContainerAppState:
    def __init__(__self__, *,
                 ...
                 edge_container_app_name: Optional[pulumi.Input[builtins.str]] = None,
                 health_check_fail_times: Optional[pulumi.Input[builtins.int]] = None,
                 health_check_host: Optional[pulumi.Input[builtins.str]] = None,
                 health_check_http_code: Optional[pulumi.Input[builtins.str]] = None,
                 health_check_interval: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] create_time: The time when the application was created.
        :param pulumi.Input[builtins.str] edge_container_app_name: The application name must start with a lowercase letter. Lowercase letters, numbers, and bars are supported. The length is limited to 6 to 128 characters.
        :param pulumi.Input[builtins.int] health_check_fail_times: The number of consecutive successful health checks required for an application to be considered as healthy. Valid values: 1 to 10. Default value: 2.
        :param pulumi.Input[builtins.str] health_check_host: The health check type. By default, this parameter is left empty.
    ...
    @property
    @pulumi.getter(name="edgeContainerAppName")
    def edge_container_app_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The application name must start with a lowercase letter. Lowercase letters, numbers, and bars are supported. The length is limited to 6 to 128 characters.
        """
        return pulumi.get(self, "edge_container_app_name")
    ...
    @edge_container_app_name.setter
    def edge_container_app_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "edge_container_app_name", value)
...
class EdgeContainerApp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_port: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            target_port: Optional[pulumi.Input[builtins.int]] = None) -> 'EdgeContainerApp':
        """
    ...
    @property
    @pulumi.getter(name="edgeContainerAppName")
    def edge_container_app_name(self) -> pulumi.Output[builtins.str]:
        """
        The application name must start with a lowercase letter. Lowercase letters, numbers, and bars are supported. The length is limited to 6 to 128 characters.
        """
        return pulumi.get(self, "edge_container_app_name")
    ...
    @property
    @pulumi.getter(name="healthCheckFailTimes")
    def health_check_fail_times(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of consecutive successful health checks required for an application to be considered as healthy. Valid values: 1 to 10. Default value: 2.
        """
        return pulumi.get(self, "health_check_fail_times")
    ...
    @property
    @pulumi.getter(name="healthCheckHost")
    def health_check_host(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The health check type. By default, this parameter is left empty.
    ...
    @property
    @pulumi.getter(name="healthCheckSuccTimes")
    def health_check_succ_times(self) -> pulumi.Output[builtins.int]:
        """
        The interval between two consecutive health checks. Unit: seconds. Valid values: `1` to `50`. Default value: `5`.
        """
        return pulumi.get(self, "health_check_succ_times")
    ...
    @property
    @pulumi.getter
    def remarks(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The backend port, which is also the service port of the application. Valid values: 1 to 65535.
        """
        return pulumi.get(self, "remarks")
