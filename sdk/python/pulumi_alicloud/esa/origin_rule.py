...
class OriginRuleArgs:
    def __init__(__self__, *,
                 ...
                 origin_http_port: Optional[pulumi.Input[builtins.str]] = None,
                 origin_https_port: Optional[pulumi.Input[builtins.str]] = None,
                 origin_scheme: Optional[pulumi.Input[builtins.str]] = None,
                 origin_sni: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] dns_record: Overwrite the DNS resolution record of the origin request.
        :param pulumi.Input[builtins.str] origin_host: The HOST carried in the back-to-origin request.
        :param pulumi.Input[builtins.str] origin_http_port: The port of the origin station accessed when the HTTP protocol is used to return to the origin.
        :param pulumi.Input[builtins.str] origin_https_port: The port of the origin station accessed when the HTTPS protocol is used to return to the origin.
        :param pulumi.Input[builtins.str] origin_scheme: The protocol used by the back-to-origin request. Value range:
        :param pulumi.Input[builtins.str] origin_sni: SNI carried in the back-to-origin request.
        :param pulumi.Input[builtins.str] range: Use the range sharding method to download the file from the source. Value range:
        ...
        :param pulumi.Input[builtins.int] site_version: Version number of the site.
        """
    ...
    def origin_http_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def origin_http_port(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "origin_http_port", value)

    @property
    @pulumi.getter(name="originHttpsPort")
    def origin_https_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def origin_https_port(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "origin_https_port", value)

    @property
    @pulumi.getter(name="originScheme")
    def origin_scheme(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def origin_scheme(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "origin_scheme", value)

    @property
    @pulumi.getter(name="originSni")
    def origin_sni(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @origin_sni.setter
    def origin_sni(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OriginRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rule_name: Optional[pulumi.Input[builtins.str]] = None,
            site_id: Optional[pulumi.Input[builtins.int]] = None,
            site_version: Optional[pulumi.Input[builtins.int]] = None) -> 'OriginRule':
        """
    ...
    @property
    @pulumi.getter(name="dnsRecord")
    def dns_record(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Overwrite the DNS resolution record of the origin request.
        """
        return pulumi.get(self, "dns_record")
    ...
    @property
    @pulumi.getter(name="originHost")
    def origin_host(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The HOST carried in the back-to-origin request.
        """
        return pulumi.get(self, "origin_host")
    ...
    @property
    @pulumi.getter(name="originHttpPort")
    def origin_http_port(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The port of the origin station accessed when the HTTP protocol is used to return to the origin.
        """
        return pulumi.get(self, "origin_http_port")
    ...
    @property
    @pulumi.getter(name="originHttpsPort")
    def origin_https_port(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The port of the origin station accessed when the HTTPS protocol is used to return to the origin.
        """
        return pulumi.get(self, "origin_https_port")
    ...
    @property
    @pulumi.getter(name="originScheme")
    def origin_scheme(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The protocol used by the back-to-origin request. Value range:
        """
        return pulumi.get(self, "origin_scheme")
    ...
    @property
    @pulumi.getter(name="originSni")
    def origin_sni(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        SNI carried in the back-to-origin request.
        """
        return pulumi.get(self, "origin_sni")
