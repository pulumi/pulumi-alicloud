...
class WaitingRoomEventArgs:
    def __init__(__self__, *,
                 ...
                 waiting_room_event_name: pulumi.Input[builtins.str],
                 ...
                 pre_queue_enable: Optional[pulumi.Input[builtins.str]] = None,
                 pre_queue_start_time: Optional[pulumi.Input[builtins.str]] = None,
                 random_pre_queue_enable: Optional[pulumi.Input[builtins.str]] = None,
                 waiting_room_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WaitingRoomEvent resource.
        :param pulumi.Input[builtins.str] end_time: The start time of the event. This value is a UNIX timestamp.
        :param pulumi.Input[builtins.str] new_users_per_minute: The maximum number of active users.
        :param pulumi.Input[builtins.str] queuing_method: Specifies whether to disable session renewal. Valid values:
        ...
        :param pulumi.Input[builtins.str] session_duration: The maximum number of new users per minute.
        :param pulumi.Input[builtins.int] site_id: The site ID, which can be obtained by calling the ListSites API.
        :param pulumi.Input[builtins.str] start_time: The content of the custom waiting room page. You must specify this parameter if you set WaitingRoomType to custom. The content must be Base64-encoded.
        :param pulumi.Input[builtins.str] status: The ID of the waiting room event, which can be obtained by calling the [ListWaitingRoomEvents](https://www.alibabacloud.com/help/en/doc-detail/2850279.html) operation.
        :param pulumi.Input[builtins.str] total_active_users: The name of the waiting room event.
        :param pulumi.Input[builtins.str] waiting_room_event_name: Specifies whether to enable the waiting room event. Valid values:
        :param pulumi.Input[builtins.str] waiting_room_type: The description of the waiting room.
        :param pulumi.Input[builtins.str] custom_page_html: The type of the waiting room. Valid values:
               
               - default
               - custom
        :param pulumi.Input[builtins.str] description: Specifies whether to enable JSON response. Valid values:
        ...
        :param pulumi.Input[builtins.str] json_response_enable: The HTTP status code to return while a user is in the queue. Valid values:
               
               - 200
               - 202
               - 429
        :param pulumi.Input[builtins.str] language: Specifies whether to enable random queuing.
               
               - on
               - off
        :param pulumi.Input[builtins.str] pre_queue_enable: The end time of the event. This value is a UNIX timestamp.
        :param pulumi.Input[builtins.str] pre_queue_start_time: Specifies whether to enable pre-queuing.
               
               - on
               - off
        :param pulumi.Input[builtins.str] random_pre_queue_enable: The start time for pre-queuing.
    ...
    def waiting_room_event_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def waiting_room_event_name(self, value: pulumi.Input[builtins.str]):
    ...
    def pre_queue_enable(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def pre_queue_enable(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pre_queue_enable", value)

    @property
    @pulumi.getter(name="preQueueStartTime")
    def pre_queue_start_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def pre_queue_start_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pre_queue_start_time", value)

    @property
    @pulumi.getter(name="randomPreQueueEnable")
    def random_pre_queue_enable(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def random_pre_queue_enable(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _WaitingRoomEventState:
    def __init__(__self__, *,
                 ...
                 waiting_room_event_id: Optional[pulumi.Input[builtins.int]] = None,
                 waiting_room_event_name: Optional[pulumi.Input[builtins.str]] = None,
                 waiting_room_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] status: The ID of the waiting room event, which can be obtained by calling the [ListWaitingRoomEvents](https://www.alibabacloud.com/help/en/doc-detail/2850279.html) operation.
        :param pulumi.Input[builtins.str] total_active_users: The name of the waiting room event.
        :param pulumi.Input[builtins.int] waiting_room_event_id: The unique ID of the waiting room, which can be obtained by calling the [ListWaitingRooms](https://www.alibabacloud.com/help/en/doc-detail/2850279.html) operation.
        :param pulumi.Input[builtins.str] waiting_room_event_name: Specifies whether to enable the waiting room event. Valid values:
        :param pulumi.Input[builtins.str] waiting_room_id: The website ID, which can be obtained by calling the [ListSites](https://www.alibabacloud.com/help/en/doc-detail/2850189.html) operation.
        :param pulumi.Input[builtins.str] waiting_room_type: The description of the waiting room.
        """
    ...
    def waiting_room_event_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def waiting_room_event_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "waiting_room_event_id", value)

    @property
    @pulumi.getter(name="waitingRoomEventName")
    def waiting_room_event_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies whether to enable the waiting room event. Valid values:
        """
        return pulumi.get(self, "waiting_room_event_name")
    ...
    @waiting_room_event_name.setter
    def waiting_room_event_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "waiting_room_event_name", value)
...
class WaitingRoomEvent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            waiting_room_event_name: Optional[pulumi.Input[builtins.str]] = None,
            waiting_room_id: Optional[pulumi.Input[builtins.str]] = None,
            waiting_room_type: Optional[pulumi.Input[builtins.str]] = None) -> 'WaitingRoomEvent':
        """
    ...
    @property
    @pulumi.getter(name="preQueueEnable")
    def pre_queue_enable(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The end time of the event. This value is a UNIX timestamp.
        """
        return pulumi.get(self, "pre_queue_enable")
    ...
    @property
    @pulumi.getter(name="preQueueStartTime")
    def pre_queue_start_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether to enable pre-queuing.
    ...
    @property
    @pulumi.getter(name="randomPreQueueEnable")
    def random_pre_queue_enable(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The start time for pre-queuing.
        """
        return pulumi.get(self, "random_pre_queue_enable")
    ...
    @property
    @pulumi.getter(name="waitingRoomEventId")
    def waiting_room_event_id(self) -> pulumi.Output[builtins.int]:
        """
        The unique ID of the waiting room, which can be obtained by calling the [ListWaitingRooms](https://www.alibabacloud.com/help/en/doc-detail/2850279.html) operation.
        """
        return pulumi.get(self, "waiting_room_event_id")
    ...
    @property
    @pulumi.getter(name="waitingRoomEventName")
    def waiting_room_event_name(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether to enable the waiting room event. Valid values:
        """
        return pulumi.get(self, "waiting_room_event_name")
