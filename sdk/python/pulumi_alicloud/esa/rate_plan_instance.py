...
class RatePlanInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] auto_pay: Specifies whether to enable auto payment.
        :param pulumi.Input[builtins.bool] auto_renew: Auto-renewal:
        :param pulumi.Input[builtins.str] coverage: The service locations for the websites that can be associated with the plan. Multiple values are separated by commas (,). Valid values:
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource. Valid values:
               - `Subscription`: subscription.
        :param pulumi.Input[builtins.int] period: Subscription period (in months).
        :param pulumi.Input[builtins.str] plan_name: Package name.Value range:
        :param pulumi.Input[builtins.str] type: The DNS setup option for the website. Valid values:
               - `NS`
               - `CNAME`
        """
...
class _RatePlanInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] auto_renew: Auto-renewal:
        :param pulumi.Input[builtins.str] coverage: The service locations for the websites that can be associated with the plan. Multiple values are separated by commas (,). Valid values:
        :param pulumi.Input[builtins.str] create_time: The time when the plan was purchased.
        :param pulumi.Input[builtins.str] instance_status: The plan instance status.
               - `Renewing`: renewing
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource. Valid values:
               - `Subscription`: subscription.
        :param pulumi.Input[builtins.int] period: Subscription period (in months).
...
class RatePlanInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            plan_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'RatePlanInstance':
        """
    ...
    @property
    @pulumi.getter(name="planName")
    def plan_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Package name.Value range:
        """
        return pulumi.get(self, "plan_name")
