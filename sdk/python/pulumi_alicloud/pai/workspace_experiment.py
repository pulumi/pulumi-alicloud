...
class WorkspaceExperimentArgs:
    def __init__(__self__, *,
                 artifact_uri: pulumi.Input[builtins.str],
                 experiment_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] artifact_uri: ArtifactUri is default OSS storage path of the output of trials in the experiment
        :param pulumi.Input[builtins.str] experiment_name: Name is the name of the experiment, unique in a namespace
        :param pulumi.Input[builtins.str] workspace_id: WorkspaceId is the workspace id which contains the experiment
        :param pulumi.Input[builtins.str] accessibility: Experimental Visibility
        """
    ...
    def artifact_uri(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @artifact_uri.setter
    def artifact_uri(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "artifact_uri", value)

    @property
    @pulumi.getter(name="experimentName")
    def experiment_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def experiment_name(self, value: pulumi.Input[builtins.str]):
...
class _WorkspaceExperimentState:
    def __init__(__self__, *,
                 accessibility: Optional[pulumi.Input[builtins.str]] = None,
                 artifact_uri: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] accessibility: Experimental Visibility
        :param pulumi.Input[builtins.str] artifact_uri: ArtifactUri is default OSS storage path of the output of trials in the experiment
        :param pulumi.Input[builtins.str] create_time: GmtCreateTime is time when this entity is created.
        :param pulumi.Input[builtins.str] experiment_name: Name is the name of the experiment, unique in a namespace
        :param pulumi.Input[builtins.str] workspace_id: WorkspaceId is the workspace id which contains the experiment
        """
        if accessibility is not None:
    ...
    @property
    @pulumi.getter(name="artifactUri")
    def artifact_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ArtifactUri is default OSS storage path of the output of trials in the experiment
        """
        return pulumi.get(self, "artifact_uri")
    ...
    @artifact_uri.setter
    def artifact_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "artifact_uri", value)
...
@pulumi.type_token("alicloud:pai/workspaceExperiment:WorkspaceExperiment")
class WorkspaceExperiment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            create_time: Optional[pulumi.Input[builtins.str]] = None,
            experiment_name: Optional[pulumi.Input[builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceExperiment':
        """
    ...
    @property
    @pulumi.getter(name="artifactUri")
    def artifact_uri(self) -> pulumi.Output[builtins.str]:
        """
        ArtifactUri is default OSS storage path of the output of trials in the experiment
        """
        return pulumi.get(self, "artifact_uri")
    ...
    @property
    @pulumi.getter(name="experimentName")
    def experiment_name(self) -> pulumi.Output[builtins.str]:
        """
        Name is the name of the experiment, unique in a namespace
        """
        return pulumi.get(self, "experiment_name")
