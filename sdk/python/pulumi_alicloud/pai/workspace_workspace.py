...
class WorkspaceWorkspaceArgs:
    def __init__(__self__, *,
                 ...
                 env_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 workspace_name: pulumi.Input[builtins.str],
                 display_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WorkspaceWorkspace resource.
        :param pulumi.Input[builtins.str] description: Workspace description, no more than 80 characters.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] env_types: Environments contained in the workspace:
        ...
        :param pulumi.Input[builtins.str] workspace_name: The workspace name. The format is as follows:
               - 3 to 23 characters in length and can contain letters, underscores, or numbers.
               - Must start with a large or small letter.
               - Unique in the current region.
        :param pulumi.Input[builtins.str] display_name: It is recommended that you name the workspace based on the business attribute to identify the purpose of the workspace. If not configured, the default value is the workspace name.
        """
    ...
    def env_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @env_types.setter
    def env_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _WorkspaceWorkspaceState:
    def __init__(__self__, *,
                 ...
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 env_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] create_time: The UTC time when the workspace is created. The time format is ISO8601.
        :param pulumi.Input[builtins.str] description: Workspace description, no more than 80 characters.
        :param pulumi.Input[builtins.str] display_name: It is recommended that you name the workspace based on the business attribute to identify the purpose of the workspace. If not configured, the default value is the workspace name.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] env_types: Environments contained in the workspace:
               - Simple mode only production environment (prod).
               - Standard mode includes development environment (dev) and production environment (prod).
        :param pulumi.Input[builtins.str] status: Workspace state, possible values:
        :param pulumi.Input[builtins.str] workspace_name: The workspace name. The format is as follows:
               - 3 to 23 characters in length and can contain letters, underscores, or numbers.
               - Must start with a large or small letter.
               - Unique in the current region.
    ...
    @property
    @pulumi.getter(name="envTypes")
    def env_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Environments contained in the workspace:
        - Simple mode only production environment (prod).
        - Standard mode includes development environment (dev) and production environment (prod).
    ...
    @env_types.setter
    def env_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "env_types", value)
...
class WorkspaceWorkspace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            env_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            workspace_name: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceWorkspace':
        """
    ...
    @property
    @pulumi.getter(name="envTypes")
    def env_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Environments contained in the workspace:
        - Simple mode only production environment (prod).
        - Standard mode includes development environment (dev) and production environment (prod).
