...
class WorkspaceCodeSourceArgs:
    def __init__(__self__, *,
                 accessibility: pulumi.Input[builtins.str],
                 code_repo: pulumi.Input[builtins.str],
                 display_name: pulumi.Input[builtins.str],
                 mount_path: pulumi.Input[builtins.str],
                 workspace_id: pulumi.Input[builtins.str],
                 code_branch: Optional[pulumi.Input[builtins.str]] = None,
                 code_commit: Optional[pulumi.Input[builtins.str]] = None,
                 code_repo_access_token: Optional[pulumi.Input[builtins.str]] = None,
                 code_repo_user_name: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WorkspaceCodeSource resource.
        :param pulumi.Input[builtins.str] accessibility: Visibility of the code configuration, possible values:
               - PRIVATE: In this workspace, it is only visible to you and the administrator.
               - PUBLIC: In this workspace, it is visible to everyone.
        :param pulumi.Input[builtins.str] code_repo: Code repository address.
        :param pulumi.Input[builtins.str] display_name: Code source configuration name.
        :param pulumi.Input[builtins.str] mount_path: The local Mount Directory of the code.
        :param pulumi.Input[builtins.str] workspace_id: The ID of the workspace.
        :param pulumi.Input[builtins.str] code_branch: Code repository branch.
        :param pulumi.Input[builtins.str] code_commit: The code CommitId.
        :param pulumi.Input[builtins.str] code_repo_access_token: The Token used to access the code repository.
        :param pulumi.Input[builtins.str] code_repo_user_name: The user name of the code repository.
        :param pulumi.Input[builtins.str] description: A detailed description of the code configuration.
        """
    ...
    @property
    @pulumi.getter
    def accessibility(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def accessibility(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "accessibility", value)

    @property
    @pulumi.getter(name="codeRepo")
    def code_repo(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @code_repo.setter
    def code_repo(self, value: pulumi.Input[builtins.str]):
    ...
    def code_branch(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @code_branch.setter
    def code_branch(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "code_branch", value)

    @property
    @pulumi.getter(name="codeCommit")
    def code_commit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The code CommitId.
        """
    ...
    @code_commit.setter
    def code_commit(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "code_commit", value)

    @property
    @pulumi.getter(name="codeRepoAccessToken")
    def code_repo_access_token(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def code_repo_access_token(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "code_repo_access_token", value)

    @property
    @pulumi.getter(name="codeRepoUserName")
    def code_repo_user_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def code_repo_user_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _WorkspaceCodeSourceState:
    def __init__(__self__, *,
                 ...
                 code_branch: Optional[pulumi.Input[builtins.str]] = None,
                 code_commit: Optional[pulumi.Input[builtins.str]] = None,
                 code_repo: Optional[pulumi.Input[builtins.str]] = None,
                 code_repo_access_token: Optional[pulumi.Input[builtins.str]] = None,
                 code_repo_user_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="codeRepo")
    def code_repo(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Code repository address.
        """
        return pulumi.get(self, "code_repo")
    ...
    @code_repo.setter
    def code_repo(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "code_repo", value)
...
class WorkspaceCodeSource(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:pai/workspaceCodeSource:WorkspaceCodeSource"
    ...
    def get(resource_name: str,
            ...
            display_name: Optional[pulumi.Input[builtins.str]] = None,
            mount_path: Optional[pulumi.Input[builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceCodeSource':
        """
    ...
    @property
    @pulumi.getter(name="codeBranch")
    def code_branch(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Code repository branch.
        """
        return pulumi.get(self, "code_branch")
    ...
    @property
    @pulumi.getter(name="codeCommit")
    def code_commit(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The code CommitId.
        """
        return pulumi.get(self, "code_commit")
    ...
    @property
    @pulumi.getter(name="codeRepo")
    def code_repo(self) -> pulumi.Output[builtins.str]:
        """
        Code repository address.
        """
        return pulumi.get(self, "code_repo")
    ...
    @property
    @pulumi.getter(name="codeRepoAccessToken")
    def code_repo_access_token(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Token used to access the code repository.
        """
        return pulumi.get(self, "code_repo_access_token")
    ...
    @property
    @pulumi.getter(name="codeRepoUserName")
    def code_repo_user_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The user name of the code repository.
        """
        return pulumi.get(self, "code_repo_user_name")
