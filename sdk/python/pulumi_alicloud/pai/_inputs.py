...
class WorkspaceDatasetLabelArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: The key of the tag. The length is limited to 128 bytes. "=" and "," are not supported.
        :param pulumi.Input[builtins.str] value: The value of the tag. The length is limited to 128 bytes. "=" and "," are not supported.
        """
        if key is not None:
...
class WorkspaceDatasetversionLabelArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] key: The key of the tags
        :param pulumi.Input[builtins.str] value: The value of the tags
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
