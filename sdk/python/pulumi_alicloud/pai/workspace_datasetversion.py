...
class WorkspaceDatasetversionArgs:
    def __init__(__self__, *,
                 ...
                 data_count: Optional[pulumi.Input[builtins.int]] = None,
                 data_size: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] data_source_type: The data source type. The following values are supported:
               - OSS: Alibaba Cloud Object Storage (OSS).
               - NAS: Alibaba cloud file storage (NAS).
        :param pulumi.Input[builtins.str] dataset_id: The first ID of the resource
        :param pulumi.Input[builtins.str] property: The properties of the dataset. The following values are supported:
               - FILE: FILE.
               - DIRECTORY: folder.
        :param pulumi.Input[builtins.str] uri: The Uri configuration sample is as follows:
        ...
        :param pulumi.Input[builtins.int] data_count: Data count.
        :param pulumi.Input[builtins.int] data_size: Data size.
        :param pulumi.Input[builtins.str] description: Description of dataset version.
        ...
        :param pulumi.Input[builtins.str] options: The extended field, which is of the JsonString type.
               
               When DLC uses a dataset, you can specify the default Mount path for the dataset by configuring the mountPath field.
        :param pulumi.Input[builtins.str] source_id: The data source ID.
        :param pulumi.Input[builtins.str] source_type: The data source type. The default value is USER.
        """
    ...
    def data_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Data count.
        """
    ...
    @data_count.setter
    def data_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "data_count", value)

    @property
    @pulumi.getter(name="dataSize")
    def data_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Data size.
        """
    ...
    @data_size.setter
    def data_size(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _WorkspaceDatasetversionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: Update time.
        :param pulumi.Input[builtins.int] data_count: Data count.
        :param pulumi.Input[builtins.int] data_size: Data size.
        :param pulumi.Input[builtins.str] data_source_type: The data source type. The following values are supported:
               - OSS: Alibaba Cloud Object Storage (OSS).
        ...
        :param pulumi.Input[builtins.str] uri: The Uri configuration sample is as follows:
               ...
               CPFS1.0 and CPFS2.0 are distinguished by the format of fsid: CPFS1.0 is cpfs-;CPFS2.0 is cpfs-.
        :param pulumi.Input[builtins.str] version_name: The name of the resource
        """
...
class WorkspaceDatasetversion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_type: Optional[pulumi.Input[builtins.str]] = None,
            uri: Optional[pulumi.Input[builtins.str]] = None,
            version_name: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceDatasetversion':
        """
    ...
    @property
    @pulumi.getter(name="dataCount")
    def data_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Data count.
        """
        return pulumi.get(self, "data_count")
    ...
    @property
    @pulumi.getter(name="dataSize")
    def data_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Data size.
        """
        return pulumi.get(self, "data_size")
    ...
    @property
    @pulumi.getter
    def property(self) -> pulumi.Output[builtins.str]:
        """
        The properties of the dataset. The following values are supported:
        - FILE: FILE.
        - DIRECTORY: folder.
