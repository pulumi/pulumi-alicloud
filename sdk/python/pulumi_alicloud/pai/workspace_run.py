...
class WorkspaceRunArgs:
    def __init__(__self__, *,
                 experiment_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] experiment_id: Resource attribute field of the experiment ID to which Run belongs
        :param pulumi.Input[builtins.str] run_name: The name of the resource
        :param pulumi.Input[builtins.str] source_id: Attribute Resource field representing the source task ID
        :param pulumi.Input[builtins.str] source_type: Resource attribute fields representing the source type
        """
    ...
    def experiment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def experiment_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "experiment_id", value)

    @property
    @pulumi.getter(name="runName")
    def run_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @run_name.setter
    def run_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WorkspaceRun(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            run_name: Optional[pulumi.Input[builtins.str]] = None,
            source_id: Optional[pulumi.Input[builtins.str]] = None,
            source_type: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceRun':
        """
    ...
    @property
    @pulumi.getter(name="runName")
    def run_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the resource
        """
        return pulumi.get(self, "run_name")
