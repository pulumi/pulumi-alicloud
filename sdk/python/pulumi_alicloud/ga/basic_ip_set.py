...
class BasicIpSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] accelerate_region_id: The ID of the acceleration region.
        :param pulumi.Input[builtins.str] accelerator_id: The ID of the basic GA instance.
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth of the acceleration region. Unit: Mbit/s.
        :param pulumi.Input[builtins.str] isp_type: The line type of the elastic IP address (EIP) in the acceleration region. Default value: `BGP`. Valid values: `BGP`, `BGP_PRO`, `ChinaTelecom`, `ChinaUnicom`, `ChinaMobile`, `ChinaTelecom_L2`, `ChinaUnicom_L2`, `ChinaMobile_L2`.
        """
...
class _BasicIpSetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth of the acceleration region. Unit: Mbit/s.
        :param pulumi.Input[builtins.str] isp_type: The line type of the elastic IP address (EIP) in the acceleration region. Default value: `BGP`. Valid values: `BGP`, `BGP_PRO`, `ChinaTelecom`, `ChinaUnicom`, `ChinaMobile`, `ChinaTelecom_L2`, `ChinaUnicom_L2`, `ChinaMobile_L2`.
        :param pulumi.Input[builtins.str] status: The status of the Basic Ip Set instance.
        """
...
class BasicIpSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            bandwidth: Optional[pulumi.Input[builtins.int]] = None,
            isp_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'BasicIpSet':
        """
    ...
    @property
    @pulumi.getter(name="ispType")
    def isp_type(self) -> pulumi.Output[builtins.str]:
        """
        The line type of the elastic IP address (EIP) in the acceleration region. Default value: `BGP`. Valid values: `BGP`, `BGP_PRO`, `ChinaTelecom`, `ChinaUnicom`, `ChinaMobile`, `ChinaTelecom_L2`, `ChinaUnicom_L2`, `ChinaMobile_L2`.
        """
        return pulumi.get(self, "isp_type")
