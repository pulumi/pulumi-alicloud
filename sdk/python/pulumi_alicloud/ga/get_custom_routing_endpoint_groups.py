...
def get_custom_routing_endpoint_groups(accelerator_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Custom Routing Endpoint Group IDs.
    :param builtins.str listener_id: The ID of the custom routing listener.
    :param builtins.str name_regex: A regex string to filter results by Custom Routing Endpoint Group name.
...
def get_custom_routing_endpoint_groups_output(accelerator_id: Optional[pulumi.Input[builtins.str]] = None,
