...
def get_basic_accelerate_ip_endpoint_relations(accelerate_ip_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Global Accelerator Basic Accelerate Ip Endpoint Relations IDs.
...
def get_basic_accelerate_ip_endpoint_relations_output(accelerate_ip_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
