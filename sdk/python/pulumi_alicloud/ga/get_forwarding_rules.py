...
def get_forwarding_rules(accelerator_id: Optional[builtins.str] = None,
    ...
    :param builtins.str accelerator_id: The ID of the Global Accelerator instance.
    :param Sequence[builtins.str] ids: A list of Forwarding Rule IDs.
    ...
    :param builtins.str status: The status of the acceleration region. Valid values: `active`, `configuring`.
    """
    __args__ = dict()
...
def get_forwarding_rules_output(accelerator_id: Optional[pulumi.Input[builtins.str]] = None,
