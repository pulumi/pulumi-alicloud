...
def get_accelerators(bandwidth_billing_type: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Accelerator IDs.
    :param _builtins.str name_regex: A regex string to filter results by Accelerator name.
...
def get_accelerators_output(bandwidth_billing_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
