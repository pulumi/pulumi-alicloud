...
class GetAcceleratorsResult:
    ...
    def bandwidth_billing_type(self) -> Optional[builtins.str]:
...
def get_accelerators(bandwidth_billing_type: Optional[builtins.str] = None,
    ...
    :param builtins.str bandwidth_billing_type: The bandwidth billing method. Default value: `BandwidthPackage`. Valid values:
           - `BandwidthPackage`: billed based on bandwidth plans.
           - `CDT`: billed based on data transfer.
    :param Sequence[builtins.str] ids: A list of Accelerator IDs.
    :param builtins.str name_regex: A regex string to filter results by Accelerator name.
...
def get_accelerators_output(bandwidth_billing_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
