...
class AdditionalCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_id: The Certificate ID. **NOTE:** From version 1.209.1, `certificate_id` can be modified.
        :param pulumi.Input[builtins.str] domain: The domain name specified by the certificate. **NOTE:** You can associate each domain name with only one additional certificate.
        :param pulumi.Input[builtins.str] listener_id: The ID of the listener. **NOTE:** Only HTTPS listeners support this parameter.
        """
...
class AdditionalCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            certificate_id: Optional[pulumi.Input[builtins.str]] = None,
            domain: Optional[pulumi.Input[builtins.str]] = None,
            listener_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AdditionalCertificate':
        """
