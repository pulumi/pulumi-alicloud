...
class AccessLogArgs:
    def __init__(__self__, *,
                 ...
                 sls_log_store_name: pulumi.Input[builtins.str],
                 sls_project_name: pulumi.Input[builtins.str],
                 sls_region_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a AccessLog resource.
        :param pulumi.Input[builtins.str] accelerator_id: The ID of the global acceleration instance.
        :param pulumi.Input[builtins.str] endpoint_group_id: The ID of the endpoint group instance.
        :param pulumi.Input[builtins.str] listener_id: The ID of the listener.
        :param pulumi.Input[builtins.str] sls_log_store_name: The name of the Log Store.
        :param pulumi.Input[builtins.str] sls_project_name: The name of the Log Service project.
        :param pulumi.Input[builtins.str] sls_region_id: The region ID of the Log Service project.
        """
    ...
    def sls_log_store_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sls_log_store_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sls_log_store_name", value)

    @property
    @pulumi.getter(name="slsProjectName")
    def sls_project_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sls_project_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sls_project_name", value)

    @property
    @pulumi.getter(name="slsRegionId")
    def sls_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sls_region_id(self, value: pulumi.Input[builtins.str]):
...
class _AccessLogState:
    def __init__(__self__, *,
                 ...
                 sls_log_store_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] sls_project_name: The name of the Log Service project.
        :param pulumi.Input[builtins.str] sls_region_id: The region ID of the Log Service project.
        :param pulumi.Input[builtins.str] status: Whether access log is enabled.
        """
    ...
    @property
    @pulumi.getter(name="slsLogStoreName")
    def sls_log_store_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Log Store.
        """
        return pulumi.get(self, "sls_log_store_name")
    ...
    @sls_log_store_name.setter
    def sls_log_store_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sls_log_store_name", value)
...
class AccessLog(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sls_project_name: Optional[pulumi.Input[builtins.str]] = None,
            sls_region_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessLog':
        """
    ...
    @property
    @pulumi.getter(name="slsLogStoreName")
    def sls_log_store_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Log Store.
        """
        return pulumi.get(self, "sls_log_store_name")
    ...
    @property
    @pulumi.getter(name="slsRegionId")
    def sls_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The region ID of the Log Service project.
        """
        return pulumi.get(self, "sls_region_id")
