...
class BasicEndpointArgs:
    def __init__(__self__, *,
                 accelerator_id: pulumi.Input[builtins.str],
                 endpoint_address: pulumi.Input[builtins.str],
                 endpoint_group_id: pulumi.Input[builtins.str],
                 endpoint_type: pulumi.Input[builtins.str],
                 basic_endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_sub_address: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_sub_address_type: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_zone_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a BasicEndpoint resource.
        :param pulumi.Input[builtins.str] accelerator_id: The ID of the Basic GA instance.
        :param pulumi.Input[builtins.str] endpoint_address: The address of the Basic Endpoint.
        :param pulumi.Input[builtins.str] endpoint_group_id: The ID of the Basic Endpoint Group.
        :param pulumi.Input[builtins.str] endpoint_type: The type of the Basic Endpoint. Valid values: `ENI`, `SLB`, `ECS` and `NLB`.
        :param pulumi.Input[builtins.str] basic_endpoint_name: The name of the Basic Endpoint.
        :param pulumi.Input[builtins.str] endpoint_sub_address: The sub address of the Basic Endpoint.
        :param pulumi.Input[builtins.str] endpoint_sub_address_type: The sub address type of the Basic Endpoint. Valid values: `primary`, `secondary`.
        :param pulumi.Input[builtins.str] endpoint_zone_id: The zone id of the Basic Endpoint.
        """
    ...
    def accelerator_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def accelerator_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "accelerator_id", value)

    @property
    @pulumi.getter(name="endpointAddress")
    def endpoint_address(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def endpoint_address(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "endpoint_address", value)

    @property
    @pulumi.getter(name="endpointGroupId")
    def endpoint_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def endpoint_group_id(self, value: pulumi.Input[builtins.str]):
    ...
    def basic_endpoint_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def basic_endpoint_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "basic_endpoint_name", value)

    @property
    @pulumi.getter(name="endpointSubAddress")
    def endpoint_sub_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def endpoint_sub_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "endpoint_sub_address", value)

    @property
    @pulumi.getter(name="endpointSubAddressType")
    def endpoint_sub_address_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def endpoint_sub_address_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "endpoint_sub_address_type", value)

    @property
    @pulumi.getter(name="endpointZoneId")
    def endpoint_zone_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def endpoint_zone_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BasicEndpointState:
    def __init__(__self__, *,
                 ...
                 basic_endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_address: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] endpoint_address: The address of the Basic Endpoint.
        :param pulumi.Input[builtins.str] endpoint_group_id: The ID of the Basic Endpoint Group.
        :param pulumi.Input[builtins.str] endpoint_id: The ID of the Basic Endpoint.
        :param pulumi.Input[builtins.str] endpoint_sub_address: The sub address of the Basic Endpoint.
        :param pulumi.Input[builtins.str] endpoint_sub_address_type: The sub address type of the Basic Endpoint. Valid values: `primary`, `secondary`.
        :param pulumi.Input[builtins.str] endpoint_type: The type of the Basic Endpoint. Valid values: `ENI`, `SLB`, `ECS` and `NLB`.
        :param pulumi.Input[builtins.str] endpoint_zone_id: The zone id of the Basic Endpoint.
        :param pulumi.Input[builtins.str] status: The status of the Basic Endpoint.
        """
    ...
    @property
    @pulumi.getter(name="endpointAddress")
    def endpoint_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The address of the Basic Endpoint.
        """
        return pulumi.get(self, "endpoint_address")
    ...
    @endpoint_address.setter
    def endpoint_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "endpoint_address", value)
...
class BasicEndpoint(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:ga/basicEndpoint:BasicEndpoint"
    ...
    def get(resource_name: str,
            ...
            endpoint_type: Optional[pulumi.Input[builtins.str]] = None,
            endpoint_zone_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'BasicEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="acceleratorId")
    def accelerator_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Basic GA instance.
        """
        return pulumi.get(self, "accelerator_id")
    ...
    @property
    @pulumi.getter(name="basicEndpointName")
    def basic_endpoint_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Basic Endpoint.
        """
        return pulumi.get(self, "basic_endpoint_name")
    ...
    @property
    @pulumi.getter(name="endpointAddress")
    def endpoint_address(self) -> pulumi.Output[builtins.str]:
        """
        The address of the Basic Endpoint.
        """
        return pulumi.get(self, "endpoint_address")
    ...
    @property
    @pulumi.getter(name="endpointGroupId")
    def endpoint_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Basic Endpoint Group.
        """
        return pulumi.get(self, "endpoint_group_id")
    ...
    @property
    @pulumi.getter(name="endpointSubAddress")
    def endpoint_sub_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The sub address of the Basic Endpoint.
        """
        return pulumi.get(self, "endpoint_sub_address")
    ...
    @property
    @pulumi.getter(name="endpointSubAddressType")
    def endpoint_sub_address_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The sub address type of the Basic Endpoint. Valid values: `primary`, `secondary`.
        """
        return pulumi.get(self, "endpoint_sub_address_type")
    ...
    @property
    @pulumi.getter(name="endpointZoneId")
    def endpoint_zone_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The zone id of the Basic Endpoint.
        """
        return pulumi.get(self, "endpoint_zone_id")
