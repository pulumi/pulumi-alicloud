...
class BasicAcceleratorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] auto_use_coupon: Specifies whether to automatically pay bills by using coupons. Default value: `false`. **NOTE:** This parameter is required only if `auto_pay` is set to `true`.
        :param pulumi.Input[_builtins.str] bandwidth_billing_type: The bandwidth billing method. Valid values: `BandwidthPackage`, `CDT`, `CDT95`.
        :param pulumi.Input[_builtins.str] basic_accelerator_name: The name of the Global Accelerator Basic Accelerator instance.
        ...
        :param pulumi.Input[_builtins.str] description: The description of the Global Accelerator Basic Accelerator instance.
        :param pulumi.Input[_builtins.int] duration: The subscription duration. Default value: `1`.
        ...
        :param pulumi.Input[_builtins.str] pricing_cycle: The billing cycle. Default value: `Month`. Valid values: `Month`, `Year`.
...
class _BasicAcceleratorState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] promotion_option_no: The code of the coupon. **NOTE:** The `promotion_option_no` takes effect only for accounts registered on the international site (alibabacloud.com).
        :param pulumi.Input[_builtins.str] resource_group_id: The ID of the resource group. **Note:** Once you set a value of this property, you cannot set it to an empty string anymore.
        :param pulumi.Input[_builtins.str] status: The status of the Basic Accelerator instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags to assign to the resource.
        """
        if auto_pay is not None:
            pulumi.set(__self__, "auto_pay", auto_pay)
...
class BasicAccelerator(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="bandwidthBillingType")
    def bandwidth_billing_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The bandwidth billing method. Valid values: `BandwidthPackage`, `CDT`, `CDT95`.
        """
        return pulumi.get(self, "bandwidth_billing_type")
    ...
    @_builtins.property
    @pulumi.getter(name="basicAcceleratorName")
    def basic_accelerator_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name of the Global Accelerator Basic Accelerator instance.
        """
        return pulumi.get(self, "basic_accelerator_name")
