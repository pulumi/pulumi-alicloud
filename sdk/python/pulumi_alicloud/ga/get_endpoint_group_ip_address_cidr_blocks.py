...
def get_endpoint_group_ip_address_cidr_blocks(accelerator_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str accelerator_id: The ID of the Global Accelerator (GA) instance.
...
def get_endpoint_group_ip_address_cidr_blocks_output(accelerator_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
