...
class IpSetArgs:
    def __init__(__self__, *,
                 accelerate_region_id: pulumi.Input[builtins.str],
                 ...
                 isp_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a IpSet resource.
        :param pulumi.Input[builtins.str] accelerate_region_id: The ID of an acceleration region.
        :param pulumi.Input[builtins.str] accelerator_id: The ID of the Global Accelerator (GA) instance.
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth allocated to the acceleration region.
        ...
        :param pulumi.Input[builtins.str] ip_version: The IP protocol used by the GA instance. Default value: `IPv4`. Valid values: `IPv4`, `IPv6`, `DUAL_STACK`. **NOTE:** From version 1.220.0, `ip_version` can be set to `DUAL_STACK`.
        :param pulumi.Input[builtins.str] isp_type: The line type of the elastic IP address (EIP) in the acceleration region. Valid values: `BGP`, `BGP_PRO`.
        """
    ...
    def accelerate_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def accelerate_region_id(self, value: pulumi.Input[builtins.str]):
    ...
    def isp_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @isp_type.setter
    def isp_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _IpSetState:
    def __init__(__self__, *,
                 accelerate_region_id: Optional[pulumi.Input[builtins.str]] = None,
                 accelerator_id: Optional[pulumi.Input[builtins.str]] = None,
                 bandwidth: Optional[pulumi.Input[builtins.int]] = None,
                 ip_address_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ip_version: Optional[pulumi.Input[builtins.str]] = None,
                 isp_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth allocated to the acceleration region.
               > **NOTE:** The minimum bandwidth of each accelerated region is 2Mbps. The total bandwidth of the acceleration region should be less than or equal to the bandwidth of the basic bandwidth package you purchased.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_address_lists: The list of accelerated IP addresses in the acceleration region.
        :param pulumi.Input[builtins.str] ip_version: The IP protocol used by the GA instance. Default value: `IPv4`. Valid values: `IPv4`, `IPv6`, `DUAL_STACK`. **NOTE:** From version 1.220.0, `ip_version` can be set to `DUAL_STACK`.
        :param pulumi.Input[builtins.str] isp_type: The line type of the elastic IP address (EIP) in the acceleration region. Valid values: `BGP`, `BGP_PRO`.
        :param pulumi.Input[builtins.str] status: The status of the acceleration region.
        """
    ...
    @property
    @pulumi.getter(name="accelerateRegionId")
    def accelerate_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of an acceleration region.
        """
        return pulumi.get(self, "accelerate_region_id")
    ...
    @accelerate_region_id.setter
    def accelerate_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "accelerate_region_id", value)
    ...
    def ip_address_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def ip_address_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("alicloud:ga/ipSet:IpSet")
class IpSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip_version: Optional[pulumi.Input[builtins.str]] = None,
            isp_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'IpSet':
        """
    ...
    @property
    @pulumi.getter(name="accelerateRegionId")
    def accelerate_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of an acceleration region.
        """
        return pulumi.get(self, "accelerate_region_id")
    ...
    @property
    @pulumi.getter(name="ipAddressLists")
    def ip_address_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of accelerated IP addresses in the acceleration region.
        """
        return pulumi.get(self, "ip_address_lists")
    ...
    @property
    @pulumi.getter(name="ispType")
    def isp_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The line type of the elastic IP address (EIP) in the acceleration region. Valid values: `BGP`, `BGP_PRO`.
        """
        return pulumi.get(self, "isp_type")
