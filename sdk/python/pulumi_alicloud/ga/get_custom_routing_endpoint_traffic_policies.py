...
def get_custom_routing_endpoint_traffic_policies(accelerator_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Custom Routing Endpoint Traffic Policy IDs.
