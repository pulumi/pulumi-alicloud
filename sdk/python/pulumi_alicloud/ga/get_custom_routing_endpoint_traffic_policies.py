...
def get_custom_routing_endpoint_traffic_policies(accelerator_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Custom Routing Endpoint Traffic Policy IDs.
...
def get_custom_routing_endpoint_traffic_policies_output(accelerator_id: Optional[pulumi.Input[builtins.str]] = None,
                                                        address: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                        endpoint_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                        endpoint_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
