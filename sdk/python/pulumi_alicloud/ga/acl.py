...
class AclArgs:
    def __init__(__self__, *,
                 address_ip_version: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] acl_name: The name of the ACL. The name must be `2` to `128` characters in length, and can contain letters, digits, periods (.), hyphens (-) and underscores (_). It must start with a letter.
    ...
    def address_ip_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def address_ip_version(self, value: pulumi.Input[builtins.str]):
