...
class CustomRoutingEndpointGroupDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] from_port: The start port of the backend service port range of the endpoint group. The `from_port` value must be smaller than or equal to the `to_port` value. Valid values: `1` to `65499`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] protocols: The backend service protocol of the endpoint group. Valid values: `TCP`, `UDP`, `TCP, UDP`.
        :param pulumi.Input[builtins.int] to_port: The end port of the backend service port range of the endpoint group. The `from_port` value must be smaller than or equal to the `to_port` value. Valid values: `1` to `65499`.
        """
...
class _CustomRoutingEndpointGroupDestinationState:
    def __init__(__self__, *,
                 ...
                 custom_routing_endpoint_group_destination_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] custom_routing_endpoint_group_destination_id: The ID of the Custom Routing Endpoint Group Destination.
        :param pulumi.Input[builtins.str] endpoint_group_id: The ID of the endpoint group.
        :param pulumi.Input[builtins.int] from_port: The start port of the backend service port range of the endpoint group. The `from_port` value must be smaller than or equal to the `to_port` value. Valid values: `1` to `65499`.
        :param pulumi.Input[builtins.str] listener_id: The ID of the listener.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] protocols: The backend service protocol of the endpoint group. Valid values: `TCP`, `UDP`, `TCP, UDP`.
        :param pulumi.Input[builtins.str] status: The status of the Custom Routing Endpoint Group Destination.
        :param pulumi.Input[builtins.int] to_port: The end port of the backend service port range of the endpoint group. The `from_port` value must be smaller than or equal to the `to_port` value. Valid values: `1` to `65499`.
        """
    ...
    def custom_routing_endpoint_group_destination_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_routing_endpoint_group_destination_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CustomRoutingEndpointGroupDestination(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            protocols: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            to_port: Optional[pulumi.Input[builtins.int]] = None) -> 'CustomRoutingEndpointGroupDestination':
        """
    ...
    @property
    @pulumi.getter(name="customRoutingEndpointGroupDestinationId")
    def custom_routing_endpoint_group_destination_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Custom Routing Endpoint Group Destination.
        """
        return pulumi.get(self, "custom_routing_endpoint_group_destination_id")
