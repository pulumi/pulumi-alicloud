...
class BasicEndpointGroupArgs:
    def __init__(__self__, *,
                 ...
                 endpoint_group_region: pulumi.Input[builtins.str],
                 basic_endpoint_group_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] endpoint_group_region: The ID of the region where you want to create the endpoint group.
        :param pulumi.Input[builtins.str] basic_endpoint_group_name: The name of the endpoint group. The `basic_endpoint_group_name` must be 2 to 128 characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter.
        :param pulumi.Input[builtins.str] description: The description of the endpoint group. The `description` cannot exceed 256 characters in length and cannot contain http:// or https://.
        :param pulumi.Input[builtins.str] endpoint_address: The address of the endpoint.
        :param pulumi.Input[builtins.str] endpoint_sub_address: The sub address of the endpoint.
        :param pulumi.Input[builtins.str] endpoint_type: The type of the endpoint. Valid values: `ENI`, `SLB` and `ECS`.
        """
    ...
    def endpoint_group_region(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def endpoint_group_region(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "endpoint_group_region", value)

    @property
    @pulumi.getter(name="basicEndpointGroupName")
    def basic_endpoint_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def basic_endpoint_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BasicEndpointGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint_sub_address: The sub address of the endpoint.
        :param pulumi.Input[builtins.str] endpoint_type: The type of the endpoint. Valid values: `ENI`, `SLB` and `ECS`.
        :param pulumi.Input[builtins.str] status: The status of the Basic Endpoint Group.
        """
...
class BasicEndpointGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            endpoint_sub_address: Optional[pulumi.Input[builtins.str]] = None,
            endpoint_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'BasicEndpointGroup':
        """
    ...
    @property
    @pulumi.getter(name="basicEndpointGroupName")
    def basic_endpoint_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the endpoint group. The `basic_endpoint_group_name` must be 2 to 128 characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter.
        """
        return pulumi.get(self, "basic_endpoint_group_name")
    ...
    @property
    @pulumi.getter(name="endpointSubAddress")
    def endpoint_sub_address(self) -> pulumi.Output[builtins.str]:
        """
        The sub address of the endpoint.
        """
        return pulumi.get(self, "endpoint_sub_address")
