...
def get_basic_accelerators(accelerator_id: Optional[builtins.str] = None,
                           bandwidth_billing_type: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Global Accelerator Basic Accelerator IDs.
    :param builtins.str name_regex: A regex string to filter results by Global Accelerator Basic Accelerator name.
...
def get_basic_accelerators_output(accelerator_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  bandwidth_billing_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
