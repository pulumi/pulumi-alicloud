...
class BandwidthPackageAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 bandwidth_package_id: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] bandwidth_package_id: The ID of the Bandwidth Package. **NOTE:** From version 1.192.0, `bandwidth_package_id` can be modified.
        """
    ...
    def bandwidth_package_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def bandwidth_package_id(self, value: pulumi.Input[builtins.str]):
...
class _BandwidthPackageAttachmentState:
    def __init__(__self__, *,
                 ...
                 accelerators: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] accelerator_id: The ID of the Global Accelerator instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] accelerators: Accelerators bound with current Bandwidth Package.
        :param pulumi.Input[builtins.str] bandwidth_package_id: The ID of the Bandwidth Package. **NOTE:** From version 1.192.0, `bandwidth_package_id` can be modified.
        :param pulumi.Input[builtins.str] status: State of Bandwidth Package.
        """
    ...
    @property
    @pulumi.getter
    def accelerators(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @accelerators.setter
    def accelerators(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("alicloud:ga/bandwidthPackageAttachment:BandwidthPackageAttachment")
class BandwidthPackageAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            accelerators: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            bandwidth_package_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'BandwidthPackageAttachment':
        """
    ...
    @property
    @pulumi.getter
    def accelerators(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Accelerators bound with current Bandwidth Package.
        """
        return pulumi.get(self, "accelerators")
