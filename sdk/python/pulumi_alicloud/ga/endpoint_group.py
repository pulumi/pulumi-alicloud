...
class EndpointGroupArgs:
    def __init__(__self__, *,
                 ...
                 endpoint_group_type: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_protocol_version: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_request_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 threshold_count: Optional[pulumi.Input[builtins.int]] = None,
                 traffic_percentage: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a EndpointGroup resource.
        :param pulumi.Input[builtins.str] accelerator_id: The ID of the Global Accelerator instance to which the endpoint group will be added.
        ...
        :param pulumi.Input[builtins.str] endpoint_group_region: The ID of the region where the endpoint group is deployed.
        :param pulumi.Input[builtins.str] listener_id: The ID of the listener that is associated with the endpoint group.
        :param pulumi.Input[builtins.str] description: The description of the endpoint group.
        :param pulumi.Input[builtins.str] endpoint_group_type: The endpoint group type. Default value: `default`. Valid values: `default`, `virtual`.
        ...
        :param pulumi.Input[builtins.str] endpoint_protocol_version: The backend service protocol of the endpoint that is associated with the intelligent routing listener. Valid values: `HTTP1.1`, `HTTP2`.
               > **NOTE:** `endpoint_protocol_version` is valid only when `endpoint_request_protocol` is set to `HTTPS`.
        :param pulumi.Input[builtins.str] endpoint_request_protocol: The protocol that is used by the backend server. Valid values: `HTTP`, `HTTPS`.
        ...
        :param pulumi.Input[builtins.int] health_check_interval_seconds: The interval between two consecutive health checks. Unit: seconds.
        :param pulumi.Input[builtins.str] health_check_path: The path specified as the destination of the targets for health checks.
        :param pulumi.Input[builtins.int] health_check_port: The port that is used for health checks.
        :param pulumi.Input[builtins.str] health_check_protocol: The protocol that is used to connect to the targets for health checks. Valid values:
        ...
        :param pulumi.Input[builtins.str] name: The name of the endpoint group.
        ...
        :param pulumi.Input[builtins.int] threshold_count: The number of consecutive failed heath checks that must occur before the endpoint is deemed unhealthy. Default value: `3`.
        :param pulumi.Input[builtins.int] traffic_percentage: The weight of the endpoint group when the corresponding listener is associated with multiple endpoint groups.
        """
    ...
    def endpoint_group_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def endpoint_group_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "endpoint_group_type", value)

    @property
    @pulumi.getter(name="endpointProtocolVersion")
    def endpoint_protocol_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def endpoint_protocol_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "endpoint_protocol_version", value)

    @property
    @pulumi.getter(name="endpointRequestProtocol")
    def endpoint_request_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def endpoint_request_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def threshold_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def threshold_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "threshold_count", value)

    @property
    @pulumi.getter(name="trafficPercentage")
    def traffic_percentage(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def traffic_percentage(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _EndpointGroupState:
    def __init__(__self__, *,
                 ...
                 endpoint_group_ip_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The description of the endpoint group.
        :param pulumi.Input[Sequence[pulumi.Input['EndpointGroupEndpointConfigurationArgs']]] endpoint_configurations: The endpointConfigurations of the endpoint group. See `endpoint_configurations` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] endpoint_group_ip_lists: (Available since v1.213.0) The active endpoint IP addresses of the endpoint group. `endpoint_group_ip_list` will change with the growth of network traffic. You can run `pulumi up` to query the latest CIDR blocks and IP addresses.
        :param pulumi.Input[builtins.str] endpoint_group_region: The ID of the region where the endpoint group is deployed.
        :param pulumi.Input[builtins.str] endpoint_group_type: The endpoint group type. Default value: `default`. Valid values: `default`, `virtual`.
               > **NOTE:** Currently, only `HTTP` or `HTTPS` protocol listener can directly create a `virtual` Endpoint Group. If it is `TCP` protocol listener, and you want to create a `virtual` Endpoint Group, please ensure that the `default` Endpoint Group has been created.
        :param pulumi.Input[builtins.str] endpoint_protocol_version: The backend service protocol of the endpoint that is associated with the intelligent routing listener. Valid values: `HTTP1.1`, `HTTP2`.
        ...
        :param pulumi.Input['EndpointGroupPortOverridesArgs'] port_overrides: Mapping between listening port and forwarding port of boarding point. See `port_overrides` below.
               > **NOTE:** Port mapping is only supported when creating terminal node group for listening instance of HTTP or HTTPS protocol. The listening port in the port map must be consistent with the listening port of the current listening instance.
        :param pulumi.Input[builtins.str] status: The status of the endpoint group.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.int] threshold_count: The number of consecutive failed heath checks that must occur before the endpoint is deemed unhealthy. Default value: `3`.
        :param pulumi.Input[builtins.int] traffic_percentage: The weight of the endpoint group when the corresponding listener is associated with multiple endpoint groups.
        """
    ...
    def endpoint_group_ip_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def endpoint_group_ip_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class EndpointGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            threshold_count: Optional[pulumi.Input[builtins.int]] = None,
            traffic_percentage: Optional[pulumi.Input[builtins.int]] = None) -> 'EndpointGroup':
        """
    ...
    @property
    @pulumi.getter(name="endpointGroupIpLists")
    def endpoint_group_ip_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Available since v1.213.0) The active endpoint IP addresses of the endpoint group. `endpoint_group_ip_list` will change with the growth of network traffic. You can run `pulumi up` to query the latest CIDR blocks and IP addresses.
        """
        return pulumi.get(self, "endpoint_group_ip_lists")
    ...
    @property
    @pulumi.getter(name="endpointGroupType")
    def endpoint_group_type(self) -> pulumi.Output[builtins.str]:
        """
        The endpoint group type. Default value: `default`. Valid values: `default`, `virtual`.
        > **NOTE:** Currently, only `HTTP` or `HTTPS` protocol listener can directly create a `virtual` Endpoint Group. If it is `TCP` protocol listener, and you want to create a `virtual` Endpoint Group, please ensure that the `default` Endpoint Group has been created.
        """
    ...
    @property
    @pulumi.getter(name="endpointProtocolVersion")
    def endpoint_protocol_version(self) -> pulumi.Output[builtins.str]:
        """
        The backend service protocol of the endpoint that is associated with the intelligent routing listener. Valid values: `HTTP1.1`, `HTTP2`.
        > **NOTE:** `endpoint_protocol_version` is valid only when `endpoint_request_protocol` is set to `HTTPS`.
        """
    ...
    @property
    @pulumi.getter(name="endpointRequestProtocol")
    def endpoint_request_protocol(self) -> pulumi.Output[builtins.str]:
        """
        The protocol that is used by the backend server. Valid values: `HTTP`, `HTTPS`.
        > **NOTE:** `endpoint_request_protocol` can be specified only if the listener that is associated with the endpoint group uses `HTTP` or `HTTPS`. For the listener of `HTTP` protocol, `endpoint_request_protocol` can only be set to `HTTP`.
        """
    ...
    @property
    @pulumi.getter(name="healthCheckEnabled")
    def health_check_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable the health check feature. Valid values:
        """
        return pulumi.get(self, "health_check_enabled")
    ...
    @property
    @pulumi.getter(name="healthCheckIntervalSeconds")
    def health_check_interval_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The interval between two consecutive health checks. Unit: seconds.
        """
        return pulumi.get(self, "health_check_interval_seconds")
    ...
    @property
    @pulumi.getter(name="healthCheckPort")
    def health_check_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The port that is used for health checks.
        """
        return pulumi.get(self, "health_check_port")
    ...
    @property
    @pulumi.getter(name="healthCheckProtocol")
    def health_check_protocol(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The protocol that is used to connect to the targets for health checks. Valid values:
        - `TCP` or `tcp`: TCP protocol.
        - `HTTP` or `http`: HTTP protocol.
    ...
    @property
    @pulumi.getter(name="thresholdCount")
    def threshold_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of consecutive failed heath checks that must occur before the endpoint is deemed unhealthy. Default value: `3`.
        """
        return pulumi.get(self, "threshold_count")
    ...
    @property
    @pulumi.getter(name="trafficPercentage")
    def traffic_percentage(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The weight of the endpoint group when the corresponding listener is associated with multiple endpoint groups.
        """
        return pulumi.get(self, "traffic_percentage")
