...
class ListenerArgs:
    def __init__(__self__, *,
                 ...
                 client_affinity: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] accelerator_id: The accelerator id.
        ...
        :param pulumi.Input[builtins.str] client_affinity: The clientAffinity of the listener. Default value: `NONE`. Valid values:
        ...
        :param pulumi.Input[builtins.str] description: The description of the listener.
        ...
        :param pulumi.Input[builtins.str] http_version: The maximum version of the HTTP protocol. Default Value: `http2`. Valid values: `http1.1`, `http2`, `http3`.
               > **NOTE:** `http_version` is only valid when `protocol` is `HTTPS`.
        :param pulumi.Input[builtins.int] idle_timeout: The timeout period of idle connections. Unit: seconds. Valid values:
        ...
        :param pulumi.Input[builtins.str] listener_type: The routing type of the listener. Default Value: `Standard`. Valid values:
               - `Standard`: intelligent routing.
               - `CustomRouting`: custom routing.
        :param pulumi.Input[builtins.str] name: The name of the listener. The length of the name is 2-128 characters. It starts with uppercase and lowercase letters or Chinese characters. It can contain numbers and underscores and dashes.
        :param pulumi.Input[builtins.str] protocol: Type of network transport protocol monitored. Default value: `TCP`. Valid values: `TCP`, `UDP`, `HTTP`, `HTTPS`.
        :param pulumi.Input[builtins.bool] proxy_protocol: The proxy protocol of the listener. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.int] request_timeout: The timeout period for HTTP or HTTPS requests. Unit: seconds. Default Value: `60`. Valid values: `1` to `180`.
               > **NOTE:** `request_timeout` is only valid when `protocol` is `HTTP` or `HTTPS`.
        :param pulumi.Input[builtins.str] security_policy_id: The ID of the security policy. **NOTE:** Only `HTTPS` listeners support this parameter. Valid values:
        """
    ...
    def client_affinity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_affinity(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ListenerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] request_timeout: The timeout period for HTTP or HTTPS requests. Unit: seconds. Default Value: `60`. Valid values: `1` to `180`.
               > **NOTE:** `request_timeout` is only valid when `protocol` is `HTTP` or `HTTPS`.
        :param pulumi.Input[builtins.str] security_policy_id: The ID of the security policy. **NOTE:** Only `HTTPS` listeners support this parameter. Valid values:
        :param pulumi.Input[builtins.str] status: The status of the listener.
        """
...
class Listener(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            request_timeout: Optional[pulumi.Input[builtins.int]] = None,
            security_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'Listener':
        """
    ...
    @property
    @pulumi.getter(name="clientAffinity")
    def client_affinity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The clientAffinity of the listener. Default value: `NONE`. Valid values:
        - `NONE`: client affinity is not maintained, that is, connection requests from the same client cannot always be directed to the same terminal node.
        - `SOURCE_IP`: maintain client affinity. When a client accesses a stateful application, all requests from the same client can be directed to the same terminal node, regardless of the source port and protocol.
    ...
    @property
    @pulumi.getter(name="httpVersion")
    def http_version(self) -> pulumi.Output[builtins.str]:
        """
        The maximum version of the HTTP protocol. Default Value: `http2`. Valid values: `http1.1`, `http2`, `http3`.
        > **NOTE:** `http_version` is only valid when `protocol` is `HTTPS`.
        """
    ...
    @property
    @pulumi.getter(name="listenerType")
    def listener_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The routing type of the listener. Default Value: `Standard`. Valid values:
        - `Standard`: intelligent routing.
        - `CustomRouting`: custom routing.
