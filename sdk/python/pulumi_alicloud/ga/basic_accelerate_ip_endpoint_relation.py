...
class BasicAccelerateIpEndpointRelationArgs:
    def __init__(__self__, *,
                 accelerate_ip_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] accelerate_ip_id: The ID of the Basic Accelerate IP.
    ...
    def accelerate_ip_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def accelerate_ip_id(self, value: pulumi.Input[builtins.str]):
...
class _BasicAccelerateIpEndpointRelationState:
    def __init__(__self__, *,
                 accelerate_ip_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] accelerator_id: The ID of the Basic GA instance.
        :param pulumi.Input[builtins.str] endpoint_id: The ID of the Basic Endpoint.
        :param pulumi.Input[builtins.str] status: The status of the Basic Accelerate Ip Endpoint Relation.
        """
    ...
    @property
    @pulumi.getter(name="accelerateIpId")
    def accelerate_ip_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Basic Accelerate IP.
        """
        return pulumi.get(self, "accelerate_ip_id")
    ...
    @accelerate_ip_id.setter
    def accelerate_ip_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "accelerate_ip_id", value)
...
class BasicAccelerateIpEndpointRelation(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:ga/basicAccelerateIpEndpointRelation:BasicAccelerateIpEndpointRelation"
    ...
    def get(resource_name: str,
            ...
            accelerator_id: Optional[pulumi.Input[builtins.str]] = None,
            endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'BasicAccelerateIpEndpointRelation':
        """
    ...
    @property
    @pulumi.getter(name="accelerateIpId")
    def accelerate_ip_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Basic Accelerate IP.
        """
        return pulumi.get(self, "accelerate_ip_id")
