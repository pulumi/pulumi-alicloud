...
class CustomRoutingEndpointArgs:
    def __init__(__self__, *,
                 ...
                 traffic_to_endpoint_policy: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a CustomRoutingEndpoint resource.
        :param pulumi.Input[builtins.str] endpoint: The ID of the endpoint (vSwitch).
        :param pulumi.Input[builtins.str] endpoint_group_id: The ID of the endpoint group in which to create endpoints.
        :param pulumi.Input[builtins.str] type: The backend service type of the endpoint. Valid values: `PrivateSubNet`.
        :param pulumi.Input[builtins.str] traffic_to_endpoint_policy: The access policy of traffic to the endpoint. Default value: `DenyAll`. Valid values:
    ...
    def traffic_to_endpoint_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def traffic_to_endpoint_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CustomRoutingEndpointState:
    def __init__(__self__, *,
                 ...
                 custom_routing_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] accelerator_id: The ID of the GA instance with which the endpoint is associated.
        :param pulumi.Input[builtins.str] custom_routing_endpoint_id: The ID of the Custom Routing Endpoint.
        :param pulumi.Input[builtins.str] endpoint: The ID of the endpoint (vSwitch).
        :param pulumi.Input[builtins.str] endpoint_group_id: The ID of the endpoint group in which to create endpoints.
        :param pulumi.Input[builtins.str] listener_id: The ID of the listener with which the endpoint is associated.
        :param pulumi.Input[builtins.str] status: The status of the Custom Routing Endpoint.
        :param pulumi.Input[builtins.str] traffic_to_endpoint_policy: The access policy of traffic to the endpoint. Default value: `DenyAll`. Valid values:
               - `DenyAll`: denies all traffic to the endpoint.
               - `AllowAll`: allows all traffic to the endpoint.
               - `AllowCustom`: allows traffic only to specified destinations in the endpoint.
    ...
    def custom_routing_endpoint_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_routing_endpoint_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CustomRoutingEndpoint(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:ga/customRoutingEndpoint:CustomRoutingEndpoint"
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            traffic_to_endpoint_policy: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomRoutingEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="customRoutingEndpointId")
    def custom_routing_endpoint_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Custom Routing Endpoint.
        """
        return pulumi.get(self, "custom_routing_endpoint_id")
    ...
    @property
    @pulumi.getter(name="trafficToEndpointPolicy")
    def traffic_to_endpoint_policy(self) -> pulumi.Output[builtins.str]:
        """
        The access policy of traffic to the endpoint. Default value: `DenyAll`. Valid values:
        - `DenyAll`: denies all traffic to the endpoint.
        - `AllowAll`: allows all traffic to the endpoint.
