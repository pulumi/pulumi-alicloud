...
def get_endpoint_groups_output(accelerator_id: pulumi.Input[Optional[_builtins.str]] = None,
                               endpoint_group_type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
