...
class GetEndpointGroupsResult:
    ...
    def endpoint_group_type(self) -> Optional[_builtins.str]:
...
def get_endpoint_groups(accelerator_id: Optional[_builtins.str] = None,
                        endpoint_group_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str accelerator_id: The ID of the Global Accelerator instance to which the endpoint group will be added.
    :param _builtins.str endpoint_group_type: The endpoint group type. Default value: `default`. Valid values: `default`, `virtual`.
    :param Sequence[_builtins.str] ids: A list of Endpoint Group IDs.
    :param _builtins.str listener_id: The ID of the listener that is associated with the endpoint group.
    :param _builtins.str name_regex: A regex string to filter results by Endpoint Group name.
...
def get_endpoint_groups_output(accelerator_id: Optional[pulumi.Input[_builtins.str]] = None,
                               endpoint_group_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
