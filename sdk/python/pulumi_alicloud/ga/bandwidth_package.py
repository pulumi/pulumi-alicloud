...
class BandwidthPackageArgs:
    def __init__(__self__, *,
                 ...
                 bandwidth_type: Optional[pulumi.Input[builtins.str]] = None,
                 billing_type: Optional[pulumi.Input[builtins.str]] = None,
                 cbn_geographic_region_ida: Optional[pulumi.Input[builtins.str]] = None,
                 cbn_geographic_region_idb: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth value of bandwidth packet.
        :param pulumi.Input[builtins.str] type: The type of the bandwidth packet. China station only supports return to basic. Valid values: `Basic`, `CrossDomain`.
        :param pulumi.Input[builtins.bool] auto_pay: Whether to pay automatically. Valid values:
        :param pulumi.Input[builtins.int] auto_renew_duration: Auto renewal period of a bandwidth packet, in the unit of month. Valid values: `1` to `12`.
        :param pulumi.Input[builtins.bool] auto_use_coupon: Whether use vouchers. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.str] bandwidth_package_name: The name of the bandwidth packet.
        :param pulumi.Input[builtins.str] bandwidth_type: The bandwidth type of the bandwidth. Valid values: `Advanced`, `Basic`, `Enhanced`. If `type` is set to `Basic`, this parameter is required.
        ...
        :param pulumi.Input[builtins.str] billing_type: The billing type. Valid values: `PayBy95`, `PayByTraffic`. **NOTE:** `billing_type` is valid only when `payment_type` is set to `PayAsYouGo`.
        :param pulumi.Input[builtins.str] cbn_geographic_region_ida: Interworking area A of cross domain acceleration package. Only international stations support returning this parameter. Default value: `China-mainland`.
        :param pulumi.Input[builtins.str] cbn_geographic_region_idb: Interworking area B of cross domain acceleration package. Only international stations support returning this parameter. Default value: `Global`.
        :param pulumi.Input[builtins.str] description: The description of bandwidth package.
        :param pulumi.Input[builtins.str] duration: The subscription duration. **NOTE:** The ForceNew attribute has be removed from version 1.148.0. If `payment_type` is set to `Subscription`, this parameter is required.
        :param pulumi.Input[builtins.str] payment_type: The payment type of the bandwidth. Default value: `Subscription`. Valid values: `PayAsYouGo`, `Subscription`.
        ...
        :param pulumi.Input[builtins.int] ratio: The minimum percentage for the pay-by-95th-percentile metering method. Valid values: `30` to `100`. **NOTE:** `ratio` is valid only when `billing_type` is set to `PayBy95`.
        :param pulumi.Input[builtins.str] renewal_status: Whether to renew a bandwidth packet. automatically or not. Valid values:
    ...
    def bandwidth_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bandwidth_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def cbn_geographic_region_ida(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cbn_geographic_region_ida(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cbn_geographic_region_ida", value)

    @property
    @pulumi.getter(name="cbnGeographicRegionIdb")
    def cbn_geographic_region_idb(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cbn_geographic_region_idb(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BandwidthPackageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] renewal_status: Whether to renew a bandwidth packet. automatically or not. Valid values:
               ...
               - `NotRenewal`: No renewal any longer. After you specify this value, Alibaba Cloud stop sending notification of instance expiry, and only gives a brief reminder on the third day before the instance expiry.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group. **Note:** Once you set a value of this property, you cannot set it to an empty string anymore.
        :param pulumi.Input[builtins.str] status: The status of the Bandwidth Package.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] type: The type of the bandwidth packet. China station only supports return to basic. Valid values: `Basic`, `CrossDomain`.
        """
        if auto_pay is not None:
...
class BandwidthPackage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'BandwidthPackage':
        """
    ...
    @property
    @pulumi.getter(name="bandwidthPackageName")
    def bandwidth_package_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the bandwidth packet.
        """
        return pulumi.get(self, "bandwidth_package_name")
    ...
    @property
    @pulumi.getter(name="bandwidthType")
    def bandwidth_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The bandwidth type of the bandwidth. Valid values: `Advanced`, `Basic`, `Enhanced`. If `type` is set to `Basic`, this parameter is required.
        > **NOTE:** At present, only basic can be configured to enhanced, but not enhanced and advanced to other types of accelerated bandwidth.
        """
    ...
    @property
    @pulumi.getter(name="cbnGeographicRegionIda")
    def cbn_geographic_region_ida(self) -> pulumi.Output[builtins.str]:
        """
        Interworking area A of cross domain acceleration package. Only international stations support returning this parameter. Default value: `China-mainland`.
        """
        return pulumi.get(self, "cbn_geographic_region_ida")
    ...
    @property
    @pulumi.getter(name="cbnGeographicRegionIdb")
    def cbn_geographic_region_idb(self) -> pulumi.Output[builtins.str]:
        """
        Interworking area B of cross domain acceleration package. Only international stations support returning this parameter. Default value: `Global`.
        """
        return pulumi.get(self, "cbn_geographic_region_idb")
    ...
    @property
    @pulumi.getter
    def ratio(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The minimum percentage for the pay-by-95th-percentile metering method. Valid values: `30` to `100`. **NOTE:** `ratio` is valid only when `billing_type` is set to `PayBy95`.
        """
        return pulumi.get(self, "ratio")
