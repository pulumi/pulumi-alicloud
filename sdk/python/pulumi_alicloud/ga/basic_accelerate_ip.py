...
class BasicAccelerateIpArgs:
    def __init__(__self__, *,
                 ...
                 ip_set_id: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] ip_set_id: The ID of the Basic Ip Set.
        """
    ...
    def ip_set_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ip_set_id.setter
    def ip_set_id(self, value: pulumi.Input[builtins.str]):
...
class _BasicAccelerateIpState:
    def __init__(__self__, *,
                 accelerate_ip_address: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] accelerate_ip_address: The address of the Basic Accelerate IP.
        :param pulumi.Input[builtins.str] accelerator_id: The ID of the Basic GA instance.
        :param pulumi.Input[builtins.str] ip_set_id: The ID of the Basic Ip Set.
        :param pulumi.Input[builtins.str] status: The status of the Basic Accelerate IP instance.
        """
    ...
    def accelerate_ip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def accelerate_ip_address(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="ipSetId")
    def ip_set_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Basic Ip Set.
        """
        return pulumi.get(self, "ip_set_id")
    ...
    @ip_set_id.setter
    def ip_set_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ip_set_id", value)
...
class BasicAccelerateIp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            accelerator_id: Optional[pulumi.Input[builtins.str]] = None,
            ip_set_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'BasicAccelerateIp':
        """
    ...
    @property
    @pulumi.getter(name="accelerateIpAddress")
    def accelerate_ip_address(self) -> pulumi.Output[builtins.str]:
        """
        The address of the Basic Accelerate IP.
        """
        return pulumi.get(self, "accelerate_ip_address")
    ...
    @property
    @pulumi.getter(name="ipSetId")
    def ip_set_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Basic Ip Set.
        """
        return pulumi.get(self, "ip_set_id")
