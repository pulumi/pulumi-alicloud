...
def get_additional_certificates(accelerator_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Additional Certificate IDs.
...
def get_additional_certificates_output(accelerator_id: Optional[pulumi.Input[builtins.str]] = None,
