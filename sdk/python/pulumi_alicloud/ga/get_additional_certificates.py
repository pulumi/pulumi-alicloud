...
def get_additional_certificates(accelerator_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Additional Certificate IDs.
...
def get_additional_certificates_output(accelerator_id: Optional[pulumi.Input[_builtins.str]] = None,
