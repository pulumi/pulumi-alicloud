...
def get_custom_routing_endpoint_group_destinations(accelerator_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Custom Routing Endpoint Group Destination IDs.
...
def get_custom_routing_endpoint_group_destinations_output(accelerator_id: Optional[pulumi.Input[builtins.str]] = None,
                                                          endpoint_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                          from_port: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                                          ...
                                                          to_port: Optional[pulumi.Input[Optional[builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:ga/getCustomRoutingEndpointGroupDestinations:getCustomRoutingEndpointGroupDestinations', __args__, opts=opts, typ=GetCustomRoutingEndpointGroupDestinationsResult)
    return __ret__.apply(lambda __response__: GetCustomRoutingEndpointGroupDestinationsResult(
        accelerator_id=pulumi.get(__response__, 'accelerator_id'),
        custom_routing_endpoint_group_destinations=pulumi.get(__response__, 'custom_routing_endpoint_group_destinations'),
