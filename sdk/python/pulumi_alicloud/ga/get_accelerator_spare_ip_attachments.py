...
def get_accelerator_spare_ip_attachments(accelerator_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Accelerator Spare Ip Attachment IDs.
...
def get_accelerator_spare_ip_attachments_output(accelerator_id: Optional[pulumi.Input[builtins.str]] = None,
