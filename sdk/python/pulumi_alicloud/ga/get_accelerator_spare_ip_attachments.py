...
def get_accelerator_spare_ip_attachments(accelerator_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Accelerator Spare Ip Attachment IDs.
