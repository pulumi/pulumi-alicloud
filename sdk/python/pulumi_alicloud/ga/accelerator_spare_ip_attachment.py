...
class AcceleratorSpareIpAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 spare_ip: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] spare_ip: The standby IP address of CNAME. When the acceleration area is abnormal, the traffic is switched to the standby IP address.
    ...
    def spare_ip(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @spare_ip.setter
    def spare_ip(self, value: pulumi.Input[builtins.str]):
...
class _AcceleratorSpareIpAttachmentState:
    def __init__(__self__, *,
                 ...
                 dry_run: Optional[pulumi.Input[builtins.bool]] = None,
                 spare_ip: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] dry_run: The dry run.
        :param pulumi.Input[builtins.str] spare_ip: The standby IP address of CNAME. When the acceleration area is abnormal, the traffic is switched to the standby IP address.
        :param pulumi.Input[builtins.str] status: The status of the standby CNAME IP address.
        """
    ...
    @property
    @pulumi.getter(name="spareIp")
    def spare_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The standby IP address of CNAME. When the acceleration area is abnormal, the traffic is switched to the standby IP address.
        """
        return pulumi.get(self, "spare_ip")
    ...
    @spare_ip.setter
    def spare_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "spare_ip", value)
...
class AcceleratorSpareIpAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            dry_run: Optional[pulumi.Input[builtins.bool]] = None,
            spare_ip: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'AcceleratorSpareIpAttachment':
        """
    ...
    @property
    @pulumi.getter(name="spareIp")
    def spare_ip(self) -> pulumi.Output[builtins.str]:
        """
        The standby IP address of CNAME. When the acceleration area is abnormal, the traffic is switched to the standby IP address.
        """
        return pulumi.get(self, "spare_ip")
