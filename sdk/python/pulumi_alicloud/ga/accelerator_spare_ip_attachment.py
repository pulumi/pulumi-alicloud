...
class AcceleratorSpareIpAttachmentArgs:
    ...
    def spare_ip(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @spare_ip.setter
    def spare_ip(self, value: pulumi.Input[_builtins.str]):
...
class _AcceleratorSpareIpAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] dry_run: The dry run.
        :param pulumi.Input[_builtins.str] spare_ip: The standby IP address of CNAME. When the acceleration area is abnormal, the traffic is switched to the standby IP address.
        :param pulumi.Input[_builtins.str] status: The status of the standby CNAME IP address.
        """
...
class AcceleratorSpareIpAttachment(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="spareIp")
    def spare_ip(self) -> pulumi.Output[_builtins.str]:
        """
        The standby IP address of CNAME. When the acceleration area is abnormal, the traffic is switched to the standby IP address.
        """
        return pulumi.get(self, "spare_ip")
