...
def get_custom_routing_endpoints(accelerator_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Custom Routing Endpoint IDs.
...
def get_custom_routing_endpoints_output(accelerator_id: Optional[pulumi.Input[builtins.str]] = None,
