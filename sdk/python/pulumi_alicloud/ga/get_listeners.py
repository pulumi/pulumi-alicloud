...
def get_listeners(accelerator_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str accelerator_id: The accelerator id.
    :param Sequence[_builtins.str] ids: A list of Listener IDs.
    :param _builtins.str name_regex: A regex string to filter results by Listener name.
...
def get_listeners_output(accelerator_id: pulumi.Input[Optional[_builtins.str]] = None,
