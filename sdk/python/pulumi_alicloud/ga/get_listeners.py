...
def get_listeners(accelerator_id: Optional[builtins.str] = None,
    ...
    :param builtins.str accelerator_id: The accelerator id.
    :param Sequence[builtins.str] ids: A list of Listener IDs.
    :param builtins.str name_regex: A regex string to filter results by Listener name.
...
def get_listeners_output(accelerator_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:ga/getListeners:getListeners', __args__, opts=opts, typ=GetListenersResult)
