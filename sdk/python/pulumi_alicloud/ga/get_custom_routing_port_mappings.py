...
def get_custom_routing_port_mappings(accelerator_id: Optional[builtins.str] = None,
...
def get_custom_routing_port_mappings_output(accelerator_id: Optional[pulumi.Input[builtins.str]] = None,
