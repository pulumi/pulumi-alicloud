...
def get_basic_endpoints(endpoint_group_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Global Accelerator Basic Endpoints IDs.
    :param builtins.str name: The name of the Basic Endpoint.
    :param builtins.str name_regex: A regex string to filter results by Global Accelerator Basic Endpoints name.
...
def get_basic_endpoints_output(endpoint_group_id: Optional[pulumi.Input[builtins.str]] = None,
                               endpoint_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               endpoint_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               ...
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBasicEndpointsResult]:
    """
    This data source provides the Global Accelerator (GA) Basic Endpoints of the current Alibaba Cloud user.
