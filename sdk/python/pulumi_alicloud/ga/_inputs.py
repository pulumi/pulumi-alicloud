...
if not MYPY:
    class AclAclEntryArgsDict(TypedDict):
        ...
        """
        entry_description: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AclAclEntryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] entry_description: The description of the IP entry. The description must be `1` to `256` characters in length, and can contain letters, digits, hyphens (-), forward slashes (/), periods (.),and underscores (_).
        """
...
class CustomRoutingEndpointTrafficPolicyPortRangeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] from_port: The start port of the port range of the traffic destination. The specified port must fall within the port range of the specified endpoint group.
        :param pulumi.Input[builtins.int] to_port: The end port of the port range of the traffic destination. The specified port must fall within the port range of the specified endpoint group.
        """
...
class EndpointGroupEndpointConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str],
                 weight: pulumi.Input[builtins.int],
                 enable_clientip_preservation: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_proxy_protocol: Optional[pulumi.Input[builtins.bool]] = None,
                 sub_address: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] endpoint: The IP address or domain name of Endpoint N in the endpoint group.
        :param pulumi.Input[builtins.str] type: The type of Endpoint N in the endpoint group. Valid values:
               - `Domain`: A custom domain name.
               - `Ip`: A custom IP address.
               - `PublicIp`: An Alibaba Cloud public IP address.
               - `ECS`: An Elastic Compute Service (ECS) instance.
               ...
               - `OSS`: An Object Storage Service (OSS) bucket.
               > **NOTE:** From version 1.232.0, `type` can be set to `ALB`, `NLB`, `ENI`, `OSS`.
        :param pulumi.Input[builtins.int] weight: The weight of Endpoint N in the endpoint group. Valid values: `0` to `255`.
               > **NOTE:** If the weight of a terminal node is set to `0`, global acceleration will terminate the distribution of traffic to the terminal node. Please be careful.
        :param pulumi.Input[builtins.bool] enable_clientip_preservation: Indicates whether client IP addresses are reserved. Default Value: `false`. Valid values:
        :param pulumi.Input[builtins.bool] enable_proxy_protocol: Specifies whether to preserve client IP addresses by using the ProxyProtocol module. Default Value: `false`. Valid values:
        :param pulumi.Input[builtins.str] sub_address: The private IP address of the ENI.
               > **NOTE:** `sub_address` is valid only when `type` is set to `ENI`.
        """
    ...
    def enable_clientip_preservation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether client IP addresses are reserved. Default Value: `false`. Valid values:
        """
    ...
    def enable_clientip_preservation(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def sub_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The private IP address of the ENI.
        > **NOTE:** `sub_address` is valid only when `type` is set to `ENI`.
        """
    ...
    @sub_address.setter
    def sub_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sub_address", value)


if not MYPY:
    class EndpointGroupPortOverridesArgsDict(TypedDict):
        endpoint_port: NotRequired[pulumi.Input[builtins.int]]
        """
        Forwarding port.
        """
...
class EndpointGroupPortOverridesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] endpoint_port: Forwarding port.
        :param pulumi.Input[builtins.int] listener_port: Listener port.
        """
...
if not MYPY:
    class ForwardingRuleRuleActionArgsDict(TypedDict):
        ...
        Forwarding priority.
        """
        rule_action_type: pulumi.Input[builtins.str]
        """
        ...
        """
        rule_action_value: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ForwardingRuleRuleActionArgs:
    def __init__(__self__, *,
                 ...
                 rule_action_value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] order: Forwarding priority.
        :param pulumi.Input[builtins.str] rule_action_type: The type of the forwarding action. Valid values: `ForwardGroup`, `Redirect`, `FixResponse`, `Rewrite`, `AddHeader`, `RemoveHeader`, `Drop`.
        :param pulumi.Input['ForwardingRuleRuleActionForwardGroupConfigArgs'] forward_group_config: Forwarding configuration. See `forward_group_config` below.
               > **NOTE:** From version 1.207.0, We recommend that you do not use `forward_group_config`, and we recommend that you use the `rule_action_type` and `rule_action_value` to configure forwarding actions.
        :param pulumi.Input[builtins.str] rule_action_value: The value of the forwarding action type. For more information, see [How to use it](https://www.alibabacloud.com/help/en/global-accelerator/latest/api-ga-2019-11-20-createforwardingrules).
        """
    ...
    def rule_action_type(self) -> pulumi.Input[builtins.str]:
        """
        The type of the forwarding action. Valid values: `ForwardGroup`, `Redirect`, `FixResponse`, `Rewrite`, `AddHeader`, `RemoveHeader`, `Drop`.
        """
    ...
    def rule_action_type(self, value: pulumi.Input[builtins.str]):
    ...
    def rule_action_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The value of the forwarding action type. For more information, see [How to use it](https://www.alibabacloud.com/help/en/global-accelerator/latest/api-ga-2019-11-20-createforwardingrules).
        """
    ...
    def rule_action_value(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ForwardingRuleRuleConditionArgsDict(TypedDict):
        rule_condition_type: pulumi.Input[builtins.str]
        """
        ...
        """
        rule_condition_value: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ForwardingRuleRuleConditionArgs:
    def __init__(__self__, *,
                 ...
                 rule_condition_value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] rule_condition_type: The type of the forwarding conditions. Valid values: `Host`, `Path`, `RequestHeader`, `Query`, `Method`, `Cookie`, `SourceIP`. **NOTE:** From version 1.231.0, `rule_condition_type` can be set to `RequestHeader`, `Query`, `Method`, `Cookie`, `SourceIP`.
        ...
        :param pulumi.Input[builtins.str] rule_condition_value: The value of the forwarding condition type. For more information, see [How to use it](https://www.alibabacloud.com/help/en/global-accelerator/latest/api-ga-2019-11-20-createforwardingrules).
        """
    ...
    def rule_condition_type(self) -> pulumi.Input[builtins.str]:
        """
        The type of the forwarding conditions. Valid values: `Host`, `Path`, `RequestHeader`, `Query`, `Method`, `Cookie`, `SourceIP`. **NOTE:** From version 1.231.0, `rule_condition_type` can be set to `RequestHeader`, `Query`, `Method`, `Cookie`, `SourceIP`.
        """
    ...
    def rule_condition_type(self, value: pulumi.Input[builtins.str]):
    ...
    def rule_condition_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The value of the forwarding condition type. For more information, see [How to use it](https://www.alibabacloud.com/help/en/global-accelerator/latest/api-ga-2019-11-20-createforwardingrules).
        """
    ...
    def rule_condition_value(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ForwardingRuleRuleConditionHostConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: The domain name is 3-128 characters long, which can contain letters, numbers, dashes (-) and width period (.), and supports the use of asterisk (*) and width question mark (?) as wildcard characters.
        """
...
class ListenerCertificateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: The id of the certificate.
        """
        if id is not None:
...
if not MYPY:
    class ListenerForwardedForConfigArgsDict(TypedDict):
        forwarded_for_ga_ap_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        forwarded_for_ga_id_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Specifies whether to use the GA-ID header to retrieve the ID of the GA instance. Default value: `false`. Valid values:
        """
        forwarded_for_port_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        forwarded_for_proto_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        real_ip_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ListenerForwardedForConfigArgs:
    def __init__(__self__, *,
                 forwarded_for_ga_ap_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 forwarded_for_ga_id_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 forwarded_for_port_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 forwarded_for_proto_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 real_ip_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] forwarded_for_ga_ap_enabled: Specifies whether to use the GA-AP header to retrieve the information about acceleration regions. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.bool] forwarded_for_ga_id_enabled: Specifies whether to use the GA-ID header to retrieve the ID of the GA instance. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.bool] forwarded_for_port_enabled: Specifies whether to use the GA-X-Forward-Port header to retrieve the listener ports of the GA instance. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.bool] forwarded_for_proto_enabled: Specifies whether to use the GA-X-Forward-Proto header to retrieve the listener protocol of the GA instance. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.bool] real_ip_enabled: Specifies whether to use the X-Real-IP header to retrieve client IP addresses. Default value: `false`. Valid values:
        """
    ...
    def forwarded_for_ga_ap_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to use the GA-AP header to retrieve the information about acceleration regions. Default value: `false`. Valid values:
        """
    ...
    def forwarded_for_ga_ap_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "forwarded_for_ga_ap_enabled", value)

    @property
    @pulumi.getter(name="forwardedForGaIdEnabled")
    def forwarded_for_ga_id_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to use the GA-ID header to retrieve the ID of the GA instance. Default value: `false`. Valid values:
        """
    ...
    def forwarded_for_ga_id_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "forwarded_for_ga_id_enabled", value)

    @property
    @pulumi.getter(name="forwardedForPortEnabled")
    def forwarded_for_port_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to use the GA-X-Forward-Port header to retrieve the listener ports of the GA instance. Default value: `false`. Valid values:
        """
    ...
    def forwarded_for_port_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "forwarded_for_port_enabled", value)

    @property
    @pulumi.getter(name="forwardedForProtoEnabled")
    def forwarded_for_proto_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to use the GA-X-Forward-Proto header to retrieve the listener protocol of the GA instance. Default value: `false`. Valid values:
        """
    ...
    def forwarded_for_proto_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "forwarded_for_proto_enabled", value)

    @property
    @pulumi.getter(name="realIpEnabled")
    def real_ip_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to use the X-Real-IP header to retrieve client IP addresses. Default value: `false`. Valid values:
        """
    ...
    def real_ip_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ListenerPortRangeArgs:
    def __init__(__self__, *,
                 ...
                 to_port: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] from_port: The initial listening port used to receive requests and forward them to terminal nodes.
        :param pulumi.Input[builtins.int] to_port: The end listening port used to receive requests and forward them to terminal nodes.
        """
        pulumi.set(__self__, "from_port", from_port)
        pulumi.set(__self__, "to_port", to_port)
