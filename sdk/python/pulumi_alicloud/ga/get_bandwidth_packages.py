...
def get_bandwidth_packages(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Bandwidth Package IDs.
    :param builtins.str name_regex: A regex string to filter results by Bandwidth Package name.
...
def get_bandwidth_packages_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
