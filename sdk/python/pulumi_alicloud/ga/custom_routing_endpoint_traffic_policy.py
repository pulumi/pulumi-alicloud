...
class CustomRoutingEndpointTrafficPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] address: The IP address of the destination to which traffic is allowed.
        :param pulumi.Input[builtins.str] endpoint_id: The ID of the Custom Routing Endpoint.
...
class _CustomRoutingEndpointTrafficPolicyState:
    def __init__(__self__, *,
                 ...
                 custom_routing_endpoint_traffic_policy_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] accelerator_id: The ID of the GA instance.
        :param pulumi.Input[builtins.str] address: The IP address of the destination to which traffic is allowed.
        :param pulumi.Input[builtins.str] custom_routing_endpoint_traffic_policy_id: The ID of the Custom Routing Endpoint Traffic Policy.
        :param pulumi.Input[builtins.str] endpoint_group_id: The ID of the endpoint group.
        :param pulumi.Input[builtins.str] endpoint_id: The ID of the Custom Routing Endpoint.
        :param pulumi.Input[builtins.str] listener_id: The ID of the listener.
        :param pulumi.Input[Sequence[pulumi.Input['CustomRoutingEndpointTrafficPolicyPortRangeArgs']]] port_ranges: Port rangeSee the following. See `port_ranges` below.
        :param pulumi.Input[builtins.str] status: The status of the Custom Routing Endpoint Traffic Policy.
        """
    ...
    def custom_routing_endpoint_traffic_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_routing_endpoint_traffic_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CustomRoutingEndpointTrafficPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            listener_id: Optional[pulumi.Input[builtins.str]] = None,
            port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CustomRoutingEndpointTrafficPolicyPortRangeArgs', 'CustomRoutingEndpointTrafficPolicyPortRangeArgsDict']]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomRoutingEndpointTrafficPolicy':
        """
    ...
    @property
    @pulumi.getter(name="customRoutingEndpointTrafficPolicyId")
    def custom_routing_endpoint_traffic_policy_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Custom Routing Endpoint Traffic Policy.
        """
        return pulumi.get(self, "custom_routing_endpoint_traffic_policy_id")
