...
class ForwardingRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] accelerator_id: The ID of the Global Accelerator instance.
        :param pulumi.Input[builtins.str] listener_id: The ID of the listener.
        ...
        :param pulumi.Input[builtins.str] forwarding_rule_name: Forwarding policy name. The length of the name is 2-128 English or Chinese characters. It must start with uppercase and lowercase letters or Chinese characters. It can contain numbers, half width period (.), underscores (_) And dash (-).
        :param pulumi.Input[builtins.int] priority: Forwarding policy priority.
        """
    ...
    def forwarding_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def forwarding_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ForwardingRuleState:
    def __init__(__self__, *,
                 ...
                 forwarding_rule_id: Optional[pulumi.Input[builtins.str]] = None,
                 forwarding_rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 forwarding_rule_status: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] accelerator_id: The ID of the Global Accelerator instance.
        :param pulumi.Input[builtins.str] forwarding_rule_id: The ID of the Forwarding Rule.
        :param pulumi.Input[builtins.str] forwarding_rule_name: Forwarding policy name. The length of the name is 2-128 English or Chinese characters. It must start with uppercase and lowercase letters or Chinese characters. It can contain numbers, half width period (.), underscores (_) And dash (-).
        :param pulumi.Input[builtins.str] forwarding_rule_status: The status of the Forwarding Rule.
        :param pulumi.Input[builtins.str] listener_id: The ID of the listener.
        :param pulumi.Input[builtins.int] priority: Forwarding policy priority.
        :param pulumi.Input[Sequence[pulumi.Input['ForwardingRuleRuleActionArgs']]] rule_actions: Forward action. See `rule_actions` below.
        :param pulumi.Input[Sequence[pulumi.Input['ForwardingRuleRuleConditionArgs']]] rule_conditions: Forwarding condition list. See `rule_conditions` below.
    ...
    def forwarding_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def forwarding_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def forwarding_rule_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def forwarding_rule_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ForwardingRule(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="forwardingRuleId")
    def forwarding_rule_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Forwarding Rule.
        """
        return pulumi.get(self, "forwarding_rule_id")
    ...
    @property
    @pulumi.getter(name="forwardingRuleName")
    def forwarding_rule_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Forwarding policy name. The length of the name is 2-128 English or Chinese characters. It must start with uppercase and lowercase letters or Chinese characters. It can contain numbers, half width period (.), underscores (_) And dash (-).
        """
        return pulumi.get(self, "forwarding_rule_name")
    ...
    @property
    @pulumi.getter(name="forwardingRuleStatus")
    def forwarding_rule_status(self) -> pulumi.Output[builtins.str]:
        """
        The status of the Forwarding Rule.
        """
        return pulumi.get(self, "forwarding_rule_status")
