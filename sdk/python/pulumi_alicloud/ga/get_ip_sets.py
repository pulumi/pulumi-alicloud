...
def get_ip_sets(accelerator_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Ip Set IDs.
...
def get_ip_sets_output(accelerator_id: Optional[pulumi.Input[_builtins.str]] = None,
