...
class GetDeviceGroupsResult:
    ...
    def iot_instance_id(self) -> Optional[builtins.str]:
    ...
    def super_group_id(self) -> Optional[builtins.str]:
...
def get_device_groups(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of device group IDs.
    :param builtins.str iot_instance_id: The id of the Iot Instance.
    :param builtins.str name_regex: A regex string to filter CEN instances by name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str super_group_id: The id of the SuperGroup.
    """
    __args__ = dict()
