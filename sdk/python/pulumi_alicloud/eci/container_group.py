...
class ContainerGroupArgs:
    def __init__(__self__, *,
                 container_group_name: pulumi.Input[builtins.str],
                 ...
                 plain_http_registry: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] container_group_name: The name of the container group.
        ...
        :param pulumi.Input[builtins.str] security_group_id: The ID of the security group to which the container group belongs. Container groups within the same security group can access each other.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the VSwitch. Currently, container groups can only be deployed in VPC networks. The number of IP addresses in the VSwitch CIDR block determines the maximum number of container groups that can be created in the VSwitch. Before you can create an ECI instance, plan the CIDR block of the VSwitch.
        ...
        :param pulumi.Input[builtins.bool] auto_create_eip: Specifies whether to automatically create an EIP and bind the EIP to the elastic container instance.
        :param pulumi.Input[builtins.bool] auto_match_image_cache: Specifies whether to automatically match the image cache. Default value: `false`. Valid values: `true` and `false`.
        ...
        :param pulumi.Input[builtins.str] dns_policy: The policy of DNS. Default value: `Default`. Valid values: `Default` and `None`.
        :param pulumi.Input[builtins.int] eip_bandwidth: The bandwidth of the EIP. Default value: `5`.
        :param pulumi.Input[builtins.str] eip_instance_id: The ID of the elastic IP address (EIP).
        ...
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group. **NOTE:** From version 1.208.0, `resource_group_id` can be modified.
        :param pulumi.Input[builtins.str] restart_policy: The restart policy of the container group. Valid values: `Always`, `Never`, `OnFailure`.
        ...
        :param pulumi.Input[builtins.float] spot_price_limit: The maximum hourly price of the ECI spot instance.
        :param pulumi.Input[builtins.str] spot_strategy: Filter the results by ECI spot type. Valid values: `NoSpot`, `SpotWithPriceLimit` and `SpotAsPriceGo`. Default to `NoSpot`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
               - Key: It can be up to 64 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It cannot be a null string.
               - Value: It can be up to 128 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It can be a null string.
        :param pulumi.Input[builtins.int] termination_grace_period_seconds: The buffer time during which the program handles operations before the program stops. Unit: seconds.
        :param pulumi.Input[Sequence[pulumi.Input['ContainerGroupVolumeArgs']]] volumes: The list of volumes. See `volumes` below.
        :param pulumi.Input[builtins.str] zone_id: The ID of the zone where you want to deploy the container group. If no value is specified, the system assigns a zone to the container group. By default, no value is specified.
        """
    ...
    def container_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def container_group_name(self, value: pulumi.Input[builtins.str]):
    ...
    def plain_http_registry(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def plain_http_registry(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ContainerGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] insecure_registry: The address of the self-built mirror warehouse. When creating an image cache using an image in a self-built image repository with a self-signed certificate, you need to configure this parameter to skip certificate authentication to avoid image pull failure due to certificate authentication failure.
        :param pulumi.Input[builtins.str] instance_type: The type of the ECS instance.
        :param pulumi.Input[builtins.str] internet_ip: (Available since v1.170.0) The Public IP of the container group.
        :param pulumi.Input[builtins.str] intranet_ip: (Available since v1.170.0) The Private IP of the container group.
        :param pulumi.Input[builtins.float] memory: The amount of memory resources allocated to the container group.
        :param pulumi.Input[builtins.str] plain_http_registry: The address of the self-built mirror warehouse. When creating an image cache from an image in a self-built image repository using the HTTP protocol, you need to configure this parameter so that the ECI uses the HTTP protocol to pull the image to avoid image pull failure due to different protocols.
        :param pulumi.Input[builtins.str] ram_role_name: The RAM role that the container group assumes. ECI and ECS share the same RAM role.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group. **NOTE:** From version 1.208.0, `resource_group_id` can be modified.
        ...
        :param pulumi.Input[builtins.float] spot_price_limit: The maximum hourly price of the ECI spot instance.
        :param pulumi.Input[builtins.str] spot_strategy: Filter the results by ECI spot type. Valid values: `NoSpot`, `SpotWithPriceLimit` and `SpotAsPriceGo`. Default to `NoSpot`.
        :param pulumi.Input[builtins.str] status: The status of container group.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
               - Key: It can be up to 64 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It cannot be a null string.
               - Value: It can be up to 128 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It can be a null string.
        :param pulumi.Input[builtins.int] termination_grace_period_seconds: The buffer time during which the program handles operations before the program stops. Unit: seconds.
...
class ContainerGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            volumes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ContainerGroupVolumeArgs', 'ContainerGroupVolumeArgsDict']]]]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ContainerGroup':
        """
    ...
    @property
    @pulumi.getter(name="autoMatchImageCache")
    def auto_match_image_cache(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to automatically match the image cache. Default value: `false`. Valid values: `true` and `false`.
        """
        return pulumi.get(self, "auto_match_image_cache")
    ...
    @property
    @pulumi.getter(name="containerGroupName")
    def container_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the container group.
        """
        return pulumi.get(self, "container_group_name")
    ...
    @property
    @pulumi.getter(name="dnsPolicy")
    def dns_policy(self) -> pulumi.Output[builtins.str]:
        """
        The policy of DNS. Default value: `Default`. Valid values: `Default` and `None`.
        """
        return pulumi.get(self, "dns_policy")
    ...
    @property
    @pulumi.getter(name="plainHttpRegistry")
    def plain_http_registry(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The address of the self-built mirror warehouse. When creating an image cache from an image in a self-built image repository using the HTTP protocol, you need to configure this parameter so that the ECI uses the HTTP protocol to pull the image to avoid image pull failure due to different protocols.
        """
        return pulumi.get(self, "plain_http_registry")
    ...
    @property
    @pulumi.getter(name="restartPolicy")
    def restart_policy(self) -> pulumi.Output[builtins.str]:
        """
        The restart policy of the container group. Valid values: `Always`, `Never`, `OnFailure`.
        """
        return pulumi.get(self, "restart_policy")
