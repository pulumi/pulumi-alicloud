...
def get_container_groups(container_group_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Container Group IDs.
    :param builtins.int limit: The maximum number of resources returned in the response. Default value is `20`. Maximum value: `20`. The number of returned results is no greater than the specified number.
    :param builtins.str name_regex: A regex string to filter results by Container Group name.
    ...
    :param builtins.str status: The status list. For more information, see the description of ContainerGroup arrays.
    :param builtins.str vswitch_id: The ID of the vSwitch. Currently, container groups can only be deployed in VPC networks.
    :param builtins.str zone_id: The ID of the zone where you want to deploy the container group. If no value is specified, the system assigns a zone to the container group. By default, no value is specified.
    """
    __args__ = dict()
...
def get_container_groups_output(container_group_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                with_event: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
