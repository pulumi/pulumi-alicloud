...
class VirtualNodeArgs:
    def __init__(__self__, *,
                 kube_config: pulumi.Input[builtins.str],
                 ...
                 virtual_node_name: Optional[pulumi.Input[builtins.str]] = None,
                 zone_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a VirtualNode resource.
        :param pulumi.Input[builtins.str] kube_config: The kube config for the k8s cluster. It needs to be connected after Base64 encoding.
        ...
        :param pulumi.Input[builtins.str] eip_instance_id: The Id of eip.
        :param pulumi.Input[builtins.bool] enable_public_network: Whether to enable public network. **NOTE:** If `eip_instance_id` is not configured and `enable_public_network` is true, the system will create an elastic public network IP.
        ...
        :param pulumi.Input[builtins.str] virtual_node_name: The name of the virtual node. The length of the name is limited to `2` to `128` characters. It can contain uppercase and lowercase letters, Chinese characters, numbers, half-width colon (:), underscores (_), or hyphens (-), and must start with letters.
        :param pulumi.Input[builtins.str] zone_id: The Zone.
        """
    ...
    def kube_config(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @kube_config.setter
    def kube_config(self, value: pulumi.Input[builtins.str]):
    ...
    def virtual_node_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def virtual_node_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _VirtualNodeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_id: The resource group ID.
        :param pulumi.Input[builtins.str] security_group_id: The security group ID.
        :param pulumi.Input[builtins.str] status: The Status of the virtual node. Valid values: `Cleaned`, `Failed`, `Pending`, `Ready`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[Sequence[pulumi.Input['VirtualNodeTaintArgs']]] taints: The taint. See `taints` below.
        :param pulumi.Input[builtins.str] virtual_node_name: The name of the virtual node. The length of the name is limited to `2` to `128` characters. It can contain uppercase and lowercase letters, Chinese characters, numbers, half-width colon (:), underscores (_), or hyphens (-), and must start with letters.
        :param pulumi.Input[builtins.str] vswitch_id: The vswitch id.
...
@pulumi.type_token("alicloud:eci/virtualNode:VirtualNode")
class VirtualNode(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            virtual_node_name: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VirtualNode':
        """
    ...
    @property
    @pulumi.getter(name="eipInstanceId")
    def eip_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The Id of eip.
        """
        return pulumi.get(self, "eip_instance_id")
    ...
    @property
    @pulumi.getter(name="virtualNodeName")
    def virtual_node_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the virtual node. The length of the name is limited to `2` to `128` characters. It can contain uppercase and lowercase letters, Chinese characters, numbers, half-width colon (:), underscores (_), or hyphens (-), and must start with letters.
        """
        return pulumi.get(self, "virtual_node_name")
