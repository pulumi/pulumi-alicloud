...
class ContainerGroupAcrRegistryInfoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domains: The domain name of the ACR Enterprise Edition instance. Defaults to all domain names of the corresponding instance. Support specifying individual domain names, multiple separated by half comma.
        :param pulumi.Input[builtins.str] instance_id: The ACR enterprise edition example ID.
        :param pulumi.Input[builtins.str] instance_name: The name of the ACR enterprise edition instance.
        :param pulumi.Input[builtins.str] region_id: The ACR enterprise edition instance belongs to the region.
        """
...
if not MYPY:
    class ContainerGroupContainerArgsDict(TypedDict):
        ...
        """
        restart_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ContainerGroupContainerArgs:
    def __init__(__self__, *,
                 ...
                 restart_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] commands: Commands to be executed inside the container when performing health checks using the command line method.
        :param pulumi.Input[builtins.float] cpu: The amount of CPU resources allocated to the container. Default value: `0`.
        ...
        :param pulumi.Input[builtins.int] gpu: The number GPUs. Default value: `0`.
        :param pulumi.Input[builtins.str] image_pull_policy: The restart policy of the image. Default value: `IfNotPresent`. Valid values: `Always`, `IfNotPresent`, `Never`.
        ...
        :param pulumi.Input[builtins.float] memory: The amount of memory resources allocated to the container. Default value: `0`.
        ...
        :param pulumi.Input[builtins.bool] ready: Indicates whether the container passed the readiness probe.
        :param pulumi.Input[builtins.int] restart_count: The number of times that the container restarted.
    ...
    def restart_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of times that the container restarted.
        """
    ...
    def restart_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ContainerGroupContainerLivenessProbeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] failure_threshold: Threshold for the number of checks that are determined to have failed since the last successful check (must be consecutive failures), default is 3.
        :param pulumi.Input[Sequence[pulumi.Input['ContainerGroupContainerLivenessProbeHttpGetArgs']]] http_gets: Health check using HTTP request method. See `http_get` below.
               ...
               > **NOTE:** When you configure `readiness_probe`, you can select only one of the `exec`, `tcp_socket`, `http_get`.
        :param pulumi.Input[builtins.int] initial_delay_seconds: Check the time to start execution, calculated from the completion of container startup.
        :param pulumi.Input[builtins.int] period_seconds: Buffer time for the program to handle operations before closing.
        :param pulumi.Input[builtins.int] success_threshold: The check count threshold for re-identifying successful checks since the last failed check (must be consecutive successes), default is 1. Current must be 1.
        ...
        :param pulumi.Input[builtins.int] timeout_seconds: Check the timeout, the default is 1 second, the minimum is 1 second.
        """
...
class ContainerGroupContainerLivenessProbeHttpGetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] scheme: The protocol type corresponding to the HTTP Get request when using the HTTP request method for health checks. Valid values: `HTTP`, `HTTPS`.
        """
        if path is not None:
...
class ContainerGroupContainerSecurityContextArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] privileged: Specifies whether to give extended privileges to this container. Default value: `false`. Valid values: `true` and `false`.
        """
...
class ContainerGroupDnsConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] name_servers: The list of DNS server IP addresses.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] searches: The list of DNS lookup domains.
        """
...
class ContainerGroupHostAliasArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] hostnames: The information about the host.
        :param pulumi.Input[builtins.str] ip: The IP address of the host.
        """
...
class ContainerGroupImageRegistryCredentialArgs:
    def __init__(__self__, *,
                 ...
                 user_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] password: The password used to log on to the image repository. It is required when `image_registry_credential` is configured.
        :param pulumi.Input[builtins.str] server: The address of the image repository. It is required when `image_registry_credential` is configured.
        :param pulumi.Input[builtins.str] user_name: The username used to log on to the image repository. It is required when `image_registry_credential` is configured.
        """
...
class ContainerGroupVolumeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] flex_volume_fs_type: The type of the mounted file system. The default value is determined by the script of FlexVolume.
        :param pulumi.Input[builtins.str] flex_volume_options: The list of FlexVolume objects. Each object is a key-value pair contained in a JSON string.
        ...
        :param pulumi.Input[builtins.bool] nfs_volume_read_only: The nfs volume read only. Default value: `false`.
...
class ImageCacheImageRegistryCredentialArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] password: The password of the Image Registry.
        :param pulumi.Input[builtins.str] server: The address of Image Registry without `http://` or `https://`.
        :param pulumi.Input[builtins.str] user_name: The user name of Image Registry.
        """
...
class VirtualNodeTaintArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] effect: The effect of the taint. Valid values: `NoSchedule`, `NoExecute` and `PreferNoSchedule`.
        :param pulumi.Input[builtins.str] key: The key of the taint.
