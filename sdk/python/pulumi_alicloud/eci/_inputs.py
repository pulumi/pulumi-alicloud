...
class ContainerGroupAcrRegistryInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_name: The name of the ACR enterprise edition instance.
        :param pulumi.Input[_builtins.str] region_id: The ACR enterprise edition instance belongs to the region.
        """
...
class ContainerGroupContainerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] commands: Commands to be executed inside the container when performing health checks using the command line method.
        :param pulumi.Input[_builtins.float] cpu: The amount of CPU resources allocated to the container. Default value: `0`.
        ...
        :param pulumi.Input[_builtins.int] gpu: The number GPUs. Default value: `0`.
        :param pulumi.Input[_builtins.str] image_pull_policy: The restart policy of the image. Default value: `IfNotPresent`. Valid values: `Always`, `IfNotPresent`, `Never`.
        ...
        :param pulumi.Input[_builtins.float] memory: The amount of memory resources allocated to the container. Default value: `0`.
        ...
        :param pulumi.Input[_builtins.bool] ready: Indicates whether the container passed the readiness probe.
        :param pulumi.Input[_builtins.int] restart_count: The number of times that the container restarted.
...
class ContainerGroupContainerLivenessProbeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ContainerGroupContainerLivenessProbeHttpGetArgs']]] http_gets: Health check using HTTP request method. See `http_get` below.
               ...
               > **NOTE:** When you configure `readiness_probe`, you can select only one of the `exec`, `tcp_socket`, `http_get`.
        :param pulumi.Input[_builtins.int] initial_delay_seconds: Check the time to start execution, calculated from the completion of container startup.
        :param pulumi.Input[_builtins.int] period_seconds: Buffer time for the program to handle operations before closing.
        :param pulumi.Input[_builtins.int] success_threshold: The check count threshold for re-identifying successful checks since the last failed check (must be consecutive successes), default is 1. Current must be 1.
        ...
        :param pulumi.Input[_builtins.int] timeout_seconds: Check the timeout, the default is 1 second, the minimum is 1 second.
        """
...
class ContainerGroupDnsConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] searches: The list of DNS lookup domains.
        """
...
class ContainerGroupImageRegistryCredentialArgs:
    def __init__(__self__, *,
                 ...
                 user_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] password: The password used to log on to the image repository. It is required when `image_registry_credential` is configured.
        :param pulumi.Input[_builtins.str] server: The address of the image repository. It is required when `image_registry_credential` is configured.
        :param pulumi.Input[_builtins.str] user_name: The username used to log on to the image repository. It is required when `image_registry_credential` is configured.
        """
...
class ContainerGroupVolumeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] flex_volume_fs_type: The type of the mounted file system. The default value is determined by the script of FlexVolume.
        :param pulumi.Input[_builtins.str] flex_volume_options: The list of FlexVolume objects. Each object is a key-value pair contained in a JSON string.
        ...
        :param pulumi.Input[_builtins.bool] nfs_volume_read_only: The nfs volume read only. Default value: `false`.
...
class ImageCacheImageRegistryCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] user_name: The user name of Image Registry.
        """
