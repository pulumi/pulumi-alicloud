...
class ImageCacheArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] image_cache_name: The name of the image cache.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] images: The images to be cached. The image name must be versioned.
        :param pulumi.Input[builtins.str] security_group_id: The ID of the security group. You do not need to specify the same security group as the container group.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the VSwitch. You do not need to specify the same VSwitch as the container group.
        :param pulumi.Input[builtins.str] eip_instance_id: The instance ID of the Elastic IP Address (EIP). If you want to pull images from the Internet, you must specify an EIP to make sure that the container group can access the Internet. You can also configure the network address translation (NAT) gateway. We recommend that you configure the NAT gateway for the Internet access. Refer to [Public Network Access Method](https://help.aliyun.com/document_detail/99146.html)
        :param pulumi.Input[builtins.int] image_cache_size: The size of the image cache. Default to `20`. Unit: GiB.
        ...
        :param pulumi.Input[builtins.int] retention_days: The retention days of the image cache. Once the image cache expires, it will be cleared. By default, the image cache never expires. Note: The image cache that fails to be created is retained for only one day.
        :param pulumi.Input[builtins.str] zone_id: The zone id to cache image.
        """
...
class _ImageCacheState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] container_group_id: The ID of the container group job that is used to create the image cache.
        :param pulumi.Input[builtins.str] eip_instance_id: The instance ID of the Elastic IP Address (EIP). If you want to pull images from the Internet, you must specify an EIP to make sure that the container group can access the Internet. You can also configure the network address translation (NAT) gateway. We recommend that you configure the NAT gateway for the Internet access. Refer to [Public Network Access Method](https://help.aliyun.com/document_detail/99146.html)
        :param pulumi.Input[builtins.str] image_cache_name: The name of the image cache.
        :param pulumi.Input[builtins.int] image_cache_size: The size of the image cache. Default to `20`. Unit: GiB.
        :param pulumi.Input[Sequence[pulumi.Input['ImageCacheImageRegistryCredentialArgs']]] image_registry_credentials: The Image Registry parameters about the image to be cached. See `image_registry_credential` below.
        ...
        :param pulumi.Input[builtins.int] retention_days: The retention days of the image cache. Once the image cache expires, it will be cleared. By default, the image cache never expires. Note: The image cache that fails to be created is retained for only one day.
        :param pulumi.Input[builtins.str] security_group_id: The ID of the security group. You do not need to specify the same security group as the container group.
        :param pulumi.Input[builtins.str] status: The status of the image cache.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the VSwitch. You do not need to specify the same VSwitch as the container group.
        :param pulumi.Input[builtins.str] zone_id: The zone id to cache image.
        """
...
class ImageCache(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ImageCache':
        """
