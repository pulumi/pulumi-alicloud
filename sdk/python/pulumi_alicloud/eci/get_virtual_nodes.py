...
class GetVirtualNodesResult:
    ...
    def virtual_node_name(self) -> Optional[builtins.str]:
...
def get_virtual_nodes(ids: Optional[Sequence[builtins.str]] = None,
                      ...
                      virtual_node_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Virtual Node IDs.
    :param builtins.str name_regex: A regex string to filter results by Virtual Node name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str resource_group_id: The resource group ID. If when you create a GPU does not specify a resource group instance will automatically add the account's default resource group.
    :param builtins.str security_group_id: VNode itself and by VNode created (ECI) the security group used by.
    :param builtins.str status: The Status of the virtual node. Valid values: `Cleaned`, `Failed`, `Pending`, `Ready`.
...
def get_virtual_nodes_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             ...
                             virtual_node_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
