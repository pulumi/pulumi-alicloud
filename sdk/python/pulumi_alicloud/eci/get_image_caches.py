...
class GetImageCachesResult:
    ...
    def image_cache_name(self) -> Optional[_builtins.str]:
        """
...
def get_image_caches(ids: Optional[Sequence[_builtins.str]] = None,
                     image: Optional[_builtins.str] = None,
                     image_cache_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list ids of ECI Image Cache.
    :param _builtins.str image: Find the mirror cache containing it according to the image name.
    :param _builtins.str image_cache_name: The name of ECI Image Cache.
    :param _builtins.str name_regex: A regex string to filter results by the image cache name.
