...
class GetImageCachesResult:
    ...
    def image_cache_name(self) -> Optional[builtins.str]:
        """
...
def get_image_caches(ids: Optional[Sequence[builtins.str]] = None,
                     image: Optional[builtins.str] = None,
                     image_cache_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list ids of ECI Image Cache.
    :param builtins.str image: Find the mirror cache containing it according to the image name.
    :param builtins.str image_cache_name: The name of ECI Image Cache.
    :param builtins.str name_regex: A regex string to filter results by the image cache name.
...
def get_image_caches_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                            image: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            image_cache_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetImageCachesResult(
        ...
        image_cache_name=pulumi.get(__response__, 'image_cache_name'),
