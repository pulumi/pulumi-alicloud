...
class VvpInstanceArgs:
    def __init__(__self__, *,
                 ...
                 vvp_instance_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] vpc_id: The VPC ID of the user.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vswitch_ids: Virtual Switch ID.
        :param pulumi.Input[builtins.str] vvp_instance_name: The name of the workspace.
        :param pulumi.Input[builtins.str] zone_id: The zone ID of the resource.
        :param pulumi.Input[builtins.int] duration: The number of subscription periods. If the payment type is PRE, this parameter is required.
        :param pulumi.Input[builtins.str] pricing_cycle: The subscription period. If the payment type is PRE, this parameter is required.
        :param pulumi.Input[builtins.str] resource_group_id: The resource group to which the newly purchased instance belongs.
    ...
    def vvp_instance_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vvp_instance_name(self, value: pulumi.Input[builtins.str]):
...
class _VvpInstanceState:
    def __init__(__self__, *,
                 ...
                 vvp_instance_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="vvpInstanceName")
    def vvp_instance_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the workspace.
        """
        return pulumi.get(self, "vvp_instance_name")
    ...
    @vvp_instance_name.setter
    def vvp_instance_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vvp_instance_name", value)
...
@pulumi.type_token("alicloud:realtimecompute/vvpInstance:VvpInstance")
class VvpInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vswitch_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            vvp_instance_name: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VvpInstance':
        """
    ...
    @property
    @pulumi.getter(name="vvpInstanceName")
    def vvp_instance_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the workspace.
        """
        return pulumi.get(self, "vvp_instance_name")
