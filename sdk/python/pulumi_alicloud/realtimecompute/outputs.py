...
class VvpInstanceResourceSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 memory_gb: Optional[builtins.int] = None):
        """
        :param builtins.int cpu: CPU number.
        :param builtins.int memory_gb: Memory size.
        """
        if cpu is not None:
    ...
    def memory_gb(self) -> Optional[builtins.int]:
        """
        Memory size.
        """
...
class VvpInstanceStorageOss(dict):
    def __init__(__self__, *,
                 bucket: builtins.str):
        """
        :param builtins.str bucket: OSS Bucket name.
        """
