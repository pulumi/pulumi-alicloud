...
if not MYPY:
    class VvpInstanceResourceSpecArgsDict(TypedDict):
        ...
        CPU number.
        """
        memory_gb: NotRequired[pulumi.Input[builtins.int]]
        """
        Memory size.
        """
elif False:
...
class VvpInstanceResourceSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] cpu: CPU number.
        :param pulumi.Input[builtins.int] memory_gb: Memory size.
        """
        if cpu is not None:
...
class VvpInstanceStorageOssArgs:
    def __init__(__self__, *,
                 bucket: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] bucket: OSS Bucket name.
        """
