...
class DbInstanceArgs:
    def __init__(__self__, *,
                 cache_size: pulumi.Input[builtins.int],
                 db_instance_class: pulumi.Input[builtins.str],
                 db_instance_description: pulumi.Input[builtins.str],
                 ...
                 upgraded_engine_minor_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DbInstance resource.
        :param pulumi.Input[builtins.int] cache_size: The cache size in DBInstance on creating default cluster. The number should be divided by 100.
        :param pulumi.Input[builtins.str] db_instance_class: The class for default cluster in DBInstance. db_cluster_class has a range of class from `selectdb.xlarge` to `selectdb.256xlarge`.
        ...
        :param pulumi.Input[builtins.str] upgraded_engine_minor_version: The DBInstance minor version want to upgraded to.
        """
    ...
    def cache_size(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @cache_size.setter
    def cache_size(self, value: pulumi.Input[builtins.int]):
    ...
    def db_instance_description(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_instance_description(self, value: pulumi.Input[builtins.str]):
    ...
    def period_time(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @period_time.setter
    def period_time(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def upgraded_engine_minor_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DbInstanceState:
    def __init__(__self__, *,
                 ...
                 cache_size_postpaid: Optional[pulumi.Input[builtins.int]] = None,
                 cache_size_prepaid: Optional[pulumi.Input[builtins.int]] = None,
                 cluster_count_postpaid: Optional[pulumi.Input[builtins.int]] = None,
                 cluster_count_prepaid: Optional[pulumi.Input[builtins.int]] = None,
                 cpu_postpaid: Optional[pulumi.Input[builtins.int]] = None,
                 cpu_prepaid: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 gmt_expired: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 memory_postpaid: Optional[pulumi.Input[builtins.int]] = None,
                 memory_prepaid: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] cache_size: The cache size in DBInstance on creating default cluster. The number should be divided by 100.
        :param pulumi.Input[builtins.int] cache_size_postpaid: The sum of cache size for every `PayAsYouGo` clusters in DBInstance.
        :param pulumi.Input[builtins.int] cache_size_prepaid: The sum of cache size for every `Subscription` clusters in DBInstance.
        :param pulumi.Input[builtins.int] cluster_count_postpaid: The sum of cluster counts for `PayAsYouGo` clusters in DBInstance.
        :param pulumi.Input[builtins.int] cluster_count_prepaid: The sum of cluster counts for `Subscription` clusters in DBInstance.
        :param pulumi.Input[builtins.int] cpu_postpaid: The sum of cpu resource amount for every `PayAsYouGo` clusters in DBInstance.
        :param pulumi.Input[builtins.int] cpu_prepaid: The sum of cpu resource amount for every `Subscription` clusters in DBInstance.
        :param pulumi.Input[builtins.str] db_instance_class: The class for default cluster in DBInstance. db_cluster_class has a range of class from `selectdb.xlarge` to `selectdb.256xlarge`.
        :param pulumi.Input[builtins.str] db_instance_description: The DBInstance description.
        :param pulumi.Input[Sequence[pulumi.Input['DbInstanceDesiredSecurityIpListArgs']]] desired_security_ip_lists: The modified IP address whitelists. See `desired_security_ip_lists` below.
        :param pulumi.Input[builtins.bool] enable_public_network: If DBInstance need to open public network, set it to `true`.
        ...
        :param pulumi.Input[builtins.str] lock_mode: The lock mode of the instance. Set the value to lock, which specifies that the instance is locked when it automatically expires or has an overdue payment.
        :param pulumi.Input[builtins.str] lock_reason: The reason why the instance is locked.
        :param pulumi.Input[builtins.int] memory_postpaid: The sum of memory resource amount offor every `PayAsYouGo` clusters in DBInstance.
        :param pulumi.Input[builtins.int] memory_prepaid: The sum of memory resource amount offor every `Subscription` clusters in DBInstance.
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource. Valid values: `PayAsYouGo`,`Subscription`.
        :param pulumi.Input[builtins.str] period: It is valid when payment_type is `Subscription`. Valid values are `Year`, `Month`.
        :param pulumi.Input[builtins.int] period_time: The duration that you will buy DBInstance. It is valid when payment_type is `Subscription`. Valid values: [1~9], 12, 24, 36.
        :param pulumi.Input[builtins.str] region_id: The region ID of the instance.
        ...
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid values: `ACTIVE`,`STOPPED`,`STARTING`,`RESTART`.
        :param pulumi.Input[builtins.str] sub_domain: The sub domain of DBInstance.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
               - Key: It can be up to 64 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It cannot be a null string.
               - Value: It can be up to 128 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It can be a null string.
        :param pulumi.Input[builtins.str] upgraded_engine_minor_version: The DBInstance minor version want to upgraded to.
    ...
    def cache_size_postpaid(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cache_size_postpaid(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cache_size_postpaid", value)

    @property
    @pulumi.getter(name="cacheSizePrepaid")
    def cache_size_prepaid(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cache_size_prepaid(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cache_size_prepaid", value)

    @property
    @pulumi.getter(name="clusterCountPostpaid")
    def cluster_count_postpaid(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cluster_count_postpaid(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cluster_count_postpaid", value)

    @property
    @pulumi.getter(name="clusterCountPrepaid")
    def cluster_count_prepaid(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cluster_count_prepaid(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cluster_count_prepaid", value)

    @property
    @pulumi.getter(name="cpuPostpaid")
    def cpu_postpaid(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @cpu_postpaid.setter
    def cpu_postpaid(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cpu_postpaid", value)

    @property
    @pulumi.getter(name="cpuPrepaid")
    def cpu_prepaid(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @cpu_prepaid.setter
    def cpu_prepaid(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def gmt_expired(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @gmt_expired.setter
    def gmt_expired(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def memory_postpaid(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def memory_postpaid(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "memory_postpaid", value)

    @property
    @pulumi.getter(name="memoryPrepaid")
    def memory_prepaid(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def memory_prepaid(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DbInstance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="cacheSizePostpaid")
    def cache_size_postpaid(self) -> pulumi.Output[builtins.int]:
        """
        The sum of cache size for every `PayAsYouGo` clusters in DBInstance.
        """
        return pulumi.get(self, "cache_size_postpaid")
    ...
    @property
    @pulumi.getter(name="cacheSizePrepaid")
    def cache_size_prepaid(self) -> pulumi.Output[builtins.int]:
        """
        The sum of cache size for every `Subscription` clusters in DBInstance.
        """
        return pulumi.get(self, "cache_size_prepaid")
    ...
    @property
    @pulumi.getter(name="clusterCountPostpaid")
    def cluster_count_postpaid(self) -> pulumi.Output[builtins.int]:
        """
        The sum of cluster counts for `PayAsYouGo` clusters in DBInstance.
        """
        return pulumi.get(self, "cluster_count_postpaid")
    ...
    @property
    @pulumi.getter(name="clusterCountPrepaid")
    def cluster_count_prepaid(self) -> pulumi.Output[builtins.int]:
        """
        The sum of cluster counts for `Subscription` clusters in DBInstance.
        """
        return pulumi.get(self, "cluster_count_prepaid")
    ...
    @property
    @pulumi.getter(name="cpuPostpaid")
    def cpu_postpaid(self) -> pulumi.Output[builtins.int]:
        """
        The sum of cpu resource amount for every `PayAsYouGo` clusters in DBInstance.
        """
        return pulumi.get(self, "cpu_postpaid")
    ...
    @property
    @pulumi.getter(name="cpuPrepaid")
    def cpu_prepaid(self) -> pulumi.Output[builtins.int]:
        """
        The sum of cpu resource amount for every `Subscription` clusters in DBInstance.
        """
        return pulumi.get(self, "cpu_prepaid")
    ...
    @property
    @pulumi.getter(name="enablePublicNetwork")
    def enable_public_network(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If DBInstance need to open public network, set it to `true`.
        """
        return pulumi.get(self, "enable_public_network")
    ...
    @property
    @pulumi.getter(name="gmtCreated")
    def gmt_created(self) -> pulumi.Output[builtins.str]:
        """
        The time when DBInstance is created.
        """
        return pulumi.get(self, "gmt_created")
    ...
    @property
    @pulumi.getter(name="gmtExpired")
    def gmt_expired(self) -> pulumi.Output[builtins.str]:
        """
        The time when DBInstance will be expired. Available on `Subscription` DBInstance.
        """
        return pulumi.get(self, "gmt_expired")
    ...
    @property
    @pulumi.getter(name="lockMode")
    def lock_mode(self) -> pulumi.Output[builtins.str]:
        """
        The lock mode of the instance. Set the value to lock, which specifies that the instance is locked when it automatically expires or has an overdue payment.
        """
        return pulumi.get(self, "lock_mode")
    ...
    @property
    @pulumi.getter(name="memoryPostpaid")
    def memory_postpaid(self) -> pulumi.Output[builtins.int]:
        """
        The sum of memory resource amount offor every `PayAsYouGo` clusters in DBInstance.
        """
        return pulumi.get(self, "memory_postpaid")
    ...
    @property
    @pulumi.getter(name="memoryPrepaid")
    def memory_prepaid(self) -> pulumi.Output[builtins.int]:
        """
        The sum of memory resource amount offor every `Subscription` clusters in DBInstance.
        """
        return pulumi.get(self, "memory_prepaid")
    ...
    @property
    @pulumi.getter(name="periodTime")
    def period_time(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The duration that you will buy DBInstance. It is valid when payment_type is `Subscription`. Valid values: [1~9], 12, 24, 36.
        """
        return pulumi.get(self, "period_time")
