...
class DbClusterArgs:
    def __init__(__self__, *,
                 ...
                 db_cluster_description: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.int] cache_size: The desired cache size on creating cluster. The number should be divided by 100.
        :param pulumi.Input[builtins.str] db_cluster_class: The DBCluster class. db_cluster_class has a range of class from `selectdb.xlarge` to `selectdb.256xlarge`.
        :param pulumi.Input[builtins.str] db_cluster_description: The DBCluster description.
        :param pulumi.Input[builtins.str] db_instance_id: The InstanceId of DBInstance for DBCluster. Every DBCluster requires one DBInstance to rely on.
        ...
        :param pulumi.Input[builtins.str] desired_status: The desired status for the resource. Valid values: `ACTIVATION`,`STOPPED`,`STARTING`,`RESTART`.
        """
    ...
    def db_cluster_description(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_cluster_description(self, value: pulumi.Input[builtins.str]):
...
class _DbClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] cache_size: The desired cache size on creating cluster. The number should be divided by 100.
        :param pulumi.Input[builtins.int] cpu: The cpu resource amount of DBCluster. Depends on `db_cluster_class`.
        :param pulumi.Input[builtins.str] create_time: The time when DBCluster is created.
        :param pulumi.Input[builtins.str] db_cluster_class: The DBCluster class. db_cluster_class has a range of class from `selectdb.xlarge` to `selectdb.256xlarge`.
        :param pulumi.Input[builtins.str] db_cluster_description: The DBCluster description.
        :param pulumi.Input[builtins.str] db_cluster_id: The id of the cluster.
        :param pulumi.Input[builtins.str] db_instance_id: The InstanceId of DBInstance for DBCluster. Every DBCluster requires one DBInstance to rely on.
        :param pulumi.Input[Sequence[pulumi.Input['DbClusterDesiredParamArgs']]] desired_params: The modified parameter in DBCluster. See `desired_params` below.
        :param pulumi.Input[builtins.str] desired_status: The desired status for the resource. Valid values: `ACTIVATION`,`STOPPED`,`STARTING`,`RESTART`.
        :param pulumi.Input[builtins.str] engine: The engine of DBCluster. Always `selectdb`.
        :param pulumi.Input[builtins.str] engine_version: The version of DBCluster.
        :param pulumi.Input[builtins.int] memory: The memory resource amount of DBCluster. Depends on `db_cluster_class`.
        ...
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource. Valid values: `PayAsYouGo`,`Subscription`.
        :param pulumi.Input[builtins.str] region_id: The ID of region for the cluster.
        :param pulumi.Input[builtins.str] status: The current status of the resource.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC for the cluster.
        :param pulumi.Input[builtins.str] zone_id: The ID of zone for the cluster.
        """
...
class DbCluster(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:selectdb/dbCluster:DbCluster"
