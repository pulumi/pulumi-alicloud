...
class DbClusterParamChangeLogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] gmt_modified: When the parameter change is modified.
        :param pulumi.Input[_builtins.bool] is_applied: Whether the parameter changing is applied.
        :param pulumi.Input[_builtins.str] name: Changed parameter name.
        :param pulumi.Input[_builtins.str] new_value: The new value of parameter.
        :param pulumi.Input[_builtins.str] old_value: The old value of parameter.
        """
...
class DbInstanceInstanceNetInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] net_type: The network type of the instance.
        ...
        :param pulumi.Input[_builtins.str] vpc_instance_id: The VPC ID.
...
class DbInstanceSecurityIpListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] list_net_type: The network type of Security group.
        :param pulumi.Input[_builtins.str] security_ip_list: The IP list of Security group. Each single IP value should be Separated by comma.
        :param pulumi.Input[_builtins.str] security_ip_type: The IP address type. Valid values: `ipv4`, `ipv6` (not supported).
        """
        if group_name is not None:
            pulumi.set(__self__, "group_name", group_name)
