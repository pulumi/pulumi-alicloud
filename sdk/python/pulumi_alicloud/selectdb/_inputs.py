...
class DbClusterDesiredParamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: The new value of Parameter.
        """
        if name is not None:
...
if not MYPY:
    class DbClusterParamChangeLogArgsDict(TypedDict):
        config_id: NotRequired[pulumi.Input[builtins.int]]
        """
        The id of parameter change.
        """
        gmt_created: NotRequired[pulumi.Input[builtins.str]]
        """
        When the parameter change is created.
        """
        gmt_modified: NotRequired[pulumi.Input[builtins.str]]
        """
        When the parameter change is modified.
        """
        is_applied: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        new_value: NotRequired[pulumi.Input[builtins.str]]
        """
        The new value of parameter.
        """
        old_value: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DbClusterParamChangeLogArgs:
    def __init__(__self__, *,
                 ...
                 gmt_created: Optional[pulumi.Input[builtins.str]] = None,
                 gmt_modified: Optional[pulumi.Input[builtins.str]] = None,
                 is_applied: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 new_value: Optional[pulumi.Input[builtins.str]] = None,
                 old_value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] config_id: The id of parameter change.
        :param pulumi.Input[builtins.str] gmt_created: When the parameter change is created.
        :param pulumi.Input[builtins.str] gmt_modified: When the parameter change is modified.
        :param pulumi.Input[builtins.bool] is_applied: Whether the parameter changing is applied.
        :param pulumi.Input[builtins.str] name: Changed parameter name.
        :param pulumi.Input[builtins.str] new_value: The new value of parameter.
        :param pulumi.Input[builtins.str] old_value: The old value of parameter.
        """
    ...
    def gmt_created(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        When the parameter change is created.
        """
    ...
    @gmt_created.setter
    def gmt_created(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "gmt_created", value)

    @property
    @pulumi.getter(name="gmtModified")
    def gmt_modified(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        When the parameter change is modified.
        """
    ...
    @gmt_modified.setter
    def gmt_modified(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "gmt_modified", value)

    @property
    @pulumi.getter(name="isApplied")
    def is_applied(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the parameter changing is applied.
        """
    ...
    @is_applied.setter
    def is_applied(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def new_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The new value of parameter.
        """
    ...
    @new_value.setter
    def new_value(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "new_value", value)

    @property
    @pulumi.getter(name="oldValue")
    def old_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The old value of parameter.
        """
    ...
    @old_value.setter
    def old_value(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DbInstanceDesiredSecurityIpListArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] group_name: Security group name.
        :param pulumi.Input[builtins.str] security_ip_list: The IP list of Security group. Each single IP value should be Separated by comma.
        """
...
if not MYPY:
    class DbInstanceInstanceNetInfoArgsDict(TypedDict):
        ...
        """
        db_ip: NotRequired[pulumi.Input[builtins.str]]
        """
        The IP address of the instance.
        """
        net_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        vpc_instance_id: NotRequired[pulumi.Input[builtins.str]]
        """
        The VPC ID.
        """
...
class DbInstanceInstanceNetInfoArgs:
    def __init__(__self__, *,
                 ...
                 db_ip: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 vpc_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 vswitch_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] connection_string: The connection string of the instance.
        :param pulumi.Input[builtins.str] db_ip: The IP address of the instance.
        :param pulumi.Input[builtins.str] net_type: The network type of the instance.
        ...
        :param pulumi.Input[builtins.str] vpc_instance_id: The VPC ID.
    ...
    def db_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IP address of the instance.
        """
    ...
    @db_ip.setter
    def db_ip(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vpc_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The VPC ID.
        """
    ...
    def vpc_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DbInstanceInstanceNetInfoPortListArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] port: The port that is used to connect.
        :param pulumi.Input[builtins.str] protocol: The protocol of the port.
        """
        if port is not None:
...
if not MYPY:
    class DbInstanceSecurityIpListArgsDict(TypedDict):
        ...
        Security group name.
        """
        group_tag: NotRequired[pulumi.Input[builtins.str]]
        """
        The tag of Security group.
        """
        list_net_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        The IP list of Security group. Each single IP value should be Separated by comma.
        """
        security_ip_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DbInstanceSecurityIpListArgs:
    def __init__(__self__, *,
                 ...
                 list_net_type: Optional[pulumi.Input[builtins.str]] = None,
                 security_ip_list: Optional[pulumi.Input[builtins.str]] = None,
                 security_ip_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] group_name: Security group name.
        :param pulumi.Input[builtins.str] group_tag: The tag of Security group.
        :param pulumi.Input[builtins.str] list_net_type: The network type of Security group.
        :param pulumi.Input[builtins.str] security_ip_list: The IP list of Security group. Each single IP value should be Separated by comma.
        :param pulumi.Input[builtins.str] security_ip_type: The IP address type. Valid values: `ipv4`, `ipv6` (not supported).
        """
        if group_name is not None:
            pulumi.set(__self__, "group_name", group_name)
    ...
    def list_net_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The network type of Security group.
        """
    ...
    def list_net_type(self, value: Optional[pulumi.Input[builtins.str]]):
