...
def get_db_instances(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of DBInstance IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param Mapping[str, builtins.str] tags: A mapping of tags to assign to the resource. Used for instance searching.
...
def get_db_instances_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
