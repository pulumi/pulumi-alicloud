...
def get_regions(current: Optional[builtins.bool] = None,
    ...
    :param builtins.bool current: Set to true to match only the region configured in the provider.
    :param builtins.str name: The name of the region to select, such as `eu-central-1`.
