...
def get_regions(current: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool current: Set to true to match only the region configured in the provider.
    :param _builtins.str name: The name of the region to select, such as `eu-central-1`.
