...
def get_stores(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of store IDs.
    :param builtins.str name_regex: A regex string to filter results by store name.
...
def get_stores_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
