...
def get_stores(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of store IDs.
    :param _builtins.str name_regex: A regex string to filter results by store name.
...
def get_stores_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
