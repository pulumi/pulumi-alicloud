...
class AlertAnnotation(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: Annotations's key for new alert.
        :param builtins.str value: Annotations's value for new alert.
        """
...
class AlertGroupConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Group configuration type, including no_group, labels_auto, custom.
        """
...
class AlertJoinConfiguration(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str condition: Join condition.
        :param builtins.str type: Join type, including cross_join, inner_join, left_join, right_join, full_join, left_exclude, right_exclude, concat, no_join.
        """
...
class AlertLabel(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: Labels's key for new alert.
        :param builtins.str value: Labels's value for new alert.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class AlertNotificationList(dict):
    ...
    def __init__(__self__, *,
                 ...
                 mobile_lists: Optional[Sequence[builtins.str]] = None,
                 service_uri: Optional[builtins.str] = None):
        """
        :param builtins.str content: Notice content of alarm.
        :param builtins.str type: Notification type. support Email, SMS, DingTalk, MessageCenter.
        :param Sequence[builtins.str] email_lists: Email address list.
        :param Sequence[builtins.str] mobile_lists: SMS sending mobile number.
        :param builtins.str service_uri: Request address.
        """
    ...
    def mobile_lists(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AlertPolicyConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str alert_policy_id: Alert Policy Id.
        :param builtins.str repeat_interval: Repeat interval used by alert policy, 1h, 1m.e.g.
        :param builtins.str action_policy_id: Action Policy Id.
        """
...
class AlertQueryList(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str end: End time. example: 20s.
        :param builtins.str query: Query corresponding to chart. example: * AND aliyun.
        :param builtins.str start: Begin time. example: -60s.
        :param builtins.str chart_title: Chart title, optional from 1.161.0+.
        :param builtins.str dashboard_id: Query dashboard id.
        :param builtins.str logstore: Query logstore, use store for new alert, Deprecated from 1.161.0+.
        :param builtins.str power_sql_mode: default disable, whether to use power sql. support auto, enable, disable.
        :param builtins.str project: Query project.
        :param builtins.str region: Query project region.
        :param builtins.str role_arn: Query project store's ARN.
        :param builtins.str store: Query store for new alert.
        :param builtins.str store_type: Query store type for new alert, including log,metric,meta.
        :param builtins.str time_span_type: default Custom. No need to configure this parameter.
        """
...
class AlertSchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: including FixedRate,Hourly,Daily,Weekly,Cron.
        :param builtins.str cron_expression: Cron expression when type is Cron.
        :param builtins.int day_of_week: Day of week when type is Weekly, including 0,1,2,3,4,5,6, 0 for Sunday, 1 for Monday
        :param builtins.int hour: Hour of day when type is Weekly/Daily.
        :param builtins.str interval: Execution interval. 60 seconds minimum, such as 60s, 1h. used when type is FixedRate.
        :param builtins.str time_zone: Time zone for schedule.
        """
        pulumi.set(__self__, "type", type)
...
class AlertSeverityConfiguration(dict):
    ...
    def __init__(__self__, *,
                 eval_condition: Mapping[str, builtins.str],
                 severity: builtins.int):
        """
        :param Mapping[str, builtins.str] eval_condition: Severity when this condition is met.
        :param builtins.int severity: Severity for new alert, including 2,4,6,8,10 for Report,Low,Medium,High,Critical.
        """
    ...
    def eval_condition(self) -> Mapping[str, builtins.str]:
        """
...
class AlertTemplateConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: Alert template id.
        :param builtins.str type: Alert template type including `sys`, `user`.
        :param Mapping[str, builtins.str] annotations: Alert template annotations.
        :param builtins.str lang: Alert template language including `cn`, `en`.
        :param Mapping[str, builtins.str] tokens: Alert template tokens.
        """
...
class EtlEtlSink(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_encrypted_access_key_id: Optional[builtins.str] = None,
                 kms_encrypted_access_key_secret: Optional[builtins.str] = None,
                 role_arn: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str endpoint: Delivery target logstore region.
        :param builtins.str logstore: Delivery target logstore.
        :param builtins.str name: Delivery target name.
        :param builtins.str project: The project where the target logstore is delivered.
        :param builtins.str access_key_id: Delivery target logstore access key id.
        :param builtins.str access_key_secret: Delivery target logstore access key secret.
        :param builtins.str kms_encrypted_access_key_id: An KMS encrypts access key id used to a log etl job. If the `access_key_id` is filled in, this field will be ignored.
        :param builtins.str kms_encrypted_access_key_secret: An KMS encrypts access key secret used to a log etl job. If the `access_key_secret` is filled in, this field will be ignored.
        :param builtins.str role_arn: Sts role info under delivery target logstore. `role_arn` and `(access_key_id, access_key_secret)` fill in at most one. If you do not fill in both, then you must fill in `(kms_encrypted_access_key_id, kms_encrypted_access_key_secret, kms_encryption_access_key_id_context, kms_encryption_access_key_secret_context)` to use KMS to get the key pair.
        :param builtins.str type: ETL sinks type, the default value is AliyunLOG.
    ...
    def kms_encrypted_access_key_id(self) -> Optional[builtins.str]:
        """
    ...
    def kms_encrypted_access_key_secret(self) -> Optional[builtins.str]:
        """
...
class OssExportConfigColumn(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str type: Type of configuration name.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class StoreEncryptConf(dict):
    ...
    def __init__(__self__, *,
                 ...
                 encrypt_type: Optional[builtins.str] = None,
                 user_cmk_info: Optional['outputs.StoreEncryptConfUserCmkInfo'] = None):
        """
        :param builtins.bool enable: Enable encryption. Default false.
        :param builtins.str encrypt_type: Supported encryption type, only supports `default`(AES), `m4`.
    ...
    def encrypt_type(self) -> Optional[builtins.str]:
        """
...
class StoreEncryptConfUserCmkInfo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cmk_key_id: Optional[builtins.str] = None,
                 region_id: Optional[builtins.str] = None):
        """
        :param builtins.str arn: Role arn.
        :param builtins.str cmk_key_id: User master key id.
        :param builtins.str region_id: Region id where the user master key id is located.
        """
        if arn is not None:
    ...
    def cmk_key_id(self) -> Optional[builtins.str]:
        """
        User master key id.
        """
...
class StoreIndexFieldSearch(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str name: The field name, which is unique in the same log store.
        :param builtins.str alias: The alias of one field
        :param builtins.bool case_sensitive: Whether the case sensitive for the field. Default to false. It is valid when "type" is "text" or "json".
        :param builtins.bool enable_analytics: Whether to enable field analytics. Default to true.
        :param builtins.bool include_chinese: Whether includes the chinese for the field. Default to false. It is valid when "type" is "text" or "json".
        :param Sequence['StoreIndexFieldSearchJsonKeyArgs'] json_keys: Use nested index when type is json
        :param builtins.str token: The string of several split words, like "\\r", "#". It is valid when "type" is "text" or "json".
        :param builtins.str type: The type of one field. Valid values: ["long", "text", "double", "json"]. Default to "long".
        """
        pulumi.set(__self__, "name", name)
...
class StoreIndexFieldSearchJsonKey(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 alias: Optional[builtins.str] = None,
                 doc_value: Optional[builtins.bool] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str name: When using the json_keys field, this field is required.
        :param builtins.str alias: The alias of one field.
        :param builtins.bool doc_value: Whether to enable statistics. default to true.
               
               > **Note:** At least one of the "full_text" and "field_search" should be specified.
        :param builtins.str type: The type of one field. Valid values: ["long", "text", "double"]. Default to "long"
        """
        pulumi.set(__self__, "name", name)
        if alias is not None:
            pulumi.set(__self__, "alias", alias)
    ...
    def doc_value(self) -> Optional[builtins.bool]:
        """
...
class StoreIndexFullText(dict):
    ...
    def __init__(__self__, *,
                 ...
                 token: Optional[builtins.str] = None):
        """
        :param builtins.bool case_sensitive: Whether the case sensitive. Default to false.
        :param builtins.bool include_chinese: Whether includes the chinese. Default to false.
        :param builtins.str token: The string of several split words, like "\\r", "#"
        """
        if case_sensitive is not None:
            pulumi.set(__self__, "case_sensitive", case_sensitive)
        if include_chinese is not None:
...
class StoreShard(dict):
    ...
    def __init__(__self__, *,
                 begin_key: Optional[builtins.str] = None,
                 end_key: Optional[builtins.str] = None,
                 id: Optional[builtins.int] = None,
                 status: Optional[builtins.str] = None):
        """
        :param builtins.str begin_key: The begin value of the shard range(MD5), included in the shard range.
        :param builtins.str end_key: The end value of the shard range(MD5), not included in shard range.
        :param builtins.int id: The ID of the shard.
        :param builtins.str status: Shard status, only two status of `readwrite` and `readonly`.
        """
    ...
    def begin_key(self) -> Optional[builtins.str]:
        """
    ...
    def end_key(self) -> Optional[builtins.str]:
        """
...
class GetProjectsProjectResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str last_modify_time: The last modify time of project.
        :param builtins.str owner: The owner of project.
        :param builtins.str policy: The policy of project.
        :param builtins.str project_name: The name of the project.
        :param builtins.str region: The region of project.
        :param builtins.str status: The status of project.
        """
...
class GetStoresStoreResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str store_name: The name of the store.
        """
        pulumi.set(__self__, "id", id)
