...
def get_alert_resource(lang: Optional[builtins.str] = None,
...
def get_alert_resource_output(lang: Optional[pulumi.Input[Optional[builtins.str]]] = None,
