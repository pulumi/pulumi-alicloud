...
class DashboardArgs:
    def __init__(__self__, *,
                 char_list: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] char_list: Configuration of charts in the dashboard.
               **Note:** From version 1.164.0, `char_list` can set parameter "action".
        :param pulumi.Input[builtins.str] dashboard_name: The name of the Log Dashboard.
        :param pulumi.Input[builtins.str] project_name: The name of the log project. It is the only in one Alicloud account.
        :param pulumi.Input[builtins.str] attribute: Dashboard attribute.
        :param pulumi.Input[builtins.str] display_name: Dashboard alias.
        """
    ...
    def char_list(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @char_list.setter
    def char_list(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "char_list", value)

    @property
    @pulumi.getter(name="dashboardName")
    def dashboard_name(self) -> pulumi.Input[builtins.str]:
        """
...
class _DashboardState:
    def __init__(__self__, *,
                 attribute: Optional[pulumi.Input[builtins.str]] = None,
                 char_list: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="charList")
    def char_list(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Configuration of charts in the dashboard.
        **Note:** From version 1.164.0, `char_list` can set parameter "action".
        """
    ...
    @char_list.setter
    def char_list(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "char_list", value)
...
class Dashboard(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            dashboard_name: Optional[pulumi.Input[builtins.str]] = None,
            display_name: Optional[pulumi.Input[builtins.str]] = None,
            project_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Dashboard':
        """
    ...
    @property
    @pulumi.getter
    def attribute(self) -> pulumi.Output[builtins.str]:
        """
        Dashboard attribute.
        """
        return pulumi.get(self, "attribute")
    ...
    @property
    @pulumi.getter(name="charList")
    def char_list(self) -> pulumi.Output[builtins.str]:
        """
        Configuration of charts in the dashboard.
        **Note:** From version 1.164.0, `char_list` can set parameter "action".
        """
