...
class IngestionArgs:
    def __init__(__self__, *,
                 ...
                 ingestion_name: pulumi.Input[builtins.str],
                 interval: pulumi.Input[builtins.str],
                 logstore: pulumi.Input[builtins.str],
                 project: pulumi.Input[builtins.str],
                 run_immediately: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.str] display_name: The name displayed on the web page.
        :param pulumi.Input[builtins.str] ingestion_name: Ingestion job name, it can only contain lowercase letters, numbers, dashes `-` and underscores `_`. It must start and end with lowercase letters or numbers, and the name must be 2 to 128 characters long.
        :param pulumi.Input[builtins.str] interval: Task execution interval, support minute `m`, hour `h`, day `d`, for example 30 minutes `30m`.
        :param pulumi.Input[builtins.str] logstore: The name of the target logstore.
        :param pulumi.Input[builtins.str] project: The name of the log project. It is the only in one Alicloud account.
        :param pulumi.Input[builtins.bool] run_immediately: Whether to run the ingestion job immediately, if false, wait for an interval before starting the ingestion.
        :param pulumi.Input[builtins.str] source: Data source and data format details. [Refer to details](https://www.alibabacloud.com/help/en/doc-detail/147819.html).
        :param pulumi.Input[builtins.str] description: Ingestion job description.
        :param pulumi.Input[builtins.str] time_zone: Which time zone is the log time imported in, e.g. `+0800`.
        """
    ...
    def ingestion_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ingestion_name(self, value: pulumi.Input[builtins.str]):
    ...
    def run_immediately(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def run_immediately(self, value: pulumi.Input[builtins.bool]):
...
class _IngestionState:
    def __init__(__self__, *,
                 ...
                 ingestion_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="ingestionName")
    def ingestion_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Ingestion job name, it can only contain lowercase letters, numbers, dashes `-` and underscores `_`. It must start and end with lowercase letters or numbers, and the name must be 2 to 128 characters long.
        """
        return pulumi.get(self, "ingestion_name")
    ...
    @ingestion_name.setter
    def ingestion_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ingestion_name", value)
...
class Ingestion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            run_immediately: Optional[pulumi.Input[builtins.bool]] = None,
            source: Optional[pulumi.Input[builtins.str]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None) -> 'Ingestion':
        """
    ...
    @property
    @pulumi.getter(name="ingestionName")
    def ingestion_name(self) -> pulumi.Output[builtins.str]:
        """
        Ingestion job name, it can only contain lowercase letters, numbers, dashes `-` and underscores `_`. It must start and end with lowercase letters or numbers, and the name must be 2 to 128 characters long.
        """
        return pulumi.get(self, "ingestion_name")
    ...
    @property
    @pulumi.getter(name="runImmediately")
    def run_immediately(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to run the ingestion job immediately, if false, wait for an interval before starting the ingestion.
        """
        return pulumi.get(self, "run_immediately")
