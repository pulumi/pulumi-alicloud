...
class OssExportArgs:
    def __init__(__self__, *,
                 ...
                 export_name: pulumi.Input[builtins.str],
                 ...
                 log_read_role_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] bucket: The name of the oss bucket.
        ...
        :param pulumi.Input[builtins.str] content_type: Storage format, only supports three types: `json`, `parquet`, `orc`, `csv`.
               **According to the different format, please select the following parameters**
        :param pulumi.Input[builtins.str] export_name: Delivery configuration name, it can only contain lowercase letters, numbers, dashes `-` and underscores `_`. It must start and end with lowercase letters or numbers, and the name must be 2 to 128 characters long.
        :param pulumi.Input[builtins.str] logstore_name: The name of the log logstore.
        :param pulumi.Input[builtins.str] path_format: The OSS Bucket directory is dynamically generated according to the creation time of the export task, it cannot start with a forward slash `/`, the default value is `%Y/%m/%d/%H/%M`.
        :param pulumi.Input[builtins.str] project_name: The name of the log project. It is the only in one Alicloud account.
        :param pulumi.Input[builtins.str] time_zone: This time zone that is used to format the time, `+0800` e.g.
        :param pulumi.Input[builtins.str] compress_type: OSS data storage compression method, support: `none`, `snappy`, `zstd`, `gzip`. Among them, none means that the original data is not compressed, and snappy means that the data is compressed using the snappy algorithm, which can reduce the storage space usage of the `OSS Bucket`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] csv_config_columns: Field configuration in csv content_type.
        :param pulumi.Input[builtins.str] csv_config_delimiter: Separator configuration in csv content_type.
        :param pulumi.Input[builtins.str] csv_config_escape: escape in csv content_type.
        :param pulumi.Input[builtins.bool] csv_config_header: Indicates whether to write the field name to the CSV file, the default value is `false`.
        :param pulumi.Input[builtins.str] csv_config_linefeed: lineFeed in csv content_type.
        :param pulumi.Input[builtins.str] csv_config_null: Invalid field content in csv content_type.
        :param pulumi.Input[builtins.str] csv_config_quote: Escape character in csv content_type.
        :param pulumi.Input[builtins.str] display_name: The display name for oss export.
        :param pulumi.Input[builtins.int] from_time: The log from when to export to oss.
        :param pulumi.Input[builtins.bool] json_enable_tag: Whether to deliver the label when `content_type` = `json`.
        :param pulumi.Input[builtins.str] log_read_role_arn: Used for logstore reading, the role should have log read policy, such as `acs:ram::13234:role/logrole`, if `log_read_role_arn` is not set, `role_arn` is used to read logstore.
        :param pulumi.Input[builtins.str] prefix: The data synchronized from Log Service to OSS will be stored in this directory of Bucket.
        :param pulumi.Input[builtins.str] role_arn: Used to write to oss bucket, the OSS Bucket owner creates the role mark which has the oss bucket write policy, such as `acs:ram::13234:role/logrole`.
        :param pulumi.Input[builtins.str] suffix: The suffix for the objects in which the shipped data is stored.
        """
    ...
    def export_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @export_name.setter
    def export_name(self, value: pulumi.Input[builtins.str]):
    ...
    def csv_config_escape(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def csv_config_escape(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def csv_config_null(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def csv_config_null(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def log_read_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def log_read_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OssExport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role_arn: Optional[pulumi.Input[builtins.str]] = None,
            suffix: Optional[pulumi.Input[builtins.str]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None) -> 'OssExport':
        """
    ...
    @property
    @pulumi.getter(name="csvConfigEscape")
    def csv_config_escape(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        escape in csv content_type.
        """
        return pulumi.get(self, "csv_config_escape")
    ...
    @property
    @pulumi.getter(name="csvConfigNull")
    def csv_config_null(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Invalid field content in csv content_type.
        """
        return pulumi.get(self, "csv_config_null")
    ...
    @property
    @pulumi.getter(name="logReadRoleArn")
    def log_read_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Used for logstore reading, the role should have log read policy, such as `acs:ram::13234:role/logrole`, if `log_read_role_arn` is not set, `role_arn` is used to read logstore.
        """
        return pulumi.get(self, "log_read_role_arn")
