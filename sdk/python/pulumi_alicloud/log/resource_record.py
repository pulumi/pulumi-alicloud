...
class ResourceRecordArgs:
    def __init__(__self__, *,
                 record_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] record_id: The record's id, should be unique.
        :param pulumi.Input[builtins.str] resource_name: The name defined in log_resource, log service have some internal resource, like sls.common.user, sls.common.user_group. More detail see [Resource Data Structure](https://www.alibabacloud.com/help/en/sls/developer-reference/data-structure-of-alert-resource-data).
        :param pulumi.Input[builtins.str] tag: The record's tag, can be used for search.
        :param pulumi.Input[builtins.str] value: The json value of record. More detail see [Resource Data Structure](https://www.alibabacloud.com/help/en/sls/developer-reference/data-structure-of-alert-resource-data).
        """
    ...
    def record_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @record_id.setter
    def record_id(self, value: pulumi.Input[builtins.str]):
...
class ResourceRecord(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:log/resourceRecord:ResourceRecord"
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] record_id: The record's id, should be unique.
        :param pulumi.Input[builtins.str] resource_name_: The name defined in log_resource, log service have some internal resource, like sls.common.user, sls.common.user_group. More detail see [Resource Data Structure](https://www.alibabacloud.com/help/en/sls/developer-reference/data-structure-of-alert-resource-data).
        :param pulumi.Input[builtins.str] tag: The record's tag, can be used for search.
        :param pulumi.Input[builtins.str] value: The json value of record. More detail see [Resource Data Structure](https://www.alibabacloud.com/help/en/sls/developer-reference/data-structure-of-alert-resource-data).
        """
        ...
    ...
    def get(resource_name: str,
            ...
            resource_name_: Optional[pulumi.Input[builtins.str]] = None,
            tag: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'ResourceRecord':
        """
