...
class StoreArgs:
    def __init__(__self__, *,
                 append_meta: Optional[pulumi.Input[builtins.bool]] = None,
                 auto_split: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_web_tracking: Optional[pulumi.Input[builtins.bool]] = None,
                 encrypt_conf: Optional[pulumi.Input['StoreEncryptConfArgs']] = None,
                 hot_ttl: Optional[pulumi.Input[builtins.int]] = None,
                 infrequent_access_ttl: Optional[pulumi.Input[builtins.int]] = None,
                 logstore_name: Optional[pulumi.Input[builtins.str]] = None,
                 max_split_shard_count: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 telemetry_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Store resource.
        :param pulumi.Input[builtins.bool] append_meta: Determines whether to append log meta automatically. The meta includes log receive time and client IP address. Default to `true`.
        :param pulumi.Input[builtins.bool] auto_split: Determines whether to automatically split a shard. Default to `false`.
        :param pulumi.Input[builtins.bool] enable_web_tracking: Whether open webtracking. webtracking network tracing, support the collection of HTML log, H5, Ios and android platforms.
        ...
        :param pulumi.Input[builtins.int] hot_ttl: The ttl of hot storage. Default to 30, at least 30, hot storage ttl must be less than ttl.
        :param pulumi.Input[builtins.int] infrequent_access_ttl: Low frequency storage time
        :param pulumi.Input[builtins.str] logstore_name: The log store, which is unique in the same project. You need to specify one of the attributes: `logstore_name`, `name`.
        :param pulumi.Input[builtins.int] max_split_shard_count: The maximum number of shards for automatic split, which is in the range of 1 to 256. You must specify this parameter when autoSplit is true.
        :param pulumi.Input[builtins.str] metering_mode: Metering mode. The default metering mode of ChargeByFunction, ChargeByDataIngest traffic mode.
        :param pulumi.Input[builtins.str] mode: The mode of storage. Default to `standard`, must be `standard` or `query`, `lite`.
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.215.0. New field 'logstore_name' instead.
        :param pulumi.Input[builtins.str] project: . Field 'project' has been deprecated from provider version 1.215.0. New field 'project_name' instead.
        :param pulumi.Input[builtins.str] project_name: The project name to the log store belongs. You need to specify one of the attributes: `project_name`, `project`.
        :param pulumi.Input[builtins.int] retention_period: The data retention time (in days). Valid values: [1-3650]. Default to 30. Log store data will be stored permanently when the value is 3650.
        :param pulumi.Input[builtins.int] shard_count: The number of shards in this log store. Default to 2. You can modify it by "Split" or "Merge" operations. [Refer to details](https://www.alibabacloud.com/help/zh/sls/product-overview/shard).
        :param pulumi.Input[builtins.str] telemetry_type: Determines whether store type is metric. `Metrics` means metric store, empty means log store.
    ...
    def append_meta(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @append_meta.setter
    def append_meta(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def enable_web_tracking(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_web_tracking(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def infrequent_access_ttl(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def infrequent_access_ttl(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def max_split_shard_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_split_shard_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def telemetry_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def telemetry_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _StoreState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] append_meta: Determines whether to append log meta automatically. The meta includes log receive time and client IP address. Default to `true`.
        :param pulumi.Input[builtins.bool] auto_split: Determines whether to automatically split a shard. Default to `false`.
        :param pulumi.Input[builtins.int] create_time: Log library creation time. Unix timestamp format that represents the number of seconds from 1970-1-1 00:00:00 UTC calculation.
        :param pulumi.Input[builtins.bool] enable_web_tracking: Whether open webtracking. webtracking network tracing, support the collection of HTML log, H5, Ios and android platforms.
        :param pulumi.Input['StoreEncryptConfArgs'] encrypt_conf: Encrypted storage of data, providing data static protection capability, encrypt_conf can be updated since 1.188.0 (only enable change is supported when updating logstore). See `encrypt_conf` below.
        :param pulumi.Input[builtins.int] hot_ttl: The ttl of hot storage. Default to 30, at least 30, hot storage ttl must be less than ttl.
        :param pulumi.Input[builtins.int] infrequent_access_ttl: Low frequency storage time
...
class Store(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            telemetry_type: Optional[pulumi.Input[builtins.str]] = None) -> 'Store':
        """
    ...
    @property
    @pulumi.getter(name="appendMeta")
    def append_meta(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Determines whether to append log meta automatically. The meta includes log receive time and client IP address. Default to `true`.
        """
        return pulumi.get(self, "append_meta")
    ...
    @property
    @pulumi.getter(name="autoSplit")
    def auto_split(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Determines whether to automatically split a shard. Default to `false`.
        """
        return pulumi.get(self, "auto_split")
    ...
    @property
    @pulumi.getter(name="enableWebTracking")
    def enable_web_tracking(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether open webtracking. webtracking network tracing, support the collection of HTML log, H5, Ios and android platforms.
        """
        return pulumi.get(self, "enable_web_tracking")
    ...
    @property
    @pulumi.getter(name="hotTtl")
    def hot_ttl(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The ttl of hot storage. Default to 30, at least 30, hot storage ttl must be less than ttl.
        """
        return pulumi.get(self, "hot_ttl")
    ...
    @property
    @pulumi.getter(name="infrequentAccessTtl")
    def infrequent_access_ttl(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Low frequency storage time
        """
        return pulumi.get(self, "infrequent_access_ttl")
    ...
    @property
    @pulumi.getter(name="maxSplitShardCount")
    def max_split_shard_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum number of shards for automatic split, which is in the range of 1 to 256. You must specify this parameter when autoSplit is true.
        """
        return pulumi.get(self, "max_split_shard_count")
    ...
    @property
    @pulumi.getter(name="telemetryType")
    def telemetry_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Determines whether store type is metric. `Metrics` means metric store, empty means log store.
