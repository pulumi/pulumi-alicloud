...
class Audit(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, aliuid=None, display_name=None, multi_accounts=None, variable_map=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, aliuid=None, display_name=None, multi_accounts=None, variable_map=None):
        """
