...
class OssShipperArgs:
    def __init__(__self__, *,
                 buffer_interval: pulumi.Input[builtins.int],
                 buffer_size: pulumi.Input[builtins.int],
                 format: pulumi.Input[builtins.str],
                 logstore_name: pulumi.Input[builtins.str],
                 oss_bucket: pulumi.Input[builtins.str],
                 path_format: pulumi.Input[builtins.str],
                 ...
                 csv_config_columns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 csv_config_delimiter: Optional[pulumi.Input[builtins.str]] = None,
                 csv_config_header: Optional[pulumi.Input[builtins.bool]] = None,
                 csv_config_linefeed: Optional[pulumi.Input[builtins.str]] = None,
                 csv_config_nullidentifier: Optional[pulumi.Input[builtins.str]] = None,
                 csv_config_quote: Optional[pulumi.Input[builtins.str]] = None,
                 json_enable_tag: Optional[pulumi.Input[builtins.bool]] = None,
                 oss_prefix: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] buffer_interval: How often is it delivered every interval.
        :param pulumi.Input[builtins.int] buffer_size: Automatically control the creation interval of delivery tasks and set the upper limit of an OSS object size (calculated in uncompressed), unit: `MB`.
        :param pulumi.Input[builtins.str] format: Storage format, only supports three types: `json`, `parquet`, `csv`.
        ...
        :param pulumi.Input[builtins.str] logstore_name: The name of the log logstore.
        :param pulumi.Input[builtins.str] oss_bucket: The name of the oss bucket.
        :param pulumi.Input[builtins.str] path_format: The OSS Bucket directory is dynamically generated according to the creation time of the shipper task, it cannot start with a forward slash `/`, the default value is `%Y/%m/%d/%H/%M`.
        :param pulumi.Input[builtins.str] project_name: The name of the log project. It is the only in one Alicloud account.
        :param pulumi.Input[builtins.str] shipper_name: Delivery configuration name, it can only contain lowercase letters, numbers, dashes `-` and underscores `_`. It must start and end with lowercase letters or numbers, and the name must be 2 to 128 characters long.
        :param pulumi.Input[builtins.str] compress_type: OSS data storage compression method, support: none, snappy. Among them, none means that the original data is not compressed, and snappy means that the data is compressed using the snappy algorithm, which can reduce the storage space usage of the `OSS Bucket`.
        :param pulumi.Input[builtins.str] oss_prefix: The data synchronized from Log Service to OSS will be stored in this directory of Bucket.
        :param pulumi.Input[builtins.str] role_arn: Used for access control, the OSS Bucket owner creates the role mark, such as `acs:ram::13234:role/logrole`
        """
    ...
    def buffer_interval(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def buffer_interval(self, value: pulumi.Input[builtins.int]):
    ...
    def logstore_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def logstore_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "logstore_name", value)

    @property
    @pulumi.getter(name="ossBucket")
    def oss_bucket(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @oss_bucket.setter
    def oss_bucket(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "oss_bucket", value)

    @property
    @pulumi.getter(name="pathFormat")
    def path_format(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @path_format.setter
    def path_format(self, value: pulumi.Input[builtins.str]):
    ...
    def csv_config_columns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "csv_config_columns")

    @csv_config_columns.setter
    def csv_config_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "csv_config_columns", value)

    @property
    @pulumi.getter(name="csvConfigDelimiter")
    def csv_config_delimiter(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "csv_config_delimiter")

    @csv_config_delimiter.setter
    def csv_config_delimiter(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "csv_config_delimiter", value)

    @property
    @pulumi.getter(name="csvConfigHeader")
    def csv_config_header(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "csv_config_header")

    @csv_config_header.setter
    def csv_config_header(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "csv_config_header", value)

    @property
    @pulumi.getter(name="csvConfigLinefeed")
    def csv_config_linefeed(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "csv_config_linefeed")

    @csv_config_linefeed.setter
    def csv_config_linefeed(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "csv_config_linefeed", value)

    @property
    @pulumi.getter(name="csvConfigNullidentifier")
    def csv_config_nullidentifier(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "csv_config_nullidentifier")

    @csv_config_nullidentifier.setter
    def csv_config_nullidentifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "csv_config_nullidentifier", value)

    @property
    @pulumi.getter(name="csvConfigQuote")
    def csv_config_quote(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "csv_config_quote")

    @csv_config_quote.setter
    def csv_config_quote(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "csv_config_quote", value)

    @property
    @pulumi.getter(name="jsonEnableTag")
    def json_enable_tag(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "json_enable_tag")

    @json_enable_tag.setter
    def json_enable_tag(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "json_enable_tag", value)

    @property
    @pulumi.getter(name="ossPrefix")
    def oss_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @oss_prefix.setter
    def oss_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _OssShipperState:
    def __init__(__self__, *,
                 buffer_interval: Optional[pulumi.Input[builtins.int]] = None,
                 buffer_size: Optional[pulumi.Input[builtins.int]] = None,
                 compress_type: Optional[pulumi.Input[builtins.str]] = None,
                 csv_config_columns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 csv_config_delimiter: Optional[pulumi.Input[builtins.str]] = None,
                 csv_config_header: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 json_enable_tag: Optional[pulumi.Input[builtins.bool]] = None,
                 logstore_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="bufferInterval")
    def buffer_interval(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        How often is it delivered every interval.
        """
        return pulumi.get(self, "buffer_interval")
    ...
    @buffer_interval.setter
    def buffer_interval(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "buffer_interval", value)

    @property
    @pulumi.getter(name="bufferSize")
    def buffer_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Automatically control the creation interval of delivery tasks and set the upper limit of an OSS object size (calculated in uncompressed), unit: `MB`.
        """
        return pulumi.get(self, "buffer_size")
    ...
    @buffer_size.setter
    def buffer_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "buffer_size", value)
    ...
    @property
    @pulumi.getter(name="logstoreName")
    def logstore_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the log logstore.
        """
        return pulumi.get(self, "logstore_name")
    ...
    @logstore_name.setter
    def logstore_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "logstore_name", value)
...
class OssShipper(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 oss_bucket: Optional[pulumi.Input[builtins.str]] = None,
                 oss_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 parquet_configs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['OssShipperParquetConfigArgs', 'OssShipperParquetConfigArgsDict']]]]] = None,
                 path_format: Optional[pulumi.Input[builtins.str]] = None,
                 project_name: Optional[pulumi.Input[builtins.str]] = None,
                 role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 shipper_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def get(resource_name: str,
            ...
            project_name: Optional[pulumi.Input[builtins.str]] = None,
            role_arn: Optional[pulumi.Input[builtins.str]] = None,
            shipper_name: Optional[pulumi.Input[builtins.str]] = None) -> 'OssShipper':
        """
    ...
    @property
    @pulumi.getter(name="bufferInterval")
    def buffer_interval(self) -> pulumi.Output[builtins.int]:
        """
        How often is it delivered every interval.
        """
        return pulumi.get(self, "buffer_interval")
    ...
    @property
    @pulumi.getter(name="bufferSize")
    def buffer_size(self) -> pulumi.Output[builtins.int]:
        """
        Automatically control the creation interval of delivery tasks and set the upper limit of an OSS object size (calculated in uncompressed), unit: `MB`.
        """
        return pulumi.get(self, "buffer_size")
    ...
    @property
    @pulumi.getter(name="compressType")
    def compress_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        OSS data storage compression method, support: none, snappy. Among them, none means that the original data is not compressed, and snappy means that the data is compressed using the snappy algorithm, which can reduce the storage space usage of the `OSS Bucket`.
        """
        return pulumi.get(self, "compress_type")
    ...
    @property
    @pulumi.getter(name="csvConfigColumns")
    def csv_config_columns(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "csv_config_columns")

    @property
    @pulumi.getter(name="csvConfigDelimiter")
    def csv_config_delimiter(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "csv_config_delimiter")

    @property
    @pulumi.getter(name="csvConfigHeader")
    def csv_config_header(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "csv_config_header")

    @property
    @pulumi.getter(name="csvConfigLinefeed")
    def csv_config_linefeed(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "csv_config_linefeed")

    @property
    @pulumi.getter(name="csvConfigNullidentifier")
    def csv_config_nullidentifier(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "csv_config_nullidentifier")

    @property
    @pulumi.getter(name="csvConfigQuote")
    def csv_config_quote(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "csv_config_quote")
    ...
    @property
    @pulumi.getter(name="jsonEnableTag")
    def json_enable_tag(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "json_enable_tag")

    @property
    @pulumi.getter(name="logstoreName")
    def logstore_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the log logstore.
        """
        return pulumi.get(self, "logstore_name")
    ...
    @property
    @pulumi.getter(name="ossBucket")
    def oss_bucket(self) -> pulumi.Output[builtins.str]:
        """
        The name of the oss bucket.
        """
        return pulumi.get(self, "oss_bucket")
    ...
    @property
    @pulumi.getter(name="ossPrefix")
    def oss_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The data synchronized from Log Service to OSS will be stored in this directory of Bucket.
        """
        return pulumi.get(self, "oss_prefix")
    ...
    @property
    @pulumi.getter(name="pathFormat")
    def path_format(self) -> pulumi.Output[builtins.str]:
        """
        The OSS Bucket directory is dynamically generated according to the creation time of the shipper task, it cannot start with a forward slash `/`, the default value is `%Y/%m/%d/%H/%M`.
        """
        return pulumi.get(self, "path_format")
