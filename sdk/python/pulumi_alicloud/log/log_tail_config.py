...
class LogTailConfigArgs:
    def __init__(__self__, *,
                 input_detail: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] input_detail: The logtail configure the required JSON files. ([Refer to details](https://www.alibabacloud.com/help/doc-detail/29058.htm))
        :param pulumi.Input[_builtins.str] input_type: The input type. Currently only two types of files and plugin are supported.
        :param pulumi.Input[_builtins.str] logstore: The log store name to the query index belongs.
        :param pulumi.Input[_builtins.str] output_type: The output type. Currently, only LogService is supported.
        :param pulumi.Input[_builtins.str] project: The project name to the log store belongs.
        :param pulumi.Input[_builtins.str] log_sample: The log sample of the Logtail configuration. The log size cannot exceed 1,000 bytes.
        :param pulumi.Input[_builtins.str] name: The Logtail configuration name, which is unique in the same project.
        """
    ...
    def input_detail(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @input_detail.setter
    def input_detail(self, value: pulumi.Input[_builtins.str]):
...
class _LogTailConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] input_detail: The logtail configure the required JSON files. ([Refer to details](https://www.alibabacloud.com/help/doc-detail/29058.htm))
        :param pulumi.Input[_builtins.str] input_type: The input type. Currently only two types of files and plugin are supported.
        :param pulumi.Input[_builtins.str] last_modify_time: This parameter is auto generated by server, please do not fill in.
        :param pulumi.Input[_builtins.str] log_sample: The log sample of the Logtail configuration. The log size cannot exceed 1,000 bytes.
        :param pulumi.Input[_builtins.str] logstore: The log store name to the query index belongs.
        :param pulumi.Input[_builtins.str] name: The Logtail configuration name, which is unique in the same project.
        :param pulumi.Input[_builtins.str] output_type: The output type. Currently, only LogService is supported.
...
class LogTailConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            output_type: Optional[pulumi.Input[_builtins.str]] = None,
            project: Optional[pulumi.Input[_builtins.str]] = None) -> 'LogTailConfig':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="inputDetail")
    def input_detail(self) -> pulumi.Output[_builtins.str]:
        """
        The logtail configure the required JSON files. ([Refer to details](https://www.alibabacloud.com/help/doc-detail/29058.htm))
        """
        return pulumi.get(self, "input_detail")
    ...
    @_builtins.property
    @pulumi.getter(name="outputType")
    def output_type(self) -> pulumi.Output[_builtins.str]:
        """
        The output type. Currently, only LogService is supported.
        """
        return pulumi.get(self, "output_type")
