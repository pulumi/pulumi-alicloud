...
class LogTailConfigArgs:
    def __init__(__self__, *,
                 input_detail: pulumi.Input[builtins.str],
                 input_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] input_detail: The logtail configure the required JSON files. ([Refer to details](https://www.alibabacloud.com/help/doc-detail/29058.htm))
        :param pulumi.Input[builtins.str] input_type: The input type. Currently only two types of files and plugin are supported.
        :param pulumi.Input[builtins.str] logstore: The log store name to the query index belongs.
        :param pulumi.Input[builtins.str] output_type: The output type. Currently, only LogService is supported.
        :param pulumi.Input[builtins.str] project: The project name to the log store belongs.
        :param pulumi.Input[builtins.str] log_sample: The log sample of the Logtail configuration. The log size cannot exceed 1,000 bytes.
        :param pulumi.Input[builtins.str] name: The Logtail configuration name, which is unique in the same project.
        """
    ...
    def input_detail(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @input_detail.setter
    def input_detail(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "input_detail", value)

    @property
    @pulumi.getter(name="inputType")
    def input_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @input_type.setter
    def input_type(self, value: pulumi.Input[builtins.str]):
...
class _LogTailConfigState:
    def __init__(__self__, *,
                 input_detail: Optional[pulumi.Input[builtins.str]] = None,
                 input_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] input_detail: The logtail configure the required JSON files. ([Refer to details](https://www.alibabacloud.com/help/doc-detail/29058.htm))
        :param pulumi.Input[builtins.str] input_type: The input type. Currently only two types of files and plugin are supported.
        :param pulumi.Input[builtins.str] last_modify_time: This parameter is auto generated by server, please do not fill in.
        :param pulumi.Input[builtins.str] log_sample: The log sample of the Logtail configuration. The log size cannot exceed 1,000 bytes.
        :param pulumi.Input[builtins.str] logstore: The log store name to the query index belongs.
        :param pulumi.Input[builtins.str] name: The Logtail configuration name, which is unique in the same project.
        :param pulumi.Input[builtins.str] output_type: The output type. Currently, only LogService is supported.
    ...
    @property
    @pulumi.getter(name="inputDetail")
    def input_detail(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The logtail configure the required JSON files. ([Refer to details](https://www.alibabacloud.com/help/doc-detail/29058.htm))
        """
        return pulumi.get(self, "input_detail")
    ...
    @input_detail.setter
    def input_detail(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "input_detail", value)

    @property
    @pulumi.getter(name="inputType")
    def input_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The input type. Currently only two types of files and plugin are supported.
        """
        return pulumi.get(self, "input_type")
    ...
    @input_type.setter
    def input_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "input_type", value)
...
class LogTailConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            output_type: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None) -> 'LogTailConfig':
        """
    ...
    @property
    @pulumi.getter(name="inputDetail")
    def input_detail(self) -> pulumi.Output[builtins.str]:
        """
        The logtail configure the required JSON files. ([Refer to details](https://www.alibabacloud.com/help/doc-detail/29058.htm))
        """
        return pulumi.get(self, "input_detail")
    ...
    @property
    @pulumi.getter(name="inputType")
    def input_type(self) -> pulumi.Output[builtins.str]:
        """
        The input type. Currently only two types of files and plugin are supported.
        """
        return pulumi.get(self, "input_type")
    ...
    @property
    @pulumi.getter(name="logSample")
    def log_sample(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The log sample of the Logtail configuration. The log size cannot exceed 1,000 bytes.
        """
        return pulumi.get(self, "log_sample")
    ...
    @property
    @pulumi.getter
    def logstore(self) -> pulumi.Output[builtins.str]:
        """
        The log store name to the query index belongs.
        """
        return pulumi.get(self, "logstore")
    ...
    @property
    @pulumi.getter(name="outputType")
    def output_type(self) -> pulumi.Output[builtins.str]:
        """
        The output type. Currently, only LogService is supported.
        """
        return pulumi.get(self, "output_type")
