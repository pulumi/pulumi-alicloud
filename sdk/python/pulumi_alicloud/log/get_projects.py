...
def get_projects(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str name_regex: A regex string to filter results by project name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of log project. Valid values `Normal` and `Disable`.
    """
    __args__ = dict()
    __args__['ids'] = ids
