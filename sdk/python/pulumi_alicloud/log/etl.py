...
class EtlArgs:
    def __init__(__self__, *,
                 ...
                 etl_name: pulumi.Input[builtins.str],
                 ...
                 etl_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 kms_encryption_access_key_id_context: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 kms_encryption_access_key_secret_context: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: Log service etl job alias.
        :param pulumi.Input[builtins.str] etl_name: The name of the log etl job.
        ...
        :param pulumi.Input[builtins.str] logstore: The source logstore of the processing job.
        :param pulumi.Input[builtins.str] project: The name of the project where the etl job is located.
        :param pulumi.Input[builtins.str] script: Processing operation grammar.
        :param pulumi.Input[builtins.str] access_key_id: Source logstore access key id.
        :param pulumi.Input[builtins.str] access_key_secret: Source logstore access key secret.
        :param pulumi.Input[builtins.int] create_time: The etl job create time.
        :param pulumi.Input[builtins.str] description: Description of the log etl job.
        :param pulumi.Input[builtins.str] etl_type: Log service etl type, the default value is `ETL`.
        :param pulumi.Input[builtins.int] from_time: The start time of the processing job, if not set the value is 0, indicates to start processing from the oldest data.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] kms_encryption_access_key_id_context: An KMS encryption context used to decrypt `kms_encrypted_access_key_id` before creating or updating an instance with `kms_encrypted_access_key_id`. See [Encryption Context](https://www.alibabacloud.com/help/doc-detail/42975.htm). It is valid when `kms_encrypted_password` is set. When it is changed, the instance will reboot to make the change take effect.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] kms_encryption_access_key_secret_context: An KMS encryption context used to decrypt `kms_encrypted_access_key_secret` before creating or updating an instance with `kms_encrypted_access_key_secret`. See [Encryption Context](https://www.alibabacloud.com/help/doc-detail/42975.htm). It is valid when `kms_encrypted_password` is set. When it is changed, the instance will reboot to make the change take effect.
        :param pulumi.Input[builtins.int] last_modified_time: ETL job last modified time.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: Advanced parameter configuration of processing operations.
        :param pulumi.Input[builtins.str] role_arn: Sts role info under source logstore. `role_arn` and `(access_key_id, access_key_secret)` fill in at most one. If you do not fill in both, then you must fill in `(kms_encrypted_access_key_id, kms_encrypted_access_key_secret, kms_encryption_access_key_id_context, kms_encryption_access_key_secret_context)` to use KMS to get the key pair.
        :param pulumi.Input[builtins.str] schedule: Job scheduling type, the default value is Resident.
        :param pulumi.Input[builtins.str] status: Log project tags. the default value is RUNNING, Only 4 values are supported: `STARTING`，`RUNNING`，`STOPPING`，`STOPPED`.
        :param pulumi.Input[builtins.int] to_time: Deadline of processing job, if not set the value is 0, indicates that new data will be processed continuously.
        :param pulumi.Input[builtins.int] version: Log etl job version. the default value is `2`.
        """
    ...
    def etl_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @etl_name.setter
    def etl_name(self, value: pulumi.Input[builtins.str]):
    ...
    def etl_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @etl_type.setter
    def etl_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def kms_encryption_access_key_id_context(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def kms_encryption_access_key_id_context(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "kms_encryption_access_key_id_context", value)

    @property
    @pulumi.getter(name="kmsEncryptionAccessKeySecretContext")
    def kms_encryption_access_key_secret_context(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        An KMS encryption context used to decrypt `kms_encrypted_access_key_secret` before creating or updating an instance with `kms_encrypted_access_key_secret`. See [Encryption Context](https://www.alibabacloud.com/help/doc-detail/42975.htm). It is valid when `kms_encrypted_password` is set. When it is changed, the instance will reboot to make the change take effect.
        """
    ...
    def kms_encryption_access_key_secret_context(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class _EtlState:
    def __init__(__self__, *,
                 ...
                 etl_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="etlName")
    def etl_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the log etl job.
        """
        return pulumi.get(self, "etl_name")
    ...
    @etl_name.setter
    def etl_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "etl_name", value)
...
class Etl(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:log/etl:Etl"
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            to_time: Optional[pulumi.Input[builtins.int]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'Etl':
        """
    ...
    @property
    @pulumi.getter(name="accessKeySecret")
    def access_key_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Source logstore access key secret.
        """
        return pulumi.get(self, "access_key_secret")
    ...
    @property
    @pulumi.getter(name="etlName")
    def etl_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the log etl job.
        """
        return pulumi.get(self, "etl_name")
    ...
    @property
    @pulumi.getter(name="etlType")
    def etl_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Log service etl type, the default value is `ETL`.
        """
        return pulumi.get(self, "etl_type")
    ...
    @property
    @pulumi.getter(name="fromTime")
    def from_time(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The start time of the processing job, if not set the value is 0, indicates to start processing from the oldest data.
        """
        return pulumi.get(self, "from_time")
    ...
    @property
    @pulumi.getter(name="kmsEncryptedAccessKeyId")
    def kms_encrypted_access_key_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An KMS encrypts access key id used to a log etl job. If the `access_key_id` is filled in, this field will be ignored.
        """
        return pulumi.get(self, "kms_encrypted_access_key_id")
    ...
    @property
    @pulumi.getter(name="kmsEncryptedAccessKeySecret")
    def kms_encrypted_access_key_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An KMS encrypts access key secret used to a log etl job. If the `access_key_secret` is filled in, this field will be ignored.
        """
        return pulumi.get(self, "kms_encrypted_access_key_secret")
    ...
    @property
    @pulumi.getter(name="kmsEncryptionAccessKeyIdContext")
    def kms_encryption_access_key_id_context(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        An KMS encryption context used to decrypt `kms_encrypted_access_key_id` before creating or updating an instance with `kms_encrypted_access_key_id`. See [Encryption Context](https://www.alibabacloud.com/help/doc-detail/42975.htm). It is valid when `kms_encrypted_password` is set. When it is changed, the instance will reboot to make the change take effect.
        """
        return pulumi.get(self, "kms_encryption_access_key_id_context")
    ...
    @property
    @pulumi.getter(name="kmsEncryptionAccessKeySecretContext")
    def kms_encryption_access_key_secret_context(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        An KMS encryption context used to decrypt `kms_encrypted_access_key_secret` before creating or updating an instance with `kms_encrypted_access_key_secret`. See [Encryption Context](https://www.alibabacloud.com/help/doc-detail/42975.htm). It is valid when `kms_encrypted_password` is set. When it is changed, the instance will reboot to make the change take effect.
        """
        return pulumi.get(self, "kms_encryption_access_key_secret_context")
    ...
    @property
    @pulumi.getter(name="toTime")
    def to_time(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Deadline of processing job, if not set the value is 0, indicates that new data will be processed continuously.
        """
        return pulumi.get(self, "to_time")
