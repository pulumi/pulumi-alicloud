...
class AlertResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of alert resources, must be user or project, 'user' for init aliyuncloud account's alert center resource, including project named sls-alert-{uid}-{region} and some dashboards; 'project' for init project's alert resource, including logstore named internal-alert-history and alert dashboard.
        :param pulumi.Input[builtins.str] lang: The lang of alert center resource when type is user.
        :param pulumi.Input[builtins.str] project: The project of alert resource when type is project.
        """
...
@pulumi.type_token("alicloud:log/alertResource:AlertResource")
class AlertResource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            lang: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'AlertResource':
        """
