...
class ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] project_name: The name of the log project. It is the only in one Alicloud account. The project name is globally unique in Alibaba Cloud and cannot be modified after it is created. The naming rules are as follows:
