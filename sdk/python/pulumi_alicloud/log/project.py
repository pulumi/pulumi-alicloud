...
class ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.223.0. New field 'project_name' instead.
        :param pulumi.Input[builtins.str] policy: Log project policy, used to set a policy for a project.
        :param pulumi.Input[builtins.str] project_name: The name of the log project. It is the only in one Alicloud account. The project name is globally unique in Alibaba Cloud and cannot be modified after it is created. The naming rules are as follows:
...
@pulumi.type_token("alicloud:log/project:Project")
