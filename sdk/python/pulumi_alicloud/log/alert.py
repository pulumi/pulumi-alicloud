...
class AlertArgs:
    def __init__(__self__, *,
                 alert_displayname: pulumi.Input[builtins.str],
                 alert_name: pulumi.Input[builtins.str],
                 project_name: pulumi.Input[builtins.str],
                 alert_description: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 notify_threshold: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 schedule_interval: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 throttling: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Alert resource.
        :param pulumi.Input[builtins.str] alert_displayname: Alert displayname.
        :param pulumi.Input[builtins.str] alert_name: Name of logstore for configuring alarm service.
        :param pulumi.Input[builtins.str] project_name: The project name.
        :param pulumi.Input[builtins.str] alert_description: Alert description.
        :param pulumi.Input[Sequence[pulumi.Input['AlertAnnotationArgs']]] annotations: Annotations for new alert.
        :param pulumi.Input[builtins.bool] auto_annotation: whether to add automatic annotation, default is false.
        :param pulumi.Input[builtins.str] condition: Conditional expression, such as: count> 100, Deprecated from 1.161.0+.
        ...
        :param pulumi.Input[builtins.int] mute_until: Timestamp, notifications before closing again.
        :param pulumi.Input[builtins.bool] no_data_fire: Switch for whether new alert fires when no data happens, default is false.
        :param pulumi.Input[builtins.int] no_data_severity: when no data happens, the severity of new alert.
        ...
        :param pulumi.Input[builtins.int] notify_threshold: Notification threshold, which is not notified until the number of triggers is reached. The default is 1, Deprecated from 1.161.0+.
        ...
        :param pulumi.Input[builtins.str] schedule_interval: Execution interval. 60 seconds minimum, such as 60s, 1h. Deprecated from 1.176.0+. use interval in schedule.
        :param pulumi.Input[builtins.str] schedule_type: Default FixedRate. No need to configure this parameter. Deprecated from 1.176.0+. use type in schedule.
        :param pulumi.Input[builtins.bool] send_resolved: when new alert is resolved, whether to notify, default is false.
        ...
        :param pulumi.Input[builtins.int] threshold: Evaluation threshold, alert will not fire until the number of triggers is reached. The default is 1.
        :param pulumi.Input[builtins.str] throttling: Notification interval, default is no interval. Support number + unit type, for example 60s, 1h, Deprecated from 1.161.0+.
        :param pulumi.Input[builtins.str] type: The type of new alert, `default` for custom alert, `tpl` for template alert.
        :param pulumi.Input[builtins.str] version: The version of alert, new alert is 2.0.
        """
    ...
    def alert_displayname(self) -> pulumi.Input[builtins.str]:
        """
        Alert displayname.
        """
    ...
    def alert_displayname(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "alert_displayname", value)

    @property
    @pulumi.getter(name="alertName")
    def alert_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @alert_name.setter
    def alert_name(self, value: pulumi.Input[builtins.str]):
    ...
    def alert_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Alert description.
        """
    ...
    def alert_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def notify_threshold(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def notify_threshold(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def schedule_interval(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def schedule_interval(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def throttling(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @throttling.setter
    def throttling(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AlertState:
    def __init__(__self__, *,
                 alert_description: Optional[pulumi.Input[builtins.str]] = None,
                 alert_displayname: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="alertDisplayname")
    def alert_displayname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Alert displayname.
        """
        return pulumi.get(self, "alert_displayname")
    ...
    @alert_displayname.setter
    def alert_displayname(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alert_displayname", value)
...
class Alert(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            throttling: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'Alert':
        """
    ...
    @property
    @pulumi.getter(name="alertDescription")
    def alert_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Alert description.
        """
        return pulumi.get(self, "alert_description")
    ...
    @property
    @pulumi.getter(name="alertDisplayname")
    def alert_displayname(self) -> pulumi.Output[builtins.str]:
        """
        Alert displayname.
        """
        return pulumi.get(self, "alert_displayname")
    ...
    @property
    @pulumi.getter(name="alertName")
    def alert_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of logstore for configuring alarm service.
        """
        return pulumi.get(self, "alert_name")
    ...
    @property
    @pulumi.getter(name="autoAnnotation")
    def auto_annotation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        whether to add automatic annotation, default is false.
        """
        return pulumi.get(self, "auto_annotation")
    ...
    @pulumi.getter
    @_utilities.deprecated("""Deprecated from 1.161.0+, use dashboardId in query_list""")
    def dashboard(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "dashboard")
    ...
    @property
    @pulumi.getter(name="muteUntil")
    def mute_until(self) -> pulumi.Output[builtins.int]:
        """
        Timestamp, notifications before closing again.
        """
        return pulumi.get(self, "mute_until")
    ...
    @property
    @pulumi.getter(name="noDataFire")
    def no_data_fire(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Switch for whether new alert fires when no data happens, default is false.
        """
        return pulumi.get(self, "no_data_fire")
    ...
    @property
    @pulumi.getter(name="noDataSeverity")
    def no_data_severity(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        when no data happens, the severity of new alert.
        """
        return pulumi.get(self, "no_data_severity")
    ...
    @pulumi.getter(name="notifyThreshold")
    @_utilities.deprecated("""Deprecated from 1.161.0+, use threshold""")
    def notify_threshold(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Notification threshold, which is not notified until the number of triggers is reached. The default is 1, Deprecated from 1.161.0+.
        """
        return pulumi.get(self, "notify_threshold")
    ...
    @pulumi.getter(name="scheduleInterval")
    @_utilities.deprecated("""Field 'schedule_interval' has been deprecated from provider version 1.176.0. New field 'schedule' instead.""")
    def schedule_interval(self) -> pulumi.Output[builtins.str]:
        """
        Execution interval. 60 seconds minimum, such as 60s, 1h. Deprecated from 1.176.0+. use interval in schedule.
        """
        return pulumi.get(self, "schedule_interval")
    ...
    @property
    @pulumi.getter(name="sendResolved")
    def send_resolved(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        when new alert is resolved, whether to notify, default is false.
        """
        return pulumi.get(self, "send_resolved")
    ...
    @pulumi.getter
    @_utilities.deprecated("""Deprecated from 1.161.0+, use repeat_interval in policy_configuration""")
    def throttling(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Notification interval, default is no interval. Support number + unit type, for example 60s, 1h, Deprecated from 1.161.0+.
        """
        return pulumi.get(self, "throttling")
