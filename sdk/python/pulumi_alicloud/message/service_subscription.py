...
class ServiceSubscriptionArgs:
    def __init__(__self__, *,
                 ...
                 push_type: pulumi.Input[builtins.str],
    ...
    def push_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @push_type.setter
    def push_type(self, value: pulumi.Input[builtins.str]):
...
class _ServiceSubscriptionState:
    def __init__(__self__, *,
                 ...
                 notify_content_format: Optional[pulumi.Input[builtins.str]] = None,
                 notify_strategy: Optional[pulumi.Input[builtins.str]] = None,
                 push_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="pushType")
    def push_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Push type of Subscription. The Valid values: `http`, `queue`, `mpush`, `alisms` and `email`.
        """
        return pulumi.get(self, "push_type")
    ...
    @push_type.setter
    def push_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "push_type", value)
...
class ServiceSubscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            push_type: Optional[pulumi.Input[builtins.str]] = None,
            subscription_name: Optional[pulumi.Input[builtins.str]] = None,
            topic_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceSubscription':
        """
    ...
    @property
    @pulumi.getter(name="notifyContentFormat")
    def notify_content_format(self) -> pulumi.Output[builtins.str]:
        """
        The NotifyContentFormat attribute of Subscription. This attribute specifies the content format of the messages pushed to users. Valid values: `XML`, `JSON` and `SIMPLIFIED`. Default value: `XML`.
        """
        return pulumi.get(self, "notify_content_format")
    ...
    @property
    @pulumi.getter(name="notifyStrategy")
    def notify_strategy(self) -> pulumi.Output[builtins.str]:
        """
        The NotifyStrategy attribute of Subscription. This attribute specifies the retry strategy when message sending fails. Default value: `BACKOFF_RETRY`. Valid values:
        - `BACKOFF_RETRY`: retries with a fixed backoff interval.
        - `EXPONENTIAL_DECAY_RETRY`: retries with exponential backoff.
    ...
    @property
    @pulumi.getter(name="pushType")
    def push_type(self) -> pulumi.Output[builtins.str]:
        """
        The Push type of Subscription. The Valid values: `http`, `queue`, `mpush`, `alisms` and `email`.
        """
        return pulumi.get(self, "push_type")
