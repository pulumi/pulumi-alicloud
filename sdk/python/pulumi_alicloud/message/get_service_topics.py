...
def get_service_topics(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Topic IDs. Its element value is same as Topic Name.
    :param _builtins.str name_regex: A regex string to filter results by Topic name.
