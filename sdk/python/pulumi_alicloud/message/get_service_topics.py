...
def get_service_topics(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Topic IDs. Its element value is same as Topic Name.
    :param builtins.str name_regex: A regex string to filter results by Topic name.
...
def get_service_topics_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
