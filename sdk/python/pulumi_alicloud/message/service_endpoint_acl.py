...
class ServiceEndpointAclArgs:
    def __init__(__self__, *,
                 acl_strategy: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] acl_strategy: The ACL policy. Valid value:
    ...
    def acl_strategy(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @acl_strategy.setter
    def acl_strategy(self, value: pulumi.Input[builtins.str]):
...
class _ServiceEndpointAclState:
    def __init__(__self__, *,
                 acl_strategy: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="aclStrategy")
    def acl_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ACL policy. Valid value:
        - allow: indicates that the current endpoint allows access from the corresponding CIDR block. (Only allow is supported)
        """
    ...
    @acl_strategy.setter
    def acl_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "acl_strategy", value)
...
class ServiceEndpointAcl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            acl_strategy: Optional[pulumi.Input[builtins.str]] = None,
            cidr: Optional[pulumi.Input[builtins.str]] = None,
            endpoint_type: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceEndpointAcl':
        """
    ...
    @property
    @pulumi.getter(name="aclStrategy")
    def acl_strategy(self) -> pulumi.Output[builtins.str]:
        """
        The ACL policy. Valid value:
        - allow: indicates that the current endpoint allows access from the corresponding CIDR block. (Only allow is supported)
        """
