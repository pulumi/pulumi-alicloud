...
def get_service_queues(ids: Optional[Sequence[builtins.str]] = None,
...
def get_service_queues_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
