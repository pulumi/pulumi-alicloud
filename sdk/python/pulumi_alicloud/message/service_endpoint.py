...
class ServiceEndpointArgs:
    def __init__(__self__, *,
                 endpoint_enabled: pulumi.Input[builtins.bool],
                 endpoint_type: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ServiceEndpoint resource.
        :param pulumi.Input[builtins.bool] endpoint_enabled: Specifies whether the endpoint is enabled. Valid values:
        :param pulumi.Input[builtins.str] endpoint_type: Access point type. Value:
    ...
    def endpoint_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def endpoint_enabled(self, value: pulumi.Input[builtins.bool]):
...
class _ServiceEndpointState:
    def __init__(__self__, *,
                 endpoint_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="endpointEnabled")
    def endpoint_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether the endpoint is enabled. Valid values:
        """
        return pulumi.get(self, "endpoint_enabled")
    ...
    @endpoint_enabled.setter
    def endpoint_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "endpoint_enabled", value)
...
class ServiceEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            endpoint_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            endpoint_type: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="endpointEnabled")
    def endpoint_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether the endpoint is enabled. Valid values:
        """
        return pulumi.get(self, "endpoint_enabled")
