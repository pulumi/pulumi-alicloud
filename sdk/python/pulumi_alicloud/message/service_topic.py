...
class ServiceTopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enable_logging: Specifies whether to enable the logging feature. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.bool] logging_enabled: . Field `logging_enabled` has been deprecated from provider version 1.241.0. New field `enable_logging` instead.
        :param pulumi.Input[builtins.int] max_message_size: The maximum length of the message that is sent to the topic. Default value: `65536`. Valid values: `1024` to `65536`. Unit: bytes.
...
class _ServiceTopicState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: (Available since v1.241.0) The time when the topic was created.
        :param pulumi.Input[builtins.bool] enable_logging: Specifies whether to enable the logging feature. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.bool] logging_enabled: . Field `logging_enabled` has been deprecated from provider version 1.241.0. New field `enable_logging` instead.
        :param pulumi.Input[builtins.int] max_message_size: The maximum length of the message that is sent to the topic. Default value: `65536`. Valid values: `1024` to `65536`. Unit: bytes.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
...
class ServiceTopic(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:message/serviceTopic:ServiceTopic"
    ...
    def get(resource_name: str,
            ...
            max_message_size: Optional[pulumi.Input[builtins.int]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            topic_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceTopic':
        """
    ...
    @pulumi.getter(name="loggingEnabled")
    @_utilities.deprecated("""Field `logging_enabled` has been deprecated from provider version 1.241.0. New field `enable_logging` instead.""")
    def logging_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        . Field `logging_enabled` has been deprecated from provider version 1.241.0. New field `enable_logging` instead.
        """
        return pulumi.get(self, "logging_enabled")
