...
def get_service_subscriptions(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Subscription IDs.
    :param builtins.str name_regex: A regex string to filter results by Subscription name.
...
def get_service_subscriptions_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                     ...
                                     subscription_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
