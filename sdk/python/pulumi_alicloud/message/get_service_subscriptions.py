...
def get_service_subscriptions(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Subscription IDs.
    :param _builtins.str name_regex: A regex string to filter results by Subscription name.
