...
if not MYPY:
    class ServiceQueueDlqPolicyArgsDict(TypedDict):
        dead_letter_target_queue: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        max_receive_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ServiceQueueDlqPolicyArgs:
    def __init__(__self__, *,
                 dead_letter_target_queue: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 max_receive_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] dead_letter_target_queue: The queue to which dead-letter messages are delivered.
        :param pulumi.Input[builtins.bool] enabled: Specifies whether to enable the dead-letter message delivery. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.int] max_receive_count: The maximum number of retries.
        """
    ...
    def dead_letter_target_queue(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The queue to which dead-letter messages are delivered.
        """
    ...
    def dead_letter_target_queue(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def max_receive_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum number of retries.
        """
    ...
    def max_receive_count(self, value: Optional[pulumi.Input[builtins.int]]):
