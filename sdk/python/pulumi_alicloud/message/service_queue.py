...
class ServiceQueueArgs:
    def __init__(__self__, *,
                 ...
                 logging_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 maximum_message_size: Optional[pulumi.Input[builtins.int]] = None,
                 message_retention_period: Optional[pulumi.Input[builtins.int]] = None,
                 polling_wait_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 visibility_timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a ServiceQueue resource.
        :param pulumi.Input[builtins.str] queue_name: The name of the queue.
        :param pulumi.Input[builtins.int] delay_seconds: The period after which all messages sent to the queue are consumed. Default value: `0`. Valid values: `0` to `604800`. Unit: seconds.
        :param pulumi.Input['ServiceQueueDlqPolicyArgs'] dlq_policy: The dead-letter queue policy. See `dlq_policy` below.
        :param pulumi.Input[builtins.bool] logging_enabled: Specifies whether to enable the logging feature. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.int] maximum_message_size: The maximum length of the message that is sent to the queue. Valid values: `1024` to `65536`. Unit: bytes. Default value: `65536`.
        :param pulumi.Input[builtins.int] message_retention_period: The maximum duration for which a message is retained in the queue. After the specified retention period ends, the message is deleted regardless of whether the message is received. Valid values: `60` to `604800`. Unit: seconds. Default value: `345600`.
        :param pulumi.Input[builtins.int] polling_wait_seconds: The maximum duration for which long polling requests are held after the ReceiveMessage operation is called. Valid values: `0` to `30`. Unit: seconds. Default value: `0`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.int] visibility_timeout: The duration for which a message stays in the Inactive state after the message is received from the queue. Valid values: `1` to `43200`. Unit: seconds. Default value: `30`.
        """
    ...
    def logging_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def logging_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "logging_enabled", value)

    @property
    @pulumi.getter(name="maximumMessageSize")
    def maximum_message_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def maximum_message_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "maximum_message_size", value)

    @property
    @pulumi.getter(name="messageRetentionPeriod")
    def message_retention_period(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def message_retention_period(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "message_retention_period", value)

    @property
    @pulumi.getter(name="pollingWaitSeconds")
    def polling_wait_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def polling_wait_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def visibility_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def visibility_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _ServiceQueueState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] create_time: (Available since v1.223.2) The time when the queue was created.
        :param pulumi.Input[builtins.int] delay_seconds: The period after which all messages sent to the queue are consumed. Default value: `0`. Valid values: `0` to `604800`. Unit: seconds.
        :param pulumi.Input['ServiceQueueDlqPolicyArgs'] dlq_policy: The dead-letter queue policy. See `dlq_policy` below.
        :param pulumi.Input[builtins.bool] logging_enabled: Specifies whether to enable the logging feature. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.int] maximum_message_size: The maximum length of the message that is sent to the queue. Valid values: `1024` to `65536`. Unit: bytes. Default value: `65536`.
...
class ServiceQueue(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            queue_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            visibility_timeout: Optional[pulumi.Input[builtins.int]] = None) -> 'ServiceQueue':
        """
    ...
    @property
    @pulumi.getter(name="delaySeconds")
    def delay_seconds(self) -> pulumi.Output[builtins.int]:
        """
        The period after which all messages sent to the queue are consumed. Default value: `0`. Valid values: `0` to `604800`. Unit: seconds.
        """
        return pulumi.get(self, "delay_seconds")
    ...
    @property
    @pulumi.getter(name="loggingEnabled")
    def logging_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable the logging feature. Default value: `false`. Valid values:
        """
        return pulumi.get(self, "logging_enabled")
    ...
    @property
    @pulumi.getter(name="maximumMessageSize")
    def maximum_message_size(self) -> pulumi.Output[builtins.int]:
        """
        The maximum length of the message that is sent to the queue. Valid values: `1024` to `65536`. Unit: bytes. Default value: `65536`.
        """
        return pulumi.get(self, "maximum_message_size")
    ...
    @property
    @pulumi.getter(name="messageRetentionPeriod")
    def message_retention_period(self) -> pulumi.Output[builtins.int]:
        """
        The maximum duration for which a message is retained in the queue. After the specified retention period ends, the message is deleted regardless of whether the message is received. Valid values: `60` to `604800`. Unit: seconds. Default value: `345600`.
        """
        return pulumi.get(self, "message_retention_period")
    ...
    @property
    @pulumi.getter(name="pollingWaitSeconds")
    def polling_wait_seconds(self) -> pulumi.Output[builtins.int]:
        """
        The maximum duration for which long polling requests are held after the ReceiveMessage operation is called. Valid values: `0` to `30`. Unit: seconds. Default value: `0`.
        """
        return pulumi.get(self, "polling_wait_seconds")
    ...
    @property
    @pulumi.getter(name="visibilityTimeout")
    def visibility_timeout(self) -> pulumi.Output[builtins.int]:
        """
        The duration for which a message stays in the Inactive state after the message is received from the queue. Valid values: `1` to `43200`. Unit: seconds. Default value: `30`.
        """
        return pulumi.get(self, "visibility_timeout")
