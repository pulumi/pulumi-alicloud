...
def get_domains(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.str status: The status of the resource. Valid values: "check_failed", "checking", "configure_failed", "configuring", "offline", "online".
    """
    __args__ = dict()
...
def get_domains_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:scdn/getDomains:getDomains', __args__, opts=opts, typ=GetDomainsResult)
