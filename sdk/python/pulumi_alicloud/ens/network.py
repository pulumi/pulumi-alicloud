...
class NetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] network_name: Name of the network instanceThe naming rules are as follows: 1. Length is 2~128 English or Chinese characters; 2. It must start with a large or small letter or Chinese, not with `http://` and `https://`; 3. Can contain numbers, colons (:), underscores (_), or dashes (-).
        """
...
class _NetworkState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ens_region_id: Ens node IDExample value: cn-beijing-telecom.
        :param pulumi.Input[_builtins.str] network_name: Name of the network instanceThe naming rules are as follows: 1. Length is 2~128 English or Chinese characters; 2. It must start with a large or small letter or Chinese, not with `http://` and `https://`; 3. Can contain numbers, colons (:), underscores (_), or dashes (-).
        :param pulumi.Input[_builtins.str] status: The status of the network instance. Pending: Configuring, Available: Available.
        """
