...
class VswitchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ens_region_id: ENS Region ID.
        :param pulumi.Input[builtins.str] description: The description of the vSwitch.
        :param pulumi.Input[builtins.str] network_id: The ID of the network to which the vSwitch that you want to create belongs.
...
class _VswitchState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cidr_block: The CIDR block of the vSwitch.
        :param pulumi.Input[builtins.str] create_time: The time when the VPC was created.
        :param pulumi.Input[builtins.str] description: The description of the vSwitch.
        :param pulumi.Input[builtins.str] ens_region_id: ENS Region ID.
        :param pulumi.Input[builtins.str] network_id: The ID of the network to which the vSwitch that you want to create belongs.
        :param pulumi.Input[builtins.str] status: The status of the vSwitch.
        :param pulumi.Input[builtins.str] vswitch_name: The name of the vSwitch.
        """
...
class Vswitch(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Vswitch':
        """
    ...
    @property
    @pulumi.getter(name="vswitchName")
    def vswitch_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the vSwitch.
        """
        return pulumi.get(self, "vswitch_name")
