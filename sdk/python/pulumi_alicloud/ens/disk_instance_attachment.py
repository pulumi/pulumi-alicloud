...
class DiskInstanceAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 delete_with_instance: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DiskInstanceAttachment resource.
        :param pulumi.Input[builtins.str] disk_id: The ID of the cloud disk to be mounted. The Cloud Disk (DiskId) and the instance (InstanceId) must be on the same node.
        :param pulumi.Input[builtins.str] instance_id: Instance ID.
        :param pulumi.Input[builtins.str] delete_with_instance: Whether the cloud disk to be mounted is released with the instance  Value: true: When the instance is released, the cloud disk is released together with the instance. false: When the instance is released, the cloud disk is retained and is not released together with the instance. Empty means false by default.
        """
    ...
    def delete_with_instance(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def delete_with_instance(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DiskInstanceAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            delete_with_instance: Optional[pulumi.Input[builtins.str]] = None,
            disk_id: Optional[pulumi.Input[builtins.str]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DiskInstanceAttachment':
        """
    ...
    @property
    @pulumi.getter(name="deleteWithInstance")
    def delete_with_instance(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether the cloud disk to be mounted is released with the instance  Value: true: When the instance is released, the cloud disk is released together with the instance. false: When the instance is released, the cloud disk is retained and is not released together with the instance. Empty means false by default.
        """
        return pulumi.get(self, "delete_with_instance")
