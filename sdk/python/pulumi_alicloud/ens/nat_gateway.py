...
class NatGatewayArgs:
    def __init__(__self__, *,
                 ...
                 nat_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] instance_type: NAT specifications. Value: `enat.default`.
        :param pulumi.Input[builtins.str] nat_name: The name of the NAT gateway. The length is 1 to 128 characters, but it cannot start with 'http:// 'or 'https.
        """
    ...
    def nat_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @nat_name.setter
    def nat_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NatGatewayState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: Creation time. UTC time, in the format of YYYY-MM-DDThh:mm:ssZ.
        :param pulumi.Input[builtins.str] ens_region_id: The ID of the ENS node.
        :param pulumi.Input[builtins.str] instance_type: NAT specifications. Value: `enat.default`.
        :param pulumi.Input[builtins.str] nat_name: The name of the NAT gateway. The length is 1 to 128 characters, but it cannot start with 'http:// 'or 'https.
        :param pulumi.Input[builtins.str] network_id: The network ID.
...
class NatGateway(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="natName")
    def nat_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the NAT gateway. The length is 1 to 128 characters, but it cannot start with 'http:// 'or 'https.
        """
        return pulumi.get(self, "nat_name")
