...
class EipInstanceAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 standby: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a EipInstanceAttachment resource.
        :param pulumi.Input[builtins.str] allocation_id: The first ID of the resource
        :param pulumi.Input[builtins.str] instance_id: Instance ID
        :param pulumi.Input[builtins.str] instance_type: The type of the EIP instance. Value:
               - `Nat`:NAT gateway.
               - `SlbInstance`: Server Load Balancer (ELB).
               - `NetworkInterface`: Secondary ENI.
               - `EnsInstance` (default): The ENS instance.
        :param pulumi.Input[builtins.bool] standby: Indicates whether the EIP is a backup EIP. Value:
               - true: Spare.
               - false: not standby.
        """
    ...
    @property
    @pulumi.getter
    def standby(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @standby.setter
    def standby(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class EipInstanceAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_type: Optional[pulumi.Input[builtins.str]] = None,
            standby: Optional[pulumi.Input[builtins.bool]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'EipInstanceAttachment':
        """
    ...
    @property
    @pulumi.getter
    def standby(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the EIP is a backup EIP. Value:
        - true: Spare.
        - false: not standby.
