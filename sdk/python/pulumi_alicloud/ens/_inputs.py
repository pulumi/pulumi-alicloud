...
if not MYPY:
    class InstanceDataDiskArgsDict(TypedDict):
        ...
        Cloud Disk ID.
        """
        encrypt_key_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InstanceDataDiskArgs:
    def __init__(__self__, *,
                 ...
                 encrypt_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 encrypted: Optional[pulumi.Input[builtins.bool]] = None,
                 size: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] category: Data disk type. Optional values:
               - cloud_efficiency: Ultra cloud disk
               - cloud_ssd: Full Flash cloud disk
               - local_hdd: local hdd disk
               - local_ssd: local disk ssd.
        :param pulumi.Input[builtins.str] disk_id: Cloud Disk ID.
        :param pulumi.Input[builtins.str] encrypt_key_id: The ID of the KMS key used by the cloud disk.
        :param pulumi.Input[builtins.bool] encrypted: Whether to encrypt the cloud disk. Value range:  true: Yes  false (default): No.
        :param pulumi.Input[builtins.int] size: Data disk size, unit: GB.
        """
    ...
    def encrypt_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the KMS key used by the cloud disk.
        """
    ...
    def encrypt_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class InstanceSystemDiskArgs:
    def __init__(__self__, *,
                 ...
                 size: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] category: System disk type. Value
               - cloud_efficiency: Ultra cloud disk
               - cloud_ssd: Full Flash cloud disk
               - local_hdd: local hdd disk
               - local_ssd: local disk ssd.
        :param pulumi.Input[builtins.int] size: System disk size, unit: GB.
        """
        if category is not None:
            pulumi.set(__self__, "category", category)
        if size is not None:
...
class LoadBalancerBackendServerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] server_id: Backend server instance ID  Example value: i-5vb5h5njxiuhn48a * * * *.
        :param pulumi.Input[builtins.str] ip: IP address of the backend server  Example value: 192.168.0.5.
        :param pulumi.Input[builtins.int] port: Port used by the backend server.
        :param pulumi.Input[builtins.str] type: Backend server type  Example value: ens.
        :param pulumi.Input[builtins.int] weight: Weight of the backend server  Example value: 100.
        """
