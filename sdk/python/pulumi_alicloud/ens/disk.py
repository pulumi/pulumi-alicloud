...
class DiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] encrypted: Specifies whether to encrypt the new system disk. Valid values: `true`, `false`(default).
        :param pulumi.Input[_builtins.str] kms_key_id: The ID of the KMS key used by the cloud disk. If `encrypted` is set to `true`, the service default key is used when KMSKeyId is empty.
        :param pulumi.Input[_builtins.int] size: The size of the disk instance. Unit: GiB.
        :param pulumi.Input[_builtins.str] snapshot_id: The ID of the snapshot used to create the cloud disk.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: The label to which the instance is bound.
        """
...
class Disk(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            snapshot_id: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'Disk':
        """
