...
class ImageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] delete_after_image_upload: Whether the instance is automatically released after the image is packaged and uploaded successfully, only the build machine is supported.  Optional values: true: When the instance is released, the image is released together with the instance. false: When the instance is released, the image is retained and is not released together with the instance. Empty means false by default.
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance corresponding to the image.
        """
...
class _ImageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: Image creation time.
        :param pulumi.Input[builtins.str] delete_after_image_upload: Whether the instance is automatically released after the image is packaged and uploaded successfully, only the build machine is supported.  Optional values: true: When the instance is released, the image is released together with the instance. false: When the instance is released, the image is retained and is not released together with the instance. Empty means false by default.
        :param pulumi.Input[builtins.str] image_name: Image Name.
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance corresponding to the image.
        :param pulumi.Input[builtins.str] status: Mirror Status  Optional values: Creating: Creating Packing: Packing Uploading: Uploading Pack_failed: Packing failed Upload_failed: Upload failed Available: Only images in the Available state can be used and operated. Unavailable: Not available Copying: Copying.
        """
