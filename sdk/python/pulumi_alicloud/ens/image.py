...
class ImageArgs:
    def __init__(__self__, *,
                 ...
                 delete_after_image_upload: Optional[pulumi.Input[builtins.str]] = None,
                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_oss_region_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Image resource.
        :param pulumi.Input[builtins.str] image_name: The name of the image. The name must be 2 to 128 characters in length. The name can contain letters, digits, colons (:), underscores (_), and hyphens (-). It must start with a letter but cannot start with http:// or https://. The name can contain letters, digits, colons (:), underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] delete_after_image_upload: Specifies whether to automatically release the instance after the image is packaged and uploaded. Only image builders are supported. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] target_oss_region_id: The region of the target OSS where the image is to be stored.
        """
    ...
    def delete_after_image_upload(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def delete_after_image_upload(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def target_oss_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_oss_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ImageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: The image creation time.
        :param pulumi.Input[builtins.str] delete_after_image_upload: Specifies whether to automatically release the instance after the image is packaged and uploaded. Only image builders are supported. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.str] image_name: The name of the image. The name must be 2 to 128 characters in length. The name can contain letters, digits, colons (:), underscores (_), and hyphens (-). It must start with a letter but cannot start with http:// or https://. The name can contain letters, digits, colons (:), underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] status: The state of the image.
        :param pulumi.Input[builtins.str] target_oss_region_id: The region of the target OSS where the image is to be stored.
        """
...
class Image(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:ens/image:Image"
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            target_oss_region_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Image':
        """
    ...
    @property
    @pulumi.getter(name="deleteAfterImageUpload")
    def delete_after_image_upload(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether to automatically release the instance after the image is packaged and uploaded. Only image builders are supported. Default value: `false`. Valid values:
        """
        return pulumi.get(self, "delete_after_image_upload")
    ...
    @property
    @pulumi.getter(name="targetOssRegionId")
    def target_oss_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The region of the target OSS where the image is to be stored.
        """
        return pulumi.get(self, "target_oss_region_id")
