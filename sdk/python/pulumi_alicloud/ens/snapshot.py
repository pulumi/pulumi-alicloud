...
class SnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ens_region_id: The node ID of ENS.
        :param pulumi.Input[builtins.str] description: Snapshot Description Information.
        :param pulumi.Input[builtins.str] snapshot_name: Name of the snapshot instance.
        """
...
class _SnapshotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: Instance creation timeIt is expressed in accordance with the ISO8601 standard and uses UTC +0 time in the format of yyyy-MM-ddTHH:mm:ssZ.Example value: 2020-08-20 T14:52:28Z.
        :param pulumi.Input[builtins.str] description: Snapshot Description Information.
        :param pulumi.Input[builtins.str] disk_id: Cloud Disk ID.
        :param pulumi.Input[builtins.str] ens_region_id: The node ID of ENS.
        :param pulumi.Input[builtins.str] snapshot_name: Name of the snapshot instance.
        :param pulumi.Input[builtins.str] status: Snapshot Status. Valid values: creating, available, deleting, error.
        """
...
class Snapshot(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:ens/snapshot:Snapshot"
