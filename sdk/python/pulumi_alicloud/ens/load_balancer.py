...
class LoadBalancerArgs:
    def __init__(__self__, *,
                 ...
                 load_balancer_spec: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] ens_region_id: The ID of the ENS node.
        :param pulumi.Input[builtins.str] load_balancer_spec: Specifications of the Server Load Balancer instance. Optional values: elb.s1.small,elb.s3.medium,elb.s2.small,elb.s2.medium,elb.s3.small.
        :param pulumi.Input[builtins.str] network_id: The network ID of the created edge load balancing (ELB) instance.
        :param pulumi.Input[builtins.str] payment_type: Server Load Balancer Instance Payment Type. Value:PayAsYouGo
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the vSwitch to which the VPC instance belongs.
        ...
        :param pulumi.Input[builtins.str] load_balancer_name: Name of the Server Load Balancer instance. The length is 1~80 English or Chinese characters. When this parameter is not specified, the system randomly assigns an instance name. Cannot start with http:// and https.
        """
    ...
    def load_balancer_spec(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def load_balancer_spec(self, value: pulumi.Input[builtins.str]):
...
class _LoadBalancerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['LoadBalancerBackendServerArgs']]] backend_servers: The list of backend servers. See `backend_servers` below.
        :param pulumi.Input[builtins.str] create_time: The creation Time (UTC) of the load balancing instance.
        :param pulumi.Input[builtins.str] ens_region_id: The ID of the ENS node.
        :param pulumi.Input[builtins.str] load_balancer_name: Name of the Server Load Balancer instance. The length is 1~80 English or Chinese characters. When this parameter is not specified, the system randomly assigns an instance name. Cannot start with http:// and https.
        :param pulumi.Input[builtins.str] load_balancer_spec: Specifications of the Server Load Balancer instance. Optional values: elb.s1.small,elb.s3.medium,elb.s2.small,elb.s2.medium,elb.s3.small.
        :param pulumi.Input[builtins.str] network_id: The network ID of the created edge load balancing (ELB) instance.
        :param pulumi.Input[builtins.str] payment_type: Server Load Balancer Instance Payment Type. Value:PayAsYouGo
        :param pulumi.Input[builtins.str] status: The status of the SLB instance.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the vSwitch to which the VPC instance belongs.
        """
        if backend_servers is not None:
            pulumi.set(__self__, "backend_servers", backend_servers)
...
class LoadBalancer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            payment_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LoadBalancer':
        """
