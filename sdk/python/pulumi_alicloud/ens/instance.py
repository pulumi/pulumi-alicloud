...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 schedule_area_level: pulumi.Input[builtins.str],
                 ...
                 auto_use_coupon: Optional[pulumi.Input[builtins.str]] = None,
                 billing_cycle: Optional[pulumi.Input[builtins.str]] = None,
                 carrier: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 net_district_code: Optional[pulumi.Input[builtins.str]] = None,
                 net_work_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 public_ip_identification: Optional[pulumi.Input[builtins.bool]] = None,
                 scheduling_price_strategy: Optional[pulumi.Input[builtins.str]] = None,
                 scheduling_strategy: Optional[pulumi.Input[builtins.str]] = None,
                 security_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_type: The specification of the instance. Example value: ens.sn1.small
        :param pulumi.Input[builtins.str] payment_type: Instance payment method. Since v1.230.0, you can modify payment_type. Optional values:
               - Subscription: prepaid, annual and monthly
               - PayAsYouGo: Pay by volume
        :param pulumi.Input[builtins.str] schedule_area_level: Scheduling level, through which node-level scheduling or area scheduling is performed. Optional values:
               - Node-level scheduling: Region
               - Regional scheduling: Big (region),Middle (province),Small (city)
        :param pulumi.Input[builtins.int] amount: The number of instances created, with a minimum of 1 and a maximum of 100
        :param pulumi.Input[builtins.str] auto_release_time: The automatic release time of the pay-as-you-go instance. According to the [ISO 8601] standard, UTC +0 time is used. The format is: 'yyyy-MM-ddTHH:mm:ssZ '.
        ...
        :param pulumi.Input[builtins.bool] auto_renew: Whether to automatically renew the logo. The default value is false. This parameter is invalid when you pay by volume.
        :param pulumi.Input[builtins.str] auto_use_coupon: Whether to use vouchers. The default is to use. Value:
               - true (used)
               - false (not used)
        :param pulumi.Input[builtins.str] billing_cycle: The billing cycle for instance computing resources. Only instance-level pay-as-you-go is supported. Value
               - Hour: hourly billing
               - Day: Daily billing
               - Month: monthly billing
        :param pulumi.Input[builtins.str] carrier: Operator, required for regional scheduling. Optional values:
               - cmcc (mobile)
               - unicom
               - telecom
        :param pulumi.Input[Sequence[pulumi.Input['InstanceDataDiskArgs']]] data_disks: Data disk specifications See `data_disk` below.
        :param pulumi.Input[builtins.str] ens_region_id: The node ID. When ScheduleAreaLevel is Region, EnsRegionId is required. When ScheduleAreaLevel is Big,Middle,Small, EnsRegionId is invalid.
        :param pulumi.Input[builtins.str] force_stop: Whether to force the identity when operating the instance. Optional values:
               - true: Force
               - false (default): non-mandatory
        :param pulumi.Input[builtins.str] host_name: The host name of the instance. Example value: test-HostName
        :param pulumi.Input[builtins.str] image_id: The image ID of the instance. The arm version card cannot be filled in. Other specifications are required. Example value: m-5si16wo6simkt267p8b7h * * * *
        :param pulumi.Input[builtins.bool] include_data_disks: Whether the Payment type of the disk created with the instance is converted.
        :param pulumi.Input[builtins.str] instance_charge_strategy: The instance billing policy. Optional values:
        ...
        :param pulumi.Input[builtins.str] instance_name: The instance name. Example value: test-InstanceName. It must be 2 to 128 characters in length and must start with an uppercase or lowercase letter or a Chinese character. It cannot start with http:// or https. Can contain Chinese, English, numbers, half-width colons (:), underscores (_), periods (.), or hyphens (-)
               
               The default value is the InstanceId of the instance.
        :param pulumi.Input[builtins.str] internet_charge_type: Instance bandwidth billing method. If the billing method can be selected for the first purchase, the subsequent value of this field will be processed by default according to the billing method selected for the first time. Optional values:
               - BandwidthByDay: Daily peak bandwidth
               - 95bandwidthbymonth: 95 peak bandwidth
        :param pulumi.Input[builtins.int] internet_max_bandwidth_out: Maximum public network bandwidth. The field type is Long, and the precision may be lost during serialization/deserialization. Please note that the value must not be greater than 9007199254740991
        :param pulumi.Input[builtins.str] ip_type: The IP type. Value:
               - ipv4 (default):IPv4
               - ipv6:IPv6
        ...
        :param pulumi.Input[builtins.str] net_district_code: The area code. Example value: 350000. Required for regional-level scheduling, invalid for node-level scheduling
        :param pulumi.Input[builtins.str] net_work_id: The network ID of the instance. Can only be used in node-level scheduling
        :param pulumi.Input[builtins.str] password: The instance password. At least one of Password, KeyPairName, and PasswordInherit
        :param pulumi.Input[builtins.bool] password_inherit: Whether to use image preset password prompt: Password and KeyPairNamePasswordInherit must be passed
        :param pulumi.Input[builtins.int] period: The duration of the resource purchase. Value method:
               - If PeriodUnit is set to Day, Period can only be set to 3.
               - If PeriodUnit is set to Month, Period can be set to 1-9,12.
        :param pulumi.Input[builtins.str] period_unit: The unit of time for purchasing resources. Value:
               - Month (default): purchase by Month
               - Day: buy by Day
        :param pulumi.Input[builtins.str] private_ip_address: The private IP address. Can only be used for node-level scheduling. If a private IP address is specified, the number of instances can only be one, and both the private IP address and the vSwitch ID are not empty, the private IP address takes effect.
        :param pulumi.Input[builtins.bool] public_ip_identification: Whether to assign a public IP identifier. Value:
               - true (default): Assign
               - false: do not assign
        :param pulumi.Input[builtins.str] scheduling_price_strategy: Scheduling price policy. If it is not filled in, the default priority is low price. Value:
               - PriceLowPriority
               - PriceLowPriority (priority low price)
        :param pulumi.Input[builtins.str] scheduling_strategy: Scheduling policy. Optional values:
               - Concentrate for node-level scheduling
               - For regional scheduling, Concentrate, Disperse
        :param pulumi.Input[builtins.str] security_id: ID of the security group to which the instance belongs.
        :param pulumi.Input[builtins.str] spot_strategy: The bidding strategy for pay-as-you-go instances. It takes effect when the value of the 'InstanceChargeType' parameter is set to 'PostPaid. Value range:
        ...
        :param pulumi.Input[builtins.str] status: Status of the instance
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag bound to the instance
        :param pulumi.Input[builtins.bool] unique_suffix: Indicates whether to add an ordered suffix to HostName and InstanceName. The ordered suffix starts from 001 and cannot exceed 999.
        :param pulumi.Input[builtins.str] user_data: User-defined data, maximum support 16KB. You can pass in the UserData information. The UserData is encoded in Base64 format.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the vSwitch to which the instance belongs. Can only be used in node-level scheduling
        """
    ...
    def schedule_area_level(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def schedule_area_level(self, value: pulumi.Input[builtins.str]):
    ...
    def auto_use_coupon(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def auto_use_coupon(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "auto_use_coupon", value)

    @property
    @pulumi.getter(name="billingCycle")
    def billing_cycle(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def billing_cycle(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "billing_cycle", value)

    @property
    @pulumi.getter
    def carrier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @carrier.setter
    def carrier(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def force_stop(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @force_stop.setter
    def force_stop(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def instance_charge_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def instance_charge_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def net_district_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def net_district_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "net_district_code", value)

    @property
    @pulumi.getter(name="netWorkId")
    def net_work_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @net_work_id.setter
    def net_work_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def public_ip_identification(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def public_ip_identification(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "public_ip_identification", value)

    @property
    @pulumi.getter(name="schedulingPriceStrategy")
    def scheduling_price_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def scheduling_price_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def scheduling_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scheduling_strategy", value)

    @property
    @pulumi.getter(name="securityId")
    def security_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @security_id.setter
    def security_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _InstanceState:
    def __init__(__self__, *,
                 ...
                 private_ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 public_ip_identification: Optional[pulumi.Input[builtins.bool]] = None,
                 schedule_area_level: Optional[pulumi.Input[builtins.str]] = None,
                 scheduling_price_strategy: Optional[pulumi.Input[builtins.str]] = None,
                 scheduling_strategy: Optional[pulumi.Input[builtins.str]] = None,
                 security_id: Optional[pulumi.Input[builtins.str]] = None,
                 spot_strategy: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="scheduleAreaLevel")
    def schedule_area_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Scheduling level, through which node-level scheduling or area scheduling is performed. Optional values:
        - Node-level scheduling: Region
        - Regional scheduling: Big (region),Middle (province),Small (city)
    ...
    @schedule_area_level.setter
    def schedule_area_level(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "schedule_area_level", value)
...
class Instance(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:ens/instance:Instance"
    ...
    @property
    @pulumi.getter(name="autoUseCoupon")
    def auto_use_coupon(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether to use vouchers. The default is to use. Value:
        - true (used)
        - false (not used)
    ...
    @property
    @pulumi.getter(name="billingCycle")
    def billing_cycle(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The billing cycle for instance computing resources. Only instance-level pay-as-you-go is supported. Value
        - Hour: hourly billing
        - Day: Daily billing
    ...
    @property
    @pulumi.getter
    def carrier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Operator, required for regional scheduling. Optional values:
        - cmcc (mobile)
        - unicom
    ...
    @property
    @pulumi.getter(name="forceStop")
    def force_stop(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether to force the identity when operating the instance. Optional values:
        - true: Force
        - false (default): non-mandatory
    ...
    @property
    @pulumi.getter(name="instanceChargeStrategy")
    def instance_charge_strategy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The instance billing policy. Optional values:
        - instance: instance granularity (the subscription method does not support instance)
        - user: user Dimension (user is not transmitted or supported in the prepaid mode)
    ...
    @property
    @pulumi.getter(name="ipType")
    def ip_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IP type. Value:
        - ipv4 (default):IPv4
        - ipv6:IPv6
    ...
    @property
    @pulumi.getter(name="netDistrictCode")
    def net_district_code(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The area code. Example value: 350000. Required for regional-level scheduling, invalid for node-level scheduling
        """
        return pulumi.get(self, "net_district_code")
    ...
    @property
    @pulumi.getter(name="netWorkId")
    def net_work_id(self) -> pulumi.Output[builtins.str]:
        """
        The network ID of the instance. Can only be used in node-level scheduling
        """
        return pulumi.get(self, "net_work_id")
    ...
    @property
    @pulumi.getter(name="publicIpIdentification")
    def public_ip_identification(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to assign a public IP identifier. Value:
        - true (default): Assign
        - false: do not assign
    ...
    @property
    @pulumi.getter(name="scheduleAreaLevel")
    def schedule_area_level(self) -> pulumi.Output[builtins.str]:
        """
        Scheduling level, through which node-level scheduling or area scheduling is performed. Optional values:
        - Node-level scheduling: Region
        - Regional scheduling: Big (region),Middle (province),Small (city)
    ...
    @property
    @pulumi.getter(name="schedulingPriceStrategy")
    def scheduling_price_strategy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Scheduling price policy. If it is not filled in, the default priority is low price. Value:
        - PriceLowPriority
        - PriceLowPriority (priority low price)
    ...
    @property
    @pulumi.getter(name="securityId")
    def security_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the security group to which the instance belongs.
        """
        return pulumi.get(self, "security_id")
    ...
    @property
    @pulumi.getter(name="uniqueSuffix")
    def unique_suffix(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether to add an ordered suffix to HostName and InstanceName. The ordered suffix starts from 001 and cannot exceed 999.
        """
        return pulumi.get(self, "unique_suffix")
