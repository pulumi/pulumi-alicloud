...
class ConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] code: Abnormal Alarm General Configuration Module by Using the Encoding. Valid values: `access_failed_cnt`, `access_permission_exprie_max_days`, `log_datasize_avg_days`.
        :param pulumi.Input[builtins.str] description: Abnormal Alarm General Description of the Configuration Item.
        :param pulumi.Input[builtins.str] lang: The language of the request and response. Valid values: `zh`,`en`.
        :param pulumi.Input[builtins.str] value: The Specified Exception Alarm Generic by Using the Value. Code Different Values for This Parameter the Specific Meaning of Different:
        """
        if code is not None:
