...
def get_configs(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Config IDs.
...
def get_configs_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
