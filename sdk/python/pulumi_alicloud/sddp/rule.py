...
class RuleArgs:
    def __init__(__self__, *,
                 category: pulumi.Input[builtins.int],
                 content: pulumi.Input[builtins.str],
                 rule_name: pulumi.Input[builtins.str],
                 content_category: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 risk_level_id: Optional[pulumi.Input[builtins.str]] = None,
                 rule_type: Optional[pulumi.Input[builtins.int]] = None,
                 stat_express: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.int]] = None,
                 target: Optional[pulumi.Input[builtins.str]] = None,
                 warn_level: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Rule resource.
        :param pulumi.Input[builtins.int] category: The content type of the sensitive data detection rule. Valid values:
        :param pulumi.Input[builtins.str] content: The content of the sensitive data detection rule. **NOTE:** From version 1.222.0, `content` can be modified.
        :param pulumi.Input[builtins.str] rule_name: The name of the sensitive data detection rule. **NOTE:** From version 1.222.0, `rule_name` can be modified.
        :param pulumi.Input[builtins.str] content_category: The type of the content in the sensitive data detection rule. **NOTE:** From version 1.222.0, `content_category` cannot be modified.
        :param pulumi.Input[builtins.str] description: The description of the rule. **NOTE:** From version 1.222.0, `description` cannot be modified.
        :param pulumi.Input[builtins.str] lang: The language of the content within the request and response. Default value: `zh`. Valid values:
        :param pulumi.Input[builtins.str] product_code: The name of the service to which data in the column of the table belongs. Valid values: `OSS`, `RDS`, `ODPS`(MaxCompute).
        :param pulumi.Input[builtins.str] product_id: The ID of the service to which the data asset belongs. Valid values:
        :param pulumi.Input[builtins.str] risk_level_id: The sensitivity level of the sensitive data that hits the sensitive data detection rule. Valid values:
        :param pulumi.Input[builtins.int] rule_type: The type of the sensitive data detection rule. Valid values:
        :param pulumi.Input[builtins.str] stat_express: The statistical expression. **NOTE:** From version 1.222.0, `stat_express` cannot be modified.
        :param pulumi.Input[builtins.int] status: Sensitive Specifies whether to enable the sensitive data detection rule. Valid values:
        :param pulumi.Input[builtins.str] target: The code of the service to which the sensitive data detection rule is applied. **NOTE:** From version 1.222.0, `target` cannot be modified.
        :param pulumi.Input[builtins.int] warn_level: The risk level of the alert that is triggered. Valid values:
        """
    ...
    @property
    @pulumi.getter
    def category(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @category.setter
    def category(self, value: pulumi.Input[builtins.int]):
    ...
    def content_category(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def content_category(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def risk_level_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def risk_level_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "risk_level_id", value)

    @property
    @pulumi.getter(name="ruleType")
    def rule_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @rule_type.setter
    def rule_type(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "rule_type", value)

    @property
    @pulumi.getter(name="statExpress")
    def stat_express(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @stat_express.setter
    def stat_express(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def warn_level(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @warn_level.setter
    def warn_level(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _RuleState:
    def __init__(__self__, *,
                 category: Optional[pulumi.Input[builtins.int]] = None,
                 content: Optional[pulumi.Input[builtins.str]] = None,
                 content_category: Optional[pulumi.Input[builtins.str]] = None,
                 custom_type: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 lang: Optional[pulumi.Input[builtins.str]] = None,
                 product_code: Optional[pulumi.Input[builtins.str]] = None,
                 product_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] content: The content of the sensitive data detection rule. **NOTE:** From version 1.222.0, `content` can be modified.
        :param pulumi.Input[builtins.str] content_category: The type of the content in the sensitive data detection rule. **NOTE:** From version 1.222.0, `content_category` cannot be modified.
        :param pulumi.Input[builtins.int] custom_type: The type of the sensitive data detection rule. **NOTE:** From version 1.222.0, `custom_type` cannot be specified when create Rule.
        :param pulumi.Input[builtins.str] description: The description of the rule. **NOTE:** From version 1.222.0, `description` cannot be modified.
        :param pulumi.Input[builtins.str] lang: The language of the content within the request and response. Default value: `zh`. Valid values:
        :param pulumi.Input[builtins.str] product_code: The name of the service to which data in the column of the table belongs. Valid values: `OSS`, `RDS`, `ODPS`(MaxCompute).
        :param pulumi.Input[builtins.str] product_id: The ID of the service to which the data asset belongs. Valid values:
    ...
    @property
    @pulumi.getter
    def category(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The content type of the sensitive data detection rule. Valid values:
        """
        return pulumi.get(self, "category")
    ...
    @category.setter
    def category(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "category", value)
    ...
    def custom_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @custom_type.setter
    def custom_type(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Rule(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:sddp/rule:Rule"
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.int]] = None,
            target: Optional[pulumi.Input[builtins.str]] = None,
            warn_level: Optional[pulumi.Input[builtins.int]] = None) -> 'Rule':
        """
    ...
    @property
    @pulumi.getter
    def category(self) -> pulumi.Output[builtins.int]:
        """
        The content type of the sensitive data detection rule. Valid values:
        """
        return pulumi.get(self, "category")
    ...
    @property
    @pulumi.getter(name="contentCategory")
    def content_category(self) -> pulumi.Output[builtins.str]:
        """
        The type of the content in the sensitive data detection rule. **NOTE:** From version 1.222.0, `content_category` cannot be modified.
        """
        return pulumi.get(self, "content_category")
    ...
    @property
    @pulumi.getter(name="customType")
    def custom_type(self) -> pulumi.Output[builtins.int]:
        """
        The type of the sensitive data detection rule. **NOTE:** From version 1.222.0, `custom_type` cannot be specified when create Rule.
        """
        return pulumi.get(self, "custom_type")
    ...
    @property
    @pulumi.getter(name="riskLevelId")
    def risk_level_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The sensitivity level of the sensitive data that hits the sensitive data detection rule. Valid values:
        """
        return pulumi.get(self, "risk_level_id")
    ...
    @property
    @pulumi.getter(name="ruleType")
    def rule_type(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The type of the sensitive data detection rule. Valid values:
        """
        return pulumi.get(self, "rule_type")
    ...
    @property
    @pulumi.getter(name="statExpress")
    def stat_express(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The statistical expression. **NOTE:** From version 1.222.0, `stat_express` cannot be modified.
        """
        return pulumi.get(self, "stat_express")
    ...
    @property
    @pulumi.getter(name="warnLevel")
    def warn_level(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The risk level of the alert that is triggered. Valid values:
        """
        return pulumi.get(self, "warn_level")
