...
class DataLimitArgs:
    def __init__(__self__, *,
                 ...
                 audit_status: Optional[pulumi.Input[builtins.int]] = None,
                 engine_type: Optional[pulumi.Input[builtins.str]] = None,
                 lang: Optional[pulumi.Input[builtins.str]] = None,
                 log_store_day: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_type: The type of the service to which the data asset belongs. Valid values: `MaxCompute`, `OSS`, `RDS`.
        :param pulumi.Input[builtins.int] audit_status: Whether to enable the log auditing feature. Valid values: `0`, `1`.
        :param pulumi.Input[builtins.str] engine_type: The type of the database. Valid values: `MySQL`, `SQLServer`.
        :param pulumi.Input[builtins.str] lang: The lang.
        :param pulumi.Input[builtins.int] log_store_day: The retention period of raw logs after you enable the log auditing feature. Unit: day. Valid values: `180`, `30`, `365`, `90`. **NOTE:** The`log_store_day` is valid when the `audit_status` is `1`.
        :param pulumi.Input[builtins.str] parent_id: The ID of the data asset.
        :param pulumi.Input[builtins.str] password: The password that is used to connect to the database.
        :param pulumi.Input[builtins.int] port: The port that is used to connect to the database.
        :param pulumi.Input[builtins.str] service_region_id: The region ID of the data asset.
        :param pulumi.Input[builtins.str] user_name: The name of the service to which the data asset belongs.
        """
    ...
    def audit_status(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @audit_status.setter
    def audit_status(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def log_store_day(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def log_store_day(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DataLimit(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_type: Optional[pulumi.Input[builtins.str]] = None,
            service_region_id: Optional[pulumi.Input[builtins.str]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None) -> 'DataLimit':
        """
    ...
    @property
    @pulumi.getter(name="auditStatus")
    def audit_status(self) -> pulumi.Output[builtins.int]:
        """
        Whether to enable the log auditing feature. Valid values: `0`, `1`.
        """
        return pulumi.get(self, "audit_status")
    ...
    @property
    @pulumi.getter(name="logStoreDay")
    def log_store_day(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The retention period of raw logs after you enable the log auditing feature. Unit: day. Valid values: `180`, `30`, `365`, `90`. **NOTE:** The`log_store_day` is valid when the `audit_status` is `1`.
        """
        return pulumi.get(self, "log_store_day")
    ...
    @property
    @pulumi.getter(name="serviceRegionId")
    def service_region_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The region ID of the data asset.
        """
        return pulumi.get(self, "service_region_id")
