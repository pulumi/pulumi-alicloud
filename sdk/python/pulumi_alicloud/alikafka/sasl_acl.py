...
class SaslAclArgs:
    def __init__(__self__, *,
                 acl_operation_type: pulumi.Input[builtins.str],
                 acl_resource_name: pulumi.Input[builtins.str],
                 acl_resource_pattern_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] acl_operation_type: Operation type for this acl. The operation type can only be "Write" and "Read".
        :param pulumi.Input[builtins.str] acl_resource_name: Resource name for this acl. The resource name should be a topic or consumer group name.
        :param pulumi.Input[builtins.str] acl_resource_pattern_type: Resource pattern type for this acl. The resource pattern support two types "LITERAL" and "PREFIXED". "LITERAL": A literal name defines the full name of a resource. The special wildcard character "*" can be used to represent a resource with any name. "PREFIXED": A prefixed name defines a prefix for a resource.
        :param pulumi.Input[builtins.str] acl_resource_type: Resource type for this acl. The resource type can only be "Topic", "Group". Since version 1.247.0, the resource type support "Cluster" and "TransactionalId".
        :param pulumi.Input[builtins.str] instance_id: ID of the ALIKAFKA Instance that owns the groups.
        :param pulumi.Input[builtins.str] username: Username for the sasl user. The length should between 1 to 64 characters. The user should be an existed sasl user.
        """
    ...
    def acl_operation_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def acl_operation_type(self, value: pulumi.Input[builtins.str]):
    ...
    def acl_resource_pattern_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def acl_resource_pattern_type(self, value: pulumi.Input[builtins.str]):
...
class _SaslAclState:
    def __init__(__self__, *,
                 acl_operation_type: Optional[pulumi.Input[builtins.str]] = None,
                 acl_resource_name: Optional[pulumi.Input[builtins.str]] = None,
                 acl_resource_pattern_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] acl_resource_pattern_type: Resource pattern type for this acl. The resource pattern support two types "LITERAL" and "PREFIXED". "LITERAL": A literal name defines the full name of a resource. The special wildcard character "*" can be used to represent a resource with any name. "PREFIXED": A prefixed name defines a prefix for a resource.
        :param pulumi.Input[builtins.str] acl_resource_type: Resource type for this acl. The resource type can only be "Topic", "Group". Since version 1.247.0, the resource type support "Cluster" and "TransactionalId".
        :param pulumi.Input[builtins.str] host: The host of the acl.
        :param pulumi.Input[builtins.str] instance_id: ID of the ALIKAFKA Instance that owns the groups.
        :param pulumi.Input[builtins.str] username: Username for the sasl user. The length should between 1 to 64 characters. The user should be an existed sasl user.
        """
    ...
    @property
    @pulumi.getter(name="aclOperationType")
    def acl_operation_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation type for this acl. The operation type can only be "Write" and "Read".
        """
        return pulumi.get(self, "acl_operation_type")
    ...
    @acl_operation_type.setter
    def acl_operation_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "acl_operation_type", value)
    ...
    @property
    @pulumi.getter(name="aclResourcePatternType")
    def acl_resource_pattern_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Resource pattern type for this acl. The resource pattern support two types "LITERAL" and "PREFIXED". "LITERAL": A literal name defines the full name of a resource. The special wildcard character "*" can be used to represent a resource with any name. "PREFIXED": A prefixed name defines a prefix for a resource.
        """
        return pulumi.get(self, "acl_resource_pattern_type")
    ...
    @acl_resource_pattern_type.setter
    def acl_resource_pattern_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "acl_resource_pattern_type", value)
...
class SaslAcl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            host: Optional[pulumi.Input[builtins.str]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'SaslAcl':
        """
    ...
    @property
    @pulumi.getter(name="aclOperationType")
    def acl_operation_type(self) -> pulumi.Output[builtins.str]:
        """
        Operation type for this acl. The operation type can only be "Write" and "Read".
        """
        return pulumi.get(self, "acl_operation_type")
    ...
    @property
    @pulumi.getter(name="aclResourcePatternType")
    def acl_resource_pattern_type(self) -> pulumi.Output[builtins.str]:
        """
        Resource pattern type for this acl. The resource pattern support two types "LITERAL" and "PREFIXED". "LITERAL": A literal name defines the full name of a resource. The special wildcard character "*" can be used to represent a resource with any name. "PREFIXED": A prefixed name defines a prefix for a resource.
        """
        return pulumi.get(self, "acl_resource_pattern_type")
