...
class SaslUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: ID of the ALIKAFKA Instance that owns the groups.
        :param pulumi.Input[builtins.str] username: The name of the SASL user. The length should between `1` to `64` characters. The characters can only contain `a`-`z`, `A`-`Z`, `0`-`9`, `_` and `-`.
        :param pulumi.Input[builtins.str] kms_encrypted_password: An KMS encrypts password used to a db account. You have to specify one of `password` and `kms_encrypted_password` fields.
        ...
        :param pulumi.Input[builtins.str] password: The password of the SASL user. It may consist of letters, digits, or underlines, with a length of 1 to 64 characters. You have to specify one of `password` and `kms_encrypted_password` fields.
        :param pulumi.Input[builtins.str] type: The authentication mechanism. Default value: `plain`. Valid values: `plain`, `scram`.
        """
...
class SaslUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'SaslUser':
        """
