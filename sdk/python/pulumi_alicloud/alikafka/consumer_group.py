...
class ConsumerGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] consumer_id: ID of the consumer group. The length cannot exceed 64 characters.
...
class ConsumerGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ConsumerGroup':
        """
