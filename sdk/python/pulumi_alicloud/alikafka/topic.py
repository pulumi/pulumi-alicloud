...
class TopicArgs:
    def __init__(__self__, *,
                 ...
                 remark: pulumi.Input[builtins.str],
                 topic: pulumi.Input[builtins.str],
                 compact_topic: Optional[pulumi.Input[builtins.bool]] = None,
                 local_topic: Optional[pulumi.Input[builtins.bool]] = None,
                 partition_num: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Topic resource.
        :param pulumi.Input[builtins.str] instance_id: InstanceId of your Kafka resource, the topic will create in this instance.
        :param pulumi.Input[builtins.str] remark: This attribute is a concise description of topic. The length cannot exceed 64.
        :param pulumi.Input[builtins.str] topic: Name of the topic. Two topics on a single instance cannot have the same name. The length cannot exceed 249 characters.
        :param pulumi.Input[builtins.bool] compact_topic: Whether the topic is compactTopic or not. Compact topic must be a localTopic.
        :param pulumi.Input[builtins.bool] local_topic: Whether the topic is localTopic or not.
        :param pulumi.Input[builtins.int] partition_num: The number of partitions of the topic. The number should between 1 and 48.
    ...
    @property
    @pulumi.getter
    def remark(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @remark.setter
    def remark(self, value: pulumi.Input[builtins.str]):
    ...
    def compact_topic(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def compact_topic(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "compact_topic", value)

    @property
    @pulumi.getter(name="localTopic")
    def local_topic(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @local_topic.setter
    def local_topic(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Topic(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:alikafka/topic:Topic"
    ...
    def get(resource_name: str,
            ...
            remark: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            topic: Optional[pulumi.Input[builtins.str]] = None) -> 'Topic':
        """
    ...
    @property
    @pulumi.getter(name="compactTopic")
    def compact_topic(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the topic is compactTopic or not. Compact topic must be a localTopic.
        """
        return pulumi.get(self, "compact_topic")
    ...
    @property
    @pulumi.getter(name="localTopic")
    def local_topic(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the topic is localTopic or not.
        """
        return pulumi.get(self, "local_topic")
