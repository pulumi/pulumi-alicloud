...
class InstanceAllowedIpAttachmentArgs:
    def __init__(__self__, *,
                 allowed_ip: pulumi.Input[builtins.str],
                 allowed_type: pulumi.Input[builtins.str],
                 instance_id: pulumi.Input[builtins.str],
                 port_range: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a InstanceAllowedIpAttachment resource.
        :param pulumi.Input[builtins.str] allowed_ip: The IP address whitelist. It can be a CIDR block.
        :param pulumi.Input[builtins.str] allowed_type: The type of the whitelist. Valid Value: `vpc`, `internet`. **NOTE:** From version 1.179.0, `allowed_type` can be set to `internet`.
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] port_range: The Port range. Valid Value: `9092/9092`, `9093/9093`, `9094/9094`, `9095/9095`. **NOTE:** From version 1.179.0, `port_range` can be set to `9093/9093`. From version 1.219.0, `port_range` can be set to `9094/9094`, `9095/9095`.
    ...
    def allowed_ip(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @allowed_ip.setter
    def allowed_ip(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "allowed_ip", value)

    @property
    @pulumi.getter(name="allowedType")
    def allowed_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @allowed_type.setter
    def allowed_type(self, value: pulumi.Input[builtins.str]):
    ...
    def port_range(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @port_range.setter
    def port_range(self, value: pulumi.Input[builtins.str]):
...
class _InstanceAllowedIpAttachmentState:
    def __init__(__self__, *,
                 allowed_ip: Optional[pulumi.Input[builtins.str]] = None,
                 allowed_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="allowedIp")
    def allowed_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IP address whitelist. It can be a CIDR block.
        """
        return pulumi.get(self, "allowed_ip")
    ...
    @allowed_ip.setter
    def allowed_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "allowed_ip", value)

    @property
    @pulumi.getter(name="allowedType")
    def allowed_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the whitelist. Valid Value: `vpc`, `internet`. **NOTE:** From version 1.179.0, `allowed_type` can be set to `internet`.
        """
        return pulumi.get(self, "allowed_type")
    ...
    @allowed_type.setter
    def allowed_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "allowed_type", value)
...
class InstanceAllowedIpAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            allowed_type: Optional[pulumi.Input[builtins.str]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            port_range: Optional[pulumi.Input[builtins.str]] = None) -> 'InstanceAllowedIpAttachment':
        """
    ...
    @property
    @pulumi.getter(name="allowedIp")
    def allowed_ip(self) -> pulumi.Output[builtins.str]:
        """
        The IP address whitelist. It can be a CIDR block.
        """
        return pulumi.get(self, "allowed_ip")
    ...
    @property
    @pulumi.getter(name="allowedType")
    def allowed_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the whitelist. Valid Value: `vpc`, `internet`. **NOTE:** From version 1.179.0, `allowed_type` can be set to `internet`.
        """
        return pulumi.get(self, "allowed_type")
