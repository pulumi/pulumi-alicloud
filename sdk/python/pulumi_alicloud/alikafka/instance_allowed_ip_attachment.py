...
class InstanceAllowedIpAttachmentArgs:
    def __init__(__self__, *,
                 allowed_ip: pulumi.Input[_builtins.str],
                 allowed_type: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] port_range: The Port range. Valid Value: `9092/9092`, `9093/9093`, `9094/9094`, `9095/9095`. **NOTE:** From version 1.179.0, `port_range` can be set to `9093/9093`. From version 1.219.0, `port_range` can be set to `9094/9094`, `9095/9095`.
    ...
    def allowed_ip(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @allowed_ip.setter
    def allowed_ip(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "allowed_ip", value)

    @_builtins.property
    @pulumi.getter(name="allowedType")
    def allowed_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @allowed_type.setter
    def allowed_type(self, value: pulumi.Input[_builtins.str]):
    ...
    def port_range(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @port_range.setter
    def port_range(self, value: pulumi.Input[_builtins.str]):
...
class InstanceAllowedIpAttachment(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="allowedIp")
    def allowed_ip(self) -> pulumi.Output[_builtins.str]:
        """
        The IP address whitelist. It can be a CIDR block.
        """
        return pulumi.get(self, "allowed_ip")
    ...
    @_builtins.property
    @pulumi.getter(name="allowedType")
    def allowed_type(self) -> pulumi.Output[_builtins.str]:
        """
        The type of the whitelist. Valid Value: `vpc`, `internet`. **NOTE:** From version 1.179.0, `allowed_type` can be set to `internet`.
        """
        return pulumi.get(self, "allowed_type")
