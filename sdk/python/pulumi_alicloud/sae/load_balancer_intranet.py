...
class LoadBalancerIntranetArgs:
    def __init__(__self__, *,
                 ...
                 intranet_slb_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a LoadBalancerIntranet resource.
        :param pulumi.Input[builtins.str] app_id: The target application ID that needs to be bound to the SLB.
        ...
        :param pulumi.Input[builtins.str] intranet_slb_id: The intranet SLB ID.
        """
    ...
    def intranet_slb_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The intranet SLB ID.
        """
    ...
    def intranet_slb_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _LoadBalancerIntranetState:
    def __init__(__self__, *,
                 ...
                 intranet_ip: Optional[pulumi.Input[builtins.str]] = None,
                 intranet_slb_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] app_id: The target application ID that needs to be bound to the SLB.
        :param pulumi.Input[builtins.str] intranet_ip: Use designated private network SLBs that have been purchased to support non-shared instances.
        :param pulumi.Input[builtins.str] intranet_slb_id: The intranet SLB ID.
        :param pulumi.Input[Sequence[pulumi.Input['LoadBalancerIntranetIntranetArgs']]] intranets: The bound private network SLB. See `intranet` below.
        """
    ...
    def intranet_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @intranet_ip.setter
    def intranet_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LoadBalancerIntranet(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="intranetIp")
    def intranet_ip(self) -> pulumi.Output[builtins.str]:
        """
        Use designated private network SLBs that have been purchased to support non-shared instances.
        """
        return pulumi.get(self, "intranet_ip")
    ...
    @property
    @pulumi.getter(name="intranetSlbId")
    def intranet_slb_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The intranet SLB ID.
        """
        return pulumi.get(self, "intranet_slb_id")
