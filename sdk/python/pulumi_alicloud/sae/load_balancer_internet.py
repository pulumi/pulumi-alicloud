...
class LoadBalancerInternetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] internet_slb_id: The internet SLB ID.
        """
...
class _LoadBalancerInternetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_id: The target application ID that needs to be bound to the SLB.
        :param pulumi.Input[builtins.str] internet_ip: Use designated public network SLBs that have been purchased to support non-shared instances.
        :param pulumi.Input[builtins.str] internet_slb_id: The internet SLB ID.
        :param pulumi.Input[Sequence[pulumi.Input['LoadBalancerInternetInternetArgs']]] internets: The bound private network SLB. See `internet` below.
        """
