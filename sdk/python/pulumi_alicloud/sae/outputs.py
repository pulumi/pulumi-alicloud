...
class ApplicationConfigMapMountDescV2(dict):
    ...
    def __init__(__self__, *,
                 config_map_id: Optional[builtins.str] = None,
                 key: Optional[builtins.str] = None,
                 mount_path: Optional[builtins.str] = None):
        """
        :param builtins.str config_map_id: The ID of the ConfigMap.
        :param builtins.str key: The key.
        :param builtins.str mount_path: The mount path.
        """
    ...
    def config_map_id(self) -> Optional[builtins.str]:
        """
...
class ApplicationCustomHostAliasV2(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str host_name: The domain name or hostname.
...
class ApplicationKafkaConfigs(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kafka_endpoint: Optional[builtins.str] = None,
                 kafka_instance_id: Optional[builtins.str] = None):
        """
        ...
        :param builtins.str kafka_endpoint: The endpoint of the ApsaraMQ for Kafka API.
        :param builtins.str kafka_instance_id: The  ID of the ApsaraMQ for Kafka instance.
        """
    ...
    def kafka_endpoint(self) -> Optional[builtins.str]:
        """
    ...
    def kafka_instance_id(self) -> Optional[builtins.str]:
        """
...
class ApplicationKafkaConfigsKafkaConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 log_dir: Optional[builtins.str] = None,
                 log_type: Optional[builtins.str] = None):
        """
        :param builtins.str kafka_topic: The topic of the Kafka.
        :param builtins.str log_dir: The path in which logs are stored.
        :param builtins.str log_type: The type of the log.
        """
    ...
    def log_dir(self) -> Optional[builtins.str]:
        """
...
class ApplicationLivenessV2(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int initial_delay_seconds: The delay of the health check.
        :param builtins.int period_seconds: The interval at which the health check is performed.
        :param 'ApplicationLivenessV2TcpSocketArgs' tcp_socket: The liveness check settings of the container. See `tcp_socket` below.
        :param builtins.int timeout_seconds: The timeout period of the health check.
        """
...
class ApplicationLivenessV2Exec(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] commands: Mirror start command. The command must be an executable object in the container. For example: sleep. Setting this command will cause the original startup command of the mirror to become invalid.
        """
...
class ApplicationLivenessV2HttpGet(dict):
    ...
    def __init__(__self__, *,
                 is_contain_key_word: Optional[builtins.bool] = None,
    ...
    def is_contain_key_word(self) -> Optional[builtins.bool]:
...
class ApplicationNasConfig(dict):
    ...
    def __init__(__self__, *,
                 mount_domain: Optional[builtins.str] = None,
                 mount_path: Optional[builtins.str] = None,
                 nas_id: Optional[builtins.str] = None,
                 nas_path: Optional[builtins.str] = None,
                 read_only: Optional[builtins.bool] = None):
        """
        :param builtins.str mount_domain: The domain name of the mount target.
        :param builtins.str mount_path: The mount path of the container.
        :param builtins.str nas_id: The ID of the NAS file system.
        :param builtins.str nas_path: The directory in the NAS file system.
        :param builtins.bool read_only: Specifies whether the application can read data from or write data to resources in the directory of the NAS. Valid values: `true` and `false`. If you set `read_only` to `false`, the application has the read and write permissions.
        """
    ...
    def mount_domain(self) -> Optional[builtins.str]:
        """
    ...
    def nas_id(self) -> Optional[builtins.str]:
        """
    ...
    def nas_path(self) -> Optional[builtins.str]:
        """
...
class ApplicationOssMountDescsV2(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str bucket_path: The directory or object in OSS.
        :param builtins.str mount_path: The path of the container in SAE.
        :param builtins.bool read_only: Specifies whether the application can use the container path to read data from or write data to resources in the directory of the OSS bucket. Valid values:
        """
...
class ApplicationPvtzDiscoverySvc(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enable: Enables the Kubernetes Service-based registration and discovery feature.
...
class ApplicationPvtzDiscoverySvcPortProtocol(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str protocol: The protocol. Valid values: `TCP` and `UDP`.
        """
        if port is not None:
            pulumi.set(__self__, "port", port)
...
class ApplicationScalingRuleScalingRuleMetric(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_replicas: Maximum number of instances applied.
        :param Sequence['ApplicationScalingRuleScalingRuleMetricMetricArgs'] metrics: Indicator rule configuration. See `metrics` below.
        :param builtins.int min_replicas: Minimum number of instances applied.
...
class ApplicationScalingRuleScalingRuleMetricMetric(dict):
    ...
    def __init__(__self__, *,
                 metric_target_average_utilization: Optional[builtins.int] = None,
                 metric_type: Optional[builtins.str] = None,
                 slb_id: Optional[builtins.str] = None,
                 slb_log_store: Optional[builtins.str] = None,
                 slb_project: Optional[builtins.str] = None,
                 vport: Optional[builtins.str] = None):
        """
        :param builtins.int metric_target_average_utilization: According to different `metric_type`, set the target value of the corresponding monitoring index.
        :param builtins.str metric_type: Monitoring indicator trigger condition. Valid values: `CPU`, `MEMORY`, `tcpActiveConn`, `QPS`, `RT`, `SLB_QPS`, `SLB_RT`, `INTRANET_SLB_QPS` and `INTRANET_SLB_RT`. The values are described as follows:
               - CPU: CPU usage.
               - MEMORY: MEMORY usage.
        ...
        :param builtins.str slb_id: SLB ID.
        :param builtins.str slb_log_store: The log store of the Log Service.
        :param builtins.str slb_project: The project of the Log Service.
        :param builtins.str vport: SLB listening port.
        """
    ...
    def metric_target_average_utilization(self) -> Optional[builtins.int]:
        """
    ...
    def slb_log_store(self) -> Optional[builtins.str]:
        """
    ...
    def slb_project(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def vport(self) -> Optional[builtins.str]:
        """
        SLB listening port.
        """
...
class ApplicationScalingRuleScalingRuleMetricScaleDownRules(dict):
    ...
    def __init__(__self__, *,
                 ...
                 step: Optional[builtins.int] = None):
        """
        :param builtins.bool disabled: Whether shrinkage is prohibited.
        :param builtins.int stabilization_window_seconds: Cooling time for expansion or contraction. Valid values: `0` to `3600`. Unit: seconds. The default is `0` seconds.
        :param builtins.int step: Elastic expansion or contraction step size. the maximum number of instances to be scaled in per unit time.
        """
    ...
    @property
    @pulumi.getter
    def step(self) -> Optional[builtins.int]:
        """
...
class ApplicationScalingRuleScalingRuleTimer(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str begin_date: The Start date. When the `begin_date` and `end_date` values are empty. it indicates long-term execution and is the default value.
        :param builtins.str end_date: The End Date. When the `begin_date` and `end_date` values are empty. it indicates long-term execution and is the default value.
        :param builtins.str period: The period in which a timed elastic scaling strategy is executed.
...
class ApplicationScalingRuleScalingRuleTimerSchedule(dict):
    ...
    def __init__(__self__, *,
                 at_time: Optional[builtins.str] = None,
                 max_replicas: Optional[builtins.int] = None,
                 min_replicas: Optional[builtins.int] = None,
                 target_replicas: Optional[builtins.int] = None):
        """
        :param builtins.str at_time: Trigger point in time. When supporting format: minutes, for example: `08:00`.
        :param builtins.int target_replicas: This parameter can specify the number of instances to be applied or the minimum number of surviving instances per deployment. value range [1,50]. > **NOTE:** The attribute is valid when the attribute `scaling_rule_type` is `timing`.
        """
    ...
    def at_time(self) -> Optional[builtins.str]:
        """
    ...
    def target_replicas(self) -> Optional[builtins.int]:
        """
...
class ApplicationTomcatConfigV2(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_threads: Optional[builtins.int] = None,
                 port: Optional[builtins.int] = None,
                 uri_encoding: Optional[builtins.str] = None,
                 use_body_encoding_for_uri: Optional[builtins.str] = None):
        """
        :param builtins.str context_path: The path.
        :param builtins.int max_threads: The maximum number of connections in the connection pool.
        :param builtins.int port: The port.
        :param builtins.str uri_encoding: The URI encoding scheme in the Tomcat container.
        :param builtins.str use_body_encoding_for_uri: Specifies whether to use the encoding scheme that is specified by BodyEncoding for URL.
        """
    ...
    def max_threads(self) -> Optional[builtins.int]:
        """
    ...
    def uri_encoding(self) -> Optional[builtins.str]:
        """
    ...
    def use_body_encoding_for_uri(self) -> Optional[builtins.str]:
        """
...
class ApplicationUpdateStrategyV2(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: The type of the release policy. Valid values: `GrayBatchUpdate` and `BatchUpdate`.
        """
...
class ApplicationUpdateStrategyV2BatchUpdate(dict):
    ...
    def __init__(__self__, *,
                 batch: Optional[builtins.int] = None,
                 batch_wait_time: Optional[builtins.int] = None,
                 release_type: Optional[builtins.str] = None):
        """
        :param builtins.int batch: The number of batches in which you want to release the instances.
        :param builtins.int batch_wait_time: The batch wait time.
        :param builtins.str release_type: The processing method for the batches. Valid values: `auto` and `manual`.
        """
    ...
    @property
    @pulumi.getter
    def batch(self) -> Optional[builtins.int]:
        """
    ...
    def batch_wait_time(self) -> Optional[builtins.int]:
        """
        The batch wait time.
        """
...
class GreyTagRouteDubboRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 method_name: Optional[builtins.str] = None,
                 service_name: Optional[builtins.str] = None,
                 version: Optional[builtins.str] = None):
        """
        :param builtins.str condition: The Conditional Patterns for Grayscale Rules. Valid values: `AND`, `OR`.
        :param builtins.str group: The service group.
        :param Sequence['GreyTagRouteDubboRuleItemArgs'] items: A list of conditions items. See `items` below.
        :param builtins.str method_name: The method name
        :param builtins.str service_name: The service name.
        :param builtins.str version: The service version.
        """
    ...
    def method_name(self) -> Optional[builtins.str]:
        """
        The method name
        """
...
class GreyTagRouteDubboRuleItem(dict):
    def __init__(__self__, *,
                 cond: Optional[builtins.str] = None,
                 expr: Optional[builtins.str] = None,
                 index: Optional[builtins.int] = None,
                 operator: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str expr: The parameter value gets the expression.
        :param builtins.int index: The parameter number.
        """
        if cond is not None:
    ...
    @property
    @pulumi.getter
    def cond(self) -> Optional[builtins.str]:
...
class GreyTagRouteScRule(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str path: The path corresponding to the grayscale rule.
        """
        if condition is not None:
            pulumi.set(__self__, "condition", condition)
        if items is not None:
...
class GreyTagRouteScRuleItem(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str type: The compare types. Valid values: `param`, `cookie`, `header`.
        """
        if cond is not None:
            pulumi.set(__self__, "cond", cond)
        if name is not None:
...
class IngressDefaultRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str app_id: Target application ID.
        :param builtins.str app_name: Target application name.
        :param builtins.int container_port: Application backend port.
        """
...
class IngressRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str app_name: Target application name.
        :param builtins.int container_port: Application backend port.
        :param builtins.str domain: Application domain name.
        :param builtins.str path: URL path.
        :param builtins.str backend_protocol: The backend protocol.
        :param builtins.str rewrite_path: The rewrite path.
        """
        pulumi.set(__self__, "app_id", app_id)
        pulumi.set(__self__, "app_name", app_name)
        pulumi.set(__self__, "container_port", container_port)
...
class LoadBalancerInternetInternet(dict):
    ...
    def __init__(__self__, *,
                 https_cert_id: Optional[builtins.str] = None,
                 port: Optional[builtins.int] = None,
                 protocol: Optional[builtins.str] = None,
                 target_port: Optional[builtins.int] = None):
        """
        :param builtins.str https_cert_id: The SSL certificate. `https_cert_id` is required when HTTPS is selected
        :param builtins.int port: The SLB Port.
        :param builtins.str protocol: The Network protocol. Valid values: `TCP` ,`HTTP`,`HTTPS`.
        :param builtins.int target_port: The Container port.
        """
    ...
    def https_cert_id(self) -> Optional[builtins.str]:
        """
...
class GetApplicationScalingRulesRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 scaling_rule_enable: builtins.bool,
                 scaling_rule_metrics: Sequence['outputs.GetApplicationScalingRulesRuleScalingRuleMetricResult'],
                 scaling_rule_name: builtins.str,
                 scaling_rule_timers: Sequence['outputs.GetApplicationScalingRulesRuleScalingRuleTimerResult'],
                 scaling_rule_type: builtins.str):
        """
        :param builtins.str app_id: The ID of the Application.
        :param builtins.str create_time: The CreateTime of the Application Scaling Rule.
        :param builtins.str id: The ID of the Application Scaling Rule.
        :param builtins.bool scaling_rule_enable: Whether to enable the auto scaling policy.
        ...
        :param builtins.str scaling_rule_name: The name of the scaling rule.
        :param Sequence['GetApplicationScalingRulesRuleScalingRuleTimerArgs'] scaling_rule_timers: Timing elastic expansion.
        :param builtins.str scaling_rule_type: Flexible strategy type.
        """
        pulumi.set(__self__, "app_id", app_id)
    ...
    def scaling_rule_enable(self) -> builtins.bool:
        """
    ...
    def scaling_rule_name(self) -> builtins.str:
        """
    ...
    def scaling_rule_type(self) -> builtins.str:
        """
...
class GetApplicationScalingRulesRuleScalingRuleMetricResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_replicas: The maximum number of instances.
        ...
        :param builtins.int min_replicas: The minimum number of instances.
...
class GetApplicationScalingRulesRuleScalingRuleMetricMetricResult(dict):
    def __init__(__self__, *,
                 metric_target_average_utilization: builtins.int,
                 metric_type: builtins.str):
        """
        :param builtins.int metric_target_average_utilization: The target value of the monitoring indicator.
        :param builtins.str metric_type: The metric type of the Application Scaling Rule.
        """
        pulumi.set(__self__, "metric_target_average_utilization", metric_target_average_utilization)
        pulumi.set(__self__, "metric_type", metric_type)
    ...
    @property
    @pulumi.getter(name="metricTargetAverageUtilization")
    def metric_target_average_utilization(self) -> builtins.int:
        """
...
class GetApplicationScalingRulesRuleScalingRuleMetricMetricsStatusResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.int current_replicas: The number of current instances.
        :param builtins.int desired_replicas: The number of target instances.
        :param builtins.str last_scale_time: The time of the last elastic expansion.
        :param builtins.int max_replicas: The maximum number of instances.
        :param builtins.int min_replicas: The minimum number of instances.
        ...
        :param builtins.int next_scale_time_period: The next cycle of monitoring indicator elasticity.
        """
    ...
    def last_scale_time(self) -> builtins.str:
        """
    ...
    def next_scale_time_period(self) -> builtins.int:
        """
...
class GetApplicationScalingRulesRuleScalingRuleMetricMetricsStatusCurrentMetricResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.int current_value: The current value.
        :param builtins.str name: The name of the trigger condition.
        :param builtins.str type: The metric type. Associated with monitoring indicators.
        """
...
class GetApplicationScalingRulesRuleScalingRuleMetricMetricsStatusNextScaleMetricResult(dict):
    def __init__(__self__, *,
                 name: builtins.str,
                 next_scale_in_average_utilization: builtins.int,
                 next_scale_out_average_utilization: builtins.int):
        """
        :param builtins.str name: The name of the trigger condition.
        :param builtins.int next_scale_in_average_utilization: The percentage value of the monitoring indicator elasticity that triggers the shrinkage condition next time.
        :param builtins.int next_scale_out_average_utilization: The percentage value of the monitoring indicator elasticity that triggers the expansion condition next time.
        """
        pulumi.set(__self__, "name", name)
    ...
    def next_scale_in_average_utilization(self) -> builtins.int:
        """
    ...
    def next_scale_out_average_utilization(self) -> builtins.int:
        """
...
class GetApplicationScalingRulesRuleScalingRuleMetricScaleDownRuleResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool disabled: Whether shrinkage is prohibited.
        :param builtins.int stabilization_window_seconds: Shrinkage cooling time.
        :param builtins.int step: Elastic shrinkage step. The maximum number of instances per unit time.
        """
        pulumi.set(__self__, "disabled", disabled)
        pulumi.set(__self__, "stabilization_window_seconds", stabilization_window_seconds)
        pulumi.set(__self__, "step", step)
    ...
    @property
    @pulumi.getter(name="stabilizationWindowSeconds")
    def stabilization_window_seconds(self) -> builtins.int:
        """
...
class GetApplicationScalingRulesRuleScalingRuleMetricScaleUpRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 step: builtins.int):
        """
        :param builtins.bool disabled: Whether shrinkage is prohibited. The values are described as follows:
        :param builtins.int stabilization_window_seconds: Expansion cooling time.
        :param builtins.int step: Flexible expansion step. The maximum number of instances per unit time.
        """
        pulumi.set(__self__, "disabled", disabled)
        pulumi.set(__self__, "stabilization_window_seconds", stabilization_window_seconds)
        pulumi.set(__self__, "step", step)
...
class GetApplicationScalingRulesRuleScalingRuleTimerResult(dict):
    def __init__(__self__, *,
                 begin_date: builtins.str,
                 end_date: builtins.str,
                 period: builtins.str,
                 schedules: Sequence['outputs.GetApplicationScalingRulesRuleScalingRuleTimerScheduleResult']):
        """
        :param builtins.str begin_date: The short-term start date of the timed elastic scaling strategy.
        :param builtins.str end_date: The short-term end date of the timed elastic scaling strategy.
        :param builtins.str period: The period in which a timed elastic scaling strategy is executed.
...
class GetApplicationScalingRulesRuleScalingRuleTimerScheduleResult(dict):
    def __init__(__self__, *,
                 at_time: builtins.str,
                 max_replicas: builtins.int,
                 min_replicas: builtins.int,
                 target_replicas: builtins.int):
        """
        :param builtins.str at_time: Time point. Format: `hours:minutes`.
        :param builtins.int max_replicas: The maximum number of instances.
        :param builtins.int min_replicas: The minimum number of instances.
        :param builtins.int target_replicas: The number of target instances.
        """
        pulumi.set(__self__, "at_time", at_time)
        pulumi.set(__self__, "max_replicas", max_replicas)
        pulumi.set(__self__, "min_replicas", min_replicas)
    ...
    @property
    @pulumi.getter(name="targetReplicas")
    def target_replicas(self) -> builtins.int:
        """
        The number of target instances.
        """
        return pulumi.get(self, "target_replicas")
...
class GetApplicationsApplicationResult(dict):
    def __init__(__self__, *,
                 acr_assume_role_arn: builtins.str,
                 acr_instance_id: builtins.str,
                 app_description: builtins.str,
                 app_name: builtins.str,
                 application_id: builtins.str,
                 command: builtins.str,
                 command_args: builtins.str,
                 config_map_mount_desc: builtins.str,
                 cpu: builtins.int,
                 create_time: builtins.str,
                 custom_host_alias: builtins.str,
                 edas_container_version: builtins.str,
                 envs: builtins.str,
                 id: builtins.str,
                 image_url: builtins.str,
                 jar_start_args: builtins.str,
                 jar_start_options: builtins.str,
                 jdk: builtins.str,
                 liveness: builtins.str,
                 memory: builtins.int,
                 min_ready_instances: builtins.int,
                 mount_descs: Sequence['outputs.GetApplicationsApplicationMountDescResult'],
                 mount_host: builtins.str,
                 namespace_id: builtins.str,
                 nas_id: builtins.str,
                 oss_ak_id: builtins.str,
                 oss_ak_secret: builtins.str,
                 oss_mount_descs: builtins.str,
                 ...
                 php_arms_config_location: builtins.str,
                 php_config: builtins.str,
                 php_config_location: builtins.str,
                 post_start: builtins.str,
                 pre_stop: builtins.str,
                 readiness: builtins.str,
                 region_id: builtins.str,
                 replicas: builtins.int,
                 repo_name: builtins.str,
                 repo_namespace: builtins.str,
                 repo_origin_type: builtins.str,
                 security_group_id: builtins.str,
                 sls_configs: builtins.str,
                 status: builtins.str,
                 tags: Mapping[str, builtins.str],
                 termination_grace_period_seconds: builtins.int,
                 timezone: builtins.str,
                 tomcat_config: builtins.str,
                 vpc_id: builtins.str,
                 vswitch_id: builtins.str,
                 war_start_options: builtins.str,
                 web_container: builtins.str):
        """
        :param builtins.str acr_assume_role_arn: The ARN of the RAM role required when pulling images across accounts.
        :param builtins.str acr_instance_id: The ID of the ACR EE instance.
        :param builtins.str app_description: Application description information. No more than 1024 characters.
        :param builtins.str app_name: Application Name. Combinations of numbers, letters, and dashes (-) are allowed. It must start with a letter and the maximum length is 36 characters.
        :param builtins.str application_id: The first ID of the resource.
        :param builtins.str command: Mirror start command. The command must be an executable object in the container. For example: sleep. Setting this command will cause the original startup command of the mirror to become invalid.
        :param builtins.str command_args: Mirror startup command parameters. The parameters required for the above start command. For example: 1d.
        :param builtins.str config_map_mount_desc: ConfigMap mount description.
        :param builtins.int cpu: The CPU required for each instance, in millicores, cannot be 0.
        :param builtins.str create_time: Indicates That the Application of the Creation Time.
        :param builtins.str custom_host_alias: Custom host mapping in the container. For example: [{"hostName":"samplehost","ip":"127.0.0.1"}].
        :param builtins.str edas_container_version: The operating environment used by the Pandora application.
        :param builtins.str envs: The virtual switch where the elastic network card of the application instance is located. The switch must be located in the aforementioned VPC. The switch also has a binding relationship with the SAE namespace. If it is left blank, the default is the vSwitch ID bound to the namespace.
        :param builtins.str id: The ID of the Application.
        :param builtins.str image_url: Mirror address. Only Image type applications can configure the mirror address.
        :param builtins.str jar_start_args: The JAR package starts application parameters. Application default startup command: $JAVA_HOME/bin/java $JarStartOptions -jar $CATALINA_OPTS "$package_path" $JarStartArgs.
        :param builtins.str jar_start_options: The JAR package starts the application option. Application default startup command: $JAVA_HOME/bin/java $JarStartOptions -jar $CATALINA_OPTS "$package_path" $JarStartArgs.
        :param builtins.str jdk: The JDK version that the deployment package depends on. Image type applications are not supported.
        :param builtins.str liveness: Container health check. Containers that fail the health check will be shut down and restored. Currently, only the method of issuing commands in the container is supported.
        :param builtins.int memory: The memory required for each instance, in MB, cannot be 0. One-to-one correspondence with CPU.
        :param builtins.int min_ready_instances: The Minimum Available Instance. On the Change Had Promised during the Available Number of Instances to Be.
        :param Sequence['GetApplicationsApplicationMountDescArgs'] mount_descs: Mount description information.
        :param builtins.str mount_host: Mount point of NAS in application VPC.
        :param builtins.str namespace_id: SAE namespace ID. Only namespaces whose names are lowercase letters and dashes (-) are supported, and must start with a letter. The namespace can be obtained by calling the DescribeNamespaceList interface.
        :param builtins.str nas_id: ID of the mounted NAS, Must be in the same region as the cluster. It must have an available mount point creation quota, or its mount point must be on a switch in the VPC. If it is not filled in and the mountDescs field is present, a NAS will be automatically purchased and mounted on the switch in the VPC by default.
        :param builtins.str oss_ak_id: OSS AccessKey ID.
        :param builtins.str oss_ak_secret: OSS  AccessKey Secret.
        :param builtins.str oss_mount_descs: OSS mount description information.
        :param Sequence['GetApplicationsApplicationOssMountDetailArgs'] oss_mount_details: The OSS mount detail.
        :param builtins.str package_type: Application package type. Support FatJar, War and Image.
        :param builtins.str package_url: Deployment package address. Only FatJar or War type applications can configure the deployment package address.
        :param builtins.str package_version: The version number of the deployment package. Required when the Package Type is War and FatJar.
        :param builtins.str php_arms_config_location: The PHP application monitors the mount path, and you need to ensure that the PHP server will load the configuration file of this path. You don't need to pay attention to the configuration content, SAE will automatically render the correct configuration file.
        :param builtins.str php_config: PHP configuration file content.
        :param builtins.str php_config_location: PHP application startup configuration mount path, you need to ensure that the PHP server will start using this configuration file.
        :param builtins.str post_start: Execute the script after startup, the format is like: {"exec":{"command":["cat","/etc/group"]}}.
        :param builtins.str pre_stop: Execute the script before stopping, the format is like: {"exec":{"command":["cat","/etc/group"]}}.
        :param builtins.str readiness: Application startup status checks, containers that fail multiple health checks will be shut down and restarted. Containers that do not pass the health check will not receive SLB traffic. For example: {"exec":{"command":["sh","-c","cat /home/admin/start.sh"]},"initialDelaySeconds":30,"periodSeconds":30,"timeoutSeconds ":2}.
        :param builtins.int replicas: Initial number of instances.
        :param builtins.str security_group_id: Security group ID.
        :param builtins.str sls_configs: SLS  configuration.
        ...
        :param builtins.int termination_grace_period_seconds: Graceful offline timeout, the default is 30, the unit is seconds. The value range is 1~60.
        :param builtins.str timezone: Time zone, the default value is Asia/Shanghai.
        :param builtins.str tomcat_config: Tomcat file configuration, set to "" or "{}" means to delete the configuration:  useDefaultConfig: Whether to use a custom configuration, if it is true, it means that the custom configuration is not used; if it is false, it means that the custom configuration is used. If you do not use custom configuration, the following parameter configuration will not take effect.  contextInputType: Select the access path of the application.  war: No need to fill in the custom path, the access path of the application is the WAR package name. root: No need to fill in the custom path, the access path of the application is /. custom: You need to fill in the custom path in the custom path below. contextPath: custom path, this parameter only needs to be configured when the contextInputType type is custom.  httpPort: The port range is 1024~65535. Ports less than 1024 need Root permission to operate. Because the container is configured with Admin permissions, please fill in a port greater than 1024. If not configured, the default is 8080. maxThreads: Configure the number of connections in the connection pool, the default size is 400. uriEncoding: Tomcat encoding format, including UTF-8, ISO-8859-1, GBK and GB2312. If not set, the default is ISO-8859-1. useBodyEncoding: Whether to use BodyEncoding for URL.
        :param builtins.str vpc_id: The VPC corresponding to the SAE namespace. In SAE, a namespace can only correspond to one VPC and cannot be modified. Creating a SAE application in the namespace for the first time will form a binding relationship. Multiple namespaces can correspond to a VPC. If you leave it blank, it will default to the VPC ID bound to the namespace.
        :param builtins.str vswitch_id: The vswitch id.
        :param builtins.str war_start_options: WAR package launch application option. Application default startup command: java $JAVA_OPTS $CATALINA_OPTS [-Options] org.apache.catalina.startup.Bootstrap "$@" start.
        :param builtins.str web_container: The version of tomcat that the deployment package depends on. Image type applications are not supported.
        """
    ...
    def acr_assume_role_arn(self) -> builtins.str:
        """
    ...
    def acr_instance_id(self) -> builtins.str:
        """
    ...
    def command_args(self) -> builtins.str:
        """
    ...
    def config_map_mount_desc(self) -> builtins.str:
        """
    ...
    def custom_host_alias(self) -> builtins.str:
        """
    ...
    def edas_container_version(self) -> builtins.str:
        """
    ...
    def jar_start_args(self) -> builtins.str:
        """
    ...
    def jar_start_options(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def liveness(self) -> builtins.str:
        """
    ...
    def mount_host(self) -> builtins.str:
        """
    ...
    def oss_ak_id(self) -> builtins.str:
        """
        OSS AccessKey ID.
        """
    ...
    def oss_ak_secret(self) -> builtins.str:
        """
    ...
    def oss_mount_descs(self) -> builtins.str:
        """
    ...
    def php_arms_config_location(self) -> builtins.str:
        """
    ...
    def php_config(self) -> builtins.str:
        """
    ...
    def php_config_location(self) -> builtins.str:
        """
    ...
    def post_start(self) -> builtins.str:
        """
    ...
    def pre_stop(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def readiness(self) -> builtins.str:
        """
    ...
    def repo_origin_type(self) -> builtins.str:
    ...
    def sls_configs(self) -> builtins.str:
        """
        SLS  configuration.
        """
    ...
    def termination_grace_period_seconds(self) -> builtins.int:
        """
    ...
    def tomcat_config(self) -> builtins.str:
        """
    ...
    def war_start_options(self) -> builtins.str:
        """
    ...
    def web_container(self) -> builtins.str:
        """
...
class GetApplicationsApplicationMountDescResult(dict):
    def __init__(__self__, *,
                 ...
                 nas_path: builtins.str):
        """
        :param builtins.str mount_path: Container mount path.
        :param builtins.str nas_path: NAS relative file directory.
        """
        pulumi.set(__self__, "mount_path", mount_path)
        pulumi.set(__self__, "nas_path", nas_path)
    ...
    @property
    @pulumi.getter(name="nasPath")
    def nas_path(self) -> builtins.str:
        """
...
class GetApplicationsApplicationOssMountDetailResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str bucket_path: The path of the bucket.
        :param builtins.str mount_path: The Container mount path.
        :param builtins.bool read_only: Whether the container path has readable permission to mount directory resources.
        """
        pulumi.set(__self__, "bucket_name", bucket_name)
        pulumi.set(__self__, "bucket_path", bucket_path)
        pulumi.set(__self__, "mount_path", mount_path)
...
class GetConfigMapsMapResult(dict):
    def __init__(__self__, *,
                 ...
                 namespace_id: builtins.str):
        """
        :param builtins.str config_map_id: The first ID of the resource.
        :param builtins.str create_time: The Creation Time of the ConfigMap.
        :param builtins.str data: ConfigMap instance data. The value's format is a `json` string
        :param builtins.str description: The Description of Config Map.
        :param builtins.str id: The ID of the Config Map.
        :param builtins.str name: ConfigMap instance name.
        :param builtins.str namespace_id: The NamespaceId of Config Maps.
        """
        pulumi.set(__self__, "config_map_id", config_map_id)
        pulumi.set(__self__, "create_time", create_time)
    ...
    @property
    @pulumi.getter(name="configMapId")
    def config_map_id(self) -> builtins.str:
        """
        The first ID of the resource.
        """
        return pulumi.get(self, "config_map_id")
...
class GetGreyTagRoutesRouteResult(dict):
    def __init__(__self__, *,
                 ...
                 grey_tag_route_name: builtins.str,
                 id: builtins.str,
                 sc_rules: Sequence['outputs.GetGreyTagRoutesRouteScRuleResult']):
        """
        :param builtins.str description: The description of GreyTagRoute.
        :param Sequence['GetGreyTagRoutesRouteDubboRuleArgs'] dubbo_rules: The grayscale rule created for Dubbo Application.
        :param builtins.str grey_tag_route_name: The name of GreyTagRoute.
        :param builtins.str id: The ID of the GreyTagRoute.
    ...
    def grey_tag_route_name(self) -> builtins.str:
        """
...
class GetGreyTagRoutesRouteDubboRuleResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str condition: The conditional Patterns for Grayscale Rules.
        :param builtins.str group: The service group.
...
class GetGreyTagRoutesRouteDubboRuleItemResult(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str cond: The comparison operator.
        :param builtins.str expr: The parameter value gets the expression.
        :param builtins.int index: The parameter number.
        :param builtins.str operator: The operator.
...
class GetGreyTagRoutesRouteScRuleItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the parameter.
        :param builtins.str operator: The operator.
        :param builtins.str type: The Compare types.
        :param builtins.str value: The value of the parameter.
        """
        pulumi.set(__self__, "cond", cond)
        pulumi.set(__self__, "name", name)
...
class GetIngressesIngressResult(dict):
    def __init__(__self__, *,
                 ...
                 slb_id: builtins.str):
        """
        :param builtins.str cert_id: Cert Id.
        :param builtins.str default_rule: Default Rule.
        :param builtins.str description: Description.
        :param builtins.str id: The ID of the Ingress.
        :param builtins.str ingress_id: The first ID of the resource.
        :param builtins.int listener_port: SLB listening port.
        :param builtins.str namespace_id: The Id of Namespace.It can contain 2 to 32 characters.The value is in format {RegionId}:{namespace}.
        :param builtins.str slb_id: SLB ID.
        """
    ...
    def ingress_id(self) -> builtins.str:
        """
        The first ID of the resource.
        """
...
class GetInstanceSpecificationsSpecificationResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 instance_specification_id: builtins.str,
                 memory: builtins.int,
                 spec_info: builtins.str,
                 version: builtins.int):
        """
        :param builtins.int cpu: CPU Size, Specifications for Micronucleus.
        :param builtins.bool enable: Whether the instance is available. The value description is as follows:
        :param builtins.str id: The ID of the Instance Specification.
        :param builtins.str instance_specification_id: The first ID of the resource.
        :param builtins.int memory: The Memory specifications for the MB.
        :param builtins.str spec_info: The specification configuration name.
        :param builtins.int version: The specification configuration version.
        """
        pulumi.set(__self__, "cpu", cpu)
        pulumi.set(__self__, "enable", enable)
        pulumi.set(__self__, "id", id)
    ...
    def instance_specification_id(self) -> builtins.str:
        """
        The first ID of the resource.
        """
    ...
    def spec_info(self) -> builtins.str:
        """
...
class GetNamespacesNamespaceResult(dict):
    def __init__(__self__, *,
                 id: builtins.str,
                 namespace_description: builtins.str,
                 namespace_id: builtins.str,
                 namespace_name: builtins.str):
        """
        :param builtins.str id: The ID of the Namespace.
        :param builtins.str namespace_description: The Description of Namespace.
        :param builtins.str namespace_id: The Id of Namespace.It can contain 2 to 32 characters.The value is in format {RegionId}:{namespace}.
        :param builtins.str namespace_name: The Name of Namespace.
        """
        pulumi.set(__self__, "id", id)
    ...
    def namespace_description(self) -> builtins.str:
        """
