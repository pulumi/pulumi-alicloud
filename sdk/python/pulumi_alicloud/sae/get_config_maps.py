...
def get_config_maps(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Config Map IDs.
    :param builtins.str name_regex: A regex string to filter results by Config Map name.
    :param builtins.str namespace_id: The NamespaceId of Config Maps. The Id of Namespace.It can contain 2 to 32 characters.The value is in format {RegionId}:{namespace}.
...
def get_config_maps_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
