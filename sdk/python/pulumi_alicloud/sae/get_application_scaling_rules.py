...
def get_application_scaling_rules(app_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Application Scaling Rule IDs.
...
def get_application_scaling_rules_output(app_id: Optional[pulumi.Input[_builtins.str]] = None,
