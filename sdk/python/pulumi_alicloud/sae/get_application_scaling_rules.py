...
def get_application_scaling_rules(app_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Application Scaling Rule IDs.
...
def get_application_scaling_rules_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
