...
class IngressArgs:
    def __init__(__self__, *,
                 ...
                 slb_id: pulumi.Input[builtins.str],
                 cert_id: Optional[pulumi.Input[builtins.str]] = None,
                 cert_ids: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 load_balance_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Ingress resource.
        :param pulumi.Input[builtins.int] listener_port: SLB listening port.
        :param pulumi.Input[builtins.str] namespace_id: The ID of Namespace. It can contain 2 to 32 lowercase characters.The value is in format `{RegionId}:{namespace}`.
        ...
        :param pulumi.Input[builtins.str] cert_id: The certificate ID of the HTTPS listener. The `cert_id` takes effect only when `load_balance_type` is set to `clb`.
        :param pulumi.Input[builtins.str] cert_ids: The certificate IDs of the HTTPS listener, and multiple certificate IDs are separated by commas. The `cert_ids` takes effect only when `load_balance_type` is set to `alb`.
        ...
        :param pulumi.Input[builtins.str] listener_protocol: The protocol that is used to forward requests. Default value: `HTTP`. Valid values: `HTTP`, `HTTPS`.
        :param pulumi.Input[builtins.str] load_balance_type: The type of the SLB instance. Default value: `clb`. Valid values: `clb`, `alb`.
        """
    ...
    def slb_id(self) -> pulumi.Input[builtins.str]:
        """
        SLB ID.
        """
    ...
    @slb_id.setter
    def slb_id(self, value: pulumi.Input[builtins.str]):
    ...
    def cert_ids(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cert_ids.setter
    def cert_ids(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def load_balance_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def load_balance_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Ingress(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace_id: Optional[pulumi.Input[builtins.str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['IngressRuleArgs', 'IngressRuleArgsDict']]]]] = None,
            slb_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Ingress':
        """
    ...
    @property
    @pulumi.getter(name="certId")
    def cert_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The certificate ID of the HTTPS listener. The `cert_id` takes effect only when `load_balance_type` is set to `clb`.
        """
        return pulumi.get(self, "cert_id")
    ...
    @property
    @pulumi.getter(name="certIds")
    def cert_ids(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The certificate IDs of the HTTPS listener, and multiple certificate IDs are separated by commas. The `cert_ids` takes effect only when `load_balance_type` is set to `alb`.
        """
        return pulumi.get(self, "cert_ids")
    ...
    @property
    @pulumi.getter(name="loadBalanceType")
    def load_balance_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the SLB instance. Default value: `clb`. Valid values: `clb`, `alb`.
        """
        return pulumi.get(self, "load_balance_type")
