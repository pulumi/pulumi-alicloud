...
class ApplicationScalingRuleArgs:
    def __init__(__self__, *,
                 ...
                 scaling_rule_name: pulumi.Input[builtins.str],
                 scaling_rule_type: pulumi.Input[builtins.str],
                 ...
                 scaling_rule_enable: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] app_id: Application ID.
        :param pulumi.Input[builtins.str] scaling_rule_name: The name of a custom elastic scaling policy. In the application, the policy name cannot be repeated. It must start with a lowercase letter, and can only contain lowercase letters, numbers, and dashes (-), and no more than 32 characters. After the scaling policy is successfully created, the policy name cannot be modified.
        :param pulumi.Input[builtins.str] scaling_rule_type: Flexible strategy type. Valid values: `mix`, `timing` and `metric`.
        :param pulumi.Input[builtins.int] min_ready_instance_ratio: The min ready instance ratio.
        :param pulumi.Input[builtins.int] min_ready_instances: The min ready instances.
        :param pulumi.Input[builtins.bool] scaling_rule_enable: True whether the auto scaling policy is enabled. The value description is as follows: true: enabled state. false: disabled status. Valid values: `false`, `true`.
    ...
    def scaling_rule_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def scaling_rule_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "scaling_rule_name", value)

    @property
    @pulumi.getter(name="scalingRuleType")
    def scaling_rule_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def scaling_rule_type(self, value: pulumi.Input[builtins.str]):
    ...
    def scaling_rule_enable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def scaling_rule_enable(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ApplicationScalingRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scaling_rule_name: Optional[pulumi.Input[builtins.str]] = None,
            scaling_rule_timer: Optional[pulumi.Input[Union['ApplicationScalingRuleScalingRuleTimerArgs', 'ApplicationScalingRuleScalingRuleTimerArgsDict']]] = None,
            scaling_rule_type: Optional[pulumi.Input[builtins.str]] = None) -> 'ApplicationScalingRule':
        """
    ...
    @property
    @pulumi.getter(name="minReadyInstanceRatio")
    def min_ready_instance_ratio(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The min ready instance ratio.
        """
        return pulumi.get(self, "min_ready_instance_ratio")
    ...
    @property
    @pulumi.getter(name="scalingRuleEnable")
    def scaling_rule_enable(self) -> pulumi.Output[builtins.bool]:
        """
        True whether the auto scaling policy is enabled. The value description is as follows: true: enabled state. false: disabled status. Valid values: `false`, `true`.
        """
        return pulumi.get(self, "scaling_rule_enable")
    ...
    @property
    @pulumi.getter(name="scalingRuleType")
    def scaling_rule_type(self) -> pulumi.Output[builtins.str]:
        """
        Flexible strategy type. Valid values: `mix`, `timing` and `metric`.
        """
        return pulumi.get(self, "scaling_rule_type")
