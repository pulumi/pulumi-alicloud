...
class ApplicationScalingRuleArgs:
    def __init__(__self__, *,
                 ...
                 scaling_rule_name: pulumi.Input[_builtins.str],
                 scaling_rule_type: pulumi.Input[_builtins.str],
                 ...
                 scaling_rule_enable: pulumi.Input[Optional[_builtins.bool]] = None,
                 scaling_rule_metric: pulumi.Input[Optional['ApplicationScalingRuleScalingRuleMetricArgs']] = None,
                 scaling_rule_timer: pulumi.Input[Optional['ApplicationScalingRuleScalingRuleTimerArgs']] = None):
        """
        ...
        :param pulumi.Input[_builtins.bool] scaling_rule_enable: True whether the auto scaling policy is enabled. The value description is as follows: true: enabled state. false: disabled status. Valid values: `false`, `true`.
    ...
    def scaling_rule_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def scaling_rule_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "scaling_rule_name", value)

    @_builtins.property
    @pulumi.getter(name="scalingRuleType")
    def scaling_rule_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def scaling_rule_type(self, value: pulumi.Input[_builtins.str]):
    ...
    def scaling_rule_enable(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def scaling_rule_enable(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "scaling_rule_enable", value)

    @_builtins.property
    @pulumi.getter(name="scalingRuleMetric")
    def scaling_rule_metric(self) -> pulumi.Input[Optional['ApplicationScalingRuleScalingRuleMetricArgs']]:
        """
    ...
    def scaling_rule_metric(self, value: pulumi.Input[Optional['ApplicationScalingRuleScalingRuleMetricArgs']]):
        pulumi.set(self, "scaling_rule_metric", value)

    @_builtins.property
    @pulumi.getter(name="scalingRuleTimer")
    def scaling_rule_timer(self) -> pulumi.Input[Optional['ApplicationScalingRuleScalingRuleTimerArgs']]:
        """
    ...
    def scaling_rule_timer(self, value: pulumi.Input[Optional['ApplicationScalingRuleScalingRuleTimerArgs']]):
...
@pulumi.type_token("alicloud:sae/applicationScalingRule:ApplicationScalingRule")
class ApplicationScalingRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 min_ready_instances: pulumi.Input[Optional[_builtins.int]] = None,
                 scaling_rule_enable: pulumi.Input[Optional[_builtins.bool]] = None,
                 scaling_rule_metric: pulumi.Input[Optional[Union['ApplicationScalingRuleScalingRuleMetricArgs', 'ApplicationScalingRuleScalingRuleMetricArgsDict', 'outputs.ApplicationScalingRuleScalingRuleMetric']]] = None,
                 scaling_rule_name: pulumi.Input[Optional[_builtins.str]] = None,
                 scaling_rule_timer: pulumi.Input[Optional[Union['ApplicationScalingRuleScalingRuleTimerArgs', 'ApplicationScalingRuleScalingRuleTimerArgsDict', 'outputs.ApplicationScalingRuleScalingRuleTimer']]] = None,
                 scaling_rule_type: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.int] min_ready_instances: The min ready instances.
        :param pulumi.Input[_builtins.bool] scaling_rule_enable: True whether the auto scaling policy is enabled. The value description is as follows: true: enabled state. false: disabled status. Valid values: `false`, `true`.
        :param pulumi.Input[Union['ApplicationScalingRuleScalingRuleMetricArgs', 'ApplicationScalingRuleScalingRuleMetricArgsDict', 'outputs.ApplicationScalingRuleScalingRuleMetric']] scaling_rule_metric: Monitor the configuration of the indicator elasticity strategy. See `scaling_rule_metric` below.
        :param pulumi.Input[_builtins.str] scaling_rule_name: The name of a custom elastic scaling policy. In the application, the policy name cannot be repeated. It must start with a lowercase letter, and can only contain lowercase letters, numbers, and dashes (-), and no more than 32 characters. After the scaling policy is successfully created, the policy name cannot be modified.
        :param pulumi.Input[Union['ApplicationScalingRuleScalingRuleTimerArgs', 'ApplicationScalingRuleScalingRuleTimerArgsDict', 'outputs.ApplicationScalingRuleScalingRuleTimer']] scaling_rule_timer: Configuration of Timing Resilient Policies. See `scaling_rule_timer` below.
        :param pulumi.Input[_builtins.str] scaling_rule_type: Flexible strategy type. Valid values: `mix`, `timing` and `metric`.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            scaling_rule_name: pulumi.Input[Optional[_builtins.str]] = None,
            scaling_rule_timer: pulumi.Input[Optional[Union['ApplicationScalingRuleScalingRuleTimerArgs', 'ApplicationScalingRuleScalingRuleTimerArgsDict', 'outputs.ApplicationScalingRuleScalingRuleTimer']]] = None,
            scaling_rule_type: pulumi.Input[Optional[_builtins.str]] = None) -> 'ApplicationScalingRule':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="minReadyInstanceRatio")
    def min_ready_instance_ratio(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The min ready instance ratio.
        """
        return pulumi.get(self, "min_ready_instance_ratio")
    ...
    @_builtins.property
    @pulumi.getter(name="scalingRuleEnable")
    def scaling_rule_enable(self) -> pulumi.Output[_builtins.bool]:
        """
        True whether the auto scaling policy is enabled. The value description is as follows: true: enabled state. false: disabled status. Valid values: `false`, `true`.
        """
        return pulumi.get(self, "scaling_rule_enable")
    ...
    @_builtins.property
    @pulumi.getter(name="scalingRuleType")
    def scaling_rule_type(self) -> pulumi.Output[_builtins.str]:
        """
        Flexible strategy type. Valid values: `mix`, `timing` and `metric`.
        """
        return pulumi.get(self, "scaling_rule_type")
