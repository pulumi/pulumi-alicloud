...
def get_instance_specifications(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Instance Specification IDs.
...
def get_instance_specifications_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:sae/getInstanceSpecifications:getInstanceSpecifications', __args__, opts=opts, typ=GetInstanceSpecificationsResult)
    return __ret__.apply(lambda __response__: GetInstanceSpecificationsResult(
