...
def get_grey_tag_routes(app_id: Optional[builtins.str] = None,
    ...
    :param builtins.str app_id: The ID  of the SAE Application.
    :param Sequence[builtins.str] ids: A list of GreyTagRoute IDs.
    :param builtins.str name_regex: A regex string to filter results by GreyTagRoute name.
...
def get_grey_tag_routes_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
