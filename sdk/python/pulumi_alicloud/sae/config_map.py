...
class ConfigMapArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data: ConfigMap instance data.
        :param pulumi.Input[builtins.str] namespace_id: The NamespaceId of ConfigMap.It can contain 2 to 32 lowercase characters.The value is in format `{RegionId}:{namespace}`
        :param pulumi.Input[builtins.str] description: The Description of ConfigMap.
        :param pulumi.Input[builtins.str] name: ConfigMap instance name.
        """
...
class ConfigMap(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            namespace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ConfigMap':
        """
