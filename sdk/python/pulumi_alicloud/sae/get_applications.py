...
class GetApplicationsResult:
    ...
    @property
    @pulumi.getter
    def reverse(self) -> Optional[builtins.bool]:
...
def get_applications(app_name: Optional[builtins.str] = None,
                     ...
                     reverse: Optional[builtins.bool] = None,
    ...
    :param builtins.str field_type: The field type. Valid values:`appName`, `appIds`, `slbIps`, `instanceIps`
    :param builtins.str field_value: The field value.
    ...
    :param builtins.str order_by: The order by.Valid values:`running`,`instances`.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.bool reverse: The reverse.
    :param builtins.str status: The status of the resource. Valid values: `RUNNING`, `STOPPED`,`UNKNOWN`.
    """
    __args__ = dict()
...
def get_applications_output(app_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                            field_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            ...
                            reverse: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
