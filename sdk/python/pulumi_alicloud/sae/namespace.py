...
class NamespaceArgs:
    def __init__(__self__, *,
                 ...
                 enable_micro_registration: Optional[pulumi.Input[builtins.bool]] = None,
                 namespace_description: Optional[pulumi.Input[builtins.str]] = None,
                 namespace_id: Optional[pulumi.Input[builtins.str]] = None,
                 namespace_short_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Namespace resource.
        :param pulumi.Input[builtins.str] namespace_name: The Name of Namespace.
        :param pulumi.Input[builtins.bool] enable_micro_registration: Specifies whether to enable the SAE built-in registry. If you do not use the built-in registry, you can set `enable_micro_registration` to `false` to accelerate the creation of the namespace. Default value: `true`. Valid values:
        :param pulumi.Input[builtins.str] namespace_description: The Description of Namespace.
        :param pulumi.Input[builtins.str] namespace_id: The ID of the Namespace. It can contain 2 to 32 lowercase characters. The value is in format `{RegionId}:{namespace}`.
        :param pulumi.Input[builtins.str] namespace_short_id: The short ID of the Namespace. You do not need to specify a region ID. The value of `namespace_short_id` can be up to 20 characters in length and can contain only lowercase letters and digits.
        """
    ...
    def enable_micro_registration(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_micro_registration(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_micro_registration", value)

    @property
    @pulumi.getter(name="namespaceDescription")
    def namespace_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def namespace_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def namespace_short_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def namespace_short_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("alicloud:sae/namespace:Namespace")
class Namespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace_id: Optional[pulumi.Input[builtins.str]] = None,
            namespace_name: Optional[pulumi.Input[builtins.str]] = None,
            namespace_short_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Namespace':
        """
    ...
    @property
    @pulumi.getter(name="enableMicroRegistration")
    def enable_micro_registration(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to enable the SAE built-in registry. If you do not use the built-in registry, you can set `enable_micro_registration` to `false` to accelerate the creation of the namespace. Default value: `true`. Valid values:
        """
        return pulumi.get(self, "enable_micro_registration")
    ...
    @property
    @pulumi.getter(name="namespaceDescription")
    def namespace_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Description of Namespace.
        """
        return pulumi.get(self, "namespace_description")
    ...
    @property
    @pulumi.getter(name="namespaceShortId")
    def namespace_short_id(self) -> pulumi.Output[builtins.str]:
        """
        The short ID of the Namespace. You do not need to specify a region ID. The value of `namespace_short_id` can be up to 20 characters in length and can contain only lowercase letters and digits.
        """
        return pulumi.get(self, "namespace_short_id")
