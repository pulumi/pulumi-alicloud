...
def get_ingresses(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ingress IDs.
    :param builtins.str namespace_id: The Id of Namespace.It can contain 2 to 32 lowercase characters.The value is in format `{RegionId}:{namespace}`
...
def get_ingresses_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
