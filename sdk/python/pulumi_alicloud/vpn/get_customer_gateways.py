...
def get_customer_gateways(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: ID of the VPN customer gateways.
    :param _builtins.str name_regex: A regex string of VPN customer gateways name.
...
def get_customer_gateways_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
