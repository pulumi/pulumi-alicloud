...
def get_customer_gateways(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: ID of the VPN customer gateways.
    :param builtins.str name_regex: A regex string of VPN customer gateways name.
...
def get_customer_gateways_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
