...
class ConnectionArgs:
    def __init__(__self__, *,
                 ...
                 auto_config_route: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] local_subnets: The CIDR block of the VPC to be connected with the local data center. This parameter is used for phase-two negotiation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] remote_subnets: The CIDR block of the local data center. This parameter is used for phase-two negotiation.
        :param pulumi.Input[builtins.str] vpn_gateway_id: The ID of the VPN gateway.
        :param pulumi.Input[builtins.bool] auto_config_route: Whether to configure routing automatically. Value:
        ...
        :param pulumi.Input[builtins.bool] enable_dpd: Wether enable Dpd detection.
        :param pulumi.Input[builtins.bool] enable_nat_traversal: enable nat traversal.
        :param pulumi.Input[builtins.bool] enable_tunnels_bgp: Enable tunnel bgp.
        ...
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.216.0. New field 'vpn_connection_name' instead.
        :param pulumi.Input[builtins.str] network_type: The network type of the IPsec connection. Value:
        ...
        :param pulumi.Input[builtins.str] vpn_connection_name: The name of the IPsec-VPN connection.
        """
    ...
    def auto_config_route(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_config_route(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] auto_config_route: Whether to configure routing automatically. Value:
               ...
               - **false**: does not automatically configure routes.
        :param pulumi.Input['ConnectionBgpConfigArgs'] bgp_config: vpnBgp configuration. See `bgp_config` below.
        :param pulumi.Input[builtins.int] create_time: The time when the IPsec-VPN connection was created.
        :param pulumi.Input[builtins.str] customer_gateway_id: The ID of the customer gateway.
        :param pulumi.Input[builtins.bool] effect_immediately: Indicates whether IPsec-VPN negotiations are initiated immediately. Valid values.
        :param pulumi.Input[builtins.bool] enable_dpd: Wether enable Dpd detection.
        :param pulumi.Input[builtins.bool] enable_nat_traversal: enable nat traversal.
...
class Connection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tunnel_options_specifications: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ConnectionTunnelOptionsSpecificationArgs', 'ConnectionTunnelOptionsSpecificationArgsDict']]]]] = None,
            vpn_connection_name: Optional[pulumi.Input[builtins.str]] = None,
            vpn_gateway_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Connection':
        """
    ...
    @property
    @pulumi.getter(name="autoConfigRoute")
    def auto_config_route(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to configure routing automatically. Value:
        - **true**: Automatically configure routes.
        - **false**: does not automatically configure routes.
