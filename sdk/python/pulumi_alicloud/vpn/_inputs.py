...
if not MYPY:
    class ConnectionBgpConfigArgsDict(TypedDict):
        ...
        """
        local_asn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConnectionBgpConfigArgs:
    def __init__(__self__, *,
                 ...
                 local_asn: Optional[pulumi.Input[builtins.str]] = None,
                 local_bgp_ip: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 tunnel_cidr: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enable: specifies whether to enable BGP. Valid values: true and false (default).
        :param pulumi.Input[builtins.str] local_asn: the autonomous system number (ASN) on the Alibaba Cloud side. 
               Valid values: 1 to 4294967295. Default value: 45104. You can enter a value in two segments separated by a period (.).
               Each segment is 16 bits in length. Enter the number in each segment in decimal format.
               For example, if you enter 123.456, the ASN is 8061384. The ASN is calculated by using the following formula: 123 × 65536 + 456 = 8061384.
        :param pulumi.Input[builtins.str] local_bgp_ip: the BGP address on the Alibaba Cloud side. It must be an IP address that falls within the CIDR block of the IPsec tunnel.
        :param pulumi.Input[builtins.str] status: The negotiation status of Tunnel.
        :param pulumi.Input[builtins.str] tunnel_cidr: The CIDR block of the IPsec tunnel. The CIDR block must belong to 169.254.0.0/16 and the subnet mask is 30 bits in length.
        """
    ...
    def local_asn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        the autonomous system number (ASN) on the Alibaba Cloud side. 
        Valid values: 1 to 4294967295. Default value: 45104. You can enter a value in two segments separated by a period (.).
        Each segment is 16 bits in length. Enter the number in each segment in decimal format.
    ...
    @local_asn.setter
    def local_asn(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ConnectionHealthCheckConfigArgsDict(TypedDict):
        dip: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        retry: NotRequired[pulumi.Input[builtins.int]]
        """
        the maximum number of health check retries. Default value: 3.
        """
        sip: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConnectionHealthCheckConfigArgs:
    def __init__(__self__, *,
                 dip: Optional[pulumi.Input[builtins.str]] = None,
                 enable: Optional[pulumi.Input[builtins.bool]] = None,
                 interval: Optional[pulumi.Input[builtins.int]] = None,
                 retry: Optional[pulumi.Input[builtins.int]] = None,
                 sip: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] dip: the destination IP address configured for health checks.
        :param pulumi.Input[builtins.bool] enable: specifies whether to enable health checks. Valid values: true and false. Default value: false.
        :param pulumi.Input[builtins.int] interval: the time interval of health check retries. Unit: seconds. Default value: 3.
        :param pulumi.Input[builtins.int] retry: the maximum number of health check retries. Default value: 3.
        :param pulumi.Input[builtins.str] sip: the source IP address that is used for health checks.
        """
        if dip is not None:
    ...
    @property
    @pulumi.getter
    def dip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        the destination IP address configured for health checks.
        """
    ...
    @dip.setter
    def dip(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def sip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        the source IP address that is used for health checks.
        """
...
if not MYPY:
    class ConnectionIkeConfigArgsDict(TypedDict):
        ...
        """
        ike_local_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        ike_pfs: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        ike_remote_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConnectionIkeConfigArgs:
    def __init__(__self__, *,
                 ike_auth_alg: Optional[pulumi.Input[builtins.str]] = None,
                 ike_enc_alg: Optional[pulumi.Input[builtins.str]] = None,
                 ike_lifetime: Optional[pulumi.Input[builtins.int]] = None,
                 ike_local_id: Optional[pulumi.Input[builtins.str]] = None,
                 ike_mode: Optional[pulumi.Input[builtins.str]] = None,
                 ike_pfs: Optional[pulumi.Input[builtins.str]] = None,
                 ike_remote_id: Optional[pulumi.Input[builtins.str]] = None,
                 ike_version: Optional[pulumi.Input[builtins.str]] = None,
                 psk: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ike_auth_alg: the authentication algorithm that is used in Phase 1 negotiations. Valid values: md5, sha1, sha2
        :param pulumi.Input[builtins.str] ike_enc_alg: the encryption algorithm that is used in Phase 1 negotiations. Valid values: aes, aes192, aes256, des, and 3des. Default value: aes.
        :param pulumi.Input[builtins.int] ike_lifetime: the SA lifetime as a result of Phase 1 negotiations. Unit: seconds. Valid values: 0 to 86400. Default value: 86400.
        :param pulumi.Input[builtins.str] ike_local_id: the identifier of the VPN gateway. It can contain at most 100 characters. The default value is the IP address of the VPN gateway.
        :param pulumi.Input[builtins.str] ike_mode: the negotiation mode of IKE. Valid values: main and aggressive. Default value: main.
               - main: This mode offers higher security during negotiations.
               - aggressive: This mode supports faster negotiations and a higher success rate.
        :param pulumi.Input[builtins.str] ike_pfs: the Diffie-Hellman key exchange algorithm that is used in Phase 1 negotiations. Valid values: group1, group2, group5, and group14. Default value: group2.
        :param pulumi.Input[builtins.str] ike_remote_id: the identifier of the customer gateway. It can contain at most 100 characters. The default value is the IP address of the customer gateway.
        :param pulumi.Input[builtins.str] ike_version: the version of the Internet Key Exchange (IKE) protocol. Valid values: ikev1 and ikev2. Default value: ikev1.
               Compared with IKEv1, IKEv2 simplifies the security association (SA) negotiation process and provides better support for scenarios with multiple CIDR blocks.
        :param pulumi.Input[builtins.str] psk: the pre-shared key that is used for identity authentication between the VPN gateway and the on-premises data center. The key must be 1 to 100 characters in length and can contain digits, letters, and the following special characters: ~!\\`@#$%^&*()_-+={}[]|;:',.<>/? If you do not specify a pre-shared key, the system randomly generates a 16-bit string as the pre-shared key. You can call the DescribeVpnConnection operation to query the pre-shared key that is automatically generated by the system.
        """
    ...
    def ike_auth_alg(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        the authentication algorithm that is used in Phase 1 negotiations. Valid values: md5, sha1, sha2
        """
    ...
    @ike_auth_alg.setter
    def ike_auth_alg(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ike_auth_alg", value)

    @property
    @pulumi.getter(name="ikeEncAlg")
    def ike_enc_alg(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        the encryption algorithm that is used in Phase 1 negotiations. Valid values: aes, aes192, aes256, des, and 3des. Default value: aes.
        """
    ...
    @ike_enc_alg.setter
    def ike_enc_alg(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ike_local_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        the identifier of the VPN gateway. It can contain at most 100 characters. The default value is the IP address of the VPN gateway.
        """
    ...
    @ike_local_id.setter
    def ike_local_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ike_pfs(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        the Diffie-Hellman key exchange algorithm that is used in Phase 1 negotiations. Valid values: group1, group2, group5, and group14. Default value: group2.
        """
    ...
    @ike_pfs.setter
    def ike_pfs(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ike_pfs", value)

    @property
    @pulumi.getter(name="ikeRemoteId")
    def ike_remote_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        the identifier of the customer gateway. It can contain at most 100 characters. The default value is the IP address of the customer gateway.
        """
    ...
    def ike_remote_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ConnectionIpsecConfigArgsDict(TypedDict):
        ipsec_auth_alg: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        ipsec_enc_alg: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        ipsec_pfs: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConnectionIpsecConfigArgs:
    def __init__(__self__, *,
                 ipsec_auth_alg: Optional[pulumi.Input[builtins.str]] = None,
                 ipsec_enc_alg: Optional[pulumi.Input[builtins.str]] = None,
                 ipsec_lifetime: Optional[pulumi.Input[builtins.int]] = None,
                 ipsec_pfs: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ipsec_auth_alg: the authentication algorithm that is used in Phase 2 negotiations. Valid values: md5, sha1, sha256, sha384, and sha512. Default value: md5.
        :param pulumi.Input[builtins.str] ipsec_enc_alg: the encryption algorithm that is used in Phase 2 negotiations. Valid values: aes, aes192, aes256, des, and 3des. Default value: aes.
        :param pulumi.Input[builtins.int] ipsec_lifetime: the SA lifetime that is determined by Phase 2 negotiations. Unit: seconds. Valid values: 0 to 86400. Default value: 86400.
        :param pulumi.Input[builtins.str] ipsec_pfs: the DH key exchange algorithm that is used in Phase 2 negotiations. Valid values: disabled, group1, group2, group5, and group14. Default value: group2.
        """
    ...
    def ipsec_auth_alg(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        the authentication algorithm that is used in Phase 2 negotiations. Valid values: md5, sha1, sha256, sha384, and sha512. Default value: md5.
        """
    ...
    def ipsec_auth_alg(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipsec_auth_alg", value)

    @property
    @pulumi.getter(name="ipsecEncAlg")
    def ipsec_enc_alg(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        the encryption algorithm that is used in Phase 2 negotiations. Valid values: aes, aes192, aes256, des, and 3des. Default value: aes.
        """
    ...
    def ipsec_enc_alg(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ipsec_pfs(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        the DH key exchange algorithm that is used in Phase 2 negotiations. Valid values: disabled, group1, group2, group5, and group14. Default value: group2.
        """
    ...
    @ipsec_pfs.setter
    def ipsec_pfs(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ConnectionTunnelOptionsSpecificationArgsDict(TypedDict):
        ...
        """
        enable_dpd: NotRequired[pulumi.Input[builtins.bool]]
        """
        Wether enable Dpd detection.
        """
        enable_nat_traversal: NotRequired[pulumi.Input[builtins.bool]]
        """
        enable nat traversal.
        """
        internet_ip: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        zone_no: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConnectionTunnelOptionsSpecificationArgs:
    def __init__(__self__, *,
                 ...
                 zone_no: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] customer_gateway_id: The ID of the customer gateway in Tunnel.
        ...
        :param pulumi.Input[builtins.str] internet_ip: The local internet IP in Tunnel.
        :param pulumi.Input[builtins.str] role: The role of Tunnel.
        :param pulumi.Input[builtins.str] state: The state of Tunnel.
        :param pulumi.Input[builtins.str] status: The negotiation status of Tunnel.
        ...
        :param pulumi.Input[builtins.str] tunnel_id: The tunnel ID of IPsec-VPN connection.
        ...
        :param pulumi.Input[builtins.str] zone_no: The zoneNo of tunnel.
        """
    ...
    def zone_no(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The zoneNo of tunnel.
        """
    ...
    @zone_no.setter
    def zone_no(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ConnectionTunnelOptionsSpecificationTunnelBgpConfigArgsDict(TypedDict):
        ...
        local_asn: NotRequired[pulumi.Input[builtins.str]]
        local_bgp_ip: NotRequired[pulumi.Input[builtins.str]]
        peer_asn: NotRequired[pulumi.Input[builtins.str]]
        """
        Peer asn.
        """
...
class ConnectionTunnelOptionsSpecificationTunnelBgpConfigArgs:
    def __init__(__self__, *,
                 ...
                 local_asn: Optional[pulumi.Input[builtins.str]] = None,
                 local_bgp_ip: Optional[pulumi.Input[builtins.str]] = None,
                 peer_asn: Optional[pulumi.Input[builtins.str]] = None,
                 peer_bgp_ip: Optional[pulumi.Input[builtins.str]] = None,
                 tunnel_cidr: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] bgp_status: Whether BGP function is turned on.
        :param pulumi.Input[builtins.str] peer_asn: Peer asn.
        :param pulumi.Input[builtins.str] peer_bgp_ip: Peer bgp ip.
        """
    ...
    def peer_asn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Peer asn.
        """
    ...
    @peer_asn.setter
    def peer_asn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ConnectionTunnelOptionsSpecificationTunnelIkeConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] local_id: The identifier of the tunnel on the Alibaba Cloud side, which is used in Phase 1 negotiations. It can contain at most 100 characters. The default value is the IP address of the tunnel.
               LocalId supports fully qualified domain names (FQDNs). If you use an FQDN, we recommend that you set the negotiation mode to aggressive.
        :param pulumi.Input[builtins.str] remote_id: The identifier of the tunnel peer, which is used in Phase 1 negotiations. It can contain at most 100 characters. The default value is the IP address of the customer gateway that is associated with the tunnel.
               RemoteId supports FQDNs. If you use an FQDN, we recommend that you set the negotiation mode to aggressive.
        """
        if ike_auth_alg is not None:
            pulumi.set(__self__, "ike_auth_alg", ike_auth_alg)
...
class GatewayVpnAttachmentBgpConfigArgs:
    def __init__(__self__, *,
                 ...
                 tunnel_cidr: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enable: Whether to enable the BGP function. Valid values: true or false (default).
        :param pulumi.Input[builtins.int] local_asn: The autonomous system number on the Alibaba Cloud side. The value range of autonomous system number is 1~4294967295. Default value: 45104
        :param pulumi.Input[builtins.str] local_bgp_ip: The BGP address on the Alibaba Cloud side. This address is an IP address in the IPsec tunnel network segment.
               - Before adding the BGP configuration, we recommend that you understand the working mechanism and usage restrictions of the BGP dynamic routing function. For more information, see BGP Dynamic Routing Bulletin.
               - We recommend that you use the private number of the autonomous system number to establish a BGP connection with Alibaba Cloud. Please refer to the documentation for the private number range of the autonomous system number.
        :param pulumi.Input[builtins.str] status: The negotiation status of Tunnel.
        :param pulumi.Input[builtins.str] tunnel_cidr: IPsec tunnel network segment. This network segment must be a network segment with a mask length of 30 within 169.254.0.0/16
        """
        if enable is not None:
            pulumi.set(__self__, "enable", enable)
        if local_asn is not None:
...
class GatewayVpnAttachmentHealthCheckConfigArgs:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] dip: Target IP.
        :param pulumi.Input[builtins.bool] enable: Whether health check is enabled:-`false`: not enabled. - `true`: enabled.
        :param pulumi.Input[builtins.int] interval: The health check retry interval, in seconds.
        :param pulumi.Input[builtins.str] policy: Whether to revoke the published route when the health check fails
        :param pulumi.Input[builtins.int] retry: Number of retries for health check.
        :param pulumi.Input[builtins.str] sip: SOURCE IP.
        :param pulumi.Input[builtins.str] status: The negotiation status of Tunnel.
        """
        if dip is not None:
            pulumi.set(__self__, "dip", dip)
...
class GatewayVpnAttachmentIkeConfigArgs:
    def __init__(__self__, *,
                 ...
                 remote_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ike_auth_alg: The authentication algorithm negotiated in the first stage. Valid values: md5, sha1, sha256, sha384, sha512. Default value: md5.
        :param pulumi.Input[builtins.str] ike_enc_alg: The encryption algorithm that is used in Phase 1 negotiations. Valid values: aes, aes192, aes256, des, and 3des. Default value: aes.
        :param pulumi.Input[builtins.int] ike_lifetime: The SA lifetime as a result of Phase 1 negotiations. Unit: seconds. Valid values: 0 to 86400. Default value: 86400.
        :param pulumi.Input[builtins.str] ike_mode: IKE mode, the negotiation mode. Valid values: main and aggressive. Default value: main.
        :param pulumi.Input[builtins.str] ike_pfs: The Diffie-Hellman key exchange algorithm used in the first stage negotiation. Valid values: group1, group2, group5, or group14. Default value: group2.
        :param pulumi.Input[builtins.str] ike_version: The version of the IKE protocol. Value: ikev1 or ikev2. Default value: ikev1.
        :param pulumi.Input[builtins.str] local_id: The identifier on the Alibaba Cloud side of the IPsec connection. The length is limited to 100 characters. The default value is leftId-not-exist
        :param pulumi.Input[builtins.str] psk: A pre-shared key for authentication between the VPN gateway and the local data center. The key length is 1~100 characters.
               - If you do not specify a pre-shared key, the system randomly generates a 16-bit string as the pre-shared key.
               - The pre-shared key of the IPsec-VPN connection must be the same as the authentication key of the on-premises data center. Otherwise, connections between the on-premises data center and the VPN gateway cannot be established.
        :param pulumi.Input[builtins.str] remote_id: The identifier of the IPsec connection to the local data center. The length is limited to 100 characters. The default value is the IP address of the user gateway.
        """
        if ike_auth_alg is not None:
            pulumi.set(__self__, "ike_auth_alg", ike_auth_alg)
        if ike_enc_alg is not None:
...
class GatewayVpnAttachmentIpsecConfigArgs:
    def __init__(__self__, *,
                 ...
                 ipsec_pfs: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ipsec_auth_alg: The authentication algorithm negotiated in the second stage. Valid values: md5, sha1, sha256, sha384, sha512. Default value: MD5.
        :param pulumi.Input[builtins.str] ipsec_enc_alg: The encryption algorithm negotiated in the second stage. Valid values: aes, aes192, aes256, des, or 3des. Default value: aes.
        :param pulumi.Input[builtins.int] ipsec_lifetime: The life cycle of SA negotiated in the second stage. Unit: seconds. Value range: 0~86400. Default value: 86400.
        :param pulumi.Input[builtins.str] ipsec_pfs: Diffie-Hellman Key Exchange Algorithm Used in Second Stage Negotiation
        """
        if ipsec_auth_alg is not None:
            pulumi.set(__self__, "ipsec_auth_alg", ipsec_auth_alg)
        if ipsec_enc_alg is not None:
...
if not MYPY:
    class GatewayVpnAttachmentTunnelOptionsSpecificationArgsDict(TypedDict):
        ...
        """
        tunnel_index: pulumi.Input[builtins.int]
        """
...
class GatewayVpnAttachmentTunnelOptionsSpecificationArgs:
    def __init__(__self__, *,
                 ...
                 zone_no: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] customer_gateway_id: The ID of the user gateway associated with the tunnel.
               
               > **NOTE:**  This parameter is required when creating a dual-tunnel mode IPsec-VPN connection.
        :param pulumi.Input[builtins.int] tunnel_index: The order in which the tunnel was created.
        :param pulumi.Input[builtins.bool] enable_dpd: Whether the DPD (peer alive detection) function is enabled for the tunnel. Value:
        :param pulumi.Input[builtins.bool] enable_nat_traversal: Whether the NAT crossing function is enabled for the tunnel. Value:
        :param pulumi.Input[builtins.str] internet_ip: The local internet IP in Tunnel.
        :param pulumi.Input[builtins.str] role: The role of Tunnel.
        :param pulumi.Input[builtins.str] state: The state of Tunnel.
        :param pulumi.Input[builtins.str] status: The negotiation status of Tunnel.
    ...
    def tunnel_index(self) -> pulumi.Input[builtins.int]:
        """
        The order in which the tunnel was created.
        """
    ...
    @tunnel_index.setter
    def tunnel_index(self, value: pulumi.Input[builtins.int]):
...
class GatewayVpnAttachmentTunnelOptionsSpecificationTunnelBgpConfigArgs:
    def __init__(__self__, *,
                 ...
                 tunnel_cidr: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] bgp_status: BGP status.
        :param pulumi.Input[builtins.str] peer_asn: Peer asn.
        :param pulumi.Input[builtins.str] peer_bgp_ip: Peer bgp ip.
        """
        if bgp_status is not None:
...
class IpsecServerIkeConfigArgs:
    def __init__(__self__, *,
                 ...
                 remote_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ike_auth_alg: The authentication algorithm that is used in Phase 1 negotiations. Default value: `sha1`.
        :param pulumi.Input[builtins.str] ike_enc_alg: The encryption algorithm that is used in Phase 1 negotiations. Default value: `aes`.
        :param pulumi.Input[builtins.int] ike_lifetime: IkeLifetime: the SA lifetime determined by Phase 1 negotiations. Valid values: `0` to `86400`. Default value: `86400`. Unit: `seconds`.
        :param pulumi.Input[builtins.str] ike_mode: The IKE negotiation mode. Default value: `main`.
        :param pulumi.Input[builtins.str] ike_pfs: The Diffie-Hellman key exchange algorithm that is used in Phase 1 negotiations. Default value: `group2`.
        :param pulumi.Input[builtins.str] ike_version: The IKE version. Valid values: `ikev1` and `ikev2`. Default value: `ikev2`.
        :param pulumi.Input[builtins.str] local_id: The identifier of the IPsec server. The value can be a fully qualified domain name (FQDN) or an IP address. The default value is the public IP address of the VPN gateway.
        :param pulumi.Input[builtins.str] remote_id: The identifier of the customer gateway. The value can be an FQDN or an IP address. By default, this parameter is not specified.
        """
        if ike_auth_alg is not None:
            pulumi.set(__self__, "ike_auth_alg", ike_auth_alg)
        if ike_enc_alg is not None:
...
class IpsecServerIpsecConfigArgs:
    def __init__(__self__, *,
                 ...
                 ipsec_pfs: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ipsec_auth_alg: The authentication algorithm that is used in Phase 2 negotiations. Default value: `sha1`.
        :param pulumi.Input[builtins.str] ipsec_enc_alg: The encryption algorithm that is used in Phase 2 negotiations. Default value: `aes`.
        :param pulumi.Input[builtins.int] ipsec_lifetime: The SA lifetime determined by Phase 2 negotiations. Valid values: `0` to `86400`. Default value: `86400`. Unit: `seconds`.
        :param pulumi.Input[builtins.str] ipsec_pfs: Forwards packets of all protocols. The Diffie-Hellman key exchange algorithm used in Phase 2 negotiations. Default value: `group2`.
        """
        if ipsec_auth_alg is not None:
            pulumi.set(__self__, "ipsec_auth_alg", ipsec_auth_alg)
        if ipsec_enc_alg is not None:
