...
class GatewayVpnAttachmentBgpConfigArgs:
    def __init__(__self__, *,
                 ...
                 tunnel_cidr: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enable: Whether to enable BGP.
        :param pulumi.Input[builtins.int] local_asn: The ASN on the Alibaba Cloud side.
        :param pulumi.Input[builtins.str] local_bgp_ip: The BGP IP address on the Alibaba Cloud side.
        :param pulumi.Input[builtins.str] tunnel_cidr: The CIDR block of the IPsec tunnel. The CIDR block belongs to 169.254.0.0/16. The mask of the CIDR block is 30 bits in length.
        """
        if enable is not None:
            pulumi.set(__self__, "enable", enable)
        if local_asn is not None:
...
class GatewayVpnAttachmentHealthCheckConfigArgs:
    def __init__(__self__, *,
                 ...
                 sip: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] dip: The destination IP address that is used for health checks.
        :param pulumi.Input[builtins.bool] enable: Specifies whether to enable health checks.
        :param pulumi.Input[builtins.int] interval: The interval between two consecutive health checks. Unit: seconds.
        :param pulumi.Input[builtins.str] policy: Whether to revoke the published route when the health check fails. Valid values: `revoke_route` or `reserve_route`.
        :param pulumi.Input[builtins.int] retry: The maximum number of health check retries.
        :param pulumi.Input[builtins.str] sip: The source IP address that is used for health checks.
        """
        if dip is not None:
            pulumi.set(__self__, "dip", dip)
...
class GatewayVpnAttachmentIkeConfigArgs:
    def __init__(__self__, *,
                 ...
                 remote_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ike_auth_alg: IKE authentication algorithm supports sha1 and MD5.
        :param pulumi.Input[builtins.str] ike_enc_alg: The encryption algorithm of phase-one negotiation. Valid value: aes | aes192 | aes256 | des | 3des. Default Valid value: aes.
        :param pulumi.Input[builtins.int] ike_lifetime: The SA lifecycle as the result of phase-one negotiation. The valid value of n is [0, 86400], the unit is second and the default value is 86400.
        :param pulumi.Input[builtins.str] ike_mode: The negotiation mode of IKE V1. Valid value: main (main mode) | aggressive (aggressive mode). Default value: `main`.
        :param pulumi.Input[builtins.str] ike_pfs: The Diffie-Hellman key exchange algorithm used by phase-one negotiation. Valid value: group1 | group2 | group5 | group14 | group24. Default value: group2
        :param pulumi.Input[builtins.str] ike_version: The version of the IKE protocol. Valid value: `ikev1`, `ikev2`. Default value: `ikev1`.
        :param pulumi.Input[builtins.str] local_id: The local ID, which supports the FQDN and IP formats. The current VPN gateway IP address is selected by default.
        :param pulumi.Input[builtins.str] psk: Used for authentication between the IPsec VPN gateway and the customer gateway.
        :param pulumi.Input[builtins.str] remote_id: The peer ID, which supports FQDN and IP formats. By default, the IP address of the currently selected user gateway.
        """
        if ike_auth_alg is not None:
            pulumi.set(__self__, "ike_auth_alg", ike_auth_alg)
        if ike_enc_alg is not None:
...
class GatewayVpnAttachmentIpsecConfigArgs:
    def __init__(__self__, *,
                 ...
                 ipsec_pfs: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ipsec_auth_alg: The authentication algorithm of phase-two negotiation. Valid value: md5 | sha1 | sha256 | sha384 | sha512 |. Default value: sha1
        :param pulumi.Input[builtins.str] ipsec_enc_alg: The encryption algorithm of phase-two negotiation. Valid value: aes | aes192 | aes256 | des | 3des. Default value: aes
        :param pulumi.Input[builtins.int] ipsec_lifetime: The SA lifecycle as the result of phase-two negotiation. The valid value is [0, 86400], the unit is second and the default value is 86400.
        :param pulumi.Input[builtins.str] ipsec_pfs: The Diffie-Hellman key exchange algorithm used by phase-two negotiation. Valid value: group1 | group2 | group5 | group14 | group24| disabled. Default value: group2
        """
        if ipsec_auth_alg is not None:
            pulumi.set(__self__, "ipsec_auth_alg", ipsec_auth_alg)
        if ipsec_enc_alg is not None:
