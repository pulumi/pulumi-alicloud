...
def get_connections(customer_gateway_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: IDs of the VPN connections.
    :param builtins.str name_regex: A regex string of VPN connection name.
...
def get_connections_output(customer_gateway_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
