...
def get_gateway_zones(ids: Optional[Sequence[builtins.str]] = None,
...
def get_gateway_zones_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
