...
class GatewayVcoRouteArgs:
    def __init__(__self__, *,
                 ...
                 overlay_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] vpn_connection_id: The id of the vpn attachment.
        :param pulumi.Input[builtins.int] weight: The weight value of the destination route. Valid values: `0`, `100`.
        :param pulumi.Input[builtins.str] overlay_mode: The tunneling protocol. Set the value to Ipsec, which specifies the IPsec tunneling protocol.
        """
    ...
    def overlay_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @overlay_mode.setter
    def overlay_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _GatewayVcoRouteState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] overlay_mode: The tunneling protocol. Set the value to Ipsec, which specifies the IPsec tunneling protocol.
        :param pulumi.Input[builtins.str] route_dest: The destination network segment of the destination route.
        :param pulumi.Input[builtins.str] status: The status of the vpn route entry.
        :param pulumi.Input[builtins.str] vpn_connection_id: The id of the vpn attachment.
        :param pulumi.Input[builtins.int] weight: The weight value of the destination route. Valid values: `0`, `100`.
        """
...
class GatewayVcoRoute(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpn_connection_id: Optional[pulumi.Input[builtins.str]] = None,
            weight: Optional[pulumi.Input[builtins.int]] = None) -> 'GatewayVcoRoute':
        """
    ...
    @property
    @pulumi.getter(name="overlayMode")
    def overlay_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The tunneling protocol. Set the value to Ipsec, which specifies the IPsec tunneling protocol.
        """
        return pulumi.get(self, "overlay_mode")
