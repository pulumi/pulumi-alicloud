...
class GetGatewayVcoRoutesResult:
    ...
    def route_entry_type(self) -> Optional[builtins.str]:
...
def get_gateway_vco_routes(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Vco Route IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str route_entry_type: The Routing input type. Valid values: `custom`, `bgp`.
...
def get_gateway_vco_routes_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                  ...
                                  route_entry_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
