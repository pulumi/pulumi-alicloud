...
class IpsecServerArgs:
    def __init__(__self__, *,
                 ...
                 ipsec_server_name: Optional[pulumi.Input[builtins.str]] = None,
                 psk: Optional[pulumi.Input[builtins.str]] = None,
                 psk_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a IpsecServer resource.
        :param pulumi.Input[builtins.str] client_ip_pool: The client CIDR block. It refers to the CIDR block that is allocated to the virtual interface of the client.
        :param pulumi.Input[builtins.str] local_subnet: The local CIDR block. It refers to the CIDR block of the virtual private cloud (VPC) that is used to connect with the client. Separate multiple CIDR blocks with commas (,). Example: `192.168.1.0/24,192.168.2.0/24`.
        ...
        :param pulumi.Input[builtins.bool] effect_immediately: Specifies whether you want the configuration to immediately take effect.
        ...
        :param pulumi.Input[builtins.str] ipsec_server_name: The name of the IPsec server. The name must be `2` to `128` characters in length, and can contain digits, hyphens (-), and underscores (_). It must start with a letter.
        :param pulumi.Input[builtins.str] psk: The pre-shared key. The pre-shared key is used to authenticate the VPN gateway and the client. By default, the system generates a random string that is 16 bits in length. You can also specify the pre-shared key. It can contain at most 100 characters.
        :param pulumi.Input[builtins.bool] psk_enabled: Whether to enable the pre-shared key authentication method. The value is only `true`, which indicates that the pre-shared key authentication method is enabled.
        """
    ...
    def ipsec_server_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipsec_server_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def psk_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @psk_enabled.setter
    def psk_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class IpsecServer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            psk: Optional[pulumi.Input[builtins.str]] = None,
            psk_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            vpn_gateway_id: Optional[pulumi.Input[builtins.str]] = None) -> 'IpsecServer':
        """
    ...
    @property
    @pulumi.getter(name="ipsecServerName")
    def ipsec_server_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the IPsec server. The name must be `2` to `128` characters in length, and can contain digits, hyphens (-), and underscores (_). It must start with a letter.
        """
        return pulumi.get(self, "ipsec_server_name")
    ...
    @property
    @pulumi.getter(name="pskEnabled")
    def psk_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable the pre-shared key authentication method. The value is only `true`, which indicates that the pre-shared key authentication method is enabled.
        """
        return pulumi.get(self, "psk_enabled")
