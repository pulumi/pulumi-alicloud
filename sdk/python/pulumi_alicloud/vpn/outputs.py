...
class GatewayVpnAttachmentBgpConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tunnel_cidr: Optional[builtins.str] = None):
        """
        :param builtins.bool enable: Whether to enable BGP.
        :param builtins.int local_asn: The ASN on the Alibaba Cloud side.
        :param builtins.str local_bgp_ip: The BGP IP address on the Alibaba Cloud side.
        :param builtins.str tunnel_cidr: The CIDR block of the IPsec tunnel. The CIDR block belongs to 169.254.0.0/16. The mask of the CIDR block is 30 bits in length.
        """
        if enable is not None:
            pulumi.set(__self__, "enable", enable)
        if local_asn is not None:
...
class GatewayVpnAttachmentHealthCheckConfig(dict):
    def __init__(__self__, *,
                 ...
                 sip: Optional[builtins.str] = None):
        """
        :param builtins.str dip: The destination IP address that is used for health checks.
        :param builtins.bool enable: Specifies whether to enable health checks.
        :param builtins.int interval: The interval between two consecutive health checks. Unit: seconds.
        :param builtins.str policy: Whether to revoke the published route when the health check fails. Valid values: `revoke_route` or `reserve_route`.
        :param builtins.int retry: The maximum number of health check retries.
        :param builtins.str sip: The source IP address that is used for health checks.
        """
        if dip is not None:
            pulumi.set(__self__, "dip", dip)
...
class GatewayVpnAttachmentIkeConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 remote_id: Optional[builtins.str] = None):
        """
        :param builtins.str ike_auth_alg: IKE authentication algorithm supports sha1 and MD5.
        :param builtins.str ike_enc_alg: The encryption algorithm of phase-one negotiation. Valid value: aes | aes192 | aes256 | des | 3des. Default Valid value: aes.
        :param builtins.int ike_lifetime: The SA lifecycle as the result of phase-one negotiation. The valid value of n is [0, 86400], the unit is second and the default value is 86400.
        :param builtins.str ike_mode: The negotiation mode of IKE V1. Valid value: main (main mode) | aggressive (aggressive mode). Default value: `main`.
        :param builtins.str ike_pfs: The Diffie-Hellman key exchange algorithm used by phase-one negotiation. Valid value: group1 | group2 | group5 | group14 | group24. Default value: group2
        :param builtins.str ike_version: The version of the IKE protocol. Valid value: `ikev1`, `ikev2`. Default value: `ikev1`.
        :param builtins.str local_id: The local ID, which supports the FQDN and IP formats. The current VPN gateway IP address is selected by default.
        :param builtins.str psk: Used for authentication between the IPsec VPN gateway and the customer gateway.
        :param builtins.str remote_id: The peer ID, which supports FQDN and IP formats. By default, the IP address of the currently selected user gateway.
        """
        if ike_auth_alg is not None:
            pulumi.set(__self__, "ike_auth_alg", ike_auth_alg)
        if ike_enc_alg is not None:
...
class GatewayVpnAttachmentIpsecConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ipsec_pfs: Optional[builtins.str] = None):
        """
        :param builtins.str ipsec_auth_alg: The authentication algorithm of phase-two negotiation. Valid value: md5 | sha1 | sha256 | sha384 | sha512 |. Default value: sha1
        :param builtins.str ipsec_enc_alg: The encryption algorithm of phase-two negotiation. Valid value: aes | aes192 | aes256 | des | 3des. Default value: aes
        :param builtins.int ipsec_lifetime: The SA lifecycle as the result of phase-two negotiation. The valid value is [0, 86400], the unit is second and the default value is 86400.
        :param builtins.str ipsec_pfs: The Diffie-Hellman key exchange algorithm used by phase-two negotiation. Valid value: group1 | group2 | group5 | group14 | group24| disabled. Default value: group2
        """
        if ipsec_auth_alg is not None:
            pulumi.set(__self__, "ipsec_auth_alg", ipsec_auth_alg)
        if ipsec_enc_alg is not None:
...
class GetGatewayVpnAttachmentsAttachmentResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str connection_status: The status of the IPsec-VPN connection.
        :param builtins.str create_time: The creation time of the resource.
        :param builtins.str customer_gateway_id: The ID of the customer gateway.
        :param builtins.bool effect_immediately: Indicates whether IPsec-VPN negotiations are initiated immediately. Valid values.
        ...
        :param builtins.str id: The ID of the Vpn Attachment.
        :param Sequence['GetGatewayVpnAttachmentsAttachmentIkeConfigArgs'] ike_configs: Configuration negotiated in the second stage.
        :param builtins.str internet_ip: The internet ip of the resource. The cen.TransitRouterVpnAttachment resource will not have a value until after it is created.
        :param Sequence['GetGatewayVpnAttachmentsAttachmentIpsecConfigArgs'] ipsec_configs: The configuration of Phase 2 negotiations.
        :param builtins.str local_subnet: The CIDR block of the virtual private cloud (VPC).
        :param builtins.str network_type: The network type.
        :param builtins.str remote_subnet: The CIDR block of the on-premises data center.
        ...
        :param builtins.str vpn_attachment_name: The name of the IPsec-VPN connection.
...
class GetGatewayVpnAttachmentsAttachmentBgpConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 tunnel_cidr: builtins.str):
        """
        :param builtins.str local_asn: The ASN on the Alibaba Cloud side.
        :param builtins.str local_bgp_ip: The BGP IP address on the Alibaba Cloud side.
        :param builtins.str status: The status of the resource. Valid values: `init`, `active`, `attaching`, `attached`, `detaching`, `financialLocked`, `provisioning`, `updating`, `upgrading`, `deleted`.
        :param builtins.str tunnel_cidr: The CIDR block of the IPsec tunnel. The CIDR block belongs to 169.254.0.0/16. The mask of the CIDR block is 30 bits in length.
        """
...
class GetGatewayVpnAttachmentsAttachmentHealthCheckConfigResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.bool enable: Specifies whether to enable health checks.
        :param builtins.int interval: The interval between two consecutive health checks. Unit: seconds.
        :param builtins.str policy: (Optional) Whether to revoke the published route when the health check fails.
        :param builtins.int retry: The maximum number of health check retries.
        :param builtins.str sip: The source IP address.
        :param builtins.str status: The status of the resource. Valid values: `init`, `active`, `attaching`, `attached`, `detaching`, `financialLocked`, `provisioning`, `updating`, `upgrading`, `deleted`.
        """
...
class GetGatewayVpnAttachmentsAttachmentIkeConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 remote_id: builtins.str):
        """
        :param builtins.str ike_auth_alg: The IKE authentication algorithm.
        :param builtins.str ike_enc_alg: The IKE encryption algorithm.
        :param builtins.str ike_lifetime: The IKE lifetime. Unit: seconds.
        :param builtins.str ike_mode: The IKE negotiation mode.
        :param builtins.str ike_pfs: The DH group.
        :param builtins.str ike_version: The version of the IKE protocol.
        :param builtins.str local_id: The local ID, which supports the FQDN and IP formats. The current VPN gateway IP address is selected by default. The cen.TransitRouterVpnAttachment resource will not have a value until after it is created.
        :param builtins.str psk: The pre-shared key.
        :param builtins.str remote_id: The identifier of the peer. The default value is the IP address of the VPN gateway. The value can be a fully qualified domain name (FQDN) or an IP address.
        """
        pulumi.set(__self__, "ike_auth_alg", ike_auth_alg)
        pulumi.set(__self__, "ike_enc_alg", ike_enc_alg)
        pulumi.set(__self__, "ike_lifetime", ike_lifetime)
    ...
    @property
    @pulumi.getter(name="ikeLifetime")
    def ike_lifetime(self) -> builtins.str:
        """
...
class GetGatewayVpnAttachmentsAttachmentIpsecConfigResult(dict):
    def __init__(__self__, *,
                 ipsec_auth_alg: builtins.str,
                 ipsec_enc_alg: builtins.str,
                 ipsec_lifetime: builtins.str,
                 ipsec_pfs: builtins.str):
        """
        :param builtins.str ipsec_auth_alg: The IPsec authentication algorithm.
        :param builtins.str ipsec_enc_alg: The IPsec encryption algorithm.
        :param builtins.str ipsec_lifetime: The IPsec lifetime. Unit: seconds.
        :param builtins.str ipsec_pfs: The DH group.
        """
        pulumi.set(__self__, "ipsec_auth_alg", ipsec_auth_alg)
        pulumi.set(__self__, "ipsec_enc_alg", ipsec_enc_alg)
        pulumi.set(__self__, "ipsec_lifetime", ipsec_lifetime)
    ...
    @property
    @pulumi.getter(name="ipsecLifetime")
    def ipsec_lifetime(self) -> builtins.str:
        """
