...
class CustomerGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ip_address: The IP address of the customer gateway.
        :param pulumi.Input[builtins.str] asn: Asn.
        :param pulumi.Input[builtins.str] customer_gateway_name: The name of the customer gateway.
        :param pulumi.Input[builtins.str] description: The description of the customer gateway.
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.216.0. New field 'customer_gateway_name' instead.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: tag.
...
class _CustomerGatewayState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] asn: Asn.
        :param pulumi.Input[builtins.int] create_time: The time when the customer gateway was created.
        :param pulumi.Input[builtins.str] customer_gateway_name: The name of the customer gateway.
        :param pulumi.Input[builtins.str] description: The description of the customer gateway.
        :param pulumi.Input[builtins.str] ip_address: The IP address of the customer gateway.
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.216.0. New field 'customer_gateway_name' instead.
...
class CustomerGateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip_address: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'CustomerGateway':
        """
    ...
    @property
    @pulumi.getter
    def asn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Asn.
        """
        return pulumi.get(self, "asn")
