...
class SslVpnClientCertArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ssl_vpn_server_id: The ID of the SSL-VPN server.
        :param pulumi.Input[builtins.str] name: The name of the client certificate.
        """
...
class _SslVpnClientCertState:
    def __init__(__self__, *,
                 ...
                 client_config: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] ca_cert: The client ca cert.
        :param pulumi.Input[builtins.str] client_cert: The client cert.
        :param pulumi.Input[builtins.str] client_config: The vpn client config.
        :param pulumi.Input[builtins.str] client_key: The client key.
        :param pulumi.Input[builtins.str] name: The name of the client certificate.
        :param pulumi.Input[builtins.str] ssl_vpn_server_id: The ID of the SSL-VPN server.
        :param pulumi.Input[builtins.str] status: The status of the client certificate.
        """
    ...
    def client_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_config(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SslVpnClientCert(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            ssl_vpn_server_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'SslVpnClientCert':
        """
    ...
    @property
    @pulumi.getter(name="clientConfig")
    def client_config(self) -> pulumi.Output[builtins.str]:
        """
        The vpn client config.
        """
        return pulumi.get(self, "client_config")
