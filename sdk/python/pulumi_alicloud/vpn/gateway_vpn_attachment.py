...
class GatewayVpnAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] customer_gateway_id: The ID of the customer gateway. From version 1.196.0, `customer_gateway_id` can be modified.
        :param pulumi.Input[builtins.str] local_subnet: The CIDR block of the virtual private cloud (VPC).
        :param pulumi.Input[builtins.str] remote_subnet: The CIDR block of the on-premises data center.
        :param pulumi.Input['GatewayVpnAttachmentBgpConfigArgs'] bgp_config: Bgp configuration information. See `bgp_config` below.
        :param pulumi.Input[builtins.bool] effect_immediately: Indicates whether IPsec-VPN negotiations are initiated immediately. Valid values.
        :param pulumi.Input[builtins.bool] enable_dpd: Whether to enable the DPD (peer survival detection) function.
        :param pulumi.Input[builtins.bool] enable_nat_traversal: Allow NAT penetration.
        ...
        :param pulumi.Input[builtins.str] network_type: The network type of the IPsec connection. Valid values: `public`, `private`.
        :param pulumi.Input[builtins.str] vpn_attachment_name: The name of the vpn attachment.
        """
...
class _GatewayVpnAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['GatewayVpnAttachmentHealthCheckConfigArgs'] health_check_config: Health check configuration information. See `health_check_config` below.
        :param pulumi.Input['GatewayVpnAttachmentIkeConfigArgs'] ike_config: Configuration negotiated in the second stage. See `ike_config` below.
        :param pulumi.Input[builtins.str] internet_ip: The VPN gateway IP.
        :param pulumi.Input['GatewayVpnAttachmentIpsecConfigArgs'] ipsec_config: Configuration negotiated in the second stage. See `ipsec_config` below.
        :param pulumi.Input[builtins.str] local_subnet: The CIDR block of the virtual private cloud (VPC).
        :param pulumi.Input[builtins.str] network_type: The network type of the IPsec connection. Valid values: `public`, `private`.
        :param pulumi.Input[builtins.str] remote_subnet: The CIDR block of the on-premises data center.
...
class GatewayVpnAttachment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="effectImmediately")
    def effect_immediately(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether IPsec-VPN negotiations are initiated immediately. Valid values.
        """
        return pulumi.get(self, "effect_immediately")
