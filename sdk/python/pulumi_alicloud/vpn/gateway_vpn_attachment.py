...
class GatewayVpnAttachmentArgs:
    def __init__(__self__, *,
                 local_subnet: pulumi.Input[builtins.str],
                 remote_subnet: pulumi.Input[builtins.str],
                 ...
                 effect_immediately: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_dpd: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_nat_traversal: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 vpn_attachment_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a GatewayVpnAttachment resource.
        :param pulumi.Input[builtins.str] local_subnet: The CIDR block on the VPC side. The CIDR block is used in Phase 2 negotiations.Separate multiple CIDR blocks with commas (,). Example: 192.168.1.0/24,192.168.2.0/24.The following routing modes are supported:
               - If you set LocalSubnet and RemoteSubnet to 0.0.0.0/0, the routing mode of the IPsec-VPN connection is set to Destination Routing Mode.
               - If you set LocalSubnet and RemoteSubnet to specific CIDR blocks, the routing mode of the IPsec-VPN connection is set to Protected Data Flows.
        :param pulumi.Input[builtins.str] remote_subnet: The CIDR block on the data center side. This CIDR block is used in Phase 2 negotiations.Separate multiple CIDR blocks with commas (,). Example: 192.168.3.0/24,192.168.4.0/24.The following routing modes are supported:
               - If you set LocalSubnet and RemoteSubnet to 0.0.0.0/0, the routing mode of the IPsec-VPN connection is set to Destination Routing Mode.
               - If you set LocalSubnet and RemoteSubnet to specific CIDR blocks, the routing mode of the IPsec-VPN connection is set to Protected Data Flows.
        ...
        :param pulumi.Input[builtins.str] customer_gateway_id: Customer gateway ID.
               - This parameter is required when creating a single-tunnel mode vpn attachment.
        :param pulumi.Input[builtins.bool] effect_immediately: Specifies whether to immediately start IPsec negotiations after the configuration takes effect. Valid values:
        :param pulumi.Input[builtins.bool] enable_dpd: This parameter is supported if you create an vpn attachment in single-tunnel mode.
        ...
        :param pulumi.Input[builtins.bool] enable_nat_traversal: This parameter is supported if you create an vpn attachment in single-tunnel mode.
        ...
        :param pulumi.Input[builtins.bool] enable_tunnels_bgp: You can configure this parameter when you create a vpn attachment in dual-tunnel mode.Whether to enable the BGP function for the tunnel. Value: `true` or `false` (default).
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Tags
        ...
        :param pulumi.Input[builtins.str] vpn_attachment_name: vpn attachment name
        """
    ...
    def local_subnet(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @local_subnet.setter
    def local_subnet(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "local_subnet", value)

    @property
    @pulumi.getter(name="remoteSubnet")
    def remote_subnet(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def remote_subnet(self, value: pulumi.Input[builtins.str]):
    ...
    def effect_immediately(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def effect_immediately(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "effect_immediately", value)

    @property
    @pulumi.getter(name="enableDpd")
    def enable_dpd(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @enable_dpd.setter
    def enable_dpd(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_dpd", value)

    @property
    @pulumi.getter(name="enableNatTraversal")
    def enable_nat_traversal(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        This parameter is supported if you create an vpn attachment in single-tunnel mode.
        Specifies whether to enable NAT traversal. Valid values:
        - true (default): enables NAT traversal. After NAT traversal is enabled, the initiator does not check the UDP ports during IKE negotiations and can automatically discover NAT gateway devices along the vpn attachment tunnel.
    ...
    def enable_nat_traversal(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def vpn_attachment_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        vpn attachment name
        """
    ...
    def vpn_attachment_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _GatewayVpnAttachmentState:
    def __init__(__self__, *,
                 ...
                 ike_config: Optional[pulumi.Input['GatewayVpnAttachmentIkeConfigArgs']] = None,
                 ipsec_config: Optional[pulumi.Input['GatewayVpnAttachmentIpsecConfigArgs']] = None,
                 local_subnet: Optional[pulumi.Input[builtins.str]] = None,
                 network_type: Optional[pulumi.Input[builtins.str]] = None,
                 remote_subnet: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] remote_subnet: The CIDR block on the data center side. This CIDR block is used in Phase 2 negotiations.Separate multiple CIDR blocks with commas (,). Example: 192.168.3.0/24,192.168.4.0/24.The following routing modes are supported:
               ...
               - If you set LocalSubnet and RemoteSubnet to specific CIDR blocks, the routing mode of the IPsec-VPN connection is set to Protected Data Flows.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group
        :param pulumi.Input[builtins.str] status: The negotiation status of Tunnel.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Tags
        :param pulumi.Input[Sequence[pulumi.Input['GatewayVpnAttachmentTunnelOptionsSpecificationArgs']]] tunnel_options_specifications: Configure the tunnel.
               - You can configure parameters in the `tunnel_options_specification` array when you create a vpn attachment in dual-tunnel mode.
               - When creating a vpn attachment in dual-tunnel mode, you must add both tunnels for the vpn attachment to ensure that the vpn attachment has link redundancy. Only two tunnels can be added to a vpn attachment. See `tunnel_options_specification` below.
    ...
    @property
    @pulumi.getter(name="localSubnet")
    def local_subnet(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The CIDR block on the VPC side. The CIDR block is used in Phase 2 negotiations.Separate multiple CIDR blocks with commas (,). Example: 192.168.1.0/24,192.168.2.0/24.The following routing modes are supported:
        - If you set LocalSubnet and RemoteSubnet to 0.0.0.0/0, the routing mode of the IPsec-VPN connection is set to Destination Routing Mode.
        - If you set LocalSubnet and RemoteSubnet to specific CIDR blocks, the routing mode of the IPsec-VPN connection is set to Protected Data Flows.
    ...
    @local_subnet.setter
    def local_subnet(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "local_subnet", value)
    ...
    @property
    @pulumi.getter(name="remoteSubnet")
    def remote_subnet(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The CIDR block on the data center side. This CIDR block is used in Phase 2 negotiations.Separate multiple CIDR blocks with commas (,). Example: 192.168.3.0/24,192.168.4.0/24.The following routing modes are supported:
        - If you set LocalSubnet and RemoteSubnet to 0.0.0.0/0, the routing mode of the IPsec-VPN connection is set to Destination Routing Mode.
        - If you set LocalSubnet and RemoteSubnet to specific CIDR blocks, the routing mode of the IPsec-VPN connection is set to Protected Data Flows.
    ...
    @remote_subnet.setter
    def remote_subnet(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "remote_subnet", value)
...
class GatewayVpnAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tunnel_options_specifications: Optional[pulumi.Input[Sequence[pulumi.Input[Union['GatewayVpnAttachmentTunnelOptionsSpecificationArgs', 'GatewayVpnAttachmentTunnelOptionsSpecificationArgsDict']]]]] = None,
            vpn_attachment_name: Optional[pulumi.Input[builtins.str]] = None) -> 'GatewayVpnAttachment':
        """
    ...
    @property
    @pulumi.getter(name="customerGatewayId")
    def customer_gateway_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Customer gateway ID.
        - This parameter is required when creating a single-tunnel mode vpn attachment.
        """
    ...
    @property
    @pulumi.getter(name="effectImmediately")
    def effect_immediately(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to immediately start IPsec negotiations after the configuration takes effect. Valid values:
        """
        return pulumi.get(self, "effect_immediately")
    ...
    @property
    @pulumi.getter(name="enableDpd")
    def enable_dpd(self) -> pulumi.Output[builtins.bool]:
        """
        This parameter is supported if you create an vpn attachment in single-tunnel mode.
        Whether to enable the DPD (peer survival detection) function.
        - true (default): enables DPD. The initiator of the IPsec-VPN connection sends DPD packets to check the existence and availability of the peer. If no feedback is received from the peer within the specified period of time, the connection fails. In this case, ISAKMP SA and IPsec SA are deleted along with the security tunnel.
    ...
    @property
    @pulumi.getter(name="enableNatTraversal")
    def enable_nat_traversal(self) -> pulumi.Output[builtins.bool]:
        """
        This parameter is supported if you create an vpn attachment in single-tunnel mode.
        Specifies whether to enable NAT traversal. Valid values:
        - true (default): enables NAT traversal. After NAT traversal is enabled, the initiator does not check the UDP ports during IKE negotiations and can automatically discover NAT gateway devices along the vpn attachment tunnel.
    ...
    @property
    @pulumi.getter(name="localSubnet")
    def local_subnet(self) -> pulumi.Output[builtins.str]:
        """
        The CIDR block on the VPC side. The CIDR block is used in Phase 2 negotiations.Separate multiple CIDR blocks with commas (,). Example: 192.168.1.0/24,192.168.2.0/24.The following routing modes are supported:
        - If you set LocalSubnet and RemoteSubnet to 0.0.0.0/0, the routing mode of the IPsec-VPN connection is set to Destination Routing Mode.
        - If you set LocalSubnet and RemoteSubnet to specific CIDR blocks, the routing mode of the IPsec-VPN connection is set to Protected Data Flows.
    ...
    @property
    @pulumi.getter(name="remoteSubnet")
    def remote_subnet(self) -> pulumi.Output[builtins.str]:
        """
        The CIDR block on the data center side. This CIDR block is used in Phase 2 negotiations.Separate multiple CIDR blocks with commas (,). Example: 192.168.3.0/24,192.168.4.0/24.The following routing modes are supported:
        - If you set LocalSubnet and RemoteSubnet to 0.0.0.0/0, the routing mode of the IPsec-VPN connection is set to Destination Routing Mode.
        - If you set LocalSubnet and RemoteSubnet to specific CIDR blocks, the routing mode of the IPsec-VPN connection is set to Protected Data Flows.
    ...
    @property
    @pulumi.getter(name="vpnAttachmentName")
    def vpn_attachment_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        vpn attachment name
        """
        return pulumi.get(self, "vpn_attachment_name")
