...
class _RouteEntryState:
    def __init__(__self__, *,
                 ...
                 route_entry_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def route_entry_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("alicloud:vpn/routeEntry:RouteEntry")
class RouteEntry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpn_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
            weight: Optional[pulumi.Input[builtins.int]] = None) -> 'RouteEntry':
        """
