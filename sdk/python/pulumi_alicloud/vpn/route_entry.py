...
class RouteEntryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] weight: The value should be 0 or 100.
        """
...
class _RouteEntryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] publish_vpc: Whether to issue the destination route to the VPC.
        :param pulumi.Input[_builtins.str] route_dest: The destination network segment of the destination route.
        :param pulumi.Input[_builtins.str] route_entry_type: (Available since v1.161.0) The type of the vpn route entry.
        :param pulumi.Input[_builtins.str] status: (Available since v1.161.0) The status of the vpn route entry.
        :param pulumi.Input[_builtins.str] vpn_gateway_id: The id of the vpn gateway.
        :param pulumi.Input[_builtins.int] weight: The value should be 0 or 100.
        """
...
class RouteEntry(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="routeEntryType")
    def route_entry_type(self) -> pulumi.Output[_builtins.str]:
        """
        (Available since v1.161.0) The type of the vpn route entry.
        """
        return pulumi.get(self, "route_entry_type")
