...
def get_gateway_vpn_attachments(ids: Optional[Sequence[builtins.str]] = None,
                                ...
                                vpn_gateway_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Vpn Attachment IDs.
    :param builtins.str name_regex: A regex string to filter results by Vpn Attachment name.
    ...
    :param builtins.str vpn_gateway_id: The parameter 'vpn_gateway_id' has been deprecated from 1.194.0.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_gateway_vpn_attachments_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                       ...
                                       vpn_gateway_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
