...
class SslVpnServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] client_ip_pool: The CIDR block from which access addresses are allocated to the virtual network interface card of the client.
        :param pulumi.Input[builtins.str] local_subnet: The CIDR block to be accessed by the client through the SSL-VPN connection. It supports to set multi CIDRs by comma join ways, like `10.0.1.0/24,10.0.2.0/24,10.0.3.0/24`.
        :param pulumi.Input[builtins.str] vpn_gateway_id: The ID of the VPN gateway.
        :param pulumi.Input[builtins.str] cipher: The encryption algorithm that is used in the SSL-VPN connection. Valid values: `AES-128-CBC`,`AES-192-CBC`,`AES-256-CBC`,`none`. Default value: `AES-128-CBC`.
               * `AES-128-CBC` - the AES-128-CBC algorithm.
               * `AES-192-CBC` - the AES-192-CBC algorithm.
               * `AES-256-CBC` - the AES-256-CBC algorithm.
        :param pulumi.Input[builtins.bool] compress: Specifies whether to enable data compression. Valid values: `true`,`false`. Default value: `false`
        :param pulumi.Input[builtins.str] name: The name of the SSL-VPN server.
        :param pulumi.Input[builtins.int] port: The port used by the SSL-VPN server. The default value is `1194`.The following ports cannot be used: [22, 2222, 22222, 9000, 9001, 9002, 7505, 80, 443, 53, 68, 123, 4510, 4560, 500, 4500].
        :param pulumi.Input[builtins.str] protocol: The protocol used by the SSL-VPN server. Valid value: UDP(default) |TCP
        """
...
class _SslVpnServerState:
    def __init__(__self__, *,
                 ...
                 compress: Optional[pulumi.Input[builtins.bool]] = None,
                 connections: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] client_ip_pool: The CIDR block from which access addresses are allocated to the virtual network interface card of the client.
        :param pulumi.Input[builtins.bool] compress: Specifies whether to enable data compression. Valid values: `true`,`false`. Default value: `false`
        :param pulumi.Input[builtins.int] connections: The number of current connections.
        :param pulumi.Input[builtins.str] internet_ip: The internet IP of the SSL-VPN server.
        :param pulumi.Input[builtins.str] local_subnet: The CIDR block to be accessed by the client through the SSL-VPN connection. It supports to set multi CIDRs by comma join ways, like `10.0.1.0/24,10.0.2.0/24,10.0.3.0/24`.
        :param pulumi.Input[builtins.int] max_connections: The maximum number of connections.
        :param pulumi.Input[builtins.str] name: The name of the SSL-VPN server.
        :param pulumi.Input[builtins.int] port: The port used by the SSL-VPN server. The default value is `1194`.The following ports cannot be used: [22, 2222, 22222, 9000, 9001, 9002, 7505, 80, 443, 53, 68, 123, 4510, 4560, 500, 4500].
        :param pulumi.Input[builtins.str] protocol: The protocol used by the SSL-VPN server. Valid value: UDP(default) |TCP
        :param pulumi.Input[builtins.str] vpn_gateway_id: The ID of the VPN gateway.
    ...
    @property
    @pulumi.getter
    def connections(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @connections.setter
    def connections(self, value: Optional[pulumi.Input[builtins.int]]):
...
class SslVpnServer(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def cipher(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The encryption algorithm that is used in the SSL-VPN connection. Valid values: `AES-128-CBC`,`AES-192-CBC`,`AES-256-CBC`,`none`. Default value: `AES-128-CBC`.
        * `AES-128-CBC` - the AES-128-CBC algorithm.
        * `AES-192-CBC` - the AES-192-CBC algorithm.
    ...
    @property
    @pulumi.getter
    def compress(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable data compression. Valid values: `true`,`false`. Default value: `false`
        """
        return pulumi.get(self, "compress")
    ...
    @property
    @pulumi.getter
    def connections(self) -> pulumi.Output[builtins.int]:
        """
        The number of current connections.
        """
        return pulumi.get(self, "connections")
