...
class GatewayArgs:
    def __init__(__self__, *,
                 ...
                 auto_propagate: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 disaster_recovery_vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
                 enable_ipsec: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 ssl_connections: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] bandwidth: The Bandwidth specification of the VPN gateway. Unit: Mbps.  If you want to create a public VPN gateway, the value is 5, 10, 20, 50, 100, 200, 500, or 1000. If you want to create a private VPN gateway, the value is 200 or 1000.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC to which the VPN gateway belongs.
        :param pulumi.Input[builtins.bool] auto_pay: Whether to pay automatically. Default value: `true`. Valid values:
        :param pulumi.Input[builtins.bool] auto_propagate: Whether to automatically propagate the BGP route to the VPC. Value:  true: Propagate automatically.  false: does not propagate automatically.
        :param pulumi.Input[builtins.str] description: The description of the VPN gateway.
        :param pulumi.Input[builtins.str] disaster_recovery_vswitch_id: The ID of the backup VSwitch to which the VPN gateway is attached.
        :param pulumi.Input[builtins.bool] enable_ipsec: Enable or Disable IPSec VPN. At least one type of VPN should be enabled.
        :param pulumi.Input[builtins.bool] enable_ssl: Enable or Disable SSL VPN.  At least one type of VPN should be enabled.
               
               The following arguments will be discarded. Please use new fields as soon as possible:
        :param pulumi.Input[builtins.str] instance_charge_type: . Field 'instance_charge_type' has been deprecated from provider version 1.216.0. New field 'payment_type' instead.
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.216.0. New field 'vpn_gateway_name' instead.
        :param pulumi.Input[builtins.str] network_type: The network type of the VPN gateway. Value:  public (default): public VPN gateway. private: private network VPN gateway.
        :param pulumi.Input[builtins.str] payment_type: Type of payment. Value: Subscription: prepaid PayAsYouGo: Post-paid.
        :param pulumi.Input[builtins.int] period: The filed is only required while the InstanceChargeType is PrePaid. Valid values: [1-9, 12, 24, 36]. Default to 1.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.int] ssl_connections: Maximum number of clients.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The Tag of.
        :param pulumi.Input[builtins.str] vpn_gateway_name: The name of the VPN gateway.
        :param pulumi.Input[builtins.str] vpn_type: The VPN gateway type. Value:  Normal (default): Normal type. NationalStandard: National Secret type.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the VSwitch to which the VPN gateway is attached.
        """
    ...
    def auto_propagate(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_propagate(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def disaster_recovery_vswitch_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def disaster_recovery_vswitch_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "disaster_recovery_vswitch_id", value)

    @property
    @pulumi.getter(name="enableIpsec")
    def enable_ipsec(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @enable_ipsec.setter
    def enable_ipsec(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ssl_connections(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def ssl_connections(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _GatewayState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 disaster_recovery_internet_ip: Optional[pulumi.Input[builtins.str]] = None,
                 disaster_recovery_vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
                 enable_ipsec: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_ssl: Optional[pulumi.Input[builtins.bool]] = None,
                 instance_charge_type: Optional[pulumi.Input[builtins.str]] = None,
                 internet_ip: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 network_type: Optional[pulumi.Input[builtins.str]] = None,
                 payment_type: Optional[pulumi.Input[builtins.str]] = None,
                 period: Optional[pulumi.Input[builtins.int]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_connections: Optional[pulumi.Input[builtins.int]] = None,
                 ssl_vpn_internet_ip: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] auto_propagate: Whether to automatically propagate the BGP route to the VPC. Value:  true: Propagate automatically.  false: does not propagate automatically.
        :param pulumi.Input[builtins.int] bandwidth: The Bandwidth specification of the VPN gateway. Unit: Mbps.  If you want to create a public VPN gateway, the value is 5, 10, 20, 50, 100, 200, 500, or 1000. If you want to create a private VPN gateway, the value is 200 or 1000.
        :param pulumi.Input[builtins.str] business_status: The business status of the VPN gateway.
        :param pulumi.Input[builtins.int] create_time: The time when the VPN gateway was created.
        :param pulumi.Input[builtins.str] description: The description of the VPN gateway.
        :param pulumi.Input[builtins.str] disaster_recovery_internet_ip: The backup public IP address of the VPN gateway. The second IP address assigned by the system to create an IPsec-VPN connection. This parameter is returned only when the VPN gateway supports the dual-tunnel mode.
        :param pulumi.Input[builtins.str] disaster_recovery_vswitch_id: The ID of the backup VSwitch to which the VPN gateway is attached.
        :param pulumi.Input[builtins.bool] enable_ipsec: Enable or Disable IPSec VPN. At least one type of VPN should be enabled.
        :param pulumi.Input[builtins.bool] enable_ssl: Enable or Disable SSL VPN.  At least one type of VPN should be enabled.
               ...
               The following arguments will be discarded. Please use new fields as soon as possible:
        :param pulumi.Input[builtins.str] instance_charge_type: . Field 'instance_charge_type' has been deprecated from provider version 1.216.0. New field 'payment_type' instead.
        :param pulumi.Input[builtins.str] internet_ip: The internet ip of the VPN.
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.216.0. New field 'vpn_gateway_name' instead.
        :param pulumi.Input[builtins.str] network_type: The network type of the VPN gateway. Value:  public (default): public VPN gateway. private: private network VPN gateway.
        :param pulumi.Input[builtins.str] payment_type: Type of payment. Value: Subscription: prepaid PayAsYouGo: Post-paid.
        :param pulumi.Input[builtins.int] period: The filed is only required while the InstanceChargeType is PrePaid. Valid values: [1-9, 12, 24, 36]. Default to 1.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.int] ssl_connections: Maximum number of clients.
        :param pulumi.Input[builtins.str] ssl_vpn_internet_ip: The IP address of the SSL-VPN connection. This parameter is returned only when the VPN gateway is a public VPN gateway and supports only the single-tunnel mode. In addition, the VPN gateway must have the SSL-VPN feature enabled.
    ...
    def disaster_recovery_internet_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def disaster_recovery_internet_ip(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def internet_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @internet_ip.setter
    def internet_ip(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ssl_vpn_internet_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ssl_vpn_internet_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Gateway(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:vpn/gateway:Gateway"
    ...
    @property
    @pulumi.getter(name="autoPropagate")
    def auto_propagate(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to automatically propagate the BGP route to the VPC. Value:  true: Propagate automatically.  false: does not propagate automatically.
        """
        return pulumi.get(self, "auto_propagate")
    ...
    @property
    @pulumi.getter(name="disasterRecoveryInternetIp")
    def disaster_recovery_internet_ip(self) -> pulumi.Output[builtins.str]:
        """
        The backup public IP address of the VPN gateway. The second IP address assigned by the system to create an IPsec-VPN connection. This parameter is returned only when the VPN gateway supports the dual-tunnel mode.
        """
        return pulumi.get(self, "disaster_recovery_internet_ip")
    ...
    @property
    @pulumi.getter(name="disasterRecoveryVswitchId")
    def disaster_recovery_vswitch_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the backup VSwitch to which the VPN gateway is attached.
        """
        return pulumi.get(self, "disaster_recovery_vswitch_id")
    ...
    @property
    @pulumi.getter(name="enableIpsec")
    def enable_ipsec(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable or Disable IPSec VPN. At least one type of VPN should be enabled.
        """
        return pulumi.get(self, "enable_ipsec")
    ...
    @property
    @pulumi.getter(name="enableSsl")
    def enable_ssl(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable or Disable SSL VPN.  At least one type of VPN should be enabled.
    ...
    @property
    @pulumi.getter(name="internetIp")
    def internet_ip(self) -> pulumi.Output[builtins.str]:
        """
        The internet ip of the VPN.
        """
        return pulumi.get(self, "internet_ip")
    ...
    @property
    @pulumi.getter(name="sslConnections")
    def ssl_connections(self) -> pulumi.Output[builtins.int]:
        """
        Maximum number of clients.
        """
        return pulumi.get(self, "ssl_connections")
    ...
    @property
    @pulumi.getter(name="sslVpnInternetIp")
    def ssl_vpn_internet_ip(self) -> pulumi.Output[builtins.str]:
        """
        The IP address of the SSL-VPN connection. This parameter is returned only when the VPN gateway is a public VPN gateway and supports only the single-tunnel mode. In addition, the VPN gateway must have the SSL-VPN feature enabled.
        """
        return pulumi.get(self, "ssl_vpn_internet_ip")
    ...
    @property
    @pulumi.getter(name="vpnType")
    def vpn_type(self) -> pulumi.Output[builtins.str]:
        """
        The VPN gateway type. Value:  Normal (default): Normal type. NationalStandard: National Secret type.
        """
        return pulumi.get(self, "vpn_type")
