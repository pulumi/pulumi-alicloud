...
class PbrRouteEntryArgs:
    def __init__(__self__, *,
                 ...
                 publish_vpc: pulumi.Input[builtins.bool],
                 route_dest: pulumi.Input[builtins.str],
                 route_source: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] next_hop: The next hop of the policy-based route.
        :param pulumi.Input[builtins.bool] publish_vpc: Whether to issue the destination route to the VPC.
        :param pulumi.Input[builtins.str] route_dest: The destination CIDR block of the policy-based route.
        :param pulumi.Input[builtins.str] route_source: The source CIDR block of the policy-based route.
        :param pulumi.Input[builtins.str] vpn_gateway_id: The ID of the vpn gateway.
        :param pulumi.Input[builtins.int] weight: The weight of the policy-based route. Valid values: 0 and 100.
        """
    ...
    def publish_vpc(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @publish_vpc.setter
    def publish_vpc(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "publish_vpc", value)

    @property
    @pulumi.getter(name="routeDest")
    def route_dest(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @route_dest.setter
    def route_dest(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "route_dest", value)

    @property
    @pulumi.getter(name="routeSource")
    def route_source(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @route_source.setter
    def route_source(self, value: pulumi.Input[builtins.str]):
...
class _PbrRouteEntryState:
    def __init__(__self__, *,
                 ...
                 publish_vpc: Optional[pulumi.Input[builtins.bool]] = None,
                 route_dest: Optional[pulumi.Input[builtins.str]] = None,
                 route_source: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] route_dest: The destination CIDR block of the policy-based route.
        :param pulumi.Input[builtins.str] route_source: The source CIDR block of the policy-based route.
        :param pulumi.Input[builtins.str] status: The status of the vpn pbr route entry.
        :param pulumi.Input[builtins.str] vpn_gateway_id: The ID of the vpn gateway.
        :param pulumi.Input[builtins.int] weight: The weight of the policy-based route. Valid values: 0 and 100.
        """
    ...
    @property
    @pulumi.getter(name="publishVpc")
    def publish_vpc(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to issue the destination route to the VPC.
        """
        return pulumi.get(self, "publish_vpc")
    ...
    @publish_vpc.setter
    def publish_vpc(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "publish_vpc", value)

    @property
    @pulumi.getter(name="routeDest")
    def route_dest(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The destination CIDR block of the policy-based route.
        """
        return pulumi.get(self, "route_dest")
    ...
    @route_dest.setter
    def route_dest(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "route_dest", value)

    @property
    @pulumi.getter(name="routeSource")
    def route_source(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The source CIDR block of the policy-based route.
        """
        return pulumi.get(self, "route_source")
    ...
    @route_source.setter
    def route_source(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "route_source", value)
...
class PbrRouteEntry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpn_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
            weight: Optional[pulumi.Input[builtins.int]] = None) -> 'PbrRouteEntry':
        """
    ...
    @property
    @pulumi.getter(name="publishVpc")
    def publish_vpc(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to issue the destination route to the VPC.
        """
        return pulumi.get(self, "publish_vpc")
    ...
    @property
    @pulumi.getter(name="routeDest")
    def route_dest(self) -> pulumi.Output[builtins.str]:
        """
        The destination CIDR block of the policy-based route.
        """
        return pulumi.get(self, "route_dest")
    ...
    @property
    @pulumi.getter(name="routeSource")
    def route_source(self) -> pulumi.Output[builtins.str]:
        """
        The source CIDR block of the policy-based route.
        """
        return pulumi.get(self, "route_source")
