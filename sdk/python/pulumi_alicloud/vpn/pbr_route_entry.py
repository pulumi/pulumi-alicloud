...
class PbrRouteEntryArgs:
    def __init__(__self__, *,
                 ...
                 publish_vpc: pulumi.Input[_builtins.bool],
                 route_dest: pulumi.Input[_builtins.str],
                 route_source: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] route_source: The source CIDR block of the policy-based route.
        :param pulumi.Input[_builtins.str] vpn_gateway_id: The ID of the vpn gateway.
        :param pulumi.Input[_builtins.int] weight: The weight of the policy-based route. Valid values: 0 and 100.
        """
    ...
    def publish_vpc(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    @publish_vpc.setter
    def publish_vpc(self, value: pulumi.Input[_builtins.bool]):
    ...
    def route_source(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @route_source.setter
    def route_source(self, value: pulumi.Input[_builtins.str]):
...
class _PbrRouteEntryState:
    def __init__(__self__, *,
                 ...
                 route_source: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] route_dest: The destination CIDR block of the policy-based route.
        :param pulumi.Input[_builtins.str] route_source: The source CIDR block of the policy-based route.
        :param pulumi.Input[_builtins.str] status: The status of the vpn pbr route entry.
        :param pulumi.Input[_builtins.str] vpn_gateway_id: The ID of the vpn gateway.
        :param pulumi.Input[_builtins.int] weight: The weight of the policy-based route. Valid values: 0 and 100.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="routeSource")
    def route_source(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The source CIDR block of the policy-based route.
        """
        return pulumi.get(self, "route_source")
    ...
    @route_source.setter
    def route_source(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "route_source", value)
...
class PbrRouteEntry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[_builtins.str]] = None,
            vpn_gateway_id: Optional[pulumi.Input[_builtins.str]] = None,
            weight: Optional[pulumi.Input[_builtins.int]] = None) -> 'PbrRouteEntry':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="publishVpc")
    def publish_vpc(self) -> pulumi.Output[_builtins.bool]:
        """
        Whether to issue the destination route to the VPC.
        """
        return pulumi.get(self, "publish_vpc")
    ...
    @_builtins.property
    @pulumi.getter(name="routeSource")
    def route_source(self) -> pulumi.Output[_builtins.str]:
        """
        The source CIDR block of the policy-based route.
        """
        return pulumi.get(self, "route_source")
