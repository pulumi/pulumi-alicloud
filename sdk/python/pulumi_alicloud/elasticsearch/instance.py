...
class Instance(pulumi.CustomResource):
    ...
    """
    data_node_disk_encrypted: pulumi.Output[bool]
    """
    ...
    """
    def __init__(__self__, resource_name, opts=None, data_node_amount=None, data_node_disk_encrypted=None, data_node_disk_size=None, data_node_disk_type=None, data_node_spec=None, description=None, instance_charge_type=None, kibana_whitelists=None, kms_encrypted_password=None, kms_encryption_context=None, master_node_spec=None, password=None, period=None, private_whitelists=None, public_whitelists=None, resource_group_id=None, tags=None, version=None, vswitch_id=None, zone_count=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, data_node_amount=None, data_node_disk_encrypted=None, data_node_disk_size=None, data_node_disk_type=None, data_node_spec=None, description=None, domain=None, instance_charge_type=None, kibana_domain=None, kibana_port=None, kibana_whitelists=None, kms_encrypted_password=None, kms_encryption_context=None, master_node_spec=None, password=None, period=None, port=None, private_whitelists=None, public_whitelists=None, resource_group_id=None, status=None, tags=None, version=None, vswitch_id=None, zone_count=None):
        """
