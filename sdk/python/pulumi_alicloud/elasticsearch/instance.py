...
class InstanceArgs:
    def __init__(__self__, *,
                 data_node_amount: pulumi.Input[builtins.int],
                 data_node_disk_size: pulumi.Input[builtins.int],
                 data_node_disk_type: pulumi.Input[builtins.str],
                 data_node_spec: pulumi.Input[builtins.str],
                 ...
                 client_node_amount: Optional[pulumi.Input[builtins.int]] = None,
                 client_node_spec: Optional[pulumi.Input[builtins.str]] = None,
                 data_node_disk_encrypted: Optional[pulumi.Input[builtins.bool]] = None,
                 data_node_disk_performance_level: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 kibana_node_spec: Optional[pulumi.Input[builtins.str]] = None,
                 kibana_private_security_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 kibana_private_whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 kibana_whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 master_node_disk_type: Optional[pulumi.Input[builtins.str]] = None,
                 master_node_spec: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 period: Optional[pulumi.Input[builtins.int]] = None,
                 private_whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 protocol: Optional[pulumi.Input[builtins.str]] = None,
                 public_whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 renew_status: Optional[pulumi.Input[builtins.str]] = None,
                 renewal_duration_unit: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 setting_config: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 warm_node_amount: Optional[pulumi.Input[builtins.int]] = None,
                 warm_node_disk_encrypted: Optional[pulumi.Input[builtins.bool]] = None,
                 warm_node_disk_size: Optional[pulumi.Input[builtins.int]] = None,
                 warm_node_disk_type: Optional[pulumi.Input[builtins.str]] = None,
                 warm_node_spec: Optional[pulumi.Input[builtins.str]] = None,
                 zone_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Instance resource.
        :param pulumi.Input[builtins.int] data_node_amount: The Elasticsearch cluster's data node quantity, between 2 and 50.
        :param pulumi.Input[builtins.int] data_node_disk_size: The single data node storage space.
        :param pulumi.Input[builtins.str] data_node_disk_type: The data node disk type. Supported values: cloud_ssd, cloud_efficiency.
        :param pulumi.Input[builtins.str] data_node_spec: The data node specifications of the Elasticsearch instance.
        :param pulumi.Input[builtins.str] version: Elasticsearch version. Supported values: `5.5.3_with_X-Pack`, `6.3_with_X-Pack`, `6.7_with_X-Pack`, `6.8_with_X-Pack`, `7.4_with_X-Pack` , `7.7_with_X-Pack`, `7.10_with_X-Pack`, `7.16_with_X-Pack`, `8.5_with_X-Pack`, `8.9_with_X-Pack`, `8.13_with_X-Pack`.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of VSwitch.
        :param pulumi.Input[builtins.int] auto_renew_duration: Auto-renewal period of an Elasticsearch Instance, in the unit of the month. It is valid when `instance_charge_type` is `PrePaid` and `renew_status` is `AutoRenewal`.
        :param pulumi.Input[builtins.int] client_node_amount: The Elasticsearch cluster's client node quantity, between 2 and 25.
        :param pulumi.Input[builtins.str] client_node_spec: The client node spec. If specified, client node will be created.
        :param pulumi.Input[builtins.bool] data_node_disk_encrypted: If encrypt the data node disk. Valid values are `true`, `false`. Default to `false`.
        :param pulumi.Input[builtins.str] data_node_disk_performance_level: Cloud disk performance level. Valid values are `PL0`, `PL1`, `PL2`, `PL3`. The `data_node_disk_type` muse be `cloud_essd`.
        :param pulumi.Input[builtins.str] description: The description of instance. It a string of 0 to 30 characters.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] kibana_whitelists: Set the Kibana's IP whitelist in internet network.
        :param pulumi.Input[builtins.str] kms_encrypted_password: An KMS encrypts password used to an instance. If the `password` is filled in, this field will be ignored, but you have to specify one of `password` and `kms_encrypted_password` fields.
        ...
        :param pulumi.Input[builtins.str] master_node_disk_type: The single master node storage space. Valid values are `PrePaid`, `PostPaid`.
        :param pulumi.Input[builtins.str] master_node_spec: The dedicated master node spec. If specified, dedicated master node will be created.
        :param pulumi.Input[builtins.str] password: The password of the instance. The password can be 8 to 30 characters in length and must contain three of the following conditions: uppercase letters, lowercase letters, numbers, and special characters (`!@#$%^&*()_+-=`).
        :param pulumi.Input[builtins.int] period: The duration that you will buy Elasticsearch instance (in month). It is valid when instance_charge_type is `PrePaid`. Valid values: [1~9], 12, 24, 36. Default to 1. From version 1.69.2, when to modify this value, the resource can renewal a `PrePaid` instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_whitelists: Set the instance's IP whitelist in VPC network.
        :param pulumi.Input[builtins.str] protocol: Elasticsearch protocol. Supported values: `HTTP`, `HTTPS`.default is `HTTP`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] public_whitelists: Set the instance's IP whitelist in internet network.
        :param pulumi.Input[builtins.str] renew_status: The renewal status of the specified instance. Valid values: `AutoRenewal`, `ManualRenewal`, `NotRenewal`.The `instance_charge_type` must be `PrePaid`.
        :param pulumi.Input[builtins.str] renewal_duration_unit: Auto-Renewal Cycle Unit Values Include: Month: Month. Year: Years. Valid values: `M`, `Y`.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of resource group which the Elasticsearch instance belongs.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] setting_config: The YML configuration of the instance.[Detailed introduction](https://www.alibabacloud.com/help/doc-detail/61336.html).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.int] warm_node_amount: The Elasticsearch cluster's warm node quantity, between 3 and 50.
        :param pulumi.Input[builtins.bool] warm_node_disk_encrypted: If encrypt the warm node disk. Valid values are `true`, `false`. Default to `false`.
        :param pulumi.Input[builtins.int] warm_node_disk_size: The single warm node storage space, should between 500 and 20480
        :param pulumi.Input[builtins.str] warm_node_disk_type: The warm node disk type. Supported values:  cloud_efficiency.
        :param pulumi.Input[builtins.str] warm_node_spec: The warm node specifications of the Elasticsearch instance.
        :param pulumi.Input[builtins.int] zone_count: The Multi-AZ supported for Elasticsearch, between 1 and 3. The `data_node_amount` value must be an integral multiple of the `zone_count` value.
        """
    ...
    def data_node_amount(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def data_node_amount(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "data_node_amount", value)

    @property
    @pulumi.getter(name="dataNodeDiskSize")
    def data_node_disk_size(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def data_node_disk_size(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "data_node_disk_size", value)

    @property
    @pulumi.getter(name="dataNodeDiskType")
    def data_node_disk_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def data_node_disk_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "data_node_disk_type", value)

    @property
    @pulumi.getter(name="dataNodeSpec")
    def data_node_spec(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def data_node_spec(self, value: pulumi.Input[builtins.str]):
    ...
    def client_node_amount(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def client_node_amount(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "client_node_amount", value)

    @property
    @pulumi.getter(name="clientNodeSpec")
    def client_node_spec(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_node_spec(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_node_spec", value)

    @property
    @pulumi.getter(name="dataNodeDiskEncrypted")
    def data_node_disk_encrypted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def data_node_disk_encrypted(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "data_node_disk_encrypted", value)

    @property
    @pulumi.getter(name="dataNodeDiskPerformanceLevel")
    def data_node_disk_performance_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_node_disk_performance_level(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def kibana_node_spec(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def kibana_node_spec(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "kibana_node_spec", value)

    @property
    @pulumi.getter(name="kibanaPrivateSecurityGroupId")
    def kibana_private_security_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def kibana_private_security_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "kibana_private_security_group_id", value)

    @property
    @pulumi.getter(name="kibanaPrivateWhitelists")
    def kibana_private_whitelists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def kibana_private_whitelists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "kibana_private_whitelists", value)

    @property
    @pulumi.getter(name="kibanaWhitelists")
    def kibana_whitelists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def kibana_whitelists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def master_node_disk_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_node_disk_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "master_node_disk_type", value)

    @property
    @pulumi.getter(name="masterNodeSpec")
    def master_node_spec(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_node_spec(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def private_whitelists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def private_whitelists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def public_whitelists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def public_whitelists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "public_whitelists", value)

    @property
    @pulumi.getter(name="renewStatus")
    def renew_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @renew_status.setter
    def renew_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def setting_config(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def setting_config(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def warm_node_amount(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def warm_node_amount(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "warm_node_amount", value)

    @property
    @pulumi.getter(name="warmNodeDiskEncrypted")
    def warm_node_disk_encrypted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def warm_node_disk_encrypted(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "warm_node_disk_encrypted", value)

    @property
    @pulumi.getter(name="warmNodeDiskSize")
    def warm_node_disk_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def warm_node_disk_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "warm_node_disk_size", value)

    @property
    @pulumi.getter(name="warmNodeDiskType")
    def warm_node_disk_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def warm_node_disk_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "warm_node_disk_type", value)

    @property
    @pulumi.getter(name="warmNodeSpec")
    def warm_node_spec(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def warm_node_spec(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "warm_node_spec", value)

    @property
    @pulumi.getter(name="zoneCount")
    def zone_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @zone_count.setter
    def zone_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _InstanceState:
    def __init__(__self__, *,
                 ...
                 client_node_amount: Optional[pulumi.Input[builtins.int]] = None,
                 client_node_spec: Optional[pulumi.Input[builtins.str]] = None,
                 data_node_amount: Optional[pulumi.Input[builtins.int]] = None,
                 data_node_disk_encrypted: Optional[pulumi.Input[builtins.bool]] = None,
                 data_node_disk_performance_level: Optional[pulumi.Input[builtins.str]] = None,
                 data_node_disk_size: Optional[pulumi.Input[builtins.int]] = None,
                 data_node_disk_type: Optional[pulumi.Input[builtins.str]] = None,
                 data_node_spec: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 enable_public: Optional[pulumi.Input[builtins.bool]] = None,
                 instance_charge_type: Optional[pulumi.Input[builtins.str]] = None,
                 kibana_domain: Optional[pulumi.Input[builtins.str]] = None,
                 kibana_node_spec: Optional[pulumi.Input[builtins.str]] = None,
                 kibana_port: Optional[pulumi.Input[builtins.int]] = None,
                 kibana_private_security_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 kibana_private_whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 kibana_whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 kms_encrypted_password: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 private_whitelists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 protocol: Optional[pulumi.Input[builtins.str]] = None,
                 public_domain: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] data_node_spec: The data node specifications of the Elasticsearch instance.
        :param pulumi.Input[builtins.str] description: The description of instance. It a string of 0 to 30 characters.
        :param pulumi.Input[builtins.str] domain: Instance connection domain (only VPC network access supported).
        :param pulumi.Input[builtins.bool] enable_kibana_private_network: Bool, default to false. When it set to true, the instance can close kibana private network access。
        :param pulumi.Input[builtins.bool] enable_kibana_public_network: Bool, default to true. When it set to false, the instance can enable kibana public network access。
        :param pulumi.Input[builtins.bool] enable_public: Bool, default to false. When it set to true, the instance can enable public network access。
        :param pulumi.Input[builtins.str] instance_charge_type: Valid values are `PrePaid`, `PostPaid`. Default to `PostPaid`. From version 1.69.0, the Elasticsearch cluster allows you to update your instance_charge_ype from `PostPaid` to `PrePaid`, the following attributes are required: `period`.
        ...
        :param pulumi.Input[builtins.str] password: The password of the instance. The password can be 8 to 30 characters in length and must contain three of the following conditions: uppercase letters, lowercase letters, numbers, and special characters (`!@#$%^&*()_+-=`).
        :param pulumi.Input[builtins.int] period: The duration that you will buy Elasticsearch instance (in month). It is valid when instance_charge_type is `PrePaid`. Valid values: [1~9], 12, 24, 36. Default to 1. From version 1.69.2, when to modify this value, the resource can renewal a `PrePaid` instance.
        :param pulumi.Input[builtins.int] port: Instance connection port.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_whitelists: Set the instance's IP whitelist in VPC network.
        :param pulumi.Input[builtins.str] protocol: Elasticsearch protocol. Supported values: `HTTP`, `HTTPS`.default is `HTTP`.
        :param pulumi.Input[builtins.str] public_domain: Instance connection public domain.
        :param pulumi.Input[builtins.int] public_port: Instance connection public port.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] public_whitelists: Set the instance's IP whitelist in internet network.
        :param pulumi.Input[builtins.str] renew_status: The renewal status of the specified instance. Valid values: `AutoRenewal`, `ManualRenewal`, `NotRenewal`.The `instance_charge_type` must be `PrePaid`.
        :param pulumi.Input[builtins.str] renewal_duration_unit: Auto-Renewal Cycle Unit Values Include: Month: Month. Year: Years. Valid values: `M`, `Y`.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of resource group which the Elasticsearch instance belongs.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] setting_config: The YML configuration of the instance.[Detailed introduction](https://www.alibabacloud.com/help/doc-detail/61336.html).
        :param pulumi.Input[builtins.str] status: The Elasticsearch instance status. Includes `active`, `activating`, `inactive`. Some operations are denied when status is not `active`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] version: Elasticsearch version. Supported values: `5.5.3_with_X-Pack`, `6.3_with_X-Pack`, `6.7_with_X-Pack`, `6.8_with_X-Pack`, `7.4_with_X-Pack` , `7.7_with_X-Pack`, `7.10_with_X-Pack`, `7.16_with_X-Pack`, `8.5_with_X-Pack`, `8.9_with_X-Pack`, `8.13_with_X-Pack`.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of VSwitch.
        :param pulumi.Input[builtins.int] warm_node_amount: The Elasticsearch cluster's warm node quantity, between 3 and 50.
    ...
    @property
    @pulumi.getter(name="dataNodeAmount")
    def data_node_amount(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The Elasticsearch cluster's data node quantity, between 2 and 50.
        """
        return pulumi.get(self, "data_node_amount")
    ...
    @data_node_amount.setter
    def data_node_amount(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "data_node_amount", value)
    ...
    @property
    @pulumi.getter(name="dataNodeDiskSize")
    def data_node_disk_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The single data node storage space.
        """
        return pulumi.get(self, "data_node_disk_size")
    ...
    @data_node_disk_size.setter
    def data_node_disk_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "data_node_disk_size", value)

    @property
    @pulumi.getter(name="dataNodeDiskType")
    def data_node_disk_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The data node disk type. Supported values: cloud_ssd, cloud_efficiency.
        """
        return pulumi.get(self, "data_node_disk_type")
    ...
    @data_node_disk_type.setter
    def data_node_disk_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_node_disk_type", value)

    @property
    @pulumi.getter(name="dataNodeSpec")
    def data_node_spec(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The data node specifications of the Elasticsearch instance.
        """
        return pulumi.get(self, "data_node_spec")
    ...
    @data_node_spec.setter
    def data_node_spec(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_node_spec", value)
    ...
    def kibana_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def kibana_domain(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def kibana_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Kibana console port.
        """
    ...
    @kibana_port.setter
    def kibana_port(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def public_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_domain(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            warm_node_disk_type: Optional[pulumi.Input[builtins.str]] = None,
            warm_node_spec: Optional[pulumi.Input[builtins.str]] = None,
            zone_count: Optional[pulumi.Input[builtins.int]] = None) -> 'Instance':
        """
    ...
    @property
    @pulumi.getter(name="clientNodeAmount")
    def client_node_amount(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The Elasticsearch cluster's client node quantity, between 2 and 25.
        """
        return pulumi.get(self, "client_node_amount")
    ...
    @property
    @pulumi.getter(name="clientNodeSpec")
    def client_node_spec(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The client node spec. If specified, client node will be created.
        """
        return pulumi.get(self, "client_node_spec")
    ...
    @property
    @pulumi.getter(name="dataNodeAmount")
    def data_node_amount(self) -> pulumi.Output[builtins.int]:
        """
        The Elasticsearch cluster's data node quantity, between 2 and 50.
        """
        return pulumi.get(self, "data_node_amount")
    ...
    @property
    @pulumi.getter(name="dataNodeDiskEncrypted")
    def data_node_disk_encrypted(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If encrypt the data node disk. Valid values are `true`, `false`. Default to `false`.
        """
        return pulumi.get(self, "data_node_disk_encrypted")
    ...
    @property
    @pulumi.getter(name="dataNodeDiskPerformanceLevel")
    def data_node_disk_performance_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cloud disk performance level. Valid values are `PL0`, `PL1`, `PL2`, `PL3`. The `data_node_disk_type` muse be `cloud_essd`.
        """
        return pulumi.get(self, "data_node_disk_performance_level")
    ...
    @property
    @pulumi.getter(name="dataNodeDiskSize")
    def data_node_disk_size(self) -> pulumi.Output[builtins.int]:
        """
        The single data node storage space.
        """
        return pulumi.get(self, "data_node_disk_size")
    ...
    @property
    @pulumi.getter(name="dataNodeDiskType")
    def data_node_disk_type(self) -> pulumi.Output[builtins.str]:
        """
        The data node disk type. Supported values: cloud_ssd, cloud_efficiency.
        """
        return pulumi.get(self, "data_node_disk_type")
    ...
    @property
    @pulumi.getter(name="dataNodeSpec")
    def data_node_spec(self) -> pulumi.Output[builtins.str]:
        """
        The data node specifications of the Elasticsearch instance.
        """
        return pulumi.get(self, "data_node_spec")
    ...
    @property
    @pulumi.getter(name="enableKibanaPrivateNetwork")
    def enable_kibana_private_network(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Bool, default to false. When it set to true, the instance can close kibana private network access。
        """
        return pulumi.get(self, "enable_kibana_private_network")
    ...
    @property
    @pulumi.getter(name="enableKibanaPublicNetwork")
    def enable_kibana_public_network(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Bool, default to true. When it set to false, the instance can enable kibana public network access。
        """
        return pulumi.get(self, "enable_kibana_public_network")
    ...
    @property
    @pulumi.getter(name="kibanaDomain")
    def kibana_domain(self) -> pulumi.Output[builtins.str]:
        """
        Kibana console domain (Internet access supported).
        """
        return pulumi.get(self, "kibana_domain")
    ...
    @property
    @pulumi.getter(name="kibanaNodeSpec")
    def kibana_node_spec(self) -> pulumi.Output[builtins.str]:
        """
        The kibana node specifications of the Elasticsearch instance. Default is `elasticsearch.n4.small`.
        """
        return pulumi.get(self, "kibana_node_spec")
    ...
    @property
    @pulumi.getter(name="kibanaPort")
    def kibana_port(self) -> pulumi.Output[builtins.int]:
        """
        Kibana console port.
        """
        return pulumi.get(self, "kibana_port")
    ...
    @property
    @pulumi.getter(name="kibanaPrivateSecurityGroupId")
    def kibana_private_security_group_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        the security group id associated with Kibana private network, this param is required when `enable_kibana_private_network` set true, and the security group id should in the same VPC as `vswitch_id`
        """
        return pulumi.get(self, "kibana_private_security_group_id")
    ...
    @property
    @pulumi.getter(name="kibanaPrivateWhitelists")
    def kibana_private_whitelists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Set the Kibana's IP whitelist in private network, This option has been abandoned on newly created instance, please use `kibana_private_security_group_id` instead
        """
        return pulumi.get(self, "kibana_private_whitelists")
    ...
    @property
    @pulumi.getter(name="kibanaWhitelists")
    def kibana_whitelists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Set the Kibana's IP whitelist in internet network.
        """
        return pulumi.get(self, "kibana_whitelists")
    ...
    @property
    @pulumi.getter(name="masterNodeDiskType")
    def master_node_disk_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The single master node storage space. Valid values are `PrePaid`, `PostPaid`.
        """
        return pulumi.get(self, "master_node_disk_type")
    ...
    @property
    @pulumi.getter(name="masterNodeSpec")
    def master_node_spec(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The dedicated master node spec. If specified, dedicated master node will be created.
        """
        return pulumi.get(self, "master_node_spec")
    ...
    @property
    @pulumi.getter(name="privateWhitelists")
    def private_whitelists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Set the instance's IP whitelist in VPC network.
        """
        return pulumi.get(self, "private_whitelists")
    ...
    @property
    @pulumi.getter(name="publicDomain")
    def public_domain(self) -> pulumi.Output[builtins.str]:
        """
        Instance connection public domain.
        """
        return pulumi.get(self, "public_domain")
    ...
    @property
    @pulumi.getter(name="publicWhitelists")
    def public_whitelists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Set the instance's IP whitelist in internet network.
        """
        return pulumi.get(self, "public_whitelists")
    ...
    @property
    @pulumi.getter(name="renewStatus")
    def renew_status(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The renewal status of the specified instance. Valid values: `AutoRenewal`, `ManualRenewal`, `NotRenewal`.The `instance_charge_type` must be `PrePaid`.
        """
        return pulumi.get(self, "renew_status")
    ...
    @property
    @pulumi.getter(name="renewalDurationUnit")
    def renewal_duration_unit(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Auto-Renewal Cycle Unit Values Include: Month: Month. Year: Years. Valid values: `M`, `Y`.
        """
        return pulumi.get(self, "renewal_duration_unit")
    ...
    @property
    @pulumi.getter(name="settingConfig")
    def setting_config(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        The YML configuration of the instance.[Detailed introduction](https://www.alibabacloud.com/help/doc-detail/61336.html).
        """
        return pulumi.get(self, "setting_config")
    ...
    @property
    @pulumi.getter(name="warmNodeAmount")
    def warm_node_amount(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The Elasticsearch cluster's warm node quantity, between 3 and 50.
        """
        return pulumi.get(self, "warm_node_amount")
    ...
    @property
    @pulumi.getter(name="warmNodeDiskEncrypted")
    def warm_node_disk_encrypted(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If encrypt the warm node disk. Valid values are `true`, `false`. Default to `false`.
        """
        return pulumi.get(self, "warm_node_disk_encrypted")
    ...
    @property
    @pulumi.getter(name="warmNodeDiskSize")
    def warm_node_disk_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The single warm node storage space, should between 500 and 20480
        """
        return pulumi.get(self, "warm_node_disk_size")
    ...
    @property
    @pulumi.getter(name="warmNodeDiskType")
    def warm_node_disk_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The warm node disk type. Supported values:  cloud_efficiency.
        """
        return pulumi.get(self, "warm_node_disk_type")
    ...
    @property
    @pulumi.getter(name="warmNodeSpec")
    def warm_node_spec(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The warm node specifications of the Elasticsearch instance.
        """
        return pulumi.get(self, "warm_node_spec")
    ...
    @property
    @pulumi.getter(name="zoneCount")
    def zone_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The Multi-AZ supported for Elasticsearch, between 1 and 3. The `data_node_amount` value must be an integral multiple of the `zone_count` value.
        """
        return pulumi.get(self, "zone_count")
