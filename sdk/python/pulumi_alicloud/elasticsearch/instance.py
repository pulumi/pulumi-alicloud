...
class Instance(pulumi.CustomResource):
    ...
    """
    enable_kibana_private_network: pulumi.Output[bool]
    """
    Bool, default to false. When it set to true, the instance can close kibana private network access。
    """
    enable_kibana_public_network: pulumi.Output[bool]
    """
    ...
    Kibana console port.
    """
    kibana_private_whitelists: pulumi.Output[list]
    """
    ...
    def __init__(__self__, resource_name, opts=None, data_node_amount=None, data_node_disk_encrypted=None, data_node_disk_size=None, data_node_disk_type=None, data_node_spec=None, description=None, enable_kibana_private_network=None, enable_kibana_public_network=None, enable_public=None, instance_charge_type=None, kibana_private_whitelists=None, kibana_whitelists=None, kms_encrypted_password=None, kms_encryption_context=None, master_node_spec=None, password=None, period=None, private_whitelists=None, public_whitelists=None, resource_group_id=None, tags=None, version=None, vswitch_id=None, zone_count=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[list] kibana_private_whitelists: Set the Kibana's IP whitelist in private network.
        ...
        :param pulumi.Input[list] public_whitelists: Set the instance's IP whitelist in internet network.
