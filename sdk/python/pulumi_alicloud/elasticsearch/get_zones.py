...
def get_zones(multi: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool multi: Indicate whether the zones can be used in a multi AZ configuration. Default to `false`. Multi AZ is usually used to launch Elasticsearch instances.
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:elasticsearch/getZones:getZones', __args__, opts=opts, typ=GetZonesResult).value
...
def get_zones_output(multi: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:elasticsearch/getZones:getZones', __args__, opts=opts, typ=GetZonesResult)
