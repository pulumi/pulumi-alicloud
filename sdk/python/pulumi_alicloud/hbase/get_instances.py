...
def get_instances(availability_zone=None,ids=None,name_regex=None,output_file=None,tags=None,opts=None):
    """
    ...
    :param list ids: The ids list of HBase instances
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:hbase/getInstances:getInstances', __args__, opts=opts).value
