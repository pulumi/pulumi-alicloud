...
def get_instances(availability_zone: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: The ids list of HBase instances
    :param builtins.str name_regex: A regex string to apply to the instance name.
    :param builtins.str output_file: The name of file that can save the collection of instances after running `pulumi preview`.
...
def get_instances_output(availability_zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:hbase/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult)
