...
class InstanceArgs:
    def __init__(__self__, *,
                 core_instance_type: pulumi.Input[builtins.str],
                 engine_version: pulumi.Input[builtins.str],
                 master_instance_type: pulumi.Input[builtins.str],
                 account: Optional[pulumi.Input[builtins.str]] = None,
                 auto_renew: Optional[pulumi.Input[builtins.bool]] = None,
                 cold_storage_size: Optional[pulumi.Input[builtins.int]] = None,
                 core_disk_size: Optional[pulumi.Input[builtins.int]] = None,
                 core_disk_type: Optional[pulumi.Input[builtins.str]] = None,
                 core_instance_quantity: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 immediate_delete_flag: Optional[pulumi.Input[builtins.bool]] = None,
                 ip_white: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] core_instance_type: Instance specification. See [Instance specifications](https://help.aliyun.com/document_detail/53532.html), or you can call describeInstanceType api.
        :param pulumi.Input[builtins.str] engine_version: HBase major version. hbase:1.1/2.0, hbaseue:2.0, bds:1.0, unsupport other engine temporarily. Value options can refer to the latest docs [CreateInstance](https://www.alibabacloud.com/help/en/data-lake-analytics/latest/createinstance).
        :param pulumi.Input[builtins.str] master_instance_type: Instance specification. See [Instance specifications](https://help.aliyun.com/document_detail/53532.html), or you can call describeInstanceType api.
        :param pulumi.Input[builtins.str] account: The account of the cluster web ui. Size [0-128].
        :param pulumi.Input[builtins.bool] auto_renew: Valid values are `true`, `false`, system default to `false`, valid when pay_type = PrePaid.
        :param pulumi.Input[builtins.int] cold_storage_size: 0 or [800, 100000000], step:10-GB increments. 0 means is_cold_storage = false. [800, 100000000] means is_cold_storage = true.
        :param pulumi.Input[builtins.int] core_disk_size: User-defined HBase instance one core node's storage. Valid when engine=hbase/hbaseue. Bds engine no need core_disk_size, space.Unit: GB. Value range:
               - Custom storage space, value range: [20, 64000].
               - Cluster [400, 64000], step:40-GB increments.
               - Single [20-500GB], step:1-GB increments.
        :param pulumi.Input[builtins.str] core_disk_type: Valid values are `cloud_ssd`, `cloud_essd_pl1`, `cloud_efficiency`, `local_hdd_pro`, `local_ssd_pro`，``, local_disk size is fixed. When engine=bds, no need to set disk type(or empty string).
        :param pulumi.Input[builtins.int] core_instance_quantity: Default=2, [1-200]. If core_instance_quantity > 1, this is cluster's instance. If core_instance_quantity = 1, this is a single instance.
        :param pulumi.Input[builtins.bool] deletion_protection: The switch of delete protection. True: delete protect, False: no delete protect. You must set false when you want to delete cluster.
        :param pulumi.Input[builtins.int] duration: 1, 2, 3, 4, 5, 6, 7, 8, 9, 12, 24, 36, valid when pay_type = PrePaid,  unit: month. 12, 24, 36 mean 1, 2, 3 years.
        :param pulumi.Input[builtins.str] engine: Valid values are "hbase/hbaseue/bds". The following types are supported after v1.73.0: `hbaseue` and `bds`. Single hbase instance need to set engine=hbase, core_instance_quantity=1.
        :param pulumi.Input[builtins.bool] immediate_delete_flag: The switch of delete immediate. True: delete immediate, False: delete delay. You will not found the cluster no matter set true or false.
        :param pulumi.Input[builtins.str] ip_white: The white ip list of the cluster.
        :param pulumi.Input[builtins.str] maintain_end_time: The end time of the operation and maintenance time period of the instance, in the format of HH:mmZ (UTC time), for example 04:00Z.
        :param pulumi.Input[builtins.str] maintain_start_time: The start time of the operation and maintenance time period of the instance, in the format of HH:mmZ (UTC time), for example 02:00Z.
        :param pulumi.Input[builtins.str] name: HBase instance name. Length must be 2-128 characters long. Only Chinese characters, English letters, numbers, period (.), underline (_), or dash (-) are permitted.
        :param pulumi.Input[builtins.str] password: The password of the cluster web ui account. Size [0-128].
        :param pulumi.Input[builtins.str] pay_type: Valid values are `PrePaid`, `PostPaid`, System default to `PostPaid`. You can also convert PostPaid to PrePaid. And support convert PrePaid to PostPaid from 1.115.0+.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: The security group resource of the cluster.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] vpc_id: The id of the VPC.
        :param pulumi.Input[builtins.str] vswitch_id: If vswitch_id is not empty, that mean net_type = vpc and has a same region. If vswitch_id is empty, net_type=classic. Intl site not support classic network.
        :param pulumi.Input[builtins.str] zone_id: The Zone to launch the HBase instance. If vswitch_id is not empty, this zone_id can be "" or consistent.
        """
    ...
    def core_instance_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def core_instance_type(self, value: pulumi.Input[builtins.str]):
    ...
    def master_instance_type(self) -> pulumi.Input[builtins.str]:
        """
        Instance specification. See [Instance specifications](https://help.aliyun.com/document_detail/53532.html), or you can call describeInstanceType api.
        """
    ...
    def master_instance_type(self, value: pulumi.Input[builtins.str]):
    ...
    def cold_storage_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cold_storage_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cold_storage_size", value)

    @property
    @pulumi.getter(name="coreDiskSize")
    def core_disk_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def core_disk_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "core_disk_size", value)

    @property
    @pulumi.getter(name="coreDiskType")
    def core_disk_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def core_disk_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "core_disk_type", value)

    @property
    @pulumi.getter(name="coreInstanceQuantity")
    def core_instance_quantity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def core_instance_quantity(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def immediate_delete_flag(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def immediate_delete_flag(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "immediate_delete_flag", value)

    @property
    @pulumi.getter(name="ipWhite")
    def ip_white(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ip_white.setter
    def ip_white(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _InstanceState:
    def __init__(__self__, *,
                 ...
                 core_disk_type: Optional[pulumi.Input[builtins.str]] = None,
                 core_instance_quantity: Optional[pulumi.Input[builtins.int]] = None,
                 core_instance_type: Optional[pulumi.Input[builtins.str]] = None,
                 deletion_protection: Optional[pulumi.Input[builtins.bool]] = None,
                 duration: Optional[pulumi.Input[builtins.int]] = None,
                 engine: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 maintain_end_time: Optional[pulumi.Input[builtins.str]] = None,
                 maintain_start_time: Optional[pulumi.Input[builtins.str]] = None,
                 master_instance_quantity: Optional[pulumi.Input[builtins.int]] = None,
                 master_instance_type: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 pay_type: Optional[pulumi.Input[builtins.str]] = None,
                 security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] maintain_end_time: The end time of the operation and maintenance time period of the instance, in the format of HH:mmZ (UTC time), for example 04:00Z.
        :param pulumi.Input[builtins.str] maintain_start_time: The start time of the operation and maintenance time period of the instance, in the format of HH:mmZ (UTC time), for example 02:00Z.
        :param pulumi.Input[builtins.int] master_instance_quantity: Count nodes of the master node.
        :param pulumi.Input[builtins.str] master_instance_type: Instance specification. See [Instance specifications](https://help.aliyun.com/document_detail/53532.html), or you can call describeInstanceType api.
        :param pulumi.Input[builtins.str] name: HBase instance name. Length must be 2-128 characters long. Only Chinese characters, English letters, numbers, period (.), underline (_), or dash (-) are permitted.
        :param pulumi.Input[builtins.str] password: The password of the cluster web ui account. Size [0-128].
        :param pulumi.Input[builtins.str] pay_type: Valid values are `PrePaid`, `PostPaid`, System default to `PostPaid`. You can also convert PostPaid to PrePaid. And support convert PrePaid to PostPaid from 1.115.0+.
    ...
    @property
    @pulumi.getter(name="coreInstanceType")
    def core_instance_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Instance specification. See [Instance specifications](https://help.aliyun.com/document_detail/53532.html), or you can call describeInstanceType api.
        """
        return pulumi.get(self, "core_instance_type")
    ...
    @core_instance_type.setter
    def core_instance_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "core_instance_type", value)
    ...
    def master_instance_quantity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def master_instance_quantity(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "master_instance_quantity", value)

    @property
    @pulumi.getter(name="masterInstanceType")
    def master_instance_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Instance specification. See [Instance specifications](https://help.aliyun.com/document_detail/53532.html), or you can call describeInstanceType api.
        """
        return pulumi.get(self, "master_instance_type")
    ...
    @master_instance_type.setter
    def master_instance_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "master_instance_type", value)
...
class Instance(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:hbase/instance:Instance"
    ...
    @property
    @pulumi.getter(name="coldStorageSize")
    def cold_storage_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        0 or [800, 100000000], step:10-GB increments. 0 means is_cold_storage = false. [800, 100000000] means is_cold_storage = true.
        """
        return pulumi.get(self, "cold_storage_size")
    ...
    @property
    @pulumi.getter(name="coreDiskSize")
    def core_disk_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        User-defined HBase instance one core node's storage. Valid when engine=hbase/hbaseue. Bds engine no need core_disk_size, space.Unit: GB. Value range:
        - Custom storage space, value range: [20, 64000].
        - Cluster [400, 64000], step:40-GB increments.
    ...
    @property
    @pulumi.getter(name="coreDiskType")
    def core_disk_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Valid values are `cloud_ssd`, `cloud_essd_pl1`, `cloud_efficiency`, `local_hdd_pro`, `local_ssd_pro`，``, local_disk size is fixed. When engine=bds, no need to set disk type(or empty string).
        """
        return pulumi.get(self, "core_disk_type")
    ...
    @property
    @pulumi.getter(name="coreInstanceQuantity")
    def core_instance_quantity(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Default=2, [1-200]. If core_instance_quantity > 1, this is cluster's instance. If core_instance_quantity = 1, this is a single instance.
        """
        return pulumi.get(self, "core_instance_quantity")
    ...
    @property
    @pulumi.getter(name="coreInstanceType")
    def core_instance_type(self) -> pulumi.Output[builtins.str]:
        """
        Instance specification. See [Instance specifications](https://help.aliyun.com/document_detail/53532.html), or you can call describeInstanceType api.
        """
        return pulumi.get(self, "core_instance_type")
    ...
    @property
    @pulumi.getter(name="immediateDeleteFlag")
    def immediate_delete_flag(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The switch of delete immediate. True: delete immediate, False: delete delay. You will not found the cluster no matter set true or false.
        """
        return pulumi.get(self, "immediate_delete_flag")
    ...
    @property
    @pulumi.getter(name="ipWhite")
    def ip_white(self) -> pulumi.Output[builtins.str]:
        """
        The white ip list of the cluster.
        """
        return pulumi.get(self, "ip_white")
    ...
    @property
    @pulumi.getter(name="masterInstanceQuantity")
    def master_instance_quantity(self) -> pulumi.Output[builtins.int]:
        """
        Count nodes of the master node.
        """
        return pulumi.get(self, "master_instance_quantity")
    ...
    @property
    @pulumi.getter(name="masterInstanceType")
    def master_instance_type(self) -> pulumi.Output[builtins.str]:
        """
        Instance specification. See [Instance specifications](https://help.aliyun.com/document_detail/53532.html), or you can call describeInstanceType api.
        """
        return pulumi.get(self, "master_instance_type")
    ...
    @property
    @pulumi.getter(name="payType")
    def pay_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Valid values are `PrePaid`, `PostPaid`, System default to `PostPaid`. You can also convert PostPaid to PrePaid. And support convert PrePaid to PostPaid from 1.115.0+.
        """
        return pulumi.get(self, "pay_type")
