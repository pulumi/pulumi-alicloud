...
if not MYPY:
    class InstanceSlbConnAddrArgsDict(TypedDict):
        conn_addr: NotRequired[pulumi.Input[builtins.str]]
        """
        The Phoenix address.
        """
        conn_addr_port: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InstanceSlbConnAddrArgs:
    def __init__(__self__, *,
                 conn_addr: Optional[pulumi.Input[builtins.str]] = None,
                 conn_addr_port: Optional[pulumi.Input[builtins.str]] = None,
                 net_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] conn_addr: The Phoenix address.
        :param pulumi.Input[builtins.str] conn_addr_port: The number of the port over which Phoenix connects to the instance.
        :param pulumi.Input[builtins.str] net_type: The type of the network. Valid values:
        """
    ...
    def conn_addr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Phoenix address.
        """
    ...
    @conn_addr.setter
    def conn_addr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "conn_addr", value)

    @property
    @pulumi.getter(name="connAddrPort")
    def conn_addr_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The number of the port over which Phoenix connects to the instance.
        """
    ...
    def conn_addr_port(self, value: Optional[pulumi.Input[builtins.str]]):
