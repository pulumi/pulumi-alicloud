...
def get_instance_types(charge_type: Optional[builtins.str] = None,
    ...
    :param builtins.str charge_type: The charge type of create hbase cluster instance, `PrePaid` or `PostPaid`.
    :param builtins.str disk_type: The disk type, `cloud_ssd`, `cloud_essd_pl1`, `cloud_efficiency`, `local_hdd_pro`, `local_ssd_pro`.
    ...
    :param builtins.str region_id: The dest region id, default client region.
    :param builtins.str version: The engine version, singlehbase/hbase=1.1/2.0, bds=1.0.
    :param builtins.str zone_id: The zone id, belong to regionId.
    """
    __args__ = dict()
...
def get_instance_types_output(charge_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
