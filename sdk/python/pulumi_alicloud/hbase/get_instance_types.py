...
def get_instance_types(charge_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region_id: The dest region id, default client region.
    :param _builtins.str version: The engine version, singlehbase/hbase=1.1/2.0, bds=1.0.
    :param _builtins.str zone_id: The zone id, belong to regionId.
    """
    __args__ = dict()
