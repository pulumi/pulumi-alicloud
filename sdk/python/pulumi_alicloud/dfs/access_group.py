...
class AccessGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_group_name: The permission group name. The naming rules are as follows: The length is 6~64 characters. Globally unique and cannot be an empty string. English letters are supported and can contain numbers, underscores (_), and dashes (-).
        :param pulumi.Input[builtins.str] network_type: The permission group type. Only VPC (VPC) is supported.
        :param pulumi.Input[builtins.str] description: The permission group description.  No more than 32 characters in length.
        """
...
class _AccessGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_group_name: The permission group name. The naming rules are as follows: The length is 6~64 characters. Globally unique and cannot be an empty string. English letters are supported and can contain numbers, underscores (_), and dashes (-).
        :param pulumi.Input[builtins.str] create_time: The creation time of the permission group resource.
        :param pulumi.Input[builtins.str] description: The permission group description.  No more than 32 characters in length.
        :param pulumi.Input[builtins.str] network_type: The permission group type. Only VPC (VPC) is supported.
        """
...
@pulumi.type_token("alicloud:dfs/accessGroup:AccessGroup")
class AccessGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            create_time: Optional[pulumi.Input[builtins.str]] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            network_type: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessGroup':
        """
