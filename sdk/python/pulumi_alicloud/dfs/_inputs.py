...
class VscMountPointInstanceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] instance_id: The ID of the ECS instance to which the HDFS file system is mounted.
        :param pulumi.Input[builtins.str] status: The status of the ECS instance on which the HDFS file system is mounted.
...
if not MYPY:
    class VscMountPointInstanceVscArgsDict(TypedDict):
        vsc_id: NotRequired[pulumi.Input[builtins.str]]
        """
        VSC Channel primary key representation, used to retrieve the specified VSC Channel.
        """
        vsc_status: NotRequired[pulumi.Input[builtins.str]]
        """
        VSC Mount status.
        """
        vsc_type: NotRequired[pulumi.Input[builtins.str]]
        """
        The VSC type.
        """
elif False:
...
class VscMountPointInstanceVscArgs:
    def __init__(__self__, *,
                 vsc_id: Optional[pulumi.Input[builtins.str]] = None,
                 vsc_status: Optional[pulumi.Input[builtins.str]] = None,
                 vsc_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] vsc_id: VSC Channel primary key representation, used to retrieve the specified VSC Channel.
        :param pulumi.Input[builtins.str] vsc_status: VSC Mount status.
        :param pulumi.Input[builtins.str] vsc_type: The VSC type.
        """
    ...
    def vsc_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        VSC Channel primary key representation, used to retrieve the specified VSC Channel.
        """
    ...
    @vsc_id.setter
    def vsc_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vsc_id", value)

    @property
    @pulumi.getter(name="vscStatus")
    def vsc_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        VSC Mount status.
        """
    ...
    @vsc_status.setter
    def vsc_status(self, value: Optional[pulumi.Input[builtins.str]]):
