...
def get_file_systems(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of File System IDs.
    :param _builtins.str name_regex: A regex string to filter results by File System name.
...
def get_file_systems_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:dfs/getFileSystems:getFileSystems', __args__, opts=opts, typ=GetFileSystemsResult)
