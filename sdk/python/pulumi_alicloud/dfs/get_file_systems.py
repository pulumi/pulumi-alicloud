...
def get_file_systems(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of File System IDs.
    :param builtins.str name_regex: A regex string to filter results by File System name.
...
def get_file_systems_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
