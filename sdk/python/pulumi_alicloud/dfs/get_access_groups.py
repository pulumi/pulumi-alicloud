...
class GetAccessGroupsResult:
    ...
    def order_type(self) -> Optional[builtins.str]:
...
def get_access_groups(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Access Group IDs.
    :param builtins.str name_regex: A regex string to filter results by Access Group name.
...
def get_access_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             ...
                             order_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             start_offset: Optional[pulumi.Input[Optional[builtins.int]]] = None,
