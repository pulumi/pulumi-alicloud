...
def get_mount_points(file_system_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Mount Point IDs.
...
def get_mount_points_output(file_system_id: pulumi.Input[Optional[_builtins.str]] = None,
