...
def get_mount_points(file_system_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Mount Point IDs.
...
def get_mount_points_output(file_system_id: Optional[pulumi.Input[builtins.str]] = None,
