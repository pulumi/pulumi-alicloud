...
class AccessRuleArgs:
    def __init__(__self__, *,
                 access_group_id: pulumi.Input[builtins.str],
                 network_segment: pulumi.Input[builtins.str],
                 priority: pulumi.Input[builtins.int],
                 rw_access_type: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a AccessRule resource.
        :param pulumi.Input[builtins.str] access_group_id: Permission group resource ID. You must specify the permission group ID when creating a permission rule.
        :param pulumi.Input[builtins.str] network_segment: The IP address or network segment of the authorized object.
        :param pulumi.Input[builtins.int] priority: Permission rule priority. When the same authorization object matches multiple rules, the high-priority rule takes effect. Value range: 1~100,1 is the highest priority.
        :param pulumi.Input[builtins.str] rw_access_type: The read and write permissions of the authorized object on the file system. Value: RDWR: readable and writable RDONLY: Read only.
        :param pulumi.Input[builtins.str] description: Permission rule description.  No more than 32 characters in length.
        """
    ...
    def access_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def access_group_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "access_group_id", value)

    @property
    @pulumi.getter(name="networkSegment")
    def network_segment(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def network_segment(self, value: pulumi.Input[builtins.str]):
    ...
    def rw_access_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def rw_access_type(self, value: pulumi.Input[builtins.str]):
...
class _AccessRuleState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 network_segment: Optional[pulumi.Input[builtins.str]] = None,
                 priority: Optional[pulumi.Input[builtins.int]] = None,
                 rw_access_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering AccessRule resources.
        :param pulumi.Input[builtins.str] access_group_id: Permission group resource ID. You must specify the permission group ID when creating a permission rule.
        :param pulumi.Input[builtins.str] access_rule_id: The unique identity of the permission rule, which is used to retrieve the permission rule for a specific day in the permission group.
        :param pulumi.Input[builtins.str] create_time: Permission rule resource creation time.
        :param pulumi.Input[builtins.str] description: Permission rule description.  No more than 32 characters in length.
        :param pulumi.Input[builtins.str] network_segment: The IP address or network segment of the authorized object.
        :param pulumi.Input[builtins.int] priority: Permission rule priority. When the same authorization object matches multiple rules, the high-priority rule takes effect. Value range: 1~100,1 is the highest priority.
        :param pulumi.Input[builtins.str] rw_access_type: The read and write permissions of the authorized object on the file system. Value: RDWR: readable and writable RDONLY: Read only.
    ...
    @property
    @pulumi.getter(name="networkSegment")
    def network_segment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IP address or network segment of the authorized object.
        """
        return pulumi.get(self, "network_segment")
    ...
    @network_segment.setter
    def network_segment(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "network_segment", value)
    ...
    @property
    @pulumi.getter(name="rwAccessType")
    def rw_access_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The read and write permissions of the authorized object on the file system. Value: RDWR: readable and writable RDONLY: Read only.
        """
        return pulumi.get(self, "rw_access_type")
    ...
    @rw_access_type.setter
    def rw_access_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rw_access_type", value)


@pulumi.type_token("alicloud:dfs/accessRule:AccessRule")
class AccessRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_segment: Optional[pulumi.Input[builtins.str]] = None,
            priority: Optional[pulumi.Input[builtins.int]] = None,
            rw_access_type: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessRule':
        """
    ...
    @property
    @pulumi.getter(name="accessGroupId")
    def access_group_id(self) -> pulumi.Output[builtins.str]:
        """
        Permission group resource ID. You must specify the permission group ID when creating a permission rule.
        """
        return pulumi.get(self, "access_group_id")
    ...
    @property
    @pulumi.getter(name="accessRuleId")
    def access_rule_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique identity of the permission rule, which is used to retrieve the permission rule for a specific day in the permission group.
        """
        return pulumi.get(self, "access_rule_id")
    ...
    @property
    @pulumi.getter(name="networkSegment")
    def network_segment(self) -> pulumi.Output[builtins.str]:
        """
        The IP address or network segment of the authorized object.
        """
        return pulumi.get(self, "network_segment")
    ...
    @property
    @pulumi.getter(name="rwAccessType")
    def rw_access_type(self) -> pulumi.Output[builtins.str]:
        """
        The read and write permissions of the authorized object on the file system. Value: RDWR: readable and writable RDONLY: Read only.
        """
        return pulumi.get(self, "rw_access_type")
