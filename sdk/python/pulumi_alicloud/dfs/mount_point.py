...
class MountPointArgs:
    def __init__(__self__, *,
                 ...
                 alias_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a MountPoint resource.
        :param pulumi.Input[builtins.str] access_group_id: The id of the permission group associated with the Mount point, which is used to set the access permissions of the Mount point.
        :param pulumi.Input[builtins.str] file_system_id: Unique file system identifier, used to retrieve specified file system resources.
        :param pulumi.Input[builtins.str] network_type: The network type of the Mount point.  Only VPC (VPC) is supported.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC. Specifies the VPC environment to which the mount point belongs.
        :param pulumi.Input[builtins.str] vswitch_id: VSwitch ID, which specifies the VSwitch resource used to create the mount point.
        :param pulumi.Input[builtins.str] alias_prefix: The mount point alias prefix, which specifies the mount point alias prefix.
        :param pulumi.Input[builtins.str] description: The description of the Mount point.  No more than 32 characters in length.
        :param pulumi.Input[builtins.str] status: Mount point status. Value: Inactive: Disable mount points Active: Activate the mount point.
        """
    ...
    def alias_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @alias_prefix.setter
    def alias_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MountPointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_group_id: The id of the permission group associated with the Mount point, which is used to set the access permissions of the Mount point.
        :param pulumi.Input[builtins.str] alias_prefix: The mount point alias prefix, which specifies the mount point alias prefix.
        :param pulumi.Input[builtins.str] create_time: The creation time of the Mount point resource.
        :param pulumi.Input[builtins.str] description: The description of the Mount point.  No more than 32 characters in length.
        :param pulumi.Input[builtins.str] file_system_id: Unique file system identifier, used to retrieve specified file system resources.
        :param pulumi.Input[builtins.str] mount_point_id: The unique identifier of the Mount point, which is used to retrieve the specified mount point resources.
        :param pulumi.Input[builtins.str] network_type: The network type of the Mount point.  Only VPC (VPC) is supported.
        :param pulumi.Input[builtins.str] region_id: (Available since v1.242.0) The region ID of the Mount Point.
        :param pulumi.Input[builtins.str] status: Mount point status. Value: Inactive: Disable mount points Active: Activate the mount point.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC. Specifies the VPC environment to which the mount point belongs.
        :param pulumi.Input[builtins.str] vswitch_id: VSwitch ID, which specifies the VSwitch resource used to create the mount point.
        """
...
class MountPoint(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:dfs/mountPoint:MountPoint"
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MountPoint':
        """
    ...
    @property
    @pulumi.getter(name="aliasPrefix")
    def alias_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The mount point alias prefix, which specifies the mount point alias prefix.
        """
        return pulumi.get(self, "alias_prefix")
