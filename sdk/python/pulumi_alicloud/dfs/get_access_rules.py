...
def get_access_rules(access_group_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Access Rule IDs.
...
def get_access_rules_output(access_group_id: Optional[pulumi.Input[builtins.str]] = None,
