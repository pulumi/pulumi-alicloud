...
class FileSystemArgs:
    def __init__(__self__, *,
                 ...
                 space_capacity: pulumi.Input[builtins.int],
                 storage_type: pulumi.Input[builtins.str],
                 data_redundancy_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 provisioned_throughput_in_mi_bps: Optional[pulumi.Input[builtins.int]] = None,
                 storage_set_name: Optional[pulumi.Input[builtins.str]] = None,
                 throughput_mode: Optional[pulumi.Input[builtins.str]] = None,
                 zone_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a FileSystem resource.
        :param pulumi.Input[builtins.str] file_system_name: The file system name. The naming rules are as follows: The length is 6~64 characters. Globally unique and cannot be an empty string. English letters are supported and can contain numbers, underscores (_), and dashes (-).
        :param pulumi.Input[builtins.str] protocol_type: The protocol type. Value: `HDFS`, `PANGU`.
        :param pulumi.Input[builtins.int] space_capacity: File system capacity.  When the actual amount of data stored reaches the capacity of the file system, data cannot be written.  Unit: GiB.
        :param pulumi.Input[builtins.str] storage_type: The storage media type. Value: STANDARD (default): STANDARD PERFORMANCE: PERFORMANCE type.
        :param pulumi.Input[builtins.str] data_redundancy_type: Redundancy mode of the file system. Value:
        ...
        :param pulumi.Input[builtins.str] dedicated_cluster_id: Dedicated cluster id, which is used to support scenarios such as group cloud migration.
        :param pulumi.Input[builtins.str] description: The description of the file system resource. No more than 32 characters in length.
        :param pulumi.Input[builtins.int] partition_number: Save set sequence number, the user selects the content of the specified sequence number in the Save set.
        :param pulumi.Input[builtins.int] provisioned_throughput_in_mi_bps: Provisioned throughput. This parameter is required when ThroughputMode is set to Provisioned. Unit: MB/s Value range: 1~5120.
        :param pulumi.Input[builtins.str] storage_set_name: Save set identity, used to select a user-specified save set.
        :param pulumi.Input[builtins.str] throughput_mode: The throughput mode. Value: Standard (default): Standard throughput Provisioned: preset throughput.
        :param pulumi.Input[builtins.str] zone_id: Zone Id, which is used to create file system resources to the specified zone.
        """
    ...
    def space_capacity(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def space_capacity(self, value: pulumi.Input[builtins.int]):
    ...
    def data_redundancy_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_redundancy_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def provisioned_throughput_in_mi_bps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def provisioned_throughput_in_mi_bps(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "provisioned_throughput_in_mi_bps", value)

    @property
    @pulumi.getter(name="storageSetName")
    def storage_set_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_set_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "storage_set_name", value)

    @property
    @pulumi.getter(name="throughputMode")
    def throughput_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def throughput_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FileSystemState:
    def __init__(__self__, *,
                 ...
                 space_capacity: Optional[pulumi.Input[builtins.int]] = None,
                 storage_set_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] create_time: The creation time of the file system instance.
        :param pulumi.Input[builtins.str] data_redundancy_type: Redundancy mode of the file system. Value:
               - LRS (default): Local redundancy.
               - ZRS: Same-City redundancy. When ZRS is selected, zoneId is a string consisting of multiple zones that are expected to be redundant in the same city, for example,  'zoneId1,zoneId2 '.
        :param pulumi.Input[builtins.str] dedicated_cluster_id: Dedicated cluster id, which is used to support scenarios such as group cloud migration.
        ...
        :param pulumi.Input[builtins.str] protocol_type: The protocol type. Value: `HDFS`, `PANGU`.
        :param pulumi.Input[builtins.int] provisioned_throughput_in_mi_bps: Provisioned throughput. This parameter is required when ThroughputMode is set to Provisioned. Unit: MB/s Value range: 1~5120.
        :param pulumi.Input[builtins.str] region_id: (Available since v1.242.0) The region ID of the File System.
        :param pulumi.Input[builtins.int] space_capacity: File system capacity.  When the actual amount of data stored reaches the capacity of the file system, data cannot be written.  Unit: GiB.
        :param pulumi.Input[builtins.str] storage_set_name: Save set identity, used to select a user-specified save set.
        :param pulumi.Input[builtins.str] storage_type: The storage media type. Value: STANDARD (default): STANDARD PERFORMANCE: PERFORMANCE type.
        :param pulumi.Input[builtins.str] throughput_mode: The throughput mode. Value: Standard (default): Standard throughput Provisioned: preset throughput.
    ...
    @property
    @pulumi.getter(name="spaceCapacity")
    def space_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        File system capacity.  When the actual amount of data stored reaches the capacity of the file system, data cannot be written.  Unit: GiB.
        """
        return pulumi.get(self, "space_capacity")
    ...
    @space_capacity.setter
    def space_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "space_capacity", value)
...
class FileSystem(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dataRedundancyType")
    def data_redundancy_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Redundancy mode of the file system. Value:
        - LRS (default): Local redundancy.
        - ZRS: Same-City redundancy. When ZRS is selected, zoneId is a string consisting of multiple zones that are expected to be redundant in the same city, for example,  'zoneId1,zoneId2 '.
    ...
    @property
    @pulumi.getter(name="partitionNumber")
    def partition_number(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Save set sequence number, the user selects the content of the specified sequence number in the Save set.
        """
        return pulumi.get(self, "partition_number")
    ...
    @property
    @pulumi.getter(name="provisionedThroughputInMiBps")
    def provisioned_throughput_in_mi_bps(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Provisioned throughput. This parameter is required when ThroughputMode is set to Provisioned. Unit: MB/s Value range: 1~5120.
        """
        return pulumi.get(self, "provisioned_throughput_in_mi_bps")
    ...
    @property
    @pulumi.getter(name="spaceCapacity")
    def space_capacity(self) -> pulumi.Output[builtins.int]:
        """
        File system capacity.  When the actual amount of data stored reaches the capacity of the file system, data cannot be written.  Unit: GiB.
        """
        return pulumi.get(self, "space_capacity")
    ...
    @property
    @pulumi.getter(name="storageSetName")
    def storage_set_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Save set identity, used to select a user-specified save set.
        """
        return pulumi.get(self, "storage_set_name")
    ...
    @property
    @pulumi.getter(name="throughputMode")
    def throughput_mode(self) -> pulumi.Output[builtins.str]:
        """
        The throughput mode. Value: Standard (default): Standard throughput Provisioned: preset throughput.
        """
        return pulumi.get(self, "throughput_mode")
