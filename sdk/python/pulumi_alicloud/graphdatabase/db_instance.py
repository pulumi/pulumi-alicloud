...
class DbInstanceArgs:
    def __init__(__self__, *,
                 db_instance_category: pulumi.Input[builtins.str],
                 db_instance_network_type: pulumi.Input[builtins.str],
                 db_instance_storage_type: pulumi.Input[builtins.str],
                 db_node_class: pulumi.Input[builtins.str],
                 db_node_storage: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.str] db_instance_category: The category of the db instance. Valid values: `HA`, `SINGLE`(Available in 1.173.0+).
        :param pulumi.Input[builtins.str] db_instance_network_type: The network type of the db instance. Valid values: `vpc`.
        :param pulumi.Input[builtins.str] db_instance_storage_type: Disk storage type. Valid values: `cloud_essd`, `cloud_ssd`. Modification is not supported.
        :param pulumi.Input[builtins.str] db_node_class: The class of the db node. Valid values: `gdb.r.xlarge`, `gdb.r.2xlarge`, `gdb.r.4xlarge`, `gdb.r.8xlarge`, `gdb.r.16xlarge`, `gdb.r.xlarge_basic`, `gdb.r.2xlarge_basic`, `gdb.r.4xlarge_basic`, `gdb.r.8xlarge_basic`, `gdb.r.16xlarge_basic`.
        :param pulumi.Input[builtins.int] db_node_storage: Instance storage space, which is measured in GB.
        :param pulumi.Input[builtins.str] db_version: Kernel Version. Valid values: `1.0` or `1.0-OpenCypher`. `1.0`: represented as gremlin, `1.0-OpenCypher`: said opencypher.
        :param pulumi.Input[builtins.str] payment_type: The paymen type of the resource. Valid values: `PayAsYouGo`.
        :param pulumi.Input[builtins.str] db_instance_description: According to the practical example or notes.
    ...
    def db_instance_category(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_instance_category(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "db_instance_category", value)

    @property
    @pulumi.getter(name="dbInstanceNetworkType")
    def db_instance_network_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_instance_network_type(self, value: pulumi.Input[builtins.str]):
    ...
    def db_node_class(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_node_class(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "db_node_class", value)

    @property
    @pulumi.getter(name="dbNodeStorage")
    def db_node_storage(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def db_node_storage(self, value: pulumi.Input[builtins.int]):
...
class _DbInstanceState:
    def __init__(__self__, *,
                 ...
                 db_instance_description: Optional[pulumi.Input[builtins.str]] = None,
                 db_instance_ip_arrays: Optional[pulumi.Input[Sequence[pulumi.Input['DbInstanceDbInstanceIpArrayArgs']]]] = None,
                 db_instance_network_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] connection_string: (Available in 1.196.0+)  The connection string of the instance.
        :param pulumi.Input[builtins.str] db_instance_category: The category of the db instance. Valid values: `HA`, `SINGLE`(Available in 1.173.0+).
        :param pulumi.Input[builtins.str] db_instance_description: According to the practical example or notes.
        :param pulumi.Input[Sequence[pulumi.Input['DbInstanceDbInstanceIpArrayArgs']]] db_instance_ip_arrays: IP ADDRESS whitelist for the instance group list. See `db_instance_ip_array` below.
        :param pulumi.Input[builtins.str] db_instance_network_type: The network type of the db instance. Valid values: `vpc`.
        ...
        :param pulumi.Input[builtins.str] status: Instance status. Value range: `Creating`, `Running`, `Deleting`, `Rebooting`, `DBInstanceClassChanging`, `NetAddressCreating` and `NetAddressDeleting`.
        :param pulumi.Input[builtins.str] vpc_id: ID of the VPC.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of attaching vswitch to instance.
        :param pulumi.Input[builtins.str] zone_id: The zone ID of the resource.
        """
    ...
    @property
    @pulumi.getter(name="dbInstanceNetworkType")
    def db_instance_network_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The network type of the db instance. Valid values: `vpc`.
        """
        return pulumi.get(self, "db_instance_network_type")
    ...
    @db_instance_network_type.setter
    def db_instance_network_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_instance_network_type", value)
...
class DbInstance(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:graphdatabase/dbInstance:DbInstance"
    ...
    def get(resource_name: str,
            ...
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DbInstance':
        """
    ...
    @property
    @pulumi.getter(name="dbInstanceDescription")
    def db_instance_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        According to the practical example or notes.
        """
        return pulumi.get(self, "db_instance_description")
    ...
    @property
    @pulumi.getter(name="dbInstanceNetworkType")
    def db_instance_network_type(self) -> pulumi.Output[builtins.str]:
        """
        The network type of the db instance. Valid values: `vpc`.
        """
        return pulumi.get(self, "db_instance_network_type")
