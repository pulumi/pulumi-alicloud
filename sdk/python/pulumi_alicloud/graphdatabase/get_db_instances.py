...
def get_db_instances(db_instance_description: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Db Instance IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: Instance status. Value range: `Creating`, `Running`, `Deleting`, `DBInstanceClassChanging`, `NetAddressCreating` and `NetAddressDeleting`.
    """
    __args__ = dict()
...
def get_db_instances_output(db_instance_description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
