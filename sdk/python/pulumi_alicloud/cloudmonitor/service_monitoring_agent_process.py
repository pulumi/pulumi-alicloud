...
class ServiceMonitoringAgentProcessArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] process_user: The user who launches the process.
        """
...
class _ServiceMonitoringAgentProcessState:
    def __init__(__self__, *,
                 ...
                 process_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] process_id: The ID of the process.
        :param pulumi.Input[builtins.str] process_name: The name of the process.
        :param pulumi.Input[builtins.str] process_user: The user who launches the process.
        """
    ...
    def process_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @process_id.setter
    def process_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("alicloud:cloudmonitor/serviceMonitoringAgentProcess:ServiceMonitoringAgentProcess")
class ServiceMonitoringAgentProcess(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            process_id: Optional[pulumi.Input[builtins.str]] = None,
            process_name: Optional[pulumi.Input[builtins.str]] = None,
            process_user: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceMonitoringAgentProcess':
        """
    ...
    @property
    @pulumi.getter(name="processId")
    def process_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the process.
        """
        return pulumi.get(self, "process_id")
    ...
    @property
    @pulumi.getter(name="processUser")
    def process_user(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The user who launches the process.
        """
        return pulumi.get(self, "process_user")
