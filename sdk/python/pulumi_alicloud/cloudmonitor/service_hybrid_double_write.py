...
class ServiceHybridDoubleWriteArgs:
    def __init__(__self__, *,
                 ...
                 source_namespace: pulumi.Input[builtins.str],
                 source_user_id: pulumi.Input[builtins.str],
                 user_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ServiceHybridDoubleWrite resource.
        :param pulumi.Input[builtins.str] namespace: Target Namespace.
        :param pulumi.Input[builtins.str] source_namespace: Source Namespace.
        :param pulumi.Input[builtins.str] source_user_id: Source UserId.
        :param pulumi.Input[builtins.str] user_id: Target UserId.
        """
    ...
    def source_namespace(self) -> pulumi.Input[builtins.str]:
        """
        Source Namespace.
        """
    ...
    def source_namespace(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_namespace", value)

    @property
    @pulumi.getter(name="sourceUserId")
    def source_user_id(self) -> pulumi.Input[builtins.str]:
        """
        Source UserId.
        """
    ...
    def source_user_id(self, value: pulumi.Input[builtins.str]):
...
class _ServiceHybridDoubleWriteState:
    def __init__(__self__, *,
                 ...
                 source_user_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="sourceUserId")
    def source_user_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Source UserId.
        """
        return pulumi.get(self, "source_user_id")
    ...
    @source_user_id.setter
    def source_user_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_user_id", value)
...
class ServiceHybridDoubleWrite(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_namespace: Optional[pulumi.Input[builtins.str]] = None,
            source_user_id: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceHybridDoubleWrite':
        """
    ...
    @property
    @pulumi.getter(name="sourceNamespace")
    def source_namespace(self) -> pulumi.Output[builtins.str]:
        """
        Source Namespace.
        """
        return pulumi.get(self, "source_namespace")
    ...
    @property
    @pulumi.getter(name="sourceUserId")
    def source_user_id(self) -> pulumi.Output[builtins.str]:
        """
        Source UserId.
        """
        return pulumi.get(self, "source_user_id")
