...
if not MYPY:
    class ServiceGroupMonitoringAgentProcessAlertConfigArgsDict(TypedDict):
        ...
        """
        escalations_level: pulumi.Input[builtins.str]
        """
        ...
        The alert threshold.
        """
        times: pulumi.Input[builtins.str]
        """
        The number of times for which the threshold can be consecutively exceeded.
        """
        effective_interval: NotRequired[pulumi.Input[builtins.str]]
        """
        The time period during which the alert rule is effective.
        """
        silence_time: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ServiceGroupMonitoringAgentProcessAlertConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] comparison_operator: The operator that is used to compare the metric value with the threshold. Valid values: `GreaterThanOrEqualToThreshold`, `GreaterThanThreshold`, `LessThanOrEqualToThreshold`, `LessThanThreshold`, `NotEqualToThreshold`, `GreaterThanYesterday`, `LessThanYesterday`, `GreaterThanLastWeek`, `LessThanLastWeek`, `GreaterThanLastPeriod`, `LessThanLastPeriod`.
        :param pulumi.Input[builtins.str] escalations_level: The alert level. Valid values: `critical`, `warn`, `info`.
        :param pulumi.Input[builtins.str] statistics: The statistical method for alerts. Valid values: `Average`.
        :param pulumi.Input[builtins.str] threshold: The alert threshold.
        :param pulumi.Input[builtins.str] times: The number of times for which the threshold can be consecutively exceeded.
        :param pulumi.Input[builtins.str] effective_interval: The time period during which the alert rule is effective.
        :param pulumi.Input[builtins.int] silence_time: The mute period during which new alert notifications are not sent even if the trigger conditions are met. Unit: seconds.
    ...
    def escalations_level(self) -> pulumi.Input[builtins.str]:
        """
        The alert level. Valid values: `critical`, `warn`, `info`.
        """
    ...
    def escalations_level(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def times(self) -> pulumi.Input[builtins.str]:
        """
        The number of times for which the threshold can be consecutively exceeded.
        """
    ...
    @times.setter
    def times(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ServiceGroupMonitoringAgentProcessAlertConfigTargetListArgsDict(TypedDict):
        ...
        The alert level. Valid values: `CRITICAL`, `WARN`, `INFO`.
        """
        target_list_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServiceGroupMonitoringAgentProcessAlertConfigTargetListArgs:
    def __init__(__self__, *,
                 ...
                 target_list_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] arn: The Alibaba Cloud Resource Name (ARN) of the resource.
        :param pulumi.Input[builtins.str] json_params: The parameters of the alert callback. Specify the parameters in the JSON format.
        :param pulumi.Input[builtins.str] level: The alert level. Valid values: `CRITICAL`, `WARN`, `INFO`.
        :param pulumi.Input[builtins.str] target_list_id: The ID of the resource for which alerts are triggered.
        """
        if arn is not None:
    ...
    def target_list_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the resource for which alerts are triggered.
        """
    ...
    def target_list_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServiceGroupMonitoringAgentProcessMatchExpressArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] function: The matching condition. Valid values: `all`, `startWith`, `endWith`, `contains`, `notContains`, `equals`.
        :param pulumi.Input[builtins.str] name: The criteria based on which the instances are matched.
        :param pulumi.Input[builtins.str] value: The keyword used to match the instance name.
        """
