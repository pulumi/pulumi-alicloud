...
def get_log_configs(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Log Config IDs.
    :param builtins.str log_type: The type the of log. Valid values: `PROVIDER`.
...
def get_log_configs_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
