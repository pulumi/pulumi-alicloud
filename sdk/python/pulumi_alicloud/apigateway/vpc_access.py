...
class VpcAccessArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: ID of the instance in VPC (ECS/Server Load Balance).
        :param pulumi.Input[builtins.int] port: ID of the port corresponding to the instance.
        :param pulumi.Input[builtins.str] vpc_id: The vpc id of the vpc authorization.
        :param pulumi.Input[builtins.str] name: The name of the vpc authorization.
        """
...
class VpcAccess(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            port: Optional[pulumi.Input[builtins.int]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VpcAccess':
        """
