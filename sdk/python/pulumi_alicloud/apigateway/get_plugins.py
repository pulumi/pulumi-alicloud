...
class GetPluginsResult:
    ...
    def plugin_type(self) -> Optional[builtins.str]:
...
def get_plugins(ids: Optional[Sequence[builtins.str]] = None,
                ...
                plugin_type: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Plugin IDs.
    :param builtins.str name_regex: A regex string to filter results by Plugin name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str plugin_name: The name of the plug-in that you want to create. It can contain uppercase English letters, lowercase English letters, Chinese characters, numbers, and underscores (_). It must be 4 to 50 characters in length and cannot start with an underscore (_).
    :param builtins.str plugin_type: The type of the plug-in. Valid values: `backendSignature`, `caching`, `cors`, `ipControl`, `jwtAuth`, `trafficControl`.
...
def get_plugins_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                       ...
                       plugin_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       plugin_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
