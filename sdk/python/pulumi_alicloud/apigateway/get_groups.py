...
def get_groups(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of api group IDs.
    :param _builtins.str name_regex: A regex string to filter api gateway groups by name.
...
def get_groups_output(ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:apigateway/getGroups:getGroups', __args__, opts=opts, typ=GetGroupsResult)
