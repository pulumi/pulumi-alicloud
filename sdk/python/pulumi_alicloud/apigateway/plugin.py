...
class PluginArgs:
    def __init__(__self__, *,
                 plugin_data: pulumi.Input[builtins.str],
                 plugin_name: pulumi.Input[builtins.str],
                 plugin_type: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Plugin resource.
        :param pulumi.Input[builtins.str] plugin_data: The definition statement of the plug-in. Plug-in definition statements in the JSON and YAML formats are supported.
        :param pulumi.Input[builtins.str] plugin_name: The name of the plug-in that you want to create. It can contain uppercase English letters, lowercase English letters, Chinese characters, numbers, and underscores (_). It must be 4 to 50 characters in length and cannot start with an underscore (_).
        :param pulumi.Input[builtins.str] plugin_type: The type of the plug-in. Valid values:
               - "trafficControl"
               - "ipControl"
               - "backendSignature"
               - "jwtAuth"
               ...
               - "logMask"
               - "transformer".
        :param pulumi.Input[builtins.str] description: The description of the plug-in, which cannot exceed 200 characters.
    ...
    def plugin_data(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @plugin_data.setter
    def plugin_data(self, value: pulumi.Input[builtins.str]):
    ...
    def plugin_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @plugin_type.setter
    def plugin_type(self, value: pulumi.Input[builtins.str]):
...
class _PluginState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 plugin_data: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="pluginData")
    def plugin_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The definition statement of the plug-in. Plug-in definition statements in the JSON and YAML formats are supported.
        """
        return pulumi.get(self, "plugin_data")
    ...
    @plugin_data.setter
    def plugin_data(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "plugin_data", value)
...
class Plugin(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            plugin_name: Optional[pulumi.Input[builtins.str]] = None,
            plugin_type: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Plugin':
        """
    ...
    @property
    @pulumi.getter(name="pluginData")
    def plugin_data(self) -> pulumi.Output[builtins.str]:
        """
        The definition statement of the plug-in. Plug-in definition statements in the JSON and YAML formats are supported.
        """
        return pulumi.get(self, "plugin_data")
