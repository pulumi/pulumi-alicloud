...
class PluginAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_id: The api_id that plugin attaches to.
        :param pulumi.Input[builtins.str] group_id: The group that the api belongs to.
        :param pulumi.Input[builtins.str] plugin_id: The plugin that attaches to the api.
        :param pulumi.Input[builtins.str] stage_name: Stage that the plugin attaches to.
        """
...
class PluginAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            group_id: Optional[pulumi.Input[builtins.str]] = None,
            plugin_id: Optional[pulumi.Input[builtins.str]] = None,
            stage_name: Optional[pulumi.Input[builtins.str]] = None) -> 'PluginAttachment':
        """
