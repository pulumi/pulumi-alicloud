...
def get_backends(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Backends IDs.
    :param builtins.str name_regex: A regex string to filter Api Gateway Backends by name.
...
def get_backends_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
