...
def get_backends(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Backends IDs.
    :param _builtins.str name_regex: A regex string to filter Api Gateway Backends by name.
...
def get_backends_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
