...
def get_apis(api_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of API IDs.
    :param builtins.str name_regex: A regex string to filter results by API name.
...
def get_apis_output(api_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
