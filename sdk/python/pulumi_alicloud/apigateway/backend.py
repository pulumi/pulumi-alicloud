...
class BackendArgs:
    def __init__(__self__, *,
                 ...
                 backend_type: pulumi.Input[builtins.str],
                 create_event_bridge_service_linked_role: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @backend_type.setter
    def backend_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "backend_type", value)

    @property
    @pulumi.getter(name="createEventBridgeServiceLinkedRole")
    def create_event_bridge_service_linked_role(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def create_event_bridge_service_linked_role(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _BackendState:
    def __init__(__self__, *,
                 backend_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="backendName")
    def backend_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Backend.
        """
        return pulumi.get(self, "backend_name")
    ...
    @backend_name.setter
    def backend_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "backend_name", value)
...
class Backend(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            backend_type: Optional[pulumi.Input[builtins.str]] = None,
            create_event_bridge_service_linked_role: Optional[pulumi.Input[builtins.bool]] = None,
            description: Optional[pulumi.Input[builtins.str]] = None) -> 'Backend':
        """
    ...
    @property
    @pulumi.getter(name="backendName")
    def backend_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Backend.
        """
        return pulumi.get(self, "backend_name")
