...
class InstanceAclAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 acl_type: pulumi.Input[builtins.str],
                 instance_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a InstanceAclAttachment resource.
        :param pulumi.Input[builtins.str] acl_id: The ID of the ACL to attach.
        :param pulumi.Input[builtins.str] acl_type: The type of the ACL. Valid values: `white`, `black`.
        :param pulumi.Input[builtins.str] instance_id: The ID of the API Gateway instance that the ACL will be attached to.
        """
    ...
    def acl_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @acl_type.setter
    def acl_type(self, value: pulumi.Input[builtins.str]):
...
class InstanceAclAttachment(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:apigateway/instanceAclAttachment:InstanceAclAttachment"
    ...
    def get(resource_name: str,
            ...
            acl_id: Optional[pulumi.Input[builtins.str]] = None,
            acl_type: Optional[pulumi.Input[builtins.str]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None) -> 'InstanceAclAttachment':
        """
