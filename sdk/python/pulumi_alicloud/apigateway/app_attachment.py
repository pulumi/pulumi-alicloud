...
class AppAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_id: The api_id that app apply to access.
        :param pulumi.Input[builtins.str] app_id: The app that apply to the authorization.
        :param pulumi.Input[builtins.str] group_id: The group that the api belongs to.
        :param pulumi.Input[builtins.str] stage_name: Stage that the app apply to access.
        """
...
class AppAttachment(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:apigateway/appAttachment:AppAttachment"
    ...
    def get(resource_name: str,
            ...
            app_id: Optional[pulumi.Input[builtins.str]] = None,
            group_id: Optional[pulumi.Input[builtins.str]] = None,
            stage_name: Optional[pulumi.Input[builtins.str]] = None) -> 'AppAttachment':
        """
