...
class InstanceArgs:
    def __init__(__self__, *,
                 https_policy: pulumi.Input[builtins.str],
                 instance_name: pulumi.Input[builtins.str],
                 instance_spec: pulumi.Input[builtins.str],
                 payment_type: pulumi.Input[builtins.str],
                 delete_vpc_ip_block: Optional[pulumi.Input[builtins.str]] = None,
                 duration: Optional[pulumi.Input[builtins.int]] = None,
                 egress_ipv6_enable: Optional[pulumi.Input[builtins.bool]] = None,
                 ingress_vpc_id: Optional[pulumi.Input[builtins.str]] = None,
                 ingress_vpc_owner_id: Optional[pulumi.Input[builtins.str]] = None,
                 ingress_vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
                 instance_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 skip_wait_switch: Optional[pulumi.Input[builtins.bool]] = None,
                 to_connect_vpc_ip_block: Optional[pulumi.Input['InstanceToConnectVpcIpBlockArgs']] = None,
                 user_vpc_id: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_slb_intranet_enable: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] https_policy: Https policy.
        :param pulumi.Input[builtins.str] instance_name: Instance name.
        :param pulumi.Input[builtins.str] instance_spec: Instance spec.
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource.
        :param pulumi.Input[builtins.str] delete_vpc_ip_block: Indicates whether to delete the IP block that the VPC can access, conflict with `to_connect_vpc_ip_block`.
        :param pulumi.Input[builtins.int] duration: The time of the instance package. Valid values:
        ...
        :param pulumi.Input[builtins.bool] egress_ipv6_enable: Specifies whether IPv6 egress capability is enabled.
        :param pulumi.Input[builtins.str] ingress_vpc_id: The VpcID which the client at.
        :param pulumi.Input[builtins.str] ingress_vpc_owner_id: The user ID that the VpcID of `ingress_vpc_id` belongs to.
        :param pulumi.Input[builtins.str] ingress_vswitch_id: The VSwitch ID that belongs to the Vpc of `ingress_vpc_id`. Required when `ingress_vpc_id` is set.
        :param pulumi.Input[builtins.str] instance_cidr: The CIDR block for the instance deployment. Valid values are:
               - `192.168.0.0/16`.
               - `172.16.0.0/12`.
        :param pulumi.Input[builtins.str] instance_type: The type of the instance. Valid values are:
        :param pulumi.Input[builtins.bool] ipv6_enabled: Specifies whether IPv6 ingress capability is enabled.
        :param pulumi.Input[builtins.str] pricing_cycle: The subscription instance is of the subscription year or month type. This parameter is required when the Payment type is PrePaid. The value range is as follows:
        :param pulumi.Input[builtins.bool] skip_wait_switch: Specifies whether to skip the WAIT_SWITCH status of instance when modifying instance spec. Works only when instance spec change.
        ...
        :param pulumi.Input[builtins.str] user_vpc_id: User's VpcID.
        :param pulumi.Input[builtins.bool] vpc_slb_intranet_enable: Whether the slb of the Vpc supports.
        :param pulumi.Input[builtins.str] zone_id: The zone where the instance is deployed.
    ...
    def https_policy(self) -> pulumi.Input[builtins.str]:
        """
        Https policy.
        """
    ...
    @https_policy.setter
    def https_policy(self, value: pulumi.Input[builtins.str]):
    ...
    def instance_spec(self) -> pulumi.Input[builtins.str]:
        """
        Instance spec.
        """
    ...
    def instance_spec(self, value: pulumi.Input[builtins.str]):
    ...
    def delete_vpc_ip_block(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def delete_vpc_ip_block(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def egress_ipv6_enable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def egress_ipv6_enable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "egress_ipv6_enable", value)

    @property
    @pulumi.getter(name="ingressVpcId")
    def ingress_vpc_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ingress_vpc_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ingress_vpc_id", value)

    @property
    @pulumi.getter(name="ingressVpcOwnerId")
    def ingress_vpc_owner_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ingress_vpc_owner_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ingress_vpc_owner_id", value)

    @property
    @pulumi.getter(name="ingressVswitchId")
    def ingress_vswitch_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ingress_vswitch_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ingress_vswitch_id", value)

    @property
    @pulumi.getter(name="instanceCidr")
    def instance_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def instance_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def skip_wait_switch(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def skip_wait_switch(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def user_vpc_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        User's VpcID.
        """
    ...
    @user_vpc_id.setter
    def user_vpc_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_vpc_id", value)

    @property
    @pulumi.getter(name="vpcSlbIntranetEnable")
    def vpc_slb_intranet_enable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def vpc_slb_intranet_enable(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _InstanceState:
    def __init__(__self__, *,
                 connect_cidr_blocks: Optional[pulumi.Input[builtins.str]] = None,
                 create_time: Optional[pulumi.Input[builtins.str]] = None,
                 delete_vpc_ip_block: Optional[pulumi.Input[builtins.str]] = None,
                 duration: Optional[pulumi.Input[builtins.int]] = None,
                 egress_ipv6_enable: Optional[pulumi.Input[builtins.bool]] = None,
                 https_policy: Optional[pulumi.Input[builtins.str]] = None,
                 ingress_vpc_id: Optional[pulumi.Input[builtins.str]] = None,
                 ingress_vpc_owner_id: Optional[pulumi.Input[builtins.str]] = None,
                 ingress_vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
                 instance_cidr: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] connect_cidr_blocks: (Available since v1.228.0) The CIDR blocks that can be accessed by the Vpc integration instance.
        ...
        :param pulumi.Input[builtins.bool] support_ipv6: Does ipv6 support.
        :param pulumi.Input['InstanceToConnectVpcIpBlockArgs'] to_connect_vpc_ip_block: The additional IP block that the VPC integration instance can access, conflict with `delete_vpc_ip_block`. See `to_connect_vpc_ip_block` below.
        :param pulumi.Input[builtins.str] user_vpc_id: User's VpcID.
        :param pulumi.Input[builtins.bool] vpc_slb_intranet_enable: Whether the slb of the Vpc supports.
        :param pulumi.Input[builtins.str] zone_id: The zone where the instance is deployed.
    ...
    def connect_cidr_blocks(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connect_cidr_blocks(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="httpsPolicy")
    def https_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Https policy.
        """
        return pulumi.get(self, "https_policy")
    ...
    @https_policy.setter
    def https_policy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "https_policy", value)
...
class Instance(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:apigateway/instance:Instance"
    ...
    @property
    @pulumi.getter(name="connectCidrBlocks")
    def connect_cidr_blocks(self) -> pulumi.Output[builtins.str]:
        """
        (Available since v1.228.0) The CIDR blocks that can be accessed by the Vpc integration instance.
        """
        return pulumi.get(self, "connect_cidr_blocks")
    ...
    @property
    @pulumi.getter(name="deleteVpcIpBlock")
    def delete_vpc_ip_block(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates whether to delete the IP block that the VPC can access, conflict with `to_connect_vpc_ip_block`.
        """
        return pulumi.get(self, "delete_vpc_ip_block")
    ...
    @property
    @pulumi.getter(name="egressIpv6Enable")
    def egress_ipv6_enable(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether IPv6 egress capability is enabled.
        """
        return pulumi.get(self, "egress_ipv6_enable")
    ...
    @property
    @pulumi.getter(name="httpsPolicy")
    def https_policy(self) -> pulumi.Output[builtins.str]:
        """
        Https policy.
        """
        return pulumi.get(self, "https_policy")
    ...
    @property
    @pulumi.getter(name="ingressVpcId")
    def ingress_vpc_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The VpcID which the client at.
        """
        return pulumi.get(self, "ingress_vpc_id")
    ...
    @property
    @pulumi.getter(name="ingressVpcOwnerId")
    def ingress_vpc_owner_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The user ID that the VpcID of `ingress_vpc_id` belongs to.
        """
        return pulumi.get(self, "ingress_vpc_owner_id")
    ...
    @property
    @pulumi.getter(name="ingressVswitchId")
    def ingress_vswitch_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The VSwitch ID that belongs to the Vpc of `ingress_vpc_id`. Required when `ingress_vpc_id` is set.
        """
        return pulumi.get(self, "ingress_vswitch_id")
    ...
    @property
    @pulumi.getter(name="instanceCidr")
    def instance_cidr(self) -> pulumi.Output[builtins.str]:
        """
        The CIDR block for the instance deployment. Valid values are:
        - `192.168.0.0/16`.
        - `172.16.0.0/12`.
    ...
    @property
    @pulumi.getter(name="instanceSpec")
    def instance_spec(self) -> pulumi.Output[builtins.str]:
        """
        Instance spec.
        """
        return pulumi.get(self, "instance_spec")
    ...
    @property
    @pulumi.getter(name="skipWaitSwitch")
    def skip_wait_switch(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to skip the WAIT_SWITCH status of instance when modifying instance spec. Works only when instance spec change.
        """
        return pulumi.get(self, "skip_wait_switch")
    ...
    @property
    @pulumi.getter(name="userVpcId")
    def user_vpc_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        User's VpcID.
        """
        return pulumi.get(self, "user_vpc_id")
    ...
    @property
    @pulumi.getter(name="vpcSlbIntranetEnable")
    def vpc_slb_intranet_enable(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the slb of the Vpc supports.
        """
        return pulumi.get(self, "vpc_slb_intranet_enable")
