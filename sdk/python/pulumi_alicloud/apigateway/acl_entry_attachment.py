...
class AclEntryAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] acl_id: The ID of the ACL that the entry will be attached to.
        :param pulumi.Input[builtins.str] entry: The CIDR block of the entry to attach.
        :param pulumi.Input[builtins.str] comment: The comment for the entry.
        """
...
class AclEntryAttachment(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:apigateway/aclEntryAttachment:AclEntryAttachment"
