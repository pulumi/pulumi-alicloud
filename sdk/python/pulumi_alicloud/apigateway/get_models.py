...
def get_models(group_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Model IDs.
    :param builtins.str model_name: The name of the Model.
    :param builtins.str name_regex: A regex string to filter results by Model name.
...
def get_models_output(group_id: Optional[pulumi.Input[builtins.str]] = None,
                      ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                      model_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
