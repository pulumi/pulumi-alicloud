...
def get_models(group_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Model IDs.
    :param _builtins.str model_name: The name of the Model.
    :param _builtins.str name_regex: A regex string to filter results by Model name.
...
def get_models_output(group_id: Optional[pulumi.Input[_builtins.str]] = None,
                      ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                      model_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:apigateway/getModels:getModels', __args__, opts=opts, typ=GetModelsResult)
