...
class AccessControlListArgs:
    def __init__(__self__, *,
                 access_control_list_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] access_control_list_name: Access control list name.
        ...
        :param pulumi.Input[builtins.str] address_ip_version: The IP version. Valid values: ipv4 and ipv6.
        """
    ...
    def access_control_list_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def access_control_list_name(self, value: pulumi.Input[builtins.str]):
...
class _AccessControlListState:
    def __init__(__self__, *,
                 access_control_list_name: Optional[pulumi.Input[builtins.str]] = None,
                 acl_entrys: Optional[pulumi.Input[Sequence[pulumi.Input['AccessControlListAclEntryArgs']]]] = None,
                 address_ip_version: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="accessControlListName")
    def access_control_list_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Access control list name.
        """
        return pulumi.get(self, "access_control_list_name")
    ...
    @access_control_list_name.setter
    def access_control_list_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "access_control_list_name", value)
...
class AccessControlList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            access_control_list_name: Optional[pulumi.Input[builtins.str]] = None,
            acl_entrys: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AccessControlListAclEntryArgs', 'AccessControlListAclEntryArgsDict']]]]] = None,
            address_ip_version: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessControlList':
        """
    ...
    @property
    @pulumi.getter(name="accessControlListName")
    def access_control_list_name(self) -> pulumi.Output[builtins.str]:
        """
        Access control list name.
        """
        return pulumi.get(self, "access_control_list_name")
