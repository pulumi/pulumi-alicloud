...
class ApiFcServiceConfig(dict):
    def __init__(__self__, *,
        ...
        :param float timeout: Backend service time-out time; unit: millisecond.
...
class GetAppsAppResult(dict):
    def __init__(__self__, *,
        ...
        :param float id: App ID, which is generated by the system and globally unique.
...
class GetGroupsGroupResult(dict):
    def __init__(__self__, *,
        ...
        :param float traffic_limit: Upper QPS limit of the API group; default value: 500, which can be increased by submitting an application.
        """
