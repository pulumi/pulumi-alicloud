...
class ApiArgs:
    def __init__(__self__, *,
                 ...
                 force_nonce_check: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 stage_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 system_parameters: Optional[pulumi.Input[Sequence[pulumi.Input['ApiSystemParameterArgs']]]] = None):
        """
        The set of arguments for constructing a Api resource.
        :param pulumi.Input[builtins.str] auth_type: The authorization Type including APP and ANONYMOUS. Defaults to null.
    ...
    def force_nonce_check(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def force_nonce_check(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def stage_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @stage_names.setter
    def stage_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _ApiState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_id: The ID of the api of api gateway.
        :param pulumi.Input[builtins.str] auth_type: The authorization Type including APP and ANONYMOUS. Defaults to null.
        :param pulumi.Input[Sequence[pulumi.Input['ApiConstantParameterArgs']]] constant_parameters: constant_parameters defines the constant parameters of the api. See `constant_parameters` below.
        :param pulumi.Input[builtins.str] description: The description of the api. Defaults to null.
        :param pulumi.Input['ApiFcServiceConfigArgs'] fc_service_config: fc_service_config defines the config when service_type selected 'FunctionCompute'. See `fc_service_config` below.
...
class Api(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="forceNonceCheck")
    def force_nonce_check(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to prevent API replay attack. Default value: `false`.
        """
        return pulumi.get(self, "force_nonce_check")
    ...
    @property
    @pulumi.getter(name="stageNames")
    def stage_names(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Stages that the api need to be deployed. Valid value: `RELEASE`,`PRE`,`TEST`.
        """
        return pulumi.get(self, "stage_names")
