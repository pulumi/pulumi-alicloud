...
class ModelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_id: The group of the model belongs to.
        :param pulumi.Input[builtins.str] model_name: The name of the model.
        :param pulumi.Input[builtins.str] schema: The schema of the model.
