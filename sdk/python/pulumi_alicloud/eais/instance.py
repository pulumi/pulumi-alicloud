...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_type: The type of the Instance. Valid values: `eais.ei-a6.4xlarge`, `eais.ei-a6.2xlarge`, `eais.ei-a6.xlarge`, `eais.ei-a6.large`, `eais.ei-a6.medium`.
        ...
        :param pulumi.Input[builtins.bool] force: Specifies whether to force delete the Instance. Default value: `false`. Valid values:
