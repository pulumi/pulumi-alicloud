...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 client_connect_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 client_read_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 configuration_source: Optional[pulumi.Input[builtins.str]] = None,
                 credentials_uri: Optional[pulumi.Input[builtins.str]] = None,
                 ecs_role_name: Optional[pulumi.Input[builtins.str]] = None,
                 endpoints: Optional[pulumi.Input[Sequence[pulumi.Input['ProviderEndpointArgs']]]] = None,
                 fc: Optional[pulumi.Input[builtins.str]] = None,
                 log_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 max_retry_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 mns_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 ots_instance_name: Optional[pulumi.Input[builtins.str]] = None,
                 profile: Optional[pulumi.Input[builtins.str]] = None,
                 protocol: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 secret_key: Optional[pulumi.Input[builtins.str]] = None,
                 secure_transport: Optional[pulumi.Input[builtins.str]] = None,
                 security_token: Optional[pulumi.Input[builtins.str]] = None,
                 security_transport: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] access_key: The access key for API operations. You can retrieve this from the 'Security Management' section of the Alibaba Cloud
               console.
        :param pulumi.Input[builtins.str] account_id: The account ID for some service API operations. You can retrieve this from the 'Security Settings' section of the
               Alibaba Cloud console.
        :param pulumi.Input[builtins.int] client_connect_timeout: The maximum timeout of the client connection server.
        :param pulumi.Input[builtins.int] client_read_timeout: The maximum timeout of the client read request.
        :param pulumi.Input[builtins.str] credentials_uri: The URI of sidecar credentials service.
        :param pulumi.Input[builtins.str] ecs_role_name: The RAM Role Name attached on a ECS instance for API operations. You can retrieve this from the 'Access Control' section
               of the Alibaba Cloud console.
        :param pulumi.Input[builtins.int] max_retry_timeout: The maximum retry timeout of the request.
        :param pulumi.Input[builtins.str] profile: The profile for API operations. If not set, the default profile created with `aliyun configure` will be used.
        :param pulumi.Input[builtins.str] region: The region where Alibaba Cloud operations will take place. Examples are cn-beijing, cn-hangzhou, eu-central-1, etc.
        :param pulumi.Input[builtins.str] secret_key: The secret key for API operations. You can retrieve this from the 'Security Management' section of the Alibaba Cloud
               console.
        :param pulumi.Input[builtins.str] secure_transport: The security transport for the assume role invoking.
        :param pulumi.Input[builtins.str] security_token: security token. A security token is only required if you are using Security Token Service.
        :param pulumi.Input[builtins.str] shared_credentials_file: The path to the shared credentials file. If not set this defaults to ~/.aliyun/config.json
        :param pulumi.Input[builtins.bool] skip_region_validation: Skip static validation of region ID. Used by users of alternative AlibabaCloud-like APIs or users w/ access to regions
               that are not public (yet).
        :param pulumi.Input[builtins.str] source_ip: The source ip for the assume role invoking.
        """
    ...
    def client_connect_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def client_connect_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "client_connect_timeout", value)

    @property
    @pulumi.getter(name="clientReadTimeout")
    def client_read_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def client_read_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "client_read_timeout", value)

    @property
    @pulumi.getter(name="configurationSource")
    def configuration_source(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "configuration_source")

    @configuration_source.setter
    def configuration_source(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "configuration_source", value)

    @property
    @pulumi.getter(name="credentialsUri")
    def credentials_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def credentials_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "credentials_uri", value)

    @property
    @pulumi.getter(name="ecsRoleName")
    def ecs_role_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ecs_role_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def fc(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "fc")

    @fc.setter
    def fc(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def log_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "log_endpoint")

    @log_endpoint.setter
    def log_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_endpoint", value)

    @property
    @pulumi.getter(name="maxRetryTimeout")
    def max_retry_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_retry_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def mns_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "mns_endpoint")

    @mns_endpoint.setter
    def mns_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ots_instance_name(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "ots_instance_name")

    @ots_instance_name.setter
    def ots_instance_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def secure_transport(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def secure_transport(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def security_transport(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "security_transport")

    @security_transport.setter
    def security_transport(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Provider(pulumi.ProviderResource):
    ...
    pulumi_type = "pulumi:providers:alicloud"
    ...
    @property
    @pulumi.getter(name="accountType")
    def account_type(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "account_type")

    @property
    @pulumi.getter(name="configurationSource")
    def configuration_source(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "configuration_source")

    @property
    @pulumi.getter(name="credentialsUri")
    def credentials_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URI of sidecar credentials service.
        """
        return pulumi.get(self, "credentials_uri")
    ...
    @property
    @pulumi.getter(name="ecsRoleName")
    def ecs_role_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The RAM Role Name attached on a ECS instance for API operations. You can retrieve this from the 'Access Control' section
        of the Alibaba Cloud console.
        """
    ...
    @pulumi.getter
    @_utilities.deprecated("""Field 'fc' has been deprecated from provider version 1.28.0. New field 'fc' which in nested endpoints instead.""")
    def fc(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "fc")

    @property
    @pulumi.getter(name="logEndpoint")
    @_utilities.deprecated("""Field 'log_endpoint' has been deprecated from provider version 1.28.0. New field 'log' which in nested endpoints instead.""")
    def log_endpoint(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "log_endpoint")

    @property
    @pulumi.getter(name="mnsEndpoint")
    @_utilities.deprecated("""Field 'mns_endpoint' has been deprecated from provider version 1.28.0. New field 'mns' which in nested endpoints instead.""")
    def mns_endpoint(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "mns_endpoint")

    @property
    @pulumi.getter(name="otsInstanceName")
    @_utilities.deprecated("""Field 'ots_instance_name' has been deprecated from provider version 1.10.0. New field 'instance_name' of resource 'alicloud_ots_table' instead.""")
    def ots_instance_name(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "ots_instance_name")
    ...
    @property
    @pulumi.getter(name="secureTransport")
    def secure_transport(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The security transport for the assume role invoking.
        """
        return pulumi.get(self, "secure_transport")
    ...
    @property
    @pulumi.getter(name="securityTransport")
    def security_transport(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "security_transport")
