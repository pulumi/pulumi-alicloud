...
def get_msc_sub_contacts(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Contact IDs.
    :param builtins.str name_regex: A regex string to filter results by Contact name.
...
def get_msc_sub_contacts_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
