...
def get_saml_providers(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of SAML Provider IDs.
    :param builtins.str name_regex: A regex string to filter results by SAML Provider name.
...
def get_saml_providers_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
