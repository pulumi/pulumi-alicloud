...
def get_saml_providers(enable_details: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of SAML Provider IDs.
    :param _builtins.str name_regex: A regex string to filter results by SAML Provider name.
...
def get_saml_providers_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:ram/getSamlProviders:getSamlProviders', __args__, opts=opts, typ=GetSamlProvidersResult)
