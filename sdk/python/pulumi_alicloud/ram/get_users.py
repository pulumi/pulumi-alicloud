...
def get_users(group_name: Optional[builtins.str] = None,
    ...
    :param builtins.str group_name: Filter results by a specific group name. Returned users are in the specified group.
    :param Sequence[builtins.str] ids: A list of ram user IDs.
    :param builtins.str name_regex: A regex string to filter resulting users by their names.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str policy_name: Filter results by a specific policy name. If you set this parameter without setting `policy_type`, the later will be automatically set to `System`. Returned users are attached to the specified policy.
    :param builtins.str policy_type: Filter results by a specific policy type. Valid values are `Custom` and `System`. If you set this parameter, you must set `policy_name` as well.
    """
    __args__ = dict()
...
def get_users_output(group_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
