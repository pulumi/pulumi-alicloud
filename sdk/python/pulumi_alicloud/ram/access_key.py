...
class AccessKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] secret_file: The name of file that can save access key id and access key secret. Strongly suggest you to specified it when you creating access key, otherwise, you wouldn't get its secret ever.
        :param pulumi.Input[builtins.str] status: The status of the AccessKey. Value:
               - Active: Activated.
               - Inactive: Disabled.
        :param pulumi.Input[builtins.str] user_name: The RAM user name.
        """
...
class _AccessKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: (Available since v1.246.0) The create time of the AccessKey.
        :param pulumi.Input[builtins.str] key_fingerprint: (Available since v1.47.0) The fingerprint of the PGP key used to encrypt the secret
        :param pulumi.Input[builtins.str] pgp_key: Either a base-64 encoded PGP public key, or a keybase username in the form `keybase:some_person_that_exists`
        :param pulumi.Input[builtins.str] secret: (Available since v1.98.0) The secret access key. Note that this will be written to the state file. 
