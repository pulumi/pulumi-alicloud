...
class AccessKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] status: Status of access key. It must be `Active` or `Inactive`. Default value is `Active`.
...
class _AccessKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_fingerprint: The fingerprint of the PGP key used to encrypt the secret
        :param pulumi.Input[builtins.str] pgp_key: Either a base-64 encoded PGP public key, or a keybase username in the form `keybase:some_person_that_exists`
        :param pulumi.Input[builtins.str] secret: (Available since 1.98.0+) - The secret access key. Note that this will be written to the state file. 
