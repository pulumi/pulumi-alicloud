...
class RoleAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_name: The name of role used to bind. This name can have a string of 1 to 64 characters, must contain only alphanumeric characters or hyphens, such as "-", "_", and must not begin with a hyphen.
        """
...
class RoleAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            instance_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            role_name: Optional[pulumi.Input[builtins.str]] = None) -> 'RoleAttachment':
        """
