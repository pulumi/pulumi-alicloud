...
class SamlProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] encodedsaml_metadata_document: The metadata file which is Base64-encoded.
               The file is provided by an IdP that supports Security Assertion Markup Language (SAML) 2.0.
        :param pulumi.Input[builtins.str] saml_provider_name: The name of the IdP.  The name can be up to 128 characters in length. The name can contain letters, digits, periods (.), hyphens (-), and underscores (_). The name cannot start or end with periods (.), hyphens (-), or underscores (_).
...
class _SamlProviderState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The identity provider's ARN.
        :param pulumi.Input[builtins.str] description: The description.
        :param pulumi.Input[builtins.str] encodedsaml_metadata_document: The metadata file which is Base64-encoded.
               The file is provided by an IdP that supports Security Assertion Markup Language (SAML) 2.0.
        :param pulumi.Input[builtins.str] saml_provider_name: The name of the IdP.  The name can be up to 128 characters in length. The name can contain letters, digits, periods (.), hyphens (-), and underscores (_). The name cannot start or end with periods (.), hyphens (-), or underscores (_).
