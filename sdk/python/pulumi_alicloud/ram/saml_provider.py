...
class SamlProviderArgs:
    def __init__(__self__, *,
                 encodedsaml_metadata_document: pulumi.Input[builtins.str],
                 saml_provider_name: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SamlProvider resource.
        :param pulumi.Input[builtins.str] encodedsaml_metadata_document: The metadata file, which is Base64 encoded. The file is provided by an IdP that supports SAML 2.0.
        :param pulumi.Input[builtins.str] saml_provider_name: The name of SAML Provider.
        :param pulumi.Input[builtins.str] description: The description of SAML Provider.
        """
    ...
    def encodedsaml_metadata_document(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def encodedsaml_metadata_document(self, value: pulumi.Input[builtins.str]):
...
class _SamlProviderState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 encodedsaml_metadata_document: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Alibaba Cloud Resource Name (ARN) of the IdP.
        :param pulumi.Input[builtins.str] description: The description of SAML Provider.
        :param pulumi.Input[builtins.str] encodedsaml_metadata_document: The metadata file, which is Base64 encoded. The file is provided by an IdP that supports SAML 2.0.
        :param pulumi.Input[builtins.str] saml_provider_name: The name of SAML Provider.
        :param pulumi.Input[builtins.str] update_date: The update time.
        """
        if arn is not None:
    ...
    @property
    @pulumi.getter(name="encodedsamlMetadataDocument")
    def encodedsaml_metadata_document(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The metadata file, which is Base64 encoded. The file is provided by an IdP that supports SAML 2.0.
        """
        return pulumi.get(self, "encodedsaml_metadata_document")
    ...
    @encodedsaml_metadata_document.setter
    def encodedsaml_metadata_document(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "encodedsaml_metadata_document", value)
...
class SamlProvider(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="encodedsamlMetadataDocument")
    def encodedsaml_metadata_document(self) -> pulumi.Output[builtins.str]:
        """
        The metadata file, which is Base64 encoded. The file is provided by an IdP that supports SAML 2.0.
        """
        return pulumi.get(self, "encodedsaml_metadata_document")
