...
class PolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the policy. It can be 1 to 1024 characters in length.
        :param pulumi.Input[builtins.str] document: Field `document` has been deprecated from provider version 1.114.0. New field `policy_document` instead.
        :param pulumi.Input[builtins.bool] force: Specifies whether to force delete the Policy. Default value: `false`. Valid values:
...
class _PolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] attachment_count: Number of attachments of the policy.
        :param pulumi.Input[builtins.str] create_time: (Available since v1.246.0) The create time of the policy.
        :param pulumi.Input[builtins.str] default_version: The default version ID of the policy.
        :param pulumi.Input[builtins.str] description: The description of the policy. It can be 1 to 1024 characters in length.
        :param pulumi.Input[builtins.str] document: Field `document` has been deprecated from provider version 1.114.0. New field `policy_document` instead.
        :param pulumi.Input[builtins.bool] force: Specifies whether to force delete the Policy. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.114.0. New field `policy_name` instead.
        ...
        :param pulumi.Input[builtins.str] version: Field `version` has been deprecated from provider version 1.49.0. New field `document` instead.
        :param pulumi.Input[builtins.str] version_id: The ID of the default policy version.
        """
...
class Policy(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:ram/policy:Policy"
