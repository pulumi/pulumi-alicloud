...
class PolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] document: (Deprecated since 1.114.0, Optional, Conflicts with `policy_document`, `statement` and `version`) It has been deprecated since provider version 1.114.0 and `policy_document` instead.
        :param pulumi.Input[bool] force: This parameter is used for resource destroy. Default value is `false`.
        :param pulumi.Input[str] name: (Deprecated since 1.114.0, Required, ForceNew) It has been deprecated since provider version 1.114.0 and `policy_name` instead.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PolicyStatementArgs']]] statements: (Deprecated since 1.49.0, Optional, Type: list, Conflicts with `policy_document`, `document`) (It has been deprecated since version 1.49.0, and use field 'document' to replace.) Statements of the RAM policy document. It is required when the `document` is not specified. See `statement` below.
        :param pulumi.Input[str] version: (Deprecated since 1.49.0, Optional, Conflicts with `policy_document`, `document`) (It has been deprecated since version 1.49.0, and use field 'document' to replace.) Version of the RAM policy document. Valid value is `1`. Default value is `1`.
        """
...
class Policy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] policy_name: Name of the RAM policy. This name can have a string of 1 to 128 characters, must contain only alphanumeric characters or hyphen "-", and must not begin with a hyphen.
        :param pulumi.Input[str] rotate_strategy: The rotation strategy of the policy. You can use this parameter to delete an early policy version. Valid Values: `None`, `DeleteOldestNonDefaultVersionWhenLimitExceeded`. Default to `None`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['PolicyStatementArgs']]]] statements: (Deprecated since 1.49.0, Optional, Type: list, Conflicts with `policy_document`, `document`) (It has been deprecated since version 1.49.0, and use field 'document' to replace.) Statements of the RAM policy document. It is required when the `document` is not specified. See `statement` below.
        :param pulumi.Input[str] version: (Deprecated since 1.49.0, Optional, Conflicts with `policy_document`, `document`) (It has been deprecated since version 1.49.0, and use field 'document' to replace.) Version of the RAM policy document. Valid value is `1`. Default value is `1`.
        """
        ...
    @overload
