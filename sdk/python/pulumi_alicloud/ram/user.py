...
class UserArgs:
    def __init__(__self__, *,
                 ...
                 mobile: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a User resource.
        :param pulumi.Input[builtins.str] comments: Comment of the RAM user. This parameter can have a string of 1 to 128 characters.
        :param pulumi.Input[builtins.str] display_name: Name of the RAM user which for display. This name can have a string of 1 to 128 characters or Chinese characters, must contain only alphanumeric characters or Chinese characters or hyphens, such as "-",".", and must not end with a hyphen.
        :param pulumi.Input[builtins.str] email: Email of the RAM user.
        :param pulumi.Input[builtins.bool] force: This parameter is used for resource destroy. Default value: `false`.
        :param pulumi.Input[builtins.str] mobile: Phone number of the RAM user. This number must contain an international area code prefix, just look like this: 86-18600008888.
        :param pulumi.Input[builtins.str] name: Name of the RAM user. This name can have a string of 1 to 64 characters, must contain only alphanumeric characters or hyphens, such as "-",".","_", and must not begin with a hyphen.
        """
    ...
    @property
    @pulumi.getter
    def mobile(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @mobile.setter
    def mobile(self, value: Optional[pulumi.Input[builtins.str]]):
...
class User(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def mobile(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Phone number of the RAM user. This number must contain an international area code prefix, just look like this: 86-18600008888.
        """
        return pulumi.get(self, "mobile")
