...
def get_groups(name_regex: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name_regex: A regex string to filter the returned groups by their names.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str policy_name: Filter the results by a specific policy name. If you set this parameter without setting `policy_type`, it will be automatically set to `System`.
    :param _builtins.str policy_type: Filter the results by a specific policy type. Valid items are `Custom` and `System`. If you set this parameter, you must set `policy_name` as well.
    :param _builtins.str user_name: Filter the results by a specific the user name.
    """
    __args__ = dict()
