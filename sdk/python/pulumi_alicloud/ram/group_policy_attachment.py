...
class GroupPolicyAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_name: Name of the RAM group. This name can have a string of 1 to 64 characters, must contain only alphanumeric characters or hyphen "-", and must not begin with a hyphen.
...
class GroupPolicyAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            group_name: Optional[pulumi.Input[builtins.str]] = None,
            policy_name: Optional[pulumi.Input[builtins.str]] = None,
            policy_type: Optional[pulumi.Input[builtins.str]] = None) -> 'GroupPolicyAttachment':
        """
