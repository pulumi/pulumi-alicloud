...
def get_system_policys(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of System Policy IDs.
...
def get_system_policys_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
