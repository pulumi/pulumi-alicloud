...
def get_roles(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of ram role IDs.
    :param builtins.str name_regex: A regex string to filter results by the role name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str policy_name: Filter results by a specific policy name. If you set this parameter without setting `policy_type`, the later will be automatically set to `System`. The resulting roles will be attached to the specified policy.
...
def get_roles_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
