...
def get_policy_document(output_file: Optional[builtins.str] = None,
    ...
    :param builtins.str version: Version of the RAM policy document. Valid value is `1`. Default value is `1`.
    """
    __args__ = dict()
...
def get_policy_document_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
