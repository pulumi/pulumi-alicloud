...
class UserPolicyAttachment(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, policy_name=None, policy_type=None, user_name=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, policy_name=None, policy_type=None, user_name=None):
        """
