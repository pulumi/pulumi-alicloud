...
class AccountAliasArgs:
    def __init__(__self__, *,
                 account_alias: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a AccountAlias resource.
        :param pulumi.Input[builtins.str] account_alias: Alias of cloud account. This name can have a string of 3 to 32 characters, must contain only alphanumeric characters or hyphens, such as "-", and must not begin with a hyphen.
        """
        pulumi.set(__self__, "account_alias", account_alias)

    @property
    @pulumi.getter(name="accountAlias")
    def account_alias(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def account_alias(self, value: pulumi.Input[builtins.str]):
...
class _AccountAliasState:
    def __init__(__self__, *,
                 account_alias: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="accountAlias")
    def account_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Alias of cloud account. This name can have a string of 3 to 32 characters, must contain only alphanumeric characters or hyphens, such as "-", and must not begin with a hyphen.
        """
        return pulumi.get(self, "account_alias")
    ...
    @account_alias.setter
    def account_alias(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "account_alias", value)
...
class AccountAlias(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            account_alias: Optional[pulumi.Input[builtins.str]] = None) -> 'AccountAlias':
        """
    ...
    @property
    @pulumi.getter(name="accountAlias")
    def account_alias(self) -> pulumi.Output[builtins.str]:
        """
        Alias of cloud account. This name can have a string of 3 to 32 characters, must contain only alphanumeric characters or hyphens, such as "-", and must not begin with a hyphen.
        """
        return pulumi.get(self, "account_alias")
