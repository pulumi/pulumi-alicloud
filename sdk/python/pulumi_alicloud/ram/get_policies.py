...
def get_policies(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.bool enable_details: Default to `true`. Set it to true can output more details.
    :param builtins.str group_name: Filter results by a specific group name. Returned policies are attached to the specified group.
    :param Sequence[builtins.str] ids: A list of ram group IDs.
    :param builtins.str name_regex: A regex string to filter resulting policies by name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str role_name: Filter results by a specific role name. Returned policies are attached to the specified role.
    :param builtins.str type: Filter results by a specific policy type. Valid values are `Custom` and `System`.
    :param builtins.str user_name: Filter results by a specific user name. Returned policies are attached to the specified user.
    """
    __args__ = dict()
...
def get_policies_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                        ...
                        role_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
