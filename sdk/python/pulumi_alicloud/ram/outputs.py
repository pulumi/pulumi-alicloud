...
class PolicyStatement(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] actions: (It has been deprecated since version 1.49.0, and use field `document` to replace.) List of operations for the `resource`. The format of each item in this list is `${service}:${action_name}`, such as `oss:ListBuckets` and `ecs:Describe*`. The `${service}` can be `ecs`, `oss`, `ots` and so on, the `${action_name}` refers to the name of an api interface which related to the `${service}`.
        :param builtins.str effect: (It has been deprecated since version 1.49.0, and use field `document` to replace.) This parameter indicates whether or not the `action` is allowed. Valid values are `Allow` and `Deny`.
        :param Sequence[builtins.str] resources: (It has been deprecated since version 1.49.0, and use field `document` to replace.) List of specific objects which will be authorized. The format of each item in this list is `acs:${service}:${region}:${account_id}:${relative_id}`, such as `acs:ecs:*:*:instance/inst-002` and `acs:oss:*:1234567890000:mybucket`. The `${service}` can be `ecs`, `oss`, `ots` and so on, the `${region}` is the region info which can use `*` replace when it is not supplied, the `${account_id}` refers to someone`s Alicloud account id or you can use `*` to replace, the `${relative_id}` is the resource description section which related to the `${service}`.
        """
...
class GetGroupsGroupResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str comments: Comments of the group.
...
class GetPoliciesPolicyResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int attachment_count: Attachment count of the policy.
        :param builtins.str create_date: Creation date of the policy.
        :param builtins.str default_version: Default version of the policy.
        :param builtins.str description: Description of the policy.
        :param builtins.str document: Policy document of the policy.
        :param builtins.str id: ID of the policy.
        :param builtins.str name: Name of the policy.
        :param builtins.str policy_document: Policy document of the policy.
        :param builtins.str policy_name: Name of the policy.
        :param builtins.str type: Filter results by a specific policy type. Valid values are `Custom` and `System`.
        :param builtins.str update_date: Update date of the policy.
        :param builtins.str user_name: Filter results by a specific user name. Returned policies are attached to the specified user.
        :param builtins.str version_id: The ID of default policy.
        """
...
class GetRolesRoleResult(dict):
    def __init__(__self__, *,
                 ...
                 update_date: builtins.str):
        """
        :param builtins.str arn: Resource descriptor of the role.
        :param builtins.str assume_role_policy_document: Authorization strategy of the role. This parameter is deprecated and replaced by `document`.
        :param builtins.str create_date: Creation date of the role.
        :param builtins.str description: Description of the role.
        :param builtins.str document: Authorization strategy of the role.
        :param builtins.str id: ID of the role.
        :param builtins.str name: Name of the role.
        :param builtins.str update_date: Update date of the role.
        """
...
class GetSamlProvidersProviderResult(dict):
    def __init__(__self__, *,
                 arn: builtins.str,
                 description: builtins.str,
                 encodedsaml_metadata_document: builtins.str,
                 id: builtins.str,
                 saml_provider_name: builtins.str,
                 update_date: builtins.str):
        """
        :param builtins.str arn: The Alibaba Cloud Resource Name (ARN) of the IdP.
        :param builtins.str description: The description of SAML Provider.
        :param builtins.str encodedsaml_metadata_document: The encodedsaml metadata document.
        :param builtins.str id: The ID of the SAML Provider.
        :param builtins.str saml_provider_name: The saml provider name.
        :param builtins.str update_date: The update time.
        """
        pulumi.set(__self__, "arn", arn)
        pulumi.set(__self__, "description", description)
    ...
    def encodedsaml_metadata_document(self) -> builtins.str:
        """
...
class GetSystemPolicysPolicyResult(dict):
    def __init__(__self__, *,
                 ...
                 update_date: builtins.str):
        """
        :param builtins.int attachment_count: Number of references.
        :param builtins.str create_time: Creation time.
        :param builtins.str description: The permission policy description.
        :param builtins.str id: The ID of the resource supplied above.
        :param builtins.str policy_name: The permission policy name.
        :param builtins.str policy_type: Permission policy type.
        :param builtins.str update_date: Modification time.
        """
        pulumi.set(__self__, "attachment_count", attachment_count)
...
class GetUsersUserResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str create_date: Creation date of the user.
        :param builtins.str id: The original id is user's name, but it is user id in 1.37.0+.
        :param builtins.str last_login_date: (Removed) Last login date of the user. Removed from version 1.79.0.
