...
class GroupMembershipArgs:
    def __init__(__self__, *,
                 ...
                 user_names: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_names: Set of user name which will be added to group. Each name can have a string of 1 to 64 characters, must contain only alphanumeric characters or hyphens, such as "-",".","_", and must not begin with a hyphen.
        """
    ...
    def user_names(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @user_names.setter
    def user_names(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class GroupMembership(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            group_name: Optional[pulumi.Input[builtins.str]] = None,
            user_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'GroupMembership':
        """
    ...
    @property
    @pulumi.getter(name="userNames")
    def user_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Set of user name which will be added to group. Each name can have a string of 1 to 64 characters, must contain only alphanumeric characters or hyphens, such as "-",".","_", and must not begin with a hyphen.
        """
        return pulumi.get(self, "user_names")
