...
def get_account_aliases(output_file: Optional[builtins.str] = None,
...
def get_account_aliases_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
