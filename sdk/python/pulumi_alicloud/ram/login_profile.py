...
class LoginProfileArgs:
    def __init__(__self__, *,
                 ...
                 mfa_bind_required: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] password: The logon password of the RAM user. The password must meet the password strength requirements.
        :param pulumi.Input[builtins.str] user_name: The name of the RAM user. This name can have a string of 1 to 64 characters, must contain only alphanumeric characters or hyphens, such as "-",".","_", and must not begin with a hyphen.
        :param pulumi.Input[builtins.bool] mfa_bind_required: Specifies whether an MFA device must be attached to the RAM user upon logon. Valid values: `true`, `false`. [To enhance the security of your resources and data, the default value has been changed to `true`](https://www.alibabacloud.com/en/notice/mfa20240524?_p_lc=1) .
        :param pulumi.Input[builtins.bool] password_reset_required: Specifies whether the RAM user must change the password upon logon. Default value: `false`. Valid values: `true`, `false`.
        """
    ...
    def mfa_bind_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def mfa_bind_required(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class LoginProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[builtins.str]] = None,
            password_reset_required: Optional[pulumi.Input[builtins.bool]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None) -> 'LoginProfile':
        """
    ...
    @property
    @pulumi.getter(name="mfaBindRequired")
    def mfa_bind_required(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether an MFA device must be attached to the RAM user upon logon. Valid values: `true`, `false`. [To enhance the security of your resources and data, the default value has been changed to `true`](https://www.alibabacloud.com/en/notice/mfa20240524?_p_lc=1) .
        """
        return pulumi.get(self, "mfa_bind_required")
    ...
    @property
    @pulumi.getter(name="passwordResetRequired")
    def password_reset_required(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the RAM user must change the password upon logon. Default value: `false`. Valid values: `true`, `false`.
        """
        return pulumi.get(self, "password_reset_required")
