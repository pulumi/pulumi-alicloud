...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] comments: The Group comment information. The maximum length is 128 characters.
        :param pulumi.Input[builtins.bool] force: Specifies whether to force delete the Group. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.str] group_name: The group name. You must specify at least one of the `group_name` and `name`.
               It can be 1 to 64 characters in length and can contain letters, digits, periods (.), underscores (_), and dashes (-).
               
               The following arguments will be discarded. Please use new fields as soon as possible:
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.120.0. New field 'group_name' instead.
        """
...
class _GroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] comments: The Group comment information. The maximum length is 128 characters.
        :param pulumi.Input[builtins.str] create_time: (Available since v1.245.0) The create time of the group.
        :param pulumi.Input[builtins.bool] force: Specifies whether to force delete the Group. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.str] group_name: The group name. You must specify at least one of the `group_name` and `name`.
               It can be 1 to 64 characters in length and can contain letters, digits, periods (.), underscores (_), and dashes (-).
...
class Group(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            force: Optional[pulumi.Input[builtins.bool]] = None,
            group_name: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'Group':
        """
