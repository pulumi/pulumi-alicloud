...
class GetProjectsResult:
    ...
    """
    def __init__(__self__, id=None, ids=None, name_regex=None, names=None, output_file=None, projects=None):
...
def get_projects(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Project IDs.
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:maxcompute/getProjects:getProjects', __args__, opts=opts, typ=GetProjectsResult).value
...
def get_projects_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
