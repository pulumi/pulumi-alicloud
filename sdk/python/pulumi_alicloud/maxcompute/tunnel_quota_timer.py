...
class TunnelQuotaTimerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] nickname: The nickname of the exclusive Resource Group (Tunnel Quota) for the level - 1 data transmission service.
        ...
        :param pulumi.Input[builtins.str] time_zone: Time zone, reference: Asia/Shanghai
...
class TunnelQuotaTimer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            nickname: Optional[pulumi.Input[builtins.str]] = None,
            quota_timers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TunnelQuotaTimerQuotaTimerArgs', 'TunnelQuotaTimerQuotaTimerArgsDict']]]]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None) -> 'TunnelQuotaTimer':
        """
