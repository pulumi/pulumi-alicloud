...
class ProjectArgs:
    def __init__(__self__, *,
                 ...
                 default_quota: Optional[pulumi.Input[builtins.str]] = None,
                 ip_white_list: Optional[pulumi.Input['ProjectIpWhiteListArgs']] = None,
                 is_logical: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] default_quota: Used to implement computing resource allocation. Valid values: subQuota Nickname
        ...
        :param pulumi.Input[builtins.str] is_logical: Whether to logically delete. Default value: true. Value: (ture/false),
        ...
        :param pulumi.Input[builtins.str] project_name: The name begins with a letter, containing letters, digits, and underscores (_). It can be 3 to 28 characters in length and is globally unique.
    ...
    def default_quota(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_quota(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_logical(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @is_logical.setter
    def is_logical(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ProjectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] comment: Project description information. The length is 1 to 256 English or Chinese characters. The default value is blank.
        :param pulumi.Input[builtins.str] create_time: Represents the creation time of the project
        :param pulumi.Input[builtins.str] default_quota: Used to implement computing resource allocation. Valid values: subQuota Nickname
               If the calculation Quota is not specified, the default Quota resource will be consumed by jobs initiated by the project. For more information about computing resource usage, see [Computing Resource Usage](https://www.alibabacloud.com/help/en/maxcompute/user-guide/use-of-computing-resources).
        :param pulumi.Input['ProjectIpWhiteListArgs'] ip_white_list: IP whitelist See `ip_white_list` below.
        :param pulumi.Input[builtins.str] is_logical: Whether to logically delete. Default value: true. Value: (ture/false),
               ...
               > **NOTE:** -- ture: In this case, the project status will be changed to' deleting' and completely deleted after 14 days. -- false: delete immediately, that is, completely deleted and permanently irrecoverable.
        :param pulumi.Input[builtins.str] owner: Project owner
        :param pulumi.Input[builtins.str] project_name: The name begins with a letter, containing letters, digits, and underscores (_). It can be 3 to 28 characters in length and is globally unique.
        :param pulumi.Input['ProjectPropertiesArgs'] properties: Project base attributes See `properties` below.
...
class Project(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:maxcompute/project:Project"
    ...
    @property
    @pulumi.getter(name="defaultQuota")
    def default_quota(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Used to implement computing resource allocation. Valid values: subQuota Nickname
        If the calculation Quota is not specified, the default Quota resource will be consumed by jobs initiated by the project. For more information about computing resource usage, see [Computing Resource Usage](https://www.alibabacloud.com/help/en/maxcompute/user-guide/use-of-computing-resources).
        """
    ...
    @property
    @pulumi.getter(name="isLogical")
    def is_logical(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether to logically delete. Default value: true. Value: (ture/false),
