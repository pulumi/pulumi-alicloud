...
class RoleUserAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_name: Role Name, Valid Values: super_administrator, admin, Custom Role
        ...
        :param pulumi.Input[builtins.str] user: Supported input: Alibaba Cloud account, RAM user, and RAM role
...
class RoleUserAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_name: Optional[pulumi.Input[builtins.str]] = None,
            role_name: Optional[pulumi.Input[builtins.str]] = None,
            user: Optional[pulumi.Input[builtins.str]] = None) -> 'RoleUserAttachment':
        """
