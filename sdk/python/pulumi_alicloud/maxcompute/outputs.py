...
class ProjectProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str sql_metering_max: Set the maximum threshold for single SQL Consumption, that is, set the ODPS. SQL. metering.value.max attribute. For more information, see [Consumption control](https://www.alibabacloud.com/help/en/maxcompute/product-overview/consumption-controll).
