...
class ProjectIpWhiteList(dict):
    ...
    def __init__(__self__, *,
                 ip_list: Optional[builtins.str] = None,
                 vpc_ip_list: Optional[builtins.str] = None):
        """
        :param builtins.str ip_list: Set the IP address whitelist in the classic network. Only devices in the whitelist are allowed to access the project.
        ...
        :param builtins.str vpc_ip_list: Set the IP address whitelist in the VPC network to allow only devices in the whitelist to access the project space.
    ...
    def ip_list(self) -> Optional[builtins.str]:
        """
    ...
    def vpc_ip_list(self) -> Optional[builtins.str]:
        """
...
class ProjectProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int retention_days: Set the number of days to retain backup data. During this time, you can restore the current version to any backup version. The value range of days is [0,30], and the default value is 1. 0 means backup is turned off.
        ...
        :param builtins.str sql_metering_max: Set the maximum threshold for single SQL Consumption, that is, set the ODPS. SQL. metering.value.max attribute. For more information, see [Consumption control](https://www.alibabacloud.com/help/en/maxcompute/product-overview/consumption-control).
        ...
        :param builtins.str timezone: Project time zone, example value: Asia/Shanghai
        :param builtins.str type_system: Data type version. Value:(1/2/hive)
    ...
    def sql_metering_max(self) -> Optional[builtins.str]:
        """
    ...
    def type_system(self) -> Optional[builtins.str]:
        """
...
class ProjectPropertiesEncryption(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str algorithm: The encryption algorithm supported by the key, including AES256, AESCTR, and RC4.
        :param builtins.bool enable: Only enable function is supported. Value: (true)
               
               > **NOTE:** cannot be turned off after the function is turned on
        :param builtins.str key: The encryption algorithm Key, the Key type used by the project, including the Default Key (MaxCompute Default Key) and the self-contained Key (BYOK). The MaxCompute Default Key is the Default Key created inside MaxCompute.
        """
...
class ProjectPropertiesTableLifecycle(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Project type
        :param builtins.str value: The value of the life cycle, in days. The value range is 1~37231, and the default value is 37231.
        """
        if type is not None:
...
class ProjectSecurityProperties(dict):
    ...
    def __init__(__self__, *,
                 enable_download_privilege: Optional[builtins.bool] = None,
                 label_security: Optional[builtins.bool] = None,
                 object_creator_has_access_permission: Optional[builtins.bool] = None,
                 object_creator_has_grant_permission: Optional[builtins.bool] = None,
                 project_protection: Optional['outputs.ProjectSecurityPropertiesProjectProtection'] = None,
                 using_acl: Optional[builtins.bool] = None,
                 using_policy: Optional[builtins.bool] = None):
        """
        :param builtins.bool enable_download_privilege: Set whether to enable the [Download permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/download-control), that is, set the ODPS. security.enabledownloadprivilege property.
        :param builtins.bool label_security: Set whether to use the [Label permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/label-based-access-control), that is, set the LabelSecurity attribute, which is not used by default.
        :param builtins.bool object_creator_has_access_permission: Sets whether to allow the creator of the object to have access to the object, I .e. sets the attribute. The default is the allowed state.
        :param builtins.bool object_creator_has_grant_permission: The ObjectCreatorHasGrantPermission attribute is set to allow the object creator to have the authorization permission on the object. The default is the allowed state.
        :param 'ProjectSecurityPropertiesProjectProtectionArgs' project_protection: Project protection See `project_protection` below.
        :param builtins.bool using_acl: Set whether to use the [ACL permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/maxcompute-permissions), that is, set the CheckPermissionUsingACL attribute, which is in use by default.
        :param builtins.bool using_policy: Set whether to use the Policy permission control function (https://www.alibabacloud.com/help/en/maxcompute/user-guide/policy-based-access-control-1), that is, set the CheckPermissionUsingACL attribute, which is in use by default.
        """
    ...
    def enable_download_privilege(self) -> Optional[builtins.bool]:
        """
    ...
    def label_security(self) -> Optional[builtins.bool]:
        """
    ...
    def object_creator_has_access_permission(self) -> Optional[builtins.bool]:
        """
    ...
    def object_creator_has_grant_permission(self) -> Optional[builtins.bool]:
        """
    ...
    def using_acl(self) -> Optional[builtins.bool]:
        """
    ...
    def using_policy(self) -> Optional[builtins.bool]:
        """
...
class ProjectSecurityPropertiesProjectProtection(dict):
    ...
    def __init__(__self__, *,
                 exception_policy: Optional[builtins.str] = None,
                 protected: Optional[builtins.bool] = None):
        """
        :param builtins.str exception_policy: Set [Exceptions or Trusted Items](https://www.alibabacloud.com/help/en/maxcompute/security-and-compliance/project-data-protection)
        :param builtins.bool protected: Whether enabled, value:(true/false)
        """
    ...
    def exception_policy(self) -> Optional[builtins.str]:
        """
...
class QuotaPlanQuotaParameter(dict):
    ...
    def __init__(__self__, *,
                 elastic_reserved_cu: builtins.int,
                 max_cu: Optional[builtins.int] = None,
                 min_cu: Optional[builtins.int] = None):
        """
        :param builtins.int elastic_reserved_cu: The value of elastic Reserved CUs.
        ...
        :param builtins.int max_cu: The value of maxCU in Reserved CUs.
        :param builtins.int min_cu: The value of minCU in Reserved CUs.
        """
    ...
    def elastic_reserved_cu(self) -> builtins.int:
        """
    ...
    def max_cu(self) -> Optional[builtins.int]:
        """
    ...
    def min_cu(self) -> Optional[builtins.int]:
        """
...
class QuotaPlanQuotaSubQuotaInfoList(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str nick_name: The nickname of the level-2 quota.
...
class QuotaScheduleScheduleList(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str plan: The name of the quota plan.
        :param builtins.str type: The type of the quota plan. Valid values: daily 
...
class QuotaScheduleScheduleListCondition(dict):
    def __init__(__self__, *,
                 at: builtins.str):
        """
        :param builtins.str at: Effective time. The format is HH:mm, sample value: 00:00
...
class QuotaSubQuotaInfoList(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str nick_name: Secondary Quota nickname.
        ...
        :param builtins.str type: The secondary Quota type. The default value is: FUXI_OFFLINE
        """
        pulumi.set(__self__, "nick_name", nick_name)
        if parameter is not None:
            pulumi.set(__self__, "parameter", parameter)
...
class QuotaSubQuotaInfoListParameter(dict):
    ...
    def __init__(__self__, *,
                 max_cu: builtins.int,
                 min_cu: builtins.int,
                 enable_priority: Optional[builtins.bool] = None,
                 force_reserved_min: Optional[builtins.bool] = None,
                 scheduler_type: Optional[builtins.str] = None,
                 single_job_cu_limit: Optional[builtins.int] = None):
        """
        :param builtins.int max_cu: The value of maxCU in Reserved CUs.
        ...
        :param builtins.bool enable_priority: Enable priority. Valid values: true/false, default: false
        :param builtins.bool force_reserved_min: Exclusive or not. Valid values: true/false, default: false
        :param builtins.str scheduler_type: Scheduling policy. Valid values: Fifo/Fair, default: Fifo
        :param builtins.int single_job_cu_limit: Single job CU upper limit. Valid value: greater than or equal to 1
    ...
    def enable_priority(self) -> Optional[builtins.bool]:
        """
    ...
    def force_reserved_min(self) -> Optional[builtins.bool]:
        """
    ...
    def scheduler_type(self) -> Optional[builtins.str]:
        """
    ...
    def single_job_cu_limit(self) -> Optional[builtins.int]:
        """
...
class TunnelQuotaTimerQuotaTimer(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str begin_time: The time-sharing configuration start time. Reference value: 00:00
        :param builtins.str end_time: The end time of the timesharing configuration. Reference value: 24:00
...
class TunnelQuotaTimerQuotaTimerTunnelQuotaParameter(dict):
    ...
    def __init__(__self__, *,
                 elastic_reserved_slot_num: builtins.int,
                 slot_num: builtins.int):
        """
        :param builtins.int elastic_reserved_slot_num: The number of elastic reserved concurrency (Slot).
        :param builtins.int slot_num: The number of reserved concurrency (Slot).
    ...
    def elastic_reserved_slot_num(self) -> builtins.int:
        """
    ...
    def slot_num(self) -> builtins.int:
        """
...
class GetProjectsProjectResult(dict):
    def __init__(__self__, *,
                 ...
                 cost_storage: builtins.str,
                 create_time: builtins.str,
                 default_quota: builtins.str,
                 ...
                 type: builtins.str):
        """
        :param builtins.str comment: Project description information. The length is 1 to 256 English or Chinese characters. The default value is blank.
        :param builtins.str cost_storage: View the current storage size of the Project. The storage size is the same as the measurement size, that is, the compressed logical storage size collected by the Project.
        :param builtins.str create_time: Represents the creation time of the project
        :param builtins.str default_quota: Used to implement computing resource allocation.If the calculation Quota is not specified, the default Quota resource will be consumed by jobs initiated by the project. For more information about computing resource usage, see [Computing Resource Usage](https://www.alibabacloud.com/help/en/maxcompute/user-guide/use-of-computing-resources).
        :param 'GetProjectsProjectIpWhiteListArgs' ip_white_list: IP whitelist
        :param builtins.str owner: Project owner
        :param builtins.str project_name: The name begins with a letter, containing letters, digits, and underscores (_). It can be 3 to 28 characters in length and is globally unique.
        ...
        :param builtins.str status: The project status. Default value: AVAILABLE. Value: (AVAILABLE/READONLY/FROZEN/DELETING)
        :param builtins.str type: Project type
        """
    ...
    def cost_storage(self) -> builtins.str:
        """
...
class GetProjectsProjectIpWhiteListResult(dict):
    def __init__(__self__, *,
                 ip_list: builtins.str,
                 vpc_ip_list: builtins.str):
        """
        :param builtins.str ip_list: Set the IP address whitelist in the classic network. Only devices in the whitelist are allowed to access the project.> **NOTE:** If you only configure a classic network IP address whitelist, access to the classic network is restricted and all access to the VPC is prohibited.
        :param builtins.str vpc_ip_list: Set the IP address whitelist in the VPC network to allow only devices in the whitelist to access the project space.> **NOTE:** If you only configure a VPC network IP address whitelist, access to the VPC network is restricted and access to the classic network is prohibited.
        """
        pulumi.set(__self__, "ip_list", ip_list)
        pulumi.set(__self__, "vpc_ip_list", vpc_ip_list)
    ...
    @property
    @pulumi.getter(name="vpcIpList")
    def vpc_ip_list(self) -> builtins.str:
        """
...
class GetProjectsProjectPropertiesResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.int retention_days: Set the number of days to retain backup data. During this time, you can restore the current version to any backup version. The value range of days is [0,30], and the default value is 1. 0 means backup is turned off.The effective policy after adjusting the backup cycle is:Extend the backup cycle: The new backup cycle takes effect on the same day.Shorten the backup cycle: The system will automatically delete backup data that has exceeded the retention cycle.
        :param builtins.str sql_metering_max: Set the maximum threshold of single SQL consumption, that is, set the ODPS. SQL. metering.value.max attribute. For details, see [Consumption Monitoring Alarm](https://www.alibabacloud.com/help/en/maxcompute/product-overview/consumption-control).Unit: scan volume (GB)* complexity.
        ...
        :param builtins.str timezone: Project time zone, example value: Asia/Shanghai.
        :param builtins.str type_system: Data type version. Value:(1/2/hive)1: The original MaxCompute type system.2: New type system introduced by MaxCompute 2.0.hive: the type system of the Hive compatibility mode introduced by MaxCompute 2.0.
        """
        pulumi.set(__self__, "allow_full_scan", allow_full_scan)
        pulumi.set(__self__, "enable_decimal2", enable_decimal2)
        pulumi.set(__self__, "encryption", encryption)
    ...
    @property
    @pulumi.getter(name="allowFullScan")
    def allow_full_scan(self) -> builtins.bool:
        """
        Whether to allow full table scan. Default: false.
        """
        return pulumi.get(self, "allow_full_scan")
    ...
    @property
    @pulumi.getter(name="enableDecimal2")
    def enable_decimal2(self) -> builtins.bool:
        """
        Whether to turn on Decimal2.0.
        """
        return pulumi.get(self, "enable_decimal2")
    ...
    @property
    @pulumi.getter(name="sqlMeteringMax")
    def sql_metering_max(self) -> builtins.str:
        """
...
class GetProjectsProjectSecurityPropertiesResult(dict):
    def __init__(__self__, *,
                 enable_download_privilege: builtins.bool,
                 label_security: builtins.bool,
                 object_creator_has_access_permission: builtins.bool,
                 object_creator_has_grant_permission: builtins.bool,
                 project_protection: 'outputs.GetProjectsProjectSecurityPropertiesProjectProtectionResult',
                 using_acl: builtins.bool,
                 using_policy: builtins.bool):
        """
        :param builtins.bool enable_download_privilege: Set whether to enable the [Download permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/download-control), that is, set the ODPS. security.enabledownloadprivilege property.
        :param builtins.bool label_security: Set whether to use the [Label permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/label-based-access-control), that is, set the LabelSecurity attribute, which is not used by default.
        :param builtins.bool object_creator_has_access_permission: Sets whether to allow the creator of the object to have access to the object, I .e. sets the attribute. The default is the allowed state.
    ...
    @property
    @pulumi.getter(name="enableDownloadPrivilege")
    def enable_download_privilege(self) -> builtins.bool:
        """
        Set whether to enable the [Download permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/download-control), that is, set the ODPS. security.enabledownloadprivilege property.
        """
        return pulumi.get(self, "enable_download_privilege")
    ...
    @property
    @pulumi.getter(name="labelSecurity")
    def label_security(self) -> builtins.bool:
        """
        Set whether to use the [Label permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/label-based-access-control), that is, set the LabelSecurity attribute, which is not used by default.
        """
        return pulumi.get(self, "label_security")
    ...
    @property
    @pulumi.getter(name="objectCreatorHasAccessPermission")
    def object_creator_has_access_permission(self) -> builtins.bool:
        """
        Sets whether to allow the creator of the object to have access to the object, I .e. sets the attribute. The default is the allowed state.
        """
        return pulumi.get(self, "object_creator_has_access_permission")
    ...
    @property
    @pulumi.getter(name="objectCreatorHasGrantPermission")
    def object_creator_has_grant_permission(self) -> builtins.bool:
        """
        The ObjectCreatorHasGrantPermission attribute is set to allow the object creator to have the authorization permission on the object. The default is the allowed state.
        """
        return pulumi.get(self, "object_creator_has_grant_permission")
    ...
    @property
    @pulumi.getter(name="usingAcl")
    def using_acl(self) -> builtins.bool:
        """
        Set whether to use the [ACL permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/maxcompute-permissions), that is, set the CheckPermissionUsingACL attribute, which is in use by default.
        """
        return pulumi.get(self, "using_acl")
    ...
    @property
    @pulumi.getter(name="usingPolicy")
    def using_policy(self) -> builtins.bool:
        """
        Set whether to use the Policy permission control function (https://www.alibabacloud.com/help/en/maxcompute/user-guide/policy-based-access-control-1), that is, set the CheckPermissionUsingACL attribute, which is in use by default.
        """
        return pulumi.get(self, "using_policy")
...
class GetProjectsProjectSecurityPropertiesProjectProtectionResult(dict):
    ...
    @property
    @pulumi.getter(name="exceptionPolicy")
    def exception_policy(self) -> builtins.str:
        """
        Set [Exceptions or Trusted Items](https://www.alibabacloud.com/help/en/maxcompute/security-and-compliance/project-data-protection).
        """
        return pulumi.get(self, "exception_policy")
