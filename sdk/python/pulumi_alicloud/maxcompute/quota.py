...
class QuotaArgs:
    def __init__(__self__, *,
                 commodity_code: pulumi.Input[builtins.str],
                 payment_type: pulumi.Input[builtins.str],
                 commodity_data: Optional[pulumi.Input[builtins.str]] = None,
                 part_nick_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] commodity_code: Valid values: odps_intl/odpsplus_intl/odps/odpsplus
        ...
        :param pulumi.Input[builtins.str] payment_type: Payment type. Valid values: Subscription/PayAsYouGo
               
               > **NOTE:** -- PayAsYouGo only needs to be opened once per region
        :param pulumi.Input[builtins.str] commodity_data: Define quota rules when creating quotas, for example:{"CU":50,"ord_time":"1:Month","autoRenew":false}.
        ...
        :param pulumi.Input[builtins.str] part_nick_name: Quota partial nickname, supports English letters and numbers, up to 24 characters
    ...
    def commodity_code(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def commodity_code(self, value: pulumi.Input[builtins.str]):
    ...
    def commodity_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def commodity_data(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "commodity_data", value)

    @property
    @pulumi.getter(name="partNickName")
    def part_nick_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def part_nick_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Quota(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="commodityData")
    def commodity_data(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Define quota rules when creating quotas, for example:{"CU":50,"ord_time":"1:Month","autoRenew":false}.
        CU (minimum quota resource size is 50)
        ord_time 1:Month/Year (1 means quantity: Month/Year is the unit)
    ...
    @property
    @pulumi.getter(name="partNickName")
    def part_nick_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Quota partial nickname, supports English letters and numbers, up to 24 characters
