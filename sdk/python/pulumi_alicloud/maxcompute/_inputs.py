...
if not MYPY:
    class ProjectIpWhiteListArgsDict(TypedDict):
        ip_list: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        vpc_ip_list: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ProjectIpWhiteListArgs:
    def __init__(__self__, *,
                 ip_list: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_ip_list: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ip_list: Set the IP address whitelist in the classic network. Only devices in the whitelist are allowed to access the project.
               
               > **NOTE:** If you only configure a classic network IP address whitelist, access to the classic network is restricted and all access to the VPC is prohibited.
        :param pulumi.Input[builtins.str] vpc_ip_list: Set the IP address whitelist in the VPC network to allow only devices in the whitelist to access the project space.
    ...
    def ip_list(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Set the IP address whitelist in the classic network. Only devices in the whitelist are allowed to access the project.
    ...
    @ip_list.setter
    def ip_list(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ip_list", value)

    @property
    @pulumi.getter(name="vpcIpList")
    def vpc_ip_list(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Set the IP address whitelist in the VPC network to allow only devices in the whitelist to access the project space.
    ...
    @vpc_ip_list.setter
    def vpc_ip_list(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ProjectPropertiesArgsDict(TypedDict):
        ...
        """
        sql_metering_max: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        type_system: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ProjectPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ProjectPropertiesEncryptionArgs'] encryption: Storage encryption. For details, see [Storage Encryption](https://www.alibabacloud.com/help/en/maxcompute/security-and-compliance/storage-encryption)
               ...
               You can turn on storage encryption only for projects that have not turned on storage encryption. For projects that have turned on storage encryption, you cannot turn off storage encryption or change the encryption algorithm. See `encryption` below.
        :param pulumi.Input[builtins.int] retention_days: Set the number of days to retain backup data. During this time, you can restore the current version to any backup version. The value range of days is [0,30], and the default value is 1. 0 means backup is turned off.
               The effective policy after adjusting the backup cycle is:
               Extend the backup cycle: The new backup cycle takes effect on the same day.
               Shorten the backup cycle: The system will automatically delete backup data that has exceeded the retention cycle.
        :param pulumi.Input[builtins.str] sql_metering_max: Set the maximum threshold for single SQL Consumption, that is, set the ODPS. SQL. metering.value.max attribute. For more information, see [Consumption control](https://www.alibabacloud.com/help/en/maxcompute/product-overview/consumption-control).
               Unit: scan volume (GB)* complexity.
        ...
        :param pulumi.Input[builtins.str] timezone: Project time zone, example value: Asia/Shanghai
        :param pulumi.Input[builtins.str] type_system: Data type version. Value:(1/2/hive)
               1: The original MaxCompute type system.
               2: New type system introduced by MaxCompute 2.0.
               hive: the type system of the Hive compatibility mode introduced by MaxCompute 2.0.
        """
    ...
    def allow_full_scan(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def sql_metering_max(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Set the maximum threshold for single SQL Consumption, that is, set the ODPS. SQL. metering.value.max attribute. For more information, see [Consumption control](https://www.alibabacloud.com/help/en/maxcompute/product-overview/consumption-control).
        Unit: scan volume (GB)* complexity.
        """
    ...
    def sql_metering_max(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def type_system(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Data type version. Value:(1/2/hive)
        1: The original MaxCompute type system.
        2: New type system introduced by MaxCompute 2.0.
    ...
    @type_system.setter
    def type_system(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ProjectPropertiesEncryptionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] algorithm: The encryption algorithm supported by the key, including AES256, AESCTR, and RC4.
        :param pulumi.Input[builtins.bool] enable: Only enable function is supported. Value: (true)
               
               > **NOTE:** cannot be turned off after the function is turned on
        :param pulumi.Input[builtins.str] key: The encryption algorithm Key, the Key type used by the project, including the Default Key (MaxCompute Default Key) and the self-contained Key (BYOK). The MaxCompute Default Key is the Default Key created inside MaxCompute.
        """
...
class ProjectPropertiesTableLifecycleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: The value of the life cycle, in days. The value range is 1~37231, and the default value is 37231.
        """
        if type is not None:
...
if not MYPY:
    class ProjectSecurityPropertiesArgsDict(TypedDict):
        enable_download_privilege: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        label_security: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        object_creator_has_access_permission: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        object_creator_has_grant_permission: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        using_acl: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        using_policy: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ProjectSecurityPropertiesArgs:
    def __init__(__self__, *,
                 enable_download_privilege: Optional[pulumi.Input[builtins.bool]] = None,
                 label_security: Optional[pulumi.Input[builtins.bool]] = None,
                 object_creator_has_access_permission: Optional[pulumi.Input[builtins.bool]] = None,
                 object_creator_has_grant_permission: Optional[pulumi.Input[builtins.bool]] = None,
                 project_protection: Optional[pulumi.Input['ProjectSecurityPropertiesProjectProtectionArgs']] = None,
                 using_acl: Optional[pulumi.Input[builtins.bool]] = None,
                 using_policy: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_download_privilege: Set whether to enable the [Download permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/download-control), that is, set the ODPS. security.enabledownloadprivilege property.
        :param pulumi.Input[builtins.bool] label_security: Set whether to use the [Label permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/label-based-access-control), that is, set the LabelSecurity attribute, which is not used by default.
        :param pulumi.Input[builtins.bool] object_creator_has_access_permission: Sets whether to allow the creator of the object to have access to the object, I .e. sets the attribute. The default is the allowed state.
        :param pulumi.Input[builtins.bool] object_creator_has_grant_permission: The ObjectCreatorHasGrantPermission attribute is set to allow the object creator to have the authorization permission on the object. The default is the allowed state.
        ...
        :param pulumi.Input[builtins.bool] using_acl: Set whether to use the [ACL permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/maxcompute-permissions), that is, set the CheckPermissionUsingACL attribute, which is in use by default.
        :param pulumi.Input[builtins.bool] using_policy: Set whether to use the Policy permission control function (https://www.alibabacloud.com/help/en/maxcompute/user-guide/policy-based-access-control-1), that is, set the CheckPermissionUsingACL attribute, which is in use by default.
        """
    ...
    def enable_download_privilege(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Set whether to enable the [Download permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/download-control), that is, set the ODPS. security.enabledownloadprivilege property.
        """
    ...
    def enable_download_privilege(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_download_privilege", value)

    @property
    @pulumi.getter(name="labelSecurity")
    def label_security(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Set whether to use the [Label permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/label-based-access-control), that is, set the LabelSecurity attribute, which is not used by default.
        """
    ...
    def label_security(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "label_security", value)

    @property
    @pulumi.getter(name="objectCreatorHasAccessPermission")
    def object_creator_has_access_permission(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Sets whether to allow the creator of the object to have access to the object, I .e. sets the attribute. The default is the allowed state.
        """
    ...
    def object_creator_has_access_permission(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "object_creator_has_access_permission", value)

    @property
    @pulumi.getter(name="objectCreatorHasGrantPermission")
    def object_creator_has_grant_permission(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        The ObjectCreatorHasGrantPermission attribute is set to allow the object creator to have the authorization permission on the object. The default is the allowed state.
        """
    ...
    def object_creator_has_grant_permission(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def using_acl(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Set whether to use the [ACL permission control function](https://www.alibabacloud.com/help/en/maxcompute/user-guide/maxcompute-permissions), that is, set the CheckPermissionUsingACL attribute, which is in use by default.
        """
    ...
    @using_acl.setter
    def using_acl(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "using_acl", value)

    @property
    @pulumi.getter(name="usingPolicy")
    def using_policy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Set whether to use the Policy permission control function (https://www.alibabacloud.com/help/en/maxcompute/user-guide/policy-based-access-control-1), that is, set the CheckPermissionUsingACL attribute, which is in use by default.
        """
    ...
    @using_policy.setter
    def using_policy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "using_policy", value)


if not MYPY:
    class ProjectSecurityPropertiesProjectProtectionArgsDict(TypedDict):
        exception_policy: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ProjectSecurityPropertiesProjectProtectionArgs:
    def __init__(__self__, *,
                 exception_policy: Optional[pulumi.Input[builtins.str]] = None,
                 protected: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] exception_policy: Set [Exceptions or Trusted Items](https://www.alibabacloud.com/help/en/maxcompute/security-and-compliance/project-data-protection)
        :param pulumi.Input[builtins.bool] protected: Whether enabled, value:(true/false)
        """
    ...
    def exception_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Set [Exceptions or Trusted Items](https://www.alibabacloud.com/help/en/maxcompute/security-and-compliance/project-data-protection)
        """
    ...
    def exception_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class QuotaPlanQuotaParameterArgsDict(TypedDict):
        elastic_reserved_cu: pulumi.Input[builtins.int]
        """
        ...
        """
        max_cu: NotRequired[pulumi.Input[builtins.int]]
        """
        The value of maxCU in Reserved CUs.
        """
        min_cu: NotRequired[pulumi.Input[builtins.int]]
        """
...
class QuotaPlanQuotaParameterArgs:
    def __init__(__self__, *,
                 elastic_reserved_cu: pulumi.Input[builtins.int],
                 max_cu: Optional[pulumi.Input[builtins.int]] = None,
                 min_cu: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] elastic_reserved_cu: The value of elastic Reserved CUs.
               
               > **NOTE:**  The total number of elastically reserved CUs in all the level-2 quotas is equal to the number of elastically reserved CUs in the level-1 quota..
        :param pulumi.Input[builtins.int] max_cu: The value of maxCU in Reserved CUs.
        :param pulumi.Input[builtins.int] min_cu: The value of minCU in Reserved CUs.
        """
    ...
    def elastic_reserved_cu(self) -> pulumi.Input[builtins.int]:
        """
        The value of elastic Reserved CUs.
    ...
    def elastic_reserved_cu(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "elastic_reserved_cu", value)

    @property
    @pulumi.getter(name="maxCu")
    def max_cu(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The value of maxCU in Reserved CUs.
        """
    ...
    @max_cu.setter
    def max_cu(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_cu", value)

    @property
    @pulumi.getter(name="minCu")
    def min_cu(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The value of minCU in Reserved CUs.
        """
    ...
    @min_cu.setter
    def min_cu(self, value: Optional[pulumi.Input[builtins.int]]):
...
class QuotaPlanQuotaSubQuotaInfoListArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] nick_name: The nickname of the level-2 quota.
...
class QuotaScheduleScheduleListArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] plan: The name of the quota plan.
        :param pulumi.Input[builtins.str] type: The type of the quota plan. Valid values: daily 
...
class QuotaScheduleScheduleListConditionArgs:
    def __init__(__self__, *,
                 at: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] at: Effective time. The format is HH:mm, sample value: 00:00
    ...
    @property
    @pulumi.getter
    def at(self) -> pulumi.Input[builtins.str]:
        """
        Effective time. The format is HH:mm, sample value: 00:00
    ...
    @at.setter
    def at(self, value: pulumi.Input[builtins.str]):
...
class QuotaSubQuotaInfoListArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] nick_name: Secondary Quota nickname.
               
               > **NOTE:** -- Subscription: If you enter partNickName, the first-level QuotaNickName created is os_partNickName_p. Each first-level Quota has a default second-level Quota whose QuotaNickName is os_partNickName . -- The first-level quotanicname created by PayAsYouGo is os_PayAsYouGoQuota_p  by default, the second-level quotanicname is os_PayAsYouGoQuota
        :param pulumi.Input['QuotaSubQuotaInfoListParameterArgs'] parameter: Parameter See `parameter` below.
        :param pulumi.Input[builtins.str] type: The secondary Quota type. The default value is: FUXI_OFFLINE
        """
        pulumi.set(__self__, "nick_name", nick_name)
        if parameter is not None:
            pulumi.set(__self__, "parameter", parameter)
...
if not MYPY:
    class QuotaSubQuotaInfoListParameterArgsDict(TypedDict):
        ...
        """
        enable_priority: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enable priority. Valid values: true/false, default: false
        """
        force_reserved_min: NotRequired[pulumi.Input[builtins.bool]]
        """
        Exclusive or not. Valid values: true/false, default: false
        """
        scheduler_type: NotRequired[pulumi.Input[builtins.str]]
        """
        Scheduling policy. Valid values: Fifo/Fair, default: Fifo
        """
        single_job_cu_limit: NotRequired[pulumi.Input[builtins.int]]
        """
...
class QuotaSubQuotaInfoListParameterArgs:
    def __init__(__self__, *,
                 max_cu: pulumi.Input[builtins.int],
                 min_cu: pulumi.Input[builtins.int],
                 enable_priority: Optional[pulumi.Input[builtins.bool]] = None,
                 force_reserved_min: Optional[pulumi.Input[builtins.bool]] = None,
                 scheduler_type: Optional[pulumi.Input[builtins.str]] = None,
                 single_job_cu_limit: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] max_cu: The value of maxCU in Reserved CUs.
        ...
        :param pulumi.Input[builtins.int] min_cu: The value of minCU in Reserved CUs.
               ...
               > **NOTE:**  -- The total value of minCU in all the level-2 quotas is equal to the value of minCU in the level-1 quota.    -- The value of minCU must be less than or equal to the value of maxCU in the level-2 quota and less than or equal to the value of minCU in the level-1 quota that you purchased.
        :param pulumi.Input[builtins.bool] enable_priority: Enable priority. Valid values: true/false, default: false
        :param pulumi.Input[builtins.bool] force_reserved_min: Exclusive or not. Valid values: true/false, default: false
        :param pulumi.Input[builtins.str] scheduler_type: Scheduling policy. Valid values: Fifo/Fair, default: Fifo
        :param pulumi.Input[builtins.int] single_job_cu_limit: Single job CU upper limit. Valid value: greater than or equal to 1
    ...
    def enable_priority(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable priority. Valid values: true/false, default: false
        """
    ...
    def enable_priority(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_priority", value)

    @property
    @pulumi.getter(name="forceReservedMin")
    def force_reserved_min(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Exclusive or not. Valid values: true/false, default: false
        """
    ...
    def force_reserved_min(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def single_job_cu_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Single job CU upper limit. Valid value: greater than or equal to 1
    ...
    def single_job_cu_limit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "single_job_cu_limit", value)


if not MYPY:
    class TunnelQuotaTimerQuotaTimerArgsDict(TypedDict):
        begin_time: pulumi.Input[builtins.str]
        """
...
class TunnelQuotaTimerQuotaTimerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] begin_time: The time-sharing configuration start time. Reference value: 00:00
        :param pulumi.Input[builtins.str] end_time: The end time of the timesharing configuration. Reference value: 24:00
    ...
    def begin_time(self) -> pulumi.Input[builtins.str]:
        """
        The time-sharing configuration start time. Reference value: 00:00
        """
    ...
    @begin_time.setter
    def begin_time(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class TunnelQuotaTimerQuotaTimerTunnelQuotaParameterArgsDict(TypedDict):
        elastic_reserved_slot_num: pulumi.Input[builtins.int]
        """
        The number of elastic reserved concurrency (Slot).
        """
        slot_num: pulumi.Input[builtins.int]
        """
...
class TunnelQuotaTimerQuotaTimerTunnelQuotaParameterArgs:
    def __init__(__self__, *,
                 ...
                 slot_num: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] elastic_reserved_slot_num: The number of elastic reserved concurrency (Slot).
        :param pulumi.Input[builtins.int] slot_num: The number of reserved concurrency (Slot).
    ...
    def elastic_reserved_slot_num(self) -> pulumi.Input[builtins.int]:
        """
        The number of elastic reserved concurrency (Slot).
        """
    ...
    def elastic_reserved_slot_num(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "elastic_reserved_slot_num", value)

    @property
    @pulumi.getter(name="slotNum")
    def slot_num(self) -> pulumi.Input[builtins.int]:
        """
        The number of reserved concurrency (Slot).
    ...
    @slot_num.setter
    def slot_num(self, value: pulumi.Input[builtins.int]):
