...
class QuotaScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] nickname: The nickname of level-1 compute quota.
        :param pulumi.Input[builtins.str] timezone: Time zone, reference value: UTC +8
...
class QuotaSchedule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            nickname: Optional[pulumi.Input[builtins.str]] = None,
            schedule_lists: Optional[pulumi.Input[Sequence[pulumi.Input[Union['QuotaScheduleScheduleListArgs', 'QuotaScheduleScheduleListArgsDict']]]]] = None,
            timezone: Optional[pulumi.Input[builtins.str]] = None) -> 'QuotaSchedule':
        """
