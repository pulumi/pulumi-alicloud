...
class QuotaPlanArgs:
    def __init__(__self__, *,
                 ...
                 is_effective: Optional[pulumi.Input[builtins.bool]] = None,
                 quota: Optional[pulumi.Input['QuotaPlanQuotaArgs']] = None):
        """
        The set of arguments for constructing a QuotaPlan resource.
        :param pulumi.Input[builtins.str] nickname: Quota Name
        :param pulumi.Input[builtins.str] plan_name: The Quota plan name. Start with a letter, containing letters, numbers, and underscores (_). It is no more than 64 characters long.
        :param pulumi.Input[builtins.bool] is_effective: Whether to take effect immediately. “Valid values: true”  
    ...
    def is_effective(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_effective.setter
    def is_effective(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class QuotaPlan(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isEffective")
    def is_effective(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to take effect immediately. “Valid values: true”  
        .> **NOTE:** when other quota plans in the same quota group take effect, the effective quota group will become invalid. That is, IsEffective will become false. The effective quota plan cannot be deleted.
        """
    ...
    @property
    @pulumi.getter
    def nickname(self) -> pulumi.Output[builtins.str]:
        """
        Quota Name
        """
        return pulumi.get(self, "nickname")
