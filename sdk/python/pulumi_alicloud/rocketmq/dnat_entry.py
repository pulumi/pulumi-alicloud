...
class DnatEntryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ip_protocol: The protocol type. Valid values: TCP: Forwards packets of the TCP protocol. UDP: Forwards packets of the UDP protocol. Any: Forwards packets of all protocols.
        :param pulumi.Input[_builtins.str] sag_id: The ID of the SAG instance.
        :param pulumi.Input[_builtins.str] type: The DNAT type. Valid values: Intranet: DNAT of private IP addresses. Internet: DNAT of public IP addresses
...
class DnatEntry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip_protocol: Optional[pulumi.Input[_builtins.str]] = None,
            sag_id: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None) -> 'DnatEntry':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="externalIp")
    def external_ip(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The external public IP address.when "type" is "Internet",automatically identify the external ip.
        """
        return pulumi.get(self, "external_ip")
