...
def get_topics(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of topic IDs to filter results.
...
def get_topics_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
