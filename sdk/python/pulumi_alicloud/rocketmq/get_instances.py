...
def get_instances(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of instance IDs to filter results.
    :param builtins.str name_regex: A regex string to filter results by the instance name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.int status: The status of Ons instance. Valid values: `0` deploying, `2` arrears, `5` running, `7` upgrading.
    :param Mapping[str, builtins.str] tags: A map of tags assigned to the Ons instance.
    """
    __args__ = dict()
