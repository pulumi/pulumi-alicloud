...
class RocketMQTopicArgs:
    def __init__(__self__, *,
                 ...
                 max_send_tps: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] topic_name: Topic name and identification.
        :param pulumi.Input[builtins.int] max_send_tps: The maximum TPS for message sending.
        :param pulumi.Input[builtins.str] message_type: Message type.
    ...
    def max_send_tps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @max_send_tps.setter
    def max_send_tps(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _RocketMQTopicState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] max_send_tps: The maximum TPS for message sending.
        :param pulumi.Input[builtins.str] message_type: Message type.
        :param pulumi.Input[builtins.str] region_id: (Available since v1.247.0) The region ID to which the instance belongs.
        :param pulumi.Input[builtins.str] remark: Custom remarks.
...
class RocketMQTopic(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            remark: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            topic_name: Optional[pulumi.Input[builtins.str]] = None) -> 'RocketMQTopic':
        """
    ...
    @property
    @pulumi.getter(name="maxSendTps")
    def max_send_tps(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum TPS for message sending.
        """
        return pulumi.get(self, "max_send_tps")
