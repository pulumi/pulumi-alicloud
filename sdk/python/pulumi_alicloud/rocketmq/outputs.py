...
class ConsumerGroupConsumeRetryPolicy(dict):
    ...
    def __init__(__self__, *,
                 dead_letter_target_topic: Optional[builtins.str] = None,
                 max_retry_times: Optional[builtins.int] = None,
                 retry_policy: Optional[builtins.str] = None):
        """
        :param builtins.str dead_letter_target_topic: The dead-letter topic. If the consumer fails to consume a message in an abnormal situation and the message is still unsuccessful after retrying, the message will be delivered to the dead letter Topic for subsequent business recovery or backtracking.
        :param builtins.int max_retry_times: Maximum number of retries.
        :param builtins.str retry_policy: Consume retry policy.
        """
    ...
    def dead_letter_target_topic(self) -> Optional[builtins.str]:
        """
    ...
    def max_retry_times(self) -> Optional[builtins.int]:
        """
...
class RocketMQInstanceAclInfo(dict):
    ...
    def __init__(__self__, *,
                 acl_types: Optional[Sequence[builtins.str]] = None,
                 default_vpc_auth_free: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] acl_types: The authentication type of the instance. Valid values:
        :param builtins.bool default_vpc_auth_free: Indicates whether the authentication-free in VPCs feature is enabled. Indicates whether the authentication-free in VPCs feature is enabled. Valid values:
        """
    ...
    def acl_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def default_vpc_auth_free(self) -> Optional[builtins.bool]:
        """
...
class RocketMQInstanceNetworkInfoEndpoint(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ip_white_lists: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str endpoint_type: Access point type.
        :param builtins.str endpoint_url: Access point address.
        :param Sequence[builtins.str] ip_white_lists: White list of access addresses.
        """
    ...
    def ip_white_lists(self) -> Optional[Sequence[builtins.str]]:
        """
...
class RocketMQInstanceNetworkInfoInternetInfo(dict):
    ...
    def __init__(__self__, *,
                 flow_out_type: builtins.str,
                 internet_spec: builtins.str,
                 flow_out_bandwidth: Optional[builtins.int] = None,
                 ip_whitelists: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str flow_out_type: Public network billing type.  Parameter values are as follows:
        ...
        :param builtins.str internet_spec: Whether to enable public network access.  The parameter values are as follows:
        ...
        :param builtins.int flow_out_bandwidth: Public network bandwidth specification. Unit: Mb/s.  This field should only be filled when the public network billing type is set to payByBandwidth.  The value range is [1 - 1000].
        :param Sequence[builtins.str] ip_whitelists: Field `ip_whitelist` has been deprecated from provider version 1.245.0. New field `ip_whitelists` instead.
        """
    ...
    def flow_out_type(self) -> builtins.str:
        """
    ...
    def internet_spec(self) -> builtins.str:
        """
    ...
    def flow_out_bandwidth(self) -> Optional[builtins.int]:
        """
    ...
    def ip_whitelists(self) -> Optional[Sequence[builtins.str]]:
        """
...
class RocketMQInstanceNetworkInfoVpcInfo(dict):
    ...
    def __init__(__self__, *,
                 vpc_id: builtins.str,
                 security_group_ids: Optional[builtins.str] = None,
                 vswitch_id: Optional[builtins.str] = None,
                 vswitches: Optional[Sequence['outputs.RocketMQInstanceNetworkInfoVpcInfoVswitch']] = None):
        """
        :param builtins.str vpc_id: Proprietary Network.
        :param builtins.str security_group_ids: Security group id.
        :param builtins.str vswitch_id: VPC switch id.
    ...
    def security_group_ids(self) -> Optional[builtins.str]:
        """
        Security group id.
        """
...
class RocketMQInstanceProductInfo(dict):
    ...
    def __init__(__self__, *,
                 msg_process_spec: builtins.str,
                 auto_scaling: Optional[builtins.bool] = None,
                 message_retention_time: Optional[builtins.int] = None,
                 send_receive_ratio: Optional[builtins.float] = None,
                 storage_encryption: Optional[builtins.bool] = None,
                 storage_secret_key: Optional[builtins.str] = None,
                 support_auto_scaling: Optional[builtins.bool] = None,
                 trace_on: Optional[builtins.bool] = None):
        """
        :param builtins.str msg_process_spec: Message sending and receiving calculation specifications. For details about the upper limit for sending and receiving messages, see [Instance Specifications](https://help.aliyun.com/zh/apsaramq-for-rocketmq/cloud-message-queue-rocketmq-5-x-series/product-overview/instance-specifications).
        :param builtins.bool auto_scaling: is open auto scaling.
        :param builtins.int message_retention_time: Duration of message retention. Unit: hours.  For the range of values, please refer to [Usage Limits](https://help.aliyun.com/zh/apsaramq-for-rocketmq/cloud-message-queue-rocketmq-5-x-series/product-overview/usage-limits)>Resource Quotas>Limitations on Message Retention.  The message storage in AlibabaCloud RocketMQ is fully implemented in a serverless and elastic manner, with charges based on the actual storage space. You can control the storage capacity of messages by adjusting the duration of message retention. For more information, please see [Storage Fees](https://help.aliyun.com/zh/apsaramq-for-rocketmq/cloud-message-queue-rocketmq-5-x-series/product-overview/storage-fees).
        :param builtins.float send_receive_ratio: message send receive ratio.  Value range: [0.2, 0.5].
        :param builtins.bool storage_encryption: Specifies whether to enable the encryption at rest feature. Valid values: `true`, `false`.
        :param builtins.str storage_secret_key: The key for encryption at rest.
        :param builtins.bool support_auto_scaling: is support auto scaling.
        :param builtins.bool trace_on: Whether to enable the message trace function. Valid values: `true`, `false`.
        """
    ...
    def msg_process_spec(self) -> builtins.str:
        """
    ...
    def auto_scaling(self) -> Optional[builtins.bool]:
        """
    ...
    def message_retention_time(self) -> Optional[builtins.int]:
        """
    ...
    def send_receive_ratio(self) -> Optional[builtins.float]:
        """
    ...
    def storage_encryption(self) -> Optional[builtins.bool]:
        """
    ...
    def storage_secret_key(self) -> Optional[builtins.str]:
        """
    ...
    def support_auto_scaling(self) -> Optional[builtins.bool]:
        """
    ...
    def trace_on(self) -> Optional[builtins.bool]:
        """
...
class RocketMQInstanceSoftware(dict):
    ...
    def __init__(__self__, *,
                 maintain_time: Optional[builtins.str] = None,
                 software_version: Optional[builtins.str] = None,
                 upgrade_method: Optional[builtins.str] = None):
        """
        :param builtins.str maintain_time: Upgrade time period.
        :param builtins.str software_version: Software version.
        :param builtins.str upgrade_method: Upgrade method.
        """
    ...
    def maintain_time(self) -> Optional[builtins.str]:
        """
        Upgrade time period.
        """
    ...
    def upgrade_method(self) -> Optional[builtins.str]:
        """
        Upgrade method.
        """
...
class GetGroupsGroupResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 independent_naming: builtins.bool,
        ...
        :param builtins.str group_type: Specify the protocol applicable to the created Group ID. Valid values: `tcp`, `http`. Default to `tcp`.
        :param builtins.str id: The name of the group.
        :param builtins.bool independent_naming: Indicates whether namespaces are available. Read [Fields in SubscribeInfoDo](https://www.alibabacloud.com/help/doc-detail/29619.html) for further details.
        :param builtins.str instance_id: ID of the ONS Instance that owns the groups.
        :param builtins.str owner: The ID of the group owner, which is the Alibaba Cloud UID.
        :param builtins.str remark: Remark of the group.
    ...
    def independent_naming(self) -> builtins.bool:
        """
...
class GetInstancesInstanceResult(dict):
    def __init__(__self__, *,
                 http_internal_endpoint: builtins.str,
                 http_internet_endpoint: builtins.str,
                 http_internet_secure_endpoint: builtins.str,
                 id: builtins.str,
                 independent_naming: builtins.bool,
                 instance_id: builtins.str,
                 instance_name: builtins.str,
                 instance_status: builtins.int,
                 instance_type: builtins.int,
                 release_time: builtins.str,
                 remark: builtins.str,
                 status: builtins.int,
                 tags: Mapping[str, builtins.str],
                 tcp_endpoint: builtins.str):
        """
        :param builtins.str http_internal_endpoint: The internal HTTP endpoint for the Message Queue for Apache RocketMQ instance.
        :param builtins.str http_internet_endpoint: The public HTTP endpoint for the Message Queue for Apache RocketMQ instance.
        :param builtins.str http_internet_secure_endpoint: The public HTTPS endpoint for the Message Queue for Apache RocketMQ instance.
        :param builtins.str id: ID of the instance.
        :param builtins.bool independent_naming: Indicates whether any namespace is configured for the Message Queue for Apache RocketMQ instance.
        :param builtins.str instance_id: ID of the instance.
        :param builtins.str instance_name: Name of the instance.
        :param builtins.int instance_status: The status of the instance. Read [Fields in InstanceVO](https://www.alibabacloud.com/help/doc-detail/106351.html) for further details.
        :param builtins.int instance_type: The type of the instance. Read [Fields in InstanceVO](https://www.alibabacloud.com/help/doc-detail/106351.html) for further details.
        :param builtins.str release_time: The automatic release time of an Enterprise Platinum Edition instance.
        :param builtins.str remark: This attribute is a concise description of instance.
        :param builtins.int status: The status of Ons instance. Valid values: `0` deploying, `2` arrears, `5` running, `7` upgrading.
        :param Mapping[str, builtins.str] tags: A map of tags assigned to the Ons instance.
        :param builtins.str tcp_endpoint: The TCP endpoint for the Message Queue for Apache RocketMQ instance.
        """
    ...
    def http_internal_endpoint(self) -> builtins.str:
        """
    ...
    def http_internet_endpoint(self) -> builtins.str:
        """
    ...
    def http_internet_secure_endpoint(self) -> builtins.str:
        """
    ...
    def instance_status(self) -> builtins.int:
        """
    ...
    def instance_type(self) -> builtins.int:
        """
    ...
    def tcp_endpoint(self) -> builtins.str:
        """
...
class GetTopicsTopicResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: The id of the topic.
        :param builtins.bool independent_naming: Indicates whether namespaces are available. Read [Fields in PublishInfoDo](https://www.alibabacloud.com/help/doc-detail/29590.html) for further details.
        :param builtins.str instance_id: ID of the ONS Instance that owns the topics.
        :param builtins.int message_type: The type of the message. Read [Fields in PublishInfoDo](https://www.alibabacloud.com/help/doc-detail/29590.html) for further details.
        :param builtins.str owner: The ID of the topic owner, which is the Alibaba Cloud UID.
        :param builtins.int perm: This attribute is used to set the read-write mode for the topic.
        :param builtins.int relation: The relation ID. Read [Fields in PublishInfoDo](https://www.alibabacloud.com/help/doc-detail/29590.html) for further details.
        :param builtins.str relation_name: The name of the relation, for example, owner, publishable, subscribable, and publishable and subscribable.
        :param builtins.str remark: Remark of the topic.
        :param Mapping[str, builtins.str] tags: A map of tags assigned to the Ons instance.
        :param builtins.str topic: The name of the topic.
    ...
    @property
    @pulumi.getter
    def relation(self) -> builtins.int:
        """
    ...
    def relation_name(self) -> builtins.str:
        """
