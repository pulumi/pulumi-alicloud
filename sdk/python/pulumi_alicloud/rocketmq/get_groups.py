...
class GetGroupsResult:
    ...
    def group_id_regex(self) -> Optional[builtins.str]:
...
def get_groups(group_id_regex: Optional[builtins.str] = None,
    ...
    :param builtins.str group_id_regex: A regex string to filter results by the group name.
    ...
    :param Sequence[builtins.str] ids: A list of group names.
...
def get_groups_output(group_id_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
