...
class QosPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dest_cidr: The destination CIDR block.
        :param pulumi.Input[builtins.str] dest_port_range: The destination port range.
        :param pulumi.Input[builtins.str] ip_protocol: The transport layer protocol.
        :param pulumi.Input[builtins.int] priority: The priority of the quintuple rule. A smaller value indicates a higher priority. If the priorities of two quintuple rules are the same, the rule created earlier is applied first.Value range: 1 to 7.
        :param pulumi.Input[builtins.str] qos_id: The instance ID of the QoS policy to which the quintuple rule is created.
        :param pulumi.Input[builtins.str] source_cidr: The source CIDR block.
        :param pulumi.Input[builtins.str] source_port_range: The source port range of the transport layer.
        :param pulumi.Input[builtins.str] description: The description of the QoS policy.
        :param pulumi.Input[builtins.str] end_time: The expiration time of the quintuple rule.
        :param pulumi.Input[builtins.str] name: The name of the QoS policy.
        :param pulumi.Input[builtins.str] start_time: The time when the quintuple rule takes effect.
        """
...
@pulumi.type_token("alicloud:rocketmq/qosPolicy:QosPolicy")
class QosPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_cidr: Optional[pulumi.Input[builtins.str]] = None,
            source_port_range: Optional[pulumi.Input[builtins.str]] = None,
            start_time: Optional[pulumi.Input[builtins.str]] = None) -> 'QosPolicy':
        """
