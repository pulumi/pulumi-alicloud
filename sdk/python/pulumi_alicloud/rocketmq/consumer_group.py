...
class ConsumerGroupArgs:
    def __init__(__self__, *,
                 ...
                 consumer_group_id: pulumi.Input[builtins.str],
                 instance_id: pulumi.Input[builtins.str],
                 delivery_order_type: Optional[pulumi.Input[builtins.str]] = None,
                 max_receive_tps: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] consumer_group_id: The first ID of the resource.
        :param pulumi.Input[builtins.str] instance_id: Instance ID.
        :param pulumi.Input[builtins.str] delivery_order_type: Delivery order.
        :param pulumi.Input[builtins.int] max_receive_tps: Maximum received message tps.
        :param pulumi.Input[builtins.str] remark: Custom remarks.
        """
    ...
    def consumer_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def consumer_group_id(self, value: pulumi.Input[builtins.str]):
    ...
    def delivery_order_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Delivery order.
        """
    ...
    def delivery_order_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delivery_order_type", value)

    @property
    @pulumi.getter(name="maxReceiveTps")
    def max_receive_tps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_receive_tps(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _ConsumerGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: Instance ID.
        :param pulumi.Input[builtins.int] max_receive_tps: Maximum received message tps.
        :param pulumi.Input[builtins.str] region_id: (Available since v1.247.0) The ID of the region in which the instance resides.
        :param pulumi.Input[builtins.str] remark: Custom remarks.
...
class ConsumerGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region_id: Optional[pulumi.Input[builtins.str]] = None,
            remark: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ConsumerGroup':
        """
    ...
    @property
    @pulumi.getter(name="deliveryOrderType")
    def delivery_order_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Delivery order.
        """
        return pulumi.get(self, "delivery_order_type")
    ...
    @property
    @pulumi.getter(name="maxReceiveTps")
    def max_receive_tps(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum received message tps.
        """
        return pulumi.get(self, "max_receive_tps")
