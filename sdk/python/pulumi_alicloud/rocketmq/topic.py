...
class TopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] remark: This attribute is a concise description of topic. The length cannot exceed 128.
        ...
        :param pulumi.Input[_builtins.str] topic: Replaced by `topic_name` after version 1.97.0.
        :param pulumi.Input[_builtins.str] topic_name: Name of the topic. Two topics on a single instance cannot have the same name and the name cannot start with 'GID' or 'CID'. The length cannot exceed 64 characters.
        """
...
class Topic(pulumi.CustomResource):
    ...
    @pulumi.getter
    @_utilities.deprecated("""Attribute perm has been deprecated and suggest removing it from your template.""")
    def perm(self) -> pulumi.Output[_builtins.int]:
        """
        This attribute has been deprecated.
        """
        return pulumi.get(self, "perm")
