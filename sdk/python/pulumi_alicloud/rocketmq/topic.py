...
class TopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: ID of the ONS Instance that owns the topics.
        :param pulumi.Input[builtins.int] message_type: The type of the message. Read [Ons Topic Create](https://www.alibabacloud.com/help/doc-detail/29591.html) for further details.
        :param pulumi.Input[builtins.int] perm: This attribute has been deprecated.
        :param pulumi.Input[builtins.str] remark: This attribute is a concise description of topic. The length cannot exceed 128.
        ...
        :param pulumi.Input[builtins.str] topic: Replaced by `topic_name` after version 1.97.0.
        :param pulumi.Input[builtins.str] topic_name: Name of the topic. Two topics on a single instance cannot have the same name and the name cannot start with 'GID' or 'CID'. The length cannot exceed 64 characters.
        """
...
@pulumi.type_token("alicloud:rocketmq/topic:Topic")
class Topic(pulumi.CustomResource):
    ...
    @pulumi.getter
    @_utilities.deprecated("""Attribute perm has been deprecated and suggest removing it from your template.""")
    def perm(self) -> pulumi.Output[builtins.int]:
        """
        This attribute has been deprecated.
        """
        return pulumi.get(self, "perm")
