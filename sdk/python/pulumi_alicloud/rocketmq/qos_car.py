...
class QosCarArgs:
    def __init__(__self__, *,
                 limit_type: pulumi.Input[builtins.str],
                 priority: pulumi.Input[builtins.int],
                 qos_id: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 max_bandwidth_abs: Optional[pulumi.Input[builtins.int]] = None,
                 max_bandwidth_percent: Optional[pulumi.Input[builtins.int]] = None,
                 min_bandwidth_abs: Optional[pulumi.Input[builtins.int]] = None,
                 min_bandwidth_percent: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 percent_source_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a QosCar resource.
        :param pulumi.Input[builtins.str] limit_type: The speed limiting method. Valid values: `Absolute`, `Percent`.
        :param pulumi.Input[builtins.int] priority: The priority of the specified stream.
        :param pulumi.Input[builtins.str] qos_id: The instance ID of the QoS.
        :param pulumi.Input[builtins.str] description: The description of the QoS speed limiting rule.
        :param pulumi.Input[builtins.int] max_bandwidth_abs: The maximum bandwidth allowed for the stream specified in the quintuple rule. This parameter is required when the value of the LimitType is Absolute.
        :param pulumi.Input[builtins.int] max_bandwidth_percent: The maximum bandwidth percentage allowed for the stream specified in the quintuple rule. It is based on the maximum upstream bandwidth you set for the associated Smart Access Gateway (SAG) instance.This parameter is required when the value of the LimitType parameter is Percent.
        :param pulumi.Input[builtins.int] min_bandwidth_abs: The minimum bandwidth allowed for the stream specified in the quintuple rule. This parameter is required when the value of the LimitType parameter is Absolute.
        :param pulumi.Input[builtins.int] min_bandwidth_percent: The minimum bandwidth percentage allowed for the stream specified in the quintuple rule. It is based on the maximum upstream bandwidth you set for the associated SAG instance.This parameter is required when the value of the LimitType parameter is Percent.
        :param pulumi.Input[builtins.str] name: The name of the QoS speed limiting rule..
        :param pulumi.Input[builtins.str] percent_source_type: The bandwidth type when the speed is limited based on percentage. Valid values: CcnBandwidth, InternetUpBandwidth.The default value is InternetUpBandwidth.
        """
    ...
    def limit_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @limit_type.setter
    def limit_type(self, value: pulumi.Input[builtins.str]):
    ...
    def max_bandwidth_abs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_bandwidth_abs(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_bandwidth_abs", value)

    @property
    @pulumi.getter(name="maxBandwidthPercent")
    def max_bandwidth_percent(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_bandwidth_percent(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_bandwidth_percent", value)

    @property
    @pulumi.getter(name="minBandwidthAbs")
    def min_bandwidth_abs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def min_bandwidth_abs(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "min_bandwidth_abs", value)

    @property
    @pulumi.getter(name="minBandwidthPercent")
    def min_bandwidth_percent(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def min_bandwidth_percent(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def percent_source_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def percent_source_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _QosCarState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 limit_type: Optional[pulumi.Input[builtins.str]] = None,
                 max_bandwidth_abs: Optional[pulumi.Input[builtins.int]] = None,
                 max_bandwidth_percent: Optional[pulumi.Input[builtins.int]] = None,
                 min_bandwidth_abs: Optional[pulumi.Input[builtins.int]] = None,
                 min_bandwidth_percent: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="limitType")
    def limit_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The speed limiting method. Valid values: `Absolute`, `Percent`.
        """
        return pulumi.get(self, "limit_type")
    ...
    @limit_type.setter
    def limit_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "limit_type", value)
...
class QosCar(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            percent_source_type: Optional[pulumi.Input[builtins.str]] = None,
            priority: Optional[pulumi.Input[builtins.int]] = None,
            qos_id: Optional[pulumi.Input[builtins.str]] = None) -> 'QosCar':
        """
    ...
    @property
    @pulumi.getter(name="limitType")
    def limit_type(self) -> pulumi.Output[builtins.str]:
        """
        The speed limiting method. Valid values: `Absolute`, `Percent`.
        """
        return pulumi.get(self, "limit_type")
    ...
    @property
    @pulumi.getter(name="maxBandwidthAbs")
    def max_bandwidth_abs(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum bandwidth allowed for the stream specified in the quintuple rule. This parameter is required when the value of the LimitType is Absolute.
        """
        return pulumi.get(self, "max_bandwidth_abs")
    ...
    @property
    @pulumi.getter(name="maxBandwidthPercent")
    def max_bandwidth_percent(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum bandwidth percentage allowed for the stream specified in the quintuple rule. It is based on the maximum upstream bandwidth you set for the associated Smart Access Gateway (SAG) instance.This parameter is required when the value of the LimitType parameter is Percent.
        """
        return pulumi.get(self, "max_bandwidth_percent")
    ...
    @property
    @pulumi.getter(name="minBandwidthAbs")
    def min_bandwidth_abs(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The minimum bandwidth allowed for the stream specified in the quintuple rule. This parameter is required when the value of the LimitType parameter is Absolute.
        """
        return pulumi.get(self, "min_bandwidth_abs")
    ...
    @property
    @pulumi.getter(name="minBandwidthPercent")
    def min_bandwidth_percent(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The minimum bandwidth percentage allowed for the stream specified in the quintuple rule. It is based on the maximum upstream bandwidth you set for the associated SAG instance.This parameter is required when the value of the LimitType parameter is Percent.
        """
        return pulumi.get(self, "min_bandwidth_percent")
    ...
    @property
    @pulumi.getter(name="percentSourceType")
    def percent_source_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The bandwidth type when the speed is limited based on percentage. Valid values: CcnBandwidth, InternetUpBandwidth.The default value is InternetUpBandwidth.
        """
        return pulumi.get(self, "percent_source_type")
