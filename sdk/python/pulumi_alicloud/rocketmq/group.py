...
class GroupArgs:
    def __init__(__self__, *,
                 ...
                 read_enable: Optional[pulumi.Input[builtins.bool]] = None,
                 remark: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Group resource.
        :param pulumi.Input[builtins.str] instance_id: ID of the ONS Instance that owns the groups.
        :param pulumi.Input[builtins.str] group_id: Replaced by `group_name` after version 1.98.0.
        :param pulumi.Input[builtins.str] group_name: Name of the group. Two groups on a single instance cannot have the same name. A `group_name` starts with "GID_" or "GID-", and contains letters, numbers, hyphens (-), and underscores (_).
        :param pulumi.Input[builtins.str] group_type: Specify the protocol applicable to the created Group ID. Valid values: `tcp`, `http`. Default to `tcp`.
        :param pulumi.Input[builtins.bool] read_enable: This attribute is used to set the message reading enabled or disabled. It can only be set after the group is used by the client.
        :param pulumi.Input[builtins.str] remark: This attribute is a concise description of group. The length cannot exceed 256.
    ...
    def read_enable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @read_enable.setter
    def read_enable(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Group(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            read_enable: Optional[pulumi.Input[builtins.bool]] = None,
            remark: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Group':
        """
    ...
    @property
    @pulumi.getter(name="readEnable")
    def read_enable(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        This attribute is used to set the message reading enabled or disabled. It can only be set after the group is used by the client.
        """
        return pulumi.get(self, "read_enable")
