...
class ClientUserArgs:
    def __init__(__self__, *,
                 ...
                 sag_id: pulumi.Input[builtins.str],
                 user_mail: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.int] bandwidth: The SAG APP bandwidth that the user can use. Unit: Kbit/s. Maximum value: 2000 Kbit/s.
        :param pulumi.Input[builtins.str] sag_id: The ID of the SAG instance created for the SAG APP.
        :param pulumi.Input[builtins.str] user_mail: The email address of the user. The administrator uses this address to send the account information for logging on to the APP to the user.
        :param pulumi.Input[builtins.str] client_ip: The IP address of the SAG APP. If you specify this parameter, the current account always uses the specified IP address.Note The IP address must be in the private CIDR block of the SAG client.If you do not specify this parameter, the system automatically allocates an IP address from the private CIDR block of the SAG client. In this case, each re-connection uses a different IP address.
        :param pulumi.Input[builtins.str] kms_encrypted_password: The password of the KMS Encryption.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] kms_encryption_context: The context of the KMS Encryption.
        :param pulumi.Input[builtins.str] password: The password used to log on to the SAG APP.Both the user name and the password must be specified. If you specify the user name, the password must be specified, too.
        :param pulumi.Input[builtins.str] user_name: The user name. User names in the same SAG APP must be unique.Both the user name and the password must be specified. If you specify the user name, the password must be specified, too.
        """
    ...
    def sag_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sag_id.setter
    def sag_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sag_id", value)

    @property
    @pulumi.getter(name="userMail")
    def user_mail(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @user_mail.setter
    def user_mail(self, value: pulumi.Input[builtins.str]):
...
class _ClientUserState:
    def __init__(__self__, *,
                 ...
                 kms_encryption_context: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 sag_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_mail: Optional[pulumi.Input[builtins.str]] = None,
                 user_name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="sagId")
    def sag_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the SAG instance created for the SAG APP.
        """
        return pulumi.get(self, "sag_id")
    ...
    @sag_id.setter
    def sag_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sag_id", value)

    @property
    @pulumi.getter(name="userMail")
    def user_mail(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The email address of the user. The administrator uses this address to send the account information for logging on to the APP to the user.
        """
        return pulumi.get(self, "user_mail")
    ...
    @user_mail.setter
    def user_mail(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_mail", value)
...
class ClientUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sag_id: Optional[pulumi.Input[builtins.str]] = None,
            user_mail: Optional[pulumi.Input[builtins.str]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ClientUser':
        """
    ...
    @property
    @pulumi.getter(name="sagId")
    def sag_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the SAG instance created for the SAG APP.
        """
        return pulumi.get(self, "sag_id")
    ...
    @property
    @pulumi.getter(name="userMail")
    def user_mail(self) -> pulumi.Output[builtins.str]:
        """
        The email address of the user. The administrator uses this address to send the account information for logging on to the APP to the user.
        """
        return pulumi.get(self, "user_mail")
