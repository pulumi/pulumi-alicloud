...
class AclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] actions: The type of operations that can be performed on the resource. Valid values:
               - If `resource_type` is set to `Topic`. Valid values: `Pub`, `Sub`.
               - If `resource_type` is set to `Group`. Valid values: `Sub`.
        :param pulumi.Input[builtins.str] decision: The decision result of the authorization. Valid values: `Deny`, `Allow`.
        :param pulumi.Input[builtins.str] instance_id: The instance ID.
        :param pulumi.Input[builtins.str] resource_name: The name of the resource on which you want to grant permissions.
        :param pulumi.Input[builtins.str] resource_type: The type of the resource on which you want to grant permissions. Valid values: `Group`, `Topic`.
        :param pulumi.Input[builtins.str] username: The username of the account.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_whitelists: The IP address whitelists.
        """
...
class Acl(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:rocketmq/acl:Acl"
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] instance_id: The instance ID.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_whitelists: The IP address whitelists.
        :param pulumi.Input[builtins.str] resource_name_: The name of the resource on which you want to grant permissions.
        :param pulumi.Input[builtins.str] resource_type: The type of the resource on which you want to grant permissions. Valid values: `Group`, `Topic`.
        :param pulumi.Input[builtins.str] username: The username of the account.
        """
        ...
    ...
    def get(resource_name: str,
            ...
            resource_name_: Optional[pulumi.Input[builtins.str]] = None,
            resource_type: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'Acl':
        """
