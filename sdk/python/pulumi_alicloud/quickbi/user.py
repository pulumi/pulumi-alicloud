...
class UserArgs:
    def __init__(__self__, *,
                 ...
                 admin_user: pulumi.Input[builtins.bool],
                 auth_admin_user: pulumi.Input[builtins.bool],
                 nick_name: pulumi.Input[builtins.str],
                 user_type: pulumi.Input[builtins.str],
                 account_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a User resource.
        :param pulumi.Input[builtins.str] account_name: An Alibaba Cloud account, Alibaba Cloud name.
        :param pulumi.Input[builtins.bool] admin_user: Whether it is the administrator. Valid values: `true` and `false`.
        :param pulumi.Input[builtins.bool] auth_admin_user: Whether this is a permissions administrator. Valid values: `false`, `true`.
        :param pulumi.Input[builtins.str] nick_name: The nickname of the user.
        :param pulumi.Input[builtins.str] user_type: The members of the organization of the type of role separately. Valid values: `Analyst`, `Developer` and `Visitor`.
        :param pulumi.Input[builtins.str] account_id: Alibaba Cloud account ID.
        """
    ...
    def admin_user(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @admin_user.setter
    def admin_user(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "admin_user", value)

    @property
    @pulumi.getter(name="authAdminUser")
    def auth_admin_user(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def auth_admin_user(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "auth_admin_user", value)

    @property
    @pulumi.getter(name="nickName")
    def nick_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @nick_name.setter
    def nick_name(self, value: pulumi.Input[builtins.str]):
...
class _UserState:
    def __init__(__self__, *,
                 ...
                 admin_user: Optional[pulumi.Input[builtins.bool]] = None,
                 auth_admin_user: Optional[pulumi.Input[builtins.bool]] = None,
                 nick_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="adminUser")
    def admin_user(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether it is the administrator. Valid values: `true` and `false`.
        """
        return pulumi.get(self, "admin_user")
    ...
    @admin_user.setter
    def admin_user(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "admin_user", value)

    @property
    @pulumi.getter(name="authAdminUser")
    def auth_admin_user(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether this is a permissions administrator. Valid values: `false`, `true`.
        """
        return pulumi.get(self, "auth_admin_user")
    ...
    @auth_admin_user.setter
    def auth_admin_user(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auth_admin_user", value)

    @property
    @pulumi.getter(name="nickName")
    def nick_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The nickname of the user.
        """
        return pulumi.get(self, "nick_name")
    ...
    @nick_name.setter
    def nick_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nick_name", value)
...
@pulumi.type_token("alicloud:quickbi/user:User")
class User(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="adminUser")
    def admin_user(self) -> pulumi.Output[builtins.bool]:
        """
        Whether it is the administrator. Valid values: `true` and `false`.
        """
        return pulumi.get(self, "admin_user")
    ...
    @property
    @pulumi.getter(name="authAdminUser")
    def auth_admin_user(self) -> pulumi.Output[builtins.bool]:
        """
        Whether this is a permissions administrator. Valid values: `false`, `true`.
        """
        return pulumi.get(self, "auth_admin_user")
    ...
    @property
    @pulumi.getter(name="nickName")
    def nick_name(self) -> pulumi.Output[builtins.str]:
        """
        The nickname of the user.
        """
        return pulumi.get(self, "nick_name")
