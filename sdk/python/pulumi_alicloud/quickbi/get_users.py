...
def get_users(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of User IDs.
    :param builtins.str keyword: The keywords of the nicknames or usernames of the members of the organization.
...
def get_users_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
