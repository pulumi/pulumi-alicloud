...
class TopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] life_cycle: How many days this topic lives. The permitted range of values is [1, 7]. The default value is 3.
        :param pulumi.Input[_builtins.str] name: The name of the datahub topic. Its length is limited to 1-128 and only characters such as letters, digits and '_' are allowed. It is case-insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] record_schema: Schema of this topic, required only for TUPLE topic. Supported data types (case-insensitive) are:
               - BIGINT
               - STRING
               - BOOLEAN
               - DOUBLE
               - TIMESTAMP
        :param pulumi.Input[_builtins.str] record_type: The type of this topic. Its value must be one of {BLOB, TUPLE}. For BLOB topic, data will be organized as binary and encoded by BASE64. For TUPLE topic, data has fixed schema. The default value is "TUPLE" with a schema {STRING}.
        :param pulumi.Input[_builtins.int] shard_count: The number of shards this topic contains. The permitted range of values is [1, 10]. The default value is 1.
        """
...
class _TopicState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] comment: Comment of the datahub topic. It cannot be longer than 255 characters.
               ...
               **Notes:** Currently `life_cycle` can not be modified and it will be supported in the next future.
        :param pulumi.Input[_builtins.str] create_time: Create time of the datahub topic. It is a human-readable string rather than 64-bits UTC.
        :param pulumi.Input[_builtins.str] last_modify_time: Last modify time of the datahub topic. It is the same as *create_time* at the beginning. It is also a human-readable string rather than 64-bits UTC.
        :param pulumi.Input[_builtins.int] life_cycle: How many days this topic lives. The permitted range of values is [1, 7]. The default value is 3.
        :param pulumi.Input[_builtins.str] name: The name of the datahub topic. Its length is limited to 1-128 and only characters such as letters, digits and '_' are allowed. It is case-insensitive.
        :param pulumi.Input[_builtins.str] project_name: The name of the datahub project that this topic belongs to. It is case-insensitive.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] record_schema: Schema of this topic, required only for TUPLE topic. Supported data types (case-insensitive) are:
...
class Topic(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="lifeCycle")
    def life_cycle(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        How many days this topic lives. The permitted range of values is [1, 7]. The default value is 3.
        """
        return pulumi.get(self, "life_cycle")
    ...
    @_builtins.property
    @pulumi.getter(name="recordSchema")
    def record_schema(self) -> pulumi.Output[Optional[Mapping[str, _builtins.str]]]:
        """
        Schema of this topic, required only for TUPLE topic. Supported data types (case-insensitive) are:
        - BIGINT
        - STRING
    ...
    @_builtins.property
    @pulumi.getter(name="recordType")
    def record_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The type of this topic. Its value must be one of {BLOB, TUPLE}. For BLOB topic, data will be organized as binary and encoded by BASE64. For TUPLE topic, data has fixed schema. The default value is "TUPLE" with a schema {STRING}.
        """
        return pulumi.get(self, "record_type")
