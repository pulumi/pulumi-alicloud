...
class SubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project_name: The name of the datahub project that the subscription belongs to. Its length is limited to 3-32 and only characters such as letters, digits and '_' are allowed. It is case-insensitive.
        :param pulumi.Input[builtins.str] topic_name: The name of the datahub topic that the subscription belongs to. Its length is limited to 1-128 and only characters such as letters, digits and '_' are allowed. It is case-insensitive.
        :param pulumi.Input[builtins.str] comment: Comment of the datahub subscription. It cannot be longer than 255 characters.
        """
...
class _SubscriptionState:
    def __init__(__self__, *,
                 ...
                 sub_id: Optional[pulumi.Input[builtins.str]] = None,
                 topic_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Subscription resources.
        :param pulumi.Input[builtins.str] comment: Comment of the datahub subscription. It cannot be longer than 255 characters.
        :param pulumi.Input[builtins.str] create_time: Create time of the datahub subscription. It is a human-readable string rather than 64-bits UTC.
        :param pulumi.Input[builtins.str] last_modify_time: Last modify time of the datahub subscription. It is the same as *create_time* at the beginning. It is also a human-readable string rather than 64-bits UTC.
        :param pulumi.Input[builtins.str] project_name: The name of the datahub project that the subscription belongs to. Its length is limited to 3-32 and only characters such as letters, digits and '_' are allowed. It is case-insensitive.
        :param pulumi.Input[builtins.str] sub_id: The identidy of the subscription, generate from server side.
        :param pulumi.Input[builtins.str] topic_name: The name of the datahub topic that the subscription belongs to. Its length is limited to 1-128 and only characters such as letters, digits and '_' are allowed. It is case-insensitive.
        """
        if comment is not None:
            pulumi.set(__self__, "comment", comment)
    ...
    def sub_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sub_id.setter
    def sub_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Subscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_name: Optional[pulumi.Input[builtins.str]] = None,
            sub_id: Optional[pulumi.Input[builtins.str]] = None,
            topic_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Subscription':
        """
    ...
    @property
    @pulumi.getter(name="subId")
    def sub_id(self) -> pulumi.Output[builtins.str]:
        """
        The identidy of the subscription, generate from server side.
        """
        return pulumi.get(self, "sub_id")
