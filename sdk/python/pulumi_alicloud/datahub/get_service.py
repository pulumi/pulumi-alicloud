...
def get_service(enable: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:datahub/getService:getService', __args__, opts=opts, typ=GetServiceResult).value
...
def get_service_output(enable: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:datahub/getService:getService', __args__, opts=opts, typ=GetServiceResult)
