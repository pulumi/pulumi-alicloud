...
class ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] comment: Comment of the datahub project. It cannot be longer than 255 characters.
        :param pulumi.Input[builtins.str] name: The name of the datahub project. Its length is limited to 3-32 and only characters such as letters, digits and '_' are allowed. It is case-insensitive.
        """
...
class _ProjectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] comment: Comment of the datahub project. It cannot be longer than 255 characters.
        :param pulumi.Input[builtins.str] create_time: Create time of the datahub project. It is a human-readable string rather than 64-bits UTC.
        :param pulumi.Input[builtins.str] last_modify_time: Last modify time of the datahub project. It is the same as *create_time* at the beginning. It is also a human-readable string rather than 64-bits UTC.
        :param pulumi.Input[builtins.str] name: The name of the datahub project. Its length is limited to 3-32 and only characters such as letters, digits and '_' are allowed. It is case-insensitive.
        """
        if comment is not None:
            pulumi.set(__self__, "comment", comment)
