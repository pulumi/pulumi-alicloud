...
def get_groups(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Group IDs.
    :param builtins.str name_regex: A regex string to filter results by Group name.
...
def get_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
