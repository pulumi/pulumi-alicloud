...
class GetQuotaAlarmsResult:
    ...
    def quota_alarm_name(self) -> Optional[builtins.str]:
...
def get_quota_alarms(enable_details: Optional[builtins.bool] = None,
                     ...
                     quota_alarm_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Quota Alarm IDs.
    :param builtins.str name_regex: A regex string to filter results by Quota Alarm name.
...
def get_quota_alarms_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                            ...
                            product_code: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            quota_action_code: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            quota_alarm_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
