...
class GetQuotaAlarmsResult:
    ...
    def quota_alarm_name(self) -> Optional[_builtins.str]:
...
def get_quota_alarms(enable_details: Optional[_builtins.bool] = None,
                     ids: Optional[Sequence[_builtins.str]] = None,
                     name_regex: Optional[_builtins.str] = None,
                     output_file: Optional[_builtins.str] = None,
                     product_code: Optional[_builtins.str] = None,
                     quota_action_code: Optional[_builtins.str] = None,
                     quota_alarm_name: Optional[_builtins.str] = None,
                     quota_dimensions: Optional[Sequence[Union['GetQuotaAlarmsQuotaDimensionArgs', 'GetQuotaAlarmsQuotaDimensionArgsDict', 'outputs.GetQuotaAlarmsQuotaDimensionResult']]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Quota Alarm IDs.
    :param _builtins.str name_regex: A regex string to filter results by Quota Alarm name.
    ...
    :param Sequence[Union['GetQuotaAlarmsQuotaDimensionArgs', 'GetQuotaAlarmsQuotaDimensionArgsDict', 'outputs.GetQuotaAlarmsQuotaDimensionResult']] quota_dimensions: The Quota Dimensions.
    """
    __args__ = dict()
...
def get_quota_alarms_output(enable_details: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                            ...
                            quota_dimensions: pulumi.Input[Optional[Optional[Sequence[Union['GetQuotaAlarmsQuotaDimensionArgs', 'GetQuotaAlarmsQuotaDimensionArgsDict', 'outputs.GetQuotaAlarmsQuotaDimensionResult']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:quotas/getQuotaAlarms:getQuotaAlarms', __args__, opts=opts, typ=GetQuotaAlarmsResult)
    return __ret__.apply(lambda __response__: GetQuotaAlarmsResult(
        ...
        quota_alarm_name=pulumi.get(__response__, 'quota_alarm_name'),
        quota_dimensions=pulumi.get(__response__, 'quota_dimensions')))
