...
class TemplateServiceArgs:
    def __init__(__self__, *,
                 service_status: pulumi.Input[builtins.int]):
        """
        The set of arguments for constructing a TemplateService resource.
        :param pulumi.Input[builtins.int] service_status: Status of the quota template. Valid values:
               - `-1`: disabled.
        """
    ...
    def service_status(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def service_status(self, value: pulumi.Input[builtins.int]):
...
class _TemplateServiceState:
    def __init__(__self__, *,
                 service_status: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    @property
    @pulumi.getter(name="serviceStatus")
    def service_status(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Status of the quota template. Valid values:
        - `-1`: disabled.
        """
    ...
    @service_status.setter
    def service_status(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "service_status", value)
...
class TemplateService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            service_status: Optional[pulumi.Input[builtins.int]] = None) -> 'TemplateService':
        """
    ...
    @property
    @pulumi.getter(name="serviceStatus")
    def service_status(self) -> pulumi.Output[builtins.int]:
        """
        Status of the quota template. Valid values:
        - `-1`: disabled.
        """
