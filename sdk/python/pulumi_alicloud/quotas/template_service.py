...
class TemplateServiceArgs:
    ...
    def service_status(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def service_status(self, value: pulumi.Input[_builtins.int]):
...
class TemplateService(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="serviceStatus")
    def service_status(self) -> pulumi.Output[_builtins.int]:
        """
        Status of the quota template. Valid values:
        - `-1`: disabled.
        """
