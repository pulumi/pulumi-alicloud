...
class TemplateApplicationsArgs:
    def __init__(__self__, *,
                 aliyun_uids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 ...
                 quota_category: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] aliyun_uids: The list of Alibaba Cloud accounts (primary accounts) of the resource directory members to which the quota is applied.
        ...
        :param pulumi.Input[builtins.float] desire_value: The value of the quota request.
        ...
        :param pulumi.Input[builtins.str] product_code: Cloud service name abbreviation.
        ...
        :param pulumi.Input[builtins.str] quota_category: The quota type. Value:
        ...
        :param pulumi.Input[builtins.str] effective_time: The UTC time when the quota takes effect. This parameter applies only to the equity quota (WhiteListLabel).
        ...
        :param pulumi.Input[builtins.str] env_language: The language of the quota application result notification. Value:
               - zh (default): Chinese.
               - en: English.
        :param pulumi.Input[builtins.str] expire_time: The UTC time when the quota expires. This parameter applies only to the equity quota (WhiteListLabel).
    ...
    def aliyun_uids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @aliyun_uids.setter
    def aliyun_uids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def quota_category(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def quota_category(self, value: pulumi.Input[builtins.str]):
...
class _TemplateApplicationsState:
    def __init__(__self__, *,
                 aliyun_uids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="aliyunUids")
    def aliyun_uids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of Alibaba Cloud accounts (primary accounts) of the resource directory members to which the quota is applied.
        > **NOTE:**  Only 50 members can apply for quota increase in batch at a time. For more information about the members of the resource directory, see Query the list of all members in the resource directory.
        """
    ...
    @aliyun_uids.setter
    def aliyun_uids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "aliyun_uids", value)
...
@pulumi.type_token("alicloud:quotas/templateApplications:TemplateApplications")
class TemplateApplications(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            quota_category: Optional[pulumi.Input[builtins.str]] = None,
            reason: Optional[pulumi.Input[builtins.str]] = None) -> 'TemplateApplications':
        """
    ...
    @property
    @pulumi.getter(name="aliyunUids")
    def aliyun_uids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of Alibaba Cloud accounts (primary accounts) of the resource directory members to which the quota is applied.
        > **NOTE:**  Only 50 members can apply for quota increase in batch at a time. For more information about the members of the resource directory, see Query the list of all members in the resource directory.
        """
    ...
    @property
    @pulumi.getter(name="noticeType")
    def notice_type(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Whether to send notification of quota application result. Value:
        - 0 (default): No.
        - 3: Yes.
    ...
    @property
    @pulumi.getter(name="quotaCategory")
    def quota_category(self) -> pulumi.Output[builtins.str]:
        """
        The quota type. Value:
        - CommonQuota (default): Generic quota.
        - FlowControl:API rate quota.
