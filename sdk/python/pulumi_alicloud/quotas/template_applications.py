...
class TemplateApplicationsArgs:
    def __init__(__self__, *,
                 aliyun_uids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
        ...
        :param pulumi.Input[_builtins.str] env_language: The language of the quota application result notification. Value:
               - zh (default): Chinese.
               - en: English.
        :param pulumi.Input[_builtins.str] expire_time: The UTC time when the quota expires. This parameter applies only to the equity quota (WhiteListLabel).
    ...
    def aliyun_uids(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    @aliyun_uids.setter
    def aliyun_uids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
    ...
    def quota_category(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def quota_category(self, value: pulumi.Input[_builtins.str]):
...
class TemplateApplications(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="aliyunUids")
    def aliyun_uids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        The list of Alibaba Cloud accounts (primary accounts) of the resource directory members to which the quota is applied.
        > **NOTE:**  Only 50 members can apply for quota increase in batch at a time. For more information about the members of the resource directory, see Query the list of all members in the resource directory.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="noticeType")
    def notice_type(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Whether to send notification of quota application result. Value:
        - 0 (default): No.
        - 3: Yes.
    ...
    @_builtins.property
    @pulumi.getter(name="quotaCategory")
    def quota_category(self) -> pulumi.Output[_builtins.str]:
        """
        The quota type. Value:
        - CommonQuota (default): Generic quota.
        - FlowControl:API rate quota.
