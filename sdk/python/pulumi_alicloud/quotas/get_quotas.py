...
class GetQuotasResult:
    ...
    def group_code(self) -> Optional[_builtins.str]:
...
def get_quotas(dimensions: Optional[Sequence[Union['GetQuotasDimensionArgs', 'GetQuotasDimensionArgsDict']]] = None,
    ...
    :param _builtins.str quota_category: The category of quota. Valid Values: `FlowControl` and `CommonQuota`, `WhiteListLabel`.
    :param _builtins.str sort_field: Cloud service ECS specification quota supports setting sorting fields. Valid Values: `TIME`, `TOTAL` and `RESERVED`.
    :param _builtins.str sort_order: Ranking of cloud service ECS specification quota support. Valid Values: `Ascending` and `Descending`.
    """
    __args__ = dict()
