...
class GetQuotasResult:
    ...
    def group_code(self) -> Optional[builtins.str]:
...
def get_quotas(dimensions: Optional[Sequence[Union['GetQuotasDimensionArgs', 'GetQuotasDimensionArgsDict']]] = None,
               group_code: Optional[builtins.str] = None,
    ...
    :param builtins.str group_code: The group code.
    :param builtins.str key_word: The key word.
    :param builtins.str name_regex: A regex string to filter results by Quota name.
    ...
    :param builtins.str quota_category: The category of quota. Valid Values: `FlowControl` and `CommonQuota`, `WhiteListLabel`.
    :param builtins.str sort_field: Cloud service ECS specification quota supports setting sorting fields. Valid Values: `TIME`, `TOTAL` and `RESERVED`.
    :param builtins.str sort_order: Ranking of cloud service ECS specification quota support. Valid Values: `Ascending` and `Descending`.
    """
    __args__ = dict()
...
def get_quotas_output(dimensions: Optional[pulumi.Input[Optional[Sequence[Union['GetQuotasDimensionArgs', 'GetQuotasDimensionArgsDict']]]]] = None,
                      group_code: Optional[pulumi.Input[Optional[builtins.str]]] = None,
