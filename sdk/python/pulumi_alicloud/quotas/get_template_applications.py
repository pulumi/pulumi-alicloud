...
class GetTemplateApplicationsResult:
    ...
    def batch_quota_application_id(self) -> Optional[builtins.str]:
        """
...
def get_template_applications(batch_quota_application_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Template Applications IDs.
...
def get_template_applications_output(batch_quota_application_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
