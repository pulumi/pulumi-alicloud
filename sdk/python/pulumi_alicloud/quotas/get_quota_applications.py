...
class GetQuotaApplicationsResult:
    ...
    def quota_action_code(self) -> Optional[builtins.str]:
        return pulumi.get(self, "quota_action_code")

    @property
    @pulumi.getter(name="quotaCategory")
    def quota_category(self) -> Optional[builtins.str]:
...
def get_quota_applications(dimensions: Optional[Sequence[Union['GetQuotaApplicationsDimensionArgs', 'GetQuotaApplicationsDimensionArgsDict']]] = None,
                           ...
                           product_code: Optional[builtins.str] = None,
                           quota_action_code: Optional[builtins.str] = None,
                           quota_category: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Application Info IDs.
    ...
    :param builtins.str quota_category: The quota category. Valid values: `CommonQuota`, `FlowControl`, `WhiteListLabel`.
    :param builtins.str status: The status of the quota application. Valid Values: `Agree`, `Disagree` and `Process`.
    """
    __args__ = dict()
...
def get_quota_applications_output(dimensions: Optional[pulumi.Input[Optional[Sequence[Union['GetQuotaApplicationsDimensionArgs', 'GetQuotaApplicationsDimensionArgsDict']]]]] = None,
                                  ...
                                  quota_action_code: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  quota_category: Optional[pulumi.Input[Optional[builtins.str]]] = None,
