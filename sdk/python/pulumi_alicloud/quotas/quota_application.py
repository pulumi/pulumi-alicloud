...
class QuotaApplicationArgs:
    def __init__(__self__, *,
                 desire_value: pulumi.Input[builtins.float],
                 product_code: pulumi.Input[builtins.str],
                 quota_action_code: pulumi.Input[builtins.str],
                 reason: pulumi.Input[builtins.str],
                 audit_mode: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 quota_category: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a QuotaApplication resource.
        :param pulumi.Input[builtins.float] desire_value: The desire value of the quota application.
        :param pulumi.Input[builtins.str] product_code: The product code.
        :param pulumi.Input[builtins.str] quota_action_code: The ID of quota action.
        :param pulumi.Input[builtins.str] reason: The reason of the quota application.
        :param pulumi.Input[builtins.str] audit_mode: This parameter is discontinued and is not recommended. The mode in which you want the application to be reviewed. Valid values:
        ...
        :param pulumi.Input[builtins.str] effective_time: The effective time of the quota application.
        :param pulumi.Input[builtins.str] env_language: The language of the quota alert notification. Value:
               - zh (default): Chinese.
               - en: English.
        :param pulumi.Input[builtins.str] expire_time: The expired time of the quota application.
        :param pulumi.Input[builtins.int] notice_type: Specifies whether to send a notification about the application result. Valid values:0: sends a notification about the application result.3: A notification about the application result is sent.
        :param pulumi.Input[builtins.str] quota_category: The quota type.
    ...
    def desire_value(self) -> pulumi.Input[builtins.float]:
        """
    ...
    @desire_value.setter
    def desire_value(self, value: pulumi.Input[builtins.float]):
    ...
    def quota_action_code(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def quota_action_code(self, value: pulumi.Input[builtins.str]):
    ...
    def audit_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @audit_mode.setter
    def audit_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def quota_category(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The quota type.
        - CommonQuota (default): Generic quota.
        - FlowControl:API rate quota.
    ...
    def quota_category(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _QuotaApplicationState:
    def __init__(__self__, *,
                 approve_value: Optional[pulumi.Input[builtins.str]] = None,
                 audit_mode: Optional[pulumi.Input[builtins.str]] = None,
                 audit_reason: Optional[pulumi.Input[builtins.str]] = None,
                 create_time: Optional[pulumi.Input[builtins.str]] = None,
                 desire_value: Optional[pulumi.Input[builtins.float]] = None,
                 dimensions: Optional[pulumi.Input[Sequence[pulumi.Input['QuotaApplicationDimensionArgs']]]] = None,
                 effective_time: Optional[pulumi.Input[builtins.str]] = None,
                 env_language: Optional[pulumi.Input[builtins.str]] = None,
                 expire_time: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 quota_action_code: Optional[pulumi.Input[builtins.str]] = None,
                 quota_category: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] approve_value: The approve value of the quota application.
        :param pulumi.Input[builtins.str] audit_mode: This parameter is discontinued and is not recommended. The mode in which you want the application to be reviewed. Valid values:
               - Sync: The application is reviewed in a synchronous manner. Quota Center automatically reviews the application. The result is returned immediately after you submit the application. However, the chance of an approval for an application that is reviewed in Sync mode is lower than the chance of an approval for an application that is reviewed in Async mode. The validity period of the new quota value is 1 hour.
               - Async: The application is reviewed in an asynchronous manner. An Alibaba Cloud support engineer reviews the application. The chance of an approval for an application that is reviewed in Async mode is higher than the chance of an approval for an application that is reviewed in Sync mode. The validity period of the new quota value is one month.
        :param pulumi.Input[builtins.str] audit_reason: The audit reason.
        :param pulumi.Input[builtins.str] create_time: Resource attribute field representing creation time.
        :param pulumi.Input[builtins.float] desire_value: The desire value of the quota application.
        :param pulumi.Input[Sequence[pulumi.Input['QuotaApplicationDimensionArgs']]] dimensions: QuotaDimensions. See `dimensions` below.
        :param pulumi.Input[builtins.str] effective_time: The effective time of the quota application.
        :param pulumi.Input[builtins.str] env_language: The language of the quota alert notification. Value:
        ...
        :param pulumi.Input[builtins.str] quota_category: The quota type.
               ...
               - FlowControl:API rate quota.
               - WhiteListLabel: Equity quota.
        :param pulumi.Input[builtins.str] quota_description: The description of the quota application.
        :param pulumi.Input[builtins.str] quota_name: The name of the quota application.
        :param pulumi.Input[builtins.str] quota_unit: The unit of the quota application.
        :param pulumi.Input[builtins.str] reason: The reason of the quota application.
        :param pulumi.Input[builtins.str] status: Application Status:
               - Disagree: reject.
               - Agree: Approved.
    ...
    def approve_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def approve_value(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="desireValue")
    def desire_value(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The desire value of the quota application.
        """
        return pulumi.get(self, "desire_value")
    ...
    @desire_value.setter
    def desire_value(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "desire_value", value)
    ...
    @property
    @pulumi.getter(name="quotaActionCode")
    def quota_action_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of quota action.
        """
        return pulumi.get(self, "quota_action_code")
    ...
    @quota_action_code.setter
    def quota_action_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "quota_action_code", value)
...
class QuotaApplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            quota_unit: Optional[pulumi.Input[builtins.str]] = None,
            reason: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'QuotaApplication':
        """
    ...
    @property
    @pulumi.getter(name="approveValue")
    def approve_value(self) -> pulumi.Output[builtins.str]:
        """
        The approve value of the quota application.
        """
        return pulumi.get(self, "approve_value")
    ...
    @property
    @pulumi.getter(name="auditMode")
    def audit_mode(self) -> pulumi.Output[builtins.str]:
        """
        This parameter is discontinued and is not recommended. The mode in which you want the application to be reviewed. Valid values:
        - Sync: The application is reviewed in a synchronous manner. Quota Center automatically reviews the application. The result is returned immediately after you submit the application. However, the chance of an approval for an application that is reviewed in Sync mode is lower than the chance of an approval for an application that is reviewed in Async mode. The validity period of the new quota value is 1 hour.
        - Async: The application is reviewed in an asynchronous manner. An Alibaba Cloud support engineer reviews the application. The chance of an approval for an application that is reviewed in Async mode is higher than the chance of an approval for an application that is reviewed in Sync mode. The validity period of the new quota value is one month.
    ...
    @property
    @pulumi.getter(name="auditReason")
    def audit_reason(self) -> pulumi.Output[builtins.str]:
        """
        The audit reason.
        """
        return pulumi.get(self, "audit_reason")
    ...
    @property
    @pulumi.getter(name="desireValue")
    def desire_value(self) -> pulumi.Output[builtins.float]:
        """
        The desire value of the quota application.
        """
        return pulumi.get(self, "desire_value")
    ...
    @property
    @pulumi.getter(name="envLanguage")
    def env_language(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The language of the quota alert notification. Value:
        - zh (default): Chinese.
        - en: English.
    ...
    @property
    @pulumi.getter(name="expireTime")
    def expire_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The expired time of the quota application.
        """
        return pulumi.get(self, "expire_time")
    ...
    @property
    @pulumi.getter(name="noticeType")
    def notice_type(self) -> pulumi.Output[builtins.int]:
        """
        Specifies whether to send a notification about the application result. Valid values:0: sends a notification about the application result.3: A notification about the application result is sent.
        """
        return pulumi.get(self, "notice_type")
    ...
    @property
    @pulumi.getter(name="quotaActionCode")
    def quota_action_code(self) -> pulumi.Output[builtins.str]:
        """
        The ID of quota action.
        """
        return pulumi.get(self, "quota_action_code")
    ...
    @property
    @pulumi.getter(name="quotaCategory")
    def quota_category(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The quota type.
        - CommonQuota (default): Generic quota.
        - FlowControl:API rate quota.
    ...
    @property
    @pulumi.getter(name="quotaDescription")
    def quota_description(self) -> pulumi.Output[builtins.str]:
        """
        The description of the quota application.
        """
        return pulumi.get(self, "quota_description")
    ...
    @property
    @pulumi.getter(name="quotaName")
    def quota_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the quota application.
        """
        return pulumi.get(self, "quota_name")
    ...
    @property
    @pulumi.getter(name="quotaUnit")
    def quota_unit(self) -> pulumi.Output[builtins.str]:
        """
        The unit of the quota application.
        """
        return pulumi.get(self, "quota_unit")
