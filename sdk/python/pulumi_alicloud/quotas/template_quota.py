...
class TemplateQuotaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] env_language: The language of the quota alert notification. Value:
               - zh: Chinese.
               - en: English.
        :param pulumi.Input[_builtins.str] expire_time: The UTC time when the quota expires.
        :param pulumi.Input[_builtins.int] notice_type: Whether to notify the result of quota promotion application. Value:
               - 0: No.
               - 3: Yes.
        :param pulumi.Input[_builtins.str] quota_category: Type of quota. Value:
...
class TemplateQuota(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="envLanguage")
    def env_language(self) -> pulumi.Output[_builtins.str]:
        """
        The language of the quota alert notification. Value:
        - zh: Chinese.
        - en: English.
