...
class TemplateQuotaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] desire_value: Quota application value.
        :param pulumi.Input[builtins.str] product_code: The abbreviation of the cloud service name.
        :param pulumi.Input[builtins.str] quota_action_code: The quota ID.
        :param pulumi.Input[Sequence[pulumi.Input['TemplateQuotaDimensionArgs']]] dimensions: The Quota Dimensions. See `dimensions` below.
        :param pulumi.Input[builtins.str] effective_time: The UTC time when the quota takes effect.
        :param pulumi.Input[builtins.str] env_language: The language of the quota alert notification. Value:
               - zh: Chinese.
               - en: English.
        :param pulumi.Input[builtins.str] expire_time: The UTC time when the quota expires.
        :param pulumi.Input[builtins.int] notice_type: Whether to notify the result of quota promotion application. Value:
               - 0: No.
               - 3: Yes.
        :param pulumi.Input[builtins.str] quota_category: Type of quota. Value:
...
class TemplateQuota(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            product_code: Optional[pulumi.Input[builtins.str]] = None,
            quota_action_code: Optional[pulumi.Input[builtins.str]] = None,
            quota_category: Optional[pulumi.Input[builtins.str]] = None) -> 'TemplateQuota':
        """
    ...
    @property
    @pulumi.getter(name="envLanguage")
    def env_language(self) -> pulumi.Output[builtins.str]:
        """
        The language of the quota alert notification. Value:
        - zh: Chinese.
        - en: English.
