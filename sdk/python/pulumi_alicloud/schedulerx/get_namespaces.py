...
def get_namespaces(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:schedulerx/getNamespaces:getNamespaces', __args__, opts=opts, typ=GetNamespacesResult).value
...
def get_namespaces_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:schedulerx/getNamespaces:getNamespaces', __args__, opts=opts, typ=GetNamespacesResult)
