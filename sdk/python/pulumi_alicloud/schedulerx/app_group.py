...
class AppGroupArgs:
    def __init__(__self__, *,
                 ...
                 app_type: Optional[pulumi.Input[builtins.int]] = None,
                 app_version: Optional[pulumi.Input[builtins.str]] = None,
                 delete_jobs: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enable_log: Optional[pulumi.Input[builtins.bool]] = None,
                 max_concurrency: Optional[pulumi.Input[builtins.int]] = None,
                 max_jobs: Optional[pulumi.Input[builtins.int]] = None,
                 monitor_config_json: Optional[pulumi.Input[builtins.str]] = None,
                 monitor_contacts_json: Optional[pulumi.Input[builtins.str]] = None,
                 namespace_source: Optional[pulumi.Input[builtins.str]] = None,
                 schedule_busy_workers: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a AppGroup resource.
        :param pulumi.Input[builtins.str] app_name: Application Name
        :param pulumi.Input[builtins.str] group_id: Application ID
        :param pulumi.Input[builtins.str] namespace: The namespace ID, which is obtained on the namespace page of the console.
        :param pulumi.Input[builtins.str] namespace_name: The namespace name.
        :param pulumi.Input[builtins.int] app_type: Application type.
               - 1, general application.
               - 2, k8s application.
        :param pulumi.Input[builtins.str] app_version: Application Version, 1: Basic Edition, 2: Professional Edition
        :param pulumi.Input[builtins.bool] delete_jobs: Whether to delete the task in the application Group. The values are as follows:
        :param pulumi.Input[builtins.str] description: Application Description
        :param pulumi.Input[builtins.bool] enable_log: Whether to enable the log.
               - true: On
               - false: Close
        :param pulumi.Input[builtins.int] max_concurrency: The maximum number of instances running at the same time. The default value is 1, that is, the last trigger is not completed, and the next trigger will not be performed even at the running time.
        :param pulumi.Input[builtins.int] max_jobs: Application Grouping Configurable Maximum Number of Tasks
        :param pulumi.Input[builtins.str] monitor_config_json: Alarm configuration JSON field. For more information about this field, see **Request Parameters * *.
        :param pulumi.Input[builtins.str] monitor_contacts_json: Alarm contact JSON format.
        :param pulumi.Input[builtins.str] namespace_source: Not supported for the time being, no need to fill in.
        :param pulumi.Input[builtins.bool] schedule_busy_workers: Whether to schedule a busy machine.
        """
    ...
    def app_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Application type.
        - 1, general application.
        - 2, k8s application.
    ...
    @app_type.setter
    def app_type(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "app_type", value)

    @property
    @pulumi.getter(name="appVersion")
    def app_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @app_version.setter
    def app_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "app_version", value)

    @property
    @pulumi.getter(name="deleteJobs")
    def delete_jobs(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @delete_jobs.setter
    def delete_jobs(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def max_jobs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @max_jobs.setter
    def max_jobs(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_jobs", value)

    @property
    @pulumi.getter(name="monitorConfigJson")
    def monitor_config_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def monitor_config_json(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "monitor_config_json", value)

    @property
    @pulumi.getter(name="monitorContactsJson")
    def monitor_contacts_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def monitor_contacts_json(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def schedule_busy_workers(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def schedule_busy_workers(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AppGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace_name: Optional[pulumi.Input[builtins.str]] = None,
            namespace_source: Optional[pulumi.Input[builtins.str]] = None,
            schedule_busy_workers: Optional[pulumi.Input[builtins.bool]] = None) -> 'AppGroup':
        """
    ...
    @property
    @pulumi.getter(name="appType")
    def app_type(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Application type.
        - 1, general application.
        - 2, k8s application.
    ...
    @property
    @pulumi.getter(name="appVersion")
    def app_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Application Version, 1: Basic Edition, 2: Professional Edition
        """
        return pulumi.get(self, "app_version")
    ...
    @property
    @pulumi.getter(name="deleteJobs")
    def delete_jobs(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to delete the task in the application Group. The values are as follows:
        """
        return pulumi.get(self, "delete_jobs")
    ...
    @property
    @pulumi.getter(name="enableLog")
    def enable_log(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable the log.
        - true: On
        - false: Close
    ...
    @property
    @pulumi.getter(name="maxJobs")
    def max_jobs(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Application Grouping Configurable Maximum Number of Tasks
        """
        return pulumi.get(self, "max_jobs")
    ...
    @property
    @pulumi.getter(name="monitorConfigJson")
    def monitor_config_json(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Alarm configuration JSON field. For more information about this field, see **Request Parameters * *.
        """
        return pulumi.get(self, "monitor_config_json")
    ...
    @property
    @pulumi.getter(name="monitorContactsJson")
    def monitor_contacts_json(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Alarm contact JSON format.
        """
        return pulumi.get(self, "monitor_contacts_json")
    ...
    @property
    @pulumi.getter(name="scheduleBusyWorkers")
    def schedule_busy_workers(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to schedule a busy machine.
        """
        return pulumi.get(self, "schedule_busy_workers")
