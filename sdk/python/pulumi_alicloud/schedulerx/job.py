...
class JobArgs:
    def __init__(__self__, *,
                 execute_mode: pulumi.Input[builtins.str],
                 ...
                 max_attempt: Optional[pulumi.Input[builtins.int]] = None,
                 max_concurrency: Optional[pulumi.Input[builtins.str]] = None,
                 namespace_source: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 success_notice_enable: Optional[pulumi.Input[builtins.bool]] = None,
                 task_dispatch_mode: Optional[pulumi.Input[builtins.str]] = None,
                 template: Optional[pulumi.Input[builtins.str]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None,
                 x_attrs: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Job resource.
        :param pulumi.Input[builtins.str] execute_mode: Task execution mode, the possible results are as follows:
        :param pulumi.Input[builtins.str] group_id: The application ID, which is obtained from the **application management** page of the console.
        :param pulumi.Input[builtins.str] job_name: JobName
        :param pulumi.Input[builtins.str] job_type: Job Type
        :param pulumi.Input[builtins.str] namespace: Namespace, which is obtained on the `Namespace` page of the console.
        :param pulumi.Input['JobTimeConfigArgs'] time_config: Time configuration information See `time_config` below.
        :param pulumi.Input[builtins.int] attempt_interval: Error retry interval, unit s, default value 30.
        :param pulumi.Input[builtins.str] class_name: Full path of the task interface class.
               
               This field is available only when your task is of the Java task type.
        :param pulumi.Input[builtins.str] content: The script code of the python, shell, and go task types.
        :param pulumi.Input[builtins.str] description: Task description.
        :param pulumi.Input[builtins.int] fail_times: Number of consecutive failed alarms
        ...
        :param pulumi.Input[builtins.int] max_attempt: The maximum number of error retries, which is set based on business requirements. The default value is 0.
        :param pulumi.Input[builtins.str] max_concurrency: The maximum number of instances running at the same time. The default value is 1, that is, the last trigger is not completed, and the next trigger will not be performed even at the running time.
        :param pulumi.Input[builtins.str] namespace_source: Special third parties are required.
        :param pulumi.Input[builtins.str] parameters: User-defined parameters, which can be obtained at runtime.
        :param pulumi.Input[builtins.str] status: Task status. The values are as follows:
        :param pulumi.Input[builtins.bool] success_notice_enable: Success Notification Switch
        :param pulumi.Input[builtins.str] task_dispatch_mode: Advanced configuration of parallel grid tasks, push model or pull model
        :param pulumi.Input[builtins.str] template: K8s task type custom task template
        :param pulumi.Input[builtins.str] timezone: Time Zone
        :param pulumi.Input[builtins.str] x_attrs: Task Extension Field
        """
    ...
    def execute_mode(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @execute_mode.setter
    def execute_mode(self, value: pulumi.Input[builtins.str]):
    ...
    def attempt_interval(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def attempt_interval(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def fail_times(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @fail_times.setter
    def fail_times(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def max_attempt(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @max_attempt.setter
    def max_attempt(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def namespace_source(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def namespace_source(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def success_notice_enable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def success_notice_enable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "success_notice_enable", value)

    @property
    @pulumi.getter(name="taskDispatchMode")
    def task_dispatch_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def task_dispatch_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def x_attrs(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @x_attrs.setter
    def x_attrs(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _JobState:
    def __init__(__self__, *,
                 ...
                 content: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 execute_mode: Optional[pulumi.Input[builtins.str]] = None,
                 fail_times: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] fail_times: Number of consecutive failed alarms
        :param pulumi.Input[builtins.str] group_id: The application ID, which is obtained from the **application management** page of the console.
        :param pulumi.Input[builtins.int] job_id: JobId
        :param pulumi.Input['JobJobMonitorInfoArgs'] job_monitor_info: Task monitoring information See `job_monitor_info` below.
        :param pulumi.Input[builtins.str] job_name: JobName
        :param pulumi.Input[builtins.str] job_type: Job Type
        :param pulumi.Input['JobMapTaskXattrsArgs'] map_task_xattrs: Advanced configuration, limited to parallel computing, memory grid, and grid computing. See `map_task_xattrs` below.
    ...
    @property
    @pulumi.getter(name="executeMode")
    def execute_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Task execution mode, the possible results are as follows:
        """
        return pulumi.get(self, "execute_mode")
    ...
    @execute_mode.setter
    def execute_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "execute_mode", value)
...
class Job(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_config: Optional[pulumi.Input[Union['JobTimeConfigArgs', 'JobTimeConfigArgsDict']]] = None,
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            x_attrs: Optional[pulumi.Input[builtins.str]] = None) -> 'Job':
        """
    ...
    @property
    @pulumi.getter(name="attemptInterval")
    def attempt_interval(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Error retry interval, unit s, default value 30.
        """
        return pulumi.get(self, "attempt_interval")
    ...
    @property
    @pulumi.getter(name="executeMode")
    def execute_mode(self) -> pulumi.Output[builtins.str]:
        """
        Task execution mode, the possible results are as follows:
        """
        return pulumi.get(self, "execute_mode")
    ...
    @property
    @pulumi.getter(name="failTimes")
    def fail_times(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of consecutive failed alarms
        """
        return pulumi.get(self, "fail_times")
    ...
    @property
    @pulumi.getter(name="maxAttempt")
    def max_attempt(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum number of error retries, which is set based on business requirements. The default value is 0.
        """
        return pulumi.get(self, "max_attempt")
    ...
    @property
    @pulumi.getter(name="namespaceSource")
    def namespace_source(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Special third parties are required.
        """
        return pulumi.get(self, "namespace_source")
    ...
    @property
    @pulumi.getter
    def parameters(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        User-defined parameters, which can be obtained at runtime.
        """
        return pulumi.get(self, "parameters")
    ...
    @property
    @pulumi.getter(name="successNoticeEnable")
    def success_notice_enable(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Success Notification Switch
        """
        return pulumi.get(self, "success_notice_enable")
    ...
    @property
    @pulumi.getter(name="taskDispatchMode")
    def task_dispatch_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Advanced configuration of parallel grid tasks, push model or pull model
        """
        return pulumi.get(self, "task_dispatch_mode")
    ...
    @property
    @pulumi.getter(name="xAttrs")
    def x_attrs(self) -> pulumi.Output[builtins.str]:
        """
        Task Extension Field
        """
        return pulumi.get(self, "x_attrs")
