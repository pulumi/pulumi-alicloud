...
if not MYPY:
    class JobJobMonitorInfoContactInfoArgsDict(TypedDict):
        ding: NotRequired[pulumi.Input[builtins.str]]
        """
        DingTalk swarm robot webhook address
        """
        user_mail: NotRequired[pulumi.Input[builtins.str]]
        """
        User Email Address
        """
        ...
        The user name
        """
        user_phone: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JobJobMonitorInfoContactInfoArgs:
    def __init__(__self__, *,
                 ding: Optional[pulumi.Input[builtins.str]] = None,
                 user_mail: Optional[pulumi.Input[builtins.str]] = None,
                 user_name: Optional[pulumi.Input[builtins.str]] = None,
                 user_phone: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ding: DingTalk swarm robot webhook address
        :param pulumi.Input[builtins.str] user_mail: User Email Address
        :param pulumi.Input[builtins.str] user_name: The user name
        :param pulumi.Input[builtins.str] user_phone: The user's mobile phone number
        """
        if ding is not None:
    ...
    @property
    @pulumi.getter
    def ding(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        DingTalk swarm robot webhook address
        """
    ...
    @ding.setter
    def ding(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_phone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The user's mobile phone number
        """
    ...
    @user_phone.setter
    def user_phone(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_phone", value)


if not MYPY:
    class JobJobMonitorInfoMonitorConfigArgsDict(TypedDict):
        fail_enable: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enable failure alarm
        """
        miss_worker_enable: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether no available Machine alarm is on
        """
        send_channel: NotRequired[pulumi.Input[builtins.str]]
        """
        Alarm sending form
        - sms: sms alarm
        - phone: phone alarm
        ...
        """
        timeout_enable: NotRequired[pulumi.Input[builtins.bool]]
        """
        Time-out alarm switch. The values are as follows:
        """
        timeout_kill_enable: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class JobJobMonitorInfoMonitorConfigArgs:
    def __init__(__self__, *,
                 fail_enable: Optional[pulumi.Input[builtins.bool]] = None,
                 miss_worker_enable: Optional[pulumi.Input[builtins.bool]] = None,
                 send_channel: Optional[pulumi.Input[builtins.str]] = None,
                 timeout: Optional[pulumi.Input[builtins.int]] = None,
                 timeout_enable: Optional[pulumi.Input[builtins.bool]] = None,
                 timeout_kill_enable: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] fail_enable: Enable failure alarm
        :param pulumi.Input[builtins.bool] miss_worker_enable: Whether no available Machine alarm is on
        :param pulumi.Input[builtins.str] send_channel: Alarm sending form
               - sms: sms alarm
               - phone: phone alarm
               - mail: mail alarm
               - webhook:webhook alarm
        :param pulumi.Input[builtins.int] timeout: Timeout threshold, unit s, default 7200.
        :param pulumi.Input[builtins.bool] timeout_enable: Time-out alarm switch. The values are as follows:
        :param pulumi.Input[builtins.bool] timeout_kill_enable: The trigger switch is terminated by timeout and is turned off by default.
        """
    ...
    def fail_enable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable failure alarm
        """
    ...
    @fail_enable.setter
    def fail_enable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "fail_enable", value)

    @property
    @pulumi.getter(name="missWorkerEnable")
    def miss_worker_enable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether no available Machine alarm is on
        """
    ...
    def miss_worker_enable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "miss_worker_enable", value)

    @property
    @pulumi.getter(name="sendChannel")
    def send_channel(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Alarm sending form
        - sms: sms alarm
        - phone: phone alarm
    ...
    @send_channel.setter
    def send_channel(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def timeout_enable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Time-out alarm switch. The values are as follows:
        """
    ...
    def timeout_enable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "timeout_enable", value)

    @property
    @pulumi.getter(name="timeoutKillEnable")
    def timeout_kill_enable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        The trigger switch is terminated by timeout and is turned off by default.
        """
    ...
    def timeout_kill_enable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "timeout_kill_enable", value)


if not MYPY:
    class JobMapTaskXattrsArgsDict(TypedDict):
        consumer_size: NotRequired[pulumi.Input[builtins.int]]
        """
        The number of threads to execute a single trigger. The default value is 5.
        """
        dispatcher_size: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        queue_size: NotRequired[pulumi.Input[builtins.int]]
        """
        The upper limit of the sub-task queue cache. The default value is 10000.
        """
        task_attempt_interval: NotRequired[pulumi.Input[builtins.int]]
        """
        Subtask failure retry interval.
        """
        task_max_attempt: NotRequired[pulumi.Input[builtins.int]]
        """
...
class JobMapTaskXattrsArgs:
    def __init__(__self__, *,
                 consumer_size: Optional[pulumi.Input[builtins.int]] = None,
                 dispatcher_size: Optional[pulumi.Input[builtins.int]] = None,
                 page_size: Optional[pulumi.Input[builtins.int]] = None,
                 queue_size: Optional[pulumi.Input[builtins.int]] = None,
                 task_attempt_interval: Optional[pulumi.Input[builtins.int]] = None,
                 task_max_attempt: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] consumer_size: The number of threads to execute a single trigger. The default value is 5.
        :param pulumi.Input[builtins.int] dispatcher_size: The number of subtask distribution threads. The default value is 5.
        :param pulumi.Input[builtins.int] page_size: The number of sub-tasks pulled by a parallel task at a time. The default value is 100.
        :param pulumi.Input[builtins.int] queue_size: The upper limit of the sub-task queue cache. The default value is 10000.
        :param pulumi.Input[builtins.int] task_attempt_interval: Subtask failure retry interval.
        :param pulumi.Input[builtins.int] task_max_attempt: The number of failed sub-task retries.
        """
    ...
    def consumer_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of threads to execute a single trigger. The default value is 5.
        """
    ...
    def consumer_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "consumer_size", value)

    @property
    @pulumi.getter(name="dispatcherSize")
    def dispatcher_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of subtask distribution threads. The default value is 5.
        """
    ...
    def dispatcher_size(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def queue_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The upper limit of the sub-task queue cache. The default value is 10000.
        """
    ...
    @queue_size.setter
    def queue_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "queue_size", value)

    @property
    @pulumi.getter(name="taskAttemptInterval")
    def task_attempt_interval(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Subtask failure retry interval.
        """
    ...
    def task_attempt_interval(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "task_attempt_interval", value)

    @property
    @pulumi.getter(name="taskMaxAttempt")
    def task_max_attempt(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of failed sub-task retries.
        """
    ...
    def task_max_attempt(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "task_max_attempt", value)


if not MYPY:
    class JobTimeConfigArgsDict(TypedDict):
        time_type: pulumi.Input[builtins.int]
        """
        Time configuration type. Currently, the following time types are supported:
        """
        calendar: NotRequired[pulumi.Input[builtins.str]]
        """
        The cron type can optionally fill in a custom calendar.
        """
        data_offset: NotRequired[pulumi.Input[builtins.int]]
        """
        Cron type can choose time offset, unit s.
        """
        time_expression: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JobTimeConfigArgs:
    def __init__(__self__, *,
                 time_type: pulumi.Input[builtins.int],
                 calendar: Optional[pulumi.Input[builtins.str]] = None,
                 data_offset: Optional[pulumi.Input[builtins.int]] = None,
                 time_expression: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] time_type: Time configuration type. Currently, the following time types are supported:
        :param pulumi.Input[builtins.str] calendar: The cron type can optionally fill in a custom calendar.
        :param pulumi.Input[builtins.int] data_offset: Cron type can choose time offset, unit s.
        :param pulumi.Input[builtins.str] time_expression: Time expressions. Currently, the following types of time expressions are supported:
        """
    ...
    def time_type(self) -> pulumi.Input[builtins.int]:
        """
        Time configuration type. Currently, the following time types are supported:
        """
    ...
    @time_type.setter
    def time_type(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "time_type", value)

    @property
    @pulumi.getter
    def calendar(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The cron type can optionally fill in a custom calendar.
        """
    ...
    @calendar.setter
    def calendar(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "calendar", value)

    @property
    @pulumi.getter(name="dataOffset")
    def data_offset(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Cron type can choose time offset, unit s.
        """
    ...
    @data_offset.setter
    def data_offset(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "data_offset", value)

    @property
    @pulumi.getter(name="timeExpression")
    def time_expression(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Time expressions. Currently, the following types of time expressions are supported:
        """
    ...
    def time_expression(self, value: Optional[pulumi.Input[builtins.str]]):
