...
class CallbackArgs:
    def __init__(__self__, *,
                 callback_name: pulumi.Input[builtins.str],
                 callback_suggestions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 callback_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 callback_url: pulumi.Input[builtins.str],
                 crypt_type: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Callback resource.
        :param pulumi.Input[builtins.str] callback_name: The Callback name defined by the customer. It can contain no more than 20 characters in Chinese, English, underscore (_), and digits.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] callback_suggestions: List of audit results supported by message notification. Value: block: confirmed violation, review: Suspected violation, review: normal.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] callback_types: A list of Callback types. Value: machineScan: Machine audit result notification, selfAudit: self-service audit notification.
        :param pulumi.Input[builtins.str] callback_url: The detection result will be called back to the url.
        :param pulumi.Input[builtins.int] crypt_type: The encryption algorithm is used to verify that the callback request is sent by the Aliyun Green Service to your business service. Value: 0:SHA256,1: SM3.
        """
    ...
    def callback_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def callback_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "callback_name", value)

    @property
    @pulumi.getter(name="callbackSuggestions")
    def callback_suggestions(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def callback_suggestions(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "callback_suggestions", value)

    @property
    @pulumi.getter(name="callbackTypes")
    def callback_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def callback_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def crypt_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @crypt_type.setter
    def crypt_type(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _CallbackState:
    def __init__(__self__, *,
                 callback_name: Optional[pulumi.Input[builtins.str]] = None,
                 callback_suggestions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 callback_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 callback_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] callback_types: A list of Callback types. Value: machineScan: Machine audit result notification, selfAudit: self-service audit notification.
        :param pulumi.Input[builtins.str] callback_url: The detection result will be called back to the url.
        :param pulumi.Input[builtins.str] create_time: The creation time of the Callback.
        :param pulumi.Input[builtins.int] crypt_type: The encryption algorithm is used to verify that the callback request is sent by the Aliyun Green Service to your business service. Value: 0:SHA256,1: SM3.
        """
    ...
    @property
    @pulumi.getter(name="callbackName")
    def callback_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Callback name defined by the customer. It can contain no more than 20 characters in Chinese, English, underscore (_), and digits.
        """
        return pulumi.get(self, "callback_name")
    ...
    @callback_name.setter
    def callback_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "callback_name", value)

    @property
    @pulumi.getter(name="callbackSuggestions")
    def callback_suggestions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of audit results supported by message notification. Value: block: confirmed violation, review: Suspected violation, review: normal.
        """
        return pulumi.get(self, "callback_suggestions")
    ...
    @callback_suggestions.setter
    def callback_suggestions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "callback_suggestions", value)

    @property
    @pulumi.getter(name="callbackTypes")
    def callback_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of Callback types. Value: machineScan: Machine audit result notification, selfAudit: self-service audit notification.
        """
        return pulumi.get(self, "callback_types")
    ...
    @callback_types.setter
    def callback_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "callback_types", value)

    @property
    @pulumi.getter(name="callbackUrl")
    def callback_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The detection result will be called back to the url.
        """
        return pulumi.get(self, "callback_url")
    ...
    @callback_url.setter
    def callback_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "callback_url", value)
...
class Callback(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            callback_url: Optional[pulumi.Input[builtins.str]] = None,
            create_time: Optional[pulumi.Input[builtins.str]] = None,
            crypt_type: Optional[pulumi.Input[builtins.int]] = None) -> 'Callback':
        """
    ...
    @property
    @pulumi.getter(name="callbackName")
    def callback_name(self) -> pulumi.Output[builtins.str]:
        """
        The Callback name defined by the customer. It can contain no more than 20 characters in Chinese, English, underscore (_), and digits.
        """
        return pulumi.get(self, "callback_name")
    ...
    @property
    @pulumi.getter(name="callbackSuggestions")
    def callback_suggestions(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of audit results supported by message notification. Value: block: confirmed violation, review: Suspected violation, review: normal.
        """
        return pulumi.get(self, "callback_suggestions")
    ...
    @property
    @pulumi.getter(name="callbackTypes")
    def callback_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of Callback types. Value: machineScan: Machine audit result notification, selfAudit: self-service audit notification.
        """
        return pulumi.get(self, "callback_types")
    ...
    @property
    @pulumi.getter(name="callbackUrl")
    def callback_url(self) -> pulumi.Output[builtins.str]:
        """
        The detection result will be called back to the url.
        """
        return pulumi.get(self, "callback_url")
    ...
    @property
    @pulumi.getter(name="cryptType")
    def crypt_type(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The encryption algorithm is used to verify that the callback request is sent by the Aliyun Green Service to your business service. Value: 0:SHA256,1: SM3.
        """
        return pulumi.get(self, "crypt_type")
