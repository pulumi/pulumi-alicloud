...
class ImageLibArgs:
    def __init__(__self__, *,
                 ...
                 image_lib_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] category: The category of the image library. Valid values: BLACK: a blacklist, WHITE: a whitelist, REVIEW: a review list
        :param pulumi.Input[builtins.str] image_lib_name: The name of the image library defined by the customer. It can contain no more than 20 characters in Chinese, English, and underscore (_).
        :param pulumi.Input[builtins.str] scene: The moderation scenario to which the custom image library applies. Valid values: PORN: pornography detection, AD: ad detection, ILLEGAL: terrorist content detection
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] biz_types: List of business scenarios. For example: ["bizTypeA", "bizTypeB", "bizTypeC"]
        :param pulumi.Input[builtins.bool] enable: Specifies whether to enable the image library. Valid values: true: Enable the image library. This is the default value. false: Disable the image library.
        """
    ...
    def image_lib_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def image_lib_name(self, value: pulumi.Input[builtins.str]):
...
class _ImageLibState:
    def __init__(__self__, *,
                 ...
                 enable: Optional[pulumi.Input[builtins.bool]] = None,
                 image_lib_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="imageLibName")
    def image_lib_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the image library defined by the customer. It can contain no more than 20 characters in Chinese, English, and underscore (_).
        """
        return pulumi.get(self, "image_lib_name")
    ...
    @image_lib_name.setter
    def image_lib_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "image_lib_name", value)
...
class ImageLib(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enable: Optional[pulumi.Input[builtins.bool]] = None,
            image_lib_name: Optional[pulumi.Input[builtins.str]] = None,
            scene: Optional[pulumi.Input[builtins.str]] = None) -> 'ImageLib':
        """
    ...
    @property
    @pulumi.getter(name="imageLibName")
    def image_lib_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the image library defined by the customer. It can contain no more than 20 characters in Chinese, English, and underscore (_).
        """
        return pulumi.get(self, "image_lib_name")
    ...
    @property
    @pulumi.getter
    def scene(self) -> pulumi.Output[builtins.str]:
        """
        The moderation scenario to which the custom image library applies. Valid values: PORN: pornography detection, AD: ad detection, ILLEGAL: terrorist content detection
        """
        return pulumi.get(self, "scene")
