...
class KeywordLibArgs:
    def __init__(__self__, *,
                 keyword_lib_name: pulumi.Input[builtins.str],
                 resource_type: pulumi.Input[builtins.str],
                 biz_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 lib_type: Optional[pulumi.Input[builtins.str]] = None,
                 match_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a KeywordLib resource.
        :param pulumi.Input[builtins.str] keyword_lib_name: The name of the keyword library defined by the customer. It can contain no more than 20 characters in Chinese, English, and underscore (_).
        :param pulumi.Input[builtins.str] resource_type: The moderation scenario to which the text library applies. Valid values:TEXT: text anti-spam、IMAGE: ad violation detection、VOICE: audio anti-spam
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] biz_types: The business scenario. Example:["bizTypeA","bizTypeB"]
        :param pulumi.Input[builtins.str] category: The category of the text library. Valid values: BLACK: a blacklist. WHITE: a whitelist. REVIEW: a review list
        :param pulumi.Input[builtins.bool] enable: Specifies whether to enable text library.true: Enable the text library. This is the default value.false: Disable the text library.
        :param pulumi.Input[builtins.str] lang: Language.
        :param pulumi.Input[builtins.str] language: Language used by the text Library
        :param pulumi.Input[builtins.str] lib_type: The category of the text library in each moderation scenario. Valid values: textKeyword: a text library against which terms in text are matched. similarText: a text library against which text patterns are matched. textKeyword: a text library against which terms extracted from images are matched. voiceText: a text library against which terms converted from audio are matched.
        :param pulumi.Input[builtins.str] match_mode: The matching method. Valid values:fuzzy: fuzzy match precise: exact match
        """
    ...
    def keyword_lib_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def keyword_lib_name(self, value: pulumi.Input[builtins.str]):
    ...
    def biz_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @biz_types.setter
    def biz_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def lib_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The category of the text library in each moderation scenario. Valid values: textKeyword: a text library against which terms in text are matched. similarText: a text library against which text patterns are matched. textKeyword: a text library against which terms extracted from images are matched. voiceText: a text library against which terms converted from audio are matched.
        """
    ...
    @lib_type.setter
    def lib_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _KeywordLibState:
    def __init__(__self__, *,
                 ...
                 category: Optional[pulumi.Input[builtins.str]] = None,
                 enable: Optional[pulumi.Input[builtins.bool]] = None,
                 keyword_lib_name: Optional[pulumi.Input[builtins.str]] = None,
                 lang: Optional[pulumi.Input[builtins.str]] = None,
                 language: Optional[pulumi.Input[builtins.str]] = None,
                 lib_type: Optional[pulumi.Input[builtins.str]] = None,
                 match_mode: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="keywordLibName")
    def keyword_lib_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the keyword library defined by the customer. It can contain no more than 20 characters in Chinese, English, and underscore (_).
        """
        return pulumi.get(self, "keyword_lib_name")
    ...
    @keyword_lib_name.setter
    def keyword_lib_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "keyword_lib_name", value)
...
class KeywordLib(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            lib_type: Optional[pulumi.Input[builtins.str]] = None,
            match_mode: Optional[pulumi.Input[builtins.str]] = None,
            resource_type: Optional[pulumi.Input[builtins.str]] = None) -> 'KeywordLib':
        """
    ...
    @property
    @pulumi.getter(name="bizTypes")
    def biz_types(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The business scenario. Example:["bizTypeA","bizTypeB"]
        """
        return pulumi.get(self, "biz_types")
    ...
    @property
    @pulumi.getter(name="keywordLibName")
    def keyword_lib_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the keyword library defined by the customer. It can contain no more than 20 characters in Chinese, English, and underscore (_).
        """
        return pulumi.get(self, "keyword_lib_name")
    ...
    @property
    @pulumi.getter(name="libType")
    def lib_type(self) -> pulumi.Output[builtins.str]:
        """
        The category of the text library in each moderation scenario. Valid values: textKeyword: a text library against which terms in text are matched. similarText: a text library against which text patterns are matched. textKeyword: a text library against which terms extracted from images are matched. voiceText: a text library against which terms converted from audio are matched.
        """
        return pulumi.get(self, "lib_type")
