...
class OssStockTaskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] audio_opened: oss stock scan task detect audio. true: scan audio, false: do not scan audio
        :param pulumi.Input[_builtins.int] audio_scan_limit: The upper limit of voice scan in the oss stock scan task. The default value is 1000/Bucket.
        :param pulumi.Input[_builtins.str] audio_scenes: The audio detection scenarios included in the oss stock scan task. Set the value to antispam.
        :param pulumi.Input[_builtins.str] auto_freeze_type: Automatic freeze type. Value: acl: modify permissions, copy: Move files
        :param pulumi.Input[_builtins.str] biz_type: Business scenarios used by the oss stock scan task
        :param pulumi.Input[_builtins.str] buckets: The bucket configuration list of the oss stock scan task. Example:[{"Bucket":"bucket_01","Selected":true,"Prefixes":["img/test_"],"Type":"exclude"}]
        :param pulumi.Input[_builtins.int] callback_id: The ID of the primary key of the notification message bound to the oss stock scan task.
        :param pulumi.Input[_builtins.str] end_date: The end time of the file upload time range indicates the scanning of files uploaded before this time point.
        :param pulumi.Input[_builtins.str] image_ad_freeze_config: Picture automatically freezes the configuration of ad scenes. Example: {"type": "suggestion", "value": "block,review"}. The result will be frozen according to the suggestion in the picture detection result.
        :param pulumi.Input[_builtins.bool] image_auto_freeze_opened: Picture detection auto freeze switch. Value: true: auto freeze, false: not auto freeze.
        :param pulumi.Input[_builtins.str] image_live_freeze_config: Picture automatic freezing live scene configuration. Example:{"type":"suggestion","value":"block,review"}. The result will be frozen according to the suggestion in the picture detection result.
        :param pulumi.Input[_builtins.bool] image_opened: oss stock scan task detect images. true: scan images, false: do not scan images
        :param pulumi.Input[_builtins.str] image_porn_freeze_config: Picture automatic freezing porn scene configuration. Example: {"type": "suggestion", "value": "block,review"}. The result will be frozen according to the suggestion in the picture detection result.
        :param pulumi.Input[_builtins.int] image_scan_limit: The upper limit for scanning images in the oss stock scan task. The default value is 10000 images per Bucket.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] image_scenes: The image moderation scenario included in the oss stock scan task.Valid values:
               porn: pornography detection
               terrorism: terrorist content detection
               ad: ad violation detection
               live: undesirable scene detection
        :param pulumi.Input[_builtins.str] image_terrorism_freeze_config: The picture automatically freezes the configuration of terrorism scenes. Example: {"type": "suggestion", "value": "block,review"}. The result will be frozen according to the suggestion in the picture detection result.
        :param pulumi.Input[_builtins.bool] scan_image_no_file_type: Whether the oss stock scan task detects images with file names without suffixes. true: Detect pictures with file names without suffixes, false: Do not detect pictures with file names without suffixes
        :param pulumi.Input[_builtins.str] start_date: The start time of the file upload time range represents the files uploaded after scanning this time point.
        :param pulumi.Input[_builtins.str] video_ad_freeze_config: The video automatically freezes the configuration of ad scenarios. Example:{"type":"suggestion","value":"block,review"}. The results will be frozen according to the suggestion in the video detection results.
        :param pulumi.Input[_builtins.bool] video_auto_freeze_opened: Video detection auto freeze switch. Value: true: automatically freeze, false: not automatically freeze.
        :param pulumi.Input[_builtins.int] video_frame_interval: Resource attribute field representing the framing frequency. 1~60 seconds/frame, the default is 1 second/frame
        :param pulumi.Input[_builtins.str] video_live_freeze_config: Video automatic freeze live scene configuration. Example:{"type":"suggestion","value":"block,review"}. The results will be frozen according to the suggestion in the video detection results.
        :param pulumi.Input[_builtins.int] video_max_frames: A resource attribute field that represents the upper limit of a single video frame cut. 5 to 20000 frames, the default is 200 frames
        :param pulumi.Input[_builtins.int] video_max_size: Resource property field representing the maximum size of a single video. 1~2048MB, the default is 500MB, more than not detected.
        :param pulumi.Input[_builtins.bool] video_opened: oss stock scan task detect video. true: scan video, false: do not scan video
        :param pulumi.Input[_builtins.str] video_porn_freeze_config: Video automatic freezing porn scene configuration. Example: {"type": "suggestion", "value": "block,review"}. The result will be frozen according to the suggestion in the video detection result.
        :param pulumi.Input[_builtins.int] video_scan_limit: The upper limit of video scanning in the oss stock scan task. The default value is 1000/Bucket.
        :param pulumi.Input[_builtins.str] video_scenes: The video detection scenarios included in the oss stock scan task.
               porn: pornography detection
               terrorism: terrorist content detection
               ad: ad violation detection
               live: undesirable scene detection
               antispam: Video voice antispam
        :param pulumi.Input[_builtins.str] video_terrorism_freeze_config: The video automatically freezes the configuration of terrorism scenes. Example:{"type":"suggestion","value":"block,review"}. The results will be frozen according to the suggestion in the video detection results.
        :param pulumi.Input[_builtins.str] video_voice_antispam_freeze_config: Voice auto freeze configuration in video. Example:{"type":"suggestion","value":"block,review"}. The results will be frozen according to the suggestion in the video detection results.
        """
...
class OssStockTask(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="audioAntispamFreezeConfig")
    def audio_antispam_freeze_config(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Voice auto freeze configuration. Example:{"type":"suggestion","value":"block,review"}. The results are frozen according to the suggestion in the speech detection results.
        """
        return pulumi.get(self, "audio_antispam_freeze_config")
    ...
    @_builtins.property
    @pulumi.getter(name="audioAutoFreezeOpened")
    def audio_auto_freeze_opened(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Audio detection auto freeze switch. Value: true: automatically freeze, false: not automatically freeze.
        """
        return pulumi.get(self, "audio_auto_freeze_opened")
    ...
    @_builtins.property
    @pulumi.getter(name="audioMaxSize")
    def audio_max_size(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Resource property field representing the maximum size of a single audio. 1~2048MB, the default is 200MB, more than not detected.
        """
        return pulumi.get(self, "audio_max_size")
    ...
    @_builtins.property
    @pulumi.getter(name="audioOpened")
    def audio_opened(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        oss stock scan task detect audio. true: scan audio, false: do not scan audio
        """
        return pulumi.get(self, "audio_opened")
    ...
    @_builtins.property
    @pulumi.getter(name="audioScanLimit")
    def audio_scan_limit(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The upper limit of voice scan in the oss stock scan task. The default value is 1000/Bucket.
        """
        return pulumi.get(self, "audio_scan_limit")
    ...
    @_builtins.property
    @pulumi.getter(name="audioScenes")
    def audio_scenes(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The audio detection scenarios included in the oss stock scan task. Set the value to antispam.
        """
        return pulumi.get(self, "audio_scenes")
    ...
    @_builtins.property
    @pulumi.getter(name="autoFreezeType")
    def auto_freeze_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Automatic freeze type. Value: acl: modify permissions, copy: Move files
        """
        return pulumi.get(self, "auto_freeze_type")
    ...
    @_builtins.property
    @pulumi.getter(name="bizType")
    def biz_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Business scenarios used by the oss stock scan task
        """
        return pulumi.get(self, "biz_type")
    ...
    @_builtins.property
    @pulumi.getter
    def buckets(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The bucket configuration list of the oss stock scan task. Example:[{"Bucket":"bucket_01","Selected":true,"Prefixes":["img/test_"],"Type":"exclude"}]
        """
        return pulumi.get(self, "buckets")
    ...
    @_builtins.property
    @pulumi.getter(name="callbackId")
    def callback_id(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The ID of the primary key of the notification message bound to the oss stock scan task.
        """
        return pulumi.get(self, "callback_id")
    ...
    @_builtins.property
    @pulumi.getter(name="imageAdFreezeConfig")
    def image_ad_freeze_config(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Picture automatically freezes the configuration of ad scenes. Example: {"type": "suggestion", "value": "block,review"}. The result will be frozen according to the suggestion in the picture detection result.
        """
        return pulumi.get(self, "image_ad_freeze_config")
    ...
    @_builtins.property
    @pulumi.getter(name="imageAutoFreezeOpened")
    def image_auto_freeze_opened(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Picture detection auto freeze switch. Value: true: auto freeze, false: not auto freeze.
        """
        return pulumi.get(self, "image_auto_freeze_opened")
    ...
    @_builtins.property
    @pulumi.getter(name="imageLiveFreezeConfig")
    def image_live_freeze_config(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Picture automatic freezing live scene configuration. Example:{"type":"suggestion","value":"block,review"}. The result will be frozen according to the suggestion in the picture detection result.
        """
        return pulumi.get(self, "image_live_freeze_config")
    ...
    @_builtins.property
    @pulumi.getter(name="imageOpened")
    def image_opened(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        oss stock scan task detect images. true: scan images, false: do not scan images
        """
        return pulumi.get(self, "image_opened")
    ...
    @_builtins.property
    @pulumi.getter(name="imagePornFreezeConfig")
    def image_porn_freeze_config(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Picture automatic freezing porn scene configuration. Example: {"type": "suggestion", "value": "block,review"}. The result will be frozen according to the suggestion in the picture detection result.
        """
        return pulumi.get(self, "image_porn_freeze_config")
    ...
    @_builtins.property
    @pulumi.getter(name="imageScanLimit")
    def image_scan_limit(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The upper limit for scanning images in the oss stock scan task. The default value is 10000 images per Bucket.
        """
        return pulumi.get(self, "image_scan_limit")
    ...
    @_builtins.property
    @pulumi.getter(name="imageScenes")
    def image_scenes(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The image moderation scenario included in the oss stock scan task.Valid values:
        porn: pornography detection
        terrorism: terrorist content detection
    ...
    @_builtins.property
    @pulumi.getter(name="imageTerrorismFreezeConfig")
    def image_terrorism_freeze_config(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The picture automatically freezes the configuration of terrorism scenes. Example: {"type": "suggestion", "value": "block,review"}. The result will be frozen according to the suggestion in the picture detection result.
        """
        return pulumi.get(self, "image_terrorism_freeze_config")
    ...
    @_builtins.property
    @pulumi.getter(name="scanImageNoFileType")
    def scan_image_no_file_type(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether the oss stock scan task detects images with file names without suffixes. true: Detect pictures with file names without suffixes, false: Do not detect pictures with file names without suffixes
        """
        return pulumi.get(self, "scan_image_no_file_type")
    ...
    @_builtins.property
    @pulumi.getter(name="videoAdFreezeConfig")
    def video_ad_freeze_config(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The video automatically freezes the configuration of ad scenarios. Example:{"type":"suggestion","value":"block,review"}. The results will be frozen according to the suggestion in the video detection results.
        """
        return pulumi.get(self, "video_ad_freeze_config")
    ...
    @_builtins.property
    @pulumi.getter(name="videoAutoFreezeOpened")
    def video_auto_freeze_opened(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Video detection auto freeze switch. Value: true: automatically freeze, false: not automatically freeze.
        """
        return pulumi.get(self, "video_auto_freeze_opened")
    ...
    @_builtins.property
    @pulumi.getter(name="videoFrameInterval")
    def video_frame_interval(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Resource attribute field representing the framing frequency. 1~60 seconds/frame, the default is 1 second/frame
        """
        return pulumi.get(self, "video_frame_interval")
    ...
    @_builtins.property
    @pulumi.getter(name="videoLiveFreezeConfig")
    def video_live_freeze_config(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Video automatic freeze live scene configuration. Example:{"type":"suggestion","value":"block,review"}. The results will be frozen according to the suggestion in the video detection results.
        """
        return pulumi.get(self, "video_live_freeze_config")
    ...
    @_builtins.property
    @pulumi.getter(name="videoMaxFrames")
    def video_max_frames(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        A resource attribute field that represents the upper limit of a single video frame cut. 5 to 20000 frames, the default is 200 frames
        """
        return pulumi.get(self, "video_max_frames")
    ...
    @_builtins.property
    @pulumi.getter(name="videoMaxSize")
    def video_max_size(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Resource property field representing the maximum size of a single video. 1~2048MB, the default is 500MB, more than not detected.
        """
        return pulumi.get(self, "video_max_size")
    ...
    @_builtins.property
    @pulumi.getter(name="videoOpened")
    def video_opened(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        oss stock scan task detect video. true: scan video, false: do not scan video
        """
        return pulumi.get(self, "video_opened")
    ...
    @_builtins.property
    @pulumi.getter(name="videoPornFreezeConfig")
    def video_porn_freeze_config(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Video automatic freezing porn scene configuration. Example: {"type": "suggestion", "value": "block,review"}. The result will be frozen according to the suggestion in the video detection result.
        """
        return pulumi.get(self, "video_porn_freeze_config")
    ...
    @_builtins.property
    @pulumi.getter(name="videoScanLimit")
    def video_scan_limit(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The upper limit of video scanning in the oss stock scan task. The default value is 1000/Bucket.
        """
        return pulumi.get(self, "video_scan_limit")
    ...
    @_builtins.property
    @pulumi.getter(name="videoScenes")
    def video_scenes(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The video detection scenarios included in the oss stock scan task.
        porn: pornography detection
        terrorism: terrorist content detection
    ...
    @_builtins.property
    @pulumi.getter(name="videoTerrorismFreezeConfig")
    def video_terrorism_freeze_config(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The video automatically freezes the configuration of terrorism scenes. Example:{"type":"suggestion","value":"block,review"}. The results will be frozen according to the suggestion in the video detection results.
        """
        return pulumi.get(self, "video_terrorism_freeze_config")
    ...
    @_builtins.property
    @pulumi.getter(name="videoVoiceAntispamFreezeConfig")
    def video_voice_antispam_freeze_config(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Voice auto freeze configuration in video. Example:{"type":"suggestion","value":"block,review"}. The results will be frozen according to the suggestion in the video detection results.
        """
        return pulumi.get(self, "video_voice_antispam_freeze_config")
