...
class AuditCallbackArgs:
    def __init__(__self__, *,
                 audit_callback_name: pulumi.Input[builtins.str],
                 ...
                 crypt_type: pulumi.Input[builtins.str],
                 url: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a AuditCallback resource.
        :param pulumi.Input[builtins.str] audit_callback_name: The AuditCallback name defined by the customer. It can contain no more than 20 characters in Chinese, English, underscore (_), and digits.
        ...
        :param pulumi.Input[builtins.str] crypt_type: The encryption algorithm is used to verify that the callback request is sent by the content security service to your business service. The value is SHA256:SHA256 encryption algorithm and SM3: SM3 encryption algorithm.
        :param pulumi.Input[builtins.str] url: The detection result will be called back to the url.
        """
    ...
    def audit_callback_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def audit_callback_name(self, value: pulumi.Input[builtins.str]):
    ...
    def crypt_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @crypt_type.setter
    def crypt_type(self, value: pulumi.Input[builtins.str]):
...
class _AuditCallbackState:
    def __init__(__self__, *,
                 audit_callback_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 crypt_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="auditCallbackName")
    def audit_callback_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The AuditCallback name defined by the customer. It can contain no more than 20 characters in Chinese, English, underscore (_), and digits.
        """
        return pulumi.get(self, "audit_callback_name")
    ...
    @audit_callback_name.setter
    def audit_callback_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "audit_callback_name", value)
    ...
    @property
    @pulumi.getter(name="cryptType")
    def crypt_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The encryption algorithm is used to verify that the callback request is sent by the content security service to your business service. The value is SHA256:SHA256 encryption algorithm and SM3: SM3 encryption algorithm.
        """
        return pulumi.get(self, "crypt_type")
    ...
    @crypt_type.setter
    def crypt_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "crypt_type", value)
...
class AuditCallback(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            callback_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            crypt_type: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'AuditCallback':
        """
    ...
    @property
    @pulumi.getter(name="auditCallbackName")
    def audit_callback_name(self) -> pulumi.Output[builtins.str]:
        """
        The AuditCallback name defined by the customer. It can contain no more than 20 characters in Chinese, English, underscore (_), and digits.
        """
        return pulumi.get(self, "audit_callback_name")
    ...
    @property
    @pulumi.getter(name="cryptType")
    def crypt_type(self) -> pulumi.Output[builtins.str]:
        """
        The encryption algorithm is used to verify that the callback request is sent by the content security service to your business service. The value is SHA256:SHA256 encryption algorithm and SM3: SM3 encryption algorithm.
        """
        return pulumi.get(self, "crypt_type")
