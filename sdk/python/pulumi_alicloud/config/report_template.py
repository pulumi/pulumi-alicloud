...
warnings.warn("""alicloud.config/reporttemplate.ReportTemplate has been deprecated in favor of alicloud.cfg/reporttemplate.ReportTemplate""", DeprecationWarning)


@pulumi.type_token("alicloud:config/reportTemplate:ReportTemplate")
