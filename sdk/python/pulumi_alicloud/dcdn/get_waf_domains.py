...
class GetWafDomainsResult:
    ...
    def query_args(self) -> Optional[builtins.str]:
...
def get_waf_domains(enable_details: Optional[builtins.bool] = None,
                    ids: Optional[Sequence[builtins.str]] = None,
                    output_file: Optional[builtins.str] = None,
                    query_args: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Waf Domain IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str query_args: The query conditions. You can filter domain names by name. Fuzzy match is supported `QueryArgs={"DomainName":"Accelerated domain name"}`.
    """
    __args__ = dict()
...
def get_waf_domains_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                           ...
                           query_args: Optional[pulumi.Input[Optional[builtins.str]]] = None,
