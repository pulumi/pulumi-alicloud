...
class WafPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] defense_scene: The type of protection policy. Valid values: `waf_group`, `custom_acl`, `whitelist`, `ip_blacklist`, `region_block`.
        :param pulumi.Input[builtins.str] policy_name: The name of the protection policy. The name must be 1 to 64 characters in length, and can contain letters, digits,and underscores (_).
        :param pulumi.Input[builtins.str] policy_type: The type of the protection policy. Valid values: `default`, `custom`.
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid values: `on`, `off`.
        """
...
class WafPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_name: Optional[pulumi.Input[builtins.str]] = None,
            policy_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'WafPolicy':
        """
