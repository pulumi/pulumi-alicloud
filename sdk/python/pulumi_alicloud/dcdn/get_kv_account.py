...
def get_kv_account(status: Optional[_builtins.str] = None,
    ...
    :param _builtins.str status: The status of the KV feature for your account. Valid values: `online`, `offline`.
    """
    __args__ = dict()
