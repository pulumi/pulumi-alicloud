...
def get_kv_account(status: Optional[builtins.str] = None,
    ...
    :param builtins.str status: The status of the KV feature for your account. Valid values: `online`, `offline`.
    """
    __args__ = dict()
...
def get_kv_account_output(status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
