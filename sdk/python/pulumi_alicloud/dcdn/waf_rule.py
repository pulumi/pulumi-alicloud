...
class WafRuleArgs:
    def __init__(__self__, *,
                 ...
                 cc_status: Optional[pulumi.Input[builtins.str]] = None,
                 cn_region_list: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 other_region_list: Optional[pulumi.Input[builtins.str]] = None,
                 rate_limit: Optional[pulumi.Input['WafRuleRateLimitArgs']] = None,
                 regular_rules: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 regular_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 remote_addrs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 scenes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 waf_group_ids: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WafRule resource.
        :param pulumi.Input[builtins.str] policy_id: The protection policy ID.
        :param pulumi.Input[builtins.str] rule_name: The name of the protection rule. The name can be up to 64 characters in length and can contain letters, digits, and underscores (_). **NOTE:** This parameter cannot be modified when policy is of type `region_block`.
        :param pulumi.Input[builtins.str] action: Specifies the action of the rule. Valid values: `block`, `monitor`, `js`, `deny`.
        :param pulumi.Input[builtins.str] cc_status: Specifies whether to enable rate limiting. Valid values: `on` and `off`. **NOTE:** This parameter is required when policy is of type `custom_acl`.
        :param pulumi.Input[builtins.str] cn_region_list: The blocked regions in the Chinese mainland, separated by commas (,).
        ...
        :param pulumi.Input[builtins.str] effect: The effective scope of the rate limiting blacklist. If you set ccStatus to on, you must configure this parameter. Valid values: `rule` (takes effect for the current rule) and `service` (takes effect globally).
        :param pulumi.Input[builtins.str] other_region_list: Blocked regions outside the Chinese mainland, separated by commas (,).
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regular_rules: The regular expression.e, when waf_group appears in tags, this value can be filled in, and only one list of six digits in string format can appear with regultypes.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regular_types: Regular rule type, when waf_group appears in tags, this value can be filled in, optional values:["sqli", "xss", "code_exec", "crlf", "lfileii", "rfileii", "webshell", "vvip", "other"]
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] remote_addrs: Filter by IP address.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scenes: The types of the protection policies.
        :param pulumi.Input[builtins.str] status: The status of the waf rule. Valid values: `on` and `off`. Default value: on.
        :param pulumi.Input[builtins.str] waf_group_ids: The id of the waf rule group. The default value is "1012". Multiple rules are separated by commas. **NOTE:** This parameter is valid only when policy is of type `waf_group`.
        """
    ...
    def cc_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cc_status.setter
    def cc_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cc_status", value)

    @property
    @pulumi.getter(name="cnRegionList")
    def cn_region_list(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cn_region_list(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def other_region_list(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def other_region_list(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def regular_rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def regular_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "regular_rules", value)

    @property
    @pulumi.getter(name="regularTypes")
    def regular_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def regular_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "regular_types", value)

    @property
    @pulumi.getter(name="remoteAddrs")
    def remote_addrs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @remote_addrs.setter
    def remote_addrs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "remote_addrs", value)

    @property
    @pulumi.getter
    def scenes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @scenes.setter
    def scenes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def waf_group_ids(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def waf_group_ids(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _WafRuleState:
    def __init__(__self__, *,
                 ...
                 cn_region_list: Optional[pulumi.Input[builtins.str]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input['WafRuleConditionArgs']]]] = None,
                 defense_scene: Optional[pulumi.Input[builtins.str]] = None,
                 effect: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cn_region_list: The blocked regions in the Chinese mainland, separated by commas (,).
        :param pulumi.Input[Sequence[pulumi.Input['WafRuleConditionArgs']]] conditions: Conditions that trigger the rule. See `conditions` below. **NOTE:** This parameter is required when policy is of type `custom_acl` or `whitelist`.
        :param pulumi.Input[builtins.str] defense_scene: The type of protection policy. The following scenarios are supported:-waf_group:Web basic protection-custom_acl: Custom protection policy-whitelist: whitelist
        :param pulumi.Input[builtins.str] effect: The effective scope of the rate limiting blacklist. If you set ccStatus to on, you must configure this parameter. Valid values: `rule` (takes effect for the current rule) and `service` (takes effect globally).
        :param pulumi.Input[builtins.str] gmt_modified: Revised the time. The date format is based on ISO8601 notation and uses UTC +0 time in the format of yyyy-MM-ddTHH:mm:ssZ.
        :param pulumi.Input[builtins.str] other_region_list: Blocked regions outside the Chinese mainland, separated by commas (,).
        :param pulumi.Input[builtins.str] policy_id: The protection policy ID.
        :param pulumi.Input['WafRuleRateLimitArgs'] rate_limit: The rules of rate limiting. If you set `cc_status` to on, you must configure this parameter. See `rate_limit` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regular_rules: The regular expression.e, when waf_group appears in tags, this value can be filled in, and only one list of six digits in string format can appear with regultypes.
    ...
    def defense_scene(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def defense_scene(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WafRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scenes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            waf_group_ids: Optional[pulumi.Input[builtins.str]] = None) -> 'WafRule':
        """
    ...
    @property
    @pulumi.getter(name="ccStatus")
    def cc_status(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether to enable rate limiting. Valid values: `on` and `off`. **NOTE:** This parameter is required when policy is of type `custom_acl`.
        """
        return pulumi.get(self, "cc_status")
    ...
    @property
    @pulumi.getter(name="cnRegionList")
    def cn_region_list(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The blocked regions in the Chinese mainland, separated by commas (,).
        """
        return pulumi.get(self, "cn_region_list")
    ...
    @property
    @pulumi.getter(name="defenseScene")
    def defense_scene(self) -> pulumi.Output[builtins.str]:
        """
        The type of protection policy. The following scenarios are supported:-waf_group:Web basic protection-custom_acl: Custom protection policy-whitelist: whitelist
        """
        return pulumi.get(self, "defense_scene")
    ...
    @property
    @pulumi.getter(name="otherRegionList")
    def other_region_list(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Blocked regions outside the Chinese mainland, separated by commas (,).
        """
        return pulumi.get(self, "other_region_list")
    ...
    @property
    @pulumi.getter(name="regularRules")
    def regular_rules(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The regular expression.e, when waf_group appears in tags, this value can be filled in, and only one list of six digits in string format can appear with regultypes.
        """
        return pulumi.get(self, "regular_rules")
    ...
    @property
    @pulumi.getter(name="regularTypes")
    def regular_types(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Regular rule type, when waf_group appears in tags, this value can be filled in, optional values:["sqli", "xss", "code_exec", "crlf", "lfileii", "rfileii", "webshell", "vvip", "other"]
        """
        return pulumi.get(self, "regular_types")
    ...
    @property
    @pulumi.getter(name="remoteAddrs")
    def remote_addrs(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Filter by IP address.
        """
        return pulumi.get(self, "remote_addrs")
    ...
    @property
    @pulumi.getter
    def scenes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The types of the protection policies.
        """
        return pulumi.get(self, "scenes")
    ...
    @property
    @pulumi.getter(name="wafGroupIds")
    def waf_group_ids(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The id of the waf rule group. The default value is "1012". Multiple rules are separated by commas. **NOTE:** This parameter is valid only when policy is of type `waf_group`.
        """
        return pulumi.get(self, "waf_group_ids")
