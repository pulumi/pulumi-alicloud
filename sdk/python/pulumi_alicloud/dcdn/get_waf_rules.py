...
def get_waf_rules(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Waf Rule IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str query_args: The query conditions. The value is a string in the JSON format.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_waf_rules_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
