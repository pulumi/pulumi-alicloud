...
class KvNamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Namespace description information
        :param pulumi.Input[builtins.str] namespace: Namespace name. The name can contain letters, digits, hyphens (-), and underscores (_).
        """
...
@pulumi.type_token("alicloud:dcdn/kvNamespace:KvNamespace")
