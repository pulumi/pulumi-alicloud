...
class DomainSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] content: The address of the source station.
        :param pulumi.Input[builtins.int] port: The port number. Valid values: `443` and `80`. Default to `80`.
        :param pulumi.Input[builtins.str] priority: The priority of the origin if multiple origins are specified. Default to `20`.
        :param pulumi.Input[builtins.str] type: The type of the origin. Valid values:
        :param pulumi.Input[builtins.str] weight: The weight of the origin if multiple origins are specified. Default to `10`.
        """
...
if not MYPY:
    class ErEnvConfPresetCanaryAnhuiArgsDict(TypedDict):
        allowed_hosts: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Allowed DCDN domain names.
        """
        code_rev: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ErEnvConfPresetCanaryAnhuiArgs:
    def __init__(__self__, *,
                 allowed_hosts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 code_rev: Optional[pulumi.Input[builtins.str]] = None,
                 spec_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_hosts: Allowed DCDN domain names.
        :param pulumi.Input[builtins.str] code_rev: The version number of the code.
        :param pulumi.Input[builtins.str] spec_name: The specification of the CPU time slice. Valid values: `5ms`, `50ms`, `100ms`.
        """
    ...
    def allowed_hosts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Allowed DCDN domain names.
        """
    ...
    def allowed_hosts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "allowed_hosts", value)

    @property
    @pulumi.getter(name="codeRev")
    def code_rev(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The version number of the code.
        """
    ...
    @code_rev.setter
    def code_rev(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IpaDomainSourceArgs:
    def __init__(__self__, *,
                 ...
                 weight: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] content: The address of the origin server. You can specify an IP address or a domain name.
        :param pulumi.Input[builtins.int] port: The custom port number. Valid values: `0` to `65535`.
        :param pulumi.Input[builtins.str] priority: The priority of the origin server. Valid values: `20` and `30`. Default value: `20`. A value of 20 specifies that the origin is a primary origin. A value of 30 specifies that the origin is a secondary origin.
        :param pulumi.Input[builtins.str] type: The type of the origin server. Valid values: `ipaddr`, `domain`, `oss`.
        :param pulumi.Input[builtins.int] weight: The weight of the origin server. You must specify a value that is less than `100`. Default value: `10`.
        """
        pulumi.set(__self__, "content", content)
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "priority", priority)
...
if not MYPY:
    class WafRuleConditionArgsDict(TypedDict):
        ...
        The match field.
        """
        op_value: pulumi.Input[builtins.str]
        """
        The logical symbol.
        """
...
class WafRuleConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: The match field.
        :param pulumi.Input[builtins.str] op_value: The logical symbol.
        :param pulumi.Input[builtins.str] sub_key: The match subfield.
        :param pulumi.Input[builtins.str] values: The match content. Separate multiple values with commas (,).
        """
    ...
    def op_value(self) -> pulumi.Input[builtins.str]:
        """
        The logical symbol.
        """
    ...
    @op_value.setter
    def op_value(self, value: pulumi.Input[builtins.str]):
...
class WafRuleRateLimitArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] interval: Statistical duration, 5-1800.
        :param pulumi.Input['WafRuleRateLimitStatusArgs'] status: Response code statistics. See `status` below.
        :param pulumi.Input[builtins.str] sub_key: The subfield of the target field. If you set `target` to `Header`, `Query String Parameter`, or `Cookie Name`, you must configure `sub_key`.
        :param pulumi.Input[builtins.str] target: The statistical field for frequency control. Currently, `IP`, `Header`, `Query String Parameter`, `Cookie Name`, `Session` is supported.
        :param pulumi.Input[builtins.int] threshold: The trigger threshold of rate limiting. Valid values: 2 to 500000. Unit: requests.
        :param pulumi.Input[builtins.int] ttl: The validity period of the blacklist. Valid values: 60 to 86400. Unit: seconds.
        """
...
if not MYPY:
    class WafRuleRateLimitStatusArgsDict(TypedDict):
        ...
        """
        ratio: NotRequired[pulumi.Input[builtins.int]]
        """
...
class WafRuleRateLimitStatusArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] code: The HTTP status code returned.
        :param pulumi.Input[builtins.int] count: The number of times that the HTTP status code that was returned. Valid values: 2 to 50000. You can configure only one of the `ratio` and `count` fields.
        :param pulumi.Input[builtins.int] ratio: The percentage of HTTP status codes. Valid values: 1 to 100. You can configure only one of the `ratio` and `count` fields.
        """
        if code is not None:
