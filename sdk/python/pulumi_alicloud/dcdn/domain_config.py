...
class _DomainConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] config_id: The ID of the configuration.
        :param pulumi.Input[builtins.str] domain_name: Name of the accelerated domain. This name without suffix can have a string of 1 to 63 characters, must contain only alphanumeric characters or "-", and must not begin or end with "-", and "-" must not in the 3th and 4th character positions at the same time. Suffix `.sh` and `.tel` are not supported.
        :param pulumi.Input[Sequence[pulumi.Input['DomainConfigFunctionArgArgs']]] function_args: The args of the domain config. See `function_args` below.
        :param pulumi.Input[builtins.str] function_name: The name of the domain config.
        :param pulumi.Input[builtins.str] parent_id: By configuring the function condition (rule engine) in the domain name configuration function parameters, Rule conditions can be created (Rule conditions can match and filter user requests by identifying various parameters carried in user requests). After each rule condition is created, a corresponding ConfigId will be generated, and the ConfigId can be referenced by other functions as a ParentId parameter, in this way, the rule conditions can be combined with the functional configuration to form a more flexible configuration.
        :param pulumi.Input[builtins.str] status: The status of the Config.
        """
...
class DomainConfig(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:dcdn/domainConfig:DomainConfig"
