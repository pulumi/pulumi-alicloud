...
def get_ipa_domains(domain_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ipa Domain IDs.
...
def get_ipa_domains_output(domain_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
