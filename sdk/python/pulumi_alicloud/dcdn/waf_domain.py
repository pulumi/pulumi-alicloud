...
class WafDomainArgs:
    def __init__(__self__, *,
                 ...
                 client_ip_tag: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WafDomain resource.
        :param pulumi.Input[builtins.str] domain_name: The accelerated domain name.
        :param pulumi.Input[builtins.str] client_ip_tag: The client ip tag.
        """
    ...
    def client_ip_tag(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The client ip tag.
        """
    ...
    def client_ip_tag(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WafDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            client_ip_tag: Optional[pulumi.Input[builtins.str]] = None,
            domain_name: Optional[pulumi.Input[builtins.str]] = None) -> 'WafDomain':
        """
    ...
    @property
    @pulumi.getter(name="clientIpTag")
    def client_ip_tag(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The client ip tag.
        """
        return pulumi.get(self, "client_ip_tag")
