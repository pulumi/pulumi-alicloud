...
class ErArgs:
    def __init__(__self__, *,
                 er_name: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 env_conf: Optional[pulumi.Input['ErEnvConfArgs']] = None):
        """
        The set of arguments for constructing a Er resource.
        :param pulumi.Input[builtins.str] er_name: The name of the routine. The name must be unique among the routines that belong to the same Alibaba Cloud account.
        :param pulumi.Input[builtins.str] description: Routine The description of the routine.
    ...
    def er_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @er_name.setter
    def er_name(self, value: pulumi.Input[builtins.str]):
...
class _ErState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 env_conf: Optional[pulumi.Input['ErEnvConfArgs']] = None,
                 er_name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="erName")
    def er_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the routine. The name must be unique among the routines that belong to the same Alibaba Cloud account.
        """
        return pulumi.get(self, "er_name")
    ...
    @er_name.setter
    def er_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "er_name", value)
...
class Er(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            env_conf: Optional[pulumi.Input[Union['ErEnvConfArgs', 'ErEnvConfArgsDict']]] = None,
            er_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Er':
        """
    ...
    @property
    @pulumi.getter(name="erName")
    def er_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the routine. The name must be unique among the routines that belong to the same Alibaba Cloud account.
        """
        return pulumi.get(self, "er_name")
