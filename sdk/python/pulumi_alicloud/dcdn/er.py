...
class Er(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 env_conf: pulumi.Input[Optional[Union['ErEnvConfArgs', 'ErEnvConfArgsDict', 'outputs.ErEnvConf']]] = None,
                 er_name: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] description: Routine The description of the routine.
        :param pulumi.Input[Union['ErEnvConfArgs', 'ErEnvConfArgsDict', 'outputs.ErEnvConf']] env_conf: The configurations of the specified environment. See `env_conf` below.
        :param pulumi.Input[_builtins.str] er_name: The name of the routine. The name must be unique among the routines that belong to the same Alibaba Cloud account.
        """
        ...
    @overload
