...
class DomainSource(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str content: The address of the source station.
        :param builtins.int port: The port number. Valid values: `443` and `80`. Default to `80`.
        :param builtins.str priority: The priority of the origin if multiple origins are specified. Default to `20`.
        :param builtins.str type: The type of the origin. Valid values:
        :param builtins.str weight: The weight of the origin if multiple origins are specified. Default to `10`.
        """
...
class ErEnvConfPresetCanaryAnhui(dict):
    ...
    def __init__(__self__, *,
                 allowed_hosts: Optional[Sequence[builtins.str]] = None,
                 code_rev: Optional[builtins.str] = None,
                 spec_name: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] allowed_hosts: Allowed DCDN domain names.
        :param builtins.str code_rev: The version number of the code.
        :param builtins.str spec_name: The specification of the CPU time slice. Valid values: `5ms`, `50ms`, `100ms`.
        """
    ...
    def allowed_hosts(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def code_rev(self) -> Optional[builtins.str]:
        """
...
class IpaDomainSource(dict):
    def __init__(__self__, *,
                 ...
                 weight: builtins.int):
        """
        :param builtins.str content: The address of the origin server. You can specify an IP address or a domain name.
        :param builtins.int port: The custom port number. Valid values: `0` to `65535`.
        :param builtins.str priority: The priority of the origin server. Valid values: `20` and `30`. Default value: `20`. A value of 20 specifies that the origin is a primary origin. A value of 30 specifies that the origin is a secondary origin.
        :param builtins.str type: The type of the origin server. Valid values: `ipaddr`, `domain`, `oss`.
        :param builtins.int weight: The weight of the origin server. You must specify a value that is less than `100`. Default value: `10`.
        """
        pulumi.set(__self__, "content", content)
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "priority", priority)
...
class WafRuleCondition(dict):
    ...
    def __init__(__self__, *,
                 key: builtins.str,
                 op_value: builtins.str,
                 sub_key: Optional[builtins.str] = None,
                 values: Optional[builtins.str] = None):
        """
        :param builtins.str key: The match field.
        :param builtins.str op_value: The logical symbol.
        :param builtins.str sub_key: The match subfield.
        :param builtins.str values: The match content. Separate multiple values with commas (,).
        """
    ...
    def op_value(self) -> builtins.str:
        """
        The logical symbol.
        """
...
class WafRuleRateLimit(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int interval: Statistical duration, 5-1800.
        :param 'WafRuleRateLimitStatusArgs' status: Response code statistics. See `status` below.
        :param builtins.str sub_key: The subfield of the target field. If you set `target` to `Header`, `Query String Parameter`, or `Cookie Name`, you must configure `sub_key`.
        :param builtins.str target: The statistical field for frequency control. Currently, `IP`, `Header`, `Query String Parameter`, `Cookie Name`, `Session` is supported.
        :param builtins.int threshold: The trigger threshold of rate limiting. Valid values: 2 to 500000. Unit: requests.
        :param builtins.int ttl: The validity period of the blacklist. Valid values: 60 to 86400. Unit: seconds.
        """
...
class WafRuleRateLimitStatus(dict):
    def __init__(__self__, *,
                 ...
                 ratio: Optional[builtins.int] = None):
        """
        :param builtins.str code: The HTTP status code returned.
        :param builtins.int count: The number of times that the HTTP status code that was returned. Valid values: 2 to 50000. You can configure only one of the `ratio` and `count` fields.
        :param builtins.int ratio: The percentage of HTTP status codes. Valid values: 1 to 100. You can configure only one of the `ratio` and `count` fields.
        """
        if code is not None:
    ...
    @property
    @pulumi.getter
    def ratio(self) -> Optional[builtins.int]:
        """
...
class GetDomainsDomainResult(dict):
    def __init__(__self__, *,
                 ...
                 status: builtins.str):
        """
        :param builtins.str cert_name: Indicates the name of the certificate.
        :param builtins.str cname: The canonical name (CNAME) of the accelerated domain.
        :param builtins.str description: The reason that causes the review failure.
        :param builtins.str domain_name: The name of the DCDN Domain.
        :param builtins.str gmt_modified: The time when the accelerated domain was last modified.
        :param builtins.str id: The ID of the DCDN Domain.
        :param builtins.str resource_group_id: The ID of the resource group.
        :param builtins.str scope: The acceleration region.
        :param Sequence['GetDomainsDomainSourceArgs'] sources: The origin information.
        :param builtins.str ssl_protocol: Indicates whether the SSL certificate is enabled.
        :param builtins.str ssl_pub: Indicates the public key of the certificate.
        :param builtins.str status: The status of DCDN Domain.
        """
...
class GetDomainsDomainSourceResult(dict):
    def __init__(__self__, *,
                 ...
                 weight: builtins.str):
        """
        :param builtins.str content: The origin address.
        :param builtins.str enabled: The status of the origin.
        :param builtins.int port: The port number.
        :param builtins.str priority: The priority of the origin if multiple origins are specified.
        :param builtins.str type: The type of the origin. Valid values:
        :param builtins.str weight: The weight of the origin if multiple origins are specified.
        """
        pulumi.set(__self__, "content", content)
...
class GetIpaDomainsDomainResult(dict):
    def __init__(__self__, *,
                 ...
                 status: builtins.str):
        """
        :param builtins.str cert_name: CertName.
        :param builtins.str cname: The CNAME assigned to the domain name.
        :param builtins.str create_time: The time when the accelerated domain name was created.
        :param builtins.str description: The description.
        :param builtins.str domain_name: The name of the Domain.
        :param builtins.str id: The ID of the Ipa Domain.
        :param builtins.str resource_group_id: The ID of the resource group.
        :param builtins.str scope: The accelerated region.
        :param Sequence['GetIpaDomainsDomainSourceArgs'] sources: The information about the origin server.
        :param builtins.str ssl_protocol: Indicates whether the Security Socket Layer (SSL) certificate is enabled.
        :param builtins.str ssl_pub: Indicates the public key of the certificate if the HTTPS protocol is enabled.
        :param builtins.str status: The status of the accelerated domain name. Valid values: `check_failed`, `checking`, `configure_failed`, `configuring`, `offline`, `online`.
        """
        pulumi.set(__self__, "cert_name", cert_name)
        pulumi.set(__self__, "cname", cname)
...
class GetIpaDomainsDomainSourceResult(dict):
    def __init__(__self__, *,
                 ...
                 weight: builtins.int):
        """
        :param builtins.str content: The address of the origin server.
        :param builtins.int port: The custom port.
        :param builtins.str priority: The priority of the origin server if multiple origin servers are specified.
        :param builtins.str type: The type of the origin server.
        :param builtins.int weight: The weight of the origin server if multiple origin servers are specified.
        """
        pulumi.set(__self__, "content", content)
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "priority", priority)
...
class GetWafDomainsDomainResult(dict):
    def __init__(__self__, *,
                 client_ip_tag: builtins.str,
                 defense_scenes: Sequence['outputs.GetWafDomainsDomainDefenseSceneResult'],
                 domain_name: builtins.str,
                 id: builtins.str):
        """
        :param builtins.str client_ip_tag: The client ip tag.
        :param Sequence['GetWafDomainsDomainDefenseSceneArgs'] defense_scenes: Protection policy type.
        :param builtins.str domain_name: The accelerated domain name.
        :param builtins.str id: The ID of the Waf Domain.
        """
    ...
    def client_ip_tag(self) -> builtins.str:
        """
        The client ip tag.
        """
...
class GetWafDomainsDomainDefenseSceneResult(dict):
    def __init__(__self__, *,
                 defense_scene: builtins.str,
                 policy_id: builtins.str):
        """
        :param builtins.str defense_scene: The type of protection policy.
        :param builtins.str policy_id: The protection policy ID.
        """
    ...
    def defense_scene(self) -> builtins.str:
        """
...
class GetWafPoliciesPolicyResult(dict):
    def __init__(__self__, *,
                 dcdn_waf_policy_id: builtins.str,
                 defense_scene: builtins.str,
                 ...
                 rule_count: builtins.str,
                 status: builtins.str):
        """
        :param builtins.str dcdn_waf_policy_id: The first ID of the resource.
        :param builtins.str defense_scene: The type of protection policy.
        :param builtins.int domain_count: The number of domain names that use this protection policy.
        :param builtins.str gmt_modified: The time when the protection policy was modified.
        :param builtins.str id: The ID of the Waf Policy.
        :param builtins.str policy_name: The name of the protection policy.
        :param builtins.str policy_type: The type of the protection policy.
        :param builtins.str rule_count: The number of protection rules in this protection policy.
        :param builtins.str status: The status of the resource. Valid values: `on`, `off`.
        """
    ...
    def dcdn_waf_policy_id(self) -> builtins.str:
        """
    ...
    def rule_count(self) -> builtins.str:
        """
...
class GetWafRulesWafRuleResult(dict):
    def __init__(__self__, *,
                 action: builtins.str,
                 cc_status: builtins.str,
                 cn_region_list: builtins.str,
                 conditions: Sequence['outputs.GetWafRulesWafRuleConditionResult'],
                 defense_scene: builtins.str,
                 effect: builtins.str,
                 gmt_modified: builtins.str,
                 id: builtins.str,
                 other_region_list: builtins.str,
                 policy_id: builtins.str,
                 rate_limits: Sequence['outputs.GetWafRulesWafRuleRateLimitResult'],
                 regular_rules: Sequence[builtins.str],
                 regular_types: Sequence[builtins.str],
                 remote_addrs: Sequence[builtins.str],
                 rule_name: builtins.str,
                 scenes: Sequence[builtins.str],
                 status: builtins.str,
                 waf_group_ids: builtins.str,
                 waf_rule_id: builtins.str):
        """
        :param builtins.str action: Specifies the action of the rule.
        :param builtins.str cc_status: Whether to turn on Frequency Control, on/off
        :param builtins.str cn_region_list: The blocked regions in the Chinese mainland, separated by commas (,).
        :param Sequence['GetWafRulesWafRuleConditionArgs'] conditions: The trigger condition of the rule.
        :param builtins.str defense_scene: The type of protection policy. The following scenarios are supported:-waf_group:Web basic protection-custom_acl: Custom protection policy-whitelist: whitelist
        :param builtins.str effect: The effective range of the frequency control blacklist.
        :param builtins.str gmt_modified: Revised the time. The date format is based on ISO8601 notation and uses UTC +0 time in the format of yyyy-MM-ddTHH:mm:ssZ.
        :param builtins.str id: The ID of the Waf Rule.
        :param builtins.str other_region_list: The effective range of the frequency control blacklist.
        :param builtins.str policy_id: The protection policy ID.
        :param Sequence['GetWafRulesWafRuleRateLimitArgs'] rate_limits: The rules of rate limiting.
        :param Sequence[builtins.str] regular_rules: The regular expression.
        :param Sequence[builtins.str] regular_types: The type of the regular expression. If the value of the tags field contains waf_group, you can specify this field.
        :param Sequence[builtins.str] remote_addrs: Filter by IP address.
        :param builtins.str rule_name: The name of the protection rule.
        :param Sequence[builtins.str] scenes: List of protection scenarios
        :param builtins.str status: The information about the HTTP status code.
        :param builtins.str waf_group_ids: The id of the waf rule group.
        :param builtins.str waf_rule_id: The first ID of the resource
        """
    ...
    def cc_status(self) -> builtins.str:
        """
    ...
    def cn_region_list(self) -> builtins.str:
        """
    ...
    def other_region_list(self) -> builtins.str:
        """
        The effective range of the frequency control blacklist.
        """
    ...
    def regular_rules(self) -> Sequence[builtins.str]:
        """
    ...
    def regular_types(self) -> Sequence[builtins.str]:
        """
    ...
    def remote_addrs(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def scenes(self) -> Sequence[builtins.str]:
        """
    ...
    def waf_group_ids(self) -> builtins.str:
        """
    ...
    def waf_rule_id(self) -> builtins.str:
        """
        The first ID of the resource
        """
...
class GetWafRulesWafRuleConditionResult(dict):
    def __init__(__self__, *,
                 key: builtins.str,
                 op_value: builtins.str,
                 sub_key: builtins.str,
                 values: builtins.str):
        """
        :param builtins.str key: The match field.
        :param builtins.str op_value: The logical symbol.
        :param builtins.str sub_key: The subfield of the target field.
        :param builtins.str values: The match content. Separate multiple values with commas (,).
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "op_value", op_value)
...
class GetWafRulesWafRuleRateLimitResult(dict):
    def __init__(__self__, *,
                 ...
                 ttl: builtins.int):
        """
        :param builtins.int interval: The statistical interval. Valid values: 5 to 1800. Unit: seconds.
        :param Sequence['GetWafRulesWafRuleRateLimitStatusArgs'] statuses: The information about the HTTP status code.
        :param builtins.str sub_key: The subfield of the target field.
        :param builtins.str target: The statistical field for frequency control.
        :param builtins.int threshold: The trigger threshold of rate limiting. Valid values: 2 to 500000. Unit: requests.
        :param builtins.int ttl: The validity period of the blacklist. Valid values: 60 to 86400. Unit: seconds.
        """
        pulumi.set(__self__, "interval", interval)
...
class GetWafRulesWafRuleRateLimitStatusResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str code: The HTTP status code returned.
        :param builtins.int count: The number of times that the HTTP status code that was returned.
        :param builtins.int ratio: The percentage of HTTP status codes.
        """
        pulumi.set(__self__, "code", code)
        pulumi.set(__self__, "count", count)
        pulumi.set(__self__, "ratio", ratio)
