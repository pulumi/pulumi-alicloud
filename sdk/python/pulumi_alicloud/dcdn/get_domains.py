...
def get_domains(change_end_time: Optional[builtins.str] = None,
                change_start_time: Optional[builtins.str] = None,
                check_domain_show: Optional[builtins.bool] = None,
                domain_search_type: Optional[builtins.str] = None,
    ...
    :param builtins.str change_end_time: The end time of the update. Specify the time in the ISO 8601 standard in the `yyyy-MM-ddTHH:mm:ssZ` format. The time must be in UTC.
    :param builtins.str change_start_time: The start time of the update. Specify the time in the ISO 8601 standard in the `yyyy-MM-ddTHH:mm:ssZ` format. The time must be in UTC.
    :param builtins.bool check_domain_show: Specifies whether to display the domains in the checking, check_failed, or configure_failed status. Valid values: `true` or `false`.
    :param builtins.str domain_search_type: The search method. Default value: `fuzzy_match`. Valid values: `fuzzy_match`, `pre_match`, `suf_match`, `full_match`.
    :param builtins.bool enable_details: Default to `false`. Set it to true can output more details.
    :param Sequence[builtins.str] ids: A list ids of DCDN Domain.
    :param builtins.str name_regex: A regex string to filter results by the DCDN Domain.
...
def get_domains_output(change_end_time: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       change_start_time: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       check_domain_show: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                       domain_search_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       ...
                       security_token: Optional[pulumi.Input[Optional[builtins.str]]] = None,
