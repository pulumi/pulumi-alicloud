...
class WafPolicyDomainAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_name: Access the accelerated domain name of the specified protection policy.
        :param pulumi.Input[builtins.str] policy_id: The protection policy ID. Only one input is supported.
        """
...
class WafPolicyDomainAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            domain_name: Optional[pulumi.Input[builtins.str]] = None,
            policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WafPolicyDomainAttachment':
        """
