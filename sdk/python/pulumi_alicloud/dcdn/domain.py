...
class DomainArgs:
    def __init__(__self__, *,
                 ...
                 check_url: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 scene: Optional[pulumi.Input[builtins.str]] = None,
                 scope: Optional[pulumi.Input[builtins.str]] = None,
                 sources: Optional[pulumi.Input[Sequence[pulumi.Input['DomainSourceArgs']]]] = None,
                 ssl_pri: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_pub: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 top_level_domain: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Domain resource.
        :param pulumi.Input[builtins.str] domain_name: The accelerated domain name. You can specify multiple domain names and separate them with commas (,). You can specify up to 500 domain names in each request. The query results of multiple domain names are aggregated. If you do not specify this parameter, data of all accelerated domain names under your account is queried.
        :param pulumi.Input[builtins.str] cert_id: The certificate ID. This parameter is required and valid only when `CertType` is set to `cas`. If you specify this parameter, an existing certificate is used.
        :param pulumi.Input[builtins.str] cert_name: The name of the new certificate. You can specify only one certificate name. This parameter is optional and valid only when `CertType` is set to `upload`.
        :param pulumi.Input[builtins.str] cert_region: The region of the SSL certificate. This parameter takes effect only when `CertType` is set to `cas`. Default value: **cn-hangzhou**. Valid values: **cn-hangzhou** and **ap-southeast-1**.
        :param pulumi.Input[builtins.str] cert_type: The certificate type.
        :param pulumi.Input[builtins.str] check_url: The URL that is used for health checks.
        :param pulumi.Input[builtins.str] env: Specifies whether the certificate is issued in canary releases. If you set this parameter to `staging`, the certificate is issued in canary releases. If you do not specify this parameter or set this parameter to other values, the certificate is officially issued.
        :param pulumi.Input[builtins.str] function_type: Computing service type. Valid values:
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group. If you do not specify a value for this parameter, the system automatically assigns the ID of the default resource group.
        :param pulumi.Input[builtins.str] scene: The Acceleration scen. Supported:
        :param pulumi.Input[builtins.str] scope: The region where the acceleration service is deployed. Valid values:
        :param pulumi.Input[Sequence[pulumi.Input['DomainSourceArgs']]] sources: Source  See `sources` below.
        :param pulumi.Input[builtins.str] ssl_pri: The private key. Specify the private key only if you want to enable the SSL certificate.
        :param pulumi.Input[builtins.str] ssl_protocol: Specifies whether to enable the SSL certificate. Valid values:
        :param pulumi.Input[builtins.str] ssl_pub: The content of the SSL certificate. Specify the content of the SSL certificate only if you want to enable the SSL certificate.
        :param pulumi.Input[builtins.str] status: The status of the domain name. Valid values:
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the resource
        :param pulumi.Input[builtins.str] top_level_domain: The top-level domain.
        """
    ...
    def check_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @check_url.setter
    def check_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def function_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def scene(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @scene.setter
    def scene(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ssl_pri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ssl_pri.setter
    def ssl_pri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ssl_pri", value)

    @property
    @pulumi.getter(name="sslProtocol")
    def ssl_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ssl_protocol.setter
    def ssl_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ssl_protocol", value)

    @property
    @pulumi.getter(name="sslPub")
    def ssl_pub(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ssl_pub.setter
    def ssl_pub(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cert_type: The certificate type.
        :param pulumi.Input[builtins.str] check_url: The URL that is used for health checks.
        :param pulumi.Input[builtins.str] cname: The CNAME domain name corresponding to the accelerated domain name.
        :param pulumi.Input[builtins.str] create_time: The time when the accelerated domain name was created.
        :param pulumi.Input[builtins.str] domain_name: The accelerated domain name. You can specify multiple domain names and separate them with commas (,). You can specify up to 500 domain names in each request. The query results of multiple domain names are aggregated. If you do not specify this parameter, data of all accelerated domain names under your account is queried.
        :param pulumi.Input[builtins.str] env: Specifies whether the certificate is issued in canary releases. If you set this parameter to `staging`, the certificate is issued in canary releases. If you do not specify this parameter or set this parameter to other values, the certificate is officially issued.
        :param pulumi.Input[builtins.str] function_type: Computing service type. Valid values:
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group. If you do not specify a value for this parameter, the system automatically assigns the ID of the default resource group.
...
class Domain(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:dcdn/domain:Domain"
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            top_level_domain: Optional[pulumi.Input[builtins.str]] = None) -> 'Domain':
        """
    ...
    @property
    @pulumi.getter(name="certRegion")
    def cert_region(self) -> pulumi.Output[builtins.str]:
        """
        The region of the SSL certificate. This parameter takes effect only when `CertType` is set to `cas`. Default value: **cn-hangzhou**. Valid values: **cn-hangzhou** and **ap-southeast-1**.
        """
        return pulumi.get(self, "cert_region")
    ...
    @property
    @pulumi.getter(name="certType")
    def cert_type(self) -> pulumi.Output[builtins.str]:
        """
        The certificate type.
        """
        return pulumi.get(self, "cert_type")
    ...
    @property
    @pulumi.getter(name="checkUrl")
    def check_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL that is used for health checks.
        """
        return pulumi.get(self, "check_url")
    ...
    @property
    @pulumi.getter
    def env(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether the certificate is issued in canary releases. If you set this parameter to `staging`, the certificate is issued in canary releases. If you do not specify this parameter or set this parameter to other values, the certificate is officially issued.
        """
        return pulumi.get(self, "env")
    ...
    @property
    @pulumi.getter(name="functionType")
    def function_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Computing service type. Valid values:
        """
        return pulumi.get(self, "function_type")
    ...
    @property
    @pulumi.getter
    def scene(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Acceleration scen. Supported:
        """
        return pulumi.get(self, "scene")
    ...
    @property
    @pulumi.getter(name="sslPri")
    def ssl_pri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The private key. Specify the private key only if you want to enable the SSL certificate.
        """
        return pulumi.get(self, "ssl_pri")
    ...
    @property
    @pulumi.getter(name="sslProtocol")
    def ssl_protocol(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether to enable the SSL certificate. Valid values:
        """
        return pulumi.get(self, "ssl_protocol")
    ...
    @property
    @pulumi.getter(name="sslPub")
    def ssl_pub(self) -> pulumi.Output[builtins.str]:
        """
        The content of the SSL certificate. Specify the content of the SSL certificate only if you want to enable the SSL certificate.
        """
        return pulumi.get(self, "ssl_pub")
    ...
    @property
    @pulumi.getter(name="topLevelDomain")
    def top_level_domain(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The top-level domain.
        """
        return pulumi.get(self, "top_level_domain")
