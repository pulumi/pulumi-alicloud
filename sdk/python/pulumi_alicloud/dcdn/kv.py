...
class KvArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key: The name of the key to Put, the longest 512, cannot contain spaces.
        :param pulumi.Input[builtins.str] namespace: The name specified when the customer calls PutDcdnKvNamespace.
        :param pulumi.Input[builtins.str] value: The content of key, up to 2M(2*1000*1000).
        """
