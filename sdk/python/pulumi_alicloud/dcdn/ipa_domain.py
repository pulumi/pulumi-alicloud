...
class IpaDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_name: The domain name to be added to IPA. Wildcard domain names are supported. A wildcard domain name must start with a period (.).
        :param pulumi.Input[Sequence[pulumi.Input['IpaDomainSourceArgs']]] sources: Sources. See `sources` below.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group. If you do not set this parameter, the system automatically assigns the ID of the default resource group.
        :param pulumi.Input[builtins.str] scope: The accelerated region. Valid values: `domestic`, `global`, `overseas`.
        :param pulumi.Input[builtins.str] status: The status of DCDN Ipa Domain. Valid values: `online`, `offline`. Default to `online`.
        """
...
class IpaDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scope: Optional[pulumi.Input[builtins.str]] = None,
            sources: Optional[pulumi.Input[Sequence[pulumi.Input[Union['IpaDomainSourceArgs', 'IpaDomainSourceArgsDict']]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'IpaDomain':
        """
