...
def get_functions(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str name_regex: A regex string to filter results by function name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str service_name: Name of the service that contains the functions to find.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_functions_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
