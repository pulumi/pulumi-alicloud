...
class FunctionAsyncInvokeConfigArgs:
    def __init__(__self__, *,
                 ...
                 stateful_invocation: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a FunctionAsyncInvokeConfig resource.
        :param pulumi.Input[builtins.str] function_name: Name of the Function Compute Function.
        :param pulumi.Input[builtins.str] service_name: Name of the Function Compute Function, omitting any version or alias qualifier.
        ...
        :param pulumi.Input[builtins.int] maximum_event_age_in_seconds: Maximum age of a request that Function Compute sends to a function for processing in seconds. Valid values between 1 and 2592000 (between 60 and 21600 before v1.167.0).
        :param pulumi.Input[builtins.int] maximum_retry_attempts: Maximum number of times to retry when the function returns an error. Valid values between 0 and 8 (between 0 and 2 before v1.167.0). Defaults to 2.
        :param pulumi.Input[builtins.str] qualifier: Function Compute Function published version, `LATEST`, or Function Compute Alias name. The default value is `LATEST`.
        :param pulumi.Input[builtins.bool] stateful_invocation: Function Compute async job configuration(also known as Task Mode). valid values true or false, default `false`
        """
    ...
    def stateful_invocation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def stateful_invocation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _FunctionAsyncInvokeConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_time: The date this resource was created.
        :param pulumi.Input['FunctionAsyncInvokeConfigDestinationConfigArgs'] destination_config: Configuration block with destination configuration. See `destination_config` below.
        :param pulumi.Input[builtins.str] function_name: Name of the Function Compute Function.
        :param pulumi.Input[builtins.str] last_modified_time: The date this resource was last modified.
        :param pulumi.Input[builtins.int] maximum_event_age_in_seconds: Maximum age of a request that Function Compute sends to a function for processing in seconds. Valid values between 1 and 2592000 (between 60 and 21600 before v1.167.0).
        :param pulumi.Input[builtins.int] maximum_retry_attempts: Maximum number of times to retry when the function returns an error. Valid values between 0 and 8 (between 0 and 2 before v1.167.0). Defaults to 2.
        :param pulumi.Input[builtins.str] qualifier: Function Compute Function published version, `LATEST`, or Function Compute Alias name. The default value is `LATEST`.
        :param pulumi.Input[builtins.str] service_name: Name of the Function Compute Function, omitting any version or alias qualifier.
...
class FunctionAsyncInvokeConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            qualifier: Optional[pulumi.Input[builtins.str]] = None,
            service_name: Optional[pulumi.Input[builtins.str]] = None,
            stateful_invocation: Optional[pulumi.Input[builtins.bool]] = None) -> 'FunctionAsyncInvokeConfig':
        """
    ...
    @property
    @pulumi.getter(name="statefulInvocation")
    def stateful_invocation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Function Compute async job configuration(also known as Task Mode). valid values true or false, default `false`
        """
        return pulumi.get(self, "stateful_invocation")
