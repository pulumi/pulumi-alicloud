...
class V2Function(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            runtime: Optional[pulumi.Input[builtins.str]] = None,
            service_name: Optional[pulumi.Input[builtins.str]] = None,
            timeout: Optional[pulumi.Input[builtins.int]] = None) -> 'V2Function':
        """
    ...
    @property
    @pulumi.getter(name="caPort")
    def ca_port(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "ca_port")
    ...
    @property
    @pulumi.getter
    def cpu(self) -> pulumi.Output[Optional[builtins.float]]:
        return pulumi.get(self, "cpu")
    ...
    @property
    @pulumi.getter(name="gpuMemorySize")
    def gpu_memory_size(self) -> pulumi.Output[Optional[builtins.int]]:
        return pulumi.get(self, "gpu_memory_size")
    ...
    @property
    @pulumi.getter(name="initializationTimeout")
    def initialization_timeout(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "initialization_timeout")
