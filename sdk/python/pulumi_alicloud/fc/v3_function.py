...
class V3FunctionArgs:
    def __init__(__self__, *,
                 ...
                 instance_concurrency: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] runtime: Function runtime type
        :param pulumi.Input['V3FunctionCodeArgs'] code: Function code ZIP package. code and customContainerConfig. See `code` below.
        :param pulumi.Input[builtins.float] cpu: The CPU specification of the function. The unit is vCPU, which is a multiple of the 0.05 vCPU.
        ...
        :param pulumi.Input[builtins.str] description: The description of the function. The function compute system does not use this attribute value, but we recommend that you set a concise and clear description for the function.
        :param pulumi.Input[builtins.int] disk_size: The disk specification of the function, in MB. The optional value is 512 MB or 10240MB.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] environment_variables: The environment variable set for the function, you can get the value of the environment variable in the function.
        :param pulumi.Input[builtins.str] function_name: The function name. Consists of uppercase and lowercase letters, digits (0 to 9), underscores (_), and dashes (-). It must begin with an English letter (a ~ z), (A ~ Z), or an underscore (_). Case sensitive. The length is 1~128 characters.
        :param pulumi.Input['V3FunctionGpuConfigArgs'] gpu_config: Function GPU configuration. See `gpu_config` below.
        :param pulumi.Input[builtins.int] instance_concurrency: Maximum instance concurrency.
        ...
        :param pulumi.Input[builtins.bool] internet_access: Allow function to access public network
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] layers: The list of layers.
        ...
        :param pulumi.Input[builtins.int] memory_size: The memory specification of the function. The unit is MB. The memory size is a multiple of 64MB. The minimum value is 128MB and the maximum value is 32GB. At the same time, the ratio of cpu to memorySize (calculated by GB) should be between 1:1 and 1:4.
        ...
        :param pulumi.Input[builtins.str] role: The user is authorized to the RAM role of function compute. After the configuration, function compute will assume this role to generate temporary access credentials. In the function, you can use the temporary access credentials of the role to access the specified Alibaba cloud service, such as OSS and OTS
    ...
    def instance_concurrency(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def instance_concurrency(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _V3FunctionState:
    def __init__(__self__, *,
                 ...
                 last_update_status: Optional[pulumi.Input[builtins.str]] = None,
                 last_update_status_reason: Optional[pulumi.Input[builtins.str]] = None,
                 last_update_status_reason_code: Optional[pulumi.Input[builtins.str]] = None,
                 layers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 log_config: Optional[pulumi.Input['V3FunctionLogConfigArgs']] = None,
                 memory_size: Optional[pulumi.Input[builtins.int]] = None,
                 nas_config: Optional[pulumi.Input['V3FunctionNasConfigArgs']] = None,
                 ...
                 state_reason_code: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 timeout: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input['V3FunctionCodeArgs'] code: Function code ZIP package. code and customContainerConfig. See `code` below.
        :param pulumi.Input[builtins.int] code_size: The code package size of the function returned by the system, in byte Example : 1024
        :param pulumi.Input[builtins.float] cpu: The CPU specification of the function. The unit is vCPU, which is a multiple of the 0.05 vCPU.
        :param pulumi.Input[builtins.str] create_time: The creation time of the function.
        :param pulumi.Input['V3FunctionCustomContainerConfigArgs'] custom_container_config: The configuration of the custom container runtime. After the configuration is successful, the function can use the custom container image to execute the function. code and customContainerConfig. See `custom_container_config` below.
        :param pulumi.Input['V3FunctionCustomDnsArgs'] custom_dns: Function custom DNS configuration See `custom_dns` below.
        :param pulumi.Input['V3FunctionCustomRuntimeConfigArgs'] custom_runtime_config: Customize the runtime configuration. See `custom_runtime_config` below.
        :param pulumi.Input[builtins.str] description: The description of the function. The function compute system does not use this attribute value, but we recommend that you set a concise and clear description for the function.
        :param pulumi.Input[builtins.int] disk_size: The disk specification of the function, in MB. The optional value is 512 MB or 10240MB.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] environment_variables: The environment variable set for the function, you can get the value of the environment variable in the function.
        :param pulumi.Input[builtins.str] function_arn: ARN of function
        :param pulumi.Input[builtins.str] function_id: The first ID of the resource
        :param pulumi.Input[builtins.str] function_name: The function name. Consists of uppercase and lowercase letters, digits (0 to 9), underscores (_), and dashes (-). It must begin with an English letter (a ~ z), (A ~ Z), or an underscore (_). Case sensitive. The length is 1~128 characters.
        :param pulumi.Input['V3FunctionGpuConfigArgs'] gpu_config: Function GPU configuration. See `gpu_config` below.
        :param pulumi.Input[builtins.str] handler: Function Handler: the call entry for the function compute system to run your function.
        :param pulumi.Input[builtins.int] instance_concurrency: Maximum instance concurrency.
        :param pulumi.Input['V3FunctionInstanceLifecycleConfigArgs'] instance_lifecycle_config: Instance lifecycle callback method configuration. See `instance_lifecycle_config` below.
        :param pulumi.Input[builtins.bool] internet_access: Allow function to access public network
        :param pulumi.Input[builtins.str] last_modified_time: Last time the function was Updated
        :param pulumi.Input[builtins.str] last_update_status: The status of the last function update operation. When the function is created successfully, the value is Successful. Optional values are Successful, Failed, and InProgress.
        :param pulumi.Input[builtins.str] last_update_status_reason: The reason that caused the last function to update the Operation State to the current value
        :param pulumi.Input[builtins.str] last_update_status_reason_code: Status code of the reason that caused the last function update operation status to the current value
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] layers: The list of layers.
        :param pulumi.Input['V3FunctionLogConfigArgs'] log_config: The logs generated by the function are written to the configured Logstore. See `log_config` below.
        :param pulumi.Input[builtins.int] memory_size: The memory specification of the function. The unit is MB. The memory size is a multiple of 64MB. The minimum value is 128MB and the maximum value is 32GB. At the same time, the ratio of cpu to memorySize (calculated by GB) should be between 1:1 and 1:4.
        :param pulumi.Input['V3FunctionNasConfigArgs'] nas_config: NAS configuration. After this parameter is configured, the function can access the specified NAS resource. See `nas_config` below.
        ...
        :param pulumi.Input[builtins.str] role: The user is authorized to the RAM role of function compute. After the configuration, function compute will assume this role to generate temporary access credentials. In the function, you can use the temporary access credentials of the role to access the specified Alibaba cloud service, such as OSS and OTS
        :param pulumi.Input[builtins.str] runtime: Function runtime type
        :param pulumi.Input[builtins.str] state: Function Status
        :param pulumi.Input[builtins.str] state_reason: The reason why the function is in the current state
        :param pulumi.Input[builtins.str] state_reason_code: The status code of the reason the function is in the current state.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the resource
        :param pulumi.Input[builtins.int] timeout: The maximum running time of the function, in seconds.
    ...
    def last_update_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_update_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_update_status", value)

    @property
    @pulumi.getter(name="lastUpdateStatusReason")
    def last_update_status_reason(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_update_status_reason(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_update_status_reason", value)

    @property
    @pulumi.getter(name="lastUpdateStatusReasonCode")
    def last_update_status_reason_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_update_status_reason_code(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def state_reason_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def state_reason_code(self, value: Optional[pulumi.Input[builtins.str]]):
...
class V3Function(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def cpu(self) -> pulumi.Output[builtins.float]:
        """
        The CPU specification of the function. The unit is vCPU, which is a multiple of the 0.05 vCPU.
        """
        return pulumi.get(self, "cpu")
    ...
    @property
    @pulumi.getter(name="instanceConcurrency")
    def instance_concurrency(self) -> pulumi.Output[builtins.int]:
        """
        Maximum instance concurrency.
        """
        return pulumi.get(self, "instance_concurrency")
    ...
    @property
    @pulumi.getter(name="internetAccess")
    def internet_access(self) -> pulumi.Output[builtins.bool]:
        """
        Allow function to access public network
        """
        return pulumi.get(self, "internet_access")
    ...
    @property
    @pulumi.getter(name="lastUpdateStatus")
    def last_update_status(self) -> pulumi.Output[builtins.str]:
        """
        The status of the last function update operation. When the function is created successfully, the value is Successful. Optional values are Successful, Failed, and InProgress.
        """
        return pulumi.get(self, "last_update_status")
    ...
    @property
    @pulumi.getter(name="lastUpdateStatusReason")
    def last_update_status_reason(self) -> pulumi.Output[builtins.str]:
        """
        The reason that caused the last function to update the Operation State to the current value
        """
        return pulumi.get(self, "last_update_status_reason")
    ...
    @property
    @pulumi.getter(name="lastUpdateStatusReasonCode")
    def last_update_status_reason_code(self) -> pulumi.Output[builtins.str]:
        """
        Status code of the reason that caused the last function update operation status to the current value
        """
        return pulumi.get(self, "last_update_status_reason_code")
    ...
    @property
    @pulumi.getter(name="stateReasonCode")
    def state_reason_code(self) -> pulumi.Output[builtins.str]:
        """
        The status code of the reason the function is in the current state.
        """
        return pulumi.get(self, "state_reason_code")
