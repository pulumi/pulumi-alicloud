...
class LayerVersionArgs:
    def __init__(__self__, *,
                 compatible_runtimes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] compatible_runtimes: The list of runtime environments that are supported by the layer. Valid values: `nodejs14`, `nodejs12`, `nodejs10`, `nodejs8`, `nodejs6`, `python3.9`, `python3`, `python2.7`, `java11`, `java8`, `php7.2`, `go1`,`dotnetcore2.1`, `custom`.
        :param pulumi.Input[builtins.str] layer_name: The name of the layer.
        :param pulumi.Input[builtins.str] description: The description of the layer version.
        :param pulumi.Input[builtins.str] oss_bucket_name: The name of the OSS bucket that stores the ZIP package of the function code.
        :param pulumi.Input[builtins.str] oss_object_name: The name of the OSS object (ZIP package) that contains the function code.
        :param pulumi.Input[builtins.bool] skip_destroy: Whether to retain the old version of a previously deployed Lambda Layer. Default is `false`. When this is not set to `true`, changing any of `compatible_runtimes`, `description`, `layer_name`, `oss_bucket_name`,  `oss_object_name`, or `zip_file` forces deletion of the existing layer version and creation of a new layer version.
        :param pulumi.Input[builtins.str] zip_file: The ZIP package of the function code that is encoded in the Base64 format.
    ...
    def compatible_runtimes(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def compatible_runtimes(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _LayerVersionState:
    def __init__(__self__, *,
                 ...
                 code_check_sum: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] acl: The access mode of Layer Version.
        :param pulumi.Input[builtins.str] arn: The arn of Layer Version.
        :param pulumi.Input[builtins.str] code_check_sum: The checksum of the layer code package.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] compatible_runtimes: The list of runtime environments that are supported by the layer. Valid values: `nodejs14`, `nodejs12`, `nodejs10`, `nodejs8`, `nodejs6`, `python3.9`, `python3`, `python2.7`, `java11`, `java8`, `php7.2`, `go1`,`dotnetcore2.1`, `custom`.
        :param pulumi.Input[builtins.str] description: The description of the layer version.
        :param pulumi.Input[builtins.str] layer_name: The name of the layer.
        :param pulumi.Input[builtins.str] oss_bucket_name: The name of the OSS bucket that stores the ZIP package of the function code.
        :param pulumi.Input[builtins.str] oss_object_name: The name of the OSS object (ZIP package) that contains the function code.
        :param pulumi.Input[builtins.bool] skip_destroy: Whether to retain the old version of a previously deployed Lambda Layer. Default is `false`. When this is not set to `true`, changing any of `compatible_runtimes`, `description`, `layer_name`, `oss_bucket_name`,  `oss_object_name`, or `zip_file` forces deletion of the existing layer version and creation of a new layer version.
        :param pulumi.Input[builtins.str] version: The version of Layer Version.
        :param pulumi.Input[builtins.str] zip_file: The ZIP package of the function code that is encoded in the Base64 format.
    ...
    def code_check_sum(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def code_check_sum(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LayerVersion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            skip_destroy: Optional[pulumi.Input[builtins.bool]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None,
            zip_file: Optional[pulumi.Input[builtins.str]] = None) -> 'LayerVersion':
        """
    ...
    @property
    @pulumi.getter(name="codeCheckSum")
    def code_check_sum(self) -> pulumi.Output[builtins.str]:
        """
        The checksum of the layer code package.
        """
        return pulumi.get(self, "code_check_sum")
    ...
    @property
    @pulumi.getter(name="compatibleRuntimes")
    def compatible_runtimes(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of runtime environments that are supported by the layer. Valid values: `nodejs14`, `nodejs12`, `nodejs10`, `nodejs8`, `nodejs6`, `python3.9`, `python3`, `python2.7`, `java11`, `java8`, `php7.2`, `go1`,`dotnetcore2.1`, `custom`.
        """
        return pulumi.get(self, "compatible_runtimes")
    ...
    @property
    @pulumi.getter(name="ossObjectName")
    def oss_object_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the OSS object (ZIP package) that contains the function code.
        """
        return pulumi.get(self, "oss_object_name")
