...
class V3TriggerArgs:
    def __init__(__self__, *,
                 ...
                 trigger_config: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] qualifier: The version or alias of the function
        :param pulumi.Input[builtins.str] trigger_type: The type of the trigger. Currently, the supported types include oss, log, http, timer, tablestore, cdn_events, mns_topic and eventbridge.
        :param pulumi.Input[builtins.str] description: Description of the trigger
        :param pulumi.Input[builtins.str] invocation_role: The role required by the event source (such as OSS) to call the function.
        :param pulumi.Input[builtins.str] source_arn: Trigger Event source ARN
        :param pulumi.Input[builtins.str] trigger_config: Trigger configuration. The configuration varies for different types of triggers.
        :param pulumi.Input[builtins.str] trigger_name: Trigger Name
        """
    ...
    def trigger_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def trigger_config(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _V3TriggerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] invocation_role: The role required by the event source (such as OSS) to call the function.
        :param pulumi.Input[builtins.str] last_modified_time: (Available since v1.234.0) The last modified time of the trigger
        :param pulumi.Input[builtins.str] qualifier: The version or alias of the function
        :param pulumi.Input[builtins.str] source_arn: Trigger Event source ARN
        :param pulumi.Input[builtins.str] status: The state of the trigger
        :param pulumi.Input[builtins.str] target_arn: (Available since v1.234.0) Resource identity of the function
        :param pulumi.Input[builtins.str] trigger_config: Trigger configuration. The configuration varies for different types of triggers.
        :param pulumi.Input[builtins.str] trigger_id: (Available since v1.234.0) Trigger ID
        :param pulumi.Input[builtins.str] trigger_name: Trigger Name
        :param pulumi.Input[builtins.str] trigger_type: The type of the trigger. Currently, the supported types include oss, log, http, timer, tablestore, cdn_events, mns_topic and eventbridge.
        """
...
class V3Trigger(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            trigger_id: Optional[pulumi.Input[builtins.str]] = None,
            trigger_name: Optional[pulumi.Input[builtins.str]] = None,
            trigger_type: Optional[pulumi.Input[builtins.str]] = None) -> 'V3Trigger':
        """
    ...
    @property
    @pulumi.getter(name="triggerConfig")
    def trigger_config(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Trigger configuration. The configuration varies for different types of triggers.
        """
        return pulumi.get(self, "trigger_config")
    ...
    @property
    @pulumi.getter(name="triggerName")
    def trigger_name(self) -> pulumi.Output[builtins.str]:
        """
        Trigger Name
        """
        return pulumi.get(self, "trigger_name")
