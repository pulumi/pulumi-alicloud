...
class CustomDomainCertConfigArgs:
    def __init__(__self__, *,
                 ...
                 private_key: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] cert_name: The name of the certificate, used to distinguish different certificates.
        :param pulumi.Input[_builtins.str] certificate: Certificate data of the HTTPS certificates, follow the 'pem' format.
        :param pulumi.Input[_builtins.str] private_key: Private key of the HTTPS certificates, follow the 'pem' format.
        """
...
class CustomDomainRouteConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] service_name: The name of the Function Compute service that requests are routed to.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] methods: The requests of the specified HTTP methos are routed from. Valid method: GET, POST, DELETE, HEAD, PUT and PATCH. For example, "GET, HEAD" methods indicate that only requests from GET and HEAD methods are routed.
        :param pulumi.Input[_builtins.str] qualifier: The version or alias of the Function Compute service that requests are routed to. For example, qualifier v1 indicates that the requests are routed to the version 1 Function Compute service. For detail information about version and alias, please refer to the [developer guide](https://www.alibabacloud.com/help/doc-detail/96464.htm).
        """
...
class FunctionAsyncInvokeConfigDestinationConfigOnFailureArgs:
    def __init__(__self__, *,
                 destination: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] destination: Alicloud Resource Name (ARN) of the destination resource. See the [Developer Guide](https://www.alibabacloud.com/help/doc-detail/181866.htm) for acceptable resource types and associated RAM permissions.
        """
...
class FunctionCustomContainerConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] command: The entry point of the container, which specifies the actual command run by the container.
        """
...
class ServiceLogConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable_instance_metrics: Enable instance level metrics.
        :param pulumi.Input[_builtins.bool] enable_request_metrics: Enable request level metrics.
        """
...
class ServiceNasConfigArgs:
    def __init__(__self__, *,
                 ...
                 user_id: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] group_id: The group id of your NAS file system.
        ...
        :param pulumi.Input[_builtins.int] user_id: The user id of your NAS file system.
        """
...
class ServiceNasConfigMountPointArgs:
    def __init__(__self__, *,
                 ...
                 server_addr: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] mount_dir: The local address where to mount your remote NAS directory.
        :param pulumi.Input[_builtins.str] server_addr: The address of the remote NAS directory.
        """
    ...
    def mount_dir(self) -> pulumi.Input[_builtins.str]:
        """
        The local address where to mount your remote NAS directory.
        """
    ...
    @mount_dir.setter
    def mount_dir(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "mount_dir", value)

    @_builtins.property
    @pulumi.getter(name="serverAddr")
    def server_addr(self) -> pulumi.Input[_builtins.str]:
        """
        The address of the remote NAS directory.
        """
    ...
    @server_addr.setter
    def server_addr(self, value: pulumi.Input[_builtins.str]):
...
class ServiceVpcConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] vpc_id: A vpc ID associated with the Function Compute Service.
        """
...
class V2FunctionCodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] zip_file: Upload the base64 encoding of the code zip package directly in the request body.
        """
...
class V2FunctionCustomContainerConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] command: Container start command, equivalent to Docker ENTRYPOINT.
        :param pulumi.Input[_builtins.str] image: Container Image address. Example value: registry-vpc.cn-hangzhou.aliyuncs.com/fc-demo/helloworld:v1beta1.
        :param pulumi.Input[_builtins.bool] web_server_mode: Whether the image is run in Web Server mode. The value of true needs to implement the Web Server in the container image to listen to the port and process the request. The value of false needs to actively exit the process after the container runs, and the ExitCode needs to be 0. Default true.
        """
...
class V2FunctionCustomDnsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] searches: List of DNS search domains.
        """
...
class V2FunctionCustomHealthCheckConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] initial_delay_seconds: Delay from container startup to initiation of health check.
        :param pulumi.Input[_builtins.int] period_seconds: Health check cycle.
        :param pulumi.Input[_builtins.int] success_threshold: The threshold for the number of successful health checks. After the health check is reached, the system considers the check successful.
        :param pulumi.Input[_builtins.int] timeout_seconds: Health check timeout.
        """
...
class V3CustomDomainRouteConfigRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] path: Route matching rule
        :param pulumi.Input[_builtins.str] qualifier: Version or Alias
...
class V3CustomDomainTlsConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] min_version: TLS minimum version number. Enumeration values: TLSv1.3, TLSv1.2, TLSv1.1, TLSv1.0
        """
...
class V3FunctionCodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] oss_object_name: The name of the OSS Object that stores the function code ZIP package.
        :param pulumi.Input[_builtins.str] zip_file: The Base 64 encoding of the function code ZIP package.
        """
...
class V3FunctionCustomContainerConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] acr_instance_id: ACR Enterprise version Image Repository ID, which must be entered when using ACR Enterprise version image. (Obsolete)
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] commands: Container startup parameters.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] entrypoints: Container start command.
...
class V3FunctionCustomDnsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] searches: DNS search domain list
        """
        if dns_options is not None:
            pulumi.set(__self__, "dns_options", dns_options)
        if name_servers is not None:
...
class V3FunctionCustomRuntimeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] port: The listening port of the HTTP Server.
        """
        if args is not None:
            pulumi.set(__self__, "args", args)
        if commands is not None:
...
class V3FunctionLogConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] log_begin_rule: Log Line First Matching Rules
        :param pulumi.Input[_builtins.str] logstore: The Logstore name of log service.
        :param pulumi.Input[_builtins.str] project: The name of the log service Project.
        """
        if enable_instance_metrics is not None:
            pulumi.set(__self__, "enable_instance_metrics", enable_instance_metrics)
        if enable_request_metrics is not None:
...
class V3FunctionNasConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] user_id: Account ID
        """
...
class V3FunctionOssMountConfigMountPointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] endpoint: OSS access endpoint
...
class V3FunctionVpcConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] vswitch_ids: Switch List
        """
...
class V3LayerVersionCodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] oss_object_name: Name of the OSS Object where the user stores the Layer Code ZIP package
        :param pulumi.Input[_builtins.str] zip_file: Base 64 encoding of Layer Code ZIP package
        """
        if checksum is not None:
            pulumi.set(__self__, "checksum", checksum)
        if oss_bucket_name is not None:
...
class V3ProvisionConfigScheduledActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] schedule_expression: Timing Configuration
        :param pulumi.Input[_builtins.str] start_time: Policy effective time
        :param pulumi.Input[_builtins.int] target: Number of reserved target resources
...
class V3ProvisionConfigTargetTrackingPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] metric_target: Tracking value of the indicator
        :param pulumi.Input[_builtins.str] metric_type: Provisionedconcurrency utilization: Concurrency utilization of reserved mode instances. CPU utilization: CPU utilization. GPUMemUtilization:GPU utilization
        :param pulumi.Input[_builtins.int] min_capacity: Minimum Shrinkage
        :param pulumi.Input[_builtins.str] name: Policy Name
        :param pulumi.Input[_builtins.str] start_time: Policy Effective Time
        :param pulumi.Input[_builtins.str] time_zone: Time zone.
        """
