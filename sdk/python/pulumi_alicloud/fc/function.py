...
class FunctionArgs:
    def __init__(__self__, *,
                 ...
                 custom_container_config: pulumi.Input[Optional['FunctionCustomContainerConfigArgs']] = None,
                 ...
                 oss_key: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def custom_container_config(self) -> pulumi.Input[Optional['FunctionCustomContainerConfigArgs']]:
        """
    ...
    def custom_container_config(self, value: pulumi.Input[Optional['FunctionCustomContainerConfigArgs']]):
    ...
    def oss_key(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @oss_key.setter
    def oss_key(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class Function(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ca_port: pulumi.Input[Optional[_builtins.int]] = None,
                 code_checksum: pulumi.Input[Optional[_builtins.str]] = None,
                 custom_container_config: pulumi.Input[Optional[Union['FunctionCustomContainerConfigArgs', 'FunctionCustomContainerConfigArgsDict', 'outputs.FunctionCustomContainerConfig']]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 environment_variables: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 filename: pulumi.Input[Optional[_builtins.str]] = None,
                 handler: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        > **DEPRECATED:** This resource (alicloud_fc_function) represents the legacy Function Compute API. For new deployments and advanced features, please use the `fc.V3Function` resource which provides access to the latest FCV3 capabilities. The legacy FC resource supports only basic functionality and does not include newer features such as CPU allocation, disk size configuration, custom DNS, GPU support, and many other FCV3-specific features. If your configuration includes FCV3-specific parameters, you must migrate to the `fc.V3Function` resource.
        ...
        :param pulumi.Input[_builtins.str] code_checksum: The checksum (crc64) of the function code.Used to trigger updates.The value can be generated by data source alicloud_file_crc64_checksum.
               > **NOTE:** For more information, see [Limits](https://www.alibabacloud.com/help/doc-detail/51907.htm).
        :param pulumi.Input[Union['FunctionCustomContainerConfigArgs', 'FunctionCustomContainerConfigArgsDict', 'outputs.FunctionCustomContainerConfig']] custom_container_config: The configuration for custom container runtime.See `custom_container_config` below.
        :param pulumi.Input[_builtins.str] description: The Function Compute function description.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] environment_variables: A map that defines environment variables for the function.
        :param pulumi.Input[_builtins.str] filename: The path to the function's deployment package within the local filesystem. It is conflict with the `oss_`-prefixed options.
        :param pulumi.Input[_builtins.str] handler: The function [entry point](https://www.alibabacloud.com/help/doc-detail/157704.htm) in your code.
    ...
    def get(resource_name: str,
            ...
            runtime: pulumi.Input[Optional[_builtins.str]] = None,
            service: pulumi.Input[Optional[_builtins.str]] = None,
            timeout: pulumi.Input[Optional[_builtins.int]] = None) -> 'Function':
        """
