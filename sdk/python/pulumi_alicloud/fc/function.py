...
class FunctionArgs:
    def __init__(__self__, *,
                 ...
                 ca_port: Optional[pulumi.Input[builtins.int]] = None,
                 code_checksum: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 initialization_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 initializer: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 oss_key: Optional[pulumi.Input[builtins.str]] = None,
                 timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Function resource.
        :param pulumi.Input[builtins.str] handler: The function [entry point](https://www.alibabacloud.com/help/doc-detail/157704.htm) in your code.
        :param pulumi.Input[builtins.str] runtime: See [Runtimes][https://www.alibabacloud.com/help/zh/function-compute/latest/manage-functions#multiTask3514] for valid values.
        :param pulumi.Input[builtins.str] service: The Function Compute service name.
        :param pulumi.Input[builtins.int] ca_port: The port that the function listen to, only valid for [custom runtime](https://www.alibabacloud.com/help/doc-detail/132044.htm) and [custom container runtime](https://www.alibabacloud.com/help/doc-detail/179368.htm).
        :param pulumi.Input[builtins.str] code_checksum: The checksum (crc64) of the function code.Used to trigger updates.The value can be generated by data source alicloud_file_crc64_checksum.
        ...
        :param pulumi.Input[builtins.str] description: The Function Compute function description.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] environment_variables: A map that defines environment variables for the function.
        :param pulumi.Input[builtins.str] filename: The path to the function's deployment package within the local filesystem. It is conflict with the `oss_`-prefixed options.
        :param pulumi.Input[builtins.int] initialization_timeout: The maximum length of time, in seconds, that the function's initialization should be run for.
        :param pulumi.Input[builtins.str] initializer: The entry point of the function's [initialization](https://www.alibabacloud.com/help/doc-detail/157704.htm).
        :param pulumi.Input[builtins.int] instance_concurrency: The maximum number of requests can be executed concurrently within the single function instance.
        :param pulumi.Input[builtins.str] instance_type: The instance type of the function.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] layers: The configuration for layers.
        :param pulumi.Input[builtins.int] memory_size: Amount of memory in MB your function can use at runtime. Defaults to `128`. Limits to [128, 32768].
        :param pulumi.Input[builtins.str] name: The Function Compute function name. It is the only in one service and is conflict with "name_prefix".
        :param pulumi.Input[builtins.str] name_prefix: Setting a prefix to get a only function name. It is conflict with "name".
        :param pulumi.Input[builtins.str] oss_bucket: The OSS bucket location containing the function's deployment package. Conflicts with `filename`. This bucket must reside in the same Alibaba Cloud region where you are creating the function.
        :param pulumi.Input[builtins.str] oss_key: The OSS key of an object containing the function's deployment package. Conflicts with `filename`.
        :param pulumi.Input[builtins.int] timeout: The amount of time your function has to run in seconds.
        """
    ...
    def ca_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @ca_port.setter
    def ca_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "ca_port", value)

    @property
    @pulumi.getter(name="codeChecksum")
    def code_checksum(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def code_checksum(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def initialization_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def initialization_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "initialization_timeout", value)

    @property
    @pulumi.getter
    def initializer(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @initializer.setter
    def initializer(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def oss_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @oss_key.setter
    def oss_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FunctionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] environment_variables: A map that defines environment variables for the function.
        :param pulumi.Input[builtins.str] filename: The path to the function's deployment package within the local filesystem. It is conflict with the `oss_`-prefixed options.
        :param pulumi.Input[builtins.str] function_arn: The Function Compute service function arn. It formats as `acs:fc:<region>:<uid>:services/<serviceName>.LATEST/functions/<functionName>`.
        :param pulumi.Input[builtins.str] function_id: The Function Compute service function ID.
        :param pulumi.Input[builtins.str] handler: The function [entry point](https://www.alibabacloud.com/help/doc-detail/157704.htm) in your code.
        :param pulumi.Input[builtins.int] initialization_timeout: The maximum length of time, in seconds, that the function's initialization should be run for.
        :param pulumi.Input[builtins.str] initializer: The entry point of the function's [initialization](https://www.alibabacloud.com/help/doc-detail/157704.htm).
        :param pulumi.Input[builtins.int] instance_concurrency: The maximum number of requests can be executed concurrently within the single function instance.
        :param pulumi.Input[builtins.str] instance_type: The instance type of the function.
        :param pulumi.Input[builtins.str] last_modified: The date this resource was last modified.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] layers: The configuration for layers.
        :param pulumi.Input[builtins.int] memory_size: Amount of memory in MB your function can use at runtime. Defaults to `128`. Limits to [128, 32768].
        :param pulumi.Input[builtins.str] name: The Function Compute function name. It is the only in one service and is conflict with "name_prefix".
        :param pulumi.Input[builtins.str] name_prefix: Setting a prefix to get a only function name. It is conflict with "name".
...
class Function(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            runtime: Optional[pulumi.Input[builtins.str]] = None,
            service: Optional[pulumi.Input[builtins.str]] = None,
            timeout: Optional[pulumi.Input[builtins.int]] = None) -> 'Function':
        """
    ...
    @property
    @pulumi.getter(name="caPort")
    def ca_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The port that the function listen to, only valid for [custom runtime](https://www.alibabacloud.com/help/doc-detail/132044.htm) and [custom container runtime](https://www.alibabacloud.com/help/doc-detail/179368.htm).
        """
        return pulumi.get(self, "ca_port")
    ...
    @property
    @pulumi.getter(name="codeChecksum")
    def code_checksum(self) -> pulumi.Output[builtins.str]:
        """
        The checksum (crc64) of the function code.Used to trigger updates.The value can be generated by data source alicloud_file_crc64_checksum.
        > **NOTE:** For more information, see [Limits](https://www.alibabacloud.com/help/doc-detail/51907.htm).
        """
    ...
    @property
    @pulumi.getter
    def filename(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The path to the function's deployment package within the local filesystem. It is conflict with the `oss_`-prefixed options.
        """
        return pulumi.get(self, "filename")
    ...
    @property
    @pulumi.getter(name="initializationTimeout")
    def initialization_timeout(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum length of time, in seconds, that the function's initialization should be run for.
        """
        return pulumi.get(self, "initialization_timeout")
    ...
    @property
    @pulumi.getter
    def initializer(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The entry point of the function's [initialization](https://www.alibabacloud.com/help/doc-detail/157704.htm).
        """
        return pulumi.get(self, "initializer")
    ...
    @property
    @pulumi.getter(name="instanceConcurrency")
    def instance_concurrency(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum number of requests can be executed concurrently within the single function instance.
        """
        return pulumi.get(self, "instance_concurrency")
    ...
    @property
    @pulumi.getter(name="ossBucket")
    def oss_bucket(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The OSS bucket location containing the function's deployment package. Conflicts with `filename`. This bucket must reside in the same Alibaba Cloud region where you are creating the function.
        """
        return pulumi.get(self, "oss_bucket")
    ...
    @property
    @pulumi.getter(name="ossKey")
    def oss_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The OSS key of an object containing the function's deployment package. Conflicts with `filename`.
        """
        return pulumi.get(self, "oss_key")
