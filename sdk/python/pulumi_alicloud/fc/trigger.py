...
class TriggerArgs:
    def __init__(__self__, *,
                 ...
                 config_mns: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] function: The Function Compute function name.
        :param pulumi.Input[builtins.str] service: The Function Compute service name.
        :param pulumi.Input[builtins.str] type: The Type of the trigger. Valid values: ["oss", "log", "timer", "http", "mns_topic", "cdn_events", "eventbridge"].
        ...
        :param pulumi.Input[builtins.str] config: The config of Function Compute trigger.It is valid when `type` is not "mns_topic".See [Configure triggers and events](https://www.alibabacloud.com/help/doc-detail/70140.htm) for more details.
        :param pulumi.Input[builtins.str] config_mns: The config of Function Compute trigger when the type is "mns_topic".It is conflict with `config`.
        :param pulumi.Input[builtins.str] name: The Function Compute trigger name. It is the only in one service and is conflict with "name_prefix".
        :param pulumi.Input[builtins.str] name_prefix: Setting a prefix to get a only trigger name. It is conflict with "name".
        :param pulumi.Input[builtins.str] role: RAM role arn attached to the Function Compute trigger. Role used by the event source to call the function. The value format is "acs:ram::$account-id:role/$role-name". See [Create a trigger](https://www.alibabacloud.com/help/doc-detail/53102.htm) for more details.
        :param pulumi.Input[builtins.str] source_arn: Event source resource address. See [Create a trigger](https://www.alibabacloud.com/help/doc-detail/53102.htm) for more details.
        """
    ...
    def config_mns(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @config_mns.setter
    def config_mns(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TriggerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service: The Function Compute service name.
        :param pulumi.Input[builtins.str] source_arn: Event source resource address. See [Create a trigger](https://www.alibabacloud.com/help/doc-detail/53102.htm) for more details.
        :param pulumi.Input[builtins.str] trigger_id: The Function Compute trigger ID.
        :param pulumi.Input[builtins.str] type: The Type of the trigger. Valid values: ["oss", "log", "timer", "http", "mns_topic", "cdn_events", "eventbridge"].
...
class Trigger(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:fc/trigger:Trigger"
    ...
    def get(resource_name: str,
            ...
            source_arn: Optional[pulumi.Input[builtins.str]] = None,
            trigger_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'Trigger':
        """
    ...
    @property
    @pulumi.getter(name="configMns")
    def config_mns(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The config of Function Compute trigger when the type is "mns_topic".It is conflict with `config`.
        """
        return pulumi.get(self, "config_mns")
