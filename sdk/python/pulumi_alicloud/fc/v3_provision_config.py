...
class V3ProvisionConfigArgs:
    def __init__(__self__, *,
                 ...
                 always_allocate_cpu: Optional[pulumi.Input[builtins.bool]] = None,
                 always_allocate_gpu: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] function_name: The name of the function. If this parameter is not specified, the provisioned configurations of all functions are listed.
        :param pulumi.Input[builtins.bool] always_allocate_cpu: Whether the CPU is always allocated. The default value is true.
        :param pulumi.Input[builtins.bool] always_allocate_gpu: Whether to always assign GPU to function instance
        :param pulumi.Input[builtins.str] qualifier: The function alias or LATEST.
        ...
        :param pulumi.Input[builtins.int] target: Number of reserved target resources. The value range is [0,10000].
    ...
    def always_allocate_cpu(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def always_allocate_cpu(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "always_allocate_cpu", value)

    @property
    @pulumi.getter(name="alwaysAllocateGpu")
    def always_allocate_gpu(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def always_allocate_gpu(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _V3ProvisionConfigState:
    def __init__(__self__, *,
                 always_allocate_cpu: Optional[pulumi.Input[builtins.bool]] = None,
                 always_allocate_gpu: Optional[pulumi.Input[builtins.bool]] = None,
                 current: Optional[pulumi.Input[builtins.int]] = None,
                 current_error: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] always_allocate_cpu: Whether the CPU is always allocated. The default value is true.
        :param pulumi.Input[builtins.bool] always_allocate_gpu: Whether to always assign GPU to function instance
        :param pulumi.Input[builtins.int] current: (Available since v1.234.0) Number of actual resources
        :param pulumi.Input[builtins.str] current_error: (Available since v1.234.0) Error message when a Reserved Instance creation fails
        :param pulumi.Input[builtins.str] function_arn: (Available since v1.234.0) Resource Description of the function
        :param pulumi.Input[builtins.str] function_name: The name of the function. If this parameter is not specified, the provisioned configurations of all functions are listed.
        :param pulumi.Input[builtins.str] qualifier: The function alias or LATEST.
        :param pulumi.Input[Sequence[pulumi.Input['V3ProvisionConfigScheduledActionArgs']]] scheduled_actions: Timing policy configuration See `scheduled_actions` below.
        :param pulumi.Input[builtins.int] target: Number of reserved target resources. The value range is [0,10000].
    ...
    @property
    @pulumi.getter
    def current(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @current.setter
    def current(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "current", value)

    @property
    @pulumi.getter(name="currentError")
    def current_error(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def current_error(self, value: Optional[pulumi.Input[builtins.str]]):
...
class V3ProvisionConfig(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="alwaysAllocateCpu")
    def always_allocate_cpu(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the CPU is always allocated. The default value is true.
        """
        return pulumi.get(self, "always_allocate_cpu")
    ...
    @property
    @pulumi.getter(name="alwaysAllocateGpu")
    def always_allocate_gpu(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to always assign GPU to function instance
        """
        return pulumi.get(self, "always_allocate_gpu")
    ...
    @property
    @pulumi.getter
    def current(self) -> pulumi.Output[builtins.int]:
        """
        (Available since v1.234.0) Number of actual resources
        """
        return pulumi.get(self, "current")
    ...
    @property
    @pulumi.getter(name="currentError")
    def current_error(self) -> pulumi.Output[builtins.str]:
        """
        (Available since v1.234.0) Error message when a Reserved Instance creation fails
        """
        return pulumi.get(self, "current_error")
    ...
    @property
    @pulumi.getter
    def target(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of reserved target resources. The value range is [0,10000].
        """
        return pulumi.get(self, "target")
