...
def get_services(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of FC services ids.
    :param builtins.str name_regex: A regex string to filter results by FC service name.
...
def get_services_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
