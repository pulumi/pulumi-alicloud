...
class V3LayerVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] layer_name: Name of the layer
        :param pulumi.Input[builtins.str] acl: The access permission of the layer, 1: public, 0: private, default is private
        :param pulumi.Input['V3LayerVersionCodeArgs'] code: Layer code configuration See `code` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] compatible_runtimes: List of runtime environments supported by the layer
        :param pulumi.Input[builtins.str] description: Description of the version
        :param pulumi.Input[builtins.str] license: Layer License Agreement
        :param pulumi.Input[builtins.str] public: Whether to expose the layer. Enumeration values: true, false. (Deprecated, please use acl instead)
        """
...
class _V3LayerVersionState:
    def __init__(__self__, *,
                 acl: Optional[pulumi.Input[builtins.str]] = None,
                 code: Optional[pulumi.Input['V3LayerVersionCodeArgs']] = None,
                 code_size: Optional[pulumi.Input[builtins.str]] = None,
                 compatible_runtimes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 create_time: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 layer_name: Optional[pulumi.Input[builtins.str]] = None,
                 layer_version_arn: Optional[pulumi.Input[builtins.str]] = None,
                 license: Optional[pulumi.Input[builtins.str]] = None,
                 public: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] acl: The access permission of the layer, 1: public, 0: private, default is private
        :param pulumi.Input['V3LayerVersionCodeArgs'] code: Layer code configuration See `code` below.
        :param pulumi.Input[builtins.str] code_size: (Available since v1.234.0) The code package size of the layer, in bytes.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] compatible_runtimes: List of runtime environments supported by the layer
        :param pulumi.Input[builtins.str] create_time: The creation time of the resource
        :param pulumi.Input[builtins.str] description: Description of the version
        :param pulumi.Input[builtins.str] layer_name: Name of the layer
        :param pulumi.Input[builtins.str] layer_version_arn: (Available since v1.234.0) Layer version ARN. The format is acs:fc:{region }:{ accountID}:layers/{layerName}/versions/{layerVersion}.
        :param pulumi.Input[builtins.str] license: Layer License Agreement
        :param pulumi.Input[builtins.str] public: Whether to expose the layer. Enumeration values: true, false. (Deprecated, please use acl instead)
        :param pulumi.Input[builtins.str] version: The version of the layer
        """
        if acl is not None:
            pulumi.set(__self__, "acl", acl)
        if code is not None:
    ...
    def code_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @code_size.setter
    def code_size(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def layer_version_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def layer_version_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class V3LayerVersion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            license: Optional[pulumi.Input[builtins.str]] = None,
            public: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'V3LayerVersion':
        """
    ...
    @property
    @pulumi.getter(name="codeSize")
    def code_size(self) -> pulumi.Output[builtins.str]:
        """
        (Available since v1.234.0) The code package size of the layer, in bytes.
        """
        return pulumi.get(self, "code_size")
    ...
    @property
    @pulumi.getter(name="layerVersionArn")
    def layer_version_arn(self) -> pulumi.Output[builtins.str]:
        """
        (Available since v1.234.0) Layer version ARN. The format is acs:fc:{region }:{ accountID}:layers/{layerName}/versions/{layerVersion}.
        """
        return pulumi.get(self, "layer_version_arn")
    ...
    @property
    @pulumi.getter
    def public(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether to expose the layer. Enumeration values: true, false. (Deprecated, please use acl instead)
        """
        return pulumi.get(self, "public")
