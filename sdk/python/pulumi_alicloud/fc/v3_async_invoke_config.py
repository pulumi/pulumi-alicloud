...
class V3AsyncInvokeConfigArgs:
    def __init__(__self__, *,
                 ...
                 async_task: Optional[pulumi.Input[builtins.bool]] = None,
                 destination_config: Optional[pulumi.Input['V3AsyncInvokeConfigDestinationConfigArgs']] = None,
                 max_async_event_age_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 max_async_retry_attempts: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.bool] async_task: Whether to enable an asynchronous task
        ...
        :param pulumi.Input[builtins.int] max_async_event_age_in_seconds: Event maximum survival time
        :param pulumi.Input[builtins.int] max_async_retry_attempts: Number of Asynchronous call retries
        :param pulumi.Input[builtins.str] qualifier: Function version or alias
        """
    ...
    def async_task(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @async_task.setter
    def async_task(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def max_async_event_age_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_async_event_age_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_async_event_age_in_seconds", value)

    @property
    @pulumi.getter(name="maxAsyncRetryAttempts")
    def max_async_retry_attempts(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_async_retry_attempts(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _V3AsyncInvokeConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['V3AsyncInvokeConfigDestinationConfigArgs'] destination_config: Target Configuration See `destination_config` below.
        :param pulumi.Input[builtins.str] function_arn: (Available since v1.234.0) Function resource identification
        :param pulumi.Input[builtins.str] function_name: Function Name
        :param pulumi.Input[builtins.str] last_modified_time: (Available since v1.234.0) Last modification time
        :param pulumi.Input[builtins.int] max_async_event_age_in_seconds: Event maximum survival time
        :param pulumi.Input[builtins.int] max_async_retry_attempts: Number of Asynchronous call retries
        :param pulumi.Input[builtins.str] qualifier: Function version or alias
        """
...
class V3AsyncInvokeConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            max_async_event_age_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
            max_async_retry_attempts: Optional[pulumi.Input[builtins.int]] = None,
            qualifier: Optional[pulumi.Input[builtins.str]] = None) -> 'V3AsyncInvokeConfig':
        """
    ...
    @property
    @pulumi.getter(name="asyncTask")
    def async_task(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable an asynchronous task
        """
        return pulumi.get(self, "async_task")
    ...
    @property
    @pulumi.getter(name="maxAsyncEventAgeInSeconds")
    def max_async_event_age_in_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Event maximum survival time
        """
        return pulumi.get(self, "max_async_event_age_in_seconds")
    ...
    @property
    @pulumi.getter(name="maxAsyncRetryAttempts")
    def max_async_retry_attempts(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of Asynchronous call retries
        """
        return pulumi.get(self, "max_async_retry_attempts")
