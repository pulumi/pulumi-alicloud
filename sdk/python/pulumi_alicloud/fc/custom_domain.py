...
class CustomDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_name: The custom domain name. For example, "example.com".
        :param pulumi.Input[builtins.str] protocol: The protocol, `HTTP` or `HTTP,HTTPS`.
...
class _CustomDomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_version: The api version of Function Compute.
        :param pulumi.Input['CustomDomainCertConfigArgs'] cert_config: The configuration of HTTPS certificate.See `cert_config` below.
