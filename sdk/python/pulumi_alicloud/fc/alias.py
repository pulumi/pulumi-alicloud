...
class AliasArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alias_name: Name for the alias you are creating.
        :param pulumi.Input[builtins.str] service_name: The Function Compute service name.
        :param pulumi.Input[builtins.str] service_version: The Function Compute service version for which you are creating the alias. Pattern: (LATEST|[0-9]+).
...
@pulumi.type_token("alicloud:fc/alias:Alias")
class Alias(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            routing_config: Optional[pulumi.Input[Union['AliasRoutingConfigArgs', 'AliasRoutingConfigArgsDict']]] = None,
            service_name: Optional[pulumi.Input[builtins.str]] = None,
            service_version: Optional[pulumi.Input[builtins.str]] = None) -> 'Alias':
        """
