...
def get_triggers(function_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str function_name: FC function name.
    :param Sequence[_builtins.str] ids: A list of FC triggers ids.
    :param _builtins.str name_regex: A regex string to filter results by FC trigger name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str service_name: FC service name.
    """
    __args__ = dict()
...
def get_triggers_output(function_name: Optional[pulumi.Input[_builtins.str]] = None,
