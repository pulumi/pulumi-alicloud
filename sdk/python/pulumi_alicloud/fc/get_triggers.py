...
def get_triggers(function_name: Optional[builtins.str] = None,
    ...
    :param builtins.str function_name: FC function name.
    :param Sequence[builtins.str] ids: A list of FC triggers ids.
    :param builtins.str name_regex: A regex string to filter results by FC trigger name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str service_name: FC service name.
    """
    __args__ = dict()
...
def get_triggers_output(function_name: Optional[pulumi.Input[builtins.str]] = None,
