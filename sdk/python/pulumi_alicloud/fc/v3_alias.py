...
class V3AliasArgs:
    def __init__(__self__, *,
                 ...
                 additional_version_weight: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.float]]]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.float]]] additional_version_weight: Grayscale version
        :param pulumi.Input[builtins.str] alias_name: Function Alias
        :param pulumi.Input[builtins.str] description: Description
        :param pulumi.Input[builtins.str] version_id: The version that the alias points
        """
    ...
    def additional_version_weight(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.float]]]]:
        """
        Grayscale version
        """
    ...
    def additional_version_weight(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.float]]]]):
...
class V3Alias(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            function_name: Optional[pulumi.Input[builtins.str]] = None,
            last_modified_time: Optional[pulumi.Input[builtins.str]] = None,
            version_id: Optional[pulumi.Input[builtins.str]] = None) -> 'V3Alias':
        """
    ...
    @property
    @pulumi.getter(name="additionalVersionWeight")
    def additional_version_weight(self) -> pulumi.Output[Optional[Mapping[str, builtins.float]]]:
        """
        Grayscale version
        """
        return pulumi.get(self, "additional_version_weight")
