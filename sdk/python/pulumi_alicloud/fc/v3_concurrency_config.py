...
class V3ConcurrencyConfigArgs:
    def __init__(__self__, *,
                 ...
                 reserved_concurrency: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] reserved_concurrency: Reserved Concurrency. Functions reserve a part of account concurrency. Other functions cannot use this part of concurrency. Reserved concurrency includes the total concurrency of Reserved Instances and As-You-go instances.
        """
    ...
    def reserved_concurrency(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def reserved_concurrency(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _V3ConcurrencyConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] function_arn: (Available since v1.234.0) Resource identity of the function
        :param pulumi.Input[builtins.str] function_name: Function Name
        :param pulumi.Input[builtins.int] reserved_concurrency: Reserved Concurrency. Functions reserve a part of account concurrency. Other functions cannot use this part of concurrency. Reserved concurrency includes the total concurrency of Reserved Instances and As-You-go instances.
        """
...
class V3ConcurrencyConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            function_arn: Optional[pulumi.Input[builtins.str]] = None,
            function_name: Optional[pulumi.Input[builtins.str]] = None,
            reserved_concurrency: Optional[pulumi.Input[builtins.int]] = None) -> 'V3ConcurrencyConfig':
        """
    ...
    @property
    @pulumi.getter(name="reservedConcurrency")
    def reserved_concurrency(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Reserved Concurrency. Functions reserve a part of account concurrency. Other functions cannot use this part of concurrency. Reserved concurrency includes the total concurrency of Reserved Instances and As-You-go instances.
        """
        return pulumi.get(self, "reserved_concurrency")
