...
def get_custom_domains(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of functions ids.
    :param builtins.str name_regex: A regex string to filter results by Function Compute custom domain name.
...
def get_custom_domains_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
