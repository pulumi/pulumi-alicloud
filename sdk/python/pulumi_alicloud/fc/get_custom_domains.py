...
def get_custom_domains(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param _builtins.str name_regex: A regex string to filter results by Function Compute custom domain name.
...
def get_custom_domains_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
