...
@pulumi.output_type
class HyperNodeDataDisk(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "burstingEnabled":
            suggest = "bursting_enabled"
        elif key == "deleteWithNode":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in HyperNodeDataDisk. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        HyperNodeDataDisk.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool bursting_enabled: Whether to enable Burst (performance Burst).
        :param _builtins.str category: The disk type. Value range:
               - cloud_essd:ESSD cloud disk.
        :param _builtins.bool delete_with_node: Whether the data disk is unsubscribed and deleted with the node.
        :param _builtins.str performance_level: When creating an ESSD cloud disk to use as a system disk, set the performance level of the cloud disk. Value range:
               - PL0: maximum random read/write IOPS 10000 for a single disk.
               - PL1: maximum random read/write IOPS 50000 for a single disk.
        :param _builtins.int provisioned_iops: ESSD AutoPL cloud disk (single disk) pre-configuration performance of IOPS.
        :param _builtins.int size: The size of the disk. The unit is GiB.
        """
