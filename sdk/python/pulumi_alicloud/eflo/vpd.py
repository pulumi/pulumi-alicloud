...
class VpdArgs:
    def __init__(__self__, *,
                 ...
                 vpd_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] vpd_name: The Name of the VPD.
    ...
    def vpd_name(self) -> pulumi.Input[builtins.str]:
        """
        The Name of the VPD.
        """
    ...
    @vpd_name.setter
    def vpd_name(self, value: pulumi.Input[builtins.str]):
...
class _VpdState:
    def __init__(__self__, *,
                 ...
                 vpd_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] resource_group_id: The Resource group id.
        :param pulumi.Input[builtins.str] status: The Vpd status.
        :param pulumi.Input[builtins.str] vpd_name: The Name of the VPD.
        """
        if cidr is not None:
            pulumi.set(__self__, "cidr", cidr)
    ...
    @property
    @pulumi.getter(name="vpdName")
    def vpd_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Name of the VPD.
        """
        return pulumi.get(self, "vpd_name")
    ...
    @vpd_name.setter
    def vpd_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpd_name", value)
...
class Vpd(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpd_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Vpd':
        """
    ...
    @property
    @pulumi.getter(name="vpdName")
    def vpd_name(self) -> pulumi.Output[builtins.str]:
        """
        The Name of the VPD.
        """
        return pulumi.get(self, "vpd_name")
