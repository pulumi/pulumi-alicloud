...
class GetVpdsResult:
    ...
    def vpd_name(self) -> Optional[_builtins.str]:
        """
        The Name of the VPD.
        """
...
def get_vpds(enable_details: Optional[_builtins.bool] = None,
             ...
             vpd_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Vpd IDs.
...
def get_vpds_output(enable_details: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                    ...
                    vpd_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                    vpd_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
