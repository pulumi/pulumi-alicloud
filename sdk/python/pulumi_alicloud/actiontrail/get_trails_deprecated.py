...
def get_trails_deprecated(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str name_regex: A regex string to filter results action trail name.
...
def get_trails_deprecated_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:actiontrail/getTrailsDeprecated:getTrailsDeprecated', __args__, opts=opts, typ=GetTrailsDeprecatedResult)
    return __ret__.apply(lambda __response__: GetTrailsDeprecatedResult(
