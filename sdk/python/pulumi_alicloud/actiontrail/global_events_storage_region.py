...
class GlobalEventsStorageRegionArgs:
    def __init__(__self__, *,
                 storage_region: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a GlobalEventsStorageRegion resource.
        :param pulumi.Input[builtins.str] storage_region: Global Events Storage Region.
        """
    ...
    def storage_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_region(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GlobalEventsStorageRegion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            storage_region: Optional[pulumi.Input[builtins.str]] = None) -> 'GlobalEventsStorageRegion':
        """
    ...
    @property
    @pulumi.getter(name="storageRegion")
    def storage_region(self) -> pulumi.Output[builtins.str]:
        """
        Global Events Storage Region.
        """
        return pulumi.get(self, "storage_region")
