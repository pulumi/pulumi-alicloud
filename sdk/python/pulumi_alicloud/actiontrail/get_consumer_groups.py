...
class GetConsumerGroupsResult:
    ...
    def consumer_id_regex(self) -> Optional[builtins.str]:
        return pulumi.get(self, "consumer_id_regex")

    @property
    @pulumi.getter(name="consumerIds")
    def consumer_ids(self) -> Sequence[builtins.str]:
...
def get_consumer_groups(consumer_id_regex: Optional[builtins.str] = None,
    ...
    :param builtins.str consumer_id_regex: A regex string to filter results by the consumer group id.
    :param Sequence[builtins.str] ids: A list of ALIKAFKA Consumer Groups IDs, It is formatted to `<instance_id>:<consumer_id>`.
...
def get_consumer_groups_output(consumer_id_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
