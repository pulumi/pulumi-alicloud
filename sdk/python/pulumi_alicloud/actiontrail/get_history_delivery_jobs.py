...
def get_history_delivery_jobs(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of History Delivery Job IDs.
...
def get_history_delivery_jobs_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
