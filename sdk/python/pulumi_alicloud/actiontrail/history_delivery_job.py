...
class HistoryDeliveryJobArgs:
    def __init__(__self__, *,
                 trail_name: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a HistoryDeliveryJob resource.
        :param pulumi.Input[builtins.str] trail_name: The name of the trail for which you want to create a historical event delivery task.
        """
        pulumi.set(__self__, "trail_name", trail_name)

    @property
    @pulumi.getter(name="trailName")
    def trail_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @trail_name.setter
    def trail_name(self, value: pulumi.Input[builtins.str]):
...
class _HistoryDeliveryJobState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] status: The status of the task. Valid values: `0`, `1`, `2`, `3`. `0`: The task is initializing. `1`: The task is delivering historical events. `2`: The delivery of historical events is complete. `3`: The task fails.
        :param pulumi.Input[builtins.str] trail_name: The name of the trail for which you want to create a historical event delivery task.
        """
...
class HistoryDeliveryJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            status: Optional[pulumi.Input[builtins.int]] = None,
            trail_name: Optional[pulumi.Input[builtins.str]] = None) -> 'HistoryDeliveryJob':
        """
