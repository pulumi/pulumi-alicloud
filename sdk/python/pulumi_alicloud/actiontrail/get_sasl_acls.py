...
def get_sasl_acls(acl_resource_name: Optional[builtins.str] = None,
                  acl_resource_type: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_id: ID of the ALIKAFKA Instance that owns the sasl acls.
...
def get_sasl_acls_output(acl_resource_name: Optional[pulumi.Input[builtins.str]] = None,
