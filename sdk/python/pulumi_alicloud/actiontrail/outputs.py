...
class GetConsumerGroupsGroupResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str consumer_id: The name of the consumer group.
        :param builtins.str id: The ID of the consumer group, It is formatted to `<instance_id>:<consumer_id>`.
        :param builtins.str instance_id: ID of the ALIKAFKA Instance that owns the consumer groups.
        :param builtins.str remark: The remark of the consumer group.
        :param Mapping[str, builtins.str] tags: A mapping of tags to assign to the consumer group.
        """
...
class GetHistoryDeliveryJobsJobResult(dict):
    def __init__(__self__, *,
                 ...
                 history_delivery_job_id: builtins.str,
        ...
        """
        :param builtins.str create_time: The time when the task was created.
        :param builtins.str end_time: The time when the task ended.
        :param builtins.str home_region: The home region of the trail.
        :param builtins.str id: The ID of the History Delivery Job.
        :param Sequence['GetHistoryDeliveryJobsJobJobStatusArgs'] job_statuses: Detail status of delivery job.
        :param builtins.str start_time: The time when the task started.
        :param builtins.int status: The status of the task. Valid values: `0`, `1`, `2`, `3`. `0`: The task is initializing. `1`: The task is delivering historical events. `2`: The delivery of historical events is complete. `3`: The task fails.
        :param builtins.str trail_name: The name of the trail.
        :param builtins.str updated_time: The time when the task was updated.
        """
    ...
    def history_delivery_job_id(self) -> builtins.str:
...
class GetHistoryDeliveryJobsJobJobStatusResult(dict):
    def __init__(__self__, *,
                 ...
                 status: builtins.int):
        """
        :param builtins.str region: The region of the delivery job.
        :param builtins.int status: The status of the task. Valid values: `0`, `1`, `2`, `3`. `0`: The task is initializing. `1`: The task is delivering historical events. `2`: The delivery of historical events is complete. `3`: The task fails.
        """
...
class GetInstancesInstanceResult(dict):
    def __init__(__self__, *,
                 ...
                 config: builtins.str,
                 create_time: builtins.str,
                 deploy_type: builtins.int,
                 disk_size: builtins.int,
                 disk_type: builtins.int,
                 domain_endpoint: builtins.str,
                 eip_max: builtins.int,
                 end_point: builtins.str,
                 expired_time: builtins.int,
                 id: builtins.str,
                 io_max: builtins.int,
                 msg_retain: builtins.int,
                 name: builtins.str,
                 paid_type: builtins.str,
                 partition_num: builtins.int,
                 sasl_domain_endpoint: builtins.str,
                 security_group: builtins.str,
                 service_status: builtins.int,
                 service_version: builtins.str,
                 spec_type: builtins.str,
                 ssl_domain_endpoint: builtins.str,
                 ssl_end_point: builtins.str,
                 topic_quota: builtins.int,
        ...
        :param builtins.str config: The config the instance.
        :param builtins.str create_time: The create time of the instance.
        :param builtins.int deploy_type: The deployed type of the instance.
        :param builtins.int disk_size: The disk size of the instance.
        :param builtins.int disk_type: The disk type of the instance. 0: efficient cloud disk , 1: SSD.
        :param builtins.str domain_endpoint: The domain point of the instance.
        :param builtins.int eip_max: The peak bandwidth of the instance.
        :param builtins.str end_point: The endPoint to access the instance.
        :param builtins.int expired_time: The expired time  of the instance.
        :param builtins.str id: ID of the instance.
        :param builtins.int io_max: The peak value of io of the instance.
        :param builtins.int msg_retain: The msg retain of the instance.
        :param builtins.str name: Name of the instance.
        :param builtins.str paid_type: The paid type of the instance.
        :param builtins.int partition_num: (Available in 1.194.0+) The number of partitions.
        :param builtins.str sasl_domain_endpoint: The SASL domain point of the instance.
        :param builtins.str security_group: The security group of the instance.
        :param builtins.int service_status: The current status of the instance. -1: unknown status, 0: wait deploy, 1: initializing, 2: preparing, 3 starting, 5: in service, 7: wait upgrade, 8: upgrading, 10: released, 15: freeze, 101: deploy error, 102: upgrade error.
        :param builtins.str service_version: The kafka openSource version of the instance.
        :param builtins.str spec_type: The spec type of the instance.
        :param builtins.str ssl_domain_endpoint: The SSL domain point of the instance.
        :param builtins.str ssl_end_point: The SSL end point of the instance.
        :param builtins.int topic_quota: The max num of topic can be create of the instance.
        ...
        :param builtins.str vswitch_id: The ID of attaching vswitch to instance.
        :param builtins.str zone_id: The ID of attaching zone to instance.
        :param Mapping[str, builtins.str] tags: A mapping of tags to assign to the instance.
        """
    ...
    def deploy_type(self) -> builtins.int:
        """
    ...
    def disk_type(self) -> builtins.int:
        """
    ...
    def msg_retain(self) -> builtins.int:
        """
    ...
    def paid_type(self) -> builtins.str:
        """
    ...
    def sasl_domain_endpoint(self) -> builtins.str:
        """
    ...
    def service_status(self) -> builtins.int:
        """
    ...
    def ssl_domain_endpoint(self) -> builtins.str:
        """
    ...
    def ssl_end_point(self) -> builtins.str:
        """
    ...
    def topic_quota(self) -> builtins.int:
        """
...
class GetInstancesInstanceAllowedListResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str deploy_type: The deployed type of the instance.
...
class GetInstancesInstanceAllowedListInternetListResult(dict):
    def __init__(__self__, *,
                 allowed_ip_lists: Sequence[builtins.str],
                 port_range: builtins.str):
        """
        :param Sequence[builtins.str] allowed_ip_lists: The allowed ip list of the internet_list.
        :param builtins.str port_range: The port range of the internet_list.
        """
    ...
    def allowed_ip_lists(self) -> Sequence[builtins.str]:
        """
...
class GetInstancesInstanceUpgradeServiceDetailInfoResult(dict):
    def __init__(__self__, *,
                 current2_open_source_version: builtins.str):
        """
        :param builtins.str current2_open_source_version: The Current2OpenSourceVersion of the instance.
        """
    ...
    def current2_open_source_version(self) -> builtins.str:
        """
...
class GetSaslAclsAclResult(dict):
    def __init__(__self__, *,
                 acl_operation_type: builtins.str,
                 acl_resource_name: builtins.str,
                 acl_resource_pattern_type: builtins.str,
                 acl_resource_type: builtins.str,
                 host: builtins.str,
                 username: builtins.str):
        """
        :param builtins.str acl_operation_type: The operation type of the sasl acl.
        :param builtins.str acl_resource_name: Get results for the specified resource name.
        :param builtins.str acl_resource_pattern_type: The resource pattern type of the sasl acl.
        :param builtins.str acl_resource_type: Get results for the specified resource type.
        :param builtins.str host: The host of the sasl acl.
        :param builtins.str username: Get results for the specified username.
        """
    ...
    def acl_operation_type(self) -> builtins.str:
        """
    ...
    def acl_resource_name(self) -> builtins.str:
        """
    ...
    def acl_resource_pattern_type(self) -> builtins.str:
        """
    ...
    def acl_resource_type(self) -> builtins.str:
        """
...
class GetTopicsTopicResult(dict):
    def __init__(__self__, *,
                 compact_topic: builtins.bool,
                 create_time: builtins.str,
                 id: builtins.str,
                 instance_id: builtins.str,
                 local_topic: builtins.bool,
                 partition_num: builtins.int,
                 remark: builtins.str,
                 status: builtins.int,
                 status_name: builtins.str,
                 topic: builtins.str,
                 tags: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.bool compact_topic: whether the current topic is kafka compact topic or not.
        :param builtins.str create_time: Time of creation.
        :param builtins.str id: The ID of the topic, It is formatted to `<instance_id>:<topic>`.
        :param builtins.str instance_id: ID of the instance.
        :param builtins.bool local_topic: whether the current topic is kafka local topic or not.
        :param builtins.int partition_num: Partition number of the topic.
        :param builtins.str remark: Remark of the topic.
        :param builtins.int status: The current status code of the topic. There are three values to describe the topic status: 0 stands for the topic is in service, 1 stands for freezing and 2 stands for pause.
        :param builtins.str status_name: The status_name of the topic.
        :param builtins.str topic: A topic to filter results by the topic name.
        :param Mapping[str, builtins.str] tags: A mapping of tags to assign to the topic.
        """
    ...
    def compact_topic(self) -> builtins.bool:
        """
    ...
    def local_topic(self) -> builtins.bool:
        """
...
class GetTrailsActiontrailResult(dict):
    def __init__(__self__, *,
                 event_rw: builtins.str,
                 id: builtins.str,
                 is_organization_trail: builtins.bool,
                 oss_bucket_name: builtins.str,
                 oss_key_prefix: builtins.str,
                 oss_write_role_arn: builtins.str,
                 sls_project_arn: builtins.str,
                 sls_write_role_arn: builtins.str,
                 status: builtins.str,
                 trail_name: builtins.str,
                 trail_region: builtins.str):
        """
        :param builtins.str event_rw: Indicates whether the event is a read or a write event.
        :param builtins.str id: The id of the ActionTrail Trail. It is the same as trail name.
        :param builtins.str oss_bucket_name: The name of the specified OSS bucket.
        :param builtins.str oss_key_prefix: The prefix of the specified OSS bucket name.
        :param builtins.str sls_project_arn: The unique ARN of the Log Service project.
        :param builtins.str sls_write_role_arn: The unique ARN of the Log Service role.
        :param builtins.str status: Filter the results by status of the ActionTrail Trail. Valid values: `Disable`, `Enable`, `Fresh`.
        :param builtins.str trail_name: The name of the ActionTrail Trail.
        :param builtins.str trail_region: The regions to which the trail is applied.
        """
    ...
    def event_rw(self) -> builtins.str:
        """
    ...
    def is_organization_trail(self) -> builtins.bool:
    ...
    def oss_key_prefix(self) -> builtins.str:
        """
    ...
    def oss_write_role_arn(self) -> builtins.str:
        return pulumi.get(self, "oss_write_role_arn")

    @property
    @pulumi.getter(name="slsProjectArn")
    def sls_project_arn(self) -> builtins.str:
        """
    ...
    def sls_write_role_arn(self) -> builtins.str:
        """
    ...
    def trail_region(self) -> builtins.str:
        """
