...
def get_topics(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of ALIKAFKA Topics IDs, It is formatted to `<instance_id>:<topic>`.
    :param builtins.str instance_id: ID of the instance.
    :param builtins.str name_regex: A regex string to filter results by the topic name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str topic: A topic to filter results by the topic name.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_topics_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                      ...
                      topic: Optional[pulumi.Input[Optional[builtins.str]]] = None,
