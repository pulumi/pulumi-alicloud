...
def get_topics(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of ALIKAFKA Topics IDs, It is formatted to `<instance_id>:<topic>`.
    :param _builtins.str instance_id: ID of the instance.
    :param _builtins.str name_regex: A regex string to filter results by the topic name.
