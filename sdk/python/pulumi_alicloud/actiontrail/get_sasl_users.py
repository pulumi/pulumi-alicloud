...
def get_sasl_users(instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_id: ID of the ALIKAFKA Instance that owns the sasl users.
    :param builtins.str name_regex: A regex string to filter results by the username.
...
def get_sasl_users_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
