...
class GetTrailsResult:
    ...
    def include_organization_trail(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "include_organization_trail")

    @property
    @pulumi.getter(name="includeShadowTrails")
    def include_shadow_trails(self) -> Optional[builtins.bool]:
...
def get_trails(ids: Optional[Sequence[builtins.str]] = None,
               include_organization_trail: Optional[builtins.bool] = None,
               include_shadow_trails: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of ActionTrail Trail IDs. It is the same as trail name.
    :param builtins.bool include_organization_trail: Whether to show organization tracking. Default to `false`.
    :param builtins.bool include_shadow_trails: Whether to show shadow tracking. Default to `false`.
    :param builtins.str name_regex: A regex string to filter results by trail name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: Filter the results by status of the ActionTrail Trail. Valid values: `Disable`, `Enable`, `Fresh`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_trails_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                      include_organization_trail: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      include_shadow_trails: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
