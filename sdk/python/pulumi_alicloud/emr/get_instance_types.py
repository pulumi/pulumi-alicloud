...
class GetInstanceTypesResult:
    ...
    def destination_resource(self) -> _builtins.str:
    ...
    def support_local_storage(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "support_local_storage")

    @_builtins.property
    @pulumi.getter(name="supportNodeTypes")
    def support_node_types(self) -> Optional[Sequence[_builtins.str]]:
...
def get_instance_types(cluster_type: Optional[_builtins.str] = None,
                       destination_resource: Optional[_builtins.str] = None,
                       instance_charge_type: Optional[_builtins.str] = None,
                       instance_type: Optional[_builtins.str] = None,
                       output_file: Optional[_builtins.str] = None,
                       support_local_storage: Optional[_builtins.bool] = None,
                       support_node_types: Optional[Sequence[_builtins.str]] = None,
    ...
    :param _builtins.str cluster_type: The cluster type of the emr cluster instance. Possible values: `HADOOP`, `KAFKA`, `ZOOKEEPER`, `DRUID`.
    :param _builtins.str destination_resource: The destination resource of emr cluster instance
    ...
    :param _builtins.str instance_type: Filter the specific ecs instance type to create emr cluster.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.bool support_local_storage: Whether the current storage disk is local or not.
    :param Sequence[_builtins.str] support_node_types: The specific supported node type list.
