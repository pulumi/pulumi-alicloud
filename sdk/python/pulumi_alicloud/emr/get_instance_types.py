...
class GetInstanceTypesResult:
    ...
    def destination_resource(self) -> builtins.str:
    ...
    def support_local_storage(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "support_local_storage")

    @property
    @pulumi.getter(name="supportNodeTypes")
    def support_node_types(self) -> Optional[Sequence[builtins.str]]:
...
def get_instance_types(cluster_type: Optional[builtins.str] = None,
                       destination_resource: Optional[builtins.str] = None,
                       ...
                       support_local_storage: Optional[builtins.bool] = None,
                       support_node_types: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str cluster_type: The cluster type of the emr cluster instance. Possible values: `HADOOP`, `KAFKA`, `ZOOKEEPER`, `DRUID`.
    :param builtins.str destination_resource: The destination resource of emr cluster instance
    ...
    :param builtins.str instance_type: Filter the specific ecs instance type to create emr cluster.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.bool support_local_storage: Whether the current storage disk is local or not.
    :param Sequence[builtins.str] support_node_types: The specific supported node type list.
...
def get_instance_types_output(cluster_type: Optional[pulumi.Input[builtins.str]] = None,
                              destination_resource: Optional[pulumi.Input[builtins.str]] = None,
                              ...
                              support_local_storage: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                              support_node_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
