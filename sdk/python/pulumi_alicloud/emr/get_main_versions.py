...
class GetMainVersionsResult:
    ...
    def emr_version(self) -> Optional[builtins.str]:
        """
...
def get_main_versions(cluster_types: Optional[Sequence[builtins.str]] = None,
                      emr_version: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] cluster_types: The supported clusterType of this emr version.
...
def get_main_versions_output(cluster_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             emr_version: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetMainVersionsResult]:
    """
    The `emr_get_main_versions` data source provides a collection of emr
    main versions available in Alibaba Cloud account when create a emr cluster.
