...
def get_disk_types(cluster_type: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_type: The ecs instance type of create emr cluster instance.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str zone_id: The Zone to create emr cluster instance.
    """
    __args__ = dict()
...
def get_disk_types_output(cluster_type: Optional[pulumi.Input[builtins.str]] = None,
