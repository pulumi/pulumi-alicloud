...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 instance_storage: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] instance_class: The specification of the instance. 
        ...
        :param pulumi.Input[builtins.str] instance_storage: The storage capacity of the instance. Unit: GB. For example, the value 50 indicates 50 GB. Does not support shrink storage.
        :param pulumi.Input[builtins.str] payment_type: The billing method. Valid values: `PayAsYouGo` and `Subscription`. The `PayAsYouGo` value indicates the pay-as-you-go method, and the `Subscription` value indicates the subscription method.
        :param pulumi.Input[builtins.str] vswitch_id: The vswitch id.
        :param pulumi.Input[builtins.str] app_key: The app key.
        :param pulumi.Input[builtins.str] disk_category: The disk type of instance. Valid when the engine type is `tsdb_influxdb`. `cloud_ssd` refers to SSD disk, `cloud_efficiency` refers to efficiency disk, `cloud_essd` refers to ESSD PL1 disk. Valid values: `cloud_efficiency`, `cloud_essd`, `cloud_ssd`.
        :param pulumi.Input[builtins.str] duration: The duration.
        :param pulumi.Input[builtins.str] engine_type: The engine type of instance Enumerative: `tsdb_tsdb` refers to TSDB, `tsdb_influxdb` refers to TSDB for InfluxDB️.
        :param pulumi.Input[builtins.str] instance_alias: The alias of the instance.
    ...
    def instance_storage(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def instance_storage(self, value: pulumi.Input[builtins.str]):
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_storage: The storage capacity of the instance. Unit: GB. For example, the value 50 indicates 50 GB. Does not support shrink storage.
        :param pulumi.Input[builtins.str] payment_type: The billing method. Valid values: `PayAsYouGo` and `Subscription`. The `PayAsYouGo` value indicates the pay-as-you-go method, and the `Subscription` value indicates the subscription method.
        :param pulumi.Input[builtins.str] status: Instance status, enumerative: `ACTIVATION`, `DELETED`, `CREATING`, `CLASS_CHANGING`, `LOCKED`.
        :param pulumi.Input[builtins.str] vswitch_id: The vswitch id.
        :param pulumi.Input[builtins.str] zone_id: The zone ID of the instance.
        """
        if app_key is not None:
...
@pulumi.type_token("alicloud:tsdb/instance:Instance")
class Instance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="appKey")
    def app_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The app key.
        """
        return pulumi.get(self, "app_key")
    ...
    @property
    @pulumi.getter(name="instanceAlias")
    def instance_alias(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The alias of the instance.
        """
        return pulumi.get(self, "instance_alias")
