...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_storage: The storage capacity of the instance. Unit: GB. For example, the value 50 indicates 50 GB. Does not support shrink storage.
        :param pulumi.Input[_builtins.str] payment_type: The billing method. Valid values: `PayAsYouGo` and `Subscription`. The `PayAsYouGo` value indicates the pay-as-you-go method, and the `Subscription` value indicates the subscription method.
    ...
    def instance_storage(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def instance_storage(self, value: pulumi.Input[_builtins.str]):
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_storage: The storage capacity of the instance. Unit: GB. For example, the value 50 indicates 50 GB. Does not support shrink storage.
        :param pulumi.Input[_builtins.str] payment_type: The billing method. Valid values: `PayAsYouGo` and `Subscription`. The `PayAsYouGo` value indicates the pay-as-you-go method, and the `Subscription` value indicates the subscription method.
        :param pulumi.Input[_builtins.str] status: Instance status, enumerative: `ACTIVATION`, `DELETED`, `CREATING`, `CLASS_CHANGING`, `LOCKED`.
        :param pulumi.Input[_builtins.str] vswitch_id: The vswitch id.
        :param pulumi.Input[_builtins.str] zone_id: The zone ID of the instance.
        """
        if app_key is not None:
