...
def get_oss_backup_plans(bucket: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of OssBackupPlan IDs.
    :param _builtins.str name_regex: A regex string to filter results by OssBackupPlan name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str vault_id: The ID of backup vault the OssBackupPlan used.
    """
    __args__ = dict()
