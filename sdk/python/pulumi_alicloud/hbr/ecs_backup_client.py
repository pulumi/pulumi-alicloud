...
class EcsBackupClientArgs:
    def __init__(__self__, *,
                 ...
                 data_network_type: Optional[pulumi.Input[builtins.str]] = None,
                 data_proxy_setting: Optional[pulumi.Input[builtins.str]] = None,
                 max_cpu_core: Optional[pulumi.Input[builtins.str]] = None,
                 max_worker: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_host: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_password: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_port: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_user: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 use_https: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a EcsBackupClient resource.
        :param pulumi.Input[builtins.str] instance_id: The ID of ECS instance.
        :param pulumi.Input[builtins.str] data_network_type: The data plane access point type. Valid values: `CLASSIC`, `PUBLIC`, `VPC`. **NOTE:** The value of `CLASSIC` has been deprecated in v1.161.0+.
        :param pulumi.Input[builtins.str] data_proxy_setting: The data plane proxy settings. Valid values: `CUSTOM`, `DISABLE`, `USE_CONTROL_PROXY`.
        :param pulumi.Input[builtins.str] max_cpu_core: The number of CPU cores used by a single backup task, 0 means no restrictions.
        :param pulumi.Input[builtins.str] max_worker: The number of concurrent jobs for a single backup task, 0 means no restrictions.
        :param pulumi.Input[builtins.str] proxy_host: Custom data plane proxy server host address.
        :param pulumi.Input[builtins.str] proxy_password: The password of custom data plane proxy server.
        :param pulumi.Input[builtins.str] proxy_port: Custom data plane proxy server host port.
        :param pulumi.Input[builtins.str] proxy_user: The username of custom data plane proxy server.
        :param pulumi.Input[builtins.str] status: Status of client. Valid values: `ACTIVATED`, `STOPPED`. You can start or stop the client by specifying the status.
        :param pulumi.Input[builtins.bool] use_https: Indicates whether to use the HTTPS protocol. Valid values: `true`, `false`.
        """
    ...
    def data_network_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_network_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_network_type", value)

    @property
    @pulumi.getter(name="dataProxySetting")
    def data_proxy_setting(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_proxy_setting(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_proxy_setting", value)

    @property
    @pulumi.getter(name="maxCpuCore")
    def max_cpu_core(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @max_cpu_core.setter
    def max_cpu_core(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "max_cpu_core", value)

    @property
    @pulumi.getter(name="maxWorker")
    def max_worker(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @max_worker.setter
    def max_worker(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "max_worker", value)

    @property
    @pulumi.getter(name="proxyHost")
    def proxy_host(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @proxy_host.setter
    def proxy_host(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "proxy_host", value)

    @property
    @pulumi.getter(name="proxyPassword")
    def proxy_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def proxy_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "proxy_password", value)

    @property
    @pulumi.getter(name="proxyPort")
    def proxy_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @proxy_port.setter
    def proxy_port(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "proxy_port", value)

    @property
    @pulumi.getter(name="proxyUser")
    def proxy_user(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @proxy_user.setter
    def proxy_user(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def use_https(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @use_https.setter
    def use_https(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class EcsBackupClient(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            proxy_user: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            use_https: Optional[pulumi.Input[builtins.bool]] = None) -> 'EcsBackupClient':
        """
    ...
    @property
    @pulumi.getter(name="dataNetworkType")
    def data_network_type(self) -> pulumi.Output[builtins.str]:
        """
        The data plane access point type. Valid values: `CLASSIC`, `PUBLIC`, `VPC`. **NOTE:** The value of `CLASSIC` has been deprecated in v1.161.0+.
        """
        return pulumi.get(self, "data_network_type")
    ...
    @property
    @pulumi.getter(name="dataProxySetting")
    def data_proxy_setting(self) -> pulumi.Output[builtins.str]:
        """
        The data plane proxy settings. Valid values: `CUSTOM`, `DISABLE`, `USE_CONTROL_PROXY`.
        """
        return pulumi.get(self, "data_proxy_setting")
    ...
    @property
    @pulumi.getter(name="maxCpuCore")
    def max_cpu_core(self) -> pulumi.Output[builtins.str]:
        """
        The number of CPU cores used by a single backup task, 0 means no restrictions.
        """
        return pulumi.get(self, "max_cpu_core")
    ...
    @property
    @pulumi.getter(name="maxWorker")
    def max_worker(self) -> pulumi.Output[builtins.str]:
        """
        The number of concurrent jobs for a single backup task, 0 means no restrictions.
        """
        return pulumi.get(self, "max_worker")
    ...
    @property
    @pulumi.getter(name="proxyHost")
    def proxy_host(self) -> pulumi.Output[builtins.str]:
        """
        Custom data plane proxy server host address.
        """
        return pulumi.get(self, "proxy_host")
    ...
    @property
    @pulumi.getter(name="proxyPassword")
    def proxy_password(self) -> pulumi.Output[builtins.str]:
        """
        The password of custom data plane proxy server.
        """
        return pulumi.get(self, "proxy_password")
    ...
    @property
    @pulumi.getter(name="proxyPort")
    def proxy_port(self) -> pulumi.Output[builtins.str]:
        """
        Custom data plane proxy server host port.
        """
        return pulumi.get(self, "proxy_port")
    ...
    @property
    @pulumi.getter(name="proxyUser")
    def proxy_user(self) -> pulumi.Output[builtins.str]:
        """
        The username of custom data plane proxy server.
        """
        return pulumi.get(self, "proxy_user")
    ...
    @property
    @pulumi.getter(name="useHttps")
    def use_https(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether to use the HTTPS protocol. Valid values: `true`, `false`.
        """
        return pulumi.get(self, "use_https")
