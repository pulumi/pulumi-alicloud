...
class PolicyBindingArgs:
    def __init__(__self__, *,
                 ...
                 cross_account_role_name: Optional[pulumi.Input[builtins.str]] = None,
                 cross_account_type: Optional[pulumi.Input[builtins.str]] = None,
                 cross_account_user_id: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 policy_binding_description: Optional[pulumi.Input[builtins.str]] = None,
                 policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 source: Optional[pulumi.Input[builtins.str]] = None,
                 source_type: Optional[pulumi.Input[builtins.str]] = None,
                 speed_limit: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] cross_account_role_name: Valid only when CrossAccountType = CROSS_ACCOUNT, indicating the name of the cross-account authorization role of the data source, and the management account uses this role to access the data source.
        :param pulumi.Input[builtins.str] cross_account_type: Cross-account type, supported
        :param pulumi.Input[builtins.int] cross_account_user_id: Valid only when CrossAccountType = CROSS_ACCOUNT, indicating the ID of the actual account to which the data source belongs.
        :param pulumi.Input[builtins.str] data_source_id: The data source ID.
        :param pulumi.Input[builtins.bool] disabled: Whether the policy is effective for the data source.
               - true: Pause
               - false: not paused
        :param pulumi.Input[builtins.str] exclude: This parameter is required only when the value of SourceType is ECS_FILE or File. Indicates a file type that does not need to be backed up. All files of this type are not backed up. A maximum of 255 characters is supported.
        :param pulumi.Input[builtins.str] include: This parameter is required only when the value of SourceType is ECS_FILE or File. Indicates the file types to be backed up, and all files of these types are backed up. A maximum of 255 characters is supported.
        :param pulumi.Input[builtins.str] policy_binding_description: Resource Description
        :param pulumi.Input[builtins.str] policy_id: The policy ID.
        :param pulumi.Input[builtins.str] source: When SourceType is OSS, a prefix is specified to be backed up. If it is not specified, the entire root directory of the Bucket is backed up.
        :param pulumi.Input[builtins.str] source_type: Data source type, value range:
    ...
    def cross_account_role_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cross_account_role_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cross_account_role_name", value)

    @property
    @pulumi.getter(name="crossAccountType")
    def cross_account_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cross_account_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cross_account_type", value)

    @property
    @pulumi.getter(name="crossAccountUserId")
    def cross_account_user_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cross_account_user_id(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def policy_binding_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def policy_binding_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def speed_limit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @speed_limit.setter
    def speed_limit(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PolicyBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source: Optional[pulumi.Input[builtins.str]] = None,
            source_type: Optional[pulumi.Input[builtins.str]] = None,
            speed_limit: Optional[pulumi.Input[builtins.str]] = None) -> 'PolicyBinding':
        """
    ...
    @property
    @pulumi.getter(name="crossAccountRoleName")
    def cross_account_role_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Valid only when CrossAccountType = CROSS_ACCOUNT, indicating the name of the cross-account authorization role of the data source, and the management account uses this role to access the data source.
        """
        return pulumi.get(self, "cross_account_role_name")
    ...
    @property
    @pulumi.getter(name="crossAccountType")
    def cross_account_type(self) -> pulumi.Output[builtins.str]:
        """
        Cross-account type, supported
        """
        return pulumi.get(self, "cross_account_type")
    ...
    @property
    @pulumi.getter(name="crossAccountUserId")
    def cross_account_user_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Valid only when CrossAccountType = CROSS_ACCOUNT, indicating the ID of the actual account to which the data source belongs.
        """
        return pulumi.get(self, "cross_account_user_id")
    ...
    @property
    @pulumi.getter
    def exclude(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This parameter is required only when the value of SourceType is ECS_FILE or File. Indicates a file type that does not need to be backed up. All files of this type are not backed up. A maximum of 255 characters is supported.
        """
        return pulumi.get(self, "exclude")
    ...
    @property
    @pulumi.getter
    def include(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This parameter is required only when the value of SourceType is ECS_FILE or File. Indicates the file types to be backed up, and all files of these types are backed up. A maximum of 255 characters is supported.
        """
        return pulumi.get(self, "include")
    ...
    @property
    @pulumi.getter(name="policyBindingDescription")
    def policy_binding_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Resource Description
        """
        return pulumi.get(self, "policy_binding_description")
    ...
    @property
    @pulumi.getter(name="speedLimit")
    def speed_limit(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This parameter is required only when the value of SourceType is ECS_FILE or File. Indicates backup flow control. The format is {start}{end}{bandwidth}. Multiple flow control configurations use partitioning, and no overlap in configuration time is allowed. start: start hour. end: end of hour. bandwidth: limit rate, in KB/s.
        """
        return pulumi.get(self, "speed_limit")
