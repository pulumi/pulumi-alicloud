...
class CrossAccountArgs:
    def __init__(__self__, *,
                 cross_account_role_name: pulumi.Input[builtins.str],
                 cross_account_user_id: pulumi.Input[builtins.int],
                 alias: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a CrossAccount resource.
        :param pulumi.Input[builtins.str] cross_account_role_name: The name of RAM role that the backup account authorizes the management account to manage its resources
        :param pulumi.Input[builtins.int] cross_account_user_id: The uid of the backup account.
        :param pulumi.Input[builtins.str] alias: Backup account alias
        """
    ...
    def cross_account_role_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cross_account_role_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "cross_account_role_name", value)

    @property
    @pulumi.getter(name="crossAccountUserId")
    def cross_account_user_id(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def cross_account_user_id(self, value: pulumi.Input[builtins.int]):
...
class _CrossAccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alias: Backup account alias
        :param pulumi.Input[builtins.int] create_time: Timestamp of the creation time
        :param pulumi.Input[builtins.str] cross_account_role_name: The name of RAM role that the backup account authorizes the management account to manage its resources
        :param pulumi.Input[builtins.int] cross_account_user_id: The uid of the backup account.
        """
        if alias is not None:
...
class CrossAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            create_time: Optional[pulumi.Input[builtins.int]] = None,
            cross_account_role_name: Optional[pulumi.Input[builtins.str]] = None,
            cross_account_user_id: Optional[pulumi.Input[builtins.int]] = None) -> 'CrossAccount':
        """
    ...
    @property
    @pulumi.getter(name="crossAccountRoleName")
    def cross_account_role_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of RAM role that the backup account authorizes the management account to manage its resources
        """
        return pulumi.get(self, "cross_account_role_name")
    ...
    @property
    @pulumi.getter(name="crossAccountUserId")
    def cross_account_user_id(self) -> pulumi.Output[builtins.int]:
        """
        The uid of the backup account.
        """
        return pulumi.get(self, "cross_account_user_id")
