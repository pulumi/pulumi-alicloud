...
def get_nas_backup_plans(file_system_id: Optional[builtins.str] = None,
    ...
    :param builtins.str file_system_id: The Nas fileSystem instance ID of the EcsBackupPlan used.
    :param Sequence[builtins.str] ids: A list of NasBackupPlan IDs.
    :param builtins.str name_regex: A regex string to filter results by NasBackupPlan name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str vault_id: The backup vault ID of the NasBackupPlan used.
    """
    __args__ = dict()
...
def get_nas_backup_plans_output(file_system_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
