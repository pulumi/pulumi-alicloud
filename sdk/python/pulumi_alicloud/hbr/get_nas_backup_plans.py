...
def get_nas_backup_plans(file_system_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str file_system_id: The Nas fileSystem instance ID of the EcsBackupPlan used.
    :param Sequence[_builtins.str] ids: A list of NasBackupPlan IDs.
    :param _builtins.str name_regex: A regex string to filter results by NasBackupPlan name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str vault_id: The backup vault ID of the NasBackupPlan used.
    """
    __args__ = dict()
...
def get_nas_backup_plans_output(file_system_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
