...
def get_hana_instances(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Hana Instance IDs.
    :param _builtins.str name_regex: A regex string to filter results by Hana Instance name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str status: The status of the SAP HANA instance. Valid values:
    ...
    :param _builtins.str vault_id: The id of the vault.
    """
    __args__ = dict()
    __args__['ids'] = ids
