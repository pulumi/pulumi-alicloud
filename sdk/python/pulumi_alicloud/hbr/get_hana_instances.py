...
def get_hana_instances(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Hana Instance IDs.
    :param builtins.str name_regex: A regex string to filter results by Hana Instance name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the SAP HANA instance. Valid values:
    ...
    :param builtins.str vault_id: The id of the vault.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_hana_instances_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
