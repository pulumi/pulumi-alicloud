...
def get_ots_snapshots(end_time: Optional[builtins.str] = None,
    ...
    :param builtins.str end_time: The end time of the backup. This value must be a UNIX timestamp. Unit: milliseconds
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str start_time: The start time of the backup. This value must be a UNIX timestamp. Unit: milliseconds.
    """
    __args__ = dict()
...
def get_ots_snapshots_output(end_time: Optional[pulumi.Input[Optional[builtins.str]]] = None,
