...
class RestoreJobArgs:
    def __init__(__self__, *,
                 ...
                 snapshot_hash: pulumi.Input[builtins.str],
                 ...
                 target_client_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_create_time: Optional[pulumi.Input[builtins.str]] = None,
                 target_data_source_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_file_system_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_instance_name: Optional[pulumi.Input[builtins.str]] = None,
                 target_path: Optional[pulumi.Input[builtins.str]] = None,
                 target_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 target_table_name: Optional[pulumi.Input[builtins.str]] = None,
                 target_time: Optional[pulumi.Input[builtins.str]] = None,
                 udm_detail: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RestoreJob resource.
        :param pulumi.Input[builtins.str] restore_type: The type of recovery destination. Valid values: `ECS_FILE`, `NAS`, `OSS`,`OTS_TABLE`,`UDM_ECS_ROLLBACK`. **Note**: Currently, there is a one-to-one correspondence between the data source type with the recovery destination type.
        :param pulumi.Input[builtins.str] snapshot_hash: The hashcode of Snapshot.
        :param pulumi.Input[builtins.str] snapshot_id: The ID of Snapshot.
        :param pulumi.Input[builtins.str] source_type: The type of data source. Valid values: `ECS_FILE`, `NAS`, `OSS`,`OTS_TABLE`,`UDM_ECS`.
        ...
        :param pulumi.Input[builtins.str] restore_job_id: Restore Job ID. It's the unique key of this resource, if you want to set this argument by yourself, you must specify a unique keyword that never appears.
        :param pulumi.Input[builtins.str] target_bucket: The target name of OSS bucket. **NOTE:** Required while source_type equals `OSS`,
        :param pulumi.Input[builtins.str] target_client_id: The target client ID.
        :param pulumi.Input[builtins.str] target_create_time: The creation time of destination File System. **NOTE:** While source_type equals `NAS`, this parameter must be set. **Note:** The time format of the API adopts the ISO 8601 format, such as `2021-07-09T15:45:30CST` or `2021-07-09T07:45:30Z`.
        :param pulumi.Input[builtins.str] target_data_source_id: The target data source ID.
        :param pulumi.Input[builtins.str] target_file_system_id: The ID of destination File System. **NOTE:** Required while source_type equals `NAS`
        :param pulumi.Input[builtins.str] target_instance_id: The target ID of ECS instance. **NOTE:** Required while source_type equals `ECS_FILE`
        :param pulumi.Input[builtins.str] target_instance_name: The name of the Table store instance to which you want to restore data.**WARNING:** Required while source_type equals `OTS_TABLE`.
        :param pulumi.Input[builtins.str] target_path: The target file path of (ECS) instance. **WARNING:** Required while source_type equals `NAS` or `ECS_FILE`, If this value filled in incorrectly, the task may not start correctly, so please check the parameters before executing the plan.
        :param pulumi.Input[builtins.str] target_prefix: The target prefix of the OSS object. **WARNING:** Required while source_type equals `OSS`. If this value filled in incorrectly, the task may not start correctly, so please check the parameters before executing the plan.
        :param pulumi.Input[builtins.str] target_table_name: The name of the table that stores the restored data. **WARNING:** Required while source_type equals `OTS_TABLE`.
        :param pulumi.Input[builtins.str] target_time: The time when data is restored to the Table store instance. This value is a UNIX timestamp. Unit: seconds. **WARNING:** Required while source_type equals `OTS_TABLE`. **Note:** The time when data is restored to the Tablestore instance. It should be 0 if restores data at the End time of the snapshot.
        :param pulumi.Input[builtins.str] udm_detail: The full machine backup details.
        """
    ...
    def snapshot_hash(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def snapshot_hash(self, value: pulumi.Input[builtins.str]):
    ...
    def restore_job_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def restore_job_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def target_client_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_client_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_client_id", value)

    @property
    @pulumi.getter(name="targetCreateTime")
    def target_create_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_create_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_create_time", value)

    @property
    @pulumi.getter(name="targetDataSourceId")
    def target_data_source_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_data_source_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_data_source_id", value)

    @property
    @pulumi.getter(name="targetFileSystemId")
    def target_file_system_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_file_system_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def target_instance_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_instance_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def target_table_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_table_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_table_name", value)

    @property
    @pulumi.getter(name="targetTime")
    def target_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @target_time.setter
    def target_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_time", value)

    @property
    @pulumi.getter(name="udmDetail")
    def udm_detail(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @udm_detail.setter
    def udm_detail(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RestoreJobState:
    def __init__(__self__, *,
                 ...
                 snapshot_hash: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] snapshot_id: The ID of Snapshot.
        :param pulumi.Input[builtins.str] source_type: The type of data source. Valid values: `ECS_FILE`, `NAS`, `OSS`,`OTS_TABLE`,`UDM_ECS`.
        :param pulumi.Input[builtins.str] status: The Restore Job Status.
        :param pulumi.Input[builtins.str] target_bucket: The target name of OSS bucket. **NOTE:** Required while source_type equals `OSS`,
        :param pulumi.Input[builtins.str] target_client_id: The target client ID.
        :param pulumi.Input[builtins.str] target_create_time: The creation time of destination File System. **NOTE:** While source_type equals `NAS`, this parameter must be set. **Note:** The time format of the API adopts the ISO 8601 format, such as `2021-07-09T15:45:30CST` or `2021-07-09T07:45:30Z`.
        :param pulumi.Input[builtins.str] target_data_source_id: The target data source ID.
    ...
    @property
    @pulumi.getter(name="snapshotHash")
    def snapshot_hash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The hashcode of Snapshot.
        """
        return pulumi.get(self, "snapshot_hash")
    ...
    @snapshot_hash.setter
    def snapshot_hash(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "snapshot_hash", value)
...
class RestoreJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_time: Optional[pulumi.Input[builtins.str]] = None,
            udm_detail: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RestoreJob':
        """
    ...
    @property
    @pulumi.getter(name="restoreJobId")
    def restore_job_id(self) -> pulumi.Output[builtins.str]:
        """
        Restore Job ID. It's the unique key of this resource, if you want to set this argument by yourself, you must specify a unique keyword that never appears.
        """
        return pulumi.get(self, "restore_job_id")
    ...
    @property
    @pulumi.getter(name="snapshotHash")
    def snapshot_hash(self) -> pulumi.Output[builtins.str]:
        """
        The hashcode of Snapshot.
        """
        return pulumi.get(self, "snapshot_hash")
    ...
    @property
    @pulumi.getter(name="targetBucket")
    def target_bucket(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The target name of OSS bucket. **NOTE:** Required while source_type equals `OSS`,
        """
        return pulumi.get(self, "target_bucket")
    ...
    @property
    @pulumi.getter(name="targetClientId")
    def target_client_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The target client ID.
        """
        return pulumi.get(self, "target_client_id")
    ...
    @property
    @pulumi.getter(name="targetCreateTime")
    def target_create_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The creation time of destination File System. **NOTE:** While source_type equals `NAS`, this parameter must be set. **Note:** The time format of the API adopts the ISO 8601 format, such as `2021-07-09T15:45:30CST` or `2021-07-09T07:45:30Z`.
        """
        return pulumi.get(self, "target_create_time")
    ...
    @property
    @pulumi.getter(name="targetDataSourceId")
    def target_data_source_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The target data source ID.
        """
        return pulumi.get(self, "target_data_source_id")
    ...
    @property
    @pulumi.getter(name="targetFileSystemId")
    def target_file_system_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of destination File System. **NOTE:** Required while source_type equals `NAS`
        """
        return pulumi.get(self, "target_file_system_id")
    ...
    @property
    @pulumi.getter(name="targetInstanceId")
    def target_instance_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The target ID of ECS instance. **NOTE:** Required while source_type equals `ECS_FILE`
        """
        return pulumi.get(self, "target_instance_id")
    ...
    @property
    @pulumi.getter(name="targetInstanceName")
    def target_instance_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Table store instance to which you want to restore data.**WARNING:** Required while source_type equals `OTS_TABLE`.
        """
        return pulumi.get(self, "target_instance_name")
    ...
    @property
    @pulumi.getter(name="targetPath")
    def target_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The target file path of (ECS) instance. **WARNING:** Required while source_type equals `NAS` or `ECS_FILE`, If this value filled in incorrectly, the task may not start correctly, so please check the parameters before executing the plan.
        """
        return pulumi.get(self, "target_path")
    ...
    @property
    @pulumi.getter(name="targetTableName")
    def target_table_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the table that stores the restored data. **WARNING:** Required while source_type equals `OTS_TABLE`.
        """
        return pulumi.get(self, "target_table_name")
    ...
    @property
    @pulumi.getter(name="targetTime")
    def target_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time when data is restored to the Table store instance. This value is a UNIX timestamp. Unit: seconds. **WARNING:** Required while source_type equals `OTS_TABLE`. **Note:** The time when data is restored to the Tablestore instance. It should be 0 if restores data at the End time of the snapshot.
        """
        return pulumi.get(self, "target_time")
    ...
    @property
    @pulumi.getter(name="udmDetail")
    def udm_detail(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The full machine backup details.
        """
        return pulumi.get(self, "udm_detail")
