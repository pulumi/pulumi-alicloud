...
def get_vaults(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Vault IDs.
    :param _builtins.str name_regex: A regex string to filter results by Vault name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str status: The status of Vault. Valid values: `CREATED`, `ERROR`, `UNKNOWN`.
    :param _builtins.str vault_type: VaultType. Valid values: `STANDARD`,`OTS_BACKUP`.
...
def get_vaults_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                      name_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                      output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                      status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                      vault_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
