...
class GetVaultsResult:
    ...
    """
    def __init__(__self__, id=None, ids=None, name_regex=None, names=None, output_file=None, status=None, vault_type=None, vaults=None):
...
def get_vaults(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Vault IDs.
    :param builtins.str name_regex: A regex string to filter results by Vault name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of Vault. Valid values: `CREATED`, `ERROR`, `UNKNOWN`.
    :param builtins.str vault_type: VaultType. Valid values: `STANDARD`,`OTS_BACKUP`.
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:hbr/getVaults:getVaults', __args__, opts=opts, typ=GetVaultsResult).value
...
def get_vaults_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                      ...
                      vault_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
