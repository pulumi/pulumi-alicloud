...
def get_ots_backup_plans(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of OtsBackupPlan IDs.
    :param builtins.str name_regex: A regex string to filter results by OtsBackupPlan name.
    ...
    :param builtins.str plan_name: The ID of the backup plan.
    :param builtins.str vault_id: The ID of backup vault the OtsBackupPlan used.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_ots_backup_plans_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                plan_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                plan_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
