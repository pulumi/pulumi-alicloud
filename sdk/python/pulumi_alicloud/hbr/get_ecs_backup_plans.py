...
def get_ecs_backup_plans(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of EcsBackupPlan IDs.
    :param builtins.str instance_id: The ECS instance ID of the EcsBackupPlan used.
    :param builtins.str name_regex: A regex string to filter results by EcsBackupPlan name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str vault_id: The Vault ID of the EcsBackupPlan used.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_ecs_backup_plans_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
