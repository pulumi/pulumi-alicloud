...
class OtsBackupPlanArgs:
    def __init__(__self__, *,
                 ...
                 ots_backup_plan_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] ots_backup_plan_name: The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        ...
        :param pulumi.Input[builtins.str] instance_name: The name of the Table store instance. **Note:** Required while source_type equals `OTS_TABLE`.
    ...
    def ots_backup_plan_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ots_backup_plan_name(self, value: pulumi.Input[builtins.str]):
...
class _OtsBackupPlanState:
    def __init__(__self__, *,
                 ...
                 disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 instance_name: Optional[pulumi.Input[builtins.str]] = None,
                 ots_backup_plan_name: Optional[pulumi.Input[builtins.str]] = None,
                 ots_details: Optional[pulumi.Input[Sequence[pulumi.Input['OtsBackupPlanOtsDetailArgs']]]] = None,
    ...
    @property
    @pulumi.getter(name="otsBackupPlanName")
    def ots_backup_plan_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        """
        return pulumi.get(self, "ots_backup_plan_name")
    ...
    @ots_backup_plan_name.setter
    def ots_backup_plan_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ots_backup_plan_name", value)
...
class OtsBackupPlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['OtsBackupPlanRuleArgs', 'OtsBackupPlanRuleArgsDict']]]]] = None,
            schedule: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'OtsBackupPlan':
        """
    ...
    @property
    @pulumi.getter(name="otsBackupPlanName")
    def ots_backup_plan_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        """
        return pulumi.get(self, "ots_backup_plan_name")
