...
class ServerBackupPlanArgs:
    def __init__(__self__, *,
                 ...
                 ecs_server_backup_plan_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] ecs_server_backup_plan_name: The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        :param pulumi.Input[builtins.str] instance_id: The ID of ECS instance.
        :param pulumi.Input[builtins.int] retention: Backup retention days, the minimum is 1.
        :param pulumi.Input[builtins.str] schedule: Backup strategy. Optional format: `I|{startTime}|{interval}`
    ...
    def ecs_server_backup_plan_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ecs_server_backup_plan_name(self, value: pulumi.Input[builtins.str]):
...
class _ServerBackupPlanState:
    def __init__(__self__, *,
                 ...
                 disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ecs_server_backup_plan_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="ecsServerBackupPlanName")
    def ecs_server_backup_plan_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        """
        return pulumi.get(self, "ecs_server_backup_plan_name")
    ...
    @ecs_server_backup_plan_name.setter
    def ecs_server_backup_plan_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ecs_server_backup_plan_name", value)
...
class ServerBackupPlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            retention: Optional[pulumi.Input[builtins.int]] = None,
            schedule: Optional[pulumi.Input[builtins.str]] = None) -> 'ServerBackupPlan':
        """
    ...
    @property
    @pulumi.getter(name="ecsServerBackupPlanName")
    def ecs_server_backup_plan_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        """
        return pulumi.get(self, "ecs_server_backup_plan_name")
