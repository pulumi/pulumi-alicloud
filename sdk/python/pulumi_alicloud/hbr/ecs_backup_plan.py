...
class EcsBackupPlanArgs:
    def __init__(__self__, *,
                 ...
                 ecs_backup_plan_name: pulumi.Input[builtins.str],
                 ...
                 update_paths: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] ecs_backup_plan_name: The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        :param pulumi.Input[builtins.str] instance_id: The ID of ECS instance. The ecs backup client must have been installed on the host.
        ...
        :param pulumi.Input[builtins.str] detail: The detail of the backup plan.
        :param pulumi.Input[builtins.bool] disabled: Whether to disable the backup task. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] exclude: Exclude path. String of Json list, up to 255 characters. e.g. `"[\\"/home/work\\"]"`
        :param pulumi.Input[builtins.str] include: Include path. String of Json list, up to 255 characters. e.g. `"[\\"/var\\"]"`
        :param pulumi.Input[builtins.str] options: Windows operating system with application consistency using VSS, e.g: `{\\"UseVSS\\":false}`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] paths: List of backup path. e.g. `["/home", "/var"]`. **Note** If `path` is empty, it means that all directories will be backed up.
        :param pulumi.Input[builtins.str] speed_limit: Flow control. The format is: `{start}|{end}|{bandwidth}`. Use `|` to separate multiple flow control configurations, multiple flow control configurations not allowed to have overlapping times.
        :param pulumi.Input[builtins.bool] update_paths: Attribute update_paths has been deprecated in v1.139.0+, and you do not need to set it anymore.
        """
    ...
    def ecs_backup_plan_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ecs_backup_plan_name(self, value: pulumi.Input[builtins.str]):
    ...
    def update_paths(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @update_paths.setter
    def update_paths(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _EcsBackupPlanState:
    def __init__(__self__, *,
                 ...
                 detail: Optional[pulumi.Input[builtins.str]] = None,
                 disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ecs_backup_plan_name: Optional[pulumi.Input[builtins.str]] = None,
                 exclude: Optional[pulumi.Input[builtins.str]] = None,
                 include: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="ecsBackupPlanName")
    def ecs_backup_plan_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        """
        return pulumi.get(self, "ecs_backup_plan_name")
    ...
    @ecs_backup_plan_name.setter
    def ecs_backup_plan_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ecs_backup_plan_name", value)
...
class EcsBackupPlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            speed_limit: Optional[pulumi.Input[builtins.str]] = None,
            update_paths: Optional[pulumi.Input[builtins.bool]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EcsBackupPlan':
        """
    ...
    @property
    @pulumi.getter(name="ecsBackupPlanName")
    def ecs_backup_plan_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        """
        return pulumi.get(self, "ecs_backup_plan_name")
    ...
    @pulumi.getter(name="updatePaths")
    @_utilities.deprecated("""Attribute update_paths has been deprecated in v1.139.0+ and you do not need to set it anymore.""")
    def update_paths(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Attribute update_paths has been deprecated in v1.139.0+, and you do not need to set it anymore.
        """
        return pulumi.get(self, "update_paths")
