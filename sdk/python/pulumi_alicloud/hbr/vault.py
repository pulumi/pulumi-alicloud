...
class VaultArgs:
    def __init__(__self__, *,
                 ...
                 worm_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Vault resource.
        :param pulumi.Input[builtins.str] vault_name: The name of Vault.
        :param pulumi.Input[builtins.str] description: The description of Vault. Defaults to an empty string.
        :param pulumi.Input[builtins.str] encrypt_type: Source Encryption Type，It is valid only when vault_type is `STANDARD` or `OTS_BACKUP`. Default value: `HBR_PRIVATE`. Valid values:
               - `HBR_PRIVATE`: HBR is fully hosted, uses the backup service's own encryption method.
               - `KMS`: Use Alibaba Cloud Kms to encryption.
        :param pulumi.Input[builtins.str] kms_key_id: The key id or alias name of Alibaba Cloud Kms. It is required and valid only when encrypt_type is `KMS`.
    ...
    def worm_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @worm_enabled.setter
    def worm_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _VaultState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: (Available since v1.243.0) The time when the backup vault was created.
        :param pulumi.Input[builtins.str] description: The description of Vault. Defaults to an empty string.
        :param pulumi.Input[builtins.str] encrypt_type: Source Encryption Type，It is valid only when vault_type is `STANDARD` or `OTS_BACKUP`. Default value: `HBR_PRIVATE`. Valid values:
               - `HBR_PRIVATE`: HBR is fully hosted, uses the backup service's own encryption method.
               - `KMS`: Use Alibaba Cloud Kms to encryption.
        :param pulumi.Input[builtins.str] kms_key_id: The key id or alias name of Alibaba Cloud Kms. It is required and valid only when encrypt_type is `KMS`.
        :param pulumi.Input[builtins.str] region_id: (Available since v1.243.0) The ID of the region in which the backup vault resides.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] status: The status of the Vault.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the resource.
        :param pulumi.Input[builtins.str] vault_name: The name of Vault.
        :param pulumi.Input[builtins.str] vault_storage_class: The storage class of Vault. Valid values: `STANDARD`.
        :param pulumi.Input[builtins.str] vault_type: The type of Vault. Valid values: `STANDARD`, `OTS_BACKUP`.
...
class Vault(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vault_storage_class: Optional[pulumi.Input[builtins.str]] = None,
            vault_type: Optional[pulumi.Input[builtins.str]] = None,
            worm_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'Vault':
        """
    ...
    @property
    @pulumi.getter(name="wormEnabled")
    def worm_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the immutable backup feature is enabled. Valid values: `true`, `false`.
        """
        return pulumi.get(self, "worm_enabled")
