...
class GetRestoreJobsResult:
    ...
    def restore_ids(self) -> Optional[Sequence[builtins.str]]:
    ...
    def source_types(self) -> Optional[Sequence[builtins.str]]:
...
def get_restore_jobs(output_file: Optional[builtins.str] = None,
                     restore_ids: Optional[Sequence[builtins.str]] = None,
                     restore_type: Optional[builtins.str] = None,
                     source_types: Optional[Sequence[builtins.str]] = None,
                     status: Optional[builtins.str] = None,
                     target_buckets: Optional[Sequence[builtins.str]] = None,
                     target_file_system_ids: Optional[Sequence[builtins.str]] = None,
                     target_instance_ids: Optional[Sequence[builtins.str]] = None,
                     vault_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] restore_ids: The list of restore job IDs.
    :param builtins.str restore_type: The Recovery Destination Types. Valid values: `ECS_FILE`, `NAS`, `OSS`,`OTS_TABLE`, `UDM_ECS_ROLLBACK`.
    :param Sequence[builtins.str] source_types: The list of data source types. Valid values: `ECS_FILE`, `NAS`, `OSS`, `OTS_TABLE`,`UDM_ECS_ROLLBACK`.
    :param builtins.str status: The status of restore job. Valid values: `CANCELED`, `CANCELING`, `COMPLETE`, `CREATED`, `EXPIRED`, `FAILED`, `PARTIAL_COMPLETE`, `QUEUED`, `RUNNING`.
    :param Sequence[builtins.str] target_buckets: The name of target OSS bucket.
    :param Sequence[builtins.str] target_file_system_ids: Valid while source_type equals `NAS`. The list of destination File System IDs.
    :param Sequence[builtins.str] target_instance_ids: The ID of target ECS instance.
    :param Sequence[builtins.str] vault_ids: The list of backup vault IDs.
    """
    __args__ = dict()
...
def get_restore_jobs_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            restore_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                            restore_type: Optional[pulumi.Input[builtins.str]] = None,
                            source_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                            status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            target_buckets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                            target_file_system_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                            target_instance_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                            vault_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
