...
class NasBackupPlanArgs:
    def __init__(__self__, *,
                 ...
                 nas_backup_plan_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] file_system_id: The File System ID of Nas.
        :param pulumi.Input[builtins.str] nas_backup_plan_name: The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] paths: List of backup path. Up to 65536 characters. e.g.`["/home", "/var"]`. **Note** You should at least specify a backup path, empty array not allowed here.
        ...
        :param pulumi.Input[builtins.str] vault_id: The ID of Backup vault.
        :param pulumi.Input[builtins.str] create_time: This field has been deprecated from provider version 1.153.0+. The creation time of NAS file system. **Note** The time format of the API adopts the ISO 8601, such as `2021-07-09T15:45:30CST` or `2021-07-09T07:45:30Z`.
        :param pulumi.Input[builtins.str] cross_account_role_name: The role name created in the original account RAM backup by the cross account managed by the current account.
        ...
        :param pulumi.Input[builtins.str] cross_account_type: The type of the cross account backup. Valid values: `SELF_ACCOUNT`, `CROSS_ACCOUNT`.
        :param pulumi.Input[builtins.int] cross_account_user_id: The original account ID of the cross account backup managed by the current account.
        :param pulumi.Input[builtins.bool] disabled: Whether to disable the backup task. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] options: This parameter specifies whether to use Windows VSS to define a backup path.
        """
    ...
    def nas_backup_plan_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def nas_backup_plan_name(self, value: pulumi.Input[builtins.str]):
...
class _NasBackupPlanState:
    def __init__(__self__, *,
                 ...
                 nas_backup_plan_name: Optional[pulumi.Input[builtins.str]] = None,
                 options: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="nasBackupPlanName")
    def nas_backup_plan_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        """
        return pulumi.get(self, "nas_backup_plan_name")
    ...
    @nas_backup_plan_name.setter
    def nas_backup_plan_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nas_backup_plan_name", value)
...
class NasBackupPlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retention: Optional[pulumi.Input[builtins.str]] = None,
            schedule: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NasBackupPlan':
        """
    ...
    @property
    @pulumi.getter(name="nasBackupPlanName")
    def nas_backup_plan_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        """
        return pulumi.get(self, "nas_backup_plan_name")
    ...
    @property
    @pulumi.getter
    def retention(self) -> pulumi.Output[builtins.str]:
        """
        Backup retention days, the minimum is 1.
        """
        return pulumi.get(self, "retention")
