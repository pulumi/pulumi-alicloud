...
class _NasBackupPlanState:
    def __init__(__self__, *,
                 ...
                 nas_backup_plan_name: pulumi.Input[Optional[_builtins.str]] = None,
                 options: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="nasBackupPlanName")
    def nas_backup_plan_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        """
        return pulumi.get(self, "nas_backup_plan_name")
    ...
    @nas_backup_plan_name.setter
    def nas_backup_plan_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "nas_backup_plan_name", value)
...
class NasBackupPlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retention: pulumi.Input[Optional[_builtins.str]] = None,
            schedule: pulumi.Input[Optional[_builtins.str]] = None,
            vault_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'NasBackupPlan':
        """
