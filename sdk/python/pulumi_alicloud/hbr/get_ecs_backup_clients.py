...
def get_ecs_backup_clients(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ecs Backup Client IDs.
    :param Sequence[builtins.str] instance_ids: A list of ECS Instance IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the resource. Valid values: `ACTIVATED`, `DEACTIVATED`, `INSTALLING`, `INSTALL_FAILED`, `NOT_INSTALLED`, `REGISTERED`, `STOPPED`, `UNINSTALLING`, `UNINSTALL_FAILED`, `UNKNOWN`, `UPGRADE_FAILED`, `UPGRADING`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_ecs_backup_clients_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                  instance_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
