...
if not MYPY:
    class OtsBackupPlanOtsDetailArgsDict(TypedDict):
        table_names: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class OtsBackupPlanOtsDetailArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] table_names: The names of the destination tables in the Tablestore instance. **Note:** Required while source_type equals `OTS_TABLE`.
        """
    ...
    def table_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The names of the destination tables in the Tablestore instance. **Note:** Required while source_type equals `OTS_TABLE`.
        """
    ...
    @table_names.setter
    def table_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class OtsBackupPlanRuleArgsDict(TypedDict):
        ...
        """
        retention: NotRequired[pulumi.Input[builtins.str]]
        """
...
class OtsBackupPlanRuleArgs:
    def __init__(__self__, *,
                 ...
                 retention: Optional[pulumi.Input[builtins.str]] = None,
                 rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 schedule: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] backup_type: Backup type. Valid values: `COMPLETE`.
        :param pulumi.Input[builtins.bool] disabled: Whether to disable the backup task. Valid values: `true`, `false`. Default values: `false`.
        :param pulumi.Input[builtins.str] retention: Backup retention days, the minimum is 1.
        :param pulumi.Input[builtins.str] rule_name: The name of the backup rule.**Note:** Required while source_type equals `OTS_TABLE`. `rule_name` should be unique for the specific user.
        :param pulumi.Input[builtins.str] schedule: Backup strategy. Optional format: `I|{startTime}|{interval}`. It means to execute a backup task every `{interval}` starting from `{startTime}`. The backup task for the elapsed time will not be compensated. If the last backup task has not completed yet, the next backup task will not be triggered.
               - `startTime` Backup start time, UNIX time seconds.
        """
    ...
    @property
    @pulumi.getter
    def retention(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Backup retention days, the minimum is 1.
        """
    ...
    @retention.setter
    def retention(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PolicyBindingAdvancedOptionsUdmDetailArgsDict(TypedDict):
        ...
        """
        disk_id_lists: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The list of backup disks. If it is empty, all disks are backed up.
        """
        exclude_disk_id_lists: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class PolicyBindingAdvancedOptionsUdmDetailArgs:
    def __init__(__self__, *,
                 ...
                 disk_id_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 exclude_disk_id_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] destination_kms_key_id: Custom KMS key ID of encrypted copy.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] disk_id_lists: The list of backup disks. If it is empty, all disks are backed up.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_disk_id_lists: List of cloud disk IDs that are not backed up.
        """
    ...
    def disk_id_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of backup disks. If it is empty, all disks are backed up.
        """
    ...
    def disk_id_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "disk_id_lists", value)

    @property
    @pulumi.getter(name="excludeDiskIdLists")
    def exclude_disk_id_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of cloud disk IDs that are not backed up.
        """
    ...
    def exclude_disk_id_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class PolicyRuleArgsDict(TypedDict):
        ...
        Rule Type.
        """
        archive_days: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        keep_latest_snapshots: NotRequired[pulumi.Input[builtins.int]]
        """
        This parameter is required only when `RuleType` is set to `BACKUP`.
        """
        replication_region_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PolicyRuleArgs:
    def __init__(__self__, *,
                 rule_type: pulumi.Input[builtins.str],
                 archive_days: Optional[pulumi.Input[builtins.int]] = None,
                 backup_type: Optional[pulumi.Input[builtins.str]] = None,
                 keep_latest_snapshots: Optional[pulumi.Input[builtins.int]] = None,
                 replication_region_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] rule_type: Rule Type.
        :param pulumi.Input[builtins.int] archive_days: This parameter is required only when the value of `RuleType` is **TRANSITION. The minimum value is 30, and the Retention-ArchiveDays needs to be greater than or equal to 60.
        :param pulumi.Input[builtins.str] backup_type: This parameter is required only when the `RuleType` value is **BACKUP. Backup Type.
        :param pulumi.Input[builtins.int] keep_latest_snapshots: This parameter is required only when `RuleType` is set to `BACKUP`.
        :param pulumi.Input[builtins.str] replication_region_id: Only when the `RuleType` value is.
        :param pulumi.Input[builtins.int] retention: Retention time, in days.
        ...
        :param pulumi.Input[builtins.str] schedule: This parameter is required only if you set the `RuleType` parameter to `BACKUP`. This parameter specifies the backup schedule settings. Format: `I|{startTime}|{interval}`. The system runs the first backup job at a point in time that is specified in the {startTime} parameter and the subsequent backup jobs at an interval that is specified in the {interval} parameter. The system does not run a backup job before the specified point in time. Each backup job, except the first one, starts only after the previous backup job is complete. For example, `I|1631685600|P1D` specifies that the system runs the first backup job at 14:00:00 on September 15, 2021 and the subsequent backup jobs once a day.  *   startTime: the time at which the system starts to run a backup job. The time must follow the UNIX time format. Unit: seconds. *   interval: the interval at which the system runs a backup job. The interval must follow the ISO 8601 standard. For example, PT1H specifies an interval of one hour. P1D specifies an interval of one day.
        :param pulumi.Input[builtins.str] vault_id: Vault ID.
        """
    ...
    def archive_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        This parameter is required only when the value of `RuleType` is **TRANSITION. The minimum value is 30, and the Retention-ArchiveDays needs to be greater than or equal to 60.
        """
    ...
    @archive_days.setter
    def archive_days(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def keep_latest_snapshots(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        This parameter is required only when `RuleType` is set to `BACKUP`.
        """
    ...
    def keep_latest_snapshots(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "keep_latest_snapshots", value)

    @property
    @pulumi.getter(name="replicationRegionId")
    def replication_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Only when the `RuleType` value is.
        """
    ...
    def replication_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PolicyRuleRetentionRuleArgsDict(TypedDict):
        advanced_retention_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PolicyRuleRetentionRuleArgs:
    def __init__(__self__, *,
                 advanced_retention_type: Optional[pulumi.Input[builtins.str]] = None,
                 retention: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] advanced_retention_type: Valid values: `annually`, `MONTHLY`, and `WEEKLY`:- `annually`: the first backup of each year. - `MONTHLY`: The first backup of the month. - `WEEKLY`: The first backup of the week. - `DAILY`: The first backup of the day.
        :param pulumi.Input[builtins.int] retention: Retention time, in days.
        """
    ...
    def advanced_retention_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Valid values: `annually`, `MONTHLY`, and `WEEKLY`:- `annually`: the first backup of each year. - `MONTHLY`: The first backup of the month. - `WEEKLY`: The first backup of the week. - `DAILY`: The first backup of the day.
        """
    ...
    def advanced_retention_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RestoreJobOtsDetailArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] overwrite_existing: Whether to overwrite the existing table storage recovery task. Valid values: `true`, `false`.
        """
...
if not MYPY:
    class ServerBackupPlanDetailArgsDict(TypedDict):
        app_consistent: pulumi.Input[builtins.bool]
        """
        ...
        """
        snapshot_group: pulumi.Input[builtins.bool]
        """
        ...
        """
        destination_region_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        destination_retention: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        do_copy: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether replicate to another region. Valid values: `true`, `false`.
        """
        enable_fs_freeze: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        post_script_path: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        pre_script_path: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServerBackupPlanDetailArgs:
    def __init__(__self__, *,
                 app_consistent: pulumi.Input[builtins.bool],
                 snapshot_group: pulumi.Input[builtins.bool],
                 destination_region_id: Optional[pulumi.Input[builtins.str]] = None,
                 destination_retention: Optional[pulumi.Input[builtins.int]] = None,
                 disk_id_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 do_copy: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_fs_freeze: Optional[pulumi.Input[builtins.bool]] = None,
                 post_script_path: Optional[pulumi.Input[builtins.str]] = None,
                 pre_script_path: Optional[pulumi.Input[builtins.str]] = None,
                 timeout_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] app_consistent: Whether to turn on application consistency. The application consistency snapshot backs up memory data and ongoing database transactions at the time of snapshot creation to ensure the consistency of application system data and database transactions. By applying consistent snapshots, there is no data damage or loss, so as to avoid log rollback during database startup and ensure that the application is in a consistent startup state. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.bool] snapshot_group: Whether to turn on file system consistency. If SnapshotGroup is true, when AppConsistent is true but the relevant conditions are not met or AppConsistent is false, the resulting snapshot will be a file system consistency snapshot. The file system consistency ensures that the file system memory and disk information are synchronized at the time of snapshot creation, and the file system write operation is frozen to make the file system in a consistent state. The file system consistency snapshot can prevent the operating system from performing disk inspection and repair operations such as CHKDSK or fsck after restart. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] destination_region_id: Only vaild when DoCopy is true. The destination region ID when replicating to another region. **Note:** Once you set a value of this property, you cannot set it to an empty string anymore.
        :param pulumi.Input[builtins.int] destination_retention: Only vaild when DoCopy is true. The retention days of the destination backup. When not specified, the destination backup will be saved permanently. **Note:** Once you set a value of this property, you cannot set it to an empty string anymore.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] disk_id_lists: The list of cloud disks to be backed up in the ECS instance. When not specified, a snapshot is executed for all the disks on the ECS instance.
        :param pulumi.Input[builtins.bool] do_copy: Whether replicate to another region. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.bool] enable_fs_freeze: Only the Linux system is valid. Whether to use the Linux FsFreeze mechanism to ensure that the file system is read-only consistent before creating a storage snapshot. The default is True. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] post_script_path: Only vaild for the linux system when AppConsistent is true. The application thaw script path (e.g. /tmp/postscript.sh). The postscript.sh script must meet the following conditions: in terms of permissions, only the root user as the owner has read, write, and execute permissions, that is, 700 permissions. In terms of content, the script content needs to be customized according to the application itself. This indicates that this parameter must be set when creating an application consistency snapshot for a Linux instance. If the script is set incorrectly (for example, permissions, save path, or file name are set incorrectly), the resulting snapshot is a file system consistency snapshot.
        :param pulumi.Input[builtins.str] pre_script_path: Only vaild for the linux system when AppConsistent is true. Apply the freeze script path (e.g. /tmp/prescript.sh). prescript.sh scripts must meet the following conditions: in terms of permissions, only root, as the owner, has read, write, and execute permissions, that is, 700 permissions. In terms of content, the script content needs to be customized according to the application itself. This indicates that this parameter must be set when creating an application consistency snapshot for a Linux instance. If the script is set incorrectly (for example, permissions, save path, or file name are set incorrectly), the resulting snapshot is a file system consistency snapshot.
        :param pulumi.Input[builtins.int] timeout_in_seconds: Only the Linux system is valid, and the IO freeze timeout period. The default is 30 seconds.
        """
    ...
    def app_consistent(self) -> pulumi.Input[builtins.bool]:
        """
        Whether to turn on application consistency. The application consistency snapshot backs up memory data and ongoing database transactions at the time of snapshot creation to ensure the consistency of application system data and database transactions. By applying consistent snapshots, there is no data damage or loss, so as to avoid log rollback during database startup and ensure that the application is in a consistent startup state. Valid values: `true`, `false`.
        """
    ...
    def app_consistent(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "app_consistent", value)

    @property
    @pulumi.getter(name="snapshotGroup")
    def snapshot_group(self) -> pulumi.Input[builtins.bool]:
        """
        Whether to turn on file system consistency. If SnapshotGroup is true, when AppConsistent is true but the relevant conditions are not met or AppConsistent is false, the resulting snapshot will be a file system consistency snapshot. The file system consistency ensures that the file system memory and disk information are synchronized at the time of snapshot creation, and the file system write operation is frozen to make the file system in a consistent state. The file system consistency snapshot can prevent the operating system from performing disk inspection and repair operations such as CHKDSK or fsck after restart. Valid values: `true`, `false`.
        """
    ...
    def snapshot_group(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "snapshot_group", value)

    @property
    @pulumi.getter(name="destinationRegionId")
    def destination_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Only vaild when DoCopy is true. The destination region ID when replicating to another region. **Note:** Once you set a value of this property, you cannot set it to an empty string anymore.
        """
    ...
    def destination_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_region_id", value)

    @property
    @pulumi.getter(name="destinationRetention")
    def destination_retention(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Only vaild when DoCopy is true. The retention days of the destination backup. When not specified, the destination backup will be saved permanently. **Note:** Once you set a value of this property, you cannot set it to an empty string anymore.
        """
    ...
    def destination_retention(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def do_copy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether replicate to another region. Valid values: `true`, `false`.
        """
    ...
    @do_copy.setter
    def do_copy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "do_copy", value)

    @property
    @pulumi.getter(name="enableFsFreeze")
    def enable_fs_freeze(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Only the Linux system is valid. Whether to use the Linux FsFreeze mechanism to ensure that the file system is read-only consistent before creating a storage snapshot. The default is True. Valid values: `true`, `false`.
        """
    ...
    def enable_fs_freeze(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_fs_freeze", value)

    @property
    @pulumi.getter(name="postScriptPath")
    def post_script_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Only vaild for the linux system when AppConsistent is true. The application thaw script path (e.g. /tmp/postscript.sh). The postscript.sh script must meet the following conditions: in terms of permissions, only the root user as the owner has read, write, and execute permissions, that is, 700 permissions. In terms of content, the script content needs to be customized according to the application itself. This indicates that this parameter must be set when creating an application consistency snapshot for a Linux instance. If the script is set incorrectly (for example, permissions, save path, or file name are set incorrectly), the resulting snapshot is a file system consistency snapshot.
        """
    ...
    def post_script_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "post_script_path", value)

    @property
    @pulumi.getter(name="preScriptPath")
    def pre_script_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Only vaild for the linux system when AppConsistent is true. Apply the freeze script path (e.g. /tmp/prescript.sh). prescript.sh scripts must meet the following conditions: in terms of permissions, only root, as the owner, has read, write, and execute permissions, that is, 700 permissions. In terms of content, the script content needs to be customized according to the application itself. This indicates that this parameter must be set when creating an application consistency snapshot for a Linux instance. If the script is set incorrectly (for example, permissions, save path, or file name are set incorrectly), the resulting snapshot is a file system consistency snapshot.
        """
    ...
    def pre_script_path(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GetBackupJobsFilterArgs:
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: The key of the field to filter. Valid values: `PlanId`, `VaultId`, `InstanceId`, `Bucket`, `FileSystemId`, `CompleteTime`.
        :param builtins.str operator: The operator of the field to filter. Valid values: `EQUAL`, `NOT_EQUAL`, `GREATER_THAN`, `GREATER_THAN_OR_EQUAL`, `LESS_THAN`, `LESS_THAN_OR_EQUAL`, `BETWEEN`, `IN`.
...
class GetServerBackupPlansFilterArgs:
    def __init__(__self__, *,
                 ...
                 values: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str key: The key of the field to filter. Valid values: `planId`, `instanceId`, `planName`.
        :param Sequence[builtins.str] values: Set of values that are accepted for the given field.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
