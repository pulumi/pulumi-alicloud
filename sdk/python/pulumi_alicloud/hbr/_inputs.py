...
class PolicyBindingAdvancedOptionsOssDetailArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] inventory_id: The name of the OSS inventory. If the value is not empty, the OSS inventory will be used for performance tuning. We recommend that you use a list to improve incremental performance when backing up more than 0.1 billion OSS objects. OSS charges the storage fee for the list file separately. It takes time to generate the OSS inventory file. The backup may fail before the OSS inventory file is generated. You can wait for the next cycle.
        """
...
class PolicyRuleArgsDict(TypedDict):
    ...
    """
    Specifies whether to enable the backup lock (immutable backup) for the rule. Valid only when `PolicyType` is set to `UDM_ECS_ONLY`. When enabled, backups generated by this rule cannot be deleted until the retention period expires.
    """
...
class PolicyRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] immutable: Specifies whether to enable the backup lock (immutable backup) for the rule. Valid only when `PolicyType` is set to `UDM_ECS_ONLY`. When enabled, backups generated by this rule cannot be deleted until the retention period expires.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PolicyRuleTagFilterArgs']]] tag_filters: This parameter is required only when the value of RuleType is TAG. Resource label filtering rules. See `tag_filters` below.
        ...
        if data_source_filters is not None:
            pulumi.set(__self__, "data_source_filters", data_source_filters)
...
class PolicyRuleTagFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] value: The label value, which is empty and represents any value.
        """
        if key is not None:
