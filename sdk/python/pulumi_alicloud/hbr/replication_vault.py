...
class ReplicationVaultArgs:
    def __init__(__self__, *,
                 replication_source_region_id: pulumi.Input[builtins.str],
    ...
    def replication_source_region_id(self, value: pulumi.Input[builtins.str]):
    ...
    def replication_source_vault_id(self, value: pulumi.Input[builtins.str]):
    ...
    def vault_storage_class(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ReplicationVaultState:
    ...
    @replication_source_region_id.setter
    def replication_source_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replication_source_region_id", value)
    ...
    @replication_source_vault_id.setter
    def replication_source_vault_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replication_source_vault_id", value)
...
class ReplicationVault(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            vault_name: Optional[pulumi.Input[builtins.str]] = None,
            vault_storage_class: Optional[pulumi.Input[builtins.str]] = None) -> 'ReplicationVault':
        """
