...
class GetSnapshotsResult:
    ...
    def complete_time(self) -> Optional[builtins.str]:
        return pulumi.get(self, "complete_time")

    @property
    @pulumi.getter(name="completeTimeChecker")
    def complete_time_checker(self) -> Optional[builtins.str]:
...
def get_snapshots(bucket: Optional[builtins.str] = None,
                  complete_time: Optional[builtins.str] = None,
                  complete_time_checker: Optional[builtins.str] = None,
    ...
    :param builtins.str bucket: The bucket name of OSS. While source_type equals `OSS`, this parameter must be set.
    :param builtins.str complete_time: Timestamp of Snapshot completion. Note The time format of the API adopts the ISO 8601 format, such as 2021-07-09T15:45:30CST or 2021-07-09T07:45:30Z. **Note**: While `complete_time_checker` equals `BETWEEN`, this field should be formatted such as `"2021-08-20T14:17:15CST,2021-08-26T14:17:15CST"`, The first part of this string is the start time, the second part is the end time, and the two parts should be separated by commas.
    :param builtins.str complete_time_checker: Complete time filter operator. Optional values: `MATCH_TERM`, `GREATER_THAN`, `GREATER_THAN_OR_EQUAL`, `LESS_THAN`, `LESS_THAN_OR_EQUAL`, `BETWEEN`.
    :param builtins.str create_time: File system creation timestamp of Nas. While source_type equals `NAS`, this parameter must be set. **Note** The time format of the API adopts the ISO 8601 format, such as `2021-07-09T15:45:30CST` or `2021-07-09T07:45:30Z`.
    :param builtins.str file_system_id: The File System ID of Nas. While source_type equals `NAS`, this parameter must be set.
    :param Sequence[builtins.str] ids: A list of Snapshot IDs.
    :param builtins.str instance_id: The ID of ECS instance. The ecs backup client must have been installed on the host. While source_type equals `ECS_FILE`, this parameter must be set.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str source_type: Data source type, valid values: `ECS_FILE`, `OSS`, `NAS`.
    :param builtins.str status: The status of snapshot, valid values: `COMPLETE`, `PARTIAL_COMPLETE`.
    :param builtins.str vault_id: The ID of Vault.
    """
    __args__ = dict()
...
def get_snapshots_output(bucket: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         complete_time: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         complete_time_checker: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         create_time: Optional[pulumi.Input[Optional[builtins.str]]] = None,
