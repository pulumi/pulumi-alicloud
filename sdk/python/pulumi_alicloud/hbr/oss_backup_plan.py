...
class OssBackupPlanArgs:
    def __init__(__self__, *,
                 ...
                 oss_backup_plan_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] bucket: The name of OSS bucket.
        :param pulumi.Input[builtins.str] oss_backup_plan_name: The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        ...
        :param pulumi.Input[builtins.str] prefix: Backup prefix. Once specified, only objects with matching prefixes will be backed up.
        """
    ...
    def oss_backup_plan_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def oss_backup_plan_name(self, value: pulumi.Input[builtins.str]):
...
class _OssBackupPlanState:
    def __init__(__self__, *,
                 ...
                 cross_account_user_id: Optional[pulumi.Input[builtins.int]] = None,
                 disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 oss_backup_plan_name: Optional[pulumi.Input[builtins.str]] = None,
                 prefix: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="ossBackupPlanName")
    def oss_backup_plan_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        """
        return pulumi.get(self, "oss_backup_plan_name")
    ...
    @oss_backup_plan_name.setter
    def oss_backup_plan_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "oss_backup_plan_name", value)
...
@pulumi.type_token("alicloud:hbr/ossBackupPlan:OssBackupPlan")
class OssBackupPlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retention: Optional[pulumi.Input[builtins.str]] = None,
            schedule: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'OssBackupPlan':
        """
    ...
    @property
    @pulumi.getter(name="ossBackupPlanName")
    def oss_backup_plan_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        """
        return pulumi.get(self, "oss_backup_plan_name")
