...
def get_replication_vault_regions(output_file: Optional[_builtins.str] = None,
...
def get_replication_vault_regions_output(output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
