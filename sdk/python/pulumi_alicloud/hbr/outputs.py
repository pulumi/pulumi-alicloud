...
class OtsBackupPlanOtsDetail(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] table_names: The names of the destination tables in the Tablestore instance. **Note:** Required while source_type equals `OTS_TABLE`.
        """
...
class OtsBackupPlanRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str backup_type: Backup type. Valid values: `COMPLETE`.
        :param builtins.bool disabled: Whether to disable the backup task. Valid values: `true`, `false`. Default values: `false`.
        :param builtins.str retention: Backup retention days, the minimum is 1.
        :param builtins.str rule_name: The name of the backup rule.**Note:** Required while source_type equals `OTS_TABLE`. `rule_name` should be unique for the specific user.
        :param builtins.str schedule: Backup strategy. Optional format: `I|{startTime}|{interval}`. It means to execute a backup task every `{interval}` starting from `{startTime}`. The backup task for the elapsed time will not be compensated. If the last backup task has not completed yet, the next backup task will not be triggered.
...
class PolicyBindingAdvancedOptionsUdmDetail(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disk_id_lists: Optional[Sequence[builtins.str]] = None,
                 exclude_disk_id_lists: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str destination_kms_key_id: Custom KMS key ID of encrypted copy.
        :param Sequence[builtins.str] disk_id_lists: The list of backup disks. If it is empty, all disks are backed up.
        :param Sequence[builtins.str] exclude_disk_id_lists: List of cloud disk IDs that are not backed up.
        """
    ...
    def disk_id_lists(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def exclude_disk_id_lists(self) -> Optional[Sequence[builtins.str]]:
        """
...
class PolicyRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 archive_days: Optional[builtins.int] = None,
                 backup_type: Optional[builtins.str] = None,
                 keep_latest_snapshots: Optional[builtins.int] = None,
                 replication_region_id: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str rule_type: Rule Type.
        :param builtins.int archive_days: This parameter is required only when the value of `RuleType` is **TRANSITION. The minimum value is 30, and the Retention-ArchiveDays needs to be greater than or equal to 60.
        :param builtins.str backup_type: This parameter is required only when the `RuleType` value is **BACKUP. Backup Type.
        :param builtins.int keep_latest_snapshots: This parameter is required only when `RuleType` is set to `BACKUP`.
        :param builtins.str replication_region_id: Only when the `RuleType` value is.
        :param builtins.int retention: Retention time, in days.
    ...
    def archive_days(self) -> Optional[builtins.int]:
        """
    ...
    def keep_latest_snapshots(self) -> Optional[builtins.int]:
        """
    ...
    def replication_region_id(self) -> Optional[builtins.str]:
        """
...
class PolicyRuleRetentionRule(dict):
    ...
    def __init__(__self__, *,
                 advanced_retention_type: Optional[builtins.str] = None,
                 retention: Optional[builtins.int] = None):
        """
        :param builtins.str advanced_retention_type: Valid values: `annually`, `MONTHLY`, and `WEEKLY`:- `annually`: the first backup of each year. - `MONTHLY`: The first backup of the month. - `WEEKLY`: The first backup of the week. - `DAILY`: The first backup of the day.
        :param builtins.int retention: Retention time, in days.
        """
    ...
    def advanced_retention_type(self) -> Optional[builtins.str]:
        """
...
class RestoreJobOtsDetail(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool overwrite_existing: Whether to overwrite the existing table storage recovery task. Valid values: `true`, `false`.
        """
...
class ServerBackupPlanDetail(dict):
    ...
    def __init__(__self__, *,
                 app_consistent: builtins.bool,
                 snapshot_group: builtins.bool,
                 destination_region_id: Optional[builtins.str] = None,
                 destination_retention: Optional[builtins.int] = None,
                 disk_id_lists: Optional[Sequence[builtins.str]] = None,
                 do_copy: Optional[builtins.bool] = None,
                 enable_fs_freeze: Optional[builtins.bool] = None,
                 post_script_path: Optional[builtins.str] = None,
                 pre_script_path: Optional[builtins.str] = None,
                 timeout_in_seconds: Optional[builtins.int] = None):
        """
        :param builtins.bool app_consistent: Whether to turn on application consistency. The application consistency snapshot backs up memory data and ongoing database transactions at the time of snapshot creation to ensure the consistency of application system data and database transactions. By applying consistent snapshots, there is no data damage or loss, so as to avoid log rollback during database startup and ensure that the application is in a consistent startup state. Valid values: `true`, `false`.
        :param builtins.bool snapshot_group: Whether to turn on file system consistency. If SnapshotGroup is true, when AppConsistent is true but the relevant conditions are not met or AppConsistent is false, the resulting snapshot will be a file system consistency snapshot. The file system consistency ensures that the file system memory and disk information are synchronized at the time of snapshot creation, and the file system write operation is frozen to make the file system in a consistent state. The file system consistency snapshot can prevent the operating system from performing disk inspection and repair operations such as CHKDSK or fsck after restart. Valid values: `true`, `false`.
        :param builtins.str destination_region_id: Only vaild when DoCopy is true. The destination region ID when replicating to another region. **Note:** Once you set a value of this property, you cannot set it to an empty string anymore.
        :param builtins.int destination_retention: Only vaild when DoCopy is true. The retention days of the destination backup. When not specified, the destination backup will be saved permanently. **Note:** Once you set a value of this property, you cannot set it to an empty string anymore.
        :param Sequence[builtins.str] disk_id_lists: The list of cloud disks to be backed up in the ECS instance. When not specified, a snapshot is executed for all the disks on the ECS instance.
        :param builtins.bool do_copy: Whether replicate to another region. Valid values: `true`, `false`.
        :param builtins.bool enable_fs_freeze: Only the Linux system is valid. Whether to use the Linux FsFreeze mechanism to ensure that the file system is read-only consistent before creating a storage snapshot. The default is True. Valid values: `true`, `false`.
        :param builtins.str post_script_path: Only vaild for the linux system when AppConsistent is true. The application thaw script path (e.g. /tmp/postscript.sh). The postscript.sh script must meet the following conditions: in terms of permissions, only the root user as the owner has read, write, and execute permissions, that is, 700 permissions. In terms of content, the script content needs to be customized according to the application itself. This indicates that this parameter must be set when creating an application consistency snapshot for a Linux instance. If the script is set incorrectly (for example, permissions, save path, or file name are set incorrectly), the resulting snapshot is a file system consistency snapshot.
        :param builtins.str pre_script_path: Only vaild for the linux system when AppConsistent is true. Apply the freeze script path (e.g. /tmp/prescript.sh). prescript.sh scripts must meet the following conditions: in terms of permissions, only root, as the owner, has read, write, and execute permissions, that is, 700 permissions. In terms of content, the script content needs to be customized according to the application itself. This indicates that this parameter must be set when creating an application consistency snapshot for a Linux instance. If the script is set incorrectly (for example, permissions, save path, or file name are set incorrectly), the resulting snapshot is a file system consistency snapshot.
        :param builtins.int timeout_in_seconds: Only the Linux system is valid, and the IO freeze timeout period. The default is 30 seconds.
        """
    ...
    def app_consistent(self) -> builtins.bool:
        """
    ...
    def snapshot_group(self) -> builtins.bool:
        """
    ...
    def destination_region_id(self) -> Optional[builtins.str]:
        """
    ...
    def destination_retention(self) -> Optional[builtins.int]:
        """
    ...
    def do_copy(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_fs_freeze(self) -> Optional[builtins.bool]:
        """
    ...
    def post_script_path(self) -> Optional[builtins.str]:
        """
    ...
    def pre_script_path(self) -> Optional[builtins.str]:
        """
...
class GetBackupJobsJobResult(dict):
    def __init__(__self__, *,
                 actual_bytes: builtins.str,
                 actual_items: builtins.str,
                 back_job_name: builtins.str,
                 backup_job_id: builtins.str,
                 backup_type: builtins.str,
                 bucket: builtins.str,
                 bytes_done: builtins.str,
                 bytes_total: builtins.str,
                 complete_time: builtins.str,
                 create_time: builtins.str,
                 cross_account_role_name: builtins.str,
                 cross_account_type: builtins.str,
                 cross_account_user_id: builtins.int,
                 ...
                 items_done: builtins.str,
                 items_total: builtins.str,
                 nas_create_time: builtins.str,
        ...
        """
        :param builtins.str actual_bytes: The actual data volume of the backup task (After deduplication) . Unit byte.
        :param builtins.str actual_items: The actual number of items in the backup task. (Currently only file backup is available).
        :param builtins.str back_job_name: The name of backup job.
        :param builtins.str backup_job_id: The ID of the backup job.
        :param builtins.str backup_type: Backup type. Valid values: `COMPLETE`(full backup).
        :param builtins.str bucket: The name of target OSS bucket.
        :param builtins.str bytes_done: The amount of backup data (Incremental). Unit byte.
        :param builtins.str bytes_total: The total amount of data sources. Unit byte.
        :param builtins.str complete_time: The completion time of backup job. UNIX time seconds.
        :param builtins.str create_time: The creation time of backup job. UNIX time seconds.
        :param builtins.str cross_account_role_name: The role name created in the original account RAM backup by the cross account managed by the current account. It is valid only when `source_type` is `ECS_FILE`, `NAS`, `OSS` or `OTS`.
        :param builtins.str cross_account_type: The type of the cross account backup. It is valid only when `source_type` is `ECS_FILE`, `NAS`, `OSS` or `OTS`.
        :param builtins.int cross_account_user_id: The original account ID of the cross account backup managed by the current account. It is valid only when `source_type` is `ECS_FILE`, `NAS`, `OSS` or `OTS`.
        :param builtins.str error_message: Error message.
        :param builtins.str exclude: Exclude path. String of Json list. Up to 255 characters. e.g. `"[\\"/home/work\\"]"`
        :param builtins.str file_system_id: The ID of destination file system.
        :param builtins.str id: The ID of the backup job.
        :param builtins.str include: Include path. String of Json list. Up to 255 characters. e.g. `"[\\"/var\\"]"`
        :param builtins.str instance_id: The ID of target ECS instance.
        :param builtins.str items_done: The number of items restore job recovered.
        :param builtins.str items_total: The total number of items restore job recovered.
        :param builtins.str nas_create_time: File system creation time. UNIX time in seconds.
        :param Sequence[builtins.str] paths: List of backup path. e.g. `["/home", "/var"]`.
        :param builtins.str plan_id: The ID of a backup plan.
        :param builtins.str prefix: The prefix of Oss bucket files.
        :param builtins.str progress: Backup progress. The value is 100%*100.
        :param builtins.str source_type: The type of data source. Valid Values: `ECS_FILE`, `OSS`, `NAS`, `UDM_DISK`.
        :param builtins.str start_time: The scheduled backup start time. UNIX time seconds.
        :param builtins.str status: The status of restore job. Valid values: `COMPLETE` , `PARTIAL_COMPLETE`, `FAILED`.
        :param builtins.str updated_time: The update time of backup job. UNIX time seconds.
        :param builtins.str vault_id: The ID of backup vault.
        """
    ...
    def actual_bytes(self) -> builtins.str:
        """
    ...
    def actual_items(self) -> builtins.str:
        """
    ...
    def back_job_name(self) -> builtins.str:
        """
    ...
    def backup_job_id(self) -> builtins.str:
        """
    ...
    def bytes_done(self) -> builtins.str:
        """
    ...
    def bytes_total(self) -> builtins.str:
        """
    ...
    def cross_account_role_name(self) -> builtins.str:
        """
    ...
    def cross_account_type(self) -> builtins.str:
        """
    ...
    def cross_account_user_id(self) -> builtins.int:
        """
    ...
    def items_done(self) -> builtins.str:
        """
    ...
    def items_total(self) -> builtins.str:
        """
    ...
    def nas_create_time(self) -> builtins.str:
        """
...
class GetBackupJobsJobOtsDetailResult(dict):
    def __init__(__self__, *,
                 table_names: Sequence[builtins.str]):
        pulumi.set(__self__, "table_names", table_names)
...
class GetEcsBackupClientsClientResult(dict):
    def __init__(__self__, *,
                 ...
                 create_time: builtins.str,
                 data_network_type: builtins.str,
                 data_proxy_setting: builtins.str,
                 ecs_backup_client_id: builtins.str,
                 hostname: builtins.str,
                 id: builtins.str,
                 instance_id: builtins.str,
                 instance_name: builtins.str,
                 last_heart_beat_time: builtins.str,
                 max_client_version: builtins.str,
                 max_cpu_core: builtins.str,
                 max_worker: builtins.str,
                 os_type: builtins.str,
                 private_ipv4: builtins.str,
                 proxy_host: builtins.str,
                 proxy_password: builtins.str,
                 proxy_port: builtins.str,
                 proxy_user: builtins.str,
                 status: builtins.str,
                 updated_time: builtins.str,
                 use_https: builtins.bool,
                 zone_id: builtins.str):
        """
        :param builtins.str arch_type: The system architecture of client, only the ECS File Backup Client is available. Valid values: `AMD64` , `386`.
        :param builtins.str backup_status: Client protected status. Valid values: `UNPROTECTED`, `PROTECTED`.
        :param builtins.str client_type: The type of client. Valid values: `ECS_CLIENT` (ECS File Backup Client).
        :param builtins.str client_version: The version of client.
        :param builtins.str create_time: The creation time of client. Unix time in seconds.
        :param builtins.str data_network_type: The data plane access point type. Valid Values: `PUBLIC`, `VPC`, `CLASSIC`.
        :param builtins.str data_proxy_setting: The data plane proxy settings. Valid Values: `DISABLE`, `USE_CONTROL_PROXY`, `CUSTOM`.
               * `USE_CONTROL_PROXY` (Default, the same with control plane)
               * `CUSTOM` (Custom configuration items for the HTTP protocol).
        :param builtins.str ecs_backup_client_id: The first ID of the resource.
        :param builtins.str hostname: The hostname of ECS instance.
        :param builtins.str id: The ID of the Ecs Backup Client.
        :param builtins.str instance_id: The ID of ECS instance. When the client type is ECS file backup client, it indicates the ID of ECS instance. When the client type is a local file backup client, it is a hardware fingerprint generated based on system information.
        :param builtins.str instance_name: The name of ECS instance.
        :param builtins.str last_heart_beat_time: The last heartbeat time of client. Unix Time Seconds.
        :param builtins.str max_client_version: The latest version of client.
        :param builtins.str max_cpu_core: The number of CPU cores used by a single backup task, 0 means no restrictions.
        :param builtins.str max_worker: The number of concurrent jobs for a single backup task, 0 means no restrictions.
        :param builtins.str os_type: The operating system type of client, only the ECS File Backup Client is available. Valid values: `windows`, `linux`.
        :param builtins.str private_ipv4: Intranet IP address of the instance, only available for ECS file backup client.
        :param builtins.str proxy_host: Custom data plane proxy server host address.
        :param builtins.str proxy_password: The password of custom data plane proxy server.
        :param builtins.str proxy_port: Custom data plane proxy server host port.
        :param builtins.str proxy_user: The username of custom data plane proxy server.
        :param builtins.str status: The status of the resource.
        :param builtins.str updated_time: The update time of client. Unix Time Seconds.
        :param builtins.bool use_https: Indicates whether to use the HTTPS protocol. Valid values: `true`, `false`.
        :param builtins.str zone_id: The ID of Zone.
        """
    ...
    def data_network_type(self) -> builtins.str:
        """
    ...
    def data_proxy_setting(self) -> builtins.str:
        """
    ...
    def ecs_backup_client_id(self) -> builtins.str:
        """
    ...
    def last_heart_beat_time(self) -> builtins.str:
        """
    ...
    def max_client_version(self) -> builtins.str:
        """
    ...
    def max_cpu_core(self) -> builtins.str:
        """
    ...
    def max_worker(self) -> builtins.str:
        """
    ...
    def private_ipv4(self) -> builtins.str:
        """
    ...
    def proxy_password(self) -> builtins.str:
        """
    ...
    def proxy_port(self) -> builtins.str:
        """
    ...
    def proxy_user(self) -> builtins.str:
        """
    ...
    def use_https(self) -> builtins.bool:
        """
...
class GetEcsBackupPlansPlanResult(dict):
    def __init__(__self__, *,
                 ...
                 ecs_backup_plan_id: builtins.str,
                 ecs_backup_plan_name: builtins.str,
                 exclude: builtins.str,
                 id: builtins.str,
                 include: builtins.str,
                 instance_id: builtins.str,
                 ...
                 source_type: builtins.str,
                 speed_limit: builtins.str,
                 updated_time: builtins.str,
                 vault_id: builtins.str):
        """
        :param builtins.str backup_type: Backup type. Valid values: `COMPLETE`.
        :param builtins.str created_time: The creation time of the backup plan. UNIX time in seconds.
        :param builtins.bool disabled: Whether to be suspended. Valid values: `true`, `false`.
        :param builtins.str ecs_backup_plan_id: The ID of ecs backup plan.
        :param builtins.str ecs_backup_plan_name: The name of the backup plan.
        :param builtins.str exclude: Exclude path. String of Json list. Up to 255 characters. e.g. `"[\\"/home/work\\"]"`
        :param builtins.str id: The ID of ecs backup plan.
        :param builtins.str include: Include path. String of Json list. Up to 255 characters. e.g. `"[\\"/var\\"]"`
        :param builtins.str instance_id: The ID of ECS instance.
        :param builtins.str options: Windows operating system with application consistency using VSS. eg: {`UseVSS`:false}.
        :param Sequence[builtins.str] paths: Backup path. e.g. `["/home", "/var"]`
        :param builtins.str retention: Backup retention days, the minimum is 1.
        :param builtins.str schedule: Backup strategy. Optional format: `I|{startTime}|{interval}`. It means to execute a backup task every `{interval}` starting from `{startTime}`. The backup task for the elapsed time will not be compensated. If the last backup task has not completed yet, the next backup task will not be triggered.
               * `startTime` Backup start time, UNIX time seconds.
        :param builtins.str source_type: The type of backup source.
        :param builtins.str speed_limit: Flow control. The format is: {start}|{end}|{bandwidth}. Use `|` to separate multiple flow control configurations, multiple flow control configurations not allowed to have overlapping times.
        :param builtins.str updated_time: The update time of the backup plan. UNIX time in seconds.
        :param builtins.str vault_id: The ID of Backup vault.
        """
        pulumi.set(__self__, "backup_type", backup_type)
        pulumi.set(__self__, "create_time", create_time)
    ...
    def ecs_backup_plan_id(self) -> builtins.str:
        """
    ...
    def ecs_backup_plan_name(self) -> builtins.str:
        """
    ...
    def speed_limit(self) -> builtins.str:
        """
...
class GetHanaBackupClientsHanaBackupClientResult(dict):
    def __init__(__self__, *,
                 ...
                 vault_id: builtins.str):
        """
        :param builtins.str alert_setting: The alert settings.
        :param builtins.str client_id: The ID of the backup client.
        :param builtins.str client_name: The name of the backup client.
        :param builtins.str client_type: The type of the backup client.
        :param builtins.str client_version: The version number of the backup client.
        :param builtins.str cluster_id: The ID of the SAP HANA instance.
        :param builtins.str id: The id of the Hana Backup Client. It formats as `<vault_id>:<client_id>`.
        :param builtins.str instance_id: The ID of the instance.
        :param builtins.str instance_name: The name of the ECS instance.
        :param builtins.str max_version: The maximum version number of the backup client.
        ...
        :param builtins.bool use_https: Indicates whether data is transmitted over HTTPS.
    ...
    def alert_setting(self) -> builtins.str:
        """
        The alert settings.
        """
...
class GetHanaBackupPlansPlanResult(dict):
    def __init__(__self__, *,
                 ...
                 vault_id: builtins.str):
        """
        :param builtins.str backup_prefix: The backup prefix.
        :param builtins.str backup_type: The backup type.
        :param builtins.str cluster_id: The ID of the SAP HANA instance.
        :param builtins.str database_name: The name of the database.
        :param builtins.str id: The ID of the resource.
        :param builtins.str plan_id: The ID of the backup plan.
        :param builtins.str plan_name: The name of the backup plan.
        :param builtins.str schedule: The backup policy.
        :param builtins.str status: The status of the resource.
        :param builtins.str vault_id: The ID of the backup vault.
        """
    ...
    def backup_prefix(self) -> builtins.str:
        """
        The backup prefix.
        """
    ...
    def page_total(self) -> builtins.str:
...
class GetHanaInstancesInstanceResult(dict):
    def __init__(__self__, *,
                 alert_setting: builtins.str,
                 hana_instance_id: builtins.str,
                 hana_name: builtins.str,
                 host: builtins.str,
                 id: builtins.str,
                 ...
                 validate_certificate: builtins.bool,
                 vault_id: builtins.str):
        """
        :param builtins.str alert_setting: The alert settings. Valid value: `INHERITED`, which indicates that the backup client sends alert notifications in the same way as the backup vault.
        :param builtins.str hana_instance_id: The ID of the SAP HANA instance.
        :param builtins.str hana_name: The name of the SAP HANA instance.
        :param builtins.str host: The private or internal IP address of the host where the primary node of the SAP HANA instance resides.
        :param builtins.str id: The ID of the Hana Instance. The value formats as `<vault_id>:<hana_instance_id>`.
        :param builtins.int instance_number: The instance number of the SAP HANA system.
        :param builtins.str resource_group_id: The ID of the resource group.
        :param builtins.str status: The status of the SAP HANA instance.
        :param builtins.str status_message: The status information.
        :param builtins.bool use_ssl: Indicates whether the SAP HANA instance is connected over Secure Sockets Layer (SSL).
        :param builtins.str user_name: The username of the SYSTEMDB database.
        :param builtins.bool validate_certificate: Indicates whether the SSL certificate of the SAP HANA instance is verified.
        :param builtins.str vault_id: The ID of the backup vault.
        """
        pulumi.set(__self__, "alert_setting", alert_setting)
    ...
    def hana_instance_id(self) -> builtins.str:
        """
        The ID of the SAP HANA instance.
        """
    ...
    def hana_name(self) -> builtins.str:
        """
...
class GetNasBackupPlansPlanResult(dict):
    def __init__(__self__, *,
                 ...
                 file_system_id: builtins.str,
                 id: builtins.str,
                 nas_backup_plan_id: builtins.str,
                 nas_backup_plan_name: builtins.str,
                 options: builtins.str,
                 paths: Sequence[builtins.str],
                 retention: builtins.str,
                 schedule: builtins.str,
        ...
        """
        :param builtins.str backup_type: Backup type. Valid values: `COMPLETE`.
        :param builtins.str create_time: File System Creation Time. **Note** The time format of the API adopts the ISO 8601 format, such as `2021-07-09T15:45:30CST`.
        :param builtins.str created_time: The creation time of the backup plan. UNIX time in seconds.
        :param builtins.bool disabled: Whether to be suspended. Valid values: `true`, `false`.
        :param builtins.str file_system_id: The File System ID of Nas.
        :param builtins.str id: The ID of Nas backup plan.
        :param builtins.str nas_backup_plan_id: The ID of Nas backup plan.
        :param builtins.str nas_backup_plan_name: The name of the resource.
        :param builtins.str options: Options field of Nas backup plan.
        :param Sequence[builtins.str] paths: List of backup path. Up to 65536 Characters. e.g.`["/home", "/var"]`
        :param builtins.str retention: Backup retention days, the minimum is 1.
        :param builtins.str schedule: Backup strategy. Optional format: `I|{startTime}|{interval}`. It means to execute a backup task every `{interval}` starting from `{startTime}`. The backup task for the elapsed time will not be compensated. If the last backup task has not completed yet, the next backup task will not be triggered.
               * `startTime` Backup start time, UNIX time seconds.
        :param builtins.str updated_time: The update time of the backup plan. UNIX time in seconds.
    ...
    def nas_backup_plan_id(self) -> builtins.str:
        """
        The ID of Nas backup plan.
        """
    ...
    def nas_backup_plan_name(self) -> builtins.str:
        """
...
class GetOssBackupPlansPlanResult(dict):
    def __init__(__self__, *,
                 ...
                 disabled: builtins.bool,
                 id: builtins.str,
                 oss_backup_plan_id: builtins.str,
                 oss_backup_plan_name: builtins.str,
                 prefix: builtins.str,
                 retention: builtins.str,
                 schedule: builtins.str,
                 updated_time: builtins.str,
        ...
        """
        :param builtins.str backup_type: Backup type. Valid values: `COMPLETE`.
        :param builtins.str bucket: The name of OSS bucket.
        :param builtins.str created_time: The creation time of the backup plan. UNIX time in seconds.
        :param builtins.bool disabled: Whether to be suspended. Valid values: `true`, `false`.
        :param builtins.str id: The ID of Oss backup plan.
        :param builtins.str oss_backup_plan_id: The ID of Oss backup plan.
        :param builtins.str oss_backup_plan_name: The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        :param builtins.str prefix: Backup prefix.
        :param builtins.str retention: Backup retention days, the minimum is 1.
    ...
    def oss_backup_plan_id(self) -> builtins.str:
        """
        The ID of Oss backup plan.
        """
    ...
    def oss_backup_plan_name(self) -> builtins.str:
        """
...
class GetOtsBackupPlansPlanResult(dict):
    def __init__(__self__, *,
                 ...
                 disabled: builtins.bool,
                 id: builtins.str,
                 ots_backup_plan_id: builtins.str,
                 ots_backup_plan_name: builtins.str,
                 ...
                 vault_id: builtins.str):
        """
        :param builtins.str backup_type: The Backup type. Valid values: `COMPLETE`.
        :param builtins.str created_time: The creation time of the backup plan. UNIX time in seconds.
        :param builtins.bool disabled: Whether to be suspended. Valid values: `true`, `false`.
        :param builtins.str id: The ID of ots backup plan.
        :param builtins.str ots_backup_plan_id: The ID of ots backup plan.
        :param builtins.str ots_backup_plan_name: The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        :param builtins.str retention: The Backup retention days, the minimum is 1.
        :param builtins.str schedule: The Backup strategy. Optional format: I|{startTime}|{interval}. It means to execute a backup task every {interval} starting from {startTime}. The backup task for the elapsed time will not be compensated. If the last backup task is not completed yet, the next backup task will not be triggered.
               * `startTime` Backup start time, UNIX time seconds.
        :param builtins.str source_type: The type of the data source.
        :param builtins.str updated_time: The update time of the backup plan. UNIX time in seconds.
    ...
    def ots_backup_plan_id(self) -> builtins.str:
        """
        The ID of ots backup plan.
        """
    ...
    def ots_backup_plan_name(self) -> builtins.str:
        """
        The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        """
...
class GetOtsSnapshotsSnapshotResult(dict):
    def __init__(__self__, *,
                 ...
                 instance_name: builtins.str,
                 job_id: builtins.str,
                 parent_snapshot_hash: builtins.str,
                 range_end: builtins.str,
                 range_start: builtins.str,
                 retention: builtins.str,
                 snapshot_hash: builtins.str,
                 ...
                 vault_id: builtins.str):
        """
        :param builtins.str actual_bytes: The actual amount of backup snapshots after duplicates are removed. Unit: bytes.
        :param builtins.str backup_type: The backup type. Valid value: `COMPLETE`, which indicates full backup.
        :param builtins.str bytes_total: The total amount of data. Unit: bytes.
        :param builtins.str complete_time: The time when the backup snapshot was completed. This value is a UNIX timestamp. Unit: seconds.
        :param builtins.str create_time: The time when the Table store instance was created. This value is a UNIX timestamp. Unit: seconds.
        :param builtins.str created_time: The time when the backup snapshot was created. This value is a UNIX timestamp. Unit: seconds.
        :param builtins.str id: The ID of the backup snapshot.
        :param builtins.str instance_name: The name of the Table store instance.
        :param builtins.str job_id: The ID of the backup job.
        :param builtins.str parent_snapshot_hash: The hash value of the parent backup snapshot.
        :param builtins.str range_end: The time when the backup job ended. This value is a UNIX timestamp. Unit: milliseconds.
        :param builtins.str range_start: The time when the backup job started. This value is a UNIX timestamp. Unit: milliseconds.
        :param builtins.str retention: The retention period of the backup snapshot.
        :param builtins.str snapshot_hash: The hash value of the backup snapshot.
        :param builtins.str snapshot_id: The ID of the backup snapshot.
        :param builtins.str source_type: The type of the data source. Valid values: `ECS_FILE`,`PARTIAL_COMPLETE`,`FAILED`
        :param builtins.str start_time: The start time of the backup snapshot. This value is a UNIX timestamp. Unit: seconds.
        :param builtins.str status: The status of the backup job. Valid values: `COMPLETE`,`PARTIAL_COMPLETE`,`FAILED`.
        :param builtins.str table_name: The name of the table in the Table store instance.
        :param builtins.str updated_time: The time when the backup snapshot was updated. This value is a UNIX timestamp. Unit: seconds.
        :param builtins.str vault_id: The ID of the backup vault that stores the backup snapshot.
        """
        pulumi.set(__self__, "actual_bytes", actual_bytes)
        pulumi.set(__self__, "backup_type", backup_type)
        pulumi.set(__self__, "bytes_total", bytes_total)
    ...
    def parent_snapshot_hash(self) -> builtins.str:
        """
    ...
    def snapshot_hash(self) -> builtins.str:
        """
...
class GetReplicationVaultRegionsRegionResult(dict):
    def __init__(__self__, *,
                 replication_region_id: builtins.str):
        """
        :param builtins.str replication_region_id: The ID of the replication region.
        """
        pulumi.set(__self__, "replication_region_id", replication_region_id)

    @property
    @pulumi.getter(name="replicationRegionId")
    def replication_region_id(self) -> builtins.str:
        """
...
class GetRestoreJobsJobResult(dict):
    def __init__(__self__, *,
                 ...
                 target_create_time: builtins.str,
                 target_data_source_id: builtins.str,
                 target_file_system_id: builtins.str,
                 ...
                 vault_id: builtins.str):
        """
        :param builtins.str actual_bytes: The actual size of Snapshot.
        :param builtins.str actual_items: The actual number of files.
        :param builtins.str bytes_done: The size of restore job recovered.
        :param builtins.str bytes_total: The total size of restore job recovered.
        :param builtins.str complete_time: The completion time of restore Job.
        :param builtins.str create_time: The creation time of restore job.
        :param builtins.str error_message: The error message of recovery task execution.
        :param builtins.str expire_time: The expiration time of restore job. Unix Time in seconds.
        :param builtins.str id: The ID of the restore job.
        :param builtins.str items_done: The number of items restore job recovered.
        :param builtins.str items_total: The total number of items restore job recovered.
        :param builtins.str options: Recovery Options.
        :param builtins.int progress: The recovery progress.
        :param builtins.str restore_job_id: The ID of restore job.
        :param builtins.str restore_type: The type of recovery destination. Valid Values: `ECS_FILE`, `OSS`, `NAS`.
        :param builtins.str snapshot_hash: The hashcode of Snapshot.
        :param builtins.str snapshot_id: The ID of Snapshot.
        :param builtins.str source_type: The list of data source types. Valid values: `ECS_FILE`, `NAS`, `OSS`, `OTS_TABLE`,`UDM_ECS_ROLLBACK`.
        :param builtins.str start_time: The start time of restore job. Unix Time in Seconds.
        :param builtins.str status: The status of restore job.
        :param builtins.str target_bucket: The name of target ofo OSS bucket.
        :param builtins.str target_create_time: The creation time of destination file system.
        :param builtins.str target_file_system_id: The ID of destination file system.
        :param builtins.str target_instance_id: The ID of target ECS instance.
        :param builtins.str target_path: The target file path of ECS instance.
        :param builtins.str target_prefix: The file prefix of target OSS object.
        :param builtins.str updated_time: The update Time of restore job. Unix Time in Seconds.
        :param builtins.str vault_id: The ID of backup vault.
        """
        pulumi.set(__self__, "actual_bytes", actual_bytes)
        pulumi.set(__self__, "actual_items", actual_items)
    ...
    def error_file(self) -> builtins.str:
    ...
    def target_create_time(self) -> builtins.str:
        """
    ...
    def target_data_source_id(self) -> builtins.str:
        return pulumi.get(self, "target_data_source_id")

    @property
    @pulumi.getter(name="targetFileSystemId")
    def target_file_system_id(self) -> builtins.str:
        """
        The ID of destination file system.
        """
...
class GetServerBackupPlansPlanResult(dict):
    def __init__(__self__, *,
                 ...
                 disabled: builtins.bool,
                 ecs_server_backup_plan_id: builtins.str,
                 ecs_server_backup_plan_name: builtins.str,
                 id: builtins.str,
                 instance_id: builtins.str,
                 retention: builtins.str,
                 schedule: builtins.str):
        """
        :param builtins.str create_time: The creation time of backup plan.
        :param Sequence['GetServerBackupPlansPlanDetailArgs'] details: ECS server backup plan details.
        :param builtins.bool disabled: Whether to disable the backup task. Valid values: `true`, `false`.
        :param builtins.str ecs_server_backup_plan_id: The ID of the server backup plan.
        :param builtins.str ecs_server_backup_plan_name: The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        :param builtins.str id: The ID of the server backup plan.
        :param builtins.str instance_id: The ID of ECS Instance.
        :param builtins.str retention: Backup retention days, the minimum is 1.
        :param builtins.str schedule: Backup strategy.
        """
        pulumi.set(__self__, "create_time", create_time)
    ...
    def ecs_server_backup_plan_id(self) -> builtins.str:
        """
    ...
    def ecs_server_backup_plan_name(self) -> builtins.str:
        """
        The name of the backup plan. 1~64 characters, the backup plan name of each data source type in a single warehouse required to be unique.
        """
...
class GetServerBackupPlansPlanDetailResult(dict):
    def __init__(__self__, *,
                 ...
                 destination_retention: builtins.int,
                 disk_id_lists: Sequence[builtins.str],
                 do_copy: builtins.bool,
                 enable_fs_freeze: builtins.bool,
                 post_script_path: builtins.str,
                 pre_script_path: builtins.str,
                 snapshot_group: builtins.bool,
    ...
    @property
    @pulumi.getter(name="destinationRetention")
    def destination_retention(self) -> builtins.int:
        """
        Only vaild when DoCopy is true. The retention days of the destination backup. When not specified, the destination backup will be saved permanently. **Note:** Once you set a value of this property, you cannot set it to an empty string anymore.
        """
        return pulumi.get(self, "destination_retention")
    ...
    @property
    @pulumi.getter(name="diskIdLists")
    def disk_id_lists(self) -> Sequence[builtins.str]:
        """
        The list of cloud disks to be backed up in the ECS instance. When not specified, a snapshot is executed for all the disks on the ECS instance.
        """
        return pulumi.get(self, "disk_id_lists")
    ...
    @property
    @pulumi.getter(name="doCopy")
    def do_copy(self) -> builtins.bool:
        """
        Whether replicate to another region. Valid values: `true`, `false`.
        """
        return pulumi.get(self, "do_copy")
    ...
    @property
    @pulumi.getter(name="enableFsFreeze")
    def enable_fs_freeze(self) -> builtins.bool:
        """
        Only the Linux system is valid. Whether to use the Linux FsFreeze mechanism to ensure that the file system is read-only consistent before creating a storage snapshot. The default is True. Valid values: `true`, `false`.
        """
        return pulumi.get(self, "enable_fs_freeze")
    ...
    @property
    @pulumi.getter(name="postScriptPath")
    def post_script_path(self) -> builtins.str:
        """
        Only vaild for the linux system when AppConsistent is true. The application thaw script path (e.g. /tmp/postscript.sh). The postscript.sh script must meet the following conditions: in terms of permissions, only the root user as the owner has read, write, and execute permissions, that is, 700 permissions. In terms of content, the script content needs to be customized according to the application itself. This indicates that this parameter must be set when creating an application consistency snapshot for a Linux instance. If the script is set incorrectly (for example, permissions, save path, or file name are set incorrectly), the resulting snapshot is a file system consistency snapshot.
        """
        return pulumi.get(self, "post_script_path")
    ...
    @property
    @pulumi.getter(name="preScriptPath")
    def pre_script_path(self) -> builtins.str:
        """
        Only vaild for the linux system when AppConsistent is true. Apply the freeze script path (e.g. /tmp/prescript.sh). prescript.sh scripts must meet the following conditions: in terms of permissions, only root, as the owner, has read, write, and execute permissions, that is, 700 permissions. In terms of content, the script content needs to be customized according to the application itself. This indicates that this parameter must be set when creating an application consistency snapshot for a Linux instance. If the script is set incorrectly (for example, permissions, save path, or file name are set incorrectly), the resulting snapshot is a file system consistency snapshot.
        """
        return pulumi.get(self, "pre_script_path")
...
class GetSnapshotsSnapshotResult(dict):
    def __init__(__self__, *,
                 ...
                 updated_time: builtins.str):
        """
        :param builtins.str actual_bytes: The actual data volume of the snapshot. Unit byte.
        :param builtins.str actual_items: The actual number of items in the snapshot. (Currently only file backup is available).
        :param builtins.str backup_type: Backup type. Possible values: `COMPLETE` (full backup).
        :param builtins.str bucket: The name of OSS bucket.
        :param builtins.str bytes_done: The incremental amount of backup data. Unit byte.
        :param builtins.str bytes_total: The total amount of data sources. Unit byte.
        :param builtins.str client_id: The ID of ECS backup client.
        :param builtins.str complete_time: The time when the snapshot completed. UNIX time in seconds.
        :param builtins.str create_time: File System Creation Time of Nas. Unix Time Seconds.
        :param builtins.str created_time: Snapshot creation time. UNIX time in seconds.
        :param builtins.str file_system_id: The ID of NAS File system.
        :param builtins.str id: The ID of the Snapshot.
        :param builtins.str instance_id: The ID of ECS instance.
        :param builtins.str items_done: The number of backup items. (Currently only file backup is available).
        :param builtins.str items_total: The total number of data source items. (Currently only file backup is available).
        :param builtins.str job_id: The job ID of backup task.
        :param builtins.str parent_snapshot_hash: The hashcode of parent backup snapshot.
        :param builtins.str path: Backup Path.
        :param builtins.str prefix: Backup file prefix.
        :param builtins.str retention: The number of days to keep.
        :param builtins.str snapshot_hash: The hashcode of Snapshot.
        :param builtins.str snapshot_id: The ID of the Snapshot.
        :param builtins.str source_type: Data source type, optional values: `ECS_FILE`, `OSS`, `NAS`.
        :param builtins.str start_time: The start time of the snapshot. UNIX time in seconds.
        :param builtins.str status: The status of snapshot execution. Possible values: `COMPLETE`, `PARTIAL_COMPLETE`, `FAILED`.
        :param builtins.str updated_time: The update time of snapshot. UNIX time in seconds.
        """
        pulumi.set(__self__, "actual_bytes", actual_bytes)
        pulumi.set(__self__, "actual_items", actual_items)
        pulumi.set(__self__, "backup_type", backup_type)
...
class GetVaultsVaultResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 index_available: builtins.bool,
                 index_level: builtins.str,
                 index_update_time: builtins.str,
                 latest_replication_time: builtins.str,
                 payment_type: builtins.str,
                 replication: builtins.bool,
                 replication_source_region_id: builtins.str,
                 replication_source_vault_id: builtins.str,
                 retention: builtins.str,
                 search_enabled: builtins.bool,
                 source_types: Sequence[builtins.str],
                 status: builtins.str,
                 storage_size: builtins.str,
                 updated_time: builtins.str,
                 vault_id: builtins.str,
                 vault_name: builtins.str,
                 vault_status_message: builtins.str,
                 vault_storage_class: builtins.str,
                 vault_type: builtins.str):
        """
        :param builtins.str bucket_name: The name of the OSS bucket of the Vault.
        :param builtins.str bytes_done: The amount of backup data. The unit is Byte.
        :param builtins.str created_time: The creation time of the Vault. UNIX time in seconds.
        :param builtins.bool dedup: Whether to enable the deduplication function for the database backup Vault.
        :param builtins.str description: The description of the vault.
        :param builtins.str id: The ID of vault.
        :param builtins.bool index_available: Index available.
        :param builtins.str index_level: Index level.
        :param builtins.str index_update_time: Index update time.
        :param builtins.str latest_replication_time: The time of the last remote backup synchronization.
        :param builtins.str payment_type: Billing model, possible values:
               * `FREE` is not billed
        ...
        :param builtins.bool replication: Whether it is a remote backup warehouse. It's a boolean value.
        :param builtins.str replication_source_region_id: The region ID to which the remote backup Vault belongs.
        :param builtins.str replication_source_vault_id: The source vault ID of the remote backup Vault.
        :param builtins.str retention: Warehouse-level data retention days, only valid for archive libraries.
        :param builtins.bool search_enabled: Whether to enable the backup search function.
        :param builtins.str status: The status of Vault. Valid values: `CREATED`, `ERROR`, `UNKNOWN`.
        :param builtins.str storage_size: Backup vault storage usage. The unit is Byte.
        :param builtins.str updated_time: The update time of the Vault. UNIX time in seconds.
        :param builtins.str vault_id: The ID of vault, same as `id`.
        :param builtins.str vault_name: The name of vault.
        :param builtins.str vault_status_message: Error status information of Vault. Only valid for remote backup warehouses. Only the remote backup warehouse is valid.
        :param builtins.str vault_storage_class: The storage class of vault. Valid values: `STANDARD`.
        :param builtins.str vault_type: The type of Vault. Valid values: `STANDARD`,`OTS_BACKUP`.
        """
    ...
    def index_available(self) -> builtins.bool:
        """
        Index available.
        """
    ...
    def index_level(self) -> builtins.str:
        """
        Index level.
        """
    ...
    def index_update_time(self) -> builtins.str:
        """
        Index update time.
        """
    ...
    def latest_replication_time(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def replication(self) -> builtins.bool:
        """
    ...
    def replication_source_region_id(self) -> builtins.str:
        """
    ...
    def replication_source_vault_id(self) -> builtins.str:
        """
    ...
    def search_enabled(self) -> builtins.bool:
        """
    ...
    def source_types(self) -> Sequence[builtins.str]:
    ...
    def storage_size(self) -> builtins.str:
        """
    ...
    def vault_status_message(self) -> builtins.str:
        """
    ...
    def vault_storage_class(self) -> builtins.str:
        """
