...
class HanaBackupClientArgs:
    def __init__(__self__, *,
                 ...
                 client_info: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] alert_setting: The alert settings. Valid value: `INHERITED`.
        :param pulumi.Input[builtins.str] client_info: The installation information of the HBR clients.
        :param pulumi.Input[builtins.bool] use_https: Specifies whether to transmit data over HTTPS. Valid values: `true`, `false`.
        """
    ...
    def client_info(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @client_info.setter
    def client_info(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _HanaBackupClientState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alert_setting: The alert settings. Valid value: `INHERITED`.
        :param pulumi.Input[builtins.str] client_id: The ID of the backup client.
        :param pulumi.Input[builtins.str] client_info: The installation information of the HBR clients.
        :param pulumi.Input[builtins.str] cluster_id: The ID of the SAP HANA instance.
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] status: The status of the Hana Backup Client.
        :param pulumi.Input[builtins.bool] use_https: Specifies whether to transmit data over HTTPS. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] vault_id: The ID of the backup vault.
        """
        if alert_setting is not None:
...
class HanaBackupClient(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:hbr/hanaBackupClient:HanaBackupClient"
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            use_https: Optional[pulumi.Input[builtins.bool]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'HanaBackupClient':
        """
    ...
    @property
    @pulumi.getter(name="clientInfo")
    def client_info(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The installation information of the HBR clients.
        """
        return pulumi.get(self, "client_info")
    ...
    @property
    @pulumi.getter(name="useHttps")
    def use_https(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to transmit data over HTTPS. Valid values: `true`, `false`.
        """
        return pulumi.get(self, "use_https")
