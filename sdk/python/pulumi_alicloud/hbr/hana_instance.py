...
class HanaInstanceArgs:
    def __init__(__self__, *,
                 ...
                 alert_setting: Optional[pulumi.Input[builtins.str]] = None,
                 ecs_instance_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 hana_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 validate_certificate: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a HanaInstance resource.
        :param pulumi.Input[builtins.str] vault_id: The ID of the backup vault.
        :param pulumi.Input[builtins.str] alert_setting: The alert settings. Valid value: `INHERITED`, which indicates that the backup client sends alert notifications in the same way as the backup vault.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ecs_instance_ids: The IDs of ECS instances that host the SAP HANA instance to be registered. HBR installs backup clients on the specified ECS instances.
        :param pulumi.Input[builtins.str] hana_name: The name of the SAP HANA instance.
        :param pulumi.Input[builtins.str] host: The private or internal IP address of the host where the primary node of the SAP HANA instance resides.
        :param pulumi.Input[builtins.int] instance_number: The instance number of the SAP HANA system.
        :param pulumi.Input[builtins.str] password: The password that is used to connect with the SAP HANA database.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] sid: The security identifier (SID) of the SAP HANA database.
        :param pulumi.Input[builtins.bool] use_ssl: Specifies whether to connect with the SAP HANA database over Secure Sockets Layer (SSL).
        :param pulumi.Input[builtins.str] user_name: The username of the SYSTEMDB database.
        :param pulumi.Input[builtins.bool] validate_certificate: Specifies whether to verify the SSL certificate of the SAP HANA database.
        """
    ...
    def alert_setting(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alert_setting(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alert_setting", value)

    @property
    @pulumi.getter(name="ecsInstanceIds")
    def ecs_instance_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def ecs_instance_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "ecs_instance_ids", value)

    @property
    @pulumi.getter(name="hanaName")
    def hana_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @hana_name.setter
    def hana_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def validate_certificate(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def validate_certificate(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _HanaInstanceState:
    def __init__(__self__, *,
                 alert_setting: Optional[pulumi.Input[builtins.str]] = None,
                 ecs_instance_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 hana_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 hana_name: Optional[pulumi.Input[builtins.str]] = None,
                 host: Optional[pulumi.Input[builtins.str]] = None,
                 instance_number: Optional[pulumi.Input[builtins.int]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] alert_setting: The alert settings. Valid value: `INHERITED`, which indicates that the backup client sends alert notifications in the same way as the backup vault.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ecs_instance_ids: The IDs of ECS instances that host the SAP HANA instance to be registered. HBR installs backup clients on the specified ECS instances.
        :param pulumi.Input[builtins.str] hana_instance_id: The id of the Hana Instance.
        :param pulumi.Input[builtins.str] hana_name: The name of the SAP HANA instance.
        :param pulumi.Input[builtins.str] host: The private or internal IP address of the host where the primary node of the SAP HANA instance resides.
        :param pulumi.Input[builtins.int] instance_number: The instance number of the SAP HANA system.
        :param pulumi.Input[builtins.str] password: The password that is used to connect with the SAP HANA database.
    ...
    def hana_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hana_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HanaInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_name: Optional[pulumi.Input[builtins.str]] = None,
            validate_certificate: Optional[pulumi.Input[builtins.bool]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'HanaInstance':
        """
    ...
    @property
    @pulumi.getter(name="alertSetting")
    def alert_setting(self) -> pulumi.Output[builtins.str]:
        """
        The alert settings. Valid value: `INHERITED`, which indicates that the backup client sends alert notifications in the same way as the backup vault.
        """
        return pulumi.get(self, "alert_setting")
    ...
    @property
    @pulumi.getter(name="ecsInstanceIds")
    def ecs_instance_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The IDs of ECS instances that host the SAP HANA instance to be registered. HBR installs backup clients on the specified ECS instances.
        """
        return pulumi.get(self, "ecs_instance_ids")
    ...
    @property
    @pulumi.getter(name="hanaInstanceId")
    def hana_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the Hana Instance.
        """
        return pulumi.get(self, "hana_instance_id")
    ...
    @property
    @pulumi.getter(name="hanaName")
    def hana_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the SAP HANA instance.
        """
        return pulumi.get(self, "hana_name")
    ...
    @property
    @pulumi.getter(name="instanceNumber")
    def instance_number(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The instance number of the SAP HANA system.
        """
        return pulumi.get(self, "instance_number")
    ...
    @property
    @pulumi.getter(name="validateCertificate")
    def validate_certificate(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to verify the SSL certificate of the SAP HANA database.
        """
        return pulumi.get(self, "validate_certificate")
