...
class HanaBackupPlanArgs:
    def __init__(__self__, *,
                 ...
                 backup_prefix: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] backup_type: The backup type. Valid values:
        ...
        :param pulumi.Input[builtins.str] plan_name: The name of the backup plan.
        :param pulumi.Input[builtins.str] schedule: The backup policy. Format: `I|{startTime}|{interval}`. The system runs the first backup job at a point in time that is specified in the {startTime} parameter and the subsequent backup jobs at an interval that is specified in the {interval} parameter. The system does not run a backup job before the specified point in time. Each backup job, except the first one, starts only after the previous backup job is completed. For example, I|1631685600|P1D specifies that the system runs the first backup job at 14:00:00 on September 15, 2021 and the subsequent backup jobs once a day.
        :param pulumi.Input[builtins.str] vault_id: The ID of the backup vault.
        :param pulumi.Input[builtins.str] backup_prefix: The backup prefix.
        :param pulumi.Input[builtins.str] resource_group_id: The resource attribute field that represents the resource group ID.
    ...
    def backup_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The backup prefix.
        """
    ...
    def backup_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HanaBackupPlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            schedule: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'HanaBackupPlan':
        """
    ...
    @property
    @pulumi.getter(name="backupPrefix")
    def backup_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The backup prefix.
        """
        return pulumi.get(self, "backup_prefix")
