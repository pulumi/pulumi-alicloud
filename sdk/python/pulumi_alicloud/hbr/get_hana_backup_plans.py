...
def get_hana_backup_plans(cluster_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Hana Backup Plan IDs.
    :param builtins.str name_regex: A regex string to filter results by Hana Backup Plan name.
...
def get_hana_backup_plans_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                                 database_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
