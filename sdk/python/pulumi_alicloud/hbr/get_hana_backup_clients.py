...
def get_hana_backup_clients(client_id: Optional[builtins.str] = None,
    ...
    :param builtins.str client_id: The ID of the backup client.
    :param builtins.str cluster_id: The ID of the SAP HANA instance.
    :param Sequence[builtins.str] ids: A list of Hana Backup Client IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the Hana Backup Client. Valid Values: `REGISTERED`, `ACTIVATED`, `DEACTIVATED`, `INSTALLING`, `INSTALL_FAILED`, `NOT_INSTALLED`, `UPGRADING`, `UPGRADE_FAILED`, `UNINSTALLING`, `UNINSTALL_FAILED`, `STOPPED`, `UNKNOWN`.
    :param builtins.str vault_id: The ID of the backup vault.
    """
    __args__ = dict()
...
def get_hana_backup_clients_output(client_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
