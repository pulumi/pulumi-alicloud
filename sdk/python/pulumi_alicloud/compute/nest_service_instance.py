...
class NestServiceInstanceArgs:
    def __init__(__self__, *,
                 ...
                 service_version: pulumi.Input[builtins.str],
                 commodity: Optional[pulumi.Input['NestServiceInstanceCommodityArgs']] = None,
                 enable_instance_ops: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_user_prometheus: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 service_instance_name: Optional[pulumi.Input[builtins.str]] = None,
                 specification_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] service_version: The version of the service.
        :param pulumi.Input['NestServiceInstanceCommodityArgs'] commodity: The order information of cloud market. See `commodity` below.
        :param pulumi.Input[builtins.bool] enable_instance_ops: Whether the service instance has the O&M function. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.bool] enable_user_prometheus: Whether Prometheus monitoring is enabled. Default value: `false`. Valid values:
        ...
        :param pulumi.Input[builtins.str] parameters: The parameters entered by the deployment service instance.
        :param pulumi.Input[builtins.str] payment_type: The type of payment. Valid values: `Permanent`, `Subscription`, `PayAsYouGo`, `CustomFixTime`.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] service_instance_name: The name of the Service Instance.
        :param pulumi.Input[builtins.str] specification_name: The name of the specification.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] template_name: The name of the template.
        """
    ...
    def service_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def service_version(self, value: pulumi.Input[builtins.str]):
    ...
    def enable_instance_ops(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_instance_ops(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_instance_ops", value)

    @property
    @pulumi.getter(name="enableUserPrometheus")
    def enable_user_prometheus(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_user_prometheus(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def service_instance_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_instance_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_instance_name", value)

    @property
    @pulumi.getter(name="specificationName")
    def specification_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def specification_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NestServiceInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_version: The version of the service.
        :param pulumi.Input[builtins.str] specification_name: The name of the specification.
        :param pulumi.Input[builtins.str] status: The status of the Service Instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] template_name: The name of the template.
        """
        if commodity is not None:
...
class NestServiceInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            template_name: Optional[pulumi.Input[builtins.str]] = None) -> 'NestServiceInstance':
        """
    ...
    @property
    @pulumi.getter(name="enableInstanceOps")
    def enable_instance_ops(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the service instance has the O&M function. Default value: `false`. Valid values:
        """
        return pulumi.get(self, "enable_instance_ops")
    ...
    @property
    @pulumi.getter(name="enableUserPrometheus")
    def enable_user_prometheus(self) -> pulumi.Output[builtins.bool]:
        """
        Whether Prometheus monitoring is enabled. Default value: `false`. Valid values:
        """
        return pulumi.get(self, "enable_user_prometheus")
    ...
    @property
    @pulumi.getter(name="serviceInstanceName")
    def service_instance_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Service Instance.
        """
        return pulumi.get(self, "service_instance_name")
    ...
    @property
    @pulumi.getter(name="specificationName")
    def specification_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the specification.
        """
        return pulumi.get(self, "specification_name")
