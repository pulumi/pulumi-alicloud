...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 delete_snapshot: Optional[pulumi.Input[builtins.bool]] = None,
                 ecs_lists: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceEcsListArgs']]]] = None,
                 enable_raid: Optional[pulumi.Input[builtins.bool]] = None,
                 encryption: Optional[pulumi.Input[builtins.bool]] = None,
                 fs_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 raid_stripe_unit_number: Optional[pulumi.Input[builtins.int]] = None,
                 snapshot_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 used_scene: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Instance resource.
        :param pulumi.Input[builtins.str] category: Category of database file system.
        :param pulumi.Input[builtins.int] size: Size of database file system, unit GiB.
        :param pulumi.Input[builtins.str] zone_id: The ID of the zone to which the database file system belongs.
        :param pulumi.Input[builtins.str] advanced_features: The number of CPU cores and the upper limit of memory used by the database file storage instance.
        :param pulumi.Input[builtins.bool] delete_snapshot: Whether to delete the original snapshot after creating DBFS using the snapshot.
        ...
        :param pulumi.Input[builtins.bool] enable_raid: Whether to create DBFS in RAID mode. If created in RAID mode, the capacity is at least 66GB.Valid values: true or false. Default value: false.
        :param pulumi.Input[builtins.bool] encryption: Whether to encrypt DBFS.Valid values: true or false. Default value: false.
        :param pulumi.Input[builtins.str] fs_name: Database file system name.
        :param pulumi.Input[builtins.str] instance_name: . Field 'instance_name' has been deprecated from provider version 1.212.0. New field 'fs_name' instead.
        :param pulumi.Input[builtins.str] instance_type: Instance type. Value range:
               - dbfs.small
               - dbfs.medium
               - dbfs.large (default)
        :param pulumi.Input[builtins.str] kms_key_id: The ID of the KMS key used by DBFS.
        :param pulumi.Input[builtins.str] performance_level: When you create a DBFS instance, set the performance level of the DBFS instance. Value range:
        ...
        :param pulumi.Input[builtins.int] raid_stripe_unit_number: Number of strips. Required when the EnableRaid parameter is true.Value range: Currently, only 8 stripes are supported.
        :param pulumi.Input[builtins.str] snapshot_id: The ID of the snapshot used to create the DBFS instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
               
               The following arguments will be discarded. Please use new fields as soon as possible:
        :param pulumi.Input[builtins.str] used_scene: The usage scenario of DBFS. Value range:
               - MySQL 5.7
               - PostgreSQL
               - MongoDB.
        """
    ...
    def delete_snapshot(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def delete_snapshot(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def enable_raid(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @enable_raid.setter
    def enable_raid(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def fs_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @fs_name.setter
    def fs_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def raid_stripe_unit_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def raid_stripe_unit_number(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def used_scene(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @used_scene.setter
    def used_scene(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Instance(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:databasefilesystem/instance:Instance"
    ...
    @property
    @pulumi.getter(name="deleteSnapshot")
    def delete_snapshot(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to delete the original snapshot after creating DBFS using the snapshot.
        """
        return pulumi.get(self, "delete_snapshot")
    ...
    @property
    @pulumi.getter(name="enableRaid")
    def enable_raid(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to create DBFS in RAID mode. If created in RAID mode, the capacity is at least 66GB.Valid values: true or false. Default value: false.
        """
        return pulumi.get(self, "enable_raid")
    ...
    @property
    @pulumi.getter(name="fsName")
    def fs_name(self) -> pulumi.Output[builtins.str]:
        """
        Database file system name.
        """
        return pulumi.get(self, "fs_name")
    ...
    @property
    @pulumi.getter(name="raidStripeUnitNumber")
    def raid_stripe_unit_number(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of strips. Required when the EnableRaid parameter is true.Value range: Currently, only 8 stripes are supported.
        """
        return pulumi.get(self, "raid_stripe_unit_number")
    ...
    @property
    @pulumi.getter(name="usedScene")
    def used_scene(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The usage scenario of DBFS. Value range:
        - MySQL 5.7
        - PostgreSQL
