...
class AutoSnapShotPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_name: Automatic snapshot policy name
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] repeat_weekdays: A collection of automatic snapshots performed on several days of the week. Value range: 1~7, for example, `1` means Monday.
        :param pulumi.Input[builtins.int] retention_days: Automatic snapshot retention days.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] time_points: The set of times at which the snapshot is taken on the day the automatic snapshot is executed. Value range: `00` to `23`, representing 24 time points from 00:00 to 23:00, for example, `01` indicates 01:00.
        """
...
class _AutoSnapShotPolicyState:
    def __init__(__self__, *,
                 applied_dbfs_number: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 status_detail: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] applied_dbfs_number: The number of database file systems set by the automatic snapshot policy.
        :param pulumi.Input[builtins.str] create_time: The creation time of the resource
        :param pulumi.Input[builtins.str] last_modified: Last modification time of automatic snapshot policy
        :param pulumi.Input[builtins.str] policy_id: Automatic snapshot policy ID
        :param pulumi.Input[builtins.str] policy_name: Automatic snapshot policy name
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] repeat_weekdays: A collection of automatic snapshots performed on several days of the week. Value range: 1~7, for example, `1` means Monday.
        :param pulumi.Input[builtins.int] retention_days: Automatic snapshot retention days.
        :param pulumi.Input[builtins.str] status: Automatic snapshot policy status
        :param pulumi.Input[builtins.str] status_detail: Automatic snapshot policy status details
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] time_points: The set of times at which the snapshot is taken on the day the automatic snapshot is executed. Value range: `00` to `23`, representing 24 time points from 00:00 to 23:00, for example, `01` indicates 01:00.
        """
    ...
    def applied_dbfs_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def applied_dbfs_number(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def status_detail(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def status_detail(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("alicloud:databasefilesystem/autoSnapShotPolicy:AutoSnapShotPolicy")
class AutoSnapShotPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="appliedDbfsNumber")
    def applied_dbfs_number(self) -> pulumi.Output[builtins.int]:
        """
        The number of database file systems set by the automatic snapshot policy.
        """
        return pulumi.get(self, "applied_dbfs_number")
    ...
    @property
    @pulumi.getter(name="statusDetail")
    def status_detail(self) -> pulumi.Output[builtins.str]:
        """
        Automatic snapshot policy status details
        """
        return pulumi.get(self, "status_detail")
