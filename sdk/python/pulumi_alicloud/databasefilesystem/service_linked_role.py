...
class ServiceLinkedRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] product_name: The product name for SLR. Dbfs can automatically create the following service-linked roles: `AliyunServiceRoleForDbfs`.
        """
...
class _ServiceLinkedRoleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] product_name: The product name for SLR. Dbfs can automatically create the following service-linked roles: `AliyunServiceRoleForDbfs`.
        :param pulumi.Input[builtins.bool] status: The status of the service Associated role. Valid Values: `true`: Created. `false`: not created.
        """
...
@pulumi.type_token("alicloud:databasefilesystem/serviceLinkedRole:ServiceLinkedRole")
class ServiceLinkedRole(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            product_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.bool]] = None) -> 'ServiceLinkedRole':
        """
