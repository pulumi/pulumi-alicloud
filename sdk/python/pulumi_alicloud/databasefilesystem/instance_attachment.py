...
class InstanceAttachmentArgs:
    def __init__(__self__, *,
                 ecs_id: pulumi.Input[builtins.str],
    ...
    def ecs_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ecs_id.setter
    def ecs_id(self, value: pulumi.Input[builtins.str]):
...
class _InstanceAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ecs_id: The ID of the ECS instance.
        :param pulumi.Input[builtins.str] instance_id: The ID of the Database File System.
        :param pulumi.Input[builtins.str] status: The status of Instance Attachment.
        """
...
class InstanceAttachment(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:databasefilesystem/instanceAttachment:InstanceAttachment"
    ...
    @property
    @pulumi.getter(name="ecsId")
    def ecs_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the ECS instance.
        """
        return pulumi.get(self, "ecs_id")
