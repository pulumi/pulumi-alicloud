...
def get_auto_snap_shot_policies(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Auto Snap Shot Policy IDs.
    :param builtins.str name_regex: A regex string to filter results by Auto Snap Shot Policy name.
...
def get_auto_snap_shot_policies_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
