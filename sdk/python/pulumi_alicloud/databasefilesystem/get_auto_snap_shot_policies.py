...
def get_auto_snap_shot_policies(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Auto Snap Shot Policy IDs.
    :param _builtins.str name_regex: A regex string to filter results by Auto Snap Shot Policy name.
...
def get_auto_snap_shot_policies_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
