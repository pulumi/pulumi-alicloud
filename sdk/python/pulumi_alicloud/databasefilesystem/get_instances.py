...
def get_instances(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str status: Database file system state. Valid values: `attached`, `attaching`, `creating`, `deleted`, `deleting`, `detaching`, `resizing`, `snapshotting`, `unattached`, `upgrading`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_instances_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:databasefilesystem/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult)
