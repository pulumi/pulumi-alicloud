...
def get_snapshots(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param _builtins.str status: The status of the snapshot. Valid values: `accomplished`, `failed`, `progressing`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_snapshots_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:databasefilesystem/getSnapshots:getSnapshots', __args__, opts=opts, typ=GetSnapshotsResult)
