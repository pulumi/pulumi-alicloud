...
def get_snapshots(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str status: The status of the snapshot. Valid values: `accomplished`, `failed`, `progressing`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_snapshots_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
