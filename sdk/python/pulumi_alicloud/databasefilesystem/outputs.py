...
class InstanceEcsList(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str ecs_id: The ID of the ECS instance.
        """
...
class GetAutoSnapShotPoliciesAutoSnapShotPolicyResult(dict):
    def __init__(__self__, *,
                 applied_dbfs_number: builtins.int,
        ...
        """
        :param builtins.int applied_dbfs_number: The number of database file systems set by the automatic snapshot policy.
        :param builtins.str create_time: The creation time of the resource
        :param builtins.str id: The ID of the policy.
        :param builtins.str last_modified: Last modification time of automatic snapshot policy
        :param builtins.str policy_id: Automatic snapshot policy ID
        :param builtins.str policy_name: Automatic snapshot policy name
        :param Sequence[builtins.str] repeat_weekdays: A collection of automatic snapshots performed on several days of the week.
        :param builtins.int retention_days: Automatic snapshot retention days
        :param builtins.str status: Automatic snapshot policy status
        :param builtins.str status_detail: Automatic snapshot policy status details
        :param Sequence[builtins.str] time_points: The set of times at which the snapshot is taken on the day the automatic snapshot is executed.
        """
    ...
    def applied_dbfs_number(self) -> builtins.int:
        """
...
class GetInstancesInstanceResult(dict):
    def __init__(__self__, *,
                 attach_node_number: builtins.int,
                 category: builtins.str,
                 create_time: builtins.str,
                 dbfs_cluster_id: builtins.str,
                 ecs_lists: Sequence['outputs.GetInstancesInstanceEcsListResult'],
                 enable_raid: builtins.bool,
                 encryption: builtins.bool,
                 id: builtins.str,
                 ...
                 raid_stripe_unit_number: builtins.str,
                 size: builtins.int,
                 status: builtins.str,
                 zone_id: builtins.str):
        """
        :param builtins.int attach_node_number: the number of nodes of the Database file system.
        :param builtins.str category: The type of the Database file system. Valid values: `standard`.
        :param builtins.str create_time: The create time of the Database file system.
        :param builtins.str dbfs_cluster_id: The cluster ID of the Database file system.
        ...
        :param builtins.bool enable_raid: Whether to create the Database file system in RAID way. Valid values : `true` anf `false`.
        :param builtins.bool encryption: Whether to encrypt the Database file system. Valid values: `true` and `false`.
        :param builtins.str id: The ID of the Instance.
        :param builtins.str instance_id: The ID of the Database File System
        :param builtins.str instance_name: The name of the Database file system.
        :param builtins.str kms_key_id: The KMS key ID of the Database file system used. This parameter is valid When `encryption` parameter is set to `true`.
        :param builtins.str payment_type: Thr payment type of the Database file system. Valid value: `PayAsYouGo`.
        :param builtins.str performance_level: The performance level of the Database file system. Valid values: `PL0`, `PL1`, `PL2`, `PL3`.
        :param builtins.str raid_stripe_unit_number: The number of strip . When `enable_raid` parameter is set to `true` will transfer. This parameter is valid When `enable_raid` parameter is set to `true`.
        :param builtins.int size: The size Of the Database file system. Unit: GiB.
        :param builtins.str status: The status of the Database file system.
        :param builtins.str zone_id: The Zone ID of the Database file system.
        """
    ...
    def attach_node_number(self) -> builtins.int:
        """
    ...
    def dbfs_cluster_id(self) -> builtins.str:
        """
    ...
    def enable_raid(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter
    def encryption(self) -> builtins.bool:
        """
    ...
    def raid_stripe_unit_number(self) -> builtins.str:
        """
...
class GetSnapshotsSnapshotResult(dict):
    def __init__(__self__, *,
                 ...
                 source_fs_size: builtins.int,
                 status: builtins.str):
        """
        :param builtins.str category: The type of the Snapshot.
        :param builtins.str create_time: The creation time of the snapshot.
        :param builtins.str description: The description of the snapshot.
        :param builtins.str id: The ID of the Snapshot.
        :param builtins.str instance_id: The ID of the database file system.
        :param builtins.str last_modified_time: The last modification time of the snapshot.
        :param builtins.str progress: The progress of the snapshot.
        :param builtins.int remain_time: The remaining completion time of the snapshot being created, in seconds.
        :param builtins.int retention_days: The retention days of the snapshot.
        :param builtins.str snapshot_id: The ID of the snapshot.
        :param builtins.str snapshot_name: The name of the snapshot.
        :param builtins.str snapshot_type: The creation of the snapshot.
        :param builtins.int source_fs_size: Source database file system capacity.
        :param builtins.str status: The status of the snapshot. Possible values: `progressing`, `accomplished`, `failed`.
        """
        pulumi.set(__self__, "category", category)
        pulumi.set(__self__, "create_time", create_time)
    ...
    def source_fs_size(self) -> builtins.int:
        """
