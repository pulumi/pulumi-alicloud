...
class AnycastEipAddressAttachmentPopLocation(dict):
    ...
    def __init__(__self__, *,
                 pop_location: Optional[_builtins.str] = None):
        """
        :param _builtins.str pop_location: The access point information of the associated access area when the cloud resource instance is bound.If you are binding for the first time, this parameter does not need to be configured, and the system automatically associates all access areas.
        """
    ...
    def pop_location(self) -> Optional[_builtins.str]:
        """
...
class GetAnycastEipAddressesAddressResult(dict):
    def __init__(__self__, *,
                 ...
                 service_location: _builtins.str,
                 status: _builtins.str):
        """
        :param _builtins.int ali_uid: Anycast EIP instance account ID.
        :param _builtins.str anycast_eip_address_name: Anycast EIP instance name.
        ...
        :param _builtins.str anycast_id: Anycast EIP instance ID.
        :param _builtins.int bandwidth: The peak bandwidth of the Anycast EIP instance, in Mbps.
        :param _builtins.str bid: Anycast EIP instance account BID.
        :param _builtins.str business_status: The business status of the Anycast EIP instance. -`Normal`: Normal state. -`FinancialLocked`: The status of arrears locked.
        :param _builtins.str description: Anycast EIP instance description.
        :param _builtins.str id: The ID of the Anycast Eip Address.
        :param _builtins.str internet_charge_type: The billing method of Anycast EIP instance. `PayByBandwidth`: refers to the method of billing based on traffic.
        :param _builtins.str ip_address: Anycast EIP instance IP address.
        :param _builtins.str payment_type: The payment model of Anycast EIP instance. "PostPaid": Refers to the post-paid mode.
        :param _builtins.str service_location: Anycast EIP instance access area. "international": Refers to areas outside of Mainland China.
        :param _builtins.str status: IP status。- `Associating`, `Unassociating`, `Allocated`, `Associated`, `Modifying`, `Releasing`, `Released`.
        """
    ...
    def anycast_eip_address_name(self) -> _builtins.str:
        """
    ...
    def anycast_id(self) -> _builtins.str:
        """
    ...
    def service_location(self) -> _builtins.str:
        """
...
class GetAnycastEipAddressesAddressAnycastEipBindInfoListResult(dict):
    def __init__(__self__, *,
                 bind_instance_id: _builtins.str,
                 bind_instance_region_id: _builtins.str,
                 bind_instance_type: _builtins.str,
                 bind_time: _builtins.str):
        """
        :param _builtins.str bind_instance_id: The bound cloud resource instance ID.
        :param _builtins.str bind_instance_region_id: The region ID of the bound cloud resource instance.
        :param _builtins.str bind_instance_type: Bind the cloud resource instance type.
    ...
    def bind_instance_id(self) -> _builtins.str:
        """
    ...
    def bind_instance_region_id(self) -> _builtins.str:
        """
    ...
    def bind_instance_type(self) -> _builtins.str:
        """
