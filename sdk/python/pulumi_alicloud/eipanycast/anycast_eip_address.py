...
class AnycastEipAddressArgs:
    def __init__(__self__, *,
                 service_location: pulumi.Input[builtins.str],
                 anycast_eip_address_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] service_location: Anycast EIP instance access area. "international": Refers to areas outside of Mainland China.
        :param pulumi.Input[builtins.str] anycast_eip_address_name: Anycast EIP instance name.
        :param pulumi.Input[builtins.int] bandwidth: The peak bandwidth of the Anycast EIP instance, in Mbps.
        :param pulumi.Input[builtins.str] description: Anycast EIP instance description.
        :param pulumi.Input[builtins.str] internet_charge_type: The billing method of Anycast EIP instance. "PayByBandwidth": refers to the method of billing based on traffic.
        :param pulumi.Input[builtins.str] payment_type: The payment model of Anycast EIP instance. "PayAsYouGo": Refers to the post-paid mode.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the instance belongs.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: List of resource-bound tags.
        """
    ...
    def service_location(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def service_location(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "service_location", value)

    @property
    @pulumi.getter(name="anycastEipAddressName")
    def anycast_eip_address_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def anycast_eip_address_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AnycastEipAddressState:
    def __init__(__self__, *,
                 ...
                 payment_type: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_location: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] anycast_eip_address_name: Anycast EIP instance name.
        :param pulumi.Input[builtins.int] bandwidth: The peak bandwidth of the Anycast EIP instance, in Mbps.
        :param pulumi.Input[builtins.str] create_time: Anycast EIP instance creation time.
        :param pulumi.Input[builtins.str] description: Anycast EIP instance description.
        :param pulumi.Input[builtins.str] internet_charge_type: The billing method of Anycast EIP instance. "PayByBandwidth": refers to the method of billing based on traffic.
        :param pulumi.Input[builtins.str] payment_type: The payment model of Anycast EIP instance. "PayAsYouGo": Refers to the post-paid mode.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the instance belongs.
    ...
    @property
    @pulumi.getter(name="serviceLocation")
    def service_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Anycast EIP instance access area. "international": Refers to areas outside of Mainland China.
        """
        return pulumi.get(self, "service_location")
    ...
    @service_location.setter
    def service_location(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_location", value)
...
class AnycastEipAddress(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_location: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'AnycastEipAddress':
        """
    ...
    @property
    @pulumi.getter(name="anycastEipAddressName")
    def anycast_eip_address_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Anycast EIP instance name.
        """
        return pulumi.get(self, "anycast_eip_address_name")
    ...
    @property
    @pulumi.getter(name="serviceLocation")
    def service_location(self) -> pulumi.Output[builtins.str]:
        """
        Anycast EIP instance access area. "international": Refers to areas outside of Mainland China.
        """
        return pulumi.get(self, "service_location")
