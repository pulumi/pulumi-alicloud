...
class AnycastEipAddressAttachmentArgs:
    def __init__(__self__, *,
                 anycast_id: pulumi.Input[builtins.str],
                 bind_instance_id: pulumi.Input[builtins.str],
                 bind_instance_region_id: pulumi.Input[builtins.str],
                 bind_instance_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] anycast_id: The ID of the Anycast EIP instance.
        :param pulumi.Input[builtins.str] bind_instance_id: The ID of the cloud resource instance to be bound.
        :param pulumi.Input[builtins.str] bind_instance_region_id: The region ID of the cloud resource instance to be bound.You can only bind cloud resource instances in some regions. You can call the describeanystserverregions operation to obtain the region ID of the cloud resource instances that can be bound.
        :param pulumi.Input[builtins.str] bind_instance_type: The type of the cloud resource instance to be bound. Value:
               - **SlbInstance**: a private network SLB instance.
               - **NetworkInterface**: ENI.
        :param pulumi.Input[builtins.str] association_mode: Binding mode, value:
        ...
        :param pulumi.Input[builtins.str] private_ip_address: The secondary private IP address of the elastic network card to be bound.This parameter takes effect only when **BindInstanceType** is set to **NetworkInterface. When you do not enter, this parameter is the primary private IP of the ENI by default.
        """
    ...
    def anycast_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @anycast_id.setter
    def anycast_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "anycast_id", value)

    @property
    @pulumi.getter(name="bindInstanceId")
    def bind_instance_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def bind_instance_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "bind_instance_id", value)

    @property
    @pulumi.getter(name="bindInstanceRegionId")
    def bind_instance_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def bind_instance_region_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "bind_instance_region_id", value)

    @property
    @pulumi.getter(name="bindInstanceType")
    def bind_instance_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def bind_instance_type(self, value: pulumi.Input[builtins.str]):
...
class _AnycastEipAddressAttachmentState:
    def __init__(__self__, *,
                 anycast_id: Optional[pulumi.Input[builtins.str]] = None,
                 association_mode: Optional[pulumi.Input[builtins.str]] = None,
                 bind_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 bind_instance_region_id: Optional[pulumi.Input[builtins.str]] = None,
                 bind_instance_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] bind_instance_type: The type of the cloud resource instance to be bound. Value:
               - **SlbInstance**: a private network SLB instance.
               - **NetworkInterface**: ENI.
        :param pulumi.Input[builtins.str] bind_time: Binding time.Time is expressed according to ISO8601 standard and UTC time is used. The format is: 'YYYY-MM-DDThh:mm:ssZ'.
        :param pulumi.Input[Sequence[pulumi.Input['AnycastEipAddressAttachmentPopLocationArgs']]] pop_locations: The access point information of the associated access area when the cloud resource instance is bound.If you are binding for the first time, this parameter does not need to be configured, and the system automatically associates all access areas. See `pop_locations` below.
        :param pulumi.Input[builtins.str] private_ip_address: The secondary private IP address of the elastic network card to be bound.This parameter takes effect only when **BindInstanceType** is set to **NetworkInterface. When you do not enter, this parameter is the primary private IP of the ENI by default.
        :param pulumi.Input[builtins.str] status: The status of the bound cloud resource instance. Value:BINDING: BINDING.Bound: Bound.UNBINDING: UNBINDING.DELETED: DELETED.MODIFYING: being modified.
        """
    ...
    @property
    @pulumi.getter(name="anycastId")
    def anycast_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Anycast EIP instance.
        """
        return pulumi.get(self, "anycast_id")
    ...
    @anycast_id.setter
    def anycast_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "anycast_id", value)
    ...
    @property
    @pulumi.getter(name="bindInstanceId")
    def bind_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the cloud resource instance to be bound.
        """
        return pulumi.get(self, "bind_instance_id")
    ...
    @bind_instance_id.setter
    def bind_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bind_instance_id", value)

    @property
    @pulumi.getter(name="bindInstanceRegionId")
    def bind_instance_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The region ID of the cloud resource instance to be bound.You can only bind cloud resource instances in some regions. You can call the describeanystserverregions operation to obtain the region ID of the cloud resource instances that can be bound.
        """
        return pulumi.get(self, "bind_instance_region_id")
    ...
    @bind_instance_region_id.setter
    def bind_instance_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bind_instance_region_id", value)

    @property
    @pulumi.getter(name="bindInstanceType")
    def bind_instance_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the cloud resource instance to be bound. Value:
        - **SlbInstance**: a private network SLB instance.
        - **NetworkInterface**: ENI.
    ...
    @bind_instance_type.setter
    def bind_instance_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bind_instance_type", value)
...
class AnycastEipAddressAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pop_locations: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AnycastEipAddressAttachmentPopLocationArgs', 'AnycastEipAddressAttachmentPopLocationArgsDict']]]]] = None,
            private_ip_address: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'AnycastEipAddressAttachment':
        """
    ...
    @property
    @pulumi.getter(name="anycastId")
    def anycast_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Anycast EIP instance.
        """
        return pulumi.get(self, "anycast_id")
    ...
    @property
    @pulumi.getter(name="associationMode")
    def association_mode(self) -> pulumi.Output[builtins.str]:
        """
        Binding mode, value:
        - **Default**: The Default mode. The cloud resource instance to be bound is set as the Default origin.
        - **Normal**: In Normal mode, the cloud resource instance to be bound is set to the common source station.
    ...
    @property
    @pulumi.getter(name="bindInstanceId")
    def bind_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the cloud resource instance to be bound.
        """
        return pulumi.get(self, "bind_instance_id")
    ...
    @property
    @pulumi.getter(name="bindInstanceRegionId")
    def bind_instance_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The region ID of the cloud resource instance to be bound.You can only bind cloud resource instances in some regions. You can call the describeanystserverregions operation to obtain the region ID of the cloud resource instances that can be bound.
        """
        return pulumi.get(self, "bind_instance_region_id")
    ...
    @property
    @pulumi.getter(name="bindInstanceType")
    def bind_instance_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the cloud resource instance to be bound. Value:
        - **SlbInstance**: a private network SLB instance.
        - **NetworkInterface**: ENI.
    ...
    @property
    @pulumi.getter(name="bindTime")
    def bind_time(self) -> pulumi.Output[builtins.str]:
        """
        Binding time.Time is expressed according to ISO8601 standard and UTC time is used. The format is: 'YYYY-MM-DDThh:mm:ssZ'.
        """
        return pulumi.get(self, "bind_time")
