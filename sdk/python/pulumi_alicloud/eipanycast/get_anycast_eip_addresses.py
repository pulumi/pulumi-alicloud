...
class GetAnycastEipAddressesResult:
    ...
    def anycast_eip_address_name(self) -> Optional[builtins.str]:
        return pulumi.get(self, "anycast_eip_address_name")

    @property
    @pulumi.getter(name="bindInstanceIds")
    def bind_instance_ids(self) -> Optional[Sequence[builtins.str]]:
...
def get_anycast_eip_addresses(anycast_eip_address_name: Optional[builtins.str] = None,
                              bind_instance_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] bind_instance_ids: The bind instance ids.
    ...
    :param Sequence[builtins.str] ids: A list of Anycast Eip Address IDs.
    ...
    :param builtins.str name_regex: A regex string to filter results by Anycast Eip Address name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str payment_type: The payment model of Anycast EIP instance. `PayAsYouGo`: Refers to the post-paid mode. Default value is `PayAsYouGo`.
    ...
    :param builtins.str status: IP status。- `Associating`, `Unassociating`, `Allocated`, `Associated`, `Modifying`, `Releasing`, `Released`. Valid values: `Allocated`, `Associated`.
    """
    __args__ = dict()
...
def get_anycast_eip_addresses_output(anycast_eip_address_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     bind_instance_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                     business_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     ...
                                     service_location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
