...
class GetAnycastEipAddressesResult:
    ...
    def anycast_eip_address_name(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "anycast_eip_address_name")

    @_builtins.property
    @pulumi.getter(name="bindInstanceIds")
    def bind_instance_ids(self) -> Optional[Sequence[_builtins.str]]:
...
def get_anycast_eip_addresses(anycast_eip_address_name: Optional[_builtins.str] = None,
                              bind_instance_ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] bind_instance_ids: The bind instance ids.
    ...
    :param Sequence[_builtins.str] ids: A list of Anycast Eip Address IDs.
    ...
    :param _builtins.str name_regex: A regex string to filter results by Anycast Eip Address name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str payment_type: The payment model of Anycast EIP instance. `PayAsYouGo`: Refers to the post-paid mode. Default value is `PayAsYouGo`.
    ...
    :param _builtins.str status: IP status。- `Associating`, `Unassociating`, `Allocated`, `Associated`, `Modifying`, `Releasing`, `Released`. Valid values: `Allocated`, `Associated`.
    """
    __args__ = dict()
