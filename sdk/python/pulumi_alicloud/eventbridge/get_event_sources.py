...
def get_event_sources(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Event Source IDs.
    :param builtins.str name_regex: A regex string to filter results by Event Source name.
...
def get_event_sources_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
