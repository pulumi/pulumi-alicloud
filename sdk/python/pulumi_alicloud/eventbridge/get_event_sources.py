...
def get_event_sources(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Event Source IDs.
    :param _builtins.str name_regex: A regex string to filter results by Event Source name.
...
def get_event_sources_output(ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
