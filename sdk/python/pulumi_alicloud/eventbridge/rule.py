...
class RuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] event_bus_name: The name of the event bus.
        :param pulumi.Input[builtins.str] filter_pattern: The pattern to match interested events. Event mode, JSON format. The value description is as follows: `stringEqual` mode. `stringExpression` mode. Each field has up to 5 expressions (map structure).
        :param pulumi.Input[builtins.str] rule_name: The name of the event rule.
        :param pulumi.Input[Sequence[pulumi.Input['RuleTargetArgs']]] targets: The targets of rule. See `targets` below.
        :param pulumi.Input[builtins.str] description: The description of the event rule.
        :param pulumi.Input[builtins.str] status: The status of the event rule. Valid values: `ENABLE`, `DISABLE`.
        """
