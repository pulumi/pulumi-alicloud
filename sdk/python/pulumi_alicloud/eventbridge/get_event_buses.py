...
class GetEventBusesResult:
    ...
    def event_bus_type(self) -> Optional[builtins.str]:
...
def get_event_buses(event_bus_type: Optional[builtins.str] = None,
    ...
    :param builtins.str event_bus_type: The event bus type.
    :param Sequence[builtins.str] ids: A list of Event Bus IDs. Its element value is same as Event Bus Name.
    :param builtins.str name_prefix: The name prefix.
    :param builtins.str name_regex: A regex string to filter results by Event Bus name.
...
def get_event_buses_output(event_bus_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
