...
class ServiceLinkedRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] product_name: The product name for SLR. EventBridge can automatically create the following service-linked roles:
...
class ServiceLinkedRole(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            product_name: Optional[pulumi.Input[str]] = None) -> 'ServiceLinkedRole':
        """
