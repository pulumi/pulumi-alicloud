...
class EventBusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] event_bus_name: The name of event bus. The length is limited to 2 ~ 127 characters, which can be composed of letters, numbers or hyphens (-)
        :param pulumi.Input[builtins.str] description: The description of event bus.
        """
...
class EventBus(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            event_bus_name: Optional[pulumi.Input[builtins.str]] = None) -> 'EventBus':
        """
