...
class ApiDestinationArgs:
    def __init__(__self__, *,
                 api_destination_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] api_destination_name: The name of the API destination.
        ...
        :param pulumi.Input[builtins.str] description: The description of the API destination.
        """
    ...
    def api_destination_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def api_destination_name(self, value: pulumi.Input[builtins.str]):
...
class _ApiDestinationState:
    def __init__(__self__, *,
                 api_destination_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] api_destination_name: The name of the API destination.
        :param pulumi.Input[builtins.str] connection_name: The name of the connection.
        :param pulumi.Input[builtins.int] create_time: The creation time of the Api Destination.
        :param pulumi.Input[builtins.str] description: The description of the API destination.
        :param pulumi.Input['ApiDestinationHttpApiParametersArgs'] http_api_parameters: The parameters that are configured for the API destination. See `http_api_parameters` below.
        """
    ...
    @property
    @pulumi.getter(name="apiDestinationName")
    def api_destination_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the API destination.
        """
        return pulumi.get(self, "api_destination_name")
    ...
    @api_destination_name.setter
    def api_destination_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "api_destination_name", value)
...
class ApiDestination(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="apiDestinationName")
    def api_destination_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the API destination.
        """
        return pulumi.get(self, "api_destination_name")
