...
class GetRulesResult:
    ...
    def rule_name_prefix(self) -> Optional[_builtins.str]:
...
def get_rules(event_bus_name: Optional[_builtins.str] = None,
              ids: Optional[Sequence[_builtins.str]] = None,
              name_regex: Optional[_builtins.str] = None,
              output_file: Optional[_builtins.str] = None,
              rule_name_prefix: Optional[_builtins.str] = None,
    ...
    :param _builtins.str rule_name_prefix: The rule name prefix.
    :param _builtins.str status: Rule status, either Enable or Disable. Valid values: `DISABLE`, `ENABLE`.
    """
    __args__ = dict()
