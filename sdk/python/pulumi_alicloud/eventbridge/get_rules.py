...
class GetRulesResult:
    ...
    def rule_name_prefix(self) -> Optional[builtins.str]:
...
def get_rules(event_bus_name: Optional[builtins.str] = None,
    ...
    :param builtins.str rule_name_prefix: The rule name prefix.
    :param builtins.str status: Rule status, either Enable or Disable. Valid values: `DISABLE`, `ENABLE`.
    """
    __args__ = dict()
...
def get_rules_output(event_bus_name: Optional[pulumi.Input[builtins.str]] = None,
                     ...
                     rule_name_prefix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
