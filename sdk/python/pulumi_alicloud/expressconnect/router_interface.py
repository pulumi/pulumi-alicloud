...
class RouterInterfaceArgs:
    def __init__(__self__, *,
                 opposite_region_id: pulumi.Input[builtins.str],
                 role: pulumi.Input[builtins.str],
                 router_id: pulumi.Input[builtins.str],
                 router_type: pulumi.Input[builtins.str],
                 ...
                 delete_health_check_ip: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 hc_rate: Optional[pulumi.Input[builtins.int]] = None,
                 hc_threshold: Optional[pulumi.Input[builtins.str]] = None,
                 health_check_source_ip: Optional[pulumi.Input[builtins.str]] = None,
                 health_check_target_ip: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_access_point_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 router_interface_name: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RouterInterface resource.
        :param pulumi.Input[builtins.str] opposite_region_id: The geographical ID of the location of the receiving end of the connection.
        :param pulumi.Input[builtins.str] role: The role of the router interface. Valid Values: `InitiatingSide`, `AcceptingSide`.
        :param pulumi.Input[builtins.str] router_id: The router id associated with the router interface.
        :param pulumi.Input[builtins.str] router_type: The type of router associated with the router interface. Valid Values: `VRouter`, `VBR`.
        :param pulumi.Input[builtins.str] spec: The specification of the router interface. Valid Values: `Mini.2`, `Mini.5`, `Mini.5`, `Small.2`, `Small.5`, `Middle.1`, `Middle.2`, `Middle.5`, `Large.1`, `Large.2`, `Large.5`, `XLarge.1`, `Negative`.
        :param pulumi.Input[builtins.str] access_point_id: The access point ID to which the VBR belongs.
        :param pulumi.Input[builtins.bool] auto_pay: Whether to pay automatically, value:-**false** (default): automatic payment is not enabled. After generating an order, you need to complete the payment at the order center.-**true**: Enable automatic payment to automatically pay for orders.> **InstanceChargeType** is required when the value of the parameter is **PrePaid.
        :param pulumi.Input[builtins.bool] delete_health_check_ip: Whether to delete the health check IP address configured on the router interface. Value:-**true**: deletes the health check IP address.-**false** (default): does not delete the health check IP address.
        :param pulumi.Input[builtins.str] description: The description of the router interface. The description must be 2 to 256 characters in length and cannot start with http:// or https://.
        :param pulumi.Input[builtins.int] hc_rate: The health check rate. Unit: seconds. The recommended value is 2. This indicates the interval between successive probe messages sent during the specified health check.
        :param pulumi.Input[builtins.str] hc_threshold: The health check thresholds. Unit: pcs. The recommended value is 8. This indicates the number of probe messages to be sent during the specified health check.
        :param pulumi.Input[builtins.str] health_check_source_ip: The health check source IP address, must be an unused IP within the local VPC.
        :param pulumi.Input[builtins.str] health_check_target_ip: The IP address for health screening purposes.
        :param pulumi.Input[builtins.str] opposite_access_point_id: The Access point ID to which the other end belongs.
        :param pulumi.Input[builtins.str] opposite_interface_id: The Interface ID of the router at the other end.
        :param pulumi.Input[builtins.str] opposite_interface_owner_id: The AliCloud account ID of the owner of the router interface on the other end.
        :param pulumi.Input[builtins.str] opposite_router_id: The id of the router at the other end.
        :param pulumi.Input[builtins.str] opposite_router_type: The opposite router type of the router on the other side. Valid Values: `VRouter`, `VBR`.
        :param pulumi.Input[builtins.str] payment_type: The payment methods for router interfaces. Valid Values: `PayAsYouGo`, `Subscription`.
        :param pulumi.Input[builtins.int] period: Purchase duration, value:-When you choose to pay on a monthly basis, the value range is **1 to 9 * *.-When you choose to pay per year, the value range is **1 to 3 * *.> **InstanceChargeType** is required when the value of the parameter is **PrePaid.
        :param pulumi.Input[builtins.str] pricing_cycle: The billing cycle of the prepaid fee. Valid values:-**Month** (default): monthly payment.-**Year**: Pay per Year.> **InstanceChargeType** is required when the value of the parameter is **PrePaid.
        :param pulumi.Input[builtins.str] router_interface_id: The first ID of the resource.
        :param pulumi.Input[builtins.str] router_interface_name: The name of the resource.
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid Values: `Idle`, `AcceptingConnecting`, `Connecting`, `Activating`, `Active`, `Modifying`, `Deactivating`, `Inactive`, `Deleting`.
        """
    ...
    def opposite_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def opposite_region_id(self, value: pulumi.Input[builtins.str]):
    ...
    def router_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @router_type.setter
    def router_type(self, value: pulumi.Input[builtins.str]):
    ...
    def delete_health_check_ip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def delete_health_check_ip(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def hc_rate(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @hc_rate.setter
    def hc_rate(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "hc_rate", value)

    @property
    @pulumi.getter(name="hcThreshold")
    def hc_threshold(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @hc_threshold.setter
    def hc_threshold(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hc_threshold", value)

    @property
    @pulumi.getter(name="healthCheckSourceIp")
    def health_check_source_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def health_check_source_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "health_check_source_ip", value)

    @property
    @pulumi.getter(name="healthCheckTargetIp")
    def health_check_target_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def health_check_target_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "health_check_target_ip", value)

    @property
    @pulumi.getter(name="oppositeAccessPointId")
    def opposite_access_point_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def opposite_access_point_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def router_interface_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def router_interface_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RouterInterfaceState:
    def __init__(__self__, *,
                 ...
                 connected_time: Optional[pulumi.Input[builtins.str]] = None,
                 create_time: Optional[pulumi.Input[builtins.str]] = None,
                 cross_border: Optional[pulumi.Input[builtins.bool]] = None,
                 delete_health_check_ip: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 end_time: Optional[pulumi.Input[builtins.str]] = None,
                 has_reservation_data: Optional[pulumi.Input[builtins.str]] = None,
                 hc_rate: Optional[pulumi.Input[builtins.int]] = None,
                 hc_threshold: Optional[pulumi.Input[builtins.str]] = None,
                 health_check_source_ip: Optional[pulumi.Input[builtins.str]] = None,
                 health_check_target_ip: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_access_point_id: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_bandwidth: Optional[pulumi.Input[builtins.int]] = None,
                 opposite_interface_business_status: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_interface_id: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_interface_owner_id: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_interface_spec: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_interface_status: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_region_id: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_router_id: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_router_type: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_vpc_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 payment_type: Optional[pulumi.Input[builtins.str]] = None,
                 period: Optional[pulumi.Input[builtins.int]] = None,
                 pricing_cycle: Optional[pulumi.Input[builtins.str]] = None,
                 reservation_active_time: Optional[pulumi.Input[builtins.str]] = None,
                 reservation_bandwidth: Optional[pulumi.Input[builtins.str]] = None,
                 reservation_internet_charge_type: Optional[pulumi.Input[builtins.str]] = None,
                 reservation_order_type: Optional[pulumi.Input[builtins.str]] = None,
                 role: Optional[pulumi.Input[builtins.str]] = None,
                 router_id: Optional[pulumi.Input[builtins.str]] = None,
                 router_interface_id: Optional[pulumi.Input[builtins.str]] = None,
                 router_interface_name: Optional[pulumi.Input[builtins.str]] = None,
                 router_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] access_point_id: The access point ID to which the VBR belongs.
        :param pulumi.Input[builtins.bool] auto_pay: Whether to pay automatically, value:-**false** (default): automatic payment is not enabled. After generating an order, you need to complete the payment at the order center.-**true**: Enable automatic payment to automatically pay for orders.> **InstanceChargeType** is required when the value of the parameter is **PrePaid.
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth of the resource.
        :param pulumi.Input[builtins.str] business_status: The businessStatus of the resource. Valid Values: `Normal`, `FinancialLocked`, `SecurityLocked`.
        :param pulumi.Input[builtins.str] connected_time: The connected time of the resource.
        :param pulumi.Input[builtins.str] create_time: The creation time of the resource.
        :param pulumi.Input[builtins.bool] cross_border: The cross border of the resource.
        :param pulumi.Input[builtins.bool] delete_health_check_ip: Whether to delete the health check IP address configured on the router interface. Value:-**true**: deletes the health check IP address.-**false** (default): does not delete the health check IP address.
        :param pulumi.Input[builtins.str] description: The description of the router interface. The description must be 2 to 256 characters in length and cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] end_time: The end time of the resource.
        :param pulumi.Input[builtins.str] has_reservation_data: The has reservation data of the resource.
        :param pulumi.Input[builtins.int] hc_rate: The health check rate. Unit: seconds. The recommended value is 2. This indicates the interval between successive probe messages sent during the specified health check.
        :param pulumi.Input[builtins.str] hc_threshold: The health check thresholds. Unit: pcs. The recommended value is 8. This indicates the number of probe messages to be sent during the specified health check.
        :param pulumi.Input[builtins.str] health_check_source_ip: The health check source IP address, must be an unused IP within the local VPC.
        :param pulumi.Input[builtins.str] health_check_target_ip: The IP address for health screening purposes.
        :param pulumi.Input[builtins.str] opposite_access_point_id: The Access point ID to which the other end belongs.
        :param pulumi.Input[builtins.int] opposite_bandwidth: The opposite bandwidth of the router on the other side.
        :param pulumi.Input[builtins.str] opposite_interface_business_status: The opposite interface business status of the router on the other side. Valid Values: `Normal`, `FinancialLocked`, `SecurityLocked`.
        :param pulumi.Input[builtins.str] opposite_interface_id: The Interface ID of the router at the other end.
        :param pulumi.Input[builtins.str] opposite_interface_owner_id: The AliCloud account ID of the owner of the router interface on the other end.
        :param pulumi.Input[builtins.str] opposite_interface_spec: The opposite interface spec of the router on the other side. Valid Values: `Mini.2`, `Mini.5`, `Mini.5`, `Small.2`, `Small.5`, `Middle.1`, `Middle.2`, `Middle.5`, `Large.1`, `Large.2`, `Large.5`, `XLarge.1`, `Negative`.
        :param pulumi.Input[builtins.str] opposite_interface_status: The opposite interface status of the router on the other side. Valid Values: `Idle`, `AcceptingConnecting`, `Connecting`, `Activating`, `Active`, `Modifying`, `Deactivating`, `Inactive`, `Deleting`.
        :param pulumi.Input[builtins.str] opposite_region_id: The geographical ID of the location of the receiving end of the connection.
        :param pulumi.Input[builtins.str] opposite_router_id: The id of the router at the other end.
        :param pulumi.Input[builtins.str] opposite_router_type: The opposite router type of the router on the other side. Valid Values: `VRouter`, `VBR`.
        :param pulumi.Input[builtins.str] opposite_vpc_instance_id: The opposite vpc instance id of the router on the other side.
        :param pulumi.Input[builtins.str] payment_type: The payment methods for router interfaces. Valid Values: `PayAsYouGo`, `Subscription`.
        :param pulumi.Input[builtins.int] period: Purchase duration, value:-When you choose to pay on a monthly basis, the value range is **1 to 9 * *.-When you choose to pay per year, the value range is **1 to 3 * *.> **InstanceChargeType** is required when the value of the parameter is **PrePaid.
        :param pulumi.Input[builtins.str] pricing_cycle: The billing cycle of the prepaid fee. Valid values:-**Month** (default): monthly payment.-**Year**: Pay per Year.> **InstanceChargeType** is required when the value of the parameter is **PrePaid.
        :param pulumi.Input[builtins.str] reservation_active_time: The reservation active time of the resource.
        :param pulumi.Input[builtins.str] reservation_bandwidth: The reservation bandwidth of the resource.
        :param pulumi.Input[builtins.str] reservation_internet_charge_type: The reservation internet charge type of the resource.
        :param pulumi.Input[builtins.str] reservation_order_type: The reservation order type of the resource.
        :param pulumi.Input[builtins.str] role: The role of the router interface. Valid Values: `InitiatingSide`, `AcceptingSide`.
        :param pulumi.Input[builtins.str] router_id: The router id associated with the router interface.
        :param pulumi.Input[builtins.str] router_interface_id: The first ID of the resource.
        :param pulumi.Input[builtins.str] router_interface_name: The name of the resource.
        ...
        :param pulumi.Input[builtins.str] spec: The specification of the router interface. Valid Values: `Mini.2`, `Mini.5`, `Mini.5`, `Small.2`, `Small.5`, `Middle.1`, `Middle.2`, `Middle.5`, `Large.1`, `Large.2`, `Large.5`, `XLarge.1`, `Negative`.
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid Values: `Idle`, `AcceptingConnecting`, `Connecting`, `Activating`, `Active`, `Modifying`, `Deactivating`, `Inactive`, `Deleting`.
        :param pulumi.Input[builtins.str] vpc_instance_id: The vpc instance id of the resource.
        """
        if access_point_id is not None:
            pulumi.set(__self__, "access_point_id", access_point_id)
        if auto_pay is not None:
    ...
    def connected_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connected_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def cross_border(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @cross_border.setter
    def cross_border(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def has_reservation_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def has_reservation_data(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def opposite_bandwidth(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def opposite_bandwidth(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "opposite_bandwidth", value)

    @property
    @pulumi.getter(name="oppositeInterfaceBusinessStatus")
    def opposite_interface_business_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def opposite_interface_business_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def opposite_interface_spec(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def opposite_interface_spec(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "opposite_interface_spec", value)

    @property
    @pulumi.getter(name="oppositeInterfaceStatus")
    def opposite_interface_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def opposite_interface_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "opposite_interface_status", value)

    @property
    @pulumi.getter(name="oppositeRegionId")
    def opposite_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The geographical ID of the location of the receiving end of the connection.
        """
        return pulumi.get(self, "opposite_region_id")
    ...
    @opposite_region_id.setter
    def opposite_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "opposite_region_id", value)
    ...
    def opposite_vpc_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def opposite_vpc_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def reservation_active_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def reservation_active_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "reservation_active_time", value)

    @property
    @pulumi.getter(name="reservationBandwidth")
    def reservation_bandwidth(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def reservation_bandwidth(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "reservation_bandwidth", value)

    @property
    @pulumi.getter(name="reservationInternetChargeType")
    def reservation_internet_charge_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def reservation_internet_charge_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "reservation_internet_charge_type", value)

    @property
    @pulumi.getter(name="reservationOrderType")
    def reservation_order_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def reservation_order_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="routerType")
    def router_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of router associated with the router interface. Valid Values: `VRouter`, `VBR`.
        """
        return pulumi.get(self, "router_type")
    ...
    @router_type.setter
    def router_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "router_type", value)
...
class RouterInterface(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:expressconnect/routerInterface:RouterInterface"
    ...
    def get(resource_name: str,
            ...
            spec: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpc_instance_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RouterInterface':
        """
    ...
    @property
    @pulumi.getter(name="accessPointId")
    def access_point_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The access point ID to which the VBR belongs.
        """
        return pulumi.get(self, "access_point_id")
    ...
    @property
    @pulumi.getter(name="connectedTime")
    def connected_time(self) -> pulumi.Output[builtins.str]:
        """
        The connected time of the resource.
        """
        return pulumi.get(self, "connected_time")
    ...
    @property
    @pulumi.getter(name="crossBorder")
    def cross_border(self) -> pulumi.Output[builtins.bool]:
        """
        The cross border of the resource.
        """
        return pulumi.get(self, "cross_border")
    ...
    @property
    @pulumi.getter(name="deleteHealthCheckIp")
    def delete_health_check_ip(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to delete the health check IP address configured on the router interface. Value:-**true**: deletes the health check IP address.-**false** (default): does not delete the health check IP address.
        """
        return pulumi.get(self, "delete_health_check_ip")
    ...
    @property
    @pulumi.getter(name="hasReservationData")
    def has_reservation_data(self) -> pulumi.Output[builtins.str]:
        """
        The has reservation data of the resource.
        """
        return pulumi.get(self, "has_reservation_data")
    ...
    @property
    @pulumi.getter(name="hcRate")
    def hc_rate(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The health check rate. Unit: seconds. The recommended value is 2. This indicates the interval between successive probe messages sent during the specified health check.
        """
        return pulumi.get(self, "hc_rate")
    ...
    @property
    @pulumi.getter(name="hcThreshold")
    def hc_threshold(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The health check thresholds. Unit: pcs. The recommended value is 8. This indicates the number of probe messages to be sent during the specified health check.
        """
        return pulumi.get(self, "hc_threshold")
    ...
    @property
    @pulumi.getter(name="healthCheckSourceIp")
    def health_check_source_ip(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The health check source IP address, must be an unused IP within the local VPC.
        """
        return pulumi.get(self, "health_check_source_ip")
    ...
    @property
    @pulumi.getter(name="healthCheckTargetIp")
    def health_check_target_ip(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IP address for health screening purposes.
        """
        return pulumi.get(self, "health_check_target_ip")
    ...
    @property
    @pulumi.getter(name="oppositeAccessPointId")
    def opposite_access_point_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Access point ID to which the other end belongs.
        """
        return pulumi.get(self, "opposite_access_point_id")
    ...
    @property
    @pulumi.getter(name="oppositeBandwidth")
    def opposite_bandwidth(self) -> pulumi.Output[builtins.int]:
        """
        The opposite bandwidth of the router on the other side.
        """
        return pulumi.get(self, "opposite_bandwidth")
    ...
    @property
    @pulumi.getter(name="oppositeInterfaceBusinessStatus")
    def opposite_interface_business_status(self) -> pulumi.Output[builtins.str]:
        """
        The opposite interface business status of the router on the other side. Valid Values: `Normal`, `FinancialLocked`, `SecurityLocked`.
        """
        return pulumi.get(self, "opposite_interface_business_status")
    ...
    @property
    @pulumi.getter(name="oppositeInterfaceId")
    def opposite_interface_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Interface ID of the router at the other end.
        """
        return pulumi.get(self, "opposite_interface_id")
    ...
    @property
    @pulumi.getter(name="oppositeInterfaceOwnerId")
    def opposite_interface_owner_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The AliCloud account ID of the owner of the router interface on the other end.
        """
        return pulumi.get(self, "opposite_interface_owner_id")
    ...
    @property
    @pulumi.getter(name="oppositeInterfaceSpec")
    def opposite_interface_spec(self) -> pulumi.Output[builtins.str]:
        """
        The opposite interface spec of the router on the other side. Valid Values: `Mini.2`, `Mini.5`, `Mini.5`, `Small.2`, `Small.5`, `Middle.1`, `Middle.2`, `Middle.5`, `Large.1`, `Large.2`, `Large.5`, `XLarge.1`, `Negative`.
        """
        return pulumi.get(self, "opposite_interface_spec")
    ...
    @property
    @pulumi.getter(name="oppositeInterfaceStatus")
    def opposite_interface_status(self) -> pulumi.Output[builtins.str]:
        """
        The opposite interface status of the router on the other side. Valid Values: `Idle`, `AcceptingConnecting`, `Connecting`, `Activating`, `Active`, `Modifying`, `Deactivating`, `Inactive`, `Deleting`.
        """
        return pulumi.get(self, "opposite_interface_status")
    ...
    @property
    @pulumi.getter(name="oppositeRegionId")
    def opposite_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The geographical ID of the location of the receiving end of the connection.
        """
        return pulumi.get(self, "opposite_region_id")
    ...
    @property
    @pulumi.getter(name="oppositeRouterId")
    def opposite_router_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The id of the router at the other end.
        """
        return pulumi.get(self, "opposite_router_id")
    ...
    @property
    @pulumi.getter(name="oppositeRouterType")
    def opposite_router_type(self) -> pulumi.Output[builtins.str]:
        """
        The opposite router type of the router on the other side. Valid Values: `VRouter`, `VBR`.
        """
        return pulumi.get(self, "opposite_router_type")
    ...
    @property
    @pulumi.getter(name="oppositeVpcInstanceId")
    def opposite_vpc_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The opposite vpc instance id of the router on the other side.
        """
        return pulumi.get(self, "opposite_vpc_instance_id")
    ...
    @property
    @pulumi.getter(name="reservationActiveTime")
    def reservation_active_time(self) -> pulumi.Output[builtins.str]:
        """
        The reservation active time of the resource.
        """
        return pulumi.get(self, "reservation_active_time")
    ...
    @property
    @pulumi.getter(name="reservationBandwidth")
    def reservation_bandwidth(self) -> pulumi.Output[builtins.str]:
        """
        The reservation bandwidth of the resource.
        """
        return pulumi.get(self, "reservation_bandwidth")
    ...
    @property
    @pulumi.getter(name="reservationInternetChargeType")
    def reservation_internet_charge_type(self) -> pulumi.Output[builtins.str]:
        """
        The reservation internet charge type of the resource.
        """
        return pulumi.get(self, "reservation_internet_charge_type")
    ...
    @property
    @pulumi.getter(name="reservationOrderType")
    def reservation_order_type(self) -> pulumi.Output[builtins.str]:
        """
        The reservation order type of the resource.
        """
        return pulumi.get(self, "reservation_order_type")
    ...
    @property
    @pulumi.getter(name="routerInterfaceId")
    def router_interface_id(self) -> pulumi.Output[builtins.str]:
        """
        The first ID of the resource.
        """
        return pulumi.get(self, "router_interface_id")
    ...
    @property
    @pulumi.getter(name="routerInterfaceName")
    def router_interface_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "router_interface_name")
    ...
    @property
    @pulumi.getter(name="routerType")
    def router_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of router associated with the router interface. Valid Values: `VRouter`, `VBR`.
        """
        return pulumi.get(self, "router_type")
    ...
    @property
    @pulumi.getter(name="vpcInstanceId")
    def vpc_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The vpc instance id of the resource.
        """
        return pulumi.get(self, "vpc_instance_id")
