...
class GetRouterInterfacesResult:
    ...
    def include_reservation_data(self) -> Optional[_builtins.str]:
...
def get_router_interfaces(filters: Optional[Sequence[Union['GetRouterInterfacesFilterArgs', 'GetRouterInterfacesFilterArgsDict']]] = None,
    ...
    :param _builtins.str include_reservation_data: Does it contain renewal data. Valid values: `true`, `false`.
