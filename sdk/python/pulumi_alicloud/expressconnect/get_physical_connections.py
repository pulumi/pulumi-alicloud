...
def get_physical_connections(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Physical Connection IDs.
    :param builtins.bool include_reservation_data: The include reservation data.
    :param builtins.str name_regex: A regex string to filter results by Physical Connection name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: Resources on Behalf of a State of the Resource Attribute Field. Valid values: `Canceled`, `Enabled`, `Terminated`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_physical_connections_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
