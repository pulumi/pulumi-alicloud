...
class TrafficQosQueueArgs:
    def __init__(__self__, *,
                 ...
                 queue_type: pulumi.Input[builtins.str],
                 bandwidth_percent: Optional[pulumi.Input[builtins.str]] = None,
                 queue_description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] queue_type: QoS queue type, value:
               - **High**: High priority queue.
               - **Medium**: Normal priority queue.
               - **Default**: the Default priority queue.
               > **NOTE:**  Default priority queue cannot be created.
        :param pulumi.Input[builtins.str] bandwidth_percent: QoS queue bandwidth percentage.
        ...
        :param pulumi.Input[builtins.str] queue_description: The description of the QoS queue.  The length is 0 to 256 characters and cannot start with 'http:// 'or 'https.
        :param pulumi.Input[builtins.str] queue_name: The name of the QoS queue.  The length is 0 to 128 characters and cannot start with 'http:// 'or 'https.
        """
    ...
    def queue_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @queue_type.setter
    def queue_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "queue_type", value)

    @property
    @pulumi.getter(name="bandwidthPercent")
    def bandwidth_percent(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bandwidth_percent(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bandwidth_percent", value)

    @property
    @pulumi.getter(name="queueDescription")
    def queue_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def queue_description(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TrafficQosQueue(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:expressconnect/trafficQosQueue:TrafficQosQueue"
    ...
    def get(resource_name: str,
            ...
            queue_name: Optional[pulumi.Input[builtins.str]] = None,
            queue_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'TrafficQosQueue':
        """
    ...
    @property
    @pulumi.getter(name="bandwidthPercent")
    def bandwidth_percent(self) -> pulumi.Output[builtins.str]:
        """
        QoS queue bandwidth percentage.
    ...
    @property
    @pulumi.getter(name="queueDescription")
    def queue_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the QoS queue.  The length is 0 to 256 characters and cannot start with 'http:// 'or 'https.
        """
        return pulumi.get(self, "queue_description")
    ...
    @property
    @pulumi.getter(name="queueName")
    def queue_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the QoS queue.  The length is 0 to 128 characters and cannot start with 'http:// 'or 'https.
        """
        return pulumi.get(self, "queue_name")
    ...
    @property
    @pulumi.getter(name="queueType")
    def queue_type(self) -> pulumi.Output[builtins.str]:
        """
        QoS queue type, value:
        - **High**: High priority queue.
        - **Medium**: Normal priority queue.
