...
def get_access_points(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Access Point IDs.
    :param _builtins.str name_regex: A regex string to filter results by Access Point name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str status: The Physical Connection to Which the Access Point State. Valid values: `disabled`, `full`, `hot`, `recommended`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_access_points_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
