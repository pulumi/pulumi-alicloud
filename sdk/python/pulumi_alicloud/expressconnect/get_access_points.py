...
def get_access_points(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Access Point IDs.
    :param builtins.str name_regex: A regex string to filter results by Access Point name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The Physical Connection to Which the Access Point State. Valid values: `disabled`, `full`, `hot`, `recommended`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_access_points_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
