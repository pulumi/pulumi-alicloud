...
class VirtualBorderRouterArgs:
    ...
    def _configure(
        ...
        if associated_physical_connections is None and 'associatedPhysicalConnections' in kwargs:
        ...
        if include_cross_account_vbr is None and 'includeCrossAccountVbr' in kwargs:
