...
class VirtualBorderRouterArgs:
    def __init__(__self__, *,
                 local_gateway_ip: pulumi.Input[builtins.str],
                 peer_gateway_ip: pulumi.Input[builtins.str],
                 peering_subnet_mask: pulumi.Input[builtins.str],
                 physical_connection_id: pulumi.Input[builtins.str],
                 vlan_id: pulumi.Input[builtins.int],
                 associated_physical_connections: Optional[pulumi.Input[builtins.str]] = None,
                 bandwidth: Optional[pulumi.Input[builtins.int]] = None,
                 circuit_code: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 detect_multiplier: Optional[pulumi.Input[builtins.int]] = None,
                 enable_ipv6: Optional[pulumi.Input[builtins.bool]] = None,
                 include_cross_account_vbr: Optional[pulumi.Input[builtins.bool]] = None,
                 local_ipv6_gateway_ip: Optional[pulumi.Input[builtins.str]] = None,
                 min_rx_interval: Optional[pulumi.Input[builtins.int]] = None,
                 min_tx_interval: Optional[pulumi.Input[builtins.int]] = None,
                 peer_ipv6_gateway_ip: Optional[pulumi.Input[builtins.str]] = None,
                 peering_ipv6_subnet_mask: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 vbr_owner_id: Optional[pulumi.Input[builtins.str]] = None,
                 virtual_border_router_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a VirtualBorderRouter resource.
        :param pulumi.Input[builtins.str] local_gateway_ip: Alibaba Cloud-Connected IPv4 address.
        :param pulumi.Input[builtins.str] peer_gateway_ip: The Client-Side Interconnection IPv4 Address.
        ...
        :param pulumi.Input[builtins.int] vlan_id: The VLAN ID of the VBR. Value range: 0~2999.
        :param pulumi.Input[builtins.str] associated_physical_connections: The associated physical connections.
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth.
        :param pulumi.Input[builtins.str] circuit_code: Operators for physical connection circuit provided coding.
        :param pulumi.Input[builtins.str] description: The description of VBR. Length is from 2 to 256 characters, must start with a letter or the Chinese at the beginning, but not at the http:// Or https:// at the beginning.
        :param pulumi.Input[builtins.int] detect_multiplier: Detection time multiplier that recipient allows the sender to send a message of the maximum allowable connections for the number of packets, used to detect whether the link normal. Value: 3~10.
        :param pulumi.Input[builtins.bool] enable_ipv6: Whether to Enable IPv6. Valid values: `false`, `true`.
        :param pulumi.Input[builtins.bool] include_cross_account_vbr: Whether cross account border routers are included. Valid values: `false`, `true`. Default: `true`.
        :param pulumi.Input[builtins.str] local_ipv6_gateway_ip: Alibaba Cloud-Connected IPv6 Address.
        :param pulumi.Input[builtins.int] min_rx_interval: Configure BFD packet reception interval of values include: 200~1000, unit: ms.
        :param pulumi.Input[builtins.int] min_tx_interval: Configure BFD packet transmission interval maximum value: 200~1000, unit: ms.
        :param pulumi.Input[builtins.str] peer_ipv6_gateway_ip: The Client-Side Interconnection IPv6 Address.
    ...
    def local_gateway_ip(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def local_gateway_ip(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "local_gateway_ip", value)

    @property
    @pulumi.getter(name="peerGatewayIp")
    def peer_gateway_ip(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def peer_gateway_ip(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "peer_gateway_ip", value)

    @property
    @pulumi.getter(name="peeringSubnetMask")
    def peering_subnet_mask(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def peering_subnet_mask(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "peering_subnet_mask", value)

    @property
    @pulumi.getter(name="physicalConnectionId")
    def physical_connection_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def physical_connection_id(self, value: pulumi.Input[builtins.str]):
    ...
    def associated_physical_connections(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def associated_physical_connections(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def detect_multiplier(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def detect_multiplier(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def include_cross_account_vbr(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def include_cross_account_vbr(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "include_cross_account_vbr", value)

    @property
    @pulumi.getter(name="localIpv6GatewayIp")
    def local_ipv6_gateway_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def local_ipv6_gateway_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "local_ipv6_gateway_ip", value)

    @property
    @pulumi.getter(name="minRxInterval")
    def min_rx_interval(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def min_rx_interval(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "min_rx_interval", value)

    @property
    @pulumi.getter(name="minTxInterval")
    def min_tx_interval(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def min_tx_interval(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "min_tx_interval", value)

    @property
    @pulumi.getter(name="peerIpv6GatewayIp")
    def peer_ipv6_gateway_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_ipv6_gateway_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peer_ipv6_gateway_ip", value)

    @property
    @pulumi.getter(name="peeringIpv6SubnetMask")
    def peering_ipv6_subnet_mask(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peering_ipv6_subnet_mask(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vbr_owner_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The vbr owner id.
        """
    ...
    @vbr_owner_id.setter
    def vbr_owner_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vbr_owner_id", value)

    @property
    @pulumi.getter(name="virtualBorderRouterName")
    def virtual_border_router_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def virtual_border_router_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _VirtualBorderRouterState:
    def __init__(__self__, *,
                 ...
                 enable_ipv6: Optional[pulumi.Input[builtins.bool]] = None,
                 include_cross_account_vbr: Optional[pulumi.Input[builtins.bool]] = None,
                 local_gateway_ip: Optional[pulumi.Input[builtins.str]] = None,
                 local_ipv6_gateway_ip: Optional[pulumi.Input[builtins.str]] = None,
                 min_rx_interval: Optional[pulumi.Input[builtins.int]] = None,
                 min_tx_interval: Optional[pulumi.Input[builtins.int]] = None,
                 peer_gateway_ip: Optional[pulumi.Input[builtins.str]] = None,
                 peer_ipv6_gateway_ip: Optional[pulumi.Input[builtins.str]] = None,
                 peering_ipv6_subnet_mask: Optional[pulumi.Input[builtins.str]] = None,
                 peering_subnet_mask: Optional[pulumi.Input[builtins.str]] = None,
                 physical_connection_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] peering_subnet_mask: Alibaba Cloud-Connected IPv4 and Client-Side Interconnection IPv4 of Subnet Mask.
        :param pulumi.Input[builtins.str] physical_connection_id: The ID of the Physical Connection to Which the ID.
        :param pulumi.Input[builtins.str] route_table_id: (Available in v1.166.0+) The Route Table ID Of the Virtual Border Router.
        :param pulumi.Input[builtins.str] status: The instance state. Valid values: `active`, `deleting`, `recovering`, `terminated`, `terminating`, `unconfirmed`.
        :param pulumi.Input[builtins.str] vbr_owner_id: The vbr owner id.
        :param pulumi.Input[builtins.str] virtual_border_router_name: The name of VBR. Length is from 2 to 128 characters, must start with a letter or the Chinese at the beginning can contain numbers, the underscore character (_) and dash (-). But do not start with http:// or https:// at the beginning.
        :param pulumi.Input[builtins.int] vlan_id: The VLAN ID of the VBR. Value range: 0~2999.
    ...
    @property
    @pulumi.getter(name="localGatewayIp")
    def local_gateway_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Alibaba Cloud-Connected IPv4 address.
        """
        return pulumi.get(self, "local_gateway_ip")
    ...
    @local_gateway_ip.setter
    def local_gateway_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "local_gateway_ip", value)
    ...
    @property
    @pulumi.getter(name="peerGatewayIp")
    def peer_gateway_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Client-Side Interconnection IPv4 Address.
        """
        return pulumi.get(self, "peer_gateway_ip")
    ...
    @peer_gateway_ip.setter
    def peer_gateway_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peer_gateway_ip", value)
    ...
    @property
    @pulumi.getter(name="peeringSubnetMask")
    def peering_subnet_mask(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Alibaba Cloud-Connected IPv4 and Client-Side Interconnection IPv4 of Subnet Mask.
        """
        return pulumi.get(self, "peering_subnet_mask")
    ...
    @peering_subnet_mask.setter
    def peering_subnet_mask(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peering_subnet_mask", value)

    @property
    @pulumi.getter(name="physicalConnectionId")
    def physical_connection_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Physical Connection to Which the ID.
        """
        return pulumi.get(self, "physical_connection_id")
    ...
    @physical_connection_id.setter
    def physical_connection_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "physical_connection_id", value)
...
class VirtualBorderRouter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vbr_owner_id: Optional[pulumi.Input[builtins.str]] = None,
            virtual_border_router_name: Optional[pulumi.Input[builtins.str]] = None,
            vlan_id: Optional[pulumi.Input[builtins.int]] = None) -> 'VirtualBorderRouter':
        """
    ...
    @property
    @pulumi.getter(name="associatedPhysicalConnections")
    def associated_physical_connections(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The associated physical connections.
        """
        return pulumi.get(self, "associated_physical_connections")
    ...
    @property
    @pulumi.getter(name="circuitCode")
    def circuit_code(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Operators for physical connection circuit provided coding.
        """
        return pulumi.get(self, "circuit_code")
    ...
    @property
    @pulumi.getter(name="detectMultiplier")
    def detect_multiplier(self) -> pulumi.Output[builtins.int]:
        """
        Detection time multiplier that recipient allows the sender to send a message of the maximum allowable connections for the number of packets, used to detect whether the link normal. Value: 3~10.
        """
        return pulumi.get(self, "detect_multiplier")
    ...
    @property
    @pulumi.getter(name="includeCrossAccountVbr")
    def include_cross_account_vbr(self) -> pulumi.Output[builtins.bool]:
        """
        Whether cross account border routers are included. Valid values: `false`, `true`. Default: `true`.
        """
        return pulumi.get(self, "include_cross_account_vbr")
    ...
    @property
    @pulumi.getter(name="localGatewayIp")
    def local_gateway_ip(self) -> pulumi.Output[builtins.str]:
        """
        Alibaba Cloud-Connected IPv4 address.
        """
        return pulumi.get(self, "local_gateway_ip")
    ...
    @property
    @pulumi.getter(name="localIpv6GatewayIp")
    def local_ipv6_gateway_ip(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Alibaba Cloud-Connected IPv6 Address.
        """
        return pulumi.get(self, "local_ipv6_gateway_ip")
    ...
    @property
    @pulumi.getter(name="minRxInterval")
    def min_rx_interval(self) -> pulumi.Output[builtins.int]:
        """
        Configure BFD packet reception interval of values include: 200~1000, unit: ms.
        """
        return pulumi.get(self, "min_rx_interval")
    ...
    @property
    @pulumi.getter(name="minTxInterval")
    def min_tx_interval(self) -> pulumi.Output[builtins.int]:
        """
        Configure BFD packet transmission interval maximum value: 200~1000, unit: ms.
        """
        return pulumi.get(self, "min_tx_interval")
    ...
    @property
    @pulumi.getter(name="peerGatewayIp")
    def peer_gateway_ip(self) -> pulumi.Output[builtins.str]:
        """
        The Client-Side Interconnection IPv4 Address.
        """
        return pulumi.get(self, "peer_gateway_ip")
    ...
    @property
    @pulumi.getter(name="peerIpv6GatewayIp")
    def peer_ipv6_gateway_ip(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Client-Side Interconnection IPv6 Address.
        """
        return pulumi.get(self, "peer_ipv6_gateway_ip")
    ...
    @property
    @pulumi.getter(name="peeringIpv6SubnetMask")
    def peering_ipv6_subnet_mask(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Alibaba Cloud-Connected IPv6 with Client-Side Interconnection IPv6 of Subnet Mask.
        """
        return pulumi.get(self, "peering_ipv6_subnet_mask")
    ...
    @property
    @pulumi.getter(name="peeringSubnetMask")
    def peering_subnet_mask(self) -> pulumi.Output[builtins.str]:
        """
        Alibaba Cloud-Connected IPv4 and Client-Side Interconnection IPv4 of Subnet Mask.
        """
        return pulumi.get(self, "peering_subnet_mask")
    ...
    @property
    @pulumi.getter(name="physicalConnectionId")
    def physical_connection_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Physical Connection to Which the ID.
        """
        return pulumi.get(self, "physical_connection_id")
    ...
    @property
    @pulumi.getter(name="vbrOwnerId")
    def vbr_owner_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The vbr owner id.
        """
        return pulumi.get(self, "vbr_owner_id")
    ...
    @property
    @pulumi.getter(name="virtualBorderRouterName")
    def virtual_border_router_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of VBR. Length is from 2 to 128 characters, must start with a letter or the Chinese at the beginning can contain numbers, the underscore character (_) and dash (-). But do not start with http:// or https:// at the beginning.
        """
        return pulumi.get(self, "virtual_border_router_name")
