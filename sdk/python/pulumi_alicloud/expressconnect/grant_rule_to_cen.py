...
class GrantRuleToCenArgs:
    def __init__(__self__, *,
                 ...
                 cen_owner_id: pulumi.Input[builtins.int],
                 instance_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a GrantRuleToCen resource.
        :param pulumi.Input[builtins.str] cen_id: The ID of the CEN instance to which you want to grant permissions.
        :param pulumi.Input[builtins.int] cen_owner_id: The user ID (UID) of the Alibaba Cloud account to which the CEN instance belongs.
        :param pulumi.Input[builtins.str] instance_id: The ID of the VBR.
        """
    ...
    def cen_owner_id(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @cen_owner_id.setter
    def cen_owner_id(self, value: pulumi.Input[builtins.int]):
...
class _GrantRuleToCenState:
    def __init__(__self__, *,
                 ...
                 cen_owner_id: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="cenOwnerId")
    def cen_owner_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The user ID (UID) of the Alibaba Cloud account to which the CEN instance belongs.
        """
        return pulumi.get(self, "cen_owner_id")
    ...
    @cen_owner_id.setter
    def cen_owner_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cen_owner_id", value)
...
class GrantRuleToCen(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cen_id: Optional[pulumi.Input[builtins.str]] = None,
            cen_owner_id: Optional[pulumi.Input[builtins.int]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None) -> 'GrantRuleToCen':
        """
    ...
    @property
    @pulumi.getter(name="cenOwnerId")
    def cen_owner_id(self) -> pulumi.Output[builtins.int]:
        """
        The user ID (UID) of the Alibaba Cloud account to which the CEN instance belongs.
        """
        return pulumi.get(self, "cen_owner_id")
