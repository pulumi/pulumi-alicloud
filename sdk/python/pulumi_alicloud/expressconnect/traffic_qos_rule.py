...
class TrafficQosRuleArgs:
    def __init__(__self__, *,
                 ...
                 qos_id: pulumi.Input[builtins.str],
                 queue_id: pulumi.Input[builtins.str],
                 dst_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 dst_ipv6_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 dst_port_range: Optional[pulumi.Input[builtins.str]] = None,
                 match_dscp: Optional[pulumi.Input[builtins.int]] = None,
                 remarking_dscp: Optional[pulumi.Input[builtins.int]] = None,
                 rule_description: Optional[pulumi.Input[builtins.str]] = None,
                 rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 src_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 src_ipv6_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 src_port_range: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a TrafficQosRule resource.
        :param pulumi.Input[builtins.int] priority: QoS rule priority. Value range: **1** to **9000**. The larger the number, the higher the priority. The priority of a QoS rule cannot be repeated in the same QoS policy.
        :param pulumi.Input[builtins.str] protocol: QoS rule protocol type, value:
               - **ALL**
               - **ICMP(IPv4)**
               - **ICMPv6(IPv6)* *
               - **TCP**
               ...
               - **PostgreSQL**
               - **Redis**.
        :param pulumi.Input[builtins.str] qos_id: The QoS policy ID.
        :param pulumi.Input[builtins.str] queue_id: The QoS queue ID.
        :param pulumi.Input[builtins.str] dst_cidr: The traffic of the QoS rule matches the Destination IPv4 network segment.
               > **NOTE:**  If this parameter is not supported, enter **SrcIPv6Cidr** or **DstIPv6Cidr * *.
        :param pulumi.Input[builtins.str] dst_ipv6_cidr: The QoS rule traffic matches the Destination IPv6 network segment.
               > **NOTE:**  If this parameter is not supported, enter **SrcCidr** or **DstCidr * *.
        :param pulumi.Input[builtins.str] dst_port_range: QoS rule traffic matches the destination port number range. Value range: **0** to **65535**. If not, the value is - 1. Currently, only a single port number is supported, and the start and end of the port number must be the same. The corresponding destination port number range is fixed for different protocol types. The values are as follows:
        ...
        :param pulumi.Input[builtins.int] match_dscp: The DSCP value of the traffic matched by the QoS rule. Value range: **0** to **63**. If not, the value is - 1.
        :param pulumi.Input[builtins.int] remarking_dscp: Modify The DSCP value in the flow. Value range: **0** to **63**. If the value is not modified, the value is - 1.
        :param pulumi.Input[builtins.str] rule_description: The description of the QoS rule.  The length is 0 to 256 characters and cannot start with 'http:// 'or 'https.
        :param pulumi.Input[builtins.str] rule_name: The name of the QoS rule.  The length is 0 to 128 characters and cannot start with 'http:// 'or 'https.
        :param pulumi.Input[builtins.str] src_cidr: The QoS rule traffic matches the source IPv4 CIDR block.
               > **NOTE:**  If this parameter is not supported, enter **SrcIPv6Cidr** or **DstIPv6Cidr * *.
        :param pulumi.Input[builtins.str] src_ipv6_cidr: The QoS rule traffic matches the source IPv6 network segment.
               > **NOTE:**  If this parameter is not supported, enter **SrcCidr** or **DstCidr * *.
        :param pulumi.Input[builtins.str] src_port_range: The source port number of the QoS rule traffic matching. The value range is **0** to **65535**. If the traffic does not match, the value is - 1. Currently, only a single port number is supported, and the start and end of the port number must be the same.
        """
    ...
    def qos_id(self) -> pulumi.Input[builtins.str]:
        """
        The QoS policy ID.
        """
    ...
    @qos_id.setter
    def qos_id(self, value: pulumi.Input[builtins.str]):
    ...
    @dst_cidr.setter
    def dst_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dst_cidr", value)

    @property
    @pulumi.getter(name="dstIpv6Cidr")
    def dst_ipv6_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dst_ipv6_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @match_dscp.setter
    def match_dscp(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "match_dscp", value)

    @property
    @pulumi.getter(name="remarkingDscp")
    def remarking_dscp(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def remarking_dscp(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "remarking_dscp", value)

    @property
    @pulumi.getter(name="ruleDescription")
    def rule_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rule_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @src_cidr.setter
    def src_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "src_cidr", value)

    @property
    @pulumi.getter(name="srcIpv6Cidr")
    def src_ipv6_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def src_ipv6_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TrafficQosRuleState:
    def __init__(__self__, *,
                 ...
                 qos_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] remarking_dscp: Modify The DSCP value in the flow. Value range: **0** to **63**. If the value is not modified, the value is - 1.
        :param pulumi.Input[builtins.str] rule_description: The description of the QoS rule.  The length is 0 to 256 characters and cannot start with 'http:// 'or 'https.
        :param pulumi.Input[builtins.str] rule_id: The ID of the QoS rule.
        :param pulumi.Input[builtins.str] rule_name: The name of the QoS rule.  The length is 0 to 128 characters and cannot start with 'http:// 'or 'https.
        :param pulumi.Input[builtins.str] src_cidr: The QoS rule traffic matches the source IPv4 CIDR block.
               > **NOTE:**  If this parameter is not supported, enter **SrcIPv6Cidr** or **DstIPv6Cidr * *.
        :param pulumi.Input[builtins.str] src_ipv6_cidr: The QoS rule traffic matches the source IPv6 network segment.
               > **NOTE:**  If this parameter is not supported, enter **SrcCidr** or **DstCidr * *.
        :param pulumi.Input[builtins.str] src_port_range: The source port number of the QoS rule traffic matching. The value range is **0** to **65535**. If the traffic does not match, the value is - 1. Currently, only a single port number is supported, and the start and end of the port number must be the same.
        :param pulumi.Input[builtins.str] status: The status of the QoS rule. Value:
        """
        if dst_cidr is not None:
            pulumi.set(__self__, "dst_cidr", dst_cidr)
        if dst_ipv6_cidr is not None:
    ...
    @property
    @pulumi.getter(name="qosId")
    def qos_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The QoS policy ID.
        """
        return pulumi.get(self, "qos_id")
    ...
    @qos_id.setter
    def qos_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "qos_id", value)
...
class TrafficQosRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            src_ipv6_cidr: Optional[pulumi.Input[builtins.str]] = None,
            src_port_range: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'TrafficQosRule':
        """
    ...
    @property
    @pulumi.getter(name="dstCidr")
    def dst_cidr(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The traffic of the QoS rule matches the Destination IPv4 network segment.
        > **NOTE:**  If this parameter is not supported, enter **SrcIPv6Cidr** or **DstIPv6Cidr * *.
        """
    ...
    @property
    @pulumi.getter(name="dstIpv6Cidr")
    def dst_ipv6_cidr(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The QoS rule traffic matches the Destination IPv6 network segment.
        > **NOTE:**  If this parameter is not supported, enter **SrcCidr** or **DstCidr * *.
        """
    ...
    @property
    @pulumi.getter(name="matchDscp")
    def match_dscp(self) -> pulumi.Output[builtins.int]:
        """
        The DSCP value of the traffic matched by the QoS rule. Value range: **0** to **63**. If not, the value is - 1.
        """
        return pulumi.get(self, "match_dscp")
    ...
    @property
    @pulumi.getter(name="qosId")
    def qos_id(self) -> pulumi.Output[builtins.str]:
        """
        The QoS policy ID.
        """
        return pulumi.get(self, "qos_id")
    ...
    @property
    @pulumi.getter(name="remarkingDscp")
    def remarking_dscp(self) -> pulumi.Output[builtins.int]:
        """
        Modify The DSCP value in the flow. Value range: **0** to **63**. If the value is not modified, the value is - 1.
        """
        return pulumi.get(self, "remarking_dscp")
    ...
    @property
    @pulumi.getter(name="ruleDescription")
    def rule_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the QoS rule.  The length is 0 to 256 characters and cannot start with 'http:// 'or 'https.
        """
        return pulumi.get(self, "rule_description")
    ...
    @property
    @pulumi.getter(name="srcCidr")
    def src_cidr(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The QoS rule traffic matches the source IPv4 CIDR block.
        > **NOTE:**  If this parameter is not supported, enter **SrcIPv6Cidr** or **DstIPv6Cidr * *.
        """
    ...
    @property
    @pulumi.getter(name="srcIpv6Cidr")
    def src_ipv6_cidr(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The QoS rule traffic matches the source IPv6 network segment.
        > **NOTE:**  If this parameter is not supported, enter **SrcCidr** or **DstCidr * *.
        """
