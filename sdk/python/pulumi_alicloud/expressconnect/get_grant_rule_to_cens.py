...
def get_grant_rule_to_cens(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Grant Rule To Cen IDs.
    :param builtins.str instance_id: The ID of the VBR.
...
def get_grant_rule_to_cens_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
