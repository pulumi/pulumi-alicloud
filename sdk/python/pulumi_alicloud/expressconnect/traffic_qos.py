...
class TrafficQosArgs:
    def __init__(__self__, *,
                 qos_description: Optional[pulumi.Input[builtins.str]] = None,
                 qos_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a TrafficQos resource.
        :param pulumi.Input[builtins.str] qos_description: The description of the QoS policy.  The length is **0** to **256** characters and cannot start with 'http:// 'or 'https.
        :param pulumi.Input[builtins.str] qos_name: The name of the QoS policy.  The length is **0** to **128** characters and cannot start with 'http:// 'or 'https.
        """
    ...
    def qos_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def qos_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "qos_description", value)

    @property
    @pulumi.getter(name="qosName")
    def qos_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @qos_name.setter
    def qos_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TrafficQosState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] qos_description: The description of the QoS policy.  The length is **0** to **256** characters and cannot start with 'http:// 'or 'https.
        :param pulumi.Input[builtins.str] qos_name: The name of the QoS policy.  The length is **0** to **128** characters and cannot start with 'http:// 'or 'https.
        :param pulumi.Input[builtins.str] status: The status of the QoS policy. Value:
...
class TrafficQos(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:expressconnect/trafficQos:TrafficQos"
    ...
    def get(resource_name: str,
            ...
            qos_description: Optional[pulumi.Input[builtins.str]] = None,
            qos_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'TrafficQos':
        """
    ...
    @property
    @pulumi.getter(name="qosDescription")
    def qos_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the QoS policy.  The length is **0** to **256** characters and cannot start with 'http:// 'or 'https.
        """
        return pulumi.get(self, "qos_description")
    ...
    @property
    @pulumi.getter(name="qosName")
    def qos_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the QoS policy.  The length is **0** to **128** characters and cannot start with 'http:// 'or 'https.
        """
        return pulumi.get(self, "qos_name")
