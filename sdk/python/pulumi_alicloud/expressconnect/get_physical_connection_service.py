...
def get_physical_connection_service(enable: Optional[builtins.str] = None,
...
def get_physical_connection_service_output(enable: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:expressconnect/getPhysicalConnectionService:getPhysicalConnectionService', __args__, opts=opts, typ=GetPhysicalConnectionServiceResult)
    return __ret__.apply(lambda __response__: GetPhysicalConnectionServiceResult(
