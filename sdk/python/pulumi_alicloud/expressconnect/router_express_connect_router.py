...
class RouterExpressConnectRouterArgs:
    def __init__(__self__, *,
                 alibaba_side_asn: pulumi.Input[builtins.int],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ecr_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] alibaba_side_asn: ASN representing resources.
        :param pulumi.Input[builtins.str] description: Represents the description of the leased line gateway.
        :param pulumi.Input[builtins.str] ecr_name: Name of the Gateway representing the leased line.
        ...
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the ECR instance belongs.
    ...
    def alibaba_side_asn(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def alibaba_side_asn(self, value: pulumi.Input[builtins.int]):
    ...
    def ecr_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ecr_name.setter
    def ecr_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RouterExpressConnectRouterState:
    def __init__(__self__, *,
                 alibaba_side_asn: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] alibaba_side_asn: ASN representing resources.
        :param pulumi.Input[builtins.str] create_time: Represents the creation time of the resource.
        :param pulumi.Input[builtins.str] description: Represents the description of the leased line gateway.
        :param pulumi.Input[builtins.str] ecr_name: Name of the Gateway representing the leased line.
        :param pulumi.Input[Sequence[pulumi.Input['RouterExpressConnectRouterRegionArgs']]] regions: List of regions representing leased line gateways. See `regions` below.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the ECR instance belongs.
    ...
    @property
    @pulumi.getter(name="alibabaSideAsn")
    def alibaba_side_asn(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        ASN representing resources.
        """
        return pulumi.get(self, "alibaba_side_asn")
    ...
    @alibaba_side_asn.setter
    def alibaba_side_asn(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "alibaba_side_asn", value)
...
class RouterExpressConnectRouter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'RouterExpressConnectRouter':
        """
    ...
    @property
    @pulumi.getter(name="alibabaSideAsn")
    def alibaba_side_asn(self) -> pulumi.Output[builtins.int]:
        """
        ASN representing resources.
        """
        return pulumi.get(self, "alibaba_side_asn")
    ...
    @property
    @pulumi.getter(name="ecrName")
    def ecr_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the Gateway representing the leased line.
        """
        return pulumi.get(self, "ecr_name")
