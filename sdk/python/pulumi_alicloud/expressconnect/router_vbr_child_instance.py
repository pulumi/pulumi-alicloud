...
class RouterVbrChildInstanceArgs:
    def __init__(__self__, *,
                 child_instance_id: pulumi.Input[builtins.str],
                 child_instance_region_id: pulumi.Input[builtins.str],
                 child_instance_type: pulumi.Input[builtins.str],
                 ecr_id: pulumi.Input[builtins.str],
                 child_instance_owner_id: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RouterVbrChildInstance resource.
        :param pulumi.Input[builtins.str] child_instance_id: The ID of the leased line gateway subinstance.
        :param pulumi.Input[builtins.str] child_instance_region_id: Region of the leased line gateway sub-instance
        :param pulumi.Input[builtins.str] child_instance_type: The type of the network instance. Value: `VBR`: VBR instance.
        :param pulumi.Input[builtins.str] ecr_id: ID of the representative leased line gateway instance.
        :param pulumi.Input[builtins.str] child_instance_owner_id: The ID of the Alibaba Cloud account (primary account) to which the VBR instance belongs.
               
               > **NOTE:**  This parameter is required if you want to load a cross-account network instance.
        :param pulumi.Input[builtins.str] description: Resource attribute fields that represent descriptive information
        """
    ...
    def child_instance_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def child_instance_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "child_instance_id", value)

    @property
    @pulumi.getter(name="childInstanceRegionId")
    def child_instance_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def child_instance_region_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "child_instance_region_id", value)

    @property
    @pulumi.getter(name="childInstanceType")
    def child_instance_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def child_instance_type(self, value: pulumi.Input[builtins.str]):
    ...
    @ecr_id.setter
    def ecr_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ecr_id", value)

    @property
    @pulumi.getter(name="childInstanceOwnerId")
    def child_instance_owner_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def child_instance_owner_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RouterVbrChildInstanceState:
    def __init__(__self__, *,
                 child_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 child_instance_owner_id: Optional[pulumi.Input[builtins.str]] = None,
                 child_instance_region_id: Optional[pulumi.Input[builtins.str]] = None,
                 child_instance_type: Optional[pulumi.Input[builtins.str]] = None,
                 create_time: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ecr_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: Resource attribute fields that represent descriptive information
        :param pulumi.Input[builtins.str] ecr_id: ID of the representative leased line gateway instance.
        :param pulumi.Input[builtins.str] status: Binding relationship status of leased line gateway subinstances.
        """
    ...
    @property
    @pulumi.getter(name="childInstanceId")
    def child_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the leased line gateway subinstance.
        """
        return pulumi.get(self, "child_instance_id")
    ...
    @child_instance_id.setter
    def child_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "child_instance_id", value)
    ...
    @property
    @pulumi.getter(name="childInstanceRegionId")
    def child_instance_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Region of the leased line gateway sub-instance
        """
        return pulumi.get(self, "child_instance_region_id")
    ...
    @child_instance_region_id.setter
    def child_instance_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "child_instance_region_id", value)

    @property
    @pulumi.getter(name="childInstanceType")
    def child_instance_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the network instance. Value: `VBR`: VBR instance.
        """
        return pulumi.get(self, "child_instance_type")
    ...
    @child_instance_type.setter
    def child_instance_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "child_instance_type", value)
    ...
    @ecr_id.setter
    def ecr_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ecr_id", value)
...
class RouterVbrChildInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            ecr_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'RouterVbrChildInstance':
        """
    ...
    @property
    @pulumi.getter(name="childInstanceId")
    def child_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the leased line gateway subinstance.
        """
        return pulumi.get(self, "child_instance_id")
    ...
    @property
    @pulumi.getter(name="childInstanceOwnerId")
    def child_instance_owner_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Alibaba Cloud account (primary account) to which the VBR instance belongs.
    ...
    @property
    @pulumi.getter(name="childInstanceRegionId")
    def child_instance_region_id(self) -> pulumi.Output[builtins.str]:
        """
        Region of the leased line gateway sub-instance
        """
        return pulumi.get(self, "child_instance_region_id")
    ...
    @property
    @pulumi.getter(name="childInstanceType")
    def child_instance_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the network instance. Value: `VBR`: VBR instance.
        """
        return pulumi.get(self, "child_instance_type")
