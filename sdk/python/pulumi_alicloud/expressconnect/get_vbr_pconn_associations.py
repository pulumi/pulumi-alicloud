...
class GetVbrPconnAssociationsResult:
    ...
    def vbr_id(self) -> Optional[builtins.str]:
        """
...
def get_vbr_pconn_associations(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Vbr Pconn Association IDs.
...
def get_vbr_pconn_associations_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                      ...
                                      vbr_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
