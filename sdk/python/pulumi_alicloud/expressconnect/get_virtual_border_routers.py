...
def get_virtual_border_routers(filters: Optional[Sequence[Union['GetVirtualBorderRoutersFilterArgs', 'GetVirtualBorderRoutersFilterArgsDict']]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Virtual Border Router IDs.
    :param builtins.str name_regex: A regex string to filter results by Virtual Border Router name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The instance state with. Valid values: `active`, `deleting`, `recovering`, `terminated`, `terminating`, `unconfirmed`.
    """
    __args__ = dict()
