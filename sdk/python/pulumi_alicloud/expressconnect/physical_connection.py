...
class PhysicalConnectionArgs:
    def __init__(__self__, *,
                 access_point_id: pulumi.Input[builtins.str],
                 ...
                 physical_connection_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] access_point_id: The access point ID of the Express Connect circuit.
        :param pulumi.Input[builtins.str] line_operator: The connectivity provider of the Express Connect circuit. Valid values:
               - `CT`: China Telecom.
               - `CU`: China Unicom.
               - `CM`: China Mobile.
        ...
        :param pulumi.Input[builtins.str] bandwidth: The maximum bandwidth of the hosted connection.
        :param pulumi.Input[builtins.str] circuit_code: The circuit code of the Express Connect circuit.
        :param pulumi.Input[builtins.str] description: The description of the Express Connect circuit.
        :param pulumi.Input[builtins.str] peer_location: The geographical location of the data center.
        :param pulumi.Input[builtins.int] period: The subscription duration. Valid values:
               - If `pricing_cycle` is set to `Month`. Valid values: `1` to `9`.
               - If `pricing_cycle` is set to `Year`. Valid values: `1` to `5`.
        :param pulumi.Input[builtins.str] physical_connection_name: The name of the Express Connect circuit.
        :param pulumi.Input[builtins.str] port_type: The port type of the Express Connect circuit. Valid values:
        ...
        :param pulumi.Input[builtins.str] pricing_cycle: The billing cycle of the subscription. Default value: `Month`. Valid values: `Month`, `Year`.
               > **NOTE:** `period` and `pricing_cycle` are valid only when `status` is set to `Enabled`.
        :param pulumi.Input[builtins.str] redundant_physical_connection_id: The ID of the redundant Express Connect circuit. **NOTE:** From version 1.230.1, `redundant_physical_connection_id` cannot be modified.
        :param pulumi.Input[builtins.str] status: The status of the Express Connect circuit. Valid values: `Confirmed`, `Enabled`, `Canceled`, `Terminated`. **NOTE:** From version 1.230.1, `status` can be set to `Confirmed`. If you want to set `status` to `Enabled`, `period` must be set.
        :param pulumi.Input[builtins.str] type: The type of Express Connect circuit. Default value: `VPC`. Valid values: `VPC`.
        """
    ...
    def access_point_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def access_point_id(self, value: pulumi.Input[builtins.str]):
    ...
    def physical_connection_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def physical_connection_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PhysicalConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] line_operator: The connectivity provider of the Express Connect circuit. Valid values:
               ...
               - `Equinix`: Equinix.
               - `Other`: Other connectivity providers outside the Chinese mainland.
        :param pulumi.Input[builtins.str] order_id: The ID of the order that is placed. **Note:** `order_id` takes effect only if `status` is set to `Enabled`.
        :param pulumi.Input[builtins.str] peer_location: The geographical location of the data center.
        :param pulumi.Input[builtins.int] period: The subscription duration. Valid values:
               - If `pricing_cycle` is set to `Month`. Valid values: `1` to `9`.
               - If `pricing_cycle` is set to `Year`. Valid values: `1` to `5`.
...
class PhysicalConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            redundant_physical_connection_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'PhysicalConnection':
        """
    ...
    @property
    @pulumi.getter(name="physicalConnectionName")
    def physical_connection_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Express Connect circuit.
        """
        return pulumi.get(self, "physical_connection_name")
    ...
    @property
    @pulumi.getter(name="redundantPhysicalConnectionId")
    def redundant_physical_connection_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the redundant Express Connect circuit. **NOTE:** From version 1.230.1, `redundant_physical_connection_id` cannot be modified.
        """
        return pulumi.get(self, "redundant_physical_connection_id")
