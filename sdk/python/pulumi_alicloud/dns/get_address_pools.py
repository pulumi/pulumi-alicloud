...
def get_address_pools(enable_details: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Address Pool IDs.
    :param _builtins.str instance_id: The id of the instance.
    :param _builtins.str name_regex: A regex string to filter results by Address Pool name.
...
def get_address_pools_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
