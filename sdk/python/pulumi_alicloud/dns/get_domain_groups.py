...
def get_domain_groups(ids: Optional[Sequence[builtins.str]] = None,
...
def get_domain_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
