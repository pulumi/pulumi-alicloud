...
class CustomLineArgs:
    def __init__(__self__, *,
                 custom_line_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] custom_line_name: The name of the Custom Line.
    ...
    def custom_line_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def custom_line_name(self, value: pulumi.Input[builtins.str]):
...
class _CustomLineState:
    def __init__(__self__, *,
                 custom_line_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="customLineName")
    def custom_line_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Custom Line.
        """
        return pulumi.get(self, "custom_line_name")
    ...
    @custom_line_name.setter
    def custom_line_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_line_name", value)
...
class CustomLine(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            domain_name: Optional[pulumi.Input[builtins.str]] = None,
            ip_segment_lists: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CustomLineIpSegmentListArgs', 'CustomLineIpSegmentListArgsDict']]]]] = None,
            lang: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomLine':
        """
    ...
    @property
    @pulumi.getter(name="customLineName")
    def custom_line_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Custom Line.
        """
        return pulumi.get(self, "custom_line_name")
