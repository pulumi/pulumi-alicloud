...
def get_access_strategies(enable_details: Optional[_builtins.bool] = None,
                          ids: Optional[Sequence[_builtins.str]] = None,
                          instance_id: Optional[_builtins.str] = None,
                          lang: Optional[_builtins.str] = None,
                          name_regex: Optional[_builtins.str] = None,
                          output_file: Optional[_builtins.str] = None,
                          strategy_mode: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Access Strategy IDs.
    :param _builtins.str instance_id: The Id of the associated instance.
    :param _builtins.str lang: The lang.
    :param _builtins.str name_regex: A regex string to filter results by Access Strategy name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str strategy_mode: The type of the access policy. Valid values:
