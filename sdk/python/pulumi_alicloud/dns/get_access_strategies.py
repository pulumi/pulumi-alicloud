...
def get_access_strategies(enable_details: Optional[builtins.bool] = None,
                          ...
                          strategy_mode: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Access Strategy IDs.
    :param builtins.str instance_id: The Id of the associated instance.
    :param builtins.str lang: The lang.
    :param builtins.str name_regex: A regex string to filter results by Access Strategy name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str strategy_mode: The type of the access policy. Valid values:
...
def get_access_strategies_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                 ...
                                 strategy_mode: Optional[pulumi.Input[builtins.str]] = None,
