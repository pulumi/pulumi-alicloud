...
class DomainAttachment(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, domain_names=None, instance_id=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[list] domain_names: The domain names bound to the DNS instance.
    ...
    @staticmethod
    def get(resource_name, id, opts=None, domain_names=None, instance_id=None):
        """
