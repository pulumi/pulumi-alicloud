...
class AlidnsDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] remark: Remarks information for your domain name.
        :param pulumi.Input[_builtins.str] resource_group_id: The Id of resource group which the dns domain belongs.
...
class _AlidnsDomainState:
    def __init__(__self__, *,
                 ...
                 lang: Optional[pulumi.Input[_builtins.str]] = None,
                 puny_code: Optional[pulumi.Input[_builtins.str]] = None,
                 remark: Optional[pulumi.Input[_builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[_builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] domain_name: Name of the domain. This name without suffix can have a string of 1 to 63 characters(domain name subject, excluding suffix), must contain only alphanumeric characters or "-", and must not begin or end with "-", and "-" must not in the 3th and 4th character positions at the same time. Suffix `.sh` and `.tel` are not supported.
        :param pulumi.Input[_builtins.str] group_id: Id of the group in which the domain will add. If not supplied, then use default group.
        :param pulumi.Input[_builtins.str] group_name: Domain name group name.
        :param pulumi.Input[_builtins.str] lang: User language.
        :param pulumi.Input[_builtins.str] puny_code: Only return punycode codes for Chinese domain names.
        :param pulumi.Input[_builtins.str] remark: Remarks information for your domain name.
        :param pulumi.Input[_builtins.str] resource_group_id: The Id of resource group which the dns domain belongs.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags to assign to the resource.
               - Key: It can be [1, 20] characters in length. It can contain A-Z, a-z, numbers, underscores (_), and hyphens (-). It cannot begin with "aliyun", "acs:", "http://", or "https://". It cannot be a null string.
    ...
    def puny_code(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @puny_code.setter
    def puny_code(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class AlidnsDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            remark: Optional[pulumi.Input[_builtins.str]] = None,
            resource_group_id: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'AlidnsDomain':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="punyCode")
    def puny_code(self) -> pulumi.Output[_builtins.str]:
        """
        Only return punycode codes for Chinese domain names.
        """
        return pulumi.get(self, "puny_code")
