...
class AddressPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] lba_strategy: The load balancing policy of the address pool. Valid values:`ALL_RR` or `RATIO`. `ALL_RR`: returns all addresses. `RATIO`: returns addresses by weight.
        :param pulumi.Input[builtins.str] type: The type of the address pool. Valid values: `IPV4`, `IPV6`, `DOMAIN`.
        """
    ...
    def address_pool_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def address_pool_name(self, value: pulumi.Input[builtins.str]):
    ...
    def lba_strategy(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @lba_strategy.setter
    def lba_strategy(self, value: pulumi.Input[builtins.str]):
...
class _AddressPoolState:
    def __init__(__self__, *,
                 address_pool_name: Optional[pulumi.Input[builtins.str]] = None,
                 addresses: Optional[pulumi.Input[Sequence[pulumi.Input['AddressPoolAddressArgs']]]] = None,
                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 lba_strategy: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="addressPoolName")
    def address_pool_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the address pool.
        """
        return pulumi.get(self, "address_pool_name")
    ...
    @address_pool_name.setter
    def address_pool_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "address_pool_name", value)
    ...
    @property
    @pulumi.getter(name="lbaStrategy")
    def lba_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The load balancing policy of the address pool. Valid values:`ALL_RR` or `RATIO`. `ALL_RR`: returns all addresses. `RATIO`: returns addresses by weight.
        """
        return pulumi.get(self, "lba_strategy")
    ...
    @lba_strategy.setter
    def lba_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "lba_strategy", value)
...
class AddressPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            lba_strategy: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'AddressPool':
        """
    ...
    @property
    @pulumi.getter(name="addressPoolName")
    def address_pool_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the address pool.
        """
        return pulumi.get(self, "address_pool_name")
    ...
    @property
    @pulumi.getter(name="lbaStrategy")
    def lba_strategy(self) -> pulumi.Output[builtins.str]:
        """
        The load balancing policy of the address pool. Valid values:`ALL_RR` or `RATIO`. `ALL_RR`: returns all addresses. `RATIO`: returns addresses by weight.
        """
        return pulumi.get(self, "lba_strategy")
