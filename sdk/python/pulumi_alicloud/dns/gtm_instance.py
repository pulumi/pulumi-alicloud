...
class GtmInstanceArgs:
    def __init__(__self__, *,
                 health_check_task_count: pulumi.Input[builtins.int],
                 instance_name: pulumi.Input[builtins.str],
                 package_edition: pulumi.Input[builtins.str],
                 payment_type: pulumi.Input[builtins.str],
                 period: pulumi.Input[builtins.int],
                 sms_notification_count: pulumi.Input[builtins.int],
                 alert_configs: Optional[pulumi.Input[Sequence[pulumi.Input['GtmInstanceAlertConfigArgs']]]] = None,
                 alert_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 public_cname_mode: Optional[pulumi.Input[builtins.str]] = None,
                 public_rr: Optional[pulumi.Input[builtins.str]] = None,
                 public_user_domain_name: Optional[pulumi.Input[builtins.str]] = None,
                 public_zone_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] health_check_task_count: The quota of detection tasks.
        :param pulumi.Input[builtins.str] instance_name: The name of the instance.
        :param pulumi.Input[builtins.str] package_edition: Paid package version. Valid values: `ultimate`, `standard`.
        :param pulumi.Input[builtins.str] payment_type: The Payment Type of the resource. Valid value: `Subscription`.
        ...
        :param pulumi.Input[builtins.int] sms_notification_count: The quota of SMS notifications.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] alert_groups: The alert group.
        :param pulumi.Input[builtins.str] cname_type: The access type of the CNAME domain name. Valid value: `PUBLIC`.
        :param pulumi.Input[builtins.bool] force_update: The force update.
        :param pulumi.Input[builtins.str] lang: The lang.
        :param pulumi.Input[builtins.str] public_cname_mode: The Public Network domain name access method. Valid values: `CUSTOM`, `SYSTEM_ASSIGN`.
        :param pulumi.Input[builtins.str] public_rr: The CNAME access domain name.
        :param pulumi.Input[builtins.str] public_user_domain_name: The website domain name that the user uses on the Internet.
        :param pulumi.Input[builtins.str] public_zone_name: The domain name that is used to access GTM over the Internet.
        :param pulumi.Input[builtins.int] renew_period: Automatic renewal period, the unit is month. When setting `renewal_status` to AutoRenewal, it must be set.
        :param pulumi.Input[builtins.str] renewal_status: Automatic renewal status. Valid values: `AutoRenewal`, `ManualRenewal`.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] strategy_mode: The type of the access policy. Valid values: `GEO`, `LATENCY`.
        :param pulumi.Input[builtins.int] ttl: The global time to live. Valid values: `60`, `120`, `300`, `600`. Unit: second.
        """
    ...
    def health_check_task_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def health_check_task_count(self, value: pulumi.Input[builtins.int]):
    ...
    def package_edition(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def package_edition(self, value: pulumi.Input[builtins.str]):
    ...
    def sms_notification_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def sms_notification_count(self, value: pulumi.Input[builtins.int]):
    ...
    def alert_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The alert group.
        """
    ...
    @alert_groups.setter
    def alert_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def public_cname_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_cname_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "public_cname_mode", value)

    @property
    @pulumi.getter(name="publicRr")
    def public_rr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @public_rr.setter
    def public_rr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "public_rr", value)

    @property
    @pulumi.getter(name="publicUserDomainName")
    def public_user_domain_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_user_domain_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "public_user_domain_name", value)

    @property
    @pulumi.getter(name="publicZoneName")
    def public_zone_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_zone_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _GtmInstanceState:
    def __init__(__self__, *,
                 ...
                 cname_type: Optional[pulumi.Input[builtins.str]] = None,
                 force_update: Optional[pulumi.Input[builtins.bool]] = None,
                 health_check_task_count: Optional[pulumi.Input[builtins.int]] = None,
                 instance_name: Optional[pulumi.Input[builtins.str]] = None,
                 lang: Optional[pulumi.Input[builtins.str]] = None,
                 package_edition: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 renewal_status: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 sms_notification_count: Optional[pulumi.Input[builtins.int]] = None,
                 strategy_mode: Optional[pulumi.Input[builtins.str]] = None,
                 ttl: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    @property
    @pulumi.getter(name="healthCheckTaskCount")
    def health_check_task_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The quota of detection tasks.
        """
        return pulumi.get(self, "health_check_task_count")
    ...
    @health_check_task_count.setter
    def health_check_task_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "health_check_task_count", value)
    ...
    @property
    @pulumi.getter(name="packageEdition")
    def package_edition(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Paid package version. Valid values: `ultimate`, `standard`.
        """
        return pulumi.get(self, "package_edition")
    ...
    @package_edition.setter
    def package_edition(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "package_edition", value)
    ...
    @property
    @pulumi.getter(name="smsNotificationCount")
    def sms_notification_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The quota of SMS notifications.
        """
        return pulumi.get(self, "sms_notification_count")
    ...
    @sms_notification_count.setter
    def sms_notification_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "sms_notification_count", value)
...
class GtmInstance(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:dns/gtmInstance:GtmInstance"
    ...
    def get(resource_name: str,
            ...
            sms_notification_count: Optional[pulumi.Input[builtins.int]] = None,
            strategy_mode: Optional[pulumi.Input[builtins.str]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None) -> 'GtmInstance':
        """
    ...
    @property
    @pulumi.getter(name="alertGroups")
    def alert_groups(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The alert group.
        """
        return pulumi.get(self, "alert_groups")
    ...
    @property
    @pulumi.getter(name="cnameType")
    def cname_type(self) -> pulumi.Output[builtins.str]:
        """
        The access type of the CNAME domain name. Valid value: `PUBLIC`.
        """
        return pulumi.get(self, "cname_type")
    ...
    @property
    @pulumi.getter(name="healthCheckTaskCount")
    def health_check_task_count(self) -> pulumi.Output[builtins.int]:
        """
        The quota of detection tasks.
        """
        return pulumi.get(self, "health_check_task_count")
    ...
    @property
    @pulumi.getter(name="packageEdition")
    def package_edition(self) -> pulumi.Output[builtins.str]:
        """
        Paid package version. Valid values: `ultimate`, `standard`.
        """
        return pulumi.get(self, "package_edition")
    ...
    @property
    @pulumi.getter(name="publicCnameMode")
    def public_cname_mode(self) -> pulumi.Output[builtins.str]:
        """
        The Public Network domain name access method. Valid values: `CUSTOM`, `SYSTEM_ASSIGN`.
        """
        return pulumi.get(self, "public_cname_mode")
    ...
    @property
    @pulumi.getter(name="publicRr")
    def public_rr(self) -> pulumi.Output[builtins.str]:
        """
        The CNAME access domain name.
        """
        return pulumi.get(self, "public_rr")
    ...
    @property
    @pulumi.getter(name="publicUserDomainName")
    def public_user_domain_name(self) -> pulumi.Output[builtins.str]:
        """
        The website domain name that the user uses on the Internet.
        """
        return pulumi.get(self, "public_user_domain_name")
    ...
    @property
    @pulumi.getter(name="publicZoneName")
    def public_zone_name(self) -> pulumi.Output[builtins.str]:
        """
        The domain name that is used to access GTM over the Internet.
        """
        return pulumi.get(self, "public_zone_name")
    ...
    @property
    @pulumi.getter(name="smsNotificationCount")
    def sms_notification_count(self) -> pulumi.Output[builtins.int]:
        """
        The quota of SMS notifications.
        """
        return pulumi.get(self, "sms_notification_count")
