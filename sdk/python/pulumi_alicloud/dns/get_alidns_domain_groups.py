...
def get_alidns_domain_groups(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param _builtins.str name_regex: A regex string to filter results by the domain group name.
...
def get_alidns_domain_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
