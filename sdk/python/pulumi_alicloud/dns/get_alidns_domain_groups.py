...
def get_alidns_domain_groups(ids=None,name_regex=None,output_file=None,opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:dns/getAlidnsDomainGroups:getAlidnsDomainGroups', __args__, opts=opts).value
