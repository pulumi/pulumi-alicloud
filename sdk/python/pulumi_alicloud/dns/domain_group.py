...
class DomainGroupArgs:
    def __init__(__self__, *,
                 domain_group_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] domain_group_name: The Name of the domain group. The `domain_group_name` is required when the value of the `group_name`  is Empty.
        :param pulumi.Input[builtins.str] group_name: The Name of the domain group. The `group_name` has been deprecated from provider version 1.97.0. Please use `domain_group_name` instead.
    ...
    def domain_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def domain_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DomainGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            domain_group_name: Optional[pulumi.Input[builtins.str]] = None,
            group_name: Optional[pulumi.Input[builtins.str]] = None,
            lang: Optional[pulumi.Input[builtins.str]] = None) -> 'DomainGroup':
        """
    ...
    @property
    @pulumi.getter(name="domainGroupName")
    def domain_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The Name of the domain group. The `domain_group_name` is required when the value of the `group_name`  is Empty.
        """
        return pulumi.get(self, "domain_group_name")
