...
class RecordArgs:
    def __init__(__self__, *,
                 host_record: pulumi.Input[_builtins.str],
    ...
    def host_record(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @host_record.setter
    def host_record(self, value: pulumi.Input[_builtins.str]):
...
class _RecordState:
    def __init__(__self__, *,
                 host_record: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.int] priority: The priority of domain record. Valid values are `[1-10]`. When the `type` is `MX`, this parameter is required.
        :param pulumi.Input[_builtins.str] routing: The resolution line of domain record. Valid values are `default`, `telecom`, `unicom`, `mobile`, `oversea`, `edu`, `drpeng`, `btvn`, .etc. When the `type` is `FORWORD_URL`, this parameter must be `default`. Default value is `default`. For checking all resolution lines enumeration please visit [Alibaba Cloud DNS doc](https://www.alibabacloud.com/help/en/alibaba-cloud-dns/latest/what-is-alibaba-cloud-dns) or using dns_get_resolution_lines in data source to get the value.
        :param pulumi.Input[_builtins.str] status: The record status. `Enable` or `Disable`.
    ...
    @_builtins.property
    @pulumi.getter(name="hostRecord")
    def host_record(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Host record for the domain record. This host_record can have at most 253 characters, and each part split with "." can have at most 63 characters, and must contain only alphanumeric characters or hyphens, such as "-",".","*","@",  and must not begin or end with "-".
        """
        return pulumi.get(self, "host_record")
    ...
    @host_record.setter
    def host_record(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "host_record", value)
...
class Record(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ttl: Optional[pulumi.Input[_builtins.int]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            value: Optional[pulumi.Input[_builtins.str]] = None) -> 'Record':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="hostRecord")
    def host_record(self) -> pulumi.Output[_builtins.str]:
        """
        Host record for the domain record. This host_record can have at most 253 characters, and each part split with "." can have at most 63 characters, and must contain only alphanumeric characters or hyphens, such as "-",".","*","@",  and must not begin or end with "-".
        """
        return pulumi.get(self, "host_record")
