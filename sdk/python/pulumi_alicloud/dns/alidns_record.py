...
class AlidnsRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] rr: Host record for the domain record. This host_record can have at most 253 characters, and each part split with `.` can have at most 63 characters, and must contain only alphanumeric characters or hyphens, such as `-`, `.`, `*`, `@`, and must not begin or end with `-`.
        :param pulumi.Input[builtins.str] type: The type of domain record. Valid values: `A`,`NS`,`MX`,`TXT`,`CNAME`,`SRV`,`AAAA`,`CAA`, `REDIRECT_URL` and `FORWORD_URL`.
        :param pulumi.Input[builtins.str] value: The value of domain record, When the `type` is `MX`,`NS`,`CNAME`,`SRV`, the server will treat the `value` as a fully qualified domain name, so it's no need to add a `.` at the end.
        :param pulumi.Input[builtins.str] lang: User language.
        :param pulumi.Input[builtins.str] line: The resolution line of domain record. When the `type` is `FORWORD_URL`, this parameter must be `default`. Default value is `default`. For checking all resolution lines enumeration please visit [Alibaba Cloud DNS doc](https://www.alibabacloud.com/help/en/alibaba-cloud-dns/latest/adding-a-dns-record) or using dns_get_resolution_lines in data source to get the value.
        :param pulumi.Input[builtins.int] priority: The priority of domain record. Valid values: `[1-10]`. When the `type` is `MX`, this parameter is required.
        :param pulumi.Input[builtins.str] remark: The remark of the domain record.
        :param pulumi.Input[builtins.str] status: The status of the domain record. Valid values: `ENABLE`,`DISABLE`.
        :param pulumi.Input[builtins.int] ttl: The effective time of domain record. Its scope depends on the edition of the cloud resolution. Free is `[600, 86400]`, Basic is `[120, 86400]`, Standard is `[60, 86400]`, Ultimate is `[10, 86400]`, Exclusive is `[1, 86400]`. Default value is `600`.
    ...
    @property
    @pulumi.getter
    def rr(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @rr.setter
    def rr(self, value: pulumi.Input[builtins.str]):
...
class _AlidnsRecordState:
    def __init__(__self__, *,
                 ...
                 priority: Optional[pulumi.Input[builtins.int]] = None,
                 remark: Optional[pulumi.Input[builtins.str]] = None,
                 rr: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 ttl: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter
    def rr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Host record for the domain record. This host_record can have at most 253 characters, and each part split with `.` can have at most 63 characters, and must contain only alphanumeric characters or hyphens, such as `-`, `.`, `*`, `@`, and must not begin or end with `-`.
        """
        return pulumi.get(self, "rr")
    ...
    @rr.setter
    def rr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rr", value)
...
@pulumi.type_token("alicloud:dns/alidnsRecord:AlidnsRecord")
class AlidnsRecord(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            user_client_ip: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'AlidnsRecord':
        """
    ...
    @property
    @pulumi.getter
    def rr(self) -> pulumi.Output[builtins.str]:
        """
        Host record for the domain record. This host_record can have at most 253 characters, and each part split with `.` can have at most 63 characters, and must contain only alphanumeric characters or hyphens, such as `-`, `.`, `*`, `@`, and must not begin or end with `-`.
        """
        return pulumi.get(self, "rr")
