...
class GetAlidnsInstancesResult:
    ...
    def user_client_ip(self) -> Optional[builtins.str]:
...
def get_alidns_instances(domain_type: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_type: The type of domain.
    :param Sequence[builtins.str] ids: A list of instance IDs.
    :param builtins.str lang: Language.
...
def get_alidns_instances_output(domain_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                user_client_ip: Optional[pulumi.Input[Optional[builtins.str]]] = None,
