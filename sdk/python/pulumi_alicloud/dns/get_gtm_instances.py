...
def get_gtm_instances(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Gtm Instance IDs.
...
def get_gtm_instances_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
