...
class GetGtmInstancesResult:
    ...
    def output_file(self) -> _builtins.str:
...
def get_gtm_instances(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Gtm Instance IDs.
