...
class GetRecordsResult:
    ...
    def host_record_regex(self) -> Optional[builtins.str]:
...
def get_records(domain_name: Optional[builtins.str] = None,
                host_record_regex: Optional[builtins.str] = None,
    ...
    :param builtins.str host_record_regex: Host record regex.
    :param Sequence[builtins.str] ids: A list of record IDs.
    :param builtins.bool is_locked: Whether the record is locked or not.
...
def get_records_output(domain_name: Optional[pulumi.Input[builtins.str]] = None,
                       host_record_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                       is_locked: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
