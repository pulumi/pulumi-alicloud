...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dns_security: DNS security level. Valid values: `no`, `basic`, `advanced`.
...
class Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            renewal_status: Optional[pulumi.Input[builtins.str]] = None,
            version_code: Optional[pulumi.Input[builtins.str]] = None,
            version_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Instance':
        """
