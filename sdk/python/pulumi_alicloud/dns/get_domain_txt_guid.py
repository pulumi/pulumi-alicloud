...
def get_domain_txt_guid(domain_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain_name: Verified domain name.
    :param _builtins.str lang: User language.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str type: Txt verification function. Value:`ADD_SUB_DOMAIN`, `RETRIEVAL`.
    """
    __args__ = dict()
