...
def get_domain_txt_guid(domain_name: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_name: Verified domain name.
    ...
    :param builtins.str type: Txt verification function. Value:`ADD_SUB_DOMAIN`, `RETRIEVAL`.
    """
    __args__ = dict()
...
def get_domain_txt_guid_output(domain_name: Optional[pulumi.Input[builtins.str]] = None,
