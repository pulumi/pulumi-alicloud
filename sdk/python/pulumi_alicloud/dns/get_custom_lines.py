...
def get_custom_lines(domain_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Custom Line IDs.
    :param builtins.str lang: The lang.
    :param builtins.str name_regex: A regex string to filter results by Custom Line name.
...
def get_custom_lines_output(domain_name: Optional[pulumi.Input[builtins.str]] = None,
