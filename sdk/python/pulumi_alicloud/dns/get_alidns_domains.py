...
def get_alidns_domains(ali_domain: Optional[builtins.bool] = None,
...
def get_alidns_domains_output(ali_domain: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
