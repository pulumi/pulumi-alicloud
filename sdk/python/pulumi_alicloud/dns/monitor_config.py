...
class MonitorConfigArgs:
    def __init__(__self__, *,
                 ...
                 monitor_extend_info: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] addr_pool_id: The ID of the address pool.
        :param pulumi.Input[builtins.int] evaluation_count: The number of consecutive times of failed health check attempts. Valid values: `1`, `2`, `3`.
        :param pulumi.Input[builtins.int] interval: The health check interval. Unit: seconds. Valid values: `60`.
        ...
        :param pulumi.Input[builtins.str] monitor_extend_info: The extended information. This value follows the json format. For more details, see the [description of MonitorExtendInfo in the Request parameters table for details](https://www.alibabacloud.com/help/en/alibaba-cloud-dns/latest/api-alidns-2015-01-09-adddnsgtmmonitor).
        :param pulumi.Input[builtins.str] protocol_type: The health check protocol. Valid values: `HTTP`, `HTTPS`, `PING`, `TCP`.
        :param pulumi.Input[builtins.int] timeout: The timeout period. Unit: milliseconds. Valid values: `2000`, `3000`, `5000`, `10000`.
        :param pulumi.Input[builtins.str] lang: The lang.
        """
    ...
    def monitor_extend_info(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def monitor_extend_info(self, value: pulumi.Input[builtins.str]):
...
class _MonitorConfigState:
    def __init__(__self__, *,
                 ...
                 lang: Optional[pulumi.Input[builtins.str]] = None,
                 monitor_extend_info: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="monitorExtendInfo")
    def monitor_extend_info(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The extended information. This value follows the json format. For more details, see the [description of MonitorExtendInfo in the Request parameters table for details](https://www.alibabacloud.com/help/en/alibaba-cloud-dns/latest/api-alidns-2015-01-09-adddnsgtmmonitor).
        """
        return pulumi.get(self, "monitor_extend_info")
    ...
    @monitor_extend_info.setter
    def monitor_extend_info(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "monitor_extend_info", value)
...
class MonitorConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            monitor_extend_info: Optional[pulumi.Input[builtins.str]] = None,
            protocol_type: Optional[pulumi.Input[builtins.str]] = None,
            timeout: Optional[pulumi.Input[builtins.int]] = None) -> 'MonitorConfig':
        """
    ...
    @property
    @pulumi.getter(name="addrPoolId")
    def addr_pool_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the address pool.
        """
        return pulumi.get(self, "addr_pool_id")
    ...
    @property
    @pulumi.getter(name="monitorExtendInfo")
    def monitor_extend_info(self) -> pulumi.Output[builtins.str]:
        """
        The extended information. This value follows the json format. For more details, see the [description of MonitorExtendInfo in the Request parameters table for details](https://www.alibabacloud.com/help/en/alibaba-cloud-dns/latest/api-alidns-2015-01-09-adddnsgtmmonitor).
        """
        return pulumi.get(self, "monitor_extend_info")
