...
class DiAlarmRuleNotificationSettings(dict):
    ...
    def __init__(__self__, *,
                 inhibition_interval: Optional[builtins.int] = None,
        ...
        """
        :param builtins.int inhibition_interval: Alarm suppression interval, in minutes
    ...
    def inhibition_interval(self) -> Optional[builtins.int]:
        """
...
class DiAlarmRuleNotificationSettingsNotificationChannel(dict):
    def __init__(__self__, *,
                 channels: Optional[Sequence[builtins.str]] = None,
                 severity: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] channels: Channel, optional enumeration value:
...
class DiAlarmRuleNotificationSettingsNotificationReceiver(dict):
    ...
    def __init__(__self__, *,
                 ...
                 receiver_values: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str receiver_type: The type of the receiver. Valid values: AliyunUid/DingToken/FeishuToken/WebHookUrl.
        :param Sequence[builtins.str] receiver_values: Receiver Value List
        """
    ...
    def receiver_values(self) -> Optional[Sequence[builtins.str]]:
        """
        Receiver Value List
        """
...
class DiAlarmRuleTriggerCondition(dict):
    ...
    def __init__(__self__, *,
                 ddl_report_tags: Optional[Sequence[builtins.str]] = None,
                 duration: Optional[builtins.int] = None,
                 severity: Optional[builtins.str] = None,
                 threshold: Optional[builtins.int] = None):
        """
        :param Sequence[builtins.str] ddl_report_tags: It takes effect only when the DDL notification is issued. The list of effective DDLs is required.
        :param builtins.int duration: Alarm calculation time interval, unit minute
        :param builtins.str severity: Severity, optional enumeration value:
               
               Warning
               
               Critical
        :param builtins.int threshold: Alarm threshold.
    ...
    def ddl_report_tags(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DiJobDestinationDataSourceSetting(dict):
    ...
    def __init__(__self__, *,
                 data_source_name: Optional[builtins.str] = None):
        """
        :param builtins.str data_source_name: Destination data source name
        """
...
class DiJobJobSettings(dict):
    ...
    def __init__(__self__, *,
                 channel_settings: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str channel_settings: Channel-related task settings, in the form of a Json String.
    ...
    def channel_settings(self) -> Optional[builtins.str]:
        """
...
class DiJobJobSettingsColumnDataTypeSetting(dict):
    ...
    def __init__(__self__, *,
                 destination_data_type: Optional[builtins.str] = None,
                 source_data_type: Optional[builtins.str] = None):
        """
        :param builtins.str destination_data_type: The destination type of the mapping relationship
        :param builtins.str source_data_type: The source type of the mapping type
        """
    ...
    def destination_data_type(self) -> Optional[builtins.str]:
        """
    ...
    def source_data_type(self) -> Optional[builtins.str]:
        """
...
class DiJobJobSettingsCycleScheduleSettings(dict):
    ...
    def __init__(__self__, *,
                 cycle_migration_type: Optional[builtins.str] = None,
                 schedule_parameters: Optional[builtins.str] = None):
        """
        :param builtins.str cycle_migration_type: The type of synchronization that requires periodic scheduling. Value range:
               
               Full: Full
               
               OfflineIncremental: offline increment
        :param builtins.str schedule_parameters: Scheduling Parameters
        """
    ...
    def cycle_migration_type(self) -> Optional[builtins.str]:
        """
    ...
    def schedule_parameters(self) -> Optional[builtins.str]:
        """
...
class DiJobJobSettingsDdlHandlingSetting(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: DDL type, optional enumeration value:
...
class DiJobJobSettingsRuntimeSetting(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Set name, optional ENUM value:
        ...
        :param builtins.str value: Runtime setting value
        """
        if name is not None:
...
class DiJobResourceSettingsOfflineResourceSettings(dict):
    ...
    def __init__(__self__, *,
                 requested_cu: Optional[builtins.float] = None,
                 resource_group_identifier: Optional[builtins.str] = None):
        """
        :param builtins.float requested_cu: Scheduling resource group cu
        :param builtins.str resource_group_identifier: Scheduling resource group name
        """
    ...
    def requested_cu(self) -> Optional[builtins.float]:
        """
    ...
    def resource_group_identifier(self) -> Optional[builtins.str]:
        """
...
class DiJobSourceDataSourceSetting(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str data_source_name: Data source name of a single source
...
class DiJobSourceDataSourceSettingDataSourceProperties(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str encoding: Data Source Encoding
        :param builtins.str timezone: Data Source Time Zone
        """
...
class DiJobTableMappingSourceObjectSelectionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 expression_type: Optional[builtins.str] = None,
                 object_type: Optional[builtins.str] = None):
        """
        :param builtins.str expression: Expression, such as mysql_table_1
        :param builtins.str expression_type: Expression type, value range: Exact/Regex
        :param builtins.str object_type: Object type, optional enumeration value:
    ...
    def expression_type(self) -> Optional[builtins.str]:
        """
...
class DiJobTableMappingTransformationRule(dict):
    ...
    def __init__(__self__, *,
                 rule_action_type: Optional[builtins.str] = None,
                 rule_name: Optional[builtins.str] = None,
                 rule_target_type: Optional[builtins.str] = None):
        """
        :param builtins.str rule_action_type: Action type, optional enumeration value:
        ...
        :param builtins.str rule_target_type: Target type of action, optional enumeration value:
    ...
    def rule_action_type(self) -> Optional[builtins.str]:
        """
    ...
    def rule_target_type(self) -> Optional[builtins.str]:
        """
...
class DiJobTransformationRule(dict):
    ...
    def __init__(__self__, *,
                 rule_action_type: Optional[builtins.str] = None,
                 rule_expression: Optional[builtins.str] = None,
                 rule_name: Optional[builtins.str] = None,
                 rule_target_type: Optional[builtins.str] = None):
        """
        :param builtins.str rule_action_type: Action type, optional enumeration value:
               ...
               DefineIncrementalCondition
        :param builtins.str rule_expression: Regular expression, in json string format.
    ...
    def rule_expression(self) -> Optional[builtins.str]:
        """
...
class ProjectMemberRole(dict):
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str code: Project Role Code.
        :param builtins.str name: project role name
        :param builtins.str type: project role type
        """
        if code is not None:
...
class GetFoldersFolderResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str folder_path: Folder Path.
        :param builtins.str id: The Folder ID.
