...
class NetworkArgs:
    def __init__(__self__, *,
                 dw_resource_group_id: pulumi.Input[builtins.str],
                 vpc_id: pulumi.Input[builtins.str],
                 vswitch_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a Network resource.
        :param pulumi.Input[builtins.str] dw_resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] vpc_id: Virtual Private Cloud ID of network resources
        :param pulumi.Input[builtins.str] vswitch_id: The vSwitch ID of the network resource.
        """
    ...
    def dw_resource_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dw_resource_group_id(self, value: pulumi.Input[builtins.str]):
...
class _NetworkState:
    def __init__(__self__, *,
                 ...
                 dw_resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_id: Optional[pulumi.Input[builtins.str]] = None,
                 vswitch_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Network resources.
        :param pulumi.Input[builtins.int] create_time: Time when the network resource was created
        :param pulumi.Input[builtins.str] dw_resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] status: Network Resource Status
        :param pulumi.Input[builtins.str] vpc_id: Virtual Private Cloud ID of network resources
        :param pulumi.Input[builtins.str] vswitch_id: The vSwitch ID of the network resource.
        """
    ...
    @property
    @pulumi.getter(name="dwResourceGroupId")
    def dw_resource_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the resource group.
        """
        return pulumi.get(self, "dw_resource_group_id")
    ...
    @dw_resource_group_id.setter
    def dw_resource_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dw_resource_group_id", value)
...
class Network(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Network':
        """
    ...
    @property
    @pulumi.getter(name="dwResourceGroupId")
    def dw_resource_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the resource group.
        """
        return pulumi.get(self, "dw_resource_group_id")
