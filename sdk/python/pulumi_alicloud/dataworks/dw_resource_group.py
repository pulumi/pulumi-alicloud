...
class DwResourceGroupArgs:
    def __init__(__self__, *,
                 default_vpc_id: pulumi.Input[builtins.str],
                 default_vswitch_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] default_vpc_id: The VPC ID of the default network resource.
        :param pulumi.Input[builtins.str] default_vswitch_id: The ID of the vswitch bound to the network resource by default.
        :param pulumi.Input[builtins.str] remark: Resource Group Comments
        :param pulumi.Input[builtins.bool] auto_renew: Whether to automatically renew. The default value is false.
        :param pulumi.Input[builtins.int] payment_duration: When the payment method is Prepaid, the unit is PaymentDurationUnit.
        :param pulumi.Input[builtins.str] payment_duration_unit: When the payment method is Prepaid, the payment duration unit, Month is Month, Year is Year, and there is no other optional value.
        :param pulumi.Input[builtins.str] payment_type: The billing type of the resource group. PrePaid is Subscription, and PostPaid is Pay-As-You-Go.
        ...
        :param pulumi.Input[builtins.int] specification: Package year and package month resource group specifications, unit CU
    ...
    def default_vpc_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def default_vpc_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "default_vpc_id", value)

    @property
    @pulumi.getter(name="defaultVswitchId")
    def default_vswitch_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def default_vswitch_id(self, value: pulumi.Input[builtins.str]):
...
class _DwResourceGroupState:
    def __init__(__self__, *,
                 ...
                 default_vpc_id: Optional[pulumi.Input[builtins.str]] = None,
                 default_vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
                 payment_duration: Optional[pulumi.Input[builtins.int]] = None,
                 payment_duration_unit: Optional[pulumi.Input[builtins.str]] = None,
                 payment_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] auto_renew: Whether to automatically renew. The default value is false.
        :param pulumi.Input[builtins.int] create_time: Resource group creation time
        :param pulumi.Input[builtins.str] default_vpc_id: The VPC ID of the default network resource.
        :param pulumi.Input[builtins.str] default_vswitch_id: The ID of the vswitch bound to the network resource by default.
        :param pulumi.Input[builtins.int] payment_duration: When the payment method is Prepaid, the unit is PaymentDurationUnit.
        :param pulumi.Input[builtins.str] payment_duration_unit: When the payment method is Prepaid, the payment duration unit, Month is Month, Year is Year, and there is no other optional value.
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Resource group name
        :param pulumi.Input[builtins.int] specification: Package year and package month resource group specifications, unit CU
        :param pulumi.Input[builtins.str] status: Resource group status:
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the resource
        """
        if auto_renew is not None:
            pulumi.set(__self__, "auto_renew", auto_renew)
    ...
    @property
    @pulumi.getter(name="defaultVpcId")
    def default_vpc_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The VPC ID of the default network resource.
        """
        return pulumi.get(self, "default_vpc_id")
    ...
    @default_vpc_id.setter
    def default_vpc_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_vpc_id", value)

    @property
    @pulumi.getter(name="defaultVswitchId")
    def default_vswitch_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the vswitch bound to the network resource by default.
        """
        return pulumi.get(self, "default_vswitch_id")
    ...
    @default_vswitch_id.setter
    def default_vswitch_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_vswitch_id", value)
...
class DwResourceGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            specification: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'DwResourceGroup':
        """
    ...
    @property
    @pulumi.getter(name="defaultVpcId")
    def default_vpc_id(self) -> pulumi.Output[builtins.str]:
        """
        The VPC ID of the default network resource.
        """
        return pulumi.get(self, "default_vpc_id")
    ...
    @property
    @pulumi.getter(name="defaultVswitchId")
    def default_vswitch_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the vswitch bound to the network resource by default.
        """
        return pulumi.get(self, "default_vswitch_id")
