...
class DiAlarmRuleArgs:
    def __init__(__self__, *,
                 di_alarm_rule_name: pulumi.Input[builtins.str],
                 di_job_id: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.str] di_alarm_rule_name: Data Integration alarm rule name
        :param pulumi.Input[builtins.int] di_job_id: Task ID: the ID of the task associated with the alert rule.
        :param pulumi.Input[builtins.str] metric_type: Alarm indicator type. Optional enumerated values:
    ...
    def di_alarm_rule_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def di_alarm_rule_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "di_alarm_rule_name", value)

    @property
    @pulumi.getter(name="diJobId")
    def di_job_id(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @di_job_id.setter
    def di_job_id(self, value: pulumi.Input[builtins.int]):
...
class _DiAlarmRuleState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 di_alarm_rule_id: Optional[pulumi.Input[builtins.int]] = None,
                 di_alarm_rule_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] di_alarm_rule_id: Resource attribute field representing resource level ID
        :param pulumi.Input[builtins.str] di_alarm_rule_name: Data Integration alarm rule name
        :param pulumi.Input[builtins.int] di_job_id: Task ID: the ID of the task associated with the alert rule.
        :param pulumi.Input[builtins.str] metric_type: Alarm indicator type. Optional enumerated values:
               - Heartbeat (task status alarm)
    ...
    def di_alarm_rule_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def di_alarm_rule_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "di_alarm_rule_id", value)

    @property
    @pulumi.getter(name="diAlarmRuleName")
    def di_alarm_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Data Integration alarm rule name
        """
        return pulumi.get(self, "di_alarm_rule_name")
    ...
    @di_alarm_rule_name.setter
    def di_alarm_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "di_alarm_rule_name", value)
...
class DiAlarmRule(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="diAlarmRuleId")
    def di_alarm_rule_id(self) -> pulumi.Output[builtins.int]:
        """
        Resource attribute field representing resource level ID
        """
        return pulumi.get(self, "di_alarm_rule_id")
    ...
    @property
    @pulumi.getter(name="diAlarmRuleName")
    def di_alarm_rule_name(self) -> pulumi.Output[builtins.str]:
        """
        Data Integration alarm rule name
        """
        return pulumi.get(self, "di_alarm_rule_name")
