...
class DiJobArgs:
    def __init__(__self__, *,
                 ...
                 destination_data_source_type: pulumi.Input[builtins.str],
                 job_name: pulumi.Input[builtins.str],
                 migration_type: pulumi.Input[builtins.str],
                 ...
                 source_data_source_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] destination_data_source_type: The type of the target data source. Enumerated values: Hologres and Hive.
        :param pulumi.Input[builtins.str] job_name: Task Name.
        :param pulumi.Input[builtins.str] migration_type: Synchronization type, optional enumeration values are:
        ...
        :param pulumi.Input[builtins.str] source_data_source_type: The type of the source data source. The enumerated value is MySQL.
        ...
        :param pulumi.Input[builtins.str] description: Description of the integration task
    ...
    def destination_data_source_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destination_data_source_type(self, value: pulumi.Input[builtins.str]):
    ...
    def migration_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def migration_type(self, value: pulumi.Input[builtins.str]):
    ...
    def source_data_source_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_data_source_type(self, value: pulumi.Input[builtins.str]):
...
class _DiJobState:
    def __init__(__self__, *,
                 ...
                 destination_data_source_type: Optional[pulumi.Input[builtins.str]] = None,
                 di_job_id: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 source_data_source_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DiJobDestinationDataSourceSettingArgs']]] destination_data_source_settings: Destination data source See `destination_data_source_settings` below.
        :param pulumi.Input[builtins.str] destination_data_source_type: The type of the target data source. Enumerated values: Hologres and Hive.
        :param pulumi.Input[builtins.int] di_job_id: Integration Task Id
        :param pulumi.Input[builtins.str] job_name: Task Name.
        :param pulumi.Input['DiJobJobSettingsArgs'] job_settings: The dimension settings of the synchronization task, including the DDL processing policy, the source and destination column data type mapping policy, and the task runtime parameters. See `job_settings` below.
        :param pulumi.Input[builtins.str] migration_type: Synchronization type, optional enumeration values are:
    ...
    @property
    @pulumi.getter(name="destinationDataSourceType")
    def destination_data_source_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the target data source. Enumerated values: Hologres and Hive.
        """
        return pulumi.get(self, "destination_data_source_type")
    ...
    @destination_data_source_type.setter
    def destination_data_source_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_data_source_type", value)

    @property
    @pulumi.getter(name="diJobId")
    def di_job_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Integration Task Id
        """
    ...
    @di_job_id.setter
    def di_job_id(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter(name="sourceDataSourceType")
    def source_data_source_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the source data source. The enumerated value is MySQL.
        """
        return pulumi.get(self, "source_data_source_type")
    ...
    @source_data_source_type.setter
    def source_data_source_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_data_source_type", value)
...
class DiJob(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="destinationDataSourceType")
    def destination_data_source_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the target data source. Enumerated values: Hologres and Hive.
        """
        return pulumi.get(self, "destination_data_source_type")
    ...
    @property
    @pulumi.getter(name="diJobId")
    def di_job_id(self) -> pulumi.Output[builtins.int]:
        """
        Integration Task Id
        """
        return pulumi.get(self, "di_job_id")
    ...
    @property
    @pulumi.getter(name="migrationType")
    def migration_type(self) -> pulumi.Output[builtins.str]:
        """
        Synchronization type, optional enumeration values are:
    ...
    @property
    @pulumi.getter(name="sourceDataSourceType")
    def source_data_source_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the source data source. The enumerated value is MySQL.
        """
        return pulumi.get(self, "source_data_source_type")
