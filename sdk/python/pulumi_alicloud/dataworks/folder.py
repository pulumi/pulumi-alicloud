...
class FolderArgs:
    def __init__(__self__, *,
                 folder_path: pulumi.Input[builtins.str],
                 project_id: Optional[pulumi.Input[builtins.str]] = None,
                 project_identifier: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Folder resource.
        :param pulumi.Input[builtins.str] folder_path: Folder Path. The folder path composed with for part: `Business Flow/{Business Flow Name}/[folderDi|folderMaxCompute|folderGeneral|folderJdbc|folderUserDefined]/{Directory Name}`. The first segment of path must be `Business Flow`, and sencond segment of path must be a Business Flow Name within the project. The third part of path must be one of those keywords:`folderDi|folderMaxCompute|folderGeneral|folderJdbc|folderUserDefined`. Then the finial part of folder path can be specified in yourself.
    ...
    def folder_path(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @folder_path.setter
    def folder_path(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("alicloud:dataworks/folder:Folder")
class Folder(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            folder_path: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            project_identifier: Optional[pulumi.Input[builtins.str]] = None) -> 'Folder':
        """
    ...
    @property
    @pulumi.getter(name="projectIdentifier")
    def project_identifier(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "project_identifier")
