...
class DataSourceSharedRuleArgs:
    def __init__(__self__, *,
                 data_source_id: pulumi.Input[builtins.int],
                 env_type: pulumi.Input[builtins.str],
                 target_project_id: pulumi.Input[builtins.int],
                 shared_user: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DataSourceSharedRule resource.
        :param pulumi.Input[builtins.int] data_source_id: The ID of the data source, that is, the unique identifier of the data source.
        :param pulumi.Input[builtins.str] env_type: The environment type of the data source shared to the target project, such as Dev (Development Environment) and Prod (production environment).
        :param pulumi.Input[builtins.int] target_project_id: The ID of the project to which the data source is shared.
        :param pulumi.Input[builtins.str] shared_user: The target user of the data source permission policy, which is null to share to the project.
        """
    ...
    def data_source_id(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def data_source_id(self, value: pulumi.Input[builtins.int]):
    ...
    def target_project_id(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def target_project_id(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "target_project_id", value)

    @property
    @pulumi.getter(name="sharedUser")
    def shared_user(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @shared_user.setter
    def shared_user(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DataSourceSharedRuleState:
    def __init__(__self__, *,
                 ...
                 data_source_shared_rule_id: Optional[pulumi.Input[builtins.str]] = None,
                 env_type: Optional[pulumi.Input[builtins.str]] = None,
                 shared_user: Optional[pulumi.Input[builtins.str]] = None,
                 target_project_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        Input properties used for looking up and filtering DataSourceSharedRule resources.
        :param pulumi.Input[builtins.int] create_time: The creation time of the data source sharing rule.
        :param pulumi.Input[builtins.int] data_source_id: The ID of the data source, that is, the unique identifier of the data source.
        :param pulumi.Input[builtins.str] data_source_shared_rule_id: The data source sharing rule ID, that is, the unique identifier of the data source sharing rule.
        :param pulumi.Input[builtins.str] env_type: The environment type of the data source shared to the target project, such as Dev (Development Environment) and Prod (production environment).
        :param pulumi.Input[builtins.str] shared_user: The target user of the data source permission policy, which is null to share to the project.
        :param pulumi.Input[builtins.int] target_project_id: The ID of the project to which the data source is shared.
        """
    ...
    def data_source_shared_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_source_shared_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="targetProjectId")
    def target_project_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The ID of the project to which the data source is shared.
        """
        return pulumi.get(self, "target_project_id")
    ...
    @target_project_id.setter
    def target_project_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "target_project_id", value)
...
class DataSourceSharedRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            env_type: Optional[pulumi.Input[builtins.str]] = None,
            shared_user: Optional[pulumi.Input[builtins.str]] = None,
            target_project_id: Optional[pulumi.Input[builtins.int]] = None) -> 'DataSourceSharedRule':
        """
    ...
    @property
    @pulumi.getter(name="dataSourceSharedRuleId")
    def data_source_shared_rule_id(self) -> pulumi.Output[builtins.str]:
        """
        The data source sharing rule ID, that is, the unique identifier of the data source sharing rule.
        """
        return pulumi.get(self, "data_source_shared_rule_id")
    ...
    @property
    @pulumi.getter(name="sharedUser")
    def shared_user(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The target user of the data source permission policy, which is null to share to the project.
        """
        return pulumi.get(self, "shared_user")
    ...
    @property
    @pulumi.getter(name="targetProjectId")
    def target_project_id(self) -> pulumi.Output[builtins.int]:
        """
        The ID of the project to which the data source is shared.
        """
        return pulumi.get(self, "target_project_id")
