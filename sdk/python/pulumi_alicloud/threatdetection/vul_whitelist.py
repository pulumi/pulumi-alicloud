...
class VulWhitelistArgs:
    def __init__(__self__, *,
                 whitelist: pulumi.Input[builtins.str],
                 reason: Optional[pulumi.Input[builtins.str]] = None,
                 target_info: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a VulWhitelist resource.
        :param pulumi.Input[builtins.str] whitelist: Information about the vulnerability to be added to the whitelist. see [how to use it](https://www.alibabacloud.com/help/en/security-center/developer-reference/api-sas-2018-12-03-modifycreatevulwhitelist).
        :param pulumi.Input[builtins.str] reason: Reason for adding whitelist.
        :param pulumi.Input[builtins.str] target_info: Set the effective range of the whitelist. see [how to use it](https://www.alibabacloud.com/help/en/security-center/developer-reference/api-sas-2018-12-03-modifycreatevulwhitelist).
        """
    ...
    @property
    @pulumi.getter
    def whitelist(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @whitelist.setter
    def whitelist(self, value: pulumi.Input[builtins.str]):
    ...
    def target_info(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @target_info.setter
    def target_info(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VulWhitelist(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reason: Optional[pulumi.Input[builtins.str]] = None,
            target_info: Optional[pulumi.Input[builtins.str]] = None,
            whitelist: Optional[pulumi.Input[builtins.str]] = None) -> 'VulWhitelist':
        """
    ...
    @property
    @pulumi.getter(name="targetInfo")
    def target_info(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Set the effective range of the whitelist. see [how to use it](https://www.alibabacloud.com/help/en/security-center/developer-reference/api-sas-2018-12-03-modifycreatevulwhitelist).
        """
        return pulumi.get(self, "target_info")
