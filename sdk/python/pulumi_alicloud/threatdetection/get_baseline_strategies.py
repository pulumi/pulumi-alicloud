...
class GetBaselineStrategiesResult:
    ...
    def custom_type(self) -> Optional[builtins.str]:
        """
    ...
    def strategy_ids(self) -> Optional[builtins.str]:
...
def get_baseline_strategies(custom_type: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Baseline Strategy IDs.
...
def get_baseline_strategies_output(custom_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                   ...
                                   strategy_ids: Optional[pulumi.Input[Optional[builtins.str]]] = None,
