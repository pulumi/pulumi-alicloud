...
class AssetBindArgs:
    def __init__(__self__, *,
                 auth_version: Optional[pulumi.Input[builtins.int]] = None,
                 uuid: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a AssetBind resource.
        :param pulumi.Input[builtins.int] auth_version: Bind version.
        :param pulumi.Input[builtins.str] uuid: The first ID of the resource
        """
    ...
    def auth_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Bind version.
        """
    ...
    @auth_version.setter
    def auth_version(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AssetBind(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            auth_version: Optional[pulumi.Input[builtins.int]] = None,
            uuid: Optional[pulumi.Input[builtins.str]] = None) -> 'AssetBind':
        """
    ...
    @property
    @pulumi.getter(name="authVersion")
    def auth_version(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Bind version.
        """
        return pulumi.get(self, "auth_version")
