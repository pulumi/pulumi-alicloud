...
class GetAssetsResult:
    ...
    @property
    @pulumi.getter
    def importance(self) -> Optional[builtins.int]:
        return pulumi.get(self, "importance")

    @property
    @pulumi.getter(name="logicalExp")
    def logical_exp(self) -> Optional[builtins.str]:
        return pulumi.get(self, "logical_exp")

    @property
    @pulumi.getter(name="machineTypes")
    def machine_types(self) -> Optional[builtins.str]:
        return pulumi.get(self, "machine_types")

    @property
    @pulumi.getter(name="noGroupTrace")
    def no_group_trace(self) -> Optional[builtins.bool]:
...
def get_assets(criteria: Optional[builtins.str] = None,
               ids: Optional[Sequence[builtins.str]] = None,
               importance: Optional[builtins.int] = None,
               logical_exp: Optional[builtins.str] = None,
               machine_types: Optional[builtins.str] = None,
               no_group_trace: Optional[builtins.bool] = None,
    ...
    :param builtins.str criteria: Set the conditions for searching assets. This parameter is in JSON format. Note the case when you enter the parameter. **NOTE:** You can search for assets by using conditions such as the instance ID, instance name, VPC ID, region, and public IP address of the asset.
    :param Sequence[builtins.str] ids: A list of Asset IDs.
    :param builtins.int importance: Set asset importance. Value:
           - **2**: Significant assets
           - **1**: General assets
           - **0**: Test asset
    :param builtins.str logical_exp: Set the logical relationship between multiple search conditions. The default value is **OR**. Valid values:
    ...
    :param builtins.str machine_types: The type of asset to query. Value:
           - **ecs**: server.
           - **cloud_product**: Cloud product.
    :param builtins.bool no_group_trace: Specifies whether to internationalize the name of the default group. Default value: false
...
def get_assets_output(criteria: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                      importance: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                      logical_exp: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      machine_types: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      no_group_trace: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
