...
class CheckConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] vendors: The cloud service providers.
...
class CheckConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 enable_auto_check: pulumi.Input[Optional[_builtins.bool]] = None,
                 end_time: pulumi.Input[Optional[_builtins.int]] = None,
                 selected_checks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CheckConfigSelectedCheckArgs', 'CheckConfigSelectedCheckArgsDict', 'outputs.CheckConfigSelectedCheck']]]]] = None,
                 start_time: pulumi.Input[Optional[_builtins.int]] = None,
                 system_config: pulumi.Input[Optional[_builtins.bool]] = None,
                 vendors: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[_builtins.int] end_time: Check the end time of the time period, which indicates the time of day. The start time and end time of the query can only be selected in the following time range.
               ...
               - **12~18** When the start time is 12, the end time needs to be set to 18 o'clock on the current day.
               - **18~24** When the start time is 18, the end time needs to be set to 24 hours of the current day.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CheckConfigSelectedCheckArgs', 'CheckConfigSelectedCheckArgsDict', 'outputs.CheckConfigSelectedCheck']]]] selected_checks: The check items selected in the policy. See `selected_checks` below.
        :param pulumi.Input[_builtins.int] start_time: The start time of the check. The value specifies a point in time in a day.
        :param pulumi.Input[_builtins.bool] system_config: Specifies whether to use the configuration automatically generated by the system. Valid values:
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] vendors: The cloud service providers.
