...
class BackupPolicyArgs:
    def __init__(__self__, *,
                 ...
                 policy_version: pulumi.Input[builtins.str],
                 uuid_lists: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 policy_region_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a BackupPolicy resource.
        :param pulumi.Input[builtins.str] backup_policy_name: Protection of the Name of the Policy.
        :param pulumi.Input[builtins.str] policy: The Specified Protection Policies of the Specific Configuration. see [how to use it](https://www.alibabacloud.com/help/en/security-center/developer-reference/api-sas-2018-12-03-createbackuppolicy).
        :param pulumi.Input[builtins.str] policy_version: Anti-Blackmail Policy Version. Valid values: `1.0.0`, `2.0.0`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] uuid_lists: Specify the Protection of Server UUID List.
        :param pulumi.Input[builtins.str] policy_region_id: The region ID of the non-Alibaba cloud server. You can call the [DescribeSupportRegion](https://www.alibabacloud.com/help/en/security-center/developer-reference/api-sas-2018-12-03-describesupportregion) interface to view the region supported by anti-ransomware, and then select the region supported by anti-ransomware according to the region where your non-Alibaba cloud server is located.
        """
    ...
    def policy_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def policy_version(self, value: pulumi.Input[builtins.str]):
    ...
    def policy_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def policy_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BackupPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_region_id: The region ID of the non-Alibaba cloud server. You can call the [DescribeSupportRegion](https://www.alibabacloud.com/help/en/security-center/developer-reference/api-sas-2018-12-03-describesupportregion) interface to view the region supported by anti-ransomware, and then select the region supported by anti-ransomware according to the region where your non-Alibaba cloud server is located.
        :param pulumi.Input[builtins.str] policy_version: Anti-Blackmail Policy Version. Valid values: `1.0.0`, `2.0.0`.
        :param pulumi.Input[builtins.str] status: The status of the Backup Policy instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] uuid_lists: Specify the Protection of Server UUID List.
        """
...
class BackupPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_version: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            uuid_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'BackupPolicy':
        """
    ...
    @property
    @pulumi.getter(name="backupPolicyName")
    def backup_policy_name(self) -> pulumi.Output[builtins.str]:
        """
        Protection of the Name of the Policy.
        """
        return pulumi.get(self, "backup_policy_name")
    ...
    @property
    @pulumi.getter(name="policyRegionId")
    def policy_region_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The region ID of the non-Alibaba cloud server. You can call the [DescribeSupportRegion](https://www.alibabacloud.com/help/en/security-center/developer-reference/api-sas-2018-12-03-describesupportregion) interface to view the region supported by anti-ransomware, and then select the region supported by anti-ransomware according to the region where your non-Alibaba cloud server is located.
        """
        return pulumi.get(self, "policy_region_id")
