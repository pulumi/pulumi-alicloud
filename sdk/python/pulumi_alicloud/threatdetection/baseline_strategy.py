...
class BaselineStrategyArgs:
    def __init__(__self__, *,
                 baseline_strategy_name: pulumi.Input[builtins.str],
                 custom_type: pulumi.Input[builtins.str],
                 cycle_days: pulumi.Input[builtins.int],
                 end_time: pulumi.Input[builtins.str],
                 risk_sub_type_name: pulumi.Input[builtins.str],
                 start_time: pulumi.Input[builtins.str],
                 target_type: pulumi.Input[builtins.str],
                 cycle_start_time: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a BaselineStrategy resource.
        :param pulumi.Input[builtins.str] baseline_strategy_name: Policy name.
        :param pulumi.Input[builtins.str] custom_type: The type of policy. Value:
               * **common**: standard policy
               * **custom**: custom policy
        :param pulumi.Input[builtins.int] cycle_days: The detection period of the policy.
        :param pulumi.Input[builtins.str] end_time: The baseline check policy execution end time.
        :param pulumi.Input[builtins.str] risk_sub_type_name: Detection item subtype.
        :param pulumi.Input[builtins.str] start_time: The baseline check policy start time.
        :param pulumi.Input[builtins.str] target_type: The method of adding assets that take effect from the policy. Value:
               * **groupId**: Added by asset group.
               * **uuid**: Add by single asset.
        :param pulumi.Input[builtins.int] cycle_start_time: The detection period of the policy. Value:
               * **0**: 0:00~06:00
               * **6**: 6:00~12:00
               * **12**: 12:00~18:00
               * **18**: 18:00~24:00
    ...
    def baseline_strategy_name(self) -> pulumi.Input[builtins.str]:
        """
        Policy name.
        """
    ...
    def baseline_strategy_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "baseline_strategy_name", value)

    @property
    @pulumi.getter(name="customType")
    def custom_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @custom_type.setter
    def custom_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "custom_type", value)

    @property
    @pulumi.getter(name="cycleDays")
    def cycle_days(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @cycle_days.setter
    def cycle_days(self, value: pulumi.Input[builtins.int]):
    ...
    def risk_sub_type_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def risk_sub_type_name(self, value: pulumi.Input[builtins.str]):
    ...
    def cycle_start_time(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cycle_start_time(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _BaselineStrategyState:
    def __init__(__self__, *,
                 baseline_strategy_id: Optional[pulumi.Input[builtins.str]] = None,
                 baseline_strategy_name: Optional[pulumi.Input[builtins.str]] = None,
                 custom_type: Optional[pulumi.Input[builtins.str]] = None,
                 cycle_days: Optional[pulumi.Input[builtins.int]] = None,
                 cycle_start_time: Optional[pulumi.Input[builtins.int]] = None,
                 end_time: Optional[pulumi.Input[builtins.str]] = None,
                 risk_sub_type_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] baseline_strategy_id: The ID of the baseline check policy.
        :param pulumi.Input[builtins.str] baseline_strategy_name: Policy name.
        :param pulumi.Input[builtins.str] custom_type: The type of policy. Value:
               * **common**: standard policy
               * **custom**: custom policy
    ...
    def baseline_strategy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def baseline_strategy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "baseline_strategy_id", value)

    @property
    @pulumi.getter(name="baselineStrategyName")
    def baseline_strategy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Policy name.
        """
        return pulumi.get(self, "baseline_strategy_name")
    ...
    @baseline_strategy_name.setter
    def baseline_strategy_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "baseline_strategy_name", value)

    @property
    @pulumi.getter(name="customType")
    def custom_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of policy. Value:
        * **common**: standard policy
        * **custom**: custom policy
    ...
    @custom_type.setter
    def custom_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_type", value)

    @property
    @pulumi.getter(name="cycleDays")
    def cycle_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The detection period of the policy.
        """
        return pulumi.get(self, "cycle_days")
    ...
    @cycle_days.setter
    def cycle_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cycle_days", value)
    ...
    @property
    @pulumi.getter(name="riskSubTypeName")
    def risk_sub_type_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Detection item subtype.
        """
        return pulumi.get(self, "risk_sub_type_name")
    ...
    @risk_sub_type_name.setter
    def risk_sub_type_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "risk_sub_type_name", value)
...
class BaselineStrategy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            risk_sub_type_name: Optional[pulumi.Input[builtins.str]] = None,
            start_time: Optional[pulumi.Input[builtins.str]] = None,
            target_type: Optional[pulumi.Input[builtins.str]] = None) -> 'BaselineStrategy':
        """
    ...
    @property
    @pulumi.getter(name="baselineStrategyId")
    def baseline_strategy_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the baseline check policy.
        """
        return pulumi.get(self, "baseline_strategy_id")
    ...
    @property
    @pulumi.getter(name="baselineStrategyName")
    def baseline_strategy_name(self) -> pulumi.Output[builtins.str]:
        """
        Policy name.
        """
        return pulumi.get(self, "baseline_strategy_name")
    ...
    @property
    @pulumi.getter(name="customType")
    def custom_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of policy. Value:
        * **common**: standard policy
        * **custom**: custom policy
    ...
    @property
    @pulumi.getter(name="cycleDays")
    def cycle_days(self) -> pulumi.Output[builtins.int]:
        """
        The detection period of the policy.
        """
        return pulumi.get(self, "cycle_days")
    ...
    @property
    @pulumi.getter(name="cycleStartTime")
    def cycle_start_time(self) -> pulumi.Output[builtins.int]:
        """
        The detection period of the policy. Value:
        * **0**: 0:00~06:00
        * **6**: 6:00~12:00
    ...
    @property
    @pulumi.getter(name="riskSubTypeName")
    def risk_sub_type_name(self) -> pulumi.Output[builtins.str]:
        """
        Detection item subtype.
        """
        return pulumi.get(self, "risk_sub_type_name")
