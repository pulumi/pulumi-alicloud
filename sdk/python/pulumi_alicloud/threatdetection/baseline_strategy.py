...
class BaselineStrategyArgs:
    def __init__(__self__, *,
                 baseline_strategy_name: pulumi.Input[_builtins.str],
                 custom_type: pulumi.Input[_builtins.str],
                 cycle_days: pulumi.Input[_builtins.int],
        ...
        :param pulumi.Input[_builtins.int] cycle_days: The detection period of the policy.
        :param pulumi.Input[_builtins.str] end_time: The baseline check policy execution end time.
        :param pulumi.Input[_builtins.str] risk_sub_type_name: Detection item subtype.
        :param pulumi.Input[_builtins.str] start_time: The baseline check policy start time.
        :param pulumi.Input[_builtins.str] target_type: The method of adding assets that take effect from the policy. Value:
               * **groupId**: Added by asset group.
               * **uuid**: Add by single asset.
        :param pulumi.Input[_builtins.int] cycle_start_time: The detection period of the policy. Value:
               * **0**: 0:00~06:00
               * **6**: 6:00~12:00
               * **12**: 12:00~18:00
               * **18**: 18:00~24:00
    ...
    def baseline_strategy_name(self) -> pulumi.Input[_builtins.str]:
        """
        Policy name.
        """
    ...
    def baseline_strategy_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "baseline_strategy_name", value)

    @_builtins.property
    @pulumi.getter(name="customType")
    def custom_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @custom_type.setter
    def custom_type(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "custom_type", value)

    @_builtins.property
    @pulumi.getter(name="cycleDays")
    def cycle_days(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @cycle_days.setter
    def cycle_days(self, value: pulumi.Input[_builtins.int]):
    ...
    def risk_sub_type_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def risk_sub_type_name(self, value: pulumi.Input[_builtins.str]):
...
class BaselineStrategy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="baselineStrategyId")
    def baseline_strategy_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the baseline check policy.
        """
        return pulumi.get(self, "baseline_strategy_id")
    ...
    @_builtins.property
    @pulumi.getter(name="baselineStrategyName")
    def baseline_strategy_name(self) -> pulumi.Output[_builtins.str]:
        """
        Policy name.
        """
        return pulumi.get(self, "baseline_strategy_name")
    ...
    @_builtins.property
    @pulumi.getter(name="customType")
    def custom_type(self) -> pulumi.Output[_builtins.str]:
        """
        The type of policy. Value:
        * **common**: standard policy
        * **custom**: custom policy
    ...
    @_builtins.property
    @pulumi.getter(name="cycleDays")
    def cycle_days(self) -> pulumi.Output[_builtins.int]:
        """
        The detection period of the policy.
        """
        return pulumi.get(self, "cycle_days")
    ...
    @_builtins.property
    @pulumi.getter(name="cycleStartTime")
    def cycle_start_time(self) -> pulumi.Output[_builtins.int]:
        """
        The detection period of the policy. Value:
        * **0**: 0:00~06:00
        * **6**: 6:00~12:00
    ...
    @_builtins.property
    @pulumi.getter(name="riskSubTypeName")
    def risk_sub_type_name(self) -> pulumi.Output[_builtins.str]:
        """
        Detection item subtype.
        """
        return pulumi.get(self, "risk_sub_type_name")
