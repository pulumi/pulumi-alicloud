...
class ClientUserDefineRuleArgs:
    def __init__(__self__, *,
                 action_type: pulumi.Input[builtins.int],
                 client_user_define_rule_name: pulumi.Input[builtins.str],
                 platform: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.int],
                 cmdline: Optional[pulumi.Input[builtins.str]] = None,
                 file_path: Optional[pulumi.Input[builtins.str]] = None,
                 hash: Optional[pulumi.Input[builtins.str]] = None,
                 ip: Optional[pulumi.Input[builtins.str]] = None,
                 new_file_path: Optional[pulumi.Input[builtins.str]] = None,
                 parent_cmdline: Optional[pulumi.Input[builtins.str]] = None,
                 parent_proc_path: Optional[pulumi.Input[builtins.str]] = None,
                 port_str: Optional[pulumi.Input[builtins.str]] = None,
                 proc_path: Optional[pulumi.Input[builtins.str]] = None,
                 registry_content: Optional[pulumi.Input[builtins.str]] = None,
                 registry_key: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ClientUserDefineRule resource.
        :param pulumi.Input[builtins.int] action_type: The operation type. Value:
               - **0**: plus White
               - **1**: Plus Black.
        :param pulumi.Input[builtins.str] client_user_define_rule_name: The custom rule name.
        :param pulumi.Input[builtins.str] platform: The operating system type. Value:
               - **windows**:widows
               - **linux**:linux
               - **all**: all.
        :param pulumi.Input[builtins.int] type: The rule type. Value:
               - **1**: Process hash
               - **2**: command line
               - **3**: Process network
               ...
               - **7**: File Rename.
        :param pulumi.Input[builtins.str] cmdline: Command line. When the value of the Type attribute is 2, 3, 4, 5, 6, or 7, the command line field is required.
        :param pulumi.Input[builtins.str] file_path: The file path. When the value of the Type attribute is 4 or 6, 7, the FilePath field is required.
        :param pulumi.Input[builtins.str] hash: Process hash list. When the value of the Type attribute is 1, the Hash attribute is required.
        :param pulumi.Input[builtins.str] ip: IP address. When the value of the Type attribute is 3, the Ip attribute is required.
        :param pulumi.Input[builtins.str] new_file_path: The new file path to rename the file. When the value of the Type attribute is 7, the NewFilePath attribute is required.
        :param pulumi.Input[builtins.str] parent_cmdline: The parent command line.
        :param pulumi.Input[builtins.str] parent_proc_path: Parent process path.
        :param pulumi.Input[builtins.str] port_str: The port number. When the value of the Type attribute is 3, the PortStr attribute is required. Value range: **1-65535**.
        :param pulumi.Input[builtins.str] proc_path: The process path. When the Type attribute is set to 2, 3, 4, 5, 6, or 7, the ProcPath attribute is required.
        :param pulumi.Input[builtins.str] registry_content: The registry value. When the value of the Type attribute is 5, the RegistryKey attribute is required.
        :param pulumi.Input[builtins.str] registry_key: The registry key. When the value of the Type attribute is 5, the RegistryKey attribute is required.
        """
    ...
    def action_type(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @action_type.setter
    def action_type(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "action_type", value)

    @property
    @pulumi.getter(name="clientUserDefineRuleName")
    def client_user_define_rule_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def client_user_define_rule_name(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def cmdline(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cmdline.setter
    def cmdline(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def new_file_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def new_file_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "new_file_path", value)

    @property
    @pulumi.getter(name="parentCmdline")
    def parent_cmdline(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def parent_cmdline(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "parent_cmdline", value)

    @property
    @pulumi.getter(name="parentProcPath")
    def parent_proc_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Parent process path.
        """
    ...
    def parent_proc_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "parent_proc_path", value)

    @property
    @pulumi.getter(name="portStr")
    def port_str(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @port_str.setter
    def port_str(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "port_str", value)

    @property
    @pulumi.getter(name="procPath")
    def proc_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @proc_path.setter
    def proc_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "proc_path", value)

    @property
    @pulumi.getter(name="registryContent")
    def registry_content(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def registry_content(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "registry_content", value)

    @property
    @pulumi.getter(name="registryKey")
    def registry_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @registry_key.setter
    def registry_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ClientUserDefineRuleState:
    def __init__(__self__, *,
                 action_type: Optional[pulumi.Input[builtins.int]] = None,
                 client_user_define_rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 cmdline: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="actionType")
    def action_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The operation type. Value:
        - **0**: plus White
        - **1**: Plus Black.
    ...
    @action_type.setter
    def action_type(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "action_type", value)

    @property
    @pulumi.getter(name="clientUserDefineRuleName")
    def client_user_define_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The custom rule name.
        """
        return pulumi.get(self, "client_user_define_rule_name")
    ...
    @client_user_define_rule_name.setter
    def client_user_define_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_user_define_rule_name", value)
...
class ClientUserDefineRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            registry_content: Optional[pulumi.Input[builtins.str]] = None,
            registry_key: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.int]] = None) -> 'ClientUserDefineRule':
        """
    ...
    @property
    @pulumi.getter(name="actionType")
    def action_type(self) -> pulumi.Output[builtins.int]:
        """
        The operation type. Value:
        - **0**: plus White
        - **1**: Plus Black.
    ...
    @property
    @pulumi.getter(name="clientUserDefineRuleName")
    def client_user_define_rule_name(self) -> pulumi.Output[builtins.str]:
        """
        The custom rule name.
        """
        return pulumi.get(self, "client_user_define_rule_name")
    ...
    @property
    @pulumi.getter
    def cmdline(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Command line. When the value of the Type attribute is 2, 3, 4, 5, 6, or 7, the command line field is required.
        """
        return pulumi.get(self, "cmdline")
    ...
    @property
    @pulumi.getter
    def hash(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Process hash list. When the value of the Type attribute is 1, the Hash attribute is required.
        """
        return pulumi.get(self, "hash")
    ...
    @property
    @pulumi.getter(name="newFilePath")
    def new_file_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The new file path to rename the file. When the value of the Type attribute is 7, the NewFilePath attribute is required.
        """
        return pulumi.get(self, "new_file_path")
    ...
    @property
    @pulumi.getter(name="parentCmdline")
    def parent_cmdline(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The parent command line.
        """
        return pulumi.get(self, "parent_cmdline")
    ...
    @property
    @pulumi.getter(name="parentProcPath")
    def parent_proc_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Parent process path.
        """
        return pulumi.get(self, "parent_proc_path")
    ...
    @property
    @pulumi.getter(name="portStr")
    def port_str(self) -> pulumi.Output[builtins.str]:
        """
        The port number. When the value of the Type attribute is 3, the PortStr attribute is required. Value range: **1-65535**.
        """
        return pulumi.get(self, "port_str")
    ...
    @property
    @pulumi.getter(name="procPath")
    def proc_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The process path. When the Type attribute is set to 2, 3, 4, 5, 6, or 7, the ProcPath attribute is required.
        """
        return pulumi.get(self, "proc_path")
    ...
    @property
    @pulumi.getter(name="registryContent")
    def registry_content(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The registry value. When the value of the Type attribute is 5, the RegistryKey attribute is required.
        """
        return pulumi.get(self, "registry_content")
    ...
    @property
    @pulumi.getter(name="registryKey")
    def registry_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The registry key. When the value of the Type attribute is 5, the RegistryKey attribute is required.
        """
        return pulumi.get(self, "registry_key")
