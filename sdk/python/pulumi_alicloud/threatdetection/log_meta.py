...
class LogMetaArgs:
    def __init__(__self__, *,
                 log_meta_name: pulumi.Input[builtins.str],
                 status: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a LogMeta resource.
        :param pulumi.Input[builtins.str] log_meta_name: The name of the exclusive Logstore where logs are stored. Value:
    ...
    def log_meta_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def log_meta_name(self, value: pulumi.Input[builtins.str]):
...
class _LogMetaState:
    def __init__(__self__, *,
                 log_meta_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="logMetaName")
    def log_meta_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the exclusive Logstore where logs are stored. Value:
        - aegis-log-client: client event log
        - aegis-log-crack: Brute Force log
    ...
    @log_meta_name.setter
    def log_meta_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_meta_name", value)
...
class LogMeta(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            log_meta_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'LogMeta':
        """
    ...
    @property
    @pulumi.getter(name="logMetaName")
    def log_meta_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the exclusive Logstore where logs are stored. Value:
        - aegis-log-client: client event log
        - aegis-log-crack: Brute Force log
