...
def get_web_lock_configs(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Web Lock Config IDs.
    :param builtins.str lang: The language of the content within the request and the response. Valid values: `zh`, `en`.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str remark: The string that allows you to search for servers in fuzzy match mode. You can enter a server name or IP address.
    :param builtins.str source_ip: The source IP address of the request.
    :param builtins.str status: The protection status of the server that you want to query. Valid values: `on`, `off`.
    """
    __args__ = dict()
    __args__['ids'] = ids
    __args__['lang'] = lang
...
def get_web_lock_configs_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                ...
                                remark: Optional[pulumi.Input[Optional[builtins.str]]] = None,
