...
def get_anti_brute_force_rules(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Anti-Brute Force Rule IDs.
    :param builtins.str name_regex: A regex string to filter results by the name of the defense rule.
...
def get_anti_brute_force_rules_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
