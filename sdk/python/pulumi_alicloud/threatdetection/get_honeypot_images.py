...
def get_honeypot_images(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Honeypot Image IDs.
    :param builtins.str name_regex: A regex string to filter results by Honeypot mirror nam.
...
def get_honeypot_images_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
