...
class HoneypotNodeArgs:
    def __init__(__self__, *,
                 available_probe_num: pulumi.Input[builtins.int],
                 node_name: pulumi.Input[builtins.str],
                 allow_honeypot_access_internet: Optional[pulumi.Input[builtins.bool]] = None,
                 security_group_probe_ip_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a HoneypotNode resource.
        :param pulumi.Input[builtins.int] available_probe_num: Number of probes available.
        :param pulumi.Input[builtins.str] node_name: Management node name.
        :param pulumi.Input[builtins.bool] allow_honeypot_access_internet: Whether to allow honeypot access to the external network. Value:-**true**: Allow-**false**: Disabled
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_probe_ip_lists: Release the collection of network segments.
        """
    ...
    def available_probe_num(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def available_probe_num(self, value: pulumi.Input[builtins.int]):
    ...
    def allow_honeypot_access_internet(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_honeypot_access_internet(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_honeypot_access_internet", value)

    @property
    @pulumi.getter(name="securityGroupProbeIpLists")
    def security_group_probe_ip_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def security_group_probe_ip_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _HoneypotNodeState:
    def __init__(__self__, *,
                 allow_honeypot_access_internet: Optional[pulumi.Input[builtins.bool]] = None,
                 available_probe_num: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] node_name: Management node name.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_probe_ip_lists: Release the collection of network segments.
        :param pulumi.Input[builtins.int] status: The status of the resource
        """
        if allow_honeypot_access_internet is not None:
            pulumi.set(__self__, "allow_honeypot_access_internet", allow_honeypot_access_internet)
    ...
    @property
    @pulumi.getter(name="availableProbeNum")
    def available_probe_num(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of probes available.
        """
        return pulumi.get(self, "available_probe_num")
    ...
    @available_probe_num.setter
    def available_probe_num(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "available_probe_num", value)
...
class HoneypotNode(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            node_name: Optional[pulumi.Input[builtins.str]] = None,
            security_group_probe_ip_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            status: Optional[pulumi.Input[builtins.int]] = None) -> 'HoneypotNode':
        """
    ...
    @property
    @pulumi.getter(name="allowHoneypotAccessInternet")
    def allow_honeypot_access_internet(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to allow honeypot access to the external network. Value:-**true**: Allow-**false**: Disabled
        """
        return pulumi.get(self, "allow_honeypot_access_internet")
    ...
    @property
    @pulumi.getter(name="availableProbeNum")
    def available_probe_num(self) -> pulumi.Output[builtins.int]:
        """
        Number of probes available.
        """
        return pulumi.get(self, "available_probe_num")
    ...
    @property
    @pulumi.getter(name="securityGroupProbeIpLists")
    def security_group_probe_ip_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Release the collection of network segments.
        """
        return pulumi.get(self, "security_group_probe_ip_lists")
