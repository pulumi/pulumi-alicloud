...
class HoneypotNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_probe_ip_lists: Release the collection of network segments.
        """
    ...
    def available_probe_num(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def available_probe_num(self, value: pulumi.Input[_builtins.int]):
...
class HoneypotNode(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="allowHoneypotAccessInternet")
    def allow_honeypot_access_internet(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether to allow honeypot access to the external network. Value:-**true**: Allow-**false**: Disabled
        """
        return pulumi.get(self, "allow_honeypot_access_internet")
    ...
    @_builtins.property
    @pulumi.getter(name="availableProbeNum")
    def available_probe_num(self) -> pulumi.Output[_builtins.int]:
        """
        Number of probes available.
        """
        return pulumi.get(self, "available_probe_num")
    ...
    @_builtins.property
    @pulumi.getter(name="securityGroupProbeIpLists")
    def security_group_probe_ip_lists(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Release the collection of network segments.
        """
        return pulumi.get(self, "security_group_probe_ip_lists")
