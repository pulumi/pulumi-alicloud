...
class WebLockConfigArgs:
    def __init__(__self__, *,
                 defence_mode: pulumi.Input[builtins.str],
                 dir: pulumi.Input[builtins.str],
                 local_backup_dir: pulumi.Input[builtins.str],
                 mode: pulumi.Input[builtins.str],
                 uuid: pulumi.Input[builtins.str],
                 exclusive_dir: Optional[pulumi.Input[builtins.str]] = None,
                 exclusive_file: Optional[pulumi.Input[builtins.str]] = None,
                 exclusive_file_type: Optional[pulumi.Input[builtins.str]] = None,
                 inclusive_file_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WebLockConfig resource.
        :param pulumi.Input[builtins.str] defence_mode: Protection mode. Value:-**block**: Intercept-**audit**: Alarm
        :param pulumi.Input[builtins.str] dir: Specify the protection directory.
        :param pulumi.Input[builtins.str] local_backup_dir: The local backup path is used to protect the safe backup of the Directory.
        :param pulumi.Input[builtins.str] mode: Specify the protected directory mode. Value:-**whitelist**: whitelist mode, which protects the added protected directories and file types.-**blacklist**: blacklist mode, which protects all unexcluded subdirectories, file types, and specified files under the added protection directory.
        :param pulumi.Input[builtins.str] uuid: Specify the UUID of the server to which you want to add a protection directory.> You can call the DescribeCloudCenterInstances interface to obtain the UUID of the server.
        :param pulumi.Input[builtins.str] exclusive_dir: Specify a directory address that does not require Web tamper protection (I. E. Excluded directories).> The protection Mode **Mode** is set to **blacklist**, you need to configure this parameter.
        :param pulumi.Input[builtins.str] exclusive_file: Specify files that do not need to enable tamper protection for web pages (that is, exclude files).> The protection Mode **Mode** is set to **blacklist**, you need to configure this parameter.
        :param pulumi.Input[builtins.str] exclusive_file_type: Specify the type of file that does not require Web tamper protection (that is, the type of excluded file). When there are multiple file types, use semicolons (;) separation. Value:-php-jsp-asp-aspx-js-cgi-html-htm-xml-shtml-shtm-jpg-gif-png > The protection Mode **Mode** is set to **blacklist**, you need to configure this parameter.
        :param pulumi.Input[builtins.str] inclusive_file_type: Specify the type of file that requires tamper protection. When there are multiple file types, use semicolons (;) separation. Value:-php-jsp-asp-aspx-js-cgi-html-htm-xml-shtml-shtm-jpg-gif-png> The protection Mode **Mode** is set to **whitelist**, you need to configure this parameter.
        """
    ...
    def defence_mode(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @defence_mode.setter
    def defence_mode(self, value: pulumi.Input[builtins.str]):
    ...
    def local_backup_dir(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def local_backup_dir(self, value: pulumi.Input[builtins.str]):
    ...
    def exclusive_dir(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def exclusive_dir(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "exclusive_dir", value)

    @property
    @pulumi.getter(name="exclusiveFile")
    def exclusive_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def exclusive_file(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "exclusive_file", value)

    @property
    @pulumi.getter(name="exclusiveFileType")
    def exclusive_file_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specify the type of file that does not require Web tamper protection (that is, the type of excluded file). When there are multiple file types, use semicolons (;) separation. Value:-php-jsp-asp-aspx-js-cgi-html-htm-xml-shtml-shtm-jpg-gif-png > The protection Mode **Mode** is set to **blacklist**, you need to configure this parameter.
        """
    ...
    def exclusive_file_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "exclusive_file_type", value)

    @property
    @pulumi.getter(name="inclusiveFileType")
    def inclusive_file_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inclusive_file_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _WebLockConfigState:
    def __init__(__self__, *,
                 defence_mode: Optional[pulumi.Input[builtins.str]] = None,
                 dir: Optional[pulumi.Input[builtins.str]] = None,
                 exclusive_dir: Optional[pulumi.Input[builtins.str]] = None,
                 exclusive_file: Optional[pulumi.Input[builtins.str]] = None,
                 exclusive_file_type: Optional[pulumi.Input[builtins.str]] = None,
                 inclusive_file_type: Optional[pulumi.Input[builtins.str]] = None,
                 local_backup_dir: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="defenceMode")
    def defence_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Protection mode. Value:-**block**: Intercept-**audit**: Alarm
        """
        return pulumi.get(self, "defence_mode")
    ...
    @defence_mode.setter
    def defence_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "defence_mode", value)
    ...
    @property
    @pulumi.getter(name="localBackupDir")
    def local_backup_dir(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The local backup path is used to protect the safe backup of the Directory.
        """
        return pulumi.get(self, "local_backup_dir")
    ...
    @local_backup_dir.setter
    def local_backup_dir(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "local_backup_dir", value)
...
class WebLockConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            local_backup_dir: Optional[pulumi.Input[builtins.str]] = None,
            mode: Optional[pulumi.Input[builtins.str]] = None,
            uuid: Optional[pulumi.Input[builtins.str]] = None) -> 'WebLockConfig':
        """
    ...
    @property
    @pulumi.getter(name="defenceMode")
    def defence_mode(self) -> pulumi.Output[builtins.str]:
        """
        Protection mode. Value:-**block**: Intercept-**audit**: Alarm
        """
        return pulumi.get(self, "defence_mode")
    ...
    @property
    @pulumi.getter
    def dir(self) -> pulumi.Output[builtins.str]:
        """
        Specify the protection directory.
        """
        return pulumi.get(self, "dir")
    ...
    @property
    @pulumi.getter(name="exclusiveDir")
    def exclusive_dir(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify a directory address that does not require Web tamper protection (I. E. Excluded directories).> The protection Mode **Mode** is set to **blacklist**, you need to configure this parameter.
        """
        return pulumi.get(self, "exclusive_dir")
    ...
    @property
    @pulumi.getter(name="exclusiveFile")
    def exclusive_file(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify files that do not need to enable tamper protection for web pages (that is, exclude files).> The protection Mode **Mode** is set to **blacklist**, you need to configure this parameter.
        """
        return pulumi.get(self, "exclusive_file")
    ...
    @property
    @pulumi.getter(name="exclusiveFileType")
    def exclusive_file_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify the type of file that does not require Web tamper protection (that is, the type of excluded file). When there are multiple file types, use semicolons (;) separation. Value:-php-jsp-asp-aspx-js-cgi-html-htm-xml-shtml-shtm-jpg-gif-png > The protection Mode **Mode** is set to **blacklist**, you need to configure this parameter.
        """
        return pulumi.get(self, "exclusive_file_type")
    ...
    @property
    @pulumi.getter(name="inclusiveFileType")
    def inclusive_file_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify the type of file that requires tamper protection. When there are multiple file types, use semicolons (;) separation. Value:-php-jsp-asp-aspx-js-cgi-html-htm-xml-shtml-shtm-jpg-gif-png> The protection Mode **Mode** is set to **whitelist**, you need to configure this parameter.
        """
        return pulumi.get(self, "inclusive_file_type")
    ...
    @property
    @pulumi.getter(name="localBackupDir")
    def local_backup_dir(self) -> pulumi.Output[builtins.str]:
        """
        The local backup path is used to protect the safe backup of the Directory.
        """
        return pulumi.get(self, "local_backup_dir")
