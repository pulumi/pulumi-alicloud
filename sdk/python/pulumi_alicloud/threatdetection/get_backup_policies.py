...
class GetBackupPoliciesResult:
    ...
    def machine_remark(self) -> Optional[builtins.str]:
...
def get_backup_policies(current_page: Optional[builtins.int] = None,
                        ids: Optional[Sequence[builtins.str]] = None,
                        machine_remark: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Threat Detection Backup Policies IDs.
    :param builtins.str machine_remark: The information that you want to use to identify the servers protected by the anti-ransomware policy. You can enter the IP address or ID of a server.
    :param builtins.str name: The name of the anti-ransomware policy that you want to query.
    :param builtins.str name_regex: A regex string to filter results by Threat Detection Backup Policies name.
...
def get_backup_policies_output(current_page: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                               ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                               machine_remark: Optional[pulumi.Input[Optional[builtins.str]]] = None,
