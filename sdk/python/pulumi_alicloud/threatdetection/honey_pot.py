...
class HoneyPotArgs:
    def __init__(__self__, *,
                 honeypot_image_id: pulumi.Input[builtins.str],
                 honeypot_image_name: pulumi.Input[builtins.str],
                 honeypot_name: pulumi.Input[builtins.str],
                 node_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a HoneyPot resource.
        :param pulumi.Input[builtins.str] honeypot_image_id: The image ID of the honeypot.
        :param pulumi.Input[builtins.str] honeypot_image_name: Honeypot mirror name.
        :param pulumi.Input[builtins.str] honeypot_name: Honeypot custom name.
        :param pulumi.Input[builtins.str] node_id: The ID of the honeypot management node.
        """
    ...
    def honeypot_image_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def honeypot_image_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "honeypot_image_id", value)

    @property
    @pulumi.getter(name="honeypotImageName")
    def honeypot_image_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def honeypot_image_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "honeypot_image_name", value)

    @property
    @pulumi.getter(name="honeypotName")
    def honeypot_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def honeypot_name(self, value: pulumi.Input[builtins.str]):
...
class _HoneyPotState:
    def __init__(__self__, *,
                 honeypot_id: Optional[pulumi.Input[builtins.str]] = None,
                 honeypot_image_id: Optional[pulumi.Input[builtins.str]] = None,
                 honeypot_image_name: Optional[pulumi.Input[builtins.str]] = None,
                 honeypot_name: Optional[pulumi.Input[builtins.str]] = None,
                 node_id: Optional[pulumi.Input[builtins.str]] = None,
                 preset_id: Optional[pulumi.Input[builtins.str]] = None,
                 states: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering HoneyPot resources.
        :param pulumi.Input[builtins.str] honeypot_id: Honeypot ID.
        :param pulumi.Input[builtins.str] honeypot_image_id: The image ID of the honeypot.
        :param pulumi.Input[builtins.str] honeypot_image_name: Honeypot mirror name.
        :param pulumi.Input[builtins.str] honeypot_name: Honeypot custom name.
        :param pulumi.Input[builtins.str] node_id: The ID of the honeypot management node.
        :param pulumi.Input[builtins.str] preset_id: The custom parameter ID of honeypot.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] states: Honeypot status.
    ...
    def honeypot_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Honeypot ID.
        """
    ...
    @honeypot_id.setter
    def honeypot_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "honeypot_id", value)

    @property
    @pulumi.getter(name="honeypotImageId")
    def honeypot_image_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The image ID of the honeypot.
        """
        return pulumi.get(self, "honeypot_image_id")
    ...
    @honeypot_image_id.setter
    def honeypot_image_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "honeypot_image_id", value)

    @property
    @pulumi.getter(name="honeypotImageName")
    def honeypot_image_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Honeypot mirror name.
        """
        return pulumi.get(self, "honeypot_image_name")
    ...
    @honeypot_image_name.setter
    def honeypot_image_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "honeypot_image_name", value)

    @property
    @pulumi.getter(name="honeypotName")
    def honeypot_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Honeypot custom name.
        """
        return pulumi.get(self, "honeypot_name")
    ...
    @honeypot_name.setter
    def honeypot_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "honeypot_name", value)
    ...
    def preset_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @preset_id.setter
    def preset_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "preset_id", value)

    @property
    @pulumi.getter
    def states(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Honeypot status.
        """
    ...
    @states.setter
    def states(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class HoneyPot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            preset_id: Optional[pulumi.Input[builtins.str]] = None,
            states: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'HoneyPot':
        """
    ...
    @property
    @pulumi.getter(name="honeypotId")
    def honeypot_id(self) -> pulumi.Output[builtins.str]:
        """
        Honeypot ID.
        """
        return pulumi.get(self, "honeypot_id")
    ...
    @property
    @pulumi.getter(name="honeypotImageId")
    def honeypot_image_id(self) -> pulumi.Output[builtins.str]:
        """
        The image ID of the honeypot.
        """
        return pulumi.get(self, "honeypot_image_id")
    ...
    @property
    @pulumi.getter(name="honeypotImageName")
    def honeypot_image_name(self) -> pulumi.Output[builtins.str]:
        """
        Honeypot mirror name.
        """
        return pulumi.get(self, "honeypot_image_name")
    ...
    @property
    @pulumi.getter(name="honeypotName")
    def honeypot_name(self) -> pulumi.Output[builtins.str]:
        """
        Honeypot custom name.
        """
        return pulumi.get(self, "honeypot_name")
    ...
    @property
    @pulumi.getter(name="presetId")
    def preset_id(self) -> pulumi.Output[builtins.str]:
        """
        The custom parameter ID of honeypot.
        """
        return pulumi.get(self, "preset_id")
    ...
    @property
    @pulumi.getter
    def states(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Honeypot status.
        """
        return pulumi.get(self, "states")
