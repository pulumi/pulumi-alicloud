...
class HoneyPotArgs:
    def __init__(__self__, *,
                 honeypot_image_id: pulumi.Input[_builtins.str],
                 honeypot_image_name: pulumi.Input[_builtins.str],
                 honeypot_name: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] node_id: The ID of the honeypot management node.
        """
    ...
    def honeypot_image_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def honeypot_image_id(self, value: pulumi.Input[_builtins.str]):
    ...
    def honeypot_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def honeypot_name(self, value: pulumi.Input[_builtins.str]):
...
class _HoneyPotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] honeypot_name: Honeypot custom name.
        :param pulumi.Input[_builtins.str] node_id: The ID of the honeypot management node.
        :param pulumi.Input[_builtins.str] preset_id: The custom parameter ID of honeypot.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] states: Honeypot status.
...
class HoneyPot(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="honeypotId")
    def honeypot_id(self) -> pulumi.Output[_builtins.str]:
        """
        Honeypot ID.
        """
        return pulumi.get(self, "honeypot_id")
    ...
    @_builtins.property
    @pulumi.getter(name="honeypotImageId")
    def honeypot_image_id(self) -> pulumi.Output[_builtins.str]:
        """
        The image ID of the honeypot.
        """
        return pulumi.get(self, "honeypot_image_id")
    ...
    @_builtins.property
    @pulumi.getter(name="honeypotName")
    def honeypot_name(self) -> pulumi.Output[_builtins.str]:
        """
        Honeypot custom name.
        """
        return pulumi.get(self, "honeypot_name")
    ...
    @_builtins.property
    @pulumi.getter(name="presetId")
    def preset_id(self) -> pulumi.Output[_builtins.str]:
        """
        The custom parameter ID of honeypot.
        """
        return pulumi.get(self, "preset_id")
    ...
    @_builtins.property
    @pulumi.getter
    def states(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Honeypot status.
        """
        return pulumi.get(self, "states")
