...
class HoneypotProbeArgs:
    def __init__(__self__, *,
                 control_node_id: pulumi.Input[builtins.str],
                 display_name: pulumi.Input[builtins.str],
                 probe_type: pulumi.Input[builtins.str],
                 arp: Optional[pulumi.Input[builtins.bool]] = None,
                 honeypot_bind_lists: Optional[pulumi.Input[Sequence[pulumi.Input['HoneypotProbeHoneypotBindListArgs']]]] = None,
                 ping: Optional[pulumi.Input[builtins.bool]] = None,
                 probe_version: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_ip: Optional[pulumi.Input[builtins.str]] = None,
                 service_ip_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 uuid: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a HoneypotProbe resource.
        :param pulumi.Input[builtins.str] control_node_id: The ID of the management node.
        :param pulumi.Input[builtins.str] display_name: Probe display name.
        :param pulumi.Input[builtins.str] probe_type: Probe type, support `host_probe` and `vpc_black_hole_probe`.
        :param pulumi.Input[builtins.bool] arp: ARP spoofing detection.**true**: Enable **false**: Disabled
        ...
        :param pulumi.Input[builtins.bool] ping: Ping scan detection. Value: **true**: Enable **false**: Disabled
        :param pulumi.Input[builtins.str] probe_version: The version of the probe.
        :param pulumi.Input[builtins.str] proxy_ip: The IP address of the proxy.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] service_ip_lists: Listen to the IP address list.
        :param pulumi.Input[builtins.str] uuid: Machine uuid, **probe_type** is `host_probe`. This value cannot be empty.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC. **probe_type** is `vpc_black_hole_probe`. This value cannot be empty.
        """
    ...
    def control_node_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def control_node_id(self, value: pulumi.Input[builtins.str]):
    ...
    def probe_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @probe_type.setter
    def probe_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "probe_type", value)

    @property
    @pulumi.getter
    def arp(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @arp.setter
    def arp(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def ping(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @ping.setter
    def ping(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ping", value)

    @property
    @pulumi.getter(name="probeVersion")
    def probe_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def probe_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "probe_version", value)

    @property
    @pulumi.getter(name="proxyIp")
    def proxy_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @proxy_ip.setter
    def proxy_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "proxy_ip", value)

    @property
    @pulumi.getter(name="serviceIpLists")
    def service_ip_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def service_ip_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _HoneypotProbeState:
    def __init__(__self__, *,
                 arp: Optional[pulumi.Input[builtins.bool]] = None,
                 control_node_id: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 honeypot_bind_lists: Optional[pulumi.Input[Sequence[pulumi.Input['HoneypotProbeHoneypotBindListArgs']]]] = None,
                 honeypot_probe_id: Optional[pulumi.Input[builtins.str]] = None,
                 ping: Optional[pulumi.Input[builtins.bool]] = None,
                 probe_type: Optional[pulumi.Input[builtins.str]] = None,
                 probe_version: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_ip: Optional[pulumi.Input[builtins.str]] = None,
                 service_ip_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: Probe display name.
        :param pulumi.Input[Sequence[pulumi.Input['HoneypotProbeHoneypotBindListArgs']]] honeypot_bind_lists: Configure the service.See the following `Block HoneypotBindList`.
        :param pulumi.Input[builtins.str] honeypot_probe_id: The first ID of the resource
        :param pulumi.Input[builtins.bool] ping: Ping scan detection. Value: **true**: Enable **false**: Disabled
        :param pulumi.Input[builtins.str] probe_type: Probe type, support `host_probe` and `vpc_black_hole_probe`.
        :param pulumi.Input[builtins.str] probe_version: The version of the probe.
        :param pulumi.Input[builtins.str] proxy_ip: The IP address of the proxy.
    ...
    @property
    @pulumi.getter(name="controlNodeId")
    def control_node_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the management node.
        """
        return pulumi.get(self, "control_node_id")
    ...
    @control_node_id.setter
    def control_node_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "control_node_id", value)
    ...
    def honeypot_probe_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def honeypot_probe_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="probeType")
    def probe_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Probe type, support `host_probe` and `vpc_black_hole_probe`.
        """
        return pulumi.get(self, "probe_type")
    ...
    @probe_type.setter
    def probe_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "probe_type", value)
...
class HoneypotProbe(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            uuid: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'HoneypotProbe':
        """
    ...
    @property
    @pulumi.getter
    def arp(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        ARP spoofing detection.**true**: Enable **false**: Disabled
        """
        return pulumi.get(self, "arp")
    ...
    @property
    @pulumi.getter(name="controlNodeId")
    def control_node_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the management node.
        """
        return pulumi.get(self, "control_node_id")
    ...
    @property
    @pulumi.getter(name="honeypotProbeId")
    def honeypot_probe_id(self) -> pulumi.Output[builtins.str]:
        """
        The first ID of the resource
        """
        return pulumi.get(self, "honeypot_probe_id")
    ...
    @property
    @pulumi.getter
    def ping(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Ping scan detection. Value: **true**: Enable **false**: Disabled
        """
        return pulumi.get(self, "ping")
    ...
    @property
    @pulumi.getter(name="probeType")
    def probe_type(self) -> pulumi.Output[builtins.str]:
        """
        Probe type, support `host_probe` and `vpc_black_hole_probe`.
        """
        return pulumi.get(self, "probe_type")
    ...
    @property
    @pulumi.getter(name="probeVersion")
    def probe_version(self) -> pulumi.Output[builtins.str]:
        """
        The version of the probe.
        """
        return pulumi.get(self, "probe_version")
    ...
    @property
    @pulumi.getter(name="proxyIp")
    def proxy_ip(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IP address of the proxy.
        """
        return pulumi.get(self, "proxy_ip")
    ...
    @property
    @pulumi.getter(name="serviceIpLists")
    def service_ip_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Listen to the IP address list.
        """
        return pulumi.get(self, "service_ip_lists")
