...
class GetLogShipperResult:
    ...
    def buy_status(self) -> builtins.str:
        """
    ...
    def open_status(self) -> builtins.str:
        """
    ...
    def sls_project_status(self) -> builtins.str:
        """
    ...
    def sls_service_status(self) -> builtins.str:
        """
...
def get_log_shipper(enable: Optional[builtins.str] = None,
    ...
    :param builtins.str enable: Setting the value to `On` to enable the service. Valid values: `On` or `Off`. Default to `Off`.
...
def get_log_shipper_output(enable: Optional[pulumi.Input[Optional[builtins.str]]] = None,
