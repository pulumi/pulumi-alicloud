...
class GetHoneypotProbesResult:
    ...
    def probe_status(self) -> Optional[builtins.str]:
        return pulumi.get(self, "probe_status")

    @property
    @pulumi.getter(name="probeType")
    def probe_type(self) -> Optional[builtins.str]:
        """
...
def get_honeypot_probes(display_name: Optional[builtins.str] = None,
                        ...
                        probe_status: Optional[builtins.str] = None,
                        probe_type: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Honeypot Probe IDs.
    :param builtins.str name_regex: A regex string to filter results by display name.
...
def get_honeypot_probes_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               ...
                               probe_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               probe_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
