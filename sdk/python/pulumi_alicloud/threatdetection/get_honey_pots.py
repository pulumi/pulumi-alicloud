...
class GetHoneyPotsResult:
    ...
    def honeypot_name(self) -> Optional[builtins.str]:
        """
...
def get_honey_pots(honeypot_id: Optional[builtins.str] = None,
                   honeypot_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Honey Pot IDs.
    :param builtins.str name_regex: A regex string to filter results by honey pot name.
    :param builtins.str node_id: The ID of the honeypot management node.
    :param builtins.str node_name: The name of the honeypot management node.
...
def get_honey_pots_output(honeypot_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          honeypot_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
