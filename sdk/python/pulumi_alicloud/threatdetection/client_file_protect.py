...
class ClientFileProtectArgs:
    def __init__(__self__, *,
                 file_ops: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 file_paths: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 proc_paths: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 rule_action: pulumi.Input[builtins.str],
                 rule_name: pulumi.Input[builtins.str],
                 alert_level: Optional[pulumi.Input[builtins.int]] = None,
                 status: Optional[pulumi.Input[builtins.int]] = None,
                 switch_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ClientFileProtect resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_ops: file operation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_paths: file path.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] proc_paths: process path.
        :param pulumi.Input[builtins.str] rule_action: rule action, pass or alert.
        :param pulumi.Input[builtins.str] rule_name: ruleName.
        :param pulumi.Input[builtins.int] alert_level: 0 no alert 1 info 2 suspicious 3 critical.
        :param pulumi.Input[builtins.int] status: rule status 0 is disable 1 is enable.
        :param pulumi.Input[builtins.str] switch_id: switch id.
        """
    ...
    def file_ops(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        file operation.
        """
    ...
    @file_ops.setter
    def file_ops(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "file_ops", value)

    @property
    @pulumi.getter(name="filePaths")
    def file_paths(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        file path.
        """
    ...
    @file_paths.setter
    def file_paths(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "file_paths", value)

    @property
    @pulumi.getter(name="procPaths")
    def proc_paths(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        process path.
        """
    ...
    @proc_paths.setter
    def proc_paths(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def alert_level(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @alert_level.setter
    def alert_level(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def switch_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        switch id.
        """
    ...
    @switch_id.setter
    def switch_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ClientFileProtectState:
    def __init__(__self__, *,
                 alert_level: Optional[pulumi.Input[builtins.int]] = None,
                 file_ops: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 file_paths: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 proc_paths: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="fileOps")
    def file_ops(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        file operation.
        """
        return pulumi.get(self, "file_ops")
    ...
    @file_ops.setter
    def file_ops(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "file_ops", value)

    @property
    @pulumi.getter(name="filePaths")
    def file_paths(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        file path.
        """
        return pulumi.get(self, "file_paths")
    ...
    @file_paths.setter
    def file_paths(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "file_paths", value)

    @property
    @pulumi.getter(name="procPaths")
    def proc_paths(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        process path.
        """
        return pulumi.get(self, "proc_paths")
    ...
    @proc_paths.setter
    def proc_paths(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "proc_paths", value)
...
class ClientFileProtect(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rule_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.int]] = None,
            switch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ClientFileProtect':
        """
    ...
    @property
    @pulumi.getter(name="alertLevel")
    def alert_level(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        0 no alert 1 info 2 suspicious 3 critical.
        """
        return pulumi.get(self, "alert_level")
    ...
    @property
    @pulumi.getter(name="fileOps")
    def file_ops(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        file operation.
        """
        return pulumi.get(self, "file_ops")
    ...
    @property
    @pulumi.getter(name="filePaths")
    def file_paths(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        file path.
        """
        return pulumi.get(self, "file_paths")
    ...
    @property
    @pulumi.getter(name="procPaths")
    def proc_paths(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        process path.
        """
        return pulumi.get(self, "proc_paths")
    ...
    @property
    @pulumi.getter(name="switchId")
    def switch_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        switch id.
        """
        return pulumi.get(self, "switch_id")
