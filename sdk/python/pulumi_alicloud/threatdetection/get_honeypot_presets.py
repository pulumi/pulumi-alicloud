...
class GetHoneypotPresetsResult:
    ...
    def honeypot_image_name(self) -> Optional[builtins.str]:
        """
...
def get_honeypot_presets(current_page: Optional[builtins.int] = None,
                         enable_details: Optional[builtins.bool] = None,
                         honeypot_image_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Honeypot Preset IDs.
...
def get_honeypot_presets_output(current_page: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                honeypot_image_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                preset_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetHoneypotPresetsResult(
        ...
        honeypot_image_name=pulumi.get(__response__, 'honeypot_image_name'),
        ...
        presets=pulumi.get(__response__, 'presets')))
