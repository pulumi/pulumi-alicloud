...
def get_honeypot_nodes(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Honeypot Node IDs.
    :param builtins.str name_regex: A regex string to filter results by Honeypot Node name.
...
def get_honeypot_nodes_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
