...
class HoneypotPresetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] node_id: Unique id of management node
        :param pulumi.Input[builtins.str] preset_name: Honeypot template custom name
        """
...
class _HoneypotPresetState:
    def __init__(__self__, *,
                 ...
                 honeypot_preset_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] honeypot_image_name: Honeypot mirror name
        :param pulumi.Input[builtins.str] honeypot_preset_id: Unique ID of honeypot Template
        :param pulumi.Input['HoneypotPresetMetaArgs'] meta: Honeypot template custom parameters. See `meta` below.
        :param pulumi.Input[builtins.str] node_id: Unique id of management node
        :param pulumi.Input[builtins.str] preset_name: Honeypot template custom name
        """
    ...
    def honeypot_preset_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def honeypot_preset_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HoneypotPreset(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            meta: Optional[pulumi.Input[Union['HoneypotPresetMetaArgs', 'HoneypotPresetMetaArgsDict']]] = None,
            node_id: Optional[pulumi.Input[builtins.str]] = None,
            preset_name: Optional[pulumi.Input[builtins.str]] = None) -> 'HoneypotPreset':
        """
    ...
    @property
    @pulumi.getter(name="honeypotPresetId")
    def honeypot_preset_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique ID of honeypot Template
        """
        return pulumi.get(self, "honeypot_preset_id")
