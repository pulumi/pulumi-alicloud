...
def get_vul_whitelists(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Threat Detection Vul Whitelist IDs.
...
def get_vul_whitelists_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
