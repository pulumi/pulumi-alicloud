...
def get_protocols(output_file: Optional[builtins.str] = None,
    ...
    :param builtins.str type: The file system type. Valid Values: `Performance` and `Capacity`.
...
def get_protocols_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
