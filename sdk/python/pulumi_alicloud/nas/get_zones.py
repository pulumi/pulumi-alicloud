...
def get_zones(file_system_type: Optional[builtins.str] = None,
    ...
    :param builtins.str file_system_type: The type of the file system.  Valid values: `standard`, `extreme`, `cpfs`.
...
def get_zones_output(file_system_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
