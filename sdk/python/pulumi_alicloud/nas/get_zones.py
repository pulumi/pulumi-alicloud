...
def get_zones(file_system_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str file_system_type: The type of the file system.  Valid values: `standard`, `extreme`, `cpfs`.
