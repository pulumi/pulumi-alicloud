...
def get_filesets(file_system_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Fileset IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the fileset. Valid values: `CREATED`, `CREATING`, `RELEASED`, `RELEASING`.
    """
    __args__ = dict()
...
def get_filesets_output(file_system_id: Optional[pulumi.Input[builtins.str]] = None,
