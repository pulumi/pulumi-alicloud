...
class GetAccessGroupsResult:
    ...
    def access_group_name(self) -> Optional[builtins.str]:
        """
    ...
    def access_group_type(self) -> Optional[builtins.str]:
        """
    ...
    def useutc_date_time(self) -> Optional[builtins.bool]:
...
def get_access_groups(access_group_name: Optional[builtins.str] = None,
                      access_group_type: Optional[builtins.str] = None,
                      ...
                      useutc_date_time: Optional[builtins.bool] = None,
    ...
    :param builtins.str file_system_type: The type of file system. Valid values: `standard` and `extreme`. Default to `standard`.
    :param builtins.str name_regex: A regex string to filter AccessGroups by name.
    ...
    :param builtins.bool useutc_date_time: Specifies whether the time to return is in UTC. Valid values: true and false.
    """
    __args__ = dict()
...
def get_access_groups_output(access_group_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             access_group_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             file_system_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ...
                             useutc_date_time: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
