...
def get_lifecycle_policies(file_system_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Lifecycle Policy IDs.
    :param _builtins.str name_regex: A regex string to filter results by Lifecycle Policy name.
...
def get_lifecycle_policies_output(file_system_id: Optional[pulumi.Input[_builtins.str]] = None,
