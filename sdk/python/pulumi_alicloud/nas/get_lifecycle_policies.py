...
def get_lifecycle_policies(file_system_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Lifecycle Policy IDs.
    :param builtins.str name_regex: A regex string to filter results by Lifecycle Policy name.
...
def get_lifecycle_policies_output(file_system_id: Optional[pulumi.Input[builtins.str]] = None,
