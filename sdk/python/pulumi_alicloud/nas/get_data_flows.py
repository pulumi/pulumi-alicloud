...
def get_data_flows(file_system_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Data Flow IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the Data flow. Including: `Starting`, `Running`, `Updating`, `Deleting`, `Stopping`, `Stopped`, `Misconfigured`.
    """
    __args__ = dict()
...
def get_data_flows_output(file_system_id: Optional[pulumi.Input[builtins.str]] = None,
