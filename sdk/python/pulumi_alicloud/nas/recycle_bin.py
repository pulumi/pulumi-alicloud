...
class RecycleBinArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] file_system_id: The ID of the file system for which you want to enable the recycle bin feature.
        :param pulumi.Input[builtins.int] reserved_days: The period for which the files in the recycle bin are retained. Unit: days. Valid values: `1` to `180`.
        """
...
class _RecycleBinState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] file_system_id: The ID of the file system for which you want to enable the recycle bin feature.
        :param pulumi.Input[builtins.int] reserved_days: The period for which the files in the recycle bin are retained. Unit: days. Valid values: `1` to `180`.
        :param pulumi.Input[builtins.str] status: The status of the recycle bin.
        """
...
class RecycleBin(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            file_system_id: Optional[pulumi.Input[builtins.str]] = None,
            reserved_days: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'RecycleBin':
        """
    ...
    @property
    @pulumi.getter(name="reservedDays")
    def reserved_days(self) -> pulumi.Output[builtins.int]:
        """
        The period for which the files in the recycle bin are retained. Unit: days. Valid values: `1` to `180`.
        """
        return pulumi.get(self, "reserved_days")
