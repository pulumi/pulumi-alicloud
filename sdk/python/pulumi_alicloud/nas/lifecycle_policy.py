...
class LifecyclePolicyArgs:
    def __init__(__self__, *,
                 ...
                 lifecycle_policy_name: pulumi.Input[builtins.str],
                 lifecycle_rule_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] lifecycle_policy_name: The name of the lifecycle management policy.
        :param pulumi.Input[builtins.str] lifecycle_rule_name: The rules in the lifecycle management policy. Valid values: `DEFAULT_ATIME_14`, `DEFAULT_ATIME_30`, `DEFAULT_ATIME_60`, `DEFAULT_ATIME_90`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] paths: The absolute path of the directory for which the lifecycle management policy is configured. Set a maximum of `10` path. The path value must be prefixed by a forward slash (/) and must be an existing path in the mount target.
        :param pulumi.Input[builtins.str] storage_type: The storage type of the data that is dumped to the IA storage medium. Valid values: `InfrequentAccess`.
        """
    ...
    def lifecycle_policy_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def lifecycle_policy_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "lifecycle_policy_name", value)

    @property
    @pulumi.getter(name="lifecycleRuleName")
    def lifecycle_rule_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def lifecycle_rule_name(self, value: pulumi.Input[builtins.str]):
...
class _LifecyclePolicyState:
    def __init__(__self__, *,
                 ...
                 lifecycle_policy_name: Optional[pulumi.Input[builtins.str]] = None,
                 lifecycle_rule_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="lifecyclePolicyName")
    def lifecycle_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the lifecycle management policy.
        """
        return pulumi.get(self, "lifecycle_policy_name")
    ...
    @lifecycle_policy_name.setter
    def lifecycle_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "lifecycle_policy_name", value)

    @property
    @pulumi.getter(name="lifecycleRuleName")
    def lifecycle_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The rules in the lifecycle management policy. Valid values: `DEFAULT_ATIME_14`, `DEFAULT_ATIME_30`, `DEFAULT_ATIME_60`, `DEFAULT_ATIME_90`.
        """
        return pulumi.get(self, "lifecycle_rule_name")
    ...
    @lifecycle_rule_name.setter
    def lifecycle_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "lifecycle_rule_name", value)
...
class LifecyclePolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            lifecycle_rule_name: Optional[pulumi.Input[builtins.str]] = None,
            paths: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            storage_type: Optional[pulumi.Input[builtins.str]] = None) -> 'LifecyclePolicy':
        """
    ...
    @property
    @pulumi.getter(name="lifecyclePolicyName")
    def lifecycle_policy_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the lifecycle management policy.
        """
        return pulumi.get(self, "lifecycle_policy_name")
    ...
    @property
    @pulumi.getter(name="lifecycleRuleName")
    def lifecycle_rule_name(self) -> pulumi.Output[builtins.str]:
        """
        The rules in the lifecycle management policy. Valid values: `DEFAULT_ATIME_14`, `DEFAULT_ATIME_30`, `DEFAULT_ATIME_60`, `DEFAULT_ATIME_90`.
        """
        return pulumi.get(self, "lifecycle_rule_name")
