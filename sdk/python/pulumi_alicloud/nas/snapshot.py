...
class SnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the snapshot. It must be `2` to `256` characters in length and cannot start with `https://` or `https://`.
        :param pulumi.Input[builtins.int] retention_days: The retention period of the snapshot. Unit: days. Valid values:
               * `-1`: The default value. Auto snapshots are permanently retained. After the number of auto snapshots exceeds the upper limit, the earliest auto snapshot is automatically deleted.
        :param pulumi.Input[builtins.str] snapshot_name: SnapshotName. It must be `2` to `128` characters in length and must start with a letter, but cannot start with `https://` or `https://`.
        """
...
class Snapshot(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:nas/snapshot:Snapshot"
