...
class MountTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_group_name: The name of the permission group that applies to the mount target.
        :param pulumi.Input[builtins.str] network_type: mount target network type. Valid values: `VPC`. The classic network's mount targets are not supported.
        :param pulumi.Input[builtins.str] security_group_id: The ID of security group.
        :param pulumi.Input[builtins.str] status: Whether the MountTarget is active. The status of the mount target. Valid values: `Active` and `Inactive`, Default value is `Active`. Before you mount a file system, make sure that the mount target is in the Active state.
        :param pulumi.Input[builtins.str] vpc_id: The ID of VPC.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the VSwitch in the VPC where the mount target resides.
        """
...
class _MountTargetState:
    def __init__(__self__, *,
                 ...
                 mount_target_domain: Optional[pulumi.Input[builtins.str]] = None,
                 network_type: Optional[pulumi.Input[builtins.str]] = None,
                 security_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] access_group_name: The name of the permission group that applies to the mount target.
        :param pulumi.Input[builtins.str] file_system_id: The ID of the file system.
        :param pulumi.Input[builtins.str] mount_target_domain: The IPv4 domain name of the mount target. **NOTE:** Available since v1.161.0.
        :param pulumi.Input[builtins.str] network_type: mount target network type. Valid values: `VPC`. The classic network's mount targets are not supported.
        :param pulumi.Input[builtins.str] security_group_id: The ID of security group.
        :param pulumi.Input[builtins.str] status: Whether the MountTarget is active. The status of the mount target. Valid values: `Active` and `Inactive`, Default value is `Active`. Before you mount a file system, make sure that the mount target is in the Active state.
        :param pulumi.Input[builtins.str] vpc_id: The ID of VPC.
    ...
    def mount_target_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mount_target_domain(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MountTarget(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MountTarget':
        """
    ...
    @property
    @pulumi.getter(name="accessGroupName")
    def access_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the permission group that applies to the mount target.
        """
        return pulumi.get(self, "access_group_name")
    ...
    @property
    @pulumi.getter(name="mountTargetDomain")
    def mount_target_domain(self) -> pulumi.Output[builtins.str]:
        """
        The IPv4 domain name of the mount target. **NOTE:** Available since v1.161.0.
        """
        return pulumi.get(self, "mount_target_domain")
