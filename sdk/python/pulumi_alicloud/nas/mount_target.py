...
class MountTargetArgs:
    def __init__(__self__, *,
                 ...
                 dual_stack: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] access_group_name: The name of the permission group.
        :param pulumi.Input[builtins.bool] dual_stack: Whether to create an IPv6 mount point.
        ...
        :param pulumi.Input[builtins.str] status: The current status of the Mount point, including Active and Inactive, can be used to mount the file system only when the status is Active.
    ...
    def dual_stack(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @dual_stack.setter
    def dual_stack(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _MountTargetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] dual_stack: Whether to create an IPv6 mount point.
               ...
               > **NOTE:**  currently, only extreme NAS supports IPv6 function in various regions in mainland China, and IPv6 function needs to be turned on for this file system.
        :param pulumi.Input[builtins.str] file_system_id: The ID of the file system.
        :param pulumi.Input[builtins.str] mount_target_domain: The domain name of the Mount point.
        :param pulumi.Input[builtins.str] network_type: Network type.
        :param pulumi.Input[builtins.str] security_group_id: The ID of the security group.
        :param pulumi.Input[builtins.str] status: The current status of the Mount point, including Active and Inactive, can be used to mount the file system only when the status is Active.
        :param pulumi.Input[builtins.str] vpc_id: VPC ID.
...
class MountTarget(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dualStack")
    def dual_stack(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to create an IPv6 mount point.
