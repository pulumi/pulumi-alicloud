...
class GetMountTargetsResult:
    ...
    def mount_target_domain(self) -> Optional[builtins.str]:
        """
...
def get_mount_targets(access_group_name: Optional[builtins.str] = None,
                      file_system_id: Optional[builtins.str] = None,
                      ids: Optional[Sequence[builtins.str]] = None,
                      mount_target_domain: Optional[builtins.str] = None,
    ...
    :param builtins.str file_system_id: The ID of the FileSystem that owns the MountTarget.
    :param Sequence[builtins.str] ids: A list of MountTargetDomain.
    ...
    return AwaitableGetMountTargetsResult(
        ...
        mount_target_domain=pulumi.get(__ret__, 'mount_target_domain'),
...
def get_mount_targets_output(access_group_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             file_system_id: Optional[pulumi.Input[builtins.str]] = None,
                             ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             mount_target_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:nas/getMountTargets:getMountTargets', __args__, opts=opts, typ=GetMountTargetsResult)
    return __ret__.apply(lambda __response__: GetMountTargetsResult(
        ...
        mount_target_domain=pulumi.get(__response__, 'mount_target_domain'),
