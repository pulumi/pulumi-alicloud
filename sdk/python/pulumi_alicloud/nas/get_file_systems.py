...
def get_file_systems(description_regex: Optional[builtins.str] = None,
    ...
    :param builtins.str description_regex: A regex string to filter the results by the ：FileSystem description.
    :param Sequence[builtins.str] ids: A list of FileSystemId.
...
def get_file_systems_output(description_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
