...
class AutoSnapshotPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] repeat_weekdays: The day on which an auto snapshot is created.
               - A maximum of 7 time points can be selected.
               - The format is  an JSON array of ["1", "2", … "7"]  and the time points are separated by commas (,).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] time_points: The point in time at which an auto snapshot is created.
               - A maximum of 24 time points can be selected.
               - The format is  an JSON array of ["0", "1", … "23"] and the time points are separated by commas (,).
        :param pulumi.Input[builtins.str] auto_snapshot_policy_name: The name of the automatic snapshot policy. Limits:
        ...
        :param pulumi.Input[builtins.str] file_system_type: The file system type.
        :param pulumi.Input[builtins.int] retention_days: The number of days for which you want to retain auto snapshots. Unit: days. Valid values:
...
@pulumi.type_token("alicloud:nas/autoSnapshotPolicy:AutoSnapshotPolicy")
class AutoSnapshotPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="autoSnapshotPolicyName")
    def auto_snapshot_policy_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the automatic snapshot policy. Limits:
        - The name must be `2` to `128` characters in length,
        - The name must start with a letter.
