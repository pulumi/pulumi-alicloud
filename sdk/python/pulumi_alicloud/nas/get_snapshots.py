...
def get_snapshots(file_system_id: Optional[builtins.str] = None,
    ...
    :param builtins.str status: Status. Valid values: `accomplished`, `failed`, `progressing`.
    """
    __args__ = dict()
...
def get_snapshots_output(file_system_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
