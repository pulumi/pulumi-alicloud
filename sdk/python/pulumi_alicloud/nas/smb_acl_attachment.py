...
class SmbAclAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 keytab: pulumi.Input[builtins.str],
                 keytab_md5: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] keytab: The string that is generated after the system encodes the keytab file by using Base64.
        :param pulumi.Input[builtins.str] keytab_md5: RThe string that is generated after the system encodes the keytab file by using MD5.
        :param pulumi.Input[builtins.bool] enable_anonymous_access: Specifies whether to allow anonymous access. Valid values:
               true: The file system allows anonymous access.
               false: The file system denies anonymous access. Default value: false.
        :param pulumi.Input[builtins.bool] encrypt_data: Specifies whether to enable encryption in transit. Valid values:
               true: enables encryption in transit.
               false: disables encryption in transit. Default value: false.
        :param pulumi.Input[builtins.str] home_dir_path: The home directory of each user. Each user-specific home directory must meet the following requirements:    
        ...
        :param pulumi.Input[builtins.bool] reject_unencrypted_access: Specifies whether to deny access from non-encrypted clients. Valid values:
               true: The file system denies access from non-encrypted clients.
               false: The file system allows access from non-encrypted clients. Default value: false.
        :param pulumi.Input[builtins.str] super_admin_sid: The ID of a super admin. The ID must meet the following requirements:
    ...
    @property
    @pulumi.getter
    def keytab(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @keytab.setter
    def keytab(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "keytab", value)

    @property
    @pulumi.getter(name="keytabMd5")
    def keytab_md5(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @keytab_md5.setter
    def keytab_md5(self, value: pulumi.Input[builtins.str]):
...
class _SmbAclAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] auth_method: The method that is used to authenticate network identities.
        :param pulumi.Input[builtins.bool] enable_anonymous_access: Specifies whether to allow anonymous access. Valid values:
               true: The file system allows anonymous access.
               false: The file system denies anonymous access. Default value: false.
        :param pulumi.Input[builtins.str] enabled: Specifies whether to enable the ACL feature.
...
class SmbAclAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            keytab_md5: Optional[pulumi.Input[builtins.str]] = None,
            reject_unencrypted_access: Optional[pulumi.Input[builtins.bool]] = None,
            super_admin_sid: Optional[pulumi.Input[builtins.str]] = None) -> 'SmbAclAttachment':
        """
    ...
    @property
    @pulumi.getter(name="enableAnonymousAccess")
    def enable_anonymous_access(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to allow anonymous access. Valid values:
        true: The file system allows anonymous access.
        false: The file system denies anonymous access. Default value: false.
    ...
    @property
    @pulumi.getter(name="encryptData")
    def encrypt_data(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable encryption in transit. Valid values:
        true: enables encryption in transit.
        false: disables encryption in transit. Default value: false.
    ...
    @property
    @pulumi.getter(name="homeDirPath")
    def home_dir_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The home directory of each user. Each user-specific home directory must meet the following requirements:    
        Each segment starts with a forward slash (/) or a backslash (\\).
        Each segment does not contain the following special characters: <>":?*.
    ...
    @property
    @pulumi.getter
    def keytab(self) -> pulumi.Output[builtins.str]:
        """
        The string that is generated after the system encodes the keytab file by using Base64.
        """
        return pulumi.get(self, "keytab")
    ...
    @property
    @pulumi.getter(name="keytabMd5")
    def keytab_md5(self) -> pulumi.Output[builtins.str]:
        """
        RThe string that is generated after the system encodes the keytab file by using MD5.
        """
        return pulumi.get(self, "keytab_md5")
    ...
    @property
    @pulumi.getter(name="rejectUnencryptedAccess")
    def reject_unencrypted_access(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to deny access from non-encrypted clients. Valid values:
        true: The file system denies access from non-encrypted clients.
        false: The file system allows access from non-encrypted clients. Default value: false.
    ...
    @property
    @pulumi.getter(name="superAdminSid")
    def super_admin_sid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of a super admin. The ID must meet the following requirements:
        The ID starts with S and does not contain letters except S.
        The ID contains at least three hyphens (-) as delimiters.
