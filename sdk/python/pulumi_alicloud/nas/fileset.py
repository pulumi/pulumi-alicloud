...
class FilesetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] file_system_path: The path of the fileset.
        :param pulumi.Input[builtins.str] description: The description of the Fileset. It must be `2` to `128` characters in length and must start with a letter or Chinese, but cannot start with `https://` or `https://`.
...
class _FilesetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] file_system_id: The ID of the file system.
        :param pulumi.Input[builtins.str] file_system_path: The path of the fileset.
        :param pulumi.Input[builtins.str] fileset_id: The first ID of the resource.
        :param pulumi.Input[builtins.str] status: The status of the fileset.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if dry_run is not None:
