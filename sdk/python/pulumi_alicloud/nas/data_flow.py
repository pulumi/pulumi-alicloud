...
class DataFlowArgs:
    def __init__(__self__, *,
                 ...
                 fset_id: pulumi.Input[builtins.str],
                 source_storage: pulumi.Input[builtins.str],
                 throughput: pulumi.Input[builtins.int],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 dry_run: Optional[pulumi.Input[builtins.bool]] = None,
                 source_security_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] fset_id: The ID of the Fileset.
        :param pulumi.Input[builtins.str] source_storage: The access path of the source store. Format: `<storage type>://<path>`. Among them:
        ...
        :param pulumi.Input[builtins.int] throughput: The maximum transmission bandwidth of data flow, unit: `MB/s`. Valid values: `1200`, `1500`, `600`. **NOTE:** The transmission bandwidth of data flow must be less than the IO bandwidth of the file system.
        :param pulumi.Input[builtins.str] description: The Description of the data flow. Restrictions:
        :param pulumi.Input[builtins.bool] dry_run: The dry run.
        :param pulumi.Input[builtins.str] source_security_type: The security protection type of the source storage. If the source storage must be accessed through security protection, specify the security protection type of the source storage. Value:
        ...
        :param pulumi.Input[builtins.str] status: The status of the Data flow. Valid values: `Running`, `Stopped`.
        """
    ...
    def fset_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @fset_id.setter
    def fset_id(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def throughput(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @throughput.setter
    def throughput(self, value: pulumi.Input[builtins.int]):
    ...
    def source_security_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_security_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DataFlowState:
    def __init__(__self__, *,
                 data_flow_id: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 dry_run: Optional[pulumi.Input[builtins.bool]] = None,
                 file_system_id: Optional[pulumi.Input[builtins.str]] = None,
                 fset_id: Optional[pulumi.Input[builtins.str]] = None,
                 source_security_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] data_flow_id: The ID of the Data flow.
        :param pulumi.Input[builtins.str] description: The Description of the data flow. Restrictions:
        :param pulumi.Input[builtins.bool] dry_run: The dry run.
        :param pulumi.Input[builtins.str] file_system_id: The ID of the file system.
        :param pulumi.Input[builtins.str] fset_id: The ID of the Fileset.
    ...
    def data_flow_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @data_flow_id.setter
    def data_flow_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="fsetId")
    def fset_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Fileset.
        """
        return pulumi.get(self, "fset_id")
    ...
    @fset_id.setter
    def fset_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "fset_id", value)
...
class DataFlow(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_storage: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            throughput: Optional[pulumi.Input[builtins.int]] = None) -> 'DataFlow':
        """
    ...
    @property
    @pulumi.getter(name="dataFlowId")
    def data_flow_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Data flow.
        """
        return pulumi.get(self, "data_flow_id")
    ...
    @property
    @pulumi.getter(name="fsetId")
    def fset_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Fileset.
        """
        return pulumi.get(self, "fset_id")
    ...
    @property
    @pulumi.getter(name="sourceSecurityType")
    def source_security_type(self) -> pulumi.Output[builtins.str]:
        """
        The security protection type of the source storage. If the source storage must be accessed through security protection, specify the security protection type of the source storage. Value:
        - `NONE` (default): Indicates that the source storage does not need to be accessed through security protection.
        - `SSL`: Protects access through SSL certificates.
