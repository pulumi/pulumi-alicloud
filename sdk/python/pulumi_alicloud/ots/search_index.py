...
class SearchIndexArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] time_to_live: The index type of the OTS Table. Specifies the retention period of data in the search index. Unit: seconds. Default value: -1.
...
class _SearchIndexState:
    def __init__(__self__, *,
                 ...
                 current_sync_timestamp: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 sync_phase: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] create_time: The search index create time.
        :param pulumi.Input[builtins.int] current_sync_timestamp: The timestamp for sync phase.
        :param pulumi.Input[builtins.str] index_id: The index id of the search index which could not be changed.
        :param pulumi.Input[builtins.str] index_name: The index name of the OTS Table. If changed, a new index would be created.
        :param pulumi.Input[builtins.str] instance_name: The name of the OTS instance in which table will located.
        :param pulumi.Input[Sequence[pulumi.Input['SearchIndexSchemaArgs']]] schemas: The schema of the search index. If changed, a new index would be created. See `schema` below.
        :param pulumi.Input[builtins.str] sync_phase: The search index sync phase. possible values: `Full`, `Incr`.
        :param pulumi.Input[builtins.str] table_name: The name of the OTS table. If changed, a new table would be created.
        :param pulumi.Input[builtins.int] time_to_live: The index type of the OTS Table. Specifies the retention period of data in the search index. Unit: seconds. Default value: -1.
               If the retention period exceeds the TTL value, OTS automatically deletes expired data.
        """
    ...
    def current_sync_timestamp(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def current_sync_timestamp(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def sync_phase(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sync_phase.setter
    def sync_phase(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SearchIndex(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sync_phase: Optional[pulumi.Input[builtins.str]] = None,
            table_name: Optional[pulumi.Input[builtins.str]] = None,
            time_to_live: Optional[pulumi.Input[builtins.int]] = None) -> 'SearchIndex':
        """
    ...
    @property
    @pulumi.getter(name="currentSyncTimestamp")
    def current_sync_timestamp(self) -> pulumi.Output[builtins.int]:
        """
        The timestamp for sync phase.
        """
        return pulumi.get(self, "current_sync_timestamp")
    ...
    @property
    @pulumi.getter(name="syncPhase")
    def sync_phase(self) -> pulumi.Output[builtins.str]:
        """
        The search index sync phase. possible values: `Full`, `Incr`.
        """
        return pulumi.get(self, "sync_phase")
    ...
    @property
    @pulumi.getter(name="timeToLive")
    def time_to_live(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The index type of the OTS Table. Specifies the retention period of data in the search index. Unit: seconds. Default value: -1.
        If the retention period exceeds the TTL value, OTS automatically deletes expired data.
        """
