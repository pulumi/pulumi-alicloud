...
def get_search_indexes(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param _builtins.str name_regex: A regex string to filter results by search index name.
...
def get_search_indexes_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
