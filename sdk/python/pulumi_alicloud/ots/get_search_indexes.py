...
def get_search_indexes(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of search index IDs.
    :param builtins.str instance_name: The name of OTS instance.
    :param builtins.str name_regex: A regex string to filter results by search index name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str table_name: The name of OTS table.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_search_indexes_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
