...
class SearchIndexSchemaFieldSchema(dict):
    ...
    def __init__(__self__, *,
                 ...
                 analyzer: Optional[builtins.str] = None,
                 enable_sort_and_agg: Optional[builtins.bool] = None,
                 index: Optional[builtins.bool] = None,
                 is_array: Optional[builtins.bool] = None,
                 store: Optional[builtins.bool] = None):
        """
        :param builtins.str field_name: The name of the field that is used to sort data. only required if sorter_type is FieldSort.
        :param builtins.str field_type: Specifies the type of the field. Valid values: Text, Long, Double, Boolean, Keyword, Date, GeoPoint, Nested.
        :param builtins.str analyzer: Specifies the type of the analyzer that you want to use. If fieldType is set to Text, you can configure this parameter. Otherwise, the default analyzer type single-word tokenization is used.
        :param builtins.bool enable_sort_and_agg: Specifies whether to enable sorting and aggregation. Type: Boolean. Sorting can be enabled only for fields for which enable_sort_and_agg is set to true.
        :param builtins.bool index: Specifies whether to enable indexing for the column. Type: Boolean.
        :param builtins.bool is_array: Specifies whether the value is an array. Type: Boolean.
        :param builtins.bool store: Specifies whether to store the value of the field in the search index. Type: Boolean. If you set store to true, you can read the value of the field from the search index without querying the data table. This improves query performance.
        """
    ...
    @property
    @pulumi.getter
    def analyzer(self) -> Optional[builtins.str]:
        """
    ...
    def enable_sort_and_agg(self) -> Optional[builtins.bool]:
        """
...
class SearchIndexSchemaIndexSetting(dict):
    ...
    def __init__(__self__, *,
                 routing_fields: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] routing_fields: Specifies custom routing fields. You can specify some primary key columns as routing fields. Tablestore distributes data that is written to a search index across different partitions based on the specified routing fields. The data whose routing field values are the same is distributed to the same partition.
        """
    ...
    def routing_fields(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SearchIndexSchemaIndexSortSorter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sorter_type: Optional[builtins.str] = None):
        """
        :param builtins.str field_name: The name of the field that is used to sort data. only required if sorter_type is FieldSort.
        :param builtins.str mode: The sorting method that is used when the field contains multiple values. valid values: `Min`, `Max`, `Avg`. only required if sorter_type is FieldSort.
        :param builtins.str order: The sort order. Data can be sorted in ascending(`Asc`) or descending(`Desc`) order. Default value: `Asc`.
        :param builtins.str sorter_type: Data is sorted by Which fields or keys. valid values: `PrimaryKeySort`, `FieldSort`.
        """
    ...
    def sorter_type(self) -> Optional[builtins.str]:
        """
...
class TableDefinedColumn(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str name: Name for defined column.
        :param builtins.str type: Type for defined column. `Integer`, `String`, `Binary`, `Double`, `Boolean` is allowed.
        """
...
class TablePrimaryKey(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str name: Name for primary key.
        :param builtins.str type: Type for primary key. Only `Integer`, `String` or `Binary` is allowed.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class TunnelChannel(dict):
    ...
    def __init__(__self__, *,
                 ...
                 channel_rpo: Optional[builtins.int] = None,
                 channel_status: Optional[builtins.str] = None,
                 channel_type: Optional[builtins.str] = None,
                 client_id: Optional[builtins.str] = None):
        """
        :param builtins.str channel_id: The id of the channel.
        :param builtins.int channel_rpo: The latest consumption time of the channel, unix time in nanosecond.
        :param builtins.str channel_status: The status of the channel, valid values: `WAIT`, `OPEN`, `CLOSING`, `CLOSE`, `TERMINATED`.
        :param builtins.str channel_type: The type of the channel, valid values: `BaseData`, `Stream`.
        :param builtins.str client_id: The client id of the channel.
        """
    ...
    def channel_rpo(self) -> Optional[builtins.int]:
        """
    ...
    def channel_status(self) -> Optional[builtins.str]:
        """
...
class GetSearchIndexesIndexResult(dict):
    def __init__(__self__, *,
                 ...
                 current_sync_timestamp: builtins.int,
                 id: builtins.str,
                 index_name: builtins.str,
                 instance_name: builtins.str,
                 metering_last_update_time: builtins.int,
                 reserved_read_cu: builtins.int,
                 row_count: builtins.int,
                 schema: builtins.str,
                 storage_size: builtins.int,
                 sync_phase: builtins.str,
                 table_name: builtins.str,
                 time_to_live: builtins.int):
        """
        :param builtins.int create_time: The creation time of the index.
        :param builtins.int current_sync_timestamp: Timestamp for sync phase.
        :param builtins.str id: The resource ID. The value is `<instance_name>:<table_name>:<indexName>:<indexType>`.
        :param builtins.str index_name: The index name of the OTS Table which could not be changed.
        :param builtins.str instance_name: The name of OTS instance.
        :param builtins.int metering_last_update_time: Last update time for metering data..
        :param builtins.int reserved_read_cu: Reserve related resources for the index.
        :param builtins.int row_count: The number of rows of data for index.
        :param builtins.str schema: JSON representation of the schema of index.
        :param builtins.int storage_size: Storage space occupied by index.
        :param builtins.str sync_phase: The synchronization state of the index.
        :param builtins.str table_name: The name of OTS table.
        :param builtins.int time_to_live: TTL of index.
        """
        pulumi.set(__self__, "create_time", create_time)
    ...
    def current_sync_timestamp(self) -> builtins.int:
        """
    ...
    def metering_last_update_time(self) -> builtins.int:
        """
    ...
    def reserved_read_cu(self) -> builtins.int:
        """
    ...
    def sync_phase(self) -> builtins.str:
        """
...
class GetSecondaryIndexesIndexResult(dict):
    def __init__(__self__, *,
                 defined_columns: Sequence[builtins.str],
                 id: builtins.str,
                 index_name: builtins.str,
                 ...
                 table_name: builtins.str):
        """
        :param Sequence[builtins.str] defined_columns: A list of defined column for index, referenced from Table's primary keys or predefined columns.
        :param builtins.str id: The resource ID. The value is `<instance_name>:<table_name>:<indexName>:<indexType>`.
        :param builtins.str index_name: The index name of the OTS Table which could not be changed.
        :param builtins.str index_type: The index type of the OTS Table which could not be changed.
        :param builtins.str instance_name: The name of OTS instance.
        :param Sequence[builtins.str] primary_keys: A list of primary keys for index, referenced from Table's primary keys or predefined columns.
        :param builtins.str table_name: The name of OTS table.
        """
    ...
    def defined_columns(self) -> Sequence[builtins.str]:
        """
...
class GetTunnelsTunnelResult(dict):
    def __init__(__self__, *,
                 ...
                 tunnel_rpo: builtins.int,
                 tunnel_stage: builtins.str,
        ...
        :param builtins.int create_time: The creation time of the Tunnel.
        :param builtins.bool expired: Whether the tunnel has expired.
        :param builtins.str id: The resource ID. The value is `<instance_name>:<table_name>:<tunnel_name>`.
        :param builtins.str instance_name: The name of OTS instance.
        :param builtins.str table_name: The name of OTS table.
        :param builtins.str tunnel_id: The tunnel id of the OTS which could not be changed.
        :param builtins.str tunnel_name: The tunnel name of the OTS which could not be changed.
        :param builtins.int tunnel_rpo: The latest consumption time of the tunnel, unix time in nanosecond.
        :param builtins.str tunnel_stage: The stage of OTS tunnel, valid values: `InitBaseDataAndStreamShard`, `ProcessBaseData`, `ProcessStream`.
        :param builtins.str tunnel_type: The type of the OTS tunnel, valid values: `BaseAndStream`, `BaseData`, `Stream`.
        """
    ...
    def tunnel_rpo(self) -> builtins.int:
        """
    ...
    def tunnel_stage(self) -> builtins.str:
        """
...
class GetTunnelsTunnelChannelResult(dict):
    def __init__(__self__, *,
                 ...
                 channel_rpo: builtins.int,
                 channel_status: builtins.str,
    ...
    @property
    @pulumi.getter(name="channelRpo")
    def channel_rpo(self) -> builtins.int:
        """
        The latest consumption time of the channel, unix time in nanosecond
        """
        return pulumi.get(self, "channel_rpo")
    ...
    @property
    @pulumi.getter(name="channelStatus")
    def channel_status(self) -> builtins.str:
        """
        The status of the channel, valid values: `WAIT`, `OPEN`, `CLOSING`, `CLOSE`, `TERMINATED`.
        """
        return pulumi.get(self, "channel_status")
