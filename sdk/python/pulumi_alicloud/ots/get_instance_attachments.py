...
def get_instance_attachments(instance_name: Optional[builtins.str] = None,
    ...
    :param builtins.str name_regex: A regex string to filter results by vpc name.
...
def get_instance_attachments_output(instance_name: Optional[pulumi.Input[builtins.str]] = None,
