...
class InstanceAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_name: The name of the OTS instance.
        :param pulumi.Input[builtins.str] vpc_name: The name of attaching VPC to instance. It can only contain letters and numbers, must start with a letter, and is limited to 3-16 characters in length.
...
class _InstanceAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_name: The name of the OTS instance.
        :param pulumi.Input[builtins.str] vpc_id: The ID of attaching VPC to instance.
        :param pulumi.Input[builtins.str] vpc_name: The name of attaching VPC to instance. It can only contain letters and numbers, must start with a letter, and is limited to 3-16 characters in length.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of attaching VSwitch to instance.
        """
...
@pulumi.type_token("alicloud:ots/instanceAttachment:InstanceAttachment")
class InstanceAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vpc_name: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'InstanceAttachment':
        """
