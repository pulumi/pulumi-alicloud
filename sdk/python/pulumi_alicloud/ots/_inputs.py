...
class SearchIndexSchemaFieldSchemaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] analyzer: Specifies the type of the analyzer that you want to use. If fieldType is set to Text, you can configure this parameter. Otherwise, the default analyzer type single-word tokenization is used.
        :param pulumi.Input[_builtins.bool] enable_sort_and_agg: Specifies whether to enable sorting and aggregation. Type: Boolean. Sorting can be enabled only for fields for which enable_sort_and_agg is set to true.
        :param pulumi.Input[_builtins.bool] index: Specifies whether to enable indexing for the column. Type: Boolean.
        :param pulumi.Input[_builtins.bool] is_array: Specifies whether the value is an array. Type: Boolean.
        :param pulumi.Input[_builtins.bool] store: Specifies whether to store the value of the field in the search index. Type: Boolean. If you set store to true, you can read the value of the field from the search index without querying the data table. This improves query performance.
        """
...
class SearchIndexSchemaIndexSortSorterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] order: The sort order. Data can be sorted in ascending(`Asc`) or descending(`Desc`) order. Default value: `Asc`.
        :param pulumi.Input[_builtins.str] sorter_type: Data is sorted by Which fields or keys. valid values: `PrimaryKeySort`, `FieldSort`.
        """
...
class TableDefinedColumnArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] name: Name for defined column.
        :param pulumi.Input[_builtins.str] type: Type for defined column. `Integer`, `String`, `Binary`, `Double`, `Boolean` is allowed.
        """
...
class TablePrimaryKeyArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] name: Name for primary key.
        :param pulumi.Input[_builtins.str] type: Type for primary key. Only `Integer`, `String` or `Binary` is allowed.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class TunnelChannelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] channel_status: The status of the channel, valid values: `WAIT`, `OPEN`, `CLOSING`, `CLOSE`, `TERMINATED`.
        :param pulumi.Input[_builtins.str] channel_type: The type of the channel, valid values: `BaseData`, `Stream`.
        :param pulumi.Input[_builtins.str] client_id: The client id of the channel.
        """
