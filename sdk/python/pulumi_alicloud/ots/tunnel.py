...
class TunnelArgs:
    def __init__(__self__, *,
                 ...
                 tunnel_name: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] tunnel_type: The type of the OTS tunnel. Only `BaseAndStream`, `BaseData` or `Stream` is allowed.
        """
    ...
    def tunnel_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @tunnel_name.setter
    def tunnel_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "tunnel_name", value)

    @_builtins.property
    @pulumi.getter(name="tunnelType")
    def tunnel_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @tunnel_type.setter
    def tunnel_type(self, value: pulumi.Input[_builtins.str]):
...
class _TunnelState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_name: The name of the OTS instance in which table will located.
        :param pulumi.Input[_builtins.str] table_name: The name of the OTS table. If changed, a new table would be created.
        :param pulumi.Input[_builtins.str] tunnel_id: The tunnel id of the OTS which could not be changed.
        :param pulumi.Input[_builtins.str] tunnel_name: The name of the OTS tunnel. If changed, a new tunnel would be created.
        :param pulumi.Input[_builtins.int] tunnel_rpo: The latest consumption time of the tunnel, unix time in nanosecond.
        :param pulumi.Input[_builtins.str] tunnel_stage: The stage of OTS tunnel, valid values: `InitBaseDataAndStreamShard`, `ProcessBaseData`, `ProcessStream`.
        :param pulumi.Input[_builtins.str] tunnel_type: The type of the OTS tunnel. Only `BaseAndStream`, `BaseData` or `Stream` is allowed.
        """
...
class Tunnel(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="tunnelName")
    def tunnel_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the OTS tunnel. If changed, a new tunnel would be created.
        """
        return pulumi.get(self, "tunnel_name")
    ...
    @_builtins.property
    @pulumi.getter(name="tunnelRpo")
    def tunnel_rpo(self) -> pulumi.Output[_builtins.int]:
        """
        The latest consumption time of the tunnel, unix time in nanosecond.
        """
        return pulumi.get(self, "tunnel_rpo")
    ...
    @_builtins.property
    @pulumi.getter(name="tunnelStage")
    def tunnel_stage(self) -> pulumi.Output[_builtins.str]:
        """
        The stage of OTS tunnel, valid values: `InitBaseDataAndStreamShard`, `ProcessBaseData`, `ProcessStream`.
        """
        return pulumi.get(self, "tunnel_stage")
    ...
    @_builtins.property
    @pulumi.getter(name="tunnelType")
    def tunnel_type(self) -> pulumi.Output[_builtins.str]:
        """
        The type of the OTS tunnel. Only `BaseAndStream`, `BaseData` or `Stream` is allowed.
        """
        return pulumi.get(self, "tunnel_type")
