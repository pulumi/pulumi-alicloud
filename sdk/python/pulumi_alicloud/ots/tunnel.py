...
class TunnelArgs:
    def __init__(__self__, *,
                 ...
                 tunnel_name: pulumi.Input[builtins.str],
                 tunnel_type: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] table_name: The name of the OTS table. If changed, a new table would be created.
        :param pulumi.Input[builtins.str] tunnel_name: The name of the OTS tunnel. If changed, a new tunnel would be created.
        :param pulumi.Input[builtins.str] tunnel_type: The type of the OTS tunnel. Only `BaseAndStream`, `BaseData` or `Stream` is allowed.
        """
    ...
    def tunnel_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @tunnel_name.setter
    def tunnel_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "tunnel_name", value)

    @property
    @pulumi.getter(name="tunnelType")
    def tunnel_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @tunnel_type.setter
    def tunnel_type(self, value: pulumi.Input[builtins.str]):
...
class _TunnelState:
    def __init__(__self__, *,
                 ...
                 tunnel_rpo: Optional[pulumi.Input[builtins.int]] = None,
                 tunnel_stage: Optional[pulumi.Input[builtins.str]] = None,
                 tunnel_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] create_time: The creation time of the Tunnel.
        :param pulumi.Input[builtins.bool] expired: Whether the tunnel has expired.
        :param pulumi.Input[builtins.str] instance_name: The name of the OTS instance in which table will located.
        :param pulumi.Input[builtins.str] table_name: The name of the OTS table. If changed, a new table would be created.
        :param pulumi.Input[builtins.str] tunnel_id: The tunnel id of the OTS which could not be changed.
        :param pulumi.Input[builtins.str] tunnel_name: The name of the OTS tunnel. If changed, a new tunnel would be created.
        :param pulumi.Input[builtins.int] tunnel_rpo: The latest consumption time of the tunnel, unix time in nanosecond.
        :param pulumi.Input[builtins.str] tunnel_stage: The stage of OTS tunnel, valid values: `InitBaseDataAndStreamShard`, `ProcessBaseData`, `ProcessStream`.
        :param pulumi.Input[builtins.str] tunnel_type: The type of the OTS tunnel. Only `BaseAndStream`, `BaseData` or `Stream` is allowed.
        """
    ...
    def tunnel_rpo(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @tunnel_rpo.setter
    def tunnel_rpo(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "tunnel_rpo", value)

    @property
    @pulumi.getter(name="tunnelStage")
    def tunnel_stage(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @tunnel_stage.setter
    def tunnel_stage(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tunnel_stage", value)

    @property
    @pulumi.getter(name="tunnelType")
    def tunnel_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the OTS tunnel. Only `BaseAndStream`, `BaseData` or `Stream` is allowed.
        """
        return pulumi.get(self, "tunnel_type")
    ...
    @tunnel_type.setter
    def tunnel_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tunnel_type", value)
...
class Tunnel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tunnel_rpo: Optional[pulumi.Input[builtins.int]] = None,
            tunnel_stage: Optional[pulumi.Input[builtins.str]] = None,
            tunnel_type: Optional[pulumi.Input[builtins.str]] = None) -> 'Tunnel':
        """
    ...
    @property
    @pulumi.getter(name="tunnelName")
    def tunnel_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the OTS tunnel. If changed, a new tunnel would be created.
        """
        return pulumi.get(self, "tunnel_name")
    ...
    @property
    @pulumi.getter(name="tunnelRpo")
    def tunnel_rpo(self) -> pulumi.Output[builtins.int]:
        """
        The latest consumption time of the tunnel, unix time in nanosecond.
        """
        return pulumi.get(self, "tunnel_rpo")
    ...
    @property
    @pulumi.getter(name="tunnelStage")
    def tunnel_stage(self) -> pulumi.Output[builtins.str]:
        """
        The stage of OTS tunnel, valid values: `InitBaseDataAndStreamShard`, `ProcessBaseData`, `ProcessStream`.
        """
        return pulumi.get(self, "tunnel_stage")
    ...
    @property
    @pulumi.getter(name="tunnelType")
    def tunnel_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the OTS tunnel. Only `BaseAndStream`, `BaseData` or `Stream` is allowed.
        """
        return pulumi.get(self, "tunnel_type")
