...
class SecondaryIndexArgs:
    def __init__(__self__, *,
                 include_base_data: pulumi.Input[builtins.bool],
                 ...
                 defined_columns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a SecondaryIndex resource.
        :param pulumi.Input[builtins.bool] include_base_data: whether the index contains data that already exists in the data table. When include_base_data is set to true, it means that stock data is included.
        :param pulumi.Input[builtins.str] index_name: The index name of the OTS Table. If changed, a new index would be created.
        :param pulumi.Input[builtins.str] index_type: The index type of the OTS Table. If changed, a new index would be created, only `Global` or `Local` is allowed.
        :param pulumi.Input[builtins.str] instance_name: The name of the OTS instance in which table will located.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] primary_keys: A list of primary keys for index, referenced from Table's primary keys or predefined columns.
        :param pulumi.Input[builtins.str] table_name: The name of the OTS table. If changed, a new table would be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] defined_columns: A list of defined column for index, referenced from Table's primary keys or predefined columns.
        """
    ...
    def include_base_data(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def include_base_data(self, value: pulumi.Input[builtins.bool]):
    ...
    def defined_columns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def defined_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _SecondaryIndexState:
    def __init__(__self__, *,
                 defined_columns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 include_base_data: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="includeBaseData")
    def include_base_data(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        whether the index contains data that already exists in the data table. When include_base_data is set to true, it means that stock data is included.
        """
        return pulumi.get(self, "include_base_data")
    ...
    @include_base_data.setter
    def include_base_data(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "include_base_data", value)
...
class SecondaryIndex(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_name: Optional[pulumi.Input[builtins.str]] = None,
            primary_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            table_name: Optional[pulumi.Input[builtins.str]] = None) -> 'SecondaryIndex':
        """
    ...
    @property
    @pulumi.getter(name="definedColumns")
    def defined_columns(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of defined column for index, referenced from Table's primary keys or predefined columns.
        """
        return pulumi.get(self, "defined_columns")
    ...
    @property
    @pulumi.getter(name="includeBaseData")
    def include_base_data(self) -> pulumi.Output[builtins.bool]:
        """
        whether the index contains data that already exists in the data table. When include_base_data is set to true, it means that stock data is included.
        """
        return pulumi.get(self, "include_base_data")
