...
def get_secondary_indexes(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param _builtins.str name_regex: A regex string to filter results by secondary index name.
