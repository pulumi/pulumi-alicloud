...
def get_secondary_indexes(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of secondary index IDs.
    :param builtins.str instance_name: The name of OTS instance.
    :param builtins.str name_regex: A regex string to filter results by secondary index name.
...
def get_secondary_indexes_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
