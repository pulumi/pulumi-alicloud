...
def get_tunnels(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of tunnel IDs.
    :param builtins.str instance_name: The name of OTS instance.
    :param builtins.str name_regex: A regex string to filter results by tunnel name.
...
def get_tunnels_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
