...
def get_tables(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of table IDs.
    :param builtins.str instance_name: The name of OTS instance.
    :param builtins.str name_regex: A regex string to filter results by table name.
...
def get_tables_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:ots/getTables:getTables', __args__, opts=opts, typ=GetTablesResult)
