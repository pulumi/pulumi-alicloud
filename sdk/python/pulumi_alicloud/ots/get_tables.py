...
def get_tables(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of table IDs.
    :param _builtins.str instance_name: The name of OTS instance.
    :param _builtins.str name_regex: A regex string to filter results by table name.
