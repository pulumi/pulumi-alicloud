...
class BucketReplication(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cross_region_replication = alicloud.ots.BucketReplication("cross-region-replication",
            action="ALL",
            bucket="bucket-in-hangzhou",
            destination=alicloud.ots.BucketReplicationDestinationArgs(
                bucket="bucket-in-beijing",
                location="oss-cn-beijing",
            ))
        same_region_replication = alicloud.ots.BucketReplication("same-region-replication",
            action="ALL",
            bucket="bucket-in-hangzhou",
            destination=alicloud.ots.BucketReplicationDestinationArgs(
        ...
        replication_with_prefix = alicloud.ots.BucketReplication("replication-with-prefix",
            action="ALL",
            bucket="bucket-1",
            destination=alicloud.ots.BucketReplicationDestinationArgs(
                bucket="bucket-2",
            ...
            prefix_set=alicloud.ots.BucketReplicationPrefixSetArgs(
                prefixes=[
                    "prefix1/",
                    "prefix2/",
                ],
            ))
        replication_with_specific_action = alicloud.ots.BucketReplication("replication-with-specific-action",
            action="PUT",
            bucket="bucket-1",
            destination=alicloud.ots.BucketReplicationDestinationArgs(
                bucket="bucket-2",
            ...
            historical_object_replication="disabled")
        replication_with_kms_encryption = alicloud.ots.BucketReplication("replication-with-kms-encryption",
            action="ALL",
            bucket="bucket-1",
            destination=alicloud.ots.BucketReplicationDestinationArgs(
                bucket="bucket-2",
            ...
            encryption_configuration=alicloud.ots.BucketReplicationEncryptionConfigurationArgs(
                replica_kms_key_id="<your kms key id>",
            ),
            historical_object_replication="disabled",
            source_selection_criteria=alicloud.ots.BucketReplicationSourceSelectionCriteriaArgs(
                sse_kms_encrypted_objects=alicloud.ots.BucketReplicationSourceSelectionCriteriaSseKmsEncryptedObjectsArgs(
                    status="Enabled",
                ),
            ),
    ...
    def _internal_init(__self__,
        ...
        super(BucketReplication, __self__).__init__(
            'alicloud:ots/bucketReplication:BucketReplication',
            resource_name,
            __props__,
            opts)
