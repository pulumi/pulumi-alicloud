...
class NasFileSystemArgs:
    def __init__(__self__, *,
                 ...
                 nas_file_system_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The description of nas file system.
        :param pulumi.Input[builtins.str] file_system_id: The filesystem id of nas file system.
        :param pulumi.Input[builtins.str] mount_target_domain: The domain of mount target.
        :param pulumi.Input[builtins.str] nas_file_system_name: The name of nas file system.
        :param pulumi.Input[builtins.bool] reset: The mount point is in an inactive state, reset the mount point of the NAS file system. Default to `false`.
        """
    ...
    def nas_file_system_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nas_file_system_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NasFileSystemState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] office_site_id: The ID of office site.
        :param pulumi.Input[builtins.bool] reset: The mount point is in an inactive state, reset the mount point of the NAS file system. Default to `false`.
        :param pulumi.Input[builtins.str] status: The status of nas file system. Valid values: `Pending`, `Running`, `Stopped`,`Deleting`, `Deleted`, `Invalid`.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if file_system_id is not None:
...
class NasFileSystem(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            office_site_id: Optional[pulumi.Input[builtins.str]] = None,
            reset: Optional[pulumi.Input[builtins.bool]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'NasFileSystem':
        """
    ...
    @property
    @pulumi.getter(name="nasFileSystemName")
    def nas_file_system_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of nas file system.
        """
        return pulumi.get(self, "nas_file_system_name")
    ...
    @property
    @pulumi.getter
    def reset(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The mount point is in an inactive state, reset the mount point of the NAS file system. Default to `false`.
        """
        return pulumi.get(self, "reset")
