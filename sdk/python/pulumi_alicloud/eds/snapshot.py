...
class SnapshotArgs:
    ...
    def source_disk_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def source_disk_type(self, value: pulumi.Input[_builtins.str]):
...
class Snapshot(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="sourceDiskType")
    def source_disk_type(self) -> pulumi.Output[_builtins.str]:
        """
        The type of the disk for which to create a snapshot. Valid values: `SYSTEM`, `DATA`.
        """
        return pulumi.get(self, "source_disk_type")
