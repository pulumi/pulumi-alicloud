...
class CustomPropertyArgs:
    def __init__(__self__, *,
                 property_key: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] property_key: The Custom attribute key.
    ...
    def property_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @property_key.setter
    def property_key(self, value: pulumi.Input[builtins.str]):
...
class _CustomPropertyState:
    def __init__(__self__, *,
                 property_key: Optional[pulumi.Input[builtins.str]] = None,
                 property_values: Optional[pulumi.Input[Sequence[pulumi.Input['CustomPropertyPropertyValueArgs']]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="propertyKey")
    def property_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Custom attribute key.
        """
        return pulumi.get(self, "property_key")
    ...
    @property_key.setter
    def property_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "property_key", value)
...
class CustomProperty(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="propertyKey")
    def property_key(self) -> pulumi.Output[builtins.str]:
        """
        The Custom attribute key.
        """
        return pulumi.get(self, "property_key")
