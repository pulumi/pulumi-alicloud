...
def get_zones(output_file: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:eds/getZones:getZones', __args__, opts=opts, typ=GetZonesResult).value
...
def get_zones_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:eds/getZones:getZones', __args__, opts=opts, typ=GetZonesResult)
