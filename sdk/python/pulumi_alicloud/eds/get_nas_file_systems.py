...
class GetNasFileSystemsResult:
    ...
    def office_site_id(self) -> Optional[builtins.str]:
...
def get_nas_file_systems(ids: Optional[Sequence[builtins.str]] = None,
                         name_regex: Optional[builtins.str] = None,
                         office_site_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Nas File System IDs.
    :param builtins.str name_regex: A regex string to filter results by Nas File System name.
...
def get_nas_file_systems_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                office_site_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
