...
class GetImagesResult:
    ...
    def desktop_instance_type(self) -> Optional[builtins.str]:
...
def get_images(desktop_instance_type: Optional[builtins.str] = None,
    ...
    :param builtins.str desktop_instance_type: The desktop type of the image.
    :param Sequence[builtins.str] ids: A list of Image IDs.
    :param builtins.str image_type: The image type of the image. Valid values: `SYSTEM`, `CUSTOM`.
    :param builtins.str name_regex: A regex string to filter results by Image name.
...
def get_images_output(desktop_instance_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
