...
def get_ram_directories(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Ram Directory IDs.
    :param _builtins.str name_regex: A regex string to filter results by Ram Directory name.
...
def get_ram_directories_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                               name_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRamDirectoriesResult]:
    """
    This data source provides the Ecd Ram Directories of the current Alibaba Cloud user.
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:eds/getRamDirectories:getRamDirectories', __args__, opts=opts, typ=GetRamDirectoriesResult)
    return __ret__.apply(lambda __response__: GetRamDirectoriesResult(
