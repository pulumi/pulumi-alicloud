...
def get_ram_directories(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ram Directory IDs.
    :param builtins.str name_regex: A regex string to filter results by Ram Directory name.
...
def get_ram_directories_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
