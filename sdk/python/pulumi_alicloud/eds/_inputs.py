...
if not MYPY:
    class CustomPropertyPropertyValueArgsDict(TypedDict):
        ...
        """
        property_value_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CustomPropertyPropertyValueArgs:
    def __init__(__self__, *,
                 ...
                 property_value_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] property_value: The value of an attribute.
        :param pulumi.Input[builtins.str] property_value_id: The value of an attribute id.
        """
    ...
    def property_value_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The value of an attribute id.
        """
    ...
    def property_value_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EcdPolicyGroupAuthorizeAccessPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cidr_ip: The cidrip of authorize access rule.
        :param pulumi.Input[builtins.str] description: The description of authorize access rule.
        """
...
class EcdPolicyGroupAuthorizeSecurityPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cidr_ip: The cidrip of security rules.
        :param pulumi.Input[builtins.str] description: The description of security rules.
        :param pulumi.Input[builtins.str] ip_protocol: The ip protocol of security rules.
        :param pulumi.Input[builtins.str] policy: The policy of security rules.
        :param pulumi.Input[builtins.str] port_range: The port range of security rules.
        :param pulumi.Input[builtins.str] priority: The priority of security rules.
        :param pulumi.Input[builtins.str] type: The type of security rules.
        """
        if cidr_ip is not None:
            pulumi.set(__self__, "cidr_ip", cidr_ip)
        if description is not None:
