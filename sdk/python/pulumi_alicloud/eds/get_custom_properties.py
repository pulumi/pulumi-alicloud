...
def get_custom_properties(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Custom Property IDs.
...
def get_custom_properties_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
