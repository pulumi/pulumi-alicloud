...
def get_custom_properties(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Custom Property IDs.
...
def get_custom_properties_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
