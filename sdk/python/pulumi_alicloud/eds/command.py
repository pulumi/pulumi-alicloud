...
class CommandArgs:
    def __init__(__self__, *,
                 ...
                 command_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] command_content: The Contents of the Script to Base64 Encoded Transmission.
        :param pulumi.Input[builtins.str] command_type: The Script Type. Valid values: `RunBatScript`, `RunPowerShellScript`.
        :param pulumi.Input[builtins.str] desktop_id: The desktop id of the Desktop.
        :param pulumi.Input[builtins.str] content_encoding: That Returns the Data Encoding Method. Valid values: `Base64`, `PlainText`.
        :param pulumi.Input[builtins.str] timeout: The timeout period for script execution the unit is seconds. Default to: `60`.
        """
    ...
    def command_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @command_type.setter
    def command_type(self, value: pulumi.Input[builtins.str]):
...
class _CommandState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content_encoding: That Returns the Data Encoding Method. Valid values: `Base64`, `PlainText`.
        :param pulumi.Input[builtins.str] desktop_id: The desktop id of the Desktop.
        :param pulumi.Input[builtins.str] status: Script Is Executed in the Overall Implementation of the State. Valid values: `Pending`, `Failed`, `PartialFailed`, `Running`, `Stopped`, `Stopping`, `Finished`, `Success`.
        :param pulumi.Input[builtins.str] timeout: The timeout period for script execution the unit is seconds. Default to: `60`.
        """
...
class Command(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            desktop_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            timeout: Optional[pulumi.Input[builtins.str]] = None) -> 'Command':
        """
