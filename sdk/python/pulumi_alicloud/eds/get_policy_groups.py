...
def get_policy_groups(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Policy Group IDs.
    :param _builtins.str name_regex: A regex string to filter results by Policy Group name.
...
def get_policy_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
