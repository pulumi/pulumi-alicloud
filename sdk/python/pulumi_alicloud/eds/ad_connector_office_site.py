...
class AdConnectorOfficeSiteArgs:
    def __init__(__self__, *,
                 ad_connector_office_site_name: pulumi.Input[builtins.str],
                 cen_id: pulumi.Input[builtins.str],
                 cidr_block: pulumi.Input[builtins.str],
                 dns_addresses: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 domain_name: pulumi.Input[builtins.str],
                 ad_hostname: Optional[pulumi.Input[builtins.str]] = None,
                 bandwidth: Optional[pulumi.Input[builtins.int]] = None,
                 cen_owner_id: Optional[pulumi.Input[builtins.str]] = None,
                 desktop_access_type: Optional[pulumi.Input[builtins.str]] = None,
                 domain_password: Optional[pulumi.Input[builtins.str]] = None,
                 domain_user_name: Optional[pulumi.Input[builtins.str]] = None,
                 enable_admin_access: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 specification: Optional[pulumi.Input[builtins.int]] = None,
                 sub_domain_dns_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 sub_domain_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] ad_connector_office_site_name: The name of the workspace. The name must be 2 to 255 characters in length. It must start with a letter and cannot start with `http://` or `https://`. It can contain digits, colons (:), underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] cen_id: The ID of the CEN instance.
        :param pulumi.Input[builtins.str] cidr_block: Workspace Corresponds to the Security Office Network of IPv4 Segment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_addresses: The IP address N of the DNS server of the enterprise AD system. You can specify only one IP address.
        :param pulumi.Input[builtins.str] domain_name: The domain name of the enterprise AD system. You can register each domain name only once.
        :param pulumi.Input[builtins.str] ad_hostname: The ad hostname.
        :param pulumi.Input[builtins.int] bandwidth: The maximum public bandwidth value. Valid values: 0 to 200. If you do not specify this parameter or you set this parameter to 0, Internet access is disabled.
        :param pulumi.Input[builtins.str] cen_owner_id: The cen owner id.
        :param pulumi.Input[builtins.str] desktop_access_type: The method that you use to connect to cloud desktops. **Note:** The VPC connection method is provided by Alibaba Cloud PrivateLink. You are not charged for PrivateLink. When you set this parameter to VPC or Any, PrivateLink is automatically activated. Default value: `INTERNET`. Valid values:
        ...
        :param pulumi.Input[builtins.str] domain_password: The password of the domain administrator. The password can be up to 64 characters in length.
        :param pulumi.Input[builtins.str] domain_user_name: The username of the domain administrator. The username can be up to 64 characters in length.
        :param pulumi.Input[builtins.bool] enable_admin_access: Specifies whether to grant the permissions of the local administrator to the desktop users. Default value: true.
        :param pulumi.Input[builtins.bool] enable_internet_access: Specifies whether to enable Internet access.
        :param pulumi.Input[builtins.bool] mfa_enabled: Specifies whether to enable multi-factor authentication (MFA).
        :param pulumi.Input[builtins.str] protocol_type: The protocol type. Valid values: `ASP`, `HDX`.
        :param pulumi.Input[builtins.int] specification: The AD Connector specifications. Valid values: `1`, `2`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sub_domain_dns_addresses: The DNS address N of the enterprise AD subdomain. If you specify a value for the `sub_domain_name` parameter but you do not specify a value for this parameter, the DNS address of the subdomain is the same as the DNS address of the parent domain.
        :param pulumi.Input[builtins.str] sub_domain_name: The domain name of the enterprise AD subdomain.
        :param pulumi.Input[builtins.str] verify_code: The verification code. If the CEN instance that you specify for the CenId parameter belongs to another Alibaba Cloud account, you must call the SendVerifyCode operation to obtain the verification code.
        """
    ...
    def ad_connector_office_site_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ad_connector_office_site_name(self, value: pulumi.Input[builtins.str]):
    ...
    def dns_addresses(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def dns_addresses(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def ad_hostname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ad hostname.
        """
    ...
    @ad_hostname.setter
    def ad_hostname(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def desktop_access_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def desktop_access_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "desktop_access_type", value)

    @property
    @pulumi.getter(name="domainPassword")
    def domain_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def domain_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "domain_password", value)

    @property
    @pulumi.getter(name="domainUserName")
    def domain_user_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def domain_user_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "domain_user_name", value)

    @property
    @pulumi.getter(name="enableAdminAccess")
    def enable_admin_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_admin_access(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def specification(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def specification(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "specification", value)

    @property
    @pulumi.getter(name="subDomainDnsAddresses")
    def sub_domain_dns_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def sub_domain_dns_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "sub_domain_dns_addresses", value)

    @property
    @pulumi.getter(name="subDomainName")
    def sub_domain_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sub_domain_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AdConnectorOfficeSiteState:
    def __init__(__self__, *,
                 ad_connector_office_site_name: Optional[pulumi.Input[builtins.str]] = None,
                 ad_hostname: Optional[pulumi.Input[builtins.str]] = None,
                 bandwidth: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 desktop_access_type: Optional[pulumi.Input[builtins.str]] = None,
                 dns_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] protocol_type: The protocol type. Valid values: `ASP`, `HDX`.
        :param pulumi.Input[builtins.int] specification: The AD Connector specifications. Valid values: `1`, `2`.
        :param pulumi.Input[builtins.str] status: The resource State.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sub_domain_dns_addresses: The DNS address N of the enterprise AD subdomain. If you specify a value for the `sub_domain_name` parameter but you do not specify a value for this parameter, the DNS address of the subdomain is the same as the DNS address of the parent domain.
        :param pulumi.Input[builtins.str] sub_domain_name: The domain name of the enterprise AD subdomain.
        :param pulumi.Input[builtins.str] verify_code: The verification code. If the CEN instance that you specify for the CenId parameter belongs to another Alibaba Cloud account, you must call the SendVerifyCode operation to obtain the verification code.
        """
    ...
    @property
    @pulumi.getter(name="adConnectorOfficeSiteName")
    def ad_connector_office_site_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the workspace. The name must be 2 to 255 characters in length. It must start with a letter and cannot start with `http://` or `https://`. It can contain digits, colons (:), underscores (_), and hyphens (-).
        """
        return pulumi.get(self, "ad_connector_office_site_name")
    ...
    @ad_connector_office_site_name.setter
    def ad_connector_office_site_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ad_connector_office_site_name", value)
    ...
    @property
    @pulumi.getter(name="dnsAddresses")
    def dns_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The IP address N of the DNS server of the enterprise AD system. You can specify only one IP address.
        """
        return pulumi.get(self, "dns_addresses")
    ...
    @dns_addresses.setter
    def dns_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "dns_addresses", value)
...
class AdConnectorOfficeSite(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sub_domain_dns_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            sub_domain_name: Optional[pulumi.Input[builtins.str]] = None,
            verify_code: Optional[pulumi.Input[builtins.str]] = None) -> 'AdConnectorOfficeSite':
        """
    ...
    @property
    @pulumi.getter(name="adConnectorOfficeSiteName")
    def ad_connector_office_site_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the workspace. The name must be 2 to 255 characters in length. It must start with a letter and cannot start with `http://` or `https://`. It can contain digits, colons (:), underscores (_), and hyphens (-).
        """
        return pulumi.get(self, "ad_connector_office_site_name")
    ...
    @property
    @pulumi.getter(name="adHostname")
    def ad_hostname(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ad hostname.
        """
        return pulumi.get(self, "ad_hostname")
    ...
    @property
    @pulumi.getter(name="cenOwnerId")
    def cen_owner_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The cen owner id.
        """
        return pulumi.get(self, "cen_owner_id")
    ...
    @property
    @pulumi.getter(name="desktopAccessType")
    def desktop_access_type(self) -> pulumi.Output[builtins.str]:
        """
        The method that you use to connect to cloud desktops. **Note:** The VPC connection method is provided by Alibaba Cloud PrivateLink. You are not charged for PrivateLink. When you set this parameter to VPC or Any, PrivateLink is automatically activated. Default value: `INTERNET`. Valid values:
        - `INTERNET`: connects clients to cloud desktops only over the Internet.
        - `VPC`: connects clients to cloud desktops only over a VPC.
    ...
    @property
    @pulumi.getter(name="dnsAddresses")
    def dns_addresses(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The IP address N of the DNS server of the enterprise AD system. You can specify only one IP address.
        """
        return pulumi.get(self, "dns_addresses")
    ...
    @property
    @pulumi.getter(name="domainPassword")
    def domain_password(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The password of the domain administrator. The password can be up to 64 characters in length.
        """
        return pulumi.get(self, "domain_password")
    ...
    @property
    @pulumi.getter(name="domainUserName")
    def domain_user_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The username of the domain administrator. The username can be up to 64 characters in length.
        """
        return pulumi.get(self, "domain_user_name")
    ...
    @property
    @pulumi.getter(name="enableAdminAccess")
    def enable_admin_access(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to grant the permissions of the local administrator to the desktop users. Default value: true.
        """
        return pulumi.get(self, "enable_admin_access")
    ...
    @property
    @pulumi.getter(name="enableInternetAccess")
    def enable_internet_access(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to enable Internet access.
        """
        return pulumi.get(self, "enable_internet_access")
    ...
    @property
    @pulumi.getter(name="mfaEnabled")
    def mfa_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable multi-factor authentication (MFA).
        """
        return pulumi.get(self, "mfa_enabled")
    ...
    @property
    @pulumi.getter(name="protocolType")
    def protocol_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The protocol type. Valid values: `ASP`, `HDX`.
        """
        return pulumi.get(self, "protocol_type")
    ...
    @property
    @pulumi.getter
    def specification(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The AD Connector specifications. Valid values: `1`, `2`.
        """
        return pulumi.get(self, "specification")
    ...
    @property
    @pulumi.getter(name="subDomainDnsAddresses")
    def sub_domain_dns_addresses(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The DNS address N of the enterprise AD subdomain. If you specify a value for the `sub_domain_name` parameter but you do not specify a value for this parameter, the DNS address of the subdomain is the same as the DNS address of the parent domain.
        """
        return pulumi.get(self, "sub_domain_dns_addresses")
    ...
    @property
    @pulumi.getter(name="subDomainName")
    def sub_domain_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The domain name of the enterprise AD subdomain.
        """
        return pulumi.get(self, "sub_domain_name")
    ...
    @property
    @pulumi.getter(name="verifyCode")
    def verify_code(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The verification code. If the CEN instance that you specify for the CenId parameter belongs to another Alibaba Cloud account, you must call the SendVerifyCode operation to obtain the verification code.
        """
        return pulumi.get(self, "verify_code")
