...
class GetSnapshotsResult:
    ...
    def desktop_id(self) -> Optional[builtins.str]:
...
def get_snapshots(desktop_id: Optional[builtins.str] = None,
    ...
    :param builtins.str desktop_id: The ID of the Desktop.
...
def get_snapshots_output(desktop_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
