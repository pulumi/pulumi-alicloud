...
def get_network_packages(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Network Package IDs.
...
def get_network_packages_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
