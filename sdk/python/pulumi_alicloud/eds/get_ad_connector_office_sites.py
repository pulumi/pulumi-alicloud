...
def get_ad_connector_office_sites(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ad Connector Office Site IDs.
    :param builtins.str name_regex: A regex string to filter results by Ad Connector Office Site name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The workspace status. Valid values:
...
def get_ad_connector_office_sites_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
