...
class NetworkPackageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth of package public network bandwidth peak. Valid values: 1~200. Unit:Mbps.
        :param pulumi.Input[builtins.str] office_site_id: The ID of office site.
        """
...
class _NetworkPackageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth of package public network bandwidth peak. Valid values: 1~200. Unit:Mbps.
        :param pulumi.Input[builtins.str] internet_charge_type: The internet charge type  of  package.
        :param pulumi.Input[builtins.str] office_site_id: The ID of office site.
        :param pulumi.Input[builtins.str] status: The status of network package. Valid values: `Creating`, `InUse`, `Releasing`,`Released`.
        """
...
class NetworkPackage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            internet_charge_type: Optional[pulumi.Input[builtins.str]] = None,
            office_site_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkPackage':
        """
