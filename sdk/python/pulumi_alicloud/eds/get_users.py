...
def get_users(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param _builtins.str status: The status of the resource. Valid values: `Unlocked`, `Locked`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_users_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
