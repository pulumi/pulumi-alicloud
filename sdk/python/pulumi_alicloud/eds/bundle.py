...
class BundleArgs:
    def __init__(__self__, *,
                 desktop_type: pulumi.Input[builtins.str],
                 image_id: pulumi.Input[builtins.str],
                 root_disk_size_gib: pulumi.Input[builtins.int],
                 user_disk_size_gibs: pulumi.Input[Sequence[pulumi.Input[builtins.int]]],
                 bundle_name: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 language: Optional[pulumi.Input[builtins.str]] = None,
                 root_disk_performance_level: Optional[pulumi.Input[builtins.str]] = None,
                 user_disk_performance_level: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Bundle resource.
        :param pulumi.Input[builtins.str] desktop_type: The desktop type. You can call `eds_get_desktop_types` to query desktop type.
        :param pulumi.Input[builtins.str] image_id: The ID of the image.
        :param pulumi.Input[builtins.int] root_disk_size_gib: The root disk size gib.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] user_disk_size_gibs: The size of the data disk. Currently, only one data disk can be set. Unit: GiB.
        ...
        :param pulumi.Input[builtins.str] description: The description of the bundle.
        :param pulumi.Input[builtins.str] language: The language. Valid values: `zh-CN`, `zh-HK`, `en-US`, `ja-JP`.
        :param pulumi.Input[builtins.str] root_disk_performance_level: The root disk performance level. Valid values: `PL0`, `PL1`, `PL2`, `PL3`.
        :param pulumi.Input[builtins.str] user_disk_performance_level: The user disk performance level. Valid values: `PL0`, `PL1`, `PL2`, `PL3`.
        """
    ...
    def desktop_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @desktop_type.setter
    def desktop_type(self, value: pulumi.Input[builtins.str]):
    ...
    def root_disk_size_gib(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def root_disk_size_gib(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "root_disk_size_gib", value)

    @property
    @pulumi.getter(name="userDiskSizeGibs")
    def user_disk_size_gibs(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.int]]]:
        """
    ...
    def user_disk_size_gibs(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]):
        pulumi.set(self, "user_disk_size_gibs", value)

    @property
    @pulumi.getter(name="bundleName")
    def bundle_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @bundle_name.setter
    def bundle_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def root_disk_performance_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def root_disk_performance_level(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "root_disk_performance_level", value)

    @property
    @pulumi.getter(name="userDiskPerformanceLevel")
    def user_disk_performance_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def user_disk_performance_level(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BundleState:
    def __init__(__self__, *,
                 ...
                 user_disk_performance_level: Optional[pulumi.Input[builtins.str]] = None,
                 user_disk_size_gibs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="userDiskSizeGibs")
    def user_disk_size_gibs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
        The size of the data disk. Currently, only one data disk can be set. Unit: GiB.
        - The size of the data disk that supports the setting corresponds to the specification. For more information, see [Overview of Desktop Specifications](https://help.aliyun.com/document_detail/188609.htm?spm=a2c4g.11186623.0.0.6406297bE0U5DG).
        - The data disk size (user_disk_size_gib) set in the template must be greater than the data disk size (data_disk_size) in the mirror.
    ...
    @user_disk_size_gibs.setter
    def user_disk_size_gibs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
        pulumi.set(self, "user_disk_size_gibs", value)
...
class Bundle(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            root_disk_size_gib: Optional[pulumi.Input[builtins.int]] = None,
            user_disk_performance_level: Optional[pulumi.Input[builtins.str]] = None,
            user_disk_size_gibs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None) -> 'Bundle':
        """
    ...
    @property
    @pulumi.getter(name="bundleName")
    def bundle_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the bundle.
        """
        return pulumi.get(self, "bundle_name")
    ...
    @property
    @pulumi.getter(name="rootDiskPerformanceLevel")
    def root_disk_performance_level(self) -> pulumi.Output[builtins.str]:
        """
        The root disk performance level. Valid values: `PL0`, `PL1`, `PL2`, `PL3`.
        """
        return pulumi.get(self, "root_disk_performance_level")
    ...
    @property
    @pulumi.getter(name="rootDiskSizeGib")
    def root_disk_size_gib(self) -> pulumi.Output[builtins.int]:
        """
        The root disk size gib.
        """
        return pulumi.get(self, "root_disk_size_gib")
    ...
    @property
    @pulumi.getter(name="userDiskPerformanceLevel")
    def user_disk_performance_level(self) -> pulumi.Output[builtins.str]:
        """
        The user disk performance level. Valid values: `PL0`, `PL1`, `PL2`, `PL3`.
        """
        return pulumi.get(self, "user_disk_performance_level")
    ...
    @property
    @pulumi.getter(name="userDiskSizeGibs")
    def user_disk_size_gibs(self) -> pulumi.Output[Sequence[builtins.int]]:
        """
        The size of the data disk. Currently, only one data disk can be set. Unit: GiB.
        - The size of the data disk that supports the setting corresponds to the specification. For more information, see [Overview of Desktop Specifications](https://help.aliyun.com/document_detail/188609.htm?spm=a2c4g.11186623.0.0.6406297bE0U5DG).
        - The data disk size (user_disk_size_gib) set in the template must be greater than the data disk size (data_disk_size) in the mirror.
