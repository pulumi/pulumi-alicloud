...
class BundleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] desktop_type: The desktop type. You can call `eds.get_desktop_types` to query desktop type.
    ...
    def desktop_type(self) -> pulumi.Input[str]:
        """
        The desktop type. You can call `eds.get_desktop_types` to query desktop type.
        """
