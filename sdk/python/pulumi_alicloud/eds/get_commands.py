...
def get_commands(command_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str content_encoding: That Returns the Data Encoding Method. Valid values: `Base64`, `PlainText`.
