...
class GetCommandsResult:
    ...
    def command_type(self) -> Optional[builtins.str]:
...
def get_commands(command_type: Optional[builtins.str] = None,
                 content_encoding: Optional[builtins.str] = None,
                 desktop_id: Optional[builtins.str] = None,
    ...
    :param builtins.str content_encoding: That Returns the Data Encoding Method. Valid values: `Base64`, `PlainText`.
...
def get_commands_output(command_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        content_encoding: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        desktop_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
