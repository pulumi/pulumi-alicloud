...
class GetBundlesResult:
    ...
    def bundle_ids(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "bundle_ids")

    @property
    @pulumi.getter(name="bundleType")
    def bundle_type(self) -> Optional[builtins.str]:
...
def get_bundles(bundle_ids: Optional[Sequence[builtins.str]] = None,
                bundle_type: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Bundle IDs.
    :param builtins.str name_regex: A regex string to filter results by Bundle name.
...
def get_bundles_output(bundle_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                       bundle_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetBundlesResult(
        ...
        bundle_type=pulumi.get(__response__, 'bundle_type'),
