...
class GetBundlesResult:
    ...
    def bundle_ids(self) -> Sequence[_builtins.str]:
...
def get_bundles(bundle_ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Bundle IDs.
    :param _builtins.str name_regex: A regex string to filter results by Bundle name.
...
def get_bundles_output(bundle_ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                       bundle_type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
