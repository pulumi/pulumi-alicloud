...
class RamDirectoryArgs:
    def __init__(__self__, *,
                 ram_directory_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] ram_directory_name: The name of the directory. The name must be 2 to 255 characters in length. It must start with a letter but cannot start with `http://` or `https://`. It can contain letters, digits, colons (:), underscores (_), and hyphens (-).
        ...
        :param pulumi.Input[builtins.bool] enable_admin_access: Whether to enable public network access.
        :param pulumi.Input[builtins.bool] enable_internet_access: Whether to grant local administrator rights to users who use cloud desktops.
        """
    ...
    def ram_directory_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ram_directory_name(self, value: pulumi.Input[builtins.str]):
...
class _RamDirectoryState:
    def __init__(__self__, *,
                 ...
                 enable_admin_access: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_internet_access: Optional[pulumi.Input[builtins.bool]] = None,
                 ram_directory_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="ramDirectoryName")
    def ram_directory_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the directory. The name must be 2 to 255 characters in length. It must start with a letter but cannot start with `http://` or `https://`. It can contain letters, digits, colons (:), underscores (_), and hyphens (-).
        """
        return pulumi.get(self, "ram_directory_name")
    ...
    @ram_directory_name.setter
    def ram_directory_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ram_directory_name", value)
...
class RamDirectory(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ram_directory_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'RamDirectory':
        """
    ...
    @property
    @pulumi.getter(name="ramDirectoryName")
    def ram_directory_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the directory. The name must be 2 to 255 characters in length. It must start with a letter but cannot start with `http://` or `https://`. It can contain letters, digits, colons (:), underscores (_), and hyphens (-).
        """
        return pulumi.get(self, "ram_directory_name")
