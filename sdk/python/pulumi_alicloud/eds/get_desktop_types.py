...
def get_desktop_types(cpu_count: Optional[builtins.int] = None,
    ...
    :param builtins.int cpu_count: The CPU cores.
    :param builtins.float gpu_count: The GPU cores.
    :param Sequence[builtins.str] ids: A list of Desktop Type IDs.
    :param builtins.str instance_type_family: The Specification family. Valid values: `eds.graphics`, `eds.hf`, `eds.general`, `ecd.graphics`, `ecd.performance`, `ecd.advanced`, `ecd.basic`.
    :param builtins.int memory_size: The Memory size. Unit: MiB.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the resource. Valid values: `SUFFICIENT`.
    """
    __args__ = dict()
...
def get_desktop_types_output(cpu_count: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                             gpu_count: Optional[pulumi.Input[Optional[builtins.float]]] = None,
                             ...
                             memory_size: Optional[pulumi.Input[Optional[builtins.int]]] = None,
