...
class AdConnectorDirectoryArgs:
    def __init__(__self__, *,
                 ...
                 domain_password: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] domain_password: The user password of the domain administrator. The maximum number of English characters is 64.
        :param pulumi.Input[_builtins.str] domain_user_name: The username of the domain administrator. The maximum number of English characters is 64.
        ...
        :param pulumi.Input[_builtins.bool] enable_admin_access: Whether to grant local administrator rights to users who use cloud desktops.
        :param pulumi.Input[_builtins.bool] mfa_enabled: Whether MFA authentication is enabled. After all AD users in this directory log on to the cloud desktop, enter the correct password and then enter the dynamic verification code generated by the MFA device. **NOTE:** The MFA device needs to be bound when logging in for the first time.
        :param pulumi.Input[_builtins.int] specification: The AD Connector specifications. Valid values: `1`, `2`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] sub_domain_dns_addresses: The Enterprise already has the DNS address of the AD subdomain. If `sub_domain_name` is set and this parameter is not set, the child Domain DNS is considered consistent with the parent domain.
        :param pulumi.Input[_builtins.str] sub_domain_name: The Enterprise already has a fully qualified domain name (FQDN) of an AD subdomain, with both a host name and a domain name.
        """
    ...
    def domain_password(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def domain_password(self, value: pulumi.Input[_builtins.str]):
...
class _AdConnectorDirectoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] mfa_enabled: Whether MFA authentication is enabled. After all AD users in this directory log on to the cloud desktop, enter the correct password and then enter the dynamic verification code generated by the MFA device. **NOTE:** The MFA device needs to be bound when logging in for the first time.
        :param pulumi.Input[_builtins.int] specification: The AD Connector specifications. Valid values: `1`, `2`.
        :param pulumi.Input[_builtins.str] status: The status of directory.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] sub_domain_dns_addresses: The Enterprise already has the DNS address of the AD subdomain. If `sub_domain_name` is set and this parameter is not set, the child Domain DNS is considered consistent with the parent domain.
        :param pulumi.Input[_builtins.str] sub_domain_name: The Enterprise already has a fully qualified domain name (FQDN) of an AD subdomain, with both a host name and a domain name.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] vswitch_ids: List of VSwitch IDs in the directory.
        """
...
class AdConnectorDirectory(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sub_domain_dns_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            sub_domain_name: Optional[pulumi.Input[_builtins.str]] = None,
            vswitch_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'AdConnectorDirectory':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="domainPassword")
    def domain_password(self) -> pulumi.Output[_builtins.str]:
        """
        The user password of the domain administrator. The maximum number of English characters is 64.
        """
        return pulumi.get(self, "domain_password")
