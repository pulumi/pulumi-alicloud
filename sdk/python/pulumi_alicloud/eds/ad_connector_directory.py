...
class AdConnectorDirectoryArgs:
    def __init__(__self__, *,
                 ...
                 domain_password: pulumi.Input[builtins.str],
                 domain_user_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] directory_name: The name of the directory. The name must be 2 to 255 characters in length. It must start with a letter but cannot start with `http://` or `https://`. It can contain letters, digits, colons (:), underscores (_), and hyphens (-).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_addresses: The DNS address list.
        :param pulumi.Input[builtins.str] domain_name: The name of the domain.
        :param pulumi.Input[builtins.str] domain_password: The user password of the domain administrator. The maximum number of English characters is 64.
        :param pulumi.Input[builtins.str] domain_user_name: The username of the domain administrator. The maximum number of English characters is 64.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vswitch_ids: List of VSwitch IDs in the directory.
        :param pulumi.Input[builtins.str] desktop_access_type: The desktop access type. Valid values: `VPC`, `INTERNET`, `ANY`.
        :param pulumi.Input[builtins.bool] enable_admin_access: Whether to grant local administrator rights to users who use cloud desktops.
        :param pulumi.Input[builtins.bool] mfa_enabled: Whether MFA authentication is enabled. After all AD users in this directory log on to the cloud desktop, enter the correct password and then enter the dynamic verification code generated by the MFA device. **NOTE:** The MFA device needs to be bound when logging in for the first time.
        :param pulumi.Input[builtins.int] specification: The AD Connector specifications. Valid values: `1`, `2`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sub_domain_dns_addresses: The Enterprise already has the DNS address of the AD subdomain. If `sub_domain_name` is set and this parameter is not set, the child Domain DNS is considered consistent with the parent domain.
        :param pulumi.Input[builtins.str] sub_domain_name: The Enterprise already has a fully qualified domain name (FQDN) of an AD subdomain, with both a host name and a domain name.
        """
    ...
    def domain_password(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def domain_password(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "domain_password", value)

    @property
    @pulumi.getter(name="domainUserName")
    def domain_user_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def domain_user_name(self, value: pulumi.Input[builtins.str]):
...
class _AdConnectorDirectoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] mfa_enabled: Whether MFA authentication is enabled. After all AD users in this directory log on to the cloud desktop, enter the correct password and then enter the dynamic verification code generated by the MFA device. **NOTE:** The MFA device needs to be bound when logging in for the first time.
        :param pulumi.Input[builtins.int] specification: The AD Connector specifications. Valid values: `1`, `2`.
        :param pulumi.Input[builtins.str] status: The status of directory.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sub_domain_dns_addresses: The Enterprise already has the DNS address of the AD subdomain. If `sub_domain_name` is set and this parameter is not set, the child Domain DNS is considered consistent with the parent domain.
        :param pulumi.Input[builtins.str] sub_domain_name: The Enterprise already has a fully qualified domain name (FQDN) of an AD subdomain, with both a host name and a domain name.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vswitch_ids: List of VSwitch IDs in the directory.
        """
...
class AdConnectorDirectory(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sub_domain_dns_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            sub_domain_name: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'AdConnectorDirectory':
        """
    ...
    @property
    @pulumi.getter(name="domainPassword")
    def domain_password(self) -> pulumi.Output[builtins.str]:
        """
        The user password of the domain administrator. The maximum number of English characters is 64.
        """
        return pulumi.get(self, "domain_password")
    ...
    @property
    @pulumi.getter(name="domainUserName")
    def domain_user_name(self) -> pulumi.Output[builtins.str]:
        """
        The username of the domain administrator. The maximum number of English characters is 64.
        """
        return pulumi.get(self, "domain_user_name")
