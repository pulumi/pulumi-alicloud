...
def get_ad_connector_directories(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Ad Connector Directory IDs.
    :param _builtins.str name_regex: A regex string to filter results by Ad Connector Directory name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str status: The status of directory. Valid values: `REGISTERING`, `REGISTERED`, `DEREGISTERING`, `NEEDCONFIGTRUST`, `CONFIGTRUSTFAILED`, `DEREGISTERED`, `ERROR`, `CONFIGTRUSTING`, `NEEDCONFIGUSER`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_ad_connector_directories_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
