...
def get_simple_office_sites(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Simple Office Site IDs.
    :param _builtins.str name_regex: A regex string to filter results by Simple Office Site name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str status: Workspace State. Valid values: `REGISTERED`,`REGISTERING`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_simple_office_sites_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                   name_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSimpleOfficeSitesResult]:
    """
    This data source provides the Ecd Simple Office Sites of the current Alibaba Cloud user.
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:eds/getSimpleOfficeSites:getSimpleOfficeSites', __args__, opts=opts, typ=GetSimpleOfficeSitesResult)
    return __ret__.apply(lambda __response__: GetSimpleOfficeSitesResult(
