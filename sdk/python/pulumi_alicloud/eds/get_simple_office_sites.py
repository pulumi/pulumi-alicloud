...
def get_simple_office_sites(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Simple Office Site IDs.
    :param builtins.str name_regex: A regex string to filter results by Simple Office Site name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: Workspace State. Valid values: `REGISTERED`,`REGISTERING`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_simple_office_sites_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
