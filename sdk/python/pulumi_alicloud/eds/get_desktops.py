...
class GetDesktopsResult:
    ...
    def desktop_name(self) -> Optional[builtins.str]:
    ...
    def end_user_ids(self) -> Optional[Sequence[builtins.str]]:
    ...
    def policy_group_id(self) -> Optional[builtins.str]:
...
def get_desktops(desktop_name: Optional[builtins.str] = None,
                 end_user_ids: Optional[Sequence[builtins.str]] = None,
                 ...
                 policy_group_id: Optional[builtins.str] = None,
    ...
    :param builtins.str desktop_name: The desktop name.
    :param Sequence[builtins.str] ids: A list of Desktop IDs.
    :param builtins.str name_regex: A regex string to filter results by Desktop name.
    :param builtins.str office_site_id: The ID of the Simple Office Site.
...
def get_desktops_output(desktop_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        end_user_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                        ...
                        policy_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
