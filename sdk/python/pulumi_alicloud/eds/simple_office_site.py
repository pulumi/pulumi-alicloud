...
class SimpleOfficeSiteArgs:
    def __init__(__self__, *,
                 ...
                 enable_cross_desktop_access: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_internet_access: Optional[pulumi.Input[builtins.bool]] = None,
                 mfa_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 office_site_name: Optional[pulumi.Input[builtins.str]] = None,
                 sso_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] bandwidth: The Internet Bandwidth Peak. It has been deprecated from version 1.142.0 and can be found in the new resource alicloud_ecd_network_package.
        ...
        :param pulumi.Input[builtins.str] desktop_access_type: Connect to the Cloud Desktop Allows the Use of the Access Mode of. Valid values: `Any`, `Internet`, `VPC`.
        :param pulumi.Input[builtins.bool] enable_admin_access: Whether to Use Cloud Desktop User Empowerment of Local Administrator Permissions.
        :param pulumi.Input[builtins.bool] enable_cross_desktop_access: Enable Cross-Desktop Access.
        :param pulumi.Input[builtins.bool] enable_internet_access: Whether the Open Internet Access Function.
        :param pulumi.Input[builtins.bool] mfa_enabled: Whether to Enable Multi-Factor Authentication MFA.
        :param pulumi.Input[builtins.str] office_site_name: The office site name.
        :param pulumi.Input[builtins.bool] sso_enabled: Whether to Enable Single Sign-on (SSO) for User-Based SSO.
        """
    ...
    def enable_cross_desktop_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_cross_desktop_access(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def office_site_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def office_site_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "office_site_name", value)

    @property
    @pulumi.getter(name="ssoEnabled")
    def sso_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @sso_enabled.setter
    def sso_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SimpleOfficeSiteState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] office_site_name: The office site name.
        :param pulumi.Input[builtins.bool] sso_enabled: Whether to Enable Single Sign-on (SSO) for User-Based SSO.
        :param pulumi.Input[builtins.str] status: Workspace State. Valid Values: `REGISTERED`,`REGISTERING`.
        """
        if bandwidth is not None:
            warnings.warn("""Field 'bandwidth' has been deprecated from provider version 1.142.0.""", DeprecationWarning)
            pulumi.log.warn("""bandwidth is deprecated: Field 'bandwidth' has been deprecated from provider version 1.142.0.""")
...
class SimpleOfficeSite(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            office_site_name: Optional[pulumi.Input[builtins.str]] = None,
            sso_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'SimpleOfficeSite':
        """
    ...
    @property
    @pulumi.getter(name="cenId")
    def cen_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cloud Enterprise Network Instance ID.
        """
        return pulumi.get(self, "cen_id")
    ...
    @property
    @pulumi.getter(name="enableCrossDesktopAccess")
    def enable_cross_desktop_access(self) -> pulumi.Output[builtins.bool]:
        """
        Enable Cross-Desktop Access.
        """
        return pulumi.get(self, "enable_cross_desktop_access")
    ...
    @property
    @pulumi.getter(name="officeSiteName")
    def office_site_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The office site name.
        """
        return pulumi.get(self, "office_site_name")
    ...
    @property
    @pulumi.getter(name="ssoEnabled")
    def sso_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to Enable Single Sign-on (SSO) for User-Based SSO.
        """
        return pulumi.get(self, "sso_enabled")
