...
def get_chart_namespaces(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of matched Container Registry Enterprise Edition namespaces.
    :param builtins.str instance_id: The ID of the Container Registry instance.
    :param builtins.str name_regex: A regex string to filter results by name space name.
...
def get_chart_namespaces_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
