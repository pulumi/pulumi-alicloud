...
def get_chart_namespaces(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of matched Container Registry Enterprise Edition namespaces.
    :param _builtins.str instance_id: The ID of the Container Registry instance.
    :param _builtins.str name_regex: A regex string to filter results by name space name.
...
def get_chart_namespaces_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
