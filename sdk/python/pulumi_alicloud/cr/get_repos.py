...
def get_repos(enable_details: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool enable_details: Boolean, false by default, only repository attributes are exported. Set to true if domain list and tags belong to this repository are needed. See `tags` in attributes.
