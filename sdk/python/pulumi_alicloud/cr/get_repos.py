...
def get_repos(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.bool enable_details: Boolean, false by default, only repository attributes are exported. Set to true if domain list and tags belong to this repository are needed. See `tags` in attributes.
    :param builtins.str name_regex: A regex string to filter results by repository name.
...
def get_repos_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
