...
class ChainChainConfigNodeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enable: Whether to enable the delivery chain node. Valid values: `true`, `false`.
        ...
        :param pulumi.Input[builtins.str] node_name: The name of delivery chain node.
        """
...
class ChainChainConfigNodeNodeConfigDenyPolicyArgs:
    def __init__(__self__, *,
                 ...
                 issue_level: Optional[pulumi.Input[builtins.str]] = None,
                 logic: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] action: The action of trigger blocking. Valid values: `BLOCK`, `BLOCK_RETAG`, `BLOCK_DELETE_TAG`. While `Block` means block the delivery chain from continuing to execute, `BLOCK_RETAG` means block overwriting push image tag, `BLOCK_DELETE_TAG` means block deletion of mirror tags.
        :param pulumi.Input[builtins.str] issue_count: The count of scanning vulnerabilities that triggers blocking.
        :param pulumi.Input[builtins.str] issue_level: The level of scanning vulnerability that triggers blocking. Valid values: `LOW`, `MEDIUM`, `HIGH`, `UNKNOWN`.
        :param pulumi.Input[builtins.str] logic: The logic of trigger blocking. Valid values: `AND`, `OR`.
        """
    ...
    def issue_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The level of scanning vulnerability that triggers blocking. Valid values: `LOW`, `MEDIUM`, `HIGH`, `UNKNOWN`.
        """
    ...
    @issue_level.setter
    def issue_level(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ChainChainConfigRouterFromArgs:
    def __init__(__self__, *,
                 node_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] node_name: The name of node. Valid values: `DOCKER_IMAGE_BUILD`, `DOCKER_IMAGE_PUSH`, `VULNERABILITY_SCANNING`, `ACTIVATE_REPLICATION`, `TRIGGER`, `SNAPSHOT`, `TRIGGER_SNAPSHOT`.
        """
        if node_name is not None:
            pulumi.set(__self__, "node_name", node_name)
...
class RegistryEnterpriseInstanceInstanceEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint_type: Network Access Endpoint Type
        """
...
class RegistryEnterpriseInstanceInstanceEndpointDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Domain Type
        """
...
if not MYPY:
    class RepoDomainListArgsDict(TypedDict):
        internal: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RepoDomainListArgs:
    def __init__(__self__, *,
                 internal: Optional[pulumi.Input[builtins.str]] = None,
                 public: Optional[pulumi.Input[builtins.str]] = None,
                 vpc: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] internal: Domain of internal endpoint, only in some regions.
        :param pulumi.Input[builtins.str] public: Domain of public endpoint.
        :param pulumi.Input[builtins.str] vpc: Domain of vpc endpoint.
        """
    ...
    @property
    @pulumi.getter
    def internal(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Domain of internal endpoint, only in some regions.
        """
    ...
    @internal.setter
    def internal(self, value: Optional[pulumi.Input[builtins.str]]):
