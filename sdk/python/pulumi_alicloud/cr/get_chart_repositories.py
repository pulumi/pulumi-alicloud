...
def get_chart_repositories(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of matched Container Registry Enterprise Edition repositories.
...
def get_chart_repositories_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
