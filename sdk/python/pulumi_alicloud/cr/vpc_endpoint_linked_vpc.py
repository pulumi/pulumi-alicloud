...
class _VpcEndpointLinkedVpcState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] module_name: The name of the module that you want to access. Valid Values:
               - `Registry`: the image repository.
               - `Chart`: a Helm chart.
        :param pulumi.Input[_builtins.str] status: The status of the Vpc Endpoint Linked Vpc.
        :param pulumi.Input[_builtins.str] vpc_id: The ID of the VPC.
        :param pulumi.Input[_builtins.str] vswitch_id: The ID of the vSwitch.
        """
        if enable_create_dns_record_in_pvzt is not None:
...
class VpcEndpointLinkedVpc(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="enableCreateDnsRecordInPvzt")
    def enable_create_dns_record_in_pvzt(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether to automatically create an Alibaba Cloud DNS PrivateZone record. Valid Values:
        """
        return pulumi.get(self, "enable_create_dns_record_in_pvzt")
