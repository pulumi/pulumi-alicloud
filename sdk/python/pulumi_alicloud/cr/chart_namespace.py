...
class ChartNamespaceArgs:
    def __init__(__self__, *,
                 ...
                 auto_create_repo: Optional[pulumi.Input[builtins.bool]] = None,
                 default_repo_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ChartNamespace resource.
        :param pulumi.Input[builtins.str] instance_id: The ID of the Container Registry instance.
        :param pulumi.Input[builtins.str] namespace_name: The name of the namespace that you want to create.
        :param pulumi.Input[builtins.bool] auto_create_repo: Specifies whether to automatically create repositories in the namespace. Valid values:
        :param pulumi.Input[builtins.str] default_repo_type: DefaultRepoType. Valid values: `PRIVATE`, `PUBLIC`.
        """
    ...
    def auto_create_repo(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_create_repo(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_create_repo", value)

    @property
    @pulumi.getter(name="defaultRepoType")
    def default_repo_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_repo_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ChartNamespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            default_repo_type: Optional[pulumi.Input[builtins.str]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            namespace_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ChartNamespace':
        """
    ...
    @property
    @pulumi.getter(name="autoCreateRepo")
    def auto_create_repo(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to automatically create repositories in the namespace. Valid values:
        """
        return pulumi.get(self, "auto_create_repo")
    ...
    @property
    @pulumi.getter(name="defaultRepoType")
    def default_repo_type(self) -> pulumi.Output[builtins.str]:
        """
        DefaultRepoType. Valid values: `PRIVATE`, `PUBLIC`.
        """
        return pulumi.get(self, "default_repo_type")
