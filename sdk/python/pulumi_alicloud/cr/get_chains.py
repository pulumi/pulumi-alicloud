...
class GetChainsResult:
    ...
    def repo_namespace_name(self) -> Optional[builtins.str]:
...
def get_chains(enable_details: Optional[builtins.bool] = None,
               ...
               repo_namespace_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Chain IDs.
    :param builtins.str instance_id: The ID of CR Enterprise Edition instance.
    :param builtins.str name_regex: A regex string to filter results by Chain name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str repo_name: The name of CR Enterprise Edition repository.
    :param builtins.str repo_namespace_name: The name of CR Enterprise Edition namespace.
    """
    __args__ = dict()
...
def get_chains_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      ...
                      repo_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      repo_namespace_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetChainsResult(
        ...
        repo_namespace_name=pulumi.get(__response__, 'repo_namespace_name')))
