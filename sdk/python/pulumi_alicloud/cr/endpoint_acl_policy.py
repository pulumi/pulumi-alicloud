...
class EndpointAclPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint_type: The type of endpoint. Valid values: `internet`.
        :param pulumi.Input[builtins.str] entry: The IP segment that allowed to access.
        :param pulumi.Input[builtins.str] instance_id: The ID of the CR Instance.
        :param pulumi.Input[builtins.str] description: The description of the entry.
        :param pulumi.Input[builtins.str] module_name: The module that needs to set the access policy. Valid values: `Registry`.
        """
...
class EndpointAclPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            entry: Optional[pulumi.Input[builtins.str]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            module_name: Optional[pulumi.Input[builtins.str]] = None) -> 'EndpointAclPolicy':
        """
