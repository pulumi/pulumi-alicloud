...
def get_endpoint_acl_policies(endpoint_type: Optional[builtins.str] = None,
    ...
    :param builtins.str endpoint_type: The type of endpoint. Valid values: `internet`.
    :param Sequence[builtins.str] ids: A list of Endpoint Acl Policy IDs.
...
def get_endpoint_acl_policies_output(endpoint_type: Optional[pulumi.Input[builtins.str]] = None,
