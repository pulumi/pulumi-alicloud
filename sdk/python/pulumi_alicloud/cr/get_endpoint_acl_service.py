...
def get_endpoint_acl_service(enable: Optional[builtins.bool] = None,
    ...
    :param builtins.bool enable: Whether to enable Acl Service, Setting the value to `true` to enable the acl service. Valid values: `true` and `false`.
    ...
    :param builtins.str module_name: The ModuleName. Valid values: `Registry`.
...
def get_endpoint_acl_service_output(enable: Optional[pulumi.Input[builtins.bool]] = None,
