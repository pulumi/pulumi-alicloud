...
def get_vpc_endpoint_linked_vpcs(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of CR Vpc Endpoint Linked Vpc IDs.
...
def get_vpc_endpoint_linked_vpcs_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
