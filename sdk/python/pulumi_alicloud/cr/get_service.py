...
def get_service(enable: Optional[_builtins.str] = None,
    ...
    :param _builtins.str password: The user password. The password must be 8 to 32 characters in length, and must contain at least two of the following character types: letters, special characters, and digits.
