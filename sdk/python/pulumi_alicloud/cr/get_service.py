...
def get_service(enable: Optional[builtins.str] = None,
    ...
    :param builtins.str password: The user password. The password must be 8 to 32 characters in length, and must contain at least two of the following character types: letters, special characters, and digits.
...
def get_service_output(enable: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:cr/getService:getService', __args__, opts=opts, typ=GetServiceResult)
