...
class ChainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] repo_name: The name of CR Enterprise Edition repository. **NOTE:** This parameter must specify a correct value, otherwise the created resource will be incorrect.
        :param pulumi.Input[_builtins.str] repo_namespace_name: The name of CR Enterprise Edition namespace. **NOTE:** This parameter must specify the correct value, otherwise the created resource will be incorrect.
        """
    ...
    def chain_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @chain_name.setter
    def chain_name(self, value: pulumi.Input[_builtins.str]):
...
class Chain(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="chainId")
    def chain_id(self) -> pulumi.Output[_builtins.str]:
        """
        Delivery chain ID.
        """
        return pulumi.get(self, "chain_id")
    ...
    @_builtins.property
    @pulumi.getter(name="chainName")
    def chain_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of delivery chain. The length of the name is 1-64 characters, lowercase English letters and numbers, and the separators "_", "-", "." can be used, noted that the separator cannot be at the first or last position.
        """
        return pulumi.get(self, "chain_name")
    ...
    @_builtins.property
    @pulumi.getter(name="repoNamespaceName")
    def repo_namespace_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name of CR Enterprise Edition namespace. **NOTE:** This parameter must specify the correct value, otherwise the created resource will be incorrect.
        """
        return pulumi.get(self, "repo_namespace_name")
