...
class ChainArgs:
    def __init__(__self__, *,
                 chain_name: pulumi.Input[builtins.str],
                 ...
                 repo_namespace_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Chain resource.
        :param pulumi.Input[builtins.str] chain_name: The name of delivery chain. The length of the name is 1-64 characters, lowercase English letters and numbers, and the separators "_", "-", "." can be used, noted that the separator cannot be at the first or last position.
        :param pulumi.Input[builtins.str] instance_id: The ID of CR Enterprise Edition instance.
        ...
        :param pulumi.Input[builtins.str] description: The description delivery chain.
        :param pulumi.Input[builtins.str] repo_name: The name of CR Enterprise Edition repository. **NOTE:** This parameter must specify a correct value, otherwise the created resource will be incorrect.
        :param pulumi.Input[builtins.str] repo_namespace_name: The name of CR Enterprise Edition namespace. **NOTE:** This parameter must specify the correct value, otherwise the created resource will be incorrect.
        """
    ...
    def chain_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @chain_name.setter
    def chain_name(self, value: pulumi.Input[builtins.str]):
    ...
    def repo_namespace_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def repo_namespace_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ChainState:
    def __init__(__self__, *,
                 chain_configs: Optional[pulumi.Input[Sequence[pulumi.Input['ChainChainConfigArgs']]]] = None,
                 chain_id: Optional[pulumi.Input[builtins.str]] = None,
                 chain_name: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ChainChainConfigArgs']]] chain_configs: The configuration of delivery chain. See `chain_config` below. **NOTE:** This parameter must specify the correct value, otherwise the created resource will be incorrect.
        :param pulumi.Input[builtins.str] chain_id: Delivery chain ID.
        :param pulumi.Input[builtins.str] chain_name: The name of delivery chain. The length of the name is 1-64 characters, lowercase English letters and numbers, and the separators "_", "-", "." can be used, noted that the separator cannot be at the first or last position.
        :param pulumi.Input[builtins.str] description: The description delivery chain.
        :param pulumi.Input[builtins.str] instance_id: The ID of CR Enterprise Edition instance.
        :param pulumi.Input[builtins.str] repo_name: The name of CR Enterprise Edition repository. **NOTE:** This parameter must specify a correct value, otherwise the created resource will be incorrect.
    ...
    def chain_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Delivery chain ID.
        """
    ...
    @chain_id.setter
    def chain_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "chain_id", value)

    @property
    @pulumi.getter(name="chainName")
    def chain_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of delivery chain. The length of the name is 1-64 characters, lowercase English letters and numbers, and the separators "_", "-", "." can be used, noted that the separator cannot be at the first or last position.
        """
        return pulumi.get(self, "chain_name")
    ...
    @chain_name.setter
    def chain_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "chain_name", value)
...
class Chain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            repo_name: Optional[pulumi.Input[builtins.str]] = None,
            repo_namespace_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Chain':
        """
    ...
    @property
    @pulumi.getter(name="chainId")
    def chain_id(self) -> pulumi.Output[builtins.str]:
        """
        Delivery chain ID.
        """
        return pulumi.get(self, "chain_id")
    ...
    @property
    @pulumi.getter(name="chainName")
    def chain_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of delivery chain. The length of the name is 1-64 characters, lowercase English letters and numbers, and the separators "_", "-", "." can be used, noted that the separator cannot be at the first or last position.
        """
        return pulumi.get(self, "chain_name")
    ...
    @property
    @pulumi.getter(name="repoNamespaceName")
    def repo_namespace_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of CR Enterprise Edition namespace. **NOTE:** This parameter must specify the correct value, otherwise the created resource will be incorrect.
        """
        return pulumi.get(self, "repo_namespace_name")
