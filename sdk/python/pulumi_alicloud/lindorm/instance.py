...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 deletion_proection: Optional[pulumi.Input[builtins.bool]] = None,
                 duration: Optional[pulumi.Input[builtins.str]] = None,
                 file_engine_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 file_engine_specification: Optional[pulumi.Input[builtins.str]] = None,
                 instance_name: Optional[pulumi.Input[builtins.str]] = None,
                 instance_storage: Optional[pulumi.Input[builtins.str]] = None,
                 ip_white_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 log_disk_category: Optional[pulumi.Input[builtins.str]] = None,
                 log_num: Optional[pulumi.Input[builtins.int]] = None,
                 log_single_storage: Optional[pulumi.Input[builtins.int]] = None,
                 log_spec: Optional[pulumi.Input[builtins.str]] = None,
                 lts_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 lts_node_specification: Optional[pulumi.Input[builtins.str]] = None,
                 multi_zone_combination: Optional[pulumi.Input[builtins.str]] = None,
                 pricing_cycle: Optional[pulumi.Input[builtins.str]] = None,
                 primary_vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
                 primary_zone_id: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 search_engine_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 search_engine_specification: Optional[pulumi.Input[builtins.str]] = None,
                 standby_vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
                 standby_zone_id: Optional[pulumi.Input[builtins.str]] = None,
                 stream_engine_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 stream_engine_specification: Optional[pulumi.Input[builtins.str]] = None,
                 table_engine_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 table_engine_specification: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 time_series_engine_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 time_series_engine_specification: Optional[pulumi.Input[builtins.str]] = None,
                 time_serires_engine_specification: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_id: Optional[pulumi.Input[builtins.str]] = None,
                 zone_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Instance resource.
        :param pulumi.Input[builtins.str] disk_category: The disk type of instance. Valid values: `cloud_efficiency`, `cloud_ssd`, `cloud_essd`, `cloud_essd_pl0`, `capacity_cloud_storage`, `local_ssd_pro`, `local_hdd_pro`. **NOTE:** From version 1.207.0, `disk_category` can be set to `cloud_essd_pl0`.
        :param pulumi.Input[builtins.str] payment_type: The billing method. Valid values: `PayAsYouGo` and `Subscription`.
        ...
        :param pulumi.Input[builtins.bool] deletion_proection: The deletion protection of instance.
        :param pulumi.Input[builtins.str] duration: The duration of paid. Valid when the `payment_type` is `Subscription`.  When `pricing_cycle` set to `Month`, the valid value id `1` to `9`.  When `pricing_cycle` set to `Year`, the valid value id `1` to `3`.
        ...
        :param pulumi.Input[builtins.int] log_single_storage: The multi-availability instance, log single-node disk capacity. This parameter is required if you want to create multiple availability zone instances. Valid values: `400` to `64000`.
        :param pulumi.Input[builtins.str] log_spec: The multiple availability zone instances, log node specification. required if you need to create multiple availability zone instances. Valid values: `lindorm.sn1.large`, `lindorm.sn1.2xlarge`.
        :param pulumi.Input[builtins.int] lts_node_count: The count of lindorm tunnel service.
        :param pulumi.Input[builtins.str] lts_node_specification: The specification of lindorm tunnel service. Valid values: `lindorm.g.2xlarge`, `lindorm.g.xlarge`.
        :param pulumi.Input[builtins.str] multi_zone_combination: The multi-zone combinations. Availability zone combinations are supported on the sale page. required if you need to create multiple availability zone instances. Valid values: `ap-southeast-5abc-aliyun`, `cn-hangzhou-ehi-aliyun`, `cn-beijing-acd-aliyun`, `ap-southeast-1-abc-aliyun`, `cn-zhangjiakou-abc-aliyun`, `cn-shanghai-efg-aliyun`, `cn-shanghai-abd-aliyun`, `cn-hangzhou-bef-aliyun`, `cn-hangzhou-bce-aliyun`, `cn-beijing-fgh-aliyun`, `cn-shenzhen-abc-aliyun`.
        :param pulumi.Input[builtins.str] pricing_cycle: The pricing cycle. Valid when the `payment_type` is `Subscription`. Valid values: `Month` and `Year`.
        :param pulumi.Input[builtins.str] primary_vswitch_id: Multi-available zone instances, the virtual switch ID of the primary available zone, must be under the available zone corresponding to the PrimaryZoneId. required if you need to create multiple availability zone instances.
        :param pulumi.Input[builtins.str] primary_zone_id: Multi-availability zone instance with the availability zone ID of the main availability zone. required if you need to create multiple availability zone instances.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.int] search_engine_node_count: The count of search engine.
        :param pulumi.Input[builtins.str] search_engine_specification: The specification of search engine. Valid values: `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`, `lindorm.g.xlarge`.
        :param pulumi.Input[builtins.str] standby_vswitch_id: The multiple availability zone instances, the virtual switch ID of the ready availability zone must be under the availability zone corresponding to the StandbyZoneId. required if you need to create multiple availability zone instances.
        :param pulumi.Input[builtins.str] standby_zone_id: The multiple availability zone instances with availability zone IDs for the prepared availability zones. required if you need to create multiple availability zone instances.
        :param pulumi.Input[builtins.int] stream_engine_node_count: The number of LindormStream nodes in the instance.
        :param pulumi.Input[builtins.str] stream_engine_specification: The specification of the LindormStream nodes in the instance. Valid values: `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`.
        :param pulumi.Input[builtins.int] table_engine_node_count: The count of table engine.
        :param pulumi.Input[builtins.str] table_engine_specification: The specification of  table engine. Valid values: `lindorm.c.2xlarge`, `lindorm.c.4xlarge`, `lindorm.c.8xlarge`, `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.int] time_series_engine_node_count: The count of time series engine.
        :param pulumi.Input[builtins.str] time_series_engine_specification: The specification of time series engine. Valid values: `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`, `lindorm.r.8xlarge`.
        :param pulumi.Input[builtins.str] time_serires_engine_specification: Field `time_serires_engine_specification` has been deprecated from provider version 1.182.0. New field `time_series_engine_specification` instead.
    ...
    def arbiter_vswitch_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def arbiter_vswitch_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "arbiter_vswitch_id", value)

    @property
    @pulumi.getter(name="arbiterZoneId")
    def arbiter_zone_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def arbiter_zone_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "arbiter_zone_id", value)

    @property
    @pulumi.getter(name="archVersion")
    def arch_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def core_single_storage(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def core_single_storage(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "core_single_storage", value)

    @property
    @pulumi.getter(name="coreSpec")
    def core_spec(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @core_spec.setter
    def core_spec(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "core_spec", value)

    @property
    @pulumi.getter(name="deletionProection")
    def deletion_proection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def deletion_proection(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def file_engine_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def file_engine_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "file_engine_node_count", value)

    @property
    @pulumi.getter(name="fileEngineSpecification")
    def file_engine_specification(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def file_engine_specification(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def instance_storage(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def log_disk_category(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def log_disk_category(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_disk_category", value)

    @property
    @pulumi.getter(name="logNum")
    def log_num(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @log_num.setter
    def log_num(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "log_num", value)

    @property
    @pulumi.getter(name="logSingleStorage")
    def log_single_storage(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def log_single_storage(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "log_single_storage", value)

    @property
    @pulumi.getter(name="logSpec")
    def log_spec(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @log_spec.setter
    def log_spec(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_spec", value)

    @property
    @pulumi.getter(name="ltsNodeCount")
    def lts_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def lts_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "lts_node_count", value)

    @property
    @pulumi.getter(name="ltsNodeSpecification")
    def lts_node_specification(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def lts_node_specification(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "lts_node_specification", value)

    @property
    @pulumi.getter(name="multiZoneCombination")
    def multi_zone_combination(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def multi_zone_combination(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def primary_vswitch_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def primary_vswitch_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def search_engine_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def search_engine_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "search_engine_node_count", value)

    @property
    @pulumi.getter(name="searchEngineSpecification")
    def search_engine_specification(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def search_engine_specification(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "search_engine_specification", value)

    @property
    @pulumi.getter(name="standbyVswitchId")
    def standby_vswitch_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def standby_vswitch_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def stream_engine_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def stream_engine_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "stream_engine_node_count", value)

    @property
    @pulumi.getter(name="streamEngineSpecification")
    def stream_engine_specification(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def stream_engine_specification(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stream_engine_specification", value)

    @property
    @pulumi.getter(name="tableEngineNodeCount")
    def table_engine_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def table_engine_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "table_engine_node_count", value)

    @property
    @pulumi.getter(name="tableEngineSpecification")
    def table_engine_specification(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def table_engine_specification(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_series_engine_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def time_series_engine_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "time_series_engine_node_count", value)

    @property
    @pulumi.getter(name="timeSeriesEngineSpecification")
    def time_series_engine_specification(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_series_engine_specification(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_serires_engine_specification(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_serires_engine_specification(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _InstanceState:
    def __init__(__self__, *,
                 ...
                 duration: Optional[pulumi.Input[builtins.str]] = None,
                 enabled_file_engine: Optional[pulumi.Input[builtins.bool]] = None,
                 enabled_lts_engine: Optional[pulumi.Input[builtins.bool]] = None,
                 enabled_search_engine: Optional[pulumi.Input[builtins.bool]] = None,
                 enabled_stream_engine: Optional[pulumi.Input[builtins.bool]] = None,
                 enabled_table_engine: Optional[pulumi.Input[builtins.bool]] = None,
                 enabled_time_serires_engine: Optional[pulumi.Input[builtins.bool]] = None,
                 file_engine_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 file_engine_specification: Optional[pulumi.Input[builtins.str]] = None,
                 instance_name: Optional[pulumi.Input[builtins.str]] = None,
                 instance_storage: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] disk_category: The disk type of instance. Valid values: `cloud_efficiency`, `cloud_ssd`, `cloud_essd`, `cloud_essd_pl0`, `capacity_cloud_storage`, `local_ssd_pro`, `local_hdd_pro`. **NOTE:** From version 1.207.0, `disk_category` can be set to `cloud_essd_pl0`.
        :param pulumi.Input[builtins.str] duration: The duration of paid. Valid when the `payment_type` is `Subscription`.  When `pricing_cycle` set to `Month`, the valid value id `1` to `9`.  When `pricing_cycle` set to `Year`, the valid value id `1` to `3`.
        :param pulumi.Input[builtins.bool] enabled_file_engine: (Available since v1.163.0) Whether to enable file engine.
        :param pulumi.Input[builtins.bool] enabled_lts_engine: (Available since v1.163.0) Whether to enable lts engine.
        :param pulumi.Input[builtins.bool] enabled_search_engine: (Available since v1.163.0) Whether to enable search engine.
        :param pulumi.Input[builtins.bool] enabled_stream_engine: (Available since v1.211.0) Whether to enable streaming engine.
        :param pulumi.Input[builtins.bool] enabled_table_engine: (Available since v1.163.0) Whether to enable table engine.
        :param pulumi.Input[builtins.bool] enabled_time_serires_engine: (Available since v1.163.0) Whether to enable time serires engine.
        :param pulumi.Input[builtins.int] file_engine_node_count: The count of file engine.
        :param pulumi.Input[builtins.str] file_engine_specification: The specification of file engine. Valid values: `lindorm.c.xlarge`.
        :param pulumi.Input[builtins.str] instance_name: The name of the instance.
        :param pulumi.Input[builtins.str] instance_storage: The storage capacity of the instance. Unit: GB. Valid values: [80, 10485760], and the value must be divisible by 80.
        ...
        :param pulumi.Input[builtins.int] search_engine_node_count: The count of search engine.
        :param pulumi.Input[builtins.str] search_engine_specification: The specification of search engine. Valid values: `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`, `lindorm.g.xlarge`.
        :param pulumi.Input[builtins.str] service_type: (Available since v1.196.0) The instance type.
        :param pulumi.Input[builtins.str] standby_vswitch_id: The multiple availability zone instances, the virtual switch ID of the ready availability zone must be under the availability zone corresponding to the StandbyZoneId. required if you need to create multiple availability zone instances.
        :param pulumi.Input[builtins.str] standby_zone_id: The multiple availability zone instances with availability zone IDs for the prepared availability zones. required if you need to create multiple availability zone instances.
        :param pulumi.Input[builtins.str] status: The status of Instance.
        :param pulumi.Input[builtins.int] stream_engine_node_count: The number of LindormStream nodes in the instance.
        :param pulumi.Input[builtins.str] stream_engine_specification: The specification of the LindormStream nodes in the instance. Valid values: `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`.
        :param pulumi.Input[builtins.int] table_engine_node_count: The count of table engine.
        :param pulumi.Input[builtins.str] table_engine_specification: The specification of  table engine. Valid values: `lindorm.c.2xlarge`, `lindorm.c.4xlarge`, `lindorm.c.8xlarge`, `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`.
    ...
    def enabled_file_engine(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enabled_file_engine(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enabled_file_engine", value)

    @property
    @pulumi.getter(name="enabledLtsEngine")
    def enabled_lts_engine(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enabled_lts_engine(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enabled_lts_engine", value)

    @property
    @pulumi.getter(name="enabledSearchEngine")
    def enabled_search_engine(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enabled_search_engine(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enabled_search_engine", value)

    @property
    @pulumi.getter(name="enabledStreamEngine")
    def enabled_stream_engine(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enabled_stream_engine(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enabled_stream_engine", value)

    @property
    @pulumi.getter(name="enabledTableEngine")
    def enabled_table_engine(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enabled_table_engine(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enabled_table_engine", value)

    @property
    @pulumi.getter(name="enabledTimeSeriresEngine")
    def enabled_time_serires_engine(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enabled_time_serires_engine(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("alicloud:lindorm/instance:Instance")
class Instance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="arbiterVswitchId")
    def arbiter_vswitch_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The multi-availability zone instance, coordinating the virtual switch ID of the availability zone, the switch must be located under the availability zone corresponding to the ArbiterZoneId. This parameter is required if you need to create multiple availability zone instances.
        """
        return pulumi.get(self, "arbiter_vswitch_id")
    ...
    @property
    @pulumi.getter(name="arbiterZoneId")
    def arbiter_zone_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The multiple Availability Zone Instance, the availability zone ID of the coordinating availability zone. required if you need to create multiple availability zone instances.
        """
        return pulumi.get(self, "arbiter_zone_id")
    ...
    @property
    @pulumi.getter(name="archVersion")
    def arch_version(self) -> pulumi.Output[builtins.str]:
        """
        The deployment architecture. If you do not fill in this parameter, the default is 1.0. to create multiple availability instances, fill in 2.0. if you need to create multiple availability instances, this parameter is required. Valid values: `1.0` to `2.0`.
        """
        return pulumi.get(self, "arch_version")
    ...
    @property
    @pulumi.getter(name="coreSingleStorage")
    def core_single_storage(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The multiple availability zone instances, CORE single node capacity. required if you want to create multiple availability zone instances. Valid values: `400` to `64000`.
        """
        return pulumi.get(self, "core_single_storage")
    ...
    @property
    @pulumi.getter(name="coreSpec")
    def core_spec(self) -> pulumi.Output[builtins.str]:
        """
        The core spec. When `disk_category` is `local_ssd_pro` or `local_hdd_pro`, this filed is valid.
        - When `disk_category` is `local_ssd_pro`, the valid values is `lindorm.i2.xlarge`, `lindorm.i2.2xlarge`, `lindorm.i2.4xlarge`, `lindorm.i2.8xlarge`.
        - When `disk_category` is `local_hdd_pro`, the valid values is `lindorm.d2c.6xlarge`, `lindorm.d2c.12xlarge`, `lindorm.d2c.24xlarge`, `lindorm.d2s.5xlarge`, `lindorm.d2s.10xlarge`, `lindorm.d1.2xlarge`, `lindorm.d1.4xlarge`, `lindorm.d1.6xlarge`.
    ...
    @property
    @pulumi.getter(name="deletionProection")
    def deletion_proection(self) -> pulumi.Output[builtins.bool]:
        """
        The deletion protection of instance.
        """
        return pulumi.get(self, "deletion_proection")
    ...
    @property
    @pulumi.getter(name="enabledFileEngine")
    def enabled_file_engine(self) -> pulumi.Output[builtins.bool]:
        """
        (Available since v1.163.0) Whether to enable file engine.
        """
        return pulumi.get(self, "enabled_file_engine")
    ...
    @property
    @pulumi.getter(name="enabledLtsEngine")
    def enabled_lts_engine(self) -> pulumi.Output[builtins.bool]:
        """
        (Available since v1.163.0) Whether to enable lts engine.
        """
        return pulumi.get(self, "enabled_lts_engine")
    ...
    @property
    @pulumi.getter(name="enabledSearchEngine")
    def enabled_search_engine(self) -> pulumi.Output[builtins.bool]:
        """
        (Available since v1.163.0) Whether to enable search engine.
        """
        return pulumi.get(self, "enabled_search_engine")
    ...
    @property
    @pulumi.getter(name="enabledStreamEngine")
    def enabled_stream_engine(self) -> pulumi.Output[builtins.bool]:
        """
        (Available since v1.211.0) Whether to enable streaming engine.
        """
        return pulumi.get(self, "enabled_stream_engine")
    ...
    @property
    @pulumi.getter(name="enabledTableEngine")
    def enabled_table_engine(self) -> pulumi.Output[builtins.bool]:
        """
        (Available since v1.163.0) Whether to enable table engine.
        """
        return pulumi.get(self, "enabled_table_engine")
    ...
    @property
    @pulumi.getter(name="enabledTimeSeriresEngine")
    def enabled_time_serires_engine(self) -> pulumi.Output[builtins.bool]:
        """
        (Available since v1.163.0) Whether to enable time serires engine.
        """
        return pulumi.get(self, "enabled_time_serires_engine")
    ...
    @property
    @pulumi.getter(name="fileEngineNodeCount")
    def file_engine_node_count(self) -> pulumi.Output[builtins.int]:
        """
        The count of file engine.
        """
        return pulumi.get(self, "file_engine_node_count")
    ...
    @property
    @pulumi.getter(name="fileEngineSpecification")
    def file_engine_specification(self) -> pulumi.Output[builtins.str]:
        """
        The specification of file engine. Valid values: `lindorm.c.xlarge`.
        """
        return pulumi.get(self, "file_engine_specification")
    ...
    @property
    @pulumi.getter(name="ipWhiteLists")
    def ip_white_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The ip white list of instance.
        """
        return pulumi.get(self, "ip_white_lists")
    ...
    @property
    @pulumi.getter(name="logDiskCategory")
    def log_disk_category(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The multi-available zone instance, log node disk type. required if you need to create multiple availability zone instances. Valid values: `cloud_efficiency`, `cloud_ssd`.
        """
        return pulumi.get(self, "log_disk_category")
    ...
    @property
    @pulumi.getter(name="logNum")
    def log_num(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The multiple Availability Zone Instance, number of log nodes. this parameter is required if you want to create multiple availability zone instances. Valid values: `4` to `400`.
        """
        return pulumi.get(self, "log_num")
    ...
    @property
    @pulumi.getter(name="logSingleStorage")
    def log_single_storage(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The multi-availability instance, log single-node disk capacity. This parameter is required if you want to create multiple availability zone instances. Valid values: `400` to `64000`.
        """
        return pulumi.get(self, "log_single_storage")
    ...
    @property
    @pulumi.getter(name="logSpec")
    def log_spec(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The multiple availability zone instances, log node specification. required if you need to create multiple availability zone instances. Valid values: `lindorm.sn1.large`, `lindorm.sn1.2xlarge`.
        """
        return pulumi.get(self, "log_spec")
    ...
    @property
    @pulumi.getter(name="ltsNodeCount")
    def lts_node_count(self) -> pulumi.Output[builtins.int]:
        """
        The count of lindorm tunnel service.
        """
        return pulumi.get(self, "lts_node_count")
    ...
    @property
    @pulumi.getter(name="ltsNodeSpecification")
    def lts_node_specification(self) -> pulumi.Output[builtins.str]:
        """
        The specification of lindorm tunnel service. Valid values: `lindorm.g.2xlarge`, `lindorm.g.xlarge`.
        """
        return pulumi.get(self, "lts_node_specification")
    ...
    @property
    @pulumi.getter(name="multiZoneCombination")
    def multi_zone_combination(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The multi-zone combinations. Availability zone combinations are supported on the sale page. required if you need to create multiple availability zone instances. Valid values: `ap-southeast-5abc-aliyun`, `cn-hangzhou-ehi-aliyun`, `cn-beijing-acd-aliyun`, `ap-southeast-1-abc-aliyun`, `cn-zhangjiakou-abc-aliyun`, `cn-shanghai-efg-aliyun`, `cn-shanghai-abd-aliyun`, `cn-hangzhou-bef-aliyun`, `cn-hangzhou-bce-aliyun`, `cn-beijing-fgh-aliyun`, `cn-shenzhen-abc-aliyun`.
        """
        return pulumi.get(self, "multi_zone_combination")
    ...
    @property
    @pulumi.getter(name="primaryVswitchId")
    def primary_vswitch_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Multi-available zone instances, the virtual switch ID of the primary available zone, must be under the available zone corresponding to the PrimaryZoneId. required if you need to create multiple availability zone instances.
        """
        return pulumi.get(self, "primary_vswitch_id")
    ...
    @property
    @pulumi.getter(name="primaryZoneId")
    def primary_zone_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Multi-availability zone instance with the availability zone ID of the main availability zone. required if you need to create multiple availability zone instances.
        """
        return pulumi.get(self, "primary_zone_id")
    ...
    @property
    @pulumi.getter(name="searchEngineNodeCount")
    def search_engine_node_count(self) -> pulumi.Output[builtins.int]:
        """
        The count of search engine.
        """
        return pulumi.get(self, "search_engine_node_count")
    ...
    @property
    @pulumi.getter(name="searchEngineSpecification")
    def search_engine_specification(self) -> pulumi.Output[builtins.str]:
        """
        The specification of search engine. Valid values: `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`, `lindorm.g.xlarge`.
        """
        return pulumi.get(self, "search_engine_specification")
    ...
    @property
    @pulumi.getter(name="standbyVswitchId")
    def standby_vswitch_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The multiple availability zone instances, the virtual switch ID of the ready availability zone must be under the availability zone corresponding to the StandbyZoneId. required if you need to create multiple availability zone instances.
        """
        return pulumi.get(self, "standby_vswitch_id")
    ...
    @property
    @pulumi.getter(name="standbyZoneId")
    def standby_zone_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The multiple availability zone instances with availability zone IDs for the prepared availability zones. required if you need to create multiple availability zone instances.
        """
        return pulumi.get(self, "standby_zone_id")
    ...
    @property
    @pulumi.getter(name="streamEngineNodeCount")
    def stream_engine_node_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of LindormStream nodes in the instance.
        """
        return pulumi.get(self, "stream_engine_node_count")
    ...
    @property
    @pulumi.getter(name="streamEngineSpecification")
    def stream_engine_specification(self) -> pulumi.Output[builtins.str]:
        """
        The specification of the LindormStream nodes in the instance. Valid values: `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`.
        """
        return pulumi.get(self, "stream_engine_specification")
    ...
    @property
    @pulumi.getter(name="tableEngineNodeCount")
    def table_engine_node_count(self) -> pulumi.Output[builtins.int]:
        """
        The count of table engine.
        """
        return pulumi.get(self, "table_engine_node_count")
    ...
    @property
    @pulumi.getter(name="tableEngineSpecification")
    def table_engine_specification(self) -> pulumi.Output[builtins.str]:
        """
        The specification of  table engine. Valid values: `lindorm.c.2xlarge`, `lindorm.c.4xlarge`, `lindorm.c.8xlarge`, `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`.
        """
        return pulumi.get(self, "table_engine_specification")
    ...
    @property
    @pulumi.getter(name="timeSeriesEngineNodeCount")
    def time_series_engine_node_count(self) -> pulumi.Output[builtins.int]:
        """
        The count of time series engine.
        """
        return pulumi.get(self, "time_series_engine_node_count")
    ...
    @property
    @pulumi.getter(name="timeSeriesEngineSpecification")
    def time_series_engine_specification(self) -> pulumi.Output[builtins.str]:
        """
        The specification of time series engine. Valid values: `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`, `lindorm.r.8xlarge`.
        """
        return pulumi.get(self, "time_series_engine_specification")
    ...
    @pulumi.getter(name="timeSeriresEngineSpecification")
    @_utilities.deprecated("""Field `time_serires_engine_specification` has been deprecated from provider version 1.182.0. New field `time_series_engine_specification` instead.""")
    def time_serires_engine_specification(self) -> pulumi.Output[builtins.str]:
        """
        Field `time_serires_engine_specification` has been deprecated from provider version 1.182.0. New field `time_series_engine_specification` instead.
        """
        return pulumi.get(self, "time_serires_engine_specification")
