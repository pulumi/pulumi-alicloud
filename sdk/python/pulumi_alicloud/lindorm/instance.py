...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] disk_category: The disk type of instance. Valid values: `cloud_efficiency`, `cloud_ssd`, `cloud_essd`, `cloud_essd_pl0`, `capacity_cloud_storage`, `local_ssd_pro`, `local_hdd_pro`. **NOTE:** From version 1.207.0, `disk_category` can be set to `cloud_essd_pl0`.
        :param pulumi.Input[_builtins.str] payment_type: The billing method. Valid values: `PayAsYouGo` and `Subscription`.
        :param pulumi.Input[_builtins.str] vswitch_id: The vswitch id.
        :param pulumi.Input[_builtins.str] arbiter_vswitch_id: The multi-availability zone instance, coordinating the virtual switch ID of the availability zone, the switch must be located under the availability zone corresponding to the ArbiterZoneId. This parameter is required if you need to create multiple availability zone instances.
        :param pulumi.Input[_builtins.str] arbiter_zone_id: The multiple Availability Zone Instance, the availability zone ID of the coordinating availability zone. required if you need to create multiple availability zone instances.
        :param pulumi.Input[_builtins.str] arch_version: The deployment architecture. If you do not fill in this parameter, the default is 1.0. to create multiple availability instances, fill in 2.0. if you need to create multiple availability instances, this parameter is required. Valid values: `1.0` to `2.0`.
        :param pulumi.Input[_builtins.str] auto_renew: Specifies whether to enable auto-renewal for the instance. Valid when the `payment_type` is `Subscription`. Default value: false. Valid values: true(enables auto-renewal), false(disables auto-renewal).
        :param pulumi.Input[_builtins.str] auto_renew_period: The subscription duration that is supported by auto-renewal. Unit: months. Valid values: `1` to `12`. This parameter is required only if the AutoRenew parameter is set to true.
        :param pulumi.Input[_builtins.int] cold_storage: The cold storage capacity of the instance. Unit: GB. Valid values: [800, 1000000].
        :param pulumi.Input[_builtins.int] core_single_storage: The multiple availability zone instances, CORE single node capacity. required if you want to create multiple availability zone instances. Valid values: `400` to `64000`.
        :param pulumi.Input[_builtins.str] core_spec: The core spec. When `disk_category` is `local_ssd_pro` or `local_hdd_pro`, this filed is valid.
        ...
        :param pulumi.Input[_builtins.bool] deletion_proection: The deletion protection of instance.
        :param pulumi.Input[_builtins.str] duration: The duration of paid. Valid when the `payment_type` is `Subscription`.  When `pricing_cycle` set to `Month`, the valid value id `1` to `9`.  When `pricing_cycle` set to `Year`, the valid value id `1` to `3`.
        :param pulumi.Input[_builtins.int] file_engine_node_count: The count of file engine.
        :param pulumi.Input[_builtins.str] file_engine_specification: The specification of file engine. Valid values: `lindorm.c.xlarge`.
        :param pulumi.Input[_builtins.str] instance_name: The name of the instance.
        :param pulumi.Input[_builtins.str] instance_storage: The storage capacity of the instance. Unit: GB. Valid values: [80, 10485760], and the value must be divisible by 80.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_white_lists: The ip white list of instance.
        :param pulumi.Input[_builtins.str] log_disk_category: The multi-available zone instance, log node disk type. required if you need to create multiple availability zone instances. Valid values: `cloud_efficiency`, `cloud_ssd`.
        :param pulumi.Input[_builtins.int] log_num: The multiple Availability Zone Instance, number of log nodes. this parameter is required if you want to create multiple availability zone instances. Valid values: `4` to `400`.
        :param pulumi.Input[_builtins.int] log_single_storage: The multi-availability instance, log single-node disk capacity. This parameter is required if you want to create multiple availability zone instances. Valid values: `400` to `64000`.
        :param pulumi.Input[_builtins.str] log_spec: The multiple availability zone instances, log node specification. required if you need to create multiple availability zone instances. Valid values: `lindorm.sn1.large`, `lindorm.sn1.2xlarge`.
        :param pulumi.Input[_builtins.int] lts_node_count: The count of lindorm tunnel service.
        :param pulumi.Input[_builtins.str] lts_node_specification: The specification of lindorm tunnel service. Valid values: `lindorm.g.2xlarge`, `lindorm.g.xlarge`.
        :param pulumi.Input[_builtins.str] multi_zone_combination: The multi-zone combinations. Availability zone combinations are supported on the sale page. required if you need to create multiple availability zone instances. Valid values: `ap-southeast-5abc-aliyun`, `cn-hangzhou-ehi-aliyun`, `cn-beijing-acd-aliyun`, `ap-southeast-1-abc-aliyun`, `cn-zhangjiakou-abc-aliyun`, `cn-shanghai-efg-aliyun`, `cn-shanghai-abd-aliyun`, `cn-hangzhou-bef-aliyun`, `cn-hangzhou-bce-aliyun`, `cn-beijing-fgh-aliyun`, `cn-shenzhen-abc-aliyun`.
        :param pulumi.Input[_builtins.str] pricing_cycle: The pricing cycle. Valid when the `payment_type` is `Subscription`. Valid values: `Month` and `Year`.
        :param pulumi.Input[_builtins.str] primary_vswitch_id: Multi-available zone instances, the virtual switch ID of the primary available zone, must be under the available zone corresponding to the PrimaryZoneId. required if you need to create multiple availability zone instances.
        :param pulumi.Input[_builtins.str] primary_zone_id: Multi-availability zone instance with the availability zone ID of the main availability zone. required if you need to create multiple availability zone instances.
        :param pulumi.Input[_builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[_builtins.int] search_engine_node_count: The count of search engine.
        :param pulumi.Input[_builtins.str] search_engine_specification: The specification of search engine. Valid values: `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`, `lindorm.g.xlarge`.
        :param pulumi.Input[_builtins.str] standby_vswitch_id: The multiple availability zone instances, the virtual switch ID of the ready availability zone must be under the availability zone corresponding to the StandbyZoneId. required if you need to create multiple availability zone instances.
        :param pulumi.Input[_builtins.str] standby_zone_id: The multiple availability zone instances with availability zone IDs for the prepared availability zones. required if you need to create multiple availability zone instances.
        :param pulumi.Input[_builtins.int] stream_engine_node_count: The number of LindormStream nodes in the instance.
        :param pulumi.Input[_builtins.str] stream_engine_specification: The specification of the LindormStream nodes in the instance. Valid values: `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`.
        :param pulumi.Input[_builtins.int] table_engine_node_count: The count of table engine.
        :param pulumi.Input[_builtins.str] table_engine_specification: The specification of  table engine. Valid values: `lindorm.c.2xlarge`, `lindorm.c.4xlarge`, `lindorm.c.8xlarge`, `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[_builtins.int] time_series_engine_node_count: The count of time series engine.
        :param pulumi.Input[_builtins.str] time_series_engine_specification: The specification of time series engine. Valid values: `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`, `lindorm.r.8xlarge`.
        :param pulumi.Input[_builtins.str] time_serires_engine_specification: Field `time_serires_engine_specification` has been deprecated from provider version 1.182.0. New field `time_series_engine_specification` instead.
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] disk_category: The disk type of instance. Valid values: `cloud_efficiency`, `cloud_ssd`, `cloud_essd`, `cloud_essd_pl0`, `capacity_cloud_storage`, `local_ssd_pro`, `local_hdd_pro`. **NOTE:** From version 1.207.0, `disk_category` can be set to `cloud_essd_pl0`.
        :param pulumi.Input[_builtins.str] duration: The duration of paid. Valid when the `payment_type` is `Subscription`.  When `pricing_cycle` set to `Month`, the valid value id `1` to `9`.  When `pricing_cycle` set to `Year`, the valid value id `1` to `3`.
        :param pulumi.Input[_builtins.bool] enabled_file_engine: (Available since v1.163.0) Whether to enable file engine.
        :param pulumi.Input[_builtins.bool] enabled_lts_engine: (Available since v1.163.0) Whether to enable lts engine.
        :param pulumi.Input[_builtins.bool] enabled_search_engine: (Available since v1.163.0) Whether to enable search engine.
        :param pulumi.Input[_builtins.bool] enabled_stream_engine: (Available since v1.211.0) Whether to enable streaming engine.
        :param pulumi.Input[_builtins.bool] enabled_table_engine: (Available since v1.163.0) Whether to enable table engine.
        :param pulumi.Input[_builtins.bool] enabled_time_serires_engine: (Available since v1.163.0) Whether to enable time serires engine.
        :param pulumi.Input[_builtins.int] file_engine_node_count: The count of file engine.
        :param pulumi.Input[_builtins.str] file_engine_specification: The specification of file engine. Valid values: `lindorm.c.xlarge`.
        :param pulumi.Input[_builtins.str] instance_name: The name of the instance.
        :param pulumi.Input[_builtins.str] instance_storage: The storage capacity of the instance. Unit: GB. Valid values: [80, 10485760], and the value must be divisible by 80.
        ...
        :param pulumi.Input[_builtins.int] search_engine_node_count: The count of search engine.
        :param pulumi.Input[_builtins.str] search_engine_specification: The specification of search engine. Valid values: `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`, `lindorm.g.xlarge`.
        :param pulumi.Input[_builtins.str] service_type: (Available since v1.196.0) The instance type.
        :param pulumi.Input[_builtins.str] standby_vswitch_id: The multiple availability zone instances, the virtual switch ID of the ready availability zone must be under the availability zone corresponding to the StandbyZoneId. required if you need to create multiple availability zone instances.
        :param pulumi.Input[_builtins.str] standby_zone_id: The multiple availability zone instances with availability zone IDs for the prepared availability zones. required if you need to create multiple availability zone instances.
        :param pulumi.Input[_builtins.str] status: The status of Instance.
        :param pulumi.Input[_builtins.int] stream_engine_node_count: The number of LindormStream nodes in the instance.
        :param pulumi.Input[_builtins.str] stream_engine_specification: The specification of the LindormStream nodes in the instance. Valid values: `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`.
        :param pulumi.Input[_builtins.int] table_engine_node_count: The count of table engine.
        :param pulumi.Input[_builtins.str] table_engine_specification: The specification of  table engine. Valid values: `lindorm.c.2xlarge`, `lindorm.c.4xlarge`, `lindorm.c.8xlarge`, `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`.
...
class Instance(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="coreSingleStorage")
    def core_single_storage(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The multiple availability zone instances, CORE single node capacity. required if you want to create multiple availability zone instances. Valid values: `400` to `64000`.
        """
        return pulumi.get(self, "core_single_storage")
    ...
    @_builtins.property
    @pulumi.getter(name="coreSpec")
    def core_spec(self) -> pulumi.Output[_builtins.str]:
        """
        The core spec. When `disk_category` is `local_ssd_pro` or `local_hdd_pro`, this filed is valid.
        - When `disk_category` is `local_ssd_pro`, the valid values is `lindorm.i2.xlarge`, `lindorm.i2.2xlarge`, `lindorm.i2.4xlarge`, `lindorm.i2.8xlarge`.
        - When `disk_category` is `local_hdd_pro`, the valid values is `lindorm.d2c.6xlarge`, `lindorm.d2c.12xlarge`, `lindorm.d2c.24xlarge`, `lindorm.d2s.5xlarge`, `lindorm.d2s.10xlarge`, `lindorm.d1.2xlarge`, `lindorm.d1.4xlarge`, `lindorm.d1.6xlarge`.
    ...
    @_builtins.property
    @pulumi.getter(name="deletionProection")
    def deletion_proection(self) -> pulumi.Output[_builtins.bool]:
        """
        The deletion protection of instance.
        """
        return pulumi.get(self, "deletion_proection")
    ...
    @_builtins.property
    @pulumi.getter(name="enabledFileEngine")
    def enabled_file_engine(self) -> pulumi.Output[_builtins.bool]:
        """
        (Available since v1.163.0) Whether to enable file engine.
        """
        return pulumi.get(self, "enabled_file_engine")
    ...
    @_builtins.property
    @pulumi.getter(name="enabledLtsEngine")
    def enabled_lts_engine(self) -> pulumi.Output[_builtins.bool]:
        """
        (Available since v1.163.0) Whether to enable lts engine.
        """
        return pulumi.get(self, "enabled_lts_engine")
    ...
    @_builtins.property
    @pulumi.getter(name="enabledSearchEngine")
    def enabled_search_engine(self) -> pulumi.Output[_builtins.bool]:
        """
        (Available since v1.163.0) Whether to enable search engine.
        """
        return pulumi.get(self, "enabled_search_engine")
    ...
    @_builtins.property
    @pulumi.getter(name="enabledStreamEngine")
    def enabled_stream_engine(self) -> pulumi.Output[_builtins.bool]:
        """
        (Available since v1.211.0) Whether to enable streaming engine.
        """
        return pulumi.get(self, "enabled_stream_engine")
    ...
    @_builtins.property
    @pulumi.getter(name="enabledTableEngine")
    def enabled_table_engine(self) -> pulumi.Output[_builtins.bool]:
        """
        (Available since v1.163.0) Whether to enable table engine.
        """
        return pulumi.get(self, "enabled_table_engine")
    ...
    @_builtins.property
    @pulumi.getter(name="enabledTimeSeriresEngine")
    def enabled_time_serires_engine(self) -> pulumi.Output[_builtins.bool]:
        """
        (Available since v1.163.0) Whether to enable time serires engine.
        """
        return pulumi.get(self, "enabled_time_serires_engine")
    ...
    @_builtins.property
    @pulumi.getter(name="fileEngineNodeCount")
    def file_engine_node_count(self) -> pulumi.Output[_builtins.int]:
        """
        The count of file engine.
        """
        return pulumi.get(self, "file_engine_node_count")
    ...
    @_builtins.property
    @pulumi.getter(name="fileEngineSpecification")
    def file_engine_specification(self) -> pulumi.Output[_builtins.str]:
        """
        The specification of file engine. Valid values: `lindorm.c.xlarge`.
        """
        return pulumi.get(self, "file_engine_specification")
    ...
    @_builtins.property
    @pulumi.getter(name="instanceStorage")
    def instance_storage(self) -> pulumi.Output[_builtins.str]:
        """
        The storage capacity of the instance. Unit: GB. Valid values: [80, 10485760], and the value must be divisible by 80.
        """
        return pulumi.get(self, "instance_storage")
    ...
    @_builtins.property
    @pulumi.getter(name="logDiskCategory")
    def log_disk_category(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The multi-available zone instance, log node disk type. required if you need to create multiple availability zone instances. Valid values: `cloud_efficiency`, `cloud_ssd`.
        """
        return pulumi.get(self, "log_disk_category")
    ...
    @_builtins.property
    @pulumi.getter(name="logNum")
    def log_num(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The multiple Availability Zone Instance, number of log nodes. this parameter is required if you want to create multiple availability zone instances. Valid values: `4` to `400`.
        """
        return pulumi.get(self, "log_num")
    ...
    @_builtins.property
    @pulumi.getter(name="logSingleStorage")
    def log_single_storage(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The multi-availability instance, log single-node disk capacity. This parameter is required if you want to create multiple availability zone instances. Valid values: `400` to `64000`.
        """
        return pulumi.get(self, "log_single_storage")
    ...
    @_builtins.property
    @pulumi.getter(name="logSpec")
    def log_spec(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The multiple availability zone instances, log node specification. required if you need to create multiple availability zone instances. Valid values: `lindorm.sn1.large`, `lindorm.sn1.2xlarge`.
        """
        return pulumi.get(self, "log_spec")
    ...
    @_builtins.property
    @pulumi.getter(name="ltsNodeCount")
    def lts_node_count(self) -> pulumi.Output[_builtins.int]:
        """
        The count of lindorm tunnel service.
        """
        return pulumi.get(self, "lts_node_count")
    ...
    @_builtins.property
    @pulumi.getter(name="ltsNodeSpecification")
    def lts_node_specification(self) -> pulumi.Output[_builtins.str]:
        """
        The specification of lindorm tunnel service. Valid values: `lindorm.g.2xlarge`, `lindorm.g.xlarge`.
        """
        return pulumi.get(self, "lts_node_specification")
    ...
    @_builtins.property
    @pulumi.getter(name="multiZoneCombination")
    def multi_zone_combination(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The multi-zone combinations. Availability zone combinations are supported on the sale page. required if you need to create multiple availability zone instances. Valid values: `ap-southeast-5abc-aliyun`, `cn-hangzhou-ehi-aliyun`, `cn-beijing-acd-aliyun`, `ap-southeast-1-abc-aliyun`, `cn-zhangjiakou-abc-aliyun`, `cn-shanghai-efg-aliyun`, `cn-shanghai-abd-aliyun`, `cn-hangzhou-bef-aliyun`, `cn-hangzhou-bce-aliyun`, `cn-beijing-fgh-aliyun`, `cn-shenzhen-abc-aliyun`.
        """
        return pulumi.get(self, "multi_zone_combination")
    ...
    @_builtins.property
    @pulumi.getter(name="searchEngineNodeCount")
    def search_engine_node_count(self) -> pulumi.Output[_builtins.int]:
        """
        The count of search engine.
        """
        return pulumi.get(self, "search_engine_node_count")
    ...
    @_builtins.property
    @pulumi.getter(name="searchEngineSpecification")
    def search_engine_specification(self) -> pulumi.Output[_builtins.str]:
        """
        The specification of search engine. Valid values: `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`, `lindorm.g.xlarge`.
        """
        return pulumi.get(self, "search_engine_specification")
    ...
    @_builtins.property
    @pulumi.getter(name="streamEngineNodeCount")
    def stream_engine_node_count(self) -> pulumi.Output[_builtins.int]:
        """
        The number of LindormStream nodes in the instance.
        """
        return pulumi.get(self, "stream_engine_node_count")
    ...
    @_builtins.property
    @pulumi.getter(name="streamEngineSpecification")
    def stream_engine_specification(self) -> pulumi.Output[_builtins.str]:
        """
        The specification of the LindormStream nodes in the instance. Valid values: `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`.
        """
        return pulumi.get(self, "stream_engine_specification")
    ...
    @_builtins.property
    @pulumi.getter(name="tableEngineNodeCount")
    def table_engine_node_count(self) -> pulumi.Output[_builtins.int]:
        """
        The count of table engine.
        """
        return pulumi.get(self, "table_engine_node_count")
    ...
    @_builtins.property
    @pulumi.getter(name="tableEngineSpecification")
    def table_engine_specification(self) -> pulumi.Output[_builtins.str]:
        """
        The specification of  table engine. Valid values: `lindorm.c.2xlarge`, `lindorm.c.4xlarge`, `lindorm.c.8xlarge`, `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`.
        """
        return pulumi.get(self, "table_engine_specification")
    ...
    @_builtins.property
    @pulumi.getter(name="timeSeriesEngineNodeCount")
    def time_series_engine_node_count(self) -> pulumi.Output[_builtins.int]:
        """
        The count of time series engine.
        """
        return pulumi.get(self, "time_series_engine_node_count")
    ...
    @_builtins.property
    @pulumi.getter(name="timeSeriesEngineSpecification")
    def time_series_engine_specification(self) -> pulumi.Output[_builtins.str]:
        """
        The specification of time series engine. Valid values: `lindorm.g.xlarge`, `lindorm.g.2xlarge`, `lindorm.g.4xlarge`, `lindorm.g.8xlarge`, `lindorm.r.8xlarge`.
        """
        return pulumi.get(self, "time_series_engine_specification")
    ...
    @pulumi.getter(name="timeSeriresEngineSpecification")
    @_utilities.deprecated("""Field `time_serires_engine_specification` has been deprecated from provider version 1.182.0. New field `time_series_engine_specification` instead.""")
    def time_serires_engine_specification(self) -> pulumi.Output[_builtins.str]:
        """
        Field `time_serires_engine_specification` has been deprecated from provider version 1.182.0. New field `time_series_engine_specification` instead.
        """
        return pulumi.get(self, "time_serires_engine_specification")
