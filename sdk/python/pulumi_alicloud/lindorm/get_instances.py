...
class GetInstancesResult:
    ...
    def query_str(self) -> Optional[builtins.str]:
    ...
    def support_engine(self) -> Optional[builtins.int]:
...
def get_instances(enable_details: Optional[builtins.bool] = None,
                  ids: Optional[Sequence[builtins.str]] = None,
                  name_regex: Optional[builtins.str] = None,
                  output_file: Optional[builtins.str] = None,
                  query_str: Optional[builtins.str] = None,
                  status: Optional[builtins.str] = None,
                  support_engine: Optional[builtins.int] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Instance IDs.
    :param builtins.str name_regex: A regex string to filter results by Instance name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str query_str: The query str, which can use `instance_name` keyword for fuzzy search.
    :param builtins.str status: Instance status, Valid values: `ACTIVATION`, `DELETED`, `CREATING`, `CLASS_CHANGING`, `LOCKED`, `INSTANCE_LEVEL_MODIFY`, `NET_MODIFYING`, `RESIZING`, `RESTARTING`, `MINOR_VERSION_TRANSING`.
    :param builtins.int support_engine: The support engine. Valid values: `1` to `7`.
    """
    __args__ = dict()
...
def get_instances_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                         ...
                         query_str: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         support_engine: Optional[pulumi.Input[Optional[builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:lindorm/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult)
    return __ret__.apply(lambda __response__: GetInstancesResult(
        ...
        support_engine=pulumi.get(__response__, 'support_engine')))
