...
class GetInstancesResult:
    ...
    def support_engine(self) -> Optional[_builtins.int]:
...
def get_instances(enable_details: Optional[_builtins.bool] = None,
                  ...
                  support_engine: Optional[_builtins.int] = None,
    ...
    :param _builtins.str query_str: The query str, which can use `instance_name` keyword for fuzzy search.
    :param _builtins.str status: Instance status, Valid values: `ACTIVATION`, `DELETED`, `CREATING`, `CLASS_CHANGING`, `LOCKED`, `INSTANCE_LEVEL_MODIFY`, `NET_MODIFYING`, `RESIZING`, `RESTARTING`, `MINOR_VERSION_TRANSING`.
    :param _builtins.int support_engine: The support engine. Valid values: `1` to `7`.
    """
    __args__ = dict()
