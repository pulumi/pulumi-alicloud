...
class ListenerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] load_balancer_id: The GWLB instance ID.
        ...
        :param pulumi.Input[builtins.str] listener_description: The description of the listener.
               
               The description must be 2 to 256 characters in length, and can contain letters, digits, commas (,), periods (.), semicolons (;), forward slashes (/), at signs (@), underscores (\\_), and hyphens (-).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags. You can specify at most 20 tags in each call.
        """
