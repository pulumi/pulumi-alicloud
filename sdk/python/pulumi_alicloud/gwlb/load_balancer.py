...
class LoadBalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vpc_id: The virtual private cloud (VPC) ID.
        ...
        :param pulumi.Input[builtins.str] address_ip_version: The IP version. Valid values:
               
               - `Ipv4`: IPv4 (default)
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to perform a dry run, without performing the actual request. Valid values:
        :param pulumi.Input[builtins.str] load_balancer_name: The GWLB instance name.
               
               The name must be 2 to 128 characters in length, and can contain letters, digits, periods (.), underscores (\\_), and hyphens (-). The name must start with a letter.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag keys. You can specify at most 20 tags in each call.
        """
...
class _LoadBalancerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] address_ip_version: The IP version. Valid values:
               ...
               - `Ipv4`: IPv4 (default)
        :param pulumi.Input[builtins.str] create_time: The time when the resource was created. The time follows the ISO 8601 standard in the **yyyy-MM-ddTHH:mm:ssZ** format. The time is displayed in UTC.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to perform a dry run, without performing the actual request. Valid values:
        :param pulumi.Input[builtins.str] load_balancer_name: The GWLB instance name.
               
               The name must be 2 to 128 characters in length, and can contain letters, digits, periods (.), underscores (\\_), and hyphens (-). The name must start with a letter.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] status: The GWLB instance status.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag keys. You can specify at most 20 tags in each call.
        :param pulumi.Input[builtins.str] vpc_id: The virtual private cloud (VPC) ID.
        :param pulumi.Input[Sequence[pulumi.Input['LoadBalancerZoneMappingArgs']]] zone_mappings: The mappings between zones and vSwitches. You must specify at least one zone. You can specify at most 20 zones. If the region supports two or more zones, we recommend that you select two or more zones. See `zone_mappings` below.
        """
