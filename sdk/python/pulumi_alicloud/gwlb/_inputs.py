...
class LoadBalancerZoneMappingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the vSwitch in the zone. You can specify only one vSwitch (subnet) in each zone of a GWLB instance.
        :param pulumi.Input[builtins.str] zone_id: The zone ID. You can call the DescribeZones operation to query the most recent zone list.
...
class LoadBalancerZoneMappingLoadBalancerAddressArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] eni_id: The ID of the elastic network interface (ENI) used by the GWLB instance.
        :param pulumi.Input[builtins.str] private_ipv4_address: The private IPv4 address.
        """
...
class ServerGroupConnectionDrainConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] connection_drain_enabled: Indicates whether connection draining is enabled. Valid values:
...
class ServerGroupHealthCheckConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] health_check_connect_port: The backend server port that is used for health checks.
               
               Valid values: `1` to `65535`.
               
               Default value: `80`.
        :param pulumi.Input[builtins.int] health_check_connect_timeout: The maximum timeout period of a health check response.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] health_check_http_codes: The HTTP status codes that the system returns for health checks.
        :param pulumi.Input[builtins.int] health_check_interval: The interval at which health checks are performed.
...
class ServerGroupServerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] server_id: The backend server ID.
               
               - If the server group is of the `Instance` type, set this parameter to the IDs of servers of the `Ecs`, `Eni`, or `Eci` type.
               - If the server group is of the `Ip` type, set ServerId to IP addresses.
        :param pulumi.Input[builtins.str] server_type: The type of the backend server. Valid values:
               
               - `Ecs`: Elastic Compute Service (ECS) instance
               - `Eni`: elastic network interface (ENI)
               - `Eci`: elastic container instance
               - `Ip`: IP address
        :param pulumi.Input[builtins.int] port: (Optional, Computed, Int) The port that is used by the backend server.
        :param pulumi.Input[builtins.str] server_group_id: The server group ID.
        :param pulumi.Input[builtins.str] server_ip: The IP address of the backend server.
        :param pulumi.Input[builtins.str] status: Indicates the status of the backend server.
        """
