...
class ServerGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_group_name: The server group name.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ServerGroupServerArgs']]] servers: The backend servers that you want to remove.
               ...
               See `servers` below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag keys.
...
class ServerGroup(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:gwlb/serverGroup:ServerGroup"
    ...
    @property
    @pulumi.getter(name="serverGroupName")
    def server_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The server group name.
