...
def get_zones(accept_language: Optional[builtins.str] = None,
    ...
    :param builtins.str accept_language: The supported language. Valid values:
           - **zh-CN**: Chinese
...
def get_zones_output(accept_language: Optional[pulumi.Input[Optional[builtins.str]]] = None,
