...
def get_zones(accept_language: Optional[_builtins.str] = None,
    ...
    :param _builtins.str accept_language: The supported language. Valid values:
           - **zh-CN**: Chinese
...
def get_zones_output(accept_language: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
