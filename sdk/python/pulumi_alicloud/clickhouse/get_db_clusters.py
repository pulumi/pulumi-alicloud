...
class GetDbClustersResult:
    ...
    def db_cluster_description(self) -> Optional[builtins.str]:
...
def get_db_clusters(db_cluster_description: Optional[builtins.str] = None,
    ...
    :param builtins.str status: The status of the resource. Valid values: `Running`,`Creating`,`Deleting`,`Restarting`,`Preparing`,.
    """
    __args__ = dict()
...
def get_db_clusters_output(db_cluster_description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
