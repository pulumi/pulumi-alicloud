...
class GetDbClustersResult:
    ...
    def db_cluster_description(self) -> Optional[_builtins.str]:
...
def get_db_clusters(db_cluster_description: Optional[_builtins.str] = None,
    ...
    :param _builtins.str status: The status of the resource. Valid values: `Running`,`Creating`,`Deleting`,`Restarting`,`Preparing`,.
    """
    __args__ = dict()
