...
class BackupPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] preferred_backup_periods: DBCluster Backup period. A list of DBCluster Backup period. Valid values: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"].
        :param pulumi.Input[builtins.str] preferred_backup_time: DBCluster backup time, in the format of `HH:mmZ-HH:mmZ`. Time setting interval is one hour. China time is 8 hours behind it.
        :param pulumi.Input[builtins.int] backup_retention_period: Data backup days. Valid values: `7` to `730`.
        """
...
class BackupPolicy(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:clickhouse/backupPolicy:BackupPolicy"
    ...
    def get(resource_name: str,
            ...
            preferred_backup_periods: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            preferred_backup_time: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'BackupPolicy':
        """
