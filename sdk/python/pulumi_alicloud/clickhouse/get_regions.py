...
class GetRegionsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def current(self) -> Optional[_builtins.bool]:
...
def get_regions(current: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool current: Set to true to match only the region configured in the provider. Default value: `true`.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str region_id: You can use specified region_id to find the region and available zones information that supports ClickHouse.
    """
    __args__ = dict()
