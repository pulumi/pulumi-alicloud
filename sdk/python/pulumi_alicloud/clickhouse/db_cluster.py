...
class DbClusterArgs:
    def __init__(__self__, *,
                 ...
                 db_cluster_class: pulumi.Input[builtins.str],
                 db_cluster_network_type: pulumi.Input[builtins.str],
                 db_cluster_version: pulumi.Input[builtins.str],
                 db_node_group_count: pulumi.Input[builtins.int],
                 db_node_storage: pulumi.Input[builtins.str],
                 payment_type: pulumi.Input[builtins.str],
                 storage_type: pulumi.Input[builtins.str],
                 allocate_public_connection: Optional[pulumi.Input[builtins.bool]] = None,
                 cold_storage: Optional[pulumi.Input[builtins.str]] = None,
                 db_cluster_access_white_lists: Optional[pulumi.Input[Sequence[pulumi.Input['DbClusterDbClusterAccessWhiteListArgs']]]] = None,
                 db_cluster_description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] category: The Category of DBCluster. Valid values: `Basic`,`HighAvailability`.
        :param pulumi.Input[builtins.str] db_cluster_class: The DBCluster class. According to the category, db_cluster_class has two value ranges:
        ...
        :param pulumi.Input[builtins.str] db_cluster_network_type: The DBCluster network type. Valid values: `vpc`.
        :param pulumi.Input[builtins.str] db_cluster_version: The DBCluster version. Valid values: `20.3.10.75`, `20.8.7.15`, `21.8.10.19`, `22.8.5.29`, `23.8`. **NOTE:** `19.15.2.2` is no longer supported. From version 1.191.0, `db_cluster_version` can be set to `22.8.5.29`.
        :param pulumi.Input[builtins.int] db_node_group_count: The db node group count. The number should between 1 and 48.
        :param pulumi.Input[builtins.str] db_node_storage: The db node storage.
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource. Valid values: `PayAsYouGo`,`Subscription`.
        :param pulumi.Input[builtins.str] storage_type: Storage type of DBCluster. Valid values: `cloud_essd`, `cloud_efficiency`, `cloud_essd_pl2`, `cloud_essd_pl3`.
        :param pulumi.Input[builtins.bool] allocate_public_connection: Whether to enable public connection. Value options: `true`, `false`.
        :param pulumi.Input[builtins.str] cold_storage: Whether to use cold storage. Valid values: `ENABLE`, `DISABLE`, default to `DISABLE`. When it's set to `ENABLE`, cold storage will be used, and `cold_storage` cannot be set to `DISABLE` again.
        ...
        :param pulumi.Input[builtins.str] db_cluster_description: The DBCluster description.
        :param pulumi.Input[builtins.str] encryption_key: Key management service KMS key ID. It is valid and required when encryption_type is `CloudDisk`.
        :param pulumi.Input[builtins.str] encryption_type: Currently only supports ECS disk encryption, with a value of CloudDisk, not encrypted when empty.
        :param pulumi.Input[builtins.str] maintain_time: The maintenance window of DBCluster. Valid format: `hh:mmZ-hh:mm Z`.
        ...
        :param pulumi.Input[builtins.str] period: Pre-paid cluster of the pay-as-you-go cycle. It is valid and required when payment_type is `Subscription`. Valid values: `Month`, `Year`.
        :param pulumi.Input[builtins.str] renewal_status: The renewal status of the resource. Valid values: `AutoRenewal`,`Normal`. It is valid and required when payment_type is `Subscription`. When `renewal_status` is set to `AutoRenewal`, the resource is renewed automatically.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid values: `Running`,`Creating`,`Deleting`,`Restarting`,`Preparing`.
        :param pulumi.Input[builtins.str] used_time: The used time of DBCluster. It is valid and required when payment_type is `Subscription`. item choices: [1-9] when period is `Month`, [1-3] when period is `Year`.
        :param pulumi.Input[builtins.str] vpc_id: The id of the VPC.
        :param pulumi.Input[builtins.str] vswitch_id: The vswitch id of DBCluster.
    ...
    def db_cluster_class(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_cluster_class(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "db_cluster_class", value)

    @property
    @pulumi.getter(name="dbClusterNetworkType")
    def db_cluster_network_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_cluster_network_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "db_cluster_network_type", value)

    @property
    @pulumi.getter(name="dbClusterVersion")
    def db_cluster_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_cluster_version(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "db_cluster_version", value)

    @property
    @pulumi.getter(name="dbNodeGroupCount")
    def db_node_group_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def db_node_group_count(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "db_node_group_count", value)

    @property
    @pulumi.getter(name="dbNodeStorage")
    def db_node_storage(self) -> pulumi.Input[builtins.str]:
        """
        The db node storage.
        """
    ...
    def db_node_storage(self, value: pulumi.Input[builtins.str]):
    ...
    def allocate_public_connection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allocate_public_connection(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allocate_public_connection", value)

    @property
    @pulumi.getter(name="coldStorage")
    def cold_storage(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cold_storage.setter
    def cold_storage(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def db_cluster_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_cluster_description(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DbClusterState:
    def __init__(__self__, *,
                 ...
                 db_cluster_access_white_lists: Optional[pulumi.Input[Sequence[pulumi.Input['DbClusterDbClusterAccessWhiteListArgs']]]] = None,
                 db_cluster_class: Optional[pulumi.Input[builtins.str]] = None,
                 db_cluster_description: Optional[pulumi.Input[builtins.str]] = None,
                 db_cluster_network_type: Optional[pulumi.Input[builtins.str]] = None,
                 db_cluster_version: Optional[pulumi.Input[builtins.str]] = None,
                 db_node_group_count: Optional[pulumi.Input[builtins.int]] = None,
                 db_node_storage: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_key: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_type: Optional[pulumi.Input[builtins.str]] = None,
                 maintain_time: Optional[pulumi.Input[builtins.str]] = None,
                 multi_zone_vswitch_lists: Optional[pulumi.Input[Sequence[pulumi.Input['DbClusterMultiZoneVswitchListArgs']]]] = None,
                 ...
                 public_connection_string: Optional[pulumi.Input[builtins.str]] = None,
                 renewal_status: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] category: The Category of DBCluster. Valid values: `Basic`,`HighAvailability`.
        :param pulumi.Input[builtins.str] cold_storage: Whether to use cold storage. Valid values: `ENABLE`, `DISABLE`, default to `DISABLE`. When it's set to `ENABLE`, cold storage will be used, and `cold_storage` cannot be set to `DISABLE` again.
        :param pulumi.Input[builtins.str] connection_string: (Available since v1.196.0) - The connection string of the cluster.
        :param pulumi.Input[Sequence[pulumi.Input['DbClusterDbClusterAccessWhiteListArgs']]] db_cluster_access_white_lists: The db cluster access white list. See `db_cluster_access_white_list` below.
        :param pulumi.Input[builtins.str] db_cluster_class: The DBCluster class. According to the category, db_cluster_class has two value ranges:
               * Under the condition that the category is the `Basic`, Valid values: `LS20`, `LS40`, `LS80`,`S8`, `S16`, `S32`, `S64`,`S80`, `S104`.
               * Under the condition that the category is the `HighAvailability`, Valid values: `LC20`, `LC40`, `LC80`,`C8`, `C16`, `C32`, `C64`, `C80`, `C104`.
        ...
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource. Valid values: `PayAsYouGo`,`Subscription`.
        :param pulumi.Input[builtins.str] period: Pre-paid cluster of the pay-as-you-go cycle. It is valid and required when payment_type is `Subscription`. Valid values: `Month`, `Year`.
        :param pulumi.Input[builtins.str] port: (Available since v1.196.0) The connection port of the cluster.
        :param pulumi.Input[builtins.str] public_connection_string: (Available since v1.245.0) The public connection string of the cluster. Only valid when `allocate_public_connection` is `true`.
        :param pulumi.Input[builtins.str] renewal_status: The renewal status of the resource. Valid values: `AutoRenewal`,`Normal`. It is valid and required when payment_type is `Subscription`. When `renewal_status` is set to `AutoRenewal`, the resource is renewed automatically.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid values: `Running`,`Creating`,`Deleting`,`Restarting`,`Preparing`.
        :param pulumi.Input[builtins.str] storage_type: Storage type of DBCluster. Valid values: `cloud_essd`, `cloud_efficiency`, `cloud_essd_pl2`, `cloud_essd_pl3`.
    ...
    @property
    @pulumi.getter(name="dbClusterClass")
    def db_cluster_class(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The DBCluster class. According to the category, db_cluster_class has two value ranges:
        * Under the condition that the category is the `Basic`, Valid values: `LS20`, `LS40`, `LS80`,`S8`, `S16`, `S32`, `S64`,`S80`, `S104`.
        * Under the condition that the category is the `HighAvailability`, Valid values: `LC20`, `LC40`, `LC80`,`C8`, `C16`, `C32`, `C64`, `C80`, `C104`.
    ...
    @db_cluster_class.setter
    def db_cluster_class(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_cluster_class", value)
    ...
    @property
    @pulumi.getter(name="dbClusterNetworkType")
    def db_cluster_network_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The DBCluster network type. Valid values: `vpc`.
        """
        return pulumi.get(self, "db_cluster_network_type")
    ...
    @db_cluster_network_type.setter
    def db_cluster_network_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_cluster_network_type", value)

    @property
    @pulumi.getter(name="dbClusterVersion")
    def db_cluster_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The DBCluster version. Valid values: `20.3.10.75`, `20.8.7.15`, `21.8.10.19`, `22.8.5.29`, `23.8`. **NOTE:** `19.15.2.2` is no longer supported. From version 1.191.0, `db_cluster_version` can be set to `22.8.5.29`.
        """
        return pulumi.get(self, "db_cluster_version")
    ...
    @db_cluster_version.setter
    def db_cluster_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_cluster_version", value)

    @property
    @pulumi.getter(name="dbNodeGroupCount")
    def db_node_group_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The db node group count. The number should between 1 and 48.
        """
        return pulumi.get(self, "db_node_group_count")
    ...
    @db_node_group_count.setter
    def db_node_group_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "db_node_group_count", value)

    @property
    @pulumi.getter(name="dbNodeStorage")
    def db_node_storage(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The db node storage.
        """
        return pulumi.get(self, "db_node_storage")
    ...
    @db_node_storage.setter
    def db_node_storage(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_node_storage", value)
    ...
    def public_connection_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_connection_string(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DbCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DbCluster':
        """
    ...
    @property
    @pulumi.getter(name="allocatePublicConnection")
    def allocate_public_connection(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable public connection. Value options: `true`, `false`.
        """
        return pulumi.get(self, "allocate_public_connection")
    ...
    @property
    @pulumi.getter(name="coldStorage")
    def cold_storage(self) -> pulumi.Output[builtins.str]:
        """
        Whether to use cold storage. Valid values: `ENABLE`, `DISABLE`, default to `DISABLE`. When it's set to `ENABLE`, cold storage will be used, and `cold_storage` cannot be set to `DISABLE` again.
        """
        return pulumi.get(self, "cold_storage")
    ...
    @property
    @pulumi.getter(name="dbClusterClass")
    def db_cluster_class(self) -> pulumi.Output[builtins.str]:
        """
        The DBCluster class. According to the category, db_cluster_class has two value ranges:
        * Under the condition that the category is the `Basic`, Valid values: `LS20`, `LS40`, `LS80`,`S8`, `S16`, `S32`, `S64`,`S80`, `S104`.
        * Under the condition that the category is the `HighAvailability`, Valid values: `LC20`, `LC40`, `LC80`,`C8`, `C16`, `C32`, `C64`, `C80`, `C104`.
    ...
    @property
    @pulumi.getter(name="dbClusterDescription")
    def db_cluster_description(self) -> pulumi.Output[builtins.str]:
        """
        The DBCluster description.
        """
        return pulumi.get(self, "db_cluster_description")
    ...
    @property
    @pulumi.getter(name="dbClusterNetworkType")
    def db_cluster_network_type(self) -> pulumi.Output[builtins.str]:
        """
        The DBCluster network type. Valid values: `vpc`.
        """
        return pulumi.get(self, "db_cluster_network_type")
    ...
    @property
    @pulumi.getter(name="dbClusterVersion")
    def db_cluster_version(self) -> pulumi.Output[builtins.str]:
        """
        The DBCluster version. Valid values: `20.3.10.75`, `20.8.7.15`, `21.8.10.19`, `22.8.5.29`, `23.8`. **NOTE:** `19.15.2.2` is no longer supported. From version 1.191.0, `db_cluster_version` can be set to `22.8.5.29`.
        """
        return pulumi.get(self, "db_cluster_version")
    ...
    @property
    @pulumi.getter(name="dbNodeGroupCount")
    def db_node_group_count(self) -> pulumi.Output[builtins.int]:
        """
        The db node group count. The number should between 1 and 48.
        """
        return pulumi.get(self, "db_node_group_count")
    ...
    @property
    @pulumi.getter(name="dbNodeStorage")
    def db_node_storage(self) -> pulumi.Output[builtins.str]:
        """
        The db node storage.
        """
        return pulumi.get(self, "db_node_storage")
    ...
    @property
    @pulumi.getter(name="publicConnectionString")
    def public_connection_string(self) -> pulumi.Output[builtins.str]:
        """
        (Available since v1.245.0) The public connection string of the cluster. Only valid when `allocate_public_connection` is `true`.
        """
        return pulumi.get(self, "public_connection_string")
