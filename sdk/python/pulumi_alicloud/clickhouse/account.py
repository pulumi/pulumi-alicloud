...
class AccountArgs:
    def __init__(__self__, *,
                 ...
                 account_description: Optional[pulumi.Input[builtins.str]] = None,
                 allow_databases: Optional[pulumi.Input[builtins.str]] = None,
                 allow_dictionaries: Optional[pulumi.Input[builtins.str]] = None,
                 ddl_authority: Optional[pulumi.Input[builtins.bool]] = None,
                 dml_authority: Optional[pulumi.Input[builtins.str]] = None,
                 total_databases: Optional[pulumi.Input[builtins.str]] = None,
                 total_dictionaries: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Account resource.
        :param pulumi.Input[builtins.str] account_name: Account name: lowercase letters, numbers, underscores, lowercase letter; length no more than 16 characters.
        :param pulumi.Input[builtins.str] account_password: The account password: uppercase letters, lowercase letters, lowercase letters, numbers, and special characters (special character! #$%^& author (s):_+-=) in a length of 8-32 bit.
        :param pulumi.Input[builtins.str] db_cluster_id: The db cluster id.
        :param pulumi.Input[builtins.str] account_description: In Chinese, English letter. May contain Chinese and English characters, lowercase letters, numbers, and underscores (_), the dash (-). Cannot start with http:// and https:// at the beginning. Length is from 2 to 256 characters.
        :param pulumi.Input[builtins.str] allow_databases: The list of databases to which you want to grant permissions. Separate databases with commas (,).
        :param pulumi.Input[builtins.str] allow_dictionaries: The list of dictionaries to which you want to grant permissions. Separate dictionaries with commas (,).
        :param pulumi.Input[builtins.bool] ddl_authority: Specifies whether to grant DDL permissions to the database account. Valid values: `true` and `false`.
        :param pulumi.Input[builtins.str] dml_authority: Specifies whether to grant DML permissions to the database account. Valid values: `all` and `readOnly,modify`.
        :param pulumi.Input[builtins.str] total_databases: The list of all databases. Separate databases with commas (,). Field 'total_databases' has been deprecated from provider version 1.223.1.
        :param pulumi.Input[builtins.str] total_dictionaries: The list of all dictionaries. Separate dictionaries with commas (,). Field 'total_dictionaries' has been deprecated from provider version 1.223.1.
        :param pulumi.Input[builtins.str] type: The type of the database account. Valid values: `Normal` or `Super`.
        """
    ...
    def account_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def account_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "account_description", value)

    @property
    @pulumi.getter(name="allowDatabases")
    def allow_databases(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def allow_databases(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "allow_databases", value)

    @property
    @pulumi.getter(name="allowDictionaries")
    def allow_dictionaries(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def allow_dictionaries(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "allow_dictionaries", value)

    @property
    @pulumi.getter(name="ddlAuthority")
    def ddl_authority(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ddl_authority(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ddl_authority", value)

    @property
    @pulumi.getter(name="dmlAuthority")
    def dml_authority(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dml_authority(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def total_databases(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def total_databases(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def total_dictionaries(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def total_dictionaries(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] ddl_authority: Specifies whether to grant DDL permissions to the database account. Valid values: `true` and `false`.
        :param pulumi.Input[builtins.str] dml_authority: Specifies whether to grant DML permissions to the database account. Valid values: `all` and `readOnly,modify`.
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid Status: `Creating`,`Available`,`Deleting`.
        :param pulumi.Input[builtins.str] total_databases: The list of all databases. Separate databases with commas (,). Field 'total_databases' has been deprecated from provider version 1.223.1.
        :param pulumi.Input[builtins.str] total_dictionaries: The list of all dictionaries. Separate dictionaries with commas (,). Field 'total_dictionaries' has been deprecated from provider version 1.223.1.
        :param pulumi.Input[builtins.str] type: The type of the database account. Valid values: `Normal` or `Super`.
        """
...
@pulumi.type_token("alicloud:clickhouse/account:Account")
class Account(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="accountDescription")
    def account_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        In Chinese, English letter. May contain Chinese and English characters, lowercase letters, numbers, and underscores (_), the dash (-). Cannot start with http:// and https:// at the beginning. Length is from 2 to 256 characters.
        """
        return pulumi.get(self, "account_description")
    ...
    @property
    @pulumi.getter(name="allowDatabases")
    def allow_databases(self) -> pulumi.Output[builtins.str]:
        """
        The list of databases to which you want to grant permissions. Separate databases with commas (,).
        """
        return pulumi.get(self, "allow_databases")
    ...
    @property
    @pulumi.getter(name="allowDictionaries")
    def allow_dictionaries(self) -> pulumi.Output[builtins.str]:
        """
        The list of dictionaries to which you want to grant permissions. Separate dictionaries with commas (,).
        """
        return pulumi.get(self, "allow_dictionaries")
    ...
    @property
    @pulumi.getter(name="ddlAuthority")
    def ddl_authority(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to grant DDL permissions to the database account. Valid values: `true` and `false`.
        """
        return pulumi.get(self, "ddl_authority")
    ...
    @property
    @pulumi.getter(name="dmlAuthority")
    def dml_authority(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether to grant DML permissions to the database account. Valid values: `all` and `readOnly,modify`.
        """
        return pulumi.get(self, "dml_authority")
    ...
    @pulumi.getter(name="totalDatabases")
    @_utilities.deprecated("""Field 'total_databases' has been deprecated from version 1.223.1 and it will be removed in the future version.""")
    def total_databases(self) -> pulumi.Output[builtins.str]:
        """
        The list of all databases. Separate databases with commas (,). Field 'total_databases' has been deprecated from provider version 1.223.1.
        """
        return pulumi.get(self, "total_databases")
    ...
    @pulumi.getter(name="totalDictionaries")
    @_utilities.deprecated("""Field 'total_dictionaries' has been deprecated from version 1.223.1 and it will be removed in the future version.""")
    def total_dictionaries(self) -> pulumi.Output[builtins.str]:
        """
        The list of all dictionaries. Separate dictionaries with commas (,). Field 'total_dictionaries' has been deprecated from provider version 1.223.1.
        """
        return pulumi.get(self, "total_dictionaries")
