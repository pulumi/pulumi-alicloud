...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] allow_databases: The list of databases to which you want to grant permissions. Separate databases with commas (,).
        :param pulumi.Input[_builtins.str] allow_dictionaries: The list of dictionaries to which you want to grant permissions. Separate dictionaries with commas (,).
        :param pulumi.Input[_builtins.bool] ddl_authority: Specifies whether to grant DDL permissions to the database account. Valid values: `true` and `false`.
        :param pulumi.Input[_builtins.str] dml_authority: Specifies whether to grant DML permissions to the database account. Valid values: `all` and `readOnly,modify`.
        :param pulumi.Input[_builtins.str] total_databases: The list of all databases. Separate databases with commas (,). Field 'total_databases' has been deprecated from provider version 1.223.1.
        :param pulumi.Input[_builtins.str] total_dictionaries: The list of all dictionaries. Separate dictionaries with commas (,). Field 'total_dictionaries' has been deprecated from provider version 1.223.1.
        :param pulumi.Input[_builtins.str] type: The type of the database account. Valid values: `Normal` or `Super`.
        """
...
class _AccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] ddl_authority: Specifies whether to grant DDL permissions to the database account. Valid values: `true` and `false`.
        :param pulumi.Input[_builtins.str] dml_authority: Specifies whether to grant DML permissions to the database account. Valid values: `all` and `readOnly,modify`.
        :param pulumi.Input[_builtins.str] status: The status of the resource. Valid Status: `Creating`,`Available`,`Deleting`.
        :param pulumi.Input[_builtins.str] total_databases: The list of all databases. Separate databases with commas (,). Field 'total_databases' has been deprecated from provider version 1.223.1.
        :param pulumi.Input[_builtins.str] total_dictionaries: The list of all dictionaries. Separate dictionaries with commas (,). Field 'total_dictionaries' has been deprecated from provider version 1.223.1.
        :param pulumi.Input[_builtins.str] type: The type of the database account. Valid values: `Normal` or `Super`.
        """
...
class Account(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="allowDatabases")
    def allow_databases(self) -> pulumi.Output[_builtins.str]:
        """
        The list of databases to which you want to grant permissions. Separate databases with commas (,).
        """
        return pulumi.get(self, "allow_databases")
    ...
    @_builtins.property
    @pulumi.getter(name="allowDictionaries")
    def allow_dictionaries(self) -> pulumi.Output[_builtins.str]:
        """
        The list of dictionaries to which you want to grant permissions. Separate dictionaries with commas (,).
        """
        return pulumi.get(self, "allow_dictionaries")
    ...
    @_builtins.property
    @pulumi.getter(name="ddlAuthority")
    def ddl_authority(self) -> pulumi.Output[_builtins.bool]:
        """
        Specifies whether to grant DDL permissions to the database account. Valid values: `true` and `false`.
        """
        return pulumi.get(self, "ddl_authority")
    ...
    @_builtins.property
    @pulumi.getter(name="dmlAuthority")
    def dml_authority(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies whether to grant DML permissions to the database account. Valid values: `all` and `readOnly,modify`.
        """
        return pulumi.get(self, "dml_authority")
    ...
    @pulumi.getter(name="totalDatabases")
    @_utilities.deprecated("""Field 'total_databases' has been deprecated from version 1.223.1 and it will be removed in the future version.""")
    def total_databases(self) -> pulumi.Output[_builtins.str]:
        """
        The list of all databases. Separate databases with commas (,). Field 'total_databases' has been deprecated from provider version 1.223.1.
        """
        return pulumi.get(self, "total_databases")
    ...
    @pulumi.getter(name="totalDictionaries")
    @_utilities.deprecated("""Field 'total_dictionaries' has been deprecated from version 1.223.1 and it will be removed in the future version.""")
    def total_dictionaries(self) -> pulumi.Output[_builtins.str]:
        """
        The list of all dictionaries. Separate dictionaries with commas (,). Field 'total_dictionaries' has been deprecated from provider version 1.223.1.
        """
        return pulumi.get(self, "total_dictionaries")
