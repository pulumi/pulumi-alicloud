...
def get_backup_policies(db_cluster_id: Optional[_builtins.str] = None,
...
def get_backup_policies_output(db_cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:clickhouse/getBackupPolicies:getBackupPolicies', __args__, opts=opts, typ=GetBackupPoliciesResult)
