...
class Apply(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        default = alicloud.sslcertificatesservice.Instance("default",
            product_type="cas",
            period=12,
            pricing_cycle=2,
            instance_name=name,
