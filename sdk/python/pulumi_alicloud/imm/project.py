...
class ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project: The name of Project.
        :param pulumi.Input[builtins.str] service_role: The service role authorized to the Intelligent Media Management service to access other cloud resources. Default value: `AliyunIMMDefaultRole`. You can also create authorization  roles through the `ram.Role`.
        """
...
class Project(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            service_role: Optional[pulumi.Input[builtins.str]] = None) -> 'Project':
        """
