...
if not MYPY:
    class PolicyNetRedirectPolicyArgsDict(TypedDict):
        custom_proxy: NotRequired[pulumi.Input[builtins.str]]
        """
        Whether to manually configure the transparent proxy.
        """
        host_addr: NotRequired[pulumi.Input[builtins.str]]
        """
        The transparent proxy IP address. The format is IPv4 address.
        """
        net_redirect: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        proxy_password: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Agent protocol type.
        """
        proxy_user_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PolicyNetRedirectPolicyArgs:
    def __init__(__self__, *,
                 custom_proxy: Optional[pulumi.Input[builtins.str]] = None,
                 host_addr: Optional[pulumi.Input[builtins.str]] = None,
                 net_redirect: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 proxy_user_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] custom_proxy: Whether to manually configure the transparent proxy.
        :param pulumi.Input[builtins.str] host_addr: The transparent proxy IP address. The format is IPv4 address.
        :param pulumi.Input[builtins.str] net_redirect: Whether to enable network redirection.
        :param pulumi.Input[builtins.str] port: Transparent proxy port. The Port value range is 1\\~ 65535.
        :param pulumi.Input[builtins.str] proxy_password: The proxy password. The length range is 1\\~ 256. Chinese characters and white space characters are not allowed.
        :param pulumi.Input[builtins.str] proxy_type: Agent protocol type.
        :param pulumi.Input[builtins.str] proxy_user_name: The proxy user name. The length range is 1\\~ 256. Chinese characters and white space characters are not allowed.
        """
    ...
    def custom_proxy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether to manually configure the transparent proxy.
        """
    ...
    @custom_proxy.setter
    def custom_proxy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_proxy", value)

    @property
    @pulumi.getter(name="hostAddr")
    def host_addr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The transparent proxy IP address. The format is IPv4 address.
        """
    ...
    @host_addr.setter
    def host_addr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "host_addr", value)

    @property
    @pulumi.getter(name="netRedirect")
    def net_redirect(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether to enable network redirection.
        """
    ...
    @net_redirect.setter
    def net_redirect(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def proxy_user_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The proxy user name. The length range is 1\\~ 256. Chinese characters and white space characters are not allowed.
        """
    ...
    def proxy_user_name(self, value: Optional[pulumi.Input[builtins.str]]):
