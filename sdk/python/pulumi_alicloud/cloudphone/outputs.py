...
class PolicyNetRedirectPolicy(dict):
    ...
    def __init__(__self__, *,
                 custom_proxy: Optional[builtins.str] = None,
                 host_addr: Optional[builtins.str] = None,
                 net_redirect: Optional[builtins.str] = None,
                 port: Optional[builtins.str] = None,
                 proxy_password: Optional[builtins.str] = None,
                 proxy_type: Optional[builtins.str] = None,
                 proxy_user_name: Optional[builtins.str] = None):
        """
        :param builtins.str custom_proxy: Whether to manually configure the transparent proxy.
        :param builtins.str host_addr: The transparent proxy IP address. The format is IPv4 address.
        :param builtins.str net_redirect: Whether to enable network redirection.
        :param builtins.str port: Transparent proxy port. The Port value range is 1\\~ 65535.
        :param builtins.str proxy_password: The proxy password. The length range is 1\\~ 256. Chinese characters and white space characters are not allowed.
        :param builtins.str proxy_type: Agent protocol type.
        :param builtins.str proxy_user_name: The proxy user name. The length range is 1\\~ 256. Chinese characters and white space characters are not allowed.
        """
    ...
    def custom_proxy(self) -> Optional[builtins.str]:
        """
    ...
    def host_addr(self) -> Optional[builtins.str]:
        """
    ...
    def net_redirect(self) -> Optional[builtins.str]:
        """
    ...
    def proxy_password(self) -> Optional[builtins.str]:
        """
    ...
    def proxy_user_name(self) -> Optional[builtins.str]:
        """
