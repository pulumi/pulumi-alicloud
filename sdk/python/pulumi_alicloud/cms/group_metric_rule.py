...
class GroupMetricRuleArgs:
    def __init__(__self__, *,
                 ...
                 group_metric_rule_name: pulumi.Input[builtins.str],
                 ...
                 contact_groups: Optional[pulumi.Input[builtins.str]] = None,
                 dimensions: Optional[pulumi.Input[builtins.str]] = None,
                 effective_interval: Optional[pulumi.Input[builtins.str]] = None,
                 email_subject: Optional[pulumi.Input[builtins.str]] = None,
                 interval: Optional[pulumi.Input[builtins.str]] = None,
                 no_effective_interval: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] group_id: The ID of the application group.
        :param pulumi.Input[builtins.str] group_metric_rule_name: The name of the alert rule.
        :param pulumi.Input[builtins.str] metric_name: The name of the metric.
        :param pulumi.Input[builtins.str] namespace: The namespace of the service.
        :param pulumi.Input[builtins.str] rule_id: The ID of the alert rule.
        :param pulumi.Input[builtins.str] category: The abbreviation of the service name.
        :param pulumi.Input[builtins.str] contact_groups: Alarm contact group.
        :param pulumi.Input[builtins.str] dimensions: The dimensions that specify the resources to be associated with the alert rule.
        :param pulumi.Input[builtins.str] effective_interval: The time period during which the alert rule is effective.
        :param pulumi.Input[builtins.str] email_subject: The subject of the alert notification email.
        :param pulumi.Input[builtins.str] interval: The interval at which Cloud Monitor checks whether the alert rule is triggered. Unit: seconds.
        :param pulumi.Input[builtins.str] no_effective_interval: The time period during which the alert rule is ineffective.
        :param pulumi.Input[builtins.int] period: The aggregation period of the monitoring data. Unit: seconds. The value is an integral multiple of 60. Default value: `300`.
        :param pulumi.Input[builtins.int] silence_time: The mute period during which new alerts are not reported even if the alert trigger conditions are met. Unit: seconds. Default value: `86400`, which is equivalent to one day.
        ...
        :param pulumi.Input[builtins.str] webhook: The callback URL.
        """
    ...
    def group_metric_rule_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def group_metric_rule_name(self, value: pulumi.Input[builtins.str]):
    ...
    def contact_groups(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Alarm contact group.
        """
    ...
    def contact_groups(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "contact_groups", value)

    @property
    @pulumi.getter
    def dimensions(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @dimensions.setter
    def dimensions(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dimensions", value)

    @property
    @pulumi.getter(name="effectiveInterval")
    def effective_interval(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def effective_interval(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def no_effective_interval(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def no_effective_interval(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _GroupMetricRuleState:
    def __init__(__self__, *,
                 ...
                 group_metric_rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 interval: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] rule_id: The ID of the alert rule.
        :param pulumi.Input[builtins.int] silence_time: The mute period during which new alerts are not reported even if the alert trigger conditions are met. Unit: seconds. Default value: `86400`, which is equivalent to one day.
        :param pulumi.Input[builtins.str] status: The status of Group Metric Rule.
        :param pulumi.Input[Sequence[pulumi.Input['GroupMetricRuleTargetArgs']]] targets: The information about the resource for which alerts are triggered. See `targets` below.
        :param pulumi.Input[builtins.str] webhook: The callback URL.
        """
        if category is not None:
    ...
    @property
    @pulumi.getter(name="groupMetricRuleName")
    def group_metric_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the alert rule.
        """
        return pulumi.get(self, "group_metric_rule_name")
    ...
    @group_metric_rule_name.setter
    def group_metric_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "group_metric_rule_name", value)
...
class GroupMetricRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            targets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['GroupMetricRuleTargetArgs', 'GroupMetricRuleTargetArgsDict']]]]] = None,
            webhook: Optional[pulumi.Input[builtins.str]] = None) -> 'GroupMetricRule':
        """
    ...
    @property
    @pulumi.getter(name="contactGroups")
    def contact_groups(self) -> pulumi.Output[builtins.str]:
        """
        Alarm contact group.
        """
        return pulumi.get(self, "contact_groups")
    ...
    @property
    @pulumi.getter
    def dimensions(self) -> pulumi.Output[builtins.str]:
        """
        The dimensions that specify the resources to be associated with the alert rule.
        """
        return pulumi.get(self, "dimensions")
    ...
    @property
    @pulumi.getter(name="effectiveInterval")
    def effective_interval(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time period during which the alert rule is effective.
        """
        return pulumi.get(self, "effective_interval")
    ...
    @property
    @pulumi.getter(name="emailSubject")
    def email_subject(self) -> pulumi.Output[builtins.str]:
        """
        The subject of the alert notification email.
        """
        return pulumi.get(self, "email_subject")
    ...
    @property
    @pulumi.getter(name="groupMetricRuleName")
    def group_metric_rule_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the alert rule.
        """
        return pulumi.get(self, "group_metric_rule_name")
    ...
    @property
    @pulumi.getter(name="noEffectiveInterval")
    def no_effective_interval(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time period during which the alert rule is ineffective.
        """
        return pulumi.get(self, "no_effective_interval")
    ...
    @property
    @pulumi.getter
    def webhook(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The callback URL.
        """
        return pulumi.get(self, "webhook")
