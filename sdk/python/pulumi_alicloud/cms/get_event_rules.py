...
def get_event_rules(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Event Rule IDs. Its element value is same as Event Rule Name.
    :param builtins.str name_prefix: The name prefix.
    :param builtins.str name_regex: A regex string to filter results by Event Rule name.
...
def get_event_rules_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:cms/getEventRules:getEventRules', __args__, opts=opts, typ=GetEventRulesResult)
