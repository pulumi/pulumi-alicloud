...
def get_event_rules(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Event Rule IDs. Its element value is same as Event Rule Name.
    :param _builtins.str name_prefix: The name prefix.
    :param _builtins.str name_regex: A regex string to filter results by Event Rule name.
