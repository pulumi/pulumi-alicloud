...
class AlarmArgs:
    def __init__(__self__, *,
                 contact_groups: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 ...
                 metric_dimensions: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contact_groups: List contact groups of the alarm rule, which must have been created on the console.
        :param pulumi.Input[builtins.str] metric: The name of the metric, such as `CPUUtilization` and `networkin_rate`. For more information, see [Metrics Reference](https://www.alibabacloud.com/help/doc-detail/28619.htm).
        :param pulumi.Input[builtins.str] project: The namespace of the cloud service, such as `acs_ecs_dashboard` and `acs_rds_dashboard`. For more information, see [Metrics Reference](https://www.alibabacloud.com/help/doc-detail/28619.htm).
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] dimensions: Field `dimensions` has been deprecated from provider version 1.173.0. New field `metric_dimensions` instead.
        :param pulumi.Input[builtins.str] effective_interval: The interval of effecting alarm rule. It format as "hh:mm-hh:mm", like "0:00-4:00". Default value: `00:00-23:59`.
        :param pulumi.Input[builtins.bool] enabled: Whether to enable alarm rule. Default value: `true`.
        :param pulumi.Input[builtins.int] end_time: Field `end_time` has been deprecated from provider version 1.50.0. New field `effective_interval` instead.
        ...
        :param pulumi.Input[builtins.str] metric_dimensions: Map of the resources associated with the alarm rule, such as "instanceId", "device" and "port". Each key's value is a string, and it uses comma to split multiple items. For more information, see [Metrics Reference](https://www.alibabacloud.com/help/doc-detail/28619.htm).
        :param pulumi.Input[builtins.str] name: The name of the alert rule.
        :param pulumi.Input[builtins.int] period: The statistical period of the metric. Unit: seconds. Default value: `300`.
        ...
        :param pulumi.Input[builtins.int] silence_time: Notification silence period in the alarm state, in seconds. Default value: `86400`. Valid value range: [300, 86400].
        :param pulumi.Input[builtins.int] start_time: Field `start_time` has been deprecated from provider version 1.50.0. New field `effective_interval` instead.
        ...
        :param pulumi.Input[builtins.str] webhook: The webhook that should be called when the alarm is triggered. Currently, only http protocol is supported. Default is empty string.
        """
    ...
    def contact_groups(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def contact_groups(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def metric_dimensions(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def metric_dimensions(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AlarmState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] silence_time: Notification silence period in the alarm state, in seconds. Default value: `86400`. Valid value range: [300, 86400].
        :param pulumi.Input[builtins.int] start_time: Field `start_time` has been deprecated from provider version 1.50.0. New field `effective_interval` instead.
        :param pulumi.Input[builtins.str] status: The status of the Alarm.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[Sequence[pulumi.Input['AlarmTargetArgs']]] targets: Adds or modifies the push channels of an alert rule. See `targets` below.
        :param pulumi.Input[builtins.str] webhook: The webhook that should be called when the alarm is triggered. Currently, only http protocol is supported. Default is empty string.
        """
...
class Alarm(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            targets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AlarmTargetArgs', 'AlarmTargetArgsDict']]]]] = None,
            webhook: Optional[pulumi.Input[builtins.str]] = None) -> 'Alarm':
        """
    ...
    @property
    @pulumi.getter(name="contactGroups")
    def contact_groups(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List contact groups of the alarm rule, which must have been created on the console.
        """
        return pulumi.get(self, "contact_groups")
    ...
    @property
    @pulumi.getter(name="metricDimensions")
    def metric_dimensions(self) -> pulumi.Output[builtins.str]:
        """
        Map of the resources associated with the alarm rule, such as "instanceId", "device" and "port". Each key's value is a string, and it uses comma to split multiple items. For more information, see [Metrics Reference](https://www.alibabacloud.com/help/doc-detail/28619.htm).
        """
        return pulumi.get(self, "metric_dimensions")
