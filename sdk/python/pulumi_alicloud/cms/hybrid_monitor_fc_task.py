...
class HybridMonitorFcTaskArgs:
    def __init__(__self__, *,
                 ...
                 yarm_config: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] namespace: The index warehouse where the host belongs.
        :param pulumi.Input[builtins.str] yarm_config: The configuration file of the Alibaba Cloud service that you want to monitor by using Hybrid Cloud Monitoring.
        :param pulumi.Input[builtins.str] target_user_id: The ID of the member account. If you call API operations by using a management account, you can connect the Alibaba Cloud services that are activated for a member account in Resource Directory to Hybrid Cloud Monitoring. You can use Resource Directory to monitor Alibaba Cloud services across enterprise accounts.
        """
    ...
    def yarm_config(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @yarm_config.setter
    def yarm_config(self, value: pulumi.Input[builtins.str]):
...
class _HybridMonitorFcTaskState:
    def __init__(__self__, *,
                 hybrid_monitor_fc_task_id: Optional[pulumi.Input[builtins.str]] = None,
                 namespace: Optional[pulumi.Input[builtins.str]] = None,
                 target_user_id: Optional[pulumi.Input[builtins.str]] = None,
                 yarm_config: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering HybridMonitorFcTask resources.
        :param pulumi.Input[builtins.str] hybrid_monitor_fc_task_id: The ID of the monitoring task.
        :param pulumi.Input[builtins.str] namespace: The index warehouse where the host belongs.
        :param pulumi.Input[builtins.str] target_user_id: The ID of the member account. If you call API operations by using a management account, you can connect the Alibaba Cloud services that are activated for a member account in Resource Directory to Hybrid Cloud Monitoring. You can use Resource Directory to monitor Alibaba Cloud services across enterprise accounts.
        :param pulumi.Input[builtins.str] yarm_config: The configuration file of the Alibaba Cloud service that you want to monitor by using Hybrid Cloud Monitoring.
        """
    ...
    def hybrid_monitor_fc_task_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hybrid_monitor_fc_task_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="yarmConfig")
    def yarm_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The configuration file of the Alibaba Cloud service that you want to monitor by using Hybrid Cloud Monitoring.
        """
        return pulumi.get(self, "yarm_config")
    ...
    @yarm_config.setter
    def yarm_config(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "yarm_config", value)
...
class HybridMonitorFcTask(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace: Optional[pulumi.Input[builtins.str]] = None,
            target_user_id: Optional[pulumi.Input[builtins.str]] = None,
            yarm_config: Optional[pulumi.Input[builtins.str]] = None) -> 'HybridMonitorFcTask':
        """
    ...
    @property
    @pulumi.getter(name="hybridMonitorFcTaskId")
    def hybrid_monitor_fc_task_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the monitoring task.
        """
        return pulumi.get(self, "hybrid_monitor_fc_task_id")
    ...
    @property
    @pulumi.getter(name="targetUserId")
    def target_user_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the member account. If you call API operations by using a management account, you can connect the Alibaba Cloud services that are activated for a member account in Resource Directory to Hybrid Cloud Monitoring. You can use Resource Directory to monitor Alibaba Cloud services across enterprise accounts.
        """
        return pulumi.get(self, "target_user_id")
    ...
    @property
    @pulumi.getter(name="yarmConfig")
    def yarm_config(self) -> pulumi.Output[builtins.str]:
        """
        The configuration file of the Alibaba Cloud service that you want to monitor by using Hybrid Cloud Monitoring.
        """
        return pulumi.get(self, "yarm_config")
