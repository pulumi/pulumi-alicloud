...
class GetMetricRuleTemplatesResult:
    ...
    def metric_rule_template_name(self) -> Optional[builtins.str]:
...
def get_metric_rule_templates(enable_details: Optional[builtins.bool] = None,
                              ids: Optional[Sequence[builtins.str]] = None,
                              keyword: Optional[builtins.str] = None,
                              metric_rule_template_name: Optional[builtins.str] = None,
    ...
    :param builtins.bool enable_details: Valid values: `true` or `false`. Default to `false`. Set it to `true` can output more details about resource attributes.
    :param Sequence[builtins.str] ids: A list of Metric Rule Template IDs.
    :param builtins.str keyword: The name of the alert template. You can perform fuzzy search based on the template name.
    :param builtins.str metric_rule_template_name: The name of the alert template.
    :param builtins.str name_regex: A regex string to filter results by Metric Rule Template name.
...
def get_metric_rule_templates_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                     keyword: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     metric_rule_template_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
