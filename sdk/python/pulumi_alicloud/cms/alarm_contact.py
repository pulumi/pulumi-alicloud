...
class AlarmContactArgs:
    def __init__(__self__, *,
                 alarm_contact_name: pulumi.Input[builtins.str],
                 describe: pulumi.Input[builtins.str],
                 channels_aliim: Optional[pulumi.Input[builtins.str]] = None,
                 channels_ding_web_hook: Optional[pulumi.Input[builtins.str]] = None,
                 channels_mail: Optional[pulumi.Input[builtins.str]] = None,
                 channels_sms: Optional[pulumi.Input[builtins.str]] = None,
                 lang: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a AlarmContact resource.
        :param pulumi.Input[builtins.str] alarm_contact_name: The name of the alarm contact. The length should between 2 and 40 characters.
        :param pulumi.Input[builtins.str] describe: The description of the alarm contact.
        :param pulumi.Input[builtins.str] channels_aliim: The TradeManager ID of the alarm contact.
        :param pulumi.Input[builtins.str] channels_ding_web_hook: The webhook URL of the DingTalk chatbot.
        :param pulumi.Input[builtins.str] channels_mail: The email address of the alarm contact. After you add or modify an email address, the recipient receives an email that contains an activation link. The system adds the recipient to the list of alarm contacts only after the recipient activates the email address.
        :param pulumi.Input[builtins.str] channels_sms: The phone number of the alarm contact. After you add or modify an email address, the recipient receives an email that contains an activation link. The system adds the recipient to the list of alarm contacts only after the recipient activates the email address.
        :param pulumi.Input[builtins.str] lang: The language type of the alarm. Valid values: `en`, `zh-cn`.
    ...
    def alarm_contact_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def alarm_contact_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "alarm_contact_name", value)

    @property
    @pulumi.getter
    def describe(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @describe.setter
    def describe(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "describe", value)

    @property
    @pulumi.getter(name="channelsAliim")
    def channels_aliim(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def channels_aliim(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "channels_aliim", value)

    @property
    @pulumi.getter(name="channelsDingWebHook")
    def channels_ding_web_hook(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def channels_ding_web_hook(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "channels_ding_web_hook", value)

    @property
    @pulumi.getter(name="channelsMail")
    def channels_mail(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def channels_mail(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "channels_mail", value)

    @property
    @pulumi.getter(name="channelsSms")
    def channels_sms(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @channels_sms.setter
    def channels_sms(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AlarmContactState:
    def __init__(__self__, *,
                 alarm_contact_name: Optional[pulumi.Input[builtins.str]] = None,
                 channels_aliim: Optional[pulumi.Input[builtins.str]] = None,
                 channels_ding_web_hook: Optional[pulumi.Input[builtins.str]] = None,
                 channels_mail: Optional[pulumi.Input[builtins.str]] = None,
                 channels_sms: Optional[pulumi.Input[builtins.str]] = None,
                 describe: Optional[pulumi.Input[builtins.str]] = None,
                 lang: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="alarmContactName")
    def alarm_contact_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the alarm contact. The length should between 2 and 40 characters.
        """
        return pulumi.get(self, "alarm_contact_name")
    ...
    @alarm_contact_name.setter
    def alarm_contact_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alarm_contact_name", value)
    ...
    @property
    @pulumi.getter
    def describe(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The description of the alarm contact.
        """
        return pulumi.get(self, "describe")
    ...
    @describe.setter
    def describe(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "describe", value)
...
class AlarmContact(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            channels_sms: Optional[pulumi.Input[builtins.str]] = None,
            describe: Optional[pulumi.Input[builtins.str]] = None,
            lang: Optional[pulumi.Input[builtins.str]] = None) -> 'AlarmContact':
        """
    ...
    @property
    @pulumi.getter(name="alarmContactName")
    def alarm_contact_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the alarm contact. The length should between 2 and 40 characters.
        """
        return pulumi.get(self, "alarm_contact_name")
    ...
    @property
    @pulumi.getter(name="channelsAliim")
    def channels_aliim(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The TradeManager ID of the alarm contact.
        """
        return pulumi.get(self, "channels_aliim")
    ...
    @property
    @pulumi.getter(name="channelsDingWebHook")
    def channels_ding_web_hook(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The webhook URL of the DingTalk chatbot.
        """
        return pulumi.get(self, "channels_ding_web_hook")
    ...
    @property
    @pulumi.getter(name="channelsMail")
    def channels_mail(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The email address of the alarm contact. After you add or modify an email address, the recipient receives an email that contains an activation link. The system adds the recipient to the list of alarm contacts only after the recipient activates the email address.
        """
        return pulumi.get(self, "channels_mail")
    ...
    @property
    @pulumi.getter(name="channelsSms")
    def channels_sms(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The phone number of the alarm contact. After you add or modify an email address, the recipient receives an email that contains an activation link. The system adds the recipient to the list of alarm contacts only after the recipient activates the email address.
        """
        return pulumi.get(self, "channels_sms")
    ...
    @property
    @pulumi.getter
    def describe(self) -> pulumi.Output[builtins.str]:
        """
        The description of the alarm contact.
        """
        return pulumi.get(self, "describe")
