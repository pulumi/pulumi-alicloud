...
class HybridMonitorSlsTaskArgs:
    def __init__(__self__, *,
                 collect_target_type: pulumi.Input[builtins.str],
                 ...
                 collect_interval: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a HybridMonitorSlsTask resource.
        :param pulumi.Input[builtins.str] collect_target_type: The type of the collection target, enter the name of the Logstore group.
        ...
        :param pulumi.Input[builtins.str] task_name: The name of the metric import task, enter the name of the metric for logs imported from Log Service.
        ...
        :param pulumi.Input[builtins.int] collect_interval: The interval at which metrics are collected. Valid values: `15`, `60`(default value). Unit: seconds.
        :param pulumi.Input[builtins.str] description: The description of the metric import task.
        """
    ...
    def collect_target_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def collect_target_type(self, value: pulumi.Input[builtins.str]):
    ...
    def collect_interval(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def collect_interval(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _HybridMonitorSlsTaskState:
    def __init__(__self__, *,
                 attach_labels: Optional[pulumi.Input[Sequence[pulumi.Input['HybridMonitorSlsTaskAttachLabelArgs']]]] = None,
                 collect_interval: Optional[pulumi.Input[builtins.int]] = None,
                 collect_target_type: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="collectTargetType")
    def collect_target_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the collection target, enter the name of the Logstore group.
        """
        return pulumi.get(self, "collect_target_type")
    ...
    @collect_target_type.setter
    def collect_target_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "collect_target_type", value)
...
class HybridMonitorSlsTask(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace: Optional[pulumi.Input[builtins.str]] = None,
            sls_process_config: Optional[pulumi.Input[Union['HybridMonitorSlsTaskSlsProcessConfigArgs', 'HybridMonitorSlsTaskSlsProcessConfigArgsDict']]] = None,
            task_name: Optional[pulumi.Input[builtins.str]] = None) -> 'HybridMonitorSlsTask':
        """
    ...
    @property
    @pulumi.getter(name="collectInterval")
    def collect_interval(self) -> pulumi.Output[builtins.int]:
        """
        The interval at which metrics are collected. Valid values: `15`, `60`(default value). Unit: seconds.
        """
        return pulumi.get(self, "collect_interval")
    ...
    @property
    @pulumi.getter(name="collectTargetType")
    def collect_target_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the collection target, enter the name of the Logstore group.
        """
        return pulumi.get(self, "collect_target_type")
