...
class HybridMonitorSlsTaskArgs:
    def __init__(__self__, *,
                 collect_target_type: pulumi.Input[_builtins.str],
                 namespace: pulumi.Input[_builtins.str],
                 sls_process_config: pulumi.Input['HybridMonitorSlsTaskSlsProcessConfigArgs'],
                 task_name: pulumi.Input[_builtins.str],
                 attach_labels: pulumi.Input[Optional[Sequence[pulumi.Input['HybridMonitorSlsTaskAttachLabelArgs']]]] = None,
                 collect_interval: pulumi.Input[Optional[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.str] task_name: The name of the metric import task, enter the name of the metric for logs imported from Log Service.
        ...
        :param pulumi.Input[_builtins.str] description: The description of the metric import task.
        """
    ...
    def collect_target_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def collect_target_type(self, value: pulumi.Input[_builtins.str]):
    ...
    def attach_labels(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['HybridMonitorSlsTaskAttachLabelArgs']]]]:
        """
    ...
    def attach_labels(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['HybridMonitorSlsTaskAttachLabelArgs']]]]):
        pulumi.set(self, "attach_labels", value)

    @_builtins.property
    @pulumi.getter(name="collectInterval")
    def collect_interval(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def collect_interval(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class _HybridMonitorSlsTaskState:
    def __init__(__self__, *,
                 attach_labels: pulumi.Input[Optional[Sequence[pulumi.Input['HybridMonitorSlsTaskAttachLabelArgs']]]] = None,
                 collect_interval: pulumi.Input[Optional[_builtins.int]] = None,
                 collect_target_type: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 namespace: pulumi.Input[Optional[_builtins.str]] = None,
                 sls_process_config: pulumi.Input[Optional['HybridMonitorSlsTaskSlsProcessConfigArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="collectTargetType")
    def collect_target_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The type of the collection target, enter the name of the Logstore group.
        """
        return pulumi.get(self, "collect_target_type")
    ...
    @collect_target_type.setter
    def collect_target_type(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "collect_target_type", value)
    ...
    @_builtins.property
    @pulumi.getter(name="slsProcessConfig")
    def sls_process_config(self) -> pulumi.Input[Optional['HybridMonitorSlsTaskSlsProcessConfigArgs']]:
        """
        The configurations of the logs that are imported from Log Service. See `sls_process_config` below.
        """
        return pulumi.get(self, "sls_process_config")
    ...
    @sls_process_config.setter
    def sls_process_config(self, value: pulumi.Input[Optional['HybridMonitorSlsTaskSlsProcessConfigArgs']]):
        pulumi.set(self, "sls_process_config", value)
...
class HybridMonitorSlsTask(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 attach_labels: pulumi.Input[Optional[Sequence[pulumi.Input[Union['HybridMonitorSlsTaskAttachLabelArgs', 'HybridMonitorSlsTaskAttachLabelArgsDict', 'outputs.HybridMonitorSlsTaskAttachLabel']]]]] = None,
                 collect_interval: pulumi.Input[Optional[_builtins.int]] = None,
                 collect_target_type: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 namespace: pulumi.Input[Optional[_builtins.str]] = None,
                 sls_process_config: pulumi.Input[Optional[Union['HybridMonitorSlsTaskSlsProcessConfigArgs', 'HybridMonitorSlsTaskSlsProcessConfigArgsDict', 'outputs.HybridMonitorSlsTaskSlsProcessConfig']]] = None,
                 task_name: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['HybridMonitorSlsTaskAttachLabelArgs', 'HybridMonitorSlsTaskAttachLabelArgsDict', 'outputs.HybridMonitorSlsTaskAttachLabel']]]] attach_labels: The label of the monitoring task. See `attach_labels` below.
        :param pulumi.Input[_builtins.int] collect_interval: The interval at which metrics are collected. Valid values: `15`, `60`(default value). Unit: seconds.
        :param pulumi.Input[_builtins.str] collect_target_type: The type of the collection target, enter the name of the Logstore group.
        :param pulumi.Input[_builtins.str] description: The description of the metric import task.
        :param pulumi.Input[_builtins.str] namespace: The name of the namespace.
        :param pulumi.Input[Union['HybridMonitorSlsTaskSlsProcessConfigArgs', 'HybridMonitorSlsTaskSlsProcessConfigArgsDict', 'outputs.HybridMonitorSlsTaskSlsProcessConfig']] sls_process_config: The configurations of the logs that are imported from Log Service. See `sls_process_config` below.
        :param pulumi.Input[_builtins.str] task_name: The name of the metric import task, enter the name of the metric for logs imported from Log Service.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            namespace: pulumi.Input[Optional[_builtins.str]] = None,
            sls_process_config: pulumi.Input[Optional[Union['HybridMonitorSlsTaskSlsProcessConfigArgs', 'HybridMonitorSlsTaskSlsProcessConfigArgsDict', 'outputs.HybridMonitorSlsTaskSlsProcessConfig']]] = None,
            task_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'HybridMonitorSlsTask':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="collectInterval")
    def collect_interval(self) -> pulumi.Output[_builtins.int]:
        """
        The interval at which metrics are collected. Valid values: `15`, `60`(default value). Unit: seconds.
        """
        return pulumi.get(self, "collect_interval")
    ...
    @_builtins.property
    @pulumi.getter(name="collectTargetType")
    def collect_target_type(self) -> pulumi.Output[_builtins.str]:
        """
        The type of the collection target, enter the name of the Logstore group.
        """
        return pulumi.get(self, "collect_target_type")
