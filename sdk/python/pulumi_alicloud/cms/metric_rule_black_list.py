...
class MetricRuleBlackListArgs:
    def __init__(__self__, *,
                 ...
                 instances: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 metric_rule_black_list_name: pulumi.Input[builtins.str],
                 ...
                 scope_type: Optional[pulumi.Input[builtins.str]] = None,
                 scope_values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a MetricRuleBlackList resource.
        :param pulumi.Input[builtins.str] category: Cloud service classification. For example, Redis includes kvstore_standard, kvstore_sharding, and kvstore_splitrw.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instances: The list of instances of cloud services specified in the alert blacklist policy.
        :param pulumi.Input[builtins.str] metric_rule_black_list_name: The name of the alert blacklist policy.
        :param pulumi.Input[builtins.str] namespace: The data namespace of the cloud service.
        :param pulumi.Input[builtins.str] effective_time: The effective time range of the alert blacklist policy.
        :param pulumi.Input[builtins.str] enable_end_time: The start timestamp of the alert blacklist policy.Unit: milliseconds.
        :param pulumi.Input[builtins.str] enable_start_time: The end timestamp of the alert blacklist policy.Unit: milliseconds.
        :param pulumi.Input[builtins.bool] is_enable: The status of the alert blacklist policy. Value:-true: enabled.-false: disabled.
        ...
        :param pulumi.Input[builtins.str] scope_type: The effective range of the alert blacklist policy. Value:-USER: The alert blacklist policy only takes effect in the current Alibaba cloud account.-GROUP: The alert blacklist policy takes effect in the specified application GROUP.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scope_values: Application Group ID list. The format is JSON Array.> This parameter is displayed only when 'ScopeType' is 'GROUP.
        """
    ...
    @property
    @pulumi.getter
    def instances(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @instances.setter
    def instances(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "instances", value)

    @property
    @pulumi.getter(name="metricRuleBlackListName")
    def metric_rule_black_list_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def metric_rule_black_list_name(self, value: pulumi.Input[builtins.str]):
    ...
    def scope_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @scope_type.setter
    def scope_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scope_type", value)

    @property
    @pulumi.getter(name="scopeValues")
    def scope_values(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @scope_values.setter
    def scope_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _MetricRuleBlackListState:
    def __init__(__self__, *,
                 ...
                 is_enable: Optional[pulumi.Input[builtins.bool]] = None,
                 metric_rule_black_list_id: Optional[pulumi.Input[builtins.str]] = None,
                 metric_rule_black_list_name: Optional[pulumi.Input[builtins.str]] = None,
                 metrics: Optional[pulumi.Input[Sequence[pulumi.Input['MetricRuleBlackListMetricArgs']]]] = None,
        ...
        :param pulumi.Input[builtins.str] category: Cloud service classification. For example, Redis includes kvstore_standard, kvstore_sharding, and kvstore_splitrw.
        :param pulumi.Input[builtins.str] create_time: The timestamp for creating an alert blacklist policy.Unit: milliseconds.
        :param pulumi.Input[builtins.str] effective_time: The effective time range of the alert blacklist policy.
        :param pulumi.Input[builtins.str] enable_end_time: The start timestamp of the alert blacklist policy.Unit: milliseconds.
        :param pulumi.Input[builtins.str] enable_start_time: The end timestamp of the alert blacklist policy.Unit: milliseconds.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instances: The list of instances of cloud services specified in the alert blacklist policy.
        :param pulumi.Input[builtins.bool] is_enable: The status of the alert blacklist policy. Value:-true: enabled.-false: disabled.
        :param pulumi.Input[builtins.str] metric_rule_black_list_id: The ID of the blacklist policy.
        :param pulumi.Input[builtins.str] metric_rule_black_list_name: The name of the alert blacklist policy.
        :param pulumi.Input[Sequence[pulumi.Input['MetricRuleBlackListMetricArgs']]] metrics: Monitoring metrics in the instance. See `metrics` below.
        :param pulumi.Input[builtins.str] namespace: The data namespace of the cloud service.
        :param pulumi.Input[builtins.str] scope_type: The effective range of the alert blacklist policy. Value:-USER: The alert blacklist policy only takes effect in the current Alibaba cloud account.-GROUP: The alert blacklist policy takes effect in the specified application GROUP.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scope_values: Application Group ID list. The format is JSON Array.> This parameter is displayed only when 'ScopeType' is 'GROUP.
        :param pulumi.Input[builtins.str] update_time: Modify the timestamp of the alert blacklist policy.Unit: milliseconds.
        """
    ...
    def metric_rule_black_list_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def metric_rule_black_list_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "metric_rule_black_list_id", value)

    @property
    @pulumi.getter(name="metricRuleBlackListName")
    def metric_rule_black_list_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the alert blacklist policy.
        """
        return pulumi.get(self, "metric_rule_black_list_name")
    ...
    @metric_rule_black_list_name.setter
    def metric_rule_black_list_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "metric_rule_black_list_name", value)
...
class MetricRuleBlackList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scope_type: Optional[pulumi.Input[builtins.str]] = None,
            scope_values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'MetricRuleBlackList':
        """
    ...
    @property
    @pulumi.getter(name="isEnable")
    def is_enable(self) -> pulumi.Output[builtins.bool]:
        """
        The status of the alert blacklist policy. Value:-true: enabled.-false: disabled.
        """
        return pulumi.get(self, "is_enable")
    ...
    @property
    @pulumi.getter(name="metricRuleBlackListId")
    def metric_rule_black_list_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the blacklist policy.
        """
        return pulumi.get(self, "metric_rule_black_list_id")
    ...
    @property
    @pulumi.getter(name="metricRuleBlackListName")
    def metric_rule_black_list_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the alert blacklist policy.
        """
        return pulumi.get(self, "metric_rule_black_list_name")
    ...
    @property
    @pulumi.getter(name="scopeType")
    def scope_type(self) -> pulumi.Output[builtins.str]:
        """
        The effective range of the alert blacklist policy. Value:-USER: The alert blacklist policy only takes effect in the current Alibaba cloud account.-GROUP: The alert blacklist policy takes effect in the specified application GROUP.
        """
        return pulumi.get(self, "scope_type")
    ...
    @property
    @pulumi.getter(name="scopeValues")
    def scope_values(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Application Group ID list. The format is JSON Array.> This parameter is displayed only when 'ScopeType' is 'GROUP.
        """
        return pulumi.get(self, "scope_values")
