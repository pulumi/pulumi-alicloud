...
def get_namespaces(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Namespace IDs.
    :param _builtins.str keyword: The keywords of the `namespace` or `description` of the namespace.
...
def get_namespaces_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
