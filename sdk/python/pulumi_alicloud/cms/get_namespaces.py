...
def get_namespaces(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Namespace IDs.
    :param builtins.str keyword: The keywords of the `namespace` or `description` of the namespace.
...
def get_namespaces_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
