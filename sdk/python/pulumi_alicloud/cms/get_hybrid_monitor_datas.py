...
class GetHybridMonitorDatasResult:
    ...
    def prom_sql(self) -> builtins.str:
...
def get_hybrid_monitor_datas(end: Optional[builtins.str] = None,
                             namespace: Optional[builtins.str] = None,
                             output_file: Optional[builtins.str] = None,
                             period: Optional[builtins.str] = None,
                             prom_sql: Optional[builtins.str] = None,
    ...
    :param builtins.str end: The timestamp that specifies the end of the time range to query.
    ...
    :param builtins.str period: The interval at which monitoring data is collected. Unit: seconds.
    :param builtins.str prom_sql: The name of the metric. Note PromQL statements are supported.
    :param builtins.str start: The timestamp that specifies the beginning of the time range to query.
    """
    __args__ = dict()
    __args__['end'] = end
...
def get_hybrid_monitor_datas_output(end: Optional[pulumi.Input[builtins.str]] = None,
                                    namespace: Optional[pulumi.Input[builtins.str]] = None,
                                    output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    period: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    prom_sql: Optional[pulumi.Input[builtins.str]] = None,
