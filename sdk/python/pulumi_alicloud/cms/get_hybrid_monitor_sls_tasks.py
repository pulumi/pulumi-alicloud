...
def get_hybrid_monitor_sls_tasks(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Hybrid Monitor Sls Task IDs.
    :param builtins.str keyword: The keyword that is used to search for metric import tasks.
    :param builtins.str namespace: The name of the namespace.
...
def get_hybrid_monitor_sls_tasks_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
