...
def get_sls_groups(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Sls Group IDs. Its element value is same as Sls Group Name.
    :param builtins.str keyword: The keywords of the `sls_group_name` or `sls_group_description` of the Sls Group.
    :param builtins.str name_regex: A regex string to filter results by Sls Group name.
...
def get_sls_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
