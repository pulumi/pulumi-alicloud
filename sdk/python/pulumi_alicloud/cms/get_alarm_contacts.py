...
class GetAlarmContactsResult:
    ...
    def chanel_type(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "chanel_type")

    @_builtins.property
    @pulumi.getter(name="chanelValue")
    def chanel_value(self) -> Optional[_builtins.str]:
...
def get_alarm_contacts(chanel_type: Optional[_builtins.str] = None,
                       chanel_value: Optional[_builtins.str] = None,
    ...
    :param _builtins.str chanel_type: The alarm notification method. Alarm notifications can be sent by using `Email` or `DingWebHook`.
    :param _builtins.str chanel_value: The alarm notification target.
    :param Sequence[_builtins.str] ids: A list of alarm contact IDs.
    :param _builtins.str name_regex: A regex string to filter results by alarm contact name.
