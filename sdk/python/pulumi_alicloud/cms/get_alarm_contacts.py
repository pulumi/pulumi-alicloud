...
class GetAlarmContactsResult:
    ...
    def chanel_type(self) -> Optional[builtins.str]:
        return pulumi.get(self, "chanel_type")

    @property
    @pulumi.getter(name="chanelValue")
    def chanel_value(self) -> Optional[builtins.str]:
...
def get_alarm_contacts(chanel_type: Optional[builtins.str] = None,
                       chanel_value: Optional[builtins.str] = None,
    ...
    :param builtins.str chanel_type: The alarm notification method. Alarm notifications can be sent by using `Email` or `DingWebHook`.
    :param builtins.str chanel_value: The alarm notification target.
    :param Sequence[builtins.str] ids: A list of alarm contact IDs.
    :param builtins.str name_regex: A regex string to filter results by alarm contact name.
...
def get_alarm_contacts_output(chanel_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              chanel_value: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetAlarmContactsResult(
        ...
        chanel_value=pulumi.get(__response__, 'chanel_value'),
