...
def get_alarm_contact_groups(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Alarm Contact Group IDs.
    :param _builtins.str name_regex: A regex string to filter results by Alarm Contact Group name.
...
def get_alarm_contact_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
