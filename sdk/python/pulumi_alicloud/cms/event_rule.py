...
class EventRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] rule_name: The name of the event-triggered alert rule.
        ...
        :param pulumi.Input[builtins.str] description: The description of the event-triggered alert rule.
        ...
        :param pulumi.Input[builtins.str] group_id: The ID of the application group to which the event-triggered alert rule belongs.
        ...
        :param pulumi.Input[builtins.int] silence_time: The silence time.
        ...
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid values: `ENABLED`, `DISABLED`.
