...
class DynamicTagGroupArgs:
    def __init__(__self__, *,
                 contact_group_lists: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 match_expresses: pulumi.Input[Sequence[pulumi.Input['DynamicTagGroupMatchExpressArgs']]],
                 tag_key: pulumi.Input[builtins.str],
                 match_express_filter_relation: Optional[pulumi.Input[builtins.str]] = None,
                 template_id_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a DynamicTagGroup resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contact_group_lists: The alert contact groups. The alert notifications of the application group are sent to the alert contacts that belong to the specified alert contact groups.
        ...
        :param pulumi.Input[builtins.str] tag_key: The tag keys of the cloud resources.
        :param pulumi.Input[builtins.str] match_express_filter_relation: The relationship between the conditional expressions for the tag values of the cloud resources. Valid values: `and`, `or`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] template_id_lists: The IDs of the alert templates.
        """
    ...
    def contact_group_lists(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def contact_group_lists(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def match_express_filter_relation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def match_express_filter_relation(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "match_express_filter_relation", value)

    @property
    @pulumi.getter(name="templateIdLists")
    def template_id_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def template_id_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _DynamicTagGroupState:
    def __init__(__self__, *,
                 contact_group_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 match_express_filter_relation: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] match_express_filter_relation: The relationship between the conditional expressions for the tag values of the cloud resources. Valid values: `and`, `or`.
        :param pulumi.Input[Sequence[pulumi.Input['DynamicTagGroupMatchExpressArgs']]] match_expresses: The conditional expressions used to create an application group based on the tag. See `match_express` below.
        :param pulumi.Input[builtins.str] status: The status of the Dynamic Tag Group.
        :param pulumi.Input[builtins.str] tag_key: The tag keys of the cloud resources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] template_id_lists: The IDs of the alert templates.
        """
    ...
    @property
    @pulumi.getter(name="contactGroupLists")
    def contact_group_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The alert contact groups. The alert notifications of the application group are sent to the alert contacts that belong to the specified alert contact groups.
        """
        return pulumi.get(self, "contact_group_lists")
    ...
    @contact_group_lists.setter
    def contact_group_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "contact_group_lists", value)
...
class DynamicTagGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tag_key: Optional[pulumi.Input[builtins.str]] = None,
            template_id_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'DynamicTagGroup':
        """
    ...
    @property
    @pulumi.getter(name="contactGroupLists")
    def contact_group_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The alert contact groups. The alert notifications of the application group are sent to the alert contacts that belong to the specified alert contact groups.
        """
        return pulumi.get(self, "contact_group_lists")
    ...
    @property
    @pulumi.getter(name="matchExpressFilterRelation")
    def match_express_filter_relation(self) -> pulumi.Output[builtins.str]:
        """
        The relationship between the conditional expressions for the tag values of the cloud resources. Valid values: `and`, `or`.
        """
        return pulumi.get(self, "match_express_filter_relation")
    ...
    @property
    @pulumi.getter(name="templateIdLists")
    def template_id_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The IDs of the alert templates.
        """
        return pulumi.get(self, "template_id_lists")
