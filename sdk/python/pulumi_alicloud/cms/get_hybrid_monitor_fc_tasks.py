...
def get_hybrid_monitor_fc_tasks(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Hybrid Monitor Fc Task IDs.
...
def get_hybrid_monitor_fc_tasks_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
