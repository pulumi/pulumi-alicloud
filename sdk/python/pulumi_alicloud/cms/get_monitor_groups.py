...
class GetMonitorGroupsResult:
    ...
    def dynamic_tag_rule_id(self) -> Optional[builtins.str]:
    ...
    def include_template_history(self) -> Optional[builtins.bool]:
    ...
    def monitor_group_name(self) -> Optional[builtins.str]:
    ...
    def select_contact_groups(self) -> Optional[builtins.bool]:
...
def get_monitor_groups(dynamic_tag_rule_id: Optional[builtins.str] = None,
                       ids: Optional[Sequence[builtins.str]] = None,
                       include_template_history: Optional[builtins.bool] = None,
                       keyword: Optional[builtins.str] = None,
                       monitor_group_name: Optional[builtins.str] = None,
                       name_regex: Optional[builtins.str] = None,
                       output_file: Optional[builtins.str] = None,
                       select_contact_groups: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Monitor Group IDs.
    :param builtins.bool include_template_history: The include template history.
    :param builtins.str keyword: The keyword to be matched.
    :param builtins.str monitor_group_name: The name of the application group.
    :param builtins.str name_regex: A regex string to filter results by Monitor Group name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.bool select_contact_groups: The select contact groups.
    :param builtins.str type: The type of the application group. Valid values: `custom`, `ehpc_cluster`, `kubernetes`.
    """
    __args__ = dict()
...
def get_monitor_groups_output(dynamic_tag_rule_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                              include_template_history: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                              keyword: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              monitor_group_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              select_contact_groups: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
