...
class SlsGroupArgs:
    def __init__(__self__, *,
                 ...
                 sls_group_name: pulumi.Input[builtins.str],
                 sls_group_description: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] sls_group_name: The name of the resource. The name must be `2` to `32` characters in length, and can contain letters, digits and underscores (_). It must start with a letter.
        :param pulumi.Input[builtins.str] sls_group_description: The Description of the Sls Group.
        """
    ...
    def sls_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sls_group_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sls_group_name", value)

    @property
    @pulumi.getter(name="slsGroupDescription")
    def sls_group_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sls_group_description(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SlsGroupState:
    def __init__(__self__, *,
                 ...
                 sls_group_description: Optional[pulumi.Input[builtins.str]] = None,
                 sls_group_name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="slsGroupName")
    def sls_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the resource. The name must be `2` to `32` characters in length, and can contain letters, digits and underscores (_). It must start with a letter.
        """
        return pulumi.get(self, "sls_group_name")
    ...
    @sls_group_name.setter
    def sls_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sls_group_name", value)
...
class SlsGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sls_group_configs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SlsGroupSlsGroupConfigArgs', 'SlsGroupSlsGroupConfigArgsDict']]]]] = None,
            sls_group_description: Optional[pulumi.Input[builtins.str]] = None,
            sls_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'SlsGroup':
        """
    ...
    @property
    @pulumi.getter(name="slsGroupDescription")
    def sls_group_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Description of the Sls Group.
        """
        return pulumi.get(self, "sls_group_description")
    ...
    @property
    @pulumi.getter(name="slsGroupName")
    def sls_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the resource. The name must be `2` to `32` characters in length, and can contain letters, digits and underscores (_). It must start with a letter.
        """
        return pulumi.get(self, "sls_group_name")
