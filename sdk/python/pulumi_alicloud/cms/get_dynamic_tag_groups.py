...
def get_dynamic_tag_groups(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Dynamic Tag Group IDs.
...
def get_dynamic_tag_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:cms/getDynamicTagGroups:getDynamicTagGroups', __args__, opts=opts, typ=GetDynamicTagGroupsResult)
    return __ret__.apply(lambda __response__: GetDynamicTagGroupsResult(
