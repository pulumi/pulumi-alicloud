...
class AlarmContactGroupArgs:
    def __init__(__self__, *,
                 alarm_contact_group_name: pulumi.Input[builtins.str],
                 contacts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 describe: Optional[pulumi.Input[builtins.str]] = None,
                 enable_subscribed: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a AlarmContactGroup resource.
        :param pulumi.Input[builtins.str] alarm_contact_group_name: The name of the alarm group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contacts: The name of the alert contact.
        :param pulumi.Input[builtins.str] describe: The description of the alert group.
        :param pulumi.Input[builtins.bool] enable_subscribed: Whether to open weekly subscription.
        """
    ...
    def alarm_contact_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def alarm_contact_group_name(self, value: pulumi.Input[builtins.str]):
    ...
    def enable_subscribed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_subscribed(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _AlarmContactGroupState:
    def __init__(__self__, *,
                 alarm_contact_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 contacts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 describe: Optional[pulumi.Input[builtins.str]] = None,
                 enable_subscribed: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    @property
    @pulumi.getter(name="alarmContactGroupName")
    def alarm_contact_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the alarm group.
        """
        return pulumi.get(self, "alarm_contact_group_name")
    ...
    @alarm_contact_group_name.setter
    def alarm_contact_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alarm_contact_group_name", value)
...
class AlarmContactGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            contacts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            describe: Optional[pulumi.Input[builtins.str]] = None,
            enable_subscribed: Optional[pulumi.Input[builtins.bool]] = None) -> 'AlarmContactGroup':
        """
    ...
    @property
    @pulumi.getter(name="alarmContactGroupName")
    def alarm_contact_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the alarm group.
        """
        return pulumi.get(self, "alarm_contact_group_name")
    ...
    @property
    @pulumi.getter
    def contacts(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The name of the alert contact.
        """
        return pulumi.get(self, "contacts")
    ...
    @property
    @pulumi.getter
    def describe(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the alert group.
        """
        return pulumi.get(self, "describe")
    ...
    @property
    @pulumi.getter(name="enableSubscribed")
    def enable_subscribed(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to open weekly subscription.
        """
        return pulumi.get(self, "enable_subscribed")
