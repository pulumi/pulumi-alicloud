...
class NamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] namespace: The name of the namespace. The name can contain lowercase letters, digits, and hyphens (-).
        :param pulumi.Input[builtins.str] description: The description of the namespace.
        :param pulumi.Input[builtins.str] specification: The data retention period. Default value: `cms.s1.3xlarge`. Valid values:
...
class Namespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            namespace: Optional[pulumi.Input[builtins.str]] = None,
            specification: Optional[pulumi.Input[builtins.str]] = None) -> 'Namespace':
        """
