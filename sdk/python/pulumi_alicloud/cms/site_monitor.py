...
class SiteMonitor(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 alert_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None,
                 interval: Optional[pulumi.Input[float]] = None,
                 isp_cities: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['SiteMonitorIspCityArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] alert_ids: The IDs of existing alert rules to be associated with the site monitoring task.
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['SiteMonitorIspCityArgs']]]] isp_cities: The detection points in a JSON array. For example, `[{"city":"546","isp":"465"},{"city":"572","isp":"465"},{"city":"738","isp":"465"}]` indicates the detection points in Beijing, Hangzhou, and Qingdao respectively. You can call the [DescribeSiteMonitorISPCityList](https://www.alibabacloud.com/help/en/doc-detail/115045.htm?spm=a2c63.p38356.b99.238.5fec36962UlFG6) operation to query detection point information. If this parameter is not specified, three detection points will be chosen randomly for monitoring.
    ...
    def alert_ids(self) -> Optional[List[str]]:
        """
    ...
    def isp_cities(self) -> Optional[List['outputs.SiteMonitorIspCity']]:
        """
    ...
    def options_json(self) -> Optional[str]:
        """
