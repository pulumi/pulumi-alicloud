...
class SiteMonitorArgs:
    def __init__(__self__, *,
                 ...
                 alert_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 options_json: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SiteMonitor resource.
        :param pulumi.Input[builtins.str] address: The URL or IP address monitored by the site monitoring task.
        :param pulumi.Input[builtins.str] task_name: The name of the site monitoring task. The name must be 4 to 100 characters in length. The name can contain the following types of characters: letters, digits, and underscores.
        :param pulumi.Input[builtins.str] task_type: The protocol of the site monitoring task. Currently, site monitoring supports the following protocols: HTTP, PING, TCP, UDP, DNS, SMTP, POP3, and FTP.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] alert_ids: The IDs of existing alert rules to be associated with the site monitoring task.
        :param pulumi.Input[builtins.int] interval: The monitoring interval of the site monitoring task. Unit: minutes. Valid values: `1`, `5`, `15`, `30` and `60`. Default value: `1`. **NOTE:** From version 1.207.0, `interval` can be set to `30`, `60`.
        ...
        :param pulumi.Input[builtins.str] options_json: The extended options of the protocol of the site monitoring task. The options vary according to the protocol. See [extended options](https://www.alibabacloud.com/help/en/cms/developer-reference/api-cms-2019-01-01-createsitemonitor#api-detail-35).
        """
    ...
    def alert_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @alert_ids.setter
    def alert_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def options_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @options_json.setter
    def options_json(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SiteMonitorState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] address: The URL or IP address monitored by the site monitoring task.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] alert_ids: The IDs of existing alert rules to be associated with the site monitoring task.
        :param pulumi.Input[builtins.str] create_time: The time when the site monitoring task was created.
        :param pulumi.Input[builtins.int] interval: The monitoring interval of the site monitoring task. Unit: minutes. Valid values: `1`, `5`, `15`, `30` and `60`. Default value: `1`. **NOTE:** From version 1.207.0, `interval` can be set to `30`, `60`.
        :param pulumi.Input[Sequence[pulumi.Input['SiteMonitorIspCityArgs']]] isp_cities: The detection points in a JSON array. For example, `[{"city":"546","isp":"465"},{"city":"572","isp":"465"},{"city":"738","isp":"465"}]` indicates the detection points in Beijing, Hangzhou, and Qingdao respectively. You can call the [DescribeSiteMonitorISPCityList](https://www.alibabacloud.com/help/en/doc-detail/115045.htm) operation to query detection point information. If this parameter is not specified, three detection points will be chosen randomly for monitoring. See `isp_cities` below.
        :param pulumi.Input[builtins.str] options_json: The extended options of the protocol of the site monitoring task. The options vary according to the protocol. See [extended options](https://www.alibabacloud.com/help/en/cms/developer-reference/api-cms-2019-01-01-createsitemonitor#api-detail-35).
        :param pulumi.Input[builtins.str] task_name: The name of the site monitoring task. The name must be 4 to 100 characters in length. The name can contain the following types of characters: letters, digits, and underscores.
        :param pulumi.Input[builtins.str] task_state: The status of the site monitoring task.
        :param pulumi.Input[builtins.str] task_type: The protocol of the site monitoring task. Currently, site monitoring supports the following protocols: HTTP, PING, TCP, UDP, DNS, SMTP, POP3, and FTP.
        :param pulumi.Input[builtins.str] update_time: The time when the site monitoring task was updated.
        """
    ...
    @task_state.setter
    def task_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SiteMonitor(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            task_state: Optional[pulumi.Input[builtins.str]] = None,
            task_type: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'SiteMonitor':
        """
    ...
    @property
    @pulumi.getter(name="alertIds")
    def alert_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The IDs of existing alert rules to be associated with the site monitoring task.
        """
        return pulumi.get(self, "alert_ids")
    ...
    @property
    @pulumi.getter(name="optionsJson")
    def options_json(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The extended options of the protocol of the site monitoring task. The options vary according to the protocol. See [extended options](https://www.alibabacloud.com/help/en/cms/developer-reference/api-cms-2019-01-01-createsitemonitor#api-detail-35).
        """
        return pulumi.get(self, "options_json")
    ...
    @property
    @pulumi.getter(name="taskState")
    def task_state(self) -> pulumi.Output[builtins.str]:
        """
        The status of the site monitoring task.
        """
        return pulumi.get(self, "task_state")
