...
class MetricRuleTemplateArgs:
    def __init__(__self__, *,
                 metric_rule_template_name: pulumi.Input[builtins.str],
                 alert_templates: Optional[pulumi.Input[Sequence[pulumi.Input['MetricRuleTemplateAlertTemplateArgs']]]] = None,
                 apply_mode: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enable_end_time: Optional[pulumi.Input[builtins.str]] = None,
                 enable_start_time: Optional[pulumi.Input[builtins.str]] = None,
                 group_id: Optional[pulumi.Input[builtins.str]] = None,
                 notify_level: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] metric_rule_template_name: The name of the alert template.
        ...
        :param pulumi.Input[builtins.str] apply_mode: The mode in which the alert template is applied. Valid values:
        ...
        :param pulumi.Input[builtins.str] description: The description of the alert template.
        :param pulumi.Input[builtins.str] enable_end_time: The end of the time period during which the alert rule is effective. Valid values: `00` to `23`. The value `00` indicates 00:59 and the value `23` indicates 23:59.
        :param pulumi.Input[builtins.str] enable_start_time: The beginning of the time period during which the alert rule is effective. Valid values: `00` to `23`. The value `00` indicates 00:00 and the value `23` indicates 23:00.
        :param pulumi.Input[builtins.str] group_id: The ID of the application group.
        :param pulumi.Input[builtins.str] notify_level: The alert notification method. Valid values:
        :param pulumi.Input[builtins.int] silence_time: The mute period during which notifications are not repeatedly sent for an alert. Unit: seconds. Default value: `86400`. Valid values: `0` to `86400`.
        :param pulumi.Input[builtins.str] webhook: The callback URL to which a POST request is sent when an alert is triggered based on the alert rule.
        """
    ...
    def metric_rule_template_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def metric_rule_template_name(self, value: pulumi.Input[builtins.str]):
    ...
    def apply_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @apply_mode.setter
    def apply_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def enable_end_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def enable_end_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "enable_end_time", value)

    @property
    @pulumi.getter(name="enableStartTime")
    def enable_start_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def enable_start_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def notify_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @notify_level.setter
    def notify_level(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MetricRuleTemplateState:
    def __init__(__self__, *,
                 ...
                 enable_start_time: Optional[pulumi.Input[builtins.str]] = None,
                 group_id: Optional[pulumi.Input[builtins.str]] = None,
                 metric_rule_template_name: Optional[pulumi.Input[builtins.str]] = None,
                 notify_level: Optional[pulumi.Input[builtins.str]] = None,
                 rest_version: Optional[pulumi.Input[builtins.str]] = None,
                 silence_time: Optional[pulumi.Input[builtins.int]] = None,
                 webhook: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] metric_rule_template_name: The name of the alert template.
        :param pulumi.Input[builtins.str] notify_level: The alert notification method. Valid values:
        :param pulumi.Input[builtins.str] rest_version: The version of the alert template.
        :param pulumi.Input[builtins.int] silence_time: The mute period during which notifications are not repeatedly sent for an alert. Unit: seconds. Default value: `86400`. Valid values: `0` to `86400`.
        :param pulumi.Input[builtins.str] webhook: The callback URL to which a POST request is sent when an alert is triggered based on the alert rule.
        """
        if alert_templates is not None:
    ...
    @property
    @pulumi.getter(name="metricRuleTemplateName")
    def metric_rule_template_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the alert template.
        """
        return pulumi.get(self, "metric_rule_template_name")
    ...
    @metric_rule_template_name.setter
    def metric_rule_template_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "metric_rule_template_name", value)
    ...
    def rest_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @rest_version.setter
    def rest_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MetricRuleTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rest_version: Optional[pulumi.Input[builtins.str]] = None,
            silence_time: Optional[pulumi.Input[builtins.int]] = None,
            webhook: Optional[pulumi.Input[builtins.str]] = None) -> 'MetricRuleTemplate':
        """
    ...
    @property
    @pulumi.getter(name="applyMode")
    def apply_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The mode in which the alert template is applied. Valid values:
        - `GROUP_INSTANCE_FIRST`: The metrics in the application group take precedence.
        - `ALARM_TEMPLATE_FIRST `: The metrics specified in the alert template take precedence.
    ...
    @property
    @pulumi.getter(name="enableEndTime")
    def enable_end_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The end of the time period during which the alert rule is effective. Valid values: `00` to `23`. The value `00` indicates 00:59 and the value `23` indicates 23:59.
        """
        return pulumi.get(self, "enable_end_time")
    ...
    @property
    @pulumi.getter(name="enableStartTime")
    def enable_start_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The beginning of the time period during which the alert rule is effective. Valid values: `00` to `23`. The value `00` indicates 00:00 and the value `23` indicates 23:00.
        """
        return pulumi.get(self, "enable_start_time")
    ...
    @property
    @pulumi.getter(name="metricRuleTemplateName")
    def metric_rule_template_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the alert template.
        """
        return pulumi.get(self, "metric_rule_template_name")
    ...
    @property
    @pulumi.getter(name="notifyLevel")
    def notify_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The alert notification method. Valid values:
        """
        return pulumi.get(self, "notify_level")
    ...
    @property
    @pulumi.getter(name="restVersion")
    def rest_version(self) -> pulumi.Output[builtins.str]:
        """
        The version of the alert template.
        """
        return pulumi.get(self, "rest_version")
    ...
    @property
    @pulumi.getter(name="silenceTime")
    def silence_time(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The mute period during which notifications are not repeatedly sent for an alert. Unit: seconds. Default value: `86400`. Valid values: `0` to `86400`.
        """
        return pulumi.get(self, "silence_time")
