...
class HostGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] host_group_name: Specify the New Host Group Name, Supports up to 128 Characters.
        :param pulumi.Input[builtins.str] instance_id: Specify the New Host Group Where the Bastion Host ID of.
        :param pulumi.Input[builtins.str] comment: Specify the New Host Group of Notes, Supports up to 500 Characters.
        """
...
class _HostGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] comment: Specify the New Host Group of Notes, Supports up to 500 Characters.
        :param pulumi.Input[builtins.str] host_group_id: Host Group ID.
        :param pulumi.Input[builtins.str] host_group_name: Specify the New Host Group Name, Supports up to 128 Characters.
        :param pulumi.Input[builtins.str] instance_id: Specify the New Host Group Where the Bastion Host ID of.
        """
        if comment is not None:
...
class HostGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            host_group_id: Optional[pulumi.Input[builtins.str]] = None,
            host_group_name: Optional[pulumi.Input[builtins.str]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None) -> 'HostGroup':
        """
    ...
    @property
    @pulumi.getter(name="hostGroupName")
    def host_group_name(self) -> pulumi.Output[builtins.str]:
        """
        Specify the New Host Group Name, Supports up to 128 Characters.
        """
        return pulumi.get(self, "host_group_name")
