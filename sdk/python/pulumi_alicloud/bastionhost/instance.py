...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 license_code: pulumi.Input[builtins.str],
                 ...
                 enable_public_access: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 public_white_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] bandwidth: The bandwidth of Cloud Bastionhost instance.
        ...
        :param pulumi.Input[builtins.str] description: Description of the instance. This name can have a string of 1 to 63 characters.
        :param pulumi.Input[builtins.str] license_code: The package type of Cloud Bastionhost instance. You can query more supported types through the [DescribePricingModule](https://help.aliyun.com/document_detail/96469.html).
        :param pulumi.Input[builtins.str] plan_code: The plan code of Cloud Bastionhost instance. Valid values:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: security group IDs configured to Bastionhost. 
        ...
        :param pulumi.Input[builtins.int] period: Duration for initially producing the instance. Valid values: [1~9], 12, 24, 36. At present, the provider does not support modify "period".
               > **NOTE:** The attribute `period` is only used to create Subscription instance or modify the PayAsYouGo instance to Subscription. Once effect, it will not be modified that means running `pulumi up` will not effect the resource.
        :param pulumi.Input[builtins.int] renew_period: Automatic renewal period. Valid values: `1` to `9`, `12`, `24`, `36`. **NOTE:** The `renew_period` is required under the condition that `renewal_status` is `AutoRenewal`. From version 1.193.0, `renew_period` can be modified.
        :param pulumi.Input[builtins.str] renewal_period_unit: The unit of the auto-renewal period. Valid values:  **NOTE:** The `renewal_period_unit` is required under the condition that `renewal_status` is `AutoRenewal`.
               - `M`: months.
               - `Y`: years.
        :param pulumi.Input[builtins.str] renewal_status: Automatic renewal status. Valid values: `AutoRenewal`, `ManualRenewal`, `NotRenewal`. From version 1.193.0, `renewal_status` can be modified.
        :param pulumi.Input[builtins.str] resource_group_id: The Id of resource group which the Bastionhost Instance belongs. If not set, the resource is created in the default resource group.
    ...
    def license_code(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @license_code.setter
    def license_code(self, value: pulumi.Input[builtins.str]):
    ...
    def enable_public_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_public_access(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def public_white_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "public_white_lists")

    @public_white_lists.setter
    def public_white_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _InstanceState:
    def __init__(__self__, *,
                 ...
                 enable_public_access: Optional[pulumi.Input[builtins.bool]] = None,
                 ldap_auth_servers: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceLdapAuthServerArgs']]]] = None,
                 license_code: Optional[pulumi.Input[builtins.str]] = None,
                 period: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="licenseCode")
    def license_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The package type of Cloud Bastionhost instance. You can query more supported types through the [DescribePricingModule](https://help.aliyun.com/document_detail/96469.html).
        """
        return pulumi.get(self, "license_code")
    ...
    @license_code.setter
    def license_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "license_code", value)
...
class Instance(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:bastionhost/instance:Instance"
    ...
    @property
    @pulumi.getter(name="enablePublicAccess")
    def enable_public_access(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to Enable the public internet access to a specified Bastionhost instance. The valid values: `true`, `false`.
        """
        return pulumi.get(self, "enable_public_access")
    ...
    @property
    @pulumi.getter(name="licenseCode")
    def license_code(self) -> pulumi.Output[builtins.str]:
        """
        The package type of Cloud Bastionhost instance. You can query more supported types through the [DescribePricingModule](https://help.aliyun.com/document_detail/96469.html).
        """
        return pulumi.get(self, "license_code")
    ...
    @property
    @pulumi.getter(name="publicWhiteLists")
    def public_white_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "public_white_lists")
