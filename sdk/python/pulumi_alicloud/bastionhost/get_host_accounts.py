...
class GetHostAccountsResult:
    ...
    def host_account_name(self) -> Optional[builtins.str]:
    ...
    def protocol_name(self) -> Optional[builtins.str]:
...
def get_host_accounts(host_account_name: Optional[builtins.str] = None,
                      ...
                      protocol_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Host Account IDs.
    ...
    :param builtins.str name_regex: A regex string to filter results by Host Account name.
...
def get_host_accounts_output(host_account_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ...
                             protocol_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetHostAccountsResult(
        ...
        protocol_name=pulumi.get(__response__, 'protocol_name')))
