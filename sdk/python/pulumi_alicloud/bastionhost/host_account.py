...
class HostAccountArgs:
    def __init__(__self__, *,
                 host_account_name: pulumi.Input[builtins.str],
                 host_id: pulumi.Input[builtins.str],
                 instance_id: pulumi.Input[builtins.str],
                 protocol_name: pulumi.Input[builtins.str],
                 pass_phrase: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 private_key: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a HostAccount resource.
        :param pulumi.Input[builtins.str] host_account_name: The name of the host account. The name can be up to 128 characters in length.
        :param pulumi.Input[builtins.str] host_id: The ID of the host for which you want to create an account.
        :param pulumi.Input[builtins.str] instance_id: The ID of the Bastionhost instance where you want to create an account for the host.
        :param pulumi.Input[builtins.str] protocol_name: The protocol used by the host account. Valid values: SSH,RDP
        :param pulumi.Input[builtins.str] pass_phrase: The passphrase of the private key for the host account. **NOTE:** It is valid when the attribute `protocol_name` is `SSH`.
        :param pulumi.Input[builtins.str] password: The password of the host account.
        :param pulumi.Input[builtins.str] private_key: The private key of the host account. The value is a Base64-encoded string. **NOTE:** It is valid when the attribute `protocol_name` is `SSH`
        """
    ...
    def host_account_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def host_account_name(self, value: pulumi.Input[builtins.str]):
    ...
    def protocol_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def protocol_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "protocol_name", value)

    @property
    @pulumi.getter(name="passPhrase")
    def pass_phrase(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @pass_phrase.setter
    def pass_phrase(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _HostAccountState:
    def __init__(__self__, *,
                 host_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 host_account_name: Optional[pulumi.Input[builtins.str]] = None,
                 host_id: Optional[pulumi.Input[builtins.str]] = None,
                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 pass_phrase: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 private_key: Optional[pulumi.Input[builtins.str]] = None,
                 protocol_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering HostAccount resources.
        :param pulumi.Input[builtins.str] host_account_id: Hosting account ID.
        :param pulumi.Input[builtins.str] host_account_name: The name of the host account. The name can be up to 128 characters in length.
        :param pulumi.Input[builtins.str] host_id: The ID of the host for which you want to create an account.
        :param pulumi.Input[builtins.str] instance_id: The ID of the Bastionhost instance where you want to create an account for the host.
        :param pulumi.Input[builtins.str] pass_phrase: The passphrase of the private key for the host account. **NOTE:** It is valid when the attribute `protocol_name` is `SSH`.
    ...
    def host_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Hosting account ID.
        """
    ...
    def host_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "host_account_id", value)

    @property
    @pulumi.getter(name="hostAccountName")
    def host_account_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the host account. The name can be up to 128 characters in length.
        """
        return pulumi.get(self, "host_account_name")
    ...
    @host_account_name.setter
    def host_account_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "host_account_name", value)
    ...
    @property
    @pulumi.getter(name="protocolName")
    def protocol_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The protocol used by the host account. Valid values: SSH,RDP
        """
        return pulumi.get(self, "protocol_name")
    ...
    @protocol_name.setter
    def protocol_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "protocol_name", value)
...
class HostAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[builtins.str]] = None,
            private_key: Optional[pulumi.Input[builtins.str]] = None,
            protocol_name: Optional[pulumi.Input[builtins.str]] = None) -> 'HostAccount':
        """
    ...
    @property
    @pulumi.getter(name="hostAccountId")
    def host_account_id(self) -> pulumi.Output[builtins.str]:
        """
        Hosting account ID.
        """
        return pulumi.get(self, "host_account_id")
    ...
    @property
    @pulumi.getter(name="hostAccountName")
    def host_account_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the host account. The name can be up to 128 characters in length.
        """
        return pulumi.get(self, "host_account_name")
    ...
    @property
    @pulumi.getter(name="passPhrase")
    def pass_phrase(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The passphrase of the private key for the host account. **NOTE:** It is valid when the attribute `protocol_name` is `SSH`.
        """
        return pulumi.get(self, "pass_phrase")
    ...
    @property
    @pulumi.getter(name="protocolName")
    def protocol_name(self) -> pulumi.Output[builtins.str]:
        """
        The protocol used by the host account. Valid values: SSH,RDP
        """
        return pulumi.get(self, "protocol_name")
