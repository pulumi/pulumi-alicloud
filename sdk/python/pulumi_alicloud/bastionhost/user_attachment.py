...
class UserAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: Specifies the user group to add the user's bastion host ID of.
        :param pulumi.Input[builtins.str] user_group_id: Specifies the user group to which you want to add the user ID.
        :param pulumi.Input[builtins.str] user_id: Specify that you want to add to the policy attached to the user group ID. This includes response parameters in a Json-formatted string supports up to set up 100 USER ID.
        """
...
@pulumi.type_token("alicloud:bastionhost/userAttachment:UserAttachment")
class UserAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            user_group_id: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UserAttachment':
        """
