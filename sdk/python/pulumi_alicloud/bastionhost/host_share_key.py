...
class HostShareKeyArgs:
    def __init__(__self__, *,
                 host_share_key_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] host_share_key_name: The name of the host shared key to be added. The name can be a maximum of 128 characters in length.
        :param pulumi.Input[builtins.str] instance_id: The ID of the Bastion instance.
        :param pulumi.Input[builtins.str] private_key: The private key. The value is a Base64-encoded string.
        :param pulumi.Input[builtins.str] pass_phrase: The password of the private key. The value is a Base64-encoded string.
        """
    ...
    def host_share_key_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def host_share_key_name(self, value: pulumi.Input[builtins.str]):
...
class _HostShareKeyState:
    def __init__(__self__, *,
                 host_share_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 host_share_key_name: Optional[pulumi.Input[builtins.str]] = None,
                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 pass_phrase: Optional[pulumi.Input[builtins.str]] = None,
                 private_key: Optional[pulumi.Input[builtins.str]] = None,
                 private_key_finger_print: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering HostShareKey resources.
        :param pulumi.Input[builtins.str] host_share_key_id: The first ID of the resource.
        :param pulumi.Input[builtins.str] host_share_key_name: The name of the host shared key to be added. The name can be a maximum of 128 characters in length.
        :param pulumi.Input[builtins.str] instance_id: The ID of the Bastion instance.
        :param pulumi.Input[builtins.str] pass_phrase: The password of the private key. The value is a Base64-encoded string.
        :param pulumi.Input[builtins.str] private_key: The private key. The value is a Base64-encoded string.
        :param pulumi.Input[builtins.str] private_key_finger_print: The fingerprint of the private key.
        """
    ...
    def host_share_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def host_share_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "host_share_key_id", value)

    @property
    @pulumi.getter(name="hostShareKeyName")
    def host_share_key_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the host shared key to be added. The name can be a maximum of 128 characters in length.
        """
        return pulumi.get(self, "host_share_key_name")
    ...
    @host_share_key_name.setter
    def host_share_key_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "host_share_key_name", value)
    ...
    def private_key_finger_print(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_key_finger_print(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HostShareKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pass_phrase: Optional[pulumi.Input[builtins.str]] = None,
            private_key: Optional[pulumi.Input[builtins.str]] = None,
            private_key_finger_print: Optional[pulumi.Input[builtins.str]] = None) -> 'HostShareKey':
        """
    ...
    @property
    @pulumi.getter(name="hostShareKeyId")
    def host_share_key_id(self) -> pulumi.Output[builtins.str]:
        """
        The first ID of the resource.
        """
        return pulumi.get(self, "host_share_key_id")
    ...
    @property
    @pulumi.getter(name="hostShareKeyName")
    def host_share_key_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the host shared key to be added. The name can be a maximum of 128 characters in length.
        """
        return pulumi.get(self, "host_share_key_name")
    ...
    @property
    @pulumi.getter(name="privateKeyFingerPrint")
    def private_key_finger_print(self) -> pulumi.Output[builtins.str]:
        """
        The fingerprint of the private key.
        """
        return pulumi.get(self, "private_key_finger_print")
