...
class UserGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: Specify the New Group of the Bastion Host of Instance Id.
        :param pulumi.Input[builtins.str] user_group_name: Specify the New Group Name. Supports up to 128 Characters.
        :param pulumi.Input[builtins.str] comment: Specify the New Group of Remark Information. Supports up to 500 Characters.
        """
...
class _UserGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] comment: Specify the New Group of Remark Information. Supports up to 500 Characters.
        :param pulumi.Input[builtins.str] instance_id: Specify the New Group of the Bastion Host of Instance Id.
        :param pulumi.Input[builtins.str] user_group_id: The User Group self ID.
        :param pulumi.Input[builtins.str] user_group_name: Specify the New Group Name. Supports up to 128 Characters.
        """
        if comment is not None:
            pulumi.set(__self__, "comment", comment)
...
class UserGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            user_group_id: Optional[pulumi.Input[builtins.str]] = None,
            user_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'UserGroup':
        """
