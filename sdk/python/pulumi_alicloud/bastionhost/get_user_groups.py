...
def get_user_groups(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of User Group self IDs.
    :param builtins.str instance_id: Specify the New Group of the Bastion Host of Instance Id.
    :param builtins.str name_regex: A regex string to filter results by User Group name.
...
def get_user_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
