...
def get_user_groups(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of User Group self IDs.
    :param _builtins.str instance_id: Specify the New Group of the Bastion Host of Instance Id.
    :param _builtins.str name_regex: A regex string to filter results by User Group name.
...
def get_user_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:bastionhost/getUserGroups:getUserGroups', __args__, opts=opts, typ=GetUserGroupsResult)
