...
class HostAccountShareKeyAttachmentArgs:
    def __init__(__self__, *,
                 host_account_id: pulumi.Input[builtins.str],
                 host_share_key_id: pulumi.Input[builtins.str],
                 instance_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a HostAccountShareKeyAttachment resource.
        :param pulumi.Input[builtins.str] host_account_id: The ID list of the host account.
        :param pulumi.Input[builtins.str] host_share_key_id: The ID of the host shared key.
        :param pulumi.Input[builtins.str] instance_id: The ID of the Bastion machine instance.
        """
    ...
    def host_account_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def host_account_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "host_account_id", value)

    @property
    @pulumi.getter(name="hostShareKeyId")
    def host_share_key_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def host_share_key_id(self, value: pulumi.Input[builtins.str]):
...
class HostAccountShareKeyAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            host_account_id: Optional[pulumi.Input[builtins.str]] = None,
            host_share_key_id: Optional[pulumi.Input[builtins.str]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None) -> 'HostAccountShareKeyAttachment':
        """
