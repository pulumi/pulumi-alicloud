...
class HostAccountShareKeyAttachmentArgs:
    def __init__(__self__, *,
                 host_account_id: pulumi.Input[_builtins.str],
                 host_share_key_id: pulumi.Input[_builtins.str],
    ...
    def host_account_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def host_account_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "host_account_id", value)

    @_builtins.property
    @pulumi.getter(name="hostShareKeyId")
    def host_share_key_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def host_share_key_id(self, value: pulumi.Input[_builtins.str]):
