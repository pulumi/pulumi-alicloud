...
class HostArgs:
    def __init__(__self__, *,
                 active_address_type: pulumi.Input[builtins.str],
                 ...
                 host_private_address: Optional[pulumi.Input[builtins.str]] = None,
                 host_public_address: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] active_address_type: Specify the new create a host of address types. Valid values: `Public`: the IP address of a Public network. `Private`: Private network address.
        :param pulumi.Input[builtins.str] host_name: Specify the new create a host name of the supports up to 128 characters.
        :param pulumi.Input[builtins.str] instance_id: Specify the new create a host where the Bastion host ID of.
        :param pulumi.Input[builtins.str] os_type: Specify the new create the host's operating system. Valid values: `Linux`,`Windows`.
        :param pulumi.Input[builtins.str] source: Specify the new create a host of source. Valid values: 
               * `Local`: localhost
               * `Ecs`:ECS instance
               * `Rds`:RDS exclusive cluster host.
        :param pulumi.Input[builtins.str] comment: Specify a host of notes, supports up to 500 characters.
        :param pulumi.Input[builtins.str] host_private_address: Specify the new create a host of the private network address, it is possible to use the domain name or IP ADDRESS. **NOTE:**  This parameter is required if the `active_address_type` parameter is set to `Private`.
        :param pulumi.Input[builtins.str] host_public_address: Specify the new create a host of the IP address of a public network, it is possible to use the domain name or IP ADDRESS.
        :param pulumi.Input[builtins.str] instance_region_id: The instance region id.
        :param pulumi.Input[builtins.str] source_instance_id: Specify the newly created ECS instance ID or dedicated cluster host ID. **NOTE:** This parameter is required if the `source` parameter is set to `Ecs` or `Rds`.
        """
    ...
    def active_address_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def active_address_type(self, value: pulumi.Input[builtins.str]):
    ...
    def host_private_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def host_private_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "host_private_address", value)

    @property
    @pulumi.getter(name="hostPublicAddress")
    def host_public_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def host_public_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _HostState:
    def __init__(__self__, *,
                 active_address_type: Optional[pulumi.Input[builtins.str]] = None,
                 comment: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] active_address_type: Specify the new create a host of address types. Valid values: `Public`: the IP address of a Public network. `Private`: Private network address.
        :param pulumi.Input[builtins.str] comment: Specify a host of notes, supports up to 500 characters.
        :param pulumi.Input[builtins.str] host_id: The host ID.
        :param pulumi.Input[builtins.str] host_name: Specify the new create a host name of the supports up to 128 characters.
        :param pulumi.Input[builtins.str] host_private_address: Specify the new create a host of the private network address, it is possible to use the domain name or IP ADDRESS. **NOTE:**  This parameter is required if the `active_address_type` parameter is set to `Private`.
        :param pulumi.Input[builtins.str] host_public_address: Specify the new create a host of the IP address of a public network, it is possible to use the domain name or IP ADDRESS.
        :param pulumi.Input[builtins.str] instance_id: Specify the new create a host where the Bastion host ID of.
    ...
    @property
    @pulumi.getter(name="activeAddressType")
    def active_address_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specify the new create a host of address types. Valid values: `Public`: the IP address of a Public network. `Private`: Private network address.
        """
        return pulumi.get(self, "active_address_type")
    ...
    @active_address_type.setter
    def active_address_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "active_address_type", value)
...
class Host(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            os_type: Optional[pulumi.Input[builtins.str]] = None,
            source: Optional[pulumi.Input[builtins.str]] = None,
            source_instance_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Host':
        """
    ...
    @property
    @pulumi.getter(name="activeAddressType")
    def active_address_type(self) -> pulumi.Output[builtins.str]:
        """
        Specify the new create a host of address types. Valid values: `Public`: the IP address of a Public network. `Private`: Private network address.
        """
        return pulumi.get(self, "active_address_type")
    ...
    @property
    @pulumi.getter(name="hostPrivateAddress")
    def host_private_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify the new create a host of the private network address, it is possible to use the domain name or IP ADDRESS. **NOTE:**  This parameter is required if the `active_address_type` parameter is set to `Private`.
        """
        return pulumi.get(self, "host_private_address")
    ...
    @property
    @pulumi.getter(name="hostPublicAddress")
    def host_public_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify the new create a host of the IP address of a public network, it is possible to use the domain name or IP ADDRESS.
        """
        return pulumi.get(self, "host_public_address")
    ...
    @property
    @pulumi.getter(name="instanceRegionId")
    def instance_region_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The instance region id.
        """
        return pulumi.get(self, "instance_region_id")
    ...
    @property
    @pulumi.getter(name="sourceInstanceId")
    def source_instance_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify the newly created ECS instance ID or dedicated cluster host ID. **NOTE:** This parameter is required if the `source` parameter is set to `Ecs` or `Rds`.
        """
        return pulumi.get(self, "source_instance_id")
