...
def get_instances(description_regex: Optional[builtins.str] = None,
    ...
    :param builtins.str description_regex: A regex string to filter results by the instance description.
    :param Sequence[builtins.str] ids: Matched instance IDs to filter data source result.
    :param builtins.str output_file: File name to persist data source output.
...
def get_instances_output(description_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
