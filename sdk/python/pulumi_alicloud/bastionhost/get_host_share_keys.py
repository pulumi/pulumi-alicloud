...
def get_host_share_keys(enable_details: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Host Share Key IDs.
    :param _builtins.str instance_id: The ID of the Bastion instance.
    :param _builtins.str name_regex: A regex string to filter results by Host Share Key name.
...
def get_host_share_keys_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
