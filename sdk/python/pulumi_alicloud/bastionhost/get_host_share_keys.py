...
def get_host_share_keys(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Host Share Key IDs.
    :param builtins.str instance_id: The ID of the Bastion instance.
    :param builtins.str name_regex: A regex string to filter results by Host Share Key name.
...
def get_host_share_keys_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
