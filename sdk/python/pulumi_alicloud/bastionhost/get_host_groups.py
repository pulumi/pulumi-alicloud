...
def get_host_groups(host_group_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Host Group IDs.
    :param _builtins.str instance_id: Specify the New Host Group Where the Bastion Host ID of.
    :param _builtins.str name_regex: A regex string to filter results by Host Group name.
...
def get_host_groups_output(host_group_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
