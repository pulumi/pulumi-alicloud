...
def get_host_groups(host_group_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Host Group IDs.
    :param builtins.str instance_id: Specify the New Host Group Where the Bastion Host ID of.
    :param builtins.str name_regex: A regex string to filter results by Host Group name.
...
def get_host_groups_output(host_group_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
