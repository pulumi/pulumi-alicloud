...
class MscSubWebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_url: The serverUrl of the Webhook. This url must start with `https://oapi.dingtalk.com/robot/send?access_token=`.
        :param pulumi.Input[builtins.str] webhook_name: The name of the Webhook. **Note:** The name must be `2` to `12` characters in length, and can contain uppercase and lowercase letters.
        """
...
class MscSubWebhook(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            server_url: Optional[pulumi.Input[builtins.str]] = None,
            webhook_name: Optional[pulumi.Input[builtins.str]] = None) -> 'MscSubWebhook':
        """
