...
class GetIndustrialPidLoopsLoopResult(dict):
    def __init__(__self__, *,
                 id: builtins.str,
                 pid_loop_configuration: builtins.str,
                 pid_loop_dcs_type: builtins.str,
                 pid_loop_desc: builtins.str,
                 pid_loop_id: builtins.str,
                 pid_loop_is_crucial: builtins.bool,
                 pid_loop_name: builtins.str,
                 pid_loop_type: builtins.str,
                 pid_project_id: builtins.str,
                 status: builtins.str):
        """
        :param builtins.str id: The ID of the Pid Loop.
        :param builtins.str pid_loop_dcs_type: The dcs type of Pid Loop.
        :param builtins.str pid_loop_id: The ID of the Pid Loop.
        :param builtins.bool pid_loop_is_crucial: Whether is crucial Pid Loop.
        :param builtins.str pid_loop_name: The name of Pid Loop.
        :param builtins.str pid_loop_type: The type of Pid Loop.
        :param builtins.str pid_project_id: The pid project id.
        :param builtins.str status: The status of Pid Loop.
        """
    ...
    def pid_loop_configuration(self) -> builtins.str:
        return pulumi.get(self, "pid_loop_configuration")

    @property
    @pulumi.getter(name="pidLoopDcsType")
    def pid_loop_dcs_type(self) -> builtins.str:
        """
    ...
    def pid_loop_desc(self) -> builtins.str:
        return pulumi.get(self, "pid_loop_desc")

    @property
    @pulumi.getter(name="pidLoopId")
    def pid_loop_id(self) -> builtins.str:
        """
        The ID of the Pid Loop.
        """
    ...
    def pid_loop_is_crucial(self) -> builtins.bool:
        """
    ...
    def pid_loop_name(self) -> builtins.str:
        """
    ...
    def pid_loop_type(self) -> builtins.str:
        """
    ...
    def pid_project_id(self) -> builtins.str:
        """
        The pid project id.
        """
...
class GetIndustrialPidOrganizationsOrganizationResult(dict):
    def __init__(__self__, *,
                 id: builtins.str,
                 parent_pid_organization_id: builtins.str,
                 pid_organization_id: builtins.str,
                 pid_organization_level: builtins.int,
                 pid_organization_name: builtins.str):
        """
        :param builtins.str id: The ID of the Pid Organization.
        :param builtins.str parent_pid_organization_id: The parent organization id.
        :param builtins.str pid_organization_id: The organization id.
        :param builtins.int pid_organization_level: The organization level.
        :param builtins.str pid_organization_name: The organization name.
        """
        pulumi.set(__self__, "id", id)
    ...
    def parent_pid_organization_id(self) -> builtins.str:
        """
    ...
    def pid_organization_id(self) -> builtins.str:
        """
        The organization id.
        """
    ...
    def pid_organization_level(self) -> builtins.int:
        """
    ...
    def pid_organization_name(self) -> builtins.str:
        """
...
class GetIndustrialPidProjectsProjectResult(dict):
    def __init__(__self__, *,
                 id: builtins.str,
                 pid_organization_id: builtins.str,
                 pid_project_desc: builtins.str,
                 pid_project_id: builtins.str,
                 pid_project_name: builtins.str):
        """
        :param builtins.str id: The ID of the Pid Project.
        :param builtins.str pid_organization_id: The ID of Pid Organization.
        :param builtins.str pid_project_desc: The description of Pid Project.
        :param builtins.str pid_project_id: The ID of Pid Project.
        :param builtins.str pid_project_name: The name of Pid Project.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "pid_organization_id", pid_organization_id)
    ...
    def pid_project_desc(self) -> builtins.str:
        """
    ...
    def pid_project_name(self) -> builtins.str:
        """
