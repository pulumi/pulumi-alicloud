...
class IndustrialPidOrganizationArgs:
    def __init__(__self__, *,
                 pid_organization_name: pulumi.Input[builtins.str],
                 parent_pid_organization_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a IndustrialPidOrganization resource.
        :param pulumi.Input[builtins.str] pid_organization_name: The name of pid organization.
        :param pulumi.Input[builtins.str] parent_pid_organization_id: The ID of parent pid organization.
        """
    ...
    def pid_organization_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def pid_organization_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "pid_organization_name", value)

    @property
    @pulumi.getter(name="parentPidOrganizationId")
    def parent_pid_organization_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def parent_pid_organization_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _IndustrialPidOrganizationState:
    def __init__(__self__, *,
                 parent_pid_organization_id: Optional[pulumi.Input[builtins.str]] = None,
                 pid_organization_name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="pidOrganizationName")
    def pid_organization_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of pid organization.
        """
        return pulumi.get(self, "pid_organization_name")
    ...
    @pid_organization_name.setter
    def pid_organization_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pid_organization_name", value)
...
class IndustrialPidOrganization(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            parent_pid_organization_id: Optional[pulumi.Input[builtins.str]] = None,
            pid_organization_name: Optional[pulumi.Input[builtins.str]] = None) -> 'IndustrialPidOrganization':
        """
    ...
    @property
    @pulumi.getter(name="parentPidOrganizationId")
    def parent_pid_organization_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of parent pid organization.
        """
        return pulumi.get(self, "parent_pid_organization_id")
    ...
    @property
    @pulumi.getter(name="pidOrganizationName")
    def pid_organization_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of pid organization.
        """
        return pulumi.get(self, "pid_organization_name")
