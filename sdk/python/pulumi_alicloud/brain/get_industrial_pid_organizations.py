...
class GetIndustrialPidOrganizationsResult:
    ...
    def parent_organization_id(self) -> Optional[_builtins.str]:
...
def get_industrial_pid_organizations(ids: Optional[Sequence[_builtins.str]] = None,
                                     name_regex: Optional[_builtins.str] = None,
                                     output_file: Optional[_builtins.str] = None,
                                     parent_organization_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Pid Organization IDs.
    :param _builtins.str name_regex: A regex string to filter results by Pid Organization name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str parent_organization_id: The parent organization id.
    """
    __args__ = dict()
    __args__['ids'] = ids
