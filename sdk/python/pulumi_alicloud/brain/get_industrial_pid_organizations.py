...
class GetIndustrialPidOrganizationsResult:
    ...
    def parent_organization_id(self) -> Optional[builtins.str]:
...
def get_industrial_pid_organizations(ids: Optional[Sequence[builtins.str]] = None,
                                     name_regex: Optional[builtins.str] = None,
                                     output_file: Optional[builtins.str] = None,
                                     parent_organization_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Pid Organization IDs.
    :param builtins.str name_regex: A regex string to filter results by Pid Organization name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str parent_organization_id: The parent organization id.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_industrial_pid_organizations_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                            name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                            output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                            parent_organization_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
