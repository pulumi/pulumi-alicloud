...
def get_industrial_serice(enable: Optional[builtins.str] = None,
...
def get_industrial_serice_output(enable: Optional[pulumi.Input[Optional[builtins.str]]] = None,
