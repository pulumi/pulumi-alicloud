...
class IndustrialPidProjectArgs:
    def __init__(__self__, *,
                 pid_organization_id: pulumi.Input[builtins.str],
                 pid_project_name: pulumi.Input[builtins.str],
                 pid_project_desc: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a IndustrialPidProject resource.
        :param pulumi.Input[builtins.str] pid_organization_id: The ID of Pid Organization.
        :param pulumi.Input[builtins.str] pid_project_name: The name of Pid Project.
        :param pulumi.Input[builtins.str] pid_project_desc: The description of Pid Project.
        """
    ...
    def pid_organization_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def pid_organization_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "pid_organization_id", value)

    @property
    @pulumi.getter(name="pidProjectName")
    def pid_project_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def pid_project_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "pid_project_name", value)

    @property
    @pulumi.getter(name="pidProjectDesc")
    def pid_project_desc(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def pid_project_desc(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _IndustrialPidProjectState:
    def __init__(__self__, *,
                 pid_organization_id: Optional[pulumi.Input[builtins.str]] = None,
                 pid_project_desc: Optional[pulumi.Input[builtins.str]] = None,
                 pid_project_name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="pidOrganizationId")
    def pid_organization_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of Pid Organization.
        """
        return pulumi.get(self, "pid_organization_id")
    ...
    @pid_organization_id.setter
    def pid_organization_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pid_organization_id", value)
    ...
    @property
    @pulumi.getter(name="pidProjectName")
    def pid_project_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of Pid Project.
        """
        return pulumi.get(self, "pid_project_name")
    ...
    @pid_project_name.setter
    def pid_project_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pid_project_name", value)


@pulumi.type_token("alicloud:brain/industrialPidProject:IndustrialPidProject")
class IndustrialPidProject(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pid_organization_id: Optional[pulumi.Input[builtins.str]] = None,
            pid_project_desc: Optional[pulumi.Input[builtins.str]] = None,
            pid_project_name: Optional[pulumi.Input[builtins.str]] = None) -> 'IndustrialPidProject':
        """
    ...
    @property
    @pulumi.getter(name="pidOrganizationId")
    def pid_organization_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of Pid Organization.
        """
        return pulumi.get(self, "pid_organization_id")
    ...
    @property
    @pulumi.getter(name="pidProjectDesc")
    def pid_project_desc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of Pid Project.
        """
        return pulumi.get(self, "pid_project_desc")
    ...
    @property
    @pulumi.getter(name="pidProjectName")
    def pid_project_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of Pid Project.
        """
        return pulumi.get(self, "pid_project_name")
