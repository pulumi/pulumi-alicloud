...
def get_topic_subscriptions(name_prefix: Optional[builtins.str] = None,
    ...
    :param builtins.str name_prefix: A string to filter resulting subscriptions of the topic by their name prefixs.
...
def get_topic_subscriptions_output(name_prefix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
