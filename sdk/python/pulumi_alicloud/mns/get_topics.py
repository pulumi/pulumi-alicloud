...
def get_topics(name_prefix: Optional[builtins.str] = None,
    ...
    :param builtins.str name_prefix: A string to filter resulting topics by their name prefixs.
...
def get_topics_output(name_prefix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
