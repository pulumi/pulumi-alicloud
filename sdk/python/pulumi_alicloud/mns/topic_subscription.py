...
class TopicSubscriptionArgs:
    def __init__(__self__, *,
                 ...
                 filter_tag: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 notify_content_format: Optional[pulumi.Input[builtins.str]] = None,
                 notify_strategy: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] topic_name: The topic which The subscription belongs to was named with the name.A topic name must start with an English letter or a digit, and can contain English letters, digits, and hyphens, with the length not exceeding 256 characters.
        :param pulumi.Input[builtins.str] filter_tag: The length should be shorter than 16.
        :param pulumi.Input[builtins.str] name: Two topics subscription on a single account in the same topic cannot have the same name. A topic subscription name must start with an English letter or a digit, and can contain English letters, digits, and hyphens, with the length not exceeding 256 characters.
        :param pulumi.Input[builtins.str] notify_content_format: The NotifyContentFormat attribute of Subscription. This attribute specifies the content format of the messages pushed to users. The valid values: `SIMPLIFIED`, `XML` and `JSON`. Default to `SIMPLIFIED`.
        :param pulumi.Input[builtins.str] notify_strategy: The NotifyStrategy attribute of Subscription. This attribute specifies the retry strategy when message sending fails. The Valid values: `EXPONENTIAL_DECAY_RETRY` and `BACKOFF_RETRY`. Default value to `BACKOFF_RETRY` .
        """
    ...
    def filter_tag(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @filter_tag.setter
    def filter_tag(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def notify_content_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def notify_content_format(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "notify_content_format", value)

    @property
    @pulumi.getter(name="notifyStrategy")
    def notify_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def notify_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("alicloud:mns/topicSubscription:TopicSubscription")
class TopicSubscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            notify_content_format: Optional[pulumi.Input[builtins.str]] = None,
            notify_strategy: Optional[pulumi.Input[builtins.str]] = None,
            topic_name: Optional[pulumi.Input[builtins.str]] = None) -> 'TopicSubscription':
        """
    ...
    @property
    @pulumi.getter(name="filterTag")
    def filter_tag(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The length should be shorter than 16.
        """
        return pulumi.get(self, "filter_tag")
    ...
    @property
    @pulumi.getter(name="notifyContentFormat")
    def notify_content_format(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The NotifyContentFormat attribute of Subscription. This attribute specifies the content format of the messages pushed to users. The valid values: `SIMPLIFIED`, `XML` and `JSON`. Default to `SIMPLIFIED`.
        """
        return pulumi.get(self, "notify_content_format")
    ...
    @property
    @pulumi.getter(name="notifyStrategy")
    def notify_strategy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The NotifyStrategy attribute of Subscription. This attribute specifies the retry strategy when message sending fails. The Valid values: `EXPONENTIAL_DECAY_RETRY` and `BACKOFF_RETRY`. Default value to `BACKOFF_RETRY` .
        """
        return pulumi.get(self, "notify_strategy")
