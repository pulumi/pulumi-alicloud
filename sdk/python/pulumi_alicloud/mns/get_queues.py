...
def get_queues(name_prefix: Optional[builtins.str] = None,
    ...
    :param builtins.str name_prefix: A string to filter resulting queues by their name prefixs.
...
def get_queues_output(name_prefix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:mns/getQueues:getQueues', __args__, opts=opts, typ=GetQueuesResult)
