...
class DomainArgs:
    def __init__(__self__, *,
                 ...
                 is_access_product: pulumi.Input[builtins.str],
                 cluster_type: Optional[pulumi.Input[builtins.str]] = None,
                 connection_time: Optional[pulumi.Input[builtins.int]] = None,
                 domain: Optional[pulumi.Input[builtins.str]] = None,
                 domain_name: Optional[pulumi.Input[builtins.str]] = None,
                 http2_ports: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 http_ports: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 http_to_user_ip: Optional[pulumi.Input[builtins.str]] = None,
                 https_ports: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 https_redirect: Optional[pulumi.Input[builtins.str]] = None,
                 load_balancing: Optional[pulumi.Input[builtins.str]] = None,
                 log_headers: Optional[pulumi.Input[Sequence[pulumi.Input['DomainLogHeaderArgs']]]] = None,
                 read_time: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 write_time: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Domain resource.
        :param pulumi.Input[builtins.str] instance_id: The ID of the WAF instance.
        :param pulumi.Input[builtins.str] is_access_product: Specifies whether to configure a Layer-7 proxy, such as Anti-DDoS Pro or CDN, to filter the inbound traffic before it is forwarded to WAF. Valid values: `On` and `Off`. Default to `Off`.
        :param pulumi.Input[builtins.str] cluster_type: The type of the WAF cluster. Valid values: `PhysicalCluster` and `VirtualCluster`. Default to `PhysicalCluster`.
        :param pulumi.Input[builtins.int] connection_time: The connection timeout for WAF exclusive clusters. Unit: seconds.
        :param pulumi.Input[builtins.str] domain: Field `domain` has been deprecated from version 1.94.0. Use `domain_name` instead.
        :param pulumi.Input[builtins.str] domain_name: The domain that you want to add to WAF. The `domain_name` is required when the value of the `domain`  is Empty.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] http2_ports: List of the HTTP 2.0 ports.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] http_ports: List of the HTTP ports.
        :param pulumi.Input[builtins.str] http_to_user_ip: Specifies whether to enable the HTTP back-to-origin feature. After this feature is enabled, the WAF instance can use HTTP to forward HTTPS requests to the origin server. 
               By default, port 80 is used to forward the requests to the origin server. Valid values: `On` and `Off`. Default to `Off`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] https_ports: List of the HTTPS ports.
        :param pulumi.Input[builtins.str] https_redirect: Specifies whether to redirect HTTP requests as HTTPS requests. Valid values: "On" and `Off`. Default to `Off`.
        :param pulumi.Input[builtins.str] load_balancing: The load balancing algorithm that is used to forward requests to the origin. Valid values: `IpHash` and `RoundRobin`. Default to `IpHash`.
        ...
        :param pulumi.Input[builtins.int] read_time: The read timeout of a WAF exclusive cluster. Unit: seconds.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the queried domain belongs in Resource Management. By default, no value is specified, indicating that the domain belongs to the default resource group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_ips: List of the IP address or domain of the origin server to which the specified domain points.
        :param pulumi.Input[builtins.int] write_time: The timeout period for a WAF exclusive cluster write connection. Unit: seconds.
        """
    ...
    def is_access_product(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def is_access_product(self, value: pulumi.Input[builtins.str]):
    ...
    def connection_time(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def connection_time(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def http2_ports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @http2_ports.setter
    def http2_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "http2_ports", value)

    @property
    @pulumi.getter(name="httpPorts")
    def http_ports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @http_ports.setter
    def http_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "http_ports", value)

    @property
    @pulumi.getter(name="httpToUserIp")
    def http_to_user_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def http_to_user_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "http_to_user_ip", value)

    @property
    @pulumi.getter(name="httpsPorts")
    def https_ports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @https_ports.setter
    def https_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "https_ports", value)

    @property
    @pulumi.getter(name="httpsRedirect")
    def https_redirect(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def https_redirect(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "https_redirect", value)

    @property
    @pulumi.getter(name="loadBalancing")
    def load_balancing(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def load_balancing(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def read_time(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @read_time.setter
    def read_time(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def write_time(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @write_time.setter
    def write_time(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _DomainState:
    def __init__(__self__, *,
                 ...
                 is_access_product: Optional[pulumi.Input[builtins.str]] = None,
                 load_balancing: Optional[pulumi.Input[builtins.str]] = None,
                 log_headers: Optional[pulumi.Input[Sequence[pulumi.Input['DomainLogHeaderArgs']]]] = None,
                 read_time: Optional[pulumi.Input[builtins.int]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_type: The type of the WAF cluster. Valid values: `PhysicalCluster` and `VirtualCluster`. Default to `PhysicalCluster`.
        :param pulumi.Input[builtins.str] cname: The CNAME record assigned by the WAF instance to the specified domain.
        :param pulumi.Input[builtins.int] connection_time: The connection timeout for WAF exclusive clusters. Unit: seconds.
        :param pulumi.Input[builtins.str] domain: Field `domain` has been deprecated from version 1.94.0. Use `domain_name` instead.
        :param pulumi.Input[builtins.str] domain_name: The domain that you want to add to WAF. The `domain_name` is required when the value of the `domain`  is Empty.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] http2_ports: List of the HTTP 2.0 ports.
    ...
    @property
    @pulumi.getter(name="isAccessProduct")
    def is_access_product(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies whether to configure a Layer-7 proxy, such as Anti-DDoS Pro or CDN, to filter the inbound traffic before it is forwarded to WAF. Valid values: `On` and `Off`. Default to `Off`.
        """
        return pulumi.get(self, "is_access_product")
    ...
    @is_access_product.setter
    def is_access_product(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "is_access_product", value)
...
class Domain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            source_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            write_time: Optional[pulumi.Input[builtins.int]] = None) -> 'Domain':
        """
    ...
    @property
    @pulumi.getter(name="connectionTime")
    def connection_time(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The connection timeout for WAF exclusive clusters. Unit: seconds.
        """
        return pulumi.get(self, "connection_time")
    ...
    @property
    @pulumi.getter(name="http2Ports")
    def http2_ports(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of the HTTP 2.0 ports.
        """
        return pulumi.get(self, "http2_ports")
    ...
    @property
    @pulumi.getter(name="httpPorts")
    def http_ports(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of the HTTP ports.
        """
        return pulumi.get(self, "http_ports")
    ...
    @property
    @pulumi.getter(name="httpToUserIp")
    def http_to_user_ip(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether to enable the HTTP back-to-origin feature. After this feature is enabled, the WAF instance can use HTTP to forward HTTPS requests to the origin server. 
        By default, port 80 is used to forward the requests to the origin server. Valid values: `On` and `Off`. Default to `Off`.
        """
    ...
    @property
    @pulumi.getter(name="httpsPorts")
    def https_ports(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of the HTTPS ports.
        """
        return pulumi.get(self, "https_ports")
    ...
    @property
    @pulumi.getter(name="httpsRedirect")
    def https_redirect(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether to redirect HTTP requests as HTTPS requests. Valid values: "On" and `Off`. Default to `Off`.
        """
        return pulumi.get(self, "https_redirect")
    ...
    @property
    @pulumi.getter(name="isAccessProduct")
    def is_access_product(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether to configure a Layer-7 proxy, such as Anti-DDoS Pro or CDN, to filter the inbound traffic before it is forwarded to WAF. Valid values: `On` and `Off`. Default to `Off`.
        """
        return pulumi.get(self, "is_access_product")
    ...
    @property
    @pulumi.getter(name="loadBalancing")
    def load_balancing(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The load balancing algorithm that is used to forward requests to the origin. Valid values: `IpHash` and `RoundRobin`. Default to `IpHash`.
        """
        return pulumi.get(self, "load_balancing")
    ...
    @property
    @pulumi.getter(name="readTime")
    def read_time(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The read timeout of a WAF exclusive cluster. Unit: seconds.
        """
        return pulumi.get(self, "read_time")
    ...
    @property
    @pulumi.getter(name="sourceIps")
    def source_ips(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of the IP address or domain of the origin server to which the specified domain points.
        """
        return pulumi.get(self, "source_ips")
    ...
    @property
    @pulumi.getter(name="writeTime")
    def write_time(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The timeout period for a WAF exclusive cluster write connection. Unit: seconds.
        """
        return pulumi.get(self, "write_time")
