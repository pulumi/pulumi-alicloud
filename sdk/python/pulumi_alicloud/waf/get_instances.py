...
def get_instances(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of WAF instance IDs.
    :param builtins.str instance_source: The source of the WAF instance.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str resource_group_id: The ID of resource group to which WAF instance belongs.
