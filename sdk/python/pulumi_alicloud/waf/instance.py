...
class InstanceArgs:
    def __init__(__self__, *,
                 big_screen: pulumi.Input[builtins.str],
                 exclusive_ip_package: pulumi.Input[builtins.str],
                 ext_bandwidth: pulumi.Input[builtins.str],
                 ext_domain_package: pulumi.Input[builtins.str],
                 log_storage: pulumi.Input[builtins.str],
                 log_time: pulumi.Input[builtins.str],
                 package_code: pulumi.Input[builtins.str],
                 prefessional_service: pulumi.Input[builtins.str],
                 subscription_type: pulumi.Input[builtins.str],
                 waf_log: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] big_screen: Specify whether big screen is supported. Valid values: ["0", "1"]. "0" for false and "1" for true.
        :param pulumi.Input[builtins.str] exclusive_ip_package: Specify the number of exclusive WAF IP addresses.
        :param pulumi.Input[builtins.str] ext_bandwidth: The extra bandwidth. Unit: Mbit/s.
        :param pulumi.Input[builtins.str] ext_domain_package: The number of extra domains.
        :param pulumi.Input[builtins.str] log_storage: Log storage size. Unit: T. Valid values: [3, 5, 10, 20, 50].
        :param pulumi.Input[builtins.str] log_time: Log storage period. Unit: day. Valid values: [180, 360].
        :param pulumi.Input[builtins.str] package_code: Subscription plan:
        ...
        :param pulumi.Input[builtins.str] prefessional_service: Specify whether professional service is supported. Valid values: ["true", "false"]
        :param pulumi.Input[builtins.str] subscription_type: Subscription of WAF service. Valid values: ["Subscription", "PayAsYouGo"].
        :param pulumi.Input[builtins.str] waf_log: Specify whether Log service is supported. Valid values: ["true", "false"]
        :param pulumi.Input[builtins.str] modify_type: Type of configuration change. Valid value: Upgrade.
        :param pulumi.Input[builtins.int] period: Service time of Web Application Firewall.
        :param pulumi.Input[builtins.str] region: The instance region ID.
        :param pulumi.Input[builtins.int] renew_period: Renewal period of WAF service. Unit: month
        :param pulumi.Input[builtins.str] renewal_status: Renewal status of WAF service. Valid values: 
    ...
    def big_screen(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @big_screen.setter
    def big_screen(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "big_screen", value)

    @property
    @pulumi.getter(name="exclusiveIpPackage")
    def exclusive_ip_package(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def exclusive_ip_package(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "exclusive_ip_package", value)

    @property
    @pulumi.getter(name="extBandwidth")
    def ext_bandwidth(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ext_bandwidth(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ext_bandwidth", value)

    @property
    @pulumi.getter(name="extDomainPackage")
    def ext_domain_package(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ext_domain_package(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ext_domain_package", value)

    @property
    @pulumi.getter(name="logStorage")
    def log_storage(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @log_storage.setter
    def log_storage(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "log_storage", value)

    @property
    @pulumi.getter(name="logTime")
    def log_time(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @log_time.setter
    def log_time(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "log_time", value)

    @property
    @pulumi.getter(name="packageCode")
    def package_code(self) -> pulumi.Input[builtins.str]:
        """
        Subscription plan:
        * China site customers can purchase the following versions of China Mainland region, valid values: ["version_3", "version_4", "version_5"].
        * China site customers can purchase the following versions of International region, valid values: ["version_pro_asia", "version_business_asia", "version_enterprise_asia"]
    ...
    @package_code.setter
    def package_code(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "package_code", value)

    @property
    @pulumi.getter(name="prefessionalService")
    def prefessional_service(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def prefessional_service(self, value: pulumi.Input[builtins.str]):
    ...
    def waf_log(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @waf_log.setter
    def waf_log(self, value: pulumi.Input[builtins.str]):
...
class _InstanceState:
    def __init__(__self__, *,
                 big_screen: Optional[pulumi.Input[builtins.str]] = None,
                 exclusive_ip_package: Optional[pulumi.Input[builtins.str]] = None,
                 ext_bandwidth: Optional[pulumi.Input[builtins.str]] = None,
                 ext_domain_package: Optional[pulumi.Input[builtins.str]] = None,
                 log_storage: Optional[pulumi.Input[builtins.str]] = None,
                 log_time: Optional[pulumi.Input[builtins.str]] = None,
                 modify_type: Optional[pulumi.Input[builtins.str]] = None,
                 package_code: Optional[pulumi.Input[builtins.str]] = None,
                 period: Optional[pulumi.Input[builtins.int]] = None,
                 prefessional_service: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 renew_period: Optional[pulumi.Input[builtins.int]] = None,
                 renewal_status: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 waf_log: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="bigScreen")
    def big_screen(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specify whether big screen is supported. Valid values: ["0", "1"]. "0" for false and "1" for true.
        """
        return pulumi.get(self, "big_screen")
    ...
    @big_screen.setter
    def big_screen(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "big_screen", value)

    @property
    @pulumi.getter(name="exclusiveIpPackage")
    def exclusive_ip_package(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specify the number of exclusive WAF IP addresses.
        """
        return pulumi.get(self, "exclusive_ip_package")
    ...
    @exclusive_ip_package.setter
    def exclusive_ip_package(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "exclusive_ip_package", value)

    @property
    @pulumi.getter(name="extBandwidth")
    def ext_bandwidth(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The extra bandwidth. Unit: Mbit/s.
        """
        return pulumi.get(self, "ext_bandwidth")
    ...
    @ext_bandwidth.setter
    def ext_bandwidth(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ext_bandwidth", value)

    @property
    @pulumi.getter(name="extDomainPackage")
    def ext_domain_package(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The number of extra domains.
        """
        return pulumi.get(self, "ext_domain_package")
    ...
    @ext_domain_package.setter
    def ext_domain_package(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ext_domain_package", value)

    @property
    @pulumi.getter(name="logStorage")
    def log_storage(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Log storage size. Unit: T. Valid values: [3, 5, 10, 20, 50].
        """
        return pulumi.get(self, "log_storage")
    ...
    @log_storage.setter
    def log_storage(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_storage", value)

    @property
    @pulumi.getter(name="logTime")
    def log_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Log storage period. Unit: day. Valid values: [180, 360].
        """
        return pulumi.get(self, "log_time")
    ...
    @log_time.setter
    def log_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_time", value)
    ...
    @property
    @pulumi.getter(name="packageCode")
    def package_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Subscription plan:
        * China site customers can purchase the following versions of China Mainland region, valid values: ["version_3", "version_4", "version_5"].
        * China site customers can purchase the following versions of International region, valid values: ["version_pro_asia", "version_business_asia", "version_enterprise_asia"]
    ...
    @package_code.setter
    def package_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "package_code", value)
    ...
    @property
    @pulumi.getter(name="prefessionalService")
    def prefessional_service(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specify whether professional service is supported. Valid values: ["true", "false"]
        """
        return pulumi.get(self, "prefessional_service")
    ...
    @prefessional_service.setter
    def prefessional_service(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "prefessional_service", value)
    ...
    @property
    @pulumi.getter(name="wafLog")
    def waf_log(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specify whether Log service is supported. Valid values: ["true", "false"]
        """
        return pulumi.get(self, "waf_log")
    ...
    @waf_log.setter
    def waf_log(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "waf_log", value)
...
class Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.int]] = None,
            subscription_type: Optional[pulumi.Input[builtins.str]] = None,
            waf_log: Optional[pulumi.Input[builtins.str]] = None) -> 'Instance':
        """
    ...
    @property
    @pulumi.getter(name="bigScreen")
    def big_screen(self) -> pulumi.Output[builtins.str]:
        """
        Specify whether big screen is supported. Valid values: ["0", "1"]. "0" for false and "1" for true.
        """
        return pulumi.get(self, "big_screen")
    ...
    @property
    @pulumi.getter(name="exclusiveIpPackage")
    def exclusive_ip_package(self) -> pulumi.Output[builtins.str]:
        """
        Specify the number of exclusive WAF IP addresses.
        """
        return pulumi.get(self, "exclusive_ip_package")
    ...
    @property
    @pulumi.getter(name="extBandwidth")
    def ext_bandwidth(self) -> pulumi.Output[builtins.str]:
        """
        The extra bandwidth. Unit: Mbit/s.
        """
        return pulumi.get(self, "ext_bandwidth")
    ...
    @property
    @pulumi.getter(name="extDomainPackage")
    def ext_domain_package(self) -> pulumi.Output[builtins.str]:
        """
        The number of extra domains.
        """
        return pulumi.get(self, "ext_domain_package")
    ...
    @property
    @pulumi.getter(name="logStorage")
    def log_storage(self) -> pulumi.Output[builtins.str]:
        """
        Log storage size. Unit: T. Valid values: [3, 5, 10, 20, 50].
        """
        return pulumi.get(self, "log_storage")
    ...
    @property
    @pulumi.getter(name="logTime")
    def log_time(self) -> pulumi.Output[builtins.str]:
        """
        Log storage period. Unit: day. Valid values: [180, 360].
        """
        return pulumi.get(self, "log_time")
    ...
    @property
    @pulumi.getter(name="packageCode")
    def package_code(self) -> pulumi.Output[builtins.str]:
        """
        Subscription plan:
        * China site customers can purchase the following versions of China Mainland region, valid values: ["version_3", "version_4", "version_5"].
        * China site customers can purchase the following versions of International region, valid values: ["version_pro_asia", "version_business_asia", "version_enterprise_asia"]
    ...
    @property
    @pulumi.getter(name="prefessionalService")
    def prefessional_service(self) -> pulumi.Output[builtins.str]:
        """
        Specify whether professional service is supported. Valid values: ["true", "false"]
        """
        return pulumi.get(self, "prefessional_service")
    ...
    @property
    @pulumi.getter(name="wafLog")
    def waf_log(self) -> pulumi.Output[builtins.str]:
        """
        Specify whether Log service is supported. Valid values: ["true", "false"]
        """
        return pulumi.get(self, "waf_log")
