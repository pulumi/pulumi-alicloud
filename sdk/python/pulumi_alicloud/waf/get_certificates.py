...
def get_certificates(domain: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Certificate IDs.
    :param _builtins.str instance_id: WAF instance ID.
    :param _builtins.str name_regex: A regex string to filter results by Certificate name.
...
def get_certificates_output(domain: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
