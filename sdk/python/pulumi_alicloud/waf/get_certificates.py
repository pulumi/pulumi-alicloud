...
def get_certificates(domain: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Certificate IDs.
    :param builtins.str instance_id: WAF instance ID.
    :param builtins.str name_regex: A regex string to filter results by Certificate name.
...
def get_certificates_output(domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
