...
def get_domains(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.bool enable_details: Default to false and only output `id`, `domain_name`. Set it to true can output more details.
    :param Sequence[builtins.str] ids: A list of WAF domain names. Each item is domain name.
    :param builtins.str instance_id: The Id of waf instance to which waf domain belongs.
