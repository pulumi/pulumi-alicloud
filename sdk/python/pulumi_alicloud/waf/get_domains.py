...
def get_domains(enable_details: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool enable_details: Default to false and only output `id`, `domain_name`. Set it to true can output more details.
    :param Sequence[_builtins.str] ids: A list of WAF domain names. Each item is domain name.
    :param _builtins.str instance_id: The Id of waf instance to which waf domain belongs.
