...
class AuditLogConfigArgs:
    def __init__(__self__, *,
                 ...
                 db_audit: Optional[pulumi.Input[builtins.bool]] = None,
                 retention: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a AuditLogConfig resource.
        :param pulumi.Input[builtins.str] instance_id: Instance ID, Call the Describeinstances Get.
        :param pulumi.Input[builtins.bool] db_audit: Indicates Whether to Enable the Audit Log.  Valid value: 
        ...
        :param pulumi.Input[builtins.int] retention: Audit Log Retention Period Value: 1~365. 
    ...
    def db_audit(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @db_audit.setter
    def db_audit(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AuditLogConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            retention: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'AuditLogConfig':
        """
    ...
    @property
    @pulumi.getter(name="dbAudit")
    def db_audit(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates Whether to Enable the Audit Log.  Valid value: 
        * true: Default Value, Open.
        * false: Closed.
