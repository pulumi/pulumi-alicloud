...
class BackupPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The id of Tair (Redis OSS-Compatible) And Memcache (KVStore) Instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] backup_periods: Backup Cycle. Allowed values: Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday.
        :param pulumi.Input[builtins.str] backup_time: Backup time, in the format of HH:mmZ- HH:mm Z.
        """
...
class BackupPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            backup_periods: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            backup_time: Optional[pulumi.Input[builtins.str]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BackupPolicy':
        """
    ...
    @property
    @pulumi.getter(name="backupTime")
    def backup_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Backup time, in the format of HH:mmZ- HH:mm Z.
        """
        return pulumi.get(self, "backup_time")
