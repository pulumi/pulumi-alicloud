...
class GetInstancesResult:
    ...
    def architecture_type(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def expired(self) -> Optional[builtins.str]:
        return pulumi.get(self, "expired")

    @property
    @pulumi.getter(name="globalInstance")
    def global_instance(self) -> Optional[builtins.bool]:
...
def get_instances(architecture_type: Optional[builtins.str] = None,
                  ...
                  expired: Optional[builtins.str] = None,
                  global_instance: Optional[builtins.bool] = None,
    ...
    :param builtins.str edition_type: Used to retrieve instances belong to specified `vswitch` resources.  Valid values: `Enterprise`, `Community`.
    ...
    :param builtins.str expired: The expiration status of the instance.
    :param builtins.bool global_instance: Whether to create a distributed cache.
    :param Sequence[builtins.str] ids: A list of KVStore DBInstance IDs.
...
def get_instances_output(architecture_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         ...
                         expired: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         global_instance: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
