...
def get_connections(ids: Optional[builtins.str] = None,
    ...
    :param builtins.str ids: A list of Tair (Redis OSS-Compatible) And Memcache (KVStore) Instance ids, only support one item.
...
def get_connections_output(ids: Optional[pulumi.Input[builtins.str]] = None,
