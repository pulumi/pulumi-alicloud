...
class GetInstanceClassesResult:
    ...
    def edition_type(self) -> Optional[builtins.str]:
    ...
    def instance_classes(self) -> Sequence[builtins.str]:
        """
    ...
    def series_type(self) -> Optional[builtins.str]:
        return pulumi.get(self, "series_type")

    @property
    @pulumi.getter(name="shardNumber")
    def shard_number(self) -> Optional[builtins.int]:
...
def get_instance_classes(architecture: Optional[builtins.str] = None,
                         edition_type: Optional[builtins.str] = None,
                         ...
                         series_type: Optional[builtins.str] = None,
                         shard_number: Optional[builtins.int] = None,
    ...
    :param builtins.str architecture: The Tair (Redis OSS-Compatible) And Memcache (KVStore) Instance system architecture required by the user. Valid values: `standard`, `cluster` and `rwsplit`.
    :param builtins.str edition_type: The Tair (Redis OSS-Compatible) And Memcache (KVStore) Instance edition type required by the user. Valid values: `Community` and `Enterprise`.
    ...
    :param builtins.str instance_charge_type: Filter the results by charge type. Valid values: `PrePaid` and `PostPaid`. Default to `PrePaid`.
    :param builtins.str node_type: The Tair (Redis OSS-Compatible) And Memcache (KVStore) Instance node type required by the user. Valid values: `double`, `single`, `readone`, `readthree` and `readfive`.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi up`).
    :param builtins.str package_type: It has been deprecated from 1.68.0.
    :param builtins.str performance_type: It has been deprecated from 1.68.0.
    :param builtins.str product_type: The type of the service. Valid values:
    ...
    :param builtins.str series_type: The Tair (Redis OSS-Compatible) And Memcache (KVStore) Instance series type required by the user. Valid values: `enhanced_performance_type` and `hybrid_storage`.
    :param builtins.int shard_number: The number of shard.Valid values: `1`, `2`, `4`, `8`, `16`, `32`, `64`, `128`, `256`.
    :param builtins.str storage_type: It has been deprecated from 1.68.0.
...
def get_instance_classes_output(architecture: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                edition_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                series_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                shard_number: Optional[pulumi.Input[Optional[builtins.int]]] = None,
