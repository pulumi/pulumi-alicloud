...
class ConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_string_prefix: The prefix of the public endpoint. The prefix can be 8 to 64 characters in length, and can contain lowercase letters and digits. It must start with a lowercase letter.
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] port: The service port number of the instance.
        """
...
class _ConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_string: The public connection string of Tair (Redis OSS-Compatible) And Memcache (KVStore) Instance.
        :param pulumi.Input[builtins.str] connection_string_prefix: The prefix of the public endpoint. The prefix can be 8 to 64 characters in length, and can contain lowercase letters and digits. It must start with a lowercase letter.
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] port: The service port number of the instance.
        """
