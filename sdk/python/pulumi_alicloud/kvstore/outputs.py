...
class GetInstanceEnginesInstanceEngineResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str engine_version: Database version required by the user. Value options of Redis can refer to the latest docs [detail info](https://www.alibabacloud.com/help/doc-detail/60873.htm) `EngineVersion`. Value of Memcache should be empty.
