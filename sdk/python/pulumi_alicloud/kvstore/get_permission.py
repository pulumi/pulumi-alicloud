...
def get_permission(enable: Optional[builtins.str] = None,
    ...
    :param builtins.str enable: Setting the value to `On` to assigns a RAM role to Tair (Redis OSS-Compatible) And Memcache (KVStore). If has been enabled, return the result. Valid values: "On" or "Off". Default to "Off".
    """
    __args__ = dict()
...
def get_permission_output(enable: Optional[pulumi.Input[Optional[builtins.str]]] = None,
