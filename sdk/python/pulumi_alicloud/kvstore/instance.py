...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] availability_zone: (Deprecated since v1.101.0) It has been deprecated from provider version 1.101.0 and `zone_id` instead.
        ...
        :param pulumi.Input[str] connection_string_prefix: (Deprecated since v1.101.0) It has been deprecated from provider version 1.101.0 and resource `kvstore.Connection` instead.
        ...
        :param pulumi.Input[bool] enable_public: (Deprecated since v1.101.0) It has been deprecated from provider version 1.101.0 and resource `kvstore.Connection` instead.
        ...
        :param pulumi.Input[str] instance_charge_type: (Deprecated since v1.101.0) It has been deprecated from provider version 1.101.0 and `payment_type` instead.
        ...
        :param pulumi.Input[str] instance_name: (Deprecated since v1.101.0) It has been deprecated from provider version 1.101.0 and `db_instance_name` instead.
        ...
        :param pulumi.Input[str] node_type: (Deprecated since v1.120.1) "Field `node_type` has been deprecated from version 1.120.1". This parameter is determined by the `instance_class`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceParameterArgs']]] parameters: (Deprecated since v1.101.0) It has been deprecated from provider version 1.101.0 and `config` instead. See `parameters` below.
...
class Instance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] node_type: (Deprecated since v1.120.1) "Field `node_type` has been deprecated from version 1.120.1". This parameter is determined by the `instance_class`.
        :param pulumi.Input[str] order_type: Specifies a change type when you change the configuration of a subscription instance. Valid values: `UPGRADE`, `DOWNGRADE`. Default value: `UPGRADE`. `UPGRADE` means upgrades the configuration of a subscription instance. `DOWNGRADE` means downgrades the configuration of a subscription instance.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceParameterArgs']]]] parameters: (Deprecated since v1.101.0) It has been deprecated from provider version 1.101.0 and `config` instead. See `parameters` below.
        :param pulumi.Input[str] password: The password of the KVStore DBInstance. The password that is used to connect to the instance. The password must be 8 to 32 characters in length and must contain at least three of the following character types: uppercase letters, lowercase letters, special characters, and digits. Special characters include: `! @ # $ % ^ & * ( ) _ + - =`
        :param pulumi.Input[str] payment_type: The billing method of the KVStore DBInstance. Valid values: `PrePaid`, `PostPaid`. Default value: `PostPaid`.
        :param pulumi.Input[str] period: The duration that you will buy KVStore DBInstance (in month). It is valid when payment_type is `PrePaid`. Valid values: `[1~9]`, `12`, `24`, `36`.
        :param pulumi.Input[int] port: It has been deprecated from provider version 1.101.0 and resource `kvstore.Connection` instead.
