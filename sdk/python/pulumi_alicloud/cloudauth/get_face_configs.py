...
def get_face_configs(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Face Config IDs.
    :param builtins.str name_regex: A regex string to filter results by biz_name.
...
def get_face_configs_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
