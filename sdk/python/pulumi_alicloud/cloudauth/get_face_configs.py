...
class GetFaceConfigsResult:
    ...
    """
    def __init__(__self__, configs=None, id=None, ids=None, name_regex=None, names=None, output_file=None):
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> Sequence['outputs.GetFaceConfigsConfigResult']:
...
class AwaitableGetFaceConfigsResult(GetFaceConfigsResult):
...
def get_face_configs(ids: Optional[Sequence[_builtins.str]] = None,
                     name_regex: Optional[_builtins.str] = None,
                     output_file: Optional[_builtins.str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFaceConfigsResult:
    """
    ...
    :param Sequence[_builtins.str] ids: A list of Face Config IDs.
    :param _builtins.str name_regex: A regex string to filter results by biz_name.
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:cloudauth/getFaceConfigs:getFaceConfigs', __args__, opts=opts, typ=GetFaceConfigsResult).value

    return AwaitableGetFaceConfigsResult(
...
def get_face_configs_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
