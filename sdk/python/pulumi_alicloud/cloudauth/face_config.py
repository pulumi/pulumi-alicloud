...
class FaceConfigArgs:
    def __init__(__self__, *,
                 biz_name: pulumi.Input[builtins.str],
                 biz_type: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a FaceConfig resource.
        :param pulumi.Input[builtins.str] biz_name: Scene name.
        :param pulumi.Input[builtins.str] biz_type: Scene type. **NOTE:** The biz_type cannot exceed 32 characters and can only use English letters, numbers and dashes (-).
        """
    ...
    def biz_name(self) -> pulumi.Input[builtins.str]:
        """
        Scene name.
        """
    ...
    @biz_name.setter
    def biz_name(self, value: pulumi.Input[builtins.str]):
...
class _FaceConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] biz_name: Scene name.
        :param pulumi.Input[builtins.str] biz_type: Scene type. **NOTE:** The biz_type cannot exceed 32 characters and can only use English letters, numbers and dashes (-).
        :param pulumi.Input[builtins.str] gmt_modified: Last Modified Date.
        """
...
class FaceConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            biz_name: Optional[pulumi.Input[builtins.str]] = None,
            biz_type: Optional[pulumi.Input[builtins.str]] = None,
            gmt_modified: Optional[pulumi.Input[builtins.str]] = None) -> 'FaceConfig':
        """
    ...
    @property
    @pulumi.getter(name="bizName")
    def biz_name(self) -> pulumi.Output[builtins.str]:
        """
        Scene name.
        """
        return pulumi.get(self, "biz_name")
