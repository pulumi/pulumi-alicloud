...
class FaceConfigArgs:
    def __init__(__self__, *,
                 biz_name: pulumi.Input[_builtins.str],
    ...
    def biz_name(self) -> pulumi.Input[_builtins.str]:
        """
        Scene name.
        """
    ...
    @biz_name.setter
    def biz_name(self, value: pulumi.Input[_builtins.str]):
...
class FaceConfig(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="bizName")
    def biz_name(self) -> pulumi.Output[_builtins.str]:
        """
        Scene name.
        """
        return pulumi.get(self, "biz_name")
