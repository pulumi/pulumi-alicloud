...
class RegistryEnterpriseNamespaceArgs:
    def __init__(__self__, *,
                 ...
                 auto_create: Optional[pulumi.Input[builtins.bool]] = None,
                 default_visibility: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RegistryEnterpriseNamespace resource.
        :param pulumi.Input[builtins.str] instance_id: The ID of the Container Registry Enterprise Edition instance.
        :param pulumi.Input[builtins.bool] auto_create: Specifies whether to automatically create an image repository in the namespace. Default value: `false`. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] default_visibility: The default type of the repository that is automatically created. Valid values:
               - `PUBLIC`: A public repository.
               - `PRIVATE`: A private repository.
        :param pulumi.Input[builtins.str] name: The name of the Container Registry Enterprise Edition Name. It must be `2` to `120` characters in length, and can contain lowercase letters, digits, underscores (_), hyphens (-), and periods (.). It cannot start or end with a delimiter.
        """
    ...
    def auto_create(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @auto_create.setter
    def auto_create(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_create", value)

    @property
    @pulumi.getter(name="defaultVisibility")
    def default_visibility(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_visibility(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RegistryEnterpriseNamespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            default_visibility: Optional[pulumi.Input[builtins.str]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'RegistryEnterpriseNamespace':
        """
    ...
    @property
    @pulumi.getter(name="autoCreate")
    def auto_create(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to automatically create an image repository in the namespace. Default value: `false`. Valid values: `true`, `false`.
        """
        return pulumi.get(self, "auto_create")
    ...
    @property
    @pulumi.getter(name="defaultVisibility")
    def default_visibility(self) -> pulumi.Output[builtins.str]:
        """
        The default type of the repository that is automatically created. Valid values:
        - `PUBLIC`: A public repository.
        - `PRIVATE`: A private repository.
