...
if not MYPY:
    class ClusterNodeArgsDict(TypedDict):
        eip: NotRequired[pulumi.Input[builtins.str]]
        id: NotRequired[pulumi.Input[builtins.str]]
        name: NotRequired[pulumi.Input[builtins.str]]
...
class EdgeKubernetesAddonArgs:
    def __init__(__self__, *,
                 ...
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] config: The ACK add-on configurations. For more config information, see cs_kubernetes_addon_metadata.
        :param pulumi.Input[builtins.bool] disabled: Disables the automatic installation of a component. Default is `false`.
               ...
               ```
        :param pulumi.Input[builtins.str] name: Name of the ACK add-on. The name must match one of the names returned by [DescribeAddons](https://help.aliyun.com/document_detail/171524.html).
        :param pulumi.Input[builtins.str] version: It specifies the version of the component.
        """
...
class EdgeKubernetesCertificateAuthorityArgs:
    ...
    def cluster_cert(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The base64 encoded cluster certificate data required to communicate with your cluster. Add this to the certificate-authority-data section of the kubeconfig file for your cluster.
        """
    ...
    @cluster_cert.setter
    def cluster_cert(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cluster_cert", value)


if not MYPY:
    class EdgeKubernetesConnectionsArgsDict(TypedDict):
        api_server_internet: NotRequired[pulumi.Input[builtins.str]]
        """
        API Server Internet endpoint.
        """
        api_server_intranet: NotRequired[pulumi.Input[builtins.str]]
        """
        API Server Intranet endpoint.
        """
        master_public_ip: NotRequired[pulumi.Input[builtins.str]]
        """
        Master node SSH IP address.
        """
        service_domain: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EdgeKubernetesConnectionsArgs:
    def __init__(__self__, *,
                 api_server_internet: Optional[pulumi.Input[builtins.str]] = None,
                 api_server_intranet: Optional[pulumi.Input[builtins.str]] = None,
                 master_public_ip: Optional[pulumi.Input[builtins.str]] = None,
                 service_domain: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] api_server_internet: API Server Internet endpoint.
        :param pulumi.Input[builtins.str] api_server_intranet: API Server Intranet endpoint.
        :param pulumi.Input[builtins.str] master_public_ip: Master node SSH IP address.
        :param pulumi.Input[builtins.str] service_domain: Service Access Domain.
        """
    ...
    def api_server_internet(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        API Server Internet endpoint.
        """
    ...
    def api_server_internet(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "api_server_internet", value)

    @property
    @pulumi.getter(name="apiServerIntranet")
    def api_server_intranet(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        API Server Intranet endpoint.
        """
    ...
    def api_server_intranet(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "api_server_intranet", value)

    @property
    @pulumi.getter(name="masterPublicIp")
    def master_public_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Master node SSH IP address.
        """
    ...
    def master_public_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EdgeKubernetesLogConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Type of collecting logs, only `SLS` are supported currently.
        :param pulumi.Input[builtins.str] project: Log Service project name, cluster logs will output to this project.
        """
...
class EdgeKubernetesRuntimeArgs:
    def __init__(__self__, *,
                 ...
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the runtime. Supported runtimes can be queried by data source alicloud_cs_kubernetes_version.
        :param pulumi.Input[builtins.str] version: The version of the runtime.
...
class EdgeKubernetesWorkerDataDiskArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] auto_snapshot_policy_id: Worker node data disk auto snapshot policy.
        :param pulumi.Input[builtins.str] category: The type of the data disks. Valid values: `cloud`, `cloud_efficiency`, `cloud_ssd` and `cloud_essd`. Default to `cloud_efficiency`.
        :param pulumi.Input[builtins.str] device: The device of the data disks.
        :param pulumi.Input[builtins.str] encrypted: Specifies whether to encrypt data disks. Valid values: true and false. Default is `false`.
        :param pulumi.Input[builtins.str] kms_key_id: The id of the kms key.
        :param pulumi.Input[builtins.str] name: The name of the data disks.
        :param pulumi.Input[builtins.str] performance_level: Worker node data disk performance level, when `category` values `cloud_essd`, the optional values are `PL0`, `PL1`, `PL2` or `PL3`, but the specific performance level is related to the disk capacity. For more information, see [Enhanced SSDs](https://www.alibabacloud.com/help/doc-detail/122389.htm). Default is `PL1`.
        :param pulumi.Input[builtins.str] size: The size of a data disk, at least 40. Unit: GiB.
        :param pulumi.Input[builtins.str] snapshot_id: The id of snapshot.
        """
...
class EdgeKubernetesWorkerNodeArgs:
    def __init__(__self__, *,
                 ...
                 private_ip: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] id: ID of the node.
        :param pulumi.Input[builtins.str] name: The kubernetes cluster's name. It is unique in one Alicloud account.
        :param pulumi.Input[builtins.str] private_ip: The private IP address of node.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if name is not None:
...
if not MYPY:
    class KubernetesAutoscalerNodepoolArgsDict(TypedDict):
        ...
        """
        taints: NotRequired[pulumi.Input[builtins.str]]
        """
...
class KubernetesAutoscalerNodepoolArgs:
    def __init__(__self__, *,
                 ...
                 taints: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] id: The scaling group id of the groups configured for cluster-autoscaler.
        :param pulumi.Input[builtins.str] labels: The labels for the nodes in scaling group.
        :param pulumi.Input[builtins.str] taints: The taints for the nodes in scaling group.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
    ...
    @property
    @pulumi.getter
    def taints(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The taints for the nodes in scaling group.
        """
    ...
    @taints.setter
    def taints(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class KubernetesDeleteOptionArgsDict(TypedDict):
        delete_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class KubernetesDeleteOptionArgs:
    def __init__(__self__, *,
                 delete_mode: Optional[pulumi.Input[builtins.str]] = None,
                 resource_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] delete_mode: The deletion mode of the cluster. Different resources may have different default behavior, see `resource_type` for details. Valid values:
        :param pulumi.Input[builtins.str] resource_type: The type of resources that are created by cluster. Valid values:
               - `SLB`: SLB resources created by the Nginx Ingress Service, default behavior is to delete, option to retain is available.
               - `ALB`: ALB resources created by the ALB Ingress Controller, default behavior is to retain, option to delete is available.
               - `SLS_Data`: SLS Project used by the cluster logging feature, default behavior is to retain, option to delete is available.
               - `SLS_ControlPlane`: SLS Project used for the managed cluster control plane logs, default behavior is to retain, option to delete is available.
    ...
    def delete_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The deletion mode of the cluster. Different resources may have different default behavior, see `resource_type` for details. Valid values:
        """
    ...
    @delete_mode.setter
    def delete_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class KubernetesPermissionPermissionArgsDict(TypedDict):
        ...
        """
        is_custom: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        is_ram_role: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class KubernetesPermissionPermissionArgs:
    def __init__(__self__, *,
                 ...
                 is_ram_role: Optional[pulumi.Input[builtins.bool]] = None,
                 namespace: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cluster: The ID of the cluster that you want to manage, When `role_type` value is `all-clusters`, the value of `cluster` must be `""`.
        :param pulumi.Input[builtins.str] role_name: Specifies the predefined role that you want to assign. Valid values `admin`, `ops`, `dev`, `restricted` and the custom cluster roles.
        :param pulumi.Input[builtins.str] role_type: The authorization type. Valid values `cluster`, `namespace` and `all-clusters`.
        :param pulumi.Input[builtins.bool] is_custom: Specifies whether to perform a custom authorization. To perform a custom authorization, the value of `is_custom` must be `true`, and set `role_name` to a custom cluster role.
        :param pulumi.Input[builtins.bool] is_ram_role: Specifies whether the permissions are granted to a RAM role. When `uid` is ram role id, the value of `is_ram_role` must be `true`.
        :param pulumi.Input[builtins.str] namespace: The namespace to which the permissions are scoped. This parameter is required only if you set role_type to namespace.
        """
    ...
    def is_ram_role(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether the permissions are granted to a RAM role. When `uid` is ram role id, the value of `is_ram_role` must be `true`.
        """
    ...
    @is_ram_role.setter
    def is_ram_role(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ManagedKubernetesAddonArgs:
    def __init__(__self__, *,
                 ...
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] config: If this parameter is left empty, no configurations are required. For more config information, see cs_kubernetes_addon_metadata.
        :param pulumi.Input[builtins.bool] disabled: It specifies whether to disable automatic installation. 
...
if not MYPY:
    class ManagedKubernetesMaintenanceWindowArgsDict(TypedDict):
        ...
        """
        weekly_period: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ManagedKubernetesMaintenanceWindowArgs:
    def __init__(__self__, *,
                 ...
                 weekly_period: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] duration: The maintenance time, values range from 1 to 24,unit is hour. For example: "3h".
        :param pulumi.Input[builtins.bool] enable: Whether to open the maintenance window. The following parameters take effect only `enable = true`.
        :param pulumi.Input[builtins.str] maintenance_time: Initial maintenance time, RFC3339 format. For example: "2024-10-15T12:31:00.000+08:00".
        :param pulumi.Input[builtins.str] weekly_period: Maintenance cycle, you can set the values from Monday to Sunday, separated by commas when the values are multiple. The default is Thursday.
    ...
    def weekly_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Maintenance cycle, you can set the values from Monday to Sunday, separated by commas when the values are multiple. The default is Thursday.
    ...
    def weekly_period(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagedKubernetesOperationPolicyClusterAutoUpgradeArgs:
    def __init__(__self__, *,
                 ...
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] channel: The automatic cluster upgrade channel. Valid values: `patch`, `stable`, `rapid`.
               ...
               ```
        :param pulumi.Input[builtins.bool] enabled: Whether the RRSA feature has been enabled.
        """
...
if not MYPY:
    class ManagedKubernetesRrsaMetadataArgsDict(TypedDict):
        ...
        Whether the RRSA feature has been enabled.
        """
        ram_oidc_provider_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        The arn of OIDC provider that was registered in RAM.
        """
        ram_oidc_provider_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The name of OIDC Provider that was registered in RAM.
        """
        rrsa_oidc_issuer_url: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ManagedKubernetesRrsaMetadataArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ram_oidc_provider_arn: Optional[pulumi.Input[builtins.str]] = None,
                 ram_oidc_provider_name: Optional[pulumi.Input[builtins.str]] = None,
                 rrsa_oidc_issuer_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Whether the RRSA feature has been enabled.
        :param pulumi.Input[builtins.str] ram_oidc_provider_arn: The arn of OIDC provider that was registered in RAM.
        :param pulumi.Input[builtins.str] ram_oidc_provider_name: The name of OIDC Provider that was registered in RAM.
        :param pulumi.Input[builtins.str] rrsa_oidc_issuer_url: The issuer URL of RRSA OIDC Token.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
    ...
    def ram_oidc_provider_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The arn of OIDC provider that was registered in RAM.
        """
    ...
    def ram_oidc_provider_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ram_oidc_provider_arn", value)

    @property
    @pulumi.getter(name="ramOidcProviderName")
    def ram_oidc_provider_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of OIDC Provider that was registered in RAM.
        """
    ...
    def ram_oidc_provider_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ram_oidc_provider_name", value)

    @property
    @pulumi.getter(name="rrsaOidcIssuerUrl")
    def rrsa_oidc_issuer_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The issuer URL of RRSA OIDC Token.
        """
    ...
    def rrsa_oidc_issuer_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rrsa_oidc_issuer_url", value)


if not MYPY:
    class NodePoolDataDiskArgsDict(TypedDict):
        auto_format: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        mount_target: NotRequired[pulumi.Input[builtins.str]]
        """
...
class NodePoolDataDiskArgs:
    def __init__(__self__, *,
                 auto_format: Optional[pulumi.Input[builtins.str]] = None,
                 auto_snapshot_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 kms_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 mount_target: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 performance_level: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 snapshot_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] auto_format: Whether to automatically mount the data disk. Valid values: true and false.
        :param pulumi.Input[builtins.str] auto_snapshot_policy_id: The ID of the automatic snapshot policy that you want to apply to the system disk.
        :param pulumi.Input[builtins.bool] bursting_enabled: Whether the data disk is enabled with Burst (performance Burst). This is configured when the disk type is cloud_auto.
        :param pulumi.Input[builtins.str] category: The type of data disk. Default value: `cloud_efficiency`. Valid values:
        :param pulumi.Input[builtins.str] device: The mount target of data disk N. Valid values of N: 1 to 16. If you do not specify this parameter, the system automatically assigns a mount target when Auto Scaling creates ECS instances. The name of the mount target ranges from /dev/xvdb to /dev/xvdz.
        :param pulumi.Input[builtins.str] encrypted: Specifies whether to encrypt data disks. Valid values: true and false. Default to `false`.
        :param pulumi.Input[builtins.str] file_system: The type of the mounted file system. Works when auto_format is true. Optional value: `ext4`, `xfs`.
        :param pulumi.Input[builtins.str] kms_key_id: The kms key id used to encrypt the data disk. It takes effect when `encrypted` is true.
        :param pulumi.Input[builtins.str] mount_target: The Mount path. Works when auto_format is true.
        :param pulumi.Input[builtins.str] name: The length is 2~128 English or Chinese characters. It must start with an uppercase or lowr letter or a Chinese character and cannot start with http:// or https. Can contain numbers, colons (:), underscores (_), or dashes (-). It will be overwritten if auto_format is set.
        :param pulumi.Input[builtins.str] performance_level: Worker node data disk performance level, when `category` values `cloud_essd`, the optional values are `PL0`, `PL1`, `PL2` or `PL3`, but the specific performance level is related to the disk capacity. For more information, see [Enhanced SSDs](https://www.alibabacloud.com/help/doc-detail/122389.htm). Default is `PL1`.
        :param pulumi.Input[builtins.int] provisioned_iops: The read/write IOPS preconfigured for the data disk, which is configured when the disk type is cloud_auto.
        :param pulumi.Input[builtins.int] size: The size of a data disk, Its valid value range [40~32768] in GB. Default to `40`.
        :param pulumi.Input[builtins.str] snapshot_id: The ID of the snapshot that you want to use to create data disk N. Valid values of N: 1 to 16. If you specify this parameter, DataDisk.N.Size is ignored. The size of the disk is the same as the size of the specified snapshot. If you specify a snapshot that is created on or before July 15, 2013, the operation fails and InvalidSnapshot.TooOld is returned.
        """
    ...
    def auto_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether to automatically mount the data disk. Valid values: true and false.
        """
    ...
    @auto_format.setter
    def auto_format(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def mount_target(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Mount path. Works when auto_format is true.
        """
    ...
    @mount_target.setter
    def mount_target(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class NodePoolKubeletConfigurationArgsDict(TypedDict):
        ...
        """
        cluster_dns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The list of IP addresses of the cluster DNS servers.
        """
        container_log_max_files: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        container_log_max_workers: NotRequired[pulumi.Input[builtins.str]]
        """
        Specifies the maximum number of concurrent workers required to perform log rotation operations.
        """
        container_log_monitor_interval: NotRequired[pulumi.Input[builtins.str]]
        """
        Specifies the duration for which container logs are monitored for log rotation.
        """
        cpu_cfs_quota: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        event_burst: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        event_record_qps: NotRequired[pulumi.Input[builtins.str]]
        """
        Same as eventRecordQPS. The maximum event creations per second. If 0, there is no limit enforced. Valid value is `[0-50]`.
        """
        eviction_hard: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        ...
        """
        eviction_soft: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        ...
        """
        eviction_soft_grace_period: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        ...
        """
        feature_gates: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.bool]]]]
        """
        Feature switch to enable configuration of experimental features.
        """
        image_gc_high_threshold_percent: NotRequired[pulumi.Input[builtins.str]]
        """
        If the image usage exceeds this threshold, image garbage collection will continue.
        """
        image_gc_low_threshold_percent: NotRequired[pulumi.Input[builtins.str]]
        """
        Image garbage collection is not performed when the image usage is below this threshold.
        """
        kube_api_burst: NotRequired[pulumi.Input[builtins.str]]
        """
        Same as kubeAPIBurst. The burst to allow while talking with kubernetes api-server. Valid value is `[0-100]`.
        """
        kube_api_qps: NotRequired[pulumi.Input[builtins.str]]
        """
        Same as kubeAPIQPS. The QPS to use while talking with kubernetes api-server. Valid value is `[0-50]`.
        """
        kube_reserved: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        Same as kubeReserved. The set of ResourceName=ResourceQuantity (e.g. cpu=200m,memory=150G) pairs that describe resources reserved for kubernetes system components. Currently, cpu, memory and local storage for root file system are supported. See [compute resources](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for more details.
        """
        max_pods: NotRequired[pulumi.Input[builtins.str]]
        """
        The maximum number of running pods.
        """
        memory_manager_policy: NotRequired[pulumi.Input[builtins.str]]
        """
        The policy to be used by the memory manager.
        """
        pod_pids_limit: NotRequired[pulumi.Input[builtins.str]]
        """
        The maximum number of PIDs that can be used in a Pod.
        """
        read_only_port: NotRequired[pulumi.Input[builtins.str]]
        """
        Read-only port number.
        """
        registry_burst: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        registry_pull_qps: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        serialize_image_pulls: NotRequired[pulumi.Input[builtins.str]]
        """
        Same as serializeImagePulls. When enabled, it tells the Kubelet to pull images one at a time. We recommend not changing the default value on nodes that run docker daemon with version < 1.9 or an Aufs storage backend. Valid value is `true` or `false`.
        """
        system_reserved: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class NodePoolKubeletConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 cluster_dns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 container_log_max_files: Optional[pulumi.Input[builtins.str]] = None,
                 container_log_max_size: Optional[pulumi.Input[builtins.str]] = None,
                 container_log_max_workers: Optional[pulumi.Input[builtins.str]] = None,
                 container_log_monitor_interval: Optional[pulumi.Input[builtins.str]] = None,
                 cpu_cfs_quota: Optional[pulumi.Input[builtins.str]] = None,
                 cpu_cfs_quota_period: Optional[pulumi.Input[builtins.str]] = None,
                 cpu_manager_policy: Optional[pulumi.Input[builtins.str]] = None,
                 event_burst: Optional[pulumi.Input[builtins.str]] = None,
                 event_record_qps: Optional[pulumi.Input[builtins.str]] = None,
                 eviction_hard: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 eviction_soft: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 eviction_soft_grace_period: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 feature_gates: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.bool]]]] = None,
                 image_gc_high_threshold_percent: Optional[pulumi.Input[builtins.str]] = None,
                 image_gc_low_threshold_percent: Optional[pulumi.Input[builtins.str]] = None,
                 kube_api_burst: Optional[pulumi.Input[builtins.str]] = None,
                 kube_api_qps: Optional[pulumi.Input[builtins.str]] = None,
                 kube_reserved: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 max_pods: Optional[pulumi.Input[builtins.str]] = None,
                 memory_manager_policy: Optional[pulumi.Input[builtins.str]] = None,
                 pod_pids_limit: Optional[pulumi.Input[builtins.str]] = None,
                 read_only_port: Optional[pulumi.Input[builtins.str]] = None,
                 registry_burst: Optional[pulumi.Input[builtins.str]] = None,
                 registry_pull_qps: Optional[pulumi.Input[builtins.str]] = None,
                 reserved_memories: Optional[pulumi.Input[Sequence[pulumi.Input['NodePoolKubeletConfigurationReservedMemoryArgs']]]] = None,
                 serialize_image_pulls: Optional[pulumi.Input[builtins.str]] = None,
                 system_reserved: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_unsafe_sysctls: Allowed sysctl mode whitelist.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cluster_dns: The list of IP addresses of the cluster DNS servers.
        :param pulumi.Input[builtins.str] container_log_max_files: The maximum number of log files that can exist in each container.
        :param pulumi.Input[builtins.str] container_log_max_size: The maximum size that can be reached before a log file is rotated.
        :param pulumi.Input[builtins.str] container_log_max_workers: Specifies the maximum number of concurrent workers required to perform log rotation operations.
        :param pulumi.Input[builtins.str] container_log_monitor_interval: Specifies the duration for which container logs are monitored for log rotation.
        :param pulumi.Input[builtins.str] cpu_cfs_quota: CPU CFS quota constraint switch.
        :param pulumi.Input[builtins.str] cpu_cfs_quota_period: CPU CFS quota period value.
        :param pulumi.Input[builtins.str] cpu_manager_policy: Same as cpuManagerPolicy. The name of the policy to use. Requires the CPUManager feature gate to be enabled. Valid value is `none` or `static`.
        :param pulumi.Input[builtins.str] event_burst: Same as eventBurst. The maximum size of a burst of event creations, temporarily allows event creations to burst to this number, while still not exceeding `event_record_qps`. It is only used when `event_record_qps` is greater than 0. Valid value is `[0-100]`.
        :param pulumi.Input[builtins.str] event_record_qps: Same as eventRecordQPS. The maximum event creations per second. If 0, there is no limit enforced. Valid value is `[0-50]`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] eviction_hard: Same as evictionHard. The map of signal names to quantities that defines hard eviction thresholds. For example: `{"memory.available" = "300Mi"}`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] eviction_soft: Same as evictionSoft. The map of signal names to quantities that defines soft eviction thresholds. For example: `{"memory.available" = "300Mi"}`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] eviction_soft_grace_period: Same as evictionSoftGracePeriod. The map of signal names to quantities that defines grace periods for each soft eviction signal. For example: `{"memory.available" = "30s"}`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.bool]]] feature_gates: Feature switch to enable configuration of experimental features.
        :param pulumi.Input[builtins.str] image_gc_high_threshold_percent: If the image usage exceeds this threshold, image garbage collection will continue.
        :param pulumi.Input[builtins.str] image_gc_low_threshold_percent: Image garbage collection is not performed when the image usage is below this threshold.
        :param pulumi.Input[builtins.str] kube_api_burst: Same as kubeAPIBurst. The burst to allow while talking with kubernetes api-server. Valid value is `[0-100]`.
        :param pulumi.Input[builtins.str] kube_api_qps: Same as kubeAPIQPS. The QPS to use while talking with kubernetes api-server. Valid value is `[0-50]`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] kube_reserved: Same as kubeReserved. The set of ResourceName=ResourceQuantity (e.g. cpu=200m,memory=150G) pairs that describe resources reserved for kubernetes system components. Currently, cpu, memory and local storage for root file system are supported. See [compute resources](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for more details.
        :param pulumi.Input[builtins.str] max_pods: The maximum number of running pods.
        :param pulumi.Input[builtins.str] memory_manager_policy: The policy to be used by the memory manager.
        :param pulumi.Input[builtins.str] pod_pids_limit: The maximum number of PIDs that can be used in a Pod.
        :param pulumi.Input[builtins.str] read_only_port: Read-only port number.
        :param pulumi.Input[builtins.str] registry_burst: Same as registryBurst. The maximum size of burst pulls, temporarily allows pulls to burst to this number, while still not exceeding `registry_pull_qps`. Only used if `registry_pull_qps` is greater than 0. Valid value is `[0-100]`.
        :param pulumi.Input[builtins.str] registry_pull_qps: Same as registryPullQPS. The limit of registry pulls per second. Setting it to `0` means no limit. Valid value is `[0-50]`.
        ...
        :param pulumi.Input[builtins.str] serialize_image_pulls: Same as serializeImagePulls. When enabled, it tells the Kubelet to pull images one at a time. We recommend not changing the default value on nodes that run docker daemon with version < 1.9 or an Aufs storage backend. Valid value is `true` or `false`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] system_reserved: Same as systemReserved. The set of ResourceName=ResourceQuantity (e.g. cpu=200m,memory=150G) pairs that describe resources reserved for non-kubernetes components. Currently, only cpu and memory are supported. See [compute resources](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for more details.
        :param pulumi.Input[builtins.str] topology_manager_policy: Name of the Topology Manager policy used.
    ...
    def cluster_dns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of IP addresses of the cluster DNS servers.
        """
    ...
    @cluster_dns.setter
    def cluster_dns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "cluster_dns", value)

    @property
    @pulumi.getter(name="containerLogMaxFiles")
    def container_log_max_files(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The maximum number of log files that can exist in each container.
        """
    ...
    def container_log_max_files(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def container_log_max_workers(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the maximum number of concurrent workers required to perform log rotation operations.
        """
    ...
    def container_log_max_workers(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "container_log_max_workers", value)

    @property
    @pulumi.getter(name="containerLogMonitorInterval")
    def container_log_monitor_interval(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the duration for which container logs are monitored for log rotation.
        """
    ...
    def container_log_monitor_interval(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "container_log_monitor_interval", value)

    @property
    @pulumi.getter(name="cpuCfsQuota")
    def cpu_cfs_quota(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        CPU CFS quota constraint switch.
        """
    ...
    def cpu_cfs_quota(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def event_burst(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Same as eventBurst. The maximum size of a burst of event creations, temporarily allows event creations to burst to this number, while still not exceeding `event_record_qps`. It is only used when `event_record_qps` is greater than 0. Valid value is `[0-100]`.
        """
    ...
    @event_burst.setter
    def event_burst(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_burst", value)

    @property
    @pulumi.getter(name="eventRecordQps")
    def event_record_qps(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Same as eventRecordQPS. The maximum event creations per second. If 0, there is no limit enforced. Valid value is `[0-50]`.
        """
    ...
    def event_record_qps(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_record_qps", value)

    @property
    @pulumi.getter(name="evictionHard")
    def eviction_hard(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Same as evictionHard. The map of signal names to quantities that defines hard eviction thresholds. For example: `{"memory.available" = "300Mi"}`.
        """
    ...
    def eviction_hard(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "eviction_hard", value)

    @property
    @pulumi.getter(name="evictionSoft")
    def eviction_soft(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Same as evictionSoft. The map of signal names to quantities that defines soft eviction thresholds. For example: `{"memory.available" = "300Mi"}`.
        """
    ...
    def eviction_soft(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "eviction_soft", value)

    @property
    @pulumi.getter(name="evictionSoftGracePeriod")
    def eviction_soft_grace_period(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Same as evictionSoftGracePeriod. The map of signal names to quantities that defines grace periods for each soft eviction signal. For example: `{"memory.available" = "30s"}`.
        """
    ...
    def eviction_soft_grace_period(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "eviction_soft_grace_period", value)

    @property
    @pulumi.getter(name="featureGates")
    def feature_gates(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.bool]]]]:
        """
        Feature switch to enable configuration of experimental features.
        """
    ...
    def feature_gates(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.bool]]]]):
        pulumi.set(self, "feature_gates", value)

    @property
    @pulumi.getter(name="imageGcHighThresholdPercent")
    def image_gc_high_threshold_percent(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        If the image usage exceeds this threshold, image garbage collection will continue.
        """
    ...
    def image_gc_high_threshold_percent(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "image_gc_high_threshold_percent", value)

    @property
    @pulumi.getter(name="imageGcLowThresholdPercent")
    def image_gc_low_threshold_percent(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Image garbage collection is not performed when the image usage is below this threshold.
        """
    ...
    def image_gc_low_threshold_percent(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "image_gc_low_threshold_percent", value)

    @property
    @pulumi.getter(name="kubeApiBurst")
    def kube_api_burst(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Same as kubeAPIBurst. The burst to allow while talking with kubernetes api-server. Valid value is `[0-100]`.
        """
    ...
    def kube_api_burst(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "kube_api_burst", value)

    @property
    @pulumi.getter(name="kubeApiQps")
    def kube_api_qps(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Same as kubeAPIQPS. The QPS to use while talking with kubernetes api-server. Valid value is `[0-50]`.
        """
    ...
    @kube_api_qps.setter
    def kube_api_qps(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "kube_api_qps", value)

    @property
    @pulumi.getter(name="kubeReserved")
    def kube_reserved(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Same as kubeReserved. The set of ResourceName=ResourceQuantity (e.g. cpu=200m,memory=150G) pairs that describe resources reserved for kubernetes system components. Currently, cpu, memory and local storage for root file system are supported. See [compute resources](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for more details.
        """
    ...
    def kube_reserved(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "kube_reserved", value)

    @property
    @pulumi.getter(name="maxPods")
    def max_pods(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The maximum number of running pods.
        """
    ...
    @max_pods.setter
    def max_pods(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "max_pods", value)

    @property
    @pulumi.getter(name="memoryManagerPolicy")
    def memory_manager_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The policy to be used by the memory manager.
        """
    ...
    def memory_manager_policy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "memory_manager_policy", value)

    @property
    @pulumi.getter(name="podPidsLimit")
    def pod_pids_limit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The maximum number of PIDs that can be used in a Pod.
        """
    ...
    def pod_pids_limit(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pod_pids_limit", value)

    @property
    @pulumi.getter(name="readOnlyPort")
    def read_only_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Read-only port number.
        """
    ...
    def read_only_port(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "read_only_port", value)

    @property
    @pulumi.getter(name="registryBurst")
    def registry_burst(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Same as registryBurst. The maximum size of burst pulls, temporarily allows pulls to burst to this number, while still not exceeding `registry_pull_qps`. Only used if `registry_pull_qps` is greater than 0. Valid value is `[0-100]`.
        """
    ...
    def registry_burst(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "registry_burst", value)

    @property
    @pulumi.getter(name="registryPullQps")
    def registry_pull_qps(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Same as registryPullQPS. The limit of registry pulls per second. Setting it to `0` means no limit. Valid value is `[0-50]`.
        """
    ...
    def registry_pull_qps(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def serialize_image_pulls(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Same as serializeImagePulls. When enabled, it tells the Kubelet to pull images one at a time. We recommend not changing the default value on nodes that run docker daemon with version < 1.9 or an Aufs storage backend. Valid value is `true` or `false`.
        """
    ...
    def serialize_image_pulls(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "serialize_image_pulls", value)

    @property
    @pulumi.getter(name="systemReserved")
    def system_reserved(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Same as systemReserved. The set of ResourceName=ResourceQuantity (e.g. cpu=200m,memory=150G) pairs that describe resources reserved for non-kubernetes components. Currently, only cpu and memory are supported. See [compute resources](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) for more details.
        """
    ...
    def system_reserved(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class NodePoolKubeletConfigurationReservedMemoryArgsDict(TypedDict):
        ...
        """
        numa_node: NotRequired[pulumi.Input[builtins.int]]
        """
        The NUMA node.
        """
elif False:
...
class NodePoolKubeletConfigurationReservedMemoryArgs:
    def __init__(__self__, *,
                 ...
                 numa_node: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] limits: Memory resource limit.
        :param pulumi.Input[builtins.int] numa_node: The NUMA node.
        """
    ...
    def numa_node(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The NUMA node.
        """
    ...
    @numa_node.setter
    def numa_node(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class NodePoolKubeletConfigurationTracingArgsDict(TypedDict):
        ...
        """
        sampling_rate_per_million: NotRequired[pulumi.Input[builtins.str]]
        """
...
class NodePoolKubeletConfigurationTracingArgs:
    def __init__(__self__, *,
                 ...
                 sampling_rate_per_million: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] endpoint: The endpoint of the collector.
        :param pulumi.Input[builtins.str] sampling_rate_per_million: Number of samples to be collected per million span.
        """
    ...
    def sampling_rate_per_million(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Number of samples to be collected per million span.
        """
    ...
    def sampling_rate_per_million(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class NodePoolManagementArgsDict(TypedDict):
        ...
        """
        auto_vul_fix: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        surge: NotRequired[pulumi.Input[builtins.int]]
        """
        Number of additional nodes. You have to specify one of surge, surge_percentage.
        """
        surge_percentage: NotRequired[pulumi.Input[builtins.int]]
        """
...
class NodePoolManagementArgs:
    def __init__(__self__, *,
                 ...
                 auto_vul_fix: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 surge: Optional[pulumi.Input[builtins.int]] = None,
                 surge_percentage: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] auto_repair: Whether to enable automatic repair. Valid values: `true`: Automatic repair. `false`: not automatically repaired.
        ...
        :param pulumi.Input[builtins.bool] auto_upgrade: Specifies whether to enable auto update. Valid values: `true`: enables auto update. `false`: disables auto update.
        ...
        :param pulumi.Input[builtins.bool] auto_vul_fix: Specifies whether to automatically patch CVE vulnerabilities. Valid values: `true`, `false`.
        ...
        :param pulumi.Input[builtins.bool] enable: Specifies whether to enable the managed node pool feature. Valid values: `true`: enables the managed node pool feature. `false`: disables the managed node pool feature. Other parameters in this section take effect only when you specify enable=true.
        :param pulumi.Input[builtins.int] max_unavailable: Maximum number of unavailable nodes. Default value: 1. Value range:\\[1,1000\\].
        :param pulumi.Input[builtins.int] surge: Number of additional nodes. You have to specify one of surge, surge_percentage.
        :param pulumi.Input[builtins.int] surge_percentage: Proportion of additional nodes. You have to specify one of surge, surge_percentage.
        """
    ...
    def auto_vul_fix(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to automatically patch CVE vulnerabilities. Valid values: `true`, `false`.
        """
    ...
    @auto_vul_fix.setter
    def auto_vul_fix(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def surge(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of additional nodes. You have to specify one of surge, surge_percentage.
        """
    ...
    @surge.setter
    def surge(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def surge_percentage(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Proportion of additional nodes. You have to specify one of surge, surge_percentage.
        """
    ...
    def surge_percentage(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "surge_percentage", value)


if not MYPY:
    class NodePoolManagementAutoRepairPolicyArgsDict(TypedDict):
        restart_node: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class NodePoolManagementAutoRepairPolicyArgs:
    def __init__(__self__, *,
                 restart_node: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] restart_node: Specifies whether to automatically restart nodes after patching CVE vulnerabilities. Valid values: `true`, `false`.
        """
    ...
    def restart_node(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to automatically restart nodes after patching CVE vulnerabilities. Valid values: `true`, `false`.
        """
    ...
    @restart_node.setter
    def restart_node(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "restart_node", value)


if not MYPY:
    class NodePoolManagementAutoUpgradePolicyArgsDict(TypedDict):
        auto_upgrade_kubelet: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class NodePoolManagementAutoUpgradePolicyArgs:
    def __init__(__self__, *,
                 auto_upgrade_kubelet: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] auto_upgrade_kubelet: Specifies whether  to automatically update the kubelet. Valid values: `true`: yes; `false`: no.
        """
    ...
    def auto_upgrade_kubelet(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether  to automatically update the kubelet. Valid values: `true`: yes; `false`: no.
        """
    ...
    def auto_upgrade_kubelet(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class NodePoolManagementAutoVulFixPolicyArgsDict(TypedDict):
        ...
        Specifies whether to automatically restart nodes after patching CVE vulnerabilities. Valid values: `true`, `false`.
        """
        vul_level: NotRequired[pulumi.Input[builtins.str]]
        """
...
class NodePoolManagementAutoVulFixPolicyArgs:
    def __init__(__self__, *,
                 restart_node: Optional[pulumi.Input[builtins.bool]] = None,
                 vul_level: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] restart_node: Specifies whether to automatically restart nodes after patching CVE vulnerabilities. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] vul_level: The severity levels of vulnerabilities that is allowed to automatically patch. Multiple severity levels are separated by commas (,).
        """
        if restart_node is not None:
            pulumi.set(__self__, "restart_node", restart_node)
    ...
    def vul_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The severity levels of vulnerabilities that is allowed to automatically patch. Multiple severity levels are separated by commas (,).
        """
    ...
    @vul_level.setter
    def vul_level(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vul_level", value)


if not MYPY:
    class NodePoolPrivatePoolOptionsArgsDict(TypedDict):
        private_pool_options_id: NotRequired[pulumi.Input[builtins.str]]
        """
        The ID of the private node pool.
        """
        private_pool_options_match_criteria: NotRequired[pulumi.Input[builtins.str]]
        """
...
class NodePoolPrivatePoolOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] private_pool_options_id: The ID of the private node pool.
        :param pulumi.Input[builtins.str] private_pool_options_match_criteria: The type of private node pool. This parameter specifies the type of the private pool that you want to use to create instances. A private node pool is generated when an elasticity assurance or a capacity reservation service takes effect. The system selects a private node pool to launch instances. Valid values: `Open`: specifies an open private node pool. The system selects an open private node pool to launch instances. If no matching open private node pool is available, the resources in the public node pool are used. `Target`: specifies a private node pool. The system uses the resources of the specified private node pool to launch instances. If the specified private node pool is unavailable, instances cannot be started. `None`: no private node pool is used. The resources of private node pools are not used to launch the instances.
        """
...
class NodePoolRollingPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] max_parallelism: The maximum number of unusable nodes.
        """
...
if not MYPY:
    class NodePoolScalingConfigArgsDict(TypedDict):
        eip_bandwidth: NotRequired[pulumi.Input[builtins.int]]
        """
        Peak EIP bandwidth. Its valid value range [1~500] in Mbps. It works if `is_bond_eip=true`. Default to `5`.
        """
        eip_internet_charge_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        is_bond_eip: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class NodePoolScalingConfigArgs:
    def __init__(__self__, *,
                 ...
                 eip_internet_charge_type: Optional[pulumi.Input[builtins.str]] = None,
                 enable: Optional[pulumi.Input[builtins.bool]] = None,
                 is_bond_eip: Optional[pulumi.Input[builtins.bool]] = None,
                 max_size: Optional[pulumi.Input[builtins.int]] = None,
                 min_size: Optional[pulumi.Input[builtins.int]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] eip_bandwidth: Peak EIP bandwidth. Its valid value range [1~500] in Mbps. It works if `is_bond_eip=true`. Default to `5`.
        :param pulumi.Input[builtins.str] eip_internet_charge_type: EIP billing type. `PayByBandwidth`: Charged at fixed bandwidth. `PayByTraffic`: Billed as used traffic. Default: `PayByBandwidth`. It works if `is_bond_eip=true`, conflict with `internet_charge_type`. EIP and public network IP can only choose one.
        :param pulumi.Input[builtins.bool] enable: Whether to enable automatic scaling. Value:
        :param pulumi.Input[builtins.bool] is_bond_eip: Whether to bind EIP for an instance. Default: `false`.
        :param pulumi.Input[builtins.int] max_size: Max number of instances in a auto scaling group, its valid value range [0~1000]. `max_size` has to be greater than `min_size`.
        :param pulumi.Input[builtins.int] min_size: Min number of instances in a auto scaling group, its valid value range [0~1000].
        :param pulumi.Input[builtins.str] type: Instance classification, not required. Vaild value: `cpu`, `gpu`, `gpushare` and `spot`. Default: `cpu`. The actual instance type is determined by `instance_types`.
        """
    ...
    def eip_internet_charge_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        EIP billing type. `PayByBandwidth`: Charged at fixed bandwidth. `PayByTraffic`: Billed as used traffic. Default: `PayByBandwidth`. It works if `is_bond_eip=true`, conflict with `internet_charge_type`. EIP and public network IP can only choose one.
        """
    ...
    def eip_internet_charge_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_bond_eip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to bind EIP for an instance. Default: `false`.
        """
    ...
    @is_bond_eip.setter
    def is_bond_eip(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class NodePoolSpotPriceLimitArgsDict(TypedDict):
        ...
        """
        price_limit: NotRequired[pulumi.Input[builtins.str]]
        """
...
class NodePoolSpotPriceLimitArgs:
    def __init__(__self__, *,
                 ...
                 price_limit: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] instance_type: The type of the preemptible instance.
        :param pulumi.Input[builtins.str] price_limit: The maximum price of a single instance.
        """
    ...
    def price_limit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The maximum price of a single instance.
        """
    ...
    @price_limit.setter
    def price_limit(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NodePoolTaintArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] key: The key of a taint.
        :param pulumi.Input[builtins.str] effect: The scheduling policy.
        :param pulumi.Input[builtins.str] value: The value of a taint.
        """
        pulumi.set(__self__, "key", key)
...
if not MYPY:
    class NodePoolTeeConfigArgsDict(TypedDict):
        tee_enable: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class NodePoolTeeConfigArgs:
    def __init__(__self__, *,
                 tee_enable: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] tee_enable: Specifies whether to enable confidential computing for the cluster.
        """
    ...
    def tee_enable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to enable confidential computing for the cluster.
        """
    ...
    @tee_enable.setter
    def tee_enable(self, value: Optional[pulumi.Input[builtins.bool]]):
