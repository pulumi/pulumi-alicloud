...
class GetClusterCredentialResult:
    ...
    def temporary_duration_minutes(self) -> Optional[builtins.int]:
...
def get_cluster_credential(cluster_id: Optional[builtins.str] = None,
                           output_file: Optional[builtins.str] = None,
                           temporary_duration_minutes: Optional[builtins.int] = None,
    ...
    :param builtins.str cluster_id: The id of target cluster.
    :param builtins.str output_file: File name where to save the returned KubeConfig (after running `pulumi preview`).
    :param builtins.int temporary_duration_minutes: Automatic expiration time of the returned credential. The valid value between `15` and `4320`, in minutes. When this field is omitted, the expiration time will be determined by the system automatically and the result will be in the attributed field `expiration`.
    """
    __args__ = dict()
...
def get_cluster_credential_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                                  output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  temporary_duration_minutes: Optional[pulumi.Input[Optional[builtins.int]]] = None,
