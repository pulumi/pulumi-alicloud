...
def get_registry_enterprise_namespaces(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of ids to filter results by namespace id. Each item formats as `<instance_id>:<namespace_name>`.
    :param builtins.str instance_id: ID of Container Registry Enterprise Edition instance.
    :param builtins.str name_regex: A regex string to filter results by namespace name.
...
def get_registry_enterprise_namespaces_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
