...
def get_kubernetes_permission(uid: Optional[builtins.str] = None,
    ...
    :param builtins.str uid: The ID of the RAM user. If you want to query the permissions of a RAM role, specify the ID of the RAM role.
    """
    __args__ = dict()
    __args__['uid'] = uid
...
def get_kubernetes_permission_output(uid: Optional[pulumi.Input[builtins.str]] = None,
