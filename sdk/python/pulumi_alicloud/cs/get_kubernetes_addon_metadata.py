...
class GetKubernetesAddonMetadataResult:
    ...
    def config_schema(self) -> builtins.str:
        """
...
def get_kubernetes_addon_metadata(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the cluster addon. You can get a list of available addons that the cluster can install by using data source `cs_get_kubernetes_addons`.
    :param builtins.str version: The version of the cluster addon.
    """
    __args__ = dict()
...
def get_kubernetes_addon_metadata_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
