...
def get_edge_kubernetes_clusters(enable_details: Optional[_builtins.bool] = None,
...
def get_edge_kubernetes_clusters_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
