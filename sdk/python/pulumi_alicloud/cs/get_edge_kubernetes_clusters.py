...
def get_edge_kubernetes_clusters(enable_details: Optional[builtins.bool] = None,
...
def get_edge_kubernetes_clusters_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
