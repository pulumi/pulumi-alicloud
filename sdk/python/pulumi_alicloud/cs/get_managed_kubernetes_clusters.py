...
def get_managed_kubernetes_clusters(enable_details: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str kube_config_file_prefix: The path prefix of kube config. You could store kube config in a specified directory by specifying this field, like `~/.kube/managed`, then it will be named with `~/.kube/managed-clusterID-kubeconfig`. From version 1.243.0, kube_config will not export kube_config if this field is not set. Please use the attribute output_file of new DataSource `cs_get_cluster_credential` to replace it
...
def get_managed_kubernetes_clusters_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
