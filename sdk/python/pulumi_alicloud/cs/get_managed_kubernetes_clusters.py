...
def get_managed_kubernetes_clusters(enable_details: Optional[bool] = None,
    ...
    :param str kube_config_file_prefix: The path prefix of kube config. You could store kube config in a specified directory by specifying this field, like `~/.kube/managed`, then it will be named with `~/.kube/managed-clusterID-kubeconfig`. If you don't specify this field, it will be stored in the current directory and named with `clusterID-kubeconfig`.
...
@_utilities.lift_output_func(get_managed_kubernetes_clusters)
def get_managed_kubernetes_clusters_output(enable_details: Optional[pulumi.Input[Optional[bool]]] = None,
