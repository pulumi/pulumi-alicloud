...
def get_managed_kubernetes_clusters(enable_details=None,ids=None,name_regex=None,output_file=None,opts=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:cs/getManagedKubernetesClusters:getManagedKubernetesClusters', __args__, opts=opts).value
