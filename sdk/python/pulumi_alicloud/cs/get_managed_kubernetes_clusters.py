...
__all__ = [
    ...
    'get_managed_kubernetes_clusters_output',
]
...
class GetManagedKubernetesClustersResult:
    ...
    def kube_config_file_prefix(self) -> Optional[builtins.str]:
...
def get_managed_kubernetes_clusters(enable_details: Optional[builtins.bool] = None,
                                    ids: Optional[Sequence[builtins.str]] = None,
                                    kube_config_file_prefix: Optional[builtins.str] = None,
    ...
    :param builtins.bool enable_details: Boolean, false by default, only `id` and `name` are exported. Set to true if more details are needed, e.g., `master_disk_category`, `slb_internet_enabled`, `connections`. See full list in attributes.
    :param Sequence[builtins.str] ids: Cluster IDs to filter.
    :param builtins.str kube_config_file_prefix: The path prefix of kube config. You could store kube config in a specified directory by specifying this field, like `~/.kube/managed`, then it will be named with `~/.kube/managed-clusterID-kubeconfig`. From version 1.243.0, kube_config will not export kube_config if this field is not set. Please use the attribute output_file of new DataSource `cs_get_cluster_credential` to replace it
    :param builtins.str name_regex: A regex string to filter results by cluster name.
...
def get_managed_kubernetes_clusters_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                           ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                           kube_config_file_prefix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
