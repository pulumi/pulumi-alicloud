...
class ManagedKubernetesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] timezone: When you create a cluster, set the time zones for the Master and Worker nodes. You can only change the managed node time zone if you create a cluster. Once the cluster is created, you can only change the time zone of the Worker node.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] worker_vswitch_ids: The vswitches used by control plane. Modification after creation will not take effect. Please use `vswitch_ids` to managed control plane vswtiches, which supports modifying control plane vswtiches.
        """
...
class ManagedKubernetes(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vswitch_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            worker_ram_role_name: Optional[pulumi.Input[builtins.str]] = None,
            worker_vswitch_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ManagedKubernetes':
        """
