...
class EdgeKubernetesArgs:
    def __init__(__self__, *,
                 worker_instance_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 worker_number: pulumi.Input[builtins.int],
                 worker_vswitch_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 ...
                 rds_instances: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 worker_disk_category: Optional[pulumi.Input[builtins.str]] = None,
                 worker_disk_performance_level: Optional[pulumi.Input[builtins.str]] = None,
                 worker_disk_size: Optional[pulumi.Input[builtins.int]] = None,
                 worker_disk_snapshot_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 worker_instance_charge_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EdgeKubernetes resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] worker_instance_types: The instance types of worker node, you can set multiple types to avoid NoStock of a certain type.
        :param pulumi.Input[builtins.int] worker_number: The cloud worker node number of the edge kubernetes cluster. Default to 1. It is limited up to 50 and if you want to enlarge it, please apply white list or contact with us.
        ...
        :param pulumi.Input[builtins.bool] new_nat_gateway: Whether to create a new nat gateway while creating kubernetes cluster. Default to true. Then openapi in Alibaba Cloud are not all on intranet, So turn this option on is a good choice.
        ...
        :param pulumi.Input[builtins.str] password: The password of ssh login cluster node. You have to specify one of `password`, `key_name` `kms_encrypted_password` fields.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rds_instances: RDS instance list, You can choose which RDS instances whitelist to add instances to.
        ...
        :param pulumi.Input[builtins.str] worker_disk_category: The system disk category of worker node. Its valid value are `cloud_efficiency`, `cloud_ssd` and `cloud_essd` and . Default to `cloud_efficiency`.
        :param pulumi.Input[builtins.str] worker_disk_performance_level: Worker node system disk performance level, when `worker_disk_category` values `cloud_essd`, the optional values are `PL0`, `PL1`, `PL2` or `PL3`, but the specific performance level is related to the disk capacity. For more information, see [Enhanced SSDs](https://www.alibabacloud.com/help/doc-detail/122389.htm). Default is `PL1`.
        :param pulumi.Input[builtins.int] worker_disk_size: The system disk size of worker node. Its valid value range [20~32768] in GB. Default to 40.
        :param pulumi.Input[builtins.str] worker_disk_snapshot_policy_id: Worker node system disk auto snapshot policy.
        ...
        :param pulumi.Input[builtins.str] worker_instance_charge_type: Worker payment type, its valid value is `PostPaid`. Defaults to `PostPaid`. More charge details in [ACK@edge charge](https://help.aliyun.com/document_detail/178718.html).
        """
    ...
    def worker_instance_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def worker_instance_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "worker_instance_types", value)

    @property
    @pulumi.getter(name="workerNumber")
    def worker_number(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def worker_number(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "worker_number", value)

    @property
    @pulumi.getter(name="workerVswitchIds")
    def worker_vswitch_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def worker_vswitch_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def install_cloud_monitor(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def rds_instances(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def rds_instances(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def worker_disk_category(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def worker_disk_category(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "worker_disk_category", value)

    @property
    @pulumi.getter(name="workerDiskPerformanceLevel")
    def worker_disk_performance_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def worker_disk_performance_level(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "worker_disk_performance_level", value)

    @property
    @pulumi.getter(name="workerDiskSize")
    def worker_disk_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def worker_disk_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "worker_disk_size", value)

    @property
    @pulumi.getter(name="workerDiskSnapshotPolicyId")
    def worker_disk_snapshot_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def worker_disk_snapshot_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "worker_disk_snapshot_policy_id", value)

    @property
    @pulumi.getter(name="workerInstanceChargeType")
    def worker_instance_charge_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def worker_instance_charge_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EdgeKubernetesState:
    def __init__(__self__, *,
                 ...
                 worker_disk_snapshot_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 worker_instance_charge_type: Optional[pulumi.Input[builtins.str]] = None,
                 worker_instance_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 worker_nodes: Optional[pulumi.Input[Sequence[pulumi.Input['EdgeKubernetesWorkerNodeArgs']]]] = None,
                 worker_number: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="workerInstanceTypes")
    def worker_instance_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The instance types of worker node, you can set multiple types to avoid NoStock of a certain type.
        """
        return pulumi.get(self, "worker_instance_types")
    ...
    @worker_instance_types.setter
    def worker_instance_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "worker_instance_types", value)
    ...
    @property
    @pulumi.getter(name="workerNumber")
    def worker_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The cloud worker node number of the edge kubernetes cluster. Default to 1. It is limited up to 50 and if you want to enlarge it, please apply white list or contact with us.
        """
        return pulumi.get(self, "worker_number")
    ...
    @worker_number.setter
    def worker_number(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "worker_number", value)
...
class EdgeKubernetes(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            worker_number: Optional[pulumi.Input[builtins.int]] = None,
            worker_ram_role_name: Optional[pulumi.Input[builtins.str]] = None,
            worker_vswitch_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'EdgeKubernetes':
        """
    ...
    @property
    @pulumi.getter(name="rdsInstances")
    def rds_instances(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        RDS instance list, You can choose which RDS instances whitelist to add instances to.
        """
        return pulumi.get(self, "rds_instances")
    ...
    @property
    @pulumi.getter(name="workerDiskCategory")
    def worker_disk_category(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The system disk category of worker node. Its valid value are `cloud_efficiency`, `cloud_ssd` and `cloud_essd` and . Default to `cloud_efficiency`.
        """
        return pulumi.get(self, "worker_disk_category")
    ...
    @property
    @pulumi.getter(name="workerDiskPerformanceLevel")
    def worker_disk_performance_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Worker node system disk performance level, when `worker_disk_category` values `cloud_essd`, the optional values are `PL0`, `PL1`, `PL2` or `PL3`, but the specific performance level is related to the disk capacity. For more information, see [Enhanced SSDs](https://www.alibabacloud.com/help/doc-detail/122389.htm). Default is `PL1`.
        """
        return pulumi.get(self, "worker_disk_performance_level")
    ...
    @property
    @pulumi.getter(name="workerDiskSize")
    def worker_disk_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The system disk size of worker node. Its valid value range [20~32768] in GB. Default to 40.
        """
        return pulumi.get(self, "worker_disk_size")
    ...
    @property
    @pulumi.getter(name="workerDiskSnapshotPolicyId")
    def worker_disk_snapshot_policy_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Worker node system disk auto snapshot policy.
    ...
    @property
    @pulumi.getter(name="workerInstanceChargeType")
    def worker_instance_charge_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Worker payment type, its valid value is `PostPaid`. Defaults to `PostPaid`. More charge details in [ACK@edge charge](https://help.aliyun.com/document_detail/178718.html).
        """
        return pulumi.get(self, "worker_instance_charge_type")
    ...
    @property
    @pulumi.getter(name="workerInstanceTypes")
    def worker_instance_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The instance types of worker node, you can set multiple types to avoid NoStock of a certain type.
        """
        return pulumi.get(self, "worker_instance_types")
    ...
    @property
    @pulumi.getter(name="workerNumber")
    def worker_number(self) -> pulumi.Output[builtins.int]:
        """
        The cloud worker node number of the edge kubernetes cluster. Default to 1. It is limited up to 50 and if you want to enlarge it, please apply white list or contact with us.
        """
        return pulumi.get(self, "worker_number")
    ...
    @property
    @pulumi.getter(name="workerVswitchIds")
    def worker_vswitch_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The vswitches used by workers.
        """
        return pulumi.get(self, "worker_vswitch_ids")
