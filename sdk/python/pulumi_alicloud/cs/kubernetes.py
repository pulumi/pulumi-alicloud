...
class KubernetesArgs:
    def __init__(__self__, *,
                 master_instance_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 master_vswitch_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 ...
                 enable_ssh: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 master_auto_renew: Optional[pulumi.Input[builtins.bool]] = None,
                 master_auto_renew_period: Optional[pulumi.Input[builtins.int]] = None,
                 master_disk_category: Optional[pulumi.Input[builtins.str]] = None,
                 master_disk_performance_level: Optional[pulumi.Input[builtins.str]] = None,
                 master_disk_size: Optional[pulumi.Input[builtins.int]] = None,
                 master_disk_snapshot_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 master_instance_charge_type: Optional[pulumi.Input[builtins.str]] = None,
                 master_period: Optional[pulumi.Input[builtins.int]] = None,
                 master_period_unit: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] enable_ssh: Enable login to the node through SSH. Default to `false`.
        :param pulumi.Input[builtins.str] image_id: Custom Image support. Must be based on AliyunLinux or AliyunLinux3.
        :param pulumi.Input[builtins.bool] install_cloud_monitor: Install cloud monitor agent on ECS. Default to `true`.
        :param pulumi.Input[builtins.bool] is_enterprise_security_group: Enable to create advanced security group. default: false. See [Advanced security group](https://www.alibabacloud.com/help/doc-detail/120621.htm). Only works for **Create** Operation.
        ...
        :param pulumi.Input[builtins.bool] master_auto_renew: Enable master payment auto-renew, defaults to false.
        :param pulumi.Input[builtins.int] master_auto_renew_period: Master payment auto-renew period, it can be one of {1, 2, 3, 6, 12}.
        :param pulumi.Input[builtins.str] master_disk_category: The system disk category of master node. Its valid value are `cloud_ssd`, `cloud_essd` and `cloud_efficiency`. Default to `cloud_efficiency`.
        :param pulumi.Input[builtins.str] master_disk_performance_level: Master node system disk performance level. When `master_disk_category` values `cloud_essd`, the optional values are `PL0`, `PL1`, `PL2` or `PL3`, but the specific performance level is related to the disk capacity. For more information, see [Enhanced SSDs](https://www.alibabacloud.com/help/doc-detail/122389.htm). Default is `PL1`.
        :param pulumi.Input[builtins.int] master_disk_size: The system disk size of master node. Its valid value range [20~500] in GB. Default to 20.
        :param pulumi.Input[builtins.str] master_disk_snapshot_policy_id: Master node system disk auto snapshot policy.
               
               *Computed params*
        :param pulumi.Input[builtins.str] master_instance_charge_type: Master payment type. or `PostPaid` or `PrePaid`, defaults to `PostPaid`. If value is `PrePaid`, the files `master_period`, `master_period_unit`, `master_auto_renew` and `master_auto_renew_period` are required.
        :param pulumi.Input[builtins.int] master_period: Master payment period.Its valid value is one of {1, 2, 3, 6, 12, 24, 36, 48, 60}.
        :param pulumi.Input[builtins.str] master_period_unit: Master payment period unit, the valid value is `Month`.
        :param pulumi.Input[builtins.str] name: The kubernetes cluster's name. It is unique in one Alicloud account.
        :param pulumi.Input[builtins.bool] new_nat_gateway: Whether to create a new nat gateway while creating kubernetes cluster. Default to true. Then openapi in Alibaba Cloud are not all on intranet, So turn this option on is a good choice. Your cluster nodes and applications will have public network access. If there is a NAT gateway in the selected VPC, ACK will use this gateway by default; if there is no NAT gateway in the selected VPC, ACK will create a new NAT gateway for you and automatically configure SNAT rules. Only works for **Create** Operation.
        ...
        :param pulumi.Input[builtins.str] platform: The architecture of the nodes that run pods, its valid value `AliyunLinux`, `AliyunLinux3`. Default to `AliyunLinux3`.
        :param pulumi.Input[builtins.str] pod_cidr: [Flannel Specific] The CIDR block for the pod network when using Flannel.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] pod_vswitch_ids: [Terway Specific] The vswitches for the pod network when using Terway. It is recommended that `pod_vswitch_ids` is not belong to `worker_vswitch_ids` and `master_vswitch_ids` but must be in same availability zones. Only works for **Create** Operation.
        ...
        :param pulumi.Input[builtins.bool] slb_internet_enabled: Whether to create internet load balancer for API Server. Default to true. Only works for **Create** Operation. 
               ...
               *Master params*
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Default nil, A map of tags assigned to the kubernetes cluster and work nodes.
    ...
    def master_instance_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def master_instance_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "master_instance_types", value)

    @property
    @pulumi.getter(name="masterVswitchIds")
    def master_vswitch_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def master_vswitch_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def enable_ssh(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @enable_ssh.setter
    def enable_ssh(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def master_auto_renew(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def master_auto_renew(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "master_auto_renew", value)

    @property
    @pulumi.getter(name="masterAutoRenewPeriod")
    def master_auto_renew_period(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def master_auto_renew_period(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "master_auto_renew_period", value)

    @property
    @pulumi.getter(name="masterDiskCategory")
    def master_disk_category(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_disk_category(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "master_disk_category", value)

    @property
    @pulumi.getter(name="masterDiskPerformanceLevel")
    def master_disk_performance_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_disk_performance_level(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "master_disk_performance_level", value)

    @property
    @pulumi.getter(name="masterDiskSize")
    def master_disk_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def master_disk_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "master_disk_size", value)

    @property
    @pulumi.getter(name="masterDiskSnapshotPolicyId")
    def master_disk_snapshot_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_disk_snapshot_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "master_disk_snapshot_policy_id", value)

    @property
    @pulumi.getter(name="masterInstanceChargeType")
    def master_instance_charge_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_instance_charge_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "master_instance_charge_type", value)

    @property
    @pulumi.getter(name="masterPeriod")
    def master_period(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def master_period(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "master_period", value)

    @property
    @pulumi.getter(name="masterPeriodUnit")
    def master_period_unit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_period_unit(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _KubernetesState:
    def __init__(__self__, *,
                 ...
                 master_period: Optional[pulumi.Input[builtins.int]] = None,
                 master_period_unit: Optional[pulumi.Input[builtins.str]] = None,
                 master_vswitch_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 name_prefix: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="masterVswitchIds")
    def master_vswitch_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The vswitches used by master, you can specific 3 or 5 vswitches because of the amount of masters. Detailed below.
        """
        return pulumi.get(self, "master_vswitch_ids")
    ...
    @master_vswitch_ids.setter
    def master_vswitch_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "master_vswitch_ids", value)
...
class Kubernetes(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            version: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            worker_ram_role_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Kubernetes':
        """
    ...
    @property
    @pulumi.getter(name="enableSsh")
    def enable_ssh(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable login to the node through SSH. Default to `false`.
        """
        return pulumi.get(self, "enable_ssh")
    ...
    @property
    @pulumi.getter(name="masterAutoRenew")
    def master_auto_renew(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable master payment auto-renew, defaults to false.
        """
        return pulumi.get(self, "master_auto_renew")
    ...
    @property
    @pulumi.getter(name="masterAutoRenewPeriod")
    def master_auto_renew_period(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Master payment auto-renew period, it can be one of {1, 2, 3, 6, 12}.
        """
        return pulumi.get(self, "master_auto_renew_period")
    ...
    @property
    @pulumi.getter(name="masterDiskCategory")
    def master_disk_category(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The system disk category of master node. Its valid value are `cloud_ssd`, `cloud_essd` and `cloud_efficiency`. Default to `cloud_efficiency`.
        """
        return pulumi.get(self, "master_disk_category")
    ...
    @property
    @pulumi.getter(name="masterDiskPerformanceLevel")
    def master_disk_performance_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Master node system disk performance level. When `master_disk_category` values `cloud_essd`, the optional values are `PL0`, `PL1`, `PL2` or `PL3`, but the specific performance level is related to the disk capacity. For more information, see [Enhanced SSDs](https://www.alibabacloud.com/help/doc-detail/122389.htm). Default is `PL1`.
        """
        return pulumi.get(self, "master_disk_performance_level")
    ...
    @property
    @pulumi.getter(name="masterDiskSize")
    def master_disk_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The system disk size of master node. Its valid value range [20~500] in GB. Default to 20.
        """
        return pulumi.get(self, "master_disk_size")
    ...
    @property
    @pulumi.getter(name="masterDiskSnapshotPolicyId")
    def master_disk_snapshot_policy_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Master node system disk auto snapshot policy.
    ...
    @property
    @pulumi.getter(name="masterInstanceChargeType")
    def master_instance_charge_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Master payment type. or `PostPaid` or `PrePaid`, defaults to `PostPaid`. If value is `PrePaid`, the files `master_period`, `master_period_unit`, `master_auto_renew` and `master_auto_renew_period` are required.
        """
        return pulumi.get(self, "master_instance_charge_type")
    ...
    @property
    @pulumi.getter(name="masterInstanceTypes")
    def master_instance_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The instance type of master node. Specify one type for single AZ Cluster, three types for MultiAZ Cluster.
        """
        return pulumi.get(self, "master_instance_types")
    ...
    @property
    @pulumi.getter(name="masterPeriod")
    def master_period(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Master payment period.Its valid value is one of {1, 2, 3, 6, 12, 24, 36, 48, 60}.
        """
        return pulumi.get(self, "master_period")
    ...
    @property
    @pulumi.getter(name="masterPeriodUnit")
    def master_period_unit(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Master payment period unit, the valid value is `Month`.
        """
        return pulumi.get(self, "master_period_unit")
    ...
    @property
    @pulumi.getter(name="masterVswitchIds")
    def master_vswitch_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The vswitches used by master, you can specific 3 or 5 vswitches because of the amount of masters. Detailed below.
        """
        return pulumi.get(self, "master_vswitch_ids")
