...
def get_serverless_kubernetes_clusters(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.bool enable_details: Boolean, false by default, only `id` and `name` are exported. Set to true if more details are needed, e.g.,  `deletion_protection`, `connections`. See full list in attributes.
    :param Sequence[builtins.str] ids: Cluster IDs to filter.
    :param builtins.str kube_config_file_prefix: The path prefix of kube config. You could store kube config in a specified directory by specifying this field, like `~/.kube/serverless`, then it will be named with `~/.kube/serverless-clusterID-kubeconfig`. From version 1.243.0, kube_config will not export kube_config if this field is not set. Please use the attribute output_file of new DataSource `cs_get_cluster_credential` to replace it
...
def get_serverless_kubernetes_clusters_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
