...
class KubernetesPolicyInstance(pulumi.CustomResource):
        ...
        create_cluster = alicloud.cs.ManagedKubernetes("CreateCluster",
            ...
            vswitch_ids=std.split_output(separator=",",
                text=std.join_output(separator=",",
                    input=[__item.id for __item in create_v_switch]).apply(lambda invoke: invoke.result)).apply(lambda invoke: invoke.result),
            pod_cidr=pod_cidr,
    ...
    def get(resource_name: str,
            ...
            namespaces: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            parameters: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            policy_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'KubernetesPolicyInstance':
        """
