...
class KubernetesPermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] uid: The ID of the Ram user, and it can also be the id of the Ram Role. If you use Ram Role id, you need to set `is_ram_role` to `true` during authorization.
...
class KubernetesPermission(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            permissions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['KubernetesPermissionPermissionArgs', 'KubernetesPermissionPermissionArgsDict']]]]] = None,
            uid: Optional[pulumi.Input[builtins.str]] = None) -> 'KubernetesPermission':
        """
