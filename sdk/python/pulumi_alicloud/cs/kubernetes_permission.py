...
class KubernetesPermission(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        default_managed_kubernetes = alicloud.cs.ManagedKubernetes("default",
            ...
            worker_vswitch_ids=std.split_output(separator=",",
                text=std.join_output(separator=",",
                    input=[__item.id for __item in default_switch]).apply(lambda invoke: invoke.result)).apply(lambda invoke: invoke.result),
