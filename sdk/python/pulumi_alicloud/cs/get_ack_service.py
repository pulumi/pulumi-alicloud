...
def get_ack_service(enable: Optional[builtins.str] = None,
    ...
    :param builtins.str type: Types of services opened. Valid values: `propayasgo`: Container service ack Pro managed version, `edgepayasgo`: Edge container service, `gspayasgo`: Gene computing services.
...
def get_ack_service_output(enable: Optional[pulumi.Input[Optional[builtins.str]]] = None,
