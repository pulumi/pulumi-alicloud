...
def get_ack_service(enable: Optional[_builtins.str] = None,
    ...
    :param _builtins.str type: Types of services opened. Valid values: `propayasgo`: Container service ack Pro managed version, `edgepayasgo`: Edge container service, `gspayasgo`: Gene computing services.
