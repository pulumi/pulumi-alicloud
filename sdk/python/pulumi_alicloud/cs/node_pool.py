...
class NodePoolArgs:
    def __init__(__self__, *,
                 ...
                 cpu_policy: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 node_name_mode: Optional[pulumi.Input[builtins.str]] = None,
                 node_pool_name: Optional[pulumi.Input[builtins.str]] = None,
                 on_demand_base_capacity: Optional[pulumi.Input[builtins.str]] = None,
                 on_demand_percentage_above_base_capacity: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 pre_user_data: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 security_hardening_os: Optional[pulumi.Input[builtins.bool]] = None,
                 soc_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 system_disk_categories: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 system_disk_kms_key: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 system_disk_snapshot_policy_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] compensate_with_on_demand: Specifies whether to automatically create pay-as-you-go instances to meet the required number of ECS instances if preemptible instances cannot be created due to reasons such as cost or insufficient inventory. This parameter takes effect when you set `multi_az_policy` to `COST_OPTIMIZED`. Valid values: `true`: automatically creates pay-as-you-go instances to meet the required number of ECS instances if preemptible instances cannot be created. `false`: does not create pay-as-you-go instances to meet the required number of ECS instances if preemptible instances cannot be created.
        :param pulumi.Input[builtins.str] cpu_policy: Node CPU management policies. Default value: `none`. When the cluster version is 1.12.6 or later, the following two policies are supported:
        ...
        :param pulumi.Input[builtins.str] image_type: The operating system image type and the `platform` parameter can be selected from the following values:
        ...
        :param pulumi.Input[builtins.bool] keep_instance_name: Add an existing instance to the node pool, whether to keep the original instance name. It is recommended to set to `true`.
        :param pulumi.Input[builtins.str] key_name: The name of the key pair. When the node pool is a managed node pool, only `key_name` is supported.
        :param pulumi.Input[builtins.str] kms_encrypted_password: An KMS encrypts password used to a cs kubernetes. You have to specify one of `password` `key_name` `kms_encrypted_password` fields.
        ...
        :param pulumi.Input[builtins.str] node_pool_name: The name of node pool.
        :param pulumi.Input[builtins.str] on_demand_base_capacity: The minimum number of pay-as-you-go instances that must be kept in the scaling group. Valid values: 0 to 1000. If the number of pay-as-you-go instances is less than the value of this parameter, Auto Scaling preferably creates pay-as-you-go instances.
        :param pulumi.Input[builtins.str] on_demand_percentage_above_base_capacity: The percentage of pay-as-you-go instances among the extra instances that exceed the number specified by `on_demand_base_capacity`. Valid values: 0 to 100.
        :param pulumi.Input[builtins.str] password: The password of ssh login. You have to specify one of `password` and `key_name` fields. The password rule is 8 to 30 characters and contains at least three items (upper and lower case letters, numbers, and special symbols).
        :param pulumi.Input[builtins.int] period: Node payment period. Its valid value is one of {1, 2, 3, 6, 12}.
        :param pulumi.Input[builtins.str] period_unit: Node payment period unit, valid value: `Month`. Default is `Month`.
        :param pulumi.Input[builtins.str] platform: Operating system release, using `image_type` instead.
        :param pulumi.Input[builtins.str] pre_user_data: Node pre custom data, base64-encoded, the script executed before the node is initialized.
        ...
        :param pulumi.Input[builtins.str] ram_role_name: The name of the Worker RAM role.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rds_instances: The list of RDS instances.
        ...
        :param pulumi.Input[builtins.str] runtime_name: The runtime name of containers. If not set, the cluster runtime will be used as the node pool runtime. If you select another container runtime, see [Comparison of Docker, containerd, and Sandboxed-Container](https://www.alibabacloud.com/help/doc-detail/160313.htm).
        :param pulumi.Input[builtins.str] runtime_version: The runtime version of containers. If not set, the cluster runtime will be used as the node pool runtime.
        :param pulumi.Input['NodePoolScalingConfigArgs'] scaling_config: Automatic scaling configuration. See `scaling_config` below.
        :param pulumi.Input[builtins.str] scaling_policy: Scaling group mode, default value: `release`. Valid values:
        :param pulumi.Input[builtins.str] security_group_id: The security group ID of the node pool. This field has been replaced by `security_group_ids`, please use the `security_group_ids` field instead.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: Multiple security groups can be configured for a node pool. If both `security_group_ids` and `security_group_id` are configured, `security_group_ids` takes effect. This field cannot be modified.
        :param pulumi.Input[builtins.bool] security_hardening_os: Alibaba Cloud OS security reinforcement. Default value: `false`. Value:
        :param pulumi.Input[builtins.bool] soc_enabled: Whether enable worker node to support soc security reinforcement, its valid value `true` or `false`. Default to `false` and apply to AliyunLinux series. See [SOC Reinforcement](https://help.aliyun.com/document_detail/196148.html).
               
               > **NOTE:**  It is forbidden to set both `security_hardening_os` and `soc_enabled` to `true` at the same time.
        :param pulumi.Input[builtins.int] spot_instance_pools: The number of instance types that are available. Auto Scaling creates preemptible instances of multiple instance types that are available at the lowest cost. Valid values: 1 to 10.
        :param pulumi.Input[builtins.bool] spot_instance_remedy: Specifies whether to supplement preemptible instances when the number of preemptible instances drops below the specified minimum number. If you set the value to true, Auto Scaling attempts to create a new preemptible instance when the system notifies that an existing preemptible instance is about to be reclaimed. Valid values: `true`: enables the supplementation of preemptible instances. `false`: disables the supplementation of preemptible instances.
        ...
        :param pulumi.Input[builtins.str] spot_strategy: The preemptible instance type. Value:
        ...
        :param pulumi.Input[builtins.bool] system_disk_bursting_enabled: Specifies whether to enable the burst feature for system disks. Valid values:`true`: enables the burst feature. `false`: disables the burst feature. This parameter is supported only when `system_disk_category` is set to `cloud_auto`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] system_disk_categories: The multi-disk categories of the system disk. When a high-priority disk type cannot be used, Auto Scaling automatically tries to create a system disk with the next priority disk category. Valid values see `system_disk_category`.
        :param pulumi.Input[builtins.str] system_disk_category: The category of the system disk for nodes. Default value: `cloud_efficiency`. Valid values:
        :param pulumi.Input[builtins.str] system_disk_encrypt_algorithm: The encryption algorithm used by the system disk. Value range: aes-256.
        :param pulumi.Input[builtins.bool] system_disk_encrypted: Whether to encrypt the system disk. Value range: `true`: encryption. `false`: Do not encrypt.
        :param pulumi.Input[builtins.str] system_disk_kms_key: The ID of the KMS key used by the system disk.
        :param pulumi.Input[builtins.str] system_disk_performance_level: The system disk performance of the node takes effect only for the ESSD disk.
        ...
        :param pulumi.Input[builtins.int] system_disk_provisioned_iops: The predefined IOPS of a system disk. Valid values: 0 to min{50,000, 1,000 × Capacity - Baseline IOPS}. Baseline IOPS = min{1,800 + 50 × Capacity, 50,000}. This parameter is supported only when `system_disk_category` is set to `cloud_auto`.
        :param pulumi.Input[builtins.int] system_disk_size: The size of the system disk. Unit: GiB. The value of this parameter must be at least 1 and greater than or equal to the image size. Default value: 40 or the size of the image, whichever is larger.
        ...
        :param pulumi.Input[builtins.str] system_disk_snapshot_policy_id: The ID of the automatic snapshot policy used by the system disk.
    ...
    def cis_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @cis_enabled.setter
    def cis_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def cpu_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cpu_policy.setter
    def cpu_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def desired_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def format_disk(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @format_disk.setter
    def format_disk(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def node_name_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def node_name_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def on_demand_base_capacity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def on_demand_base_capacity(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "on_demand_base_capacity", value)

    @property
    @pulumi.getter(name="onDemandPercentageAboveBaseCapacity")
    def on_demand_percentage_above_base_capacity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def on_demand_percentage_above_base_capacity(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def pre_user_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def pre_user_data(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def security_hardening_os(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def security_hardening_os(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "security_hardening_os", value)

    @property
    @pulumi.getter(name="socEnabled")
    def soc_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @soc_enabled.setter
    def soc_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def system_disk_categories(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def system_disk_categories(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def system_disk_kms_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def system_disk_kms_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def system_disk_snapshot_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def system_disk_snapshot_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def unschedulable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "unschedulable", value)

    @property
    @pulumi.getter(name="updateNodes")
    def update_nodes(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @update_nodes.setter
    def update_nodes(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _NodePoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] node_name_mode: Each node name consists of a prefix, its private network IP, and a suffix, separated by commas. The input format is `customized,,ip,`.
               ...
               - The node IP address is the complete private IP address of the node.
               - For example, if the string `customized,aliyun,ip,com` is passed in (where 'customized' and 'ip' are fixed strings, 'aliyun' is the prefix, and 'com' is the suffix), the name of the node is `aliyun192.168.xxx.xxxcom`.
        :param pulumi.Input[builtins.str] node_pool_id: The first ID of the resource.
        :param pulumi.Input[builtins.str] node_pool_name: The name of node pool.
        :param pulumi.Input[builtins.str] on_demand_base_capacity: The minimum number of pay-as-you-go instances that must be kept in the scaling group. Valid values: 0 to 1000. If the number of pay-as-you-go instances is less than the value of this parameter, Auto Scaling preferably creates pay-as-you-go instances.
        :param pulumi.Input[builtins.str] on_demand_percentage_above_base_capacity: The percentage of pay-as-you-go instances among the extra instances that exceed the number specified by `on_demand_base_capacity`. Valid values: 0 to 100.
        :param pulumi.Input[builtins.str] password: The password of ssh login. You have to specify one of `password` and `key_name` fields. The password rule is 8 to 30 characters and contains at least three items (upper and lower case letters, numbers, and special symbols).
        ...
        :param pulumi.Input[builtins.str] runtime_version: The runtime version of containers. If not set, the cluster runtime will be used as the node pool runtime.
        :param pulumi.Input['NodePoolScalingConfigArgs'] scaling_config: Automatic scaling configuration. See `scaling_config` below.
        :param pulumi.Input[builtins.str] scaling_group_id: The ID of the scaling group.
        :param pulumi.Input[builtins.str] scaling_policy: Scaling group mode, default value: `release`. Valid values:
        :param pulumi.Input[builtins.str] security_group_id: The security group ID of the node pool. This field has been replaced by `security_group_ids`, please use the `security_group_ids` field instead.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: Multiple security groups can be configured for a node pool. If both `security_group_ids` and `security_group_id` are configured, `security_group_ids` takes effect. This field cannot be modified.
        :param pulumi.Input[builtins.bool] security_hardening_os: Alibaba Cloud OS security reinforcement. Default value: `false`. Value:
...
class NodePool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            update_nodes: Optional[pulumi.Input[builtins.bool]] = None,
            user_data: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'NodePool':
        """
    ...
    @pulumi.getter(name="cisEnabled")
    @_utilities.deprecated("""Field 'cis_enabled' has been deprecated from provider version 1.223.1. Whether enable worker node to support cis security reinforcement, its valid value `true` or `false`. Default to `false` and apply to AliyunLinux series. Use `security_hardening_os` instead.""")
    def cis_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether enable worker node to support cis security reinforcement, its valid value `true` or `false`. Default to `false` and apply to AliyunLinux series. Use `security_hardening_os` instead.
        """
        return pulumi.get(self, "cis_enabled")
    ...
    @property
    @pulumi.getter(name="compensateWithOnDemand")
    def compensate_with_on_demand(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to automatically create pay-as-you-go instances to meet the required number of ECS instances if preemptible instances cannot be created due to reasons such as cost or insufficient inventory. This parameter takes effect when you set `multi_az_policy` to `COST_OPTIMIZED`. Valid values: `true`: automatically creates pay-as-you-go instances to meet the required number of ECS instances if preemptible instances cannot be created. `false`: does not create pay-as-you-go instances to meet the required number of ECS instances if preemptible instances cannot be created.
        """
        return pulumi.get(self, "compensate_with_on_demand")
    ...
    @property
    @pulumi.getter(name="cpuPolicy")
    def cpu_policy(self) -> pulumi.Output[builtins.str]:
        """
        Node CPU management policies. Default value: `none`. When the cluster version is 1.12.6 or later, the following two policies are supported:
        """
        return pulumi.get(self, "cpu_policy")
    ...
    @property
    @pulumi.getter(name="desiredSize")
    def desired_size(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Number of expected nodes in the node pool.
        """
        return pulumi.get(self, "desired_size")
    ...
    @property
    @pulumi.getter(name="formatDisk")
    def format_disk(self) -> pulumi.Output[builtins.bool]:
        """
        After you select this check box, if data disks have been attached to the specified ECS instances and the file system of the last data disk is uninitialized, the system automatically formats the last data disk to ext4 and mounts the data disk to /var/lib/docker and /var/lib/kubelet. The original data on the disk will be cleared. Make sure that you back up data in advance. If no data disk is mounted on the ECS instance, no new data disk will be purchased. Default is `false`.
        """
        return pulumi.get(self, "format_disk")
    ...
    @property
    @pulumi.getter(name="loginAsNonRoot")
    def login_as_non_root(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the ECS instance is logged on as a ecs-user user. Valid value: `true` and `false`.
        """
        return pulumi.get(self, "login_as_non_root")
    ...
    @property
    @pulumi.getter(name="nodeNameMode")
    def node_name_mode(self) -> pulumi.Output[builtins.str]:
        """
        Each node name consists of a prefix, its private network IP, and a suffix, separated by commas. The input format is `customized,,ip,`.
        - The prefix and suffix can be composed of one or more parts separated by '.', each part can use lowercase letters, numbers and '-', and the beginning and end of the node name must be lowercase letters and numbers.
        - The node IP address is the complete private IP address of the node.
    ...
    @property
    @pulumi.getter(name="onDemandBaseCapacity")
    def on_demand_base_capacity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The minimum number of pay-as-you-go instances that must be kept in the scaling group. Valid values: 0 to 1000. If the number of pay-as-you-go instances is less than the value of this parameter, Auto Scaling preferably creates pay-as-you-go instances.
        """
        return pulumi.get(self, "on_demand_base_capacity")
    ...
    @property
    @pulumi.getter(name="onDemandPercentageAboveBaseCapacity")
    def on_demand_percentage_above_base_capacity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The percentage of pay-as-you-go instances among the extra instances that exceed the number specified by `on_demand_base_capacity`. Valid values: 0 to 100.
        """
        return pulumi.get(self, "on_demand_percentage_above_base_capacity")
    ...
    @property
    @pulumi.getter(name="preUserData")
    def pre_user_data(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Node pre custom data, base64-encoded, the script executed before the node is initialized.
        """
        return pulumi.get(self, "pre_user_data")
    ...
    @property
    @pulumi.getter(name="securityHardeningOs")
    def security_hardening_os(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Alibaba Cloud OS security reinforcement. Default value: `false`. Value:
        """
        return pulumi.get(self, "security_hardening_os")
    ...
    @property
    @pulumi.getter(name="socEnabled")
    def soc_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether enable worker node to support soc security reinforcement, its valid value `true` or `false`. Default to `false` and apply to AliyunLinux series. See [SOC Reinforcement](https://help.aliyun.com/document_detail/196148.html).
    ...
    @property
    @pulumi.getter(name="spotInstancePools")
    def spot_instance_pools(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of instance types that are available. Auto Scaling creates preemptible instances of multiple instance types that are available at the lowest cost. Valid values: 1 to 10.
        """
        return pulumi.get(self, "spot_instance_pools")
    ...
    @property
    @pulumi.getter(name="spotInstanceRemedy")
    def spot_instance_remedy(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to supplement preemptible instances when the number of preemptible instances drops below the specified minimum number. If you set the value to true, Auto Scaling attempts to create a new preemptible instance when the system notifies that an existing preemptible instance is about to be reclaimed. Valid values: `true`: enables the supplementation of preemptible instances. `false`: disables the supplementation of preemptible instances.
        """
        return pulumi.get(self, "spot_instance_remedy")
    ...
    @property
    @pulumi.getter(name="systemDiskCategories")
    def system_disk_categories(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The multi-disk categories of the system disk. When a high-priority disk type cannot be used, Auto Scaling automatically tries to create a system disk with the next priority disk category. Valid values see `system_disk_category`.
        """
        return pulumi.get(self, "system_disk_categories")
    ...
    @property
    @pulumi.getter(name="systemDiskKmsKey")
    def system_disk_kms_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the KMS key used by the system disk.
        """
        return pulumi.get(self, "system_disk_kms_key")
    ...
    @property
    @pulumi.getter(name="systemDiskSnapshotPolicyId")
    def system_disk_snapshot_policy_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the automatic snapshot policy used by the system disk.
        """
        return pulumi.get(self, "system_disk_snapshot_policy_id")
    ...
    @property
    @pulumi.getter(name="updateNodes")
    def update_nodes(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Synchronously update node labels and taints.
        """
        return pulumi.get(self, "update_nodes")
