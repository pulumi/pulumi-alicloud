...
def get_registry_enterprise_instances(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.bool enable_details: Default to `true`. Set it to true can output instance authorization token.
    :param Sequence[builtins.str] ids: A list of ids to filter results by instance id.
...
def get_registry_enterprise_instances_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
