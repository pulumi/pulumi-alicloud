...
def get_registry_enterprise_instances(enable_details: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool enable_details: Default to `true`. Set it to true can output instance authorization token.
...
def get_registry_enterprise_instances_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
