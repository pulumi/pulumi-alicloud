...
def get_registry_enterprise_instances(ids=None,name_regex=None,output_file=None,opts=None):
    """
    ...
    :param list ids: A list of ids to filter results by instance id.
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:cs/getRegistryEnterpriseInstances:getRegistryEnterpriseInstances', __args__, opts=opts).value
