...
class ServerlessKubernetesArgs:
    def __init__(__self__, *,
                 ...
                 endpoint_public_access_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 kube_config: Optional[pulumi.Input[builtins.str]] = None,
                 load_balancer_spec: Optional[pulumi.Input[builtins.str]] = None,
                 logging_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 private_zone: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 service_discovery_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.bool] deletion_protection: Whether enable the deletion protection or not.
        ...
        :param pulumi.Input[builtins.str] name: The kubernetes cluster's name. It is the only in one Alicloud account.
        :param pulumi.Input[builtins.bool] new_nat_gateway: Whether to create a new nat gateway while creating kubernetes cluster. SNAT must be configured when a new VPC is automatically created. Default is `true`.
        :param pulumi.Input['ServerlessKubernetesOperationPolicyArgs'] operation_policy: The cluster automatic operation policy. See `operation_policy` below.
               ...
               *Removed params*
        :param pulumi.Input[builtins.bool] private_zone: Has been deprecated from provider version 1.123.1. `PrivateZone` is used as the enumeration value of `service_discovery_types`.
        ...
        :param pulumi.Input[builtins.str] service_cidr: CIDR block of the service network. The specified CIDR block cannot overlap with that of the VPC or those of the ACK clusters that are deployed in the VPC. The CIDR block cannot be modified after the cluster is created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] service_discovery_types: Service discovery type. Only works for **Create** Operation. If the value is empty, it means that service discovery is not enabled. Valid values are `CoreDNS` and `PrivateZone`.
        :param pulumi.Input[builtins.str] sls_project_name: If you use an existing SLS project, you must specify `sls_project_name`. Only works for **Create** Operation.
        ...
        :param pulumi.Input[builtins.str] time_zone: The time zone of the cluster.
        :param pulumi.Input[builtins.str] version: Desired Kubernetes version. If you do not specify a value, the latest available version at resource creation is used.  Do not specify if cluster auto upgrade is enabled, see cluster_auto_upgrade for more information.
        :param pulumi.Input[builtins.str] vpc_id: The vpc where new kubernetes cluster will be located. Specify one vpc's id, if it is not specified, a new VPC will be built.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vswitch_ids: The vswitches where new kubernetes cluster will be located.
        :param pulumi.Input[builtins.str] zone_id: When creating a cluster using automatic VPC creation, you need to specify the zone where the VPC is located. Only works for **Create** Operation.
        """
    ...
    def endpoint_public_access_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def endpoint_public_access_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def logging_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @logging_type.setter
    def logging_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def private_zone(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @private_zone.setter
    def private_zone(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def service_discovery_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def service_discovery_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ServerlessKubernetes(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ServerlessKubernetes':
        """
    ...
    @property
    @pulumi.getter(name="endpointPublicAccessEnabled")
    def endpoint_public_access_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to create internet eip for API Server. Default to false. Only works for **Create** Operation.
        """
        return pulumi.get(self, "endpoint_public_access_enabled")
    ...
    @pulumi.getter(name="loggingType")
    @_utilities.deprecated("""Field 'logging_type' has been deprecated from provider version 1.229.1. Please use addons `alibaba-log-controller` to enable logging.""")
    def logging_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Enable log service, Valid value `SLS`. Only works for **Create** Operation.
        """
        return pulumi.get(self, "logging_type")
    ...
    @pulumi.getter(name="privateZone")
    @_utilities.deprecated("""Field 'private_zone' has been deprecated from provider version 1.123.1. New field 'service_discovery_types' replace it.""")
    def private_zone(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Has been deprecated from provider version 1.123.1. `PrivateZone` is used as the enumeration value of `service_discovery_types`.
        """
        return pulumi.get(self, "private_zone")
    ...
    @property
    @pulumi.getter(name="serviceDiscoveryTypes")
    def service_discovery_types(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Service discovery type. Only works for **Create** Operation. If the value is empty, it means that service discovery is not enabled. Valid values are `CoreDNS` and `PrivateZone`.
        """
        return pulumi.get(self, "service_discovery_types")
    ...
    @pulumi.getter(name="slsProjectName")
    @_utilities.deprecated("""Field 'sls_project_name' has been deprecated from provider version 1.229.1. Please use the field `config` of addons `alibaba-log-controller` to specify log project name.""")
    def sls_project_name(self) -> pulumi.Output[builtins.str]:
        """
        If you use an existing SLS project, you must specify `sls_project_name`. Only works for **Create** Operation.
        """
        return pulumi.get(self, "sls_project_name")
