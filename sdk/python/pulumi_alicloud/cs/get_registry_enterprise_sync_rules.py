...
class GetRegistryEnterpriseSyncRulesResult:
    ...
    def target_instance_id(self) -> Optional[builtins.str]:
        """
...
def get_registry_enterprise_sync_rules(ids: Optional[Sequence[builtins.str]] = None,
                                       ...
                                       target_instance_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of ids to filter results by sync rule id.
    :param builtins.str instance_id: ID of Container Registry Enterprise Edition local instance.
    :param builtins.str name_regex: A regex string to filter results by sync rule name.
...
def get_registry_enterprise_sync_rules_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                              ...
                                              target_instance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
