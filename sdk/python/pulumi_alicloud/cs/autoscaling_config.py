...
class AutoscalingConfigArgs:
    def __init__(__self__, *,
                 ...
                 cool_down_duration: Optional[pulumi.Input[builtins.str]] = None,
                 daemonset_eviction_for_nodes: Optional[pulumi.Input[builtins.bool]] = None,
                 expander: Optional[pulumi.Input[builtins.str]] = None,
                 gpu_utilization_threshold: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 recycle_node_deletion_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 scale_down_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 scale_up_from_zero: Optional[pulumi.Input[builtins.bool]] = None,
                 scaler_type: Optional[pulumi.Input[builtins.str]] = None,
                 scan_interval: Optional[pulumi.Input[builtins.str]] = None,
                 skip_nodes_with_local_storage: Optional[pulumi.Input[builtins.bool]] = None,
                 skip_nodes_with_system_pods: Optional[pulumi.Input[builtins.bool]] = None,
                 unneeded_duration: Optional[pulumi.Input[builtins.str]] = None,
                 utilization_threshold: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] cool_down_duration: The cool down duration. Default is `10m`. If the delay (cooldown) value is set too long, there could be complaints that the Horizontal Pod Autoscaler is not responsive to workload changes. However, if the delay value is set too short, the scale of the replicas set may keep thrashing as usual.
        :param pulumi.Input[builtins.bool] daemonset_eviction_for_nodes: If true DaemonSet pods will be  terminated from nodes. Default is `false`.
        :param pulumi.Input[builtins.str] expander: The policy for selecting which node pool to scale. Valid values: `least-waste`, `random`, `priority`. For more information on these policies, see [Configure auto scaling](https://www.alibabacloud.com/help/en/container-service-for-kubernetes/latest/auto-scaling-of-nodes#section-3bg-2ko-inl)
        :param pulumi.Input[builtins.str] gpu_utilization_threshold: The scale-in threshold for GPU instance. Default is `0.5`.
        :param pulumi.Input[builtins.int] max_graceful_termination_sec: Maximum number of seconds CA waits for pod termination when trying to scale down a node. Default is `14400`.
        :param pulumi.Input[builtins.int] min_replica_count: Minimum number of replicas that a replica set or replication controller should have to allow their pods deletion in scale down. Default is `0`.
        :param pulumi.Input[builtins.bool] recycle_node_deletion_enabled: Should CA delete the K8s node object when recycle node has scaled down successfully. Default is `false`.
        :param pulumi.Input[builtins.bool] scale_down_enabled: Specify whether to allow the scale-in of nodes. Default is `true`.
        :param pulumi.Input[builtins.bool] scale_up_from_zero: Should CA scale up when there 0 ready nodes. Default is `true`.
        :param pulumi.Input[builtins.str] scaler_type: The type of autoscaler. Valid values: `cluster-autoscaler`, `goatscaler`. For cluster version 1.22 and below, we only support `cluster-autoscaler`.
        :param pulumi.Input[builtins.str] scan_interval: The interval at which the cluster is reevaluated for scaling. Default is `30s`.
        :param pulumi.Input[builtins.bool] skip_nodes_with_local_storage: If true cluster autoscaler will never delete nodes with pods with local storage, e.g. EmptyDir or HostPath. Default is `false`.
        :param pulumi.Input[builtins.bool] skip_nodes_with_system_pods: If true cluster autoscaler will never delete nodes with pods from kube-system (except for DaemonSet or mirror pods). Default is `true`.
        :param pulumi.Input[builtins.str] unneeded_duration: The unneeded duration. Default is `10m`.
        :param pulumi.Input[builtins.str] utilization_threshold: The scale-in threshold. Default is `0.5`.
        """
    ...
    def cool_down_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cool_down_duration(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cool_down_duration", value)

    @property
    @pulumi.getter(name="daemonsetEvictionForNodes")
    def daemonset_eviction_for_nodes(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def daemonset_eviction_for_nodes(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def gpu_utilization_threshold(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def gpu_utilization_threshold(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def recycle_node_deletion_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def recycle_node_deletion_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "recycle_node_deletion_enabled", value)

    @property
    @pulumi.getter(name="scaleDownEnabled")
    def scale_down_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def scale_down_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "scale_down_enabled", value)

    @property
    @pulumi.getter(name="scaleUpFromZero")
    def scale_up_from_zero(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def scale_up_from_zero(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def scan_interval(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def scan_interval(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scan_interval", value)

    @property
    @pulumi.getter(name="skipNodesWithLocalStorage")
    def skip_nodes_with_local_storage(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def skip_nodes_with_local_storage(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "skip_nodes_with_local_storage", value)

    @property
    @pulumi.getter(name="skipNodesWithSystemPods")
    def skip_nodes_with_system_pods(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def skip_nodes_with_system_pods(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "skip_nodes_with_system_pods", value)

    @property
    @pulumi.getter(name="unneededDuration")
    def unneeded_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def unneeded_duration(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "unneeded_duration", value)

    @property
    @pulumi.getter(name="utilizationThreshold")
    def utilization_threshold(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def utilization_threshold(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AutoscalingConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            skip_nodes_with_system_pods: Optional[pulumi.Input[builtins.bool]] = None,
            unneeded_duration: Optional[pulumi.Input[builtins.str]] = None,
            utilization_threshold: Optional[pulumi.Input[builtins.str]] = None) -> 'AutoscalingConfig':
        """
    ...
    @property
    @pulumi.getter(name="coolDownDuration")
    def cool_down_duration(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The cool down duration. Default is `10m`. If the delay (cooldown) value is set too long, there could be complaints that the Horizontal Pod Autoscaler is not responsive to workload changes. However, if the delay value is set too short, the scale of the replicas set may keep thrashing as usual.
        """
        return pulumi.get(self, "cool_down_duration")
    ...
    @property
    @pulumi.getter(name="daemonsetEvictionForNodes")
    def daemonset_eviction_for_nodes(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true DaemonSet pods will be  terminated from nodes. Default is `false`.
        """
        return pulumi.get(self, "daemonset_eviction_for_nodes")
    ...
    @property
    @pulumi.getter
    def expander(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The policy for selecting which node pool to scale. Valid values: `least-waste`, `random`, `priority`. For more information on these policies, see [Configure auto scaling](https://www.alibabacloud.com/help/en/container-service-for-kubernetes/latest/auto-scaling-of-nodes#section-3bg-2ko-inl)
        """
        return pulumi.get(self, "expander")
    ...
    @property
    @pulumi.getter(name="gpuUtilizationThreshold")
    def gpu_utilization_threshold(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The scale-in threshold for GPU instance. Default is `0.5`.
        """
        return pulumi.get(self, "gpu_utilization_threshold")
    ...
    @property
    @pulumi.getter(name="maxGracefulTerminationSec")
    def max_graceful_termination_sec(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum number of seconds CA waits for pod termination when trying to scale down a node. Default is `14400`.
        """
        return pulumi.get(self, "max_graceful_termination_sec")
    ...
    @property
    @pulumi.getter(name="minReplicaCount")
    def min_replica_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Minimum number of replicas that a replica set or replication controller should have to allow their pods deletion in scale down. Default is `0`.
        """
        return pulumi.get(self, "min_replica_count")
    ...
    @property
    @pulumi.getter(name="recycleNodeDeletionEnabled")
    def recycle_node_deletion_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should CA delete the K8s node object when recycle node has scaled down successfully. Default is `false`.
        """
        return pulumi.get(self, "recycle_node_deletion_enabled")
    ...
    @property
    @pulumi.getter(name="scaleDownEnabled")
    def scale_down_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specify whether to allow the scale-in of nodes. Default is `true`.
        """
        return pulumi.get(self, "scale_down_enabled")
    ...
    @property
    @pulumi.getter(name="scaleUpFromZero")
    def scale_up_from_zero(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should CA scale up when there 0 ready nodes. Default is `true`.
        """
        return pulumi.get(self, "scale_up_from_zero")
    ...
    @property
    @pulumi.getter(name="scanInterval")
    def scan_interval(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The interval at which the cluster is reevaluated for scaling. Default is `30s`.
        """
        return pulumi.get(self, "scan_interval")
    ...
    @property
    @pulumi.getter(name="skipNodesWithLocalStorage")
    def skip_nodes_with_local_storage(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true cluster autoscaler will never delete nodes with pods with local storage, e.g. EmptyDir or HostPath. Default is `false`.
        """
        return pulumi.get(self, "skip_nodes_with_local_storage")
    ...
    @property
    @pulumi.getter(name="skipNodesWithSystemPods")
    def skip_nodes_with_system_pods(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true cluster autoscaler will never delete nodes with pods from kube-system (except for DaemonSet or mirror pods). Default is `true`.
        """
        return pulumi.get(self, "skip_nodes_with_system_pods")
    ...
    @property
    @pulumi.getter(name="unneededDuration")
    def unneeded_duration(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The unneeded duration. Default is `10m`.
        """
        return pulumi.get(self, "unneeded_duration")
    ...
    @property
    @pulumi.getter(name="utilizationThreshold")
    def utilization_threshold(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The scale-in threshold. Default is `0.5`.
        """
        return pulumi.get(self, "utilization_threshold")
