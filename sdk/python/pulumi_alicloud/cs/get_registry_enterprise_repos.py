...
def get_registry_enterprise_repos(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.bool enable_details: Boolean, false by default, only repository attributes are exported. Set to true if tags belong to this repository are needed. See `tags` in attributes.
    :param Sequence[builtins.str] ids: A list of ids to filter results by repository id.
...
def get_registry_enterprise_repos_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
