...
class RegistryEnterpriseSyncRuleArgs:
    def __init__(__self__, *,
                 ...
                 tag_filter: pulumi.Input[builtins.str],
                 target_instance_id: pulumi.Input[builtins.str],
                 target_namespace_name: pulumi.Input[builtins.str],
                 target_region_id: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 repo_name: Optional[pulumi.Input[builtins.str]] = None,
                 sync_rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 sync_scope: Optional[pulumi.Input[builtins.str]] = None,
                 sync_trigger: Optional[pulumi.Input[builtins.str]] = None,
                 target_repo_name: Optional[pulumi.Input[builtins.str]] = None,
                 target_user_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RegistryEnterpriseSyncRule resource.
        :param pulumi.Input[builtins.str] instance_id: The ID of the Container Registry source instance.
        :param pulumi.Input[builtins.str] namespace_name: The namespace name of the source instance.
        :param pulumi.Input[builtins.str] tag_filter: The regular expression used to filter image tags.
        :param pulumi.Input[builtins.str] target_instance_id: The ID of the destination instance.
        :param pulumi.Input[builtins.str] target_namespace_name: The namespace name of the destination instance.
        :param pulumi.Input[builtins.str] target_region_id: The region ID of the destination instance.
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.240.0. New field `sync_rule_name` instead.
        :param pulumi.Input[builtins.str] repo_name: The image repository name of the source instance.
        :param pulumi.Input[builtins.str] sync_rule_name: The name of the sync rule.
        :param pulumi.Input[builtins.str] sync_scope: The synchronization scope. Valid values:
        ...
        :param pulumi.Input[builtins.str] sync_trigger: The policy configured to trigger the synchronization rule. Default value: `PASSIVE`. Valid values:
               - `INITIATIVE`: Manually triggers the synchronization rule.
               - `PASSIVE`: Automatically triggers the synchronization rule.
        :param pulumi.Input[builtins.str] target_repo_name: The image repository name of the destination instance.
        :param pulumi.Input[builtins.str] target_user_id: The UID of the account to which the target instance belongs.
        """
    ...
    def tag_filter(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @tag_filter.setter
    def tag_filter(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "tag_filter", value)

    @property
    @pulumi.getter(name="targetInstanceId")
    def target_instance_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_instance_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_instance_id", value)

    @property
    @pulumi.getter(name="targetNamespaceName")
    def target_namespace_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_namespace_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_namespace_name", value)

    @property
    @pulumi.getter(name="targetRegionId")
    def target_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_region_id(self, value: pulumi.Input[builtins.str]):
    ...
    def sync_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sync_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sync_rule_name", value)

    @property
    @pulumi.getter(name="syncScope")
    def sync_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sync_scope.setter
    def sync_scope(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sync_scope", value)

    @property
    @pulumi.getter(name="syncTrigger")
    def sync_trigger(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sync_trigger.setter
    def sync_trigger(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sync_trigger", value)

    @property
    @pulumi.getter(name="targetRepoName")
    def target_repo_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_repo_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_repo_name", value)

    @property
    @pulumi.getter(name="targetUserId")
    def target_user_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_user_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RegistryEnterpriseSyncRuleState:
    def __init__(__self__, *,
                 ...
                 repo_name: Optional[pulumi.Input[builtins.str]] = None,
                 repo_sync_rule_id: Optional[pulumi.Input[builtins.str]] = None,
                 rule_id: Optional[pulumi.Input[builtins.str]] = None,
                 sync_direction: Optional[pulumi.Input[builtins.str]] = None,
                 sync_rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 sync_scope: Optional[pulumi.Input[builtins.str]] = None,
                 sync_trigger: Optional[pulumi.Input[builtins.str]] = None,
                 tag_filter: Optional[pulumi.Input[builtins.str]] = None,
                 target_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_namespace_name: Optional[pulumi.Input[builtins.str]] = None,
                 target_region_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_repo_name: Optional[pulumi.Input[builtins.str]] = None,
                 target_user_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering RegistryEnterpriseSyncRule resources.
        :param pulumi.Input[builtins.str] create_time: (Available since v1.240.0) The time when the synchronization rule was created.
        :param pulumi.Input[builtins.str] instance_id: The ID of the Container Registry source instance.
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.240.0. New field `sync_rule_name` instead.
        :param pulumi.Input[builtins.str] namespace_name: The namespace name of the source instance.
        :param pulumi.Input[builtins.str] region_id: (Available since v1.240.0) The region ID of the source instance.
        :param pulumi.Input[builtins.str] repo_name: The image repository name of the source instance.
        :param pulumi.Input[builtins.str] repo_sync_rule_id: (Available since v1.240.0) The ID of the synchronization rule.
        :param pulumi.Input[builtins.str] rule_id: (Deprecated since v1.240.0) Field `rule_id` has been deprecated from provider version 1.240.0. New field `repo_sync_rule_id` instead.
        :param pulumi.Input[builtins.str] sync_direction: The synchronization direction.
        :param pulumi.Input[builtins.str] sync_rule_name: The name of the sync rule.
        :param pulumi.Input[builtins.str] sync_scope: The synchronization scope. Valid values:
               - `REPO`: Encrypts or decrypts data.
               - `NAMESPACE`: Generates or verifies a digital signature.
    ...
    def repo_sync_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def repo_sync_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sync_direction(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sync_direction(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="tagFilter")
    def tag_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The regular expression used to filter image tags.
        """
        return pulumi.get(self, "tag_filter")
    ...
    @tag_filter.setter
    def tag_filter(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tag_filter", value)

    @property
    @pulumi.getter(name="targetInstanceId")
    def target_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the destination instance.
        """
        return pulumi.get(self, "target_instance_id")
    ...
    @target_instance_id.setter
    def target_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_instance_id", value)

    @property
    @pulumi.getter(name="targetNamespaceName")
    def target_namespace_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The namespace name of the destination instance.
        """
        return pulumi.get(self, "target_namespace_name")
    ...
    @target_namespace_name.setter
    def target_namespace_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_namespace_name", value)

    @property
    @pulumi.getter(name="targetRegionId")
    def target_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The region ID of the destination instance.
        """
        return pulumi.get(self, "target_region_id")
    ...
    @target_region_id.setter
    def target_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_region_id", value)
...
class RegistryEnterpriseSyncRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_region_id: Optional[pulumi.Input[builtins.str]] = None,
            target_repo_name: Optional[pulumi.Input[builtins.str]] = None,
            target_user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RegistryEnterpriseSyncRule':
        """
    ...
    @property
    @pulumi.getter(name="repoName")
    def repo_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The image repository name of the source instance.
        """
        return pulumi.get(self, "repo_name")
    ...
    @property
    @pulumi.getter(name="repoSyncRuleId")
    def repo_sync_rule_id(self) -> pulumi.Output[builtins.str]:
        """
        (Available since v1.240.0) The ID of the synchronization rule.
        """
        return pulumi.get(self, "repo_sync_rule_id")
    ...
    @property
    @pulumi.getter(name="syncDirection")
    def sync_direction(self) -> pulumi.Output[builtins.str]:
        """
        The synchronization direction.
        """
        return pulumi.get(self, "sync_direction")
    ...
    @property
    @pulumi.getter(name="syncRuleName")
    def sync_rule_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the sync rule.
        """
        return pulumi.get(self, "sync_rule_name")
    ...
    @property
    @pulumi.getter(name="syncScope")
    def sync_scope(self) -> pulumi.Output[builtins.str]:
        """
        The synchronization scope. Valid values:
        - `REPO`: Encrypts or decrypts data.
        - `NAMESPACE`: Generates or verifies a digital signature.
    ...
    @property
    @pulumi.getter(name="syncTrigger")
    def sync_trigger(self) -> pulumi.Output[builtins.str]:
        """
        The policy configured to trigger the synchronization rule. Default value: `PASSIVE`. Valid values:
        - `INITIATIVE`: Manually triggers the synchronization rule.
        - `PASSIVE`: Automatically triggers the synchronization rule.
    ...
    @property
    @pulumi.getter(name="tagFilter")
    def tag_filter(self) -> pulumi.Output[builtins.str]:
        """
        The regular expression used to filter image tags.
        """
        return pulumi.get(self, "tag_filter")
    ...
    @property
    @pulumi.getter(name="targetInstanceId")
    def target_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the destination instance.
        """
        return pulumi.get(self, "target_instance_id")
    ...
    @property
    @pulumi.getter(name="targetNamespaceName")
    def target_namespace_name(self) -> pulumi.Output[builtins.str]:
        """
        The namespace name of the destination instance.
        """
        return pulumi.get(self, "target_namespace_name")
    ...
    @property
    @pulumi.getter(name="targetRegionId")
    def target_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The region ID of the destination instance.
        """
        return pulumi.get(self, "target_region_id")
    ...
    @property
    @pulumi.getter(name="targetRepoName")
    def target_repo_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The image repository name of the destination instance.
        """
        return pulumi.get(self, "target_repo_name")
    ...
    @property
    @pulumi.getter(name="targetUserId")
    def target_user_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The UID of the account to which the target instance belongs.
        """
        return pulumi.get(self, "target_user_id")
