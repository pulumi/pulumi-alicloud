...
class KubernetesAutoscalerArgs:
    def __init__(__self__, *,
                 ...
                 cool_down_duration: pulumi.Input[builtins.str],
                 defer_scale_in_duration: pulumi.Input[builtins.str],
                 utilization: pulumi.Input[builtins.str],
                 nodepools: Optional[pulumi.Input[Sequence[pulumi.Input['KubernetesAutoscalerNodepoolArgs']]]] = None,
                 use_ecs_ram_role_token: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] cool_down_duration: The cool_down_duration option of cluster-autoscaler.
        :param pulumi.Input[builtins.str] defer_scale_in_duration: The defer_scale_in_duration option of cluster-autoscaler.
        :param pulumi.Input[builtins.str] utilization: The utilization option of cluster-autoscaler.
        ...
        :param pulumi.Input[builtins.bool] use_ecs_ram_role_token: Enable autoscaler access to alibabacloud service by ecs ramrole token. default: false
        """
    ...
    def cool_down_duration(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cool_down_duration(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "cool_down_duration", value)

    @property
    @pulumi.getter(name="deferScaleInDuration")
    def defer_scale_in_duration(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def defer_scale_in_duration(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "defer_scale_in_duration", value)

    @property
    @pulumi.getter
    def utilization(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @utilization.setter
    def utilization(self, value: pulumi.Input[builtins.str]):
    ...
    def use_ecs_ram_role_token(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_ecs_ram_role_token(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _KubernetesAutoscalerState:
    def __init__(__self__, *,
                 ...
                 defer_scale_in_duration: Optional[pulumi.Input[builtins.str]] = None,
                 nodepools: Optional[pulumi.Input[Sequence[pulumi.Input['KubernetesAutoscalerNodepoolArgs']]]] = None,
                 use_ecs_ram_role_token: Optional[pulumi.Input[builtins.bool]] = None,
                 utilization: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="deferScaleInDuration")
    def defer_scale_in_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The defer_scale_in_duration option of cluster-autoscaler.
        """
        return pulumi.get(self, "defer_scale_in_duration")
    ...
    @defer_scale_in_duration.setter
    def defer_scale_in_duration(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "defer_scale_in_duration", value)
    ...
    @property
    @pulumi.getter
    def utilization(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The utilization option of cluster-autoscaler.
        """
        return pulumi.get(self, "utilization")
    ...
    @utilization.setter
    def utilization(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "utilization", value)
...
class KubernetesAutoscaler(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            nodepools: Optional[pulumi.Input[Sequence[pulumi.Input[Union['KubernetesAutoscalerNodepoolArgs', 'KubernetesAutoscalerNodepoolArgsDict']]]]] = None,
            use_ecs_ram_role_token: Optional[pulumi.Input[builtins.bool]] = None,
            utilization: Optional[pulumi.Input[builtins.str]] = None) -> 'KubernetesAutoscaler':
        """
    ...
    @property
    @pulumi.getter(name="coolDownDuration")
    def cool_down_duration(self) -> pulumi.Output[builtins.str]:
        """
        The cool_down_duration option of cluster-autoscaler.
        """
        return pulumi.get(self, "cool_down_duration")
    ...
    @property
    @pulumi.getter(name="deferScaleInDuration")
    def defer_scale_in_duration(self) -> pulumi.Output[builtins.str]:
        """
        The defer_scale_in_duration option of cluster-autoscaler.
        """
        return pulumi.get(self, "defer_scale_in_duration")
    ...
    @property
    @pulumi.getter(name="useEcsRamRoleToken")
    def use_ecs_ram_role_token(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable autoscaler access to alibabacloud service by ecs ramrole token. default: false
        """
        return pulumi.get(self, "use_ecs_ram_role_token")
    ...
    @property
    @pulumi.getter
    def utilization(self) -> pulumi.Output[builtins.str]:
        """
        The utilization option of cluster-autoscaler.
        """
        return pulumi.get(self, "utilization")
