...
class KubernetesAddonInitArgs:
    def __init__(__self__, *,
                 ...
                 cleanup_cloud_resources: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] cleanup_cloud_resources: Whether to clean up cloud resources when deleting. Currently only works for addon `ack-virtual-node` and you must specify it when uninstall addon `ack-virtual-node`. Valid values: `true`: clean up, `false`: do not clean up.
        :param pulumi.Input[builtins.str] config: The customized configuration of addon. Your customized configuration will be merged to existed configuration stored in server. If you want to clean one configuration, you must set the configuration to empty value, removing from code cannot make effect. You can checkout the customized configuration of the addon through datasource `cs_get_kubernetes_addon_metadata`, the returned format is the standard json schema. If return empty, it means that the addon does not support custom configuration yet. You can also checkout the current custom configuration through the data source `cs_get_kubernetes_addons`.
        :param pulumi.Input[builtins.str] name: The name of addon.
        :param pulumi.Input[builtins.str] version: The current version of addon.
        """
    ...
    def cleanup_cloud_resources(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def cleanup_cloud_resources(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _KubernetesAddonState:
    def __init__(__self__, *,
                 can_upgrade: Optional[pulumi.Input[builtins.bool]] = None,
                 cleanup_cloud_resources: Optional[pulumi.Input[builtins.bool]] = None,
                 cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                 config: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 next_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] can_upgrade: Is the addon ready for upgrade.
        :param pulumi.Input[builtins.bool] cleanup_cloud_resources: Whether to clean up cloud resources when deleting. Currently only works for addon `ack-virtual-node` and you must specify it when uninstall addon `ack-virtual-node`. Valid values: `true`: clean up, `false`: do not clean up.
        :param pulumi.Input[builtins.str] cluster_id: The id of kubernetes cluster.
        :param pulumi.Input[builtins.str] config: The customized configuration of addon. Your customized configuration will be merged to existed configuration stored in server. If you want to clean one configuration, you must set the configuration to empty value, removing from code cannot make effect. You can checkout the customized configuration of the addon through datasource `cs_get_kubernetes_addon_metadata`, the returned format is the standard json schema. If return empty, it means that the addon does not support custom configuration yet. You can also checkout the current custom configuration through the data source `cs_get_kubernetes_addons`.
        :param pulumi.Input[builtins.str] name: The name of addon.
        :param pulumi.Input[builtins.str] next_version: The version which addon can be upgraded to.
        :param pulumi.Input[builtins.bool] required: Is it a mandatory addon to be installed.
        :param pulumi.Input[builtins.str] version: The current version of addon.
        """
    ...
    def can_upgrade(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @can_upgrade.setter
    def can_upgrade(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def next_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @next_version.setter
    def next_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("alicloud:cs/kubernetesAddon:KubernetesAddon")
class KubernetesAddon(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            next_version: Optional[pulumi.Input[builtins.str]] = None,
            required: Optional[pulumi.Input[builtins.bool]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'KubernetesAddon':
        """
    ...
    @property
    @pulumi.getter(name="canUpgrade")
    def can_upgrade(self) -> pulumi.Output[builtins.bool]:
        """
        Is the addon ready for upgrade.
        """
        return pulumi.get(self, "can_upgrade")
    ...
    @property
    @pulumi.getter(name="cleanupCloudResources")
    def cleanup_cloud_resources(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to clean up cloud resources when deleting. Currently only works for addon `ack-virtual-node` and you must specify it when uninstall addon `ack-virtual-node`. Valid values: `true`: clean up, `false`: do not clean up.
        """
        return pulumi.get(self, "cleanup_cloud_resources")
    ...
    @property
    @pulumi.getter(name="nextVersion")
    def next_version(self) -> pulumi.Output[builtins.str]:
        """
        The version which addon can be upgraded to.
        """
        return pulumi.get(self, "next_version")
