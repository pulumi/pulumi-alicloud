...
def get_nacos_configs(accept_language: Optional[builtins.str] = None,
    ...
    :param builtins.str accept_language: The language type of the returned information. Valid values: `zh`, `en`.
    ...
    :param Sequence[builtins.str] ids: A list of MSE Engine Configs ids. It is formatted to `<instance_id>:<namespace_id>:<data_id>:<group>`.
...
def get_nacos_configs_output(accept_language: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             app_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             data_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
