...
class EngineNamespaceArgs:
    def __init__(__self__, *,
                 namespace_show_name: pulumi.Input[builtins.str],
                 accept_language: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 namespace_desc: Optional[pulumi.Input[builtins.str]] = None,
                 namespace_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EngineNamespace resource.
        :param pulumi.Input[builtins.str] namespace_show_name: The name of the Engine Namespace.
        :param pulumi.Input[builtins.str] accept_language: The language type of the returned information. Valid values: `zh`, `en`.
        :param pulumi.Input[builtins.str] cluster_id: The id of the cluster.It is formatted to `mse-xxxxxxxx`.
        :param pulumi.Input[builtins.str] instance_id: The instance id of the cluster. It is formatted to `mse-cn-xxxxxxxxxxx`.Available since v1.232.0.
        :param pulumi.Input[builtins.str] namespace_desc: The description of the namespace.
               
               **NOTE:** You must set `cluster_id` or `instance_id` or both.
        :param pulumi.Input[builtins.str] namespace_id: The id of Namespace.
        """
    ...
    def namespace_show_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def namespace_show_name(self, value: pulumi.Input[builtins.str]):
    ...
    def namespace_desc(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def namespace_desc(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EngineNamespaceState:
    def __init__(__self__, *,
                 ...
                 namespace_desc: Optional[pulumi.Input[builtins.str]] = None,
                 namespace_id: Optional[pulumi.Input[builtins.str]] = None,
                 namespace_show_name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="namespaceShowName")
    def namespace_show_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Engine Namespace.
        """
        return pulumi.get(self, "namespace_show_name")
    ...
    @namespace_show_name.setter
    def namespace_show_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "namespace_show_name", value)
...
class EngineNamespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace_desc: Optional[pulumi.Input[builtins.str]] = None,
            namespace_id: Optional[pulumi.Input[builtins.str]] = None,
            namespace_show_name: Optional[pulumi.Input[builtins.str]] = None) -> 'EngineNamespace':
        """
    ...
    @property
    @pulumi.getter(name="namespaceDesc")
    def namespace_desc(self) -> pulumi.Output[builtins.str]:
        """
        The description of the namespace.
    ...
    @property
    @pulumi.getter(name="namespaceShowName")
    def namespace_show_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Engine Namespace.
        """
        return pulumi.get(self, "namespace_show_name")
