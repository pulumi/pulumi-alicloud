...
class GatewaySlbListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] gateway_slb_status: The Status of the gateway slb.
        :param pulumi.Input[_builtins.str] gmt_create: The creation time of the gateway slb.
        :param pulumi.Input[_builtins.str] slb_id: The ID of the gateway slb.
        :param pulumi.Input[_builtins.str] slb_ip: The ip of the gateway slb.
        :param pulumi.Input[_builtins.str] slb_port: The port of the gateway slb.
        :param pulumi.Input[_builtins.str] type: The type of the gateway slb.
        """
