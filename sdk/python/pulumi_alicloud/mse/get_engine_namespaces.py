...
def get_engine_namespaces(accept_language: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Engine Namespace IDs. It is formatted to `<instance_id>:<namespace_id>`.
    :param builtins.str instance_id: The ID of the MSE Cluster Instance.It is formatted to `mse-cn-xxxxxxxxxxx`.Available since v1.232.0
...
def get_engine_namespaces_output(accept_language: Optional[pulumi.Input[Optional[builtins.str]]] = None,
