...
class GetGatewaysResult:
    ...
    def gateway_name(self) -> Optional[builtins.str]:
...
def get_gateways(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Gateway IDs.
    :param builtins.str name_regex: A regex string to filter results by Gateway name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the gateway. Valid values: `0`, `1`, `2`, `3`, `4`, `6`, `8`, `9`, `10`, `11`, `12`, `13`.
...
def get_gateways_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                        gateway_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
