...
class GetClustersResult:
    ...
    def cluster_alias_name(self) -> Optional[builtins.str]:
    ...
    def request_pars(self) -> Optional[builtins.str]:
...
def get_clusters(cluster_alias_name: Optional[builtins.str] = None,
                 ...
                 request_pars: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_alias_name: The alias name of MSE Cluster.
    :param builtins.bool enable_details: Default to `false`. Set it to `true` can output more details about resource attributes.
    :param Sequence[builtins.str] ids: A list of MSE Cluster ids. It is formatted to `<instance_id>`
    :param builtins.str name_regex: A regex string to filter the results by the cluster alias name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str request_pars: The extended request parameters. The JSON format is supported.
...
def get_clusters_output(cluster_alias_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        ...
                        request_pars: Optional[pulumi.Input[Optional[builtins.str]]] = None,
