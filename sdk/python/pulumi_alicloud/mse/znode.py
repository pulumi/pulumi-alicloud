...
class ZnodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] path: The Node path. The value must start with a forward slash (/).
        :param pulumi.Input[builtins.str] accept_language: The language type of the returned information. Valid values: `zh` or `en`.
        :param pulumi.Input[builtins.str] data: The Node data.
        """
...
class Znode(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cluster_id: Optional[pulumi.Input[builtins.str]] = None,
            data: Optional[pulumi.Input[builtins.str]] = None,
            path: Optional[pulumi.Input[builtins.str]] = None) -> 'Znode':
        """
