...
def get_znodes(accept_language: Optional[builtins.str] = None,
    ...
    :param builtins.str accept_language: The language type of the returned information. Valid values: `zh` or `en`.
    :param builtins.str cluster_id: The ID of the Cluster.
    :param Sequence[builtins.str] ids: A list of Znode IDs.
    :param builtins.str name_regex: A regex string to filter results by Znode name.
...
def get_znodes_output(accept_language: Optional[pulumi.Input[Optional[builtins.str]]] = None,
