...
class ClusterArgs:
    def __init__(__self__, *,
                 cluster_specification: pulumi.Input[builtins.str],
                 ...
                 pub_network_flow: pulumi.Input[builtins.str],
                 acl_entry_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 cluster_alias_name: Optional[pulumi.Input[builtins.str]] = None,
                 connection_type: Optional[pulumi.Input[builtins.str]] = None,
                 disk_type: Optional[pulumi.Input[builtins.str]] = None,
                 mse_version: Optional[pulumi.Input[builtins.str]] = None,
                 payment_type: Optional[pulumi.Input[builtins.str]] = None,
                 private_slb_specification: Optional[pulumi.Input[builtins.str]] = None,
                 pub_slb_specification: Optional[pulumi.Input[builtins.str]] = None,
                 request_pars: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_specification: The engine specification of MSE Cluster. **NOTE:** From version 1.188.0, `cluster_specification` can be modified. If you were an international user, please use the specification version ending with `_200_c`.Valid values:
        ...
        :param pulumi.Input[builtins.str] cluster_type: The type of MSE Cluster.
        :param pulumi.Input[builtins.str] cluster_version: The version of MSE Cluster. See [details](https://www.alibabacloud.com/help/en/mse/developer-reference/api-mse-2019-05-31-createcluster)
        :param pulumi.Input[builtins.int] instance_count: The count of instance. **NOTE:** From version 1.188.0, `instance_count` can be modified.
        :param pulumi.Input[builtins.str] net_type: The type of network. Valid values: `privatenet` and `pubnet` and `both`(Available since v1.232.0).
        :param pulumi.Input[builtins.str] pub_network_flow: The public network bandwidth.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] acl_entry_lists: The whitelist. **NOTE:** This attribute is invalid when the value of `pub_network_flow` is `0` and the value of `net_type` is `privatenet`.
        :param pulumi.Input[builtins.str] cluster_alias_name: The alias of MSE Cluster.
        :param pulumi.Input[builtins.str] connection_type: The connection type. Valid values: `slb`,`single_eni`(Available since v1.232.0). If your region is one of `ap-southeast-6、us-west-1、eu-central-1、us-east-1、ap-southeast-1`,and your cluster's mse_version is `mse_dev`,please use `single_eni`.
        :param pulumi.Input[builtins.str] disk_type: The type of Disk.
        :param pulumi.Input[builtins.str] mse_version: The version of MSE. Valid values: `mse_dev` or `mse_pro` or `mse_serverless`(Available since v1.232.0).
        :param pulumi.Input[builtins.str] payment_type: Payment type: Subscription (prepaid), PayAsYouGo (postpaid). Default PayAsYouGo.
        :param pulumi.Input[builtins.str] private_slb_specification: The specification of private network SLB.
        :param pulumi.Input[builtins.str] pub_slb_specification: The specification of public network SLB. Serverless Instance could ignore this parameter.
        :param pulumi.Input[builtins.str] request_pars: The extended request parameters in the JSON format.
        :param pulumi.Input[builtins.str] resource_group_id: The resource group of the resource.
    ...
    def cluster_specification(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cluster_specification(self, value: pulumi.Input[builtins.str]):
    ...
    def pub_network_flow(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def pub_network_flow(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "pub_network_flow", value)

    @property
    @pulumi.getter(name="aclEntryLists")
    def acl_entry_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def acl_entry_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "acl_entry_lists", value)

    @property
    @pulumi.getter(name="clusterAliasName")
    def cluster_alias_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cluster_alias_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def mse_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @mse_version.setter
    def mse_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def private_slb_specification(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_slb_specification(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "private_slb_specification", value)

    @property
    @pulumi.getter(name="pubSlbSpecification")
    def pub_slb_specification(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def pub_slb_specification(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pub_slb_specification", value)

    @property
    @pulumi.getter(name="requestPars")
    def request_pars(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @request_pars.setter
    def request_pars(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ClusterState:
    def __init__(__self__, *,
                 ...
                 cluster_specification: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 payment_type: Optional[pulumi.Input[builtins.str]] = None,
                 private_slb_specification: Optional[pulumi.Input[builtins.str]] = None,
                 pub_network_flow: Optional[pulumi.Input[builtins.str]] = None,
                 pub_slb_specification: Optional[pulumi.Input[builtins.str]] = None,
                 request_pars: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] acl_entry_lists: The whitelist. **NOTE:** This attribute is invalid when the value of `pub_network_flow` is `0` and the value of `net_type` is `privatenet`.
        :param pulumi.Input[builtins.str] app_version: (Available since v1.205.0) The application version.
        :param pulumi.Input[builtins.str] cluster_alias_name: The alias of MSE Cluster.
        :param pulumi.Input[builtins.str] cluster_id: (Available since v1.162.0) The cluster id of Cluster.
        :param pulumi.Input[builtins.str] cluster_specification: The engine specification of MSE Cluster. **NOTE:** From version 1.188.0, `cluster_specification` can be modified. If you were an international user, please use the specification version ending with `_200_c`.Valid values:
               - Professional Edition
               - `MSE_SC_1_2_60_c`: 1C2G
               - `MSE_SC_2_4_60_c`: 2C4G
        ...
        :param pulumi.Input[builtins.str] request_pars: The extended request parameters in the JSON format.
        :param pulumi.Input[builtins.str] resource_group_id: The resource group of the resource.
        :param pulumi.Input[builtins.str] status: The status of MSE Cluster.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the resource.
        :param pulumi.Input[builtins.str] vpc_id: The id of the VPC.
        :param pulumi.Input[builtins.str] vswitch_id: The id of VSwitch.
        """
    ...
    @property
    @pulumi.getter(name="clusterSpecification")
    def cluster_specification(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The engine specification of MSE Cluster. **NOTE:** From version 1.188.0, `cluster_specification` can be modified. If you were an international user, please use the specification version ending with `_200_c`.Valid values:
        - Professional Edition
        - `MSE_SC_1_2_60_c`: 1C2G
    ...
    @cluster_specification.setter
    def cluster_specification(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cluster_specification", value)
    ...
    @property
    @pulumi.getter(name="pubNetworkFlow")
    def pub_network_flow(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The public network bandwidth.
        """
        return pulumi.get(self, "pub_network_flow")
    ...
    @pub_network_flow.setter
    def pub_network_flow(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pub_network_flow", value)
...
class Cluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="aclEntryLists")
    def acl_entry_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The whitelist. **NOTE:** This attribute is invalid when the value of `pub_network_flow` is `0` and the value of `net_type` is `privatenet`.
        """
        return pulumi.get(self, "acl_entry_lists")
    ...
    @property
    @pulumi.getter(name="appVersion")
    def app_version(self) -> pulumi.Output[builtins.str]:
        """
        (Available since v1.205.0) The application version.
        """
        return pulumi.get(self, "app_version")
    ...
    @property
    @pulumi.getter(name="clusterAliasName")
    def cluster_alias_name(self) -> pulumi.Output[builtins.str]:
        """
        The alias of MSE Cluster.
        """
        return pulumi.get(self, "cluster_alias_name")
    ...
    @property
    @pulumi.getter(name="clusterSpecification")
    def cluster_specification(self) -> pulumi.Output[builtins.str]:
        """
        The engine specification of MSE Cluster. **NOTE:** From version 1.188.0, `cluster_specification` can be modified. If you were an international user, please use the specification version ending with `_200_c`.Valid values:
        - Professional Edition
        - `MSE_SC_1_2_60_c`: 1C2G
    ...
    @property
    @pulumi.getter(name="mseVersion")
    def mse_version(self) -> pulumi.Output[builtins.str]:
        """
        The version of MSE. Valid values: `mse_dev` or `mse_pro` or `mse_serverless`(Available since v1.232.0).
        """
        return pulumi.get(self, "mse_version")
    ...
    @property
    @pulumi.getter(name="privateSlbSpecification")
    def private_slb_specification(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The specification of private network SLB.
        """
        return pulumi.get(self, "private_slb_specification")
    ...
    @property
    @pulumi.getter(name="pubNetworkFlow")
    def pub_network_flow(self) -> pulumi.Output[builtins.str]:
        """
        The public network bandwidth.
        """
        return pulumi.get(self, "pub_network_flow")
    ...
    @property
    @pulumi.getter(name="pubSlbSpecification")
    def pub_slb_specification(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The specification of public network SLB. Serverless Instance could ignore this parameter.
        """
        return pulumi.get(self, "pub_slb_specification")
    ...
    @property
    @pulumi.getter(name="requestPars")
    def request_pars(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The extended request parameters in the JSON format.
        """
        return pulumi.get(self, "request_pars")
