...
class GetChangeSetsResult:
    ...
    def change_set_name(self) -> Optional[_builtins.str]:
...
def get_change_sets(change_set_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Change Set IDs.
    :param _builtins.str name_regex: A regex string to filter results by Change Set name.
    ...
    :param _builtins.str status: The status of the change set. Valid Value: `CREATE_COMPLETE`, `CREATE_FAILED`, `CREATE_IN_PROGRESS`, `CREATE_PENDING`, `DELETE_COMPLETE` and `DELETE_FAILED`.
    """
    __args__ = dict()
