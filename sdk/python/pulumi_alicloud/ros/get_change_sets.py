...
class GetChangeSetsResult:
    ...
    def change_set_name(self) -> Optional[builtins.str]:
...
def get_change_sets(change_set_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Change Set IDs.
    :param builtins.str name_regex: A regex string to filter results by Change Set name.
    ...
    :param builtins.str status: The status of the change set. Valid Value: `CREATE_COMPLETE`, `CREATE_FAILED`, `CREATE_IN_PROGRESS`, `CREATE_PENDING`, `DELETE_COMPLETE` and `DELETE_FAILED`.
    """
    __args__ = dict()
...
def get_change_sets_output(change_set_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
