...
class TemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] template_name: The name of the template. The name can be up to 255 characters in length and can contain digits, letters, hyphens (-), and underscores (_). It must start with a digit or letter.
        :param pulumi.Input[builtins.str] description: The description of the template. The description can be up to 256 characters in length.
...
class Template(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:ros/template:Template"
    ...
    def get(resource_name: str,
            ...
            template_body: Optional[pulumi.Input[builtins.str]] = None,
            template_name: Optional[pulumi.Input[builtins.str]] = None,
            template_url: Optional[pulumi.Input[builtins.str]] = None) -> 'Template':
        """
