...
class GetStackInstancesResult:
    ...
    def stack_instance_account_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "stack_instance_account_id")

    @property
    @pulumi.getter(name="stackInstanceRegionId")
    def stack_instance_region_id(self) -> Optional[builtins.str]:
...
def get_stack_instances(enable_details: Optional[builtins.bool] = None,
                        ids: Optional[Sequence[builtins.str]] = None,
                        output_file: Optional[builtins.str] = None,
                        stack_group_name: Optional[builtins.str] = None,
                        stack_instance_account_id: Optional[builtins.str] = None,
                        stack_instance_region_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Stack Instance IDs.
...
def get_stack_instances_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                               ...
                               stack_group_name: Optional[pulumi.Input[builtins.str]] = None,
                               stack_instance_account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               stack_instance_region_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
