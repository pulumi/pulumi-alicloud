...
class StackGroupArgs:
    def __init__(__self__, *,
                 stack_group_name: pulumi.Input[builtins.str],
                 account_ids: Optional[pulumi.Input[builtins.str]] = None,
                 administration_role_name: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 execution_role_name: Optional[pulumi.Input[builtins.str]] = None,
                 operation_description: Optional[pulumi.Input[builtins.str]] = None,
                 operation_preferences: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input['StackGroupParameterArgs']]]] = None,
                 region_ids: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] stack_group_name: The name of the stack group. The name must be unique in a region.
        :param pulumi.Input[builtins.str] account_ids: The list of target account IDs, in JSON format. A maximum of 20 accounts can be specified.
        :param pulumi.Input[builtins.str] administration_role_name: The name of the RAM administrator role assumed by ROS. ROS assumes this role to perform operations on the stack corresponding to the stack instance in the stack group.
        :param pulumi.Input[builtins.str] description: The description of the stack group.
        :param pulumi.Input[builtins.str] execution_role_name: The name of the RAM execution role assumed by the administrator role. ROS assumes this role to perform operations on the stack corresponding to the stack instance in the stack group.
        :param pulumi.Input[builtins.str] operation_description: The description of the operation.
        :param pulumi.Input[builtins.str] operation_preferences: The operation settings, in JSON format.
        ...
        :param pulumi.Input[builtins.str] region_ids: The list of target regions, in JSON format. A maximum of 20 accounts can be specified.
    ...
    def stack_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def stack_group_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "stack_group_name", value)

    @property
    @pulumi.getter(name="accountIds")
    def account_ids(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @account_ids.setter
    def account_ids(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "account_ids", value)

    @property
    @pulumi.getter(name="administrationRoleName")
    def administration_role_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def administration_role_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def execution_role_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def execution_role_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "execution_role_name", value)

    @property
    @pulumi.getter(name="operationDescription")
    def operation_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def operation_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "operation_description", value)

    @property
    @pulumi.getter(name="operationPreferences")
    def operation_preferences(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def operation_preferences(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def region_ids(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @region_ids.setter
    def region_ids(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _StackGroupState:
    def __init__(__self__, *,
                 ...
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input['StackGroupParameterArgs']]]] = None,
                 region_ids: Optional[pulumi.Input[builtins.str]] = None,
                 stack_group_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['StackGroupParameterArgs']]] parameters: The parameters. If the parameter name and value are not specified, ROS will use the default value specified in the template.
        :param pulumi.Input[builtins.str] region_ids: The list of target regions, in JSON format. A maximum of 20 accounts can be specified.
        :param pulumi.Input[builtins.str] stack_group_id: The id of Stack Group.
        :param pulumi.Input[builtins.str] stack_group_name: The name of the stack group. The name must be unique in a region.
        :param pulumi.Input[builtins.str] status: The status of Stack Group.
        :param pulumi.Input[builtins.str] template_body: The structure that contains the template body. The template body must be 1 to 524,288 bytes in length. If the length of the template body is longer than required, we recommend that you add parameters to the HTTP POST request body to avoid request failures due to excessive length of URLs.
        :param pulumi.Input[builtins.str] template_url: The URL of the file that contains the template body. The URL must point to a template located in an HTTP or HTTPS web server or an Alibaba Cloud OSS bucket. Examples: oss://ros/template/demo and oss://ros/template/demo?RegionId=cn-hangzhou. The template must be 1 to 524,288 bytes in length. If the region of the OSS bucket is not specified, the RegionId value is used by default.
        :param pulumi.Input[builtins.str] template_version: The version of the template.
        """
    ...
    def stack_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def stack_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stack_group_id", value)

    @property
    @pulumi.getter(name="stackGroupName")
    def stack_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the stack group. The name must be unique in a region.
        """
        return pulumi.get(self, "stack_group_name")
    ...
    @stack_group_name.setter
    def stack_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stack_group_name", value)
...
class StackGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            template_body: Optional[pulumi.Input[builtins.str]] = None,
            template_url: Optional[pulumi.Input[builtins.str]] = None,
            template_version: Optional[pulumi.Input[builtins.str]] = None) -> 'StackGroup':
        """
    ...
    @property
    @pulumi.getter(name="accountIds")
    def account_ids(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The list of target account IDs, in JSON format. A maximum of 20 accounts can be specified.
        """
        return pulumi.get(self, "account_ids")
    ...
    @property
    @pulumi.getter(name="administrationRoleName")
    def administration_role_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the RAM administrator role assumed by ROS. ROS assumes this role to perform operations on the stack corresponding to the stack instance in the stack group.
        """
        return pulumi.get(self, "administration_role_name")
    ...
    @property
    @pulumi.getter(name="executionRoleName")
    def execution_role_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the RAM execution role assumed by the administrator role. ROS assumes this role to perform operations on the stack corresponding to the stack instance in the stack group.
        """
        return pulumi.get(self, "execution_role_name")
    ...
    @property
    @pulumi.getter(name="operationDescription")
    def operation_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the operation.
        """
        return pulumi.get(self, "operation_description")
    ...
    @property
    @pulumi.getter(name="operationPreferences")
    def operation_preferences(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The operation settings, in JSON format.
        """
        return pulumi.get(self, "operation_preferences")
    ...
    @property
    @pulumi.getter(name="regionIds")
    def region_ids(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The list of target regions, in JSON format. A maximum of 20 accounts can be specified.
        """
        return pulumi.get(self, "region_ids")
    ...
    @property
    @pulumi.getter(name="stackGroupId")
    def stack_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of Stack Group.
        """
        return pulumi.get(self, "stack_group_id")
    ...
    @property
    @pulumi.getter(name="stackGroupName")
    def stack_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the stack group. The name must be unique in a region.
        """
        return pulumi.get(self, "stack_group_name")
