...
class ChangeSetParameterArgs:
    def __init__(__self__, *,
                 ...
                 parameter_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] parameter_key: The parameter key.
...
class StackInstanceParameterOverrideArgs:
    def __init__(__self__, *,
                 ...
                 parameter_value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] parameter_key: The key of override parameter. If you do not specify the key and value of the parameter, ROS uses the key and value that you specified when you created the stack group.
        :param pulumi.Input[builtins.str] parameter_value: The value of override parameter. If you do not specify the key and value of the parameter, ROS uses the key and value that you specified when you created the stack group.
        """
        if parameter_key is not None:
            pulumi.set(__self__, "parameter_key", parameter_key)
        if parameter_value is not None:
...
class TemplateScratchPreferenceParameterArgs:
    def __init__(__self__, *,
                 ...
                 parameter_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] parameter_key: Priority parameter key. For more information about values, see [supplementary instructions for request parameters](https://www.alibabacloud.com/help/zh/doc-detail/358846.html#h2-url-4).
        :param pulumi.Input[builtins.str] parameter_value: Priority parameter value. For more information about values, see [supplementary instructions for request parameters](https://www.alibabacloud.com/help/zh/doc-detail/358846.html#h2-url-4).
        """
        pulumi.set(__self__, "parameter_key", parameter_key)
        pulumi.set(__self__, "parameter_value", parameter_value)
...
class TemplateScratchSourceResourceArgs:
    def __init__(__self__, *,
                 ...
                 resource_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] resource_id: The ID of the Source Resource.
        :param pulumi.Input[builtins.str] resource_type: The type of the Source resource.
        """
...
if not MYPY:
    class TemplateScratchSourceResourceGroupArgsDict(TypedDict):
        ...
        """
        resource_type_filters: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
elif False:
...
class TemplateScratchSourceResourceGroupArgs:
    def __init__(__self__, *,
                 resource_group_id: pulumi.Input[builtins.str],
                 resource_type_filters: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the Source Resource Group.
        """
    ...
    def resource_type_filters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "resource_type_filters")

    @resource_type_filters.setter
    def resource_type_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "resource_type_filters", value)


if not MYPY:
    class TemplateScratchSourceTagArgsDict(TypedDict):
        resource_tags: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]
        """
...
class TemplateScratchSourceTagArgs:
    def __init__(__self__, *,
                 ...
                 resource_type_filters: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] resource_tags: Source label. **NOTE:** A maximum of 10 source labels can be configured.
        """
    ...
    def resource_tags(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
        Source label. **NOTE:** A maximum of 10 source labels can be configured.
        """
    ...
    def resource_tags(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
