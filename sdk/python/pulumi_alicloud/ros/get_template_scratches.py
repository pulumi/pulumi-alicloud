...
class GetTemplateScratchesResult:
    ...
    def template_scratch_type(self) -> Optional[builtins.str]:
...
def get_template_scratches(enable_details: Optional[builtins.bool] = None,
                           ids: Optional[Sequence[builtins.str]] = None,
                           output_file: Optional[builtins.str] = None,
                           status: Optional[builtins.str] = None,
                           template_scratch_type: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Template Scratch IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the resource. Valid Values: `GENERATE_IN_PROGRESS`, `GENERATE_COMPLETE` and `GENERATE_FAILED`.
    :param builtins.str template_scratch_type: The type of the template scratch. Valid Values: `ResourceImport`, `ArchitectureReplication`.
    """
    __args__ = dict()
...
def get_template_scratches_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                  ...
                                  template_scratch_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
