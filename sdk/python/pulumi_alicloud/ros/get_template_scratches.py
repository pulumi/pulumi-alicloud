...
class GetTemplateScratchesResult:
    ...
    def template_scratch_type(self) -> Optional[_builtins.str]:
...
def get_template_scratches(enable_details: Optional[_builtins.bool] = None,
                           ids: Optional[Sequence[_builtins.str]] = None,
                           output_file: Optional[_builtins.str] = None,
                           status: Optional[_builtins.str] = None,
                           template_scratch_type: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Template Scratch IDs.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str status: The status of the resource. Valid Values: `GENERATE_IN_PROGRESS`, `GENERATE_COMPLETE` and `GENERATE_FAILED`.
    :param _builtins.str template_scratch_type: The type of the template scratch. Valid Values: `ResourceImport`, `ArchitectureReplication`.
    """
    __args__ = dict()
