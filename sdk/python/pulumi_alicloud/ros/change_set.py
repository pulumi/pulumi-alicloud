...
class ChangeSetArgs:
    def __init__(__self__, *,
                 change_set_name: pulumi.Input[_builtins.str],
                 change_set_type: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] stack_name: The name of the stack for which you want to create the change set.  The name can be up to 255 characters in length and can contain digits, letters, hyphens (-), and underscores (_). It must start with a digit or letter.  Note This parameter takes effect only when ChangeSetType is set to CREATE or IMPORT.
        :param pulumi.Input[_builtins.str] stack_policy_body: The stack policy body.
        :param pulumi.Input[_builtins.str] stack_policy_during_update_body: The stack policy during update body.
        :param pulumi.Input[_builtins.str] stack_policy_during_update_url: The stack policy during update url.
        :param pulumi.Input[_builtins.str] stack_policy_url: The stack policy url.
        ...
        :param pulumi.Input[_builtins.int] timeout_in_minutes: Timeout In Minutes.
        :param pulumi.Input[_builtins.bool] use_previous_parameters: The use previous parameters.
        """
    ...
    def change_set_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def change_set_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "change_set_name", value)

    @_builtins.property
    @pulumi.getter(name="changeSetType")
    def change_set_type(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def change_set_type(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class _ChangeSetState:
    def __init__(__self__, *,
                 change_set_name: Optional[pulumi.Input[_builtins.str]] = None,
                 change_set_type: Optional[pulumi.Input[_builtins.str]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 disable_rollback: Optional[pulumi.Input[_builtins.bool]] = None,
                 notification_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] stack_policy_during_update_url: The stack policy during update url.
        :param pulumi.Input[_builtins.str] stack_policy_url: The stack policy url.
        :param pulumi.Input[_builtins.str] status: The status of the change set.
        :param pulumi.Input[_builtins.str] template_body: The structure that contains the template body. The template body must be 1 to 524,288 bytes in length.  If the length of the template body is longer than required, we recommend that you add parameters to the HTTP POST request body to avoid request failures due to excessive length of URLs.  You can specify one of TemplateBody or TemplateURL parameters, but you cannot specify both of them.
        :param pulumi.Input[_builtins.str] template_url: The template url.
        :param pulumi.Input[_builtins.int] timeout_in_minutes: Timeout In Minutes.
        :param pulumi.Input[_builtins.bool] use_previous_parameters: The use previous parameters.
    ...
    @_builtins.property
    @pulumi.getter(name="changeSetName")
    def change_set_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The name of the change set.  The name can be up to 255 characters in length and can contain digits, letters, hyphens (-), and underscores (_). It must start with a digit or letter.
        """
        return pulumi.get(self, "change_set_name")
    ...
    @change_set_name.setter
    def change_set_name(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "change_set_name", value)
...
class ChangeSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            template_url: Optional[pulumi.Input[_builtins.str]] = None,
            timeout_in_minutes: Optional[pulumi.Input[_builtins.int]] = None,
            use_previous_parameters: Optional[pulumi.Input[_builtins.bool]] = None) -> 'ChangeSet':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="changeSetType")
    def change_set_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The type of the change set. Valid values:  CREATE: creates a change set for a new stack. UPDATE: creates a change set for an existing stack. IMPORT: creates a change set for a new stack or an existing stack to import non-ROS-managed resources. If you create a change set for a new stack, ROS creates a stack that has a unique stack ID. The stack is in the REVIEW_IN_PROGRESS state until you execute the change set.  You cannot use the UPDATE type to create a change set for a new stack or the CREATE type to create a change set for an existing stack.
        """
        return pulumi.get(self, "change_set_type")
    ...
    @_builtins.property
    @pulumi.getter(name="timeoutInMinutes")
    def timeout_in_minutes(self) -> pulumi.Output[_builtins.int]:
        """
        Timeout In Minutes.
        """
        return pulumi.get(self, "timeout_in_minutes")
