...
class ChangeSetArgs:
    def __init__(__self__, *,
                 change_set_name: pulumi.Input[builtins.str],
                 change_set_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] change_set_name: The name of the change set.  The name can be up to 255 characters in length and can contain digits, letters, hyphens (-), and underscores (_). It must start with a digit or letter.
        :param pulumi.Input[builtins.str] change_set_type: The type of the change set. Valid values:  CREATE: creates a change set for a new stack. UPDATE: creates a change set for an existing stack. IMPORT: creates a change set for a new stack or an existing stack to import non-ROS-managed resources. If you create a change set for a new stack, ROS creates a stack that has a unique stack ID. The stack is in the REVIEW_IN_PROGRESS state until you execute the change set.  You cannot use the UPDATE type to create a change set for a new stack or the CREATE type to create a change set for an existing stack.
        :param pulumi.Input[builtins.str] description: The description of the change set. The description can be up to 1,024 bytes in length.
        :param pulumi.Input[builtins.bool] disable_rollback: Specifies whether to disable rollback on stack creation failure. Default value: false.  Valid values:  true: disables rollback on stack creation failure. false: enables rollback on stack creation failure. Note This parameter takes effect only when ChangeSetType is set to CREATE or IMPORT.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] notification_urls: The notification urls.
        :param pulumi.Input[Sequence[pulumi.Input['ChangeSetParameterArgs']]] parameters: Parameters.
        :param pulumi.Input[builtins.str] ram_role_name: The ram role name.
        :param pulumi.Input[builtins.str] replacement_option: The replacement option.
        :param pulumi.Input[builtins.str] stack_id: The ID of the stack for which you want to create the change set. ROS generates the change set by comparing the stack information with the information that you submit, such as a modified template or different inputs.
        :param pulumi.Input[builtins.str] stack_name: The name of the stack for which you want to create the change set.  The name can be up to 255 characters in length and can contain digits, letters, hyphens (-), and underscores (_). It must start with a digit or letter.  Note This parameter takes effect only when ChangeSetType is set to CREATE or IMPORT.
        :param pulumi.Input[builtins.str] stack_policy_body: The stack policy body.
        :param pulumi.Input[builtins.str] stack_policy_during_update_body: The stack policy during update body.
        :param pulumi.Input[builtins.str] stack_policy_during_update_url: The stack policy during update url.
        :param pulumi.Input[builtins.str] stack_policy_url: The stack policy url.
        ...
        :param pulumi.Input[builtins.str] template_url: The template url.
        :param pulumi.Input[builtins.int] timeout_in_minutes: Timeout In Minutes.
        :param pulumi.Input[builtins.bool] use_previous_parameters: The use previous parameters.
        """
    ...
    def change_set_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def change_set_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "change_set_name", value)

    @property
    @pulumi.getter(name="changeSetType")
    def change_set_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def change_set_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ChangeSetState:
    def __init__(__self__, *,
                 change_set_name: Optional[pulumi.Input[builtins.str]] = None,
                 change_set_type: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 disable_rollback: Optional[pulumi.Input[builtins.bool]] = None,
                 notification_urls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] stack_policy_during_update_url: The stack policy during update url.
        :param pulumi.Input[builtins.str] stack_policy_url: The stack policy url.
        :param pulumi.Input[builtins.str] status: The status of the change set.
        :param pulumi.Input[builtins.str] template_body: The structure that contains the template body. The template body must be 1 to 524,288 bytes in length.  If the length of the template body is longer than required, we recommend that you add parameters to the HTTP POST request body to avoid request failures due to excessive length of URLs.  You can specify one of TemplateBody or TemplateURL parameters, but you cannot specify both of them.
        :param pulumi.Input[builtins.str] template_url: The template url.
        :param pulumi.Input[builtins.int] timeout_in_minutes: Timeout In Minutes.
        :param pulumi.Input[builtins.bool] use_previous_parameters: The use previous parameters.
    ...
    @property
    @pulumi.getter(name="changeSetName")
    def change_set_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the change set.  The name can be up to 255 characters in length and can contain digits, letters, hyphens (-), and underscores (_). It must start with a digit or letter.
        """
        return pulumi.get(self, "change_set_name")
    ...
    @change_set_name.setter
    def change_set_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "change_set_name", value)
...
class ChangeSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 disable_rollback: Optional[pulumi.Input[builtins.bool]] = None,
                 notification_urls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ChangeSetParameterArgs', 'ChangeSetParameterArgsDict']]]]] = None,
                 ram_role_name: Optional[pulumi.Input[builtins.str]] = None,
                 replacement_option: Optional[pulumi.Input[builtins.str]] = None,
                 stack_id: Optional[pulumi.Input[builtins.str]] = None,
                 stack_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def get(resource_name: str,
            ...
            template_url: Optional[pulumi.Input[builtins.str]] = None,
            timeout_in_minutes: Optional[pulumi.Input[builtins.int]] = None,
            use_previous_parameters: Optional[pulumi.Input[builtins.bool]] = None) -> 'ChangeSet':
        """
    ...
    @property
    @pulumi.getter(name="changeSetName")
    def change_set_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the change set.  The name can be up to 255 characters in length and can contain digits, letters, hyphens (-), and underscores (_). It must start with a digit or letter.
        """
        return pulumi.get(self, "change_set_name")
    ...
    @property
    @pulumi.getter(name="changeSetType")
    def change_set_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of the change set. Valid values:  CREATE: creates a change set for a new stack. UPDATE: creates a change set for an existing stack. IMPORT: creates a change set for a new stack or an existing stack to import non-ROS-managed resources. If you create a change set for a new stack, ROS creates a stack that has a unique stack ID. The stack is in the REVIEW_IN_PROGRESS state until you execute the change set.  You cannot use the UPDATE type to create a change set for a new stack or the CREATE type to create a change set for an existing stack.
        """
        return pulumi.get(self, "change_set_type")
    ...
    @property
    @pulumi.getter(name="stackName")
    def stack_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the stack for which you want to create the change set.  The name can be up to 255 characters in length and can contain digits, letters, hyphens (-), and underscores (_). It must start with a digit or letter.  Note This parameter takes effect only when ChangeSetType is set to CREATE or IMPORT.
        """
        return pulumi.get(self, "stack_name")
    ...
    @property
    @pulumi.getter(name="timeoutInMinutes")
    def timeout_in_minutes(self) -> pulumi.Output[builtins.int]:
        """
        Timeout In Minutes.
        """
        return pulumi.get(self, "timeout_in_minutes")
