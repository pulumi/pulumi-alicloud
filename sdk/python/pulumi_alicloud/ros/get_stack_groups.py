...
def get_stack_groups(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Stack Group IDs.
    :param builtins.str name_regex: A regex string to filter results by Stack Group name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of Stack Group. Valid Values: `ACTIVE`, `DELETED`.
    """
    __args__ = dict()
...
def get_stack_groups_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
