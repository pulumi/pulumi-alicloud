...
def get_stack_groups(enable_details: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Stack Group IDs.
    :param _builtins.str name_regex: A regex string to filter results by Stack Group name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str status: The status of Stack Group. Valid Values: `ACTIVE`, `DELETED`.
    """
    __args__ = dict()
...
def get_stack_groups_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                            ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                            name_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetStackGroupsResult]:
    """
    This data source provides the Ros Stack Groups of the current Alibaba Cloud user.
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:ros/getStackGroups:getStackGroups', __args__, opts=opts, typ=GetStackGroupsResult)
    return __ret__.apply(lambda __response__: GetStackGroupsResult(
