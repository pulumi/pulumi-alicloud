...
def get_templates(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Template IDs.
    :param builtins.str name_regex: A regex string to filter results by Template name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str share_type: Share Type. Valid Values: `Private`, `Shared`
    :param Mapping[str, builtins.str] tags: Query the resource bound to the tag. The format of the incoming value is `json` string, including `TagKey` and `TagValue`. `TagKey` cannot be null, and `TagValue` can be empty. Format example `{"key1":"value1"}`.
...
def get_templates_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
