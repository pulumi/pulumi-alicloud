...
class GetStacksResult:
    ...
    def parent_stack_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "parent_stack_id")

    @property
    @pulumi.getter(name="showNestedStack")
    def show_nested_stack(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "show_nested_stack")

    @property
    @pulumi.getter(name="stackName")
    def stack_name(self) -> Optional[builtins.str]:
...
def get_stacks(enable_details: Optional[builtins.bool] = None,
               ids: Optional[Sequence[builtins.str]] = None,
               name_regex: Optional[builtins.str] = None,
               output_file: Optional[builtins.str] = None,
               parent_stack_id: Optional[builtins.str] = None,
               show_nested_stack: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Stack IDs.
    :param builtins.str name_regex: A regex string to filter results by Stack name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str parent_stack_id: ParentStackId.
    :param builtins.bool show_nested_stack: The show nested stack.
    :param builtins.str stack_name: StackName.
...
def get_stacks_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      ...
                      parent_stack_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      show_nested_stack: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      stack_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetStacksResult(
        ...
        parent_stack_id=pulumi.get(__response__, 'parent_stack_id'),
        show_nested_stack=pulumi.get(__response__, 'show_nested_stack'),
