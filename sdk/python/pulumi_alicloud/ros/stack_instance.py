...
class StackInstanceArgs:
    def __init__(__self__, *,
                 ...
                 stack_instance_account_id: pulumi.Input[builtins.str],
                 stack_instance_region_id: pulumi.Input[builtins.str],
                 ...
                 timeout_in_minutes: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a StackInstance resource.
        :param pulumi.Input[builtins.str] stack_group_name: The name of the stack group.
        :param pulumi.Input[builtins.str] stack_instance_account_id: The account to which the stack instance belongs.
        :param pulumi.Input[builtins.str] stack_instance_region_id: The region of the stack instance.
        :param pulumi.Input[builtins.str] operation_description: The operation description.
        :param pulumi.Input[builtins.str] operation_preferences: The operation preferences. The operation settings. The following fields are supported:
        ...
        :param pulumi.Input[builtins.bool] retain_stacks: Specifies whether to retain the stack corresponding to the stack instance.Default value `false`. **NOTE:** When `retain_stacks` is `true`, the stack is retained. If the stack is retained, the corresponding stack is not deleted when the stack instance is deleted from the stack group.
        :param pulumi.Input[builtins.str] timeout_in_minutes: The timeout period that is specified for the stack creation request. Default value: `60`. Unit: `minutes`.
        """
    ...
    def stack_instance_account_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def stack_instance_account_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "stack_instance_account_id", value)

    @property
    @pulumi.getter(name="stackInstanceRegionId")
    def stack_instance_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def stack_instance_region_id(self, value: pulumi.Input[builtins.str]):
    ...
    def timeout_in_minutes(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def timeout_in_minutes(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _StackInstanceState:
    def __init__(__self__, *,
                 ...
                 stack_instance_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 stack_instance_region_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] stack_instance_account_id: The account to which the stack instance belongs.
        :param pulumi.Input[builtins.str] stack_instance_region_id: The region of the stack instance.
        :param pulumi.Input[builtins.str] status: The status of the stack instance. Valid values: `CURRENT` or `OUTDATED`. 
    ...
    @property
    @pulumi.getter(name="stackInstanceAccountId")
    def stack_instance_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The account to which the stack instance belongs.
        """
        return pulumi.get(self, "stack_instance_account_id")
    ...
    @stack_instance_account_id.setter
    def stack_instance_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stack_instance_account_id", value)

    @property
    @pulumi.getter(name="stackInstanceRegionId")
    def stack_instance_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The region of the stack instance.
        """
        return pulumi.get(self, "stack_instance_region_id")
    ...
    @stack_instance_region_id.setter
    def stack_instance_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stack_instance_region_id", value)
...
class StackInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            stack_instance_region_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            timeout_in_minutes: Optional[pulumi.Input[builtins.str]] = None) -> 'StackInstance':
        """
    ...
    @property
    @pulumi.getter(name="stackInstanceAccountId")
    def stack_instance_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The account to which the stack instance belongs.
        """
        return pulumi.get(self, "stack_instance_account_id")
    ...
    @property
    @pulumi.getter(name="stackInstanceRegionId")
    def stack_instance_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The region of the stack instance.
        """
        return pulumi.get(self, "stack_instance_region_id")
    ...
    @property
    @pulumi.getter(name="timeoutInMinutes")
    def timeout_in_minutes(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The timeout period that is specified for the stack creation request. Default value: `60`. Unit: `minutes`.
        """
        return pulumi.get(self, "timeout_in_minutes")
