...
class ListenerProxyProtocolConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] proxy_protocol_config_vpc_id_enabled: Whether to enable carrying VpcId to backend servers through Proxy Protocol.
        """
...
class LoadBalancerModificationProtectionConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] reason: The reason why the configuration read-only mode is enabled. The value must be 2 to 128 characters in length, and can contain letters, digits, periods (.), underscores (\\_), and hyphens (-). The value must start with a letter.
               ...
               > **NOTE:**   This parameter takes effect only if the `status` parameter is set to `ConsoleProtection`.
        :param pulumi.Input[_builtins.str] status: Specifies whether to enable the configuration read-only mode. Valid values:
               - `NonProtection`: disables the configuration read-only mode. In this case, you cannot set the `ModificationProtectionReason` parameter. If you specify `ModificationProtectionReason`, the value is cleared.
               - `ConsoleProtection`: enables the configuration read-only mode. In this case, you can specify `ModificationProtectionReason`.
...
class LoadBalancerZoneMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] zone_id: The ID of the zone of the NLB instance. You must add at least two zones. You can add a maximum of 10 zones.
               You can call the [DescribeZones](https://www.alibabacloud.com/help/en/doc-detail/443890.html) operation to query the most recent zone list.
        :param pulumi.Input[_builtins.str] allocation_id: The ID of the elastic IP address (EIP) that is associated with the Internet-facing NLB instance. You can specify one EIP for each zone. You must add at least two zones. You can add a maximum of 10 zones.
        :param pulumi.Input[_builtins.str] eni_id: The ID of the elastic network interface (ENI).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ipv4_local_addresses: IPv4 Local address list. The list of addresses that NLB interacts with backend services.
        :param pulumi.Input[_builtins.str] ipv6_address: The IPv6 address of the NLB instance.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ipv6_local_addresses: IPv6 Local address list. The list of addresses that NLB interacts with backend services.
        :param pulumi.Input[_builtins.str] private_ipv4_address: The private IP address. You must add at least two zones. You can add a maximum of 10 zones.
        :param pulumi.Input[_builtins.str] public_ipv4_address: The public IPv4 address of the NLB instance.
...
class ServerGroupHealthCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] health_check_connect_port: The port that you want to use for health checks on backend servers.
               Valid values: `0` to `65535`.
               Default value: `0`. If you set the value to 0, the port of the backend server is used for health checks.
        :param pulumi.Input[_builtins.int] health_check_connect_timeout: The maximum timeout period of a health check. Unit: seconds. Valid values: `1` to `300`. Default value: `5`.
        ...
        :param pulumi.Input[_builtins.int] health_check_interval: The interval at which health checks are performed. Unit: seconds.
               Valid values: `5` to `50`.
               Default value: `10`.
        :param pulumi.Input[_builtins.str] health_check_req: UDP healthy check request string, the value is a character string of 512 characters
        :param pulumi.Input[_builtins.str] health_check_type: The protocol that you want to use for health checks. Valid values: `TCP` (default) and `HTTP`.
        :param pulumi.Input[_builtins.str] health_check_url: The path to which health check requests are sent.
        ...
        :param pulumi.Input[_builtins.int] healthy_threshold: The number of times that an unhealthy backend server must consecutively pass health checks before it is declared healthy. In this case, the health status changes from `fail` to `success`.
               Valid values: `2` to `10`.
               Default value: `2`.
        :param pulumi.Input[_builtins.str] http_check_method: The HTTP method that is used for health checks. Valid values: `GET` (default) and `HEAD`.
