...
if not MYPY:
    class ListenerProxyProtocolConfigArgsDict(TypedDict):
        proxy_protocol_config_private_link_ep_id_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to enable carrying PrivateLinkEpId to backend servers through Proxy Protocol.
        """
        proxy_protocol_config_private_link_eps_id_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to enable carrying PrivateLinkEpsId to backend servers through the Proxy Protocol.
        """
        proxy_protocol_config_vpc_id_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ListenerProxyProtocolConfigArgs:
    def __init__(__self__, *,
                 proxy_protocol_config_private_link_ep_id_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 proxy_protocol_config_private_link_eps_id_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 proxy_protocol_config_vpc_id_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] proxy_protocol_config_private_link_ep_id_enabled: Whether to enable carrying PrivateLinkEpId to backend servers through Proxy Protocol.
        :param pulumi.Input[builtins.bool] proxy_protocol_config_private_link_eps_id_enabled: Whether to enable carrying PrivateLinkEpsId to backend servers through the Proxy Protocol.
        :param pulumi.Input[builtins.bool] proxy_protocol_config_vpc_id_enabled: Whether to enable carrying VpcId to backend servers through Proxy Protocol.
        """
    ...
    def proxy_protocol_config_private_link_ep_id_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable carrying PrivateLinkEpId to backend servers through Proxy Protocol.
        """
    ...
    def proxy_protocol_config_private_link_ep_id_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def proxy_protocol_config_private_link_eps_id_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable carrying PrivateLinkEpsId to backend servers through the Proxy Protocol.
        """
    ...
    def proxy_protocol_config_private_link_eps_id_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def proxy_protocol_config_vpc_id_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable carrying VpcId to backend servers through Proxy Protocol.
        """
    ...
    def proxy_protocol_config_vpc_id_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class LoadBalancerDeletionProtectionConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Specifies whether to enable deletion protection. Valid values:
        :param pulumi.Input[builtins.str] enabled_time: Opening time of the configuration read-only mode.
        :param pulumi.Input[builtins.str] reason: The reason why deletion protection is enabled. The reason must be 2 to 128 characters in length, and can contain letters, digits, periods (.), underscores (\\_), and hyphens (-). The reason must start with a letter.
...
class LoadBalancerModificationProtectionConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] enabled_time: Opening time of the configuration read-only mode.
        :param pulumi.Input[builtins.str] reason: The reason why the configuration read-only mode is enabled. The value must be 2 to 128 characters in length, and can contain letters, digits, periods (.), underscores (\\_), and hyphens (-). The value must start with a letter.
               
               > **NOTE:**   This parameter takes effect only if the `status` parameter is set to `ConsoleProtection`.
        :param pulumi.Input[builtins.str] status: Specifies whether to enable the configuration read-only mode. Valid values:
               - `NonProtection`: disables the configuration read-only mode. In this case, you cannot set the `ModificationProtectionReason` parameter. If you specify `ModificationProtectionReason`, the value is cleared.
               - `ConsoleProtection`: enables the configuration read-only mode. In this case, you can specify `ModificationProtectionReason`.
...
if not MYPY:
    class LoadBalancerZoneMappingArgsDict(TypedDict):
        ...
        """
        public_ipv4_address: NotRequired[pulumi.Input[builtins.str]]
        """
...
class LoadBalancerZoneMappingArgs:
    def __init__(__self__, *,
                 ...
                 public_ipv4_address: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] vswitch_id: The vSwitch in the zone. You can specify only one vSwitch (subnet) in each zone of an NLB instance. You must add at least two zones. You can add a maximum of 10 zones.
        :param pulumi.Input[builtins.str] zone_id: The ID of the zone of the NLB instance. You must add at least two zones. You can add a maximum of 10 zones.
               You can call the [DescribeZones](https://www.alibabacloud.com/help/en/doc-detail/443890.html) operation to query the most recent zone list.
        :param pulumi.Input[builtins.str] allocation_id: The ID of the elastic IP address (EIP) that is associated with the Internet-facing NLB instance. You can specify one EIP for each zone. You must add at least two zones. You can add a maximum of 10 zones.
        :param pulumi.Input[builtins.str] eni_id: The ID of the elastic network interface (ENI).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ipv4_local_addresses: IPv4 Local address list. The list of addresses that NLB interacts with backend services.
        :param pulumi.Input[builtins.str] ipv6_address: The IPv6 address of the NLB instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ipv6_local_addresses: IPv6 Local address list. The list of addresses that NLB interacts with backend services.
        :param pulumi.Input[builtins.str] private_ipv4_address: The private IP address. You must add at least two zones. You can add a maximum of 10 zones.
        :param pulumi.Input[builtins.str] public_ipv4_address: The public IPv4 address of the NLB instance.
        :param pulumi.Input[builtins.str] status: Zone Status
        """
    ...
    def public_ipv4_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The public IPv4 address of the NLB instance.
        """
    ...
    def public_ipv4_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ServerGroupHealthCheckArgsDict(TypedDict):
        ...
        """
        health_check_connect_timeout: NotRequired[pulumi.Input[builtins.int]]
        """
        The maximum timeout period of a health check. Unit: seconds. Valid values: `1` to `300`. Default value: `5`.
        """
        health_check_domain: NotRequired[pulumi.Input[builtins.str]]
        """
        The domain name that you want to use for health checks. Valid values:
        - `$SERVER_IP`: the private IP address of a backend server.
        """
        health_check_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Specifies whether to enable the health check feature. Valid values:
        """
        health_check_exp: NotRequired[pulumi.Input[builtins.str]]
        """
        health check response character string. The value contains a maximum of 512 characters
        """
        health_check_http_codes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        Default value: `10`.
        """
        health_check_req: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Default value: `2`.
        """
        http_check_method: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServerGroupHealthCheckArgs:
    def __init__(__self__, *,
                 ...
                 health_check_connect_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 health_check_domain: Optional[pulumi.Input[builtins.str]] = None,
                 health_check_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 health_check_exp: Optional[pulumi.Input[builtins.str]] = None,
                 health_check_http_codes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 health_check_interval: Optional[pulumi.Input[builtins.int]] = None,
                 health_check_req: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 http_check_method: Optional[pulumi.Input[builtins.str]] = None,
                 unhealthy_threshold: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] health_check_connect_port: The port that you want to use for health checks on backend servers.
               Valid values: `0` to `65535`.
               Default value: `0`. If you set the value to 0, the port of the backend server is used for health checks.
        :param pulumi.Input[builtins.int] health_check_connect_timeout: The maximum timeout period of a health check. Unit: seconds. Valid values: `1` to `300`. Default value: `5`.
        :param pulumi.Input[builtins.str] health_check_domain: The domain name that you want to use for health checks. Valid values:
               - `$SERVER_IP`: the private IP address of a backend server.
        :param pulumi.Input[builtins.bool] health_check_enabled: Specifies whether to enable the health check feature. Valid values:
        :param pulumi.Input[builtins.str] health_check_exp: health check response character string. The value contains a maximum of 512 characters
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] health_check_http_codes: The HTTP status codes to return for health checks. Separate multiple HTTP status codes with commas (,). Valid values: `http\\_2xx` (default), `http\\_3xx`, `http\\_4xx`, and `http\\_5xx`.
               
               > **NOTE:**  This parameter takes effect only when `HealthCheckType` is set to `HTTP`.
        :param pulumi.Input[builtins.int] health_check_interval: The interval at which health checks are performed. Unit: seconds.
               Valid values: `5` to `50`.
               Default value: `10`.
        :param pulumi.Input[builtins.str] health_check_req: UDP healthy check request string, the value is a character string of 512 characters
        :param pulumi.Input[builtins.str] health_check_type: The protocol that you want to use for health checks. Valid values: `TCP` (default) and `HTTP`.
        :param pulumi.Input[builtins.str] health_check_url: The path to which health check requests are sent.
               
               The path must be 1 to 80 characters in length, and can contain only letters, digits, and the following special characters: `- / . % ? # & =`. It can also contain the following extended characters: `_ ; ~ ! ( ) * [ ] @ $ ^ : ' , +`. The path must start with a forward slash (/).
               
               > **NOTE:**  This parameter takes effect only when `HealthCheckType` is set to `HTTP`.
        :param pulumi.Input[builtins.int] healthy_threshold: The number of times that an unhealthy backend server must consecutively pass health checks before it is declared healthy. In this case, the health status changes from `fail` to `success`.
               Valid values: `2` to `10`.
               Default value: `2`.
        :param pulumi.Input[builtins.str] http_check_method: The HTTP method that is used for health checks. Valid values: `GET` (default) and `HEAD`.
               
               > **NOTE:**  This parameter takes effect only when `HealthCheckType` is set to `HTTP`.
        :param pulumi.Input[builtins.int] unhealthy_threshold: The number of times that a healthy backend server must consecutively fail health checks before it is declared unhealthy. In this case, the health status changes from `success` to `fail`.
               Valid values: `2` to `10`.
               Default value: `2`.
        """
    ...
    def health_check_connect_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum timeout period of a health check. Unit: seconds. Valid values: `1` to `300`. Default value: `5`.
        """
    ...
    def health_check_connect_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def health_check_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to enable the health check feature. Valid values:
        """
    ...
    def health_check_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "health_check_enabled", value)

    @property
    @pulumi.getter(name="healthCheckExp")
    def health_check_exp(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        health check response character string. The value contains a maximum of 512 characters
        """
    ...
    def health_check_exp(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "health_check_exp", value)

    @property
    @pulumi.getter(name="healthCheckHttpCodes")
    def health_check_http_codes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The HTTP status codes to return for health checks. Separate multiple HTTP status codes with commas (,). Valid values: `http\\_2xx` (default), `http\\_3xx`, `http\\_4xx`, and `http\\_5xx`.
    ...
    def health_check_http_codes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def health_check_req(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        UDP healthy check request string, the value is a character string of 512 characters
        """
    ...
    def health_check_req(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def http_check_method(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The HTTP method that is used for health checks. Valid values: `GET` (default) and `HEAD`.
    ...
    def http_check_method(self, value: Optional[pulumi.Input[builtins.str]]):
