...
class LoadbalancerCommonBandwidthPackageAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bandwidth_package_id: Specifies whether only to precheck the request. Valid values:
        :param pulumi.Input[builtins.str] load_balancer_id: The ID of the EIP bandwidth plan.
        """
...
class _LoadbalancerCommonBandwidthPackageAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bandwidth_package_id: Specifies whether only to precheck the request. Valid values:
        :param pulumi.Input[builtins.str] load_balancer_id: The ID of the EIP bandwidth plan.
        :param pulumi.Input[builtins.str] status: Network-based load balancing instance status. Value:, indicating that the instance listener will no longer forward traffic.
        """
...
@pulumi.type_token("alicloud:nlb/loadbalancerCommonBandwidthPackageAttachment:LoadbalancerCommonBandwidthPackageAttachment")
class LoadbalancerCommonBandwidthPackageAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            bandwidth_package_id: Optional[pulumi.Input[builtins.str]] = None,
            load_balancer_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'LoadbalancerCommonBandwidthPackageAttachment':
        """
