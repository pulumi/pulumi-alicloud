...
class LoadBalancerSecurityGroupAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] load_balancer_id: The ID of the NLB instance to be associated with the security group.
        :param pulumi.Input[builtins.str] security_group_id: The ID of the security group to be disassociated.
...
class LoadBalancerSecurityGroupAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            dry_run: Optional[pulumi.Input[builtins.bool]] = None,
            load_balancer_id: Optional[pulumi.Input[builtins.str]] = None,
            security_group_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LoadBalancerSecurityGroupAttachment':
        """
