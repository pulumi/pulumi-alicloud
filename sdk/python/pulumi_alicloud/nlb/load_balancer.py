...
class LoadBalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] address_type: The type of IPv4 address used by the NLB instance. Valid values:
        ...
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC where the NLB instance is deployed.
        ...
        :param pulumi.Input[builtins.str] address_ip_version: The protocol version. Valid values:
               
               - **ipv4:** IPv4. This is the default value.
               - **DualStack:** dual stack.
        :param pulumi.Input[builtins.str] bandwidth_package_id: The ID of the EIP bandwidth plan that is associated with the Internet-facing NLB instance.
        :param pulumi.Input[builtins.int] cps: The speed limit of new connections per second processed by NLB instances in each VIP. Value range: `0` to `1000000`.
               
               - *0** means no speed limit.
        :param pulumi.Input[builtins.bool] cross_zone_enabled: Specifies whether to enable cross-zone load balancing for the NLB instance. Valid values:
        ...
        :param pulumi.Input[builtins.str] deletion_protection_reason: The reason why the deletion protection feature is enabled or disabled. The `deletion_protection_reason` takes effect only when `deletion_protection_enabled` is set to `true`.
        :param pulumi.Input[builtins.str] ipv6_address_type: The type of IPv6 address used by the NLB instance. Valid values:
        ...
        :param pulumi.Input[builtins.str] load_balancer_name: The name of the NLB instance.
        ...
        :param pulumi.Input[builtins.str] load_balancer_type: The type of the Server Load Balancer (SLB) instance. Set the value to `network`, which specifies NLB.
        ...
        :param pulumi.Input[builtins.str] modification_protection_reason: The reason why the configuration read-only mode is enabled. The `modification_protection_reason` takes effect only when `modification_protection_status` is set to `ConsoleProtection`.
        :param pulumi.Input[builtins.str] modification_protection_status: Specifies whether to enable the configuration read-only mode. Default value: `NonProtection`. Valid values:
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The security group to which the network-based SLB instance belongs.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: List of labels.
        """
...
class _LoadBalancerState:
    def __init__(__self__, *,
                 ...
                 ipv6_address_type: Optional[pulumi.Input[builtins.str]] = None,
                 load_balancer_business_status: Optional[pulumi.Input[builtins.str]] = None,
                 load_balancer_name: Optional[pulumi.Input[builtins.str]] = None,
                 load_balancer_type: Optional[pulumi.Input[builtins.str]] = None,
                 modification_protection_config: Optional[pulumi.Input['LoadBalancerModificationProtectionConfigArgs']] = None,
                 modification_protection_reason: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] cps: The speed limit of new connections per second processed by NLB instances in each VIP. Value range: `0` to `1000000`.
               ...
               - *0** means no speed limit.
        :param pulumi.Input[builtins.str] create_time: Resource creation time, using Greenwich Mean Time, formating' yyyy-MM-ddTHH:mm:ssZ '.
        :param pulumi.Input[builtins.bool] cross_zone_enabled: Specifies whether to enable cross-zone load balancing for the NLB instance. Valid values:
        :param pulumi.Input['LoadBalancerDeletionProtectionConfigArgs'] deletion_protection_config: Specifies whether to enable deletion protection. Default value: `false`. See `deletion_protection_config` below.
        :param pulumi.Input[builtins.bool] deletion_protection_enabled: Specifies whether to enable deletion protection. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.str] deletion_protection_reason: The reason why the deletion protection feature is enabled or disabled. The `deletion_protection_reason` takes effect only when `deletion_protection_enabled` is set to `true`.
        :param pulumi.Input[builtins.str] dns_name: The domain name of the NLB instance.
        :param pulumi.Input[builtins.str] ipv6_address_type: The type of IPv6 address used by the NLB instance. Valid values:
               - `Internet`: a public IP address. The domain name of the NLB instance is resolved to the public IP address. Therefore, the NLB instance can be accessed over the Internet.
               - `Intranet`: a private IP address. The domain name of the NLB instance is resolved to the private IP address. Therefore, the NLB instance can be accessed over the VPC where the NLB instance is deployed.
        :param pulumi.Input[builtins.str] load_balancer_business_status: The business status of the NLB instance.
        :param pulumi.Input[builtins.str] load_balancer_name: The name of the NLB instance.
               The value must be 2 to 128 characters in length, and can contain letters, digits, periods (.), underscores (\\_), and hyphens (-). The value must start with a letter.
        :param pulumi.Input[builtins.str] load_balancer_type: The type of the Server Load Balancer (SLB) instance. Set the value to `network`, which specifies NLB.
        :param pulumi.Input['LoadBalancerModificationProtectionConfigArgs'] modification_protection_config: Specifies whether to enable the configuration read-only mode. Default value: `NonProtection`. See `modification_protection_config` below.
        ...
        :param pulumi.Input[builtins.str] modification_protection_status: Specifies whether to enable the configuration read-only mode. Default value: `NonProtection`. Valid values:
               ...
               - `ConsoleProtection`: Enables the configuration read-only mode. You can set the `modification_protection_reason`.
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource
        :param pulumi.Input[builtins.str] region_id: The ID of the region where the NLB instance is deployed.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the new resource group.
               You can log on to the [Resource Management console](https://resourcemanager.console.aliyun.com/resource-groups) to view resource group IDs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The security group to which the network-based SLB instance belongs.
    ...
    def load_balancer_business_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def load_balancer_business_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LoadBalancer(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:nlb/loadBalancer:LoadBalancer"
    ...
    @property
    @pulumi.getter(name="deletionProtectionReason")
    def deletion_protection_reason(self) -> pulumi.Output[builtins.str]:
        """
        The reason why the deletion protection feature is enabled or disabled. The `deletion_protection_reason` takes effect only when `deletion_protection_enabled` is set to `true`.
        """
        return pulumi.get(self, "deletion_protection_reason")
    ...
    @property
    @pulumi.getter(name="loadBalancerBusinessStatus")
    def load_balancer_business_status(self) -> pulumi.Output[builtins.str]:
        """
        The business status of the NLB instance.
        """
        return pulumi.get(self, "load_balancer_business_status")
