...
class GetLoadBalancersResult:
    ...
    def load_balancer_names(self) -> Optional[Sequence[builtins.str]]:
...
def get_load_balancers(address_ip_version: Optional[builtins.str] = None,
                       ...
                       load_balancer_names: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str address_ip_version: The IP version. Valid values: `ipv4`, `DualStack`.
    :param builtins.str address_type: The type of IPv4 address used by the NLB instance. Valid values: `Internet`, `Intranet`.
    ...
    :param builtins.str ipv6_address_type: The type of IPv6 address used by the NLB instance. Valid values: `Internet`, `Intranet`.
    :param builtins.str load_balancer_business_status: The business status of the NLB instance. Valid values: `Abnormal`, `Normal`.
    :param Sequence[builtins.str] load_balancer_names: The name of the NLB instance. You can specify at most 10 names.
    ...
    :param builtins.str status: The status of the NLB instance. Valid values: `Inactive`, `Active`, `Provisioning`, `Configuring`, `Deleting`, `Deleted`.
    :param Sequence[builtins.str] vpc_ids: The ID of the virtual private cloud (VPC) where the NLB instance is deployed. You can specify at most 10 IDs.
...
def get_load_balancers_output(address_ip_version: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              ...
                              ipv6_address_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              load_balancer_business_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              load_balancer_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
