...
class GetServerGroupServerAttachmentsResult:
    ...
    def server_ips(self) -> Optional[Sequence[builtins.str]]:
...
def get_server_group_server_attachments(ids: Optional[Sequence[builtins.str]] = None,
                                        ...
                                        server_ips: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Server Group Server Attachment IDs.
    ...
    :param Sequence[builtins.str] server_ids: The IDs of the servers. You can specify at most 40 server IDs in each call.
    :param Sequence[builtins.str] server_ips: The IP addresses of the servers. You can specify at most 40 server IP addresses in each call.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_server_group_server_attachments_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                               output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                               server_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                               server_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                               server_ips: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
