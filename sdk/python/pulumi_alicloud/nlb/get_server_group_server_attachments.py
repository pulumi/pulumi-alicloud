...
class GetServerGroupServerAttachmentsResult:
    ...
    def server_ips(self) -> Optional[Sequence[_builtins.str]]:
...
def get_server_group_server_attachments(ids: Optional[Sequence[_builtins.str]] = None,
                                        output_file: Optional[_builtins.str] = None,
                                        server_group_id: Optional[_builtins.str] = None,
                                        server_ids: Optional[Sequence[_builtins.str]] = None,
                                        server_ips: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Server Group Server Attachment IDs.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str server_group_id: The ID of the server group.
    :param Sequence[_builtins.str] server_ids: The IDs of the servers. You can specify at most 40 server IDs in each call.
    :param Sequence[_builtins.str] server_ips: The IP addresses of the servers. You can specify at most 40 server IP addresses in each call.
    """
    __args__ = dict()
    __args__['ids'] = ids
