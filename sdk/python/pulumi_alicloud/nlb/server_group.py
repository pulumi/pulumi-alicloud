...
class ServerGroupArgs:
    def __init__(__self__, *,
                 ...
                 connection_drain: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] server_group_name: The new name of the server group.
               The name must be 2 to 128 characters in length, and can contain letters, digits, periods (.), underscores (\\_), and hyphens (-). The name must start with a letter.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the virtual private cloud (VPC) to which the server group belongs.
        ...
        :param pulumi.Input[builtins.bool] any_port_enabled: Specifies whether to enable all-port forwarding. Valid values:
        :param pulumi.Input[builtins.bool] connection_drain: . Field 'connection_drain' has been deprecated from provider version 1.231.0. New field 'connection_drain_enabled' instead.
        :param pulumi.Input[builtins.bool] connection_drain_enabled: Specifies whether to enable connection draining. Valid values:
        :param pulumi.Input[builtins.int] connection_drain_timeout: The timeout period of connection draining. Unit: seconds. Valid values: `10` to `900`.
        :param pulumi.Input['ServerGroupHealthCheckArgs'] health_check: Health check configuration information. See `health_check` below.
        :param pulumi.Input[builtins.bool] preserve_client_ip_enabled: Specifies whether to enable client IP preservation. Valid values:
        :param pulumi.Input[builtins.str] protocol: The protocol used to forward requests to the backend servers. Valid values:
    ...
    def connection_drain(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def connection_drain(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ServerGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_group_type: The type of server group. Valid values:
               ...
               - `Instance`: allows you to add servers of the `Ecs`, `Eni`, or `Eci` type. This is the default value.
               - `Ip`: allows you to add servers by specifying IP addresses.
        :param pulumi.Input[builtins.str] status: Server group status. Value:
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Label.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the virtual private cloud (VPC) to which the server group belongs.
...
class ServerGroup(pulumi.CustomResource):
    ...
    @pulumi.getter(name="connectionDrain")
    @_utilities.deprecated("""Field 'connection_drain' has been deprecated since provider version 1.214.0. New field 'connection_drain_enabled' instead.""")
    def connection_drain(self) -> pulumi.Output[builtins.bool]:
        """
        . Field 'connection_drain' has been deprecated from provider version 1.231.0. New field 'connection_drain_enabled' instead.
        """
        return pulumi.get(self, "connection_drain")
