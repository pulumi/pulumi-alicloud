...
class ServerGroupServerAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_id: The ID of the server.
               - If the server group type is Instance, set the ServerId parameter to the ID of an Elastic Compute Service (ECS) instance, an elastic network interface (ENI), or an elastic container instance. These backend servers are specified by Ecs, Eni, or Eci.
               - If the server group type is Ip, set the ServerId parameter to an IP address.
        :param pulumi.Input[builtins.str] server_type: The type of the backend server. Valid values: `Ecs`, `Eni`, `Eci`, `Ip`.
        :param pulumi.Input[builtins.str] description: The description of the servers. The description must be 2 to 256 characters in length, and can contain letters, digits, commas (,), periods (.), semicolons (;), forward slashes (/), at signs (@), underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.int] port: The port used by the backend server. Valid values: 1 to 65535.
        :param pulumi.Input[builtins.str] server_ip: The IP address of the server. If the server group type is Ip, set the ServerId parameter to an IP address.
        :param pulumi.Input[builtins.int] weight: The weight of the backend server. Valid values: 0 to 100. Default value: 100. If the weight of a backend server is set to 0, no requests are forwarded to the backend server.
        """
...
class _ServerGroupServerAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] weight: The weight of the backend server. Valid values: 0 to 100. Default value: 100. If the weight of a backend server is set to 0, no requests are forwarded to the backend server.
        :param pulumi.Input[builtins.str] zone_id: The zoneId of the server.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if port is not None:
...
class ServerGroupServerAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            weight: Optional[pulumi.Input[builtins.int]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ServerGroupServerAttachment':
        """
    ...
    @property
    @pulumi.getter(name="serverIp")
    def server_ip(self) -> pulumi.Output[builtins.str]:
        """
        The IP address of the server. If the server group type is Ip, set the ServerId parameter to an IP address.
        """
        return pulumi.get(self, "server_ip")
