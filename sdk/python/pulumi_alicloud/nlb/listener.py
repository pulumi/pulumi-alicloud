...
class ListenerArgs:
    def __init__(__self__, *,
                 ...
                 listener_protocol: pulumi.Input[builtins.str],
                 load_balancer_id: pulumi.Input[builtins.str],
                 server_group_id: pulumi.Input[builtins.str],
                 alpn_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 ca_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 listener_description: Optional[pulumi.Input[builtins.str]] = None,
                 mss: Optional[pulumi.Input[builtins.int]] = None,
                 proxy_protocol_config: Optional[pulumi.Input['ListenerProxyProtocolConfigArgs']] = None,
                 proxy_protocol_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 sec_sensor_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] listener_port: The listener port. Valid values: `0` to `65535`.
               If you set the value to `0`, the listener listens by port range. If you set the value to `0`, you must specify `StartPort` and `EndPort`.
        :param pulumi.Input[builtins.str] listener_protocol: The listening protocol. Valid values: `TCP`, `UDP`, and `TCPSSL`.
        :param pulumi.Input[builtins.str] load_balancer_id: The ID of the Network Load Balancer (NLB) instance.
        :param pulumi.Input[builtins.str] server_group_id: The ID of the server group.
        :param pulumi.Input[builtins.bool] alpn_enabled: Specifies whether to enable Application-Layer Protocol Negotiation (ALPN). Valid values:
        :param pulumi.Input[builtins.str] alpn_policy: The ALPN policy. Valid values:
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ca_certificate_ids: The list of certificate authority (CA) certificates. This parameter takes effect only for listeners that use SSL over TCP. 
               
               > **NOTE:**  Only one CA certificate is supported.
        :param pulumi.Input[builtins.bool] ca_enabled: Specifies whether to enable mutual authentication. Valid values:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] certificate_ids: The list of server certificates. This parameter takes effect only for listeners that use SSL over TCP. 
               
               > **NOTE:**  This parameter takes effect only for TCPSSL listeners.
        :param pulumi.Input[builtins.int] cps: The maximum number of connections that can be created per second on the NLB instance. Valid values: `0` to `1000000`. `0` specifies that the number of connections is unlimited.
        :param pulumi.Input[builtins.int] end_port: The last port in the listener port range. Valid values: `0` to `65535`. The number of the last port must be greater than the number of the first port.
               
               > **NOTE:**  This parameter is required when `ListenerPort` is set to `0`.
        :param pulumi.Input[builtins.int] idle_timeout: The timeout period of idle connections. Unit: seconds. Valid values: `1` to `900`. Default value: `900`.
        :param pulumi.Input[builtins.str] listener_description: Enter a name for the listener.
               The description must be 2 to 256 characters in length, and can contain letters, digits, commas (,), periods (.), semicolons (;), forward slashes (/), at signs (@), underscores (\\_), and hyphens (-).
        :param pulumi.Input[builtins.int] mss: The maximum size of a TCP segment. Unit: bytes. Valid values: `0` to `1500`. `0` specifies that the maximum segment size remains unchanged.
        ...
        :param pulumi.Input[builtins.bool] proxy_protocol_enabled: Specifies whether to use the Proxy protocol to pass client IP addresses to backend servers. Valid values:
        :param pulumi.Input[builtins.bool] sec_sensor_enabled: Specifies whether to enable fine-grained monitoring. Valid values:
        :param pulumi.Input[builtins.str] security_policy_id: The security policy ID. System security policies and custom security policies are supported.
        ...
        :param pulumi.Input[builtins.int] start_port: The first port in the listener port range. Valid values: `0` to `65535`.
               
               > **NOTE:**  This parameter is required when `ListenerPort` is set to `0`.
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid values: `Running`, `Stopped`. When you want to enable this instance, you can set the property value to `Running`;
    ...
    def listener_protocol(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def listener_protocol(self, value: pulumi.Input[builtins.str]):
    ...
    def alpn_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @alpn_enabled.setter
    def alpn_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ca_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @ca_enabled.setter
    def ca_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def listener_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def listener_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "listener_description", value)

    @property
    @pulumi.getter
    def mss(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @mss.setter
    def mss(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def proxy_protocol_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def proxy_protocol_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "proxy_protocol_enabled", value)

    @property
    @pulumi.getter(name="secSensorEnabled")
    def sec_sensor_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def sec_sensor_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ListenerState:
    def __init__(__self__, *,
                 ...
                 listener_protocol: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['ListenerProxyProtocolConfigArgs'] proxy_protocol_config: The Proxy Protocol is used to carry the VpcId, PrivateLinkEpId, and PrivateLinkEpsId information to the backend server for configuration. See `proxy_protocol_config` below.
        :param pulumi.Input[builtins.bool] proxy_protocol_enabled: Specifies whether to use the Proxy protocol to pass client IP addresses to backend servers. Valid values:
        :param pulumi.Input[builtins.str] region_id: The ID of the region where the Network Load Balancer (NLB) instance is deployed.
    ...
    @property
    @pulumi.getter(name="listenerProtocol")
    def listener_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The listening protocol. Valid values: `TCP`, `UDP`, and `TCPSSL`.
        """
        return pulumi.get(self, "listener_protocol")
    ...
    @listener_protocol.setter
    def listener_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "listener_protocol", value)
...
class Listener(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:nlb/listener:Listener"
    ...
    def get(resource_name: str,
            ...
            start_port: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Listener':
        """
    ...
    @property
    @pulumi.getter(name="alpnEnabled")
    def alpn_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to enable Application-Layer Protocol Negotiation (ALPN). Valid values:
        """
        return pulumi.get(self, "alpn_enabled")
    ...
    @property
    @pulumi.getter(name="caEnabled")
    def ca_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to enable mutual authentication. Valid values:
        """
        return pulumi.get(self, "ca_enabled")
    ...
    @property
    @pulumi.getter
    def cps(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum number of connections that can be created per second on the NLB instance. Valid values: `0` to `1000000`. `0` specifies that the number of connections is unlimited.
        """
        return pulumi.get(self, "cps")
    ...
    @property
    @pulumi.getter(name="listenerDescription")
    def listener_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Enter a name for the listener.
        The description must be 2 to 256 characters in length, and can contain letters, digits, commas (,), periods (.), semicolons (;), forward slashes (/), at signs (@), underscores (\\_), and hyphens (-).
        """
    ...
    @property
    @pulumi.getter(name="listenerProtocol")
    def listener_protocol(self) -> pulumi.Output[builtins.str]:
        """
        The listening protocol. Valid values: `TCP`, `UDP`, and `TCPSSL`.
        """
        return pulumi.get(self, "listener_protocol")
    ...
    @property
    @pulumi.getter
    def mss(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum size of a TCP segment. Unit: bytes. Valid values: `0` to `1500`. `0` specifies that the maximum segment size remains unchanged.
    ...
    @property
    @pulumi.getter(name="proxyProtocolEnabled")
    def proxy_protocol_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to use the Proxy protocol to pass client IP addresses to backend servers. Valid values:
        """
        return pulumi.get(self, "proxy_protocol_enabled")
    ...
    @property
    @pulumi.getter(name="secSensorEnabled")
    def sec_sensor_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to enable fine-grained monitoring. Valid values:
        """
        return pulumi.get(self, "sec_sensor_enabled")
