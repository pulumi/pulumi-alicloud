...
class LoadBalancerZoneShiftedAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] load_balancer_id: Network load balancer id
        :param pulumi.Input[builtins.str] vswitch_id: The list of zones and vSwitch mappings
        :param pulumi.Input[builtins.str] zone_id: ZoneId
        """
...
class LoadBalancerZoneShiftedAttachment(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:nlb/loadBalancerZoneShiftedAttachment:LoadBalancerZoneShiftedAttachment"
