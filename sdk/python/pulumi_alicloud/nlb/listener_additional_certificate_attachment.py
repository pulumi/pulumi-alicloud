...
class ListenerAdditionalCertificateAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_id: The ID of additional certificates.
        :param pulumi.Input[builtins.str] listener_id: The listener ID. You must specify the ID of a listener that uses SSL over TCP.
...
class ListenerAdditionalCertificateAttachment(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:nlb/listenerAdditionalCertificateAttachment:ListenerAdditionalCertificateAttachment"
    ...
    def get(resource_name: str,
            ...
            dry_run: Optional[pulumi.Input[builtins.bool]] = None,
            listener_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ListenerAdditionalCertificateAttachment':
        """
