...
class GetServerGroupsResult:
    ...
    def server_group_names(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "server_group_names")

    @property
    @pulumi.getter(name="serverGroupType")
    def server_group_type(self) -> Optional[builtins.str]:
...
def get_server_groups(ids: Optional[Sequence[builtins.str]] = None,
                      ...
                      server_group_names: Optional[Sequence[builtins.str]] = None,
                      server_group_type: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] server_group_names: The names of the server groups to be queried.
    :param builtins.str server_group_type: The type of the server group. Valid values: `Instance`, `Ip`.
    :param builtins.str status: The status of the resource. Valid values: `Available`, `Configuring`, `Creating`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_server_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             ...
                             server_group_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             server_group_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
