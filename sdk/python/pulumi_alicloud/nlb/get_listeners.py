...
def get_listeners(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] load_balancer_ids: The ID of the NLB instance. You can specify at most 20 IDs.
...
def get_listeners_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
