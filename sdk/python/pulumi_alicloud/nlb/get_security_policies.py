...
class GetSecurityPoliciesResult:
    ...
    def security_policy_names(self) -> Optional[Sequence[builtins.str]]:
...
def get_security_policies(ids: Optional[Sequence[builtins.str]] = None,
                          name_regex: Optional[builtins.str] = None,
                          output_file: Optional[builtins.str] = None,
                          resource_group_id: Optional[builtins.str] = None,
                          security_policy_names: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Security Policy IDs.
    :param builtins.str name_regex: A regex string to filter results by Security Policy name.
    ...
    :param Sequence[builtins.str] security_policy_names: The names of the TLS security policies.
    :param builtins.str status: The status of the resource. Valid values: `Available`, `Configuring`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_security_policies_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 ...
                                 security_policy_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
