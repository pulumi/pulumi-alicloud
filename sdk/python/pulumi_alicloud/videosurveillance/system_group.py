...
class SystemGroupArgs:
    def __init__(__self__, *,
                 ...
                 in_protocol: pulumi.Input[builtins.str],
                 out_protocol: pulumi.Input[builtins.str],
                 play_domain: pulumi.Input[builtins.str],
                 push_domain: pulumi.Input[builtins.str],
                 callback: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a SystemGroup resource.
        :param pulumi.Input[builtins.str] group_name: The Group Name.
        :param pulumi.Input[builtins.str] in_protocol: The use of the access protocol support gb28181, Real Time Messaging Protocol (rtmp). Valid values: `gb28181`, `rtmp`.
        :param pulumi.Input[builtins.str] out_protocol: The playback protocol used by the space, multiple values are separated by commas (,). Valid values: `flv`,`hls`, `rtmp`.
        :param pulumi.Input[builtins.str] play_domain: The domain name of plan streaming used by the group.
        :param pulumi.Input[builtins.str] push_domain: The domain name of push streaming used by the group.
        :param pulumi.Input[builtins.str] callback: The space within the device status update of the callback, need to start with http:// or https:// at the beginning.
        :param pulumi.Input[builtins.str] description: The description of Group.
        :param pulumi.Input[builtins.bool] enabled: Whether to open Group.
        """
    ...
    def in_protocol(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @in_protocol.setter
    def in_protocol(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "in_protocol", value)

    @property
    @pulumi.getter(name="outProtocol")
    def out_protocol(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @out_protocol.setter
    def out_protocol(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "out_protocol", value)

    @property
    @pulumi.getter(name="playDomain")
    def play_domain(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @play_domain.setter
    def play_domain(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "play_domain", value)

    @property
    @pulumi.getter(name="pushDomain")
    def push_domain(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @push_domain.setter
    def push_domain(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "push_domain", value)

    @property
    @pulumi.getter
    def callback(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @callback.setter
    def callback(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SystemGroupState:
    def __init__(__self__, *,
                 callback: Optional[pulumi.Input[builtins.str]] = None,
                 capture_image: Optional[pulumi.Input[builtins.int]] = None,
                 capture_interval: Optional[pulumi.Input[builtins.int]] = None,
                 capture_oss_bucket: Optional[pulumi.Input[builtins.str]] = None,
                 capture_oss_path: Optional[pulumi.Input[builtins.str]] = None,
                 capture_video: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 group_name: Optional[pulumi.Input[builtins.str]] = None,
                 in_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 lazy_pull: Optional[pulumi.Input[builtins.bool]] = None,
                 out_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 play_domain: Optional[pulumi.Input[builtins.str]] = None,
                 push_domain: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.bool]] = None):
        """
        Input properties used for looking up and filtering SystemGroup resources.
        :param pulumi.Input[builtins.str] callback: The space within the device status update of the callback, need to start with http:// or https:// at the beginning.
        :param pulumi.Input[builtins.int] capture_image: The capture image.
        :param pulumi.Input[builtins.int] capture_interval: The capture interval.
        :param pulumi.Input[builtins.str] capture_oss_bucket: The capture oss bucket.
        :param pulumi.Input[builtins.str] capture_oss_path: The capture oss path.
        :param pulumi.Input[builtins.int] capture_video: The capture video.
        :param pulumi.Input[builtins.str] description: The description of Group.
        :param pulumi.Input[builtins.bool] enabled: Whether to open Group.
        :param pulumi.Input[builtins.str] group_name: The Group Name.
        :param pulumi.Input[builtins.str] in_protocol: The use of the access protocol support gb28181, Real Time Messaging Protocol (rtmp). Valid values: `gb28181`, `rtmp`.
        :param pulumi.Input[builtins.bool] lazy_pull: Whether to enable on-demand streaming. Default value:`false`.
        :param pulumi.Input[builtins.str] out_protocol: The playback protocol used by the space, multiple values are separated by commas (,). Valid values: `flv`,`hls`, `rtmp`.
        :param pulumi.Input[builtins.str] play_domain: The domain name of plan streaming used by the group.
        :param pulumi.Input[builtins.str] push_domain: The domain name of push streaming used by the group.
        :param pulumi.Input[builtins.bool] status: Whether to open Group. Valid values: `on`,`off`.
        """
        if callback is not None:
            pulumi.set(__self__, "callback", callback)
    ...
    def capture_image(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The capture image.
        """
    ...
    def capture_image(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "capture_image", value)

    @property
    @pulumi.getter(name="captureInterval")
    def capture_interval(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def capture_interval(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "capture_interval", value)

    @property
    @pulumi.getter(name="captureOssBucket")
    def capture_oss_bucket(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def capture_oss_bucket(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "capture_oss_bucket", value)

    @property
    @pulumi.getter(name="captureOssPath")
    def capture_oss_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def capture_oss_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "capture_oss_path", value)

    @property
    @pulumi.getter(name="captureVideo")
    def capture_video(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The capture video.
        """
    ...
    def capture_video(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter(name="inProtocol")
    def in_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The use of the access protocol support gb28181, Real Time Messaging Protocol (rtmp). Valid values: `gb28181`, `rtmp`.
        """
        return pulumi.get(self, "in_protocol")
    ...
    @in_protocol.setter
    def in_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "in_protocol", value)

    @property
    @pulumi.getter(name="lazyPull")
    def lazy_pull(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @lazy_pull.setter
    def lazy_pull(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "lazy_pull", value)

    @property
    @pulumi.getter(name="outProtocol")
    def out_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The playback protocol used by the space, multiple values are separated by commas (,). Valid values: `flv`,`hls`, `rtmp`.
        """
        return pulumi.get(self, "out_protocol")
    ...
    @out_protocol.setter
    def out_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "out_protocol", value)

    @property
    @pulumi.getter(name="playDomain")
    def play_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The domain name of plan streaming used by the group.
        """
        return pulumi.get(self, "play_domain")
    ...
    @play_domain.setter
    def play_domain(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "play_domain", value)

    @property
    @pulumi.getter(name="pushDomain")
    def push_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The domain name of push streaming used by the group.
        """
        return pulumi.get(self, "push_domain")
    ...
    @push_domain.setter
    def push_domain(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "push_domain", value)
...
class SystemGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            play_domain: Optional[pulumi.Input[builtins.str]] = None,
            push_domain: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.bool]] = None) -> 'SystemGroup':
        """
    ...
    @property
    @pulumi.getter
    def callback(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The space within the device status update of the callback, need to start with http:// or https:// at the beginning.
        """
        return pulumi.get(self, "callback")
    ...
    @property
    @pulumi.getter(name="captureImage")
    def capture_image(self) -> pulumi.Output[builtins.int]:
        """
        The capture image.
        """
        return pulumi.get(self, "capture_image")
    ...
    @property
    @pulumi.getter(name="captureInterval")
    def capture_interval(self) -> pulumi.Output[builtins.int]:
        """
        The capture interval.
        """
        return pulumi.get(self, "capture_interval")
    ...
    @property
    @pulumi.getter(name="captureOssBucket")
    def capture_oss_bucket(self) -> pulumi.Output[builtins.str]:
        """
        The capture oss bucket.
        """
        return pulumi.get(self, "capture_oss_bucket")
    ...
    @property
    @pulumi.getter(name="captureOssPath")
    def capture_oss_path(self) -> pulumi.Output[builtins.str]:
        """
        The capture oss path.
        """
        return pulumi.get(self, "capture_oss_path")
    ...
    @property
    @pulumi.getter(name="captureVideo")
    def capture_video(self) -> pulumi.Output[builtins.int]:
        """
        The capture video.
        """
        return pulumi.get(self, "capture_video")
    ...
    @property
    @pulumi.getter(name="inProtocol")
    def in_protocol(self) -> pulumi.Output[builtins.str]:
        """
        The use of the access protocol support gb28181, Real Time Messaging Protocol (rtmp). Valid values: `gb28181`, `rtmp`.
        """
        return pulumi.get(self, "in_protocol")
    ...
    @property
    @pulumi.getter(name="lazyPull")
    def lazy_pull(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to enable on-demand streaming. Default value:`false`.
        """
        return pulumi.get(self, "lazy_pull")
    ...
    @property
    @pulumi.getter(name="outProtocol")
    def out_protocol(self) -> pulumi.Output[builtins.str]:
        """
        The playback protocol used by the space, multiple values are separated by commas (,). Valid values: `flv`,`hls`, `rtmp`.
        """
        return pulumi.get(self, "out_protocol")
    ...
    @property
    @pulumi.getter(name="playDomain")
    def play_domain(self) -> pulumi.Output[builtins.str]:
        """
        The domain name of plan streaming used by the group.
        """
        return pulumi.get(self, "play_domain")
    ...
    @property
    @pulumi.getter(name="pushDomain")
    def push_domain(self) -> pulumi.Output[builtins.str]:
        """
        The domain name of push streaming used by the group.
        """
        return pulumi.get(self, "push_domain")
