...
class GetSystemGroupsResult:
    ...
    def in_protocol(self) -> Optional[builtins.str]:
...
def get_system_groups(ids: Optional[Sequence[builtins.str]] = None,
                      in_protocol: Optional[builtins.str] = None,
    ...
    :param builtins.str in_protocol: The use of the access protocol support gb28181, Real Time Messaging Protocol (rtmp). Valid values: `gb28181`, `rtmp`.
    ...
    :param builtins.str status: The status. Valid values: `on`,`off`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_system_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             in_protocol: Optional[pulumi.Input[Optional[builtins.str]]] = None,
