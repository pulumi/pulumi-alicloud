...
class GetSystemGroupsResult:
    ...
    def in_protocol(self) -> Optional[_builtins.str]:
...
def get_system_groups(ids: Optional[Sequence[_builtins.str]] = None,
                      in_protocol: Optional[_builtins.str] = None,
    ...
    :param _builtins.str in_protocol: The use of the access protocol support gb28181, Real Time Messaging Protocol (rtmp). Valid values: `gb28181`, `rtmp`.
    ...
    :param _builtins.str status: The status. Valid values: `on`,`off`.
    """
    __args__ = dict()
    __args__['ids'] = ids
