...
class GetDdosCooPortsResult:
    ...
    def frontend_port(self) -> Optional[builtins.str]:
        """
        The forwarding port.
        """
    ...
    def frontend_protocol(self) -> Optional[builtins.str]:
        """
...
def get_ddos_coo_ports(frontend_port: Optional[builtins.str] = None,
                       frontend_protocol: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Port IDs.
...
def get_ddos_coo_ports_output(frontend_port: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              frontend_protocol: Optional[pulumi.Input[Optional[builtins.str]]] = None,
