...
def get_ddos_bgp_instances(ids: Optional[Sequence[builtins.str]] = None,
...
def get_ddos_bgp_instances_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
