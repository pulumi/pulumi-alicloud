...
class GetDdosCooDomainResourcesResult:
    ...
    def query_domain_pattern(self) -> Optional[_builtins.str]:
...
def get_ddos_coo_domain_resources(ids: Optional[Sequence[_builtins.str]] = None,
                                  instance_ids: Optional[Sequence[_builtins.str]] = None,
                                  output_file: Optional[_builtins.str] = None,
                                  query_domain_pattern: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Domain Resource IDs.
    :param Sequence[_builtins.str] instance_ids: A ID list of Ddoscoo instance.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str query_domain_pattern: Match the pattern.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_ddos_coo_domain_resources_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                         instance_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                         output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                         query_domain_pattern: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
