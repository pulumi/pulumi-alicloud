...
class DomainResourceArgs:
    def __init__(__self__, *,
                 ...
                 real_servers: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 rs_type: pulumi.Input[builtins.int],
                 cert: Optional[pulumi.Input[builtins.str]] = None,
                 cert_identifier: Optional[pulumi.Input[builtins.str]] = None,
                 cert_name: Optional[pulumi.Input[builtins.str]] = None,
                 cert_region: Optional[pulumi.Input[builtins.str]] = None,
                 https_ext: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] domain: The domain name for which you want to configure the Static Page Caching policy.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_ids: InstanceIds
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] real_servers: Server address information of the source station.
        :param pulumi.Input[builtins.int] rs_type: The address type of the origin server. Valid values:
        :param pulumi.Input[builtins.str] cert: The private key of the certificate that you want to associate. This parameter must be used together with the CertName and Cert parameters.
        ...
        :param pulumi.Input[builtins.str] cert_name: The public key of the certificate that you want to associate. This parameter must be used together with the CertName and Key parameters.
               ...
               > **NOTE:**   If you specify a value for the CertName, Cert, and Key parameters, you do not need to specify a value for the CertId parameter.
        :param pulumi.Input[builtins.str] cert_region: The region of the certificate. `cn-hangzhou` and `ap-southeast-1` are supported. The default value is `cn-hangzhou`.
        :param pulumi.Input[builtins.str] https_ext: The advanced HTTPS settings. This parameter takes effect only when the value of the `ProxyType` parameter includes `https`. The value is a string that consists of a JSON struct. The JSON struct contains the following fields:
        ...
        :param pulumi.Input[builtins.str] key: The globally unique ID of the certificate. The value is in the "Certificate ID-cn-hangzhou" format. For example, if the ID of the certificate is 123, the value of the CertIdentifier parameter is 123-cn-hangzhou.
               
               > **NOTE:**   You can specify only one of this parameter and the CertId parameter.
        :param pulumi.Input[builtins.bool] ocsp_enabled: Specifies whether to enable the OCSP feature. Valid values:
        """
    ...
    def real_servers(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @real_servers.setter
    def real_servers(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "real_servers", value)

    @property
    @pulumi.getter(name="rsType")
    def rs_type(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @rs_type.setter
    def rs_type(self, value: pulumi.Input[builtins.int]):
    ...
    def cert_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cert_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def https_ext(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @https_ext.setter
    def https_ext(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DomainResourceState:
    def __init__(__self__, *,
                 ...
                 real_servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 rs_type: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] cert_name: The public key of the certificate that you want to associate. This parameter must be used together with the CertName and Key parameters.
               ...
               > **NOTE:**   If you specify a value for the CertName, Cert, and Key parameters, you do not need to specify a value for the CertId parameter.
        :param pulumi.Input[builtins.str] cert_region: The region of the certificate. `cn-hangzhou` and `ap-southeast-1` are supported. The default value is `cn-hangzhou`.
        :param pulumi.Input[builtins.str] cname: The CNAME address to query.
        :param pulumi.Input[builtins.str] domain: The domain name for which you want to configure the Static Page Caching policy.
    ...
    @property
    @pulumi.getter(name="realServers")
    def real_servers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Server address information of the source station.
        """
        return pulumi.get(self, "real_servers")
    ...
    @real_servers.setter
    def real_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "real_servers", value)

    @property
    @pulumi.getter(name="rsType")
    def rs_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The address type of the origin server. Valid values:
        """
        return pulumi.get(self, "rs_type")
    ...
    @rs_type.setter
    def rs_type(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "rs_type", value)
...
class DomainResource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            proxy_types: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DomainResourceProxyTypeArgs', 'DomainResourceProxyTypeArgsDict']]]]] = None,
            real_servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            rs_type: Optional[pulumi.Input[builtins.int]] = None) -> 'DomainResource':
        """
    ...
    @property
    @pulumi.getter
    def cert(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The private key of the certificate that you want to associate. This parameter must be used together with the CertName and Cert parameters.
    ...
    @property
    @pulumi.getter(name="certIdentifier")
    def cert_identifier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the certificate.
    ...
    @property
    @pulumi.getter(name="certRegion")
    def cert_region(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The region of the certificate. `cn-hangzhou` and `ap-southeast-1` are supported. The default value is `cn-hangzhou`.
        """
        return pulumi.get(self, "cert_region")
    ...
    @property
    @pulumi.getter(name="httpsExt")
    def https_ext(self) -> pulumi.Output[builtins.str]:
        """
        The advanced HTTPS settings. This parameter takes effect only when the value of the `ProxyType` parameter includes `https`. The value is a string that consists of a JSON struct. The JSON struct contains the following fields:
    ...
    @property
    @pulumi.getter(name="ocspEnabled")
    def ocsp_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable the OCSP feature. Valid values:
        """
        return pulumi.get(self, "ocsp_enabled")
    ...
    @property
    @pulumi.getter(name="realServers")
    def real_servers(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Server address information of the source station.
        """
        return pulumi.get(self, "real_servers")
    ...
    @property
    @pulumi.getter(name="rsType")
    def rs_type(self) -> pulumi.Output[builtins.int]:
        """
        The address type of the origin server. Valid values:
        """
        return pulumi.get(self, "rs_type")
