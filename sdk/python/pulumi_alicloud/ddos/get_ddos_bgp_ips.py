...
def get_ddos_bgp_ips(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ip IDs.
    ...
    :param builtins.str product_name: The product name. Valid Value:`ECS`, `SLB`, `EIP`, `WAF`.
    :param builtins.str status: The current state of the IP address. Valid Value:
...
def get_ddos_bgp_ips_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
