...
class PortArgs:
    def __init__(__self__, *,
                 frontend_port: pulumi.Input[builtins.str],
                 ...
                 backend_port: Optional[pulumi.Input[builtins.str]] = None,
                 config: Optional[pulumi.Input['PortConfigArgs']] = None):
        """
        The set of arguments for constructing a Port resource.
        :param pulumi.Input[builtins.str] frontend_port: The forwarding port to query. Valid values: `0` to `65535`.
        :param pulumi.Input[builtins.str] frontend_protocol: The type of the forwarding protocol to query. Valid values:
        :param pulumi.Input[builtins.str] instance_id: The ID of the Anti-DDoS Pro or Anti-DDoS Premium instance to which the port forwarding rule belongs.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] real_servers: List of source IP addresses
        :param pulumi.Input[builtins.str] backend_port: The port of the origin server. Valid values: `0` to `65535`.
    ...
    def frontend_port(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def frontend_port(self, value: pulumi.Input[builtins.str]):
    ...
    def backend_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @backend_port.setter
    def backend_port(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PortState:
    def __init__(__self__, *,
                 backend_port: Optional[pulumi.Input[builtins.str]] = None,
                 config: Optional[pulumi.Input['PortConfigArgs']] = None,
                 frontend_port: Optional[pulumi.Input[builtins.str]] = None,
                 frontend_protocol: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="frontendPort")
    def frontend_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The forwarding port to query. Valid values: `0` to `65535`.
        """
        return pulumi.get(self, "frontend_port")
    ...
    @frontend_port.setter
    def frontend_port(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "frontend_port", value)

    @property
    @pulumi.getter(name="frontendProtocol")
    def frontend_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the forwarding protocol to query. Valid values:
        """
        return pulumi.get(self, "frontend_protocol")
    ...
    @frontend_protocol.setter
    def frontend_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "frontend_protocol", value)
...
class Port(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            frontend_protocol: Optional[pulumi.Input[builtins.str]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            real_servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Port':
        """
    ...
    @property
    @pulumi.getter(name="backendPort")
    def backend_port(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The port of the origin server. Valid values: `0` to `65535`.
        """
        return pulumi.get(self, "backend_port")
    ...
    @property
    @pulumi.getter(name="frontendPort")
    def frontend_port(self) -> pulumi.Output[builtins.str]:
        """
        The forwarding port to query. Valid values: `0` to `65535`.
        """
        return pulumi.get(self, "frontend_port")
    ...
    @property
    @pulumi.getter(name="frontendProtocol")
    def frontend_protocol(self) -> pulumi.Output[builtins.str]:
        """
        The type of the forwarding protocol to query. Valid values:
        """
        return pulumi.get(self, "frontend_protocol")
