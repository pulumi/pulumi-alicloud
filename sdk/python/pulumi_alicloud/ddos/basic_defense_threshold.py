...
class BasicDefenseThresholdArgs:
    def __init__(__self__, *,
                 ddos_type: pulumi.Input[builtins.str],
                 ...
                 is_auto: Optional[pulumi.Input[builtins.bool]] = None,
                 pps: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a BasicDefenseThreshold resource.
        :param pulumi.Input[builtins.str] ddos_type: The type of the threshold to query. Valid values: `defense`,`blackhole`.
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] instance_type: The instance type of the public IP address asset. Value: `ecs`,`slb`,`eip`.
        :param pulumi.Input[builtins.int] bps: Specifies the traffic scrubbing threshold. Unit: Mbit/s. The traffic scrubbing threshold cannot exceed the peak inbound or outbound Internet traffic, whichever is larger, of the asset.
        :param pulumi.Input[builtins.str] internet_ip: The Internet IP address.
        :param pulumi.Input[builtins.bool] is_auto: Whether it is the system default threshold. Value:
        :param pulumi.Input[builtins.int] pps: The current message number cleaning threshold. Unit: pps.
        """
    ...
    def ddos_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ddos_type.setter
    def ddos_type(self, value: pulumi.Input[builtins.str]):
    ...
    def is_auto(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_auto.setter
    def is_auto(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_auto", value)

    @property
    @pulumi.getter
    def pps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @pps.setter
    def pps(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _BasicDefenseThresholdState:
    def __init__(__self__, *,
                 bps: Optional[pulumi.Input[builtins.int]] = None,
                 ddos_type: Optional[pulumi.Input[builtins.str]] = None,
                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 instance_type: Optional[pulumi.Input[builtins.str]] = None,
                 internet_ip: Optional[pulumi.Input[builtins.str]] = None,
                 is_auto: Optional[pulumi.Input[builtins.bool]] = None,
                 max_bps: Optional[pulumi.Input[builtins.int]] = None,
                 max_pps: Optional[pulumi.Input[builtins.int]] = None,
                 pps: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] internet_ip: The Internet IP address.
        :param pulumi.Input[builtins.bool] is_auto: Whether it is the system default threshold. Value:
        :param pulumi.Input[builtins.int] max_bps: The maximum traffic scrubbing threshold. Unit: Mbit/s.
        :param pulumi.Input[builtins.int] max_pps: The maximum packet scrubbing threshold. Unit: pps.
        :param pulumi.Input[builtins.int] pps: The current message number cleaning threshold. Unit: pps.
        """
        if bps is not None:
            pulumi.set(__self__, "bps", bps)
    ...
    @property
    @pulumi.getter(name="ddosType")
    def ddos_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the threshold to query. Valid values: `defense`,`blackhole`.
        """
        return pulumi.get(self, "ddos_type")
    ...
    @ddos_type.setter
    def ddos_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ddos_type", value)
    ...
    def max_bps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @max_bps.setter
    def max_bps(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_bps", value)

    @property
    @pulumi.getter(name="maxPps")
    def max_pps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @max_pps.setter
    def max_pps(self, value: Optional[pulumi.Input[builtins.int]]):
...
class BasicDefenseThreshold(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            max_bps: Optional[pulumi.Input[builtins.int]] = None,
            max_pps: Optional[pulumi.Input[builtins.int]] = None,
            pps: Optional[pulumi.Input[builtins.int]] = None) -> 'BasicDefenseThreshold':
        """
    ...
    @property
    @pulumi.getter(name="ddosType")
    def ddos_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the threshold to query. Valid values: `defense`,`blackhole`.
        """
        return pulumi.get(self, "ddos_type")
    ...
    @property
    @pulumi.getter(name="isAuto")
    def is_auto(self) -> pulumi.Output[builtins.bool]:
        """
        Whether it is the system default threshold. Value:
        """
        return pulumi.get(self, "is_auto")
    ...
    @property
    @pulumi.getter(name="maxBps")
    def max_bps(self) -> pulumi.Output[builtins.int]:
        """
        The maximum traffic scrubbing threshold. Unit: Mbit/s.
        """
        return pulumi.get(self, "max_bps")
    ...
    @property
    @pulumi.getter(name="maxPps")
    def max_pps(self) -> pulumi.Output[builtins.int]:
        """
        The maximum packet scrubbing threshold. Unit: pps.
        """
        return pulumi.get(self, "max_pps")
    ...
    @property
    @pulumi.getter
    def pps(self) -> pulumi.Output[builtins.int]:
        """
        The current message number cleaning threshold. Unit: pps.
        """
        return pulumi.get(self, "pps")
