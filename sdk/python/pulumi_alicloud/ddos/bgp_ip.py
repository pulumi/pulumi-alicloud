...
class BgpIpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The ID of the native protection enterprise instance to be operated.
        :param pulumi.Input[builtins.str] ip: The IP address.
        :param pulumi.Input[builtins.str] member_uid: The member account id of the IP address.
...
class _BgpIpState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] member_uid: The member account id of the IP address.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] status: The current state of the IP address. Valid Value: `normal`, `hole_begin`.
        """
...
class BgpIp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            member_uid: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'BgpIp':
        """
    ...
    @property
    @pulumi.getter(name="memberUid")
    def member_uid(self) -> pulumi.Output[builtins.str]:
        """
        The member account id of the IP address.
        """
        return pulumi.get(self, "member_uid")
