...
class SchedulerRule(pulumi.CustomResource):
    ...
    `RegionId`: String type, optional (Required when ValueType is 2) the ID of the region.
      ...
      * `valueType` (`float`)
    """
    def __init__(__self__, resource_name, opts=None, param=None, resource_group_id=None, rule_name=None, rule_type=None, rules=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[float] rule_type: The rule type. Valid values:
               ...
               `3`: globalization acceleration.
               `6`: Cloud product interaction.
        :param pulumi.Input[list] rules: The details of the common filter interaction rule, expressed as a JSON string. The structure is as follows:
               `Type`: String type, required, the address format of the linkage resource. Valid values:
               `A`: IP address.
               `CNAME`: Domain name.
               `Value`: String type, required, link address of resource.
    ...
    @staticmethod
    def get(resource_name, id, opts=None, cname=None, param=None, resource_group_id=None, rule_name=None, rule_type=None, rules=None):
        """
