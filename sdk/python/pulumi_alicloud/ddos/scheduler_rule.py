...
class SchedulerRuleArgs:
    def __init__(__self__, *,
                 ...
                 rule_type: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.int] rule_type: The rule type. Valid values:
               `2`: tiered protection.
        ...
        :param pulumi.Input[builtins.str] param: The scheduling rule for the Global Accelerator instance that interacts with Anti-DDoS Pro or Anti-DDoS Premium.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the anti-DDoS pro instance belongs in resource management. By default, no value is specified, indicating that the domains in the default resource group are listed.
        """
    ...
    def rule_type(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @rule_type.setter
    def rule_type(self, value: pulumi.Input[builtins.int]):
...
class _SchedulerRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cname: The cname is the traffic scheduler corresponding to rules.
        :param pulumi.Input[builtins.str] param: The scheduling rule for the Global Accelerator instance that interacts with Anti-DDoS Pro or Anti-DDoS Premium.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the anti-DDoS pro instance belongs in resource management. By default, no value is specified, indicating that the domains in the default resource group are listed.
        :param pulumi.Input[builtins.str] rule_name: The name of the rule.
        :param pulumi.Input[builtins.int] rule_type: The rule type. Valid values:
...
class SchedulerRule(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="ruleType")
    def rule_type(self) -> pulumi.Output[builtins.int]:
        """
        The rule type. Valid values:
        `2`: tiered protection.
        `3`: globalization acceleration.
