...
def get_ddos_coo_instances(ids: Optional[Sequence[builtins.str]] = None,
...
def get_ddos_coo_instances_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
