...
class MscSubSubscriptionArgs:
    def __init__(__self__, *,
                 item_name: pulumi.Input[builtins.str],
                 contact_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 email_status: Optional[pulumi.Input[builtins.int]] = None,
                 pmsg_status: Optional[pulumi.Input[builtins.int]] = None,
                 sms_status: Optional[pulumi.Input[builtins.int]] = None,
                 tts_status: Optional[pulumi.Input[builtins.int]] = None,
                 webhook_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 webhook_status: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a MscSubSubscription resource.
        :param pulumi.Input[builtins.str] item_name: The name of the Subscription. **NOTE:**  You should use the `get_msc_sub_subscriptions` to query the available subscription item name.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contact_ids: The ids of subscribed contacts.
        ...
        :param pulumi.Input[builtins.int] email_status: The status of email subscription. Valid values: `-1`, `-2`, `0`, `1`. `-1` means required, `-2` means banned; `1` means subscribed; `0` means not subscribed.
        :param pulumi.Input[builtins.int] pmsg_status: The status of pmsg subscription. Valid values: `-1`, `-2`, `0`, `1`. `-1` means required, `-2` means banned; `1` means subscribed; `0` means not subscribed.
        :param pulumi.Input[builtins.int] sms_status: The status of sms subscription. Valid values: `-1`, `-2`, `0`, `1`. `-1` means required, `-2` means banned; `1` means subscribed; `0` means not subscribed.
        :param pulumi.Input[builtins.int] tts_status: The status of tts subscription. Valid values: `-1`, `-2`, `0`, `1`. `-1` means required, `-2` means banned; `1` means subscribed; `0` means not subscribed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] webhook_ids: The ids of subscribed webhooks.
        :param pulumi.Input[builtins.int] webhook_status: The status of webhook subscription. Valid values: `-1`, `-2`, `0`, `1`. `-1` means required, `-2` means banned; `1` means subscribed; `0` means not subscribed.
        """
    ...
    def item_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @item_name.setter
    def item_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "item_name", value)

    @property
    @pulumi.getter(name="contactIds")
    def contact_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @contact_ids.setter
    def contact_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "contact_ids", value)

    @property
    @pulumi.getter(name="emailStatus")
    def email_status(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @email_status.setter
    def email_status(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "email_status", value)

    @property
    @pulumi.getter(name="pmsgStatus")
    def pmsg_status(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @pmsg_status.setter
    def pmsg_status(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "pmsg_status", value)

    @property
    @pulumi.getter(name="smsStatus")
    def sms_status(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @sms_status.setter
    def sms_status(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "sms_status", value)

    @property
    @pulumi.getter(name="ttsStatus")
    def tts_status(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @tts_status.setter
    def tts_status(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def webhook_status(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def webhook_status(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _MscSubSubscriptionState:
    def __init__(__self__, *,
                 ...
                 email_status: Optional[pulumi.Input[builtins.int]] = None,
                 item_name: Optional[pulumi.Input[builtins.str]] = None,
                 pmsg_status: Optional[pulumi.Input[builtins.int]] = None,
                 sms_status: Optional[pulumi.Input[builtins.int]] = None,
                 tts_status: Optional[pulumi.Input[builtins.int]] = None,
                 webhook_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] channel: The channel the Subscription.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contact_ids: The ids of subscribed contacts.
               **NOTE:** There is a potential diff error because of the order of `contact_ids` values indefinite.
               So, from version 1.161.0, `contact_ids` type has been updated as `set` from `list`,
               and you can use tolist to convert it to a list.
        :param pulumi.Input[builtins.str] description: The description of the Subscription.
        :param pulumi.Input[builtins.int] email_status: The status of email subscription. Valid values: `-1`, `-2`, `0`, `1`. `-1` means required, `-2` means banned; `1` means subscribed; `0` means not subscribed.
        :param pulumi.Input[builtins.str] item_name: The name of the Subscription. **NOTE:**  You should use the `get_msc_sub_subscriptions` to query the available subscription item name.
        :param pulumi.Input[builtins.int] pmsg_status: The status of pmsg subscription. Valid values: `-1`, `-2`, `0`, `1`. `-1` means required, `-2` means banned; `1` means subscribed; `0` means not subscribed.
        :param pulumi.Input[builtins.int] sms_status: The status of sms subscription. Valid values: `-1`, `-2`, `0`, `1`. `-1` means required, `-2` means banned; `1` means subscribed; `0` means not subscribed.
    ...
    @property
    @pulumi.getter(name="itemName")
    def item_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Subscription. **NOTE:**  You should use the `get_msc_sub_subscriptions` to query the available subscription item name.
        """
        return pulumi.get(self, "item_name")
    ...
    @item_name.setter
    def item_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "item_name", value)
...
@pulumi.type_token("alicloud:index/mscSubSubscription:MscSubSubscription")
class MscSubSubscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tts_status: Optional[pulumi.Input[builtins.int]] = None,
            webhook_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            webhook_status: Optional[pulumi.Input[builtins.int]] = None) -> 'MscSubSubscription':
        """
    ...
    @property
    @pulumi.getter(name="emailStatus")
    def email_status(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The status of email subscription. Valid values: `-1`, `-2`, `0`, `1`. `-1` means required, `-2` means banned; `1` means subscribed; `0` means not subscribed.
        """
        return pulumi.get(self, "email_status")
    ...
    @property
    @pulumi.getter(name="itemName")
    def item_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Subscription. **NOTE:**  You should use the `get_msc_sub_subscriptions` to query the available subscription item name.
        """
        return pulumi.get(self, "item_name")
    ...
    @property
    @pulumi.getter(name="pmsgStatus")
    def pmsg_status(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The status of pmsg subscription. Valid values: `-1`, `-2`, `0`, `1`. `-1` means required, `-2` means banned; `1` means subscribed; `0` means not subscribed.
        """
        return pulumi.get(self, "pmsg_status")
    ...
    @property
    @pulumi.getter(name="smsStatus")
    def sms_status(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The status of sms subscription. Valid values: `-1`, `-2`, `0`, `1`. `-1` means required, `-2` means banned; `1` means subscribed; `0` means not subscribed.
        """
        return pulumi.get(self, "sms_status")
    ...
    @property
    @pulumi.getter(name="ttsStatus")
    def tts_status(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The status of tts subscription. Valid values: `-1`, `-2`, `0`, `1`. `-1` means required, `-2` means banned; `1` means subscribed; `0` means not subscribed.
        """
        return pulumi.get(self, "tts_status")
    ...
    @property
    @pulumi.getter(name="webhookIds")
    def webhook_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The ids of subscribed webhooks.
        """
        return pulumi.get(self, "webhook_ids")
    ...
    @property
    @pulumi.getter(name="webhookStatus")
    def webhook_status(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The status of webhook subscription. Valid values: `-1`, `-2`, `0`, `1`. `-1` means required, `-2` means banned; `1` means subscribed; `0` means not subscribed.
        """
        return pulumi.get(self, "webhook_status")
