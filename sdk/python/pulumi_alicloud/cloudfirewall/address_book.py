...
class AddressBookArgs:
    def __init__(__self__, *,
                 ...
                 auto_add_tag_ecs: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The description of the Address Book.
        :param pulumi.Input[builtins.str] group_name: The name of the Address Book.
        :param pulumi.Input[builtins.str] group_type: The type of the Address Book. Valid values: `ip`, `ipv6`, `domain`, `port`, `tag`.
               **NOTE:** From version 1.213.1, `group_type` can be set to `ipv6`, `domain`, `port`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] address_lists: The list of addresses.
        :param pulumi.Input[builtins.int] auto_add_tag_ecs: Whether you want to automatically add new matching tags of the ECS IP address to the Address Book. Valid values: `0`, `1`.
        ...
        :param pulumi.Input[builtins.str] tag_relation: The logical relation among the ECS tags that to be matched. Default value: `and`. Valid values:
        """
    ...
    def auto_add_tag_ecs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def auto_add_tag_ecs(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AddressBook(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            group_type: Optional[pulumi.Input[builtins.str]] = None,
            lang: Optional[pulumi.Input[builtins.str]] = None,
            tag_relation: Optional[pulumi.Input[builtins.str]] = None) -> 'AddressBook':
        """
    ...
    @property
    @pulumi.getter(name="addressLists")
    def address_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of addresses.
        """
        return pulumi.get(self, "address_lists")
    ...
    @property
    @pulumi.getter(name="autoAddTagEcs")
    def auto_add_tag_ecs(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Whether you want to automatically add new matching tags of the ECS IP address to the Address Book. Valid values: `0`, `1`.
        """
        return pulumi.get(self, "auto_add_tag_ecs")
