...
class NatFirewallArgs:
    def __init__(__self__, *,
                 ...
                 proxy_name: pulumi.Input[builtins.str],
                 region_no: pulumi.Input[builtins.str],
                 vpc_id: pulumi.Input[builtins.str],
                 firewall_switch: Optional[pulumi.Input[builtins.str]] = None,
                 lang: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 strict_mode: Optional[pulumi.Input[builtins.int]] = None,
                 vswitch_auto: Optional[pulumi.Input[builtins.str]] = None,
                 vswitch_cidr: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] proxy_name: NAT firewall name.
        :param pulumi.Input[builtins.str] region_no: Region.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC instance.
        :param pulumi.Input[builtins.str] firewall_switch: Safety protection switch. Value:-**open**: open-**close**: close.
        :param pulumi.Input[builtins.str] lang: Lang.
        :param pulumi.Input[builtins.str] status: The status of the resource.
        :param pulumi.Input[builtins.int] strict_mode: Whether strict mode is enabled 1-Enable strict mode 0-Disable strict mode.
        :param pulumi.Input[builtins.str] vswitch_auto: Whether to use switch automatic mode. Value: **true**: Use automatic mode: **false**: Use manual mode.
        :param pulumi.Input[builtins.str] vswitch_cidr: The network segment of the virtual switch. Required for Switch automatic mode.
        :param pulumi.Input[builtins.str] vswitch_id: The switch ID. Required for switch manual mode.
        """
    ...
    def proxy_name(self) -> pulumi.Input[builtins.str]:
        """
        NAT firewall name.
        """
    ...
    @proxy_name.setter
    def proxy_name(self, value: pulumi.Input[builtins.str]):
    ...
    def firewall_switch(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def firewall_switch(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def strict_mode(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @strict_mode.setter
    def strict_mode(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "strict_mode", value)

    @property
    @pulumi.getter(name="vswitchAuto")
    def vswitch_auto(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @vswitch_auto.setter
    def vswitch_auto(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vswitch_auto", value)

    @property
    @pulumi.getter(name="vswitchCidr")
    def vswitch_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @vswitch_cidr.setter
    def vswitch_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NatFirewallState:
    def __init__(__self__, *,
                 ...
                 proxy_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="proxyName")
    def proxy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        NAT firewall name.
        """
        return pulumi.get(self, "proxy_name")
    ...
    @proxy_name.setter
    def proxy_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "proxy_name", value)
...
class NatFirewall(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vswitch_auto: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_cidr: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NatFirewall':
        """
    ...
    @property
    @pulumi.getter(name="firewallSwitch")
    def firewall_switch(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Safety protection switch. Value:-**open**: open-**close**: close.
        """
        return pulumi.get(self, "firewall_switch")
    ...
    @property
    @pulumi.getter(name="proxyName")
    def proxy_name(self) -> pulumi.Output[builtins.str]:
        """
        NAT firewall name.
        """
        return pulumi.get(self, "proxy_name")
    ...
    @property
    @pulumi.getter(name="strictMode")
    def strict_mode(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Whether strict mode is enabled 1-Enable strict mode 0-Disable strict mode.
        """
        return pulumi.get(self, "strict_mode")
    ...
    @property
    @pulumi.getter(name="vswitchAuto")
    def vswitch_auto(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether to use switch automatic mode. Value: **true**: Use automatic mode: **false**: Use manual mode.
        """
        return pulumi.get(self, "vswitch_auto")
    ...
    @property
    @pulumi.getter(name="vswitchCidr")
    def vswitch_cidr(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The network segment of the virtual switch. Required for Switch automatic mode.
        """
        return pulumi.get(self, "vswitch_cidr")
