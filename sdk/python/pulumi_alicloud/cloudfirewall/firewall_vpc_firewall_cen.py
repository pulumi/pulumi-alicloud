...
class FirewallVpcFirewallCenArgs:
    def __init__(__self__, *,
                 ...
                 vpc_firewall_name: pulumi.Input[builtins.str],
                 vpc_region: pulumi.Input[builtins.str],
                 lang: Optional[pulumi.Input[builtins.str]] = None,
                 member_uid: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] status: Firewall switch status.
        :param pulumi.Input[builtins.str] vpc_firewall_name: The name of the VPC firewall instance.
        :param pulumi.Input[builtins.str] vpc_region: The ID of the region to which the VPC is created.
        :param pulumi.Input[builtins.str] lang: The language type of the requested and received messages. Valid values:
        :param pulumi.Input[builtins.str] member_uid: The UID of the member account (other Alibaba Cloud account) of the current Alibaba cloud account.
        """
    ...
    def vpc_firewall_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vpc_firewall_name(self, value: pulumi.Input[builtins.str]):
    ...
    def member_uid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @member_uid.setter
    def member_uid(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FirewallVpcFirewallCenState:
    def __init__(__self__, *,
                 ...
                 connect_type: Optional[pulumi.Input[builtins.str]] = None,
                 lang: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cen_id: The ID of the CEN instance.
        :param pulumi.Input[builtins.str] connect_type: Intercommunication type, value: expressconnect: Express Channel cen: Cloud Enterprise Network
        :param pulumi.Input[builtins.str] lang: The language type of the requested and received messages. Valid values:
        :param pulumi.Input['FirewallVpcFirewallCenLocalVpcArgs'] local_vpc: The details of the VPC. See `local_vpc` below.
        :param pulumi.Input[builtins.str] member_uid: The UID of the member account (other Alibaba Cloud account) of the current Alibaba cloud account.
        :param pulumi.Input[builtins.str] status: Firewall switch status.
        :param pulumi.Input[builtins.str] vpc_firewall_id: VPC firewall ID
        :param pulumi.Input[builtins.str] vpc_firewall_name: The name of the VPC firewall instance.
        :param pulumi.Input[builtins.str] vpc_region: The ID of the region to which the VPC is created.
        """
    ...
    def connect_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @connect_type.setter
    def connect_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FirewallVpcFirewallCen(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:cloudfirewall/firewallVpcFirewallCen:FirewallVpcFirewallCen"
    ...
    def get(resource_name: str,
            ...
            vpc_firewall_id: Optional[pulumi.Input[builtins.str]] = None,
            vpc_firewall_name: Optional[pulumi.Input[builtins.str]] = None,
            vpc_region: Optional[pulumi.Input[builtins.str]] = None) -> 'FirewallVpcFirewallCen':
        """
    ...
    @property
    @pulumi.getter(name="connectType")
    def connect_type(self) -> pulumi.Output[builtins.str]:
        """
        Intercommunication type, value: expressconnect: Express Channel cen: Cloud Enterprise Network
        """
        return pulumi.get(self, "connect_type")
    ...
    @property
    @pulumi.getter(name="memberUid")
    def member_uid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The UID of the member account (other Alibaba Cloud account) of the current Alibaba cloud account.
        """
        return pulumi.get(self, "member_uid")
