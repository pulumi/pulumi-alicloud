...
class FirewallVpcFirewallControlPolicyArgs:
    def __init__(__self__, *,
                 ...
                 release: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a FirewallVpcFirewallControlPolicy resource.
        :param pulumi.Input[builtins.str] acl_action: The action that Cloud Firewall performs on the traffic. Valid values: `accept`, `drop`, `log`.
        :param pulumi.Input[builtins.str] application_name: The type of the applications that the access control policy supports. Valid values: `FTP`, `HTTP`, `HTTPS`, `MySQL`, `SMTP`, `SMTPS`, `RDP`, `VNC`, `SSH`, `Redis`, `MQTT`, `MongoDB`, `Memcache`, `SSL`, `ANY`.
        :param pulumi.Input[builtins.str] description: Access control over VPC firewalls description of the strategy information.
        :param pulumi.Input[builtins.str] destination: The destination address in the access control policy. Valid values:
        ...
        :param pulumi.Input[builtins.str] destination_type: The type of the destination address in the access control policy. Valid values: `net`, `group`, `domain`.
        :param pulumi.Input[builtins.int] order: The priority of the access control policy. The priority value starts from 1. A smaller priority value indicates a higher priority.
        :param pulumi.Input[builtins.str] proto: The type of the protocol in the access control policy. Valid values: `ANY`, `TCP`, `UDP`, `ICMP`.
        :param pulumi.Input[builtins.str] source: Access control over VPC firewalls strategy in the source address.
        :param pulumi.Input[builtins.str] source_type: The type of the source address in the access control policy. Valid values: `net`, `group`.
        :param pulumi.Input[builtins.str] vpc_firewall_id: The ID of the VPC firewall instance. Valid values:
               - When the VPC firewall protects traffic between two VPCs connected through the cloud enterprise network, the policy group ID uses the cloud enterprise network instance ID.
               - When the VPC firewall protects traffic between two VPCs connected through the express connection, the policy group ID uses the ID of the VPC firewall instance.
        :param pulumi.Input[builtins.str] dest_port: The destination port in the access control policy. **Note:** If `dest_port_type` is set to `port`, you must specify this parameter.
        :param pulumi.Input[builtins.str] dest_port_group: Access control policy in the access traffic of the destination port address book name. **Note:** If `dest_port_type` is set to `group`, you must specify this parameter.
        :param pulumi.Input[builtins.str] dest_port_type: The type of the destination port in the access control policy. Valid values: `port`, `group`.
        :param pulumi.Input[builtins.str] lang: The language of the content within the request and response. Valid values: `zh`, `en`.
        :param pulumi.Input[builtins.str] member_uid: The UID of the member account of the current Alibaba cloud account.
        :param pulumi.Input[builtins.bool] release: The enabled status of the access control policy. The policy is enabled by default after it is created.. Valid values:
        """
    ...
    @property
    @pulumi.getter
    def release(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @release.setter
    def release(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _FirewallVpcFirewallControlPolicyState:
    def __init__(__self__, *,
                 ...
                 dest_port: Optional[pulumi.Input[builtins.str]] = None,
                 dest_port_group: Optional[pulumi.Input[builtins.str]] = None,
                 dest_port_group_ports: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 dest_port_type: Optional[pulumi.Input[builtins.str]] = None,
                 destination: Optional[pulumi.Input[builtins.str]] = None,
                 destination_group_cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 destination_group_type: Optional[pulumi.Input[builtins.str]] = None,
                 destination_type: Optional[pulumi.Input[builtins.str]] = None,
                 hit_times: Optional[pulumi.Input[builtins.int]] = None,
                 lang: Optional[pulumi.Input[builtins.str]] = None,
                 member_uid: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 source_group_cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] acl_action: The action that Cloud Firewall performs on the traffic. Valid values: `accept`, `drop`, `log`.
        :param pulumi.Input[builtins.str] acl_uuid: Access control over VPC firewalls strategy unique identifier.
        :param pulumi.Input[builtins.str] application_id: Policy specifies the application ID.
        :param pulumi.Input[builtins.str] application_name: The type of the applications that the access control policy supports. Valid values: `FTP`, `HTTP`, `HTTPS`, `MySQL`, `SMTP`, `SMTPS`, `RDP`, `VNC`, `SSH`, `Redis`, `MQTT`, `MongoDB`, `Memcache`, `SSL`, `ANY`.
        :param pulumi.Input[builtins.str] description: Access control over VPC firewalls description of the strategy information.
        :param pulumi.Input[builtins.str] dest_port: The destination port in the access control policy. **Note:** If `dest_port_type` is set to `port`, you must specify this parameter.
        :param pulumi.Input[builtins.str] dest_port_group: Access control policy in the access traffic of the destination port address book name. **Note:** If `dest_port_type` is set to `group`, you must specify this parameter.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dest_port_group_ports: Port Address Book port list.
        :param pulumi.Input[builtins.str] dest_port_type: The type of the destination port in the access control policy. Valid values: `port`, `group`.
        :param pulumi.Input[builtins.str] destination: The destination address in the access control policy. Valid values:
               - If `destination_type` is set to `net`, the value of `destination` must be a CIDR block.
               - If `destination_type` is set to `group`, the value of `destination` must be an address book.
               - If `destination_type` is set to `domain`, the value of `destination` must be a domain name.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] destination_group_cidrs: Destination address book defined in the address list.
        :param pulumi.Input[builtins.str] destination_group_type: The destination address book type in the access control policy.
        :param pulumi.Input[builtins.str] destination_type: The type of the destination address in the access control policy. Valid values: `net`, `group`, `domain`.
        :param pulumi.Input[builtins.int] hit_times: Control strategy of hits per second.
        :param pulumi.Input[builtins.str] lang: The language of the content within the request and response. Valid values: `zh`, `en`.
        :param pulumi.Input[builtins.str] member_uid: The UID of the member account of the current Alibaba cloud account.
        :param pulumi.Input[builtins.int] order: The priority of the access control policy. The priority value starts from 1. A smaller priority value indicates a higher priority.
        :param pulumi.Input[builtins.str] proto: The type of the protocol in the access control policy. Valid values: `ANY`, `TCP`, `UDP`, `ICMP`.
        :param pulumi.Input[builtins.bool] release: The enabled status of the access control policy. The policy is enabled by default after it is created.. Valid values:
        :param pulumi.Input[builtins.str] source: Access control over VPC firewalls strategy in the source address.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_group_cidrs: SOURCE address of the address list.
        :param pulumi.Input[builtins.str] source_group_type: The source address type in the access control policy.
        :param pulumi.Input[builtins.str] source_type: The type of the source address in the access control policy. Valid values: `net`, `group`.
        :param pulumi.Input[builtins.str] vpc_firewall_id: The ID of the VPC firewall instance. Valid values:
               - When the VPC firewall protects traffic between two VPCs connected through the cloud enterprise network, the policy group ID uses the cloud enterprise network instance ID.
               - When the VPC firewall protects traffic between two VPCs connected through the express connection, the policy group ID uses the ID of the VPC firewall instance.
    ...
    def dest_port_group_ports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def dest_port_group_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def destination_group_cidrs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def destination_group_cidrs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def hit_times(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @hit_times.setter
    def hit_times(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def source_group_cidrs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def source_group_cidrs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class FirewallVpcFirewallControlPolicy(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:cloudfirewall/firewallVpcFirewallControlPolicy:FirewallVpcFirewallControlPolicy"
    ...
    def get(resource_name: str,
            ...
            source_group_type: Optional[pulumi.Input[builtins.str]] = None,
            source_type: Optional[pulumi.Input[builtins.str]] = None,
            vpc_firewall_id: Optional[pulumi.Input[builtins.str]] = None) -> 'FirewallVpcFirewallControlPolicy':
        """
    ...
    @property
    @pulumi.getter(name="destPortGroupPorts")
    def dest_port_group_ports(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Port Address Book port list.
        """
        return pulumi.get(self, "dest_port_group_ports")
    ...
    @property
    @pulumi.getter(name="destinationGroupCidrs")
    def destination_group_cidrs(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Destination address book defined in the address list.
        """
        return pulumi.get(self, "destination_group_cidrs")
    ...
    @property
    @pulumi.getter(name="hitTimes")
    def hit_times(self) -> pulumi.Output[builtins.int]:
        """
        Control strategy of hits per second.
        """
        return pulumi.get(self, "hit_times")
    ...
    @property
    @pulumi.getter
    def release(self) -> pulumi.Output[builtins.bool]:
        """
        The enabled status of the access control policy. The policy is enabled by default after it is created.. Valid values:
        """
        return pulumi.get(self, "release")
    ...
    @property
    @pulumi.getter(name="sourceGroupCidrs")
    def source_group_cidrs(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        SOURCE address of the address list.
        """
        return pulumi.get(self, "source_group_cidrs")
