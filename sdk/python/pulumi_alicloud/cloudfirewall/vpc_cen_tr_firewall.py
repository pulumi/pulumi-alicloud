...
class VpcCenTrFirewallArgs:
    def __init__(__self__, *,
                 ...
                 firewall_name: pulumi.Input[builtins.str],
                 firewall_subnet_cidr: pulumi.Input[builtins.str],
                 firewall_vpc_cidr: pulumi.Input[builtins.str],
                 region_no: pulumi.Input[builtins.str],
                 route_mode: pulumi.Input[builtins.str],
                 tr_attachment_master_cidr: pulumi.Input[builtins.str],
                 tr_attachment_slave_cidr: pulumi.Input[builtins.str],
                 transit_router_id: pulumi.Input[builtins.str],
                 firewall_description: Optional[pulumi.Input[builtins.str]] = None,
                 tr_attachment_master_zone: Optional[pulumi.Input[builtins.str]] = None,
                 tr_attachment_slave_zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] firewall_name: The name of Cloud Firewall.
        :param pulumi.Input[builtins.str] firewall_subnet_cidr: Required in automatic mode, the CIDR of subnet used to store the firewall ENI in the firewall VPC.
        :param pulumi.Input[builtins.str] firewall_vpc_cidr: Required in automatic mode,  th CIDR of firewall VPC.
        :param pulumi.Input[builtins.str] region_no: The region ID of the transit router instance.
        :param pulumi.Input[builtins.str] route_mode: The routing pattern. Value: managed: indicates automatic mode
        :param pulumi.Input[builtins.str] tr_attachment_master_cidr: Required in automatic mode, the primary CIDR of network used to connect to the TR in the firewall VPC.
        :param pulumi.Input[builtins.str] tr_attachment_slave_cidr: Required in automatic mode, the the secondary CIDR of the subnet in the firewall VPC used to connect to TR.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the transit router instance.
        :param pulumi.Input[builtins.str] firewall_description: Firewall description.
        :param pulumi.Input[builtins.str] tr_attachment_master_zone: The primary zone of the switch.
        :param pulumi.Input[builtins.str] tr_attachment_slave_zone: Switch standby area.
        """
    ...
    def firewall_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def firewall_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "firewall_name", value)

    @property
    @pulumi.getter(name="firewallSubnetCidr")
    def firewall_subnet_cidr(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def firewall_subnet_cidr(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "firewall_subnet_cidr", value)

    @property
    @pulumi.getter(name="firewallVpcCidr")
    def firewall_vpc_cidr(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def firewall_vpc_cidr(self, value: pulumi.Input[builtins.str]):
    ...
    def route_mode(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @route_mode.setter
    def route_mode(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "route_mode", value)

    @property
    @pulumi.getter(name="trAttachmentMasterCidr")
    def tr_attachment_master_cidr(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def tr_attachment_master_cidr(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "tr_attachment_master_cidr", value)

    @property
    @pulumi.getter(name="trAttachmentSlaveCidr")
    def tr_attachment_slave_cidr(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def tr_attachment_slave_cidr(self, value: pulumi.Input[builtins.str]):
    ...
    def firewall_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def firewall_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "firewall_description", value)

    @property
    @pulumi.getter(name="trAttachmentMasterZone")
    def tr_attachment_master_zone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tr_attachment_master_zone(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tr_attachment_master_zone", value)

    @property
    @pulumi.getter(name="trAttachmentSlaveZone")
    def tr_attachment_slave_zone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Switch standby area.
        """
    ...
    def tr_attachment_slave_zone(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _VpcCenTrFirewallState:
    def __init__(__self__, *,
                 ...
                 firewall_subnet_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 firewall_vpc_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 region_no: Optional[pulumi.Input[builtins.str]] = None,
                 route_mode: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 tr_attachment_master_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 tr_attachment_master_zone: Optional[pulumi.Input[builtins.str]] = None,
                 tr_attachment_slave_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 tr_attachment_slave_zone: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] region_no: The region ID of the transit router instance.
        :param pulumi.Input[builtins.str] route_mode: The routing pattern. Value: managed: indicates automatic mode
        :param pulumi.Input[builtins.str] status: Firewall status. Value:
        :param pulumi.Input[builtins.str] tr_attachment_master_cidr: Required in automatic mode, the primary CIDR of network used to connect to the TR in the firewall VPC.
        :param pulumi.Input[builtins.str] tr_attachment_master_zone: The primary zone of the switch.
        :param pulumi.Input[builtins.str] tr_attachment_slave_cidr: Required in automatic mode, the the secondary CIDR of the subnet in the firewall VPC used to connect to TR.
        :param pulumi.Input[builtins.str] tr_attachment_slave_zone: Switch standby area.
    ...
    @property
    @pulumi.getter(name="firewallSubnetCidr")
    def firewall_subnet_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Required in automatic mode, the CIDR of subnet used to store the firewall ENI in the firewall VPC.
        """
        return pulumi.get(self, "firewall_subnet_cidr")
    ...
    @firewall_subnet_cidr.setter
    def firewall_subnet_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "firewall_subnet_cidr", value)

    @property
    @pulumi.getter(name="firewallVpcCidr")
    def firewall_vpc_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Required in automatic mode,  th CIDR of firewall VPC.
        """
        return pulumi.get(self, "firewall_vpc_cidr")
    ...
    @firewall_vpc_cidr.setter
    def firewall_vpc_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "firewall_vpc_cidr", value)
    ...
    @property
    @pulumi.getter(name="trAttachmentMasterCidr")
    def tr_attachment_master_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Required in automatic mode, the primary CIDR of network used to connect to the TR in the firewall VPC.
        """
        return pulumi.get(self, "tr_attachment_master_cidr")
    ...
    @tr_attachment_master_cidr.setter
    def tr_attachment_master_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tr_attachment_master_cidr", value)
    ...
    @property
    @pulumi.getter(name="trAttachmentSlaveCidr")
    def tr_attachment_slave_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Required in automatic mode, the the secondary CIDR of the subnet in the firewall VPC used to connect to TR.
        """
        return pulumi.get(self, "tr_attachment_slave_cidr")
    ...
    @tr_attachment_slave_cidr.setter
    def tr_attachment_slave_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tr_attachment_slave_cidr", value)
...
class VpcCenTrFirewall(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tr_attachment_slave_cidr: Optional[pulumi.Input[builtins.str]] = None,
            tr_attachment_slave_zone: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VpcCenTrFirewall':
        """
    ...
    @property
    @pulumi.getter(name="firewallDescription")
    def firewall_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Firewall description.
        """
        return pulumi.get(self, "firewall_description")
    ...
    @property
    @pulumi.getter(name="firewallName")
    def firewall_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of Cloud Firewall.
        """
        return pulumi.get(self, "firewall_name")
    ...
    @property
    @pulumi.getter(name="firewallSubnetCidr")
    def firewall_subnet_cidr(self) -> pulumi.Output[builtins.str]:
        """
        Required in automatic mode, the CIDR of subnet used to store the firewall ENI in the firewall VPC.
        """
        return pulumi.get(self, "firewall_subnet_cidr")
    ...
    @property
    @pulumi.getter(name="firewallVpcCidr")
    def firewall_vpc_cidr(self) -> pulumi.Output[builtins.str]:
        """
        Required in automatic mode,  th CIDR of firewall VPC.
        """
        return pulumi.get(self, "firewall_vpc_cidr")
    ...
    @property
    @pulumi.getter(name="regionNo")
    def region_no(self) -> pulumi.Output[builtins.str]:
        """
        The region ID of the transit router instance.
        """
        return pulumi.get(self, "region_no")
    ...
    @property
    @pulumi.getter(name="routeMode")
    def route_mode(self) -> pulumi.Output[builtins.str]:
        """
        The routing pattern. Value: managed: indicates automatic mode
        """
        return pulumi.get(self, "route_mode")
    ...
    @property
    @pulumi.getter(name="trAttachmentMasterCidr")
    def tr_attachment_master_cidr(self) -> pulumi.Output[builtins.str]:
        """
        Required in automatic mode, the primary CIDR of network used to connect to the TR in the firewall VPC.
        """
        return pulumi.get(self, "tr_attachment_master_cidr")
    ...
    @property
    @pulumi.getter(name="trAttachmentMasterZone")
    def tr_attachment_master_zone(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The primary zone of the switch.
        """
        return pulumi.get(self, "tr_attachment_master_zone")
    ...
    @property
    @pulumi.getter(name="trAttachmentSlaveCidr")
    def tr_attachment_slave_cidr(self) -> pulumi.Output[builtins.str]:
        """
        Required in automatic mode, the the secondary CIDR of the subnet in the firewall VPC used to connect to TR.
        """
        return pulumi.get(self, "tr_attachment_slave_cidr")
    ...
    @property
    @pulumi.getter(name="trAttachmentSlaveZone")
    def tr_attachment_slave_zone(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Switch standby area.
        """
        return pulumi.get(self, "tr_attachment_slave_zone")
