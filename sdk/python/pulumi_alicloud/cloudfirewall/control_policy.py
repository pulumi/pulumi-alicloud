...
class ControlPolicyArgs:
    def __init__(__self__, *,
                 ...
                 domain_resolve_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] destination: The destination address in the access control policy.
        :param pulumi.Input[builtins.str] destination_type: The type of the destination address in the access control policy. Valid values: `net`, `group`, `domain`, `location`.
        ...
        :param pulumi.Input[builtins.str] proto: The protocol type supported by the access control policy. Valid values: `ANY`, ` TCP`, `UDP`, `ICMP`.
        :param pulumi.Input[builtins.str] source: The source address in the access control policy.
        :param pulumi.Input[builtins.str] source_type: The type of the source address in the access control policy. Valid values: `net`, `group`, `location`.
        :param pulumi.Input[builtins.str] application_name: The application type supported by the access control policy. Valid values: `ANY`, `HTTP`, `HTTPS`, `MQTT`, `Memcache`, `MongoDB`, `MySQL`, `RDP`, `Redis`, `SMTP`, `SMTPS`, `SSH`, `SSL`, `VNC`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_name_lists: The application types supported by the access control policy.
        ...
        :param pulumi.Input[builtins.str] dest_port: The destination port in the access control policy. **Note:** If `dest_port_type` is set to `port`, you must specify `dest_port`.
        :param pulumi.Input[builtins.str] dest_port_group: The name of the destination port address book in the access control policy. **Note:** If `dest_port_type` is set to `group`, you must specify `dest_port_group`.
        ...
        :param pulumi.Input[builtins.str] domain_resolve_type: The domain name resolution method of the access control policy. Valid values:
               - `FQDN`: Fully qualified domain name (FQDN)-based resolution.
               - `DNS`: DNS-based dynamic resolution.
               - `FQDN_AND_DNS`: FQDN and DNS-based dynamic resolution.
        :param pulumi.Input[builtins.int] end_time: The time when the access control policy stops taking effect. The value is a UNIX timestamp. Unit: seconds. The value must be on the hour or on the half hour, and at least 30 minutes later than the start time.
               > **NOTE:** If `repeat_type` is set to `None`, `Daily`, `Weekly`, or `Monthly`, `start_time` and `end_time` must be set.
        :param pulumi.Input[builtins.str] ip_version: The IP version supported by the access control policy. Default value: `4`. Valid values:
        :param pulumi.Input[builtins.str] lang: The language of the content within the request and response. Valid values: `zh`, `en`.
        :param pulumi.Input[builtins.str] release: The status of the access control policy. Valid values: `true`, `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] repeat_days: The days of a week or of a month on which the access control policy takes effect. Valid values:
        ...
        :param pulumi.Input[builtins.str] repeat_end_time: The point in time when the recurrence ends. Example: `23:30`. The end time must be on the hour or on the half hour, and at least 30 minutes later than the start time.
               > **NOTE:** If `repeat_type` is set to `Daily`, `Weekly`, or `Monthly`, `repeat_start_time` and `repeat_end_time` must be set.
        :param pulumi.Input[builtins.str] repeat_start_time: The point in time when the recurrence starts. Example: `08:00`. The start time must be on the hour or on the half hour, and at least 30 minutes earlier than the end time.
        :param pulumi.Input[builtins.str] repeat_type: The recurrence type for the access control policy to take effect. Default value: `Permanent`. Valid values:
               - `Permanent`: The policy always takes effect.
               - `None`: The policy takes effect for only once.
               - `Daily`: The policy takes effect on a daily basis.
               - `Weekly`: The policy takes effect on a weekly basis.
               - `Monthly`: The policy takes effect on a monthly basis.
        :param pulumi.Input[builtins.str] source_ip: The source IP address of the request.
        :param pulumi.Input[builtins.int] start_time: The time when the access control policy starts to take effect. The value is a UNIX timestamp. Unit: seconds. The value must be on the hour or on the half hour, and at least 30 minutes earlier than the end time.
        """
    ...
    def domain_resolve_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def domain_resolve_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ControlPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] acl_action: The action that Cloud Firewall performs on the traffic. Valid values: `accept`, `drop`, `log`.
        :param pulumi.Input[builtins.str] acl_uuid: (Available since v1.148.0) The unique ID of the access control policy.
        :param pulumi.Input[builtins.str] application_name: The application type supported by the access control policy. Valid values: `ANY`, `HTTP`, `HTTPS`, `MQTT`, `Memcache`, `MongoDB`, `MySQL`, `RDP`, `Redis`, `SMTP`, `SMTPS`, `SSH`, `SSL`, `VNC`.
               > **NOTE:** If `proto` is set to `TCP`, you can set `application_name` to any valid value. If `proto` is set to `UDP`, `ICMP`, or `ANY`, you can only set `application_name` to `ANY`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_name_lists: The application types supported by the access control policy.
               > **NOTE:** If `proto` is set to `TCP`, you can set `application_name_list` to any valid value. If `proto` is set to `UDP`, `ICMP`, or `ANY`, you can only set `application_name_list` to `["ANY"]`. From version 1.232.0, You must specify at least one of the `application_name_list` and `application_name`. If you specify both `application_name_list` and `application_name`, only the `application_name_list` takes effect.
        :param pulumi.Input[builtins.str] create_time: (Available since v1.232.0) The time when the access control policy was created.
        :param pulumi.Input[builtins.str] description: The description of the access control policy.
        :param pulumi.Input[builtins.str] dest_port: The destination port in the access control policy. **Note:** If `dest_port_type` is set to `port`, you must specify `dest_port`.
        :param pulumi.Input[builtins.str] dest_port_group: The name of the destination port address book in the access control policy. **Note:** If `dest_port_type` is set to `group`, you must specify `dest_port_group`.
        :param pulumi.Input[builtins.str] dest_port_type: The type of the destination port in the access control policy. Valid values: `port`, `group`.
...
class ControlPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_ip: Optional[pulumi.Input[builtins.str]] = None,
            source_type: Optional[pulumi.Input[builtins.str]] = None,
            start_time: Optional[pulumi.Input[builtins.int]] = None) -> 'ControlPolicy':
        """
    ...
    @property
    @pulumi.getter(name="applicationNameLists")
    def application_name_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The application types supported by the access control policy.
        > **NOTE:** If `proto` is set to `TCP`, you can set `application_name_list` to any valid value. If `proto` is set to `UDP`, `ICMP`, or `ANY`, you can only set `application_name_list` to `["ANY"]`. From version 1.232.0, You must specify at least one of the `application_name_list` and `application_name`. If you specify both `application_name_list` and `application_name`, only the `application_name_list` takes effect.
        """
    ...
    @property
    @pulumi.getter(name="domainResolveType")
    def domain_resolve_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The domain name resolution method of the access control policy. Valid values:
        - `FQDN`: Fully qualified domain name (FQDN)-based resolution.
        - `DNS`: DNS-based dynamic resolution.
