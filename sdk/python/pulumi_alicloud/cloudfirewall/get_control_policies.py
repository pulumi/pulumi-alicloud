...
def get_control_policies(acl_action: Optional[builtins.str] = None,
    ...
    :param builtins.str ip_version: The IP version of the address in the access control policy.
    :param builtins.str lang: The language of the content within the response. Valid values: `en`, `zh`.
...
def get_control_policies_output(acl_action: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                ip_version: Optional[pulumi.Input[Optional[builtins.str]]] = None,
