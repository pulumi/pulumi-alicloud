...
def get_control_policies_output(acl_action: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                ...
                                ip_version: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
