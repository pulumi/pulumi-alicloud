...
class InstanceMemberArgs:
    def __init__(__self__, *,
                 member_uid: pulumi.Input[builtins.str],
                 member_desc: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a InstanceMember resource.
        :param pulumi.Input[builtins.str] member_uid: The UID of the cloud firewall member account.
        :param pulumi.Input[builtins.str] member_desc: Remarks of cloud firewall member accounts.
        """
    ...
    def member_uid(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @member_uid.setter
    def member_uid(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "member_uid", value)

    @property
    @pulumi.getter(name="memberDesc")
    def member_desc(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @member_desc.setter
    def member_desc(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _InstanceMemberState:
    def __init__(__self__, *,
                 ...
                 member_desc: Optional[pulumi.Input[builtins.str]] = None,
                 member_display_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] create_time: When the cloud firewall member account was added.> use second-level timestamp format.
        :param pulumi.Input[builtins.str] member_desc: Remarks of cloud firewall member accounts.
        :param pulumi.Input[builtins.str] member_display_name: The name of the cloud firewall member account.
        :param pulumi.Input[builtins.str] member_uid: The UID of the cloud firewall member account.
        :param pulumi.Input[builtins.int] modify_time: The last modification time of the cloud firewall member account.> use second-level timestamp format.
        :param pulumi.Input[builtins.str] status: The resource attribute field that represents the resource status.
        """
    ...
    def member_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def member_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class InstanceMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            member_uid: Optional[pulumi.Input[builtins.str]] = None,
            modify_time: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'InstanceMember':
        """
    ...
    @property
    @pulumi.getter(name="memberDesc")
    def member_desc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Remarks of cloud firewall member accounts.
        """
        return pulumi.get(self, "member_desc")
    ...
    @property
    @pulumi.getter(name="memberDisplayName")
    def member_display_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the cloud firewall member account.
        """
        return pulumi.get(self, "member_display_name")
