...
class GetInstanceMembersResult:
    ...
    def current_page(self) -> Optional[builtins.str]:
...
def get_instance_members(current_page: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Instance Member IDs.
...
def get_instance_members_output(current_page: Optional[pulumi.Input[Optional[builtins.str]]] = None,
