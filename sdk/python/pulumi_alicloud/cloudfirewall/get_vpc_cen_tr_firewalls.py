...
class GetVpcCenTrFirewallsResult:
    ...
    def current_page(self) -> Optional[builtins.int]:
    ...
    def firewall_switch_status(self) -> Optional[builtins.str]:
        """
...
def get_vpc_cen_tr_firewalls(cen_id: Optional[builtins.str] = None,
                             current_page: Optional[builtins.int] = None,
                             firewall_id: Optional[builtins.str] = None,
                             firewall_name: Optional[builtins.str] = None,
                             firewall_switch_status: Optional[builtins.str] = None,
    ...
    :param builtins.int current_page: The page number of the pagination query. The default value is 1.
    ...
    :param Sequence[builtins.str] ids: A list of Vpc Cen Tr Firewall IDs.
    ...
    :param builtins.int page_size: The maximum number of pieces of data per page that are displayed during a paged query. The default value is 10.
...
def get_vpc_cen_tr_firewalls_output(cen_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    current_page: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                    firewall_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    firewall_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    firewall_switch_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    ...
                                    region_no: Optional[pulumi.Input[Optional[builtins.str]]] = None,
