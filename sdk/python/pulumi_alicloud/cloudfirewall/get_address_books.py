...
def get_address_books(group_type: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Address Book IDs.
    :param builtins.str name_regex: A regex string to filter results Address Book name.
...
def get_address_books_output(group_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
