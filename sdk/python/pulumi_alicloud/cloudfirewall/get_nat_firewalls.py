...
def get_nat_firewalls(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    default_ake43g = alicloud.vpc.SnatEntry("defaultAKE43g",
        ...
        snat_table_id=default2i_r_zp_c.snat_table_ids.apply(lambda snat_table_ids: snat_table_ids[0]).apply(lambda x: str(x)),
        eip_affinity=1,
...
def get_nat_firewalls_output(ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                             lang: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                             member_uid: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                             ...
                             proxy_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
