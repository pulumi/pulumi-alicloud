...
class GetVpcFirewallCensResult:
    ...
    def network_instance_id(self) -> Optional[builtins.str]:
        """
...
def get_vpc_firewall_cens(cen_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Vpc Firewall Cen IDs.
    :param builtins.str lang: The language type of the requested and received messages. Value:-**zh** (default): Chinese.-**en**: English.
    :param builtins.str member_uid: The UID of the member account (other Alibaba Cloud account) of the current Alibaba cloud account.
...
def get_vpc_firewall_cens_output(cen_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 ...
                                 network_instance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
