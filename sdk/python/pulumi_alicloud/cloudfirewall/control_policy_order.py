...
class ControlPolicyOrderArgs:
    def __init__(__self__, *,
                 acl_uuid: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] acl_uuid: The unique ID of the access control policy.
        :param pulumi.Input[builtins.str] direction: The direction of the traffic to which the access control policy applies. Valid values: `in`, `out`.
        :param pulumi.Input[builtins.int] order: The priority of the access control policy. The priority value starts from 1. A small priority value indicates a high priority. **NOTE:** The value of `-1` indicates the lowest priority.
    ...
    def acl_uuid(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @acl_uuid.setter
    def acl_uuid(self, value: pulumi.Input[builtins.str]):
...
class ControlPolicyOrder(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            acl_uuid: Optional[pulumi.Input[builtins.str]] = None,
            direction: Optional[pulumi.Input[builtins.str]] = None,
            order: Optional[pulumi.Input[builtins.int]] = None) -> 'ControlPolicyOrder':
        """
