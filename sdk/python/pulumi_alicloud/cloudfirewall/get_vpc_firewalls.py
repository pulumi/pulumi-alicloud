...
class GetVpcFirewallsResult:
    ...
    def vpc_firewall_id(self) -> Optional[builtins.str]:
        """
    ...
    def vpc_firewall_name(self) -> Optional[builtins.str]:
        """
...
def get_vpc_firewalls(ids: Optional[Sequence[builtins.str]] = None,
                      ...
                      vpc_firewall_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Vpc Firewall IDs.
    :param builtins.str lang: The language type of the requested and received messages. Value:-**zh** (default): Chinese.-**en**: English.
    :param builtins.str member_uid: The UID of the Alibaba Cloud member account.
...
def get_vpc_firewalls_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             ...
                             vpc_firewall_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             vpc_firewall_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
