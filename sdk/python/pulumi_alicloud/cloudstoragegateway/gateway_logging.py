...
class GatewayLoggingArgs:
    def __init__(__self__, *,
                 ...
                 sls_logstore: pulumi.Input[builtins.str],
                 sls_project: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] sls_logstore: The name of the Log Store.
        :param pulumi.Input[builtins.str] sls_project: The name of the Project.
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid values: `Enabled`, `Disable`.
        """
    ...
    def sls_logstore(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sls_logstore.setter
    def sls_logstore(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sls_logstore", value)

    @property
    @pulumi.getter(name="slsProject")
    def sls_project(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sls_project.setter
    def sls_project(self, value: pulumi.Input[builtins.str]):
...
class _GatewayLoggingState:
    def __init__(__self__, *,
                 ...
                 sls_logstore: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="slsLogstore")
    def sls_logstore(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Log Store.
        """
        return pulumi.get(self, "sls_logstore")
    ...
    @sls_logstore.setter
    def sls_logstore(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sls_logstore", value)
...
class GatewayLogging(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sls_logstore: Optional[pulumi.Input[builtins.str]] = None,
            sls_project: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'GatewayLogging':
        """
    ...
    @property
    @pulumi.getter(name="slsLogstore")
    def sls_logstore(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Log Store.
        """
        return pulumi.get(self, "sls_logstore")
    ...
    @property
    @pulumi.getter(name="slsProject")
    def sls_project(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Project.
        """
        return pulumi.get(self, "sls_project")
