...
class GatewayCacheDiskArgs:
    def __init__(__self__, *,
                 cache_disk_size_in_gb: pulumi.Input[builtins.int],
                 gateway_id: pulumi.Input[builtins.str],
                 cache_disk_category: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] cache_disk_size_in_gb: The capacity of the cache disk.
        :param pulumi.Input[builtins.str] gateway_id: The ID of the gateway.
        :param pulumi.Input[builtins.str] cache_disk_category: The type of the cache disk. Valid values: `cloud_efficiency`, `cloud_ssd`, `cloud_essd`. **NOTE:** From version 1.227.0, `cache_disk_category` can be set to `cloud_essd`.
        :param pulumi.Input[builtins.str] performance_level: The performance level (PL) of the Enterprise SSD (ESSD). Valid values: `PL1`, `PL2`, `PL3`. **NOTE:** If `cache_disk_category` is set to `cloud_essd`, `performance_level` is required.
        """
    ...
    def cache_disk_size_in_gb(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def cache_disk_size_in_gb(self, value: pulumi.Input[builtins.int]):
    ...
    def cache_disk_category(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cache_disk_category(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _GatewayCacheDiskState:
    def __init__(__self__, *,
                 cache_disk_category: Optional[pulumi.Input[builtins.str]] = None,
                 cache_disk_size_in_gb: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] cache_disk_category: The type of the cache disk. Valid values: `cloud_efficiency`, `cloud_ssd`, `cloud_essd`. **NOTE:** From version 1.227.0, `cache_disk_category` can be set to `cloud_essd`.
        :param pulumi.Input[builtins.int] cache_disk_size_in_gb: The capacity of the cache disk.
        :param pulumi.Input[builtins.str] cache_id: The ID of the cache disk.
        :param pulumi.Input[builtins.str] gateway_id: The ID of the gateway.
        :param pulumi.Input[builtins.str] local_file_path: The path of the cache disk.
        :param pulumi.Input[builtins.str] performance_level: The performance level (PL) of the Enterprise SSD (ESSD). Valid values: `PL1`, `PL2`, `PL3`. **NOTE:** If `cache_disk_category` is set to `cloud_essd`, `performance_level` is required.
        :param pulumi.Input[builtins.int] status: The status of the Gateway Cache Disk.
        """
        if cache_disk_category is not None:
            pulumi.set(__self__, "cache_disk_category", cache_disk_category)
    ...
    @property
    @pulumi.getter(name="cacheDiskSizeInGb")
    def cache_disk_size_in_gb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The capacity of the cache disk.
        """
        return pulumi.get(self, "cache_disk_size_in_gb")
    ...
    @cache_disk_size_in_gb.setter
    def cache_disk_size_in_gb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cache_disk_size_in_gb", value)
...
class GatewayCacheDisk(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            local_file_path: Optional[pulumi.Input[builtins.str]] = None,
            performance_level: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.int]] = None) -> 'GatewayCacheDisk':
        """
    ...
    @property
    @pulumi.getter(name="cacheDiskCategory")
    def cache_disk_category(self) -> pulumi.Output[builtins.str]:
        """
        The type of the cache disk. Valid values: `cloud_efficiency`, `cloud_ssd`, `cloud_essd`. **NOTE:** From version 1.227.0, `cache_disk_category` can be set to `cloud_essd`.
        """
        return pulumi.get(self, "cache_disk_category")
    ...
    @property
    @pulumi.getter(name="cacheDiskSizeInGb")
    def cache_disk_size_in_gb(self) -> pulumi.Output[builtins.int]:
        """
        The capacity of the cache disk.
        """
        return pulumi.get(self, "cache_disk_size_in_gb")
    ...
    @property
    @pulumi.getter(name="cacheId")
    def cache_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the cache disk.
        """
        return pulumi.get(self, "cache_id")
