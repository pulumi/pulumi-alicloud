...
def get_gateway_file_shares(gateway_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Gateway File Share IDs.
    :param _builtins.str name_regex: A regex string to filter results by Gateway File Share name.
...
def get_gateway_file_shares_output(gateway_id: Optional[pulumi.Input[_builtins.str]] = None,
