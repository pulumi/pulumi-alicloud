...
def get_gateway_smb_users(gateway_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Gateway SMB User IDs.
    :param builtins.str name_regex: A regex string to filter results by Gateway SMB username.
...
def get_gateway_smb_users_output(gateway_id: Optional[pulumi.Input[builtins.str]] = None,
