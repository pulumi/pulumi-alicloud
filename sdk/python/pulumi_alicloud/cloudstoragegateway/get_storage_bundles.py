...
class GetStorageBundlesResult:
    ...
    def backend_bucket_region_id(self) -> builtins.str:
...
def get_storage_bundles(backend_bucket_region_id: Optional[builtins.str] = None,
...
def get_storage_bundles_output(backend_bucket_region_id: Optional[pulumi.Input[builtins.str]] = None,
