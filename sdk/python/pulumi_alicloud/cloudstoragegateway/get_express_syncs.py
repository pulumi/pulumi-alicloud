...
def get_express_syncs(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Express Sync IDs.
    :param builtins.str name_regex: A regex string to filter results by Express Sync name.
...
def get_express_syncs_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
