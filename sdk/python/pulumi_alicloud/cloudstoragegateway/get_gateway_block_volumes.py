...
def get_gateway_block_volumes(gateway_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Gateway Block Volume IDs.
    :param builtins.str name_regex: A regex string to filter results by Gateway Block Volume name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.int status: The status of volume. Valid values:
    """
    __args__ = dict()
...
def get_gateway_block_volumes_output(gateway_id: Optional[pulumi.Input[builtins.str]] = None,
