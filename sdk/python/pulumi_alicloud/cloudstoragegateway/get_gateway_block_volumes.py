...
def get_gateway_block_volumes(gateway_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Gateway Block Volume IDs.
    :param _builtins.str name_regex: A regex string to filter results by Gateway Block Volume name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.int status: The status of volume. Valid values:
    """
    __args__ = dict()
...
def get_gateway_block_volumes_output(gateway_id: Optional[pulumi.Input[_builtins.str]] = None,
