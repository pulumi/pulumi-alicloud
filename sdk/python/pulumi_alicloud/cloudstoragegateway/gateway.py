...
class GatewayArgs:
    def __init__(__self__, *,
                 ...
                 storage_bundle_id: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 gateway_class: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 reason_type: Optional[pulumi.Input[builtins.str]] = None,
                 release_after_expiration: Optional[pulumi.Input[builtins.bool]] = None,
                 vswitch_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Gateway resource.
        :param pulumi.Input[builtins.str] gateway_name: The name of the gateway. The name must be `1` to `60` characters in length and can contain letters, digits, periods (.), underscores (_), and hyphens (-). It must start with a letter.
        :param pulumi.Input[builtins.str] location: The location of the gateway. Valid values: `Cloud`, `On_Premise`.
        :param pulumi.Input[builtins.str] storage_bundle_id: The ID of the gateway cluster.
        :param pulumi.Input[builtins.str] type: The type of the gateway. Valid values: `File`, `Iscsi`.
        :param pulumi.Input[builtins.str] description: The description of the gateway.
        :param pulumi.Input[builtins.str] gateway_class: The specification of the gateway. Valid values: `Basic`, `Standard`, `Enhanced`, `Advanced`. **NOTE:** If `location` is set to `Cloud`, `gateway_class` is required. Otherwise, `gateway_class` will be ignored. If `payment_type` is set to `Subscription`, `gateway_class` cannot be modified.
        :param pulumi.Input[builtins.str] payment_type: The Payment type of gateway. Valid values: `PayAsYouGo`, `Subscription`. **NOTE:** From version 1.233.0, `payment_type` can be set to `Subscription`.
        :param pulumi.Input[builtins.int] public_network_bandwidth: The public bandwidth of the gateway. Default value: `5`. Valid values: `5` to `200`. **NOTE:** `public_network_bandwidth` is only valid when `location` is `Cloud`. If `payment_type` is set to `Subscription`, `public_network_bandwidth` cannot be modified.
        :param pulumi.Input[builtins.str] reason_detail: The detailed reason why you want to delete the gateway.
        :param pulumi.Input[builtins.str] reason_type: The type of the reason why you want to delete the gateway.
        :param pulumi.Input[builtins.bool] release_after_expiration: Specifies whether to release the gateway after the subscription expires. Valid values:
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the VSwitch. **NOTE:** If `location` is set to `Cloud`, `vswitch_id` is required. Otherwise, `vswitch_id` will be ignored.
        """
    ...
    def storage_bundle_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def storage_bundle_id(self, value: pulumi.Input[builtins.str]):
    ...
    def gateway_class(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def gateway_class(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def reason_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @reason_type.setter
    def reason_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "reason_type", value)

    @property
    @pulumi.getter(name="releaseAfterExpiration")
    def release_after_expiration(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def release_after_expiration(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _GatewayState:
    def __init__(__self__, *,
                 ...
                 storage_bundle_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="storageBundleId")
    def storage_bundle_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the gateway cluster.
        """
        return pulumi.get(self, "storage_bundle_id")
    ...
    @storage_bundle_id.setter
    def storage_bundle_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "storage_bundle_id", value)
...
class Gateway(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:cloudstoragegateway/gateway:Gateway"
    ...
    @property
    @pulumi.getter(name="gatewayClass")
    def gateway_class(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The specification of the gateway. Valid values: `Basic`, `Standard`, `Enhanced`, `Advanced`. **NOTE:** If `location` is set to `Cloud`, `gateway_class` is required. Otherwise, `gateway_class` will be ignored. If `payment_type` is set to `Subscription`, `gateway_class` cannot be modified.
        """
        return pulumi.get(self, "gateway_class")
    ...
    @property
    @pulumi.getter(name="publicNetworkBandwidth")
    def public_network_bandwidth(self) -> pulumi.Output[builtins.int]:
        """
        The public bandwidth of the gateway. Default value: `5`. Valid values: `5` to `200`. **NOTE:** `public_network_bandwidth` is only valid when `location` is `Cloud`. If `payment_type` is set to `Subscription`, `public_network_bandwidth` cannot be modified.
        """
        return pulumi.get(self, "public_network_bandwidth")
    ...
    @property
    @pulumi.getter(name="reasonDetail")
    def reason_detail(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The detailed reason why you want to delete the gateway.
        """
        return pulumi.get(self, "reason_detail")
    ...
    @property
    @pulumi.getter(name="reasonType")
    def reason_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of the reason why you want to delete the gateway.
        """
        return pulumi.get(self, "reason_type")
    ...
    @property
    @pulumi.getter(name="releaseAfterExpiration")
    def release_after_expiration(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to release the gateway after the subscription expires. Valid values:
        """
        return pulumi.get(self, "release_after_expiration")
    ...
    @property
    @pulumi.getter(name="storageBundleId")
    def storage_bundle_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the gateway cluster.
        """
        return pulumi.get(self, "storage_bundle_id")
