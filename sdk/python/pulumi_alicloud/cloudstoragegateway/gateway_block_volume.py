...
class GatewayBlockVolumeArgs:
    def __init__(__self__, *,
                 gateway_block_volume_name: pulumi.Input[builtins.str],
                 ...
                 chap_in_password: Optional[pulumi.Input[builtins.str]] = None,
                 chap_in_user: Optional[pulumi.Input[builtins.str]] = None,
                 chunk_size: Optional[pulumi.Input[builtins.int]] = None,
                 is_source_deletion: Optional[pulumi.Input[builtins.bool]] = None,
                 local_path: Optional[pulumi.Input[builtins.str]] = None,
                 oss_bucket_ssl: Optional[pulumi.Input[builtins.bool]] = None,
                 recovery: Optional[pulumi.Input[builtins.bool]] = None,
                 size: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a GatewayBlockVolume resource.
        :param pulumi.Input[builtins.str] gateway_block_volume_name: The Block volume name. The name must be 1 to 32 characters in length, and can contain lower case letters and digits.
        :param pulumi.Input[builtins.str] gateway_id: The Gateway ID.
        :param pulumi.Input[builtins.str] oss_bucket_name: The name of the OSS Bucket.
        :param pulumi.Input[builtins.str] oss_endpoint: The endpoint of the OSS Bucket.
        :param pulumi.Input[builtins.str] protocol: The Protocol. Valid values: `iSCSI`.
        :param pulumi.Input[builtins.str] cache_mode: The Block volume set mode to cache mode. Valid values: `Cache`, `WriteThrough`.
        :param pulumi.Input[builtins.bool] chap_enabled: Whether to enable iSCSI access of CHAP authentication, which currently supports both CHAP inbound authentication.  Default value: `false`.
        :param pulumi.Input[builtins.str] chap_in_password: The password for inbound authentication when the block volume enables iSCSI access to CHAP authentication. **NOTE:** When the `chap_enabled` is  `true` is,The `chap_in_password` is valid.
        :param pulumi.Input[builtins.str] chap_in_user: The Inbound CHAP user. The `chap_in_user` must be 1 to 32 characters in length, and can contain letters and digits. **NOTE:** When the `chap_enabled` is  `true` is,The `chap_in_password` is valid.
        :param pulumi.Input[builtins.int] chunk_size: The Block volume storage allocation unit.  Valid values: `8192`, `16384`, `32768`, `65536`, `131072`. Default value: `32768`. Unit: `Byte`.
        :param pulumi.Input[builtins.bool] is_source_deletion: Whether to delete the source data. Default value `true`. **NOTE:** When `is_source_deletion` is `true`, the data in the OSS Bucket on the cloud is also deleted when deleting the block gateway volume. Please operate with caution.
        :param pulumi.Input[builtins.str] local_path: The Cache disk to local path. **NOTE:**  When the `cache_mode` is  `Cache` is,The `chap_in_password` is valid.
        :param pulumi.Input[builtins.bool] oss_bucket_ssl: Whether to enable SSL access your OSS Buckets. Default value: `true`.
        :param pulumi.Input[builtins.bool] recovery: The recovery.
        :param pulumi.Input[builtins.int] size: The Volume size. Valid values: `1` to `262144`. Unit: `Byte`.
        """
    ...
    def gateway_block_volume_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def gateway_block_volume_name(self, value: pulumi.Input[builtins.str]):
    ...
    def chap_in_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def chap_in_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "chap_in_password", value)

    @property
    @pulumi.getter(name="chapInUser")
    def chap_in_user(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @chap_in_user.setter
    def chap_in_user(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_source_deletion(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_source_deletion(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def recovery(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        The recovery.
        """
    ...
    @recovery.setter
    def recovery(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _GatewayBlockVolumeState:
    def __init__(__self__, *,
                 ...
                 chap_in_user: Optional[pulumi.Input[builtins.str]] = None,
                 chunk_size: Optional[pulumi.Input[builtins.int]] = None,
                 gateway_block_volume_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] gateway_block_volume_name: The Block volume name. The name must be 1 to 32 characters in length, and can contain lower case letters and digits.
        :param pulumi.Input[builtins.str] gateway_id: The Gateway ID.
        :param pulumi.Input[builtins.str] index_id: The ID of the index.
        :param pulumi.Input[builtins.bool] is_source_deletion: Whether to delete the source data. Default value `true`. **NOTE:** When `is_source_deletion` is `true`, the data in the OSS Bucket on the cloud is also deleted when deleting the block gateway volume. Please operate with caution.
        :param pulumi.Input[builtins.str] local_path: The Cache disk to local path. **NOTE:**  When the `cache_mode` is  `Cache` is,The `chap_in_password` is valid.
        :param pulumi.Input[builtins.str] oss_bucket_name: The name of the OSS Bucket.
        :param pulumi.Input[builtins.bool] oss_bucket_ssl: Whether to enable SSL access your OSS Buckets. Default value: `true`.
        ...
        :param pulumi.Input[builtins.bool] recovery: The recovery.
        :param pulumi.Input[builtins.int] size: The Volume size. Valid values: `1` to `262144`. Unit: `Byte`.
        :param pulumi.Input[builtins.str] status: The status of volume. Valid values:
        """
        if cache_mode is not None:
            pulumi.set(__self__, "cache_mode", cache_mode)
        if chap_enabled is not None:
    ...
    @property
    @pulumi.getter(name="gatewayBlockVolumeName")
    def gateway_block_volume_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Block volume name. The name must be 1 to 32 characters in length, and can contain lower case letters and digits.
        """
        return pulumi.get(self, "gateway_block_volume_name")
    ...
    @gateway_block_volume_name.setter
    def gateway_block_volume_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "gateway_block_volume_name", value)
...
class GatewayBlockVolume(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            recovery: Optional[pulumi.Input[builtins.bool]] = None,
            size: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'GatewayBlockVolume':
        """
    ...
    @property
    @pulumi.getter(name="chapInPassword")
    def chap_in_password(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The password for inbound authentication when the block volume enables iSCSI access to CHAP authentication. **NOTE:** When the `chap_enabled` is  `true` is,The `chap_in_password` is valid.
        """
        return pulumi.get(self, "chap_in_password")
    ...
    @property
    @pulumi.getter(name="chapInUser")
    def chap_in_user(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Inbound CHAP user. The `chap_in_user` must be 1 to 32 characters in length, and can contain letters and digits. **NOTE:** When the `chap_enabled` is  `true` is,The `chap_in_password` is valid.
        """
        return pulumi.get(self, "chap_in_user")
    ...
    @property
    @pulumi.getter(name="chunkSize")
    def chunk_size(self) -> pulumi.Output[builtins.int]:
        """
        The Block volume storage allocation unit.  Valid values: `8192`, `16384`, `32768`, `65536`, `131072`. Default value: `32768`. Unit: `Byte`.
        """
        return pulumi.get(self, "chunk_size")
    ...
    @property
    @pulumi.getter(name="gatewayBlockVolumeName")
    def gateway_block_volume_name(self) -> pulumi.Output[builtins.str]:
        """
        The Block volume name. The name must be 1 to 32 characters in length, and can contain lower case letters and digits.
        """
        return pulumi.get(self, "gateway_block_volume_name")
    ...
    @property
    @pulumi.getter(name="isSourceDeletion")
    def is_source_deletion(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to delete the source data. Default value `true`. **NOTE:** When `is_source_deletion` is `true`, the data in the OSS Bucket on the cloud is also deleted when deleting the block gateway volume. Please operate with caution.
        """
        return pulumi.get(self, "is_source_deletion")
    ...
    @property
    @pulumi.getter
    def recovery(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The recovery.
        """
        return pulumi.get(self, "recovery")
