...
class GetStocksResult:
    ...
    def gateway_class(self) -> Optional[builtins.str]:
...
def get_stocks(gateway_class: Optional[builtins.str] = None,
    ...
    :param builtins.str gateway_class: The gateway class. Valid values: `Basic`, `Standard`,`Enhanced`,`Advanced`.
...
def get_stocks_output(gateway_class: Optional[pulumi.Input[Optional[builtins.str]]] = None,
