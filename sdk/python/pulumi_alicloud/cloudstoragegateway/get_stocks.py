...
class GetStocksResult:
    ...
    def gateway_class(self) -> Optional[_builtins.str]:
...
def get_stocks(gateway_class: Optional[_builtins.str] = None,
    ...
    :param _builtins.str gateway_class: The gateway class. Valid values: `Basic`, `Standard`,`Enhanced`,`Advanced`.
