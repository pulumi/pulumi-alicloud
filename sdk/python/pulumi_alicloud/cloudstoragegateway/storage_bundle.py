...
class StorageBundleArgs:
    def __init__(__self__, *,
                 storage_bundle_name: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a StorageBundle resource.
        :param pulumi.Input[builtins.str] storage_bundle_name: The name of storage bundle.
        :param pulumi.Input[builtins.str] description: The description of storage bundle.
        """
    ...
    def storage_bundle_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def storage_bundle_name(self, value: pulumi.Input[builtins.str]):
...
class _StorageBundleState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 storage_bundle_name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="storageBundleName")
    def storage_bundle_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of storage bundle.
        """
        return pulumi.get(self, "storage_bundle_name")
    ...
    @storage_bundle_name.setter
    def storage_bundle_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "storage_bundle_name", value)
...
class StorageBundle(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            storage_bundle_name: Optional[pulumi.Input[builtins.str]] = None) -> 'StorageBundle':
        """
    ...
    @property
    @pulumi.getter(name="storageBundleName")
    def storage_bundle_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of storage bundle.
        """
        return pulumi.get(self, "storage_bundle_name")
