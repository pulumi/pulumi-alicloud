...
class ExpressSyncArgs:
    def __init__(__self__, *,
                 ...
                 express_sync_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] bucket_region: The region of the OSS Bucket.
        :param pulumi.Input[builtins.str] express_sync_name: The name of the ExpressSync. The length of the name is limited to `1` to `128` characters. It can contain uppercase and lowercase letters, Chinese characters, numbers, English periods (.), underscores (_), or hyphens (-), and must start with  letters.
        :param pulumi.Input[builtins.str] bucket_prefix: The prefix of the OSS Bucket.
        :param pulumi.Input[builtins.str] description: The description of the Express Sync. The length of the name is limited to `1` to `255` characters.
        """
    ...
    def express_sync_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def express_sync_name(self, value: pulumi.Input[builtins.str]):
...
class _ExpressSyncState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 express_sync_name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="expressSyncName")
    def express_sync_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the ExpressSync. The length of the name is limited to `1` to `128` characters. It can contain uppercase and lowercase letters, Chinese characters, numbers, English periods (.), underscores (_), or hyphens (-), and must start with  letters.
        """
        return pulumi.get(self, "express_sync_name")
    ...
    @express_sync_name.setter
    def express_sync_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "express_sync_name", value)
...
class ExpressSync(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            bucket_region: Optional[pulumi.Input[builtins.str]] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            express_sync_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ExpressSync':
        """
    ...
    @property
    @pulumi.getter(name="expressSyncName")
    def express_sync_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the ExpressSync. The length of the name is limited to `1` to `128` characters. It can contain uppercase and lowercase letters, Chinese characters, numbers, English periods (.), underscores (_), or hyphens (-), and must start with  letters.
        """
        return pulumi.get(self, "express_sync_name")
