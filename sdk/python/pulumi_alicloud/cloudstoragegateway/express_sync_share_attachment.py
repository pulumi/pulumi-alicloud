...
class ExpressSyncShareAttachmentArgs:
    def __init__(__self__, *,
                 express_sync_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] express_sync_id: The ID of the ExpressSync.
        :param pulumi.Input[builtins.str] gateway_id: The ID of the Gateway.
        :param pulumi.Input[builtins.str] share_name: The name of the GatewayFileShare. **NOTE:** When GatewayFileShare is associated with a speed sync group, its reverse synchronization function will be turned off by default.
        """
    ...
    def express_sync_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def express_sync_id(self, value: pulumi.Input[builtins.str]):
...
class _ExpressSyncShareAttachmentState:
    def __init__(__self__, *,
                 express_sync_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="expressSyncId")
    def express_sync_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the ExpressSync.
        """
        return pulumi.get(self, "express_sync_id")
    ...
    @express_sync_id.setter
    def express_sync_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "express_sync_id", value)
...
class ExpressSyncShareAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            express_sync_id: Optional[pulumi.Input[builtins.str]] = None,
            gateway_id: Optional[pulumi.Input[builtins.str]] = None,
            share_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ExpressSyncShareAttachment':
        """
    ...
    @property
    @pulumi.getter(name="expressSyncId")
    def express_sync_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the ExpressSync.
        """
        return pulumi.get(self, "express_sync_id")
