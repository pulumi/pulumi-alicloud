...
class GatewayFileShareArgs:
    def __init__(__self__, *,
                 gateway_file_share_name: pulumi.Input[builtins.str],
                 gateway_id: pulumi.Input[builtins.str],
                 local_path: pulumi.Input[builtins.str],
                 oss_bucket_name: pulumi.Input[builtins.str],
                 oss_endpoint: pulumi.Input[builtins.str],
                 protocol: pulumi.Input[builtins.str],
                 access_based_enumeration: Optional[pulumi.Input[builtins.bool]] = None,
                 backend_limit: Optional[pulumi.Input[builtins.int]] = None,
                 browsable: Optional[pulumi.Input[builtins.bool]] = None,
                 bypass_cache_read: Optional[pulumi.Input[builtins.bool]] = None,
                 cache_mode: Optional[pulumi.Input[builtins.str]] = None,
                 direct_io: Optional[pulumi.Input[builtins.bool]] = None,
                 download_limit: Optional[pulumi.Input[builtins.int]] = None,
                 fast_reclaim: Optional[pulumi.Input[builtins.bool]] = None,
                 fe_limit: Optional[pulumi.Input[builtins.int]] = None,
                 ignore_delete: Optional[pulumi.Input[builtins.bool]] = None,
                 in_place: Optional[pulumi.Input[builtins.bool]] = None,
                 lag_period: Optional[pulumi.Input[builtins.int]] = None,
                 nfs_v4_optimization: Optional[pulumi.Input[builtins.bool]] = None,
                 oss_bucket_ssl: Optional[pulumi.Input[builtins.bool]] = None,
                 partial_sync_paths: Optional[pulumi.Input[builtins.str]] = None,
                 path_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 polling_interval: Optional[pulumi.Input[builtins.int]] = None,
                 remote_sync: Optional[pulumi.Input[builtins.bool]] = None,
                 remote_sync_download: Optional[pulumi.Input[builtins.bool]] = None,
                 ro_client_list: Optional[pulumi.Input[builtins.str]] = None,
                 ro_user_list: Optional[pulumi.Input[builtins.str]] = None,
                 rw_client_list: Optional[pulumi.Input[builtins.str]] = None,
                 rw_user_list: Optional[pulumi.Input[builtins.str]] = None,
                 squash: Optional[pulumi.Input[builtins.str]] = None,
                 support_archive: Optional[pulumi.Input[builtins.bool]] = None,
                 transfer_acceleration: Optional[pulumi.Input[builtins.bool]] = None,
                 windows_acl: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a GatewayFileShare resource.
        :param pulumi.Input[builtins.str] gateway_file_share_name: The name of the file share. Length from `1` to `255` characters can contain lowercase letters, digits, (.), (_) Or (-), at the same time, must start with a lowercase letter.
        :param pulumi.Input[builtins.str] gateway_id: The ID of the gateway.
        :param pulumi.Input[builtins.str] local_path: The cache disk inside the device name.
        :param pulumi.Input[builtins.str] oss_bucket_name: The name of the OSS Bucket.
        :param pulumi.Input[builtins.str] oss_endpoint: The gateway file share corresponds to the Object Storage SERVICE (OSS), Bucket Endpoint. **NOTE:** distinguish between intranet and internet Endpoint. We recommend that if the OSS Bucket and the gateway is in the same Region is use the RDS intranet IP Endpoint: `oss-cn-hangzhou-internal.aliyuncs.com`.
        :param pulumi.Input[builtins.str] protocol: Share types. Valid values: `SMB`, `NFS`.
        :param pulumi.Input[builtins.bool] access_based_enumeration: Whether to enable Windows ABE, the prime minister, need windowsAcl parameter is set to true in the entry into force of. Default value: `false`. **NOTE:** The attribute is valid when the attribute `protocol` is `SMB`. Gateway version >= 1.0.45 above support.
        :param pulumi.Input[builtins.int] backend_limit: The Max upload speed of the gateway file share. Unit: `MB/s`, 0 means unlimited. Value range: `0` ~ `1280`. Default value: `0`. **NOTE:** at the same time if you have to limit the maximum write speed, maximum upload speed is no less than the maximum write speed.
        :param pulumi.Input[builtins.bool] browsable: The whether browsable of the gateway file share (that is, in the network neighborhood of whether you can find). The attribute is valid when the attribute `protocol` is `SMB`. Default value: `true`.
        :param pulumi.Input[builtins.bool] bypass_cache_read: Direct reading OSS of the gateway file share.
        :param pulumi.Input[builtins.str] cache_mode: The set up gateway file share cache mode. Valid values: `Cache` or `Sync`. `Cache`: cached mode. `Sync`: replication mode are available. Default value: `Cache`.
        :param pulumi.Input[builtins.bool] direct_io: File sharing Whether to enable DirectIO (direct I/O mode for data transmission). Default value: `false`.
        :param pulumi.Input[builtins.int] download_limit: The maximum download speed of the gateway file share. Unit: `MB/s`. `0` means unlimited. Value range: `0` ~ `1280`. **NOTE:** only in copy mode and enable download file data can be set. only when the shared opens the reverse synchronization or acceded to by the speed synchronization Group when, this parameter will not take effect. Gateway version >= 1.3.0 above support.
        :param pulumi.Input[builtins.bool] fast_reclaim: The whether to enable Upload optimization of the gateway file share, which is suitable for data pure backup migration scenarios. Default value: `false`. **NOTE:** Gateway version >= 1.0.39 above support.
        :param pulumi.Input[builtins.int] fe_limit: The maximum write speed of the gateway file share. Unit: `MB/s`, `0` means unlimited. Value range: `0` ~ `1280`. Default value: `0`.
        :param pulumi.Input[builtins.bool] ignore_delete: The whether to ignore deleted of the gateway file share. After the opening of the Gateway side delete file or delete cloud (OSS) corresponding to the file. Default value: `false`. **NOTE:** `ignore_delete` and `remote_sync` cannot be enabled simultaneously. Gateway version >= 1.0.40 above support.
        :param pulumi.Input[builtins.bool] in_place: The whether debris optimization of the gateway file share. Default value: `false`.
        :param pulumi.Input[builtins.int] lag_period: The synchronization delay, I.e. gateway local cache sync to Alibaba Cloud Object Storage Service (oss) of the delay time. Unit: `Seconds`. Value range: `5` ~ `120`. Default value: `5`. **NOTE:** Gateway version >= 1.0.40 above support.
        :param pulumi.Input[builtins.bool] nfs_v4_optimization: The set up gateway file share NFS protocol, whether to enable NFS v4 optimization improve Mount Upload efficiency. Default value: `false`. **NOTE:** If it is enabled, NFS V3 cannot be mounted. The attribute is valid when the attribute `protocol` is `NFS`. Gateway version >= 1.2.0 above support.
        :param pulumi.Input[builtins.bool] oss_bucket_ssl: Whether they are using SSL connect to OSS Bucket.
        :param pulumi.Input[builtins.str] partial_sync_paths: In part mode, the directory path group JSON format.
        :param pulumi.Input[builtins.str] path_prefix: The subdirectory path under the object storage (OSS) bucket corresponding to the file share. If it is blank, it means the root directory of the bucket.
        :param pulumi.Input[builtins.int] polling_interval: The reverse synchronization time intervals of the gateway file share. Value range: `15` ~ `36000`. **NOTE:** in copy mode + reverse synchronization is enabled Download file data, value range: `3600` ~ `36000`.
        :param pulumi.Input[builtins.bool] remote_sync: Whether to enable reverse synchronization of the gateway file share. Default value: `false`.
        :param pulumi.Input[builtins.bool] remote_sync_download: Copy mode, whether to download the file data. Default value: `false`. **NOTE:** only when the attribute `remote_sync` is `true` or acceded to by the speed synchronization group, this parameter will not take effect.
        :param pulumi.Input[builtins.str] ro_client_list: File sharing NFS read-only client list (IP address or IP address range). Use commas (,) to separate multiple clients.
        :param pulumi.Input[builtins.str] ro_user_list: The read-only client list. When Protocol for Server Message Block (SMB) to go back to.
        :param pulumi.Input[builtins.str] rw_client_list: Read and write the client list. When Protocol NFS is returned when the status is.
        :param pulumi.Input[builtins.str] rw_user_list: Read-write user list. When Protocol for Server Message Block (SMB) to go back to.
        :param pulumi.Input[builtins.str] squash: The NFS protocol user mapping of the gateway file share. Valid values: `none`, `root_squash`, `all_squash`, `all_anonymous`. Default value: `none`. **NOTE:** The attribute is valid when the attribute `protocol` is `NFS`.
        :param pulumi.Input[builtins.bool] support_archive: Whether to support the archive transparent read.
        :param pulumi.Input[builtins.bool] transfer_acceleration: The set up gateway file share whether to enable transmission acceleration needs corresponding OSS Bucket enabled transport acceleration. **NOTE:** Gateway version >= 1.3.0 above support.
        :param pulumi.Input[builtins.bool] windows_acl: Whether to enable by Windows access list (requires AD domain) the permissions control. Default value: `false`. **NOTE:** The attribute is valid when the attribute `protocol` is `SMB`. Gateway version >= 1.0.45 above support.
        """
    ...
    def gateway_file_share_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def gateway_file_share_name(self, value: pulumi.Input[builtins.str]):
    ...
    def oss_bucket_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def oss_bucket_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "oss_bucket_name", value)

    @property
    @pulumi.getter(name="ossEndpoint")
    def oss_endpoint(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @oss_endpoint.setter
    def oss_endpoint(self, value: pulumi.Input[builtins.str]):
    ...
    def access_based_enumeration(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def access_based_enumeration(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "access_based_enumeration", value)

    @property
    @pulumi.getter(name="backendLimit")
    def backend_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def backend_limit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "backend_limit", value)

    @property
    @pulumi.getter
    def browsable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @browsable.setter
    def browsable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "browsable", value)

    @property
    @pulumi.getter(name="bypassCacheRead")
    def bypass_cache_read(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def bypass_cache_read(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "bypass_cache_read", value)

    @property
    @pulumi.getter(name="cacheMode")
    def cache_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cache_mode.setter
    def cache_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cache_mode", value)

    @property
    @pulumi.getter(name="directIo")
    def direct_io(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @direct_io.setter
    def direct_io(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "direct_io", value)

    @property
    @pulumi.getter(name="downloadLimit")
    def download_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def download_limit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "download_limit", value)

    @property
    @pulumi.getter(name="fastReclaim")
    def fast_reclaim(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @fast_reclaim.setter
    def fast_reclaim(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "fast_reclaim", value)

    @property
    @pulumi.getter(name="feLimit")
    def fe_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @fe_limit.setter
    def fe_limit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "fe_limit", value)

    @property
    @pulumi.getter(name="ignoreDelete")
    def ignore_delete(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ignore_delete(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ignore_delete", value)

    @property
    @pulumi.getter(name="inPlace")
    def in_place(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @in_place.setter
    def in_place(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "in_place", value)

    @property
    @pulumi.getter(name="lagPeriod")
    def lag_period(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @lag_period.setter
    def lag_period(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "lag_period", value)

    @property
    @pulumi.getter(name="nfsV4Optimization")
    def nfs_v4_optimization(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def nfs_v4_optimization(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "nfs_v4_optimization", value)

    @property
    @pulumi.getter(name="ossBucketSsl")
    def oss_bucket_ssl(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def oss_bucket_ssl(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "oss_bucket_ssl", value)

    @property
    @pulumi.getter(name="partialSyncPaths")
    def partial_sync_paths(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def partial_sync_paths(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def remote_sync(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @remote_sync.setter
    def remote_sync(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "remote_sync", value)

    @property
    @pulumi.getter(name="remoteSyncDownload")
    def remote_sync_download(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def remote_sync_download(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "remote_sync_download", value)

    @property
    @pulumi.getter(name="roClientList")
    def ro_client_list(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ro_client_list(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ro_client_list", value)

    @property
    @pulumi.getter(name="roUserList")
    def ro_user_list(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ro_user_list.setter
    def ro_user_list(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ro_user_list", value)

    @property
    @pulumi.getter(name="rwClientList")
    def rw_client_list(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rw_client_list(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rw_client_list", value)

    @property
    @pulumi.getter(name="rwUserList")
    def rw_user_list(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @rw_user_list.setter
    def rw_user_list(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rw_user_list", value)

    @property
    @pulumi.getter
    def squash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @squash.setter
    def squash(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "squash", value)

    @property
    @pulumi.getter(name="supportArchive")
    def support_archive(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def support_archive(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "support_archive", value)

    @property
    @pulumi.getter(name="transferAcceleration")
    def transfer_acceleration(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def transfer_acceleration(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "transfer_acceleration", value)

    @property
    @pulumi.getter(name="windowsAcl")
    def windows_acl(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @windows_acl.setter
    def windows_acl(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _GatewayFileShareState:
    def __init__(__self__, *,
                 ...
                 fast_reclaim: Optional[pulumi.Input[builtins.bool]] = None,
                 fe_limit: Optional[pulumi.Input[builtins.int]] = None,
                 gateway_file_share_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 oss_bucket_ssl: Optional[pulumi.Input[builtins.bool]] = None,
                 oss_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 partial_sync_paths: Optional[pulumi.Input[builtins.str]] = None,
                 path_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 polling_interval: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.bool] ignore_delete: The whether to ignore deleted of the gateway file share. After the opening of the Gateway side delete file or delete cloud (OSS) corresponding to the file. Default value: `false`. **NOTE:** `ignore_delete` and `remote_sync` cannot be enabled simultaneously. Gateway version >= 1.0.40 above support.
        :param pulumi.Input[builtins.bool] in_place: The whether debris optimization of the gateway file share. Default value: `false`.
        :param pulumi.Input[builtins.str] index_id: The ID of the file share.
        :param pulumi.Input[builtins.int] lag_period: The synchronization delay, I.e. gateway local cache sync to Alibaba Cloud Object Storage Service (oss) of the delay time. Unit: `Seconds`. Value range: `5` ~ `120`. Default value: `5`. **NOTE:** Gateway version >= 1.0.40 above support.
        :param pulumi.Input[builtins.str] local_path: The cache disk inside the device name.
        :param pulumi.Input[builtins.bool] nfs_v4_optimization: The set up gateway file share NFS protocol, whether to enable NFS v4 optimization improve Mount Upload efficiency. Default value: `false`. **NOTE:** If it is enabled, NFS V3 cannot be mounted. The attribute is valid when the attribute `protocol` is `NFS`. Gateway version >= 1.2.0 above support.
        :param pulumi.Input[builtins.str] oss_bucket_name: The name of the OSS Bucket.
    ...
    @property
    @pulumi.getter(name="gatewayFileShareName")
    def gateway_file_share_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the file share. Length from `1` to `255` characters can contain lowercase letters, digits, (.), (_) Or (-), at the same time, must start with a lowercase letter.
        """
        return pulumi.get(self, "gateway_file_share_name")
    ...
    @gateway_file_share_name.setter
    def gateway_file_share_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "gateway_file_share_name", value)
    ...
    @property
    @pulumi.getter(name="ossEndpoint")
    def oss_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The gateway file share corresponds to the Object Storage SERVICE (OSS), Bucket Endpoint. **NOTE:** distinguish between intranet and internet Endpoint. We recommend that if the OSS Bucket and the gateway is in the same Region is use the RDS intranet IP Endpoint: `oss-cn-hangzhou-internal.aliyuncs.com`.
        """
        return pulumi.get(self, "oss_endpoint")
    ...
    @oss_endpoint.setter
    def oss_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "oss_endpoint", value)
...
class GatewayFileShare(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            support_archive: Optional[pulumi.Input[builtins.bool]] = None,
            transfer_acceleration: Optional[pulumi.Input[builtins.bool]] = None,
            windows_acl: Optional[pulumi.Input[builtins.bool]] = None) -> 'GatewayFileShare':
        """
    ...
    @property
    @pulumi.getter(name="accessBasedEnumeration")
    def access_based_enumeration(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to enable Windows ABE, the prime minister, need windowsAcl parameter is set to true in the entry into force of. Default value: `false`. **NOTE:** The attribute is valid when the attribute `protocol` is `SMB`. Gateway version >= 1.0.45 above support.
        """
        return pulumi.get(self, "access_based_enumeration")
    ...
    @property
    @pulumi.getter(name="backendLimit")
    def backend_limit(self) -> pulumi.Output[builtins.int]:
        """
        The Max upload speed of the gateway file share. Unit: `MB/s`, 0 means unlimited. Value range: `0` ~ `1280`. Default value: `0`. **NOTE:** at the same time if you have to limit the maximum write speed, maximum upload speed is no less than the maximum write speed.
        """
        return pulumi.get(self, "backend_limit")
    ...
    @property
    @pulumi.getter
    def browsable(self) -> pulumi.Output[builtins.bool]:
        """
        The whether browsable of the gateway file share (that is, in the network neighborhood of whether you can find). The attribute is valid when the attribute `protocol` is `SMB`. Default value: `true`.
        """
        return pulumi.get(self, "browsable")
    ...
    @property
    @pulumi.getter(name="bypassCacheRead")
    def bypass_cache_read(self) -> pulumi.Output[builtins.bool]:
        """
        Direct reading OSS of the gateway file share.
        """
        return pulumi.get(self, "bypass_cache_read")
    ...
    @property
    @pulumi.getter(name="cacheMode")
    def cache_mode(self) -> pulumi.Output[builtins.str]:
        """
        The set up gateway file share cache mode. Valid values: `Cache` or `Sync`. `Cache`: cached mode. `Sync`: replication mode are available. Default value: `Cache`.
        """
        return pulumi.get(self, "cache_mode")
    ...
    @property
    @pulumi.getter(name="directIo")
    def direct_io(self) -> pulumi.Output[builtins.bool]:
        """
        File sharing Whether to enable DirectIO (direct I/O mode for data transmission). Default value: `false`.
        """
        return pulumi.get(self, "direct_io")
    ...
    @property
    @pulumi.getter(name="downloadLimit")
    def download_limit(self) -> pulumi.Output[builtins.int]:
        """
        The maximum download speed of the gateway file share. Unit: `MB/s`. `0` means unlimited. Value range: `0` ~ `1280`. **NOTE:** only in copy mode and enable download file data can be set. only when the shared opens the reverse synchronization or acceded to by the speed synchronization Group when, this parameter will not take effect. Gateway version >= 1.3.0 above support.
        """
        return pulumi.get(self, "download_limit")
    ...
    @property
    @pulumi.getter(name="fastReclaim")
    def fast_reclaim(self) -> pulumi.Output[builtins.bool]:
        """
        The whether to enable Upload optimization of the gateway file share, which is suitable for data pure backup migration scenarios. Default value: `false`. **NOTE:** Gateway version >= 1.0.39 above support.
        """
        return pulumi.get(self, "fast_reclaim")
    ...
    @property
    @pulumi.getter(name="feLimit")
    def fe_limit(self) -> pulumi.Output[builtins.int]:
        """
        The maximum write speed of the gateway file share. Unit: `MB/s`, `0` means unlimited. Value range: `0` ~ `1280`. Default value: `0`.
        """
        return pulumi.get(self, "fe_limit")
    ...
    @property
    @pulumi.getter(name="gatewayFileShareName")
    def gateway_file_share_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the file share. Length from `1` to `255` characters can contain lowercase letters, digits, (.), (_) Or (-), at the same time, must start with a lowercase letter.
        """
        return pulumi.get(self, "gateway_file_share_name")
    ...
    @property
    @pulumi.getter(name="ignoreDelete")
    def ignore_delete(self) -> pulumi.Output[builtins.bool]:
        """
        The whether to ignore deleted of the gateway file share. After the opening of the Gateway side delete file or delete cloud (OSS) corresponding to the file. Default value: `false`. **NOTE:** `ignore_delete` and `remote_sync` cannot be enabled simultaneously. Gateway version >= 1.0.40 above support.
        """
        return pulumi.get(self, "ignore_delete")
    ...
    @property
    @pulumi.getter(name="inPlace")
    def in_place(self) -> pulumi.Output[builtins.bool]:
        """
        The whether debris optimization of the gateway file share. Default value: `false`.
        """
        return pulumi.get(self, "in_place")
    ...
    @property
    @pulumi.getter(name="lagPeriod")
    def lag_period(self) -> pulumi.Output[builtins.int]:
        """
        The synchronization delay, I.e. gateway local cache sync to Alibaba Cloud Object Storage Service (oss) of the delay time. Unit: `Seconds`. Value range: `5` ~ `120`. Default value: `5`. **NOTE:** Gateway version >= 1.0.40 above support.
        """
        return pulumi.get(self, "lag_period")
    ...
    @property
    @pulumi.getter(name="nfsV4Optimization")
    def nfs_v4_optimization(self) -> pulumi.Output[builtins.bool]:
        """
        The set up gateway file share NFS protocol, whether to enable NFS v4 optimization improve Mount Upload efficiency. Default value: `false`. **NOTE:** If it is enabled, NFS V3 cannot be mounted. The attribute is valid when the attribute `protocol` is `NFS`. Gateway version >= 1.2.0 above support.
        """
        return pulumi.get(self, "nfs_v4_optimization")
    ...
    @property
    @pulumi.getter(name="ossBucketName")
    def oss_bucket_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the OSS Bucket.
        """
        return pulumi.get(self, "oss_bucket_name")
    ...
    @property
    @pulumi.getter(name="ossBucketSsl")
    def oss_bucket_ssl(self) -> pulumi.Output[builtins.bool]:
        """
        Whether they are using SSL connect to OSS Bucket.
        """
        return pulumi.get(self, "oss_bucket_ssl")
    ...
    @property
    @pulumi.getter(name="ossEndpoint")
    def oss_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The gateway file share corresponds to the Object Storage SERVICE (OSS), Bucket Endpoint. **NOTE:** distinguish between intranet and internet Endpoint. We recommend that if the OSS Bucket and the gateway is in the same Region is use the RDS intranet IP Endpoint: `oss-cn-hangzhou-internal.aliyuncs.com`.
        """
        return pulumi.get(self, "oss_endpoint")
    ...
    @property
    @pulumi.getter(name="partialSyncPaths")
    def partial_sync_paths(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        In part mode, the directory path group JSON format.
        """
        return pulumi.get(self, "partial_sync_paths")
    ...
    @property
    @pulumi.getter(name="pathPrefix")
    def path_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The subdirectory path under the object storage (OSS) bucket corresponding to the file share. If it is blank, it means the root directory of the bucket.
        """
        return pulumi.get(self, "path_prefix")
    ...
    @property
    @pulumi.getter(name="pollingInterval")
    def polling_interval(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The reverse synchronization time intervals of the gateway file share. Value range: `15` ~ `36000`. **NOTE:** in copy mode + reverse synchronization is enabled Download file data, value range: `3600` ~ `36000`.
        """
        return pulumi.get(self, "polling_interval")
    ...
    @property
    @pulumi.getter(name="remoteSync")
    def remote_sync(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to enable reverse synchronization of the gateway file share. Default value: `false`.
        """
        return pulumi.get(self, "remote_sync")
    ...
    @property
    @pulumi.getter(name="remoteSyncDownload")
    def remote_sync_download(self) -> pulumi.Output[builtins.bool]:
        """
        Copy mode, whether to download the file data. Default value: `false`. **NOTE:** only when the attribute `remote_sync` is `true` or acceded to by the speed synchronization group, this parameter will not take effect.
        """
        return pulumi.get(self, "remote_sync_download")
    ...
    @property
    @pulumi.getter(name="roClientList")
    def ro_client_list(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        File sharing NFS read-only client list (IP address or IP address range). Use commas (,) to separate multiple clients.
        """
        return pulumi.get(self, "ro_client_list")
    ...
    @property
    @pulumi.getter(name="roUserList")
    def ro_user_list(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The read-only client list. When Protocol for Server Message Block (SMB) to go back to.
        """
        return pulumi.get(self, "ro_user_list")
    ...
    @property
    @pulumi.getter(name="rwClientList")
    def rw_client_list(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Read and write the client list. When Protocol NFS is returned when the status is.
        """
        return pulumi.get(self, "rw_client_list")
    ...
    @property
    @pulumi.getter(name="rwUserList")
    def rw_user_list(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Read-write user list. When Protocol for Server Message Block (SMB) to go back to.
        """
        return pulumi.get(self, "rw_user_list")
    ...
    @property
    @pulumi.getter
    def squash(self) -> pulumi.Output[builtins.str]:
        """
        The NFS protocol user mapping of the gateway file share. Valid values: `none`, `root_squash`, `all_squash`, `all_anonymous`. Default value: `none`. **NOTE:** The attribute is valid when the attribute `protocol` is `NFS`.
        """
        return pulumi.get(self, "squash")
    ...
    @property
    @pulumi.getter(name="supportArchive")
    def support_archive(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to support the archive transparent read.
        """
        return pulumi.get(self, "support_archive")
    ...
    @property
    @pulumi.getter(name="transferAcceleration")
    def transfer_acceleration(self) -> pulumi.Output[builtins.bool]:
        """
        The set up gateway file share whether to enable transmission acceleration needs corresponding OSS Bucket enabled transport acceleration. **NOTE:** Gateway version >= 1.3.0 above support.
        """
        return pulumi.get(self, "transfer_acceleration")
    ...
    @property
    @pulumi.getter(name="windowsAcl")
    def windows_acl(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to enable by Windows access list (requires AD domain) the permissions control. Default value: `false`. **NOTE:** The attribute is valid when the attribute `protocol` is `SMB`. Gateway version >= 1.0.45 above support.
        """
        return pulumi.get(self, "windows_acl")
