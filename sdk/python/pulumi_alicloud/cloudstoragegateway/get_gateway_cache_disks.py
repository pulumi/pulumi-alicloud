...
def get_gateway_cache_disks(gateway_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Gateway Cache Disk IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.int status: The status of the resource. Valid values: `0`, `1`, `2`. `0`: Normal. `1`: Is about to expire. `2`: Has expired.
    """
    __args__ = dict()
...
def get_gateway_cache_disks_output(gateway_id: Optional[pulumi.Input[builtins.str]] = None,
