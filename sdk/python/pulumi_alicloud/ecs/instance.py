...
class InstanceArgs:
    def __init__(__self__, *,
                 allocate_public_ip: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 include_data_disks: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 internet_max_bandwidth_in: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 is_outdated: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 maintenance_action: Optional[pulumi.Input[builtins.str]] = None,
                 maintenance_notify: Optional[pulumi.Input[builtins.bool]] = None,
                 maintenance_time: Optional[pulumi.Input['InstanceMaintenanceTimeArgs']] = None,
                 network_card_index: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 operator_type: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 password_inherit: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 spot_duration: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 system_disk_encrypted: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] allocate_public_ip: It has been deprecated from version "1.7.0". Setting "internet_max_bandwidth_out" larger than 0 can allocate a public ip address for an instance.
        :param pulumi.Input[builtins.str] auto_release_time: The automatic release time of the `PostPaid` instance.
        ...
        :param pulumi.Input[builtins.int] auto_renew_period: Auto renewal period of an instance, in the unit of month. It is valid when `instance_charge_type` is `PrePaid`. Default to 1. Valid value:
               - [1, 2, 3, 6, 12] when `period_unit` in "Month"
               - [1, 2, 3] when `period_unit` in "Week"
        :param pulumi.Input[builtins.str] availability_zone: The Zone to start the instance in. It is ignored and will be computed when set `vswitch_id`.
        :param pulumi.Input[builtins.str] credit_specification: Performance mode of the t5 burstable instance. Valid values: 'Standard', 'Unlimited'.
        ...
        :param pulumi.Input[builtins.str] hpc_cluster_id: The ID of the Elastic High Performance Computing (E-HPC) cluster to which to assign the instance.
        :param pulumi.Input[builtins.str] http_endpoint: Specifies whether to enable the access channel for instance metadata. Valid values: `enabled`, `disabled`. Default value: `enabled`.
        :param pulumi.Input[builtins.int] http_put_response_hop_limit: **NOTE:**: This parameter is not available for use yet. The HTTP PUT response hop limit for accessing instance metadata. Valid values: 1 to 64. Default value: 1.
        :param pulumi.Input[builtins.str] http_tokens: Specifies whether to forcefully use the security-enhanced mode (IMDSv2) to access instance metadata. Default value: optional. Valid values:
               - optional: does not forcefully use the security-enhanced mode (IMDSv2).
               - required: forcefully uses the security-enhanced mode (IMDSv2). After you set this parameter to required, you cannot access instance metadata in normal mode.
        :param pulumi.Input[builtins.str] image_id: The Image to use for the instance. ECS instance's image can be replaced via changing `image_id`. When it is changed, the instance will reboot to make the change take effect. If you do not use `launch_template_id` or `launch_template_name` to specify a launch template, you must specify `image_id`.
        ...
        :param pulumi.Input[builtins.bool] include_data_disks: Whether to change instance disks charge type when changing instance charge type.
        :param pulumi.Input[builtins.str] instance_charge_type: Valid values are `PrePaid`, `PostPaid`. **NOTE:** From version 1.243.0, the default value `PostPaid` will be removed.
        ...
        :param pulumi.Input[builtins.str] instance_name: The name of the ECS. This instance_name can have a string of 2 to 128 characters, must contain only alphanumeric characters or hyphens, such as "-",".","_", and must not begin with a hyphen, and must not begin with http:// or https://. **NOTE:** From version 1.243.0, the default value `ECS-Instance` will be removed.
        :param pulumi.Input[builtins.str] instance_type: The type of instance to start. When it is changed, the instance will reboot to make the change take effect. If you do not use `launch_template_id` or `launch_template_name` to specify a launch template, you must specify `instance_type`.
        :param pulumi.Input[builtins.str] internet_charge_type: Internet charge type of the instance, Valid values are `PayByBandwidth`, `PayByTraffic`. At present, 'PrePaid' instance cannot change the value to "PayByBandwidth" from "PayByTraffic". **NOTE:** From version 1.243.0, the default value `PayByTraffic` will be removed.
        :param pulumi.Input[builtins.int] internet_max_bandwidth_in: Maximum incoming bandwidth from the public network, measured in Mbps (Mega bit per second). Value range: [1, 200]. If this value is not specified, then automatically sets it to 200 Mbps.
        :param pulumi.Input[builtins.int] internet_max_bandwidth_out: Maximum outgoing bandwidth to the public network, measured in Mbps (Mega bit per second). Value range:  [0, 100]. **NOTE:** From version 1.243.0, the default value `0` will be removed.
        :param pulumi.Input[builtins.int] ipv6_address_count: The number of IPv6 addresses to randomly generate for the primary ENI. Valid values: 1 to 10. **NOTE:** You cannot specify both the `ipv6_addresses` and `ipv6_address_count` parameters.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ipv6_addresses: A list of IPv6 address to be assigned to the primary ENI. Support up to 10. **NOTE:** From version 1.241.0, `ipv6_addresses` can be modified.
        :param pulumi.Input[builtins.bool] is_outdated: Whether to use outdated instance type.
        :param pulumi.Input[builtins.str] key_name: The name of key pair that can login ECS instance successfully without password. If it is specified, the password would be invalid.
        :param pulumi.Input[builtins.str] kms_encrypted_password: An KMS encrypts password used to an instance. If the `password` is filled in, this field will be ignored. When it is changed, the instance will reboot to make the change take effect.
        ...
        :param pulumi.Input[builtins.str] launch_template_id: The ID of the launch template. For more information, see [DescribeLaunchTemplates](https://www.alibabacloud.com/help/en/ecs/developer-reference/api-describelaunchtemplates).To use a launch template to create an instance, you must use the `launch_template_id` or `launch_template_name` parameter to specify the launch template.
        :param pulumi.Input[builtins.str] launch_template_name: The name of the launch template.
        :param pulumi.Input[builtins.str] launch_template_version: The version of the launch template. If you set `launch_template_id` or `launch_template_name` parameter but do not set the version number of the launch template, the default template version is used.
        :param pulumi.Input[builtins.str] maintenance_action: The maintenance action. Valid values: `Stop`, `AutoRecover` and `AutoRedeploy`.
               * `Stop` : stops the instance.
               * `AutoRecover` : automatically recovers the instance.
               * `AutoRedeploy` : fails the instance over, which may cause damage to the data disks attached to the instance.
        :param pulumi.Input[builtins.bool] maintenance_notify: Specifies whether to send an event notification before instance shutdown. Valid values: `true`, `false`. Default value: `false`.
        :param pulumi.Input['InstanceMaintenanceTimeArgs'] maintenance_time: The time of maintenance. See `maintenance_time` below.
        :param pulumi.Input[builtins.int] network_card_index: The index of the network card for Primary ENI.
        :param pulumi.Input[builtins.str] network_interface_traffic_mode: The communication mode of the Primary ENI. Default value: `Standard`. Valid values:
        ...
        :param pulumi.Input[builtins.str] operator_type: The operation type. It is valid when `instance_charge_type` is `PrePaid`. Default value: `upgrade`. Valid values: `upgrade`, `downgrade`. **NOTE:**  When the new instance type specified by the `instance_type` parameter has lower specifications than the current instance type, you must set `operator_type` to `downgrade`.
        :param pulumi.Input[builtins.str] password: Password to an instance is a string of 8 to 30 characters. It must contain uppercase/lowercase letters and numerals, but cannot contain special symbols. When it is changed, the instance will reboot to make the change take effect.
        :param pulumi.Input[builtins.bool] password_inherit: Specifies whether to use the password preset in the image. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.int] period: The duration that you will buy the resource, in month. It is valid and required when `instance_charge_type` is `PrePaid`. Valid values:
        ...
        :param pulumi.Input[builtins.str] resource_group_id: The Id of resource group which the instance belongs.
        :param pulumi.Input[builtins.str] role_name: Instance RAM role name. The name is provided and maintained by RAM. You can use `ram.Role` to create a new one.
        :param pulumi.Input[builtins.int] secondary_private_ip_address_count: The number of private IP addresses to be automatically assigned from within the CIDR block of the vswitch. **NOTE:** To assign secondary private IP addresses, you must specify `secondary_private_ips` or `secondary_private_ip_address_count` but not both.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] secondary_private_ips: A list of Secondary private IP addresses which is selected from within the CIDR block of the vSwitch.
        :param pulumi.Input[builtins.str] security_enhancement_strategy: The security enhancement strategy.
               - Active: Enable security enhancement strategy, it only works on system images.
               - Deactive: Disable security enhancement strategy, it works on all images.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: A list of security group ids to associate with. If you do not use `launch_template_id` or `launch_template_name` to specify a launch template, you must specify `security_groups`.
        :param pulumi.Input[builtins.int] spot_duration: The retention time of the preemptive instance in hours. Valid values: `0`, `1`, `2`, `3`, `4`, `5`, `6`. Retention duration 2~6 is under invitation test, please submit a work order if you need to open. If the value is `0`, the mode is no protection period. Default value is `1`.
        :param pulumi.Input[builtins.float] spot_price_limit: The hourly price threshold of a instance, and it takes effect only when parameter 'spot_strategy' is 'SpotWithPriceLimit'. Three decimals is allowed at most.
        :param pulumi.Input[builtins.str] spot_strategy: The spot strategy of a Pay-As-You-Go instance, and it takes effect only when parameter `instance_charge_type` is 'PostPaid'. Value range:
               - NoSpot: A regular Pay-As-You-Go instance.
               - SpotWithPriceLimit: A price threshold for a spot instance
               - SpotAsPriceGo: A price that is based on the highest Pay-As-You-Go instance
               
               Default to NoSpot. Note: Currently, the spot instance only supports domestic site account.
        :param pulumi.Input[builtins.str] status: The instance status. Valid values: ["Running", "Stopped"]. You can control the instance start and stop through this parameter. Default to `Running`.
        :param pulumi.Input[builtins.str] stopped_mode: The stop mode of the pay-as-you-go instance. Valid values: `StopCharging`,`KeepCharging`, `Not-applicable`. Default value: If the prerequisites required for enabling the economical mode are met, and you have enabled this mode in the ECS console, the default value is `StopCharging`. For more information, see "Enable the economical mode" in [Economical mode](https://www.alibabacloud.com/help/en/elastic-compute-service/latest/economical-mode). Otherwise, the default value is `KeepCharging`. **Note:** `Not-applicable`: Economical mode is not applicable to the instance.`
        ...
        :param pulumi.Input[builtins.bool] system_disk_encrypted: Specifies whether to encrypt the system disk. Valid values: `true`,`false`. Default value: `false`.
    ...
    def allocate_public_ip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allocate_public_ip(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def include_data_disks(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def include_data_disks(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def internet_max_bandwidth_in(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def internet_max_bandwidth_in(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def is_outdated(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_outdated.setter
    def is_outdated(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def maintenance_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def maintenance_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "maintenance_action", value)

    @property
    @pulumi.getter(name="maintenanceNotify")
    def maintenance_notify(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def maintenance_notify(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def network_card_index(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def network_card_index(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def operator_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def operator_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def password_inherit(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def password_inherit(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def queue_pair_number(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def spot_duration(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def spot_duration(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def system_disk_auto_snapshot_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def system_disk_category(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "system_disk_category", value)

    @property
    @pulumi.getter(name="systemDiskDescription")
    def system_disk_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def system_disk_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "system_disk_description", value)

    @property
    @pulumi.getter(name="systemDiskEncryptAlgorithm")
    def system_disk_encrypt_algorithm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def system_disk_encrypt_algorithm(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "system_disk_encrypt_algorithm", value)

    @property
    @pulumi.getter(name="systemDiskEncrypted")
    def system_disk_encrypted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def system_disk_encrypted(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "system_disk_encrypted", value)

    @property
    @pulumi.getter(name="systemDiskKmsKeyId")
    def system_disk_kms_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def system_disk_kms_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "system_disk_kms_key_id", value)

    @property
    @pulumi.getter(name="systemDiskName")
    def system_disk_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def system_disk_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "system_disk_name", value)

    @property
    @pulumi.getter(name="systemDiskPerformanceLevel")
    def system_disk_performance_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def system_disk_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "system_disk_size", value)

    @property
    @pulumi.getter(name="systemDiskStorageClusterId")
    def system_disk_storage_cluster_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def system_disk_storage_cluster_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _InstanceState:
    def __init__(__self__, *,
                 ...
                 dedicated_host_id: Optional[pulumi.Input[builtins.str]] = None,
                 deletion_protection: Optional[pulumi.Input[builtins.bool]] = None,
                 deployment_set_group_no: Optional[pulumi.Input[builtins.str]] = None,
                 deployment_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 dry_run: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_jumbo_frame: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 system_disk_encrypt_algorithm: Optional[pulumi.Input[builtins.str]] = None,
                 system_disk_encrypted: Optional[pulumi.Input[builtins.bool]] = None,
                 system_disk_id: Optional[pulumi.Input[builtins.str]] = None,
                 system_disk_kms_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 system_disk_name: Optional[pulumi.Input[builtins.str]] = None,
                 system_disk_performance_level: Optional[pulumi.Input[builtins.str]] = None,
                 system_disk_size: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] auto_renew_period: Auto renewal period of an instance, in the unit of month. It is valid when `instance_charge_type` is `PrePaid`. Default to 1. Valid value:
               ...
               - [1, 2, 3] when `period_unit` in "Week"
        :param pulumi.Input[builtins.str] availability_zone: The Zone to start the instance in. It is ignored and will be computed when set `vswitch_id`.
        :param pulumi.Input[builtins.int] cpu: The number of vCPUs.
        :param pulumi.Input[builtins.str] create_time: (Available since v1.232.0) The time when the instance was created.
        :param pulumi.Input[builtins.str] credit_specification: Performance mode of the t5 burstable instance. Valid values: 'Standard', 'Unlimited'.
        :param pulumi.Input[Sequence[pulumi.Input['InstanceDataDiskArgs']]] data_disks: The list of data disks created with instance. See `data_disks` below.
        :param pulumi.Input[builtins.str] dedicated_host_id: The ID of the dedicated host on which to create the instance. If you set the DedicatedHostId parameter, the `spot_strategy` and `spot_price_limit` parameters cannot be set. This is because preemptible instances cannot be created on dedicated hosts.
        :param pulumi.Input[builtins.bool] deletion_protection: Whether enable the deletion protection or not. It does not work when the instance is spot. Default value: `false`.
        ...
        :param pulumi.Input[builtins.bool] maintenance_notify: Specifies whether to send an event notification before instance shutdown. Valid values: `true`, `false`. Default value: `false`.
        :param pulumi.Input['InstanceMaintenanceTimeArgs'] maintenance_time: The time of maintenance. See `maintenance_time` below.
        :param pulumi.Input[builtins.int] memory: The memory size of the instance. Unit: MiB.
        :param pulumi.Input[builtins.int] network_card_index: The index of the network card for Primary ENI.
        :param pulumi.Input[builtins.str] network_interface_id: The ID of the Primary ENI.
        :param pulumi.Input[builtins.str] network_interface_traffic_mode: The communication mode of the Primary ENI. Default value: `Standard`. Valid values:
               - `Standard`: Uses the TCP communication mode.
               - `HighPerformance`: Uses the remote direct memory access (RDMA) communication mode with Elastic RDMA Interface (ERI) enabled.
        :param pulumi.Input['InstanceNetworkInterfacesArgs'] network_interfaces: The list of network interfaces created with instance. See `network_interfaces` below.
        :param pulumi.Input[builtins.str] operator_type: The operation type. It is valid when `instance_charge_type` is `PrePaid`. Default value: `upgrade`. Valid values: `upgrade`, `downgrade`. **NOTE:**  When the new instance type specified by the `instance_type` parameter has lower specifications than the current instance type, you must set `operator_type` to `downgrade`.
        :param pulumi.Input[builtins.str] os_name: The name of the operating system of the instance.
        :param pulumi.Input[builtins.str] os_type: The type of the operating system of the instance.
        :param pulumi.Input[builtins.str] password: Password to an instance is a string of 8 to 30 characters. It must contain uppercase/lowercase letters and numerals, but cannot contain special symbols. When it is changed, the instance will reboot to make the change take effect.
        :param pulumi.Input[builtins.bool] password_inherit: Specifies whether to use the password preset in the image. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.int] period: The duration that you will buy the resource, in month. It is valid and required when `instance_charge_type` is `PrePaid`. Valid values:
               - [1-9, 12, 24, 36, 48, 60] when `period_unit` in "Month"
        ...
        :param pulumi.Input[builtins.str] spot_strategy: The spot strategy of a Pay-As-You-Go instance, and it takes effect only when parameter `instance_charge_type` is 'PostPaid'. Value range:
               ...
               Default to NoSpot. Note: Currently, the spot instance only supports domestic site account.
        :param pulumi.Input[builtins.str] start_time: (Available since v1.232.0) The time when the instance was last started.
        :param pulumi.Input[builtins.str] status: The instance status. Valid values: ["Running", "Stopped"]. You can control the instance start and stop through this parameter. Default to `Running`.
        :param pulumi.Input[builtins.str] stopped_mode: The stop mode of the pay-as-you-go instance. Valid values: `StopCharging`,`KeepCharging`, `Not-applicable`. Default value: If the prerequisites required for enabling the economical mode are met, and you have enabled this mode in the ECS console, the default value is `StopCharging`. For more information, see "Enable the economical mode" in [Economical mode](https://www.alibabacloud.com/help/en/elastic-compute-service/latest/economical-mode). Otherwise, the default value is `KeepCharging`. **Note:** `Not-applicable`: Economical mode is not applicable to the instance.`
               * `KeepCharging`: standard mode. Billing of the instance continues after the instance is stopped, and resources are retained for the instance.
               * `StopCharging`: economical mode. Billing of some resources of the instance stops after the instance is stopped. When the instance is stopped, its resources such as vCPUs, memory, and public IP address are released. You may be unable to restart the instance if some types of resources are out of stock in the current region.
        ...
        :param pulumi.Input[builtins.str] system_disk_encrypt_algorithm: The algorithm to be used to encrypt the system disk. Valid values are `aes-256`, `sm4-128`. Default value is `aes-256`.
        :param pulumi.Input[builtins.bool] system_disk_encrypted: Specifies whether to encrypt the system disk. Valid values: `true`,`false`. Default value: `false`.
        :param pulumi.Input[builtins.str] system_disk_id: (Available since v1.210.0) The ID of system disk.
        :param pulumi.Input[builtins.str] system_disk_kms_key_id: The ID of the Key Management Service (KMS) key to be used for the system disk.
        :param pulumi.Input[builtins.str] system_disk_name: The name of the system disk. The name must be 2 to 128 characters in length and can contain letters, digits, periods (.), colons (:), underscores (_), and hyphens (-). It must start with a letter and cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] system_disk_performance_level: The performance level of the ESSD used as the system disk, Valid values: `PL0`, `PL1`, `PL2`, `PL3`, Default to `PL1`;For more information about ESSD, See [Encryption Context](https://www.alibabacloud.com/help/doc-detail/122389.htm).
        :param pulumi.Input[builtins.int] system_disk_size: Size of the system disk, measured in GiB. Value range: [20, 500]. The specified value must be equal to or greater than max{20, Imagesize}. Default value: max{40, ImageSize}.
    ...
    def deployment_set_group_no(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def deployment_set_group_no(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def system_disk_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def system_disk_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            volume_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Instance':
        """
    ...
    @pulumi.getter(name="allocatePublicIp")
    @_utilities.deprecated("""Field 'allocate_public_ip' has been deprecated from provider version 1.6.1. Setting 'internet_max_bandwidth_out' larger than 0 will allocate public ip for instance.""")
    def allocate_public_ip(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        It has been deprecated from version "1.7.0". Setting "internet_max_bandwidth_out" larger than 0 can allocate a public ip address for an instance.
        """
        return pulumi.get(self, "allocate_public_ip")
    ...
    @property
    @pulumi.getter(name="autoReleaseTime")
    def auto_release_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The automatic release time of the `PostPaid` instance.
        The time follows the ISO 8601 standard and is in UTC time. Format: yyyy-MM-ddTHH:mm:ssZ. It must be at least half an hour later than the current time and less than 3 years since the current time.
        Setting it to null can cancel automatic release feature, and the ECS instance will not be released automatically.
    ...
    @property
    @pulumi.getter(name="deploymentSetGroupNo")
    def deployment_set_group_no(self) -> pulumi.Output[builtins.str]:
        """
        The group number of the instance in a deployment set when the deployment set is use.
        """
        return pulumi.get(self, "deployment_set_group_no")
    ...
    @property
    @pulumi.getter(name="deploymentSetId")
    def deployment_set_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the deployment set to which to deploy the instance. **NOTE:** From version 1.176.0, instance's deploymentSetId can be removed when 'deployment_set_id' = "".
        """
        return pulumi.get(self, "deployment_set_id")
    ...
    @property
    @pulumi.getter(name="hpcClusterId")
    def hpc_cluster_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Elastic High Performance Computing (E-HPC) cluster to which to assign the instance.
        """
        return pulumi.get(self, "hpc_cluster_id")
    ...
    @property
    @pulumi.getter(name="includeDataDisks")
    def include_data_disks(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to change instance disks charge type when changing instance charge type.
        """
        return pulumi.get(self, "include_data_disks")
    ...
    @pulumi.getter(name="internetMaxBandwidthIn")
    @_utilities.deprecated("""The attribute is invalid and no any affect for the instance. So it has been deprecated since version v1.121.2.""")
    def internet_max_bandwidth_in(self) -> pulumi.Output[builtins.int]:
        """
        Maximum incoming bandwidth from the public network, measured in Mbps (Mega bit per second). Value range: [1, 200]. If this value is not specified, then automatically sets it to 200 Mbps.
        """
        return pulumi.get(self, "internet_max_bandwidth_in")
    ...
    @property
    @pulumi.getter(name="internetMaxBandwidthOut")
    def internet_max_bandwidth_out(self) -> pulumi.Output[builtins.int]:
        """
        Maximum outgoing bandwidth to the public network, measured in Mbps (Mega bit per second). Value range:  [0, 100]. **NOTE:** From version 1.243.0, the default value `0` will be removed.
        """
        return pulumi.get(self, "internet_max_bandwidth_out")
    ...
    @property
    @pulumi.getter(name="isOutdated")
    def is_outdated(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to use outdated instance type.
        """
        return pulumi.get(self, "is_outdated")
    ...
    @property
    @pulumi.getter(name="launchTemplateId")
    def launch_template_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the launch template. For more information, see [DescribeLaunchTemplates](https://www.alibabacloud.com/help/en/ecs/developer-reference/api-describelaunchtemplates).To use a launch template to create an instance, you must use the `launch_template_id` or `launch_template_name` parameter to specify the launch template.
        """
        return pulumi.get(self, "launch_template_id")
    ...
    @property
    @pulumi.getter(name="launchTemplateName")
    def launch_template_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the launch template.
        """
        return pulumi.get(self, "launch_template_name")
    ...
    @property
    @pulumi.getter(name="launchTemplateVersion")
    def launch_template_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version of the launch template. If you set `launch_template_id` or `launch_template_name` parameter but do not set the version number of the launch template, the default template version is used.
        """
        return pulumi.get(self, "launch_template_version")
    ...
    @property
    @pulumi.getter(name="maintenanceAction")
    def maintenance_action(self) -> pulumi.Output[builtins.str]:
        """
        The maintenance action. Valid values: `Stop`, `AutoRecover` and `AutoRedeploy`.
        * `Stop` : stops the instance.
        * `AutoRecover` : automatically recovers the instance.
    ...
    @property
    @pulumi.getter(name="maintenanceNotify")
    def maintenance_notify(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to send an event notification before instance shutdown. Valid values: `true`, `false`. Default value: `false`.
        """
        return pulumi.get(self, "maintenance_notify")
    ...
    @property
    @pulumi.getter(name="networkCardIndex")
    def network_card_index(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The index of the network card for Primary ENI.
        """
        return pulumi.get(self, "network_card_index")
    ...
    @property
    @pulumi.getter(name="networkInterfaceTrafficMode")
    def network_interface_traffic_mode(self) -> pulumi.Output[builtins.str]:
        """
        The communication mode of the Primary ENI. Default value: `Standard`. Valid values:
        - `Standard`: Uses the TCP communication mode.
        - `HighPerformance`: Uses the remote direct memory access (RDMA) communication mode with Elastic RDMA Interface (ERI) enabled.
    ...
    @property
    @pulumi.getter(name="operatorType")
    def operator_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The operation type. It is valid when `instance_charge_type` is `PrePaid`. Default value: `upgrade`. Valid values: `upgrade`, `downgrade`. **NOTE:**  When the new instance type specified by the `instance_type` parameter has lower specifications than the current instance type, you must set `operator_type` to `downgrade`.
        """
        return pulumi.get(self, "operator_type")
    ...
    @property
    @pulumi.getter(name="passwordInherit")
    def password_inherit(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to use the password preset in the image. Default value: `false`. Valid values:
        """
        return pulumi.get(self, "password_inherit")
    ...
    @property
    @pulumi.getter(name="primaryIpAddress")
    def primary_ip_address(self) -> pulumi.Output[builtins.str]:
        """
        The primary private IP address of the ENI.
        """
        return pulumi.get(self, "primary_ip_address")
    ...
    @property
    @pulumi.getter(name="queuePairNumber")
    def queue_pair_number(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of queues supported by the ERI.
        """
        return pulumi.get(self, "queue_pair_number")
    ...
    @property
    @pulumi.getter(name="renewalStatus")
    def renewal_status(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether to renew an ECS instance automatically or not. It is valid when `instance_charge_type` is `PrePaid`. Default to "Normal". Valid values:
        - `AutoRenewal`: Enable auto renewal.
        - `Normal`: Disable auto renewal.
    ...
    @property
    @pulumi.getter(name="spotDuration")
    def spot_duration(self) -> pulumi.Output[builtins.int]:
        """
        The retention time of the preemptive instance in hours. Valid values: `0`, `1`, `2`, `3`, `4`, `5`, `6`. Retention duration 2~6 is under invitation test, please submit a work order if you need to open. If the value is `0`, the mode is no protection period. Default value is `1`.
        """
        return pulumi.get(self, "spot_duration")
    ...
    @property
    @pulumi.getter(name="systemDiskAutoSnapshotPolicyId")
    def system_disk_auto_snapshot_policy_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the automatic snapshot policy applied to the system disk.
        """
        return pulumi.get(self, "system_disk_auto_snapshot_policy_id")
    ...
    @property
    @pulumi.getter(name="systemDiskDescription")
    def system_disk_description(self) -> pulumi.Output[builtins.str]:
        """
        The description of the system disk. The description must be 2 to 256 characters in length and cannot start with http:// or https://.
        """
        return pulumi.get(self, "system_disk_description")
    ...
    @property
    @pulumi.getter(name="systemDiskEncryptAlgorithm")
    def system_disk_encrypt_algorithm(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The algorithm to be used to encrypt the system disk. Valid values are `aes-256`, `sm4-128`. Default value is `aes-256`.
        """
        return pulumi.get(self, "system_disk_encrypt_algorithm")
    ...
    @property
    @pulumi.getter(name="systemDiskEncrypted")
    def system_disk_encrypted(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to encrypt the system disk. Valid values: `true`,`false`. Default value: `false`.
        """
        return pulumi.get(self, "system_disk_encrypted")
    ...
    @property
    @pulumi.getter(name="systemDiskId")
    def system_disk_id(self) -> pulumi.Output[builtins.str]:
        """
        (Available since v1.210.0) The ID of system disk.
        """
        return pulumi.get(self, "system_disk_id")
    ...
    @property
    @pulumi.getter(name="systemDiskKmsKeyId")
    def system_disk_kms_key_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Key Management Service (KMS) key to be used for the system disk.
        """
        return pulumi.get(self, "system_disk_kms_key_id")
    ...
    @property
    @pulumi.getter(name="systemDiskName")
    def system_disk_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the system disk. The name must be 2 to 128 characters in length and can contain letters, digits, periods (.), colons (:), underscores (_), and hyphens (-). It must start with a letter and cannot start with http:// or https://.
        """
        return pulumi.get(self, "system_disk_name")
    ...
    @property
    @pulumi.getter(name="systemDiskPerformanceLevel")
    def system_disk_performance_level(self) -> pulumi.Output[builtins.str]:
        """
        The performance level of the ESSD used as the system disk, Valid values: `PL0`, `PL1`, `PL2`, `PL3`, Default to `PL1`;For more information about ESSD, See [Encryption Context](https://www.alibabacloud.com/help/doc-detail/122389.htm).
        """
        return pulumi.get(self, "system_disk_performance_level")
    ...
    @property
    @pulumi.getter(name="systemDiskStorageClusterId")
    def system_disk_storage_cluster_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the dedicated block storage cluster. If you want to use disks in a dedicated block storage cluster as system disks when you create instances, you must specify this parameter. For more information about dedicated block storage clusters.
        """
        return pulumi.get(self, "system_disk_storage_cluster_id")
