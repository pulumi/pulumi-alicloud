...
class EipSegmentAddressArgs:
    def __init__(__self__, *,
                 eip_mask: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] eip_mask: The subnet mask of the contiguous EIP group. Valid values:
        :param pulumi.Input[builtins.str] bandwidth: The maximum bandwidth of the contiguous EIP group. Unit: Mbit/s.
        ...
        :param pulumi.Input[builtins.str] internet_charge_type: The metering method of the contiguous EIP group. Valid values:
        ...
        :param pulumi.Input[builtins.str] netmode: The network type. Set the value to `public`, which specifies the public network type.
        :param pulumi.Input[builtins.str] resource_group_id: The resource group ID.
        :param pulumi.Input[builtins.str] zone: The zone of the contiguous EIP group.
        """
    ...
    def eip_mask(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @eip_mask.setter
    def eip_mask(self, value: pulumi.Input[builtins.str]):
...
class _EipSegmentAddressState:
    def __init__(__self__, *,
                 ...
                 eip_mask: Optional[pulumi.Input[builtins.str]] = None,
                 internet_charge_type: Optional[pulumi.Input[builtins.str]] = None,
                 isp: Optional[pulumi.Input[builtins.str]] = None,
                 netmode: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 segment_address_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] bandwidth: The maximum bandwidth of the contiguous EIP group. Unit: Mbit/s.
               ...
               Default value: `5`. Unit: Mbit/s.
        :param pulumi.Input[builtins.str] create_time: The time when the contiguous Elastic IP address group was created. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
        :param pulumi.Input[builtins.str] eip_mask: The subnet mask of the contiguous EIP group. Valid values:
        :param pulumi.Input[builtins.str] internet_charge_type: The metering method of the contiguous EIP group. Valid values:
               - `PayByBandwidth` (default)
               - `PayByTraffic`
        ...
        :param pulumi.Input[builtins.str] netmode: The network type. Set the value to `public`, which specifies the public network type.
        :param pulumi.Input[builtins.str] resource_group_id: The resource group ID.
        :param pulumi.Input[builtins.str] segment_address_name: The name of the contiguous Elastic IP address group.
    ...
    @property
    @pulumi.getter(name="eipMask")
    def eip_mask(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The subnet mask of the contiguous EIP group. Valid values:
        """
        return pulumi.get(self, "eip_mask")
    ...
    @eip_mask.setter
    def eip_mask(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "eip_mask", value)
    ...
    def segment_address_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def segment_address_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EipSegmentAddress(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:ecs/eipSegmentAddress:EipSegmentAddress"
    ...
    def get(resource_name: str,
            ...
            segment_address_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'EipSegmentAddress':
        """
    ...
    @property
    @pulumi.getter
    def bandwidth(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The maximum bandwidth of the contiguous EIP group. Unit: Mbit/s.
        - Valid values when `InstanceChargeType` is set to `PostPaid` and `InternetChargeType` is set to `PayByBandwidth`: `1` to `500`.****
        - Valid values when `InstanceChargeType` is set to `PostPaid` and `InternetChargeType` is set to `PayByTraffic`: `1` to `200`.****
    ...
    @property
    @pulumi.getter(name="eipMask")
    def eip_mask(self) -> pulumi.Output[builtins.str]:
        """
        The subnet mask of the contiguous EIP group. Valid values:
        """
        return pulumi.get(self, "eip_mask")
    ...
    @property
    @pulumi.getter
    def isp(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The line type. Valid values:
        - `BGP` (default): BGP (Multi-ISP) line The BGP (Multi-ISP) line is supported in all regions.
        - `BGP_PRO`: BGP (Multi-ISP) Pro line BGP (Multi-ISP) Pro line is supported only in the China (Hong Kong), Singapore, Japan (Tokyo), Malaysia (Kuala Lumpur), Philippines (Manila), Indonesia (Jakarta), and Thailand (Bangkok) regions.
    ...
    @property
    @pulumi.getter
    def netmode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The network type. Set the value to `public`, which specifies the public network type.
        """
        return pulumi.get(self, "netmode")
    ...
    @property
    @pulumi.getter(name="segmentAddressName")
    def segment_address_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the contiguous Elastic IP address group.
        """
        return pulumi.get(self, "segment_address_name")
