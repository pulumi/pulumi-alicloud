...
class ImageCopyArgs:
    def __init__(__self__, *,
                 source_image_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] source_image_id: The source image ID.
        :param pulumi.Input[builtins.str] source_region_id: The ID of the region to which the source custom image belongs. You can call [DescribeRegions](https://www.alibabacloud.com/help/doc-detail/25609.htm) to view the latest regions of Alibaba Cloud.
        :param pulumi.Input[builtins.str] description: The description of the image. It must be 2 to 256 characters in length and must not start with http:// or https://. Default value: null.
        :param pulumi.Input[builtins.bool] encrypted: Indicates whether to encrypt the image.
        :param pulumi.Input[builtins.bool] force: Indicates whether to force delete the custom image, Default is `false`. 
               - true：Force deletes the custom image, regardless of whether the image is currently being used by other instances.
               - false：Verifies that the image is not currently in use by any other instances before deleting the image.
        :param pulumi.Input[builtins.str] image_name: The image name. It must be 2 to 128 characters in length, and must begin with a letter or Chinese character (beginning with http:// or https:// is not allowed). It can contain digits, colons (:), underscores (_), or hyphens (-). Default value: null.
        :param pulumi.Input[builtins.str] kms_key_id: Key ID used to encrypt the image.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag value of an image. The value of N ranges from 1 to 20.
        """
    ...
    def source_image_id(self) -> pulumi.Input[builtins.str]:
        """
        The source image ID.
        """
    ...
    def source_image_id(self, value: pulumi.Input[builtins.str]):
...
class ImageCopy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_image_id: Optional[pulumi.Input[builtins.str]] = None,
            source_region_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ImageCopy':
        """
