...
class GetInstanceTypesResult:
    ...
    def eni_amount(self) -> Optional[builtins.int]:
        """
    ...
    def gpu_amount(self) -> Optional[builtins.int]:
        return pulumi.get(self, "gpu_amount")

    @property
    @pulumi.getter(name="gpuSpec")
    def gpu_spec(self) -> Optional[builtins.str]:
    ...
    def instance_type_family(self) -> Optional[builtins.str]:
    ...
    def is_outdated(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "is_outdated")

    @property
    @pulumi.getter(name="kubernetesNodeRole")
    def kubernetes_node_role(self) -> Optional[builtins.str]:
        return pulumi.get(self, "kubernetes_node_role")

    @property
    @pulumi.getter(name="memorySize")
    def memory_size(self) -> Optional[builtins.float]:
        """
    ...
    def minimum_eni_ipv6_address_quantity(self) -> Optional[builtins.int]:
        return pulumi.get(self, "minimum_eni_ipv6_address_quantity")

    @property
    @pulumi.getter(name="minimumEniPrivateIpAddressQuantity")
    def minimum_eni_private_ip_address_quantity(self) -> Optional[builtins.int]:
    ...
    def sorted_by(self) -> Optional[builtins.str]:
    ...
    def system_disk_category(self) -> Optional[builtins.str]:
...
def get_instance_types(availability_zone: Optional[builtins.str] = None,
                       cpu_core_count: Optional[builtins.int] = None,
                       eni_amount: Optional[builtins.int] = None,
                       gpu_amount: Optional[builtins.int] = None,
                       gpu_spec: Optional[builtins.str] = None,
                       ...
                       instance_type_family: Optional[builtins.str] = None,
                       is_outdated: Optional[builtins.bool] = None,
                       kubernetes_node_role: Optional[builtins.str] = None,
                       memory_size: Optional[builtins.float] = None,
                       minimum_eni_ipv6_address_quantity: Optional[builtins.int] = None,
                       minimum_eni_private_ip_address_quantity: Optional[builtins.int] = None,
                       network_type: Optional[builtins.str] = None,
                       output_file: Optional[builtins.str] = None,
                       sorted_by: Optional[builtins.str] = None,
                       spot_strategy: Optional[builtins.str] = None,
                       system_disk_category: Optional[builtins.str] = None,
    ...
    :param builtins.str availability_zone: The zone where instance types are supported.
    ...
    :param builtins.int gpu_amount: The GPU amount of an instance type.
    :param builtins.str gpu_spec: The GPU spec of an instance type.
    :param builtins.str image_id: The ID of the image.
    :param builtins.str instance_charge_type: Filter the results by charge type. Valid values: `PrePaid` and `PostPaid`. Default to `PostPaid`.
    :param builtins.str instance_type: Instance specifications. For more information, see instance Specification Family, or you can call the describe instance types interface to get the latest specification table.
    :param builtins.str instance_type_family: Filter the results based on their family name. For example: 'ecs.n4'.
    :param builtins.bool is_outdated: If true, outdated instance types are included in the results. Default to false.
    :param builtins.str kubernetes_node_role: Filter the result which is used to create a kubernetes cluster
    ...
    :param builtins.int minimum_eni_ipv6_address_quantity: The minimum number of IPv6 addresses per ENI. **Note:** If an instance type supports fewer IPv6 addresses per ENI than the specified value, information about the instance type is not queried.
    :param builtins.int minimum_eni_private_ip_address_quantity: The minimum expected IPv4 address upper limit of a single ENI when querying instance specifications. **Note:** If an instance type supports fewer IPv4 addresses per ENI than the specified value, information about the instance type is not queried.
    :param builtins.str network_type: Filter the results by network type. Valid values: `Classic` and `Vpc`.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str sorted_by: Sort mode, valid values: `CPU`, `Memory`, `Price`.
    :param builtins.str spot_strategy: Filter the results by ECS spot type. Valid values: `NoSpot`, `SpotWithPriceLimit` and `SpotAsPriceGo`. Default to `NoSpot`.
    :param builtins.str system_disk_category: Filter the results by system disk category. Valid values: `cloud`, `ephemeral_ssd`, `cloud_essd`, `cloud_efficiency`, `cloud_ssd`, `cloud_essd_entry`, `cloud_auto`. 
...
def get_instance_types_output(availability_zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              cpu_core_count: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                              eni_amount: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                              gpu_amount: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                              gpu_spec: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              image_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              instance_charge_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              instance_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              instance_type_family: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              is_outdated: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                              kubernetes_node_role: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              memory_size: Optional[pulumi.Input[Optional[builtins.float]]] = None,
                              minimum_eni_ipv6_address_quantity: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                              minimum_eni_private_ip_address_quantity: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                              ...
                              sorted_by: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              spot_strategy: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              system_disk_category: Optional[pulumi.Input[Optional[builtins.str]]] = None,
