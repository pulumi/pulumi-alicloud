...
class ActivationArgs:
    def __init__(__self__, *,
                 ...
                 time_to_live_in_hours: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Activation resource.
        :param pulumi.Input[builtins.str] description: The description of the activation code. The description can be 1 to 100 characters in length and cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.int] instance_count: The maximum number of times that the activation code can be used to register managed instances. Valid values: `1` to `1000`. Default value: `10`.
        :param pulumi.Input[builtins.str] instance_name: The default instance name prefix. The instance name prefix must be 1 to 50 characters in length. It must start with a letter and cannot start with `http://` or `https://`. The instance name prefix can contain only letters, digits, periods (.), underscores (_), hyphens (-), and colons (:).
        ...
        :param pulumi.Input[builtins.str] ip_address_range: The IP addresses of hosts that are allowed to use the activation code. The value can be IPv4 addresses, IPv6 addresses, or CIDR blocks.
        :param pulumi.Input[builtins.int] time_to_live_in_hours: The validity period of the activation code. The activation code cannot be used to register new instances after the validity period expires. Unit: hours. Valid values: `1` to `24`. Default value: `4`.
        """
    ...
    def time_to_live_in_hours(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def time_to_live_in_hours(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Activation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_name: Optional[pulumi.Input[builtins.str]] = None,
            ip_address_range: Optional[pulumi.Input[builtins.str]] = None,
            time_to_live_in_hours: Optional[pulumi.Input[builtins.int]] = None) -> 'Activation':
        """
    ...
    @property
    @pulumi.getter(name="ipAddressRange")
    def ip_address_range(self) -> pulumi.Output[builtins.str]:
        """
        The IP addresses of hosts that are allowed to use the activation code. The value can be IPv4 addresses, IPv6 addresses, or CIDR blocks.
        """
        return pulumi.get(self, "ip_address_range")
    ...
    @property
    @pulumi.getter(name="timeToLiveInHours")
    def time_to_live_in_hours(self) -> pulumi.Output[builtins.int]:
        """
        The validity period of the activation code. The activation code cannot be used to register new instances after the validity period expires. Unit: hours. Valid values: `1` to `24`. Default value: `4`.
        """
        return pulumi.get(self, "time_to_live_in_hours")
