...
class EcsNetworkInterfacePermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: Alibaba Cloud Partner (Certified ISV) account ID or individual user ID.
        :param pulumi.Input[builtins.str] network_interface_id: The ID of the network interface.
        :param pulumi.Input[builtins.str] permission: The permissions of the Network Interface. Valid values: `InstanceAttach`. `InstanceAttach`: Allows authorized users to mount your ENI to the other ECS instance. The ECS instance must be in the same zone as the ENI.
        :param pulumi.Input[builtins.bool] force: Whether to force deletion of Network Interface Permission. Default value: `true`.
        """
...
class _EcsNetworkInterfacePermissionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] network_interface_id: The ID of the network interface.
        :param pulumi.Input[builtins.str] permission: The permissions of the Network Interface. Valid values: `InstanceAttach`. `InstanceAttach`: Allows authorized users to mount your ENI to the other ECS instance. The ECS instance must be in the same zone as the ENI.
        :param pulumi.Input[builtins.str] status: The Status of the Network Interface Permissions. Valid values: `Pending`, `Granted`, `Revoking`, `Revoked`.
        """
...
class EcsNetworkInterfacePermission(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_interface_id: Optional[pulumi.Input[builtins.str]] = None,
            permission: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'EcsNetworkInterfacePermission':
        """
