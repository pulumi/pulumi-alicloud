...
class GetInstancesResult:
    ...
    def ram_role_name(self) -> Optional[builtins.str]:
        """
        The Ram role name.
        """
...
def get_instances(availability_zone: Optional[builtins.str] = None,
                  ...
                  ram_role_name: Optional[builtins.str] = None,
    ...
    :param builtins.bool enable_details: Default to `true`. If false, the attributes `ram_role_name` and `disk_device_mappings` will not be fetched and output.
    :param Sequence[builtins.str] ids: A list of ECS instance IDs.
    :param builtins.str image_id: The image ID of some ECS instance used.
    :param builtins.str instance_name: The name of the instance. Fuzzy search with the asterisk (*) wildcard characters is supported.
...
def get_instances_output(availability_zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         ...
                         instance_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         ...
                         ram_role_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
