...
class EcsDiskAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] bootable: Whether to mount as a system disk. Default to: `false`.
        :param pulumi.Input[builtins.bool] delete_with_instance: Indicates whether the disk is released together with the instance. Default to: `false`.
        :param pulumi.Input[builtins.str] key_pair_name: The name of key pair
        :param pulumi.Input[builtins.str] password: When mounting the system disk, setting the user name and password of the instance is only effective for the administrator and root user names, and other user names are not effective.
        """
...
class _EcsDiskAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] bootable: Whether to mount as a system disk. Default to: `false`.
        :param pulumi.Input[builtins.bool] delete_with_instance: Indicates whether the disk is released together with the instance. Default to: `false`.
        :param pulumi.Input[builtins.str] device: The name of the cloud disk device.
        :param pulumi.Input[builtins.str] disk_id: ID of the Disk to be attached.
        :param pulumi.Input[builtins.str] instance_id: ID of the Instance to attach to.
        :param pulumi.Input[builtins.str] key_pair_name: The name of key pair
        :param pulumi.Input[builtins.str] password: When mounting the system disk, setting the user name and password of the instance is only effective for the administrator and root user names, and other user names are not effective.
...
class EcsDiskAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            key_pair_name: Optional[pulumi.Input[builtins.str]] = None,
            password: Optional[pulumi.Input[builtins.str]] = None) -> 'EcsDiskAttachment':
        """
