...
class HpcClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: The description of ECS Hpc Cluster.
        :param pulumi.Input[str] name: The name of ECS Hpc Cluster.
        """
        HpcClusterArgs._configure(
...
class HpcCluster(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            HpcClusterArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            description: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None) -> 'HpcCluster':
        """
