...
def get_auto_snapshot_policies(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Auto Snapshot Policy IDs.
    :param _builtins.str name_regex: A regex string to filter results by Auto Snapshot Policy name.
...
def get_auto_snapshot_policies_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
