...
def get_auto_snapshot_policies(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Auto Snapshot Policy IDs.
    :param builtins.str name_regex: A regex string to filter results by Auto Snapshot Policy name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of Auto Snapshot Policy. Valid Values: `Expire`, `Normal`.
...
def get_auto_snapshot_policies_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
