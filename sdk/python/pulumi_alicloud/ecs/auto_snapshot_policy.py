...
class AutoSnapshotPolicyArgs:
    def __init__(__self__, *,
                 repeat_weekdays: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 ...
                 copied_snapshots_retention_days: Optional[pulumi.Input[builtins.int]] = None,
                 copy_encryption_configuration: Optional[pulumi.Input['AutoSnapshotPolicyCopyEncryptionConfigurationArgs']] = None,
                 enable_cross_region_copy: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 target_copy_regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a AutoSnapshotPolicy resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] repeat_weekdays: The days of the week on which to create automatic snapshots. Valid values: `1` to `7`, which correspond to the days of the week. For example, `1` indicates Monday. One or more days can be specified.
        :param pulumi.Input[builtins.int] retention_days: The retention period of the automatic snapshots. Unit: days. Valid values:
               - `-1`: Automatic snapshots are retained until they are deleted.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] time_points: The points in time of the day at which to create automatic snapshots.
        ...
        :param pulumi.Input[builtins.str] auto_snapshot_policy_name: The name of the automatic snapshot policy. The name must be 2 to 128 characters in length. The name must start with a letter and cannot start with http:// or https://. The name can contain letters, digits, colons (:), underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.int] copied_snapshots_retention_days: The retention period of the snapshot copy in the destination region. Unit: days. Valid values:
        ...
        :param pulumi.Input[builtins.bool] enable_cross_region_copy: Specifies whether to enable cross-region replication for snapshots. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] name: . Field `name` has been deprecated from provider version 1.236.0. New field `auto_snapshot_policy_name` instead.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group. If this parameter is specified to query resources, up to 1,000 resources that belong to the specified resource group can be displayed in the response.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_copy_regions: The destination region to which to copy the snapshot. You can specify only a single destination region.
        """
    ...
    def repeat_weekdays(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def repeat_weekdays(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def copied_snapshots_retention_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def copied_snapshots_retention_days(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def enable_cross_region_copy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_cross_region_copy(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def target_copy_regions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def target_copy_regions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _AutoSnapshotPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] copied_snapshots_retention_days: The retention period of the snapshot copy in the destination region. Unit: days. Valid values:
               - `-1`: The snapshot copy is retained until it is deleted.
        :param pulumi.Input['AutoSnapshotPolicyCopyEncryptionConfigurationArgs'] copy_encryption_configuration: The encryption parameters for cross-region snapshot replication. See `copy_encryption_configuration` below.
        :param pulumi.Input[builtins.str] create_time: (Available since v1.236.0) The time when the automatic snapshot policy was created. The time follows the ISO 8601 standard in the yyyy-MM-ddThh:mm:ssZ format. The time is displayed in UTC.
        :param pulumi.Input[builtins.bool] enable_cross_region_copy: Specifies whether to enable cross-region replication for snapshots. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] name: . Field `name` has been deprecated from provider version 1.236.0. New field `auto_snapshot_policy_name` instead.
        :param pulumi.Input[builtins.str] region_id: (Available since v1.236.0) The region ID of the automatic snapshot policy.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] repeat_weekdays: The days of the week on which to create automatic snapshots. Valid values: `1` to `7`, which correspond to the days of the week. For example, `1` indicates Monday. One or more days can be specified.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group. If this parameter is specified to query resources, up to 1,000 resources that belong to the specified resource group can be displayed in the response.
        :param pulumi.Input[builtins.int] retention_days: The retention period of the automatic snapshots. Unit: days. Valid values:
               - `-1`: Automatic snapshots are retained until they are deleted.
        :param pulumi.Input[builtins.str] status: The status of the automatic snapshot policy.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_copy_regions: The destination region to which to copy the snapshot. You can specify only a single destination region.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] time_points: The points in time of the day at which to create automatic snapshots.
...
class AutoSnapshotPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            target_copy_regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            time_points: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'AutoSnapshotPolicy':
        """
    ...
    @property
    @pulumi.getter(name="copiedSnapshotsRetentionDays")
    def copied_snapshots_retention_days(self) -> pulumi.Output[builtins.int]:
        """
        The retention period of the snapshot copy in the destination region. Unit: days. Valid values:
        - `-1`: The snapshot copy is retained until it is deleted.
        """
    ...
    @property
    @pulumi.getter(name="enableCrossRegionCopy")
    def enable_cross_region_copy(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable cross-region replication for snapshots. Valid values: `true`, `false`.
        """
        return pulumi.get(self, "enable_cross_region_copy")
    ...
    @property
    @pulumi.getter(name="targetCopyRegions")
    def target_copy_regions(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The destination region to which to copy the snapshot. You can specify only a single destination region.
        """
        return pulumi.get(self, "target_copy_regions")
