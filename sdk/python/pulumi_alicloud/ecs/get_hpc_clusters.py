...
def get_hpc_clusters(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Hpc Cluster IDs.
    :param builtins.str name_regex: A regex string to filter results by Hpc Cluster name.
...
def get_hpc_clusters_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
