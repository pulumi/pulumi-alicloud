...
class EcsInstanceSetArgs:
    def __init__(__self__, *,
                 ...
                 boot_check_os_with_assistant: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] image_id: The Image to use for the instance.
        :param pulumi.Input[builtins.str] instance_type: The type of instance to start.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: A list of security group ids to associate with.
        :param pulumi.Input[builtins.int] amount: The number of instances that you want to create. Valid values: `1` to `100`.
        :param pulumi.Input[builtins.str] auto_release_time: The automatic release time of the `PostPaid` instance.
        :param pulumi.Input[builtins.bool] auto_renew: Whether to enable auto-renewal for the instance. This parameter is valid only when the `instance_charge_type` is set to `PrePaid`.
        :param pulumi.Input[builtins.int] auto_renew_period: Auto renewal period of an instance, in the unit of month. It is valid when `instance_charge_type` is `PrePaid`.
               - When `period_unit` is `Month`, Valid values: `1`, `2`, `3`, `6`, `12`.
               - When `period_unit` is `Week`, Valid values: `1`, `2`, `3`.
        :param pulumi.Input[builtins.bool] boot_check_os_with_assistant: Indicate how to check instance ready to use.
        ...
        :param pulumi.Input[builtins.str] dedicated_host_id: The ID of the dedicated host on which to create the instance. If the `dedicated_host_id` is specified, the `spot_strategy` and `spot_price_limit`  are ignored. This is because preemptible instances cannot be created on dedicated hosts.
        :param pulumi.Input[builtins.bool] deletion_protection: Whether to enable release protection for the instance.
        :param pulumi.Input[builtins.str] deployment_set_id: The ID of the deployment set to which to deploy the instance.
        :param pulumi.Input[builtins.str] description: The description of the instance, This description can have a string of 2 to 256 characters, It cannot begin with `http://` or `https://`.
        ...
        :param pulumi.Input[builtins.str] host_name: The hostname of instance.
        ...
        :param pulumi.Input[builtins.str] instance_charge_type: The billing method of the instance. Valid values: `PrePaid`, `PostPaid`.
        :param pulumi.Input[builtins.str] instance_name: The name of the ECS. This instance_name can have a string of 2 to 128 characters, must contain only alphanumeric characters or hyphens, such as "-",".","_", and must not begin with a hyphen, and must not begin with `http://` or `https://`.
        :param pulumi.Input[builtins.str] internet_charge_type: The Internet charge type of the instance. Valid values are `PayByBandwidth`, `PayByTraffic`.
        :param pulumi.Input[builtins.int] internet_max_bandwidth_out: The Maximum outgoing bandwidth to the public network, measured in Mbps (Mega bit per second). Valid values: `1` to `100`.
        :param pulumi.Input[builtins.str] key_pair_name: The name of key pair that can login ECS instance successfully without password.
        :param pulumi.Input[builtins.str] launch_template_id: The ID of the launch template.
        :param pulumi.Input[builtins.str] launch_template_name: The name of the launch template. To use a launch template to create an instance, you must use the `launch_template_id` or `launch_template_name` parameter to specify the launch template.
        :param pulumi.Input[builtins.str] launch_template_version: The version of the launch template.
        ...
        :param pulumi.Input[builtins.str] password: The password to an instance is a string of 8 to 30 characters. It must contain uppercase/lowercase letters and numerals, but cannot contain special symbols.
        :param pulumi.Input[builtins.bool] password_inherit: Whether to use the password preset in the image.
        :param pulumi.Input[builtins.int] period: The duration that you will buy the resource, in month. It is valid when `instance_charge_type` is `PrePaid`.
               - When `period_unit` is `Month`, Valid values: `1`, `2`, `3`, `4`, `5`, `6`, `7`, `8`, `9`, `12`, `24`, `36`, `48`, `60`.
               - When `period_unit` is `Week`, Valid values: `1`, `2`, `3`.
        :param pulumi.Input[builtins.str] period_unit: The duration unit that you will buy the resource. It is valid when `instance_charge_type` is 'PrePaid'. Valid value: `Week`, `Month`.
        :param pulumi.Input[builtins.str] ram_role_name: The Instance RAM role name.
        ...
        :param pulumi.Input[builtins.str] spot_strategy: The spot strategy of a Pay-As-You-Go instance, and it takes effect only when parameter `instance_charge_type` is 'PostPaid'.
        ...
        :param pulumi.Input[builtins.str] system_disk_category: The category of the system disk. Valid values are `cloud_efficiency`, `cloud_ssd`, `cloud_essd`, `cloud`.
        ...
        :param pulumi.Input[builtins.str] system_disk_name: The name of the system disk.
        :param pulumi.Input[builtins.str] system_disk_performance_level: The performance level of the ESSD used as the system disk. Valid values: `PL0`, `PL1`, `PL2`, `PL3`.
        :param pulumi.Input[builtins.int] system_disk_size: The size of the system disk, measured in GiB. Value range:  values: `20` to `500`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.bool] unique_suffix: Whether to automatically append incremental suffixes to the hostname specified by the HostName parameter and to the instance name specified by the InstanceName parameter when you batch create instances. The incremental suffixes can range from `001` to `999`.
        :param pulumi.Input[builtins.str] vswitch_id: The virtual switch ID to launch in VPC.
        :param pulumi.Input[builtins.str] zone_id: The ID of the zone in which to create the instance.
        """
    ...
    def boot_check_os_with_assistant(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def boot_check_os_with_assistant(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _EcsInstanceSetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] image_id: The Image to use for the instance.
        :param pulumi.Input[builtins.str] instance_charge_type: The billing method of the instance. Valid values: `PrePaid`, `PostPaid`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_ids: A list of ECS Instance ID.
        :param pulumi.Input[builtins.str] instance_name: The name of the ECS. This instance_name can have a string of 2 to 128 characters, must contain only alphanumeric characters or hyphens, such as "-",".","_", and must not begin with a hyphen, and must not begin with `http://` or `https://`.
        :param pulumi.Input[builtins.str] instance_type: The type of instance to start.
        :param pulumi.Input[builtins.str] internet_charge_type: The Internet charge type of the instance. Valid values are `PayByBandwidth`, `PayByTraffic`.
        :param pulumi.Input[builtins.int] internet_max_bandwidth_out: The Maximum outgoing bandwidth to the public network, measured in Mbps (Mega bit per second). Valid values: `1` to `100`.
...
class EcsInstanceSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            unique_suffix: Optional[pulumi.Input[builtins.bool]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EcsInstanceSet':
        """
    ...
    @property
    @pulumi.getter(name="bootCheckOsWithAssistant")
    def boot_check_os_with_assistant(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicate how to check instance ready to use.
        """
        return pulumi.get(self, "boot_check_os_with_assistant")
