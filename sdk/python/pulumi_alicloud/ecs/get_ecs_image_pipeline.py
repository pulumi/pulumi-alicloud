...
def get_ecs_image_pipeline(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Image Pipeline ids.
    :param builtins.str name: The name of the image template.
    :param builtins.str name_regex: A regex string to filter results by Image Pipeline name.
...
def get_ecs_image_pipeline_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
