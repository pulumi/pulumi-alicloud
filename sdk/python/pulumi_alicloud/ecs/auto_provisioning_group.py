...
class AutoProvisioningGroupArgs:
    def __init__(__self__, *,
                 ...
                 total_target_capacity: pulumi.Input[builtins.str],
                 auto_provisioning_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 auto_provisioning_group_type: Optional[pulumi.Input[builtins.str]] = None,
                 default_target_capacity_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 max_spot_price: Optional[pulumi.Input[builtins.float]] = None,
                 pay_as_you_go_allocation_strategy: Optional[pulumi.Input[builtins.str]] = None,
                 pay_as_you_go_target_capacity: Optional[pulumi.Input[builtins.str]] = None,
                 spot_allocation_strategy: Optional[pulumi.Input[builtins.str]] = None,
                 spot_instance_interruption_behavior: Optional[pulumi.Input[builtins.str]] = None,
                 spot_instance_pools_to_use_count: Optional[pulumi.Input[builtins.int]] = None,
                 spot_target_capacity: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] launch_template_id: The ID of the instance launch template associated with the auto provisioning group.
        :param pulumi.Input[builtins.str] total_target_capacity: The total target capacity of the auto provisioning group. The target capacity consists of the following three parts:PayAsYouGoTargetCapacity,SpotTargetCapacity and the supplemental capacity besides PayAsYouGoTargetCapacity and SpotTargetCapacity.
        :param pulumi.Input[builtins.str] auto_provisioning_group_name: The name of the auto provisioning group to be created. It must be 2 to 128 characters in length. It must start with a letter but cannot start with http:// or https://. It can contain letters, digits, colons (:), underscores (_), and hyphens (-)
        :param pulumi.Input[builtins.str] auto_provisioning_group_type: The type of the auto provisioning group. Valid values:`request` and `maintain`,Default value: `maintain`.
        :param pulumi.Input[builtins.str] default_target_capacity_type: The type of supplemental instances. When the total value of `PayAsYouGoTargetCapacity` and `SpotTargetCapacity` is smaller than the value of TotalTargetCapacity, the auto provisioning group will create instances of the specified type to meet the capacity requirements. Valid values:`PayAsYouGo`: Pay-as-you-go instances; `Spot`: Preemptible instances, Default value: `Spot`.
        :param pulumi.Input[builtins.str] description: The description of the auto provisioning group.
        :param pulumi.Input[builtins.str] excess_capacity_termination_policy: The shutdown policy for excess preemptible instances followed when the capacity of the auto provisioning group exceeds the target capacity. Valid values: `no-termination` and `termination`,Default value: `no-termination`.
        :param pulumi.Input[builtins.str] launch_template_version: The version of the instance launch template associated with the auto provisioning group.
        :param pulumi.Input[builtins.float] max_spot_price: The global maximum price for preemptible instances in the auto provisioning group. If both the `MaxSpotPrice` and `LaunchTemplateConfig.N.MaxPrice` parameters are specified, the maximum price is the lower value of the two.
        :param pulumi.Input[builtins.str] pay_as_you_go_allocation_strategy: The scale-out policy for pay-as-you-go instances. Valid values: `lowest-price` and `prioritized`,Default value: `lowest-price`.
        :param pulumi.Input[builtins.str] pay_as_you_go_target_capacity: The target capacity of pay-as-you-go instances in the auto provisioning group.
        :param pulumi.Input[builtins.str] spot_allocation_strategy: The scale-out policy for preemptible instances. Valid values:`lowest-price` and `diversified`,Default value: `lowest-price`.
        :param pulumi.Input[builtins.str] spot_instance_interruption_behavior: The default behavior after preemptible instances are shut down. Valid values: `stop` and `terminate`,Default value: `stop`.
        :param pulumi.Input[builtins.int] spot_instance_pools_to_use_count: This parameter takes effect when the `SpotAllocationStrategy` parameter is set to `lowest-price`. The auto provisioning group selects instance types of the lowest cost to create instances.
        :param pulumi.Input[builtins.str] spot_target_capacity: The target capacity of preemptible instances in the auto provisioning group.
        :param pulumi.Input[builtins.bool] terminate_instances: Specifies whether to release instances of the auto provisioning group. Valid values:`false` and `true`, default value: `false`.
        :param pulumi.Input[builtins.bool] terminate_instances_with_expiration: The shutdown policy for preemptible instances when the auto provisioning group expires. Valid values: `false` and `true`, default value: `false`.
        :param pulumi.Input[builtins.str] valid_from: The time when the auto provisioning group is started. The period of time between this point in time and the point in time specified by the `valid_until` parameter is the effective time period of the auto provisioning group.By default, an auto provisioning group is immediately started after creation.
        :param pulumi.Input[builtins.str] valid_until: The time when the auto provisioning group expires. The period of time between this point in time and the point in time specified by the `valid_from` parameter is the effective time period of the auto provisioning group.By default, an auto provisioning group never expires.
        """
    ...
    def total_target_capacity(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def total_target_capacity(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "total_target_capacity", value)

    @property
    @pulumi.getter(name="autoProvisioningGroupName")
    def auto_provisioning_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def auto_provisioning_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "auto_provisioning_group_name", value)

    @property
    @pulumi.getter(name="autoProvisioningGroupType")
    def auto_provisioning_group_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def auto_provisioning_group_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "auto_provisioning_group_type", value)

    @property
    @pulumi.getter(name="defaultTargetCapacityType")
    def default_target_capacity_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_target_capacity_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def max_spot_price(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def max_spot_price(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "max_spot_price", value)

    @property
    @pulumi.getter(name="payAsYouGoAllocationStrategy")
    def pay_as_you_go_allocation_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def pay_as_you_go_allocation_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pay_as_you_go_allocation_strategy", value)

    @property
    @pulumi.getter(name="payAsYouGoTargetCapacity")
    def pay_as_you_go_target_capacity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def pay_as_you_go_target_capacity(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def spot_instance_interruption_behavior(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def spot_instance_interruption_behavior(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "spot_instance_interruption_behavior", value)

    @property
    @pulumi.getter(name="spotInstancePoolsToUseCount")
    def spot_instance_pools_to_use_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def spot_instance_pools_to_use_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "spot_instance_pools_to_use_count", value)

    @property
    @pulumi.getter(name="spotTargetCapacity")
    def spot_target_capacity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def spot_target_capacity(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AutoProvisioningGroupState:
    def __init__(__self__, *,
                 ...
                 terminate_instances: Optional[pulumi.Input[builtins.bool]] = None,
                 terminate_instances_with_expiration: Optional[pulumi.Input[builtins.bool]] = None,
                 total_target_capacity: Optional[pulumi.Input[builtins.str]] = None,
                 valid_from: Optional[pulumi.Input[builtins.str]] = None,
                 valid_until: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="totalTargetCapacity")
    def total_target_capacity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The total target capacity of the auto provisioning group. The target capacity consists of the following three parts:PayAsYouGoTargetCapacity,SpotTargetCapacity and the supplemental capacity besides PayAsYouGoTargetCapacity and SpotTargetCapacity.
        """
        return pulumi.get(self, "total_target_capacity")
    ...
    @total_target_capacity.setter
    def total_target_capacity(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "total_target_capacity", value)
...
class AutoProvisioningGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            total_target_capacity: Optional[pulumi.Input[builtins.str]] = None,
            valid_from: Optional[pulumi.Input[builtins.str]] = None,
            valid_until: Optional[pulumi.Input[builtins.str]] = None) -> 'AutoProvisioningGroup':
        """
    ...
    @property
    @pulumi.getter(name="autoProvisioningGroupName")
    def auto_provisioning_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the auto provisioning group to be created. It must be 2 to 128 characters in length. It must start with a letter but cannot start with http:// or https://. It can contain letters, digits, colons (:), underscores (_), and hyphens (-)
        """
        return pulumi.get(self, "auto_provisioning_group_name")
    ...
    @property
    @pulumi.getter(name="autoProvisioningGroupType")
    def auto_provisioning_group_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of the auto provisioning group. Valid values:`request` and `maintain`,Default value: `maintain`.
        """
        return pulumi.get(self, "auto_provisioning_group_type")
    ...
    @property
    @pulumi.getter(name="defaultTargetCapacityType")
    def default_target_capacity_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of supplemental instances. When the total value of `PayAsYouGoTargetCapacity` and `SpotTargetCapacity` is smaller than the value of TotalTargetCapacity, the auto provisioning group will create instances of the specified type to meet the capacity requirements. Valid values:`PayAsYouGo`: Pay-as-you-go instances; `Spot`: Preemptible instances, Default value: `Spot`.
        """
        return pulumi.get(self, "default_target_capacity_type")
    ...
    @property
    @pulumi.getter(name="maxSpotPrice")
    def max_spot_price(self) -> pulumi.Output[builtins.float]:
        """
        The global maximum price for preemptible instances in the auto provisioning group. If both the `MaxSpotPrice` and `LaunchTemplateConfig.N.MaxPrice` parameters are specified, the maximum price is the lower value of the two.
        """
        return pulumi.get(self, "max_spot_price")
    ...
    @property
    @pulumi.getter(name="payAsYouGoAllocationStrategy")
    def pay_as_you_go_allocation_strategy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The scale-out policy for pay-as-you-go instances. Valid values: `lowest-price` and `prioritized`,Default value: `lowest-price`.
        """
        return pulumi.get(self, "pay_as_you_go_allocation_strategy")
    ...
    @property
    @pulumi.getter(name="payAsYouGoTargetCapacity")
    def pay_as_you_go_target_capacity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The target capacity of pay-as-you-go instances in the auto provisioning group.
        """
        return pulumi.get(self, "pay_as_you_go_target_capacity")
    ...
    @property
    @pulumi.getter(name="spotAllocationStrategy")
    def spot_allocation_strategy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The scale-out policy for preemptible instances. Valid values:`lowest-price` and `diversified`,Default value: `lowest-price`.
        """
        return pulumi.get(self, "spot_allocation_strategy")
    ...
    @property
    @pulumi.getter(name="spotInstanceInterruptionBehavior")
    def spot_instance_interruption_behavior(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The default behavior after preemptible instances are shut down. Valid values: `stop` and `terminate`,Default value: `stop`.
        """
        return pulumi.get(self, "spot_instance_interruption_behavior")
    ...
    @property
    @pulumi.getter(name="spotInstancePoolsToUseCount")
    def spot_instance_pools_to_use_count(self) -> pulumi.Output[builtins.int]:
        """
        This parameter takes effect when the `SpotAllocationStrategy` parameter is set to `lowest-price`. The auto provisioning group selects instance types of the lowest cost to create instances.
        """
        return pulumi.get(self, "spot_instance_pools_to_use_count")
    ...
    @property
    @pulumi.getter(name="spotTargetCapacity")
    def spot_target_capacity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The target capacity of preemptible instances in the auto provisioning group.
        """
        return pulumi.get(self, "spot_target_capacity")
    ...
    @property
    @pulumi.getter(name="totalTargetCapacity")
    def total_target_capacity(self) -> pulumi.Output[builtins.str]:
        """
        The total target capacity of the auto provisioning group. The target capacity consists of the following three parts:PayAsYouGoTargetCapacity,SpotTargetCapacity and the supplemental capacity besides PayAsYouGoTargetCapacity and SpotTargetCapacity.
        """
        return pulumi.get(self, "total_target_capacity")
