...
class EcsDeploymentSetArgs:
    def __init__(__self__, *,
                 ...
                 on_unable_to_redeploy_failed_instance: Optional[pulumi.Input[builtins.str]] = None,
                 strategy: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EcsDeploymentSet resource.
        :param pulumi.Input[builtins.str] deployment_set_name: The name of the deployment set. The name must be `2` to `128` characters in length and can contain letters, digits, colons (:), underscores (_), and hyphens (-). It must start with a letter and cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] description: The description of the deployment set. The description must be `2` to `256` characters in length and cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] domain: Field `domain` has been deprecated from provider version 1.243.0.
        :param pulumi.Input[builtins.str] granularity: Field `granularity` has been deprecated from provider version 1.243.0.
        :param pulumi.Input[builtins.str] on_unable_to_redeploy_failed_instance: The emergency solution to use in the situation where instances in the deployment set cannot be evenly distributed to different zones due to resource insufficiency after the instances failover. Valid values:
        ...
        :param pulumi.Input[builtins.str] strategy: The deployment strategy. Default value: `Availability`. Valid values: `Availability`, `AvailabilityGroup`, `LowLatency`.
        """
    ...
    def on_unable_to_redeploy_failed_instance(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def on_unable_to_redeploy_failed_instance(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EcsDeploymentSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            granularity: Optional[pulumi.Input[builtins.str]] = None,
            on_unable_to_redeploy_failed_instance: Optional[pulumi.Input[builtins.str]] = None,
            strategy: Optional[pulumi.Input[builtins.str]] = None) -> 'EcsDeploymentSet':
        """
    ...
    @property
    @pulumi.getter(name="deploymentSetName")
    def deployment_set_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the deployment set. The name must be `2` to `128` characters in length and can contain letters, digits, colons (:), underscores (_), and hyphens (-). It must start with a letter and cannot start with `http://` or `https://`.
        """
        return pulumi.get(self, "deployment_set_name")
    ...
    @property
    @pulumi.getter(name="onUnableToRedeployFailedInstance")
    def on_unable_to_redeploy_failed_instance(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The emergency solution to use in the situation where instances in the deployment set cannot be evenly distributed to different zones due to resource insufficiency after the instances failover. Valid values:
        - `CancelMembershipAndStart` - Removes the instances from the deployment set and starts the instances immediately after they are failed over.
        - `KeepStopped`- Leaves the instances in the Stopped state and starts them after resources are replenished.
