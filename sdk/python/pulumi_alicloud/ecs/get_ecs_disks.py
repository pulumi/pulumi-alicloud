...
def get_ecs_disks(additional_attributes: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] additional_attributes: Other attribute values. Currently, only the incoming value of IOPS is supported, which means to query the IOPS upper limit of the current disk.
    ...
    :param builtins.bool dry_run: Specifies whether to check the validity of the request without actually making the request.request Default value: false. Valid values:
    ...
    :param builtins.bool enable_shared: Whether it is shared block storage.
...
def get_ecs_disks_output(additional_attributes: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                         ...
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEcsDisksResult]:
    """
    This data source provides the Ecs Disks of the current Alibaba Cloud user.
