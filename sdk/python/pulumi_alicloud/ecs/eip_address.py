...
class EipAddressArgs:
    def __init__(__self__, *,
                 activity_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 high_definition_monitor_log_status: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 netmode: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 public_ip_address_pool_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] activity_id: The promotion code. This parameter is not required.
        :param pulumi.Input[builtins.str] address_name: The EIP name.
        ...
        :param pulumi.Input[builtins.bool] auto_pay: Specifies whether to enable automatic payment. Valid values:
        :param pulumi.Input[builtins.str] bandwidth: The maximum bandwidth of the specified EIP. Unit: Mbit/s.
        ...
        :param pulumi.Input[builtins.bool] deletion_protection: Specifies whether to enable deletion protection. Valid values:
        :param pulumi.Input[builtins.str] description: The description of the EIP.
               
               The description must be 2 to 256 characters in length. The description must start with a letter but cannot start with `http://` or `https://`.
               
               > **NOTE:**   You cannot specify this parameter if you create a subscription EIP.
        :param pulumi.Input[builtins.str] high_definition_monitor_log_status: The status of fine-grained monitoring. Valid values:
               - `ON`
               - `OFF`
        :param pulumi.Input[builtins.str] instance_charge_type: . Field 'instance_charge_type' has been deprecated from provider version 1.126.0. New field 'payment_type' instead.
        :param pulumi.Input[builtins.str] internet_charge_type: The metering method of the EIP. Valid values:
        ...
        :param pulumi.Input[builtins.str] ip_address: The IP address of the EIP. Supports a maximum of 50 EIPs.
        :param pulumi.Input[builtins.str] isp: The line type. Valid values:
        ...
        :param pulumi.Input[builtins.str] log_project: The name of the Simple Log Service (SLS) project.
        :param pulumi.Input[builtins.str] log_store: The name of the Logstore.
        :param pulumi.Input[builtins.str] mode: The association mode. Valid values:
               - `NAT` (default): NAT mode
               - `MULTI_BINDED`: multi-EIP-to-ENI mode
               - `BINDED`: cut-network interface controller mode
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.126.0. New field 'address_name' instead.
        :param pulumi.Input[builtins.str] netmode: The network type. By default, this value is set to `public`, which specifies the public network type.
        :param pulumi.Input[builtins.str] payment_type: The billing method of the EIP. Valid values:
        ...
        :param pulumi.Input[builtins.str] public_ip_address_pool_id: The ID of the IP address pool. The EIP is allocated from the IP address pool. By default, the IP address pool feature is unavailable. To use the IP address pool, apply for the privilege in the Quota Center console. For more information, see the "Request a quota increase in the Quota Center console" section in [Manage EIP quotas](https://www.alibabacloud.com/help/en/doc-detail/108213.html).
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_protection_types: Security protection level.
        ...
        :param pulumi.Input[builtins.str] zone: The zone of the EIP. When the service type of the IP address pool specified by `PublicIpAddressPoolId` is CloudBox, the default value is the zone of the IP address pool. For more information, see [ListPublicIpAddressPools](https://www.alibabacloud.com/help/en/doc-detail/429433.html). 
    ...
    def activity_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @activity_id.setter
    def activity_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def high_definition_monitor_log_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def high_definition_monitor_log_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def netmode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @netmode.setter
    def netmode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def public_ip_address_pool_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_ip_address_pool_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EipAddressState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bandwidth: The maximum bandwidth of the specified EIP. Unit: Mbit/s.
               ...
               Default value: `5` Mbit /s.
        :param pulumi.Input[builtins.str] create_time: The time when the EIP was created.
        :param pulumi.Input[builtins.bool] deletion_protection: Specifies whether to enable deletion protection. Valid values:
        :param pulumi.Input[builtins.str] description: The description of the EIP.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_protection_types: Security protection level.
               - When the return is empty, the basic DDoS protection is specified.
               - When `antidos_enhanced` is returned, it indicates DDoS protection (enhanced version).
        :param pulumi.Input[builtins.str] status: The state of the EIP.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the resource
        :param pulumi.Input[builtins.str] zone: The zone of the EIP. When the service type of the IP address pool specified by `PublicIpAddressPoolId` is CloudBox, the default value is the zone of the IP address pool. For more information, see [ListPublicIpAddressPools](https://www.alibabacloud.com/help/en/doc-detail/429433.html). 
...
class EipAddress(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'EipAddress':
        """
    ...
    @property
    @pulumi.getter(name="activityId")
    def activity_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The promotion code. This parameter is not required.
        """
        return pulumi.get(self, "activity_id")
    ...
    @property
    @pulumi.getter(name="addressName")
    def address_name(self) -> pulumi.Output[builtins.str]:
        """
        The EIP name.
    ...
    @property
    @pulumi.getter(name="highDefinitionMonitorLogStatus")
    def high_definition_monitor_log_status(self) -> pulumi.Output[builtins.str]:
        """
        The status of fine-grained monitoring. Valid values:
        - `ON`
        - `OFF`
    ...
    @property
    @pulumi.getter(name="logProject")
    def log_project(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Simple Log Service (SLS) project.
        """
        return pulumi.get(self, "log_project")
    ...
    @property
    @pulumi.getter(name="logStore")
    def log_store(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Logstore.
        """
        return pulumi.get(self, "log_store")
    ...
    @property
    @pulumi.getter
    def netmode(self) -> pulumi.Output[builtins.str]:
        """
        The network type. By default, this value is set to `public`, which specifies the public network type.
        """
        return pulumi.get(self, "netmode")
    ...
    @property
    @pulumi.getter(name="publicIpAddressPoolId")
    def public_ip_address_pool_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the IP address pool. The EIP is allocated from the IP address pool. By default, the IP address pool feature is unavailable. To use the IP address pool, apply for the privilege in the Quota Center console. For more information, see the "Request a quota increase in the Quota Center console" section in [Manage EIP quotas](https://www.alibabacloud.com/help/en/doc-detail/108213.html).
        """
        return pulumi.get(self, "public_ip_address_pool_id")
    ...
    @property
    @pulumi.getter(name="securityProtectionTypes")
    def security_protection_types(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Security protection level.
        - When the return is empty, the basic DDoS protection is specified.
        - When `antidos_enhanced` is returned, it indicates DDoS protection (enhanced version).
