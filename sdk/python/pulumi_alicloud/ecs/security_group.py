...
class SecurityGroupArgs:
    def __init__(__self__, *,
                 ...
                 inner_access: Optional[pulumi.Input[builtins.bool]] = None,
                 inner_access_policy: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 security_group_type: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 vpc_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SecurityGroup resource.
        :param pulumi.Input[builtins.str] description: The description of the security group. The description must be `2` to `256` characters in length. It cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.bool] inner_access: Field `inner_access` has been deprecated from provider version 1.55.3. New field `inner_access_policy` instead.
        :param pulumi.Input[builtins.str] inner_access_policy: The internal access control policy of the security group. Valid values:
               - `Accept`: The internal interconnectivity policy.
               - `Drop`: The internal isolation policy.
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.239.0. New field `security_group_name` instead.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the security group belongs. **NOTE:** From version 1.115.0, `resource_group_id` can be modified.
        :param pulumi.Input[builtins.str] security_group_name: The name of the security group. The name must be `2` to `128` characters in length. The name must start with a letter and cannot start with `http://` or `https://`. The name can contain Unicode characters under the Decimal Number category and the categories whose names contain Letter. The name can also contain colons (:), underscores (\\_), periods (.), and hyphens (-).
        :param pulumi.Input[builtins.str] security_group_type: The type of the security group. Default value: `normal`. Valid values:
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC in which you want to create the security group.
        """
    ...
    def inner_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @inner_access.setter
    def inner_access(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "inner_access", value)

    @property
    @pulumi.getter(name="innerAccessPolicy")
    def inner_access_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inner_access_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def security_group_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def security_group_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SecurityGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: (Available since v1.239.0) The time when the security group was created.
        :param pulumi.Input[builtins.str] description: The description of the security group. The description must be `2` to `256` characters in length. It cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.bool] inner_access: Field `inner_access` has been deprecated from provider version 1.55.3. New field `inner_access_policy` instead.
        :param pulumi.Input[builtins.str] inner_access_policy: The internal access control policy of the security group. Valid values:
               - `Accept`: The internal interconnectivity policy.
...
class SecurityGroup(pulumi.CustomResource):
    ...
    @pulumi.getter(name="innerAccess")
    @_utilities.deprecated("""Field `inner_access` has been deprecated from provider version 1.55.3. New field `inner_access_policy` instead.""")
    def inner_access(self) -> pulumi.Output[builtins.bool]:
        """
        Field `inner_access` has been deprecated from provider version 1.55.3. New field `inner_access_policy` instead.
        """
        return pulumi.get(self, "inner_access")
    ...
    @property
    @pulumi.getter(name="innerAccessPolicy")
    def inner_access_policy(self) -> pulumi.Output[builtins.str]:
        """
        The internal access control policy of the security group. Valid values:
        - `Accept`: The internal interconnectivity policy.
        - `Drop`: The internal isolation policy.
    ...
    @property
    @pulumi.getter(name="securityGroupType")
    def security_group_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the security group. Default value: `normal`. Valid values:
        """
        return pulumi.get(self, "security_group_type")
