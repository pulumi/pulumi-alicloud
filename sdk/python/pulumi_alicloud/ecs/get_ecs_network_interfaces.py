...
def get_ecs_network_interfaces(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Network Interface IDs.
    ...
    :param builtins.str name_regex: A regex string to filter results by Network Interface name.
...
def get_ecs_network_interfaces_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
