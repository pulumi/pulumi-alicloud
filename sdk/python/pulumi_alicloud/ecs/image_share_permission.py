...
class ImageSharePermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: Alibaba Cloud Account ID. It is used to share images.
...
class ImageSharePermission(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            account_id: Optional[pulumi.Input[builtins.str]] = None,
            image_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ImageSharePermission':
        """
