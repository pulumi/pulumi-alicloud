...
class ReservedInstanceArgs:
    def __init__(__self__, *,
                 ...
                 reserved_instance_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_type: Instance type of the RI. For more information, see [Instance type families](https://www.alibabacloud.com/help/doc-detail/25378.html).
        :param pulumi.Input[builtins.int] auto_renew_period: The auto-renewal term of the reserved instance. This parameter takes effect only when AutoRenew is set to true. Valid values: 1, 12, 36, and 60. Default value when `period_unit` is set to Month: 1 Default value when `period_unit` is set to Year: 12
        :param pulumi.Input[builtins.str] description: Description of the RI. 2 to 256 English or Chinese characters. It cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.int] instance_amount: Number of instances allocated to an RI (An RI is a coupon that includes one or more allocated instances.).
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.194.0. New field `reserved_instance_name` instead.
        :param pulumi.Input[builtins.str] offering_type: Payment type of the RI. Default value: `All Upfront`. Valid values:
               - `No Upfront`: No upfront payment.
               - `Partial Upfront`: A portion of upfront payment.
               - `All Upfront`: Full upfront payment.
        :param pulumi.Input[builtins.int] period: The validity period of the reserved instance. Default value: `1`. **NOTE:** From version 1.183.0, `period` can be set to `5`, when `period_unit` is `Year`.
               - When `period_unit` is `Year`, Valid values: `1`, `3`, `5`.
               - When `period_unit` is `Month`, Valid values: `1`.
        :param pulumi.Input[builtins.str] period_unit: The unit of the validity period of the reserved instance. Valid value: `Month`, `Year`. Default value: `Year`. **NOTE:** From version 1.183.0, `period_unit` can be set to `Month`.
        :param pulumi.Input[builtins.str] platform: The operating system type of the image used by the instance. Optional values: `Windows`, `Linux`. Default is `Linux`.
        :param pulumi.Input[builtins.str] renewal_status: Automatic renewal status. Valid values: `AutoRenewal`,`Normal`.
        :param pulumi.Input[builtins.str] reserved_instance_name: Name of the RI. The name must be a string of 2 to 128 characters in length and can contain letters, numbers, colons (:), underscores (_), and hyphens. It must start with a letter. It cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] resource_group_id: Resource group ID.
        :param pulumi.Input[builtins.str] scope: Scope of the RI. Optional values: `Region`: region-level, `Zone`: zone-level. Default is `Region`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] zone_id: ID of the zone to which the RI belongs. When Scope is set to Zone, this parameter is required. For information about the zone list, see [DescribeZones](https://www.alibabacloud.com/help/doc-detail/25610.html).
        """
    ...
    def reserved_instance_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def reserved_instance_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ReservedInstanceState:
    def __init__(__self__, *,
                 allocation_status: Optional[pulumi.Input[builtins.str]] = None,
                 auto_renew_period: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] allocation_status: Indicates the sharing status of the reserved instance when the AllocationType parameter is set to Shared. Valid values: `allocated`: The reserved instance is allocated to another account. `beAllocated`: The reserved instance is allocated by another account.
        :param pulumi.Input[builtins.int] auto_renew_period: The auto-renewal term of the reserved instance. This parameter takes effect only when AutoRenew is set to true. Valid values: 1, 12, 36, and 60. Default value when `period_unit` is set to Month: 1 Default value when `period_unit` is set to Year: 12
        :param pulumi.Input[builtins.str] create_time: The time when the reserved instance was created.
        :param pulumi.Input[builtins.str] description: Description of the RI. 2 to 256 English or Chinese characters. It cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] expired_time: The time when the reserved instance expires.
        :param pulumi.Input[builtins.int] instance_amount: Number of instances allocated to an RI (An RI is a coupon that includes one or more allocated instances.).
        :param pulumi.Input[builtins.str] instance_type: Instance type of the RI. For more information, see [Instance type families](https://www.alibabacloud.com/help/doc-detail/25378.html).
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.194.0. New field `reserved_instance_name` instead.
        :param pulumi.Input[builtins.str] offering_type: Payment type of the RI. Default value: `All Upfront`. Valid values:
        ...
        :param pulumi.Input[builtins.str] resource_group_id: Resource group ID.
        :param pulumi.Input[builtins.str] scope: Scope of the RI. Optional values: `Region`: region-level, `Zone`: zone-level. Default is `Region`.
        :param pulumi.Input[builtins.str] start_time: The time when the reserved instance took effect.
        :param pulumi.Input[builtins.str] status: The status of the reserved instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] zone_id: ID of the zone to which the RI belongs. When Scope is set to Zone, this parameter is required. For information about the zone list, see [DescribeZones](https://www.alibabacloud.com/help/doc-detail/25610.html).
        """
    ...
    def allocation_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def allocation_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ReservedInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ReservedInstance':
        """
    ...
    @property
    @pulumi.getter(name="allocationStatus")
    def allocation_status(self) -> pulumi.Output[builtins.str]:
        """
        Indicates the sharing status of the reserved instance when the AllocationType parameter is set to Shared. Valid values: `allocated`: The reserved instance is allocated to another account. `beAllocated`: The reserved instance is allocated by another account.
        """
        return pulumi.get(self, "allocation_status")
    ...
    @property
    @pulumi.getter(name="offeringType")
    def offering_type(self) -> pulumi.Output[builtins.str]:
        """
        Payment type of the RI. Default value: `All Upfront`. Valid values:
        - `No Upfront`: No upfront payment.
        - `Partial Upfront`: A portion of upfront payment.
    ...
    @property
    @pulumi.getter(name="reservedInstanceName")
    def reserved_instance_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the RI. The name must be a string of 2 to 128 characters in length and can contain letters, numbers, colons (:), underscores (_), and hyphens. It must start with a letter. It cannot start with http:// or https://.
        """
        return pulumi.get(self, "reserved_instance_name")
