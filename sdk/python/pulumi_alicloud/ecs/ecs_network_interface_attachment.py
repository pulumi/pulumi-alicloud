...
class EcsNetworkInterfaceAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 trunk_network_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 wait_for_network_configuration_ready: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a EcsNetworkInterfaceAttachment resource.
        :param pulumi.Input[builtins.str] instance_id: The ID of the ECS instance.
        :param pulumi.Input[builtins.str] network_interface_id: The ID of the network interface.
        :param pulumi.Input[builtins.int] network_card_index: The index of the network card.
        :param pulumi.Input[builtins.str] trunk_network_instance_id: The ID of the trunk network instance.
        :param pulumi.Input[builtins.bool] wait_for_network_configuration_ready: The wait for network configuration ready.
        """
    ...
    def trunk_network_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def trunk_network_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trunk_network_instance_id", value)

    @property
    @pulumi.getter(name="waitForNetworkConfigurationReady")
    def wait_for_network_configuration_ready(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def wait_for_network_configuration_ready(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class EcsNetworkInterfaceAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_interface_id: Optional[pulumi.Input[builtins.str]] = None,
            trunk_network_instance_id: Optional[pulumi.Input[builtins.str]] = None,
            wait_for_network_configuration_ready: Optional[pulumi.Input[builtins.bool]] = None) -> 'EcsNetworkInterfaceAttachment':
        """
    ...
    @property
    @pulumi.getter(name="trunkNetworkInstanceId")
    def trunk_network_instance_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the trunk network instance.
        """
        return pulumi.get(self, "trunk_network_instance_id")
    ...
    @property
    @pulumi.getter(name="waitForNetworkConfigurationReady")
    def wait_for_network_configuration_ready(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The wait for network configuration ready.
        """
        return pulumi.get(self, "wait_for_network_configuration_ready")
