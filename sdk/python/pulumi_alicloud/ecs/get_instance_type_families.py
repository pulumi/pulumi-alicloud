...
def get_instance_type_families(generation: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_charge_type: Valid values are `PrePaid`, `PostPaid`, Default to `PostPaid`.
    ...
    :param builtins.str zone_id: The Zone to launch the instance.
    """
    __args__ = dict()
...
def get_instance_type_families_output(generation: Optional[pulumi.Input[Optional[builtins.str]]] = None,
