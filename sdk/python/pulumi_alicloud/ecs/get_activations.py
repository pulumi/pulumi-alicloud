...
def get_activations(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Activation IDs.
...
def get_activations_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
