...
def get_ecs_storage_capacity_units(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Storage Capacity Unit IDs.
    :param builtins.str name_regex: A regex string to filter results by Storage Capacity Unit name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of Storage Capacity Unit. Valid values: `Active`, `Creating`, `Expired`, `Pending`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_ecs_storage_capacity_units_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
