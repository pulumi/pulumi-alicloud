...
class GetCapacityReservationsResult:
    ...
    def capacity_reservation_ids(self) -> Optional[Sequence[builtins.str]]:
...
def get_capacity_reservations(capacity_reservation_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Capacity Reservation IDs.
...
def get_capacity_reservations_output(capacity_reservation_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
