...
class GetDisksResult:
    ...
    def additional_attributes(self) -> Optional[Sequence[_builtins.str]]:
    ...
    def delete_auto_snapshot(self) -> Optional[_builtins.bool]:
...
def get_disks(additional_attributes: Optional[Sequence[_builtins.str]] = None,
              ...
              delete_auto_snapshot: Optional[_builtins.bool] = None,
              ...
              enable_auto_snapshot: Optional[_builtins.bool] = None,
              enable_automated_snapshot_policy: Optional[_builtins.bool] = None,
              enable_shared: Optional[_builtins.bool] = None,
              encrypted: Optional[_builtins.str] = None,
              ids: Optional[Sequence[_builtins.str]] = None,
              instance_id: Optional[_builtins.str] = None,
              kms_key_id: Optional[_builtins.str] = None,
              name_regex: Optional[_builtins.str] = None,
              operation_locks: Optional[Sequence[Union['GetDisksOperationLockArgs', 'GetDisksOperationLockArgsDict', 'outputs.GetDisksOperationLockResult']]] = None,
    ...
    :param _builtins.str availability_zone: Availability zone of the disk.
    :param _builtins.str category: Disk category. Possible values: `cloud` (basic cloud disk), `cloud_efficiency` (ultra cloud disk), `ephemeral_ssd` (local SSD cloud disk), `cloud_ssd` (SSD cloud disk), and `cloud_essd` (ESSD cloud disk), `cloud_essd_entry`.
    :param _builtins.str encrypted: Indicate whether the disk is encrypted or not. Possible values: `on` and `off`.
    :param Sequence[_builtins.str] ids: A list of disks IDs.
    ...
    :param _builtins.str resource_group_id: The Id of resource group which the disk belongs.
    :param _builtins.str snapshot_id: Snapshot used to create the disk. It is null if no snapshot is used to create the disk.
    :param _builtins.str status: Current status. Possible values: `In_use`, `Available`, `Attaching`, `Detaching`, `Creating` and `ReIniting`.
    :param Mapping[str, _builtins.str] tags: A map of tags assigned to the disks. It must be in the format:
           ```python
           import pulumi
           import pulumi_alicloud as alicloud
           ...
           ```
    :param _builtins.str type: Disk type. Possible values: `system` and `data`.
    """
    __args__ = dict()
...
def get_disks_output(additional_attributes: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                     auto_snapshot_policy_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     ...
                     delete_auto_snapshot: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                     delete_with_instance: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                     disk_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     disk_type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     dry_run: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                     enable_auto_snapshot: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                     enable_automated_snapshot_policy: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                     enable_shared: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                     encrypted: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     ...
                     operation_locks: pulumi.Input[Optional[Optional[Sequence[Union['GetDisksOperationLockArgs', 'GetDisksOperationLockArgsDict', 'outputs.GetDisksOperationLockResult']]]]] = None,
