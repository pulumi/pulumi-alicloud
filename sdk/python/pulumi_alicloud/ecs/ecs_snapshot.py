...
class EcsSnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] category: The category of the snapshot. Valid values:
        :param pulumi.Input[builtins.str] description: The description of the snapshot.
        :param pulumi.Input[builtins.bool] force: Specifies whether to force delete the snapshot that has been used to create disks. Valid values:
        :param pulumi.Input[builtins.bool] instant_access: Field `instant_access` has been deprecated from provider version 1.231.0.
        :param pulumi.Input[builtins.int] instant_access_retention_days: Field `instant_access_retention_days` has been deprecated from provider version 1.231.0.
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.120.0. New field `snapshot_name` instead.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group. **NOTE:** From version 1.239.0, `resource_group_id` can be modified.
        :param pulumi.Input[builtins.int] retention_days: The retention period of the snapshot. Valid values: `1` to `65536`. **NOTE:** From version 1.231.0, `retention_days` can be modified.
...
class _EcsSnapshotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] category: The category of the snapshot. Valid values:
        :param pulumi.Input[builtins.str] create_time: (Available since v1.239.0) The time when the snapshot was created.
        :param pulumi.Input[builtins.str] description: The description of the snapshot.
        :param pulumi.Input[builtins.str] disk_id: The ID of the disk.
        :param pulumi.Input[builtins.bool] force: Specifies whether to force delete the snapshot that has been used to create disks. Valid values:
        :param pulumi.Input[builtins.bool] instant_access: Field `instant_access` has been deprecated from provider version 1.231.0.
        :param pulumi.Input[builtins.int] instant_access_retention_days: Field `instant_access_retention_days` has been deprecated from provider version 1.231.0.
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.120.0. New field `snapshot_name` instead.
        :param pulumi.Input[builtins.str] region_id: (Available since v1.239.0) The region ID of the snapshot.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group. **NOTE:** From version 1.239.0, `resource_group_id` can be modified.
        :param pulumi.Input[builtins.int] retention_days: The retention period of the snapshot. Valid values: `1` to `65536`. **NOTE:** From version 1.231.0, `retention_days` can be modified.
        :param pulumi.Input[builtins.str] snapshot_name: The name of the snapshot.
        :param pulumi.Input[builtins.str] status: The status of the Snapshot.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        """
        if category is not None:
            pulumi.set(__self__, "category", category)
...
class EcsSnapshot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            snapshot_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'EcsSnapshot':
        """
