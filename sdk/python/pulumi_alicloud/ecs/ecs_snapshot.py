...
class EcsSnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] force: Specifies whether to force delete the snapshot that has been used to create disks. Valid values:
        :param pulumi.Input[_builtins.bool] instant_access: Field `instant_access` has been deprecated from provider version 1.231.0.
        :param pulumi.Input[_builtins.int] instant_access_retention_days: Field `instant_access_retention_days` has been deprecated from provider version 1.231.0.
        :param pulumi.Input[_builtins.str] name: Field `name` has been deprecated from provider version 1.120.0. New field `snapshot_name` instead.
        :param pulumi.Input[_builtins.str] resource_group_id: The ID of the resource group. **NOTE:** From version 1.239.0, `resource_group_id` can be modified.
...
class _EcsSnapshotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] instant_access_retention_days: Field `instant_access_retention_days` has been deprecated from provider version 1.231.0.
        :param pulumi.Input[_builtins.str] name: Field `name` has been deprecated from provider version 1.120.0. New field `snapshot_name` instead.
        :param pulumi.Input[_builtins.str] region_id: (Available since v1.239.0) The region ID of the snapshot.
        :param pulumi.Input[_builtins.str] resource_group_id: The ID of the resource group. **NOTE:** From version 1.239.0, `resource_group_id` can be modified.
        :param pulumi.Input[_builtins.int] retention_days: The retention period of the snapshot. Valid values: `1` to `65536`. **NOTE:** From version 1.231.0, `retention_days` can be modified.
        :param pulumi.Input[_builtins.str] snapshot_name: The name of the snapshot.
...
class EcsSnapshot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            snapshot_name: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'EcsSnapshot':
        """
