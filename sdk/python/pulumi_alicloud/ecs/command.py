...
class CommandArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] command_content: The Base64-encoded content of the command.
        :param pulumi.Input[builtins.str] type: The command type. Valid Values: `RunBatScript`, `RunPowerShellScript` and `RunShellScript`.
        :param pulumi.Input[builtins.str] description: The description of command.
        :param pulumi.Input[builtins.bool] enable_parameter: Specifies whether to use custom parameters in the command to be created. Default to: false.
        :param pulumi.Input[builtins.str] name: The name of the command, which supports all character sets. It can be up to 128 characters in length.
        :param pulumi.Input[builtins.int] timeout: The timeout period that is specified for the command to be run on ECS instances. Unit: seconds. Default to: `60`.
        :param pulumi.Input[builtins.str] working_dir: The execution path of the command in the ECS instance.
        """
