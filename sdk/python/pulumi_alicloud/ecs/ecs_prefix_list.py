...
class EcsPrefixListArgs:
    def __init__(__self__, *,
                 ...
                 prefix_list_name: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EcsPrefixList resource.
        :param pulumi.Input[builtins.str] address_family: The IP address family. Valid values: `IPv4`,`IPv6`.
        :param pulumi.Input[Sequence[pulumi.Input['EcsPrefixListEntryArgs']]] entries: The Entry. The details see Block `entry`.
        :param pulumi.Input[builtins.int] max_entries: The maximum number of entries that the prefix list can contain.  Valid values: 1 to 200.
        :param pulumi.Input[builtins.str] prefix_list_name: The name of the prefix. The name must be 2 to 128 characters in length. It must start with a letter and cannot start with `http://`, `https://`, `com.aliyun`, or `com.alibabacloud`. It can contain letters, digits, colons (:), underscores (_), periods (.), and hyphens (-).
        :param pulumi.Input[builtins.str] description: The description of the prefix list. The description must be 2 to 256 characters in length and cannot start with `http://` or `https://`.
        """
    ...
    def prefix_list_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def prefix_list_name(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("alicloud:ecs/ecsPrefixList:EcsPrefixList")
class EcsPrefixList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            entries: Optional[pulumi.Input[Sequence[pulumi.Input[Union['EcsPrefixListEntryArgs', 'EcsPrefixListEntryArgsDict']]]]] = None,
            max_entries: Optional[pulumi.Input[builtins.int]] = None,
            prefix_list_name: Optional[pulumi.Input[builtins.str]] = None) -> 'EcsPrefixList':
        """
