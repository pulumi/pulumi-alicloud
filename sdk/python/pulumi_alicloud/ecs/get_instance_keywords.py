...
def get_instance_keywords(key: Optional[builtins.str] = None,
    ...
    :param builtins.str key: The type of reserved keyword to query. Valid values: `account`, `database`.
...
def get_instance_keywords_output(key: Optional[pulumi.Input[builtins.str]] = None,
