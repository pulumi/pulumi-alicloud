...
class GetEcsDeploymentSetsResult:
    ...
    def deployment_set_name(self) -> Optional[builtins.str]:
...
def get_ecs_deployment_sets(deployment_set_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Deployment Set IDs.
    :param builtins.str name_regex: A regex string to filter results by Deployment Set name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str strategy: The deployment strategy. Valid values: `Availability`.
    """
    __args__ = dict()
...
def get_ecs_deployment_sets_output(deployment_set_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                   ...
                                   strategy: Optional[pulumi.Input[Optional[builtins.str]]] = None,
