...
class DiskAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] disk_id: ID of the Disk to be attached.
...
class DiskAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            key_pair_name: Optional[pulumi.Input[builtins.str]] = None,
            password: Optional[pulumi.Input[builtins.str]] = None) -> 'DiskAttachment':
        """
    ...
    @property
    @pulumi.getter
    def bootable(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "bootable")

    @property
    @pulumi.getter(name="deleteWithInstance")
    def delete_with_instance(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "delete_with_instance")
