...
class GetImagesResult:
    ...
    def image_owner_id(self) -> Optional[builtins.str]:
    ...
    def is_support_cloud_init(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "is_support_cloud_init")

    @property
    @pulumi.getter(name="isSupportIoOptimized")
    def is_support_io_optimized(self) -> Optional[builtins.bool]:
...
def get_images(action_type: Optional[builtins.str] = None,
               ...
               image_owner_id: Optional[builtins.str] = None,
               instance_type: Optional[builtins.str] = None,
               is_support_cloud_init: Optional[builtins.bool] = None,
               is_support_io_optimized: Optional[builtins.bool] = None,
    ...
    :param builtins.str action_type: The scenario in which the image will be used. Default value: `CreateEcs`. Valid values:                                                
           * `CreateEcs`: instance creation.
           * `ChangeOS`: replacement of the system disk or operating system.
    :param builtins.str architecture: The image architecture. Valid values: `i386` and `x86_64`.
    :param builtins.bool dry_run: Specifies whether the image is running on an ECS instance. Default value: `false`. Valid values:
    :param builtins.str image_family: The name of the image family. You can set this parameter to query images of the specified image family. This parameter is empty by default.
    :param builtins.str image_id: The ID of the image.
    :param builtins.str image_name: The name of the image.
    :param builtins.str image_owner_id: The ID of the Alibaba Cloud account to which the image belongs. This parameter takes effect only when you query shared images or community images.
    :param builtins.str instance_type: The instance type for which the image can be used.
    :param builtins.bool is_support_cloud_init: Specifies whether the image supports cloud-init.
    :param builtins.bool is_support_io_optimized: Specifies whether the image can be used on I/O optimized instances.
    :param builtins.bool most_recent: If more than one result are returned, select the most recent one.
    :param builtins.str name_regex: A regex string to filter resulting images by name.
    ...
    :param builtins.str owners: Filter results by a specific image owner. Valid items are `system`, `self`, `others`, `marketplace`.
    :param builtins.str resource_group_id: The ID of the resource group to which the custom image belongs.
...
def get_images_output(action_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      architecture: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      dry_run: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      image_family: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      image_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      image_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      image_owner_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      instance_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      is_support_cloud_init: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      is_support_io_optimized: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      ...
                      owners: Optional[pulumi.Input[Optional[builtins.str]]] = None,
