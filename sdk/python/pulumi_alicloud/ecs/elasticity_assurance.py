...
class ElasticityAssuranceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: The tag key-value pair information bound by the elastic guarantee service.
        """
    ...
    def instance_amount(self, value: pulumi.Input[_builtins.int]):
...
class _ElasticityAssuranceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] status: The status of flexible guarantee services. Possible values:-Preparing: in preparation.-Prepared: to take effect.-Active: in effect.-Released: Released.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: The tag key-value pair information bound by the elastic guarantee service.
        :param pulumi.Input[_builtins.int] used_assurance_times: This parameter is not yet available.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] zone_ids: The zone ID of the region to which the elastic Protection Service belongs. Currently, only the creation of flexible protection services in one available area is supported.
        """
        if assurance_times is not None:
            pulumi.set(__self__, "assurance_times", assurance_times)
...
class ElasticityAssurance(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="assuranceTimes")
    def assurance_times(self) -> pulumi.Output[_builtins.str]:
        """
        The total number of times that the elasticity assurance can be applied. Set the value to Unlimited. This value indicates that the elasticity assurance can be applied an unlimited number of times within its effective duration. Default value: Unlimited.
        """
        return pulumi.get(self, "assurance_times")
    ...
    @_builtins.property
    @pulumi.getter(name="elasticityAssuranceId")
    def elasticity_assurance_id(self) -> pulumi.Output[_builtins.str]:
        """
        The first ID of the resource
        """
        return pulumi.get(self, "elasticity_assurance_id")
    ...
    @_builtins.property
    @pulumi.getter(name="privatePoolOptionsName")
    def private_pool_options_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the flexible protection service.
        """
        return pulumi.get(self, "private_pool_options_name")
    ...
    @_builtins.property
    @pulumi.getter(name="startTimeType")
    def start_time_type(self) -> pulumi.Output[_builtins.str]:
        """
        Flexible guarantee effective way. Possible values:-Now: Effective immediately.-Later: the specified time takes effect.
        """
        return pulumi.get(self, "start_time_type")
    ...
    @_builtins.property
    @pulumi.getter(name="usedAssuranceTimes")
    def used_assurance_times(self) -> pulumi.Output[_builtins.int]:
        """
        This parameter is not yet available.
        """
        return pulumi.get(self, "used_assurance_times")
