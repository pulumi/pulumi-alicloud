...
class GetEcsDedicatedHostClustersResult:
    ...
    def dedicated_host_cluster_ids(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "dedicated_host_cluster_ids")

    @property
    @pulumi.getter(name="dedicatedHostClusterName")
    def dedicated_host_cluster_name(self) -> Optional[builtins.str]:
...
def get_ecs_dedicated_host_clusters(dedicated_host_cluster_ids: Optional[Sequence[builtins.str]] = None,
                                    dedicated_host_cluster_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] dedicated_host_cluster_ids: The IDs of dedicated host clusters.
    :param builtins.str dedicated_host_cluster_name: The name of the dedicated host cluster.
    :param Sequence[builtins.str] ids: A list of Dedicated Host Cluster IDs.
    :param builtins.str name_regex: A regex string to filter results by Dedicated Host Cluster name.
...
def get_ecs_dedicated_host_clusters_output(dedicated_host_cluster_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                           dedicated_host_cluster_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
