...
class GetEcsDedicatedHostClustersResult:
    ...
    def dedicated_host_cluster_ids(self) -> Optional[Sequence[_builtins.str]]:
        return pulumi.get(self, "dedicated_host_cluster_ids")

    @_builtins.property
    @pulumi.getter(name="dedicatedHostClusterName")
    def dedicated_host_cluster_name(self) -> Optional[_builtins.str]:
...
def get_ecs_dedicated_host_clusters(dedicated_host_cluster_ids: Optional[Sequence[_builtins.str]] = None,
                                    dedicated_host_cluster_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] dedicated_host_cluster_ids: The IDs of dedicated host clusters.
    :param _builtins.str dedicated_host_cluster_name: The name of the dedicated host cluster.
    :param Sequence[_builtins.str] ids: A list of Dedicated Host Cluster IDs.
    :param _builtins.str name_regex: A regex string to filter results by Dedicated Host Cluster name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param Mapping[str, _builtins.str] tags: A mapping of tags to assign to the resource.
    :param _builtins.str zone_id: The zone ID of the dedicated host cluster.
    """
    __args__ = dict()
