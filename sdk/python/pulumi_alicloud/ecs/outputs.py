...
__all__ = [
    ...
    'DedicatedHostNetworkAttributes',
...
@pulumi.output_type
class DedicatedHostNetworkAttributes(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DedicatedHostNetworkAttributes. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DedicatedHostNetworkAttributes.__key_warning(key)
        return super().__getitem__(key)
