...
class ImageImportArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] architecture: The architecture of the image. Default value: `x86_64`. Valid values: `x86_64`, `i386`.
        :param pulumi.Input[builtins.str] boot_mode: The boot mode of the image. Valid values: `BIOS`, `UEFI`.
        :param pulumi.Input[builtins.str] description: The description of the image. The `description` must be 2 to 256 characters in length and cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] image_name: The name of the image. The `image_name` must be `2` to `128` characters in length. The `image_name` must start with a letter and cannot start with acs: or aliyun. The `image_name` cannot contain http:// or https://. The `image_name` can contain letters, digits, periods (.), colons (:), underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] license_type: The type of the license used to activate the operating system after the image is imported. Default value: `Auto`. Valid values: `Auto`, `Aliyun`, `BYOL`.
        :param pulumi.Input[builtins.str] os_type: The type of the operating system. Default value: `linux`. Valid values: `windows`, `linux`.
        :param pulumi.Input[builtins.str] platform: The operating system platform. More valid values refer to [ImportImage OpenAPI](https://www.alibabacloud.com/help/en/elastic-compute-service/latest/importimage).
...
class ImageImport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            license_type: Optional[pulumi.Input[builtins.str]] = None,
            os_type: Optional[pulumi.Input[builtins.str]] = None,
            platform: Optional[pulumi.Input[builtins.str]] = None) -> 'ImageImport':
        """
