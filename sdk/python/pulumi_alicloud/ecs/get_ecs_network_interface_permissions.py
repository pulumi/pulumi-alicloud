...
def get_ecs_network_interface_permissions(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Network Interface Permission IDs.
    ...
    :param builtins.str status: The Status of the Network Interface Permissions. Valid values: `Granted`, `Pending`, `Revoked`, `Revoking`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_ecs_network_interface_permissions_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
