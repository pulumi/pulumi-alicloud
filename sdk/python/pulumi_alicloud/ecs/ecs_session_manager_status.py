...
__all__ = ['EcsSessionManagerStatusArgs', 'EcsSessionManagerStatus']

@pulumi.input_type
class EcsSessionManagerStatusArgs:
    def __init__(__self__, *,
                 session_manager_status_name: pulumi.Input[builtins.str],
                 status: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a EcsSessionManagerStatus resource.
        :param pulumi.Input[builtins.str] session_manager_status_name: The name of the Session Manager Status. Valid values: `sessionManagerStatus`.
        :param pulumi.Input[builtins.str] status: The status of the Session Manager Status. Valid values: `Enabled`, `Disabled`.
        """
    ...
    def session_manager_status_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def session_manager_status_name(self, value: pulumi.Input[builtins.str]):
...
class _EcsSessionManagerStatusState:
    def __init__(__self__, *,
                 session_manager_status_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="sessionManagerStatusName")
    def session_manager_status_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Session Manager Status. Valid values: `sessionManagerStatus`.
        """
        return pulumi.get(self, "session_manager_status_name")
    ...
    @session_manager_status_name.setter
    def session_manager_status_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "session_manager_status_name", value)
...
class EcsSessionManagerStatus(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param EcsSessionManagerStatusArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EcsSessionManagerStatusArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EcsSessionManagerStatusArgs.__new__(EcsSessionManagerStatusArgs)

            if session_manager_status_name is None and not opts.urn:
                raise TypeError("Missing required property 'session_manager_status_name'")
            __props__.__dict__["session_manager_status_name"] = session_manager_status_name
            if status is None and not opts.urn:
                raise TypeError("Missing required property 'status'")
            __props__.__dict__["status"] = status
        super(EcsSessionManagerStatus, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            session_manager_status_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'EcsSessionManagerStatus':
        """
        ...
        __props__ = _EcsSessionManagerStatusState.__new__(_EcsSessionManagerStatusState)

        __props__.__dict__["session_manager_status_name"] = session_manager_status_name
        __props__.__dict__["status"] = status
        return EcsSessionManagerStatus(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="sessionManagerStatusName")
    def session_manager_status_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Session Manager Status. Valid values: `sessionManagerStatus`.
        """
        return pulumi.get(self, "session_manager_status_name")
