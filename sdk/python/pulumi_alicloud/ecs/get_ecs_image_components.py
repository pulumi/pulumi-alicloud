...
class GetEcsImageComponentsResult:
    ...
    def image_component_name(self) -> Optional[_builtins.str]:
...
def get_ecs_image_components(ids: Optional[Sequence[_builtins.str]] = None,
                             image_component_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Image Component IDs.
    :param _builtins.str image_component_name: The name of the component.
    :param _builtins.str name_regex: A regex string to filter results by Image Component name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str owner: Mirror component type. Valid values: `SELF` or `ALIYUN`. Possible values:
