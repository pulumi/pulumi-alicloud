...
class GetEcsImageComponentsResult:
    ...
    def image_component_name(self) -> Optional[builtins.str]:
...
def get_ecs_image_components(ids: Optional[Sequence[builtins.str]] = None,
                             image_component_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Image Component IDs.
    :param builtins.str image_component_name: The name of the component.
    :param builtins.str name_regex: A regex string to filter results by Image Component name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str owner: Mirror component type. Valid values: `SELF` or `ALIYUN`. Possible values:
...
def get_ecs_image_components_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                    image_component_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
