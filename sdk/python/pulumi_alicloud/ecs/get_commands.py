...
class GetCommandsResult:
    ...
    def command_provider(self) -> Optional[_builtins.str]:
...
def get_commands(command_provider: Optional[_builtins.str] = None,
    ...
    :param _builtins.str command_provider: Public order provider.
    :param _builtins.str content_encoding: The Base64-encoded content of the command.
    :param _builtins.str description: The description of command.
    :param Sequence[_builtins.str] ids: A list of Command IDs.
    :param _builtins.str name: The name of the command.
    :param _builtins.str name_regex: A regex string to filter results by Command name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str type: The command type. Valid Values: `RunBatScript`, `RunPowerShellScript` and `RunShellScript`.
    """
    __args__ = dict()
...
def get_commands_output(command_provider: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
