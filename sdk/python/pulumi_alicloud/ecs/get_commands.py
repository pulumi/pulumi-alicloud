...
class GetCommandsResult:
    ...
    def command_provider(self) -> Optional[builtins.str]:
...
def get_commands(command_provider: Optional[builtins.str] = None,
    ...
    :param builtins.str command_provider: Public order provider.
    :param builtins.str content_encoding: The Base64-encoded content of the command.
    :param builtins.str description: The description of command.
    :param Sequence[builtins.str] ids: A list of Command IDs.
    :param builtins.str name: The name of the command.
    :param builtins.str name_regex: A regex string to filter results by Command name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str type: The command type. Valid Values: `RunBatScript`, `RunPowerShellScript` and `RunShellScript`.
    """
    __args__ = dict()
...
def get_commands_output(command_provider: Optional[pulumi.Input[Optional[builtins.str]]] = None,
