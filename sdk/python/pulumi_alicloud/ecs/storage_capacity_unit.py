...
class StorageCapacityUnitArgs:
    def __init__(__self__, *,
                 ...
                 storage_capacity_unit_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a StorageCapacityUnit resource.
        :param pulumi.Input[builtins.int] capacity: The capacity of the Storage Capacity Unit. Unit: GiB. Valid values: `20`, `40`, `100`, `200`, `500`, `1024`, `2048`, `5120`, `10240`, `20480`, and `51200`.
        :param pulumi.Input[builtins.str] description: The description of the Storage Capacity Unit. The description must be 2 to 256 characters in length and cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.int] period: The validity period of the Storage Capacity Unit. Default value: `1`.
               * When PeriodUnit is set to Month, Valid values: `1`, `2`, `3`, `6`.
               * When PeriodUnit is set to Year, Valid values: `1`, `3`, `5`.
        :param pulumi.Input[builtins.str] period_unit: The unit of the validity period of the Storage Capacity Unit. Default value: `Month`. Valid values: `Month`, `Year`.
        :param pulumi.Input[builtins.str] start_time: The time when the Storage Capacity Unit takes effect. It cannot be earlier than or more than six months later than the time when the Storage Capacity Unit is created. Specify the time in the ISO 8601 standard in the `yyyy-MM-ddTHH:mm:ssZ` format. The time must be in UTC. **NOTE:** This parameter is empty by default. The Storage Capacity Unit immediately takes effect after it is created.
        :param pulumi.Input[builtins.str] storage_capacity_unit_name: The name of the Storage Capacity Unit.
        """
    ...
    def storage_capacity_unit_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_capacity_unit_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _StorageCapacityUnitState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] period_unit: The unit of the validity period of the Storage Capacity Unit. Default value: `Month`. Valid values: `Month`, `Year`.
        :param pulumi.Input[builtins.str] start_time: The time when the Storage Capacity Unit takes effect. It cannot be earlier than or more than six months later than the time when the Storage Capacity Unit is created. Specify the time in the ISO 8601 standard in the `yyyy-MM-ddTHH:mm:ssZ` format. The time must be in UTC. **NOTE:** This parameter is empty by default. The Storage Capacity Unit immediately takes effect after it is created.
        :param pulumi.Input[builtins.str] status: The status of Storage Capacity Unit.
        :param pulumi.Input[builtins.str] storage_capacity_unit_name: The name of the Storage Capacity Unit.
        """
...
class StorageCapacityUnit(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            start_time: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            storage_capacity_unit_name: Optional[pulumi.Input[builtins.str]] = None) -> 'StorageCapacityUnit':
        """
    ...
    @property
    @pulumi.getter(name="storageCapacityUnitName")
    def storage_capacity_unit_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Storage Capacity Unit.
        """
        return pulumi.get(self, "storage_capacity_unit_name")
