...
class DedicatedHostNetworkAttributeArgsDict(TypedDict):
    slb_udp_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class DedicatedHostNetworkAttributeArgs:
    def __init__(__self__, *,
                 slb_udp_timeout: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    def slb_udp_timeout(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The timeout period for a UDP session between Server Load Balancer (SLB) and the dedicated host. Unit: seconds. Valid values: 15 to 310.
        """
    ...
    def slb_udp_timeout(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class EcsInstanceSetDataDiskArgsDict(TypedDict):
    ...
    """
    disk_category: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The category of the disk. Valid values: `cloud_efficiency`, `cloud_ssd`, `cloud_essd`, `cloud`.
    """
    disk_description: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class EcsInstanceSetDataDiskArgs:
    def __init__(__self__, *,
                 ...
                 disk_description: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def disk_description(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The description of the data disk.
        """
    ...
    def disk_description(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class EcsLaunchTemplateImageOptionsArgsDict(TypedDict):
    login_as_non_root: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class EcsLaunchTemplateNetworkInterfacesArgsDict(TypedDict):
    delete_on_release: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class ImageDiskDeviceMappingArgsDict(TypedDict):
    ...
    Image format.
    """
    import_oss_bucket: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Import the bucket of the OSS to which the image belongs.
    """
    import_oss_object: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Import the object of the OSS to which the image file belongs.
    """
    progress: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Copy the progress of the task.
    """
    remain_time: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class ImageDiskDeviceMappingArgs:
    def __init__(__self__, *,
                 ...
                 import_oss_bucket: pulumi.Input[Optional[_builtins.str]] = None,
                 import_oss_object: pulumi.Input[Optional[_builtins.str]] = None,
                 progress: pulumi.Input[Optional[_builtins.str]] = None,
                 remain_time: pulumi.Input[Optional[_builtins.int]] = None,
                 size: pulumi.Input[Optional[_builtins.int]] = None,
                 snapshot_id: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def import_oss_bucket(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Import the bucket of the OSS to which the image belongs.
        """
    ...
    def import_oss_bucket(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "import_oss_bucket", value)

    @_builtins.property
    @pulumi.getter(name="importOssObject")
    def import_oss_object(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Import the object of the OSS to which the image file belongs.
        """
    ...
    def import_oss_object(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def remain_time(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        For an image being replicated, return the remaining time of the replication task, in seconds.
        """
    ...
    @remain_time.setter
    def remain_time(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class ImageImportDiskDeviceMappingArgsDict(TypedDict):
    ...
    """
    disk_image_size: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    oss_bucket: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The OSS bucket where the image file is stored.
    """
    oss_object: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class ImageImportDiskDeviceMappingArgs:
    def __init__(__self__, *,
                 device: pulumi.Input[Optional[_builtins.str]] = None,
                 disk_image_size: pulumi.Input[Optional[_builtins.int]] = None,
                 format: pulumi.Input[Optional[_builtins.str]] = None,
                 oss_bucket: pulumi.Input[Optional[_builtins.str]] = None,
                 oss_object: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def disk_image_size(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The size of the disk. Default value: `5`.
        """
    ...
    def disk_image_size(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def oss_bucket(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The OSS bucket where the image file is stored.
        """
    ...
    @oss_bucket.setter
    def oss_bucket(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "oss_bucket", value)

    @_builtins.property
    @pulumi.getter(name="ossObject")
    def oss_object(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The name (key) of the object that the uploaded image is stored as in the OSS bucket.
        """
    ...
    @oss_object.setter
    def oss_object(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class InstanceDataDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] category: The category of the disk. Default value: `cloud_efficiency`. Valid values:
...
class InstanceNetworkInterfacesArgsDict(TypedDict):
    ...
    """
    queue_pair_number: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    source_dest_check: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class InstanceNetworkInterfacesArgs:
    def __init__(__self__, *,
                 ...
                 queue_pair_number: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    def queue_pair_number(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The number of queues supported by the ERI.
        """
    ...
    def queue_pair_number(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class ReservedInstanceOperationLockArgsDict(TypedDict):
    lock_reason: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
