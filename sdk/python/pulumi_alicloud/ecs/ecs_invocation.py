...
class EcsInvocationArgs:
    def __init__(__self__, *,
                 ...
                 timed: Optional[pulumi.Input[builtins.bool]] = None,
                 username: Optional[pulumi.Input[builtins.str]] = None,
                 windows_password_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EcsInvocation resource.
        :param pulumi.Input[builtins.str] command_id: The ID of the command.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_ids: The list of instances to execute the command. You can specify up to 50 instance IDs.
        :param pulumi.Input[builtins.str] frequency: The schedule on which the recurring execution of the command takes place. Take note of the following items:
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: The key-value pairs of custom parameters to be passed in when the custom parameter feature is enabled.  Number of custom parameters: 0 to 10.
        :param pulumi.Input[builtins.str] repeat_mode: Specifies how to run the command. Valid values: `Once`, `Period`, `NextRebootOnly`, `EveryReboot`. Default value: When `timed` is set to false and Frequency is not specified, the default value of `repeat_mode` is `Once`. When `Timed` is set to true and Frequency is specified, `period` is used as the value of RepeatMode regardless of whether `repeat_mode` is specified.
        :param pulumi.Input[builtins.bool] timed: Specifies whether to periodically run the command. Default value: `false`.
        :param pulumi.Input[builtins.str] username: The username that is used to run the command on the ECS instance. 
        ...
        :param pulumi.Input[builtins.str] windows_password_name: The name of the password used to run the command on a Windows instance.
        """
    ...
    @property
    @pulumi.getter
    def timed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @timed.setter
    def timed(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def windows_password_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def windows_password_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EcsInvocation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            timed: Optional[pulumi.Input[builtins.bool]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None,
            windows_password_name: Optional[pulumi.Input[builtins.str]] = None) -> 'EcsInvocation':
        """
    ...
    @property
    @pulumi.getter
    def timed(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to periodically run the command. Default value: `false`.
        """
        return pulumi.get(self, "timed")
    ...
    @property
    @pulumi.getter(name="windowsPasswordName")
    def windows_password_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the password used to run the command on a Windows instance.
        """
        return pulumi.get(self, "windows_password_name")
