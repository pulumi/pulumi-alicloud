...
class EcsImagePipelineArgs:
    def __init__(__self__, *,
                 ...
                 base_image_type: pulumi.Input[builtins.str],
                 add_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 build_content: Optional[pulumi.Input[builtins.str]] = None,
                 delete_instance_on_failure: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 to_region_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 vswitch_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EcsImagePipeline resource.
        :param pulumi.Input[builtins.str] base_image: The source image. When you set `base_image_type` to `IMAGE`, set `base_image` to the ID of a custom image. When you set `base_image_type` to `IMAGE_FAMILY`, set `base_image` to the name of an image family.
        :param pulumi.Input[builtins.str] base_image_type: The type of the source image. Valid values: `IMAGE`, `IMAGE_FAMILY`.
               - IMAGE: custom image.
               - IMAGE_FAMILY: image family.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] add_accounts: The ID of Alibaba Cloud account to which to share the created image.
        :param pulumi.Input[builtins.str] build_content: The content of the image template. The content cannot be greater than 16 KB in size, and can contain up to 127 commands.
        :param pulumi.Input[builtins.bool] delete_instance_on_failure: Specifies whether to release the intermediate instance if the image cannot be created.
        :param pulumi.Input[builtins.str] description: The description of the image template. The description must be `2` to `256` characters in length and cannot start with `http://` or `https://`. **Note:** If the intermediate instance cannot be started, the instance is released by default.
        :param pulumi.Input[builtins.str] image_name: The name prefix of the image to be created. The prefix must be `2` to `64` characters in length. It must start with a letter and cannot start with `http://` or `https://`. It can contain letters, digits, colons (:), underscores (_), periods (.),and hyphens (-).
        ...
        :param pulumi.Input[builtins.int] internet_max_bandwidth_out: The size of the outbound public bandwidth for the intermediate instance. Unit: `Mbit/s`. Valid values: `0` to `100`. Default value: `0`.
        :param pulumi.Input[builtins.str] name: The name of the image template. The name must be `2` to `128` characters in length. It must start with a letter and cannot start with `http://` or `https://`. It can contain letters, digits, colons (:), underscores (_), periods (.),and hyphens (-).
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.int] system_disk_size: The size of the system disk of the intermediate instance. Unit: GiB. Valid values: `20` to `500`. Default value: `40`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] to_region_ids: The ID of region to which to distribute the created image.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the vSwitch. If you do not specify this parameter, a virtual private cloud (VPC) and a vSwitch are created by default.
        """
    ...
    def base_image_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def base_image_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "base_image_type", value)

    @property
    @pulumi.getter(name="addAccounts")
    def add_accounts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @add_accounts.setter
    def add_accounts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "add_accounts", value)

    @property
    @pulumi.getter(name="buildContent")
    def build_content(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def build_content(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "build_content", value)

    @property
    @pulumi.getter(name="deleteInstanceOnFailure")
    def delete_instance_on_failure(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def delete_instance_on_failure(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def to_region_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def to_region_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _EcsImagePipelineState:
    def __init__(__self__, *,
                 ...
                 base_image_type: Optional[pulumi.Input[builtins.str]] = None,
                 build_content: Optional[pulumi.Input[builtins.str]] = None,
                 delete_instance_on_failure: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 image_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="baseImageType")
    def base_image_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the source image. Valid values: `IMAGE`, `IMAGE_FAMILY`.
        - IMAGE: custom image.
        - IMAGE_FAMILY: image family.
    ...
    @base_image_type.setter
    def base_image_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "base_image_type", value)
...
class EcsImagePipeline(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            to_region_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EcsImagePipeline':
        """
    ...
    @property
    @pulumi.getter(name="addAccounts")
    def add_accounts(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The ID of Alibaba Cloud account to which to share the created image.
        """
        return pulumi.get(self, "add_accounts")
    ...
    @property
    @pulumi.getter(name="baseImageType")
    def base_image_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the source image. Valid values: `IMAGE`, `IMAGE_FAMILY`.
        - IMAGE: custom image.
        - IMAGE_FAMILY: image family.
    ...
    @property
    @pulumi.getter(name="buildContent")
    def build_content(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The content of the image template. The content cannot be greater than 16 KB in size, and can contain up to 127 commands.
        """
        return pulumi.get(self, "build_content")
    ...
    @property
    @pulumi.getter(name="deleteInstanceOnFailure")
    def delete_instance_on_failure(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to release the intermediate instance if the image cannot be created.
        """
        return pulumi.get(self, "delete_instance_on_failure")
    ...
    @property
    @pulumi.getter(name="toRegionIds")
    def to_region_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The ID of region to which to distribute the created image.
        """
        return pulumi.get(self, "to_region_ids")
