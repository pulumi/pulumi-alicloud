...
class ImageArgs:
    def __init__(__self__, *,
                 ...
                 detection_strategy: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] architecture: The system architecture of the system disk. If you specify a data disk snapshot to create the system disk of the custom image, you must use Architecture to specify the system architecture of the system disk. Valid values: `i386`, `x86\\_64`, `arm64`. Default value: `x86\\_64`.
        :param pulumi.Input[builtins.str] boot_mode: The new boot mode of the image. Valid values:
        ...
        :param pulumi.Input[builtins.bool] delete_auto_snapshot: Not the public attribute and it used to automatically delete dependence snapshots while deleting the image.
        :param pulumi.Input[builtins.str] description: The new description of the custom image. The description must be 2 to 256 characters in length It cannot start with `http://` or `https://`. This parameter is empty by default, which specifies that the original description is retained.
        :param pulumi.Input[builtins.str] detection_strategy: The mode in which to check the custom image. If you do not specify this parameter, the image is not checked. Only the standard check mode is supported.
        ...
        :param pulumi.Input[builtins.bool] force: Whether to perform forced deletion. Value range:
               ...
               Default value: false
        :param pulumi.Input[builtins.str] image_family: The name of the image family. The name must be 2 to 128 characters in length. It must start with a letter and cannot start with acs: or aliyun. It cannot contain http:// or https://. It can contain letters, digits, periods (.), colons (:), underscores (\\_), and hyphens (-). By default, this parameter is empty.
        :param pulumi.Input[builtins.str] image_name: The name of the custom image. The name must be 2 to 128 characters in length. It must start with a letter and cannot start with acs: or aliyun. It cannot contain http:// or https://. It can contain letters, digits, periods (.), colons (:), underscores (\\_), and hyphens (-). By default, this parameter is empty. In this case, the original name is retained.
        :param pulumi.Input[builtins.str] image_version: The image version.
        ...
        :param pulumi.Input[builtins.str] license_type: The type of the license that is used to activate the operating system after the image is imported. Set the value to BYOL. BYOL: The license that comes with the source operating system is used. When you use the BYOL license, make sure that your license key is supported by Alibaba Cloud.
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.227.0. New field 'image_name' instead.
        :param pulumi.Input[builtins.str] platform: The operating system distribution for the system disk in the custom image. If you specify a data disk snapshot to create the system disk of the custom image, use Platform to specify the operating system distribution for the system disk. Valid values: `Aliyun`, `Anolis`, `CentOS`, `Ubuntu`, `CoreOS`, `SUSE`, `Debian`, `OpenSUSE`, `FreeBSD`, `RedHat`, `Kylin`, `UOS`, `Fedora`, `Fedora CoreOS`, `CentOS Stream`, `AlmaLinux`, `Rocky Linux`, `Gentoo`, `Customized Linux`, `Others Linux`, `Windows Server 2022`, `Windows Server 2019`, `Windows Server 2016`, `Windows Server 2012`, `Windows Server 2008`, `Windows Server 2003`. Default value: `Others Linux`.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which to assign the custom image. If you do not specify this parameter, the image is assigned to the default resource group.
        ...
        :param pulumi.Input[builtins.str] snapshot_id: The ID of the snapshot that you want to use to create the custom image.
    ...
    def detection_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def detection_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] boot_mode: The new boot mode of the image. Valid values:
               ...
               *   UEFI-Preferred: BIOS and UEFI
               ...
               > **NOTE:**   For information about the UEFI-Preferred boot mode, see [Best practices for ECS instance boot modes](https://www.alibabacloud.com/help/en/doc-detail/2244655.html).
        :param pulumi.Input[builtins.str] create_time: The create time
        :param pulumi.Input[builtins.bool] delete_auto_snapshot: Not the public attribute and it used to automatically delete dependence snapshots while deleting the image.
        :param pulumi.Input[builtins.str] description: The new description of the custom image. The description must be 2 to 256 characters in length It cannot start with `http://` or `https://`. This parameter is empty by default, which specifies that the original description is retained.
        :param pulumi.Input[builtins.str] detection_strategy: The mode in which to check the custom image. If you do not specify this parameter, the image is not checked. Only the standard check mode is supported.
        ...
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which to assign the custom image. If you do not specify this parameter, the image is assigned to the default resource group.
               ...
               > **NOTE:**   If you call the CreateImage operation as a Resource Access Management (RAM) user who does not have the permissions to manage the default resource group and do not specify `ResourceGroupId`, the `Forbbiden: User not authorized to operate on the specified resource` error message is returned. You must specify the ID of a resource group that the RAM user has the permissions to manage or grant the RAM user the permissions to manage the default resource group before you call the CreateImage operation again.
        :param pulumi.Input[builtins.str] snapshot_id: The ID of the snapshot that you want to use to create the custom image.
        :param pulumi.Input[builtins.str] status: The status of the image. By default, if you do not specify this parameter, only images in the Available state are returned.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag
...
class Image(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            snapshot_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Image':
        """
    ...
    @property
    @pulumi.getter(name="detectionStrategy")
    def detection_strategy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The mode in which to check the custom image. If you do not specify this parameter, the image is not checked. Only the standard check mode is supported.
    ...
    @property
    @pulumi.getter(name="imageFamily")
    def image_family(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the image family. The name must be 2 to 128 characters in length. It must start with a letter and cannot start with acs: or aliyun. It cannot contain http:// or https://. It can contain letters, digits, periods (.), colons (:), underscores (\\_), and hyphens (-). By default, this parameter is empty.
        """
        return pulumi.get(self, "image_family")
    ...
    @property
    @pulumi.getter(name="imageVersion")
    def image_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The image version.
