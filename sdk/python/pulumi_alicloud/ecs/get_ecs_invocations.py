...
class GetEcsInvocationsResult:
    ...
    def invoke_status(self) -> Optional[_builtins.str]:
...
def get_ecs_invocations(command_id: Optional[_builtins.str] = None,
                        content_encoding: Optional[_builtins.str] = None,
                        ids: Optional[Sequence[_builtins.str]] = None,
                        invoke_status: Optional[_builtins.str] = None,
    ...
    :param _builtins.str command_id: The execution ID of the command.
    :param _builtins.str content_encoding: The encoding mode of the CommandContent and Output response parameters. Valid values: `PlainText`, `Base64`.
    :param Sequence[_builtins.str] ids: A list of Invocation IDs.
    :param _builtins.str invoke_status: The overall execution state of the command. The value of this parameter depends on the execution states on all the involved instances. Valid values: `Running`, `Finished`, `Failed`, `PartialFailed`, `Stopped`.
