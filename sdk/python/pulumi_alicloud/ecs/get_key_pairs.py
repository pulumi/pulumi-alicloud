...
def get_key_pairs(finger_print: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name_regex: A regex string to apply to the resulting key pairs.
...
def get_key_pairs_output(finger_print: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
