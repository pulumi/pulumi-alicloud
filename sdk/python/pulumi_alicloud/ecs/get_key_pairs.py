...
def get_key_pairs(finger_print: Optional[builtins.str] = None,
    ...
    :param builtins.str name_regex: A regex string to apply to the resulting key pairs.
...
def get_key_pairs_output(finger_print: Optional[pulumi.Input[Optional[builtins.str]]] = None,
