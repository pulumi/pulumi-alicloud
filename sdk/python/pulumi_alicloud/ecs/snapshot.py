...
class SnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] disk_id: The source disk ID.
        :param pulumi.Input[builtins.str] description: Description of the snapshot. This description can have a string of 2 to 256 characters, It cannot begin with http:// or https://. Default value is null.
        :param pulumi.Input[builtins.str] name: The name of the snapshot to be created. The name must be 2 to 128 characters in length. It must start with a letter and cannot start with http:// or https://. It can contain letters, digits, colons (:), underscores (_), and hyphens (-).
...
class Snapshot(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:ecs/snapshot:Snapshot"
    ...
    def get(resource_name: str,
            ...
            snapshot_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Snapshot':
        """
