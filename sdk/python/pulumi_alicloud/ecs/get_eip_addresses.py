...
class GetEipAddressesResult:
    ...
    def address_name(self) -> Optional[builtins.str]:
    ...
    def associated_instance_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "associated_instance_id")

    @property
    @pulumi.getter(name="associatedInstanceType")
    def associated_instance_type(self) -> Optional[builtins.str]:
    ...
    def include_reservation_data(self) -> Optional[builtins.bool]:
    ...
    def segment_instance_id(self) -> Optional[builtins.str]:
...
def get_eip_addresses(address_name: Optional[builtins.str] = None,
                      associated_instance_id: Optional[builtins.str] = None,
                      associated_instance_type: Optional[builtins.str] = None,
                      dry_run: Optional[builtins.bool] = None,
                      enable_details: Optional[builtins.bool] = None,
                      ids: Optional[Sequence[builtins.str]] = None,
                      include_reservation_data: Optional[builtins.bool] = None,
                      ...
                      segment_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str address_name: The eip name.
    :param builtins.str associated_instance_id: The associated instance id.
    :param builtins.str associated_instance_type: The associated instance type.
    :param builtins.bool dry_run: The dry run.
    :param builtins.bool enable_details: Default to `true`. Set it to `false` can hide the `tags` to output.
    :param Sequence[builtins.str] ids: A list of Address IDs.
    :param builtins.bool include_reservation_data: The include reservation data. Valid values: `BGP` and `BGP_PRO`.
    :param builtins.str ip_address: The eip address.
    :param builtins.str isp: The Internet service provider (ISP). Valid values `BGP` and `BGP_PRO`.
    :param builtins.str lock_reason: The lock reason.
    :param builtins.str name_regex: A regex string to filter results by Address name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str payment_type: The billing method of the EIP. Valid values: `Subscription` and `PayAsYouGo`.
    :param builtins.str resource_group_id: The ID of the resource group.
    :param builtins.str segment_instance_id: The IDs of the contiguous EIPs.  This value is returned only when contiguous EIPs are specified.
...
def get_eip_addresses_output(address_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             associated_instance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             associated_instance_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ...
                             include_reservation_data: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                             ip_address: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ip_addresses: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             isp: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             lock_reason: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ...
                             segment_instance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
