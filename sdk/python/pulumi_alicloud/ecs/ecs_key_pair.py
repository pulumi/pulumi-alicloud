...
class EcsKeyPairArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_file: The key file.
        :param pulumi.Input[builtins.str] key_pair_name: The name of the key pair. The name must be 2 to 128 characters in length. The name must start with a letter and cannot start with http:// or https://. The name can contain letters, digits, colons (:), underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] public_key: The public key of the key pair.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which to add the key pair.
    ...
    def key_name_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "key_name_prefix")

    @key_name_prefix.setter
    def key_name_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EcsKeyPairState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: (Available since v1.237.0) The time when the key pair was created.
        :param pulumi.Input[builtins.str] finger_print: The fingerprint of the key pair.
        :param pulumi.Input[builtins.str] key_file: The key file.
        :param pulumi.Input[builtins.str] key_pair_name: The name of the key pair. The name must be 2 to 128 characters in length. The name must start with a letter and cannot start with http:// or https://. The name can contain letters, digits, colons (:), underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] public_key: The public key of the key pair.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which to add the key pair.
...
class EcsKeyPair(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            public_key: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'EcsKeyPair':
        """
    ...
    @property
    @pulumi.getter(name="keyNamePrefix")
    def key_name_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "key_name_prefix")
