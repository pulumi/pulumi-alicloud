...
class GetEcsKeyPairsResult:
    ...
    def finger_print(self) -> Optional[_builtins.str]:
        """
...
def get_ecs_key_pairs(finger_print: Optional[_builtins.str] = None,
    ...
    :param _builtins.str finger_print: The fingerprint of the key pair.
    :param Sequence[_builtins.str] ids: A list of Key Pair IDs.
