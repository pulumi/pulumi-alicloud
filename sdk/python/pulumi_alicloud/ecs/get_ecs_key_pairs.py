...
def get_ecs_key_pairs(finger_print: Optional[builtins.str] = None,
...
def get_ecs_key_pairs_output(finger_print: Optional[pulumi.Input[Optional[builtins.str]]] = None,
