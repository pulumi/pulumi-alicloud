...
class GetElasticityAssurancesResult:
    ...
    def private_pool_options_ids(self) -> Optional[Sequence[builtins.str]]:
...
def get_elasticity_assurances(ids: Optional[Sequence[builtins.str]] = None,
                              output_file: Optional[builtins.str] = None,
                              private_pool_options_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Elasticity Assurance IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param Sequence[builtins.str] private_pool_options_ids: The ID of the elastic protection service.
...
def get_elasticity_assurances_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                     output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     private_pool_options_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
