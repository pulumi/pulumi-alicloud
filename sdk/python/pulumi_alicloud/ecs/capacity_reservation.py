...
class CapacityReservationArgs:
    def __init__(__self__, *,
                 ...
                 end_time_type: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] end_time: end time of the capacity reservation. the capacity reservation will be  released at the end time automatically if set. otherwise it will last until manually released
        :param pulumi.Input[_builtins.str] end_time_type: Release mode of capacity reservation service. Value range:Limited: release at specified time. The EndTime parameter must be specified at the same time.Unlimited: manual release. No time limit.
        :param pulumi.Input[_builtins.str] match_criteria: The type of private resource pool generated after the capacity reservation service takes effect. Value range:Open: Open mode.Target: dedicated mode.Default value: Open
        :param pulumi.Input[_builtins.str] platform: platform of the capacity reservation, value range `windows`, `linux`.
    ...
    def end_time_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def end_time_type(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _CapacityReservationState:
    def __init__(__self__, *,
                 ...
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 time_slot: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] platform: platform of the capacity reservation, value range `windows`, `linux`.
        :param pulumi.Input[_builtins.str] resource_group_id: The resource group id.
        :param pulumi.Input[_builtins.str] start_time: time of the capacity reservation which become active.
        :param pulumi.Input[_builtins.str] start_time_type: The capacity is scheduled to take effect. Possible values:-Now: Effective immediately.-Later: the specified time takes effect.
        :param pulumi.Input[_builtins.str] status: The status of the capacity reservation.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: The tag of the resource.
        :param pulumi.Input[_builtins.str] time_slot: This parameter is under test and is not yet open for use.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] zone_ids: The ID of the zone in the region to which the capacity reservation service belongs. Currently, it is only supported to create a capacity reservation service in one zone.
        """
        if capacity_reservation_name is not None:
            pulumi.set(__self__, "capacity_reservation_name", capacity_reservation_name)
    ...
    def time_slot(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @time_slot.setter
    def time_slot(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class CapacityReservation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_slot: pulumi.Input[Optional[_builtins.str]] = None,
            zone_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'CapacityReservation':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="capacityReservationName")
    def capacity_reservation_name(self) -> pulumi.Output[_builtins.str]:
        """
        Capacity reservation service name.
        """
        return pulumi.get(self, "capacity_reservation_name")
    ...
    @_builtins.property
    @pulumi.getter(name="endTimeType")
    def end_time_type(self) -> pulumi.Output[_builtins.str]:
        """
        Release mode of capacity reservation service. Value range:Limited: release at specified time. The EndTime parameter must be specified at the same time.Unlimited: manual release. No time limit.
        """
        return pulumi.get(self, "end_time_type")
    ...
    @_builtins.property
    @pulumi.getter(name="timeSlot")
    def time_slot(self) -> pulumi.Output[_builtins.str]:
        """
        This parameter is under test and is not yet open for use.
        """
        return pulumi.get(self, "time_slot")
