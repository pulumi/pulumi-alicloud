...
def get_security_group_rules(direction: Optional[builtins.str] = None,
    ...
    :param builtins.str group_id: The ID of the security group that owns the rules.
...
def get_security_group_rules_output(direction: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    group_id: Optional[pulumi.Input[builtins.str]] = None,
                                    ip_protocol: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    nic_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
