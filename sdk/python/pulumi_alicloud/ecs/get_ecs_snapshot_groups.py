...
class GetEcsSnapshotGroupsResult:
    ...
    def snapshot_group_name(self) -> Optional[builtins.str]:
...
def get_ecs_snapshot_groups(ids: Optional[Sequence[builtins.str]] = None,
                            instance_id: Optional[builtins.str] = None,
                            name_regex: Optional[builtins.str] = None,
                            output_file: Optional[builtins.str] = None,
                            snapshot_group_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Snapshot Group IDs.
    :param builtins.str instance_id: The ID of the instance.
    :param builtins.str name_regex: A regex string to filter results by Snapshot Group name.
    ...
    :param builtins.str status: The state of snapshot-consistent group. Valid Values: `accomplished`, `failed` and `progressing`.
    :param Mapping[str, builtins.str] tags: A mapping of tags to assign to the snapshot group.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_ecs_snapshot_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                   ...
                                   snapshot_group_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
