...
def get_eips(address_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of EIP IDs.
    :param builtins.str ip_address: Public IP Address of the the EIP.
    :param Sequence[builtins.str] ip_addresses: A list of EIP public IP addresses.
...
def get_eips_output(address_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
