...
class EipAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance with which you want to associate the EIP. You can enter the ID of a NAT gateway, CLB instance, ECS instance, secondary ENI, HAVIP, or IP address.
        :param pulumi.Input[builtins.bool] force: Specifies whether to disassociate the EIP from a NAT gateway if a DNAT or SNAT entry is added to the NAT gateway. Valid values:
        :param pulumi.Input[builtins.str] instance_type: The type of the instance with which you want to associate the EIP. Valid values:
               - `Nat`: NAT gateway
        ...
        :param pulumi.Input[builtins.str] private_ip_address: The IP address in the CIDR block of the vSwitch.
        ...
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC in which an IPv4 gateway is created. The VPC and the EIP must be in the same region.
...
class EipAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            mode: Optional[pulumi.Input[builtins.str]] = None,
            private_ip_address: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EipAssociation':
        """
