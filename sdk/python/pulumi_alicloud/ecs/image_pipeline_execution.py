...
class ImagePipelineExecutionArgs:
    def __init__(__self__, *,
                 image_pipeline_id: pulumi.Input[builtins.str],
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ImagePipelineExecution resource.
        :param pulumi.Input[builtins.str] image_pipeline_id: The ID of the image template.
        :param pulumi.Input[builtins.str] status: The status of the image build task. Valid values:
    ...
    def image_pipeline_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def image_pipeline_id(self, value: pulumi.Input[builtins.str]):
...
class _ImagePipelineExecutionState:
    def __init__(__self__, *,
                 ...
                 image_pipeline_id: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering ImagePipelineExecution resources.
        :param pulumi.Input[builtins.str] create_time: The time when the image build task was created.
        :param pulumi.Input[builtins.str] image_pipeline_id: The ID of the image template.
        :param pulumi.Input[builtins.str] status: The status of the image build task. Valid values:
               - CANCELLED: canceled. The build process has been canceled.
        """
    ...
    @property
    @pulumi.getter(name="imagePipelineId")
    def image_pipeline_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the image template.
        """
        return pulumi.get(self, "image_pipeline_id")
    ...
    @image_pipeline_id.setter
    def image_pipeline_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "image_pipeline_id", value)
...
class ImagePipelineExecution(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            create_time: Optional[pulumi.Input[builtins.str]] = None,
            image_pipeline_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ImagePipelineExecution':
        """
    ...
    @property
    @pulumi.getter(name="imagePipelineId")
    def image_pipeline_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the image template.
        """
        return pulumi.get(self, "image_pipeline_id")
