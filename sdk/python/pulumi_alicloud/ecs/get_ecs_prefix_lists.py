...
def get_ecs_prefix_lists(address_family: Optional[builtins.str] = None,
    ...
    :param builtins.str address_family: The address family of the prefix list. Valid values: `IPv4`,`IPv6`. This parameter is empty by default, which indicates that all prefix lists are to be queried.
    :param Sequence[builtins.str] ids: A list of Prefix List IDs.
    :param builtins.str name_regex: A regex string to filter results by `prefix_list_name`.
...
def get_ecs_prefix_lists_output(address_family: Optional[pulumi.Input[Optional[builtins.str]]] = None,
