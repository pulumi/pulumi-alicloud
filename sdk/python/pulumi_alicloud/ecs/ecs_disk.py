...
class EcsDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: Field `availability_zone` has been deprecated from provider version 1.122.0. New field `zone_id` instead.
        :param pulumi.Input[builtins.bool] bursting_enabled: Specifies whether to enable the performance burst feature. Valid values: `true`, `false`. **NOTE:** `bursting_enabled` is only valid when `category` is `cloud_auto`.
        :param pulumi.Input[builtins.str] category: The category of the data disk. Default value: `cloud_efficiency`. Valid Values: `cloud`, `cloud_efficiency`, `cloud_ssd`, `cloud_essd`, `cloud_auto`, `cloud_essd_entry`, `elastic_ephemeral_disk_standard`, `elastic_ephemeral_disk_premium`.
        :param pulumi.Input[builtins.bool] delete_auto_snapshot: Specifies whether to delete the automatic snapshots of the disk when the disk is released. Default value: `false`.
        :param pulumi.Input[builtins.bool] delete_with_instance: Specifies whether to release the disk along with its associated instance. Default value: `false`.
        :param pulumi.Input[builtins.str] description: The description of the disk. The description must be 2 to 256 characters in length and cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] disk_name: The name of the data disk. The name must be 2 to 128 characters in length and can contain letters, digits, colons (:), underscores (_), periods (.), and hyphens (-). The name must start with a letter.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to check the validity of the request without actually making the request.request Default value: `false`. Valid values:
        :param pulumi.Input[builtins.bool] enable_auto_snapshot: Specifies whether to enable the automatic snapshot policy feature for the cloud disk. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.bool] encrypted: Specifies whether to encrypt the disk. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance to which the created subscription disk is automatically attached.
        ...
        :param pulumi.Input[builtins.str] kms_key_id: The ID of the Key Management Service (KMS) key that is used for the disk. **NOTE:** `kms_key_id` is only valid when `encrypted` is `true`.
        :param pulumi.Input[builtins.str] multi_attach: Specifies whether to enable the multi-attach feature for the disk. Default value: `Disabled`. Valid values: `Enabled`, `Disabled`. **NOTE:** Currently, `multi_attach` can only be set to `Enabled` when `category` is set to `cloud_essd`.
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.122.0. New field `disk_name` instead.
               
               > **NOTE:** Disk category `cloud` has been outdated, and it only can be used none I/O Optimized ECS instances. Recommend `cloud_efficiency` and `cloud_ssd` disk.
        :param pulumi.Input[builtins.str] payment_type: The payment type of the disk. Default to `PayAsYouGo`. Valid values: `PayAsYouGo`, `Subscription`. If you want to change the disk payment type, the `instance_id` is required.
        :param pulumi.Input[builtins.str] performance_level: Specifies the performance level of an ESSD when you create the ESSD. Valid values:
               - `PL0`: A single ESSD delivers up to 10,000 random read/write IOPS.
               - `PL1`: A single ESSD delivers up to 50,000 random read/write IOPS.
               - `PL2`: A single ESSD delivers up to 100,000 random read/write IOPS.
               - `PL3`: A single ESSD delivers up to 1,000,000 random read/write IOPS.
        :param pulumi.Input[builtins.int] provisioned_iops: The provisioned read/write IOPS of the ESSD AutoPL disk. Valid values: 0 to min{50,000, 1,000 × Capacity - Baseline IOPS}. **NOTE:** `provisioned_iops` is only valid when `category` is `cloud_auto`.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which to add the disk.
        :param pulumi.Input[builtins.int] size: The size of the disk. Unit: GiB. This parameter is required. Valid values:
        ...
        :param pulumi.Input[builtins.str] snapshot_id: The ID of the snapshot to use to create the disk. **NOTE:** If the size of the snapshot specified by `snapshot_id` is larger than the value of `size`, the size of the created disk is equal to the specified snapshot size. If the size of the snapshot specified by `snapshot_id` is smaller than the value of `size`, the size of the created disk is equal to the value of `size`.
        :param pulumi.Input[builtins.str] storage_set_id: The ID of the storage set.
        :param pulumi.Input[builtins.int] storage_set_partition_number: The number of partitions in the storage set.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] type: The type to expand cloud disks. Valid Values: `online`, `offline`. Default to `offline`.
        :param pulumi.Input[builtins.str] zone_id: ID of the free zone to which the disk belongs. One of the `zone_id` and `instance_id` must be set but can not be set at the same time.
        """
...
class _EcsDiskState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] bursting_enabled: Specifies whether to enable the performance burst feature. Valid values: `true`, `false`. **NOTE:** `bursting_enabled` is only valid when `category` is `cloud_auto`.
        :param pulumi.Input[builtins.str] category: The category of the data disk. Default value: `cloud_efficiency`. Valid Values: `cloud`, `cloud_efficiency`, `cloud_ssd`, `cloud_essd`, `cloud_auto`, `cloud_essd_entry`, `elastic_ephemeral_disk_standard`, `elastic_ephemeral_disk_premium`.
        :param pulumi.Input[builtins.str] create_time: (Available since v1.237.0) The time when the disk was created.
        :param pulumi.Input[builtins.bool] delete_auto_snapshot: Specifies whether to delete the automatic snapshots of the disk when the disk is released. Default value: `false`.
        :param pulumi.Input[builtins.bool] delete_with_instance: Specifies whether to release the disk along with its associated instance. Default value: `false`.
        :param pulumi.Input[builtins.str] description: The description of the disk. The description must be 2 to 256 characters in length and cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] disk_name: The name of the data disk. The name must be 2 to 128 characters in length and can contain letters, digits, colons (:), underscores (_), periods (.), and hyphens (-). The name must start with a letter.
        ...
        :param pulumi.Input[builtins.str] performance_level: Specifies the performance level of an ESSD when you create the ESSD. Valid values:
               ...
               - `PL3`: A single ESSD delivers up to 1,000,000 random read/write IOPS.
        :param pulumi.Input[builtins.int] provisioned_iops: The provisioned read/write IOPS of the ESSD AutoPL disk. Valid values: 0 to min{50,000, 1,000 × Capacity - Baseline IOPS}. **NOTE:** `provisioned_iops` is only valid when `category` is `cloud_auto`.
        :param pulumi.Input[builtins.str] region_id: (Available since v1.237.0) The ID of the region to which the disk belongs.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which to add the disk.
        :param pulumi.Input[builtins.int] size: The size of the disk. Unit: GiB. This parameter is required. Valid values:
               - If `category` is set to `cloud`. Valid values: `5` to `2000`.
               - If `category` is set to `cloud_efficiency`. Valid values: `20` to `32768`.
...
class EcsDisk(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EcsDisk':
        """
