...
class KeyPairArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_file: The name of file to save your new key pair's private key. Strongly suggest you to specified it when you creating key pair, otherwise, you wouldn't get its private key ever.
        :param pulumi.Input[builtins.str] key_name: The key pair's name. It is the only in one Alicloud account.
        :param pulumi.Input[builtins.str] public_key: You can import an existing public key and using Alicloud key pair to manage it. If this parameter is specified, `resource_group_id` is the key pair belongs.
        :param pulumi.Input[builtins.str] resource_group_id: The Id of resource group which the key pair belongs.
        """
...
class KeyPair(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:ecs/keyPair:KeyPair"
    ...
    def get(resource_name: str,
            ...
            public_key: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'KeyPair':
        """
