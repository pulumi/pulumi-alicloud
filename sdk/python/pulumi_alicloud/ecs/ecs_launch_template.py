...
class EcsLaunchTemplateArgs:
    def __init__(__self__, *,
                 ...
                 data_disks: pulumi.Input[Optional[Sequence[pulumi.Input['EcsLaunchTemplateDataDiskArgs']]]] = None,
                 ...
                 image_options: pulumi.Input[Optional['EcsLaunchTemplateImageOptionsArgs']] = None,
                 ...
                 network_interfaces: pulumi.Input[Optional['EcsLaunchTemplateNetworkInterfacesArgs']] = None,
                 ...
                 system_disk: pulumi.Input[Optional['EcsLaunchTemplateSystemDiskArgs']] = None,
        ...
        :param pulumi.Input[_builtins.bool] enable_vm_os_config: Whether to enable the instance operating system configuration.
        ...
        :param pulumi.Input[_builtins.str] internet_charge_type: Internet bandwidth billing method. Valid values: `PayByTraffic`, `PayByBandwidth`.
        ...
        :param pulumi.Input[_builtins.str] io_optimized: Whether it is an I/O-optimized instance or not. Valid values: `none`, `optimized`.
        ...
        :param pulumi.Input[_builtins.str] period_unit: The unit of the subscription period. Default value: `Month`. Valid values: `Week`, `Month`.
        :param pulumi.Input[_builtins.str] private_ip_address: The private IP address of the instance.
        ...
        :param pulumi.Input[_builtins.str] resource_group_id: The ID of the resource group to which to assign the instance, Elastic Block Storage (EBS) device, and ENI.
        :param pulumi.Input[_builtins.str] security_enhancement_strategy: Whether or not to activate the security enhancement feature and install network security software free of charge. Valid values: `Active`, `Deactive`.
        :param pulumi.Input[_builtins.str] security_group_id: The security group ID.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: The ID of security group N to which to assign the instance.
        ...
        :param pulumi.Input[_builtins.int] system_disk_size: It has been deprecated from version 1.120.0, and use field `system_disk` instead.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags to assign to instance, block storage, and elastic network.
               - Key: It can be up to 64 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It cannot be a null string.
               - Value: It can be up to 128 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It can be a null string.
        :param pulumi.Input[_builtins.str] template_resource_group_id: The template resource group id.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] template_tags: A mapping of tags to assign to the launch template.
        :param pulumi.Input[_builtins.bool] update_default_version_number: Whether to update the default version of the launch template to the latest version automatically. It is conflict with `default_version_number`.
        :param pulumi.Input[_builtins.str] user_data: The User Data.
        :param pulumi.Input[_builtins.str] userdata: It has been deprecated from version 1.120.0, and use field `user_data` instead.
        :param pulumi.Input[_builtins.str] version_description: The description of the launch template version. The description must be 2 to 256 characters in length and cannot start with http:// or https://.
    ...
    def data_disks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['EcsLaunchTemplateDataDiskArgs']]]]:
        """
    ...
    @data_disks.setter
    def data_disks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['EcsLaunchTemplateDataDiskArgs']]]]):
    ...
    def image_options(self) -> pulumi.Input[Optional['EcsLaunchTemplateImageOptionsArgs']]:
        """
    ...
    def image_options(self, value: pulumi.Input[Optional['EcsLaunchTemplateImageOptionsArgs']]):
    ...
    def network_interfaces(self) -> pulumi.Input[Optional['EcsLaunchTemplateNetworkInterfacesArgs']]:
        """
    ...
    def network_interfaces(self, value: pulumi.Input[Optional['EcsLaunchTemplateNetworkInterfacesArgs']]):
    ...
    def system_disk(self) -> pulumi.Input[Optional['EcsLaunchTemplateSystemDiskArgs']]:
        """
    ...
    @system_disk.setter
    def system_disk(self, value: pulumi.Input[Optional['EcsLaunchTemplateSystemDiskArgs']]):
...
class EcsLaunchTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpc_id: pulumi.Input[Optional[_builtins.str]] = None,
            vswitch_id: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'EcsLaunchTemplate':
        """
