...
class EcsLaunchTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] auto_renew: Specifies whether to enable auto-renewal for the instance. This parameter is valid only if `internet_charge_type` is set to `PrePaid`.
        :param pulumi.Input[builtins.int] auto_renew_period: The auto-renewal period of the instance. Valid values when `period_unit` is set to `Month`: 1, 2, 3, 6, 12, 24, 36, 48, and 60. Default value: 1.
        ...
        :param pulumi.Input[builtins.int] default_version_number: The version number of the default launch template version. Default to 1. It is conflict with `update_default_version_number`.
        :param pulumi.Input[builtins.str] deployment_set_id: The Deployment Set Id.
        ...
        :param pulumi.Input[builtins.bool] enable_vm_os_config: Whether to enable the instance operating system configuration.
        ...
        :param pulumi.Input[builtins.str] http_endpoint: Whether to enable access to instance metadata. Valid values:
               - enabled: Enabled.
               - disabled: Disabled.
        :param pulumi.Input[builtins.int] http_put_response_hop_limit: The HTTP PUT response hop limit required for instance metadata requests.
        :param pulumi.Input[builtins.str] http_tokens: Whether to use the hardened mode (IMDSv2) when accessing instance metadata. Valid values:
        ...
        :param pulumi.Input[builtins.str] internet_charge_type: Internet bandwidth billing method. Valid values: `PayByTraffic`, `PayByBandwidth`.
        ...
        :param pulumi.Input[builtins.str] io_optimized: Whether it is an I/O-optimized instance or not. Valid values: `none`, `optimized`.
        :param pulumi.Input[builtins.str] key_pair_name: The name of the key pair.
               - Ignore this parameter for Windows instances. It is null by default. Even if you enter this parameter, only the  Password content is used.
               - The password logon method for Linux instances is set to forbidden upon initialization.
        :param pulumi.Input[builtins.str] launch_template_name: The name of Launch Template.
        :param pulumi.Input[builtins.str] name: It has been deprecated from version 1.120.0, and use field `launch_template_name` instead.
        ...
        :param pulumi.Input[builtins.str] network_type: Network type of the instance. Valid values: `classic`, `vpc`.
        :param pulumi.Input[builtins.bool] password_inherit: Whether to use the password preset by the mirror.
        :param pulumi.Input[builtins.int] period: The subscription period of the instance. Unit: months. This parameter takes effect and is required only when InstanceChargeType is set to PrePaid. If the DedicatedHostId parameter is specified, the value of the Period parameter must be within the subscription period of the dedicated host.
        ...
        :param pulumi.Input[builtins.str] period_unit: The unit of the subscription period. Default value: `Month`. Valid values: `Week`, `Month`.
        ...
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which to assign the instance, Elastic Block Storage (EBS) device, and ENI.
        :param pulumi.Input[builtins.str] security_enhancement_strategy: Whether or not to activate the security enhancement feature and install network security software free of charge. Valid values: `Active`, `Deactive`.
        :param pulumi.Input[builtins.str] security_group_id: The security group ID.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The ID of security group N to which to assign the instance.
        :param pulumi.Input[builtins.str] spot_duration: The protection period of the preemptible instance. Unit: hours. Valid values: `0`, `1`, `2`, `3`, `4`, `5`, and `6`. Default to: `1`.
        ...
        :param pulumi.Input[builtins.str] spot_strategy: The spot strategy for a Pay-As-You-Go instance. This parameter is valid and required only when InstanceChargeType is set to PostPaid. Valid values: `NoSpot`, `SpotAsPriceGo`, `SpotWithPriceLimit`.
        :param pulumi.Input['EcsLaunchTemplateSystemDiskArgs'] system_disk: The System Disk. See `system_disk` below.
        :param pulumi.Input[builtins.str] system_disk_category: It has been deprecated from version 1.120.0, and use field `system_disk` instead.
        :param pulumi.Input[builtins.str] system_disk_description: It has been deprecated from version 1.120.0, and use field `system_disk` instead.
        :param pulumi.Input[builtins.str] system_disk_name: It has been deprecated from version 1.120.0, and use field `system_disk` instead.
        :param pulumi.Input[builtins.int] system_disk_size: It has been deprecated from version 1.120.0, and use field `system_disk` instead.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to instance, block storage, and elastic network.
               - Key: It can be up to 64 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It cannot be a null string.
               - Value: It can be up to 128 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It can be a null string.
        :param pulumi.Input[builtins.str] template_resource_group_id: The template resource group id.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] template_tags: A mapping of tags to assign to the launch template.
        :param pulumi.Input[builtins.bool] update_default_version_number: Whether to update the default version of the launch template to the latest version automatically. It is conflict with `default_version_number`.
        :param pulumi.Input[builtins.str] user_data: The User Data.
        :param pulumi.Input[builtins.str] userdata: It has been deprecated from version 1.120.0, and use field `user_data` instead.
        :param pulumi.Input[builtins.str] version_description: The description of the launch template version. The description must be 2 to 256 characters in length and cannot start with http:// or https://.
...
class _EcsLaunchTemplateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_pair_name: The name of the key pair.
               - Ignore this parameter for Windows instances. It is null by default. Even if you enter this parameter, only the  Password content is used.
               - The password logon method for Linux instances is set to forbidden upon initialization.
        :param pulumi.Input[builtins.int] latest_version_number: The latest version number of the launch template.
        :param pulumi.Input[builtins.str] launch_template_name: The name of Launch Template.
        :param pulumi.Input[builtins.str] name: It has been deprecated from version 1.120.0, and use field `launch_template_name` instead.
        :param pulumi.Input['EcsLaunchTemplateNetworkInterfacesArgs'] network_interfaces: The list of network interfaces created with instance. See `network_interfaces` below.
        :param pulumi.Input[builtins.str] network_type: Network type of the instance. Valid values: `classic`, `vpc`.
...
@pulumi.type_token("alicloud:ecs/ecsLaunchTemplate:EcsLaunchTemplate")
class EcsLaunchTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EcsLaunchTemplate':
        """
