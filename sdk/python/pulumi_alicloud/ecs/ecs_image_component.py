...
class EcsImageComponentArgs:
    def __init__(__self__, *,
                 ...
                 image_component_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] content: Component content. Consists of multiple commands. The maximum number of commands cannot exceed 127. Details of supported commands and command formats,
        :param pulumi.Input[builtins.str] component_type: The component type. Supports mirrored build components and test components.
        ...
        :param pulumi.Input[builtins.str] component_version: The component version number, which is used in conjunction with the component name, is in the format of major.minor.patch and is a non-negative integer.
               
               Default value:(x +1).0.0, where x is the maximum major version of the current component.
        :param pulumi.Input[builtins.str] description: Description information. It must be 2 to 256 characters in length and cannot start with http:// or https.
        :param pulumi.Input[builtins.str] image_component_name: The component name. It must be 2 to 128 characters in length and start with an uppercase letter or a Chinese character. It cannot start with http:// or https. Can contain Chinese, English, numbers, half-length colons (:), underscores (_), half-length periods (.), or dashes (-).
               
               > **NOTE:**  When 'Name' is not set, the 'ImageComponentId' return value is used by default.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the enterprise resource group to which the created image component belongs.
        :param pulumi.Input[builtins.str] system_type: The operating system supported by the component.
               ...
               Default value: Linux.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: List of label key-value pairs.
        """
    ...
    def image_component_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def image_component_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EcsImageComponentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] component_version: The component version number, which is used in conjunction with the component name, is in the format of major.minor.patch and is a non-negative integer.
               ...
               Default value:(x +1).0.0, where x is the maximum major version of the current component.
        :param pulumi.Input[builtins.str] content: Component content. Consists of multiple commands. The maximum number of commands cannot exceed 127. Details of supported commands and command formats,
        :param pulumi.Input[builtins.str] create_time: Component creation time.
        :param pulumi.Input[builtins.str] description: Description information. It must be 2 to 256 characters in length and cannot start with http:// or https.
        :param pulumi.Input[builtins.str] image_component_name: The component name. It must be 2 to 128 characters in length and start with an uppercase letter or a Chinese character. It cannot start with http:// or https. Can contain Chinese, English, numbers, half-length colons (:), underscores (_), half-length periods (.), or dashes (-).
...
class EcsImageComponent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            system_type: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'EcsImageComponent':
        """
    ...
    @property
    @pulumi.getter(name="componentType")
    def component_type(self) -> pulumi.Output[builtins.str]:
        """
        The component type. Supports mirrored build components and test components.
    ...
    @property
    @pulumi.getter(name="imageComponentName")
    def image_component_name(self) -> pulumi.Output[builtins.str]:
        """
        The component name. It must be 2 to 128 characters in length and start with an uppercase letter or a Chinese character. It cannot start with http:// or https. Can contain Chinese, English, numbers, half-length colons (:), underscores (_), half-length periods (.), or dashes (-).
