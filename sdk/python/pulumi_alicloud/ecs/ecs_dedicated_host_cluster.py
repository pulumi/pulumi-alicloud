...
class EcsDedicatedHostClusterArgs:
    def __init__(__self__, *,
                 ...
                 dedicated_host_cluster_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] zone_id: The ID of the zone in which to create the dedicated host cluster.
        :param pulumi.Input[builtins.str] dedicated_host_cluster_name: The name of the dedicated host cluster. The name must be `2` to `128` characters in length and can contain letters, digits, periods (.), underscores (_), and hyphens (-). It must start with a letter. It cannot contain `http://` or `https://`.
        :param pulumi.Input[builtins.str] description: The description of the dedicated host cluster. The description must be `2` to `256` characters in length. It cannot start with `http://` or `https://`.
    ...
    def dedicated_host_cluster_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dedicated_host_cluster_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EcsDedicatedHostCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            dry_run: Optional[pulumi.Input[builtins.bool]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EcsDedicatedHostCluster':
        """
    ...
    @property
    @pulumi.getter(name="dedicatedHostClusterName")
    def dedicated_host_cluster_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the dedicated host cluster. The name must be `2` to `128` characters in length and can contain letters, digits, periods (.), underscores (_), and hyphens (-). It must start with a letter. It cannot contain `http://` or `https://`.
        """
        return pulumi.get(self, "dedicated_host_cluster_name")
