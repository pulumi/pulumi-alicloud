...
def get_security_groups(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Security Group IDs.
    :param builtins.str name_regex: A regex string to filter the resulting security groups by their names.
...
def get_security_groups_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
