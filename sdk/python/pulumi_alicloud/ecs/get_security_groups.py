...
def get_security_groups(enable_details: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str name_regex: A regex string to filter the resulting security groups by their names.
...
def get_security_groups_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
