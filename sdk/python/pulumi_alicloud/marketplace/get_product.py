...
class GetProductResult:
    ...
    def available_region(self) -> Optional[builtins.str]:
...
def get_product(available_region: Optional[builtins.str] = None,
    ...
    :param builtins.str available_region: A available region id used to filter market place Ecs images.
    :param builtins.str product_code: The product code of the market product.
    """
    __args__ = dict()
...
def get_product_output(available_region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
