...
class GetProductResult:
    ...
    def available_region(self) -> Optional[_builtins.str]:
...
def get_product(available_region: Optional[_builtins.str] = None,
    ...
    :param _builtins.str available_region: A available region id used to filter market place Ecs images.
    :param _builtins.str product_code: The product code of the market product.
    """
    __args__ = dict()
...
def get_product_output(available_region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
