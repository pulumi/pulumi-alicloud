...
class GetProductsResult:
    ...
    def search_term(self) -> Optional[builtins.str]:
    ...
    def suggested_price(self) -> Optional[builtins.float]:
        """
    ...
    def supplier_id(self) -> Optional[builtins.str]:
        """
    ...
    def supplier_name_keyword(self) -> Optional[builtins.str]:
...
def get_products(category_id: Optional[builtins.str] = None,
                 ...
                 search_term: Optional[builtins.str] = None,
                 sort: Optional[builtins.str] = None,
                 suggested_price: Optional[builtins.float] = None,
                 supplier_id: Optional[builtins.str] = None,
                 supplier_name_keyword: Optional[builtins.str] = None,
    ...
    :param builtins.str category_id: The Category ID of products.
    :param Sequence[builtins.str] ids: A list of product code.
    :param builtins.str name_regex: A regex string to apply to the product name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str product_type: The type of products, Valid values: `APP`, `SERVICE`, `MIRROR`, `DOWNLOAD` and `API_SERVICE`.
    :param builtins.str search_term: Search term in this query.
    :param builtins.str sort: This field determines how to sort the filtered results, Valid values: `user_count-desc`, `created_on-desc`, `price-desc` and `score-desc`.
    :param builtins.float suggested_price: The suggested price of the product.
    :param builtins.str supplier_id: The supplier id of the product.
    :param builtins.str supplier_name_keyword: The supplier name keyword of the product.
    """
    __args__ = dict()
...
def get_products_output(category_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        ...
                        search_term: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        sort: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        suggested_price: Optional[pulumi.Input[Optional[builtins.float]]] = None,
                        supplier_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        supplier_name_keyword: Optional[pulumi.Input[Optional[builtins.str]]] = None,
