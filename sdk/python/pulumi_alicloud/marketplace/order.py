...
class OrderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] pay_type: Valid values are `PrePaid`, `PostPaid`,System default to `PostPaid`.
        :param pulumi.Input[_builtins.int] quantity: The quantity of the market product will be purchased.
        """
    ...
    def pricing_cycle(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def pricing_cycle(self, value: pulumi.Input[_builtins.str]):
...
class Order(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def components(self) -> pulumi.Output[Optional[Mapping[str, _builtins.str]]]:
        """
        Service providers customize additional components.
        """
        return pulumi.get(self, "components")
    ...
    @_builtins.property
    @pulumi.getter(name="couponId")
    def coupon_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The coupon id of the market product.
        """
        return pulumi.get(self, "coupon_id")
    ...
    @_builtins.property
    @pulumi.getter(name="pricingCycle")
    def pricing_cycle(self) -> pulumi.Output[_builtins.str]:
        """
        The purchase cycle of the product, valid values are `Day`, `Month` and `Year`.
        """
        return pulumi.get(self, "pricing_cycle")
