...
def get_open_api_pricing_modules(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str name_regex: A regex string to filter results by Property name.
...
def get_open_api_pricing_modules_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
