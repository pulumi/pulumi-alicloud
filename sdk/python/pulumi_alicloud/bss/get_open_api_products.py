...
def get_open_api_products(ids: Optional[Sequence[builtins.str]] = None,
...
def get_open_api_products_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
