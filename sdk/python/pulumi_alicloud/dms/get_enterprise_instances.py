...
class GetEnterpriseInstancesResult:
    ...
    def env_type(self) -> Optional[builtins.str]:
        """
    ...
    def instance_alias_regex(self) -> Optional[builtins.str]:
        return pulumi.get(self, "instance_alias_regex")

    @property
    @pulumi.getter(name="instanceSource")
    def instance_source(self) -> Optional[builtins.str]:
        """
    ...
    def search_key(self) -> Optional[builtins.str]:
    ...
    @property
    @pulumi.getter
    def tid(self) -> Optional[builtins.int]:
...
def get_enterprise_instances(env_type: Optional[builtins.str] = None,
                             instance_alias_regex: Optional[builtins.str] = None,
                             instance_source: Optional[builtins.str] = None,
                             ...
                             tid: Optional[builtins.int] = None,
    ...
    :param builtins.str env_type: The type of the environment to which the database instance belongs.
    :param builtins.str instance_alias_regex: A regex string to filter the results by the DMS Enterprise Instance instance_alias.
    :param builtins.str instance_source: The source of the database instance.
    :param builtins.str instance_type: The ID of the database instance.
    :param builtins.str name_regex: A regex string to filter the results by the DMS Enterprise Instance instance_alias.
    :param builtins.str net_type: The network type of the database instance. Valid values: CLASSIC and VPC. For more information about the valid values, see the description of the RegisterInstance operation.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str search_key: The keyword used to query database instances.
    :param builtins.str status: Filter the results by status of the DMS Enterprise Instances. Valid values: `NORMAL`, `UNAVAILABLE`, `UNKNOWN`, `DELETED`, `DISABLE`.
    :param builtins.int tid: The ID of the tenant in Data Management (DMS) Enterprise.
    """
    __args__ = dict()
...
def get_enterprise_instances_output(env_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    instance_alias_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    instance_source: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    ...
                                    net_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    search_key: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    tid: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEnterpriseInstancesResult]:
    """
    This data source provides a list of DMS Enterprise Instances in an Alibaba Cloud account according to the specified filters.
