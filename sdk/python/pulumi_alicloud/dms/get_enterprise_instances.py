...
class GetEnterpriseInstancesResult:
    ...
    def env_type(self) -> Optional[_builtins.str]:
        """
    ...
    def instance_alias_regex(self) -> Optional[_builtins.str]:
    ...
    @_builtins.property
    @pulumi.getter
    def tid(self) -> Optional[_builtins.int]:
...
def get_enterprise_instances(env_type: Optional[_builtins.str] = None,
                             instance_alias_regex: Optional[_builtins.str] = None,
                             ...
                             tid: Optional[_builtins.int] = None,
    ...
    :param _builtins.str instance_alias_regex: A regex string to filter the results by the DMS Enterprise Instance instance_alias.
    ...
    :param _builtins.str name_regex: A regex string to filter the results by the DMS Enterprise Instance instance_alias.
    :param _builtins.str net_type: The network type of the database instance. Valid values: CLASSIC and VPC. For more information about the valid values, see the description of the RegisterInstance operation.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str search_key: The keyword used to query database instances.
    ...
    :param _builtins.int tid: The ID of the tenant in Data Management (DMS) Enterprise.
    """
    __args__ = dict()
...
def get_enterprise_instances_output(env_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    instance_alias_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    ...
                                    tid: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
