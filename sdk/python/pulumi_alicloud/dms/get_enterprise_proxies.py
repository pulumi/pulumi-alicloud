...
class GetEnterpriseProxiesResult:
    ...
    @property
    @pulumi.getter
    def tid(self) -> Optional[builtins.str]:
...
def get_enterprise_proxies(ids: Optional[Sequence[builtins.str]] = None,
                           output_file: Optional[builtins.str] = None,
                           tid: Optional[builtins.str] = None,
...
def get_enterprise_proxies_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                  output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  tid: Optional[pulumi.Input[Optional[builtins.str]]] = None,
