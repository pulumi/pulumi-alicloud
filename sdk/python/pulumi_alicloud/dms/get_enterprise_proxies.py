...
class GetEnterpriseProxiesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def tid(self) -> Optional[_builtins.str]:
...
def get_enterprise_proxies(ids: Optional[Sequence[_builtins.str]] = None,
                           output_file: Optional[_builtins.str] = None,
                           tid: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Proxy IDs.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str tid: The ID of the tenant.
    """
    __args__ = dict()
    __args__['ids'] = ids
