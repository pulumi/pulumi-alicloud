...
def get_user_tenants(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of DMS User Tenant IDs (TID).
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the user tenant.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_user_tenants_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
