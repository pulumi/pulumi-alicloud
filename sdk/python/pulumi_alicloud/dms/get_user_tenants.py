...
def get_user_tenants(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of DMS User Tenant IDs (TID).
...
def get_user_tenants_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
