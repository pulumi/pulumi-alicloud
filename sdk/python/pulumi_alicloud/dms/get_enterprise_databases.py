...
def get_enterprise_databases(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Database IDs.
    :param builtins.str instance_id: The instance ID of the target database.
    :param builtins.str name_regex: A regex string to filter the results by the database Schema Name.
...
def get_enterprise_databases_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
