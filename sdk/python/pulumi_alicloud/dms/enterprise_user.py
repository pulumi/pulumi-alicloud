...
class EnterpriseUserArgs:
    def __init__(__self__, *,
                 ...
                 max_execute_count: Optional[pulumi.Input[builtins.int]] = None,
                 max_result_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] uid: The Alibaba Cloud unique ID (UID) of the user to add.
        :param pulumi.Input[builtins.int] max_execute_count: Maximum number of inquiries on the day.
        :param pulumi.Input[builtins.int] max_result_count: Query the maximum number of rows on the day.
        :param pulumi.Input[builtins.str] mobile: The DingTalk number or mobile number of the user.
        :param pulumi.Input[builtins.str] nick_name: It has been deprecated from 1.100.0 and use `user_name` instead.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] role_names: The roles that the user plays.
        :param pulumi.Input[builtins.str] status: The state of DMS Enterprise User. Valid values: `NORMAL`, `DISABLE`.
        :param pulumi.Input[builtins.int] tid: The tenant ID.
        :param pulumi.Input[builtins.str] user_name: The nickname of the user.
        """
    ...
    def max_execute_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_execute_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_execute_count", value)

    @property
    @pulumi.getter(name="maxResultCount")
    def max_result_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_result_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class EnterpriseUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tid: Optional[pulumi.Input[builtins.int]] = None,
            uid: Optional[pulumi.Input[builtins.str]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None) -> 'EnterpriseUser':
        """
    ...
    @property
    @pulumi.getter(name="maxExecuteCount")
    def max_execute_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum number of inquiries on the day.
        """
        return pulumi.get(self, "max_execute_count")
    ...
    @property
    @pulumi.getter(name="maxResultCount")
    def max_result_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Query the maximum number of rows on the day.
        """
        return pulumi.get(self, "max_result_count")
