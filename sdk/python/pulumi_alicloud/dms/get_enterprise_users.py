...
def get_enterprise_users(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of DMS Enterprise User IDs (UID).
    :param builtins.str name_regex: A regex string to filter the results by the DMS Enterprise User nick_name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str role: The role of the user to query.
    :param builtins.str search_key: The keyword used to query users.
    :param builtins.str status: The status of the user.
    :param builtins.int tid: The ID of the tenant in DMS Enterprise.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_enterprise_users_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
