...
class EnterpriseAuthorityTemplateArgs:
    ...
    def authority_template_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def authority_template_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "authority_template_name", value)

    @_builtins.property
    @pulumi.getter
    def tid(self) -> pulumi.Input[_builtins.int]:
        """
        Tenant ID.
        """
    ...
    @tid.setter
    def tid(self, value: pulumi.Input[_builtins.int]):
...
class EnterpriseAuthorityTemplate(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="authorityTemplateId")
    def authority_template_id(self) -> pulumi.Output[_builtins.int]:
        """
        Permission template ID.
        """
        return pulumi.get(self, "authority_template_id")
    ...
    @_builtins.property
    @pulumi.getter(name="authorityTemplateName")
    def authority_template_name(self) -> pulumi.Output[_builtins.str]:
        """
        Permission Template name.
        """
        return pulumi.get(self, "authority_template_name")
    ...
    @_builtins.property
    @pulumi.getter
    def tid(self) -> pulumi.Output[_builtins.int]:
        """
        Tenant ID.
        """
        return pulumi.get(self, "tid")
