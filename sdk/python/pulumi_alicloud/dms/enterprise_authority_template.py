...
class EnterpriseAuthorityTemplateArgs:
    def __init__(__self__, *,
                 authority_template_name: pulumi.Input[builtins.str],
                 tid: pulumi.Input[builtins.int],
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EnterpriseAuthorityTemplate resource.
        :param pulumi.Input[builtins.str] authority_template_name: Permission Template name.
        :param pulumi.Input[builtins.int] tid: Tenant ID.
        :param pulumi.Input[builtins.str] description: Permission template description information.
        """
    ...
    def authority_template_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def authority_template_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "authority_template_name", value)

    @property
    @pulumi.getter
    def tid(self) -> pulumi.Input[builtins.int]:
        """
        Tenant ID.
        """
    ...
    @tid.setter
    def tid(self, value: pulumi.Input[builtins.int]):
...
class _EnterpriseAuthorityTemplateState:
    def __init__(__self__, *,
                 authority_template_id: Optional[pulumi.Input[builtins.int]] = None,
                 authority_template_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] authority_template_id: Permission template ID.
        :param pulumi.Input[builtins.str] authority_template_name: Permission Template name.
    ...
    def authority_template_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def authority_template_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "authority_template_id", value)

    @property
    @pulumi.getter(name="authorityTemplateName")
    def authority_template_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Permission Template name.
        """
        return pulumi.get(self, "authority_template_name")
    ...
    @authority_template_name.setter
    def authority_template_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authority_template_name", value)
...
class EnterpriseAuthorityTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            create_time: Optional[pulumi.Input[builtins.str]] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            tid: Optional[pulumi.Input[builtins.int]] = None) -> 'EnterpriseAuthorityTemplate':
        """
    ...
    @property
    @pulumi.getter(name="authorityTemplateId")
    def authority_template_id(self) -> pulumi.Output[builtins.int]:
        """
        Permission template ID.
        """
        return pulumi.get(self, "authority_template_id")
    ...
    @property
    @pulumi.getter(name="authorityTemplateName")
    def authority_template_name(self) -> pulumi.Output[builtins.str]:
        """
        Permission Template name.
        """
        return pulumi.get(self, "authority_template_name")
    ...
    @property
    @pulumi.getter
    def tid(self) -> pulumi.Output[builtins.int]:
        """
        Tenant ID.
        """
        return pulumi.get(self, "tid")
