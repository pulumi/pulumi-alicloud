...
def get_enterprise_proxy_accesses(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Proxy Access IDs.
...
def get_enterprise_proxy_accesses_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
