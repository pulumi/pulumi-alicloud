...
class EnterpriseProxyAccessArgs:
    def __init__(__self__, *,
                 ...
                 indep_account: Optional[pulumi.Input[builtins.str]] = None,
                 indep_password: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_access_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EnterpriseProxyAccess resource.
        :param pulumi.Input[builtins.str] proxy_id: The ID of the security agent.
        :param pulumi.Input[builtins.str] user_id: The user ID.
        :param pulumi.Input[builtins.str] indep_account: Database account.
        :param pulumi.Input[builtins.str] indep_password: Database password.
        :param pulumi.Input[builtins.str] proxy_access_id: Security Protection authorization ID. After the target user is authorized by the security protection agent, the system automatically generates a security protection authorization ID, which is globally unique.
        """
    ...
    def indep_account(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Database account.
        """
    ...
    def indep_account(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "indep_account", value)

    @property
    @pulumi.getter(name="indepPassword")
    def indep_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Database password.
        """
    ...
    def indep_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "indep_password", value)

    @property
    @pulumi.getter(name="proxyAccessId")
    def proxy_access_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def proxy_access_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EnterpriseProxyAccessState:
    def __init__(__self__, *,
                 ...
                 access_secret: Optional[pulumi.Input[builtins.str]] = None,
                 create_time: Optional[pulumi.Input[builtins.str]] = None,
                 indep_account: Optional[pulumi.Input[builtins.str]] = None,
                 indep_password: Optional[pulumi.Input[builtins.str]] = None,
                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 origin_info: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_access_id: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_name: Optional[pulumi.Input[builtins.str]] = None,
                 user_uid: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering EnterpriseProxyAccess resources.
        :param pulumi.Input[builtins.str] access_id: The authorized account of the security agent.
        :param pulumi.Input[builtins.str] access_secret: Secure access agent authorization password.
        :param pulumi.Input[builtins.str] indep_account: Database account.
        :param pulumi.Input[builtins.str] indep_password: Database password.
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] origin_info: The source information of the security access agent permission is enabled, and the return value is as follows:
        ...
        :param pulumi.Input[builtins.str] proxy_id: The ID of the security agent.
        :param pulumi.Input[builtins.str] user_id: The user ID.
        :param pulumi.Input[builtins.str] user_name: User nickname.
        :param pulumi.Input[builtins.str] user_uid: User UID.
        """
    ...
    def access_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def access_secret(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def origin_info(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @origin_info.setter
    def origin_info(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_uid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        User UID.
        """
    ...
    @user_uid.setter
    def user_uid(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EnterpriseProxyAccess(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_id: Optional[pulumi.Input[builtins.str]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None,
            user_uid: Optional[pulumi.Input[builtins.str]] = None) -> 'EnterpriseProxyAccess':
        """
    ...
    @property
    @pulumi.getter(name="accessSecret")
    def access_secret(self) -> pulumi.Output[builtins.str]:
        """
        Secure access agent authorization password.
        """
        return pulumi.get(self, "access_secret")
    ...
    @property
    @pulumi.getter(name="indepAccount")
    def indep_account(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Database account.
        """
        return pulumi.get(self, "indep_account")
    ...
    @property
    @pulumi.getter(name="indepPassword")
    def indep_password(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Database password.
        """
        return pulumi.get(self, "indep_password")
    ...
    @property
    @pulumi.getter(name="originInfo")
    def origin_info(self) -> pulumi.Output[builtins.str]:
        """
        The source information of the security access agent permission is enabled, and the return value is as follows:
        * **Owner Authorization**: The UID of the owner in parentheses.
        * **Work Order Authorization**: The ticket number in parentheses is the number of the user to apply for permission.
    ...
    @property
    @pulumi.getter(name="proxyAccessId")
    def proxy_access_id(self) -> pulumi.Output[builtins.str]:
        """
        Security Protection authorization ID. After the target user is authorized by the security protection agent, the system automatically generates a security protection authorization ID, which is globally unique.
        """
        return pulumi.get(self, "proxy_access_id")
    ...
    @property
    @pulumi.getter(name="proxyId")
    def proxy_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the security agent.
        """
        return pulumi.get(self, "proxy_id")
    ...
    @property
    @pulumi.getter(name="userUid")
    def user_uid(self) -> pulumi.Output[builtins.str]:
        """
        User UID.
        """
        return pulumi.get(self, "user_uid")
