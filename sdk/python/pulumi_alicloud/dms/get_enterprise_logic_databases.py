...
def get_enterprise_logic_databases(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Logic Database IDs.
...
def get_enterprise_logic_databases_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
