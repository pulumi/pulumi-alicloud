...
class EnterpriseProxyArgs:
    def __init__(__self__, *,
                 ...
                 tid: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EnterpriseProxy resource.
        :param pulumi.Input[builtins.str] instance_id: The ID of the database instance.
        :param pulumi.Input[builtins.str] password: The password of the database account.
        :param pulumi.Input[builtins.str] username: The username of the database account.
        :param pulumi.Input[builtins.str] tid: The ID of the tenant.
        """
    ...
    @property
    @pulumi.getter
    def tid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @tid.setter
    def tid(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EnterpriseProxy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[builtins.str]] = None,
            tid: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'EnterpriseProxy':
        """
    ...
    @property
    @pulumi.getter
    def tid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the tenant.
        """
        return pulumi.get(self, "tid")
