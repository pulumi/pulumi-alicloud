...
class GetEnterpriseDatabasesDatabaseResult(dict):
    def __init__(__self__, *,
                 ...
                 dba_id: builtins.str,
                 dba_name: builtins.str,
                 encoding: builtins.str,
                 env_type: builtins.str,
                 host: builtins.str,
                 id: builtins.str,
                 instance_id: builtins.str,
                 owner_id_lists: Sequence[builtins.str],
                 owner_name_lists: Sequence[builtins.str],
                 port: builtins.int,
                 ...
                 state: builtins.str):
        """
        :param builtins.str catalog_name: The name of the Database Directory.> PG Series databases will display the database name.
        :param builtins.str database_id: The ID of the physical library.
        :param builtins.str db_type: Database type.
        :param builtins.str dba_id: The DBA user ID of the target database.
        :param builtins.str dba_name: The DBA nickname of the target Library.
        :param builtins.str encoding: Database encoding.
        :param builtins.str env_type: The environment type of the database.
        :param builtins.str host: The database connection address.
        :param builtins.str id: The Database ID, same value as `database_id`.
        :param builtins.str instance_id: The instance ID of the target database.
        :param Sequence[builtins.str] owner_id_lists: Library Owner User ID list.
        :param Sequence[builtins.str] owner_name_lists: Library Owner nickname list.
        :param builtins.int port: The connection port of the database.
        :param builtins.str schema_name: The name of the database.> PG Series databases will display schema names.
        :param builtins.str search_name: Library search name.
        :param builtins.str sid: Database SID.> only Oracle Database Display.
        :param builtins.str state: Library status, value description:-**NORMAL**: NORMAL-**DISABLE**: Disabled-**OFFLINE**: OFFLINE-**NOT_EXIST**: does not exist
        """
    ...
    def dba_name(self) -> builtins.str:
        """
    ...
    def owner_id_lists(self) -> Sequence[builtins.str]:
        """
    ...
    def owner_name_lists(self) -> Sequence[builtins.str]:
        """
    ...
    def search_name(self) -> builtins.str:
        """
        Library search name.
        """
...
class GetEnterpriseInstancesInstanceResult(dict):
    def __init__(__self__, *,
                 data_link_name: builtins.str,
                 database_password: builtins.str,
                 database_user: builtins.str,
                 dba_id: builtins.str,
                 dba_nick_name: builtins.str,
                 ddl_online: builtins.int,
                 ecs_instance_id: builtins.str,
                 ecs_region: builtins.str,
                 env_type: builtins.str,
                 export_timeout: builtins.int,
                 host: builtins.str,
                 id: builtins.str,
                 ...
                 safe_rule_id: builtins.str,
                 sid: builtins.str,
                 status: builtins.str,
                 use_dsql: builtins.int,
                 vpc_id: builtins.str):
        """
        :param builtins.str data_link_name: The name of the data link for the database instance.
        :param builtins.str database_password: The logon password of the database instance.
        :param builtins.str database_user: The logon username of the database instance.
        :param builtins.str dba_id: The ID of the database administrator (DBA) of the database instance.
        :param builtins.str dba_nick_name: The nickname of the DBA.
        :param builtins.int ddl_online: Indicates whether the online data description language (DDL) service was enabled for the database instance.
        :param builtins.str ecs_instance_id: The ID of the Elastic Compute Service (ECS) instance to which the database instance belongs.
        :param builtins.str ecs_region: The region where the database instance resides.
        :param builtins.str env_type: The type of the environment to which the database instance belongs.
        :param builtins.int export_timeout: The timeout period for exporting the database instance.
        :param builtins.str host: The endpoint of the database instance.
        :param builtins.str instance_alias: The alias of the database instance.
        :param builtins.str instance_id: The ID of the database instance.
        ...
        :param builtins.int port: The connection port of the database instance.
        :param builtins.int query_timeout: The timeout period for querying the database instance.
        :param builtins.str safe_rule_id: The ID of the security rule for the database instance.
        :param builtins.str sid: The system ID (SID) of the database instance.
        ...
        :param builtins.int use_dsql: Indicates whether cross-database query was enabled for the database instance.
        :param builtins.str vpc_id: The ID of the Virtual Private Cloud (VPC) to which the database instance belongs.
        """
    ...
    def data_link_name(self) -> builtins.str:
        """
    ...
    def dba_nick_name(self) -> builtins.str:
        """
    ...
    def ddl_online(self) -> builtins.int:
        """
    ...
    def ecs_region(self) -> builtins.str:
        """
    ...
    def export_timeout(self) -> builtins.int:
        """
    ...
    def safe_rule_id(self) -> builtins.str:
        """
    ...
    def use_dsql(self) -> builtins.int:
        """
...
class GetEnterpriseLogicDatabasesDatabaseResult(dict):
    def __init__(__self__, *,
                 alias: builtins.str,
                 database_ids: Sequence[builtins.str],
                 db_type: builtins.str,
                 env_type: builtins.str,
                 id: builtins.str,
                 logic: builtins.bool,
                 logic_database_id: builtins.str,
                 owner_id_lists: Sequence[builtins.str],
                 owner_name_lists: Sequence[builtins.str],
                 schema_name: builtins.str,
                 search_name: builtins.str):
        """
        :param builtins.str alias: Logical Library alias.
        :param Sequence[builtins.str] database_ids: Sub-Database ID.
        :param builtins.str db_type: Database type.
        :param builtins.str env_type: Environment type, return value is as follows:-product: production environment-dev: development environment-pre: Advance Environment-test: test environment-sit:SIT environment-uat:UAT environment-pet: Pressure measurement environment-stag:STAG environment
        :param builtins.str id: Logic Database ID.
        :param builtins.bool logic: Whether it is a logical Library, the return value is true.
        :param builtins.str logic_database_id: The ID of the logical Library.
        :param Sequence[builtins.str] owner_id_lists: The user ID list of the logical library Owner.
        :param Sequence[builtins.str] owner_name_lists: The nickname list of the logical library Owner.
        :param builtins.str schema_name: Logical Library name.
        :param builtins.str search_name: Logical library search name.
        """
    ...
    def logic_database_id(self) -> builtins.str:
        """
...
class GetEnterpriseProxiesProxyResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 instance_id: builtins.str,
                 private_enable: builtins.bool,
                 private_host: builtins.str,
                 protocol_port: builtins.int,
                 protocol_type: builtins.str,
                 proxy_id: builtins.str,
                 public_enable: builtins.bool,
                 public_host: builtins.str):
        """
        :param builtins.str creator_id: The ID of the user who enabled the secure access proxy feature.
        :param builtins.str creator_name: The nickname of the user who enabled the secure access proxy feature.
        :param builtins.int https_port: The port that was used by HTTPS clients to connect to the database instance.
        :param builtins.str id: The ID of the Proxy.
        :param builtins.str instance_id: The ID of the database instance.
        :param builtins.bool private_enable: Indicates whether the internal endpoint is enabled. Default value: true.
        :param builtins.str private_host: The internal endpoint.
        :param builtins.int protocol_port: Database protocol connection port number.
        :param builtins.str protocol_type: Database protocol type, for example, MYSQL.
        :param builtins.str proxy_id: The ID of the secure access proxy.
        :param builtins.bool public_enable: Indicates whether the public endpoint is enabled.
        :param builtins.str public_host: The public endpoint. A public endpoint is returned no matter whether the public endpoint is enabled or disabled. **Note:** When the public network address is in the **true** state, the returned public network address is a valid address with DNS resolution capability. When the public address is in the **false** state, the returned Public address is an invalid address without DNS resolution.
        """
    ...
    def private_enable(self) -> builtins.bool:
        """
    ...
    def public_enable(self) -> builtins.bool:
        """
...
class GetEnterpriseProxyAccessesAccessResult(dict):
    def __init__(__self__, *,
                 ...
                 access_secret: builtins.str,
                 create_time: builtins.str,
                 id: builtins.str,
                 indep_account: builtins.str,
                 instance_id: builtins.str,
                 origin_info: builtins.str,
                 proxy_access_id: builtins.str,
                 proxy_id: builtins.str,
                 user_id: builtins.str,
                 user_name: builtins.str,
                 user_uid: builtins.str):
        """
        :param builtins.str access_id: The authorized account of the security agent.
        :param builtins.str create_time: The authorization time of the security access agent permission.
        :param builtins.str id: Security Protection authorization ID.
        :param builtins.str indep_account: Database account.
        :param builtins.str instance_id: The ID of the instance.
        :param builtins.str origin_info: The source information of the security access agent permission is enabled, and the return value is as follows:**Owner Authorization**: The UID of the owner in parentheses.**Work Order Authorization**: The ticket number in parentheses is the number of the user to apply for permission.
        :param builtins.str proxy_access_id: Security Protection authorization ID. After the target user is authorized by the security protection agent, the system automatically generates a security protection authorization ID, which is globally unique.
        :param builtins.str proxy_id: The ID of the security agent.
        :param builtins.str user_id: The user ID.
        :param builtins.str user_name: User nickname.
        :param builtins.str user_uid: User UID.
        """
    ...
    def access_secret(self) -> builtins.str:
    ...
    def indep_account(self) -> builtins.str:
        """
        Database account.
        """
    ...
    def origin_info(self) -> builtins.str:
        """
    ...
    def proxy_access_id(self) -> builtins.str:
        """
    ...
    def user_uid(self) -> builtins.str:
        """
        User UID.
        """
...
class GetEnterpriseUsersUserResult(dict):
    def __init__(__self__, *,
                 ...
                 parent_uid: builtins.int,
                 role_ids: Sequence[builtins.int],
                 role_names: Sequence[builtins.str],
                 status: builtins.str,
                 uid: builtins.str,
                 user_id: builtins.str,
                 user_name: builtins.str):
        """
        :param builtins.str id: The Alibaba Cloud unique ID (UID) of the user.
        :param builtins.str mobile: The DingTalk number or mobile number of the user.
        :param builtins.str nick_name: The nickname of the user.
        :param builtins.int parent_uid: The Alibaba Cloud unique ID (UID) of the parent account if the user corresponds to a Resource Access Management (RAM) user.
        :param Sequence[builtins.int] role_ids: The list ids of the role that the user plays.
        :param Sequence[builtins.str] role_names: The list names of the role that he user plays.
        :param builtins.str status: The status of the user.
        :param builtins.str user_id: The ID of the user.
        :param builtins.str user_name: The nickname of the user.
        """
        pulumi.set(__self__, "id", id)
    ...
    def parent_uid(self) -> builtins.int:
        """
    ...
    def role_ids(self) -> Sequence[builtins.int]:
        """
...
class GetUserTenantsTenantResult(dict):
    def __init__(__self__, *,
                 ...
                 tid: builtins.str):
        """
        :param builtins.str id: The user tenant id.
        :param builtins.str status: The status of the user tenant.
        :param builtins.str tenant_name: The name of the user tenant.
        :param builtins.str tid: The user tenant id. Same as id.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "status", status)
