...
class EnterpriseLogicDatabaseArgs:
    def __init__(__self__, *,
                 ...
                 database_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 logic_database_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EnterpriseLogicDatabase resource.
        :param pulumi.Input[builtins.str] alias: Logical Library alias.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] database_ids: Sub-Database ID
        :param pulumi.Input[builtins.str] logic_database_id: The ID of the logical Library.
        """
    ...
    def database_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Sub-Database ID
        """
    ...
    @database_ids.setter
    def database_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "database_ids", value)

    @property
    @pulumi.getter(name="logicDatabaseId")
    def logic_database_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def logic_database_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EnterpriseLogicDatabaseState:
    def __init__(__self__, *,
                 ...
                 database_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 db_type: Optional[pulumi.Input[builtins.str]] = None,
                 env_type: Optional[pulumi.Input[builtins.str]] = None,
                 logic: Optional[pulumi.Input[builtins.bool]] = None,
                 logic_database_id: Optional[pulumi.Input[builtins.str]] = None,
                 owner_id_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 owner_name_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 schema_name: Optional[pulumi.Input[builtins.str]] = None,
                 search_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering EnterpriseLogicDatabase resources.
        :param pulumi.Input[builtins.str] alias: Logical Library alias.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] database_ids: Sub-Database ID
        :param pulumi.Input[builtins.str] db_type: Database type.
        :param pulumi.Input[builtins.str] env_type: Environment type, return value is as follows:-product: production environment-dev: development environment-pre: Advance Environment-test: test environment-sit:SIT environment-uat:UAT environment-pet: Pressure measurement environment-stag:STAG environment
        :param pulumi.Input[builtins.bool] logic: Whether it is a logical Library, the return value is true.
        :param pulumi.Input[builtins.str] logic_database_id: The ID of the logical Library.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] owner_id_lists: The user ID list of the logical library Owner.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] owner_name_lists: The nickname list of the logical library Owner.
        :param pulumi.Input[builtins.str] schema_name: Logical Library name.
        :param pulumi.Input[builtins.str] search_name: Logical library search name.
        """
    ...
    @property
    @pulumi.getter(name="databaseIds")
    def database_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Sub-Database ID
        """
        return pulumi.get(self, "database_ids")
    ...
    @database_ids.setter
    def database_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "database_ids", value)

    @property
    @pulumi.getter(name="dbType")
    def db_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Database type.
        """
    ...
    @db_type.setter
    def db_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def logic(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @logic.setter
    def logic(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def owner_id_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def owner_id_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "owner_id_lists", value)

    @property
    @pulumi.getter(name="ownerNameLists")
    def owner_name_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def owner_name_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def search_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @search_name.setter
    def search_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EnterpriseLogicDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            owner_name_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            schema_name: Optional[pulumi.Input[builtins.str]] = None,
            search_name: Optional[pulumi.Input[builtins.str]] = None) -> 'EnterpriseLogicDatabase':
        """
    ...
    @property
    @pulumi.getter(name="databaseIds")
    def database_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Sub-Database ID
        """
        return pulumi.get(self, "database_ids")
    ...
    @property
    @pulumi.getter(name="dbType")
    def db_type(self) -> pulumi.Output[builtins.str]:
        """
        Database type.
        """
        return pulumi.get(self, "db_type")
    ...
    @property
    @pulumi.getter
    def logic(self) -> pulumi.Output[builtins.bool]:
        """
        Whether it is a logical Library, the return value is true.
        """
        return pulumi.get(self, "logic")
    ...
    @property
    @pulumi.getter(name="logicDatabaseId")
    def logic_database_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the logical Library.
        """
        return pulumi.get(self, "logic_database_id")
    ...
    @property
    @pulumi.getter(name="ownerIdLists")
    def owner_id_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The user ID list of the logical library Owner.
        """
        return pulumi.get(self, "owner_id_lists")
    ...
    @property
    @pulumi.getter(name="ownerNameLists")
    def owner_name_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The nickname list of the logical library Owner.
        """
        return pulumi.get(self, "owner_name_lists")
    ...
    @property
    @pulumi.getter(name="searchName")
    def search_name(self) -> pulumi.Output[builtins.str]:
        """
        Logical library search name.
        """
        return pulumi.get(self, "search_name")
