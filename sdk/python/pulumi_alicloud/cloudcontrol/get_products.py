...
def get_products(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Product IDs.
...
def get_products_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
