...
def get_products(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Product IDs.
...
def get_products_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
