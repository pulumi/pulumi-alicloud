...
class GetPricesResult:
    ...
    def desire_attributes(self) -> Optional[Mapping[str, builtins.str]]:
    ...
    def resource_code(self) -> builtins.str:
...
def get_prices(desire_attributes: Optional[Mapping[str, builtins.str]] = None,
               output_file: Optional[builtins.str] = None,
               product: Optional[builtins.str] = None,
               resource_code: Optional[builtins.str] = None,
...
def get_prices_output(desire_attributes: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
