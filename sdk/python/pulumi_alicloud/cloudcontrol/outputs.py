...
class GetPricesPriceResult(dict):
    def __init__(__self__, *,
                 ...
                 trade_price: builtins.float):
        """
        :param builtins.str currency: Currency. Value range: CNY: RMB. USD: USD. JPY: Japanese yen.
        :param builtins.float discount_price: Discount
        :param Sequence['GetPricesPriceModuleDetailArgs'] module_details: Pricing Module Price Details
        :param builtins.float original_price: Original Price
        :param Sequence['GetPricesPricePromotionDetailArgs'] promotion_details: Offer Details
        :param builtins.float trade_price: Preferential price
        """
    ...
    def discount_price(self) -> builtins.float:
        """
        Discount
        """
    ...
    def original_price(self) -> builtins.float:
        """
        Original Price
        """
...
class GetPricesPriceModuleDetailResult(dict):
    def __init__(__self__, *,
                 cost_after_discount: builtins.float,
                 invoice_discount: builtins.float,
                 module_code: builtins.str,
                 module_name: builtins.str,
                 original_cost: builtins.float,
                 price_type: builtins.str):
        """
        :param builtins.float cost_after_discount: Preferential price.
        :param builtins.float invoice_discount: Discount.
        :param builtins.str module_code: Valuation Module Identification.
        :param builtins.str module_name: Pricing Module Name.
        :param builtins.float original_cost: Original Price.
        :param builtins.str price_type: Price Type.
        """
    ...
    def cost_after_discount(self) -> builtins.float:
        """
        Preferential price.
        """
    ...
    def invoice_discount(self) -> builtins.float:
        """
        Discount.
        """
    ...
    def module_code(self) -> builtins.str:
        """
    ...
    def original_cost(self) -> builtins.float:
        """
        Original Price.
        """
    ...
    def price_type(self) -> builtins.str:
        """
        Price Type.
        """
...
class GetPricesPricePromotionDetailResult(dict):
    def __init__(__self__, *,
                 promotion_desc: builtins.str,
                 promotion_id: builtins.int,
                 promotion_name: builtins.str):
        """
        :param builtins.str promotion_desc: Offer Description.
        :param builtins.int promotion_id: Offer logo.
        :param builtins.str promotion_name: Offer Name.
        """
    ...
    def promotion_desc(self) -> builtins.str:
        """
        Offer Description.
        """
    ...
    def promotion_id(self) -> builtins.int:
        """
        Offer logo.
        """
    ...
    def promotion_name(self) -> builtins.str:
        """
        Offer Name.
        """
...
class GetProductsProductResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str product_code: The first ID of the resource
        :param builtins.str product_name: The name of the resource
        """
...
class GetResourceTypesTypeResult(dict):
    def __init__(__self__, *,
                 create_only_properties: Sequence[builtins.str],
                 delete_only_properties: Sequence[builtins.str],
                 filter_properties: Sequence[builtins.str],
                 get_only_properties: Sequence[builtins.str],
                 get_response_properties: Sequence[builtins.str],
                 handlers: 'outputs.GetResourceTypesTypeHandlersResult',
                 id: builtins.str,
                 infos: Sequence['outputs.GetResourceTypesTypeInfoResult'],
                 list_only_properties: Sequence[builtins.str],
                 list_response_properties: Sequence[builtins.str],
                 primary_identifier: builtins.str,
                 product: builtins.str,
                 properties: builtins.str,
                 public_properties: Sequence[builtins.str],
                 read_only_properties: Sequence[builtins.str],
                 requireds: Sequence[builtins.str],
                 resource_type: builtins.str,
                 sensitive_info_properties: Sequence[builtins.str],
                 update_only_properties: Sequence[builtins.str],
                 update_type_properties: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] create_only_properties: Create an operation private parameter collection. The attributes are not returned in the resource query operation, but the parameters are required in the creation operation.
        :param Sequence[builtins.str] delete_only_properties: Delete operation private parameter collection. The attribute is not returned in the resource query operation, but the parameter is required in the delete operation.
        :param Sequence[builtins.str] filter_properties: A collection of attributes that can be used as the filter parameter during the list operation.
        :param Sequence[builtins.str] get_only_properties: Query operation private parameter collection. The attribute is not returned in the resource query operation, but the input parameter is required in the query operation.
        :param Sequence[builtins.str] get_response_properties: The collection of properties returned by the query.
        ...
        :param Sequence[builtins.str] list_only_properties: Enumerate the operation private parameter collection. The attributes are not returned in the resource query operation, but the parameters that need to be passed in the enumeration operation.
        :param Sequence[builtins.str] list_response_properties: Enumerates the returned property collection.
        :param builtins.str primary_identifier: Resource ID
        :param builtins.str product: Product Code.
        :param builtins.str properties: Resource attribute definition, where key is the attribute name and value is the attribute details.
        :param Sequence[builtins.str] public_properties: A collection of public attributes, which are the basic attributes of the resource. Non-Operation private parameters.
        :param Sequence[builtins.str] read_only_properties: A set of read-only parameters. It is returned only in the list or get Operation. It is not used as an input parameter during creation and change.
        :param Sequence[builtins.str] requireds: Resource creation required parameter collection.
        :param builtins.str resource_type: The resource type.
        :param Sequence[builtins.str] sensitive_info_properties: A collection of sensitive attributes, such as passwords.
        :param Sequence[builtins.str] update_only_properties: Update operation private parameter collection. The attributes are not returned in the resource query operation, but the parameters are required in the update operation.
        :param Sequence[builtins.str] update_type_properties: A collection of properties that can be modified.
        """
    ...
    def create_only_properties(self) -> Sequence[builtins.str]:
        """
    ...
    def delete_only_properties(self) -> Sequence[builtins.str]:
        """
    ...
    def filter_properties(self) -> Sequence[builtins.str]:
        """
    ...
    def get_only_properties(self) -> Sequence[builtins.str]:
        """
    ...
    def get_response_properties(self) -> Sequence[builtins.str]:
        """
    ...
    def list_only_properties(self) -> Sequence[builtins.str]:
        """
    ...
    def list_response_properties(self) -> Sequence[builtins.str]:
        """
    ...
    def primary_identifier(self) -> builtins.str:
        """
        Resource ID
        """
    ...
    def public_properties(self) -> Sequence[builtins.str]:
        """
    ...
    def read_only_properties(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def requireds(self) -> Sequence[builtins.str]:
        """
    ...
    def sensitive_info_properties(self) -> Sequence[builtins.str]:
        """
    ...
    def update_only_properties(self) -> Sequence[builtins.str]:
        """
    ...
    def update_type_properties(self) -> Sequence[builtins.str]:
        """
...
class GetResourceTypesTypeHandlersCreateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] permissions: The collection of required RAM permission information.
        """
...
class GetResourceTypesTypeInfoResult(dict):
    def __init__(__self__, *,
                 ...
                 delivery_scope: builtins.str,
                 description: builtins.str,
                 title: builtins.str):
        """
        :param builtins.str charge_type: Payment formpaid (paid)(free).
        :param builtins.str delivery_scope: Delivery Levelcenter (centralized deployment level)region (regional deployment level)zone (Availability zone deployment level).
        :param builtins.str description: Resource type description.
        :param builtins.str title: The resource type name.
        """
    ...
    def delivery_scope(self) -> builtins.str:
        """
