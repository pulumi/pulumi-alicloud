...
def get_resource_types(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Resource Type IDs.
...
def get_resource_types_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
