...
class ResourceArgs:
    def __init__(__self__, *,
                 ...
                 resource_code: pulumi.Input[builtins.str],
                 desire_attributes: Optional[pulumi.Input[builtins.str]] = None,
                 resource_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Resource resource.
        :param pulumi.Input[builtins.str] product: The product Code represents the product to be operated. Currently supported products and resources can be queried at the following link: [supported-services-and-resource-types](https://help.aliyun.com/zh/cloud-control-api/product-overview/supported-services-and-resource-types).
        :param pulumi.Input[builtins.str] resource_code: Resource Code, if there is a parent resource, split with `::`, such as VPC::VSwitch. The supported resource Code can be obtained from the following link: [supported-services-and-resource-types](https://help.aliyun.com/zh/cloud-control-api/product-overview/supported-services-and-resource-types).
        :param pulumi.Input[builtins.str] desire_attributes: Resource attributes specified when a user creates or updates a resource.
        :param pulumi.Input[builtins.str] resource_id: If there is a parent resource, you need to enter the id of the parent resource, for example, in the VPC::VSwtich resource, you need to enter the id of the VPC: vpc-dexadfe3r4ad. If there are more than one level of parent resources, you need to use `:` to split.
        """
    ...
    def resource_code(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def resource_code(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "resource_code", value)

    @property
    @pulumi.getter(name="desireAttributes")
    def desire_attributes(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def desire_attributes(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ResourceState:
    def __init__(__self__, *,
                 ...
                 resource_attributes: Optional[pulumi.Input[builtins.str]] = None,
                 resource_code: Optional[pulumi.Input[builtins.str]] = None,
                 resource_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Resource resources.
        :param pulumi.Input[builtins.str] desire_attributes: Resource attributes specified when a user creates or updates a resource.
        :param pulumi.Input[builtins.str] product: The product Code represents the product to be operated. Currently supported products and resources can be queried at the following link: [supported-services-and-resource-types](https://help.aliyun.com/zh/cloud-control-api/product-overview/supported-services-and-resource-types).
        :param pulumi.Input[builtins.str] resource_attributes: The collection of properties for the resource.
        :param pulumi.Input[builtins.str] resource_code: Resource Code, if there is a parent resource, split with `::`, such as VPC::VSwitch. The supported resource Code can be obtained from the following link: [supported-services-and-resource-types](https://help.aliyun.com/zh/cloud-control-api/product-overview/supported-services-and-resource-types).
        :param pulumi.Input[builtins.str] resource_id: If there is a parent resource, you need to enter the id of the parent resource, for example, in the VPC::VSwtich resource, you need to enter the id of the VPC: vpc-dexadfe3r4ad. If there are more than one level of parent resources, you need to use `:` to split.
        """
        if desire_attributes is not None:
    ...
    def resource_attributes(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_attributes(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_attributes", value)

    @property
    @pulumi.getter(name="resourceCode")
    def resource_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Resource Code, if there is a parent resource, split with `::`, such as VPC::VSwitch. The supported resource Code can be obtained from the following link: [supported-services-and-resource-types](https://help.aliyun.com/zh/cloud-control-api/product-overview/supported-services-and-resource-types).
        """
        return pulumi.get(self, "resource_code")
    ...
    @resource_code.setter
    def resource_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_code", value)
...
class Resource(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:cloudcontrol/resource:Resource"
    ...
    def get(resource_name: str,
            ...
            resource_attributes: Optional[pulumi.Input[builtins.str]] = None,
            resource_code: Optional[pulumi.Input[builtins.str]] = None,
            resource_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Resource':
        """
    ...
    @property
    @pulumi.getter(name="desireAttributes")
    def desire_attributes(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Resource attributes specified when a user creates or updates a resource.
        """
        return pulumi.get(self, "desire_attributes")
    ...
    @property
    @pulumi.getter(name="resourceAttributes")
    def resource_attributes(self) -> pulumi.Output[builtins.str]:
        """
        The collection of properties for the resource.
        """
        return pulumi.get(self, "resource_attributes")
    ...
    @property
    @pulumi.getter(name="resourceCode")
    def resource_code(self) -> pulumi.Output[builtins.str]:
        """
        Resource Code, if there is a parent resource, split with `::`, such as VPC::VSwitch. The supported resource Code can be obtained from the following link: [supported-services-and-resource-types](https://help.aliyun.com/zh/cloud-control-api/product-overview/supported-services-and-resource-types).
        """
        return pulumi.get(self, "resource_code")
