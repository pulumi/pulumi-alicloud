...
class GroupArgs:
    def __init__(__self__, *,
                 ...
                 instance_group_spec: pulumi.Input[builtins.str],
                 ...
                 gpu_acceleration: Optional[pulumi.Input[builtins.bool]] = None,
                 instance_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 number_of_instances: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_group_spec: Instance group specifications.
        :param pulumi.Input[builtins.int] amount: The number of instance groups. The default value is 1 and the maximum value is 100.
        :param pulumi.Input[builtins.bool] auto_pay: Whether to pay automatically. The default is false.
        :param pulumi.Input[builtins.bool] auto_renew: Whether to enable automatic renewal. The default is false.
        :param pulumi.Input[builtins.str] charge_type: The billing type.
        :param pulumi.Input[builtins.bool] gpu_acceleration: Whether to enable GPU acceleration. The default value is false.
               - true: On.
               - false: closed.
        :param pulumi.Input[builtins.str] instance_group_name: The instance group name
        ...
        :param pulumi.Input[builtins.int] number_of_instances: The number of instances in the instance group. The maximum value is 100.
        :param pulumi.Input[builtins.str] office_site_id: The network ID.
        ...
        :param pulumi.Input[builtins.int] period: The duration of the resource purchase. The unit is specified by PeriodUnit.
        :param pulumi.Input[builtins.str] period_unit: The unit of time for purchasing resources.
        :param pulumi.Input[builtins.str] policy_group_id: The policy ID. You can query the list of policies by calling ListPolicyGroups.
    ...
    def instance_group_spec(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def instance_group_spec(self, value: pulumi.Input[builtins.str]):
    ...
    def gpu_acceleration(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def gpu_acceleration(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "gpu_acceleration", value)

    @property
    @pulumi.getter(name="instanceGroupName")
    def instance_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def instance_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "instance_group_name", value)

    @property
    @pulumi.getter(name="numberOfInstances")
    def number_of_instances(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def number_of_instances(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _GroupState:
    def __init__(__self__, *,
                 ...
                 instance_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 instance_group_spec: Optional[pulumi.Input[builtins.str]] = None,
                 number_of_instances: Optional[pulumi.Input[builtins.int]] = None,
                 office_site_id: Optional[pulumi.Input[builtins.str]] = None,
                 period: Optional[pulumi.Input[builtins.int]] = None,
                 period_unit: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] period_unit: The unit of time for purchasing resources.
        :param pulumi.Input[builtins.str] policy_group_id: The policy ID. You can query the list of policies by calling ListPolicyGroups.
        :param pulumi.Input[builtins.str] status: Instance group status
        :param pulumi.Input[builtins.str] vswitch_id: The vSwitch ID.
        """
        if amount is not None:
            pulumi.set(__self__, "amount", amount)
    ...
    @property
    @pulumi.getter(name="instanceGroupSpec")
    def instance_group_spec(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Instance group specifications.
        """
        return pulumi.get(self, "instance_group_spec")
    ...
    @instance_group_spec.setter
    def instance_group_spec(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "instance_group_spec", value)
...
class Group(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_group_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Group':
        """
    ...
    @property
    @pulumi.getter(name="gpuAcceleration")
    def gpu_acceleration(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable GPU acceleration. The default value is false.
        - true: On.
        - false: closed.
    ...
    @property
    @pulumi.getter(name="instanceGroupName")
    def instance_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The instance group name
    ...
    @property
    @pulumi.getter(name="instanceGroupSpec")
    def instance_group_spec(self) -> pulumi.Output[builtins.str]:
        """
        Instance group specifications.
        """
        return pulumi.get(self, "instance_group_spec")
    ...
    @property
    @pulumi.getter(name="numberOfInstances")
    def number_of_instances(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of instances in the instance group. The maximum value is 100.
        """
        return pulumi.get(self, "number_of_instances")
    ...
    @property
    @pulumi.getter(name="officeSiteId")
    def office_site_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The network ID.
        - Create a shared network instance: Network ID is optional. Enter the network ID whose type is **Shared Network** on the [cloud mobile phone console> Network](https://wya.wuying.aliyun.com/network) page. If the console does not have a shared network, you can fill it in. A shared network is automatically created when the instance group is created.
        - Create a VPC instance: the network ID is required. Enter the network ID of `VPC` on the [cloud mobile phone console> Network](https://wya.wuying.aliyun.com/network) page. If the console does not have a VPC network, you need to create a network first.
    ...
    @property
    @pulumi.getter(name="policyGroupId")
    def policy_group_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The policy ID. You can query the list of policies by calling ListPolicyGroups.
        """
        return pulumi.get(self, "policy_group_id")
