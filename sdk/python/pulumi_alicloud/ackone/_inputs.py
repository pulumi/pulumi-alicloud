...
if not MYPY:
    class ClusterNetworkArgsDict(TypedDict):
        ...
        """
        vswitches: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ClusterNetworkArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] vpc_id: VpcId to which the cluster belongs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vswitches: Switch to which the cluster belongs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: Security group to which the cluster belongs.
        """
    ...
    @property
    @pulumi.getter
    def vswitches(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Switch to which the cluster belongs.
        """
    ...
    @vswitches.setter
    def vswitches(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
