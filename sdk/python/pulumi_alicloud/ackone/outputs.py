...
class ClusterNetwork(dict):
    ...
    def __init__(__self__, *,
                 vpc_id: builtins.str,
                 vswitches: Sequence[builtins.str],
                 security_group_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str vpc_id: VpcId to which the cluster belongs.
        :param Sequence[builtins.str] vswitches: Switch to which the cluster belongs.
        :param Sequence[builtins.str] security_group_ids: Security group to which the cluster belongs.
        """
    ...
    @property
    @pulumi.getter
    def vswitches(self) -> Sequence[builtins.str]:
        """
