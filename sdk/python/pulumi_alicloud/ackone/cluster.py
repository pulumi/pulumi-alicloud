...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 argocd_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] argocd_enabled: (Available since v1.243.0) Whether to enable ArgoCD. Default to true. Only valid when `profile` is 'Default'. It has to be false when cluster is deleted.
        :param pulumi.Input[builtins.str] cluster_name: Cluster name.
        :param pulumi.Input[builtins.str] profile: Cluster attributes. Valid values: 'Default', 'XFlow'.
    ...
    def argocd_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def argocd_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] argocd_enabled: (Available since v1.243.0) Whether to enable ArgoCD. Default to true. Only valid when `profile` is 'Default'. It has to be false when cluster is deleted.
        :param pulumi.Input[builtins.str] cluster_name: Cluster name.
        :param pulumi.Input[builtins.str] create_time: Cluster creation time.
        :param pulumi.Input['ClusterNetworkArgs'] network: Cluster network information. See `network` below.
        :param pulumi.Input[builtins.str] profile: Cluster attributes. Valid values: 'Default', 'XFlow'.
...
class Cluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="argocdEnabled")
    def argocd_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Available since v1.243.0) Whether to enable ArgoCD. Default to true. Only valid when `profile` is 'Default'. It has to be false when cluster is deleted.
        """
        return pulumi.get(self, "argocd_enabled")
