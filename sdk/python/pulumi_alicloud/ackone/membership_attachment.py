...
class MembershipAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 sub_cluster_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a MembershipAttachment resource.
        :param pulumi.Input[builtins.str] cluster_id: The ID of the cluster to which the membership is being attached.
        :param pulumi.Input[builtins.str] sub_cluster_id: The ID of the member being attached to the cluster.
        """
    ...
    def sub_cluster_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sub_cluster_id(self, value: pulumi.Input[builtins.str]):
...
class _MembershipAttachmentState:
    def __init__(__self__, *,
                 ...
                 sub_cluster_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="subClusterId")
    def sub_cluster_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the member being attached to the cluster.
        """
        return pulumi.get(self, "sub_cluster_id")
    ...
    @sub_cluster_id.setter
    def sub_cluster_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sub_cluster_id", value)
...
class MembershipAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            cluster_id: Optional[pulumi.Input[builtins.str]] = None,
            sub_cluster_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MembershipAttachment':
        """
    ...
    @property
    @pulumi.getter(name="subClusterId")
    def sub_cluster_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the member being attached to the cluster.
        """
        return pulumi.get(self, "sub_cluster_id")
