...
def get_scaling_groups(ids=None,name_regex=None,output_file=None,opts=None):
    """
    ...
    :param list ids: A list of scaling group IDs.
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:ess/getScalingGroups:getScalingGroups', __args__, opts=opts).value
