...
def get_scaling_groups(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of scaling group IDs.
    :param builtins.str name_regex: A regex string to filter resulting scaling groups by name.
...
def get_scaling_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
