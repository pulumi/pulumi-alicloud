...
def get_notifications(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of notification ids.
...
def get_notifications_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
