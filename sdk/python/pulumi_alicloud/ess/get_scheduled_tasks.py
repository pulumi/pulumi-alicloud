...
class GetScheduledTasksResult:
    ...
    def scheduled_action(self) -> Optional[builtins.str]:
        """
    ...
    def scheduled_task_id(self) -> Optional[builtins.str]:
...
def get_scheduled_tasks(ids: Optional[Sequence[builtins.str]] = None,
                        name_regex: Optional[builtins.str] = None,
                        output_file: Optional[builtins.str] = None,
                        scheduled_action: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of scheduled task IDs.
    :param builtins.str name_regex: A regex string to filter resulting scheduled tasks by name.
    ...
    :param builtins.str scheduled_task_id: The id of the scheduled task.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_scheduled_tasks_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                               name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               scheduled_action: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               scheduled_task_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
