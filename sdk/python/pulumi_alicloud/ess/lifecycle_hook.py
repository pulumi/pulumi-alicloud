...
class LifecycleHookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] lifecycle_transition: Type of Scaling activity attached to lifecycle hook. Supported value: SCALE_OUT, SCALE_IN.
        :param pulumi.Input[builtins.str] scaling_group_id: The ID of the Auto Scaling group to which you want to assign the lifecycle hook.
        :param pulumi.Input[builtins.str] default_result: Defines the action the Auto Scaling group should take when the lifecycle hook timeout elapses. Applicable value: CONTINUE, ABANDON, ROLLBACK, default value: CONTINUE.
        :param pulumi.Input[builtins.int] heartbeat_timeout: Defines the amount of time, in seconds, that can elapse before the lifecycle hook times out. When the lifecycle hook times out, Auto Scaling performs the action defined in the default_result parameter. Default value: 600.
        :param pulumi.Input[builtins.str] name: The name of the lifecycle hook, which must contain 2-64 characters (English or Chinese), starting with numbers, English letters or Chinese characters, and can contain number, underscores `_`, hypens `-`, and decimal point `.`. If this parameter value is not specified, the default value is lifecycle hook id.
        :param pulumi.Input[builtins.str] notification_arn: The Arn of notification target.
        :param pulumi.Input[builtins.str] notification_metadata: Additional information that you want to include when Auto Scaling sends a message to the notification target.
        """
...
class _LifecycleHookState:
    ...
    @property
    @pulumi.getter(name="lifecycleTransition")
    def lifecycle_transition(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Type of Scaling activity attached to lifecycle hook. Supported value: SCALE_OUT, SCALE_IN.
        """
        return pulumi.get(self, "lifecycle_transition")
    ...
    @lifecycle_transition.setter
    def lifecycle_transition(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "lifecycle_transition", value)
...
class LifecycleHook(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            notification_arn: Optional[pulumi.Input[builtins.str]] = None,
            notification_metadata: Optional[pulumi.Input[builtins.str]] = None,
            scaling_group_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LifecycleHook':
        """
    ...
    @property
    @pulumi.getter(name="notificationMetadata")
    def notification_metadata(self) -> pulumi.Output[builtins.str]:
        """
        Additional information that you want to include when Auto Scaling sends a message to the notification target.
        """
        return pulumi.get(self, "notification_metadata")
