...
class ScalingConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 image_options_login_as_non_root: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 io_optimized: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 override: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 substitute: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] scaling_group_id: ID of the scaling group of a scaling configuration.
        :param pulumi.Input[builtins.bool] active: Whether active current scaling configuration in the specified scaling group. Default to `false`.
        ...
        :param pulumi.Input[builtins.bool] deletion_protection: Specifies whether to enable the Release Protection feature for ECS instances. This parameter is applicable to only pay-as-you-go instances. You can use this parameter to specify whether an ECS instance can be directly released by using the ECS console or calling the DeleteInstance operation. Valid values: true, false. Default value: false.
        :param pulumi.Input[builtins.bool] enable: Whether enable the specified scaling group(make it active) to which the current scaling configuration belongs.
        :param pulumi.Input[builtins.bool] force_delete: The last scaling configuration will be deleted forcibly with deleting its scaling group. Default to false.
        :param pulumi.Input[builtins.str] host_name: Hostname of an ECS instance.
        :param pulumi.Input[builtins.str] image_id: ID of an image file, indicating the image resource selected when an instance is enabled.
        :param pulumi.Input[builtins.str] image_name: Name of an image file, indicating the image resource selected when an instance is enabled.
        :param pulumi.Input[builtins.bool] image_options_login_as_non_root: Specifies whether to use ecs-user to log on to an ECS instance. For more information, see Manage the username used to log on to an ECS instance. Valid values: true, false. Default value: false.
        :param pulumi.Input[builtins.str] instance_description: The description of ECS instances. The description must be 2 to 256 characters in length. It can contain letters but cannot start with http:// or https://.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_ids: It has been deprecated from version 1.6.0. New resource `ess.Attachment` replaces it.
        :param pulumi.Input[builtins.str] instance_name: Name of an ECS instance. Default to "ESS-Instance". It is valid from version 1.7.1.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_types: Resource types of an ECS instance.
        :param pulumi.Input[builtins.str] internet_charge_type: Network billing type, Values: PayByBandwidth or PayByTraffic. Default to `PayByBandwidth`.
        :param pulumi.Input[builtins.int] internet_max_bandwidth_in: Maximum incoming bandwidth from the public network, measured in Mbps (Mega bit per second).
        :param pulumi.Input[builtins.int] internet_max_bandwidth_out: Maximum outgoing bandwidth from the public network, measured in Mbps (Mega bit per second). The value range for PayByBandwidth is [0,1024].
        :param pulumi.Input[builtins.str] io_optimized: It has been deprecated on instance resource. All the launched alicloud instances will be I/O optimized.
        :param pulumi.Input[builtins.bool] is_outdated: Whether to use outdated instance type. Default to false.
        ...
        :param pulumi.Input[builtins.str] kms_encrypted_password: An KMS encrypts password used to a db account. If the `password` is filled in, this field will be ignored.
        ...
        :param pulumi.Input[builtins.bool] override: Indicates whether to overwrite the existing data. Default to false.
        :param pulumi.Input[builtins.str] password: The password of the ECS instance. The password must be 8 to 30 characters in length. It must contains at least three of the following character types: uppercase letters, lowercase letters, digits, and special characters. Special characters include `() ~!@#$%^&*-_+=\\|{}[]:;'<>,.?/`, The password of Windows-based instances cannot start with a forward slash (/).
        :param pulumi.Input[builtins.bool] password_inherit: Specifies whether to use the password that is predefined in the image. If the PasswordInherit parameter is set to true, the `password` and `kms_encrypted_password` will be ignored. You must ensure that the selected image has a password configured.
        :param pulumi.Input[builtins.str] resource_group_id: ID of resource group.
        ...
        :param pulumi.Input[builtins.str] scaling_configuration_name: Name shown for the scheduled task. which must contain 2-64 characters (English or Chinese), starting with numbers, English letters or Chinese characters, and can contain number, underscores `_`, hypens `-`, and decimal point `.`. If this parameter value is not specified, the default value is ScalingConfigurationId.
        :param pulumi.Input[builtins.str] security_enhancement_strategy: Specifies whether to enable Security Hardening. Valid values: Active, Deactive.
        :param pulumi.Input[builtins.str] security_group_id: ID of the security group used to create new instance. It is conflict with `security_group_ids`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: List IDs of the security group used to create new instances. It is conflict with `security_group_id`.
        :param pulumi.Input[builtins.int] spot_duration: The protection period of preemptible instances. Unit: hours. Valid values: 1, 0.
        ...
        :param pulumi.Input[builtins.str] spot_strategy: The spot strategy for a Pay-As-You-Go instance. Valid values: `NoSpot`, `SpotAsPriceGo`, `SpotWithPriceLimit`.
        :param pulumi.Input[builtins.str] substitute: The another scaling configuration which will be active automatically and replace current configuration when setting `active` to 'false'. It is invalid when `active` is 'true'.
        :param pulumi.Input[builtins.str] system_disk_auto_snapshot_policy_id: The id of auto snapshot policy for system disk.
        :param pulumi.Input[builtins.str] system_disk_category: Category of the system disk. The parameter value options are `ephemeral_ssd`, `cloud_efficiency`, `cloud_ssd`, `cloud_essd` and `cloud`. `cloud` only is used to some no I/O optimized instance. Default to `cloud_efficiency`.
        ...
        :param pulumi.Input[builtins.str] system_disk_encrypt_algorithm: The algorithm that you want to use to encrypt the system disk. Valid values: AES-256, SM4-128.
        :param pulumi.Input[builtins.bool] system_disk_encrypted: Whether to encrypt the system disk.
        :param pulumi.Input[builtins.str] system_disk_kms_key_id: The ID of the KMS key that you want to use to encrypt the system disk.
        :param pulumi.Input[builtins.str] system_disk_name: The name of the system disk. It must be 2 to 128 characters in length. It must start with a letter and cannot start with http:// or https://. It can contain letters, digits, colons (:), underscores (_), and hyphens (-). Default value: null.
        :param pulumi.Input[builtins.str] system_disk_performance_level: The performance level of the ESSD used as the system disk.
        :param pulumi.Input[builtins.int] system_disk_provisioned_iops: IOPS measures the number of read and write operations that an EBS device can process per second.
        :param pulumi.Input[builtins.int] system_disk_size: Size of system disk, in GiB. Valid values: Basic disk: 20 to 500, ESSD: The valid values depend on the performance level (PL) of the system disk (PL0 ESSD: 1 to 2048, PL1 ESSD: 20 to 2048, PL2 ESSD: 461 to 2048, PL3 ESSD: 1261 to 2048) , ESSD AutoPL disk: 1 to 2048, Other disk categories: 20 to 2048. The value of this parameter must be at least 1 and greater than or equal to the image size. Default value: 40 or the size of the image, whichever is larger.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource. It will be applied for ECS instances finally.
               - Key: It can be up to 64 characters in length. It cannot begin with "aliyun", "http://", or "https://". It cannot be a null string.
               - Value: It can be up to 128 characters in length. It cannot begin with "aliyun", "http://", or "https://" It can be a null string.
        :param pulumi.Input[builtins.str] user_data: User-defined data to customize the startup behaviors of the ECS instance and to pass data into the ECS instance.
        """
    ...
    def image_options_login_as_non_root(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def image_options_login_as_non_root(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def io_optimized(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @io_optimized.setter
    def io_optimized(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def override(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @override.setter
    def override(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def substitute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @substitute.setter
    def substitute(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ScalingConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_disk_size: Optional[pulumi.Input[builtins.int]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            user_data: Optional[pulumi.Input[builtins.str]] = None) -> 'ScalingConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="creditSpecification")
    def credit_specification(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Performance mode of the t5 burstable instance. Valid values: 'Standard', 'Unlimited'.
        """
        return pulumi.get(self, "credit_specification")
    ...
    @property
    @pulumi.getter(name="imageOptionsLoginAsNonRoot")
    def image_options_login_as_non_root(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to use ecs-user to log on to an ECS instance. For more information, see Manage the username used to log on to an ECS instance. Valid values: true, false. Default value: false.
        """
        return pulumi.get(self, "image_options_login_as_non_root")
    ...
    @property
    @pulumi.getter(name="internetMaxBandwidthIn")
    def internet_max_bandwidth_in(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum incoming bandwidth from the public network, measured in Mbps (Mega bit per second).
        """
        return pulumi.get(self, "internet_max_bandwidth_in")
    ...
    @pulumi.getter(name="ioOptimized")
    @_utilities.deprecated("""Attribute io_optimized has been deprecated on instance resource. All the launched alicloud instances will be IO optimized. Suggest to remove it from your template.""")
    def io_optimized(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        It has been deprecated on instance resource. All the launched alicloud instances will be I/O optimized.
        """
        return pulumi.get(self, "io_optimized")
    ...
    @property
    @pulumi.getter
    def override(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether to overwrite the existing data. Default to false.
        """
        return pulumi.get(self, "override")
    ...
    @property
    @pulumi.getter(name="securityEnhancementStrategy")
    def security_enhancement_strategy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether to enable Security Hardening. Valid values: Active, Deactive.
        """
        return pulumi.get(self, "security_enhancement_strategy")
    ...
    @property
    @pulumi.getter(name="spotDuration")
    def spot_duration(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The protection period of preemptible instances. Unit: hours. Valid values: 1, 0.
        """
        return pulumi.get(self, "spot_duration")
    ...
    @property
    @pulumi.getter
    def substitute(self) -> pulumi.Output[builtins.str]:
        """
        The another scaling configuration which will be active automatically and replace current configuration when setting `active` to 'false'. It is invalid when `active` is 'true'.
        """
        return pulumi.get(self, "substitute")
    ...
    @property
    @pulumi.getter(name="systemDiskCategory")
    def system_disk_category(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Category of the system disk. The parameter value options are `ephemeral_ssd`, `cloud_efficiency`, `cloud_ssd`, `cloud_essd` and `cloud`. `cloud` only is used to some no I/O optimized instance. Default to `cloud_efficiency`.
        """
        return pulumi.get(self, "system_disk_category")
    ...
    @property
    @pulumi.getter(name="systemDiskDescription")
    def system_disk_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the system disk. The description must be 2 to 256 characters in length and cannot start with http:// or https://.
        """
        return pulumi.get(self, "system_disk_description")
    ...
    @property
    @pulumi.getter(name="systemDiskEncrypted")
    def system_disk_encrypted(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to encrypt the system disk.
        """
        return pulumi.get(self, "system_disk_encrypted")
    ...
    @property
    @pulumi.getter(name="systemDiskName")
    def system_disk_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the system disk. It must be 2 to 128 characters in length. It must start with a letter and cannot start with http:// or https://. It can contain letters, digits, colons (:), underscores (_), and hyphens (-). Default value: null.
        """
        return pulumi.get(self, "system_disk_name")
    ...
    @property
    @pulumi.getter(name="systemDiskPerformanceLevel")
    def system_disk_performance_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The performance level of the ESSD used as the system disk.
        """
        return pulumi.get(self, "system_disk_performance_level")
    ...
    @property
    @pulumi.getter(name="systemDiskSize")
    def system_disk_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Size of system disk, in GiB. Valid values: Basic disk: 20 to 500, ESSD: The valid values depend on the performance level (PL) of the system disk (PL0 ESSD: 1 to 2048, PL1 ESSD: 20 to 2048, PL2 ESSD: 461 to 2048, PL3 ESSD: 1261 to 2048) , ESSD AutoPL disk: 1 to 2048, Other disk categories: 20 to 2048. The value of this parameter must be at least 1 and greater than or equal to the image size. Default value: 40 or the size of the image, whichever is larger.
        """
        return pulumi.get(self, "system_disk_size")
