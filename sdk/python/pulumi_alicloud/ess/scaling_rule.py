...
class ScalingRuleArgs:
    def __init__(__self__, *,
                 ...
                 hybrid_monitor_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 initial_max_size: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 predictive_scaling_mode: Optional[pulumi.Input[builtins.str]] = None,
                 predictive_task_buffer_time: Optional[pulumi.Input[builtins.int]] = None,
                 predictive_value_behavior: Optional[pulumi.Input[builtins.str]] = None,
                 predictive_value_buffer: Optional[pulumi.Input[builtins.int]] = None,
                 scale_in_evaluation_count: Optional[pulumi.Input[builtins.int]] = None,
                 scale_out_evaluation_count: Optional[pulumi.Input[builtins.int]] = None,
                 scaling_rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 scaling_rule_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] scaling_group_id: ID of the scaling group of a scaling rule.
        :param pulumi.Input[builtins.str] adjustment_type: Adjustment mode of a scaling rule. Optional values:
               - QuantityChangeInCapacity: It is used to increase or decrease a specified number of ECS instances.
               - PercentChangeInCapacity: It is used to increase or decrease a specified proportion of ECS instances.
               - TotalCapacity: It is used to adjust the quantity of ECS instances in the current scaling group to a specified value.
        :param pulumi.Input[builtins.int] adjustment_value: The number of ECS instances to be adjusted in the scaling rule. This parameter is required and applicable only to simple scaling rules. The number of ECS instances to be adjusted in a single scaling activity cannot exceed 500. Value range:
        ...
        :param pulumi.Input[builtins.int] cooldown: The cooldown time of the scaling rule. This parameter is applicable only to simple scaling rules. Value range: [0, 86,400], in seconds. The default value is empty，if not set, the return value will be 0, which is the default value of integer.
        :param pulumi.Input[builtins.bool] disable_scale_in: Indicates whether scale in by the target tracking policy is disabled. Default to false.
        :param pulumi.Input[builtins.int] estimated_instance_warmup: The estimated time, in seconds, until a newly launched instance will contribute CloudMonitor metrics. Default to 300.
        ...
        :param pulumi.Input[builtins.str] hybrid_monitor_namespace: The ID of the Hybrid Cloud Monitoring metric repository.
        :param pulumi.Input[builtins.int] initial_max_size: The maximum number of ECS instances that can be added to the scaling group. If you specify InitialMaxSize, you must also specify PredictiveValueBehavior.
        :param pulumi.Input[builtins.str] metric_name: A CloudMonitor metric name.
        :param pulumi.Input[builtins.str] metric_type: The type of the metric. Valid values: system, custom, hybrid.
        :param pulumi.Input[builtins.int] min_adjustment_magnitude: The minimum number of instances that must be scaled. This parameter takes effect if you set ScalingRuleType to SimpleScalingRule or StepScalingRule, and AdjustmentType to PercentChangeInCapacity.
        :param pulumi.Input[builtins.str] predictive_scaling_mode: The mode of the predictive scaling rule. Valid values: PredictAndScale, PredictOnly.
        :param pulumi.Input[builtins.int] predictive_task_buffer_time: The amount of buffer time before the prediction task runs. By default, all prediction tasks that are automatically created by a predictive scaling rule run on the hour. You can specify a buffer time to run prediction tasks and prepare resources in advance. Valid values: 0 to 60. Unit: minutes.
        :param pulumi.Input[builtins.str] predictive_value_behavior: The action on the predicted maximum value. Valid values: MaxOverridePredictiveValue, PredictiveValueOverrideMax, PredictiveValueOverrideMaxWithBuffer.
        :param pulumi.Input[builtins.int] predictive_value_buffer: The ratio based on which the predicted value is increased if you set PredictiveValueBehavior to PredictiveValueOverrideMaxWithBuffer. If the predicted value increased by this ratio is greater than the initial maximum capacity, the increased value is used as the maximum value for prediction tasks. Valid values: 0 to 100.
        :param pulumi.Input[builtins.int] scale_in_evaluation_count: The number of consecutive times that the event-triggered task created for scale-ins must meet the threshold conditions before an alert is triggered. After a target tracking scaling rule is created, an event-triggered task is automatically created and associated with the target tracking scaling rule.
        :param pulumi.Input[builtins.int] scale_out_evaluation_count: The number of consecutive times that the event-triggered task created for scale-outs must meet the threshold conditions before an alert is triggered. After a target tracking scaling rule is created, an event-triggered task is automatically created and associated with the target tracking scaling rule.
        :param pulumi.Input[builtins.str] scaling_rule_name: Name shown for the scaling rule, which must contain 2-64 characters (English or Chinese), starting with numbers, English letters or Chinese characters, and can contain number, underscores `_`, hypens `-`, and decimal point `.`. If this parameter value is not specified, the default value is scaling rule id.
        :param pulumi.Input[builtins.str] scaling_rule_type: The scaling rule type, either "SimpleScalingRule", "TargetTrackingScalingRule", "StepScalingRule", "PredictiveScalingRule". Default to "SimpleScalingRule".
    ...
    def hybrid_monitor_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hybrid_monitor_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hybrid_monitor_namespace", value)

    @property
    @pulumi.getter(name="initialMaxSize")
    def initial_max_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def initial_max_size(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def predictive_scaling_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def predictive_scaling_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "predictive_scaling_mode", value)

    @property
    @pulumi.getter(name="predictiveTaskBufferTime")
    def predictive_task_buffer_time(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def predictive_task_buffer_time(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "predictive_task_buffer_time", value)

    @property
    @pulumi.getter(name="predictiveValueBehavior")
    def predictive_value_behavior(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def predictive_value_behavior(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "predictive_value_behavior", value)

    @property
    @pulumi.getter(name="predictiveValueBuffer")
    def predictive_value_buffer(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def predictive_value_buffer(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "predictive_value_buffer", value)

    @property
    @pulumi.getter(name="scaleInEvaluationCount")
    def scale_in_evaluation_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def scale_in_evaluation_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "scale_in_evaluation_count", value)

    @property
    @pulumi.getter(name="scaleOutEvaluationCount")
    def scale_out_evaluation_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def scale_out_evaluation_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "scale_out_evaluation_count", value)

    @property
    @pulumi.getter(name="scalingRuleName")
    def scaling_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def scaling_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scaling_rule_name", value)

    @property
    @pulumi.getter(name="scalingRuleType")
    def scaling_rule_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def scaling_rule_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ScalingRuleState:
    def __init__(__self__, *,
                 ...
                 adjustment_value: Optional[pulumi.Input[builtins.int]] = None,
                 alarm_dimension: Optional[pulumi.Input['ScalingRuleAlarmDimensionArgs']] = None,
                 ari: Optional[pulumi.Input[builtins.str]] = None,
                 cooldown: Optional[pulumi.Input[builtins.int]] = None,
                 disable_scale_in: Optional[pulumi.Input[builtins.bool]] = None,
                 estimated_instance_warmup: Optional[pulumi.Input[builtins.int]] = None,
                 hybrid_metrics: Optional[pulumi.Input[Sequence[pulumi.Input['ScalingRuleHybridMetricArgs']]]] = None,
        ...
        :param pulumi.Input[builtins.int] adjustment_value: The number of ECS instances to be adjusted in the scaling rule. This parameter is required and applicable only to simple scaling rules. The number of ECS instances to be adjusted in a single scaling activity cannot exceed 500. Value range:
               ...
               - TotalCapacity：[0, 1000]
        :param pulumi.Input['ScalingRuleAlarmDimensionArgs'] alarm_dimension: AlarmDimension for StepScalingRule. See `alarm_dimension` below.
        :param pulumi.Input[builtins.str] ari: The unique identifier of the scaling rule.
        :param pulumi.Input[builtins.int] cooldown: The cooldown time of the scaling rule. This parameter is applicable only to simple scaling rules. Value range: [0, 86,400], in seconds. The default value is empty，if not set, the return value will be 0, which is the default value of integer.
        :param pulumi.Input[builtins.bool] disable_scale_in: Indicates whether scale in by the target tracking policy is disabled. Default to false.
        :param pulumi.Input[builtins.int] estimated_instance_warmup: The estimated time, in seconds, until a newly launched instance will contribute CloudMonitor metrics. Default to 300.
        :param pulumi.Input[Sequence[pulumi.Input['ScalingRuleHybridMetricArgs']]] hybrid_metrics: The Hybrid Cloud Monitoring metrics. See `hybrid_metrics` below.
    ...
    @property
    @pulumi.getter
    def ari(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ari.setter
    def ari(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ScalingRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scaling_rule_type: Optional[pulumi.Input[builtins.str]] = None,
            step_adjustments: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ScalingRuleStepAdjustmentArgs', 'ScalingRuleStepAdjustmentArgsDict']]]]] = None,
            target_value: Optional[pulumi.Input[builtins.float]] = None) -> 'ScalingRule':
        """
    ...
    @property
    @pulumi.getter(name="adjustmentValue")
    def adjustment_value(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of ECS instances to be adjusted in the scaling rule. This parameter is required and applicable only to simple scaling rules. The number of ECS instances to be adjusted in a single scaling activity cannot exceed 500. Value range:
        - QuantityChangeInCapacity：(0, 500] U (-500, 0]
        - PercentChangeInCapacity：[0, 10000] U [-100, 0]
    ...
    @property
    @pulumi.getter
    def ari(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier of the scaling rule.
        """
        return pulumi.get(self, "ari")
    ...
    @property
    @pulumi.getter
    def cooldown(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The cooldown time of the scaling rule. This parameter is applicable only to simple scaling rules. Value range: [0, 86,400], in seconds. The default value is empty，if not set, the return value will be 0, which is the default value of integer.
        """
        return pulumi.get(self, "cooldown")
    ...
    @property
    @pulumi.getter(name="disableScaleIn")
    def disable_scale_in(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether scale in by the target tracking policy is disabled. Default to false.
        """
        return pulumi.get(self, "disable_scale_in")
    ...
    @property
    @pulumi.getter(name="estimatedInstanceWarmup")
    def estimated_instance_warmup(self) -> pulumi.Output[builtins.int]:
        """
        The estimated time, in seconds, until a newly launched instance will contribute CloudMonitor metrics. Default to 300.
        """
        return pulumi.get(self, "estimated_instance_warmup")
    ...
    @property
    @pulumi.getter(name="hybridMonitorNamespace")
    def hybrid_monitor_namespace(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Hybrid Cloud Monitoring metric repository.
        """
        return pulumi.get(self, "hybrid_monitor_namespace")
    ...
    @property
    @pulumi.getter(name="initialMaxSize")
    def initial_max_size(self) -> pulumi.Output[builtins.int]:
        """
        The maximum number of ECS instances that can be added to the scaling group. If you specify InitialMaxSize, you must also specify PredictiveValueBehavior.
        """
        return pulumi.get(self, "initial_max_size")
    ...
    @property
    @pulumi.getter(name="predictiveScalingMode")
    def predictive_scaling_mode(self) -> pulumi.Output[builtins.str]:
        """
        The mode of the predictive scaling rule. Valid values: PredictAndScale, PredictOnly.
        """
        return pulumi.get(self, "predictive_scaling_mode")
    ...
    @property
    @pulumi.getter(name="predictiveTaskBufferTime")
    def predictive_task_buffer_time(self) -> pulumi.Output[builtins.int]:
        """
        The amount of buffer time before the prediction task runs. By default, all prediction tasks that are automatically created by a predictive scaling rule run on the hour. You can specify a buffer time to run prediction tasks and prepare resources in advance. Valid values: 0 to 60. Unit: minutes.
        """
        return pulumi.get(self, "predictive_task_buffer_time")
    ...
    @property
    @pulumi.getter(name="predictiveValueBehavior")
    def predictive_value_behavior(self) -> pulumi.Output[builtins.str]:
        """
        The action on the predicted maximum value. Valid values: MaxOverridePredictiveValue, PredictiveValueOverrideMax, PredictiveValueOverrideMaxWithBuffer.
        """
        return pulumi.get(self, "predictive_value_behavior")
    ...
    @property
    @pulumi.getter(name="predictiveValueBuffer")
    def predictive_value_buffer(self) -> pulumi.Output[builtins.int]:
        """
        The ratio based on which the predicted value is increased if you set PredictiveValueBehavior to PredictiveValueOverrideMaxWithBuffer. If the predicted value increased by this ratio is greater than the initial maximum capacity, the increased value is used as the maximum value for prediction tasks. Valid values: 0 to 100.
        """
        return pulumi.get(self, "predictive_value_buffer")
    ...
    @property
    @pulumi.getter(name="scaleInEvaluationCount")
    def scale_in_evaluation_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of consecutive times that the event-triggered task created for scale-ins must meet the threshold conditions before an alert is triggered. After a target tracking scaling rule is created, an event-triggered task is automatically created and associated with the target tracking scaling rule.
        """
        return pulumi.get(self, "scale_in_evaluation_count")
    ...
    @property
    @pulumi.getter(name="scaleOutEvaluationCount")
    def scale_out_evaluation_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of consecutive times that the event-triggered task created for scale-outs must meet the threshold conditions before an alert is triggered. After a target tracking scaling rule is created, an event-triggered task is automatically created and associated with the target tracking scaling rule.
        """
        return pulumi.get(self, "scale_out_evaluation_count")
    ...
    @property
    @pulumi.getter(name="scalingRuleName")
    def scaling_rule_name(self) -> pulumi.Output[builtins.str]:
        """
        Name shown for the scaling rule, which must contain 2-64 characters (English or Chinese), starting with numbers, English letters or Chinese characters, and can contain number, underscores `_`, hypens `-`, and decimal point `.`. If this parameter value is not specified, the default value is scaling rule id.
        """
        return pulumi.get(self, "scaling_rule_name")
    ...
    @property
    @pulumi.getter(name="scalingRuleType")
    def scaling_rule_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The scaling rule type, either "SimpleScalingRule", "TargetTrackingScalingRule", "StepScalingRule", "PredictiveScalingRule". Default to "SimpleScalingRule".
        """
        return pulumi.get(self, "scaling_rule_type")
    ...
    @property
    @pulumi.getter(name="targetValue")
    def target_value(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The target value for the metric.
        """
        return pulumi.get(self, "target_value")
