...
class AlarmArgs:
    def __init__(__self__, *,
                 alarm_actions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 scaling_group_id: pulumi.Input[builtins.str],
                 cloud_monitor_group_id: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 expressions_logic_operator: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] alarm_actions: The list of actions to execute when this alarm transition into an ALARM state. Each action is specified as ess scaling rule ari.
        :param pulumi.Input[builtins.str] scaling_group_id: The scaling group associated with this alarm, the 'ForceNew' attribute is available in 1.56.0+.
        :param pulumi.Input[builtins.int] cloud_monitor_group_id: Defines the application group id defined by CMS which is assigned when you upload custom metric to CMS, only available for custom metirc.
        ...
        :param pulumi.Input[builtins.str] description: The description for the alarm.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] dimensions: The dimension map for the alarm's associated metric. For all metrics, you can not set the dimension key as "scaling_group" or "userId", which is set by default, the second dimension for metric, such as "device" for "PackagesNetIn", need to be set by users. See `dimensions` below.
        :param pulumi.Input[builtins.str] effective: The effective period of the event-triggered task. By default, the event-triggered task is in effect at all times.
        :param pulumi.Input[builtins.bool] enable: Whether to enable specific ess alarm. Default to true.
        :param pulumi.Input[builtins.int] evaluation_count: The number of times that needs to satisfies comparison condition before transition into ALARM state. Defaults to 3.
        ...
        :param pulumi.Input[builtins.str] expressions_logic_operator: The relationship between the trigger conditions in the multi-metric alert rule.
        :param pulumi.Input[builtins.str] metric_name: The name for the alarm's associated metric. See `dimensions` below for details.
        :param pulumi.Input[builtins.str] metric_type: The type for the alarm's associated metric. Supported value: system, custom. "system" means the metric data is collected by Aliyun Cloud Monitor Service(CMS), "custom" means the metric data is upload to CMS by users. Defaults to system.
        :param pulumi.Input[builtins.str] name: The name for ess alarm.
        ...
        :param pulumi.Input[builtins.str] threshold: The value against which the specified statistics is compared.
        """
    ...
    def alarm_actions(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def alarm_actions(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def cloud_monitor_group_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cloud_monitor_group_id(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def expressions_logic_operator(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def expressions_logic_operator(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AlarmState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] period: The period in seconds over which the specified statistic is applied. Supported value: 60, 120, 300, 900. Defaults to 300.
        :param pulumi.Input[builtins.str] scaling_group_id: The scaling group associated with this alarm, the 'ForceNew' attribute is available in 1.56.0+.
        :param pulumi.Input[builtins.str] state: The status of the event-triggered task. Valid values:
...
class Alarm(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            statistics: Optional[pulumi.Input[builtins.str]] = None,
            threshold: Optional[pulumi.Input[builtins.str]] = None) -> 'Alarm':
        """
    ...
    @property
    @pulumi.getter(name="alarmActions")
    def alarm_actions(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of actions to execute when this alarm transition into an ALARM state. Each action is specified as ess scaling rule ari.
        """
        return pulumi.get(self, "alarm_actions")
    ...
    @property
    @pulumi.getter(name="cloudMonitorGroupId")
    def cloud_monitor_group_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Defines the application group id defined by CMS which is assigned when you upload custom metric to CMS, only available for custom metirc.
        """
        return pulumi.get(self, "cloud_monitor_group_id")
    ...
    @property
    @pulumi.getter
    def effective(self) -> pulumi.Output[builtins.str]:
        """
        The effective period of the event-triggered task. By default, the event-triggered task is in effect at all times.
        """
        return pulumi.get(self, "effective")
    ...
    @property
    @pulumi.getter(name="evaluationCount")
    def evaluation_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of times that needs to satisfies comparison condition before transition into ALARM state. Defaults to 3.
        """
        return pulumi.get(self, "evaluation_count")
    ...
    @property
    @pulumi.getter(name="expressionsLogicOperator")
    def expressions_logic_operator(self) -> pulumi.Output[builtins.str]:
        """
        The relationship between the trigger conditions in the multi-metric alert rule.
        """
        return pulumi.get(self, "expressions_logic_operator")
    ...
    @property
    @pulumi.getter(name="metricType")
    def metric_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type for the alarm's associated metric. Supported value: system, custom. "system" means the metric data is collected by Aliyun Cloud Monitor Service(CMS), "custom" means the metric data is upload to CMS by users. Defaults to system.
        """
        return pulumi.get(self, "metric_type")
    ...
    @property
    @pulumi.getter
    def threshold(self) -> pulumi.Output[builtins.str]:
        """
        The value against which the specified statistics is compared.
        """
        return pulumi.get(self, "threshold")
