...
class AttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] lifecycle_hook: Specifies whether to trigger a lifecycle hook for the scaling group to which instances are being added.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] load_balancer_weights: The weight of ECS instance N or elastic container instance N as a backend server of the associated Server Load Balancer (SLB) instance. Valid values of N: 1 to 20. Valid values of this parameter: 1 to 100.
...
class Attachment(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def entrusted(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether the scaling group manages the lifecycles of the instances that are manually added to the scaling group.
        """
        return pulumi.get(self, "entrusted")
    ...
    @_builtins.property
    @pulumi.getter(name="lifecycleHook")
    def lifecycle_hook(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether to trigger a lifecycle hook for the scaling group to which instances are being added.
        """
        return pulumi.get(self, "lifecycle_hook")
    ...
    @_builtins.property
    @pulumi.getter(name="loadBalancerWeights")
    def load_balancer_weights(self) -> pulumi.Output[Sequence[_builtins.int]]:
        """
        The weight of ECS instance N or elastic container instance N as a backend server of the associated Server Load Balancer (SLB) instance. Valid values of N: 1 to 20. Valid values of this parameter: 1 to 100.
