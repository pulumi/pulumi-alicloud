...
class AttachmentArgs:
    def __init__(__self__, *,
                 ...
                 load_balancer_weights: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None):
        """
        The set of arguments for constructing a Attachment resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_ids: ID of the ECS instance to be attached to the scaling group. You can input up to 20 IDs.
        :param pulumi.Input[builtins.str] scaling_group_id: ID of the scaling group of a scaling configuration.
        :param pulumi.Input[builtins.bool] entrusted: Specifies whether the scaling group manages the lifecycles of the instances that are manually added to the scaling group.
        :param pulumi.Input[builtins.bool] force: Whether to remove forcibly "AutoCreated" ECS instances in order to release scaling group capacity "MaxSize" for attaching ECS instances. Default to false.
        :param pulumi.Input[builtins.bool] lifecycle_hook: Specifies whether to trigger a lifecycle hook for the scaling group to which instances are being added.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] load_balancer_weights: The weight of ECS instance N or elastic container instance N as a backend server of the associated Server Load Balancer (SLB) instance. Valid values of N: 1 to 20. Valid values of this parameter: 1 to 100.
    ...
    def load_balancer_weights(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
    ...
    def load_balancer_weights(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
...
class Attachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            lifecycle_hook: Optional[pulumi.Input[builtins.bool]] = None,
            load_balancer_weights: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
            scaling_group_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Attachment':
        """
    ...
    @property
    @pulumi.getter
    def entrusted(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the scaling group manages the lifecycles of the instances that are manually added to the scaling group.
        """
        return pulumi.get(self, "entrusted")
    ...
    @property
    @pulumi.getter(name="lifecycleHook")
    def lifecycle_hook(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to trigger a lifecycle hook for the scaling group to which instances are being added.
        """
        return pulumi.get(self, "lifecycle_hook")
    ...
    @property
    @pulumi.getter(name="loadBalancerWeights")
    def load_balancer_weights(self) -> pulumi.Output[Sequence[builtins.int]]:
        """
        The weight of ECS instance N or elastic container instance N as a backend server of the associated Server Load Balancer (SLB) instance. Valid values of N: 1 to 20. Valid values of this parameter: 1 to 100.
