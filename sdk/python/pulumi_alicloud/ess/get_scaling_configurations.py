...
def get_scaling_configurations(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of scaling configuration IDs.
    :param builtins.str name_regex: A regex string to filter resulting scaling configurations by name.
...
def get_scaling_configurations_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
