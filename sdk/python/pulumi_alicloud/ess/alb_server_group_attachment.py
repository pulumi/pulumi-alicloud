...
class AlbServerGroupAttachmentArgs:
    def __init__(__self__, *,
                 alb_server_group_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] alb_server_group_id: ID of Alb Server Group.
        :param pulumi.Input[builtins.int] port: The port will be used for Alb Server Group backend server.
        :param pulumi.Input[builtins.str] scaling_group_id: ID of the scaling group.
        :param pulumi.Input[builtins.int] weight: The weight of an ECS instance attached to the Alb Server Group.
        :param pulumi.Input[builtins.bool] force_attach: If instances of scaling group are attached/removed from slb backend server when attach/detach alb
    ...
    def alb_server_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def alb_server_group_id(self, value: pulumi.Input[builtins.str]):
...
class AlbServerGroupAttachment(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:ess/albServerGroupAttachment:AlbServerGroupAttachment"
    ...
    def get(resource_name: str,
            ...
            port: Optional[pulumi.Input[builtins.int]] = None,
            scaling_group_id: Optional[pulumi.Input[builtins.str]] = None,
            weight: Optional[pulumi.Input[builtins.int]] = None) -> 'AlbServerGroupAttachment':
        """
    ...
    @property
    @pulumi.getter(name="albServerGroupId")
    def alb_server_group_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of Alb Server Group.
        """
        return pulumi.get(self, "alb_server_group_id")
