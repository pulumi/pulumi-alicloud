...
def get_scaling_rules(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of scaling rule IDs.
    :param builtins.str name_regex: A regex string to filter resulting scaling rules by name.
...
def get_scaling_rules_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             scaling_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
