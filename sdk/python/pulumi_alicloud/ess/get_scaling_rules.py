...
def get_scaling_rules(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of scaling rule IDs.
    :param _builtins.str name_regex: A regex string to filter resulting scaling rules by name.
...
def get_scaling_rules_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
