...
def get_lifecycle_hooks(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of lifecycle hook IDs.
    :param _builtins.str name_regex: A regex string to filter resulting lifecycle hook by name.
...
def get_lifecycle_hooks_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
