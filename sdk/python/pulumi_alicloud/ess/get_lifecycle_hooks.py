...
def get_lifecycle_hooks(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of lifecycle hook IDs.
    :param builtins.str name_regex: A regex string to filter resulting lifecycle hook by name.
...
def get_lifecycle_hooks_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
