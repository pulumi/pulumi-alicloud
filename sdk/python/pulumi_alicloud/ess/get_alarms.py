...
def get_alarms(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of alarm IDs.
    ...
    :param builtins.str name_regex: A regex string to filter resulting alarms by name.
...
def get_alarms_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                      metric_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
