...
class NotificationArgs:
    def __init__(__self__, *,
                 notification_arn: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] notification_arn: The Alibaba Cloud Resource Name (ARN) of the notification object, The value must be in `acs:ess:{region}:{account-id}:{resource-relative-id}` format.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] notification_types: The notification types of Auto Scaling events and resource changes. Supported notification types: 'AUTOSCALING:SCALE_OUT_SUCCESS', 'AUTOSCALING:SCALE_IN_SUCCESS', 'AUTOSCALING:SCALE_OUT_ERROR', 'AUTOSCALING:SCALE_IN_ERROR', 'AUTOSCALING:SCALE_REJECT', 'AUTOSCALING:SCALE_OUT_START', 'AUTOSCALING:SCALE_IN_START', 'AUTOSCALING:SCHEDULE_TASK_EXPIRING'.
        :param pulumi.Input[builtins.str] scaling_group_id: The ID of the Auto Scaling group.
        :param pulumi.Input[builtins.str] time_zone: The time zone of the notification. Specify the value in UTC. For example, a value of UTC+8 specifies that the time is 8 hours ahead of Coordinated Universal Time, and a value of UTC-7 specifies that the time is 7 hours behind Coordinated Universal Time.
        """
    ...
    def notification_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def notification_arn(self, value: pulumi.Input[builtins.str]):
...
class _NotificationState:
    def __init__(__self__, *,
                 notification_arn: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="notificationArn")
    def notification_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Alibaba Cloud Resource Name (ARN) of the notification object, The value must be in `acs:ess:{region}:{account-id}:{resource-relative-id}` format.
        * region: the region ID of the scaling group. For more information, see `Regions and zones`
        * account-id: the ID of your account.
    ...
    @notification_arn.setter
    def notification_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "notification_arn", value)
...
class Notification(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            notification_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            scaling_group_id: Optional[pulumi.Input[builtins.str]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None) -> 'Notification':
        """
    ...
    @property
    @pulumi.getter(name="notificationArn")
    def notification_arn(self) -> pulumi.Output[builtins.str]:
        """
        The Alibaba Cloud Resource Name (ARN) of the notification object, The value must be in `acs:ess:{region}:{account-id}:{resource-relative-id}` format.
        * region: the region ID of the scaling group. For more information, see `Regions and zones`
        * account-id: the ID of your account.
    ...
    @property
    @pulumi.getter(name="notificationTypes")
    def notification_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The notification types of Auto Scaling events and resource changes. Supported notification types: 'AUTOSCALING:SCALE_OUT_SUCCESS', 'AUTOSCALING:SCALE_IN_SUCCESS', 'AUTOSCALING:SCALE_OUT_ERROR', 'AUTOSCALING:SCALE_IN_ERROR', 'AUTOSCALING:SCALE_REJECT', 'AUTOSCALING:SCALE_OUT_START', 'AUTOSCALING:SCALE_IN_START', 'AUTOSCALING:SCHEDULE_TASK_EXPIRING'.
        """
        return pulumi.get(self, "notification_types")
