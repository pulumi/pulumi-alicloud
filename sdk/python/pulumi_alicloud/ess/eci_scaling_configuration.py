...
class EciScalingConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 auto_create_eip: Optional[pulumi.Input[builtins.bool]] = None,
                 auto_match_image_cache: Optional[pulumi.Input[builtins.bool]] = None,
                 container_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 containers: Optional[pulumi.Input[Sequence[pulumi.Input['EciScalingConfigurationContainerArgs']]]] = None,
                 cost_optimization: Optional[pulumi.Input[builtins.bool]] = None,
                 cpu: Optional[pulumi.Input[builtins.float]] = None,
                 cpu_options_core: Optional[pulumi.Input[builtins.int]] = None,
                 cpu_options_threads_per_core: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 egress_bandwidth: Optional[pulumi.Input[builtins.int]] = None,
                 eip_bandwidth: Optional[pulumi.Input[builtins.int]] = None,
                 enable_sls: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 image_snapshot_id: Optional[pulumi.Input[builtins.str]] = None,
                 ingress_bandwidth: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 load_balancer_weight: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] scaling_group_id: ID of the scaling group of a eci scaling configuration.
        ...
        :param pulumi.Input[builtins.bool] active: Whether active current eci scaling configuration in the specified scaling group. Note that only
               one configuration can be active. Default to `false`.
        :param pulumi.Input[builtins.int] active_deadline_seconds: The duration in seconds relative to the startTime that the job may be active before the system tries to terminate it.
        :param pulumi.Input[builtins.bool] auto_create_eip: Whether create eip automatically.
        :param pulumi.Input[builtins.bool] auto_match_image_cache: Whether to automatically match the image cache.
        :param pulumi.Input[builtins.str] container_group_name: The name series of the elastic container instances created from the scaling configuration. If you want to use an ordered instance name, specify the value for this parameter in the following format: name_prefix(AUTO_INCREMENT)[begin_number,bits]name_suffix.
        ...
        :param pulumi.Input[builtins.bool] cost_optimization: Indicates whether the Cost Optimization feature is enabled. Valid values: true,false.
        :param pulumi.Input[builtins.float] cpu: The amount of CPU resources allocated to the container group.
        :param pulumi.Input[builtins.int] cpu_options_core: The number of physical CPU cores. You can specify this parameter for only specific instance types.
        :param pulumi.Input[builtins.int] cpu_options_threads_per_core: The number of threads per core. You can specify this parameter for only specific instance types. If you set this parameter to 1, Hyper-Threading is disabled.
        :param pulumi.Input[builtins.str] description: The description of data disk N. Valid values of N: 1 to 16. The description must be 2 to
        ...
        :param pulumi.Input[Sequence[pulumi.Input['EciScalingConfigurationDnsConfigOptionArgs']]] dns_config_options: The options. Each option is a name-value pair. The value in the name-value pair is optional.   See `dns_config_options` below for
               details.
        :param pulumi.Input[builtins.str] dns_policy: dns policy of contain group.
        :param pulumi.Input[builtins.int] egress_bandwidth: egress bandwidth.
        :param pulumi.Input[builtins.int] eip_bandwidth: Eip bandwidth.
        :param pulumi.Input[builtins.bool] enable_sls: Enable sls log service.
        :param pulumi.Input[builtins.int] ephemeral_storage: The size of ephemeral storage.
        :param pulumi.Input[builtins.bool] force_delete: The eci scaling configuration will be deleted forcibly with deleting its scaling group.
               Default to false.
        ...
        :param pulumi.Input[builtins.str] host_name: Hostname of an ECI instance.
        :param pulumi.Input[Sequence[pulumi.Input['EciScalingConfigurationImageRegistryCredentialArgs']]] image_registry_credentials: The image registry credential.   See `image_registry_credentials` below for
               details.
        :param pulumi.Input[builtins.str] image_snapshot_id: The ID of image cache.
        :param pulumi.Input[builtins.int] ingress_bandwidth: Ingress bandwidth.
        ...
        :param pulumi.Input[builtins.str] instance_family_level: The level of the instance family, which is used to filter instance types that meet the specified criteria. This parameter takes effect only if you set CostOptimization to true. Valid values: EntryLevel, EnterpriseLevel, CreditEntryLevel.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_types: The specified ECS instance types. You can specify up to five ECS instance types.
        :param pulumi.Input[builtins.int] ipv6_address_count: Number of IPv6 addresses.
        :param pulumi.Input[builtins.int] load_balancer_weight: The weight of an ECI instance attached to the Server Group.
        :param pulumi.Input[builtins.float] memory: The amount of memory resources allocated to the container group.
        :param pulumi.Input[builtins.str] ram_role_name: The RAM role that the container group assumes. ECI and ECS share the same RAM role.
        :param pulumi.Input[builtins.str] resource_group_id: ID of resource group.
        :param pulumi.Input[builtins.str] restart_policy: The restart policy of the container group. Default to `Always`.
        :param pulumi.Input[builtins.str] scaling_configuration_name: Name shown for the scheduled task. which must contain 2-64 characters (
        ...
        :param pulumi.Input[Sequence[pulumi.Input['EciScalingConfigurationSecurityContextSysctlArgs']]] security_context_sysctls: The system information about the security context in which the elastic container instance is run.   See `security_context_sysctls` below for
               details.
        :param pulumi.Input[builtins.str] security_group_id: ID of the security group used to create new instance. It is conflict
               with `security_group_ids`.
        :param pulumi.Input[builtins.float] spot_price_limit: The maximum price hourly for spot instance.
        :param pulumi.Input[builtins.str] spot_strategy: The spot strategy for a Pay-As-You-Go instance. Valid values: `NoSpot`, `SpotAsPriceGo`
               , `SpotWithPriceLimit`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource. It will be applied for ECI instances finally.
               ...
               a null string.
        :param pulumi.Input[builtins.int] termination_grace_period_seconds: The program's buffering time before closing.
    ...
    def auto_create_eip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_create_eip(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_create_eip", value)

    @property
    @pulumi.getter(name="autoMatchImageCache")
    def auto_match_image_cache(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_match_image_cache(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_match_image_cache", value)

    @property
    @pulumi.getter(name="containerGroupName")
    def container_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def container_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def cost_optimization(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def cost_optimization(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def cpu_options_core(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cpu_options_core(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cpu_options_core", value)

    @property
    @pulumi.getter(name="cpuOptionsThreadsPerCore")
    def cpu_options_threads_per_core(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cpu_options_threads_per_core(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def egress_bandwidth(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        egress bandwidth.
        """
    ...
    def egress_bandwidth(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def enable_sls(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @enable_sls.setter
    def enable_sls(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def image_snapshot_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def image_snapshot_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "image_snapshot_id", value)

    @property
    @pulumi.getter(name="ingressBandwidth")
    def ingress_bandwidth(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Ingress bandwidth.
        """
    ...
    def ingress_bandwidth(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def load_balancer_weight(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def load_balancer_weight(self, value: Optional[pulumi.Input[builtins.int]]):
...
class EciScalingConfiguration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="activeDeadlineSeconds")
    def active_deadline_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The duration in seconds relative to the startTime that the job may be active before the system tries to terminate it.
        """
        return pulumi.get(self, "active_deadline_seconds")
    ...
    @property
    @pulumi.getter(name="autoCreateEip")
    def auto_create_eip(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether create eip automatically.
        """
        return pulumi.get(self, "auto_create_eip")
    ...
    @property
    @pulumi.getter(name="autoMatchImageCache")
    def auto_match_image_cache(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to automatically match the image cache.
        """
        return pulumi.get(self, "auto_match_image_cache")
    ...
    @property
    @pulumi.getter(name="containerGroupName")
    def container_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name series of the elastic container instances created from the scaling configuration. If you want to use an ordered instance name, specify the value for this parameter in the following format: name_prefix(AUTO_INCREMENT)[begin_number,bits]name_suffix.
        name_prefix: the prefix of the hostname.
        (AUTO_INCREMENT): the sort method. This is a static field.
    ...
    @property
    @pulumi.getter(name="costOptimization")
    def cost_optimization(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the Cost Optimization feature is enabled. Valid values: true,false.
        """
        return pulumi.get(self, "cost_optimization")
    ...
    @property
    @pulumi.getter(name="cpuOptionsCore")
    def cpu_options_core(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of physical CPU cores. You can specify this parameter for only specific instance types.
        """
        return pulumi.get(self, "cpu_options_core")
    ...
    @property
    @pulumi.getter(name="cpuOptionsThreadsPerCore")
    def cpu_options_threads_per_core(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of threads per core. You can specify this parameter for only specific instance types. If you set this parameter to 1, Hyper-Threading is disabled.
        """
        return pulumi.get(self, "cpu_options_threads_per_core")
    ...
    @property
    @pulumi.getter(name="dnsPolicy")
    def dns_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        dns policy of contain group.
        """
        return pulumi.get(self, "dns_policy")
    ...
    @property
    @pulumi.getter(name="egressBandwidth")
    def egress_bandwidth(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        egress bandwidth.
        """
        return pulumi.get(self, "egress_bandwidth")
    ...
    @property
    @pulumi.getter(name="enableSls")
    def enable_sls(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable sls log service.
        """
        return pulumi.get(self, "enable_sls")
    ...
    @property
    @pulumi.getter(name="ephemeralStorage")
    def ephemeral_storage(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The size of ephemeral storage.
        """
        return pulumi.get(self, "ephemeral_storage")
    ...
    @property
    @pulumi.getter(name="imageSnapshotId")
    def image_snapshot_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of image cache.
        """
        return pulumi.get(self, "image_snapshot_id")
    ...
    @property
    @pulumi.getter(name="ingressBandwidth")
    def ingress_bandwidth(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Ingress bandwidth.
        """
        return pulumi.get(self, "ingress_bandwidth")
    ...
    @property
    @pulumi.getter(name="instanceFamilyLevel")
    def instance_family_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The level of the instance family, which is used to filter instance types that meet the specified criteria. This parameter takes effect only if you set CostOptimization to true. Valid values: EntryLevel, EnterpriseLevel, CreditEntryLevel.
        """
        return pulumi.get(self, "instance_family_level")
    ...
    @property
    @pulumi.getter(name="loadBalancerWeight")
    def load_balancer_weight(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The weight of an ECI instance attached to the Server Group.
        """
        return pulumi.get(self, "load_balancer_weight")
    ...
    @property
    @pulumi.getter
    def memory(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The amount of memory resources allocated to the container group.
        """
        return pulumi.get(self, "memory")
    ...
    @property
    @pulumi.getter(name="terminationGracePeriodSeconds")
    def termination_grace_period_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The program's buffering time before closing.
        """
        return pulumi.get(self, "termination_grace_period_seconds")
