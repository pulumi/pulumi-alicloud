...
class ScalingGroupVServerGroupsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] force: If instances of scaling group are attached/removed from slb backend server when attach/detach vserver group from scaling group. Default to true.
        """
