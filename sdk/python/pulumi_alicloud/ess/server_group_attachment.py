...
class ServerGroupAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] port: The port will be used for Server Group backend server.
        :param pulumi.Input[builtins.str] scaling_group_id: ID of the scaling group.
        :param pulumi.Input[builtins.str] server_group_id: ID of Server Group.
        :param pulumi.Input[builtins.str] type: The type of server group N. Valid values: ALB, NLB.
        :param pulumi.Input[builtins.int] weight: The weight of an ECS instance attached to the Server Group.
        :param pulumi.Input[builtins.bool] force_attach: If instances of scaling group are attached/removed from backend server when
...
class ServerGroupAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            server_group_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            weight: Optional[pulumi.Input[builtins.int]] = None) -> 'ServerGroupAttachment':
        """
    ...
    @property
    @pulumi.getter(name="forceAttach")
    def force_attach(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If instances of scaling group are attached/removed from backend server when
        server group from scaling group. Default to false.
        """
