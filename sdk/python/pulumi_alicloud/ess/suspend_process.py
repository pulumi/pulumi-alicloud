...
class SuspendProcessArgs:
    def __init__(__self__, *,
                 process: pulumi.Input[builtins.str],
                 scaling_group_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a SuspendProcess resource.
        :param pulumi.Input[builtins.str] process: Activity type N that you want to suspend. Valid values are: `SCALE_OUT`,`SCALE_IN`,`HealthCheck`,`AlarmNotification` and `ScheduledAction`.
    ...
    @property
    @pulumi.getter
    def process(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @process.setter
    def process(self, value: pulumi.Input[builtins.str]):
...
class _SuspendProcessState:
    def __init__(__self__, *,
                 process: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def process(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Activity type N that you want to suspend. Valid values are: `SCALE_OUT`,`SCALE_IN`,`HealthCheck`,`AlarmNotification` and `ScheduledAction`.
        """
        return pulumi.get(self, "process")
    ...
    @process.setter
    def process(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "process", value)
...
class SuspendProcess(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            process: Optional[pulumi.Input[builtins.str]] = None,
            scaling_group_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SuspendProcess':
        """
    ...
    @property
    @pulumi.getter
    def process(self) -> pulumi.Output[builtins.str]:
        """
        Activity type N that you want to suspend. Valid values are: `SCALE_OUT`,`SCALE_IN`,`HealthCheck`,`AlarmNotification` and `ScheduledAction`.
        """
        return pulumi.get(self, "process")
