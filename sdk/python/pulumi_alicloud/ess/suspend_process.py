...
class SuspendProcessArgs:
    def __init__(__self__, *,
                 process: pulumi.Input[_builtins.str],
    ...
    @_builtins.property
    @pulumi.getter
    def process(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @process.setter
    def process(self, value: pulumi.Input[_builtins.str]):
...
class SuspendProcess(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def process(self) -> pulumi.Output[_builtins.str]:
        """
        Activity type N that you want to suspend. Valid values are: `SCALE_OUT`,`SCALE_IN`,`HealthCheck`,`AlarmNotification` and `ScheduledAction`.
        """
        return pulumi.get(self, "process")
