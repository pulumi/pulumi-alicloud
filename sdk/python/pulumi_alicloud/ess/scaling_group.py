...
class ScalingGroupArgs:
    def __init__(__self__, *,
                 ...
                 az_balance: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 group_deletion_protection: Optional[pulumi.Input[builtins.bool]] = None,
                 group_type: Optional[pulumi.Input[builtins.str]] = None,
                 health_check_type: Optional[pulumi.Input[builtins.str]] = None,
                 health_check_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 loadbalancer_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 max_instance_lifetime: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 protected_instances: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 removal_policies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 stop_instance_timeout: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] max_size: Maximum number of ECS instances in the scaling group. Value range: [0, 2000].
               **NOTE:** From version 1.204.1, `max_size` can be set to `2000`.
        :param pulumi.Input[builtins.int] min_size: Minimum number of ECS instances in the scaling group. Value range: [0, 2000].
        ...
        :param pulumi.Input[builtins.str] allocation_strategy: The allocation policy of instances. Auto Scaling selects instance types based on the allocation policy to create instances. The policy can be applied to pay-as-you-go instances and preemptible instances. This parameter takes effect only if you set MultiAZPolicy to COMPOSABLE.
        :param pulumi.Input[builtins.bool] az_balance: Specifies whether to evenly distribute instances in the scaling group across multiple zones. This parameter takes effect only if you set MultiAZPolicy to COMPOSABLE.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] db_instance_ids: If an RDS instance is specified in the scaling group, the scaling group automatically attaches the Intranet IP addresses of its ECS instances to the RDS access whitelist.
               - The specified RDS instance must be in running status.
               - The specified RDS instance’s whitelist must have room for more IP addresses.
        :param pulumi.Input[builtins.int] default_cooldown: Default cool-down time (in seconds) of the scaling group. Value range: [0, 86400]. The default value is 300s.
        :param pulumi.Input[builtins.int] desired_capacity: Expected number of ECS instances in the scaling group. Value range: [min_size, max_size].
        :param pulumi.Input[builtins.bool] group_deletion_protection: Specifies whether the scaling group deletion protection is enabled. `true` or `false`, Default value: `false`.
        :param pulumi.Input[builtins.str] group_type: Resource type within scaling group. Optional values: ECS, ECI. Default to ECS.
        :param pulumi.Input[builtins.str] health_check_type: Resource type within scaling group. Optional values: ECS, ECI, NONE, LOAD_BALANCER. Default to ECS.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] health_check_types: The health check modes of the scaling group. Valid values: ECS, NONE, LOAD_BALANCER.
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance from which Auto Scaling obtains the required configuration information and uses the information to automatically create a scaling configuration.
        :param pulumi.Input[builtins.str] launch_template_id: Instance launch template ID, scaling group obtains launch configuration from instance launch template, see [Launch Template](https://www.alibabacloud.com/help/doc-detail/73916.html). Creating scaling group from launch template enable group automatically.
        ...
        :param pulumi.Input[builtins.str] launch_template_version: The version number of the launch template. Valid values are the version number, `Latest`, or `Default`, Default value: `Default`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] loadbalancer_ids: If a Server Load Balancer instance is specified in the scaling group, the scaling group automatically attaches its ECS instances to the Server Load Balancer instance.
        ...
        :param pulumi.Input[builtins.int] max_instance_lifetime: The maximum life span of an instance in the scaling group. Unit: seconds.
        :param pulumi.Input[builtins.str] multi_az_policy: Multi-AZ scaling group ECS instance expansion and contraction strategy. PRIORITY, COMPOSABLE, BALANCE or COST_OPTIMIZED(Available since v1.54.0).
        :param pulumi.Input[builtins.int] on_demand_base_capacity: The minimum amount of the Auto Scaling group's capacity that must be fulfilled by On-Demand Instances. This base portion is provisioned first as your group scales.
        :param pulumi.Input[builtins.int] on_demand_percentage_above_base_capacity: Controls the percentages of On-Demand Instances and Spot Instances for your additional capacity beyond OnDemandBaseCapacity.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] protected_instances: Set or unset instances within group into protected status.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] removal_policies: RemovalPolicy is used to select the ECS instances you want to remove from the scaling group when multiple candidates for removal exist. Optional values:
               - OldestInstance: removes the ECS instance that is added to the scaling group at the earliest point in time.
               - NewestInstance: removes the ECS instance that is added to the scaling group at the latest point in time.
               - OldestScalingConfiguration: removes the ECS instance that is created based on the earliest scaling configuration.
               - Default values: Default value of RemovalPolicy.1: OldestScalingConfiguration. Default value of RemovalPolicy.2: OldestInstance.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which you want to add the scaling group.
        :param pulumi.Input[builtins.str] scaling_group_name: Name shown for the scaling group, which must contain 2-64 characters (English or Chinese), starting with numbers, English letters or Chinese characters, and can contain numbers, underscores `_`, hyphens `-`, and decimal points `.`. If this parameter is not specified, the default value is ScalingGroupId.
        :param pulumi.Input[builtins.str] scaling_policy: The reclaim mode of the scaling group. Optional values: recycle, release, forceRecycle, forceRelease.
        :param pulumi.Input[builtins.str] spot_allocation_strategy: The allocation policy of preemptible instances. You can use this parameter to individually specify the allocation policy for preemptible instances. This parameter takes effect only if you set MultiAZPolicy to COMPOSABLE.
        :param pulumi.Input[builtins.int] spot_instance_pools: The number of Spot pools to use to allocate your Spot capacity. The Spot pools is composed of instance types of lowest price.
        ...
        :param pulumi.Input[builtins.int] stop_instance_timeout: The period of time required by the ECS instance to enter the Stopped state. Unit: seconds. Valid values: 30 to 240.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
               - Key: It can be up to 64 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It cannot be a null string.
               - Value: It can be up to 128 characters in length. It cannot begin with "aliyun", "acs:", "http://", or "https://". It can be a null string.
        :param pulumi.Input[builtins.str] vswitch_id: It has been deprecated from version 1.7.1 and new field 'vswitch_ids' replaces it.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vswitch_ids: List of virtual switch IDs in which the ecs instances to be launched.
        """
    ...
    def az_balance(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @az_balance.setter
    def az_balance(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "az_balance", value)

    @property
    @pulumi.getter(name="capacityOptionsCompensateWithOnDemand")
    def capacity_options_compensate_with_on_demand(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to automatically create pay-as-you-go instances to meet the requirement on the number of ECS instances when the expected capacity of preemptible instances cannot be provided due to reasons such as cost-related issues and insufficient resources. This parameter is supported only if you set 'multi_az_policy' to COST_OPTIMIZED. Valid values: true, false.
        """
    ...
    def capacity_options_compensate_with_on_demand(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "capacity_options_compensate_with_on_demand", value)

    @property
    @pulumi.getter(name="capacityOptionsOnDemandBaseCapacity")
    def capacity_options_on_demand_base_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The minimum number of pay-as-you-go instances that must be contained in the scaling group. When the actual number of pay-as-you-go instances in the scaling group drops below the value of this parameter, Auto Scaling preferentially creates pay-as-you-go instances. Valid values: 0 to 1000. If you set 'multi_az_policy' to COMPOSABLE, the default value of this parameter is 0.
        """
    ...
    def capacity_options_on_demand_base_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def capacity_options_on_demand_percentage_above_base_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def capacity_options_spot_auto_replace_on_demand(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def container_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def container_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def group_deletion_protection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def group_deletion_protection(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def health_check_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def health_check_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def loadbalancer_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def loadbalancer_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "loadbalancer_ids", value)

    @property
    @pulumi.getter(name="maxInstanceLifetime")
    def max_instance_lifetime(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_instance_lifetime(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def protected_instances(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def protected_instances(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "protected_instances", value)

    @property
    @pulumi.getter(name="removalPolicies")
    def removal_policies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def removal_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def stop_instance_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def stop_instance_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ScalingGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ScalingGroup':
        """
    ...
    @property
    @pulumi.getter(name="allocationStrategy")
    def allocation_strategy(self) -> pulumi.Output[builtins.str]:
        """
        The allocation policy of instances. Auto Scaling selects instance types based on the allocation policy to create instances. The policy can be applied to pay-as-you-go instances and preemptible instances. This parameter takes effect only if you set MultiAZPolicy to COMPOSABLE.
        """
        return pulumi.get(self, "allocation_strategy")
    ...
    @property
    @pulumi.getter(name="azBalance")
    def az_balance(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to evenly distribute instances in the scaling group across multiple zones. This parameter takes effect only if you set MultiAZPolicy to COMPOSABLE.
        """
        return pulumi.get(self, "az_balance")
    ...
    @property
    @pulumi.getter(name="capacityOptionsCompensateWithOnDemand")
    def capacity_options_compensate_with_on_demand(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to automatically create pay-as-you-go instances to meet the requirement on the number of ECS instances when the expected capacity of preemptible instances cannot be provided due to reasons such as cost-related issues and insufficient resources. This parameter is supported only if you set 'multi_az_policy' to COST_OPTIMIZED. Valid values: true, false.
        """
        return pulumi.get(self, "capacity_options_compensate_with_on_demand")
    ...
    @property
    @pulumi.getter(name="capacityOptionsOnDemandBaseCapacity")
    def capacity_options_on_demand_base_capacity(self) -> pulumi.Output[builtins.int]:
        """
        The minimum number of pay-as-you-go instances that must be contained in the scaling group. When the actual number of pay-as-you-go instances in the scaling group drops below the value of this parameter, Auto Scaling preferentially creates pay-as-you-go instances. Valid values: 0 to 1000. If you set 'multi_az_policy' to COMPOSABLE, the default value of this parameter is 0.
        """
        return pulumi.get(self, "capacity_options_on_demand_base_capacity")
    ...
    @property
    @pulumi.getter(name="capacityOptionsOnDemandPercentageAboveBaseCapacity")
    def capacity_options_on_demand_percentage_above_base_capacity(self) -> pulumi.Output[builtins.int]:
        """
        The percentage of pay-as-you-go instances in the excess instances when the minimum number of pay-as-you-go instances is reached. 'on_demand_base_capacity' specifies the minimum number of pay-as-you-go instances that must be contained in the scaling group. Valid values: 0 to 100. If you set 'multi_az_policy' to COMPOSABLE, the default value of this parameter is 100.
        """
        return pulumi.get(self, "capacity_options_on_demand_percentage_above_base_capacity")
    ...
    @property
    @pulumi.getter(name="compensateWithOnDemand")
    def compensate_with_on_demand(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to automatically create pay-as-you-go instances to meet the requirement on the number of ECS instances when the expected capacity of preemptible instances cannot be provided due to reasons such as cost-related issues and insufficient resources. This parameter is supported only if you set 'multi_az_policy' to COST_OPTIMIZED. Valid values: true, false.
        """
        return pulumi.get(self, "compensate_with_on_demand")
    ...
    @property
    @pulumi.getter(name="containerGroupId")
    def container_group_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the elastic container instance.
        """
        return pulumi.get(self, "container_group_id")
    ...
    @property
    @pulumi.getter(name="dbInstanceIds")
    def db_instance_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        If an RDS instance is specified in the scaling group, the scaling group automatically attaches the Intranet IP addresses of its ECS instances to the RDS access whitelist.
        - The specified RDS instance must be in running status.
        - The specified RDS instance’s whitelist must have room for more IP addresses.
    ...
    @property
    @pulumi.getter(name="defaultCooldown")
    def default_cooldown(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Default cool-down time (in seconds) of the scaling group. Value range: [0, 86400]. The default value is 300s.
        """
        return pulumi.get(self, "default_cooldown")
    ...
    @property
    @pulumi.getter(name="groupDeletionProtection")
    def group_deletion_protection(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the scaling group deletion protection is enabled. `true` or `false`, Default value: `false`.
        """
        return pulumi.get(self, "group_deletion_protection")
    ...
    @property
    @pulumi.getter(name="healthCheckTypes")
    def health_check_types(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The health check modes of the scaling group. Valid values: ECS, NONE, LOAD_BALANCER.
        """
        return pulumi.get(self, "health_check_types")
    ...
    @property
    @pulumi.getter(name="loadbalancerIds")
    def loadbalancer_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        If a Server Load Balancer instance is specified in the scaling group, the scaling group automatically attaches its ECS instances to the Server Load Balancer instance.
        - The Server Load Balancer instance must be enabled.
        - At least one listener must be configured for each Server Load Balancer and it HealthCheck must be on. Otherwise, creation will fail (it may be useful to add a `depends_on` argument
    ...
    @property
    @pulumi.getter(name="maxInstanceLifetime")
    def max_instance_lifetime(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum life span of an instance in the scaling group. Unit: seconds.
        """
        return pulumi.get(self, "max_instance_lifetime")
    ...
    @property
    @pulumi.getter(name="multiAzPolicy")
    def multi_az_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Multi-AZ scaling group ECS instance expansion and contraction strategy. PRIORITY, COMPOSABLE, BALANCE or COST_OPTIMIZED(Available since v1.54.0).
        """
        return pulumi.get(self, "multi_az_policy")
    ...
    @property
    @pulumi.getter(name="onDemandBaseCapacity")
    def on_demand_base_capacity(self) -> pulumi.Output[builtins.int]:
        """
        The minimum amount of the Auto Scaling group's capacity that must be fulfilled by On-Demand Instances. This base portion is provisioned first as your group scales.
        """
        return pulumi.get(self, "on_demand_base_capacity")
    ...
    @property
    @pulumi.getter(name="onDemandPercentageAboveBaseCapacity")
    def on_demand_percentage_above_base_capacity(self) -> pulumi.Output[builtins.int]:
        """
        Controls the percentages of On-Demand Instances and Spot Instances for your additional capacity beyond OnDemandBaseCapacity.
        """
        return pulumi.get(self, "on_demand_percentage_above_base_capacity")
    ...
    @property
    @pulumi.getter(name="protectedInstances")
    def protected_instances(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Set or unset instances within group into protected status.
        """
        return pulumi.get(self, "protected_instances")
    ...
    @property
    @pulumi.getter(name="removalPolicies")
    def removal_policies(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        RemovalPolicy is used to select the ECS instances you want to remove from the scaling group when multiple candidates for removal exist. Optional values:
        - OldestInstance: removes the ECS instance that is added to the scaling group at the earliest point in time.
        - NewestInstance: removes the ECS instance that is added to the scaling group at the latest point in time.
    ...
    @property
    @pulumi.getter(name="scalingGroupName")
    def scaling_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name shown for the scaling group, which must contain 2-64 characters (English or Chinese), starting with numbers, English letters or Chinese characters, and can contain numbers, underscores `_`, hyphens `-`, and decimal points `.`. If this parameter is not specified, the default value is ScalingGroupId.
        """
        return pulumi.get(self, "scaling_group_name")
    ...
    @property
    @pulumi.getter(name="scalingPolicy")
    def scaling_policy(self) -> pulumi.Output[builtins.str]:
        """
        The reclaim mode of the scaling group. Optional values: recycle, release, forceRecycle, forceRelease.
        """
        return pulumi.get(self, "scaling_policy")
    ...
    @property
    @pulumi.getter(name="spotAllocationStrategy")
    def spot_allocation_strategy(self) -> pulumi.Output[builtins.str]:
        """
        The allocation policy of preemptible instances. You can use this parameter to individually specify the allocation policy for preemptible instances. This parameter takes effect only if you set MultiAZPolicy to COMPOSABLE.
        """
        return pulumi.get(self, "spot_allocation_strategy")
    ...
    @property
    @pulumi.getter(name="spotInstancePools")
    def spot_instance_pools(self) -> pulumi.Output[builtins.int]:
        """
        The number of Spot pools to use to allocate your Spot capacity. The Spot pools is composed of instance types of lowest price.
        """
        return pulumi.get(self, "spot_instance_pools")
    ...
    @property
    @pulumi.getter(name="spotInstanceRemedy")
    def spot_instance_remedy(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to replace spot instances with newly created spot/onDemand instance when receive a spot recycling message.
        """
        return pulumi.get(self, "spot_instance_remedy")
    ...
    @property
    @pulumi.getter(name="stopInstanceTimeout")
    def stop_instance_timeout(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The period of time required by the ECS instance to enter the Stopped state. Unit: seconds. Valid values: 30 to 240.
        """
        return pulumi.get(self, "stop_instance_timeout")
