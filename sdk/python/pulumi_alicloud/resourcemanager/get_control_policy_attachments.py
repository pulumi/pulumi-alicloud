...
def get_control_policy_attachments(language: Optional[builtins.str] = None,
    ...
    :param builtins.str policy_type: The policy type of control policy. Valid values: `Custom` and `System`.
...
def get_control_policy_attachments_output(language: Optional[pulumi.Input[Optional[builtins.str]]] = None,
