...
def get_control_policy_attachments(language: Optional[_builtins.str] = None,
    ...
    :param _builtins.str policy_type: The policy type of control policy. Valid values: `Custom` and `System`.
