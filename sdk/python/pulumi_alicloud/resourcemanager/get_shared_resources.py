...
def get_shared_resources(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of shared resource IDs.
...
def get_shared_resources_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
