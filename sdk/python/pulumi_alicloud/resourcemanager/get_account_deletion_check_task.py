...
class GetAccountDeletionCheckTaskResult:
    ...
    def allow_delete(self) -> builtins.bool:
        """
...
def get_account_deletion_check_task(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_id: The ID of the member that you want to delete.
    """
    __args__ = dict()
...
def get_account_deletion_check_task_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
