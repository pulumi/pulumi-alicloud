...
class GetResourceSharesResult:
    ...
    def resource_share_name(self) -> Optional[builtins.str]:
...
def get_resource_shares(ids: Optional[Sequence[builtins.str]] = None,
                        name_regex: Optional[builtins.str] = None,
                        output_file: Optional[builtins.str] = None,
                        resource_share_name: Optional[builtins.str] = None,
                        resource_share_owner: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Resource Share IDs.
    :param builtins.str name_regex: A regex string to filter results by Resource Share name.
    ...
    :param builtins.str resource_share_owner: The owner of resource share, Valid values: `Self` and `OtherAccounts`.
    :param builtins.str status: The status of resource share. Valid values: `Active`,`Deleted` and `Deleting`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_resource_shares_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                               name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               resource_share_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetResourceSharesResult(
        ...
        resource_share_owner=pulumi.get(__response__, 'resource_share_owner'),
