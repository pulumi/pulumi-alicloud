...
def get_handshakes(enable_details: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Resource Manager Handshake IDs.
...
def get_handshakes_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
