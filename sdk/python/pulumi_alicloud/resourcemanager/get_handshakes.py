...
def get_handshakes(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Resource Manager Handshake IDs.
...
def get_handshakes_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
