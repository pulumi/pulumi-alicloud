...
def get_delegated_administrators(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Delegated Administrator IDs.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str service_principal: The identification of the trusted service.
    """
    __args__ = dict()
    __args__['ids'] = ids
