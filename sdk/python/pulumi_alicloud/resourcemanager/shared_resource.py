...
class SharedResourceArgs:
    def __init__(__self__, *,
                 ...
                 resource_share_id: pulumi.Input[builtins.str],
                 resource_type: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a SharedResource resource.
        :param pulumi.Input[builtins.str] resource_id: The resource ID need shared.
        :param pulumi.Input[builtins.str] resource_share_id: The resource share ID of resource manager.
        :param pulumi.Input[builtins.str] resource_type: The resource type of should shared. Valid values:
               - `VSwitch`.
    ...
    def resource_share_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def resource_share_id(self, value: pulumi.Input[builtins.str]):
...
class _SharedResourceState:
    def __init__(__self__, *,
                 ...
                 resource_share_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_type: The resource type of should shared. Valid values:
               ...
               - The following types are added after v1.240.0: `Snapshot`.
               - For more information about the types of resources that can be shared, see [Services that work with Resource Sharing](https://help.aliyun.com/zh/resource-management/resource-sharing/product-overview/services-that-work-with-resource-sharing?spm=api-workbench.API%20Document.0.0.32fff3cdFveEud)
        :param pulumi.Input[builtins.str] status: The status of the Shared Resource.
        """
    ...
    @property
    @pulumi.getter(name="resourceShareId")
    def resource_share_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The resource share ID of resource manager.
        """
        return pulumi.get(self, "resource_share_id")
    ...
    @resource_share_id.setter
    def resource_share_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_share_id", value)
...
class SharedResource(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:resourcemanager/sharedResource:SharedResource"
    ...
    def get(resource_name: str,
            ...
            resource_share_id: Optional[pulumi.Input[builtins.str]] = None,
            resource_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'SharedResource':
        """
    ...
    @property
    @pulumi.getter(name="resourceShareId")
    def resource_share_id(self) -> pulumi.Output[builtins.str]:
        """
        The resource share ID of resource manager.
        """
        return pulumi.get(self, "resource_share_id")
