...
def get_accounts(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of account IDs.
...
def get_accounts_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
