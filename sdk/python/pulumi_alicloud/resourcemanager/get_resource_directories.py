...
def get_resource_directories(output_file: Optional[builtins.str] = None,
...
def get_resource_directories_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
