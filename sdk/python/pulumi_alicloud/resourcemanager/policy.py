...
class PolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_document: The content of the policy. The content must be 1 to 2,048 characters in length.
        :param pulumi.Input[builtins.str] policy_name: The name of the policy. name must be 1 to 128 characters in length and can contain letters, digits, and hyphens (-).
        :param pulumi.Input[builtins.str] default_version: The version of the policy. Default to v1.
        :param pulumi.Input[builtins.str] description: The description of the policy. The description must be 1 to 1,024 characters in length.
        """
...
class _PolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_document: The content of the policy. The content must be 1 to 2,048 characters in length.
        :param pulumi.Input[builtins.str] policy_name: The name of the policy. name must be 1 to 128 characters in length and can contain letters, digits, and hyphens (-).
        :param pulumi.Input[builtins.str] policy_type: The type of the policy. Valid values: `Custom`, `System`.
        """
        if default_version is not None:
            warnings.warn("""Field 'default_version' has been deprecated from provider version 1.90.0""", DeprecationWarning)
            pulumi.log.warn("""default_version is deprecated: Field 'default_version' has been deprecated from provider version 1.90.0""")
...
@pulumi.type_token("alicloud:resourcemanager/policy:Policy")
class Policy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_document: Optional[pulumi.Input[builtins.str]] = None,
            policy_name: Optional[pulumi.Input[builtins.str]] = None,
            policy_type: Optional[pulumi.Input[builtins.str]] = None) -> 'Policy':
        """
