...
class PolicyVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] is_default_version: Specifies whether to set the policy version as the default version. Default to `false`.
        """
...
class PolicyVersion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            is_default_version: Optional[pulumi.Input[builtins.bool]] = None,
            policy_document: Optional[pulumi.Input[builtins.str]] = None,
            policy_name: Optional[pulumi.Input[builtins.str]] = None) -> 'PolicyVersion':
        """
    ...
    @pulumi.getter(name="isDefaultVersion")
    @_utilities.deprecated("""Field 'is_default_version' has been deprecated from provider version 1.90.0""")
    def is_default_version(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to set the policy version as the default version. Default to `false`.
        """
        return pulumi.get(self, "is_default_version")
