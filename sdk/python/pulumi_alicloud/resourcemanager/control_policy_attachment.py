...
class ControlPolicyAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_id: The ID of the access control policy.
        :param pulumi.Input[builtins.str] target_id: The ID of the object to which you want to attach the access control policy.
        """
...
class ControlPolicyAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            policy_id: Optional[pulumi.Input[builtins.str]] = None,
            target_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ControlPolicyAttachment':
        """
