...
class DelegatedAdministratorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: The ID of the member account in the resource directory.
        :param pulumi.Input[builtins.str] service_principal: The identification of the trusted service. **NOTE:** Only some trusted services support delegated administrator accounts. For more information, see [Supported trusted services](https://www.alibabacloud.com/help/en/resource-management/latest/manage-trusted-services-overview).
        """
...
class DelegatedAdministrator(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            account_id: Optional[pulumi.Input[builtins.str]] = None,
            service_principal: Optional[pulumi.Input[builtins.str]] = None) -> 'DelegatedAdministrator':
        """
