...
class ResourceShareArgs:
    def __init__(__self__, *,
                 resource_share_name: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ResourceShare resource.
        :param pulumi.Input[builtins.str] resource_share_name: The name of resource share.
        """
        pulumi.set(__self__, "resource_share_name", resource_share_name)

    @property
    @pulumi.getter(name="resourceShareName")
    def resource_share_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def resource_share_name(self, value: pulumi.Input[builtins.str]):
...
class _ResourceShareState:
    def __init__(__self__, *,
                 ...
                 resource_share_owner: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering ResourceShare resources.
        :param pulumi.Input[builtins.str] resource_share_name: The name of resource share.
        :param pulumi.Input[builtins.str] resource_share_owner: The owner of the Resource Share.
        :param pulumi.Input[builtins.str] status: The status of the Resource Share.
        """
    ...
    @property
    @pulumi.getter(name="resourceShareName")
    def resource_share_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of resource share.
        """
        return pulumi.get(self, "resource_share_name")
    ...
    @resource_share_name.setter
    def resource_share_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_share_name", value)

    @property
    @pulumi.getter(name="resourceShareOwner")
    def resource_share_owner(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_share_owner(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ResourceShare(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_share_name: Optional[pulumi.Input[builtins.str]] = None,
            resource_share_owner: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ResourceShare':
        """
    ...
    @property
    @pulumi.getter(name="resourceShareName")
    def resource_share_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of resource share.
        """
        return pulumi.get(self, "resource_share_name")
    ...
    @property
    @pulumi.getter(name="resourceShareOwner")
    def resource_share_owner(self) -> pulumi.Output[builtins.str]:
        """
        The owner of the Resource Share.
        """
        return pulumi.get(self, "resource_share_owner")
