...
class ResourceDirectoryArgs:
    def __init__(__self__, *,
                 member_deletion_status: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ResourceDirectory resource.
        :param pulumi.Input[builtins.str] member_deletion_status: Specifies whether to enable the member deletion feature. Valid values:`Enabled` and `Disabled`.
        :param pulumi.Input[builtins.str] status: The status of control policy. Valid values:`Enabled` and `Disabled`.
        """
    ...
    def member_deletion_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def member_deletion_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ResourceDirectoryState:
    def __init__(__self__, *,
                 ...
                 master_account_name: Optional[pulumi.Input[builtins.str]] = None,
                 member_deletion_status: Optional[pulumi.Input[builtins.str]] = None,
                 root_folder_id: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering ResourceDirectory resources.
        :param pulumi.Input[builtins.str] master_account_id: The ID of the master account.
        :param pulumi.Input[builtins.str] master_account_name: The name of the master account.
        :param pulumi.Input[builtins.str] member_deletion_status: Specifies whether to enable the member deletion feature. Valid values:`Enabled` and `Disabled`.
        :param pulumi.Input[builtins.str] root_folder_id: The ID of the root folder.
        :param pulumi.Input[builtins.str] status: The status of control policy. Valid values:`Enabled` and `Disabled`.
        """
    ...
    def master_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_account_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_account_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def root_folder_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def root_folder_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ResourceDirectory(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            member_deletion_status: Optional[pulumi.Input[builtins.str]] = None,
            root_folder_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ResourceDirectory':
        """
    ...
    @property
    @pulumi.getter(name="masterAccountName")
    def master_account_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the master account.
        """
        return pulumi.get(self, "master_account_name")
    ...
    @property
    @pulumi.getter(name="memberDeletionStatus")
    def member_deletion_status(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether to enable the member deletion feature. Valid values:`Enabled` and `Disabled`.
        """
        return pulumi.get(self, "member_deletion_status")
    ...
    @property
    @pulumi.getter(name="rootFolderId")
    def root_folder_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the root folder.
        """
        return pulumi.get(self, "root_folder_id")
