...
class ControlPolicyArgs:
    def __init__(__self__, *,
                 control_policy_name: pulumi.Input[builtins.str],
                 effect_scope: pulumi.Input[builtins.str],
                 policy_document: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ControlPolicy resource.
        :param pulumi.Input[builtins.str] control_policy_name: The name of control policy.
        :param pulumi.Input[builtins.str] effect_scope: The effect scope. Valid values `RAM`.
        :param pulumi.Input[builtins.str] policy_document: The policy document of control policy.
        :param pulumi.Input[builtins.str] description: The description of control policy.
        """
    ...
    def control_policy_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def control_policy_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "control_policy_name", value)

    @property
    @pulumi.getter(name="effectScope")
    def effect_scope(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @effect_scope.setter
    def effect_scope(self, value: pulumi.Input[builtins.str]):
...
class _ControlPolicyState:
    def __init__(__self__, *,
                 control_policy_name: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 effect_scope: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="controlPolicyName")
    def control_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of control policy.
        """
        return pulumi.get(self, "control_policy_name")
    ...
    @control_policy_name.setter
    def control_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "control_policy_name", value)
    ...
    @property
    @pulumi.getter(name="effectScope")
    def effect_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The effect scope. Valid values `RAM`.
        """
        return pulumi.get(self, "effect_scope")
    ...
    @effect_scope.setter
    def effect_scope(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "effect_scope", value)
...
class ControlPolicy(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:resourcemanager/controlPolicy:ControlPolicy"
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            effect_scope: Optional[pulumi.Input[builtins.str]] = None,
            policy_document: Optional[pulumi.Input[builtins.str]] = None) -> 'ControlPolicy':
        """
    ...
    @property
    @pulumi.getter(name="controlPolicyName")
    def control_policy_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of control policy.
        """
        return pulumi.get(self, "control_policy_name")
    ...
    @property
    @pulumi.getter(name="effectScope")
    def effect_scope(self) -> pulumi.Output[builtins.str]:
        """
        The effect scope. Valid values `RAM`.
        """
        return pulumi.get(self, "effect_scope")
