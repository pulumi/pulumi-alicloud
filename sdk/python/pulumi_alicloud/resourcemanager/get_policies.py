...
def get_policies(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Resource Manager Policy IDs.
    :param builtins.str name_regex: A regex string to filter results by policy name.
...
def get_policies_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
