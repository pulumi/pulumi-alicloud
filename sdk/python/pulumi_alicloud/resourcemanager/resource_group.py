...
class ResourceGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: The display name of the resource group. The name must be 1 to 50 characters in length.
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.114.0. New field `resource_group_name` instead.
        :param pulumi.Input[builtins.str] resource_group_name: The unique identifier of the resource group. The identifier must be 3 to 50 characters in length and can contain letters, digits, and hyphens (-). The identifier must start with a letter.
...
class _ResourceGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: The ID of the Alibaba Cloud account to which the resource group belongs.
        :param pulumi.Input[builtins.str] display_name: The display name of the resource group. The name must be 1 to 50 characters in length.
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.114.0. New field `resource_group_name` instead.
