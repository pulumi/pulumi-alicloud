...
def get_policy_attachments(language: Optional[builtins.str] = None,
    ...
    :param builtins.str language: The language that is used to return the description of the system policy. Valid values:`en`: English, `zh-CN`: Chinese, `ja`: Japanese.
...
def get_policy_attachments_output(language: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  ...
                                  principal_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
