...
def get_policy_attachments(language: Optional[_builtins.str] = None,
    ...
    :param _builtins.str language: The language that is used to return the description of the system policy. Valid values:`en`: English, `zh-CN`: Chinese, `ja`: Japanese.
