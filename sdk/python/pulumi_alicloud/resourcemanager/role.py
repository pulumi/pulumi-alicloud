...
class RoleArgs:
    def __init__(__self__, *,
                 assume_role_policy_document: pulumi.Input[builtins.str],
                 role_name: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 max_session_duration: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Role resource.
        :param pulumi.Input[builtins.str] assume_role_policy_document: The content of the permissions strategy that plays a role.
        :param pulumi.Input[builtins.str] role_name: Role Name. The length is 1 ~ 64 characters, which can include English letters, numbers, dots "." and dashes "-".
        :param pulumi.Input[builtins.str] description: The description of the Resource Manager role.
        :param pulumi.Input[builtins.int] max_session_duration: Role maximum session time. Valid values: [3600-43200]. Default to `3600`.
        """
    ...
    def assume_role_policy_document(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def assume_role_policy_document(self, value: pulumi.Input[builtins.str]):
...
class _RoleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The resource descriptor of the role.
        :param pulumi.Input[builtins.str] assume_role_policy_document: The content of the permissions strategy that plays a role.
        :param pulumi.Input[builtins.str] description: The description of the Resource Manager role.
        :param pulumi.Input[builtins.int] max_session_duration: Role maximum session time. Valid values: [3600-43200]. Default to `3600`.
        :param pulumi.Input[builtins.str] role_id: This ID of Resource Manager role. The value is set to `role_name`.
        :param pulumi.Input[builtins.str] role_name: Role Name. The length is 1 ~ 64 characters, which can include English letters, numbers, dots "." and dashes "-".
...
@pulumi.type_token("alicloud:resourcemanager/role:Role")
