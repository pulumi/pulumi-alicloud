...
def get_policy_versions(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of policy version IDs.
...
def get_policy_versions_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
