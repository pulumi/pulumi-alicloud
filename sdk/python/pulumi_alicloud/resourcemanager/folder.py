...
class FolderArgs:
    def __init__(__self__, *,
                 folder_name: pulumi.Input[builtins.str],
                 parent_folder_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Folder resource.
        :param pulumi.Input[builtins.str] folder_name: The name of the folder. The name must be 1 to 24 characters in length and can contain letters, digits, underscores (_), periods (.), and hyphens (-).
        :param pulumi.Input[builtins.str] parent_folder_id: The ID of the parent folder. If not set, the system default value will be used.
        """
    ...
    def folder_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @folder_name.setter
    def folder_name(self, value: pulumi.Input[builtins.str]):
...
class _FolderState:
    def __init__(__self__, *,
                 folder_name: Optional[pulumi.Input[builtins.str]] = None,
                 parent_folder_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="folderName")
    def folder_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the folder. The name must be 1 to 24 characters in length and can contain letters, digits, underscores (_), periods (.), and hyphens (-).
        """
        return pulumi.get(self, "folder_name")
    ...
    @folder_name.setter
    def folder_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "folder_name", value)
...
class Folder(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            folder_name: Optional[pulumi.Input[builtins.str]] = None,
            parent_folder_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Folder':
        """
    ...
    @property
    @pulumi.getter(name="folderName")
    def folder_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the folder. The name must be 1 to 24 characters in length and can contain letters, digits, underscores (_), periods (.), and hyphens (-).
        """
        return pulumi.get(self, "folder_name")
    ...
    @property
    @pulumi.getter(name="parentFolderId")
    def parent_folder_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the parent folder. If not set, the system default value will be used.
        """
        return pulumi.get(self, "parent_folder_id")
