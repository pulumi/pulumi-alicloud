...
def get_roles(enable_details: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Resource Manager Role IDs.
...
def get_roles_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
