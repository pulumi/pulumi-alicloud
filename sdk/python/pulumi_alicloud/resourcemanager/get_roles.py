...
def get_roles(ids=None,name_regex=None,output_file=None,opts=None):
    """
    ...
    :param list ids: A list of Resource Manager Role IDs.
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:resourcemanager/getRoles:getRoles', __args__, opts=opts).value
