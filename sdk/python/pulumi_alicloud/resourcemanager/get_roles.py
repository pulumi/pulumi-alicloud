...
def get_roles(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Resource Manager Role IDs.
    :param builtins.str name_regex: A regex string to filter results by role name.
...
def get_roles_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
