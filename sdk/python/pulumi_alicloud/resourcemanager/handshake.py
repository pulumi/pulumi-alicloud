...
class HandshakeArgs:
    def __init__(__self__, *,
                 target_entity: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] target_entity: Invited account ID or login email.
        :param pulumi.Input[builtins.str] target_type: Type of account being invited. Valid values: `Account`, `Email`.
        :param pulumi.Input[builtins.str] note: Remarks. The maximum length is 1024 characters.
        """
    ...
    def target_entity(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_entity(self, value: pulumi.Input[builtins.str]):
...
class _HandshakeState:
    def __init__(__self__, *,
                 ...
                 target_entity: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] expire_time: The expiration time of the invitation.
        :param pulumi.Input[builtins.str] master_account_id: Resource account master account ID.
        :param pulumi.Input[builtins.str] master_account_name: The name of the main account of the resource directory.
        ...
        :param pulumi.Input[builtins.str] status: Invitation status. Valid values: `Pending` waiting for confirmation, `Accepted`, `Cancelled`, `Declined`, `Expired`.
        :param pulumi.Input[builtins.str] target_entity: Invited account ID or login email.
        :param pulumi.Input[builtins.str] target_type: Type of account being invited. Valid values: `Account`, `Email`.
        """
    ...
    @property
    @pulumi.getter(name="targetEntity")
    def target_entity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Invited account ID or login email.
        """
        return pulumi.get(self, "target_entity")
    ...
    @target_entity.setter
    def target_entity(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_entity", value)
...
class Handshake(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            target_entity: Optional[pulumi.Input[builtins.str]] = None,
            target_type: Optional[pulumi.Input[builtins.str]] = None) -> 'Handshake':
        """
    ...
    @property
    @pulumi.getter(name="targetEntity")
    def target_entity(self) -> pulumi.Output[builtins.str]:
        """
        Invited account ID or login email.
        """
        return pulumi.get(self, "target_entity")
