...
def get_control_policies(enable_details: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Control Policy IDs.
    :param _builtins.str language: The language. Valid value `zh-CN`, `en`, and `ja`. Default value `zh-CN`.
    :param _builtins.str name_regex: A regex string to filter results by Control Policy name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str policy_type: The policy type of control policy. Valid values `System` and `Custom`.
    """
    __args__ = dict()
