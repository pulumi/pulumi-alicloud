...
def get_control_policies(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Control Policy IDs.
    :param builtins.str language: The language. Valid value `zh-CN`, `en`, and `ja`. Default value `zh-CN`.
    :param builtins.str name_regex: A regex string to filter results by Control Policy name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str policy_type: The policy type of control policy. Valid values `System` and `Custom`.
    """
    __args__ = dict()
...
def get_control_policies_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
