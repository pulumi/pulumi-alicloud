...
def get_resource_groups(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.bool enable_details: Set it to true can output more details. Default value: `false`.
    :param Sequence[builtins.str] ids: A list of resource group IDs.
    :param builtins.str name_regex: A regex string to filter results by resource group identifier.
...
def get_resource_groups_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
