...
def contacts(enable_details: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:sslcertificatesservice/contacts:Contacts', __args__, opts=opts, typ=ContactsResult).value
...
def contacts_output(enable_details: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                    ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                    name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                    output_file: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ContactsResult]:
    """
    This data source provides Ssl Certificates Service Contact available to the user.[What is Contact](https://next.api.alibabacloud.com/document/cas/2020-04-07/CreateContact)
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:sslcertificatesservice/contacts:Contacts', __args__, opts=opts, typ=ContactsResult)
    return __ret__.apply(lambda __response__: ContactsResult(
