...
__all__ = [
    'GetCompaniesResult',
    'AwaitableGetCompaniesResult',
    'get_companies',
    'get_companies_output',
]

@pulumi.output_type
class GetCompaniesResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def companies(self) -> Sequence['outputs.GetCompaniesCompanyResult']:
        """
...
class AwaitableGetCompaniesResult(GetCompaniesResult):
...
def get_companies(company_id: Optional[_builtins.int] = None,
                  ids: Optional[Sequence[_builtins.str]] = None,
                  keyword: Optional[_builtins.str] = None,
                  name_regex: Optional[_builtins.str] = None,
                  output_file: Optional[_builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCompaniesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:sslcertificatesservice/getCompanies:getCompanies', __args__, opts=opts, typ=GetCompaniesResult).value

    return AwaitableGetCompaniesResult(
...
def get_companies_output(company_id: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                         ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                         keyword: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                         name_regex: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                         output_file: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCompaniesResult]:
    """
    This data source provides SSL Certificate Service Companies available to the user.[What is Company](https://next.api.alibabacloud.com/document/cas/2020-04-07/CreateCompany)
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:sslcertificatesservice/getCompanies:getCompanies', __args__, opts=opts, typ=GetCompaniesResult)
    return __ret__.apply(lambda __response__: GetCompaniesResult(
