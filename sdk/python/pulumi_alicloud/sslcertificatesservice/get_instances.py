...
def get_instances(brand: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:sslcertificatesservice/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult).value
...
def get_instances_output(brand: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:sslcertificatesservice/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult)
