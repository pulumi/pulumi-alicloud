...
def get_instances(description_regex: Optional[builtins.str] = None,
    ...
    :param builtins.str description_regex: A regex string to filter results by instance description.
    :param Sequence[builtins.str] ids: A list of DRDS instance IDs.
    :param builtins.str name_regex: A regex string to filter results by instance description. It is deprecated since v1.91.0 and will be removed in a future release, please use 'description_regex' instead.
    """
    __args__ = dict()
