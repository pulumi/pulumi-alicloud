...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 instance_series: pulumi.Input[builtins.str],
                 ...
                 mysql_version: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] vswitch_id: The VSwitch ID to launch in.
        :param pulumi.Input[builtins.str] zone_id: The Zone to launch the DRDS instance.
    ...
    def instance_series(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def instance_series(self, value: pulumi.Input[builtins.str]):
    ...
    def mysql_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def mysql_version(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _InstanceState:
    def __init__(__self__, *,
                 ...
                 instance_charge_type: Optional[pulumi.Input[builtins.str]] = None,
                 instance_series: Optional[pulumi.Input[builtins.str]] = None,
                 mysql_version: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="instanceSeries")
    def instance_series(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The parameter of the instance series. **NOTE:**  `drds.sn1.4c8g`,`drds.sn1.8c16g`,`drds.sn1.16c32g`,`drds.sn1.32c64g` are no longer supported. Valid values:
        - `drds.sn2.4c16g` Starter Edition.
        - `drds.sn2.8c32g` Standard Edition.
    ...
    @instance_series.setter
    def instance_series(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "instance_series", value)
...
class Instance(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:drds/instance:Instance"
    ...
    @property
    @pulumi.getter(name="instanceSeries")
    def instance_series(self) -> pulumi.Output[builtins.str]:
        """
        The parameter of the instance series. **NOTE:**  `drds.sn1.4c8g`,`drds.sn1.8c16g`,`drds.sn1.16c32g`,`drds.sn1.32c64g` are no longer supported. Valid values:
        - `drds.sn2.4c16g` Starter Edition.
        - `drds.sn2.8c32g` Standard Edition.
    ...
    @property
    @pulumi.getter(name="mysqlVersion")
    def mysql_version(self) -> pulumi.Output[builtins.int]:
        """
        The MySQL version supported by the instance, with the following range of values. `5`: Fully compatible with MySQL 5.x (default) `8`: Fully compatible with MySQL 8.0. This parameter takes effect when the primary instance is created, and the read-only instance has the same MySQL version as the primary instance by default.
        """
        return pulumi.get(self, "mysql_version")
