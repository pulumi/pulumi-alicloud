...
class PolardbxInstanceArgs:
    def __init__(__self__, *,
                 cn_class: pulumi.Input[builtins.str],
                 cn_node_count: pulumi.Input[builtins.int],
                 dn_class: pulumi.Input[builtins.str],
                 dn_node_count: pulumi.Input[builtins.int],
                 primary_zone: pulumi.Input[builtins.str],
                 topology_type: pulumi.Input[builtins.str],
                 ...
                 tertiary_zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a PolardbxInstance resource.
        :param pulumi.Input[builtins.str] cn_class: Compute node specifications.
        :param pulumi.Input[builtins.int] cn_node_count: Number of computing nodes.
        :param pulumi.Input[builtins.str] dn_class: Storage node specifications.
        :param pulumi.Input[builtins.int] dn_node_count: The number of storage nodes.
        :param pulumi.Input[builtins.str] primary_zone: Primary Availability Zone.
        :param pulumi.Input[builtins.str] topology_type: Topology type:
        ...
        :param pulumi.Input[builtins.str] resource_group_id: The resource group ID can be empty. This parameter is not supported for the time being.
        :param pulumi.Input[builtins.str] secondary_zone: Secondary availability zone.
        :param pulumi.Input[builtins.str] tertiary_zone: Third Availability Zone.
        """
    ...
    def cn_class(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @cn_class.setter
    def cn_class(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "cn_class", value)

    @property
    @pulumi.getter(name="cnNodeCount")
    def cn_node_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def cn_node_count(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "cn_node_count", value)

    @property
    @pulumi.getter(name="dnClass")
    def dn_class(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @dn_class.setter
    def dn_class(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "dn_class", value)

    @property
    @pulumi.getter(name="dnNodeCount")
    def dn_node_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def dn_node_count(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "dn_node_count", value)

    @property
    @pulumi.getter(name="primaryZone")
    def primary_zone(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @primary_zone.setter
    def primary_zone(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "primary_zone", value)

    @property
    @pulumi.getter(name="topologyType")
    def topology_type(self) -> pulumi.Input[builtins.str]:
        """
        Topology type:
        - **3azones**: three available areas;
        - **1azone**: Single zone.
    ...
    def topology_type(self, value: pulumi.Input[builtins.str]):
    ...
    def tertiary_zone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tertiary_zone(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PolardbxInstanceState:
    def __init__(__self__, *,
                 cn_class: Optional[pulumi.Input[builtins.str]] = None,
                 cn_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 create_time: Optional[pulumi.Input[builtins.str]] = None,
                 dn_class: Optional[pulumi.Input[builtins.str]] = None,
                 dn_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 primary_zone: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 secondary_zone: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 tertiary_zone: Optional[pulumi.Input[builtins.str]] = None,
                 topology_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="cnClass")
    def cn_class(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Compute node specifications.
        """
        return pulumi.get(self, "cn_class")
    ...
    @cn_class.setter
    def cn_class(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cn_class", value)

    @property
    @pulumi.getter(name="cnNodeCount")
    def cn_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of computing nodes.
        """
        return pulumi.get(self, "cn_node_count")
    ...
    @cn_node_count.setter
    def cn_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cn_node_count", value)
    ...
    @property
    @pulumi.getter(name="dnClass")
    def dn_class(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Storage node specifications.
        """
        return pulumi.get(self, "dn_class")
    ...
    @dn_class.setter
    def dn_class(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dn_class", value)

    @property
    @pulumi.getter(name="dnNodeCount")
    def dn_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of storage nodes.
        """
        return pulumi.get(self, "dn_node_count")
    ...
    @dn_node_count.setter
    def dn_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "dn_node_count", value)

    @property
    @pulumi.getter(name="primaryZone")
    def primary_zone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Primary Availability Zone.
        """
        return pulumi.get(self, "primary_zone")
    ...
    @primary_zone.setter
    def primary_zone(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "primary_zone", value)
    ...
    @property
    @pulumi.getter(name="topologyType")
    def topology_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Topology type:
        - **3azones**: three available areas;
        - **1azone**: Single zone.
    ...
    @topology_type.setter
    def topology_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "topology_type", value)
...
class PolardbxInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            topology_type: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PolardbxInstance':
        """
    ...
    @property
    @pulumi.getter(name="cnClass")
    def cn_class(self) -> pulumi.Output[builtins.str]:
        """
        Compute node specifications.
        """
        return pulumi.get(self, "cn_class")
    ...
    @property
    @pulumi.getter(name="cnNodeCount")
    def cn_node_count(self) -> pulumi.Output[builtins.int]:
        """
        Number of computing nodes.
        """
        return pulumi.get(self, "cn_node_count")
    ...
    @property
    @pulumi.getter(name="dnClass")
    def dn_class(self) -> pulumi.Output[builtins.str]:
        """
        Storage node specifications.
        """
        return pulumi.get(self, "dn_class")
    ...
    @property
    @pulumi.getter(name="dnNodeCount")
    def dn_node_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of storage nodes.
        """
        return pulumi.get(self, "dn_node_count")
    ...
    @property
    @pulumi.getter(name="primaryZone")
    def primary_zone(self) -> pulumi.Output[builtins.str]:
        """
        Primary Availability Zone.
        """
        return pulumi.get(self, "primary_zone")
    ...
    @property
    @pulumi.getter(name="secondaryZone")
    def secondary_zone(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Secondary availability zone.
        """
        return pulumi.get(self, "secondary_zone")
    ...
    @property
    @pulumi.getter(name="tertiaryZone")
    def tertiary_zone(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Third Availability Zone.
        """
        return pulumi.get(self, "tertiary_zone")
    ...
    @property
    @pulumi.getter(name="topologyType")
    def topology_type(self) -> pulumi.Output[builtins.str]:
        """
        Topology type:
        - **3azones**: three available areas;
        - **1azone**: Single zone.
