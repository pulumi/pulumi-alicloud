...
class ZoneAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] zone_id: The name of the Private Zone Record.
        :param pulumi.Input[builtins.str] lang: The language of code.
        :param pulumi.Input[builtins.str] user_client_ip: The user custom IP address.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_ids: The id List of the VPC with the same region, for example:["vpc-1","vpc-2"].
...
class ZoneAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpc_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            vpcs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ZoneAttachmentVpcArgs', 'ZoneAttachmentVpcArgsDict']]]]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ZoneAttachment':
        """
