...
def get_resolver_zones(output_file: Optional[builtins.str] = None,
    ...
    :param builtins.str status: The status of the Zone. Valid values: `NORMAL`, `SOLD_OUT`.
    """
    __args__ = dict()
...
def get_resolver_zones_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
