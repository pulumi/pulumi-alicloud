...
class EndpointIpConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cidr_block: The Subnet mask.
        :param pulumi.Input[builtins.str] vswitch_id: The Vswitch id.
        :param pulumi.Input[builtins.str] zone_id: The Zone ID.
        :param pulumi.Input[builtins.str] ip: The IP address within the parameter range of the subnet mask.  It is recommended to use the IP address assigned by the system.
        """
...
class RuleAttachmentVpcArgs:
    def __init__(__self__, *,
                 ...
                 vpc_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] region_id: The region of the vpc. If not set, the current region will instead of.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC.  **NOTE:** The VPC that can be associated with the forwarding rule must belong to the same region as the Endpoint.
        """
...
class RuleForwardIpArgs:
    def __init__(__self__, *,
                 ...
                 port: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] ip: The ip of the forwarding destination.
        :param pulumi.Input[builtins.int] port: The port of the forwarding destination.
        """
        pulumi.set(__self__, "ip", ip)
...
if not MYPY:
    class ZoneUserInfoArgsDict(TypedDict):
        region_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ZoneUserInfoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] region_ids: The list of the region IDs.
        :param pulumi.Input[builtins.str] user_id: The user ID belonging to the region is used for cross-account synchronization scenarios.
        """
