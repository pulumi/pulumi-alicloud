...
def get_endpoints(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Endpoint IDs.
    :param _builtins.str name_regex: A regex string to filter results by Endpoint name.
...
def get_endpoints_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
