...
def get_endpoints(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Endpoint IDs.
    :param builtins.str name_regex: A regex string to filter results by Endpoint name.
...
def get_endpoints_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
