...
class ZoneArgs:
    def __init__(__self__, *,
                 ...
                 user_client_ip: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] lang: The language. Valid values: "zh", "en", "jp".
        :param pulumi.Input[builtins.str] name: The name of the Private Zone. The `name` has been deprecated from provider version 1.107.0. Please use 'zone_name' instead.
        :param pulumi.Input[builtins.str] proxy_pattern: The recursive DNS proxy. Valid values:
               - ZONE: indicates that the recursive DNS proxy is disabled.
               - RECORD: indicates that the recursive DNS proxy is enabled.
               Default to "ZONE".
        :param pulumi.Input[builtins.str] remark: The remark of the Private Zone.
        :param pulumi.Input[builtins.str] resource_group_id: The Id of resource group which the Private Zone belongs.
        :param pulumi.Input[builtins.str] sync_status: The status of the host synchronization task. Valid values:  `ON`,`OFF`. **NOTE:** You can update the `sync_status` to enable/disable the host synchronization task.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags of the Private Zone.
        :param pulumi.Input[builtins.str] user_client_ip: The IP address of the client.
        ...
        :param pulumi.Input[builtins.str] zone_name: The zone_name of the Private Zone. The `zone_name` is required when the value of the `name`  is Empty.
        """
        if lang is not None:
    ...
    def user_client_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def user_client_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ZoneState:
    def __init__(__self__, *,
                 is_ptr: Optional[pulumi.Input[builtins.bool]] = None,
                 lang: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_pattern: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] is_ptr: Whether the Private Zone is ptr.
        :param pulumi.Input[builtins.str] lang: The language. Valid values: "zh", "en", "jp".
        :param pulumi.Input[builtins.str] name: The name of the Private Zone. The `name` has been deprecated from provider version 1.107.0. Please use 'zone_name' instead.
        :param pulumi.Input[builtins.str] proxy_pattern: The recursive DNS proxy. Valid values:
               - ZONE: indicates that the recursive DNS proxy is disabled.
               - RECORD: indicates that the recursive DNS proxy is enabled.
               Default to "ZONE".
        :param pulumi.Input[builtins.int] record_count: The count of the Private Zone Record.
        :param pulumi.Input[builtins.str] remark: The remark of the Private Zone.
        :param pulumi.Input[builtins.str] resource_group_id: The Id of resource group which the Private Zone belongs.
        :param pulumi.Input[builtins.str] sync_status: The status of the host synchronization task. Valid values:  `ON`,`OFF`. **NOTE:** You can update the `sync_status` to enable/disable the host synchronization task.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags of the Private Zone.
    ...
    def is_ptr(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_ptr.setter
    def is_ptr(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Zone(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isPtr")
    def is_ptr(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the Private Zone is ptr.
        """
        return pulumi.get(self, "is_ptr")
    ...
    @property
    @pulumi.getter(name="proxyPattern")
    def proxy_pattern(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The recursive DNS proxy. Valid values:
        - ZONE: indicates that the recursive DNS proxy is disabled.
        - RECORD: indicates that the recursive DNS proxy is enabled.
    ...
    @property
    @pulumi.getter(name="syncStatus")
    def sync_status(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The status of the host synchronization task. Valid values:  `ON`,`OFF`. **NOTE:** You can update the `sync_status` to enable/disable the host synchronization task.
        """
        return pulumi.get(self, "sync_status")
    ...
    @property
    @pulumi.getter(name="userClientIp")
    def user_client_ip(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IP address of the client.
        """
        return pulumi.get(self, "user_client_ip")
