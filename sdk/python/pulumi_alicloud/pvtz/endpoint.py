...
class EndpointArgs:
    def __init__(__self__, *,
                 ...
                 vpc_region_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a Endpoint resource.
        :param pulumi.Input[builtins.str] endpoint_name: The name of the resource.
        ...
        :param pulumi.Input[builtins.str] vpc_region_id: The Region of the VPC.
        """
    ...
    def vpc_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vpc_region_id(self, value: pulumi.Input[builtins.str]):
...
class _EndpointState:
    def __init__(__self__, *,
                 ...
                 vpc_region_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Endpoint resources.
        :param pulumi.Input[builtins.str] endpoint_name: The name of the resource.
        :param pulumi.Input[Sequence[pulumi.Input['EndpointIpConfigArgs']]] ip_configs: The Ip Configs. See `ip_configs` below. **NOTE:** In order to ensure high availability, add at least 2 and up to 6.
        :param pulumi.Input[builtins.str] security_group_id: The ID of the Security Group.
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid values: `CHANGE_FAILED`, `CHANGE_INIT`, `EXCEPTION`, `FAILED`, `INIT`, `SUCCESS`.
        :param pulumi.Input[builtins.str] vpc_id: The VPC ID.
        :param pulumi.Input[builtins.str] vpc_region_id: The Region of the VPC.
        """
    ...
    @property
    @pulumi.getter(name="vpcRegionId")
    def vpc_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Region of the VPC.
        """
        return pulumi.get(self, "vpc_region_id")
    ...
    @vpc_region_id.setter
    def vpc_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpc_region_id", value)
...
class Endpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vpc_region_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Endpoint':
        """
    ...
    @property
    @pulumi.getter(name="vpcRegionId")
    def vpc_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The Region of the VPC.
        """
        return pulumi.get(self, "vpc_region_id")
