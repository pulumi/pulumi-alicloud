...
class ZoneRecordArgs:
    def __init__(__self__, *,
                 ...
                 resource_record: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] type: The type of the Private Zone Record. Valid values: A, CNAME, TXT, MX, PTR, SRV.
        :param pulumi.Input[builtins.str] value: The value of the Private Zone Record.
        ...
        :param pulumi.Input[builtins.int] priority: The priority of the Private Zone Record. At present, only can "MX" record support it. Valid values: [1-99]. Default to 1.
        :param pulumi.Input[builtins.str] remark: The remark of the Private Zone Record.
        :param pulumi.Input[builtins.str] resource_record: The resource record of the Private Zone Record.
        :param pulumi.Input[builtins.str] rr: The rr of the Private Zone Record.
        :param pulumi.Input[builtins.str] status: Resolve record status. Value:
               - ENABLE: enable resolution.
               - DISABLE: pause parsing.
        :param pulumi.Input[builtins.int] ttl: The ttl of the Private Zone Record. Default to `60`.
        """
    ...
    def resource_record(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_record(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ZoneRecordState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] lang: User language.
        :param pulumi.Input[builtins.int] priority: The priority of the Private Zone Record. At present, only can "MX" record support it. Valid values: [1-99]. Default to 1.
        :param pulumi.Input[builtins.str] record_id: The Private Zone Record ID.
        :param pulumi.Input[builtins.str] remark: The remark of the Private Zone Record.
        :param pulumi.Input[builtins.str] resource_record: The resource record of the Private Zone Record.
        :param pulumi.Input[builtins.str] rr: The rr of the Private Zone Record.
        :param pulumi.Input[builtins.str] status: Resolve record status. Value:
...
class ZoneRecord(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_client_ip: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ZoneRecord':
        """
    ...
    @pulumi.getter(name="resourceRecord")
    @_utilities.deprecated("""Field 'resource_record' has been deprecated from version 1.109.0. Use 'rr' instead.""")
    def resource_record(self) -> pulumi.Output[builtins.str]:
        """
        The resource record of the Private Zone Record.
        """
        return pulumi.get(self, "resource_record")
