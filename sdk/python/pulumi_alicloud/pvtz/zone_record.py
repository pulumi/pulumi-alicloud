...
class ZoneRecord(pulumi.CustomResource):
    ...
    """
    record_id: pulumi.Output[float]
    """
    The Private Zone Record ID.
    """
    resource_record: pulumi.Output[str]
    """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, priority=None, record_id=None, resource_record=None, ttl=None, type=None, value=None, zone_id=None):
        """
