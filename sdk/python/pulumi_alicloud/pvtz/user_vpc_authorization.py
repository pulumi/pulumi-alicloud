...
class UserVpcAuthorizationArgs:
    def __init__(__self__, *,
                 authorized_user_id: pulumi.Input[builtins.str],
                 auth_channel: Optional[pulumi.Input[builtins.str]] = None,
                 auth_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a UserVpcAuthorization resource.
        :param pulumi.Input[builtins.str] authorized_user_id: The primary account ID of the user who authorizes the resource.
        :param pulumi.Input[builtins.str] auth_channel: The auth channel. Valid values: `RESOURCE_DIRECTORY`.
        :param pulumi.Input[builtins.str] auth_type: The type of Authorization. Valid values: `NORMAL` and `CLOUD_PRODUCT`.
        """
    ...
    def authorized_user_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def authorized_user_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "authorized_user_id", value)

    @property
    @pulumi.getter(name="authChannel")
    def auth_channel(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @auth_channel.setter
    def auth_channel(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _UserVpcAuthorizationState:
    def __init__(__self__, *,
                 auth_channel: Optional[pulumi.Input[builtins.str]] = None,
                 auth_type: Optional[pulumi.Input[builtins.str]] = None,
                 authorized_user_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="authorizedUserId")
    def authorized_user_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The primary account ID of the user who authorizes the resource.
        """
        return pulumi.get(self, "authorized_user_id")
    ...
    @authorized_user_id.setter
    def authorized_user_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authorized_user_id", value)
...
class UserVpcAuthorization(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            auth_channel: Optional[pulumi.Input[builtins.str]] = None,
            auth_type: Optional[pulumi.Input[builtins.str]] = None,
            authorized_user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UserVpcAuthorization':
        """
    ...
    @property
    @pulumi.getter(name="authChannel")
    def auth_channel(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The auth channel. Valid values: `RESOURCE_DIRECTORY`.
        """
        return pulumi.get(self, "auth_channel")
    ...
    @property
    @pulumi.getter(name="authorizedUserId")
    def authorized_user_id(self) -> pulumi.Output[builtins.str]:
        """
        The primary account ID of the user who authorizes the resource.
        """
        return pulumi.get(self, "authorized_user_id")
