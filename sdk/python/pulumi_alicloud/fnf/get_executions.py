...
def get_executions(enable_details: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Execution IDs. The value formats as `<flow_name>:<execution_name>`.
    :param _builtins.str name_regex: A regex string to filter results by Execution name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str status: The status of the resource. Valid values: `Running`, `Stopped`, `Succeeded`, `Failed`, `TimedOut`.
    """
    __args__ = dict()
