...
def get_executions(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Execution IDs. The value formats as `<flow_name>:<execution_name>`.
    :param builtins.str name_regex: A regex string to filter results by Execution name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the resource. Valid values: `Running`, `Stopped`, `Succeeded`, `Failed`, `TimedOut`.
    """
    __args__ = dict()
...
def get_executions_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:fnf/getExecutions:getExecutions', __args__, opts=opts, typ=GetExecutionsResult)
