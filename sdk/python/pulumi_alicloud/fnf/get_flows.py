...
def get_flows(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Flow IDs.
    :param _builtins.int limit: The number of resource queries.
    :param _builtins.str name_regex: A regex string to filter results by Flow name.
...
def get_flows_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
