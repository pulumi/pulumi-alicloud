...
def get_flows(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Flow IDs.
    :param builtins.int limit: The number of resource queries.
    :param builtins.str name_regex: A regex string to filter results by Flow name.
...
def get_flows_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
