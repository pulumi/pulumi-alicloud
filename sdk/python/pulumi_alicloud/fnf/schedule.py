...
class ScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cron_expression: The CRON expression of the time-based schedule to be created.
        :param pulumi.Input[builtins.str] flow_name: The name of the flow bound to the time-based schedule you want to create.
        :param pulumi.Input[builtins.str] schedule_name: The name of the time-based schedule to be created.
        :param pulumi.Input[builtins.str] description: The description of the time-based schedule to be created.
        :param pulumi.Input[builtins.bool] enable: Specifies whether to enable the time-based schedule you want to create. Valid values: `false`, `true`.
        :param pulumi.Input[builtins.str] payload: The trigger message of the time-based schedule to be created. It must be in JSON object format.
        """
...
class _ScheduleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enable: Specifies whether to enable the time-based schedule you want to create. Valid values: `false`, `true`.
        :param pulumi.Input[builtins.str] flow_name: The name of the flow bound to the time-based schedule you want to create.
        :param pulumi.Input[builtins.str] last_modified_time: The time when the time-based schedule was last updated.
        :param pulumi.Input[builtins.str] payload: The trigger message of the time-based schedule to be created. It must be in JSON object format.
        :param pulumi.Input[builtins.str] schedule_id: The ID of the time-based schedule.
        :param pulumi.Input[builtins.str] schedule_name: The name of the time-based schedule to be created.
        """
    ...
    @property
    @pulumi.getter(name="flowName")
    def flow_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the flow bound to the time-based schedule you want to create.
        """
        return pulumi.get(self, "flow_name")
    ...
    @flow_name.setter
    def flow_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "flow_name", value)
...
class Schedule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            payload: Optional[pulumi.Input[builtins.str]] = None,
            schedule_id: Optional[pulumi.Input[builtins.str]] = None,
            schedule_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Schedule':
        """
    ...
    @property
    @pulumi.getter(name="cronExpression")
    def cron_expression(self) -> pulumi.Output[builtins.str]:
        """
        The CRON expression of the time-based schedule to be created.
        """
        return pulumi.get(self, "cron_expression")
    ...
    @property
    @pulumi.getter(name="flowName")
    def flow_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the flow bound to the time-based schedule you want to create.
        """
        return pulumi.get(self, "flow_name")
    ...
    @property
    @pulumi.getter
    def payload(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The trigger message of the time-based schedule to be created. It must be in JSON object format.
        """
        return pulumi.get(self, "payload")
