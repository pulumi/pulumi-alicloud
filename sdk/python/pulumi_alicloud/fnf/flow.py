...
class FlowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] definition: The definition of the flow. It must comply with the Flow Definition Language (FDL) syntax.
        :param pulumi.Input[builtins.str] description: The description of the flow.
        :param pulumi.Input[builtins.str] type: The type of the flow. Valid values are `FDL` or `DEFAULT`.
        :param pulumi.Input[builtins.str] name: The name of the flow. The name must be unique in an Alibaba Cloud account.
        :param pulumi.Input[builtins.str] role_arn: The ARN of the specified RAM role that Serverless Workflow uses to assume the role when Serverless Workflow executes a flow.
        """
...
class _FlowState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] definition: The definition of the flow. It must comply with the Flow Definition Language (FDL) syntax.
        :param pulumi.Input[builtins.str] description: The description of the flow.
        :param pulumi.Input[builtins.str] flow_id: The unique ID of the flow.
        :param pulumi.Input[builtins.str] last_modified_time: The time when the flow was last modified.
        :param pulumi.Input[builtins.str] name: The name of the flow. The name must be unique in an Alibaba Cloud account.
        :param pulumi.Input[builtins.str] role_arn: The ARN of the specified RAM role that Serverless Workflow uses to assume the role when Serverless Workflow executes a flow.
        :param pulumi.Input[builtins.str] type: The type of the flow. Valid values are `FDL` or `DEFAULT`.
        """
...
class Flow(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            role_arn: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'Flow':
        """
