...
def get_schedules(flow_name: Optional[builtins.str] = None,
    ...
    :param builtins.str flow_name: The name of the flow bound to the time-based schedule you want to create.
    :param Sequence[builtins.str] ids: A list of Schedule IDs.
    :param builtins.int limit: The number of resource queries.
    :param builtins.str name_regex: A regex string to filter results by Schedule name.
...
def get_schedules_output(flow_name: Optional[pulumi.Input[builtins.str]] = None,
