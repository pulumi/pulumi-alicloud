...
def get_schedules(flow_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str flow_name: The name of the flow bound to the time-based schedule you want to create.
    :param Sequence[_builtins.str] ids: A list of Schedule IDs.
    :param _builtins.int limit: The number of resource queries.
    :param _builtins.str name_regex: A regex string to filter results by Schedule name.
