...
if not MYPY:
    class AScriptExtAttributeArgsDict(TypedDict):
        attribute_key: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AScriptExtAttributeArgs:
    def __init__(__self__, *,
                 attribute_key: Optional[pulumi.Input[builtins.str]] = None,
                 attribute_value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] attribute_key: Key to extend attribute
        :param pulumi.Input[builtins.str] attribute_value: The value of the extended attribute
        """
    ...
    def attribute_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Key to extend attribute
        """
    ...
    def attribute_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AclAclEntryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] description: The description of the ACL entry. The description must be `1` to `256` characters in length, and can contain letters, digits, hyphens (-), forward slashes (/), periods (.),and underscores (_). It can also contain Chinese characters.
        :param pulumi.Input[builtins.str] entry: The IP address for the ACL entry.
        :param pulumi.Input[builtins.str] status: The status of the ACL entry. Valid values:
               - `Adding`: The ACL entry is being added.
               - `Available`: The ACL entry is added and available.
               - `Removing`: The ACL entry is being removed.
        """
...
class ListenerAccessLogTracingConfigArgs:
    ...
    def tracing_enabled(self, value: pulumi.Input[builtins.bool]):
    ...
    def tracing_sample(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @tracing_type.setter
    def tracing_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ListenerAclConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] acl_type: The type of the ACL. Valid values: `White` Or `Black`. `White`: specifies the ACL as a whitelist. Only requests from the IP addresses or CIDR blocks in the ACL are forwarded. Whitelists apply to scenarios where only specific IP addresses are allowed to access an application. Risks may occur if the whitelist is improperly set. After you set a whitelist for an Application Load Balancer (ALB) listener, only requests from IP addresses that are added to the whitelist are distributed by the listener. If the whitelist is enabled without IP addresses specified, the ALB listener does not forward requests. `Black`: All requests from the IP addresses or CIDR blocks in the ACL are denied. The blacklist is used to prevent specified IP addresses from accessing an application. If the blacklist is enabled but the corresponding ACL does not contain IP addresses, the ALB listener forwards all requests.
        """
...
if not MYPY:
    class ListenerAclConfigAclRelationArgsDict(TypedDict):
        acl_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ListenerAclConfigAclRelationArgs:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] acl_id: Snooping Binding of the Access Policy Group ID List.
...
class ListenerCaCertificateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] certificate_id: The ID of the certificate. Currently, only server certificates are supported.
        """
...
class ListenerDefaultActionForwardGroupConfigServerGroupTupleArgs:
    def __init__(__self__, *,
                 server_group_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] server_group_id: Forwarded to the Destination Server Group ID
        """
...
if not MYPY:
    class ListenerQuicConfigArgsDict(TypedDict):
        quic_listener_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        quic_upgrade_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ListenerQuicConfigArgs:
    def __init__(__self__, *,
                 quic_listener_id: Optional[pulumi.Input[builtins.str]] = None,
                 quic_upgrade_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] quic_listener_id: There Is a Need to Correlate the QuIC Listener ID. The Https Listener, in Effect at the Time. quicupgradeenabled True When Required.
        :param pulumi.Input[builtins.bool] quic_upgrade_enabled: Indicates Whether to Enable the QuIC Upgrade
        """
    ...
    def quic_listener_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        There Is a Need to Correlate the QuIC Listener ID. The Https Listener, in Effect at the Time. quicupgradeenabled True When Required.
        """
    ...
    def quic_listener_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "quic_listener_id", value)

    @property
    @pulumi.getter(name="quicUpgradeEnabled")
    def quic_upgrade_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates Whether to Enable the QuIC Upgrade
        """
    ...
    def quic_upgrade_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "quic_upgrade_enabled", value)


if not MYPY:
    class ListenerXForwardedForConfigArgsDict(TypedDict):
        x_forwarded_for_client_cert_client_verify_alias: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        x_forwarded_for_client_cert_client_verify_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Indicates Whether the X-Forwarded-Clientcert-clientverify Header Field Is Used to Obtain Access to the Server Load Balancer Instance of the Client Certificate to Verify the Results.
        """
        x_forwarded_for_client_cert_finger_print_alias: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        x_forwarded_for_client_cert_finger_print_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        x_forwarded_for_client_cert_issuer_dn_alias: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        x_forwarded_for_client_cert_issuer_dn_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Indicates Whether the X-Forwarded-Clientcert-issuerdn Header Field Is Used to Obtain Access to the Server Load Balancer Instance of the Client Certificate after the Manifests Are Signed, the Publisher Information.
        """
        x_forwarded_for_client_cert_subject_dn_alias: NotRequired[pulumi.Input[builtins.str]]
        """
        The Custom Header Field Name,
        """
        x_forwarded_for_client_cert_subject_dn_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        x_forwarded_for_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        x_forwarded_for_slb_id_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Indicates Whether the SLB-ID Header Field Is Used to Obtain the Load Balancing Instance Id
        """
        x_forwarded_for_slb_port_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ListenerXForwardedForConfigArgs:
    def __init__(__self__, *,
                 x_forwarded_for_client_cert_client_verify_alias: Optional[pulumi.Input[builtins.str]] = None,
                 x_forwarded_for_client_cert_client_verify_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 x_forwarded_for_client_cert_finger_print_alias: Optional[pulumi.Input[builtins.str]] = None,
                 x_forwarded_for_client_cert_finger_print_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 x_forwarded_for_client_cert_issuer_dn_alias: Optional[pulumi.Input[builtins.str]] = None,
                 x_forwarded_for_client_cert_issuer_dn_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 x_forwarded_for_client_cert_subject_dn_alias: Optional[pulumi.Input[builtins.str]] = None,
                 x_forwarded_for_client_cert_subject_dn_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 x_forwarded_for_client_source_ips_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 x_forwarded_for_client_source_ips_trusted: Optional[pulumi.Input[builtins.str]] = None,
                 x_forwarded_for_client_src_port_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 x_forwarded_for_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 x_forwarded_for_host_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 x_forwarded_for_processing_mode: Optional[pulumi.Input[builtins.str]] = None,
                 x_forwarded_for_proto_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 x_forwarded_for_slb_id_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 x_forwarded_for_slb_port_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] x_forwarded_for_client_cert_client_verify_alias: The Custom Header Field Names Only When xforwardedforclientcertclientverifyenabled Has a Value of True, this Value Will Not Take Effect until.
        :param pulumi.Input[builtins.bool] x_forwarded_for_client_cert_client_verify_enabled: Indicates Whether the X-Forwarded-Clientcert-clientverify Header Field Is Used to Obtain Access to the Server Load Balancer Instance of the Client Certificate to Verify the Results.
        :param pulumi.Input[builtins.str] x_forwarded_for_client_cert_finger_print_alias: The Custom Header Field Names Only When xforwardedforclientcertfingerprintenabled, Which Evaluates to True When the Entry into Force of.
        :param pulumi.Input[builtins.bool] x_forwarded_for_client_cert_finger_print_enabled: Indicates Whether the X-Forwarded-Clientcert-fingerprint Header Field Is Used to Obtain Access to the Server Load Balancer Instance of the Client Certificate Fingerprint Value.
        :param pulumi.Input[builtins.str] x_forwarded_for_client_cert_issuer_dn_alias: The Custom Header Field Names Only When xforwardedforclientcertsubjectdnenabled, Which Evaluates to True When the Entry into Force of.
        :param pulumi.Input[builtins.bool] x_forwarded_for_client_cert_issuer_dn_enabled: Indicates Whether the X-Forwarded-Clientcert-issuerdn Header Field Is Used to Obtain Access to the Server Load Balancer Instance of the Client Certificate after the Manifests Are Signed, the Publisher Information.
    ...
    def x_forwarded_for_client_cert_client_verify_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Custom Header Field Names Only When xforwardedforclientcertclientverifyenabled Has a Value of True, this Value Will Not Take Effect until.
        """
    ...
    def x_forwarded_for_client_cert_client_verify_alias(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def x_forwarded_for_client_cert_client_verify_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates Whether the X-Forwarded-Clientcert-clientverify Header Field Is Used to Obtain Access to the Server Load Balancer Instance of the Client Certificate to Verify the Results.
        """
    ...
    def x_forwarded_for_client_cert_client_verify_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def x_forwarded_for_client_cert_finger_print_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Custom Header Field Names Only When xforwardedforclientcertfingerprintenabled, Which Evaluates to True When the Entry into Force of.
        """
    ...
    def x_forwarded_for_client_cert_finger_print_alias(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def x_forwarded_for_client_cert_finger_print_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates Whether the X-Forwarded-Clientcert-fingerprint Header Field Is Used to Obtain Access to the Server Load Balancer Instance of the Client Certificate Fingerprint Value.
        """
    ...
    def x_forwarded_for_client_cert_finger_print_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def x_forwarded_for_client_cert_issuer_dn_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Custom Header Field Names Only When xforwardedforclientcertsubjectdnenabled, Which Evaluates to True When the Entry into Force of.
        """
    ...
    def x_forwarded_for_client_cert_issuer_dn_alias(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def x_forwarded_for_client_cert_issuer_dn_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates Whether the X-Forwarded-Clientcert-issuerdn Header Field Is Used to Obtain Access to the Server Load Balancer Instance of the Client Certificate after the Manifests Are Signed, the Publisher Information.
        """
    ...
    def x_forwarded_for_client_cert_issuer_dn_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def x_forwarded_for_client_cert_subject_dn_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Custom Header Field Name,
        """
    ...
    def x_forwarded_for_client_cert_subject_dn_alias(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def x_forwarded_for_client_cert_subject_dn_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates Whether the X-Forwarded-Clientcert-subjectdn Header Field Is Used to Obtain Access to the Server Load Balancer Instance of the Client Certificate Owner Information.
        """
    ...
    def x_forwarded_for_client_cert_subject_dn_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def x_forwarded_for_client_source_ips_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def x_forwarded_for_client_source_ips_trusted(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "x_forwarded_for_client_source_ips_trusted", value)

    @property
    @pulumi.getter(name="xForwardedForClientSrcPortEnabled")
    def x_forwarded_for_client_src_port_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates Whether the X-Forwarded-Client-Port Header Field Is Used to Obtain Access to Server Load Balancer Instances to the Client, and Those of the Ports.
        """
    ...
    def x_forwarded_for_client_src_port_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "x_forwarded_for_client_src_port_enabled", value)

    @property
    @pulumi.getter(name="xForwardedForEnabled")
    def x_forwarded_for_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to Enable by X-Forwarded-For Header Field Is Used to Obtain the Client IP Addresses.
        """
    ...
    def x_forwarded_for_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def x_forwarded_for_host_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def x_forwarded_for_processing_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "x_forwarded_for_processing_mode", value)

    @property
    @pulumi.getter(name="xForwardedForProtoEnabled")
    def x_forwarded_for_proto_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates Whether the X-Forwarded-Proto Header Field Is Used to Obtain the Server Load Balancer Instance Snooping Protocols.
        """
    ...
    def x_forwarded_for_proto_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "x_forwarded_for_proto_enabled", value)

    @property
    @pulumi.getter(name="xForwardedForSlbIdEnabled")
    def x_forwarded_for_slb_id_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates Whether the SLB-ID Header Field Is Used to Obtain the Load Balancing Instance Id
        """
    ...
    def x_forwarded_for_slb_id_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "x_forwarded_for_slb_id_enabled", value)

    @property
    @pulumi.getter(name="xForwardedForSlbPortEnabled")
    def x_forwarded_for_slb_port_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates Whether the X-Forwarded-Port Header Field Is Used to Obtain the Server Load Balancer Instance Listening Port
        """
    ...
    def x_forwarded_for_slb_port_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "x_forwarded_for_slb_port_enabled", value)


if not MYPY:
    class LoadBalancerAccessLogConfigArgsDict(TypedDict):
        log_project: NotRequired[pulumi.Input[builtins.str]]
        """
        The project to which the access log is shipped.
        """
        log_store: NotRequired[pulumi.Input[builtins.str]]
        """
...
class LoadBalancerAccessLogConfigArgs:
    def __init__(__self__, *,
                 log_project: Optional[pulumi.Input[builtins.str]] = None,
                 log_store: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] log_project: The project to which the access log is shipped.
        :param pulumi.Input[builtins.str] log_store: The Logstore to which the access log is shipped.
        """
    ...
    def log_project(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The project to which the access log is shipped.
        """
    ...
    @log_project.setter
    def log_project(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_project", value)

    @property
    @pulumi.getter(name="logStore")
    def log_store(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Logstore to which the access log is shipped.
        """
    ...
    @log_store.setter
    def log_store(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class LoadBalancerDeletionProtectionConfigArgsDict(TypedDict):
        ...
        """
        enabled_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class LoadBalancerDeletionProtectionConfigArgs:
    def __init__(__self__, *,
                 ...
                 enabled_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Remove the Protection Status
        :param pulumi.Input[builtins.str] enabled_time: Deletion Protection Turn-on Time Use Greenwich Mean Time, in the Format of Yyyy-MM-ddTHH: mm: SSZ
        """
    ...
    def enabled_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Deletion Protection Turn-on Time Use Greenwich Mean Time, in the Format of Yyyy-MM-ddTHH: mm: SSZ
        """
    ...
    @enabled_time.setter
    def enabled_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "enabled_time", value)


if not MYPY:
    class LoadBalancerLoadBalancerBillingConfigArgsDict(TypedDict):
        pay_type: pulumi.Input[builtins.str]
        """
        Pay Type
        """
elif False:
...
class LoadBalancerLoadBalancerBillingConfigArgs:
    def __init__(__self__, *,
                 pay_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] pay_type: Pay Type
        """
        pulumi.set(__self__, "pay_type", pay_type)

    @property
    @pulumi.getter(name="payType")
    def pay_type(self) -> pulumi.Input[builtins.str]:
        """
        Pay Type
        """
    ...
    @pay_type.setter
    def pay_type(self, value: pulumi.Input[builtins.str]):
...
class LoadBalancerModificationProtectionConfigArgs:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] reason: Managed Instance
        :param pulumi.Input[builtins.str] status: Load Balancing Modify the Protection Status
        """
...
if not MYPY:
    class LoadBalancerZoneMappingArgsDict(TypedDict):
        ...
        """
        intranet_address: NotRequired[pulumi.Input[builtins.str]]
        """
...
class LoadBalancerZoneMappingArgs:
    def __init__(__self__, *,
                 ...
                 intranet_address: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the vSwitch that corresponds to the zone. Each zone can use only one vSwitch and subnet.
        :param pulumi.Input[builtins.str] zone_id: The ID of the zone to which the SLB instance belongs.
        :param pulumi.Input[builtins.str] address: An IP address of the IPv4 type.
        :param pulumi.Input[builtins.str] allocation_id: The ID of the EIP instance.
        :param pulumi.Input[builtins.str] eip_type: The type of the EIP instance.
        :param pulumi.Input[builtins.str] intranet_address: IPv4 private network address.
        :param pulumi.Input[builtins.str] ipv6_address: An IP address of the IPv6 type.
    ...
    def intranet_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        IPv4 private network address.
        """
    ...
    def intranet_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class LoadBalancerZoneMappingLoadBalancerAddressArgsDict(TypedDict):
        ...
        IPv4 private network address.
        """
        intranet_address_hc_status: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        An IP address of the IPv6 type.
        """
        ipv6_address_hc_status: NotRequired[pulumi.Input[builtins.str]]
        """
...
class LoadBalancerZoneMappingLoadBalancerAddressArgs:
    def __init__(__self__, *,
                 ...
                 eip_type: Optional[pulumi.Input[builtins.str]] = None,
                 intranet_address: Optional[pulumi.Input[builtins.str]] = None,
                 intranet_address_hc_status: Optional[pulumi.Input[builtins.str]] = None,
                 ipv4_local_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ipv6_address: Optional[pulumi.Input[builtins.str]] = None,
                 ipv6_address_hc_status: Optional[pulumi.Input[builtins.str]] = None,
                 ipv6_local_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] address: An IP address of the IPv4 type.
        :param pulumi.Input[builtins.str] allocation_id: The elastic IP identifier.
        :param pulumi.Input[builtins.str] eip_type: The type of the public EIP. Value:
        :param pulumi.Input[builtins.str] intranet_address: IPv4 private network address.
        :param pulumi.Input[builtins.str] intranet_address_hc_status: The private network IPv4 address detection status of the application-oriented load balancing instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ipv4_local_addresses: IPv4 Local address list. The list of addresses used by ALB to interact with the backend service.
        :param pulumi.Input[builtins.str] ipv6_address: An IP address of the IPv6 type.
        :param pulumi.Input[builtins.str] ipv6_address_hc_status: The IPv6 address detection status of the application-based load balancing instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ipv6_local_addresses: IPv6 Local address list. The list of addresses used by ALB to interact with the backend service.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
        if allocation_id is not None:
    ...
    def intranet_address_hc_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The private network IPv4 address detection status of the application-oriented load balancing instance.
        """
    ...
    def intranet_address_hc_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ipv6_address_hc_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IPv6 address detection status of the application-based load balancing instance.
        """
    ...
    def ipv6_address_hc_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RuleRuleActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] order: The order of the forwarding rule actions. Valid values: `1` to `50000`. The actions are performed in ascending order. You cannot leave this parameter empty. Each value must be unique.
        :param pulumi.Input[builtins.str] type: The action type. Valid values: `ForwardGroup`, `Redirect`, `FixedResponse`, `Rewrite`, `InsertHeader`, `RemoveHeader`, `TrafficLimit`, `TrafficMirror` and `Cors`.
               **Note:** The preceding actions can be classified into two types:  `FinalType`: A forwarding rule can contain only one `FinalType` action, which is executed last. This type of action can contain only one `ForwardGroup`, `Redirect` or `FixedResponse` action. `ExtType`: A forwarding rule can contain one or more `ExtType` actions, which are executed before `FinalType` actions and need to coexist with the `FinalType` actions. This type of action can contain multiple `InsertHeader` actions or one `Rewrite` action.
               **NOTE:** The `TrafficLimit` and `TrafficMirror` option is available since 1.162.0.
               **NOTE:** From version 1.205.0, `type` can be set to `Cors`.
...
if not MYPY:
    class RuleRuleActionCorsConfigArgsDict(TypedDict):
        allow_credentials: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RuleRuleActionCorsConfigArgs:
    def __init__(__self__, *,
                 allow_credentials: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] allow_credentials: Specifies whether credentials can be passed during CORS operations. Valid values: `on`, `off`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allow_headers: The allowed headers for CORS requests.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allow_methods: The allowed HTTP methods for CORS requests. Valid values: `GET`, `POST`, `PUT`, `DELETE`, `HEAD`, `OPTIONS`, `PATCH`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allow_origins: The allowed origins of CORS requests.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] expose_headers: The headers that can be exposed.
        :param pulumi.Input[builtins.int] max_age: The maximum cache time of preflight requests in the browser. Unit: seconds. Valid values: `-1` to `172800`.
        """
    ...
    def allow_credentials(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies whether credentials can be passed during CORS operations. Valid values: `on`, `off`.
        """
    ...
    def allow_credentials(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RuleRuleActionFixedResponseConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] content: The fixed response. The response cannot exceed 1 KB in size and can contain only ASCII characters.
        :param pulumi.Input[builtins.str] content_type: The format of the fixed response. Valid values: `text/plain`, `text/css`, `text/html`, `application/javascript`, and `application/json`.
        :param pulumi.Input[builtins.str] http_code: The redirect method. Valid values: `301`, `302`, `303`, `307`, and `308`.
        """
...
class RuleRuleActionForwardGroupConfigServerGroupStickySessionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Whether to enable session persistence.
        :param pulumi.Input[builtins.int] timeout: The timeout period. Unit: seconds. Valid values: `1` to `86400`. Default value: `1000`.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class RuleRuleActionForwardGroupConfigServerGroupTupleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] server_group_id: The ID of the destination server group to which requests are forwarded.
        :param pulumi.Input[builtins.int] weight: The Weight of server group. Default value: `100`. **NOTE:** This attribute is required when the number of `server_group_tuples` is greater than 2.
        """
...
class RuleRuleActionInsertHeaderConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] value_type: The value type of the inserted header field. Valid values:
               - `UserDefined`: a custom value
               - `ReferenceHeader`: uses a field of the user request header.
               - `SystemDefined`: a system value.
        """
...
class RuleRuleActionRedirectConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] host: The host name of the destination to which requests are redirected within ALB. Valid values:  The host name must be 3 to 128 characters in length, and can contain letters, digits, hyphens (-), periods (.), asterisks (*), and question marks (?). The host name must contain at least one period (.), and cannot start or end with a period (.). The rightmost domain label can contain only letters, asterisks (*) and question marks (?) and cannot contain digits or hyphens (-). Other domain labels cannot start or end with a hyphen (-). You can include asterisks (*) and question marks (?) anywhere in a domain label. Default value: ${host}. You cannot use this value with other characters at the same time.
        :param pulumi.Input[builtins.str] http_code: The redirect method. Valid values: `301`, `302`, `303`, `307`, and `308`.
        :param pulumi.Input[builtins.str] path: The path to which requests are to be redirected within ALB. Valid values: The path must be 1 to 128 characters in length, and start with a forward slash (/). The path can contain letters, digits, asterisks (*), question marks (?)and the following special characters: $ - _ . + / & ~ @ :. It cannot contain the following special characters: " % # ; ! ( ) [ ] ^ , ”. The path is case-sensitive. Default value: ${path}. This value can be used only once. You can use it with a valid string.
        :param pulumi.Input[builtins.str] port: The port of the destination to which requests are redirected. Valid values: 1 to 63335. Default value: ${port}. You cannot use this value together with other characters at the same time.
        :param pulumi.Input[builtins.str] protocol: The protocol of the requests to be redirected. Valid values: `HTTP` and `HTTPS`. Default value: `${protocol}`. You cannot use this value together with other characters at the same time. Note HTTPS listeners can redirect only HTTPS requests.
        :param pulumi.Input[builtins.str] query: The query string of the request to be redirected within ALB. The query string must be 1 to 128 characters in length, can contain letters and printable characters. It cannot contain the following special characters: # [ ] { } \\ | < > &. Default value: ${query}. This value can be used only once. You can use it with a valid string.
        """
        if host is not None:
...
if not MYPY:
    class RuleRuleActionTrafficLimitConfigArgsDict(TypedDict):
        per_ip_qps: NotRequired[pulumi.Input[builtins.int]]
        """
...
class RuleRuleActionTrafficLimitConfigArgs:
    def __init__(__self__, *,
                 per_ip_qps: Optional[pulumi.Input[builtins.int]] = None,
                 qps: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] per_ip_qps: The number of requests per second for a single IP address. Value range: 1~1000000. Note: If the QPS parameter is also configured, the value of the PerIpQps parameter must be smaller than the value of the QPS parameter.
        :param pulumi.Input[builtins.int] qps: The Number of requests per second. Valid values: `1` to `100000`.
        """
    ...
    def per_ip_qps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of requests per second for a single IP address. Value range: 1~1000000. Note: If the QPS parameter is also configured, the value of the PerIpQps parameter must be smaller than the value of the QPS parameter.
        """
    ...
    @per_ip_qps.setter
    def per_ip_qps(self, value: Optional[pulumi.Input[builtins.int]]):
...
class RuleRuleActionTrafficMirrorConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] target_type: The Mirror target type.
        """
...
class RuleRuleConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of the forwarding rule. Valid values:
               - `Host`: Requests are forwarded based on hosts.
               - `Path`: Requests are forwarded based on the path.
               - `Header`: Requests are forwarded based on the HTTP header field.
               - `QueryString`: Requests are forwarded based on the query string.
...
class RuleRuleConditionHeaderConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Add one or more IP addresses or IP address segments. You can add up to 5 forwarding rules in a SourceIp.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if values is not None:
...
if not MYPY:
    class ServerGroupConnectionDrainConfigArgsDict(TypedDict):
        connection_drain_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Specifies whether to enable connection draining. Valid values:
        """
        connection_drain_timeout: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ServerGroupConnectionDrainConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] connection_drain_enabled: Specifies whether to enable connection draining. Valid values:
        :param pulumi.Input[builtins.int] connection_drain_timeout: The timeout period of connection draining.
...
if not MYPY:
    class ServerGroupHealthCheckConfigArgsDict(TypedDict):
        health_check_enabled: pulumi.Input[builtins.bool]
        """
        Specifies whether to enable the health check feature. Valid values:
        """
        health_check_codes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The status code for a successful health check
        """
        health_check_connect_port: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        health_check_host: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        *   The domain name cannot start or end with a hyphen (-).
        ...
        """
        health_check_http_version: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        *   **HTTP1.1**
        ...
        > **NOTE:**   This parameter takes effect only if you set `HealthCheckEnabled` to `true`.
        """
        health_check_method: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        *   `HEAD`: HTTP and HTTPS health checks use the HEAD method by default.
        ...
        > **NOTE:**   This parameter takes effect only if you set `HealthCheckEnabled` to `true` and `HealthCheckProtocol` to `HTTP` or `HTTPS`.
        """
        health_check_protocol: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServerGroupHealthCheckConfigArgs:
    def __init__(__self__, *,
                 health_check_enabled: pulumi.Input[builtins.bool],
                 health_check_codes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 health_check_connect_port: Optional[pulumi.Input[builtins.int]] = None,
                 health_check_host: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.bool] health_check_enabled: Specifies whether to enable the health check feature. Valid values:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] health_check_codes: The status code for a successful health check
        :param pulumi.Input[builtins.int] health_check_connect_port: The backend port that is used for health checks.
               ...
               > **NOTE:**   This parameter takes effect only if you set `HealthCheckEnabled` to `true`.
        :param pulumi.Input[builtins.str] health_check_host: The domain name that is used for health checks.
               ...
               *   The domain name cannot start or end with a hyphen (-).
               ...
               > **NOTE:**   This parameter takes effect only if `HealthCheckProtocol` is set to `HTTP`, `HTTPS`, or `gRPC`.
        :param pulumi.Input[builtins.str] health_check_http_version: The HTTP version that is used for health checks. Valid values:
               ...
               *   **HTTP1.1**
               ...
               > **NOTE:**   This parameter takes effect only if you set `HealthCheckEnabled` to true and `HealthCheckProtocol` to `HTTP` or `HTTPS`.
        :param pulumi.Input[builtins.int] health_check_interval: The interval at which health checks are performed. Unit: seconds.
               
               Valid values: `1` to `50`.
               
               > **NOTE:**   This parameter takes effect only if you set `HealthCheckEnabled` to `true`.
        :param pulumi.Input[builtins.str] health_check_method: The HTTP method that is used for health checks. Valid values:
               ...
               *   `HEAD`: HTTP and HTTPS health checks use the HEAD method by default.
               ...
               > **NOTE:**   This parameter takes effect only if you set `HealthCheckEnabled` to true and `HealthCheckProtocol` to `HTTP`, `HTTPS`, or `gRPC`.
        :param pulumi.Input[builtins.str] health_check_path: The URL that is used for health checks.
               
               The URL must be 1 to 80 characters in length, and can contain letters, digits, and the following special characters: `- / . % ? # & =`. It can also contain the following extended characters: `_ ; ~ ! ( ) * [ ] @ $ ^ : ' , +`. The URL must start with a forward slash (`/`).
               
               > **NOTE:**   This parameter takes effect only if you set `HealthCheckEnabled` to `true` and `HealthCheckProtocol` to `HTTP` or `HTTPS`.
        :param pulumi.Input[builtins.str] health_check_protocol: The protocol that is used for health checks. Valid values:
               
               - `HTTP`: HTTP health checks simulate browser behaviors by sending HEAD or GET requests to probe the availability of backend servers.
               - `HTTPS`: HTTPS health checks simulate browser behaviors by sending HEAD or GET requests to probe the availability of backend servers. HTTPS provides higher security than HTTP because HTTPS supports data encryption.
               - `TCP`: TCP health checks send TCP SYN packets to a backend server to probe the availability of backend servers.
               - `gRPC`: gRPC health checks send POST or GET requests to a backend server to check whether the backend server is healthy.
        :param pulumi.Input[builtins.int] health_check_timeout: The timeout period of a health check response. If a backend ECS instance does not respond within the specified timeout period, the ECS instance fails the health check. Unit: seconds.
               
               Valid values: `1` to `300`.
               
               > **NOTE:**   This parameter takes effect only if you set `HealthCheckEnabled` to `true`.
        :param pulumi.Input[builtins.int] healthy_threshold: The number of times that an unhealthy backend server must consecutively pass health checks before it is declared healthy. In this case, the health check status of the backend server changes from `fail` to `success`.
               
               Valid values: `2` to `10`.
               
               Default value: `3`.
        :param pulumi.Input[builtins.int] unhealthy_threshold: The number of times that a healthy backend server must consecutively fail health checks before it is declared unhealthy. In this case, the health check status of the backend server changes from `success` to `fail`.
    ...
    def health_check_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        Specifies whether to enable the health check feature. Valid values:
        """
    ...
    def health_check_enabled(self, value: pulumi.Input[builtins.bool]):
    ...
    def health_check_codes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def health_check_connect_port(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def health_check_host(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ServerGroupServerArgsDict(TypedDict):
        ...
        *   If the server group is of the `Ip` type, set ServerId to IP addresses.
        ...
        """
        remote_ip_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        server_ip: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServerGroupServerArgs:
    def __init__(__self__, *,
                 ...
                 remote_ip_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 server_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 server_ip: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 weight: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] server_id: The ID of the backend server. You can specify at most 200 servers in each call.
               ...
               *   If the server group is of the `Ip` type, set ServerId to IP addresses.
               ...
               > **NOTE:**   You cannot perform this operation on a server group of the Function Compute type. You can call the [ListServerGroups](https://www.alibabacloud.com/help/en/doc-detail/213627.html) operation to query the type of server groups.
        :param pulumi.Input[builtins.str] server_type: The type of the backend server. You can specify at most 200 servers in each call. Default values:
               ...
               - `Ip`: IP address
               - `Fc`: Function Compute
        :param pulumi.Input[builtins.str] description: The description of the backend server. The description must be 2 to 256 characters in length, and cannot start with http:// or https://.
        :param pulumi.Input[builtins.int] port: The port that is used by the backend server. Valid values: `1` to `65535`. You can specify at most 200 servers in each call.
               
               > **NOTE:**   This parameter is required if you set `ServerType` to `Ecs`, `Eni`, `Eci`, or `Ip`. You do not need to set this parameter if `ServerType` is set to `Fc`.
        :param pulumi.Input[builtins.bool] remote_ip_enabled: Specifies whether to enable the remote IP feature. You can specify at most 200 servers in each call. Default values:
        :param pulumi.Input[builtins.str] server_group_id: The ID of the server group.
        :param pulumi.Input[builtins.str] server_ip: The IP address of the backend server. You can specify at most 200 servers in each call.
    ...
    def remote_ip_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to enable the remote IP feature. You can specify at most 200 servers in each call. Default values:
        """
    ...
    def remote_ip_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def server_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IP address of the backend server. You can specify at most 200 servers in each call.
    ...
    @server_ip.setter
    def server_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ServerGroupSlowStartConfigArgsDict(TypedDict):
        slow_start_duration: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        Default value: 30.
        """
        slow_start_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ServerGroupSlowStartConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] slow_start_duration: The duration of a slow start.
               
               Valid values: 30 to 900.
               
               Default value: 30.
        :param pulumi.Input[builtins.bool] slow_start_enabled: Indicates whether slow starts are enabled. Valid values:
        """
...
if not MYPY:
    class ServerGroupStickySessionConfigArgsDict(TypedDict):
        ...
        """
        sticky_session_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ServerGroupStickySessionConfigArgs:
    def __init__(__self__, *,
                 ...
                 sticky_session_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 sticky_session_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cookie: The cookie to be configured on the server.
               
               The cookie must be 1 to 200 characters in length and can contain only ASCII characters and digits. It cannot contain commas (,), semicolons (;), or space characters. It cannot start with a dollar sign ($).
               
               > **NOTE:**  This parameter takes effect when the `StickySessionEnabled` parameter is set to `true` and the `StickySessionType` parameter is set to `Server`.
        :param pulumi.Input[builtins.int] cookie_timeout: The maximum amount of time to wait before the session cookie expires. Unit: seconds.
               ...
               > **NOTE:**   This parameter takes effect only when `StickySessionEnabled` is set to `true` and `StickySessionType` is set to `Insert`.
        :param pulumi.Input[builtins.bool] sticky_session_enabled: Specifies whether to enable session persistence. Valid values:
        :param pulumi.Input[builtins.str] sticky_session_type: The method that is used to handle a cookie. Valid values:
    ...
    def sticky_session_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to enable session persistence. Valid values:
        """
    ...
    def sticky_session_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ServerGroupUchConfigArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: The parameter type. Only QueryString can be filled.
        :param pulumi.Input[builtins.str] value: Consistency hash parameter value
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
        if value is not None:
