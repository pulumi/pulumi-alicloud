...
class LoadBalancerAccessLogConfigAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 log_project: pulumi.Input[builtins.str],
                 log_store: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a LoadBalancerAccessLogConfigAttachment resource.
        :param pulumi.Input[builtins.str] load_balancer_id: The ID of the load balancing instance.
        :param pulumi.Input[builtins.str] log_project: The log items shipped by the access log.
        :param pulumi.Input[builtins.str] log_store: Logstore for log delivery.
        """
    ...
    def log_project(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @log_project.setter
    def log_project(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "log_project", value)

    @property
    @pulumi.getter(name="logStore")
    def log_store(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @log_store.setter
    def log_store(self, value: pulumi.Input[builtins.str]):
...
class LoadBalancerAccessLogConfigAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            load_balancer_id: Optional[pulumi.Input[builtins.str]] = None,
            log_project: Optional[pulumi.Input[builtins.str]] = None,
            log_store: Optional[pulumi.Input[builtins.str]] = None) -> 'LoadBalancerAccessLogConfigAttachment':
        """
    ...
    @property
    @pulumi.getter(name="logProject")
    def log_project(self) -> pulumi.Output[builtins.str]:
        """
        The log items shipped by the access log.
        """
        return pulumi.get(self, "log_project")
    ...
    @property
    @pulumi.getter(name="logStore")
    def log_store(self) -> pulumi.Output[builtins.str]:
        """
        Logstore for log delivery.
        """
        return pulumi.get(self, "log_store")
