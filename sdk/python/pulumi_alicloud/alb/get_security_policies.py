...
class GetSecurityPoliciesResult:
    ...
    def security_policy_ids(self) -> Optional[Sequence[builtins.str]]:
...
def get_security_policies(ids: Optional[Sequence[builtins.str]] = None,
                          ...
                          security_policy_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] security_policy_ids: The security policy ids.
    :param builtins.str security_policy_name: The name of the resource.
...
def get_security_policies_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 ...
                                 security_policy_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 security_policy_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:alb/getSecurityPolicies:getSecurityPolicies', __args__, opts=opts, typ=GetSecurityPoliciesResult)
    return __ret__.apply(lambda __response__: GetSecurityPoliciesResult(
        ...
        security_policy_ids=pulumi.get(__response__, 'security_policy_ids'),
