...
class GetSecurityPoliciesResult:
    ...
    def security_policy_ids(self) -> Optional[Sequence[_builtins.str]]:
...
def get_security_policies(ids: Optional[Sequence[_builtins.str]] = None,
                          ...
                          security_policy_ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] security_policy_ids: The security policy ids.
    :param _builtins.str security_policy_name: The name of the resource.
...
def get_security_policies_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                 ...
                                 security_policy_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
