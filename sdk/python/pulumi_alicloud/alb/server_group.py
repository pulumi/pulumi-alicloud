...
class ServerGroupArgs:
    def __init__(__self__, *,
                 ...
                 server_group_name: pulumi.Input[builtins.str],
                 ...
                 upstream_keepalive_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] server_group_name: The name of the server group. The name must be 2 to 128 characters in length, and can contain letters, digits, periods (.), underscores (\\_), and hyphens (-). The name must start with a letter.
        ...
        :param pulumi.Input[builtins.bool] cross_zone_enabled: Indicates whether cross-zone load balancing is enabled for the server group. Valid values:
        ...
        :param pulumi.Input[builtins.str] health_check_template_id: The ID of the resource group to which you want to transfer the cloud resource.
               
               > **NOTE:**   You can use resource groups to manage resources within your Alibaba Cloud account by group. This helps you resolve issues such as resource grouping and permission management for your Alibaba Cloud account. For more information, see [What is resource management?](https://www.alibabacloud.com/help/en/doc-detail/94475.html)
        :param pulumi.Input[builtins.bool] ipv6_enabled: Enable Ipv6
        :param pulumi.Input[builtins.str] protocol: The backend protocol. Valid values:
        ...
        :param pulumi.Input[builtins.str] resource_group_id: Elegant interrupt configuration.
        :param pulumi.Input[builtins.str] scheduler: The scheduling algorithm. Valid values:
        ...
        :param pulumi.Input[builtins.str] server_group_type: The type of server group. Valid values:
        ...
        :param pulumi.Input[builtins.str] service_name: Only applicable to the ALB Ingress scenario, indicating the K8s Service name corresponding to the server group.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The creation time of the resource
        :param pulumi.Input['ServerGroupUchConfigArgs'] uch_config: Url consistency hash parameter configuration See `uch_config` below.
        :param pulumi.Input[builtins.bool] upstream_keepalive_enabled: Specifies whether to enable persistent TCP connections.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the virtual private cloud (VPC). You can add only servers that are deployed in the specified VPC to the server group.
    ...
    def server_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def server_group_name(self, value: pulumi.Input[builtins.str]):
    ...
    def upstream_keepalive_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def upstream_keepalive_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ServerGroup(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:alb/serverGroup:ServerGroup"
    ...
    @property
    @pulumi.getter(name="healthCheckTemplateId")
    def health_check_template_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the resource group to which you want to transfer the cloud resource.
    ...
    @property
    @pulumi.getter(name="upstreamKeepaliveEnabled")
    def upstream_keepalive_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable persistent TCP connections.
        """
        return pulumi.get(self, "upstream_keepalive_enabled")
