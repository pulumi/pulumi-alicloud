...
class GetRulesResult:
    ...
    def rule_ids(self) -> Optional[Sequence[builtins.str]]:
...
def get_rules(ids: Optional[Sequence[builtins.str]] = None,
              ...
              rule_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Rule IDs.
    ...
    :param builtins.str name_regex: A regex string to filter results by Rule name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param Sequence[builtins.str] rule_ids: The rule ids.
...
def get_rules_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                     ...
                     rule_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
