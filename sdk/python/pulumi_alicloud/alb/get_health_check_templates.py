...
class GetHealthCheckTemplatesResult:
    ...
    def health_check_template_ids(self) -> Optional[Sequence[_builtins.str]]:
        return pulumi.get(self, "health_check_template_ids")

    @_builtins.property
    @pulumi.getter(name="healthCheckTemplateName")
    def health_check_template_name(self) -> Optional[_builtins.str]:
...
def get_health_check_templates(health_check_template_ids: Optional[Sequence[_builtins.str]] = None,
                               health_check_template_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] health_check_template_ids: The health check template ids.
    ...
    :param Sequence[_builtins.str] ids: A list of Health Check Template IDs.
    :param _builtins.str name_regex: A regex string to filter results by Health Check Template name.
