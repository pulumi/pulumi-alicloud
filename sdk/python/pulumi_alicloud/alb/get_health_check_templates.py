...
class GetHealthCheckTemplatesResult:
    ...
    def health_check_template_ids(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "health_check_template_ids")

    @property
    @pulumi.getter(name="healthCheckTemplateName")
    def health_check_template_name(self) -> Optional[builtins.str]:
...
def get_health_check_templates(health_check_template_ids: Optional[Sequence[builtins.str]] = None,
                               health_check_template_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] health_check_template_ids: The health check template ids.
    ...
    :param Sequence[builtins.str] ids: A list of Health Check Template IDs.
    :param builtins.str name_regex: A regex string to filter results by Health Check Template name.
...
def get_health_check_templates_output(health_check_template_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                      health_check_template_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:alb/getHealthCheckTemplates:getHealthCheckTemplates', __args__, opts=opts, typ=GetHealthCheckTemplatesResult)
    return __ret__.apply(lambda __response__: GetHealthCheckTemplatesResult(
        health_check_template_ids=pulumi.get(__response__, 'health_check_template_ids'),
