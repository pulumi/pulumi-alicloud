...
class LoadBalancerZoneShiftedAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vswitch_id: The VSwitch corresponding to the zone. By default, each zone uses one VSwitch and one subnet.
...
class _LoadBalancerZoneShiftedAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] load_balancer_id: The ID of the load balancing instance.
        :param pulumi.Input[builtins.str] status: Availability zone status. Value:
        :param pulumi.Input[builtins.str] vswitch_id: The VSwitch corresponding to the zone. By default, each zone uses one VSwitch and one subnet.
        :param pulumi.Input[builtins.str] zone_id: The ID of the zone.
        """
...
class LoadBalancerZoneShiftedAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LoadBalancerZoneShiftedAttachment':
        """
