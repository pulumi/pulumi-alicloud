...
class ListenerArgs:
    def __init__(__self__, *,
                 ...
                 access_log_record_customized_headers_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 gzip_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] ca_enabled: Whether to turn on two-way authentication. Value:
    ...
    def access_log_record_customized_headers_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def gzip_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @gzip_enabled.setter
    def gzip_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Listener(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="caEnabled")
    def ca_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to turn on two-way authentication. Value:
        """
        return pulumi.get(self, "ca_enabled")
    ...
    @property
    @pulumi.getter(name="gzipEnabled")
    def gzip_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to Enable Gzip Compression, as a Specific File Type on a Compression. Valid Values: True Or False. Default Value: TRUE.
        """
        return pulumi.get(self, "gzip_enabled")
    ...
    @property
    @pulumi.getter(name="http2Enabled")
    def http2_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to Enable HTTP/2 Features. Valid Values: True Or False. Default Value: TRUE.
        """
        return pulumi.get(self, "http2_enabled")
