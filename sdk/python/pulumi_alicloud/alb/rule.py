...
class RuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] listener_id: The ID of the listener to which the forwarding rule belongs.
        :param pulumi.Input[builtins.int] priority: The priority of the rule. Valid values: 1 to 10000. A smaller value indicates a higher priority. **Note*:* The priority of each rule within the same listener must be unique.
        ...
        :param pulumi.Input[builtins.str] rule_name: The name of the forwarding rule. The name must be 2 to 128 characters in length, and can contain letters, digits, periods (.), underscores (_), and hyphens (-). The name must start with a letter.
        :param pulumi.Input[builtins.str] direction: The direction to which the forwarding rule is applied. Default value: `Request`. Valid values:
               - `Request`: The forwarding rule is applied to the client requests received by ALB.
               - `Response`: The forwarding rule is applied to the responses returned by backend servers.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to precheck this request.
        """
...
class Rule(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:alb/rule:Rule"
    ...
    def get(resource_name: str,
            ...
            rule_conditions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RuleRuleConditionArgs', 'RuleRuleConditionArgsDict']]]]] = None,
            rule_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'Rule':
        """
