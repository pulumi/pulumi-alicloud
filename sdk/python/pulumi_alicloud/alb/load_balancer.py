...
class LoadBalancerArgs:
    def __init__(__self__, *,
                 ...
                 load_balancer_edition: pulumi.Input[builtins.str],
                 ...
                 address_allocated_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] address_type: The type of IP address that the SLB instance uses to provide services.
        ...
        :param pulumi.Input[builtins.str] load_balancer_edition: The edition of the ALB instance.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the virtual private cloud (VPC) where the SLB instance is deployed.
        ...
        :param pulumi.Input[builtins.str] address_allocated_mode: The method in which IP addresses are assigned. Valid values:  Fixed: The ALB instance uses a fixed IP address. Dynamic (default): An IP address is dynamically assigned to each zone of the ALB instance.
        :param pulumi.Input[builtins.str] address_ip_version: The protocol version. Value:
               - `IPv4`:IPv4 type.
               - `DualStack`: the dual-stack type.
        :param pulumi.Input[builtins.str] bandwidth_package_id: The ID of the EIP bandwidth plan which is associated with an ALB instance that uses a public IP address.
        ...
        :param pulumi.Input[builtins.bool] deletion_protection_enabled: Specifies whether to enable deletion protection. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.bool] dry_run: Whether to PreCheck only this request, value:
        :param pulumi.Input[builtins.str] ipv6_address_type: The address type of Ipv6
        :param pulumi.Input[builtins.str] load_balancer_name: The name of the resource
    ...
    def load_balancer_edition(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def load_balancer_edition(self, value: pulumi.Input[builtins.str]):
    ...
    def address_allocated_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def address_allocated_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _LoadBalancerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] load_balancer_name: The name of the resource
        :param pulumi.Input['LoadBalancerModificationProtectionConfigArgs'] modification_protection_config: Modify the Protection Configuration See `modification_protection_config` below.
        :param pulumi.Input[builtins.str] region_id: The region ID of the resource
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group
        :param pulumi.Input[builtins.str] status: Server Load Balancer Instance Status:, indicating that the instance listener will no longer forward traffic.(default).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the resource
        :param pulumi.Input[builtins.str] vpc_id: The ID of the virtual private cloud (VPC) where the SLB instance is deployed.
        :param pulumi.Input[Sequence[pulumi.Input['LoadBalancerZoneMappingArgs']]] zone_mappings: The zones and vSwitches. You must specify at least two zones. See `zone_mappings` below.
        """
...
class LoadBalancer(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:alb/loadBalancer:LoadBalancer"
    ...
    @property
    @pulumi.getter(name="addressAllocatedMode")
    def address_allocated_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The method in which IP addresses are assigned. Valid values:  Fixed: The ALB instance uses a fixed IP address. Dynamic (default): An IP address is dynamically assigned to each zone of the ALB instance.
        """
        return pulumi.get(self, "address_allocated_mode")
    ...
    @property
    @pulumi.getter(name="bandwidthPackageId")
    def bandwidth_package_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the EIP bandwidth plan which is associated with an ALB instance that uses a public IP address.
        """
        return pulumi.get(self, "bandwidth_package_id")
    ...
    @property
    @pulumi.getter(name="ipv6AddressType")
    def ipv6_address_type(self) -> pulumi.Output[builtins.str]:
        """
        The address type of Ipv6
        """
        return pulumi.get(self, "ipv6_address_type")
    ...
    @property
    @pulumi.getter(name="loadBalancerName")
    def load_balancer_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the resource
        """
        return pulumi.get(self, "load_balancer_name")
