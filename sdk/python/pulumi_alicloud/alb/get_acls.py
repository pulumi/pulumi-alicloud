...
class GetAclsResult:
    ...
    def acl_ids(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "acl_ids")

    @property
    @pulumi.getter(name="aclName")
    def acl_name(self) -> Optional[builtins.str]:
...
def get_acls(acl_ids: Optional[Sequence[builtins.str]] = None,
             acl_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] acl_ids: The acl ids.
    ...
    :param Sequence[builtins.str] ids: A list of Acl IDs.
    :param builtins.str name_regex: A regex string to filter results by Acl name.
...
def get_acls_output(acl_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                    acl_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
