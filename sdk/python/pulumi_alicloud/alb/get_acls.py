...
class GetAclsResult:
    ...
    def acl_ids(self) -> Optional[Sequence[_builtins.str]]:
...
def get_acls(acl_ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] acl_ids: The acl ids.
