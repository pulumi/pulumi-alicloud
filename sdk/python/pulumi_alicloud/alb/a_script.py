...
class AScriptArgs:
    def __init__(__self__, *,
                 ascript_name: pulumi.Input[builtins.str],
                 listener_id: pulumi.Input[builtins.str],
                 position: pulumi.Input[builtins.str],
                 script_content: pulumi.Input[builtins.str],
                 dry_run: Optional[pulumi.Input[builtins.bool]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ext_attribute_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] ascript_name: AScript name.
        :param pulumi.Input[builtins.str] listener_id: Listener ID of script attribution
        :param pulumi.Input[builtins.str] position: Script execution location.
        :param pulumi.Input[builtins.str] script_content: AScript script content.
        :param pulumi.Input[builtins.bool] dry_run: Whether to PreCheck only this request
        :param pulumi.Input[builtins.bool] enabled: Whether AScript is enabled.
        :param pulumi.Input[builtins.bool] ext_attribute_enabled: Whether extension parameters are enabled. When ExtAttributeEnabled is true, ExtAttributes must be set.
    ...
    def ascript_name(self) -> pulumi.Input[builtins.str]:
        """
        AScript name.
        """
    ...
    @ascript_name.setter
    def ascript_name(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def position(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @position.setter
    def position(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "position", value)

    @property
    @pulumi.getter(name="scriptContent")
    def script_content(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def script_content(self, value: pulumi.Input[builtins.str]):
    ...
    def ext_attribute_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ext_attribute_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _AScriptState:
    def __init__(__self__, *,
                 ascript_name: Optional[pulumi.Input[builtins.str]] = None,
                 dry_run: Optional[pulumi.Input[builtins.bool]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ext_attribute_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ext_attributes: Optional[pulumi.Input[Sequence[pulumi.Input['AScriptExtAttributeArgs']]]] = None,
        ...
        :param pulumi.Input[builtins.str] position: Script execution location.
        :param pulumi.Input[builtins.str] script_content: AScript script content.
        :param pulumi.Input[builtins.str] status: Script status
        """
    ...
    @property
    @pulumi.getter(name="ascriptName")
    def ascript_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        AScript name.
        """
        return pulumi.get(self, "ascript_name")
    ...
    @ascript_name.setter
    def ascript_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ascript_name", value)
...
class AScript(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            position: Optional[pulumi.Input[builtins.str]] = None,
            script_content: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'AScript':
        """
    ...
    @property
    @pulumi.getter(name="ascriptName")
    def ascript_name(self) -> pulumi.Output[builtins.str]:
        """
        AScript name.
        """
        return pulumi.get(self, "ascript_name")
    ...
    @property
    @pulumi.getter(name="extAttributeEnabled")
    def ext_attribute_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether extension parameters are enabled. When ExtAttributeEnabled is true, ExtAttributes must be set.
        """
        return pulumi.get(self, "ext_attribute_enabled")
    ...
    @property
    @pulumi.getter(name="scriptContent")
    def script_content(self) -> pulumi.Output[builtins.str]:
        """
        AScript script content.
        """
        return pulumi.get(self, "script_content")
