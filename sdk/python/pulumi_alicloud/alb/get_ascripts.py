...
class GetAscriptsResult:
    ...
    def ascript_name(self) -> Optional[_builtins.str]:
        """
        Script name.
        """
...
def get_ascripts(ascript_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of AScript IDs.
...
def get_ascripts_output(ascript_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
