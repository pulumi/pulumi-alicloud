...
class ListenerAdditionalCertificateAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_id: The Certificate ID.
        :param pulumi.Input[builtins.str] listener_id: The ID of the ALB listener.
        """
...
class _ListenerAdditionalCertificateAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_id: The Certificate ID.
        :param pulumi.Input[builtins.str] certificate_type: The type of the certificate.
        :param pulumi.Input[builtins.str] listener_id: The ID of the ALB listener.
        :param pulumi.Input[builtins.str] status: The status of the certificate.
        """
