...
class GetServerGroupsResult:
    ...
    def server_group_ids(self) -> Optional[Sequence[builtins.str]]:
...
def get_server_groups(enable_details: Optional[builtins.bool] = None,
                      ...
                      server_group_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Server Group IDs.
    :param builtins.str name_regex: A regex string to filter results by Server Group name.
    ...
    :param Sequence[builtins.str] server_group_ids: The server group IDs.
...
def get_server_groups_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                             ...
                             server_group_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             server_group_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
