...
def get_certificates(certificate_source: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:sslcertificatesserviceinstance/getCertificates:getCertificates', __args__, opts=opts, typ=GetCertificatesResult).value
...
def get_certificates_output(certificate_source: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:sslcertificatesserviceinstance/getCertificates:getCertificates', __args__, opts=opts, typ=GetCertificatesResult)
