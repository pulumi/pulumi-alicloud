...
def get_app_groups(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of App Group IDs. Its element value is same as App Group Name.
    :param builtins.str instance_id: The Instance ID.
    :param builtins.str name_regex: A regex string to filter results by App Group name.
...
def get_app_groups_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
