...
class ShortUrlArgs:
    def __init__(__self__, *,
                 effective_days: pulumi.Input[builtins.int],
                 short_url_name: pulumi.Input[builtins.str],
                 source_url: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ShortUrl resource.
        :param pulumi.Input[builtins.int] effective_days: Short chain service use validity period. Valid values: `30`, `60`, `90`. The unit is days, and the maximum validity period is 90 days.
        :param pulumi.Input[builtins.str] short_url_name: The name of the resource.
        :param pulumi.Input[builtins.str] source_url: The original link address.
        """
    ...
    def effective_days(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def effective_days(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "effective_days", value)

    @property
    @pulumi.getter(name="shortUrlName")
    def short_url_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def short_url_name(self, value: pulumi.Input[builtins.str]):
...
class _ShortUrlState:
    def __init__(__self__, *,
                 effective_days: Optional[pulumi.Input[builtins.int]] = None,
                 short_url_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] short_url_name: The name of the resource.
        :param pulumi.Input[builtins.str] source_url: The original link address.
        :param pulumi.Input[builtins.str] status: Short chain status.
        """
    ...
    @property
    @pulumi.getter(name="effectiveDays")
    def effective_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Short chain service use validity period. Valid values: `30`, `60`, `90`. The unit is days, and the maximum validity period is 90 days.
        """
        return pulumi.get(self, "effective_days")
    ...
    @effective_days.setter
    def effective_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "effective_days", value)

    @property
    @pulumi.getter(name="shortUrlName")
    def short_url_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "short_url_name")
    ...
    @short_url_name.setter
    def short_url_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "short_url_name", value)
...
class ShortUrl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            short_url_name: Optional[pulumi.Input[builtins.str]] = None,
            source_url: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ShortUrl':
        """
    ...
    @property
    @pulumi.getter(name="effectiveDays")
    def effective_days(self) -> pulumi.Output[builtins.int]:
        """
        Short chain service use validity period. Valid values: `30`, `60`, `90`. The unit is days, and the maximum validity period is 90 days.
        """
        return pulumi.get(self, "effective_days")
    ...
    @property
    @pulumi.getter(name="shortUrlName")
    def short_url_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "short_url_name")
