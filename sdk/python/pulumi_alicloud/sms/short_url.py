...
class ShortUrlArgs:
    def __init__(__self__, *,
                 effective_days: pulumi.Input[_builtins.int],
                 short_url_name: pulumi.Input[_builtins.str],
    ...
    def effective_days(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def effective_days(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "effective_days", value)

    @_builtins.property
    @pulumi.getter(name="shortUrlName")
    def short_url_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def short_url_name(self, value: pulumi.Input[_builtins.str]):
...
class _ShortUrlState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] short_url_name: The name of the resource.
        :param pulumi.Input[_builtins.str] source_url: The original link address.
        :param pulumi.Input[_builtins.str] status: Short chain status.
        """
...
class ShortUrl(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="effectiveDays")
    def effective_days(self) -> pulumi.Output[_builtins.int]:
        """
        Short chain service use validity period. Valid values: `30`, `60`, `90`. The unit is days, and the maximum validity period is 90 days.
        """
        return pulumi.get(self, "effective_days")
    ...
    @_builtins.property
    @pulumi.getter(name="shortUrlName")
    def short_url_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "short_url_name")
