...
class EditingProjectArgs:
    def __init__(__self__, *,
                 ...
                 cover_url: Optional[pulumi.Input[builtins.str]] = None,
                 division: Optional[pulumi.Input[builtins.str]] = None,
                 editing_project_name: Optional[pulumi.Input[builtins.str]] = None,
                 timeline: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EditingProject resource.
        :param pulumi.Input[builtins.str] title: The title of the online editing project.
        :param pulumi.Input[builtins.str] cover_url: The thumbnail URL of the online editing project. If you do not specify this parameter and the video track in the timeline has mezzanine files, the thumbnail of the first mezzanine file in the timeline is used.
        :param pulumi.Input[builtins.str] division: The region where you want to create the online editing project.
        :param pulumi.Input[builtins.str] editing_project_name: The description of the online editing project.
        :param pulumi.Input[builtins.str] timeline: The timeline of the online editing project, in JSON format. For more information about the structure, see [Timeline](https://www.alibabacloud.com/help/en/apsaravideo-for-vod/latest/basic-structures). If you do not specify this parameter, an empty timeline is created and the duration of the online editing project is zero.
        """
    ...
    def cover_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cover_url.setter
    def cover_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def editing_project_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def editing_project_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "editing_project_name", value)

    @property
    @pulumi.getter
    def timeline(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @timeline.setter
    def timeline(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EditingProject(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            timeline: Optional[pulumi.Input[builtins.str]] = None,
            title: Optional[pulumi.Input[builtins.str]] = None) -> 'EditingProject':
        """
    ...
    @property
    @pulumi.getter(name="coverUrl")
    def cover_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The thumbnail URL of the online editing project. If you do not specify this parameter and the video track in the timeline has mezzanine files, the thumbnail of the first mezzanine file in the timeline is used.
        """
        return pulumi.get(self, "cover_url")
    ...
    @property
    @pulumi.getter(name="editingProjectName")
    def editing_project_name(self) -> pulumi.Output[builtins.str]:
        """
        The description of the online editing project.
        """
        return pulumi.get(self, "editing_project_name")
    ...
    @property
    @pulumi.getter
    def timeline(self) -> pulumi.Output[builtins.str]:
        """
        The timeline of the online editing project, in JSON format. For more information about the structure, see [Timeline](https://www.alibabacloud.com/help/en/apsaravideo-for-vod/latest/basic-structures). If you do not specify this parameter, an empty timeline is created and the duration of the online editing project is zero.
        """
        return pulumi.get(self, "timeline")
