...
def get_domains(domain_search_type: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_search_type: The search method. Valid values:
    :param Sequence[builtins.str] ids: A list of Domain IDs. Its element value is same as Domain Name.
    ...
    :param builtins.str status: The status of the domain name. The value of this parameter is used as a condition to filter domain names.
...
def get_domains_output(domain_search_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
