...
class CasterArgs:
    def __init__(__self__, *,
                 norm_type: pulumi.Input[builtins.int],
                 payment_type: pulumi.Input[builtins.str],
                 auto_switch_urgent_config: Optional[pulumi.Input[builtins.str]] = None,
                 auto_switch_urgent_on: Optional[pulumi.Input[builtins.bool]] = None,
                 callback_url: Optional[pulumi.Input[builtins.str]] = None,
                 caster_name: Optional[pulumi.Input[builtins.str]] = None,
                 delay: Optional[pulumi.Input[builtins.float]] = None,
                 domain_name: Optional[pulumi.Input[builtins.str]] = None,
                 program_effect: Optional[pulumi.Input[builtins.int]] = None,
                 program_name: Optional[pulumi.Input[builtins.str]] = None,
                 record_config: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 resource_type: Optional[pulumi.Input[builtins.str]] = None,
                 side_output_url: Optional[pulumi.Input[builtins.str]] = None,
                 side_output_url_list: Optional[pulumi.Input[builtins.str]] = None,
                 sync_groups_config: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 transcode_config: Optional[pulumi.Input[builtins.str]] = None,
                 urgent_image_id: Optional[pulumi.Input[builtins.str]] = None,
                 urgent_image_url: Optional[pulumi.Input[builtins.str]] = None,
                 urgent_live_stream_url: Optional[pulumi.Input[builtins.str]] = None,
                 urgent_material_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Caster resource.
        :param pulumi.Input[builtins.int] norm_type: Guide station specification type. Value:
               - 0: Broadcast single type.
               - 1: General purpose.
        :param pulumi.Input[builtins.str] payment_type: The paymen type of the resource
        :param pulumi.Input[builtins.str] auto_switch_urgent_config: Automatic standby broadcast configuration. eofThres: indicates that the broadcast is automatically cut and prepared after the flow interruption time, in seconds.
        :param pulumi.Input[builtins.bool] auto_switch_urgent_on: Turn on the cut-off automatic switch for broadcast preparation.
               
               true: open.
               
               false: closed.
        :param pulumi.Input[builtins.str] callback_url: The callback address of the user. To receive Callback Notifications, enter an available address and accept the HTTP protocol. If this parameter is set to null, the callback notification from the director Station is canceled by default.
        :param pulumi.Input[builtins.str] caster_name: Guide station name.
        :param pulumi.Input[builtins.float] delay: Delayed playback. Time unit: seconds.
        :param pulumi.Input[builtins.str] domain_name: Master play domain name.
        :param pulumi.Input[builtins.int] program_effect: Carousel effective flag.
               
               0: Not in effect.
               
               1: Entry into force.
        :param pulumi.Input[builtins.str] program_name: The carousel station name, which can be configured when using the carousel function.
        :param pulumi.Input[builtins.str] record_config: Record configuration information. The format is JSON. The configuration element information is as follows:
        ...
        :param pulumi.Input[builtins.str] side_output_url: The user-defined stream ingest address corresponding to the bypass output address of the guide station. If this parameter is left blank, the streaming address corresponding to the output address automatically generated by Alibaba Cloud is used by default.
        :param pulumi.Input[builtins.str] side_output_url_list: The list of multiple forwarding stream addresses, which can be the CDN forwarding stream addresses of Alibaba Cloud or a third-party vendor. A guide can add up to 20 RTMP forwarding addresses.
        :param pulumi.Input[builtins.str] sync_groups_config: Multi-View synchronization configuration to synchronize multiple video sources. Multi-View synchronization is divided into two modes:
        ...
        :param pulumi.Input[builtins.str] transcode_config: Transcoding configuration.
        ...
        :param pulumi.Input[builtins.str] urgent_image_id: The ID of the picture material of the media library.
        :param pulumi.Input[builtins.str] urgent_image_url: Prepare the URL of the picture material.
        :param pulumi.Input[builtins.str] urgent_live_stream_url: The prepared live stream URL.
        :param pulumi.Input[builtins.str] urgent_material_id: Prepared video, media library material ID. If this parameter is set to null, the standby configuration is cleared by default.
        """
    ...
    def norm_type(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @norm_type.setter
    def norm_type(self, value: pulumi.Input[builtins.int]):
    ...
    def auto_switch_urgent_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def auto_switch_urgent_config(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "auto_switch_urgent_config", value)

    @property
    @pulumi.getter(name="autoSwitchUrgentOn")
    def auto_switch_urgent_on(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_switch_urgent_on(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def caster_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Guide station name.
        """
    ...
    @caster_name.setter
    def caster_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def program_effect(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def program_effect(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def record_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def record_config(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def side_output_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def side_output_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "side_output_url", value)

    @property
    @pulumi.getter(name="sideOutputUrlList")
    def side_output_url_list(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def side_output_url_list(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "side_output_url_list", value)

    @property
    @pulumi.getter(name="syncGroupsConfig")
    def sync_groups_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sync_groups_config(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def transcode_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def transcode_config(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transcode_config", value)

    @property
    @pulumi.getter(name="urgentImageId")
    def urgent_image_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def urgent_image_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "urgent_image_id", value)

    @property
    @pulumi.getter(name="urgentImageUrl")
    def urgent_image_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def urgent_image_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "urgent_image_url", value)

    @property
    @pulumi.getter(name="urgentLiveStreamUrl")
    def urgent_live_stream_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def urgent_live_stream_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "urgent_live_stream_url", value)

    @property
    @pulumi.getter(name="urgentMaterialId")
    def urgent_material_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def urgent_material_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CasterState:
    def __init__(__self__, *,
                 ...
                 delay: Optional[pulumi.Input[builtins.float]] = None,
                 domain_name: Optional[pulumi.Input[builtins.str]] = None,
                 norm_type: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="normType")
    def norm_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Guide station specification type. Value:
        - 0: Broadcast single type.
        - 1: General purpose.
    ...
    @norm_type.setter
    def norm_type(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "norm_type", value)
...
class Caster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            urgent_image_url: Optional[pulumi.Input[builtins.str]] = None,
            urgent_live_stream_url: Optional[pulumi.Input[builtins.str]] = None,
            urgent_material_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Caster':
        """
    ...
    @property
    @pulumi.getter(name="autoSwitchUrgentConfig")
    def auto_switch_urgent_config(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Automatic standby broadcast configuration. eofThres: indicates that the broadcast is automatically cut and prepared after the flow interruption time, in seconds.
        """
        return pulumi.get(self, "auto_switch_urgent_config")
    ...
    @property
    @pulumi.getter(name="autoSwitchUrgentOn")
    def auto_switch_urgent_on(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Turn on the cut-off automatic switch for broadcast preparation.
    ...
    @property
    @pulumi.getter(name="callbackUrl")
    def callback_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The callback address of the user. To receive Callback Notifications, enter an available address and accept the HTTP protocol. If this parameter is set to null, the callback notification from the director Station is canceled by default.
        """
        return pulumi.get(self, "callback_url")
    ...
    @property
    @pulumi.getter(name="casterName")
    def caster_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Guide station name.
        """
        return pulumi.get(self, "caster_name")
    ...
    @property
    @pulumi.getter
    def delay(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Delayed playback. Time unit: seconds.
        """
        return pulumi.get(self, "delay")
    ...
    @property
    @pulumi.getter(name="normType")
    def norm_type(self) -> pulumi.Output[builtins.int]:
        """
        Guide station specification type. Value:
        - 0: Broadcast single type.
        - 1: General purpose.
    ...
    @property
    @pulumi.getter(name="programEffect")
    def program_effect(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Carousel effective flag.
    ...
    @property
    @pulumi.getter(name="programName")
    def program_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The carousel station name, which can be configured when using the carousel function.
        """
        return pulumi.get(self, "program_name")
    ...
    @property
    @pulumi.getter(name="recordConfig")
    def record_config(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Record configuration information. The format is JSON. The configuration element information is as follows:
        """
        return pulumi.get(self, "record_config")
    ...
    @property
    @pulumi.getter(name="sideOutputUrl")
    def side_output_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The user-defined stream ingest address corresponding to the bypass output address of the guide station. If this parameter is left blank, the streaming address corresponding to the output address automatically generated by Alibaba Cloud is used by default.
        """
        return pulumi.get(self, "side_output_url")
    ...
    @property
    @pulumi.getter(name="sideOutputUrlList")
    def side_output_url_list(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The list of multiple forwarding stream addresses, which can be the CDN forwarding stream addresses of Alibaba Cloud or a third-party vendor. A guide can add up to 20 RTMP forwarding addresses.
        """
        return pulumi.get(self, "side_output_url_list")
    ...
    @property
    @pulumi.getter(name="syncGroupsConfig")
    def sync_groups_config(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Multi-View synchronization configuration to synchronize multiple video sources. Multi-View synchronization is divided into two modes:
        - `mode 0`: (In the anchor mode, multiple video sources are synchronized according to the specified mode.)
        - `mode 1`: (Conference mode, there is no concept of anchor video, all video sources are synchronized with each other.)
    ...
    @property
    @pulumi.getter(name="transcodeConfig")
    def transcode_config(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Transcoding configuration.
    ...
    @property
    @pulumi.getter(name="urgentImageId")
    def urgent_image_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the picture material of the media library.
        """
        return pulumi.get(self, "urgent_image_id")
    ...
    @property
    @pulumi.getter(name="urgentImageUrl")
    def urgent_image_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Prepare the URL of the picture material.
        """
        return pulumi.get(self, "urgent_image_url")
    ...
    @property
    @pulumi.getter(name="urgentLiveStreamUrl")
    def urgent_live_stream_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The prepared live stream URL.
        """
        return pulumi.get(self, "urgent_live_stream_url")
    ...
    @property
    @pulumi.getter(name="urgentMaterialId")
    def urgent_material_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Prepared video, media library material ID. If this parameter is set to null, the standby configuration is cleared by default.
        """
        return pulumi.get(self, "urgent_material_id")
