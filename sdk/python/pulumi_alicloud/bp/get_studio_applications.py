...
def get_studio_applications(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param _builtins.str keyword: The keyword of the Application.
    :param _builtins.str name_regex: A regex string to filter results by Application name.
    :param _builtins.int order_type: The order type of the Application. Valid values:
