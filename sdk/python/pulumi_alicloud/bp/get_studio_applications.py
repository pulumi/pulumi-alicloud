...
class GetStudioApplicationsResult:
    ...
    def order_type(self) -> Optional[builtins.int]:
...
def get_studio_applications(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Application IDs.
    :param builtins.str keyword: The keyword of the Application.
    :param builtins.str name_regex: A regex string to filter results by Application name.
    :param builtins.int order_type: The order type of the Application. Valid values:
...
def get_studio_applications_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                   ...
                                   order_type: Optional[pulumi.Input[Optional[builtins.int]]] = None,
