...
class StudioApplicationInstanceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: The id of the instance.
        :param pulumi.Input[builtins.str] node_name: The name of the instance.
        :param pulumi.Input[builtins.str] node_type: The type of the instance.
        """
        if id is not None:
