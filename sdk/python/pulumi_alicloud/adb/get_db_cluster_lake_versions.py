...
def get_db_cluster_lake_versions(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of DBCluster IDs.
...
def get_db_cluster_lake_versions_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
