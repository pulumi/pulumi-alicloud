...
class ConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_prefix: Prefix of the cluster public endpoint. The prefix must be 6 to 30 characters in length, and can contain lowercase letters, digits, and hyphens (-), must start with a letter and end with a digit or letter. Default to `<db_cluster_id> + tf`.
        """
...
class _ConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_prefix: Prefix of the cluster public endpoint. The prefix must be 6 to 30 characters in length, and can contain lowercase letters, digits, and hyphens (-), must start with a letter and end with a digit or letter. Default to `<db_cluster_id> + tf`.
        :param pulumi.Input[builtins.str] connection_string: Connection cluster string.
        :param pulumi.Input[builtins.str] db_cluster_id: The Id of cluster that can run database.
        :param pulumi.Input[builtins.str] ip_address: The ip address of connection string.
        :param pulumi.Input[builtins.str] port: Connection cluster port.
        """
        if connection_prefix is not None:
            pulumi.set(__self__, "connection_prefix", connection_prefix)
