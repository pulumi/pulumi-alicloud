...
def get_clusters(description: Optional[builtins.str] = None,
    ...
    :param builtins.str description_regex: A regex string to filter results by cluster description.
    :param Sequence[builtins.str] ids: A list of ADB cluster IDs.
...
def get_clusters_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
