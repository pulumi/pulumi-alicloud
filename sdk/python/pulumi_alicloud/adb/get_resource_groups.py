...
def get_resource_groups(db_cluster_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of AnalyticDB for MySQL (ADB) Resource Group IDs.
...
def get_resource_groups_output(db_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
