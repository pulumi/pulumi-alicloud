...
class DBClusterLakeVersionArgs:
    def __init__(__self__, *,
                 ...
                 enable_default_resource_group: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 product_form: Optional[pulumi.Input[builtins.str]] = None,
                 product_version: Optional[pulumi.Input[builtins.str]] = None,
                 reserved_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 reserved_node_size: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] db_cluster_version: The version of the cluster. Valid values: `5.0`.
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource. Valid values: `PayAsYouGo`, `Subscription`. **NOTE:** From version 1.245.0, `payment_type` can be set to `Subscription`.
        ...
        :param pulumi.Input[builtins.str] backup_set_id: The ID of the backup set that you want to use to restore data.
        :param pulumi.Input[builtins.str] compute_resource: The computing resources of the cluster.
        :param pulumi.Input[builtins.str] db_cluster_description: The description of the cluster.
        :param pulumi.Input[builtins.bool] disk_encryption: Specifies whether to enable disk encryption. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.bool] enable_default_resource_group: Whether to enable default allocation of resources to user_default resource groups.
        :param pulumi.Input[builtins.bool] enable_ssl: Specifies whether to enable SSL encryption. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] kms_id: The ID of the key that is used to encrypt disk data. `kms_id` is valid only when `disk_encryption` is set to `true`.
        :param pulumi.Input[builtins.int] period: The subscription period of the subscription cluster. Valid values: `1` to `9`, `12`, `24`, `36`.
        :param pulumi.Input[builtins.str] product_form: The product form of the cluster. Valid values:
               - `IntegrationForm`: Integrated.
               - `LegacyForm`: Data Lakehouse Edition.
        :param pulumi.Input[builtins.str] product_version: The edition of the cluster. Valid values:
               - `BasicVersion`: Basic Edition.
               - `EnterpriseVersion`: Enterprise Edition.
               > **NOTE:** `product_version` must be specified only when `product_form` is set to `IntegrationForm`.
        :param pulumi.Input[builtins.int] reserved_node_count: The number of reserved resource nodes.
        :param pulumi.Input[builtins.str] reserved_node_size: The specifications of reserved resource nodes.
        ...
        :param pulumi.Input[builtins.str] source_db_cluster_id: The ID of the source AnalyticDB for MySQL Data Warehouse Edition cluster.
        :param pulumi.Input[builtins.str] storage_resource: The storage resources of the cluster.
        """
    ...
    def enable_default_resource_group(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_default_resource_group(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def product_form(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @product_form.setter
    def product_form(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def product_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "product_version", value)

    @property
    @pulumi.getter(name="reservedNodeCount")
    def reserved_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def reserved_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "reserved_node_count", value)

    @property
    @pulumi.getter(name="reservedNodeSize")
    def reserved_node_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def reserved_node_size(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_db_cluster_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_db_cluster_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_db_cluster_id", value)

    @property
    @pulumi.getter(name="storageResource")
    def storage_resource(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_resource(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DBClusterLakeVersionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] backup_set_id: The ID of the backup set that you want to use to restore data.
        :param pulumi.Input[builtins.str] commodity_code: The name of the service.
        :param pulumi.Input[builtins.str] compute_resource: The computing resources of the cluster.
        :param pulumi.Input[builtins.str] connection_string: The endpoint of the cluster.
        :param pulumi.Input[builtins.str] create_time: The createTime of the cluster.
        :param pulumi.Input[builtins.str] db_cluster_description: The description of the cluster.
        :param pulumi.Input[builtins.str] db_cluster_version: The version of the cluster. Valid values: `5.0`.
        :param pulumi.Input[builtins.bool] disk_encryption: Specifies whether to enable disk encryption. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.bool] enable_default_resource_group: Whether to enable default allocation of resources to user_default resource groups.
        :param pulumi.Input[builtins.bool] enable_ssl: Specifies whether to enable SSL encryption. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] engine: The engine of the database.
        :param pulumi.Input[builtins.str] engine_version: The engine version of the database.
        :param pulumi.Input[builtins.str] expire_time: The time when the cluster expires.
        :param pulumi.Input[builtins.bool] expired: Indicates whether the cluster has expired.
        :param pulumi.Input[builtins.str] kms_id: The ID of the key that is used to encrypt disk data. `kms_id` is valid only when `disk_encryption` is set to `true`.
        :param pulumi.Input[builtins.str] lock_mode: The lock mode of the cluster.
        :param pulumi.Input[builtins.str] lock_reason: The reason why the cluster is locked.
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource. Valid values: `PayAsYouGo`, `Subscription`. **NOTE:** From version 1.245.0, `payment_type` can be set to `Subscription`.
        :param pulumi.Input[builtins.int] period: The subscription period of the subscription cluster. Valid values: `1` to `9`, `12`, `24`, `36`.
        :param pulumi.Input[builtins.str] port: The port that is used to access the cluster.
        :param pulumi.Input[builtins.str] product_form: The product form of the cluster. Valid values:
               - `IntegrationForm`: Integrated.
               - `LegacyForm`: Data Lakehouse Edition.
        :param pulumi.Input[builtins.str] product_version: The edition of the cluster. Valid values:
...
class DBClusterLakeVersion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DBClusterLakeVersion':
        """
    ...
    @property
    @pulumi.getter(name="computeResource")
    def compute_resource(self) -> pulumi.Output[builtins.str]:
        """
        The computing resources of the cluster.
        """
        return pulumi.get(self, "compute_resource")
    ...
    @property
    @pulumi.getter(name="enableDefaultResourceGroup")
    def enable_default_resource_group(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable default allocation of resources to user_default resource groups.
        """
        return pulumi.get(self, "enable_default_resource_group")
    ...
    @property
    @pulumi.getter(name="productForm")
    def product_form(self) -> pulumi.Output[builtins.str]:
        """
        The product form of the cluster. Valid values:
        - `IntegrationForm`: Integrated.
        - `LegacyForm`: Data Lakehouse Edition.
    ...
    @property
    @pulumi.getter(name="productVersion")
    def product_version(self) -> pulumi.Output[builtins.str]:
        """
        The edition of the cluster. Valid values:
        - `BasicVersion`: Basic Edition.
        - `EnterpriseVersion`: Enterprise Edition.
    ...
    @property
    @pulumi.getter(name="reservedNodeCount")
    def reserved_node_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of reserved resource nodes.
        """
        return pulumi.get(self, "reserved_node_count")
    ...
    @property
    @pulumi.getter(name="reservedNodeSize")
    def reserved_node_size(self) -> pulumi.Output[builtins.str]:
        """
        The specifications of reserved resource nodes.
        """
        return pulumi.get(self, "reserved_node_size")
    ...
    @property
    @pulumi.getter(name="sourceDbClusterId")
    def source_db_cluster_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the source AnalyticDB for MySQL Data Warehouse Edition cluster.
        """
        return pulumi.get(self, "source_db_cluster_id")
    ...
    @property
    @pulumi.getter(name="storageResource")
    def storage_resource(self) -> pulumi.Output[builtins.str]:
        """
        The storage resources of the cluster.
        """
        return pulumi.get(self, "storage_resource")
