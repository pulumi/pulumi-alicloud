...
def get_db_clusters(description: Optional[builtins.str] = None,
    ...
    :param builtins.str description_regex: A regex string to filter results by DBCluster description.
...
def get_db_clusters_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
