...
if not MYPY:
    class DomainListenArgsDict(TypedDict):
        ...
        """
        cipher_suite: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        custom_ciphers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The specific custom encryption suite to add.
        """
        enable_tlsv3: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        exclusive_ip: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        focus_https: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        http_ports: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]
        """
        The listening port of the HTTP protocol.
        """
        https_ports: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]
        """
        ...
        """
        protection_resource: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        tls_version: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        xff_header_mode: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        xff_headers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class DomainListenArgs:
    def __init__(__self__, *,
                 ...
                 cipher_suite: Optional[pulumi.Input[builtins.int]] = None,
                 custom_ciphers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 enable_tlsv3: Optional[pulumi.Input[builtins.bool]] = None,
                 exclusive_ip: Optional[pulumi.Input[builtins.bool]] = None,
                 focus_https: Optional[pulumi.Input[builtins.bool]] = None,
                 http2_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 http_ports: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 https_ports: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 ipv6_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 protection_resource: Optional[pulumi.Input[builtins.str]] = None,
                 tls_version: Optional[pulumi.Input[builtins.str]] = None,
                 xff_header_mode: Optional[pulumi.Input[builtins.int]] = None,
                 xff_headers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] cert_id: The ID of the certificate to be added. This parameter is used only if the value of **https_ports** is not empty (indicating that the domain name uses the HTTPS protocol).
        :param pulumi.Input[builtins.int] cipher_suite: The type of encryption suite to add. This parameter is used only if the value of **https_ports** is not empty (indicating that the domain name uses the HTTPS protocol). Value:
               - **1**: indicates that all encryption suites are added.
               - **2**: indicates that a strong encryption package is added. You can select this value only if the value of **tls_version** is `tlsv1.2`.
               - **99**: indicates that a custom encryption suite is added.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] custom_ciphers: The specific custom encryption suite to add.
        :param pulumi.Input[builtins.bool] enable_tlsv3: Whether TSL1.3 version is supported. This parameter is used only if the value of **https_ports** is not empty (indicating that the domain name uses the HTTPS protocol). Value:
               - **true**: indicates that TSL1.3 is supported.
               - **false**: indicates that TSL1.3 is not supported.
        :param pulumi.Input[builtins.bool] exclusive_ip: Whether to enable exclusive IP address. This parameter is used only when the value of **ipv6_enabled** is **false** (indicating that IPv6 is not enabled) and the value of **protection_resource** is **share** (indicating that a shared cluster is used). Value:
               - **true**: indicates that the exclusive IP address is enabled.
               - **false** (default): indicates that exclusive IP address is not enabled.
        :param pulumi.Input[builtins.bool] focus_https: Whether to enable the forced jump of HTTPS. This parameter is used only when the value of `https_ports` is not empty (indicating that the domain name uses HTTPS protocol) and the value of httports is empty (indicating that the domain name does not use HTTP protocol). Value:
               - **true**: indicates that HTTPS forced redirection is enabled.
               - **false**: indicates that HTTPS forced redirection is not enabled.
        :param pulumi.Input[builtins.bool] http2_enabled: Whether to turn on http2. This parameter is used only if the value of **https_ports** is not empty (indicating that the domain name uses the HTTPS protocol). Value:
               - **true:** indicates that HTTP2 is enabled.
               - **false** (default): indicates that HTTP2 is not enabled.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] http_ports: The listening port of the HTTP protocol.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] https_ports: The listening port of the HTTPS protocol.
        :param pulumi.Input[builtins.bool] ipv6_enabled: Whether IPv6 is turned on. Value:
               - **true**: indicates that IPv6 is enabled.
               - **false** (default): indicates that IPv6 is not enabled.
        :param pulumi.Input[builtins.str] protection_resource: The type of protection resource to use. Value:
               - **share** (default): indicates that a shared cluster is used.
               - **gslb**: indicates that the shared cluster intelligent load balancing is used.
        :param pulumi.Input[builtins.str] tls_version: The version of TLS to add. This parameter is used only if the value of **https_ports** is not empty (indicating that the domain name uses the HTTPS protocol). Value: **tlsv1**, **tlsv1.1**, **tlsv1.2**.
        :param pulumi.Input[builtins.int] xff_header_mode: WAF obtains the real IP address of the client. Value:
               - **0** (default): indicates that the client has not forwarded the traffic to WAF through other layer -7 agents.
               - **1**: indicates that the first value of the X-Forwarded-For(XFF) field in the WAF read request header is used as the client IP address.
               - **2**: indicates that the custom field value set by you in the WAF read request header is used as the client IP address.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] xff_headers: Set the list of custom fields used to obtain the client IP address.
        """
    ...
    def cipher_suite(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The type of encryption suite to add. This parameter is used only if the value of **https_ports** is not empty (indicating that the domain name uses the HTTPS protocol). Value:
        - **1**: indicates that all encryption suites are added.
        - **2**: indicates that a strong encryption package is added. You can select this value only if the value of **tls_version** is `tlsv1.2`.
    ...
    @cipher_suite.setter
    def cipher_suite(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cipher_suite", value)

    @property
    @pulumi.getter(name="customCiphers")
    def custom_ciphers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The specific custom encryption suite to add.
        """
    ...
    def custom_ciphers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "custom_ciphers", value)

    @property
    @pulumi.getter(name="enableTlsv3")
    def enable_tlsv3(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether TSL1.3 version is supported. This parameter is used only if the value of **https_ports** is not empty (indicating that the domain name uses the HTTPS protocol). Value:
        - **true**: indicates that TSL1.3 is supported.
        - **false**: indicates that TSL1.3 is not supported.
    ...
    @enable_tlsv3.setter
    def enable_tlsv3(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_tlsv3", value)

    @property
    @pulumi.getter(name="exclusiveIp")
    def exclusive_ip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable exclusive IP address. This parameter is used only when the value of **ipv6_enabled** is **false** (indicating that IPv6 is not enabled) and the value of **protection_resource** is **share** (indicating that a shared cluster is used). Value:
        - **true**: indicates that the exclusive IP address is enabled.
        - **false** (default): indicates that exclusive IP address is not enabled.
    ...
    @exclusive_ip.setter
    def exclusive_ip(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "exclusive_ip", value)

    @property
    @pulumi.getter(name="focusHttps")
    def focus_https(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable the forced jump of HTTPS. This parameter is used only when the value of `https_ports` is not empty (indicating that the domain name uses HTTPS protocol) and the value of httports is empty (indicating that the domain name does not use HTTP protocol). Value:
        - **true**: indicates that HTTPS forced redirection is enabled.
        - **false**: indicates that HTTPS forced redirection is not enabled.
    ...
    @focus_https.setter
    def focus_https(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def http_ports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
        The listening port of the HTTP protocol.
        """
    ...
    @http_ports.setter
    def http_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
        pulumi.set(self, "http_ports", value)

    @property
    @pulumi.getter(name="httpsPorts")
    def https_ports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
        The listening port of the HTTPS protocol.
        """
    ...
    @https_ports.setter
    def https_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
    ...
    def protection_resource(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of protection resource to use. Value:
        - **share** (default): indicates that a shared cluster is used.
        - **gslb**: indicates that the shared cluster intelligent load balancing is used.
    ...
    def protection_resource(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "protection_resource", value)

    @property
    @pulumi.getter(name="tlsVersion")
    def tls_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The version of TLS to add. This parameter is used only if the value of **https_ports** is not empty (indicating that the domain name uses the HTTPS protocol). Value: **tlsv1**, **tlsv1.1**, **tlsv1.2**.
        """
    ...
    @tls_version.setter
    def tls_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tls_version", value)

    @property
    @pulumi.getter(name="xffHeaderMode")
    def xff_header_mode(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        WAF obtains the real IP address of the client. Value:
        - **0** (default): indicates that the client has not forwarded the traffic to WAF through other layer -7 agents.
        - **1**: indicates that the first value of the X-Forwarded-For(XFF) field in the WAF read request header is used as the client IP address.
    ...
    def xff_header_mode(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "xff_header_mode", value)

    @property
    @pulumi.getter(name="xffHeaders")
    def xff_headers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Set the list of custom fields used to obtain the client IP address.
        """
    ...
    @xff_headers.setter
    def xff_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "xff_headers", value)


if not MYPY:
    class DomainRedirectArgsDict(TypedDict):
        loadbalance: pulumi.Input[builtins.str]
        """
        ...
        """
        focus_http_backend: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        keepalive: NotRequired[pulumi.Input[builtins.bool]]
        """
        Open long connection, default true.
        """
        keepalive_requests: NotRequired[pulumi.Input[builtins.int]]
        """
        Number of long connections,  default: `60`. range :60-1000.
        """
        keepalive_timeout: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        retry: NotRequired[pulumi.Input[builtins.bool]]
        """
        Back to Source Retry. default: true, retry 3 times by default.
        """
        sni_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DomainRedirectArgs:
    def __init__(__self__, *,
                 ...
                 focus_http_backend: Optional[pulumi.Input[builtins.bool]] = None,
                 keepalive: Optional[pulumi.Input[builtins.bool]] = None,
                 keepalive_requests: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 retry: Optional[pulumi.Input[builtins.bool]] = None,
                 sni_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 sni_host: Optional[pulumi.Input[builtins.str]] = None,
                 write_timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] loadbalance: The load balancing algorithm used when returning to the source. Value:
               - **iphash**: indicates the IPHash algorithm.
               - **roundRobin**: indicates the polling algorithm.
               - **leastTime**: indicates the Least Time algorithm.
               - This value can be selected only if the value of **protection_resource** is **gslb** (indicating that the protected resource type uses shared cluster intelligent load balancing).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] backends: The IP address of the origin server corresponding to the domain name or the back-to-origin domain name of the server.
        :param pulumi.Input[builtins.int] connect_timeout: Connection timeout. Unit: seconds, value range: 5~120.
        :param pulumi.Input[builtins.bool] focus_http_backend: Whether to enable forced HTTP back-to-origin. This parameter is used only if the value of **https_ports** is not empty (indicating that the domain name uses the HTTPS protocol). Value:
               - **true**: indicates that forced HTTP back-to-origin is enabled.
               - **false**: indicates that forced HTTP back-to-origin is not enabled.
        :param pulumi.Input[builtins.bool] keepalive: Open long connection, default true.
        :param pulumi.Input[builtins.int] keepalive_requests: Number of long connections,  default: `60`. range :60-1000.
        :param pulumi.Input[builtins.int] keepalive_timeout: Long connection over time, default: `15`. Range: 1-60.
        :param pulumi.Input[builtins.int] read_timeout: Read timeout duration. **Unit**: seconds, **Value range**: 5~1800.
        :param pulumi.Input[Sequence[pulumi.Input['DomainRedirectRequestHeaderArgs']]] request_headers: The traffic tag field and value of the domain name which used to mark the traffic processed by WAF. 
               ...
               custom header field already exists in the request, the system will overwrite the value of the custom field in the
               request with the set traffic tag value. See `request_headers` below.
        :param pulumi.Input[builtins.bool] retry: Back to Source Retry. default: true, retry 3 times by default.
        :param pulumi.Input[builtins.bool] sni_enabled: Whether to enable back-to-source SNI. This parameter is used only if the value of **https_ports** is not empty (indicating that the domain name uses the HTTPS protocol). Value:
               - **true**: indicates that the back-to-source SNI is enabled.
               - **false** (default) indicates that the back-to-source SNI is not enabled.
        :param pulumi.Input[builtins.str] sni_host: Sets the value of the custom SNI extension field. If this parameter is not set, the value of the **Host** field in the request header is used as the value of the SNI extension field by default.In general, you do not need to customize SNI unless your business has special configuration requirements. You want WAF to use SNI that is inconsistent with the actual request Host in the back-to-origin request (that is, the custom SNI set here).> This parameter is required only when **sni_enalbed** is set to **true** (indicating that back-to-source SNI is enabled).
        :param pulumi.Input[builtins.int] write_timeout: Write timeout duration> **Unit**: seconds, **Value range**: 5~1800.
        """
    ...
    @property
    @pulumi.getter
    def loadbalance(self) -> pulumi.Input[builtins.str]:
        """
        The load balancing algorithm used when returning to the source. Value:
        - **iphash**: indicates the IPHash algorithm.
        - **roundRobin**: indicates the polling algorithm.
    ...
    @loadbalance.setter
    def loadbalance(self, value: pulumi.Input[builtins.str]):
    ...
    def focus_http_backend(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable forced HTTP back-to-origin. This parameter is used only if the value of **https_ports** is not empty (indicating that the domain name uses the HTTPS protocol). Value:
        - **true**: indicates that forced HTTP back-to-origin is enabled.
        - **false**: indicates that forced HTTP back-to-origin is not enabled.
    ...
    def focus_http_backend(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "focus_http_backend", value)

    @property
    @pulumi.getter
    def keepalive(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Open long connection, default true.
        """
    ...
    @keepalive.setter
    def keepalive(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "keepalive", value)

    @property
    @pulumi.getter(name="keepaliveRequests")
    def keepalive_requests(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of long connections,  default: `60`. range :60-1000.
        """
    ...
    def keepalive_requests(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter
    def retry(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Back to Source Retry. default: true, retry 3 times by default.
        """
    ...
    @retry.setter
    def retry(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "retry", value)

    @property
    @pulumi.getter(name="sniEnabled")
    def sni_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable back-to-source SNI. This parameter is used only if the value of **https_ports** is not empty (indicating that the domain name uses the HTTPS protocol). Value:
        - **true**: indicates that the back-to-source SNI is enabled.
        - **false** (default) indicates that the back-to-source SNI is not enabled.
    ...
    @sni_enabled.setter
    def sni_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "sni_enabled", value)

    @property
    @pulumi.getter(name="sniHost")
    def sni_host(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Sets the value of the custom SNI extension field. If this parameter is not set, the value of the **Host** field in the request header is used as the value of the SNI extension field by default.In general, you do not need to customize SNI unless your business has special configuration requirements. You want WAF to use SNI that is inconsistent with the actual request Host in the back-to-origin request (that is, the custom SNI set here).> This parameter is required only when **sni_enalbed** is set to **true** (indicating that back-to-source SNI is enabled).
        """
    ...
    @sni_host.setter
    def sni_host(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DomainRedirectRequestHeaderArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: The traffic tag field and value of the domain name, which is used to mark the traffic processed by WAF. the format of this parameter value is **[{" k ":"_key_"," v ":"_value_"}]**. where_key_represents the specified custom request header field, and_value_represents the value set for this field.By specifying the custom request header field and the corresponding value, when the access traffic of the domain name passes through WAF, WAF automatically adds the specified custom field value to the request header as the traffic mark, which is convenient for backend service statistics.Explain that if the custom header field already exists in the request, the system will overwrite the value of the custom field in the request with the set traffic tag value.
        :param pulumi.Input[builtins.str] value: The traffic tag field and value of the domain name, which is used to mark the traffic processed by WAF. the format of this parameter value is **[{" k ":"_key_"," v ":"_value_"}]**. where_key_represents the specified custom request header field, and_value_represents the value set for this field.By specifying the custom request header field and the corresponding value, when the access traffic of the domain name passes through WAF, WAF automatically adds the specified custom field value to the request header as the traffic mark, which is convenient for backend service statistics.Explain that if the custom header field already exists in the request, the system will overwrite the value of the custom field in the request with the set traffic tag value.
        """
        if key is not None:
