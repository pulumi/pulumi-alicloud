...
class DomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain: The name of the domain name to query.
        :param pulumi.Input[builtins.str] instance_id: WAF instance ID
        ...
        :param pulumi.Input[builtins.str] access_type: The access type of the WAF instance. Value: **share** (default): CNAME access.
        """
...
class _DomainState:
    def __init__(__self__, *,
                 ...
                 resource_manager_resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['DomainListenArgs'] listen: Configure listening information. See `listen` below.
        :param pulumi.Input['DomainRedirectArgs'] redirect: Configure forwarding information. See `redirect` below.
        :param pulumi.Input[builtins.str] resource_manager_resource_group_id: The ID of the resource group.
    ...
    def resource_manager_resource_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_manager_resource_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Domain(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:wafv3/domain:Domain"
    ...
    @property
    @pulumi.getter(name="resourceManagerResourceGroupId")
    def resource_manager_resource_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the resource group.
        """
        return pulumi.get(self, "resource_manager_resource_group_id")
