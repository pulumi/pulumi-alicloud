...
def get_domains(backend: Optional[_builtins.str] = None,
    ...
    :param _builtins.str backend: The address type of the origin server. The address can be an IP address or a domain name. You can specify only one type of address.
    ...
    :param _builtins.str instance_id: The WAF instance ID.
