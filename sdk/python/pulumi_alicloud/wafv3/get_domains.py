...
def get_domains(backend: Optional[builtins.str] = None,
    ...
    :param builtins.str backend: The address type of the origin server. The address can be an IP address or a domain name. You can specify only one type of address.
    ...
    :param builtins.str instance_id: The WAF instance ID.
...
def get_domains_output(backend: Optional[pulumi.Input[Optional[builtins.str]]] = None,
