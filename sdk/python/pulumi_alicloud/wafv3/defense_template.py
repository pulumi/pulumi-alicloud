...
class DefenseTemplateArgs:
    def __init__(__self__, *,
                 defense_scene: pulumi.Input[builtins.str],
                 defense_template_name: pulumi.Input[builtins.str],
                 instance_id: pulumi.Input[builtins.str],
                 status: pulumi.Input[builtins.str],
                 template_origin: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] defense_scene: The module to which the protection rule that you want to create belongs. Value:
        ...
        :param pulumi.Input[builtins.str] defense_template_name: The name of the protection rule template.
        :param pulumi.Input[builtins.str] instance_id: The ID of the Web Application Firewall (WAF) instance. .
        :param pulumi.Input[builtins.str] status: The status of the protection rule template. Valid values:
               - **0**: disabled.
               - **1**: enabled.
        :param pulumi.Input[builtins.str] template_origin: The origin of the protection rule template that you want to create. Set the value to **custom**. The value specifies that the protection rule template is a custom template. .
        :param pulumi.Input[builtins.str] template_type: The type of the protection rule template. Valid values:
               - **user_default:** default template.
               - **user_custom:** custom template.
        :param pulumi.Input[builtins.str] description: The description of the protection rule template. .
        :param pulumi.Input[builtins.str] resource_manager_resource_group_id: The ID of the Alibaba Cloud resource group. .
        """
    ...
    def defense_scene(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def defense_scene(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "defense_scene", value)

    @property
    @pulumi.getter(name="defenseTemplateName")
    def defense_template_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def defense_template_name(self, value: pulumi.Input[builtins.str]):
    ...
    def template_origin(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def template_origin(self, value: pulumi.Input[builtins.str]):
...
class _DefenseTemplateState:
    def __init__(__self__, *,
                 ...
                 defense_template_id: Optional[pulumi.Input[builtins.int]] = None,
                 defense_template_name: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 resource_manager_resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 template_origin: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] defense_scene: The module to which the protection rule that you want to create belongs. Value:
               ...
               - **tamperproof**: the website tamper-proofing module.
               - **dlp**: the data leakage prevention module.
        :param pulumi.Input[builtins.int] defense_template_id: Template ID.
        :param pulumi.Input[builtins.str] defense_template_name: The name of the protection rule template.
        :param pulumi.Input[builtins.str] description: The description of the protection rule template. .
        :param pulumi.Input[builtins.str] instance_id: The ID of the Web Application Firewall (WAF) instance. .
        :param pulumi.Input[builtins.str] resource_manager_resource_group_id: The ID of the Alibaba Cloud resource group. .
    ...
    def defense_template_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Template ID.
        """
    ...
    def defense_template_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "defense_template_id", value)

    @property
    @pulumi.getter(name="defenseTemplateName")
    def defense_template_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the protection rule template.
        """
        return pulumi.get(self, "defense_template_name")
    ...
    @defense_template_name.setter
    def defense_template_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "defense_template_name", value)
    ...
    @property
    @pulumi.getter(name="templateOrigin")
    def template_origin(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The origin of the protection rule template that you want to create. Set the value to **custom**. The value specifies that the protection rule template is a custom template. .
        """
        return pulumi.get(self, "template_origin")
    ...
    @template_origin.setter
    def template_origin(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "template_origin", value)
...
class DefenseTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            template_origin: Optional[pulumi.Input[builtins.str]] = None,
            template_type: Optional[pulumi.Input[builtins.str]] = None) -> 'DefenseTemplate':
        """
    ...
    @property
    @pulumi.getter(name="defenseTemplateId")
    def defense_template_id(self) -> pulumi.Output[builtins.int]:
        """
        Template ID.
        """
        return pulumi.get(self, "defense_template_id")
    ...
    @property
    @pulumi.getter(name="defenseTemplateName")
    def defense_template_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the protection rule template.
        """
        return pulumi.get(self, "defense_template_name")
    ...
    @property
    @pulumi.getter(name="resourceManagerResourceGroupId")
    def resource_manager_resource_group_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Alibaba Cloud resource group. .
        """
        return pulumi.get(self, "resource_manager_resource_group_id")
    ...
    @property
    @pulumi.getter(name="templateOrigin")
    def template_origin(self) -> pulumi.Output[builtins.str]:
        """
        The origin of the protection rule template that you want to create. Set the value to **custom**. The value specifies that the protection rule template is a custom template. .
        """
        return pulumi.get(self, "template_origin")
