...
def get_exchanges(ids: Optional[Sequence[builtins.str]] = None,
                  instance_id: Optional[builtins.str] = None,
                  name_regex: Optional[builtins.str] = None,
                  output_file: Optional[builtins.str] = None,
                  virtual_host_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Exchange IDs. Its element value is same as Exchange Name.
    :param builtins.str instance_id: The ID of the instance.
    :param builtins.str name_regex: A regex string to filter results by Exchange name.
...
def get_exchanges_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                         ...
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetExchangesResult]:
    """
    This data source provides the Amqp Exchanges of the current Alibaba Cloud user.
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:amqp/getExchanges:getExchanges', __args__, opts=opts, typ=GetExchangesResult)
    return __ret__.apply(lambda __response__: GetExchangesResult(
