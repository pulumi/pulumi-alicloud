...
def get_exchanges(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Exchange IDs. Its element value is same as Exchange Name.
    :param _builtins.str instance_id: The ID of the instance.
    :param _builtins.str name_regex: A regex string to filter results by Exchange name.
...
def get_exchanges_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
