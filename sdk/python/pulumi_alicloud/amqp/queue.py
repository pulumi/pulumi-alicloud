...
class QueueArgs:
    def __init__(__self__, *,
                 ...
                 auto_expire_state: Optional[pulumi.Input[builtins.str]] = None,
                 dead_letter_exchange: Optional[pulumi.Input[builtins.str]] = None,
                 dead_letter_routing_key: Optional[pulumi.Input[builtins.str]] = None,
                 exclusive_state: Optional[pulumi.Input[builtins.bool]] = None,
                 max_length: Optional[pulumi.Input[builtins.str]] = None,
                 maximum_priority: Optional[pulumi.Input[builtins.int]] = None,
                 message_ttl: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] virtual_host_name: The name of the virtual host.
        ...
        :param pulumi.Input[builtins.str] auto_expire_state: The validity period after which the queue is automatically deleted.
               If the queue is not accessed within a specified period of time, it is automatically deleted.
        :param pulumi.Input[builtins.str] dead_letter_exchange: The dead-letter exchange. A dead-letter exchange is used to receive rejected messages. 
        ...
        :param pulumi.Input[builtins.str] dead_letter_routing_key: The dead letter routing key.
        :param pulumi.Input[builtins.bool] exclusive_state: Specifies whether the queue is an exclusive queue. Valid values:
        ...
        :param pulumi.Input[builtins.str] max_length: The maximum number of messages that can be stored in the queue.
               If this threshold is exceeded, the earliest messages that are routed to the queue are discarded.
        :param pulumi.Input[builtins.int] maximum_priority: The highest priority supported by the queue. This parameter is set to a positive integer.
               Valid values: 0 to 255. Recommended values: 1 to 10
        :param pulumi.Input[builtins.str] message_ttl: The message TTL of the queue.
    ...
    def virtual_host_name(self, value: pulumi.Input[builtins.str]):
    ...
    def auto_expire_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def auto_expire_state(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "auto_expire_state", value)

    @property
    @pulumi.getter(name="deadLetterExchange")
    def dead_letter_exchange(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dead_letter_exchange(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dead_letter_exchange", value)

    @property
    @pulumi.getter(name="deadLetterRoutingKey")
    def dead_letter_routing_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dead_letter_routing_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dead_letter_routing_key", value)

    @property
    @pulumi.getter(name="exclusiveState")
    def exclusive_state(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def exclusive_state(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def maximum_priority(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def maximum_priority(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "maximum_priority", value)

    @property
    @pulumi.getter(name="messageTtl")
    def message_ttl(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @message_ttl.setter
    def message_ttl(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Queue(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            message_ttl: Optional[pulumi.Input[builtins.str]] = None,
            queue_name: Optional[pulumi.Input[builtins.str]] = None,
            virtual_host_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Queue':
        """
    ...
    @property
    @pulumi.getter(name="autoDeleteState")
    def auto_delete_state(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the Auto Delete attribute is configured. Valid values:
        * true: The Auto Delete attribute is configured. The queue is automatically deleted after the last subscription from consumers to this queue is canceled.
        * false: The Auto Delete attribute is not configured.
    ...
    @property
    @pulumi.getter(name="autoExpireState")
    def auto_expire_state(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The validity period after which the queue is automatically deleted.
        If the queue is not accessed within a specified period of time, it is automatically deleted.
        """
    ...
    @property
    @pulumi.getter(name="deadLetterExchange")
    def dead_letter_exchange(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The dead-letter exchange. A dead-letter exchange is used to receive rejected messages. 
        If a consumer rejects a message that cannot be retried, this message is routed to a specified dead-letter exchange.
        Then, the dead-letter exchange routes the message to the queue that is bound to the dead-letter exchange.
    ...
    @property
    @pulumi.getter(name="deadLetterRoutingKey")
    def dead_letter_routing_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The dead letter routing key.
        """
        return pulumi.get(self, "dead_letter_routing_key")
    ...
    @property
    @pulumi.getter(name="exclusiveState")
    def exclusive_state(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the queue is an exclusive queue. Valid values:
        * true: The queue is an exclusive queue. It can be used only for the connection that declares the exclusive queue. After the connection is closed, the exclusive queue is automatically deleted.
        * false: The queue is not an exclusive queue.
    ...
    @property
    @pulumi.getter(name="maxLength")
    def max_length(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The maximum number of messages that can be stored in the queue.
        If this threshold is exceeded, the earliest messages that are routed to the queue are discarded.
        """
    ...
    @property
    @pulumi.getter(name="maximumPriority")
    def maximum_priority(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The highest priority supported by the queue. This parameter is set to a positive integer.
        Valid values: 0 to 255. Recommended values: 1 to 10
        """
    ...
    @property
    @pulumi.getter(name="messageTtl")
    def message_ttl(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The message TTL of the queue.
        If the retention period of a message in the queue exceeds the message TTL of the queue, the message expires.
        Message TTL must be set to a non-negative integer, in milliseconds.
