...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 max_eip_tps: Optional[pulumi.Input[builtins.str]] = None,
                 max_tps: Optional[pulumi.Input[builtins.str]] = None,
                 modify_type: Optional[pulumi.Input[builtins.str]] = None,
                 period: Optional[pulumi.Input[builtins.int]] = None,
                 period_cycle: Optional[pulumi.Input[builtins.str]] = None,
                 queue_capacity: Optional[pulumi.Input[builtins.str]] = None,
                 renewal_duration: Optional[pulumi.Input[builtins.int]] = None,
                 renewal_duration_unit: Optional[pulumi.Input[builtins.str]] = None,
                 renewal_status: Optional[pulumi.Input[builtins.str]] = None,
                 serverless_charge_type: Optional[pulumi.Input[builtins.str]] = None,
                 storage_size: Optional[pulumi.Input[builtins.str]] = None,
                 support_eip: Optional[pulumi.Input[builtins.bool]] = None,
                 support_tracing: Optional[pulumi.Input[builtins.bool]] = None,
                 tracing_storage_time: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Instance resource.
        :param pulumi.Input[builtins.str] payment_type: The Payment type. Valid value: 
               - Subscription: Pre-paid.
               - PayAsYouGo: Post-paid, and for serverless Edition.
        :param pulumi.Input[builtins.bool] auto_renew: Renewal method. Automatic renewal: true; Manual renewal: false. When RenewalStatus has a value, the value of RenewalStatus shall prevail.
        :param pulumi.Input[builtins.str] instance_name: The instance name.
        :param pulumi.Input[builtins.str] instance_type: Instance type. Valid values: 
        ...
        :param pulumi.Input[builtins.int] max_connections: The maximum number of connections, according to the value given on the purchase page of the cloud message queue RabbitMQ version console.
        :param pulumi.Input[builtins.str] max_eip_tps: Peak TPS traffic of the public network, which must be a multiple of 128, unit: times per second.
        :param pulumi.Input[builtins.str] max_tps: Configure the private network TPS traffic peak, please set the value according to the cloud message queue RabbitMQ version of the console purchase page given.
        :param pulumi.Input[builtins.str] modify_type: This parameter must be provided while you change the instance specification. Type of instance lifting and lowering:
               - Upgrade: Upgrade
               - Downgrade: Downgrading.
        :param pulumi.Input[builtins.int] period: Prepayment cycle, unit: periodCycle. This parameter is valid when PaymentType is set to Subscription.
        :param pulumi.Input[builtins.str] period_cycle: Prepaid cycle units. Value: Month, Year.
        :param pulumi.Input[builtins.str] queue_capacity: Configure the maximum number of queues. The value range is as follows:  Professional version:[50,1000], minimum modification step size is 5  Enterprise Edition:[200,6000], minimum modification step size is 100  Platinum version:[10000,80000], minimum modification step size is 100.
        :param pulumi.Input[builtins.int] renewal_duration: The number of automatic renewal cycles.
        :param pulumi.Input[builtins.str] renewal_duration_unit: Auto-Renewal Cycle Unit Values Include: Month: Month. Year: Years.
        :param pulumi.Input[builtins.str] renewal_status: The renewal status. Value: AutoRenewal: automatic renewal. ManualRenewal: manual renewal. NotRenewal: no renewal.
        :param pulumi.Input[builtins.str] serverless_charge_type: The billing type of the serverless instance. Value: onDemand.
        :param pulumi.Input[builtins.str] storage_size: Configure the message storage space. Unit: GB. The value is as follows:  Professional Edition and Enterprise Edition: Fixed to 0. Description A value of 0 indicates that the Professional Edition and Enterprise Edition instances do not charge storage fees, but do not have storage space. Platinum version example: m × 100, where the value range of m is [7,28].
        :param pulumi.Input[builtins.bool] support_eip: Whether to support public network.
        :param pulumi.Input[builtins.bool] support_tracing: Whether to activate the message trace function. The values are as follows:  true: Enable message trace function false: message trace function is not enabled Description The Platinum Edition instance provides the 15-day message trace function free of charge. The trace function can only be enabled and the trace storage duration can only be set to 15 days. For instances of other specifications, you can enable or disable the trace function.
        :param pulumi.Input[builtins.int] tracing_storage_time: Configure the storage duration of message traces. Unit: Days. The value is as follows:  3:3 days 7:7 days 15:15 days This parameter is valid when SupportTracing is true.
        """
    ...
    def max_eip_tps(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @max_eip_tps.setter
    def max_eip_tps(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "max_eip_tps", value)

    @property
    @pulumi.getter(name="maxTps")
    def max_tps(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @max_tps.setter
    def max_tps(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def period_cycle(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @period_cycle.setter
    def period_cycle(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "period_cycle", value)

    @property
    @pulumi.getter(name="queueCapacity")
    def queue_capacity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def queue_capacity(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "queue_capacity", value)

    @property
    @pulumi.getter(name="renewalDuration")
    def renewal_duration(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def renewal_duration(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "renewal_duration", value)

    @property
    @pulumi.getter(name="renewalDurationUnit")
    def renewal_duration_unit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def renewal_duration_unit(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def serverless_charge_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def serverless_charge_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "serverless_charge_type", value)

    @property
    @pulumi.getter(name="storageSize")
    def storage_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @storage_size.setter
    def storage_size(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "storage_size", value)

    @property
    @pulumi.getter(name="supportEip")
    def support_eip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @support_eip.setter
    def support_eip(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "support_eip", value)

    @property
    @pulumi.getter(name="supportTracing")
    def support_tracing(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def support_tracing(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "support_tracing", value)

    @property
    @pulumi.getter(name="tracingStorageTime")
    def tracing_storage_time(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def tracing_storage_time(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] auto_renew: Renewal method. Automatic renewal: true; Manual renewal: false. When RenewalStatus has a value, the value of RenewalStatus shall prevail.
        :param pulumi.Input[builtins.int] create_time: OrderCreateTime.
        :param pulumi.Input[builtins.str] instance_name: The instance name.
        :param pulumi.Input[builtins.str] instance_type: Instance type. Valid values: 
               - professional: professional Edition
               - enterprise: enterprise Edition
...
class Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            support_eip: Optional[pulumi.Input[builtins.bool]] = None,
            support_tracing: Optional[pulumi.Input[builtins.bool]] = None,
            tracing_storage_time: Optional[pulumi.Input[builtins.int]] = None) -> 'Instance':
        """
    ...
    @property
    @pulumi.getter(name="maxEipTps")
    def max_eip_tps(self) -> pulumi.Output[builtins.str]:
        """
        Peak TPS traffic of the public network, which must be a multiple of 128, unit: times per second.
        """
        return pulumi.get(self, "max_eip_tps")
    ...
    @property
    @pulumi.getter(name="maxTps")
    def max_tps(self) -> pulumi.Output[builtins.str]:
        """
        Configure the private network TPS traffic peak, please set the value according to the cloud message queue RabbitMQ version of the console purchase page given.
        """
        return pulumi.get(self, "max_tps")
    ...
    @property
    @pulumi.getter(name="periodCycle")
    def period_cycle(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Prepaid cycle units. Value: Month, Year.
        """
        return pulumi.get(self, "period_cycle")
    ...
    @property
    @pulumi.getter(name="queueCapacity")
    def queue_capacity(self) -> pulumi.Output[builtins.str]:
        """
        Configure the maximum number of queues. The value range is as follows:  Professional version:[50,1000], minimum modification step size is 5  Enterprise Edition:[200,6000], minimum modification step size is 100  Platinum version:[10000,80000], minimum modification step size is 100.
        """
        return pulumi.get(self, "queue_capacity")
    ...
    @property
    @pulumi.getter(name="renewalDuration")
    def renewal_duration(self) -> pulumi.Output[builtins.int]:
        """
        The number of automatic renewal cycles.
        """
        return pulumi.get(self, "renewal_duration")
    ...
    @property
    @pulumi.getter(name="renewalDurationUnit")
    def renewal_duration_unit(self) -> pulumi.Output[builtins.str]:
        """
        Auto-Renewal Cycle Unit Values Include: Month: Month. Year: Years.
        """
        return pulumi.get(self, "renewal_duration_unit")
    ...
    @property
    @pulumi.getter(name="serverlessChargeType")
    def serverless_charge_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The billing type of the serverless instance. Value: onDemand.
        """
        return pulumi.get(self, "serverless_charge_type")
    ...
    @property
    @pulumi.getter(name="storageSize")
    def storage_size(self) -> pulumi.Output[builtins.str]:
        """
        Configure the message storage space. Unit: GB. The value is as follows:  Professional Edition and Enterprise Edition: Fixed to 0. Description A value of 0 indicates that the Professional Edition and Enterprise Edition instances do not charge storage fees, but do not have storage space. Platinum version example: m × 100, where the value range of m is [7,28].
        """
        return pulumi.get(self, "storage_size")
    ...
    @property
    @pulumi.getter(name="supportEip")
    def support_eip(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to support public network.
        """
        return pulumi.get(self, "support_eip")
    ...
    @property
    @pulumi.getter(name="supportTracing")
    def support_tracing(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to activate the message trace function. The values are as follows:  true: Enable message trace function false: message trace function is not enabled Description The Platinum Edition instance provides the 15-day message trace function free of charge. The trace function can only be enabled and the trace storage duration can only be set to 15 days. For instances of other specifications, you can enable or disable the trace function.
        """
        return pulumi.get(self, "support_tracing")
    ...
    @property
    @pulumi.getter(name="tracingStorageTime")
    def tracing_storage_time(self) -> pulumi.Output[builtins.int]:
        """
        Configure the storage duration of message traces. Unit: Days. The value is as follows:  3:3 days 7:7 days 15:15 days This parameter is valid when SupportTracing is true.
        """
        return pulumi.get(self, "tracing_storage_time")
