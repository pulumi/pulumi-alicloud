...
class GetInstancesResult:
    ...
    """
    def __init__(__self__, enable_details=None, id=None, ids=None, instances=None, name_regex=None, names=None, output_file=None, status=None):
...
def get_instances(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.str status: The status of the resource. Valid values: "DEPLOYING", "EXPIRED", "RELEASED", "SERVING".
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:amqp/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult).value
...
def get_instances_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:amqp/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult)
