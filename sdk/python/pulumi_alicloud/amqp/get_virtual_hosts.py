...
def get_virtual_hosts(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Virtual Host IDs. Its element value is same as Virtual Host Name.
    :param builtins.str instance_id: InstanceId.
    :param builtins.str name_regex: A regex string to filter results by Virtual Host name.
...
def get_virtual_hosts_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
