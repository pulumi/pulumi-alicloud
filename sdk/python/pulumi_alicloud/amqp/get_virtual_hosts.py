...
def get_virtual_hosts(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Virtual Host IDs. Its element value is same as Virtual Host Name.
    :param _builtins.str instance_id: InstanceId.
    :param _builtins.str name_regex: A regex string to filter results by Virtual Host name.
...
def get_virtual_hosts_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
