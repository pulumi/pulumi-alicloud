...
def get_queues(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Queue IDs. Its element value is same as Queue Name.
    :param builtins.str instance_id: The ID of the instance.
    :param builtins.str name_regex: A regex string to filter results by Queue name.
...
def get_queues_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
