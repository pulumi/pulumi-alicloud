...
class BindingArgs:
    def __init__(__self__, *,
                 binding_key: pulumi.Input[builtins.str],
                 binding_type: pulumi.Input[builtins.str],
                 destination_name: pulumi.Input[builtins.str],
                 instance_id: pulumi.Input[builtins.str],
                 source_exchange: pulumi.Input[builtins.str],
                 virtual_host_name: pulumi.Input[builtins.str],
                 argument: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Binding resource.
        :param pulumi.Input[builtins.str] binding_key: The Binding Key.
               ...
               * For a topic source exchange: The binding key can contain letters, digits, hyphens (-), underscores (_), periods (.), and at signs (@).
               ...
               The binding key must be 1 to 255 characters in length.
        :param pulumi.Input[builtins.str] binding_type: The type of the object that you want to bind to the source exchange. Valid values: `EXCHANGE`, `QUEUE`.
        :param pulumi.Input[builtins.str] destination_name: The name of the object that you want to bind to the source exchange.
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] source_exchange: The name of the source exchange.
        :param pulumi.Input[builtins.str] virtual_host_name: The name of the vhost.
        :param pulumi.Input[builtins.str] argument: The key-value pairs that are configured for the headers attributes of a message. Default value: `x-match:all`. Valid values:
    ...
    def binding_key(self) -> pulumi.Input[builtins.str]:
        """
        The Binding Key.
        * For a non-topic source exchange: The binding key can contain only letters, digits, hyphens (-), underscores (_), periods (.), and at signs (@).
        The binding key must be 1 to 255 characters in length.
    ...
    @binding_key.setter
    def binding_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "binding_key", value)

    @property
    @pulumi.getter(name="bindingType")
    def binding_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @binding_type.setter
    def binding_type(self, value: pulumi.Input[builtins.str]):
    ...
    def source_exchange(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_exchange(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def argument(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @argument.setter
    def argument(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BindingState:
    ...
    @property
    @pulumi.getter(name="bindingKey")
    def binding_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Binding Key.
        * For a non-topic source exchange: The binding key can contain only letters, digits, hyphens (-), underscores (_), periods (.), and at signs (@).
        The binding key must be 1 to 255 characters in length.
    ...
    @binding_key.setter
    def binding_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "binding_key", value)
    ...
    @property
    @pulumi.getter(name="sourceExchange")
    def source_exchange(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the source exchange.
        """
        return pulumi.get(self, "source_exchange")
    ...
    @source_exchange.setter
    def source_exchange(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_exchange", value)
...
class Binding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            source_exchange: Optional[pulumi.Input[builtins.str]] = None,
            virtual_host_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Binding':
        """
    ...
    @property
    @pulumi.getter
    def argument(self) -> pulumi.Output[builtins.str]:
        """
        The key-value pairs that are configured for the headers attributes of a message. Default value: `x-match:all`. Valid values:
        - `x-match:all`: A headers exchange routes a message to a queue only if all binding attributes of the queue except for x-match match the headers attributes of the message.
        - `x-match:any`: A headers exchange routes a message to a queue if one or more binding attributes of the queue except for x-match match the headers attributes of the message.
    ...
    @property
    @pulumi.getter(name="bindingKey")
    def binding_key(self) -> pulumi.Output[builtins.str]:
        """
        The Binding Key.
        * For a non-topic source exchange: The binding key can contain only letters, digits, hyphens (-), underscores (_), periods (.), and at signs (@).
        The binding key must be 1 to 255 characters in length.
    ...
    @property
    @pulumi.getter(name="bindingType")
    def binding_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the object that you want to bind to the source exchange. Valid values: `EXCHANGE`, `QUEUE`.
        """
        return pulumi.get(self, "binding_type")
    ...
    @property
    @pulumi.getter(name="sourceExchange")
    def source_exchange(self) -> pulumi.Output[builtins.str]:
        """
        The name of the source exchange.
        """
        return pulumi.get(self, "source_exchange")
