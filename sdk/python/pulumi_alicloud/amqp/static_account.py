...
class StaticAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_key: Access key.
        :param pulumi.Input[builtins.str] instance_id: Amqp instance ID.
        :param pulumi.Input[builtins.str] secret_key: Secret key.
        """
...
class _StaticAccountState:
    def __init__(__self__, *,
                 ...
                 master_uid: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] access_key: Access key.
        :param pulumi.Input[builtins.int] create_time: The timestamp that indicates when the pair of static username and password was created.
        :param pulumi.Input[builtins.str] instance_id: Amqp instance ID.
        :param pulumi.Input[builtins.str] master_uid: The ID of the user's primary account.
        :param pulumi.Input[builtins.str] password: The static password.
        :param pulumi.Input[builtins.str] secret_key: Secret key.
        :param pulumi.Input[builtins.str] user_name: The static username.
        """
    ...
    def master_uid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @master_uid.setter
    def master_uid(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StaticAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[builtins.str]] = None,
            secret_key: Optional[pulumi.Input[builtins.str]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None) -> 'StaticAccount':
        """
    ...
    @property
    @pulumi.getter(name="masterUid")
    def master_uid(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the user's primary account.
        """
        return pulumi.get(self, "master_uid")
