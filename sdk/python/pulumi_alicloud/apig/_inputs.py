...
class GatewayLogConfigSlsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enable: Enable Log Service
        """
...
class GatewayNetworkAccessConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Network Access Type
        """
        if type is not None:
...
class GatewayVpcArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] vpc_id: The VPC network ID.
        :param pulumi.Input[builtins.str] name: The name of the VPC gateway.
        """
...
if not MYPY:
    class GatewayZoneConfigArgsDict(TypedDict):
        select_option: pulumi.Input[builtins.str]
        """
...
class GatewayZoneConfigArgs:
    def __init__(__self__, *,
                 select_option: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] select_option: Availability Zone Options
        """
        pulumi.set(__self__, "select_option", select_option)

    @property
    @pulumi.getter(name="selectOption")
    def select_option(self) -> pulumi.Input[builtins.str]:
        """
        Availability Zone Options
        """
    ...
    def select_option(self, value: pulumi.Input[builtins.str]):
