...
class GetDomainsResult:
    ...
    """
    def __init__(__self__, domains=None, enable_details=None, id=None, ids=None, name_regex=None, names=None, output_file=None, resource_group_id=None):
...
def get_domains(enable_details: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:apig/getDomains:getDomains', __args__, opts=opts, typ=GetDomainsResult).value
...
def get_domains_output(enable_details: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:apig/getDomains:getDomains', __args__, opts=opts, typ=GetDomainsResult)
