...
class HttpApiArgs:
    def __init__(__self__, *,
                 http_api_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] http_api_name: The name of the resource
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] protocols: API protocol
        :param pulumi.Input[builtins.str] base_path: API path
        :param pulumi.Input[builtins.str] description: Description of API
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group
        :param pulumi.Input[builtins.str] type: API type
        """
    ...
    def http_api_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def http_api_name(self, value: pulumi.Input[builtins.str]):
...
class _HttpApiState:
    def __init__(__self__, *,
                 base_path: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 http_api_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="httpApiName")
    def http_api_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the resource
        """
        return pulumi.get(self, "http_api_name")
    ...
    @http_api_name.setter
    def http_api_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "http_api_name", value)
...
class HttpApi(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            protocols: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'HttpApi':
        """
    ...
    @property
    @pulumi.getter(name="httpApiName")
    def http_api_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the resource
        """
        return pulumi.get(self, "http_api_name")
