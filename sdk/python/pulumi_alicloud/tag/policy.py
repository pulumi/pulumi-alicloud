...
class PolicyArgs:
    def __init__(__self__, *,
                 policy_content: pulumi.Input[builtins.str],
                 policy_name: pulumi.Input[builtins.str],
                 policy_desc: Optional[pulumi.Input[builtins.str]] = None,
                 user_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Policy resource.
        :param pulumi.Input[builtins.str] policy_content: The document of the tag policy.
        :param pulumi.Input[builtins.str] policy_name: The name of the tag policy. The name must be 1 to 128 characters in length and can contain letters, digits, and underscores (_).
        :param pulumi.Input[builtins.str] policy_desc: The description of the policy. The description must be 1 to 512 characters in length.
        :param pulumi.Input[builtins.str] user_type: The mode of the Tag Policy feature. Valid values: `USER`, `RD`.
        """
    ...
    def policy_content(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def policy_content(self, value: pulumi.Input[builtins.str]):
    ...
    def policy_desc(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @policy_desc.setter
    def policy_desc(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Policy(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:tag/policy:Policy"
    ...
    def get(resource_name: str,
            ...
            policy_desc: Optional[pulumi.Input[builtins.str]] = None,
            policy_name: Optional[pulumi.Input[builtins.str]] = None,
            user_type: Optional[pulumi.Input[builtins.str]] = None) -> 'Policy':
        """
    ...
    @property
    @pulumi.getter(name="policyContent")
    def policy_content(self) -> pulumi.Output[builtins.str]:
        """
        The document of the tag policy.
        """
        return pulumi.get(self, "policy_content")
    ...
    @property
    @pulumi.getter(name="policyDesc")
    def policy_desc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the policy. The description must be 1 to 512 characters in length.
        """
        return pulumi.get(self, "policy_desc")
