...
class AssociatedRuleArgs:
    def __init__(__self__, *,
                 associated_setting_name: pulumi.Input[builtins.str],
                 status: pulumi.Input[builtins.str],
                 tag_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a AssociatedRule resource.
        :param pulumi.Input[builtins.str] associated_setting_name: The setting name of the associated resource tag rule. For specific values, see the Rule Setting Name column in [Resources that Support Associated Resource Tag Settings](https://www.alibabacloud.com/help/en/resource-management/tag/user-guide/associated-resource-label-settings)
        :param pulumi.Input[builtins.str] status: Whether to enable the associated resource tag rule. Valid values: `Enable`, `Disable`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tag_keys: List of tag keys for the associated resource tag rule.
        """
    ...
    def associated_setting_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def associated_setting_name(self, value: pulumi.Input[builtins.str]):
    ...
    def tag_keys(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @tag_keys.setter
    def tag_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _AssociatedRuleState:
    def __init__(__self__, *,
                 associated_setting_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="associatedSettingName")
    def associated_setting_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The setting name of the associated resource tag rule. For specific values, see the Rule Setting Name column in [Resources that Support Associated Resource Tag Settings](https://www.alibabacloud.com/help/en/resource-management/tag/user-guide/associated-resource-label-settings)
        """
        return pulumi.get(self, "associated_setting_name")
    ...
    @associated_setting_name.setter
    def associated_setting_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "associated_setting_name", value)
...
class AssociatedRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            associated_setting_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tag_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'AssociatedRule':
        """
    ...
    @property
    @pulumi.getter(name="associatedSettingName")
    def associated_setting_name(self) -> pulumi.Output[builtins.str]:
        """
        The setting name of the associated resource tag rule. For specific values, see the Rule Setting Name column in [Resources that Support Associated Resource Tag Settings](https://www.alibabacloud.com/help/en/resource-management/tag/user-guide/associated-resource-label-settings)
        """
        return pulumi.get(self, "associated_setting_name")
    ...
    @property
    @pulumi.getter(name="tagKeys")
    def tag_keys(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of tag keys for the associated resource tag rule.
        """
        return pulumi.get(self, "tag_keys")
