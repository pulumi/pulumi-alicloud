...
class PolicyAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_id: The ID of the tag policy.
        :param pulumi.Input[builtins.str] target_id: The ID of the object.
        :param pulumi.Input[builtins.str] target_type: The type of the object. Valid values: `USER`, `ROOT`, `FOLDER`, `ACCOUNT`.
        """
...
@pulumi.type_token("alicloud:tag/policyAttachment:PolicyAttachment")
class PolicyAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_id: Optional[pulumi.Input[builtins.str]] = None,
            target_id: Optional[pulumi.Input[builtins.str]] = None,
            target_type: Optional[pulumi.Input[builtins.str]] = None) -> 'PolicyAttachment':
        """
