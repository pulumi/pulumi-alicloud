...
class GetApplicationGroupsResult:
    ...
    def deploy_region_id(self) -> Optional[builtins.str]:
...
def get_application_groups(application_name: Optional[builtins.str] = None,
                           deploy_region_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Application Group IDs. Its element value is same as Application Group Name.
    :param builtins.str name_regex: A regex string to filter results by Application Group name.
...
def get_application_groups_output(application_name: Optional[pulumi.Input[builtins.str]] = None,
                                  deploy_region_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
