...
def get_application_groups_output(application_name: pulumi.Input[Optional[_builtins.str]] = None,
                                  deploy_region_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
