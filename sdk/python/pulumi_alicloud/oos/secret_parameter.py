...
class SecretParameterArgs:
    def __init__(__self__, *,
                 secret_parameter_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] secret_parameter_name: The name of the encryption parameter.  The name must be `2` to `180` characters in length, and can contain letters, digits, hyphens (-), forward slashes (/) and underscores (_). It cannot start with `ALIYUN`, `ACS`, `ALIBABA`, `ALICLOUD`, or `OOS`.
        :param pulumi.Input[builtins.str] value: The value of the encryption parameter. The value must be `1` to `4096` characters in length.
        :param pulumi.Input[builtins.str] constraints: The constraints of the encryption parameter. By default, this parameter is null. Valid values:
               * `AllowedValues`: The value that is allowed for the encryption parameter. It must be an array string.
               * `AllowedPattern`: The pattern that is allowed for the encryption parameter. It must be a regular expression.
               * `MinLength`: The minimum length of the encryption parameter.
               * `MaxLength`: The maximum length of the encryption parameter.
        :param pulumi.Input[builtins.str] description: The description of the encryption parameter. The description must be `1` to `200` characters in length.
        :param pulumi.Input[builtins.str] dkms_instance_id: The ID of the KMS instance.
        :param pulumi.Input[builtins.str] key_id: The Customer Master Key (CMK) of Key Management Service (KMS) that is used to encrypt the parameter.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the Resource Group.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] type: The data type of the encryption parameter. Valid values: `Secret`.
        """
    ...
    def secret_parameter_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def secret_parameter_name(self, value: pulumi.Input[builtins.str]):
...
class _SecretParameterState:
    def __init__(__self__, *,
                 ...
                 key_id: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 secret_parameter_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] constraints: The constraints of the encryption parameter. By default, this parameter is null. Valid values:
               ...
               * `MinLength`: The minimum length of the encryption parameter.
               * `MaxLength`: The maximum length of the encryption parameter.
        :param pulumi.Input[builtins.str] create_time: Parameter creation time
        :param pulumi.Input[builtins.str] description: The description of the encryption parameter. The description must be `1` to `200` characters in length.
        :param pulumi.Input[builtins.str] dkms_instance_id: The ID of the KMS instance.
        :param pulumi.Input[builtins.str] key_id: The Customer Master Key (CMK) of Key Management Service (KMS) that is used to encrypt the parameter.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the Resource Group.
    ...
    @property
    @pulumi.getter(name="secretParameterName")
    def secret_parameter_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the encryption parameter.  The name must be `2` to `180` characters in length, and can contain letters, digits, hyphens (-), forward slashes (/) and underscores (_). It cannot start with `ALIYUN`, `ACS`, `ALIBABA`, `ALICLOUD`, or `OOS`.
        """
        return pulumi.get(self, "secret_parameter_name")
    ...
    @secret_parameter_name.setter
    def secret_parameter_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "secret_parameter_name", value)
...
class SecretParameter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'SecretParameter':
        """
    ...
    @property
    @pulumi.getter(name="dkmsInstanceId")
    def dkms_instance_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the KMS instance.
        """
        return pulumi.get(self, "dkms_instance_id")
    ...
    @property
    @pulumi.getter(name="secretParameterName")
    def secret_parameter_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the encryption parameter.  The name must be `2` to `180` characters in length, and can contain letters, digits, hyphens (-), forward slashes (/) and underscores (_). It cannot start with `ALIYUN`, `ACS`, `ALIBABA`, `ALICLOUD`, or `OOS`.
        """
        return pulumi.get(self, "secret_parameter_name")
