...
class PatchBaselineArgs:
    def __init__(__self__, *,
                 approval_rules: pulumi.Input[builtins.str],
                 operation_system: pulumi.Input[builtins.str],
                 patch_baseline_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] approval_rules: Accept the rules. This value follows the json format. For more details, see the description of [ApprovalRules in the Request parameters table for details](https://www.alibabacloud.com/help/zh/operation-orchestration-service/latest/api-oos-2019-06-01-createpatchbaseline).
        :param pulumi.Input[builtins.str] operation_system: Operating system type. Valid values: `AliyunLinux`, `Anolis`, `CentOS`, `Debian`, `RedhatEnterpriseLinux`, `Ubuntu`, `Windows`, `AlmaLinux`.
        :param pulumi.Input[builtins.str] patch_baseline_name: The name of the patch baseline.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] approved_patches: Approved Patch.
        :param pulumi.Input[builtins.bool] approved_patches_enable_non_security: ApprovedPatchesEnableNonSecurity.
        :param pulumi.Input[builtins.str] description: Patches baseline description information.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rejected_patches: Reject patches.
        :param pulumi.Input[builtins.str] rejected_patches_action: Rejected patches action. Valid values: `ALLOW_AS_DEPENDENCY`, `BLOCK`.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sources: Source.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Label.
        """
    ...
    def approval_rules(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def approval_rules(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "approval_rules", value)

    @property
    @pulumi.getter(name="operationSystem")
    def operation_system(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def operation_system(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "operation_system", value)

    @property
    @pulumi.getter(name="patchBaselineName")
    def patch_baseline_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def patch_baseline_name(self, value: pulumi.Input[builtins.str]):
    ...
    def rejected_patches_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rejected_patches_action(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PatchBaselineState:
    def __init__(__self__, *,
                 approval_rules: Optional[pulumi.Input[builtins.str]] = None,
                 approved_patches: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 approved_patches_enable_non_security: Optional[pulumi.Input[builtins.bool]] = None,
                 create_time: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 operation_system: Optional[pulumi.Input[builtins.str]] = None,
                 patch_baseline_name: Optional[pulumi.Input[builtins.str]] = None,
                 rejected_patches: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 rejected_patches_action: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 sources: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="approvalRules")
    def approval_rules(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Accept the rules. This value follows the json format. For more details, see the description of [ApprovalRules in the Request parameters table for details](https://www.alibabacloud.com/help/zh/operation-orchestration-service/latest/api-oos-2019-06-01-createpatchbaseline).
        """
        return pulumi.get(self, "approval_rules")
    ...
    @approval_rules.setter
    def approval_rules(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "approval_rules", value)
    ...
    @property
    @pulumi.getter(name="operationSystem")
    def operation_system(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operating system type. Valid values: `AliyunLinux`, `Anolis`, `CentOS`, `Debian`, `RedhatEnterpriseLinux`, `Ubuntu`, `Windows`, `AlmaLinux`.
        """
        return pulumi.get(self, "operation_system")
    ...
    @operation_system.setter
    def operation_system(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "operation_system", value)

    @property
    @pulumi.getter(name="patchBaselineName")
    def patch_baseline_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the patch baseline.
        """
        return pulumi.get(self, "patch_baseline_name")
    ...
    @patch_baseline_name.setter
    def patch_baseline_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "patch_baseline_name", value)
...
class PatchBaseline(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            sources: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'PatchBaseline':
        """
    ...
    @property
    @pulumi.getter(name="approvalRules")
    def approval_rules(self) -> pulumi.Output[builtins.str]:
        """
        Accept the rules. This value follows the json format. For more details, see the description of [ApprovalRules in the Request parameters table for details](https://www.alibabacloud.com/help/zh/operation-orchestration-service/latest/api-oos-2019-06-01-createpatchbaseline).
        """
        return pulumi.get(self, "approval_rules")
    ...
    @property
    @pulumi.getter(name="operationSystem")
    def operation_system(self) -> pulumi.Output[builtins.str]:
        """
        Operating system type. Valid values: `AliyunLinux`, `Anolis`, `CentOS`, `Debian`, `RedhatEnterpriseLinux`, `Ubuntu`, `Windows`, `AlmaLinux`.
        """
        return pulumi.get(self, "operation_system")
    ...
    @property
    @pulumi.getter(name="patchBaselineName")
    def patch_baseline_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the patch baseline.
        """
        return pulumi.get(self, "patch_baseline_name")
    ...
    @property
    @pulumi.getter(name="rejectedPatchesAction")
    def rejected_patches_action(self) -> pulumi.Output[builtins.str]:
        """
        Rejected patches action. Valid values: `ALLOW_AS_DEPENDENCY`, `BLOCK`.
        """
        return pulumi.get(self, "rejected_patches_action")
