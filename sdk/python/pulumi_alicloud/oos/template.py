...
class TemplateArgs:
    def __init__(__self__, *,
                 ...
                 auto_delete_executions: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] content: The content of the template. The template must be in the JSON or YAML format. Maximum size: 64 KB.
        :param pulumi.Input[builtins.str] template_name: The name of the template. The template name can be up to 200 characters in length. The name can contain letters, digits, hyphens (-), and underscores (_). It cannot start with `ALIYUN`, `ACS`, `ALIBABA`, or `ALICLOUD`.
        :param pulumi.Input[builtins.bool] auto_delete_executions: When deleting a template, whether to delete its related executions. Default to `false`.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of resource group which the template belongs.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] version_name: The name of template version.
        """
    ...
    def auto_delete_executions(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_delete_executions(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _TemplateState:
    def __init__(__self__, *,
                 ...
                 has_trigger: Optional[pulumi.Input[builtins.bool]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 share_type: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 template_format: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] auto_delete_executions: When deleting a template, whether to delete its related executions. Default to `false`.
        :param pulumi.Input[builtins.str] content: The content of the template. The template must be in the JSON or YAML format. Maximum size: 64 KB.
        :param pulumi.Input[builtins.str] created_by: The creator of the template.
        :param pulumi.Input[builtins.str] created_date: The time when the template is created.
        :param pulumi.Input[builtins.str] description: The description of the template.
        :param pulumi.Input[builtins.bool] has_trigger: Is it triggered successfully.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of resource group which the template belongs.
        :param pulumi.Input[builtins.str] share_type: The sharing type of the template. The sharing type of templates created by users are set to Private. The sharing type of common templates provided by OOS are set to Public.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] template_format: The format of the template. The format can be JSON or YAML. The system automatically identifies the format.
        :param pulumi.Input[builtins.str] template_id: The id of OOS Template.
        :param pulumi.Input[builtins.str] template_name: The name of the template. The template name can be up to 200 characters in length. The name can contain letters, digits, hyphens (-), and underscores (_). It cannot start with `ALIYUN`, `ACS`, `ALIBABA`, or `ALICLOUD`.
        :param pulumi.Input[builtins.str] template_type: The type of OOS Template. `Automation` means the implementation of Alibaba Cloud API template, `Package` means represents a template for installing software.
        :param pulumi.Input[builtins.str] template_version: The version of OOS Template.
        :param pulumi.Input[builtins.str] updated_by: The user who updated the template.
        :param pulumi.Input[builtins.str] updated_date: The time when the template was updated.
        :param pulumi.Input[builtins.str] version_name: The name of template version.
        """
        if auto_delete_executions is not None:
            pulumi.set(__self__, "auto_delete_executions", auto_delete_executions)
    ...
    def has_trigger(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @has_trigger.setter
    def has_trigger(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def template_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def template_format(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Template(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            updated_by: Optional[pulumi.Input[builtins.str]] = None,
            updated_date: Optional[pulumi.Input[builtins.str]] = None,
            version_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Template':
        """
    ...
    @property
    @pulumi.getter(name="autoDeleteExecutions")
    def auto_delete_executions(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When deleting a template, whether to delete its related executions. Default to `false`.
        """
        return pulumi.get(self, "auto_delete_executions")
    ...
    @property
    @pulumi.getter(name="hasTrigger")
    def has_trigger(self) -> pulumi.Output[builtins.bool]:
        """
        Is it triggered successfully.
        """
        return pulumi.get(self, "has_trigger")
    ...
    @property
    @pulumi.getter(name="templateFormat")
    def template_format(self) -> pulumi.Output[builtins.str]:
        """
        The format of the template. The format can be JSON or YAML. The system automatically identifies the format.
        """
        return pulumi.get(self, "template_format")
