...
class ExecutionArgs:
    def __init__(__self__, *,
                 ...
                 loop_mode: Optional[pulumi.Input[builtins.str]] = None,
                 mode: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[builtins.str]] = None,
                 parent_execution_id: Optional[pulumi.Input[builtins.str]] = None,
                 safety_check: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] template_name: The name of execution template.
        :param pulumi.Input[builtins.str] description: The description of OOS Execution.
        :param pulumi.Input[builtins.str] loop_mode: The loop mode of OOS Execution.
        :param pulumi.Input[builtins.str] mode: The mode of OOS Execution. Valid: `Automatic`, `Debug`. Default to `Automatic`.
        :param pulumi.Input[builtins.str] parameters: The parameters required by the template. Default to `{}`.
        :param pulumi.Input[builtins.str] parent_execution_id: The id of parent execution.
        :param pulumi.Input[builtins.str] safety_check: The mode of safety check.
        :param pulumi.Input[builtins.str] template_content: The content of template. When the user selects an existing template to create and execute a task, it is not necessary to pass in this field.
        :param pulumi.Input[builtins.str] template_version: The version of execution template.
        """
    ...
    def loop_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @loop_mode.setter
    def loop_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def parent_execution_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def parent_execution_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "parent_execution_id", value)

    @property
    @pulumi.getter(name="safetyCheck")
    def safety_check(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @safety_check.setter
    def safety_check(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ExecutionState:
    def __init__(__self__, *,
                 counters: Optional[pulumi.Input[builtins.str]] = None,
                 create_date: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 end_date: Optional[pulumi.Input[builtins.str]] = None,
                 executed_by: Optional[pulumi.Input[builtins.str]] = None,
                 is_parent: Optional[pulumi.Input[builtins.bool]] = None,
                 loop_mode: Optional[pulumi.Input[builtins.str]] = None,
                 mode: Optional[pulumi.Input[builtins.str]] = None,
                 outputs: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[builtins.str]] = None,
                 parent_execution_id: Optional[pulumi.Input[builtins.str]] = None,
                 ram_role: Optional[pulumi.Input[builtins.str]] = None,
                 safety_check: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] counters: The counters of OOS Execution.
        :param pulumi.Input[builtins.str] create_date: The time when the execution was created.
        :param pulumi.Input[builtins.str] description: The description of OOS Execution.
        :param pulumi.Input[builtins.str] end_date: The time when the execution was ended.
        :param pulumi.Input[builtins.str] executed_by: The user who execute the template.
        :param pulumi.Input[builtins.bool] is_parent: Whether to include subtasks.
        :param pulumi.Input[builtins.str] loop_mode: The loop mode of OOS Execution.
        :param pulumi.Input[builtins.str] mode: The mode of OOS Execution. Valid: `Automatic`, `Debug`. Default to `Automatic`.
        :param pulumi.Input[builtins.str] outputs: The outputs of OOS Execution.
        :param pulumi.Input[builtins.str] parameters: The parameters required by the template. Default to `{}`.
        :param pulumi.Input[builtins.str] parent_execution_id: The id of parent execution.
        :param pulumi.Input[builtins.str] ram_role: The role that executes the current template.
        :param pulumi.Input[builtins.str] safety_check: The mode of safety check.
        :param pulumi.Input[builtins.str] start_date: The time when the execution was started.
        :param pulumi.Input[builtins.str] status: The status of OOS Execution.
        :param pulumi.Input[builtins.str] status_message: The message of status.
        :param pulumi.Input[builtins.str] template_content: The content of template. When the user selects an existing template to create and execute a task, it is not necessary to pass in this field.
        :param pulumi.Input[builtins.str] template_id: The id of template.
        :param pulumi.Input[builtins.str] template_name: The name of execution template.
        :param pulumi.Input[builtins.str] template_version: The version of execution template.
        :param pulumi.Input[builtins.str] update_date: The time when the execution was updated.
        """
    ...
    @property
    @pulumi.getter
    def counters(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @counters.setter
    def counters(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def executed_by(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @executed_by.setter
    def executed_by(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "executed_by", value)

    @property
    @pulumi.getter(name="isParent")
    def is_parent(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_parent.setter
    def is_parent(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ram_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ram_role.setter
    def ram_role(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Execution(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            template_name: Optional[pulumi.Input[builtins.str]] = None,
            template_version: Optional[pulumi.Input[builtins.str]] = None,
            update_date: Optional[pulumi.Input[builtins.str]] = None) -> 'Execution':
        """
    ...
    @property
    @pulumi.getter
    def counters(self) -> pulumi.Output[builtins.str]:
        """
        The counters of OOS Execution.
        """
        return pulumi.get(self, "counters")
    ...
    @property
    @pulumi.getter(name="executedBy")
    def executed_by(self) -> pulumi.Output[builtins.str]:
        """
        The user who execute the template.
        """
        return pulumi.get(self, "executed_by")
    ...
    @property
    @pulumi.getter(name="isParent")
    def is_parent(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to include subtasks.
        """
        return pulumi.get(self, "is_parent")
    ...
    @property
    @pulumi.getter(name="loopMode")
    def loop_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The loop mode of OOS Execution.
        """
        return pulumi.get(self, "loop_mode")
    ...
    @property
    @pulumi.getter(name="parentExecutionId")
    def parent_execution_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The id of parent execution.
        """
        return pulumi.get(self, "parent_execution_id")
    ...
    @property
    @pulumi.getter(name="ramRole")
    def ram_role(self) -> pulumi.Output[builtins.str]:
        """
        The role that executes the current template.
        """
        return pulumi.get(self, "ram_role")
    ...
    @property
    @pulumi.getter(name="safetyCheck")
    def safety_check(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The mode of safety check.
        """
        return pulumi.get(self, "safety_check")
    ...
    @property
    @pulumi.getter(name="templateContent")
    def template_content(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The content of template. When the user selects an existing template to create and execute a task, it is not necessary to pass in this field.
        """
        return pulumi.get(self, "template_content")
