...
class GetExecutionsResult:
    ...
    def end_date_after(self) -> Optional[builtins.str]:
        return pulumi.get(self, "end_date_after")

    @property
    @pulumi.getter(name="executedBy")
    def executed_by(self) -> Optional[builtins.str]:
    ...
    def include_child_execution(self) -> Optional[builtins.bool]:
    ...
    def parent_execution_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "parent_execution_id")

    @property
    @pulumi.getter(name="ramRole")
    def ram_role(self) -> Optional[builtins.str]:
        return pulumi.get(self, "ram_role")

    @property
    @pulumi.getter(name="sortField")
    def sort_field(self) -> Optional[builtins.str]:
    ...
    def start_date_after(self) -> Optional[builtins.str]:
        return pulumi.get(self, "start_date_after")

    @property
    @pulumi.getter(name="startDateBefore")
    def start_date_before(self) -> Optional[builtins.str]:
...
def get_executions(category: Optional[builtins.str] = None,
                   end_date: Optional[builtins.str] = None,
                   end_date_after: Optional[builtins.str] = None,
                   executed_by: Optional[builtins.str] = None,
                   ids: Optional[Sequence[builtins.str]] = None,
                   include_child_execution: Optional[builtins.bool] = None,
                   mode: Optional[builtins.str] = None,
                   output_file: Optional[builtins.str] = None,
                   parent_execution_id: Optional[builtins.str] = None,
                   ram_role: Optional[builtins.str] = None,
                   sort_field: Optional[builtins.str] = None,
                   sort_order: Optional[builtins.str] = None,
                   start_date_after: Optional[builtins.str] = None,
                   start_date_before: Optional[builtins.str] = None,
    ...
    :param builtins.str end_date_after: Execution whose end time is less than or equal to the specified time.
    :param builtins.str executed_by: The user who execute the template.
    :param Sequence[builtins.str] ids: A list of OOS Execution ids.
    :param builtins.bool include_child_execution: Whether to include sub-execution.
    ...
    :param builtins.str sort_field: The sort field.
    :param builtins.str sort_order: The sort order.
    :param builtins.str start_date_after: The execution whose start time is greater than or equal to the specified time.
    :param builtins.str start_date_before: The execution with start time less than or equal to the specified time.
...
def get_executions_output(category: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          end_date: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          end_date_after: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          executed_by: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                          include_child_execution: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                          mode: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          parent_execution_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          ram_role: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          sort_field: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          sort_order: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          start_date_after: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          start_date_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
