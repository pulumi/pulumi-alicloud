...
class GetPatchBaselinesResult:
    ...
    def operation_system(self) -> Optional[builtins.str]:
...
def get_patch_baselines(enable_details: Optional[builtins.bool] = None,
                        ids: Optional[Sequence[builtins.str]] = None,
                        name_regex: Optional[builtins.str] = None,
                        operation_system: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Patch Baseline IDs. Its element value is same as Patch Baseline Name.
    :param builtins.str name_regex: A regex string to filter results by Patch Baseline name.
    :param builtins.str operation_system: Operating system type. Valid values: `AliyunLinux`, `Anolis`, `CentOS`, `Debian`, `RedhatEnterpriseLinux`, `Ubuntu`, `Windows`.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str share_type: Patch baseline sharing type. Valid values: `Private`, `Public`.
    """
    __args__ = dict()
...
def get_patch_baselines_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                               ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                               name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               operation_system: Optional[pulumi.Input[Optional[builtins.str]]] = None,
