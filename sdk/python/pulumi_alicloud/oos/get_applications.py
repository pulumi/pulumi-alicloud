...
def get_applications(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Application IDs. Its element value is same as Application Name.
...
def get_applications_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
