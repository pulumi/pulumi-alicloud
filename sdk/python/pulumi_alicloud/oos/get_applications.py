...
def get_applications(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Application IDs. Its element value is same as Application Name.
    :param _builtins.str name_regex: A regex string to filter results by Application name.
...
def get_applications_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:oos/getApplications:getApplications', __args__, opts=opts, typ=GetApplicationsResult)
