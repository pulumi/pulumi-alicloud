...
class StateConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 targets: pulumi.Input[builtins.str],
                 template_name: pulumi.Input[builtins.str],
                 configure_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] schedule_expression: Timing expression.
        :param pulumi.Input[builtins.str] schedule_type: Timing type. Valid values: `rate`.
        :param pulumi.Input[builtins.str] targets: The Target resources.  This field is in the format of JSON strings. For detailed definition instructions, please refer to [Parameter](https://www.alibabacloud.com/help/en/doc-detail/120674.html).
        :param pulumi.Input[builtins.str] template_name: The name of the template.
        :param pulumi.Input[builtins.str] configure_mode: Configuration mode. Valid values: `ApplyAndAutoCorrect`, `ApplyAndMonitor`, `ApplyOnly`.
        :param pulumi.Input[builtins.str] description: The description of the resource.
        :param pulumi.Input[builtins.str] parameters: The parameter of the Template. This field is in the format of JSON strings. For detailed definition instructions, please refer to [Metadata types that are supported by a configuration list](https://www.alibabacloud.com/help/en/doc-detail/208276.html).
        ...
        :param pulumi.Input[builtins.str] template_version: The version number. If you do not specify this parameter, the system uses the latest version.
        """
    ...
    @property
    @pulumi.getter
    def targets(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @targets.setter
    def targets(self, value: pulumi.Input[builtins.str]):
    ...
    def configure_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def configure_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _StateConfigurationState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 targets: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def targets(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Target resources.  This field is in the format of JSON strings. For detailed definition instructions, please refer to [Parameter](https://www.alibabacloud.com/help/en/doc-detail/120674.html).
        """
        return pulumi.get(self, "targets")
    ...
    @targets.setter
    def targets(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "targets", value)
...
class StateConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            targets: Optional[pulumi.Input[builtins.str]] = None,
            template_name: Optional[pulumi.Input[builtins.str]] = None,
            template_version: Optional[pulumi.Input[builtins.str]] = None) -> 'StateConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="configureMode")
    def configure_mode(self) -> pulumi.Output[builtins.str]:
        """
        Configuration mode. Valid values: `ApplyAndAutoCorrect`, `ApplyAndMonitor`, `ApplyOnly`.
        """
        return pulumi.get(self, "configure_mode")
    ...
    @property
    @pulumi.getter(name="scheduleExpression")
    def schedule_expression(self) -> pulumi.Output[builtins.str]:
        """
        Timing expression.
        """
        return pulumi.get(self, "schedule_expression")
    ...
    @property
    @pulumi.getter
    def targets(self) -> pulumi.Output[builtins.str]:
        """
        The Target resources.  This field is in the format of JSON strings. For detailed definition instructions, please refer to [Parameter](https://www.alibabacloud.com/help/en/doc-detail/120674.html).
        """
        return pulumi.get(self, "targets")
    ...
    @property
    @pulumi.getter(name="templateVersion")
    def template_version(self) -> pulumi.Output[builtins.str]:
        """
        The version number. If you do not specify this parameter, the system uses the latest version.
        """
        return pulumi.get(self, "template_version")
