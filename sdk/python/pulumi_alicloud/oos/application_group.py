...
class ApplicationGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] import_tag_key: The tag key must be passed in at the same time as the tag value (import_tag_value) or none, not just one. If both `import_tag_key` and `import_tag_value` are left empty, the default is app-{ApplicationName} (application name).
        :param pulumi.Input[_builtins.str] import_tag_value: The tag value must be passed in at the same time as the tag key (import_tag_key) or none, not just one. If both `import_tag_key` and `import_tag_value` are left empty, the default is application group name.
               .
        """
    ...
    def deploy_region_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def deploy_region_id(self, value: pulumi.Input[_builtins.str]):
...
class ApplicationGroup(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="applicationGroupName")
    def application_group_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the Application group.
        """
        return pulumi.get(self, "application_group_name")
    ...
    @_builtins.property
    @pulumi.getter(name="deployRegionId")
    def deploy_region_id(self) -> pulumi.Output[_builtins.str]:
        """
        The region ID of the deployment.
        """
        return pulumi.get(self, "deploy_region_id")
    ...
    @_builtins.property
    @pulumi.getter(name="importTagKey")
    def import_tag_key(self) -> pulumi.Output[_builtins.str]:
        """
        The tag key must be passed in at the same time as the tag value (import_tag_value) or none, not just one. If both `import_tag_key` and `import_tag_value` are left empty, the default is app-{ApplicationName} (application name).
        """
        return pulumi.get(self, "import_tag_key")
    ...
    @_builtins.property
    @pulumi.getter(name="importTagValue")
    def import_tag_value(self) -> pulumi.Output[_builtins.str]:
        """
        The tag value must be passed in at the same time as the tag key (import_tag_key) or none, not just one. If both `import_tag_key` and `import_tag_value` are left empty, the default is application group name.
        .
        """
