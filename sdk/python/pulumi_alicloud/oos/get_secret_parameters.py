...
class GetSecretParametersResult:
    ...
    def secret_parameter_name(self) -> Optional[builtins.str]:
        """
...
def get_secret_parameters(enable_details: Optional[builtins.bool] = None,
                          ...
                          secret_parameter_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Secret Parameter IDs.
    :param builtins.str name_regex: A regex string to filter results by Secret Parameter name.
    ...
    :param builtins.bool with_decryption: Specifies whether to decrypt the parameter value. Default value: `false`. **Note:** `with_decryption` takes effect only if `enable_details` is set to `true`.
    """
    __args__ = dict()
...
def get_secret_parameters_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                 ...
                                 secret_parameter_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
