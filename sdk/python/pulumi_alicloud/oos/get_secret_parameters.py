...
class GetSecretParametersResult:
    ...
    def secret_parameter_name(self) -> Optional[_builtins.str]:
        """
...
def get_secret_parameters(enable_details: Optional[_builtins.bool] = None,
                          ids: Optional[Sequence[_builtins.str]] = None,
                          name_regex: Optional[_builtins.str] = None,
                          output_file: Optional[_builtins.str] = None,
                          resource_group_id: Optional[_builtins.str] = None,
                          secret_parameter_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Secret Parameter IDs.
    :param _builtins.str name_regex: A regex string to filter results by Secret Parameter name.
    ...
    :param _builtins.str sort_field: The field used to sort the query results. Valid values: `Name`, `CreatedDate`.
    :param _builtins.str sort_order: The order in which the entries are sorted. Default value: `Descending`. Valid values: `Ascending`, `Descending`.
    :param Mapping[str, _builtins.str] tags: A mapping of tags to assign to the resource.
    :param _builtins.bool with_decryption: Specifies whether to decrypt the parameter value. Default value: `false`. **Note:** `with_decryption` takes effect only if `enable_details` is set to `true`.
    """
    __args__ = dict()
...
def get_secret_parameters_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                 ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                 name_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 resource_group_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 secret_parameter_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
