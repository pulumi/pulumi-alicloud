...
class GetTemplatesResult:
    ...
    def created_date_after(self) -> Optional[builtins.str]:
        return pulumi.get(self, "created_date_after")

    @property
    @pulumi.getter(name="hasTrigger")
    def has_trigger(self) -> Optional[builtins.bool]:
    ...
    def template_format(self) -> Optional[builtins.str]:
...
def get_templates(category: Optional[builtins.str] = None,
                  created_by: Optional[builtins.str] = None,
                  created_date: Optional[builtins.str] = None,
                  created_date_after: Optional[builtins.str] = None,
                  has_trigger: Optional[builtins.bool] = None,
                  ...
                  template_format: Optional[builtins.str] = None,
    ...
    :param builtins.str created_date_after: Create a template whose time is greater than or equal to the specified time. The format is: YYYY-MM-DDThh:mm:ssZ.
    :param builtins.bool has_trigger: Is it triggered successfully.
    :param Sequence[builtins.str] ids: A list of OOS Template ids. Each element in the list is same as template_name.
    :param builtins.str name_regex: A regex string to filter the results by the template_name.
    ...
    :param builtins.str sort_field: Sort field. Valid values: `TotalExecutionCount`, `Popularity`, `TemplateName` and `CreatedDate`. Default to `TotalExecutionCount`.
    :param builtins.str sort_order: Sort order. Valid values: `Ascending`, `Descending`. Default to `Descending`
...
def get_templates_output(category: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         created_by: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         created_date: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         created_date_after: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         has_trigger: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                         ...
                         template_format: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         template_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
