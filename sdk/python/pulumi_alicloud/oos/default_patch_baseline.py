...
class _DefaultPatchBaselineState:
    def __init__(__self__, *,
                 patch_baseline_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] patch_baseline_id: The ID of the patch baseline.
        :param pulumi.Input[builtins.str] patch_baseline_name: The name of the patch baseline.
        """
    ...
    def patch_baseline_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def patch_baseline_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DefaultPatchBaseline(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            patch_baseline_id: Optional[pulumi.Input[builtins.str]] = None,
            patch_baseline_name: Optional[pulumi.Input[builtins.str]] = None) -> 'DefaultPatchBaseline':
        """
    ...
    @property
    @pulumi.getter(name="patchBaselineId")
    def patch_baseline_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the patch baseline.
        """
        return pulumi.get(self, "patch_baseline_id")
