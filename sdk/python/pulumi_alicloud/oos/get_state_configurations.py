...
def get_state_configurations(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of State Configuration IDs.
...
def get_state_configurations_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
