...
class NetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] is_default: Created by default. If the client does not have ccn in the binding, it will create a ccn for the user to replace.
        :param pulumi.Input[builtins.str] cidr_block: The CidrBlock of the CCN instance. Defaults to null.
        :param pulumi.Input[builtins.str] description: The description of the CCN instance. The description can contain 2 to 256 characters. The description must start with English letters, but cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] name: The name of the CCN instance. The name can contain 2 to 128 characters including a-z, A-Z, 0-9, periods, underlines, and hyphens. The name must start with an English letter, but cannot start with http:// or https://.
        """
...
@pulumi.type_token("alicloud:cloudconnect/network:Network")
