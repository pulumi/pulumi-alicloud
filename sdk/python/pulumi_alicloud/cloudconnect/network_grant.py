...
class NetworkGrantArgs:
    def __init__(__self__, *,
                 ccn_id: pulumi.Input[builtins.str],
                 cen_id: pulumi.Input[builtins.str],
                 cen_uid: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a NetworkGrant resource.
        :param pulumi.Input[builtins.str] ccn_id: The ID of the CCN instance.
        :param pulumi.Input[builtins.str] cen_id: The ID of the CEN instance.
        :param pulumi.Input[builtins.str] cen_uid: The ID of the account to which the CEN instance belongs.
        """
    ...
    def ccn_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ccn_id.setter
    def ccn_id(self, value: pulumi.Input[builtins.str]):
    ...
    def cen_uid(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @cen_uid.setter
    def cen_uid(self, value: pulumi.Input[builtins.str]):
...
class _NetworkGrantState:
    def __init__(__self__, *,
                 ccn_id: Optional[pulumi.Input[builtins.str]] = None,
                 cen_id: Optional[pulumi.Input[builtins.str]] = None,
                 cen_uid: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="ccnId")
    def ccn_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the CCN instance.
        """
        return pulumi.get(self, "ccn_id")
    ...
    @ccn_id.setter
    def ccn_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ccn_id", value)
    ...
    @property
    @pulumi.getter(name="cenUid")
    def cen_uid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the account to which the CEN instance belongs.
        """
        return pulumi.get(self, "cen_uid")
    ...
    @cen_uid.setter
    def cen_uid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cen_uid", value)
...
class NetworkGrant(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ccn_id: Optional[pulumi.Input[builtins.str]] = None,
            cen_id: Optional[pulumi.Input[builtins.str]] = None,
            cen_uid: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkGrant':
        """
    ...
    @property
    @pulumi.getter(name="ccnId")
    def ccn_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the CCN instance.
        """
        return pulumi.get(self, "ccn_id")
    ...
    @property
    @pulumi.getter(name="cenUid")
    def cen_uid(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the account to which the CEN instance belongs.
        """
        return pulumi.get(self, "cen_uid")
