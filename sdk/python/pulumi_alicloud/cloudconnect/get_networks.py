...
def get_networks(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of CCN instances IDs.
    :param builtins.str name_regex: A regex string to filter CCN instances by name.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_networks_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:cloudconnect/getNetworks:getNetworks', __args__, opts=opts, typ=GetNetworksResult)
