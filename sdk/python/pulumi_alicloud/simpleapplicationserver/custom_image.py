...
class CustomImageArgs:
    def __init__(__self__, *,
                 custom_image_name: pulumi.Input[builtins.str],
                 instance_id: pulumi.Input[builtins.str],
                 system_snapshot_id: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a CustomImage resource.
        :param pulumi.Input[builtins.str] custom_image_name: The name of the resource. The name must be `2` to `128` characters in length. It must start with a letter or a number. It can contain letters, digits, colons (:), underscores (_) and hyphens (-).
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance.
        :param pulumi.Input[builtins.str] system_snapshot_id: The ID of the system snapshot.
        :param pulumi.Input[builtins.str] description: The description of the Custom Image.
        :param pulumi.Input[builtins.str] status: The Shared status of the Custom Image. Valid values: `Share`, `UnShare`.
    ...
    def custom_image_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def custom_image_name(self, value: pulumi.Input[builtins.str]):
    ...
    def system_snapshot_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def system_snapshot_id(self, value: pulumi.Input[builtins.str]):
...
class _CustomImageState:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 system_snapshot_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="systemSnapshotId")
    def system_snapshot_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the system snapshot.
        """
        return pulumi.get(self, "system_snapshot_id")
    ...
    @system_snapshot_id.setter
    def system_snapshot_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "system_snapshot_id", value)
...
class CustomImage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            system_snapshot_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomImage':
        """
    ...
    @property
    @pulumi.getter(name="customImageName")
    def custom_image_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the resource. The name must be `2` to `128` characters in length. It must start with a letter or a number. It can contain letters, digits, colons (:), underscores (_) and hyphens (-).
        """
        return pulumi.get(self, "custom_image_name")
    ...
    @property
    @pulumi.getter(name="systemSnapshotId")
    def system_snapshot_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the system snapshot.
        """
        return pulumi.get(self, "system_snapshot_id")
