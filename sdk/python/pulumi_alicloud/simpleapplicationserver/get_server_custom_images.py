...
def get_server_custom_images(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Custom Image IDs.
    :param builtins.str name_regex: A regex string to filter results by Custom Image name.
...
def get_server_custom_images_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
