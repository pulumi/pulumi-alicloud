...
class FirewallRuleArgs:
    def __init__(__self__, *,
                 ...
                 rule_protocol: pulumi.Input[builtins.str],
                 remark: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a FirewallRule resource.
        :param pulumi.Input[builtins.str] instance_id: Alibaba Cloud simple application server instance ID.
        :param pulumi.Input[builtins.str] port: The port range. Valid values of port numbers: `1` to `65535`. Specify a port range in the format of `<start port number>/<end port number>`. Example: `1024/1055`, which indicates the port range of `1024` through `1055`.
        :param pulumi.Input[builtins.str] rule_protocol: The transport layer protocol. Valid values: `Tcp`, `Udp`, `TcpAndUdp`.
        :param pulumi.Input[builtins.str] remark: The remarks of the firewall rule.
        """
    ...
    def rule_protocol(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def rule_protocol(self, value: pulumi.Input[builtins.str]):
...
class _FirewallRuleState:
    def __init__(__self__, *,
                 firewall_rule_id: Optional[pulumi.Input[builtins.str]] = None,
                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 port: Optional[pulumi.Input[builtins.str]] = None,
                 remark: Optional[pulumi.Input[builtins.str]] = None,
                 rule_protocol: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering FirewallRule resources.
        :param pulumi.Input[builtins.str] firewall_rule_id: The ID of the firewall rule.
        :param pulumi.Input[builtins.str] instance_id: Alibaba Cloud simple application server instance ID.
        :param pulumi.Input[builtins.str] port: The port range. Valid values of port numbers: `1` to `65535`. Specify a port range in the format of `<start port number>/<end port number>`. Example: `1024/1055`, which indicates the port range of `1024` through `1055`.
        :param pulumi.Input[builtins.str] remark: The remarks of the firewall rule.
        :param pulumi.Input[builtins.str] rule_protocol: The transport layer protocol. Valid values: `Tcp`, `Udp`, `TcpAndUdp`.
    ...
    def firewall_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def firewall_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="ruleProtocol")
    def rule_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The transport layer protocol. Valid values: `Tcp`, `Udp`, `TcpAndUdp`.
        """
        return pulumi.get(self, "rule_protocol")
    ...
    @rule_protocol.setter
    def rule_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rule_protocol", value)


@pulumi.type_token("alicloud:simpleapplicationserver/firewallRule:FirewallRule")
class FirewallRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            port: Optional[pulumi.Input[builtins.str]] = None,
            remark: Optional[pulumi.Input[builtins.str]] = None,
            rule_protocol: Optional[pulumi.Input[builtins.str]] = None) -> 'FirewallRule':
        """
    ...
    @property
    @pulumi.getter(name="firewallRuleId")
    def firewall_rule_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the firewall rule.
        """
        return pulumi.get(self, "firewall_rule_id")
    ...
    @property
    @pulumi.getter(name="ruleProtocol")
    def rule_protocol(self) -> pulumi.Output[builtins.str]:
        """
        The transport layer protocol. Valid values: `Tcp`, `Udp`, `TcpAndUdp`.
        """
        return pulumi.get(self, "rule_protocol")
