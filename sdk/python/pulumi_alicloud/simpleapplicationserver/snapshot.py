...
class SnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] snapshot_name: The name of the snapshot. The name must be `2` to `50` characters in length. It must start with a letter and cannot start with `http://` or `https://`. It can contain letters, digits, colons (:), underscores (_), periods (.),and hyphens (-).
        """
...
class _SnapshotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] disk_id: The ID of the disk.
        :param pulumi.Input[builtins.str] snapshot_name: The name of the snapshot. The name must be `2` to `50` characters in length. It must start with a letter and cannot start with `http://` or `https://`. It can contain letters, digits, colons (:), underscores (_), periods (.),and hyphens (-).
        :param pulumi.Input[builtins.str] status: The status of the snapshot. Valid values: `Progressing`, `Accomplished` and `Failed`.
        """
...
@pulumi.type_token("alicloud:simpleapplicationserver/snapshot:Snapshot")
class Snapshot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            disk_id: Optional[pulumi.Input[builtins.str]] = None,
            snapshot_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'Snapshot':
        """
