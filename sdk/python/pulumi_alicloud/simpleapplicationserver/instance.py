...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 data_disk_size: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.str] instance_name: The name of the simple application server.
        :param pulumi.Input[_builtins.str] password: The password of the simple application server. The password must be 8 to 30 characters in length. It must contain at least three of the following character types: uppercase letters, lowercase letters, digits, and special characters. Special characters include: `( ) ~ ! @ # $ % ^ & * - + = | { } [ ] : ; < > , . ? /`.
        :param pulumi.Input[_builtins.str] payment_type: The paymen type of the resource. Valid values: `Subscription`.
        :param pulumi.Input[_builtins.str] status: The status of the simple application server. Valid values: `Resetting`, `Running`, `Stopped`.
        """
    ...
    def data_disk_size(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def data_disk_size(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class Instance(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="dataDiskSize")
    def data_disk_size(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The size of the data disk. Unit: GB. Valid values: `0` to `16380`.
        """
        return pulumi.get(self, "data_disk_size")
