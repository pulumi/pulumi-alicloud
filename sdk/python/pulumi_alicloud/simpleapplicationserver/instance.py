...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 data_disk_size: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] image_id: The ID of the image.  You can use the `simpleapplicationserver_get_images` to query the available images in the specified region. The value must be an integral multiple of 20.
        :param pulumi.Input[builtins.int] period: The period. Unit: months. Valid values: `1`,`3`, `6`, `12`, `24`, `36`.
        :param pulumi.Input[builtins.str] plan_id: The ID of the plan. You can use the `simpleapplicationserver_get_server_plans`  to query all the plans provided by Simple Application Server in the specified region.
        :param pulumi.Input[builtins.bool] auto_renew: Specifies whether to enable auto-renewal. Unit: months. Valid values: `true` and `false`.
        :param pulumi.Input[builtins.int] auto_renew_period: The auto renew period. Valid values: `1`,`3`, `6`, `12`, `24`, `36`. **NOTE:** The attribute `auto_renew` is valid when the attribute is `true`.
        :param pulumi.Input[builtins.int] data_disk_size: The size of the data disk. Unit: GB. Valid values: `0` to `16380`.
        :param pulumi.Input[builtins.str] instance_name: The name of the simple application server.
        :param pulumi.Input[builtins.str] password: The password of the simple application server. The password must be 8 to 30 characters in length. It must contain at least three of the following character types: uppercase letters, lowercase letters, digits, and special characters. Special characters include: `( ) ~ ! @ # $ % ^ & * - + = | { } [ ] : ; < > , . ? /`.
        :param pulumi.Input[builtins.str] payment_type: The paymen type of the resource. Valid values: `Subscription`.
        :param pulumi.Input[builtins.str] status: The status of the simple application server. Valid values: `Resetting`, `Running`, `Stopped`.
        """
    ...
    def data_disk_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def data_disk_size(self, value: Optional[pulumi.Input[builtins.int]]):
...
@pulumi.type_token("alicloud:simpleapplicationserver/instance:Instance")
class Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            period: Optional[pulumi.Input[builtins.int]] = None,
            plan_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'Instance':
        """
    ...
    @property
    @pulumi.getter(name="dataDiskSize")
    def data_disk_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The size of the data disk. Unit: GB. Valid values: `0` to `16380`.
        """
        return pulumi.get(self, "data_disk_size")
