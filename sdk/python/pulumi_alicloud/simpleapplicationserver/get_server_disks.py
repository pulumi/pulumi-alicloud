...
def get_server_disks(disk_type: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Disk IDs.
    :param builtins.str instance_id: The ID of the simple application server to which the disk is attached.
...
def get_server_disks_output(disk_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
