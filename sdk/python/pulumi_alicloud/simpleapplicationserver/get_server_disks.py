...
def get_server_disks(disk_type: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Disk IDs.
    :param _builtins.str instance_id: The ID of the simple application server to which the disk is attached.
