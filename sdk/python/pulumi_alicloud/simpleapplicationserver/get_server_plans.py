...
class GetServerPlansResult:
    ...
    @property
    @pulumi.getter
    def core(self) -> Optional[builtins.int]:
    ...
    @property
    @pulumi.getter
    def flow(self) -> Optional[builtins.int]:
...
def get_server_plans(bandwidth: Optional[builtins.int] = None,
                     core: Optional[builtins.int] = None,
                     disk_size: Optional[builtins.int] = None,
                     flow: Optional[builtins.int] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Instance Plan IDs.
    ...
    :param builtins.str platform: The platform of Plan supported. Valid values: ["Linux", "Windows"].
    """
    __args__ = dict()
...
def get_server_plans_output(bandwidth: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                            core: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                            disk_size: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                            flow: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                            ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                            memory: Optional[pulumi.Input[Optional[builtins.float]]] = None,
