...
def get_server_firewall_rules(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Firewall Rule IDs.
...
def get_server_firewall_rules_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
