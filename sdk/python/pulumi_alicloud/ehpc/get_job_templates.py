...
def get_job_templates(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Job Template IDs.
...
def get_job_templates_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
