...
if not MYPY:
    class ClusterAdditionalVolumeArgsDict(TypedDict):
        job_queue: NotRequired[pulumi.Input[builtins.str]]
        """
        The queue of the nodes to which the additional file system is attached.
        """
        local_directory: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        remote_directory: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        volume_mount_option: NotRequired[pulumi.Input[builtins.str]]
        """
        The mount options of the file system.
        """
        volume_mountpoint: NotRequired[pulumi.Input[builtins.str]]
        """
        The mount target of the additional file system.
        """
        volume_protocol: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterAdditionalVolumeArgs:
    def __init__(__self__, *,
                 ...
                 local_directory: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] job_queue: The queue of the nodes to which the additional file system is attached.
        :param pulumi.Input[builtins.str] local_directory: The local directory on which the additional file system is mounted.
        :param pulumi.Input[builtins.str] location: The type of the cluster. Valid value: `PublicCloud`.
        :param pulumi.Input[builtins.str] remote_directory: The remote directory to which the additional file system is mounted.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterAdditionalVolumeRoleArgs']]] roles: The roles. See `roles` below.
        :param pulumi.Input[builtins.str] volume_id: The ID of the additional file system.
        :param pulumi.Input[builtins.str] volume_mount_option: The mount options of the file system.
        :param pulumi.Input[builtins.str] volume_mountpoint: The mount target of the additional file system.
        :param pulumi.Input[builtins.str] volume_protocol: The type of the protocol that is used by the additional file system. Valid values: `NFS`, `SMB`. Default value: `NFS`
        :param pulumi.Input[builtins.str] volume_type: The type of the additional shared storage. Only NAS file systems are supported.
        """
    ...
    def local_directory(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The local directory on which the additional file system is mounted.
        """
    ...
    def local_directory(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterAdditionalVolumeRoleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The type of the nodes to which the additional file system is attached.
        """
        if name is not None:
...
class ClusterApplicationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] tag: The tag of the software.
        """
        if tag is not None:
...
class ClusterPostInstallScriptArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] args: The parameter that is used to run the script after the cluster is created.
        :param pulumi.Input[builtins.str] url: The URL that is used to download the script after the cluster is created.
        """
        if args is not None:
