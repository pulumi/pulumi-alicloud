...
def get_clusters(enable_details: Optional[builtins.bool] = None,
...
def get_clusters_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:ehpc/getClusters:getClusters', __args__, opts=opts, typ=GetClustersResult)
