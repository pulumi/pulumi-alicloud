...
def get_msc_sub_webhooks(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Webhook IDs.
    :param builtins.str name_regex: A regex string to filter results by Webhook name.
...
def get_msc_sub_webhooks_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
