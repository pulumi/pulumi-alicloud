...
def get_msc_sub_webhooks(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Webhook IDs.
    :param _builtins.str name_regex: A regex string to filter results by Webhook name.
...
def get_msc_sub_webhooks_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                name_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetMscSubWebhooksResult]:
    """
    This data source provides the Msc Sub Webhooks of the current Alibaba Cloud user.
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:index/getMscSubWebhooks:getMscSubWebhooks', __args__, opts=opts, typ=GetMscSubWebhooksResult)
    return __ret__.apply(lambda __response__: GetMscSubWebhooksResult(
