...
class ScheduledSqlArgs:
    def __init__(__self__, *,
                 ...
                 scheduled_sql_name: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ScheduledSql resource.
        :param pulumi.Input[builtins.str] display_name: Task Display Name.
        :param pulumi.Input[builtins.str] project: Log project.
        ...
        :param pulumi.Input[builtins.str] scheduled_sql_name: Timed SQL name.
    ...
    def scheduled_sql_name(self) -> pulumi.Input[builtins.str]:
        """
        Timed SQL name.
        """
    ...
    def scheduled_sql_name(self, value: pulumi.Input[builtins.str]):
...
class _ScheduledSqlState:
    def __init__(__self__, *,
                 ...
                 scheduled_sql_name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="scheduledSqlName")
    def scheduled_sql_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Timed SQL name.
        """
        return pulumi.get(self, "scheduled_sql_name")
    ...
    @scheduled_sql_name.setter
    def scheduled_sql_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scheduled_sql_name", value)
...
class ScheduledSql(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            schedule: Optional[pulumi.Input[Union['ScheduledSqlScheduleArgs', 'ScheduledSqlScheduleArgsDict']]] = None,
            scheduled_sql_configuration: Optional[pulumi.Input[Union['ScheduledSqlScheduledSqlConfigurationArgs', 'ScheduledSqlScheduledSqlConfigurationArgsDict']]] = None,
            scheduled_sql_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ScheduledSql':
        """
    ...
    @property
    @pulumi.getter(name="scheduledSqlName")
    def scheduled_sql_name(self) -> pulumi.Output[builtins.str]:
        """
        Timed SQL name.
        """
        return pulumi.get(self, "scheduled_sql_name")
