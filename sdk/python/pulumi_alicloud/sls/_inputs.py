...
if not MYPY:
    class AlertConfigurationArgsDict(TypedDict):
        ...
        """
        auto_annotation: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        mute_until: NotRequired[pulumi.Input[builtins.int]]
        """
        Second-level timestamp representing the temporary shutdown deadline.
        """
        no_data_fire: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        no_data_severity: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        send_resolved: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AlertConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 auto_annotation: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 mute_until: Optional[pulumi.Input[builtins.int]] = None,
                 no_data_fire: Optional[pulumi.Input[builtins.bool]] = None,
                 no_data_severity: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] dashboard: The instrument cluster associated with the alarm. It is recommended to set to internal-alert-analysis.
        ...
        :param pulumi.Input[builtins.bool] send_resolved: Whether to send a recovery notification. true: A recovery alarm is triggered when the alarm is restored. false (default): Turn off the alarm recovery notification function.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Customize the category of alarm monitoring rules.
        ...
        :param pulumi.Input[builtins.int] threshold: Set the continuous trigger threshold. When the cumulative number of triggers reaches this value, an alarm is generated. The statistics are not counted when the trigger condition is not met.
        :param pulumi.Input[builtins.str] type: Template Type.
        :param pulumi.Input[builtins.str] version: Template Version.
        """
    ...
    def auto_annotation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to turn on automatic labeling. true (default): The automatic annotation function is enabled, and the system automatically adds information such as__county__to the alarm. For more information, see Automatic Labeling. false: Turn off the automatic annotation function.
        """
    ...
    def auto_annotation(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def mute_until(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Second-level timestamp representing the temporary shutdown deadline.
        """
    ...
    @mute_until.setter
    def mute_until(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "mute_until", value)

    @property
    @pulumi.getter(name="noDataFire")
    def no_data_fire(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether no data triggers an alarm. true: If the number of times the query and analysis results (if there are multiple results, the result after the collection operation) is no data exceeds the continuous trigger threshold, an alarm is generated. false (default): Turn off the no data alarm function.
        """
    ...
    @no_data_fire.setter
    def no_data_fire(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "no_data_fire", value)

    @property
    @pulumi.getter(name="noDataSeverity")
    def no_data_severity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Alarm severity when no data triggers an alarm.
        """
    ...
    def no_data_severity(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AlertConfigurationAnnotationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: Field name.
        :param pulumi.Input[builtins.str] value: Field value.
        """
        if key is not None:
...
class AlertConfigurationConditionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] condition: Data matching expression. When the data content does not need to be determined, set it to an empty string. In other cases, it needs to be set as an expression, for example, errCnt> 10.
        :param pulumi.Input[builtins.str] count_condition: The number of pieces of data to determine the number of pieces of data to indicate how many pieces of data meet the conditions. If data exists, it is satisfied. Set it to an empty string. In other cases, it needs to be set as an expression, such as__count__> 3.
        """
...
class AlertConfigurationGroupConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] fields: The field used for grouping evaluation. When type is set to custom, fields must be set.
        """
...
if not MYPY:
    class AlertConfigurationPolicyConfigurationArgsDict(TypedDict):
        action_policy_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        alert_policy_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AlertConfigurationPolicyConfigurationArgs:
    def __init__(__self__, *,
                 action_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 alert_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 repeat_interval: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] action_policy_id: The ID of the action policy used. If the alert policy is in advanced mode and the selected alert policy is not configured with a dynamic action policy, set the actionPolicyId to an empty string.
        :param pulumi.Input[builtins.str] alert_policy_id: Alarm policy ID. If it is in simple mode or normal mode, set it to sls.builtin.dynamic (dynamic alarm policy built into the system). For advanced mode, set it to the specified alarm policy ID.
        :param pulumi.Input[builtins.str] repeat_interval: Repeat the waiting time. For example, 5m, 1H, etc.
        """
    ...
    def action_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the action policy used. If the alert policy is in advanced mode and the selected alert policy is not configured with a dynamic action policy, set the actionPolicyId to an empty string.
        """
    ...
    def action_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AlertConfigurationQueryListArgsDict(TypedDict):
        chart_title: NotRequired[pulumi.Input[builtins.str]]
        """
        Chart Name.
        """
        ...
        """
        power_sql_mode: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        store: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Time Type.
        """
        ui: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AlertConfigurationQueryListArgs:
    def __init__(__self__, *,
                 chart_title: Optional[pulumi.Input[builtins.str]] = None,
                 dashboard_id: Optional[pulumi.Input[builtins.str]] = None,
                 end: Optional[pulumi.Input[builtins.str]] = None,
                 power_sql_mode: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 ui: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] chart_title: Chart Name.
        :param pulumi.Input[builtins.str] dashboard_id: Dashboard ID.
        :param pulumi.Input[builtins.str] end: End time. When storeType is set to log or metric, end must be set.
        :param pulumi.Input[builtins.str] power_sql_mode: Whether to use exclusive SQL. The value is as follows: auto: automatic switching. enable: Starts. disable: disable.
        :param pulumi.Input[builtins.str] project: Project Name.
        :param pulumi.Input[builtins.str] query: Query and analysis statements. When storeType is set to log or metric, query is set to the query analysis statement. When storeType is set to meta, set query to an empty string.
        :param pulumi.Input[builtins.str] region: Region of the target Project.
        :param pulumi.Input[builtins.str] role_arn: Roles used to write alarm data to the event Library.
        :param pulumi.Input[builtins.str] start: Start time. When storeType is set to log or metric, start must be set.
        :param pulumi.Input[builtins.str] store: Query the Logstore, Metricstore, or resource data associated with the statistics. When storeType is set to log, store is set to the target Logstore. When storeType is set to metric, store is set to the target Metricstore. When storeType is set to meta, store is set to the target resource data name.
        :param pulumi.Input[builtins.str] store_type: Query the data source type. The value is as follows: log: Logstore. metric: Time series Library. meta: resource data.
        :param pulumi.Input[builtins.str] time_span_type: Time Type.
        :param pulumi.Input[builtins.str] ui: Use of specific scene alarm front end.
        """
    ...
    def chart_title(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Chart Name.
        """
    ...
    @chart_title.setter
    def chart_title(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def power_sql_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether to use exclusive SQL. The value is as follows: auto: automatic switching. enable: Starts. disable: disable.
        """
    ...
    def power_sql_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def ui(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Use of specific scene alarm front end.
        """
    ...
    @ui.setter
    def ui(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AlertConfigurationSeverityConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] severity: Alarm severity.
        """
...
class AlertConfigurationSinkAlerthubArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Open.
        """
...
if not MYPY:
    class AlertConfigurationSinkEventStoreArgsDict(TypedDict):
        ...
        """
        event_store: NotRequired[pulumi.Input[builtins.str]]
        """
        Event Library Name.
        """
        project: NotRequired[pulumi.Input[builtins.str]]
...
class AlertConfigurationSinkEventStoreArgs:
    def __init__(__self__, *,
                 ...
                 event_store: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 role_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Open.
        :param pulumi.Input[builtins.str] endpoint: SLS service endpoint.
        :param pulumi.Input[builtins.str] event_store: Event Library Name.
        :param pulumi.Input[builtins.str] project: Project Name.
        :param pulumi.Input[builtins.str] role_arn: Roles used to write alarm data to the event Library.
        """
        if enabled is not None:
    ...
    def event_store(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Event Library Name.
        """
    ...
    @event_store.setter
    def event_store(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AlertConfigurationTemplateConfigurationArgsDict(TypedDict):
        ...
        Template ID.
        """
        tokens: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        Template Variables.
        """
        type: NotRequired[pulumi.Input[builtins.str]]
...
class AlertConfigurationTemplateConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 tokens: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Template Annotations.
        :param pulumi.Input[builtins.str] lang: Template Language.
        :param pulumi.Input[builtins.str] template_id: Template ID.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tokens: Template Variables.
        :param pulumi.Input[builtins.str] version: Template Version.
        """
        if annotations is not None:
            pulumi.set(__self__, "annotations", annotations)
    ...
    @property
    @pulumi.getter
    def tokens(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Template Variables.
        """
    ...
    @tokens.setter
    def tokens(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class AlertScheduleArgsDict(TypedDict):
        ...
        """
        run_immdiately: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AlertScheduleArgs:
    def __init__(__self__, *,
                 ...
                 run_immdiately: Optional[pulumi.Input[builtins.bool]] = None,
                 time_zone: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cron_expression: Cron expression, the minimum accuracy is minutes, 24 hours. For example, 0 0/1 * * * means that the check is conducted every 1 hour from 00:00. When type is set to Cron, cronExpression must be set.
        :param pulumi.Input[builtins.int] delay: Timed task execution delay (unit: s).
        :param pulumi.Input[builtins.str] interval: Fixed interval for scheduling.
        :param pulumi.Input[builtins.bool] run_immdiately: Dispatch immediately.
        :param pulumi.Input[builtins.str] time_zone: The time zone where the Cron expression is located. The default value is null, indicating the eighth zone in the east.
        :param pulumi.Input[builtins.str] type: Check the frequency type. Log Service checks the query and analysis results according to the frequency you configured. The values are as follows: Fixedate: checks query and analysis results at regular intervals. Cron: specifies the time interval by using the Cron expression, and checks the query and analysis results at the specified time interval.
        """
    ...
    def run_immdiately(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Dispatch immediately.
        """
    ...
    def run_immdiately(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class CollectionPolicyCentralizeConfigArgsDict(TypedDict):
        dest_logstore: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        dest_project: NotRequired[pulumi.Input[builtins.str]]
        """
        The geographical attributes of the centralized transfer project should be consistent with the destRegion.
        """
        dest_region: NotRequired[pulumi.Input[builtins.str]]
        """
        Centralized transfer destination area.
        """
        dest_ttl: NotRequired[pulumi.Input[builtins.int]]
        """
...
class CollectionPolicyCentralizeConfigArgs:
    def __init__(__self__, *,
                 dest_logstore: Optional[pulumi.Input[builtins.str]] = None,
                 dest_project: Optional[pulumi.Input[builtins.str]] = None,
                 dest_region: Optional[pulumi.Input[builtins.str]] = None,
                 dest_ttl: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] dest_logstore: When the central logstore is transferred to the destination logstore, its geographical attribute should be consistent with the destRegion and belong to the destProject.
        :param pulumi.Input[builtins.str] dest_project: The geographical attributes of the centralized transfer project should be consistent with the destRegion.
        :param pulumi.Input[builtins.str] dest_region: Centralized transfer destination area.
        :param pulumi.Input[builtins.int] dest_ttl: The number of days for the central transfer destination. This is valid only if the central transfer destination log store is not created for the first time.
        """
    ...
    def dest_logstore(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        When the central logstore is transferred to the destination logstore, its geographical attribute should be consistent with the destRegion and belong to the destProject.
        """
    ...
    def dest_logstore(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dest_logstore", value)

    @property
    @pulumi.getter(name="destProject")
    def dest_project(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The geographical attributes of the centralized transfer project should be consistent with the destRegion.
        """
    ...
    @dest_project.setter
    def dest_project(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def dest_ttl(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of days for the central transfer destination. This is valid only if the central transfer destination log store is not created for the first time.
        """
    ...
    @dest_ttl.setter
    def dest_ttl(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "dest_ttl", value)


if not MYPY:
    class CollectionPolicyDataConfigArgsDict(TypedDict):
        data_project: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        data_region: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CollectionPolicyDataConfigArgs:
    def __init__(__self__, *,
                 data_project: Optional[pulumi.Input[builtins.str]] = None,
                 data_region: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] data_project: Valid only when the log type is global. For example, if the productCode is sls, the log is collected to the default dedicated Project of the account in a specific dataRegion.
        :param pulumi.Input[builtins.str] data_region: If and only if the log type is global log type, for example, if productCode is sls, global logs will be collected to the corresponding region during the first configuration.
        """
    ...
    def data_project(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Valid only when the log type is global. For example, if the productCode is sls, the log is collected to the default dedicated Project of the account in a specific dataRegion.
        """
    ...
    @data_project.setter
    def data_project(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_project", value)

    @property
    @pulumi.getter(name="dataRegion")
    def data_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        If and only if the log type is global log type, for example, if productCode is sls, global logs will be collected to the corresponding region during the first configuration.
        """
    ...
    @data_region.setter
    def data_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_region", value)


if not MYPY:
    class CollectionPolicyPolicyConfigArgsDict(TypedDict):
        resource_mode: pulumi.Input[builtins.str]
        """
        ...
        """
        instance_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class CollectionPolicyPolicyConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] resource_mode: Resource collection mode. If all is configured, all instances under the account will be collected to the default logstore. If attributeMode is configured, filtering will be performed according to the region attribute and resource label of the instance. If instanceMode is configured, filtering will be performed according to the instance ID.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_ids: A collection of instance IDs, valid only if resourceMode is instanceMode. Only instances whose instance ID is in the instance ID collection are collected.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: The region collection to which the instance belongs. Valid only when resourceMode is set to attributeMode. Wildcard characters are supported. If the region collection filter item is an empty array, it means that you do not need to filter by region, and all instances meet the filtering condition of the region collection. Otherwise, only instances with region attributes in the region collection are collected. The region collection and resource label of the instance. The instance objects are collected only when all of them are met.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] resource_tags: Resource label, valid if and only if resourceMode is attributeMode.
    ...
    def resource_mode(self) -> pulumi.Input[builtins.str]:
        """
        Resource collection mode. If all is configured, all instances under the account will be collected to the default logstore. If attributeMode is configured, filtering will be performed according to the region attribute and resource label of the instance. If instanceMode is configured, filtering will be performed according to the instance ID.
        """
    ...
    def resource_mode(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class CollectionPolicyResourceDirectoryArgsDict(TypedDict):
        account_group_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CollectionPolicyResourceDirectoryArgs:
    def __init__(__self__, *,
                 account_group_type: Optional[pulumi.Input[builtins.str]] = None,
                 members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] account_group_type: Support all mode all and custom mode custom under this resource directory
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] members: When the resource directory is configured in the custom mode, the corresponding member account list
        """
    ...
    def account_group_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Support all mode all and custom mode custom under this resource directory
        """
    ...
    def account_group_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OssExportSinkConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 to_time: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] from_time: The beginning of the time range to ship data. The value 1 specifies that the data shipping job ships data from the first log in the Logstore. Example value: 1718380800
        :param pulumi.Input[builtins.str] logstore: The name of the Logstore.
        :param pulumi.Input[builtins.str] role_arn: The ARN of the RAM role that is used to write data to OSS. Example value: acs:ram::xxxxxxx
        ...
        :param pulumi.Input[builtins.int] to_time: The end of the time range to ship data. The value 0 specifies that the data shipping job continuously ships data until the job is manually stopped. Example value: 1718380800
        """
        pulumi.set(__self__, "from_time", from_time)
        pulumi.set(__self__, "logstore", logstore)
        pulumi.set(__self__, "role_arn", role_arn)
...
if not MYPY:
    class OssExportSinkConfigurationSinkArgsDict(TypedDict):
        ...
        """
        path_format_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class OssExportSinkConfigurationSinkArgs:
    def __init__(__self__, *,
                 ...
                 path_format: Optional[pulumi.Input[builtins.str]] = None,
                 path_format_type: Optional[pulumi.Input[builtins.str]] = None,
                 prefix: Optional[pulumi.Input[builtins.str]] = None,
                 suffix: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] bucket: The OSS bucket.
        :param pulumi.Input[builtins.str] buffer_interval: The interval between two data shipping operations. Valid values: 300 to 900. Unit: seconds.
        :param pulumi.Input[builtins.str] buffer_size: The size of the OSS object to which data is shipped. Valid values: 5 to 256. Unit: MB.
        :param pulumi.Input[builtins.str] compression_type: Supports four compression types, such as snappy, gzip, zstd, and none.
        :param pulumi.Input[builtins.str] content_detail: The OSS file content details. Note: the value of this parameter should be updated based on the value of the contentType parameter.
               ...
               The columns parameter is the key of the log in the source Logstore and must carry the data type of the key, for example:{"columns": [{"name": "a", "type": "string"}, {"name": "B", "type": "string"}, {"name": "c", "type": "string": "string"}]}
        :param pulumi.Input[builtins.str] content_type: The storage format of the OSS object. Valid values: json, parquet, csv, and orc.
        :param pulumi.Input[builtins.str] endpoint: The OSS Endpoint can only be an OSS intranet Endpoint and only supports the same region. Example value: https://oss-cn-hangzhou-internal.aliyuncs.com
        :param pulumi.Input[builtins.str] role_arn: The ARN of the RAM role that is used to write data to OSS. Example value: acs:ram::xxxxxxx
        :param pulumi.Input[builtins.str] time_zone: The time zone. Example value: +0800
        :param pulumi.Input[builtins.int] delay_seconds: The latency of data shipping. The value of this parameter cannot exceed the data retention period of the source Logstore.
        :param pulumi.Input[builtins.str] path_format: The directory is dynamically generated according to the time. The default value is% Y/%m/%d/%H/%M. The corresponding generated directory is, for example, 2017/01/23/12/00. Note that the partition format cannot start and end. Example values:%Y/%m/%d
        :param pulumi.Input[builtins.str] path_format_type: The partition format type. only support time
        :param pulumi.Input[builtins.str] prefix: The prefix of the OSS object.
        :param pulumi.Input[builtins.str] suffix: The suffix of the OSS object.
        """
    ...
    def buffer_interval(self) -> pulumi.Input[builtins.str]:
        """
        The interval between two data shipping operations. Valid values: 300 to 900. Unit: seconds.
        """
    ...
    def buffer_interval(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "buffer_interval", value)

    @property
    @pulumi.getter(name="bufferSize")
    def buffer_size(self) -> pulumi.Input[builtins.str]:
        """
        The size of the OSS object to which data is shipped. Valid values: 5 to 256. Unit: MB.
        """
    ...
    @buffer_size.setter
    def buffer_size(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "buffer_size", value)

    @property
    @pulumi.getter(name="compressionType")
    def compression_type(self) -> pulumi.Input[builtins.str]:
        """
        Supports four compression types, such as snappy, gzip, zstd, and none.
        """
    ...
    def compression_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "compression_type", value)

    @property
    @pulumi.getter(name="contentDetail")
    def content_detail(self) -> pulumi.Input[builtins.str]:
        """
        The OSS file content details. Note: the value of this parameter should be updated based on the value of the contentType parameter.
    ...
    def content_detail(self, value: pulumi.Input[builtins.str]):
    ...
    def path_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The directory is dynamically generated according to the time. The default value is% Y/%m/%d/%H/%M. The corresponding generated directory is, for example, 2017/01/23/12/00. Note that the partition format cannot start and end. Example values:%Y/%m/%d
        """
    ...
    @path_format.setter
    def path_format(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "path_format", value)

    @property
    @pulumi.getter(name="pathFormatType")
    def path_format_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The partition format type. only support time
        """
    ...
    def path_format_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ScheduledSqlScheduleArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cron_expression: Cron expression, minimum precision is minutes, 24-hour clock. For example, 0 0/1 **indicates that the check is performed every one hour from 00:00. When type is set to Cron, cronExpression must be set.
        :param pulumi.Input[builtins.int] delay: Delay time.
        :param pulumi.Input[builtins.str] interval: Time interval, such as 5m, 1H.
        :param pulumi.Input[builtins.bool] run_immediately: Whether to execute the OSS import task immediately after it is created.
...
if not MYPY:
    class ScheduledSqlScheduledSqlConfigurationArgsDict(TypedDict):
        ...
        Write Mode.
        """
        dest_endpoint: NotRequired[pulumi.Input[builtins.str]]
        """
        Target Endpoint.
        """
        dest_logstore: NotRequired[pulumi.Input[builtins.str]]
        ...
        Target Project.
        """
        dest_role_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        Write target role ARN.
        """
        from_time: NotRequired[pulumi.Input[builtins.int]]
        """
        Schedule Start Time.
        """
        from_time_expr: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Maximum retries.
        """
        max_run_time_in_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
        SQL timeout.
        """
        parameters: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        ...
        """
        resource_pool: NotRequired[pulumi.Input[builtins.str]]
        """
        Resource Pool.
        """
        role_arn: NotRequired[pulumi.Input[builtins.str]]
        ...
        SQL statement.
        """
        source_logstore: NotRequired[pulumi.Input[builtins.str]]
        """
        Source Logstore.
        """
        ...
        SQL type.
        """
        to_time: NotRequired[pulumi.Input[builtins.int]]
        """
        Time at end of schedule.
        """
        to_time_expr: NotRequired[pulumi.Input[builtins.str]]
        """
        SQL time window-end.
        """
elif False:
...
class ScheduledSqlScheduledSqlConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 dest_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 dest_logstore: Optional[pulumi.Input[builtins.str]] = None,
                 dest_project: Optional[pulumi.Input[builtins.str]] = None,
                 dest_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 from_time: Optional[pulumi.Input[builtins.int]] = None,
                 from_time_expr: Optional[pulumi.Input[builtins.str]] = None,
                 max_retries: Optional[pulumi.Input[builtins.int]] = None,
                 max_run_time_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 resource_pool: Optional[pulumi.Input[builtins.str]] = None,
                 role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 script: Optional[pulumi.Input[builtins.str]] = None,
                 source_logstore: Optional[pulumi.Input[builtins.str]] = None,
                 sql_type: Optional[pulumi.Input[builtins.str]] = None,
                 to_time: Optional[pulumi.Input[builtins.int]] = None,
                 to_time_expr: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] data_format: Write Mode.
        :param pulumi.Input[builtins.str] dest_endpoint: Target Endpoint.
        :param pulumi.Input[builtins.str] dest_logstore: Target Logstore.
        :param pulumi.Input[builtins.str] dest_project: Target Project.
        :param pulumi.Input[builtins.str] dest_role_arn: Write target role ARN.
        :param pulumi.Input[builtins.int] from_time: Schedule Start Time.
        :param pulumi.Input[builtins.str] from_time_expr: SQL time window-start.
        :param pulumi.Input[builtins.int] max_retries: Maximum retries.
        :param pulumi.Input[builtins.int] max_run_time_in_seconds: SQL timeout.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: Parameter configuration.
        :param pulumi.Input[builtins.str] resource_pool: Resource Pool.
        :param pulumi.Input[builtins.str] role_arn: Read role ARN.
        :param pulumi.Input[builtins.str] script: SQL statement.
        :param pulumi.Input[builtins.str] source_logstore: Source Logstore.
        :param pulumi.Input[builtins.str] sql_type: SQL type.
        :param pulumi.Input[builtins.int] to_time: Time at end of schedule.
        :param pulumi.Input[builtins.str] to_time_expr: SQL time window-end.
        """
    ...
    def dest_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Target Endpoint.
        """
    ...
    def dest_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def dest_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Write target role ARN.
        """
    ...
    def dest_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def from_time_expr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        SQL time window-start.
        """
    ...
    def from_time_expr(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def max_run_time_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        SQL timeout.
        """
    ...
    def max_run_time_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def resource_pool(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Resource Pool.
        """
    ...
    def resource_pool(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_logstore(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Source Logstore.
        """
    ...
    def source_logstore(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def to_time_expr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        SQL time window-end.
        """
    ...
    @to_time_expr.setter
    def to_time_expr(self, value: Optional[pulumi.Input[builtins.str]]):
