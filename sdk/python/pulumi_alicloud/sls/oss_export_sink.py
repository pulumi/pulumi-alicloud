...
class OssExportSinkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: The display name of the job.
        :param pulumi.Input[builtins.str] job_name: The unique identifier of the OSS data shipping job.
        :param pulumi.Input[builtins.str] project: The name of the project.
        :param pulumi.Input[builtins.str] description: The description of the job.
        """
...
class _OssExportSinkState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['OssExportSinkConfigurationArgs'] configuration: OSSExportConfiguration See `configuration` below.
        :param pulumi.Input[builtins.int] create_time: Creation time. Example value: 1718787534
        :param pulumi.Input[builtins.str] description: The description of the job.
        :param pulumi.Input[builtins.str] display_name: The display name of the job.
        :param pulumi.Input[builtins.str] job_name: The unique identifier of the OSS data shipping job.
        :param pulumi.Input[builtins.str] project: The name of the project.
        :param pulumi.Input[builtins.str] status: The status of the post task. Example value: RUNNING
        """
...
class OssExportSink(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            job_name: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'OssExportSink':
        """
