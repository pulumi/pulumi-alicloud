...
class AlertArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alert_name: Alert rule ID, unique under Project.
        ...
        :param pulumi.Input[builtins.str] display_name: Display name of the alarm rule.
        ...
        :param pulumi.Input[builtins.str] description: Compatible fields, set to empty strings.
        :param pulumi.Input[builtins.str] status: Resource attribute field representing alarm status.
        """
...
class _AlertState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alert_name: Alert rule ID, unique under Project.
        :param pulumi.Input['AlertConfigurationArgs'] configuration: Detailed configuration of alarm monitoring rules. See `configuration` below.
        :param pulumi.Input[builtins.int] create_time: Alarm rule creation time.
        :param pulumi.Input[builtins.str] description: Compatible fields, set to empty strings.
        :param pulumi.Input[builtins.str] display_name: Display name of the alarm rule.
        :param pulumi.Input[builtins.str] project_name: Project Name.
        :param pulumi.Input['AlertScheduleArgs'] schedule: Check the frequency-dependent configuration. See `schedule` below.
...
class Alert(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:sls/alert:Alert"
    ...
    def get(resource_name: str,
            ...
            project_name: Optional[pulumi.Input[builtins.str]] = None,
            schedule: Optional[pulumi.Input[Union['AlertScheduleArgs', 'AlertScheduleArgsDict']]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'Alert':
        """
