...
class CollectionPolicyArgs:
    def __init__(__self__, *,
                 data_code: pulumi.Input[builtins.str],
                 ...
                 centralize_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] data_code: Log type encoding.
        :param pulumi.Input[builtins.bool] enabled: Whether to open.
        :param pulumi.Input['CollectionPolicyPolicyConfigArgs'] policy_config: Collection rule configuration. See `policy_config` below.
        :param pulumi.Input[builtins.str] policy_name: The name of the rule, with a minimum of 3 characters and a maximum of 63 characters, must start with a letter.
        :param pulumi.Input[builtins.str] product_code: Product code.
        ...
        :param pulumi.Input[builtins.bool] centralize_enabled: Whether to enable centralized Conversion. The default value is false.
    ...
    def data_code(self) -> pulumi.Input[builtins.str]:
        """
        Log type encoding.
        """
    ...
    @data_code.setter
    def data_code(self, value: pulumi.Input[builtins.str]):
    ...
    def centralize_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def centralize_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _CollectionPolicyState:
    def __init__(__self__, *,
                 centralize_config: Optional[pulumi.Input['CollectionPolicyCentralizeConfigArgs']] = None,
                 centralize_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 data_code: Optional[pulumi.Input[builtins.str]] = None,
                 data_config: Optional[pulumi.Input['CollectionPolicyDataConfigArgs']] = None,
    ...
    @property
    @pulumi.getter(name="dataCode")
    def data_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Log type encoding.
        """
        return pulumi.get(self, "data_code")
    ...
    @data_code.setter
    def data_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_code", value)
...
class CollectionPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="centralizeEnabled")
    def centralize_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable centralized Conversion. The default value is false.
        """
        return pulumi.get(self, "centralize_enabled")
    ...
    @property
    @pulumi.getter(name="dataCode")
    def data_code(self) -> pulumi.Output[builtins.str]:
        """
        Log type encoding.
        """
        return pulumi.get(self, "data_code")
