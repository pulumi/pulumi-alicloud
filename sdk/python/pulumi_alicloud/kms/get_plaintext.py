...
class GetPlaintextResult:
    ...
    def encryption_context(self) -> Optional[Mapping[str, builtins.str]]:
...
def get_plaintext(ciphertext_blob: Optional[builtins.str] = None,
                  encryption_context: Optional[Mapping[str, builtins.str]] = None,
...
def get_plaintext_output(ciphertext_blob: Optional[pulumi.Input[builtins.str]] = None,
                         encryption_context: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
