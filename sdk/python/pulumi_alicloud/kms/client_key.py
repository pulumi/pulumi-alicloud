...
class ClientKeyArgs:
    def __init__(__self__, *,
                 aap_name: pulumi.Input[builtins.str],
                 password: pulumi.Input[builtins.str],
                 not_after: Optional[pulumi.Input[builtins.str]] = None,
                 not_before: Optional[pulumi.Input[builtins.str]] = None,
                 private_key_data_file: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ClientKey resource.
        :param pulumi.Input[builtins.str] aap_name: ClientKey's parent Application Access Point name.
        :param pulumi.Input[builtins.str] password: To enhance security, set a password for the downloaded Client Key,When an application accesses KMS, you must use the ClientKey content and this password to initialize the SDK client.
        :param pulumi.Input[builtins.str] not_after: The ClientKey expiration time. Example: "2027-08-10 T08:03:30Z".
        :param pulumi.Input[builtins.str] not_before: The valid start time of the ClientKey. Example: "2022-08-10 T08:03:30Z".
        :param pulumi.Input[builtins.str] private_key_data_file: The name of file that can save access key id and access key secret. Strongly suggest you to specified it when you creating access key, otherwise, you wouldn't get its secret ever.
        """
    ...
    def aap_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @aap_name.setter
    def aap_name(self, value: pulumi.Input[builtins.str]):
    ...
    def private_key_data_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_key_data_file(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ClientKeyState:
    def __init__(__self__, *,
                 aap_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] aap_name: ClientKey's parent Application Access Point name.
        :param pulumi.Input[builtins.str] create_time: Create timestamp, e.g. "2022-08-10T08:03:30Z".
        :param pulumi.Input[builtins.str] not_after: The ClientKey expiration time. Example: "2027-08-10 T08:03:30Z".
        :param pulumi.Input[builtins.str] not_before: The valid start time of the ClientKey. Example: "2022-08-10 T08:03:30Z".
        :param pulumi.Input[builtins.str] password: To enhance security, set a password for the downloaded Client Key,When an application accesses KMS, you must use the ClientKey content and this password to initialize the SDK client.
        :param pulumi.Input[builtins.str] private_key_data_file: The name of file that can save access key id and access key secret. Strongly suggest you to specified it when you creating access key, otherwise, you wouldn't get its secret ever.
    ...
    @property
    @pulumi.getter(name="aapName")
    def aap_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ClientKey's parent Application Access Point name.
        """
        return pulumi.get(self, "aap_name")
    ...
    @aap_name.setter
    def aap_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aap_name", value)
...
class ClientKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            not_before: Optional[pulumi.Input[builtins.str]] = None,
            password: Optional[pulumi.Input[builtins.str]] = None,
            private_key_data_file: Optional[pulumi.Input[builtins.str]] = None) -> 'ClientKey':
        """
    ...
    @property
    @pulumi.getter(name="aapName")
    def aap_name(self) -> pulumi.Output[builtins.str]:
        """
        ClientKey's parent Application Access Point name.
        """
        return pulumi.get(self, "aap_name")
    ...
    @property
    @pulumi.getter(name="privateKeyDataFile")
    def private_key_data_file(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of file that can save access key id and access key secret. Strongly suggest you to specified it when you creating access key, otherwise, you wouldn't get its secret ever.
        """
        return pulumi.get(self, "private_key_data_file")
