...
class NetworkRuleArgs:
    def __init__(__self__, *,
                 source_private_ips: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 network_rule_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a NetworkRule resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_private_ips: Allowed private network addresses.
        :param pulumi.Input[builtins.str] description: Description.
        :param pulumi.Input[builtins.str] network_rule_name: Network Rule Name.
        """
    ...
    def source_private_ips(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def source_private_ips(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def network_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Network Rule Name.
        """
    ...
    def network_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NetworkRuleState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 network_rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 source_private_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="sourcePrivateIps")
    def source_private_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Allowed private network addresses.
        """
        return pulumi.get(self, "source_private_ips")
    ...
    @source_private_ips.setter
    def source_private_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "source_private_ips", value)
...
class NetworkRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            network_rule_name: Optional[pulumi.Input[builtins.str]] = None,
            source_private_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'NetworkRule':
        """
    ...
    @property
    @pulumi.getter(name="networkRuleName")
    def network_rule_name(self) -> pulumi.Output[builtins.str]:
        """
        Network Rule Name.
        """
        return pulumi.get(self, "network_rule_name")
    ...
    @property
    @pulumi.getter(name="sourcePrivateIps")
    def source_private_ips(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Allowed private network addresses.
        """
        return pulumi.get(self, "source_private_ips")
