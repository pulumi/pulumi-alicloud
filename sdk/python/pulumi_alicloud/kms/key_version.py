...
class KeyVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_id: The id of the master key (CMK).
...
class _KeyVersionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_id: The id of the master key (CMK).
               ...
               > **NOTE:** The minimum interval for creating a Alikms key version is 7 days.
        :param pulumi.Input[builtins.str] key_version_id: The id of the Alikms key version.
        """
...
class KeyVersion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            key_id: Optional[pulumi.Input[builtins.str]] = None,
            key_version_id: Optional[pulumi.Input[builtins.str]] = None) -> 'KeyVersion':
        """
