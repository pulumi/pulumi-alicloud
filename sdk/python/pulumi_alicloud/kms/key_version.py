...
class KeyVersion(pulumi.CustomResource):
    ...
    """
    key_version_id: pulumi.Output[str]
    """
    The id of the Alikms key version.
    """
    def __init__(__self__, resource_name, opts=None, key_id=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, creation_date=None, key_id=None, key_version_id=None):
        """
