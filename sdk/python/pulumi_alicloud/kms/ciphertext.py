...
class CiphertextArgs:
    def __init__(__self__, *,
                 ...
                 encryption_context: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Ciphertext resource.
        :param pulumi.Input[builtins.str] key_id: The globally unique ID of the CMK.
        :param pulumi.Input[builtins.str] plaintext: The plaintext to be encrypted which must be encoded in Base64.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] encryption_context: The Encryption context. If you specify this parameter here, it is also required when you call the Decrypt API operation. For more information, see [Encryption Context](https://www.alibabacloud.com/help/doc-detail/42975.htm).
        """
    ...
    def encryption_context(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def encryption_context(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class _CiphertextState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ciphertext_blob: The ciphertext of the data key encrypted with the primary CMK version.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] encryption_context: The Encryption context. If you specify this parameter here, it is also required when you call the Decrypt API operation. For more information, see [Encryption Context](https://www.alibabacloud.com/help/doc-detail/42975.htm).
        :param pulumi.Input[builtins.str] key_id: The globally unique ID of the CMK.
        :param pulumi.Input[builtins.str] plaintext: The plaintext to be encrypted which must be encoded in Base64.
        """
...
class Ciphertext(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:kms/ciphertext:Ciphertext"
    ...
    @property
    @pulumi.getter(name="encryptionContext")
    def encryption_context(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        The Encryption context. If you specify this parameter here, it is also required when you call the Decrypt API operation. For more information, see [Encryption Context](https://www.alibabacloud.com/help/doc-detail/42975.htm).
        """
        return pulumi.get(self, "encryption_context")
