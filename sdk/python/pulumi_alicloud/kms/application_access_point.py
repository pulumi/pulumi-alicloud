...
class ApplicationAccessPointArgs:
    def __init__(__self__, *,
                 application_access_point_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] application_access_point_name: Application Access Point Name.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] policies: The policies that have bound to the Application Access Point (AAP).
    ...
    def application_access_point_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def application_access_point_name(self, value: pulumi.Input[builtins.str]):
...
class _ApplicationAccessPointState:
    def __init__(__self__, *,
                 application_access_point_name: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="applicationAccessPointName")
    def application_access_point_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Application Access Point Name.
        """
        return pulumi.get(self, "application_access_point_name")
    ...
    @application_access_point_name.setter
    def application_access_point_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "application_access_point_name", value)
...
class ApplicationAccessPoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            application_access_point_name: Optional[pulumi.Input[builtins.str]] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            policies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ApplicationAccessPoint':
        """
    ...
    @property
    @pulumi.getter(name="applicationAccessPointName")
    def application_access_point_name(self) -> pulumi.Output[builtins.str]:
        """
        Application Access Point Name.
        """
        return pulumi.get(self, "application_access_point_name")
