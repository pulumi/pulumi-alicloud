...
def get_keys(description_regex: Optional[builtins.str] = None,
    ...
    :param builtins.str description_regex: A regex string to filter the results by the KMS key description.
    :param builtins.bool enable_details: Default to `true`. Set it to `true` can output more details about resource attributes.
    :param builtins.str filters: The CMK filter. The filter consists of one or more key-value pairs. 
    ...
    :param Sequence[builtins.str] ids: A list of KMS key IDs.
...
def get_keys_output(description_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
