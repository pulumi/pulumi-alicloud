...
class GetSecretVersionsResult:
    ...
    def include_deprecated(self) -> Optional[builtins.str]:
...
def get_secret_versions(enable_details: Optional[builtins.bool] = None,
                        ids: Optional[Sequence[builtins.str]] = None,
                        include_deprecated: Optional[builtins.str] = None,
    ...
    :param builtins.bool enable_details: Default to false and only output `secret_name`, `version_id`, `version_stages`. Set it to true can output more details.
    :param Sequence[builtins.str] ids: A list of KMS Secret Version ids.
    :param builtins.str include_deprecated: Specifies whether to return deprecated secret versions. Default to `false`.
    ...
    :param builtins.str version_stage: The stage of the secret version.
    """
    __args__ = dict()
...
def get_secret_versions_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                               ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                               include_deprecated: Optional[pulumi.Input[Optional[builtins.str]]] = None,
