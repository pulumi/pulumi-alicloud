...
def get_ciphertext(encryption_context: Optional[Mapping[str, builtins.str]] = None,
    ...
    :param Mapping[str, builtins.str] encryption_context: The Encryption context. If you specify this parameter here, it is also required when you call the Decrypt API operation. For more information, see [Encryption Context](https://www.alibabacloud.com/help/doc-detail/42975.htm).
    :param builtins.str key_id: The globally unique ID of the CMK.
    :param builtins.str plaintext: The plaintext to be encrypted which must be encoded in Base64.
    """
    __args__ = dict()
...
def get_ciphertext_output(encryption_context: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
