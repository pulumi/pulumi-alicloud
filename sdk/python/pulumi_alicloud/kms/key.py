...
class KeyArgs:
    def __init__(__self__, *,
                 automatic_rotation: Optional[pulumi.Input[builtins.str]] = None,
                 deletion_protection: Optional[pulumi.Input[builtins.str]] = None,
                 deletion_protection_description: Optional[pulumi.Input[builtins.str]] = None,
                 deletion_window_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 dkms_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 pending_window_in_days: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] automatic_rotation: Specifies whether to enable automatic key rotation. Default value: `Disabled`. Valid values: `Enabled`, `Disabled`.
        :param pulumi.Input[builtins.str] deletion_protection: Specifies whether to enable deletion protection. Default value: `Disabled`. Valid values: `Enabled`, `Disabled`.
        :param pulumi.Input[builtins.str] deletion_protection_description: The description of deletion protection. **NOTE:** `deletion_protection_description` takes effect only if `deletion_protection` is set to `Enabled`.
        :param pulumi.Input[builtins.int] deletion_window_in_days: Field `deletion_window_in_days` has been deprecated from provider version 1.85.0. New field `pending_window_in_days` instead.
        :param pulumi.Input[builtins.str] description: The description of the key.
        :param pulumi.Input[builtins.str] dkms_instance_id: The ID of the KMS instance.
        :param pulumi.Input[builtins.bool] is_enabled: Field `is_enabled` has been deprecated from provider version 1.85.0. New field `status` instead.
        ...
        :param pulumi.Input[builtins.str] key_spec: The specification of the key. Default value: `Aliyun_AES_256`. Valid values: `Aliyun_AES_256`, `Aliyun_AES_128`, `Aliyun_AES_192`, `Aliyun_SM4`, `RSA_2048`, `RSA_3072`, `EC_P256`, `EC_P256K`, `EC_SM2`.
        :param pulumi.Input[builtins.str] key_state: Field `key_state` has been deprecated from provider version 1.123.1. New field `status` instead.
        :param pulumi.Input[builtins.str] key_usage: The usage of the key. Default value: `ENCRYPT/DECRYPT`. Valid values:
               - `ENCRYPT/DECRYPT`: Encrypts or decrypts data.
               - `SIGN/VERIFY`: Generates or verifies a digital signature.
        :param pulumi.Input[builtins.str] origin: The key material origin. Default value: `Aliyun_KMS`. Valid values: `Aliyun_KMS`, `EXTERNAL`.
        :param pulumi.Input[builtins.int] pending_window_in_days: The number of days before the CMK is deleted. During this period, the CMK is in the PendingDeletion state. After this period ends, you cannot cancel the deletion. Unit: days. Valid values: `7` to `366`. **NOTE:** From version 1.184.0, `pending_window_in_days` can be set to `366`.
        :param pulumi.Input[builtins.str] policy: The content of the key policy. The value is in the JSON format. The value can be up to 32,768 bytes in length. For more information, see [How to use it](https://www.alibabacloud.com/help/en/kms/developer-reference/api-setkeypolicy).
        :param pulumi.Input[builtins.str] protection_level: The protection level of the key. Default value: `SOFTWARE`. Valid values: `SOFTWARE`, `HSM`.
        :param pulumi.Input[builtins.str] rotation_interval: The period of automatic key rotation. The following units are supported: d (day), h (hour), m (minute), and s (second). For example, you can use either 7d or 604800s to specify a seven-day interval. **NOTE**: If `automatic_rotation` is set to `Enabled`, `rotation_interval` is required.
        :param pulumi.Input[builtins.str] status: The status of key. Default value: `Enabled`. Valid values: `Enabled`, `Disabled`, `PendingDeletion`.
    ...
    def automatic_rotation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def automatic_rotation(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def deletion_protection_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def deletion_protection_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def dkms_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dkms_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def pending_window_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def pending_window_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _KeyState:
    def __init__(__self__, *,
                 ...
                 delete_date: Optional[pulumi.Input[builtins.str]] = None,
                 deletion_protection: Optional[pulumi.Input[builtins.str]] = None,
                 deletion_protection_description: Optional[pulumi.Input[builtins.str]] = None,
                 deletion_window_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 key_state: Optional[pulumi.Input[builtins.str]] = None,
                 key_usage: Optional[pulumi.Input[builtins.str]] = None,
                 last_rotation_date: Optional[pulumi.Input[builtins.str]] = None,
                 material_expire_time: Optional[pulumi.Input[builtins.str]] = None,
                 next_rotation_date: Optional[pulumi.Input[builtins.str]] = None,
                 origin: Optional[pulumi.Input[builtins.str]] = None,
                 pending_window_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 policy: Optional[pulumi.Input[builtins.str]] = None,
                 primary_key_version: Optional[pulumi.Input[builtins.str]] = None,
                 protection_level: Optional[pulumi.Input[builtins.str]] = None,
                 rotation_interval: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the key.
        :param pulumi.Input[builtins.str] automatic_rotation: Specifies whether to enable automatic key rotation. Default value: `Disabled`. Valid values: `Enabled`, `Disabled`.
        :param pulumi.Input[builtins.str] creation_date: The time when the CMK was created.
        :param pulumi.Input[builtins.str] creator: The creator of the CMK.
        :param pulumi.Input[builtins.str] delete_date: The time at which the CMK is scheduled for deletion.
        :param pulumi.Input[builtins.str] deletion_protection: Specifies whether to enable deletion protection. Default value: `Disabled`. Valid values: `Enabled`, `Disabled`.
        :param pulumi.Input[builtins.str] deletion_protection_description: The description of deletion protection. **NOTE:** `deletion_protection_description` takes effect only if `deletion_protection` is set to `Enabled`.
        :param pulumi.Input[builtins.int] deletion_window_in_days: Field `deletion_window_in_days` has been deprecated from provider version 1.85.0. New field `pending_window_in_days` instead.
        :param pulumi.Input[builtins.str] description: The description of the key.
        ...
        :param pulumi.Input[builtins.str] key_usage: The usage of the key. Default value: `ENCRYPT/DECRYPT`. Valid values:
               - `ENCRYPT/DECRYPT`: Encrypts or decrypts data.
               - `SIGN/VERIFY`: Generates or verifies a digital signature.
        :param pulumi.Input[builtins.str] last_rotation_date: The time when the last rotation was performed.
        :param pulumi.Input[builtins.str] material_expire_time: The time when the key material expires.
        :param pulumi.Input[builtins.str] next_rotation_date: The time when the next rotation will be performed.
        :param pulumi.Input[builtins.str] origin: The key material origin. Default value: `Aliyun_KMS`. Valid values: `Aliyun_KMS`, `EXTERNAL`.
        :param pulumi.Input[builtins.int] pending_window_in_days: The number of days before the CMK is deleted. During this period, the CMK is in the PendingDeletion state. After this period ends, you cannot cancel the deletion. Unit: days. Valid values: `7` to `366`. **NOTE:** From version 1.184.0, `pending_window_in_days` can be set to `366`.
        :param pulumi.Input[builtins.str] policy: The content of the key policy. The value is in the JSON format. The value can be up to 32,768 bytes in length. For more information, see [How to use it](https://www.alibabacloud.com/help/en/kms/developer-reference/api-setkeypolicy).
        :param pulumi.Input[builtins.str] primary_key_version: The ID of the current primary key version of the symmetric CMK.
        :param pulumi.Input[builtins.str] protection_level: The protection level of the key. Default value: `SOFTWARE`. Valid values: `SOFTWARE`, `HSM`.
        :param pulumi.Input[builtins.str] rotation_interval: The period of automatic key rotation. The following units are supported: d (day), h (hour), m (minute), and s (second). For example, you can use either 7d or 604800s to specify a seven-day interval. **NOTE**: If `automatic_rotation` is set to `Enabled`, `rotation_interval` is required.
        :param pulumi.Input[builtins.str] status: The status of key. Default value: `Enabled`. Valid values: `Enabled`, `Disabled`, `PendingDeletion`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
    ...
    def delete_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @delete_date.setter
    def delete_date(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def last_rotation_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_rotation_date(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_rotation_date", value)

    @property
    @pulumi.getter(name="materialExpireTime")
    def material_expire_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def material_expire_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "material_expire_time", value)

    @property
    @pulumi.getter(name="nextRotationDate")
    def next_rotation_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def next_rotation_date(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def primary_key_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def primary_key_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Key(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rotation_interval: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Key':
        """
    ...
    @property
    @pulumi.getter(name="automaticRotation")
    def automatic_rotation(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether to enable automatic key rotation. Default value: `Disabled`. Valid values: `Enabled`, `Disabled`.
        """
        return pulumi.get(self, "automatic_rotation")
    ...
    @property
    @pulumi.getter(name="deleteDate")
    def delete_date(self) -> pulumi.Output[builtins.str]:
        """
        The time at which the CMK is scheduled for deletion.
        """
        return pulumi.get(self, "delete_date")
    ...
    @property
    @pulumi.getter(name="deletionProtectionDescription")
    def deletion_protection_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of deletion protection. **NOTE:** `deletion_protection_description` takes effect only if `deletion_protection` is set to `Enabled`.
        """
        return pulumi.get(self, "deletion_protection_description")
    ...
    @property
    @pulumi.getter(name="dkmsInstanceId")
    def dkms_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the KMS instance.
        """
        return pulumi.get(self, "dkms_instance_id")
    ...
    @property
    @pulumi.getter(name="lastRotationDate")
    def last_rotation_date(self) -> pulumi.Output[builtins.str]:
        """
        The time when the last rotation was performed.
        """
        return pulumi.get(self, "last_rotation_date")
    ...
    @property
    @pulumi.getter(name="materialExpireTime")
    def material_expire_time(self) -> pulumi.Output[builtins.str]:
        """
        The time when the key material expires.
        """
        return pulumi.get(self, "material_expire_time")
    ...
    @property
    @pulumi.getter(name="nextRotationDate")
    def next_rotation_date(self) -> pulumi.Output[builtins.str]:
        """
        The time when the next rotation will be performed.
        """
        return pulumi.get(self, "next_rotation_date")
    ...
    @property
    @pulumi.getter(name="pendingWindowInDays")
    def pending_window_in_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of days before the CMK is deleted. During this period, the CMK is in the PendingDeletion state. After this period ends, you cannot cancel the deletion. Unit: days. Valid values: `7` to `366`. **NOTE:** From version 1.184.0, `pending_window_in_days` can be set to `366`.
        """
        return pulumi.get(self, "pending_window_in_days")
    ...
    @property
    @pulumi.getter(name="primaryKeyVersion")
    def primary_key_version(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the current primary key version of the symmetric CMK.
        """
        return pulumi.get(self, "primary_key_version")
    ...
    @property
    @pulumi.getter(name="protectionLevel")
    def protection_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The protection level of the key. Default value: `SOFTWARE`. Valid values: `SOFTWARE`, `HSM`.
        """
        return pulumi.get(self, "protection_level")
