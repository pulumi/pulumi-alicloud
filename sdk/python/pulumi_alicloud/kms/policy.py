...
class PolicyArgs:
    def __init__(__self__, *,
                 access_control_rules: pulumi.Input[builtins.str],
                 kms_instance_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] access_control_rules: Network Rules in JSON struct.
        :param pulumi.Input[builtins.str] kms_instance_id: KMS instance .
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] permissions: Allowed permissions (RBAC)Optional values:"RbacPermission/Template/CryptoServiceKeyUser" and "RbacPermission/Template/CryptoServiceSecretUser".
        :param pulumi.Input[builtins.str] policy_name: Policy Name.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resources: The resources that the permission policy allows to access.Use "key/${KeyId}" or "key/*"  to specify a key or all keys.Use "secret/${SecretName}" or "secret/*" to specify a secret or all secrets.
    ...
    def access_control_rules(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def access_control_rules(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "access_control_rules", value)

    @property
    @pulumi.getter(name="kmsInstanceId")
    def kms_instance_id(self) -> pulumi.Input[builtins.str]:
        """
        KMS instance .
        """
    ...
    def kms_instance_id(self, value: pulumi.Input[builtins.str]):
...
class _PolicyState:
    def __init__(__self__, *,
                 access_control_rules: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 kms_instance_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="accessControlRules")
    def access_control_rules(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Network Rules in JSON struct.
        """
        return pulumi.get(self, "access_control_rules")
    ...
    @access_control_rules.setter
    def access_control_rules(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "access_control_rules", value)
    ...
    @property
    @pulumi.getter(name="kmsInstanceId")
    def kms_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        KMS instance .
        """
        return pulumi.get(self, "kms_instance_id")
    ...
    @kms_instance_id.setter
    def kms_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "kms_instance_id", value)
...
class Policy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            permissions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            policy_name: Optional[pulumi.Input[builtins.str]] = None,
            resources: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Policy':
        """
    ...
    @property
    @pulumi.getter(name="accessControlRules")
    def access_control_rules(self) -> pulumi.Output[builtins.str]:
        """
        Network Rules in JSON struct.
        """
        return pulumi.get(self, "access_control_rules")
    ...
    @property
    @pulumi.getter(name="kmsInstanceId")
    def kms_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        KMS instance .
        """
        return pulumi.get(self, "kms_instance_id")
