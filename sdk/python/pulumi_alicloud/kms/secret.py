...
class SecretArgs:
    def __init__(__self__, *,
                 ...
                 enable_automatic_rotation: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 secret_data_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] enable_automatic_rotation: Specifies whether to enable automatic rotation. Default value: `false`. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] encryption_key_id: The ID of the KMS key.
    ...
    def enable_automatic_rotation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_automatic_rotation(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def secret_data_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def secret_data_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SecretState:
    def __init__(__self__, *,
                 ...
                 extended_config: Optional[pulumi.Input[builtins.str]] = None,
                 force_delete_without_recovery: Optional[pulumi.Input[builtins.bool]] = None,
                 planned_delete_time: Optional[pulumi.Input[builtins.str]] = None,
                 policy: Optional[pulumi.Input[builtins.str]] = None,
                 recovery_window_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 rotation_interval: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] create_time: (Available since v1.224.0) The time when the secret is created.
        :param pulumi.Input[builtins.str] description: The description of the secret.
        :param pulumi.Input[builtins.str] dkms_instance_id: The ID of the KMS instance.
        :param pulumi.Input[builtins.bool] enable_automatic_rotation: Specifies whether to enable automatic rotation. Default value: `false`. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] encryption_key_id: The ID of the KMS key.
    ...
    def planned_delete_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def planned_delete_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Secret(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            version_id: Optional[pulumi.Input[builtins.str]] = None,
            version_stages: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Secret':
        """
    ...
    @property
    @pulumi.getter(name="enableAutomaticRotation")
    def enable_automatic_rotation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable automatic rotation. Default value: `false`. Valid values: `true`, `false`.
        """
        return pulumi.get(self, "enable_automatic_rotation")
    ...
    @property
    @pulumi.getter(name="encryptionKeyId")
    def encryption_key_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the KMS key.
        """
        return pulumi.get(self, "encryption_key_id")
    ...
    @property
    @pulumi.getter(name="extendedConfig")
    def extended_config(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The extended configuration of the secret. For more information, see [How to use it](https://www.alibabacloud.com/help/en/key-management-service/latest/kms-createsecret).
        """
        return pulumi.get(self, "extended_config")
    ...
    @property
    @pulumi.getter(name="plannedDeleteTime")
    def planned_delete_time(self) -> pulumi.Output[builtins.str]:
        """
        The time when the secret is scheduled to be deleted.
        """
        return pulumi.get(self, "planned_delete_time")
    ...
    @property
    @pulumi.getter(name="secretDataType")
    def secret_data_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of the secret value. Default value: `text`. Valid values: `text`, `binary`.
        """
        return pulumi.get(self, "secret_data_type")
