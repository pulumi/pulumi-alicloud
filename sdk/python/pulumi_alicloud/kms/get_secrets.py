...
class GetSecretsResult:
    ...
    def fetch_tags(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "fetch_tags")

    @property
    @pulumi.getter
    def filters(self) -> Optional[builtins.str]:
...
def get_secrets(enable_details: Optional[builtins.bool] = None,
                fetch_tags: Optional[builtins.bool] = None,
                filters: Optional[builtins.str] = None,
    ...
    :param builtins.bool fetch_tags: Whether to include the predetermined resource tag in the return value. Default to `false`.
    :param builtins.str filters: The secret filter. The filter consists of one or more key-value pairs. 
           More details see API [ListSecrets](https://www.alibabacloud.com/help/en/key-management-service/latest/listsecrets).
    :param Sequence[builtins.str] ids: A list of KMS Secret ids. The value is same as KMS secret_name.
    :param builtins.str name_regex: A regex string to filter the results by the KMS secret_name.
...
def get_secrets_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                       fetch_tags: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                       filters: Optional[pulumi.Input[Optional[builtins.str]]] = None,
