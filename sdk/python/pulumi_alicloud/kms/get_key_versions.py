...
def get_key_versions(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of KMS KeyVersion IDs.
...
def get_key_versions_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:kms/getKeyVersions:getKeyVersions', __args__, opts=opts, typ=GetKeyVersionsResult)
