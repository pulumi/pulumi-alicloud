...
def get_aliases(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of KMS aliases IDs. The value is same as KMS alias_name.
    :param builtins.str name_regex: A regex string to filter the results by the KMS alias name.
...
def get_aliases_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
