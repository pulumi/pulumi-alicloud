...
def get_aliases(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of KMS aliases IDs. The value is same as KMS alias_name.
    :param _builtins.str name_regex: A regex string to filter the results by the KMS alias name.
