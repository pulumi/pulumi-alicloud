...
def get_agents(agent_name: Optional[builtins.str] = None,
    ...
    :param builtins.str name_regex: A regex string to filter resulting chatbot agents by name.
...
def get_agents_output(agent_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
