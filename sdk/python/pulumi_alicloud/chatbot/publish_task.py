...
class PublishTaskArgs:
    def __init__(__self__, *,
                 biz_type: pulumi.Input[builtins.str],
                 agent_key: Optional[pulumi.Input[builtins.str]] = None,
                 data_id_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a PublishTask resource.
        :param pulumi.Input[builtins.str] biz_type: The type of the publishing unit. Please use the CreateInstancePublishTask API to publish the robot.
        :param pulumi.Input[builtins.str] agent_key: The business space key. If you do not set it, the default business space is accessed. The key value is obtained on the business management page of the primary account.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] data_id_lists: Additional release information. Currently supported: If the BizType is faq, enter the category Id in this field to indicate that only the knowledge under these categories is published.
        """
    ...
    def biz_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @biz_type.setter
    def biz_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "biz_type", value)

    @property
    @pulumi.getter(name="agentKey")
    def agent_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @agent_key.setter
    def agent_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "agent_key", value)

    @property
    @pulumi.getter(name="dataIdLists")
    def data_id_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def data_id_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _PublishTaskState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] agent_key: The business space key. If you do not set it, the default business space is accessed. The key value is obtained on the business management page of the primary account.
        :param pulumi.Input[builtins.str] biz_type: The type of the publishing unit. Please use the CreateInstancePublishTask API to publish the robot.
        :param pulumi.Input[builtins.str] create_time: UTC time of task creation
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] data_id_lists: Additional release information. Currently supported: If the BizType is faq, enter the category Id in this field to indicate that only the knowledge under these categories is published.
        :param pulumi.Input[builtins.str] modify_time: UTC time for task modification
        :param pulumi.Input[builtins.str] status: The status of the task.
        """
        if agent_key is not None:
            pulumi.set(__self__, "agent_key", agent_key)
...
class PublishTask(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            data_id_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            modify_time: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'PublishTask':
        """
    ...
    @property
    @pulumi.getter(name="agentKey")
    def agent_key(self) -> pulumi.Output[builtins.str]:
        """
        The business space key. If you do not set it, the default business space is accessed. The key value is obtained on the business management page of the primary account.
        """
        return pulumi.get(self, "agent_key")
    ...
    @property
    @pulumi.getter(name="bizType")
    def biz_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the publishing unit. Please use the CreateInstancePublishTask API to publish the robot.
        """
        return pulumi.get(self, "biz_type")
    ...
    @property
    @pulumi.getter(name="dataIdLists")
    def data_id_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Additional release information. Currently supported: If the BizType is faq, enter the category Id in this field to indicate that only the knowledge under these categories is published.
        """
        return pulumi.get(self, "data_id_lists")
