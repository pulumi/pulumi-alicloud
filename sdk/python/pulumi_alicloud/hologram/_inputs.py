...
if not MYPY:
    class InstanceEndpointArgsDict(TypedDict):
        alternative_endpoints: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InstanceEndpointArgs:
    def __init__(__self__, *,
                 alternative_endpoints: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] alternative_endpoints: Some old instances have both AnyTunnel and SingleTunnel enabled. When switching from AnyTunnel to SingleTunnel, the endpoints of both are retained. Therefore, one more field is required to store the Endpoint.
        :param pulumi.Input[builtins.bool] enabled: Whether to turn on the network.
        :param pulumi.Input[builtins.str] endpoint: Domain name.
        :param pulumi.Input[builtins.str] type: The network type.
        :param pulumi.Input[builtins.str] vpc_id: VPC primary key.
        :param pulumi.Input[builtins.str] vpc_instance_id: The vpc instance ID.
    ...
    def alternative_endpoints(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Some old instances have both AnyTunnel and SingleTunnel enabled. When switching from AnyTunnel to SingleTunnel, the endpoints of both are retained. Therefore, one more field is required to store the Endpoint.
        """
    ...
    def alternative_endpoints(self, value: Optional[pulumi.Input[builtins.str]]):
