...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 gateway_count: Optional[pulumi.Input[builtins.int]] = None,
                 initial_databases: Optional[pulumi.Input[builtins.str]] = None,
                 leader_instance_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_type: The instance type. Value:
               - Standard: Universal.
        ...
        :param pulumi.Input[builtins.str] zone_id: The zone Id. Refer to "Instructions for Use".
        :param pulumi.Input[builtins.bool] auto_pay: Whether to pay automatically. The default value is true. Value:
        ...
        :param pulumi.Input[builtins.int] cold_storage_size: Instance low-frequency storage space. Unit: GB.
               > **NOTE:**  PayAsYouGo (PostPaid) instances ignore this parameter.
        :param pulumi.Input[builtins.int] cpu: Instance specifications. Value:
        ...
        :param pulumi.Input[builtins.int] duration: The buying cycle. Buy for 2 months. If the Payment type is PayAsYouGo (PostPaid), you do not need to specify it.
        :param pulumi.Input[Sequence[pulumi.Input['InstanceEndpointArgs']]] endpoints: List of domain names. See `endpoints` below.
        :param pulumi.Input[builtins.int] gateway_count: Number of gateway nodes.
        :param pulumi.Input[builtins.str] initial_databases: Initialize the database and split multiple database names ",".
        :param pulumi.Input[builtins.str] leader_instance_id: The ID of the primary instance.
        :param pulumi.Input[builtins.str] pricing_cycle: Billing cycle. Value:
        ...
        :param pulumi.Input[builtins.str] scale_type: Change matching type. Value:
               - UPGRADE: UPGRADE
        ...
        :param pulumi.Input[builtins.int] storage_size: The standard storage space of the instance. Unit: GB.
               > **NOTE:**  PayAsYouGo instances (PostPaid) ignore this parameter.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Instance tag.
        """
    ...
    def gateway_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def gateway_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "gateway_count", value)

    @property
    @pulumi.getter(name="initialDatabases")
    def initial_databases(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def initial_databases(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "initial_databases", value)

    @property
    @pulumi.getter(name="leaderInstanceId")
    def leader_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def leader_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Instance(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:hologram/instance:Instance"
    ...
    @property
    @pulumi.getter(name="gatewayCount")
    def gateway_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of gateway nodes.
        """
        return pulumi.get(self, "gateway_count")
    ...
    @property
    @pulumi.getter(name="initialDatabases")
    def initial_databases(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Initialize the database and split multiple database names ",".
        """
        return pulumi.get(self, "initial_databases")
    ...
    @property
    @pulumi.getter(name="leaderInstanceId")
    def leader_instance_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the primary instance.
        """
        return pulumi.get(self, "leader_instance_id")
    ...
    @property
    @pulumi.getter(name="scaleType")
    def scale_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Change matching type. Value:
        - UPGRADE: UPGRADE
        - DOWNGRADE: Downgrading
    ...
    @property
    @pulumi.getter(name="storageSize")
    def storage_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The standard storage space of the instance. Unit: GB.
        > **NOTE:**  PayAsYouGo instances (PostPaid) ignore this parameter.
        """
