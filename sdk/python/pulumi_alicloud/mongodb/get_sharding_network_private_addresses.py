...
def get_sharding_network_private_addresses(db_instance_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str role: The role of the node. Valid values: `Primary` or `Secondary`.
    """
    __args__ = dict()
