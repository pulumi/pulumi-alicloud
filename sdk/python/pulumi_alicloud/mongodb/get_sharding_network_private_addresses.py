...
def get_sharding_network_private_addresses(db_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str role: The role of the node. Valid values: `Primary` or `Secondary`.
    """
    __args__ = dict()
...
def get_sharding_network_private_addresses_output(db_instance_id: Optional[pulumi.Input[builtins.str]] = None,
