...
class _PrivateSrvNetworkAddressState:
    def __init__(__self__, *,
                 ...
                 private_srv_connection_string_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering PrivateSrvNetworkAddress resources.
        :param pulumi.Input[builtins.str] db_instance_id: The instance ID.
        :param pulumi.Input[builtins.str] private_srv_connection_string_uri: Private network SRV highly available connection address
        """
    ...
    def private_srv_connection_string_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_srv_connection_string_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PrivateSrvNetworkAddress(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            db_instance_id: Optional[pulumi.Input[builtins.str]] = None,
            private_srv_connection_string_uri: Optional[pulumi.Input[builtins.str]] = None) -> 'PrivateSrvNetworkAddress':
        """
    ...
    @property
    @pulumi.getter(name="privateSrvConnectionStringUri")
    def private_srv_connection_string_uri(self) -> pulumi.Output[builtins.str]:
        """
        Private network SRV highly available connection address
        """
        return pulumi.get(self, "private_srv_connection_string_uri")
