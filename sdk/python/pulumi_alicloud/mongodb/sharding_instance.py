...
class ShardingInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] network_type: The network type of the instance. Valid values:`Classic` or `VPC`.
        ...
        :param pulumi.Input[builtins.str] tde_status: The TDE(Transparent Data Encryption) status. It can be updated from version 1.160.0.
        ...
        :param pulumi.Input[builtins.str] zone_id: The Zone to launch the DB instance. MongoDB Sharding Instance does not support multiple-zone.
...
class ShardingInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ShardingInstance':
        """
