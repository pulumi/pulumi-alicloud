...
class InstanceReplicaSetArgs:
    ...
    def vpc_cloud_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ServerlessInstanceSecurityIpGroupArgsDict(TypedDict):
        ...
        """
        security_ip_group_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The name of the IP whitelist.
        """
        security_ip_list: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServerlessInstanceSecurityIpGroupArgs:
    def __init__(__self__, *,
                 ...
                 security_ip_list: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] security_ip_group_attribute: The attribute of the IP whitelist. This parameter is empty by default.
        :param pulumi.Input[builtins.str] security_ip_group_name: The name of the IP whitelist.
        :param pulumi.Input[builtins.str] security_ip_list: The IP addresses in the whitelist.
        """
    ...
    def security_ip_list(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IP addresses in the whitelist.
        """
    ...
    def security_ip_list(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "security_ip_list", value)


if not MYPY:
    class ShardingInstanceConfigServerListArgsDict(TypedDict):
        connect_string: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        node_class: NotRequired[pulumi.Input[builtins.str]]
        """
        The instance type of the ConfigServer node. Valid values: `mdb.shard.2x.xlarge.d`, `dds.cs.mid`.
        """
        node_description: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        node_storage: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ShardingInstanceConfigServerListArgs:
    def __init__(__self__, *,
                 connect_string: Optional[pulumi.Input[builtins.str]] = None,
                 max_connections: Optional[pulumi.Input[builtins.int]] = None,
                 max_iops: Optional[pulumi.Input[builtins.int]] = None,
                 node_class: Optional[pulumi.Input[builtins.str]] = None,
                 node_description: Optional[pulumi.Input[builtins.str]] = None,
                 node_id: Optional[pulumi.Input[builtins.str]] = None,
                 node_storage: Optional[pulumi.Input[builtins.int]] = None,
                 port: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] connect_string: The connection address of the Config Server node.
        :param pulumi.Input[builtins.int] max_connections: The max connections of the Config Server node.
        :param pulumi.Input[builtins.int] max_iops: The maximum IOPS of the Config Server node.
        :param pulumi.Input[builtins.str] node_class: The instance type of the ConfigServer node. Valid values: `mdb.shard.2x.xlarge.d`, `dds.cs.mid`.
        :param pulumi.Input[builtins.str] node_description: The description of the Config Server node.
        :param pulumi.Input[builtins.str] node_id: The ID of the Config Server node.
        :param pulumi.Input[builtins.int] node_storage: The storage space of the ConfigServer node.
        :param pulumi.Input[builtins.int] port: The connection port of the Config Server node.
        """
    ...
    def connect_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The connection address of the Config Server node.
        """
    ...
    def connect_string(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def node_class(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The instance type of the ConfigServer node. Valid values: `mdb.shard.2x.xlarge.d`, `dds.cs.mid`.
        """
    ...
    @node_class.setter
    def node_class(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "node_class", value)

    @property
    @pulumi.getter(name="nodeDescription")
    def node_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The description of the Config Server node.
        """
    ...
    def node_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def node_storage(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The storage space of the ConfigServer node.
        """
    ...
    @node_storage.setter
    def node_storage(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ShardingInstanceMongoListArgsDict(TypedDict):
        node_class: pulumi.Input[builtins.str]
        """
...
class ShardingInstanceMongoListArgs:
    def __init__(__self__, *,
                 ...
                 port: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] node_class: The instance type of the mongo node. see [Instance specifications](https://www.alibabacloud.com/help/doc-detail/57141.htm).
        :param pulumi.Input[builtins.str] connect_string: The connection address of the Config Server node.
        :param pulumi.Input[builtins.str] node_id: The ID of the Config Server node.
        :param pulumi.Input[builtins.int] port: The connection port of the Config Server node.
        """
    ...
    @property
    @pulumi.getter(name="nodeClass")
    def node_class(self) -> pulumi.Input[builtins.str]:
        """
        The instance type of the mongo node. see [Instance specifications](https://www.alibabacloud.com/help/doc-detail/57141.htm).
        """
        return pulumi.get(self, "node_class")
    ...
    @node_class.setter
    def node_class(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "node_class", value)
...
if not MYPY:
    class ShardingInstanceShardListArgsDict(TypedDict):
        ...
        """
        node_storage: pulumi.Input[builtins.int]
        """
        ...
        The ID of the Config Server node.
        """
        readonly_replicas: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ShardingInstanceShardListArgs:
    def __init__(__self__, *,
                 ...
                 node_storage: pulumi.Input[builtins.int],
                 node_id: Optional[pulumi.Input[builtins.str]] = None,
                 readonly_replicas: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] node_class: The instance type of the shard node. see [Instance specifications](https://www.alibabacloud.com/help/doc-detail/57141.htm).
        :param pulumi.Input[builtins.int] node_storage: The storage space of the shard node.
               - Custom storage space; value range: [10, 1,000]
               - 10-GB increments. Unit: GB.
        :param pulumi.Input[builtins.str] node_id: The ID of the Config Server node.
        :param pulumi.Input[builtins.int] readonly_replicas: The number of read-only nodes in shard node Default value: `0`. Valid values: `0` to `5`.
        """
        pulumi.set(__self__, "node_class", node_class)
        pulumi.set(__self__, "node_storage", node_storage)
        if node_id is not None:
    ...
    @property
    @pulumi.getter(name="nodeStorage")
    def node_storage(self) -> pulumi.Input[builtins.int]:
        """
        The storage space of the shard node.
        - Custom storage space; value range: [10, 1,000]
        - 10-GB increments. Unit: GB.
    ...
    @node_storage.setter
    def node_storage(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "node_storage", value)
    ...
    def readonly_replicas(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of read-only nodes in shard node Default value: `0`. Valid values: `0` to `5`.
        """
    ...
    def readonly_replicas(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "readonly_replicas", value)


if not MYPY:
    class ShardingNetworkPrivateAddressNetworkAddressArgsDict(TypedDict):
        expired_time: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        network_address: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ShardingNetworkPrivateAddressNetworkAddressArgs:
    def __init__(__self__, *,
                 ...
                 vswitch_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] expired_time: The remaining duration of the classic network endpoint.
        :param pulumi.Input[builtins.str] ip_address: The IP address of the instance.
        :param pulumi.Input[builtins.str] network_address: The connection string of the instance.
        :param pulumi.Input[builtins.str] network_type: The network type of the instance.
        :param pulumi.Input[builtins.str] node_id: The ID of the Shard node or ConfigServer node.
        :param pulumi.Input[builtins.str] node_type: The type of the node.
        :param pulumi.Input[builtins.str] port: The port that is used to connect to the instance.
        :param pulumi.Input[builtins.str] role: The role of the node.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the vSwitch in the VPC.
        """
...
class ShardingNetworkPublicAddressNetworkAddressArgs:
    def __init__(__self__, *,
                 ...
                 vswitch_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] expired_time: The remaining duration of the classic network address. Unit: `seconds`.
        :param pulumi.Input[builtins.str] ip_address: The IP address of the instance.
        :param pulumi.Input[builtins.str] network_address: The endpoint of the instance.
        :param pulumi.Input[builtins.str] network_type: The network type.
        :param pulumi.Input[builtins.str] node_id: The ID of the `mongos`, `shard`, or `Configserver` node in the sharded cluster instance.
        :param pulumi.Input[builtins.str] node_type: The type of the node.
        :param pulumi.Input[builtins.str] port: The port number.
        :param pulumi.Input[builtins.str] role: The role of the node.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC.
        :param pulumi.Input[builtins.str] vswitch_id: The vSwitch ID of the VPC.
        """
        if expired_time is not None:
            pulumi.set(__self__, "expired_time", expired_time)
        if ip_address is not None:
