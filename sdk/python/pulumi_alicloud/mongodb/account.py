...
class AccountArgs:
    def __init__(__self__, *,
                 ...
                 character_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Account resource.
        :param pulumi.Input[builtins.str] account_name: The new password.
               
               - The password must contain at least three of the following character types: uppercase letters, lowercase letters, digits, and special characters. Special characters include `! # $ % ^ & * ( ) _ + - =`
               - The password must be 8 to 32 characters in length.
        :param pulumi.Input[builtins.str] account_password: The password of the database account. The password must be 8 to 32 characters in length. It can contain at least three types of the following characters: uppercase letters, lowercase letters, digits, and special characters. Special characters include ! # $ % ^ & \\* ( ) \\_ + - =
        :param pulumi.Input[builtins.str] instance_id: The account whose password needs to be reset. Set the value to `root`.
        :param pulumi.Input[builtins.str] account_description: Account comment information.
        ...
        :param pulumi.Input[builtins.str] character_type: The role type of the instance. Value description
    ...
    def character_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def character_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] character_type: The role type of the instance. Value description
               ...
               - When the instance type is a replica set, charactertype can be null or pass in normal.
        :param pulumi.Input[builtins.str] instance_id: The account whose password needs to be reset. Set the value to `root`.
        :param pulumi.Input[builtins.str] status: Account Status
        """
        if account_description is not None:
            pulumi.set(__self__, "account_description", account_description)
...
class Account(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:mongodb/account:Account"
    ...
    @property
    @pulumi.getter(name="characterType")
    def character_type(self) -> pulumi.Output[builtins.str]:
        """
        The role type of the instance. Value description
