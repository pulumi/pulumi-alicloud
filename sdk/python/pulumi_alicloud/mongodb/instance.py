...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 encryptor_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] backup_retention_period: The retention period of full backups.
        ...
        :param pulumi.Input[builtins.int] log_backup_retention_period: The number of days for which log backups are retained. Valid values: `7` to `730`. **NOTE:** `log_backup_retention_period` is valid only when `enable_backup_log` is set to `1`.
        :param pulumi.Input[builtins.str] maintain_end_time: The end time of the operation and maintenance time period of the instance, in the format of HH:mmZ (UTC time).
        :param pulumi.Input[builtins.str] maintain_start_time: The start time of the operation and maintenance time period of the instance, in the format of HH:mmZ (UTC time).
        :param pulumi.Input[builtins.str] name: The name of DB instance. It must be 2 to 256 characters in length.
        :param pulumi.Input[builtins.str] network_type: The network type of the instance. Valid values:`Classic`, `VPC`.
        :param pulumi.Input[builtins.str] order_type: The type of configuration changes performed. Default value: `DOWNGRADE`. Valid values:
        ...
        :param pulumi.Input[builtins.int] period: The duration that you will buy DB instance (in month). It is valid when `instance_charge_type` is `PrePaid`. Default value: `1`. Valid values: [1~9], 12, 24, 36.
        :param pulumi.Input[builtins.int] provisioned_iops: The provisioned IOPS. Valid values: `0` to `50000`.
        :param pulumi.Input[builtins.int] readonly_replicas: The number of read-only nodes in the replica set instance. Default value: 0. Valid values: 0 to 5.
    ...
    def backup_retention_policy_on_cluster_deletion(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def backup_retention_policy_on_cluster_deletion(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def cloud_disk_encryption_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def encryptor_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def encryptor_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] provisioned_iops: The provisioned IOPS. Valid values: `0` to `50000`.
        :param pulumi.Input[builtins.int] readonly_replicas: The number of read-only nodes in the replica set instance. Default value: 0. Valid values: 0 to 5.
        :param pulumi.Input[builtins.str] replica_set_name: The name of the mongo replica set.
        ...
        :param pulumi.Input[builtins.str] ssl_action: Actions performed on SSL functions. Valid values:
               ...
               - `Close`: turn off SSL encryption.
               - `Update`: update SSL certificate.
        :param pulumi.Input[builtins.str] ssl_status: Status of the SSL feature.
        :param pulumi.Input[builtins.str] storage_engine: The storage engine of the instance. Default value: `WiredTiger`. Valid values: `WiredTiger`, `RocksDB`.
        :param pulumi.Input[builtins.str] storage_type: The storage type of the instance. Valid values: `cloud_essd1`, `cloud_essd2`, `cloud_essd3`, `cloud_auto`, `local_ssd`. **NOTE:** From version 1.229.0, `storage_type` can be modified. However, `storage_type` can only be modified to `cloud_auto`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] tde_status: The TDE(Transparent Data Encryption) status. Valid values: `enabled`.
...
class Instance(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:mongodb/instance:Instance"
    ...
    @property
    @pulumi.getter(name="backupRetentionPolicyOnClusterDeletion")
    def backup_retention_policy_on_cluster_deletion(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The backup retention policy configured for the instance. Valid values:
        """
        return pulumi.get(self, "backup_retention_policy_on_cluster_deletion")
    ...
    @property
    @pulumi.getter(name="cloudDiskEncryptionKey")
    def cloud_disk_encryption_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the encryption key.
        """
        return pulumi.get(self, "cloud_disk_encryption_key")
    ...
    @property
    @pulumi.getter(name="encryptorName")
    def encryptor_name(self) -> pulumi.Output[builtins.str]:
        """
        The encryption method. **NOTE:** `encryptor_name` is valid only when `tde_status` is set to `enabled`.
        """
        return pulumi.get(self, "encryptor_name")
    ...
    @property
    @pulumi.getter(name="readonlyReplicas")
    def readonly_replicas(self) -> pulumi.Output[builtins.int]:
        """
        The number of read-only nodes in the replica set instance. Default value: 0. Valid values: 0 to 5.
        """
        return pulumi.get(self, "readonly_replicas")
    ...
    @property
    @pulumi.getter(name="sslAction")
    def ssl_action(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Actions performed on SSL functions. Valid values:
        - `Open`: turn on SSL encryption.
        - `Close`: turn off SSL encryption.
