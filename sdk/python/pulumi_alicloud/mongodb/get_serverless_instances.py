...
def get_serverless_instances_output(db_instance_class: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                    db_instance_description: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
