...
class GetServerlessInstancesResult:
    ...
    def db_instance_description(self) -> Optional[builtins.str]:
...
def get_serverless_instances(db_instance_class: Optional[builtins.str] = None,
                             db_instance_description: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Serverless Instance IDs.
    :param builtins.str network_type: The network type of the instance. Valid values: `Classic` or `VPC`.
    ...
    :param builtins.str status: The instance status. Valid values: `Creating`, `DBInstanceClassChanging`, `DBInstanceNetTypeChanging`, `Deleting`, `EngineVersionUpgrading`, `GuardSwitching`, `HASwitching`, `Importing`, `ImportingFromOthers`, `LinkSwitching`, `MinorVersionUpgrading`, `NodeCreating`, `NodeDeleting`, `Rebooting`, `Restoring`, `Running`, `SSLModifying`, `TDEModifying`, `TempDBInstanceCreating`, `Transing`, `TransingToOthers`, `released`.
...
def get_serverless_instances_output(db_instance_class: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    db_instance_description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
