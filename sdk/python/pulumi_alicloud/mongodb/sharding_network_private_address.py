...
class ShardingNetworkPrivateAddressArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] db_instance_id: The ID of the sharded cluster instance.
        ...
        :param pulumi.Input[builtins.str] account_name: The username of the account.
               - The name must be 4 to 16 characters in length and can contain lowercase letters, digits, and underscores (_). It must start with a lowercase letter.
               - You need to set the account name and password only when you apply for an endpoint for a shard or ConfigServer node for the first time. In this case, the account name and password are used for all shard and ConfigServer nodes.
               - The permissions of this account are fixed to read-only.
        :param pulumi.Input[builtins.str] account_password: The password for the account.
...
@pulumi.type_token("alicloud:mongodb/shardingNetworkPrivateAddress:ShardingNetworkPrivateAddress")
class ShardingNetworkPrivateAddress(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            node_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ShardingNetworkPrivateAddress':
        """
