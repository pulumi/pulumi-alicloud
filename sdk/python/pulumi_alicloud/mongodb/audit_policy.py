...
class AuditPolicyArgs:
    def __init__(__self__, *,
                 audit_status: pulumi.Input[builtins.str],
                 db_instance_id: pulumi.Input[builtins.str],
                 storage_period: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a AuditPolicy resource.
        :param pulumi.Input[builtins.str] audit_status: The status of the audit log. Valid values: `disabled`, `enable`.
        :param pulumi.Input[builtins.str] db_instance_id: The ID of the instance.
        :param pulumi.Input[builtins.int] storage_period: The retention period of audit logs. Valid values: `1` to `30`. Default value: `30`.
        """
    ...
    def audit_status(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @audit_status.setter
    def audit_status(self, value: pulumi.Input[builtins.str]):
    ...
    def storage_period(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def storage_period(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _AuditPolicyState:
    def __init__(__self__, *,
                 audit_status: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="auditStatus")
    def audit_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The status of the audit log. Valid values: `disabled`, `enable`.
        """
        return pulumi.get(self, "audit_status")
    ...
    @audit_status.setter
    def audit_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "audit_status", value)
...
class AuditPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            audit_status: Optional[pulumi.Input[builtins.str]] = None,
            db_instance_id: Optional[pulumi.Input[builtins.str]] = None,
            storage_period: Optional[pulumi.Input[builtins.int]] = None) -> 'AuditPolicy':
        """
    ...
    @property
    @pulumi.getter(name="auditStatus")
    def audit_status(self) -> pulumi.Output[builtins.str]:
        """
        The status of the audit log. Valid values: `disabled`, `enable`.
        """
        return pulumi.get(self, "audit_status")
    ...
    @property
    @pulumi.getter(name="storagePeriod")
    def storage_period(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The retention period of audit logs. Valid values: `1` to `30`. Default value: `30`.
        """
        return pulumi.get(self, "storage_period")
