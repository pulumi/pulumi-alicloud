...
def get_sharding_network_public_addresses(db_instance_id: Optional[_builtins.str] = None,
...
def get_sharding_network_public_addresses_output(db_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
