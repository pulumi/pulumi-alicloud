...
class ServerlessInstanceArgs:
    def __init__(__self__, *,
                 ...
                 capacity_unit: pulumi.Input[builtins.int],
                 ...
                 period_price_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] account_password: The password of the database logon account.
        ...
        :param pulumi.Input[builtins.int] capacity_unit: The I/O throughput consumed by the instance. Valid values: `100` to `8000`.
        :param pulumi.Input[builtins.int] db_instance_storage: The db instance storage. Valid values: `1` to `100`.
        :param pulumi.Input[builtins.str] engine_version: The database version number. Valid values: `4.2`.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC network.
        :param pulumi.Input[builtins.str] vswitch_id: The of the vswitch.
        :param pulumi.Input[builtins.str] zone_id: The ID of the zone. Use this parameter to specify the zone created by the instance.
        :param pulumi.Input[builtins.bool] auto_renew: Set whether the instance is automatically renewed.
        :param pulumi.Input[builtins.str] db_instance_description: The db instance description.
        :param pulumi.Input[builtins.str] engine: The database engine of the instance. Valid values: `MongoDB`.
        :param pulumi.Input[builtins.str] maintain_end_time: The end time of the maintenance window. Specify the time in the `HH:mmZ` format. The time must be in UTC. **NOTE:** The difference between the start time and end time must be one hour. For example, if `maintain_start_time` is `01:00Z`, `maintain_end_time` must be `02:00Z`.
        :param pulumi.Input[builtins.str] maintain_start_time: The start time of the maintenance window. Specify the time in the `HH:mmZ` format. The time must be in UTC.
        :param pulumi.Input[builtins.int] period: The purchase duration of the instance, in months. Valid values: `1` to `9`, `12`, `24`, `36`, `60`.
        :param pulumi.Input[builtins.str] period_price_type: The period price type. Valid values: `Day`, `Month`.
        ...
        :param pulumi.Input[builtins.str] storage_engine: The storage engine used by the instance. Valid values: `WiredTiger`.
    ...
    def capacity_unit(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def capacity_unit(self, value: pulumi.Input[builtins.int]):
    ...
    def period_price_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def period_price_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ServerlessInstanceState:
    def __init__(__self__, *,
                 ...
                 auto_renew: Optional[pulumi.Input[builtins.bool]] = None,
                 capacity_unit: Optional[pulumi.Input[builtins.int]] = None,
                 db_instance_description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[Sequence[pulumi.Input['ServerlessInstanceSecurityIpGroupArgs']]] security_ip_groups: An array that consists of the information of IP whitelists.
        :param pulumi.Input[builtins.str] status: The instance status. For more information, see the instance Status Table.
        :param pulumi.Input[builtins.str] storage_engine: The storage engine used by the instance. Valid values: `WiredTiger`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC network.
        :param pulumi.Input[builtins.str] vswitch_id: The of the vswitch.
    ...
    @property
    @pulumi.getter(name="capacityUnit")
    def capacity_unit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The I/O throughput consumed by the instance. Valid values: `100` to `8000`.
        """
        return pulumi.get(self, "capacity_unit")
    ...
    @capacity_unit.setter
    def capacity_unit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "capacity_unit", value)
...
class ServerlessInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ServerlessInstance':
        """
    ...
    @property
    @pulumi.getter(name="capacityUnit")
    def capacity_unit(self) -> pulumi.Output[builtins.int]:
        """
        The I/O throughput consumed by the instance. Valid values: `100` to `8000`.
        """
        return pulumi.get(self, "capacity_unit")
    ...
    @property
    @pulumi.getter(name="periodPriceType")
    def period_price_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The period price type. Valid values: `Day`, `Month`.
        """
        return pulumi.get(self, "period_price_type")
