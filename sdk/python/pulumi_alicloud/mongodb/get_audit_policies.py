...
def get_audit_policies(db_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str db_instance_id: The id of the db instance.
...
def get_audit_policies_output(db_instance_id: Optional[pulumi.Input[builtins.str]] = None,
