...
def get_audit_policies(db_instance_id: Optional[_builtins.str] = None,
...
def get_audit_policies_output(db_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
