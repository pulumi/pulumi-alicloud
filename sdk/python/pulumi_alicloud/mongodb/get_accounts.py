...
def get_accounts(account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str account_name: The name of the account. Valid values: `root`.
...
def get_accounts_output(account_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
