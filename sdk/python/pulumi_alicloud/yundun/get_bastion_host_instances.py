...
def get_bastion_host_instances(description_regex: Optional[_builtins.str] = None,
...
def get_bastion_host_instances_output(description_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
