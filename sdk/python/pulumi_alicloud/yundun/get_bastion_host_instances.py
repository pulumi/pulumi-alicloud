...
def get_bastion_host_instances(description_regex: Optional[builtins.str] = None,
...
def get_bastion_host_instances_output(description_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
