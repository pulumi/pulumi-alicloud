...
class DBAuditInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] plan_code: Plan code of the Cloud DBAudit to produce. (alpha.professional, alpha.basic, alpha.premium)
        :param pulumi.Input[_builtins.str] vswitch_id: vSwtich ID configured to audit
        :param pulumi.Input[_builtins.str] resource_group_id: The Id of resource group which the DBaudit Instance belongs. If not set, the resource is created in the default resource group.
...
class DBAuditInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_id: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            vswitch_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'DBAuditInstance':
        """
