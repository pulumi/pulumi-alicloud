...
def get_db_audit_instance(description_regex: Optional[_builtins.str] = None,
...
def get_db_audit_instance_output(description_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
