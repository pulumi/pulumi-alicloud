...
def get_db_audit_instance(description_regex: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:yundun/getDBAuditInstance:getDBAuditInstance', __args__, opts=opts, typ=GetDBAuditInstanceResult).value
...
def get_db_audit_instance_output(description_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 ...
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDBAuditInstanceResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
