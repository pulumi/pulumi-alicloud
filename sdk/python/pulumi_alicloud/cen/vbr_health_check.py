...
class VbrHealthCheckArgs:
    def __init__(__self__, *,
                 ...
                 health_check_target_ip: pulumi.Input[builtins.str],
                 vbr_instance_id: pulumi.Input[builtins.str],
                 vbr_instance_region_id: pulumi.Input[builtins.str],
                 ...
                 vbr_instance_owner_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] health_check_target_ip: The destination IP address of health checks.
        :param pulumi.Input[builtins.str] vbr_instance_id: The ID of the VBR.
        :param pulumi.Input[builtins.str] vbr_instance_region_id: The ID of the region to which the VBR belongs.
               
               ->**NOTE:** The `cen.VbrHealthCheck` resource depends on the related `cen.InstanceAttachment` resource.
        :param pulumi.Input[builtins.int] health_check_interval: Specifies the interval at which the health check sends continuous detection packets. Default value: 2. Value range: 2 to 3.
        :param pulumi.Input[builtins.str] health_check_source_ip: The source IP address of health checks.
        :param pulumi.Input[builtins.int] healthy_threshold: Specifies the number of probe messages sent by the health check. Default value: 8. Value range: 3 to 8.
        :param pulumi.Input[builtins.int] vbr_instance_owner_id: The ID of the account to which the VBR belongs.
        """
    ...
    def health_check_target_ip(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def health_check_target_ip(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "health_check_target_ip", value)

    @property
    @pulumi.getter(name="vbrInstanceId")
    def vbr_instance_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the VBR.
        """
    ...
    def vbr_instance_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "vbr_instance_id", value)

    @property
    @pulumi.getter(name="vbrInstanceRegionId")
    def vbr_instance_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vbr_instance_region_id(self, value: pulumi.Input[builtins.str]):
    ...
    def vbr_instance_owner_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def vbr_instance_owner_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _VbrHealthCheckState:
    def __init__(__self__, *,
                 ...
                 healthy_threshold: Optional[pulumi.Input[builtins.int]] = None,
                 vbr_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 vbr_instance_owner_id: Optional[pulumi.Input[builtins.int]] = None,
                 vbr_instance_region_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="vbrInstanceId")
    def vbr_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the VBR.
        """
        return pulumi.get(self, "vbr_instance_id")
    ...
    @vbr_instance_id.setter
    def vbr_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vbr_instance_id", value)
    ...
    @property
    @pulumi.getter(name="vbrInstanceRegionId")
    def vbr_instance_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the region to which the VBR belongs.
    ...
    @vbr_instance_region_id.setter
    def vbr_instance_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vbr_instance_region_id", value)
...
class VbrHealthCheck(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vbr_instance_id: Optional[pulumi.Input[builtins.str]] = None,
            vbr_instance_owner_id: Optional[pulumi.Input[builtins.int]] = None,
            vbr_instance_region_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VbrHealthCheck':
        """
    ...
    @property
    @pulumi.getter(name="healthCheckSourceIp")
    def health_check_source_ip(self) -> pulumi.Output[builtins.str]:
        """
        The source IP address of health checks.
        """
        return pulumi.get(self, "health_check_source_ip")
    ...
    @property
    @pulumi.getter(name="healthCheckTargetIp")
    def health_check_target_ip(self) -> pulumi.Output[builtins.str]:
        """
        The destination IP address of health checks.
        """
        return pulumi.get(self, "health_check_target_ip")
    ...
    @property
    @pulumi.getter(name="vbrInstanceId")
    def vbr_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the VBR.
        """
        return pulumi.get(self, "vbr_instance_id")
    ...
    @property
    @pulumi.getter(name="vbrInstanceOwnerId")
    def vbr_instance_owner_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The ID of the account to which the VBR belongs.
        """
        return pulumi.get(self, "vbr_instance_owner_id")
    ...
    @property
    @pulumi.getter(name="vbrInstanceRegionId")
    def vbr_instance_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the region to which the VBR belongs.
