...
class GetTransitRoutersResult:
    ...
    def transit_router_ids(self) -> Optional[Sequence[builtins.str]]:
...
def get_transit_routers(cen_id: Optional[builtins.str] = None,
                        ...
                        transit_router_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of resource id. The element value is same as <cen_id>:<transit_router_id>`.
    :param builtins.str name_regex: A regex string to filter CEN Transit Routers by name.
    ...
    :param Sequence[builtins.str] transit_router_ids: A list of ID of the transit router.
    """
    __args__ = dict()
...
def get_transit_routers_output(cen_id: Optional[pulumi.Input[builtins.str]] = None,
                               ...
                               transit_router_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
