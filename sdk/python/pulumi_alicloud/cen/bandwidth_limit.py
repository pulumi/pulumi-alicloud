...
class BandwidthLimitArgs:
    def __init__(__self__, *,
                 bandwidth_limit: pulumi.Input[builtins.int],
                 instance_id: pulumi.Input[builtins.str],
                 region_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
    ...
    def bandwidth_limit(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def bandwidth_limit(self, value: pulumi.Input[builtins.int]):
    ...
    def region_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @region_ids.setter
    def region_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _BandwidthLimitState:
    def __init__(__self__, *,
                 bandwidth_limit: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="bandwidthLimit")
    def bandwidth_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The bandwidth configured for the interconnected regions communication.
    ...
    @bandwidth_limit.setter
    def bandwidth_limit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "bandwidth_limit", value)
...
class BandwidthLimit(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            bandwidth_limit: Optional[pulumi.Input[builtins.int]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            region_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'BandwidthLimit':
        """
    ...
    @property
    @pulumi.getter(name="bandwidthLimit")
    def bandwidth_limit(self) -> pulumi.Output[builtins.int]:
        """
        The bandwidth configured for the interconnected regions communication.
    ...
    @property
    @pulumi.getter(name="regionIds")
    def region_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of the two regions to interconnect. Must be two different regions.
        """
        return pulumi.get(self, "region_ids")
