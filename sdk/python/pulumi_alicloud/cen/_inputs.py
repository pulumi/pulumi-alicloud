...
class TrafficMarkingPolicyTrafficMatchRuleArgs:
    def __init__(__self__, *,
                 ...
                 dst_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 match_dscp: Optional[pulumi.Input[builtins.int]] = None,
                 protocol: Optional[pulumi.Input[builtins.str]] = None,
                 src_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 src_port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
    ...
    def dst_port_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
    ...
    def src_port_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
    ...
    def traffic_match_rule_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def traffic_match_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "traffic_match_rule_name", value)


if not MYPY:
    class TransitRouterMulticastDomainOptionsArgsDict(TypedDict):
        igmpv2_support: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TransitRouterMulticastDomainOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] igmpv2_support: Whether to enable IGMP function for multicast domain. Default value: `disable`. Valid values: `enable`, `disable`.
        """
...
class TransitRouterVpcAttachmentZoneMappingArgs:
    def __init__(__self__, *,
                 ...
                 zone_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the vSwitch that you want to add to the VPC connection.  You can specify at most 10 vSwitches in each call.
               - If the VPC connection belongs to the current Alibaba Cloud account, you can call the [DescribeVSwitches](https://www.alibabacloud.com/help/en/doc-detail/35748.html) operation to query the IDs of the vSwitches and zones of the VPC.
               - If the VPC connection belongs to another Alibaba Cloud account, you can call the [ListGrantVSwitchesToCen](https://www.alibabacloud.com/help/en/doc-detail/427599.html) operation to query the IDs of the vSwitches and zones of the VPC.
        :param pulumi.Input[builtins.str] zone_id: The ID of the zone that supports Enterprise Edition transit routers.  You can call the [DescribeZones](https://www.alibabacloud.com/help/en/doc-detail/36064.html) operation to query the most recent zone list.  You can specify at most 10 zones in each call.
        """
...
class TransitRouterVpnAttachmentZoneArgs:
    def __init__(__self__, *,
                 zone_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] zone_id: The zone ID of the read-only instance.
               You can call the [ListTransitRouterAvailableResource](https://www.alibabacloud.com/help/en/doc-detail/261356.html) operation to query the most recent zone list.
        """
        pulumi.set(__self__, "zone_id", zone_id)
