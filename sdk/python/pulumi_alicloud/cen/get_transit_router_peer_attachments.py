...
def get_transit_router_peer_attachments(cen_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name_regex: A regex string to filter CEN Transit Router peer attachments by name.
