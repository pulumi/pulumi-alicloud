...
class PrivateZoneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_region_id: The ID of the region where PrivateZone is accessed. This region refers to the region in which PrivateZone is accessed by clients.
        :param pulumi.Input[builtins.str] cen_id: The ID of the CEN instance.
        :param pulumi.Input[builtins.str] host_region_id: The ID of the region where PrivateZone is deployed.
               
               ->**NOTE:** The resource `cen.PrivateZone` depends on the resource `cen.InstanceAttachment`.
        :param pulumi.Input[builtins.str] host_vpc_id: The ID of the VPC that is associated with PrivateZone.
        """
...
class _PrivateZoneState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] host_region_id: The ID of the region where PrivateZone is deployed.
               ...
               ->**NOTE:** The resource `cen.PrivateZone` depends on the resource `cen.InstanceAttachment`.
        :param pulumi.Input[builtins.str] host_vpc_id: The ID of the VPC that is associated with PrivateZone.
        :param pulumi.Input[builtins.str] status: The status of the Private Zone.
        """
...
class PrivateZone(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            host_region_id: Optional[pulumi.Input[builtins.str]] = None,
            host_vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'PrivateZone':
        """
