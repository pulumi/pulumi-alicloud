...
class GetRouteMapsResult:
    ...
    def cen_region_id(self) -> Optional[builtins.str]:
        """
    ...
    def description_regex(self) -> Optional[builtins.str]:
    ...
    def transmit_direction(self) -> Optional[builtins.str]:
        """
...
def get_route_maps(cen_id: Optional[builtins.str] = None,
                   cen_region_id: Optional[builtins.str] = None,
                   description_regex: Optional[builtins.str] = None,
                   ids: Optional[Sequence[builtins.str]] = None,
                   output_file: Optional[builtins.str] = None,
                   status: Optional[builtins.str] = None,
                   transmit_direction: Optional[builtins.str] = None,
    ...
    :param builtins.str description_regex: A regex string to filter CEN route map by description.
    :param Sequence[builtins.str] ids: A list of CEN route map IDs. Each item formats as `<cen_id>:<route_map_id>`.
...
def get_route_maps_output(cen_id: Optional[pulumi.Input[builtins.str]] = None,
                          cen_region_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          description_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          ...
                          transmit_direction: Optional[pulumi.Input[Optional[builtins.str]]] = None,
