...
class TransitRouterGrantAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cen_id: The ID of the Cloud Enterprise Network (CEN) instance to which the transit router belongs.
        :param pulumi.Input[builtins.str] cen_owner_id: The ID of the Alibaba Cloud account to which the CEN instance belongs.
        :param pulumi.Input[builtins.str] instance_id: The ID of the network instance.
        :param pulumi.Input[builtins.str] instance_type: The type of the network instance. Valid values: `VPC`, `ExpressConnect`, `VPN`.
        :param pulumi.Input[builtins.str] order_type: The entity that pays the fees of the network instance. Valid values: `PayByResourceOwner`, `PayByCenOwner`.
        """
...
class TransitRouterGrantAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            instance_type: Optional[pulumi.Input[builtins.str]] = None,
            order_type: Optional[pulumi.Input[builtins.str]] = None) -> 'TransitRouterGrantAttachment':
        """
