...
class TransitRouterMulticastDomainMemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_ip_address: The IP address of the multicast group to which the multicast member belongs. If the multicast group you specified does not exist in the current multicast domain, the system will automatically create a new multicast group for you in the current multicast domain.
        :param pulumi.Input[builtins.str] network_interface_id: The ID of the ENI.
        ...
        :param pulumi.Input[builtins.str] vpc_id: The VPC to which the ENI of the multicast member belongs. This field is mandatory for VPCs owned by another accounts.
        """
...
class _TransitRouterMulticastDomainMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_ip_address: The IP address of the multicast group to which the multicast member belongs. If the multicast group you specified does not exist in the current multicast domain, the system will automatically create a new multicast group for you in the current multicast domain.
        :param pulumi.Input[builtins.str] network_interface_id: The ID of the ENI.
        :param pulumi.Input[builtins.str] status: The status of the Transit Router Multicast Domain Member.
        :param pulumi.Input[builtins.str] transit_router_multicast_domain_id: The ID of the multicast domain to which the multicast member belongs.
        :param pulumi.Input[builtins.str] vpc_id: The VPC to which the ENI of the multicast member belongs. This field is mandatory for VPCs owned by another accounts.
        """
        if dry_run is not None:
...
class TransitRouterMulticastDomainMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_multicast_domain_id: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TransitRouterMulticastDomainMember':
        """
