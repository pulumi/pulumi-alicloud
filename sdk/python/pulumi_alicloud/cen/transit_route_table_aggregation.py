...
class TransitRouteTableAggregationArgs:
    def __init__(__self__, *,
                 ...
                 transit_route_table_aggregation_scope: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] transit_route_table_aggregation_cidr: The destination CIDR block of the aggregate route. CIDR blocks that start with `0` or `100.64`. Multicast CIDR blocks, including `224.0.0.1` to `239.255.255.254`.
        :param pulumi.Input[builtins.str] transit_route_table_aggregation_scope: The scope of networks that you want to advertise the aggregate route. Valid Value: `VPC`.
        :param pulumi.Input[builtins.str] transit_route_table_id: The ID of the route table of the Enterprise Edition transit router.
        :param pulumi.Input[builtins.str] transit_route_table_aggregation_description: The description of the aggregate route.
    ...
    def transit_route_table_aggregation_scope(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def transit_route_table_aggregation_scope(self, value: pulumi.Input[builtins.str]):
...
class _TransitRouteTableAggregationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] status: The status of the Transit Route Table Aggregation.
        :param pulumi.Input[builtins.str] transit_route_table_aggregation_cidr: The destination CIDR block of the aggregate route. CIDR blocks that start with `0` or `100.64`. Multicast CIDR blocks, including `224.0.0.1` to `239.255.255.254`.
        :param pulumi.Input[builtins.str] transit_route_table_aggregation_description: The description of the aggregate route.
        :param pulumi.Input[builtins.str] transit_route_table_aggregation_name: The name of the aggregate route.
        :param pulumi.Input[builtins.str] transit_route_table_aggregation_scope: The scope of networks that you want to advertise the aggregate route. Valid Value: `VPC`.
...
class TransitRouteTableAggregation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="transitRouteTableAggregationScope")
    def transit_route_table_aggregation_scope(self) -> pulumi.Output[builtins.str]:
        """
        The scope of networks that you want to advertise the aggregate route. Valid Value: `VPC`.
        """
        return pulumi.get(self, "transit_route_table_aggregation_scope")
