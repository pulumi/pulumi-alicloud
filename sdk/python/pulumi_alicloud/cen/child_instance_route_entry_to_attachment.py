...
class ChildInstanceRouteEntryToAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] dry_run: Whether to perform pre-check on this request, including permission and instance status verification.
        """
    ...
    def child_instance_route_table_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def child_instance_route_table_id(self, value: pulumi.Input[_builtins.str]):
...
class _ChildInstanceRouteEntryToAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] destination_cidr_block: DestinationCidrBlock
        :param pulumi.Input[_builtins.bool] dry_run: Whether to perform pre-check on this request, including permission and instance status verification.
        :param pulumi.Input[_builtins.str] service_type: ServiceType
...
class ChildInstanceRouteEntryToAttachment(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="childInstanceRouteTableId")
    def child_instance_route_table_id(self) -> pulumi.Output[_builtins.str]:
        """
        The first ID of the resource
        """
        return pulumi.get(self, "child_instance_route_table_id")
