...
class TransitRouterPrefixListAssociationArgs:
    def __init__(__self__, *,
                 ...
                 transit_router_table_id: pulumi.Input[builtins.str],
                 next_hop_type: Optional[pulumi.Input[builtins.str]] = None,
                 owner_uid: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a TransitRouterPrefixListAssociation resource.
        :param pulumi.Input[builtins.str] next_hop: The ID of the next hop. **NOTE:** If `next_hop` is set to `BlackHole`, you must set this parameter to `BlackHole`.
        ...
        :param pulumi.Input[builtins.str] transit_router_table_id: The ID of the route table of the transit router.
        :param pulumi.Input[builtins.str] next_hop_type: The type of the next hop. Valid values:
        ...
        :param pulumi.Input[builtins.int] owner_uid: The ID of the Alibaba Cloud account to which the prefix list belongs.
        """
    ...
    def transit_router_table_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def transit_router_table_id(self, value: pulumi.Input[builtins.str]):
    ...
    def owner_uid(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @owner_uid.setter
    def owner_uid(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _TransitRouterPrefixListAssociationState:
    def __init__(__self__, *,
                 ...
                 transit_router_table_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] owner_uid: The ID of the Alibaba Cloud account to which the prefix list belongs.
        :param pulumi.Input[builtins.str] prefix_list_id: The ID of the prefix list.
        :param pulumi.Input[builtins.str] status: The status of the prefix list.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the transit router.
        :param pulumi.Input[builtins.str] transit_router_table_id: The ID of the route table of the transit router.
        """
    ...
    @property
    @pulumi.getter(name="transitRouterTableId")
    def transit_router_table_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the route table of the transit router.
        """
        return pulumi.get(self, "transit_router_table_id")
    ...
    @transit_router_table_id.setter
    def transit_router_table_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transit_router_table_id", value)
...
class TransitRouterPrefixListAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_id: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_table_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TransitRouterPrefixListAssociation':
        """
    ...
    @property
    @pulumi.getter(name="ownerUid")
    def owner_uid(self) -> pulumi.Output[builtins.int]:
        """
        The ID of the Alibaba Cloud account to which the prefix list belongs.
        """
        return pulumi.get(self, "owner_uid")
    ...
    @property
    @pulumi.getter(name="transitRouterTableId")
    def transit_router_table_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the route table of the transit router.
        """
        return pulumi.get(self, "transit_router_table_id")
