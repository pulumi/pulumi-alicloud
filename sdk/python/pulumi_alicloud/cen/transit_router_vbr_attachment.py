...
class TransitRouterVbrAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 vbr_id: pulumi.Input[builtins.str],
                 ...
                 route_table_association_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 route_table_propagation_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 transit_router_attachment_description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cen_id: The ID of the CEN.
        :param pulumi.Input[builtins.str] vbr_id: The ID of the VBR.
        :param pulumi.Input[builtins.bool] auto_publish_route_enabled: Specifies whether to enable the Enterprise Edition transit router to automatically advertise routes to the VBR. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to perform a dry run. Default value: `false`. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.str] resource_type: The resource type of the transit router vbr attachment. Default value: `VBR`. Valid values: `VBR`.
        :param pulumi.Input[builtins.bool] route_table_association_enabled: Whether to enabled route table association. **NOTE:** "Field `route_table_association_enabled` has been deprecated from provider version 1.233.1. Please use the resource `cen.TransitRouterRouteTableAssociation` instead, how to use alicloud_cen_transit_router_route_table_association."
        :param pulumi.Input[builtins.bool] route_table_propagation_enabled: Whether to enabled route table propagation. **NOTE:** "Field `route_table_propagation_enabled` has been deprecated from provider version 1.233.1. Please use the resource `cen.TransitRouterRouteTablePropagation` instead, how to use alicloud_cen_transit_router_route_table_propagation."
               
               ->**NOTE:** Ensure that the vbr is not used in Express Connect.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] transit_router_attachment_description: The description of the transit router vbr attachment.
        :param pulumi.Input[builtins.str] transit_router_attachment_name: The name of the transit router vbr attachment.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the transit router.
        :param pulumi.Input[builtins.str] vbr_owner_id: The owner id of the vbr.
        """
    ...
    def vbr_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the VBR.
        """
    ...
    @vbr_id.setter
    def vbr_id(self, value: pulumi.Input[builtins.str]):
    ...
    def route_table_association_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def route_table_association_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def route_table_propagation_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def route_table_propagation_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def transit_router_attachment_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def transit_router_attachment_description(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TransitRouterVbrAttachmentState:
    def __init__(__self__, *,
                 ...
                 transit_router_attachment_name: Optional[pulumi.Input[builtins.str]] = None,
                 transit_router_id: Optional[pulumi.Input[builtins.str]] = None,
                 vbr_id: Optional[pulumi.Input[builtins.str]] = None,
                 vbr_owner_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] route_table_propagation_enabled: Whether to enabled route table propagation. **NOTE:** "Field `route_table_propagation_enabled` has been deprecated from provider version 1.233.1. Please use the resource `cen.TransitRouterRouteTablePropagation` instead, how to use alicloud_cen_transit_router_route_table_propagation."
               ...
               ->**NOTE:** Ensure that the vbr is not used in Express Connect.
        :param pulumi.Input[builtins.str] status: The status of the Transit Router VBR Attachment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] transit_router_attachment_description: The description of the transit router vbr attachment.
        :param pulumi.Input[builtins.str] transit_router_attachment_id: The ID of the VBR connection.
        :param pulumi.Input[builtins.str] transit_router_attachment_name: The name of the transit router vbr attachment.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the transit router.
        :param pulumi.Input[builtins.str] vbr_id: The ID of the VBR.
        :param pulumi.Input[builtins.str] vbr_owner_id: The owner id of the vbr.
    ...
    @property
    @pulumi.getter(name="vbrId")
    def vbr_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the VBR.
        """
        return pulumi.get(self, "vbr_id")
    ...
    @vbr_id.setter
    def vbr_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vbr_id", value)
...
class TransitRouterVbrAttachment(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:cen/transitRouterVbrAttachment:TransitRouterVbrAttachment"
    ...
    def get(resource_name: str,
            ...
            transit_router_id: Optional[pulumi.Input[builtins.str]] = None,
            vbr_id: Optional[pulumi.Input[builtins.str]] = None,
            vbr_owner_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TransitRouterVbrAttachment':
        """
    ...
    @property
    @pulumi.getter(name="autoPublishRouteEnabled")
    def auto_publish_route_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable the Enterprise Edition transit router to automatically advertise routes to the VBR. Default value: `false`. Valid values:
        """
        return pulumi.get(self, "auto_publish_route_enabled")
    ...
    @pulumi.getter(name="routeTableAssociationEnabled")
    @_utilities.deprecated("""Field `route_table_association_enabled` has been deprecated from provider version 1.233.1. Please use the resource `cen.TransitRouterRouteTableAssociation` instead.""")
    def route_table_association_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enabled route table association. **NOTE:** "Field `route_table_association_enabled` has been deprecated from provider version 1.233.1. Please use the resource `cen.TransitRouterRouteTableAssociation` instead, how to use alicloud_cen_transit_router_route_table_association."
        """
        return pulumi.get(self, "route_table_association_enabled")
    ...
    @pulumi.getter(name="routeTablePropagationEnabled")
    @_utilities.deprecated("""Field `route_table_propagation_enabled` has been deprecated from provider version 1.233.1. Please use the resource `cen.TransitRouterRouteTablePropagation` instead.""")
    def route_table_propagation_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enabled route table propagation. **NOTE:** "Field `route_table_propagation_enabled` has been deprecated from provider version 1.233.1. Please use the resource `cen.TransitRouterRouteTablePropagation` instead, how to use alicloud_cen_transit_router_route_table_propagation."
    ...
    @property
    @pulumi.getter(name="transitRouterAttachmentDescription")
    def transit_router_attachment_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the transit router vbr attachment.
        """
        return pulumi.get(self, "transit_router_attachment_description")
    ...
    @property
    @pulumi.getter(name="transitRouterAttachmentName")
    def transit_router_attachment_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the transit router vbr attachment.
        """
        return pulumi.get(self, "transit_router_attachment_name")
    ...
    @property
    @pulumi.getter(name="vbrId")
    def vbr_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the VBR.
        """
        return pulumi.get(self, "vbr_id")
    ...
    @property
    @pulumi.getter(name="vbrOwnerId")
    def vbr_owner_id(self) -> pulumi.Output[builtins.str]:
        """
        The owner id of the vbr.
        """
        return pulumi.get(self, "vbr_owner_id")
