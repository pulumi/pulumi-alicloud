...
class GetTransitRouteTableAggregationsResult:
    ...
    def transit_route_table_aggregation_cidr(self) -> Optional[builtins.str]:
        """
...
def get_transit_route_table_aggregations(ids: Optional[Sequence[builtins.str]] = None,
                                         name_regex: Optional[builtins.str] = None,
                                         output_file: Optional[builtins.str] = None,
                                         status: Optional[builtins.str] = None,
                                         transit_route_table_aggregation_cidr: Optional[builtins.str] = None,
                                         transit_route_table_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Transit Route Table Aggregation IDs.
    :param builtins.str name_regex: A regex string to filter results by Transit Route Table Aggregation name.
...
def get_transit_route_table_aggregations_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                ...
                                                transit_route_table_aggregation_cidr: Optional[pulumi.Input[Optional[builtins.str]]] = None,
