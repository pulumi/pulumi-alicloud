...
class GetTransitRouteTableAggregationsResult:
    ...
    def transit_route_table_aggregation_cidr(self) -> Optional[str]:
        """
...
def get_transit_route_table_aggregations_output(ids: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
