...
def get_inter_region_traffic_qos_policies(ids: Optional[Sequence[_builtins.str]] = None,
                                          name_regex: Optional[_builtins.str] = None,
                                          output_file: Optional[_builtins.str] = None,
                                          status: Optional[_builtins.str] = None,
                                          traffic_qos_policy_description: Optional[_builtins.str] = None,
                                          traffic_qos_policy_id: Optional[_builtins.str] = None,
                                          traffic_qos_policy_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Inter Region Traffic Qos Policy IDs.
    :param _builtins.str name_regex: A regex string to filter results by Inter Region Traffic Qos Policy name.
    ...
    :param _builtins.str traffic_qos_policy_description: The description of the QoS policy.
    :param _builtins.str traffic_qos_policy_id: The ID of the QoS policy.
    :param _builtins.str traffic_qos_policy_name: The name of the QoS policy.
...
def get_inter_region_traffic_qos_policies_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                                 name_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                 output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                 status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                 traffic_qos_policy_description: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                 traffic_qos_policy_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                 traffic_qos_policy_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
