...
def get_transit_router_service(enable: Optional[builtins.str] = None,
...
def get_transit_router_service_output(enable: Optional[pulumi.Input[Optional[builtins.str]]] = None,
