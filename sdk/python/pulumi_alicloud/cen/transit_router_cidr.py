...
class TransitRouterCidrArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cidr: The new CIDR block of the transit router.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the transit router.
        :param pulumi.Input[builtins.str] description: The new description of the transit router CIDR block.
               The description must be 1 to 256 characters in length, and cannot start with http:// or https://. You can also leave this parameter empty.
        :param pulumi.Input[builtins.bool] publish_cidr_route: Specifies whether to allow the system to automatically add a route that points to the CIDR block to the route table of the transit router.
        :param pulumi.Input[builtins.str] transit_router_cidr_name: The new name of the transit router CIDR block.
...
class _TransitRouterCidrState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The new description of the transit router CIDR block.
               The description must be 1 to 256 characters in length, and cannot start with http:// or https://. You can also leave this parameter empty.
        :param pulumi.Input[builtins.bool] publish_cidr_route: Specifies whether to allow the system to automatically add a route that points to the CIDR block to the route table of the transit router.
        :param pulumi.Input[builtins.str] transit_router_cidr_id: The ID of the CIDR block.
        :param pulumi.Input[builtins.str] transit_router_cidr_name: The new name of the transit router CIDR block.
               The name must be 1 to 128 characters in length, and cannot start with http:// or https://. You can also leave this parameter empty.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the transit router.
        """
...
@pulumi.type_token("alicloud:cen/transitRouterCidr:TransitRouterCidr")
class TransitRouterCidr(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="publishCidrRoute")
    def publish_cidr_route(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to allow the system to automatically add a route that points to the CIDR block to the route table of the transit router.
        """
        return pulumi.get(self, "publish_cidr_route")
