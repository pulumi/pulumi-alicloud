...
class TransitRouterCidrArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] publish_cidr_route: Specifies whether to allow the system to automatically add a route that points to the CIDR block to the route table of the transit router.
        :param pulumi.Input[_builtins.str] transit_router_cidr_name: The new name of the transit router CIDR block.
...
class _TransitRouterCidrState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: The new description of the transit router CIDR block.
               The description must be 1 to 256 characters in length, and cannot start with http:// or https://. You can also leave this parameter empty.
        :param pulumi.Input[_builtins.bool] publish_cidr_route: Specifies whether to allow the system to automatically add a route that points to the CIDR block to the route table of the transit router.
        :param pulumi.Input[_builtins.str] transit_router_cidr_id: The ID of the CIDR block.
        :param pulumi.Input[_builtins.str] transit_router_cidr_name: The new name of the transit router CIDR block.
               The name must be 1 to 128 characters in length, and cannot start with http:// or https://. You can also leave this parameter empty.
        :param pulumi.Input[_builtins.str] transit_router_id: The ID of the transit router.
        """
...
class TransitRouterCidr(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="transitRouterCidrId")
    def transit_router_cidr_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the CIDR block.
        """
        return pulumi.get(self, "transit_router_cidr_id")
    ...
    @_builtins.property
    @pulumi.getter(name="transitRouterCidrName")
    def transit_router_cidr_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The new name of the transit router CIDR block.
        The name must be 1 to 128 characters in length, and cannot start with http:// or https://. You can also leave this parameter empty.
        """
