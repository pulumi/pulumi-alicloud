...
class TransitRouterCidrArgs:
    def __init__(__self__, *,
                 ...
                 publish_cidr_route: Optional[pulumi.Input[builtins.bool]] = None,
                 transit_router_cidr_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a TransitRouterCidr resource.
        :param pulumi.Input[builtins.str] cidr: The cidr of the transit router.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the transit router.
        :param pulumi.Input[builtins.str] description: The description of the transit router. The description must be `2` to `256` characters in length, and it must start with English letters, but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.bool] publish_cidr_route: Whether to allow automatically adding Transit Router Cidr in Transit Router Route Table. Valid values: `true` and `false`. Default value: `true`.
        :param pulumi.Input[builtins.str] transit_router_cidr_name: The name of the transit router. The name must be `2` to `128` characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter but cannot start with `http://` or `https://`.
        """
    ...
    def publish_cidr_route(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def publish_cidr_route(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "publish_cidr_route", value)

    @property
    @pulumi.getter(name="transitRouterCidrName")
    def transit_router_cidr_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def transit_router_cidr_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TransitRouterCidrState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 publish_cidr_route: Optional[pulumi.Input[builtins.bool]] = None,
                 transit_router_cidr_id: Optional[pulumi.Input[builtins.str]] = None,
                 transit_router_cidr_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The description of the transit router. The description must be `2` to `256` characters in length, and it must start with English letters, but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.bool] publish_cidr_route: Whether to allow automatically adding Transit Router Cidr in Transit Router Route Table. Valid values: `true` and `false`. Default value: `true`.
        :param pulumi.Input[builtins.str] transit_router_cidr_id: The ID of the transit router cidr.
        :param pulumi.Input[builtins.str] transit_router_cidr_name: The name of the transit router. The name must be `2` to `128` characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the transit router.
        """
        if cidr is not None:
    ...
    def transit_router_cidr_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def transit_router_cidr_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TransitRouterCidr(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            transit_router_cidr_id: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_cidr_name: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TransitRouterCidr':
        """
    ...
    @property
    @pulumi.getter(name="publishCidrRoute")
    def publish_cidr_route(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to allow automatically adding Transit Router Cidr in Transit Router Route Table. Valid values: `true` and `false`. Default value: `true`.
        """
        return pulumi.get(self, "publish_cidr_route")
    ...
    @property
    @pulumi.getter(name="transitRouterCidrId")
    def transit_router_cidr_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the transit router cidr.
        """
        return pulumi.get(self, "transit_router_cidr_id")
    ...
    @property
    @pulumi.getter(name="transitRouterCidrName")
    def transit_router_cidr_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the transit router. The name must be `2` to `128` characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter but cannot start with `http://` or `https://`.
        """
        return pulumi.get(self, "transit_router_cidr_name")
