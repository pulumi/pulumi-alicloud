...
class GetTransitRouterRouteEntriesResult:
    ...
    def transit_router_route_entry_ids(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "transit_router_route_entry_ids")

    @property
    @pulumi.getter(name="transitRouterRouteEntryNames")
    def transit_router_route_entry_names(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "transit_router_route_entry_names")

    @property
    @pulumi.getter(name="transitRouterRouteEntryStatus")
    def transit_router_route_entry_status(self) -> Optional[builtins.str]:
        """
...
def get_transit_router_route_entries(ids: Optional[Sequence[builtins.str]] = None,
                                     name_regex: Optional[builtins.str] = None,
                                     output_file: Optional[builtins.str] = None,
                                     status: Optional[builtins.str] = None,
                                     transit_router_route_entry_ids: Optional[Sequence[builtins.str]] = None,
                                     transit_router_route_entry_names: Optional[Sequence[builtins.str]] = None,
                                     transit_router_route_entry_status: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of CEN Transit Router Route Entry IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param Sequence[builtins.str] transit_router_route_entry_ids: A list of ID of the cen transit router route entry.
    :param Sequence[builtins.str] transit_router_route_entry_names: A list of name of the cen transit router route entry.
    :param builtins.str transit_router_route_entry_status: The status of the resource.Valid values `Creating`, `Active` and `Deleting`.
    :param builtins.str transit_router_route_table_id: ID of the CEN Transit Router Route Table.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_transit_router_route_entries_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                            ...
                                            transit_router_route_entry_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                            transit_router_route_entry_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                            transit_router_route_entry_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
