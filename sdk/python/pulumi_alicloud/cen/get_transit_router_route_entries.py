...
class GetTransitRouterRouteEntriesResult:
    ...
    def transit_router_route_entry_ids(self) -> Optional[Sequence[_builtins.str]]:
        return pulumi.get(self, "transit_router_route_entry_ids")

    @_builtins.property
    @pulumi.getter(name="transitRouterRouteEntryNames")
    def transit_router_route_entry_names(self) -> Optional[Sequence[_builtins.str]]:
        return pulumi.get(self, "transit_router_route_entry_names")

    @_builtins.property
    @pulumi.getter(name="transitRouterRouteEntryStatus")
    def transit_router_route_entry_status(self) -> Optional[_builtins.str]:
        """
...
def get_transit_router_route_entries(ids: Optional[Sequence[_builtins.str]] = None,
                                     name_regex: Optional[_builtins.str] = None,
                                     output_file: Optional[_builtins.str] = None,
                                     status: Optional[_builtins.str] = None,
                                     transit_router_route_entry_ids: Optional[Sequence[_builtins.str]] = None,
                                     transit_router_route_entry_names: Optional[Sequence[_builtins.str]] = None,
                                     transit_router_route_entry_status: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of CEN Transit Router Route Entry IDs.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param Sequence[_builtins.str] transit_router_route_entry_ids: A list of ID of the cen transit router route entry.
    :param Sequence[_builtins.str] transit_router_route_entry_names: A list of name of the cen transit router route entry.
    :param _builtins.str transit_router_route_entry_status: The status of the resource.Valid values `Creating`, `Active` and `Deleting`.
    :param _builtins.str transit_router_route_table_id: ID of the CEN Transit Router Route Table.
    """
    __args__ = dict()
    __args__['ids'] = ids
