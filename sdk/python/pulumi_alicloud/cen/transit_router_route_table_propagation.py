...
class TransitRouterRouteTablePropagationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] transit_router_attachment_id: The ID the transit router attachment.
...
class _TransitRouterRouteTablePropagationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] dry_run: The dry run.
               ...
               > **NOTE:** The Zone of CEN has MasterZone and SlaveZone, first zone_id of zone_mapping need be MasterZone. We have a API to describeZones[API](https://help.aliyun.com/document_detail/261356.html)
        :param pulumi.Input[builtins.str] status: The associating status of the network.
        :param pulumi.Input[builtins.str] transit_router_attachment_id: The ID the transit router attachment.
        :param pulumi.Input[builtins.str] transit_router_route_table_id: The ID of the transit router route table.
        """
        if dry_run is not None:
...
@pulumi.type_token("alicloud:cen/transitRouterRouteTablePropagation:TransitRouterRouteTablePropagation")
class TransitRouterRouteTablePropagation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_attachment_id: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_route_table_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TransitRouterRouteTablePropagation':
        """
