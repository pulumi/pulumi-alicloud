...
class RouteServiceArgs:
    def __init__(__self__, *,
                 access_region_id: pulumi.Input[builtins.str],
                 cen_id: pulumi.Input[builtins.str],
                 host: pulumi.Input[builtins.str],
                 host_region_id: pulumi.Input[builtins.str],
                 host_vpc_id: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RouteService resource.
        :param pulumi.Input[builtins.str] access_region_id: The region of the network instances that access the cloud services.
        :param pulumi.Input[builtins.str] cen_id: The ID of the CEN instance.
        :param pulumi.Input[builtins.str] host: The domain name or IP address of the cloud service.
        :param pulumi.Input[builtins.str] host_region_id: The region of the cloud service.
        :param pulumi.Input[builtins.str] host_vpc_id: The VPC associated with the cloud service.
               
               > **NOTE:** The values of `host_region_id` and `access_region_id` must be consistent.
        :param pulumi.Input[builtins.str] description: The description of the cloud service.
        """
    ...
    def access_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def access_region_id(self, value: pulumi.Input[builtins.str]):
    ...
    def host_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def host_region_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "host_region_id", value)

    @property
    @pulumi.getter(name="hostVpcId")
    def host_vpc_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @host_vpc_id.setter
    def host_vpc_id(self, value: pulumi.Input[builtins.str]):
...
class _RouteServiceState:
    def __init__(__self__, *,
                 access_region_id: Optional[pulumi.Input[builtins.str]] = None,
                 cen_id: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 host: Optional[pulumi.Input[builtins.str]] = None,
                 host_region_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] host_vpc_id: The VPC associated with the cloud service.
               ...
               > **NOTE:** The values of `host_region_id` and `access_region_id` must be consistent.
        :param pulumi.Input[builtins.str] status: The status of the cloud service.
        """
    ...
    @property
    @pulumi.getter(name="accessRegionId")
    def access_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The region of the network instances that access the cloud services.
        """
        return pulumi.get(self, "access_region_id")
    ...
    @access_region_id.setter
    def access_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "access_region_id", value)
    ...
    @property
    @pulumi.getter(name="hostRegionId")
    def host_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The region of the cloud service.
        """
        return pulumi.get(self, "host_region_id")
    ...
    @host_region_id.setter
    def host_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "host_region_id", value)
...
class RouteService(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:cen/routeService:RouteService"
    ...
    def get(resource_name: str,
            ...
            host_region_id: Optional[pulumi.Input[builtins.str]] = None,
            host_vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'RouteService':
        """
    ...
    @property
    @pulumi.getter(name="accessRegionId")
    def access_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The region of the network instances that access the cloud services.
        """
        return pulumi.get(self, "access_region_id")
    ...
    @property
    @pulumi.getter(name="hostRegionId")
    def host_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The region of the cloud service.
        """
        return pulumi.get(self, "host_region_id")
