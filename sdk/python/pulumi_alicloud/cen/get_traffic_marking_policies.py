...
def get_traffic_marking_policies(description: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Traffic Marking Policy IDs.
    :param builtins.str name_regex: A regex string to filter results by Traffic Marking Policy name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the resource.  Valid values: `Active`, `Creating`, `Deleting`, `Updating`.
...
def get_traffic_marking_policies_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
