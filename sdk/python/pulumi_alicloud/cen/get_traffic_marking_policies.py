...
def get_traffic_marking_policies(description: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Traffic Marking Policy IDs.
    :param _builtins.str name_regex: A regex string to filter results by Traffic Marking Policy name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str status: The status of the resource.  Valid values: `Active`, `Creating`, `Deleting`, `Updating`.
