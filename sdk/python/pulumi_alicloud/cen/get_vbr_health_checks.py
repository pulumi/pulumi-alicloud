...
class GetVbrHealthChecksResult:
    ...
    def vbr_instance_id(self) -> Optional[builtins.str]:
        """
    ...
    def vbr_instance_owner_id(self) -> Optional[builtins.int]:
...
def get_vbr_health_checks(cen_id: Optional[builtins.str] = None,
                          output_file: Optional[builtins.str] = None,
                          vbr_instance_id: Optional[builtins.str] = None,
                          vbr_instance_owner_id: Optional[builtins.int] = None,
                          vbr_instance_region_id: Optional[builtins.str] = None,
    ...
    :param builtins.int vbr_instance_owner_id: The User ID (UID) of the account to which the VBR instance belongs.
...
def get_vbr_health_checks_output(cen_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 vbr_instance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 vbr_instance_owner_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
