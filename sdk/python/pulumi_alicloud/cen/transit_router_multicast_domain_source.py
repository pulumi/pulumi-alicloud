...
class TransitRouterMulticastDomainSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_ip_address: The IP address of the multicast group to which the multicast source belongs. Value range: **224.0.0.1** to **239.255.255.254**. If the multicast group you specified does not exist in the current multicast domain, the system will automatically create a new multicast group for you.
        :param pulumi.Input[builtins.str] network_interface_id: ENI ID of the multicast source.
        :param pulumi.Input[builtins.str] transit_router_multicast_domain_id: The ID of the multicast domain to which the multicast source belongs.
        :param pulumi.Input[builtins.str] vpc_id: The VPC to which the ENI of the multicast source belongs. This field is mandatory for VPCs that is owned by another accounts.
        """
...
class TransitRouterMulticastDomainSource(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:cen/transitRouterMulticastDomainSource:TransitRouterMulticastDomainSource"
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_multicast_domain_id: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TransitRouterMulticastDomainSource':
        """
