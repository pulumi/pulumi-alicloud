...
def get_transit_router_multicast_domain_associations(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Transit Router Multicast Domain Association IDs.
...
def get_transit_router_multicast_domain_associations_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
