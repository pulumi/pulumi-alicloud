...
class InterRegionTrafficQosQueueArgs:
    def __init__(__self__, *,
                 dscps: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 remain_bandwidth_percent: pulumi.Input[builtins.int],
                 traffic_qos_policy_id: pulumi.Input[builtins.str],
                 inter_region_traffic_qos_queue_description: Optional[pulumi.Input[builtins.str]] = None,
                 inter_region_traffic_qos_queue_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a InterRegionTrafficQosQueue resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dscps: The DSCP value of the traffic packet to be matched in the current queue, ranging from 0 to 63.
        :param pulumi.Input[builtins.int] remain_bandwidth_percent: The percentage of cross-region bandwidth that the current queue can use.
        :param pulumi.Input[builtins.str] traffic_qos_policy_id: The ID of the traffic scheduling policy.
        :param pulumi.Input[builtins.str] inter_region_traffic_qos_queue_description: The description information of the traffic scheduling policy.
        :param pulumi.Input[builtins.str] inter_region_traffic_qos_queue_name: The name of the traffic scheduling policy.
        """
    ...
    @property
    @pulumi.getter
    def dscps(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @dscps.setter
    def dscps(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "dscps", value)

    @property
    @pulumi.getter(name="remainBandwidthPercent")
    def remain_bandwidth_percent(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def remain_bandwidth_percent(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "remain_bandwidth_percent", value)

    @property
    @pulumi.getter(name="trafficQosPolicyId")
    def traffic_qos_policy_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def traffic_qos_policy_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "traffic_qos_policy_id", value)

    @property
    @pulumi.getter(name="interRegionTrafficQosQueueDescription")
    def inter_region_traffic_qos_queue_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inter_region_traffic_qos_queue_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "inter_region_traffic_qos_queue_description", value)

    @property
    @pulumi.getter(name="interRegionTrafficQosQueueName")
    def inter_region_traffic_qos_queue_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inter_region_traffic_qos_queue_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _InterRegionTrafficQosQueueState:
    def __init__(__self__, *,
                 dscps: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 inter_region_traffic_qos_queue_description: Optional[pulumi.Input[builtins.str]] = None,
                 inter_region_traffic_qos_queue_name: Optional[pulumi.Input[builtins.str]] = None,
                 remain_bandwidth_percent: Optional[pulumi.Input[builtins.int]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 traffic_qos_policy_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] inter_region_traffic_qos_queue_name: The name of the traffic scheduling policy.
        :param pulumi.Input[builtins.int] remain_bandwidth_percent: The percentage of cross-region bandwidth that the current queue can use.
        :param pulumi.Input[builtins.str] status: The status of the traffic scheduling policy. -**Creating**: The function is being created.-**Active**: available.-**Modifying**: is being modified.-**Deleting**: Deleted.-**Deleted**: Deleted.
        :param pulumi.Input[builtins.str] traffic_qos_policy_id: The ID of the traffic scheduling policy.
        """
    ...
    @property
    @pulumi.getter
    def dscps(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The DSCP value of the traffic packet to be matched in the current queue, ranging from 0 to 63.
        """
        return pulumi.get(self, "dscps")
    ...
    @dscps.setter
    def dscps(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "dscps", value)
    ...
    @property
    @pulumi.getter(name="remainBandwidthPercent")
    def remain_bandwidth_percent(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The percentage of cross-region bandwidth that the current queue can use.
        """
        return pulumi.get(self, "remain_bandwidth_percent")
    ...
    @remain_bandwidth_percent.setter
    def remain_bandwidth_percent(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "remain_bandwidth_percent", value)
    ...
    @property
    @pulumi.getter(name="trafficQosPolicyId")
    def traffic_qos_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the traffic scheduling policy.
        """
        return pulumi.get(self, "traffic_qos_policy_id")
    ...
    @traffic_qos_policy_id.setter
    def traffic_qos_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "traffic_qos_policy_id", value)
...
class InterRegionTrafficQosQueue(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            remain_bandwidth_percent: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            traffic_qos_policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'InterRegionTrafficQosQueue':
        """
    ...
    @property
    @pulumi.getter
    def dscps(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The DSCP value of the traffic packet to be matched in the current queue, ranging from 0 to 63.
        """
        return pulumi.get(self, "dscps")
    ...
    @property
    @pulumi.getter(name="interRegionTrafficQosQueueDescription")
    def inter_region_traffic_qos_queue_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description information of the traffic scheduling policy.
        """
        return pulumi.get(self, "inter_region_traffic_qos_queue_description")
    ...
    @property
    @pulumi.getter(name="interRegionTrafficQosQueueName")
    def inter_region_traffic_qos_queue_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the traffic scheduling policy.
        """
        return pulumi.get(self, "inter_region_traffic_qos_queue_name")
    ...
    @property
    @pulumi.getter(name="remainBandwidthPercent")
    def remain_bandwidth_percent(self) -> pulumi.Output[builtins.int]:
        """
        The percentage of cross-region bandwidth that the current queue can use.
        """
        return pulumi.get(self, "remain_bandwidth_percent")
    ...
    @property
    @pulumi.getter(name="trafficQosPolicyId")
    def traffic_qos_policy_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the traffic scheduling policy.
        """
        return pulumi.get(self, "traffic_qos_policy_id")
