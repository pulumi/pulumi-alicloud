...
def get_instances(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of CEN instances IDs.
...
def get_instances_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:cen/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult)
