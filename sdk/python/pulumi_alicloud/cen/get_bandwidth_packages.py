...
def get_bandwidth_packages(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: Limit search to a list of specific CEN Bandwidth Package IDs.
    :param builtins.bool include_reservation_data: Indicates whether to include renewal data. Valid values: `true`: Return renewal data in the response. `false`: Do not return renewal data in the response.
    :param builtins.str instance_id: ID of a CEN instance.
    :param builtins.str name_regex: A regex string to filter CEN Bandwidth Package by name.
...
def get_bandwidth_packages_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
