...
class TrafficMarkingPolicyArgs:
    def __init__(__self__, *,
                 marking_dscp: pulumi.Input[builtins.int],
    ...
    def marking_dscp(self) -> pulumi.Input[builtins.int]:
        """
        MarkingDscp
        """
    ...
    @marking_dscp.setter
    def marking_dscp(self, value: pulumi.Input[builtins.int]):
    ...
    def traffic_marking_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TrafficMarkingPolicyState:
    def __init__(__self__, *,
                 ...
                 traffic_marking_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 traffic_marking_policy_name: Optional[pulumi.Input[builtins.str]] = None,
                 traffic_match_rules: Optional[pulumi.Input[Sequence[pulumi.Input['TrafficMarkingPolicyTrafficMatchRuleArgs']]]] = None,
    ...
    @marking_dscp.setter
    def marking_dscp(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "marking_dscp", value)
    ...
    def traffic_marking_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def traffic_marking_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TrafficMarkingPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            traffic_marking_policy_name: Optional[pulumi.Input[builtins.str]] = None,
            traffic_match_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TrafficMarkingPolicyTrafficMatchRuleArgs', 'TrafficMarkingPolicyTrafficMatchRuleArgsDict']]]]] = None,
            transit_router_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TrafficMarkingPolicy':
        """
    ...
    @property
    @pulumi.getter(name="trafficMarkingPolicyId")
    def traffic_marking_policy_id(self) -> pulumi.Output[builtins.str]:
        """
        The first ID of the resource
        """
        return pulumi.get(self, "traffic_marking_policy_id")
    ...
    @property
    @pulumi.getter(name="trafficMarkingPolicyName")
    def traffic_marking_policy_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        TrafficMarkingPolicyName
        """
        return pulumi.get(self, "traffic_marking_policy_name")
