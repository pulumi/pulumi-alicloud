...
class BandwidthPackageAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bandwidth_package_id: The ID of the bandwidth package.
...
class BandwidthPackageAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            bandwidth_package_id: Optional[pulumi.Input[builtins.str]] = None,
            instance_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BandwidthPackageAttachment':
        """
