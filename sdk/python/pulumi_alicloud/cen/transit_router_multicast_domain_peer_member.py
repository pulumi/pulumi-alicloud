...
class TransitRouterMulticastDomainPeerMemberArgs:
    def __init__(__self__, *,
                 ...
                 peer_transit_router_multicast_domain_id: pulumi.Input[builtins.str],
                 transit_router_multicast_domain_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] group_ip_address: The IP address of the multicast group to which the multicast member belongs. Value range: **224.0.0.1** to **239.255.255.254**.If the multicast group you specified does not exist in the current multicast domain, the system will automatically create a new multicast group for you in the current multicast domain.
        :param pulumi.Input[builtins.str] peer_transit_router_multicast_domain_id: The IDs of the inter-region multicast domains.
        :param pulumi.Input[builtins.str] transit_router_multicast_domain_id: The ID of the multicast domain to which the multicast member belongs.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether only to precheck the request.
        """
    ...
    def group_ip_address(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def group_ip_address(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "group_ip_address", value)

    @property
    @pulumi.getter(name="peerTransitRouterMulticastDomainId")
    def peer_transit_router_multicast_domain_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def peer_transit_router_multicast_domain_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "peer_transit_router_multicast_domain_id", value)

    @property
    @pulumi.getter(name="transitRouterMulticastDomainId")
    def transit_router_multicast_domain_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def transit_router_multicast_domain_id(self, value: pulumi.Input[builtins.str]):
...
class _TransitRouterMulticastDomainPeerMemberState:
    def __init__(__self__, *,
                 ...
                 peer_transit_router_multicast_domain_id: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 transit_router_multicast_domain_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering TransitRouterMulticastDomainPeerMember resources.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether only to precheck the request.
        :param pulumi.Input[builtins.str] group_ip_address: The IP address of the multicast group to which the multicast member belongs. Value range: **224.0.0.1** to **239.255.255.254**.If the multicast group you specified does not exist in the current multicast domain, the system will automatically create a new multicast group for you in the current multicast domain.
        :param pulumi.Input[builtins.str] peer_transit_router_multicast_domain_id: The IDs of the inter-region multicast domains.
        :param pulumi.Input[builtins.str] status: The status of the multicast resource. Valid values:
    ...
    @property
    @pulumi.getter(name="groupIpAddress")
    def group_ip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IP address of the multicast group to which the multicast member belongs. Value range: **224.0.0.1** to **239.255.255.254**.If the multicast group you specified does not exist in the current multicast domain, the system will automatically create a new multicast group for you in the current multicast domain.
        """
        return pulumi.get(self, "group_ip_address")
    ...
    @group_ip_address.setter
    def group_ip_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "group_ip_address", value)

    @property
    @pulumi.getter(name="peerTransitRouterMulticastDomainId")
    def peer_transit_router_multicast_domain_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IDs of the inter-region multicast domains.
        """
        return pulumi.get(self, "peer_transit_router_multicast_domain_id")
    ...
    @peer_transit_router_multicast_domain_id.setter
    def peer_transit_router_multicast_domain_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peer_transit_router_multicast_domain_id", value)
    ...
    @property
    @pulumi.getter(name="transitRouterMulticastDomainId")
    def transit_router_multicast_domain_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the multicast domain to which the multicast member belongs.
        """
        return pulumi.get(self, "transit_router_multicast_domain_id")
    ...
    @transit_router_multicast_domain_id.setter
    def transit_router_multicast_domain_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transit_router_multicast_domain_id", value)


@pulumi.type_token("alicloud:cen/transitRouterMulticastDomainPeerMember:TransitRouterMulticastDomainPeerMember")
class TransitRouterMulticastDomainPeerMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            peer_transit_router_multicast_domain_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_multicast_domain_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TransitRouterMulticastDomainPeerMember':
        """
    ...
    @property
    @pulumi.getter(name="groupIpAddress")
    def group_ip_address(self) -> pulumi.Output[builtins.str]:
        """
        The IP address of the multicast group to which the multicast member belongs. Value range: **224.0.0.1** to **239.255.255.254**.If the multicast group you specified does not exist in the current multicast domain, the system will automatically create a new multicast group for you in the current multicast domain.
        """
        return pulumi.get(self, "group_ip_address")
    ...
    @property
    @pulumi.getter(name="peerTransitRouterMulticastDomainId")
    def peer_transit_router_multicast_domain_id(self) -> pulumi.Output[builtins.str]:
        """
        The IDs of the inter-region multicast domains.
        """
        return pulumi.get(self, "peer_transit_router_multicast_domain_id")
    ...
    @property
    @pulumi.getter(name="transitRouterMulticastDomainId")
    def transit_router_multicast_domain_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the multicast domain to which the multicast member belongs.
        """
        return pulumi.get(self, "transit_router_multicast_domain_id")
