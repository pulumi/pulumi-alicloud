...
class TransitRouterMulticastDomainPeerMemberArgs:
    ...
    def peer_transit_router_multicast_domain_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def peer_transit_router_multicast_domain_id(self, value: pulumi.Input[_builtins.str]):
...
class _TransitRouterMulticastDomainPeerMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] group_ip_address: The IP address of the multicast group to which the multicast member belongs. Value range: **224.0.0.1** to **239.255.255.254**.If the multicast group you specified does not exist in the current multicast domain, the system will automatically create a new multicast group for you in the current multicast domain.
        :param pulumi.Input[_builtins.str] peer_transit_router_multicast_domain_id: The IDs of the inter-region multicast domains.
        :param pulumi.Input[_builtins.str] status: The status of the multicast resource. Valid values:
...
class TransitRouterMulticastDomainPeerMember(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="peerTransitRouterMulticastDomainId")
    def peer_transit_router_multicast_domain_id(self) -> pulumi.Output[_builtins.str]:
        """
        The IDs of the inter-region multicast domains.
        """
        return pulumi.get(self, "peer_transit_router_multicast_domain_id")
