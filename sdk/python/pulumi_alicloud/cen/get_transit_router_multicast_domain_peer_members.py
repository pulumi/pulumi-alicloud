...
class GetTransitRouterMulticastDomainPeerMembersResult:
    ...
    def peer_transit_router_multicast_domains(self) -> Optional[Sequence[_builtins.str]]:
...
def get_transit_router_multicast_domain_peer_members(ids: Optional[Sequence[_builtins.str]] = None,
                                                     output_file: Optional[_builtins.str] = None,
                                                     peer_transit_router_multicast_domains: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Cen Transit Router Multicast Domain Peer Member IDs.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param Sequence[_builtins.str] peer_transit_router_multicast_domains: The IDs of the inter-region multicast domains.
    :param _builtins.str resource_id: The ID of the resource associated with the multicast resource.
    :param _builtins.str resource_type: The type of the multicast resource. Valid values:
