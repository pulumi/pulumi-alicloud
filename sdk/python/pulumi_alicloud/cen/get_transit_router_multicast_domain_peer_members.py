...
class GetTransitRouterMulticastDomainPeerMembersResult:
    ...
    def peer_transit_router_multicast_domains(self) -> Optional[Sequence[builtins.str]]:
...
def get_transit_router_multicast_domain_peer_members(ids: Optional[Sequence[builtins.str]] = None,
                                                     output_file: Optional[builtins.str] = None,
                                                     peer_transit_router_multicast_domains: Optional[Sequence[builtins.str]] = None,
                                                     ...
                                                     transit_router_multicast_domain_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Cen Transit Router Multicast Domain Peer Member IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param Sequence[builtins.str] peer_transit_router_multicast_domains: The IDs of the inter-region multicast domains.
    :param builtins.str resource_id: The ID of the resource associated with the multicast resource.
    :param builtins.str resource_type: The type of the multicast resource. Valid values:
...
def get_transit_router_multicast_domain_peer_members_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                            output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                            peer_transit_router_multicast_domains: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
