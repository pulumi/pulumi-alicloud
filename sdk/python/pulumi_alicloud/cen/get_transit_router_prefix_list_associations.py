...
def get_transit_router_prefix_list_associations(ids: Optional[Sequence[_builtins.str]] = None,
                                                ...
                                                transit_router_table_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Cen Transit Router Prefix List Association IDs.
    ...
    :param _builtins.str status: The status of the prefix list. Valid Value: `Active`, `Updating`.
