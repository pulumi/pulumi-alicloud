...
class GetTransitRouterPrefixListAssociationsResult:
    ...
    def owner_uid(self) -> Optional[builtins.int]:
...
def get_transit_router_prefix_list_associations(ids: Optional[Sequence[builtins.str]] = None,
                                                output_file: Optional[builtins.str] = None,
                                                owner_uid: Optional[builtins.int] = None,
                                                ...
                                                transit_router_table_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Cen Transit Router Prefix List Association IDs.
    ...
    :param builtins.str status: The status of the prefix list. Valid Value: `Active`, `Updating`.
...
def get_transit_router_prefix_list_associations_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                       output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                       owner_uid: Optional[pulumi.Input[Optional[builtins.int]]] = None,
