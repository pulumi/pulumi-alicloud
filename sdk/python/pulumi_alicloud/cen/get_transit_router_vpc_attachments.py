...
def get_transit_router_vpc_attachments(cen_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Transit Router VPC Attachment IDs.
    :param builtins.str name_regex: A regex string to filter results by Transit Router VPC Attachment name.
...
def get_transit_router_vpc_attachments_output(cen_id: Optional[pulumi.Input[builtins.str]] = None,
