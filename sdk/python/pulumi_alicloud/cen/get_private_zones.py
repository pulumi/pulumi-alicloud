...
def get_private_zones(cen_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of CEN private zone IDs. Each element format as `<cen_id>:<access_region_id>`. 
           **NOTE:** Before 1.162.0, each element same as `access_region_id`.
...
def get_private_zones_output(cen_id: Optional[pulumi.Input[builtins.str]] = None,
