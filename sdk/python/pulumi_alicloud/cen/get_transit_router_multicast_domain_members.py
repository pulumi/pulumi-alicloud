...
def get_transit_router_multicast_domain_members(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Transit Router Multicast Domain Member IDs.
...
def get_transit_router_multicast_domain_members_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
