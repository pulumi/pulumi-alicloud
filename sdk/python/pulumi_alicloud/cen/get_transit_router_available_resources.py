...
class GetTransitRouterAvailableResourcesResult:
    ...
    def support_multicast(self) -> Optional[builtins.bool]:
        """
...
def get_transit_router_available_resources(output_file: Optional[builtins.str] = None,
                                           support_multicast: Optional[builtins.bool] = None,
...
def get_transit_router_available_resources_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                  support_multicast: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
