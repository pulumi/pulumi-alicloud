...
class GetTransitRouterCidrsResult:
    ...
    def transit_router_cidr_id(self) -> Optional[builtins.str]:
...
def get_transit_router_cidrs(ids: Optional[Sequence[builtins.str]] = None,
                             name_regex: Optional[builtins.str] = None,
                             output_file: Optional[builtins.str] = None,
                             transit_router_cidr_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Cen Transit Router Cidr IDs.
    :param builtins.str name_regex: A regex string to filter results by Transit Router Cidr name.
...
def get_transit_router_cidrs_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                    name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    transit_router_cidr_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetTransitRouterCidrsResult(
        ...
        transit_router_cidr_id=pulumi.get(__response__, 'transit_router_cidr_id'),
