...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cen_instance_name: The name of the CEN Instance. The name can be empty or `1` to `128` characters in length and cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] description: The description of the CEN Instance. The description can be empty or `1` to `256` characters in length and cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.98.0. New field `cen_instance_name` instead.
        :param pulumi.Input[builtins.str] protection_level: The level of CIDR block overlapping. Default value: `REDUCE`.
