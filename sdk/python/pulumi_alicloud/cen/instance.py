...
class Instance(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, description=None, name=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[str] description: The description of the CEN instance. Defaults to null.
        :param pulumi.Input[str] name: The name of the CEN instance. Defaults to null.
