...
class InstanceArgs:
    def __init__(__self__, *,
                 cen_instance_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cen_instance_name: The name of the CEN instance.
        :param pulumi.Input[builtins.str] description: The description of the CEN instance.
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.246.0. New field 'cen_instance_name' instead.
        :param pulumi.Input[builtins.str] protection_level: The level of CIDR block overlapping. Valid values:  REDUCED: Overlapped CIDR blocks are allowed. However, the overlapped CIDR blocks cannot be the same.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags of the CEN instance.
    ...
    def cen_instance_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cen_instance_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cen_instance_name: The name of the CEN instance.
        :param pulumi.Input[builtins.str] create_time: The time when the CEN instance was created.
        :param pulumi.Input[builtins.str] description: The description of the CEN instance.
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.246.0. New field 'cen_instance_name' instead.
        :param pulumi.Input[builtins.str] protection_level: The level of CIDR block overlapping. Valid values:  REDUCED: Overlapped CIDR blocks are allowed. However, the overlapped CIDR blocks cannot be the same.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group
        :param pulumi.Input[builtins.str] status: The state of the CEN instance.   Creating: The CEN instance is being created. Active: The CEN instance is running. Deleting: The CEN instance is being deleted.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags of the CEN instance.
...
class Instance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Instance':
        """
    ...
    @property
    @pulumi.getter(name="cenInstanceName")
    def cen_instance_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the CEN instance.
        """
        return pulumi.get(self, "cen_instance_name")
