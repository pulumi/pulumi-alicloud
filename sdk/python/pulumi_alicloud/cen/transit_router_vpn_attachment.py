...
class TransitRouterVpnAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vpn_id: The ID of the IPsec-VPN attachment.
        :param pulumi.Input[builtins.bool] auto_publish_route_enabled: Specifies whether to allow the transit router to automatically advertise routes to the IPsec-VPN attachment. Valid values:
        :param pulumi.Input[builtins.str] cen_id: The ID of the Cloud Enterprise Network (CEN) instance.
        :param pulumi.Input[builtins.str] charge_type: The billing method.
        ...
        :param pulumi.Input[builtins.str] transit_router_attachment_description: The new description of the VPN attachment.
               The description must be 2 to 256 characters in length. The description must start with a letter but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] transit_router_attachment_name: The name of the VPN attachment.
               The name must be 2 to 128 characters in length, and can contain letters, digits, underscores (\\_), and hyphens (-). It must start with a letter.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the transit router.
        :param pulumi.Input[builtins.str] vpn_owner_id: The ID of the Alibaba Cloud account to which the IPsec-VPN connection belongs.
...
class _TransitRouterVpnAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region_id: The ID of the region where the transit router is deployed.
