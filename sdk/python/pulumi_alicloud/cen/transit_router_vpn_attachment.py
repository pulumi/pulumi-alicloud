...
class TransitRouterVpnAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 vpn_id: pulumi.Input[builtins.str],
                 ...
                 vpn_owner_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] vpn_id: The id of the vpn.
        ...
        :param pulumi.Input[builtins.bool] auto_publish_route_enabled: Whether to allow the forwarding router instance to automatically publish routing entries to IPsec connections.
        :param pulumi.Input[builtins.str] cen_id: The id of the cen.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] transit_router_attachment_description: The description of the VPN connection. The description can contain `2` to `256` characters. The description must start with English letters, but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] transit_router_attachment_name: The name of the VPN connection. The name must be `2` to `128` characters in length, and can contain digits, underscores (_), and hyphens (-). It must start with a letter.
        :param pulumi.Input[builtins.str] vpn_owner_id: The owner id of vpn. **NOTE:** You must set `vpn_owner_id`, if you want to connect the transit router to an IPsec-VPN connection that belongs to another Alibaba Cloud account.
        """
    ...
    def vpn_id(self) -> pulumi.Input[builtins.str]:
        """
        The id of the vpn.
        """
    ...
    @vpn_id.setter
    def vpn_id(self, value: pulumi.Input[builtins.str]):
    ...
    def vpn_owner_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @vpn_owner_id.setter
    def vpn_owner_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TransitRouterVpnAttachmentState:
    def __init__(__self__, *,
                 ...
                 vpn_id: Optional[pulumi.Input[builtins.str]] = None,
                 vpn_owner_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="vpnId")
    def vpn_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The id of the vpn.
        """
        return pulumi.get(self, "vpn_id")
    ...
    @vpn_id.setter
    def vpn_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpn_id", value)
...
class TransitRouterVpnAttachment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="vpnId")
    def vpn_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the vpn.
        """
        return pulumi.get(self, "vpn_id")
    ...
    @property
    @pulumi.getter(name="vpnOwnerId")
    def vpn_owner_id(self) -> pulumi.Output[builtins.str]:
        """
        The owner id of vpn. **NOTE:** You must set `vpn_owner_id`, if you want to connect the transit router to an IPsec-VPN connection that belongs to another Alibaba Cloud account.
        """
        return pulumi.get(self, "vpn_owner_id")
