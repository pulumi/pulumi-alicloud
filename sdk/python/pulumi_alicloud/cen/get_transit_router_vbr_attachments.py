...
def get_transit_router_vbr_attachments(cen_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str transit_router_id: ID of the transit router.
    """
    __args__ = dict()
...
def get_transit_router_vbr_attachments_output(cen_id: Optional[pulumi.Input[_builtins.str]] = None,
