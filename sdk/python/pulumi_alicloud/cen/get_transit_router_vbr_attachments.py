...
def get_transit_router_vbr_attachments(cen_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of resource id. The element value is same as `transit_router_id`.
    ...
    :param builtins.str transit_router_id: ID of the transit router.
    """
    __args__ = dict()
...
def get_transit_router_vbr_attachments_output(cen_id: Optional[pulumi.Input[builtins.str]] = None,
