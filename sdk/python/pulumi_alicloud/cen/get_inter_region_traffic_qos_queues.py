...
def get_inter_region_traffic_qos_queues(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Inter Region Traffic Qos Queue IDs.
...
def get_inter_region_traffic_qos_queues_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
