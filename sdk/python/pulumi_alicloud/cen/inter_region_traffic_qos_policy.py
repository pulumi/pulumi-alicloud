...
class InterRegionTrafficQosPolicyArgs:
    def __init__(__self__, *,
                 ...
                 bandwidth_guarantee_mode: Optional[pulumi.Input[builtins.str]] = None,
                 inter_region_traffic_qos_policy_description: Optional[pulumi.Input[builtins.str]] = None,
                 inter_region_traffic_qos_policy_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a InterRegionTrafficQosPolicy resource.
        :param pulumi.Input[builtins.str] transit_router_attachment_id: Peer Attachment ID.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the forwarding router instance.
        :param pulumi.Input[builtins.str] bandwidth_guarantee_mode: Bandwidth guarantee mode. You can select by bandwidth or by bandwidth percentage. The default is by percentage.
        :param pulumi.Input[builtins.str] inter_region_traffic_qos_policy_description: The description information of the traffic scheduling policy.
        :param pulumi.Input[builtins.str] inter_region_traffic_qos_policy_name: The name of the traffic scheduling policy.
        """
    ...
    def bandwidth_guarantee_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bandwidth_guarantee_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bandwidth_guarantee_mode", value)

    @property
    @pulumi.getter(name="interRegionTrafficQosPolicyDescription")
    def inter_region_traffic_qos_policy_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inter_region_traffic_qos_policy_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "inter_region_traffic_qos_policy_description", value)

    @property
    @pulumi.getter(name="interRegionTrafficQosPolicyName")
    def inter_region_traffic_qos_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inter_region_traffic_qos_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _InterRegionTrafficQosPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] inter_region_traffic_qos_policy_description: The description information of the traffic scheduling policy.
        :param pulumi.Input[builtins.str] inter_region_traffic_qos_policy_name: The name of the traffic scheduling policy.
        :param pulumi.Input[builtins.str] status: The status of the traffic scheduling policy.
        :param pulumi.Input[builtins.str] transit_router_attachment_id: Peer Attachment ID.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the forwarding router instance.
        """
        if bandwidth_guarantee_mode is not None:
...
class InterRegionTrafficQosPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_attachment_id: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_id: Optional[pulumi.Input[builtins.str]] = None) -> 'InterRegionTrafficQosPolicy':
        """
    ...
    @property
    @pulumi.getter(name="bandwidthGuaranteeMode")
    def bandwidth_guarantee_mode(self) -> pulumi.Output[builtins.str]:
        """
        Bandwidth guarantee mode. You can select by bandwidth or by bandwidth percentage. The default is by percentage.
        """
        return pulumi.get(self, "bandwidth_guarantee_mode")
    ...
    @property
    @pulumi.getter(name="interRegionTrafficQosPolicyDescription")
    def inter_region_traffic_qos_policy_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description information of the traffic scheduling policy.
        """
        return pulumi.get(self, "inter_region_traffic_qos_policy_description")
    ...
    @property
    @pulumi.getter(name="interRegionTrafficQosPolicyName")
    def inter_region_traffic_qos_policy_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the traffic scheduling policy.
        """
        return pulumi.get(self, "inter_region_traffic_qos_policy_name")
