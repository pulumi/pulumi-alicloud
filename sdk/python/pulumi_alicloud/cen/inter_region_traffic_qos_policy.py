...
class InterRegionTrafficQosPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] transit_router_attachment_id: The ID of the inter-region connection.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the transit router.
        :param pulumi.Input[builtins.str] inter_region_traffic_qos_policy_description: The description of the QoS policy. The description must be 2 to 128 characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The description must start with a letter.
        :param pulumi.Input[builtins.str] inter_region_traffic_qos_policy_name: The name of the QoS policy. The name must be 2 to 128 characters in length, and can contain letters, digits, underscores (_), and hyphens (-). It must start with a letter.
        """
...
class _InterRegionTrafficQosPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] inter_region_traffic_qos_policy_description: The description of the QoS policy. The description must be 2 to 128 characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The description must start with a letter.
        :param pulumi.Input[builtins.str] inter_region_traffic_qos_policy_name: The name of the QoS policy. The name must be 2 to 128 characters in length, and can contain letters, digits, underscores (_), and hyphens (-). It must start with a letter.
        :param pulumi.Input[builtins.str] status: The status of the Inter Region Traffic Qos Policy.
        :param pulumi.Input[builtins.str] transit_router_attachment_id: The ID of the inter-region connection.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the transit router.
        """
        if inter_region_traffic_qos_policy_description is not None:
