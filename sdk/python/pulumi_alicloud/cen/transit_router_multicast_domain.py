...
class TransitRouterMulticastDomainArgs:
    def __init__(__self__, *,
                 ...
                 transit_router_multicast_domain_description: Optional[pulumi.Input[builtins.str]] = None,
                 transit_router_multicast_domain_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] transit_router_multicast_domain_description: The description of the multicast domain.
        :param pulumi.Input[builtins.str] transit_router_multicast_domain_name: The name of the multicast domain.
        """
    ...
    def transit_router_multicast_domain_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def transit_router_multicast_domain_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transit_router_multicast_domain_description", value)

    @property
    @pulumi.getter(name="transitRouterMulticastDomainName")
    def transit_router_multicast_domain_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def transit_router_multicast_domain_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TransitRouterMulticastDomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TransitRouterMulticastDomainOptionsArgs'] options: The function options of the multicast domain. See `options` below.
        :param pulumi.Input[builtins.str] region_id: (Available since v1.242.0) The region ID of the transit router.
        :param pulumi.Input[builtins.str] status: The status of the Transit Router Multicast Domain.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the forwarding router instance.
        :param pulumi.Input[builtins.str] transit_router_multicast_domain_description: The description of the multicast domain.
        :param pulumi.Input[builtins.str] transit_router_multicast_domain_name: The name of the multicast domain.
...
class TransitRouterMulticastDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            transit_router_id: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_multicast_domain_description: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_multicast_domain_name: Optional[pulumi.Input[builtins.str]] = None) -> 'TransitRouterMulticastDomain':
        """
    ...
    @property
    @pulumi.getter(name="transitRouterMulticastDomainDescription")
    def transit_router_multicast_domain_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the multicast domain.
        """
        return pulumi.get(self, "transit_router_multicast_domain_description")
    ...
    @property
    @pulumi.getter(name="transitRouterMulticastDomainName")
    def transit_router_multicast_domain_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the multicast domain.
        """
        return pulumi.get(self, "transit_router_multicast_domain_name")
