...
class _TransitRouterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cen_id: The ID of the CEN.
        :param pulumi.Input[builtins.bool] dry_run: The dry run.
        :param pulumi.Input[builtins.str] status: The associating status of the Transit Router.
        :param pulumi.Input[builtins.bool] support_multicast: Specifies whether to enable the multicast feature for the Enterprise Edition transit router. Valid values: `false`, `true`. Default Value: `false`. The multicast feature is supported only in specific regions. You can call [ListTransitRouterAvailableResource](https://www.alibabacloud.com/help/en/cen/developer-reference/api-cbn-2017-09-12-listtransitrouteravailableresource) to query the regions that support multicast.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] transit_router_description: The description of the transit router.
        :param pulumi.Input[builtins.str] transit_router_id: The transit router id of the transit router.
        :param pulumi.Input[builtins.str] transit_router_name: The name of the transit router.
        :param pulumi.Input[builtins.str] type: The Type of the Transit Router. Valid values: `Enterprise`, `Basic`.
        """
