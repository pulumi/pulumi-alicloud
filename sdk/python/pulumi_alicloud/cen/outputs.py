...
class TrafficMarkingPolicyTrafficMatchRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dst_port_ranges: Optional[Sequence[builtins.int]] = None,
                 match_dscp: Optional[builtins.int] = None,
                 protocol: Optional[builtins.str] = None,
                 src_cidr: Optional[builtins.str] = None,
                 src_port_ranges: Optional[Sequence[builtins.int]] = None,
...
class TransitRouterMulticastDomainOptions(dict):
    ...
    def __init__(__self__, *,
                 igmpv2_support: Optional[builtins.str] = None):
        """
        :param builtins.str igmpv2_support: Whether to enable IGMP function for multicast domain. Default value: `disable`. Valid values: `enable`, `disable`.
        """
    ...
    def igmpv2_support(self) -> Optional[builtins.str]:
        """
...
class TransitRouterVpcAttachmentZoneMapping(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str vswitch_id: The ID of the vSwitch that you want to add to the VPC connection.  You can specify at most 10 vSwitches in each call.
        ...
        :param builtins.str zone_id: The ID of the zone that supports Enterprise Edition transit routers.  You can call the [DescribeZones](https://www.alibabacloud.com/help/en/doc-detail/36064.html) operation to query the most recent zone list.  You can specify at most 10 zones in each call.
        """
...
class GetBandwidthLimitsLimitResult(dict):
    def __init__(__self__, *,
                 bandwidth_limit: builtins.int,
                 instance_id: builtins.str,
                 local_region_id: builtins.str,
                 opposite_region_id: builtins.str,
                 status: builtins.str):
        """
        :param builtins.int bandwidth_limit: The bandwidth limit configured for the interconnected regions communication.
        :param builtins.str instance_id: ID of the CEN instance.
        :param builtins.str local_region_id: ID of local region.
        :param builtins.str opposite_region_id: ID of opposite region.
        :param builtins.str status: Status of the CEN Bandwidth Limit, including "Active" and "Modifying".
        """
    ...
    def bandwidth_limit(self) -> builtins.int:
        """
...
class GetBandwidthPackagesPackageResult(dict):
    def __init__(__self__, *,
                 ...
                 status: builtins.str):
        """
        :param builtins.int bandwidth: The bandwidth in Mbps of the CEN bandwidth package.
        :param builtins.str bandwidth_package_charge_type: The billing method, including `POSTPAY` and `PREPAY`.
        :param builtins.str business_status: Status of the CEN Bandwidth Package, including `Normal`, `FinancialLocked` and `SecurityLocked`.
        :param builtins.str cen_bandwidth_package_id: The ID of the bandwidth package.
        :param builtins.str cen_bandwidth_package_name: The name of the bandwidth package.
        :param Sequence[builtins.str] cen_ids: The list of CEN instances that are associated with the bandwidth package.
        :param builtins.str description: Description of the CEN Bandwidth Package.
        :param builtins.str geographic_region_a_id: Region ID of the interconnected regions.
        :param builtins.str geographic_region_b_id: Region ID of the interconnected regions.
        :param builtins.str geographic_span_id: The area ID of the cross-area connection.
        :param builtins.str has_reservation_data: Indicates whether renewal data is involved.
        :param builtins.str id: ID of the CEN Bandwidth Package.
        :param builtins.str instance_id: ID of a CEN instance.
        :param builtins.bool is_cross_border: Indicates whether the bandwidth package is a cross-border bandwidth package.
        :param builtins.str name: Name of the CEN Bandwidth Package.
        :param builtins.str payment_type: The billing method of the bandwidth package.
        :param builtins.str reservation_active_time: The expiration time of the temporary upgrade.
        :param builtins.str reservation_bandwidth: The restored bandwidth after the temporary upgrade.
        :param builtins.str reservation_internet_charge_type: The billing method after the configuration change.
        :param builtins.str reservation_order_type: The type of the configuration change.
        :param builtins.str status: Status of the CEN Bandwidth Package in CEN instance, Valid value: `Idle` and `InUse`.
        """
    ...
    def bandwidth_package_charge_type(self) -> builtins.str:
        """
    ...
    def geographic_span_id(self) -> builtins.str:
        """
    ...
    def is_cross_border(self) -> builtins.bool:
        """
...
class GetChildInstanceRouteEntryToAttachmentsAttachmentResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str destination_cidr_block: DestinationCidrBlock
        :param builtins.str id: The ID of the resource. The value is formulated as `<cen_id>:<child_instance_route_table_id>:<transit_router_attachment_id>:<destination_cidr_block>`.
...
class GetFlowlogsFlowlogResult(dict):
    def __init__(__self__, *,
                 ...
                 flow_log_version: builtins.str,
                 id: builtins.str,
                 interval: builtins.int,
                 log_format_string: builtins.str,
                 log_store_name: builtins.str,
                 project_name: builtins.str,
                 record_total: builtins.str,
        ...
        """
        :param builtins.str cen_id: The ID of Cen instance.
        :param builtins.str create_time: The createTime of flowlog.
        :param builtins.str description: The description of the flowlog.
        :param builtins.str flow_log_id: The ID of FlowLog.
        :param builtins.str flow_log_name: The name of the flowlog.
        :param builtins.str flow_log_version: Flowlog Version.
        :param builtins.str id: The ID of FlowLog.
        :param builtins.int interval: The duration of the capture window for the flow log to capture traffic. Unit: seconds. Valid values: **60** or **600 * *. Default value: **600 * *.
        :param builtins.str log_format_string: (Available since v1.236.0) Log Format.
        :param builtins.str log_store_name: The LogStore that stores the flowlog.
        :param builtins.str project_name: The Project that stores the flowlog.
        :param builtins.str record_total: (Available since v1.236.0) Total number of records.
        :param builtins.str region_id: Region id
        :param builtins.str status: The status of the flow log. Valid values:-**Active**: started.-**InActive**: not started.
        :param Mapping[str, builtins.str] tags: The tag of the resource.
        :param builtins.str transit_router_attachment_id: (Available since v1.236.0) Cross-region Connection ID or VBR connection ID.> This parameter is required.
        :param builtins.str transit_router_id: Transit Router ID
        """
        pulumi.set(__self__, "cen_id", cen_id)
    ...
    def flow_log_version(self) -> builtins.str:
        """
        Flowlog Version.
        """
    ...
    def log_format_string(self) -> builtins.str:
        """
    ...
    def log_store_name(self) -> builtins.str:
        """
    ...
    def record_total(self) -> builtins.str:
        """
...
class GetInstanceAttachmentsAttachmentResult(dict):
    def __init__(__self__, *,
                 child_instance_attach_time: builtins.str,
                 child_instance_id: builtins.str,
                 child_instance_owner_id: builtins.int,
                 ...
                 status: builtins.str):
        """
        :param builtins.str child_instance_attach_time: The time when the network is associated with the CEN instance.
        :param builtins.str child_instance_id: The ID of the network.
        :param builtins.int child_instance_owner_id: The ID of the account to which the network belongs.
        :param builtins.str child_instance_region_id: The region to which the network to be queried belongs.
        :param builtins.str child_instance_type: The type of the associated network. Valid values: `VPC`, `VBR` and `CCN`.
        :param builtins.str id: The ID of the CEN Instance Attachment.
        :param builtins.str instance_id: The ID of the CEN instance.
        :param builtins.str status: The status of the Cen Child Instance Attachment. Valid value: `Attaching`, `Attached` and `Aetaching`.
        """
    ...
    def child_instance_attach_time(self) -> builtins.str:
        """
    ...
    def child_instance_owner_id(self) -> builtins.int:
        """
...
class GetInstancesInstanceResult(dict):
    def __init__(__self__, *,
                 cen_bandwidth_package_ids: Sequence[builtins.str],
                 cen_id: builtins.str,
                 cen_instance_name: builtins.str,
                 create_time: builtins.str,
                 description: builtins.str,
                 id: builtins.str,
                 name: builtins.str,
                 ...
                 tags: Mapping[str, builtins.str]):
        """
        :param Sequence[builtins.str] cen_bandwidth_package_ids: List of CEN Bandwidth Package IDs in the specified CEN instance.
        :param builtins.str cen_id: ID of the CEN instance.
        :param builtins.str cen_instance_name: Name of the CEN instance.
        :param builtins.str create_time: The creation time of the CEN Instance.
        :param builtins.str description: Description of the CEN instance.
        :param builtins.str id: ID of the CEN instance.
        :param builtins.str name: Name of the CEN instance.
        :param builtins.str protection_level: Indicates the allowed level of CIDR block overlapping.
        :param builtins.str status: The status of CEN instance. Valid value: `Active`, `Creating` and `Deleting`.
    ...
    def cen_instance_name(self) -> builtins.str:
        """
...
class GetInterRegionTrafficQosPoliciesPolicyResult(dict):
    def __init__(__self__, *,
                 id: builtins.str,
                 inter_region_traffic_qos_policy_description: builtins.str,
                 inter_region_traffic_qos_policy_id: builtins.str,
                 inter_region_traffic_qos_policy_name: builtins.str,
                 status: builtins.str,
                 transit_router_attachment_id: builtins.str,
                 transit_router_id: builtins.str):
        """
        :param builtins.str id: The ID of the Inter Region Traffic Qos Policy.
        :param builtins.str inter_region_traffic_qos_policy_description: The description of the Inter Region Traffic Qos Policy.
        :param builtins.str inter_region_traffic_qos_policy_id: The ID of the Inter Region Traffic Qos Policy.
        :param builtins.str inter_region_traffic_qos_policy_name: The name of the Inter Region Traffic Qos Policy.
        :param builtins.str status: The status of the traffic scheduling policy. Valid Value: `Creating`, `Active`, `Modifying`, `Deleting`, `Deleted`.
        :param builtins.str transit_router_attachment_id: The ID of the inter-region connection.
    ...
    def inter_region_traffic_qos_policy_description(self) -> builtins.str:
        """
    ...
    def inter_region_traffic_qos_policy_id(self) -> builtins.str:
        """
        The ID of the Inter Region Traffic Qos Policy.
        """
    ...
    def inter_region_traffic_qos_policy_name(self) -> builtins.str:
        """
...
class GetInterRegionTrafficQosQueuesQueueResult(dict):
    def __init__(__self__, *,
                 dscps: Sequence[builtins.str],
                 id: builtins.str,
                 inter_region_traffic_qos_queue_description: builtins.str,
                 inter_region_traffic_qos_queue_id: builtins.str,
                 inter_region_traffic_qos_queue_name: builtins.str,
                 remain_bandwidth_percent: builtins.int,
                 status: builtins.str,
                 traffic_qos_policy_id: builtins.str):
        """
        :param Sequence[builtins.str] dscps: The DSCP value of the traffic packet to be matched in the current queue, ranging from 0 to 63.
        :param builtins.str inter_region_traffic_qos_queue_description: The description information of the traffic scheduling policy.
        :param builtins.str inter_region_traffic_qos_queue_id: The ID of the resource.
        :param builtins.str inter_region_traffic_qos_queue_name: The name of the traffic scheduling policy.
        :param builtins.int remain_bandwidth_percent: The percentage of cross-region bandwidth that the current queue can use.
        :param builtins.str status: The status of the traffic scheduling policy. -**Creating**: The function is being created.-**Active**: available.-**Modifying**: is being modified.-**Deleting**: Deleted.-**Deleted**: Deleted.
        :param builtins.str traffic_qos_policy_id: The ID of the traffic scheduling policy.
        """
    ...
    @property
    @pulumi.getter
    def dscps(self) -> Sequence[builtins.str]:
        """
    ...
    def inter_region_traffic_qos_queue_description(self) -> builtins.str:
        """
    ...
    def inter_region_traffic_qos_queue_id(self) -> builtins.str:
        """
    ...
    def inter_region_traffic_qos_queue_name(self) -> builtins.str:
        """
    ...
    def remain_bandwidth_percent(self) -> builtins.int:
        """
    ...
    def traffic_qos_policy_id(self) -> builtins.str:
        """
...
class GetPrivateZonesZoneResult(dict):
    def __init__(__self__, *,
                 access_region_id: builtins.str,
                 cen_id: builtins.str,
                 host_region_id: builtins.str,
                 host_vpc_id: builtins.str,
                 id: builtins.str,
                 private_zone_dns_servers: builtins.str,
                 status: builtins.str):
        """
        :param builtins.str access_region_id: The access region. The access region is the region of the cloud resource that accesses the PrivateZone service through CEN.
        :param builtins.str cen_id: The ID of the CEN instance.
        :param builtins.str host_region_id: The service region. The service region is the target region of the PrivateZone service accessed through CEN.
        :param builtins.str host_vpc_id: The VPC that belongs to the service region.
        :param builtins.str id: The ID of the private zone. It formats as `<cen_id>:<access_region_id>`.
        :param builtins.str private_zone_dns_servers: The DNS IP addresses of the PrivateZone service.
        :param builtins.str status: The status of the PrivateZone service, including `Creating`, `Active` and `Deleting`.
        """
    ...
    def access_region_id(self) -> builtins.str:
        """
    ...
    def host_region_id(self) -> builtins.str:
        """
    ...
    def private_zone_dns_servers(self) -> builtins.str:
        """
...
class GetRegionRouteEntriesEntryResult(dict):
    def __init__(__self__, *,
                 ...
                 next_hop_region_id: builtins.str,
                 next_hop_type: builtins.str,
                 type: builtins.str):
        """
        :param builtins.str cidr_block: The destination CIDR block of the route entry.
        :param builtins.str next_hop_id: ID of the next hop.
        :param builtins.str next_hop_region_id: ID of the region where the next hop is located.
        :param builtins.str next_hop_type: Type of the next hop.
        :param builtins.str type: Type of the route entry.
        """
    ...
    def next_hop_region_id(self) -> builtins.str:
        """
...
class GetRouteEntriesEntryResult(dict):
    def __init__(__self__, *,
                 ...
                 next_hop_id: builtins.str,
                 next_hop_type: builtins.str,
                 operational_mode: builtins.bool,
                 publish_status: builtins.str,
                 route_table_id: builtins.str,
                 route_type: builtins.str):
        """
        :param builtins.str cidr_block: The destination CIDR block of the route entry to query.
        ...
        :param builtins.str next_hop_id: ID of the next hop.
        :param builtins.str next_hop_type: Type of the next hop, including "Instance", "HaVip" and "RouterInterface".
        :param builtins.bool operational_mode: Whether to allow the route entry to be published or removed to or from CEN.
        :param builtins.str publish_status: The publish status of the route entry in CEN, including "Published" and "NonPublished".
        :param builtins.str route_table_id: ID of the route table of the VPC or VBR.
        :param builtins.str route_type: Type of the route entry, including "System", "Custom" and "BGP".
        """
        pulumi.set(__self__, "cidr_block", cidr_block)
    ...
    def operational_mode(self) -> builtins.bool:
        """
...
class GetRouteEntriesEntryConflictResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str cidr_block: The destination CIDR block of the route entry to query.
        :param builtins.str instance_id: ID of the CEN instance.
        :param builtins.str instance_type: The type of the CEN child instance.
        :param builtins.str region_id: ID of the region where the conflicted route entry is located.
        :param builtins.str status: Reasons of exceptions.
        """
        pulumi.set(__self__, "cidr_block", cidr_block)
        pulumi.set(__self__, "instance_id", instance_id)
...
class GetRouteMapsMapResult(dict):
    def __init__(__self__, *,
                 as_path_match_mode: builtins.str,
                 cen_id: builtins.str,
                 cen_region_id: builtins.str,
                 cidr_match_mode: builtins.str,
                 community_match_mode: builtins.str,
                 community_operate_mode: builtins.str,
                 description: builtins.str,
                 destination_child_instance_types: Sequence[builtins.str],
                 destination_cidr_blocks: Sequence[builtins.str],
                 destination_instance_ids: Sequence[builtins.str],
                 destination_instance_ids_reverse_match: builtins.bool,
                 destination_route_table_ids: Sequence[builtins.str],
                 id: builtins.str,
                 map_result: builtins.str,
                 match_asns: Sequence[builtins.str],
                 match_community_sets: Sequence[builtins.str],
                 next_priority: builtins.int,
                 operate_community_sets: Sequence[builtins.str],
                 preference: builtins.int,
                 prepend_as_paths: Sequence[builtins.str],
                 priority: builtins.int,
                 route_map_id: builtins.str,
                 route_types: Sequence[builtins.str],
                 source_child_instance_types: Sequence[builtins.str],
                 source_instance_ids: Sequence[builtins.str],
                 source_instance_ids_reverse_match: builtins.bool,
                 source_region_ids: Sequence[builtins.str],
                 source_route_table_ids: Sequence[builtins.str],
                 status: builtins.str,
                 transmit_direction: builtins.str):
        """
        :param builtins.str as_path_match_mode: A match statement. It indicates the mode in which the as-path attribute is matched.
        :param builtins.str cen_id: The ID of the CEN instance.
        :param builtins.str cen_region_id: The ID of the region to which the CEN instance belongs.
        :param builtins.str cidr_match_mode: A match statement. It indicates the mode in which the prefix attribute is matched.
        :param builtins.str community_match_mode: A match statement. It indicates the mode in which the community attribute is matched.
        :param builtins.str community_operate_mode: An action statement. It indicates the mode in which the community attribute is operated.
        :param builtins.str description: The description of the route map.
        :param Sequence[builtins.str] destination_child_instance_types: A match statement that indicates the list of IDs of the destination instances.
        :param Sequence[builtins.str] destination_cidr_blocks: A match statement that indicates the prefix list.
        :param Sequence[builtins.str] destination_instance_ids: A match statement that indicates the list of IDs of the destination instances.
        :param builtins.bool destination_instance_ids_reverse_match: Indicates whether to enable the reverse match method of the DestinationInstanceIds match condition.
        :param Sequence[builtins.str] destination_route_table_ids: A match statement that indicates the list of IDs of the destination route tables.
        :param builtins.str id: The ID of the route map. It formats as `<cen_id>:<route_map_id>`. Before 1.161.0, it is `route_map_id`.
        :param builtins.str map_result: The action that is performed to a route if the route meets all the match conditions.
        :param Sequence[builtins.str] match_asns: A match statement that indicates the As path list.
        :param Sequence[builtins.str] match_community_sets: A match statement that indicates the community set.
        :param builtins.int next_priority: The priority of the next route map that is associated with the current route map.
        :param Sequence[builtins.str] operate_community_sets: An action statement that operates the community attribute.
        :param builtins.int preference: An action statement that modifies the preference of the route.
        :param Sequence[builtins.str] prepend_as_paths: Indicates AS Path prepending when a regional gateway receives or publishes a route.
        :param builtins.int priority: The priority of the route map.
        :param builtins.str route_map_id: The ID of the route map.
        :param Sequence[builtins.str] route_types: A match statement that indicates the list of route types.
        :param Sequence[builtins.str] source_child_instance_types: A match statement that indicates the list of IDs of the source instances.
        :param Sequence[builtins.str] source_instance_ids: A match statement that indicates the list of IDs of the source instances.
        :param builtins.bool source_instance_ids_reverse_match: Indicates whether to enable the reverse match method of the SourceInstanceIds match condition.
        :param Sequence[builtins.str] source_region_ids: A match statement that indicates the list of IDs of the source regions.
        :param Sequence[builtins.str] source_route_table_ids: A match statement that indicates the list of IDs of the source route tables.
        :param builtins.str status: The status of the route map, including `Creating`, `Active` and `Deleting`.
        :param builtins.str transmit_direction: The direction in which the route map is applied, including `RegionIn` and `RegionOut`.
        """
    ...
    def as_path_match_mode(self) -> builtins.str:
        """
    ...
    def cen_region_id(self) -> builtins.str:
        """
    ...
    def cidr_match_mode(self) -> builtins.str:
        """
    ...
    def community_match_mode(self) -> builtins.str:
        """
    ...
    def community_operate_mode(self) -> builtins.str:
        """
    ...
    def destination_child_instance_types(self) -> Sequence[builtins.str]:
        """
    ...
    def destination_cidr_blocks(self) -> Sequence[builtins.str]:
        """
    ...
    def destination_instance_ids(self) -> Sequence[builtins.str]:
        """
        A match statement that indicates the list of IDs of the destination instances.
        """
    ...
    def destination_instance_ids_reverse_match(self) -> builtins.bool:
        """
    ...
    def destination_route_table_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def map_result(self) -> builtins.str:
        """
    ...
    def match_asns(self) -> Sequence[builtins.str]:
        """
    ...
    def match_community_sets(self) -> Sequence[builtins.str]:
        """
    ...
    def next_priority(self) -> builtins.int:
        """
    ...
    def operate_community_sets(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def preference(self) -> builtins.int:
        """
    ...
    def prepend_as_paths(self) -> Sequence[builtins.str]:
        """
    ...
    def route_map_id(self) -> builtins.str:
        """
    ...
    def route_types(self) -> Sequence[builtins.str]:
        """
    ...
    def source_child_instance_types(self) -> Sequence[builtins.str]:
        """
    ...
    def source_instance_ids(self) -> Sequence[builtins.str]:
        """
        A match statement that indicates the list of IDs of the source instances.
        """
    ...
    def source_instance_ids_reverse_match(self) -> builtins.bool:
        """
    ...
    def source_region_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def source_route_table_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def transmit_direction(self) -> builtins.str:
        """
...
class GetRouteServicesServiceResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 status: builtins.str,
                 update_interval: builtins.str):
        """
        :param builtins.str access_region_id: The region of the network instances that access the cloud services.
        :param builtins.str cen_id: The ID of the CEN instance.
        :param Sequence[builtins.str] cidrs: The IP address of the cloud service.
        :param builtins.str description: The description of the cloud service.
        :param builtins.str host: The domain name or IP address of the cloud service.
        :param builtins.str host_region_id: The region of the cloud service.
        :param builtins.str host_vpc_id: The VPC associated with the cloud service.
        :param builtins.str id: The ID of the route service.
        :param builtins.str status: The status of the cloud service. Valid values: `Active`, `Creating` and `Deleting`.
        :param builtins.str update_interval: The update interval. Default value: 5. The value cannot be modified.
        """
        pulumi.set(__self__, "access_region_id", access_region_id)
        pulumi.set(__self__, "cen_id", cen_id)
    ...
    def update_interval(self) -> builtins.str:
        """
...
class GetTrafficMarkingPoliciesPolicyResult(dict):
    def __init__(__self__, *,
                 description: builtins.str,
                 id: builtins.str,
                 marking_dscp: builtins.int,
                 priority: builtins.int,
                 status: builtins.str,
                 traffic_marking_policy_id: builtins.str,
                 traffic_marking_policy_name: builtins.str,
                 transit_router_id: builtins.str):
        """
        :param builtins.str description: The description of the Traffic Marking Policy.
        :param builtins.str id: The ID of the resource. The value is formatted `<transit_router_id>:<traffic_marking_policy_id>`.
        :param builtins.int marking_dscp: The DSCP(Differentiated Services Code Point) of the Traffic Marking Policy.
        :param builtins.int priority: The Priority of the Traffic Marking Policy.
        :param builtins.str status: The status of the resource.
        :param builtins.str traffic_marking_policy_id: The ID of the Traffic Marking Policy.
        :param builtins.str traffic_marking_policy_name: The name of the Traffic Marking Policy.
        :param builtins.str transit_router_id: The ID of the transit router.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "id", id)
    ...
    def marking_dscp(self) -> builtins.int:
        """
    ...
    def traffic_marking_policy_id(self) -> builtins.str:
        """
    ...
    def traffic_marking_policy_name(self) -> builtins.str:
        """
...
class GetTransitRouteTableAggregationsTransitRouteTableAggregationResult(dict):
    def __init__(__self__, *,
                 ...
                 route_type: builtins.str,
                 status: builtins.str,
                 transit_route_table_aggregation_cidr: builtins.str,
                 transit_route_table_aggregation_description: builtins.str,
                 transit_route_table_aggregation_name: builtins.str,
                 transit_route_table_aggregation_scope: builtins.str,
                 transit_route_table_id: builtins.str):
        """
        :param builtins.str id: The ID of the Transit Route Table Aggregation. It formats as `<transit_route_table_id>:<transit_route_table_aggregation_cidr>`.
        :param builtins.str route_type: The route type of the aggregate route.
        :param builtins.str status: The status of Transit Route Table Aggregation. Valid Values: `AllConfigured`, `Configuring`, `ConfigFailed`, `PartialConfigured`, `Deleting`.
        :param builtins.str transit_route_table_aggregation_cidr: The destination CIDR block of the aggregate route.
        :param builtins.str transit_route_table_aggregation_description: The description of the aggregate route.
        :param builtins.str transit_route_table_aggregation_name: The name of the aggregate route.
        :param builtins.str transit_route_table_aggregation_scope: The scope of networks that you want to advertise the aggregate route.
        :param builtins.str transit_route_table_id: The ID of the route table of the Enterprise Edition transit router.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "route_type", route_type)
        pulumi.set(__self__, "status", status)
    ...
    def transit_route_table_aggregation_cidr(self) -> builtins.str:
        """
    ...
    def transit_route_table_aggregation_description(self) -> builtins.str:
        """
    ...
    def transit_route_table_aggregation_name(self) -> builtins.str:
        """
    ...
    def transit_route_table_aggregation_scope(self) -> builtins.str:
        """
    ...
    def transit_route_table_id(self) -> builtins.str:
        """
...
class GetTransitRouterAvailableResourcesResourceResult(dict):
    def __init__(__self__, *,
                 ...
                 master_zones: Sequence[builtins.str],
                 slave_zones: Sequence[builtins.str],
                 support_multicast: builtins.bool):
        """
        :param Sequence[builtins.str] available_zones: (Available since v1.225.0) The list of available zones.
        :param Sequence[builtins.str] master_zones: The list of primary zones.
        :param Sequence[builtins.str] slave_zones: The list of secondary zones.
        :param builtins.bool support_multicast: Specifies whether to query only the zones in which the multicast feature is supported.
        """
    ...
    def master_zones(self) -> Sequence[builtins.str]:
        """
    ...
    def slave_zones(self) -> Sequence[builtins.str]:
        """
    ...
    def support_multicast(self) -> builtins.bool:
        """
...
class GetTransitRouterCidrsCidrResult(dict):
    def __init__(__self__, *,
                 ...
                 family: builtins.str,
                 id: builtins.str,
                 publish_cidr_route: builtins.bool,
                 transit_router_cidr_id: builtins.str,
                 transit_router_cidr_name: builtins.str,
                 transit_router_id: builtins.str):
        """
        :param builtins.str cidr: The cidr of the transit router.
        :param builtins.str description: The description of the transit router.
        :param builtins.str family: The type of the transit router cidr.
        :param builtins.str id: The ID of the Cen Transit Router Cidr. It formats as `<transit_router_id>:<transit_router_cidr_id>`.
        :param builtins.bool publish_cidr_route: Whether to allow automatically adding Transit Router Cidr in Transit Router Route Table.
        :param builtins.str transit_router_cidr_id: The ID of the transit router cidr.
        :param builtins.str transit_router_cidr_name: The name of the transit router.
        :param builtins.str transit_router_id: The ID of the transit router.
        """
    ...
    def publish_cidr_route(self) -> builtins.bool:
        """
    ...
    def transit_router_cidr_id(self) -> builtins.str:
        """
    ...
    def transit_router_cidr_name(self) -> builtins.str:
        """
...
class GetTransitRouterMulticastDomainAssociationsAssociationResult(dict):
    def __init__(__self__, *,
                 ...
                 resource_owner_id: builtins.int,
                 resource_type: builtins.str,
                 status: builtins.str,
                 transit_router_attachment_id: builtins.str,
                 transit_router_multicast_domain_id: builtins.str,
                 vswitch_id: builtins.str):
        """
        :param builtins.str id: The ID of the Transit Router Multicast Domain Association. It formats as `<transit_router_multicast_domain_id>:<transit_router_attachment_id>:<vswitch_id>`.
        :param builtins.str resource_id: The ID of the resource associated with the multicast domain.
        :param builtins.int resource_owner_id: The ID of the Alibaba Cloud account to which the resource associated with the multicast domain belongs.
        :param builtins.str resource_type: The type of resource associated with the multicast domain. Valid Value: `VPC`.
        :param builtins.str status: The status of the associated resource. Valid Value: `Associated`, `Associating`, `Dissociating`.
        :param builtins.str transit_router_attachment_id: The ID of the network instance connection.
        :param builtins.str transit_router_multicast_domain_id: The ID of the multicast domain.
    ...
    def resource_owner_id(self) -> builtins.int:
        """
    ...
    def transit_router_multicast_domain_id(self) -> builtins.str:
        """
...
class GetTransitRouterMulticastDomainMembersMemberResult(dict):
    def __init__(__self__, *,
                 ...
                 vpc_id: builtins.str):
        """
        :param builtins.str group_ip_address: The IP address of the multicast group to which the multicast member belongs. If the multicast group you specified does not exist in the current multicast domain, the system will automatically create a new multicast group for you in the current multicast domain.
        :param builtins.str id: The `key` of the resource supplied above.The value is formulated as `<transit_router_multicast_domain_id>:<group_ip_address>:<network_interface_id>`.
        :param builtins.str network_interface_id: The ID of the ENI.
        :param builtins.str status: The status of the resource
        :param builtins.str transit_router_multicast_domain_id: The ID of the multicast domain to which the multicast member belongs.
        :param builtins.str vpc_id: The VPC to which the ENI of the multicast member belongs. This field is mandatory for VPCs owned by another accounts.
        """
...
class GetTransitRouterMulticastDomainPeerMembersMemberResult(dict):
    def __init__(__self__, *,
                 group_ip_address: builtins.str,
                 id: builtins.str,
                 peer_transit_router_multicast_domain_id: builtins.str,
                 status: builtins.str,
                 transit_router_multicast_domain_id: builtins.str):
        """
        :param builtins.str group_ip_address: The IP address of the multicast group to which the multicast member belongs. Value range: **224.0.0.1** to **239.255.255.254**.If the multicast group you specified does not exist in the current multicast domain, the system will automatically create a new multicast group for you in the current multicast domain.
        :param builtins.str id: The `key` of the resource supplied above.The value is formulated as `<transit_router_multicast_domain_id>:<group_ip_address>:<peer_transit_router_multicast_domain_id>`.
        :param builtins.str peer_transit_router_multicast_domain_id: The multicast domain ID of the peer transit router.
        :param builtins.str status: The status of the resource
        :param builtins.str transit_router_multicast_domain_id: The ID of the multicast domain to which the multicast member belongs.
        """
        pulumi.set(__self__, "group_ip_address", group_ip_address)
    ...
    def peer_transit_router_multicast_domain_id(self) -> builtins.str:
        """
...
class GetTransitRouterMulticastDomainSourcesSourceResult(dict):
    def __init__(__self__, *,
                 ...
                 vpc_id: builtins.str):
        """
        :param builtins.str group_ip_address: The IP address of the multicast group to which the multicast source belongs. Value range: **224.0.0.1** to **239.255.255.254**. If the multicast group you specified does not exist in the current multicast domain, the system will automatically create a new multicast group for you.
        :param builtins.str id: The id of the resource.
        :param builtins.str network_interface_id: ENI ID of the multicast source.
        :param builtins.str status: The status of the resource.
        :param builtins.str transit_router_multicast_domain_id: The ID of the multicast domain to which the multicast source belongs.
        :param builtins.str vpc_id: The VPC to which the ENI of the multicast source belongs. This field is mandatory for VPCs that is owned by another accounts.
        """
        pulumi.set(__self__, "group_ip_address", group_ip_address)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "network_interface_id", network_interface_id)
...
class GetTransitRouterMulticastDomainsDomainResult(dict):
    def __init__(__self__, *,
                 ...
                 status: builtins.str,
                 transit_router_id: builtins.str,
                 transit_router_multicast_domain_description: builtins.str,
                 transit_router_multicast_domain_id: builtins.str,
                 transit_router_multicast_domain_name: builtins.str):
        """
        :param builtins.str id: The ID of the Transit Router Multicast Domain.
        :param builtins.str status: The status of the multicast domain. Valid Value: `Active`.
        :param builtins.str transit_router_id: The ID of the transit router.
        :param builtins.str transit_router_multicast_domain_description: The description of the Transit Router Multicast Domain.
        :param builtins.str transit_router_multicast_domain_id: The ID of the multicast domain.
        :param builtins.str transit_router_multicast_domain_name: The name of the Transit Router Multicast Domain.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "status", status)
        pulumi.set(__self__, "transit_router_id", transit_router_id)
    ...
    def transit_router_multicast_domain_description(self) -> builtins.str:
        """
    ...
    def transit_router_multicast_domain_name(self) -> builtins.str:
        """
...
class GetTransitRouterPeerAttachmentsAttachmentResult(dict):
    def __init__(__self__, *,
                 ...
                 geographic_span_id: builtins.str,
                 id: builtins.str,
                 peer_transit_router_id: builtins.str,
                 peer_transit_router_owner_id: builtins.str,
                 peer_transit_router_region_id: builtins.str,
                 resource_type: builtins.str,
                 status: builtins.str,
                 transit_router_attachment_description: builtins.str,
                 transit_router_attachment_id: builtins.str,
                 transit_router_attachment_name: builtins.str,
                 transit_router_id: builtins.str):
        """
        :param builtins.bool auto_publish_route_enabled: Auto publish route enabled.
        :param builtins.int bandwidth: The bandwidth of the bandwidth package.
        :param builtins.str cen_bandwidth_package_id: ID of the CEN bandwidth package.
        :param builtins.str geographic_span_id: ID of the geographic.
        :param builtins.str id: The ID of CEN Transit Router peer attachments.
        :param builtins.str peer_transit_router_id: ID of the peer transit router.
        :param builtins.str peer_transit_router_owner_id: Owner ID of the peer transit router.
        :param builtins.str peer_transit_router_region_id: Region ID of the peer transit router.
        ...
        :param builtins.str transit_router_attachment_description: The description of CEN Transit Router peer attachments.
        :param builtins.str transit_router_attachment_id: The ID of CEN Transit Router peer attachments.
        :param builtins.str transit_router_attachment_name: Name of the transit router attachment.
    ...
    def peer_transit_router_owner_id(self) -> builtins.str:
        """
...
class GetTransitRouterPrefixListAssociationsAssociationResult(dict):
    def __init__(__self__, *,
                 ...
                 status: builtins.str,
                 transit_router_id: builtins.str,
                 transit_router_table_id: builtins.str):
        """
        :param builtins.str id: The ID of the Cen Transit Router Prefix List Association. It formats as `<prefix_list_id>:<transit_router_id>:<transit_router_table_id>:<next_hop>`.
        :param builtins.str next_hop: The ID of the next hop connection.
        :param builtins.str next_hop_instance_id: The ID of the network instance associated with the next hop connection.
        :param builtins.str next_hop_type: The type of the next hop.
        :param builtins.int owner_uid: The ID of the Alibaba Cloud account to which the prefix list belongs.
        :param builtins.str prefix_list_id: The ID of the prefix list.
        :param builtins.str status: The status of the prefix list.
        :param builtins.str transit_router_id: The ID of the transit router.
        :param builtins.str transit_router_table_id: The ID of the route table of the transit router.
        """
        pulumi.set(__self__, "id", id)
    ...
    def transit_router_table_id(self) -> builtins.str:
        """
...
class GetTransitRouterRouteEntriesEntryResult(dict):
    def __init__(__self__, *,
                 id: builtins.str,
                 status: builtins.str,
                 transit_router_route_entry_description: builtins.str,
                 transit_router_route_entry_destination_cidr_block: builtins.str,
                 transit_router_route_entry_id: builtins.str,
                 transit_router_route_entry_name: builtins.str,
                 transit_router_route_entry_next_hop_id: builtins.str,
                 transit_router_route_entry_next_hop_type: builtins.str,
                 transit_router_route_entry_type: builtins.str):
        """
        :param builtins.str transit_router_route_entry_destination_cidr_block: The target network segment of the route entry.
        :param builtins.str transit_router_route_entry_next_hop_id: ID of the next hop.
        :param builtins.str transit_router_route_entry_next_hop_type: Type of the next hop.
        :param builtins.str transit_router_route_entry_type: Type of the route entry.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "status", status)
    ...
    def transit_router_route_entry_description(self) -> builtins.str:
    ...
    def transit_router_route_entry_destination_cidr_block(self) -> builtins.str:
        """
...
class GetTransitRouterRouteTableAssociationsAssociationResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str resource_type: Type of the resource.
        :param builtins.str status: The status of the route table, including `Active`, `Associating`, `Dissociating`.
        :param builtins.str transit_router_attachment_id: The ID of the network instance connection.
...
class GetTransitRouterRouteTablesTableResult(dict):
    def __init__(__self__, *,
                 id: builtins.str,
                 status: builtins.str,
                 transit_router_route_table_description: builtins.str,
                 transit_router_route_table_id: builtins.str,
...
class GetTransitRouterVbrAttachmentsAttachmentResult(dict):
    def __init__(__self__, *,
                 ...
                 transit_router_attachment_name: builtins.str,
                 vbr_id: builtins.str,
                 vbr_owner_id: builtins.str):
        """
        :param builtins.bool auto_publish_route_enabled: ID of the region where the conflicted VBR is located.
        :param builtins.str resource_type: Type of the resource.
        :param builtins.str status: The status of the resource. Valid values `Attached`, `Attaching` and `Detaching`.
        :param builtins.str transit_router_attachment_id: ID of the transit router VBR attachment.
        :param builtins.str transit_router_attachment_name: Name of the transit router attachment.
        :param builtins.str vbr_id: ID of the VBR.
        :param builtins.str vbr_owner_id: The Owner ID of the VBR.
        """
        pulumi.set(__self__, "auto_publish_route_enabled", auto_publish_route_enabled)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "resource_type", resource_type)
    ...
    def vbr_owner_id(self) -> builtins.str:
        """
...
class GetTransitRouterVpcAttachmentsAttachmentResult(dict):
    def __init__(__self__, *,
                 ...
                 transit_router_id: builtins.str,
                 vpc_id: builtins.str,
                 vpc_owner_id: builtins.str,
                 zone_mappings: Sequence['outputs.GetTransitRouterVpcAttachmentsAttachmentZoneMappingResult']):
        """
        :param builtins.bool auto_publish_route_enabled: (Available since v1.224.0) Whether the transit router is automatically published to the VPC instance.
        :param builtins.str cen_id: The ID of the CEN instance.
        :param builtins.str payment_type: The payment type of the resource.
        :param builtins.str resource_type: The resource type of the Transit Router VPC Attachment.
        :param builtins.str status: The status of the Transit Router VPC Attachment. Valid Values: `Attached`, `Attaching`, `Detaching`.
        :param builtins.str transit_router_attachment_description: The description of the Transit Router VPC Attachment.
        :param builtins.str transit_router_attachment_id: The ID of the Transit Router VPC Attachment.
        :param builtins.str transit_router_attachment_name: The name of the Transit Router VPC Attachment.
        :param builtins.str transit_router_id: The ID of the transit router.
        :param builtins.str vpc_id: The ID of the VPC.
        :param builtins.str vpc_owner_id: The Owner ID of the VPC.
...
class GetTransitRouterVpnAttachmentsAttachmentResult(dict):
    def __init__(__self__, *,
                 ...
                 transit_router_id: builtins.str,
                 vpn_id: builtins.str,
                 vpn_owner_id: builtins.str,
                 zones: Sequence['outputs.GetTransitRouterVpnAttachmentsAttachmentZoneResult']):
        """
        :param builtins.bool auto_publish_route_enabled: Whether to allow the forwarding router instance to automatically publish routing entries to IPsec connections.
        :param builtins.str create_time: The creation time of the resource.
        :param builtins.str resource_type: Type of the resource.
        :param builtins.str status: The status of the transit router attachment.
        :param builtins.str transit_router_attachment_description: The description of the VPN connection.
        :param builtins.str transit_router_attachment_name: The name of the VPN connection.
        :param builtins.str transit_router_id: The ID of the forwarding router instance.
        :param builtins.str vpn_id: The id of the vpn.
        :param builtins.str vpn_owner_id: The owner id of vpn.
    ...
    def vpn_owner_id(self) -> builtins.str:
        """
        The owner id of vpn.
        """
...
class GetTransitRoutersTransitRouterResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 status: builtins.str,
                 transit_router_description: builtins.str,
                 transit_router_id: builtins.str,
                 transit_router_name: builtins.str,
                 type: builtins.str,
                 xgw_vip: builtins.str):
        """
        :param builtins.str ali_uid: The UID of the Aliyun.
        :param builtins.str cen_id: The ID of the CEN instance.
        :param builtins.str id: The ID of the resource, It is formatted to `<cen_id>:<transit_router_id>`. **NOTE:** Before 1.151.0, It is formatted to `<transit_router_id>`.
        :param builtins.str status: The status of the resource. Valid values `Active`, `Creating`, `Deleting` and `Updating`.
        :param builtins.str transit_router_description: The description of the transit router.
        :param builtins.str transit_router_id: The ID of the transit router.
        :param builtins.str transit_router_name: The name of the transit router.
        :param builtins.str type: The Type of the transit router.
        :param builtins.str xgw_vip: The vip of the XGW.
        """
    ...
    def transit_router_description(self) -> builtins.str:
        """
        The description of the transit router.
        """
...
class GetVbrHealthChecksCheckResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 vbr_instance_id: builtins.str,
                 vbr_instance_region_id: builtins.str):
        """
        :param builtins.str cen_id: The ID of the Cloud Enterprise Network (CEN) instance.
        :param builtins.int health_check_interval: The time interval at which probe packets are sent during the health check.
        :param builtins.str health_check_source_ip: The source IP address of the health check.
        :param builtins.str health_check_target_ip: The destination IP address of the health check.
        :param builtins.int healthy_threshold: The number of probe packets that are sent during the health check.
        :param builtins.str id: The ID of the CEN VBR Heath Check.
        :param builtins.str vbr_instance_id: The ID of the VBR instance.
        :param builtins.str vbr_instance_region_id: The ID of the region where the VBR instance is deployed.
        """
        pulumi.set(__self__, "cen_id", cen_id)
    ...
    def vbr_instance_id(self) -> builtins.str:
        """
    ...
    def vbr_instance_region_id(self) -> builtins.str:
        """
