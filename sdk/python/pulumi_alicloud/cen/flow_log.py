...
class FlowLogArgs:
    def __init__(__self__, *,
                 ...
                 log_store_name: pulumi.Input[builtins.str],
                 ...
                 log_format_string: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cen_id: cen id
        :param pulumi.Input[builtins.str] log_store_name: The LogStore that stores the flowlog.
        :param pulumi.Input[builtins.str] project_name: The Project that stores the flowlog.
        :param pulumi.Input[builtins.str] description: The description of the flowlog.
        :param pulumi.Input[builtins.str] flow_log_name: The name of the flowlog.
        :param pulumi.Input[builtins.int] interval: The duration of the capture window for the flow log to capture traffic. Unit: seconds. Valid values: `60` or **600 * *. Default value: **600 * *.
        :param pulumi.Input[builtins.str] log_format_string: Log Format
        :param pulumi.Input[builtins.str] status: The status of the flow log. Valid values:
               - `Active`: started.
               - `InActive`: not started.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the resource
        :param pulumi.Input[builtins.str] transit_router_attachment_id: Cross-region Connection ID or VBR connection ID.
               
               > **NOTE:**  This parameter is required.
        :param pulumi.Input[builtins.str] transit_router_id: Transit Router ID
        """
    ...
    def log_store_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def log_store_name(self, value: pulumi.Input[builtins.str]):
    ...
    def log_format_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Log Format
        """
    ...
    def log_format_string(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FlowLogState:
    def __init__(__self__, *,
                 ...
                 interval: Optional[pulumi.Input[builtins.int]] = None,
                 log_format_string: Optional[pulumi.Input[builtins.str]] = None,
                 log_store_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="logStoreName")
    def log_store_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The LogStore that stores the flowlog.
        """
        return pulumi.get(self, "log_store_name")
    ...
    @log_store_name.setter
    def log_store_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_store_name", value)
...
class FlowLog(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            transit_router_attachment_id: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_id: Optional[pulumi.Input[builtins.str]] = None) -> 'FlowLog':
        """
    ...
    @property
    @pulumi.getter(name="flowLogName")
    def flow_log_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the flowlog.
        """
        return pulumi.get(self, "flow_log_name")
    ...
    @property
    @pulumi.getter(name="logFormatString")
    def log_format_string(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Log Format
        """
        return pulumi.get(self, "log_format_string")
    ...
    @property
    @pulumi.getter(name="logStoreName")
    def log_store_name(self) -> pulumi.Output[builtins.str]:
        """
        The LogStore that stores the flowlog.
        """
        return pulumi.get(self, "log_store_name")
    ...
    @property
    @pulumi.getter(name="transitRouterAttachmentId")
    def transit_router_attachment_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cross-region Connection ID or VBR connection ID.
    ...
    @property
    @pulumi.getter(name="transitRouterId")
    def transit_router_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Transit Router ID
        """
        return pulumi.get(self, "transit_router_id")
