...
class TransitRouterVpcAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 transit_router_vpc_attachment_name: Optional[pulumi.Input[builtins.str]] = None,
                 transit_router_vpc_attachment_options: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.bool] auto_publish_route_enabled: Specifies whether to enable the Enterprise Edition transit router to automatically advertise routes to VPCs. Valid values:
               - **false:** (default)
        ...
        :param pulumi.Input[builtins.bool] force_delete: Whether to forcibly delete the VPC connection. The value is:
        :param pulumi.Input[builtins.str] payment_type: The billing method. The default value is `PayAsYouGo`, which specifies the pay-as-you-go billing method.
        :param pulumi.Input[builtins.str] resource_type: The resource type of the transit router vpc attachment. Default value: `VPC`. Valid values: `VPC`.
        ...
        :param pulumi.Input[builtins.str] transit_router_attachment_description: The description of the VPC connection.
               
               The description must be 2 to 256 characters in length. The description must start with a letter but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] transit_router_attachment_name: . Field 'transit_router_attachment_name' has been deprecated from provider version 1.230.1. New field 'transit_router_vpc_attachment_name' instead.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the Enterprise Edition transit router.
        :param pulumi.Input[builtins.str] transit_router_vpc_attachment_name: The name of the VPC connection.
               
               The name must be 2 to 128 characters in length, and can contain letters, digits, underscores (\\_), and hyphens (-). It must start with a letter.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] transit_router_vpc_attachment_options: TransitRouterVpcAttachmentOptions
        :param pulumi.Input[builtins.int] vpc_owner_id: VpcOwnerId
        """
    ...
    def transit_router_vpc_attachment_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def transit_router_vpc_attachment_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transit_router_vpc_attachment_name", value)

    @property
    @pulumi.getter(name="transitRouterVpcAttachmentOptions")
    def transit_router_vpc_attachment_options(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def transit_router_vpc_attachment_options(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class _TransitRouterVpcAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] transit_router_attachment_description: The description of the VPC connection.
               ...
               The description must be 2 to 256 characters in length. The description must start with a letter but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] transit_router_attachment_id: The ID of the Transit Router Attachment.
        :param pulumi.Input[builtins.str] transit_router_attachment_name: . Field 'transit_router_attachment_name' has been deprecated from provider version 1.230.1. New field 'transit_router_vpc_attachment_name' instead.
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the Enterprise Edition transit router.
        :param pulumi.Input[builtins.str] transit_router_vpc_attachment_name: The name of the VPC connection.
...
class TransitRouterVpcAttachment(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:cen/transitRouterVpcAttachment:TransitRouterVpcAttachment"
    ...
    @property
    @pulumi.getter(name="transitRouterVpcAttachmentName")
    def transit_router_vpc_attachment_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the VPC connection.
    ...
    @property
    @pulumi.getter(name="transitRouterVpcAttachmentOptions")
    def transit_router_vpc_attachment_options(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        TransitRouterVpcAttachmentOptions
        """
        return pulumi.get(self, "transit_router_vpc_attachment_options")
