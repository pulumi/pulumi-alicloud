...
def get_region_route_entries(instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str region_id: ID of the region.
    """
    __args__ = dict()
...
def get_region_route_entries_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
