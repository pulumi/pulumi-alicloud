...
def get_transit_router_multicast_domain_sources(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of the multicast domain IDs.
...
def get_transit_router_multicast_domain_sources_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
