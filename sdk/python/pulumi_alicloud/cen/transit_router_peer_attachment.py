...
class TransitRouterPeerAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] peer_transit_router_region_id: The region ID of peer transit router.
        :param pulumi.Input[builtins.bool] auto_publish_route_enabled: Auto publish route enabled. The system default value is `false`.
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth of the bandwidth package.
        :param pulumi.Input[builtins.str] bandwidth_type: The method that is used to allocate bandwidth to the cross-region connection. Valid values: `BandwidthPackage` and `DataTransfer`.
               * `DataTransfer` - uses pay-by-data-transfer bandwidth.
               * `BandwidthPackage` - allocates bandwidth from a bandwidth plan.
        :param pulumi.Input[builtins.str] cen_bandwidth_package_id: The ID of the bandwidth package. If you do not enter the ID of the package, it means you are using the test. The system default test is 1bps, demonstrating that you test network connectivity
        :param pulumi.Input[builtins.str] default_link_type: DefaultLinkType. Valid values: `Platinum` and `Gold`.
        :param pulumi.Input[builtins.bool] dry_run: Whether to perform pre-check for this request, including permission, instance status verification, etc.
        ...
        :param pulumi.Input[builtins.str] transit_router_attachment_description: The description of transit router attachment. The description is 2~256 characters long and must start with a letter or Chinese, but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] transit_router_attachment_name: The name of transit router attachment. The name is 2~128 characters in length, starts with uppercase and lowercase letters or Chinese, and can contain numbers, underscores (_) and dashes (-)
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the transit router to attach.
        """
...
class _TransitRouterPeerAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] transit_router_attachment_description: The description of transit router attachment. The description is 2~256 characters long and must start with a letter or Chinese, but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] transit_router_attachment_id: The ID of transit router attachment.
        :param pulumi.Input[builtins.str] transit_router_attachment_name: The name of transit router attachment. The name is 2~128 characters in length, starts with uppercase and lowercase letters or Chinese, and can contain numbers, underscores (_) and dashes (-)
        :param pulumi.Input[builtins.str] transit_router_id: The ID of the transit router to attach.
        """
        if auto_publish_route_enabled is not None:
...
class TransitRouterPeerAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            transit_router_attachment_id: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_attachment_name: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TransitRouterPeerAttachment':
        """
