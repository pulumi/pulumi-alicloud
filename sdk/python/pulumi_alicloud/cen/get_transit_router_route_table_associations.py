...
def get_transit_router_route_table_associations_output(ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                                       output_file: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                                       status: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                                       transit_router_attachment_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                                       transit_router_attachment_resource_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                                       transit_router_attachment_resource_type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                                       transit_router_route_table_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
