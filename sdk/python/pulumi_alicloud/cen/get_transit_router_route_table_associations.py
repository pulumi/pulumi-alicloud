...
class GetTransitRouterRouteTableAssociationsResult:
    ...
    def transit_router_attachment_resource_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "transit_router_attachment_resource_id")

    @property
    @pulumi.getter(name="transitRouterAttachmentResourceType")
    def transit_router_attachment_resource_type(self) -> Optional[builtins.str]:
...
def get_transit_router_route_table_associations(ids: Optional[Sequence[builtins.str]] = None,
                                                output_file: Optional[builtins.str] = None,
                                                status: Optional[builtins.str] = None,
                                                transit_router_attachment_id: Optional[builtins.str] = None,
                                                transit_router_attachment_resource_id: Optional[builtins.str] = None,
                                                transit_router_attachment_resource_type: Optional[builtins.str] = None,
    ...
    :param builtins.str transit_router_attachment_resource_id: The ID of the next hop.
    :param builtins.str transit_router_attachment_resource_type: The type of next hop. Valid values:
...
def get_transit_router_route_table_associations_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                       ...
                                                       transit_router_attachment_resource_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                       transit_router_attachment_resource_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                       transit_router_route_table_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
