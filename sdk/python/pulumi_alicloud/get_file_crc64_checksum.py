...
def get_file_crc64_checksum(filename: Optional[builtins.str] = None,
    ...
    :param builtins.str filename: The name of the file to be computed crc64 checksum.
    """
    __args__ = dict()
...
def get_file_crc64_checksum_output(filename: Optional[pulumi.Input[builtins.str]] = None,
