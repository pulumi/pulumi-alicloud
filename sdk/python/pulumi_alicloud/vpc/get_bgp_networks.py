...
def get_bgp_networks(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Bgp Network IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str router_id: The ID of the router to which the route table belongs.
    :param builtins.str status: The state of the advertised BGP network. Valid values: `Available`, `Pending`, `Deleting`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_bgp_networks_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
