...
class GatewayRouteTableAttachmentArgs:
    def __init__(__self__, *,
                 ipv4_gateway_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] ipv4_gateway_id: The ID of the IPv4 Gateway instance.
        :param pulumi.Input[builtins.str] route_table_id: The ID of the Gateway route table to be bound.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to only precheck this request. Default value: `false`.
        """
    ...
    def ipv4_gateway_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ipv4_gateway_id(self, value: pulumi.Input[builtins.str]):
...
class _GatewayRouteTableAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ipv4_gateway_id: The ID of the IPv4 Gateway instance.
        :param pulumi.Input[builtins.str] route_table_id: The ID of the Gateway route table to be bound.
        :param pulumi.Input[builtins.str] status: The status of the IPv4 Gateway instance. Value:
...
class GatewayRouteTableAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ipv4_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
            route_table_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'GatewayRouteTableAttachment':
        """
