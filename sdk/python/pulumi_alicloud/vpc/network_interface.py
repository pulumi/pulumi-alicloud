...
class NetworkInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vswitch_id: The VSwitch to create the ENI in.
        :param pulumi.Input[builtins.str] description: Description of the ENI. This description can have a string of 2 to 256 characters, It cannot begin with http:// or https://. Default value is null.
        :param pulumi.Input[builtins.str] name: Name of the ENI. This name can have a string of 2 to 128 characters, must contain only alphanumeric characters or hyphens, such as "-", ".", "_", and must not begin or end with a hyphen, and must not begin with http:// or https://. Default value is null.
        :param pulumi.Input[builtins.str] private_ip: The primary private IP of the ENI.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_ips: List of secondary private IPs to assign to the ENI. Don't use both private_ips and private_ips_count in the same ENI resource block.
        :param pulumi.Input[builtins.int] private_ips_count: Number of secondary private IPs to assign to the ENI. Don't use both private_ips and private_ips_count in the same ENI resource block.
        :param pulumi.Input[builtins.str] resource_group_id: The Id of resource group which the network interface belongs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: A list of security group ids to associate with.
...
class _NetworkInterfaceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description of the ENI. This description can have a string of 2 to 256 characters, It cannot begin with http:// or https://. Default value is null.
        :param pulumi.Input[builtins.str] mac: (Available in 1.54.0+) The MAC address of an ENI.
        :param pulumi.Input[builtins.str] name: Name of the ENI. This name can have a string of 2 to 128 characters, must contain only alphanumeric characters or hyphens, such as "-", ".", "_", and must not begin or end with a hyphen, and must not begin with http:// or https://. Default value is null.
        :param pulumi.Input[builtins.str] private_ip: The primary private IP of the ENI.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_ips: List of secondary private IPs to assign to the ENI. Don't use both private_ips and private_ips_count in the same ENI resource block.
        :param pulumi.Input[builtins.int] private_ips_count: Number of secondary private IPs to assign to the ENI. Don't use both private_ips and private_ips_count in the same ENI resource block.
...
class NetworkInterface(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="privateIpAddresses")
    def private_ip_addresses(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "private_ip_addresses")
