...
class Ipv6CidrBlockArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ipv6_cidr_block: The additional IPv6 CIDR block to be removed.
               
               > **NOTE:**  You must specify either the `Ipv6CidrBlock` parameter or the `SecondaryCidrBlock` parameter, but not both.
        :param pulumi.Input[_builtins.int] ipv6_cidr_mask: Add an IPv6 CIDR block to the VPC from an IPAM pool by specifying a subnet mask.
        ...
        :param pulumi.Input[_builtins.str] ipv6_ipam_pool_id: The ID of the IPAM pool instance.
