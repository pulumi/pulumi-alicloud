...
def get_bgp_groups(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Bgp Group IDs.
    :param _builtins.str name_regex: A regex string to filter results by Bgp Group name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str router_id: The ID of the virtual border router (VBR) that is associated with the BGP group.
    :param _builtins.str status: The status of the resource. Valid values: `Available`, `Deleting` and `Pending`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_bgp_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                          name_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                          output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                          router_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                          status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBgpGroupsResult]:
    """
    This data source provides the Vpc Bgp Groups of the current Alibaba Cloud user.
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:vpc/getBgpGroups:getBgpGroups', __args__, opts=opts, typ=GetBgpGroupsResult)
    return __ret__.apply(lambda __response__: GetBgpGroupsResult(
