...
def get_bgp_groups(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Bgp Group IDs.
    :param builtins.str name_regex: A regex string to filter results by Bgp Group name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str router_id: The ID of the virtual border router (VBR) that is associated with the BGP group.
    :param builtins.str status: The status of the resource. Valid values: `Available`, `Deleting` and `Pending`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_bgp_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
