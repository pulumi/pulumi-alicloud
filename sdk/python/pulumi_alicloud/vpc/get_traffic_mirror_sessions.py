...
class GetTrafficMirrorSessionsResult:
    ...
    def traffic_mirror_session_name(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "traffic_mirror_session_name")

    @_builtins.property
    @pulumi.getter(name="trafficMirrorSourceId")
    def traffic_mirror_source_id(self) -> Optional[_builtins.str]:
...
def get_traffic_mirror_sessions(enabled: Optional[_builtins.bool] = None,
                                ...
                                traffic_mirror_session_name: Optional[_builtins.str] = None,
                                traffic_mirror_source_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool enabled: Specifies whether to enable traffic mirror sessions. default to `false`.
    :param Sequence[_builtins.str] ids: A list of Traffic Mirror Session IDs.
    :param _builtins.str name_regex: A regex string to filter results by Traffic Mirror Session name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.int priority: The priority of the traffic mirror session. Valid values: `1` to `32766`. A smaller value indicates a higher priority. You cannot specify the same priority for traffic mirror sessions that are created in the same region with the same Alibaba Cloud account.
    ...
    :param _builtins.str traffic_mirror_session_name: The name of the traffic mirror session. The name must be `2` to `128` characters in length and can contain digits, underscores (_), and hyphens (-). It must start with a letter.
    :param _builtins.str traffic_mirror_source_id: The ID of the mirror source. You can specify only an elastic network interface (ENI) as the mirror source.
...
def get_traffic_mirror_sessions_output(enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                       ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                       name_regex: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                       output_file: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                       priority: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                       status: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                       traffic_mirror_filter_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                       traffic_mirror_session_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                       traffic_mirror_source_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                       traffic_mirror_target_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
