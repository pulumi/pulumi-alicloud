...
class Ipv6EgressRuleArgs:
    def __init__(__self__, *,
                 ...
                 ipv6_egress_rule_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Ipv6EgressRule resource.
        :param pulumi.Input[builtins.str] instance_id: The ID of the IPv6 address to which you want to apply the egress-only rule.
        :param pulumi.Input[builtins.str] ipv6_gateway_id: The ID of the IPv6 gateway.
        :param pulumi.Input[builtins.str] description: The description of the egress-only rule. The description must be `2` to `256` characters in length. It cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] instance_type: The type of instance to which you want to apply the egress-only rule. Valid values: `Ipv6Address`. `Ipv6Address` (default): an IPv6 address.
        :param pulumi.Input[builtins.str] ipv6_egress_rule_name: The name of the egress-only rule. The name must be `2` to `128` characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter but cannot start with `http://` or `https://`.
        """
    ...
    def ipv6_egress_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipv6_egress_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _Ipv6EgressRuleState:
    def __init__(__self__, *,
                 ...
                 instance_type: Optional[pulumi.Input[builtins.str]] = None,
                 ipv6_egress_rule_id: Optional[pulumi.Input[builtins.str]] = None,
                 ipv6_egress_rule_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_id: The ID of the IPv6 address to which you want to apply the egress-only rule.
        :param pulumi.Input[builtins.str] instance_type: The type of instance to which you want to apply the egress-only rule. Valid values: `Ipv6Address`. `Ipv6Address` (default): an IPv6 address.
        :param pulumi.Input[builtins.str] ipv6_egress_rule_id: The ID of the IPv6 EgressRule.
        :param pulumi.Input[builtins.str] ipv6_egress_rule_name: The name of the egress-only rule. The name must be `2` to `128` characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] ipv6_gateway_id: The ID of the IPv6 gateway.
    ...
    def ipv6_egress_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipv6_egress_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Ipv6EgressRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ipv6_egress_rule_name: Optional[pulumi.Input[builtins.str]] = None,
            ipv6_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'Ipv6EgressRule':
        """
    ...
    @property
    @pulumi.getter(name="ipv6EgressRuleId")
    def ipv6_egress_rule_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the IPv6 EgressRule.
        """
        return pulumi.get(self, "ipv6_egress_rule_id")
    ...
    @property
    @pulumi.getter(name="ipv6EgressRuleName")
    def ipv6_egress_rule_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the egress-only rule. The name must be `2` to `128` characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter but cannot start with `http://` or `https://`.
        """
        return pulumi.get(self, "ipv6_egress_rule_name")
