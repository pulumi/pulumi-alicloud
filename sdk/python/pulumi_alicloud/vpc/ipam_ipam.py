...
class IpamIpamArgs:
    def __init__(__self__, *,
                 ...
                 ipam_description: Optional[pulumi.Input[builtins.str]] = None,
                 ipam_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] operating_region_lists: List of IPAM effective regions.
        :param pulumi.Input[builtins.str] ipam_description: The description of IPAM.
        ...
        :param pulumi.Input[builtins.str] ipam_name: The name of the resource.
    ...
    def ipam_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipam_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipam_description", value)

    @property
    @pulumi.getter(name="ipamName")
    def ipam_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ipam_name.setter
    def ipam_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _IpamIpamState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ipam_name: The name of the resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] operating_region_lists: List of IPAM effective regions.
        :param pulumi.Input[builtins.str] private_default_scope_id: After an IPAM is created, the scope of the private network IPAM created by the system by default.
    ...
    def private_default_scope_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_default_scope_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IpamIpam(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'IpamIpam':
        """
    ...
    @property
    @pulumi.getter(name="ipamDescription")
    def ipam_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of IPAM.
        It must be 2 to 256 characters in length and must start with an uppercase letter or a Chinese character, but cannot start with 'http: // 'or 'https. If the description is not filled in, it is blank. The default value is blank.
        """
    ...
    @property
    @pulumi.getter(name="ipamName")
    def ipam_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "ipam_name")
