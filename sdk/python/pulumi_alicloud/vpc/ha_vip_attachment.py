...
class HAVipAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 havip_id: Optional[pulumi.Input[builtins.str]] = None,
                 instance_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a HAVipAttachment resource.
        :param pulumi.Input[builtins.str] instance_id: The ID of the ECS instance bound to the HaVip instance.
        :param pulumi.Input[builtins.bool] force: Whether to force the ECS instance or Eni instance bound to AVIP to be unbound. The value is:
        ...
        :param pulumi.Input[builtins.str] ha_vip_id: The ID of the HaVip instance.
        :param pulumi.Input[builtins.str] havip_id: . Field 'havip_id' has been deprecated from provider version 1.211.0. New field 'ha_vip_id' instead.
        :param pulumi.Input[builtins.str] instance_type: The type of the instance associated with the VIIP.
    ...
    def havip_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @havip_id.setter
    def havip_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HAVipAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            instance_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'HAVipAttachment':
        """
    ...
    @pulumi.getter(name="havipId")
    @_utilities.deprecated("""Field 'havip_id' has been deprecated since provider version 1.211.0. New field 'ha_vip_id' instead.""")
    def havip_id(self) -> pulumi.Output[builtins.str]:
        """
        . Field 'havip_id' has been deprecated from provider version 1.211.0. New field 'ha_vip_id' instead.
        """
        return pulumi.get(self, "havip_id")
