...
class GetPrefixListsResult:
    ...
    def prefix_list_name(self) -> Optional[builtins.str]:
        """
...
def get_prefix_lists(enable_details: Optional[builtins.bool] = None,
    ...
    :param builtins.bool enable_details: Default to `true`. Set it to `false` can hide the `entrys` to output.
    :param Sequence[builtins.str] ids: A list of Prefix List IDs.
    :param builtins.str name_regex: A regex string to filter results by Prefix List name.
...
def get_prefix_lists_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                            ...
                            prefix_list_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
