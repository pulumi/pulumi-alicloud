...
class GetRouterInterfacesResult:
    ...
    def opposite_interface_id(self) -> Optional[builtins.str]:
        """
    ...
    def opposite_interface_owner_id(self) -> Optional[builtins.str]:
        """
...
def get_router_interfaces(ids: Optional[Sequence[builtins.str]] = None,
                          name_regex: Optional[builtins.str] = None,
                          opposite_interface_id: Optional[builtins.str] = None,
                          opposite_interface_owner_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of router interface IDs.
    :param builtins.str name_regex: A regex string used to filter by router interface name.
    :param builtins.str opposite_interface_id: ID of the peer router interface.
    :param builtins.str opposite_interface_owner_id: Account ID of the owner of the peer router interface.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str role: Role of the router interface. Valid values are `InitiatingSide` (connection initiator) and 
           `AcceptingSide` (connection receiver). The value of this parameter must be `InitiatingSide` if the `router_type` is set to `VBR`.
    :param builtins.str router_id: ID of the VRouter located in the local region.
    :param builtins.str router_type: Router type in the local region. Valid values are `VRouter` and `VBR` (physical connection).
    :param builtins.str specification: Specification of the link, such as `Small.1` (10Mb), `Middle.1` (100Mb), `Large.2` (2Gb), ...etc.
    :param builtins.str status: Expected status. Valid values are `Active`, `Inactive` and `Idle`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_router_interfaces_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 opposite_interface_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 opposite_interface_owner_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
