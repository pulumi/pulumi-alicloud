...
class Ipv6AddressArgs:
    def __init__(__self__, *,
                 ...
                 ipv6_address_description: Optional[pulumi.Input[builtins.str]] = None,
                 ipv6_address_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] vswitch_id: The VSwitchId of the IPv6 address.
        :param pulumi.Input[builtins.str] address_type: The type of the IPv6 address. Value:
        ...
        :param pulumi.Input[builtins.str] ipv6_address_description: The description of the IPv6 Address. The description must be 2 to 256 characters in length. It cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] ipv6_address_name: The name of the IPv6 Address. The name must be 2 to 128 characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter but cannot start with http:// or https://.
    ...
    def ipv6_address_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipv6_address_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipv6_address_description", value)

    @property
    @pulumi.getter(name="ipv6AddressName")
    def ipv6_address_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipv6_address_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _Ipv6AddressState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ipv6_address_name: The name of the IPv6 Address. The name must be 2 to 128 characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter but cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the instance belongs.
        :param pulumi.Input[builtins.str] status: The status of the resource.  Available, Pending and Deleting.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags for the resource.
        :param pulumi.Input[builtins.str] vswitch_id: The VSwitchId of the IPv6 address.
        """
        if address_type is not None:
...
class Ipv6Address(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Ipv6Address':
        """
    ...
    @property
    @pulumi.getter(name="ipv6AddressDescription")
    def ipv6_address_description(self) -> pulumi.Output[builtins.str]:
        """
        The description of the IPv6 Address. The description must be 2 to 256 characters in length. It cannot start with http:// or https://.
        """
        return pulumi.get(self, "ipv6_address_description")
    ...
    @property
    @pulumi.getter(name="ipv6AddressName")
    def ipv6_address_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the IPv6 Address. The name must be 2 to 128 characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter but cannot start with http:// or https://.
        """
        return pulumi.get(self, "ipv6_address_name")
