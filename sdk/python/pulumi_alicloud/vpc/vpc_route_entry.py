...
class VPCRouteEntryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] destination_cidr_block: The destination network segment of the routing entry.
        :param pulumi.Input[builtins.str] route_table_id: Routing table ID
        :param pulumi.Input[builtins.str] description: Description of the route entry.
        :param pulumi.Input[Sequence[pulumi.Input['VPCRouteEntryNextHopArgs']]] next_hops: Next jump See `next_hops` below.
        :param pulumi.Input[builtins.str] nexthop_id: The ID of the next hop instance of the custom route entry.
        :param pulumi.Input[builtins.str] nexthop_type: The type of the next hop of the custom route entry. Valid values:
        ...
        :param pulumi.Input[builtins.str] route_entry_name: The name of the route entry.
...
class _VPCRouteEntryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VPCRouteEntryRoutePublishTargetArgs']]] route_publish_targets: Route publish status and publish target type See `route_publish_targets` below.
        :param pulumi.Input[builtins.str] route_table_id: Routing table ID
        :param pulumi.Input[builtins.str] status: The status of the route entry.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
...
class VPCRouteEntry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            route_publish_targets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VPCRouteEntryRoutePublishTargetArgs', 'VPCRouteEntryRoutePublishTargetArgsDict']]]]] = None,
            route_table_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'VPCRouteEntry':
        """
    ...
    @property
    @pulumi.getter(name="nexthopId")
    def nexthop_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the next hop instance of the custom route entry.
        """
        return pulumi.get(self, "nexthop_id")
    ...
    @property
    @pulumi.getter(name="nexthopType")
    def nexthop_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the next hop of the custom route entry. Valid values:
        - `Instance` (default): The ECS Instance.
        - `HaVip`: a highly available virtual IP address.
    ...
    @property
    @pulumi.getter(name="routeEntryName")
    def route_entry_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the route entry.
        """
        return pulumi.get(self, "route_entry_name")
