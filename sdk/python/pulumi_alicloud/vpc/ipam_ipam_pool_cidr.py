...
class IpamIpamPoolCidrArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cidr: The CIDR address segment to be preset.
               
               > **NOTE:**  currently, only IPv4 address segments are supported.
        :param pulumi.Input[builtins.str] ipam_pool_id: The ID of the IPAM pool instance.
        """
...
class IpamIpamPoolCidr(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cidr: Optional[pulumi.Input[builtins.str]] = None,
            ipam_pool_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'IpamIpamPoolCidr':
        """
