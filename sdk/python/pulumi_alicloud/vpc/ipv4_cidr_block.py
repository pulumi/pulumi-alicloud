...
class Ipv4CidrBlockArgs:
    def __init__(__self__, *,
                 ...
                 secondary_cidr_block: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] secondary_cidr_block: Additional network segment information.
    ...
    def secondary_cidr_block(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def secondary_cidr_block(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _Ipv4CidrBlockState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ipv4_ipam_pool_id: The ID of the IP Address Manager (IPAM) pool that contains IPv4 addresses.
        :param pulumi.Input[builtins.str] region_id: The ID of the region where the VPC resides.
        :param pulumi.Input[builtins.str] secondary_cidr_block: Additional network segment information.
        :param pulumi.Input[builtins.int] secondary_cidr_mask: Add an additional CIDR block from the IPAM address pool to the VPC by entering a mask.
...
class Ipv4CidrBlock(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secondary_cidr_block: Optional[pulumi.Input[builtins.str]] = None,
            secondary_cidr_mask: Optional[pulumi.Input[builtins.int]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Ipv4CidrBlock':
        """
    ...
    @property
    @pulumi.getter(name="secondaryCidrBlock")
    def secondary_cidr_block(self) -> pulumi.Output[builtins.str]:
        """
        Additional network segment information.
        """
        return pulumi.get(self, "secondary_cidr_block")
