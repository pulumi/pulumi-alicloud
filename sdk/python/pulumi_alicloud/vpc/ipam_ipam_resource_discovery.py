...
class IpamIpamResourceDiscoveryArgs:
    def __init__(__self__, *,
                 operating_region_lists: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 ipam_resource_discovery_description: Optional[pulumi.Input[builtins.str]] = None,
                 ipam_resource_discovery_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] operating_region_lists: The list of operating regions for resource discovery.
        :param pulumi.Input[builtins.str] ipam_resource_discovery_description: The description of resource discovery.
        :param pulumi.Input[builtins.str] ipam_resource_discovery_name: The name of the resource
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Label list information.
        """
    ...
    def operating_region_lists(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def operating_region_lists(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "operating_region_lists", value)

    @property
    @pulumi.getter(name="ipamResourceDiscoveryDescription")
    def ipam_resource_discovery_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipam_resource_discovery_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipam_resource_discovery_description", value)

    @property
    @pulumi.getter(name="ipamResourceDiscoveryName")
    def ipam_resource_discovery_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipam_resource_discovery_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _IpamIpamResourceDiscoveryState:
    def __init__(__self__, *,
                 ...
                 ipam_resource_discovery_description: Optional[pulumi.Input[builtins.str]] = None,
                 ipam_resource_discovery_name: Optional[pulumi.Input[builtins.str]] = None,
                 operating_region_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] create_time: The time when the resource discovery was created.
        :param pulumi.Input[builtins.str] ipam_resource_discovery_description: The description of resource discovery.
        :param pulumi.Input[builtins.str] ipam_resource_discovery_name: The name of the resource
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] operating_region_lists: The list of operating regions for resource discovery.
        :param pulumi.Input[builtins.str] region_id: The region ID of the resource
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group
        :param pulumi.Input[builtins.str] status: The status of the resource discovery instance. Value:
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Label list information.
        """
    ...
    @property
    @pulumi.getter(name="operatingRegionLists")
    def operating_region_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of operating regions for resource discovery.
        """
        return pulumi.get(self, "operating_region_lists")
    ...
    @operating_region_lists.setter
    def operating_region_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "operating_region_lists", value)
...
class IpamIpamResourceDiscovery(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:vpc/ipamIpamResourceDiscovery:IpamIpamResourceDiscovery"
    ...
    def get(resource_name: str,
            ...
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'IpamIpamResourceDiscovery':
        """
    ...
    @property
    @pulumi.getter(name="ipamResourceDiscoveryDescription")
    def ipam_resource_discovery_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of resource discovery.
        """
        return pulumi.get(self, "ipam_resource_discovery_description")
    ...
    @property
    @pulumi.getter(name="ipamResourceDiscoveryName")
    def ipam_resource_discovery_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the resource
        """
        return pulumi.get(self, "ipam_resource_discovery_name")
    ...
    @property
    @pulumi.getter(name="operatingRegionLists")
    def operating_region_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of operating regions for resource discovery.
        """
        return pulumi.get(self, "operating_region_lists")
