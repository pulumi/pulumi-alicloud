...
class PublicIpAddressPoolArgs:
    def __init__(__self__, *,
                 ...
                 public_ip_address_pool_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] biz_type: The name of the VPC Public IP address pool.
        :param pulumi.Input[builtins.str] description: Description.
        :param pulumi.Input[builtins.str] isp: The Internet service provider. Valid values: `BGP`, `BGP_PRO`, `ChinaTelecom`, `ChinaUnicom`, `ChinaMobile`, `ChinaTelecom_L2`, `ChinaUnicom_L2`, `ChinaMobile_L2`, `BGP_FinanceCloud`. Default Value: `BGP`.
        :param pulumi.Input[builtins.str] public_ip_address_pool_name: The name of the VPC Public IP address pool.
        :param pulumi.Input[builtins.str] resource_group_id: The resource group ID of the VPC Public IP address pool.
    ...
    def public_ip_address_pool_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the VPC Public IP address pool.
        """
    ...
    def public_ip_address_pool_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PublicIpAddressPoolState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ip_address_remaining: Optional[pulumi.Input[builtins.bool]] = None,
                 isp: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 total_ip_num: Optional[pulumi.Input[builtins.int]] = None,
                 used_ip_num: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] description: Description.
        :param pulumi.Input[builtins.bool] ip_address_remaining: Whether there is a free IP address.
        :param pulumi.Input[builtins.str] isp: The Internet service provider. Valid values: `BGP`, `BGP_PRO`, `ChinaTelecom`, `ChinaUnicom`, `ChinaMobile`, `ChinaTelecom_L2`, `ChinaUnicom_L2`, `ChinaMobile_L2`, `BGP_FinanceCloud`. Default Value: `BGP`.
        :param pulumi.Input[builtins.str] public_ip_address_pool_name: The name of the VPC Public IP address pool.
        :param pulumi.Input[builtins.str] resource_group_id: The resource group ID of the VPC Public IP address pool.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_protection_types: Security protection level.
               - If the configuration is empty, the default value is DDoS protection (Basic edition).
               - `AntiDDoS_Enhanced` indicates DDoS protection (enhanced version).
        :param pulumi.Input[builtins.str] status: The status of the VPC Public IP address pool.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags of PrefixList.
        :param pulumi.Input[builtins.int] total_ip_num: The total number of public IP address pools.
        :param pulumi.Input[builtins.int] used_ip_num: The number of used IP addresses in the public IP address pool.
        """
        if biz_type is not None:
            pulumi.set(__self__, "biz_type", biz_type)
    ...
    def ip_address_remaining(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ip_address_remaining(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def total_ip_num(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @total_ip_num.setter
    def total_ip_num(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "total_ip_num", value)

    @property
    @pulumi.getter(name="usedIpNum")
    def used_ip_num(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @used_ip_num.setter
    def used_ip_num(self, value: Optional[pulumi.Input[builtins.int]]):
...
class PublicIpAddressPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            total_ip_num: Optional[pulumi.Input[builtins.int]] = None,
            used_ip_num: Optional[pulumi.Input[builtins.int]] = None) -> 'PublicIpAddressPool':
        """
    ...
    @property
    @pulumi.getter(name="ipAddressRemaining")
    def ip_address_remaining(self) -> pulumi.Output[builtins.bool]:
        """
        Whether there is a free IP address.
        """
        return pulumi.get(self, "ip_address_remaining")
    ...
    @property
    @pulumi.getter(name="publicIpAddressPoolName")
    def public_ip_address_pool_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the VPC Public IP address pool.
        """
        return pulumi.get(self, "public_ip_address_pool_name")
    ...
    @property
    @pulumi.getter(name="totalIpNum")
    def total_ip_num(self) -> pulumi.Output[builtins.int]:
        """
        The total number of public IP address pools.
        """
        return pulumi.get(self, "total_ip_num")
    ...
    @property
    @pulumi.getter(name="usedIpNum")
    def used_ip_num(self) -> pulumi.Output[builtins.int]:
        """
        The number of used IP addresses in the public IP address pool.
        """
        return pulumi.get(self, "used_ip_num")
