...
def get_traffic_mirror_filter_ingress_rules(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Traffic Mirror Filter Ingress Rule IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the resource. Valid values:`Creating`, `Created`, `Modifying` and `Deleting`.
    :param builtins.str traffic_mirror_filter_id: The ID of the Traffic Mirror Filter.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_traffic_mirror_filter_ingress_rules_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
