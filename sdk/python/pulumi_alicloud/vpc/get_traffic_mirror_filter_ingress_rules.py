...
def get_traffic_mirror_filter_ingress_rules(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Traffic Mirror Filter Ingress Rule IDs.
    ...
    :param _builtins.str traffic_mirror_filter_id: The ID of the Traffic Mirror Filter.
    """
    __args__ = dict()
    __args__['ids'] = ids
