...
class HaVipv2Args:
    def __init__(__self__, *,
                 ...
                 havip_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] vswitch_id: The switch ID to which the HaVip instance belongs.
               
               The following arguments will be discarded. Please use new fields as soon as possible:
        :param pulumi.Input[builtins.str] description: The description of the HaVip instance. The length is 2 to 256 characters.
        :param pulumi.Input[builtins.str] ha_vip_name: The name of the HaVip instance.
        :param pulumi.Input[builtins.str] havip_name: Field 'havip_name' has been deprecated from provider version 1.205.0. New field 'ha_vip_name' instead.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags of HaVip.
        """
    ...
    def havip_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @havip_name.setter
    def havip_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _HaVipv2State:
    def __init__(__self__, *,
                 associated_eip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 associated_instance_type: Optional[pulumi.Input[builtins.str]] = None,
                 associated_instances: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] associated_eip_addresses: EIP bound to HaVip.
        :param pulumi.Input[builtins.str] associated_instance_type: The type of the instance that is bound to the HaVip. Value:-**EcsInstance**: ECS instance.-**NetworkInterface**: ENI instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] associated_instances: An ECS instance that is bound to HaVip.
        :param pulumi.Input[builtins.str] create_time: The creation time of the resource.
        :param pulumi.Input[builtins.str] description: The description of the HaVip instance. The length is 2 to 256 characters.
        :param pulumi.Input[builtins.str] ha_vip_id: The ID of the resource.
        :param pulumi.Input[builtins.str] ha_vip_name: The name of the HaVip instance.
        :param pulumi.Input[builtins.str] havip_name: Field 'havip_name' has been deprecated from provider version 1.205.0. New field 'ha_vip_name' instead.
        :param pulumi.Input[builtins.str] ip_address: The ip address of the HaVip. If not filled, the default will be assigned one from the vswitch.
        :param pulumi.Input[builtins.str] master_instance_id: The primary instance ID bound to HaVip.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] status: The status of this resource instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags of HaVip.
        :param pulumi.Input[builtins.str] vpc_id: The VPC ID to which the HaVip instance belongs.
        :param pulumi.Input[builtins.str] vswitch_id: The switch ID to which the HaVip instance belongs.
    ...
    def associated_eip_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        EIP bound to HaVip.
        """
    ...
    def associated_eip_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def associated_instances(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def associated_instances(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class HaVipv2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'HaVipv2':
        """
    ...
    @property
    @pulumi.getter(name="associatedEipAddresses")
    def associated_eip_addresses(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        EIP bound to HaVip.
        """
        return pulumi.get(self, "associated_eip_addresses")
    ...
    @property
    @pulumi.getter(name="associatedInstances")
    def associated_instances(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        An ECS instance that is bound to HaVip.
        """
        return pulumi.get(self, "associated_instances")
    ...
    @pulumi.getter(name="havipName")
    @_utilities.deprecated("""Field 'havip_name' has been deprecated from provider version 1.205.0. New field 'ha_vip_name' instead.""")
    def havip_name(self) -> pulumi.Output[builtins.str]:
        """
        Field 'havip_name' has been deprecated from provider version 1.205.0. New field 'ha_vip_name' instead.
        """
        return pulumi.get(self, "havip_name")
