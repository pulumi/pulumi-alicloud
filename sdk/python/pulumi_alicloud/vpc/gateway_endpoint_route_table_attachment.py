...
class GatewayEndpointRouteTableAttachmentArgs:
    def __init__(__self__, *,
                 gateway_endpoint_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] gateway_endpoint_id: The ID of the gateway endpoint instance to which you want to associate the route table.
    ...
    def gateway_endpoint_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def gateway_endpoint_id(self, value: pulumi.Input[builtins.str]):
...
class _GatewayEndpointRouteTableAttachmentState:
    def __init__(__self__, *,
                 gateway_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] gateway_endpoint_id: The ID of the gateway endpoint instance to which you want to associate the route table.
        :param pulumi.Input[builtins.str] route_table_id: Routing table ID.
        :param pulumi.Input[builtins.str] status: Status of the gateway endpoint.
        """
    ...
    @property
    @pulumi.getter(name="gatewayEndpointId")
    def gateway_endpoint_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the gateway endpoint instance to which you want to associate the route table.
        """
        return pulumi.get(self, "gateway_endpoint_id")
    ...
    @gateway_endpoint_id.setter
    def gateway_endpoint_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "gateway_endpoint_id", value)
...
class GatewayEndpointRouteTableAttachment(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:vpc/gatewayEndpointRouteTableAttachment:GatewayEndpointRouteTableAttachment"
    ...
    def get(resource_name: str,
            ...
            gateway_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
            route_table_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'GatewayEndpointRouteTableAttachment':
        """
    ...
    @property
    @pulumi.getter(name="gatewayEndpointId")
    def gateway_endpoint_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the gateway endpoint instance to which you want to associate the route table.
        """
        return pulumi.get(self, "gateway_endpoint_id")
