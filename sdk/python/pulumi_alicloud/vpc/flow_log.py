...
class FlowLogArgs:
    def __init__(__self__, *,
                 ...
                 traffic_paths: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a FlowLog resource.
        :param pulumi.Input[builtins.str] log_store_name: The name of the logstore.
        ...
        :param pulumi.Input[builtins.str] resource_type: The resource type of the traffic captured by the flow log:
               - `NetworkInterface`: ENI.
               - `VSwitch`: All ENIs in the VSwitch.
               - `VPC`: All ENIs in the VPC.
        :param pulumi.Input[builtins.str] traffic_type: The type of traffic collected. Valid values:
               - *All**: All traffic.
               - *Allow**: Access control allowedtraffic.
               - *Drop**: Access control denied traffic.
        :param pulumi.Input[builtins.str] aggregation_interval: Data aggregation interval
        :param pulumi.Input[builtins.str] description: The Description of the VPC Flow Log.
        :param pulumi.Input[builtins.str] flow_log_name: The Name of the VPC Flow Log.
        :param pulumi.Input[builtins.str] ip_version: The IP address type of the collected traffic.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] status: The status of the VPC Flow Log. Valid values: `Active` and `Inactive`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the current instance resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] traffic_paths: The collected flow path. Value:
    ...
    def traffic_paths(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def traffic_paths(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _FlowLogState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] aggregation_interval: Data aggregation interval
        :param pulumi.Input[builtins.str] business_status: Business status
        :param pulumi.Input[builtins.str] create_time: Creation time
        :param pulumi.Input[builtins.str] description: The Description of the VPC Flow Log.
        :param pulumi.Input[builtins.str] flow_log_id: The flow log ID.
        :param pulumi.Input[builtins.str] flow_log_name: The Name of the VPC Flow Log.
        :param pulumi.Input[builtins.str] ip_version: The IP address type of the collected traffic.
        :param pulumi.Input[builtins.str] log_store_name: The name of the logstore.
        :param pulumi.Input[builtins.str] project_name: The name of the project.
        :param pulumi.Input[builtins.str] region_id: (Available since v1.243.0) The region ID.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] resource_id: The ID of the resource.
        :param pulumi.Input[builtins.str] resource_type: The resource type of the traffic captured by the flow log:
               - `NetworkInterface`: ENI.
...
class FlowLog(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            traffic_paths: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            traffic_type: Optional[pulumi.Input[builtins.str]] = None) -> 'FlowLog':
        """
    ...
    @property
    @pulumi.getter(name="trafficPaths")
    def traffic_paths(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The collected flow path. Value:
        - *all**: indicates full acquisition.
        - *internetGateway**: indicates public network traffic collection.
