...
@pulumi.input_type
class TrafficMirrorFilterIngressRuleInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] destination_cidr_block: The destination CIDR block of the inbound traffic.
        :param pulumi.Input[builtins.int] priority: The priority of the inbound rule. A smaller value indicates a higher priority. The maximum value is `10`, which indicates that you can configure at most 10 inbound rules for a filter.
        :param pulumi.Input[builtins.str] protocol: The transport protocol used by inbound traffic that needs to be mirrored. Valid values: `ALL`, `ICMP`, `TCP`, `UDP`.
        :param pulumi.Input[builtins.str] source_cidr_block: The source CIDR block of the inbound traffic.
        :param pulumi.Input[builtins.str] traffic_mirror_filter_id: The ID of the filter.
               
               The following arguments will be discarded. Please use new fields as soon as possible:
        :param pulumi.Input[builtins.str] action: The collection policy of the inbound rule. Valid values: `accept` or `drop`. `accept`: collects network traffic. `drop`: does not collect network traffic.
        :param pulumi.Input[builtins.str] destination_port_range: The destination CIDR block of the inbound traffic. Valid values: `1` to `65535`. Separate the first port and last port with a forward slash (/), for example, `1/200` or `80/80`. A value of `-1/-1` indicates that all ports are available. Therefore, do not set the value to `-1/-1`. **NOTE:** When `protocol` is `ICMP`, this parameter is invalid.
        :param pulumi.Input[builtins.bool] dry_run: Whether to PreCheck this request only. Value:
        ...
        :param pulumi.Input[builtins.str] rule_action: . Field 'rule_action' has been deprecated from provider version 1.211.0. New field 'action' instead.
        :param pulumi.Input[builtins.str] source_port_range: The source port range of the inbound traffic. Valid values: `1` to `65535`. Separate the first port and last port with a forward slash (/), for example, `1/200` or `80/80`. A value of `-1/-1` indicates that all ports are available. Therefore, do not set the value to `-1/-1`. **NOTE:** When `protocol` is `ICMP`, this parameter is invalid.
        """
...
class _TrafficMirrorFilterIngressRuleState:
    def __init__(__self__, *,
                 ...
                 traffic_mirror_filter_ingress_rule_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] source_cidr_block: The source CIDR block of the inbound traffic.
        :param pulumi.Input[builtins.str] source_port_range: The source port range of the inbound traffic. Valid values: `1` to `65535`. Separate the first port and last port with a forward slash (/), for example, `1/200` or `80/80`. A value of `-1/-1` indicates that all ports are available. Therefore, do not set the value to `-1/-1`. **NOTE:** When `protocol` is `ICMP`, this parameter is invalid.
        :param pulumi.Input[builtins.str] status: The state of the inbound rule. `Creating`, `Created`, `Modifying` and `Deleting`.
        :param pulumi.Input[builtins.str] traffic_mirror_filter_id: The ID of the filter.
               
               The following arguments will be discarded. Please use new fields as soon as possible:
        :param pulumi.Input[builtins.str] traffic_mirror_filter_ingress_rule_id: The ID of the outbound rule.
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
    ...
    def traffic_mirror_filter_ingress_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def traffic_mirror_filter_ingress_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "traffic_mirror_filter_ingress_rule_id", value)


@pulumi.type_token("alicloud:vpc/trafficMirrorFilterIngressRule:TrafficMirrorFilterIngressRule")
class TrafficMirrorFilterIngressRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param TrafficMirrorFilterIngressRuleInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TrafficMirrorFilterIngressRuleInitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            traffic_mirror_filter_id: Optional[pulumi.Input[builtins.str]] = None,
            traffic_mirror_filter_ingress_rule_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TrafficMirrorFilterIngressRule':
        """
    ...
    @property
    @pulumi.getter(name="trafficMirrorFilterIngressRuleId")
    def traffic_mirror_filter_ingress_rule_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the outbound rule.
        """
        return pulumi.get(self, "traffic_mirror_filter_ingress_rule_id")
