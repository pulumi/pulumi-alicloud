...
class RouteTableAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] route_table_id: The ID of the route table to be bound to the switch.
        :param pulumi.Input[builtins.str] vswitch_id: The ID of the switch to bind the route table.
        """
...
@pulumi.type_token("alicloud:vpc/routeTableAttachment:RouteTableAttachment")
class RouteTableAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            route_table_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RouteTableAttachment':
        """
