...
class IpamIpamScopeArgs:
    def __init__(__self__, *,
                 ...
                 ipam_scope_description: Optional[pulumi.Input[builtins.str]] = None,
                 ipam_scope_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] ipam_id: The id of the Ipam instance.
        :param pulumi.Input[builtins.str] ipam_scope_description: The description of the IPAM's scope of action.
        ...
        :param pulumi.Input[builtins.str] ipam_scope_name: The name of the resource.
        :param pulumi.Input[builtins.str] ipam_scope_type: IPAM scope of action type:
               `private`.
    ...
    def ipam_scope_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipam_scope_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipam_scope_description", value)

    @property
    @pulumi.getter(name="ipamScopeName")
    def ipam_scope_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipam_scope_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("alicloud:vpc/ipamIpamScope:IpamIpamScope")
class IpamIpamScope(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'IpamIpamScope':
        """
    ...
    @property
    @pulumi.getter(name="ipamScopeDescription")
    def ipam_scope_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the IPAM's scope of action.
        It must be 2 to 256 characters in length and must start with a lowercase letter, but cannot start with 'http:// 'or 'https. If it is not filled in, it is empty. The default value is empty.
        """
    ...
    @property
    @pulumi.getter(name="ipamScopeName")
    def ipam_scope_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "ipam_scope_name")
    ...
    @property
    @pulumi.getter(name="ipamScopeType")
    def ipam_scope_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        IPAM scope of action type:
        `private`.
