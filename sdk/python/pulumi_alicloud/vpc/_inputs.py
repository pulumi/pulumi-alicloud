...
if not MYPY:
    class DhcpOptionsSetAssociateVpcArgsDict(TypedDict):
        ...
        """
        associate_status: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DhcpOptionsSetAssociateVpcArgs:
    def __init__(__self__, *,
                 vpc_id: pulumi.Input[builtins.str],
                 associate_status: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC network that is associated with the DHCP options set.
        :param pulumi.Input[builtins.str] associate_status: The status of the VPC associated with the DHCP option set.
        """
    ...
    def associate_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The status of the VPC associated with the DHCP option set.
        """
    ...
    def associate_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "associate_status", value)


if not MYPY:
    class NatGatewayAccessModeArgsDict(TypedDict):
        mode_value: NotRequired[pulumi.Input[builtins.str]]
        """
        The mode of Access. Valid values:
        """
        tunnel_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class NatGatewayAccessModeArgs:
    def __init__(__self__, *,
                 mode_value: Optional[pulumi.Input[builtins.str]] = None,
                 tunnel_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] mode_value: The mode of Access. Valid values:
        :param pulumi.Input[builtins.str] tunnel_type: The type of Tunnel. Valid values: `geneve`. **NOTE:** `tunnel_type` takes effect only if `mode_value` is set to `tunnel`.
        """
    ...
    def mode_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The mode of Access. Valid values:
        """
    ...
    @mode_value.setter
    def mode_value(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NetworkAclAttachmentResourceArgs:
    def __init__(__self__, *,
                 ...
                 resource_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] resource_id: The resource id that the network acl will associate with.
        :param pulumi.Input[builtins.str] resource_type: The resource id that the network acl will associate with. Only support `VSwitch` now.
        """
...
if not MYPY:
    class NetworkAclEgressAclEntryArgsDict(TypedDict):
        ...
        """
        destination_cidr_ip: NotRequired[pulumi.Input[builtins.str]]
        """
        The network of the destination address.
        """
        entry_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class NetworkAclEgressAclEntryArgs:
    def __init__(__self__, *,
                 ...
                 destination_cidr_ip: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] description: The description of the outbound rule.  The description must be 1 to 256 characters in length and cannot start with http:// or https.
        :param pulumi.Input[builtins.str] destination_cidr_ip: The network of the destination address.
        :param pulumi.Input[builtins.str] entry_type: The route entry type. The value can be `custom`, indicating custom.
        :param pulumi.Input[builtins.str] ip_version: The IP protocol version of the route entry. Valid values: "IPV4" and "IPV4'.
        :param pulumi.Input[builtins.str] network_acl_entry_name: Name of the outbound rule entry.  The name must be 1 to 128 characters in length and cannot start with http:// or https.
        :param pulumi.Input[builtins.str] policy: Authorization policy. Value:
               - accept: Allow.
               - drop: Refused.
        :param pulumi.Input[builtins.str] port: The destination port range of the outbound rule.  When the Protocol type of the outbound rule is all, icmp, or gre, the port range is - 1/-1, indicating that the port is not restricted. When the Protocol type of the outbound rule is tcp or udp, the port range is 1 to 65535, and the format is 1/200 or 80/80, indicating port 1 to port 200 or port 80.
        :param pulumi.Input[builtins.str] protocol: The protocol type. Value:
               - icmp: Network Control Message Protocol.
               - gre: Generic Routing Encapsulation Protocol.
               - tcp: Transmission Control Protocol.
               - udp: User Datagram Protocol.
    ...
    def destination_cidr_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The network of the destination address.
        """
    ...
    def destination_cidr_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NetworkAclEntriesEgressArgs:
    def __init__(__self__, *,
                 ...
                 protocol: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] destination_cidr_ip: The destination ip of the egress entry.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if destination_cidr_ip is not None:
...
if not MYPY:
    class NetworkAclEntriesIngressArgsDict(TypedDict):
        ...
        port: NotRequired[pulumi.Input[builtins.str]]
        protocol: NotRequired[pulumi.Input[builtins.str]]
        source_cidr_ip: NotRequired[pulumi.Input[builtins.str]]
        """
...
class NetworkAclEntriesIngressArgs:
    def __init__(__self__, *,
                 ...
                 port: Optional[pulumi.Input[builtins.str]] = None,
                 protocol: Optional[pulumi.Input[builtins.str]] = None,
                 source_cidr_ip: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] source_cidr_ip: The source ip of the ingress entry.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if entry_type is not None:
    ...
    def source_cidr_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The source ip of the ingress entry.
        """
    ...
    def source_cidr_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NetworkAclIngressAclEntryArgs:
    def __init__(__self__, *,
                 ...
                 source_cidr_ip: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] description: Description of the inbound rule.  The description must be 1 to 256 characters in length and cannot start with http:// or https.
        :param pulumi.Input[builtins.str] entry_type: The route entry type. The value can be `custom`, indicating custom.
        :param pulumi.Input[builtins.str] ip_version: The IP protocol version of the route entry. Valid values: "IPV4" and "IPV6'.
        :param pulumi.Input[builtins.str] network_acl_entry_name: The name of the inbound rule entry.  The name must be 1 to 128 characters in length and cannot start with http:// or https.
        :param pulumi.Input[builtins.str] policy: Authorization policy. Value:
               - accept: Allow.
               - drop: Refused.
        :param pulumi.Input[builtins.str] port: The source port range of the inbound rule.  When the Protocol type of the inbound rule is all, icmp, or gre, the port range is - 1/-1, indicating that the port is not restricted. When the Protocol type of the inbound rule is tcp or udp, the port range is 1 to 65535, and the format is 1/200 or 80/80, indicating port 1 to port 200 or port 80.
        :param pulumi.Input[builtins.str] protocol: The protocol type. Value:
               - icmp: Network Control Message Protocol.
               - gre: Generic Routing Encapsulation Protocol.
               - tcp: Transmission Control Protocol.
               - udp: User Datagram Protocol.
               - all: Supports all protocols.
        :param pulumi.Input[builtins.str] source_cidr_ip: Source address network segment.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if entry_type is not None:
...
class NetworkAclResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_type: The type of the associated resource.
...
if not MYPY:
    class NetworkIpv6CidrBlockArgsDict(TypedDict):
        ...
        """
        ipv6_isp: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PrefixListEntryArgs:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cidr: The CIDR address block of the prefix list.
        :param pulumi.Input[builtins.str] description: The description of the cidr entry. It must be 2 to 256 characters in length and must start with a letter or Chinese, but cannot start with `http://` or `https://`.
        """
        if cidr is not None:
...
if not MYPY:
    class PrefixListPrefixListAssociationArgsDict(TypedDict):
        ...
        """
        resource_uid: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PrefixListPrefixListAssociationArgs:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] owner_id: The ID of the Alibaba Cloud account (primary account) to which the prefix list belongs.
        :param pulumi.Input[builtins.str] prefix_list_id: The ID of the query Prefix List.
        :param pulumi.Input[builtins.str] reason: Reason when the association fails.
        :param pulumi.Input[builtins.str] region_id: The region ID of the prefix list to be queried.
        :param pulumi.Input[builtins.str] resource_id: The ID of the associated resource.
        :param pulumi.Input[builtins.str] resource_type: The associated resource type. Value:-**vpcRouteTable**: The VPC route table.-**trRouteTable**: the routing table of the forwarding router.
        :param pulumi.Input[builtins.str] resource_uid: The ID of the Alibaba Cloud account (primary account) to which the resource bound to the prefix list belongs.
...
if not MYPY:
    class TrafficMirrorFilterEgressRuleArgsDict(TypedDict):
        ...
        traffic_mirror_filter_rule_status: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class TrafficMirrorFilterEgressRuleArgs:
    def __init__(__self__, *,
                 ...
                 traffic_mirror_filter_rule_status: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def traffic_mirror_filter_rule_status(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "traffic_mirror_filter_rule_status")

    @traffic_mirror_filter_rule_status.setter
    def traffic_mirror_filter_rule_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class VPCRouteEntryNextHopArgsDict(TypedDict):
        enabled: NotRequired[pulumi.Input[builtins.int]]
        """
        Whether the route is available.
        """
        next_hop_region_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        nexthop_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ID of next hop
        """
        nexthop_type: NotRequired[pulumi.Input[builtins.str]]
        """
        type of next hop
        """
...
class VPCRouteEntryNextHopArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.int]] = None,
                 next_hop_region_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.int] enabled: Whether the route is available.
        :param pulumi.Input[builtins.str] next_hop_region_id: The region of the next instance.
        :param pulumi.Input['VPCRouteEntryNextHopNextHopRelatedInfoArgs'] next_hop_related_info: Next hop information.
        :param pulumi.Input[builtins.str] nexthop_id: ID of next hop
        :param pulumi.Input[builtins.str] nexthop_type: type of next hop
        :param pulumi.Input[builtins.int] weight: The weight of the route entry.
        """
    ...
    @property
    @pulumi.getter
    def enabled(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Whether the route is available.
        """
    ...
    @enabled.setter
    def enabled(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "enabled", value)

    @property
    @pulumi.getter(name="nextHopRegionId")
    def next_hop_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The region of the next instance.
        """
    ...
    def next_hop_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VPCRouteEntryNextHopNextHopRelatedInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_type: InstanceType
        :param pulumi.Input[builtins.str] region_id: The region of the instance associated with the next hop.
        """
...
if not MYPY:
    class VPCRouteEntryRoutePublishTargetArgsDict(TypedDict):
        ...
        """
        publish_status: NotRequired[pulumi.Input[builtins.str]]
        """
        Route Publish Status
        """
        target_instance_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VPCRouteEntryRoutePublishTargetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] target_type: Route publish target type
        :param pulumi.Input[builtins.str] publish_status: Route Publish Status
        :param pulumi.Input[builtins.str] target_instance_id: Route publish target instance id.
        """
