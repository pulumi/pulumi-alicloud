...
class GetPublicIpAddressPoolCidrBlocksResult:
    ...
    def public_ip_address_pool_id(self) -> builtins.str:
        """
...
def get_public_ip_address_pool_cidr_blocks(cidr_block: Optional[builtins.str] = None,
                                           ids: Optional[Sequence[builtins.str]] = None,
                                           output_file: Optional[builtins.str] = None,
                                           public_ip_address_pool_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cidr_block: The CIDR block.
    :param Sequence[builtins.str] ids: A list of Vpc Public Ip Address Pool Cidr Block IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str public_ip_address_pool_id: The ID of the Vpc Public IP address pool.
    :param builtins.str status: The status of the CIDR block in the Vpc Public IP address pool. Valid values: `Created`, `Modifying`, `Deleting`.
    """
    __args__ = dict()
...
def get_public_ip_address_pool_cidr_blocks_output(cidr_block: Optional[pulumi.Input[Optional[builtins.str]]] = None,
