...
class RouteTableArgs:
    def __init__(__self__, *,
                 ...
                 route_propagation_enable: Optional[pulumi.Input[builtins.bool]] = None,
                 route_table_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a RouteTable resource.
        :param pulumi.Input[builtins.str] vpc_id: The ID of VPC.
               
               The following arguments will be discarded. Please use new fields as soon as possible:
        :param pulumi.Input[builtins.str] associate_type: The type of cloud resource that is bound to the routing table. Value:
               - `VSwitch`: switch.
               - `Gateway`:IPv4 Gateway.
        :param pulumi.Input[builtins.str] description: Description of the routing table.
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.119.1. New field 'route_table_name' instead.
        :param pulumi.Input[builtins.bool] route_propagation_enable: Route Table Receive Propagate Route State
        :param pulumi.Input[builtins.str] route_table_name: The name of the routing table.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag
        """
        ...
        if name is not None:
            warnings.warn("""Field 'name' has been deprecated since provider version 1.119.1. New field 'route_table_name' instead.""", DeprecationWarning)
            pulumi.log.warn("""name is deprecated: Field 'name' has been deprecated since provider version 1.119.1. New field 'route_table_name' instead.""")
        if name is not None:
            pulumi.set(__self__, "name", name)
        if route_propagation_enable is not None:
            pulumi.set(__self__, "route_propagation_enable", route_propagation_enable)
    ...
    @property
    @pulumi.getter
    @_utilities.deprecated("""Field 'name' has been deprecated since provider version 1.119.1. New field 'route_table_name' instead.""")
    ...
    @property
    @pulumi.getter(name="routePropagationEnable")
    def route_propagation_enable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Route Table Receive Propagate Route State
        """
        return pulumi.get(self, "route_propagation_enable")

    @route_propagation_enable.setter
    def route_propagation_enable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "route_propagation_enable", value)
...
class _RouteTableState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] associate_type: The type of cloud resource that is bound to the routing table. Value:
               - `VSwitch`: switch.
               - `Gateway`:IPv4 Gateway.
        :param pulumi.Input[builtins.str] create_time: The creation time of the routing table
        :param pulumi.Input[builtins.str] description: Description of the routing table.
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.119.1. New field 'route_table_name' instead.
        :param pulumi.Input[builtins.str] resource_group_id: Resource group ID.
        :param pulumi.Input[builtins.bool] route_propagation_enable: Route Table Receive Propagate Route State
        :param pulumi.Input[builtins.str] route_table_name: The name of the routing table.
        :param pulumi.Input[builtins.str] status: Routing table state
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag
        :param pulumi.Input[builtins.str] vpc_id: The ID of VPC.
...
class RouteTable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["route_propagation_enable"] = route_propagation_enable
    ...
    @property
    @pulumi.getter(name="routePropagationEnable")
    def route_propagation_enable(self) -> pulumi.Output[builtins.bool]:
        """
        Route Table Receive Propagate Route State
        """
        return pulumi.get(self, "route_propagation_enable")
