...
class BgpGroupArgs:
    def __init__(__self__, *,
                 ...
                 bgp_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 is_fake_asn: Optional[pulumi.Input[builtins.bool]] = None,
                 local_asn: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a BgpGroup resource.
        :param pulumi.Input[builtins.int] peer_asn: The AS number of the BGP peer.
        :param pulumi.Input[builtins.str] router_id: The ID of the VBR.
        :param pulumi.Input[builtins.str] auth_key: The authentication key of the BGP group.
        :param pulumi.Input[builtins.str] bgp_group_name: The name of the BGP group. The name must be `2` to `128` characters in length and can contain digits, periods (.), underscores (_), and hyphens (-). The name must start with a letter but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] description: The description of the BGP group. The description must be `2` to `256` characters in length. It must start with a letter but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.bool] is_fake_asn: The is fake asn. A router that runs BGP typically belongs to only one AS. In some cases, for example, the AS needs to be migrated or is merged with another AS, a new AS number replaces the original one.
        :param pulumi.Input[builtins.int] local_asn: The AS number on the Alibaba Cloud side.
        """
    ...
    def bgp_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bgp_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_fake_asn(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_fake_asn.setter
    def is_fake_asn(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BgpGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            peer_asn: Optional[pulumi.Input[builtins.int]] = None,
            router_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'BgpGroup':
        """
    ...
    @property
    @pulumi.getter(name="authKey")
    def auth_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The authentication key of the BGP group.
        """
        return pulumi.get(self, "auth_key")
    ...
    @property
    @pulumi.getter(name="bgpGroupName")
    def bgp_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the BGP group. The name must be `2` to `128` characters in length and can contain digits, periods (.), underscores (_), and hyphens (-). The name must start with a letter but cannot start with `http://` or `https://`.
        """
        return pulumi.get(self, "bgp_group_name")
    ...
    @property
    @pulumi.getter(name="isFakeAsn")
    def is_fake_asn(self) -> pulumi.Output[builtins.bool]:
        """
        The is fake asn. A router that runs BGP typically belongs to only one AS. In some cases, for example, the AS needs to be migrated or is merged with another AS, a new AS number replaces the original one.
        """
        return pulumi.get(self, "is_fake_asn")
