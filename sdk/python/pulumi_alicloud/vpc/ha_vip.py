...
class HAVipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] havip_name: The name of the HaVip instance.
...
class _HAVipState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] associated_instances: The ID of the instance with which the HAVIP is associated.
        :param pulumi.Input[_builtins.str] create_time: The time when the HAVIP was created.
        :param pulumi.Input[_builtins.str] description: The description of the HaVip instance.
        :param pulumi.Input[_builtins.str] ha_vip_id: The ID of the HAVIP.
        :param pulumi.Input[_builtins.str] ha_vip_name: The name of the HAVIP.
        :param pulumi.Input[_builtins.str] havip_name: The name of the HaVip instance.
        :param pulumi.Input[_builtins.str] ip_address: The ip address of the HaVip. If not filled, the default will be assigned one from the vswitch.
        :param pulumi.Input[_builtins.str] master_instance_id: The ID of the active instance that is associated with the HAVIP.
        :param pulumi.Input[_builtins.str] resource_group_id: The ID of the resource group to which the HAVIP belongs.
        :param pulumi.Input[_builtins.str] status: (Available since v1.120.0) The status of the HaVip instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: The list of tags.
        :param pulumi.Input[_builtins.str] vpc_id: The ID of the VPC to which the HAVIP belongs.
        :param pulumi.Input[_builtins.str] vswitch_id: The vswitch_id of the HaVip, the field can't be changed.
        """
...
class HAVip(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[_builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'HAVip':
        """
