...
class HAVip(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, description=None, ip_address=None, vswitch_id=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, description=None, ip_address=None, vswitch_id=None):
        """
