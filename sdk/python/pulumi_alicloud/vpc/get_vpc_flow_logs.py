...
def get_vpc_flow_logs(description: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_type: The resource type. Valid values: `NetworkInterface`, `VPC`, `VSwitch`.
    :param _builtins.str status: The status of  flow log. Valid values: `Active`, `Inactive`.
    :param _builtins.str traffic_type: The traffic type. Valid values: `All`, `Allow`, `Drop`.
    """
    __args__ = dict()
...
def get_vpc_flow_logs_output(description: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                             ...
                             traffic_type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
