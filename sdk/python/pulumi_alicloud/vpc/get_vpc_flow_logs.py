...
def get_vpc_flow_logs(description: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_type: The resource type. Valid values: `NetworkInterface`, `VPC`, `VSwitch`.
    :param builtins.str status: The status of  flow log. Valid values: `Active`, `Inactive`.
    :param builtins.str traffic_type: The traffic type. Valid values: `All`, `Allow`, `Drop`.
    """
    __args__ = dict()
...
def get_vpc_flow_logs_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ...
                             traffic_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
