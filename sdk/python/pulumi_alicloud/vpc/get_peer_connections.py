...
class GetPeerConnectionsResult:
    ...
    def peer_connection_name(self) -> Optional[builtins.str]:
        """
...
def get_peer_connections(ids: Optional[Sequence[builtins.str]] = None,
                         name_regex: Optional[builtins.str] = None,
                         output_file: Optional[builtins.str] = None,
                         peer_connection_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of PeerConnection IDs.
    :param builtins.str name_regex: A regex string to filter results by PeerConnection name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str peer_connection_name: The name of the resource.
    :param builtins.str status: The status of the resource. Valid values: `Accepting`, `Activated`, `Creating`, `Deleted`, `Deleting`, `Expired`, `Rejected`, `Updating`.
    :param builtins.str vpc_id: The ID of the requester VPC.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_peer_connections_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                peer_connection_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
