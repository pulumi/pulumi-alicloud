...
class GetIpv4GatewaysResult:
    ...
    def ipv4_gateway_name(self) -> Optional[_builtins.str]:
...
def get_ipv4_gateways(ids: Optional[Sequence[_builtins.str]] = None,
                      ipv4_gateway_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Ipv4 Gateway IDs.
    :param _builtins.str ipv4_gateway_name: The name of the IPv4 gateway.
    :param _builtins.str name_regex: A regex string to filter results by Ipv4 Gateway name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str status: The status of the resource. Valid values: `Creating`, `Created`, `Deleting`, `Pending`, `Deleted`.
...
def get_ipv4_gateways_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                             ipv4_gateway_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
