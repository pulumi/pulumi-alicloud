...
class GetIpv4GatewaysResult:
    ...
    def ipv4_gateway_name(self) -> Optional[builtins.str]:
...
def get_ipv4_gateways(ids: Optional[Sequence[builtins.str]] = None,
                      ipv4_gateway_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ipv4 Gateway IDs.
    :param builtins.str ipv4_gateway_name: The name of the IPv4 gateway.
    :param builtins.str name_regex: A regex string to filter results by Ipv4 Gateway name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the resource. Valid values: `Creating`, `Created`, `Deleting`, `Pending`, `Deleted`.
...
def get_ipv4_gateways_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             ipv4_gateway_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
