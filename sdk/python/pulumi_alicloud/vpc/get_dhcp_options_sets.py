...
class GetDhcpOptionsSetsResult:
    ...
    def dhcp_options_set_name(self) -> Optional[builtins.str]:
...
def get_dhcp_options_sets(dhcp_options_set_name: Optional[builtins.str] = None,
    ...
    :param builtins.str dhcp_options_set_name: The name of the DHCP options set.The name must be 2 to 128 characters in length and can contain letters, Chinese characters, digits, underscores (_), and hyphens (-). It must start with a letter or a Chinese character.
    :param builtins.str domain_name: The root domain, for example, example.com. After a DHCP options set is associated with a Virtual Private Cloud (VPC) network, the root domain in the DHCP options set is automatically synchronized to the ECS instances in the VPC network.
    :param Sequence[builtins.str] ids: A list of Dhcp Options Set IDs.
    :param builtins.str name_regex: A regex string to filter results by Dhcp Options Set name.
...
def get_dhcp_options_sets_output(dhcp_options_set_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 ...
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDhcpOptionsSetsResult]:
    """
    This data source provides the Vpc Dhcp Options Sets of the current Alibaba Cloud user.
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:vpc/getDhcpOptionsSets:getDhcpOptionsSets', __args__, opts=opts, typ=GetDhcpOptionsSetsResult)
    return __ret__.apply(lambda __response__: GetDhcpOptionsSetsResult(
        dhcp_options_set_name=pulumi.get(__response__, 'dhcp_options_set_name'),
