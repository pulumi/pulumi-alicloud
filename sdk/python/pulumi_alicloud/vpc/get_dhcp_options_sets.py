...
class GetDhcpOptionsSetsResult:
    ...
    def dhcp_options_set_name(self) -> Optional[_builtins.str]:
...
def get_dhcp_options_sets(dhcp_options_set_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dhcp_options_set_name: The name of the DHCP options set.The name must be 2 to 128 characters in length and can contain letters, Chinese characters, digits, underscores (_), and hyphens (-). It must start with a letter or a Chinese character.
    :param _builtins.str domain_name: The root domain, for example, example.com. After a DHCP options set is associated with a Virtual Private Cloud (VPC) network, the root domain in the DHCP options set is automatically synchronized to the ECS instances in the VPC network.
    :param Sequence[_builtins.str] ids: A list of Dhcp Options Set IDs.
    :param _builtins.str name_regex: A regex string to filter results by Dhcp Options Set name.
...
def get_dhcp_options_sets_output(dhcp_options_set_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                 domain_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
