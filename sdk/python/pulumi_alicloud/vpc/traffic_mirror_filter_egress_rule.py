...
class TrafficMirrorFilterEgressRuleInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] destination_cidr_block: The destination CIDR block of the outbound traffic.
        ...
        :param pulumi.Input[builtins.str] protocol: The transport protocol used by outbound traffic that needs to be mirrored. Valid values: `ALL`, `ICMP`, `TCP`, `UDP`.
        :param pulumi.Input[builtins.str] source_cidr_block: The source CIDR block of the outbound traffic.
        ...
        :param pulumi.Input[builtins.str] source_port_range: The source port range of the outbound traffic. Valid values: `1` to `65535`. Separate the first port and last port with a forward slash (/), for example, `1/200` or `80/80`. A value of `-1/-1` indicates that all ports are available. Therefore, do not set the value to `-1/-1`. **NOTE:** When `protocol` is `ICMP`, this parameter is invalid.
        """
...
class _TrafficMirrorFilterEgressRuleState:
    def __init__(__self__, *,
                 ...
                 traffic_mirror_filter_egress_rule_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] traffic_mirror_filter_egress_rule_id: The ID of the outbound rule.
        :param pulumi.Input[builtins.str] traffic_mirror_filter_id: The ID of the filter.
    ...
    def traffic_mirror_filter_egress_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def traffic_mirror_filter_egress_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TrafficMirrorFilterEgressRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            traffic_mirror_filter_egress_rule_id: Optional[pulumi.Input[builtins.str]] = None,
            traffic_mirror_filter_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TrafficMirrorFilterEgressRule':
        """
    ...
    @property
    @pulumi.getter(name="trafficMirrorFilterEgressRuleId")
    def traffic_mirror_filter_egress_rule_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the outbound rule.
        """
        return pulumi.get(self, "traffic_mirror_filter_egress_rule_id")
