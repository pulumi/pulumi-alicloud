...
class BgpPeerArgs:
    def __init__(__self__, *,
                 bgp_group_id: pulumi.Input[builtins.str],
                 bfd_multi_hop: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] bgp_group_id: The ID of the BGP group.
        :param pulumi.Input[builtins.int] bfd_multi_hop: The BFD hop count. Valid values: `1` to `255`. **NOTE:** The attribute is valid when the attribute `enable_bfd` is `true`. The parameter specifies the maximum number of network devices that a packet can traverse from the source to the destination. You can set a proper value based on the factors that affect the physical connection.
        :param pulumi.Input[builtins.bool] enable_bfd: Specifies whether to enable the Bidirectional Forwarding Detection (BFD) feature.
        :param pulumi.Input[builtins.str] ip_version: The IP version.
        :param pulumi.Input[builtins.str] peer_ip_address: The IP address of the BGP peer.
        """
    ...
    def bgp_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @bgp_group_id.setter
    def bgp_group_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "bgp_group_id", value)

    @property
    @pulumi.getter(name="bfdMultiHop")
    def bfd_multi_hop(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The BFD hop count. Valid values: `1` to `255`. **NOTE:** The attribute is valid when the attribute `enable_bfd` is `true`. The parameter specifies the maximum number of network devices that a packet can traverse from the source to the destination. You can set a proper value based on the factors that affect the physical connection.
        """
    ...
    def bfd_multi_hop(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _BgpPeerState:
    def __init__(__self__, *,
                 bfd_multi_hop: Optional[pulumi.Input[builtins.int]] = None,
                 bgp_group_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] bfd_multi_hop: The BFD hop count. Valid values: `1` to `255`. **NOTE:** The attribute is valid when the attribute `enable_bfd` is `true`. The parameter specifies the maximum number of network devices that a packet can traverse from the source to the destination. You can set a proper value based on the factors that affect the physical connection.
        :param pulumi.Input[builtins.str] bgp_group_id: The ID of the BGP group.
        :param pulumi.Input[builtins.str] bgp_peer_name: The name of the BGP neighbor.
        :param pulumi.Input[builtins.bool] enable_bfd: Specifies whether to enable the Bidirectional Forwarding Detection (BFD) feature.
        :param pulumi.Input[builtins.str] ip_version: The IP version.
        :param pulumi.Input[builtins.str] peer_ip_address: The IP address of the BGP peer.
        :param pulumi.Input[builtins.str] status: Status of BGP neighbors.
        """
        if bfd_multi_hop is not None:
            pulumi.set(__self__, "bfd_multi_hop", bfd_multi_hop)
    ...
    @property
    @pulumi.getter(name="bgpGroupId")
    def bgp_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the BGP group.
        """
        return pulumi.get(self, "bgp_group_id")
    ...
    @bgp_group_id.setter
    def bgp_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bgp_group_id", value)
...
class BgpPeer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip_version: Optional[pulumi.Input[builtins.str]] = None,
            peer_ip_address: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'BgpPeer':
        """
    ...
    @property
    @pulumi.getter(name="bfdMultiHop")
    def bfd_multi_hop(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The BFD hop count. Valid values: `1` to `255`. **NOTE:** The attribute is valid when the attribute `enable_bfd` is `true`. The parameter specifies the maximum number of network devices that a packet can traverse from the source to the destination. You can set a proper value based on the factors that affect the physical connection.
        """
        return pulumi.get(self, "bfd_multi_hop")
    ...
    @property
    @pulumi.getter(name="bgpGroupId")
    def bgp_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the BGP group.
        """
        return pulumi.get(self, "bgp_group_id")
    ...
    @property
    @pulumi.getter(name="enableBfd")
    def enable_bfd(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable the Bidirectional Forwarding Detection (BFD) feature.
        """
        return pulumi.get(self, "enable_bfd")
