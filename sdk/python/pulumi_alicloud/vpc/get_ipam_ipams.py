...
class GetIpamIpamsResult:
    ...
    def ipam_name(self) -> Optional[builtins.str]:
        """
...
def get_ipam_ipams(ids: Optional[Sequence[builtins.str]] = None,
                   ipam_id: Optional[builtins.str] = None,
                   ipam_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ipam IDs.
    :param builtins.str ipam_id: The first ID of the resource.
    :param builtins.str ipam_name: The name of the resource.
...
def get_ipam_ipams_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                          ipam_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          ipam_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
