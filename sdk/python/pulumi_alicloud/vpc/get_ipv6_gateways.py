...
def get_ipv6_gateways_output(ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                             ipv6_gateway_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
