...
class GetIpv6GatewaysResult:
    ...
    def ipv6_gateway_name(self) -> Optional[builtins.str]:
...
def get_ipv6_gateways(ids: Optional[Sequence[builtins.str]] = None,
                      ipv6_gateway_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ipv6 Gateway IDs.
    :param builtins.str ipv6_gateway_name: The name of the IPv6 gateway.
    :param builtins.str name_regex: A regex string to filter results by Ipv6 Gateway name.
...
def get_ipv6_gateways_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             ipv6_gateway_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
