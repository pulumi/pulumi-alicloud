...
class VbrHaArgs:
    def __init__(__self__, *,
                 peer_vbr_id: pulumi.Input[builtins.str],
                 vbr_id: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 dry_run: Optional[pulumi.Input[builtins.bool]] = None,
                 vbr_ha_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a VbrHa resource.
        :param pulumi.Input[builtins.str] peer_vbr_id: The ID of the other VBR in the VBR failover group.
        :param pulumi.Input[builtins.str] vbr_id: The ID of the VBR instance.
        :param pulumi.Input[builtins.str] description: The description of the VBR switching group. It must be `2` to `256` characters in length and must start with a letter or Chinese, but cannot start with `https://` or `https://`.
        :param pulumi.Input[builtins.bool] dry_run: The dry run.
        :param pulumi.Input[builtins.str] vbr_ha_name: The name of the VBR failover group.
        """
    ...
    def peer_vbr_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @peer_vbr_id.setter
    def peer_vbr_id(self, value: pulumi.Input[builtins.str]):
    ...
    def vbr_ha_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @vbr_ha_name.setter
    def vbr_ha_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _VbrHaState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 dry_run: Optional[pulumi.Input[builtins.bool]] = None,
                 peer_vbr_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] dry_run: The dry run.
        :param pulumi.Input[builtins.str] peer_vbr_id: The ID of the other VBR in the VBR failover group.
        :param pulumi.Input[builtins.str] status: The state of the VBR failover group.
        :param pulumi.Input[builtins.str] vbr_ha_name: The name of the VBR failover group.
        :param pulumi.Input[builtins.str] vbr_id: The ID of the VBR instance.
        """
        if description is not None:
    ...
    @property
    @pulumi.getter(name="peerVbrId")
    def peer_vbr_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the other VBR in the VBR failover group.
        """
        return pulumi.get(self, "peer_vbr_id")
    ...
    @peer_vbr_id.setter
    def peer_vbr_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peer_vbr_id", value)
...
class VbrHa(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            vbr_ha_name: Optional[pulumi.Input[builtins.str]] = None,
            vbr_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VbrHa':
        """
    ...
    @property
    @pulumi.getter(name="peerVbrId")
    def peer_vbr_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the other VBR in the VBR failover group.
        """
        return pulumi.get(self, "peer_vbr_id")
    ...
    @property
    @pulumi.getter(name="vbrHaName")
    def vbr_ha_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the VBR failover group.
        """
        return pulumi.get(self, "vbr_ha_name")
