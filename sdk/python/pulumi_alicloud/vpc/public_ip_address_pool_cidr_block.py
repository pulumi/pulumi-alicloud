...
class PublicIpAddressPoolCidrBlockArgs:
    def __init__(__self__, *,
                 public_ip_address_pool_id: pulumi.Input[builtins.str],
                 cidr_block: Optional[pulumi.Input[builtins.str]] = None,
                 cidr_mask: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a PublicIpAddressPoolCidrBlock resource.
        :param pulumi.Input[builtins.str] public_ip_address_pool_id: The ID of the VPC Public IP address pool.
        :param pulumi.Input[builtins.str] cidr_block: The CIDR block.
        :param pulumi.Input[builtins.int] cidr_mask: IP address and network segment mask. After you enter the mask, the system automatically allocates the IP address network segment. Value range: **24** to **28**.
    ...
    def public_ip_address_pool_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def public_ip_address_pool_id(self, value: pulumi.Input[builtins.str]):
    ...
    def cidr_mask(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @cidr_mask.setter
    def cidr_mask(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _PublicIpAddressPoolCidrBlockState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] public_ip_address_pool_id: The ID of the VPC Public IP address pool.
        :param pulumi.Input[builtins.str] status: The status of the VPC Public Ip Address Pool Cidr Block.
        """
        if cidr_block is not None:
            pulumi.set(__self__, "cidr_block", cidr_block)
        if cidr_mask is not None:
...
class PublicIpAddressPoolCidrBlock(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            create_time: Optional[pulumi.Input[builtins.str]] = None,
            public_ip_address_pool_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'PublicIpAddressPoolCidrBlock':
        """
    ...
    @property
    @pulumi.getter(name="cidrMask")
    def cidr_mask(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        IP address and network segment mask. After you enter the mask, the system automatically allocates the IP address network segment. Value range: **24** to **28**.
        > **NOTE:**  **CidrBlock** and **CidrMask** cannot be configured at the same time. Select one of them to configure.
        """
    ...
    @property
    @pulumi.getter(name="publicIpAddressPoolId")
    def public_ip_address_pool_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the VPC Public IP address pool.
        """
        return pulumi.get(self, "public_ip_address_pool_id")
