...
class PublicIpAddressPoolCidrBlockArgs:
    ...
    def public_ip_address_pool_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def public_ip_address_pool_id(self, value: pulumi.Input[_builtins.str]):
...
class _PublicIpAddressPoolCidrBlockState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] public_ip_address_pool_id: The ID of the VPC Public IP address pool.
        :param pulumi.Input[_builtins.str] status: The status of the VPC Public Ip Address Pool Cidr Block.
        """
        if cidr_block is not None:
            pulumi.set(__self__, "cidr_block", cidr_block)
        if cidr_mask is not None:
