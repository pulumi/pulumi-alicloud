...
class PeerConnectionArgs:
    def __init__(__self__, *,
                 accepting_region_id: pulumi.Input[builtins.str],
                 accepting_vpc_id: pulumi.Input[builtins.str],
                 vpc_id: pulumi.Input[builtins.str],
                 accepting_ali_uid: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 peer_connection_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] accepting_region_id: The region ID of the accepter VPC of the VPC peering connection that you want to create.
        ...
        :param pulumi.Input[builtins.str] accepting_vpc_id: The ID of the accepter VPC.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the requester VPC or accepter VPC of the VPC peering connection that you want to query.
        :param pulumi.Input[builtins.int] accepting_ali_uid: The ID of the Alibaba Cloud account to which the accepter VPC belongs.
        ...
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth of the VPC peering connection. Unit: Mbit/s. The value must be an integer greater than 0. Before you specify this parameter, make sure that you create an inter-region VPC peering connection.
        :param pulumi.Input[builtins.str] description: The description of the VPC peering connection.
               The description must be 2 to 256 characters in length. The description must start with a letter but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to perform only a dry run, without performing the actual request. Valid values:
        :param pulumi.Input[builtins.bool] force_delete: Specifies whether to forcefully delete the VPC peering connection. Valid values:
        :param pulumi.Input[builtins.str] link_type: The link type of the VPC peering connection that you want to create. Valid values:
               - Platinum.
               - Gold: default value.
        ...
        :param pulumi.Input[builtins.str] peer_connection_name: The name of the VPC peering connection.
               The name must be 2 to 128 characters in length, and can contain digits, underscores (\\_), and hyphens (-). It must start with a letter.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the new resource group.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags of VpcPeer.
        """
    ...
    def accepting_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def accepting_region_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "accepting_region_id", value)

    @property
    @pulumi.getter(name="acceptingVpcId")
    def accepting_vpc_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def accepting_vpc_id(self, value: pulumi.Input[builtins.str]):
    ...
    def accepting_ali_uid(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def accepting_ali_uid(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def peer_connection_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_connection_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PeerConnectionState:
    def __init__(__self__, *,
                 accepting_ali_uid: Optional[pulumi.Input[builtins.int]] = None,
                 accepting_region_id: Optional[pulumi.Input[builtins.str]] = None,
                 accepting_vpc_id: Optional[pulumi.Input[builtins.str]] = None,
                 bandwidth: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] accepting_vpc_id: The ID of the accepter VPC.
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth of the VPC peering connection. Unit: Mbit/s. The value must be an integer greater than 0. Before you specify this parameter, make sure that you create an inter-region VPC peering connection.
        :param pulumi.Input[builtins.str] create_time: The creation time of the VPC peer connection. Use UTC time in the format' YYYY-MM-DDThh:mm:ssZ '.
        :param pulumi.Input[builtins.str] description: The description of the VPC peering connection.
               The description must be 2 to 256 characters in length. The description must start with a letter but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to perform only a dry run, without performing the actual request. Valid values:
        :param pulumi.Input[builtins.bool] force_delete: Specifies whether to forcefully delete the VPC peering connection. Valid values:
        ...
        :param pulumi.Input[builtins.str] peer_connection_name: The name of the VPC peering connection.
               The name must be 2 to 128 characters in length, and can contain digits, underscores (\\_), and hyphens (-). It must start with a letter.
        :param pulumi.Input[builtins.str] region_id: The region ID of the resource to which you want to create and add tags.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the new resource group.
    ...
    @property
    @pulumi.getter(name="acceptingRegionId")
    def accepting_region_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The region ID of the accepter VPC of the VPC peering connection that you want to create.
    ...
    @accepting_region_id.setter
    def accepting_region_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "accepting_region_id", value)

    @property
    @pulumi.getter(name="acceptingVpcId")
    def accepting_vpc_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the accepter VPC.
        """
        return pulumi.get(self, "accepting_vpc_id")
    ...
    @accepting_vpc_id.setter
    def accepting_vpc_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "accepting_vpc_id", value)
...
class PeerConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PeerConnection':
        """
    ...
    @property
    @pulumi.getter(name="acceptingAliUid")
    def accepting_ali_uid(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The ID of the Alibaba Cloud account to which the accepter VPC belongs.
    ...
    @property
    @pulumi.getter(name="acceptingRegionId")
    def accepting_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The region ID of the accepter VPC of the VPC peering connection that you want to create.
    ...
    @property
    @pulumi.getter(name="acceptingVpcId")
    def accepting_vpc_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the accepter VPC.
        """
        return pulumi.get(self, "accepting_vpc_id")
    ...
    @property
    @pulumi.getter(name="peerConnectionName")
    def peer_connection_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the VPC peering connection.
        The name must be 2 to 128 characters in length, and can contain digits, underscores (\\_), and hyphens (-). It must start with a letter.
        """
