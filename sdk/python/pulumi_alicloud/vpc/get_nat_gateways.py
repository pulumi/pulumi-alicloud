...
class GetNatGatewaysResult:
    ...
    @property
    @pulumi.getter
    def gateways(self) -> List['outputs.GetNatGatewaysGatewayResult']:
        """
...
def get_nat_gateways(ids: Optional[List[str]] = None,
    ...
    :param List[str] ids: A list of NAT gateways IDs.
