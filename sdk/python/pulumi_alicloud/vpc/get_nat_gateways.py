...
class GetNatGatewaysResult:
    ...
    def nat_type(self) -> Optional[builtins.str]:
        """
...
def get_nat_gateways(dry_run: Optional[builtins.bool] = None,
                     ...
                     nat_type: Optional[builtins.str] = None,
    ...
    :param builtins.bool dry_run: Specifies whether to only precheck the request.
    :param builtins.bool enable_details: Default to `false`. Set it to `true` can output more details about resource attributes.
    :param Sequence[builtins.str] ids: A list of NAT gateways IDs.
    :param builtins.str name_regex: A regex string to filter nat gateways by name.
    :param builtins.str nat_gateway_name: The name of NAT gateway.
    :param builtins.str nat_type: The nat type of NAT gateway. Valid values `Enhanced` and `Normal`.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str payment_type: The payment type of NAT gateway. Valid values `PayAsYouGo` and `Subscription`.
    :param builtins.str resource_group_id: The resource group id of NAT gateway.
    :param builtins.str specification: The specification of NAT gateway. Valid values `Middle`, `Large`, `Small` and `XLarge.1`. Default value is `Small`.
    :param builtins.str status: The status of NAT gateway. Valid values `Available`, `Converting`, `Creating`, `Deleting` and `Modifying`.
    :param Mapping[str, builtins.str] tags: The tags of NAT gateway.
...
def get_nat_gateways_output(dry_run: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                            ...
                            nat_gateway_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            nat_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            ...
                            specification: Optional[pulumi.Input[Optional[builtins.str]]] = None,
