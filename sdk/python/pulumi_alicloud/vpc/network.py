...
class NetworkArgs:
    def __init__(__self__, *,
                 ...
                 classic_link_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 ipv6_isp: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] dns_hostname_status: The status of VPC DNS Hostname. Valid values: `ENABLED`, `DISABLED`.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to perform a dry run. Valid values:
        :param pulumi.Input[builtins.bool] enable_ipv6: Specifies whether to enable IPv6. Valid values:
        ...
        :param pulumi.Input[builtins.str] ipv4_ipam_pool_id: The ID of the IP Address Manager (IPAM) pool that contains IPv4 addresses.
        :param pulumi.Input[builtins.str] ipv6_cidr_block: The IPv6 CIDR block of the default VPC.
               
               > **NOTE:**  When `EnableIpv6` is set to `true`, this parameter is required.
        :param pulumi.Input[builtins.str] ipv6_isp: The IPv6 address segment type of the VPC. Value:
        ...
        :param pulumi.Input[builtins.int] secondary_cidr_mask: Add an additional CIDR block from the IPAM address pool to the VPC by entering a mask.
    ...
    def classic_link_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def classic_link_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def dns_hostname_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ipv4_cidr_mask(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def ipv4_ipam_pool_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ipv6_isp(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ipv6_isp.setter
    def ipv6_isp(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def secondary_cidr_mask(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def system_route_table_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_cidrs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @user_cidrs.setter
    def user_cidrs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _NetworkState:
    def __init__(__self__, *,
                 ...
                 router_table_id: Optional[pulumi.Input[builtins.str]] = None,
                 secondary_cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 secondary_cidr_mask: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.bool] is_default: Specifies whether to create the default VPC in the specified region. Valid values:
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.119.0. New field 'vpc_name' instead.
        :param pulumi.Input[builtins.str] region_id: (Available since v1.240.0) The region ID of the VPC to which the route table belongs.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which you want to move the resource.
               
               > **NOTE:**   You can use resource groups to facilitate resource grouping and permission management for an Alibaba Cloud. For more information, see [What is resource management?](https://www.alibabacloud.com/help/en/doc-detail/94475.html)
        :param pulumi.Input[builtins.str] route_table_id: The ID of the route table that you want to query.
        :param pulumi.Input[builtins.str] router_id: The router ID of the VPC.
    ...
    def router_table_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def router_table_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Network(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:vpc/network:Network"
    ...
    @property
    @pulumi.getter(name="classicLinkEnabled")
    def classic_link_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The status of ClassicLink function.
        """
        return pulumi.get(self, "classic_link_enabled")
    ...
    @property
    @pulumi.getter(name="ipv6Isp")
    def ipv6_isp(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IPv6 address segment type of the VPC. Value:
        - `BGP` (default): Alibaba Cloud BGP IPv6.
        - `ChinaMobile`: China Mobile (single line).
    ...
    @pulumi.getter(name="routerTableId")
    @_utilities.deprecated("""Field 'router_table_id' has been deprecated since provider version 1.221.0. New field 'route_table_id' instead.""")
    def router_table_id(self) -> pulumi.Output[builtins.str]:
        """
        . Field 'router_table_id' has been deprecated from provider version 1.227.1. New field 'route_table_id' instead.
        """
        return pulumi.get(self, "router_table_id")
    ...
    @property
    @pulumi.getter(name="userCidrs")
    def user_cidrs(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of user CIDRs.
        """
        return pulumi.get(self, "user_cidrs")
