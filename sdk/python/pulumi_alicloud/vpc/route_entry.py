...
class RouteEntryArgs:
    def __init__(__self__, *,
                 ...
                 destination_cidrblock: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 nexthop_id: Optional[pulumi.Input[builtins.str]] = None,
                 nexthop_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RouteEntry resource.
        :param pulumi.Input[builtins.str] route_table_id: The ID of the Route Table.
        :param pulumi.Input[builtins.str] description: The description of the Route Entry. The description must be `1` to `256` characters in length, and cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] destination_cidrblock: The destination CIDR block of the custom route entry.
        :param pulumi.Input[builtins.str] name: The name of the Route Entry. The name must be `1` to `128` characters in length, and cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] nexthop_id: The ID of Next Hop.
        :param pulumi.Input[builtins.str] nexthop_type: The type of Next Hop. Valid values:
    ...
    def destination_cidrblock(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def destination_cidrblock(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def nexthop_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of Next Hop.
        """
    ...
    @nexthop_id.setter
    def nexthop_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nexthop_id", value)

    @property
    @pulumi.getter(name="nexthopType")
    def nexthop_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @nexthop_type.setter
    def nexthop_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RouteEntryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] nexthop_type: The type of Next Hop. Valid values:
               ...
               - `Ecr`: A Express Connect Router (ECR).
        :param pulumi.Input[builtins.str] route_table_id: The ID of the Route Table.
        :param pulumi.Input[builtins.str] router_id: This argument has been deprecated. Please use other arguments to launch a custom route entry.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if destination_cidrblock is not None:
...
class RouteEntry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            nexthop_type: Optional[pulumi.Input[builtins.str]] = None,
            route_table_id: Optional[pulumi.Input[builtins.str]] = None,
            router_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RouteEntry':
        """
    ...
    @property
    @pulumi.getter(name="destinationCidrblock")
    def destination_cidrblock(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The destination CIDR block of the custom route entry.
        """
        return pulumi.get(self, "destination_cidrblock")
    ...
    @property
    @pulumi.getter(name="nexthopId")
    def nexthop_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of Next Hop.
        """
        return pulumi.get(self, "nexthop_id")
    ...
    @property
    @pulumi.getter(name="nexthopType")
    def nexthop_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of Next Hop. Valid values:
        - `Instance`: An Elastic Compute Service (ECS) instance.
        - `HaVip`: A high-availability virtual IP address (HAVIP).
