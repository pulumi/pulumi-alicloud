...
class VswitchCidrReservationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cidr_reservation_type: Reserved CIDR Block Type.Valid values: `Prefix`. Default value: Prefix.
        :param pulumi.Input[_builtins.str] ip_version: Reserved ip version of network segment, valid values: `IPv4`, `IPv6`, default IPv4.
        :param pulumi.Input[_builtins.str] vswitch_cidr_reservation_name: The name of the resource.
        """
...
class _VswitchCidrReservationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] vpc_id: The id of the vpc instance to which the reserved CIDR block belongs.
        :param pulumi.Input[_builtins.str] vswitch_cidr_reservation_id: The resource attribute field of the resource ID.
        :param pulumi.Input[_builtins.str] vswitch_cidr_reservation_name: The name of the resource.
        :param pulumi.Input[_builtins.str] vswitch_id: The Id of the switch instance.
        """
        if cidr_reservation_cidr is not None:
...
class VswitchCidrReservation(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="cidrReservationCidr")
    def cidr_reservation_cidr(self) -> pulumi.Output[_builtins.str]:
        """
        Reserved network segment CIdrBlock.
        """
        return pulumi.get(self, "cidr_reservation_cidr")
    ...
    @_builtins.property
    @pulumi.getter(name="cidrReservationDescription")
    def cidr_reservation_description(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The description of the reserved CIDR block.
        """
        return pulumi.get(self, "cidr_reservation_description")
    ...
    @_builtins.property
    @pulumi.getter(name="cidrReservationMask")
    def cidr_reservation_mask(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Reserved segment mask.
        """
        return pulumi.get(self, "cidr_reservation_mask")
    ...
    @_builtins.property
    @pulumi.getter(name="cidrReservationType")
    def cidr_reservation_type(self) -> pulumi.Output[_builtins.str]:
        """
        Reserved CIDR Block Type.Valid values: `Prefix`. Default value: Prefix.
        """
        return pulumi.get(self, "cidr_reservation_type")
    ...
    @_builtins.property
    @pulumi.getter(name="vswitchCidrReservationId")
    def vswitch_cidr_reservation_id(self) -> pulumi.Output[_builtins.str]:
        """
        The resource attribute field of the resource ID.
        """
        return pulumi.get(self, "vswitch_cidr_reservation_id")
    ...
    @_builtins.property
    @pulumi.getter(name="vswitchCidrReservationName")
    def vswitch_cidr_reservation_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The name of the resource.
        """
        return pulumi.get(self, "vswitch_cidr_reservation_name")
