...
class DhcpOptionsSetAttachmentArgs:
    def __init__(__self__, *,
                 dhcp_options_set_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] dhcp_options_set_id: The ID of the DHCP options set.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC network that is to be associated with the DHCP options set..
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to precheck this request only. Default values: `false`. Valid values:
        """
    ...
    def dhcp_options_set_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dhcp_options_set_id(self, value: pulumi.Input[builtins.str]):
...
class _DhcpOptionsSetAttachmentState:
    def __init__(__self__, *,
                 dhcp_options_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 dry_run: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] dhcp_options_set_id: The ID of the DHCP options set.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to precheck this request only. Default values: `false`. Valid values:
        :param pulumi.Input[builtins.str] status: The status of the VPC network that is associated with the DHCP options set.  Valid values: `InUse` or `Pending`.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC network that is to be associated with the DHCP options set..
        """
    ...
    @property
    @pulumi.getter(name="dhcpOptionsSetId")
    def dhcp_options_set_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the DHCP options set.
        """
        return pulumi.get(self, "dhcp_options_set_id")
    ...
    @dhcp_options_set_id.setter
    def dhcp_options_set_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dhcp_options_set_id", value)
...
class DhcpOptionsSetAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            dry_run: Optional[pulumi.Input[builtins.bool]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DhcpOptionsSetAttachment':
        """
    ...
    @property
    @pulumi.getter(name="dhcpOptionsSetId")
    def dhcp_options_set_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the DHCP options set.
        """
        return pulumi.get(self, "dhcp_options_set_id")
