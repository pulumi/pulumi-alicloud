...
class BgpNetworkArgs:
    def __init__(__self__, *,
                 dst_cidr_block: pulumi.Input[builtins.str],
                 router_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a BgpNetwork resource.
        :param pulumi.Input[builtins.str] dst_cidr_block: The CIDR block of the virtual private cloud (VPC) or vSwitch that you want to connect to a data center.
        :param pulumi.Input[builtins.str] router_id: The ID of the vRouter associated with the router interface.
        """
    ...
    def dst_cidr_block(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dst_cidr_block(self, value: pulumi.Input[builtins.str]):
...
class _BgpNetworkState:
    def __init__(__self__, *,
                 dst_cidr_block: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] dst_cidr_block: The CIDR block of the virtual private cloud (VPC) or vSwitch that you want to connect to a data center.
        :param pulumi.Input[builtins.str] router_id: The ID of the vRouter associated with the router interface.
        :param pulumi.Input[builtins.str] status: The state of the advertised BGP network.
        """
    ...
    @property
    @pulumi.getter(name="dstCidrBlock")
    def dst_cidr_block(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The CIDR block of the virtual private cloud (VPC) or vSwitch that you want to connect to a data center.
        """
        return pulumi.get(self, "dst_cidr_block")
    ...
    @dst_cidr_block.setter
    def dst_cidr_block(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dst_cidr_block", value)
...
class BgpNetwork(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            dst_cidr_block: Optional[pulumi.Input[builtins.str]] = None,
            router_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'BgpNetwork':
        """
    ...
    @property
    @pulumi.getter(name="dstCidrBlock")
    def dst_cidr_block(self) -> pulumi.Output[builtins.str]:
        """
        The CIDR block of the virtual private cloud (VPC) or vSwitch that you want to connect to a data center.
        """
        return pulumi.get(self, "dst_cidr_block")
