...
class GetCommonBandwidthPackagesResult:
    ...
    def bandwidth_package_name(self) -> Optional[_builtins.str]:
        """
...
def get_common_bandwidth_packages(bandwidth_package_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool dry_run: Specifies whether to precheck only the request.
    :param Sequence[_builtins.str] ids: A list of Common Bandwidth Packages IDs.
    :param _builtins.bool include_reservation_data: Specifies whether to return data of orders that have not taken effect.
