...
class GetCommonBandwidthPackagesResult:
    ...
    def bandwidth_package_name(self) -> Optional[builtins.str]:
        """
...
def get_common_bandwidth_packages(bandwidth_package_name: Optional[builtins.str] = None,
    ...
    :param builtins.str bandwidth_package_name: The name of bandwidth package.
    :param builtins.bool dry_run: Specifies whether to precheck only the request.
    :param Sequence[builtins.str] ids: A list of Common Bandwidth Packages IDs.
    :param builtins.bool include_reservation_data: Specifies whether to return data of orders that have not taken effect.
    ...
    :param builtins.str resource_group_id: The Id of resource group which the common bandwidth package belongs.
    :param builtins.str status: The status of bandwidth package. Valid values: `Available` and `Pending`.
    """
    __args__ = dict()
...
def get_common_bandwidth_packages_output(bandwidth_package_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
