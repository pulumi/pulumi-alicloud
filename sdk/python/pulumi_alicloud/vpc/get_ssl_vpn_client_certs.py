...
class GetSslVpnClientCertsResult:
    ...
    def ssl_vpn_server_id(self) -> Optional[builtins.str]:
        """
...
def get_ssl_vpn_client_certs(ids: Optional[Sequence[builtins.str]] = None,
                             name_regex: Optional[builtins.str] = None,
                             output_file: Optional[builtins.str] = None,
                             ssl_vpn_server_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: IDs of the SSL-VPN client certificates.
    :param builtins.str name_regex: A regex string of SSL-VPN client certificate name.
    :param builtins.str output_file: Save the result to the file.
    :param builtins.str ssl_vpn_server_id: Use the SSL-VPN server ID as the search key.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_ssl_vpn_client_certs_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                    name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    ssl_vpn_server_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
