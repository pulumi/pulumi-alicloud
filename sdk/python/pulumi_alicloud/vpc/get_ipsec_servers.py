...
class GetIpsecServersResult:
    ...
    def ipsec_server_name(self) -> Optional[_builtins.str]:
        """
...
def get_ipsec_servers(ids: Optional[Sequence[_builtins.str]] = None,
                      ipsec_server_name: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Ipsec Server IDs.
    :param _builtins.str ipsec_server_name: The name of the IPsec server.
    :param _builtins.str name_regex: A regex string to filter results by Ipsec Server name.
...
def get_ipsec_servers_output(ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                             ipsec_server_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
