...
class GetIpsecServersResult:
    ...
    def ipsec_server_name(self) -> Optional[builtins.str]:
        """
...
def get_ipsec_servers(ids: Optional[Sequence[builtins.str]] = None,
                      ipsec_server_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ipsec Server IDs.
    :param builtins.str ipsec_server_name: The name of the IPsec server.
    :param builtins.str name_regex: A regex string to filter results by Ipsec Server name.
...
def get_ipsec_servers_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             ipsec_server_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
