...
class GetNetworksResult:
    ...
    def dhcp_options_set_id(self) -> Optional[builtins.str]:
        """
    ...
    def vpc_owner_id(self) -> Optional[builtins.int]:
...
def get_networks(cidr_block: Optional[builtins.str] = None,
                 dhcp_options_set_id: Optional[builtins.str] = None,
                 ...
                 vpc_owner_id: Optional[builtins.int] = None,
    ...
    :param builtins.bool dry_run: Indicates whether to check this request only. Valid values: `true` and `false`.
    :param builtins.bool enable_details: Default to `true`. Set it to true can output the `route_table_id`.
    :param Sequence[builtins.str] ids: A list of VPC IDs.
    :param builtins.bool is_default: Indicate whether the VPC is the default one in the specified region.
    :param builtins.str name_regex: A regex string to filter VPCs by name.
    ...
    :param builtins.int vpc_owner_id: The owner ID of VPC.
    :param builtins.str vswitch_id: Filter results by the specified vSwitch.
    """
    __args__ = dict()
...
def get_networks_output(cidr_block: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        dhcp_options_set_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        ...
                        vpc_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        vpc_owner_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
