...
class CommonBandwithPackageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bandwidth: The maximum bandwidth of the Internet Shared Bandwidth instance. Unit: Mbit/s.
               Valid values: `1` to `1000`. Default value: `1`.
        :param pulumi.Input[builtins.str] bandwidth_package_name: The description of the EIP bandwidth plan. The description must be 2 to 256 characters in length. It must start with a letter but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.bool] deletion_protection: Specifies whether to enable deletion protection. Valid values:
        :param pulumi.Input[builtins.str] description: The description of the Internet Shared Bandwidth instance.
               The description must be 0 to 256 characters in length and cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] force: Specifies whether to forcefully delete the Internet Shared Bandwidth instance. Valid values:
        :param pulumi.Input[builtins.str] internet_charge_type: Billing method of Internet Shared Bandwidth. Valid values:
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_protection_types: The edition of Anti-DDoS. If you do not set this parameter, Anti-DDoS Origin Basic is used. If you set the value to AntiDDoS_Enhanced, Anti-DDoS Pro(Premium) is used. It is valid when `internet_charge_type` is `PayBy95`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the resource
        :param pulumi.Input[builtins.str] zone: The zone of the Internet Shared Bandwidth instance. This parameter is required if you create an Internet Shared Bandwidth instance for a cloud box.
...
class _CommonBandwithPackageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which you want to move the resource.
               ...
               > **NOTE:**   You can use resource groups to facilitate resource grouping and permission management for an Alibaba Cloud. For more information, see [What is resource management?](https://www.alibabacloud.com/help/en/doc-detail/94475.html)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_protection_types: The edition of Anti-DDoS. If you do not set this parameter, Anti-DDoS Origin Basic is used. If you set the value to AntiDDoS_Enhanced, Anti-DDoS Pro(Premium) is used. It is valid when `internet_charge_type` is `PayBy95`.
        :param pulumi.Input[builtins.str] status: The status of the Internet Shared Bandwidth instance. Default value: `Available`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag of the resource
        :param pulumi.Input[builtins.str] zone: The zone of the Internet Shared Bandwidth instance. This parameter is required if you create an Internet Shared Bandwidth instance for a cloud box.
...
class CommonBandwithPackage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'CommonBandwithPackage':
        """
