...
def get_pbr_route_entries(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of VPN Pbr Route Entries IDs.
...
def get_pbr_route_entries_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
