...
class GatewayEndpointArgs:
    def __init__(__self__, *,
                 ...
                 gateway_endpoint_descrption: Optional[pulumi.Input[builtins.str]] = None,
                 gateway_endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
                 policy_document: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 route_tables: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a GatewayEndpoint resource.
        :param pulumi.Input[builtins.str] service_name: The endpoint service name.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC.
        :param pulumi.Input[builtins.str] gateway_endpoint_descrption: The description of the VPC gateway endpoint.
               The length of the description information is between 1 and 255 characters.
        :param pulumi.Input[builtins.str] gateway_endpoint_name: The name of the VPC gateway endpoint.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] route_tables: The ID list of the route table associated with the VPC gateway endpoint.
    ...
    def gateway_endpoint_descrption(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def gateway_endpoint_descrption(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "gateway_endpoint_descrption", value)

    @property
    @pulumi.getter(name="gatewayEndpointName")
    def gateway_endpoint_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def gateway_endpoint_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def route_tables(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @route_tables.setter
    def route_tables(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _GatewayEndpointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: The creation time of the VPC gateway endpoint.
        :param pulumi.Input[builtins.str] gateway_endpoint_descrption: The description of the VPC gateway endpoint.
               The length of the description information is between 1 and 255 characters.
        :param pulumi.Input[builtins.str] gateway_endpoint_name: The name of the VPC gateway endpoint.
        :param pulumi.Input[builtins.str] policy_document: Access control policies for cloud services. This parameter is required when the cloud service is oss. For details about the syntax and structure of access policies, see [syntax and structure of permission Policies](https://help.aliyun.com/document_detail/93739.html).
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] route_tables: The ID list of the route table associated with the VPC gateway endpoint.
        :param pulumi.Input[builtins.str] service_name: The endpoint service name.
        :param pulumi.Input[builtins.str] status: The status of VPC gateway endpoint.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags of the resource.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC.
        """
...
class GatewayEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'GatewayEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="gatewayEndpointDescrption")
    def gateway_endpoint_descrption(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the VPC gateway endpoint.
        The length of the description information is between 1 and 255 characters.
        """
    ...
    @property
    @pulumi.getter(name="gatewayEndpointName")
    def gateway_endpoint_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the VPC gateway endpoint.
        """
        return pulumi.get(self, "gateway_endpoint_name")
    ...
    @property
    @pulumi.getter(name="routeTables")
    def route_tables(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The ID list of the route table associated with the VPC gateway endpoint.
        """
        return pulumi.get(self, "route_tables")
