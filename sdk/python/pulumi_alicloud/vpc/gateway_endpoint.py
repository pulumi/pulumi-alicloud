...
class GatewayEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_name: The name of endpoint service.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC.
        :param pulumi.Input[builtins.str] gateway_endpoint_descrption: The description of the gateway endpoint.
        :param pulumi.Input[builtins.str] gateway_endpoint_name: The name of the gateway endpoint.
...
class _GatewayEndpointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: The creation time of the gateway endpoint.
        :param pulumi.Input[builtins.str] gateway_endpoint_descrption: The description of the gateway endpoint.
        :param pulumi.Input[builtins.str] gateway_endpoint_name: The name of the gateway endpoint.
        :param pulumi.Input[builtins.str] policy_document: Access control policies for cloud services. This parameter is required when the cloud service is oss. For details about the syntax and structure of access policies, see [syntax and structure of permission Policies](https://help.aliyun.com/document_detail/93739.html).
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the instance belongs.
