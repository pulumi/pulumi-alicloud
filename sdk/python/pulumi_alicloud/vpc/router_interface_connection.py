...
class RouterInterfaceConnectionArgs:
    def __init__(__self__, *,
                 ...
                 opposite_interface_id: pulumi.Input[builtins.str],
                 opposite_interface_owner_id: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_router_id: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_router_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RouterInterfaceConnection resource.
        :param pulumi.Input[builtins.str] interface_id: One side router interface ID.
        :param pulumi.Input[builtins.str] opposite_interface_id: Another side router interface ID. It must belong the specified "opposite_interface_owner_id" account.
        :param pulumi.Input[builtins.str] opposite_interface_owner_id: Another side router interface account ID. Log on to the Alibaba Cloud console, select User Info > Account Management to check the account ID. Default to Provider account_id.
        :param pulumi.Input[builtins.str] opposite_router_id: Another side router ID. It must belong the specified "opposite_interface_owner_id" account. It is valid when field "opposite_interface_owner_id" is specified.
        :param pulumi.Input[builtins.str] opposite_router_type: Another side router Type. Optional value: VRouter, VBR. It is valid when field "opposite_interface_owner_id" is specified.
    ...
    def opposite_interface_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def opposite_interface_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "opposite_interface_id", value)

    @property
    @pulumi.getter(name="oppositeInterfaceOwnerId")
    def opposite_interface_owner_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def opposite_interface_owner_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "opposite_interface_owner_id", value)

    @property
    @pulumi.getter(name="oppositeRouterId")
    def opposite_router_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def opposite_router_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "opposite_router_id", value)

    @property
    @pulumi.getter(name="oppositeRouterType")
    def opposite_router_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def opposite_router_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RouterInterfaceConnectionState:
    def __init__(__self__, *,
                 ...
                 opposite_interface_id: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_interface_owner_id: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_router_id: Optional[pulumi.Input[builtins.str]] = None,
                 opposite_router_type: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="oppositeInterfaceId")
    def opposite_interface_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Another side router interface ID. It must belong the specified "opposite_interface_owner_id" account.
        """
        return pulumi.get(self, "opposite_interface_id")
    ...
    @opposite_interface_id.setter
    def opposite_interface_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "opposite_interface_id", value)
...
class RouterInterfaceConnection(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:vpc/routerInterfaceConnection:RouterInterfaceConnection"
    ...
    def get(resource_name: str,
            ...
            opposite_interface_owner_id: Optional[pulumi.Input[builtins.str]] = None,
            opposite_router_id: Optional[pulumi.Input[builtins.str]] = None,
            opposite_router_type: Optional[pulumi.Input[builtins.str]] = None) -> 'RouterInterfaceConnection':
        """
    ...
    @property
    @pulumi.getter(name="oppositeInterfaceId")
    def opposite_interface_id(self) -> pulumi.Output[builtins.str]:
        """
        Another side router interface ID. It must belong the specified "opposite_interface_owner_id" account.
        """
        return pulumi.get(self, "opposite_interface_id")
    ...
    @property
    @pulumi.getter(name="oppositeInterfaceOwnerId")
    def opposite_interface_owner_id(self) -> pulumi.Output[builtins.str]:
        """
        Another side router interface account ID. Log on to the Alibaba Cloud console, select User Info > Account Management to check the account ID. Default to Provider account_id.
        """
        return pulumi.get(self, "opposite_interface_owner_id")
    ...
    @property
    @pulumi.getter(name="oppositeRouterId")
    def opposite_router_id(self) -> pulumi.Output[builtins.str]:
        """
        Another side router ID. It must belong the specified "opposite_interface_owner_id" account. It is valid when field "opposite_interface_owner_id" is specified.
        """
        return pulumi.get(self, "opposite_router_id")
    ...
    @property
    @pulumi.getter(name="oppositeRouterType")
    def opposite_router_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Another side router Type. Optional value: VRouter, VBR. It is valid when field "opposite_interface_owner_id" is specified.
