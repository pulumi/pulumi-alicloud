...
class GetNetworkAclsResult:
    ...
    def network_acl_name(self) -> Optional[builtins.str]:
...
def get_network_acls(ids: Optional[Sequence[builtins.str]] = None,
                     name_regex: Optional[builtins.str] = None,
                     network_acl_name: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Network Acl ID.
    :param builtins.str name_regex: A regex string to filter results by Network Acl name.
    ...
    :param builtins.str resource_type: The type of the associated resource. Valid values `VSwitch`. `resource_type` and `resource_id` need to be specified at the same time to take effect.
    :param builtins.str status: The state of the network ACL. Valid values: `Available` and `Modifying`.
...
def get_network_acls_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                            name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            network_acl_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
