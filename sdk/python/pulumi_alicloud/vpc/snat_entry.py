...
class SnatEntryArgs:
    def __init__(__self__, *,
                 snat_ip: pulumi.Input[builtins.str],
                 snat_table_id: pulumi.Input[builtins.str],
                 eip_affinity: Optional[pulumi.Input[builtins.int]] = None,
                 snat_entry_name: Optional[pulumi.Input[builtins.str]] = None,
                 source_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 source_vswitch_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SnatEntry resource.
        :param pulumi.Input[builtins.str] snat_ip: The IP of a SNAT entry. Separate multiple EIP or NAT IP addresses with commas (,). **NOTE:** From version 1.241.0, `snat_ip` can be modified.
        :param pulumi.Input[builtins.str] snat_table_id: The ID of the SNAT table.
        :param pulumi.Input[builtins.int] eip_affinity: Specifies whether to enable EIP affinity. Default value: `0`. Valid values:
        :param pulumi.Input[builtins.str] snat_entry_name: The name of the SNAT entry. The name must be `2` to `128` characters in length. It must start with a letter but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] source_cidr: The source CIDR block specified in the SNAT entry.
        :param pulumi.Input[builtins.str] source_vswitch_id: The ID of the vSwitch.
        """
    ...
    def snat_ip(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @snat_ip.setter
    def snat_ip(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "snat_ip", value)

    @property
    @pulumi.getter(name="snatTableId")
    def snat_table_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def snat_table_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "snat_table_id", value)

    @property
    @pulumi.getter(name="eipAffinity")
    def eip_affinity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @eip_affinity.setter
    def eip_affinity(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def source_vswitch_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_vswitch_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SnatEntryState:
    def __init__(__self__, *,
                 ...
                 snat_entry_name: Optional[pulumi.Input[builtins.str]] = None,
                 snat_ip: Optional[pulumi.Input[builtins.str]] = None,
                 snat_table_id: Optional[pulumi.Input[builtins.str]] = None,
                 source_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 source_vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] eip_affinity: Specifies whether to enable EIP affinity. Default value: `0`. Valid values:
        :param pulumi.Input[builtins.str] snat_entry_id: The id of the snat entry on the server.
        :param pulumi.Input[builtins.str] snat_entry_name: The name of the SNAT entry. The name must be `2` to `128` characters in length. It must start with a letter but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] snat_ip: The IP of a SNAT entry. Separate multiple EIP or NAT IP addresses with commas (,). **NOTE:** From version 1.241.0, `snat_ip` can be modified.
        :param pulumi.Input[builtins.str] snat_table_id: The ID of the SNAT table.
        :param pulumi.Input[builtins.str] source_cidr: The source CIDR block specified in the SNAT entry.
        :param pulumi.Input[builtins.str] source_vswitch_id: The ID of the vSwitch.
        :param pulumi.Input[builtins.str] status: (Available since v1.119.1) The ID of the SNAT entry.
        """
        if eip_affinity is not None:
            pulumi.set(__self__, "eip_affinity", eip_affinity)
    ...
    @property
    @pulumi.getter(name="snatIp")
    def snat_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IP of a SNAT entry. Separate multiple EIP or NAT IP addresses with commas (,). **NOTE:** From version 1.241.0, `snat_ip` can be modified.
        """
        return pulumi.get(self, "snat_ip")
    ...
    @snat_ip.setter
    def snat_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "snat_ip", value)

    @property
    @pulumi.getter(name="snatTableId")
    def snat_table_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the SNAT table.
        """
        return pulumi.get(self, "snat_table_id")
    ...
    @snat_table_id.setter
    def snat_table_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "snat_table_id", value)
...
class SnatEntry(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:vpc/snatEntry:SnatEntry"
    ...
    def get(resource_name: str,
            ...
            source_cidr: Optional[pulumi.Input[builtins.str]] = None,
            source_vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'SnatEntry':
        """
    ...
    @property
    @pulumi.getter(name="eipAffinity")
    def eip_affinity(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specifies whether to enable EIP affinity. Default value: `0`. Valid values:
        """
        return pulumi.get(self, "eip_affinity")
    ...
    @property
    @pulumi.getter(name="snatEntryName")
    def snat_entry_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the SNAT entry. The name must be `2` to `128` characters in length. It must start with a letter but cannot start with `http://` or `https://`.
        """
        return pulumi.get(self, "snat_entry_name")
    ...
    @property
    @pulumi.getter(name="snatIp")
    def snat_ip(self) -> pulumi.Output[builtins.str]:
        """
        The IP of a SNAT entry. Separate multiple EIP or NAT IP addresses with commas (,). **NOTE:** From version 1.241.0, `snat_ip` can be modified.
        """
        return pulumi.get(self, "snat_ip")
    ...
    @property
    @pulumi.getter(name="snatTableId")
    def snat_table_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the SNAT table.
        """
        return pulumi.get(self, "snat_table_id")
    ...
    @property
    @pulumi.getter(name="sourceVswitchId")
    def source_vswitch_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the vSwitch.
        """
        return pulumi.get(self, "source_vswitch_id")
