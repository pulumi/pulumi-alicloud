...
class GetIpamIpamPoolAllocationsResult:
    ...
    def ipam_pool_allocation_id(self) -> Optional[builtins.str]:
        """
    ...
    def ipam_pool_allocation_name(self) -> Optional[builtins.str]:
        """
...
def get_ipam_ipam_pool_allocations(cidr: Optional[builtins.str] = None,
                                   ids: Optional[Sequence[builtins.str]] = None,
                                   ipam_pool_allocation_id: Optional[builtins.str] = None,
                                   ipam_pool_allocation_name: Optional[builtins.str] = None,
    ...
    :param builtins.str cidr: The allocated address segment.
    :param Sequence[builtins.str] ids: A list of Ipam Pool Allocation IDs.
    :param builtins.str ipam_pool_allocation_id: The instance ID of the ipam pool allocation.
    :param builtins.str ipam_pool_allocation_name: The name of the ipam pool allocation.It must be 1 to 128 characters in length and cannot start with 'http:// 'or 'https.
    :param builtins.str ipam_pool_id: The ID of the IPAM Pool.
...
def get_ipam_ipam_pool_allocations_output(cidr: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                          ipam_pool_allocation_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          ipam_pool_allocation_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
