...
class Ipv6GatewayArgs:
    def __init__(__self__, *,
                 ...
                 ipv6_gateway_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] vpc_id: The ID of the virtual private cloud (VPC) for which you want to create the IPv6 gateway.
        :param pulumi.Input[builtins.str] description: The description of the IPv6 gateway. The description must be 2 to 256 characters in length. It cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] ipv6_gateway_name: The name of the IPv6 gateway. The name must be 2 to 128 characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter but cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the instance belongs.
        :param pulumi.Input[builtins.str] spec: IPv6 gateways do not distinguish between specifications. This parameter is no longer used.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags for the resource.
        """
    ...
    def ipv6_gateway_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipv6_gateway_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _Ipv6GatewayState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] business_status: The status of the IPv6 gateway.
        :param pulumi.Input[builtins.str] create_time: The creation time of the resource.
        :param pulumi.Input[builtins.str] description: The description of the IPv6 gateway. The description must be 2 to 256 characters in length. It cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] expired_time: The expiration time of IPv6 gateway.
        :param pulumi.Input[builtins.str] instance_charge_type: The charge type of IPv6 gateway.
        :param pulumi.Input[builtins.str] ipv6_gateway_id: Resource primary key attribute field.
        :param pulumi.Input[builtins.str] ipv6_gateway_name: The name of the IPv6 gateway. The name must be 2 to 128 characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter but cannot start with http:// or https://.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the instance belongs.
        :param pulumi.Input[builtins.str] spec: IPv6 gateways do not distinguish between specifications. This parameter is no longer used.
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid values: Available, Pending and Deleting.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags for the resource.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the virtual private cloud (VPC) for which you want to create the IPv6 gateway.
        """
...
class Ipv6Gateway(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="ipv6GatewayName")
    def ipv6_gateway_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the IPv6 gateway. The name must be 2 to 128 characters in length, and can contain letters, digits, underscores (_), and hyphens (-). The name must start with a letter but cannot start with http:// or https://.
        """
        return pulumi.get(self, "ipv6_gateway_name")
