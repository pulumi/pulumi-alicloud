...
class NetworkAclArgs:
    def __init__(__self__, *,
                 ...
                 network_acl_name: Optional[pulumi.Input[builtins.str]] = None,
                 resources: Optional[pulumi.Input[Sequence[pulumi.Input['NetworkAclResourceArgs']]]] = None,
                 source_network_acl_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The description of the network ACL.  The description must be 1 to 256 characters in length and cannot start with http:// or https.
        ...
        :param pulumi.Input[builtins.str] name: . Field 'name' has been deprecated from provider version 1.122.0. New field 'network_acl_name' instead.
        :param pulumi.Input[builtins.str] network_acl_name: The name of the network ACL.  The name must be 1 to 128 characters in length and cannot start with http:// or https.
        :param pulumi.Input[Sequence[pulumi.Input['NetworkAclResourceArgs']]] resources: The associated resource. See `resources` below.
        :param pulumi.Input[builtins.str] source_network_acl_id: SOURCE NetworkAcl specified by CopyNetworkAclEntries.
    ...
    def network_acl_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_network_acl_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_network_acl_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NetworkAclState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NetworkAclResourceArgs']]] resources: The associated resource. See `resources` below.
        :param pulumi.Input[builtins.str] source_network_acl_id: SOURCE NetworkAcl specified by CopyNetworkAclEntries.
        :param pulumi.Input[builtins.str] status: The state of the network ACL.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags of this resource.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the associated VPC.
...
class NetworkAcl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkAcl':
        """
    ...
    @property
    @pulumi.getter(name="sourceNetworkAclId")
    def source_network_acl_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        SOURCE NetworkAcl specified by CopyNetworkAclEntries.
        """
        return pulumi.get(self, "source_network_acl_id")
