...
class Ipv6InternetBandwidthArgs:
    def __init__(__self__, *,
                 ...
                 ipv6_address_id: pulumi.Input[builtins.str],
                 ipv6_gateway_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.int] bandwidth: The amount of Internet bandwidth resources of the IPv6 address, Unit: `Mbit/s`. Valid values: `1` to `5000`. **NOTE:** If `internet_charge_type` is set to `PayByTraffic`, the amount of Internet bandwidth resources of the IPv6 address is limited by the specification of the IPv6 gateway. `Small` (default): specifies the Free edition and the Internet bandwidth is from `1` to `500` Mbit/s. `Medium`: specifies the Medium edition and the Internet bandwidth is from `1` to `1000` Mbit/s. `Large`: specifies the Large edition and the Internet bandwidth is from `1` to `2000` Mbit/s.
        :param pulumi.Input[builtins.str] ipv6_address_id: The ID of the IPv6 address instance.
        :param pulumi.Input[builtins.str] ipv6_gateway_id: The ID of the IPv6 gateway to which the IPv6 address belongs.
        :param pulumi.Input[builtins.str] internet_charge_type: The metering method of the Internet bandwidth resources of the IPv6 gateway. Valid values: `PayByBandwidth`, `PayByTraffic`.
        """
    ...
    def ipv6_address_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ipv6_address_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ipv6_address_id", value)

    @property
    @pulumi.getter(name="ipv6GatewayId")
    def ipv6_gateway_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ipv6_gateway_id(self, value: pulumi.Input[builtins.str]):
...
class _Ipv6InternetBandwidthState:
    def __init__(__self__, *,
                 ...
                 internet_charge_type: Optional[pulumi.Input[builtins.str]] = None,
                 ipv6_address_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="ipv6AddressId")
    def ipv6_address_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the IPv6 address instance.
        """
        return pulumi.get(self, "ipv6_address_id")
    ...
    @ipv6_address_id.setter
    def ipv6_address_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipv6_address_id", value)
...
class Ipv6InternetBandwidth(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ipv6_address_id: Optional[pulumi.Input[builtins.str]] = None,
            ipv6_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'Ipv6InternetBandwidth':
        """
    ...
    @property
    @pulumi.getter(name="ipv6AddressId")
    def ipv6_address_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the IPv6 address instance.
        """
        return pulumi.get(self, "ipv6_address_id")
