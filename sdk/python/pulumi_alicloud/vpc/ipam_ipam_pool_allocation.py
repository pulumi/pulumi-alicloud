...
class IpamIpamPoolAllocationArgs:
    def __init__(__self__, *,
                 ...
                 ipam_pool_allocation_description: Optional[pulumi.Input[builtins.str]] = None,
                 ipam_pool_allocation_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a IpamIpamPoolAllocation resource.
        :param pulumi.Input[builtins.str] ipam_pool_id: The ID of the IPAM Pool.
        :param pulumi.Input[builtins.str] cidr: The allocated address segment.
        :param pulumi.Input[builtins.int] cidr_mask: Create a custom reserved network segment from The IPAM address pool by entering a mask.
               
               > **NOTE:**  Enter at least one of `Cidr` or **CidrMask.
        :param pulumi.Input[builtins.str] ipam_pool_allocation_description: The description of the ipam pool alloctaion.
        ...
        :param pulumi.Input[builtins.str] ipam_pool_allocation_name: The name of the ipam pool allocation.
    ...
    def ipam_pool_allocation_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipam_pool_allocation_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipam_pool_allocation_description", value)

    @property
    @pulumi.getter(name="ipamPoolAllocationName")
    def ipam_pool_allocation_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipam_pool_allocation_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _IpamIpamPoolAllocationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ipam_pool_allocation_name: The name of the ipam pool allocation.
               It must be 1 to 128 characters in length and cannot start with 'http:// 'or 'https.
        :param pulumi.Input[builtins.str] ipam_pool_id: The ID of the IPAM Pool.
        :param pulumi.Input[builtins.str] region_id: When the IPAM Pool to which CIDR is allocated has the region attribute, this attribute is the IPAM Pool region.
               When the IPAM Pool to which CIDR is allocated does not have the region attribute, this attribute is the IPAM region.
        :param pulumi.Input[builtins.str] status: The status of the instance. Value:
        """
        if cidr is not None:
            pulumi.set(__self__, "cidr", cidr)
        if cidr_mask is not None:
...
class IpamIpamPoolAllocation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ipam_pool_id: Optional[pulumi.Input[builtins.str]] = None,
            region_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'IpamIpamPoolAllocation':
        """
    ...
    @property
    @pulumi.getter(name="ipamPoolAllocationDescription")
    def ipam_pool_allocation_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the ipam pool alloctaion.
        It must be 1 to 256 characters in length and must start with an English letter or Chinese character, but cannot start with 'http:// 'or 'https. If it is not filled in, it is empty. The default value is empty.
        """
    ...
    @property
    @pulumi.getter(name="ipamPoolAllocationName")
    def ipam_pool_allocation_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the ipam pool allocation.
        It must be 1 to 128 characters in length and cannot start with 'http:// 'or 'https.
        """
