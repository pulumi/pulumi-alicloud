...
class PeerConnectionAccepterArgs:
    def __init__(__self__, *,
                 ...
                 peer_connection_accepter_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_id: The ID of the VPC peering connection whose name or description you want to modify.
        :param pulumi.Input[builtins.int] bandwidth: The new bandwidth of the VPC peering connection. Unit: Mbit/s. The value must be an integer greater than 0.
        :param pulumi.Input[builtins.str] description: The new description of the VPC peering connection.
        ...
        :param pulumi.Input[builtins.str] link_type: Link Type
        :param pulumi.Input[builtins.str] peer_connection_accepter_name: The new name of the VPC peering connection.
    ...
    def peer_connection_accepter_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_connection_accepter_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PeerConnectionAccepterState:
    def __init__(__self__, *,
                 accepting_owner_uid: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] accepting_owner_uid: The ID of the Alibaba Cloud account (primary account) of the receiving end of the VPC peering connection to be created.-to-peer connection to the VPC account.-account VPC peer-to-peer connection.
        :param pulumi.Input[builtins.str] accepting_region_id: The region ID of the recipient of the VPC peering connection to be created.-to-peer connection in the same region, enter the same region ID as the region ID of the initiator.-region VPC peer-to-peer connection, enter a region ID that is different from the region ID of the initiator.
        :param pulumi.Input[builtins.str] accepting_vpc_id: The VPC ID of the receiving end of the VPC peer connection.
        :param pulumi.Input[builtins.int] bandwidth: The new bandwidth of the VPC peering connection. Unit: Mbit/s. The value must be an integer greater than 0.
        ...
        :param pulumi.Input[builtins.str] peer_connection_accepter_name: The new name of the VPC peering connection.
               The name must be 1 to 128 characters in length, and cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] region_id: The ID of the region where you want to query VPC peering connections.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the new resource group.
               
               > **NOTE:**   You can use resource groups to manage resources within your Alibaba Cloud account by group. This helps you resolve issues such as resource grouping and permission management for your Alibaba Cloud account. For more information, see [What is resource management?](https://www.alibabacloud.com/help/en/doc-detail/94475.html)
        :param pulumi.Input[builtins.str] status: The status of the resource
        :param pulumi.Input[builtins.str] vpc_id: The VPC ID of the initiator of the VPC peering connection.
        """
    ...
    def accepting_owner_uid(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def accepting_owner_uid(self, value: Optional[pulumi.Input[builtins.int]]):
...
class PeerConnectionAccepter(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:vpc/peerConnectionAccepter:PeerConnectionAccepter"
    ...
    def get(resource_name: str,
            ...
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PeerConnectionAccepter':
        """
    ...
    @property
    @pulumi.getter(name="acceptingOwnerUid")
    def accepting_owner_uid(self) -> pulumi.Output[builtins.int]:
        """
        The ID of the Alibaba Cloud account (primary account) of the receiving end of the VPC peering connection to be created.-to-peer connection to the VPC account.-account VPC peer-to-peer connection.
        """
        return pulumi.get(self, "accepting_owner_uid")
    ...
    @property
    @pulumi.getter(name="peerConnectionAccepterName")
    def peer_connection_accepter_name(self) -> pulumi.Output[builtins.str]:
        """
        The new name of the VPC peering connection.
        The name must be 1 to 128 characters in length, and cannot start with `http://` or `https://`.
        """
