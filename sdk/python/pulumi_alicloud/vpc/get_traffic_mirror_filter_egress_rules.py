...
def get_traffic_mirror_filter_egress_rules(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Traffic Mirror Filter Egress Rule IDs.
...
def get_traffic_mirror_filter_egress_rules_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
