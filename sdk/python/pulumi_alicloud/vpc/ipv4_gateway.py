...
class Ipv4GatewayArgs:
    ...
    def ipv4_gateway_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipv4_gateway_description", value)

    @property
    @pulumi.getter(name="ipv4GatewayName")
    def ipv4_gateway_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipv4_gateway_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _Ipv4GatewayState:
    def __init__(__self__, *,
                 ...
                 ipv4_gateway_name: Optional[pulumi.Input[builtins.str]] = None,
                 ipv4_gateway_route_table_id: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def ipv4_gateway_route_table_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Ipv4Gateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Ipv4Gateway':
        """
    ...
    @property
    @pulumi.getter(name="ipv4GatewayName")
    def ipv4_gateway_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the IPv4 gateway. The name must be 2 to 128 characters in length, and can contain letters, digits, periods (.), underscores (_), and hyphens (-). It must start with a letter.
        """
        return pulumi.get(self, "ipv4_gateway_name")
