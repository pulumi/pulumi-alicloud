...
class CommonBandwithPackageAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 bandwidth_package_bandwidth: Optional[pulumi.Input[builtins.str]] = None,
                 cancel_common_bandwidth_package_ip_bandwidth: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] bandwidth_package_id: The ID of the Internet Shared Bandwidth instance.
        :param pulumi.Input[builtins.str] instance_id: The ID of the EIP that you want to query.
        ...
        :param pulumi.Input[builtins.str] bandwidth_package_bandwidth: The maximum bandwidth for the EIP. This value cannot be larger than the maximum bandwidth of the Internet Shared Bandwidth instance. Unit: Mbit/s.
        :param pulumi.Input[builtins.bool] cancel_common_bandwidth_package_ip_bandwidth: Whether to cancel the maximum bandwidth configuration for the EIP. Default: false.
        :param pulumi.Input[builtins.str] ip_type: The type of IP address. Set the value to `EIP` to associate EIPs with the Internet Shared Bandwidth instance.
        """
    ...
    def bandwidth_package_bandwidth(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bandwidth_package_bandwidth(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bandwidth_package_bandwidth", value)

    @property
    @pulumi.getter(name="cancelCommonBandwidthPackageIpBandwidth")
    def cancel_common_bandwidth_package_ip_bandwidth(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def cancel_common_bandwidth_package_ip_bandwidth(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _CommonBandwithPackageAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The ID of the EIP that you want to query.
               ...
               > **NOTE:**   If both `EipAddress` and `AllocationId` are specified, you can specify up to 50 EIP IDs for `AllocationId`, and specify up to 50 EIPs for `EipAddress`.
        :param pulumi.Input[builtins.str] ip_type: The type of IP address. Set the value to `EIP` to associate EIPs with the Internet Shared Bandwidth instance.
        :param pulumi.Input[builtins.str] status: The status of the Internet Shared Bandwidth instance.
        """
        if bandwidth_package_bandwidth is not None:
            pulumi.set(__self__, "bandwidth_package_bandwidth", bandwidth_package_bandwidth)
...
class CommonBandwithPackageAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            ip_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'CommonBandwithPackageAttachment':
        """
    ...
    @property
    @pulumi.getter(name="bandwidthPackageBandwidth")
    def bandwidth_package_bandwidth(self) -> pulumi.Output[builtins.str]:
        """
        The maximum bandwidth for the EIP. This value cannot be larger than the maximum bandwidth of the Internet Shared Bandwidth instance. Unit: Mbit/s.
        """
        return pulumi.get(self, "bandwidth_package_bandwidth")
    ...
    @property
    @pulumi.getter(name="cancelCommonBandwidthPackageIpBandwidth")
    def cancel_common_bandwidth_package_ip_bandwidth(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to cancel the maximum bandwidth configuration for the EIP. Default: false.
        """
        return pulumi.get(self, "cancel_common_bandwidth_package_ip_bandwidth")
