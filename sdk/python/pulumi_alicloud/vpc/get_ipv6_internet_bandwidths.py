...
class GetIpv6InternetBandwidthsResult:
    ...
    def ipv6_address_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "ipv6_address_id")

    @property
    @pulumi.getter(name="ipv6InternetBandwidthId")
    def ipv6_internet_bandwidth_id(self) -> Optional[builtins.str]:
...
def get_ipv6_internet_bandwidths(ids: Optional[Sequence[builtins.str]] = None,
                                 ipv6_address_id: Optional[builtins.str] = None,
                                 ipv6_internet_bandwidth_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ipv6 Internet Bandwidth IDs.
    :param builtins.str ipv6_address_id: The ID of the IPv6 address.
    :param builtins.str ipv6_internet_bandwidth_id: The ID of the Ipv6 Internet Bandwidth.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the resource. Valid values: `Normal`, `FinancialLocked` and `SecurityLocked`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_ipv6_internet_bandwidths_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                        ipv6_address_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        ipv6_internet_bandwidth_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
