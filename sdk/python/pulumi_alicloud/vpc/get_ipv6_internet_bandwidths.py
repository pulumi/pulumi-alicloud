...
class GetIpv6InternetBandwidthsResult:
    ...
    def ipv6_address_id(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "ipv6_address_id")

    @_builtins.property
    @pulumi.getter(name="ipv6InternetBandwidthId")
    def ipv6_internet_bandwidth_id(self) -> Optional[_builtins.str]:
...
def get_ipv6_internet_bandwidths(ids: Optional[Sequence[_builtins.str]] = None,
                                 ipv6_address_id: Optional[_builtins.str] = None,
                                 ipv6_internet_bandwidth_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Ipv6 Internet Bandwidth IDs.
...
def get_ipv6_internet_bandwidths_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                        ipv6_address_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                        ipv6_internet_bandwidth_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
