...
def get_ssl_vpn_servers(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: IDs of the SSL-VPN servers.
    :param builtins.str name_regex: A regex string of SSL-VPN server name.
...
def get_ssl_vpn_servers_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
