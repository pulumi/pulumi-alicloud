...
class GetSslVpnServersResult:
    ...
    @property
    @pulumi.getter
    def servers(self) -> List['outputs.GetSslVpnServersServerResult']:
        """
...
def get_ssl_vpn_servers(ids: Optional[List[str]] = None,
    ...
    :param List[str] ids: IDs of the SSL-VPN servers.
