...
def get_traffic_mirror_service(enable: Optional[builtins.str] = None,
...
def get_traffic_mirror_service_output(enable: Optional[pulumi.Input[Optional[builtins.str]]] = None,
