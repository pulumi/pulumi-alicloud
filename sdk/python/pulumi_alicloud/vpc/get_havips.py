...
def get_havips(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ha Vip IDs.
    :param builtins.str name_regex: A regex string to filter results by Ha Vip name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of HaVip instance. Valid value: `Available`, `InUse` and `Pending`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_havips_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
