...
def get_havips(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Ha Vip IDs.
    :param _builtins.str name_regex: A regex string to filter results by Ha Vip name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str status: The status of HaVip instance. Valid value: `Available`, `InUse` and `Pending`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_havips_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                      name_regex: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                      output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                      status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetHavipsResult]:
    """
    This data source provides the Havips of the current Alibaba Cloud user.
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:vpc/getHavips:getHavips', __args__, opts=opts, typ=GetHavipsResult)
    return __ret__.apply(lambda __response__: GetHavipsResult(
        havips=pulumi.get(__response__, 'havips'),
