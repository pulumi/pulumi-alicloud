...
class PrefixListArgs:
    def __init__(__self__, *,
                 ...
                 prefix_list_description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] ip_version: The IP version of the prefix list. Value:-**IPV4**:IPv4 version.-**IPV6**:IPv6 version.
        :param pulumi.Input[builtins.int] max_entries: The maximum number of entries for CIDR address blocks in the prefix list.
        :param pulumi.Input[builtins.str] prefix_list_description: The description of the prefix list.It must be 2 to 256 characters in length and must start with a letter or Chinese, but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] prefix_list_name: The name of the prefix list. The name must be 2 to 128 characters in length, and must start with a letter. It can contain digits, periods (.), underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the PrefixList belongs.
    ...
    def prefix_list_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def prefix_list_description(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PrefixListState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: The time when the prefix list was created.
        :param pulumi.Input[Sequence[pulumi.Input['PrefixListEntryArgs']]] entrys: The CIDR address block list of the prefix list.See the following `Block Entrys`.
        :param pulumi.Input[builtins.str] ip_version: The IP version of the prefix list. Value:-**IPV4**:IPv4 version.-**IPV6**:IPv6 version.
        :param pulumi.Input[builtins.int] max_entries: The maximum number of entries for CIDR address blocks in the prefix list.
        ...
        :param pulumi.Input[builtins.str] prefix_list_description: The description of the prefix list.It must be 2 to 256 characters in length and must start with a letter or Chinese, but cannot start with `http://` or `https://`.
        :param pulumi.Input[builtins.str] prefix_list_id: The ID of the query Prefix List.
        :param pulumi.Input[builtins.str] prefix_list_name: The name of the prefix list. The name must be 2 to 128 characters in length, and must start with a letter. It can contain digits, periods (.), underscores (_), and hyphens (-).
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the PrefixList belongs.
        :param pulumi.Input[builtins.str] share_type: The share type of the prefix list. Value:-**Shared**: indicates that the prefix list is a Shared prefix list.-Null: indicates that the prefix list is not a shared prefix list.
        :param pulumi.Input[builtins.str] status: Resource attribute fields that represent the status of the resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags of PrefixList.
        """
...
class PrefixList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            share_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'PrefixList':
        """
    ...
    @property
    @pulumi.getter(name="prefixListDescription")
    def prefix_list_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the prefix list.It must be 2 to 256 characters in length and must start with a letter or Chinese, but cannot start with `http://` or `https://`.
        """
        return pulumi.get(self, "prefix_list_description")
    ...
    @property
    @pulumi.getter(name="prefixListName")
    def prefix_list_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the prefix list. The name must be 2 to 128 characters in length, and must start with a letter. It can contain digits, periods (.), underscores (_), and hyphens (-).
        """
        return pulumi.get(self, "prefix_list_name")
    ...
    @property
    @pulumi.getter(name="shareType")
    def share_type(self) -> pulumi.Output[builtins.str]:
        """
        The share type of the prefix list. Value:-**Shared**: indicates that the prefix list is a Shared prefix list.-Null: indicates that the prefix list is not a shared prefix list.
        """
        return pulumi.get(self, "share_type")
