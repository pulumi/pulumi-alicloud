...
class GetIpv6EgressRulesResult:
    ...
    def ipv6_egress_rule_name(self) -> Optional[_builtins.str]:
...
def get_ipv6_egress_rules(ids: Optional[Sequence[_builtins.str]] = None,
                          instance_id: Optional[_builtins.str] = None,
                          ipv6_egress_rule_name: Optional[_builtins.str] = None,
                          ipv6_gateway_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Ipv6 Egress Rule IDs.
    :param _builtins.str instance_id: The ID of the instance that is associated with the IPv6 address to which the egress-only rule is applied.
    ...
    :param _builtins.str name_regex: A regex string to filter results by Ipv6 Egress Rule name.
...
def get_ipv6_egress_rules_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                 instance_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 ipv6_egress_rule_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
