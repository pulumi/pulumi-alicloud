...
class GetIpv6EgressRulesResult:
    ...
    def ipv6_egress_rule_name(self) -> Optional[builtins.str]:
...
def get_ipv6_egress_rules(ids: Optional[Sequence[builtins.str]] = None,
                          instance_id: Optional[builtins.str] = None,
                          ipv6_egress_rule_name: Optional[builtins.str] = None,
                          ipv6_gateway_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Ipv6 Egress Rule IDs.
    :param builtins.str instance_id: The ID of the instance that is associated with the IPv6 address to which the egress-only rule is applied.
    ...
    :param builtins.str name_regex: A regex string to filter results by Ipv6 Egress Rule name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str status: The status of the resource. Valid values: `Available`, `Deleting`, `Pending`.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_ipv6_egress_rules_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 instance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 ipv6_egress_rule_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetIpv6EgressRulesResult(
        ...
        ipv6_egress_rule_name=pulumi.get(__response__, 'ipv6_egress_rule_name'),
