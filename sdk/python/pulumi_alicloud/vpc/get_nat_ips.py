...
class GetNatIpsResult:
    ...
    def nat_ip_cidr(self) -> Optional[builtins.str]:
        return pulumi.get(self, "nat_ip_cidr")

    @property
    @pulumi.getter(name="natIpIds")
    def nat_ip_ids(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "nat_ip_ids")

    @property
    @pulumi.getter(name="natIpNames")
    def nat_ip_names(self) -> Optional[Sequence[builtins.str]]:
...
def get_nat_ips(ids: Optional[Sequence[builtins.str]] = None,
                name_regex: Optional[builtins.str] = None,
                nat_gateway_id: Optional[builtins.str] = None,
                nat_ip_cidr: Optional[builtins.str] = None,
                nat_ip_ids: Optional[Sequence[builtins.str]] = None,
                nat_ip_names: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Nat Ip IDs.
    :param builtins.str name_regex: A regex string to filter results by Nat Ip name.
    :param builtins.str nat_gateway_id: The ID of the Virtual Private Cloud (VPC) NAT gateway for which you want to create the NAT IP address.
    :param builtins.str nat_ip_cidr: NAT IP ADDRESS of the address segment.
    :param Sequence[builtins.str] nat_ip_names: NAT IP ADDRESS the name of the root directory. Length is from `2` to `128` characters, must start with a letter or the Chinese at the beginning can contain numbers, half a period (.), underscore (_) and dash (-). But do not start with `http://` or `https://` at the beginning.
...
def get_nat_ips_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                       name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       nat_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
                       nat_ip_cidr: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       nat_ip_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                       nat_ip_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
