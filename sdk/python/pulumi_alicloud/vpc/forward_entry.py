...
class ForwardEntryArgs:
    def __init__(__self__, *,
                 ...
                 forward_table_id: pulumi.Input[builtins.str],
                 internal_ip: pulumi.Input[builtins.str],
                 internal_port: pulumi.Input[builtins.str],
                 ip_protocol: pulumi.Input[builtins.str],
                 forward_entry_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 port_break: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a ForwardEntry resource.
        :param pulumi.Input[builtins.str] external_ip: The external ip address, the ip must along bandwidth package public ip which `vpc.NatGateway` argument `bandwidth_packages`.
        :param pulumi.Input[builtins.str] external_port: The external port, valid value is 1~65535|any.
        :param pulumi.Input[builtins.str] forward_table_id: The value can get from `vpc.NatGateway` Attributes "forward_table_ids".
        :param pulumi.Input[builtins.str] internal_ip: The internal ip, must a private ip.
        :param pulumi.Input[builtins.str] internal_port: The internal port, valid value is 1~65535|any.
        :param pulumi.Input[builtins.str] ip_protocol: The ip protocol, valid value is tcp|udp|any.
        :param pulumi.Input[builtins.str] forward_entry_name: The name of forward entry.
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.119.1. New field `forward_entry_name` instead.
    ...
    def forward_table_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def forward_table_id(self, value: pulumi.Input[builtins.str]):
    ...
    def forward_entry_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def forward_entry_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def port_break(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @port_break.setter
    def port_break(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ForwardEntryState:
    def __init__(__self__, *,
                 ...
                 forward_entry_id: Optional[pulumi.Input[builtins.str]] = None,
                 forward_entry_name: Optional[pulumi.Input[builtins.str]] = None,
                 forward_table_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] external_ip: The external ip address, the ip must along bandwidth package public ip which `vpc.NatGateway` argument `bandwidth_packages`.
        :param pulumi.Input[builtins.str] external_port: The external port, valid value is 1~65535|any.
        :param pulumi.Input[builtins.str] forward_entry_id: The id of the forward entry on the server.
        :param pulumi.Input[builtins.str] forward_entry_name: The name of forward entry.
        :param pulumi.Input[builtins.str] forward_table_id: The value can get from `vpc.NatGateway` Attributes "forward_table_ids".
        :param pulumi.Input[builtins.str] internal_ip: The internal ip, must a private ip.
        :param pulumi.Input[builtins.str] internal_port: The internal port, valid value is 1~65535|any.
    ...
    def forward_entry_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def forward_entry_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="forwardTableId")
    def forward_table_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The value can get from `vpc.NatGateway` Attributes "forward_table_ids".
        """
        return pulumi.get(self, "forward_table_id")
    ...
    @forward_table_id.setter
    def forward_table_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "forward_table_id", value)
...
class ForwardEntry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            port_break: Optional[pulumi.Input[builtins.bool]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ForwardEntry':
        """
    ...
    @property
    @pulumi.getter(name="forwardEntryId")
    def forward_entry_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the forward entry on the server.
        """
        return pulumi.get(self, "forward_entry_id")
    ...
    @property
    @pulumi.getter(name="forwardEntryName")
    def forward_entry_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of forward entry.
        """
        return pulumi.get(self, "forward_entry_name")
    ...
    @property
    @pulumi.getter(name="forwardTableId")
    def forward_table_id(self) -> pulumi.Output[builtins.str]:
        """
        The value can get from `vpc.NatGateway` Attributes "forward_table_ids".
        """
        return pulumi.get(self, "forward_table_id")
    ...
    @property
    @pulumi.getter(name="portBreak")
    def port_break(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to remove limits on the port range. Default value is `false`.
