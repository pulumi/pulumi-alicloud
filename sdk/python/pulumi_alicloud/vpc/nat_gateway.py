...
class NatGatewayArgs:
    def __init__(__self__, *,
                 ...
                 eip_bind_mode: Optional[pulumi.Input[builtins.str]] = None,
                 force: Optional[pulumi.Input[builtins.bool]] = None,
                 icmp_reply_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 private_link_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] deletion_protection: Whether enable the deletion protection or not. Default value: `false`.
               - true: Enable deletion protection.
               - false: Disable deletion protection.
        :param pulumi.Input[builtins.str] description: Description of the nat gateway, This description can have a string of 2 to 256 characters, It cannot begin with http:// or https://. Defaults to null.
        :param pulumi.Input[builtins.bool] dry_run: Specifies whether to only precheck this request. Default value: `false`.
        :param pulumi.Input[builtins.str] eip_bind_mode: The EIP binding mode of the NAT gateway. Default value: `MULTI_BINDED`. Valid values:
               - `MULTI_BINDED`: Multi EIP network card visible mode.
               - `NAT`: EIP normal mode, compatible with IPv4 gateway.
        :param pulumi.Input[builtins.bool] force: Specifies whether to forcefully delete the NAT gateway.
        :param pulumi.Input[builtins.bool] icmp_reply_enabled: Specifies whether to enable ICMP retrieval. Default value: `true`. Valid values:
        :param pulumi.Input[builtins.str] instance_charge_type: Field `instance_charge_type` has been deprecated from provider version 1.121.0. New field `payment_type` instead.
        :param pulumi.Input[builtins.str] internet_charge_type: The internet charge type. Valid values `PayByLcu`. The `PayByLcu` is only support enhanced NAT. **NOTE:** From version 1.137.0, `internet_charge_type` cannot be set to `PayBySpec`.
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.121.0. New field `nat_gateway_name` instead.
        :param pulumi.Input[builtins.str] nat_gateway_name: Name of the nat gateway. The value can have a string of 2 to 128 characters, must contain only alphanumeric characters or hyphens, such as "-",".","_", and must not begin or end with a hyphen, and must not begin with http:// or https://. Defaults to null.
        :param pulumi.Input[builtins.str] nat_type: The type of NAT gateway. Valid values: `Enhanced`. **NOTE:** From version 1.137.0, `nat_type` cannot be set to `Normal`.
        :param pulumi.Input[builtins.str] network_type: Indicates the type of the created NAT gateway. Valid values `internet` and `intranet`. `internet`: Internet NAT Gateway. `intranet`: VPC NAT Gateway.
        :param pulumi.Input[builtins.str] payment_type: The billing method of the NAT gateway. Valid values are `PayAsYouGo`. Default to `PayAsYouGo`.
        :param pulumi.Input[builtins.int] period: The duration that you will buy the resource, in month. It is valid when `payment_type` is `Subscription`. Valid values: [1-9, 12, 24, 36]. At present, the provider does not support modify "period" and you can do that via web console. **NOTE:** International station only supports `Subscription`.
               > **NOTE:** The attribute `period` is only used to create Subscription instance or modify the PayAsYouGo instance to Subscription. Once effect, it will not be modified that means running `pulumi up` will not effect the resource.
        :param pulumi.Input[builtins.bool] private_link_enabled: Specifies whether to enable PrivateLink. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.str] specification: The specification of the nat gateway. Valid values are `Small`, `Middle` and `Large`. Effective when `internet_charge_type` is `PayBySpec` and `network_type` is `internet`. Details refer to [Nat Gateway Specification](https://help.aliyun.com/document_detail/203500.html).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags of NAT gateway.
    ...
    def eip_bind_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def eip_bind_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def icmp_reply_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def icmp_reply_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def private_link_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def private_link_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _NatGatewayState:
    def __init__(__self__, *,
                 ...
                 eip_bind_mode: Optional[pulumi.Input[builtins.str]] = None,
                 force: Optional[pulumi.Input[builtins.bool]] = None,
                 forward_table_ids: Optional[pulumi.Input[builtins.str]] = None,
                 icmp_reply_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 instance_charge_type: Optional[pulumi.Input[builtins.str]] = None,
                 internet_charge_type: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 period: Optional[pulumi.Input[builtins.int]] = None,
                 private_link_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 snat_table_ids: Optional[pulumi.Input[builtins.str]] = None,
                 specification: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] eip_bind_mode: The EIP binding mode of the NAT gateway. Default value: `MULTI_BINDED`. Valid values:
               ...
               - `NAT`: EIP normal mode, compatible with IPv4 gateway.
        :param pulumi.Input[builtins.bool] force: Specifies whether to forcefully delete the NAT gateway.
        :param pulumi.Input[builtins.str] forward_table_ids: The nat gateway will auto create a forward item.
        :param pulumi.Input[builtins.bool] icmp_reply_enabled: Specifies whether to enable ICMP retrieval. Default value: `true`. Valid values:
        :param pulumi.Input[builtins.str] instance_charge_type: Field `instance_charge_type` has been deprecated from provider version 1.121.0. New field `payment_type` instead.
        :param pulumi.Input[builtins.str] internet_charge_type: The internet charge type. Valid values `PayByLcu`. The `PayByLcu` is only support enhanced NAT. **NOTE:** From version 1.137.0, `internet_charge_type` cannot be set to `PayBySpec`.
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.121.0. New field `nat_gateway_name` instead.
        ...
        :param pulumi.Input[builtins.int] period: The duration that you will buy the resource, in month. It is valid when `payment_type` is `Subscription`. Valid values: [1-9, 12, 24, 36]. At present, the provider does not support modify "period" and you can do that via web console. **NOTE:** International station only supports `Subscription`.
               > **NOTE:** The attribute `period` is only used to create Subscription instance or modify the PayAsYouGo instance to Subscription. Once effect, it will not be modified that means running `pulumi up` will not effect the resource.
        :param pulumi.Input[builtins.bool] private_link_enabled: Specifies whether to enable PrivateLink. Default value: `false`. Valid values:
        :param pulumi.Input[builtins.str] snat_table_ids: The nat gateway will auto create a snat item.
        :param pulumi.Input[builtins.str] specification: The specification of the nat gateway. Valid values are `Small`, `Middle` and `Large`. Effective when `internet_charge_type` is `PayBySpec` and `network_type` is `internet`. Details refer to [Nat Gateway Specification](https://help.aliyun.com/document_detail/203500.html).
        :param pulumi.Input[builtins.str] status: (Available since v1.121.0) The status of NAT gateway.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tags of NAT gateway.
        :param pulumi.Input[builtins.str] vpc_id: The VPC ID.
        :param pulumi.Input[builtins.str] vswitch_id: The id of VSwitch.
        """
    ...
    def forward_table_ids(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def forward_table_ids(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def snat_table_ids(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def snat_table_ids(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NatGateway(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:vpc/natGateway:NatGateway"
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NatGateway':
        """
    ...
    @property
    @pulumi.getter(name="eipBindMode")
    def eip_bind_mode(self) -> pulumi.Output[builtins.str]:
        """
        The EIP binding mode of the NAT gateway. Default value: `MULTI_BINDED`. Valid values:
        - `MULTI_BINDED`: Multi EIP network card visible mode.
        - `NAT`: EIP normal mode, compatible with IPv4 gateway.
    ...
    @property
    @pulumi.getter(name="forwardTableIds")
    def forward_table_ids(self) -> pulumi.Output[builtins.str]:
        """
        The nat gateway will auto create a forward item.
        """
        return pulumi.get(self, "forward_table_ids")
    ...
    @property
    @pulumi.getter(name="icmpReplyEnabled")
    def icmp_reply_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to enable ICMP retrieval. Default value: `true`. Valid values:
        """
        return pulumi.get(self, "icmp_reply_enabled")
    ...
    @property
    @pulumi.getter(name="natType")
    def nat_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of NAT gateway. Valid values: `Enhanced`. **NOTE:** From version 1.137.0, `nat_type` cannot be set to `Normal`.
        """
        return pulumi.get(self, "nat_type")
    ...
    @property
    @pulumi.getter(name="privateLinkEnabled")
    def private_link_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable PrivateLink. Default value: `false`. Valid values:
        """
        return pulumi.get(self, "private_link_enabled")
    ...
    @property
    @pulumi.getter(name="snatTableIds")
    def snat_table_ids(self) -> pulumi.Output[builtins.str]:
        """
        The nat gateway will auto create a snat item.
        """
        return pulumi.get(self, "snat_table_ids")
