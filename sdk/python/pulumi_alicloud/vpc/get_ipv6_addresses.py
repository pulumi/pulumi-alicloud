...
def get_ipv6_addresses(associated_instance_id: Optional[builtins.str] = None,
...
def get_ipv6_addresses_output(associated_instance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
