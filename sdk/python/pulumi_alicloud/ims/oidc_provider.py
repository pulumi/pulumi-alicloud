...
class OidcProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] issuer_url: The issuer URL of the OIDC identity provider.
        :param pulumi.Input[builtins.str] oidc_provider_name: The name of the OIDC identity provider.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] client_ids: Client ID.
        :param pulumi.Input[builtins.str] description: Description of OIDC identity provider.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] fingerprints: The authentication fingerprint of the HTTPS CA certificate.
        :param pulumi.Input[builtins.int] issuance_limit_time: The earliest time when an external IdP is allowed to issue an ID Token. If the iat field in the ID Token is greater than the current time, the request is rejected.Unit: hours. Value range: 1~168.
        """
...
class _OidcProviderState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Alibaba Cloud Resource Name (ARN) of the OIDC IdP.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] client_ids: Client ID.
        :param pulumi.Input[builtins.str] create_time: Creation Time (UTC time).
        :param pulumi.Input[builtins.str] description: Description of OIDC identity provider.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] fingerprints: The authentication fingerprint of the HTTPS CA certificate.
        :param pulumi.Input[builtins.int] issuance_limit_time: The earliest time when an external IdP is allowed to issue an ID Token. If the iat field in the ID Token is greater than the current time, the request is rejected.Unit: hours. Value range: 1~168.
        :param pulumi.Input[builtins.str] issuer_url: The issuer URL of the OIDC identity provider.
...
class OidcProvider(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            issuance_limit_time: Optional[pulumi.Input[builtins.int]] = None,
            issuer_url: Optional[pulumi.Input[builtins.str]] = None,
            oidc_provider_name: Optional[pulumi.Input[builtins.str]] = None) -> 'OidcProvider':
        """
    ...
    @property
    @pulumi.getter(name="clientIds")
    def client_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Client ID.
        """
        return pulumi.get(self, "client_ids")
    ...
    @property
    @pulumi.getter
    def fingerprints(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The authentication fingerprint of the HTTPS CA certificate.
        """
        return pulumi.get(self, "fingerprints")
