...
class EnterpriseSnapshotPolicyCrossRegionCopyInfo(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Enable Snapshot replication.
...
class EnterpriseSnapshotPolicyCrossRegionCopyInfoRegion(dict):
    ...
    def __init__(__self__, *,
                 ...
                 retain_days: Optional[builtins.int] = None):
        """
        :param builtins.str region_id: Destination region ID.
        :param builtins.int retain_days: Number of days of snapshot retention for replication.
        """
    ...
    def retain_days(self) -> Optional[builtins.int]:
        """
...
class EnterpriseSnapshotPolicyRetainRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time_interval: Optional[builtins.int] = None,
                 time_unit: Optional[builtins.str] = None):
        """
        :param builtins.int number: Retention based on counting method.
        :param builtins.int time_interval: Time unit.
        :param builtins.str time_unit: Time-based retention.
        """
    ...
    def time_interval(self) -> Optional[builtins.int]:
        """
        Time unit.
        """
    ...
    def time_unit(self) -> Optional[builtins.str]:
        """
...
class EnterpriseSnapshotPolicySchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cron_expression: CronTab expression.
        """
...
class EnterpriseSnapshotPolicySpecialRetainRules(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Whether special reservations are enabled. Value range:
               - true
               - false.
...
class EnterpriseSnapshotPolicySpecialRetainRulesRule(dict):
    ...
    def __init__(__self__, *,
                 special_period_unit: Optional[builtins.str] = None,
                 time_interval: Optional[builtins.int] = None,
                 time_unit: Optional[builtins.str] = None):
        """
        :param builtins.str special_period_unit: The cycle unit of the special reserved snapshot. If the value is set to WEEKS, the first snapshot of each week is reserved. The retention time is determined by TimeUnit and TimeInterval. The value range is:
               - WEEKS
               - MONTHS
               - YEARS.
        """
    ...
    def special_period_unit(self) -> Optional[builtins.str]:
        """
...
class EnterpriseSnapshotPolicyStorageRule(dict):
    ...
    def __init__(__self__, *,
                 enable_immediate_access: Optional[builtins.bool] = None):
        """
        :param builtins.bool enable_immediate_access: Snapshot speed available.
        """
    ...
    def enable_immediate_access(self) -> Optional[builtins.bool]:
        """
...
class SolutionInstanceParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str parameter_key: Create parameter Key.
        :param builtins.str parameter_value: Create parameter Value.
        """
...
class GetDedicatedBlockStorageClustersClusterResult(dict):
    def __init__(__self__, *,
                 ...
                 dedicated_block_storage_cluster_id: builtins.str,
                 dedicated_block_storage_cluster_name: builtins.str,
                 delivery_capacity: builtins.str,
                 ...
                 status: builtins.str,
                 supported_category: builtins.str,
                 total_capacity: builtins.str,
                 type: builtins.str,
                 used_capacity: builtins.str,
                 zone_id: builtins.str):
        """
        :param builtins.str available_capacity: The available capacity of the dedicated block storage cluster. Unit: GiB.
        :param builtins.str category: The type of cloud disk that can be created by a dedicated block storage cluster.
        :param builtins.str create_time: The creation time of the resource
        :param builtins.str dedicated_block_storage_cluster_id: The first ID of the resource
        :param builtins.str dedicated_block_storage_cluster_name: The name of the resource
        :param builtins.str delivery_capacity: Capacity to be delivered in GB.
        :param builtins.str description: The description of the dedicated block storage cluster.
        :param builtins.str expired_time: The expiration time of the dedicated block storage cluster, in the Unix timestamp format, in seconds.
        :param builtins.str performance_level: Cloud disk performance level, possible values:-PL0.-PL1.-PL2.-PL3.> Only valid in SupportedCategory = cloud_essd.
        :param builtins.str resource_group_id: The ID of the resource group
        :param builtins.str status: The status of the resource
        :param builtins.str supported_category: This parameter is not supported.
        :param builtins.str total_capacity: The total capacity of the dedicated block storage cluster. Unit: GiB.
        :param builtins.str type: The dedicated block storage cluster performance type. Possible values:-Standard: Basic type. This type of dedicated block storage cluster can create an ESSD PL0 cloud disk.-Premium: performance type. This type of dedicated block storage cluster can create an ESSD PL1 cloud disk.
        :param builtins.str used_capacity: The used (created disk) capacity of the current cluster, in GB
    ...
    def dedicated_block_storage_cluster_id(self) -> builtins.str:
        """
    ...
    def dedicated_block_storage_cluster_name(self) -> builtins.str:
        """
    ...
    def delivery_capacity(self) -> builtins.str:
        """
    ...
    def supported_category(self) -> builtins.str:
        """
    ...
    def total_capacity(self) -> builtins.str:
        """
    ...
    def used_capacity(self) -> builtins.str:
        """
...
class GetDiskReplicaGroupsGroupResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 last_recover_point: builtins.str,
                 primary_region: builtins.str,
                 primary_zone: builtins.str,
                 replica_group_id: builtins.str,
                 rpo: builtins.int,
                 site: builtins.str,
                 source_region_id: builtins.str,
                 source_zone_id: builtins.str,
                 standby_region: builtins.str,
                 standby_zone: builtins.str,
                 status: builtins.str):
        """
        :param builtins.str description: The description of the consistent replication group.
        :param builtins.str destination_region_id: The ID of the region to which the disaster recovery site belongs.
        :param builtins.str destination_zone_id: The ID of the zone to which the disaster recovery site belongs.
        :param builtins.str group_name: Consistent replication group name.
        :param builtins.str id: The ID of the Disk Replica Group.
        :param builtins.str primary_region: The initial source region of the replication group.
        :param builtins.str primary_zone: The initial source available area of the replication group.
        :param builtins.str replica_group_id: The ID of the consistent replication group.
        :param builtins.int rpo: The recovery point objective (RPO) of the replication pair-consistent group.
        :param builtins.str site: Site information sources for replication pairs and consistent replication groups.
        :param builtins.str source_region_id: The ID of the region to which the production site belongs.
        :param builtins.str source_zone_id: The ID of the zone to which the production site belongs.
        :param builtins.str standby_region: The initial destination region of the replication group.
        :param builtins.str standby_zone: The initial destination zone of the replication group.
        :param builtins.str status: The status of the consistent replication group. Possible values:
        """
        pulumi.set(__self__, "description", description)
    ...
    def destination_zone_id(self) -> builtins.str:
        """
    ...
    def last_recover_point(self) -> builtins.str:
    ...
    def replica_group_id(self) -> builtins.str:
        """
    ...
    def source_region_id(self) -> builtins.str:
        """
    ...
    def source_zone_id(self) -> builtins.str:
        """
    ...
    def standby_region(self) -> builtins.str:
        """
    ...
    def standby_zone(self) -> builtins.str:
        """
...
class GetDiskReplicaPairsPairResult(dict):
    def __init__(__self__, *,
                 ...
                 description: builtins.str,
                 destination_disk_id: builtins.str,
                 destination_region_id: builtins.str,
                 destination_zone_id: builtins.str,
                 ...
                 replica_pair_id: builtins.str,
                 resource_group_id: builtins.str,
                 rpo: builtins.str,
                 source_zone_id: builtins.str,
                 status: builtins.str):
        """
        :param builtins.str bandwidth: The bandwidth for asynchronous data replication between cloud disks. The unit is Kbps. Value range:-10240 Kbps: equal to 10 Mbps.-20480 Kbps: equal to 20 Mbps.-51200 Kbps: equal to 50 Mbps.-102400 Kbps: equal to 100 Mbps.Default value: 10240.This parameter cannot be specified when the ChargeType value is POSTPAY. The system value is 0, which indicates that the disk is dynamically allocated according to data write changes during asynchronous replication.
        :param builtins.str description: The description of the asynchronous replication relationship. 2 to 256 English or Chinese characters in length and cannot start with' http:// 'or' https.
        :param builtins.str destination_disk_id: The ID of the standby disk.
        :param builtins.str destination_region_id: The ID of the region to which the disaster recovery site belongs.
        :param builtins.str destination_zone_id: The ID of the zone to which the disaster recovery site belongs.
        :param builtins.str disk_id: The ID of the primary disk.
        :param builtins.str pair_name: The name of the asynchronous replication relationship. The length must be 2 to 128 characters in length and must start with a letter or Chinese name. It cannot start with http:// or https. It can contain Chinese, English, numbers, half-width colons (:), underscores (_), half-width periods (.), or dashes (-).
        :param builtins.str payment_type: The payment type of the resource.
        :param builtins.str replica_pair_id: The first ID of the resource
        :param builtins.str resource_group_id: The ID of the resource group
        :param builtins.str rpo: The RPO value set by the consistency group in seconds. Currently only 900 seconds are supported.
        :param builtins.str source_zone_id: The ID of the zone to which the production site belongs.
        :param builtins.str status: The status of the resource.
        """
    ...
    def destination_disk_id(self) -> builtins.str:
        """
    ...
    def pair_name(self) -> builtins.str:
        """
    ...
    def replica_pair_id(self) -> builtins.str:
        """
        The first ID of the resource
        """
