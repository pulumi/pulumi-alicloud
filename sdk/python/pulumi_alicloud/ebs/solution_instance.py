...
class SolutionInstanceArgs:
    def __init__(__self__, *,
                 solution_id: pulumi.Input[builtins.str],
                 ...
                 solution_instance_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SolutionInstance resource.
        :param pulumi.Input[builtins.str] solution_id: Solution ID.
        :param pulumi.Input[builtins.str] description: Solution Instance Description.
        ...
        :param pulumi.Input[builtins.str] solution_instance_name: Solution Instance Name.
        """
    ...
    def solution_id(self) -> pulumi.Input[builtins.str]:
        """
        Solution ID.
        """
    ...
    @solution_id.setter
    def solution_id(self, value: pulumi.Input[builtins.str]):
    ...
    def solution_instance_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def solution_instance_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SolutionInstanceState:
    def __init__(__self__, *,
                 ...
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input['SolutionInstanceParameterArgs']]]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 solution_id: Optional[pulumi.Input[builtins.str]] = None,
                 solution_instance_name: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering SolutionInstance resources.
        :param pulumi.Input[builtins.str] create_time: Solution Instance Creation Time.
        :param pulumi.Input[builtins.str] description: Solution Instance Description.
        :param pulumi.Input[Sequence[pulumi.Input['SolutionInstanceParameterArgs']]] parameters: Solution Instance Creation Parameters. See `parameters` below.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group.
        :param pulumi.Input[builtins.str] solution_id: Solution ID.
    ...
    @property
    @pulumi.getter(name="solutionId")
    def solution_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Solution ID.
        """
        return pulumi.get(self, "solution_id")
    ...
    @solution_id.setter
    def solution_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "solution_id", value)
...
class SolutionInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            solution_id: Optional[pulumi.Input[builtins.str]] = None,
            solution_instance_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'SolutionInstance':
        """
    ...
    @property
    @pulumi.getter(name="solutionId")
    def solution_id(self) -> pulumi.Output[builtins.str]:
        """
        Solution ID.
        """
        return pulumi.get(self, "solution_id")
    ...
    @property
    @pulumi.getter(name="solutionInstanceName")
    def solution_instance_name(self) -> pulumi.Output[builtins.str]:
        """
        Solution Instance Name.
        """
        return pulumi.get(self, "solution_instance_name")
