...
def get_regions(output_file: Optional[builtins.str] = None,
    ...
    :param builtins.str region_id: A list of Disk Replica Group IDs.
    """
    __args__ = dict()
...
def get_regions_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
