...
class ReplicaPairDrillArgs:
    def __init__(__self__, *,
                 pair_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ReplicaPairDrill resource.
        :param pulumi.Input[builtins.str] pair_id: Copy the ID of the pair. You can call DescribeDiskReplicaPairs to query the list of asynchronous replication pairs to obtain the replication pair ID.
        """
        pulumi.set(__self__, "pair_id", pair_id)

    @property
    @pulumi.getter(name="pairId")
    def pair_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @pair_id.setter
    def pair_id(self, value: pulumi.Input[builtins.str]):
...
class _ReplicaPairDrillState:
    def __init__(__self__, *,
                 pair_id: Optional[pulumi.Input[builtins.str]] = None,
                 replica_pair_drill_id: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering ReplicaPairDrill resources.
        :param pulumi.Input[builtins.str] pair_id: Copy the ID of the pair. You can call DescribeDiskReplicaPairs to query the list of asynchronous replication pairs to obtain the replication pair ID.
        :param pulumi.Input[builtins.str] replica_pair_drill_id: The first ID of the resource.
    ...
    @property
    @pulumi.getter(name="pairId")
    def pair_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Copy the ID of the pair. You can call DescribeDiskReplicaPairs to query the list of asynchronous replication pairs to obtain the replication pair ID.
        """
        return pulumi.get(self, "pair_id")
    ...
    @pair_id.setter
    def pair_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pair_id", value)

    @property
    @pulumi.getter(name="replicaPairDrillId")
    def replica_pair_drill_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def replica_pair_drill_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ReplicaPairDrill(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pair_id: Optional[pulumi.Input[builtins.str]] = None,
            replica_pair_drill_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ReplicaPairDrill':
        """
    ...
    @property
    @pulumi.getter(name="pairId")
    def pair_id(self) -> pulumi.Output[builtins.str]:
        """
        Copy the ID of the pair. You can call DescribeDiskReplicaPairs to query the list of asynchronous replication pairs to obtain the replication pair ID.
        """
        return pulumi.get(self, "pair_id")
    ...
    @property
    @pulumi.getter(name="replicaPairDrillId")
    def replica_pair_drill_id(self) -> pulumi.Output[builtins.str]:
        """
        The first ID of the resource.
        """
        return pulumi.get(self, "replica_pair_drill_id")
