...
class GetDiskReplicaPairsResult:
    ...
    def replica_group_id(self) -> Optional[_builtins.str]:
...
def get_disk_replica_pairs(ids: Optional[Sequence[_builtins.str]] = None,
                           output_file: Optional[_builtins.str] = None,
                           replica_group_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Disk Replica Pair IDs.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str replica_group_id: Consistent Replication Group ID, you can specify a consistent replication group ID to query the replication pairs within the group.
    :param _builtins.str site: Get data for replication pairs where this Region is the production site or the disaster recovery site.
    """
    __args__ = dict()
    __args__['ids'] = ids
