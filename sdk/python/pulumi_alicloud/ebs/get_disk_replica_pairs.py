...
class GetDiskReplicaPairsResult:
    ...
    def replica_group_id(self) -> Optional[builtins.str]:
...
def get_disk_replica_pairs(ids: Optional[Sequence[builtins.str]] = None,
                           output_file: Optional[builtins.str] = None,
                           replica_group_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Disk Replica Pair IDs.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str replica_group_id: Consistent Replication Group ID, you can specify a consistent replication group ID to query the replication pairs within the group.
    :param builtins.str site: Get data for replication pairs where this Region is the production site or the disaster recovery site.
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_disk_replica_pairs_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                  output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  replica_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  site: Optional[pulumi.Input[Optional[builtins.str]]] = None,
