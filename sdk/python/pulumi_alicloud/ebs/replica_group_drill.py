...
__all__ = ['ReplicaGroupDrillArgs', 'ReplicaGroupDrill']
...
class ReplicaGroupDrillArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_id: The ID of the replication group. You can use the describediskreplicaggroups interface to query the asynchronous replication group list to obtain the value of the replication group ID input parameter.
        """
...
class _ReplicaGroupDrillState:
    def __init__(__self__, *,
                 ...
                 replica_group_drill_id: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering ReplicaGroupDrill resources.
        :param pulumi.Input[builtins.str] group_id: The ID of the replication group. You can use the describediskreplicaggroups interface to query the asynchronous replication group list to obtain the value of the replication group ID input parameter.
        :param pulumi.Input[builtins.str] replica_group_drill_id: The first ID of the resource.
        :param pulumi.Input[builtins.str] status: Walkthrough status. _failed: Execution failed._failed: Cleanup failed.
        """
        if group_id is not None:
            pulumi.set(__self__, "group_id", group_id)
        if replica_group_drill_id is not None:
            pulumi.set(__self__, "replica_group_drill_id", replica_group_drill_id)
    ...
    def replica_group_drill_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def replica_group_drill_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ReplicaGroupDrill(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ReplicaGroupDrillArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ReplicaGroupDrillArgs.__new__(ReplicaGroupDrillArgs)

            if group_id is None and not opts.urn:
                raise TypeError("Missing required property 'group_id'")
            __props__.__dict__["group_id"] = group_id
            __props__.__dict__["replica_group_drill_id"] = None
            __props__.__dict__["status"] = None
        super(ReplicaGroupDrill, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            group_id: Optional[pulumi.Input[builtins.str]] = None,
            replica_group_drill_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ReplicaGroupDrill':
        """
        ...
        __props__ = _ReplicaGroupDrillState.__new__(_ReplicaGroupDrillState)

        __props__.__dict__["group_id"] = group_id
        __props__.__dict__["replica_group_drill_id"] = replica_group_drill_id
        __props__.__dict__["status"] = status
        return ReplicaGroupDrill(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="replicaGroupDrillId")
    def replica_group_drill_id(self) -> pulumi.Output[builtins.str]:
        """
        The first ID of the resource.
        """
        return pulumi.get(self, "replica_group_drill_id")
