...
class EnterpriseSnapshotPolicyAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_id: the enterprise snapshot policy id.
...
class EnterpriseSnapshotPolicyAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            disk_id: Optional[pulumi.Input[builtins.str]] = None,
            policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EnterpriseSnapshotPolicyAttachment':
        """
