...
class EnterpriseSnapshotPolicyCrossRegionCopyInfoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Enable Snapshot replication.
...
if not MYPY:
    class EnterpriseSnapshotPolicyCrossRegionCopyInfoRegionArgsDict(TypedDict):
        ...
        """
        retain_days: NotRequired[pulumi.Input[builtins.int]]
        """
...
class EnterpriseSnapshotPolicyCrossRegionCopyInfoRegionArgs:
    def __init__(__self__, *,
                 ...
                 retain_days: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] region_id: Destination region ID.
        :param pulumi.Input[builtins.int] retain_days: Number of days of snapshot retention for replication.
        """
    ...
    def retain_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of days of snapshot retention for replication.
        """
    ...
    @retain_days.setter
    def retain_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class EnterpriseSnapshotPolicyRetainRuleArgsDict(TypedDict):
        ...
        """
        time_interval: NotRequired[pulumi.Input[builtins.int]]
        """
        Time unit.
        """
        time_unit: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EnterpriseSnapshotPolicyRetainRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] number: Retention based on counting method.
        :param pulumi.Input[builtins.int] time_interval: Time unit.
        :param pulumi.Input[builtins.str] time_unit: Time-based retention.
        """
...
class EnterpriseSnapshotPolicyScheduleArgs:
    def __init__(__self__, *,
                 cron_expression: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] cron_expression: CronTab expression.
        """
...
class EnterpriseSnapshotPolicySpecialRetainRulesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Whether special reservations are enabled. Value range:
               - true
               - false.
...
if not MYPY:
    class EnterpriseSnapshotPolicySpecialRetainRulesRuleArgsDict(TypedDict):
        special_period_unit: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EnterpriseSnapshotPolicySpecialRetainRulesRuleArgs:
    def __init__(__self__, *,
                 special_period_unit: Optional[pulumi.Input[builtins.str]] = None,
                 time_interval: Optional[pulumi.Input[builtins.int]] = None,
                 time_unit: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] special_period_unit: The cycle unit of the special reserved snapshot. If the value is set to WEEKS, the first snapshot of each week is reserved. The retention time is determined by TimeUnit and TimeInterval. The value range is:
               - WEEKS
               - MONTHS
               - YEARS.
        """
    ...
    def special_period_unit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The cycle unit of the special reserved snapshot. If the value is set to WEEKS, the first snapshot of each week is reserved. The retention time is determined by TimeUnit and TimeInterval. The value range is:
        - WEEKS
        - MONTHS
    ...
    def special_period_unit(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class EnterpriseSnapshotPolicyStorageRuleArgsDict(TypedDict):
        enable_immediate_access: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class EnterpriseSnapshotPolicyStorageRuleArgs:
    def __init__(__self__, *,
                 enable_immediate_access: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_immediate_access: Snapshot speed available.
        """
    ...
    def enable_immediate_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Snapshot speed available.
        """
    ...
    def enable_immediate_access(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SolutionInstanceParameterArgs:
    def __init__(__self__, *,
                 ...
                 parameter_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] parameter_key: Create parameter Key.
        :param pulumi.Input[builtins.str] parameter_value: Create parameter Value.
        """
