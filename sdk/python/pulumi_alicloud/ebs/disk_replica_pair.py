...
class DiskReplicaPairArgs:
    def __init__(__self__, *,
                 destination_disk_id: pulumi.Input[builtins.str],
                 destination_region_id: pulumi.Input[builtins.str],
                 destination_zone_id: pulumi.Input[builtins.str],
                 disk_id: pulumi.Input[builtins.str],
                 source_zone_id: pulumi.Input[builtins.str],
                 bandwidth: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 disk_replica_pair_name: Optional[pulumi.Input[builtins.str]] = None,
                 one_shot: Optional[pulumi.Input[builtins.bool]] = None,
                 pair_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 reverse_replicate: Optional[pulumi.Input[builtins.bool]] = None,
                 rpo: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a DiskReplicaPair resource.
        :param pulumi.Input[builtins.str] destination_disk_id: The ID of the standby disk.
        :param pulumi.Input[builtins.str] destination_region_id: The ID of the region to which the disaster recovery site belongs.
        :param pulumi.Input[builtins.str] destination_zone_id: The ID of the zone to which the disaster recovery site belongs.
        :param pulumi.Input[builtins.str] disk_id: The ID of the primary disk.
        :param pulumi.Input[builtins.str] source_zone_id: The ID of the zone to which the production site belongs.
        :param pulumi.Input[builtins.int] bandwidth: The bandwidth for asynchronous data replication between cloud disks. The unit is Kbps. Value range:
        ...
        :param pulumi.Input[builtins.str] description: The description of the asynchronous replication relationship. 2 to 256 English or Chinese characters in length and cannot start with' http:// 'or' https.
        :param pulumi.Input[builtins.str] disk_replica_pair_name: The name of the asynchronous replication relationship. The length must be 2 to 128 characters in length and must start with a letter or Chinese name. It cannot start with http:// or https. It can contain Chinese, English, numbers, half-width colons (:), underscores (_), half-width periods (.), or dashes (-).
        :param pulumi.Input[builtins.bool] one_shot: Whether to synchronize immediately. Value range:
               - true: Start data synchronization immediately.
               - false: Data Synchronization starts after the RPO time period.
               
               Default value: false.
        :param pulumi.Input[builtins.str] pair_name: . Field 'pair_name' has been deprecated from provider version 1.245.0. New field 'disk_replica_pair_name' instead.
        :param pulumi.Input[builtins.str] payment_type: The payment type of the resource
        :param pulumi.Input[builtins.int] period: The purchase duration of the asynchronous replication relationship. This parameter is required when 'ChargeType = PrePay. The duration unit is specified by'periodunit', and the value range is:
        ...
        :param pulumi.Input[builtins.str] period_unit: The unit of the purchase time of the asynchronous replication relationship. Value range:
               - Week: Week.
               - Month: Month.
               
               Default value: Month.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group
        :param pulumi.Input[builtins.bool] reverse_replicate: Specifies whether to enable the reverse replication sub-feature. Valid values: true and false. Default value: true.
        :param pulumi.Input[builtins.int] rpo: The RPO value set by the consistency group in seconds. Currently only 900 seconds are supported.
    ...
    def destination_disk_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destination_disk_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "destination_disk_id", value)

    @property
    @pulumi.getter(name="destinationRegionId")
    def destination_region_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destination_region_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "destination_region_id", value)

    @property
    @pulumi.getter(name="destinationZoneId")
    def destination_zone_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destination_zone_id(self, value: pulumi.Input[builtins.str]):
    ...
    def source_zone_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_zone_id(self, value: pulumi.Input[builtins.str]):
    ...
    def disk_replica_pair_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def disk_replica_pair_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "disk_replica_pair_name", value)

    @property
    @pulumi.getter(name="oneShot")
    def one_shot(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @one_shot.setter
    def one_shot(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def pair_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @pair_name.setter
    def pair_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def reverse_replicate(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reverse_replicate(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "reverse_replicate", value)

    @property
    @pulumi.getter
    def rpo(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @rpo.setter
    def rpo(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _DiskReplicaPairState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 destination_disk_id: Optional[pulumi.Input[builtins.str]] = None,
                 destination_region_id: Optional[pulumi.Input[builtins.str]] = None,
                 destination_zone_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 reverse_replicate: Optional[pulumi.Input[builtins.bool]] = None,
                 rpo: Optional[pulumi.Input[builtins.int]] = None,
                 source_zone_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="destinationDiskId")
    def destination_disk_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the standby disk.
        """
        return pulumi.get(self, "destination_disk_id")
    ...
    @destination_disk_id.setter
    def destination_disk_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_disk_id", value)
    ...
    @property
    @pulumi.getter(name="destinationZoneId")
    def destination_zone_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the zone to which the disaster recovery site belongs.
        """
        return pulumi.get(self, "destination_zone_id")
    ...
    @destination_zone_id.setter
    def destination_zone_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_zone_id", value)
    ...
    @property
    @pulumi.getter(name="sourceZoneId")
    def source_zone_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the zone to which the production site belongs.
        """
        return pulumi.get(self, "source_zone_id")
    ...
    @source_zone_id.setter
    def source_zone_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_zone_id", value)
...
class DiskReplicaPair(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_zone_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'DiskReplicaPair':
        """
    ...
    @property
    @pulumi.getter(name="destinationDiskId")
    def destination_disk_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the standby disk.
        """
        return pulumi.get(self, "destination_disk_id")
    ...
    @property
    @pulumi.getter(name="destinationRegionId")
    def destination_region_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the region to which the disaster recovery site belongs.
        """
        return pulumi.get(self, "destination_region_id")
    ...
    @property
    @pulumi.getter(name="destinationZoneId")
    def destination_zone_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the zone to which the disaster recovery site belongs.
        """
        return pulumi.get(self, "destination_zone_id")
    ...
    @property
    @pulumi.getter(name="diskReplicaPairName")
    def disk_replica_pair_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the asynchronous replication relationship. The length must be 2 to 128 characters in length and must start with a letter or Chinese name. It cannot start with http:// or https. It can contain Chinese, English, numbers, half-width colons (:), underscores (_), half-width periods (.), or dashes (-).
        """
        return pulumi.get(self, "disk_replica_pair_name")
    ...
    @property
    @pulumi.getter(name="oneShot")
    def one_shot(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to synchronize immediately. Value range:
        - true: Start data synchronization immediately.
        - false: Data Synchronization starts after the RPO time period.
    ...
    @pulumi.getter(name="pairName")
    @_utilities.deprecated("""Field 'pair_name' has been deprecated since provider version 1.245.0. New field 'disk_replica_pair_name' instead.""")
    def pair_name(self) -> pulumi.Output[builtins.str]:
        """
        . Field 'pair_name' has been deprecated from provider version 1.245.0. New field 'disk_replica_pair_name' instead.
        """
        return pulumi.get(self, "pair_name")
    ...
    @property
    @pulumi.getter(name="reverseReplicate")
    def reverse_replicate(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable the reverse replication sub-feature. Valid values: true and false. Default value: true.
        """
        return pulumi.get(self, "reverse_replicate")
    ...
    @property
    @pulumi.getter
    def rpo(self) -> pulumi.Output[builtins.int]:
        """
        The RPO value set by the consistency group in seconds. Currently only 900 seconds are supported.
        """
        return pulumi.get(self, "rpo")
    ...
    @property
    @pulumi.getter(name="sourceZoneId")
    def source_zone_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the zone to which the production site belongs.
        """
        return pulumi.get(self, "source_zone_id")
