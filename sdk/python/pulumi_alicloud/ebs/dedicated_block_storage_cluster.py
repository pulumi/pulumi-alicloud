...
class DedicatedBlockStorageClusterArgs:
    def __init__(__self__, *,
                 dedicated_block_storage_cluster_name: pulumi.Input[builtins.str],
                 total_capacity: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 zone_id: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DedicatedBlockStorageCluster resource.
        :param pulumi.Input[builtins.str] dedicated_block_storage_cluster_name: The name of the resource
        :param pulumi.Input[builtins.str] total_capacity: The total capacity of the dedicated block storage cluster. Unit: GiB.
        :param pulumi.Input[builtins.str] type: The dedicated block storage cluster performance type. Possible values:-Standard: Basic type. This type of dedicated block storage cluster can create an ESSD PL0 cloud disk.-Premium: performance type. This type of dedicated block storage cluster can create an ESSD PL1 cloud disk.
        :param pulumi.Input[builtins.str] zone_id: The zone ID  of the resource
        :param pulumi.Input[builtins.str] description: The description of the dedicated block storage cluster.
        """
    ...
    def dedicated_block_storage_cluster_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dedicated_block_storage_cluster_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "dedicated_block_storage_cluster_name", value)

    @property
    @pulumi.getter(name="totalCapacity")
    def total_capacity(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def total_capacity(self, value: pulumi.Input[builtins.str]):
...
class _DedicatedBlockStorageClusterState:
    def __init__(__self__, *,
                 available_capacity: Optional[pulumi.Input[builtins.str]] = None,
                 category: Optional[pulumi.Input[builtins.str]] = None,
                 create_time: Optional[pulumi.Input[builtins.str]] = None,
                 dedicated_block_storage_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                 dedicated_block_storage_cluster_name: Optional[pulumi.Input[builtins.str]] = None,
                 delivery_capacity: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 supported_category: Optional[pulumi.Input[builtins.str]] = None,
                 total_capacity: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 used_capacity: Optional[pulumi.Input[builtins.str]] = None,
                 zone_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering DedicatedBlockStorageCluster resources.
        :param pulumi.Input[builtins.str] available_capacity: The available capacity of the dedicated block storage cluster. Unit: GiB.
        :param pulumi.Input[builtins.str] category: The type of cloud disk that can be created by a dedicated block storage cluster.
        :param pulumi.Input[builtins.str] create_time: The creation time of the resource
        :param pulumi.Input[builtins.str] dedicated_block_storage_cluster_id: The first ID of the resource
        :param pulumi.Input[builtins.str] dedicated_block_storage_cluster_name: The name of the resource
        :param pulumi.Input[builtins.str] delivery_capacity: Capacity to be delivered in GB.
        :param pulumi.Input[builtins.str] description: The description of the dedicated block storage cluster.
        :param pulumi.Input[builtins.str] expired_time: The expiration time of the dedicated block storage cluster, in the Unix timestamp format, in seconds.
        :param pulumi.Input[builtins.str] performance_level: Cloud disk performance level, possible values:-PL0.-PL1.-PL2.-PL3.> Only valid in SupportedCategory = cloud_essd.
        ...
        :param pulumi.Input[builtins.str] supported_category: This parameter is not supported.
        :param pulumi.Input[builtins.str] total_capacity: The total capacity of the dedicated block storage cluster. Unit: GiB.
        :param pulumi.Input[builtins.str] type: The dedicated block storage cluster performance type. Possible values:-Standard: Basic type. This type of dedicated block storage cluster can create an ESSD PL0 cloud disk.-Premium: performance type. This type of dedicated block storage cluster can create an ESSD PL1 cloud disk.
        :param pulumi.Input[builtins.str] used_capacity: The used (created disk) capacity of the current cluster, in GB
        :param pulumi.Input[builtins.str] zone_id: The zone ID  of the resource
        """
    ...
    def available_capacity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def available_capacity(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def dedicated_block_storage_cluster_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dedicated_block_storage_cluster_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dedicated_block_storage_cluster_id", value)

    @property
    @pulumi.getter(name="dedicatedBlockStorageClusterName")
    def dedicated_block_storage_cluster_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the resource
        """
        return pulumi.get(self, "dedicated_block_storage_cluster_name")
    ...
    @dedicated_block_storage_cluster_name.setter
    def dedicated_block_storage_cluster_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dedicated_block_storage_cluster_name", value)

    @property
    @pulumi.getter(name="deliveryCapacity")
    def delivery_capacity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def delivery_capacity(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def supported_category(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def supported_category(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "supported_category", value)

    @property
    @pulumi.getter(name="totalCapacity")
    def total_capacity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The total capacity of the dedicated block storage cluster. Unit: GiB.
        """
        return pulumi.get(self, "total_capacity")
    ...
    @total_capacity.setter
    def total_capacity(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "total_capacity", value)
    ...
    def used_capacity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def used_capacity(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DedicatedBlockStorageCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            used_capacity: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DedicatedBlockStorageCluster':
        """
    ...
    @property
    @pulumi.getter(name="availableCapacity")
    def available_capacity(self) -> pulumi.Output[builtins.str]:
        """
        The available capacity of the dedicated block storage cluster. Unit: GiB.
        """
        return pulumi.get(self, "available_capacity")
    ...
    @property
    @pulumi.getter(name="dedicatedBlockStorageClusterId")
    def dedicated_block_storage_cluster_id(self) -> pulumi.Output[builtins.str]:
        """
        The first ID of the resource
        """
        return pulumi.get(self, "dedicated_block_storage_cluster_id")
    ...
    @property
    @pulumi.getter(name="dedicatedBlockStorageClusterName")
    def dedicated_block_storage_cluster_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the resource
        """
        return pulumi.get(self, "dedicated_block_storage_cluster_name")
    ...
    @property
    @pulumi.getter(name="deliveryCapacity")
    def delivery_capacity(self) -> pulumi.Output[builtins.str]:
        """
        Capacity to be delivered in GB.
        """
        return pulumi.get(self, "delivery_capacity")
    ...
    @property
    @pulumi.getter(name="performanceLevel")
    def performance_level(self) -> pulumi.Output[builtins.str]:
        """
        Cloud disk performance level, possible values:-PL0.-PL1.-PL2.-PL3.> Only valid in SupportedCategory = cloud_essd.
        """
        return pulumi.get(self, "performance_level")
    ...
    @property
    @pulumi.getter(name="supportedCategory")
    def supported_category(self) -> pulumi.Output[builtins.str]:
        """
        This parameter is not supported.
        """
        return pulumi.get(self, "supported_category")
    ...
    @property
    @pulumi.getter(name="totalCapacity")
    def total_capacity(self) -> pulumi.Output[builtins.str]:
        """
        The total capacity of the dedicated block storage cluster. Unit: GiB.
        """
        return pulumi.get(self, "total_capacity")
    ...
    @property
    @pulumi.getter(name="usedCapacity")
    def used_capacity(self) -> pulumi.Output[builtins.str]:
        """
        The used (created disk) capacity of the current cluster, in GB
        """
        return pulumi.get(self, "used_capacity")
