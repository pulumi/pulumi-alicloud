...
class AccountAccountTagArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] tag_key: The key of the tags
        :param pulumi.Input[builtins.str] tag_value: The value of the tags
        """
...
class BaselineBaselineItemArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] config: Baseline item configuration. The format is a JSON string.
        :param pulumi.Input[builtins.str] name: The baseline item name.
        :param pulumi.Input[builtins.str] version: The baseline item version.
        """
