...
def get_baselines(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Baseline IDs.
...
def get_baselines_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
