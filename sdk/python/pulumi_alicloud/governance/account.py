...
class AccountArgs:
    def __init__(__self__, *,
                 ...
                 default_domain_name: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 folder_id: Optional[pulumi.Input[builtins.str]] = None,
                 payer_account_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Account resource.
        :param pulumi.Input[builtins.str] baseline_id: The baseline ID.
               
               If it is left blank, the system default baseline is used by default.
        :param pulumi.Input[builtins.int] account_id: The ID of the enrolled account.
        ...
        :param pulumi.Input[builtins.str] account_name_prefix: Account name prefix.
        ...
        :param pulumi.Input[builtins.str] default_domain_name: The domain name is used to qualify the login name of RAM users and RAM roles.
        :param pulumi.Input[builtins.str] display_name: The account display name.
               - This parameter is required if you are creating a new resource account.
               - If the registration application is applied to an existing account, this parameter does not need to be filled in.
        :param pulumi.Input[builtins.str] folder_id: The ID of the parent resource folder.
               ...
               If the registration application is applied to an existing account, this parameter does not need to be filled in.
        :param pulumi.Input[builtins.int] payer_account_id: The ID of the billing account. If you leave this parameter empty, the current account is used as the billing account.
        """
    ...
    def default_domain_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_domain_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def payer_account_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def payer_account_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _AccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] folder_id: The ID of the parent resource folder.
               ...
               If the registration application is applied to an existing account, this parameter does not need to be filled in.
        :param pulumi.Input[builtins.int] payer_account_id: The ID of the billing account. If you leave this parameter empty, the current account is used as the billing account.
        :param pulumi.Input[builtins.str] status: Account registration status. Value:
        """
        if account_id is not None:
            pulumi.set(__self__, "account_id", account_id)
        if account_name_prefix is not None:
...
class Account(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultDomainName")
    def default_domain_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The domain name is used to qualify the login name of RAM users and RAM roles.
        """
        return pulumi.get(self, "default_domain_name")
    ...
    @property
    @pulumi.getter(name="payerAccountId")
    def payer_account_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The ID of the billing account. If you leave this parameter empty, the current account is used as the billing account.
        """
        return pulumi.get(self, "payer_account_id")
