...
class ServerGroupServerAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] port: The port that is used by the backend server. Valid values: `1` to `65535`.
        :param pulumi.Input[builtins.str] server_group_id: The ID of the server group.
        :param pulumi.Input[builtins.str] server_id: The ID of the backend server. You can specify the ID of an Elastic Compute Service (ECS) instance or an elastic network interface (ENI).
        :param pulumi.Input[builtins.str] description: The description of the backend server.
        :param pulumi.Input[builtins.str] type: The type of backend server. Valid values: `ecs`, `eni`, `eci`. **NOTE:** From version 1.246.0, `type` can be set to `eci`.
        :param pulumi.Input[builtins.int] weight: The weight of the backend server. Valid values: `0` to `100`. Default value: `100`. If the value is set to `0`, no requests are forwarded to the backend server.
        """
...
@pulumi.type_token("alicloud:slb/serverGroupServerAttachment:ServerGroupServerAttachment")
class ServerGroupServerAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            server_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            weight: Optional[pulumi.Input[builtins.int]] = None) -> 'ServerGroupServerAttachment':
        """
