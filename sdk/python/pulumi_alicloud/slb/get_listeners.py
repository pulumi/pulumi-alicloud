...
def get_listeners(description_regex: Optional[builtins.str] = None,
    ...
    :param builtins.str description_regex: A regex string to filter results by SLB listener description.
    :param builtins.int frontend_port: Filter listeners by the specified frontend port.
    :param builtins.str load_balancer_id: ID of the SLB with listeners.
...
def get_listeners_output(description_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         frontend_port: Optional[pulumi.Input[Optional[builtins.int]]] = None,
