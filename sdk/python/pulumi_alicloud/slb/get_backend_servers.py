...
def get_backend_servers(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: List of attached ECS instance IDs.
...
def get_backend_servers_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
