...
class GetZonesResult:
    ...
    def available_slb_address_ip_version(self) -> Optional[builtins.str]:
        return pulumi.get(self, "available_slb_address_ip_version")

    @property
    @pulumi.getter(name="availableSlbAddressType")
    def available_slb_address_type(self) -> Optional[builtins.str]:
...
def get_zones(available_slb_address_ip_version: Optional[builtins.str] = None,
              available_slb_address_type: Optional[builtins.str] = None,
    ...
    :param builtins.str available_slb_address_ip_version: Filter the results by a slb instance address version. Can be either `ipv4`, or `ipv6`.
    :param builtins.str available_slb_address_type: Filter the results by a slb instance network type. Valid values:
    ...
    :param builtins.bool enable_details: Default to false and only output `id` in the `zones` block. Set it to true can output more details.
    :param builtins.str master_zone_id: The primary zone.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str slave_zone_id: The secondary zone.
    """
    __args__ = dict()
...
def get_zones_output(available_slb_address_ip_version: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     available_slb_address_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
