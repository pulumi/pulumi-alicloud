...
def get_master_slave_server_groups(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of master slave server group IDs to filter results.
    :param _builtins.str load_balancer_id: ID of the SLB.
    :param _builtins.str name_regex: A regex string to filter results by master slave server group name.
...
def get_master_slave_server_groups_output(ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
