...
class AttachmentArgs:
    def __init__(__self__, *,
                 ...
                 backend_servers: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_ids: A list of instance ids to added backend server in the SLB.
        :param pulumi.Input[builtins.str] load_balancer_id: ID of the load balancer.
        :param pulumi.Input[builtins.str] backend_servers: The backend servers of the load balancer.
        ...
        :param pulumi.Input[builtins.str] server_type: Type of the instances. Valid value ecs, eni. Default to ecs.
        :param pulumi.Input[builtins.int] weight: Weight of the instances. Valid value range: [0-100]. Default to 100.
        """
    ...
    def backend_servers(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def backend_servers(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Attachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            load_balancer_id: Optional[pulumi.Input[builtins.str]] = None,
            server_type: Optional[pulumi.Input[builtins.str]] = None,
            weight: Optional[pulumi.Input[builtins.int]] = None) -> 'Attachment':
        """
    ...
    @property
    @pulumi.getter(name="backendServers")
    def backend_servers(self) -> pulumi.Output[builtins.str]:
        """
        The backend servers of the load balancer.
        """
        return pulumi.get(self, "backend_servers")
