...
class ListenerXForwardedFor(dict):
    ...
    def __init__(__self__, *,
                 retrive_client_ip: Optional[builtins.bool] = None,
                 retrive_slb_id: Optional[builtins.bool] = None,
                 retrive_slb_ip: Optional[builtins.bool] = None,
                 retrive_slb_proto: Optional[builtins.bool] = None):
        """
        :param builtins.bool retrive_client_ip: Whether to retrieve the client ip.
        :param builtins.bool retrive_slb_id: Indicates whether the SLB-ID header is used to retrieve the ID of the CLB instance. Default value: `false`. Valid values: `true`, `false`.
        :param builtins.bool retrive_slb_ip: Indicates whether the SLB-IP header is used to retrieve the virtual IP address (VIP) requested by the client. Default value: `false`. Valid values: `true`, `false`.
        :param builtins.bool retrive_slb_proto: Specifies whether to use the X-Forwarded-Proto header to retrieve the listener protocol. Default value: `false`. Valid values: `true`, `false`.
        """
    ...
    def retrive_client_ip(self) -> Optional[builtins.bool]:
        """
    ...
    def retrive_slb_id(self) -> Optional[builtins.bool]:
        """
    ...
    def retrive_slb_ip(self) -> Optional[builtins.bool]:
        """
    ...
    def retrive_slb_proto(self) -> Optional[builtins.bool]:
        """
...
class MasterSlaveServerGroupServer(dict):
    ...
    def __init__(__self__, *,
                 port: builtins.int,
                 server_id: builtins.str,
                 is_backup: Optional[builtins.int] = None,
...
class ServerGroupServer(dict):
    ...
    def __init__(__self__, *,
                 port: builtins.int,
                 server_ids: Sequence[builtins.str],
                 type: Optional[builtins.str] = None,
                 weight: Optional[builtins.int] = None):
        """
        :param builtins.int port: The port used by the backend server. Valid values: `1` to `65535`.
        :param Sequence[builtins.str] server_ids: The list of Elastic Compute Service (ECS) Ids or Elastic Network Interface (ENI) Ids.
        :param builtins.str type: Specify the type of the backend server. Default value: `ecs`. Valid values: `ecs`, `eni`.
        :param builtins.int weight: Weight of the backend server. Default value: `100`. Valid values: `0` to `100`.
        """
        pulumi.set(__self__, "port", port)
    ...
    def server_ids(self) -> Sequence[builtins.str]:
        """
...
class GetAclsAclResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: Acl name.
        ...
        :param builtins.str resource_group_id: The Id of resource group which acl belongs.
...
class GetApplicationLoadBalancersBalancerResult(dict):
    def __init__(__self__, *,
                 ...
                 auto_release_time: builtins.int,
                 backend_servers: Sequence['outputs.GetApplicationLoadBalancersBalancerBackendServerResult'],
                 bandwidth: builtins.int,
                 create_time_stamp: builtins.int,
                 delete_protection: builtins.str,
                 end_time: builtins.str,
                 end_time_stamp: builtins.int,
                 id: builtins.str,
                 ...
                 load_balancer_spec: builtins.str,
                 master_zone_id: builtins.str,
                 modification_protection_reason: builtins.str,
                 modification_protection_status: builtins.str,
                 network_type: builtins.str,
                 payment_type: builtins.str,
                 region_id_alias: builtins.str,
                 renewal_cyc_unit: builtins.str,
                 renewal_duration: builtins.int,
                 renewal_status: builtins.str,
                 resource_group_id: builtins.str,
                 slave_zone_id: builtins.str,
                 status: builtins.str,
        ...
        :param builtins.int auto_release_time: The auto release time.
        :param Sequence['GetApplicationLoadBalancersBalancerBackendServerArgs'] backend_servers: The backend servers of the SLB.
        :param builtins.int bandwidth: The bandwidth of the SLB.
        :param builtins.int create_time_stamp: The create time stamp of the SLB.
        :param builtins.str delete_protection: Whether the SLB should delete protection.
        :param builtins.str end_time: The end time of the SLB.
        :param builtins.int end_time_stamp: The end time stamp of the SLB.
        :param builtins.str id: ID of the SLB.
        ...
        :param builtins.str load_balancer_id: Thd ID of the SLB.
        :param builtins.str load_balancer_name: The name of the SLB.
        :param builtins.str load_balancer_spec: The specification of the SLB.
        :param builtins.str master_zone_id: The master zone id of the SLB.
        :param builtins.str modification_protection_reason: The reason of modification protection.
        :param builtins.str modification_protection_status: The status of modification protection.
        ...
        :param builtins.str region_id_alias: Region ID the SLB belongs to.
        :param builtins.str renewal_cyc_unit: The renewal cyc unit of the SLB.
        :param builtins.int renewal_duration: The renewal duration of the SLB.
        :param builtins.str renewal_status: The renewal status of the SLB.
    ...
    def auto_release_time(self) -> builtins.int:
        """
    ...
    def create_time_stamp(self) -> builtins.int:
        """
    ...
    def end_time_stamp(self) -> builtins.int:
        """
    ...
    def region_id_alias(self) -> builtins.str:
        """
    ...
    def renewal_cyc_unit(self) -> builtins.str:
        """
...
class GetApplicationLoadBalancersBalancerBackendServerResult(dict):
    def __init__(__self__, *,
                 ...
                 weight: builtins.int):
        """
        :param builtins.str description: The description of protocol.
        :param builtins.str server_id: The server ID.
        :param builtins.str type: The type of servers.
        :param builtins.int weight: The weight of servers.
        """
...
class GetApplicationLoadBalancersBalancerListenerPortsAndProtocalResult(dict):
    def __init__(__self__, *,
                 ...
                 listener_protocal: builtins.str):
        """
        :param builtins.int listener_port: The listener port.
        :param builtins.str listener_protocal: The listener protoal.
        """
    ...
    def listener_protocal(self) -> builtins.str:
        """
...
class GetApplicationLoadBalancersBalancerListenerPortsAndProtocolResult(dict):
    def __init__(__self__, *,
                 ...
                 listener_forward: builtins.str,
                 listener_port: builtins.int,
                 listener_protocol: builtins.str):
        """
        :param builtins.str description: The description of protocol.
        :param builtins.int forward_port: The forward port.
        :param builtins.str listener_forward: The listener forward.
        :param builtins.int listener_port: The listener port.
        :param builtins.str listener_protocol: The listener protocol.
        """
        pulumi.set(__self__, "description", description)
    ...
    def listener_forward(self) -> builtins.str:
        """
...
class GetApplicationLoadBalancersSlbResult(dict):
    def __init__(__self__, *,
                 ...
                 master_availability_zone: builtins.str,
                 name: builtins.str,
                 network_type: builtins.str,
                 region_id: builtins.str,
                 slave_availability_zone: builtins.str,
                 status: builtins.str,
                 tags: Mapping[str, builtins.str],
                 vpc_id: builtins.str,
                 vswitch_id: builtins.str):
    ...
    def slave_availability_zone(self) -> builtins.str:
...
class GetAttachmentsSlbAttachmentResult(dict):
    def __init__(__self__, *,
                 ...
                 weight: builtins.int):
        """
        :param builtins.str instance_id: ID of the attached ECS instance.
        :param builtins.int weight: Weight associated to the ECS instance.
        """
...
class GetBackendServersBackendServerResult(dict):
    def __init__(__self__, *,
                 ...
                 weight: builtins.int):
        """
        :param builtins.str id: backend server ID.
        :param builtins.str server_type: Type of the backend server.
        :param builtins.int weight: Weight associated to the ECS instance.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "server_type", server_type)
...
class GetCaCertificatesCertificateResult(dict):
    def __init__(__self__, *,
                 ...
                 tags: Mapping[str, builtins.str]):
        """
        :param builtins.str ca_certificate_id: (Available in v1.123.1+) CA certificate ID.
        :param builtins.str ca_certificate_name: (Available in v1.123.1+) CA certificate name.
        :param builtins.str common_name: CA certificate common name.
        :param builtins.int created_timestamp: CA certificate created timestamp.
        :param builtins.str expired_time: CA certificate expired time.
        :param builtins.int expired_timestamp: CA certificate expired timestamp.
        :param builtins.str fingerprint: CA certificate fingerprint.
        :param builtins.str id: CA certificate ID.
        :param builtins.str name: (Deprecated from v1.123.1) Deprecated and replace by `ca_certificate_name`.
        :param builtins.str resource_group_id: The Id of resource group which ca certificates belongs.
        :param Mapping[str, builtins.str] tags: A mapping of tags to assign to the resource.
        """
    ...
    def ca_certificate_name(self) -> builtins.str:
        """
    ...
    def created_timestamp(self) -> builtins.int:
        """
    ...
    def expired_timestamp(self) -> builtins.int:
        """
...
class GetDomainExtensionsExtensionResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str id: The ID of the domain extension.
        :param builtins.str server_certificate_id: The ID of the certificate used by the domain name.
        """
...
class GetListenersSlbListenerResult(dict):
    def __init__(__self__, *,
                 ...
                 description: builtins.str,
                 enable_http2: builtins.str,
                 established_timeout: builtins.int,
                 frontend_port: builtins.int,
                 gzip: builtins.str,
                 ...
                 health_check_http_code: builtins.str,
                 health_check_interval: builtins.int,
                 health_check_timeout: builtins.int,
                 health_check_type: builtins.str,
                 health_check_uri: builtins.str,
                 healthy_threshold: builtins.int,
                 idle_timeout: builtins.int,
                 master_slave_server_group_id: builtins.str,
                 persistence_timeout: builtins.int,
                 protocol: builtins.str,
                 proxy_protocol_v2_enabled: builtins.bool,
                 ...
                 status: builtins.str,
                 sticky_session: builtins.str,
                 sticky_session_type: builtins.str,
                 tls_cipher_policy: builtins.str,
                 unhealthy_threshold: builtins.int,
                 x_forwarded_for: builtins.str,
                 x_forwarded_for_slb_id: builtins.str,
                 x_forwarded_for_slb_ip: builtins.str,
                 x_forwarded_for_slb_proto: builtins.str):
        """
        :param builtins.int backend_port: Port opened on the backend server to receive requests.
        :param builtins.int bandwidth: Peak bandwidth. If the value is set to -1, the listener is not limited by bandwidth.
        :param builtins.str ca_certificate_id: ID of the CA certificate (only required when two-way authentication is used). Only available when the protocol is `https`.
        :param builtins.str cookie: Cookie configured by the backend server. Only available when the sticky_session_type is `server`.
        :param builtins.int cookie_timeout: Cookie timeout in seconds. Only available when the sticky_session_type is `insert`.
        :param builtins.str description: The description of slb listener.
        :param builtins.str enable_http2: Whether to enable https listener support http2 or not. Valid values are `on` and `off`. Default to `on`.
        :param builtins.int established_timeout: Connection timeout in seconds for the Layer 4 TCP listener. Only available when the protocol is `tcp`.
        :param builtins.int frontend_port: Filter listeners by the specified frontend port.
        :param builtins.str gzip: Indicate whether Gzip compression is enabled or not. Possible values are `on` and `off`. Only available when the protocol is `http` or `https`.
        :param builtins.str health_check: Indicate whether health check is enabled of not. Possible values are `on` and `off`.
        :param builtins.int health_check_connect_port: Port used for health check.
        :param builtins.int health_check_connect_timeout: Amount of time in seconds to wait for the response for a health check.
        :param builtins.str health_check_domain: Domain name used for health check. The SLB sends HTTP head requests to the backend server, the domain is useful when the backend server verifies the host field in the requests. Only available when the protocol is `http`, `https` or `tcp` (in this case health_check_type must be `http`).
        :param builtins.str health_check_http_code: HTTP status codes indicating that the health check is normal. It can contain several comma-separated values such as "http_2xx,http_3xx". Only available when the protocol is `http`, `https` or `tcp` (in this case health_check_type must be `http`).
        :param builtins.int health_check_interval: Time interval between two consecutive health checks.
        :param builtins.int health_check_timeout: Amount of time in seconds to wait for the response from a health check. If an ECS instance sends no response within the specified timeout period, the health check fails. Only available when the protocol is `http` or `https`.
        :param builtins.str health_check_type: Health check method. Possible values are `tcp` and `http`. Only available when the protocol is `tcp`.
        :param builtins.str health_check_uri: URI used for health check. Only available when the protocol is `http`, `https` or `tcp` (in this case health_check_type must be `http`).
        :param builtins.int healthy_threshold: Number of consecutive successes of health check performed on the same ECS instance (from failure to success).
        :param builtins.int idle_timeout: Timeout of http or https listener established connection idle timeout. Valid value range: [1-60] in seconds. Default to 15.
        :param builtins.str master_slave_server_group_id: ID of the active/standby server group.
        :param builtins.int persistence_timeout: Timeout value of the TCP connection in seconds. If the value is 0, the session persistence function is disabled. Only available when the protocol is `tcp`.
        :param builtins.str protocol: Filter listeners by the specified protocol. Valid values: `http`, `https`, `tcp` and `udp`.
        :param builtins.bool proxy_protocol_v2_enabled: Whether to support carrying the client source address to the backend server through the Proxy Protocol. Valid values are `true` and `false`. Default to `false`.
        :param builtins.int request_timeout: Timeout of http or https listener request (which does not get response from backend) timeout. Valid value range: [1-180] in seconds. Default to 60.
        :param builtins.str scheduler: Algorithm used to distribute traffic. Possible values: `wrr` (weighted round robin), `wlc` (weighted least connection) and `rr` (round robin).
        :param builtins.str security_status: Security status. Only available when the protocol is `https`.
        :param builtins.str server_group_id: ID of the linked VServer group.
        :param builtins.str ssl_certificate_id: ID of the server certificate. Only available when the protocol is `https`.
        :param builtins.str status: Listener status.
        :param builtins.str sticky_session: Indicate whether session persistence is enabled or not. If enabled, all session requests from the same client are sent to the same backend server. Possible values are `on` and `off`. Only available when the protocol is `http` or `https`.
        :param builtins.str sticky_session_type: Method used to handle the cookie. Possible values are `insert` (cookie added to the response) and `server` (cookie set by the backend server). Only available when the protocol is `http` or `https` and sticky_session is `on`.
        :param builtins.str tls_cipher_policy: Https listener TLS cipher policy. Valid values are `tls_cipher_policy_1_0`, `tls_cipher_policy_1_1`, `tls_cipher_policy_1_2`, `tls_cipher_policy_1_2_strict`. Default to `tls_cipher_policy_1_0`.
        :param builtins.int unhealthy_threshold: Number of consecutive failures of health check performed on the same ECS instance (from success to failure).
        :param builtins.str x_forwarded_for: Indicate whether the HTTP header field "X-Forwarded-For" is added or not; it allows the backend server to know about the user's IP address. Possible values are `on` and `off`. Only available when the protocol is `http` or `https`.
        :param builtins.str x_forwarded_for_slb_id: Indicate whether the HTTP header field "X-Forwarded-For_SLBID" is added or not; it allows the backend server to know about the SLB ID. Possible values are `on` and `off`. Only available when the protocol is `http` or `https`.
        :param builtins.str x_forwarded_for_slb_ip: Indicate whether the HTTP header field "X-Forwarded-For_SLBIP" is added or not; it allows the backend server to know about the SLB IP address. Possible values are `on` and `off`. Only available when the protocol is `http` or `https`.
        :param builtins.str x_forwarded_for_slb_proto: Indicate whether the HTTP header field "X-Forwarded-For_proto" is added or not; it allows the backend server to know about the user's protocol. Possible values are `on` and `off`. Only available when the protocol is `http` or `https`.
        """
    ...
    def master_slave_server_group_id(self) -> builtins.str:
        """
    ...
    def proxy_protocol_v2_enabled(self) -> builtins.bool:
        """
    ...
    def sticky_session(self) -> builtins.str:
        """
    ...
    def x_forwarded_for(self) -> builtins.str:
        """
    ...
    def x_forwarded_for_slb_id(self) -> builtins.str:
        """
    ...
    def x_forwarded_for_slb_ip(self) -> builtins.str:
        """
    ...
    def x_forwarded_for_slb_proto(self) -> builtins.str:
        """
...
class GetLoadBalancersSlbResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str address: Service address of the SLBs.
        :param builtins.str creation_time: SLB creation time.
        :param builtins.str id: ID of the SLB.
        :param builtins.bool internet: SLB addressType: internet if `true`, intranet if `false`. Must be `false` when `network_type` is `vpc`.
        :param builtins.str master_availability_zone: Master availability zone of the SLBs.
        :param builtins.str name: SLB name.
        :param builtins.str network_type: Network type of the SLBs. Valid values: `vpc` and `classic`.
        :param builtins.str region_id: Region ID the SLB belongs to.
        :param builtins.str slave_availability_zone: Slave availability zone of the SLBs.
        :param builtins.str status: SLB current status. Possible values: `inactive`, `active` and `locked`.
        :param Mapping[str, builtins.str] tags: A map of tags assigned to the SLB instances. The `tags` can have a maximum of 5 tag. It must be in the format:
               ```python
               import pulumi
...
class GetMasterSlaveServerGroupsGroupResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: master slave server group ID.
        :param builtins.str name: master slave server group name.
...
class GetMasterSlaveServerGroupsGroupServerResult(dict):
    def __init__(__self__, *,
                 instance_id: builtins.str,
                 is_backup: builtins.int,
                 port: builtins.int,
                 server_type: builtins.str,
                 weight: builtins.int):
        """
        :param builtins.str instance_id: ID of the attached ECS instance.
        :param builtins.int is_backup: (Removed from v1.63.0) Determine if the server is executing.
        :param builtins.int port: The port used by the master slave server group.
        :param builtins.str server_type: The server type of the attached ECS instance.
        :param builtins.int weight: Weight associated to the ECS instance.
        """
        pulumi.set(__self__, "instance_id", instance_id)
        pulumi.set(__self__, "is_backup", is_backup)
    ...
    @property
    @pulumi.getter(name="isBackup")
    def is_backup(self) -> builtins.int:
        """
...
class GetRulesSlbRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 url: builtins.str):
        """
        :param builtins.str domain: Domain name in the HTTP request where the rule applies (e.g. "*.aliyun.com").
        :param builtins.str id: Rule ID.
        :param builtins.str name: Rule name.
        :param builtins.str server_group_id: ID of the linked VServer group.
        :param builtins.str url: Path in the HTTP request where the rule applies (e.g. "/image").
        """
        pulumi.set(__self__, "domain", domain)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class GetServerCertificatesCertificateResult(dict):
    def __init__(__self__, *,
                 alicloud_certificate_id: builtins.str,
                 alicloud_certificate_name: builtins.str,
                 common_name: builtins.str,
                 ...
                 fingerprint: builtins.str,
                 id: builtins.str,
                 is_alicloud_certificate: builtins.bool,
                 name: builtins.str,
                 subject_alternative_names: Sequence[builtins.str],
                 resource_group_id: Optional[builtins.str] = None,
                 tags: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str alicloud_certificate_id: Id of server certificate issued by alibaba cloud.
        :param builtins.str alicloud_certificate_name: Name of server certificate issued by alibaba cloud.
        :param builtins.str common_name: Server certificate common name.
        :param builtins.str created_time: Server certificate created time.
        :param builtins.int created_timestamp: Server certificate created timestamp.
        :param builtins.str expired_time: Server certificate expired time.
        :param builtins.int expired_timestamp: Server certificate expired timestamp.
        :param builtins.str fingerprint: Server certificate fingerprint.
        :param builtins.str id: Server certificate ID.
        :param builtins.bool is_alicloud_certificate: Is server certificate issued by alibaba cloud or not.
        :param builtins.str name: Server certificate name.
        :param Sequence[builtins.str] subject_alternative_names: Server certificate subject alternative name list.
    ...
    def alicloud_certificate_id(self) -> builtins.str:
        """
    ...
    def alicloud_certificate_name(self) -> builtins.str:
        """
    ...
    def is_alicloud_certificate(self) -> builtins.bool:
        """
...
class GetServerGroupsSlbServerGroupResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: VServer group ID.
        :param builtins.str name: VServer group name.
...
class GetTlsCipherPoliciesPolicyResult(dict):
    def __init__(__self__, *,
                 ...
                 status: builtins.str,
                 tls_cipher_policy_id: builtins.str,
                 tls_cipher_policy_name: builtins.str,
                 tls_versions: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] ciphers: The encryption algorithms supported. It depends on the value of `tls_versions`.
        :param builtins.str create_time: The creation time timestamp.
        :param builtins.str id: The ID of the Tls Cipher Policy.
        :param Sequence['GetTlsCipherPoliciesPolicyRelateListenerArgs'] relate_listeners: Array of Relate Listeners.
        :param builtins.str status: TLS policy instance state.
        :param builtins.str tls_cipher_policy_id: The ID of TLS cipher policy.
        ...
        :param Sequence[builtins.str] tls_versions: The version of TLS protocol.
        """
    ...
    def tls_cipher_policy_id(self) -> builtins.str:
        """
    ...
    def tls_cipher_policy_name(self) -> builtins.str:
        """
...
class GetTlsCipherPoliciesPolicyRelateListenerResult(dict):
    def __init__(__self__, *,
                 ...
                 protocol: builtins.str):
        """
        :param builtins.str load_balancer_id: The ID of SLB instance.
        :param builtins.int port: Listening port. Valid value: 1 to 65535.
        :param builtins.str protocol: Snooping protocols. Valid values: `TCP`, `UDP`, `HTTP`, or `HTTPS`.
        """
        pulumi.set(__self__, "load_balancer_id", load_balancer_id)
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "protocol", protocol)
...
class GetZonesZoneResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: ID of the zone. It is same as `master_zone_id`.
        :param builtins.str master_zone_id: The primary zone.
        :param builtins.str slave_zone_id: The secondary zone.
        :param Sequence[builtins.str] slb_slave_zone_ids: (Deprecated from 1.157.0) A list of slb slave zone ids in which the slb master zone. 
...
class GetZonesZoneSupportedResourceResult(dict):
    def __init__(__self__, *,
                 ...
                 address_type: builtins.str):
        """
        :param builtins.str address_ip_version: The type of IP address.
        :param builtins.str address_type: The type of network.
        """
        pulumi.set(__self__, "address_ip_version", address_ip_version)
        pulumi.set(__self__, "address_type", address_type)
