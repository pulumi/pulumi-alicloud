...
class TlsCipherPolicyArgs:
    def __init__(__self__, *,
                 ...
                 tls_cipher_policy_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ciphers: The encryption algorithms supported. It depends on the value of `tls_versions`.
        :param pulumi.Input[builtins.str] tls_cipher_policy_name: TLS policy name. Length is from 2 to 128, or in both the English and Chinese characters must be with an uppercase/lowercase letter or a Chinese character and the beginning, may contain numbers, in dot `.`, underscore `_` or dash `-`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tls_versions: The version of TLS protocol. You can find the corresponding value description in the document center [What is Tls Cipher Policy](https://www.alibabacloud.com/help/doc-detail/196714.htm).
        """
    ...
    def tls_cipher_policy_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def tls_cipher_policy_name(self, value: pulumi.Input[builtins.str]):
...
class _TlsCipherPolicyState:
    def __init__(__self__, *,
                 ...
                 tls_cipher_policy_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ciphers: The encryption algorithms supported. It depends on the value of `tls_versions`.
        :param pulumi.Input[builtins.str] status: TLS policy instance state.
        :param pulumi.Input[builtins.str] tls_cipher_policy_name: TLS policy name. Length is from 2 to 128, or in both the English and Chinese characters must be with an uppercase/lowercase letter or a Chinese character and the beginning, may contain numbers, in dot `.`, underscore `_` or dash `-`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tls_versions: The version of TLS protocol. You can find the corresponding value description in the document center [What is Tls Cipher Policy](https://www.alibabacloud.com/help/doc-detail/196714.htm).
        """
    ...
    @property
    @pulumi.getter(name="tlsCipherPolicyName")
    def tls_cipher_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        TLS policy name. Length is from 2 to 128, or in both the English and Chinese characters must be with an uppercase/lowercase letter or a Chinese character and the beginning, may contain numbers, in dot `.`, underscore `_` or dash `-`.
        """
        return pulumi.get(self, "tls_cipher_policy_name")
    ...
    @tls_cipher_policy_name.setter
    def tls_cipher_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tls_cipher_policy_name", value)
...
class TlsCipherPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tls_cipher_policy_name: Optional[pulumi.Input[builtins.str]] = None,
            tls_versions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'TlsCipherPolicy':
        """
    ...
    @property
    @pulumi.getter(name="tlsCipherPolicyName")
    def tls_cipher_policy_name(self) -> pulumi.Output[builtins.str]:
        """
        TLS policy name. Length is from 2 to 128, or in both the English and Chinese characters must be with an uppercase/lowercase letter or a Chinese character and the beginning, may contain numbers, in dot `.`, underscore `_` or dash `-`.
        """
        return pulumi.get(self, "tls_cipher_policy_name")
