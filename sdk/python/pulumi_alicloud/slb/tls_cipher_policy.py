...
class TlsCipherPolicyArgs:
    def __init__(__self__, *,
                 ...
                 tls_cipher_policy_name: pulumi.Input[_builtins.str],
    ...
    def tls_cipher_policy_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def tls_cipher_policy_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "tls_cipher_policy_name", value)

    @_builtins.property
    @pulumi.getter(name="tlsVersions")
    def tls_versions(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    @tls_versions.setter
    def tls_versions(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class TlsCipherPolicy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="tlsCipherPolicyName")
    def tls_cipher_policy_name(self) -> pulumi.Output[_builtins.str]:
        """
        TLS policy name. Length is from 2 to 128, or in both the English and Chinese characters must be with an uppercase/lowercase letter or a Chinese character and the beginning, may contain numbers, in dot `.`, underscore `_` or dash `-`.
        """
        return pulumi.get(self, "tls_cipher_policy_name")
