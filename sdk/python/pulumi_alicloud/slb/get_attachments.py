...
def get_attachments(instance_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] instance_ids: List of attached ECS instance IDs.
    :param builtins.str load_balancer_id: ID of the SLB with attachments.
...
def get_attachments_output(instance_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
