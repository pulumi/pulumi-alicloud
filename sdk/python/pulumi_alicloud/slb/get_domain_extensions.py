...
def get_domain_extensions(frontend_port: Optional[builtins.int] = None,
    ...
    :param builtins.int frontend_port: The frontend port used by the HTTPS listener of the SLB instance. Valid values: 1–65535.
    :param Sequence[builtins.str] ids: IDs of the SLB domain extensions.
    :param builtins.str load_balancer_id: The ID of the SLB instance.
    """
    __args__ = dict()
...
def get_domain_extensions_output(frontend_port: Optional[pulumi.Input[builtins.int]] = None,
