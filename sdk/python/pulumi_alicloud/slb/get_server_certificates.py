...
def get_server_certificates(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of server certificates IDs to filter results.
    :param builtins.str name_regex: A regex string to filter results by server certificate name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str resource_group_id: The Id of resource group which the slb server certificates belongs.
...
def get_server_certificates_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                   ...
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetServerCertificatesResult]:
    """
    This data source provides the server certificate list.
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:slb/getServerCertificates:getServerCertificates', __args__, opts=opts, typ=GetServerCertificatesResult)
    return __ret__.apply(lambda __response__: GetServerCertificatesResult(
