...
def get_server_certificates(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of server certificates IDs to filter results.
    :param _builtins.str name_regex: A regex string to filter results by server certificate name.
...
def get_server_certificates_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
