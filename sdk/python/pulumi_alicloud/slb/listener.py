...
class ListenerArgs:
    def __init__(__self__, *,
                 ...
                 proxy_protocol_v2_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 request_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 scheduler: Optional[pulumi.Input[builtins.str]] = None,
                 server_certificate_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def listener_forward(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "listener_forward", value)

    @property
    @pulumi.getter(name="masterSlaveServerGroupId")
    def master_slave_server_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "master_slave_server_group_id")

    @master_slave_server_group_id.setter
    def master_slave_server_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def proxy_protocol_v2_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "proxy_protocol_v2_enabled")

    @proxy_protocol_v2_enabled.setter
    def proxy_protocol_v2_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def server_certificate_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "server_certificate_id")

    @server_certificate_id.setter
    def server_certificate_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Listener(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="aclStatus")
    def acl_status(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "acl_status")

    @property
    @pulumi.getter(name="aclType")
    def acl_type(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "acl_type")
    ...
    @property
    @pulumi.getter(name="caCertificateId")
    def ca_certificate_id(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "ca_certificate_id")
    ...
    @property
    @pulumi.getter(name="enableHttp2")
    def enable_http2(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "enable_http2")

    @property
    @pulumi.getter(name="establishedTimeout")
    def established_timeout(self) -> pulumi.Output[Optional[builtins.int]]:
        return pulumi.get(self, "established_timeout")

    @property
    @pulumi.getter(name="forwardPort")
    def forward_port(self) -> pulumi.Output[Optional[builtins.int]]:
        return pulumi.get(self, "forward_port")
    ...
    @property
    @pulumi.getter
    def gzip(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "gzip")
    ...
    @property
    @pulumi.getter(name="listenerForward")
    def listener_forward(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "listener_forward")
    ...
    @property
    @pulumi.getter(name="masterSlaveServerGroupId")
    def master_slave_server_group_id(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "master_slave_server_group_id")

    @property
    @pulumi.getter(name="persistenceTimeout")
    def persistence_timeout(self) -> pulumi.Output[Optional[builtins.int]]:
        return pulumi.get(self, "persistence_timeout")
    ...
    @property
    @pulumi.getter(name="proxyProtocolV2Enabled")
    def proxy_protocol_v2_enabled(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "proxy_protocol_v2_enabled")
    ...
    @property
    @pulumi.getter(name="serverCertificateId")
    def server_certificate_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "server_certificate_id")

    @property
    @pulumi.getter(name="serverGroupId")
    def server_group_id(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "server_group_id")

    @property
    @pulumi.getter(name="sslCertificateId")
    @_utilities.deprecated("""Field 'ssl_certificate_id' has been deprecated from 1.59.0 and using 'server_certificate_id' instead.""")
    def ssl_certificate_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "ssl_certificate_id")
