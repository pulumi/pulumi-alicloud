...
class DomainExtensionArgs:
    def __init__(__self__, *,
                 ...
                 server_certificate_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.int] frontend_port: The frontend port used by the HTTPS listener of the SLB instance. Valid values: 1–65535.
        :param pulumi.Input[builtins.str] load_balancer_id: The ID of the SLB instance.
        :param pulumi.Input[builtins.str] server_certificate_id: The ID of the certificate used by the domain name.
    ...
    def server_certificate_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def server_certificate_id(self, value: pulumi.Input[builtins.str]):
...
class DomainExtension(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            frontend_port: Optional[pulumi.Input[builtins.int]] = None,
            load_balancer_id: Optional[pulumi.Input[builtins.str]] = None,
            server_certificate_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DomainExtension':
        """
