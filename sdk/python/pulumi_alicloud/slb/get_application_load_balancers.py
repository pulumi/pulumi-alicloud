...
class GetApplicationLoadBalancersResult:
    ...
    def address_ip_version(self) -> Optional[builtins.str]:
        """
    ...
    def internet_charge_type(self) -> Optional[builtins.str]:
        """
    ...
    def master_zone_id(self) -> Optional[builtins.str]:
        """
    ...
    def server_intranet_address(self) -> Optional[builtins.str]:
        return pulumi.get(self, "server_intranet_address")

    @property
    @pulumi.getter(name="slaveZoneId")
    def slave_zone_id(self) -> Optional[builtins.str]:
        """
...
def get_application_load_balancers(address: Optional[builtins.str] = None,
                                   address_ip_version: Optional[builtins.str] = None,
                                   address_type: Optional[builtins.str] = None,
                                   enable_details: Optional[builtins.bool] = None,
                                   ids: Optional[Sequence[builtins.str]] = None,
                                   internet_charge_type: Optional[builtins.str] = None,
                                   load_balancer_name: Optional[builtins.str] = None,
                                   master_zone_id: Optional[builtins.str] = None,
                                   ...
                                   server_intranet_address: Optional[builtins.str] = None,
                                   slave_zone_id: Optional[builtins.str] = None,
    ...
    :param builtins.str address: Service address of the SLBs.
    :param builtins.str address_ip_version: The address ip version. Valid values `ipv4` and `ipv6`.
    :param builtins.str address_type: The address type of the SLB. Valid values `internet` and `intranet`.
    :param Sequence[builtins.str] ids: A list of SLBs IDs.
    :param builtins.str internet_charge_type: The internet charge type. Valid values `PayByBandwidth` and `PayByTraffic`.
    :param builtins.str load_balancer_name: The name of the SLB.
    :param builtins.str master_zone_id: The master zone id of the SLB.
    :param builtins.str name_regex: A regex string to filter results by SLB name.
    :param builtins.str network_type: Network type of the SLBs. Valid values: `vpc` and `classic`.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str payment_type: The payment type of SLB. Valid values `PayAsYouGo` and `Subscription`.
    :param builtins.str resource_group_id: The Id of resource group which SLB belongs.
    :param builtins.str server_id: The server ID.
    :param builtins.str server_intranet_address: The server intranet address.
    :param builtins.str slave_zone_id: The slave zone id of the SLB.
    :param builtins.str status: SLB current status. Possible values: `inactive`, `active` and `locked`.
    :param Mapping[str, builtins.str] tags: A map of tags assigned to the SLB instances. The `tags` can have a maximum of 5 tag. It must be in the format:
    :param builtins.str vpc_id: ID of the VPC linked to the SLBs.
    :param builtins.str vswitch_id: ID of the vSwitch linked to the SLBs.
    """
    __args__ = dict()
...
def get_application_load_balancers_output(address: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          address_ip_version: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          address_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                          ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                          internet_charge_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          load_balancer_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          master_zone_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          ...
                                          payment_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          ...
                                          server_intranet_address: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          slave_zone_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          ...
                                          vswitch_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
