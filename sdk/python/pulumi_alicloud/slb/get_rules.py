...
def get_rules(frontend_port: Optional[builtins.int] = None,
    ...
    :param builtins.int frontend_port: SLB listener port.
    :param Sequence[builtins.str] ids: A list of rules IDs to filter results.
    :param builtins.str load_balancer_id: ID of the SLB with listener rules.
...
def get_rules_output(frontend_port: Optional[pulumi.Input[builtins.int]] = None,
