...
def get_ca_certificates(ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of ca certificates IDs to filter results.
    :param _builtins.str name_regex: A regex string to filter results by ca certificate name.
...
def get_ca_certificates_output(ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
