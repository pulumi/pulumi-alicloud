...
def get_ca_certificates(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of ca certificates IDs to filter results.
    :param builtins.str name_regex: A regex string to filter results by ca certificate name.
...
def get_ca_certificates_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
