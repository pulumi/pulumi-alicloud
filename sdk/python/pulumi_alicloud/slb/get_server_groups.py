...
def get_server_groups(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of VServer group IDs to filter results.
    :param builtins.str load_balancer_id: ID of the SLB.
    :param builtins.str name_regex: A regex string to filter results by VServer group name.
...
def get_server_groups_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
