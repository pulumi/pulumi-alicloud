...
if not MYPY:
    class ListenerXForwardedForArgsDict(TypedDict):
        retrive_client_ip: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to retrieve the client ip.
        """
        retrive_slb_id: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        retrive_slb_ip: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        retrive_slb_proto: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ListenerXForwardedForArgs:
    def __init__(__self__, *,
                 retrive_client_ip: Optional[pulumi.Input[builtins.bool]] = None,
                 retrive_slb_id: Optional[pulumi.Input[builtins.bool]] = None,
                 retrive_slb_ip: Optional[pulumi.Input[builtins.bool]] = None,
                 retrive_slb_proto: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] retrive_client_ip: Whether to retrieve the client ip.
        :param pulumi.Input[builtins.bool] retrive_slb_id: Indicates whether the SLB-ID header is used to retrieve the ID of the CLB instance. Default value: `false`. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.bool] retrive_slb_ip: Indicates whether the SLB-IP header is used to retrieve the virtual IP address (VIP) requested by the client. Default value: `false`. Valid values: `true`, `false`.
        :param pulumi.Input[builtins.bool] retrive_slb_proto: Specifies whether to use the X-Forwarded-Proto header to retrieve the listener protocol. Default value: `false`. Valid values: `true`, `false`.
        """
    ...
    def retrive_client_ip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to retrieve the client ip.
        """
    ...
    def retrive_client_ip(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "retrive_client_ip", value)

    @property
    @pulumi.getter(name="retriveSlbId")
    def retrive_slb_id(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether the SLB-ID header is used to retrieve the ID of the CLB instance. Default value: `false`. Valid values: `true`, `false`.
        """
    ...
    def retrive_slb_id(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "retrive_slb_id", value)

    @property
    @pulumi.getter(name="retriveSlbIp")
    def retrive_slb_ip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether the SLB-IP header is used to retrieve the virtual IP address (VIP) requested by the client. Default value: `false`. Valid values: `true`, `false`.
        """
    ...
    def retrive_slb_ip(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "retrive_slb_ip", value)

    @property
    @pulumi.getter(name="retriveSlbProto")
    def retrive_slb_proto(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to use the X-Forwarded-Proto header to retrieve the listener protocol. Default value: `false`. Valid values: `true`, `false`.
        """
    ...
    def retrive_slb_proto(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class MasterSlaveServerGroupServerArgs:
    def __init__(__self__, *,
                 port: pulumi.Input[builtins.int],
                 server_id: pulumi.Input[builtins.str],
                 is_backup: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @is_backup.setter
    def is_backup(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ServerGroupServerArgsDict(TypedDict):
        ...
        """
        server_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ServerGroupServerArgs:
    def __init__(__self__, *,
                 ...
                 weight: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] port: The port used by the backend server. Valid values: `1` to `65535`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] server_ids: The list of Elastic Compute Service (ECS) Ids or Elastic Network Interface (ENI) Ids.
        :param pulumi.Input[builtins.str] type: Specify the type of the backend server. Default value: `ecs`. Valid values: `ecs`, `eni`.
        :param pulumi.Input[builtins.int] weight: Weight of the backend server. Default value: `100`. Valid values: `0` to `100`.
        """
        pulumi.set(__self__, "port", port)
    ...
    def server_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The list of Elastic Compute Service (ECS) Ids or Elastic Network Interface (ENI) Ids.
        """
    ...
    @server_ids.setter
    def server_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
