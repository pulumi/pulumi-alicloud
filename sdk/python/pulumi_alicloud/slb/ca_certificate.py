...
class CaCertificateArgs:
    def __init__(__self__, *,
                 ...
                 ca_certificate_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] ca_certificate: the content of the CA certificate.
        :param pulumi.Input[builtins.str] ca_certificate_name: Name of the CA Certificate.
        :param pulumi.Input[builtins.str] name: Field `name` has been deprecated from provider version 1.123.1. New field `ca_certificate_name` instead
        :param pulumi.Input[builtins.str] resource_group_id: The Id of resource group which the slb_ca certificate belongs.
    ...
    def ca_certificate_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ca_certificate_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CaCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'CaCertificate':
        """
    ...
    @property
    @pulumi.getter(name="caCertificateName")
    def ca_certificate_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the CA Certificate.
        """
        return pulumi.get(self, "ca_certificate_name")
