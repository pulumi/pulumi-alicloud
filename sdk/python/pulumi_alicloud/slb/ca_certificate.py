...
class CaCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_group_id: The Id of resource group which the slb_ca certificate belongs.
...
class CaCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            resource_group_id: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'CaCertificate':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="caCertificateName")
    def ca_certificate_name(self) -> pulumi.Output[_builtins.str]:
        """
        Name of the CA Certificate.
        """
        return pulumi.get(self, "ca_certificate_name")
