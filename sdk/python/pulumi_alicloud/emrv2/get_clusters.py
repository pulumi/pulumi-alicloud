...
class GetClustersResult:
    ...
    def cluster_states(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "cluster_states")

    @property
    @pulumi.getter(name="clusterTypes")
    def cluster_types(self) -> Optional[Sequence[builtins.str]]:
    ...
    def next_token(self) -> Optional[builtins.str]:
    ...
    def payment_types(self) -> Optional[Sequence[builtins.str]]:
...
def get_clusters(cluster_name: Optional[builtins.str] = None,
                 cluster_states: Optional[Sequence[builtins.str]] = None,
                 cluster_types: Optional[Sequence[builtins.str]] = None,
                 ...
                 payment_types: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] cluster_states: The cluster states.
    :param Sequence[builtins.str] cluster_types: The cluster types.
    :param Sequence[builtins.str] ids: A list of Cluster IDs.
    :param builtins.int max_results: The max results is used to list clusters for next page.
    :param builtins.str name_regex: A regex string to filter results by Cluster name.
    :param builtins.str next_token: The next token is used to list clusters for next page.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param Sequence[builtins.str] payment_types: The cluster payment types.
...
def get_clusters_output(cluster_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        cluster_states: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                        cluster_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                        ...
                        payment_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
