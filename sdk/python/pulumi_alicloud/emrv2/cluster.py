...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 log_collect_strategy: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] applications: The applications of EMR cluster to be installed, e.g. HADOOP-COMMON, HDFS, YARN, HIVE, SPARK2, SPARK3, ZOOKEEPER etc. You can find all valid applications in emr web console.
        :param pulumi.Input[builtins.str] cluster_name: The name of emr cluster. The name length must be less than 64. Supported characters: chinese character, english character, number, "-", "_".
        :param pulumi.Input[builtins.str] cluster_type: EMR Cluster Type, e.g. DATALAKE, OLAP, DATAFLOW, DATASERVING, CUSTOM etc. You can find all valid EMR cluster type in emr web console.
        ...
        :param pulumi.Input[builtins.str] release_version: EMR Version, e.g. EMR-5.10.0. You can find the all valid EMR Version in emr web console.
        ...
        :param pulumi.Input[builtins.bool] deletion_protection: The deletion protection of EMR cluster.
        :param pulumi.Input[builtins.str] deploy_mode: The deploy mode of EMR cluster. Supported value: NORMAL or HA.
        :param pulumi.Input[builtins.str] log_collect_strategy: The log collect strategy of EMR cluster.
        :param pulumi.Input[builtins.str] payment_type: Payment Type for this cluster. Supported value: PayAsYouGo or Subscription. **NOTE:** From version 1.227.0, `payment_type` can be modified.
        :param pulumi.Input[builtins.str] resource_group_id: The Id of resource group which the emr-cluster belongs.
        :param pulumi.Input[builtins.str] security_mode: The security mode of EMR cluster. Supported value: NORMAL or KERBEROS.
    ...
    def log_collect_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def log_collect_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Cluster(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:emrv2/cluster:Cluster"
    ...
    @property
    @pulumi.getter(name="logCollectStrategy")
    def log_collect_strategy(self) -> pulumi.Output[builtins.str]:
        """
        The log collect strategy of EMR cluster.
        """
        return pulumi.get(self, "log_collect_strategy")
