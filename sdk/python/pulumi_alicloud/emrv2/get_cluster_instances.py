...
class GetClusterInstancesResult:
    ...
    def instance_states(self) -> Optional[Sequence[builtins.str]]:
...
def get_cluster_instances(cluster_id: Optional[builtins.str] = None,
                          ids: Optional[Sequence[builtins.str]] = None,
                          instance_states: Optional[Sequence[builtins.str]] = None,
                          max_results: Optional[builtins.int] = None,
                          next_token: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: The emr cluster ID.
    :param Sequence[builtins.str] ids: A list of Cluster IDs.
    :param Sequence[builtins.str] instance_states: The cluster ecs instance states.
    :param builtins.int max_results: The max results is used to list emr cluster ecs instances for next page.
    :param builtins.str next_token: The next token is used to list emr cluster ecs instances for next page.
    :param Sequence[builtins.str] node_group_ids: The cluster node group ids.
    :param Sequence[builtins.str] node_group_names: The cluster node group names.
...
def get_cluster_instances_output(cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 instance_states: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 max_results: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                 next_token: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 node_group_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 node_group_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
