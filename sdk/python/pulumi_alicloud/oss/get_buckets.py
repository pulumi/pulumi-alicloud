...
def get_buckets(name_regex: Optional[builtins.str] = None,
    ...
    :param builtins.str name_regex: A regex string to filter results by bucket name.
...
def get_buckets_output(name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
