...
class BucketArgs:
    def __init__(__self__, *,
                 ...
                 lifecycle_rule_allow_same_action_overlap: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 logging_isenable: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] acl: The [canned ACL](https://www.alibabacloud.com/help/doc-detail/31898.htm) to apply. Can be "private", "public-read" and "public-read-write". This property has been deprecated since 1.220.0, please use the resource `oss.BucketAcl` instead.
        ...
        :param pulumi.Input[builtins.bool] force_destroy: A boolean that indicates all objects should be deleted from the bucket so that the bucket can be destroyed without error. These objects are not recoverable. Defaults to "false".
        :param pulumi.Input[builtins.bool] lifecycle_rule_allow_same_action_overlap: A boolean that indicates lifecycle rules allow prefix overlap.
        ...
        :param pulumi.Input[builtins.bool] logging_isenable: The flag of using logging enable container. Defaults true.
        :param pulumi.Input[builtins.str] policy: Json format text of bucket policy [bucket policy management](https://www.alibabacloud.com/help/doc-detail/100680.htm). This property has been deprecated since 1.220.0, please use the resource `oss.BucketPolicy` instead.
        :param pulumi.Input[builtins.str] redundancy_type: The [redundancy type](https://www.alibabacloud.com/help/doc-detail/90589.htm) to enable. Can be "LRS", and "ZRS". Defaults to "LRS".
        ...
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the bucket belongs.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the bucket. The items are no more than 10 for a bucket.
    ...
    def lifecycle_rule_allow_same_action_overlap(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def lifecycle_rule_allow_same_action_overlap(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def logging_isenable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def logging_isenable(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _BucketState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] acl: The [canned ACL](https://www.alibabacloud.com/help/doc-detail/31898.htm) to apply. Can be "private", "public-read" and "public-read-write". This property has been deprecated since 1.220.0, please use the resource `oss.BucketAcl` instead.
        :param pulumi.Input[Sequence[pulumi.Input['BucketCorsRuleArgs']]] cors_rules: A rule of  [Cross-Origin Resource Sharing](https://www.alibabacloud.com/help/doc-detail/31903.htm). The items of core rule are no more than 10 for every OSS bucket. See `cors_rule` below.
        :param pulumi.Input[builtins.str] creation_date: The creation date of the bucket.
        :param pulumi.Input[builtins.str] extranet_endpoint: The extranet access endpoint of the bucket.
        :param pulumi.Input[builtins.bool] force_destroy: A boolean that indicates all objects should be deleted from the bucket so that the bucket can be destroyed without error. These objects are not recoverable. Defaults to "false".
        :param pulumi.Input[builtins.str] intranet_endpoint: The intranet access endpoint of the bucket.
        :param pulumi.Input[builtins.bool] lifecycle_rule_allow_same_action_overlap: A boolean that indicates lifecycle rules allow prefix overlap.
        :param pulumi.Input[Sequence[pulumi.Input['BucketLifecycleRuleArgs']]] lifecycle_rules: A configuration of [object lifecycle management](https://www.alibabacloud.com/help/doc-detail/31904.htm). See `lifecycle_rule` below.
        :param pulumi.Input[builtins.str] location: The location of the bucket.
        :param pulumi.Input['BucketLoggingArgs'] logging: A Settings of [bucket logging](https://www.alibabacloud.com/help/doc-detail/31900.htm). See `logging` below.
        :param pulumi.Input[builtins.bool] logging_isenable: The flag of using logging enable container. Defaults true.
        :param pulumi.Input[builtins.str] owner: The bucket owner.
        :param pulumi.Input[builtins.str] policy: Json format text of bucket policy [bucket policy management](https://www.alibabacloud.com/help/doc-detail/100680.htm). This property has been deprecated since 1.220.0, please use the resource `oss.BucketPolicy` instead.
        :param pulumi.Input[builtins.str] redundancy_type: The [redundancy type](https://www.alibabacloud.com/help/doc-detail/90589.htm) to enable. Can be "LRS", and "ZRS". Defaults to "LRS".
        :param pulumi.Input['BucketRefererConfigArgs'] referer_config: The configuration of [referer](https://www.alibabacloud.com/help/doc-detail/31901.htm). This property has been deprecated since 1.220.0, please use the resource `oss.BucketReferer` instead. See `referer_config` below.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the resource group to which the bucket belongs.
...
class Bucket(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:oss/bucket:Bucket"
    ...
    @property
    @pulumi.getter(name="lifecycleRuleAllowSameActionOverlap")
    def lifecycle_rule_allow_same_action_overlap(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean that indicates lifecycle rules allow prefix overlap.
        """
        return pulumi.get(self, "lifecycle_rule_allow_same_action_overlap")
    ...
    @pulumi.getter(name="loggingIsenable")
    @_utilities.deprecated("""Deprecated from 1.37.0. When `logging` is set, the bucket logging will be able.""")
    def logging_isenable(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The flag of using logging enable container. Defaults true.
        """
        return pulumi.get(self, "logging_isenable")
