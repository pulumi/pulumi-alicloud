...
class AccessPointPublicAccessBlockConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool block_public_access: Block public access enabled for access point
        """
...
class AccessPointVpcConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str vpc_id: The vpc ID is required only when the value of NetworkOrigin is VPC.
        """
...
class BucketAccessMonitor(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str status: The access monitor state of a bucket. If you want to manage objects based on the last access time of the objects, specifies the status to `Enabled`. Valid values: `Enabled` and `Disabled`.
        """
...
class BucketCnameCertificate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 valid_end_date: Optional[builtins.str] = None,
                 valid_start_date: Optional[builtins.str] = None):
        """
        :param builtins.str cert_id: Certificate Identifier
        :param builtins.str certificate: The certificate public key.
        :param builtins.str creation_date: Certificate creation time
        :param builtins.str fingerprint: Certificate Fingerprint
        :param builtins.str private_key: The certificate private key.
        :param builtins.str status: Cname status
        :param builtins.str type: Certificate Type
        :param builtins.str valid_end_date: Certificate validity period end time
        :param builtins.str valid_start_date: Certificate validity period start time
        """
    ...
    def valid_end_date(self) -> Optional[builtins.str]:
        """
    ...
    def valid_start_date(self) -> Optional[builtins.str]:
        """
...
class BucketCorsCorsRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] allowed_methods: The cross-origin request method that is allowed. Valid values: GET, PUT, DELETE, POST, and HEAD.
        :param Sequence[builtins.str] allowed_headers: Specifies whether the headers specified by Access-Control-Request-Headers in the OPTIONS preflight request are allowed. You can use only one asterisk (*) as the wildcard for allowed header. .
        :param Sequence[builtins.str] allowed_origins: The origins from which cross-origin requests are allowed. .
        :param Sequence[builtins.str] expose_headers: The response headers for allowed access requests from applications, such as an XMLHttpRequest object in JavaScript. .
        :param builtins.int max_age_seconds: The period of time within which the browser can cache the response to an OPTIONS preflight request for the specified resource. Unit: seconds.
        """
...
class BucketLifecycleRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str id: Unique identifier for the rule. If omitted, OSS bucket will assign a unique name.
        ...
        :param builtins.str prefix: The prefix in the names of the objects to which the lifecycle rule does not apply.
...
class BucketLifecycleRuleAbortMultipartUpload(dict):
    ...
    def __init__(__self__, *,
                 created_before_date: Optional[builtins.str] = None,
                 days: Optional[builtins.int] = None):
        """
        :param builtins.str created_before_date: Specifies the time before which the rules take effect. The date must conform to the ISO8601 format and always be UTC 00:00. For example: 2002-10-11T00:00:00.000Z indicates that parts created before 2002-10-11T00:00:00.000Z are deleted, and parts created after this time (including this time) are not deleted.
    ...
    def created_before_date(self) -> Optional[builtins.str]:
        """
...
class BucketLifecycleRuleExpiration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str created_before_date: Specifies the time before which the rules take effect. The date must conform to the ISO8601 format and always be UTC 00:00. For example: 2002-10-11T00:00:00.000Z indicates that parts created before 2002-10-11T00:00:00.000Z are deleted, and parts created after this time (including this time) are not deleted.
        :param builtins.str date: Specifies the date after which you want the corresponding action to take effect. The value obeys ISO8601 format like `2017-03-09`.
        :param builtins.int days: Specifies the number of days noncurrent object versions transition.
        :param builtins.bool expired_object_delete_marker: On a versioned bucket (versioning-enabled or versioning-suspended bucket), you can add this element in the lifecycle configuration to direct OSS to delete expired object delete markers. This cannot be specified with Days, Date or CreatedBeforeDate in a Lifecycle Expiration Policy.
...
class BucketLifecycleRuleFilterNotTag(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: The key of the tag that is specified for the objects.
        :param builtins.str value: The value of the tag that is specified for the objects.
        """
...
class BucketLifecycleRuleNoncurrentVersionTransition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_access_time: Optional[builtins.bool] = None,
                 return_to_std_when_visit: Optional[builtins.bool] = None):
        """
        :param builtins.int days: Specifies the number of days noncurrent object versions transition.
        :param builtins.str storage_class: The [storage class](https://www.alibabacloud.com/help/doc-detail/51374.htm) to apply. Can be "Standard", "IA", "Archive", "ColdArchive" and "DeepColdArchive". Defaults to "Standard". "ColdArchive" is available since 1.203.0. "DeepColdArchive" is available since 1.209.0.
        :param builtins.bool is_access_time: Specifies whether the lifecycle rule applies to objects based on their last access time. If set to `true`, the rule applies to objects based on their last access time; if set to `false`, the rule applies to objects based on their last modified time. If configure the rule based on the last access time, please enable `access_monitor` first.
        :param builtins.bool return_to_std_when_visit: Specifies whether to convert the storage class of non-Standard objects back to Standard after the objects are accessed. It takes effect only when the IsAccessTime parameter is set to true. If set to `true`, converts the storage class of the objects to Standard; if set to `false`, does not convert the storage class of the objects to Standard.
        """
        pulumi.set(__self__, "days", days)
    ...
    def is_access_time(self) -> Optional[builtins.bool]:
        """
    ...
    def return_to_std_when_visit(self) -> Optional[builtins.bool]:
        """
...
class BucketRefererConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] referers: The list of referer.
        :param builtins.bool allow_empty: Allows referer to be empty. Defaults false.
        """
...
class BucketReplicationDestination(dict):
    ...
    def __init__(__self__, *,
                 ...
                 transfer_type: Optional[builtins.str] = None):
        """
        :param builtins.str bucket: The destination bucket to which the data is replicated.
        :param builtins.str location: The region in which the destination bucket is located.
        :param builtins.str transfer_type: The link used to transfer data in data replication.. Can be `internal` or `oss_acc`. Defaults to `internal`.
    ...
    def transfer_type(self) -> Optional[builtins.str]:
        """
...
class BucketReplicationEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str replica_kms_key_id: The CMK ID used in SSE-KMS.
...
class BucketReplicationPrefixSet(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] prefixes: The list of object key name prefix identifying one or more objects to which the rule applies.
...
class BucketReplicationProgress(dict):
    ...
    def __init__(__self__, *,
                 historical_object: Optional[builtins.str] = None,
                 new_object: Optional[builtins.str] = None):
        """
        :param builtins.str historical_object: The percentage of the replicated historical data. This element is valid only when historical_object_replication is set to enabled.
        :param builtins.str new_object: The time used to distinguish new data from historical data. Data that is written to the source bucket before the time is replicated to the destination bucket as new data. The value of this element is in GMT.
        """
    ...
    def historical_object(self) -> Optional[builtins.str]:
        """
    ...
    def new_object(self) -> Optional[builtins.str]:
        """
...
class BucketReplicationSourceSelectionCriteriaSseKmsEncryptedObjects(dict):
    def __init__(__self__, *,
                 status: Optional[builtins.str] = None):
        """
        :param builtins.str status: The status of the data replication task. Can be starting, doing and closing.
        """
        if status is not None:
            pulumi.set(__self__, "status", status)
...
class BucketServerSideEncryptionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_data_encryption: Optional[builtins.str] = None,
                 kms_master_key_id: Optional[builtins.str] = None):
        """
        :param builtins.str sse_algorithm: The server-side encryption algorithm to use. Possible values: `AES256` and `KMS`.
        :param builtins.str kms_data_encryption: The algorithm used to encrypt objects. If this element is not specified, objects are encrypted with AES256. This element is valid only when the value of SSEAlgorithm is set to KMS. Valid values: `SM4`.
        :param builtins.str kms_master_key_id: The alibaba cloud KMS master key ID used for the SSE-KMS encryption.
        """
    ...
    def kms_data_encryption(self) -> Optional[builtins.str]:
        """
...
class BucketTransferAcceleration(dict):
    def __init__(__self__, *,
                 enabled: builtins.bool):
        """
        :param builtins.bool enabled: Specifies the accelerate status of a bucket.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class BucketVersioning(dict):
    def __init__(__self__, *,
                 status: builtins.str):
        """
        :param builtins.str status: Specifies the versioning state of a bucket. Valid values: `Enabled` and `Suspended`.
        """
        pulumi.set(__self__, "status", status)
...
class BucketWebsite(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str index_document: Alicloud OSS returns this index document when requests are made to the root domain or any of the subfolders.
...
class BucketWebsiteErrorDocument(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int http_status: The HTTP status code when the error page is returned. The default 404.
        :param builtins.str key: The error page file. If the Object accessed does not exist, this error page is returned.
        """
...
class BucketWebsiteIndexDocument(dict):
    ...
    def __init__(__self__, *,
                 ...
                 support_sub_dir: Optional[builtins.bool] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str suffix: The default home page.
        :param builtins.bool support_sub_dir: Whether to jump to the default home page of a subdirectory when accessing a subdirectory.
        :param builtins.str type: After the default homepage is set, the behavior when an Object that ends with a non-forward slash (/) is accessed and the Object does not exist.
        """
    ...
    def support_sub_dir(self) -> Optional[builtins.bool]:
        """
...
class BucketWebsiteRoutingRulesRoutingRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int rule_number: The sequence number of the matching and executing jump rules. OSS matches rules according to this sequence number. If the match is successful, the rule is executed and subsequent rules are not executed.
        """
...
class BucketWebsiteRoutingRulesRoutingRuleCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_suffix_equals: Optional[builtins.str] = None):
        """
        :param builtins.str http_error_code_returned_equals: When the specified Object is accessed, this status is returned to match this rule. This field must be 404 when the jump rule is mirrored back to the source.
        ...
        :param builtins.str key_prefix_equals: Only objects that match this prefix can match this rule.
        :param builtins.str key_suffix_equals: Only objects that match this suffix can match this rule.
        """
    ...
    def key_suffix_equals(self) -> Optional[builtins.str]:
        """
...
class BucketWebsiteRoutingRulesRoutingRuleConditionIncludeHeader(dict):
    ...
    def __init__(__self__, *,
                 ends_with: Optional[builtins.str] = None,
                 equals: Optional[builtins.str] = None,
                 key: Optional[builtins.str] = None,
                 starts_with: Optional[builtins.str] = None):
        """
        :param builtins.str ends_with: This rule can only be matched if the request contains the Header specified by Key and the value ends with this value.
        :param builtins.str equals: This rule can only be matched if the request contains the Header specified by Key and the value is the specified value.
        :param builtins.str starts_with: This rule can only be matched if the request contains the Header specified by Key and the value starts with this value.
        """
    ...
    def ends_with(self) -> Optional[builtins.str]:
        """
...
class BucketWebsiteRoutingRulesRoutingRuleLuaConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str script: The Lua script name.
        """
...
class BucketWebsiteRoutingRulesRoutingRuleRedirect(dict):
    ...
    def __init__(__self__, *,
                 enable_replace_prefix: Optional[builtins.bool] = None,
                 host_name: Optional[builtins.str] = None,
                 http_redirect_code: Optional[builtins.str] = None,
                 mirror_allow_get_image_info: Optional[builtins.bool] = None,
                 mirror_allow_head_object: Optional[builtins.bool] = None,
                 mirror_allow_video_snapshot: Optional[builtins.bool] = None,
                 mirror_async_status: Optional[builtins.int] = None,
                 mirror_auth: Optional['outputs.BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorAuth'] = None,
                 mirror_check_md5: Optional[builtins.bool] = None,
                 mirror_dst_region: Optional[builtins.str] = None,
                 mirror_dst_slave_vpc_id: Optional[builtins.str] = None,
                 mirror_dst_vpc_id: Optional[builtins.str] = None,
                 mirror_follow_redirect: Optional[builtins.bool] = None,
                 mirror_headers: Optional['outputs.BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeaders'] = None,
                 mirror_is_express_tunnel: Optional[builtins.bool] = None,
                 mirror_multi_alternates: Optional['outputs.BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorMultiAlternates'] = None,
                 mirror_pass_original_slashes: Optional[builtins.bool] = None,
                 mirror_pass_query_string: Optional[builtins.bool] = None,
                 mirror_proxy_pass: Optional[builtins.bool] = None,
                 mirror_return_headers: Optional['outputs.BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorReturnHeaders'] = None,
                 mirror_role: Optional[builtins.str] = None,
                 mirror_save_oss_meta: Optional[builtins.bool] = None,
                 mirror_sni: Optional[builtins.bool] = None,
                 mirror_switch_all_errors: Optional[builtins.bool] = None,
                 mirror_taggings: Optional['outputs.BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorTaggings'] = None,
                 mirror_tunnel_id: Optional[builtins.str] = None,
                 mirror_url: Optional[builtins.str] = None,
                 mirror_url_probe: Optional[builtins.str] = None,
                 mirror_url_slave: Optional[builtins.str] = None,
                 mirror_user_last_modified: Optional[builtins.bool] = None,
                 mirror_using_role: Optional[builtins.bool] = None,
                 pass_query_string: Optional[builtins.bool] = None,
                 ...
                 transparent_mirror_response_codes: Optional[builtins.str] = None):
        """
        :param builtins.bool enable_replace_prefix: If this field is set to true, the prefix of Object is replaced with the value specified by ReplaceKeyPrefixWith. If this field is not specified or is blank, the Object prefix is truncated.
        :param builtins.str host_name: The domain name during the jump. The domain name must comply with the domain name specification.
        :param builtins.str http_redirect_code: The status code returned during the jump. It takes effect only when the RedirectType is set to External or AliCDN.
        :param builtins.bool mirror_allow_get_image_info: Image back-to-source allows getting Image information
        :param builtins.bool mirror_allow_head_object: Whether to allow HeadObject in image back-to-source
        :param builtins.bool mirror_allow_video_snapshot: Mirror back-to-source allows support for video frame truncation
        :param builtins.int mirror_async_status: The status code of the mirror back-to-source trigger asynchronous pull mode.
        ...
        :param builtins.bool mirror_check_md5: Whether to check the MD5 of the source body. It takes effect only when the RedirectType is set to Mirror.
        :param builtins.str mirror_dst_region: Mirrored back-to-source high-speed Channel vpregion
        :param builtins.str mirror_dst_slave_vpc_id: Mirroring back-to-source high-speed Channel standby station VpcId
        :param builtins.str mirror_dst_vpc_id: Mirror back-to-source high-speed Channel VpcId
        :param builtins.bool mirror_follow_redirect: If the result of the image back-to-source acquisition is 3xx, whether to continue to jump to the specified Location to obtain data. It takes effect only when the RedirectType is set to Mirror.
        ...
        :param builtins.bool mirror_is_express_tunnel: Whether it is a mirror back-to-source high-speed Channel
        ...
        :param builtins.bool mirror_pass_original_slashes: Transparent transmission/to source Station
        :param builtins.bool mirror_pass_query_string: Same as PassQueryString and takes precedence over PassQueryString. It takes effect only when the RedirectType is set to Mirror.
        :param builtins.bool mirror_proxy_pass: Whether mirroring back to source does not save data
        ...
        :param builtins.str mirror_role: Roles used when mirroring back-to-source
        :param builtins.bool mirror_save_oss_meta: Mirror back-to-source back-to-source OSS automatically saves user metadata
        :param builtins.bool mirror_sni: Transparent transmission of SNI
        :param builtins.bool mirror_switch_all_errors: It is used to judge the status of active-standby switching. The judgment logic of active-standby switching is that the source station returns an error. If MirrorSwitchAllErrors is true, it is considered a failure except the following status code: 200,206,301,302,303,307,404; If false, only the source Station Returns 5xx or times out is considered a failure.
        ...
        :param builtins.str mirror_tunnel_id: Mirror back-to-source leased line back-to-source tunnel ID
        :param builtins.str mirror_url: The address of the origin of the image. It takes effect only when the RedirectType is set to Mirror. The origin address must start with http:// or https:// and end with a forward slash (/). OSS takes the Object name after the Origin address to form the origin URL.
        :param builtins.str mirror_url_probe: Mirror back-to-source Master-backup back-to-source switching decision URL
        :param builtins.str mirror_url_slave: Mirror back-to-source primary backup back-to-source backup station URL
        :param builtins.bool mirror_user_last_modified: Whether the source station LastModifiedTime is used for the image back-to-source save file.
        :param builtins.bool mirror_using_role: Whether to use role for mirroring back to source
        :param builtins.bool pass_query_string: Whether to carry the request parameters when executing the jump or mirror back-to-source rule. Did the user carry the request parameters when requesting OSS? a = B & c = d, and set PassQueryString to true. If the rule is a 302 jump, this request parameter is added to the Location header of the jump. For example Location:example.com? a = B & c = d, and the jump type is mirrored back-to-origin, this request parameter is also carried in the back-to-origin request initiated. Values: true, false (default)
        :param builtins.str protocol: The protocol at the time of the jump. It takes effect only when the RedirectType is set to External or AliCDN.
        :param builtins.str redirect_type: Specifies the type of jump. The value range is as follows: Mirror: Mirror back to the source. External: External redirects, that is, OSS returns a 3xx request to redirect to another address. AliCDN: Alibaba Cloud CDN jump, mainly used for Alibaba Cloud CDN. Unlike External, OSS adds an additional Header. After recognizing this Header, Alibaba Cloud CDN redirects the data to the specified address and returns the obtained data to the user instead of returning the 3xx Redirection request to the user.
        :param builtins.str replace_key_prefix_with: The prefix of the Object name will be replaced with this value during Redirect. If the prefix is empty, this string is inserted in front of the Object name.
        :param builtins.str replace_key_with: During redirection, the Object name is replaced with the value specified by ReplaceKeyWith. You can set variables in ReplaceKeyWith. Currently, the supported variable is ${key}, which indicates the name of the Object in the request.
        :param builtins.str transparent_mirror_response_codes: Mirror back-to-source transparent source station response code list
        """
    ...
    def enable_replace_prefix(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_allow_get_image_info(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_allow_head_object(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_allow_video_snapshot(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_async_status(self) -> Optional[builtins.int]:
        """
    ...
    def mirror_check_md5(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_dst_region(self) -> Optional[builtins.str]:
        """
    ...
    def mirror_dst_slave_vpc_id(self) -> Optional[builtins.str]:
        """
    ...
    def mirror_dst_vpc_id(self) -> Optional[builtins.str]:
        """
    ...
    def mirror_follow_redirect(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_is_express_tunnel(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_pass_original_slashes(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_pass_query_string(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_proxy_pass(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_role(self) -> Optional[builtins.str]:
        """
    ...
    def mirror_save_oss_meta(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_sni(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_switch_all_errors(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_tunnel_id(self) -> Optional[builtins.str]:
        """
    ...
    def mirror_url(self) -> Optional[builtins.str]:
        """
    ...
    def mirror_url_probe(self) -> Optional[builtins.str]:
        """
    ...
    def mirror_url_slave(self) -> Optional[builtins.str]:
        """
    ...
    def mirror_user_last_modified(self) -> Optional[builtins.bool]:
        """
    ...
    def mirror_using_role(self) -> Optional[builtins.bool]:
        """
    ...
    def pass_query_string(self) -> Optional[builtins.bool]:
        """
    ...
    def transparent_mirror_response_codes(self) -> Optional[builtins.str]:
        """
...
class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorAuth(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str access_key_id: Mirror back-to-source source Station back-to-source AK
        :param builtins.str access_key_secret: Mirroring back to the source station back to the source SK will be automatically desensitized when obtaining the configuration.
        :param builtins.str auth_type: Authentication type of mirror return Source
        :param builtins.str region: Signature Region
        """
...
class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeaders(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool pass_all: Indicates whether other headers except the following headers are transmitted to the source site. It takes effect only when the RedirectType is set to Mirror. content-length, authorization2, authorization, range, date, and other headers Headers whose names start with oss-/x-oss-/x-drs-
        :param Sequence[builtins.str] passes: Pass through the specified Header to the source site. It takes effect only when the RedirectType is set to Mirror. Each Header is up to 1024 bytes in length and has A character set of 0 to 9, a to Z, A to z, and dashes (-).
        :param Sequence[builtins.str] removes: Do not pass the specified Header to the source site. It takes effect only when the RedirectType is set to Mirror. Each Header is up to 1024 bytes in length and has A character set of 0 to 9, a to Z, A to z, and dashes (-).
...
class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeadersSet(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str value: Set the value of the Header to 1024 bytes at most. \\r\\n. It takes effect only when the RedirectType is set to Mirror.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
...
class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorMultiAlternatesMirrorMultiAlternate(dict):
    ...
    def __init__(__self__, *,
                 mirror_multi_alternate_dst_region: Optional[builtins.str] = None,
                 mirror_multi_alternate_number: Optional[builtins.int] = None,
                 mirror_multi_alternate_url: Optional[builtins.str] = None,
                 mirror_multi_alternate_vpc_id: Optional[builtins.str] = None):
        """
        :param builtins.str mirror_multi_alternate_dst_region: Mirroring back-to-source multi-station Region
        :param builtins.int mirror_multi_alternate_number: Image back-to-source multi-source station serial number
        :param builtins.str mirror_multi_alternate_url: Mirroring back-to-source multi-source site URL
        :param builtins.str mirror_multi_alternate_vpc_id: Mirroring back-to-source multi-source VpcId
        """
    ...
    def mirror_multi_alternate_dst_region(self) -> Optional[builtins.str]:
        """
    ...
    def mirror_multi_alternate_number(self) -> Optional[builtins.int]:
        """
    ...
    def mirror_multi_alternate_url(self) -> Optional[builtins.str]:
        """
    ...
    def mirror_multi_alternate_vpc_id(self) -> Optional[builtins.str]:
        """
...
class GetBucketObjectsObjectResult(dict):
    def __init__(__self__, *,
                 ...
                 storage_class: builtins.str):
        """
        :param builtins.str acl: Object access control list. Possible values: `default`, `private`, `public-read` and `public-read-write`.
        :param builtins.str cache_control: Caching behavior along the request/reply chain. Read [RFC2616 Cache-Control](https://www.ietf.org/rfc/rfc2616.txt) for further details.
        :param builtins.str content_disposition: Presentational information for the object. Read [RFC2616 Content-Disposition](https://www.ietf.org/rfc/rfc2616.txt) for further details.
        :param builtins.str content_encoding: Content encodings that have been applied to the object and thus what decoding mechanisms must be applied to obtain the media-type referenced by the Content-Type header field. Read [RFC2616 Content-Encoding](https://www.ietf.org/rfc/rfc2616.txt) for further details.
        :param builtins.str content_length: Size of the object in bytes.
        :param builtins.str content_md5: MD5 value of the content. Read [MD5](https://www.alibabacloud.com/help/doc-detail/31978.htm) for computing method.
        :param builtins.str content_type: Standard MIME type describing the format of the object data, e.g. "application/octet-stream".
        :param builtins.str etag: ETag generated for the object (MD5 sum of the object content).
        :param builtins.str expires: Expiration date for the the request/response. Read [RFC2616 Expires](https://www.ietf.org/rfc/rfc2616.txt) for further details.
        :param builtins.str key: Object key.
        :param builtins.str last_modification_time: Last modification time of the object.
        :param builtins.str server_side_encryption: Server-side encryption of the object in OSS. It can be empty or `AES256`.
        :param builtins.str sse_kms_key_id: If present, specifies the ID of the Key Management Service(KMS) master encryption key that was used for the object.
        :param builtins.str storage_class: Object storage type. Possible values: `Standard`, `IA`, `Archive` and `ColdArchive`.
        """
...
class GetBucketsBucketResult(dict):
    def __init__(__self__, *,
                 ...
                 extranet_endpoint: builtins.str,
                 intranet_endpoint: builtins.str,
        ...
        """
        :param builtins.str acl: Bucket access control list. Possible values: `private`, `public-read` and `public-read-write`.
        ...
        :param builtins.str creation_date: Bucket creation date.
        :param builtins.str extranet_endpoint: Internet domain name for accessing the bucket from outside.
        :param builtins.str intranet_endpoint: Intranet domain name for accessing the bucket from an ECS instance in the same region.
        ...
        :param builtins.str location: Region of the data center where the bucket is located.
        ...
        :param builtins.str name: Bucket name.
        :param builtins.str owner: Bucket owner.
        :param builtins.str policy: The policies configured for a specified bucket.
        :param builtins.str redundancy_type: Redundancy type. Possible values: `LRS`, and `ZRS`.
        ...
        :param builtins.str storage_class: Object storage type. Possible values: `Standard`, `IA`, `Archive` and `ColdArchive`.
        :param Mapping[str, builtins.str] tags: A mapping of tags.
...
class GetBucketsBucketCorsRuleResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] allowed_headers: Control whether the headers specified by Access-Control-Request-Headers in the OPTIONS prefetch command are allowed. Each header specified by Access-Control-Request-Headers must match a value in AllowedHeader. Each rule allows up to one wildcard “*” .
        :param Sequence[builtins.str] allowed_methods: Specify the allowed methods for cross-domain requests. Possible values: `GET`, `PUT`, `DELETE`, `POST` and `HEAD`.
        :param Sequence[builtins.str] allowed_origins: The origins allowed for cross-domain requests. Multiple elements can be used to specify multiple allowed origins. Each rule allows up to one wildcard "\\*". If "\\*" is specified, cross-domain requests of all origins are allowed.
        :param Sequence[builtins.str] expose_headers: Specify the response headers allowing users to access from an application (for example, a Javascript XMLHttpRequest object). The wildcard "\\*" is not allowed.
        :param builtins.int max_age_seconds: Specify the cache time for the returned result of a browser prefetch (OPTIONS) request to a specific resource.
        """
        pulumi.set(__self__, "allowed_headers", allowed_headers)
        pulumi.set(__self__, "allowed_methods", allowed_methods)
        pulumi.set(__self__, "allowed_origins", allowed_origins)
...
class GetBucketsBucketLifecycleRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 prefix: builtins.str):
        """
        :param builtins.bool enabled: Indicate whether the rule is enabled or not.
        ...
        :param builtins.str id: Unique ID of the rule.
        :param builtins.str prefix: Prefix applicable to a rule. Only those objects with a matching prefix can be affected by the rule.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class GetBucketsBucketLifecycleRuleExpirationResult(dict):
    def __init__(__self__, *,
                 ...
                 days: builtins.int):
        """
        :param builtins.str date: Date after which the rule to take effect. The format is like 2017-03-09.
        :param builtins.int days: Indicate the number of days after the last object update until the rules take effect.
        """
        pulumi.set(__self__, "date", date)
        pulumi.set(__self__, "days", days)
...
class GetBucketsBucketLoggingResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str target_bucket: Bucket for storing access logs.
        :param builtins.str target_prefix: Prefix of the saved access log file paths.
        """
        pulumi.set(__self__, "target_bucket", target_bucket)
        pulumi.set(__self__, "target_prefix", target_prefix)
...
class GetBucketsBucketRefererConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 referers: Sequence[builtins.str]):
        """
        :param builtins.bool allow_empty: Indicate whether the access request referer field can be empty.
        :param Sequence[builtins.str] referers: Referer access whitelist.
        """
        pulumi.set(__self__, "allow_empty", allow_empty)
        pulumi.set(__self__, "referers", referers)
...
class GetBucketsBucketServerSideEncryptionRuleResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kms_master_key_id: The alibaba cloud KMS master key ID used for the SSE-KMS encryption.
        :param builtins.str sse_algorithm: The server-side encryption algorithm to use.
        """
        pulumi.set(__self__, "kms_master_key_id", kms_master_key_id)
        pulumi.set(__self__, "sse_algorithm", sse_algorithm)
...
class GetBucketsBucketVersioningResult(dict):
    def __init__(__self__, *,
                 status: builtins.str):
        """
        :param builtins.str status: A bucket versioning state. Possible values:`Enabled` and `Suspended`.
        """
        pulumi.set(__self__, "status", status)
...
class GetBucketsBucketWebsiteResult(dict):
    def __init__(__self__, *,
                 ...
                 index_document: builtins.str):
        """
        :param builtins.str error_document: Key of the HTML document containing the error page.
        :param builtins.str index_document: Key of the HTML document containing the home page.
        """
        pulumi.set(__self__, "error_document", error_document)
        pulumi.set(__self__, "index_document", index_document)
...
class GetInstanceAttachmentsAttachmentResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str domain: The domain of the instance attachment.
        :param builtins.str endpoint: The access endpoint of the instance attachment.
        :param builtins.str id: The resource ID, the value is same as "instance_name".
        :param builtins.str instance_name: The name of OTS instance.
        :param builtins.str region: The region of the instance attachment.
        :param builtins.str vpc_id: The ID of attaching VPC to instance.
        :param builtins.str vpc_name: The name of attaching VPC to instance.
        """
...
class GetInstancesInstanceResult(dict):
    def __init__(__self__, *,
                 ...
                 entity_quota: builtins.int,
                 id: builtins.str,
                 name: builtins.str,
                 network: builtins.str,
                 network_source_acls: Sequence[builtins.str],
                 network_type_acls: Sequence[builtins.str],
                 policy: builtins.str,
                 policy_version: builtins.int,
                 resource_group_id: builtins.str,
                 status: builtins.str,
                 table_quota: builtins.int,
                 tags: Mapping[str, builtins.str],
                 user_id: builtins.str):
        """
        :param builtins.str cluster_type: The cluster type of the instance. Possible values: `SSD`, `HYBRID`.
        :param builtins.str create_time: The create time of the instance.
        :param builtins.str description: The description of the instance.
        :param builtins.int entity_quota: (Removed since v1.221.0) The instance quota which indicating the maximum number of tables.
        :param builtins.str id: ID of the instance.
        :param builtins.str name: Instance name.
        :param builtins.str network: (Removed since v1.221.0) The network type of the instance. Possible values: `NORMAL`, `VPC`, `VPC_CONSOLE`.
        :param Sequence[builtins.str] network_source_acls: (Available since v1.221.0) The set of request sources that are allowed access. Possible values: `TRUST_PROXY`.
        :param Sequence[builtins.str] network_type_acls: (Available since v1.221.0) The set of network types that are allowed access. Possible values: `CLASSIC`, `VPC`, `INTERNET`.
        :param builtins.str policy: (Available since v1.221.0) instance policy, json string.
        :param builtins.int policy_version: (Available since v1.221.0) instance policy version.
        :param builtins.str resource_group_id: (Available since v1.221.0) The resource group the instance belongs to.
        :param builtins.str status: Instance status. Possible values: `Running`, `Disabled`, `Deleting`.
        :param builtins.int table_quota: (Available since v1.221.0) The instance quota which indicating the maximum number of tables.
        :param Mapping[str, builtins.str] tags: A map of tags assigned to the instance. It must be in the format:
               ...
               ```
        :param builtins.str user_id: The user id of the instance.
        """
    ...
    def entity_quota(self) -> builtins.int:
        """
    ...
    def network_source_acls(self) -> Sequence[builtins.str]:
        """
    ...
    def network_type_acls(self) -> Sequence[builtins.str]:
        """
    ...
    def table_quota(self) -> builtins.int:
        """
...
class GetTablesTableResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: ID of the table. The value is `<instance_name>:<table_name>`.
        :param builtins.str instance_name: The name of OTS instance.
        :param builtins.int max_version: The maximum number of versions stored in this table.
        ...
        :param builtins.str table_name: The table name of the OTS which could not be changed.
        :param builtins.int time_to_live: The retention time of data stored in this table.
        """
    ...
    def max_version(self) -> builtins.int:
        """
    ...
    def time_to_live(self) -> builtins.int:
        """
