...
class AccessPointArgs:
    def __init__(__self__, *,
                 access_point_name: pulumi.Input[builtins.str],
                 bucket: pulumi.Input[builtins.str],
                 network_origin: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] bucket: The Bucket to which the current access point belongs.
        :param pulumi.Input[builtins.str] network_origin: Access point network source. The valid values are as follows: 
    ...
    def access_point_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def access_point_name(self, value: pulumi.Input[builtins.str]):
    ...
    def network_origin(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def network_origin(self, value: pulumi.Input[builtins.str]):
...
class _AccessPointState:
    def __init__(__self__, *,
                 ...
                 network_origin: Optional[pulumi.Input[builtins.str]] = None,
                 public_access_block_configuration: Optional[pulumi.Input['AccessPointPublicAccessBlockConfigurationArgs']] = None,
    ...
    @property
    @pulumi.getter(name="networkOrigin")
    def network_origin(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Access point network source. The valid values are as follows: 
        - vpc: only the specified VPC ID can be used to access the access point.
        - internet: the access point can be accessed through both external and internal Endpoint.
    ...
    @network_origin.setter
    def network_origin(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "network_origin", value)
...
class AccessPoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="accessPointName")
    def access_point_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the access point
        """
        return pulumi.get(self, "access_point_name")
    ...
    @property
    @pulumi.getter(name="networkOrigin")
    def network_origin(self) -> pulumi.Output[builtins.str]:
        """
        Access point network source. The valid values are as follows: 
        - vpc: only the specified VPC ID can be used to access the access point.
        - internet: the access point can be accessed through both external and internal Endpoint.
