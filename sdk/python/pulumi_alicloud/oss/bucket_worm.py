...
class BucketWormArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] retention_period_in_days: The specified number of days to retain the Object.
        :param pulumi.Input[builtins.str] status: The status of the compliance retention policy. Optional values:
...
class _BucketWormState:
    def __init__(__self__, *,
                 ...
                 retention_period_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 worm_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] status: The status of the compliance retention policy. Optional values:
               - `InProgress`: After a compliance retention policy is created, the policy is in the InProgress status by default, and the validity period of this status is 24 hours.
               - `Locked`: The compliance retention policy is Locked.
        :param pulumi.Input[builtins.str] worm_id: The ID of the retention policy.
        """
    ...
    def worm_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @worm_id.setter
    def worm_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BucketWorm(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retention_period_in_days: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            worm_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BucketWorm':
        """
    ...
    @property
    @pulumi.getter(name="retentionPeriodInDays")
    def retention_period_in_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The specified number of days to retain the Object.
        """
        return pulumi.get(self, "retention_period_in_days")
    ...
    @property
    @pulumi.getter(name="wormId")
    def worm_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the retention policy.
        """
        return pulumi.get(self, "worm_id")
