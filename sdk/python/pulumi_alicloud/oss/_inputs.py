...
class AccessPointPublicAccessBlockConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] block_public_access: Block public access enabled for access point
        """
...
class AccessPointVpcConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] vpc_id: The vpc ID is required only when the value of NetworkOrigin is VPC.
        """
...
class BucketAccessMonitorArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] status: The access monitor state of a bucket. If you want to manage objects based on the last access time of the objects, specifies the status to `Enabled`. Valid values: `Enabled` and `Disabled`.
        """
...
if not MYPY:
    class BucketCnameCertificateArgsDict(TypedDict):
        ...
        Certificate Type
        """
        valid_end_date: NotRequired[pulumi.Input[builtins.str]]
        """
        Certificate validity period end time
        """
        valid_start_date: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketCnameCertificateArgs:
    def __init__(__self__, *,
                 ...
                 valid_end_date: Optional[pulumi.Input[builtins.str]] = None,
                 valid_start_date: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cert_id: Certificate Identifier
        :param pulumi.Input[builtins.str] certificate: The certificate public key.
        :param pulumi.Input[builtins.str] creation_date: Certificate creation time
        :param pulumi.Input[builtins.str] fingerprint: Certificate Fingerprint
        :param pulumi.Input[builtins.str] private_key: The certificate private key.
        :param pulumi.Input[builtins.str] status: Cname status
        :param pulumi.Input[builtins.str] type: Certificate Type
        :param pulumi.Input[builtins.str] valid_end_date: Certificate validity period end time
        :param pulumi.Input[builtins.str] valid_start_date: Certificate validity period start time
        """
    ...
    def valid_end_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Certificate validity period end time
        """
    ...
    def valid_end_date(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "valid_end_date", value)

    @property
    @pulumi.getter(name="validStartDate")
    def valid_start_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Certificate validity period start time
        """
    ...
    def valid_start_date(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BucketCorsCorsRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_methods: The cross-origin request method that is allowed. Valid values: GET, PUT, DELETE, POST, and HEAD.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_headers: Specifies whether the headers specified by Access-Control-Request-Headers in the OPTIONS preflight request are allowed. You can use only one asterisk (*) as the wildcard for allowed header. .
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_origins: The origins from which cross-origin requests are allowed. .
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] expose_headers: The response headers for allowed access requests from applications, such as an XMLHttpRequest object in JavaScript. .
        :param pulumi.Input[builtins.int] max_age_seconds: The period of time within which the browser can cache the response to an OPTIONS preflight request for the specified resource. Unit: seconds.
        """
...
class BucketCorsRuleArgs:
    def __init__(__self__, *,
                 ...
                 max_age_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_methods: Specifies which methods are allowed. Can be GET, PUT, POST, DELETE or HEAD.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] expose_headers: Specifies expose header in the response.
        :param pulumi.Input[builtins.int] max_age_seconds: Specifies time in seconds that browser can cache the response for a preflight request.
        """
        pulumi.set(__self__, "allowed_methods", allowed_methods)
        pulumi.set(__self__, "allowed_origins", allowed_origins)
        if allowed_headers is not None:
...
class BucketLifecycleRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Specifies lifecycle rule status.
        ...
        :param pulumi.Input['BucketLifecycleRuleFilterArgs'] filter: Configuration block used to identify objects that a Lifecycle rule applies to. See `filter` below.
               ...
               `NOTE`: At least one of expiration, transitions, abort_multipart_upload, noncurrent_version_expiration and noncurrent_version_transition should be configured.
        :param pulumi.Input[builtins.str] id: Unique identifier for the rule. If omitted, OSS bucket will assign a unique name.
        ...
        :param pulumi.Input[builtins.str] prefix: The prefix in the names of the objects to which the lifecycle rule does not apply.
...
if not MYPY:
    class BucketLifecycleRuleAbortMultipartUploadArgsDict(TypedDict):
        created_before_date: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketLifecycleRuleAbortMultipartUploadArgs:
    def __init__(__self__, *,
                 created_before_date: Optional[pulumi.Input[builtins.str]] = None,
                 days: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] created_before_date: Specifies the time before which the rules take effect. The date must conform to the ISO8601 format and always be UTC 00:00. For example: 2002-10-11T00:00:00.000Z indicates that parts created before 2002-10-11T00:00:00.000Z are deleted, and parts created after this time (including this time) are not deleted.
        :param pulumi.Input[builtins.int] days: Specifies the number of days noncurrent object versions transition.
        """
    ...
    def created_before_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the time before which the rules take effect. The date must conform to the ISO8601 format and always be UTC 00:00. For example: 2002-10-11T00:00:00.000Z indicates that parts created before 2002-10-11T00:00:00.000Z are deleted, and parts created after this time (including this time) are not deleted.
        """
    ...
    def created_before_date(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BucketLifecycleRuleExpirationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] created_before_date: Specifies the time before which the rules take effect. The date must conform to the ISO8601 format and always be UTC 00:00. For example: 2002-10-11T00:00:00.000Z indicates that parts created before 2002-10-11T00:00:00.000Z are deleted, and parts created after this time (including this time) are not deleted.
        :param pulumi.Input[builtins.str] date: Specifies the date after which you want the corresponding action to take effect. The value obeys ISO8601 format like `2017-03-09`.
        :param pulumi.Input[builtins.int] days: Specifies the number of days noncurrent object versions transition.
        :param pulumi.Input[builtins.bool] expired_object_delete_marker: On a versioned bucket (versioning-enabled or versioning-suspended bucket), you can add this element in the lifecycle configuration to direct OSS to delete expired object delete markers. This cannot be specified with Days, Date or CreatedBeforeDate in a Lifecycle Expiration Policy.
...
class BucketLifecycleRuleFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] object_size_greater_than: Minimum object size (in bytes) to which the rule applies.
        :param pulumi.Input[builtins.int] object_size_less_than: Maximum object size (in bytes) to which the rule applies.
        """
        if not_ is not None:
...
class BucketLifecycleRuleFilterNotTagArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: The key of the tag that is specified for the objects.
        :param pulumi.Input[builtins.str] value: The value of the tag that is specified for the objects.
        """
...
if not MYPY:
    class BucketLifecycleRuleNoncurrentVersionTransitionArgsDict(TypedDict):
        ...
        """
        is_access_time: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        return_to_std_when_visit: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BucketLifecycleRuleNoncurrentVersionTransitionArgs:
    def __init__(__self__, *,
                 days: pulumi.Input[builtins.int],
                 storage_class: pulumi.Input[builtins.str],
                 is_access_time: Optional[pulumi.Input[builtins.bool]] = None,
                 return_to_std_when_visit: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.int] days: Specifies the number of days noncurrent object versions transition.
        :param pulumi.Input[builtins.str] storage_class: The [storage class](https://www.alibabacloud.com/help/doc-detail/51374.htm) to apply. Can be "Standard", "IA", "Archive", "ColdArchive" and "DeepColdArchive". Defaults to "Standard". "ColdArchive" is available since 1.203.0. "DeepColdArchive" is available since 1.209.0.
        :param pulumi.Input[builtins.bool] is_access_time: Specifies whether the lifecycle rule applies to objects based on their last access time. If set to `true`, the rule applies to objects based on their last access time; if set to `false`, the rule applies to objects based on their last modified time. If configure the rule based on the last access time, please enable `access_monitor` first.
        :param pulumi.Input[builtins.bool] return_to_std_when_visit: Specifies whether to convert the storage class of non-Standard objects back to Standard after the objects are accessed. It takes effect only when the IsAccessTime parameter is set to true. If set to `true`, converts the storage class of the objects to Standard; if set to `false`, does not convert the storage class of the objects to Standard.
        """
        pulumi.set(__self__, "days", days)
    ...
    def is_access_time(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether the lifecycle rule applies to objects based on their last access time. If set to `true`, the rule applies to objects based on their last access time; if set to `false`, the rule applies to objects based on their last modified time. If configure the rule based on the last access time, please enable `access_monitor` first.
        """
    ...
    def is_access_time(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_access_time", value)

    @property
    @pulumi.getter(name="returnToStdWhenVisit")
    def return_to_std_when_visit(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to convert the storage class of non-Standard objects back to Standard after the objects are accessed. It takes effect only when the IsAccessTime parameter is set to true. If set to `true`, converts the storage class of the objects to Standard; if set to `false`, does not convert the storage class of the objects to Standard.
        """
    ...
    def return_to_std_when_visit(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BucketLoggingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] target_bucket: The name of the bucket that will receive the log objects.
        :param pulumi.Input[builtins.str] target_prefix: To specify a key prefix for log objects.
        """
...
if not MYPY:
    class BucketRefererConfigArgsDict(TypedDict):
        referers: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        The list of referer.
        """
...
class BucketRefererConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] referers: The list of referer.
        :param pulumi.Input[builtins.bool] allow_empty: Allows referer to be empty. Defaults false.
        """
    ...
    @property
    @pulumi.getter
    def referers(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The list of referer.
        """
    ...
    @referers.setter
    def referers(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class BucketReplicationDestinationArgsDict(TypedDict):
        ...
        """
        transfer_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketReplicationDestinationArgs:
    def __init__(__self__, *,
                 bucket: pulumi.Input[builtins.str],
                 location: pulumi.Input[builtins.str],
                 transfer_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] bucket: The destination bucket to which the data is replicated.
        :param pulumi.Input[builtins.str] location: The region in which the destination bucket is located.
        :param pulumi.Input[builtins.str] transfer_type: The link used to transfer data in data replication.. Can be `internal` or `oss_acc`. Defaults to `internal`.
    ...
    def transfer_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The link used to transfer data in data replication.. Can be `internal` or `oss_acc`. Defaults to `internal`.
    ...
    def transfer_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transfer_type", value)


if not MYPY:
    class BucketReplicationEncryptionConfigurationArgsDict(TypedDict):
        replica_kms_key_id: pulumi.Input[builtins.str]
        """
...
class BucketReplicationEncryptionConfigurationArgs:
    def __init__(__self__, *,
                 replica_kms_key_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] replica_kms_key_id: The CMK ID used in SSE-KMS.
    ...
    def replica_kms_key_id(self) -> pulumi.Input[builtins.str]:
        """
        The CMK ID used in SSE-KMS.
    ...
    def replica_kms_key_id(self, value: pulumi.Input[builtins.str]):
...
class BucketReplicationPrefixSetArgs:
    def __init__(__self__, *,
                 prefixes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] prefixes: The list of object key name prefix identifying one or more objects to which the rule applies.
...
if not MYPY:
    class BucketReplicationProgressArgsDict(TypedDict):
        historical_object: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        new_object: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketReplicationProgressArgs:
    def __init__(__self__, *,
                 historical_object: Optional[pulumi.Input[builtins.str]] = None,
                 new_object: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] historical_object: The percentage of the replicated historical data. This element is valid only when historical_object_replication is set to enabled.
        :param pulumi.Input[builtins.str] new_object: The time used to distinguish new data from historical data. Data that is written to the source bucket before the time is replicated to the destination bucket as new data. The value of this element is in GMT.
        """
    ...
    def historical_object(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The percentage of the replicated historical data. This element is valid only when historical_object_replication is set to enabled.
        """
    ...
    def historical_object(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "historical_object", value)

    @property
    @pulumi.getter(name="newObject")
    def new_object(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The time used to distinguish new data from historical data. Data that is written to the source bucket before the time is replicated to the destination bucket as new data. The value of this element is in GMT.
        """
    ...
    @new_object.setter
    def new_object(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BucketReplicationSourceSelectionCriteriaSseKmsEncryptedObjectsArgs:
    def __init__(__self__, *,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] status: The status of the data replication task. Can be starting, doing and closing.
        """
        if status is not None:
            pulumi.set(__self__, "status", status)
...
if not MYPY:
    class BucketServerSideEncryptionRuleArgsDict(TypedDict):
        ...
        """
        kms_data_encryption: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketServerSideEncryptionRuleArgs:
    def __init__(__self__, *,
                 sse_algorithm: pulumi.Input[builtins.str],
                 kms_data_encryption: Optional[pulumi.Input[builtins.str]] = None,
                 kms_master_key_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] sse_algorithm: The server-side encryption algorithm to use. Possible values: `AES256` and `KMS`.
        :param pulumi.Input[builtins.str] kms_data_encryption: The algorithm used to encrypt objects. If this element is not specified, objects are encrypted with AES256. This element is valid only when the value of SSEAlgorithm is set to KMS. Valid values: `SM4`.
        :param pulumi.Input[builtins.str] kms_master_key_id: The alibaba cloud KMS master key ID used for the SSE-KMS encryption.
        """
    ...
    def kms_data_encryption(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The algorithm used to encrypt objects. If this element is not specified, objects are encrypted with AES256. This element is valid only when the value of SSEAlgorithm is set to KMS. Valid values: `SM4`.
        """
    ...
    def kms_data_encryption(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BucketTransferAccelerationArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: Specifies the accelerate status of a bucket.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class BucketVersioningArgs:
    def __init__(__self__, *,
                 status: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] status: Specifies the versioning state of a bucket. Valid values: `Enabled` and `Suspended`.
        """
        pulumi.set(__self__, "status", status)
...
if not MYPY:
    class BucketWebsiteArgsDict(TypedDict):
        index_document: pulumi.Input[builtins.str]
        """
...
class BucketWebsiteArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] index_document: Alicloud OSS returns this index document when requests are made to the root domain or any of the subfolders.
    ...
    def index_document(self) -> pulumi.Input[builtins.str]:
        """
        Alicloud OSS returns this index document when requests are made to the root domain or any of the subfolders.
        """
    ...
    def index_document(self, value: pulumi.Input[builtins.str]):
...
class BucketWebsiteErrorDocumentArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] http_status: The HTTP status code when the error page is returned. The default 404.
        :param pulumi.Input[builtins.str] key: The error page file. If the Object accessed does not exist, this error page is returned.
        """
...
if not MYPY:
    class BucketWebsiteIndexDocumentArgsDict(TypedDict):
        ...
        """
        support_sub_dir: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BucketWebsiteIndexDocumentArgs:
    def __init__(__self__, *,
                 ...
                 support_sub_dir: Optional[pulumi.Input[builtins.bool]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] suffix: The default home page.
        :param pulumi.Input[builtins.bool] support_sub_dir: Whether to jump to the default home page of a subdirectory when accessing a subdirectory.
        :param pulumi.Input[builtins.str] type: After the default homepage is set, the behavior when an Object that ends with a non-forward slash (/) is accessed and the Object does not exist.
        """
    ...
    def support_sub_dir(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to jump to the default home page of a subdirectory when accessing a subdirectory.
        """
    ...
    def support_sub_dir(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class BucketWebsiteRoutingRulesRoutingRuleArgsDict(TypedDict):
        ...
        """
        rule_number: NotRequired[pulumi.Input[builtins.int]]
        """
...
class BucketWebsiteRoutingRulesRoutingRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] rule_number: The sequence number of the matching and executing jump rules. OSS matches rules according to this sequence number. If the match is successful, the rule is executed and subsequent rules are not executed.
        """
...
if not MYPY:
    class BucketWebsiteRoutingRulesRoutingRuleConditionArgsDict(TypedDict):
        ...
        """
        key_suffix_equals: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketWebsiteRoutingRulesRoutingRuleConditionArgs:
    def __init__(__self__, *,
                 ...
                 key_suffix_equals: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] http_error_code_returned_equals: When the specified Object is accessed, this status is returned to match this rule. This field must be 404 when the jump rule is mirrored back to the source.
        ...
        :param pulumi.Input[builtins.str] key_prefix_equals: Only objects that match this prefix can match this rule.
        :param pulumi.Input[builtins.str] key_suffix_equals: Only objects that match this suffix can match this rule.
        """
    ...
    def key_suffix_equals(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Only objects that match this suffix can match this rule.
        """
    ...
    def key_suffix_equals(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BucketWebsiteRoutingRulesRoutingRuleConditionIncludeHeaderArgsDict(TypedDict):
        ends_with: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketWebsiteRoutingRulesRoutingRuleConditionIncludeHeaderArgs:
    def __init__(__self__, *,
                 ends_with: Optional[pulumi.Input[builtins.str]] = None,
                 equals: Optional[pulumi.Input[builtins.str]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 starts_with: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ends_with: This rule can only be matched if the request contains the Header specified by Key and the value ends with this value.
        :param pulumi.Input[builtins.str] equals: This rule can only be matched if the request contains the Header specified by Key and the value is the specified value.
        :param pulumi.Input[builtins.str] starts_with: This rule can only be matched if the request contains the Header specified by Key and the value starts with this value.
        """
    ...
    def ends_with(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        This rule can only be matched if the request contains the Header specified by Key and the value ends with this value.
        """
    ...
    @ends_with.setter
    def ends_with(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BucketWebsiteRoutingRulesRoutingRuleLuaConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] script: The Lua script name.
        """
...
if not MYPY:
    class BucketWebsiteRoutingRulesRoutingRuleRedirectArgsDict(TypedDict):
        enable_replace_prefix: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        mirror_allow_get_image_info: NotRequired[pulumi.Input[builtins.bool]]
        """
        Image back-to-source allows getting Image information
        """
        mirror_allow_head_object: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to allow HeadObject in image back-to-source
        """
        mirror_allow_video_snapshot: NotRequired[pulumi.Input[builtins.bool]]
        """
        Mirror back-to-source allows support for video frame truncation
        """
        mirror_async_status: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        mirror_check_md5: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to check the MD5 of the source body. It takes effect only when the RedirectType is set to Mirror.
        """
        mirror_dst_region: NotRequired[pulumi.Input[builtins.str]]
        """
        Mirrored back-to-source high-speed Channel vpregion
        """
        mirror_dst_slave_vpc_id: NotRequired[pulumi.Input[builtins.str]]
        """
        Mirroring back-to-source high-speed Channel standby station VpcId
        """
        mirror_dst_vpc_id: NotRequired[pulumi.Input[builtins.str]]
        """
        Mirror back-to-source high-speed Channel VpcId
        """
        mirror_follow_redirect: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        mirror_is_express_tunnel: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        mirror_pass_original_slashes: NotRequired[pulumi.Input[builtins.bool]]
        """
        Transparent transmission/to source Station
        """
        mirror_pass_query_string: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        mirror_proxy_pass: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        mirror_role: NotRequired[pulumi.Input[builtins.str]]
        """
        Roles used when mirroring back-to-source
        """
        mirror_save_oss_meta: NotRequired[pulumi.Input[builtins.bool]]
        """
        Mirror back-to-source back-to-source OSS automatically saves user metadata
        """
        mirror_sni: NotRequired[pulumi.Input[builtins.bool]]
        """
        Transparent transmission of SNI
        """
        mirror_switch_all_errors: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        mirror_tunnel_id: NotRequired[pulumi.Input[builtins.str]]
        """
        Mirror back-to-source leased line back-to-source tunnel ID
        """
        mirror_url: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        mirror_url_probe: NotRequired[pulumi.Input[builtins.str]]
        """
        Mirror back-to-source Master-backup back-to-source switching decision URL
        """
        mirror_url_slave: NotRequired[pulumi.Input[builtins.str]]
        """
        Mirror back-to-source primary backup back-to-source backup station URL
        """
        mirror_user_last_modified: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether the source station LastModifiedTime is used for the image back-to-source save file.
        """
        mirror_using_role: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to use role for mirroring back to source
        """
        pass_query_string: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        transparent_mirror_response_codes: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketWebsiteRoutingRulesRoutingRuleRedirectArgs:
    def __init__(__self__, *,
                 enable_replace_prefix: Optional[pulumi.Input[builtins.bool]] = None,
                 host_name: Optional[pulumi.Input[builtins.str]] = None,
                 http_redirect_code: Optional[pulumi.Input[builtins.str]] = None,
                 mirror_allow_get_image_info: Optional[pulumi.Input[builtins.bool]] = None,
                 mirror_allow_head_object: Optional[pulumi.Input[builtins.bool]] = None,
                 mirror_allow_video_snapshot: Optional[pulumi.Input[builtins.bool]] = None,
                 mirror_async_status: Optional[pulumi.Input[builtins.int]] = None,
                 mirror_auth: Optional[pulumi.Input['BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorAuthArgs']] = None,
                 mirror_check_md5: Optional[pulumi.Input[builtins.bool]] = None,
                 mirror_dst_region: Optional[pulumi.Input[builtins.str]] = None,
                 mirror_dst_slave_vpc_id: Optional[pulumi.Input[builtins.str]] = None,
                 mirror_dst_vpc_id: Optional[pulumi.Input[builtins.str]] = None,
                 mirror_follow_redirect: Optional[pulumi.Input[builtins.bool]] = None,
                 mirror_headers: Optional[pulumi.Input['BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeadersArgs']] = None,
                 mirror_is_express_tunnel: Optional[pulumi.Input[builtins.bool]] = None,
                 mirror_multi_alternates: Optional[pulumi.Input['BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorMultiAlternatesArgs']] = None,
                 mirror_pass_original_slashes: Optional[pulumi.Input[builtins.bool]] = None,
                 mirror_pass_query_string: Optional[pulumi.Input[builtins.bool]] = None,
                 mirror_proxy_pass: Optional[pulumi.Input[builtins.bool]] = None,
                 mirror_return_headers: Optional[pulumi.Input['BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorReturnHeadersArgs']] = None,
                 mirror_role: Optional[pulumi.Input[builtins.str]] = None,
                 mirror_save_oss_meta: Optional[pulumi.Input[builtins.bool]] = None,
                 mirror_sni: Optional[pulumi.Input[builtins.bool]] = None,
                 mirror_switch_all_errors: Optional[pulumi.Input[builtins.bool]] = None,
                 mirror_taggings: Optional[pulumi.Input['BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorTaggingsArgs']] = None,
                 mirror_tunnel_id: Optional[pulumi.Input[builtins.str]] = None,
                 mirror_url: Optional[pulumi.Input[builtins.str]] = None,
                 mirror_url_probe: Optional[pulumi.Input[builtins.str]] = None,
                 mirror_url_slave: Optional[pulumi.Input[builtins.str]] = None,
                 mirror_user_last_modified: Optional[pulumi.Input[builtins.bool]] = None,
                 mirror_using_role: Optional[pulumi.Input[builtins.bool]] = None,
                 pass_query_string: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 transparent_mirror_response_codes: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_replace_prefix: If this field is set to true, the prefix of Object is replaced with the value specified by ReplaceKeyPrefixWith. If this field is not specified or is blank, the Object prefix is truncated.
        :param pulumi.Input[builtins.str] host_name: The domain name during the jump. The domain name must comply with the domain name specification.
        :param pulumi.Input[builtins.str] http_redirect_code: The status code returned during the jump. It takes effect only when the RedirectType is set to External or AliCDN.
        :param pulumi.Input[builtins.bool] mirror_allow_get_image_info: Image back-to-source allows getting Image information
        :param pulumi.Input[builtins.bool] mirror_allow_head_object: Whether to allow HeadObject in image back-to-source
        :param pulumi.Input[builtins.bool] mirror_allow_video_snapshot: Mirror back-to-source allows support for video frame truncation
        :param pulumi.Input[builtins.int] mirror_async_status: The status code of the mirror back-to-source trigger asynchronous pull mode.
        ...
        :param pulumi.Input[builtins.bool] mirror_check_md5: Whether to check the MD5 of the source body. It takes effect only when the RedirectType is set to Mirror.
        :param pulumi.Input[builtins.str] mirror_dst_region: Mirrored back-to-source high-speed Channel vpregion
        :param pulumi.Input[builtins.str] mirror_dst_slave_vpc_id: Mirroring back-to-source high-speed Channel standby station VpcId
        :param pulumi.Input[builtins.str] mirror_dst_vpc_id: Mirror back-to-source high-speed Channel VpcId
        :param pulumi.Input[builtins.bool] mirror_follow_redirect: If the result of the image back-to-source acquisition is 3xx, whether to continue to jump to the specified Location to obtain data. It takes effect only when the RedirectType is set to Mirror.
        ...
        :param pulumi.Input[builtins.bool] mirror_is_express_tunnel: Whether it is a mirror back-to-source high-speed Channel
        :param pulumi.Input['BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorMultiAlternatesArgs'] mirror_multi_alternates: Mirror back-to-source multi-source station configuration container. **NOTE:**: If you want to clean one configuration, you must set the configuration to empty value, removing from code cannot make effect. See `mirror_multi_alternates` below.
        :param pulumi.Input[builtins.bool] mirror_pass_original_slashes: Transparent transmission/to source Station
        :param pulumi.Input[builtins.bool] mirror_pass_query_string: Same as PassQueryString and takes precedence over PassQueryString. It takes effect only when the RedirectType is set to Mirror.
        :param pulumi.Input[builtins.bool] mirror_proxy_pass: Whether mirroring back to source does not save data
        :param pulumi.Input['BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorReturnHeadersArgs'] mirror_return_headers: The container that saves the image back to the source and returns the response header rule. **NOTE:**: If you want to clean one configuration, you must set the configuration to empty value, removing from code cannot make effect. See `mirror_return_headers` below.
        :param pulumi.Input[builtins.str] mirror_role: Roles used when mirroring back-to-source
        :param pulumi.Input[builtins.bool] mirror_save_oss_meta: Mirror back-to-source back-to-source OSS automatically saves user metadata
        :param pulumi.Input[builtins.bool] mirror_sni: Transparent transmission of SNI
        :param pulumi.Input[builtins.bool] mirror_switch_all_errors: It is used to judge the status of active-standby switching. The judgment logic of active-standby switching is that the source station returns an error. If MirrorSwitchAllErrors is true, it is considered a failure except the following status code: 200,206,301,302,303,307,404; If false, only the source Station Returns 5xx or times out is considered a failure.
        ...
        :param pulumi.Input[builtins.str] mirror_tunnel_id: Mirror back-to-source leased line back-to-source tunnel ID
        :param pulumi.Input[builtins.str] mirror_url: The address of the origin of the image. It takes effect only when the RedirectType is set to Mirror. The origin address must start with http:// or https:// and end with a forward slash (/). OSS takes the Object name after the Origin address to form the origin URL.
        :param pulumi.Input[builtins.str] mirror_url_probe: Mirror back-to-source Master-backup back-to-source switching decision URL
        :param pulumi.Input[builtins.str] mirror_url_slave: Mirror back-to-source primary backup back-to-source backup station URL
        :param pulumi.Input[builtins.bool] mirror_user_last_modified: Whether the source station LastModifiedTime is used for the image back-to-source save file.
        :param pulumi.Input[builtins.bool] mirror_using_role: Whether to use role for mirroring back to source
        :param pulumi.Input[builtins.bool] pass_query_string: Whether to carry the request parameters when executing the jump or mirror back-to-source rule. Did the user carry the request parameters when requesting OSS? a = B & c = d, and set PassQueryString to true. If the rule is a 302 jump, this request parameter is added to the Location header of the jump. For example Location:example.com? a = B & c = d, and the jump type is mirrored back-to-origin, this request parameter is also carried in the back-to-origin request initiated. Values: true, false (default)
        :param pulumi.Input[builtins.str] protocol: The protocol at the time of the jump. It takes effect only when the RedirectType is set to External or AliCDN.
        :param pulumi.Input[builtins.str] redirect_type: Specifies the type of jump. The value range is as follows: Mirror: Mirror back to the source. External: External redirects, that is, OSS returns a 3xx request to redirect to another address. AliCDN: Alibaba Cloud CDN jump, mainly used for Alibaba Cloud CDN. Unlike External, OSS adds an additional Header. After recognizing this Header, Alibaba Cloud CDN redirects the data to the specified address and returns the obtained data to the user instead of returning the 3xx Redirection request to the user.
        :param pulumi.Input[builtins.str] replace_key_prefix_with: The prefix of the Object name will be replaced with this value during Redirect. If the prefix is empty, this string is inserted in front of the Object name.
        :param pulumi.Input[builtins.str] replace_key_with: During redirection, the Object name is replaced with the value specified by ReplaceKeyWith. You can set variables in ReplaceKeyWith. Currently, the supported variable is ${key}, which indicates the name of the Object in the request.
        :param pulumi.Input[builtins.str] transparent_mirror_response_codes: Mirror back-to-source transparent source station response code list
        """
    ...
    def enable_replace_prefix(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If this field is set to true, the prefix of Object is replaced with the value specified by ReplaceKeyPrefixWith. If this field is not specified or is blank, the Object prefix is truncated.
        """
    ...
    def enable_replace_prefix(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def mirror_allow_get_image_info(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Image back-to-source allows getting Image information
        """
    ...
    def mirror_allow_get_image_info(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "mirror_allow_get_image_info", value)

    @property
    @pulumi.getter(name="mirrorAllowHeadObject")
    def mirror_allow_head_object(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to allow HeadObject in image back-to-source
        """
    ...
    def mirror_allow_head_object(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "mirror_allow_head_object", value)

    @property
    @pulumi.getter(name="mirrorAllowVideoSnapshot")
    def mirror_allow_video_snapshot(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Mirror back-to-source allows support for video frame truncation
        """
    ...
    def mirror_allow_video_snapshot(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "mirror_allow_video_snapshot", value)

    @property
    @pulumi.getter(name="mirrorAsyncStatus")
    def mirror_async_status(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The status code of the mirror back-to-source trigger asynchronous pull mode.
        """
    ...
    def mirror_async_status(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def mirror_check_md5(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to check the MD5 of the source body. It takes effect only when the RedirectType is set to Mirror.
        """
    ...
    def mirror_check_md5(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "mirror_check_md5", value)

    @property
    @pulumi.getter(name="mirrorDstRegion")
    def mirror_dst_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Mirrored back-to-source high-speed Channel vpregion
        """
    ...
    def mirror_dst_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirror_dst_region", value)

    @property
    @pulumi.getter(name="mirrorDstSlaveVpcId")
    def mirror_dst_slave_vpc_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Mirroring back-to-source high-speed Channel standby station VpcId
        """
    ...
    def mirror_dst_slave_vpc_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirror_dst_slave_vpc_id", value)

    @property
    @pulumi.getter(name="mirrorDstVpcId")
    def mirror_dst_vpc_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Mirror back-to-source high-speed Channel VpcId
        """
    ...
    def mirror_dst_vpc_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirror_dst_vpc_id", value)

    @property
    @pulumi.getter(name="mirrorFollowRedirect")
    def mirror_follow_redirect(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If the result of the image back-to-source acquisition is 3xx, whether to continue to jump to the specified Location to obtain data. It takes effect only when the RedirectType is set to Mirror.
        """
    ...
    def mirror_follow_redirect(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def mirror_is_express_tunnel(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether it is a mirror back-to-source high-speed Channel
        """
    ...
    def mirror_is_express_tunnel(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def mirror_pass_original_slashes(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Transparent transmission/to source Station
        """
    ...
    def mirror_pass_original_slashes(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "mirror_pass_original_slashes", value)

    @property
    @pulumi.getter(name="mirrorPassQueryString")
    def mirror_pass_query_string(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Same as PassQueryString and takes precedence over PassQueryString. It takes effect only when the RedirectType is set to Mirror.
        """
    ...
    def mirror_pass_query_string(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "mirror_pass_query_string", value)

    @property
    @pulumi.getter(name="mirrorProxyPass")
    def mirror_proxy_pass(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether mirroring back to source does not save data
        """
    ...
    def mirror_proxy_pass(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def mirror_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Roles used when mirroring back-to-source
        """
    ...
    @mirror_role.setter
    def mirror_role(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirror_role", value)

    @property
    @pulumi.getter(name="mirrorSaveOssMeta")
    def mirror_save_oss_meta(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Mirror back-to-source back-to-source OSS automatically saves user metadata
        """
    ...
    def mirror_save_oss_meta(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "mirror_save_oss_meta", value)

    @property
    @pulumi.getter(name="mirrorSni")
    def mirror_sni(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Transparent transmission of SNI
        """
    ...
    @mirror_sni.setter
    def mirror_sni(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "mirror_sni", value)

    @property
    @pulumi.getter(name="mirrorSwitchAllErrors")
    def mirror_switch_all_errors(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        It is used to judge the status of active-standby switching. The judgment logic of active-standby switching is that the source station returns an error. If MirrorSwitchAllErrors is true, it is considered a failure except the following status code: 200,206,301,302,303,307,404; If false, only the source Station Returns 5xx or times out is considered a failure.
        """
    ...
    def mirror_switch_all_errors(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def mirror_tunnel_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Mirror back-to-source leased line back-to-source tunnel ID
        """
    ...
    def mirror_tunnel_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirror_tunnel_id", value)

    @property
    @pulumi.getter(name="mirrorUrl")
    def mirror_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The address of the origin of the image. It takes effect only when the RedirectType is set to Mirror. The origin address must start with http:// or https:// and end with a forward slash (/). OSS takes the Object name after the Origin address to form the origin URL.
        """
    ...
    @mirror_url.setter
    def mirror_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirror_url", value)

    @property
    @pulumi.getter(name="mirrorUrlProbe")
    def mirror_url_probe(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Mirror back-to-source Master-backup back-to-source switching decision URL
        """
    ...
    def mirror_url_probe(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirror_url_probe", value)

    @property
    @pulumi.getter(name="mirrorUrlSlave")
    def mirror_url_slave(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Mirror back-to-source primary backup back-to-source backup station URL
        """
    ...
    def mirror_url_slave(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirror_url_slave", value)

    @property
    @pulumi.getter(name="mirrorUserLastModified")
    def mirror_user_last_modified(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the source station LastModifiedTime is used for the image back-to-source save file.
        """
    ...
    def mirror_user_last_modified(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "mirror_user_last_modified", value)

    @property
    @pulumi.getter(name="mirrorUsingRole")
    def mirror_using_role(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to use role for mirroring back to source
        """
    ...
    def mirror_using_role(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "mirror_using_role", value)

    @property
    @pulumi.getter(name="passQueryString")
    def pass_query_string(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to carry the request parameters when executing the jump or mirror back-to-source rule. Did the user carry the request parameters when requesting OSS? a = B & c = d, and set PassQueryString to true. If the rule is a 302 jump, this request parameter is added to the Location header of the jump. For example Location:example.com? a = B & c = d, and the jump type is mirrored back-to-origin, this request parameter is also carried in the back-to-origin request initiated. Values: true, false (default)
        """
    ...
    def pass_query_string(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def transparent_mirror_response_codes(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Mirror back-to-source transparent source station response code list
        """
    ...
    def transparent_mirror_response_codes(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorAuthArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] access_key_id: Mirror back-to-source source Station back-to-source AK
        :param pulumi.Input[builtins.str] access_key_secret: Mirroring back to the source station back to the source SK will be automatically desensitized when obtaining the configuration.
        :param pulumi.Input[builtins.str] auth_type: Authentication type of mirror return Source
        :param pulumi.Input[builtins.str] region: Signature Region
        """
...
class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeadersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] pass_all: Indicates whether other headers except the following headers are transmitted to the source site. It takes effect only when the RedirectType is set to Mirror. content-length, authorization2, authorization, range, date, and other headers Headers whose names start with oss-/x-oss-/x-drs-
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] passes: Pass through the specified Header to the source site. It takes effect only when the RedirectType is set to Mirror. Each Header is up to 1024 bytes in length and has A character set of 0 to 9, a to Z, A to z, and dashes (-).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] removes: Do not pass the specified Header to the source site. It takes effect only when the RedirectType is set to Mirror. Each Header is up to 1024 bytes in length and has A character set of 0 to 9, a to Z, A to z, and dashes (-).
...
class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorHeadersSetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] value: Set the value of the Header to 1024 bytes at most. \\r\\n. It takes effect only when the RedirectType is set to Mirror.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
...
if not MYPY:
    class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorMultiAlternatesMirrorMultiAlternateArgsDict(TypedDict):
        mirror_multi_alternate_dst_region: NotRequired[pulumi.Input[builtins.str]]
        """
        Mirroring back-to-source multi-station Region
        """
        mirror_multi_alternate_number: NotRequired[pulumi.Input[builtins.int]]
        """
        Image back-to-source multi-source station serial number
        """
        mirror_multi_alternate_url: NotRequired[pulumi.Input[builtins.str]]
        """
        Mirroring back-to-source multi-source site URL
        """
        mirror_multi_alternate_vpc_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketWebsiteRoutingRulesRoutingRuleRedirectMirrorMultiAlternatesMirrorMultiAlternateArgs:
    def __init__(__self__, *,
                 mirror_multi_alternate_dst_region: Optional[pulumi.Input[builtins.str]] = None,
                 mirror_multi_alternate_number: Optional[pulumi.Input[builtins.int]] = None,
                 mirror_multi_alternate_url: Optional[pulumi.Input[builtins.str]] = None,
                 mirror_multi_alternate_vpc_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] mirror_multi_alternate_dst_region: Mirroring back-to-source multi-station Region
        :param pulumi.Input[builtins.int] mirror_multi_alternate_number: Image back-to-source multi-source station serial number
        :param pulumi.Input[builtins.str] mirror_multi_alternate_url: Mirroring back-to-source multi-source site URL
        :param pulumi.Input[builtins.str] mirror_multi_alternate_vpc_id: Mirroring back-to-source multi-source VpcId
        """
    ...
    def mirror_multi_alternate_dst_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Mirroring back-to-source multi-station Region
        """
    ...
    def mirror_multi_alternate_dst_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirror_multi_alternate_dst_region", value)

    @property
    @pulumi.getter(name="mirrorMultiAlternateNumber")
    def mirror_multi_alternate_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Image back-to-source multi-source station serial number
        """
    ...
    def mirror_multi_alternate_number(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "mirror_multi_alternate_number", value)

    @property
    @pulumi.getter(name="mirrorMultiAlternateUrl")
    def mirror_multi_alternate_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Mirroring back-to-source multi-source site URL
        """
    ...
    def mirror_multi_alternate_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirror_multi_alternate_url", value)

    @property
    @pulumi.getter(name="mirrorMultiAlternateVpcId")
    def mirror_multi_alternate_vpc_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Mirroring back-to-source multi-source VpcId
        """
    ...
    def mirror_multi_alternate_vpc_id(self, value: Optional[pulumi.Input[builtins.str]]):
