...
class BucketAccessMonitorInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] status: Specifies whether to enable access tracking for the bucket. Valid values: Enabled: enables access tracking. Disabled: disables access tracking.
        """
