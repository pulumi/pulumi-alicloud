...
class BucketDataRedundancyTransitionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket: Storage space name.
        """
...
class _BucketDataRedundancyTransitionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket: Storage space name.
        :param pulumi.Input[builtins.str] create_time: Stores the creation time of the redundant transformation task.
        :param pulumi.Input[builtins.str] status: Stores the state of the redundant translation task. The values are as follows:  Queueing: in the queue.  Processing: In progress.  Finished: Finished.
        :param pulumi.Input[builtins.str] task_id: Unique identification of the storage redundancy conversion task.
        """
...
class BucketDataRedundancyTransition(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            create_time: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            task_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BucketDataRedundancyTransition':
        """
