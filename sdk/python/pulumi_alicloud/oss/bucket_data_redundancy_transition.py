...
class _BucketDataRedundancyTransitionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] task_id: Unique identification of the storage redundancy conversion task.
        """
...
class BucketDataRedundancyTransition(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            create_time: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            task_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'BucketDataRedundancyTransition':
        """
