...
class BucketRequestPaymentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] payer: The payer of the request and traffic fees.Valid values: BucketOwner: request and traffic fees are paid by the bucket owner. Requester: request and traffic fees are paid by the requester.
        """
...
class BucketRequestPayment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            bucket: Optional[pulumi.Input[builtins.str]] = None,
            payer: Optional[pulumi.Input[builtins.str]] = None) -> 'BucketRequestPayment':
        """
