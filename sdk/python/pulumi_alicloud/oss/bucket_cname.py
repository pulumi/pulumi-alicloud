...
class BucketCnameArgs:
    def __init__(__self__, *,
                 ...
                 delete_certificate: Optional[pulumi.Input[builtins.bool]] = None,
                 force: Optional[pulumi.Input[builtins.bool]] = None,
                 previous_cert_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a BucketCname resource.
        :param pulumi.Input[builtins.str] bucket: The bucket to which the custom domain name belongs
        :param pulumi.Input[builtins.str] domain: User-defined domain name
        ...
        :param pulumi.Input[builtins.bool] delete_certificate: Whether to delete the certificate.
        :param pulumi.Input[builtins.bool] force: Whether to force overwrite certificate.
        :param pulumi.Input[builtins.str] previous_cert_id: The current certificate ID. If the Force value is not true, the OSS Server checks whether the value matches the current certificate ID. If the value does not match, an error is reported.
        """
    ...
    def delete_certificate(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def delete_certificate(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def previous_cert_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def previous_cert_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BucketCname(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            force: Optional[pulumi.Input[builtins.bool]] = None,
            previous_cert_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'BucketCname':
        """
    ...
    @property
    @pulumi.getter(name="deleteCertificate")
    def delete_certificate(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to delete the certificate.
        """
        return pulumi.get(self, "delete_certificate")
    ...
    @property
    @pulumi.getter(name="previousCertId")
    def previous_cert_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The current certificate ID. If the Force value is not true, the OSS Server checks whether the value matches the current certificate ID. If the value does not match, an error is reported.
        """
        return pulumi.get(self, "previous_cert_id")
