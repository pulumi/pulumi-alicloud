...
class BucketRefererArgs:
    def __init__(__self__, *,
                 allow_empty_referer: pulumi.Input[builtins.bool],
                 bucket: pulumi.Input[builtins.str],
                 allow_truncate_query_string: Optional[pulumi.Input[builtins.bool]] = None,
                 referer_blacklists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 referer_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 truncate_path: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a BucketReferer resource.
        :param pulumi.Input[builtins.bool] allow_empty_referer: Whether to allow empty Referer request headers.
        :param pulumi.Input[builtins.str] bucket: Name of the Bucket.
        :param pulumi.Input[builtins.bool] allow_truncate_query_string: Specifies whether to truncate the query string in the URL when the Referer is matched. Valid values: true, false.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] referer_blacklists: The container that holds the Referer blacklist.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] referer_lists: The container that holds the Referer whitelist.
        :param pulumi.Input[builtins.bool] truncate_path: Specifies whether to truncate the path and parts that follow the path in the URL when the Referer is matched. Valid values: true, false. If TruncatePath is set to true, the value of AllowTruncateQueryString must be also true because the query string follows the path component. When the path is truncated, the query string is also truncated.
        """
    ...
    def allow_empty_referer(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def allow_empty_referer(self, value: pulumi.Input[builtins.bool]):
    ...
    def allow_truncate_query_string(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_truncate_query_string(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_truncate_query_string", value)

    @property
    @pulumi.getter(name="refererBlacklists")
    def referer_blacklists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def referer_blacklists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "referer_blacklists", value)

    @property
    @pulumi.getter(name="refererLists")
    def referer_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def referer_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "referer_lists", value)

    @property
    @pulumi.getter(name="truncatePath")
    def truncate_path(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def truncate_path(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _BucketRefererState:
    def __init__(__self__, *,
                 allow_empty_referer: Optional[pulumi.Input[builtins.bool]] = None,
                 allow_truncate_query_string: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="allowEmptyReferer")
    def allow_empty_referer(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to allow empty Referer request headers.
        """
        return pulumi.get(self, "allow_empty_referer")
    ...
    @allow_empty_referer.setter
    def allow_empty_referer(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_empty_referer", value)
...
class BucketReferer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            referer_blacklists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            referer_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            truncate_path: Optional[pulumi.Input[builtins.bool]] = None) -> 'BucketReferer':
        """
    ...
    @property
    @pulumi.getter(name="allowEmptyReferer")
    def allow_empty_referer(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to allow empty Referer request headers.
        """
        return pulumi.get(self, "allow_empty_referer")
    ...
    @property
    @pulumi.getter(name="allowTruncateQueryString")
    def allow_truncate_query_string(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether to truncate the query string in the URL when the Referer is matched. Valid values: true, false.
        """
        return pulumi.get(self, "allow_truncate_query_string")
    ...
    @property
    @pulumi.getter(name="refererBlacklists")
    def referer_blacklists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The container that holds the Referer blacklist.
        """
        return pulumi.get(self, "referer_blacklists")
    ...
    @property
    @pulumi.getter(name="refererLists")
    def referer_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The container that holds the Referer whitelist.
        """
        return pulumi.get(self, "referer_lists")
    ...
    @property
    @pulumi.getter(name="truncatePath")
    def truncate_path(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to truncate the path and parts that follow the path in the URL when the Referer is matched. Valid values: true, false. If TruncatePath is set to true, the value of AllowTruncateQueryString must be also true because the query string follows the path component. When the path is truncated, the query string is also truncated.
        """
        return pulumi.get(self, "truncate_path")
