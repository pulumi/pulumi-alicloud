...
class BucketServerSideEncryptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] sse_algorithm: The server-side encryption method. Valid Values: KMS, AES256.
        :param pulumi.Input[builtins.str] kms_data_encryption: The algorithm used to encrypt objects. If this element is not specified, objects are encrypted by using AES256. This element is valid only when the value of SSEAlgorithm is set to KMS.
        :param pulumi.Input[builtins.str] kms_master_key_id: The CMK ID that must be specified when SSEAlgorithm is set to KMS and a specified CMK is used for encryption. In other cases, this element must be set to null.
        """
...
class BucketServerSideEncryption(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            kms_data_encryption: Optional[pulumi.Input[builtins.str]] = None,
            kms_master_key_id: Optional[pulumi.Input[builtins.str]] = None,
            sse_algorithm: Optional[pulumi.Input[builtins.str]] = None) -> 'BucketServerSideEncryption':
        """
    ...
    @property
    @pulumi.getter(name="kmsDataEncryption")
    def kms_data_encryption(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The algorithm used to encrypt objects. If this element is not specified, objects are encrypted by using AES256. This element is valid only when the value of SSEAlgorithm is set to KMS.
        """
        return pulumi.get(self, "kms_data_encryption")
