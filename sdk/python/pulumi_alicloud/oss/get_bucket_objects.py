...
class GetBucketObjectsResult:
    ...
    def key_regex(self) -> Optional[builtins.str]:
...
def get_bucket_objects(bucket_name: Optional[builtins.str] = None,
                       key_prefix: Optional[builtins.str] = None,
                       key_regex: Optional[builtins.str] = None,
    ...
    :param builtins.str bucket_name: Name of the bucket that contains the objects to find.
    :param builtins.str key_prefix: Filter results by the given key prefix (such as "path/to/folder/logs-").
    :param builtins.str key_regex: A regex string to filter results by key.
...
def get_bucket_objects_output(bucket_name: Optional[pulumi.Input[builtins.str]] = None,
                              key_prefix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              key_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
