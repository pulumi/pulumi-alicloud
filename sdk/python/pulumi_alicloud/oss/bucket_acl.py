...
class BucketAclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] acl: Bucket-level Access Control List (ACL)，Valid values: `private`, `public-read`, `public-read-write`.
        :param pulumi.Input[builtins.str] bucket: The name of the bucket to which the current ACL configuration belongs.
        """
...
class BucketAcl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            acl: Optional[pulumi.Input[builtins.str]] = None,
            bucket: Optional[pulumi.Input[builtins.str]] = None) -> 'BucketAcl':
        """
