...
class BucketReplicationArgs:
    def __init__(__self__, *,
                 ...
                 historical_object_replication: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 sync_role: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] action: The operations that can be synchronized to the destination bucket. You can set action to one or more of the following operation types. Valid values: `ALL`(contains PUT, DELETE, and ABORT), `PUT`, `DELETE` and `ABORT`. Defaults to `ALL`.
        ...
        :param pulumi.Input[builtins.str] historical_object_replication: Specifies whether to replicate historical data from the source bucket to the destination bucket before data replication is enabled. Can be `enabled` or `disabled`. Defaults to `enabled`.
        ...
        :param pulumi.Input[builtins.str] sync_role: Specifies the role that you authorize OSS to use to replicate data. If SSE-KMS is specified to encrypt the objects replicated to the destination bucket, it must be specified.
        """
    ...
    def historical_object_replication(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def historical_object_replication(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sync_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sync_role.setter
    def sync_role(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BucketReplicationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['BucketReplicationPrefixSetArgs'] prefix_set: The prefixes used to specify the object to replicate. Only objects that match the prefix are replicated to the destination bucket. See `prefix_set` below.
        :param pulumi.Input['BucketReplicationProgressArgs'] progress: Specifies the progress for querying the progress of a data replication task of a bucket.
        :param pulumi.Input[builtins.str] rule_id: The ID of the data replication rule.
        :param pulumi.Input['BucketReplicationSourceSelectionCriteriaArgs'] source_selection_criteria: Specifies other conditions used to filter the source objects to replicate. See `source_selection_criteria` below.
...
class BucketReplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_selection_criteria: Optional[pulumi.Input[Union['BucketReplicationSourceSelectionCriteriaArgs', 'BucketReplicationSourceSelectionCriteriaArgsDict']]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            sync_role: Optional[pulumi.Input[builtins.str]] = None) -> 'BucketReplication':
        """
    ...
    @property
    @pulumi.getter(name="historicalObjectReplication")
    def historical_object_replication(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether to replicate historical data from the source bucket to the destination bucket before data replication is enabled. Can be `enabled` or `disabled`. Defaults to `enabled`.
        """
        return pulumi.get(self, "historical_object_replication")
    ...
    @property
    @pulumi.getter(name="syncRole")
    def sync_role(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the role that you authorize OSS to use to replicate data. If SSE-KMS is specified to encrypt the objects replicated to the destination bucket, it must be specified.
        """
        return pulumi.get(self, "sync_role")
