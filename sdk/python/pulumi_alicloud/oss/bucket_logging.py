...
class BucketLoggingInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] target_bucket: The bucket that stores access logs.
        :param pulumi.Input[builtins.str] target_prefix: The prefix of the saved log objects. This element can be left empty.
        """
