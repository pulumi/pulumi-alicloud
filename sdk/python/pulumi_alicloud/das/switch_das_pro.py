...
class SwitchDasProArgs:
    def __init__(__self__, *,
                 ...
                 sql_retention: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] sql_retention: The storage duration of SQL Explorer data. Valid values: `30`, `180`, `365`, `1095`, `1825`. Unit: days. Default value: `30`.
        :param pulumi.Input[builtins.str] user_id: The ID of the Alibaba Cloud account that is used to create the database instance.
        """
    ...
    def sql_retention(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def sql_retention(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _SwitchDasProState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The ID of the database instance.
        :param pulumi.Input[builtins.int] sql_retention: The storage duration of SQL Explorer data. Valid values: `30`, `180`, `365`, `1095`, `1825`. Unit: days. Default value: `30`.
        :param pulumi.Input[builtins.bool] status: Whether the database instance has DAS professional.
        :param pulumi.Input[builtins.str] user_id: The ID of the Alibaba Cloud account that is used to create the database instance.
        """
...
class SwitchDasPro(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sql_retention: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.bool]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SwitchDasPro':
        """
    ...
    @property
    @pulumi.getter(name="sqlRetention")
    def sql_retention(self) -> pulumi.Output[builtins.int]:
        """
        The storage duration of SQL Explorer data. Valid values: `30`, `180`, `365`, `1095`, `1825`. Unit: days. Default value: `30`.
        """
        return pulumi.get(self, "sql_retention")
