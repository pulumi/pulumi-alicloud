...
def get_aggregate_compliance_packs(aggregator_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Aggregate Compliance Pack IDs.
    :param builtins.str name_regex: A regex string to filter results by Aggregate Compliance Pack name.
...
def get_aggregate_compliance_packs_output(aggregator_id: Optional[pulumi.Input[builtins.str]] = None,
