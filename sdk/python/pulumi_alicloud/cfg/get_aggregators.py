...
def get_aggregators(enable_details: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of aggregator ids.
    :param _builtins.str name_regex: A regex string to filter results by aggregator name.
...
def get_aggregators_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
