...
def get_aggregators(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of aggregator ids.
    :param builtins.str name_regex: A regex string to filter results by aggregator name.
...
def get_aggregators_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                           ...
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAggregatorsResult]:
    """
    This data source provides the Config Aggregators of the current Alibaba Cloud user.
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:cfg/getAggregators:getAggregators', __args__, opts=opts, typ=GetAggregatorsResult)
    return __ret__.apply(lambda __response__: GetAggregatorsResult(
