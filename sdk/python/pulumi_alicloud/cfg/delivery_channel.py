...
class DeliveryChannelArgs:
    def __init__(__self__, *,
                 delivery_channel_assume_role_arn: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] delivery_channel_assume_role_arn: The Alibaba Cloud Resource Name (ARN) of the role to be assumed by the delivery method.
        :param pulumi.Input[builtins.str] delivery_channel_target_arn: The ARN of the delivery destination. This parameter is required when you create a delivery method. The value must be in one of the following formats:
               - `acs:oss:{RegionId}:{Aliuid}:{bucketName}`: if your delivery destination is an Object Storage Service (OSS) bucket.
               - `acs:mns:{RegionId}:{Aliuid}:/topics/{topicName}`: if your delivery destination is a Message Service (MNS) topic.
               - `acs:log:{RegionId}:{Aliuid}:project/{projectName}/logstore/{logstoreName}`: if your delivery destination is a Log Service Logstore.
        :param pulumi.Input[builtins.str] delivery_channel_type: The type of the delivery method. This parameter is required when you create a delivery method. Valid values: `OSS`: Object Storage, `MNS`: Message Service, `SLS`: Log Service.
        :param pulumi.Input[builtins.str] delivery_channel_condition: The rule attached to the delivery method. This parameter is applicable only to delivery methods of the MNS type. Please refer to api [PutDeliveryChannel](https://www.alibabacloud.com/help/en/doc-detail/174253.htm) for example format.
        ...
        :param pulumi.Input[builtins.int] status: The status of the delivery method. Valid values: `0`: The delivery method is disabled., `1`: The delivery destination is enabled. This is the default value.
        """
    ...
    def delivery_channel_assume_role_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def delivery_channel_assume_role_arn(self, value: pulumi.Input[builtins.str]):
...
class _DeliveryChannelState:
    def __init__(__self__, *,
                 delivery_channel_assume_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 delivery_channel_condition: Optional[pulumi.Input[builtins.str]] = None,
                 delivery_channel_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="deliveryChannelAssumeRoleArn")
    def delivery_channel_assume_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Alibaba Cloud Resource Name (ARN) of the role to be assumed by the delivery method.
        """
        return pulumi.get(self, "delivery_channel_assume_role_arn")
    ...
    @delivery_channel_assume_role_arn.setter
    def delivery_channel_assume_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delivery_channel_assume_role_arn", value)
...
class DeliveryChannel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            delivery_channel_type: Optional[pulumi.Input[builtins.str]] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.int]] = None) -> 'DeliveryChannel':
        """
    ...
    @property
    @pulumi.getter(name="deliveryChannelAssumeRoleArn")
    def delivery_channel_assume_role_arn(self) -> pulumi.Output[builtins.str]:
        """
        The Alibaba Cloud Resource Name (ARN) of the role to be assumed by the delivery method.
        """
        return pulumi.get(self, "delivery_channel_assume_role_arn")
    ...
    @property
    @pulumi.getter(name="deliveryChannelCondition")
    def delivery_channel_condition(self) -> pulumi.Output[builtins.str]:
        """
        The rule attached to the delivery method. This parameter is applicable only to delivery methods of the MNS type. Please refer to api [PutDeliveryChannel](https://www.alibabacloud.com/help/en/doc-detail/174253.htm) for example format.
        """
        return pulumi.get(self, "delivery_channel_condition")
    ...
    @property
    @pulumi.getter(name="deliveryChannelName")
    def delivery_channel_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the delivery channel.
        """
        return pulumi.get(self, "delivery_channel_name")
