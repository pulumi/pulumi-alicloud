...
class AggregatorArgs:
    def __init__(__self__, *,
                 aggregator_name: pulumi.Input[builtins.str],
                 description: pulumi.Input[builtins.str],
                 aggregator_accounts: Optional[pulumi.Input[Sequence[pulumi.Input['AggregatorAggregatorAccountArgs']]]] = None,
                 aggregator_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Aggregator resource.
        :param pulumi.Input[builtins.str] aggregator_name: The name of aggregator.
        :param pulumi.Input[builtins.str] description: The description of aggregator.
        ...
        :param pulumi.Input[builtins.str] aggregator_type: The type of aggregator. Valid values: `CUSTOM`, `RD`. The Default value: `CUSTOM`.
    ...
    def aggregator_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def aggregator_name(self, value: pulumi.Input[builtins.str]):
    ...
    def aggregator_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def aggregator_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AggregatorState:
    def __init__(__self__, *,
                 aggregator_accounts: Optional[pulumi.Input[Sequence[pulumi.Input['AggregatorAggregatorAccountArgs']]]] = None,
                 aggregator_name: Optional[pulumi.Input[builtins.str]] = None,
                 aggregator_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] aggregator_type: The type of aggregator. Valid values: `CUSTOM`, `RD`. The Default value: `CUSTOM`.
               ...
               * `RD` - The global account group.
        :param pulumi.Input[builtins.str] description: The description of aggregator.
        :param pulumi.Input[builtins.str] status: The status of the resource. Valid values: `0`: creating `1`: normal `2`: deleting.
        """
        if aggregator_accounts is not None:
            pulumi.set(__self__, "aggregator_accounts", aggregator_accounts)
    ...
    @property
    @pulumi.getter(name="aggregatorName")
    def aggregator_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of aggregator.
        """
        return pulumi.get(self, "aggregator_name")
    ...
    @aggregator_name.setter
    def aggregator_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aggregator_name", value)
...
class Aggregator(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            aggregator_type: Optional[pulumi.Input[builtins.str]] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'Aggregator':
        """
    ...
    @property
    @pulumi.getter(name="aggregatorName")
    def aggregator_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of aggregator.
        """
        return pulumi.get(self, "aggregator_name")
    ...
    @property
    @pulumi.getter(name="aggregatorType")
    def aggregator_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of aggregator. Valid values: `CUSTOM`, `RD`. The Default value: `CUSTOM`.
        * `CUSTOM` - The custom account group.
        * `RD` - The global account group.
