...
def get_deliveries(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Delivery IDs.
...
def get_deliveries_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
