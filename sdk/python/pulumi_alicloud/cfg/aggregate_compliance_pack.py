...
class AggregateCompliancePackArgs:
    def __init__(__self__, *,
                 aggregate_compliance_pack_name: pulumi.Input[builtins.str],
                 aggregator_id: pulumi.Input[builtins.str],
                 description: pulumi.Input[builtins.str],
                 risk_level: pulumi.Input[builtins.int],
                 compliance_pack_template_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] aggregate_compliance_pack_name: The name of compliance package name. **NOTE:** From version 1.145.0, `aggregate_compliance_pack_name` can be modified.
        :param pulumi.Input[builtins.str] aggregator_id: The ID of aggregator.
        :param pulumi.Input[builtins.str] description: The description of compliance package.
        :param pulumi.Input[builtins.int] risk_level: The Risk Level. Valid values:
        :param pulumi.Input[builtins.str] compliance_pack_template_id: The Template ID of compliance package.
    ...
    def aggregate_compliance_pack_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def aggregate_compliance_pack_name(self, value: pulumi.Input[builtins.str]):
    ...
    def compliance_pack_template_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def compliance_pack_template_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AggregateCompliancePackState:
    def __init__(__self__, *,
                 aggregate_compliance_pack_name: Optional[pulumi.Input[builtins.str]] = None,
                 aggregator_compliance_pack_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] aggregate_compliance_pack_name: The name of compliance package name. **NOTE:** From version 1.145.0, `aggregate_compliance_pack_name` can be modified.
        :param pulumi.Input[builtins.str] aggregator_compliance_pack_id: The ID of the compliance package.
        :param pulumi.Input[builtins.str] aggregator_id: The ID of aggregator.
        :param pulumi.Input[builtins.str] compliance_pack_template_id: The Template ID of compliance package.
        :param pulumi.Input[Sequence[pulumi.Input['AggregateCompliancePackConfigRuleIdArgs']]] config_rule_ids: A list of Config Rule IDs. See `config_rule_ids` below.
        :param pulumi.Input[Sequence[pulumi.Input['AggregateCompliancePackConfigRuleArgs']]] config_rules: A list of Config Rules. See `config_rules` below. **NOTE:** Field `config_rules` has been deprecated from provider version 1.141.0. New field `config_rule_ids` instead.
        :param pulumi.Input[builtins.str] description: The description of compliance package.
        :param pulumi.Input[builtins.int] risk_level: The Risk Level. Valid values:
        :param pulumi.Input[builtins.str] status: The status of the Aggregate Compliance Pack.
        """
    ...
    @property
    @pulumi.getter(name="aggregateCompliancePackName")
    def aggregate_compliance_pack_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of compliance package name. **NOTE:** From version 1.145.0, `aggregate_compliance_pack_name` can be modified.
        """
        return pulumi.get(self, "aggregate_compliance_pack_name")
    ...
    @aggregate_compliance_pack_name.setter
    def aggregate_compliance_pack_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aggregate_compliance_pack_name", value)

    @property
    @pulumi.getter(name="aggregatorCompliancePackId")
    def aggregator_compliance_pack_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def aggregator_compliance_pack_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AggregateCompliancePack(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 aggregator_id: Optional[pulumi.Input[builtins.str]] = None,
                 compliance_pack_template_id: Optional[pulumi.Input[builtins.str]] = None,
                 config_rule_ids: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AggregateCompliancePackConfigRuleIdArgs', 'AggregateCompliancePackConfigRuleIdArgsDict']]]]] = None,
                 config_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AggregateCompliancePackConfigRuleArgs', 'AggregateCompliancePackConfigRuleArgsDict']]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 risk_level: Optional[pulumi.Input[builtins.int]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            risk_level: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'AggregateCompliancePack':
        """
    ...
    @property
    @pulumi.getter(name="aggregateCompliancePackName")
    def aggregate_compliance_pack_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of compliance package name. **NOTE:** From version 1.145.0, `aggregate_compliance_pack_name` can be modified.
        """
        return pulumi.get(self, "aggregate_compliance_pack_name")
    ...
    @property
    @pulumi.getter(name="aggregatorCompliancePackId")
    def aggregator_compliance_pack_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the compliance package.
        """
        return pulumi.get(self, "aggregator_compliance_pack_id")
    ...
    @property
    @pulumi.getter(name="compliancePackTemplateId")
    def compliance_pack_template_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Template ID of compliance package.
        """
        return pulumi.get(self, "compliance_pack_template_id")
