...
class DeliveryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the delivery channel.
        ...
        :param pulumi.Input[builtins.str] oversized_data_oss_target_arn: The oss ARN of the delivery channel when the value data oversized limit.  The value must be in one of the following formats:  acs:oss:{RegionId}:{Aliuid}:{bucketName} if your delivery destination is an Object Storage Service (OSS) bucket.
        :param pulumi.Input[builtins.int] status: The status of the delivery channel. Valid values:  
...
class Delivery(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            non_compliant_notification: Optional[pulumi.Input[builtins.bool]] = None,
            oversized_data_oss_target_arn: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.int]] = None) -> 'Delivery':
        """
