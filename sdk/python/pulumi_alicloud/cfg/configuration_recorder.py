...
class ConfigurationRecorderArgs:
    def __init__(__self__, *,
                 enterprise_edition: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] enterprise_edition: Whether to use the enterprise version configuration audit. Valid values: `true` and `false`. Default value `false`. For enterprise accounts, We recommend you to use the resource alicloud_config_aggregator.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_types: A list of resource types to be monitored. [Resource types that support Cloud Config.](https://www.alibabacloud.com/help/en/doc-detail/127411.htm)
    ...
    def enterprise_edition(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enterprise_edition(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ConfigurationRecorderState:
    def __init__(__self__, *,
                 enterprise_edition: Optional[pulumi.Input[builtins.bool]] = None,
                 organization_enable_status: Optional[pulumi.Input[builtins.str]] = None,
                 organization_master_id: Optional[pulumi.Input[builtins.int]] = None,
                 resource_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering ConfigurationRecorder resources.
        :param pulumi.Input[builtins.bool] enterprise_edition: Whether to use the enterprise version configuration audit. Valid values: `true` and `false`. Default value `false`. For enterprise accounts, We recommend you to use the resource alicloud_config_aggregator.
        :param pulumi.Input[builtins.str] organization_enable_status: Enterprise version configuration audit enabled status. Values: `REGISTRABLE`: Not enabled, `BUILDING`: Building and `REGISTERED`: Enabled.
        :param pulumi.Input[builtins.int] organization_master_id: The ID of the Enterprise management account.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_types: A list of resource types to be monitored. [Resource types that support Cloud Config.](https://www.alibabacloud.com/help/en/doc-detail/127411.htm)
               * If you use an ordinary account, the `resource_types` supports the update operation after the process of creation is completed.
               * If you use an enterprise account, the `resource_types` does not support updating.
        :param pulumi.Input[builtins.str] status: Status of resource monitoring. Values: `REGISTRABLE`: Not registered, `BUILDING`: Under construction, `REGISTERED`: Registered and `REBUILDING`: Rebuilding.
        """
        if enterprise_edition is not None:
            pulumi.set(__self__, "enterprise_edition", enterprise_edition)
    ...
    def organization_enable_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def organization_enable_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "organization_enable_status", value)

    @property
    @pulumi.getter(name="organizationMasterId")
    def organization_master_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def organization_master_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ConfigurationRecorder(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            organization_master_id: Optional[pulumi.Input[builtins.int]] = None,
            resource_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ConfigurationRecorder':
        """
    ...
    @property
    @pulumi.getter(name="enterpriseEdition")
    def enterprise_edition(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to use the enterprise version configuration audit. Valid values: `true` and `false`. Default value `false`. For enterprise accounts, We recommend you to use the resource alicloud_config_aggregator.
        """
        return pulumi.get(self, "enterprise_edition")
    ...
    @property
    @pulumi.getter(name="organizationEnableStatus")
    def organization_enable_status(self) -> pulumi.Output[builtins.str]:
        """
        Enterprise version configuration audit enabled status. Values: `REGISTRABLE`: Not enabled, `BUILDING`: Building and `REGISTERED`: Enabled.
        """
        return pulumi.get(self, "organization_enable_status")
    ...
    @property
    @pulumi.getter(name="organizationMasterId")
    def organization_master_id(self) -> pulumi.Output[builtins.int]:
        """
        The ID of the Enterprise management account.
        """
        return pulumi.get(self, "organization_master_id")
