...
class RemediationArgs:
    def __init__(__self__, *,
                 config_rule_id: pulumi.Input[builtins.str],
                 invoke_type: pulumi.Input[builtins.str],
                 params: pulumi.Input[builtins.str],
                 remediation_template_id: pulumi.Input[builtins.str],
                 remediation_type: pulumi.Input[builtins.str],
                 remediation_source_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Remediation resource.
        :param pulumi.Input[builtins.str] config_rule_id: Rule ID.
        :param pulumi.Input[builtins.str] invoke_type: Execution type, valid values: `Manual`, `Automatic`.
        :param pulumi.Input[builtins.str] params: Remediation parameter.
        :param pulumi.Input[builtins.str] remediation_template_id: Remediation template ID.
        :param pulumi.Input[builtins.str] remediation_type: Remediation type, valid values: `OOS`, `FC`.
               
               The following arguments will be discarded. Please use new fields as soon as possible:
        :param pulumi.Input[builtins.str] remediation_source_type: Remediation resource type, valid values: `ALIYUN` , `CUSTOMER`.
        """
    ...
    def config_rule_id(self) -> pulumi.Input[builtins.str]:
        """
        Rule ID.
        """
    ...
    def config_rule_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "config_rule_id", value)

    @property
    @pulumi.getter(name="invokeType")
    def invoke_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @invoke_type.setter
    def invoke_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "invoke_type", value)

    @property
    @pulumi.getter
    def params(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @params.setter
    def params(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "params", value)

    @property
    @pulumi.getter(name="remediationTemplateId")
    def remediation_template_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def remediation_template_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "remediation_template_id", value)

    @property
    @pulumi.getter(name="remediationType")
    def remediation_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def remediation_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "remediation_type", value)

    @property
    @pulumi.getter(name="remediationSourceType")
    def remediation_source_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def remediation_source_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RemediationState:
    def __init__(__self__, *,
                 ...
                 invoke_type: Optional[pulumi.Input[builtins.str]] = None,
                 params: Optional[pulumi.Input[builtins.str]] = None,
                 remediation_id: Optional[pulumi.Input[builtins.str]] = None,
                 remediation_source_type: Optional[pulumi.Input[builtins.str]] = None,
                 remediation_template_id: Optional[pulumi.Input[builtins.str]] = None,
                 remediation_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Remediation resources.
        :param pulumi.Input[builtins.str] config_rule_id: Rule ID.
        :param pulumi.Input[builtins.str] invoke_type: Execution type, valid values: `Manual`, `Automatic`.
        :param pulumi.Input[builtins.str] params: Remediation parameter.
        :param pulumi.Input[builtins.str] remediation_id: Remediation ID.
        :param pulumi.Input[builtins.str] remediation_source_type: Remediation resource type, valid values: `ALIYUN` , `CUSTOMER`.
        :param pulumi.Input[builtins.str] remediation_template_id: Remediation template ID.
        :param pulumi.Input[builtins.str] remediation_type: Remediation type, valid values: `OOS`, `FC`.
    ...
    @property
    @pulumi.getter(name="invokeType")
    def invoke_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Execution type, valid values: `Manual`, `Automatic`.
        """
        return pulumi.get(self, "invoke_type")
    ...
    @invoke_type.setter
    def invoke_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "invoke_type", value)
    ...
    def remediation_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Remediation ID.
        """
    ...
    def remediation_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="remediationTemplateId")
    def remediation_template_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Remediation template ID.
        """
        return pulumi.get(self, "remediation_template_id")
    ...
    @remediation_template_id.setter
    def remediation_template_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "remediation_template_id", value)

    @property
    @pulumi.getter(name="remediationType")
    def remediation_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Remediation type, valid values: `OOS`, `FC`.
    ...
    @remediation_type.setter
    def remediation_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "remediation_type", value)
...
class Remediation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            remediation_source_type: Optional[pulumi.Input[builtins.str]] = None,
            remediation_template_id: Optional[pulumi.Input[builtins.str]] = None,
            remediation_type: Optional[pulumi.Input[builtins.str]] = None) -> 'Remediation':
        """
    ...
    @property
    @pulumi.getter(name="invokeType")
    def invoke_type(self) -> pulumi.Output[builtins.str]:
        """
        Execution type, valid values: `Manual`, `Automatic`.
        """
        return pulumi.get(self, "invoke_type")
    ...
    @property
    @pulumi.getter
    def params(self) -> pulumi.Output[builtins.str]:
        """
        Remediation parameter.
        """
        return pulumi.get(self, "params")
    ...
    @property
    @pulumi.getter(name="remediationId")
    def remediation_id(self) -> pulumi.Output[builtins.str]:
        """
        Remediation ID.
        """
        return pulumi.get(self, "remediation_id")
    ...
    @property
    @pulumi.getter(name="remediationSourceType")
    def remediation_source_type(self) -> pulumi.Output[builtins.str]:
        """
        Remediation resource type, valid values: `ALIYUN` , `CUSTOMER`.
        """
        return pulumi.get(self, "remediation_source_type")
    ...
    @property
    @pulumi.getter(name="remediationTemplateId")
    def remediation_template_id(self) -> pulumi.Output[builtins.str]:
        """
        Remediation template ID.
        """
        return pulumi.get(self, "remediation_template_id")
    ...
    @property
    @pulumi.getter(name="remediationType")
    def remediation_type(self) -> pulumi.Output[builtins.str]:
        """
        Remediation type, valid values: `OOS`, `FC`.
