...
class CompliancePackArgs:
    def __init__(__self__, *,
                 compliance_pack_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] compliance_pack_name: The Compliance Package Name. **NOTE:** From version 1.146.0, `compliance_pack_name` can be modified.
        :param pulumi.Input[builtins.str] description: The Description of compliance pack.
        :param pulumi.Input[builtins.int] risk_level: The Risk Level. Valid values:
        :param pulumi.Input[builtins.str] compliance_pack_template_id: Compliance Package Template Id.
    ...
    def compliance_pack_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def compliance_pack_name(self, value: pulumi.Input[builtins.str]):
...
class _CompliancePackState:
    def __init__(__self__, *,
                 compliance_pack_name: Optional[pulumi.Input[builtins.str]] = None,
                 compliance_pack_template_id: Optional[pulumi.Input[builtins.str]] = None,
                 config_rule_ids: Optional[pulumi.Input[Sequence[pulumi.Input['CompliancePackConfigRuleIdArgs']]]] = None,
                 config_rules: Optional[pulumi.Input[Sequence[pulumi.Input['CompliancePackConfigRuleArgs']]]] = None,
        ...
        :param pulumi.Input[builtins.str] description: The Description of compliance pack.
        :param pulumi.Input[builtins.int] risk_level: The Risk Level. Valid values:
        :param pulumi.Input[builtins.str] status: The status of the Compliance Pack.
        """
    ...
    @property
    @pulumi.getter(name="compliancePackName")
    def compliance_pack_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Compliance Package Name. **NOTE:** From version 1.146.0, `compliance_pack_name` can be modified.
        """
        return pulumi.get(self, "compliance_pack_name")
    ...
    @compliance_pack_name.setter
    def compliance_pack_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "compliance_pack_name", value)
...
@pulumi.type_token("alicloud:cfg/compliancePack:CompliancePack")
class CompliancePack(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            risk_level: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'CompliancePack':
        """
    ...
    @property
    @pulumi.getter(name="compliancePackName")
    def compliance_pack_name(self) -> pulumi.Output[builtins.str]:
        """
        The Compliance Package Name. **NOTE:** From version 1.146.0, `compliance_pack_name` can be modified.
        """
        return pulumi.get(self, "compliance_pack_name")
