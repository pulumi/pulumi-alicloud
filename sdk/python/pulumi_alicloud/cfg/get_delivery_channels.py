...
def get_delivery_channels(ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Config Delivery Channel IDs.
    :param builtins.str name_regex: A regex string to filter results by delivery channel name.
...
def get_delivery_channels_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
