...
class GetRulesResult:
    ...
    def config_rule_state(self) -> Optional[_builtins.str]:
        """
...
def get_rules(config_rule_state: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Config Rule IDs.
...
def get_rules_output(config_rule_state: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
