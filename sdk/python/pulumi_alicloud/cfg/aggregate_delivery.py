...
class AggregateDeliveryArgs:
    def __init__(__self__, *,
                 ...
                 delivery_channel_target_arn: pulumi.Input[builtins.str],
                 delivery_channel_type: pulumi.Input[builtins.str],
                 configuration_item_change_notification: Optional[pulumi.Input[builtins.bool]] = None,
                 configuration_snapshot: Optional[pulumi.Input[builtins.bool]] = None,
                 delivery_channel_condition: Optional[pulumi.Input[builtins.str]] = None,
                 delivery_channel_name: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 non_compliant_notification: Optional[pulumi.Input[builtins.bool]] = None,
                 oversized_data_oss_target_arn: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a AggregateDelivery resource.
        :param pulumi.Input[builtins.str] aggregator_id: Aggregator ID.
        :param pulumi.Input[builtins.str] delivery_channel_target_arn: The ARN of the delivery destination.  
               - If the value of the DeliveryChannelType parameter is OSS, the value of this parameter is the ARN of the destination OSS bucket.
               - If the value of the DeliveryChannelType parameter is MNS, the value of this parameter is the ARN of the destination MNS topic.
               - If the value of the DeliveryChannelType parameter is SLS, the value of this parameter is the ARN of the destination Log Service Logstore.
        :param pulumi.Input[builtins.str] delivery_channel_type: The type of the delivery channel. Valid values:
               - OSS: Object Storage Service (OSS)
               - MNS: Message Service (MNS)
               - SLS: Log Service
        :param pulumi.Input[builtins.bool] configuration_item_change_notification: Indicates whether the specified destination receives resource change logs. If the value of this parameter is true, Cloud Config delivers the resource change logs to OSS, Log Service, or MNS when the configurations of the resources change. Valid values:  
               - true: The specified destination receives resource change logs.
               - false: The specified destination does not receive resource change logs.
        :param pulumi.Input[builtins.bool] configuration_snapshot: Indicates whether the specified destination receives scheduled resource snapshots. Cloud Config delivers scheduled resource snapshots at 04:00Z and 16:00Z to OSS, MNS, or Log Service every day. The time is displayed in UTC. Valid values:  
               - true: The specified destination receives scheduled resource snapshots.
               - false: The specified destination does not receive scheduled resource snapshots.
        :param pulumi.Input[builtins.str] delivery_channel_condition: The rule that is attached to the delivery channel.   
        ...
        :param pulumi.Input[builtins.str] delivery_channel_name: The name of the delivery channel.
        :param pulumi.Input[builtins.str] description: The description of the delivery method.
        :param pulumi.Input[builtins.bool] non_compliant_notification: Indicates whether the specified destination receives resource non-compliance events. If the value of this parameter is true, Cloud Config delivers resource non-compliance events to Log Service or MNS when resources are evaluated as non-compliant. Valid values:  
               - true: The specified destination receives resource non-compliance events.
               - false: The specified destination does not receive resource non-compliance events.
        :param pulumi.Input[builtins.str] oversized_data_oss_target_arn: The ARN of the OSS bucket to which the delivered data is transferred when the size of the data exceeds the specified upper limit of the delivery channel.
        :param pulumi.Input[builtins.int] status: The status of the delivery method. Valid values:   
    ...
    def delivery_channel_target_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def delivery_channel_target_arn(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "delivery_channel_target_arn", value)

    @property
    @pulumi.getter(name="deliveryChannelType")
    def delivery_channel_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def delivery_channel_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "delivery_channel_type", value)

    @property
    @pulumi.getter(name="configurationItemChangeNotification")
    def configuration_item_change_notification(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def configuration_item_change_notification(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "configuration_item_change_notification", value)

    @property
    @pulumi.getter(name="configurationSnapshot")
    def configuration_snapshot(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def configuration_snapshot(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "configuration_snapshot", value)

    @property
    @pulumi.getter(name="deliveryChannelCondition")
    def delivery_channel_condition(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def delivery_channel_condition(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delivery_channel_condition", value)

    @property
    @pulumi.getter(name="deliveryChannelName")
    def delivery_channel_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def delivery_channel_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def non_compliant_notification(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def non_compliant_notification(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "non_compliant_notification", value)

    @property
    @pulumi.getter(name="oversizedDataOssTargetArn")
    def oversized_data_oss_target_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def oversized_data_oss_target_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AggregateDeliveryState:
    def __init__(__self__, *,
                 ...
                 configuration_snapshot: Optional[pulumi.Input[builtins.bool]] = None,
                 delivery_channel_condition: Optional[pulumi.Input[builtins.str]] = None,
                 delivery_channel_id: Optional[pulumi.Input[builtins.str]] = None,
                 delivery_channel_name: Optional[pulumi.Input[builtins.str]] = None,
                 delivery_channel_target_arn: Optional[pulumi.Input[builtins.str]] = None,
                 delivery_channel_type: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 non_compliant_notification: Optional[pulumi.Input[builtins.bool]] = None,
                 oversized_data_oss_target_arn: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.int]] = None):
        ...
        :param pulumi.Input[builtins.str] delivery_channel_condition: The rule that is attached to the delivery channel.   
               ...
               Examples:[{"filterType":"ResourceType","values":["ACS::ActionTrail::Trail","ACS::CBWP::CommonBandwidthPackage","ACS::CDN::Domain","ACS::CEN::CenBandwidthPackage","ACS::CEN::CenInstance","ACS::CEN::Flowlog","ACS::DdosCoo::Instance"],"multiple":true}].
        :param pulumi.Input[builtins.str] delivery_channel_id: The ID of the delivery method. This parameter is required when you modify a delivery method.
        :param pulumi.Input[builtins.str] delivery_channel_name: The name of the delivery channel.
        :param pulumi.Input[builtins.str] delivery_channel_target_arn: The ARN of the delivery destination.  
               - If the value of the DeliveryChannelType parameter is OSS, the value of this parameter is the ARN of the destination OSS bucket.
               - If the value of the DeliveryChannelType parameter is MNS, the value of this parameter is the ARN of the destination MNS topic.
    ...
    def delivery_channel_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def delivery_channel_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="deliveryChannelTargetArn")
    def delivery_channel_target_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the delivery destination.  
        - If the value of the DeliveryChannelType parameter is OSS, the value of this parameter is the ARN of the destination OSS bucket.
        - If the value of the DeliveryChannelType parameter is MNS, the value of this parameter is the ARN of the destination MNS topic.
    ...
    @delivery_channel_target_arn.setter
    def delivery_channel_target_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delivery_channel_target_arn", value)

    @property
    @pulumi.getter(name="deliveryChannelType")
    def delivery_channel_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the delivery channel. Valid values:
        - OSS: Object Storage Service (OSS)
        - MNS: Message Service (MNS)
    ...
    @delivery_channel_type.setter
    def delivery_channel_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delivery_channel_type", value)
...
class AggregateDelivery(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            non_compliant_notification: Optional[pulumi.Input[builtins.bool]] = None,
            oversized_data_oss_target_arn: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.int]] = None) -> 'AggregateDelivery':
        """
    ...
    @property
    @pulumi.getter(name="configurationItemChangeNotification")
    def configuration_item_change_notification(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the specified destination receives resource change logs. If the value of this parameter is true, Cloud Config delivers the resource change logs to OSS, Log Service, or MNS when the configurations of the resources change. Valid values:  
        - true: The specified destination receives resource change logs.
        - false: The specified destination does not receive resource change logs.
    ...
    @property
    @pulumi.getter(name="configurationSnapshot")
    def configuration_snapshot(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the specified destination receives scheduled resource snapshots. Cloud Config delivers scheduled resource snapshots at 04:00Z and 16:00Z to OSS, MNS, or Log Service every day. The time is displayed in UTC. Valid values:  
        - true: The specified destination receives scheduled resource snapshots.
        - false: The specified destination does not receive scheduled resource snapshots.
    ...
    @property
    @pulumi.getter(name="deliveryChannelCondition")
    def delivery_channel_condition(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The rule that is attached to the delivery channel.   
    ...
    @property
    @pulumi.getter(name="deliveryChannelId")
    def delivery_channel_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the delivery method. This parameter is required when you modify a delivery method.
        """
        return pulumi.get(self, "delivery_channel_id")
    ...
    @property
    @pulumi.getter(name="deliveryChannelName")
    def delivery_channel_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the delivery channel.
        """
        return pulumi.get(self, "delivery_channel_name")
    ...
    @property
    @pulumi.getter(name="deliveryChannelTargetArn")
    def delivery_channel_target_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the delivery destination.  
        - If the value of the DeliveryChannelType parameter is OSS, the value of this parameter is the ARN of the destination OSS bucket.
        - If the value of the DeliveryChannelType parameter is MNS, the value of this parameter is the ARN of the destination MNS topic.
    ...
    @property
    @pulumi.getter(name="deliveryChannelType")
    def delivery_channel_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the delivery channel. Valid values:
        - OSS: Object Storage Service (OSS)
        - MNS: Message Service (MNS)
    ...
    @property
    @pulumi.getter(name="nonCompliantNotification")
    def non_compliant_notification(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the specified destination receives resource non-compliance events. If the value of this parameter is true, Cloud Config delivers resource non-compliance events to Log Service or MNS when resources are evaluated as non-compliant. Valid values:  
        - true: The specified destination receives resource non-compliance events.
        - false: The specified destination does not receive resource non-compliance events.
    ...
    @property
    @pulumi.getter(name="oversizedDataOssTargetArn")
    def oversized_data_oss_target_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the OSS bucket to which the delivered data is transferred when the size of the data exceeds the specified upper limit of the delivery channel.
        """
        return pulumi.get(self, "oversized_data_oss_target_arn")
