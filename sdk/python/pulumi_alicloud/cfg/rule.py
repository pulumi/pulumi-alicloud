...
class RuleArgs:
    def __init__(__self__, *,
                 risk_level: pulumi.Input[builtins.int],
                 rule_name: pulumi.Input[builtins.str],
                 source_identifier: pulumi.Input[builtins.str],
                 source_owner: pulumi.Input[builtins.str],
                 config_rule_trigger_types: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 exclude_resource_ids_scope: Optional[pulumi.Input[builtins.str]] = None,
                 input_parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 maximum_execution_frequency: Optional[pulumi.Input[builtins.str]] = None,
                 region_ids_scope: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_ids_scope: Optional[pulumi.Input[builtins.str]] = None,
                 resource_types_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 scope_compliance_resource_types: Optional[pulumi.Input[builtins.str]] = None,
                 source_detail_message_type: Optional[pulumi.Input[builtins.str]] = None,
                 source_maximum_execution_frequency: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] risk_level: The risk level of the resources that are not compliant with the rule. Valid values:  `1`: critical `2`: warning `3`: info
        :param pulumi.Input[builtins.str] rule_name: The name of the rule.
        :param pulumi.Input[builtins.str] source_identifier: The identifier of the rule.  For a managed rule, the value is the name of the managed rule. For a custom rule, the value is the ARN of the custom rule.
        :param pulumi.Input[builtins.str] source_owner: Specifies whether you or Alibaba Cloud owns and manages the rule. Valid values:  `CUSTOM_FC`: The rule is a custom rule and you own the rule. `ALIYUN`: The rule is a managed rule and Alibaba Cloud owns the rule
        :param pulumi.Input[builtins.str] config_rule_trigger_types: The trigger type of the rule. Valid values:  `ConfigurationItemChangeNotification`: The rule is triggered upon configuration changes. `ScheduledNotification`: The rule is triggered as scheduled.
        :param pulumi.Input[builtins.str] description: The description of the rule.
        :param pulumi.Input[builtins.str] exclude_resource_ids_scope: The rule monitors excluded resource IDs, multiple of which are separated by commas, only applies to rules created based on managed rules, , custom rule this field is empty.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] input_parameters: The settings of the input parameters for the rule.
        :param pulumi.Input[builtins.str] maximum_execution_frequency: The frequency of the compliance evaluations, it is required if the ConfigRuleTriggerTypes value is ScheduledNotification. Valid values:  `One_Hour`, `Three_Hours`, `Six_Hours`, `Twelve_Hours`, `TwentyFour_Hours`.
        :param pulumi.Input[builtins.str] region_ids_scope: The rule monitors region IDs, separated by commas, only applies to rules created based on managed rules.
        :param pulumi.Input[builtins.str] resource_group_ids_scope: The rule monitors resource group IDs, separated by commas, only applies to rules created based on managed rules.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_types_scopes: The types of the resources to be evaluated against the rule.
        :param pulumi.Input[builtins.str] scope_compliance_resource_types: Field 'scope_compliance_resource_types' has been deprecated from provider version 1.124.1. New field 'resource_types_scope' instead.
        :param pulumi.Input[builtins.str] source_detail_message_type: Field 'source_detail_message_type' has been deprecated from provider version 1.124.1. New field 'config_rule_trigger_types' instead.
        :param pulumi.Input[builtins.str] source_maximum_execution_frequency: Field 'source_maximum_execution_frequency' has been deprecated from provider version 1.124.1. New field 'maximum_execution_frequency' instead.
        :param pulumi.Input[builtins.str] status: The status of the rule. Valid values: ACTIVE: The rule is monitoring the configurations of target resources. DELETING_RESULTS: The compliance evaluation result returned by the rule is being deleted. EVALUATING: The rule is triggered and is evaluating whether the configurations of target resources are compliant. INACTIVE: The rule is disabled from monitoring the configurations of target resources.
        :param pulumi.Input[builtins.str] tag_key_scope: The rule monitors the tag key, only applies to rules created based on managed rules.
        :param pulumi.Input[builtins.str] tag_value_scope: The rule monitors the tag value, only applies to rules created based on managed rules.
    ...
    def risk_level(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @risk_level.setter
    def risk_level(self, value: pulumi.Input[builtins.int]):
    ...
    def source_owner(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @source_owner.setter
    def source_owner(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_owner", value)

    @property
    @pulumi.getter(name="configRuleTriggerTypes")
    def config_rule_trigger_types(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def config_rule_trigger_types(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def exclude_resource_ids_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def exclude_resource_ids_scope(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "exclude_resource_ids_scope", value)

    @property
    @pulumi.getter(name="inputParameters")
    def input_parameters(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def input_parameters(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def region_ids_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def region_ids_scope(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "region_ids_scope", value)

    @property
    @pulumi.getter(name="resourceGroupIdsScope")
    def resource_group_ids_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_group_ids_scope(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def resource_types_scopes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def scope_compliance_resource_types(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def scope_compliance_resource_types(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_detail_message_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_detail_message_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_maximum_execution_frequency(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_maximum_execution_frequency(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def tag_key_scope(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def tag_value_scope(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RuleState:
    def __init__(__self__, *,
                 ...
                 compliance_pack_id: Optional[pulumi.Input[builtins.str]] = None,
                 config_rule_arn: Optional[pulumi.Input[builtins.str]] = None,
                 config_rule_id: Optional[pulumi.Input[builtins.str]] = None,
                 config_rule_trigger_types: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 input_parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 maximum_execution_frequency: Optional[pulumi.Input[builtins.str]] = None,
                 modified_timestamp: Optional[pulumi.Input[builtins.int]] = None,
                 region_ids_scope: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_ids_scope: Optional[pulumi.Input[builtins.str]] = None,
                 resource_types_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 risk_level: Optional[pulumi.Input[builtins.int]] = None,
                 rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 scope_compliance_resource_types: Optional[pulumi.Input[builtins.str]] = None,
                 source_detail_message_type: Optional[pulumi.Input[builtins.str]] = None,
                 source_identifier: Optional[pulumi.Input[builtins.str]] = None,
                 source_maximum_execution_frequency: Optional[pulumi.Input[builtins.str]] = None,
                 source_owner: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 tag_key_scope: Optional[pulumi.Input[builtins.str]] = None,
                 tag_value_scope: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Rule resources.
        :param pulumi.Input[builtins.int] account_id: The ID of Alicloud account.
        :param pulumi.Input['RuleComplianceArgs'] compliance: compliance information.
        :param pulumi.Input[builtins.str] compliance_pack_id: Compliance Package ID.
        :param pulumi.Input[builtins.str] config_rule_arn: config rule arn.
        :param pulumi.Input[builtins.str] config_rule_id: The ID of the rule.
        :param pulumi.Input[builtins.str] config_rule_trigger_types: The trigger type of the rule. Valid values:  `ConfigurationItemChangeNotification`: The rule is triggered upon configuration changes. `ScheduledNotification`: The rule is triggered as scheduled.
        :param pulumi.Input[builtins.int] create_time: The timestamp when the rule was created.
        :param pulumi.Input[builtins.str] description: The description of the rule.
        :param pulumi.Input[builtins.str] event_source: The event source of the rule.
        :param pulumi.Input[builtins.str] exclude_resource_ids_scope: The rule monitors excluded resource IDs, multiple of which are separated by commas, only applies to rules created based on managed rules, , custom rule this field is empty.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] input_parameters: The settings of the input parameters for the rule.
        :param pulumi.Input[builtins.str] maximum_execution_frequency: The frequency of the compliance evaluations, it is required if the ConfigRuleTriggerTypes value is ScheduledNotification. Valid values:  `One_Hour`, `Three_Hours`, `Six_Hours`, `Twelve_Hours`, `TwentyFour_Hours`.
        :param pulumi.Input[builtins.int] modified_timestamp: The timestamp when the rule was last modified.
        :param pulumi.Input[builtins.str] region_ids_scope: The rule monitors region IDs, separated by commas, only applies to rules created based on managed rules.
        :param pulumi.Input[builtins.str] resource_group_ids_scope: The rule monitors resource group IDs, separated by commas, only applies to rules created based on managed rules.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_types_scopes: The types of the resources to be evaluated against the rule.
        :param pulumi.Input[builtins.int] risk_level: The risk level of the resources that are not compliant with the rule. Valid values:  `1`: critical `2`: warning `3`: info
    ...
    def compliance_pack_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def compliance_pack_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "compliance_pack_id", value)

    @property
    @pulumi.getter(name="configRuleArn")
    def config_rule_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        config rule arn.
        """
    ...
    def config_rule_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "config_rule_arn", value)

    @property
    @pulumi.getter(name="configRuleId")
    def config_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the rule.
        """
    ...
    def config_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def modified_timestamp(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def modified_timestamp(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter(name="riskLevel")
    def risk_level(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The risk level of the resources that are not compliant with the rule. Valid values:  `1`: critical `2`: warning `3`: info
        """
        return pulumi.get(self, "risk_level")
    ...
    @risk_level.setter
    def risk_level(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "risk_level", value)
    ...
    @property
    @pulumi.getter(name="sourceIdentifier")
    def source_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The identifier of the rule.  For a managed rule, the value is the name of the managed rule. For a custom rule, the value is the ARN of the custom rule.
        """
        return pulumi.get(self, "source_identifier")
    ...
    @source_identifier.setter
    def source_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_identifier", value)
    ...
    @property
    @pulumi.getter(name="sourceOwner")
    def source_owner(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies whether you or Alibaba Cloud owns and manages the rule. Valid values:  `CUSTOM_FC`: The rule is a custom rule and you own the rule. `ALIYUN`: The rule is a managed rule and Alibaba Cloud owns the rule
        """
        return pulumi.get(self, "source_owner")
    ...
    @source_owner.setter
    def source_owner(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_owner", value)
...
class Rule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tag_key_scope: Optional[pulumi.Input[builtins.str]] = None,
            tag_value_scope: Optional[pulumi.Input[builtins.str]] = None) -> 'Rule':
        """
    ...
    @property
    @pulumi.getter(name="compliancePackId")
    def compliance_pack_id(self) -> pulumi.Output[builtins.str]:
        """
        Compliance Package ID.
        """
        return pulumi.get(self, "compliance_pack_id")
    ...
    @property
    @pulumi.getter(name="configRuleArn")
    def config_rule_arn(self) -> pulumi.Output[builtins.str]:
        """
        config rule arn.
        """
        return pulumi.get(self, "config_rule_arn")
    ...
    @property
    @pulumi.getter(name="configRuleTriggerTypes")
    def config_rule_trigger_types(self) -> pulumi.Output[builtins.str]:
        """
        The trigger type of the rule. Valid values:  `ConfigurationItemChangeNotification`: The rule is triggered upon configuration changes. `ScheduledNotification`: The rule is triggered as scheduled.
        """
        return pulumi.get(self, "config_rule_trigger_types")
    ...
    @property
    @pulumi.getter(name="excludeResourceIdsScope")
    def exclude_resource_ids_scope(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The rule monitors excluded resource IDs, multiple of which are separated by commas, only applies to rules created based on managed rules, , custom rule this field is empty.
        """
        return pulumi.get(self, "exclude_resource_ids_scope")
    ...
    @property
    @pulumi.getter(name="inputParameters")
    def input_parameters(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        The settings of the input parameters for the rule.
        """
        return pulumi.get(self, "input_parameters")
    ...
    @property
    @pulumi.getter(name="maximumExecutionFrequency")
    def maximum_execution_frequency(self) -> pulumi.Output[builtins.str]:
        """
        The frequency of the compliance evaluations, it is required if the ConfigRuleTriggerTypes value is ScheduledNotification. Valid values:  `One_Hour`, `Three_Hours`, `Six_Hours`, `Twelve_Hours`, `TwentyFour_Hours`.
        """
        return pulumi.get(self, "maximum_execution_frequency")
    ...
    @property
    @pulumi.getter(name="modifiedTimestamp")
    def modified_timestamp(self) -> pulumi.Output[builtins.int]:
        """
        The timestamp when the rule was last modified.
        """
        return pulumi.get(self, "modified_timestamp")
    ...
    @property
    @pulumi.getter(name="regionIdsScope")
    def region_ids_scope(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The rule monitors region IDs, separated by commas, only applies to rules created based on managed rules.
        """
        return pulumi.get(self, "region_ids_scope")
    ...
    @property
    @pulumi.getter(name="resourceGroupIdsScope")
    def resource_group_ids_scope(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The rule monitors resource group IDs, separated by commas, only applies to rules created based on managed rules.
        """
        return pulumi.get(self, "resource_group_ids_scope")
    ...
    @property
    @pulumi.getter(name="resourceTypesScopes")
    def resource_types_scopes(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The types of the resources to be evaluated against the rule.
        """
        return pulumi.get(self, "resource_types_scopes")
    ...
    @property
    @pulumi.getter(name="riskLevel")
    def risk_level(self) -> pulumi.Output[builtins.int]:
        """
        The risk level of the resources that are not compliant with the rule. Valid values:  `1`: critical `2`: warning `3`: info
        """
        return pulumi.get(self, "risk_level")
    ...
    @pulumi.getter(name="scopeComplianceResourceTypes")
    @_utilities.deprecated("""Field 'scope_compliance_resource_types' has been deprecated from provider version 1.124.1. New field 'resource_types_scope' instead.""")
    def scope_compliance_resource_types(self) -> pulumi.Output[builtins.str]:
        """
        Field 'scope_compliance_resource_types' has been deprecated from provider version 1.124.1. New field 'resource_types_scope' instead.
        """
        return pulumi.get(self, "scope_compliance_resource_types")
    ...
    @pulumi.getter(name="sourceDetailMessageType")
    @_utilities.deprecated("""Field 'source_detail_message_type' has been deprecated from provider version 1.124.1. New field 'config_rule_trigger_types' instead.""")
    def source_detail_message_type(self) -> pulumi.Output[builtins.str]:
        """
        Field 'source_detail_message_type' has been deprecated from provider version 1.124.1. New field 'config_rule_trigger_types' instead.
        """
        return pulumi.get(self, "source_detail_message_type")
    ...
    @property
    @pulumi.getter(name="sourceIdentifier")
    def source_identifier(self) -> pulumi.Output[builtins.str]:
        """
        The identifier of the rule.  For a managed rule, the value is the name of the managed rule. For a custom rule, the value is the ARN of the custom rule.
        """
        return pulumi.get(self, "source_identifier")
    ...
    @pulumi.getter(name="sourceMaximumExecutionFrequency")
    @_utilities.deprecated("""Field 'source_maximum_execution_frequency' has been deprecated from provider version 1.124.1. New field 'maximum_execution_frequency' instead.""")
    def source_maximum_execution_frequency(self) -> pulumi.Output[builtins.str]:
        """
        Field 'source_maximum_execution_frequency' has been deprecated from provider version 1.124.1. New field 'maximum_execution_frequency' instead.
        """
        return pulumi.get(self, "source_maximum_execution_frequency")
    ...
    @property
    @pulumi.getter(name="sourceOwner")
    def source_owner(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether you or Alibaba Cloud owns and manages the rule. Valid values:  `CUSTOM_FC`: The rule is a custom rule and you own the rule. `ALIYUN`: The rule is a managed rule and Alibaba Cloud owns the rule
        """
        return pulumi.get(self, "source_owner")
