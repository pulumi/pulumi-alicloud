...
class RuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] input_parameters: The settings of the input parameters for the rule.
        :param pulumi.Input[_builtins.str] maximum_execution_frequency: The frequency of the compliance evaluations, it is required if the ConfigRuleTriggerTypes value is ScheduledNotification. Valid values:  `One_Hour`, `Three_Hours`, `Six_Hours`, `Twelve_Hours`, `TwentyFour_Hours`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] resource_types_scopes: The types of the resources to be evaluated against the rule.
        :param pulumi.Input[_builtins.str] scope_compliance_resource_types: Field 'scope_compliance_resource_types' has been deprecated from provider version 1.124.1. New field 'resource_types_scope' instead.
        :param pulumi.Input[_builtins.str] source_detail_message_type: Field 'source_detail_message_type' has been deprecated from provider version 1.124.1. New field 'config_rule_trigger_types' instead.
        :param pulumi.Input[_builtins.str] source_maximum_execution_frequency: Field 'source_maximum_execution_frequency' has been deprecated from provider version 1.124.1. New field 'maximum_execution_frequency' instead.
        :param pulumi.Input[_builtins.str] status: The status of the rule. Valid values: ACTIVE: The rule is monitoring the configurations of target resources. DELETING_RESULTS: The compliance evaluation result returned by the rule is being deleted. EVALUATING: The rule is triggered and is evaluating whether the configurations of target resources are compliant. INACTIVE: The rule is disabled from monitoring the configurations of target resources.
        ...
        :param pulumi.Input[_builtins.str] tag_value_scope: The rule monitors the tag value, only applies to rules created based on managed rules.
...
class _RuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] config_rule_arn: config rule arn.
        :param pulumi.Input[_builtins.str] config_rule_id: The ID of the rule.
        :param pulumi.Input[_builtins.str] config_rule_trigger_types: The trigger type of the rule. Valid values:  `ConfigurationItemChangeNotification`: The rule is triggered upon configuration changes. `ScheduledNotification`: The rule is triggered as scheduled.
        :param pulumi.Input[_builtins.int] create_time: The timestamp when the rule was created.
        :param pulumi.Input[_builtins.str] description: The description of the rule.
        :param pulumi.Input[_builtins.str] event_source: The event source of the rule.
        :param pulumi.Input[_builtins.str] exclude_resource_ids_scope: The rule monitors excluded resource IDs, multiple of which are separated by commas, only applies to rules created based on managed rules, , custom rule this field is empty.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] input_parameters: The settings of the input parameters for the rule.
        :param pulumi.Input[_builtins.str] maximum_execution_frequency: The frequency of the compliance evaluations, it is required if the ConfigRuleTriggerTypes value is ScheduledNotification. Valid values:  `One_Hour`, `Three_Hours`, `Six_Hours`, `Twelve_Hours`, `TwentyFour_Hours`.
        :param pulumi.Input[_builtins.int] modified_timestamp: The timestamp when the rule was last modified.
        :param pulumi.Input[_builtins.str] region_ids_scope: The rule monitors region IDs, separated by commas, only applies to rules created based on managed rules.
        :param pulumi.Input[_builtins.str] resource_group_ids_scope: The rule monitors resource group IDs, separated by commas, only applies to rules created based on managed rules.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] resource_types_scopes: The types of the resources to be evaluated against the rule.
        :param pulumi.Input[_builtins.int] risk_level: The risk level of the resources that are not compliant with the rule. Valid values:  `1`: critical `2`: warning `3`: info
...
class Rule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            account_id: pulumi.Input[Optional[_builtins.int]] = None,
            compliance: pulumi.Input[Optional[Union['RuleComplianceArgs', 'RuleComplianceArgsDict', 'outputs.RuleCompliance']]] = None,
            compliance_pack_id: pulumi.Input[Optional[_builtins.str]] = None,
            config_rule_arn: pulumi.Input[Optional[_builtins.str]] = None,
            config_rule_id: pulumi.Input[Optional[_builtins.str]] = None,
            config_rule_trigger_types: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.int] account_id: The ID of Alicloud account.
        :param pulumi.Input[Union['RuleComplianceArgs', 'RuleComplianceArgsDict', 'outputs.RuleCompliance']] compliance: compliance information.
        :param pulumi.Input[_builtins.str] compliance_pack_id: Compliance Package ID.
        :param pulumi.Input[_builtins.str] config_rule_arn: config rule arn.
        :param pulumi.Input[_builtins.str] config_rule_id: The ID of the rule.
        :param pulumi.Input[_builtins.str] config_rule_trigger_types: The trigger type of the rule. Valid values:  `ConfigurationItemChangeNotification`: The rule is triggered upon configuration changes. `ScheduledNotification`: The rule is triggered as scheduled.
    ...
    @_builtins.property
    @pulumi.getter(name="configRuleArn")
    def config_rule_arn(self) -> pulumi.Output[_builtins.str]:
        """
        config rule arn.
        """
        return pulumi.get(self, "config_rule_arn")
    ...
    @_builtins.property
    @pulumi.getter(name="eventSource")
    def event_source(self) -> pulumi.Output[_builtins.str]:
        """
        The event source of the rule.
        """
        return pulumi.get(self, "event_source")
    ...
    @_builtins.property
    @pulumi.getter(name="modifiedTimestamp")
    def modified_timestamp(self) -> pulumi.Output[_builtins.int]:
        """
        The timestamp when the rule was last modified.
        """
        return pulumi.get(self, "modified_timestamp")
    ...
    @pulumi.getter(name="scopeComplianceResourceTypes")
    @_utilities.deprecated("""Field 'scope_compliance_resource_types' has been deprecated from provider version 1.124.1. New field 'resource_types_scope' instead.""")
    def scope_compliance_resource_types(self) -> pulumi.Output[_builtins.str]:
        """
        Field 'scope_compliance_resource_types' has been deprecated from provider version 1.124.1. New field 'resource_types_scope' instead.
        """
        return pulumi.get(self, "scope_compliance_resource_types")
    ...
    @pulumi.getter(name="sourceDetailMessageType")
    @_utilities.deprecated("""Field 'source_detail_message_type' has been deprecated from provider version 1.124.1. New field 'config_rule_trigger_types' instead.""")
    def source_detail_message_type(self) -> pulumi.Output[_builtins.str]:
        """
        Field 'source_detail_message_type' has been deprecated from provider version 1.124.1. New field 'config_rule_trigger_types' instead.
        """
        return pulumi.get(self, "source_detail_message_type")
    ...
    @pulumi.getter(name="sourceMaximumExecutionFrequency")
    @_utilities.deprecated("""Field 'source_maximum_execution_frequency' has been deprecated from provider version 1.124.1. New field 'maximum_execution_frequency' instead.""")
    def source_maximum_execution_frequency(self) -> pulumi.Output[_builtins.str]:
        """
        Field 'source_maximum_execution_frequency' has been deprecated from provider version 1.124.1. New field 'maximum_execution_frequency' instead.
        """
        return pulumi.get(self, "source_maximum_execution_frequency")
