...
def get_aggregate_deliveries(aggregator_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Aggregate Delivery IDs.
    :param _builtins.str name_regex: A regex string to filter results by Aggregate Delivery name.
...
def get_aggregate_deliveries_output(aggregator_id: Optional[pulumi.Input[_builtins.str]] = None,
