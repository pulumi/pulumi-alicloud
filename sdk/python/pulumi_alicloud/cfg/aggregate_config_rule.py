...
class AggregateConfigRuleArgs:
    def __init__(__self__, *,
                 aggregate_config_rule_name: pulumi.Input[builtins.str],
                 aggregator_id: pulumi.Input[builtins.str],
                 config_rule_trigger_types: pulumi.Input[builtins.str],
                 resource_types_scopes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[builtins.str] aggregate_config_rule_name: The name of the rule.
        :param pulumi.Input[builtins.str] aggregator_id: The Aggregator Id.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_types_scopes: Resource types to be evaluated. [Alibaba Cloud services that support Cloud Config.](https://www.alibabacloud.com/help/en/doc-detail/127411.htm)
        ...
        :param pulumi.Input[builtins.str] source_identifier: The identifier of the rule. For a managed rule, the value is the identifier of the managed rule. For a custom rule, the value is the ARN of the custom rule. Using managed rules, refer to [List of Managed rules.](https://www.alibabacloud.com/help/en/doc-detail/127404.htm)
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] input_parameters: The settings map of the input parameters for the rule.
        :param pulumi.Input[builtins.str] maximum_execution_frequency: The frequency of the compliance evaluations. Valid values:  `One_Hour`, `Three_Hours`, `Six_Hours`, `Twelve_Hours`, `TwentyFour_Hours`. System default value is `TwentyFour_Hours` and valid when the `config_rule_trigger_types` is `ScheduledNotification`.
        ...
        :param pulumi.Input[builtins.str] status: The rule status. The valid values: `ACTIVE`, `INACTIVE`.
        ...
        :param pulumi.Input[builtins.str] tag_value_scope: The rule monitors the tag value, use with the `tag_key_scope` options. only applies to rules created based on managed rules.
        """
    ...
    def aggregate_config_rule_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def aggregate_config_rule_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "aggregate_config_rule_name", value)

    @property
    @pulumi.getter(name="aggregatorId")
    def aggregator_id(self) -> pulumi.Input[builtins.str]:
        """
        The Aggregator Id.
        """
    ...
    def aggregator_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "aggregator_id", value)

    @property
    @pulumi.getter(name="configRuleTriggerTypes")
    def config_rule_trigger_types(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def config_rule_trigger_types(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "config_rule_trigger_types", value)

    @property
    @pulumi.getter(name="resourceTypesScopes")
    def resource_types_scopes(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def resource_types_scopes(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _AggregateConfigRuleState:
    def __init__(__self__, *,
                 aggregate_config_rule_name: Optional[pulumi.Input[builtins.str]] = None,
                 aggregator_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] aggregate_config_rule_name: The name of the rule.
        :param pulumi.Input[builtins.str] aggregator_id: The Aggregator Id.
        :param pulumi.Input[builtins.str] config_rule_id: (Available since v1.141.0) The rule ID of Aggregate Config Rule.
        :param pulumi.Input[builtins.str] config_rule_trigger_types: The trigger type of the rule. Valid values: `ConfigurationItemChangeNotification`: The rule is triggered upon configuration changes. `ScheduledNotification`: The rule is triggered as scheduled.
        :param pulumi.Input[builtins.str] description: The description of the rule.
        :param pulumi.Input[builtins.str] exclude_resource_ids_scope: The rule monitors excluded resource IDs, multiple of which are separated by commas, only applies to rules created based on managed rules, , custom rule this field is empty.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] input_parameters: The settings map of the input parameters for the rule.
    ...
    @property
    @pulumi.getter(name="aggregateConfigRuleName")
    def aggregate_config_rule_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the rule.
        """
        return pulumi.get(self, "aggregate_config_rule_name")
    ...
    @aggregate_config_rule_name.setter
    def aggregate_config_rule_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aggregate_config_rule_name", value)

    @property
    @pulumi.getter(name="aggregatorId")
    def aggregator_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Aggregator Id.
        """
        return pulumi.get(self, "aggregator_id")
    ...
    @aggregator_id.setter
    def aggregator_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aggregator_id", value)
...
class AggregateConfigRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tag_key_scope: Optional[pulumi.Input[builtins.str]] = None,
            tag_value_scope: Optional[pulumi.Input[builtins.str]] = None) -> 'AggregateConfigRule':
        """
    ...
    @property
    @pulumi.getter(name="aggregateConfigRuleName")
    def aggregate_config_rule_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the rule.
        """
        return pulumi.get(self, "aggregate_config_rule_name")
    ...
    @property
    @pulumi.getter(name="aggregatorId")
    def aggregator_id(self) -> pulumi.Output[builtins.str]:
        """
        The Aggregator Id.
        """
        return pulumi.get(self, "aggregator_id")
