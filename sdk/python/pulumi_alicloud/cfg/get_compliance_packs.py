...
def get_compliance_packs(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Compliance Pack IDs.
    :param builtins.str name_regex: A regex string to filter results by Compliance Pack name.
...
def get_compliance_packs_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
