...
def get_configuration_recorders(output_file: Optional[builtins.str] = None,
...
def get_configuration_recorders_output(output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
