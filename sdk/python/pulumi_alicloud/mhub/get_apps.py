...
def get_apps(enable_details: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of App IDs. The value formats as `<product_id>:<app_key>`
    :param _builtins.str name_regex: A regex string to filter results by App name.
    :param _builtins.str os_type: The os type. Valid values: `Android` and `iOS`.
...
def get_apps_output(enable_details: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:mhub/getApps:getApps', __args__, opts=opts, typ=GetAppsResult)
