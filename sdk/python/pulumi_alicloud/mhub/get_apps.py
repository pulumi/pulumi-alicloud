...
def get_apps(enable_details: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] ids: A list of App IDs. The value formats as `<product_id>:<app_key>`
    :param builtins.str name_regex: A regex string to filter results by App name.
    :param builtins.str os_type: The os type. Valid values: `Android` and `iOS`.
...
def get_apps_output(enable_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
