...
class AppArgs:
    def __init__(__self__, *,
                 ...
                 encoded_icon: Optional[pulumi.Input[builtins.str]] = None,
                 industry_id: Optional[pulumi.Input[builtins.str]] = None,
                 package_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a App resource.
        :param pulumi.Input[builtins.str] app_name: AppName.
        :param pulumi.Input[builtins.str] product_id: The ID of the Product.
        :param pulumi.Input[builtins.str] type: The type of the Product. Valid values: `Android` and `iOS`.
        :param pulumi.Input[builtins.str] bundle_id: The app id of iOS. **NOTE:** Either `bundle_id` or `package_name` must be set.
        :param pulumi.Input[builtins.str] encoded_icon: Base64 string of picture.
        :param pulumi.Input[builtins.str] industry_id: The Industry ID of the app. For information about Industry and how to use it, MHUB[Industry](https://help.aliyun.com/document_detail/201638.html).
        :param pulumi.Input[builtins.str] package_name: Android App package name. **NOTE:** Either `bundle_id` or `package_name` must be set.
        """
    ...
    def encoded_icon(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @encoded_icon.setter
    def encoded_icon(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "encoded_icon", value)

    @property
    @pulumi.getter(name="industryId")
    def industry_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @industry_id.setter
    def industry_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class App(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            package_name: Optional[pulumi.Input[builtins.str]] = None,
            product_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'App':
        """
    ...
    @property
    @pulumi.getter(name="encodedIcon")
    def encoded_icon(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Base64 string of picture.
        """
        return pulumi.get(self, "encoded_icon")
    ...
    @property
    @pulumi.getter(name="industryId")
    def industry_id(self) -> pulumi.Output[builtins.str]:
        """
        The Industry ID of the app. For information about Industry and how to use it, MHUB[Industry](https://help.aliyun.com/document_detail/201638.html).
        """
        return pulumi.get(self, "industry_id")
