...
class GetOrganizationsResult:
    ...
    def real_pk(self) -> Optional[builtins.str]:
...
def get_organizations(ids: Optional[Sequence[builtins.str]] = None,
                      name_regex: Optional[builtins.str] = None,
                      output_file: Optional[builtins.str] = None,
                      real_pk: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Organization IDs.
    :param builtins.str name_regex: A regex string to filter results by Organization name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str real_pk: User pk, not required, only required when the ak used by the calling interface is inconsistent with the user pk
    """
    __args__ = dict()
    __args__['ids'] = ids
...
def get_organizations_output(ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             output_file: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             real_pk: Optional[pulumi.Input[Optional[builtins.str]]] = None,
