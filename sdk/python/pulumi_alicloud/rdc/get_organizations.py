...
class GetOrganizationsResult:
    ...
    def real_pk(self) -> Optional[_builtins.str]:
...
def get_organizations(ids: Optional[Sequence[_builtins.str]] = None,
                      name_regex: Optional[_builtins.str] = None,
                      output_file: Optional[_builtins.str] = None,
                      real_pk: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] ids: A list of Organization IDs.
    :param _builtins.str name_regex: A regex string to filter results by Organization name.
    :param _builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param _builtins.str real_pk: User pk, not required, only required when the ak used by the calling interface is inconsistent with the user pk
    """
    __args__ = dict()
    __args__['ids'] = ids
