...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] db_instance_id: The Adb pg instance ID.
        :param pulumi.Input[builtins.str] account_description: The description of the account.
        :param pulumi.Input[builtins.str] account_type: Account type. The value range is as follows:
               
               Normal: Normal account number.
               
               Super: a high-privilege account.
        :param pulumi.Input[builtins.str] database_name: Database name, with the following restrictions:
...
class Account(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:gpdb/account:Account"
