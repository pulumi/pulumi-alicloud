...
class DbInstanceIpArrayArgs:
    def __init__(__self__, *,
                 ...
                 db_instance_ip_array_name: pulumi.Input[builtins.str],
                 security_ip_lists: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[builtins.str] db_instance_ip_array_name: The name of the IP address whitelist. If you do not specify this parameter, the default whitelist is queried.
               
               > **NOTE:**   Each instance supports up to 50 IP address whitelists.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_ip_lists: The IP address whitelist contains a maximum of 1000 IP addresses separated by commas in the following three formats:
               - 0.0.0.0/0
               - 10.23.12.24(IP)
        ...
        :param pulumi.Input[builtins.str] db_instance_ip_array_attribute: The default is empty. To distinguish between different attribute values, the console does not display groups with the 'hidden' attribute.
        :param pulumi.Input[builtins.str] modify_mode: The method of modification. Valid values:
    ...
    def db_instance_ip_array_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_instance_ip_array_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "db_instance_ip_array_name", value)

    @property
    @pulumi.getter(name="securityIpLists")
    def security_ip_lists(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def security_ip_lists(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class DbInstanceIpArray(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            db_instance_ip_array_name: Optional[pulumi.Input[builtins.str]] = None,
            modify_mode: Optional[pulumi.Input[builtins.str]] = None,
            security_ip_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'DbInstanceIpArray':
        """
    ...
    @property
    @pulumi.getter(name="dbInstanceIpArrayName")
    def db_instance_ip_array_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the IP address whitelist. If you do not specify this parameter, the default whitelist is queried.
    ...
    @property
    @pulumi.getter(name="securityIpLists")
    def security_ip_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The IP address whitelist contains a maximum of 1000 IP addresses separated by commas in the following three formats:
        - 0.0.0.0/0
        - 10.23.12.24(IP)
