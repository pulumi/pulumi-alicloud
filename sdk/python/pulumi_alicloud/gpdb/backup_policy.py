...
class BackupPolicyArgs:
    def __init__(__self__, *,
                 ...
                 preferred_backup_period: pulumi.Input[builtins.str],
                 preferred_backup_time: pulumi.Input[builtins.str],
                 backup_retention_period: Optional[pulumi.Input[builtins.int]] = None,
                 enable_recovery_point: Optional[pulumi.Input[builtins.bool]] = None,
                 recovery_point_period: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] preferred_backup_period: Data backup cycle. Separate multiple values with commas (,). Value Description:
               - **Monday**: Monday.
               - **Tuesday**: Tuesday.
               - **Wednesday**: Wednesday.
               - **Thursday**: Thursday.
               ...
               - **Saturday**: Saturday.
               - **Sunday**: Sunday.
        :param pulumi.Input[builtins.str] preferred_backup_time: Data backup time. Format: HH:mmZ-HH:mmZ(UTC time).
        :param pulumi.Input[builtins.int] backup_retention_period: Data backup retention days.
        :param pulumi.Input[builtins.bool] enable_recovery_point: Whether to enable automatic recovery points. Value Description:
               - **true**: enabled.
               - **false**: Closed.
        :param pulumi.Input[builtins.str] recovery_point_period: Recovery point frequency. Value Description:
               - **1**: Hourly.
               - **2**: Every two hours.
               - **4**: Every four hours.
               - **8**: Every eight hours.
    ...
    def preferred_backup_period(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def preferred_backup_period(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "preferred_backup_period", value)

    @property
    @pulumi.getter(name="preferredBackupTime")
    def preferred_backup_time(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def preferred_backup_time(self, value: pulumi.Input[builtins.str]):
    ...
    def enable_recovery_point(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_recovery_point(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_recovery_point", value)

    @property
    @pulumi.getter(name="recoveryPointPeriod")
    def recovery_point_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def recovery_point_period(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BackupPolicyState:
    def __init__(__self__, *,
                 ...
                 enable_recovery_point: Optional[pulumi.Input[builtins.bool]] = None,
                 preferred_backup_period: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="preferredBackupPeriod")
    def preferred_backup_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Data backup cycle. Separate multiple values with commas (,). Value Description:
        - **Monday**: Monday.
        - **Tuesday**: Tuesday.
    ...
    @preferred_backup_period.setter
    def preferred_backup_period(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "preferred_backup_period", value)
...
class BackupPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            preferred_backup_period: Optional[pulumi.Input[builtins.str]] = None,
            preferred_backup_time: Optional[pulumi.Input[builtins.str]] = None,
            recovery_point_period: Optional[pulumi.Input[builtins.str]] = None) -> 'BackupPolicy':
        """
    ...
    @property
    @pulumi.getter(name="enableRecoveryPoint")
    def enable_recovery_point(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to enable automatic recovery points. Value Description:
        - **true**: enabled.
        - **false**: Closed.
    ...
    @property
    @pulumi.getter(name="preferredBackupPeriod")
    def preferred_backup_period(self) -> pulumi.Output[builtins.str]:
        """
        Data backup cycle. Separate multiple values with commas (,). Value Description:
        - **Monday**: Monday.
        - **Tuesday**: Tuesday.
    ...
    @property
    @pulumi.getter(name="recoveryPointPeriod")
    def recovery_point_period(self) -> pulumi.Output[builtins.str]:
        """
        Recovery point frequency. Value Description:
        - **1**: Hourly.
        - **2**: Every two hours.
