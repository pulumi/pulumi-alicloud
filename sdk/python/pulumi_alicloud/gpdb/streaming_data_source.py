...
class StreamingDataSourceArgs:
    def __init__(__self__, *,
                 data_source_config: pulumi.Input[builtins.str],
                 ...
                 service_id: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.str] data_source_config: The configurations of the data source.
        ...
        :param pulumi.Input[builtins.int] service_id: The real-time data service ID.
        :param pulumi.Input[builtins.str] data_source_description: The description of the data source.
        """
    ...
    def data_source_config(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def data_source_config(self, value: pulumi.Input[builtins.str]):
    ...
    def service_id(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @service_id.setter
    def service_id(self, value: pulumi.Input[builtins.int]):
...
class _StreamingDataSourceState:
    def __init__(__self__, *,
                 ...
                 data_source_config: Optional[pulumi.Input[builtins.str]] = None,
                 data_source_description: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 service_id: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="dataSourceConfig")
    def data_source_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The configurations of the data source.
        """
        return pulumi.get(self, "data_source_config")
    ...
    @data_source_config.setter
    def data_source_config(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_source_config", value)
    ...
    @property
    @pulumi.getter(name="serviceId")
    def service_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The real-time data service ID.
        """
        return pulumi.get(self, "service_id")
    ...
    @service_id.setter
    def service_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "service_id", value)
...
class StreamingDataSource(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:gpdb/streamingDataSource:StreamingDataSource"
    ...
    def get(resource_name: str,
            ...
            db_instance_id: Optional[pulumi.Input[builtins.str]] = None,
            service_id: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'StreamingDataSource':
        """
    ...
    @property
    @pulumi.getter(name="dataSourceConfig")
    def data_source_config(self) -> pulumi.Output[builtins.str]:
        """
        The configurations of the data source.
        """
        return pulumi.get(self, "data_source_config")
    ...
    @property
    @pulumi.getter(name="serviceId")
    def service_id(self) -> pulumi.Output[builtins.int]:
        """
        The real-time data service ID.
        """
        return pulumi.get(self, "service_id")
