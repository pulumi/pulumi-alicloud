...
class _StreamingDataSourceState:
    def __init__(__self__, *,
                 ...
                 data_source_config: pulumi.Input[Optional[_builtins.str]] = None,
                 data_source_description: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="dataSourceConfig")
    def data_source_config(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The configurations of the data source.
        """
        return pulumi.get(self, "data_source_config")
    ...
    @data_source_config.setter
    def data_source_config(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "data_source_config", value)
...
class StreamingDataSource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            db_instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            service_id: pulumi.Input[Optional[_builtins.int]] = None,
            status: pulumi.Input[Optional[_builtins.str]] = None) -> 'StreamingDataSource':
        """
