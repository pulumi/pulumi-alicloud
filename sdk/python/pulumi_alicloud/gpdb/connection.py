...
class ConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The Id of instance that can run database.
        :param pulumi.Input[builtins.str] connection_prefix: Prefix of an Internet connection string. It must be checked for uniqueness. It may consist of lowercase letters, numbers, and underlines, and must start with a letter and have no more than 30 characters. Default to <instance_id> + '-tf'.
        :param pulumi.Input[builtins.str] port: Internet connection port. Valid value: [3200-3999]. Default to 3306.
        """
...
class _ConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_prefix: Prefix of an Internet connection string. It must be checked for uniqueness. It may consist of lowercase letters, numbers, and underlines, and must start with a letter and have no more than 30 characters. Default to <instance_id> + '-tf'.
        :param pulumi.Input[builtins.str] connection_string: Connection instance string.
        :param pulumi.Input[builtins.str] instance_id: The Id of instance that can run database.
...
class Connection(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:gpdb/connection:Connection"
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            ip_address: Optional[pulumi.Input[builtins.str]] = None,
            port: Optional[pulumi.Input[builtins.str]] = None) -> 'Connection':
        """
