...
def get_zones(multi: Optional[builtins.bool] = None,
    ...
    :param builtins.bool multi: Indicate whether the zones can be used in a multi AZ configuration. Default to `false`. Multi AZ is usually used to launch Gpdb instances.
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:gpdb/getZones:getZones', __args__, opts=opts, typ=GetZonesResult).value
...
def get_zones_output(multi: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:gpdb/getZones:getZones', __args__, opts=opts, typ=GetZonesResult)
