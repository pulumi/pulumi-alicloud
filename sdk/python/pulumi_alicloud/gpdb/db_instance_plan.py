...
class DbInstancePlanArgs:
    def __init__(__self__, *,
                 ...
                 db_instance_plan_name: pulumi.Input[builtins.str],
                 plan_configs: pulumi.Input[Sequence[pulumi.Input['DbInstancePlanPlanConfigArgs']]],
                 plan_schedule_type: pulumi.Input[builtins.str],
                 plan_type: pulumi.Input[builtins.str],
                 plan_desc: Optional[pulumi.Input[builtins.str]] = None,
                 plan_end_date: Optional[pulumi.Input[builtins.str]] = None,
                 plan_start_date: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DbInstancePlan resource.
        :param pulumi.Input[builtins.str] db_instance_id: The ID of the GPDB instance.
        :param pulumi.Input[builtins.str] db_instance_plan_name: The name of the Plan.
        ...
        :param pulumi.Input[builtins.str] plan_schedule_type: The execution mode of the plan. Valid values: `Postpone`, `Regular`.
        :param pulumi.Input[builtins.str] plan_type: The type of the Plan. Valid values: `PauseResume`, `Resize`.
        :param pulumi.Input[builtins.str] plan_desc: The description of the Plan.
        :param pulumi.Input[builtins.str] plan_end_date: The end time of the Plan.
        :param pulumi.Input[builtins.str] plan_start_date: The start time of the Plan.
        :param pulumi.Input[builtins.str] status: The Status of the Plan. Valid values: `active`, `cancel`.
        """
    ...
    def db_instance_plan_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_instance_plan_name(self, value: pulumi.Input[builtins.str]):
    ...
    def plan_schedule_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def plan_schedule_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "plan_schedule_type", value)

    @property
    @pulumi.getter(name="planType")
    def plan_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @plan_type.setter
    def plan_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "plan_type", value)

    @property
    @pulumi.getter(name="planDesc")
    def plan_desc(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @plan_desc.setter
    def plan_desc(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "plan_desc", value)

    @property
    @pulumi.getter(name="planEndDate")
    def plan_end_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def plan_end_date(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "plan_end_date", value)

    @property
    @pulumi.getter(name="planStartDate")
    def plan_start_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def plan_start_date(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DbInstancePlanState:
    def __init__(__self__, *,
                 ...
                 db_instance_plan_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 plan_schedule_type: Optional[pulumi.Input[builtins.str]] = None,
                 plan_start_date: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] plan_desc: The description of the Plan.
        :param pulumi.Input[builtins.str] plan_end_date: The end time of the Plan.
        :param pulumi.Input[builtins.str] plan_id: The ID of the plan.
        :param pulumi.Input[builtins.str] plan_schedule_type: The execution mode of the plan. Valid values: `Postpone`, `Regular`.
        :param pulumi.Input[builtins.str] plan_start_date: The start time of the Plan.
        :param pulumi.Input[builtins.str] plan_type: The type of the Plan. Valid values: `PauseResume`, `Resize`.
        :param pulumi.Input[builtins.str] status: The Status of the Plan. Valid values: `active`, `cancel`.
    ...
    @property
    @pulumi.getter(name="dbInstancePlanName")
    def db_instance_plan_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Plan.
        """
        return pulumi.get(self, "db_instance_plan_name")
    ...
    @db_instance_plan_name.setter
    def db_instance_plan_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_instance_plan_name", value)
    ...
    @property
    @pulumi.getter(name="planScheduleType")
    def plan_schedule_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The execution mode of the plan. Valid values: `Postpone`, `Regular`.
        """
        return pulumi.get(self, "plan_schedule_type")
    ...
    @plan_schedule_type.setter
    def plan_schedule_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "plan_schedule_type", value)
...
class DbInstancePlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            plan_start_date: Optional[pulumi.Input[builtins.str]] = None,
            plan_type: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'DbInstancePlan':
        """
    ...
    @property
    @pulumi.getter(name="dbInstancePlanName")
    def db_instance_plan_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Plan.
        """
        return pulumi.get(self, "db_instance_plan_name")
    ...
    @property
    @pulumi.getter(name="planDesc")
    def plan_desc(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the Plan.
        """
        return pulumi.get(self, "plan_desc")
    ...
    @property
    @pulumi.getter(name="planEndDate")
    def plan_end_date(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The end time of the Plan.
        """
        return pulumi.get(self, "plan_end_date")
    ...
    @property
    @pulumi.getter(name="planScheduleType")
    def plan_schedule_type(self) -> pulumi.Output[builtins.str]:
        """
        The execution mode of the plan. Valid values: `Postpone`, `Regular`.
        """
        return pulumi.get(self, "plan_schedule_type")
    ...
    @property
    @pulumi.getter(name="planStartDate")
    def plan_start_date(self) -> pulumi.Output[builtins.str]:
        """
        The start time of the Plan.
        """
        return pulumi.get(self, "plan_start_date")
