...
class GetDbInstancePlansResult:
    ...
    def plan_schedule_type(self) -> Optional[builtins.str]:
...
def get_db_instance_plans(db_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str db_instance_id: The ID of the Database instance.
    :param Sequence[builtins.str] ids: A list of DB Instance Plan IDs.
    :param builtins.str name_regex: A regex string to filter results by DB Instance Plan name.
    ...
    :param builtins.str status: Planning Status. Valid values: `active`, `cancel`, `deleted`, `finished`.
    """
    __args__ = dict()
...
def get_db_instance_plans_output(db_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                                 ...
                                 plan_schedule_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 plan_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
