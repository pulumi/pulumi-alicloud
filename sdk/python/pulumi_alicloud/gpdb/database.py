...
class DatabaseArgs:
    def __init__(__self__, *,
                 ...
                 ctype: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] owner: Data Sheet owner
        :param pulumi.Input[builtins.str] character_set_name: Character set, default value is UTF8
        :param pulumi.Input[builtins.str] collate: Database locale parameters, specifying string comparison/collation
        :param pulumi.Input[builtins.str] ctype: Database locale parameters, specifying character classification/case conversion rules
        :param pulumi.Input[builtins.str] description: Database Description
        """
    ...
    @property
    @pulumi.getter
    def ctype(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ctype.setter
    def ctype(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Database(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def collate(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Database locale parameters, specifying string comparison/collation
        """
        return pulumi.get(self, "collate")
    ...
    @property
    @pulumi.getter
    def ctype(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Database locale parameters, specifying character classification/case conversion rules
        """
        return pulumi.get(self, "ctype")
