...
class GetInstancesInstanceResult(dict):
    def __init__(__self__, *,
        ...
        :param str charge_type: The billing method of the instance. Valid values: `Subscription`, `PayAsYouGo`.
        ...
        :param str creation_time: The time when the instance was created. The time is in the YYYY-MM-DDThh:mm:ssZ format, such as 2011-05-30T12:11:4Z.
