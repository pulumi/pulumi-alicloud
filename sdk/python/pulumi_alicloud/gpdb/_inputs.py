...
if not MYPY:
    class DbInstancePlanPlanConfigPauseArgsDict(TypedDict):
        execute_time: NotRequired[pulumi.Input[builtins.str]]
        """
        The executed time of the Plan.
        """
        plan_cron_time: NotRequired[pulumi.Input[builtins.str]]
        """
        The Cron Time of the plan.
        """
        plan_task_status: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DbInstancePlanPlanConfigPauseArgs:
    def __init__(__self__, *,
                 execute_time: Optional[pulumi.Input[builtins.str]] = None,
                 plan_cron_time: Optional[pulumi.Input[builtins.str]] = None,
                 plan_task_status: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] execute_time: The executed time of the Plan.
        :param pulumi.Input[builtins.str] plan_cron_time: The Cron Time of the plan.
        :param pulumi.Input[builtins.str] plan_task_status: (Available since v1.231.0) The status of the plan task.
        """
    ...
    def execute_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The executed time of the Plan.
        """
    ...
    @execute_time.setter
    def execute_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "execute_time", value)

    @property
    @pulumi.getter(name="planCronTime")
    def plan_cron_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cron Time of the plan.
        """
    ...
    def plan_cron_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "plan_cron_time", value)

    @property
    @pulumi.getter(name="planTaskStatus")
    def plan_task_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Available since v1.231.0) The status of the plan task.
        """
    ...
    def plan_task_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DbInstancePlanPlanConfigScaleDownArgsDict(TypedDict):
        ...
        The executed time of the Plan.
        """
        instance_spec: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DbInstancePlanPlanConfigScaleDownArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] execute_time: The executed time of the Plan.
        :param pulumi.Input[builtins.str] instance_spec: The specification of segment nodes of the Plan.
        :param pulumi.Input[builtins.str] plan_cron_time: The Cron Time of the plan.
        :param pulumi.Input[builtins.str] plan_task_status: (Available since v1.231.0) The status of the plan task.
        """
        if execute_time is not None:
...
if not MYPY:
    class DbInstancePlanPlanConfigScaleInArgsDict(TypedDict):
        ...
        (Available since v1.231.0) The status of the plan task.
        """
        segment_node_num: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DbInstancePlanPlanConfigScaleInArgs:
    def __init__(__self__, *,
                 ...
                 plan_cron_time: Optional[pulumi.Input[builtins.str]] = None,
                 plan_task_status: Optional[pulumi.Input[builtins.str]] = None,
                 segment_node_num: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] execute_time: The executed time of the Plan.
        :param pulumi.Input[builtins.str] plan_cron_time: The Cron Time of the plan.
        :param pulumi.Input[builtins.str] plan_task_status: (Available since v1.231.0) The status of the plan task.
        :param pulumi.Input[builtins.str] segment_node_num: The segment Node Num of the Plan.
        """
        if execute_time is not None:
            pulumi.set(__self__, "execute_time", execute_time)
        if plan_cron_time is not None:
    ...
    def segment_node_num(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The segment Node Num of the Plan.
        """
    ...
    def segment_node_num(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class InstanceIpWhitelistArgsDict(TypedDict):
        ip_group_attribute: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        ip_group_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InstanceIpWhitelistArgs:
    def __init__(__self__, *,
                 ip_group_attribute: Optional[pulumi.Input[builtins.str]] = None,
                 ip_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 security_ip_list: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ip_group_attribute: The value of this parameter is empty by default. The attribute of the whitelist group. 
               If the value contains `hidden`, this white list item will not output.
        :param pulumi.Input[builtins.str] ip_group_name: IP whitelist group name.
        :param pulumi.Input[builtins.str] security_ip_list: List of IP addresses allowed to access all databases of an instance. The list contains up to 1,000 IP addresses, separated by commas. Supported formats include 0.0.0.0/0, 10.23.12.24 (IP), and 10.23.12.24/24 (Classless Inter-Domain Routing (CIDR) mode. /24 represents the length of the prefix in an IP address. The range of the prefix length is [1,32]). System default to `["127.0.0.1"]`.
        """
    ...
    def ip_group_attribute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The value of this parameter is empty by default. The attribute of the whitelist group. 
        If the value contains `hidden`, this white list item will not output.
        """
    ...
    def ip_group_attribute(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ip_group_attribute", value)

    @property
    @pulumi.getter(name="ipGroupName")
    def ip_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        IP whitelist group name.
        """
    ...
    def ip_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class InstanceParameterArgsDict(TypedDict):
        ...
        """
        force_restart_instance: NotRequired[pulumi.Input[builtins.str]]
        """
        (Available since v1.231.0) Whether to force restart the instance to config the parameter.
        """
        is_changeable_config: NotRequired[pulumi.Input[builtins.str]]
        """
        (Available since v1.231.0) Whether the parameter is changeable.
        """
        optional_range: NotRequired[pulumi.Input[builtins.str]]
        """
        (Available since v1.231.0) The optional range of the parameter.
        """
        parameter_description: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InstanceParameterArgs:
    def __init__(__self__, *,
                 ...
                 force_restart_instance: Optional[pulumi.Input[builtins.str]] = None,
                 is_changeable_config: Optional[pulumi.Input[builtins.str]] = None,
                 optional_range: Optional[pulumi.Input[builtins.str]] = None,
                 parameter_description: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] default_value: (Available since v1.231.0) The default value of the parameter.
        :param pulumi.Input[builtins.str] force_restart_instance: (Available since v1.231.0) Whether to force restart the instance to config the parameter.
        :param pulumi.Input[builtins.str] is_changeable_config: (Available since v1.231.0) Whether the parameter is changeable.
        :param pulumi.Input[builtins.str] optional_range: (Available since v1.231.0) The optional range of the parameter.
        :param pulumi.Input[builtins.str] parameter_description: (Available since v1.231.0) The description of the parameter.
        """
    ...
    def force_restart_instance(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Available since v1.231.0) Whether to force restart the instance to config the parameter.
        """
    ...
    def force_restart_instance(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "force_restart_instance", value)

    @property
    @pulumi.getter(name="isChangeableConfig")
    def is_changeable_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Available since v1.231.0) Whether the parameter is changeable.
        """
    ...
    def is_changeable_config(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "is_changeable_config", value)

    @property
    @pulumi.getter(name="optionalRange")
    def optional_range(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Available since v1.231.0) The optional range of the parameter.
        """
    ...
    def optional_range(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "optional_range", value)

    @property
    @pulumi.getter(name="parameterDescription")
    def parameter_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Available since v1.231.0) The description of the parameter.
        """
    ...
    def parameter_description(self, value: Optional[pulumi.Input[builtins.str]]):
