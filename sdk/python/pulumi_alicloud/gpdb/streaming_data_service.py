...
class StreamingDataServiceArgs:
    def __init__(__self__, *,
                 ...
                 service_spec: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] db_instance_id: The ID of the associated instance.
        :param pulumi.Input[builtins.str] service_name: Service Name
        :param pulumi.Input[builtins.str] service_spec: Resource Specifications
        :param pulumi.Input[builtins.str] service_description: The creation time of the resource
        """
    ...
    def service_spec(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @service_spec.setter
    def service_spec(self, value: pulumi.Input[builtins.str]):
...
class _StreamingDataServiceState:
    def __init__(__self__, *,
                 ...
                 service_spec: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="serviceSpec")
    def service_spec(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Resource Specifications
        """
        return pulumi.get(self, "service_spec")
    ...
    @service_spec.setter
    def service_spec(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_spec", value)
...
class StreamingDataService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_name: Optional[pulumi.Input[builtins.str]] = None,
            service_spec: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'StreamingDataService':
        """
    ...
    @property
    @pulumi.getter(name="serviceSpec")
    def service_spec(self) -> pulumi.Output[builtins.str]:
        """
        Resource Specifications
        """
        return pulumi.get(self, "service_spec")
