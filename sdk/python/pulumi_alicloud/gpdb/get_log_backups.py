...
def get_log_backups(db_instance_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Logbackup IDs.
...
def get_log_backups_output(db_instance_id: Optional[pulumi.Input[builtins.str]] = None,
