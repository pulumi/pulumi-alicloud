...
class ElasticInstanceArgs:
    def __init__(__self__, *,
                 ...
                 seg_node_num: pulumi.Input[builtins.int],
                 seg_storage_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] engine: Database engine: `gpdb`.
        :param pulumi.Input[builtins.str] engine_version: Database version. Valid value is `6.0`.
        ...
        :param pulumi.Input[builtins.int] storage_size: The storage capacity of per segment node. Unit: GB. Minimum is `50`, max is `4000`, step is `50`.
        :param pulumi.Input[builtins.str] vswitch_id: The virtual switch ID to launch ADB PG instances in one VPC.
        :param pulumi.Input[builtins.str] db_instance_category: The edition of the instance. Valid values: `Basic`, `HighAvailability`. Default value: `HighAvailability`.
        :param pulumi.Input[builtins.str] db_instance_description: The description of ADB PG instance. It is a string of 2 to 256 characters.
        ...
        :param pulumi.Input[builtins.str] encryption_type: The type of the encryption. Valid values: `CloudDisk`. **Note:** Disk encryption cannot be disabled after it is enabled.
        :param pulumi.Input[builtins.str] instance_network_type: The network type of ADB PG instance. Only `VPC` supported now.
        :param pulumi.Input[builtins.int] payment_duration: The subscription period. Valid values: [1~12]. It is valid when payment_type is `Subscription`.  
        ...
        :param pulumi.Input[builtins.str] zone_id: The Zone to launch the ADB PG instance. If specified, must be consistent with the zone where the vswitch is located.
        """
    ...
    def seg_node_num(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @seg_node_num.setter
    def seg_node_num(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "seg_node_num", value)

    @property
    @pulumi.getter(name="segStorageType")
    def seg_storage_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def seg_storage_type(self, value: pulumi.Input[builtins.str]):
...
class _ElasticInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_string: ADB PG instance connection string.
        :param pulumi.Input[builtins.str] db_instance_category: The edition of the instance. Valid values: `Basic`, `HighAvailability`. Default value: `HighAvailability`.
        :param pulumi.Input[builtins.str] db_instance_description: The description of ADB PG instance. It is a string of 2 to 256 characters.
        :param pulumi.Input[builtins.str] encryption_key: The ID of the encryption key. **Note:** If the `encryption_type` parameter is set to `CloudDisk`, you must specify this parameter to the encryption key that is in the same region as the disk that is specified by the EncryptionType parameter. Otherwise, leave this parameter empty.
        :param pulumi.Input[builtins.str] encryption_type: The type of the encryption. Valid values: `CloudDisk`. **Note:** Disk encryption cannot be disabled after it is enabled.
...
class ElasticInstance(pulumi.CustomResource):
    ...
    pulumi_type = "alicloud:gpdb/elasticInstance:ElasticInstance"
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vswitch_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ElasticInstance':
        """
    ...
    @property
    @pulumi.getter(name="instanceNetworkType")
    def instance_network_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The network type of ADB PG instance. Only `VPC` supported now.
        """
        return pulumi.get(self, "instance_network_type")
