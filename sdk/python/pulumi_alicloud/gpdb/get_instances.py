...
class GetInstancesResult:
    ...
    def db_instance_categories(self) -> Optional[builtins.str]:
        return pulumi.get(self, "db_instance_categories")

    @property
    @pulumi.getter(name="dbInstanceModes")
    def db_instance_modes(self) -> Optional[builtins.str]:
    ...
    def instance_network_type(self) -> Optional[builtins.str]:
...
def get_instances(availability_zone: Optional[builtins.str] = None,
                  db_instance_categories: Optional[builtins.str] = None,
                  db_instance_modes: Optional[builtins.str] = None,
                  description: Optional[builtins.str] = None,
                  enable_details: Optional[builtins.bool] = None,
                  ids: Optional[Sequence[builtins.str]] = None,
                  instance_network_type: Optional[builtins.str] = None,
    ...
    :param builtins.str db_instance_categories: The db instance categories.
    :param builtins.str db_instance_modes: The db instance modes.
    ...
    :param Sequence[builtins.str] ids: The ids list of AnalyticDB for PostgreSQL instances.
    :param builtins.str instance_network_type: The network type of the instance.
    :param builtins.str name_regex: A regex string to apply to the instance name.
    :param builtins.str output_file: File name where to save data source results (after running `pulumi preview`).
    :param builtins.str resource_group_id: The ID of the enterprise resource group to which the instance belongs.
...
def get_instances_output(availability_zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         db_instance_categories: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         db_instance_modes: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         ...
                         instance_network_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
