...
def get_accounts(db_instance_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] ids: A list of Account IDs. Its element value is same as Account Name.
    :param builtins.str name_regex: A regex string to filter results by Account name.
...
def get_accounts_output(db_instance_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('alicloud:gpdb/getAccounts:getAccounts', __args__, opts=opts, typ=GetAccountsResult)
