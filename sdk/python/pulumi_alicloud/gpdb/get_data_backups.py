...
class GetDataBackupsResult:
    ...
    def backup_mode(self) -> Optional[builtins.str]:
        """
    ...
    def data_backup_id(self) -> Optional[builtins.str]:
...
def get_data_backups(backup_mode: Optional[builtins.str] = None,
                     data_backup_id: Optional[builtins.str] = None,
    ...
    :param builtins.str data_backup_id: The first ID of the resource
    ...
    :param builtins.str end_time: The query end time, which must be greater than the query start time. Format: yyyy-MM-ddTHH:mmZ(UTC time).
    :param Sequence[builtins.str] ids: A list of Databackup IDs.
    ...
    :param builtins.str start_time: The query start time. Format: yyyy-MM-ddTHH:mmZ(UTC time).
...
def get_data_backups_output(backup_mode: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            data_backup_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            data_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
