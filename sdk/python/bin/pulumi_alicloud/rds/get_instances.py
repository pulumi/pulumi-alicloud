...
def get_instances(connection_mode=None, db_type=None, engine=None, name_regex=None, output_file=None, status=None, tags=None, vpc_id=None, vswitch_id=None):
    """
    ...
    __ret__ = pulumi.runtime.invoke('alicloud:rds/getInstances:getInstances', __args__)
