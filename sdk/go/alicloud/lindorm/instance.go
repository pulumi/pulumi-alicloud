...
type Instance struct {
	...
	// (Deprecated since v1.182.0) Field `timeSeriresEngineSpecification` has been deprecated from provider version 1.182.0. New field `timeSeriesEngineSpecification` instead.
	//
