...
//						defaultSecurityGroup[0].ID().ToIDOutput().ToStringOutput(),
//					},
//				})
//				if err != nil {
//					return err
...
//			}
//			instanceId := pulumi.IDInput(pulumi.All(len(_default.Ids), defaultInstance[0].ID()).ApplyT(func(_args []interface{}) (*string, error) {
//				length := _args[0].(int)
...
// ## Import
//
// Bastion Host Share Key can be imported using the id, which consists of instanceId and host_share_key_id, e.g.
//
// ```sh
