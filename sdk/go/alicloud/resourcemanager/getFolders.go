...
//				FolderName: pulumi.String(pulumi.String(name)),
//			})
//			if err != nil {
//				return err
//			}
...
func GetFoldersOutput(ctx *pulumi.Context, args GetFoldersOutputArgs, opts ...pulumi.InvokeOption) GetFoldersResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetFoldersResultOutput, error) {
			...
			return ctx.InvokeOutput("alicloud:resourcemanager/getFolders:getFolders", args, GetFoldersResultOutput{}, options).(GetFoldersResultOutput), nil
