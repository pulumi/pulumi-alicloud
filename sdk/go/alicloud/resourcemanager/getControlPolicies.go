...
func GetControlPoliciesOutput(ctx *pulumi.Context, args GetControlPoliciesOutputArgs, opts ...pulumi.InvokeOption) GetControlPoliciesResultOutput {
	...
	return ctx.InvokeOutput("alicloud:resourcemanager/getControlPolicies:getControlPolicies", args, GetControlPoliciesResultOutput{}, options).(GetControlPoliciesResultOutput)
}
