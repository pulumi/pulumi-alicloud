...
func (o GetPrometheusMonitoringsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetPrometheusMonitoringsResult] {
	return pulumix.Output[GetPrometheusMonitoringsResult]{
