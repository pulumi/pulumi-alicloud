...
//				NetworkInterfaceId:             exampleEcsNetworkInterface.ID().ToIDOutput().ToStringOutput(),
...
// ## Import
//
// Cen Transit Router Multicast Domain Member can be imported using the id, which consists of transit_router_multicast_domain_id, groupIpAddress and network_interface_id, e.g.
//
// ```sh
