...
func (o GetTransitRouterRouteEntriesResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetTransitRouterRouteEntriesResult] {
	return pulumix.Output[GetTransitRouterRouteEntriesResult]{
