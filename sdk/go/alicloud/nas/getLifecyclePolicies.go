...
func (o GetLifecyclePoliciesResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetLifecyclePoliciesResult] {
	return pulumix.Output[GetLifecyclePoliciesResult]{
