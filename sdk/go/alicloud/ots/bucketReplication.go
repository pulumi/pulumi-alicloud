...
// 		_, err := ots.NewBucketReplication(ctx, "cross-region-replication", &ots.BucketReplicationArgs{
// 			Action: pulumi.String("ALL"),
// 			Bucket: pulumi.String("bucket-in-hangzhou"),
// 			Destination: &ots.BucketReplicationDestinationArgs{
...
// 			return err
// 		}
// 		_, err = ots.NewBucketReplication(ctx, "same-region-replication", &ots.BucketReplicationArgs{
// 			Action: pulumi.String("ALL"),
// 			Bucket: pulumi.String("bucket-in-hangzhou"),
// 			Destination: &ots.BucketReplicationDestinationArgs{
...
// 			return err
// 		}
// 		_, err = ots.NewBucketReplication(ctx, "replication-with-prefix", &ots.BucketReplicationArgs{
// 			Action: pulumi.String("ALL"),
...
// 			PrefixSet: &ots.BucketReplicationPrefixSetArgs{
...
// 			return err
// 		}
// 		_, err = ots.NewBucketReplication(ctx, "replication-with-specific-action", &ots.BucketReplicationArgs{
...
// 			return err
// 		}
// 		_, err = ots.NewBucketReplication(ctx, "replication-with-kms-encryption", &ots.BucketReplicationArgs{
// 			Action: pulumi.String("ALL"),
// 			Bucket: pulumi.String("bucket-1"),
// 			Destination: &ots.BucketReplicationDestinationArgs{
// 				Bucket:   pulumi.String("bucket-2"),
// 				Location: pulumi.String("oss-cn-hangzhou"),
// 			},
// 			EncryptionConfiguration: &ots.BucketReplicationEncryptionConfigurationArgs{
// 				ReplicaKmsKeyId: pulumi.String("<your kms key id>"),
// 			},
// 			HistoricalObjectReplication: pulumi.String("disabled"),
// 			SourceSelectionCriteria: &ots.BucketReplicationSourceSelectionCriteriaArgs{
// 				SseKmsEncryptedObjects: &ots.BucketReplicationSourceSelectionCriteriaSseKmsEncryptedObjectsArgs{
...
func NewBucketReplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("alicloud:ots/bucketReplication:BucketReplication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketReplication(ctx *pulumi.Context,
	...
	var resource BucketReplication
	err := ctx.ReadResource("alicloud:ots/bucketReplication:BucketReplication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
