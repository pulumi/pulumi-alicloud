...
func (o GetReplicationVaultRegionsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetReplicationVaultRegionsResult] {
	return pulumix.Output[GetReplicationVaultRegionsResult]{
