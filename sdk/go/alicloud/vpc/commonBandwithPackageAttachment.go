...
//
// > **NOTE:** Terraform will auto build common bandwidth package attachment while it uses `vpc.CommonBandwithPackageAttachment` to build a common bandwidth package attachment resource.
//
