...
//
// The `slb.ApplicationLoadBalancer` resource allows you to manage `paymentType = "Subscription"` load balancer, but Terraform cannot destroy it.
...
// A mapping of tags to assign to the resource. The `tags` can have a maximum of 10 tag for every load balancer instance. This filed mark as `Computed` since v1.217.1.
func (o ApplicationLoadBalancerOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *ApplicationLoadBalancer) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
