...
func NewFunction(ctx *pulumi.Context,
	...
	if args == nil {
		...
		inputs["codeChecksum"] = args.CodeChecksum
...
func GetFunction(ctx *pulumi.Context,
	...
	inputs := make(map[string]interface{})
	if state != nil {
		inputs["codeChecksum"] = state.CodeChecksum
...
func (r *Function) CodeChecksum() pulumi.StringOutput {
	return (pulumi.StringOutput)(r.s.State["codeChecksum"])
}
