...
//
// > **NOTE:** This parameter only applies during resource update. If modified in isolation without other property changes, Terraform will not trigger any action.
func (o TairInstanceOutput) EncryptionKey() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *TairInstance) pulumi.StringPtrOutput { return v.EncryptionKey }).(pulumi.StringPtrOutput)
}
...
//
// > **NOTE:** This parameter only applies during resource update. If modified in isolation without other property changes, Terraform will not trigger any action.
func (o TairInstanceOutput) EncryptionName() pulumi.StringPtrOutput {
...
//
// > **NOTE:** This parameter only applies during resource update. If modified in isolation without other property changes, Terraform will not trigger any action.
func (o TairInstanceOutput) RoleArn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *TairInstance) pulumi.StringPtrOutput { return v.RoleArn }).(pulumi.StringPtrOutput)
}
...
//
// > **NOTE:**  After TDE is enabled, it cannot be disabled. Evaluate the potential impact on your business before enabling this feature. For more information, see [Enable Transparent Data Encryption (TDE)](https://help.aliyun.com/document_detail/265913.html).
func (o TairInstanceOutput) TdeStatus() pulumi.StringOutput {
	return o.ApplyT(func(v *TairInstance) pulumi.StringOutput { return v.TdeStatus }).(pulumi.StringOutput)
}
