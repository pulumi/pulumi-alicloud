...
func NewGlobalSecurityIpGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("alicloud:redis/globalSecurityIpGroup:GlobalSecurityIpGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGlobalSecurityIpGroup(ctx *pulumi.Context,
	...
	var resource GlobalSecurityIpGroup
	err := ctx.ReadResource("alicloud:redis/globalSecurityIpGroup:GlobalSecurityIpGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
