...
func LookupKubernetesClusters(ctx *pulumi.Context, args *GetKubernetesClustersArgs) (*GetKubernetesClustersResult, error) {
	...
	outputs, err := ctx.Invoke("alicloud:cs/getKubernetesClusters:getKubernetesClusters", inputs)
	if err != nil {
		return nil, err
	}
