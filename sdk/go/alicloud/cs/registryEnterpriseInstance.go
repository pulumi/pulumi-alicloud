...
// 		_, err := cs.NewRegistryEnterpriseInstance(ctx, "my_instance", &cs.RegistryEnterpriseInstanceArgs{
...
func NewRegistryEnterpriseInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("alicloud:cs/registryEnterpriseInstance:RegistryEnterpriseInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRegistryEnterpriseInstance(ctx *pulumi.Context,
	...
	var resource RegistryEnterpriseInstance
	err := ctx.ReadResource("alicloud:cs/registryEnterpriseInstance:RegistryEnterpriseInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
