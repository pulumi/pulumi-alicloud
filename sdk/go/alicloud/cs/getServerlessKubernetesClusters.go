...
func LookupServerlessKubernetesClusters(ctx *pulumi.Context, args *GetServerlessKubernetesClustersArgs) (*GetServerlessKubernetesClustersResult, error) {
	...
	outputs, err := ctx.Invoke("alicloud:cs/getServerlessKubernetesClusters:getServerlessKubernetesClusters", inputs)
	if err != nil {
		return nil, err
	}
