...
//
// The `rds.Instance` resource allows you to manage `instanceChargeType = "Prepaid"` db instance, but Terraform cannot destroy it.
...
type Instance struct {
	...
	// - true: enable.
	// - false: disable.
	PgBouncerEnabled pulumi.BoolPtrOutput `pulumi:"pgBouncerEnabled"`
	...
	RecoveryModel pulumi.StringOutput `pulumi:"recoveryModel"`
...
type instanceState struct {
	...
	// - true: enable.
	// - false: disable.
	PgBouncerEnabled *bool `pulumi:"pgBouncerEnabled"`
	// The configuration of [AD domain](https://www.alibabacloud.com/help/en/doc-detail/349288.htm) . See `pgHbaConf` below.
...
type InstanceState struct {
	...
	// - true: enable.
	// - false: disable.
	PgBouncerEnabled pulumi.BoolPtrInput
	// The configuration of [AD domain](https://www.alibabacloud.com/help/en/doc-detail/349288.htm) . See `pgHbaConf` below.
	...
	// - simple: Enable Simple Recovery.
	// > **NOTE:** If you set this parameter to Manual, you must specify the ManualHATime parameter.
	RecoveryModel pulumi.StringPtrInput
	// The policy based on which ApsaraDB RDS retains archived backup files after the instance is released. Valid values:
	// - None: No archived backup files are retained.
	// - Lastest: Only the last archived backup file is retained.
	// - All: All the archived backup files are retained.
...
// - optimized: Enable
// - none: Disable
func (o InstanceOutput) OptimizedWrites() pulumi.StringOutput {
	return o.ApplyT(func(v *Instance) pulumi.StringOutput { return v.OptimizedWrites }).(pulumi.StringOutput)
}
...
// - true: enable.
// - false: disable.
func (o InstanceOutput) PgBouncerEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *Instance) pulumi.BoolPtrOutput { return v.PgBouncerEnabled }).(pulumi.BoolPtrOutput)
}
...
// - simple: Enable Simple Recovery.
// > **NOTE:** If you set this parameter to Manual, you must specify the ManualHATime parameter.
func (o InstanceOutput) RecoveryModel() pulumi.StringOutput {
	return o.ApplyT(func(v *Instance) pulumi.StringOutput { return v.RecoveryModel }).(pulumi.StringOutput)
}
