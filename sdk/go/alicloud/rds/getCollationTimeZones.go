...
func GetCollationTimeZonesOutput(ctx *pulumi.Context, args GetCollationTimeZonesOutputArgs, opts ...pulumi.InvokeOption) GetCollationTimeZonesResultOutput {
	...
	return ctx.InvokeOutput("alicloud:rds/getCollationTimeZones:getCollationTimeZones", args, GetCollationTimeZonesResultOutput{}, options).(GetCollationTimeZonesResultOutput)
}
