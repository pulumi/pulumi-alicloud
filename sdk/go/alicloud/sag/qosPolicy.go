...
func NewQosPolicy(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("alicloud:rocketmq/qosPolicy:QosPolicy"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource QosPolicy
	err := ctx.RegisterResource("alicloud:sag/qosPolicy:QosPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQosPolicy(ctx *pulumi.Context,
	...
	var resource QosPolicy
	err := ctx.ReadResource("alicloud:sag/qosPolicy:QosPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
