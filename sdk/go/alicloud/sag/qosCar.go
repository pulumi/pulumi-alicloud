...
func NewQosCar(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("alicloud:rocketmq/qosCar:QosCar"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource QosCar
	err := ctx.RegisterResource("alicloud:sag/qosCar:QosCar", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQosCar(ctx *pulumi.Context,
	...
	var resource QosCar
	err := ctx.ReadResource("alicloud:sag/qosCar:QosCar", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
