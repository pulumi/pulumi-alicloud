...
func NewQos(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("alicloud:rocketmq/qos:Qos"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Qos
	err := ctx.RegisterResource("alicloud:sag/qos:Qos", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQos(ctx *pulumi.Context,
	...
	var resource Qos
	err := ctx.ReadResource("alicloud:sag/qos:Qos", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
