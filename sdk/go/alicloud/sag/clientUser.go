...
func NewClientUser(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("alicloud:rocketmq/clientUser:ClientUser"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource ClientUser
	err := ctx.RegisterResource("alicloud:sag/clientUser:ClientUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClientUser(ctx *pulumi.Context,
	...
	var resource ClientUser
	err := ctx.ReadResource("alicloud:sag/clientUser:ClientUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
