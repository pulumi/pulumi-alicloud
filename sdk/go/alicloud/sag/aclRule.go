...
func NewAclRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("alicloud:sag/aclRule:AclRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAclRule(ctx *pulumi.Context,
	...
	var resource AclRule
	err := ctx.ReadResource("alicloud:sag/aclRule:AclRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
