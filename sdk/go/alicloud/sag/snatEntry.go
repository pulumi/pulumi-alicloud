...
func NewSnatEntry(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("alicloud:rocketmq/snatEntry:SnatEntry"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource SnatEntry
	err := ctx.RegisterResource("alicloud:sag/snatEntry:SnatEntry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnatEntry(ctx *pulumi.Context,
	...
	var resource SnatEntry
	err := ctx.ReadResource("alicloud:sag/snatEntry:SnatEntry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
