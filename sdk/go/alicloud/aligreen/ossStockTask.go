...
//					pulumi.String("porn"),
//				},
//				AudioAntispamFreezeConfig:      pulumi.String(pulumi.String(json0)),
//				ImageLiveFreezeConfig:          pulumi.String(pulumi.String(json1)),
//				VideoTerrorismFreezeConfig:     pulumi.String(pulumi.String(json2)),
//				ImageTerrorismFreezeConfig:     pulumi.String(pulumi.String(json3)),
//				CallbackId:                     defaultJnW8Na.ID(),
//				ImageAdFreezeConfig:            pulumi.String(pulumi.String(json4)),
//				BizType:                        pulumi.String("recommend_massmedia_template_01"),
//				AudioScenes:                    pulumi.String(pulumi.String(json5)),
//				ImagePornFreezeConfig:          pulumi.String(pulumi.String(json6)),
//				VideoLiveFreezeConfig:          pulumi.String(pulumi.String(json7)),
//				VideoPornFreezeConfig:          pulumi.String(pulumi.String(json8)),
//				VideoVoiceAntispamFreezeConfig: pulumi.String(pulumi.String(json9)),
//				VideoScenes:                    pulumi.String(pulumi.String(json10)),
//				VideoAdFreezeConfig:            pulumi.String(pulumi.String(json11)),
//			})
//			if err != nil {
//				return err
//			}
