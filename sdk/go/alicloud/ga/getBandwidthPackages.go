...
func GetBandwidthPackagesOutput(ctx *pulumi.Context, args GetBandwidthPackagesOutputArgs, opts ...pulumi.InvokeOption) GetBandwidthPackagesResultOutput {
	...
	return ctx.InvokeOutput("alicloud:ga/getBandwidthPackages:getBandwidthPackages", args, GetBandwidthPackagesResultOutput{}, options).(GetBandwidthPackagesResultOutput)
}
