...
// tmp1 = vpc.ID()
// } else {
// tmp1 = pulumi.Any(_var.Vpc_id)
// }
// var tmp2 bool
// if _var.Security_group_id == "" {
// tmp2 = 1
// } else {
// tmp2 = 0 == true
// }
...
//	    _ := index
//
// __res, err := ecs.NewSecurityGroup(ctx, fmt.Sprintf("defaultSecurityGroup-%v", key0), &ecs.SecurityGroupArgs{
...
// if _var.Availability_zone == "" {
// tmp3 = *pulumi.String(defaultInstanceTypes.Types[0].ZoneId)
// } else {
// tmp3 = pulumi.Any(_var.Availability_zone)
// }
// var tmp4 pulumi.String
// if _var.Vpc_id == "" {
// tmp4 = vpc.ID()
// } else {
// tmp4 = pulumi.Any(_var.Vpc_id)
// }
// var tmp5 bool
// if _var.Vswitch_id == "" {
// tmp5 = 1
...
// VswitchName: pulumi.Any(_var.Vswitch_name),
// CidrBlock: pulumi.Any(_var.Vswitch_cidr),
...
// if _var.Security_group_id == "" {
// tmp6 = defaultSecurityGroup.ID()
// } else {
// tmp6 = pulumi.Any(_var.Security_group_id)
// }
// var tmp7 pulumi.String
// if _var.Vswitch_id == "" {
// tmp7 = vswitch.ID()
// } else {
// tmp7 = pulumi.Any(_var.Vswitch_id)
// }
// _, err = emr.NewCluster(ctx, "defaultCluster", &emr.ClusterArgs{
...
// SshEnable: pulumi.Bool(true),
// MasterPwd: pulumi.String("ABCtest1234!"),
// RelatedClusterId: pulumi.Any(related_cluster_id),
// })
// if err != nil {
// return err
// }
