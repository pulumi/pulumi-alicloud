...
//				VpcId:     defaultrple4a.ID().ToIDOutput().ToStringOutput(),
...
//				ZoneId:              pulumi.String("cn-beijing-h"),
//				VswitchId:           defaultnYWSkl.ID().ToIDOutput().ToStringOutput(),
...
//				DbInstanceId:       defaultZ7DPgB.ID().ToIDOutput().ToStringOutput(),
