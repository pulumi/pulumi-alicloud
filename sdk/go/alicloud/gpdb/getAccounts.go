...
func GetAccounts(ctx *pulumi.Context, args *GetAccountsArgs, opts ...pulumi.InvokeOption) (*GetAccountsResult, error) {
	...
	err := ctx.Invoke("alicloud:gpdb/getAccounts:getAccounts", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetAccountsOutput(ctx *pulumi.Context, args GetAccountsOutputArgs, opts ...pulumi.InvokeOption) GetAccountsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetAccountsResultOutput, error) {
			...
			return ctx.InvokeOutput("alicloud:gpdb/getAccounts:getAccounts", args, GetAccountsResultOutput{}, options).(GetAccountsResultOutput), nil
