...
func Certificates(ctx *pulumi.Context, args *CertificatesArgs, opts ...pulumi.InvokeOption) (*CertificatesResult, error) {
	...
	err := ctx.Invoke("alicloud:sslcertificatesserviceinstance/certificates:Certificates", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
// The source of the certificate.
func (o CertificatesResultOutput) CertificateSource() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CertificatesResult) *string { return v.CertificateSource }).(pulumi.StringPtrOutput)
}

// The status of the certificate.
func (o CertificatesResultOutput) CertificateStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CertificatesResult) *string { return v.CertificateStatus }).(pulumi.StringPtrOutput)
}
...
// The ID of the certificate instance that issued this certificate.
func (o CertificatesResultOutput) InstanceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v CertificatesResult) *string { return v.InstanceId }).(pulumi.StringPtrOutput)
}
