...
func NewAccount(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("alicloud:kvstore/account:Account", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetAccount(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("alicloud:kvstore/account:Account", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &Account{s: s}, nil
...
func (r *Account) AccountPrivilege() pulumi.StringOutput {
