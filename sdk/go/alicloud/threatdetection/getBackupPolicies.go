...
func GetBackupPoliciesOutput(ctx *pulumi.Context, args GetBackupPoliciesOutputArgs, opts ...pulumi.InvokeOption) GetBackupPoliciesResultOutput {
	...
	return ctx.InvokeOutput("alicloud:threatdetection/getBackupPolicies:getBackupPolicies", args, GetBackupPoliciesResultOutput{}, options).(GetBackupPoliciesResultOutput)
}
