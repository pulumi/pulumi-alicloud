...
func (o GetConfigurationRecordersResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetConfigurationRecordersResult] {
	return pulumix.Output[GetConfigurationRecordersResult]{
