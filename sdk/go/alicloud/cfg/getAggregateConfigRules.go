...
func (o GetAggregateConfigRulesResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetAggregateConfigRulesResult] {
	return pulumix.Output[GetAggregateConfigRulesResult]{
