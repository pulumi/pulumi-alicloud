...
//				ConfigRuleId:          pulumi.Any(alicloud_config_rule.PrerequirementRule.Config_rule_id),
...
//				Params:                pulumi.String("{\"regionId\":\"{regionId}\",\"tags\":\"{\\\"terraform\\\":\\\"terraform\\\"}\",\"resourceType\":\"{resourceType}\",\"resourceIds\":\"{resourceId}\"}"),
