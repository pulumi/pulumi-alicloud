...
type DedicatedHost struct {
	...
	NetworkAttributes DedicatedHostNetworkAttributesPtrOutput `pulumi:"networkAttributes"`
...
type dedicatedHostState struct {
	...
	// dedicated host network parameters. contains the following attributes:
	NetworkAttributes *DedicatedHostNetworkAttributes `pulumi:"networkAttributes"`
	// The billing method of the dedicated host. Valid values: `PrePaid`, `PostPaid`. Default: `PostPaid`.
...
type DedicatedHostState struct {
	...
	// dedicated host network parameters. contains the following attributes:
	NetworkAttributes DedicatedHostNetworkAttributesPtrInput
	// The billing method of the dedicated host. Valid values: `PrePaid`, `PostPaid`. Default: `PostPaid`.
