...
func (o GetEcsStorageCapacityUnitsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetEcsStorageCapacityUnitsResult] {
	return pulumix.Output[GetEcsStorageCapacityUnitsResult]{
