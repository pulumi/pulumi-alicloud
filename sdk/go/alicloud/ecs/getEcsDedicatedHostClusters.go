...
func (o GetEcsDedicatedHostClustersResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetEcsDedicatedHostClustersResult] {
	return pulumix.Output[GetEcsDedicatedHostClustersResult]{
