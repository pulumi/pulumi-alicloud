...
public class EventBus extends com.pulumi.resources.CustomResource {
     ...
     */
    public EventBus(java.lang.String name, EventBusArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public EventBus(java.lang.String name, EventBusArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:eventbridge/eventBus:EventBus", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private EventBus(java.lang.String name, Output<java.lang.String> id, @Nullable EventBusState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:eventbridge/eventBus:EventBus", name, state, makeResourceOptions(options, id), false);
    }

    private static EventBusArgs makeArgs(EventBusArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
