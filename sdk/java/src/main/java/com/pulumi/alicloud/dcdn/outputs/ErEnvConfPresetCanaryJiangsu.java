...
@CustomType
public final class ErEnvConfPresetCanaryJiangsu {
    /**
    ...
    private ErEnvConfPresetCanaryJiangsu(
    ...
    public static Builder builder(ErEnvConfPresetCanaryJiangsu defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryJiangsu defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryJiangsu build() {
            return new ErEnvConfPresetCanaryJiangsu(allowedHosts, codeRev, specName);
        }
    }
}
