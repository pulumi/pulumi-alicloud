...
@CustomType
public final class ErEnvConfPresetCanaryXinjiang {
    /**
    ...
    public static Builder builder(ErEnvConfPresetCanaryXinjiang defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryXinjiang defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            ...
            return new ErEnvConfPresetCanaryXinjiang(allowedHosts, codeRev, specName);
        }
    }
}
