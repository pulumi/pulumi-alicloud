...
public final class ErEnvConfPresetCanaryTianjinArgs extends com.pulumi.resources.ResourceArgs {

    public static final ErEnvConfPresetCanaryTianjinArgs Empty = new ErEnvConfPresetCanaryTianjinArgs();
    ...
    private ErEnvConfPresetCanaryTianjinArgs() {}

    private ErEnvConfPresetCanaryTianjinArgs(ErEnvConfPresetCanaryTianjinArgs $) {
    ...
    public static Builder builder(ErEnvConfPresetCanaryTianjinArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ErEnvConfPresetCanaryTianjinArgs();
        }

        public Builder(ErEnvConfPresetCanaryTianjinArgs defaults) {
            $ = new ErEnvConfPresetCanaryTianjinArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ErEnvConfPresetCanaryTianjinArgs build() {
            return $;
        }
    }
