...
public final class GetAntiBruteForceRulesResult {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAntiBruteForceRulesResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ids(List<String> ids) {
            if (ids == null) {
              throw new MissingRequiredPropertyException("GetAntiBruteForceRulesResult", "ids");
            }
            this.ids = ids;
            return this;
        }
        ...
        public Builder names(List<String> names) {
            if (names == null) {
              throw new MissingRequiredPropertyException("GetAntiBruteForceRulesResult", "names");
            }
            this.names = names;
            return this;
        }
        ...
        public Builder rules(List<GetAntiBruteForceRulesRule> rules) {
            if (rules == null) {
              throw new MissingRequiredPropertyException("GetAntiBruteForceRulesResult", "rules");
            }
            this.rules = rules;
            return this;
        }
        ...
        public GetAntiBruteForceRulesResult build() {
            final var _resultValue = new GetAntiBruteForceRulesResult();
            _resultValue.id = id;
