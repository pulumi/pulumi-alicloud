...
public final class JobMonitorRuleState extends com.pulumi.resources.ResourceArgs {

    public static final JobMonitorRuleState Empty = new JobMonitorRuleState();
     ...
     * 
     */
    @Import(name="dtsJobId")
    private @Nullable Output<String> dtsJobId;

    /**
     * @return Migration, synchronization or subscription task ID can be by calling the [DescribeDtsJobs] get.
     * 
     */
    public Optional<Output<String>> dtsJobId() {
        return Optional.ofNullable(this.dtsJobId);
    }
    ...
    private JobMonitorRuleState() {}

    private JobMonitorRuleState(JobMonitorRuleState $) {
    ...
    public static Builder builder(JobMonitorRuleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobMonitorRuleState();
        }

        public Builder(JobMonitorRuleState defaults) {
            $ = new JobMonitorRuleState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder dtsJobId(@Nullable Output<String> dtsJobId) {
            $.dtsJobId = dtsJobId;
            return this;
        }
        ...
        public JobMonitorRuleState build() {
            return $;
        }
    }
