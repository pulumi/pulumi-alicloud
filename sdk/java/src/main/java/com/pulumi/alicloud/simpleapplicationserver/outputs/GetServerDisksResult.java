...
public final class GetServerDisksResult {
    ...
    public static final class Builder {
        ...
        public Builder disks(List<GetServerDisksDisk> disks) {
            if (disks == null) {
              throw new MissingRequiredPropertyException("GetServerDisksResult", "disks");
            }
            this.disks = disks;
            return this;
        }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetServerDisksResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ids(List<String> ids) {
            if (ids == null) {
              throw new MissingRequiredPropertyException("GetServerDisksResult", "ids");
            }
            this.ids = ids;
            return this;
        }
        ...
        public Builder names(List<String> names) {
            if (names == null) {
              throw new MissingRequiredPropertyException("GetServerDisksResult", "names");
            }
            this.names = names;
            return this;
        }
        ...
        public GetServerDisksResult build() {
            final var _resultValue = new GetServerDisksResult();
