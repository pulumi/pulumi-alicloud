    ...
    public static final class Builder {
        ...
        public TrafficMirrorFilterEgressRuleArgs build() {
            if ($.destinationCidrBlock == null) {
                throw new MissingRequiredPropertyException("TrafficMirrorFilterEgressRuleArgs", "destinationCidrBlock");
            }
            if ($.priority == null) {
                throw new MissingRequiredPropertyException("TrafficMirrorFilterEgressRuleArgs", "priority");
            }
            if ($.protocol == null) {
                throw new MissingRequiredPropertyException("TrafficMirrorFilterEgressRuleArgs", "protocol");
            }
            if ($.sourceCidrBlock == null) {
                throw new MissingRequiredPropertyException("TrafficMirrorFilterEgressRuleArgs", "sourceCidrBlock");
            }
            if ($.trafficMirrorFilterId == null) {
                throw new MissingRequiredPropertyException("TrafficMirrorFilterEgressRuleArgs", "trafficMirrorFilterId");
            }
            return $;
        }
    }
