...
@CustomType
public final class ScalingRuleHybridMetricDimension {
    ...
    public static Builder builder(ScalingRuleHybridMetricDimension defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String dimensionValue;
        public Builder() {}
        public Builder(ScalingRuleHybridMetricDimension defaults) {
        ...
        public ScalingRuleHybridMetricDimension build() {
            final var _resultValue = new ScalingRuleHybridMetricDimension();
