...
public final class DbInstancePlanPlanConfigPauseArgs extends com.pulumi.resources.ResourceArgs {

    public static final DbInstancePlanPlanConfigPauseArgs Empty = new DbInstancePlanPlanConfigPauseArgs();
    ...
    public static Builder builder(DbInstancePlanPlanConfigPauseArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DbInstancePlanPlanConfigPauseArgs();
        }

        public Builder(DbInstancePlanPlanConfigPauseArgs defaults) {
            $ = new DbInstancePlanPlanConfigPauseArgs(Objects.requireNonNull(defaults));
        }
