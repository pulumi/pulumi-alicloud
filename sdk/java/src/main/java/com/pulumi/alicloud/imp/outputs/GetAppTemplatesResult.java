...
public final class GetAppTemplatesResult {
    ...
    private final List<GetAppTemplatesTemplate> templates;
    ...
    private GetAppTemplatesResult(
        ...
        @CustomType.Parameter("templates") List<GetAppTemplatesTemplate> templates) {
        this.id = id;
        this.ids = ids;
    ...
    public static final class Builder {
        ...
        public Builder templates(GetAppTemplatesTemplate... templates) {
            ...
            return new GetAppTemplatesResult(id, ids, nameRegex, names, outputFile, status, templates);
        }
    }
}
