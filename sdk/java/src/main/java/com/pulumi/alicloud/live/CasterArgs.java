...
public final class CasterArgs extends com.pulumi.resources.ResourceArgs {

    public static final CasterArgs Empty = new CasterArgs();
     ...
     * 
     */
    @Import(name="normType", required=true)
    ...
    public static Builder builder(CasterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CasterArgs defaults) {
            $ = new CasterArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder normType(Output<Integer> normType) {
            $.normType = normType;
            return this;
        }
        ...
        public CasterArgs build() {
            if ($.normType == null) {
                throw new MissingRequiredPropertyException("CasterArgs", "normType");
            }
            if ($.paymentType == null) {
                throw new MissingRequiredPropertyException("CasterArgs", "paymentType");
            }
            return $;
        }
    }
