...
public class ResourceRecord extends com.pulumi.resources.CustomResource {
     ...
     */
    public ResourceRecord(java.lang.String name, ResourceRecordArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ResourceRecord(java.lang.String name, ResourceRecordArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:log/resourceRecord:ResourceRecord", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ResourceRecord(java.lang.String name, Output<java.lang.String> id, @Nullable ResourceRecordState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:log/resourceRecord:ResourceRecord", name, state, makeResourceOptions(options, id), false);
    }

    private static ResourceRecordArgs makeArgs(ResourceRecordArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ResourceRecordArgs.Empty : args;
    }
     ...
     */
    public static ResourceRecord get(java.lang.String name, Output<java.lang.String> id, @Nullable ResourceRecordState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
