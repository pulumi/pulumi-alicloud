...
public final class GetServerGroupsPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return A list of VServer group IDs to filter results.
     * 
     */
    ...
    /**
     * @return A regex string to filter results by VServer group name.
     * 
     */
    ...
    public static final class Builder {
        ...
        public GetServerGroupsPlainArgs build() {
            if ($.loadBalancerId == null) {
                throw new MissingRequiredPropertyException("GetServerGroupsPlainArgs", "loadBalancerId");
            }
            return $;
        }
    }
