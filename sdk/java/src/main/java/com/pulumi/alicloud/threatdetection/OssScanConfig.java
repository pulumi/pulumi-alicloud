 ...
 *             .build());
 * 
 *         final var bucketRandom = defaultRandomInteger.result();
 * 
 *         var default8j4t1R = new Bucket(&#34;default8j4t1R&#34;, BucketArgs.builder()        
 *             .bucket(bucketRandom.applyValue(bucketRandom -&gt; String.format(&#34;%s-1-%s&#34;, name,bucketRandom)))
 *             .storageClass(&#34;Standard&#34;)
 *             .build());
 * 
 *         var default9HMqfT = new Bucket(&#34;default9HMqfT&#34;, BucketArgs.builder()        
 *             .bucket(bucketRandom.applyValue(bucketRandom -&gt; String.format(&#34;%s-2-%s&#34;, name,bucketRandom)))
 *             .storageClass(&#34;Standard&#34;)
 *             .build());
 * 
 *         var defaultxBXqFQ = new Bucket(&#34;defaultxBXqFQ&#34;, BucketArgs.builder()        
 *             .bucket(bucketRandom.applyValue(bucketRandom -&gt; String.format(&#34;%s-3-%s&#34;, name,bucketRandom)))
 *             .storageClass(&#34;Standard&#34;)
 *             .build());
 * 
 *         var defaulthZvCmR = new Bucket(&#34;defaulthZvCmR&#34;, BucketArgs.builder()        
 *             .bucket(bucketRandom.applyValue(bucketRandom -&gt; String.format(&#34;%s-4-%s&#34;, name,bucketRandom)))
 *             .storageClass(&#34;Standard&#34;)
 *             .build());
 * 
