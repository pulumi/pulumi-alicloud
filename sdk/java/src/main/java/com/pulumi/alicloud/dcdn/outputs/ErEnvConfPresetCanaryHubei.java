...
@CustomType
public final class ErEnvConfPresetCanaryHubei {
    /**
    ...
    public static Builder builder(ErEnvConfPresetCanaryHubei defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryHubei defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            ...
            return new ErEnvConfPresetCanaryHubei(allowedHosts, codeRev, specName);
        }
    }
}
