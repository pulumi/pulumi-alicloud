...
public final class EcsLaunchTemplateState extends com.pulumi.resources.ResourceArgs {

    public static final EcsLaunchTemplateState Empty = new EcsLaunchTemplateState();
    ...
    private EcsLaunchTemplateState() {}
    ...
    public static Builder builder(EcsLaunchTemplateState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EcsLaunchTemplateState();
        }

        public Builder(EcsLaunchTemplateState defaults) {
            $ = new EcsLaunchTemplateState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param instanceName The name of the instance. The name must be `2` to `128` characters in length. It must start with a letter and cannot start with http:// or https://. It can contain letters, digits, colons (:), underscores (_), periods (.), commas (,), brackets ([]), and hyphens (-).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param latestVersionNumber The latest version number of the launch template.
         * 
         * @return builder
         * 
         */
        ...
        public EcsLaunchTemplateState build() {
            return $;
        }
    }
