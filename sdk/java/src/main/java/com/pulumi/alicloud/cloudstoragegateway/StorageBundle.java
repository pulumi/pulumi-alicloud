...
public class StorageBundle extends com.pulumi.resources.CustomResource {
     ...
     */
    public StorageBundle(java.lang.String name) {
     ...
     */
    public StorageBundle(java.lang.String name, StorageBundleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public StorageBundle(java.lang.String name, StorageBundleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cloudstoragegateway/storageBundle:StorageBundle", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private StorageBundle(java.lang.String name, Output<java.lang.String> id, @Nullable StorageBundleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cloudstoragegateway/storageBundle:StorageBundle", name, state, makeResourceOptions(options, id), false);
    }

    private static StorageBundleArgs makeArgs(StorageBundleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? StorageBundleArgs.Empty : args;
    }
     ...
     */
    public static StorageBundle get(java.lang.String name, Output<java.lang.String> id, @Nullable StorageBundleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
