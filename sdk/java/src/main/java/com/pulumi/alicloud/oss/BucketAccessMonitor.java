...
public class BucketAccessMonitor extends com.pulumi.resources.CustomResource {
     ...
     */
    public BucketAccessMonitor(String name) {
     ...
     */
    public BucketAccessMonitor(String name, BucketAccessMonitorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:oss/bucketAccessMonitor:BucketAccessMonitor", name, args == null ? BucketAccessMonitorArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private BucketAccessMonitor(String name, Output<String> id, @Nullable BucketAccessMonitorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:oss/bucketAccessMonitor:BucketAccessMonitor", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static BucketAccessMonitor get(String name, Output<String> id, @Nullable BucketAccessMonitorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
