...
public final class DbClusterState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param dbClusterVersion The DBCluster version. Valid values: `20.3.10.75`, `20.8.7.15`, `21.8.10.19`, `22.8.5.29`, `23.8`, `25.3`. **NOTE:** `19.15.2.2` is no longer supported. From version 1.191.0, `dbClusterVersion` can be set to `22.8.5.29`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param publicConnectionString (Available since v1.245.0) The public connection string of the cluster. Only valid when `allocatePublicConnection` is `true`.
         * 
         * @return builder
         * 
         */
