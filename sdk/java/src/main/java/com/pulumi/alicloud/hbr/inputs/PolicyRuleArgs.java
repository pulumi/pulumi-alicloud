...
public final class PolicyRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Specifies whether to enable the backup lock (immutable backup) for the rule. Valid only when `PolicyType` is set to `UDM_ECS_ONLY`. When enabled, backups generated by this rule cannot be deleted until the retention period expires.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param immutable Specifies whether to enable the backup lock (immutable backup) for the rule. Valid only when `PolicyType` is set to `UDM_ECS_ONLY`. When enabled, backups generated by this rule cannot be deleted until the retention period expires.
         * 
         * @return builder
         * 
         */
