...
public final class GetPolicyVersionsResult {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetPolicyVersionsResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ids(List<String> ids) {
            if (ids == null) {
              throw new MissingRequiredPropertyException("GetPolicyVersionsResult", "ids");
            }
            this.ids = ids;
            return this;
        }
        ...
        public Builder policyName(String policyName) {
            if (policyName == null) {
              throw new MissingRequiredPropertyException("GetPolicyVersionsResult", "policyName");
            }
        ...
        public Builder policyType(String policyType) {
            if (policyType == null) {
              throw new MissingRequiredPropertyException("GetPolicyVersionsResult", "policyType");
            }
        ...
        public Builder versions(List<GetPolicyVersionsVersion> versions) {
            if (versions == null) {
              throw new MissingRequiredPropertyException("GetPolicyVersionsResult", "versions");
            }
