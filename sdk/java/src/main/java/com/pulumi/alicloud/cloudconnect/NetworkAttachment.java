...
public class NetworkAttachment extends com.pulumi.resources.CustomResource {
    ...
    public NetworkAttachment(java.lang.String name, NetworkAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cloudconnect/networkAttachment:NetworkAttachment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private NetworkAttachment(java.lang.String name, Output<java.lang.String> id, @Nullable NetworkAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cloudconnect/networkAttachment:NetworkAttachment", name, state, makeResourceOptions(options, id), false);
    }
