...
public final class JobState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="executeMode")
    private @Nullable Output<String> executeMode;

    /**
     * @return Task execution mode, the possible results are as follows:
     * 
     */
    public Optional<Output<String>> executeMode() {
        return Optional.ofNullable(this.executeMode);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder executeMode(@Nullable Output<String> executeMode) {
         ...
         * 
         */
        public Builder timeConfig(@Nullable Output<JobTimeConfigArgs> timeConfig) {
