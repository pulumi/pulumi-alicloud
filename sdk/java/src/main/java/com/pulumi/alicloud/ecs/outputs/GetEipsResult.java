...
public final class GetEipsResult {
    ...
    private GetEipsResult(
        ...
        @CustomType.Parameter("addresses") List<GetEipsAddress> addresses,
        ...
        @CustomType.Parameter("eips") List<GetEipsEip> eips,
    ...
    public static final class Builder {
        ...
        public Builder tags(@Nullable Map<String,Object> tags) {
            ...
            return new GetEipsResult(addressName, addresses, associatedInstanceId, associatedInstanceType, dryRun, eips, enableDetails, id, ids, includeReservationData, ipAddress, ipAddresses, isp, lockReason, nameRegex, names, outputFile, paymentType, resourceGroupId, segmentInstanceId, status, tags);
        }
    }
}
