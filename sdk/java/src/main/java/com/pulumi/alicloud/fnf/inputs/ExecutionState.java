...
public final class ExecutionState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="executionName")
    private @Nullable Output<String> executionName;

    /**
     * @return The name of the execution.
     * 
     */
    public Optional<Output<String>> executionName() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder executionName(@Nullable Output<String> executionName) {
