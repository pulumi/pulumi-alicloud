...
public final class KeywordLibState extends com.pulumi.resources.ResourceArgs {

    public static final KeywordLibState Empty = new KeywordLibState();
     ...
     * 
     */
    @Import(name="keywordLibName")
    private @Nullable Output<String> keywordLibName;
     ...
     * 
     */
    public Optional<Output<String>> keywordLibName() {
        return Optional.ofNullable(this.keywordLibName);
    }
    ...
    private KeywordLibState() {}

    private KeywordLibState(KeywordLibState $) {
    ...
    public static Builder builder(KeywordLibState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(KeywordLibState defaults) {
            $ = new KeywordLibState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder keywordLibName(@Nullable Output<String> keywordLibName) {
