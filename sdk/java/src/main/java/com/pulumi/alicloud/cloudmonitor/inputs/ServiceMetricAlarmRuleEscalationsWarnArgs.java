...
public final class ServiceMetricAlarmRuleEscalationsWarnArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceMetricAlarmRuleEscalationsWarnArgs Empty = new ServiceMetricAlarmRuleEscalationsWarnArgs();
    ...
    private ServiceMetricAlarmRuleEscalationsWarnArgs() {}

    private ServiceMetricAlarmRuleEscalationsWarnArgs(ServiceMetricAlarmRuleEscalationsWarnArgs $) {
    ...
    public static Builder builder(ServiceMetricAlarmRuleEscalationsWarnArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceMetricAlarmRuleEscalationsWarnArgs();
        }

        public Builder(ServiceMetricAlarmRuleEscalationsWarnArgs defaults) {
            $ = new ServiceMetricAlarmRuleEscalationsWarnArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceMetricAlarmRuleEscalationsWarnArgs build() {
            return $;
        }
    }
