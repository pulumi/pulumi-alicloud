...
public final class ErEnvConfPresetCanaryJiangxiArgs extends com.pulumi.resources.ResourceArgs {

    public static final ErEnvConfPresetCanaryJiangxiArgs Empty = new ErEnvConfPresetCanaryJiangxiArgs();
    ...
    private ErEnvConfPresetCanaryJiangxiArgs() {}

    private ErEnvConfPresetCanaryJiangxiArgs(ErEnvConfPresetCanaryJiangxiArgs $) {
    ...
    public static Builder builder(ErEnvConfPresetCanaryJiangxiArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ErEnvConfPresetCanaryJiangxiArgs();
        }

        public Builder(ErEnvConfPresetCanaryJiangxiArgs defaults) {
            $ = new ErEnvConfPresetCanaryJiangxiArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ErEnvConfPresetCanaryJiangxiArgs build() {
            return $;
        }
    }
