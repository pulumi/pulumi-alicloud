...
public final class GetVirtualHostsResult {
    ...
    public static final class Builder {
        ...
        public Builder hosts(List<GetVirtualHostsHost> hosts) {
            if (hosts == null) {
              throw new MissingRequiredPropertyException("GetVirtualHostsResult", "hosts");
            }
            this.hosts = hosts;
            return this;
        }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetVirtualHostsResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ids(List<String> ids) {
            if (ids == null) {
              throw new MissingRequiredPropertyException("GetVirtualHostsResult", "ids");
            }
            this.ids = ids;
            return this;
        }
        ...
        public Builder instanceId(String instanceId) {
            if (instanceId == null) {
              throw new MissingRequiredPropertyException("GetVirtualHostsResult", "instanceId");
            }
        ...
        public Builder names(List<String> names) {
            if (names == null) {
              throw new MissingRequiredPropertyException("GetVirtualHostsResult", "names");
            }
            this.names = names;
            return this;
        }
