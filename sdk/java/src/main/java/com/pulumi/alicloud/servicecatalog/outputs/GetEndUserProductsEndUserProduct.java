...
public final class GetEndUserProductsEndUserProduct {
    ...
    public static final class Builder {
        ...
        public Builder createTime(String createTime) {
            if (createTime == null) {
              throw new MissingRequiredPropertyException("GetEndUserProductsEndUserProduct", "createTime");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetEndUserProductsEndUserProduct", "description");
            }
        ...
        public Builder hasDefaultLaunchOption(Boolean hasDefaultLaunchOption) {
            if (hasDefaultLaunchOption == null) {
              throw new MissingRequiredPropertyException("GetEndUserProductsEndUserProduct", "hasDefaultLaunchOption");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetEndUserProductsEndUserProduct", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder productArn(String productArn) {
            if (productArn == null) {
              throw new MissingRequiredPropertyException("GetEndUserProductsEndUserProduct", "productArn");
            }
        ...
        public Builder productId(String productId) {
            if (productId == null) {
              throw new MissingRequiredPropertyException("GetEndUserProductsEndUserProduct", "productId");
            }
        ...
        public Builder productName(String productName) {
            if (productName == null) {
              throw new MissingRequiredPropertyException("GetEndUserProductsEndUserProduct", "productName");
            }
        ...
        public Builder productType(String productType) {
            if (productType == null) {
              throw new MissingRequiredPropertyException("GetEndUserProductsEndUserProduct", "productType");
            }
        ...
        public Builder providerName(String providerName) {
            if (providerName == null) {
              throw new MissingRequiredPropertyException("GetEndUserProductsEndUserProduct", "providerName");
            }
