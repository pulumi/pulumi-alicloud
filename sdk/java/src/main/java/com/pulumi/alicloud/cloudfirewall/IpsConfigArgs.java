...
public final class IpsConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final IpsConfigArgs Empty = new IpsConfigArgs();
    ...
    private IpsConfigArgs() {}

    private IpsConfigArgs(IpsConfigArgs $) {
    ...
    public static Builder builder(IpsConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(IpsConfigArgs defaults) {
            $ = new IpsConfigArgs(Objects.requireNonNull(defaults));
        }
