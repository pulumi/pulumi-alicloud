...
@CustomType
public final class ErEnvConfPresetCanaryJilin {
    /**
    ...
    public static Builder builder(ErEnvConfPresetCanaryJilin defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryJilin defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryJilin build() {
            return new ErEnvConfPresetCanaryJilin(allowedHosts, codeRev, specName);
        }
    }
}
