...
public class RdsDbProxy extends com.pulumi.resources.CustomResource {
     ...
     */
    public RdsDbProxy(java.lang.String name) {
     ...
     */
    public RdsDbProxy(java.lang.String name, RdsDbProxyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RdsDbProxy(java.lang.String name, RdsDbProxyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:rds/rdsDbProxy:RdsDbProxy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RdsDbProxy(java.lang.String name, Output<java.lang.String> id, @Nullable RdsDbProxyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:rds/rdsDbProxy:RdsDbProxy", name, state, makeResourceOptions(options, id), false);
    }

    private static RdsDbProxyArgs makeArgs(RdsDbProxyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RdsDbProxyArgs.Empty : args;
    }
     ...
     */
    public static RdsDbProxy get(java.lang.String name, Output<java.lang.String> id, @Nullable RdsDbProxyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
