    ...
    public static final class Builder {
        ...
        public Builder parameterName(String parameterName) {
            if (parameterName == null) {
              throw new MissingRequiredPropertyException("GetAggregateCompliancePacksPackConfigRuleConfigRuleParameter", "parameterName");
            }
        ...
        public Builder parameterValue(String parameterValue) {
            if (parameterValue == null) {
              throw new MissingRequiredPropertyException("GetAggregateCompliancePacksPackConfigRuleConfigRuleParameter", "parameterValue");
            }
        ...
        public Builder required(Boolean required) {
            if (required == null) {
              throw new MissingRequiredPropertyException("GetAggregateCompliancePacksPackConfigRuleConfigRuleParameter", "required");
            }
