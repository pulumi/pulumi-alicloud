...
public final class OssStockTaskState extends com.pulumi.resources.ResourceArgs {

    public static final OssStockTaskState Empty = new OssStockTaskState();
    ...
    private OssStockTaskState() {}

    private OssStockTaskState(OssStockTaskState $) {
    ...
    public static Builder builder(OssStockTaskState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OssStockTaskState();
        }

        public Builder(OssStockTaskState defaults) {
            $ = new OssStockTaskState(Objects.requireNonNull(defaults));
        }
        ...
        public OssStockTaskState build() {
            return $;
        }
    }
