...
@CustomType
public final class ErEnvConfPresetCanaryYunnan {
    /**
    ...
    private ErEnvConfPresetCanaryYunnan(
    ...
    public static Builder builder(ErEnvConfPresetCanaryYunnan defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryYunnan defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryYunnan build() {
            return new ErEnvConfPresetCanaryYunnan(allowedHosts, codeRev, specName);
        }
    }
}
