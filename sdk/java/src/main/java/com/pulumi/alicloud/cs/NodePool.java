...
import com.pulumi.alicloud.cs.outputs.NodePoolInstancePattern;
...
import com.pulumi.alicloud.cs.outputs.NodePoolResourcePoolOptions;
 ...
 * 
 * Create Target mode private pools with `alicloud.ecs.CapacityReservation` and `alicloud.ecs.ElasticityAssurance`, then reference them in the node pool via `resourcePoolOptions`. To use a private pool, the node pool must specify `instanceTypes` that include the private pool&#39;s instance type, and its vSwitch must be in the same zone as the private pool.
 * 
 * <pre>
 * {@code
 * package generated_program;
 ...
 *     public static void stack(Context ctx) {
 *         final var config = ctx.config();
 *         final var name = config.get("name").orElse("tf-example-resource-pool-options");
 *         final var default = AlicloudFunctions.getZones(GetZonesArgs.builder()
 *             .availableResourceCreation("VSwitch")
 *             .build());
 * 
 *         final var cloudEssd = EcsFunctions.getInstanceTypes(GetInstanceTypesArgs.builder()
 ...
 *             .nameRegex("^default-NODELETING-ACK$")
 *             .build());
 * 
 *         final var vsw1 = VpcFunctions.getSwitches(GetSwitchesArgs.builder()
 ...
 *             .build());
 * 
 *         final var defaultGetManagedKubernetesClusters = CsFunctions.getManagedKubernetesClusters(GetManagedKubernetesClustersArgs.builder()
 *             .nameRegex("^cluster-")
 *             .build());
 * 
 ...
 *             .instanceAmount(1)
 *             .instanceType(cloudEssd.instanceTypes()[0].id())
 *             .matchCriteria("Target")
 *             .zoneIds(default_.zones()[0].id())
 *             .build());
 * 
 ...
 *         var privatePoolFirst = new NodePool("privatePoolFirst", NodePoolArgs.builder()
 *             .nodePoolName(String.format("%s-first", name))
 *             .clusterId(defaultGetManagedKubernetesClusters.ids()[0])
 *             .vswitchIds(vsw1.ids()[0])
 *             .instanceChargeType("PostPaid")
 *             .systemDiskCategory("cloud_essd")
 *             .systemDiskSize(120)
 *             .multiAzPolicy("PRIORITY")
 *             .desiredSize("0")
 *             .instanceTypes(cloudEssd.instanceTypes()[0].id())
 *             .resourcePoolOptions(NodePoolResourcePoolOptionsArgs.builder()
 *                 .strategy("PrivatePoolFirst")
 *                 .privatePoolIds(defaultCapacityReservation.id())
 *                 .build())
 *             .build());
 * 
 *         // PrivatePoolOnly: use the specified private pools only; private_pool_ids is required.
 *         var privatePoolOnly = new NodePool("privatePoolOnly", NodePoolArgs.builder()
 *             .nodePoolName(String.format("%s-only", name))
 *             .clusterId(defaultGetManagedKubernetesClusters.ids()[0])
 *             .vswitchIds(vsw1.ids()[0])
 *             .instanceChargeType("PostPaid")
 *             .systemDiskCategory("cloud_essd")
...
public class NodePool extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="autoMode", refs={NodePoolAutoMode.class}, tree="[0]")
    private Output<NodePoolAutoMode> autoMode;
     ...
     * 
     */
    public Output<NodePoolAutoMode> autoMode() {
     ...
     * 
     */
    @Export(name="instanceMetadataOptions", refs={NodePoolInstanceMetadataOptions.class}, tree="[0]")
    private Output<NodePoolInstanceMetadataOptions> instanceMetadataOptions;

    /**
     * @return ECS instance metadata access configuration. See `instanceMetadataOptions` below.
     * 
     */
    public Output<NodePoolInstanceMetadataOptions> instanceMetadataOptions() {
     ...
     * 
     */
    @Export(name="instancePatterns", refs={List.class,NodePoolInstancePattern.class}, tree="[0,1]")
    private Output</* @Nullable */ List<NodePoolInstancePattern>> instancePatterns;

    /**
     * @return Instance property configuration. See `instancePatterns` below.
     * 
     */
    public Output<Optional<List<NodePoolInstancePattern>>> instancePatterns() {
        return Codegen.optional(this.instancePatterns);
    }
    /**
     ...
     * 
     */
    @Export(name="preUserData", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> preUserData;

    /**
     * @return Node pre custom data, base64-encoded, the script executed before the node is initialized.
     * 
     */
    public Output<Optional<String>> preUserData() {
        return Codegen.optional(this.preUserData);
    }
    /**
     ...
     * 
     */
    @Export(name="resourcePoolOptions", refs={NodePoolResourcePoolOptions.class}, tree="[0]")
    private Output</* @Nullable */ NodePoolResourcePoolOptions> resourcePoolOptions;
     ...
     * 
     */
    public Output<Optional<NodePoolResourcePoolOptions>> resourcePoolOptions() {
        return Codegen.optional(this.resourcePoolOptions);
    }
    /**
    ...
    public NodePool(java.lang.String name, NodePoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cs/nodePool:NodePool", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private NodePool(java.lang.String name, Output<java.lang.String> id, @Nullable NodePoolState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cs/nodePool:NodePool", name, state, makeResourceOptions(options, id), false);
    }
