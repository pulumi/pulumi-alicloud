...
@CustomType
public final class InstanceSecurityIpGroup {
    /**
    ...
    public static Builder builder(InstanceSecurityIpGroup defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String securityIpList;
        public Builder() {}
        public Builder(InstanceSecurityIpGroup defaults) {
        ...
        public InstanceSecurityIpGroup build() {
            final var _resultValue = new InstanceSecurityIpGroup();
