...
public final class DdosFunctions {
     ...
     *             .build());
     * 
     *         ctx.export(&#34;instance&#34;, instanceDdosBgpInstances.applyValue(getDdosBgpInstancesResult -&gt; getDdosBgpInstancesResult).stream().map(element -&gt; element.id()).collect(toList()));
     *     }
     * }
     * ```
