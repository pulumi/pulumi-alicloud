...
public final class GatewayFileShareState extends com.pulumi.resources.ResourceArgs {

    public static final GatewayFileShareState Empty = new GatewayFileShareState();
     ...
     * 
     */
    @Import(name="gatewayFileShareName")
    private @Nullable Output<String> gatewayFileShareName;
     ...
     * 
     */
    public Optional<Output<String>> gatewayFileShareName() {
        return Optional.ofNullable(this.gatewayFileShareName);
    }
    ...
    private GatewayFileShareState() {}

    private GatewayFileShareState(GatewayFileShareState $) {
    ...
    public static Builder builder(GatewayFileShareState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GatewayFileShareState();
        }

        public Builder(GatewayFileShareState defaults) {
            $ = new GatewayFileShareState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder gatewayFileShareName(@Nullable Output<String> gatewayFileShareName) {
        ...
        /**
         * @param indexId The ID of the file share.
         * 
         * @return builder
         * 
         */
        ...
        public GatewayFileShareState build() {
            return $;
        }
    }
