...
@CustomType
public final class ErEnvConfPresetCanaryOverseas {
    /**
    ...
    public static Builder builder(ErEnvConfPresetCanaryOverseas defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryOverseas defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryOverseas build() {
            return new ErEnvConfPresetCanaryOverseas(allowedHosts, codeRev, specName);
        }
    }
}
