...
public final class GetOpenApiProductsResult {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetOpenApiProductsResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ids(List<String> ids) {
            if (ids == null) {
              throw new MissingRequiredPropertyException("GetOpenApiProductsResult", "ids");
            }
            this.ids = ids;
            return this;
        }
        ...
        public Builder names(List<String> names) {
            if (names == null) {
              throw new MissingRequiredPropertyException("GetOpenApiProductsResult", "names");
            }
            this.names = names;
            return this;
        }
        ...
        public Builder products(List<GetOpenApiProductsProduct> products) {
            if (products == null) {
              throw new MissingRequiredPropertyException("GetOpenApiProductsResult", "products");
            }
