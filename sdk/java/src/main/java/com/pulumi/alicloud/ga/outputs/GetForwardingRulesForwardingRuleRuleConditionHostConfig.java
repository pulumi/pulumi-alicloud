...
public final class GetForwardingRulesForwardingRuleRuleConditionHostConfig {
    ...
    public static final class Builder {
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetForwardingRulesForwardingRuleRuleConditionHostConfig", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetForwardingRulesForwardingRuleRuleConditionHostConfig build() {
            final var _resultValue = new GetForwardingRulesForwardingRuleRuleConditionHostConfig();
