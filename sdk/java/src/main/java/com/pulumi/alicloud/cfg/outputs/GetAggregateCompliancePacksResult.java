...
public final class GetAggregateCompliancePacksResult {
     ...
     * 
     */
    private final List<GetAggregateCompliancePacksPack> packs;
    /**
    ...
    private GetAggregateCompliancePacksResult(
        ...
        @CustomType.Parameter("packs") List<GetAggregateCompliancePacksPack> packs,
    ...
    public static final class Builder {
        ...
        public Builder status(@Nullable String status) {
            ...
            return new GetAggregateCompliancePacksResult(aggregatorId, enableDetails, id, ids, nameRegex, names, outputFile, packs, status);
        }
    }
}
