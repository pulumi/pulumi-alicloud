...
public final class RdsAccountState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final RdsAccountState Empty = new RdsAccountState();
    ...
    private RdsAccountState() {}

    private RdsAccountState(RdsAccountState $) {
    ...
    public static Builder builder(RdsAccountState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RdsAccountState defaults) {
            $ = new RdsAccountState(Objects.requireNonNull(defaults));
        }
