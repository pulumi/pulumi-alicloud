...
public final class ErEnvConfPresetCanaryHeilongjiangArgs extends com.pulumi.resources.ResourceArgs {

    public static final ErEnvConfPresetCanaryHeilongjiangArgs Empty = new ErEnvConfPresetCanaryHeilongjiangArgs();
    ...
    private ErEnvConfPresetCanaryHeilongjiangArgs() {}

    private ErEnvConfPresetCanaryHeilongjiangArgs(ErEnvConfPresetCanaryHeilongjiangArgs $) {
    ...
    public static Builder builder(ErEnvConfPresetCanaryHeilongjiangArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ErEnvConfPresetCanaryHeilongjiangArgs();
        }

        public Builder(ErEnvConfPresetCanaryHeilongjiangArgs defaults) {
            $ = new ErEnvConfPresetCanaryHeilongjiangArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ErEnvConfPresetCanaryHeilongjiangArgs build() {
            return $;
        }
    }
