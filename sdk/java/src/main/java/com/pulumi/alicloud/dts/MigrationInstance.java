...
public class MigrationInstance extends com.pulumi.resources.CustomResource {
     ...
     */
    public MigrationInstance(java.lang.String name) {
     ...
     */
    public MigrationInstance(java.lang.String name, MigrationInstanceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MigrationInstance(java.lang.String name, MigrationInstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:dts/migrationInstance:MigrationInstance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MigrationInstance(java.lang.String name, Output<java.lang.String> id, @Nullable MigrationInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:dts/migrationInstance:MigrationInstance", name, state, makeResourceOptions(options, id), false);
    }

    private static MigrationInstanceArgs makeArgs(MigrationInstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MigrationInstanceArgs.Empty : args;
    }
     ...
     */
    public static MigrationInstance get(java.lang.String name, Output<java.lang.String> id, @Nullable MigrationInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
