...
public final class AggregateConfigRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder aggregateConfigRuleName(Output<String> aggregateConfigRuleName) {
         ...
         * 
         */
        public Builder configRuleTriggerTypes(Output<String> configRuleTriggerTypes) {
         ...
         * 
         */
        public Builder resourceTypesScopes(Output<List<String>> resourceTypesScopes) {
