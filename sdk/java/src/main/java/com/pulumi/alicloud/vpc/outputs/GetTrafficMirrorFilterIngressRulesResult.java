...
public final class GetTrafficMirrorFilterIngressRulesResult {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressRulesResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ids(List<String> ids) {
            if (ids == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressRulesResult", "ids");
            }
            this.ids = ids;
            return this;
        }
        ...
        public Builder rules(List<GetTrafficMirrorFilterIngressRulesRule> rules) {
            if (rules == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressRulesResult", "rules");
            }
            this.rules = rules;
            return this;
        }
        ...
        public Builder trafficMirrorFilterId(String trafficMirrorFilterId) {
            if (trafficMirrorFilterId == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressRulesResult", "trafficMirrorFilterId");
            }
