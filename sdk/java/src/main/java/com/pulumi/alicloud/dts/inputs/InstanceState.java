...
public final class InstanceState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param period The billing method of the subscription instance. Value: `Year`, `Month`. **NOTE:** This parameter is valid and must be passed in only when `payment_type` is `Subscription`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param sourceEndpointEngineName (ForceNew, Optional) Source instance database engine type.
         * - **MySQL**:MySQL databases (including RDS MySQL and self-built MySQL).
         * - **PolarDB**:PolarDB MySQL.
         * - **polardb_o**:PolarDB O engine.
         * - **polardb_pg**:PolarDB PostgreSQL.
