...
public final class AlarmContactState extends com.pulumi.resources.ResourceArgs {

    public static final AlarmContactState Empty = new AlarmContactState();

    /**
     * The name of the alarm contact. The length should between 2 and 40 characters.
     * 
     */
    @Import(name="alarmContactName")
    private @Nullable Output<String> alarmContactName;

    /**
     * @return The name of the alarm contact. The length should between 2 and 40 characters.
     * 
     */
    public Optional<Output<String>> alarmContactName() {
        return Optional.ofNullable(this.alarmContactName);
    }
    ...
    private AlarmContactState() {}

    private AlarmContactState(AlarmContactState $) {
    ...
    public static Builder builder(AlarmContactState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlarmContactState();
        }

        public Builder(AlarmContactState defaults) {
            $ = new AlarmContactState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder alarmContactName(@Nullable Output<String> alarmContactName) {
        ...
        public AlarmContactState build() {
            return $;
        }
    }
