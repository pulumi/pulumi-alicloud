...
@CustomType
public final class ErEnvConfPresetCanaryShandong {
    /**
    ...
    private ErEnvConfPresetCanaryShandong(
    ...
    public static Builder builder(ErEnvConfPresetCanaryShandong defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryShandong defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryShandong build() {
            return new ErEnvConfPresetCanaryShandong(allowedHosts, codeRev, specName);
        }
    }
}
