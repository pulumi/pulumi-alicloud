...
public final class GetSynchronizationJobsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSynchronizationJobsArgs Empty = new GetSynchronizationJobsArgs();
    ...
    /**
     * @return The status of the resource. Valid values: `Synchronizing`, `Suspending`. `Downgrade`, `Failed`, `Finished`, `InitializeFailed`, `Locked`, `Modifying`, `NotConfigured`, `NotStarted`, `PreCheckPass`, `PrecheckFailed`, `Prechecking`, `Retrying`, `Upgrade`.
     * 
     */
    ...
    private GetSynchronizationJobsArgs() {}

    private GetSynchronizationJobsArgs(GetSynchronizationJobsArgs $) {
    ...
    public static Builder builder(GetSynchronizationJobsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSynchronizationJobsArgs();
        }

        public Builder(GetSynchronizationJobsArgs defaults) {
            $ = new GetSynchronizationJobsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSynchronizationJobsArgs build() {
            return $;
        }
    }
