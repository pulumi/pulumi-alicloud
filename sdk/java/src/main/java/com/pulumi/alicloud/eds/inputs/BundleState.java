...
public final class BundleState extends com.pulumi.resources.ResourceArgs {

    public static final BundleState Empty = new BundleState();
     ...
     * 
     */
    @Import(name="userDiskSizeGibs")
    private @Nullable Output<List<Integer>> userDiskSizeGibs;
     ...
     * 
     */
    public Optional<Output<List<Integer>>> userDiskSizeGibs() {
        return Optional.ofNullable(this.userDiskSizeGibs);
    }
    ...
    public static Builder builder(BundleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BundleState defaults) {
            $ = new BundleState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder userDiskSizeGibs(@Nullable Output<List<Integer>> userDiskSizeGibs) {
