...
public final class GetPrometheusArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetPrometheusArgs Empty = new GetPrometheusArgs();
    ...
    private GetPrometheusArgs() {}

    private GetPrometheusArgs(GetPrometheusArgs $) {
    ...
    public static Builder builder(GetPrometheusArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPrometheusArgs();
        }

        public Builder(GetPrometheusArgs defaults) {
            $ = new GetPrometheusArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPrometheusArgs build() {
            return $;
        }
    }
