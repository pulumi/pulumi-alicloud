...
@CustomType
public final class DiJobResourceSettingsScheduleResourceSettings {
    /**
    ...
    private DiJobResourceSettingsScheduleResourceSettings() {}
    /**
     * @return Scheduling resource group cu
     * 
     */
    ...
    public static Builder builder(DiJobResourceSettingsScheduleResourceSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String resourceGroupIdentifier;
        public Builder() {}
        public Builder(DiJobResourceSettingsScheduleResourceSettings defaults) {
        ...
        public DiJobResourceSettingsScheduleResourceSettings build() {
            final var _resultValue = new DiJobResourceSettingsScheduleResourceSettings();
