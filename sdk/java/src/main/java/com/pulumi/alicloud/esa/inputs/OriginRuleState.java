...
public final class OriginRuleState extends com.pulumi.resources.ResourceArgs {

    public static final OriginRuleState Empty = new OriginRuleState();
    ...
    public static Builder builder(OriginRuleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(OriginRuleState defaults) {
            $ = new OriginRuleState(Objects.requireNonNull(defaults));
        }

        /**
         * @param configId Back-to-source rule configuration ID
         * 
         * @return builder
         * 
         */
