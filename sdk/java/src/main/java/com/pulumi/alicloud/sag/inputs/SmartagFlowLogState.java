...
public final class SmartagFlowLogState extends com.pulumi.resources.ResourceArgs {

    public static final SmartagFlowLogState Empty = new SmartagFlowLogState();
    ...
    private SmartagFlowLogState() {}

    private SmartagFlowLogState(SmartagFlowLogState $) {
    ...
    public static Builder builder(SmartagFlowLogState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SmartagFlowLogState();
        }

        public Builder(SmartagFlowLogState defaults) {
            $ = new SmartagFlowLogState(Objects.requireNonNull(defaults));
        }
        ...
        public SmartagFlowLogState build() {
            return $;
        }
    }
