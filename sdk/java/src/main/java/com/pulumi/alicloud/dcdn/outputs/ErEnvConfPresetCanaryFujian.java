...
@CustomType
public final class ErEnvConfPresetCanaryFujian {
    /**
    ...
    private ErEnvConfPresetCanaryFujian(
    ...
    public static Builder builder(ErEnvConfPresetCanaryFujian defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryFujian defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryFujian build() {
            return new ErEnvConfPresetCanaryFujian(allowedHosts, codeRev, specName);
        }
    }
}
