...
public final class CompliancePackState extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<String>> compliancePackName() {
        return Optional.ofNullable(this.compliancePackName);
    }
    ...
    private CompliancePackState() {}

    private CompliancePackState(CompliancePackState $) {
    ...
    public static Builder builder(CompliancePackState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CompliancePackState();
        }

        public Builder(CompliancePackState defaults) {
            $ = new CompliancePackState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder compliancePackName(@Nullable Output<String> compliancePackName) {
        ...
        /**
         * @param status The status of the Compliance Pack.
         * 
         * @return builder
         * 
         */
        ...
        public CompliancePackState build() {
            return $;
        }
    }
