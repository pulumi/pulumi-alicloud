...
@CustomType
public final class StarRocksInstanceObserverNodeGroup {
    /**
    ...
    public static Builder builder(StarRocksInstanceObserverNodeGroup defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zoneId;
        public Builder() {}
        public Builder(StarRocksInstanceObserverNodeGroup defaults) {
        ...
        public StarRocksInstanceObserverNodeGroup build() {
            final var _resultValue = new StarRocksInstanceObserverNodeGroup();
            _resultValue.cu = cu;
