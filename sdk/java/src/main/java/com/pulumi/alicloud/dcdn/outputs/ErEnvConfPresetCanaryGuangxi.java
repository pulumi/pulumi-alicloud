...
@CustomType
public final class ErEnvConfPresetCanaryGuangxi {
    /**
    ...
    private ErEnvConfPresetCanaryGuangxi(
    ...
    public static Builder builder(ErEnvConfPresetCanaryGuangxi defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryGuangxi defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryGuangxi build() {
            return new ErEnvConfPresetCanaryGuangxi(allowedHosts, codeRev, specName);
        }
    }
}
