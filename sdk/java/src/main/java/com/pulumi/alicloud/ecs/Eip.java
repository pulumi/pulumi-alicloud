...
public class Eip extends com.pulumi.resources.CustomResource {
    ...
    public Eip(java.lang.String name, @Nullable EipArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:ecs/eip:Eip", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Eip(java.lang.String name, Output<java.lang.String> id, @Nullable EipState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:ecs/eip:Eip", name, state, makeResourceOptions(options, id), false);
    }
