...
public final class InstanceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param autoRenewPeriod The auto renew period. Valid values: `1`,`3`, `6`, `12`, `24`, `36`. **NOTE:** The attribute `autoRenew` is valid when the attribute is `true`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param password The password of the simple application server. The password must be 8 to 30 characters in length. It must contain at least three of the following character types: uppercase letters, lowercase letters, digits, and special characters. Special characters include: `( ) ~ ! {@literal @} # $ % ^ &amp; * - + = | { } [ ] : ; &lt; &gt; , . ? /`.
         * 
         * @return builder
         * 
         */
