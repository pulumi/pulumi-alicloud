...
public final class GetSecurityPoliciesResult {
    ...
    private final @Nullable List<String> securityPolicyNames;
    ...
    private GetSecurityPoliciesResult(
        ...
        @CustomType.Parameter("securityPolicyNames") @Nullable List<String> securityPolicyNames,
    ...
    public static final class Builder {
        ...
        public Builder tags(@Nullable Map<String,Object> tags) {
            ...
            return new GetSecurityPoliciesResult(id, ids, nameRegex, names, outputFile, policies, resourceGroupId, securityPolicyNames, status, tags);
        }
    }
}
