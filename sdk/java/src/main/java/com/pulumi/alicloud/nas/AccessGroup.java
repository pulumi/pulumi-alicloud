...
public class AccessGroup extends com.pulumi.resources.CustomResource {
     ...
     */
    public AccessGroup(java.lang.String name, @Nullable AccessGroupArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AccessGroup(java.lang.String name, @Nullable AccessGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:nas/accessGroup:AccessGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AccessGroup(java.lang.String name, Output<java.lang.String> id, @Nullable AccessGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:nas/accessGroup:AccessGroup", name, state, makeResourceOptions(options, id), false);
    }

    private static AccessGroupArgs makeArgs(@Nullable AccessGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
