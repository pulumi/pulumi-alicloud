...
public class LogConfig extends com.pulumi.resources.CustomResource {
     ...
     */
    public LogConfig(java.lang.String name) {
     ...
     */
    public LogConfig(java.lang.String name, LogConfigArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LogConfig(java.lang.String name, LogConfigArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:apigateway/logConfig:LogConfig", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LogConfig(java.lang.String name, Output<java.lang.String> id, @Nullable LogConfigState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:apigateway/logConfig:LogConfig", name, state, makeResourceOptions(options, id), false);
    }

    private static LogConfigArgs makeArgs(LogConfigArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LogConfigArgs.Empty : args;
    }
     ...
     */
    public static LogConfig get(java.lang.String name, Output<java.lang.String> id, @Nullable LogConfigState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
