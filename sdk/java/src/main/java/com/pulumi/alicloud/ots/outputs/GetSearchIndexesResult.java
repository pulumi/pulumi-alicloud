...
public final class GetSearchIndexesResult {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetSearchIndexesResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ids(List<String> ids) {
            if (ids == null) {
              throw new MissingRequiredPropertyException("GetSearchIndexesResult", "ids");
            }
            this.ids = ids;
            return this;
        }
        ...
        public Builder indexes(List<GetSearchIndexesIndex> indexes) {
            if (indexes == null) {
              throw new MissingRequiredPropertyException("GetSearchIndexesResult", "indexes");
            }
        ...
        public Builder instanceName(String instanceName) {
            if (instanceName == null) {
              throw new MissingRequiredPropertyException("GetSearchIndexesResult", "instanceName");
            }
        ...
        public Builder names(List<String> names) {
            if (names == null) {
              throw new MissingRequiredPropertyException("GetSearchIndexesResult", "names");
            }
            this.names = names;
            return this;
        }
        ...
        public Builder tableName(String tableName) {
            if (tableName == null) {
              throw new MissingRequiredPropertyException("GetSearchIndexesResult", "tableName");
            }
