...
public final class WorkspaceModelArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceModelArgs Empty = new WorkspaceModelArgs();
    ...
    private WorkspaceModelArgs() {}

    private WorkspaceModelArgs(WorkspaceModelArgs $) {
    ...
    public static Builder builder(WorkspaceModelArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceModelArgs();
        }

        public Builder(WorkspaceModelArgs defaults) {
            $ = new WorkspaceModelArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WorkspaceModelArgs build() {
            if ($.modelName == null) {
                throw new MissingRequiredPropertyException("WorkspaceModelArgs", "modelName");
            }
            return $;
        }
    }
