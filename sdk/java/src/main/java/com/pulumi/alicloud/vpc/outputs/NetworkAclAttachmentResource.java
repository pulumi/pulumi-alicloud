...
public final class NetworkAclAttachmentResource {
    ...
    public static final class Builder {
        ...
        public Builder resourceId(String resourceId) {
            if (resourceId == null) {
              throw new MissingRequiredPropertyException("NetworkAclAttachmentResource", "resourceId");
            }
        ...
        public Builder resourceType(String resourceType) {
            if (resourceType == null) {
              throw new MissingRequiredPropertyException("NetworkAclAttachmentResource", "resourceType");
            }
