...
public final class EdgeContainerAppState extends com.pulumi.resources.ResourceArgs {

    public static final EdgeContainerAppState Empty = new EdgeContainerAppState();
     ...
     * 
     */
    @Import(name="edgeContainerAppName")
    private @Nullable Output<String> edgeContainerAppName;
     ...
     * 
     */
    public Optional<Output<String>> edgeContainerAppName() {
        return Optional.ofNullable(this.edgeContainerAppName);
    }
    ...
    private EdgeContainerAppState() {}

    private EdgeContainerAppState(EdgeContainerAppState $) {
    ...
    public static Builder builder(EdgeContainerAppState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EdgeContainerAppState();
        }

        public Builder(EdgeContainerAppState defaults) {
            $ = new EdgeContainerAppState(Objects.requireNonNull(defaults));
        }

        /**
         * @param createTime The time when the application was created.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder edgeContainerAppName(@Nullable Output<String> edgeContainerAppName) {
        ...
        public EdgeContainerAppState build() {
            return $;
        }
    }
