...
@CustomType
public final class ErEnvConfPresetCanaryShanghai {
    /**
    ...
    private ErEnvConfPresetCanaryShanghai(
    ...
    public static Builder builder(ErEnvConfPresetCanaryShanghai defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryShanghai defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryShanghai build() {
            return new ErEnvConfPresetCanaryShanghai(allowedHosts, codeRev, specName);
        }
    }
}
