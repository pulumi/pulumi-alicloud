...
@CustomType
public final class ErEnvConfProduction {
    /**
    ...
    public static Builder builder(ErEnvConfProduction defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfProduction defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfProduction build() {
            return new ErEnvConfProduction(allowedHosts, codeRev, specName);
        }
    }
}
