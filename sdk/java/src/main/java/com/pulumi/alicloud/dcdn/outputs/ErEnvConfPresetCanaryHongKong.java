...
@CustomType
public final class ErEnvConfPresetCanaryHongKong {
    /**
    ...
    private ErEnvConfPresetCanaryHongKong(
    ...
    public static Builder builder(ErEnvConfPresetCanaryHongKong defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryHongKong defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryHongKong build() {
            return new ErEnvConfPresetCanaryHongKong(allowedHosts, codeRev, specName);
        }
    }
}
