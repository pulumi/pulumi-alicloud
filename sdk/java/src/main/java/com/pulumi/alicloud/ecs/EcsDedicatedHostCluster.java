...
public class EcsDedicatedHostCluster extends com.pulumi.resources.CustomResource {
     ...
     */
    public EcsDedicatedHostCluster(String name) {
     ...
     */
    public EcsDedicatedHostCluster(String name, EcsDedicatedHostClusterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:ecs/ecsDedicatedHostCluster:EcsDedicatedHostCluster", name, args == null ? EcsDedicatedHostClusterArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private EcsDedicatedHostCluster(String name, Output<String> id, @Nullable EcsDedicatedHostClusterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:ecs/ecsDedicatedHostCluster:EcsDedicatedHostCluster", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static EcsDedicatedHostCluster get(String name, Output<String> id, @Nullable EcsDedicatedHostClusterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
