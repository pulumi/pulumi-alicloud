...
@CustomType
public final class ErEnvConfPresetCanaryTaiwan {
    /**
    ...
    private ErEnvConfPresetCanaryTaiwan(
    ...
    public static Builder builder(ErEnvConfPresetCanaryTaiwan defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryTaiwan defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryTaiwan build() {
            return new ErEnvConfPresetCanaryTaiwan(allowedHosts, codeRev, specName);
        }
    }
}
