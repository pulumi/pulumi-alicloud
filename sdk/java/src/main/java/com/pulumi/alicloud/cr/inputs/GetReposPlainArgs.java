...
public final class GetReposPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetReposPlainArgs Empty = new GetReposPlainArgs();
    ...
    private GetReposPlainArgs() {}

    private GetReposPlainArgs(GetReposPlainArgs $) {
    ...
    public static Builder builder(GetReposPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetReposPlainArgs();
        }

        public Builder(GetReposPlainArgs defaults) {
            $ = new GetReposPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetReposPlainArgs build() {
            return $;
        }
    }
