...
public final class GetOtsBackupPlansResult {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetOtsBackupPlansResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ids(List<String> ids) {
            if (ids == null) {
              throw new MissingRequiredPropertyException("GetOtsBackupPlansResult", "ids");
            }
            this.ids = ids;
            return this;
        }
        ...
        public Builder names(List<String> names) {
            if (names == null) {
              throw new MissingRequiredPropertyException("GetOtsBackupPlansResult", "names");
            }
            this.names = names;
            return this;
        }
        ...
        public Builder plans(List<GetOtsBackupPlansPlan> plans) {
            if (plans == null) {
              throw new MissingRequiredPropertyException("GetOtsBackupPlansResult", "plans");
            }
            this.plans = plans;
            return this;
        }
