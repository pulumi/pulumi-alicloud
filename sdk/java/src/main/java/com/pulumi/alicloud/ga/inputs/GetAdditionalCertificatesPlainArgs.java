    ...
    public static final class Builder {
        ...
        public GetAdditionalCertificatesPlainArgs build() {
            if ($.acceleratorId == null) {
                throw new MissingRequiredPropertyException("GetAdditionalCertificatesPlainArgs", "acceleratorId");
            }
            if ($.listenerId == null) {
                throw new MissingRequiredPropertyException("GetAdditionalCertificatesPlainArgs", "listenerId");
            }
            return $;
        }
    }
