...
public final class GetApplicationInfosApplicationDimension {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetApplicationInfosApplicationDimension", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetApplicationInfosApplicationDimension", "value");
            }
            this.value = value;
            return this;
        }
