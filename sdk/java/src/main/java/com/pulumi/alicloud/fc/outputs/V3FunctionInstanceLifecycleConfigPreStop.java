...
@CustomType
public final class V3FunctionInstanceLifecycleConfigPreStop {
    /**
    ...
    public static Builder builder(V3FunctionInstanceLifecycleConfigPreStop defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer timeout;
        public Builder() {}
        public Builder(V3FunctionInstanceLifecycleConfigPreStop defaults) {
        ...
        public V3FunctionInstanceLifecycleConfigPreStop build() {
            final var _resultValue = new V3FunctionInstanceLifecycleConfigPreStop();
