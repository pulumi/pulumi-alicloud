...
public final class GetInstanceTypesResult {
    ...
    public static final class Builder {
        ...
        public Builder systemDiskCategory(@Nullable String systemDiskCategory) {
            ...
            return new GetInstanceTypesResult(availabilityZone, cpuCoreCount, eniAmount, gpuAmount, gpuSpec, id, ids, imageId, instanceChargeType, instanceTypeFamily, instanceTypes, isOutdated, kubernetesNodeRole, memorySize, networkType, outputFile, sortedBy, spotStrategy, systemDiskCategory);
        }
    }
}
