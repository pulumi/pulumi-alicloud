...
public final class PolicyState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param document (Deprecated since 1.114.0, Optional, Conflicts with `policy_document`, `statement` and `version`) It has been deprecated since provider version 1.114.0 and `policy_document` instead.
         * 
         * @return builder
         * 
         * @deprecated
        ...
        /**
         * @param name (Deprecated since 1.114.0, Required, ForceNew) It has been deprecated since provider version 1.114.0 and `policy_name` instead.
         * 
         * @return builder
         * 
         * @deprecated
        ...
        /**
         * @param statements (Deprecated since 1.49.0, Optional, Type: list, Conflicts with `policy_document`, `document`) (It has been deprecated since version 1.49.0, and use field &#39;document&#39; to replace.) Statements of the RAM policy document. It is required when the `document` is not specified. See `statement` below.
         * 
         * @return builder
         * 
         * @deprecated
        ...
        /**
         * @param version (Deprecated since 1.49.0, Optional, Conflicts with `policy_document`, `document`) (It has been deprecated since version 1.49.0, and use field &#39;document&#39; to replace.) Version of the RAM policy document. Valid value is `1`. Default value is `1`.
         * 
         * @return builder
         * 
         * @deprecated
