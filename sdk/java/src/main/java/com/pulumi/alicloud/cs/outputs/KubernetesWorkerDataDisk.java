...
public final class KubernetesWorkerDataDisk {
    ...
    public static Builder builder(KubernetesWorkerDataDisk defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(KubernetesWorkerDataDisk defaults) {
        ...
        public Builder snapshotId(@Nullable String snapshotId) {
            this.snapshotId = snapshotId;
            return this;
        }        public KubernetesWorkerDataDisk build() {
            return new KubernetesWorkerDataDisk(autoSnapshotPolicyId, category, device, encrypted, kmsKeyId, name, performanceLevel, size, snapshotId);
        }
    }
}
