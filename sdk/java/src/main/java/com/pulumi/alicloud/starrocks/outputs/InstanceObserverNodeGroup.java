...
@CustomType
public final class InstanceObserverNodeGroup {
    /**
    ...
    public static Builder builder(InstanceObserverNodeGroup defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zoneId;
        public Builder() {}
        public Builder(InstanceObserverNodeGroup defaults) {
        ...
        public InstanceObserverNodeGroup build() {
            final var _resultValue = new InstanceObserverNodeGroup();
            _resultValue.cu = cu;
