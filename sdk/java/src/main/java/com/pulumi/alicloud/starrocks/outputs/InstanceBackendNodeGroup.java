...
@CustomType
public final class InstanceBackendNodeGroup {
    /**
    ...
    private InstanceBackendNodeGroup() {}
    /**
     * @return Number of CUs. CU (Compute Unit) is the basic measurement unit of the service, where 1 CU = 1 CPU core + 4 GiB memory.
     * 
     */
    ...
    public static Builder builder(InstanceBackendNodeGroup defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zoneId;
        public Builder() {}
        public Builder(InstanceBackendNodeGroup defaults) {
        ...
        public InstanceBackendNodeGroup build() {
            final var _resultValue = new InstanceBackendNodeGroup();
            _resultValue.cu = cu;
