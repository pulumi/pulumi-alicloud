...
import com.pulumi.alicloud.sslcertificatesserviceinstance.inputs.SslCertificatesServiceInstanceState;
import com.pulumi.alicloud.sslcertificatesserviceinstance.outputs.SslCertificatesServiceInstanceParameter;
 ...
 * 
 */
@ResourceType(type="alicloud:sslcertificatesserviceinstance/sslCertificatesServiceInstance:SslCertificatesServiceInstance")
public class SslCertificatesServiceInstance extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="parameters", refs={List.class,SslCertificatesServiceInstanceParameter.class}, tree="[0,1]")
    private Output</* @Nullable */ List<SslCertificatesServiceInstanceParameter>> parameters;
     ...
     * 
     */
    public Output<Optional<List<SslCertificatesServiceInstanceParameter>>> parameters() {
     ...
     */
    public SslCertificatesServiceInstance(java.lang.String name) {
        this(name, SslCertificatesServiceInstanceArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SslCertificatesServiceInstance(java.lang.String name, @Nullable SslCertificatesServiceInstanceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SslCertificatesServiceInstance(java.lang.String name, @Nullable SslCertificatesServiceInstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:sslcertificatesserviceinstance/sslCertificatesServiceInstance:SslCertificatesServiceInstance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SslCertificatesServiceInstance(java.lang.String name, Output<java.lang.String> id, @Nullable SslCertificatesServiceInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:sslcertificatesserviceinstance/sslCertificatesServiceInstance:SslCertificatesServiceInstance", name, state, makeResourceOptions(options, id), false);
    }

    private static SslCertificatesServiceInstanceArgs makeArgs(@Nullable SslCertificatesServiceInstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SslCertificatesServiceInstanceArgs.Empty : args;
    }
     ...
     */
    public static SslCertificatesServiceInstance get(java.lang.String name, Output<java.lang.String> id, @Nullable SslCertificatesServiceInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
