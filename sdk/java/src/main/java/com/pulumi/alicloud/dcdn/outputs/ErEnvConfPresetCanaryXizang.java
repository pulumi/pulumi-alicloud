...
@CustomType
public final class ErEnvConfPresetCanaryXizang {
    /**
    ...
    private ErEnvConfPresetCanaryXizang(
    ...
    public static Builder builder(ErEnvConfPresetCanaryXizang defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryXizang defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryXizang build() {
            return new ErEnvConfPresetCanaryXizang(allowedHosts, codeRev, specName);
        }
    }
}
