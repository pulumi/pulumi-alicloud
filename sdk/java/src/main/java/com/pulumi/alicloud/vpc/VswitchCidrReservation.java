...
public class VswitchCidrReservation extends com.pulumi.resources.CustomResource {
     ...
     */
    public VswitchCidrReservation(java.lang.String name) {
     ...
     */
    public VswitchCidrReservation(java.lang.String name, VswitchCidrReservationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VswitchCidrReservation(java.lang.String name, VswitchCidrReservationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:vpc/vswitchCidrReservation:VswitchCidrReservation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VswitchCidrReservation(java.lang.String name, Output<java.lang.String> id, @Nullable VswitchCidrReservationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:vpc/vswitchCidrReservation:VswitchCidrReservation", name, state, makeResourceOptions(options, id), false);
    }

    private static VswitchCidrReservationArgs makeArgs(VswitchCidrReservationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VswitchCidrReservationArgs.Empty : args;
    }
     ...
     */
    public static VswitchCidrReservation get(java.lang.String name, Output<java.lang.String> id, @Nullable VswitchCidrReservationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
