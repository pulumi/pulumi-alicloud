...
public class InstanceMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public InstanceMember(java.lang.String name) {
     ...
     */
    public InstanceMember(java.lang.String name, InstanceMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InstanceMember(java.lang.String name, InstanceMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cloudfirewall/instanceMember:InstanceMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private InstanceMember(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cloudfirewall/instanceMember:InstanceMember", name, state, makeResourceOptions(options, id), false);
    }

    private static InstanceMemberArgs makeArgs(InstanceMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? InstanceMemberArgs.Empty : args;
    }
     ...
     */
    public static InstanceMember get(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
