...
public final class K8sSlbAttachmentSlbConfig {
     ...
     * 
     */
    private final List<K8sSlbAttachmentSlbConfigPortMapping> portMappings;
    /**
    ...
    private K8sSlbAttachmentSlbConfig(
        ...
        @CustomType.Parameter("portMappings") List<K8sSlbAttachmentSlbConfigPortMapping> portMappings,
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            ...
            return new K8sSlbAttachmentSlbConfig(name, portMappings, scheduler, slbId, specification, type);
        }
    }
}
