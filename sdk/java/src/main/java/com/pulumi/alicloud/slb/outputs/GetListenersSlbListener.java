...
public final class GetListenersSlbListener {
    ...
    private GetListenersSlbListener(
        ...
        @CustomType.Parameter("proxyProtocolV2Enabled") Boolean proxyProtocolV2Enabled,
    ...
    public static final class Builder {
        ...
        public Builder xForwardedForSlbProto(String xForwardedForSlbProto) {
            ...
            return new GetListenersSlbListener(backendPort, bandwidth, caCertificateId, cookie, cookieTimeout, description, enableHttp2, establishedTimeout, frontendPort, gzip, healthCheck, healthCheckConnectPort, healthCheckConnectTimeout, healthCheckDomain, healthCheckHttpCode, healthCheckInterval, healthCheckTimeout, healthCheckType, healthCheckUri, healthyThreshold, idleTimeout, masterSlaveServerGroupId, persistenceTimeout, protocol, proxyProtocolV2Enabled, requestTimeout, scheduler, securityStatus, serverCertificateId, serverGroupId, sslCertificateId, status, stickySession, stickySessionType, tlsCipherPolicy, unhealthyThreshold, xForwardedFor, xForwardedForSlbId, xForwardedForSlbIp, xForwardedForSlbProto);
        }
    }
}
