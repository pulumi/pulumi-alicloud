    ...
    public static final class Builder {
        ...
        public StreamingJobArgs build() {
            if ($.dataSourceId == null) {
                throw new MissingRequiredPropertyException("StreamingJobArgs", "dataSourceId");
            }
            if ($.dbInstanceId == null) {
                throw new MissingRequiredPropertyException("StreamingJobArgs", "dbInstanceId");
            }
            if ($.jobName == null) {
                throw new MissingRequiredPropertyException("StreamingJobArgs", "jobName");
            }
            return $;
        }
    }
