...
public class Model extends com.pulumi.resources.CustomResource {
    ...
    public Model(java.lang.String name, ModelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:apigateway/model:Model", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Model(java.lang.String name, Output<java.lang.String> id, @Nullable ModelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:apigateway/model:Model", name, state, makeResourceOptions(options, id), false);
    }
