...
public final class GetAppTemplatesTemplateConfigList {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetAppTemplatesTemplateConfigList", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetAppTemplatesTemplateConfigList", "value");
            }
            this.value = value;
            return this;
        }
