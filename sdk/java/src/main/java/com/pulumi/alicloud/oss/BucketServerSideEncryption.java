...
public class BucketServerSideEncryption extends com.pulumi.resources.CustomResource {
     ...
     */
    public BucketServerSideEncryption(java.lang.String name) {
     ...
     */
    public BucketServerSideEncryption(java.lang.String name, BucketServerSideEncryptionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public BucketServerSideEncryption(java.lang.String name, BucketServerSideEncryptionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:oss/bucketServerSideEncryption:BucketServerSideEncryption", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private BucketServerSideEncryption(java.lang.String name, Output<java.lang.String> id, @Nullable BucketServerSideEncryptionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:oss/bucketServerSideEncryption:BucketServerSideEncryption", name, state, makeResourceOptions(options, id), false);
    }

    private static BucketServerSideEncryptionArgs makeArgs(BucketServerSideEncryptionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? BucketServerSideEncryptionArgs.Empty : args;
    }
     ...
     */
    public static BucketServerSideEncryption get(java.lang.String name, Output<java.lang.String> id, @Nullable BucketServerSideEncryptionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
