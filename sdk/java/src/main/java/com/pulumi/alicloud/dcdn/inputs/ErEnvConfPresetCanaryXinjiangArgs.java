...
public final class ErEnvConfPresetCanaryXinjiangArgs extends com.pulumi.resources.ResourceArgs {

    public static final ErEnvConfPresetCanaryXinjiangArgs Empty = new ErEnvConfPresetCanaryXinjiangArgs();
    ...
    private ErEnvConfPresetCanaryXinjiangArgs() {}

    private ErEnvConfPresetCanaryXinjiangArgs(ErEnvConfPresetCanaryXinjiangArgs $) {
    ...
    public static Builder builder(ErEnvConfPresetCanaryXinjiangArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ErEnvConfPresetCanaryXinjiangArgs();
        }

        public Builder(ErEnvConfPresetCanaryXinjiangArgs defaults) {
            $ = new ErEnvConfPresetCanaryXinjiangArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ErEnvConfPresetCanaryXinjiangArgs build() {
            return $;
        }
    }
