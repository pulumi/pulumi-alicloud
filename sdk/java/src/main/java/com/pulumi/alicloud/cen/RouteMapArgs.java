...
public final class RouteMapArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder cenRegionId(Output<String> cenRegionId) {
         ...
         * 
         */
        public Builder mapResult(Output<String> mapResult) {
            $.mapResult = mapResult;
            return this;
        }
         ...
         * 
         */
        public Builder transmitDirection(Output<String> transmitDirection) {
