...
public class TransitRouterCidr extends com.pulumi.resources.CustomResource {
     ...
     */
    public TransitRouterCidr(java.lang.String name) {
     ...
     */
    public TransitRouterCidr(java.lang.String name, TransitRouterCidrArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TransitRouterCidr(java.lang.String name, TransitRouterCidrArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cen/transitRouterCidr:TransitRouterCidr", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TransitRouterCidr(java.lang.String name, Output<java.lang.String> id, @Nullable TransitRouterCidrState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cen/transitRouterCidr:TransitRouterCidr", name, state, makeResourceOptions(options, id), false);
    }

    private static TransitRouterCidrArgs makeArgs(TransitRouterCidrArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? TransitRouterCidrArgs.Empty : args;
    }
     ...
     */
    public static TransitRouterCidr get(java.lang.String name, Output<java.lang.String> id, @Nullable TransitRouterCidrState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
