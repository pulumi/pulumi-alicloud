...
public final class GetDeliveriesResult {
    ...
    public static final class Builder {
        ...
        public Builder deliveries(List<GetDeliveriesDelivery> deliveries) {
            if (deliveries == null) {
              throw new MissingRequiredPropertyException("GetDeliveriesResult", "deliveries");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetDeliveriesResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ids(List<String> ids) {
            if (ids == null) {
              throw new MissingRequiredPropertyException("GetDeliveriesResult", "ids");
            }
            this.ids = ids;
            return this;
        }
        ...
        public Builder names(List<String> names) {
            if (names == null) {
              throw new MissingRequiredPropertyException("GetDeliveriesResult", "names");
            }
            this.names = names;
            return this;
        }
