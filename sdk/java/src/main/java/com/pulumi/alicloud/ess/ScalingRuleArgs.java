...
public final class ScalingRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final ScalingRuleArgs Empty = new ScalingRuleArgs();
    ...
    private ScalingRuleArgs() {}

    private ScalingRuleArgs(ScalingRuleArgs $) {
    ...
    public static Builder builder(ScalingRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ScalingRuleArgs defaults) {
            $ = new ScalingRuleArgs(Objects.requireNonNull(defaults));
        }
