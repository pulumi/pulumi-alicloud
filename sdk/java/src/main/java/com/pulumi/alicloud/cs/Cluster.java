...
import com.pulumi.alicloud.cs.ClusterArgs;
import com.pulumi.alicloud.cs.inputs.ClusterState;
import com.pulumi.alicloud.cs.outputs.ClusterNode;
...
@ResourceType(type="alicloud:cs/cluster:Cluster")
public class Cluster extends com.pulumi.resources.CustomResource {
    ...
    public Cluster(java.lang.String name, ClusterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cs/cluster:Cluster", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Cluster(java.lang.String name, Output<java.lang.String> id, @Nullable ClusterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cs/cluster:Cluster", name, state, makeResourceOptions(options, id), false);
    }
