...
public final class ErEnvConfPresetCanaryHenanArgs extends com.pulumi.resources.ResourceArgs {

    public static final ErEnvConfPresetCanaryHenanArgs Empty = new ErEnvConfPresetCanaryHenanArgs();
    ...
    private ErEnvConfPresetCanaryHenanArgs() {}

    private ErEnvConfPresetCanaryHenanArgs(ErEnvConfPresetCanaryHenanArgs $) {
    ...
    public static Builder builder(ErEnvConfPresetCanaryHenanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ErEnvConfPresetCanaryHenanArgs();
        }

        public Builder(ErEnvConfPresetCanaryHenanArgs defaults) {
            $ = new ErEnvConfPresetCanaryHenanArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ErEnvConfPresetCanaryHenanArgs build() {
            return $;
        }
    }
