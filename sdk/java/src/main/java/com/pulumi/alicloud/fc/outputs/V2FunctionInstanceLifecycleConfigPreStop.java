...
@CustomType
public final class V2FunctionInstanceLifecycleConfigPreStop {
    /**
    ...
    public static Builder builder(V2FunctionInstanceLifecycleConfigPreStop defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer timeout;
        public Builder() {}
        public Builder(V2FunctionInstanceLifecycleConfigPreStop defaults) {
