...
public class DbInstancePlan extends com.pulumi.resources.CustomResource {
     ...
     */
    public DbInstancePlan(java.lang.String name) {
     ...
     */
    public DbInstancePlan(java.lang.String name, DbInstancePlanArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DbInstancePlan(java.lang.String name, DbInstancePlanArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:gpdb/dbInstancePlan:DbInstancePlan", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DbInstancePlan(java.lang.String name, Output<java.lang.String> id, @Nullable DbInstancePlanState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:gpdb/dbInstancePlan:DbInstancePlan", name, state, makeResourceOptions(options, id), false);
    }

    private static DbInstancePlanArgs makeArgs(DbInstancePlanArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DbInstancePlanArgs.Empty : args;
    }
     ...
     */
    public static DbInstancePlan get(java.lang.String name, Output<java.lang.String> id, @Nullable DbInstancePlanState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
