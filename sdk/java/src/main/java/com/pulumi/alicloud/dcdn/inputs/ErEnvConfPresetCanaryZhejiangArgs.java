...
public final class ErEnvConfPresetCanaryZhejiangArgs extends com.pulumi.resources.ResourceArgs {

    public static final ErEnvConfPresetCanaryZhejiangArgs Empty = new ErEnvConfPresetCanaryZhejiangArgs();
    ...
    private ErEnvConfPresetCanaryZhejiangArgs() {}

    private ErEnvConfPresetCanaryZhejiangArgs(ErEnvConfPresetCanaryZhejiangArgs $) {
    ...
    public static Builder builder(ErEnvConfPresetCanaryZhejiangArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ErEnvConfPresetCanaryZhejiangArgs();
        }

        public Builder(ErEnvConfPresetCanaryZhejiangArgs defaults) {
            $ = new ErEnvConfPresetCanaryZhejiangArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ErEnvConfPresetCanaryZhejiangArgs build() {
            return $;
        }
    }
