...
public final class GetLifecycleHooksPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLifecycleHooksPlainArgs Empty = new GetLifecycleHooksPlainArgs();
    ...
    private GetLifecycleHooksPlainArgs() {}

    private GetLifecycleHooksPlainArgs(GetLifecycleHooksPlainArgs $) {
        this.ids = $.ids;
    ...
    public static Builder builder(GetLifecycleHooksPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLifecycleHooksPlainArgs();
        }

        public Builder(GetLifecycleHooksPlainArgs defaults) {
            $ = new GetLifecycleHooksPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLifecycleHooksPlainArgs build() {
            return $;
        }
    }
