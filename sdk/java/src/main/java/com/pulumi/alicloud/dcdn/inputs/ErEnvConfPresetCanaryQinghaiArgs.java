...
public final class ErEnvConfPresetCanaryQinghaiArgs extends com.pulumi.resources.ResourceArgs {

    public static final ErEnvConfPresetCanaryQinghaiArgs Empty = new ErEnvConfPresetCanaryQinghaiArgs();
    ...
    private ErEnvConfPresetCanaryQinghaiArgs() {}

    private ErEnvConfPresetCanaryQinghaiArgs(ErEnvConfPresetCanaryQinghaiArgs $) {
    ...
    public static Builder builder(ErEnvConfPresetCanaryQinghaiArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ErEnvConfPresetCanaryQinghaiArgs();
        }

        public Builder(ErEnvConfPresetCanaryQinghaiArgs defaults) {
            $ = new ErEnvConfPresetCanaryQinghaiArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ErEnvConfPresetCanaryQinghaiArgs build() {
            return $;
        }
    }
