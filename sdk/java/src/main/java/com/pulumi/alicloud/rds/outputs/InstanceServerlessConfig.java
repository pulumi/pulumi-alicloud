...
public final class InstanceServerlessConfig {
    ...
    public static final class Builder {
        ...
        public Builder maxCapacity(Double maxCapacity) {
            if (maxCapacity == null) {
              throw new MissingRequiredPropertyException("InstanceServerlessConfig", "maxCapacity");
            }
        ...
        public Builder minCapacity(Double minCapacity) {
            if (minCapacity == null) {
              throw new MissingRequiredPropertyException("InstanceServerlessConfig", "minCapacity");
            }
