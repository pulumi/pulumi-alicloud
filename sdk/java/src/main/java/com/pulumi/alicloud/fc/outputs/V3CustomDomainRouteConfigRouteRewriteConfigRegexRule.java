...
public final class V3CustomDomainRouteConfigRouteRewriteConfigRegexRule {
    ...
    public static Builder builder(V3CustomDomainRouteConfigRouteRewriteConfigRegexRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String replacement;
        public Builder() {}
        public Builder(V3CustomDomainRouteConfigRouteRewriteConfigRegexRule defaults) {
        ...
        public V3CustomDomainRouteConfigRouteRewriteConfigRegexRule build() {
            final var _resultValue = new V3CustomDomainRouteConfigRouteRewriteConfigRegexRule();
