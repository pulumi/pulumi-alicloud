...
public class NestServiceInstance extends com.pulumi.resources.CustomResource {
     ...
     */
    public NestServiceInstance(java.lang.String name) {
     ...
     */
    public NestServiceInstance(java.lang.String name, NestServiceInstanceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NestServiceInstance(java.lang.String name, NestServiceInstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:compute/nestServiceInstance:NestServiceInstance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NestServiceInstance(java.lang.String name, Output<java.lang.String> id, @Nullable NestServiceInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:compute/nestServiceInstance:NestServiceInstance", name, state, makeResourceOptions(options, id), false);
    }

    private static NestServiceInstanceArgs makeArgs(NestServiceInstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? NestServiceInstanceArgs.Empty : args;
    }
     ...
     */
    public static NestServiceInstance get(java.lang.String name, Output<java.lang.String> id, @Nullable NestServiceInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
