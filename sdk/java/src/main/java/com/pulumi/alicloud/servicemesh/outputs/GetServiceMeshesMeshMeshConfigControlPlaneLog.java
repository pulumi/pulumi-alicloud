...
public final class GetServiceMeshesMeshMeshConfigControlPlaneLog {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetServiceMeshesMeshMeshConfigControlPlaneLog", "enabled");
            }
        ...
        public Builder project(String project) {
            if (project == null) {
              throw new MissingRequiredPropertyException("GetServiceMeshesMeshMeshConfigControlPlaneLog", "project");
            }
