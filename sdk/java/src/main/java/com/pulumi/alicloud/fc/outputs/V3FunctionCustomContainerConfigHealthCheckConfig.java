...
@CustomType
public final class V3FunctionCustomContainerConfigHealthCheckConfig {
    ...
    private V3FunctionCustomContainerConfigHealthCheckConfig() {}
    ...
    public static Builder builder(V3FunctionCustomContainerConfigHealthCheckConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer timeoutSeconds;
        public Builder() {}
        public Builder(V3FunctionCustomContainerConfigHealthCheckConfig defaults) {
        ...
        public V3FunctionCustomContainerConfigHealthCheckConfig build() {
            final var _resultValue = new V3FunctionCustomContainerConfigHealthCheckConfig();
