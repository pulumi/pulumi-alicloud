...
public final class GetEndUserProductsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetEndUserProductsArgs Empty = new GetEndUserProductsArgs();
    ...
    private GetEndUserProductsArgs() {}

    private GetEndUserProductsArgs(GetEndUserProductsArgs $) {
        this.ids = $.ids;
    ...
    public static Builder builder(GetEndUserProductsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetEndUserProductsArgs();
        }

        public Builder(GetEndUserProductsArgs defaults) {
            $ = new GetEndUserProductsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetEndUserProductsArgs build() {
            return $;
        }
    }
