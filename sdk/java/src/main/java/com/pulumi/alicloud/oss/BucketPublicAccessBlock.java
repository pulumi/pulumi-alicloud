...
public class BucketPublicAccessBlock extends com.pulumi.resources.CustomResource {
    ...
    public BucketPublicAccessBlock(java.lang.String name, BucketPublicAccessBlockArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:oss/bucketPublicAccessBlock:BucketPublicAccessBlock", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private BucketPublicAccessBlock(java.lang.String name, Output<java.lang.String> id, @Nullable BucketPublicAccessBlockState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:oss/bucketPublicAccessBlock:BucketPublicAccessBlock", name, state, makeResourceOptions(options, id), false);
    }
