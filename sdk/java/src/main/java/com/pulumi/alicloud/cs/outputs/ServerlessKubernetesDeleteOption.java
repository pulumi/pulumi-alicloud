...
public final class ServerlessKubernetesDeleteOption {
    ...
    public static Builder builder(ServerlessKubernetesDeleteOption defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String resourceType;
        public Builder() {}
        public Builder(ServerlessKubernetesDeleteOption defaults) {
        ...
        public ServerlessKubernetesDeleteOption build() {
            final var _resultValue = new ServerlessKubernetesDeleteOption();
