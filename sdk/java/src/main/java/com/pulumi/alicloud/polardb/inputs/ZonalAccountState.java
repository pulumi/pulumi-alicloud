...
public final class ZonalAccountState extends com.pulumi.resources.ResourceArgs {

    public static final ZonalAccountState Empty = new ZonalAccountState();
    ...
    private ZonalAccountState() {}

    private ZonalAccountState(ZonalAccountState $) {
    ...
    public static Builder builder(ZonalAccountState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZonalAccountState();
        }

        public Builder(ZonalAccountState defaults) {
            $ = new ZonalAccountState(Objects.requireNonNull(defaults));
        }
        ...
        public ZonalAccountState build() {
            return $;
        }
    }
