...
public final class ClientUserDefineRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClientUserDefineRuleArgs Empty = new ClientUserDefineRuleArgs();
     ...
     * 
     */
    @Import(name="clientUserDefineRuleName", required=true)
    ...
    private ClientUserDefineRuleArgs() {}

    private ClientUserDefineRuleArgs(ClientUserDefineRuleArgs $) {
    ...
    public static Builder builder(ClientUserDefineRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClientUserDefineRuleArgs();
        }

        public Builder(ClientUserDefineRuleArgs defaults) {
            $ = new ClientUserDefineRuleArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder actionType(Output<Integer> actionType) {
         ...
         * 
         */
        public Builder clientUserDefineRuleName(Output<String> clientUserDefineRuleName) {
