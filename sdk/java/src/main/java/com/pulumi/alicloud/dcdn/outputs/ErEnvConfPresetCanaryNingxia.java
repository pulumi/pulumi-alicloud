...
@CustomType
public final class ErEnvConfPresetCanaryNingxia {
    /**
    ...
    private ErEnvConfPresetCanaryNingxia(
    ...
    public static Builder builder(ErEnvConfPresetCanaryNingxia defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryNingxia defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryNingxia build() {
            return new ErEnvConfPresetCanaryNingxia(allowedHosts, codeRev, specName);
        }
    }
}
