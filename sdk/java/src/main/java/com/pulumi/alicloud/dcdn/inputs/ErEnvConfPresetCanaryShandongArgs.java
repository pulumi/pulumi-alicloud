...
public final class ErEnvConfPresetCanaryShandongArgs extends com.pulumi.resources.ResourceArgs {

    public static final ErEnvConfPresetCanaryShandongArgs Empty = new ErEnvConfPresetCanaryShandongArgs();
    ...
    private ErEnvConfPresetCanaryShandongArgs() {}

    private ErEnvConfPresetCanaryShandongArgs(ErEnvConfPresetCanaryShandongArgs $) {
    ...
    public static Builder builder(ErEnvConfPresetCanaryShandongArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ErEnvConfPresetCanaryShandongArgs();
        }

        public Builder(ErEnvConfPresetCanaryShandongArgs defaults) {
            $ = new ErEnvConfPresetCanaryShandongArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ErEnvConfPresetCanaryShandongArgs build() {
            return $;
        }
    }
