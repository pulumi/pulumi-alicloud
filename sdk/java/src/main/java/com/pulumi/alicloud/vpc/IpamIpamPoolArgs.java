...
public final class IpamIpamPoolArgs extends com.pulumi.resources.ResourceArgs {

    public static final IpamIpamPoolArgs Empty = new IpamIpamPoolArgs();
    ...
    private IpamIpamPoolArgs() {}

    private IpamIpamPoolArgs(IpamIpamPoolArgs $) {
    ...
    public static Builder builder(IpamIpamPoolArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpamIpamPoolArgs();
        }

        public Builder(IpamIpamPoolArgs defaults) {
            $ = new IpamIpamPoolArgs(Objects.requireNonNull(defaults));
        }
        ...
        public IpamIpamPoolArgs build() {
            if ($.ipamScopeId == null) {
                throw new MissingRequiredPropertyException("IpamIpamPoolArgs", "ipamScopeId");
            }
            return $;
        }
    }
