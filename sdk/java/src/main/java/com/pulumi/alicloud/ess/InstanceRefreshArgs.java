...
public final class InstanceRefreshArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceRefreshArgs Empty = new InstanceRefreshArgs();
    ...
    private InstanceRefreshArgs() {}

    private InstanceRefreshArgs(InstanceRefreshArgs $) {
    ...
    public static Builder builder(InstanceRefreshArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceRefreshArgs();
        }

        public Builder(InstanceRefreshArgs defaults) {
            $ = new InstanceRefreshArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceRefreshArgs build() {
            if ($.scalingGroupId == null) {
                throw new MissingRequiredPropertyException("InstanceRefreshArgs", "scalingGroupId");
            }
            return $;
        }
    }
