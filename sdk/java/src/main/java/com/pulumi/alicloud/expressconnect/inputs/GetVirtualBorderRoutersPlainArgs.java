...
public final class GetVirtualBorderRoutersPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return Custom filter block as described below. See `filter` below.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param filters Custom filter block as described below. See `filter` below.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tags A map of tags to filter Virtual Border Routers that match the given tags.
         * 
         * @return builder
         * 
         */
