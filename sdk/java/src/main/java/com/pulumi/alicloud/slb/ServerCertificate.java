...
public class ServerCertificate extends com.pulumi.resources.CustomResource {
     ...
     */
    public ServerCertificate(java.lang.String name, @Nullable ServerCertificateArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ServerCertificate(java.lang.String name, @Nullable ServerCertificateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:slb/serverCertificate:ServerCertificate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ServerCertificate(java.lang.String name, Output<java.lang.String> id, @Nullable ServerCertificateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:slb/serverCertificate:ServerCertificate", name, state, makeResourceOptions(options, id), false);
    }

    private static ServerCertificateArgs makeArgs(@Nullable ServerCertificateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
