...
public class StateConfiguration extends com.pulumi.resources.CustomResource {
     ...
     */
    public StateConfiguration(java.lang.String name) {
     ...
     */
    public StateConfiguration(java.lang.String name, StateConfigurationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public StateConfiguration(java.lang.String name, StateConfigurationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:oos/stateConfiguration:StateConfiguration", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private StateConfiguration(java.lang.String name, Output<java.lang.String> id, @Nullable StateConfigurationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:oos/stateConfiguration:StateConfiguration", name, state, makeResourceOptions(options, id), false);
    }

    private static StateConfigurationArgs makeArgs(StateConfigurationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? StateConfigurationArgs.Empty : args;
    }
     ...
     */
    public static StateConfiguration get(java.lang.String name, Output<java.lang.String> id, @Nullable StateConfigurationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
