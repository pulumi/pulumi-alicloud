...
public final class TransitRouterRouteTablePropagationArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransitRouterRouteTablePropagationArgs Empty = new TransitRouterRouteTablePropagationArgs();
    ...
    private TransitRouterRouteTablePropagationArgs() {}

    private TransitRouterRouteTablePropagationArgs(TransitRouterRouteTablePropagationArgs $) {
        this.dryRun = $.dryRun;
    ...
    public static Builder builder(TransitRouterRouteTablePropagationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransitRouterRouteTablePropagationArgs();
        }

        public Builder(TransitRouterRouteTablePropagationArgs defaults) {
            $ = new TransitRouterRouteTablePropagationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TransitRouterRouteTablePropagationArgs build() {
            if ($.transitRouterAttachmentId == null) {
                throw new MissingRequiredPropertyException("TransitRouterRouteTablePropagationArgs", "transitRouterAttachmentId");
            }
            if ($.transitRouterRouteTableId == null) {
                throw new MissingRequiredPropertyException("TransitRouterRouteTablePropagationArgs", "transitRouterRouteTableId");
            }
            return $;
        }
    }
