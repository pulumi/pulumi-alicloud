...
public final class GetKubernetesClustersClusterWorkerNode {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetKubernetesClustersClusterWorkerNode", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetKubernetesClustersClusterWorkerNode", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder privateIp(String privateIp) {
            if (privateIp == null) {
              throw new MissingRequiredPropertyException("GetKubernetesClustersClusterWorkerNode", "privateIp");
            }
            this.privateIp = privateIp;
            return this;
        }
        public GetKubernetesClustersClusterWorkerNode build() {
            final var _resultValue = new GetKubernetesClustersClusterWorkerNode();
            _resultValue.id = id;
