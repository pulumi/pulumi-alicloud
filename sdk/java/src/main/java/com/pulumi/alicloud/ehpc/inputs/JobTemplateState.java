...
public final class JobTemplateState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="jobTemplateName")
    private @Nullable Output<String> jobTemplateName;

    /**
     * @return A Job Template Name.
     * 
     */
    public Optional<Output<String>> jobTemplateName() {
        return Optional.ofNullable(this.jobTemplateName);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder jobTemplateName(@Nullable Output<String> jobTemplateName) {
