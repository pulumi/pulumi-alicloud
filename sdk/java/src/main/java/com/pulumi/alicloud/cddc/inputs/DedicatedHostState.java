...
public final class DedicatedHostState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="hostClass")
    private @Nullable Output<String> hostClass;
     ...
     * 
     */
    public Optional<Output<String>> hostClass() {
        return Optional.ofNullable(this.hostClass);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder hostClass(@Nullable Output<String> hostClass) {
            $.hostClass = hostClass;
            return this;
        }
        ...
        /**
         * @param status The state of the host. Valid values: `0:` The host is being created. `1`: The host is running. `2`: The host is faulty. `3`: The host is ready for deactivation. `4`: The host is being maintained. `5`: The host is deactivated. `6`: The host is restarting. `7`: The host is locked.
         * 
         * @return builder
         * 
         */
