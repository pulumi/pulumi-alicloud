...
public final class GetInstancesResult {
    ...
    public static final class Builder {
        ...
        public Builder vswitchId(@Nullable String vswitchId) {
            ...
            return new GetInstancesResult(availabilityZone, id, ids, imageId, instances, nameRegex, names, outputFile, pageNumber, pageSize, ramRoleName, resourceGroupId, status, tags, totalCount, vpcId, vswitchId);
        }
    }
}
