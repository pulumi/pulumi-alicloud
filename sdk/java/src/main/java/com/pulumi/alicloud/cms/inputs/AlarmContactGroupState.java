...
public final class AlarmContactGroupState extends com.pulumi.resources.ResourceArgs {

    public static final AlarmContactGroupState Empty = new AlarmContactGroupState();

    /**
     * The name of the alarm group.
     * 
     */
    @Import(name="alarmContactGroupName")
    private @Nullable Output<String> alarmContactGroupName;

    /**
     * @return The name of the alarm group.
     * 
     */
    public Optional<Output<String>> alarmContactGroupName() {
        return Optional.ofNullable(this.alarmContactGroupName);
    }
    ...
    private AlarmContactGroupState() {}

    private AlarmContactGroupState(AlarmContactGroupState $) {
    ...
    public static Builder builder(AlarmContactGroupState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlarmContactGroupState();
        }

        public Builder(AlarmContactGroupState defaults) {
            $ = new AlarmContactGroupState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder alarmContactGroupName(@Nullable Output<String> alarmContactGroupName) {
        ...
        public AlarmContactGroupState build() {
            return $;
        }
    }
