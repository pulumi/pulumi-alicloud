...
@CustomType
public final class ErEnvConfPresetCanaryLiaoning {
    /**
    ...
    private ErEnvConfPresetCanaryLiaoning(
    ...
    public static Builder builder(ErEnvConfPresetCanaryLiaoning defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryLiaoning defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            ...
            return new ErEnvConfPresetCanaryLiaoning(allowedHosts, codeRev, specName);
        }
    }
}
