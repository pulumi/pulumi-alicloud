...
public final class ErEnvConfPresetCanaryGuizhouArgs extends com.pulumi.resources.ResourceArgs {

    public static final ErEnvConfPresetCanaryGuizhouArgs Empty = new ErEnvConfPresetCanaryGuizhouArgs();
    ...
    private ErEnvConfPresetCanaryGuizhouArgs() {}

    private ErEnvConfPresetCanaryGuizhouArgs(ErEnvConfPresetCanaryGuizhouArgs $) {
    ...
    public static Builder builder(ErEnvConfPresetCanaryGuizhouArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ErEnvConfPresetCanaryGuizhouArgs();
        }

        public Builder(ErEnvConfPresetCanaryGuizhouArgs defaults) {
            $ = new ErEnvConfPresetCanaryGuizhouArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ErEnvConfPresetCanaryGuizhouArgs build() {
            return $;
        }
    }
