...
public final class DomainGroupState extends com.pulumi.resources.ResourceArgs {

    public static final DomainGroupState Empty = new DomainGroupState();
    ...
    private DomainGroupState() {}

    private DomainGroupState(DomainGroupState $) {
    ...
    public static Builder builder(DomainGroupState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainGroupState();
        }

        public Builder(DomainGroupState defaults) {
            $ = new DomainGroupState(Objects.requireNonNull(defaults));
        }
