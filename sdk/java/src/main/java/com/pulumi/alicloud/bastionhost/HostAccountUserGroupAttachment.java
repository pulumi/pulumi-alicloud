...
public class HostAccountUserGroupAttachment extends com.pulumi.resources.CustomResource {
     ...
     */
    public HostAccountUserGroupAttachment(java.lang.String name) {
     ...
     */
    public HostAccountUserGroupAttachment(java.lang.String name, HostAccountUserGroupAttachmentArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HostAccountUserGroupAttachment(java.lang.String name, HostAccountUserGroupAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:bastionhost/hostAccountUserGroupAttachment:HostAccountUserGroupAttachment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HostAccountUserGroupAttachment(java.lang.String name, Output<java.lang.String> id, @Nullable HostAccountUserGroupAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:bastionhost/hostAccountUserGroupAttachment:HostAccountUserGroupAttachment", name, state, makeResourceOptions(options, id), false);
    }

    private static HostAccountUserGroupAttachmentArgs makeArgs(HostAccountUserGroupAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? HostAccountUserGroupAttachmentArgs.Empty : args;
    }
     ...
     */
    public static HostAccountUserGroupAttachment get(java.lang.String name, Output<java.lang.String> id, @Nullable HostAccountUserGroupAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
