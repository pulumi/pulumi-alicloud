...
public final class CustomDiskState extends com.pulumi.resources.ResourceArgs {

    public static final CustomDiskState Empty = new CustomDiskState();
    ...
    public static Builder builder(CustomDiskState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CustomDiskState defaults) {
            $ = new CustomDiskState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param regionId The region ID. You can view the region ID through the DescribeRegions interface.
         * 
         * @return builder
         * 
         */
