...
public final class AggregateDeliveryArgs extends com.pulumi.resources.ResourceArgs {

    public static final AggregateDeliveryArgs Empty = new AggregateDeliveryArgs();
    ...
    private AggregateDeliveryArgs() {}

    private AggregateDeliveryArgs(AggregateDeliveryArgs $) {
    ...
    public static Builder builder(AggregateDeliveryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AggregateDeliveryArgs();
        }

        public Builder(AggregateDeliveryArgs defaults) {
            $ = new AggregateDeliveryArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param configurationItemChangeNotification Open or close delivery configuration change history.
         * 
         * @return builder
         * 
         */
