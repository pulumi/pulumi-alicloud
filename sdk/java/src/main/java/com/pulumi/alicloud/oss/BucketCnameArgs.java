...
public final class BucketCnameArgs extends com.pulumi.resources.ResourceArgs {

    public static final BucketCnameArgs Empty = new BucketCnameArgs();
    ...
    private BucketCnameArgs() {}

    private BucketCnameArgs(BucketCnameArgs $) {
        this.bucket = $.bucket;
    ...
    public static Builder builder(BucketCnameArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BucketCnameArgs defaults) {
            $ = new BucketCnameArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BucketCnameArgs build() {
            if ($.bucket == null) {
                throw new MissingRequiredPropertyException("BucketCnameArgs", "bucket");
            }
            if ($.domain == null) {
                throw new MissingRequiredPropertyException("BucketCnameArgs", "domain");
            }
            return $;
        }
    }
