...
public final class ErEnvConfPresetCanaryShanghaiArgs extends com.pulumi.resources.ResourceArgs {

    public static final ErEnvConfPresetCanaryShanghaiArgs Empty = new ErEnvConfPresetCanaryShanghaiArgs();
    ...
    private ErEnvConfPresetCanaryShanghaiArgs() {}

    private ErEnvConfPresetCanaryShanghaiArgs(ErEnvConfPresetCanaryShanghaiArgs $) {
    ...
    public static Builder builder(ErEnvConfPresetCanaryShanghaiArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ErEnvConfPresetCanaryShanghaiArgs();
        }

        public Builder(ErEnvConfPresetCanaryShanghaiArgs defaults) {
            $ = new ErEnvConfPresetCanaryShanghaiArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ErEnvConfPresetCanaryShanghaiArgs build() {
            return $;
        }
    }
