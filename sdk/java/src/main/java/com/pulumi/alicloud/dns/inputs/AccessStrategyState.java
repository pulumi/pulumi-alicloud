...
public final class AccessStrategyState extends com.pulumi.resources.ResourceArgs {

    public static final AccessStrategyState Empty = new AccessStrategyState();
     ...
     * 
     */
    @Import(name="defaultAddrPoolType")
    private @Nullable Output<String> defaultAddrPoolType;

    /**
     * @return The type of the primary address pool. Valid values: `IPV4`, `IPV6`, `DOMAIN`.
     * 
     */
    public Optional<Output<String>> defaultAddrPoolType() {
        return Optional.ofNullable(this.defaultAddrPoolType);
    }
    ...
    public Optional<Output<List<AccessStrategyDefaultAddrPoolArgs>>> defaultAddrPools() {
        return Optional.ofNullable(this.defaultAddrPools);
    }
     ...
     * 
     */
    @Import(name="defaultMinAvailableAddrNum")
    private @Nullable Output<Integer> defaultMinAvailableAddrNum;

    /**
     * @return The minimum number of available addresses for the primary address pool set.
     * 
     */
    public Optional<Output<Integer>> defaultMinAvailableAddrNum() {
        return Optional.ofNullable(this.defaultMinAvailableAddrNum);
    }
    ...
    private AccessStrategyState() {}

    private AccessStrategyState(AccessStrategyState $) {
    ...
    public static Builder builder(AccessStrategyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessStrategyState();
        }

        public Builder(AccessStrategyState defaults) {
            $ = new AccessStrategyState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder defaultAddrPoolType(@Nullable Output<String> defaultAddrPoolType) {
         ...
         * 
         */
        public Builder defaultAddrPools(@Nullable Output<List<AccessStrategyDefaultAddrPoolArgs>> defaultAddrPools) {
         ...
         * 
         */
        public Builder defaultMinAvailableAddrNum(@Nullable Output<Integer> defaultMinAvailableAddrNum) {
        ...
        public AccessStrategyState build() {
            return $;
        }
    }
