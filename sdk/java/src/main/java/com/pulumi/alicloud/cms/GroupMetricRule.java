...
public class GroupMetricRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public GroupMetricRule(java.lang.String name) {
     ...
     */
    public GroupMetricRule(java.lang.String name, GroupMetricRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GroupMetricRule(java.lang.String name, GroupMetricRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cms/groupMetricRule:GroupMetricRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private GroupMetricRule(java.lang.String name, Output<java.lang.String> id, @Nullable GroupMetricRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:cms/groupMetricRule:GroupMetricRule", name, state, makeResourceOptions(options, id), false);
    }

    private static GroupMetricRuleArgs makeArgs(GroupMetricRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? GroupMetricRuleArgs.Empty : args;
    }
     ...
     */
    public static GroupMetricRule get(java.lang.String name, Output<java.lang.String> id, @Nullable GroupMetricRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
