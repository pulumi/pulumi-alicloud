...
public class TairInstance extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return The custom key ID. You can call [DescribeEncryptionKeyList](https://help.aliyun.com/document_detail/473860.html) to obtain it.
     * 
     * &gt; **NOTE:**  * If this parameter is not specified, a key is automatically generated by [Key Management Service](https://help.aliyun.com/document_detail/28935.html).
     * 
     * &gt; **NOTE:**  * To create a custom key, you can call the [CreateKey](https://help.aliyun.com/document_detail/28947.html) operation of Key Management Service.
    ...
    private Output</* @Nullable */ String> encryptionName;

    /**
     * @return The encryption algorithm. The default value is AES-CTR-256.
     * 
     * &gt; **NOTE:**  This parameter is available only when the `TDEStatus` parameter is set to `Enabled`.
     * 
     * &gt; **NOTE:** This parameter only applies during resource update. If modified in isolation without other property changes, Terraform will not trigger any action.
     * 
     */
    public Output<Optional<String>> encryptionName() {
        return Codegen.optional(this.encryptionName);
    }
    /**
    ...
    /**
     * @return The database version. Default value: `1.0`. The valid values depend on the Tair instance series:
     * - tair_rdb: Tair memory-enhanced instances are compatible with Redis 5.0, Redis 6.0, and Redis 7.0. Set the value to `5.0`, `6.0`, or `7.0`.
     * - tair_scm: Tair persistent memory-optimized instances are compatible with Redis 6.0. Set the value to `1.0`.
     * - tair_essd: Tair disk-based instances (ESSD/SSD) are compatible with Redis 6.0. Set the value to `1.0` to create an ESSD-based instance or `2.0` to create an SSD-based instance.
     * 
    ...
    /**
     * @return The Alibaba Cloud Resource Name (ARN) of the role to be authorized. After authorization, you can use the related Key Management Service (KMS) features. Format: `acs:ram::$accountID:role/$roleName`.
     * 
     * &gt; **NOTE:**  * `$accountID`: Your Alibaba Cloud account ID. To view it, log on to the Alibaba Cloud console, move the pointer over your profile picture in the upper-right corner, and click **Security Settings**.
     * 
     * &gt; **NOTE:**  * `$roleName`: The RAM role name. The value is fixed as `AliyunRdsInstanceEncryptionDefaultRole`.
    ...
    /**
     * @return Specifies whether to enable Transparent Data Encryption (TDE). Valid value: `enabled`.
     * 
     * &gt; **NOTE:**  After TDE is enabled, it cannot be disabled. Evaluate the potential impact on your business before enabling this feature. For more information, see [Enable Transparent Data Encryption (TDE)](https://help.aliyun.com/document_detail/265913.html).
     * 
     */
