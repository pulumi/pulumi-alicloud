...
public class Stack extends com.pulumi.resources.CustomResource {
    ...
    public Stack(java.lang.String name, StackArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:ros/stack:Stack", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Stack(java.lang.String name, Output<java.lang.String> id, @Nullable StackState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:ros/stack:Stack", name, state, makeResourceOptions(options, id), false);
    }
