...
public class RdsInstanceCrossBackupPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public RdsInstanceCrossBackupPolicy(java.lang.String name, RdsInstanceCrossBackupPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RdsInstanceCrossBackupPolicy(java.lang.String name, RdsInstanceCrossBackupPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:rds/rdsInstanceCrossBackupPolicy:RdsInstanceCrossBackupPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RdsInstanceCrossBackupPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable RdsInstanceCrossBackupPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:rds/rdsInstanceCrossBackupPolicy:RdsInstanceCrossBackupPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static RdsInstanceCrossBackupPolicyArgs makeArgs(RdsInstanceCrossBackupPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RdsInstanceCrossBackupPolicyArgs.Empty : args;
    }
     ...
     */
    public static RdsInstanceCrossBackupPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable RdsInstanceCrossBackupPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
