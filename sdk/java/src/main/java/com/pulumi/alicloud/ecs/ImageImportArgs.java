...
public final class ImageImportArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(ImageImportArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ImageImportArgs defaults) {
            $ = new ImageImportArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder diskDeviceMappings(Output<List<ImageImportDiskDeviceMappingArgs>> diskDeviceMappings) {
