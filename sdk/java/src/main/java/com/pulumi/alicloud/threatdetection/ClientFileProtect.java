...
public class ClientFileProtect extends com.pulumi.resources.CustomResource {
     ...
     */
    public ClientFileProtect(java.lang.String name) {
     ...
     */
    public ClientFileProtect(java.lang.String name, ClientFileProtectArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ClientFileProtect(java.lang.String name, ClientFileProtectArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:threatdetection/clientFileProtect:ClientFileProtect", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ClientFileProtect(java.lang.String name, Output<java.lang.String> id, @Nullable ClientFileProtectState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:threatdetection/clientFileProtect:ClientFileProtect", name, state, makeResourceOptions(options, id), false);
    }

    private static ClientFileProtectArgs makeArgs(ClientFileProtectArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ClientFileProtectArgs.Empty : args;
    }
     ...
     */
    public static ClientFileProtect get(java.lang.String name, Output<java.lang.String> id, @Nullable ClientFileProtectState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
