...
public final class ManagedKubernetesWorkerDataDisk {
    ...
    public static Builder builder(ManagedKubernetesWorkerDataDisk defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ManagedKubernetesWorkerDataDisk defaults) {
        ...
        public Builder snapshotId(@Nullable String snapshotId) {
            this.snapshotId = snapshotId;
            return this;
        }        public ManagedKubernetesWorkerDataDisk build() {
            return new ManagedKubernetesWorkerDataDisk(autoSnapshotPolicyId, category, device, encrypted, kmsKeyId, name, performanceLevel, size, snapshotId);
        }
    }
}
