...
public final class GetExpressSyncsResult {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetExpressSyncsResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ids(List<String> ids) {
            if (ids == null) {
              throw new MissingRequiredPropertyException("GetExpressSyncsResult", "ids");
            }
            this.ids = ids;
            return this;
        }
        ...
        public Builder names(List<String> names) {
            if (names == null) {
              throw new MissingRequiredPropertyException("GetExpressSyncsResult", "names");
            }
            this.names = names;
            return this;
        }
        ...
        public Builder syncs(List<GetExpressSyncsSync> syncs) {
            if (syncs == null) {
              throw new MissingRequiredPropertyException("GetExpressSyncsResult", "syncs");
            }
            this.syncs = syncs;
            return this;
        }
