...
public final class KubernetesPermissionState extends com.pulumi.resources.ResourceArgs {
    ...
    private KubernetesPermissionState() {}

    private KubernetesPermissionState(KubernetesPermissionState $) {
    ...
    public static Builder builder(KubernetesPermissionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KubernetesPermissionState();
        }

        public Builder(KubernetesPermissionState defaults) {
            $ = new KubernetesPermissionState(Objects.requireNonNull(defaults));
        }
        ...
        public KubernetesPermissionState build() {
            return $;
        }
    }
