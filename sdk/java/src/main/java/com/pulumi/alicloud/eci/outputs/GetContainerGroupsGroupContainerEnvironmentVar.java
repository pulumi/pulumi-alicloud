...
public final class GetContainerGroupsGroupContainerEnvironmentVar {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetContainerGroupsGroupContainerEnvironmentVar", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetContainerGroupsGroupContainerEnvironmentVar", "value");
            }
            this.value = value;
            return this;
        }
        public GetContainerGroupsGroupContainerEnvironmentVar build() {
            final var _resultValue = new GetContainerGroupsGroupContainerEnvironmentVar();
