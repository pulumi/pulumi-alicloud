...
@CustomType
public final class ErEnvConfPresetCanaryTianjin {
    /**
    ...
    private ErEnvConfPresetCanaryTianjin(
    ...
    public static Builder builder(ErEnvConfPresetCanaryTianjin defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryTianjin defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryTianjin build() {
            return new ErEnvConfPresetCanaryTianjin(allowedHosts, codeRev, specName);
        }
    }
}
