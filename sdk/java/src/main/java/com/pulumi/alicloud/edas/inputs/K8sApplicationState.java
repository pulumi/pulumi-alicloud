...
public final class K8sApplicationState extends com.pulumi.resources.ResourceArgs {

    public static final K8sApplicationState Empty = new K8sApplicationState();
    ...
    private K8sApplicationState() {}

    private K8sApplicationState(K8sApplicationState $) {
    ...
    public static Builder builder(K8sApplicationState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new K8sApplicationState();
        }

        public Builder(K8sApplicationState defaults) {
            $ = new K8sApplicationState(Objects.requireNonNull(defaults));
        }
        ...
        public K8sApplicationState build() {
            return $;
        }
    }
