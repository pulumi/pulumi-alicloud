...
public final class GetFlowLogServicePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFlowLogServicePlainArgs Empty = new GetFlowLogServicePlainArgs();
    ...
    private GetFlowLogServicePlainArgs() {}

    private GetFlowLogServicePlainArgs(GetFlowLogServicePlainArgs $) {
        this.enable = $.enable;
    }
    ...
    public static Builder builder(GetFlowLogServicePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFlowLogServicePlainArgs();
        }

        public Builder(GetFlowLogServicePlainArgs defaults) {
            $ = new GetFlowLogServicePlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFlowLogServicePlainArgs build() {
            return $;
        }
    }
