...
@CustomType
public final class ErEnvConfPresetCanaryChongqing {
    /**
    ...
    private ErEnvConfPresetCanaryChongqing(
    ...
    public static Builder builder(ErEnvConfPresetCanaryChongqing defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryChongqing defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryChongqing build() {
            return new ErEnvConfPresetCanaryChongqing(allowedHosts, codeRev, specName);
        }
    }
}
