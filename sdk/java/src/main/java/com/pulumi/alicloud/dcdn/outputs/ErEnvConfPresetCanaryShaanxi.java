...
@CustomType
public final class ErEnvConfPresetCanaryShaanxi {
    /**
    ...
    private ErEnvConfPresetCanaryShaanxi(
    ...
    public static Builder builder(ErEnvConfPresetCanaryShaanxi defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryShaanxi defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryShaanxi build() {
            return new ErEnvConfPresetCanaryShaanxi(allowedHosts, codeRev, specName);
        }
    }
}
