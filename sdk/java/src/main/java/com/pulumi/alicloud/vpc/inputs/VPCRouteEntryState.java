...
public final class VPCRouteEntryState extends com.pulumi.resources.ResourceArgs {

    public static final VPCRouteEntryState Empty = new VPCRouteEntryState();
    ...
    private VPCRouteEntryState() {}

    private VPCRouteEntryState(VPCRouteEntryState $) {
    ...
    public static Builder builder(VPCRouteEntryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VPCRouteEntryState();
        }

        public Builder(VPCRouteEntryState defaults) {
            $ = new VPCRouteEntryState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param status The status of the route entry.
         * 
         * @return builder
         * 
         */
        ...
        public VPCRouteEntryState build() {
            return $;
        }
    }
