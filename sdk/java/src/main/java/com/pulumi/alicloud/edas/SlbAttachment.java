...
public class SlbAttachment extends com.pulumi.resources.CustomResource {
     ...
     */
    public SlbAttachment(java.lang.String name, SlbAttachmentArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SlbAttachment(java.lang.String name, SlbAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:edas/slbAttachment:SlbAttachment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SlbAttachment(java.lang.String name, Output<java.lang.String> id, @Nullable SlbAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:edas/slbAttachment:SlbAttachment", name, state, makeResourceOptions(options, id), false);
    }

    private static SlbAttachmentArgs makeArgs(SlbAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SlbAttachmentArgs.Empty : args;
    }
     ...
     */
    public static SlbAttachment get(java.lang.String name, Output<java.lang.String> id, @Nullable SlbAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
