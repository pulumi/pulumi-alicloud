...
public final class ErEnvConfPresetCanaryOverseasArgs extends com.pulumi.resources.ResourceArgs {

    public static final ErEnvConfPresetCanaryOverseasArgs Empty = new ErEnvConfPresetCanaryOverseasArgs();
    ...
    private ErEnvConfPresetCanaryOverseasArgs() {}

    private ErEnvConfPresetCanaryOverseasArgs(ErEnvConfPresetCanaryOverseasArgs $) {
    ...
    public static Builder builder(ErEnvConfPresetCanaryOverseasArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ErEnvConfPresetCanaryOverseasArgs();
        }

        public Builder(ErEnvConfPresetCanaryOverseasArgs defaults) {
            $ = new ErEnvConfPresetCanaryOverseasArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ErEnvConfPresetCanaryOverseasArgs build() {
            return $;
        }
    }
