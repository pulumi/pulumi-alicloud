...
public final class ErEnvConfPresetCanaryJilinArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ErEnvConfPresetCanaryJilinArgs() {}

    private ErEnvConfPresetCanaryJilinArgs(ErEnvConfPresetCanaryJilinArgs $) {
    ...
    public static Builder builder(ErEnvConfPresetCanaryJilinArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ErEnvConfPresetCanaryJilinArgs();
        }

        public Builder(ErEnvConfPresetCanaryJilinArgs defaults) {
        ...
        public ErEnvConfPresetCanaryJilinArgs build() {
            return $;
        }
    }
