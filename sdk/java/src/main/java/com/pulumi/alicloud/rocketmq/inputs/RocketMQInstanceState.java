...
public final class RocketMQInstanceState extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<String>> seriesCode() {
        return Optional.ofNullable(this.seriesCode);
    }
    ...
    public Optional<Output<String>> subSeriesCode() {
        return Optional.ofNullable(this.subSeriesCode);
    }
    ...
    public static Builder builder(RocketMQInstanceState defaults) {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder networkInfo(@Nullable Output<RocketMQInstanceNetworkInfoArgs> networkInfo) {
         ...
         * 
         */
        public Builder seriesCode(@Nullable Output<String> seriesCode) {
         ...
         * 
         */
        public Builder subSeriesCode(@Nullable Output<String> subSeriesCode) {
        ...
        public RocketMQInstanceState build() {
            return $;
        }
    }
