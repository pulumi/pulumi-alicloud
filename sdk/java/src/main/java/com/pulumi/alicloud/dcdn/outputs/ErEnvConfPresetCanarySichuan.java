...
@CustomType
public final class ErEnvConfPresetCanarySichuan {
    /**
    ...
    public static Builder builder(ErEnvConfPresetCanarySichuan defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanarySichuan defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanarySichuan build() {
            return new ErEnvConfPresetCanarySichuan(allowedHosts, codeRev, specName);
        }
    }
}
