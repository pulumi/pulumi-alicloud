...
public final class KeyState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<String> lastRotationDate;

    /**
     * @return The date and time the last rotation was performed. The time is displayed in UTC.
     * 
     */
    public Optional<Output<String>> lastRotationDate() {
    ...
    private @Nullable Output<String> materialExpireTime;
     ...
     * 
     */
    public Optional<Output<String>> materialExpireTime() {
    ...
    private @Nullable Output<String> nextRotationDate;

    /**
     * @return The time the next rotation is scheduled for execution.
     * 
     */
    public Optional<Output<String>> nextRotationDate() {
    ...
    private @Nullable Output<String> primaryKeyVersion;

    /**
     * @return The ID of the current primary key version of the symmetric CMK.
     * 
     */
    public Optional<Output<String>> primaryKeyVersion() {
    ...
    public static final class Builder {
        ...
        /**
         * @param lastRotationDate The date and time the last rotation was performed. The time is displayed in UTC.
         * 
         * @return builder
         * 
         */
        public Builder lastRotationDate(@Nullable Output<String> lastRotationDate) {
        ...
        /**
         * @param materialExpireTime The time and date the key material for the CMK expires. The time is displayed in UTC. If the value is empty, the key material for the CMK does not expire.
         * 
         * @return builder
         * 
         */
        public Builder materialExpireTime(@Nullable Output<String> materialExpireTime) {
        ...
        /**
         * @param nextRotationDate The time the next rotation is scheduled for execution.
         * 
         * @return builder
         * 
         */
        public Builder nextRotationDate(@Nullable Output<String> nextRotationDate) {
         ...
         * 
         */
        public Builder primaryKeyVersion(@Nullable Output<String> primaryKeyVersion) {
