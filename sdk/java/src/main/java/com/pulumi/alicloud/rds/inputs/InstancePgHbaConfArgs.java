...
public final class InstancePgHbaConfArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstancePgHbaConfArgs Empty = new InstancePgHbaConfArgs();
    ...
    private InstancePgHbaConfArgs() {}

    private InstancePgHbaConfArgs(InstancePgHbaConfArgs $) {
    ...
    public static Builder builder(InstancePgHbaConfArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstancePgHbaConfArgs();
        }

        public Builder(InstancePgHbaConfArgs defaults) {
            $ = new InstancePgHbaConfArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstancePgHbaConfArgs build() {
            if ($.address == null) {
                throw new MissingRequiredPropertyException("InstancePgHbaConfArgs", "address");
            }
            if ($.database == null) {
                throw new MissingRequiredPropertyException("InstancePgHbaConfArgs", "database");
            }
            if ($.method == null) {
                throw new MissingRequiredPropertyException("InstancePgHbaConfArgs", "method");
            }
            if ($.priorityId == null) {
                throw new MissingRequiredPropertyException("InstancePgHbaConfArgs", "priorityId");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("InstancePgHbaConfArgs", "type");
            }
            if ($.user == null) {
                throw new MissingRequiredPropertyException("InstancePgHbaConfArgs", "user");
            }
            return $;
        }
    }
