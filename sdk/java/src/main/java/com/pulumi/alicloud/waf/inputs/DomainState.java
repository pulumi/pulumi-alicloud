...
public final class DomainState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<String> isAccessProduct;
     ...
     * 
     */
    public Optional<Output<String>> isAccessProduct() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder isAccessProduct(@Nullable Output<String> isAccessProduct) {
