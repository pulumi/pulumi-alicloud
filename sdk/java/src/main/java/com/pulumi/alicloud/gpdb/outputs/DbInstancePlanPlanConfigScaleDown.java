...
@CustomType
public final class DbInstancePlanPlanConfigScaleDown {
    /**
    ...
    public static Builder builder(DbInstancePlanPlanConfigScaleDown defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String planTaskStatus;
        public Builder() {}
        public Builder(DbInstancePlanPlanConfigScaleDown defaults) {
        ...
        public DbInstancePlanPlanConfigScaleDown build() {
            final var _resultValue = new DbInstancePlanPlanConfigScaleDown();
