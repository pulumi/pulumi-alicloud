...
public class RouterVpcAssociation extends com.pulumi.resources.CustomResource {
     ...
     */
    public RouterVpcAssociation(String name) {
     ...
     */
    public RouterVpcAssociation(String name, RouterVpcAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:expressconnect/routerVpcAssociation:RouterVpcAssociation", name, args == null ? RouterVpcAssociationArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RouterVpcAssociation(String name, Output<String> id, @Nullable RouterVpcAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:expressconnect/routerVpcAssociation:RouterVpcAssociation", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RouterVpcAssociation get(String name, Output<String> id, @Nullable RouterVpcAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
