...
public class RdsServiceLinkedRole extends com.pulumi.resources.CustomResource {
     ...
     */
    public RdsServiceLinkedRole(java.lang.String name) {
     ...
     */
    public RdsServiceLinkedRole(java.lang.String name, RdsServiceLinkedRoleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RdsServiceLinkedRole(java.lang.String name, RdsServiceLinkedRoleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:rds/rdsServiceLinkedRole:RdsServiceLinkedRole", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RdsServiceLinkedRole(java.lang.String name, Output<java.lang.String> id, @Nullable RdsServiceLinkedRoleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:rds/rdsServiceLinkedRole:RdsServiceLinkedRole", name, state, makeResourceOptions(options, id), false);
    }

    private static RdsServiceLinkedRoleArgs makeArgs(RdsServiceLinkedRoleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RdsServiceLinkedRoleArgs.Empty : args;
    }
     ...
     */
    public static RdsServiceLinkedRole get(java.lang.String name, Output<java.lang.String> id, @Nullable RdsServiceLinkedRoleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
