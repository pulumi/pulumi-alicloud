...
public final class PolicyBindingArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PolicyBindingArgs() {}

    private PolicyBindingArgs(PolicyBindingArgs $) {
    ...
    public static Builder builder(PolicyBindingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PolicyBindingArgs defaults) {
            $ = new PolicyBindingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyBindingArgs build() {
            return $;
        }
    }
