...
public final class GetHybridMonitorDatasDataLabel {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetHybridMonitorDatasDataLabel", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetHybridMonitorDatasDataLabel", "value");
            }
            this.value = value;
            return this;
        }
