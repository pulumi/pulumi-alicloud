...
public final class KubernetesWorkerDataDiskArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The size of a data disk, Its valid value range [40~32768] in GB. Unit: GiB.
     * 
     */
    ...
    private KubernetesWorkerDataDiskArgs() {}

    private KubernetesWorkerDataDiskArgs(KubernetesWorkerDataDiskArgs $) {
    ...
    public static Builder builder(KubernetesWorkerDataDiskArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KubernetesWorkerDataDiskArgs();
        }

        public Builder(KubernetesWorkerDataDiskArgs defaults) {
            $ = new KubernetesWorkerDataDiskArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param encrypted Specifies whether to encrypt data disks. Valid values: true and false.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param size The size of a data disk, Its valid value range [40~32768] in GB. Unit: GiB.
         * 
         * @return builder
         * 
         */
        ...
        public KubernetesWorkerDataDiskArgs build() {
            return $;
        }
    }
