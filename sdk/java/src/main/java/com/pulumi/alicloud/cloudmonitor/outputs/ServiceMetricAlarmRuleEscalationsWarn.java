...
@CustomType
public final class ServiceMetricAlarmRuleEscalationsWarn {
    ...
    public static Builder builder(ServiceMetricAlarmRuleEscalationsWarn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer times;
        public Builder() {}
        public Builder(ServiceMetricAlarmRuleEscalationsWarn defaults) {
        ...
        public ServiceMetricAlarmRuleEscalationsWarn build() {
            final var _resultValue = new ServiceMetricAlarmRuleEscalationsWarn();
