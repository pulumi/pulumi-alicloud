...
@CustomType
public final class StarRocksInstanceFrontendNodeGroup {
    /**
    ...
    private StarRocksInstanceFrontendNodeGroup() {}
    /**
     * @return Number of CUs. CU (Compute Unit) is the basic measurement unit of the service, where 1 CU = 1 CPU core + 4 GiB memory.
     * 
     */
    ...
    public static Builder builder(StarRocksInstanceFrontendNodeGroup defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zoneId;
        public Builder() {}
        public Builder(StarRocksInstanceFrontendNodeGroup defaults) {
        ...
        public StarRocksInstanceFrontendNodeGroup build() {
            final var _resultValue = new StarRocksInstanceFrontendNodeGroup();
            _resultValue.cu = cu;
