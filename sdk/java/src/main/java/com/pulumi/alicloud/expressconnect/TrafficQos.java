...
public class TrafficQos extends com.pulumi.resources.CustomResource {
     ...
     */
    public TrafficQos(java.lang.String name) {
     ...
     */
    public TrafficQos(java.lang.String name, @Nullable TrafficQosArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TrafficQos(java.lang.String name, @Nullable TrafficQosArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:expressconnect/trafficQos:TrafficQos", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TrafficQos(java.lang.String name, Output<java.lang.String> id, @Nullable TrafficQosState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:expressconnect/trafficQos:TrafficQos", name, state, makeResourceOptions(options, id), false);
    }

    private static TrafficQosArgs makeArgs(@Nullable TrafficQosArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? TrafficQosArgs.Empty : args;
    }
     ...
     */
    public static TrafficQos get(java.lang.String name, Output<java.lang.String> id, @Nullable TrafficQosState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
