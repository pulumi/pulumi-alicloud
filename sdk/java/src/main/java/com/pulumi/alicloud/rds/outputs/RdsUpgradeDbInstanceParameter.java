...
public final class RdsUpgradeDbInstanceParameter {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("RdsUpgradeDbInstanceParameter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("RdsUpgradeDbInstanceParameter", "value");
            }
            this.value = value;
            return this;
        }
        public RdsUpgradeDbInstanceParameter build() {
            final var _resultValue = new RdsUpgradeDbInstanceParameter();
