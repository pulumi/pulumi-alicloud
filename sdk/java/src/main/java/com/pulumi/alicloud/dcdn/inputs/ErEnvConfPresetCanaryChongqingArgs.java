...
public final class ErEnvConfPresetCanaryChongqingArgs extends com.pulumi.resources.ResourceArgs {

    public static final ErEnvConfPresetCanaryChongqingArgs Empty = new ErEnvConfPresetCanaryChongqingArgs();
    ...
    private ErEnvConfPresetCanaryChongqingArgs() {}

    private ErEnvConfPresetCanaryChongqingArgs(ErEnvConfPresetCanaryChongqingArgs $) {
    ...
    public static Builder builder(ErEnvConfPresetCanaryChongqingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ErEnvConfPresetCanaryChongqingArgs();
        }

        public Builder(ErEnvConfPresetCanaryChongqingArgs defaults) {
            $ = new ErEnvConfPresetCanaryChongqingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ErEnvConfPresetCanaryChongqingArgs build() {
            return $;
        }
    }
