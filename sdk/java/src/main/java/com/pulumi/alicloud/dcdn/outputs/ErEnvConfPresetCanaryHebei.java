...
@CustomType
public final class ErEnvConfPresetCanaryHebei {
    /**
    ...
    public static Builder builder(ErEnvConfPresetCanaryHebei defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryHebei defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryHebei build() {
            return new ErEnvConfPresetCanaryHebei(allowedHosts, codeRev, specName);
        }
    }
}
