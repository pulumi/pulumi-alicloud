...
public final class BasicAcceleratorState extends com.pulumi.resources.ResourceArgs {

    public static final BasicAcceleratorState Empty = new BasicAcceleratorState();
    ...
    public static Builder builder(BasicAcceleratorState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BasicAcceleratorState();
        }

        public Builder(BasicAcceleratorState defaults) {
            $ = new BasicAcceleratorState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param status The status of the Basic Accelerator instance.
         * 
         * @return builder
         * 
         */
