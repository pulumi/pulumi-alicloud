...
public final class GetHybridMonitorSlsTasksResult {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetHybridMonitorSlsTasksResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ids(List<String> ids) {
            if (ids == null) {
              throw new MissingRequiredPropertyException("GetHybridMonitorSlsTasksResult", "ids");
            }
            this.ids = ids;
            return this;
        }
        ...
        public Builder tasks(List<GetHybridMonitorSlsTasksTask> tasks) {
            if (tasks == null) {
              throw new MissingRequiredPropertyException("GetHybridMonitorSlsTasksResult", "tasks");
            }
            this.tasks = tasks;
            return this;
        }
