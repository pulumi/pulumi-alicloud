...
@CustomType
public final class ErEnvConfPresetCanaryJiangxi {
    /**
    ...
    private ErEnvConfPresetCanaryJiangxi(
    ...
    public static Builder builder(ErEnvConfPresetCanaryJiangxi defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryJiangxi defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryJiangxi build() {
            return new ErEnvConfPresetCanaryJiangxi(allowedHosts, codeRev, specName);
        }
    }
}
