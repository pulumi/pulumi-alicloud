...
public final class BucketReplicationDestination {
    ...
    /**
     * @return The link used to transfer data in data replication.. Can be `internal` or `ossAcc`. Defaults to `internal`.
     * 
    ...
    public static final class Builder {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("BucketReplicationDestination", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder location(String location) {
            if (location == null) {
              throw new MissingRequiredPropertyException("BucketReplicationDestination", "location");
            }
