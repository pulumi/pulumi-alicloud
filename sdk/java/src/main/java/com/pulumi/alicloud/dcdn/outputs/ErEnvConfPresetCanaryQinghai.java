...
@CustomType
public final class ErEnvConfPresetCanaryQinghai {
    /**
    ...
    public static Builder builder(ErEnvConfPresetCanaryQinghai defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryQinghai defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryQinghai build() {
            return new ErEnvConfPresetCanaryQinghai(allowedHosts, codeRev, specName);
        }
    }
}
