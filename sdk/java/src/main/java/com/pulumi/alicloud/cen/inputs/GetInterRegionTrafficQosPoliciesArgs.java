    ...
    public static final class Builder {
        ...
        public GetInterRegionTrafficQosPoliciesArgs build() {
            if ($.transitRouterAttachmentId == null) {
                throw new MissingRequiredPropertyException("GetInterRegionTrafficQosPoliciesArgs", "transitRouterAttachmentId");
            }
            if ($.transitRouterId == null) {
                throw new MissingRequiredPropertyException("GetInterRegionTrafficQosPoliciesArgs", "transitRouterId");
            }
            return $;
        }
    }
