...
public final class GetTrafficMirrorServiceResult {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorServiceResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorServiceResult", "status");
            }
            this.status = status;
            return this;
        }
