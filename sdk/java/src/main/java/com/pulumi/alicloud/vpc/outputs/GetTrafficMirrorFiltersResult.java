...
public final class GetTrafficMirrorFiltersResult {
    ...
    public static final class Builder {
        ...
        public Builder filters(List<GetTrafficMirrorFiltersFilter> filters) {
            if (filters == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFiltersResult", "filters");
            }
        ...
        public Builder names(List<String> names) {
            if (names == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFiltersResult", "names");
            }
            this.names = names;
            return this;
        }
