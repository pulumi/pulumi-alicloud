...
package com.pulumi.alicloud.starrocks.outputs;
...
@CustomType
public final class InstanceFrontendNodeGroup {
    /**
    ...
    private InstanceFrontendNodeGroup() {}
    /**
     * @return Number of CUs. CU (Compute Unit) is the basic measurement unit of the service, where 1 CU = 1 CPU core + 4 GiB memory.
     * 
     */
    ...
    public static Builder builder(InstanceFrontendNodeGroup defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zoneId;
        public Builder() {}
        public Builder(InstanceFrontendNodeGroup defaults) {
        ...
        public InstanceFrontendNodeGroup build() {
            final var _resultValue = new InstanceFrontendNodeGroup();
            _resultValue.cu = cu;
