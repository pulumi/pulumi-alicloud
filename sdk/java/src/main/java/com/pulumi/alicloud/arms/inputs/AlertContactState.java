...
public final class AlertContactState extends com.pulumi.resources.ResourceArgs {

    public static final AlertContactState Empty = new AlertContactState();
    ...
    private AlertContactState() {}

    private AlertContactState(AlertContactState $) {
    ...
    public static Builder builder(AlertContactState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlertContactState();
        }

        public Builder(AlertContactState defaults) {
            $ = new AlertContactState(Objects.requireNonNull(defaults));
        }
        ...
        public AlertContactState build() {
            return $;
        }
    }
