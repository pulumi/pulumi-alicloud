...
public final class GroupMetricRuleState extends com.pulumi.resources.ResourceArgs {

    public static final GroupMetricRuleState Empty = new GroupMetricRuleState();
    ...
    private GroupMetricRuleState() {}

    private GroupMetricRuleState(GroupMetricRuleState $) {
    ...
    public static Builder builder(GroupMetricRuleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupMetricRuleState();
        }

        public Builder(GroupMetricRuleState defaults) {
            $ = new GroupMetricRuleState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder escalations(@Nullable Output<GroupMetricRuleEscalationsArgs> escalations) {
        ...
        public GroupMetricRuleState build() {
            return $;
        }
    }
