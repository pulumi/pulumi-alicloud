...
public class Activation extends com.pulumi.resources.CustomResource {
     ...
     */
    public Activation(java.lang.String name, @Nullable ActivationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Activation(java.lang.String name, @Nullable ActivationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:ecs/activation:Activation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Activation(java.lang.String name, Output<java.lang.String> id, @Nullable ActivationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:ecs/activation:Activation", name, state, makeResourceOptions(options, id), false);
    }

    private static ActivationArgs makeArgs(@Nullable ActivationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
