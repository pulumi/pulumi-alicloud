...
import com.pulumi.alicloud.configaggregate.inputs.RemediationState;
 ...
 * 
 * @deprecated
 * alicloud.configaggregate/remediation.Remediation has been deprecated in favor of alicloud.cfg/aggregateremediation.AggregateRemediation
 * 
 */
...
@ResourceType(type="alicloud:configaggregate/remediation:Remediation")
public class Remediation extends com.pulumi.resources.CustomResource {
    ...
    public Remediation(java.lang.String name, RemediationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:configaggregate/remediation:Remediation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Remediation(java.lang.String name, Output<java.lang.String> id, @Nullable RemediationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:configaggregate/remediation:Remediation", name, state, makeResourceOptions(options, id), false);
    }
