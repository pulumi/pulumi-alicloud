...
public final class GetTrafficMirrorFilterIngressRulesRule {
    ...
    public static final class Builder {
        ...
        public Builder trafficMirrorFilterRuleId(String trafficMirrorFilterRuleId) {
            ...
            return new GetTrafficMirrorFilterIngressRulesRule(destinationCidrBlock, destinationPortRange, id, priority, protocol, ruleAction, sourceCidrBlock, sourcePortRange, status, trafficMirrorFilterId, trafficMirrorFilterRuleId);
        }
    }
}
