...
@CustomType
public final class ApplicationPreStopV2Exec {
    /**
    ...
    private ApplicationPreStopV2Exec() {}
    /**
     * @return Mirror start command. The command must be an executable object in the container. For example: sleep. Setting this command will cause the original startup command of the mirror to become invalid.
     * 
     */
    ...
    public static Builder builder(ApplicationPreStopV2Exec defaults) {
    ...
    public static final class Builder {
        private @Nullable List<String> commands;
        public Builder() {}
        public Builder(ApplicationPreStopV2Exec defaults) {
