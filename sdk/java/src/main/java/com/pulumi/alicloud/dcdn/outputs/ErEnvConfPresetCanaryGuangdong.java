...
@CustomType
public final class ErEnvConfPresetCanaryGuangdong {
    /**
    ...
    private ErEnvConfPresetCanaryGuangdong(
    ...
    public static Builder builder(ErEnvConfPresetCanaryGuangdong defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryGuangdong defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryGuangdong build() {
            return new ErEnvConfPresetCanaryGuangdong(allowedHosts, codeRev, specName);
        }
    }
}
