    ...
    public static final class Builder {
        ...
        public Builder serverGroupTuples(List<GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfigServerGroupTuple> serverGroupTuples) {
            if (serverGroupTuples == null) {
              throw new MissingRequiredPropertyException("GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfig", "serverGroupTuples");
            }
        ...
        public GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfig build() {
            final var _resultValue = new GetRulesRuleRuleActionTrafficMirrorConfigMirrorGroupConfig();
