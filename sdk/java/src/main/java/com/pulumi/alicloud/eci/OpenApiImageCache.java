...
public class OpenApiImageCache extends com.pulumi.resources.CustomResource {
     ...
     */
    public OpenApiImageCache(String name) {
     ...
     */
    public OpenApiImageCache(String name, OpenApiImageCacheArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:eci/openApiImageCache:OpenApiImageCache", name, args == null ? OpenApiImageCacheArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OpenApiImageCache(String name, Output<String> id, @Nullable OpenApiImageCacheState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:eci/openApiImageCache:OpenApiImageCache", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static OpenApiImageCache get(String name, Output<String> id, @Nullable OpenApiImageCacheState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
