...
public final class RouterInterfaceState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<String> oppositeRegion;

    /**
     * @return The Region of peer side.
     * 
     */
    public Optional<Output<String>> oppositeRegion() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder oppositeRegion(@Nullable Output<String> oppositeRegion) {
