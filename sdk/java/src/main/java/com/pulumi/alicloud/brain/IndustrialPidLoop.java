...
public class IndustrialPidLoop extends com.pulumi.resources.CustomResource {
     ...
     */
    public IndustrialPidLoop(java.lang.String name) {
     ...
     */
    public IndustrialPidLoop(java.lang.String name, IndustrialPidLoopArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IndustrialPidLoop(java.lang.String name, IndustrialPidLoopArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:brain/industrialPidLoop:IndustrialPidLoop", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IndustrialPidLoop(java.lang.String name, Output<java.lang.String> id, @Nullable IndustrialPidLoopState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:brain/industrialPidLoop:IndustrialPidLoop", name, state, makeResourceOptions(options, id), false);
    }

    private static IndustrialPidLoopArgs makeArgs(IndustrialPidLoopArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? IndustrialPidLoopArgs.Empty : args;
    }
     ...
     */
    public static IndustrialPidLoop get(java.lang.String name, Output<java.lang.String> id, @Nullable IndustrialPidLoopState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
