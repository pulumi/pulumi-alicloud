...
@CustomType
public final class ErEnvConfPresetCanaryZhejiang {
    /**
    ...
    private ErEnvConfPresetCanaryZhejiang(
    ...
    public static Builder builder(ErEnvConfPresetCanaryZhejiang defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryZhejiang defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryZhejiang build() {
            return new ErEnvConfPresetCanaryZhejiang(allowedHosts, codeRev, specName);
        }
    }
}
