...
public final class GetAlarmContactGroupsResult {
    private final List<GetAlarmContactGroupsGroup> groups;
    /**
    ...
    private GetAlarmContactGroupsResult(
        @CustomType.Parameter("groups") List<GetAlarmContactGroupsGroup> groups,
    ...
    public static final class Builder {
        ...
        public Builder outputFile(@Nullable String outputFile) {
            ...
            return new GetAlarmContactGroupsResult(groups, id, ids, nameRegex, names, outputFile);
        }
    }
}
