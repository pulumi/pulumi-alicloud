...
public final class GetAlarmContactGroupsResult {
    ...
    public static final class Builder {
        ...
        public Builder groups(List<GetAlarmContactGroupsGroup> groups) {
            if (groups == null) {
              throw new MissingRequiredPropertyException("GetAlarmContactGroupsResult", "groups");
            }
            this.groups = groups;
            return this;
        }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAlarmContactGroupsResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ids(List<String> ids) {
            if (ids == null) {
              throw new MissingRequiredPropertyException("GetAlarmContactGroupsResult", "ids");
            }
            this.ids = ids;
            return this;
        }
        ...
        public Builder names(List<String> names) {
            if (names == null) {
              throw new MissingRequiredPropertyException("GetAlarmContactGroupsResult", "names");
            }
            this.names = names;
            return this;
        }
