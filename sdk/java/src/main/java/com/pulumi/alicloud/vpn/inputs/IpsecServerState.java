...
public final class IpsecServerState extends com.pulumi.resources.ResourceArgs {

    public static final IpsecServerState Empty = new IpsecServerState();
    ...
    private IpsecServerState() {}

    private IpsecServerState(IpsecServerState $) {
    ...
    public static Builder builder(IpsecServerState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpsecServerState();
        }

        public Builder(IpsecServerState defaults) {
            $ = new IpsecServerState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param ikeConfigs The configuration of Phase 1 negotiations. See `ikeConfig` below.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param ipsecConfigs The configuration of Phase 2 negotiations. See `ipsecConfig` below.
         * 
         * @return builder
         * 
         */
