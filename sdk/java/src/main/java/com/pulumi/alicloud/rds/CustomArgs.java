...
public final class CustomArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public CustomArgs build() {
            if ($.amount == null) {
                throw new MissingRequiredPropertyException("CustomArgs", "amount");
            }
            if ($.instanceType == null) {
                throw new MissingRequiredPropertyException("CustomArgs", "instanceType");
            }
            if ($.vswitchId == null) {
                throw new MissingRequiredPropertyException("CustomArgs", "vswitchId");
            }
            return $;
        }
    }
