...
public final class BastionHostInstanceLdapAuthServer {
    ...
    public static final class Builder {
        ...
        public Builder account(String account) {
            if (account == null) {
              throw new MissingRequiredPropertyException("BastionHostInstanceLdapAuthServer", "account");
            }
        ...
        public Builder baseDn(String baseDn) {
            if (baseDn == null) {
              throw new MissingRequiredPropertyException("BastionHostInstanceLdapAuthServer", "baseDn");
            }
            this.baseDn = baseDn;
            return this;
        }
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("BastionHostInstanceLdapAuthServer", "password");
            }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("BastionHostInstanceLdapAuthServer", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder server(String server) {
            if (server == null) {
              throw new MissingRequiredPropertyException("BastionHostInstanceLdapAuthServer", "server");
            }
            this.server = server;
            return this;
        }
