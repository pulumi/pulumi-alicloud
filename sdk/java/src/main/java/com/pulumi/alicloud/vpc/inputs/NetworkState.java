...
public final class NetworkState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param dnsHostnameStatus Whether to enable the DNS hostname feature. Valid values: `ENABLED`, `DISABLED`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param regionId The ID of the region where the VPC is located.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param routeTableId The ID of the system route table.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param routerTableId . Field &#39;router_table_id&#39; has been deprecated from provider version 1.227.1. New field &#39;route_table_id&#39; instead.
         * 
         * @return builder
         * 
         * @deprecated
