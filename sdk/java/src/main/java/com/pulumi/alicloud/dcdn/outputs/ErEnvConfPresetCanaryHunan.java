...
@CustomType
public final class ErEnvConfPresetCanaryHunan {
    /**
    ...
    private ErEnvConfPresetCanaryHunan(
    ...
    public static Builder builder(ErEnvConfPresetCanaryHunan defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryHunan defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            ...
            return new ErEnvConfPresetCanaryHunan(allowedHosts, codeRev, specName);
        }
    }
}
