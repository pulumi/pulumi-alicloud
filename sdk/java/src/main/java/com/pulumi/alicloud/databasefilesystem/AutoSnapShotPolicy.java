...
public class AutoSnapShotPolicy extends com.pulumi.resources.CustomResource {
    ...
    public AutoSnapShotPolicy(java.lang.String name, AutoSnapShotPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:databasefilesystem/autoSnapShotPolicy:AutoSnapShotPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AutoSnapShotPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable AutoSnapShotPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:databasefilesystem/autoSnapShotPolicy:AutoSnapShotPolicy", name, state, makeResourceOptions(options, id), false);
    }
