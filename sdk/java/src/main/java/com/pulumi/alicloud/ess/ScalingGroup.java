...
public class ScalingGroup extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="capacityOptionsPriceComparisonMode", refs={String.class}, tree="[0]")
    private Output<String> capacityOptionsPriceComparisonMode;

    /**
     * @return The price comparison mode. Valid values: PricePerUnit,PricePerVCpu. Default value: PricePerUnit.
     * 
     */
    public Output<String> capacityOptionsPriceComparisonMode() {
        return this.capacityOptionsPriceComparisonMode;
    }
    /**
