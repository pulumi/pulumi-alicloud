...
public final class GetTablesTableDefinedColumn {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetTablesTableDefinedColumn", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetTablesTableDefinedColumn", "type");
            }
            this.type = type;
            return this;
        }
