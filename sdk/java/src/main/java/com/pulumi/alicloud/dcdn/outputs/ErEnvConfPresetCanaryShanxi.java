...
@CustomType
public final class ErEnvConfPresetCanaryShanxi {
    /**
    ...
    private ErEnvConfPresetCanaryShanxi(
    ...
    public static Builder builder(ErEnvConfPresetCanaryShanxi defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErEnvConfPresetCanaryShanxi defaults) {
        ...
        public Builder specName(@Nullable String specName) {
            this.specName = specName;
            return this;
        }        public ErEnvConfPresetCanaryShanxi build() {
            return new ErEnvConfPresetCanaryShanxi(allowedHosts, codeRev, specName);
        }
    }
}
