...
public class Instance extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="authModel", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> authModel;

    /**
     * @return The authentication mode of the instance. Default value: `ram`. Valid values:
     * 
     */
    public Output<Optional<String>> authModel() {
        return Codegen.optional(this.authModel);
    }
    /**
