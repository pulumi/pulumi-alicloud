...
import com.pulumi.alicloud.esa.inputs.SiteOriginClientCertificateState;
 ...
 * ## Import
 * 
 * ESA Site Origin Client Certificate can be imported using the id, which consists of siteId and site_origin_client_certificate_id, e.g.
 * 
 * ```sh
 ...
 * 
 */
@ResourceType(type="alicloud:esa/siteOriginClientCertificate:SiteOriginClientCertificate")
public class SiteOriginClientCertificate extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="siteOriginClientCertificateId", refs={String.class}, tree="[0]")
    private Output<String> siteOriginClientCertificateId;

    /**
     * @return The certificate ID on ESA.
     * 
     */
    public Output<String> siteOriginClientCertificateId() {
        return this.siteOriginClientCertificateId;
    }
    /**
     * The certificate name.
     * 
     */
    @Export(name="siteOriginClientCertificateName", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> siteOriginClientCertificateName;

    /**
     * @return The certificate name.
     * 
     */
    public Output<Optional<String>> siteOriginClientCertificateName() {
        return Codegen.optional(this.siteOriginClientCertificateName);
    }
    /**
     ...
     */
    public SiteOriginClientCertificate(java.lang.String name) {
        this(name, SiteOriginClientCertificateArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SiteOriginClientCertificate(java.lang.String name, SiteOriginClientCertificateArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SiteOriginClientCertificate(java.lang.String name, SiteOriginClientCertificateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:esa/siteOriginClientCertificate:SiteOriginClientCertificate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SiteOriginClientCertificate(java.lang.String name, Output<java.lang.String> id, @Nullable SiteOriginClientCertificateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("alicloud:esa/siteOriginClientCertificate:SiteOriginClientCertificate", name, state, makeResourceOptions(options, id), false);
    }

    private static SiteOriginClientCertificateArgs makeArgs(SiteOriginClientCertificateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SiteOriginClientCertificateArgs.Empty : args;
    }
     ...
     */
    public static SiteOriginClientCertificate get(java.lang.String name, Output<java.lang.String> id, @Nullable SiteOriginClientCertificateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
