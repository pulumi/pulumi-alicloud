...
public final class GetDbInstancePlansPlanPlanConfigScaleIn {
    ...
    public static final class Builder {
        ...
        public Builder executeTime(String executeTime) {
            if (executeTime == null) {
              throw new MissingRequiredPropertyException("GetDbInstancePlansPlanPlanConfigScaleIn", "executeTime");
            }
        ...
        public Builder planCronTime(String planCronTime) {
            if (planCronTime == null) {
              throw new MissingRequiredPropertyException("GetDbInstancePlansPlanPlanConfigScaleIn", "planCronTime");
            }
        ...
        public Builder planTaskStatus(String planTaskStatus) {
            if (planTaskStatus == null) {
              throw new MissingRequiredPropertyException("GetDbInstancePlansPlanPlanConfigScaleIn", "planTaskStatus");
            }
        ...
        public Builder segmentNodeNum(String segmentNodeNum) {
            if (segmentNodeNum == null) {
              throw new MissingRequiredPropertyException("GetDbInstancePlansPlanPlanConfigScaleIn", "segmentNodeNum");
            }
