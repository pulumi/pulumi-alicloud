...
public final class ClusterNodeGroupSystemDisk {
    ...
    public static final class Builder {
        ...
        public Builder category(String category) {
            if (category == null) {
              throw new MissingRequiredPropertyException("ClusterNodeGroupSystemDisk", "category");
            }
        ...
        public Builder size(Integer size) {
            if (size == null) {
              throw new MissingRequiredPropertyException("ClusterNodeGroupSystemDisk", "size");
            }
            this.size = size;
            return this;
        }
