...
export class DomainConfig extends pulumi.CustomResource {
     ...
     */
    declare public readonly functionArgs: pulumi.Output<outputs.dcdn.DomainConfigFunctionArg[]>;
    /**
...
export interface DomainConfigState {
     ...
     * The args of the domain config. See `functionArgs` below.
     */
    functionArgs?: pulumi.Input<pulumi.Input<inputs.dcdn.DomainConfigFunctionArg>[] | undefined>;
    /**
     * The name of the domain config.
     */
