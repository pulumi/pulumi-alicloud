...
export class ServiceEventRule extends pulumi.CustomResource {
     ...
     */
    declare public readonly deliveryMode: pulumi.Output<string>;
    /**
     * Message Receiving Terminal Endpoint Object. See `endpoint` below.
     */
    declare public readonly endpoint: pulumi.Output<outputs.message.ServiceEventRuleEndpoint | undefined>;
    /**
     * Event Type List
     */
     ...
     */
    declare public readonly matchRules: pulumi.Output<outputs.message.ServiceEventRuleMatchRule[][] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ServiceEventRuleArgs | ServiceEventRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["deliveryMode"] = state?.deliveryMode;
            ...
            resourceInputs["deliveryMode"] = args?.deliveryMode;
