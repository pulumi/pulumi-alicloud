...
export class ServiceBasicPublic extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceBasicPublicState, opts?: pulumi.CustomResourceOptions): ServiceBasicPublic {
        return new ServiceBasicPublic(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'alicloud:cloudmonitor/serviceBasicPublic:ServiceBasicPublic';

    /**
     * Returns true if the given object is an instance of ServiceBasicPublic.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ServiceBasicPublic {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ServiceBasicPublic.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: ServiceBasicPublicArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ServiceBasicPublicArgs | ServiceBasicPublicState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ServiceBasicPublic.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ServiceBasicPublicState {
    /**
     * The creation time of the resource.
     */
 ...
 */
export interface ServiceBasicPublicArgs {
}
