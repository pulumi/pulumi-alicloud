...
export function getInstances(args?: GetInstancesArgs, opts?: pulumi.InvokeOptions): Promise<GetInstancesResult> {
    ...
    return pulumi.runtime.invoke("alicloud:sslcertificatesservice/getInstances:getInstances", {
        "brand": args.brand,
...
export interface GetInstancesResult {
     ...
     */
    readonly instances: outputs.sslcertificatesservice.GetInstancesInstance[];
...
export function getInstancesOutput(args?: GetInstancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstancesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("alicloud:sslcertificatesservice/getInstances:getInstances", {
        "brand": args.brand,
        "certificateStatus": args.certificateStatus,
        "certificateType": args.certificateType,
        "enableDetails": args.enableDetails,
