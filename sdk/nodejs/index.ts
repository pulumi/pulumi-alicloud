...
export {actiontrail, adb, alikafka, apigateway, cas, cassandra, cdn, cen, cfg, cloudconnect, cms, config, cr, cs, datahub, dcdn, ddos, dds, dms, dns, drds, eci, ecs, edas, elasticsearch, emr, ess, fc, gpdb, hbase, kms, kvstore, log, marketplace, maxcompute, mns, mongodb, mse, nas, oos, oss, ots, polardb, pvtz, ram, rds, resourcemanager, rocketmq, sag, slb, types, vpc, vpn, waf, yundun};
