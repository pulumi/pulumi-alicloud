...
export class NatGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NatGatewayState): NatGateway {
        return new NatGateway(name, <any>state, { id });
    }
     ...
     */
    public readonly bandwidthPackages: pulumi.Output<{ bandwidth: number, ipCount: number, publicIpAddresses: string, zone: string }[] | undefined>;
    /**
...
export interface NatGatewayState {
     ...
     * A list of bandwidth packages for the nat gatway. Only support nat gateway created before 00:00 on November 4, 2017. Available in v1.13.0+ and v1.7.1-.
     */
    readonly bandwidthPackages?: pulumi.Input<pulumi.Input<{ bandwidth: pulumi.Input<number>, ipCount: pulumi.Input<number>, publicIpAddresses?: pulumi.Input<string>, zone?: pulumi.Input<string> }>[]>;
    /**
     * Description of the nat gateway, This description can have a string of 2 to 256 characters, It cannot begin with http:// or https://. Defaults to null.
     */
