 ...
 * ## Import
 *
 * Bastion Host Host Account can be imported using the id, which consists of instance_id, userId and host_group_id, e.g.
 *
 * ```sh
...
export interface HostGroupAccountUserAttachmentState {
     ...
     * A list names of the host account.
     */
    hostAccountNames?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * The ID of the host group.
     */
