 ...
 *
 * > **WARN:** There is a serious bug in the `trafficPercentage` of the `alicloud.ga.EndpointGroup` before version 1.211.1, while the value of `trafficPercentage` has not been explicitly specified in the Terraform code, Terraform will set `trafficPercentage` to `0`. This behavior will cause your instance traffic to drop to zero. So, please use provider greater than or equal to version `1.211.1`.
 *
 * ## Example Usage
 *
 * Basic Usage
