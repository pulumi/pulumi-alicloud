...
export class AclEntryAttachment extends pulumi.CustomResource {
     ...
     */
    declare public readonly entryDescription: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AclEntryAttachmentArgs | AclEntryAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["entryDescription"] = state?.entryDescription;
            ...
            resourceInputs["entryDescription"] = args?.entryDescription;
