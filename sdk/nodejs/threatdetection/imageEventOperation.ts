...
export class ImageEventOperation extends pulumi.CustomResource {
     ...
     */
    declare public readonly conditions: pulumi.Output<string>;
    /**
     ...
     * The operation code.
     */
    declare public readonly operationCode: pulumi.Output<string>;
    /**
     * The application scope of the rule.
     */
    declare public readonly scenarios: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: ImageEventOperationArgs | ImageEventOperationState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if (args?.operationCode === undefined && !opts.urn) {
