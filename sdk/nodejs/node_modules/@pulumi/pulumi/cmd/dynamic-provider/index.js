...
function cancelRPC(call, callback) {
    callback(undefined, new emptyproto.Empty());
}
function configureRPC(call, callback) {
    callback(undefined, new emptyproto.Empty());
}
function invokeRPC(call, callback) {
...
function diffRPC(call, callback) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const req = call.request;
...
function createRPC(call, callback) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const req = call.request;
...
function readRPC(call, callback) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const req = call.request;
...
function updateRPC(call, callback) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const req = call.request;
...
function deleteRPC(call, callback) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const req = call.request;
            const props = req.getProperties().toJavaScript();
            const provider = yield getProvider(props);
            if (provider.delete) {
