...
`,
    ...
    cases.push({
        ...
        func: () => __awaiter(this, void 0, void 0, function* () { console.log(this); }),
        expectText: undefined,
        error: `Error serializing function 'func': closure.spec.js(0,0)
...
`,
    ...
    {
        const v = {
            d1: resource_1.output(4),
            d2: resource_1.output("str"),
            d3: resource_1.output(undefined),
            d4: resource_1.output({ a: 1, b: true }),
        };
        cases.push({
...
`,
    ...
    }
    {
        ...
        v.d2 = resource_1.output({ a: 1, b: v });
        cases.push({
...
Module './bin/index.js' is a 'deployment only' module. In general these cannot be captured inside a 'run time' function.`
    ...
    }
    {
        ...
        // 'require-reference'.
        index_1.runtime.setConfig("test:TestingKey1", "TestingValue1");
...
`,
    ...
    {
        index_1.runtime.setConfig("test:TestingKey2", "TestingValue2");
        cases.push({
    ...
    function serializeFunction(test) {
        return __awaiter(this, void 0, void 0, function* () {
            if (test.func) {
                ...
                return yield index_1.runtime.serializeFunction(test.factoryFunc, { isFactoryFunction: true });
            }
            else {
...
function compareTextWithWildcards(expected, actual) {
    ...
    const expectedLines = expected.split(os_1.EOL);
    const actualLines = actual.split(os_1.EOL);
    let actualIndex = 0;
