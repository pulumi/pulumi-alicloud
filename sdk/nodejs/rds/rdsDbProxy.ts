...
export class RdsDbProxy extends pulumi.CustomResource {
     ...
     */
    declare public readonly dbProxyConnectStringPort: pulumi.Output<number>;
    /**
     * The new prefix of the proxy endpoint. Enter a prefix.
     */
    declare public readonly dbProxyConnectionPrefix: pulumi.Output<string>;
    /**
     * Connection instance string.
     */
    declare public /*out*/ readonly dbProxyConnectionString: pulumi.Output<string>;
    /**
     * Remarks of agent terminal.
     */
    declare public /*out*/ readonly dbProxyEndpointAliases: pulumi.Output<string>;
    /**
     * Proxy connection address ID.
     */
    declare public /*out*/ readonly dbProxyEndpointId: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly dbProxyEndpointReadWriteMode: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly dbProxyFeatures: pulumi.Output<string>;
    /**
     * The number of proxy instances that are enabled. Valid values: 1 to 60.
     */
    declare public readonly dbProxyInstanceNum: pulumi.Output<number>;
    /**
     * The database proxy type. Valid values:
     * - common: universal proxy.
     * - exclusive: Exclusive proxy (default).
     */
    declare public readonly dbProxyInstanceType: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly dbProxySslEnabled: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly effectiveSpecificTime: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly effectiveTime: pulumi.Output<string>;
    /**
     ...
     */
    declare public /*out*/ readonly netType: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly readOnlyInstanceDistributionType: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly readOnlyInstanceMaxDelayTime: pulumi.Output<number>;
    /**
     ...
     */
    declare public readonly readOnlyInstanceWeights: pulumi.Output<outputs.rds.RdsDbProxyReadOnlyInstanceWeight[]>;
    /**
    ...
    constructor(name: string, argsOrState?: RdsDbProxyArgs | RdsDbProxyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["dbProxyConnectStringPort"] = state?.dbProxyConnectStringPort;
            resourceInputs["dbProxyConnectionPrefix"] = state?.dbProxyConnectionPrefix;
            resourceInputs["dbProxyConnectionString"] = state?.dbProxyConnectionString;
            resourceInputs["dbProxyEndpointAliases"] = state?.dbProxyEndpointAliases;
            resourceInputs["dbProxyEndpointId"] = state?.dbProxyEndpointId;
            resourceInputs["dbProxyEndpointReadWriteMode"] = state?.dbProxyEndpointReadWriteMode;
            resourceInputs["dbProxyFeatures"] = state?.dbProxyFeatures;
            resourceInputs["dbProxyInstanceNum"] = state?.dbProxyInstanceNum;
            resourceInputs["dbProxyInstanceType"] = state?.dbProxyInstanceType;
            resourceInputs["dbProxySslEnabled"] = state?.dbProxySslEnabled;
            resourceInputs["effectiveSpecificTime"] = state?.effectiveSpecificTime;
            ...
            resourceInputs["readOnlyInstanceDistributionType"] = state?.readOnlyInstanceDistributionType;
            resourceInputs["readOnlyInstanceMaxDelayTime"] = state?.readOnlyInstanceMaxDelayTime;
            resourceInputs["readOnlyInstanceWeights"] = state?.readOnlyInstanceWeights;
            ...
            if (args?.dbProxyInstanceNum === undefined && !opts.urn) {
                throw new Error("Missing required property 'dbProxyInstanceNum'");
            }
            if (args?.instanceId === undefined && !opts.urn) {
                throw new Error("Missing required property 'instanceId'");
            }
            if (args?.instanceNetworkType === undefined && !opts.urn) {
            ...
            resourceInputs["dbProxyConnectStringPort"] = args?.dbProxyConnectStringPort;
            resourceInputs["dbProxyConnectionPrefix"] = args?.dbProxyConnectionPrefix;
            resourceInputs["dbProxyEndpointReadWriteMode"] = args?.dbProxyEndpointReadWriteMode;
            resourceInputs["dbProxyFeatures"] = args?.dbProxyFeatures;
            resourceInputs["dbProxyInstanceNum"] = args?.dbProxyInstanceNum;
            resourceInputs["dbProxyInstanceType"] = args?.dbProxyInstanceType;
            resourceInputs["dbProxySslEnabled"] = args?.dbProxySslEnabled;
            resourceInputs["effectiveSpecificTime"] = args?.effectiveSpecificTime;
            resourceInputs["effectiveTime"] = args?.effectiveTime;
            resourceInputs["instanceId"] = args?.instanceId;
            resourceInputs["instanceNetworkType"] = args?.instanceNetworkType;
            resourceInputs["readOnlyInstanceDistributionType"] = args?.readOnlyInstanceDistributionType;
            resourceInputs["readOnlyInstanceMaxDelayTime"] = args?.readOnlyInstanceMaxDelayTime;
            resourceInputs["readOnlyInstanceWeights"] = args?.readOnlyInstanceWeights;
