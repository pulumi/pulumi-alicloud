 ...
 *
 * const cross_region_replication = new alicloud.ots.BucketReplication("cross-region-replication", {
 *     action: "ALL",
 ...
 *     },
 * });
 * const same_region_replication = new alicloud.ots.BucketReplication("same-region-replication", {
 *     action: "ALL",
 *     bucket: "bucket-in-hangzhou",
 *     destination: {
 ...
 *     },
 * });
 * const replication_with_prefix = new alicloud.ots.BucketReplication("replication-with-prefix", {
 *     action: "ALL",
 *     bucket: "bucket-1",
 *     destination: {
 *         bucket: "bucket-2",
 ...
 *     },
 * });
 * const replication_with_specific_action = new alicloud.ots.BucketReplication("replication-with-specific-action", {
 *     action: "PUT",
 *     bucket: "bucket-1",
 *     destination: {
 *         bucket: "bucket-2",
 ...
 *     historicalObjectReplication: "disabled",
 * });
 * const replication_with_kms_encryption = new alicloud.ots.BucketReplication("replication-with-kms-encryption", {
 *     action: "ALL",
 *     bucket: "bucket-1",
 *     destination: {
 *         bucket: "bucket-2",
...
export class BucketReplication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'alicloud:ots/bucketReplication:BucketReplication';
     ...
     */
    public readonly destination!: pulumi.Output<outputs.ots.BucketReplicationDestination>;
    /**
     ...
     */
    public readonly encryptionConfiguration!: pulumi.Output<outputs.ots.BucketReplicationEncryptionConfiguration | undefined>;
    /**
     ...
     */
    public readonly prefixSet!: pulumi.Output<outputs.ots.BucketReplicationPrefixSet | undefined>;
    /**
     ...
     */
    public readonly progress!: pulumi.Output<outputs.ots.BucketReplicationProgress>;
    /**
     ...
     */
    public readonly sourceSelectionCriteria!: pulumi.Output<outputs.ots.BucketReplicationSourceSelectionCriteria | undefined>;
    /**
...
export interface BucketReplicationState {
     ...
     * Specifies the destination for the rule(See the following block `destination`).
     */
    destination?: pulumi.Input<inputs.ots.BucketReplicationDestination>;
    /**
     * Specifies the encryption configuration for the objects replicated to the destination bucket(See the following block `encryptionConfiguration`).
     */
    encryptionConfiguration?: pulumi.Input<inputs.ots.BucketReplicationEncryptionConfiguration>;
    /**
     * Specifies whether to replicate historical data from the source bucket to the destination bucket before data replication is enabled. Can be `enabled` or `disabled`. Defaults to `enabled`.
     */
     ...
     * The prefixes used to specify the object to replicate. Only objects that match the prefix are replicated to the destination bucket(See the following block `prefixSet`).
     */
    prefixSet?: pulumi.Input<inputs.ots.BucketReplicationPrefixSet>;
    /**
     * Retrieves the progress of the data replication task. This status is returned only when the data replication task is in the doing state.
     */
    progress?: pulumi.Input<inputs.ots.BucketReplicationProgress>;
    /**
     * The ID of the data replication rule.
     */
     ...
     * Specifies other conditions used to filter the source objects to replicate(See the following block `sourceSelectionCriteria`).
     */
    sourceSelectionCriteria?: pulumi.Input<inputs.ots.BucketReplicationSourceSelectionCriteria>;
    /**
     * Specifies whether to replicate objects encrypted by using SSE-KMS. Can be `Enabled` or `Disabled`.
     */
