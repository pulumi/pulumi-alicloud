...
export class GlobalSecurityIpGroup extends pulumi.CustomResource {
     ...
     */
    public readonly globalIgName!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly globalSecurityIpList!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: GlobalSecurityIpGroupArgs | GlobalSecurityIpGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["globalIgName"] = state ? state.globalIgName : undefined;
            resourceInputs["globalSecurityIpList"] = state ? state.globalSecurityIpList : undefined;
            resourceInputs["regionId"] = state ? state.regionId : undefined;
        } else {
            const args = argsOrState as GlobalSecurityIpGroupArgs | undefined;
            if ((!args || args.globalIgName === undefined) && !opts.urn) {
                throw new Error("Missing required property 'globalIgName'");
            }
            if ((!args || args.globalSecurityIpList === undefined) && !opts.urn) {
                throw new Error("Missing required property 'globalSecurityIpList'");
            }
            resourceInputs["globalIgName"] = args ? args.globalIgName : undefined;
            resourceInputs["globalSecurityIpList"] = args ? args.globalSecurityIpList : undefined;
