 ...
 *     groupName: name,
 * });
 * const defaultDeployGroups = alicloud.edas.getDeployGroupsOutput({
 *     appId: defaultDeployGroup.appId,
 * });
 * const defaultApplicationScale = new alicloud.edas.ApplicationScale("defaultApplicationScale", {
 *     appId: defaultApplication.id,
 *     deployGroup: defaultDeployGroups.apply(defaultDeployGroups => defaultDeployGroups.groups?.[0]?.groupId),
