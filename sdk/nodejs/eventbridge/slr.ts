 ...
 * ```
 */
export class Slr extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SlrState, opts?: pulumi.CustomResourceOptions): Slr {
        return new Slr(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'alicloud:eventbridge/slr:Slr';

    /**
     * Returns true if the given object is an instance of Slr.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Slr {
