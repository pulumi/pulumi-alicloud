...
build::
	go install -ldflags "-X github.com/pulumi/pulumi-alicloud/pkg/version.Version=${VERSION}" ${PROJECT}/cmd/${TFGEN}
	go install -ldflags "-X github.com/pulumi/pulumi-alicloud/pkg/version.Version=${VERSION}" ${PROJECT}/cmd/${PROVIDER}
...
install::
	GOBIN=$(PULUMI_BIN) go install -ldflags "-X github.com/pulumi/pulumi-alicloud/pkg/version.Version=${VERSION}" ${PROJECT}/cmd/${PROVIDER}
